	...
	if err := validation.Validate([]validation.Validation{
		...
		{TargetValue: serverParameters,
			Constraints: []validation.Constraint{{Target: "serverParameters.ServerProperties", Name: validation.Null, Rule: false,
				Chain: []validation.Constraint{{Target: "serverParameters.ServerProperties.State", Name: validation.ReadOnly, Rule: true, Chain: nil},
					{Target: "serverParameters.ServerProperties.ProvisioningState", Name: validation.ReadOnly, Rule: true, Chain: nil},
