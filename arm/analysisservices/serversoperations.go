...
func (client ServersOperationsClient) Create(resourceGroupName string, serverName string, serverParameters Server, cancel <-chan struct{}) (result autorest.Response, err error) {
	if err := validation.Validate([]validation.Validation{
		...
		{TargetValue: serverParameters,
			Constraints: []validation.Constraint{{Target: "serverParameters.Properties", Name: validation.Null, Rule: false,
				Chain: []validation.Constraint{{Target: "serverParameters.Properties.ProvisioningState", Name: validation.ReadOnly, Rule: true, Chain: nil},
					{Target: "serverParameters.Properties.ServerFullName", Name: validation.ReadOnly, Rule: true, Chain: nil},
				}}}}}); err != nil {
