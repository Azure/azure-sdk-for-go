...
// ServicesClient is the use these REST APIs to manage Azure API Management client.
...
// Backup creates a backup of the API Management service to the given Azure Storage Account.
func (client ServicesClient) Backup(resourceGroupName string, serviceName string, parameters ServiceBackupRestoreParameters, cancel <-chan struct{}) (result autorest.Response, err error) {
        req, err := client.BackupPreparer(resourceGroupName, serviceName, parameters, cancel)
        if err != nil {
                return result, autorest.NewErrorWithError(err, "apimanagement.ServicesClient", "Backup", nil , "Failure preparing request")
        }

        resp, err := client.BackupSender(req)
        if err != nil {
                result.Response = resp
                return result, autorest.NewErrorWithError(err, "apimanagement.ServicesClient", "Backup", resp, "Failure sending request")
        }
...
func (client ServicesClient) BackupSender(req *http.Request) (*http.Response, error) {
        return autorest.SendWithSender(client, req, azure.DoPollForAsynchronous(client.PollingDelay))
}

// BackupResponder handles the response to the Backup request. The method always closes the http.Response Body.
func (client ServicesClient) BackupResponder(resp *http.Response) (result autorest.Response, err error) { 
...
func (client ServicesClient) CheckNameAvailability(parameters ServiceCheckNameAvailabilityParameters) (result ServiceNameAvailabilityResult, err error) {
        ...
        if err != nil {
                return result, autorest.NewErrorWithError(err, "apimanagement.ServicesClient", "CheckNameAvailability", nil , "Failure preparing request")
        }

        resp, err := client.CheckNameAvailabilitySender(req)
        if err != nil {
                result.Response = autorest.Response{Response: resp}
                return result, autorest.NewErrorWithError(err, "apimanagement.ServicesClient", "CheckNameAvailability", resp, "Failure sending request")
        }
...
// CreateOrUpdate creates or updates an API Management service.
func (client ServicesClient) CreateOrUpdate(resourceGroupName string, serviceName string, parameters ServiceResource) (result ServiceResource, err error) {
        ...
        if err != nil {
                return result, autorest.NewErrorWithError(err, "apimanagement.ServicesClient", "CreateOrUpdate", nil , "Failure preparing request")
        }

        resp, err := client.CreateOrUpdateSender(req)
        if err != nil {
        result.Response = autorest.Response{Response: resp}
                return result, autorest.NewErrorWithError(err, "apimanagement.ServicesClient", "CreateOrUpdate", resp, "Failure sending request")
        }
...
func (client ServicesClient) Delete(resourceGroupName string, serviceName string) (result ErrorResponse, err error) {
        req, err := client.DeletePreparer(resourceGroupName, serviceName)
        if err != nil {
                return result, autorest.NewErrorWithError(err, "apimanagement.ServicesClient", "Delete", nil , "Failure preparing request")
        }

        resp, err := client.DeleteSender(req)
        if err != nil {
                result.Response = autorest.Response{Response: resp}
                return result, autorest.NewErrorWithError(err, "apimanagement.ServicesClient", "Delete", resp, "Failure sending request")
        }
...
func (client ServicesClient) Get(resourceGroupName string, serviceName string) (result SetObject, err error) {
        req, err := client.GetPreparer(resourceGroupName, serviceName)
        if err != nil {
                return result, autorest.NewErrorWithError(err, "apimanagement.ServicesClient", "Get", nil , "Failure preparing request")
        }

        resp, err := client.GetSender(req)
        if err != nil {
        result.Response = autorest.Response{Response: resp}
                return result, autorest.NewErrorWithError(err, "apimanagement.ServicesClient", "Get", resp, "Failure sending request")
        }
...
func (client ServicesClient) GetSsoToken(resourceGroupName string, serviceName string) (result ServiceGetSsoTokenResult, err error) {
        ...
        if err != nil {
                return result, autorest.NewErrorWithError(err, "apimanagement.ServicesClient", "GetSsoToken", nil , "Failure preparing request")
        }

        resp, err := client.GetSsoTokenSender(req)
        if err != nil {
                result.Response = autorest.Response{Response: resp}
                return result, autorest.NewErrorWithError(err, "apimanagement.ServicesClient", "GetSsoToken", resp, "Failure sending request")
        }
...
func (client ServicesClient) List() (result ServiceListResult, err error) {
        ...
        if err != nil {
                return result, autorest.NewErrorWithError(err, "apimanagement.ServicesClient", "List", nil , "Failure preparing request")
        }

        resp, err := client.ListSender(req)
        if err != nil {
                result.Response = autorest.Response{Response: resp}
                return result, autorest.NewErrorWithError(err, "apimanagement.ServicesClient", "List", resp, "Failure sending request")
        }
...
func (client ServicesClient) ListByResourceGroup() (resourceGroupName string, result ServiceListResult, err error) {
        ...
        if err != nil {
                return result, autorest.NewErrorWithError(err, "apimanagement.ServicesClient", "ListByResourceGroup", nil , "Failure preparing request")
        }

        resp, err := client.ListByResourceGroupSender(req)
        if err != nil {
                result.Response = autorest.Response{Response: resp}
                return result, autorest.NewErrorWithError(err, "apimanagement.ServicesClient", "ListByResourceGroup", resp, "Failure sending request")
        }
...
// ManageDeployments manages deployments of an API Management service.
func (client ServicesClient) ManageDeployments(resourceGroupName string, serviceName string, parameters ServiceManageDeploymentsParameters, cancel <-chan struct{}) (result autorest.Response, err error) {
        req, err := client.ManageDeploymentsPreparer(resourceGroupName, serviceName, parameters, cancel)
        if err != nil {
                return result, autorest.NewErrorWithError(err, "apimanagement.ServicesClient", "ManageDeployments", nil , "Failure preparing request")
        }

        resp, err := client.ManageDeploymentsSender(req)
        if err != nil {
                result.Response = resp
                return result, autorest.NewErrorWithError(err, "apimanagement.ServicesClient", "ManageDeployments", resp, "Failure sending request")
        }
...
// closes the http.Response Body.
func (client ServicesClient) ManageDeploymentsResponder(resp *http.Response) (result autorest.Response, err error) { 
        err = autorest.Respond(
                resp,
                client.ByInspecting(),
                azure.WithErrorUnlessStatusCode(http.StatusOK,http.StatusAccepted),
...
// ApiManagementServices_Backup operation on the current service.
func (client ServicesClient) Restore(resourceGroupName string, serviceName string, parameters ServiceBackupRestoreParameters, cancel <-chan struct{}) (result autorest.Response, err error) {
        req, err := client.RestorePreparer(resourceGroupName, serviceName, parameters, cancel)
        if err != nil {
                return result, autorest.NewErrorWithError(err, "apimanagement.ServicesClient", "Restore", nil , "Failure preparing request")
        }

        resp, err := client.RestoreSender(req)
        if err != nil {
                result.Response = resp
                return result, autorest.NewErrorWithError(err, "apimanagement.ServicesClient", "Restore", resp, "Failure sending request")
        }
...
func (client ServicesClient) RestoreResponder(resp *http.Response) (result autorest.Response, err error) { 
        err = autorest.Respond(
                resp,
                client.ByInspecting(),
                azure.WithErrorUnlessStatusCode(http.StatusOK,http.StatusAccepted),
...
func (client ServicesClient) Update(resourceGroupName string, serviceName string, parameters ServiceBaseParameters, cancel <-chan struct{}) (result autorest.Response, err error) {
        req, err := client.UpdatePreparer(resourceGroupName, serviceName, parameters, cancel)
        if err != nil {
                return result, autorest.NewErrorWithError(err, "apimanagement.ServicesClient", "Update", nil , "Failure preparing request")
        }

        resp, err := client.UpdateSender(req)
        if err != nil {
                result.Response = resp
                return result, autorest.NewErrorWithError(err, "apimanagement.ServicesClient", "Update", resp, "Failure sending request")
        }
...
func (client ServicesClient) UpdatePreparer(resourceGroupName string, serviceName string, parameters ServiceBaseParameters, cancel <-chan struct{}) (*http.Request, error) {
        pathParameters := map[string]interface{} {
                "resourceGroupName": autorest.Encode("path",resourceGroupName),
                "serviceName":       autorest.Encode("path",serviceName),
                "subscriptionId":    autorest.Encode("path",client.SubscriptionID),
...
func (client ServicesClient) UpdateResponder(resp *http.Response) (result autorest.Response, err error) { 
        err = autorest.Respond(
                resp,
                client.ByInspecting(),
                azure.WithErrorUnlessStatusCode(http.StatusOK,http.StatusAccepted),
...
// UpdateHostname creates, updates, or deletes the custom hostnames for an API Management service.
func (client ServicesClient) UpdateHostname(resourceGroupName string, serviceName string, parameters ServiceUpdateHostnameParameters, cancel <-chan struct{}) (result autorest.Response, err error) {
        req, err := client.UpdateHostnamePreparer(resourceGroupName, serviceName, parameters, cancel)
        if err != nil {
                return result, autorest.NewErrorWithError(err, "apimanagement.ServicesClient", "UpdateHostname", nil , "Failure preparing request")
        }

        resp, err := client.UpdateHostnameSender(req)
        if err != nil {
                result.Response = resp
                return result, autorest.NewErrorWithError(err, "apimanagement.ServicesClient", "UpdateHostname", resp, "Failure sending request")
        }
...
// closes the http.Response Body.
func (client ServicesClient) UpdateHostnameResponder(resp *http.Response) (result autorest.Response, err error) { 
        err = autorest.Respond(
                resp,
                client.ByInspecting(),
                azure.WithErrorUnlessStatusCode(http.StatusOK),
...
func (client ServicesClient) UploadCertificate(resourceGroupName string, serviceName string, parameters ServiceUploadCertificateParameters) (result CertificateInformation, err error) {
        ...
        if err != nil {
                return result, autorest.NewErrorWithError(err, "apimanagement.ServicesClient", "UploadCertificate", nil , "Failure preparing request")
        }

        resp, err := client.UploadCertificateSender(req)
        if err != nil {
                result.Response = autorest.Response{Response: resp}
                return result, autorest.NewErrorWithError(err, "apimanagement.ServicesClient", "UploadCertificate", resp, "Failure sending request")
        }
