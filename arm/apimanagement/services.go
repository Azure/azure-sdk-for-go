...
// ServicesClient is the use these REST APIs to manage Azure API Management
// deployment.
...
func (client ServicesClient) ManageDeployments(resourceGroupName string, serviceName string, parameters ServiceManageDeploymentsParameters, cancel <-chan struct{}) (result autorest.Response, err error) {
    if err := validation.Validate([]validation.Validation{
         ...
         Chain: []validation.Constraint{	{Target: "parameters.VpnConfiguration.Vnetid", Name: validation.ReadOnly, Rule: true, Chain: nil },
         	{Target: "parameters.VpnConfiguration.Subnetname", Name: validation.ReadOnly, Rule: true, Chain: nil },
         }}}}}); err != nil {
