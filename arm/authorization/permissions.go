...
func (client PermissionsClient) ListForResource(resourceGroupName string, resourceProviderNamespace string, parentResourcePath string, resourceType string, resourceName string) (result PermissionGetResult, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "authorization/PermissionsClient", "ListForResource", autorest.UndefinedStatusCode, "Failure preparing request")
	}

	resp, err := client.ListForResourceSender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "authorization/PermissionsClient", "ListForResource", resp.StatusCode, "Failure sending request")
	}

	result, err = client.ListForResourceResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "authorization/PermissionsClient", "ListForResource", resp.StatusCode, "Failure responding to request")
	}
...
func (client PermissionsClient) ListForResourceNextResults(lastResults PermissionGetResult) (result PermissionGetResult, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "authorization/PermissionsClient", "ListForResource", autorest.UndefinedStatusCode, "Failure preparing next results request request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "authorization/PermissionsClient", "ListForResource", resp.StatusCode, "Failure sending next results request request")
	}

	result, err = client.ListForResourceResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "authorization/PermissionsClient", "ListForResource", resp.StatusCode, "Failure responding to next results request request")
	}
...
func (client PermissionsClient) ListForResourceGroup(resourceGroupName string) (result PermissionGetResult, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "authorization/PermissionsClient", "ListForResourceGroup", autorest.UndefinedStatusCode, "Failure preparing request")
	}

	resp, err := client.ListForResourceGroupSender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "authorization/PermissionsClient", "ListForResourceGroup", resp.StatusCode, "Failure sending request")
	}

	result, err = client.ListForResourceGroupResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "authorization/PermissionsClient", "ListForResourceGroup", resp.StatusCode, "Failure responding to request")
	}
...
func (client PermissionsClient) ListForResourceGroupNextResults(lastResults PermissionGetResult) (result PermissionGetResult, ae error) {
	req, err := lastResults.PermissionGetResultPreparer()
	if err != nil {
		return result, autorest.NewErrorWithError(err, "authorization/PermissionsClient", "ListForResourceGroup", autorest.UndefinedStatusCode, "Failure preparing next results request request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "authorization/PermissionsClient", "ListForResourceGroup", resp.StatusCode, "Failure sending next results request request")
	}

	result, err = client.ListForResourceGroupResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "authorization/PermissionsClient", "ListForResourceGroup", resp.StatusCode, "Failure responding to next results request request")
	}
