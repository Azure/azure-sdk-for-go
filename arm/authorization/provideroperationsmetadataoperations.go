...
func (client ProviderOperationsMetadataOperationsClient) Get(resourceProviderNamespace string, apiVersion string, expand string) (result ProviderOperationsMetadata, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "authorization/ProviderOperationsMetadataOperationsClient", "Get", autorest.UndefinedStatusCode, "Failure preparing request")
	}

	resp, err := client.GetSender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "authorization/ProviderOperationsMetadataOperationsClient", "Get", resp.StatusCode, "Failure sending request")
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "authorization/ProviderOperationsMetadataOperationsClient", "Get", resp.StatusCode, "Failure responding to request")
	}
...
func (client ProviderOperationsMetadataOperationsClient) List(apiVersion string, expand string) (result ProviderOperationsMetadataListResult, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "authorization/ProviderOperationsMetadataOperationsClient", "List", autorest.UndefinedStatusCode, "Failure preparing request")
	}

	resp, err := client.ListSender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "authorization/ProviderOperationsMetadataOperationsClient", "List", resp.StatusCode, "Failure sending request")
	}

	result, err = client.ListResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "authorization/ProviderOperationsMetadataOperationsClient", "List", resp.StatusCode, "Failure responding to request")
	}
...
func (client ProviderOperationsMetadataOperationsClient) ListNextResults(lastResults ProviderOperationsMetadataListResult) (result ProviderOperationsMetadataListResult, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "authorization/ProviderOperationsMetadataOperationsClient", "List", autorest.UndefinedStatusCode, "Failure preparing next results request request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "authorization/ProviderOperationsMetadataOperationsClient", "List", resp.StatusCode, "Failure sending next results request request")
	}

	result, err = client.ListResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "authorization/ProviderOperationsMetadataOperationsClient", "List", resp.StatusCode, "Failure responding to next results request request")
	}
