...
func (client RoleDefinitionsClient) CreateOrUpdate(scope string, roleDefinitionID string, roleDefinition RoleDefinition) (result RoleDefinition, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "authorization/RoleDefinitionsClient", "CreateOrUpdate", autorest.UndefinedStatusCode, "Failure preparing request")
	}

	resp, err := client.CreateOrUpdateSender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "authorization/RoleDefinitionsClient", "CreateOrUpdate", resp.StatusCode, "Failure sending request")
	}

	result, err = client.CreateOrUpdateResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "authorization/RoleDefinitionsClient", "CreateOrUpdate", resp.StatusCode, "Failure responding to request")
	}
...
func (client RoleDefinitionsClient) Delete(scope string, roleDefinitionID string) (result RoleDefinition, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "authorization/RoleDefinitionsClient", "Delete", autorest.UndefinedStatusCode, "Failure preparing request")
	}

	resp, err := client.DeleteSender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "authorization/RoleDefinitionsClient", "Delete", resp.StatusCode, "Failure sending request")
	}

	result, err = client.DeleteResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "authorization/RoleDefinitionsClient", "Delete", resp.StatusCode, "Failure responding to request")
	}
...
func (client RoleDefinitionsClient) Get(scope string, roleDefinitionID string) (result RoleDefinition, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "authorization/RoleDefinitionsClient", "Get", autorest.UndefinedStatusCode, "Failure preparing request")
	}

	resp, err := client.GetSender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "authorization/RoleDefinitionsClient", "Get", resp.StatusCode, "Failure sending request")
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "authorization/RoleDefinitionsClient", "Get", resp.StatusCode, "Failure responding to request")
	}
...
func (client RoleDefinitionsClient) GetByID(roleDefinitionID string) (result RoleDefinition, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "authorization/RoleDefinitionsClient", "GetByID", autorest.UndefinedStatusCode, "Failure preparing request")
	}

	resp, err := client.GetByIDSender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "authorization/RoleDefinitionsClient", "GetByID", resp.StatusCode, "Failure sending request")
	}

	result, err = client.GetByIDResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "authorization/RoleDefinitionsClient", "GetByID", resp.StatusCode, "Failure responding to request")
	}
...
func (client RoleDefinitionsClient) List(scope string, filter string) (result RoleDefinitionListResult, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "authorization/RoleDefinitionsClient", "List", autorest.UndefinedStatusCode, "Failure preparing request")
	}

	resp, err := client.ListSender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "authorization/RoleDefinitionsClient", "List", resp.StatusCode, "Failure sending request")
	}

	result, err = client.ListResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "authorization/RoleDefinitionsClient", "List", resp.StatusCode, "Failure responding to request")
	}
...
func (client RoleDefinitionsClient) ListNextResults(lastResults RoleDefinitionListResult) (result RoleDefinitionListResult, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "authorization/RoleDefinitionsClient", "List", autorest.UndefinedStatusCode, "Failure preparing next results request request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "authorization/RoleDefinitionsClient", "List", resp.StatusCode, "Failure sending next results request request")
	}

	result, err = client.ListResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "authorization/RoleDefinitionsClient", "List", resp.StatusCode, "Failure responding to next results request request")
	}
