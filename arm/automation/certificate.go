...
// NewCertificateClientWithAuthFile creates an instance of the CertificateClient client.
func NewCertificateClientWithAuthFile() (CertificateClient, error) {
	c, err := NewWithAuthFile()
	return CertificateClient{c}, err
}
