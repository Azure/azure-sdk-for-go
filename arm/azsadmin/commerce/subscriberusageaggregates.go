...
func (client SubscriberUsageAggregatesClient) List(reportedStartTime date.Time, reportedEndTime date.Time, aggregationGranularity string, subscriberID string, continuationToken string) (result UsageAggregatePage, err error) {
	if err := validation.Validate([]validation.Validation{}); err != nil {
		return result, validation.NewErrorWithValidationError(err, "commerce.SubscriberUsageAggregatesClient", "List")
	}

	req, err := client.ListPreparer(reportedStartTime, reportedEndTime, aggregationGranularity, subscriberID, continuationToken)
	if err != nil {
...
func (client SubscriberUsageAggregatesClient) ListPreparer(reportedStartTime date.Time, reportedEndTime date.Time, aggregationGranularity string, subscriberID string, continuationToken string) (*http.Request, error) {
