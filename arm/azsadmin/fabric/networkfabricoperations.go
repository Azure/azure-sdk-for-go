...
// fabric operation.
func (client NetworkFabricOperationsClient) Get(location string, provider string, networkOperationResult string) (result OperationStatus, err error) {
	if err := validation.Validate([]validation.Validation{}); err != nil {
		return result, validation.NewErrorWithValidationError(err, "fabric.NetworkFabricOperationsClient", "Get")
	}

	req, err := client.GetPreparer(location, provider, networkOperationResult)
	if err != nil {
...
func (client NetworkFabricOperationsClient) GetPreparer(location string, provider string, networkOperationResult string) (*http.Request, error) {
