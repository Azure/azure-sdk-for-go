...
func (client ResourceHealthsClient) Get(location string, serviceRegistrationID string, resourceRegistrationID string, filter string) (result ResourceHealth, err error) {
	if err := validation.Validate([]validation.Validation{}); err != nil {
		return result, validation.NewErrorWithValidationError(err, "infrastructureinsights.ResourceHealthsClient", "Get")
	}

	req, err := client.GetPreparer(location, serviceRegistrationID, resourceRegistrationID, filter)
	if err != nil {
...
func (client ResourceHealthsClient) GetPreparer(location string, serviceRegistrationID string, resourceRegistrationID string, filter string) (*http.Request, error) {
...
func (client ResourceHealthsClient) List(location string, serviceRegistrationID string, filter string) (result ResourceHealthList, err error) {
	if err := validation.Validate([]validation.Validation{}); err != nil {
		return result, validation.NewErrorWithValidationError(err, "infrastructureinsights.ResourceHealthsClient", "List")
	}

	req, err := client.ListPreparer(location, serviceRegistrationID, filter)
	if err != nil {
...
func (client ResourceHealthsClient) ListPreparer(location string, serviceRegistrationID string, filter string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"location":              autorest.Encode("path", location),
		"serviceRegistrationId": autorest.Encode("path", serviceRegistrationID),
		"subscriptionId":        autorest.Encode("path", client.SubscriptionID),
...
func (client ResourceHealthsClient) ListNextResults(lastResults ResourceHealthList) (result ResourceHealthList, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "infrastructureinsights.ResourceHealthsClient", "List", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "infrastructureinsights.ResourceHealthsClient", "List", resp, "Failure sending next results request")
	}

	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "infrastructureinsights.ResourceHealthsClient", "List", resp, "Failure responding to next results request")
	}
...
func (client ResourceHealthsClient) ListComplete(location string, serviceRegistrationID string, filter string, cancel <-chan struct{}) (<-chan ResourceHealth, <-chan error) {
	resultChan := make(chan ResourceHealth)
	...
	go func() {
		...
		list, err := client.List(location, serviceRegistrationID, filter)
		if err != nil {
			errChan <- err
			return
		}
