...
func (client ServiceHealthsClient) Get(location string, serviceHealth string) (result ServiceHealth, err error) {
	if err := validation.Validate([]validation.Validation{}); err != nil {
		return result, validation.NewErrorWithValidationError(err, "infrastructureinsights.ServiceHealthsClient", "Get")
	}

	req, err := client.GetPreparer(location, serviceHealth)
	if err != nil {
...
func (client ServiceHealthsClient) GetPreparer(location string, serviceHealth string) (*http.Request, error) {
...
func (client ServiceHealthsClient) List(location string, filter string) (result ServiceHealthList, err error) {
	if err := validation.Validate([]validation.Validation{}); err != nil {
		return result, validation.NewErrorWithValidationError(err, "infrastructureinsights.ServiceHealthsClient", "List")
	}
...
func (client ServiceHealthsClient) ListPreparer(location string, filter string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"location":       autorest.Encode("path", location),
		"subscriptionId": autorest.Encode("path", client.SubscriptionID),
	}
...
func (client ServiceHealthsClient) ListNextResults(lastResults ServiceHealthList) (result ServiceHealthList, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "infrastructureinsights.ServiceHealthsClient", "List", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "infrastructureinsights.ServiceHealthsClient", "List", resp, "Failure sending next results request")
	}

	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "infrastructureinsights.ServiceHealthsClient", "List", resp, "Failure responding to next results request")
	}
...
func (client ServiceHealthsClient) ListComplete(location string, filter string, cancel <-chan struct{}) (<-chan ServiceHealth, <-chan error) {
	resultChan := make(chan ServiceHealth)
