...
// BatchAccountBaseProperties is the properties of a Batch account.
...
type BatchAccountCreateParameters struct {
	Location                    *string             `json:"location,omitempty"`
	Tags                        *map[string]*string `json:"tags,omitempty"`
	*BatchAccountBaseProperties `json:"properties,omitempty"`
}
...
// BatchAccountUpdateParameters is parameters supplied to the Update operation.
