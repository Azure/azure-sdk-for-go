...
// specified domain name and a CDN endpoint. This is to use custom domain names
// to represent the URLs for branding purposes.
...
// CustomDomainParameters is customDomain properties required for custom domain
// creation or update.
