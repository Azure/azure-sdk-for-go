...
// ResourceSkusClient is the the Compute Management Client.
...
// NewResourceSkusClientWithBaseURI creates an instance of the
// ResourceSkusClient client.
func NewResourceSkusClientWithBaseURI(baseURI string, subscriptionID string) ResourceSkusClient {
	return ResourceSkusClient{NewWithBaseURI(baseURI, subscriptionID)}
}

// List gets the list of Microsoft.Compute SKUs available for your
// Subscription.
