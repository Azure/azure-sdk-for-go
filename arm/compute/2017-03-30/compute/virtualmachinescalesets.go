...
// name of the VM scale set to create or update. parameters is the scale set
// object.
...
// machines in a VM scale set. This operation is only supported for managed
// disks. This method may poll for completion. Polling can be canceled by
// passing the cancel channel argument. The channel will be used to cancel
// polling and any outstanding HTTP requests.
//
// resourceGroupName is the name of the resource group. VMScaleSetName is the
