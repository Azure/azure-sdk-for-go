...
// ListVirtualMachineExtensionImageWrapper is
type ListVirtualMachineExtensionImageWrapper struct {
	autorest.Response `json:"-"`
	Value             *[]VirtualMachineExtensionImage `json:"value,omitempty"`
}

// ListVirtualMachineImageResourceWrapper is
type ListVirtualMachineImageResourceWrapper struct {
	autorest.Response `json:"-"`
