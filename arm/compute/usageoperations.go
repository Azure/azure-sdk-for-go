...
func (client UsageOperationsManagementClient) List(location string) (result ListUsagesResult, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "compute/UsageOperationsManagementClient", "List", "Failure preparing request")
	}

	resp, err := client.ListSender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "compute/UsageOperationsManagementClient", "List", "Failure sending request")
	}

	result, err = client.ListResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "compute/UsageOperationsManagementClient", "List", "Failure responding to request")
	}
