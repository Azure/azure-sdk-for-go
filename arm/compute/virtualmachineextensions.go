...
// NewVirtualMachineExtensionsClientWithAuthFile creates an instance of the VirtualMachineExtensionsClient client.
func NewVirtualMachineExtensionsClientWithAuthFile() (VirtualMachineExtensionsClient, error) {
	c, err := NewWithAuthFile()
	return VirtualMachineExtensionsClient{c}, err
}
