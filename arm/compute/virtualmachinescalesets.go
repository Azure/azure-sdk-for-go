...
// NewVirtualMachineScaleSetsClientWithAuthFile creates an instance of the VirtualMachineScaleSetsClient client.
func NewVirtualMachineScaleSetsClientWithAuthFile() (VirtualMachineScaleSetsClient, error) {
	c, err := NewWithAuthFile()
	return VirtualMachineScaleSetsClient{c}, err
}
