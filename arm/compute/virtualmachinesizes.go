...
// NewVirtualMachineSizesManagementClient creates an instance of the
// VirtualMachineSizesManagementClient client.
func NewVirtualMachineSizesManagementClient(subscriptionID string) VirtualMachineSizesManagementClient {
	return NewVirtualMachineSizesManagementClientWithBaseURI(DefaultBaseURI, subscriptionID)
}

// NewVirtualMachineSizesManagementClientWithBaseURI creates an instance of
// the VirtualMachineSizesManagementClient client.
func NewVirtualMachineSizesManagementClientWithBaseURI(baseURI string, subscriptionID string) VirtualMachineSizesManagementClient {
	return VirtualMachineSizesManagementClient{NewWithBaseURI(baseURI, subscriptionID)}
}
...
func (client VirtualMachineSizesManagementClient) List(location string) (result VirtualMachineSizeListResult, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "compute/VirtualMachineSizesManagementClient", "List", "Failure preparing request")
	}

	resp, err := client.ListSender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "compute/VirtualMachineSizesManagementClient", "List", "Failure sending request")
	}

	result, err = client.ListResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "compute/VirtualMachineSizesManagementClient", "List", "Failure responding to request")
	}
