...
const (
	...
	Basic SkuName = "Basic"
	// Dev specifies the dev state for sku name.
	Dev SkuName = "Dev"
	// Enterprise specifies the enterprise state for sku name.
	Enterprise SkuName = "Enterprise"
...
const (
	...
	// SkuTierDev specifies the sku tier dev state for sku tier.
	SkuTierDev SkuTier = "Dev"
	// SkuTierEnterprise specifies the sku tier enterprise state for sku tier.
...
// Status is the status of an Azure resource at the time the operation was
// called.
type Status struct {
