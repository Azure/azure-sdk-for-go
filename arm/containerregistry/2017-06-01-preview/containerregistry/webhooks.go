...
// WebhooksClient is the client for the Webhooks methods of the
...
// NewWebhooksClientWithBaseURI creates an instance of the WebhooksClient
// client.
...
// Create creates a webhook for a container registry with the specified
// parameters. This method may poll for completion. Polling can be canceled by
...
// webhookName is the name of the webhook. webhookCreateParameters is the
...
// Delete deletes a webhook from a container registry. This method may poll for
...
// GetCallbackConfig gets the configuration of service URI and custom headers
// for the webhook.
//
// resourceGroupName is the name of the resource group to which the container
// registry belongs. registryName is the name of the container registry.
...
// Update updates a webhook with the specified parameters. This method may poll
...
// resourceGroupName is the name of the resource group to which the container
// registry belongs. registryName is the name of the container registry.
// webhookName is the name of the webhook. webhookUpdateParameters is the
