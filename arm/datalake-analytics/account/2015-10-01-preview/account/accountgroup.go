...
// AddDataLakeStoreAccount updates the specified Data Lake Analytics account to
...
//
// resourceGroupName is the name of the Azure resource group that contains the
// Data Lake Analytics account.the account will be associated with. name is the
// name of the Data Lake Analytics account to create. parameters is parameters
...
// DeleteDataLakeStoreAccount updates the Data Lake Analytics account specified
// to remove the specified Data Lake Store account.
//
// resourceGroupName is the name of the Azure resource group that contains the
// Data Lake Analytics account. accountName is the name of the Data Lake
...
// linked to the specified Data Lake Analytics account. The response includes a
...
// Categories?$count=true. Optional. search is a free form search. A free-text
// search expression to match for whether a particular entry should be included
// in the feed, e.g. Categories?$search=blue OR green. Optional.
...
// account to update. parameters is parameters supplied to the update Data Lake
