...
const (
	...
	// ServicePrincipal specifies the service principal state for aad object
	// type.
...
const (
	// Disabled specifies the disabled state for firewall allow azure ips
	// state.
...
// ComputePolicyAccountCreateParameters is the parameters used to create a new
// compute policy.
...
// ComputePolicyCreateOrUpdateParameters is the parameters used to create a new
// compute policy.
...
// ComputePolicyProperties is the compute policy properties to use when
// creating a new compute policy
...
// ComputePolicyPropertiesCreateParameters is the compute policy properties to
// use when creating a new compute policy
...
// DataLakeAnalyticsFirewallRuleListResult is data Lake Analytics firewall rule
// list information.
...
// FirewallRuleProperties is data Lake Analytics firewall rule properties
// information
...
// OptionalSubResource is the Resource model definition for a nested resource
