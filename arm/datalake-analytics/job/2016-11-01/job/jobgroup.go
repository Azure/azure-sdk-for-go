...
func (client GroupClient) Build(accountName string, parameters Information) (result Information, err error) {
    ...
    Chain: []validation.Constraint{	{Target: "parameters.Properties.Script", Name: validation.Null, Rule: true, Chain: nil },
    }}}}}); err != nil {
...
// GetDebugDataPath gets the job debug data information specified by the job
// ID.
//
// accountName is the Azure Data Lake Analytics account to execute job
// operations on. jobIdentity is jobInfo ID.
...
//
// accountName is the Azure Data Lake Analytics account to execute job
// operations on. jobIdentity is job Information ID.
...
// returning elements. Optional. selectParameter is oData Select statement.
