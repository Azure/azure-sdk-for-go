...
const (
	...
	// LabVmsShutdownTask specifies the lab vms shutdown task state for task
	// type.
	LabVmsShutdownTask TaskType = "LabVmsShutdownTask"
	// LabVmsStartupTask specifies the lab vms startup task state for task
	// type.
...
// ResponseWithContinuationCostPreparer prepares a request to retrieve the next set of results. It returns
// nil if no more results exist.
...
// ResponseWithContinuationCostInsightPreparer prepares a request to retrieve the next set of results. It returns
// nil if no more results exist.
