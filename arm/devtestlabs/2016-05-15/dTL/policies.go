...
// NewPoliciesClientWithBaseURI creates an instance of the PoliciesClient
// client.
...
// resourceGroupName is the name of the resource group. labName is the name of
// the lab. policySetName is the name of the policy set. name is the name of
// the policy. expand is specify the $expand query. Example:
...
//
// resourceGroupName is the name of the resource group. labName is the name of
// the lab. policySetName is the name of the policy set. expand is specify the
// $expand query. Example: 'properties($select=description)' filter is the
// filter to apply to the operation. top is the maximum number of resources to
