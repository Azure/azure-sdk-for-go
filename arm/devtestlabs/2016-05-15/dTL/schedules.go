...
// NewSchedulesClientWithBaseURI creates an instance of the SchedulesClient
// client.
...
// the lab. name is the name of the schedule. schedule is a schedule.
...
//
// resourceGroupName is the name of the resource group. labName is the name of
// the lab. name is the name of the schedule. expand is specify the $expand
...
// 'properties($select=status)' filter is the filter to apply to the operation.
