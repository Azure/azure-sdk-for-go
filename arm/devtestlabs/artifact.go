...
// ArtifactClient is the azure DevTest Labs REST API.
...
// NewArtifactClientWithBaseURI creates an instance of the ArtifactClient
// client.
...
func (client ArtifactClient) GenerateArmTemplate(resourceGroupName string, labName string, artifactSourceName string, name string, generateArmTemplateRequest GenerateArmTemplateRequest) (result ArmTemplateInfo, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "devtestlabs.ArtifactClient", "GenerateArmTemplate", nil, "Failure preparing request")
	}

	resp, err := client.GenerateArmTemplateSender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "devtestlabs.ArtifactClient", "GenerateArmTemplate", resp, "Failure sending request")
	}

	result, err = client.GenerateArmTemplateResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "devtestlabs.ArtifactClient", "GenerateArmTemplate", resp, "Failure responding to request")
	}
...
func (client ArtifactClient) GetResource(resourceGroupName string, labName string, artifactSourceName string, name string) (result Artifact, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "devtestlabs.ArtifactClient", "GetResource", nil, "Failure preparing request")
	}

	resp, err := client.GetResourceSender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "devtestlabs.ArtifactClient", "GetResource", resp, "Failure sending request")
	}

	result, err = client.GetResourceResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "devtestlabs.ArtifactClient", "GetResource", resp, "Failure responding to request")
	}
...
// the filter to apply on the operation. top is the maximum number of resources
...
func (client ArtifactClient) List(resourceGroupName string, labName string, artifactSourceName string, filter string, top *int32, orderBy string) (result ResponseWithContinuationArtifact, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "devtestlabs.ArtifactClient", "List", nil, "Failure preparing request")
	}

	resp, err := client.ListSender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "devtestlabs.ArtifactClient", "List", resp, "Failure sending request")
	}

	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "devtestlabs.ArtifactClient", "List", resp, "Failure responding to request")
	}
...
func (client ArtifactClient) ListNextResults(lastResults ResponseWithContinuationArtifact) (result ResponseWithContinuationArtifact, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "devtestlabs.ArtifactClient", "List", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "devtestlabs.ArtifactClient", "List", resp, "Failure sending next results request")
	}

	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "devtestlabs.ArtifactClient", "List", resp, "Failure responding to next results request")
	}
