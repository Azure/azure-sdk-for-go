...
func (client ArtifactClient) GenerateArmTemplate(resourceGroupName string, labName string, artifactSourceName string, name string, generateArmTemplateRequest GenerateArmTemplateRequest) (result ArmTemplateInfo, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "devtestlabs.ArtifactClient", "GenerateArmTemplate", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "devtestlabs.ArtifactClient", "GenerateArmTemplate", resp, "Failure sending request")
		return
	}
...
func (client ArtifactClient) GetResource(resourceGroupName string, labName string, artifactSourceName string, name string) (result Artifact, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "devtestlabs.ArtifactClient", "GetResource", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "devtestlabs.ArtifactClient", "GetResource", resp, "Failure sending request")
		return
	}
...
func (client ArtifactClient) List(resourceGroupName string, labName string, artifactSourceName string, filter string, top *int32, orderBy string) (result ResponseWithContinuationArtifact, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "devtestlabs.ArtifactClient", "List", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "devtestlabs.ArtifactClient", "List", resp, "Failure sending request")
		return
	}
