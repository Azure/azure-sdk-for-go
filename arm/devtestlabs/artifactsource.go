...
func (client ArtifactSourceClient) CreateOrUpdateResource(resourceGroupName string, labName string, name string, artifactSource ArtifactSource) (result ArtifactSource, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "devtestlabs.ArtifactSourceClient", "CreateOrUpdateResource", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "devtestlabs.ArtifactSourceClient", "CreateOrUpdateResource", resp, "Failure sending request")
		return
	}
...
func (client ArtifactSourceClient) DeleteResource(resourceGroupName string, labName string, name string) (result autorest.Response, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "devtestlabs.ArtifactSourceClient", "DeleteResource", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "devtestlabs.ArtifactSourceClient", "DeleteResource", resp, "Failure sending request")
		return
	}
...
func (client ArtifactSourceClient) GetResource(resourceGroupName string, labName string, name string) (result ArtifactSource, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "devtestlabs.ArtifactSourceClient", "GetResource", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "devtestlabs.ArtifactSourceClient", "GetResource", resp, "Failure sending request")
		return
	}
...
func (client ArtifactSourceClient) List(resourceGroupName string, labName string, filter string, top *int32, orderBy string) (result ResponseWithContinuationArtifactSource, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "devtestlabs.ArtifactSourceClient", "List", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "devtestlabs.ArtifactSourceClient", "List", resp, "Failure sending request")
		return
	}
...
func (client ArtifactSourceClient) PatchResource(resourceGroupName string, labName string, name string, artifactSource ArtifactSource) (result ArtifactSource, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "devtestlabs.ArtifactSourceClient", "PatchResource", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "devtestlabs.ArtifactSourceClient", "PatchResource", resp, "Failure sending request")
		return
	}
