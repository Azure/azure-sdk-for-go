...
func (client CostClient) GetResource(resourceGroupName string, labName string, name string) (result Cost, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "devtestlabs.CostClient", "GetResource", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "devtestlabs.CostClient", "GetResource", resp, "Failure sending request")
		return
	}
