...
func (client CustomImageClient) CreateOrUpdateResource(resourceGroupName string, labName string, name string, customImage CustomImage, cancel <-chan struct{}) (<-chan CustomImage, <-chan error) {
	...
	go func() {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "devtestlabs.CustomImageClient", "CreateOrUpdateResource", nil, "Failure preparing request")
			return
		}
		...
		if err != nil {
			...
			err = autorest.NewErrorWithError(err, "devtestlabs.CustomImageClient", "CreateOrUpdateResource", resp, "Failure sending request")
			return
		}
...
func (client CustomImageClient) DeleteResource(resourceGroupName string, labName string, name string, cancel <-chan struct{}) (<-chan autorest.Response, <-chan error) {
	...
	go func() {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "devtestlabs.CustomImageClient", "DeleteResource", nil, "Failure preparing request")
			return
		}
		...
		if err != nil {
			...
			err = autorest.NewErrorWithError(err, "devtestlabs.CustomImageClient", "DeleteResource", resp, "Failure sending request")
			return
		}
...
func (client CustomImageClient) GetResource(resourceGroupName string, labName string, name string) (result CustomImage, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "devtestlabs.CustomImageClient", "GetResource", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "devtestlabs.CustomImageClient", "GetResource", resp, "Failure sending request")
		return
	}
...
func (client CustomImageClient) List(resourceGroupName string, labName string, filter string, top *int32, orderBy string) (result ResponseWithContinuationCustomImage, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "devtestlabs.CustomImageClient", "List", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "devtestlabs.CustomImageClient", "List", resp, "Failure sending request")
		return
	}
