...
// CustomImageClient is the azure DevTest Labs REST API.
...
func (client CustomImageClient) CreateOrUpdateResource(resourceGroupName string, labName string, name string, customImage CustomImage, cancel <-chan struct{}) (result autorest.Response, err error) {
	req, err := client.CreateOrUpdateResourcePreparer(resourceGroupName, labName, name, customImage, cancel)
	if err != nil {
		return result, autorest.NewErrorWithError(err, "devtestlabs.CustomImageClient", "CreateOrUpdateResource", nil, "Failure preparing request")
	}

	resp, err := client.CreateOrUpdateResourceSender(req)
	if err != nil {
		result.Response = resp
		return result, autorest.NewErrorWithError(err, "devtestlabs.CustomImageClient", "CreateOrUpdateResource", resp, "Failure sending request")
	}

	result, err = client.CreateOrUpdateResourceResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "devtestlabs.CustomImageClient", "CreateOrUpdateResource", resp, "Failure responding to request")
	}
...
func (client CustomImageClient) CreateOrUpdateResourceResponder(resp *http.Response) (result autorest.Response, err error) {
...
// resourceGroupName is the name of the resource group. labName is the name of
// the lab. name is the name of the custom image.
func (client CustomImageClient) DeleteResource(resourceGroupName string, labName string, name string, cancel <-chan struct{}) (result autorest.Response, err error) {
	req, err := client.DeleteResourcePreparer(resourceGroupName, labName, name, cancel)
	if err != nil {
		return result, autorest.NewErrorWithError(err, "devtestlabs.CustomImageClient", "DeleteResource", nil, "Failure preparing request")
	}

	resp, err := client.DeleteResourceSender(req)
	if err != nil {
		result.Response = resp
		return result, autorest.NewErrorWithError(err, "devtestlabs.CustomImageClient", "DeleteResource", resp, "Failure sending request")
	}

	result, err = client.DeleteResourceResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "devtestlabs.CustomImageClient", "DeleteResource", resp, "Failure responding to request")
	}
...
func (client CustomImageClient) GetResource(resourceGroupName string, labName string, name string) (result CustomImage, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "devtestlabs.CustomImageClient", "GetResource", nil, "Failure preparing request")
	}

	resp, err := client.GetResourceSender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "devtestlabs.CustomImageClient", "GetResource", resp, "Failure sending request")
	}

	result, err = client.GetResourceResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "devtestlabs.CustomImageClient", "GetResource", resp, "Failure responding to request")
	}
...
func (client CustomImageClient) List(resourceGroupName string, labName string, filter string, top *int32, orderBy string) (result ResponseWithContinuationCustomImage, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "devtestlabs.CustomImageClient", "List", nil, "Failure preparing request")
	}

	resp, err := client.ListSender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "devtestlabs.CustomImageClient", "List", resp, "Failure sending request")
	}

	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "devtestlabs.CustomImageClient", "List", resp, "Failure responding to request")
	}
...
func (client CustomImageClient) ListNextResults(lastResults ResponseWithContinuationCustomImage) (result ResponseWithContinuationCustomImage, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "devtestlabs.CustomImageClient", "List", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "devtestlabs.CustomImageClient", "List", resp, "Failure sending next results request")
	}

	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "devtestlabs.CustomImageClient", "List", resp, "Failure responding to next results request")
	}
