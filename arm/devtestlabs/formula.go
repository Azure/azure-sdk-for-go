...
func (client FormulaClient) CreateOrUpdateResource(resourceGroupName string, labName string, name string, formula Formula, cancel <-chan struct{}) (result autorest.Response, err error) {
	req, err := client.CreateOrUpdateResourcePreparer(resourceGroupName, labName, name, formula, cancel)
	if err != nil {
		return result, autorest.NewErrorWithError(err, "devtestlabs.FormulaClient", "CreateOrUpdateResource", nil, "Failure preparing request")
	}

	resp, err := client.CreateOrUpdateResourceSender(req)
	if err != nil {
		result.Response = resp
		return result, autorest.NewErrorWithError(err, "devtestlabs.FormulaClient", "CreateOrUpdateResource", resp, "Failure sending request")
	}
...
func (client FormulaClient) CreateOrUpdateResourceResponder(resp *http.Response) (result autorest.Response, err error) {
...
func (client FormulaClient) DeleteResource(resourceGroupName string, labName string, name string) (result autorest.Response, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "devtestlabs.FormulaClient", "DeleteResource", nil, "Failure preparing request")
	}

	resp, err := client.DeleteResourceSender(req)
	if err != nil {
		result.Response = resp
		return result, autorest.NewErrorWithError(err, "devtestlabs.FormulaClient", "DeleteResource", resp, "Failure sending request")
	}
...
func (client FormulaClient) GetResource(resourceGroupName string, labName string, name string) (result Formula, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "devtestlabs.FormulaClient", "GetResource", nil, "Failure preparing request")
	}

	resp, err := client.GetResourceSender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "devtestlabs.FormulaClient", "GetResource", resp, "Failure sending request")
	}
...
func (client FormulaClient) List(resourceGroupName string, labName string, filter string, top *int32, orderBy string) (result ResponseWithContinuationFormula, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "devtestlabs.FormulaClient", "List", nil, "Failure preparing request")
	}

	resp, err := client.ListSender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "devtestlabs.FormulaClient", "List", resp, "Failure sending request")
	}
