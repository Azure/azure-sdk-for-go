...
func (client GalleryImageClient) List(resourceGroupName string, labName string, filter string, top *int32, orderBy string) (result ResponseWithContinuationGalleryImage, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "devtestlabs.GalleryImageClient", "List", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "devtestlabs.GalleryImageClient", "List", resp, "Failure sending request")
		return
	}
