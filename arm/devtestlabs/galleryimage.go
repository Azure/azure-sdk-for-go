...
// GalleryImageClient is the azure DevTest Labs REST API.
...
func (client GalleryImageClient) List(resourceGroupName string, labName string, filter string, top *int32, orderBy string) (result ResponseWithContinuationGalleryImage, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "devtestlabs.GalleryImageClient", "List", nil, "Failure preparing request")
	}

	resp, err := client.ListSender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "devtestlabs.GalleryImageClient", "List", resp, "Failure sending request")
	}

	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "devtestlabs.GalleryImageClient", "List", resp, "Failure responding to request")
	}
...
func (client GalleryImageClient) ListNextResults(lastResults ResponseWithContinuationGalleryImage) (result ResponseWithContinuationGalleryImage, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "devtestlabs.GalleryImageClient", "List", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "devtestlabs.GalleryImageClient", "List", resp, "Failure sending next results request")
	}

	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "devtestlabs.GalleryImageClient", "List", resp, "Failure responding to next results request")
	}
