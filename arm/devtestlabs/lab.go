...
func (client LabClient) CreateEnvironment(resourceGroupName string, name string, labVirtualMachine LabVirtualMachine, cancel <-chan struct{}) (<-chan autorest.Response, <-chan error) {
	...
	go func() {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "devtestlabs.LabClient", "CreateEnvironment", nil, "Failure preparing request")
			return
		}
		...
		if err != nil {
			...
			err = autorest.NewErrorWithError(err, "devtestlabs.LabClient", "CreateEnvironment", resp, "Failure sending request")
			return
		}
...
func (client LabClient) CreateOrUpdateResource(resourceGroupName string, name string, lab Lab, cancel <-chan struct{}) (<-chan Lab, <-chan error) {
	...
	go func() {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "devtestlabs.LabClient", "CreateOrUpdateResource", nil, "Failure preparing request")
			return
		}
		...
		if err != nil {
			...
			err = autorest.NewErrorWithError(err, "devtestlabs.LabClient", "CreateOrUpdateResource", resp, "Failure sending request")
			return
		}
...
func (client LabClient) DeleteResource(resourceGroupName string, name string, cancel <-chan struct{}) (<-chan autorest.Response, <-chan error) {
	...
	go func() {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "devtestlabs.LabClient", "DeleteResource", nil, "Failure preparing request")
			return
		}
		...
		if err != nil {
			result.Response = resp
			err = autorest.NewErrorWithError(err, "devtestlabs.LabClient", "DeleteResource", resp, "Failure sending request")
			return
		}
...
func (client LabClient) GenerateUploadURI(resourceGroupName string, name string, generateUploadURIParameter GenerateUploadURIParameter) (result GenerateUploadURIResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "devtestlabs.LabClient", "GenerateUploadURI", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "devtestlabs.LabClient", "GenerateUploadURI", resp, "Failure sending request")
		return
	}
...
func (client LabClient) GetResource(resourceGroupName string, name string) (result Lab, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "devtestlabs.LabClient", "GetResource", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "devtestlabs.LabClient", "GetResource", resp, "Failure sending request")
		return
	}
...
func (client LabClient) ListByResourceGroup(resourceGroupName string, filter string, top *int32, orderBy string) (result ResponseWithContinuationLab, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "devtestlabs.LabClient", "ListByResourceGroup", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "devtestlabs.LabClient", "ListByResourceGroup", resp, "Failure sending request")
		return
	}
...
func (client LabClient) ListBySubscription(filter string, top *int32, orderBy string) (result ResponseWithContinuationLab, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "devtestlabs.LabClient", "ListBySubscription", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "devtestlabs.LabClient", "ListBySubscription", resp, "Failure sending request")
		return
	}
...
func (client LabClient) ListVhds(resourceGroupName string, name string) (result ResponseWithContinuationLabVhd, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "devtestlabs.LabClient", "ListVhds", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "devtestlabs.LabClient", "ListVhds", resp, "Failure sending request")
		return
	}
...
func (client LabClient) PatchResource(resourceGroupName string, name string, lab Lab) (result Lab, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "devtestlabs.LabClient", "PatchResource", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "devtestlabs.LabClient", "PatchResource", resp, "Failure sending request")
		return
	}
