...
// NewPoliciesClientWithAuthFile creates an instance of the PoliciesClient client.
func NewPoliciesClientWithAuthFile() (PoliciesClient, error) {
	c, err := NewWithAuthFile()
	return PoliciesClient{c}, err
}
