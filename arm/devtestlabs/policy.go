...
func (client PolicyClient) CreateOrUpdateResource(resourceGroupName string, labName string, policySetName string, name string, policy Policy) (result Policy, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "devtestlabs.PolicyClient", "CreateOrUpdateResource", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "devtestlabs.PolicyClient", "CreateOrUpdateResource", resp, "Failure sending request")
		return
	}
...
func (client PolicyClient) DeleteResource(resourceGroupName string, labName string, policySetName string, name string) (result autorest.Response, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "devtestlabs.PolicyClient", "DeleteResource", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "devtestlabs.PolicyClient", "DeleteResource", resp, "Failure sending request")
		return
	}
...
func (client PolicyClient) GetResource(resourceGroupName string, labName string, policySetName string, name string) (result Policy, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "devtestlabs.PolicyClient", "GetResource", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "devtestlabs.PolicyClient", "GetResource", resp, "Failure sending request")
		return
	}
...
func (client PolicyClient) List(resourceGroupName string, labName string, policySetName string, filter string, top *int32, orderBy string) (result ResponseWithContinuationPolicy, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "devtestlabs.PolicyClient", "List", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "devtestlabs.PolicyClient", "List", resp, "Failure sending request")
		return
	}
...
func (client PolicyClient) PatchResource(resourceGroupName string, labName string, policySetName string, name string, policy Policy) (result Policy, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "devtestlabs.PolicyClient", "PatchResource", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "devtestlabs.PolicyClient", "PatchResource", resp, "Failure sending request")
		return
	}
