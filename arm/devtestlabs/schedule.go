...
func (client ScheduleClient) CreateOrUpdateResource(resourceGroupName string, labName string, name string, schedule Schedule) (result Schedule, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "devtestlabs.ScheduleClient", "CreateOrUpdateResource", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "devtestlabs.ScheduleClient", "CreateOrUpdateResource", resp, "Failure sending request")
		return
	}
...
func (client ScheduleClient) DeleteResource(resourceGroupName string, labName string, name string) (result autorest.Response, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "devtestlabs.ScheduleClient", "DeleteResource", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "devtestlabs.ScheduleClient", "DeleteResource", resp, "Failure sending request")
		return
	}
...
func (client ScheduleClient) Execute(resourceGroupName string, labName string, name string, cancel <-chan struct{}) (<-chan autorest.Response, <-chan error) {
	...
	go func() {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "devtestlabs.ScheduleClient", "Execute", nil, "Failure preparing request")
			return
		}
		...
		if err != nil {
			result.Response = resp
			err = autorest.NewErrorWithError(err, "devtestlabs.ScheduleClient", "Execute", resp, "Failure sending request")
			return
		}
...
func (client ScheduleClient) GetResource(resourceGroupName string, labName string, name string) (result Schedule, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "devtestlabs.ScheduleClient", "GetResource", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "devtestlabs.ScheduleClient", "GetResource", resp, "Failure sending request")
		return
	}
...
func (client ScheduleClient) List(resourceGroupName string, labName string, filter string, top *int32, orderBy string) (result ResponseWithContinuationSchedule, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "devtestlabs.ScheduleClient", "List", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "devtestlabs.ScheduleClient", "List", resp, "Failure sending request")
		return
	}
...
func (client ScheduleClient) PatchResource(resourceGroupName string, labName string, name string, schedule Schedule) (result Schedule, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "devtestlabs.ScheduleClient", "PatchResource", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "devtestlabs.ScheduleClient", "PatchResource", resp, "Failure sending request")
		return
	}
