...
func (client VirtualNetworkClient) CreateOrUpdateResource(resourceGroupName string, labName string, name string, virtualNetwork VirtualNetwork, cancel <-chan struct{}) (<-chan VirtualNetwork, <-chan error) {
	...
	go func() {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "devtestlabs.VirtualNetworkClient", "CreateOrUpdateResource", nil, "Failure preparing request")
			return
		}
		...
		if err != nil {
			...
			err = autorest.NewErrorWithError(err, "devtestlabs.VirtualNetworkClient", "CreateOrUpdateResource", resp, "Failure sending request")
			return
		}
...
func (client VirtualNetworkClient) DeleteResource(resourceGroupName string, labName string, name string, cancel <-chan struct{}) (<-chan autorest.Response, <-chan error) {
	...
	go func() {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "devtestlabs.VirtualNetworkClient", "DeleteResource", nil, "Failure preparing request")
			return
		}
		...
		if err != nil {
			...
			err = autorest.NewErrorWithError(err, "devtestlabs.VirtualNetworkClient", "DeleteResource", resp, "Failure sending request")
			return
		}
...
func (client VirtualNetworkClient) GetResource(resourceGroupName string, labName string, name string) (result VirtualNetwork, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "devtestlabs.VirtualNetworkClient", "GetResource", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "devtestlabs.VirtualNetworkClient", "GetResource", resp, "Failure sending request")
		return
	}
...
func (client VirtualNetworkClient) List(resourceGroupName string, labName string, filter string, top *int32, orderBy string) (result ResponseWithContinuationVirtualNetwork, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "devtestlabs.VirtualNetworkClient", "List", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "devtestlabs.VirtualNetworkClient", "List", resp, "Failure sending request")
		return
	}
...
func (client VirtualNetworkClient) PatchResource(resourceGroupName string, labName string, name string, virtualNetwork VirtualNetwork) (result VirtualNetwork, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "devtestlabs.VirtualNetworkClient", "PatchResource", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "devtestlabs.VirtualNetworkClient", "PatchResource", resp, "Failure sending request")
		return
	}
