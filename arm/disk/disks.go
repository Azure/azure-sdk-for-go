		...
		{TargetValue: diskParameter,
			Constraints: []validation.Constraint{{Target: "diskParameter.Properties", Name: validation.Null, Rule: false,
				Chain: []validation.Constraint{{Target: "diskParameter.Properties.CreationData", Name: validation.Null, Rule: true,
					...
					{Target: "diskParameter.Properties.TimeCreated", Name: validation.ReadOnly, Rule: true, Chain: nil},
					{Target: "diskParameter.Properties.OwnerID", Name: validation.ReadOnly, Rule: true, Chain: nil},
					{Target: "diskParameter.Properties.ProvisioningState", Name: validation.ReadOnly, Rule: true, Chain: nil},
				}}}}}); err != nil {
