		...
		{TargetValue: snapshot,
			Constraints: []validation.Constraint{{Target: "snapshot.Properties", Name: validation.Null, Rule: false,
				Chain: []validation.Constraint{{Target: "snapshot.Properties.CreationData", Name: validation.Null, Rule: true,
					...
					{Target: "snapshot.Properties.TimeCreated", Name: validation.ReadOnly, Rule: true, Chain: nil},
					{Target: "snapshot.Properties.OwnerID", Name: validation.ReadOnly, Rule: true, Chain: nil},
					{Target: "snapshot.Properties.ProvisioningState", Name: validation.ReadOnly, Rule: true, Chain: nil},
				}}}}}); err != nil {
