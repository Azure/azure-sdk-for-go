...
// DNS zone is created). Possible values include: 'A', 'AAAA', 'CNAME', 'MX', 'NS', 'PTR', 'SOA', 'SRV', 'TXT'
// parameters is parameters supplied to the CreateOrUpdate operation. ifMatch is the etag of the record set. Omit this
...
// deleted). Possible values include: 'A', 'AAAA', 'CNAME', 'MX', 'NS', 'PTR', 'SOA', 'SRV', 'TXT' ifMatch is the etag
...
//
// resourceGroupName is the name of the resource group. zoneName is the name of the DNS zone (without a terminating
// dot). recordType is the type of record sets to enumerate. Possible values include: 'A', 'AAAA', 'CNAME', 'MX', 'NS',
// 'PTR', 'SOA', 'SRV', 'TXT' top is the maximum number of record sets to return. If not specified, returns up to 100
// record sets. recordsetnamesuffix is the suffix label of the record set name that has to be used to filter the record
...
// dot). relativeRecordSetName is the name of the record set, relative to the name of the zone. recordType is the type
// of DNS record in this record set. Possible values include: 'A', 'AAAA', 'CNAME', 'MX', 'NS', 'PTR', 'SOA', 'SRV',
// 'TXT' parameters is parameters supplied to the Update operation. ifMatch is the etag of the record set. Omit this
// value to always overwrite the current record set. Specify the last-seen etag value to prevent accidentally
