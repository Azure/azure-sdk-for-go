...
// namespace name. eventHubName is the Event Hub name. consumerGroupName is the
// consumer group name. parameters is parameters supplied to create a consumer
// group resource.
