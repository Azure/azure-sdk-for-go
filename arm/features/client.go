...
func (client ManagementClient) Get(resourceProviderNamespace string, featureName string) (result Result, ae error) {
...
func (client ManagementClient) GetResponder(resp *http.Response) (result Result, err error) {
...
func (client ManagementClient) List(resourceProviderNamespace string) (result OperationsListResult, ae error) {
...
// closes the http.Response Body.
func (client ManagementClient) ListResponder(resp *http.Response) (result OperationsListResult, err error) {
	err = autorest.Respond(
		resp,
		client.ByInspecting(),
		autorest.WithErrorUnlessStatusCode(http.StatusOK),
...
func (client ManagementClient) ListNextResults(lastResults OperationsListResult) (result OperationsListResult, ae error) {
...
func (client ManagementClient) ListAll() (result OperationsListResult, ae error) {
...
// closes the http.Response Body.
func (client ManagementClient) ListAllResponder(resp *http.Response) (result OperationsListResult, err error) {
	err = autorest.Respond(
		resp,
		client.ByInspecting(),
		autorest.WithErrorUnlessStatusCode(http.StatusOK),
...
func (client ManagementClient) ListAllNextResults(lastResults OperationsListResult) (result OperationsListResult, ae error) {
	req, err := lastResults.OperationsListResultPreparer()
	if err != nil {
...
// resourceProviderNamespace is namespace of the resource provider.
// featureName is previewed feature name in the resource provider.
func (client ManagementClient) Register(resourceProviderNamespace string, featureName string) (result Result, ae error) {
...
// closes the http.Response Body.
func (client ManagementClient) RegisterResponder(resp *http.Response) (result Result, err error) {
	err = autorest.Respond(
		resp,
		client.ByInspecting(),
		autorest.WithErrorUnlessStatusCode(http.StatusOK),
