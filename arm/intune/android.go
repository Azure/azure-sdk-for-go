...
func (client AndroidClient) AddAppForMAMPolicy(hostName string, policyName string, appName string, parameters MAMPolicyAppIDOrGroupIDPayload) (result autorest.Response, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "intune/AndroidClient", "AddAppForMAMPolicy", autorest.UndefinedStatusCode, "Failure preparing request")
	}

	resp, err := client.AddAppForMAMPolicySender(req)
	if err != nil {
		result.Response = resp
		return result, autorest.NewErrorWithError(err, "intune/AndroidClient", "AddAppForMAMPolicy", resp.StatusCode, "Failure sending request")
	}

	result, err = client.AddAppForMAMPolicyResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "intune/AndroidClient", "AddAppForMAMPolicy", resp.StatusCode, "Failure responding to request")
	}
...
func (client AndroidClient) AddGroupForMAMPolicy(hostName string, policyName string, groupID string, parameters MAMPolicyAppIDOrGroupIDPayload) (result autorest.Response, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "intune/AndroidClient", "AddGroupForMAMPolicy", autorest.UndefinedStatusCode, "Failure preparing request")
	}

	resp, err := client.AddGroupForMAMPolicySender(req)
	if err != nil {
		result.Response = resp
		return result, autorest.NewErrorWithError(err, "intune/AndroidClient", "AddGroupForMAMPolicy", resp.StatusCode, "Failure sending request")
	}

	result, err = client.AddGroupForMAMPolicyResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "intune/AndroidClient", "AddGroupForMAMPolicy", resp.StatusCode, "Failure responding to request")
	}
...
func (client AndroidClient) CreateOrUpdateMAMPolicy(hostName string, policyName string, parameters AndroidMAMPolicy) (result AndroidMAMPolicy, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "intune/AndroidClient", "CreateOrUpdateMAMPolicy", autorest.UndefinedStatusCode, "Failure preparing request")
	}

	resp, err := client.CreateOrUpdateMAMPolicySender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "intune/AndroidClient", "CreateOrUpdateMAMPolicy", resp.StatusCode, "Failure sending request")
	}

	result, err = client.CreateOrUpdateMAMPolicyResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "intune/AndroidClient", "CreateOrUpdateMAMPolicy", resp.StatusCode, "Failure responding to request")
	}
...
func (client AndroidClient) DeleteAppForMAMPolicy(hostName string, policyName string, appName string) (result autorest.Response, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "intune/AndroidClient", "DeleteAppForMAMPolicy", autorest.UndefinedStatusCode, "Failure preparing request")
	}

	resp, err := client.DeleteAppForMAMPolicySender(req)
	if err != nil {
		result.Response = resp
		return result, autorest.NewErrorWithError(err, "intune/AndroidClient", "DeleteAppForMAMPolicy", resp.StatusCode, "Failure sending request")
	}

	result, err = client.DeleteAppForMAMPolicyResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "intune/AndroidClient", "DeleteAppForMAMPolicy", resp.StatusCode, "Failure responding to request")
	}
...
func (client AndroidClient) DeleteGroupForMAMPolicy(hostName string, policyName string, groupID string) (result autorest.Response, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "intune/AndroidClient", "DeleteGroupForMAMPolicy", autorest.UndefinedStatusCode, "Failure preparing request")
	}

	resp, err := client.DeleteGroupForMAMPolicySender(req)
	if err != nil {
		result.Response = resp
		return result, autorest.NewErrorWithError(err, "intune/AndroidClient", "DeleteGroupForMAMPolicy", resp.StatusCode, "Failure sending request")
	}

	result, err = client.DeleteGroupForMAMPolicyResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "intune/AndroidClient", "DeleteGroupForMAMPolicy", resp.StatusCode, "Failure responding to request")
	}
...
func (client AndroidClient) DeleteMAMPolicy(hostName string, policyName string) (result autorest.Response, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "intune/AndroidClient", "DeleteMAMPolicy", autorest.UndefinedStatusCode, "Failure preparing request")
	}

	resp, err := client.DeleteMAMPolicySender(req)
	if err != nil {
		result.Response = resp
		return result, autorest.NewErrorWithError(err, "intune/AndroidClient", "DeleteMAMPolicy", resp.StatusCode, "Failure sending request")
	}

	result, err = client.DeleteMAMPolicyResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "intune/AndroidClient", "DeleteMAMPolicy", resp.StatusCode, "Failure responding to request")
	}
...
func (client AndroidClient) GetAppForMAMPolicy(hostName string, policyName string, filter string, top *int, selectParameter string) (result ApplicationCollection, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "intune/AndroidClient", "GetAppForMAMPolicy", autorest.UndefinedStatusCode, "Failure preparing request")
	}

	resp, err := client.GetAppForMAMPolicySender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "intune/AndroidClient", "GetAppForMAMPolicy", resp.StatusCode, "Failure sending request")
	}

	result, err = client.GetAppForMAMPolicyResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "intune/AndroidClient", "GetAppForMAMPolicy", resp.StatusCode, "Failure responding to request")
	}
...
func (client AndroidClient) GetAppForMAMPolicyNextResults(lastResults ApplicationCollection) (result ApplicationCollection, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "intune/AndroidClient", "GetAppForMAMPolicy", autorest.UndefinedStatusCode, "Failure preparing next results request request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "intune/AndroidClient", "GetAppForMAMPolicy", resp.StatusCode, "Failure sending next results request request")
	}

	result, err = client.GetAppForMAMPolicyResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "intune/AndroidClient", "GetAppForMAMPolicy", resp.StatusCode, "Failure responding to next results request request")
	}
...
func (client AndroidClient) GetGroupsForMAMPolicy(hostName string, policyName string) (result GroupsCollection, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "intune/AndroidClient", "GetGroupsForMAMPolicy", autorest.UndefinedStatusCode, "Failure preparing request")
	}

	resp, err := client.GetGroupsForMAMPolicySender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "intune/AndroidClient", "GetGroupsForMAMPolicy", resp.StatusCode, "Failure sending request")
	}

	result, err = client.GetGroupsForMAMPolicyResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "intune/AndroidClient", "GetGroupsForMAMPolicy", resp.StatusCode, "Failure responding to request")
	}
...
func (client AndroidClient) GetGroupsForMAMPolicyNextResults(lastResults GroupsCollection) (result GroupsCollection, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "intune/AndroidClient", "GetGroupsForMAMPolicy", autorest.UndefinedStatusCode, "Failure preparing next results request request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "intune/AndroidClient", "GetGroupsForMAMPolicy", resp.StatusCode, "Failure sending next results request request")
	}

	result, err = client.GetGroupsForMAMPolicyResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "intune/AndroidClient", "GetGroupsForMAMPolicy", resp.StatusCode, "Failure responding to next results request request")
	}
...
func (client AndroidClient) GetMAMPolicies(hostName string, filter string, top *int, selectParameter string) (result AndroidMAMPolicyCollection, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "intune/AndroidClient", "GetMAMPolicies", autorest.UndefinedStatusCode, "Failure preparing request")
	}

	resp, err := client.GetMAMPoliciesSender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "intune/AndroidClient", "GetMAMPolicies", resp.StatusCode, "Failure sending request")
	}

	result, err = client.GetMAMPoliciesResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "intune/AndroidClient", "GetMAMPolicies", resp.StatusCode, "Failure responding to request")
	}
...
func (client AndroidClient) GetMAMPoliciesNextResults(lastResults AndroidMAMPolicyCollection) (result AndroidMAMPolicyCollection, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "intune/AndroidClient", "GetMAMPolicies", autorest.UndefinedStatusCode, "Failure preparing next results request request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "intune/AndroidClient", "GetMAMPolicies", resp.StatusCode, "Failure sending next results request request")
	}

	result, err = client.GetMAMPoliciesResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "intune/AndroidClient", "GetMAMPolicies", resp.StatusCode, "Failure responding to next results request request")
	}
...
func (client AndroidClient) GetMAMPolicyByName(hostName string, policyName string, selectParameter string) (result AndroidMAMPolicy, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "intune/AndroidClient", "GetMAMPolicyByName", autorest.UndefinedStatusCode, "Failure preparing request")
	}

	resp, err := client.GetMAMPolicyByNameSender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "intune/AndroidClient", "GetMAMPolicyByName", resp.StatusCode, "Failure sending request")
	}

	result, err = client.GetMAMPolicyByNameResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "intune/AndroidClient", "GetMAMPolicyByName", resp.StatusCode, "Failure responding to request")
	}
...
func (client AndroidClient) PatchMAMPolicy(hostName string, policyName string, parameters AndroidMAMPolicy) (result AndroidMAMPolicy, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "intune/AndroidClient", "PatchMAMPolicy", autorest.UndefinedStatusCode, "Failure preparing request")
	}

	resp, err := client.PatchMAMPolicySender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "intune/AndroidClient", "PatchMAMPolicy", resp.StatusCode, "Failure sending request")
	}

	result, err = client.PatchMAMPolicyResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "intune/AndroidClient", "PatchMAMPolicy", resp.StatusCode, "Failure responding to request")
	}
