			...
			Constraints: []validation.Constraint{{Target: "iotHubDescription.Subscriptionid", Name: validation.Null, Rule: true, Chain: nil},
				...
				{Target: "iotHubDescription.Properties", Name: validation.Null, Rule: false,
					Chain: []validation.Constraint{{Target: "iotHubDescription.Properties.CloudToDevice", Name: validation.Null, Rule: false,
						...
						{Target: "iotHubDescription.Properties.ProvisioningState", Name: validation.ReadOnly, Rule: true, Chain: nil},
						{Target: "iotHubDescription.Properties.HostName", Name: validation.ReadOnly, Rule: true, Chain: nil},
					}},
				{Target: "iotHubDescription.Sku", Name: validation.Null, Rule: true,
					Chain: []validation.Constraint{{Target: "iotHubDescription.Sku.Capacity", Name: validation.Null, Rule: true, Chain: nil},
						{Target: "iotHubDescription.Sku.Tier", Name: validation.ReadOnly, Rule: true, Chain: nil},
					}}}}}); err != nil {
