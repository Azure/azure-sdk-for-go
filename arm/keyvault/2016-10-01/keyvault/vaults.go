...
//
// vaultName is the name of the vault. location is the location of the deleted
// vault.
...
// PurgeDeleted permanently deletes the specified vault. aka Purges the deleted
// Azure key vault. This method may poll for completion. Polling can be
// canceled by passing the cancel channel argument. The channel will be used to
// cancel polling and any outstanding HTTP requests.
//
// vaultName is the name of the soft-deleted vault. location is the location of
// the soft-deleted vault.
