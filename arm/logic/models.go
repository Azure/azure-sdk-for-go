...
type Workflow struct {
	...
	Properties struct {
		CreatedTime    date.DateTime `json:"createdTime,omitempty"`
		ChangedTime    date.DateTime `json:"changedTime,omitempty"`
...
type WorkflowAccessKey struct {
	Id         string `json:"id,omitempty"`
	Properties struct {
		NotBefore date.DateTime `json:"notBefore,omitempty"`
		NotAfter  date.DateTime `json:"notAfter,omitempty"`
	} `json:"properties,omitempty"`
	Name string `json:"name,omitempty"`
	Type string `json:"type,omitempty"`
}
