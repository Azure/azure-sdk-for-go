...
func (client WorkflowsClient) CreateOrUpdate(resourceGroupName string, workflowName string, workflow Workflow) (result Workflow, err error) {
	if err := validation.Validate([]validation.Validation{
		{workflow,
			[]validation.Constraint{{"workflow.Properties", validation.Null, false,
				[]validation.Constraint{{"workflow.Properties.Sku", validation.Null, false,
					[]validation.Constraint{{"workflow.Properties.Sku.Plan", validation.Null, false,
						[]validation.Constraint{{"Name", validation.ReadOnly, true, nil},
							{"Type", validation.ReadOnly, true, nil},
						}},
					}},
					{"workflow.Properties.IntegrationAccount", validation.Null, false,
						[]validation.Constraint{{"Name", validation.ReadOnly, true, nil},
							{"Type", validation.ReadOnly, true, nil},
						}},
					{"ProvisioningState", validation.ReadOnly, true, nil},
					{"CreatedTime", validation.ReadOnly, true, nil},
					{"ChangedTime", validation.ReadOnly, true, nil},
					{"Version", validation.ReadOnly, true, nil},
					{"AccessEndpoint", validation.ReadOnly, true, nil},
				}}}}}); err != nil {
