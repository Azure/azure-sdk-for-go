...
// NewWorkflowsClientWithAuthFile creates an instance of the WorkflowsClient client.
func NewWorkflowsClientWithAuthFile() (WorkflowsClient, error) {
	c, err := NewWithAuthFile()
	return WorkflowsClient{c}, err
}
