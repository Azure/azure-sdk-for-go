...
func (client WorkflowsClient) CreateOrUpdate(resourceGroupName string, workflowName string, workflow Workflow) (result Workflow, err error) {
	if err := validation.Validate([]validation.Validation{
		{TargetValue: workflow,
			Constraints: []validation.Constraint{{Target: "workflow.WorkflowProperties", Name: validation.Null, Rule: false,
				Chain: []validation.Constraint{{Target: "workflow.WorkflowProperties.Sku", Name: validation.Null, Rule: false,
					Chain: []validation.Constraint{{Target: "workflow.WorkflowProperties.Sku.Plan", Name: validation.Null, Rule: false,
						Chain: []validation.Constraint{{Target: "workflow.WorkflowProperties.Sku.Plan.Name", Name: validation.ReadOnly, Rule: true, Chain: nil},
							{Target: "workflow.WorkflowProperties.Sku.Plan.Type", Name: validation.ReadOnly, Rule: true, Chain: nil},
						}},
					}},
					{Target: "workflow.WorkflowProperties.IntegrationAccount", Name: validation.Null, Rule: false,
						Chain: []validation.Constraint{{Target: "workflow.WorkflowProperties.IntegrationAccount.Name", Name: validation.ReadOnly, Rule: true, Chain: nil},
							{Target: "workflow.WorkflowProperties.IntegrationAccount.Type", Name: validation.ReadOnly, Rule: true, Chain: nil},
						}},
					{Target: "workflow.WorkflowProperties.ProvisioningState", Name: validation.ReadOnly, Rule: true, Chain: nil},
					{Target: "workflow.WorkflowProperties.CreatedTime", Name: validation.ReadOnly, Rule: true, Chain: nil},
					{Target: "workflow.WorkflowProperties.ChangedTime", Name: validation.ReadOnly, Rule: true, Chain: nil},
					{Target: "workflow.WorkflowProperties.Version", Name: validation.ReadOnly, Rule: true, Chain: nil},
					{Target: "workflow.WorkflowProperties.AccessEndpoint", Name: validation.ReadOnly, Rule: true, Chain: nil},
				}}}}}); err != nil {
