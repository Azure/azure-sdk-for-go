...
func (client WorkflowsClient) CreateOrUpdate(resourceGroupName string, workflowName string, workflow Workflow) (result Workflow, err error) {
	if err := validation.Validate([]validation.Validation{
		{TargetValue: workflow,
			Constraints: []validation.Constraint{{Target: "workflow.Properties", Name: validation.Null, Rule: false,
				Chain: []validation.Constraint{{Target: "workflow.Properties.Sku", Name: validation.Null, Rule: false,
					Chain: []validation.Constraint{{Target: "workflow.Properties.Sku.Plan", Name: validation.Null, Rule: false,
						Chain: []validation.Constraint{{Target: "workflow.Properties.Sku.Plan.Name", Name: validation.ReadOnly, Rule: true, Chain: nil},
							{Target: "workflow.Properties.Sku.Plan.Type", Name: validation.ReadOnly, Rule: true, Chain: nil},
						}},
					}},
					{Target: "workflow.Properties.IntegrationAccount", Name: validation.Null, Rule: false,
						Chain: []validation.Constraint{{Target: "workflow.Properties.IntegrationAccount.Name", Name: validation.ReadOnly, Rule: true, Chain: nil},
							{Target: "workflow.Properties.IntegrationAccount.Type", Name: validation.ReadOnly, Rule: true, Chain: nil},
						}},
					{Target: "workflow.Properties.ProvisioningState", Name: validation.ReadOnly, Rule: true, Chain: nil},
					{Target: "workflow.Properties.CreatedTime", Name: validation.ReadOnly, Rule: true, Chain: nil},
					{Target: "workflow.Properties.ChangedTime", Name: validation.ReadOnly, Rule: true, Chain: nil},
					{Target: "workflow.Properties.Version", Name: validation.ReadOnly, Rule: true, Chain: nil},
					{Target: "workflow.Properties.AccessEndpoint", Name: validation.ReadOnly, Rule: true, Chain: nil},
				}}}}}); err != nil {
