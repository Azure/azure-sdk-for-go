...
// ActivityLogAlertsClient is the client for the ActivityLogAlerts methods of
// the Activitylogalertsapi service.
type ActivityLogAlertsClient struct {
	ManagementClient
}

// NewActivityLogAlertsClient creates an instance of the
// ActivityLogAlertsClient client.
...
// NewActivityLogAlertsClientWithBaseURI creates an instance of the
// ActivityLogAlertsClient client.
...
//
// resourceGroupName is the name of the resource group. activityLogAlertName is
// the name of the activity log alert. activityLogAlert is the activity log
// alert to create or use for the update.
func (client ActivityLogAlertsClient) CreateOrUpdate(resourceGroupName string, activityLogAlertName string, activityLogAlert ActivityLogAlertResource) (result ActivityLogAlertResource, err error) {
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewErrorWithValidationError(err, "activitylogalertsapi.ActivityLogAlertsClient", "CreateOrUpdate")
	}

	req, err := client.CreateOrUpdatePreparer(resourceGroupName, activityLogAlertName, activityLogAlert)
	if err != nil {
		err = autorest.NewErrorWithError(err, "activitylogalertsapi.ActivityLogAlertsClient", "CreateOrUpdate", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "activitylogalertsapi.ActivityLogAlertsClient", "CreateOrUpdate", resp, "Failure sending request")
		return
	}

	result, err = client.CreateOrUpdateResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "activitylogalertsapi.ActivityLogAlertsClient", "CreateOrUpdate", resp, "Failure responding to request")
	}
...
func (client ActivityLogAlertsClient) Delete(resourceGroupName string, activityLogAlertName string) (result autorest.Response, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "activitylogalertsapi.ActivityLogAlertsClient", "Delete", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "activitylogalertsapi.ActivityLogAlertsClient", "Delete", resp, "Failure sending request")
		return
	}

	result, err = client.DeleteResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "activitylogalertsapi.ActivityLogAlertsClient", "Delete", resp, "Failure responding to request")
	}
...
func (client ActivityLogAlertsClient) Get(resourceGroupName string, activityLogAlertName string) (result ActivityLogAlertResource, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "activitylogalertsapi.ActivityLogAlertsClient", "Get", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "activitylogalertsapi.ActivityLogAlertsClient", "Get", resp, "Failure sending request")
		return
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "activitylogalertsapi.ActivityLogAlertsClient", "Get", resp, "Failure responding to request")
	}
...
// ListByResourceGroup get a list of all activity log alerts in a resource
// group.
//
...
func (client ActivityLogAlertsClient) ListByResourceGroup(resourceGroupName string) (result ActivityLogAlertList, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "activitylogalertsapi.ActivityLogAlertsClient", "ListByResourceGroup", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "activitylogalertsapi.ActivityLogAlertsClient", "ListByResourceGroup", resp, "Failure sending request")
		return
	}

	result, err = client.ListByResourceGroupResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "activitylogalertsapi.ActivityLogAlertsClient", "ListByResourceGroup", resp, "Failure responding to request")
	}
...
// ListBySubscriptionID get a list of all activity log alerts in a
// subscription.
func (client ActivityLogAlertsClient) ListBySubscriptionID() (result ActivityLogAlertList, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "activitylogalertsapi.ActivityLogAlertsClient", "ListBySubscriptionID", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "activitylogalertsapi.ActivityLogAlertsClient", "ListBySubscriptionID", resp, "Failure sending request")
		return
	}

	result, err = client.ListBySubscriptionIDResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "activitylogalertsapi.ActivityLogAlertsClient", "ListBySubscriptionID", resp, "Failure responding to request")
	}
...
//
// resourceGroupName is the name of the resource group. activityLogAlertName is
// the name of the activity log alert. activityLogAlertPatch is parameters
// supplied to the operation.
func (client ActivityLogAlertsClient) Update(resourceGroupName string, activityLogAlertName string, activityLogAlertPatch ActivityLogAlertResourcePatch) (result ActivityLogAlertResource, err error) {
	req, err := client.UpdatePreparer(resourceGroupName, activityLogAlertName, activityLogAlertPatch)
	if err != nil {
		err = autorest.NewErrorWithError(err, "activitylogalertsapi.ActivityLogAlertsClient", "Update", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "activitylogalertsapi.ActivityLogAlertsClient", "Update", resp, "Failure sending request")
		return
	}

	result, err = client.UpdateResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "activitylogalertsapi.ActivityLogAlertsClient", "Update", resp, "Failure responding to request")
	}
...
func (client ActivityLogAlertsClient) UpdatePreparer(resourceGroupName string, activityLogAlertName string, activityLogAlertPatch ActivityLogAlertResourcePatch) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"activityLogAlertName": autorest.Encode("path", activityLogAlertName),
		"resourceGroupName":    autorest.Encode("path", resourceGroupName),
		"subscriptionId":       autorest.Encode("path", client.SubscriptionID),
