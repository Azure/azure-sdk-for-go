...
// ActionGroupsClient is the client for the ActionGroups methods of the
// Actiongroupsapi service.
...
// NewActionGroupsClientWithBaseURI creates an instance of the
// ActionGroupsClient client.
...
//
// resourceGroupName is the name of the resource group. actionGroupName is the
// name of the action group. actionGroup is the action group to create or use
// for the update.
func (client ActionGroupsClient) CreateOrUpdate(resourceGroupName string, actionGroupName string, actionGroup ActionGroupResource) (result ActionGroupResource, err error) {
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewErrorWithValidationError(err, "actiongroupsapi.ActionGroupsClient", "CreateOrUpdate")
	}

	req, err := client.CreateOrUpdatePreparer(resourceGroupName, actionGroupName, actionGroup)
	if err != nil {
		err = autorest.NewErrorWithError(err, "actiongroupsapi.ActionGroupsClient", "CreateOrUpdate", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "actiongroupsapi.ActionGroupsClient", "CreateOrUpdate", resp, "Failure sending request")
		return
	}

	result, err = client.CreateOrUpdateResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "actiongroupsapi.ActionGroupsClient", "CreateOrUpdate", resp, "Failure responding to request")
	}
...
func (client ActionGroupsClient) Delete(resourceGroupName string, actionGroupName string) (result autorest.Response, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "actiongroupsapi.ActionGroupsClient", "Delete", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "actiongroupsapi.ActionGroupsClient", "Delete", resp, "Failure sending request")
		return
	}

	result, err = client.DeleteResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "actiongroupsapi.ActionGroupsClient", "Delete", resp, "Failure responding to request")
	}
...
// EnableReceiver enable a receiver in an action group. This changes the
// receiver's status from Disabled to Enabled.
//
// resourceGroupName is the name of the resource group. actionGroupName is the
// name of the action group. enableRequest is the receiver to re-enable.
func (client ActionGroupsClient) EnableReceiver(resourceGroupName string, actionGroupName string, enableRequest EnableRequest) (result autorest.Response, err error) {
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewErrorWithValidationError(err, "actiongroupsapi.ActionGroupsClient", "EnableReceiver")
	}

	req, err := client.EnableReceiverPreparer(resourceGroupName, actionGroupName, enableRequest)
	if err != nil {
		err = autorest.NewErrorWithError(err, "actiongroupsapi.ActionGroupsClient", "EnableReceiver", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = resp
		err = autorest.NewErrorWithError(err, "actiongroupsapi.ActionGroupsClient", "EnableReceiver", resp, "Failure sending request")
		return
	}

	result, err = client.EnableReceiverResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "actiongroupsapi.ActionGroupsClient", "EnableReceiver", resp, "Failure responding to request")
	}
...
func (client ActionGroupsClient) EnableReceiverResponder(resp *http.Response) (result autorest.Response, err error) {
	err = autorest.Respond(
		resp,
		client.ByInspecting(),
		azure.WithErrorUnlessStatusCode(http.StatusOK, http.StatusConflict, http.StatusNotFound),
		autorest.ByClosing())
	result.Response = resp
	return
}
...
func (client ActionGroupsClient) Get(resourceGroupName string, actionGroupName string) (result ActionGroupResource, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "actiongroupsapi.ActionGroupsClient", "Get", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "actiongroupsapi.ActionGroupsClient", "Get", resp, "Failure sending request")
		return
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "actiongroupsapi.ActionGroupsClient", "Get", resp, "Failure responding to request")
	}
...
func (client ActionGroupsClient) ListByResourceGroup(resourceGroupName string) (result ActionGroupList, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "actiongroupsapi.ActionGroupsClient", "ListByResourceGroup", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "actiongroupsapi.ActionGroupsClient", "ListByResourceGroup", resp, "Failure sending request")
		return
	}

	result, err = client.ListByResourceGroupResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "actiongroupsapi.ActionGroupsClient", "ListByResourceGroup", resp, "Failure responding to request")
	}
...
func (client ActionGroupsClient) ListBySubscriptionID() (result ActionGroupList, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "actiongroupsapi.ActionGroupsClient", "ListBySubscriptionID", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "actiongroupsapi.ActionGroupsClient", "ListBySubscriptionID", resp, "Failure sending request")
		return
	}

	result, err = client.ListBySubscriptionIDResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "actiongroupsapi.ActionGroupsClient", "ListBySubscriptionID", resp, "Failure responding to request")
	}
