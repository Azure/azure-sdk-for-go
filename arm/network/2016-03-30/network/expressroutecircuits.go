...
// ExpressRouteCircuitsClient is the the Microsoft Azure Network management API
...
// of the circuit. parameters is parameters supplied to the create/delete
...
// GetPeeringStats the Liststats ExpressRouteCircuit opertion retrieves all the
// stats from a ExpressRouteCircuits in a resource group.
//
// resourceGroupName is the name of the resource group. circuitName is the name
// of the circuit. peeringName is the name of the peering.
...
// the currently advertised arp table associated with the ExpressRouteCircuits
// in a resource group. This method may poll for completion. Polling can be
// canceled by passing the cancel channel argument. The channel will be used to
// cancel polling and any outstanding HTTP requests.
//
// resourceGroupName is the name of the resource group. circuitName is the name
// of the circuit. peeringName is the name of the peering. devicePath is the
// path of the device.
...
// ListRoutesTableSummary the ListRoutesTable from ExpressRouteCircuit opertion
// retrieves the currently advertised routes table associated with the
// ExpressRouteCircuits in a resource group. This method may poll for
// completion. Polling can be canceled by passing the cancel channel argument.
// The channel will be used to cancel polling and any outstanding HTTP
