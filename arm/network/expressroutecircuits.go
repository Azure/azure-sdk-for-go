...
// NewExpressRouteCircuitsClientWithAuthFile creates an instance of the ExpressRouteCircuitsClient client.
func NewExpressRouteCircuitsClientWithAuthFile() (ExpressRouteCircuitsClient, error) {
	c, err := NewWithAuthFile()
	return ExpressRouteCircuitsClient{c}, err
}
