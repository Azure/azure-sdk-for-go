	...
	if err := validation.Validate([]validation.Validation{
		{TargetValue: parameters,
			Constraints: []validation.Constraint{{Target: "parameters.Properties", Name: validation.Null, Rule: true,
				Chain: []validation.Constraint{{Target: "parameters.Properties.VirtualNetworkGateway1", Name: validation.Null, Rule: true,
					Chain: []validation.Constraint{{Target: "parameters.Properties.VirtualNetworkGateway1.Properties", Name: validation.Null, Rule: true,
						Chain: []validation.Constraint{{Target: "parameters.Properties.VirtualNetworkGateway1.Properties.IPConfigurations", Name: validation.Null, Rule: true, Chain: nil},
							{Target: "parameters.Properties.VirtualNetworkGateway1.Properties.ProvisioningState", Name: validation.ReadOnly, Rule: true, Chain: nil},
						}},
					}},
					{Target: "parameters.Properties.VirtualNetworkGateway2", Name: validation.Null, Rule: false,
						Chain: []validation.Constraint{{Target: "parameters.Properties.VirtualNetworkGateway2.Properties", Name: validation.Null, Rule: true,
							Chain: []validation.Constraint{{Target: "parameters.Properties.VirtualNetworkGateway2.Properties.IPConfigurations", Name: validation.Null, Rule: true, Chain: nil},
								{Target: "parameters.Properties.VirtualNetworkGateway2.Properties.ProvisioningState", Name: validation.ReadOnly, Rule: true, Chain: nil},
							}},
						}},
					{Target: "parameters.Properties.LocalNetworkGateway2", Name: validation.Null, Rule: false,
						Chain: []validation.Constraint{{Target: "parameters.Properties.LocalNetworkGateway2.Properties", Name: validation.Null, Rule: true,
							Chain: []validation.Constraint{{Target: "parameters.Properties.LocalNetworkGateway2.Properties.LocalNetworkAddressSpace", Name: validation.Null, Rule: true, Chain: nil},
								{Target: "parameters.Properties.LocalNetworkGateway2.Properties.ProvisioningState", Name: validation.ReadOnly, Rule: true, Chain: nil},
							}},
						}},
					{Target: "parameters.Properties.ConnectionStatus", Name: validation.ReadOnly, Rule: true, Chain: nil},
					{Target: "parameters.Properties.TunnelConnectionStatus", Name: validation.ReadOnly, Rule: true, Chain: nil},
					{Target: "parameters.Properties.EgressBytesTransferred", Name: validation.ReadOnly, Rule: true, Chain: nil},
					{Target: "parameters.Properties.IngressBytesTransferred", Name: validation.ReadOnly, Rule: true, Chain: nil},
