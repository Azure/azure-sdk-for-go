...
func (client NamespacesClient) CheckAvailability(parameters CheckAvailabilityParameters) (result CheckAvailabilityResource, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "notificationhubs/NamespacesClient", "CheckAvailability", autorest.UndefinedStatusCode, "Failure preparing request")
	}

	resp, err := client.CheckAvailabilitySender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "notificationhubs/NamespacesClient", "CheckAvailability", resp.StatusCode, "Failure sending request")
	}

	result, err = client.CheckAvailabilityResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "notificationhubs/NamespacesClient", "CheckAvailability", resp.StatusCode, "Failure responding to request")
	}
...
func (client NamespacesClient) CreateOrUpdate(resourceGroupName string, namespaceName string, parameters NamespaceCreateOrUpdateParameters) (result NamespaceResource, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "notificationhubs/NamespacesClient", "CreateOrUpdate", autorest.UndefinedStatusCode, "Failure preparing request")
	}

	resp, err := client.CreateOrUpdateSender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "notificationhubs/NamespacesClient", "CreateOrUpdate", resp.StatusCode, "Failure sending request")
	}

	result, err = client.CreateOrUpdateResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "notificationhubs/NamespacesClient", "CreateOrUpdate", resp.StatusCode, "Failure responding to request")
	}
...
func (client NamespacesClient) CreateOrUpdateAuthorizationRule(resourceGroupName string, namespaceName string, authorizationRuleName string, parameters SharedAccessAuthorizationRuleCreateOrUpdateParameters) (result SharedAccessAuthorizationRuleResource, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "notificationhubs/NamespacesClient", "CreateOrUpdateAuthorizationRule", autorest.UndefinedStatusCode, "Failure preparing request")
	}

	resp, err := client.CreateOrUpdateAuthorizationRuleSender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "notificationhubs/NamespacesClient", "CreateOrUpdateAuthorizationRule", resp.StatusCode, "Failure sending request")
	}

	result, err = client.CreateOrUpdateAuthorizationRuleResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "notificationhubs/NamespacesClient", "CreateOrUpdateAuthorizationRule", resp.StatusCode, "Failure responding to request")
	}
...
func (client NamespacesClient) Delete(resourceGroupName string, namespaceName string) (result autorest.Response, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "notificationhubs/NamespacesClient", "Delete", autorest.UndefinedStatusCode, "Failure preparing request")
	}

	resp, err := client.DeleteSender(req)
	if err != nil {
		result.Response = resp
		return result, autorest.NewErrorWithError(err, "notificationhubs/NamespacesClient", "Delete", resp.StatusCode, "Failure sending request")
	}

	result, err = client.DeleteResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "notificationhubs/NamespacesClient", "Delete", resp.StatusCode, "Failure responding to request")
	}
...
func (client NamespacesClient) DeleteAuthorizationRule(resourceGroupName string, namespaceName string, authorizationRuleName string) (result autorest.Response, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "notificationhubs/NamespacesClient", "DeleteAuthorizationRule", autorest.UndefinedStatusCode, "Failure preparing request")
	}

	resp, err := client.DeleteAuthorizationRuleSender(req)
	if err != nil {
		result.Response = resp
		return result, autorest.NewErrorWithError(err, "notificationhubs/NamespacesClient", "DeleteAuthorizationRule", resp.StatusCode, "Failure sending request")
	}

	result, err = client.DeleteAuthorizationRuleResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "notificationhubs/NamespacesClient", "DeleteAuthorizationRule", resp.StatusCode, "Failure responding to request")
	}
...
func (client NamespacesClient) Get(resourceGroupName string, namespaceName string) (result NamespaceResource, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "notificationhubs/NamespacesClient", "Get", autorest.UndefinedStatusCode, "Failure preparing request")
	}

	resp, err := client.GetSender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "notificationhubs/NamespacesClient", "Get", resp.StatusCode, "Failure sending request")
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "notificationhubs/NamespacesClient", "Get", resp.StatusCode, "Failure responding to request")
	}
...
func (client NamespacesClient) GetAuthorizationRule(resourceGroupName string, namespaceName string, authorizationRuleName string) (result SharedAccessAuthorizationRuleResource, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "notificationhubs/NamespacesClient", "GetAuthorizationRule", autorest.UndefinedStatusCode, "Failure preparing request")
	}

	resp, err := client.GetAuthorizationRuleSender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "notificationhubs/NamespacesClient", "GetAuthorizationRule", resp.StatusCode, "Failure sending request")
	}

	result, err = client.GetAuthorizationRuleResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "notificationhubs/NamespacesClient", "GetAuthorizationRule", resp.StatusCode, "Failure responding to request")
	}
...
func (client NamespacesClient) GetLongRunningOperationStatus(operationStatusLink string) (result autorest.Response, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "notificationhubs/NamespacesClient", "GetLongRunningOperationStatus", autorest.UndefinedStatusCode, "Failure preparing request")
	}

	resp, err := client.GetLongRunningOperationStatusSender(req)
	if err != nil {
		result.Response = resp
		return result, autorest.NewErrorWithError(err, "notificationhubs/NamespacesClient", "GetLongRunningOperationStatus", resp.StatusCode, "Failure sending request")
	}

	result, err = client.GetLongRunningOperationStatusResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "notificationhubs/NamespacesClient", "GetLongRunningOperationStatus", resp.StatusCode, "Failure responding to request")
	}
...
func (client NamespacesClient) GetLongRunningOperationStatusSender(req *http.Request) (*http.Response, error) {
	return client.Send(req, http.StatusNotFound, http.StatusAccepted, http.StatusOK)
}
...
func (client NamespacesClient) List(resourceGroupName string) (result NamespaceListResult, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "notificationhubs/NamespacesClient", "List", autorest.UndefinedStatusCode, "Failure preparing request")
	}

	resp, err := client.ListSender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "notificationhubs/NamespacesClient", "List", resp.StatusCode, "Failure sending request")
	}

	result, err = client.ListResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "notificationhubs/NamespacesClient", "List", resp.StatusCode, "Failure responding to request")
	}
...
func (client NamespacesClient) ListNextResults(lastResults NamespaceListResult) (result NamespaceListResult, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "notificationhubs/NamespacesClient", "List", autorest.UndefinedStatusCode, "Failure preparing next results request request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "notificationhubs/NamespacesClient", "List", resp.StatusCode, "Failure sending next results request request")
	}

	result, err = client.ListResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "notificationhubs/NamespacesClient", "List", resp.StatusCode, "Failure responding to next results request request")
	}
...
func (client NamespacesClient) ListAll() (result NamespaceListResult, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "notificationhubs/NamespacesClient", "ListAll", autorest.UndefinedStatusCode, "Failure preparing request")
	}

	resp, err := client.ListAllSender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "notificationhubs/NamespacesClient", "ListAll", resp.StatusCode, "Failure sending request")
	}

	result, err = client.ListAllResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "notificationhubs/NamespacesClient", "ListAll", resp.StatusCode, "Failure responding to request")
	}
...
func (client NamespacesClient) ListAllNextResults(lastResults NamespaceListResult) (result NamespaceListResult, ae error) {
	req, err := lastResults.NamespaceListResultPreparer()
	if err != nil {
		return result, autorest.NewErrorWithError(err, "notificationhubs/NamespacesClient", "ListAll", autorest.UndefinedStatusCode, "Failure preparing next results request request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "notificationhubs/NamespacesClient", "ListAll", resp.StatusCode, "Failure sending next results request request")
	}

	result, err = client.ListAllResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "notificationhubs/NamespacesClient", "ListAll", resp.StatusCode, "Failure responding to next results request request")
	}
...
func (client NamespacesClient) ListAuthorizationRules(resourceGroupName string, namespaceName string) (result SharedAccessAuthorizationRuleListResult, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "notificationhubs/NamespacesClient", "ListAuthorizationRules", autorest.UndefinedStatusCode, "Failure preparing request")
	}

	resp, err := client.ListAuthorizationRulesSender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "notificationhubs/NamespacesClient", "ListAuthorizationRules", resp.StatusCode, "Failure sending request")
	}

	result, err = client.ListAuthorizationRulesResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "notificationhubs/NamespacesClient", "ListAuthorizationRules", resp.StatusCode, "Failure responding to request")
	}
...
func (client NamespacesClient) ListAuthorizationRulesNextResults(lastResults SharedAccessAuthorizationRuleListResult) (result SharedAccessAuthorizationRuleListResult, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "notificationhubs/NamespacesClient", "ListAuthorizationRules", autorest.UndefinedStatusCode, "Failure preparing next results request request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "notificationhubs/NamespacesClient", "ListAuthorizationRules", resp.StatusCode, "Failure sending next results request request")
	}

	result, err = client.ListAuthorizationRulesResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "notificationhubs/NamespacesClient", "ListAuthorizationRules", resp.StatusCode, "Failure responding to next results request request")
	}
...
func (client NamespacesClient) ListKeys(resourceGroupName string, namespaceName string, authorizationRuleName string) (result ResourceListKeys, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "notificationhubs/NamespacesClient", "ListKeys", autorest.UndefinedStatusCode, "Failure preparing request")
	}

	resp, err := client.ListKeysSender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "notificationhubs/NamespacesClient", "ListKeys", resp.StatusCode, "Failure sending request")
	}

	result, err = client.ListKeysResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "notificationhubs/NamespacesClient", "ListKeys", resp.StatusCode, "Failure responding to request")
	}
