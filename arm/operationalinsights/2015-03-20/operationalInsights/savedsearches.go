...
// SavedSearchesClient is the azure Log Analytics API reference for
// LinkTargets, StorageInsightConfigs and SavedSearches.
type SavedSearchesClient struct {
	ManagementClient
}

// NewSavedSearchesClient creates an instance of the SavedSearchesClient
// client.
...
// NewSavedSearchesClientWithBaseURI creates an instance of the
// SavedSearchesClient client.
...
// insensitive. workspaceName is log Analytics workspace name savedSearchName
// is the id of the saved search. parameters is the parameters required to save
// a search.
...
// resourceGroupName is the name of the resource group to get. The name is case
// insensitive. workspaceName is log Analytics workspace name savedSearchName
// is the name of the saved search.
...
//
// resourceGroupName is the name of the resource group to get. The name is case
// insensitive. workspaceName is log Analytics workspace name
