...
// StorageInsightsClient is the azure Log Analytics API reference for
// LinkTargets, StorageInsightConfigs and SavedSearches.
type StorageInsightsClient struct {
	ManagementClient
}

// NewStorageInsightsClient creates an instance of the StorageInsightsClient
// client.
...
// NewStorageInsightsClientWithBaseURI creates an instance of the
// StorageInsightsClient client.
...
// insensitive. workspaceName is log Analytics Workspace name that will contain
// the storageInsightsConfigs resource storageInsightName is name of the
// storageInsightsConfigs resource parameters is the parameters required to
...
//
// resourceGroupName is the name of the resource group to get. The name is case
// insensitive. workspaceName is log Analytics Workspace name that contains the
// storageInsightsConfigs resource storageInsightName is name of the
