...
func (client OperationsClient) List(resourceGroupName string) (result ClientDiscoveryResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "registeredidentities.OperationsClient", "List", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "registeredidentities.OperationsClient", "List", resp, "Failure sending request")
		return
	}

	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "registeredidentities.OperationsClient", "List", resp, "Failure responding to request")
	}
...
func (client OperationsClient) ListNextResults(lastResults ClientDiscoveryResponse) (result ClientDiscoveryResponse, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "registeredidentities.OperationsClient", "List", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "registeredidentities.OperationsClient", "List", resp, "Failure sending next results request")
	}

	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "registeredidentities.OperationsClient", "List", resp, "Failure responding to next results request")
	}
