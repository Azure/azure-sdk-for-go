...
// Trigger triggers the backup job for the specified backup item. This is an
...
// the name of backup item used in this POST operation. resourceBackupRequest
// is the resource backup request.
func (client BackupsClient) Trigger(vaultName string, resourceGroupName string, fabricName string, containerName string, protectedItemName string, resourceBackupRequest BackupRequestResource) (result autorest.Response, err error) {
	req, err := client.TriggerPreparer(vaultName, resourceGroupName, fabricName, containerName, protectedItemName, resourceBackupRequest)
	if err != nil {
...
func (client BackupsClient) TriggerPreparer(vaultName string, resourceGroupName string, fabricName string, containerName string, protectedItemName string, resourceBackupRequest BackupRequestResource) (*http.Request, error) {
