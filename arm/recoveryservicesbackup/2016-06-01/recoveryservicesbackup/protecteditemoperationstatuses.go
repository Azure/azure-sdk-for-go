...
// ProtectedItemOperationStatusesClient is the client for the
// ProtectedItemOperationStatuses methods of the Recoveryservicesbackup
// service.
type ProtectedItemOperationStatusesClient struct {
	ManagementClient
}

// NewProtectedItemOperationStatusesClient creates an instance of the
...
// NewProtectedItemOperationStatusesClientWithBaseURI creates an instance of
// the ProtectedItemOperationStatusesClient client.
...
// Get gets the status of an operation such as triggering a backup or restore.
...
// the name of backup item used in this GET operation. operationID is the
// OperationID used in this GET operation.
