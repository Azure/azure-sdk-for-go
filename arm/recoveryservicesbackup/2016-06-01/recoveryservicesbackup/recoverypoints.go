...
// Get provides the backup data for the RecoveryPointID. This is an
...
// fabricName is the fabric name associated with backup item. containerName is
// the container name associated with backup item. protectedItemName is the
// name of the backup item used in this GET operation. recoveryPointID is the
// RecoveryPointID associated with this GET operation.
...
// List lists the recovery points, or backup copies, for the specified backup
// item.
//
// vaultName is the name of the Recovery Services vault. resourceGroupName is
// the name of the resource group associated with the Recovery Services vault.
...
// the name of backup item used in this GET operation. filter is startDate eq
// {yyyy-mm-dd hh:mm:ss PM} and endDate { yyyy-mm-dd hh:mm:ss PM}.
