...
// Trigger restores the specified backup data. This is an asynchronous
...
// protectedItemName is the backup item to be restored. recoveryPointID is the
// recovery point ID for the backup data to be restored. resourceRestoreRequest
// is the resource restore request.
func (client RestoresClient) Trigger(vaultName string, resourceGroupName string, fabricName string, containerName string, protectedItemName string, recoveryPointID string, resourceRestoreRequest RestoreRequestResource) (result autorest.Response, err error) {
	req, err := client.TriggerPreparer(vaultName, resourceGroupName, fabricName, containerName, protectedItemName, recoveryPointID, resourceRestoreRequest)
	if err != nil {
...
func (client RestoresClient) TriggerPreparer(vaultName string, resourceGroupName string, fabricName string, containerName string, protectedItemName string, recoveryPointID string, resourceRestoreRequest RestoreRequestResource) (*http.Request, error) {
