...
// NewBackupResourceStorageConfigsClientWithAuthFile creates an instance of the BackupResourceStorageConfigsClient
// client.
func NewBackupResourceStorageConfigsClientWithAuthFile() (BackupResourceStorageConfigsClient, error) {
	c, err := NewWithAuthFile()
	return BackupResourceStorageConfigsClient{c}, err
}
