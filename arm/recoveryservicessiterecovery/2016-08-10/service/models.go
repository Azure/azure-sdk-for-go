...
const (
	...
	// LatestApplicationConsistent specifies the latest application consistent
	// state for a2a rp recovery point type.
	LatestApplicationConsistent A2ARpRecoveryPointType = "LatestApplicationConsistent"
	// LatestCrashConsistent specifies the latest crash consistent state for
	// a2a rp recovery point type.
	LatestCrashConsistent A2ARpRecoveryPointType = "LatestCrashConsistent"
	// LatestProcessed specifies the latest processed state for a2a rp recovery
	// point type.
	LatestProcessed A2ARpRecoveryPointType = "LatestProcessed"
)

// AlternateLocationRecoveryOption enumerates the values for alternate location
// recovery option.
type AlternateLocationRecoveryOption string

const (
	// CreateVMIfNotFound specifies the create vm if not found state for
	// alternate location recovery option.
	CreateVMIfNotFound AlternateLocationRecoveryOption = "CreateVmIfNotFound"
	// NoAction specifies the no action state for alternate location recovery
	// option.
...
const (
	...
	// ForSynchronization specifies the for synchronization state for data sync
	// status.
...
const (
	// MigrationComplete specifies the migration complete state for disable
	// protection reason.
	MigrationComplete DisableProtectionReason = "MigrationComplete"
	// NotSpecified specifies the not specified state for disable protection
	// reason.
...
const (
	...
	// NotApplicable specifies the not applicable state for failover deployment
	// model.
	NotApplicable FailoverDeploymentModel = "NotApplicable"
	// ResourceManager specifies the resource manager state for failover
	// deployment model.
	ResourceManager FailoverDeploymentModel = "ResourceManager"
)

// HyperVReplicaAzureRpRecoveryPointType enumerates the values for hyper v
// replica azure rp recovery point type.
type HyperVReplicaAzureRpRecoveryPointType string

const (
	// HyperVReplicaAzureRpRecoveryPointTypeLatest specifies the hyper v
	// replica azure rp recovery point type latest state for hyper v replica
	// azure rp recovery point type.
	...
	// specifies the hyper v replica azure rp recovery point type latest
	// application consistent state for hyper v replica azure rp recovery point
	// type.
	...
	// HyperVReplicaAzureRpRecoveryPointTypeLatestProcessed specifies the hyper
	// v replica azure rp recovery point type latest processed state for hyper
	// v replica azure rp recovery point type.
	HyperVReplicaAzureRpRecoveryPointTypeLatestProcessed HyperVReplicaAzureRpRecoveryPointType = "LatestProcessed"
)

// InMageV2RpRecoveryPointType enumerates the values for in mage v2 rp recovery
// point type.
type InMageV2RpRecoveryPointType string

const (
	// InMageV2RpRecoveryPointTypeLatest specifies the in mage v2 rp recovery
	// point type latest state for in mage v2 rp recovery point type.
	InMageV2RpRecoveryPointTypeLatest InMageV2RpRecoveryPointType = "Latest"
	// InMageV2RpRecoveryPointTypeLatestApplicationConsistent specifies the in
	// mage v2 rp recovery point type latest application consistent state for
	// in mage v2 rp recovery point type.
	InMageV2RpRecoveryPointTypeLatestApplicationConsistent InMageV2RpRecoveryPointType = "LatestApplicationConsistent"
	// InMageV2RpRecoveryPointTypeLatestCrashConsistent specifies the in mage
	// v2 rp recovery point type latest crash consistent state for in mage v2
	// rp recovery point type.
	InMageV2RpRecoveryPointTypeLatestCrashConsistent InMageV2RpRecoveryPointType = "LatestCrashConsistent"
	// InMageV2RpRecoveryPointTypeLatestProcessed specifies the in mage v2 rp
	// recovery point type latest processed state for in mage v2 rp recovery
	// point type.
...
const (
	// LicenseTypeNoLicenseType specifies the license type no license type
	// state for license type.
	LicenseTypeNoLicenseType LicenseType = "NoLicenseType"
	// LicenseTypeNotSpecified specifies the license type not specified state
	// for license type.
	LicenseTypeNotSpecified LicenseType = "NotSpecified"
	// LicenseTypeWindowsServer specifies the license type windows server state
	// for license type.
	LicenseTypeWindowsServer LicenseType = "WindowsServer"
)

// PossibleOperationsDirections enumerates the values for possible operations
// directions.
type PossibleOperationsDirections string

const (
	// PrimaryToRecovery specifies the primary to recovery state for possible
	// operations directions.
	PrimaryToRecovery PossibleOperationsDirections = "PrimaryToRecovery"
	// RecoveryToPrimary specifies the recovery to primary state for possible
	// operations directions.
	RecoveryToPrimary PossibleOperationsDirections = "RecoveryToPrimary"
)

// RecoveryPlanActionLocation enumerates the values for recovery plan action
// location.
...
// ReplicationProtectedItemOperation enumerates the values for replication
// protected item operation.
type ReplicationProtectedItemOperation string

const (
	// ChangePit specifies the change pit state for replication protected item
	// operation.
	ChangePit ReplicationProtectedItemOperation = "ChangePit"
	// Commit specifies the commit state for replication protected item
	// operation.
	Commit ReplicationProtectedItemOperation = "Commit"
	// CompleteMigration specifies the complete migration state for replication
	// protected item operation.
	CompleteMigration ReplicationProtectedItemOperation = "CompleteMigration"
	// DisableProtection specifies the disable protection state for replication
	// protected item operation.
	DisableProtection ReplicationProtectedItemOperation = "DisableProtection"
	// Failback specifies the failback state for replication protected item
	// operation.
	Failback ReplicationProtectedItemOperation = "Failback"
	// FinalizeFailback specifies the finalize failback state for replication
	// protected item operation.
	FinalizeFailback ReplicationProtectedItemOperation = "FinalizeFailback"
	// PlannedFailover specifies the planned failover state for replication
	// protected item operation.
	PlannedFailover ReplicationProtectedItemOperation = "PlannedFailover"
	// RepairReplication specifies the repair replication state for replication
	// protected item operation.
	RepairReplication ReplicationProtectedItemOperation = "RepairReplication"
	// ReverseReplicate specifies the reverse replicate state for replication
	// protected item operation.
	ReverseReplicate ReplicationProtectedItemOperation = "ReverseReplicate"
	// SwitchProtection specifies the switch protection state for replication
	// protected item operation.
	SwitchProtection ReplicationProtectedItemOperation = "SwitchProtection"
	// TestFailover specifies the test failover state for replication protected
	// item operation.
	TestFailover ReplicationProtectedItemOperation = "TestFailover"
	// TestFailoverCleanup specifies the test failover cleanup state for
	// replication protected item operation.
	TestFailoverCleanup ReplicationProtectedItemOperation = "TestFailoverCleanup"
	// UnplannedFailover specifies the unplanned failover state for replication
	// protected item operation.
	UnplannedFailover ReplicationProtectedItemOperation = "UnplannedFailover"
)

// RpInMageRecoveryPointType enumerates the values for rp in mage recovery
// point type.
...
const (
	...
	// LatestTag specifies the latest tag state for rp in mage recovery point
	// type.
	LatestTag RpInMageRecoveryPointType = "LatestTag"
	// LatestTime specifies the latest time state for rp in mage recovery point
	// type.
...
// A2AApplyRecoveryPointInput is applyRecoveryPoint input specific to A2A
// provider.
...
// A2AUpdateReplicationProtectedItemInput is inMage Azure V2 input to update
...
// ApplyRecoveryPointInputProperties is input properties to apply recovery
// point.
...
// ApplyRecoveryPointProviderSpecificInput is provider specific input for apply
// recovery point.
...
// ARMInnerError is aRM internal error class for providing additional debug
// data.
...
// AsrJobDetails is this class represents job details based on specific job
// type.
...
// AutomationRunbookTaskDetails is this class represents the task details for
...
// AzureToAzureCreateNetworkMappingInput is create network mappings input
// properties/behaviour specific to Azure to Azure Network
// mapping.
type AzureToAzureCreateNetworkMappingInput struct {
	PrimaryNetworkID *string `json:"primaryNetworkId,omitempty"`
}

// AzureToAzureNetworkMappingSettings is a2A  Network Mapping fabric specific
// settings.
...
// AzureToAzureVMSyncedConfigDetails is azure to Azure VM synced configuration
// details.
...
// ConsistencyCheckTaskDetails is this class contains monitoring details of all
// the inconsistent Protected Entites in Vmm.
...
// CreateNetworkMappingInputProperties is common input details for network
// mapping operation.
...
// CreateProtectionContainerInputProperties is create protection container
// input properties.
...
// CreateProtectionContainerMappingInputProperties is configure pairing input
// properties.
...
// DisableProtectionProviderSpecificInput is disable protection provider
// specific input.
type DisableProtectionProviderSpecificInput struct {
}

// DiscoverProtectableItemRequest is request to add a physical machine as a
// protectable item in a container.
type DiscoverProtectableItemRequest struct {
	Properties *DiscoverProtectableItemRequestProperties `json:"properties,omitempty"`
}

// DiscoverProtectableItemRequestProperties is discover protectable item
// properties.
...
// Display is contains the localized display information for this particular
...
// EnableProtectionProviderSpecificInput is enable protection provider specific
// input.
...
// EventProviderSpecificDetails is model class for provider specific details
// for an event.
...
// FabricCreationInput is site details provided during the time of site
// creation
type FabricCreationInput struct {
	Properties *FabricCreationInputProperties `json:"properties,omitempty"`
}

// FabricCreationInputProperties is properties of site details provided during
// the time of site creation
...
// FabricReplicationGroupTaskDetails is this class represents the fabric
// replication group task details.
...
// FabricSpecificCreateNetworkMappingInput is input details specific to fabrics
// during Network Mapping.
...
// FabricSpecificUpdateNetworkMappingInput is input details specific to fabrics
// during Network Mapping.
...
// FailoverProcessServerRequestProperties is the properties of the Failover
...
// GroupTaskDetails is this class represents the group task details when parent
...
// HyperVReplica2012EventDetails is model class for event details of a
// HyperVReplica E2E event.
...
// HyperVReplica2012R2EventDetails is model class for event details of a
// HyperVReplica blue E2E event.
...
// HyperVReplicaAzureApplyRecoveryPointInput is applyRecoveryPoint input
// specific to HyperVReplicaAzure provider.
...
// HyperVReplicaAzureEnableProtectionInput is azure specific enable protection
// input.
...
// HyperVReplicaAzureEventDetails is model class for event details of a
// HyperVReplica E2A event.
...
// HyperVReplicaAzureFailbackProviderInput is hvrA provider specific input for
// failback.
...
// HyperVReplicaAzureFailoverProviderInput is hvrA provider specific input for
// failover.
...
// HyperVReplicaAzurePolicyDetails is hyper-V Replica Azure specific protection
// profile details.
...
// HyperVReplicaAzurePolicyInput is hyper-V Replica Azure specific input for
...
// HyperVReplicaAzureReplicationDetails is hyper V Replica Azure provider
// specific settings.
...
// HyperVReplicaAzureUpdateReplicationProtectedItemInput is hyperV replica
// Azure input to update replication protected item.
...
// HyperVReplicaBaseEventDetails is abstract model class for event details of a
// HyperVReplica E2E event.
...
// HyperVReplicaBasePolicyDetails is base class for HyperVReplica policy
// details.
...
// HyperVReplicaBaseReplicationDetails is hyper V replica provider specific
// settings base class.
...
// HyperVReplicaBluePolicyDetails is hyper-V Replica Blue specific protection
// profile details.
...
// HyperVReplicaBlueReplicationDetails is hyperV replica 2012 R2 (Blue)
// replication details.
...
// HyperVReplicaPolicyDetails is hyper-V Replica Blue specific protection
// profile details.
...
// HyperVReplicaPolicyInput is hyper-V Replica specific protection profile
// Input.
...
// InconsistentVMDetails is this class stores the monitoring details for
...
// InlineWorkflowTaskDetails is this class represents the inline workflow task
// details.
...
// InMageAzureV2ApplyRecoveryPointInput is applyRecoveryPoint input specific to
// InMageAzureV2 provider.
type InMageAzureV2ApplyRecoveryPointInput struct {
	VaultLocation *string `json:"vaultLocation,omitempty"`
}

// InMageAzureV2EnableProtectionInput is vMware Azure specific enable
// protection input.
...
// InMageAzureV2EventDetails is model class for event details of a
// VMwareAzureV2 event.
...
// InMageAzureV2FailoverProviderInput is inMageAzureV2 provider specific input
// for failover.
...
// InMageAzureV2PolicyDetails is inMage Azure v2 specific protection profile
// details.
...
// InMageAzureV2UpdateReplicationProtectedItemInput is inMage Azure V2 input to
...
// InMageBasePolicyDetails is base class for the policies of providers using
// InMage replication.
...
// InMageDisableProtectionProviderSpecificInput is inMage disable protection
...
// InMageDiskExclusionInput is diskExclusionInput when doing enable protection
...
// InMageDiskSignatureExclusionOptions is guest disk signature based disk
// exclusion option when doing enable protection of
...
// InMageEnableProtectionInput is vMware Azure specific enable protection
// input.
...
// InMageVolumeExclusionOptions is guest disk signature based disk exclusion
// option when doing enable protection of
// virtual machine in InMage provider.
...
// JobEntity is this class contains the minimal job details required to
// navigate to the desired drill down.
...
type JobErrorDetails struct {
	ServiceErrorDetails  *Error         `json:"serviceErrorDetails,omitempty"`
...
// JobStatusEventDetails is model class for event details of a job status
// event.
...
// JobTaskDetails is this class represents a task which is actually a workflow
...
// ManualActionTaskDetails is this class represents the manual action task
// details.
...
// NetworkMapping is network Mapping model.
// Ideally it should have been possible to inherit this class from prev version
// in
// InheritedModels as long as there is no difference in structure or method
// signature.
// Since there were no base Models for certain fields and methods viz
// NetworkMappingProperties
// and Load with required return type, the class has been introduced in its
// entirety with
...
// NetworkMappingCollection is list of network mappings.
// As with NetworkMapping, it should be possible to reuse a prev version of
// this class.
// It doesn't seem likely this class could be anything more than a slightly
// bespoke collection
// of NetworkMapping. Hence it makes sense to override Load with
// Base.NetworkMapping instead
...
// NetworkMappingFabricSpecificSettings is network Mapping fabric specific
// settings.
...
// PlannedFailoverInputProperties is input definition for planned failover
// input properties.
...
// PolicyProviderSpecificDetails is base class for Provider specific details
// for policies.
...
// ProtectedItemsQueryParameter is query parameter to enumerate protected
// items.
...
// ProtectionContainerFabricSpecificDetails is base class for fabric specific
...
// ProtectionContainerMappingCollection is protection container mapping
// collection class.
...
// ProtectionContainerMappingProperties is protection container mapping
// properties.
...
// ProtectionContainerMappingProviderSpecificDetails is container mapping
...
// RecoveryPlanAutomationRunbookActionDetails is recovery plan Automation
// runbook action details.
...
// RecoveryPlanGroupTaskDetails is this class represents the recovery plan
// group task.
...
// RecoveryPlanHyperVReplicaAzureFailbackInput is recovery plan HVR Azure
// failback input.
...
// RecoveryPlanHyperVReplicaAzureFailoverInput is recovery plan HVR Azure
// failover input.
...
// RecoveryPlanInMageAzureV2FailoverInput is recovery plan InMageAzureV2
// failover input.
...
// RecoveryPlanPlannedFailoverInputProperties is recovery plan planned failover
// input properties.
...
// RecoveryPlanProviderSpecificFailoverInput is recovery plan provider specific
// failover input base class.
...
// RecoveryPlanShutdownGroupTaskDetails is this class represents the recovery
// plan shutdown group task details.
...
// RecoveryPlanTestFailoverCleanupInput is recovery plan test failover cleanup
// input.
...
// RecoveryPlanTestFailoverCleanupInputProperties is recovery plan test
// failover cleanup input properties.
...
// RecoveryPlanTestFailoverInputProperties is recovery plan test failover input
// properties.
...
// RecoveryPlanUnplannedFailoverInput is recovery plan unplanned failover
// input.
...
// RecoveryPlanUnplannedFailoverInputProperties is recovery plan unplanned
// failover input properties.
...
// RemoveProtectionContainerMappingInputProperties is unpairing input
// properties.
...
// ReplicationGroupDetails is replication group details. This will be used in
// case of San and Wvr.
...
// ReplicationProtectedItemProperties is replication protected item custom data
// details.
...
// ReplicationProviderContainerUnmappingInput is provider specific input for
// unpairing operations.
type ReplicationProviderContainerUnmappingInput struct {
	InstanceType *string `json:"instanceType,omitempty"`
}

// ReplicationProviderSpecificContainerCreationInput is provider specific input
// for container creation operation.
type ReplicationProviderSpecificContainerCreationInput struct {
}

// ReplicationProviderSpecificContainerMappingInput is provider specific input
// for pairing operations.
type ReplicationProviderSpecificContainerMappingInput struct {
	InstanceType *string `json:"instanceType,omitempty"`
}

// ReplicationProviderSpecificSettings is replication provider specific
// settings.
...
// ReverseReplicationProviderSpecificInput is provider specific reverse
// replication input.
...
// ScriptActionTaskDetails is this class represents the script action task
// details.
...
// StorageClassificationMappingCollection is collection of storage mapping
// details.
...
// SwitchProtectionJobDetails is this class represents details for switch
// protection job.
...
// SwitchProtectionProviderSpecificInput is provider specific switch protection
// input.
...
// TestFailoverCleanupInputProperties is input definition for test failover
...
// TestFailoverInputProperties is input definition for planned failover input
// properties.
...
// TestFailoverJobDetails is this class represents the details for a test
// failover job.
...
// TestFailoverReplicationProtectedItemDetails is test failover details for a
// replication protected item.
...
// UnplannedFailoverInputProperties is input definition for planned failover
// input properties.
...
// UpdateMobilityServiceRequest is request to update the mobility service on a
// protected item.
type UpdateMobilityServiceRequest struct {
	Properties *UpdateMobilityServiceRequestProperties `json:"properties,omitempty"`
}

// UpdateMobilityServiceRequestProperties is the properties of an update
// mobility service request.
...
// UpdateNetworkMappingInputProperties is common input details for network
// mapping operation.
...
// UpdateReplicationProtectedItemInput is update replication protected item
// input.
...
// UpdateReplicationProtectedItemInputProperties is update protected item input
// properties.
...
// UpdateReplicationProtectedItemProviderInput is update replication protected
// item provider specific input.
...
// UpdateVCenterRequestProperties is the properties of an update vCenter
// request.
...
// VirtualMachineTaskDetails is this class represents the virtual machine task
// details.
...
// VmmToAzureCreateNetworkMappingInput is create network mappings input
// properties/behaviour specific to Vmm to Azure Network
// mapping.
type VmmToAzureCreateNetworkMappingInput struct {
}

// VmmToAzureNetworkMappingSettings is e2A  Network Mapping fabric specific
// settings.
type VmmToAzureNetworkMappingSettings struct {
}

// VmmToAzureUpdateNetworkMappingInput is update network mappings input
// properties/behaviour specific to vmm to azure.
type VmmToAzureUpdateNetworkMappingInput struct {
}

// VmmToVmmCreateNetworkMappingInput is create network mappings input
// properties/behaviour specific to vmm to vmm Network mapping.
type VmmToVmmCreateNetworkMappingInput struct {
}

// VmmToVmmNetworkMappingSettings is e2E  Network Mapping fabric specific
// settings.
type VmmToVmmNetworkMappingSettings struct {
}

// VmmToVmmUpdateNetworkMappingInput is update network mappings input
// properties/behaviour specific to vmm to vmm.
...
// VMNicUpdatesTaskDetails is this class represents the vm NicUpdates task
// details.
