...
// ReplicationNetworkMappingsClient is the client for the
// ReplicationNetworkMappings methods of the Service service.
type ReplicationNetworkMappingsClient struct {
	ManagementClient
}

// NewReplicationNetworkMappingsClient creates an instance of the
// ReplicationNetworkMappingsClient client.
...
// NewReplicationNetworkMappingsClientWithBaseURI creates an instance of the
// ReplicationNetworkMappingsClient client.
...
// Create the operation to create an ASR network mapping. This method may poll
// for completion. Polling can be canceled by passing the cancel channel
// argument. The channel will be used to cancel polling and any outstanding
// HTTP requests.
//
// fabricName is primary fabric name. networkName is primary network name.
// networkMappingName is network mapping name. input is create network mapping
// input.
func (client ReplicationNetworkMappingsClient) Create(fabricName string, networkName string, networkMappingName string, input CreateNetworkMappingInput, cancel <-chan struct{}) (<-chan NetworkMapping, <-chan error) {
	...
	go func() {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ReplicationNetworkMappingsClient", "Create", nil, "Failure preparing request")
			return
		}
		...
		if err != nil {
			...
			err = autorest.NewErrorWithError(err, "service.ReplicationNetworkMappingsClient", "Create", resp, "Failure sending request")
			return
		}

		result, err = client.CreateResponder(resp)
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ReplicationNetworkMappingsClient", "Create", resp, "Failure responding to request")
		}
	}()
...
// Delete the operation to delete a network mapping. This method may poll for
// completion. Polling can be canceled by passing the cancel channel argument.
// The channel will be used to cancel polling and any outstanding HTTP
// requests.
//
// fabricName is primary fabric name. networkName is primary network name.
// networkMappingName is aRM Resource Name for network mapping.
func (client ReplicationNetworkMappingsClient) Delete(fabricName string, networkName string, networkMappingName string, cancel <-chan struct{}) (<-chan autorest.Response, <-chan error) {
	...
	go func() {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ReplicationNetworkMappingsClient", "Delete", nil, "Failure preparing request")
			return
		}
		...
		if err != nil {
			...
			err = autorest.NewErrorWithError(err, "service.ReplicationNetworkMappingsClient", "Delete", resp, "Failure sending request")
			return
		}

		result, err = client.DeleteResponder(resp)
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ReplicationNetworkMappingsClient", "Delete", resp, "Failure responding to request")
		}
	}()
	return resultChan, errChan
}
...
//
// fabricName is primary fabric name. networkName is primary network name.
// networkMappingName is network mapping name.
func (client ReplicationNetworkMappingsClient) Get(fabricName string, networkName string, networkMappingName string) (result NetworkMapping, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ReplicationNetworkMappingsClient", "Get", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.ReplicationNetworkMappingsClient", "Get", resp, "Failure sending request")
		return
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ReplicationNetworkMappingsClient", "Get", resp, "Failure responding to request")
	}
...
func (client ReplicationNetworkMappingsClient) List() (result NetworkMappingCollection, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ReplicationNetworkMappingsClient", "List", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.ReplicationNetworkMappingsClient", "List", resp, "Failure sending request")
		return
	}

	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ReplicationNetworkMappingsClient", "List", resp, "Failure responding to request")
	}
...
func (client ReplicationNetworkMappingsClient) ListNextResults(lastResults NetworkMappingCollection) (result NetworkMappingCollection, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "service.ReplicationNetworkMappingsClient", "List", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "service.ReplicationNetworkMappingsClient", "List", resp, "Failure sending next results request")
	}

	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ReplicationNetworkMappingsClient", "List", resp, "Failure responding to next results request")
	}

	return
}

// ListByReplicationNetworks lists all ASR network mappings for the specified
// network.
//
// fabricName is primary fabric name. networkName is primary network name.
func (client ReplicationNetworkMappingsClient) ListByReplicationNetworks(fabricName string, networkName string) (result NetworkMappingCollection, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ReplicationNetworkMappingsClient", "ListByReplicationNetworks", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.ReplicationNetworkMappingsClient", "ListByReplicationNetworks", resp, "Failure sending request")
		return
	}

	result, err = client.ListByReplicationNetworksResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ReplicationNetworkMappingsClient", "ListByReplicationNetworks", resp, "Failure responding to request")
	}
...
func (client ReplicationNetworkMappingsClient) ListByReplicationNetworksNextResults(lastResults NetworkMappingCollection) (result NetworkMappingCollection, err error) {
	req, err := lastResults.NetworkMappingCollectionPreparer()
	if err != nil {
		return result, autorest.NewErrorWithError(err, "service.ReplicationNetworkMappingsClient", "ListByReplicationNetworks", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "service.ReplicationNetworkMappingsClient", "ListByReplicationNetworks", resp, "Failure sending next results request")
	}

	result, err = client.ListByReplicationNetworksResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ReplicationNetworkMappingsClient", "ListByReplicationNetworks", resp, "Failure responding to next results request")
	}

	return
}

// Update the operation to update an ASR network mapping. This method may poll
// for completion. Polling can be canceled by passing the cancel channel
// argument. The channel will be used to cancel polling and any outstanding
// HTTP requests.
//
// fabricName is primary fabric name. networkName is primary network name.
// networkMappingName is network mapping name. input is update network mapping
// input.
func (client ReplicationNetworkMappingsClient) Update(fabricName string, networkName string, networkMappingName string, input UpdateNetworkMappingInput, cancel <-chan struct{}) (<-chan NetworkMapping, <-chan error) {
	...
	go func() {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ReplicationNetworkMappingsClient", "Update", nil, "Failure preparing request")
			return
		}
		...
		if err != nil {
			result.Response = autorest.Response{Response: resp}
			err = autorest.NewErrorWithError(err, "service.ReplicationNetworkMappingsClient", "Update", resp, "Failure sending request")
			return
		}

		result, err = client.UpdateResponder(resp)
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ReplicationNetworkMappingsClient", "Update", resp, "Failure responding to request")
		}
	}()
	return resultChan, errChan
}
