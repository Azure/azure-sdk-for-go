...
// ReplicationPoliciesClient is the client for the ReplicationPolicies methods
// of the Service service.
type ReplicationPoliciesClient struct {
	ManagementClient
}

// NewReplicationPoliciesClient creates an instance of the
// ReplicationPoliciesClient client.
...
// NewReplicationPoliciesClientWithBaseURI creates an instance of the
// ReplicationPoliciesClient client.
...
// Create the operation to create a replication policy This method may poll for
...
func (client ReplicationPoliciesClient) Create(policyName string, input CreatePolicyInput, cancel <-chan struct{}) (<-chan Policy, <-chan error) {
	...
	go func() {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ReplicationPoliciesClient", "Create", nil, "Failure preparing request")
			return
		}
		...
		if err != nil {
			...
			err = autorest.NewErrorWithError(err, "service.ReplicationPoliciesClient", "Create", resp, "Failure sending request")
			return
		}

		result, err = client.CreateResponder(resp)
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ReplicationPoliciesClient", "Create", resp, "Failure responding to request")
		}
	}()
...
// Delete the operation to delete a replication policy. This method may poll
...
func (client ReplicationPoliciesClient) Delete(policyName string, cancel <-chan struct{}) (<-chan autorest.Response, <-chan error) {
	...
	go func() {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ReplicationPoliciesClient", "Delete", nil, "Failure preparing request")
			return
		}
		...
		if err != nil {
			...
			err = autorest.NewErrorWithError(err, "service.ReplicationPoliciesClient", "Delete", resp, "Failure sending request")
			return
		}

		result, err = client.DeleteResponder(resp)
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ReplicationPoliciesClient", "Delete", resp, "Failure responding to request")
		}
	}()
	return resultChan, errChan
}
...
func (client ReplicationPoliciesClient) Get(policyName string) (result Policy, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ReplicationPoliciesClient", "Get", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.ReplicationPoliciesClient", "Get", resp, "Failure sending request")
		return
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ReplicationPoliciesClient", "Get", resp, "Failure responding to request")
	}
...
func (client ReplicationPoliciesClient) List() (result PolicyCollection, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ReplicationPoliciesClient", "List", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.ReplicationPoliciesClient", "List", resp, "Failure sending request")
		return
	}

	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ReplicationPoliciesClient", "List", resp, "Failure responding to request")
	}
...
func (client ReplicationPoliciesClient) ListNextResults(lastResults PolicyCollection) (result PolicyCollection, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "service.ReplicationPoliciesClient", "List", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "service.ReplicationPoliciesClient", "List", resp, "Failure sending next results request")
	}

	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ReplicationPoliciesClient", "List", resp, "Failure responding to next results request")
	}

	return
}

// Update the operation to update a replication policy. This method may poll
// for completion. Polling can be canceled by passing the cancel channel
// argument. The channel will be used to cancel polling and any outstanding
// HTTP requests.
//
// policyName is protection profile Id. input is update Protection Profile
// Input
func (client ReplicationPoliciesClient) Update(policyName string, input UpdatePolicyInput, cancel <-chan struct{}) (<-chan Policy, <-chan error) {
	...
	go func() {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ReplicationPoliciesClient", "Update", nil, "Failure preparing request")
			return
		}
		...
		if err != nil {
			result.Response = autorest.Response{Response: resp}
			err = autorest.NewErrorWithError(err, "service.ReplicationPoliciesClient", "Update", resp, "Failure sending request")
			return
		}

		result, err = client.UpdateResponder(resp)
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ReplicationPoliciesClient", "Update", resp, "Failure responding to request")
		}
	}()
	return resultChan, errChan
}
