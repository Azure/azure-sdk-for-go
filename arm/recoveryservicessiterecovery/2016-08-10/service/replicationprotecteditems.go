...
// This will also
// remove the item. This method may poll for completion. Polling can be
...
//
// skipToken is the pagination token.
// Possible values: "FabricId" or "FabricId_CloudId" or null filter is oData
// filter options.
...
// for a replication protected item
// requiring resynchronization. This method may poll for completion. Polling
...
// mobility service software on a
// replication protected item to the latest available version. This method may
...
// item on which the
// agent is to be updated. updateMobilityServiceRequest is request to update
// the mobility
