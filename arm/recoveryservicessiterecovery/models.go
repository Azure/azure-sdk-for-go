...
// properties/behaviour specific to Azure to Azure Network mapping.
...
// custom role definitions for RBAC; (2) complex query filters for the event
...
// child relationship exists in the drill down.
...
// consistency check of inconsistent Protected Entity.
...
// exclusion option when doing enable protection of virtual machine in InMage
// provider.
...
// option when doing enable protection of virtual machine in InMage provider.
...
// so that one can navigate to its individual drill down.
...
// NetworkMapping is network Mapping model. Ideally it should have been
// possible to inherit this class from prev version in InheritedModels as long
// as there is no difference in structure or method signature. Since there were
// no base Models for certain fields and methods viz NetworkMappingProperties
...
// NetworkMappingCollection is list of network mappings. As with
// NetworkMapping, it should be possible to reuse a prev version of this class.
// It doesn't seem likely this class could be anything more than a slightly
// bespoke collection of NetworkMapping. Hence it makes sense to override Load
// with Base.NetworkMapping instead of existing CurrentVersion.NetworkMapping.
...
// properties/behaviour specific to Vmm to Azure Network mapping.
