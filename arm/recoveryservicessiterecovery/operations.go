...
func (client OperationsClient) List() (result OperationsDiscoveryCollection, err error) {
	if err := validation.Validate([]validation.Validation{}); err != nil {
		return result, validation.NewErrorWithValidationError(err, "recoveryservicessiterecovery.OperationsClient", "List")
	}

	req, err := client.ListPreparer()
	if err != nil {
		err = autorest.NewErrorWithError(err, "recoveryservicessiterecovery.OperationsClient", "List", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "recoveryservicessiterecovery.OperationsClient", "List", resp, "Failure sending request")
		return
	}

	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "recoveryservicessiterecovery.OperationsClient", "List", resp, "Failure responding to request")
	}
...
func (client OperationsClient) ListNextResults(lastResults OperationsDiscoveryCollection) (result OperationsDiscoveryCollection, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "recoveryservicessiterecovery.OperationsClient", "List", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "recoveryservicessiterecovery.OperationsClient", "List", resp, "Failure sending next results request")
	}

	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "recoveryservicessiterecovery.OperationsClient", "List", resp, "Failure responding to next results request")
	}
...
func (client OperationsClient) ListComplete(cancel <-chan struct{}) (<-chan OperationsDiscovery, <-chan error) {
	resultChan := make(chan OperationsDiscovery)
