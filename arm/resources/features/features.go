...
func (client Client) Get(resourceProviderNamespace string, featureName string) (result FeatureResult, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "features/Client", "Get", autorest.UndefinedStatusCode, "Failure preparing request")
	}

	resp, err := client.GetSender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "features/Client", "Get", resp.StatusCode, "Failure sending request")
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "features/Client", "Get", resp.StatusCode, "Failure responding to request")
	}
...
func (client Client) List(resourceProviderNamespace string) (result FeatureOperationsListResult, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "features/Client", "List", autorest.UndefinedStatusCode, "Failure preparing request")
	}

	resp, err := client.ListSender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "features/Client", "List", resp.StatusCode, "Failure sending request")
	}

	result, err = client.ListResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "features/Client", "List", resp.StatusCode, "Failure responding to request")
	}
...
func (client Client) ListNextResults(lastResults FeatureOperationsListResult) (result FeatureOperationsListResult, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "features/Client", "List", autorest.UndefinedStatusCode, "Failure preparing next results request request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "features/Client", "List", resp.StatusCode, "Failure sending next results request request")
	}

	result, err = client.ListResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "features/Client", "List", resp.StatusCode, "Failure responding to next results request request")
	}
...
func (client Client) ListAll() (result FeatureOperationsListResult, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "features/Client", "ListAll", autorest.UndefinedStatusCode, "Failure preparing request")
	}

	resp, err := client.ListAllSender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "features/Client", "ListAll", resp.StatusCode, "Failure sending request")
	}

	result, err = client.ListAllResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "features/Client", "ListAll", resp.StatusCode, "Failure responding to request")
	}
...
func (client Client) ListAllNextResults(lastResults FeatureOperationsListResult) (result FeatureOperationsListResult, ae error) {
	req, err := lastResults.FeatureOperationsListResultPreparer()
	if err != nil {
		return result, autorest.NewErrorWithError(err, "features/Client", "ListAll", autorest.UndefinedStatusCode, "Failure preparing next results request request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "features/Client", "ListAll", resp.StatusCode, "Failure sending next results request request")
	}

	result, err = client.ListAllResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "features/Client", "ListAll", resp.StatusCode, "Failure responding to next results request request")
	}
...
func (client Client) Register(resourceProviderNamespace string, featureName string) (result FeatureResult, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "features/Client", "Register", autorest.UndefinedStatusCode, "Failure preparing request")
	}

	resp, err := client.RegisterSender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "features/Client", "Register", resp.StatusCode, "Failure sending request")
	}

	result, err = client.RegisterResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "features/Client", "Register", resp.StatusCode, "Failure responding to request")
	}
