...
func (client GroupClient) Get(resourceProviderNamespace string, featureName string) (result Result, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "features.GroupClient", "Get", nil, "Failure preparing request")
	}

	resp, err := client.GetSender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "features.GroupClient", "Get", resp, "Failure sending request")
	}
...
func (client GroupClient) List(resourceProviderNamespace string) (result OperationsListResult, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "features.GroupClient", "List", nil, "Failure preparing request")
	}

	resp, err := client.ListSender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "features.GroupClient", "List", resp, "Failure sending request")
	}
...
func (client GroupClient) ListAll() (result OperationsListResult, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "features.GroupClient", "ListAll", nil, "Failure preparing request")
	}

	resp, err := client.ListAllSender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "features.GroupClient", "ListAll", resp, "Failure sending request")
	}
...
func (client GroupClient) Register(resourceProviderNamespace string, featureName string) (result Result, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "features.GroupClient", "Register", nil, "Failure preparing request")
	}

	resp, err := client.RegisterSender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "features.GroupClient", "Register", resp, "Failure sending request")
	}
