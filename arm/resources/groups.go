...
func (client GroupsClient) CreateOrUpdate(resourceGroupName string, parameters Group) (result Group, ae error) {
...
func (client GroupsClient) CreateOrUpdateSender(req *http.Request) (*http.Response, error) {
	return client.Send(req, http.StatusCreated, http.StatusOK, http.StatusAccepted)
}
...
func (client GroupsClient) CreateOrUpdateResponder(resp *http.Response) (result Group, err error) {
	err = autorest.Respond(
		resp,
		client.ByInspecting(),
		autorest.WithErrorUnlessStatusCode(http.StatusCreated, http.StatusOK, http.StatusAccepted),
...
// case insensitive.
func (client GroupsClient) Get(resourceGroupName string) (result Group, ae error) {
...
func (client GroupsClient) List(filter string, top int) (result GroupListResult, ae error) {
...
func (client GroupsClient) ListNextResults(lastResults GroupListResult) (result GroupListResult, ae error) {
...
func (client GroupsClient) ListResources(resourceGroupName string, filter string, top int) (result ListResult, ae error) {
...
func (client GroupsClient) ListResourcesNextResults(lastResults ListResult) (result ListResult, ae error) {
...
func (client GroupsClient) Patch(resourceGroupName string, parameters Group) (result Group, ae error) {
