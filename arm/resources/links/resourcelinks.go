...
// to different resource groups. However, all the linked resources must belong
// to the same subscription. Each resource can be linked to 50 other resources.
// If any of the linked resources are deleted or moved, the link owner must
// clean up the remaining link.
type ResourceLinksClient struct {
	ManagementClient
}

// NewResourceLinksClient creates an instance of the ResourceLinksClient
// client.
...
// NewResourceLinksClientWithBaseURI creates an instance of the
// ResourceLinksClient client.
...
// source scope.
//
// scope is the fully qualified ID of the scope for getting the resource links.
// For example, to list resource links at and under a resource group, set the
// scope to
// /subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/myGroup.
// filter is the filter to apply when getting resource links. To get links only
