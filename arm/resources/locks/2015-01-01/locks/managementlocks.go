...
// CreateOrUpdateAtResourceGroupLevel create or update a management lock at the
...
// DeleteAtResourceLevel deletes the management lock of a resource or any level
// below resource.
//
// resourceGroupName is the name of the resource group.
// resourceProviderNamespace is resource identity. parentResourcePath is
...
// ListAtResourceLevel gets all the management locks of a resource or any level
// below resource.
//
...
// resourceName is resource identity. filter is the filter to apply on the
// operation.
