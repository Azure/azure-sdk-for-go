...
// NewAppliancesClientWithBaseURI creates an instance of the AppliancesClient
// client.
...
// CreateOrUpdate creates a new appliance. This method may poll for completion.
...
// insensitive. applianceName is the name of the appliance. parameters is
...
// CreateOrUpdateByID creates a new appliance. This method may poll for
// completion. Polling can be canceled by passing the cancel channel argument.
// The channel will be used to cancel polling and any outstanding HTTP
// requests.
//
// applianceID is the fully qualified ID of the appliance, including the
// appliance name and the appliance resource type. Use the format,
...
// Delete deletes the appliance. This method may poll for completion. Polling
// can be canceled by passing the cancel channel argument. The channel will be
// used to cancel polling and any outstanding HTTP requests.
//
// resourceGroupName is the name of the resource group. The name is case
// insensitive. applianceName is the name of the appliance.
...
// DeleteByID deletes the appliance. This method may poll for completion.
// Polling can be canceled by passing the cancel channel argument. The channel
// will be used to cancel polling and any outstanding HTTP requests.
//
// applianceID is the fully qualified ID of the appliance, including the
...
// Update updates an existing appliance. The only value that can be updated via
...
// UpdateByID updates an existing appliance. The only value that can be updated
