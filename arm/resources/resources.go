...
// ResourcesManagementClient is the client for the Resources methods of the
// Resources service.
type ResourcesManagementClient struct {
	ManagementClient
}

// NewResourcesManagementClient creates an instance of the
// ResourcesManagementClient client.
func NewResourcesManagementClient(subscriptionID string) ResourcesManagementClient {
	return NewResourcesManagementClientWithBaseURI(DefaultBaseURI, subscriptionID)
}

// NewResourcesManagementClientWithBaseURI creates an instance of the
// ResourcesManagementClient client.
func NewResourcesManagementClientWithBaseURI(baseURI string, subscriptionID string) ResourcesManagementClient {
	return ResourcesManagementClient{NewWithBaseURI(baseURI, subscriptionID)}
}
...
func (client ResourcesManagementClient) CheckExistence(resourceGroupName string, resourceProviderNamespace string, parentResourcePath string, resourceType string, resourceName string, apiVersion string) (result autorest.Response, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "resources/ResourcesManagementClient", "CheckExistence", "Failure preparing request")
	}

	resp, err := client.CheckExistenceSender(req)
	if err != nil {
		result.Response = resp
		return result, autorest.NewErrorWithError(err, "resources/ResourcesManagementClient", "CheckExistence", "Failure sending request")
	}

	result, err = client.CheckExistenceResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "resources/ResourcesManagementClient", "CheckExistence", "Failure responding to request")
	}
...
func (client ResourcesManagementClient) CreateOrUpdate(resourceGroupName string, resourceProviderNamespace string, parentResourcePath string, resourceType string, resourceName string, apiVersion string, parameters GenericResource) (result GenericResource, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "resources/ResourcesManagementClient", "CreateOrUpdate", "Failure preparing request")
	}

	resp, err := client.CreateOrUpdateSender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "resources/ResourcesManagementClient", "CreateOrUpdate", "Failure sending request")
	}

	result, err = client.CreateOrUpdateResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "resources/ResourcesManagementClient", "CreateOrUpdate", "Failure responding to request")
	}
...
func (client ResourcesManagementClient) Delete(resourceGroupName string, resourceProviderNamespace string, parentResourcePath string, resourceType string, resourceName string, apiVersion string) (result autorest.Response, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "resources/ResourcesManagementClient", "Delete", "Failure preparing request")
	}

	resp, err := client.DeleteSender(req)
	if err != nil {
		result.Response = resp
		return result, autorest.NewErrorWithError(err, "resources/ResourcesManagementClient", "Delete", "Failure sending request")
	}

	result, err = client.DeleteResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "resources/ResourcesManagementClient", "Delete", "Failure responding to request")
	}
...
func (client ResourcesManagementClient) Get(resourceGroupName string, resourceProviderNamespace string, parentResourcePath string, resourceType string, resourceName string, apiVersion string) (result GenericResource, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "resources/ResourcesManagementClient", "Get", "Failure preparing request")
	}

	resp, err := client.GetSender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "resources/ResourcesManagementClient", "Get", "Failure sending request")
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "resources/ResourcesManagementClient", "Get", "Failure responding to request")
	}
...
func (client ResourcesManagementClient) List(filter string, top *int) (result ResourceListResult, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "resources/ResourcesManagementClient", "List", "Failure preparing request")
	}

	resp, err := client.ListSender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "resources/ResourcesManagementClient", "List", "Failure sending request")
	}

	result, err = client.ListResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "resources/ResourcesManagementClient", "List", "Failure responding to request")
	}
...
func (client ResourcesManagementClient) ListNextResults(lastResults ResourceListResult) (result ResourceListResult, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "resources/ResourcesManagementClient", "List", "Failure preparing next results request request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "resources/ResourcesManagementClient", "List", "Failure sending next results request request")
	}

	result, err = client.ListResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "resources/ResourcesManagementClient", "List", "Failure responding to next results request request")
	}
...
func (client ResourcesManagementClient) MoveResources(sourceResourceGroupName string, parameters MoveInfo) (result autorest.Response, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "resources/ResourcesManagementClient", "MoveResources", "Failure preparing request")
	}

	resp, err := client.MoveResourcesSender(req)
	if err != nil {
		result.Response = resp
		return result, autorest.NewErrorWithError(err, "resources/ResourcesManagementClient", "MoveResources", "Failure sending request")
	}

	result, err = client.MoveResourcesResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "resources/ResourcesManagementClient", "MoveResources", "Failure responding to request")
	}
