...
func (client GroupClient) CheckExistenceByID(resourceID string) (result autorest.Response, err error) {
	if err := validation.Validate([]validation.Validation{}); err != nil {
		return result, validation.NewErrorWithValidationError(err, "resources.GroupClient", "CheckExistenceByID")
	}
...
// CreateOrUpdate creates a resource. This method may poll for completion. Polling can be canceled by passing the
...
// CreateOrUpdateByID create a resource by ID. This method may poll for completion. Polling can be canceled by passing
...
// Delete deletes a resource. This method may poll for completion. Polling can be canceled by passing the cancel
...
// DeleteByID deletes a resource by ID. This method may poll for completion. Polling can be canceled by passing the
// cancel channel argument. The channel will be used to cancel polling and any outstanding HTTP requests.
//
// resourceID is the fully qualified ID of the resource, including the resource name and resource type. Use the format,
// /subscriptions/{guid}/resourceGroups/{resource-group-name}/{resource-provider-namespace}/{resource-type}/{resource-name}
func (client GroupClient) DeleteByID(resourceID string, cancel <-chan struct{}) (<-chan autorest.Response, <-chan error) {
	...
	errChan := make(chan error, 1)
	if err := validation.Validate([]validation.Validation{}); err != nil {
		errChan <- validation.NewErrorWithValidationError(err, "resources.GroupClient", "DeleteByID")
		close(errChan)
		close(resultChan)
		return resultChan, errChan
	}
...
func (client GroupClient) GetByID(resourceID string) (result GenericResource, err error) {
	if err := validation.Validate([]validation.Validation{}); err != nil {
		return result, validation.NewErrorWithValidationError(err, "resources.GroupClient", "GetByID")
	}
...
func (client GroupClient) List(filter string, expand string, top *int32) (result ListResult, err error) {
	if err := validation.Validate([]validation.Validation{}); err != nil {
		return result, validation.NewErrorWithValidationError(err, "resources.GroupClient", "List")
	}
...
//
// resourceGroupName is the resource group with the resources to get. filter is the filter to apply on the operation.
// expand is the $expand query parameter top is the number of results to return. If null is passed, returns all
// resources.
	...
	if err := validation.Validate([]validation.Validation{
		{TargetValue: resourceGroupName,
			Constraints: []validation.Constraint{{Target: "resourceGroupName", Name: validation.MaxLength, Rule: 90, Chain: nil},
				{Target: "resourceGroupName", Name: validation.MinLength, Rule: 1, Chain: nil},
				{Target: "resourceGroupName", Name: validation.Pattern, Rule: `^[-\w\._\(\)]+$`, Chain: nil}}}}); err != nil {
		return result, validation.NewErrorWithValidationError(err, "resources.GroupClient", "ListByResourceGroup")
	}

	req, err := client.ListByResourceGroupPreparer(resourceGroupName, filter, expand, top)
	if err != nil {
...
func (client GroupClient) ListByResourceGroupNextResults(lastResults ListResult) (result ListResult, err error) {
	req, err := lastResults.ListResultPreparer()
	if err != nil {
		return result, autorest.NewErrorWithError(err, "resources.GroupClient", "ListByResourceGroup", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "resources.GroupClient", "ListByResourceGroup", resp, "Failure sending next results request")
	}

	result, err = client.ListByResourceGroupResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "resources.GroupClient", "ListByResourceGroup", resp, "Failure responding to next results request")
	}
...
func (client GroupClient) ListByResourceGroupComplete(resourceGroupName string, filter string, expand string, top *int32, cancel <-chan struct{}) (<-chan GenericResource, <-chan error) {
	...
	go func() {
		...
		list, err := client.ListByResourceGroup(resourceGroupName, filter, expand, top)
		if err != nil {
			errChan <- err
			return
		}
...
// duration of the operation. Write and delete operations are blocked on the groups until the move completes.  This
...
//
// sourceResourceGroupName is the name of the resource group containing the resources to move. parameters is parameters
...
// check the result of the long-running operation. This method may poll for completion. Polling can be canceled by
// passing the cancel channel argument. The channel will be used to cancel polling and any outstanding HTTP requests.
//
// sourceResourceGroupName is the name of the resource group containing the resources to validate for move. parameters
// is parameters for moving resources.
func (client GroupClient) ValidateMoveResources(sourceResourceGroupName string, parameters MoveInfo, cancel <-chan struct{}) (<-chan autorest.Response, <-chan error) {
	...
	if err := validation.Validate([]validation.Validation{
		{TargetValue: sourceResourceGroupName,
			Constraints: []validation.Constraint{{Target: "sourceResourceGroupName", Name: validation.MaxLength, Rule: 90, Chain: nil},
				{Target: "sourceResourceGroupName", Name: validation.MinLength, Rule: 1, Chain: nil},
				{Target: "sourceResourceGroupName", Name: validation.Pattern, Rule: `^[-\w\._\(\)]+$`, Chain: nil}}}}); err != nil {
		errChan <- validation.NewErrorWithValidationError(err, "resources.GroupClient", "ValidateMoveResources")
		close(errChan)
		close(resultChan)
		return resultChan, errChan
	}
	...
	go func() {
		...
		req, err := client.ValidateMoveResourcesPreparer(sourceResourceGroupName, parameters, cancel)
		if err != nil {
		...
		if err != nil {
			result.Response = resp
			err = autorest.NewErrorWithError(err, "resources.GroupClient", "ValidateMoveResources", resp, "Failure sending request")
			return
		}

		result, err = client.ValidateMoveResourcesResponder(resp)
		if err != nil {
			err = autorest.NewErrorWithError(err, "resources.GroupClient", "ValidateMoveResources", resp, "Failure responding to request")
		}
	}()
	return resultChan, errChan
}
