...
func (client ManagementClient) Get(subscriptionID string) (result Subscription, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "subscriptions/ManagementClient", "Get", autorest.UndefinedStatusCode, "Failure preparing request")
	}

	resp, err := client.GetSender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "subscriptions/ManagementClient", "Get", resp.StatusCode, "Failure sending request")
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "subscriptions/ManagementClient", "Get", resp.StatusCode, "Failure responding to request")
	}
...
func (client ManagementClient) List() (result SubscriptionListResult, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "subscriptions/ManagementClient", "List", autorest.UndefinedStatusCode, "Failure preparing request")
	}

	resp, err := client.ListSender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "subscriptions/ManagementClient", "List", resp.StatusCode, "Failure sending request")
	}

	result, err = client.ListResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "subscriptions/ManagementClient", "List", resp.StatusCode, "Failure responding to request")
	}
...
func (client ManagementClient) ListNextResults(lastResults SubscriptionListResult) (result SubscriptionListResult, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "subscriptions/ManagementClient", "List", autorest.UndefinedStatusCode, "Failure preparing next results request request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "subscriptions/ManagementClient", "List", resp.StatusCode, "Failure sending next results request request")
	}

	result, err = client.ListResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "subscriptions/ManagementClient", "List", resp.StatusCode, "Failure responding to next results request request")
	}
...
func (client ManagementClient) ListLocations(subscriptionID string) (result LocationListResult, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "subscriptions/ManagementClient", "ListLocations", autorest.UndefinedStatusCode, "Failure preparing request")
	}

	resp, err := client.ListLocationsSender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "subscriptions/ManagementClient", "ListLocations", resp.StatusCode, "Failure sending request")
	}

	result, err = client.ListLocationsResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "subscriptions/ManagementClient", "ListLocations", resp.StatusCode, "Failure responding to request")
	}
...
func (client ManagementClient) ListLocationsNextResults(lastResults LocationListResult) (result LocationListResult, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "subscriptions/ManagementClient", "ListLocations", autorest.UndefinedStatusCode, "Failure preparing next results request request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "subscriptions/ManagementClient", "ListLocations", resp.StatusCode, "Failure sending next results request request")
	}

	result, err = client.ListLocationsResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "subscriptions/ManagementClient", "ListLocations", resp.StatusCode, "Failure responding to next results request request")
	}
