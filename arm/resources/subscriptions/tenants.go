...
func (client TenantsClient) List() (result TenantListResult, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "subscriptions/TenantsClient", "List", autorest.UndefinedStatusCode, "Failure preparing request")
	}

	resp, err := client.ListSender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "subscriptions/TenantsClient", "List", resp.StatusCode, "Failure sending request")
	}

	result, err = client.ListResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "subscriptions/TenantsClient", "List", resp.StatusCode, "Failure responding to request")
	}
...
func (client TenantsClient) ListNextResults(lastResults TenantListResult) (result TenantListResult, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "subscriptions/TenantsClient", "List", autorest.UndefinedStatusCode, "Failure preparing next results request request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "subscriptions/TenantsClient", "List", resp.StatusCode, "Failure sending next results request request")
	}

	result, err = client.ListResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "subscriptions/TenantsClient", "List", resp.StatusCode, "Failure responding to next results request request")
	}
