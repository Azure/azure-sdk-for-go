...
type JobDefinition struct {
	...
	Properties struct {
		...
		Status struct {
			...
			LastExecutionTime date.DateTime `json:"lastExecutionTime,omitempty"`
			NextExecutionTime date.DateTime `json:"nextExecutionTime,omitempty"`
...
type JobHistoryDefinition struct {
	...
	Properties struct {
		StartTime             date.DateTime        `json:"startTime,omitempty"`
		EndTime               date.DateTime        `json:"endTime,omitempty"`
		ExpectedExecutionTime date.DateTime        `json:"expectedExecutionTime,omitempty"`
