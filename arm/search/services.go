...
// CheckNameAvailability checks whether or not the given Search service name
// is available for use. Search service names must be globally unique since
// they are part of the service URI (https://<name>.search.windows.net).
//
...
func (client ServicesClient) CheckNameAvailability(checkNameAvailabilityInput CheckNameAvailabilityInput, xMsClientRequestID *uuid.UUID) (result CheckNameAvailabilityOutput, err error) {
	...
	req, err := client.CheckNameAvailabilityPreparer(checkNameAvailabilityInput, xMsClientRequestID)
	if err != nil {
...
func (client ServicesClient) CheckNameAvailabilityPreparer(checkNameAvailabilityInput CheckNameAvailabilityInput, xMsClientRequestID *uuid.UUID) (*http.Request, error) {
...
// last one characters, cannot contain consecutive dashes, and must be
...
// after the service is created. service is the definition of the Search
// service to create or update. xMsClientRequestID is a client-generated GUID
// value that identifies this request. If specified, this will be included in
...
func (client ServicesClient) CreateOrUpdate(resourceGroupName string, searchServiceName string, service Service, xMsClientRequestID *uuid.UUID) (result Service, err error) {
	...
	req, err := client.CreateOrUpdatePreparer(resourceGroupName, searchServiceName, service, xMsClientRequestID)
	if err != nil {
...
func (client ServicesClient) CreateOrUpdatePreparer(resourceGroupName string, searchServiceName string, service Service, xMsClientRequestID *uuid.UUID) (*http.Request, error) {
	pathParameters := map[string]interface{}{
...
// the request.
func (client ServicesClient) Delete(resourceGroupName string, searchServiceName string, xMsClientRequestID *uuid.UUID) (result autorest.Response, err error) {
	req, err := client.DeletePreparer(resourceGroupName, searchServiceName, xMsClientRequestID)
	if err != nil {
...
func (client ServicesClient) DeletePreparer(resourceGroupName string, searchServiceName string, xMsClientRequestID *uuid.UUID) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"searchServiceName": autorest.Encode("path", searchServiceName),
		"subscriptionId":    autorest.Encode("path", client.SubscriptionID),
...
// specified, this will be included in response information as a way to track
// the request.
func (client ServicesClient) Get(resourceGroupName string, searchServiceName string, xMsClientRequestID *uuid.UUID) (result Service, err error) {
...
func (client ServicesClient) GetPreparer(resourceGroupName string, searchServiceName string, xMsClientRequestID *uuid.UUID) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"searchServiceName": autorest.Encode("path", searchServiceName),
		"subscriptionId":    autorest.Encode("path", client.SubscriptionID),
...
// ListByResourceGroup gets a list of all Search services in the given
// resource group.
//
// resourceGroupName is the name of the resource group within the current
// subscription. You can obtain this value from the Azure Resource Manager
// API or the portal. xMsClientRequestID is a client-generated GUID value
// that identifies this request. If specified, this will be included in
// response information as a way to track the request.
func (client ServicesClient) ListByResourceGroup(resourceGroupName string, xMsClientRequestID *uuid.UUID) (result ServiceListResult, err error) {
	req, err := client.ListByResourceGroupPreparer(resourceGroupName, xMsClientRequestID)
	if err != nil {
...
func (client ServicesClient) ListByResourceGroupPreparer(resourceGroupName string, xMsClientRequestID *uuid.UUID) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"subscriptionId":    autorest.Encode("path", client.SubscriptionID),
	}
