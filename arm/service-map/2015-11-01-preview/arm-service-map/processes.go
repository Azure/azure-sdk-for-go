...
func (client ProcessesClient) Get(resourceGroupName string, workspaceName string, machineName string, processName string, timestamp *date.Time) (result Process, err error) {
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewErrorWithValidationError(err, "armservicemap.ProcessesClient", "Get")
	}

	req, err := client.GetPreparer(resourceGroupName, workspaceName, machineName, processName, timestamp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "armservicemap.ProcessesClient", "Get", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "armservicemap.ProcessesClient", "Get", resp, "Failure sending request")
		return
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "armservicemap.ProcessesClient", "Get", resp, "Failure responding to request")
	}
...
func (client ProcessesClient) GetLiveness(resourceGroupName string, workspaceName string, machineName string, processName string, startTime *date.Time, endTime *date.Time) (result Liveness, err error) {
	if err := validation.Validate([]validation.Validation{
		...
		{TargetValue: processName,
			Constraints: []validation.Constraint{{Target: "processName", Name: validation.MaxLength, Rule: 128, Chain: nil},
				{Target: "processName", Name: validation.MinLength, Rule: 3, Chain: nil}}}}); err != nil {
		return result, validation.NewErrorWithValidationError(err, "armservicemap.ProcessesClient", "GetLiveness")
	}

	req, err := client.GetLivenessPreparer(resourceGroupName, workspaceName, machineName, processName, startTime, endTime)
	if err != nil {
		err = autorest.NewErrorWithError(err, "armservicemap.ProcessesClient", "GetLiveness", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "armservicemap.ProcessesClient", "GetLiveness", resp, "Failure sending request")
		return
	}

	result, err = client.GetLivenessResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "armservicemap.ProcessesClient", "GetLiveness", resp, "Failure responding to request")
	}
...
func (client ProcessesClient) ListAcceptingPorts(resourceGroupName string, workspaceName string, machineName string, processName string, startTime *date.Time, endTime *date.Time) (result PortCollection, err error) {
	if err := validation.Validate([]validation.Validation{
		...
		{TargetValue: processName,
			Constraints: []validation.Constraint{{Target: "processName", Name: validation.MaxLength, Rule: 128, Chain: nil},
				{Target: "processName", Name: validation.MinLength, Rule: 3, Chain: nil}}}}); err != nil {
		return result, validation.NewErrorWithValidationError(err, "armservicemap.ProcessesClient", "ListAcceptingPorts")
	}

	req, err := client.ListAcceptingPortsPreparer(resourceGroupName, workspaceName, machineName, processName, startTime, endTime)
	if err != nil {
		err = autorest.NewErrorWithError(err, "armservicemap.ProcessesClient", "ListAcceptingPorts", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "armservicemap.ProcessesClient", "ListAcceptingPorts", resp, "Failure sending request")
		return
	}

	result, err = client.ListAcceptingPortsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "armservicemap.ProcessesClient", "ListAcceptingPorts", resp, "Failure responding to request")
	}
...
func (client ProcessesClient) ListAcceptingPortsNextResults(lastResults PortCollection) (result PortCollection, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "armservicemap.ProcessesClient", "ListAcceptingPorts", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "armservicemap.ProcessesClient", "ListAcceptingPorts", resp, "Failure sending next results request")
	}

	result, err = client.ListAcceptingPortsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "armservicemap.ProcessesClient", "ListAcceptingPorts", resp, "Failure responding to next results request")
	}
...
func (client ProcessesClient) ListConnections(resourceGroupName string, workspaceName string, machineName string, processName string, startTime *date.Time, endTime *date.Time) (result ConnectionCollection, err error) {
	if err := validation.Validate([]validation.Validation{
		...
		{TargetValue: processName,
			Constraints: []validation.Constraint{{Target: "processName", Name: validation.MaxLength, Rule: 128, Chain: nil},
				{Target: "processName", Name: validation.MinLength, Rule: 3, Chain: nil}}}}); err != nil {
		return result, validation.NewErrorWithValidationError(err, "armservicemap.ProcessesClient", "ListConnections")
	}

	req, err := client.ListConnectionsPreparer(resourceGroupName, workspaceName, machineName, processName, startTime, endTime)
	if err != nil {
		err = autorest.NewErrorWithError(err, "armservicemap.ProcessesClient", "ListConnections", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "armservicemap.ProcessesClient", "ListConnections", resp, "Failure sending request")
		return
	}

	result, err = client.ListConnectionsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "armservicemap.ProcessesClient", "ListConnections", resp, "Failure responding to request")
	}
...
func (client ProcessesClient) ListConnectionsNextResults(lastResults ConnectionCollection) (result ConnectionCollection, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "armservicemap.ProcessesClient", "ListConnections", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "armservicemap.ProcessesClient", "ListConnections", resp, "Failure sending next results request")
	}

	result, err = client.ListConnectionsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "armservicemap.ProcessesClient", "ListConnections", resp, "Failure responding to next results request")
	}
