...
// NewMachinesClientWithAuthFile creates an instance of the MachinesClient client.
func NewMachinesClientWithAuthFile() (MachinesClient, error) {
	c, err := NewWithAuthFile()
	return MachinesClient{c}, err
}
