...
func (cgp *ClientGroupProperties) UnmarshalJSON(body []byte) error {
...
func (pp *PortProperties) UnmarshalJSON(body []byte) error {
	var m map[string]*json.RawMessage
	err := json.Unmarshal(body, &m)
	if err != nil {
		return err
	...
	if v != nil {
		...
		pp.MonitoringState = monitoringState
	}
...
func (pp *ProcessProperties) UnmarshalJSON(body []byte) error {
	var m map[string]*json.RawMessage
	err := json.Unmarshal(body, &m)
	if err != nil {
		return err
	...
	if v != nil {
		...
		pp.ExecutableName = &executableName
	}
