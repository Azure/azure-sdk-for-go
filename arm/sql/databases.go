		...
		{TargetValue: parameters,
			Constraints: []validation.Constraint{{Target: "parameters.Properties", Name: validation.Null, Rule: false,
				Chain: []validation.Constraint{{Target: "parameters.Properties.CreationDate", Name: validation.ReadOnly, Rule: true, Chain: nil},
					{Target: "parameters.Properties.ContainmentState", Name: validation.ReadOnly, Rule: true, Chain: nil},
					{Target: "parameters.Properties.CurrentServiceObjectiveID", Name: validation.ReadOnly, Rule: true, Chain: nil},
					{Target: "parameters.Properties.DatabaseID", Name: validation.ReadOnly, Rule: true, Chain: nil},
					{Target: "parameters.Properties.EarliestRestoreDate", Name: validation.ReadOnly, Rule: true, Chain: nil},
					{Target: "parameters.Properties.ServiceLevelObjective", Name: validation.ReadOnly, Rule: true, Chain: nil},
					{Target: "parameters.Properties.Status", Name: validation.ReadOnly, Rule: true, Chain: nil},
					{Target: "parameters.Properties.DefaultSecondaryLocation", Name: validation.ReadOnly, Rule: true, Chain: nil},
					{Target: "parameters.Properties.ServiceTierAdvisors", Name: validation.ReadOnly, Rule: true, Chain: nil},
					{Target: "parameters.Properties.UpgradeHint", Name: validation.ReadOnly, Rule: true, Chain: nil},
					{Target: "parameters.Properties.Schemas", Name: validation.ReadOnly, Rule: true, Chain: nil},
					{Target: "parameters.Properties.TransparentDataEncryption", Name: validation.ReadOnly, Rule: true, Chain: nil},
					{Target: "parameters.Properties.RecommendedIndex", Name: validation.ReadOnly, Rule: true, Chain: nil},
				}}}}}); err != nil {
