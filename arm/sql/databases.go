...
// CreateOrUpdate creates a new Azure SQL database or updates an existing Azure
// SQL database. Location is a required property in the request body, and it
// must be the same as the location of the SQL server. This method may poll for
...
// the portal. serverName is the name of the Azure SQL server. databaseName is
// the name of the Azure SQL database to be operated on (updated or created).
// parameters is the required parameters for creating or updating a database.
...
// Encryption applies. parameters is the required parameters for creating or
...
// resource. You can obtain this value from the Azure Resource Manager API or
// the portal. serverName is the name of the Azure SQL server. databaseName is
// the name of the Azure SQL database to be retrieved. expand is the comma
...
// resource. You can obtain this value from the Azure Resource Manager API or
// the portal. serverName is the name of the Azure SQL server. databaseName is
// the name of database. serviceTierAdvisorName is the name of service tier
// advisor.
...
// resource. You can obtain this value from the Azure Resource Manager API or
// the portal. serverName is the name of the Azure SQL server. databaseName is
// the name of the Azure SQL database for which the Transparent Data Encryption
// applies.
...
// ResumeDataWarehouse resume an Azure SQL Data Warehouse database. This method
// may poll for completion. Polling can be canceled by passing the cancel
// channel argument. The channel will be used to cancel polling and any
// outstanding HTTP requests.
//
