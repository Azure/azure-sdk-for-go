...
// functionality for Azure SQL resources including servers, databases, elastic
...
// Azure SQL elastic pool. This method may poll for completion. Polling can be
...
// the portal. serverName is the name of the Azure SQL server. elasticPoolName
// is the name of the Azure SQL Elastic Pool to be operated on (Updated or
// created). parameters is the required parameters for creating or updating an
// Elastic Pool.
...
// resource. You can obtain this value from the Azure Resource Manager API or
// the portal. serverName is the name of the Azure SQL server. elasticPoolName
// is the name of the Azure SQL Elastic Pool to be deleted.
...
// resource. You can obtain this value from the Azure Resource Manager API or
// the portal. serverName is the name of the Azure SQL server. elasticPoolName
// is the name of the Azure SQL Elastic Pool to be retrieved.
...
// resource. You can obtain this value from the Azure Resource Manager API or
// the portal. serverName is the name of the Azure SQL server. elasticPoolName
// is the name of the Azure SQL Elastic Pool to be retrieved. databaseName is
...
// resource. You can obtain this value from the Azure Resource Manager API or
// the portal. serverName is the name of the Azure SQL server. elasticPoolName
// is the name of the Azure SQL Elastic Pool for which to get the current
// activity.
...
// resource. You can obtain this value from the Azure Resource Manager API or
// the portal. serverName is the name of the Azure SQL server. elasticPoolName
// is the name of the Azure SQL Elastic Pool.
