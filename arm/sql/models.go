...
const (
	// TargetDatabaseEditionsBasic specifies the target database editions basic
...
// ColumnProperties is represents the properties of an Azure SQL Database table
// column.
...
// ElasticPoolActivityListResult is represents the response to a List Azure SQL
// Elastic Pool Activity request.
...
// ElasticPoolListResult is represents the response to a List Azure SQL Elastic
// Pool request.
...
// Azure SQL Recommended Elastic Pool metrics request.
...
// RestorePointProperties is represents the properties of an Azure SQL Database
// restore point.
...
// ServerMetricListResult is represents the response to a List Azure SQL server
// metrics request.
...
// TransparentDataEncryptionProperties is represents the properties of an Azure
