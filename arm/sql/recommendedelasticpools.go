...
// recommendedElasticPoolName is the name of the Azure SQL Recommended Elastic
...
// GetDatabases gets information about an Azure SQL database inside of an Azure
