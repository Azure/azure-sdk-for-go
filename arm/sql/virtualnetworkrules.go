...
// NewVirtualNetworkRulesClientWithAuthFile creates an instance of the VirtualNetworkRulesClient client.
func NewVirtualNetworkRulesClientWithAuthFile() (VirtualNetworkRulesClient, error) {
	c, err := NewWithAuthFile()
	return VirtualNetworkRulesClient{c}, err
}
