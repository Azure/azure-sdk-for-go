...
// and subsequent PUT request is issued with exact same set of properties, then
// HTTP 200 would be returned.  This method may poll for completion. Polling
...
//
// resourceGroupName is the name of the resource group. accountName is the name
...
// be used to add a custom domain (note that custom domains cannot be added via
...
// specified resource group. Storage account names must be between 3 and 24
// characters in length and use numbers and lower-case letters only. parameters
// is the parameters to update on the account. Note that only one property can
