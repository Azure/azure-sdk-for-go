...
// AccessControlRecordsClient is the client for the AccessControlRecords
// methods of the Storsimple service.
type AccessControlRecordsClient struct {
	ManagementClient
}

// NewAccessControlRecordsClient creates an instance of the
// AccessControlRecordsClient client.
func NewAccessControlRecordsClient(deviceName string, subscriptionID string) AccessControlRecordsClient {
	return NewAccessControlRecordsClientWithBaseURI(DefaultBaseURI, deviceName, subscriptionID)
}

// NewAccessControlRecordsClientWithBaseURI creates an instance of the
// AccessControlRecordsClient client.
func NewAccessControlRecordsClientWithBaseURI(baseURI string, deviceName string, subscriptionID string) AccessControlRecordsClient {
	return AccessControlRecordsClient{NewWithBaseURI(baseURI, deviceName, subscriptionID)}
}

// CreateOrUpdate creates or Updates an access control record. This method may
// poll for completion. Polling can be canceled by passing the cancel channel
// argument. The channel will be used to cancel polling and any outstanding
// HTTP requests.
//
// accessControlRecordName is the name of the access control record. parameters
// is the access control record to be added or updated. resourceGroupName is
...
// Delete deletes the access control record. This method may poll for
// completion. Polling can be canceled by passing the cancel channel argument.
// The channel will be used to cancel polling and any outstanding HTTP
// requests.
//
// accessControlRecordName is the name of the access control record to delete.
...
//
// accessControlRecordName is name of access control record to be fetched.
// resourceGroupName is the resource group name managerName is the manager name
