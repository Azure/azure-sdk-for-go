...
func NewAlertsClient(deviceName string, subscriptionID string) AlertsClient {
	return NewAlertsClientWithBaseURI(DefaultBaseURI, deviceName, subscriptionID)
}

// NewAlertsClientWithBaseURI creates an instance of the AlertsClient client.
func NewAlertsClientWithBaseURI(baseURI string, deviceName string, subscriptionID string) AlertsClient {
	return AlertsClient{NewWithBaseURI(baseURI, deviceName, subscriptionID)}
}
...
//
// parameters is the send test alert email request. resourceGroupName is the
// resource group name managerName is the manager name
func (client AlertsClient) SendTestEmail(parameters SendTestAlertEmailRequest, resourceGroupName string, managerName string) (result autorest.Response, err error) {
	if err := validation.Validate([]validation.Validation{
		{TargetValue: parameters,
	...
	req, err := client.SendTestEmailPreparer(parameters, resourceGroupName, managerName)
	if err != nil {
...
func (client AlertsClient) SendTestEmailPreparer(parameters SendTestAlertEmailRequest, resourceGroupName string, managerName string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
