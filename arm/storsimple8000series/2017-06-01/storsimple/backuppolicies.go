...
// client.
func NewBackupPoliciesClient(deviceName string, subscriptionID string) BackupPoliciesClient {
	return NewBackupPoliciesClientWithBaseURI(DefaultBaseURI, deviceName, subscriptionID)
}

// NewBackupPoliciesClientWithBaseURI creates an instance of the
// BackupPoliciesClient client.
func NewBackupPoliciesClientWithBaseURI(baseURI string, deviceName string, subscriptionID string) BackupPoliciesClient {
	return BackupPoliciesClient{NewWithBaseURI(baseURI, deviceName, subscriptionID)}
}
...
//
// backupPolicyName is the backup policy name. backupType is the backup Type.
// This can be cloudSnapshot or localSnapshot. resourceGroupName is the
// resource group name managerName is the manager name
func (client BackupPoliciesClient) BackupNow(backupPolicyName string, backupType string, resourceGroupName string, managerName string, cancel <-chan struct{}) (<-chan autorest.Response, <-chan error) {
	...
	go func() {
		...
		req, err := client.BackupNowPreparer(backupPolicyName, backupType, resourceGroupName, managerName, cancel)
		if err != nil {
...
func (client BackupPoliciesClient) BackupNowPreparer(backupPolicyName string, backupType string, resourceGroupName string, managerName string, cancel <-chan struct{}) (*http.Request, error) {
...
// HTTP requests.
//
// backupPolicyName is the name of the backup policy to be created/updated.
// parameters is the backup policy. resourceGroupName is the resource group
// name managerName is the manager name
func (client BackupPoliciesClient) CreateOrUpdate(backupPolicyName string, parameters BackupPolicy, resourceGroupName string, managerName string, cancel <-chan struct{}) (<-chan BackupPolicy, <-chan error) {
	...
	go func() {
		...
		req, err := client.CreateOrUpdatePreparer(backupPolicyName, parameters, resourceGroupName, managerName, cancel)
		if err != nil {
...
func (client BackupPoliciesClient) CreateOrUpdatePreparer(backupPolicyName string, parameters BackupPolicy, resourceGroupName string, managerName string, cancel <-chan struct{}) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"backupPolicyName":  backupPolicyName,
		"deviceName":        client.DeviceName,
		"managerName":       managerName,
...
// will be used to cancel polling and any outstanding HTTP requests.
//
// backupPolicyName is the name of the backup policy. resourceGroupName is the
// resource group name managerName is the manager name
func (client BackupPoliciesClient) Delete(backupPolicyName string, resourceGroupName string, managerName string, cancel <-chan struct{}) (<-chan autorest.Response, <-chan error) {
	resultChan := make(chan autorest.Response, 1)
	errChan := make(chan error, 1)
	if err := validation.Validate([]validation.Validation{
		{TargetValue: managerName,
	...
	go func() {
		...
		req, err := client.DeletePreparer(backupPolicyName, resourceGroupName, managerName, cancel)
		if err != nil {
...
func (client BackupPoliciesClient) DeletePreparer(backupPolicyName string, resourceGroupName string, managerName string, cancel <-chan struct{}) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"backupPolicyName":  backupPolicyName,
		"deviceName":        client.DeviceName,
		"managerName":       managerName,
...
//
// backupPolicyName is the name of backup policy to be fetched.
// resourceGroupName is the resource group name managerName is the manager name
func (client BackupPoliciesClient) Get(backupPolicyName string, resourceGroupName string, managerName string) (result BackupPolicy, err error) {
	if err := validation.Validate([]validation.Validation{
		{TargetValue: managerName,
			Constraints: []validation.Constraint{{Target: "managerName", Name: validation.MaxLength, Rule: 50, Chain: nil},
				{Target: "managerName", Name: validation.MinLength, Rule: 2, Chain: nil}}}}); err != nil {
	...
	req, err := client.GetPreparer(backupPolicyName, resourceGroupName, managerName)
	if err != nil {
...
func (client BackupPoliciesClient) GetPreparer(backupPolicyName string, resourceGroupName string, managerName string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"backupPolicyName":  backupPolicyName,
		"deviceName":        client.DeviceName,
		"managerName":       managerName,
...
//
// resourceGroupName is the resource group name managerName is the manager name
func (client BackupPoliciesClient) ListByDevice(resourceGroupName string, managerName string) (result BackupPolicyList, err error) {
	if err := validation.Validate([]validation.Validation{
		{TargetValue: managerName,
			Constraints: []validation.Constraint{{Target: "managerName", Name: validation.MaxLength, Rule: 50, Chain: nil},
				{Target: "managerName", Name: validation.MinLength, Rule: 2, Chain: nil}}}}); err != nil {
...
func (client BackupPoliciesClient) ListByDevicePreparer(resourceGroupName string, managerName string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"deviceName":        client.DeviceName,
		"managerName":       managerName,
		"resourceGroupName": resourceGroupName,
