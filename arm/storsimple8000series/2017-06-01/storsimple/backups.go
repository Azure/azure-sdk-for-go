...
// BackupsClient is the client for the Backups methods of the Storsimple
// service.
...
func NewBackupsClient(deviceName string, subscriptionID string) BackupsClient {
	return NewBackupsClientWithBaseURI(DefaultBaseURI, deviceName, subscriptionID)
}

// NewBackupsClientWithBaseURI creates an instance of the BackupsClient client.
func NewBackupsClientWithBaseURI(baseURI string, deviceName string, subscriptionID string) BackupsClient {
	return BackupsClient{NewWithBaseURI(baseURI, deviceName, subscriptionID)}
}
...
// requests.
//
// backupName is the backup name. backupElementName is the backup element name.
// parameters is the clone request object. resourceGroupName is the resource
// group name managerName is the manager name
func (client BackupsClient) Clone(backupName string, backupElementName string, parameters CloneRequest, resourceGroupName string, managerName string, cancel <-chan struct{}) (<-chan autorest.Response, <-chan error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		errChan <- validation.NewErrorWithValidationError(err, "storsimple.BackupsClient", "Clone")
		close(errChan)
		close(resultChan)
	...
	go func() {
		...
		req, err := client.ClonePreparer(backupName, backupElementName, parameters, resourceGroupName, managerName, cancel)
		if err != nil {
		...
		if err != nil {
			...
			err = autorest.NewErrorWithError(err, "storsimple.BackupsClient", "Clone", resp, "Failure sending request")
			return
		}

		result, err = client.CloneResponder(resp)
		if err != nil {
			err = autorest.NewErrorWithError(err, "storsimple.BackupsClient", "Clone", resp, "Failure responding to request")
		}
	}()
	return resultChan, errChan
}
...
func (client BackupsClient) ClonePreparer(backupName string, backupElementName string, parameters CloneRequest, resourceGroupName string, managerName string, cancel <-chan struct{}) (*http.Request, error) {
...
//
// backupName is the backup name. resourceGroupName is the resource group name
// managerName is the manager name
func (client BackupsClient) Delete(backupName string, resourceGroupName string, managerName string, cancel <-chan struct{}) (<-chan autorest.Response, <-chan error) {
	resultChan := make(chan autorest.Response, 1)
	errChan := make(chan error, 1)
	if err := validation.Validate([]validation.Validation{
		{TargetValue: managerName,
			Constraints: []validation.Constraint{{Target: "managerName", Name: validation.MaxLength, Rule: 50, Chain: nil},
				{Target: "managerName", Name: validation.MinLength, Rule: 2, Chain: nil}}}}); err != nil {
		errChan <- validation.NewErrorWithValidationError(err, "storsimple.BackupsClient", "Delete")
		close(errChan)
		close(resultChan)
		return resultChan, errChan
	}
	...
	go func() {
		...
		req, err := client.DeletePreparer(backupName, resourceGroupName, managerName, cancel)
		if err != nil {
		...
		if err != nil {
			result.Response = resp
			err = autorest.NewErrorWithError(err, "storsimple.BackupsClient", "Delete", resp, "Failure sending request")
			return
		}

		result, err = client.DeleteResponder(resp)
		if err != nil {
			err = autorest.NewErrorWithError(err, "storsimple.BackupsClient", "Delete", resp, "Failure responding to request")
		}
	}()
	return resultChan, errChan
}
...
func (client BackupsClient) DeletePreparer(backupName string, resourceGroupName string, managerName string, cancel <-chan struct{}) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"backupName":        backupName,
		"deviceName":        client.DeviceName,
		"managerName":       managerName,
...
func (client BackupsClient) ListByDevice(resourceGroupName string, managerName string, filter string) (result BackupList, err error) {
	if err := validation.Validate([]validation.Validation{
		{TargetValue: managerName,
			Constraints: []validation.Constraint{{Target: "managerName", Name: validation.MaxLength, Rule: 50, Chain: nil},
				{Target: "managerName", Name: validation.MinLength, Rule: 2, Chain: nil}}}}); err != nil {
	...
	req, err := client.ListByDevicePreparer(resourceGroupName, managerName, filter)
	if err != nil {
...
func (client BackupsClient) ListByDevicePreparer(resourceGroupName string, managerName string, filter string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"deviceName":        client.DeviceName,
		"managerName":       managerName,
		"resourceGroupName": resourceGroupName,
...
func (client BackupsClient) ListByDeviceNextResults(lastResults BackupList) (result BackupList, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "storsimple.BackupsClient", "ListByDevice", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "storsimple.BackupsClient", "ListByDevice", resp, "Failure sending next results request")
	}

	result, err = client.ListByDeviceResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "storsimple.BackupsClient", "ListByDevice", resp, "Failure responding to next results request")
	}
...
// requests.
//
// backupName is the backupSet name resourceGroupName is the resource group
// name managerName is the manager name
func (client BackupsClient) Restore(backupName string, resourceGroupName string, managerName string, cancel <-chan struct{}) (<-chan autorest.Response, <-chan error) {
	resultChan := make(chan autorest.Response, 1)
	errChan := make(chan error, 1)
	if err := validation.Validate([]validation.Validation{
		{TargetValue: managerName,
			Constraints: []validation.Constraint{{Target: "managerName", Name: validation.MaxLength, Rule: 50, Chain: nil},
				{Target: "managerName", Name: validation.MinLength, Rule: 2, Chain: nil}}}}); err != nil {
		errChan <- validation.NewErrorWithValidationError(err, "storsimple.BackupsClient", "Restore")
		close(errChan)
		close(resultChan)
		return resultChan, errChan
	}
	...
	go func() {
		...
		req, err := client.RestorePreparer(backupName, resourceGroupName, managerName, cancel)
		if err != nil {
		...
		if err != nil {
			result.Response = resp
			err = autorest.NewErrorWithError(err, "storsimple.BackupsClient", "Restore", resp, "Failure sending request")
			return
		}

		result, err = client.RestoreResponder(resp)
		if err != nil {
			err = autorest.NewErrorWithError(err, "storsimple.BackupsClient", "Restore", resp, "Failure responding to request")
		}
	}()
	return resultChan, errChan
}
...
func (client BackupsClient) RestorePreparer(backupName string, resourceGroupName string, managerName string, cancel <-chan struct{}) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"backupName":        backupName,
		"deviceName":        client.DeviceName,
		"managerName":       managerName,
