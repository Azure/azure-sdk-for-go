...
// client.
func NewBackupSchedulesClient(deviceName string, subscriptionID string) BackupSchedulesClient {
	return NewBackupSchedulesClientWithBaseURI(DefaultBaseURI, deviceName, subscriptionID)
}

// NewBackupSchedulesClientWithBaseURI creates an instance of the
// BackupSchedulesClient client.
func NewBackupSchedulesClientWithBaseURI(baseURI string, deviceName string, subscriptionID string) BackupSchedulesClient {
	return BackupSchedulesClient{NewWithBaseURI(baseURI, deviceName, subscriptionID)}
}
...
// HTTP requests.
//
// backupPolicyName is the backup policy name. backupScheduleName is the backup
// schedule name. parameters is the backup schedule. resourceGroupName is the
// resource group name managerName is the manager name
func (client BackupSchedulesClient) CreateOrUpdate(backupPolicyName string, backupScheduleName string, parameters BackupSchedule, resourceGroupName string, managerName string, cancel <-chan struct{}) (<-chan BackupSchedule, <-chan error) {
	...
	go func() {
		...
		req, err := client.CreateOrUpdatePreparer(backupPolicyName, backupScheduleName, parameters, resourceGroupName, managerName, cancel)
		if err != nil {
...
func (client BackupSchedulesClient) CreateOrUpdatePreparer(backupPolicyName string, backupScheduleName string, parameters BackupSchedule, resourceGroupName string, managerName string, cancel <-chan struct{}) (*http.Request, error) {
...
//
// backupPolicyName is the backup policy name. backupScheduleName is the name
// the backup schedule. resourceGroupName is the resource group name
// managerName is the manager name
func (client BackupSchedulesClient) Delete(backupPolicyName string, backupScheduleName string, resourceGroupName string, managerName string, cancel <-chan struct{}) (<-chan autorest.Response, <-chan error) {
	...
	go func() {
		...
		req, err := client.DeletePreparer(backupPolicyName, backupScheduleName, resourceGroupName, managerName, cancel)
		if err != nil {
...
func (client BackupSchedulesClient) DeletePreparer(backupPolicyName string, backupScheduleName string, resourceGroupName string, managerName string, cancel <-chan struct{}) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"backupPolicyName":   backupPolicyName,
		"backupScheduleName": backupScheduleName,
		"deviceName":         client.DeviceName,
...
//
// backupPolicyName is the backup policy name. backupScheduleName is the name
// of the backup schedule to be fetched resourceGroupName is the resource group
// name managerName is the manager name
func (client BackupSchedulesClient) Get(backupPolicyName string, backupScheduleName string, resourceGroupName string, managerName string) (result BackupSchedule, err error) {
	if err := validation.Validate([]validation.Validation{
		{TargetValue: managerName,
			Constraints: []validation.Constraint{{Target: "managerName", Name: validation.MaxLength, Rule: 50, Chain: nil},
				{Target: "managerName", Name: validation.MinLength, Rule: 2, Chain: nil}}}}); err != nil {
	...
	req, err := client.GetPreparer(backupPolicyName, backupScheduleName, resourceGroupName, managerName)
	if err != nil {
...
func (client BackupSchedulesClient) GetPreparer(backupPolicyName string, backupScheduleName string, resourceGroupName string, managerName string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"backupPolicyName":   backupPolicyName,
		"backupScheduleName": backupScheduleName,
		"deviceName":         client.DeviceName,
...
//
// backupPolicyName is the backup policy name. resourceGroupName is the
// resource group name managerName is the manager name
func (client BackupSchedulesClient) ListByBackupPolicy(backupPolicyName string, resourceGroupName string, managerName string) (result BackupScheduleList, err error) {
	if err := validation.Validate([]validation.Validation{
		{TargetValue: managerName,
			Constraints: []validation.Constraint{{Target: "managerName", Name: validation.MaxLength, Rule: 50, Chain: nil},
				{Target: "managerName", Name: validation.MinLength, Rule: 2, Chain: nil}}}}); err != nil {
	...
	req, err := client.ListByBackupPolicyPreparer(backupPolicyName, resourceGroupName, managerName)
	if err != nil {
...
func (client BackupSchedulesClient) ListByBackupPolicyPreparer(backupPolicyName string, resourceGroupName string, managerName string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"backupPolicyName":  backupPolicyName,
		"deviceName":        client.DeviceName,
		"managerName":       managerName,
