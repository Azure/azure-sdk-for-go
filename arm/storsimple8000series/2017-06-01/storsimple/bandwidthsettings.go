...
func NewBandwidthSettingsClient(deviceName string, subscriptionID string) BandwidthSettingsClient {
	return NewBandwidthSettingsClientWithBaseURI(DefaultBaseURI, deviceName, subscriptionID)
}

// NewBandwidthSettingsClientWithBaseURI creates an instance of the
// BandwidthSettingsClient client.
func NewBandwidthSettingsClientWithBaseURI(baseURI string, deviceName string, subscriptionID string) BandwidthSettingsClient {
	return BandwidthSettingsClient{NewWithBaseURI(baseURI, deviceName, subscriptionID)}
}
