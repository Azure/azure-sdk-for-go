...
// client.
func NewCloudAppliancesClient(deviceName string, subscriptionID string) CloudAppliancesClient {
	return NewCloudAppliancesClientWithBaseURI(DefaultBaseURI, deviceName, subscriptionID)
}

// NewCloudAppliancesClientWithBaseURI creates an instance of the
// CloudAppliancesClient client.
func NewCloudAppliancesClientWithBaseURI(baseURI string, deviceName string, subscriptionID string) CloudAppliancesClient {
	return CloudAppliancesClient{NewWithBaseURI(baseURI, deviceName, subscriptionID)}
}
