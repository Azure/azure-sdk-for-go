...
func NewDevicesClient(deviceName string, subscriptionID string) DevicesClient {
	return NewDevicesClientWithBaseURI(DefaultBaseURI, deviceName, subscriptionID)
}

// NewDevicesClientWithBaseURI creates an instance of the DevicesClient client.
func NewDevicesClientWithBaseURI(baseURI string, deviceName string, subscriptionID string) DevicesClient {
	return DevicesClient{NewWithBaseURI(baseURI, deviceName, subscriptionID)}
}
...
func (client DevicesClient) AuthorizeForServiceEncryptionKeyRollover(resourceGroupName string, managerName string) (result autorest.Response, err error) {
	...
	req, err := client.AuthorizeForServiceEncryptionKeyRolloverPreparer(resourceGroupName, managerName)
	if err != nil {
...
func (client DevicesClient) AuthorizeForServiceEncryptionKeyRolloverPreparer(resourceGroupName string, managerName string) (*http.Request, error) {
...
//
// resourceGroupName is the resource group name managerName is the manager name
func (client DevicesClient) Deactivate(resourceGroupName string, managerName string, cancel <-chan struct{}) (<-chan autorest.Response, <-chan error) {
	resultChan := make(chan autorest.Response, 1)
	errChan := make(chan error, 1)
	if err := validation.Validate([]validation.Validation{
		{TargetValue: managerName,
	...
	go func() {
		...
		req, err := client.DeactivatePreparer(resourceGroupName, managerName, cancel)
		if err != nil {
...
func (client DevicesClient) DeactivatePreparer(resourceGroupName string, managerName string, cancel <-chan struct{}) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"deviceName":        client.DeviceName,
		"managerName":       managerName,
		"resourceGroupName": resourceGroupName,
...
//
// resourceGroupName is the resource group name managerName is the manager name
func (client DevicesClient) Delete(resourceGroupName string, managerName string, cancel <-chan struct{}) (<-chan autorest.Response, <-chan error) {
	resultChan := make(chan autorest.Response, 1)
	errChan := make(chan error, 1)
	if err := validation.Validate([]validation.Validation{
		{TargetValue: managerName,
	...
	go func() {
		...
		req, err := client.DeletePreparer(resourceGroupName, managerName, cancel)
		if err != nil {
...
func (client DevicesClient) DeletePreparer(resourceGroupName string, managerName string, cancel <-chan struct{}) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"deviceName":        client.DeviceName,
		"managerName":       managerName,
		"resourceGroupName": resourceGroupName,
...
func (client DevicesClient) Get(resourceGroupName string, managerName string, expand string) (result Device, err error) {
	if err := validation.Validate([]validation.Validation{
		{TargetValue: managerName,
			Constraints: []validation.Constraint{{Target: "managerName", Name: validation.MaxLength, Rule: 50, Chain: nil},
				{Target: "managerName", Name: validation.MinLength, Rule: 2, Chain: nil}}}}); err != nil {
	...
	req, err := client.GetPreparer(resourceGroupName, managerName, expand)
	if err != nil {
...
func (client DevicesClient) GetPreparer(resourceGroupName string, managerName string, expand string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"deviceName":        client.DeviceName,
		"managerName":       managerName,
		"resourceGroupName": resourceGroupName,
...
//
// resourceGroupName is the resource group name managerName is the manager name
func (client DevicesClient) GetUpdateSummary(resourceGroupName string, managerName string) (result Updates, err error) {
	if err := validation.Validate([]validation.Validation{
		{TargetValue: managerName,
			Constraints: []validation.Constraint{{Target: "managerName", Name: validation.MaxLength, Rule: 50, Chain: nil},
				{Target: "managerName", Name: validation.MinLength, Rule: 2, Chain: nil}}}}); err != nil {
	...
	req, err := client.GetUpdateSummaryPreparer(resourceGroupName, managerName)
	if err != nil {
...
func (client DevicesClient) GetUpdateSummaryPreparer(resourceGroupName string, managerName string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"deviceName":        client.DeviceName,
		"managerName":       managerName,
		"resourceGroupName": resourceGroupName,
...
//
// resourceGroupName is the resource group name managerName is the manager name
func (client DevicesClient) InstallUpdates(resourceGroupName string, managerName string, cancel <-chan struct{}) (<-chan autorest.Response, <-chan error) {
	resultChan := make(chan autorest.Response, 1)
	errChan := make(chan error, 1)
	if err := validation.Validate([]validation.Validation{
		{TargetValue: managerName,
	...
	go func() {
		...
		req, err := client.InstallUpdatesPreparer(resourceGroupName, managerName, cancel)
		if err != nil {
...
func (client DevicesClient) InstallUpdatesPreparer(resourceGroupName string, managerName string, cancel <-chan struct{}) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"deviceName":        client.DeviceName,
		"managerName":       managerName,
		"resourceGroupName": resourceGroupName,
...
//
// resourceGroupName is the resource group name managerName is the manager name
func (client DevicesClient) ListFailoverSets(resourceGroupName string, managerName string) (result FailoverSetsList, err error) {
	if err := validation.Validate([]validation.Validation{
		{TargetValue: managerName,
			Constraints: []validation.Constraint{{Target: "managerName", Name: validation.MaxLength, Rule: 50, Chain: nil},
				{Target: "managerName", Name: validation.MinLength, Rule: 2, Chain: nil}}}}); err != nil {
	...
	req, err := client.ListFailoverSetsPreparer(resourceGroupName, managerName)
	if err != nil {
...
func (client DevicesClient) ListFailoverSetsPreparer(resourceGroupName string, managerName string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"deviceName":        client.DeviceName,
		"managerName":       managerName,
		"resourceGroupName": resourceGroupName,
...
//
// resourceGroupName is the resource group name managerName is the manager name
func (client DevicesClient) ListMetricDefinition(resourceGroupName string, managerName string) (result MetricDefinitionList, err error) {
	if err := validation.Validate([]validation.Validation{
		{TargetValue: managerName,
			Constraints: []validation.Constraint{{Target: "managerName", Name: validation.MaxLength, Rule: 50, Chain: nil},
				{Target: "managerName", Name: validation.MinLength, Rule: 2, Chain: nil}}}}); err != nil {
...
func (client DevicesClient) ListMetricDefinitionPreparer(resourceGroupName string, managerName string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"deviceName":        client.DeviceName,
		"managerName":       managerName,
		"resourceGroupName": resourceGroupName,
...
func (client DevicesClient) ListMetrics(resourceGroupName string, managerName string, filter string) (result MetricList, err error) {
	if err := validation.Validate([]validation.Validation{
		{TargetValue: managerName,
			Constraints: []validation.Constraint{{Target: "managerName", Name: validation.MaxLength, Rule: 50, Chain: nil},
				{Target: "managerName", Name: validation.MinLength, Rule: 2, Chain: nil}}}}); err != nil {
...
func (client DevicesClient) ListMetricsPreparer(resourceGroupName string, managerName string, filter string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"deviceName":        client.DeviceName,
		"managerName":       managerName,
		"resourceGroupName": resourceGroupName,
...
// outstanding HTTP requests.
//
// parameters is the publish support package request. resourceGroupName is the
// resource group name managerName is the manager name
func (client DevicesClient) PublishSupportPackage(parameters SupportPackageRequest, resourceGroupName string, managerName string, cancel <-chan struct{}) (<-chan autorest.Response, <-chan error) {
	resultChan := make(chan autorest.Response, 1)
	errChan := make(chan error, 1)
	if err := validation.Validate([]validation.Validation{
		{TargetValue: parameters,
			Constraints: []validation.Constraint{{Target: "parameters.SdpPassKey", Name: validation.Null, Rule: true, Chain: nil}}},
		{TargetValue: managerName,
			Constraints: []validation.Constraint{{Target: "managerName", Name: validation.MaxLength, Rule: 50, Chain: nil},
				{Target: "managerName", Name: validation.MinLength, Rule: 2, Chain: nil}}}}); err != nil {
		errChan <- validation.NewErrorWithValidationError(err, "storsimple.DevicesClient", "PublishSupportPackage")
		close(errChan)
		close(resultChan)
		return resultChan, errChan
	}
	...
	go func() {
		...
		req, err := client.PublishSupportPackagePreparer(parameters, resourceGroupName, managerName, cancel)
		if err != nil {
			err = autorest.NewErrorWithError(err, "storsimple.DevicesClient", "PublishSupportPackage", nil, "Failure preparing request")
			return
		}

		resp, err := client.PublishSupportPackageSender(req)
		if err != nil {
			result.Response = resp
			err = autorest.NewErrorWithError(err, "storsimple.DevicesClient", "PublishSupportPackage", resp, "Failure sending request")
			return
		}

		result, err = client.PublishSupportPackageResponder(resp)
		if err != nil {
			err = autorest.NewErrorWithError(err, "storsimple.DevicesClient", "PublishSupportPackage", resp, "Failure responding to request")
		}
	}()
	return resultChan, errChan
}
...
func (client DevicesClient) PublishSupportPackagePreparer(parameters SupportPackageRequest, resourceGroupName string, managerName string, cancel <-chan struct{}) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"deviceName":        client.DeviceName,
		"managerName":       managerName,
		"resourceGroupName": resourceGroupName,
...
// http.Response Body if it receives an error.
func (client DevicesClient) PublishSupportPackageSender(req *http.Request) (*http.Response, error) {
	return autorest.SendWithSender(client,
		req,
		azure.DoPollForAsynchronous(client.PollingDelay))
}
...
//
// resourceGroupName is the resource group name managerName is the manager name
func (client DevicesClient) ScanForUpdates(resourceGroupName string, managerName string, cancel <-chan struct{}) (<-chan autorest.Response, <-chan error) {
	resultChan := make(chan autorest.Response, 1)
	errChan := make(chan error, 1)
	if err := validation.Validate([]validation.Validation{
		{TargetValue: managerName,
	...
	go func() {
		...
		req, err := client.ScanForUpdatesPreparer(resourceGroupName, managerName, cancel)
		if err != nil {
...
func (client DevicesClient) ScanForUpdatesPreparer(resourceGroupName string, managerName string, cancel <-chan struct{}) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"deviceName":        client.DeviceName,
		"managerName":       managerName,
		"resourceGroupName": resourceGroupName,
...
//
// parameters is patch representation of the device. resourceGroupName is the
// resource group name managerName is the manager name
func (client DevicesClient) Update(parameters DevicePatch, resourceGroupName string, managerName string) (result Device, err error) {
	if err := validation.Validate([]validation.Validation{
		{TargetValue: managerName,
			Constraints: []validation.Constraint{{Target: "managerName", Name: validation.MaxLength, Rule: 50, Chain: nil},
				{Target: "managerName", Name: validation.MinLength, Rule: 2, Chain: nil}}}}); err != nil {
...
func (client DevicesClient) UpdatePreparer(parameters DevicePatch, resourceGroupName string, managerName string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"deviceName":        client.DeviceName,
		"managerName":       managerName,
		"resourceGroupName": resourceGroupName,
