...
// client.
func NewDeviceSettingsClient(deviceName string, subscriptionID string) DeviceSettingsClient {
	return NewDeviceSettingsClientWithBaseURI(DefaultBaseURI, deviceName, subscriptionID)
}

// NewDeviceSettingsClientWithBaseURI creates an instance of the
// DeviceSettingsClient client.
func NewDeviceSettingsClientWithBaseURI(baseURI string, deviceName string, subscriptionID string) DeviceSettingsClient {
	return DeviceSettingsClient{NewWithBaseURI(baseURI, deviceName, subscriptionID)}
}
...
//
// parameters is the alert settings to be added or updated. resourceGroupName
// is the resource group name managerName is the manager name
func (client DeviceSettingsClient) CreateOrUpdateAlertSettings(parameters AlertSettings, resourceGroupName string, managerName string, cancel <-chan struct{}) (<-chan AlertSettings, <-chan error) {
	...
	go func() {
		...
		req, err := client.CreateOrUpdateAlertSettingsPreparer(parameters, resourceGroupName, managerName, cancel)
		if err != nil {
...
func (client DeviceSettingsClient) CreateOrUpdateAlertSettingsPreparer(parameters AlertSettings, resourceGroupName string, managerName string, cancel <-chan struct{}) (*http.Request, error) {
...
// cancel polling and any outstanding HTTP requests.
//
// parameters is the time settings to be added or updated. resourceGroupName is
// the resource group name managerName is the manager name
func (client DeviceSettingsClient) CreateOrUpdateTimeSettings(parameters TimeSettings, resourceGroupName string, managerName string, cancel <-chan struct{}) (<-chan TimeSettings, <-chan error) {
	...
	go func() {
		...
		req, err := client.CreateOrUpdateTimeSettingsPreparer(parameters, resourceGroupName, managerName, cancel)
		if err != nil {
...
func (client DeviceSettingsClient) CreateOrUpdateTimeSettingsPreparer(parameters TimeSettings, resourceGroupName string, managerName string, cancel <-chan struct{}) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"deviceName":        client.DeviceName,
		"managerName":       managerName,
		"resourceGroupName": resourceGroupName,
...
func (client DeviceSettingsClient) GetAlertSettings(resourceGroupName string, managerName string) (result AlertSettings, err error) {
	if err := validation.Validate([]validation.Validation{
		{TargetValue: managerName,
			Constraints: []validation.Constraint{{Target: "managerName", Name: validation.MaxLength, Rule: 50, Chain: nil},
				{Target: "managerName", Name: validation.MinLength, Rule: 2, Chain: nil}}}}); err != nil {
	...
	req, err := client.GetAlertSettingsPreparer(resourceGroupName, managerName)
	if err != nil {
...
func (client DeviceSettingsClient) GetAlertSettingsPreparer(resourceGroupName string, managerName string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"deviceName":        client.DeviceName,
		"managerName":       managerName,
		"resourceGroupName": resourceGroupName,
...
//
// resourceGroupName is the resource group name managerName is the manager name
func (client DeviceSettingsClient) GetNetworkSettings(resourceGroupName string, managerName string) (result NetworkSettings, err error) {
	if err := validation.Validate([]validation.Validation{
		{TargetValue: managerName,
			Constraints: []validation.Constraint{{Target: "managerName", Name: validation.MaxLength, Rule: 50, Chain: nil},
				{Target: "managerName", Name: validation.MinLength, Rule: 2, Chain: nil}}}}); err != nil {
	...
	req, err := client.GetNetworkSettingsPreparer(resourceGroupName, managerName)
	if err != nil {
...
func (client DeviceSettingsClient) GetNetworkSettingsPreparer(resourceGroupName string, managerName string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"deviceName":        client.DeviceName,
		"managerName":       managerName,
		"resourceGroupName": resourceGroupName,
...
//
// resourceGroupName is the resource group name managerName is the manager name
func (client DeviceSettingsClient) GetSecuritySettings(resourceGroupName string, managerName string) (result SecuritySettings, err error) {
	if err := validation.Validate([]validation.Validation{
		{TargetValue: managerName,
			Constraints: []validation.Constraint{{Target: "managerName", Name: validation.MaxLength, Rule: 50, Chain: nil},
				{Target: "managerName", Name: validation.MinLength, Rule: 2, Chain: nil}}}}); err != nil {
	...
	req, err := client.GetSecuritySettingsPreparer(resourceGroupName, managerName)
	if err != nil {
...
func (client DeviceSettingsClient) GetSecuritySettingsPreparer(resourceGroupName string, managerName string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"deviceName":        client.DeviceName,
		"managerName":       managerName,
		"resourceGroupName": resourceGroupName,
...
//
// resourceGroupName is the resource group name managerName is the manager name
func (client DeviceSettingsClient) GetTimeSettings(resourceGroupName string, managerName string) (result TimeSettings, err error) {
	if err := validation.Validate([]validation.Validation{
		{TargetValue: managerName,
			Constraints: []validation.Constraint{{Target: "managerName", Name: validation.MaxLength, Rule: 50, Chain: nil},
				{Target: "managerName", Name: validation.MinLength, Rule: 2, Chain: nil}}}}); err != nil {
	...
	req, err := client.GetTimeSettingsPreparer(resourceGroupName, managerName)
	if err != nil {
...
func (client DeviceSettingsClient) GetTimeSettingsPreparer(resourceGroupName string, managerName string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"deviceName":        client.DeviceName,
		"managerName":       managerName,
		"resourceGroupName": resourceGroupName,
...
//
// resourceGroupName is the resource group name managerName is the manager name
func (client DeviceSettingsClient) SyncRemotemanagementCertificate(resourceGroupName string, managerName string, cancel <-chan struct{}) (<-chan autorest.Response, <-chan error) {
	...
	go func() {
		...
		req, err := client.SyncRemotemanagementCertificatePreparer(resourceGroupName, managerName, cancel)
		if err != nil {
...
func (client DeviceSettingsClient) SyncRemotemanagementCertificatePreparer(resourceGroupName string, managerName string, cancel <-chan struct{}) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"deviceName":        client.DeviceName,
		"managerName":       managerName,
		"resourceGroupName": resourceGroupName,
...
//
// parameters is the network settings to be updated. resourceGroupName is the
// resource group name managerName is the manager name
func (client DeviceSettingsClient) UpdateNetworkSettings(parameters NetworkSettingsPatch, resourceGroupName string, managerName string, cancel <-chan struct{}) (<-chan NetworkSettings, <-chan error) {
	...
	go func() {
		...
		req, err := client.UpdateNetworkSettingsPreparer(parameters, resourceGroupName, managerName, cancel)
		if err != nil {
...
func (client DeviceSettingsClient) UpdateNetworkSettingsPreparer(parameters NetworkSettingsPatch, resourceGroupName string, managerName string, cancel <-chan struct{}) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"deviceName":        client.DeviceName,
		"managerName":       managerName,
		"resourceGroupName": resourceGroupName,
...
//
// parameters is the security settings properties to be patched.
// resourceGroupName is the resource group name managerName is the manager name
func (client DeviceSettingsClient) UpdateSecuritySettings(parameters SecuritySettingsPatch, resourceGroupName string, managerName string, cancel <-chan struct{}) (<-chan SecuritySettings, <-chan error) {
	...
	go func() {
		...
		req, err := client.UpdateSecuritySettingsPreparer(parameters, resourceGroupName, managerName, cancel)
		if err != nil {
...
func (client DeviceSettingsClient) UpdateSecuritySettingsPreparer(parameters SecuritySettingsPatch, resourceGroupName string, managerName string, cancel <-chan struct{}) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"deviceName":        client.DeviceName,
		"managerName":       managerName,
		"resourceGroupName": resourceGroupName,
