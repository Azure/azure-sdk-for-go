...
// methods of the Storsimple service.
type HardwareComponentGroupsClient struct {
	ManagementClient
}

// NewHardwareComponentGroupsClient creates an instance of the
// HardwareComponentGroupsClient client.
func NewHardwareComponentGroupsClient(deviceName string, subscriptionID string) HardwareComponentGroupsClient {
	return NewHardwareComponentGroupsClientWithBaseURI(DefaultBaseURI, deviceName, subscriptionID)
}

// NewHardwareComponentGroupsClientWithBaseURI creates an instance of the
// HardwareComponentGroupsClient client.
func NewHardwareComponentGroupsClientWithBaseURI(baseURI string, deviceName string, subscriptionID string) HardwareComponentGroupsClient {
	return HardwareComponentGroupsClient{NewWithBaseURI(baseURI, deviceName, subscriptionID)}
}

// ChangeControllerPowerState changes the power state of the controller. This
// method may poll for completion. Polling can be canceled by passing the
// cancel channel argument. The channel will be used to cancel polling and any
// outstanding HTTP requests.
//
// hardwareComponentGroupName is the hardware component group name. parameters
// is the controller power state change request. resourceGroupName is the
// resource group name managerName is the manager name
func (client HardwareComponentGroupsClient) ChangeControllerPowerState(hardwareComponentGroupName string, parameters ControllerPowerStateChangeRequest, resourceGroupName string, managerName string, cancel <-chan struct{}) (<-chan autorest.Response, <-chan error) {
	...
	go func() {
		...
		req, err := client.ChangeControllerPowerStatePreparer(hardwareComponentGroupName, parameters, resourceGroupName, managerName, cancel)
		if err != nil {
...
func (client HardwareComponentGroupsClient) ChangeControllerPowerStatePreparer(hardwareComponentGroupName string, parameters ControllerPowerStateChangeRequest, resourceGroupName string, managerName string, cancel <-chan struct{}) (*http.Request, error) {
...
func (client HardwareComponentGroupsClient) ListByDevice(resourceGroupName string, managerName string) (result HardwareComponentGroupList, err error) {
	if err := validation.Validate([]validation.Validation{
		{TargetValue: managerName,
			Constraints: []validation.Constraint{{Target: "managerName", Name: validation.MaxLength, Rule: 50, Chain: nil},
				{Target: "managerName", Name: validation.MinLength, Rule: 2, Chain: nil}}}}); err != nil {
...
func (client HardwareComponentGroupsClient) ListByDevicePreparer(resourceGroupName string, managerName string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"deviceName":        client.DeviceName,
		"managerName":       managerName,
		"resourceGroupName": resourceGroupName,
