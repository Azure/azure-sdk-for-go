...
func NewJobsClient(deviceName string, subscriptionID string) JobsClient {
	return NewJobsClientWithBaseURI(DefaultBaseURI, deviceName, subscriptionID)
}

// NewJobsClientWithBaseURI creates an instance of the JobsClient client.
func NewJobsClientWithBaseURI(baseURI string, deviceName string, subscriptionID string) JobsClient {
	return JobsClient{NewWithBaseURI(baseURI, deviceName, subscriptionID)}
}
...
//
// jobName is the jobName. resourceGroupName is the resource group name
// managerName is the manager name
func (client JobsClient) Cancel(jobName string, resourceGroupName string, managerName string, cancel <-chan struct{}) (<-chan autorest.Response, <-chan error) {
	...
	go func() {
		...
		req, err := client.CancelPreparer(jobName, resourceGroupName, managerName, cancel)
		if err != nil {
...
func (client JobsClient) CancelPreparer(jobName string, resourceGroupName string, managerName string, cancel <-chan struct{}) (*http.Request, error) {
...
//
// jobName is the job Name. resourceGroupName is the resource group name
// managerName is the manager name
func (client JobsClient) Get(jobName string, resourceGroupName string, managerName string) (result Job, err error) {
	if err := validation.Validate([]validation.Validation{
		{TargetValue: managerName,
			Constraints: []validation.Constraint{{Target: "managerName", Name: validation.MaxLength, Rule: 50, Chain: nil},
				{Target: "managerName", Name: validation.MinLength, Rule: 2, Chain: nil}}}}); err != nil {
	...
	req, err := client.GetPreparer(jobName, resourceGroupName, managerName)
	if err != nil {
...
func (client JobsClient) GetPreparer(jobName string, resourceGroupName string, managerName string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"deviceName":        client.DeviceName,
		"jobName":           jobName,
		"managerName":       managerName,
...
func (client JobsClient) ListByDevice(resourceGroupName string, managerName string, filter string) (result JobList, err error) {
	if err := validation.Validate([]validation.Validation{
		{TargetValue: managerName,
			Constraints: []validation.Constraint{{Target: "managerName", Name: validation.MaxLength, Rule: 50, Chain: nil},
				{Target: "managerName", Name: validation.MinLength, Rule: 2, Chain: nil}}}}); err != nil {
...
func (client JobsClient) ListByDevicePreparer(resourceGroupName string, managerName string, filter string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"deviceName":        client.DeviceName,
		"managerName":       managerName,
		"resourceGroupName": resourceGroupName,
