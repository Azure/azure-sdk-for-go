...
// ManagersClient is the client for the Managers methods of the Storsimple
// service.
...
func NewManagersClient(deviceName string, subscriptionID string) ManagersClient {
	return NewManagersClientWithBaseURI(DefaultBaseURI, deviceName, subscriptionID)
}

// NewManagersClientWithBaseURI creates an instance of the ManagersClient
// client.
func NewManagersClientWithBaseURI(baseURI string, deviceName string, subscriptionID string) ManagersClient {
	return ManagersClient{NewWithBaseURI(baseURI, deviceName, subscriptionID)}
}

// CreateExtendedInfo creates the extended info of the manager.
//
// parameters is the manager extended information. resourceGroupName is the
...
//
// parameters is the manager. resourceGroupName is the resource group name
...
// GetDevicePublicEncryptionKey returns the public encryption key of the
// device.
//
// resourceGroupName is the resource group name managerName is the manager name
func (client ManagersClient) GetDevicePublicEncryptionKey(resourceGroupName string, managerName string) (result PublicKey, err error) {
	if err := validation.Validate([]validation.Validation{
		{TargetValue: managerName,
			Constraints: []validation.Constraint{{Target: "managerName", Name: validation.MaxLength, Rule: 50, Chain: nil},
				{Target: "managerName", Name: validation.MinLength, Rule: 2, Chain: nil}}}}); err != nil {
	...
	req, err := client.GetDevicePublicEncryptionKeyPreparer(resourceGroupName, managerName)
	if err != nil {
...
func (client ManagersClient) GetDevicePublicEncryptionKeyPreparer(resourceGroupName string, managerName string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
...
// GetExtendedInfo returns the extended information of the specified manager
// name.
//
// resourceGroupName is the resource group name managerName is the manager name
...
// GetPublicEncryptionKey returns the symmetric encrypted public encryption key
// of the manager.
//
// resourceGroupName is the resource group name managerName is the manager name
...
// RegenerateActivationKey re-generates and returns the activation key of the
// manager.
//
// resourceGroupName is the resource group name managerName is the manager name
...
//
// parameters is the manager extended information. resourceGroupName is the
// resource group name managerName is the manager name ifMatch is pass the ETag
// of ExtendedInfo fetched from GET call
