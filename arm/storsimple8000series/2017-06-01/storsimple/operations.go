...
// OperationsClient is the client for the Operations methods of the Storsimple
// service.
...
func NewOperationsClient(deviceName string, subscriptionID string) OperationsClient {
	return NewOperationsClientWithBaseURI(DefaultBaseURI, deviceName, subscriptionID)
}

// NewOperationsClientWithBaseURI creates an instance of the OperationsClient
// client.
func NewOperationsClientWithBaseURI(baseURI string, deviceName string, subscriptionID string) OperationsClient {
	return OperationsClient{NewWithBaseURI(baseURI, deviceName, subscriptionID)}
}
