...
// VolumeContainersClient is the client for the VolumeContainers methods of the
// Storsimple service.
type VolumeContainersClient struct {
	ManagementClient
}

// NewVolumeContainersClient creates an instance of the VolumeContainersClient
// client.
func NewVolumeContainersClient(deviceName string, subscriptionID string) VolumeContainersClient {
	return NewVolumeContainersClientWithBaseURI(DefaultBaseURI, deviceName, subscriptionID)
}

// NewVolumeContainersClientWithBaseURI creates an instance of the
// VolumeContainersClient client.
func NewVolumeContainersClientWithBaseURI(baseURI string, deviceName string, subscriptionID string) VolumeContainersClient {
	return VolumeContainersClient{NewWithBaseURI(baseURI, deviceName, subscriptionID)}
}

// CreateOrUpdate creates or updates the volume container. This method may poll
// for completion. Polling can be canceled by passing the cancel channel
// argument. The channel will be used to cancel polling and any outstanding
// HTTP requests.
//
// volumeContainerName is the name of the volume container. parameters is the
// volume container to be added or updated. resourceGroupName is the resource
// group name managerName is the manager name
func (client VolumeContainersClient) CreateOrUpdate(volumeContainerName string, parameters VolumeContainer, resourceGroupName string, managerName string, cancel <-chan struct{}) (<-chan VolumeContainer, <-chan error) {
	...
	go func() {
		...
		req, err := client.CreateOrUpdatePreparer(volumeContainerName, parameters, resourceGroupName, managerName, cancel)
		if err != nil {
...
func (client VolumeContainersClient) CreateOrUpdatePreparer(volumeContainerName string, parameters VolumeContainer, resourceGroupName string, managerName string, cancel <-chan struct{}) (*http.Request, error) {
...
// Delete deletes the volume container. This method may poll for completion.
// Polling can be canceled by passing the cancel channel argument. The channel
// will be used to cancel polling and any outstanding HTTP requests.
//
// volumeContainerName is the name of the volume container. resourceGroupName
// is the resource group name managerName is the manager name
func (client VolumeContainersClient) Delete(volumeContainerName string, resourceGroupName string, managerName string, cancel <-chan struct{}) (<-chan autorest.Response, <-chan error) {
	...
	go func() {
		...
		req, err := client.DeletePreparer(volumeContainerName, resourceGroupName, managerName, cancel)
		if err != nil {
...
func (client VolumeContainersClient) DeletePreparer(volumeContainerName string, resourceGroupName string, managerName string, cancel <-chan struct{}) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"deviceName":          client.DeviceName,
		"managerName":         managerName,
		"resourceGroupName":   resourceGroupName,
...
// volumeContainerName is the name of the volume container. resourceGroupName
// is the resource group name managerName is the manager name
func (client VolumeContainersClient) Get(volumeContainerName string, resourceGroupName string, managerName string) (result VolumeContainer, err error) {
	if err := validation.Validate([]validation.Validation{
		{TargetValue: managerName,
			Constraints: []validation.Constraint{{Target: "managerName", Name: validation.MaxLength, Rule: 50, Chain: nil},
				{Target: "managerName", Name: validation.MinLength, Rule: 2, Chain: nil}}}}); err != nil {
	...
	req, err := client.GetPreparer(volumeContainerName, resourceGroupName, managerName)
	if err != nil {
...
func (client VolumeContainersClient) GetPreparer(volumeContainerName string, resourceGroupName string, managerName string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"deviceName":          client.DeviceName,
		"managerName":         managerName,
		"resourceGroupName":   resourceGroupName,
...
func (client VolumeContainersClient) ListByDevice(resourceGroupName string, managerName string) (result VolumeContainerList, err error) {
	if err := validation.Validate([]validation.Validation{
		{TargetValue: managerName,
			Constraints: []validation.Constraint{{Target: "managerName", Name: validation.MaxLength, Rule: 50, Chain: nil},
				{Target: "managerName", Name: validation.MinLength, Rule: 2, Chain: nil}}}}); err != nil {
	...
	req, err := client.ListByDevicePreparer(resourceGroupName, managerName)
	if err != nil {
...
func (client VolumeContainersClient) ListByDevicePreparer(resourceGroupName string, managerName string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"deviceName":        client.DeviceName,
		"managerName":       managerName,
		"resourceGroupName": resourceGroupName,
...
// container.
//
// volumeContainerName is the volume container name. resourceGroupName is the
// resource group name managerName is the manager name
func (client VolumeContainersClient) ListMetricDefinition(volumeContainerName string, resourceGroupName string, managerName string) (result MetricDefinitionList, err error) {
	if err := validation.Validate([]validation.Validation{
		{TargetValue: managerName,
			Constraints: []validation.Constraint{{Target: "managerName", Name: validation.MaxLength, Rule: 50, Chain: nil},
				{Target: "managerName", Name: validation.MinLength, Rule: 2, Chain: nil}}}}); err != nil {
	...
	req, err := client.ListMetricDefinitionPreparer(volumeContainerName, resourceGroupName, managerName)
	if err != nil {
...
func (client VolumeContainersClient) ListMetricDefinitionPreparer(volumeContainerName string, resourceGroupName string, managerName string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"deviceName":          client.DeviceName,
		"managerName":         managerName,
		"resourceGroupName":   resourceGroupName,
...
//
// volumeContainerName is the volume container name. resourceGroupName is the
// resource group name managerName is the manager name filter is oData Filter
// options
func (client VolumeContainersClient) ListMetrics(volumeContainerName string, resourceGroupName string, managerName string, filter string) (result MetricList, err error) {
	if err := validation.Validate([]validation.Validation{
		{TargetValue: managerName,
			Constraints: []validation.Constraint{{Target: "managerName", Name: validation.MaxLength, Rule: 50, Chain: nil},
				{Target: "managerName", Name: validation.MinLength, Rule: 2, Chain: nil}}}}); err != nil {
	...
	req, err := client.ListMetricsPreparer(volumeContainerName, resourceGroupName, managerName, filter)
	if err != nil {
...
func (client VolumeContainersClient) ListMetricsPreparer(volumeContainerName string, resourceGroupName string, managerName string, filter string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"deviceName":          client.DeviceName,
		"managerName":         managerName,
		"resourceGroupName":   resourceGroupName,
