...
func NewVolumesClient(deviceName string, subscriptionID string) VolumesClient {
	return NewVolumesClientWithBaseURI(DefaultBaseURI, deviceName, subscriptionID)
}

// NewVolumesClientWithBaseURI creates an instance of the VolumesClient client.
func NewVolumesClientWithBaseURI(baseURI string, deviceName string, subscriptionID string) VolumesClient {
	return VolumesClient{NewWithBaseURI(baseURI, deviceName, subscriptionID)}
}
...
// requests.
//
// volumeContainerName is the volume container name. volumeName is the volume
// name. parameters is volume to be created or updated. resourceGroupName is
// the resource group name managerName is the manager name
func (client VolumesClient) CreateOrUpdate(volumeContainerName string, volumeName string, parameters Volume, resourceGroupName string, managerName string, cancel <-chan struct{}) (<-chan Volume, <-chan error) {
	...
	go func() {
		...
		req, err := client.CreateOrUpdatePreparer(volumeContainerName, volumeName, parameters, resourceGroupName, managerName, cancel)
		if err != nil {
...
func (client VolumesClient) CreateOrUpdatePreparer(volumeContainerName string, volumeName string, parameters Volume, resourceGroupName string, managerName string, cancel <-chan struct{}) (*http.Request, error) {
...
// manager name
func (client VolumesClient) Delete(volumeContainerName string, volumeName string, resourceGroupName string, managerName string, cancel <-chan struct{}) (<-chan autorest.Response, <-chan error) {
	...
	go func() {
		...
		req, err := client.DeletePreparer(volumeContainerName, volumeName, resourceGroupName, managerName, cancel)
		if err != nil {
...
func (client VolumesClient) DeletePreparer(volumeContainerName string, volumeName string, resourceGroupName string, managerName string, cancel <-chan struct{}) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"deviceName":          client.DeviceName,
		"managerName":         managerName,
		"resourceGroupName":   resourceGroupName,
...
// name. resourceGroupName is the resource group name managerName is the
// manager name
func (client VolumesClient) Get(volumeContainerName string, volumeName string, resourceGroupName string, managerName string) (result Volume, err error) {
	if err := validation.Validate([]validation.Validation{
		{TargetValue: managerName,
			Constraints: []validation.Constraint{{Target: "managerName", Name: validation.MaxLength, Rule: 50, Chain: nil},
				{Target: "managerName", Name: validation.MinLength, Rule: 2, Chain: nil}}}}); err != nil {
	...
	req, err := client.GetPreparer(volumeContainerName, volumeName, resourceGroupName, managerName)
	if err != nil {
...
func (client VolumesClient) GetPreparer(volumeContainerName string, volumeName string, resourceGroupName string, managerName string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"deviceName":          client.DeviceName,
		"managerName":         managerName,
		"resourceGroupName":   resourceGroupName,
...
func (client VolumesClient) ListByDevice(resourceGroupName string, managerName string) (result VolumeList, err error) {
	if err := validation.Validate([]validation.Validation{
		{TargetValue: managerName,
			Constraints: []validation.Constraint{{Target: "managerName", Name: validation.MaxLength, Rule: 50, Chain: nil},
				{Target: "managerName", Name: validation.MinLength, Rule: 2, Chain: nil}}}}); err != nil {
...
func (client VolumesClient) ListByDevicePreparer(resourceGroupName string, managerName string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"deviceName":        client.DeviceName,
		"managerName":       managerName,
		"resourceGroupName": resourceGroupName,
...
func (client VolumesClient) ListByVolumeContainer(volumeContainerName string, resourceGroupName string, managerName string) (result VolumeList, err error) {
	if err := validation.Validate([]validation.Validation{
		{TargetValue: managerName,
			Constraints: []validation.Constraint{{Target: "managerName", Name: validation.MaxLength, Rule: 50, Chain: nil},
				{Target: "managerName", Name: validation.MinLength, Rule: 2, Chain: nil}}}}); err != nil {
	...
	req, err := client.ListByVolumeContainerPreparer(volumeContainerName, resourceGroupName, managerName)
	if err != nil {
...
func (client VolumesClient) ListByVolumeContainerPreparer(volumeContainerName string, resourceGroupName string, managerName string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"deviceName":          client.DeviceName,
		"managerName":         managerName,
		"resourceGroupName":   resourceGroupName,
...
// name. resourceGroupName is the resource group name managerName is the
// manager name
func (client VolumesClient) ListMetricDefinition(volumeContainerName string, volumeName string, resourceGroupName string, managerName string) (result MetricDefinitionList, err error) {
	if err := validation.Validate([]validation.Validation{
		{TargetValue: managerName,
			Constraints: []validation.Constraint{{Target: "managerName", Name: validation.MaxLength, Rule: 50, Chain: nil},
				{Target: "managerName", Name: validation.MinLength, Rule: 2, Chain: nil}}}}); err != nil {
	...
	req, err := client.ListMetricDefinitionPreparer(volumeContainerName, volumeName, resourceGroupName, managerName)
	if err != nil {
...
func (client VolumesClient) ListMetricDefinitionPreparer(volumeContainerName string, volumeName string, resourceGroupName string, managerName string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"deviceName":          client.DeviceName,
		"managerName":         managerName,
		"resourceGroupName":   resourceGroupName,
...
func (client VolumesClient) ListMetrics(volumeContainerName string, volumeName string, resourceGroupName string, managerName string, filter string) (result MetricList, err error) {
	if err := validation.Validate([]validation.Validation{
		{TargetValue: managerName,
			Constraints: []validation.Constraint{{Target: "managerName", Name: validation.MaxLength, Rule: 50, Chain: nil},
				{Target: "managerName", Name: validation.MinLength, Rule: 2, Chain: nil}}}}); err != nil {
	...
	req, err := client.ListMetricsPreparer(volumeContainerName, volumeName, resourceGroupName, managerName, filter)
	if err != nil {
...
func (client VolumesClient) ListMetricsPreparer(volumeContainerName string, volumeName string, resourceGroupName string, managerName string, filter string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"deviceName":          client.DeviceName,
		"managerName":         managerName,
		"resourceGroupName":   resourceGroupName,
