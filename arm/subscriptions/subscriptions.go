...
// SubscriptionsClient is the client for the Subscriptions methods of the
...
func (client SubscriptionsClient) Get(subscriptionID string) (result Subscription, ae error) {
	...
	if err != nil {
		...
		return result, autorest.NewErrorWithError(err, "subscriptions/SubscriptionsClient", "Get", "Failure sending request")
	}
...
func (client SubscriptionsClient) List() (result SubscriptionListResult, ae error) {
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "subscriptions/SubscriptionsClient", "List", "Failure sending request")
	}
...
func (client SubscriptionsClient) ListNextResults(lastResults SubscriptionListResult) (result SubscriptionListResult, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "subscriptions/SubscriptionsClient", "List", "Failure preparing next results request request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "subscriptions/SubscriptionsClient", "List", "Failure sending next results request request")
	}

	result, err = client.ListResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "subscriptions/SubscriptionsClient", "List", "Failure responding to next results request request")
	}
...
func (client SubscriptionsClient) ListLocations(subscriptionID string) (result LocationListResult, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "subscriptions/SubscriptionsClient", "ListLocations", "Failure preparing request")
	}

	resp, err := client.ListLocationsSender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "subscriptions/SubscriptionsClient", "ListLocations", "Failure sending request")
	}

	result, err = client.ListLocationsResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "subscriptions/SubscriptionsClient", "ListLocations", "Failure responding to request")
	}
