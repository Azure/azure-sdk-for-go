...
func (client CertificateOrdersClient) CreateOrUpdateCertificate(resourceGroupName string, certificateOrderName string, name string, keyVaultCertificate CertificateOrderCertificate) (result CertificateOrderCertificate, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.CertificateOrdersClient", "CreateOrUpdateCertificate", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "service.CertificateOrdersClient", "CreateOrUpdateCertificate", resp, "Failure sending request")
		return
	}

	result, err = client.CreateOrUpdateCertificateResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.CertificateOrdersClient", "CreateOrUpdateCertificate", resp, "Failure responding to request")
	}
...
// certificateDistinguishedName is distinguished name to be used for purchasing
// certificate
func (client CertificateOrdersClient) CreateOrUpdateCertificateOrder(resourceGroupName string, name string, certificateDistinguishedName CertificateOrder) (result CertificateOrder, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.CertificateOrdersClient", "CreateOrUpdateCertificateOrder", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.CertificateOrdersClient", "CreateOrUpdateCertificateOrder", resp, "Failure sending request")
		return
	}

	result, err = client.CreateOrUpdateCertificateOrderResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.CertificateOrdersClient", "CreateOrUpdateCertificateOrder", resp, "Failure responding to request")
	}
...
func (client CertificateOrdersClient) DeleteCertificate(resourceGroupName string, certificateOrderName string, name string) (result SetObject, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.CertificateOrdersClient", "DeleteCertificate", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.CertificateOrdersClient", "DeleteCertificate", resp, "Failure sending request")
		return
	}

	result, err = client.DeleteCertificateResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.CertificateOrdersClient", "DeleteCertificate", resp, "Failure responding to request")
	}
...
func (client CertificateOrdersClient) DeleteCertificateOrder(resourceGroupName string, name string) (result SetObject, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.CertificateOrdersClient", "DeleteCertificateOrder", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.CertificateOrdersClient", "DeleteCertificateOrder", resp, "Failure sending request")
		return
	}

	result, err = client.DeleteCertificateOrderResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.CertificateOrdersClient", "DeleteCertificateOrder", resp, "Failure responding to request")
	}
...
func (client CertificateOrdersClient) GetCertificate(resourceGroupName string, certificateOrderName string, name string) (result CertificateOrderCertificate, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.CertificateOrdersClient", "GetCertificate", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.CertificateOrdersClient", "GetCertificate", resp, "Failure sending request")
		return
	}

	result, err = client.GetCertificateResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.CertificateOrdersClient", "GetCertificate", resp, "Failure responding to request")
	}
...
func (client CertificateOrdersClient) GetCertificateOrder(resourceGroupName string, name string) (result CertificateOrder, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.CertificateOrdersClient", "GetCertificateOrder", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.CertificateOrdersClient", "GetCertificateOrder", resp, "Failure sending request")
		return
	}

	result, err = client.GetCertificateOrderResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.CertificateOrdersClient", "GetCertificateOrder", resp, "Failure responding to request")
	}
...
func (client CertificateOrdersClient) GetCertificateOrders(resourceGroupName string) (result CertificateOrderCollection, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.CertificateOrdersClient", "GetCertificateOrders", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.CertificateOrdersClient", "GetCertificateOrders", resp, "Failure sending request")
		return
	}

	result, err = client.GetCertificateOrdersResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.CertificateOrdersClient", "GetCertificateOrders", resp, "Failure responding to request")
	}
...
func (client CertificateOrdersClient) GetCertificateOrdersNextResults(lastResults CertificateOrderCollection) (result CertificateOrderCollection, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "service.CertificateOrdersClient", "GetCertificateOrders", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "service.CertificateOrdersClient", "GetCertificateOrders", resp, "Failure sending next results request")
	}

	result, err = client.GetCertificateOrdersResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.CertificateOrdersClient", "GetCertificateOrders", resp, "Failure responding to next results request")
	}
...
func (client CertificateOrdersClient) GetCertificates(resourceGroupName string, certificateOrderName string) (result CertificateOrderCertificateCollection, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.CertificateOrdersClient", "GetCertificates", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.CertificateOrdersClient", "GetCertificates", resp, "Failure sending request")
		return
	}

	result, err = client.GetCertificatesResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.CertificateOrdersClient", "GetCertificates", resp, "Failure responding to request")
	}
...
func (client CertificateOrdersClient) GetCertificatesNextResults(lastResults CertificateOrderCertificateCollection) (result CertificateOrderCertificateCollection, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "service.CertificateOrdersClient", "GetCertificates", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "service.CertificateOrdersClient", "GetCertificates", resp, "Failure sending next results request")
	}

	result, err = client.GetCertificatesResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.CertificateOrdersClient", "GetCertificates", resp, "Failure responding to next results request")
	}
...
func (client CertificateOrdersClient) ReissueCertificateOrder(resourceGroupName string, name string, reissueCertificateOrderRequest ReissueCertificateOrderRequest) (result SetObject, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.CertificateOrdersClient", "ReissueCertificateOrder", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.CertificateOrdersClient", "ReissueCertificateOrder", resp, "Failure sending request")
		return
	}

	result, err = client.ReissueCertificateOrderResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.CertificateOrdersClient", "ReissueCertificateOrder", resp, "Failure responding to request")
	}
...
func (client CertificateOrdersClient) RenewCertificateOrder(resourceGroupName string, name string, renewCertificateOrderRequest RenewCertificateOrderRequest) (result SetObject, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.CertificateOrdersClient", "RenewCertificateOrder", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.CertificateOrdersClient", "RenewCertificateOrder", resp, "Failure sending request")
		return
	}

	result, err = client.RenewCertificateOrderResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.CertificateOrdersClient", "RenewCertificateOrder", resp, "Failure responding to request")
	}
...
func (client CertificateOrdersClient) ResendCertificateEmail(resourceGroupName string, name string) (result SetObject, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.CertificateOrdersClient", "ResendCertificateEmail", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.CertificateOrdersClient", "ResendCertificateEmail", resp, "Failure sending request")
		return
	}

	result, err = client.ResendCertificateEmailResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.CertificateOrdersClient", "ResendCertificateEmail", resp, "Failure responding to request")
	}
...
func (client CertificateOrdersClient) RetrieveCertificateActions(resourceGroupName string, name string) (result ListCertificateOrderAction, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.CertificateOrdersClient", "RetrieveCertificateActions", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.CertificateOrdersClient", "RetrieveCertificateActions", resp, "Failure sending request")
		return
	}

	result, err = client.RetrieveCertificateActionsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.CertificateOrdersClient", "RetrieveCertificateActions", resp, "Failure responding to request")
	}
...
// RetrieveCertificateEmailHistory sends the retrieve certificate email history
// request.
//
// resourceGroupName is azure resource group name name is certificate order
// name
func (client CertificateOrdersClient) RetrieveCertificateEmailHistory(resourceGroupName string, name string) (result ListCertificateEmail, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.CertificateOrdersClient", "RetrieveCertificateEmailHistory", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.CertificateOrdersClient", "RetrieveCertificateEmailHistory", resp, "Failure sending request")
		return
	}

	result, err = client.RetrieveCertificateEmailHistoryResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.CertificateOrdersClient", "RetrieveCertificateEmailHistory", resp, "Failure responding to request")
	}
...
func (client CertificateOrdersClient) UpdateCertificate(resourceGroupName string, certificateOrderName string, name string, keyVaultCertificate CertificateOrderCertificate) (result CertificateOrderCertificate, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.CertificateOrdersClient", "UpdateCertificate", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.CertificateOrdersClient", "UpdateCertificate", resp, "Failure sending request")
		return
	}

	result, err = client.UpdateCertificateResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.CertificateOrdersClient", "UpdateCertificate", resp, "Failure responding to request")
	}
...
func (client CertificateOrdersClient) UpdateCertificateOrder(resourceGroupName string, name string, certificateDistinguishedName CertificateOrder) (result CertificateOrder, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.CertificateOrdersClient", "UpdateCertificateOrder", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.CertificateOrdersClient", "UpdateCertificateOrder", resp, "Failure sending request")
		return
	}

	result, err = client.UpdateCertificateOrderResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.CertificateOrdersClient", "UpdateCertificateOrder", resp, "Failure responding to request")
	}
...
func (client CertificateOrdersClient) VerifyDomainOwnership(resourceGroupName string, name string) (result SetObject, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.CertificateOrdersClient", "VerifyDomainOwnership", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.CertificateOrdersClient", "VerifyDomainOwnership", resp, "Failure sending request")
		return
	}

	result, err = client.VerifyDomainOwnershipResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.CertificateOrdersClient", "VerifyDomainOwnership", resp, "Failure responding to request")
	}
