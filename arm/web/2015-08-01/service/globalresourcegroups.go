...
func (client GlobalResourceGroupsClient) MoveResources(resourceGroupName string, moveResourceEnvelope CsmMoveResourceEnvelope) (result autorest.Response, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.GlobalResourceGroupsClient", "MoveResources", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "service.GlobalResourceGroupsClient", "MoveResources", resp, "Failure sending request")
		return
	}

	result, err = client.MoveResourcesResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.GlobalResourceGroupsClient", "MoveResources", resp, "Failure responding to request")
	}
