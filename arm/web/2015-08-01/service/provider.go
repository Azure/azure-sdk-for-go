...
func (client ProviderClient) GetPublishingUser() (result User, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ProviderClient", "GetPublishingUser", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "service.ProviderClient", "GetPublishingUser", resp, "Failure sending request")
		return
	}

	result, err = client.GetPublishingUserResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ProviderClient", "GetPublishingUser", resp, "Failure responding to request")
	}
...
func (client ProviderClient) GetSourceControl(sourceControlType string) (result SourceControl, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ProviderClient", "GetSourceControl", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.ProviderClient", "GetSourceControl", resp, "Failure sending request")
		return
	}

	result, err = client.GetSourceControlResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ProviderClient", "GetSourceControl", resp, "Failure responding to request")
	}
...
func (client ProviderClient) GetSourceControls() (result SourceControlCollection, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ProviderClient", "GetSourceControls", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.ProviderClient", "GetSourceControls", resp, "Failure sending request")
		return
	}

	result, err = client.GetSourceControlsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ProviderClient", "GetSourceControls", resp, "Failure responding to request")
	}
...
func (client ProviderClient) GetSourceControlsNextResults(lastResults SourceControlCollection) (result SourceControlCollection, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "service.ProviderClient", "GetSourceControls", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "service.ProviderClient", "GetSourceControls", resp, "Failure sending next results request")
	}

	result, err = client.GetSourceControlsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ProviderClient", "GetSourceControls", resp, "Failure responding to next results request")
	}
...
func (client ProviderClient) UpdatePublishingUser(requestMessage User) (result User, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ProviderClient", "UpdatePublishingUser", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.ProviderClient", "UpdatePublishingUser", resp, "Failure sending request")
		return
	}

	result, err = client.UpdatePublishingUserResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ProviderClient", "UpdatePublishingUser", resp, "Failure responding to request")
	}
...
func (client ProviderClient) UpdateSourceControl(sourceControlType string, requestMessage SourceControl) (result SourceControl, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ProviderClient", "UpdateSourceControl", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.ProviderClient", "UpdateSourceControl", resp, "Failure sending request")
		return
	}

	result, err = client.UpdateSourceControlResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ProviderClient", "UpdateSourceControl", resp, "Failure responding to request")
	}
