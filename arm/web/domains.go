...
// DomainsSiteManagementClient is the use these APIs to manage Azure Websites
...
// NewDomainsSiteManagementClient creates an instance of the
// DomainsSiteManagementClient client.
func NewDomainsSiteManagementClient(subscriptionID string) DomainsSiteManagementClient {
	return NewDomainsSiteManagementClientWithBaseURI(DefaultBaseURI, subscriptionID)
}

// NewDomainsSiteManagementClientWithBaseURI creates an instance of the
// DomainsSiteManagementClient client.
func NewDomainsSiteManagementClientWithBaseURI(baseURI string, subscriptionID string) DomainsSiteManagementClient {
	return DomainsSiteManagementClient{NewWithBaseURI(baseURI, subscriptionID)}
}
...
func (client DomainsSiteManagementClient) CreateOrUpdateDomain(resourceGroupName string, domainName string, domain Domain) (result Domain, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "web/DomainsSiteManagementClient", "CreateOrUpdateDomain", "Failure preparing request")
	}

	resp, err := client.CreateOrUpdateDomainSender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "web/DomainsSiteManagementClient", "CreateOrUpdateDomain", "Failure sending request")
	}

	result, err = client.CreateOrUpdateDomainResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "web/DomainsSiteManagementClient", "CreateOrUpdateDomain", "Failure responding to request")
	}
...
func (client DomainsSiteManagementClient) DeleteDomain(resourceGroupName string, domainName string, forceHardDeleteDomain *bool) (result ObjectSet, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "web/DomainsSiteManagementClient", "DeleteDomain", "Failure preparing request")
	}

	resp, err := client.DeleteDomainSender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "web/DomainsSiteManagementClient", "DeleteDomain", "Failure sending request")
	}

	result, err = client.DeleteDomainResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "web/DomainsSiteManagementClient", "DeleteDomain", "Failure responding to request")
	}
...
func (client DomainsSiteManagementClient) GetDomain(resourceGroupName string, domainName string) (result Domain, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "web/DomainsSiteManagementClient", "GetDomain", "Failure preparing request")
	}

	resp, err := client.GetDomainSender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "web/DomainsSiteManagementClient", "GetDomain", "Failure sending request")
	}

	result, err = client.GetDomainResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "web/DomainsSiteManagementClient", "GetDomain", "Failure responding to request")
	}
...
func (client DomainsSiteManagementClient) GetDomainOperation(resourceGroupName string, domainName string, operationID string) (result Domain, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "web/DomainsSiteManagementClient", "GetDomainOperation", "Failure preparing request")
	}

	resp, err := client.GetDomainOperationSender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "web/DomainsSiteManagementClient", "GetDomainOperation", "Failure sending request")
	}

	result, err = client.GetDomainOperationResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "web/DomainsSiteManagementClient", "GetDomainOperation", "Failure responding to request")
	}
...
func (client DomainsSiteManagementClient) GetDomains(resourceGroupName string) (result DomainCollection, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "web/DomainsSiteManagementClient", "GetDomains", "Failure preparing request")
	}

	resp, err := client.GetDomainsSender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "web/DomainsSiteManagementClient", "GetDomains", "Failure sending request")
	}

	result, err = client.GetDomainsResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "web/DomainsSiteManagementClient", "GetDomains", "Failure responding to request")
	}
...
func (client DomainsSiteManagementClient) UpdateDomain(resourceGroupName string, domainName string, domain Domain) (result Domain, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "web/DomainsSiteManagementClient", "UpdateDomain", "Failure preparing request")
	}

	resp, err := client.UpdateDomainSender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "web/DomainsSiteManagementClient", "UpdateDomain", "Failure sending request")
	}

	result, err = client.UpdateDomainResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "web/DomainsSiteManagementClient", "UpdateDomain", "Failure responding to request")
	}
