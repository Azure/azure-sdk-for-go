...
// GlobalCertificateOrderSiteManagementClient is the use these APIs to manage
...
// NewGlobalCertificateOrderSiteManagementClient creates an instance of the
// GlobalCertificateOrderSiteManagementClient client.
func NewGlobalCertificateOrderSiteManagementClient(subscriptionID string) GlobalCertificateOrderSiteManagementClient {
	return NewGlobalCertificateOrderSiteManagementClientWithBaseURI(DefaultBaseURI, subscriptionID)
}

// NewGlobalCertificateOrderSiteManagementClientWithBaseURI creates an
// instance of the GlobalCertificateOrderSiteManagementClient client.
func NewGlobalCertificateOrderSiteManagementClientWithBaseURI(baseURI string, subscriptionID string) GlobalCertificateOrderSiteManagementClient {
	return GlobalCertificateOrderSiteManagementClient{NewWithBaseURI(baseURI, subscriptionID)}
}
...
func (client GlobalCertificateOrderSiteManagementClient) GetAllCertificateOrders() (result CertificateOrderCollection, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "web/GlobalCertificateOrderSiteManagementClient", "GetAllCertificateOrders", "Failure preparing request")
	}

	resp, err := client.GetAllCertificateOrdersSender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "web/GlobalCertificateOrderSiteManagementClient", "GetAllCertificateOrders", "Failure sending request")
	}

	result, err = client.GetAllCertificateOrdersResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "web/GlobalCertificateOrderSiteManagementClient", "GetAllCertificateOrders", "Failure responding to request")
	}
