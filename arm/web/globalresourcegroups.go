...
// GlobalResourceGroupsSiteManagementClient is the use these APIs to manage
...
// NewGlobalResourceGroupsSiteManagementClient creates an instance of the
// GlobalResourceGroupsSiteManagementClient client.
func NewGlobalResourceGroupsSiteManagementClient(subscriptionID string) GlobalResourceGroupsSiteManagementClient {
	return NewGlobalResourceGroupsSiteManagementClientWithBaseURI(DefaultBaseURI, subscriptionID)
}

// NewGlobalResourceGroupsSiteManagementClientWithBaseURI creates an instance
// of the GlobalResourceGroupsSiteManagementClient client.
func NewGlobalResourceGroupsSiteManagementClientWithBaseURI(baseURI string, subscriptionID string) GlobalResourceGroupsSiteManagementClient {
	return GlobalResourceGroupsSiteManagementClient{NewWithBaseURI(baseURI, subscriptionID)}
}
...
func (client GlobalResourceGroupsSiteManagementClient) MoveResources(resourceGroupName string, moveResourceEnvelope CsmMoveResourceEnvelope) (result autorest.Response, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "web/GlobalResourceGroupsSiteManagementClient", "MoveResources", "Failure preparing request")
	}

	resp, err := client.MoveResourcesSender(req)
	if err != nil {
		result.Response = resp
		return result, autorest.NewErrorWithError(err, "web/GlobalResourceGroupsSiteManagementClient", "MoveResources", "Failure sending request")
	}

	result, err = client.MoveResourcesResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "web/GlobalResourceGroupsSiteManagementClient", "MoveResources", "Failure responding to request")
	}
