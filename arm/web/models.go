...
// ListCapabilityWrapper is
type ListCapabilityWrapper struct {
	autorest.Response `json:"-"`
	Value             *[]Capability `json:"value,omitempty"`
}

// ListCertificateEmailWrapper is
type ListCertificateEmailWrapper struct {
	autorest.Response `json:"-"`
	Value             *[]CertificateEmail `json:"value,omitempty"`
}

// ListCertificateOrderActionWrapper is
type ListCertificateOrderActionWrapper struct {
	autorest.Response `json:"-"`
	Value             *[]CertificateOrderAction `json:"value,omitempty"`
}

// ListHostingEnvironmentDiagnosticsWrapper is
type ListHostingEnvironmentDiagnosticsWrapper struct {
	autorest.Response `json:"-"`
	Value             *[]HostingEnvironmentDiagnostics `json:"value,omitempty"`
}

// ListOperationWrapper is
type ListOperationWrapper struct {
	autorest.Response `json:"-"`
	Value             *[]Operation `json:"value,omitempty"`
}

// ListRecommendationWrapper is
type ListRecommendationWrapper struct {
	autorest.Response `json:"-"`
	Value             *[]Recommendation `json:"value,omitempty"`
}

// ListSiteConfigurationSnapshotInfoWrapper is
type ListSiteConfigurationSnapshotInfoWrapper struct {
	autorest.Response `json:"-"`
	Value             *[]SiteConfigurationSnapshotInfo `json:"value,omitempty"`
}

// ListVnetInfoWrapper is
type ListVnetInfoWrapper struct {
	autorest.Response `json:"-"`
	Value             *[]VnetInfo `json:"value,omitempty"`
}

// ListVnetRouteWrapper is
type ListVnetRouteWrapper struct {
	autorest.Response `json:"-"`
