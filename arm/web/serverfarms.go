...
// NewServerFarmsClientWithBaseURI creates an instance of the ServerFarmsClient
// client.
...
// serverFarmEnvelope is details of App Service Plan allowPendingState is
...
//
// resourceGroupName is name of resource group name is name of App Service Plan
// vnetName is name of virtual network routeName is name of the virtual network
// route route is the route object
...
//
// resourceGroupName is name of resource group name is name of App Service Plan
// vnetName is name of virtual network
...
//
// resourceGroupName is name of resource group name is name of App Service Plan
// details is if true, metrics are broken down per App Service Plan instance
// filter is return only usages/metrics specified in the filter. Filter
// conforms to odata syntax. Example: $filter=(name.value eq 'Metric1' or
...
//
// resourceGroupName is name of resource group name is name of App Service Plan
// skipToken is skip to of web apps in a list. If specified, the resulting list
// will contain web apps starting from (including) the skipToken. Else, the
// resulting list contains web apps from the start of the list filter is
...
// the apps if necessary. Hard restart always restarts and reprovisions the
// apps
...
// Plan vnetName is the name of the virtual network gatewayName is the name of
// the gateway. Only 'primary' is supported. connectionEnvelope is the gateway
// entity.
