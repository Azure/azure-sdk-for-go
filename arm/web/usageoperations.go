...
// UsageOperationsSiteManagementClient is the use these APIs to manage Azure
...
// NewUsageOperationsSiteManagementClient creates an instance of the
// UsageOperationsSiteManagementClient client.
func NewUsageOperationsSiteManagementClient(subscriptionID string) UsageOperationsSiteManagementClient {
	return NewUsageOperationsSiteManagementClientWithBaseURI(DefaultBaseURI, subscriptionID)
}

// NewUsageOperationsSiteManagementClientWithBaseURI creates an instance of
// the UsageOperationsSiteManagementClient client.
func NewUsageOperationsSiteManagementClientWithBaseURI(baseURI string, subscriptionID string) UsageOperationsSiteManagementClient {
	return UsageOperationsSiteManagementClient{NewWithBaseURI(baseURI, subscriptionID)}
}
...
func (client UsageOperationsSiteManagementClient) GetUsage(resourceGroupName string, environmentName string, lastID string, batchSize int) (result ObjectSet, ae error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "web/UsageOperationsSiteManagementClient", "GetUsage", "Failure preparing request")
	}

	resp, err := client.GetUsageSender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "web/UsageOperationsSiteManagementClient", "GetUsage", "Failure sending request")
	}

	result, err = client.GetUsageResponder(resp)
	if err != nil {
		ae = autorest.NewErrorWithError(err, "web/UsageOperationsSiteManagementClient", "GetUsage", "Failure responding to request")
	}
