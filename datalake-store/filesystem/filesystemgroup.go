...
func NewGroupClient(adlsFileSystemDNSSuffix string) GroupClient {
	return NewGroupClientWithBaseURI(DefaultBaseURI, adlsFileSystemDNSSuffix)
}

// NewGroupClientWithBaseURI creates an instance of the GroupClient client.
func NewGroupClientWithBaseURI(baseURI string, adlsFileSystemDNSSuffix string) GroupClient {
	return GroupClient{NewWithBaseURI(baseURI, adlsFileSystemDNSSuffix)}
}
...
// appending to the file. streamContents will be closed upon successful return.
// Callers should ensure closure when receiving an error.op is the constant
// value for the operation. appendParameter is the constant value for the
// operation. offset is the optional offset in the stream to begin the append
// operation. Default is to append at the end of the stream. syncFlag is
...
// completion.
func (client GroupClient) Append(directFilePath string, streamContents io.ReadCloser, op string, appendParameter string, offset *int64, syncFlag SyncFlag) (result autorest.Response, err error) {
...
func (client GroupClient) AppendPreparer(directFilePath string, streamContents io.ReadCloser, op string, appendParameter string, offset *int64, syncFlag SyncFlag) (*http.Request, error) {
...
//
// pathParameter is the Data Lake Store path (starting with '/') of the file or
// directory for which to check access. op is the constant value for the
// operation. fsaction is file system operation read/write/execute in string
// form, matching regex pattern '[rwx-]{3}'
func (client GroupClient) CheckAccess(pathParameter string, op string, fsaction string) (result autorest.Response, err error) {
...
func (client GroupClient) CheckAccessPreparer(pathParameter string, op string, fsaction string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
...
func (client GroupClient) Concat(destinationPath string, sources []string, op string) (result autorest.Response, err error) {
...
func (client GroupClient) ConcatPreparer(destinationPath string, sources []string, op string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
...
// which to append using concurrent append. streamContents is the file contents
// to include when appending to the file. streamContents will be closed upon
// successful return. Callers should ensure closure when receiving an error.op
// is the constant value for the operation. transferEncoding is indicates the
// data being sent to the server is being streamed in chunks. appendMode is
// indicates the concurrent append call should create the file if it doesn't
// exist or just open the existing file for append syncFlag is optionally
// indicates what to do after completion of the concurrent append. DATA
// indicates more data is coming so no sync takes place, METADATA indicates a
// sync should be done to refresh metadata of the file only. CLOSE indicates
// that both the stream and metadata should be refreshed upon append
// completion.
func (client GroupClient) ConcurrentAppend(filePath string, streamContents io.ReadCloser, op string, transferEncoding string, appendMode AppendModeType, syncFlag SyncFlag) (result autorest.Response, err error) {
	req, err := client.ConcurrentAppendPreparer(filePath, streamContents, op, transferEncoding, appendMode, syncFlag)
	if err != nil {
...
func (client GroupClient) ConcurrentAppendPreparer(filePath string, streamContents io.ReadCloser, op string, transferEncoding string, appendMode AppendModeType, syncFlag SyncFlag) (*http.Request, error) {
	pathParameters := map[string]interface{}{
...
//
// directFilePath is the Data Lake Store path (starting with '/') of the file
// to create. op is the constant value for the operation. write is the constant
// value for the operation. streamContents is the file contents to include when
...
// should be refreshed upon append completion.
func (client GroupClient) Create(directFilePath string, op string, write string, streamContents io.ReadCloser, overwrite *bool, syncFlag SyncFlag) (result autorest.Response, err error) {
...
func (client GroupClient) CreatePreparer(directFilePath string, op string, write string, streamContents io.ReadCloser, overwrite *bool, syncFlag SyncFlag) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"directFilePath": autorest.Encode("path", directFilePath),
	}
...
func (client GroupClient) Delete(filePath string, op string, recursive *bool) (result FileOperationResult, err error) {
...
func (client GroupClient) DeletePreparer(filePath string, op string, recursive *bool) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"filePath": autorest.Encode("path", filePath),
	}
...
// operation.
func (client GroupClient) GetACLStatus(aclFilePath string, op string) (result ACLStatusResult, err error) {
...
func (client GroupClient) GetACLStatusPreparer(aclFilePath string, op string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
...
// path.
//
// getContentSummaryFilePath is the Data Lake Store path (starting with '/') of
// the file for which to retrieve the summary. op is the constant value for the
// operation.
func (client GroupClient) GetContentSummary(getContentSummaryFilePath string, op string) (result ContentSummaryResult, err error) {
...
func (client GroupClient) GetContentSummaryPreparer(getContentSummaryFilePath string, op string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
...
// directory for which to retrieve the status. op is the constant value for the
// operation.
func (client GroupClient) GetFileStatus(getFilePath string, op string) (result FileStatusResult, err error) {
...
func (client GroupClient) GetFileStatusPreparer(getFilePath string, op string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
...
// sets the item or lexographical index after which to begin returning results.
// For example, a file list of 'a','b','d' and listAfter='b' will return 'd',
// and a listAfter='c' will also return 'd'. Optional. listBefore is gets or
// sets the item or lexographical index before which to begin returning
// results. For example, a file list of 'a','b','d' and listBefore='d' will
// return 'a','b', and a listBefore='c' will also return 'a','b'. Optional.
func (client GroupClient) ListFileStatus(listFilePath string, op string, listSize *int32, listAfter string, listBefore string) (result FileStatusesResult, err error) {
...
func (client GroupClient) ListFileStatusPreparer(listFilePath string, op string, listSize *int32, listAfter string, listBefore string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
...
func (client GroupClient) Mkdirs(pathParameter string, op string) (result FileOperationResult, err error) {
...
func (client GroupClient) MkdirsPreparer(pathParameter string, op string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"path": autorest.Encode("path", pathParameter),
	}
...
// operation.
func (client GroupClient) ModifyACLEntries(modifyACLFilePath string, aclspec string, op string) (result autorest.Response, err error) {
...
func (client GroupClient) ModifyACLEntriesPreparer(modifyACLFilePath string, aclspec string, op string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
...
// list of Data Lake Store paths (starting with '/') of the source files. Must
...
func (client GroupClient) MsConcat(msConcatDestinationPath string, streamContents io.ReadCloser, op string, deleteSourceDirectory *bool) (result autorest.Response, err error) {
...
func (client GroupClient) MsConcatPreparer(msConcatDestinationPath string, streamContents io.ReadCloser, op string, deleteSourceDirectory *bool) (*http.Request, error) {
	pathParameters := map[string]interface{}{
...
// value for the operation. length is the number of bytes that the server will
// attempt to retrieve. It will retrieve <= length bytes. offset is the byte
// offset to start reading data from.
func (client GroupClient) Open(directFilePath string, op string, read string, length *int64, offset *int64) (result ReadCloser, err error) {
...
func (client GroupClient) OpenPreparer(directFilePath string, op string, read string, length *int64, offset *int64) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"directFilePath": autorest.Encode("path", directFilePath),
	}
...
// operation.
func (client GroupClient) RemoveACL(aclFilePath string, op string) (result autorest.Response, err error) {
...
func (client GroupClient) RemoveACLPreparer(aclFilePath string, op string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"aclFilePath": autorest.Encode("path", aclFilePath),
	}
...
func (client GroupClient) RemoveACLEntries(removeACLFilePath string, aclspec string, op string) (result autorest.Response, err error) {
...
func (client GroupClient) RemoveACLEntriesPreparer(removeACLFilePath string, aclspec string, op string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
...
// the operation.
func (client GroupClient) RemoveDefaultACL(defaultACLFilePath string, op string) (result autorest.Response, err error) {
...
func (client GroupClient) RemoveDefaultACLPreparer(defaultACLFilePath string, op string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
...
// or directory to move/rename. destination is the path to move/rename the file
// or folder to op is the constant value for the operation.
func (client GroupClient) Rename(renameFilePath string, destination string, op string) (result FileOperationResult, err error) {
...
func (client GroupClient) RenamePreparer(renameFilePath string, destination string, op string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
...
// '[default:]user|group|other::r|-w|-x|-' op is the constant value for the
// operation.
func (client GroupClient) SetACL(setACLFilePath string, aclspec string, op string) (result autorest.Response, err error) {
...
func (client GroupClient) SetACLPreparer(setACLFilePath string, aclspec string, op string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
...
// updated. 3. RelativeToCreationDate: ExpireTime is an integer in milliseconds
// representing the expiration date relative to file creation. 4. Absolute:
// ExpireTime is an integer in milliseconds, as a Unix timestamp relative to
// 1/1/1970 00:00:00. op is the constant value for the operation. expireTime is
// the time that the file will expire, corresponding to the ExpiryOption that
// was set.
func (client GroupClient) SetFileExpiry(filePath string, expiryOption ExpiryOptionType, op string, expireTime *int64) (result autorest.Response, err error) {
...
func (client GroupClient) SetFileExpiryPreparer(filePath string, expiryOption ExpiryOptionType, op string, expireTime *int64) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"filePath": autorest.Encode("path", filePath),
	}
...
//
// setOwnerFilePath is the Data Lake Store path (starting with '/') of the file
// or directory for which to set the owner. op is the constant value for the
// operation. owner is the AAD Object ID of the user owner of the file or
...
func (client GroupClient) SetOwner(setOwnerFilePath string, op string, owner string, group string) (result autorest.Response, err error) {
...
func (client GroupClient) SetOwnerPreparer(setOwnerFilePath string, op string, owner string, group string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
...
//
// setPermissionFilePath is the Data Lake Store path (starting with '/') of the
// file or directory for which to set the permission. op is the constant value
// for the operation. permission is a string representation of the permission
// (i.e 'rwx'). If empty, this property remains unchanged.
func (client GroupClient) SetPermission(setPermissionFilePath string, op string, permission string) (result autorest.Response, err error) {
...
func (client GroupClient) SetPermissionPreparer(setPermissionFilePath string, op string, permission string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
