...
// Possible values include: 'DATA', 'METADATA', 'CLOSE' leaseID is optional unique GUID per file to ensure single
// writer semantics, meaning that only clients that append to the file with the same leaseId will be allowed to do so.
// fileSessionID is optional unique GUID per file indicating all the appends with the same fileSessionId are from the
// same client and same session. This will give a performance benefit when syncFlag is DATA or METADATA.
func (client GroupClient) Append(accountName string, pathParameter string, streamContents io.ReadCloser, appendParameter string, op string, offset *int64, syncFlag SyncFlag, leaseID *uuid.UUID, fileSessionID *uuid.UUID) (result autorest.Response, err error) {
	if err := validation.Validate([]validation.Validation{}); err != nil {
		return result, validation.NewErrorWithValidationError(err, "filesystem.GroupClient", "Append")
	}
...
func (client GroupClient) CheckAccess(accountName string, pathParameter string, fsaction string, op string) (result autorest.Response, err error) {
	if err := validation.Validate([]validation.Validation{}); err != nil {
		return result, validation.NewErrorWithValidationError(err, "filesystem.GroupClient", "CheckAccess")
	}
...
// create the file if it doesn't exist or just open the existing file for append. Possible values include: 'Autocreate'
// syncFlag is optionally indicates what to do after completion of the concurrent append. DATA indicates that more data
// will be sent immediately by the client, the file handle should remain open/locked, and file metadata (including file
// length, last modified time) should NOT get updated. METADATA indicates that more data will be sent immediately by
// the client, the file handle should remain open/locked, and file metadata should get updated. CLOSE indicates that
// the client is done sending data, the file handle should be closed/unlocked, and file metadata should get updated.
...
func (client GroupClient) ConcurrentAppend(accountName string, pathParameter string, streamContents io.ReadCloser, op string, transferEncoding string, appendMode AppendModeType, syncFlag SyncFlag) (result autorest.Response, err error) {
	if err := validation.Validate([]validation.Validation{}); err != nil {
		return result, validation.NewErrorWithValidationError(err, "filesystem.GroupClient", "ConcurrentAppend")
	}
...
// data, the file handle should be closed/unlocked, and file metadata should get updated. Possible values include:
// 'DATA', 'METADATA', 'CLOSE' leaseID is optional unique GUID per file to ensure single writer semantics, meaning that
// only clients that append to the file with the same leaseId will be allowed to do so. permission is the octal
...
func (client GroupClient) Create(accountName string, pathParameter string, write string, op string, streamContents io.ReadCloser, overwrite *bool, syncFlag SyncFlag, leaseID *uuid.UUID, permission *int32) (result autorest.Response, err error) {
	if err := validation.Validate([]validation.Validation{}); err != nil {
		return result, validation.NewErrorWithValidationError(err, "filesystem.GroupClient", "Create")
	}
...
func (client GroupClient) Delete(accountName string, pathParameter string, op string, recursive *bool) (result FileOperationResult, err error) {
	if err := validation.Validate([]validation.Validation{}); err != nil {
		return result, validation.NewErrorWithValidationError(err, "filesystem.GroupClient", "Delete")
	}
...
func (client GroupClient) GetACLStatus(accountName string, pathParameter string, op string, tooID *bool) (result ACLStatusResult, err error) {
	if err := validation.Validate([]validation.Validation{}); err != nil {
		return result, validation.NewErrorWithValidationError(err, "filesystem.GroupClient", "GetACLStatus")
	}
...
func (client GroupClient) GetContentSummary(accountName string, pathParameter string, op string) (result ContentSummaryResult, err error) {
	if err := validation.Validate([]validation.Validation{}); err != nil {
		return result, validation.NewErrorWithValidationError(err, "filesystem.GroupClient", "GetContentSummary")
	}
...
func (client GroupClient) GetFileStatus(accountName string, pathParameter string, op string, tooID *bool) (result FileStatusResult, err error) {
	if err := validation.Validate([]validation.Validation{}); err != nil {
		return result, validation.NewErrorWithValidationError(err, "filesystem.GroupClient", "GetFileStatus")
	}
...
func (client GroupClient) ListFileStatus(accountName string, pathParameter string, op string, listSize *int32, listAfter string, listBefore string, tooID *bool) (result FileStatusesResult, err error) {
	if err := validation.Validate([]validation.Validation{}); err != nil {
		return result, validation.NewErrorWithValidationError(err, "filesystem.GroupClient", "ListFileStatus")
	}
...
func (client GroupClient) Mkdirs(accountName string, pathParameter string, op string, permission *int32) (result FileOperationResult, err error) {
	if err := validation.Validate([]validation.Validation{}); err != nil {
		return result, validation.NewErrorWithValidationError(err, "filesystem.GroupClient", "Mkdirs")
	}
...
func (client GroupClient) ModifyACLEntries(accountName string, pathParameter string, aclspec string, op string) (result autorest.Response, err error) {
	if err := validation.Validate([]validation.Validation{}); err != nil {
		return result, validation.NewErrorWithValidationError(err, "filesystem.GroupClient", "ModifyACLEntries")
	}
...
func (client GroupClient) MsConcat(accountName string, pathParameter string, streamContents io.ReadCloser, op string, deleteSourceDirectory *bool) (result autorest.Response, err error) {
	if err := validation.Validate([]validation.Validation{}); err != nil {
		return result, validation.NewErrorWithValidationError(err, "filesystem.GroupClient", "MsConcat")
	}
...
func (client GroupClient) Open(accountName string, pathParameter string, read string, op string, length *int64, offset *int64, fileSessionID *uuid.UUID) (result ReadCloser, err error) {
	if err := validation.Validate([]validation.Validation{}); err != nil {
		return result, validation.NewErrorWithValidationError(err, "filesystem.GroupClient", "Open")
	}
...
func (client GroupClient) RemoveACL(accountName string, pathParameter string, op string) (result autorest.Response, err error) {
	if err := validation.Validate([]validation.Validation{}); err != nil {
		return result, validation.NewErrorWithValidationError(err, "filesystem.GroupClient", "RemoveACL")
	}
...
func (client GroupClient) RemoveACLEntries(accountName string, pathParameter string, aclspec string, op string) (result autorest.Response, err error) {
	if err := validation.Validate([]validation.Validation{}); err != nil {
		return result, validation.NewErrorWithValidationError(err, "filesystem.GroupClient", "RemoveACLEntries")
	}
...
func (client GroupClient) RemoveDefaultACL(accountName string, pathParameter string, op string) (result autorest.Response, err error) {
	if err := validation.Validate([]validation.Validation{}); err != nil {
		return result, validation.NewErrorWithValidationError(err, "filesystem.GroupClient", "RemoveDefaultACL")
	}
...
func (client GroupClient) Rename(accountName string, pathParameter string, destination string, op string) (result FileOperationResult, err error) {
	if err := validation.Validate([]validation.Validation{}); err != nil {
		return result, validation.NewErrorWithValidationError(err, "filesystem.GroupClient", "Rename")
	}
...
func (client GroupClient) SetACL(accountName string, pathParameter string, aclspec string, op string) (result autorest.Response, err error) {
	if err := validation.Validate([]validation.Validation{}); err != nil {
		return result, validation.NewErrorWithValidationError(err, "filesystem.GroupClient", "SetACL")
	}
...
// Possible values include: 'NeverExpire', 'RelativeToNow', 'RelativeToCreationDate', 'Absolute' op is the constant
// value for the operation. expireTime is the time that the file will expire, corresponding to the ExpiryOption that
// was set.
func (client GroupClient) SetFileExpiry(accountName string, pathParameter string, expiryOption ExpiryOptionType, op string, expireTime *int64) (result autorest.Response, err error) {
	if err := validation.Validate([]validation.Validation{}); err != nil {
		return result, validation.NewErrorWithValidationError(err, "filesystem.GroupClient", "SetFileExpiry")
	}
...
func (client GroupClient) SetOwner(accountName string, pathParameter string, op string, owner string, group string) (result autorest.Response, err error) {
	if err := validation.Validate([]validation.Validation{}); err != nil {
		return result, validation.NewErrorWithValidationError(err, "filesystem.GroupClient", "SetOwner")
	}
...
func (client GroupClient) SetPermission(accountName string, pathParameter string, op string, permission string) (result autorest.Response, err error) {
	if err := validation.Validate([]validation.Validation{}); err != nil {
		return result, validation.NewErrorWithValidationError(err, "filesystem.GroupClient", "SetPermission")
	}
