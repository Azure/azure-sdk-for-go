...
func (client GroupClient) Detect(imageURL ImageURL, returnFaceID *bool, returnFaceLandmarks *bool, returnFaceAttributes string) (result ListDetectedFaceWrapper, err error) {
...
func (client GroupClient) DetectResponder(resp *http.Response) (result ListDetectedFaceWrapper, err error) {
...
// closes the http.Response Body.
func (client GroupClient) DetectInStreamResponder(resp *http.Response) (result ListDetectedFaceWrapper, err error) {
	err = autorest.Respond(
		resp,
		client.ByInspecting(),
		azure.WithErrorUnlessStatusCode(http.StatusOK),
...
//
func (client GroupClient) FindSimilar(body FindSimilarRequest) (result ListSimilarFaceResultWrapper, err error) {
	if err := validation.Validate([]validation.Validation{
		{TargetValue: body,
...
// closes the http.Response Body.
func (client GroupClient) FindSimilarResponder(resp *http.Response) (result ListSimilarFaceResultWrapper, err error) {
	err = autorest.Respond(
		resp,
		client.ByInspecting(),
		azure.WithErrorUnlessStatusCode(http.StatusOK),
...
//
func (client GroupClient) Identify(body IdentifyRequest) (result ListIdentifyResultItemWrapper, err error) {
	if err := validation.Validate([]validation.Validation{
		{TargetValue: body,
...
// closes the http.Response Body.
func (client GroupClient) IdentifyResponder(resp *http.Response) (result ListIdentifyResultItemWrapper, err error) {
	err = autorest.Respond(
		resp,
		client.ByInspecting(),
		azure.WithErrorUnlessStatusCode(http.StatusOK),
