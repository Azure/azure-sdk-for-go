...
// ListDetectedFaceWrapper is
type ListDetectedFaceWrapper struct {
	autorest.Response `json:"-"`
	Value             *[]DetectedFace `json:"value,omitempty"`
}

// ListGetFaceListResultWrapper is
type ListGetFaceListResultWrapper struct {
	autorest.Response `json:"-"`
	Value             *[]GetFaceListResult `json:"value,omitempty"`
}

// ListIdentifyResultItemWrapper is
type ListIdentifyResultItemWrapper struct {
	autorest.Response `json:"-"`
	Value             *[]IdentifyResultItem `json:"value,omitempty"`
}

// ListPersonGroupResultWrapper is
type ListPersonGroupResultWrapper struct {
	autorest.Response `json:"-"`
	Value             *[]PersonGroupResult `json:"value,omitempty"`
}

// ListPersonResultWrapper is
type ListPersonResultWrapper struct {
	autorest.Response `json:"-"`
	Value             *[]PersonResult `json:"value,omitempty"`
}

// ListSimilarFaceResultWrapper is
type ListSimilarFaceResultWrapper struct {
	autorest.Response `json:"-"`
