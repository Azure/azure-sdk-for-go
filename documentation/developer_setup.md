...
There are two code generation stacks available: [TypeSpec](https://typespec.io/) or autorest. TypeSpec should be used for all new stacks. Autorest should only be used for legacy stacks that use Swagger/OpenAPI specifications.
