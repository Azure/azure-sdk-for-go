...
export declare const $lib: import("@typespec/compiler").TypeSpecLibrary<{
    ...
    "cookies-unsupported": {
        readonly default: "Cookies are not supported in Swagger 2.0. Parameter was ignored.";
    };
    "invalid-format": {
    ...
    "no-matching-version-found": {
        readonly default: "The emitter did not emit any files because the specified version option does not match any versions of the service.";
    };
}, AutorestEmitterOptions, "example" | "useRef">;
export declare const reportDiagnostic: <C extends "duplicate-body-types" | "duplicate-header" | "duplicate-example" | "duplicate-example-file" | "invalid-schema" | "union-null" | "union-unsupported" | "invalid-multi-collection-format" | "inline-cycle" | "nonspecific-scalar" | "example-loading" | "unsupported-http-auth-scheme" | "unsupported-status-code-range" | "unsupported-multipart-type" | "unsupported-param-type" | "unsupported-optional-path-param" | "cookies-unsupported" | "invalid-format" | "unsupported-auth" | "no-matching-version-found", M extends keyof {
    "duplicate-body-types": {
        readonly default: "Request has multiple body types";
    };
    "duplicate-header": {
...
}, C, M>) => void, createDiagnostic: <C extends "duplicate-body-types" | "duplicate-header" | "duplicate-example" | "duplicate-example-file" | "invalid-schema" | "union-null" | "union-unsupported" | "invalid-multi-collection-format" | "inline-cycle" | "nonspecific-scalar" | "example-loading" | "unsupported-http-auth-scheme" | "unsupported-status-code-range" | "unsupported-multipart-type" | "unsupported-param-type" | "unsupported-optional-path-param" | "cookies-unsupported" | "invalid-format" | "unsupported-auth" | "no-matching-version-found", M extends keyof {
    "duplicate-body-types": {
        readonly default: "Request has multiple body types";
    };
    "duplicate-header": {
