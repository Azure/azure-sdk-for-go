...
import { DefaultFinalStateViaDecorator, EnsureResourceTypeDecorator, EnsureVerbDecorator, NeedsRouteDecorator, ParameterizedNextLinkConfigDecorator, SpreadCustomParametersDecorator, SpreadCustomResponsePropertiesDecorator } from "../generated-defs/Azure.Core.Foundations.Private.js";
import { FinalLocationDecorator, FinalOperationDecorator, FixedDecorator, ItemsDecorator, LroCanceledDecorator, LroErrorResultDecorator, LroFailedDecorator, LroStatusDecorator, LroSucceededDecorator, NextPageOperationDecorator, OperationLinkDecorator, PagedResultDecorator, PollingLocationDecorator, PollingOperationDecorator, PollingOperationParameterDecorator, UseFinalStateViaDecorator } from "../generated-defs/Azure.Core.js";
...
declare const getParameterizedNextLinkArguments: (program: Program, type: Scalar) => ModelProperty[] | undefined;
declare const parameterizedNextLinkConfigDecorator: ParameterizedNextLinkConfigDecorator;
