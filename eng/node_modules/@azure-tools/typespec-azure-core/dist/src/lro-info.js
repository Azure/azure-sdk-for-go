...
export function extractStatusMonitorInfo(program, model, statusProperty) {
    ...
    return diagnosticsToKeep.wrap({
        ...
        successType: successProperty?.type?.kind === "Intrinsic" || successProperty?.type?.kind === "Model"
