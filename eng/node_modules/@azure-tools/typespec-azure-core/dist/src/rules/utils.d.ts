import { CallableMessage, DecoratedType, DiagnosticTarget, Enum, EnumMember, Interface, LinterRuleContext, Model, ModelProperty, Namespace, Operation, Program, Scalar, SourceLocation, Type, Union, UnionVariant } from "@typespec/compiler";
