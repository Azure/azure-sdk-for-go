export declare const $lib: import("@typespec/compiler").TypeSpecLibrary<{
    ...
    "decorator-param-wrong-type": {
        ...
        readonly armIdentifiersIncorrectEntity: "The @identifiers decorator must be applied to a property that is an array of objects";
        readonly armIdentifiersProperties: "The @identifiers decorator expects a parameter that is an array of strings or an empty array.";
    };
