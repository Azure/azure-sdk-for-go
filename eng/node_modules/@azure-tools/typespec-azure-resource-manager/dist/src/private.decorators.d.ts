import { DecoratorContext, Interface, Model, ModelProperty, Program } from "@typespec/compiler";
...
export declare function registerArmResource(context: DecoratorContext, resourceType: Model): void;
