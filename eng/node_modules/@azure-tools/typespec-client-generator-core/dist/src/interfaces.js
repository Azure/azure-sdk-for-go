...
(function (UsageFlags) {
    ...
    UsageFlags[UsageFlags["Exception"] = 1024] = "Exception";
    /** Set when type is used as LRO initial response. */
    UsageFlags[UsageFlags["LroInitial"] = 2048] = "LroInitial";
    /** Set when type is used as LRO polling response. */
    UsageFlags[UsageFlags["LroPolling"] = 4096] = "LroPolling";
    /** Set when type is used as LRO final envelop response. */
    UsageFlags[UsageFlags["LroFinalEnvelope"] = 8192] = "LroFinalEnvelope";
 ...
 */
export var InitializedByFlags;
(function (InitializedByFlags) {
    InitializedByFlags[InitializedByFlags["Default"] = 0] = "Default";
    InitializedByFlags[InitializedByFlags["Individually"] = 1] = "Individually";
    InitializedByFlags[InitializedByFlags["Parent"] = 2] = "Parent";
