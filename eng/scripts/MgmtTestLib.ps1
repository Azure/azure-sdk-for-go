...
function Invoke-MgmtTestgen ()
{
    ...
    if ($cleanGenerated)
    {
        ...
        Get-ChildItem "*_test.go" | Select-String -Pattern "Code generated by Microsoft (R) AutoRest Code Generator." | Select-Object -ExcludeProperty path | Remove-Item -Force -Confirm
    }
