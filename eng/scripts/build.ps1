...
param(
    ...
    [string]$filePrefix = "zz_generated_",
    [string]$outputFolder
)
...
function Process-Sdk ()
{
    ...
    if ($cleanGenerated)
    {
        ...
        Get-ChildItem "*.go" | Select-String -Pattern "Code generated by Microsoft (R) AutoRest Code Generator." | Select-Object -ExcludeProperty path | Remove-Item -Force -Confirm
    }
