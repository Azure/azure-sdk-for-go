...
func (c *Client) NameToUnderscore(ctx context.Context, _ string, serviceName string) error {
	return nil
}

// Function where multiple parameter names change to underscore (should be filtered)
func (c *Client) MultipleNamesToUnderscore(ctx context.Context, _ string, _ string, _ int) error {
	return nil
}

// Function where parameter type also changes (should NOT be filtered)
func (c *Client) TypeAndNameChange(ctx context.Context, _ int) error {
	return nil
}

// Function where parameter name changes but not to underscore (should NOT be filtered)
func (c *Client) NameChangeNotToUnderscore(ctx context.Context, groupName string) error {
	return nil
}
