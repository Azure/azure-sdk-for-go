...
[![PkgGoDev](https://pkg.go.dev/badge/github.com/Azure/azure-sdk-for-go/sdk/profiles/{{packageName}})](https://pkg.go.dev/github.com/Azure/azure-sdk-for-go/sdk/profiles/{{packageName}})
...
This module is for profile `{{rpName}}`.

[Source code](https://github.com/Azure/azure-sdk-for-go/tree/main/sdk/profiles/{{packageName}})
