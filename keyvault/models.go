...
type Contacts struct {
	autorest.Response `json:"-"`
	ID                *string    `json:"id,omitempty"`
	ContactsProperty  *[]Contact `json:"contacts,omitempty"`
}
...
type KeyOperationsParameters struct {
	Alg   JSONWebKeyEncryptionAlgorithm `json:"alg,omitempty"`
	Value *string                       `json:"value,omitempty"`
}
...
// LifetimeAction is action and its trigger that will be performed by Key
...
type X509CertificateProperties struct {
	...
	ValidityMonths *int32                   `json:"validity_months,omitempty"`
}
