...
import original "github.com/Azure/azure-sdk-for-go/service/sql/management/2014-04-01/advisors"
...
const (
	GA			Status	= original.GA
	LimitedPublicPreview	Status	= original.LimitedPublicPreview
	PrivatePreview		Status	= original.PrivatePreview
	PublicPreview		Status	= original.PublicPreview
)
