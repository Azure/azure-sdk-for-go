...
func NewCertificatesClient(subscriptionID string, credential azcore.TokenCredential, options *arm.ClientOptions) (*CertificatesClient, error) {
	cl, err := arm.NewClient(internal.ModuleName+"/armiothub.CertificatesClient", internal.ModuleVersion, credential, options)
	if err != nil {
		return nil, err
	}
...
func (client *CertificatesClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, resourceName string, certificateName string, certificateDescription CertificateBodyDescription, options *CertificatesClientCreateOrUpdateOptions) (*policy.Request, error) {
