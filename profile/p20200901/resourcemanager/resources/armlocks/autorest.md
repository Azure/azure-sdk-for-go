...
module-name: profile/p20200901/resourcemanager/resources/armlocks
...
directive:
  - from:
      ...
      - "client_factory.go"
    where: $
    transform: return $.replace(/moduleVersion/, "internal.ModuleVersion").replace(/moduleName\+"/, "internal.ModuleName+\"/armlocks");
```