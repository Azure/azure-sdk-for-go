...
func NewClientFactory(subscriptionID string, credential azcore.TokenCredential, options *arm.ClientOptions) (*ClientFactory, error) {
	_, err := arm.NewClient(internal.ModuleName+"/armeventhub.ClientFactory", internal.ModuleVersion, credential, options)
	if err != nil {
		return nil, err
	}
...
func (c *ClientFactory) NewRegionsClient() *RegionsClient {
	subClient, _ := NewRegionsClient(c.subscriptionID, c.credential, c.options)
	return subClient
}
