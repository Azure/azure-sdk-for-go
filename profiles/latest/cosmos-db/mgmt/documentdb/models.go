...
type DatabaseAccountsCreateUpdateSQLStoredProcedureFuture = original.DatabaseAccountsCreateUpdateSQLStoredProcedureFuture
...
type DatabaseAccountsDeleteSQLStoredProcedureFuture = original.DatabaseAccountsDeleteSQLStoredProcedureFuture
...
type SQLStoredProcedure = original.SQLStoredProcedure
...
type SQLStoredProcedureProperties = original.SQLStoredProcedureProperties
