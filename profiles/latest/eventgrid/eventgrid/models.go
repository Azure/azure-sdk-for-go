...
type CertificateExpired = original.CertificateExpired
type CertificateNearExpiry = original.CertificateNearExpiry
type CertificateNewVersionCreated = original.CertificateNewVersionCreated
...
type KeyExpired = original.KeyExpired
type KeyNearExpiry = original.KeyNearExpiry
type KeyNewVersionCreated = original.KeyNewVersionCreated
...
type SecretExpired = original.SecretExpired
type SecretNearExpiry = original.SecretNearExpiry
type SecretNewVersionCreated = original.SecretNewVersionCreated
