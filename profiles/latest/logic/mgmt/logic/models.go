...
type AssemblyCollectionIterator = original.AssemblyCollectionIterator
type AssemblyCollectionPage = original.AssemblyCollectionPage
...
type BatchConfigurationCollectionIterator = original.BatchConfigurationCollectionIterator
type BatchConfigurationCollectionPage = original.BatchConfigurationCollectionPage
...
type ExpressionTracesIterator = original.ExpressionTracesIterator
type ExpressionTracesPage = original.ExpressionTracesPage
...
type KeyVaultKeyCollectionIterator = original.KeyVaultKeyCollectionIterator
type KeyVaultKeyCollectionPage = original.KeyVaultKeyCollectionPage
