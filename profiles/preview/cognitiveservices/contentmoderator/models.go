...
func New(ocpApimSubscriptionKey string, baseURL AzureRegionBaseURL) BaseClient {
	return original.New(ocpApimSubscriptionKey, baseURL)
}
func NewWithoutDefaults(ocpApimSubscriptionKey string, baseURL AzureRegionBaseURL) BaseClient {
	return original.NewWithoutDefaults(ocpApimSubscriptionKey, baseURL)
}
func NewListManagementImageListsClient(ocpApimSubscriptionKey string, baseURL AzureRegionBaseURL) ListManagementImageListsClient {
	return original.NewListManagementImageListsClient(ocpApimSubscriptionKey, baseURL)
}
func NewListManagementTermClient(ocpApimSubscriptionKey string, baseURL AzureRegionBaseURL) ListManagementTermClient {
	return original.NewListManagementTermClient(ocpApimSubscriptionKey, baseURL)
}
func NewReviewsClient(ocpApimSubscriptionKey string, baseURL AzureRegionBaseURL) ReviewsClient {
	return original.NewReviewsClient(ocpApimSubscriptionKey, baseURL)
}
func NewImageModerationClient(ocpApimSubscriptionKey string, baseURL AzureRegionBaseURL) ImageModerationClient {
	return original.NewImageModerationClient(ocpApimSubscriptionKey, baseURL)
}
func NewListManagementImageClient(ocpApimSubscriptionKey string, baseURL AzureRegionBaseURL) ListManagementImageClient {
	return original.NewListManagementImageClient(ocpApimSubscriptionKey, baseURL)
}
func NewListManagementTermListsClient(ocpApimSubscriptionKey string, baseURL AzureRegionBaseURL) ListManagementTermListsClient {
	return original.NewListManagementTermListsClient(ocpApimSubscriptionKey, baseURL)
}
func NewTextModerationClient(ocpApimSubscriptionKey string, baseURL AzureRegionBaseURL) TextModerationClient {
	return original.NewTextModerationClient(ocpApimSubscriptionKey, baseURL)
}
