...
import original "github.com/Azure/azure-sdk-for-go/services/cognitiveservices/luis/v2.0/programmatic"
...
const (
	Fail       Status = original.Fail
	InProgress Status = original.InProgress
	Queued     Status = original.Queued
	Success    Status = original.Success
	UpToDate   Status = original.UpToDate
)
...
const (
	TrainingStatusInProgress    TrainingStatus = original.TrainingStatusInProgress
	TrainingStatusNeedsTraining TrainingStatus = original.TrainingStatusNeedsTraining
	TrainingStatusTrained       TrainingStatus = original.TrainingStatusTrained
)
...
type AvailableEndpoints = original.AvailableEndpoints
...
type HierarchicalModelCreateObject = original.HierarchicalModelCreateObject
type HierarchicalModelUpdateObject = original.HierarchicalModelUpdateObject
