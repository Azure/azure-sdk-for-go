...
type DNSNameLabelReusePolicy = original.DNSNameLabelReusePolicy

const (
	DNSNameLabelReusePolicyNoreuse            DNSNameLabelReusePolicy = original.DNSNameLabelReusePolicyNoreuse
	DNSNameLabelReusePolicyResourceGroupReuse DNSNameLabelReusePolicy = original.DNSNameLabelReusePolicyResourceGroupReuse
	DNSNameLabelReusePolicySubscriptionReuse  DNSNameLabelReusePolicy = original.DNSNameLabelReusePolicySubscriptionReuse
	DNSNameLabelReusePolicyTenantReuse        DNSNameLabelReusePolicy = original.DNSNameLabelReusePolicyTenantReuse
	DNSNameLabelReusePolicyUnsecure           DNSNameLabelReusePolicy = original.DNSNameLabelReusePolicyUnsecure
)
...
type ContainerGroupPropertiesModel = original.ContainerGroupPropertiesModel
...
type SubnetServiceAssociationLinkClient = original.SubnetServiceAssociationLinkClient
type SubnetServiceAssociationLinkDeleteFuture = original.SubnetServiceAssociationLinkDeleteFuture
...
func NewSubnetServiceAssociationLinkClient(subscriptionID string) SubnetServiceAssociationLinkClient {
	return original.NewSubnetServiceAssociationLinkClient(subscriptionID)
}
func NewSubnetServiceAssociationLinkClientWithBaseURI(baseURI string, subscriptionID string) SubnetServiceAssociationLinkClient {
	return original.NewSubnetServiceAssociationLinkClientWithBaseURI(baseURI, subscriptionID)
}
...
func PossibleDNSNameLabelReusePolicyValues() []DNSNameLabelReusePolicy {
	return original.PossibleDNSNameLabelReusePolicyValues()
}
