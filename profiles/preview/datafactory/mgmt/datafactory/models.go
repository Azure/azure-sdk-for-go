...
type TypeAzureKeyVaultReference = original.TypeAzureKeyVaultReference

const (
	TypeAzureKeyVaultSecret TypeAzureKeyVaultReference = original.TypeAzureKeyVaultSecret
)
...
type AzureKeyVaultReference = original.AzureKeyVaultReference
