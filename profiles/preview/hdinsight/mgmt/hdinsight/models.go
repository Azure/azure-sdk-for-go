...
type ApplicationName = original.ApplicationName
...
type HTTPSettingsParameters = original.HTTPSettingsParameters
...
type RdpSettings = original.RdpSettings
type RDPSettingsParameters = original.RDPSettingsParameters
...
type WindowsOperatingSystemProfile = original.WindowsOperatingSystemProfile
