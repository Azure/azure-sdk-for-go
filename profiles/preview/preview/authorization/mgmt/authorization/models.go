...
import (
	...
	original "github.com/Azure/temp/github.com/Azure/azure-sdk-for-go/services/preview/authorization/mgmt/2020-04-01-preview/authorization"
)
...
func NewDenyAssignmentListResultPage(cur DenyAssignmentListResult, getNextPage func(context.Context, DenyAssignmentListResult) (DenyAssignmentListResult, error)) DenyAssignmentListResultPage {
	return original.NewDenyAssignmentListResultPage(cur, getNextPage)
}
