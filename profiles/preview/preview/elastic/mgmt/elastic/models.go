...
const (
	Healthy   DeploymentStatus = original.Healthy
	Unhealthy DeploymentStatus = original.Unhealthy
)
...
const (
	Add    OperationName = original.Add
	Delete OperationName = original.Delete
)
...
const (
	False SendingLogs = original.False
	True  SendingLogs = original.True
)
