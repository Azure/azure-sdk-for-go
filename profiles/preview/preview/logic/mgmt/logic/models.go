...
type IntegrationServiceEnvironmentManagedAPIClient = original.IntegrationServiceEnvironmentManagedAPIClient
type IntegrationServiceEnvironmentManagedAPIDeleteFuture = original.IntegrationServiceEnvironmentManagedAPIDeleteFuture
type IntegrationServiceEnvironmentManagedAPIPutFuture = original.IntegrationServiceEnvironmentManagedAPIPutFuture
...
type IntegrationServiceEnvironmentsManagedAPIOperationsClient = original.IntegrationServiceEnvironmentsManagedAPIOperationsClient
...
type WorkflowRunActionRepetitionDefinitionCollectionIterator = original.WorkflowRunActionRepetitionDefinitionCollectionIterator
type WorkflowRunActionRepetitionDefinitionCollectionPage = original.WorkflowRunActionRepetitionDefinitionCollectionPage
...
func NewIntegrationServiceEnvironmentManagedAPIClient(subscriptionID string) IntegrationServiceEnvironmentManagedAPIClient {
	return original.NewIntegrationServiceEnvironmentManagedAPIClient(subscriptionID)
}
func NewIntegrationServiceEnvironmentManagedAPIClientWithBaseURI(baseURI string, subscriptionID string) IntegrationServiceEnvironmentManagedAPIClient {
	return original.NewIntegrationServiceEnvironmentManagedAPIClientWithBaseURI(baseURI, subscriptionID)
}
...
func NewIntegrationServiceEnvironmentsManagedAPIOperationsClient(subscriptionID string) IntegrationServiceEnvironmentsManagedAPIOperationsClient {
	return original.NewIntegrationServiceEnvironmentsManagedAPIOperationsClient(subscriptionID)
}
func NewIntegrationServiceEnvironmentsManagedAPIOperationsClientWithBaseURI(baseURI string, subscriptionID string) IntegrationServiceEnvironmentsManagedAPIOperationsClient {
	return original.NewIntegrationServiceEnvironmentsManagedAPIOperationsClientWithBaseURI(baseURI, subscriptionID)
}
...
func NewWorkflowRunActionRepetitionDefinitionCollectionIterator(page WorkflowRunActionRepetitionDefinitionCollectionPage) WorkflowRunActionRepetitionDefinitionCollectionIterator {
	return original.NewWorkflowRunActionRepetitionDefinitionCollectionIterator(page)
}
func NewWorkflowRunActionRepetitionDefinitionCollectionPage(getNextPage func(context.Context, WorkflowRunActionRepetitionDefinitionCollection) (WorkflowRunActionRepetitionDefinitionCollection, error)) WorkflowRunActionRepetitionDefinitionCollectionPage {
	return original.NewWorkflowRunActionRepetitionDefinitionCollectionPage(getNextPage)
}
