...
const (
	...
	OdataTypeAlertingAction    OdataTypeBasicAction = original.OdataTypeAlertingAction
	OdataTypeLogToMetricAction OdataTypeBasicAction = original.OdataTypeLogToMetricAction
)
