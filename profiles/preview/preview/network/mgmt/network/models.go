...
type PerimeterAssociableResource = original.PerimeterAssociableResource
type PerimeterAssociableResourceProperties = original.PerimeterAssociableResourceProperties
type PerimeterAssociableResourceTypesClient = original.PerimeterAssociableResourceTypesClient
type PerimeterAssociableResourcesListResult = original.PerimeterAssociableResourcesListResult
...
type SecurityPerimeter = original.SecurityPerimeter
type SecurityPerimeterListResult = original.SecurityPerimeterListResult
type SecurityPerimeterListResultIterator = original.SecurityPerimeterListResultIterator
type SecurityPerimeterListResultPage = original.SecurityPerimeterListResultPage
type SecurityPerimeterProperties = original.SecurityPerimeterProperties
type SecurityPerimetersClient = original.SecurityPerimetersClient
...
func NewPerimeterAssociableResourceTypesClient(subscriptionID string) PerimeterAssociableResourceTypesClient {
	return original.NewPerimeterAssociableResourceTypesClient(subscriptionID)
}
func NewPerimeterAssociableResourceTypesClientWithBaseURI(baseURI string, subscriptionID string) PerimeterAssociableResourceTypesClient {
	return original.NewPerimeterAssociableResourceTypesClientWithBaseURI(baseURI, subscriptionID)
}
...
func NewSecurityPerimeterListResultIterator(page SecurityPerimeterListResultPage) SecurityPerimeterListResultIterator {
	return original.NewSecurityPerimeterListResultIterator(page)
}
func NewSecurityPerimeterListResultPage(cur SecurityPerimeterListResult, getNextPage func(context.Context, SecurityPerimeterListResult) (SecurityPerimeterListResult, error)) SecurityPerimeterListResultPage {
	return original.NewSecurityPerimeterListResultPage(cur, getNextPage)
}
func NewSecurityPerimetersClient(subscriptionID string) SecurityPerimetersClient {
	return original.NewSecurityPerimetersClient(subscriptionID)
}
func NewSecurityPerimetersClientWithBaseURI(baseURI string, subscriptionID string) SecurityPerimetersClient {
	return original.NewSecurityPerimetersClientWithBaseURI(baseURI, subscriptionID)
}
