...
type IoTSecurityDeviceAlerts = original.IoTSecurityDeviceAlerts
...
type IoTSecuritySolutionAnalyticsModelDevicesMetricsItem = original.IoTSecuritySolutionAnalyticsModelDevicesMetricsItem
...
type IoTSecuritySolutionsAnalyticsAggregatedAlertDismissClient = original.IoTSecuritySolutionsAnalyticsAggregatedAlertDismissClient
...
func NewIoTSecuritySolutionsAnalyticsAggregatedAlertDismissClient(subscriptionID string, ascLocation string) IoTSecuritySolutionsAnalyticsAggregatedAlertDismissClient {
	return original.NewIoTSecuritySolutionsAnalyticsAggregatedAlertDismissClient(subscriptionID, ascLocation)
}
func NewIoTSecuritySolutionsAnalyticsAggregatedAlertDismissClientWithBaseURI(baseURI string, subscriptionID string, ascLocation string) IoTSecuritySolutionsAnalyticsAggregatedAlertDismissClient {
	return original.NewIoTSecuritySolutionsAnalyticsAggregatedAlertDismissClientWithBaseURI(baseURI, subscriptionID, ascLocation)
}
