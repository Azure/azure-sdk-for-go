...
const (
	InstanceTypeBasicFabricSpecificCreationInputInstanceTypeA2A                         InstanceTypeBasicFabricSpecificCreationInput = original.InstanceTypeBasicFabricSpecificCreationInputInstanceTypeA2A
	InstanceTypeBasicFabricSpecificCreationInputInstanceTypeFabricSpecificCreationInput InstanceTypeBasicFabricSpecificCreationInput = original.InstanceTypeBasicFabricSpecificCreationInputInstanceTypeFabricSpecificCreationInput
	InstanceTypeBasicFabricSpecificCreationInputInstanceTypeVMwareV2                    InstanceTypeBasicFabricSpecificCreationInput = original.InstanceTypeBasicFabricSpecificCreationInputInstanceTypeVMwareV2
)

type InstanceTypeBasicFabricSpecificDetails = original.InstanceTypeBasicFabricSpecificDetails

const (
	InstanceTypeAzure                 InstanceTypeBasicFabricSpecificDetails = original.InstanceTypeAzure
	InstanceTypeFabricSpecificDetails InstanceTypeBasicFabricSpecificDetails = original.InstanceTypeFabricSpecificDetails
	InstanceTypeHyperVSite            InstanceTypeBasicFabricSpecificDetails = original.InstanceTypeHyperVSite
	InstanceTypeVMM                   InstanceTypeBasicFabricSpecificDetails = original.InstanceTypeVMM
	InstanceTypeVMware                InstanceTypeBasicFabricSpecificDetails = original.InstanceTypeVMware
	InstanceTypeVMwareV2              InstanceTypeBasicFabricSpecificDetails = original.InstanceTypeVMwareV2
)
