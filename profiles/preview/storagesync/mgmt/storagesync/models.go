...
type StorageSyncError = original.StorageSyncError
type StorageSyncErrorDetails = original.StorageSyncErrorDetails
type StorageSyncService = original.StorageSyncService
type StorageSyncServiceArray = original.StorageSyncServiceArray
type StorageSyncServiceProperties = original.StorageSyncServiceProperties
type StorageSyncServiceUpdateParameters = original.StorageSyncServiceUpdateParameters
...
type StorageSyncServicesClient = original.StorageSyncServicesClient
...
func NewStorageSyncServicesClient(subscriptionID string) StorageSyncServicesClient {
	return original.NewStorageSyncServicesClient(subscriptionID)
}
func NewStorageSyncServicesClientWithBaseURI(baseURI string, subscriptionID string) StorageSyncServicesClient {
	return original.NewStorageSyncServicesClientWithBaseURI(baseURI, subscriptionID)
}
