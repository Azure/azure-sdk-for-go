...
func NewDiagnosticSettingsClient(con *connection) *DiagnosticSettingsClient {
	return &DiagnosticSettingsClient{con: con}
}

// CreateOrUpdate - Creates or updates diagnostic settings for AadIam.
// If the operation fails it returns the *ErrorResponse error type.
func (client *DiagnosticSettingsClient) CreateOrUpdate(ctx context.Context, name string, parameters DiagnosticSettingsResource, options *DiagnosticSettingsCreateOrUpdateOptions) (DiagnosticSettingsCreateOrUpdateResponse, error) {
...
func (client *DiagnosticSettingsClient) createOrUpdateCreateRequest(ctx context.Context, name string, parameters DiagnosticSettingsResource, options *DiagnosticSettingsCreateOrUpdateOptions) (*policy.Request, error) {
...
// If the operation fails it returns the *ErrorResponse error type.
func (client *DiagnosticSettingsClient) Delete(ctx context.Context, name string, options *DiagnosticSettingsDeleteOptions) (DiagnosticSettingsDeleteResponse, error) {
...
func (client *DiagnosticSettingsClient) deleteCreateRequest(ctx context.Context, name string, options *DiagnosticSettingsDeleteOptions) (*policy.Request, error) {
	urlPath := "/providers/microsoft.aadiam/diagnosticSettings/{name}"
	if name == "" {
		return nil, errors.New("parameter name cannot be empty")
	}
...
// If the operation fails it returns the *ErrorResponse error type.
func (client *DiagnosticSettingsClient) Get(ctx context.Context, name string, options *DiagnosticSettingsGetOptions) (DiagnosticSettingsGetResponse, error) {
...
func (client *DiagnosticSettingsClient) getCreateRequest(ctx context.Context, name string, options *DiagnosticSettingsGetOptions) (*policy.Request, error) {
	urlPath := "/providers/microsoft.aadiam/diagnosticSettings/{name}"
	if name == "" {
		return nil, errors.New("parameter name cannot be empty")
	}
...
// If the operation fails it returns the *ErrorResponse error type.
func (client *DiagnosticSettingsClient) List(ctx context.Context, options *DiagnosticSettingsListOptions) (DiagnosticSettingsListResponse, error) {
...
func (client *DiagnosticSettingsClient) listCreateRequest(ctx context.Context, options *DiagnosticSettingsListOptions) (*policy.Request, error) {
