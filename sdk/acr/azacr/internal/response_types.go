...
// ContainerRegistryBlobClientCompleteUploadWithBinaryResponse contains the response from method ContainerRegistryBlobClient.CompleteUploadWithBinary.
type ContainerRegistryBlobClientCompleteUploadWithBinaryResponse struct {
	// DockerContentDigest contains the information returned from the Docker-Content-Digest header response.
	DockerContentDigest *string
...
// ContainerRegistryBlobClientUploadChunkWithBinaryResponse contains the response from method ContainerRegistryBlobClient.UploadChunkWithBinary.
type ContainerRegistryBlobClientUploadChunkWithBinaryResponse struct {
	// DockerUploadUUID contains the information returned from the Docker-Upload-UUID header response.
	DockerUploadUUID *string
...
// ContainerRegistryClientCreateManifestWithBinaryResponse contains the response from method ContainerRegistryClient.CreateManifestWithBinary.
type ContainerRegistryClientCreateManifestWithBinaryResponse struct {
	// ContentLength contains the information returned from the Content-Length header response.
	ContentLength *int64
