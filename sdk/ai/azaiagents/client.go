...
import (
	...
	"github.com/Azure/azure-sdk-for-go/sdk/ai/azaiagents/internal"
)

// ClientOptions contains optional parameters for NewClient
type AgentsClientOptions struct {
...
type AgentsServiceActionOptions struct {
...
type AgentsCLientServiceActionResponse struct {
	Value *string
}

// SomeServiceAction does some service action
func (c *Client) AgentsServiceAction(ctx context.Context, options *AgentsServiceActionOptions) (AgentsCLientServiceActionResponse, error) {
	resp, err := c.client.SomeAPI(ctx, nil)
	if err != nil {
		return AgentsCLientServiceActionResponse{}, err
	}
	return AgentsCLientServiceActionResponse{Value: resp.Value}, nil
}
