...
func NewBackendClient(con *arm.Connection, subscriptionID string) *BackendClient {
	return &BackendClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
