...
const telemetryInfo = "azsdk-go-armappconfiguration/<version>"
...
// ConfigurationStoresOperations returns the ConfigurationStoresOperations associated with this client.
func (client *Client) ConfigurationStoresOperations(subscriptionID string) ConfigurationStoresOperations {
	return &configurationStoresOperations{Client: client, subscriptionID: subscriptionID}
}
