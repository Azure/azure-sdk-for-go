...
<!--[![PkgGoDev](https://pkg.go.dev/badge/github.com/Azure/azure-sdk-for-go/sdk/arm/avs)](https://pkg.go.dev/github.com/Azure/azure-sdk-for-go/sdk/arm/avs)-->

The `avs` module provides operations for working with Azure VMWare Service.

[Source code]<!--(https://github.com/Azure/azure-sdk-for-go/tree/master/sdk/arm/avs)-->
...
```sh
go get github.com/Azure/azure-sdk-for-go/sdk/arm/avs-preview
```
