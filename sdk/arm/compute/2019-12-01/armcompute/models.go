...
type ContainerServiceMasterProfile struct {
	...
	Count *Enum28 `json:"count,omitempty"`
...
func (d DedicatedHostProperties) MarshalJSON() ([]byte, error) {
	...
	aux := &struct {
		*alias
		ProvisioningTime *timeRFC3339 `json:"provisioningTime"`
	}{
		alias:            (*alias)(&d),
		ProvisioningTime: (*timeRFC3339)(d.ProvisioningTime),
	}
...
func (d *DedicatedHostProperties) UnmarshalJSON(data []byte) error {
	...
	d.ProvisioningTime = (*time.Time)(aux.ProvisioningTime)
	return nil
}
...
func (d DiskProperties) MarshalJSON() ([]byte, error) {
	...
	aux := &struct {
		*alias
		TimeCreated *timeRFC3339 `json:"timeCreated"`
	}{
		alias:       (*alias)(&d),
		TimeCreated: (*timeRFC3339)(d.TimeCreated),
	}
	return json.Marshal(aux)
}
...
func (d *DiskProperties) UnmarshalJSON(data []byte) error {
	...
	d.TimeCreated = (*time.Time)(aux.TimeCreated)
	return nil
}
...
func (g GalleryApplicationProperties) MarshalJSON() ([]byte, error) {
	...
	aux := &struct {
		*alias
		EndOfLifeDate *timeRFC3339 `json:"endOfLifeDate"`
	}{
		alias:         (*alias)(&g),
		EndOfLifeDate: (*timeRFC3339)(g.EndOfLifeDate),
	}
	return json.Marshal(aux)
}
...
func (g *GalleryApplicationProperties) UnmarshalJSON(data []byte) error {
	...
	g.EndOfLifeDate = (*time.Time)(aux.EndOfLifeDate)
	return nil
}
...
type GalleryApplicationVersionProperties struct {
	// The provisioning state, which only appears in the response.
	ProvisioningState *GalleryApplicationVersionPropertiesProvisioningState `json:"provisioningState,omitempty"`
...
func (g GalleryArtifactPublishingProfileBase) MarshalJSON() ([]byte, error) {
	...
	aux := &struct {
		*alias
		EndOfLifeDate *timeRFC3339 `json:"endOfLifeDate"`
		PublishedDate *timeRFC3339 `json:"publishedDate"`
	}{
		alias:         (*alias)(&g),
		EndOfLifeDate: (*timeRFC3339)(g.EndOfLifeDate),
		PublishedDate: (*timeRFC3339)(g.PublishedDate),
	}
	return json.Marshal(aux)
}
...
func (g *GalleryArtifactPublishingProfileBase) UnmarshalJSON(data []byte) error {
	...
	g.EndOfLifeDate = (*time.Time)(aux.EndOfLifeDate)
	g.PublishedDate = (*time.Time)(aux.PublishedDate)
	return nil
}
...
type GalleryArtifactSource struct {
	...
	ManagedImage *ManagedArtifact `undefined:"managedImage"`
}
...
type GalleryImageProperties struct {
	...
	// The provisioning state, which only appears in the response.
	ProvisioningState *GalleryImagePropertiesProvisioningState `json:"provisioningState,omitempty"`
...
type GalleryImageVersionProperties struct {
	// The provisioning state, which only appears in the response.
	ProvisioningState *GalleryImageVersionPropertiesProvisioningState `json:"provisioningState,omitempty"`
...
type GalleryProperties struct {
	...
	// The provisioning state, which only appears in the response.
	ProvisioningState *GalleryPropertiesProvisioningState `json:"provisioningState,omitempty"`
}
...
func (i InstanceViewStatus) MarshalJSON() ([]byte, error) {
	...
	aux := &struct {
		*alias
		Time *timeRFC3339 `json:"time"`
	}{
		alias: (*alias)(&i),
		Time:  (*timeRFC3339)(i.Time),
	}
	return json.Marshal(aux)
}
...
func (l LogAnalyticsInputBase) MarshalJSON() ([]byte, error) {
	...
	aux := &struct {
		*alias
		FromTime *timeRFC3339 `json:"fromTime"`
		ToTime   *timeRFC3339 `json:"toTime"`
	}{
		alias:    (*alias)(&l),
		FromTime: (*timeRFC3339)(l.FromTime),
		ToTime:   (*timeRFC3339)(l.ToTime),
	}
	return json.Marshal(aux)
}
...
func (l *LogAnalyticsInputBase) UnmarshalJSON(data []byte) error {
	...
	l.FromTime = (*time.Time)(aux.FromTime)
	l.ToTime = (*time.Time)(aux.ToTime)
	return nil
}
...
func (m MaintenanceRedeployStatus) MarshalJSON() ([]byte, error) {
	...
	aux := &struct {
		*alias
		MaintenanceWindowEndTime      *timeRFC3339 `json:"maintenanceWindowEndTime"`
		MaintenanceWindowStartTime    *timeRFC3339 `json:"maintenanceWindowStartTime"`
		PreMaintenanceWindowEndTime   *timeRFC3339 `json:"preMaintenanceWindowEndTime"`
		PreMaintenanceWindowStartTime *timeRFC3339 `json:"preMaintenanceWindowStartTime"`
	}{
		alias:                         (*alias)(&m),
		MaintenanceWindowEndTime:      (*timeRFC3339)(m.MaintenanceWindowEndTime),
		MaintenanceWindowStartTime:    (*timeRFC3339)(m.MaintenanceWindowStartTime),
		PreMaintenanceWindowEndTime:   (*timeRFC3339)(m.PreMaintenanceWindowEndTime),
		PreMaintenanceWindowStartTime: (*timeRFC3339)(m.PreMaintenanceWindowStartTime),
	}
	return json.Marshal(aux)
}
...
func (m *MaintenanceRedeployStatus) UnmarshalJSON(data []byte) error {
	...
	m.MaintenanceWindowEndTime = (*time.Time)(aux.MaintenanceWindowEndTime)
	m.MaintenanceWindowStartTime = (*time.Time)(aux.MaintenanceWindowStartTime)
	m.PreMaintenanceWindowEndTime = (*time.Time)(aux.PreMaintenanceWindowEndTime)
	m.PreMaintenanceWindowStartTime = (*time.Time)(aux.PreMaintenanceWindowStartTime)
	return nil
}
...
func (r RollingUpgradeRunningStatus) MarshalJSON() ([]byte, error) {
	...
	aux := &struct {
		*alias
		LastActionTime *timeRFC3339 `json:"lastActionTime"`
		StartTime      *timeRFC3339 `json:"startTime"`
	}{
		alias:          (*alias)(&r),
		LastActionTime: (*timeRFC3339)(r.LastActionTime),
...
func (r *RollingUpgradeRunningStatus) UnmarshalJSON(data []byte) error {
	...
	r.LastActionTime = (*time.Time)(aux.LastActionTime)
...
func (s SnapshotProperties) MarshalJSON() ([]byte, error) {
	...
	aux := &struct {
		*alias
		...
		alias:       (*alias)(&s),
		TimeCreated: (*timeRFC3339)(s.TimeCreated),
	}
	return json.Marshal(aux)
}
...
func (s *SnapshotProperties) UnmarshalJSON(data []byte) error {
	...
	s.TimeCreated = (*time.Time)(aux.TimeCreated)
	return nil
}
...
func (u UpgradeOperationHistoryStatus) MarshalJSON() ([]byte, error) {
	...
	aux := &struct {
		*alias
		...
		alias:     (*alias)(&u),
		EndTime:   (*timeRFC3339)(u.EndTime),
		StartTime: (*timeRFC3339)(u.StartTime),
	}
	return json.Marshal(aux)
}
...
func (u *UpgradeOperationHistoryStatus) UnmarshalJSON(data []byte) error {
	...
	u.EndTime = (*time.Time)(aux.EndTime)
	u.StartTime = (*time.Time)(aux.StartTime)
	return nil
}
