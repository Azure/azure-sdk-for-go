...
func (client *VirtualMachinesClient) assessPatchesHandleResponse(resp *azcore.Response) (VirtualMachineAssessPatchesResultResponse, error) {
	var val *VirtualMachineAssessPatchesResult
	if err := resp.UnmarshalAsJSON(&val); err != nil {
		return VirtualMachineAssessPatchesResultResponse{}, err
	}
	return VirtualMachineAssessPatchesResultResponse{RawResponse: resp.Response, VirtualMachineAssessPatchesResult: val}, nil
}
...
func (client *VirtualMachinesClient) ResumeInstallPatches(token string) (VirtualMachineInstallPatchesResultPoller, error) {
	pt, err := armcore.NewPollerFromResumeToken("VirtualMachinesClient.InstallPatches", token, client.installPatchesHandleError)
	if err != nil {
		return nil, err
	}
	return &virtualMachineInstallPatchesResultPoller{
		pipeline: client.con.Pipeline(),
		pt:       pt,
	}, nil
}
...
// installPatchesHandleResponse handles the InstallPatches response.
func (client *VirtualMachinesClient) installPatchesHandleResponse(resp *azcore.Response) (VirtualMachineInstallPatchesResultResponse, error) {
	var val *VirtualMachineInstallPatchesResult
	if err := resp.UnmarshalAsJSON(&val); err != nil {
		return VirtualMachineInstallPatchesResultResponse{}, err
	}
	return VirtualMachineInstallPatchesResultResponse{RawResponse: resp.Response, VirtualMachineInstallPatchesResult: val}, nil
}
