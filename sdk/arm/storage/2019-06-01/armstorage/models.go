...
func (a AccountSasParameters) MarshalJSON() ([]byte, error) {
	...
	aux := &struct {
		*alias
		SharedAccessExpiryTime *timeRFC3339 `json:"signedExpiry"`
		SharedAccessStartTime  *timeRFC3339 `json:"signedStart"`
	}{
		alias:                  (*alias)(&a),
		SharedAccessExpiryTime: (*timeRFC3339)(a.SharedAccessExpiryTime),
		SharedAccessStartTime:  (*timeRFC3339)(a.SharedAccessStartTime),
	}
...
func (a *AccountSasParameters) UnmarshalJSON(data []byte) error {
	...
	a.SharedAccessExpiryTime = (*time.Time)(aux.SharedAccessExpiryTime)
	a.SharedAccessStartTime = (*time.Time)(aux.SharedAccessStartTime)
	return nil
}
...
// BlobContainersGetImmutabilityPolicyOptions contains the optional parameters for the BlobContainers.GetImmutabilityPolicy
// method.
...
func (b BlobRestoreParameters) MarshalJSON() ([]byte, error) {
	...
	aux := &struct {
		*alias
		TimeToRestore *timeRFC3339 `json:"timeToRestore"`
	}{
		alias:         (*alias)(&b),
		TimeToRestore: (*timeRFC3339)(b.TimeToRestore),
	}
	return json.Marshal(aux)
}
...
func (b *BlobRestoreParameters) UnmarshalJSON(data []byte) error {
	...
	b.TimeToRestore = (*time.Time)(aux.TimeToRestore)
	return nil
}
...
func (e EncryptionScopeProperties) MarshalJSON() ([]byte, error) {
	...
	aux := &struct {
		*alias
		CreationTime     *timeRFC3339 `json:"creationTime"`
		LastModifiedTime *timeRFC3339 `json:"lastModifiedTime"`
	}{
		alias:            (*alias)(&e),
		CreationTime:     (*timeRFC3339)(e.CreationTime),
		LastModifiedTime: (*timeRFC3339)(e.LastModifiedTime),
	}
	return json.Marshal(aux)
}
...
func (e *EncryptionScopeProperties) UnmarshalJSON(data []byte) error {
	...
	e.CreationTime = (*time.Time)(aux.CreationTime)
	e.LastModifiedTime = (*time.Time)(aux.LastModifiedTime)
	return nil
}
...
func (e EncryptionService) MarshalJSON() ([]byte, error) {
	...
	aux := &struct {
		*alias
		LastEnabledTime *timeRFC3339 `json:"lastEnabledTime"`
	}{
		alias:           (*alias)(&e),
		LastEnabledTime: (*timeRFC3339)(e.LastEnabledTime),
	}
	return json.Marshal(aux)
}
...
func (e *EncryptionService) UnmarshalJSON(data []byte) error {
	...
	e.LastEnabledTime = (*time.Time)(aux.LastEnabledTime)
	return nil
}
...
func (f FileShareProperties) MarshalJSON() ([]byte, error) {
	...
	aux := &struct {
		*alias
		AccessTierChangeTime *timeRFC3339 `json:"accessTierChangeTime"`
		DeletedTime          *timeRFC3339 `json:"deletedTime"`
		LastModifiedTime     *timeRFC3339 `json:"lastModifiedTime"`
	}{
		alias:                (*alias)(&f),
		AccessTierChangeTime: (*timeRFC3339)(f.AccessTierChangeTime),
		DeletedTime:          (*timeRFC3339)(f.DeletedTime),
		LastModifiedTime:     (*timeRFC3339)(f.LastModifiedTime),
	}
	return json.Marshal(aux)
}
...
func (f *FileShareProperties) UnmarshalJSON(data []byte) error {
	...
	f.AccessTierChangeTime = (*time.Time)(aux.AccessTierChangeTime)
	f.DeletedTime = (*time.Time)(aux.DeletedTime)
	f.LastModifiedTime = (*time.Time)(aux.LastModifiedTime)
	return nil
}
...
type GeoReplicationStats struct {
	...
	// operational. - Bootstrap: Indicates initial synchronization from the primary location to the secondary location is in progress.This
	// typically occurs when replication is first enabled. - Unavailable: Indicates that the secondary location is temporarily
	// unavailable.
...
func (g GeoReplicationStats) MarshalJSON() ([]byte, error) {
	...
	aux := &struct {
		*alias
		LastSyncTime *timeRFC3339 `json:"lastSyncTime"`
	}{
		alias:        (*alias)(&g),
		LastSyncTime: (*timeRFC3339)(g.LastSyncTime),
	}
	return json.Marshal(aux)
}
...
func (k KeyVaultProperties) MarshalJSON() ([]byte, error) {
	...
	aux := &struct {
		*alias
		LastKeyRotationTimestamp *timeRFC3339 `json:"lastKeyRotationTimestamp"`
	}{
		alias:                    (*alias)(&k),
		LastKeyRotationTimestamp: (*timeRFC3339)(k.LastKeyRotationTimestamp),
	}
	return json.Marshal(aux)
}
...
func (k *KeyVaultProperties) UnmarshalJSON(data []byte) error {
	...
	k.LastKeyRotationTimestamp = (*time.Time)(aux.LastKeyRotationTimestamp)
	return nil
}
...
func (m ManagementPolicyProperties) MarshalJSON() ([]byte, error) {
	...
	aux := &struct {
		*alias
		...
		alias:            (*alias)(&m),
		LastModifiedTime: (*timeRFC3339)(m.LastModifiedTime),
	}
	return json.Marshal(aux)
}
...
func (m *ManagementPolicyProperties) UnmarshalJSON(data []byte) error {
	...
	m.LastModifiedTime = (*time.Time)(aux.LastModifiedTime)
	return nil
}
...
// Filters limit replication to a subset of blobs within the storage account. A logical OR is performed on values in the filter.
...
func (o ObjectReplicationPolicyProperties) MarshalJSON() ([]byte, error) {
	...
	aux := &struct {
		*alias
		EnabledTime *timeRFC3339 `json:"enabledTime"`
	}{
		alias:       (*alias)(&o),
		EnabledTime: (*timeRFC3339)(o.EnabledTime),
	}
	return json.Marshal(aux)
}
...
func (o *ObjectReplicationPolicyProperties) UnmarshalJSON(data []byte) error {
	...
	o.EnabledTime = (*time.Time)(aux.EnabledTime)
	return nil
}
...
func (r RestorePolicyProperties) MarshalJSON() ([]byte, error) {
	...
	aux := &struct {
		*alias
		...
		alias:           (*alias)(&r),
		LastEnabledTime: (*timeRFC3339)(r.LastEnabledTime),
	}
	return json.Marshal(aux)
}
...
func (r *RestorePolicyProperties) UnmarshalJSON(data []byte) error {
	...
	r.LastEnabledTime = (*time.Time)(aux.LastEnabledTime)
	return nil
}
...
func (s ServiceSasParameters) MarshalJSON() ([]byte, error) {
	...
	aux := &struct {
		*alias
		...
		alias:                  (*alias)(&s),
		SharedAccessExpiryTime: (*timeRFC3339)(s.SharedAccessExpiryTime),
		SharedAccessStartTime:  (*timeRFC3339)(s.SharedAccessStartTime),
	}
	return json.Marshal(aux)
}
...
func (s *ServiceSasParameters) UnmarshalJSON(data []byte) error {
	...
	s.SharedAccessExpiryTime = (*time.Time)(aux.SharedAccessExpiryTime)
	s.SharedAccessStartTime = (*time.Time)(aux.SharedAccessStartTime)
	return nil
}
...
type StorageAccountCreateParameters struct {
	...
	// (e.g. West US, East US, Southeast Asia, etc.). The geo region of a resource cannot be changed once it is created, but if
...
// StorageAccountListKeysResultResponse is the response envelope for operations that return a StorageAccountListKeysResult
// type.
...
func (s StorageAccountProperties) MarshalJSON() ([]byte, error) {
	...
	aux := &struct {
		*alias
		CreationTime        *timeRFC3339 `json:"creationTime"`
		LastGeoFailoverTime *timeRFC3339 `json:"lastGeoFailoverTime"`
	}{
		alias:               (*alias)(&s),
		CreationTime:        (*timeRFC3339)(s.CreationTime),
		LastGeoFailoverTime: (*timeRFC3339)(s.LastGeoFailoverTime),
	}
	return json.Marshal(aux)
}
...
func (s *StorageAccountProperties) UnmarshalJSON(data []byte) error {
	...
	s.LastGeoFailoverTime = (*time.Time)(aux.LastGeoFailoverTime)
	return nil
}
...
func (t TagProperty) MarshalJSON() ([]byte, error) {
	...
	aux := &struct {
		*alias
		...
		alias:     (*alias)(&t),
		Timestamp: (*timeRFC3339)(t.Timestamp),
	}
	return json.Marshal(aux)
}
...
func (t *TagProperty) UnmarshalJSON(data []byte) error {
	...
	t.Timestamp = (*time.Time)(aux.Timestamp)
	return nil
}
...
func (u UpdateHistoryProperty) MarshalJSON() ([]byte, error) {
	...
	aux := &struct {
		*alias
		...
		alias:     (*alias)(&u),
		Timestamp: (*timeRFC3339)(u.Timestamp),
	}
	return json.Marshal(aux)
}
...
func (u *UpdateHistoryProperty) UnmarshalJSON(data []byte) error {
	...
	u.Timestamp = (*time.Time)(aux.Timestamp)
	return nil
}
