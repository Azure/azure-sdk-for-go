...
func NewFileServicesClient(c *Client, subscriptionID string) FileServicesOperations {
	return &FileServicesClient{Client: c, subscriptionID: subscriptionID}
}

// Do invokes the Do() method on the pipeline associated with this client.
func (client *FileServicesClient) Do(req *azcore.Request) (*azcore.Response, error) {
