...
func NewManagementPoliciesClient(c *Client, subscriptionID string) ManagementPoliciesOperations {
	return &ManagementPoliciesClient{Client: c, subscriptionID: subscriptionID}
}

// Do invokes the Do() method on the pipeline associated with this client.
func (client *ManagementPoliciesClient) Do(req *azcore.Request) (*azcore.Response, error) {
