...
func NewObjectReplicationPoliciesClient(c *Client, subscriptionID string) ObjectReplicationPoliciesOperations {
	return &ObjectReplicationPoliciesClient{Client: c, subscriptionID: subscriptionID}
}

// Do invokes the Do() method on the pipeline associated with this client.
func (client *ObjectReplicationPoliciesClient) Do(req *azcore.Request) (*azcore.Response, error) {
