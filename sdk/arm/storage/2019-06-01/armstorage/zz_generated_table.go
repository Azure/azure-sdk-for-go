...
func NewTableClient(c *Client, subscriptionID string) TableOperations {
	return &TableClient{Client: c, subscriptionID: subscriptionID}
}

// Do invokes the Do() method on the pipeline associated with this client.
func (client *TableClient) Do(req *azcore.Request) (*azcore.Response, error) {
