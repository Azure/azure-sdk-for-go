...
func NewConnectionClient(con *arm.Connection, subscriptionID string) *ConnectionClient {
	return &ConnectionClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
