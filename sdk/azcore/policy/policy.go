...
// ClientRequestOptions configures the x-ms-client-id header sent with each request
type ClientRequestOptions struct {
	// If set, RequestId will be the id set on each outgoing request
	RequestId     string
	// If set, the x-ms-client-id will be autogenerated for each request
	AutoRequestId bool
}
