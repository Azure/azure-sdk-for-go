...
func unmarshalDeliveryRuleActionTypeClassification(rawMsg json.RawMessage) (DeliveryRuleActionTypeClassification, error) {
	if rawMsg == nil {
		return nil, nil
	}
	var m map[string]interface{}
	...
	var b DeliveryRuleActionTypeClassification
	switch m["name"] {
	...
	case string(DeliveryRuleActionURLSigning):
		b = &URLSigningAction{}
	default:
		b = &DeliveryRuleActionType{}
	}
	return b, json.Unmarshal(rawMsg, b)
}

func unmarshalDeliveryRuleActionTypeClassificationArray(rawMsg json.RawMessage) ([]DeliveryRuleActionTypeClassification, error) {
	if rawMsg == nil {
		return nil, nil
	}
	var rawMessages []json.RawMessage
	...
	fArray := make([]DeliveryRuleActionTypeClassification, len(rawMessages))
	for index, rawMessage := range rawMessages {
		f, err := unmarshalDeliveryRuleActionTypeClassification(rawMessage)
		if err != nil {
			return nil, err
		}
		fArray[index] = f
