...
func blobDigest(t *testing.T, image, imageDigest string) string {
	...
	require.NoError(t, err)
	// digest of the first blob i.e. layer in the manifest
...
func TestBlobClient(t *testing.T) {
	...
	t.Run("CheckBlobExists_empty", func(t *testing.T) {
		t.Parallel()
		startRecording(t)
		ctx := context.Background()
	...
	t.Run("GetBlob_empty", func(t *testing.T) {
		t.Parallel()
		ctx := context.Background()
		client, err := NewBlobClient("endpoint", nil, nil)
		require.NoError(t, err)
	...
	t.Run("GetChunk_empty", func(t *testing.T) {
		t.Parallel()
		ctx := context.Background()
		client, err := NewBlobClient("endpoint", nil, nil)
		require.NoError(t, err)
...
func TestBlobClient_DeleteBlob(t *testing.T) {
	t.Parallel()
	repository, imgDigest := pushImage(t)
