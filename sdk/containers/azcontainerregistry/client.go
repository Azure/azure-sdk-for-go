...
func (client *Client) deleteManifestCreateRequest(ctx context.Context, name string, digest string, _ *ClientDeleteManifestOptions) (*policy.Request, error) {
...
func (client *Client) deleteRepositoryCreateRequest(ctx context.Context, name string, _ *ClientDeleteRepositoryOptions) (*policy.Request, error) {
	urlPath := "/acr/v1/{name}"
	if name == "" {
		return nil, errors.New("parameter name cannot be empty")
	}
...
func (client *Client) deleteTagCreateRequest(ctx context.Context, name string, tag string, _ *ClientDeleteTagOptions) (*policy.Request, error) {
...
func (client *Client) getManifestPropertiesCreateRequest(ctx context.Context, name string, digest string, _ *ClientGetManifestPropertiesOptions) (*policy.Request, error) {
...
func (client *Client) getRepositoryPropertiesCreateRequest(ctx context.Context, name string, _ *ClientGetRepositoryPropertiesOptions) (*policy.Request, error) {
	urlPath := "/acr/v1/{name}"
	if name == "" {
		return nil, errors.New("parameter name cannot be empty")
	}
...
func (client *Client) getTagPropertiesCreateRequest(ctx context.Context, name string, tag string, _ *ClientGetTagPropertiesOptions) (*policy.Request, error) {
	urlPath := "/acr/v1/{name}/_tags/{reference}"
	if name == "" {
		return nil, errors.New("parameter name cannot be empty")
	}
...
func (client *Client) uploadManifestCreateRequest(ctx context.Context, name string, reference string, contentType ContentType, manifestData io.ReadSeekCloser, _ *ClientUploadManifestOptions) (*policy.Request, error) {
	urlPath := "/v2/{name}/manifests/{reference}"
	if name == "" {
		return nil, errors.New("parameter name cannot be empty")
	}
