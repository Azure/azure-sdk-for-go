...
func TestClient_DeleteManifest(t *testing.T) {
	...
	require.Error(t, err)
	// _, err = client.DeleteManifest(ctx, repository, "wrong-digest", nil)
	// require.Error(t, err)
...
func TestClient_Update(t *testing.T) {
	...
	t.Run("UpdateManifestProperties", func(t *testing.T) {
		...
		res, err = client.UpdateManifestProperties(ctx, repository, digest, &ClientUpdateManifestPropertiesOptions{
			Value: &ManifestWriteableProperties{
