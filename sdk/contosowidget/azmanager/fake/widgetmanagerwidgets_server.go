...
type WidgetManagerWidgetsServer struct {
	...
	BeginCreateOrUpdateWidget func(ctx context.Context, apiVersion string, widgetName string, resource azmanager.WidgetSuite, options *azmanager.BeginCreateOrUpdateWidgetOptions) (resp azfake.PollerResponder[azmanager.CreateOrUpdateWidgetResponse], errResp azfake.ErrorResponder)

	// BeginDeleteWidget is the fake for method WidgetManagerWidgetsClient.BeginDeleteWidget
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginDeleteWidget func(ctx context.Context, apiVersion string, widgetName string, options *azmanager.BeginDeleteWidgetOptions) (resp azfake.PollerResponder[azmanager.DeleteWidgetResponse], errResp azfake.ErrorResponder)

	// GetWidget is the fake for method WidgetManagerWidgetsClient.GetWidget
	// HTTP status codes to indicate success: http.StatusOK
	GetWidget func(ctx context.Context, apiVersion string, widgetName string, options *azmanager.GetWidgetOptions) (resp azfake.Responder[azmanager.GetWidgetResponse], errResp azfake.ErrorResponder)

	// GetWidgetOperationStatus is the fake for method WidgetManagerWidgetsClient.GetWidgetOperationStatus
	// HTTP status codes to indicate success: http.StatusOK
	GetWidgetOperationStatus func(ctx context.Context, apiVersion string, widgetName string, operationID string, options *azmanager.GetWidgetOperationStatusOptions) (resp azfake.Responder[azmanager.GetWidgetOperationStatusResponse], errResp azfake.ErrorResponder)

	// NewListWidgetsPager is the fake for method WidgetManagerWidgetsClient.NewListWidgetsPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListWidgetsPager func(apiVersion string, options *azmanager.ListWidgetsOptions) (resp azfake.PagerResponder[azmanager.ListWidgetsResponse])
}
...
func (w *WidgetManagerWidgetsServerTransport) dispatchBeginCreateOrUpdateWidget(req *http.Request) (*http.Response, error) {
	...
	if beginCreateOrUpdateWidget == nil {
		...
		respr, errRespr := w.srv.BeginCreateOrUpdateWidget(req.Context(), apiVersionParam, widgetNameParam, body, nil)
...
func (w *WidgetManagerWidgetsServerTransport) dispatchBeginDeleteWidget(req *http.Request) (*http.Response, error) {
	...
	if beginDeleteWidget == nil {
		...
		respr, errRespr := w.srv.BeginDeleteWidget(req.Context(), apiVersionParam, widgetNameParam, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
...
func (w *WidgetManagerWidgetsServerTransport) dispatchGetWidget(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := w.srv.GetWidget(req.Context(), apiVersionParam, widgetNameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
...
func (w *WidgetManagerWidgetsServerTransport) dispatchGetWidgetOperationStatus(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := w.srv.GetWidgetOperationStatus(req.Context(), apiVersionParam, widgetNameParam, operationIDParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (w *WidgetManagerWidgetsServerTransport) dispatchNewListWidgetsPager(req *http.Request) (*http.Response, error) {
	...
	if newListWidgetsPager == nil {
		...
		resp := w.srv.NewListWidgetsPager(apiVersionParam, nil)
