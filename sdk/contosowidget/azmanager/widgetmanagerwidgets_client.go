...
//     method.
func (client *WidgetManagerWidgetsClient) BeginCreateOrUpdateWidget(ctx context.Context, apiVersion string, widgetName string, resource WidgetSuite, options *BeginCreateOrUpdateWidgetOptions) (*runtime.Poller[CreateOrUpdateWidgetResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.createOrUpdateWidget(ctx, apiVersion, widgetName, resource, options)
		if err != nil {
			return nil, err
		}
...
// If the operation fails it returns an *azcore.ResponseError type.
func (client *WidgetManagerWidgetsClient) createOrUpdateWidget(ctx context.Context, apiVersion string, widgetName string, resource WidgetSuite, options *BeginCreateOrUpdateWidgetOptions) (*http.Response, error) {
	var err error
	const operationName = "WidgetManagerWidgetsClient.BeginCreateOrUpdateWidget"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.createOrUpdateWidgetCreateRequest(ctx, apiVersion, widgetName, resource, options)
	if err != nil {
		return nil, err
	}
...
func (client *WidgetManagerWidgetsClient) createOrUpdateWidgetCreateRequest(ctx context.Context, apiVersion string, widgetName string, resource WidgetSuite, _ *BeginCreateOrUpdateWidgetOptions) (*policy.Request, error) {
...
//     method.
func (client *WidgetManagerWidgetsClient) BeginDeleteWidget(ctx context.Context, apiVersion string, widgetName string, options *BeginDeleteWidgetOptions) (*runtime.Poller[DeleteWidgetResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.deleteWidget(ctx, apiVersion, widgetName, options)
		if err != nil {
			return nil, err
		}
...
// If the operation fails it returns an *azcore.ResponseError type.
func (client *WidgetManagerWidgetsClient) deleteWidget(ctx context.Context, apiVersion string, widgetName string, options *BeginDeleteWidgetOptions) (*http.Response, error) {
	var err error
	const operationName = "WidgetManagerWidgetsClient.BeginDeleteWidget"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.deleteWidgetCreateRequest(ctx, apiVersion, widgetName, options)
	if err != nil {
		return nil, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
...
func (client *WidgetManagerWidgetsClient) deleteWidgetCreateRequest(ctx context.Context, apiVersion string, widgetName string, _ *BeginDeleteWidgetOptions) (*policy.Request, error) {
	urlPath := "/widgets/{widgetName}"
	if widgetName == "" {
		return nil, errors.New("parameter widgetName cannot be empty")
	}
...
func (client *WidgetManagerWidgetsClient) GetWidget(ctx context.Context, apiVersion string, widgetName string, options *GetWidgetOptions) (GetWidgetResponse, error) {
	var err error
	const operationName = "WidgetManagerWidgetsClient.GetWidget"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.getWidgetCreateRequest(ctx, apiVersion, widgetName, options)
	if err != nil {
...
func (client *WidgetManagerWidgetsClient) getWidgetCreateRequest(ctx context.Context, apiVersion string, widgetName string, _ *GetWidgetOptions) (*policy.Request, error) {
	urlPath := "/widgets/{widgetName}"
	if widgetName == "" {
		return nil, errors.New("parameter widgetName cannot be empty")
	}
...
//     method.
func (client *WidgetManagerWidgetsClient) GetWidgetOperationStatus(ctx context.Context, apiVersion string, widgetName string, operationID string, options *GetWidgetOperationStatusOptions) (GetWidgetOperationStatusResponse, error) {
	var err error
	const operationName = "WidgetManagerWidgetsClient.GetWidgetOperationStatus"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.getWidgetOperationStatusCreateRequest(ctx, apiVersion, widgetName, operationID, options)
	if err != nil {
...
func (client *WidgetManagerWidgetsClient) getWidgetOperationStatusCreateRequest(ctx context.Context, apiVersion string, widgetName string, operationID string, _ *GetWidgetOperationStatusOptions) (*policy.Request, error) {
...
func (client *WidgetManagerWidgetsClient) NewListWidgetsPager(apiVersion string, options *ListWidgetsOptions) *runtime.Pager[ListWidgetsResponse] {
	return runtime.NewPager(runtime.PagingHandler[ListWidgetsResponse]{
		...
		Fetcher: func(ctx context.Context, page *ListWidgetsResponse) (ListWidgetsResponse, error) {
			...
			resp, err := runtime.FetcherForNextLink(ctx, client.internal.Pipeline(), nextLink, func(ctx context.Context) (*policy.Request, error) {
				return client.listWidgetsCreateRequest(ctx, apiVersion, options)
			}, nil)
			if err != nil {
...
func (client *WidgetManagerWidgetsClient) listWidgetsCreateRequest(ctx context.Context, apiVersion string, _ *ListWidgetsOptions) (*policy.Request, error) {
	urlPath := "/widgets"
	req, err := runtime.NewRequest(ctx, http.MethodGet, runtime.JoinPaths(client.endpoint, urlPath))
	if err != nil {
		return nil, err
