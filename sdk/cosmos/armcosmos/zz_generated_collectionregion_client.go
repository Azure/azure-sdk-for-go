...
func NewCollectionRegionClient(con *armcore.Connection, subscriptionID string) *CollectionRegionClient {
	return &CollectionRegionClient{con: con, subscriptionID: subscriptionID}
}
...
func (client *CollectionRegionClient) listMetricsCreateRequest(ctx context.Context, resourceGroupName string, accountName string, region string, databaseRid string, collectionRid string, filter string, options *CollectionRegionListMetricsOptions) (*azcore.Request, error) {
...
func (client *CollectionRegionClient) listMetricsHandleResponse(resp *azcore.Response) (CollectionRegionListMetricsResponse, error) {
	result := CollectionRegionListMetricsResponse{RawResponse: resp.Response}
...
func (client *CollectionRegionClient) listMetricsHandleError(resp *azcore.Response) error {
