...
func TestClient(t *testing.T) {
	...
	etag := getResp.ETag
	getResp2, err4 := client.GetSetting(context.TODO(), key, &GetSettingOptions{Label: &label, OnlyIfChanged: true, ETag: etag})
	...
	getResp3, err6 := client.GetSetting(context.TODO(), key, &GetSettingOptions{Label: &label, OnlyIfChanged: true, ETag: etag})
	...
	roResp, err7 := client.SetReadOnly(context.TODO(), key, true, &SetReadOnlyOptions{Label: &label})
	...
	roResp2, err8 := client.SetReadOnly(context.TODO(), key, false, &SetReadOnlyOptions{Label: &label})
	...
	revResp, err9 := revPgr.NextPage(context.TODO())
	...
	settsResp, err10 := settsPgr.NextPage(context.TODO())
	...
	delResp, err11 := client.DeleteSetting(context.TODO(), key, &DeleteSettingOptions{Label: &label})
