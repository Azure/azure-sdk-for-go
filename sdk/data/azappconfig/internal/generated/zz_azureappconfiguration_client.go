...
//     method.
func (client *AzureAppConfigurationClient) BeginCreateSnapshot(ctx context.Context, contentType CreateSnapshotRequestContentType, name string, entity Snapshot, options *AzureAppConfigurationClientBeginCreateSnapshotOptions) (*runtime.Poller[AzureAppConfigurationClientCreateSnapshotResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.createSnapshot(ctx, contentType, name, entity, options)
		if err != nil {
			return nil, err
		}
...
// Creates a key-value snapshot.
// If the operation fails it returns an *azcore.ResponseError type.
func (client *AzureAppConfigurationClient) createSnapshot(ctx context.Context, contentType CreateSnapshotRequestContentType, name string, entity Snapshot, options *AzureAppConfigurationClientBeginCreateSnapshotOptions) (*http.Response, error) {
	var err error
	req, err := client.createSnapshotCreateRequest(ctx, contentType, name, entity, options)
	if err != nil {
		return nil, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
...
func (client *AzureAppConfigurationClient) createSnapshotCreateRequest(ctx context.Context, contentType CreateSnapshotRequestContentType, name string, entity Snapshot, options *AzureAppConfigurationClientBeginCreateSnapshotOptions) (*policy.Request, error) {
	urlPath := "/snapshots/{name}"
	if name == "" {
		return nil, errors.New("parameter name cannot be empty")
	}
...
func (client *AzureAppConfigurationClient) deleteKeyValueHandleResponse(resp *http.Response) (AzureAppConfigurationClientDeleteKeyValueResponse, error) {
	...
	if val := resp.Header.Get("Content-Type"); val != "" {
		result.ContentType = (*GetKeyValueResponseContentType)(&val)
	}
	if val := resp.Header.Get("ETag"); val != "" {
		result.ETag = &val
	}
...
func (client *AzureAppConfigurationClient) getKeyValuesHandleResponse(resp *http.Response) (AzureAppConfigurationClientGetKeyValuesResponse, error) {
	...
	if val := resp.Header.Get("Content-Type"); val != "" {
		result.ContentType = (*GetKeyValuesResponseContentType)(&val)
	}
	if val := resp.Header.Get("ETag"); val != "" {
		result.ETag = &val
	}
...
func (client *AzureAppConfigurationClient) getKeysHandleResponse(resp *http.Response) (AzureAppConfigurationClientGetKeysResponse, error) {
	...
	if val := resp.Header.Get("Content-Type"); val != "" {
		result.ContentType = (*GetKeysResponseContentType)(&val)
	}
	if val := resp.Header.Get("Sync-Token"); val != "" {
		result.SyncToken = &val
	}
...
func (client *AzureAppConfigurationClient) getLabelsHandleResponse(resp *http.Response) (AzureAppConfigurationClientGetLabelsResponse, error) {
	...
	if val := resp.Header.Get("Content-Type"); val != "" {
		result.ContentType = (*GetLabelsResponseContentType)(&val)
	}
	if val := resp.Header.Get("Sync-Token"); val != "" {
		result.SyncToken = &val
	}
...
func (client *AzureAppConfigurationClient) getSnapshotHandleResponse(resp *http.Response) (AzureAppConfigurationClientGetSnapshotResponse, error) {
	...
	if val := resp.Header.Get("Content-Type"); val != "" {
		result.ContentType = (*GetSnapshotResponseContentType)(&val)
	}
	if val := resp.Header.Get("ETag"); val != "" {
		result.ETag = &val
	}
...
func (client *AzureAppConfigurationClient) getSnapshotsHandleResponse(resp *http.Response) (AzureAppConfigurationClientGetSnapshotsResponse, error) {
	...
	if val := resp.Header.Get("Content-Type"); val != "" {
		result.ContentType = (*GetSnapshotsResponseContentType)(&val)
	}
	if val := resp.Header.Get("Sync-Token"); val != "" {
		result.SyncToken = &val
	}
...
//     method.
func (client *AzureAppConfigurationClient) PutKeyValue(ctx context.Context, contentType PutKeyValueRequestContentType, key string, entity KeyValue, options *AzureAppConfigurationClientPutKeyValueOptions) (AzureAppConfigurationClientPutKeyValueResponse, error) {
	var err error
	req, err := client.putKeyValueCreateRequest(ctx, contentType, key, entity, options)
	if err != nil {
...
func (client *AzureAppConfigurationClient) putKeyValueCreateRequest(ctx context.Context, contentType PutKeyValueRequestContentType, key string, entity KeyValue, options *AzureAppConfigurationClientPutKeyValueOptions) (*policy.Request, error) {
	urlPath := "/kv/{key}"
	if key == "" {
		return nil, errors.New("parameter key cannot be empty")
	}
...
//     method.
func (client *AzureAppConfigurationClient) UpdateSnapshot(ctx context.Context, contentType UpdateSnapshotRequestContentType, name string, entity SnapshotUpdateParameters, options *AzureAppConfigurationClientUpdateSnapshotOptions) (AzureAppConfigurationClientUpdateSnapshotResponse, error) {
	var err error
	req, err := client.updateSnapshotCreateRequest(ctx, contentType, name, entity, options)
	if err != nil {
...
func (client *AzureAppConfigurationClient) updateSnapshotCreateRequest(ctx context.Context, contentType UpdateSnapshotRequestContentType, name string, entity SnapshotUpdateParameters, options *AzureAppConfigurationClientUpdateSnapshotOptions) (*policy.Request, error) {
	urlPath := "/snapshots/{name}"
	if name == "" {
		return nil, errors.New("parameter name cannot be empty")
	}
