...
// and response model but no operations. Operations arrive in subsequent releases and will
// initially return an error reporting that they are not implemented.
//
