...
func TestItemCRUD(t *testing.T) {
	for _, integrationTests.accountType := range accountTypes {
		...
		database := integrationTests.createDatabase(t, context.TODO(), client, "itemCRUD")
...
func TestItemCRUDHierarchicalPartitionKey(t *testing.T) {
	for _, integrationTests.accountType := range accountTypes {
		...
		client := integrationTests.getClient(t, nil)
			...
			database := integrationTests.createDatabase(t, context.TODO(), client, "itemCRUDHierarchicalPartitionKey")
		defer integrationTests.deleteDatabase(t, context.TODO(), database)
		properties := ContainerProperties{
			ID: "aContainer",
			PartitionKeyDefinition: PartitionKeyDefinition{
