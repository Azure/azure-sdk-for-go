...
func NewDataFlowsClient(con *arm.Connection, subscriptionID string) *DataFlowsClient {
	return &DataFlowsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
