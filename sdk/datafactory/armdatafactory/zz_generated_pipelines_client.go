...
func NewPipelinesClient(con *arm.Connection, subscriptionID string) *PipelinesClient {
	return &PipelinesClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
