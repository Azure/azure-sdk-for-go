...
[![PkgGoDev](https://pkg.go.dev/badge/github.com/Azure/azure-sdk-for-go/sdk/datalake-store/armdatalakestore)](https://pkg.go.dev/github.com/Azure/azure-sdk-for-go/sdk/datalake-store/armdatalakestore)

The `armdatalakestore` module provides operations for working with Azure Data Lake Storage.

[Source code](https://github.com/Azure/azure-sdk-for-go/tree/main/sdk/datalake-store/armdatalakestore)
...
```sh
go get github.com/Azure/azure-sdk-for-go/sdk/datalake-store/armdatalakestore
```
...
```go
client := armdatalakestore.NewAccountsClient(con, "<subscription ID>")
```
