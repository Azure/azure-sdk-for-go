...
func (d DataLakeStoreAccountProperties) MarshalJSON() ([]byte, error) {
	objectMap := d.DataLakeStoreAccountPropertiesBasic.marshalInternal()
...
func (d *DataLakeStoreAccountProperties) UnmarshalJSON(data []byte) error {
	...
	return d.DataLakeStoreAccountPropertiesBasic.unmarshalInternal(rawMsg)
}
...
func (d DataLakeStoreAccountPropertiesBasic) marshalInternal() map[string]interface{} {
	objectMap := make(map[string]interface{})
