...
func NewTrustedIDProvidersClient(con *connection, subscriptionID string) *TrustedIDProvidersClient {
	return &TrustedIDProvidersClient{con: con, subscriptionID: subscriptionID}
}
