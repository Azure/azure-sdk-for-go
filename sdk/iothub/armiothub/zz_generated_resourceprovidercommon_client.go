...
func NewResourceProviderCommonClient(con *connection, subscriptionID string) *ResourceProviderCommonClient {
	return &ResourceProviderCommonClient{con: con, subscriptionID: subscriptionID}
}
