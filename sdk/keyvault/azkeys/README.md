...
### List keys
[`NewListPropertiesOfKeysPager`](https://aka.ms/azsdk/go/keyvault-keys/docs#Client.ListKeys) creates a pager that lists the properties of all of the keys in the client's vault.
