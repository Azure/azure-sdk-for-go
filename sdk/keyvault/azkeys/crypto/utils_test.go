...
func createKeyClient(t *testing.T, testType string) (*azkeys.Client, error) {
...
func importTestKey(t *testing.T, client *azkeys.Client, name string, hsm bool) (azkeys.ImportKeyResponse, error) {
	options := azkeys.ImportKeyOptions{
		Hsm: &hsm,
	}
	...
	return client.ImportKey(ctx, name, jwk, &options)
}
