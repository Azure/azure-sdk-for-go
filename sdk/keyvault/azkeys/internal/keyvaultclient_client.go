...
// Export - The export key operation is applicable to all key types. The target key must be marked exportable. This operation requires the keys/export permission.
// If the operation fails it returns the *KeyVaultError error type.
func (client *KeyVaultClient) Export(ctx context.Context, vaultBaseURL string, keyName string, keyVersion string, parameters KeyExportParameters, options *KeyVaultClientExportOptions) (KeyVaultClientExportResponse, error) {
	...
	if !runtime.HasStatusCode(resp, http.StatusOK) {
		return KeyVaultClientExportResponse{}, client.exportHandleError(resp)
	}
...
func (client *KeyVaultClient) exportHandleError(resp *http.Response) error {
	body, err := runtime.Payload(resp)
	if err != nil {
		return runtime.NewResponseError(err, resp)
	}
...
// Release - The release key operation is applicable to all key types. The target key must be marked exportable. This operation requires the keys/release
// permission.
// If the operation fails it returns the *KeyVaultError error type.
func (client *KeyVaultClient) Release(ctx context.Context, vaultBaseURL string, keyName string, keyVersion string, parameters KeyReleaseParameters, options *KeyVaultClientReleaseOptions) (KeyVaultClientReleaseResponse, error) {
	...
	if !runtime.HasStatusCode(resp, http.StatusOK) {
		return KeyVaultClientReleaseResponse{}, client.releaseHandleError(resp)
	}
...
// releaseHandleError handles the Release error response.
func (client *KeyVaultClient) releaseHandleError(resp *http.Response) error {
	body, err := runtime.Payload(resp)
	if err != nil {
		return runtime.NewResponseError(err, resp)
	}
