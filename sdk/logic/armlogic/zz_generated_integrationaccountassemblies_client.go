...
func NewIntegrationAccountAssembliesClient(con *armcore.Connection, subscriptionID string) *IntegrationAccountAssembliesClient {
	return &IntegrationAccountAssembliesClient{con: con, subscriptionID: subscriptionID}
}
...
func (client *IntegrationAccountAssembliesClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, integrationAccountName string, assemblyArtifactName string, assemblyArtifact AssemblyDefinition, options *IntegrationAccountAssembliesCreateOrUpdateOptions) (*azcore.Request, error) {
	...
	return req, req.MarshalAsJSON(assemblyArtifact)
}

// createOrUpdateHandleResponse handles the CreateOrUpdate response.
func (client *IntegrationAccountAssembliesClient) createOrUpdateHandleResponse(resp *azcore.Response) (IntegrationAccountAssembliesCreateOrUpdateResponse, error) {
	result := IntegrationAccountAssembliesCreateOrUpdateResponse{RawResponse: resp.Response}
	if err := resp.UnmarshalAsJSON(&result.AssemblyDefinition); err != nil {
		return IntegrationAccountAssembliesCreateOrUpdateResponse{}, err
	}
	return result, nil
}
...
func (client *IntegrationAccountAssembliesClient) createOrUpdateHandleError(resp *azcore.Response) error {
...
func (client *IntegrationAccountAssembliesClient) Delete(ctx context.Context, resourceGroupName string, integrationAccountName string, assemblyArtifactName string, options *IntegrationAccountAssembliesDeleteOptions) (IntegrationAccountAssembliesDeleteResponse, error) {
	...
	return IntegrationAccountAssembliesDeleteResponse{RawResponse: resp.Response}, nil
}

// deleteCreateRequest creates the Delete request.
func (client *IntegrationAccountAssembliesClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, integrationAccountName string, assemblyArtifactName string, options *IntegrationAccountAssembliesDeleteOptions) (*azcore.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Logic/integrationAccounts/{integrationAccountName}/assemblies/{assemblyArtifactName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *IntegrationAccountAssembliesClient) deleteHandleError(resp *azcore.Response) error {
	body, err := resp.Payload()
	if err != nil {
		return azcore.NewResponseError(err, resp.Response)
	}
...
func (client *IntegrationAccountAssembliesClient) getCreateRequest(ctx context.Context, resourceGroupName string, integrationAccountName string, assemblyArtifactName string, options *IntegrationAccountAssembliesGetOptions) (*azcore.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Logic/integrationAccounts/{integrationAccountName}/assemblies/{assemblyArtifactName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *IntegrationAccountAssembliesClient) getHandleResponse(resp *azcore.Response) (IntegrationAccountAssembliesGetResponse, error) {
	result := IntegrationAccountAssembliesGetResponse{RawResponse: resp.Response}
	if err := resp.UnmarshalAsJSON(&result.AssemblyDefinition); err != nil {
		return IntegrationAccountAssembliesGetResponse{}, err
	}
	return result, nil
...
func (client *IntegrationAccountAssembliesClient) getHandleError(resp *azcore.Response) error {
	body, err := resp.Payload()
	if err != nil {
		return azcore.NewResponseError(err, resp.Response)
	}
...
func (client *IntegrationAccountAssembliesClient) listCreateRequest(ctx context.Context, resourceGroupName string, integrationAccountName string, options *IntegrationAccountAssembliesListOptions) (*azcore.Request, error) {
...
func (client *IntegrationAccountAssembliesClient) listHandleResponse(resp *azcore.Response) (IntegrationAccountAssembliesListResponse, error) {
	result := IntegrationAccountAssembliesListResponse{RawResponse: resp.Response}
	if err := resp.UnmarshalAsJSON(&result.AssemblyCollection); err != nil {
		return IntegrationAccountAssembliesListResponse{}, err
	}
	return result, nil
}
...
func (client *IntegrationAccountAssembliesClient) listHandleError(resp *azcore.Response) error {
	body, err := resp.Payload()
	if err != nil {
		return azcore.NewResponseError(err, resp.Response)
	}
...
func (client *IntegrationAccountAssembliesClient) listContentCallbackURLCreateRequest(ctx context.Context, resourceGroupName string, integrationAccountName string, assemblyArtifactName string, options *IntegrationAccountAssembliesListContentCallbackURLOptions) (*azcore.Request, error) {
...
func (client *IntegrationAccountAssembliesClient) listContentCallbackURLHandleResponse(resp *azcore.Response) (IntegrationAccountAssembliesListContentCallbackURLResponse, error) {
	result := IntegrationAccountAssembliesListContentCallbackURLResponse{RawResponse: resp.Response}
...
func (client *IntegrationAccountAssembliesClient) listContentCallbackURLHandleError(resp *azcore.Response) error {
	body, err := resp.Payload()
	if err != nil {
		return azcore.NewResponseError(err, resp.Response)
	}
