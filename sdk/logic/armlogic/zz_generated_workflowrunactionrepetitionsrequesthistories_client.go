...
func NewWorkflowRunActionRepetitionsRequestHistoriesClient(con *armcore.Connection, subscriptionID string) *WorkflowRunActionRepetitionsRequestHistoriesClient {
	return &WorkflowRunActionRepetitionsRequestHistoriesClient{con: con, subscriptionID: subscriptionID}
}
...
func (client *WorkflowRunActionRepetitionsRequestHistoriesClient) getCreateRequest(ctx context.Context, resourceGroupName string, workflowName string, runName string, actionName string, repetitionName string, requestHistoryName string, options *WorkflowRunActionRepetitionsRequestHistoriesGetOptions) (*azcore.Request, error) {
...
func (client *WorkflowRunActionRepetitionsRequestHistoriesClient) getHandleResponse(resp *azcore.Response) (WorkflowRunActionRepetitionsRequestHistoriesGetResponse, error) {
	result := WorkflowRunActionRepetitionsRequestHistoriesGetResponse{RawResponse: resp.Response}
...
func (client *WorkflowRunActionRepetitionsRequestHistoriesClient) getHandleError(resp *azcore.Response) error {
...
func (client *WorkflowRunActionRepetitionsRequestHistoriesClient) List(resourceGroupName string, workflowName string, runName string, actionName string, repetitionName string, options *WorkflowRunActionRepetitionsRequestHistoriesListOptions) WorkflowRunActionRepetitionsRequestHistoriesListPager {
	return &workflowRunActionRepetitionsRequestHistoriesListPager{
		...
		advancer: func(ctx context.Context, resp WorkflowRunActionRepetitionsRequestHistoriesListResponse) (*azcore.Request, error) {
...
func (client *WorkflowRunActionRepetitionsRequestHistoriesClient) listCreateRequest(ctx context.Context, resourceGroupName string, workflowName string, runName string, actionName string, repetitionName string, options *WorkflowRunActionRepetitionsRequestHistoriesListOptions) (*azcore.Request, error) {
...
func (client *WorkflowRunActionRepetitionsRequestHistoriesClient) listHandleResponse(resp *azcore.Response) (WorkflowRunActionRepetitionsRequestHistoriesListResponse, error) {
	result := WorkflowRunActionRepetitionsRequestHistoriesListResponse{RawResponse: resp.Response}
...
func (client *WorkflowRunActionRepetitionsRequestHistoriesClient) listHandleError(resp *azcore.Response) error {
	body, err := resp.Payload()
	if err != nil {
		return azcore.NewResponseError(err, resp.Response)
	}
