...
func TestParsesEventGridEnvelope(t *testing.T) {
	...
	require.Equal(t, string(systemevents.TypeSubscriptionValidation), *egEvent.EventType)
...
func TestConsumeEventGridSubscriptionDeletedEvent(t *testing.T) {
	...
	sysEvent := deserializeSystemEvent[systemevents.SubscriptionDeletedEventData](t, events[0].Data)
	require.Equal(t,
...
func TestConsumeStorageBlobDeletedEventWithExtraProperty(t *testing.T) {
	...
	for _, egEvent := range events {
		require.Equal(t, string(systemevents.TypeStorageBlobDeleted), *egEvent.EventType)
...
func TestConsumeEventNotWrappedInAnArray(t *testing.T) {
	...
	require.Equal(t, string(systemevents.TypeStorageBlobDeleted), *egEvent.EventType)
	sysEvent := deserializeSystemEvent[systemevents.StorageBlobDeletedEventData](t, egEvent.Data)
	require.Equal(t, "https://example.blob.core.windows.net/testcontainer/testfile.txt", *sysEvent.URL)
}
...
func TestConsumeMultipleEventsInSameBatch(t *testing.T) {
	...
	for _, egEvent := range events {
		switch systemevents.Type(*egEvent.EventType) {
		case systemevents.TypeStorageBlobCreated:
			blobCreated := deserializeSystemEvent[systemevents.StorageBlobCreatedEventData](t, egEvent.Data)
			require.Equal(t, "https://myaccount.blob.core.windows.net/testcontainer/file1.txt", *blobCreated.URL)
		case systemevents.TypeStorageBlobDeleted:
			blobDeleted := deserializeSystemEvent[systemevents.StorageBlobDeletedEventData](t, egEvent.Data)
...
func TestConsumeAppConfigurationKeyValueDeletedEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.AppConfigurationKeyValueDeletedEventData](t, events[0].Data)
...
func TestConsumeAppConfigurationKeyValueModifiedEvent(t *testing.T) {
	...
	sysEvent := deserializeSystemEvent[systemevents.AppConfigurationKeyValueModifiedEventData](t, events[0].Data)
	require.Equal(t, "key1", *sysEvent.Key)
}
...
func TestConsumeContainerRegistryImagePushedEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.ContainerRegistryImagePushedEventData](t, events[0].Data)
...
func TestConsumeContainerRegistryImageDeletedEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.ContainerRegistryImageDeletedEventData](t, events[0].Data)
...
func TestConsumeContainerRegistryChartDeletedEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.ContainerRegistryChartDeletedEventData](t, events[0].Data)
...
func TestConsumeContainerRegistryChartPushedEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.ContainerRegistryChartPushedEventData](t, events[0].Data)
	require.Equal(t, "mediatype1", *sysEvent.Target.MediaType)
}
...
func TestConsumeContainerServiceSupportEndedEvent(t *testing.T) {
	...
	sysEvent := deserializeSystemEvent[systemevents.ContainerServiceClusterSupportEventData](t, event.Data)
	require.Equal(t, "1.23.15", *sysEvent.KubernetesVersion)

	sysEvent2 := deserializeSystemEvent[systemevents.ContainerServiceClusterSupportEndedEventData](t, event.Data)
...
func TestConsumeContainerServiceSupportEndingEvent(t *testing.T) {
	...
	sysEvent2 := deserializeSystemEvent[systemevents.ContainerServiceClusterSupportEndingEventData](t, event.Data)
	require.Equal(t, "1.23.15", *sysEvent2.KubernetesVersion)
}
...
func TestConsumeContainerServiceNodePoolRollingFailed(t *testing.T) {
	...
	sysEvent := deserializeSystemEvent[systemevents.ContainerServiceNodePoolRollingEventData](t, event.Data)
	require.Equal(t, "nodepool1", *sysEvent.NodePoolName)

	sysEvent2 := deserializeSystemEvent[systemevents.ContainerServiceNodePoolRollingFailedEventData](t, event.Data)
...
func TestConsumeContainerServiceNodePoolRollingStarted(t *testing.T) {
	...
	sysEvent2 := deserializeSystemEvent[systemevents.ContainerServiceNodePoolRollingStartedEventData](t, event.Data)
	require.Equal(t, "nodepool1", *sysEvent2.NodePoolName)
}
...
func TestConsumeContainerServiceNodePoolRollingSucceeded(t *testing.T) {
	...
	sysEvent2 := deserializeSystemEvent[systemevents.ContainerServiceNodePoolRollingSucceededEventData](t, event.Data)
	require.Equal(t, "nodepool1", *sysEvent2.NodePoolName)
}
...
func TestConsumeIoTHubDeviceCreatedEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.IotHubDeviceCreatedEventData](t, events[0].Data)
...
func TestConsumeIoTHubDeviceDeletedEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.IotHubDeviceDeletedEventData](t, events[0].Data)
...
func TestConsumeIoTHubDeviceConnectedEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.IotHubDeviceConnectedEventData](t, events[0].Data)
...
func TestConsumeIoTHubDeviceDisconnectedEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.IotHubDeviceDisconnectedEventData](t, events[0].Data)
...
func TestConsumeIoTHubDeviceTelemetryEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.IotHubDeviceTelemetryEventData](t, events[0].Data)
...
func TestConsumeEventHubCaptureFileCreatedEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.EventHubCaptureFileCreatedEventData](t, events[0].Data)
...
func TestConsumeMachineLearningServicesModelDeployedEvent(t *testing.T) {
	...
	sysEvent2 := deserializeSystemEvent[systemevents.MachineLearningServicesModelDeployedEventData](t, events[0].Data)
...
func TestConsumeMachineLearningServicesRunCompletedEvent(t *testing.T) {
	...
	sysEvent2 := deserializeSystemEvent[systemevents.MachineLearningServicesRunCompletedEventData](t, events[0].Data)
...
func TestConsumeMediaJobOutputStateChangeEvent(t *testing.T) {
	...
	require.Equal(t, systemevents.MediaJobStateScheduled, *sysEvent.PreviousState)
	mediaOutputAsset := sysEvent.Output.(*systemevents.MediaJobOutputAsset)
	require.Equal(t, systemevents.MediaJobStateProcessing, *mediaOutputAsset.State)

	require.Equal(t, "output-2ac2fe75-6557-4de5-ab25-5713b74a6901", *mediaOutputAsset.AssetName)

	require.Equal(t, systemevents.MediaJobErrorCategoryService, *mediaOutputAsset.Error.Category)
	require.Equal(t, systemevents.MediaJobErrorCodeServiceError, *mediaOutputAsset.Error.Code)
}
...
func TestConsumeMediaJobOutputStateChangeEvent_UnknownError(t *testing.T) {
	...
	sysEvent := deserializeSystemEvent[systemevents.MediaJobOutputStateChangeEventData](t, events[0].Data)
	require.Equal(t, systemevents.MediaJobStateScheduled, *sysEvent.PreviousState)
	require.Equal(t, systemevents.MediaJobStateProcessing, *sysEvent.Output.(*systemevents.MediaJobOutputAsset).State)
	...
	require.Equal(t, systemevents.MediaJobErrorCategory("SomeNewCategory"), *outputAsset.Error.Category)
	require.Equal(t, systemevents.MediaJobErrorCode("SomeNewCode"), *outputAsset.Error.Code)
}
...
func TestConsumeMediaJobOutputCanceledEvent(t *testing.T) {
	...
	require.Equal(t, systemevents.MediaJobStateCanceling, *sysEvent.PreviousState)
	require.Equal(t, systemevents.MediaJobStateCanceled, *sysEvent.Output.(*systemevents.MediaJobOutputAsset).State)
}
...
func TestConsumeMediaJobOutputCancelingEvent(t *testing.T) {
	...
	sysEvent := deserializeSystemEvent[systemevents.MediaJobOutputCancelingEventData](t, events[0].Data)
	require.Equal(t, systemevents.MediaJobStateProcessing, *sysEvent.PreviousState)
	require.Equal(t, systemevents.MediaJobStateCanceling, *sysEvent.Output.(*systemevents.MediaJobOutputAsset).State)
}
...
func TestConsumeMediaJobOutputProcessingEvent(t *testing.T) {
	...
	outputAsset := sysEvent.Output.(*systemevents.MediaJobOutputAsset)
	require.Equal(t, systemevents.MediaJobStateProcessing, *outputAsset.State)
}
...
func TestConsumeMediaJobOutputScheduledEvent(t *testing.T) {
	...
	outputAsset := sysEvent.Output.(*systemevents.MediaJobOutputAsset)
	require.Equal(t, systemevents.MediaJobStateScheduled, *outputAsset.State)
}
...
func TestConsumeMediaLiveEventIngestHeartbeatEvent(t *testing.T) {
	...
	sysEvent2 := deserializeSystemEvent[systemevents.MediaLiveEventIngestHeartbeatEventData](t, events2[0].Data)
...
func TestConsumeMediaLiveEventChannelArchiveHeartbeatEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.MediaLiveEventChannelArchiveHeartbeatEventData](t, events[0].Data)
	...
	sysEvent2 := deserializeSystemEvent[systemevents.MediaLiveEventChannelArchiveHeartbeatEventData](t, events2[0].Data)
...
func TestConsumeResourceWriteSuccessEvent(t *testing.T) {
	...
	eventData := deserializeSystemEvent[systemevents.ResourceWriteSuccessEventData](t, events[0].Data)
...
func TestConsumeResourceWriteFailureEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	eventData := deserializeSystemEvent[systemevents.ResourceWriteFailureEventData](t, events[0].Data)
...
func TestConsumeResourceWriteCancelEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	eventData := deserializeSystemEvent[systemevents.ResourceWriteCancelEventData](t, events[0].Data)
...
func TestConsumeResourceDeleteSuccessEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	eventData := deserializeSystemEvent[systemevents.ResourceDeleteSuccessEventData](t, events[0].Data)
...
func TestConsumeResourceDeleteFailureEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	eventData := deserializeSystemEvent[systemevents.ResourceDeleteFailureEventData](t, events[0].Data)
...
func TestConsumeResourceDeleteCancelEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	eventData := deserializeSystemEvent[systemevents.ResourceDeleteCancelEventData](t, events[0].Data)
...
func TestConsumeResourceActionSuccessEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	eventData := deserializeSystemEvent[systemevents.ResourceActionSuccessEventData](t, events[0].Data)
...
func TestConsumeResourceActionFailureEvent(t *testing.T) {
	...
	events := parseManyEvents(t, requestContent)
	eventData := deserializeSystemEvent[systemevents.ResourceActionFailureEventData](t, events[0].Data)
	assertResourceEventData(t, eventData)
}
...
func TestConsumeResourceActionCancelEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	eventData := deserializeSystemEvent[systemevents.ResourceActionCancelEventData](t, events[0].Data)
...
func TestConsumeStorageTaskQueuedEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.StorageTaskQueuedEventData](t, events[0].Data)
...
func TestConsumeStorageTaskCompletedEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.StorageTaskCompletedEventData](t, events[0].Data)
	require.Equal(t, systemevents.StorageTaskCompletedStatusSucceeded, *sysEvent.Status)
...
func TestConsumeAcsEmailDeliveryReportReceivedEvent(t *testing.T) {
	...
	require.NotEmpty(t, event)
	emailEvent := deserializeSystemEvent[systemevents.AcsEmailDeliveryReportReceivedEventData](t, event.Data)
	require.Equal(t, "test2@contoso.org", *emailEvent.Sender)
	require.Equal(t, "test1@contoso.com", *emailEvent.Recipient)
	require.Equal(t, systemevents.AcsEmailDeliveryReportStatusDelivered, *emailEvent.Status)
...
func TestConsumeAcsIncomingCallEvent(t *testing.T) {
	...
	incomingCallEvent := deserializeSystemEvent[systemevents.AcsIncomingCallEventData](t, event.Data)
...
func TestConsumeFhirResourceCreatedEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	healthEvent := deserializeSystemEvent[systemevents.HealthcareFhirResourceCreatedEventData](t, events[0].Data)
	require.Equal(t, systemevents.HealthcareFhirResourceTypePatient, *healthEvent.FhirResourceType)
...
func TestConsumeFhirResourceUpdatedEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	healthEvent := deserializeSystemEvent[systemevents.HealthcareFhirResourceUpdatedEventData](t, events[0].Data)
...
func TestConsumeFhirResourceDeletedEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	healthEvent := deserializeSystemEvent[systemevents.HealthcareFhirResourceDeletedEventData](t, events[0].Data)
...
func TestConsumeDicomImageCreatedEvent(t *testing.T) {
	...
	healthEvent := deserializeSystemEvent[systemevents.HealthcareDicomImageCreatedEventData](t, event.Data)
...
func TestConsumeDicomImageUpdatedEvent(t *testing.T) {
	...
	require.NotEmpty(t, event)
	healthEvent := deserializeSystemEvent[systemevents.HealthcareDicomImageUpdatedEventData](t, event.Data)
...
func TestConsumeDicomImageDeletedEvent(t *testing.T) {
	...
	event := parseEvent(t, requestContent)
	healthEvent := deserializeSystemEvent[systemevents.HealthcareDicomImageDeletedEventData](t, event.Data)
...
func TestParsesCloudEventEnvelope(t *testing.T) {
	...
	require.Equal(t, string(systemevents.TypeStorageBlobDeleted), cloudEvent.Type)
...
func TestConsumeCloudEventsWithAdditionalProperties(t *testing.T) {
	...
	if events[0].Type == string(systemevents.TypeStorageBlobDeleted) {
		eventData := deserializeSystemEvent[systemevents.StorageBlobDeletedEventData](t, events[0].Data)
...
func TestConsumeCloudEventUsingBinaryDataExtensionMethod(t *testing.T) {
	...
	require.Equal(t, string(systemevents.TypeStorageBlobDeleted), cloudEvent.Type)
	blobDeleted := deserializeSystemEvent[systemevents.StorageBlobDeletedEventData](t, cloudEvent.Data)
	require.Equal(t, "https://example.blob.core.windows.net/testcontainer/testfile.txt", *blobDeleted.URL)
}
...
func TestConsumeCloudEventNotWrappedInAnArray(t *testing.T) {
	...
	require.NotEmpty(t, event)
	require.Equal(t, string(systemevents.TypeStorageBlobDeleted), event.Type)
	eventData := deserializeSystemEvent[systemevents.StorageBlobDeletedEventData](t, event.Data)
	require.Equal(t, "https://example.blob.core.windows.net/testcontainer/testfile.txt", *eventData.URL)
}
