...
func TestConsumeCloudEventMachineLearningServicesModelRegisteredEvent(t *testing.T) {
	...
	sysEvent := deserializeSystemEvent[systemevents.MachineLearningServicesModelRegisteredEventData](t, events[0].Data)
...
func TestConsumeCloudEventMachineLearningServicesModelDeployedEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.MachineLearningServicesModelDeployedEventData](t, events[0].Data)
...
func TestConsumeCloudEventMachineLearningServicesRunCompletedEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.MachineLearningServicesRunCompletedEventData](t, events[0].Data)
...
func TestConsumeCloudEventMachineLearningServicesRunStatusChangedEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.MachineLearningServicesRunStatusChangedEventData](t, events[0].Data)
	require.Equal(t, "AutoML_ad912b2d-6467-4f32-a616-dbe4af6dd8fc", *sysEvent.RunID)
	require.Equal(t, "automl-local-regression", *sysEvent.ExperimentName)
...
func TestConsumeCloudEventMachineLearningServicesDatasetDriftDetectedEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.MachineLearningServicesDatasetDriftDetectedEventData](t, events[0].Data)
...
func TestConsumeCloudEventMapsGeofenceEnteredEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.MapsGeofenceEnteredEventData](t, events[0].Data)
...
func TestConsumeCloudEventMapsGeofenceExitedEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.MapsGeofenceExitedEventData](t, events[0].Data)
	require.Equal(t, float32(1.0), *sysEvent.Geometries[0].Distance)
}
...
func TestConsumeCloudEventMapsGeofenceResultEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.MapsGeofenceResultEventData](t, events[0].Data)
	require.Equal(t, float32(1.0), *sysEvent.Geometries[0].Distance)
}
...
func TestConsumeCloudEventMediaMediaJobStateChangeEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.MediaJobStateChangeEventData](t, events[0].Data)
	require.Equal(t, systemevents.MediaJobStateScheduled, *sysEvent.PreviousState)
	require.Equal(t, systemevents.MediaJobStateProcessing, *sysEvent.State)
}
...
func TestConsumeCloudEventMediaJobOutputStateChangeEvent(t *testing.T) {
	...
	sysEvent := deserializeSystemEvent[systemevents.MediaJobOutputStateChangeEventData](t, events[0].Data)
	require.Equal(t, systemevents.MediaJobStateScheduled, *sysEvent.PreviousState)
	require.Equal(t, systemevents.MediaJobStateProcessing, *sysEvent.Output.GetMediaJobOutput().State)

	outputAsset := sysEvent.Output.(*systemevents.MediaJobOutputAsset)
...
func TestConsumeCloudEventMediaJobScheduledEvent(t *testing.T) {
	...
	sysEvent := deserializeSystemEvent[systemevents.MediaJobScheduledEventData](t, events[0].Data)
	require.Equal(t, systemevents.MediaJobStateQueued, *sysEvent.PreviousState)
	require.Equal(t, systemevents.MediaJobStateScheduled, *sysEvent.State)
}
...
func TestConsumeCloudEventMediaJobProcessingEvent(t *testing.T) {
	...
	sysEvent := deserializeSystemEvent[systemevents.MediaJobProcessingEventData](t, events[0].Data)
	require.Equal(t, systemevents.MediaJobStateScheduled, *sysEvent.PreviousState)
	require.Equal(t, systemevents.MediaJobStateProcessing, *sysEvent.State)
}
...
func TestConsumeCloudEventMediaJobCancelingEvent(t *testing.T) {
	...
	sysEvent := deserializeSystemEvent[systemevents.MediaJobCancelingEventData](t, events[0].Data)
	require.Equal(t, systemevents.MediaJobStateProcessing, *sysEvent.PreviousState)
	require.Equal(t, systemevents.MediaJobStateCanceling, *sysEvent.State)
}
...
func TestConsumeCloudEventMediaJobFinishedEvent(t *testing.T) {
	...
	sysEvent := deserializeSystemEvent[systemevents.MediaJobFinishedEventData](t, events[0].Data)

	require.Equal(t, systemevents.MediaJobStateProcessing, *sysEvent.PreviousState)
	require.Equal(t, systemevents.MediaJobStateFinished, *sysEvent.State)
	require.Equal(t, 1, len(sysEvent.Outputs))

	outputAsset := sysEvent.Outputs[0].(*systemevents.MediaJobOutputAsset)

	require.Equal(t, systemevents.MediaJobStateFinished, *outputAsset.State)
...
func TestConsumeCloudEventMediaJobCanceledEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.MediaJobCanceledEventData](t, events[0].Data)

	require.Equal(t, systemevents.MediaJobStateCanceling, *sysEvent.PreviousState)
	require.Equal(t, systemevents.MediaJobStateCanceled, *sysEvent.State)
	require.Equal(t, 1, len(sysEvent.Outputs))

	outputAsset := sysEvent.Outputs[0].(*systemevents.MediaJobOutputAsset)

	require.Equal(t, systemevents.MediaJobStateCanceled, *outputAsset.State)
...
func TestConsumeCloudEventMediaJobErroredEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.MediaJobErroredEventData](t, events[0].Data)

	require.Equal(t, systemevents.MediaJobStateProcessing, *sysEvent.PreviousState)
	require.Equal(t, systemevents.MediaJobStateError, *sysEvent.State)
	require.Equal(t, 1, len(sysEvent.Outputs))

	outputAsset := sysEvent.Outputs[0].(*systemevents.MediaJobOutputAsset)

	require.Equal(t, systemevents.MediaJobStateError, *outputAsset.State)
	require.NotEmpty(t, *outputAsset.Error)
	require.Equal(t, systemevents.MediaJobErrorCategoryService, *outputAsset.Error.Category)
	require.Equal(t, systemevents.MediaJobErrorCodeServiceError, *outputAsset.Error.Code)
}
...
func TestConsumeCloudEventMediaJobOutputCanceledEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.MediaJobOutputCanceledEventData](t, events[0].Data)

	require.Equal(t, systemevents.MediaJobStateCanceling, *sysEvent.PreviousState)
	require.Equal(t, systemevents.MediaJobStateCanceled, *sysEvent.Output.GetMediaJobOutput().State)
	require.IsType(t, &systemevents.MediaJobOutputAsset{}, sysEvent.Output)
}
...
func TestConsumeCloudEventMediaJobOutputCancelingEvent(t *testing.T) {
	...
	sysEvent := deserializeSystemEvent[systemevents.MediaJobOutputCancelingEventData](t, event.Data)

	require.Equal(t, systemevents.MediaJobStateProcessing, *sysEvent.PreviousState)
	require.Equal(t, systemevents.MediaJobStateCanceling, *sysEvent.Output.GetMediaJobOutput().State)
	require.IsType(t, &systemevents.MediaJobOutputAsset{}, sysEvent.Output)
}
...
func TestConsumeCloudEventMediaJobOutputErroredEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.MediaJobOutputErroredEventData](t, events[0].Data)

	require.Equal(t, systemevents.MediaJobStateProcessing, *sysEvent.PreviousState)
	require.Equal(t, systemevents.MediaJobStateError, *sysEvent.Output.GetMediaJobOutput().State)
	require.IsType(t, &systemevents.MediaJobOutputAsset{}, sysEvent.Output)
	require.NotEmpty(t, *sysEvent.Output.GetMediaJobOutput().Error)
	require.Equal(t, systemevents.MediaJobErrorCategoryService, *sysEvent.Output.GetMediaJobOutput().Error.Category)
	require.Equal(t, systemevents.MediaJobErrorCodeServiceError, *sysEvent.Output.GetMediaJobOutput().Error.Code)
}
...
func TestConsumeCloudEventMediaJobOutputFinishedEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.MediaJobOutputFinishedEventData](t, events[0].Data)

	require.Equal(t, systemevents.MediaJobStateProcessing, *sysEvent.PreviousState)
	require.Equal(t, systemevents.MediaJobStateFinished, *sysEvent.Output.GetMediaJobOutput().State)
...
func TestConsumeCloudEventMediaJobOutputProcessingEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.MediaJobOutputProcessingEventData](t, events[0].Data)
...
func TestConsumeCloudEventMediaJobOutputScheduledEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.MediaJobOutputScheduledEventData](t, events[0].Data)
	require.Equal(t, systemevents.MediaJobStateQueued, *sysEvent.PreviousState)
	require.Equal(t, systemevents.MediaJobStateScheduled, *sysEvent.Output.GetMediaJobOutput().State)
	require.IsType(t, &systemevents.MediaJobOutputAsset{}, sysEvent.Output)
}
...
func TestConsumeCloudEventMediaJobOutputProgressEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.MediaJobOutputProgressEventData](t, events[0].Data)
...
func TestConsumeCloudEventMediaLiveEventEncoderConnectedEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.MediaLiveEventEncoderConnectedEventData](t, events[0].Data)
...
func TestConsumeCloudEventMediaLiveEventConnectionRejectedEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.MediaLiveEventConnectionRejectedEventData](t, events[0].Data)
...
func TestConsumeCloudEventMediaLiveEventEncoderDisconnectedEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.MediaLiveEventEncoderDisconnectedEventData](t, events[0].Data)
...
func TestConsumeCloudEventMediaLiveEventIncomingStreamReceivedEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.MediaLiveEventIncomingStreamReceivedEventData](t, events[0].Data)
...
func TestConsumeCloudEventMediaLiveEventIncomingStreamsOutOfSyncEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.MediaLiveEventIncomingStreamsOutOfSyncEventData](t, events[0].Data)
...
func TestConsumeCloudEventMediaLiveEventIncomingVideoStreamsOutOfSyncEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.MediaLiveEventIncomingVideoStreamsOutOfSyncEventData](t, events[0].Data)
...
func TestConsumeCloudEventMediaLiveEventIncomingDataChunkDroppedEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.MediaLiveEventIncomingDataChunkDroppedEventData](t, events[0].Data)
...
func TestConsumeCloudEventMediaLiveEventIngestHeartbeatEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.MediaLiveEventIngestHeartbeatEventData](t, events[0].Data)
...
func TestConsumeCloudEventMediaLiveEventTrackDiscontinuityDetectedEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.MediaLiveEventTrackDiscontinuityDetectedEventData](t, events[0].Data)
...
func TestConsumeCloudEventResourceWriteSuccessEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.ResourceWriteSuccessEventData](t, events[0].Data)
...
func TestConsumeCloudEventResourceWriteFailureEvent(t *testing.T) {
	...
	sysEvent := deserializeSystemEvent[systemevents.ResourceWriteFailureEventData](t, events[0].Data)
	require.Equal(t, "72f988bf-86f1-41af-91ab-2d7cd011db47", *sysEvent.TenantID)
}
...
func TestConsumeCloudEventResourceWriteCancelEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.ResourceWriteCancelEventData](t, events[0].Data)
	require.Equal(t, "72f988bf-86f1-41af-91ab-2d7cd011db47", *sysEvent.TenantID)
}
...
func TestConsumeCloudEventResourceDeleteSuccessEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.ResourceDeleteSuccessEventData](t, events[0].Data)
	require.Equal(t, "72f988bf-86f1-41af-91ab-2d7cd011db47", *sysEvent.TenantID)
}
...
func TestConsumeCloudEventResourceDeleteFailureEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.ResourceDeleteFailureEventData](t, events[0].Data)
	require.Equal(t, "72f988bf-86f1-41af-91ab-2d7cd011db47", *sysEvent.TenantID)
}
...
func TestConsumeCloudEventResourceDeleteCancelEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.ResourceDeleteCancelEventData](t, events[0].Data)
	require.Equal(t, "72f988bf-86f1-41af-91ab-2d7cd011db47", *sysEvent.TenantID)
}
...
func TestConsumeCloudEventResourceActionSuccessEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.ResourceActionSuccessEventData](t, events[0].Data)
	require.Equal(t, "72f988bf-86f1-41af-91ab-2d7cd011db47", *sysEvent.TenantID)
}
...
func TestConsumeCloudEventResourceActionFailureEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.ResourceActionFailureEventData](t, events[0].Data)
	require.Equal(t, "72f988bf-86f1-41af-91ab-2d7cd011db47", *sysEvent.TenantID)
}
...
func TestConsumeCloudEventResourceActionCancelEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.ResourceActionCancelEventData](t, events[0].Data)
	require.Equal(t, "72f988bf-86f1-41af-91ab-2d7cd011db47", *sysEvent.TenantID)
}
...
func TestConsumeCloudEventServiceBusActiveMessagesAvailableWithNoListenersEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.ServiceBusActiveMessagesAvailableWithNoListenersEventData](t, events[0].Data)
...
func TestConsumeCloudEventServiceBusDeadletterMessagesAvailableWithNoListenersEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.ServiceBusDeadletterMessagesAvailableWithNoListenersEventData](t, events[0].Data)
	require.Equal(t, "testns1", *sysEvent.NamespaceName)
}
...
func TestConsumeCloudEventStorageBlobCreatedEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.StorageBlobCreatedEventData](t, events[0].Data)
...
func TestConsumeCloudEventStorageBlobDeletedEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.StorageBlobDeletedEventData](t, events[0].Data)
...
func TestConsumeCloudEventStorageBlobRenamedEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.StorageBlobRenamedEventData](t, events[0].Data)
...
func TestConsumeCloudEventStorageDirectoryCreatedEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.StorageDirectoryCreatedEventData](t, events[0].Data)
...
func TestConsumeCloudEventStorageDirectoryDeletedEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.StorageDirectoryDeletedEventData](t, events[0].Data)
...
func TestConsumeCloudEventStorageDirectoryRenamedEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.StorageDirectoryRenamedEventData](t, events[0].Data)
...
func TestConsumeCloudEventStorageAsyncOperationInitiatedEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.StorageAsyncOperationInitiatedEventData](t, events[0].Data)
	require.Equal(t, "https://example.blob.core.windows.net/testcontainer/testDir", *sysEvent.URL)
}
...
func TestConsumeCloudEventStorageBlobTierChangedEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.StorageBlobTierChangedEventData](t, events[0].Data)
	require.Equal(t, "https://example.blob.core.windows.net/testcontainer/testDir", *sysEvent.URL)
}
...
func TestConsumeCloudEventWebAppUpdatedEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.WebAppUpdatedEventData](t, events[0].Data)
...
func TestConsumeCloudEventWebBackupOperationStartedEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.WebBackupOperationStartedEventData](t, events[0].Data)
	require.Equal(t, siteName, *sysEvent.Name)
}
...
func TestConsumeCloudEventWebBackupOperationCompletedEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.WebBackupOperationCompletedEventData](t, events[0].Data)
	require.Equal(t, siteName, *sysEvent.Name)
}
...
func TestConsumeCloudEventWebBackupOperationFailedEvent(t *testing.T) {
	...
	events := parseManyCloudEvents(t, requestContent)
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.WebBackupOperationFailedEventData](t, events[0].Data)
	require.Equal(t, siteName, *sysEvent.Name)
}
...
func TestConsumeCloudEventWebRestoreOperationStartedEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.WebRestoreOperationStartedEventData](t, events[0].Data)
	require.Equal(t, siteName, *sysEvent.Name)
}
...
func TestConsumeCloudEventWebRestoreOperationCompletedEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.WebRestoreOperationCompletedEventData](t, events[0].Data)
	require.Equal(t, siteName, *sysEvent.Name)
}
...
func TestConsumeCloudEventWebRestoreOperationFailedEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.WebRestoreOperationFailedEventData](t, events[0].Data)
	require.Equal(t, siteName, *sysEvent.Name)
}
...
func TestConsumeCloudEventWebSlotSwapStartedEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.WebSlotSwapStartedEventData](t, events[0].Data)
	require.Equal(t, siteName, *sysEvent.Name)
}
...
func TestConsumeCloudEventWebSlotSwapCompletedEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.WebSlotSwapCompletedEventData](t, events[0].Data)
	require.Equal(t, siteName, *sysEvent.Name)
}
...
func TestConsumeCloudEventWebSlotSwapFailedEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.WebSlotSwapFailedEventData](t, events[0].Data)
	require.Equal(t, siteName, *sysEvent.Name)
}
...
func TestConsumeCloudEventWebSlotSwapWithPreviewStartedEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.WebSlotSwapWithPreviewStartedEventData](t, events[0].Data)
	require.Equal(t, siteName, *sysEvent.Name)
}
...
func TestConsumeCloudEventWebSlotSwapWithPreviewCancelledEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.WebSlotSwapWithPreviewCancelledEventData](t, events[0].Data)
	require.Equal(t, siteName, *sysEvent.Name)
}
...
func TestConsumeCloudEventWebAppServicePlanUpdatedEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.WebAppServicePlanUpdatedEventData](t, events[0].Data)
...
func TestConsumeCloudEventPolicyInsightsPolicyStateChangedEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.PolicyInsightsPolicyStateChangedEventData](t, events[0].Data)
...
func TestConsumeCloudEventPolicyInsightsPolicyStateCreatedEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.PolicyInsightsPolicyStateCreatedEventData](t, events[0].Data)
	require.Equal(t, "4c2359fe-001e-00ba-0e04-585868000000", *sysEvent.PolicyDefinitionID)
}
...
func TestConsumeCloudEventPolicyInsightsPolicyStateDeletedEvent(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.PolicyInsightsPolicyStateDeletedEventData](t, events[0].Data)
	require.Equal(t, "4c2359fe-001e-00ba-0e04-585868000000", *sysEvent.PolicyDefinitionID)
}
...
func TestConsumeCloudEventAcsRecordingFileStatusUpdatedEventData(t *testing.T) {
	...
	require.NotEmpty(t, events)
	sysEvent := deserializeSystemEvent[systemevents.AcsRecordingFileStatusUpdatedEventData](t, events[0].Data)

	// TODO: rename, it seems?
	// require.Equal(t, systemevents.RecordingChannelTypeMixed, sysEvent.ChannelType)
	// require.Equal(t, systemevents.RecordingContentTypeAudio, sysEvent.ContentType)
	// require.Equal(t, systemevents.RecordingFormatTypeMp3, sysEvent.FormatType)

	// back compat
	require.Equal(t, systemevents.RecordingChannelTypeMixed, *sysEvent.RecordingChannelType)
	require.Equal(t, systemevents.RecordingContentTypeAudio, *sysEvent.RecordingContentType)
	require.Equal(t, systemevents.RecordingFormatTypeMp3, *sysEvent.RecordingFormatType)
}
...
func TestConsumeCloudEventAcsEmailDeliveryReportReceivedEvent(t *testing.T) {
	...
	sysEvent := deserializeSystemEvent[systemevents.AcsEmailDeliveryReportReceivedEventData](t, event.Data)
	require.Equal(t, "test2@contoso.org", *sysEvent.Sender)
	require.Equal(t, "test1@contoso.com", *sysEvent.Recipient)
	require.Equal(t, systemevents.AcsEmailDeliveryReportStatusDelivered, *sysEvent.Status)
...
func TestConsumeCloudEventAcsIncomingCallEvent(t *testing.T) {
	...
	require.NotEmpty(t, event)
	sysEvent := deserializeSystemEvent[systemevents.AcsIncomingCallEventData](t, event.Data)
...
func TestConsumeCloudEventAcsRouterJobClassificationFailedEvent(t *testing.T) {
	...
	sysEvent := deserializeSystemEvent[systemevents.AcsRouterJobClassificationFailedEventData](t, event.Data)
