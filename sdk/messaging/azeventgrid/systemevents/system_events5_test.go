...
func TestConsumeCloudEventAcsRouterJobQueuedEvent(t *testing.T) {
	...
	sysEvent := deserializeSystemEvent[systemevents.AcsRouterJobQueuedEventData](t, event.Data)
	...
	require.Equal(t, systemevents.AcsRouterLabelOperatorEqual, *selectors[0].LabelOperator)
	// TODO: might have been a field rename?
	//require.Equal(t, systemevents.AcsRouterLabelOperatorEqual, selectors[0].Operator)

	require.Equal(t, systemevents.AcsRouterWorkerSelectorStateActive, *selectors[0].State)
	// TODO: might have been a field rename?
	//require.Equal(t, systemevents.AcsRouterWorkerSelectorStateActive, selectors[0].SelectorState)
}
...
func TestConsumeCloudEventAcsRouterJobReceivedEvent(t *testing.T) {
	...
	sysEvent := deserializeSystemEvent[systemevents.AcsRouterJobReceivedEventData](t, event.Data)
	require.Equal(t, systemevents.AcsRouterJobStatusPendingClassification, *sysEvent.JobStatus)

	// TODO: don't have a .Status field?
	//require.Equal(t, Azure.Messaging.EventGrid.SystemEvents.AcsRouterJobStatus.PendingClassification, sysEvent.Status)
}
...
func TestConsumeCloudEventGatewayApiAddedEvent(t *testing.T) {
	...
	require.NotEmpty(t, event)
	apimEvent := deserializeSystemEvent[systemevents.APIManagementGatewayAPIAddedEventData](t, event.Data)
...
func TestConsumeCloudEventGatewayApiRemovedEvent(t *testing.T) {
	...
	require.NotEmpty(t, event)
	apimEvent := deserializeSystemEvent[systemevents.APIManagementGatewayAPIRemovedEventData](t, event.Data)
	require.Equal(t, "/subscriptions/{subscription-id}/resourceGroups/{your-rg}/providers/Microsoft.ApiManagement/service/{your-APIM-instance}/gateways/{gateway-name}/apis/example-api", *apimEvent.ResourceURI)
}
...
func TestConsumeCloudEventCertificateAuthorityCreatedEvent(t *testing.T) {
	...
	apimEvent := deserializeSystemEvent[systemevents.APIManagementGatewayCertificateAuthorityCreatedEventData](t, event.Data)
	require.Equal(t, "/subscriptions/{subscription-id}/resourceGroups/{your-rg}/providers/Microsoft.ApiManagement/service/{your-APIM-instance}/gateways/{gateway-name}/apis/example-api", *apimEvent.ResourceURI)
}
...
func TestConsumeCloudEventCertificateAuthorityDeletedEvent(t *testing.T) {
	...
	require.NotEmpty(t, event)
	apimEvent := deserializeSystemEvent[systemevents.APIManagementGatewayCertificateAuthorityDeletedEventData](t, event.Data)
	require.Equal(t, "/subscriptions/{subscription-id}/resourceGroups/{your-rg}/providers/Microsoft.ApiManagement/service/{your-APIM-instance}/gateways/{gateway-name}/apis/example-api", *apimEvent.ResourceURI)
}
...
func TestConsumeCloudEventCertificateAuthorityUpdatedEvent(t *testing.T) {
	...
	require.NotEmpty(t, event)
	apimEvent := deserializeSystemEvent[systemevents.APIManagementGatewayCertificateAuthorityUpdatedEventData](t, event.Data)
	require.Equal(t, "/subscriptions/{subscription-id}/resourceGroups/{your-rg}/providers/Microsoft.ApiManagement/service/{your-APIM-instance}/gateways/{gateway-name}/apis/example-api", *apimEvent.ResourceURI)
}
...
func TestConsumeCloudEventDataBoxCopyCompleted(t *testing.T) {
	...
	dataBoxEvent := deserializeSystemEvent[systemevents.DataBoxCopyCompletedEventData](t, event.Data)

	require.Equal(t, "SampleSerialNumber", *dataBoxEvent.SerialNumber)
	require.Equal(t, systemevents.DataBoxStageNameCopyCompleted, *dataBoxEvent.StageName)
...
func TestConsumeCloudEventDataBoxCopyStarted(t *testing.T) {
	...
	dataBoxEvent := deserializeSystemEvent[systemevents.DataBoxCopyStartedEventData](t, event.Data)

	require.Equal(t, "SampleSerialNumber", *dataBoxEvent.SerialNumber)
	require.Equal(t, systemevents.DataBoxStageNameCopyStarted, *dataBoxEvent.StageName)
	require.Equal(t, mustParseTime(t, "2022-10-12T19:38:08.0218897Z"), *dataBoxEvent.StageTime)
}
...
func TestConsumeCloudEventDataBoxOrderCompleted(t *testing.T) {
	...
	dataBoxEvent := deserializeSystemEvent[systemevents.DataBoxOrderCompletedEventData](t, event.Data)

	require.Equal(t, "SampleSerialNumber", *dataBoxEvent.SerialNumber)
	require.Equal(t, systemevents.DataBoxStageNameOrderCompleted, *dataBoxEvent.StageName)
	require.Equal(t, mustParseTime(t, "2022-10-12T19:38:08.0218897Z"), *dataBoxEvent.StageTime)
}
...
func TestConsumeCloudEventHealthResourcesAvailiabilityStatusChangedEvent(t *testing.T) {
	...
	require.NotEmpty(t, event)
	availabilityStatusChangedEventData := deserializeSystemEvent[systemevents.ResourceNotificationsHealthResourcesAvailabilityStatusChangedEventData](t, event.Data)
...
func TestConsumeCloudEventResourceDeletedEvent(t *testing.T) {
	...
	require.NotEmpty(t, event)
	sysEvent := deserializeSystemEvent[systemevents.ResourceNotificationsResourceManagementDeletedEventData](t, event.Data)
...
func TestConsumeCloudEventResourceCreatedOrUpdatedEvent(t *testing.T) {
	...
	sysEvent := deserializeSystemEvent[systemevents.ResourceNotificationsResourceManagementCreatedOrUpdatedEventData](t, event.Data)
