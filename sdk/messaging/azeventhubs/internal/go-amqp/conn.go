...
import (
	...
	"github.com/Azure/azure-sdk-for-go/sdk/messaging/azeventhubs/internal/go-amqp/internal/bitmap"
	...
	"github.com/Azure/azure-sdk-for-go/sdk/messaging/azeventhubs/internal/go-amqp/internal/shared"
)
...
func (c *Conn) close() {
	...
	if errors.Is(c.rxErr, net.ErrClosed) || errors.Is(c.rxErr, context.DeadlineExceeded) {
		// these are expected errors when the connection is closed, swallow it
		c.rxErr = nil
	}
