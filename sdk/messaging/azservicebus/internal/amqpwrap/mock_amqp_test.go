...
// Package amqpwrap is a generated GoMock package.
package amqpwrap
...
import (
	...
	go_amqp "github.com/Azure/azure-sdk-for-go/sdk/messaging/azservicebus/internal/go-amqp"
...
func (m *MockAMQPReceiver) AcceptMessage(ctx context.Context, msg *go_amqp.Message) error {
	m.ctrl.T.Helper()
...
func (m *MockAMQPReceiver) ModifyMessage(ctx context.Context, msg *go_amqp.Message, options *go_amqp.ModifyMessageOptions) error {
	m.ctrl.T.Helper()
...
func (m *MockAMQPReceiver) Prefetched() *go_amqp.Message {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Prefetched")
	ret0, _ := ret[0].(*go_amqp.Message)
	return ret0
}
...
func (m *MockAMQPReceiver) Receive(ctx context.Context, o *go_amqp.ReceiveOptions) (*go_amqp.Message, error) {
	m.ctrl.T.Helper()
...
func (m *MockAMQPReceiver) RejectMessage(ctx context.Context, msg *go_amqp.Message, e *go_amqp.Error) error {
	m.ctrl.T.Helper()
...
func (m *MockAMQPReceiver) ReleaseMessage(ctx context.Context, msg *go_amqp.Message) error {
	m.ctrl.T.Helper()
...
// AcceptMessage mocks base method.
func (m *MockAMQPReceiverCloser) AcceptMessage(ctx context.Context, msg *go_amqp.Message) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AcceptMessage", ctx, msg)
	ret0, _ := ret[0].(error)
	return ret0
...
// ModifyMessage mocks base method.
func (m *MockAMQPReceiverCloser) ModifyMessage(ctx context.Context, msg *go_amqp.Message, options *go_amqp.ModifyMessageOptions) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ModifyMessage", ctx, msg, options)
	ret0, _ := ret[0].(error)
	return ret0
...
// Prefetched mocks base method.
func (m *MockAMQPReceiverCloser) Prefetched() *go_amqp.Message {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Prefetched")
	ret0, _ := ret[0].(*go_amqp.Message)
	return ret0
...
// Receive mocks base method.
func (m *MockAMQPReceiverCloser) Receive(ctx context.Context, o *go_amqp.ReceiveOptions) (*go_amqp.Message, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Receive", ctx, o)
	ret0, _ := ret[0].(*go_amqp.Message)
	ret1, _ := ret[1].(error)
...
// RejectMessage mocks base method.
func (m *MockAMQPReceiverCloser) RejectMessage(ctx context.Context, msg *go_amqp.Message, e *go_amqp.Error) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "RejectMessage", ctx, msg, e)
	ret0, _ := ret[0].(error)
	return ret0
...
// ReleaseMessage mocks base method.
func (m *MockAMQPReceiverCloser) ReleaseMessage(ctx context.Context, msg *go_amqp.Message) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ReleaseMessage", ctx, msg)
	ret0, _ := ret[0].(error)
	return ret0
...
// Send mocks base method.
func (m *MockAMQPSenderCloser) Send(ctx context.Context, msg *go_amqp.Message, o *go_amqp.SendOptions) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Send", ctx, msg, o)
	ret0, _ := ret[0].(error)
	return ret0
...
// NewSession mocks base method.
func (m *MockgoamqpConn) NewSession(ctx context.Context, opts *go_amqp.SessionOptions) (*go_amqp.Session, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NewSession", ctx, opts)
	ret0, _ := ret[0].(*go_amqp.Session)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// NewReceiver mocks base method.
func (m *MockgoamqpSession) NewReceiver(ctx context.Context, source string, opts *go_amqp.ReceiverOptions) (*go_amqp.Receiver, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NewReceiver", ctx, source, opts)
	ret0, _ := ret[0].(*go_amqp.Receiver)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// NewSender mocks base method.
func (m *MockgoamqpSession) NewSender(ctx context.Context, target string, opts *go_amqp.SenderOptions) (*go_amqp.Sender, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NewSender", ctx, target, opts)
	ret0, _ := ret[0].(*go_amqp.Sender)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// AcceptMessage mocks base method.
func (m *MockgoamqpReceiver) AcceptMessage(ctx context.Context, msg *go_amqp.Message) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AcceptMessage", ctx, msg)
	ret0, _ := ret[0].(error)
	return ret0
...
// ModifyMessage mocks base method.
func (m *MockgoamqpReceiver) ModifyMessage(ctx context.Context, msg *go_amqp.Message, options *go_amqp.ModifyMessageOptions) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ModifyMessage", ctx, msg, options)
	ret0, _ := ret[0].(error)
	return ret0
...
// Prefetched mocks base method.
func (m *MockgoamqpReceiver) Prefetched() *go_amqp.Message {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Prefetched")
	ret0, _ := ret[0].(*go_amqp.Message)
	return ret0
...
// Receive mocks base method.
func (m *MockgoamqpReceiver) Receive(ctx context.Context, o *go_amqp.ReceiveOptions) (*go_amqp.Message, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Receive", ctx, o)
	ret0, _ := ret[0].(*go_amqp.Message)
	ret1, _ := ret[1].(error)
...
// RejectMessage mocks base method.
func (m *MockgoamqpReceiver) RejectMessage(ctx context.Context, msg *go_amqp.Message, e *go_amqp.Error) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "RejectMessage", ctx, msg, e)
	ret0, _ := ret[0].(error)
	return ret0
...
// ReleaseMessage mocks base method.
func (m *MockgoamqpReceiver) ReleaseMessage(ctx context.Context, msg *go_amqp.Message) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ReleaseMessage", ctx, msg)
	ret0, _ := ret[0].(error)
	return ret0
