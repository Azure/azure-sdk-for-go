...
func TestReceiverDeleteMessages(t *testing.T) {
	init := func(t *testing.T, count int, retryOptions *RetryOptions) (*Sender, *Receiver) {
		if retryOptions == nil {
	...
	t.Run("BeforeEnqueueTime", func(t *testing.T) {
		_, receiver := init(t, 1, nil)
	...
	t.Run("CountNegative", func(t *testing.T) {
		...
		_, receiver := init(t, 1, &RetryOptions{
			MaxRetries: -1,
		})
	...
	t.Run("PurgeMessages", func(t *testing.T) {
