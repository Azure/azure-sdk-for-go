...
func TestSender_TracingUserFacingError(t *testing.T) {
	...
	sendErr := &amqp.ConnError{}

	sender.tracer = newTracer(tracingvalidator.NewSpanValidator(t, tracingvalidator.SpanMatcher{
		Name:   "send queue",
	...
	createTracer := newTracer(tracingvalidator.NewSpanValidator(t, tracingvalidator.SpanMatcher{
		Name:   "create queue",
		Kind:   tracing.SpanKindProducer,
