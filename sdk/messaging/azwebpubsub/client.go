...
func (client *Client) addConnectionToGroupCreateRequest(ctx context.Context, hub string, group string, connectionID string, _ *AddConnectionToGroupOptions) (*policy.Request, error) {
	...
	reqQP.Set("api-version", version20230701)
...
func (client *Client) addConnectionsToGroupsCreateRequest(ctx context.Context, hub string, groupsToAdd AddToGroupsRequest, _ *AddConnectionsToGroupsOptions) (*policy.Request, error) {
...
func (client *Client) addUserToGroupCreateRequest(ctx context.Context, hub string, group string, userID string, _ *AddUserToGroupOptions) (*policy.Request, error) {
...
func (client *Client) connectionExistsCreateRequest(ctx context.Context, hub string, connectionID string, _ *ConnectionExistsOptions) (*policy.Request, error) {
	urlPath := "/api/hubs/{hub}/connections/{connectionId}"
	if hub == "" {
		return nil, errors.New("parameter hub cannot be empty")
	}
...
func (client *Client) groupExistsCreateRequest(ctx context.Context, hub string, group string, _ *GroupExistsOptions) (*policy.Request, error) {
...
func (client *Client) removeConnectionFromAllGroupsCreateRequest(ctx context.Context, hub string, connectionID string, _ *RemoveConnectionFromAllGroupsOptions) (*policy.Request, error) {
...
func (client *Client) removeConnectionFromGroupCreateRequest(ctx context.Context, hub string, group string, connectionID string, _ *RemoveConnectionFromGroupOptions) (*policy.Request, error) {
	urlPath := "/api/hubs/{hub}/groups/{group}/connections/{connectionId}"
	if hub == "" {
		return nil, errors.New("parameter hub cannot be empty")
	}
...
func (client *Client) removeConnectionsFromGroupsCreateRequest(ctx context.Context, hub string, groupsToRemove RemoveFromGroupsRequest, _ *RemoveConnectionsFromGroupsOptions) (*policy.Request, error) {
...
func (client *Client) removeUserFromAllGroupsCreateRequest(ctx context.Context, hub string, userID string, _ *RemoveUserFromAllGroupsOptions) (*policy.Request, error) {
...
func (client *Client) removeUserFromGroupCreateRequest(ctx context.Context, hub string, group string, userID string, _ *RemoveUserFromGroupOptions) (*policy.Request, error) {
	urlPath := "/api/hubs/{hub}/users/{userId}/groups/{group}"
	if hub == "" {
		return nil, errors.New("parameter hub cannot be empty")
	}
...
func (client *Client) userExistsCreateRequest(ctx context.Context, hub string, userID string, _ *UserExistsOptions) (*policy.Request, error) {
