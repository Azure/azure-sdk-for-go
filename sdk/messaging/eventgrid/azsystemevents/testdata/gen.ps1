...
# Copy-Item `
#     -Path $LocalTestingGitRepo/specification/eventgrid/Azure.Messaging.EventGrid.SystemEvents `
#     -Destination TempTypeSpecFiles/Azure.Messaging.EventGrid.SystemEvents `
#     -Recurse
# Remove-Item TempTypeSpecFiles/Azure.Messaging.EventGrid.SystemEvents/tspconfig.yaml
