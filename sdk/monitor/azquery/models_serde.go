...
func (b BatchQueryResults) MarshalJSON() ([]byte, error) {
	...
	populateAny(objectMap, "statistics", b.Statistics)
	populate(objectMap, "tables", b.Tables)
	populateAny(objectMap, "render", b.Visualization)
	return json.Marshal(objectMap)
}
...
func (r Results) MarshalJSON() ([]byte, error) {
	...
	populateAny(objectMap, "statistics", r.Statistics)
	populate(objectMap, "tables", r.Tables)
	populateAny(objectMap, "render", r.Visualization)
	return json.Marshal(objectMap)
}
...
func (r *Results) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "tables":
			...
			delete(rawMsg, key)
		case "render":
				err = unpopulate(val, "Visualization", &r.Visualization)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", r, err)
