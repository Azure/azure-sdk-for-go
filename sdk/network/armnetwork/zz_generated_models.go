...
type ActiveBaseSecurityAdminRule struct {
	...
	RuleCollectionDisplayName *string `json:"ruleCollectionDisplayName,omitempty"`
...
func (a ActiveBaseSecurityAdminRule) marshalInternal(discValue EffectiveAdminRuleKind) map[string]interface{} {
	objectMap := make(map[string]interface{})
	populate(objectMap, "commitTime", (*timeRFC3339)(a.CommitTime))
	populate(objectMap, "configurationDescription", a.ConfigurationDescription)
	populate(objectMap, "configurationDisplayName", a.ConfigurationDisplayName)
	...
	populate(objectMap, "ruleCollectionDisplayName", a.RuleCollectionDisplayName)
	populate(objectMap, "ruleGroups", a.RuleGroups)
	return objectMap
}

func (a *ActiveBaseSecurityAdminRule) unmarshalInternal(rawMsg map[string]json.RawMessage) error {
	for key, val := range rawMsg {
		...
		case "commitTime":
			...
			a.CommitTime = (*time.Time)(&aux)
			delete(rawMsg, key)
		case "configurationDescription":
			err = unpopulate(val, &a.ConfigurationDescription)
			delete(rawMsg, key)
		case "configurationDisplayName":
			err = unpopulate(val, &a.ConfigurationDisplayName)
			delete(rawMsg, key)
		case "id":
		...
		case "ruleCollectionAppliesToGroups":
			err = unpopulate(val, &a.RuleCollectionAppliesToGroups)
			delete(rawMsg, key)
		case "ruleCollectionDescription":
			err = unpopulate(val, &a.RuleCollectionDescription)
			delete(rawMsg, key)
		case "ruleCollectionDisplayName":
			err = unpopulate(val, &a.RuleCollectionDisplayName)
			delete(rawMsg, key)
		case "ruleGroups":
			err = unpopulate(val, &a.RuleGroups)
			delete(rawMsg, key)
		}
		if err != nil {
			return err
...
// ActiveBaseSecurityUserRuleClassification provides polymorphic access to related types.
// Call the interface's GetActiveBaseSecurityUserRule() method to access the common type.
// Use a type switch to determine the concrete type.  The possible types are:
// - *ActiveBaseSecurityUserRule, *ActiveDefaultSecurityUserRule, *ActiveSecurityUserRule
type ActiveBaseSecurityUserRuleClassification interface {
	// GetActiveBaseSecurityUserRule returns the ActiveBaseSecurityUserRule content of the underlying type.
	GetActiveBaseSecurityUserRule() *ActiveBaseSecurityUserRule
}

// ActiveBaseSecurityUserRule - Network base rule.
type ActiveBaseSecurityUserRule struct {
	// REQUIRED; Whether the rule is custom or default.
	Kind *EffectiveUserRuleKind `json:"kind,omitempty"`
...
// GetActiveBaseSecurityUserRule implements the ActiveBaseSecurityUserRuleClassification interface for type ActiveBaseSecurityUserRule.
func (a *ActiveBaseSecurityUserRule) GetActiveBaseSecurityUserRule() *ActiveBaseSecurityUserRule {
	return a
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ActiveBaseSecurityUserRule.
func (a *ActiveBaseSecurityUserRule) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return err
	}
...
func (a ActiveBaseSecurityUserRule) marshalInternal(discValue EffectiveUserRuleKind) map[string]interface{} {
	objectMap := make(map[string]interface{})
	populate(objectMap, "commitTime", (*timeRFC3339)(a.CommitTime))
	populate(objectMap, "configurationDescription", a.ConfigurationDescription)
	populate(objectMap, "configurationDisplayName", a.ConfigurationDisplayName)
...
func (a *ActiveBaseSecurityUserRule) unmarshalInternal(rawMsg map[string]json.RawMessage) error {
	for key, val := range rawMsg {
		var err error
		switch key {
		case "commitTime":
...
type ActiveConfigurationParameter struct {
	...
	// When present, the value can be passed to a subsequent query call (together with the same query and scopes used in the current request) to retrieve the
	// next page of data.
...
func (a ActiveConnectivityConfiguration) MarshalJSON() ([]byte, error) {
	objectMap := a.EffectiveConnectivityConfiguration.marshalInternal()
	populate(objectMap, "commitTime", (*timeRFC3339)(a.CommitTime))
	populate(objectMap, "region", a.Region)
	return json.Marshal(objectMap)
}
...
func (a *ActiveConnectivityConfiguration) UnmarshalJSON(data []byte) error {
	...
	return a.EffectiveConnectivityConfiguration.unmarshalInternal(rawMsg)
}

// ActiveConnectivityConfigurationsListOptions contains the optional parameters for the ActiveConnectivityConfigurations.List method.
type ActiveConnectivityConfigurationsListOptions struct {
	// placeholder for future optional parameters
}

// ActiveConnectivityConfigurationsListResult - Result of the request to list active connectivity configurations. It contains a list of active connectivity
...
func (a ActiveDefaultSecurityAdminRule) MarshalJSON() ([]byte, error) {
	objectMap := a.ActiveBaseSecurityAdminRule.marshalInternal(EffectiveAdminRuleKindDefault)
...
func (a *ActiveDefaultSecurityAdminRule) UnmarshalJSON(data []byte) error {
	...
	return a.ActiveBaseSecurityAdminRule.unmarshalInternal(rawMsg)
}

// ActiveDefaultSecurityUserRule - Network security default user rule.
type ActiveDefaultSecurityUserRule struct {
	ActiveBaseSecurityUserRule
	// Indicates the properties of the security default user rule
	Properties *DefaultUserRulePropertiesFormat `json:"properties,omitempty"`
}

// MarshalJSON implements the json.Marshaller interface for type ActiveDefaultSecurityUserRule.
func (a ActiveDefaultSecurityUserRule) MarshalJSON() ([]byte, error) {
	objectMap := a.ActiveBaseSecurityUserRule.marshalInternal(EffectiveUserRuleKindDefault)
	populate(objectMap, "properties", a.Properties)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ActiveDefaultSecurityUserRule.
func (a *ActiveDefaultSecurityUserRule) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return err
	}
	...
	return a.ActiveBaseSecurityUserRule.unmarshalInternal(rawMsg)
}
...
func (a ActiveSecurityAdminRule) MarshalJSON() ([]byte, error) {
	objectMap := a.ActiveBaseSecurityAdminRule.marshalInternal(EffectiveAdminRuleKindCustom)
	populate(objectMap, "properties", a.Properties)
	return json.Marshal(objectMap)
}
...
// ActiveSecurityAdminRulesListOptions contains the optional parameters for the ActiveSecurityAdminRules.List method.
type ActiveSecurityAdminRulesListOptions struct {
	// placeholder for future optional parameters
}

// ActiveSecurityAdminRulesListResult - Result of the request to list active security admin rules. It contains a list of active security admin rules and
// a skiptoken to get the next set of results.
...
func (a *ActiveSecurityAdminRulesListResult) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "skipToken":
			err = unpopulate(val, &a.SkipToken)
			delete(rawMsg, key)
		case "value":
...
// ActiveSecurityUserRule - Network security user rule.
type ActiveSecurityUserRule struct {
	ActiveBaseSecurityUserRule
	// Indicates the properties of the security user rule
	Properties *UserRulePropertiesFormat `json:"properties,omitempty"`
}

// MarshalJSON implements the json.Marshaller interface for type ActiveSecurityUserRule.
func (a ActiveSecurityUserRule) MarshalJSON() ([]byte, error) {
	objectMap := a.ActiveBaseSecurityUserRule.marshalInternal(EffectiveUserRuleKindCustom)
	populate(objectMap, "properties", a.Properties)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ActiveSecurityUserRule.
func (a *ActiveSecurityUserRule) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return err
	}
...
// ActiveSecurityUserRulesListOptions contains the optional parameters for the ActiveSecurityUserRules.List method.
type ActiveSecurityUserRulesListOptions struct {
	// placeholder for future optional parameters
}

// ActiveSecurityUserRulesListResult - Result of the request to list active security user rules. It contains a list of active security user rules and a
// skiptoken to get the next set of results.
type ActiveSecurityUserRulesListResult struct {
	// When present, the value can be passed to a subsequent query call (together with the same query and scopes used in the current request) to retrieve the
	// next page of data.
	SkipToken *string `json:"skipToken,omitempty"`

	// Gets a page of active security user rules.
	Value []ActiveBaseSecurityUserRuleClassification `json:"value,omitempty"`
}

// MarshalJSON implements the json.Marshaller interface for type ActiveSecurityUserRulesListResult.
func (a ActiveSecurityUserRulesListResult) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "skipToken", a.SkipToken)
	populate(objectMap, "value", a.Value)
	return json.Marshal(objectMap)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type ActiveSecurityUserRulesListResult.
func (a *ActiveSecurityUserRulesListResult) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return err
	}
	for key, val := range rawMsg {
		...
		case "skipToken":
			...
			delete(rawMsg, key)
		case "value":
			a.Value, err = unmarshalActiveBaseSecurityUserRuleClassificationArray(val)
			delete(rawMsg, key)
		}
		if err != nil {
			return err
...
type AdminPropertiesFormat struct {
	...
	// The priority of the rule. The value can be between 1 and 4096. The priority number must be unique for each rule in the collection. The lower the priority
...
func (a AdminRule) MarshalJSON() ([]byte, error) {
	objectMap := a.BaseAdminRule.marshalInternal(AdminRuleKindCustom)
	populate(objectMap, "properties", a.Properties)
	return json.Marshal(objectMap)
}
...
func (a *AdminRule) UnmarshalJSON(data []byte) error {
	...
	return a.BaseAdminRule.unmarshalInternal(rawMsg)
}

// AdminRuleCollectionsCreateOrUpdateOptions contains the optional parameters for the AdminRuleCollections.CreateOrUpdate method.
type AdminRuleCollectionsCreateOrUpdateOptions struct {
	// placeholder for future optional parameters
}

// AdminRuleCollectionsDeleteOptions contains the optional parameters for the AdminRuleCollections.Delete method.
type AdminRuleCollectionsDeleteOptions struct {
	// placeholder for future optional parameters
}

// AdminRuleCollectionsGetOptions contains the optional parameters for the AdminRuleCollections.Get method.
type AdminRuleCollectionsGetOptions struct {
	// placeholder for future optional parameters
}

// AdminRuleCollectionsListOptions contains the optional parameters for the AdminRuleCollections.List method.
type AdminRuleCollectionsListOptions struct {
...
// AdminRulesCreateOrUpdateOptions contains the optional parameters for the AdminRules.CreateOrUpdate method.
type AdminRulesCreateOrUpdateOptions struct {
	// placeholder for future optional parameters
}

// AdminRulesDeleteOptions contains the optional parameters for the AdminRules.Delete method.
type AdminRulesDeleteOptions struct {
	// placeholder for future optional parameters
}

// AdminRulesGetOptions contains the optional parameters for the AdminRules.Get method.
type AdminRulesGetOptions struct {
	// placeholder for future optional parameters
}

// AdminRulesListOptions contains the optional parameters for the AdminRules.List method.
type AdminRulesListOptions struct {
	// SkipToken is only used if a previous operation returned a partial result. If a previous response contains a nextLink element, the value of the nextLink
	// element will include a skipToken parameter that specifies a starting point to use for subsequent calls.
	SkipToken *string
	// An optional query parameter which specifies the maximum number of records to be returned by the server.
...
func (b BaseAdminRule) marshalInternal(discValue AdminRuleKind) map[string]interface{} {
	objectMap := b.ProxyResource.marshalInternal()
	b.Kind = &discValue
...
func (b *BaseAdminRule) unmarshalInternal(rawMsg map[string]json.RawMessage) error {
	for key, val := range rawMsg {
		var err error
		switch key {
		case "kind":
	...
	return b.ProxyResource.unmarshalInternal(rawMsg)
}

// BaseUserRuleClassification provides polymorphic access to related types.
// Call the interface's GetBaseUserRule() method to access the common type.
// Use a type switch to determine the concrete type.  The possible types are:
// - *BaseUserRule, *DefaultUserRule, *UserRule
type BaseUserRuleClassification interface {
	// GetBaseUserRule returns the BaseUserRule content of the underlying type.
	GetBaseUserRule() *BaseUserRule
}

// BaseUserRule - Network base rule.
type BaseUserRule struct {
	ProxyResource
	// REQUIRED; Whether the rule is custom or default.
	Kind *UserRuleKind `json:"kind,omitempty"`

	// READ-ONLY; The system metadata related to this resource.
	SystemData *SystemData `json:"systemData,omitempty" azure:"ro"`
}

// GetBaseUserRule implements the BaseUserRuleClassification interface for type BaseUserRule.
func (b *BaseUserRule) GetBaseUserRule() *BaseUserRule { return b }

// UnmarshalJSON implements the json.Unmarshaller interface for type BaseUserRule.
func (b *BaseUserRule) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return err
	}
...
func (b BaseUserRule) marshalInternal(discValue UserRuleKind) map[string]interface{} {
	objectMap := b.ProxyResource.marshalInternal()
	b.Kind = &discValue
	objectMap["kind"] = b.Kind
	populate(objectMap, "systemData", b.SystemData)
...
func (b *BaseUserRule) unmarshalInternal(rawMsg map[string]json.RawMessage) error {
	for key, val := range rawMsg {
		var err error
		switch key {
		case "kind":
...
// CloudErrorAutoGenerated - An error response from the service.
// Implements the error and azcore.HTTPResponse interfaces.
...
// CloudErrorBodyAutoGenerated - An error response from the service.
...
func (c *ConnectivityConfiguration) UnmarshalJSON(data []byte) error {
	...
	return c.ProxyResource.unmarshalInternal(rawMsg)
}

// ConnectivityConfigurationListResult - Result of the request to list network manager connectivity configurations. It contains a list of configurations
// and a link to get the next set of results.
...
// ConnectivityConfigurationsCreateOrUpdateOptions contains the optional parameters for the ConnectivityConfigurations.CreateOrUpdate method.
type ConnectivityConfigurationsCreateOrUpdateOptions struct {
	// placeholder for future optional parameters
}

// ConnectivityConfigurationsDeleteOptions contains the optional parameters for the ConnectivityConfigurations.Delete method.
type ConnectivityConfigurationsDeleteOptions struct {
	// placeholder for future optional parameters
}

// ConnectivityConfigurationsGetOptions contains the optional parameters for the ConnectivityConfigurations.Get method.
type ConnectivityConfigurationsGetOptions struct {
	// placeholder for future optional parameters
}

// ConnectivityConfigurationsListOptions contains the optional parameters for the ConnectivityConfigurations.List method.
type ConnectivityConfigurationsListOptions struct {
	// SkipToken is only used if a previous operation returned a partial result. If a previous response contains a nextLink element, the value of the nextLink
	// element will include a skipToken parameter that specifies a starting point to use for subsequent calls.
	SkipToken *string
	// An optional query parameter which specifies the maximum number of records to be returned by the server.
...
type DefaultAdminPropertiesFormat struct {
	...
	// READ-ONLY; A friendly name for the rule.
	DisplayName *string `json:"displayName,omitempty" azure:"ro"`

	// READ-ONLY; The priority of the rule. The value can be between 1 and 4096. The priority number must be unique for each rule in the collection. The lower
...
func (d DefaultAdminRule) MarshalJSON() ([]byte, error) {
	objectMap := d.BaseAdminRule.marshalInternal(AdminRuleKindDefault)
	populate(objectMap, "properties", d.Properties)
	return json.Marshal(objectMap)
}
...
func (d *DefaultAdminRule) UnmarshalJSON(data []byte) error {
	...
	return d.BaseAdminRule.unmarshalInternal(rawMsg)
}
...
// DefaultUserRule - Network security default user rule.
...
// MarshalJSON implements the json.Marshaller interface for type DefaultUserRule.
func (d DefaultUserRule) MarshalJSON() ([]byte, error) {
	objectMap := d.BaseUserRule.marshalInternal(UserRuleKindDefault)
	populate(objectMap, "properties", d.Properties)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type DefaultUserRule.
func (d *DefaultUserRule) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return err
	}
	...
	return d.BaseUserRule.unmarshalInternal(rawMsg)
}

// DefaultUserRulePropertiesFormat - Security default user rule resource.
type DefaultUserRulePropertiesFormat struct {
	// Default rule flag.
	Flag *string `json:"flag,omitempty"`
...
// MarshalJSON implements the json.Marshaller interface for type DefaultUserRulePropertiesFormat.
func (d DefaultUserRulePropertiesFormat) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "description", d.Description)
	populate(objectMap, "destinationPortRanges", d.DestinationPortRanges)
	populate(objectMap, "destinations", d.Destinations)
...
func (e EffectiveBaseSecurityAdminRule) marshalInternal(discValue EffectiveAdminRuleKind) map[string]interface{} {
	objectMap := make(map[string]interface{})
	populate(objectMap, "configurationDescription", e.ConfigurationDescription)
	populate(objectMap, "configurationDisplayName", e.ConfigurationDisplayName)
	...
	populate(objectMap, "ruleCollectionDisplayName", e.RuleCollectionDisplayName)
	populate(objectMap, "ruleGroups", e.RuleGroups)
	return objectMap
}

func (e *EffectiveBaseSecurityAdminRule) unmarshalInternal(rawMsg map[string]json.RawMessage) error {
	for key, val := range rawMsg {
		var err error
		switch key {
		case "configurationDescription":
			err = unpopulate(val, &e.ConfigurationDescription)
			delete(rawMsg, key)
		case "configurationDisplayName":
			err = unpopulate(val, &e.ConfigurationDisplayName)
			delete(rawMsg, key)
		case "id":
		...
		case "kind":
			...
			delete(rawMsg, key)
		case "ruleCollectionAppliesToGroups":
			err = unpopulate(val, &e.RuleCollectionAppliesToGroups)
			delete(rawMsg, key)
		case "ruleCollectionDescription":
			err = unpopulate(val, &e.RuleCollectionDescription)
			delete(rawMsg, key)
		case "ruleCollectionDisplayName":
			err = unpopulate(val, &e.RuleCollectionDisplayName)
			delete(rawMsg, key)
		case "ruleGroups":
			err = unpopulate(val, &e.RuleGroups)
			delete(rawMsg, key)
		}
		if err != nil {
			return err
...
func (e EffectiveConnectivityConfiguration) marshalInternal() map[string]interface{} {
	objectMap := make(map[string]interface{})
...
func (e *EffectiveConnectivityConfiguration) unmarshalInternal(rawMsg map[string]json.RawMessage) error {
	for key, val := range rawMsg {
		var err error
		switch key {
		case "configurationGroups":
			err = unpopulate(val, &e.ConfigurationGroups)
			delete(rawMsg, key)
		case "id":
			err = unpopulate(val, &e.ID)
			delete(rawMsg, key)
...
// EffectiveConnectivityConfigurationsListOptions contains the optional parameters for the EffectiveConnectivityConfigurations.List method.
type EffectiveConnectivityConfigurationsListOptions struct {
	// placeholder for future optional parameters
}
...
func (e EffectiveDefaultSecurityAdminRule) MarshalJSON() ([]byte, error) {
	objectMap := e.EffectiveBaseSecurityAdminRule.marshalInternal(EffectiveAdminRuleKindDefault)
	populate(objectMap, "properties", e.Properties)
	return json.Marshal(objectMap)
}
...
func (e *EffectiveDefaultSecurityAdminRule) UnmarshalJSON(data []byte) error {
	...
	return e.EffectiveBaseSecurityAdminRule.unmarshalInternal(rawMsg)
}
...
func (e EffectiveSecurityAdminRule) MarshalJSON() ([]byte, error) {
	objectMap := e.EffectiveBaseSecurityAdminRule.marshalInternal(EffectiveAdminRuleKindCustom)
	populate(objectMap, "properties", e.Properties)
	return json.Marshal(objectMap)
}
...
// EffectiveVirtualNetwork - Effective Virtual Network
type EffectiveVirtualNetwork struct {
	// Effective vnet Id.
	ID *string `json:"id,omitempty"`
...
// EffectiveVirtualNetworksListByNetworkGroupOptions contains the optional parameters for the EffectiveVirtualNetworks.ListByNetworkGroup method.
type EffectiveVirtualNetworksListByNetworkGroupOptions struct {
	// placeholder for future optional parameters
}

// EffectiveVirtualNetworksListByNetworkManagerOptions contains the optional parameters for the EffectiveVirtualNetworks.ListByNetworkManager method.
type EffectiveVirtualNetworksListByNetworkManagerOptions struct {
	// SkipToken is only used if a previous operation returned a partial result. If a previous response contains a nextLink element, the value of the nextLink
	// element will include a skipToken parameter that specifies a starting point to use for subsequent calls.
	SkipToken *string
	// An optional query parameter which specifies the maximum number of records to be returned by the server.
...
// EffectiveVirtualNetworksListResult - Result of the request to list Effective Virtual Network. It contains a list of groups and a URL link to get the
// next set of results.
type EffectiveVirtualNetworksListResult struct {
	// When present, the value can be passed to a subsequent query call (together with the same query and scopes used in the current request) to retrieve the
	// next page of data.
	SkipToken *string `json:"skipToken,omitempty"`

	// Gets a page of EffectiveVirtualNetwork
	Value []*EffectiveVirtualNetwork `json:"value,omitempty"`
}

// MarshalJSON implements the json.Marshaller interface for type EffectiveVirtualNetworksListResult.
func (e EffectiveVirtualNetworksListResult) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
...
// EffectiveVirtualNetworksParameter - Effective Virtual Networks Parameter.
type EffectiveVirtualNetworksParameter struct {
	// Conditional Members.
	ConditionalMembers *string `json:"conditionalMembers,omitempty"`
...
// GroupMembersItem - GroupMembers Item.
...
// NetworkGroup - The network group resource
...
// MarshalJSON implements the json.Marshaller interface for type NetworkGroup.
func (n NetworkGroup) MarshalJSON() ([]byte, error) {
	objectMap := n.ProxyResource.marshalInternal()
	populate(objectMap, "properties", n.Properties)
	populate(objectMap, "systemData", n.SystemData)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type NetworkGroup.
func (n *NetworkGroup) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return err
	}
	...
	return n.ProxyResource.unmarshalInternal(rawMsg)
}

// NetworkGroupListResult - Result of the request to list NetworkGroup. It contains a list of groups and a URL link to get the next set of results.
type NetworkGroupListResult struct {
	// Gets the URL to get the next set of results.
	NextLink *string `json:"nextLink,omitempty"`

	// Gets a page of NetworkGroup
	Value []*NetworkGroup `json:"value,omitempty"`
}

// MarshalJSON implements the json.Marshaller interface for type NetworkGroupListResult.
func (n NetworkGroupListResult) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "nextLink", n.NextLink)
	populate(objectMap, "value", n.Value)
	return json.Marshal(objectMap)
...
// NetworkGroupProperties - Properties of network group
type NetworkGroupProperties struct {
	// Network group conditional filter.
	ConditionalMembership *string `json:"conditionalMembership,omitempty"`
...
// MarshalJSON implements the json.Marshaller interface for type NetworkGroupProperties.
func (n NetworkGroupProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "conditionalMembership", n.ConditionalMembership)
	populate(objectMap, "description", n.Description)
	populate(objectMap, "displayName", n.DisplayName)
	populate(objectMap, "groupMembers", n.GroupMembers)
	populate(objectMap, "memberType", n.MemberType)
	populate(objectMap, "provisioningState", n.ProvisioningState)
	return json.Marshal(objectMap)
}

// NetworkGroupsCreateOrUpdateOptions contains the optional parameters for the NetworkGroups.CreateOrUpdate method.
type NetworkGroupsCreateOrUpdateOptions struct {
	// The ETag of the transformation. Omit this value to always overwrite the current resource. Specify the last-seen ETag value to prevent accidentally overwriting
	// concurrent changes.
	IfMatch *string
}

// NetworkGroupsDeleteOptions contains the optional parameters for the NetworkGroups.Delete method.
type NetworkGroupsDeleteOptions struct {
	// placeholder for future optional parameters
}

// NetworkGroupsGetOptions contains the optional parameters for the NetworkGroups.Get method.
type NetworkGroupsGetOptions struct {
	// placeholder for future optional parameters
}

// NetworkGroupsListOptions contains the optional parameters for the NetworkGroups.List method.
type NetworkGroupsListOptions struct {
	// SkipToken is only used if a previous operation returned a partial result. If a previous response contains a nextLink element, the value of the nextLink
	// element will include a skipToken parameter that specifies a starting point to use for subsequent calls.
	SkipToken *string
	// An optional query parameter which specifies the maximum number of records to be returned by the server.
...
// NetworkManager - The Managed Network resource
...
// MarshalJSON implements the json.Marshaller interface for type NetworkManager.
...
// NetworkManagerCommit - Network Manager Commit.
...
// MarshalJSON implements the json.Marshaller interface for type NetworkManagerCommit.
func (n NetworkManagerCommit) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "commitId", n.CommitID)
	populate(objectMap, "commitType", n.CommitType)
	populate(objectMap, "configurationIds", n.ConfigurationIDs)
	populate(objectMap, "targetLocations", n.TargetLocations)
	return json.Marshal(objectMap)
}

// NetworkManagerCommitsPostOptions contains the optional parameters for the NetworkManagerCommits.Post method.
type NetworkManagerCommitsPostOptions struct {
	// placeholder for future optional parameters
}

// NetworkManagerDeploymentStatus - Network Manager Deployment Status.
...
// MarshalJSON implements the json.Marshaller interface for type NetworkManagerDeploymentStatus.
func (n NetworkManagerDeploymentStatus) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "commitTime", (*timeRFC3339)(n.CommitTime))
	populate(objectMap, "configurationIds", n.ConfigurationIDs)
	populate(objectMap, "deploymentStatus", n.DeploymentStatus)
	populate(objectMap, "deploymentType", n.DeploymentType)
	populate(objectMap, "errorMessage", n.ErrorMessage)
	populate(objectMap, "region", n.Region)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type NetworkManagerDeploymentStatus.
func (n *NetworkManagerDeploymentStatus) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return err
	}
	for key, val := range rawMsg {
		...
		case "commitTime":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			n.CommitTime = (*time.Time)(&aux)
			delete(rawMsg, key)
		case "configurationIds":
			err = unpopulate(val, &n.ConfigurationIDs)
			delete(rawMsg, key)
		case "deploymentStatus":
			err = unpopulate(val, &n.DeploymentStatus)
			delete(rawMsg, key)
		case "deploymentType":
			err = unpopulate(val, &n.DeploymentType)
			delete(rawMsg, key)
		case "errorMessage":
			err = unpopulate(val, &n.ErrorMessage)
			delete(rawMsg, key)
		case "region":
...
// NetworkManagerDeploymentStatusListOptions contains the optional parameters for the NetworkManagerDeploymentStatus.List method.
type NetworkManagerDeploymentStatusListOptions struct {
	// placeholder for future optional parameters
}

// NetworkManagerDeploymentStatusListResult - A list of Network Manager Deployment Status
...
// MarshalJSON implements the json.Marshaller interface for type NetworkManagerDeploymentStatusListResult.
func (n NetworkManagerDeploymentStatusListResult) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "skipToken", n.SkipToken)
	populate(objectMap, "value", n.Value)
	return json.Marshal(objectMap)
}

// NetworkManagerDeploymentStatusParameter - Network Manager Deployment Status Parameter.
...
// MarshalJSON implements the json.Marshaller interface for type NetworkManagerDeploymentStatusParameter.
func (n NetworkManagerDeploymentStatusParameter) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "deploymentTypes", n.DeploymentTypes)
	populate(objectMap, "regions", n.Regions)
	populate(objectMap, "skipToken", n.SkipToken)
	return json.Marshal(objectMap)
}

// NetworkManagerEffectiveConnectivityConfigurationListResult - Result of the request to list networkManagerEffectiveConnectivityConfiguration. It contains
// a list of groups and a skiptoken to get the next set of results.
...
// MarshalJSON implements the json.Marshaller interface for type NetworkManagerEffectiveConnectivityConfigurationListResult.
func (n NetworkManagerEffectiveConnectivityConfigurationListResult) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "skipToken", n.SkipToken)
	populate(objectMap, "value", n.Value)
	return json.Marshal(objectMap)
...
// NetworkManagerEffectiveSecurityAdminRulesListOptions contains the optional parameters for the NetworkManagerEffectiveSecurityAdminRules.List method.
type NetworkManagerEffectiveSecurityAdminRulesListOptions struct {
	// placeholder for future optional parameters
}

// NetworkManagerEffectiveSecurityAdminRulesListResult - Result of the request to list networkManagerEffectiveSecurityAdminRules. It contains a list of
...
// MarshalJSON implements the json.Marshaller interface for type NetworkManagerEffectiveSecurityAdminRulesListResult.
func (n NetworkManagerEffectiveSecurityAdminRulesListResult) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "skipToken", n.SkipToken)
	populate(objectMap, "value", n.Value)
	return json.Marshal(objectMap)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type NetworkManagerEffectiveSecurityAdminRulesListResult.
func (n *NetworkManagerEffectiveSecurityAdminRulesListResult) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return err
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "skipToken":
			err = unpopulate(val, &n.SkipToken)
			delete(rawMsg, key)
		case "value":
			n.Value, err = unmarshalEffectiveBaseSecurityAdminRuleClassificationArray(val)
			delete(rawMsg, key)
		}
		if err != nil {
			return err
...
// NetworkManagerListResult - Result of the request to list NetworkManager. It contains a list of network managers and a URL link to get the next set of
// results.
type NetworkManagerListResult struct {
	// Gets the URL to get the next page of results.
	NextLink *string `json:"nextLink,omitempty"`

	// Gets a page of NetworkManager
	Value []*NetworkManager `json:"value,omitempty"`
}

// MarshalJSON implements the json.Marshaller interface for type NetworkManagerListResult.
func (n NetworkManagerListResult) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "nextLink", n.NextLink)
	populate(objectMap, "value", n.Value)
	return json.Marshal(objectMap)
...
// NetworkManagerProperties - Properties of Managed Network
type NetworkManagerProperties struct {
	...
	NetworkManagerScopes *NetworkManagerPropertiesNetworkManagerScopes `json:"networkManagerScopes,omitempty"`

	// READ-ONLY; The provisioning state of the scope assignment resource.
	ProvisioningState *ProvisioningState `json:"provisioningState,omitempty" azure:"ro"`
}

// MarshalJSON implements the json.Marshaller interface for type NetworkManagerProperties.
func (n NetworkManagerProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "description", n.Description)
	populate(objectMap, "displayName", n.DisplayName)
	populate(objectMap, "networkManagerScopeAccesses", n.NetworkManagerScopeAccesses)
	populate(objectMap, "networkManagerScopes", n.NetworkManagerScopes)
	populate(objectMap, "provisioningState", n.ProvisioningState)
	return json.Marshal(objectMap)
}

// NetworkManagerPropertiesNetworkManagerScopes - Scope of Network Manager.
...
// MarshalJSON implements the json.Marshaller interface for type NetworkManagerPropertiesNetworkManagerScopes.
func (n NetworkManagerPropertiesNetworkManagerScopes) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
...
// NetworkManagerSecurityGroupItem - Network manager security group item.
type NetworkManagerSecurityGroupItem struct {
	// Network manager group Id.
	NetworkGroupID *string `json:"networkGroupId,omitempty"`
}

// NetworkManagersCreateOrUpdateOptions contains the optional parameters for the NetworkManagers.CreateOrUpdate method.
type NetworkManagersCreateOrUpdateOptions struct {
	// placeholder for future optional parameters
}

// NetworkManagersDeleteOptions contains the optional parameters for the NetworkManagers.Delete method.
type NetworkManagersDeleteOptions struct {
	// placeholder for future optional parameters
}

// NetworkManagersGetOptions contains the optional parameters for the NetworkManagers.Get method.
type NetworkManagersGetOptions struct {
	// placeholder for future optional parameters
}

// NetworkManagersListBySubscriptionOptions contains the optional parameters for the NetworkManagers.ListBySubscription method.
type NetworkManagersListBySubscriptionOptions struct {
	// SkipToken is only used if a previous operation returned a partial result. If a previous response contains a nextLink element, the value of the nextLink
	// element will include a skipToken parameter that specifies a starting point to use for subsequent calls.
	SkipToken *string
	// An optional query parameter which specifies the maximum number of records to be returned by the server.
...
// NetworkManagersListOptions contains the optional parameters for the NetworkManagers.List method.
type NetworkManagersListOptions struct {
	// SkipToken is only used if a previous operation returned a partial result. If a previous response contains a nextLink element, the value of the nextLink
	// element will include a skipToken parameter that specifies a starting point to use for subsequent calls.
	SkipToken *string
	// An optional query parameter which specifies the maximum number of records to be returned by the server.
...
// NetworkManagersPatchTagsOptions contains the optional parameters for the NetworkManagers.PatchTags method.
type NetworkManagersPatchTagsOptions struct {
	// placeholder for future optional parameters
}
...
// NetworkSecurityPerimeterListResult - Result of the request to list NetworkSecurityPerimeter. It contains a list of network security perimeters and a
// URL link to get the next set of results.
type NetworkSecurityPerimeterListResult struct {
	// Gets the URL to get the next page of results.
	NextLink *string `json:"nextLink,omitempty"`

	// Gets a page of NetworkSecurityPerimeter
	Value []*NetworkSecurityPerimeter `json:"value,omitempty"`
}

// MarshalJSON implements the json.Marshaller interface for type NetworkSecurityPerimeterListResult.
func (n NetworkSecurityPerimeterListResult) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "nextLink", n.NextLink)
	populate(objectMap, "value", n.Value)
	return json.Marshal(objectMap)
...
// NetworkSecurityPerimeterProperties - Properties of network security perimeter.
...
// NetworkSecurityPerimetersCreateOrUpdateOptions contains the optional parameters for the NetworkSecurityPerimeters.CreateOrUpdate method.
type NetworkSecurityPerimetersCreateOrUpdateOptions struct {
	// placeholder for future optional parameters
}

// NetworkSecurityPerimetersDeleteOptions contains the optional parameters for the NetworkSecurityPerimeters.Delete method.
type NetworkSecurityPerimetersDeleteOptions struct {
	// placeholder for future optional parameters
}

// NetworkSecurityPerimetersGetOptions contains the optional parameters for the NetworkSecurityPerimeters.Get method.
type NetworkSecurityPerimetersGetOptions struct {
	// placeholder for future optional parameters
}

// NetworkSecurityPerimetersListBySubscriptionOptions contains the optional parameters for the NetworkSecurityPerimeters.ListBySubscription method.
type NetworkSecurityPerimetersListBySubscriptionOptions struct {
	// SkipToken is only used if a previous operation returned a partial result. If a previous response contains a nextLink element, the value of the nextLink
	// element will include a skipToken parameter that specifies a starting point to use for subsequent calls.
	SkipToken *string
	// An optional query parameter which specifies the maximum number of records to be returned by the server.
...
// NetworkSecurityPerimetersListOptions contains the optional parameters for the NetworkSecurityPerimeters.List method.
type NetworkSecurityPerimetersListOptions struct {
	// SkipToken is only used if a previous operation returned a partial result. If a previous response contains a nextLink element, the value of the nextLink
	// element will include a skipToken parameter that specifies a starting point to use for subsequent calls.
	SkipToken *string
	// An optional query parameter which specifies the maximum number of records to be returned by the server.
...
// PerimeterAssociableResource - Resource that is onboarded to use network security perimeter. Also referred as perimeter associable resource.
...
// MarshalJSON implements the json.Marshaller interface for type PerimeterAssociableResource.
func (p PerimeterAssociableResource) MarshalJSON() ([]byte, error) {
	objectMap := p.Resource.marshalInternal()
	populate(objectMap, "properties", p.Properties)
	return json.Marshal(objectMap)
}
...
type PerimeterAssociableResourceProperties struct {
	...
	PublicDNSZones []*string `json:"publicDnsZones,omitempty" azure:"ro"`

	// READ-ONLY; Resource type/provider name.
	ResourceType *string `json:"resourceType,omitempty" azure:"ro"`
}

// MarshalJSON implements the json.Marshaller interface for type PerimeterAssociableResourceProperties.
func (p PerimeterAssociableResourceProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "displayName", p.DisplayName)
	populate(objectMap, "publicDnsZones", p.PublicDNSZones)
	populate(objectMap, "resourceType", p.ResourceType)
	return json.Marshal(objectMap)
}

// PerimeterAssociableResourceTypesGetOptions contains the optional parameters for the PerimeterAssociableResourceTypes.Get method.
type PerimeterAssociableResourceTypesGetOptions struct {
	// placeholder for future optional parameters
}
...
type PerimeterAssociableResourcesListResult struct {
	...
	Value []*PerimeterAssociableResource `json:"value,omitempty"`
}

// MarshalJSON implements the json.Marshaller interface for type PerimeterAssociableResourcesListResult.
func (p PerimeterAssociableResourcesListResult) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "nextLink", p.NextLink)
	populate(objectMap, "value", p.Value)
	return json.Marshal(objectMap)
...
// RuleCollection - Defines the rule collection.
type RuleCollection struct {
	ProxyResource
	// Indicates the properties for the network manager rule collection.
	Properties *RuleCollectionPropertiesFormat `json:"properties,omitempty"`

	// READ-ONLY; The system metadata related to this resource.
	SystemData *SystemData `json:"systemData,omitempty" azure:"ro"`
}

// MarshalJSON implements the json.Marshaller interface for type RuleCollection.
func (r RuleCollection) MarshalJSON() ([]byte, error) {
...
// UnmarshalJSON implements the json.Unmarshaller interface for type RuleCollection.
func (r *RuleCollection) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return err
	}
	...
	return r.ProxyResource.unmarshalInternal(rawMsg)
}

// RuleCollectionListResult - Security configuration rule collection list result.
type RuleCollectionListResult struct {
	// Gets the URL to get the next set of results.
	NextLink *string `json:"nextLink,omitempty"`

	// A list of network manager security configuration rule collections
	Value []*RuleCollection `json:"value,omitempty"`
}

// MarshalJSON implements the json.Marshaller interface for type RuleCollectionListResult.
func (r RuleCollectionListResult) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "nextLink", r.NextLink)
	populate(objectMap, "value", r.Value)
	return json.Marshal(objectMap)
...
// RuleCollectionPropertiesFormat - Defines the rule collection properties.
type RuleCollectionPropertiesFormat struct {
	// Groups for configuration
	AppliesToGroups []*NetworkManagerSecurityGroupItem `json:"appliesToGroups,omitempty"`
...
// MarshalJSON implements the json.Marshaller interface for type RuleCollectionPropertiesFormat.
func (r RuleCollectionPropertiesFormat) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "appliesToGroups", r.AppliesToGroups)
...
// SecurityAdminConfigurationsCreateOrUpdateOptions contains the optional parameters for the SecurityAdminConfigurations.CreateOrUpdate method.
type SecurityAdminConfigurationsCreateOrUpdateOptions struct {
	// placeholder for future optional parameters
}

// SecurityAdminConfigurationsDeleteOptions contains the optional parameters for the SecurityAdminConfigurations.Delete method.
type SecurityAdminConfigurationsDeleteOptions struct {
	// placeholder for future optional parameters
}

// SecurityAdminConfigurationsGetOptions contains the optional parameters for the SecurityAdminConfigurations.Get method.
type SecurityAdminConfigurationsGetOptions struct {
	// placeholder for future optional parameters
}

// SecurityAdminConfigurationsListOptions contains the optional parameters for the SecurityAdminConfigurations.List method.
type SecurityAdminConfigurationsListOptions struct {
	// SkipToken is only used if a previous operation returned a partial result. If a previous response contains a nextLink element, the value of the nextLink
	// element will include a skipToken parameter that specifies a starting point to use for subsequent calls.
	SkipToken *string
	// An optional query parameter which specifies the maximum number of records to be returned by the server.
...
// SecurityConfiguration - Defines the security configuration
type SecurityConfiguration struct {
	ProxyResource
	// Indicates the properties for the network manager security Configuration.
	Properties *SecurityConfigurationPropertiesFormat `json:"properties,omitempty"`

	// READ-ONLY; The system metadata related to this resource.
	SystemData *SystemData `json:"systemData,omitempty" azure:"ro"`
}

// MarshalJSON implements the json.Marshaller interface for type SecurityConfiguration.
func (s SecurityConfiguration) MarshalJSON() ([]byte, error) {
...
// UnmarshalJSON implements the json.Unmarshaller interface for type SecurityConfiguration.
func (s *SecurityConfiguration) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return err
	}
	...
	return s.ProxyResource.unmarshalInternal(rawMsg)
}

// SecurityConfigurationListResult - A list of network manager security configurations
...
// MarshalJSON implements the json.Marshaller interface for type SecurityConfigurationListResult.
func (s SecurityConfigurationListResult) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
...
// SecurityConfigurationPropertiesFormat - Defines the security Configuration properties.
type SecurityConfigurationPropertiesFormat struct {
	// Flag if need to delete existing network security groups.
	DeleteExistingNSGs *DeleteExistingNSGs `json:"deleteExistingNSGs,omitempty"`
...
// SecurityUserConfigurationsCreateOrUpdateOptions contains the optional parameters for the SecurityUserConfigurations.CreateOrUpdate method.
type SecurityUserConfigurationsCreateOrUpdateOptions struct {
	// placeholder for future optional parameters
}

// SecurityUserConfigurationsDeleteOptions contains the optional parameters for the SecurityUserConfigurations.Delete method.
type SecurityUserConfigurationsDeleteOptions struct {
	// placeholder for future optional parameters
}

// SecurityUserConfigurationsGetOptions contains the optional parameters for the SecurityUserConfigurations.Get method.
type SecurityUserConfigurationsGetOptions struct {
	// placeholder for future optional parameters
}

// SecurityUserConfigurationsListOptions contains the optional parameters for the SecurityUserConfigurations.List method.
type SecurityUserConfigurationsListOptions struct {
	// SkipToken is only used if a previous operation returned a partial result. If a previous response contains a nextLink element, the value of the nextLink
	// element will include a skipToken parameter that specifies a starting point to use for subsequent calls.
	SkipToken *string
	// An optional query parameter which specifies the maximum number of records to be returned by the server.
...
// UserRule - Network security user rule.
...
// MarshalJSON implements the json.Marshaller interface for type UserRule.
func (u UserRule) MarshalJSON() ([]byte, error) {
	objectMap := u.BaseUserRule.marshalInternal(UserRuleKindCustom)
	populate(objectMap, "properties", u.Properties)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type UserRule.
func (u *UserRule) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return err
	}
	...
	return u.BaseUserRule.unmarshalInternal(rawMsg)
}

// UserRuleCollectionsCreateOrUpdateOptions contains the optional parameters for the UserRuleCollections.CreateOrUpdate method.
type UserRuleCollectionsCreateOrUpdateOptions struct {
	// placeholder for future optional parameters
}

// UserRuleCollectionsDeleteOptions contains the optional parameters for the UserRuleCollections.Delete method.
type UserRuleCollectionsDeleteOptions struct {
	// placeholder for future optional parameters
}

// UserRuleCollectionsGetOptions contains the optional parameters for the UserRuleCollections.Get method.
type UserRuleCollectionsGetOptions struct {
	// placeholder for future optional parameters
}

// UserRuleCollectionsListOptions contains the optional parameters for the UserRuleCollections.List method.
type UserRuleCollectionsListOptions struct {
	// SkipToken is only used if a previous operation returned a partial result. If a previous response contains a nextLink element, the value of the nextLink
	// element will include a skipToken parameter that specifies a starting point to use for subsequent calls.
	SkipToken *string
	// An optional query parameter which specifies the maximum number of records to be returned by the server.
...
// UserRuleListResult - security user rule list result.
type UserRuleListResult struct {
	// The URL to get the next set of results.
	NextLink *string `json:"nextLink,omitempty"`

	// A list of user rules
	Value []BaseUserRuleClassification `json:"value,omitempty"`
}

// MarshalJSON implements the json.Marshaller interface for type UserRuleListResult.
func (u UserRuleListResult) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "nextLink", u.NextLink)
	populate(objectMap, "value", u.Value)
	return json.Marshal(objectMap)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type UserRuleListResult.
func (u *UserRuleListResult) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return err
	}
	for key, val := range rawMsg {
		...
		case "nextLink":
			...
			delete(rawMsg, key)
		case "value":
			u.Value, err = unmarshalBaseUserRuleClassificationArray(val)
			delete(rawMsg, key)
		}
		if err != nil {
			return err
...
// UserRulePropertiesFormat - Security rule resource.
type UserRulePropertiesFormat struct {
	// REQUIRED; Indicates if the traffic matched against the rule in inbound or outbound.
	Direction *SecurityConfigurationRuleDirection `json:"direction,omitempty"`
...
// MarshalJSON implements the json.Marshaller interface for type UserRulePropertiesFormat.
func (u UserRulePropertiesFormat) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "description", u.Description)
	populate(objectMap, "destinationPortRanges", u.DestinationPortRanges)
	populate(objectMap, "destinations", u.Destinations)
	populate(objectMap, "direction", u.Direction)
	populate(objectMap, "displayName", u.DisplayName)
	populate(objectMap, "protocol", u.Protocol)
	populate(objectMap, "provisioningState", u.ProvisioningState)
	populate(objectMap, "sourcePortRanges", u.SourcePortRanges)
	populate(objectMap, "sources", u.Sources)
	return json.Marshal(objectMap)
}

// UserRulesCreateOrUpdateOptions contains the optional parameters for the UserRules.CreateOrUpdate method.
type UserRulesCreateOrUpdateOptions struct {
	// placeholder for future optional parameters
}

// UserRulesDeleteOptions contains the optional parameters for the UserRules.Delete method.
type UserRulesDeleteOptions struct {
	// placeholder for future optional parameters
}

// UserRulesGetOptions contains the optional parameters for the UserRules.Get method.
type UserRulesGetOptions struct {
	// placeholder for future optional parameters
}

// UserRulesListOptions contains the optional parameters for the UserRules.List method.
type UserRulesListOptions struct {
	// SkipToken is only used if a previous operation returned a partial result. If a previous response contains a nextLink element, the value of the nextLink
	// element will include a skipToken parameter that specifies a starting point to use for subsequent calls.
	SkipToken *string
	// An optional query parameter which specifies the maximum number of records to be returned by the server.
