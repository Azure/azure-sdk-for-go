...
// AdminRuleCollectionsListPager provides operations for iterating over paged responses.
type AdminRuleCollectionsListPager struct {
	client    *AdminRuleCollectionsClient
	current   AdminRuleCollectionsListResponse
	err       error
	requester func(context.Context) (*policy.Request, error)
	advancer  func(context.Context, AdminRuleCollectionsListResponse) (*policy.Request, error)
}

// Err returns the last error encountered while paging.
func (p *AdminRuleCollectionsListPager) Err() error {
	return p.err
}

// NextPage returns true if the pager advanced to the next page.
// Returns false if there are no more pages or an error occurred.
func (p *AdminRuleCollectionsListPager) NextPage(ctx context.Context) bool {
	var req *policy.Request
	var err error
	if !reflect.ValueOf(p.current).IsZero() {
		if p.current.RuleCollectionListResult.NextLink == nil || len(*p.current.RuleCollectionListResult.NextLink) == 0 {
			return false
		}
...
// PageResponse returns the current AdminRuleCollectionsListResponse page.
func (p *AdminRuleCollectionsListPager) PageResponse() AdminRuleCollectionsListResponse {
	return p.current
}

// AdminRulesListPager provides operations for iterating over paged responses.
type AdminRulesListPager struct {
	client    *AdminRulesClient
	current   AdminRulesListResponse
	err       error
	requester func(context.Context) (*policy.Request, error)
	advancer  func(context.Context, AdminRulesListResponse) (*policy.Request, error)
}

// Err returns the last error encountered while paging.
func (p *AdminRulesListPager) Err() error {
	return p.err
}

// NextPage returns true if the pager advanced to the next page.
// Returns false if there are no more pages or an error occurred.
func (p *AdminRulesListPager) NextPage(ctx context.Context) bool {
	var req *policy.Request
	var err error
	if !reflect.ValueOf(p.current).IsZero() {
		if p.current.AdminRuleListResult.NextLink == nil || len(*p.current.AdminRuleListResult.NextLink) == 0 {
			return false
		}
		req, err = p.advancer(ctx, p.current)
	} else {
...
// PageResponse returns the current AdminRulesListResponse page.
func (p *AdminRulesListPager) PageResponse() AdminRulesListResponse {
	return p.current
}
...
// ConnectivityConfigurationsListPager provides operations for iterating over paged responses.
type ConnectivityConfigurationsListPager struct {
	client    *ConnectivityConfigurationsClient
	current   ConnectivityConfigurationsListResponse
	err       error
	requester func(context.Context) (*policy.Request, error)
	advancer  func(context.Context, ConnectivityConfigurationsListResponse) (*policy.Request, error)
}

// Err returns the last error encountered while paging.
func (p *ConnectivityConfigurationsListPager) Err() error {
	return p.err
}

// NextPage returns true if the pager advanced to the next page.
// Returns false if there are no more pages or an error occurred.
func (p *ConnectivityConfigurationsListPager) NextPage(ctx context.Context) bool {
	var req *policy.Request
	var err error
	if !reflect.ValueOf(p.current).IsZero() {
		if p.current.ConnectivityConfigurationListResult.NextLink == nil || len(*p.current.ConnectivityConfigurationListResult.NextLink) == 0 {
			return false
		}
		req, err = p.advancer(ctx, p.current)
	} else {
...
// PageResponse returns the current ConnectivityConfigurationsListResponse page.
func (p *ConnectivityConfigurationsListPager) PageResponse() ConnectivityConfigurationsListResponse {
	return p.current
}
...
// NetworkGroupsListPager provides operations for iterating over paged responses.
type NetworkGroupsListPager struct {
	client    *NetworkGroupsClient
	current   NetworkGroupsListResponse
	err       error
	requester func(context.Context) (*policy.Request, error)
	advancer  func(context.Context, NetworkGroupsListResponse) (*policy.Request, error)
}

// Err returns the last error encountered while paging.
func (p *NetworkGroupsListPager) Err() error {
	return p.err
}

// NextPage returns true if the pager advanced to the next page.
// Returns false if there are no more pages or an error occurred.
func (p *NetworkGroupsListPager) NextPage(ctx context.Context) bool {
	var req *policy.Request
	var err error
	if !reflect.ValueOf(p.current).IsZero() {
		if p.current.NetworkGroupListResult.NextLink == nil || len(*p.current.NetworkGroupListResult.NextLink) == 0 {
			return false
		}
		req, err = p.advancer(ctx, p.current)
	} else {
...
// PageResponse returns the current NetworkGroupsListResponse page.
func (p *NetworkGroupsListPager) PageResponse() NetworkGroupsListResponse {
	return p.current
}
...
// NetworkManagersListBySubscriptionPager provides operations for iterating over paged responses.
type NetworkManagersListBySubscriptionPager struct {
	client    *NetworkManagersClient
	current   NetworkManagersListBySubscriptionResponse
	err       error
	requester func(context.Context) (*policy.Request, error)
	advancer  func(context.Context, NetworkManagersListBySubscriptionResponse) (*policy.Request, error)
}

// Err returns the last error encountered while paging.
func (p *NetworkManagersListBySubscriptionPager) Err() error {
	return p.err
}

// NextPage returns true if the pager advanced to the next page.
// Returns false if there are no more pages or an error occurred.
func (p *NetworkManagersListBySubscriptionPager) NextPage(ctx context.Context) bool {
	var req *policy.Request
	var err error
	if !reflect.ValueOf(p.current).IsZero() {
		if p.current.NetworkManagerListResult.NextLink == nil || len(*p.current.NetworkManagerListResult.NextLink) == 0 {
			return false
		}
		req, err = p.advancer(ctx, p.current)
	} else {
...
// PageResponse returns the current NetworkManagersListBySubscriptionResponse page.
func (p *NetworkManagersListBySubscriptionPager) PageResponse() NetworkManagersListBySubscriptionResponse {
	return p.current
}

// NetworkManagersListPager provides operations for iterating over paged responses.
type NetworkManagersListPager struct {
	client    *NetworkManagersClient
	current   NetworkManagersListResponse
	err       error
	requester func(context.Context) (*policy.Request, error)
	advancer  func(context.Context, NetworkManagersListResponse) (*policy.Request, error)
}

// Err returns the last error encountered while paging.
func (p *NetworkManagersListPager) Err() error {
	return p.err
}

// NextPage returns true if the pager advanced to the next page.
// Returns false if there are no more pages or an error occurred.
func (p *NetworkManagersListPager) NextPage(ctx context.Context) bool {
	var req *policy.Request
	var err error
	if !reflect.ValueOf(p.current).IsZero() {
		if p.current.NetworkManagerListResult.NextLink == nil || len(*p.current.NetworkManagerListResult.NextLink) == 0 {
...
// PageResponse returns the current NetworkManagersListResponse page.
func (p *NetworkManagersListPager) PageResponse() NetworkManagersListResponse {
	return p.current
}
...
// NetworkSecurityPerimetersListBySubscriptionPager provides operations for iterating over paged responses.
type NetworkSecurityPerimetersListBySubscriptionPager struct {
	client    *NetworkSecurityPerimetersClient
	current   NetworkSecurityPerimetersListBySubscriptionResponse
	err       error
	requester func(context.Context) (*policy.Request, error)
	advancer  func(context.Context, NetworkSecurityPerimetersListBySubscriptionResponse) (*policy.Request, error)
}

// Err returns the last error encountered while paging.
func (p *NetworkSecurityPerimetersListBySubscriptionPager) Err() error {
	return p.err
}

// NextPage returns true if the pager advanced to the next page.
// Returns false if there are no more pages or an error occurred.
func (p *NetworkSecurityPerimetersListBySubscriptionPager) NextPage(ctx context.Context) bool {
	var req *policy.Request
	var err error
	if !reflect.ValueOf(p.current).IsZero() {
		if p.current.NetworkSecurityPerimeterListResult.NextLink == nil || len(*p.current.NetworkSecurityPerimeterListResult.NextLink) == 0 {
			return false
		}
		req, err = p.advancer(ctx, p.current)
	} else {
...
// PageResponse returns the current NetworkSecurityPerimetersListBySubscriptionResponse page.
func (p *NetworkSecurityPerimetersListBySubscriptionPager) PageResponse() NetworkSecurityPerimetersListBySubscriptionResponse {
	return p.current
}

// NetworkSecurityPerimetersListPager provides operations for iterating over paged responses.
type NetworkSecurityPerimetersListPager struct {
	client    *NetworkSecurityPerimetersClient
	current   NetworkSecurityPerimetersListResponse
	err       error
	requester func(context.Context) (*policy.Request, error)
	advancer  func(context.Context, NetworkSecurityPerimetersListResponse) (*policy.Request, error)
}

// Err returns the last error encountered while paging.
func (p *NetworkSecurityPerimetersListPager) Err() error {
	return p.err
}

// NextPage returns true if the pager advanced to the next page.
// Returns false if there are no more pages or an error occurred.
func (p *NetworkSecurityPerimetersListPager) NextPage(ctx context.Context) bool {
	var req *policy.Request
	var err error
	if !reflect.ValueOf(p.current).IsZero() {
		if p.current.NetworkSecurityPerimeterListResult.NextLink == nil || len(*p.current.NetworkSecurityPerimeterListResult.NextLink) == 0 {
...
// PageResponse returns the current NetworkSecurityPerimetersListResponse page.
func (p *NetworkSecurityPerimetersListPager) PageResponse() NetworkSecurityPerimetersListResponse {
	return p.current
}
...
// SecurityAdminConfigurationsListPager provides operations for iterating over paged responses.
type SecurityAdminConfigurationsListPager struct {
	client    *SecurityAdminConfigurationsClient
	current   SecurityAdminConfigurationsListResponse
	err       error
	requester func(context.Context) (*policy.Request, error)
	advancer  func(context.Context, SecurityAdminConfigurationsListResponse) (*policy.Request, error)
}

// Err returns the last error encountered while paging.
func (p *SecurityAdminConfigurationsListPager) Err() error {
	return p.err
}

// NextPage returns true if the pager advanced to the next page.
// Returns false if there are no more pages or an error occurred.
func (p *SecurityAdminConfigurationsListPager) NextPage(ctx context.Context) bool {
	var req *policy.Request
	var err error
	if !reflect.ValueOf(p.current).IsZero() {
		if p.current.SecurityConfigurationListResult.NextLink == nil || len(*p.current.SecurityConfigurationListResult.NextLink) == 0 {
			return false
		}
		req, err = p.advancer(ctx, p.current)
	} else {
...
// PageResponse returns the current SecurityAdminConfigurationsListResponse page.
func (p *SecurityAdminConfigurationsListPager) PageResponse() SecurityAdminConfigurationsListResponse {
	return p.current
}
...
// SecurityUserConfigurationsListPager provides operations for iterating over paged responses.
type SecurityUserConfigurationsListPager struct {
	client    *SecurityUserConfigurationsClient
	current   SecurityUserConfigurationsListResponse
	err       error
	requester func(context.Context) (*policy.Request, error)
	advancer  func(context.Context, SecurityUserConfigurationsListResponse) (*policy.Request, error)
}

// Err returns the last error encountered while paging.
func (p *SecurityUserConfigurationsListPager) Err() error {
	return p.err
}

// NextPage returns true if the pager advanced to the next page.
// Returns false if there are no more pages or an error occurred.
func (p *SecurityUserConfigurationsListPager) NextPage(ctx context.Context) bool {
	var req *policy.Request
	var err error
	if !reflect.ValueOf(p.current).IsZero() {
		if p.current.SecurityConfigurationListResult.NextLink == nil || len(*p.current.SecurityConfigurationListResult.NextLink) == 0 {
...
// PageResponse returns the current SecurityUserConfigurationsListResponse page.
func (p *SecurityUserConfigurationsListPager) PageResponse() SecurityUserConfigurationsListResponse {
	return p.current
}
...
// UserRuleCollectionsListPager provides operations for iterating over paged responses.
type UserRuleCollectionsListPager struct {
	client    *UserRuleCollectionsClient
	current   UserRuleCollectionsListResponse
	err       error
	requester func(context.Context) (*policy.Request, error)
	advancer  func(context.Context, UserRuleCollectionsListResponse) (*policy.Request, error)
}

// Err returns the last error encountered while paging.
func (p *UserRuleCollectionsListPager) Err() error {
	return p.err
}

// NextPage returns true if the pager advanced to the next page.
// Returns false if there are no more pages or an error occurred.
func (p *UserRuleCollectionsListPager) NextPage(ctx context.Context) bool {
	var req *policy.Request
	var err error
	if !reflect.ValueOf(p.current).IsZero() {
		if p.current.RuleCollectionListResult.NextLink == nil || len(*p.current.RuleCollectionListResult.NextLink) == 0 {
...
// PageResponse returns the current UserRuleCollectionsListResponse page.
func (p *UserRuleCollectionsListPager) PageResponse() UserRuleCollectionsListResponse {
	return p.current
}

// UserRulesListPager provides operations for iterating over paged responses.
type UserRulesListPager struct {
	client    *UserRulesClient
	current   UserRulesListResponse
	err       error
	requester func(context.Context) (*policy.Request, error)
	advancer  func(context.Context, UserRulesListResponse) (*policy.Request, error)
}

// Err returns the last error encountered while paging.
func (p *UserRulesListPager) Err() error {
	return p.err
}

// NextPage returns true if the pager advanced to the next page.
// Returns false if there are no more pages or an error occurred.
func (p *UserRulesListPager) NextPage(ctx context.Context) bool {
	var req *policy.Request
	var err error
	if !reflect.ValueOf(p.current).IsZero() {
		if p.current.UserRuleListResult.NextLink == nil || len(*p.current.UserRuleListResult.NextLink) == 0 {
			return false
		}
		req, err = p.advancer(ctx, p.current)
	} else {
...
// PageResponse returns the current UserRulesListResponse page.
func (p *UserRulesListPager) PageResponse() UserRulesListResponse {
	return p.current
}
