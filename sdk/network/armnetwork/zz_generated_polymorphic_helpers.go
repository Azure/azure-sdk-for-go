...
func unmarshalActiveBaseSecurityUserRuleClassification(rawMsg json.RawMessage) (ActiveBaseSecurityUserRuleClassification, error) {
	if rawMsg == nil {
		return nil, nil
	}
	var m map[string]interface{}
	...
	var b ActiveBaseSecurityUserRuleClassification
	switch m["kind"] {
	case string(EffectiveUserRuleKindCustom):
		b = &ActiveSecurityUserRule{}
	case string(EffectiveUserRuleKindDefault):
		b = &ActiveDefaultSecurityUserRule{}
	default:
		b = &ActiveBaseSecurityUserRule{}
	}
	return b, json.Unmarshal(rawMsg, b)
}

func unmarshalActiveBaseSecurityUserRuleClassificationArray(rawMsg json.RawMessage) ([]ActiveBaseSecurityUserRuleClassification, error) {
	if rawMsg == nil {
		return nil, nil
	}
	var rawMessages []json.RawMessage
	...
	fArray := make([]ActiveBaseSecurityUserRuleClassification, len(rawMessages))
	for index, rawMessage := range rawMessages {
		f, err := unmarshalActiveBaseSecurityUserRuleClassification(rawMessage)
		if err != nil {
			return nil, err
		}
		fArray[index] = f
...
func unmarshalBaseUserRuleClassification(rawMsg json.RawMessage) (BaseUserRuleClassification, error) {
	if rawMsg == nil {
		return nil, nil
	}
	var m map[string]interface{}
	...
	var b BaseUserRuleClassification
	switch m["kind"] {
	case string(UserRuleKindCustom):
		b = &UserRule{}
	case string(UserRuleKindDefault):
		b = &DefaultUserRule{}
	default:
		b = &BaseUserRule{}
	}
...
func unmarshalBaseUserRuleClassificationArray(rawMsg json.RawMessage) ([]BaseUserRuleClassification, error) {
	if rawMsg == nil {
		return nil, nil
	}
	var rawMessages []json.RawMessage
	...
	fArray := make([]BaseUserRuleClassification, len(rawMessages))
	for index, rawMessage := range rawMessages {
		f, err := unmarshalBaseUserRuleClassification(rawMessage)
		if err != nil {
			return nil, err
		}
		fArray[index] = f
