...
func NewVirtualNetworkSubnetUsageClient(con *arm.Connection, subscriptionID string) *VirtualNetworkSubnetUsageClient {
	return &VirtualNetworkSubnetUsageClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
