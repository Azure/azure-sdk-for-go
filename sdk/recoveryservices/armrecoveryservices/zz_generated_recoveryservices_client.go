...
// If the operation fails it returns the *CloudError error type.
func (client *RecoveryServicesClient) GetOperationResult(ctx context.Context, resourceGroupName string, vaultName string, operationID string, options *RecoveryServicesGetOperationResultOptions) (RecoveryServicesGetOperationResultResponse, error) {
	req, err := client.getOperationResultCreateRequest(ctx, resourceGroupName, vaultName, operationID, options)
	if err != nil {
		return RecoveryServicesGetOperationResultResponse{}, err
	}
	resp, err := client.pl.Do(req)
	if err != nil {
		return RecoveryServicesGetOperationResultResponse{}, err
	...
	if !runtime.HasStatusCode(resp, http.StatusOK, http.StatusAccepted) {
		return RecoveryServicesGetOperationResultResponse{}, client.getOperationResultHandleError(resp)
	}
...
func (client *RecoveryServicesClient) getOperationResultCreateRequest(ctx context.Context, resourceGroupName string, vaultName string, operationID string, options *RecoveryServicesGetOperationResultOptions) (*policy.Request, error) {
...
func (client *RecoveryServicesClient) getOperationResultHandleResponse(resp *http.Response) (RecoveryServicesGetOperationResultResponse, error) {
	result := RecoveryServicesGetOperationResultResponse{RawResponse: resp}
...
// If the operation fails it returns the *CloudError error type.
func (client *RecoveryServicesClient) GetOperationStatus(ctx context.Context, resourceGroupName string, vaultName string, operationID string, options *RecoveryServicesGetOperationStatusOptions) (RecoveryServicesGetOperationStatusResponse, error) {
	req, err := client.getOperationStatusCreateRequest(ctx, resourceGroupName, vaultName, operationID, options)
	if err != nil {
		return RecoveryServicesGetOperationStatusResponse{}, err
	}
	resp, err := client.pl.Do(req)
	if err != nil {
		return RecoveryServicesGetOperationStatusResponse{}, err
	...
	if !runtime.HasStatusCode(resp, http.StatusOK) {
		return RecoveryServicesGetOperationStatusResponse{}, client.getOperationStatusHandleError(resp)
	}
...
func (client *RecoveryServicesClient) getOperationStatusCreateRequest(ctx context.Context, resourceGroupName string, vaultName string, operationID string, options *RecoveryServicesGetOperationStatusOptions) (*policy.Request, error) {
...
func (client *RecoveryServicesClient) getOperationStatusHandleResponse(resp *http.Response) (RecoveryServicesGetOperationStatusResponse, error) {
	result := RecoveryServicesGetOperationStatusResponse{RawResponse: resp}
