...
```go
clientFactory, err := armadvisor.NewClientFactory(<resourceURI>, <subscription ID>, cred, nil)
```
...
clientFactory, err := armadvisor.NewClientFactory(<resourceURI>, <subscription ID>, cred, &options)
```
