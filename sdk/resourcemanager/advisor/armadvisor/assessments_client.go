...
// Delete - Delete an existing Azure Advisor assessment.
...
func (client *AssessmentsClient) Delete(ctx context.Context, assessmentName string, options *AssessmentsClientDeleteOptions) (AssessmentsClientDeleteResponse, error) {
	...
	if !runtime.HasStatusCode(httpResp, http.StatusOK, http.StatusNoContent) {
		return AssessmentsClientDeleteResponse{}, runtime.NewResponseError(httpResp)
	}
...
// Get - Get an existing Azure Advisor assessment.
// If the operation fails it returns an *azcore.ResponseError type.
//   - assessmentName - Advisor assessment name.
...
// NewListPager - Get list of Azure Advisor assessments.
...
func (client *AssessmentsClient) listCreateRequest(ctx context.Context, nextLink string, options *AssessmentsClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
// Put - Create or Overwrite Azure Advisor assessment.
// If the operation fails it returns an *azcore.ResponseError type.
//   - assessmentName - Advisor assessment name.
...
func (client *AssessmentsClient) putHandleResponse(resp *http.Response, successCodes ...int) (AssessmentsClientPutResponse, error) {
