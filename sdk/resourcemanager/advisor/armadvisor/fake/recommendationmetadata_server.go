...
func (r *RecommendationMetadataServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	resultChan := make(chan result, 1)
	go func() {
		var intercepted bool
		var res result
		if recommendationMetadataServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = recommendationMetadataServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
func (r *RecommendationMetadataServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	const regexStr = `/providers/Microsoft\.Advisor/metadata/(?P<name>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)`
...
// set this to conditionally intercept incoming requests to RecommendationMetadataServerTransport
var recommendationMetadataServerTransportInterceptor interface {
