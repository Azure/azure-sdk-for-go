...
type RecommendationsServer struct {
	...
	// HTTP status codes to indicate success: http.StatusOK
	NewListByTenantPager func(options *armadvisor.RecommendationsClientListByTenantOptions) (resp azfake.PagerResponder[armadvisor.RecommendationsClientListByTenantResponse])
