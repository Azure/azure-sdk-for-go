...
func ExampleManagementClient_Predict() {
	...
	res, err := clientFactory.NewManagementClient().Predict(ctx, armadvisor.PredictionRequest{
	...
	// res = armadvisor.ManagementClientPredictResponse{
