...
func (p PredictionResponseProperties) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "lastUpdated", p.LastUpdated, true)
	populate(objectMap, "predictionType", p.PredictionType)
...
func (r RecommendationProperties) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "lastUpdated", r.LastUpdated, true)
...
func (s SuppressionProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateTime[datetime.RFC3339](objectMap, "expirationTimeStamp", s.ExpirationTimeStamp, true)
...
func (t TrackedRecommendationProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateTime[datetime.RFC3339](objectMap, "postponedTime", t.PostponedTime, true)
