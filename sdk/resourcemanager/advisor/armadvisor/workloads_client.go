...
// NewListPager - Get Workloads list.
//
...
func (client *WorkloadsClient) listCreateRequest(ctx context.Context, nextLink string, _ *WorkloadsClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *WorkloadsClient) listHandleResponse(resp *http.Response, successCodes ...int) (WorkloadsClientListResponse, error) {
