...
// The returned PrivateEndpointConnectionsServerTransport instance is connected to an instance of armagrifood.PrivateEndpointConnectionsClient via the
...
func (p *PrivateEndpointConnectionsServerTransport) dispatchCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[armagrifood.PrivateEndpointConnection](req)
	if err != nil {
		return nil, err
	}
