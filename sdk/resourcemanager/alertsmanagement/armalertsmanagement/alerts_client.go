...
// and 'vm1' is deleted then if you
// want to change state of this particular alert then use parent resource of scope. So in this example change state call will
// look like this:
...
// GetByID - Get information related to a specific alert. If scope is a deleted resource then please use scope as parent resource
// of the delete resource. For example if my alert id is
// '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroup}/providers/Microsoft.Compute/virtualMachines/vm1/providers/Microsoft.AlertsManagement/alerts/{alertId}'
// and 'vm1' is deleted then if you
// want to get alert by id then use parent resource of scope. So in this example get alert by id call will look like this:
// '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroup}/providers/Microsoft.AlertsManagement/alerts/{alertId}'.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2025-05-25-preview
...
// GetByIDTenant - Get information related to a specific alert.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2025-05-25-preview
//   - alertID - Unique ID of an alert instance.
...
func (client *AlertsClient) NewGetEnrichmentsPager(alertID string, options *AlertsClientGetEnrichmentsOptions) *runtime.Pager[AlertsClientGetEnrichmentsResponse] {
	return runtime.NewPager(runtime.PagingHandler[AlertsClientGetEnrichmentsResponse]{
		...
		Fetcher: func(ctx context.Context, page *AlertsClientGetEnrichmentsResponse) (AlertsClientGetEnrichmentsResponse, error) {
			...
			req, err := client.getEnrichmentsCreateRequest(ctx, alertID, options)
			if err != nil {
			...
			if !runtime.HasStatusCode(resp, http.StatusOK) {
				return AlertsClientGetEnrichmentsResponse{}, runtime.NewResponseError(resp)
			}
...
// (New/Acknowledged/Closed) and applied action rules for that particular alert. If scope
// is a deleted resource then please use scope as parent resource of the delete resource. For example if my alert id is
// '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroup}/providers/Microsoft.Compute/virtualMachines/vm1/providers/Microsoft.AlertsManagement/alerts/{alertId}'
// and 'vm1' is deleted then if you
// want to get history of this particular alert then use parent resource of scope. So in this example get history call will
// look like this:
