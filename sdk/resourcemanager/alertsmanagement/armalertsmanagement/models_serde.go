...
func (a AlertsMetaDataProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "metadataIdentifier", a.MetadataIdentifier)
	return json.Marshal(objectMap)
}
...
func (e Essentials) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "lastModifiedDateTime", e.LastModifiedDateTime, true)
	populate(objectMap, "lastModifiedUserName", e.LastModifiedUserName)
	populate(objectMap, "monitorCondition", e.MonitorCondition)
	populateTime[datetime.RFC3339](objectMap, "monitorConditionResolvedDateTime", e.MonitorConditionResolvedDateTime, true)
	...
	populateTime[datetime.RFC3339](objectMap, "startDateTime", e.StartDateTime, true)
...
func (e *Essentials) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "lastModifiedDateTime":
			err = unpopulateTime[datetime.RFC3339](val, "LastModifiedDateTime", &e.LastModifiedDateTime)
			delete(rawMsg, key)
		...
		case "monitorConditionResolvedDateTime":
			err = unpopulateTime[datetime.RFC3339](val, "MonitorConditionResolvedDateTime", &e.MonitorConditionResolvedDateTime)
			delete(rawMsg, key)
		case "monitorService":
		...
		case "sourceCreatedId":
			...
			delete(rawMsg, key)
		case "startDateTime":
			err = unpopulateTime[datetime.RFC3339](val, "StartDateTime", &e.StartDateTime)
			delete(rawMsg, key)
		case "targetResource":
...
func (p PrometheusEnrichmentItem) MarshalJSON() ([]byte, error) {
	...
	objectMap["type"] = TypePrometheusEnrichmentItem
	return json.Marshal(objectMap)
}
...
func (p PrometheusRangeQuery) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "datasources", p.Datasources)
	populate(objectMap, "description", p.Description)
	populateTime[datetime.RFC3339](objectMap, "end", p.End, true)
	populate(objectMap, "errorMessage", p.ErrorMessage)
	populate(objectMap, "grafanaExplorePath", p.GrafanaExplorePath)
	populate(objectMap, "linkToApi", p.LinkToAPI)
	populate(objectMap, "query", p.Query)
	populateTime[datetime.RFC3339](objectMap, "start", p.Start, true)
	populate(objectMap, "status", p.Status)
...
func (p *PrometheusRangeQuery) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "description":
			...
			delete(rawMsg, key)
		case "end":
			err = unpopulateTime[datetime.RFC3339](val, "End", &p.End)
			delete(rawMsg, key)
		case "errorMessage":
			err = unpopulate(val, "ErrorMessage", &p.ErrorMessage)
			delete(rawMsg, key)
		...
		case "query":
			...
			delete(rawMsg, key)
		case "start":
			err = unpopulateTime[datetime.RFC3339](val, "Start", &p.Start)
			delete(rawMsg, key)
		case "status":
			err = unpopulate(val, "Status", &p.Status)
			delete(rawMsg, key)
