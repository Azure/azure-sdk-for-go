...
func (e Essentials) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "lastModifiedDateTime", e.LastModifiedDateTime)
	populate(objectMap, "lastModifiedUserName", e.LastModifiedUserName)
	populate(objectMap, "monitorCondition", e.MonitorCondition)
	populateTime[datetime.RFC3339](objectMap, "monitorConditionResolvedDateTime", e.MonitorConditionResolvedDateTime)
	...
	populateTime[datetime.RFC3339](objectMap, "startDateTime", e.StartDateTime)
...
func (p PrometheusRangeQuery) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "datasources", p.Datasources)
	populate(objectMap, "description", p.Description)
	populateTime[datetime.RFC3339](objectMap, "end", p.End)
	populate(objectMap, "errorMessage", p.ErrorMessage)
	populate(objectMap, "grafanaExplorePath", p.GrafanaExplorePath)
	populate(objectMap, "linkToApi", p.LinkToAPI)
	populate(objectMap, "query", p.Query)
	populateTime[datetime.RFC3339](objectMap, "start", p.Start)
	populate(objectMap, "status", p.Status)
