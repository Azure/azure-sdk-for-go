...
// Generated from example definition: 2025-05-25-preview/Operations_List.json
func ExampleOperationsClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armalertsmanagement.OperationsClientListResponse{
		// 	OperationListResult: armalertsmanagement.OperationListResult{
