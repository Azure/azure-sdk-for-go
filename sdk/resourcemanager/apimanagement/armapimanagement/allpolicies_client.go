...
func (client *AllPoliciesClient) listByServiceCreateRequest(ctx context.Context, resourceGroupName string, serviceName string, nextLink string, _ *AllPoliciesClientListByServiceOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *AllPoliciesClient) listByServiceHandleResponse(resp *http.Response, successCodes ...int) (AllPoliciesClientListByServiceResponse, error) {
