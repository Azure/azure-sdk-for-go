...
const defaultAPIGatewayClientVersion string = "2025-09-01-preview"
...
func (client *APIGatewayClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, gatewayName string, parameters GatewayResource, _ *APIGatewayClientBeginCreateOrUpdateOptions) (*policy.Request, error) {
	...
	reqQP.Set("api-version", defaultAPIGatewayClientVersion)
...
func (client *APIGatewayClient) listCreateRequest(ctx context.Context, options *APIGatewayClientListOptions) (*policy.Request, error) {
...
func (client *APIGatewayClient) listByResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, options *APIGatewayClientListByResourceGroupOptions) (*policy.Request, error) {
