...
func (client *APIGatewayClient) getHandleResponse(resp *http.Response, successCodes ...int) (APIGatewayClientGetResponse, error) {
...
func (client *APIGatewayClient) listCreateRequest(ctx context.Context, nextLink string, options *APIGatewayClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *APIGatewayClient) listHandleResponse(resp *http.Response, successCodes ...int) (APIGatewayClientListResponse, error) {
...
func (client *APIGatewayClient) listByResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, nextLink string, options *APIGatewayClientListByResourceGroupOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
	var req *policy.Request
	var err error
	if firstPage {
...
func (client *APIGatewayClient) listByResourceGroupHandleResponse(resp *http.Response, successCodes ...int) (APIGatewayClientListByResourceGroupResponse, error) {
