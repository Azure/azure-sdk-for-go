...
func (client *APIGatewayConfigConnectionClient) getHandleResponse(resp *http.Response, successCodes ...int) (APIGatewayConfigConnectionClientGetResponse, error) {
...
func (client *APIGatewayConfigConnectionClient) listByGatewayCreateRequest(ctx context.Context, resourceGroupName string, gatewayName string, nextLink string, options *APIGatewayConfigConnectionClientListByGatewayOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *APIGatewayConfigConnectionClient) listByGatewayHandleResponse(resp *http.Response, successCodes ...int) (APIGatewayConfigConnectionClientListByGatewayResponse, error) {
