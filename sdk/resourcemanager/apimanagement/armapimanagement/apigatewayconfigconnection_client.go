...
const defaultAPIGatewayConfigConnectionClientVersion string = "2025-09-01-preview"
...
func (client *APIGatewayConfigConnectionClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, gatewayName string, configConnectionName string, parameters GatewayConfigConnectionResource, _ *APIGatewayConfigConnectionClientBeginCreateOrUpdateOptions) (*policy.Request, error) {
	...
	reqQP.Set("api-version", defaultAPIGatewayConfigConnectionClientVersion)
...
func (client *APIGatewayConfigConnectionClient) listByGatewayCreateRequest(ctx context.Context, resourceGroupName string, gatewayName string, options *APIGatewayConfigConnectionClientListByGatewayOptions) (*policy.Request, error) {
