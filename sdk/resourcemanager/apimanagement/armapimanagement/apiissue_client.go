...
func (client *APIIssueClient) createOrUpdateHandleResponse(resp *http.Response, successCodes ...int) (APIIssueClientCreateOrUpdateResponse, error) {
...
func (client *APIIssueClient) Delete(ctx context.Context, resourceGroupName string, serviceName string, apiID string, issueID string, ifMatch string, options *APIIssueClientDeleteOptions) (APIIssueClientDeleteResponse, error) {
	...
	if !runtime.HasStatusCode(httpResp, http.StatusOK, http.StatusNoContent) {
		return APIIssueClientDeleteResponse{}, runtime.NewResponseError(httpResp)
	}
...
func (client *APIIssueClient) getHandleResponse(resp *http.Response, successCodes ...int) (APIIssueClientGetResponse, error) {
...
func (client *APIIssueClient) getEntityTagHandleResponse(resp *http.Response, successCodes ...int) (APIIssueClientGetEntityTagResponse, error) {
...
func (client *APIIssueClient) listByServiceCreateRequest(ctx context.Context, resourceGroupName string, serviceName string, apiID string, nextLink string, options *APIIssueClientListByServiceOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *APIIssueClient) listByServiceHandleResponse(resp *http.Response, successCodes ...int) (APIIssueClientListByServiceResponse, error) {
...
func (client *APIIssueClient) updateHandleResponse(resp *http.Response, successCodes ...int) (APIIssueClientUpdateResponse, error) {
