...
func (testsuite *ApimauthorizationserversTestSuite) SetupSuite() {
	...
	testsuite.authsid = testutil.GenerateAlphaNumericID(testsuite.T(), "authsid", 6)
	testsuite.serviceName = testutil.GenerateAlphaNumericID(testsuite.T(), "serviceauth", 6)
