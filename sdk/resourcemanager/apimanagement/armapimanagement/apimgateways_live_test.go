...
func (testsuite *ApimgatewaysTestSuite) SetupSuite() {
	...
	testsuite.gatewayId = testutil.GenerateAlphaNumericID(testsuite.T(), "gatewayid", 6)
	testsuite.hcId = testutil.GenerateAlphaNumericID(testsuite.T(), "hcid", 6)
	testsuite.serviceName = testutil.GenerateAlphaNumericID(testsuite.T(), "servicegateway", 6)
