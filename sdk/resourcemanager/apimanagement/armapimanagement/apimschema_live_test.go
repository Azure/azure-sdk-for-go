...
func (testsuite *ApimschemaTestSuite) SetupSuite() {
	...
	testsuite.schemaId = testutil.GenerateAlphaNumericID(testsuite.T(), "globalschemaid", 6)
	testsuite.serviceName = testutil.GenerateAlphaNumericID(testsuite.T(), "serviceschema", 6)
