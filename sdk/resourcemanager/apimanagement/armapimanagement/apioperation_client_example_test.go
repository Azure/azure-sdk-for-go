...
// Generated from example definition: 2025-09-01-preview/ApiManagementCreateApiOperation.json
func ExampleAPIOperationClient_CreateOrUpdate() {
	...
	// res = armapimanagement.APIOperationClientCreateOrUpdateResponse{
...
// Generated from example definition: 2025-09-01-preview/ApiManagementDeleteApiOperation.json
func ExampleAPIOperationClient_Delete() {
	...
	res, err := clientFactory.NewAPIOperationClient().Delete(ctx, "rg1", "apimService1", "57d2ef278aa04f0888cba3f3", "57d2ef278aa04f0ad01d6cdc", "*", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.APIOperationClientDeleteResponse{
	// }
}

// Generated from example definition: 2025-09-01-preview/ApiManagementGetApiOperation.json
func ExampleAPIOperationClient_Get_apiManagementGetApiOperation() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.APIOperationClientGetResponse{
	// 	OperationContract: armapimanagement.OperationContract{
...
// Generated from example definition: 2025-09-01-preview/ApiManagementGetApiOperationPetStore.json
...
// Generated from example definition: 2025-09-01-preview/ApiManagementHeadApiOperation.json
func ExampleAPIOperationClient_GetEntityTag() {
	...
	res, err := clientFactory.NewAPIOperationClient().GetEntityTag(ctx, "rg1", "apimService1", "57d2ef278aa04f0888cba3f3", "57d2ef278aa04f0ad01d6cdc", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.APIOperationClientGetEntityTagResponse{
	// }
}

// Generated from example definition: 2025-09-01-preview/ApiManagementListApiOperations.json
func ExampleAPIOperationClient_NewListByAPIPager() {
	...
	pager := clientFactory.NewAPIOperationClient().NewListByAPIPager("rg1", "apimService1", "57d2ef278aa04f0888cba3f3", nil)
	for pager.More() {
		...
		// page = armapimanagement.APIOperationClientListByAPIResponse{
...
// Generated from example definition: 2025-09-01-preview/ApiManagementUpdateApiOperation.json
func ExampleAPIOperationClient_Update() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.APIOperationClientUpdateResponse{
	// 	OperationContract: armapimanagement.OperationContract{
	// 		Name: to.Ptr("57d2ef278aa04f0ad01d6cdc"),
	// 		Type: to.Ptr("Microsoft.ApiManagement/service/apis/operations"),
	// 		ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.ApiManagement/service/apimService1/apis/57d2ef278aa04f0888cba3f3/operations/57d2ef278aa04f0ad01d6cdc"),
