...
func (client *APIProductClient) NewListByApisPager(resourceGroupName string, serviceName string, apiID string, options *APIProductClientListByApisOptions) *runtime.Pager[APIProductClientListByApisResponse] {
	return runtime.NewPager(runtime.PagingHandler[APIProductClientListByApisResponse]{
		...
		Fetcher: func(ctx context.Context, page *APIProductClientListByApisResponse) (APIProductClientListByApisResponse, error) {
			...
			req, err := client.listByApisCreateRequest(ctx, resourceGroupName, serviceName, apiID, nextLink, options)
			if err != nil {
			...
			return client.listByApisHandleResponse(resp, http.StatusOK)
		},
...
func (client *APIProductClient) listByApisCreateRequest(ctx context.Context, resourceGroupName string, serviceName string, apiID string, nextLink string, options *APIProductClientListByApisOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *APIProductClient) listByApisHandleResponse(resp *http.Response, successCodes ...int) (APIProductClientListByApisResponse, error) {
