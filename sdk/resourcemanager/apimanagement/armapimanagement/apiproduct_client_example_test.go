...
// Generated from example definition: 2025-09-01-preview/ApiManagementListApiProducts.json
func ExampleAPIProductClient_NewListByApisPager() {
	...
	pager := clientFactory.NewAPIProductClient().NewListByApisPager("rg1", "apimService1", "57d2ef278aa04f0888cba3f3", nil)
	for pager.More() {
		...
		// page = armapimanagement.APIProductClientListByApisResponse{
