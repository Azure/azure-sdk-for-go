...
// Generated from example definition: 2025-09-01-preview/ApiManagementCreateApiRelease.json
func ExampleAPIReleaseClient_CreateOrUpdate() {
	...
	// res = armapimanagement.APIReleaseClientCreateOrUpdateResponse{
...
// Generated from example definition: 2025-09-01-preview/ApiManagementDeleteApiRelease.json
func ExampleAPIReleaseClient_Delete() {
	...
	res, err := clientFactory.NewAPIReleaseClient().Delete(ctx, "rg1", "apimService1", "5a5fcc09124a7fa9b89f2f1d", "testrev", "*", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.APIReleaseClientDeleteResponse{
	// }
}

// Generated from example definition: 2025-09-01-preview/ApiManagementGetApiRelease.json
func ExampleAPIReleaseClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.APIReleaseClientGetResponse{
	// 	APIReleaseContract: armapimanagement.APIReleaseContract{
...
// Generated from example definition: 2025-09-01-preview/ApiManagementHeadApiRelease.json
func ExampleAPIReleaseClient_GetEntityTag() {
	...
	res, err := clientFactory.NewAPIReleaseClient().GetEntityTag(ctx, "rg1", "apimService1", "a1", "5a7cb545298324c53224a799", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.APIReleaseClientGetEntityTagResponse{
	// }
}

// Generated from example definition: 2025-09-01-preview/ApiManagementListApiReleases.json
func ExampleAPIReleaseClient_NewListByServicePager() {
	...
	pager := clientFactory.NewAPIReleaseClient().NewListByServicePager("rg1", "apimService1", "a1", nil)
	for pager.More() {
		...
		// page = armapimanagement.APIReleaseClientListByServiceResponse{
...
// Generated from example definition: 2025-09-01-preview/ApiManagementUpdateApiRelease.json
func ExampleAPIReleaseClient_Update() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.APIReleaseClientUpdateResponse{
	// 	APIReleaseContract: armapimanagement.APIReleaseContract{
	// 		Name: to.Ptr("testrev"),
	// 		Type: to.Ptr("Microsoft.ApiManagement/service/apis/releases"),
	// 		ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.ApiManagement/service/apimService1/apis/a1/releases/testrev"),
