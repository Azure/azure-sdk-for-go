...
func (client *APIRevisionClient) listByServiceCreateRequest(ctx context.Context, resourceGroupName string, serviceName string, apiID string, nextLink string, options *APIRevisionClientListByServiceOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *APIRevisionClient) listByServiceHandleResponse(resp *http.Response, successCodes ...int) (APIRevisionClientListByServiceResponse, error) {
