...
func (client *APITagDescriptionClient) createOrUpdateHandleResponse(resp *http.Response, successCodes ...int) (APITagDescriptionClientCreateOrUpdateResponse, error) {
...
func (client *APITagDescriptionClient) Delete(ctx context.Context, resourceGroupName string, serviceName string, apiID string, tagDescriptionID string, ifMatch string, options *APITagDescriptionClientDeleteOptions) (APITagDescriptionClientDeleteResponse, error) {
	...
	if !runtime.HasStatusCode(httpResp, http.StatusOK, http.StatusNoContent) {
		return APITagDescriptionClientDeleteResponse{}, runtime.NewResponseError(httpResp)
	}
...
func (client *APITagDescriptionClient) getHandleResponse(resp *http.Response, successCodes ...int) (APITagDescriptionClientGetResponse, error) {
...
func (client *APITagDescriptionClient) getEntityTagHandleResponse(resp *http.Response, successCodes ...int) (APITagDescriptionClientGetEntityTagResponse, error) {
...
func (client *APITagDescriptionClient) listByServiceCreateRequest(ctx context.Context, resourceGroupName string, serviceName string, apiID string, nextLink string, options *APITagDescriptionClientListByServiceOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *APITagDescriptionClient) listByServiceHandleResponse(resp *http.Response, successCodes ...int) (APITagDescriptionClientListByServiceResponse, error) {
