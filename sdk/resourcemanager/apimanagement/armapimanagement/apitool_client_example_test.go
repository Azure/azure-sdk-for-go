...
// Generated from example definition: 2025-09-01-preview/ApiManagementDeleteApiTool.json
func ExampleAPIToolClient_Delete() {
	...
	res, err := clientFactory.NewAPIToolClient().Delete(ctx, "rg1", "apimService1", "57d2ef278aa04f0888cba3f3", "57d2ef278aa04f0ad01d6cdc", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.APIToolClientDeleteResponse{
	// }
}
...
// Generated from example definition: 2025-09-01-preview/ApiManagementHeadApiTool.json
func ExampleAPIToolClient_GetEntityTag() {
	...
	res, err := clientFactory.NewAPIToolClient().GetEntityTag(ctx, "rg1", "apimService1", "57d2ef278aa04f0888cba3f3", "57d2ef278aa04f0ad01d6cdc", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.APIToolClientGetEntityTagResponse{
	// }
}
...
// Generated from example definition: 2025-09-01-preview/ApiManagementUpdateApiTool.json
func ExampleAPIToolClient_Update() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.APIToolClientUpdateResponse{
	// 	ToolContract: armapimanagement.ToolContract{
	// 		Name: to.Ptr("createIssue"),
	// 		Type: to.Ptr("Microsoft.ApiManagement/service/apis/tools"),
