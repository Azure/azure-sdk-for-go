...
// Generated from example definition: 2025-09-01-preview/ApiManagementDeleteApiVersionSet.json
func ExampleAPIVersionSetClient_Delete() {
	...
	res, err := clientFactory.NewAPIVersionSetClient().Delete(ctx, "rg1", "apimService1", "a1", "*", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.APIVersionSetClientDeleteResponse{
	// }
}

// Generated from example definition: 2025-09-01-preview/ApiManagementGetApiVersionSet.json
func ExampleAPIVersionSetClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.APIVersionSetClientGetResponse{
	// 	APIVersionSetContract: armapimanagement.APIVersionSetContract{
	// 		Name: to.Ptr("vs1"),
	// 		Type: to.Ptr("Microsoft.ApiManagement/service/api-version-sets"),
...
// Generated from example definition: 2025-09-01-preview/ApiManagementHeadApiVersionSet.json
func ExampleAPIVersionSetClient_GetEntityTag() {
	...
	res, err := clientFactory.NewAPIVersionSetClient().GetEntityTag(ctx, "rg1", "apimService1", "vs1", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.APIVersionSetClientGetEntityTagResponse{
	// }
}

// Generated from example definition: 2025-09-01-preview/ApiManagementListApiVersionSets.json
func ExampleAPIVersionSetClient_NewListByServicePager() {
	...
	pager := clientFactory.NewAPIVersionSetClient().NewListByServicePager("rg1", "apimService1", nil)
	for pager.More() {
		...
		// page = armapimanagement.APIVersionSetClientListByServiceResponse{
...
// Generated from example definition: 2025-09-01-preview/ApiManagementUpdateApiVersionSet.json
func ExampleAPIVersionSetClient_Update() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.APIVersionSetClientUpdateResponse{
	// 	APIVersionSetContract: armapimanagement.APIVersionSetContract{
	// 		Name: to.Ptr("vs1"),
	// 		Type: to.Ptr("Microsoft.ApiManagement/service/api-version-sets"),
	// 		ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.ApiManagement/service/apimService1/apiVersionSets/vs1"),
