...
func (client *APIWikisClient) NewListPager(resourceGroupName string, serviceName string, apiID string, options *APIWikisClientListOptions) *runtime.Pager[APIWikisClientListResponse] {
	return runtime.NewPager(runtime.PagingHandler[APIWikisClientListResponse]{
		...
		Fetcher: func(ctx context.Context, page *APIWikisClientListResponse) (APIWikisClientListResponse, error) {
			...
			req, err := client.listCreateRequest(ctx, resourceGroupName, serviceName, apiID, nextLink, options)
			if err != nil {
...
func (client *APIWikisClient) listCreateRequest(ctx context.Context, resourceGroupName string, serviceName string, apiID string, nextLink string, options *APIWikisClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *APIWikisClient) listHandleResponse(resp *http.Response, successCodes ...int) (APIWikisClientListResponse, error) {
