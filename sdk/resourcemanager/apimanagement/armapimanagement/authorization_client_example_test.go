...
// Generated from example definition: 2025-09-01-preview/ApiManagementPostAuthorizationConfirmConsentCodeRequest.json
func ExampleAuthorizationClient_ConfirmConsentCode() {
	...
	res, err := clientFactory.NewAuthorizationClient().ConfirmConsentCode(ctx, "rg1", "apimService1", "aadwithauthcode", "authz1", armapimanagement.AuthorizationConfirmConsentCodeRequestContract{
	...
	// res = armapimanagement.AuthorizationClientConfirmConsentCodeResponse{
	// }
}

// Generated from example definition: 2025-09-01-preview/ApiManagementCreateAuthorizationAADAuthCode.json
...
// Generated from example definition: 2025-09-01-preview/ApiManagementDeleteAuthorization.json
func ExampleAuthorizationClient_Delete() {
	...
	res, err := clientFactory.NewAuthorizationClient().Delete(ctx, "rg1", "apimService1", "aadwithauthcode", "authz1", "*", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.AuthorizationClientDeleteResponse{
	// }
}

// Generated from example definition: 2025-09-01-preview/ApiManagementGetAuthorization.json
func ExampleAuthorizationClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.AuthorizationClientGetResponse{
	// 	AuthorizationContract: armapimanagement.AuthorizationContract{
	// 		Name: to.Ptr("authz1"),
	// 		Type: to.Ptr("Microsoft.ApiManagement/service/authorizationProviders/authorizations"),
...
// Generated from example definition: 2025-09-01-preview/ApiManagementListAuthorizationsClientCred.json
func ExampleAuthorizationClient_NewListByAuthorizationProviderPager_apiManagementListAuthorizationsClientCred() {
	...
	pager := clientFactory.NewAuthorizationClient().NewListByAuthorizationProviderPager("rg1", "apimService1", "aadwithclientcred", nil)
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
