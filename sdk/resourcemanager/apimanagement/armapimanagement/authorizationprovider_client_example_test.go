...
// Generated from example definition: 2025-09-01-preview/ApiManagementCreateAuthorizationProviderAADAuthCode.json
...
func ExampleAuthorizationProviderClient_CreateOrUpdate_apiManagementCreateAuthorizationProviderAadAuthCodeWithKeyVault() {
	...
	// 						TimeStampUTC: to.Ptr(time.Date(2025, time.September, 8, 10, 30, 45, 123456700, time.UTC)),
	// 					},
	// 					SecretIdentifier: to.Ptr("https://my.vault.azure.net/secrets/clientSecret"),
	// 					Updated: to.Ptr(time.Date(2025, time.September, 8, 10, 30, 45, 123456700, time.UTC)),
	// 				},
	// 				RedirectURL: to.Ptr("https://authorization-manager.consent.azure-apim.net/redirect/apim/apimService1"),
	// 			},
	// 		},
...
// Generated from example definition: 2025-09-01-preview/ApiManagementCreateAuthorizationProviderAADClientCred.json
...
// Generated from example definition: 2025-09-01-preview/ApiManagementCreateAuthorizationProviderGenericOAuth2.json
...
// Generated from example definition: 2025-09-01-preview/ApiManagementCreateAuthorizationProviderOOBGoogle.json
...
// Generated from example definition: 2025-09-01-preview/ApiManagementDeleteAuthorizationProvider.json
func ExampleAuthorizationProviderClient_Delete() {
	...
	res, err := clientFactory.NewAuthorizationProviderClient().Delete(ctx, "rg1", "apimService1", "aadwithauthcode", "*", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.AuthorizationProviderClientDeleteResponse{
	// }
}

// Generated from example definition: 2025-09-01-preview/ApiManagementGetAuthorizationProvider.json
func ExampleAuthorizationProviderClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.AuthorizationProviderClientGetResponse{
	// 	AuthorizationProviderContract: armapimanagement.AuthorizationProviderContract{
	// 		Name: to.Ptr("aadwithauthcode"),
	// 		Type: to.Ptr("Microsoft.ApiManagement/service/authorizationProviders"),
	// 		ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.ApiManagement/service/apimService1/authorizationProviders/aadwithauthcode"),
