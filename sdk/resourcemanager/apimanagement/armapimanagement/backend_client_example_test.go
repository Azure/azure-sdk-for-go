...
// Generated from example definition: 2025-09-01-preview/ApiManagamentCreateBackendWithCustomAssignedCertificate_Thumbprints.json
...
// Generated from example definition: 2025-09-01-preview/ApiManagementCreateBackendProxyBackend.json
...
// Generated from example definition: 2025-09-01-preview/ApiManagementCreateBackendServiceFabric.json
...
// Generated from example definition: 2025-09-01-preview/ApiManagementCreateBackendWithCustomAssignedCertificate_X509Names.json
...
// Generated from example definition: 2025-09-01-preview/ApiManagementCreateBackendWithWeightedLoadBalancer.json
...
// Generated from example definition: 2025-09-01-preview/ApiManagementDeleteBackend.json
func ExampleBackendClient_Delete() {
	...
	res, err := clientFactory.NewBackendClient().Delete(ctx, "rg1", "apimService1", "sfbackend", "*", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.BackendClientDeleteResponse{
	// }
}

// Generated from example definition: 2025-09-01-preview/ApiManagementGetBackend.json
func ExampleBackendClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.BackendClientGetResponse{
	// 	BackendContract: armapimanagement.BackendContract{
	// 		Name: to.Ptr("sfbackend"),
	// 		Type: to.Ptr("Microsoft.ApiManagement/service/backends"),
	// 		ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.ApiManagement/service/apimService1/backends/sfbackend"),
...
// Generated from example definition: 2025-09-01-preview/ApiManagementHeadBackend.json
func ExampleBackendClient_GetEntityTag() {
	...
	res, err := clientFactory.NewBackendClient().GetEntityTag(ctx, "rg1", "apimService1", "sfbackend", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.BackendClientGetEntityTagResponse{
	// }
}
...
// Generated from example definition: 2025-09-01-preview/ApiManagementUpdateBackend.json
func ExampleBackendClient_Update() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.BackendClientUpdateResponse{
	// 	BackendContract: armapimanagement.BackendContract{
	// 		Name: to.Ptr("proxybackend"),
	// 		Type: to.Ptr("Microsoft.ApiManagement/service/backends"),
	// 		ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.ApiManagement/service/apimService1/backends/proxybackend"),
