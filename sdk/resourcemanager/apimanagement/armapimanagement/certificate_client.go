...
func (client *CertificateClient) createOrUpdateHandleResponse(resp *http.Response, successCodes ...int) (CertificateClientCreateOrUpdateResponse, error) {
...
func (client *CertificateClient) Delete(ctx context.Context, resourceGroupName string, serviceName string, certificateID string, ifMatch string, options *CertificateClientDeleteOptions) (CertificateClientDeleteResponse, error) {
	...
	if !runtime.HasStatusCode(httpResp, http.StatusOK, http.StatusNoContent) {
		return CertificateClientDeleteResponse{}, runtime.NewResponseError(httpResp)
	}
...
func (client *CertificateClient) getHandleResponse(resp *http.Response, successCodes ...int) (CertificateClientGetResponse, error) {
...
func (client *CertificateClient) getEntityTagHandleResponse(resp *http.Response, successCodes ...int) (CertificateClientGetEntityTagResponse, error) {
...
func (client *CertificateClient) listByServiceCreateRequest(ctx context.Context, resourceGroupName string, serviceName string, nextLink string, options *CertificateClientListByServiceOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *CertificateClient) listByServiceHandleResponse(resp *http.Response, successCodes ...int) (CertificateClientListByServiceResponse, error) {
...
func (client *CertificateClient) refreshSecretHandleResponse(resp *http.Response, successCodes ...int) (CertificateClientRefreshSecretResponse, error) {
