...
// Generated from example definition: 2025-09-01-preview/ApiManagementCreateCertificate.json
func ExampleCertificateClient_CreateOrUpdate_apiManagementCreateCertificate() {
	...
	// res = armapimanagement.CertificateClientCreateOrUpdateResponse{
...
// Generated from example definition: 2025-09-01-preview/ApiManagementCreateCertificateWithKeyVault.json
...
// Generated from example definition: 2025-09-01-preview/ApiManagementDeleteCertificate.json
func ExampleCertificateClient_Delete() {
	...
	res, err := clientFactory.NewCertificateClient().Delete(ctx, "rg1", "apimService1", "tempcert", "*", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.CertificateClientDeleteResponse{
	// }
}

// Generated from example definition: 2025-09-01-preview/ApiManagementGetCertificate.json
func ExampleCertificateClient_Get_apiManagementGetCertificate() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.CertificateClientGetResponse{
	// 	CertificateContract: armapimanagement.CertificateContract{
...
// Generated from example definition: 2025-09-01-preview/ApiManagementGetCertificateWithKeyVault.json
...
// Generated from example definition: 2025-09-01-preview/ApiManagementHeadCertificate.json
func ExampleCertificateClient_GetEntityTag() {
	...
	res, err := clientFactory.NewCertificateClient().GetEntityTag(ctx, "rg1", "apimService1", "templateCert1", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.CertificateClientGetEntityTagResponse{
	// }
}

// Generated from example definition: 2025-09-01-preview/ApiManagementListCertificates.json
func ExampleCertificateClient_NewListByServicePager() {
	...
	pager := clientFactory.NewCertificateClient().NewListByServicePager("rg1", "apimService1", nil)
	for pager.More() {
		...
		// page = armapimanagement.CertificateClientListByServiceResponse{
...
// Generated from example definition: 2025-09-01-preview/ApiManagementRefreshCertificate.json
func ExampleCertificateClient_RefreshSecret() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.CertificateClientRefreshSecretResponse{
	// 	CertificateContract: armapimanagement.CertificateContract{
	// 		Name: to.Ptr("templateCertkv"),
	// 		Type: to.Ptr("Microsoft.ApiManagement/service/certificates"),
	// 		ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.ApiManagement/service/apimService1/certificates/templateCertkv"),
