...
// Generated from example definition: 2025-09-01-preview/ApiManagementDeleteClientApplication.json
func ExampleClientApplicationClient_Delete() {
	...
	res, err := clientFactory.NewClientApplicationClient().Delete(ctx, "rg1", "apimService1", "testAppId", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.ClientApplicationClientDeleteResponse{
	// }
}

// Generated from example definition: 2025-09-01-preview/ApiManagementGetClientApplication.json
func ExampleClientApplicationClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.ClientApplicationClientGetResponse{
	// 	ClientApplicationContract: armapimanagement.ClientApplicationContract{
	// 		Name: to.Ptr("testAppId"),
	// 		Type: to.Ptr("Microsoft.ApiManagement/service/clientApplications"),
	// 		ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.ApiManagement/service/apimService1/clientApplications/testAppId"),
...
// Generated from example definition: 2025-09-01-preview/ApiManagementHeadClientApplication.json
func ExampleClientApplicationClient_GetEntityTag() {
	...
	res, err := clientFactory.NewClientApplicationClient().GetEntityTag(ctx, "rg1", "apimService1", "testAppId", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.ClientApplicationClientGetEntityTagResponse{
	// }
}
...
// Generated from example definition: 2025-09-01-preview/ApiManagementListClientApplicationSecrets.json
func ExampleClientApplicationClient_ListSecrets() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.ClientApplicationClientListSecretsResponse{
