...
const (
	...
	// APITypeMcp - Model Context Protocol API.
...
// traffic flow by routing to regions that have carbon emission less than or equal to the specified category. However, when
// all other backends are not available it will route traffic to these regions anyway. This requires the backend to be attributed
...
// Value is optional but must be 'Enabled' or 'Disabled'. If 'Disabled', legacy Configuration API (v1) will not be available
// for self-hosted gateways. Default value is 'Enabled'
...
// McpTransportType - Transport type for Model Context Protocol API.
type McpTransportType string

const (
	// McpTransportTypeSse - This API uses HTTP+SSE transport type.
	McpTransportTypeSse McpTransportType = "sse"
	// McpTransportTypeStreamable - This API uses the Streamable HTTP transport type.
	McpTransportTypeStreamable McpTransportType = "streamable"
)

// PossibleMcpTransportTypeValues returns the possible values for the McpTransportType const type.
func PossibleMcpTransportTypeValues() []McpTransportType {
	return []McpTransportType{
		McpTransportTypeSse,
		McpTransportTypeStreamable,
	}
}
...
// but if passed in, must be 'Enabled' or 'Disabled'. If 'Disabled', private endpoints are the exclusive access method. Default
// value is 'Enabled'
...
const (
	...
	// SoapAPITypeMCP - Imports the API having a Model Context Protocol (MCP) front end.
	SoapAPITypeMCP SoapAPIType = "mcp"
