...
// validation rules, and constraints. Custom content types' identifiers need to start with the `c-` prefix. Built-in content
// types can't be modified.
...
func (client *ContentTypeClient) createOrUpdateHandleResponse(resp *http.Response, successCodes ...int) (ContentTypeClientCreateOrUpdateResponse, error) {
...
// rules, and constraints. Built-in content types (with identifiers starting with the `c-` prefix) can't be removed.
// If the operation fails it returns an *azcore.ResponseError type.
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - serviceName - The name of the API Management service.
//   - contentTypeID - Content type identifier.
...
func (client *ContentTypeClient) Delete(ctx context.Context, resourceGroupName string, serviceName string, contentTypeID string, ifMatch string, options *ContentTypeClientDeleteOptions) (ContentTypeClientDeleteResponse, error) {
	...
	if !runtime.HasStatusCode(httpResp, http.StatusOK, http.StatusNoContent) {
		return ContentTypeClientDeleteResponse{}, runtime.NewResponseError(httpResp)
	}
...
func (client *ContentTypeClient) getHandleResponse(resp *http.Response, successCodes ...int) (ContentTypeClientGetResponse, error) {
...
func (client *ContentTypeClient) listByServiceCreateRequest(ctx context.Context, resourceGroupName string, serviceName string, nextLink string, _ *ContentTypeClientListByServiceOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *ContentTypeClient) listByServiceHandleResponse(resp *http.Response, successCodes ...int) (ContentTypeClientListByServiceResponse, error) {
