...
// Generated from example definition: 2025-09-01-preview/ApiManagementGetDeletedServiceByName.json
func ExampleDeletedServicesClient_GetByName() {
	...
	// res = armapimanagement.DeletedServicesClientGetByNameResponse{
	// 	DeletedServiceContract: armapimanagement.DeletedServiceContract{
...
// Generated from example definition: 2025-09-01-preview/ApiManagementDeletedServicesListBySubscription.json
func ExampleDeletedServicesClient_NewListBySubscriptionPager() {
	...
	for pager.More() {
		...
		// page = armapimanagement.DeletedServicesClientListBySubscriptionResponse{
		// 	DeletedServicesCollection: armapimanagement.DeletedServicesCollection{
...
// Generated from example definition: 2025-09-01-preview/ApiManagementDeletedServicesPurge.json
func ExampleDeletedServicesClient_BeginPurge() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.DeletedServicesClientPurgeResponse{
	// }
}
