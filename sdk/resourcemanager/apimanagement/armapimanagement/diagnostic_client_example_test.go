...
// Generated from example definition: 2025-09-01-preview/ApiManagementCreateDiagnostic.json
func ExampleDiagnosticClient_CreateOrUpdate() {
	...
	// res = armapimanagement.DiagnosticClientCreateOrUpdateResponse{
...
// Generated from example definition: 2025-09-01-preview/ApiManagementDeleteDiagnostic.json
func ExampleDiagnosticClient_Delete() {
	...
	res, err := clientFactory.NewDiagnosticClient().Delete(ctx, "rg1", "apimService1", "applicationinsights", "*", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.DiagnosticClientDeleteResponse{
	// }
}

// Generated from example definition: 2025-09-01-preview/ApiManagementGetDiagnostic.json
func ExampleDiagnosticClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.DiagnosticClientGetResponse{
	// 	DiagnosticContract: armapimanagement.DiagnosticContract{
	// 		Name: to.Ptr("applicationinsights"),
	// 		Type: to.Ptr("Microsoft.ApiManagement/service/diagnostics"),
	// 		ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.ApiManagement/service/apimService1/diagnostics/applicationinsights"),
...
// Generated from example definition: 2025-09-01-preview/ApiManagementHeadDiagnostic.json
func ExampleDiagnosticClient_GetEntityTag() {
	...
	res, err := clientFactory.NewDiagnosticClient().GetEntityTag(ctx, "rg1", "apimService1", "applicationinsights", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.DiagnosticClientGetEntityTagResponse{
	// }
}

// Generated from example definition: 2025-09-01-preview/ApiManagementListDiagnostics.json
func ExampleDiagnosticClient_NewListByServicePager() {
	...
	pager := clientFactory.NewDiagnosticClient().NewListByServicePager("rg1", "apimService1", nil)
	for pager.More() {
		...
		// page = armapimanagement.DiagnosticClientListByServiceResponse{
...
// Generated from example definition: 2025-09-01-preview/ApiManagementUpdateDiagnostic.json
func ExampleDiagnosticClient_Update() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.DiagnosticClientUpdateResponse{
	// 	DiagnosticContract: armapimanagement.DiagnosticContract{
	// 		Name: to.Ptr("applicationinsights"),
	// 		Type: to.Ptr("Microsoft.ApiManagement/service/diagnostics"),
	// 		ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.ApiManagement/service/apimService1/diagnostics/applicationinsights"),
