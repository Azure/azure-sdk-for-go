...
// The returned APIIssueCommentServerTransport instance is connected to an instance of armapimanagement.APIIssueCommentClient via the
// azcore.ClientOptions.Transporter field in the client's constructor parameters.
func NewAPIIssueCommentServerTransport(srv *APIIssueCommentServer) *APIIssueCommentServerTransport {
	return &APIIssueCommentServerTransport{
		srv:                   srv,
		newListByServicePager: newTracker[azfake.PagerResponder[armapimanagement.APIIssueCommentClientListByServiceResponse]](),
	}
}

// APIIssueCommentServerTransport connects instances of armapimanagement.APIIssueCommentClient to instances of APIIssueCommentServer.
// Don't use this type directly, use NewAPIIssueCommentServerTransport instead.
type APIIssueCommentServerTransport struct {
	srv                   *APIIssueCommentServer
	newListByServicePager *tracker[azfake.PagerResponder[armapimanagement.APIIssueCommentClientListByServiceResponse]]
}

// Do implements the policy.Transporter interface for APIIssueCommentServerTransport.
func (a *APIIssueCommentServerTransport) Do(req *http.Request) (*http.Response, error) {
...
func (a *APIIssueCommentServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	resultChan := make(chan result, 1)
	go func() {
		var intercepted bool
		var res result
		if apiIssueCommentServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = apiIssueCommentServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			case "APIIssueCommentClient.CreateOrUpdate":
				res.resp, res.err = a.dispatchCreateOrUpdate(req)
			case "APIIssueCommentClient.Delete":
				res.resp, res.err = a.dispatchDelete(req)
			case "APIIssueCommentClient.Get":
				res.resp, res.err = a.dispatchGet(req)
			case "APIIssueCommentClient.GetEntityTag":
				res.resp, res.err = a.dispatchGetEntityTag(req)
			case "APIIssueCommentClient.NewListByServicePager":
...
func (a *APIIssueCommentServerTransport) dispatchCreateOrUpdate(req *http.Request) (*http.Response, error) {
	if a.srv.CreateOrUpdate == nil {
		return nil, &nonRetriableError{errors.New("fake for method CreateOrUpdate not implemented")}
	}
	const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.ApiManagement/service/(?P<serviceName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/apis/(?P<apiId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/issues/(?P<issueId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/comments/(?P<commentId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)`
	regex := regexp.MustCompile(regexStr)
	matches := regex.FindStringSubmatch(req.URL.EscapedPath())
	if len(matches) < 7 {
		return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
	}
	body, err := server.UnmarshalRequestAsJSON[armapimanagement.IssueCommentContract](req)
	if err != nil {
		return nil, err
	}
	...
	commentIDParam, err := url.PathUnescape(matches[regex.SubexpIndex("commentId")])
	if err != nil {
		return nil, err
	}
	ifMatchParam := getOptional(getHeaderValue(req.Header, "If-Match"))
	var options *armapimanagement.APIIssueCommentClientCreateOrUpdateOptions
	if ifMatchParam != nil {
		options = &armapimanagement.APIIssueCommentClientCreateOrUpdateOptions{
			IfMatch: ifMatchParam,
		}
	}
	respr, errRespr := a.srv.CreateOrUpdate(req.Context(), resourceGroupNameParam, serviceNameParam, apiIDParam, issueIDParam, commentIDParam, body, options)
	...
	resp, err := server.MarshalResponseAsJSON(respContent, server.GetResponse(respr).IssueCommentContract, req)
	if err != nil {
		return nil, err
	}
...
func (a *APIIssueCommentServerTransport) dispatchDelete(req *http.Request) (*http.Response, error) {
	if a.srv.Delete == nil {
	...
	respr, errRespr := a.srv.Delete(req.Context(), resourceGroupNameParam, serviceNameParam, apiIDParam, issueIDParam, commentIDParam, getHeaderValue(req.Header, "If-Match"), nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (a *APIIssueCommentServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	if a.srv.Get == nil {
	...
	respr, errRespr := a.srv.Get(req.Context(), resourceGroupNameParam, serviceNameParam, apiIDParam, issueIDParam, commentIDParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (a *APIIssueCommentServerTransport) dispatchGetEntityTag(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := a.srv.GetEntityTag(req.Context(), resourceGroupNameParam, serviceNameParam, apiIDParam, issueIDParam, commentIDParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (a *APIIssueCommentServerTransport) dispatchNewListByServicePager(req *http.Request) (*http.Response, error) {
	...
	if newListByServicePager == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.ApiManagement/service/(?P<serviceName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/apis/(?P<apiId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/issues/(?P<issueId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/comments`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 6 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
		...
		var options *armapimanagement.APIIssueCommentClientListByServiceOptions
		if filterParam != nil || topParam != nil || skipParam != nil {
			options = &armapimanagement.APIIssueCommentClientListByServiceOptions{
				Filter: filterParam,
				Top:    topParam,
				Skip:   skipParam,
			}
		...
		server.PagerResponderInjectNextLinks(newListByServicePager, req, func(page *armapimanagement.APIIssueCommentClientListByServiceResponse, createLink func() string) {
...
// set this to conditionally intercept incoming requests to APIIssueCommentServerTransport
var apiIssueCommentServerTransportInterceptor interface {
