...
func (a *APIWikiServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	resultChan := make(chan result, 1)
	go func() {
		var intercepted bool
		var res result
		if apiWikiServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = apiWikiServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
func (a *APIWikiServerTransport) dispatchCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.ApiManagement/service/(?P<serviceName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/apis/(?P<apiId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/wikis/default`
...
// set this to conditionally intercept incoming requests to APIWikiServerTransport
var apiWikiServerTransportInterceptor interface {
