...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "APIDiagnosticClient":
		initServer(&s.trMu, &s.trAPIDiagnosticServer, func() *APIDiagnosticServerTransport {
	...
	case "APIExportClient":
		initServer(&s.trMu, &s.trAPIExportServer, func() *APIExportServerTransport { return NewAPIExportServerTransport(&s.srv.APIExportServer) })
		resp, err = s.trAPIExportServer.Do(req)
	case "APIGatewayClient":
		initServer(&s.trMu, &s.trAPIGatewayServer, func() *APIGatewayServerTransport { return NewAPIGatewayServerTransport(&s.srv.APIGatewayServer) })
		resp, err = s.trAPIGatewayServer.Do(req)
	case "APIGatewayConfigConnectionClient":
		initServer(&s.trMu, &s.trAPIGatewayConfigConnectionServer, func() *APIGatewayConfigConnectionServerTransport {
	...
	case "APIGatewayHostnameBindingClient":
		initServer(&s.trMu, &s.trAPIGatewayHostnameBindingServer, func() *APIGatewayHostnameBindingServerTransport {
	...
	case "APIIssueAttachmentClient":
		initServer(&s.trMu, &s.trAPIIssueAttachmentServer, func() *APIIssueAttachmentServerTransport {
			return NewAPIIssueAttachmentServerTransport(&s.srv.APIIssueAttachmentServer)
		})
		resp, err = s.trAPIIssueAttachmentServer.Do(req)
	case "APIIssueClient":
		initServer(&s.trMu, &s.trAPIIssueServer, func() *APIIssueServerTransport { return NewAPIIssueServerTransport(&s.srv.APIIssueServer) })
		resp, err = s.trAPIIssueServer.Do(req)
	case "APIIssueCommentClient":
		initServer(&s.trMu, &s.trAPIIssueCommentServer, func() *APIIssueCommentServerTransport {
	...
	case "APIOperationClient":
		initServer(&s.trMu, &s.trAPIOperationServer, func() *APIOperationServerTransport { return NewAPIOperationServerTransport(&s.srv.APIOperationServer) })
		resp, err = s.trAPIOperationServer.Do(req)
	case "APIOperationPolicyClient":
		initServer(&s.trMu, &s.trAPIOperationPolicyServer, func() *APIOperationPolicyServerTransport {
	...
	case "APIPolicyClient":
		initServer(&s.trMu, &s.trAPIPolicyServer, func() *APIPolicyServerTransport { return NewAPIPolicyServerTransport(&s.srv.APIPolicyServer) })
		resp, err = s.trAPIPolicyServer.Do(req)
	case "APIProductClient":
		initServer(&s.trMu, &s.trAPIProductServer, func() *APIProductServerTransport { return NewAPIProductServerTransport(&s.srv.APIProductServer) })
		resp, err = s.trAPIProductServer.Do(req)
	case "APIReleaseClient":
		initServer(&s.trMu, &s.trAPIReleaseServer, func() *APIReleaseServerTransport { return NewAPIReleaseServerTransport(&s.srv.APIReleaseServer) })
		resp, err = s.trAPIReleaseServer.Do(req)
	case "APIRevisionClient":
		initServer(&s.trMu, &s.trAPIRevisionServer, func() *APIRevisionServerTransport { return NewAPIRevisionServerTransport(&s.srv.APIRevisionServer) })
		resp, err = s.trAPIRevisionServer.Do(req)
	case "APISchemaClient":
		initServer(&s.trMu, &s.trAPISchemaServer, func() *APISchemaServerTransport { return NewAPISchemaServerTransport(&s.srv.APISchemaServer) })
		resp, err = s.trAPISchemaServer.Do(req)
	case "APITagDescriptionClient":
		initServer(&s.trMu, &s.trAPITagDescriptionServer, func() *APITagDescriptionServerTransport {
			return NewAPITagDescriptionServerTransport(&s.srv.APITagDescriptionServer)
		})
		resp, err = s.trAPITagDescriptionServer.Do(req)
	case "APIToolClient":
		initServer(&s.trMu, &s.trAPIToolServer, func() *APIToolServerTransport { return NewAPIToolServerTransport(&s.srv.APIToolServer) })
		resp, err = s.trAPIToolServer.Do(req)
	case "APIVersionSetClient":
		initServer(&s.trMu, &s.trAPIVersionSetServer, func() *APIVersionSetServerTransport {
			return NewAPIVersionSetServerTransport(&s.srv.APIVersionSetServer)
		})
		resp, err = s.trAPIVersionSetServer.Do(req)
	case "APIWikiClient":
		initServer(&s.trMu, &s.trAPIWikiServer, func() *APIWikiServerTransport { return NewAPIWikiServerTransport(&s.srv.APIWikiServer) })
		resp, err = s.trAPIWikiServer.Do(req)
	case "APIWikisClient":
		initServer(&s.trMu, &s.trAPIWikisServer, func() *APIWikisServerTransport { return NewAPIWikisServerTransport(&s.srv.APIWikisServer) })
		resp, err = s.trAPIWikisServer.Do(req)
	case "AllPoliciesClient":
		initServer(&s.trMu, &s.trAllPoliciesServer, func() *AllPoliciesServerTransport { return NewAllPoliciesServerTransport(&s.srv.AllPoliciesServer) })
		resp, err = s.trAllPoliciesServer.Do(req)
	case "AuthorizationAccessPolicyClient":
		initServer(&s.trMu, &s.trAuthorizationAccessPolicyServer, func() *AuthorizationAccessPolicyServerTransport {
	...
	case "AuthorizationLoginLinksClient":
		initServer(&s.trMu, &s.trAuthorizationLoginLinksServer, func() *AuthorizationLoginLinksServerTransport {
	...
	case "AuthorizationProviderClient":
		initServer(&s.trMu, &s.trAuthorizationProviderServer, func() *AuthorizationProviderServerTransport {
	...
	case "BackendClient":
		initServer(&s.trMu, &s.trBackendServer, func() *BackendServerTransport { return NewBackendServerTransport(&s.srv.BackendServer) })
		resp, err = s.trBackendServer.Do(req)
	case "CacheClient":
		initServer(&s.trMu, &s.trCacheServer, func() *CacheServerTransport { return NewCacheServerTransport(&s.srv.CacheServer) })
		resp, err = s.trCacheServer.Do(req)
	case "CertificateClient":
		initServer(&s.trMu, &s.trCertificateServer, func() *CertificateServerTransport { return NewCertificateServerTransport(&s.srv.CertificateServer) })
	...
	case "ClientApplicationClient":
		initServer(&s.trMu, &s.trClientApplicationServer, func() *ClientApplicationServerTransport {
	...
	case "ClientApplicationProductLinkClient":
		initServer(&s.trMu, &s.trClientApplicationProductLinkServer, func() *ClientApplicationProductLinkServerTransport {
	...
	case "ContentItemClient":
		initServer(&s.trMu, &s.trContentItemServer, func() *ContentItemServerTransport { return NewContentItemServerTransport(&s.srv.ContentItemServer) })
		resp, err = s.trContentItemServer.Do(req)
	case "ContentTypeClient":
		initServer(&s.trMu, &s.trContentTypeServer, func() *ContentTypeServerTransport { return NewContentTypeServerTransport(&s.srv.ContentTypeServer) })
		resp, err = s.trContentTypeServer.Do(req)
	case "DelegationSettingsClient":
		initServer(&s.trMu, &s.trDelegationSettingsServer, func() *DelegationSettingsServerTransport {
	...
	case "DiagnosticClient":
		initServer(&s.trMu, &s.trDiagnosticServer, func() *DiagnosticServerTransport { return NewDiagnosticServerTransport(&s.srv.DiagnosticServer) })
		resp, err = s.trDiagnosticServer.Do(req)
	case "DocumentationClient":
		initServer(&s.trMu, &s.trDocumentationServer, func() *DocumentationServerTransport {
	...
	case "EmailTemplateClient":
		initServer(&s.trMu, &s.trEmailTemplateServer, func() *EmailTemplateServerTransport {
	...
	case "GatewayAPIClient":
		initServer(&s.trMu, &s.trGatewayAPIServer, func() *GatewayAPIServerTransport { return NewGatewayAPIServerTransport(&s.srv.GatewayAPIServer) })
		resp, err = s.trGatewayAPIServer.Do(req)
	case "GatewayCertificateAuthorityClient":
		initServer(&s.trMu, &s.trGatewayCertificateAuthorityServer, func() *GatewayCertificateAuthorityServerTransport {
	...
	case "GatewayClient":
		initServer(&s.trMu, &s.trGatewayServer, func() *GatewayServerTransport { return NewGatewayServerTransport(&s.srv.GatewayServer) })
		resp, err = s.trGatewayServer.Do(req)
	case "GatewayHostnameConfigurationClient":
		initServer(&s.trMu, &s.trGatewayHostnameConfigurationServer, func() *GatewayHostnameConfigurationServerTransport {
	...
	case "GatewaySKUsClient":
		initServer(&s.trMu, &s.trGatewaySKUsServer, func() *GatewaySKUsServerTransport { return NewGatewaySKUsServerTransport(&s.srv.GatewaySKUsServer) })
		resp, err = s.trGatewaySKUsServer.Do(req)
	case "GlobalSchemaClient":
		initServer(&s.trMu, &s.trGlobalSchemaServer, func() *GlobalSchemaServerTransport { return NewGlobalSchemaServerTransport(&s.srv.GlobalSchemaServer) })
		resp, err = s.trGlobalSchemaServer.Do(req)
	case "GraphQLAPIResolverClient":
		initServer(&s.trMu, &s.trGraphQLAPIResolverServer, func() *GraphQLAPIResolverServerTransport {
	...
	case "GraphQLAPIResolverPolicyClient":
		initServer(&s.trMu, &s.trGraphQLAPIResolverPolicyServer, func() *GraphQLAPIResolverPolicyServerTransport {
	...
	case "GroupClient":
		initServer(&s.trMu, &s.trGroupServer, func() *GroupServerTransport { return NewGroupServerTransport(&s.srv.GroupServer) })
		resp, err = s.trGroupServer.Do(req)
	case "GroupUserClient":
		initServer(&s.trMu, &s.trGroupUserServer, func() *GroupUserServerTransport { return NewGroupUserServerTransport(&s.srv.GroupUserServer) })
		resp, err = s.trGroupUserServer.Do(req)
	case "IdentityProviderClient":
		initServer(&s.trMu, &s.trIdentityProviderServer, func() *IdentityProviderServerTransport {
	...
	case "LoggerClient":
		initServer(&s.trMu, &s.trLoggerServer, func() *LoggerServerTransport { return NewLoggerServerTransport(&s.srv.LoggerServer) })
		resp, err = s.trLoggerServer.Do(req)
	case "NamedValueClient":
		initServer(&s.trMu, &s.trNamedValueServer, func() *NamedValueServerTransport { return NewNamedValueServerTransport(&s.srv.NamedValueServer) })
		resp, err = s.trNamedValueServer.Do(req)
	case "NetworkStatusClient":
		initServer(&s.trMu, &s.trNetworkStatusServer, func() *NetworkStatusServerTransport {
	...
	case "NotificationClient":
		initServer(&s.trMu, &s.trNotificationServer, func() *NotificationServerTransport { return NewNotificationServerTransport(&s.srv.NotificationServer) })
		resp, err = s.trNotificationServer.Do(req)
	case "NotificationRecipientEmailClient":
		initServer(&s.trMu, &s.trNotificationRecipientEmailServer, func() *NotificationRecipientEmailServerTransport {
	...
	case "NotificationRecipientUserClient":
		initServer(&s.trMu, &s.trNotificationRecipientUserServer, func() *NotificationRecipientUserServerTransport {
	...
	case "OpenIDConnectProviderClient":
		initServer(&s.trMu, &s.trOpenIDConnectProviderServer, func() *OpenIDConnectProviderServerTransport {
	...
	case "PolicyDescriptionClient":
		initServer(&s.trMu, &s.trPolicyDescriptionServer, func() *PolicyDescriptionServerTransport {
	...
	case "PolicyFragmentClient":
		initServer(&s.trMu, &s.trPolicyFragmentServer, func() *PolicyFragmentServerTransport {
	...
	case "PolicyRestrictionClient":
		initServer(&s.trMu, &s.trPolicyRestrictionServer, func() *PolicyRestrictionServerTransport {
	...
	case "PolicyRestrictionValidationsClient":
		initServer(&s.trMu, &s.trPolicyRestrictionValidationsServer, func() *PolicyRestrictionValidationsServerTransport {
	...
	case "PortalConfigClient":
		initServer(&s.trMu, &s.trPortalConfigServer, func() *PortalConfigServerTransport { return NewPortalConfigServerTransport(&s.srv.PortalConfigServer) })
		resp, err = s.trPortalConfigServer.Do(req)
	case "PortalRevisionClient":
		initServer(&s.trMu, &s.trPortalRevisionServer, func() *PortalRevisionServerTransport {
	...
	case "PortalSettingsClient":
		initServer(&s.trMu, &s.trPortalSettingsServer, func() *PortalSettingsServerTransport {
	...
	case "ProductAPIClient":
		initServer(&s.trMu, &s.trProductAPIServer, func() *ProductAPIServerTransport { return NewProductAPIServerTransport(&s.srv.ProductAPIServer) })
		resp, err = s.trProductAPIServer.Do(req)
	case "ProductAPILinkClient":
		initServer(&s.trMu, &s.trProductAPILinkServer, func() *ProductAPILinkServerTransport {
			return NewProductAPILinkServerTransport(&s.srv.ProductAPILinkServer)
		})
		resp, err = s.trProductAPILinkServer.Do(req)
	case "ProductClient":
		initServer(&s.trMu, &s.trProductServer, func() *ProductServerTransport { return NewProductServerTransport(&s.srv.ProductServer) })
		resp, err = s.trProductServer.Do(req)
	case "ProductGroupClient":
		initServer(&s.trMu, &s.trProductGroupServer, func() *ProductGroupServerTransport { return NewProductGroupServerTransport(&s.srv.ProductGroupServer) })
		resp, err = s.trProductGroupServer.Do(req)
	case "ProductGroupLinkClient":
		initServer(&s.trMu, &s.trProductGroupLinkServer, func() *ProductGroupLinkServerTransport {
	...
	case "ProductPolicyClient":
		initServer(&s.trMu, &s.trProductPolicyServer, func() *ProductPolicyServerTransport {
	...
	case "ProductSubscriptionsClient":
		initServer(&s.trMu, &s.trProductSubscriptionsServer, func() *ProductSubscriptionsServerTransport {
	...
	case "ProductWikiClient":
		initServer(&s.trMu, &s.trProductWikiServer, func() *ProductWikiServerTransport { return NewProductWikiServerTransport(&s.srv.ProductWikiServer) })
		resp, err = s.trProductWikiServer.Do(req)
	case "ProductWikisClient":
		initServer(&s.trMu, &s.trProductWikisServer, func() *ProductWikisServerTransport { return NewProductWikisServerTransport(&s.srv.ProductWikisServer) })
		resp, err = s.trProductWikisServer.Do(req)
	case "QuotaByCounterKeysClient":
		initServer(&s.trMu, &s.trQuotaByCounterKeysServer, func() *QuotaByCounterKeysServerTransport {
	...
	case "QuotaByPeriodKeysClient":
		initServer(&s.trMu, &s.trQuotaByPeriodKeysServer, func() *QuotaByPeriodKeysServerTransport {
			return NewQuotaByPeriodKeysServerTransport(&s.srv.QuotaByPeriodKeysServer)
		})
		resp, err = s.trQuotaByPeriodKeysServer.Do(req)
	case "RegionClient":
		initServer(&s.trMu, &s.trRegionServer, func() *RegionServerTransport { return NewRegionServerTransport(&s.srv.RegionServer) })
		resp, err = s.trRegionServer.Do(req)
	case "ReportsClient":
		initServer(&s.trMu, &s.trReportsServer, func() *ReportsServerTransport { return NewReportsServerTransport(&s.srv.ReportsServer) })
	...
	case "ServiceSKUsClient":
		initServer(&s.trMu, &s.trServiceSKUsServer, func() *ServiceSKUsServerTransport { return NewServiceSKUsServerTransport(&s.srv.ServiceSKUsServer) })
		resp, err = s.trServiceSKUsServer.Do(req)
	case "SignInSettingsClient":
		initServer(&s.trMu, &s.trSignInSettingsServer, func() *SignInSettingsServerTransport {
	...
	case "SignUpSettingsClient":
		initServer(&s.trMu, &s.trSignUpSettingsServer, func() *SignUpSettingsServerTransport {
	...
	case "SubscriptionClient":
		initServer(&s.trMu, &s.trSubscriptionServer, func() *SubscriptionServerTransport { return NewSubscriptionServerTransport(&s.srv.SubscriptionServer) })
		resp, err = s.trSubscriptionServer.Do(req)
	case "TagAPILinkClient":
		initServer(&s.trMu, &s.trTagAPILinkServer, func() *TagAPILinkServerTransport { return NewTagAPILinkServerTransport(&s.srv.TagAPILinkServer) })
		resp, err = s.trTagAPILinkServer.Do(req)
	case "TagClient":
		initServer(&s.trMu, &s.trTagServer, func() *TagServerTransport { return NewTagServerTransport(&s.srv.TagServer) })
		resp, err = s.trTagServer.Do(req)
	case "TagOperationLinkClient":
		initServer(&s.trMu, &s.trTagOperationLinkServer, func() *TagOperationLinkServerTransport {
	...
	case "TagProductLinkClient":
		initServer(&s.trMu, &s.trTagProductLinkServer, func() *TagProductLinkServerTransport {
	...
	case "TagResourceClient":
		initServer(&s.trMu, &s.trTagResourceServer, func() *TagResourceServerTransport { return NewTagResourceServerTransport(&s.srv.TagResourceServer) })
		resp, err = s.trTagResourceServer.Do(req)
	case "TenantAccessClient":
		initServer(&s.trMu, &s.trTenantAccessServer, func() *TenantAccessServerTransport { return NewTenantAccessServerTransport(&s.srv.TenantAccessServer) })
		resp, err = s.trTenantAccessServer.Do(req)
	case "TenantAccessGitClient":
		initServer(&s.trMu, &s.trTenantAccessGitServer, func() *TenantAccessGitServerTransport {
	...
	case "TenantConfigurationClient":
		initServer(&s.trMu, &s.trTenantConfigurationServer, func() *TenantConfigurationServerTransport {
	...
	case "TenantSettingsClient":
		initServer(&s.trMu, &s.trTenantSettingsServer, func() *TenantSettingsServerTransport {
			return NewTenantSettingsServerTransport(&s.srv.TenantSettingsServer)
		})
		resp, err = s.trTenantSettingsServer.Do(req)
	case "UserClient":
		initServer(&s.trMu, &s.trUserServer, func() *UserServerTransport { return NewUserServerTransport(&s.srv.UserServer) })
		resp, err = s.trUserServer.Do(req)
	case "UserConfirmationPasswordClient":
		initServer(&s.trMu, &s.trUserConfirmationPasswordServer, func() *UserConfirmationPasswordServerTransport {
	...
	case "UserGroupClient":
		initServer(&s.trMu, &s.trUserGroupServer, func() *UserGroupServerTransport { return NewUserGroupServerTransport(&s.srv.UserGroupServer) })
		resp, err = s.trUserGroupServer.Do(req)
	case "UserIdentitiesClient":
		initServer(&s.trMu, &s.trUserIdentitiesServer, func() *UserIdentitiesServerTransport {
	...
	case "UserSubscriptionClient":
		initServer(&s.trMu, &s.trUserSubscriptionServer, func() *UserSubscriptionServerTransport {
	...
	case "WorkspaceAPIClient":
		initServer(&s.trMu, &s.trWorkspaceAPIServer, func() *WorkspaceAPIServerTransport { return NewWorkspaceAPIServerTransport(&s.srv.WorkspaceAPIServer) })
		resp, err = s.trWorkspaceAPIServer.Do(req)
	case "WorkspaceAPIDiagnosticClient":
		initServer(&s.trMu, &s.trWorkspaceAPIDiagnosticServer, func() *WorkspaceAPIDiagnosticServerTransport {
	...
	case "WorkspaceAPIExportClient":
		initServer(&s.trMu, &s.trWorkspaceAPIExportServer, func() *WorkspaceAPIExportServerTransport {
	...
	case "WorkspaceAPIOperationClient":
		initServer(&s.trMu, &s.trWorkspaceAPIOperationServer, func() *WorkspaceAPIOperationServerTransport {
	...
	case "WorkspaceAPIOperationPolicyClient":
		initServer(&s.trMu, &s.trWorkspaceAPIOperationPolicyServer, func() *WorkspaceAPIOperationPolicyServerTransport {
	...
	case "WorkspaceAPIPolicyClient":
		initServer(&s.trMu, &s.trWorkspaceAPIPolicyServer, func() *WorkspaceAPIPolicyServerTransport {
	...
	case "WorkspaceAPIReleaseClient":
		initServer(&s.trMu, &s.trWorkspaceAPIReleaseServer, func() *WorkspaceAPIReleaseServerTransport {
	...
	case "WorkspaceAPIRevisionClient":
		initServer(&s.trMu, &s.trWorkspaceAPIRevisionServer, func() *WorkspaceAPIRevisionServerTransport {
	...
	case "WorkspaceAPISchemaClient":
		initServer(&s.trMu, &s.trWorkspaceAPISchemaServer, func() *WorkspaceAPISchemaServerTransport {
	...
	case "WorkspaceAPIVersionSetClient":
		initServer(&s.trMu, &s.trWorkspaceAPIVersionSetServer, func() *WorkspaceAPIVersionSetServerTransport {
	...
	case "WorkspaceBackendClient":
		initServer(&s.trMu, &s.trWorkspaceBackendServer, func() *WorkspaceBackendServerTransport {
	...
	case "WorkspaceCertificateClient":
		initServer(&s.trMu, &s.trWorkspaceCertificateServer, func() *WorkspaceCertificateServerTransport {
	...
	case "WorkspaceClient":
		initServer(&s.trMu, &s.trWorkspaceServer, func() *WorkspaceServerTransport { return NewWorkspaceServerTransport(&s.srv.WorkspaceServer) })
		resp, err = s.trWorkspaceServer.Do(req)
	case "WorkspaceDiagnosticClient":
		initServer(&s.trMu, &s.trWorkspaceDiagnosticServer, func() *WorkspaceDiagnosticServerTransport {
	...
	case "WorkspaceGlobalSchemaClient":
		initServer(&s.trMu, &s.trWorkspaceGlobalSchemaServer, func() *WorkspaceGlobalSchemaServerTransport {
	...
	case "WorkspaceGroupClient":
		initServer(&s.trMu, &s.trWorkspaceGroupServer, func() *WorkspaceGroupServerTransport {
	...
	case "WorkspaceGroupUserClient":
		initServer(&s.trMu, &s.trWorkspaceGroupUserServer, func() *WorkspaceGroupUserServerTransport {
	...
	case "WorkspaceLinkClient":
		initServer(&s.trMu, &s.trWorkspaceLinkServer, func() *WorkspaceLinkServerTransport {
	...
	case "WorkspaceLinksClient":
		initServer(&s.trMu, &s.trWorkspaceLinksServer, func() *WorkspaceLinksServerTransport {
	...
	case "WorkspaceLoggerClient":
		initServer(&s.trMu, &s.trWorkspaceLoggerServer, func() *WorkspaceLoggerServerTransport {
	...
	case "WorkspaceNamedValueClient":
		initServer(&s.trMu, &s.trWorkspaceNamedValueServer, func() *WorkspaceNamedValueServerTransport {
	...
	case "WorkspaceNotificationClient":
		initServer(&s.trMu, &s.trWorkspaceNotificationServer, func() *WorkspaceNotificationServerTransport {
	...
	case "WorkspaceNotificationRecipientEmailClient":
		initServer(&s.trMu, &s.trWorkspaceNotificationRecipientEmailServer, func() *WorkspaceNotificationRecipientEmailServerTransport {
	...
	case "WorkspaceNotificationRecipientUserClient":
		initServer(&s.trMu, &s.trWorkspaceNotificationRecipientUserServer, func() *WorkspaceNotificationRecipientUserServerTransport {
	...
	case "WorkspacePolicyClient":
		initServer(&s.trMu, &s.trWorkspacePolicyServer, func() *WorkspacePolicyServerTransport {
	...
	case "WorkspacePolicyFragmentClient":
		initServer(&s.trMu, &s.trWorkspacePolicyFragmentServer, func() *WorkspacePolicyFragmentServerTransport {
	...
	case "WorkspaceProductAPILinkClient":
		initServer(&s.trMu, &s.trWorkspaceProductAPILinkServer, func() *WorkspaceProductAPILinkServerTransport {
	...
	case "WorkspaceProductClient":
		initServer(&s.trMu, &s.trWorkspaceProductServer, func() *WorkspaceProductServerTransport {
	...
	case "WorkspaceProductGroupLinkClient":
		initServer(&s.trMu, &s.trWorkspaceProductGroupLinkServer, func() *WorkspaceProductGroupLinkServerTransport {
	...
	case "WorkspaceProductPolicyClient":
		initServer(&s.trMu, &s.trWorkspaceProductPolicyServer, func() *WorkspaceProductPolicyServerTransport {
	...
	case "WorkspaceSubscriptionClient":
		initServer(&s.trMu, &s.trWorkspaceSubscriptionServer, func() *WorkspaceSubscriptionServerTransport {
	...
	case "WorkspaceTagAPILinkClient":
		initServer(&s.trMu, &s.trWorkspaceTagAPILinkServer, func() *WorkspaceTagAPILinkServerTransport {
	...
	case "WorkspaceTagClient":
		initServer(&s.trMu, &s.trWorkspaceTagServer, func() *WorkspaceTagServerTransport { return NewWorkspaceTagServerTransport(&s.srv.WorkspaceTagServer) })
		resp, err = s.trWorkspaceTagServer.Do(req)
	case "WorkspaceTagOperationLinkClient":
		initServer(&s.trMu, &s.trWorkspaceTagOperationLinkServer, func() *WorkspaceTagOperationLinkServerTransport {
	...
	case "WorkspaceTagProductLinkClient":
		initServer(&s.trMu, &s.trWorkspaceTagProductLinkServer, func() *WorkspaceTagProductLinkServerTransport {
