...
func (s *ServiceSKUsServerTransport) dispatchNewListAvailableServiceSKUsPager(req *http.Request) (*http.Response, error) {
	...
	if newListAvailableServiceSKUsPager == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.ApiManagement/service/(?P<serviceName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/skus`
