...
func (client *GatewayAPIClient) createOrUpdateHandleResponse(resp *http.Response, successCodes ...int) (GatewayAPIClientCreateOrUpdateResponse, error) {
...
func (client *GatewayAPIClient) Delete(ctx context.Context, resourceGroupName string, serviceName string, gatewayID string, apiID string, options *GatewayAPIClientDeleteOptions) (GatewayAPIClientDeleteResponse, error) {
	...
	if !runtime.HasStatusCode(httpResp, http.StatusOK, http.StatusNoContent) {
		return GatewayAPIClientDeleteResponse{}, runtime.NewResponseError(httpResp)
	}
...
func (client *GatewayAPIClient) getEntityTagHandleResponse(resp *http.Response, successCodes ...int) (GatewayAPIClientGetEntityTagResponse, error) {
...
func (client *GatewayAPIClient) listByServiceCreateRequest(ctx context.Context, resourceGroupName string, serviceName string, gatewayID string, nextLink string, options *GatewayAPIClientListByServiceOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *GatewayAPIClient) listByServiceHandleResponse(resp *http.Response, successCodes ...int) (GatewayAPIClientListByServiceResponse, error) {
