...
func (client *GatewayHostnameConfigurationClient) createOrUpdateHandleResponse(resp *http.Response, successCodes ...int) (GatewayHostnameConfigurationClientCreateOrUpdateResponse, error) {
...
func (client *GatewayHostnameConfigurationClient) Delete(ctx context.Context, resourceGroupName string, serviceName string, gatewayID string, hcID string, ifMatch string, options *GatewayHostnameConfigurationClientDeleteOptions) (GatewayHostnameConfigurationClientDeleteResponse, error) {
	...
	if !runtime.HasStatusCode(httpResp, http.StatusOK, http.StatusNoContent) {
		return GatewayHostnameConfigurationClientDeleteResponse{}, runtime.NewResponseError(httpResp)
	}
...
func (client *GatewayHostnameConfigurationClient) getHandleResponse(resp *http.Response, successCodes ...int) (GatewayHostnameConfigurationClientGetResponse, error) {
...
func (client *GatewayHostnameConfigurationClient) getEntityTagHandleResponse(resp *http.Response, successCodes ...int) (GatewayHostnameConfigurationClientGetEntityTagResponse, error) {
...
func (client *GatewayHostnameConfigurationClient) listByServiceCreateRequest(ctx context.Context, resourceGroupName string, serviceName string, gatewayID string, nextLink string, options *GatewayHostnameConfigurationClientListByServiceOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *GatewayHostnameConfigurationClient) listByServiceHandleResponse(resp *http.Response, successCodes ...int) (GatewayHostnameConfigurationClientListByServiceResponse, error) {
