...
// Generated from example definition: 2025-09-01-preview/ApiManagementCreateGlobalSchema1.json
func ExampleGlobalSchemaClient_BeginCreateOrUpdate_apiManagementCreateSchema1() {
	...
	// res = armapimanagement.GlobalSchemaClientCreateOrUpdateResponse{
...
// Generated from example definition: 2025-09-01-preview/ApiManagementCreateGlobalSchema2.json
...
// Generated from example definition: 2025-09-01-preview/ApiManagementDeleteGlobalSchema.json
func ExampleGlobalSchemaClient_Delete() {
	...
	res, err := clientFactory.NewGlobalSchemaClient().Delete(ctx, "rg1", "apimService1", "schema1", "*", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.GlobalSchemaClientDeleteResponse{
	// }
}

// Generated from example definition: 2025-09-01-preview/ApiManagementGetGlobalSchema1.json
func ExampleGlobalSchemaClient_Get_apiManagementGetSchema1() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.GlobalSchemaClientGetResponse{
	// 	GlobalSchemaContract: armapimanagement.GlobalSchemaContract{
	// 		Name: to.Ptr("schema1"),
	// 		Type: to.Ptr("Microsoft.ApiManagement/service/schemas"),
	// 		ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.ApiManagement/service/apimService1/schemas/schema1"),
...
// Generated from example definition: 2025-09-01-preview/ApiManagementGetGlobalSchema2.json
...
// Generated from example definition: 2025-09-01-preview/ApiManagementHeadGlobalSchema.json
func ExampleGlobalSchemaClient_GetEntityTag() {
	...
	res, err := clientFactory.NewGlobalSchemaClient().GetEntityTag(ctx, "rg1", "apimService1", "myschema", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.GlobalSchemaClientGetEntityTagResponse{
	// }
}

// Generated from example definition: 2025-09-01-preview/ApiManagementListGlobalSchemas.json
func ExampleGlobalSchemaClient_NewListByServicePager() {
	...
	pager := clientFactory.NewGlobalSchemaClient().NewListByServicePager("rg1", "apimService1", nil)
	for pager.More() {
		...
		// page = armapimanagement.GlobalSchemaClientListByServiceResponse{
