...
// Generated from example definition: 2025-09-01-preview/ApiManagementCreateGraphQLApiResolverPolicy.json
func ExampleGraphQLAPIResolverPolicyClient_CreateOrUpdate() {
	...
	}, &armapimanagement.GraphQLAPIResolverPolicyClientCreateOrUpdateOptions{
		IfMatch: to.Ptr("*")})
	if err != nil {
	...
	// res = armapimanagement.GraphQLAPIResolverPolicyClientCreateOrUpdateResponse{
...
// Generated from example definition: 2025-09-01-preview/ApiManagementDeleteGraphQLApiResolverPolicy.json
func ExampleGraphQLAPIResolverPolicyClient_Delete() {
	...
	res, err := clientFactory.NewGraphQLAPIResolverPolicyClient().Delete(ctx, "rg1", "apimService1", "testapi", "testResolver", armapimanagement.PolicyIDNamePolicy, "*", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.GraphQLAPIResolverPolicyClientDeleteResponse{
	// }
}

// Generated from example definition: 2025-09-01-preview/ApiManagementGetGraphQLApiResolverPolicy.json
func ExampleGraphQLAPIResolverPolicyClient_Get() {
	...
	res, err := clientFactory.NewGraphQLAPIResolverPolicyClient().Get(ctx, "rg1", "apimService1", "5600b539c53f5b0062040001", "5600b53ac53f5b0062080006", armapimanagement.PolicyIDNamePolicy, nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.GraphQLAPIResolverPolicyClientGetResponse{
	// 	PolicyContract: armapimanagement.PolicyContract{
	// 		Name: to.Ptr("policy"),
	// 		Type: to.Ptr("Microsoft.ApiManagement/service/apis/resolvers/policies"),
...
// Generated from example definition: 2025-09-01-preview/ApiManagementHeadGraphQLApiResolverPolicy.json
func ExampleGraphQLAPIResolverPolicyClient_GetEntityTag() {
	...
	res, err := clientFactory.NewGraphQLAPIResolverPolicyClient().GetEntityTag(ctx, "rg1", "apimService1", "5600b539c53f5b0062040001", "5600b53ac53f5b0062080006", armapimanagement.PolicyIDNamePolicy, nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.GraphQLAPIResolverPolicyClientGetEntityTagResponse{
	// }
}

// Generated from example definition: 2025-09-01-preview/ApiManagementListGraphQLApiResolverPolicies.json
func ExampleGraphQLAPIResolverPolicyClient_NewListByResolverPager() {
	...
	for pager.More() {
		...
		// page = armapimanagement.GraphQLAPIResolverPolicyClientListByResolverResponse{
