...
// Generated from example definition: 2025-09-01-preview/ApiManagementCreateGroupExternal.json
...
// Generated from example definition: 2025-09-01-preview/ApiManagementDeleteGroup.json
func ExampleGroupClient_Delete() {
	...
	res, err := clientFactory.NewGroupClient().Delete(ctx, "rg1", "apimService1", "aadGroup", "*", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.GroupClientDeleteResponse{
	// }
}

// Generated from example definition: 2025-09-01-preview/ApiManagementGetGroup.json
func ExampleGroupClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.GroupClientGetResponse{
	// 	GroupContract: armapimanagement.GroupContract{
...
// Generated from example definition: 2025-09-01-preview/ApiManagementHeadGroup.json
func ExampleGroupClient_GetEntityTag() {
	...
	res, err := clientFactory.NewGroupClient().GetEntityTag(ctx, "rg1", "apimService1", "59306a29e4bbd510dc24e5f9", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.GroupClientGetEntityTagResponse{
	// }
}

// Generated from example definition: 2025-09-01-preview/ApiManagementListGroups.json
func ExampleGroupClient_NewListByServicePager() {
	...
	pager := clientFactory.NewGroupClient().NewListByServicePager("rg1", "apimService1", nil)
	for pager.More() {
		...
		// page = armapimanagement.GroupClientListByServiceResponse{
...
// Generated from example definition: 2025-09-01-preview/ApiManagementUpdateGroup.json
func ExampleGroupClient_Update() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.GroupClientUpdateResponse{
	// 	GroupContract: armapimanagement.GroupContract{
	// 		Name: to.Ptr("tempgroup"),
	// 		Type: to.Ptr("Microsoft.ApiManagement/service/groups"),
	// 		ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.ApiManagement/service/apimService1/groups/tempgroup"),
