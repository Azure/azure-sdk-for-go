...
func (client *IdentityProviderClient) createOrUpdateHandleResponse(resp *http.Response, successCodes ...int) (IdentityProviderClientCreateOrUpdateResponse, error) {
...
func (client *IdentityProviderClient) Delete(ctx context.Context, resourceGroupName string, serviceName string, identityProviderName IdentityProviderType, ifMatch string, options *IdentityProviderClientDeleteOptions) (IdentityProviderClientDeleteResponse, error) {
	...
	if !runtime.HasStatusCode(httpResp, http.StatusOK, http.StatusNoContent) {
		return IdentityProviderClientDeleteResponse{}, runtime.NewResponseError(httpResp)
	}
	return IdentityProviderClientDeleteResponse{}, nil
}

// deleteCreateRequest creates the Delete request.
func (client *IdentityProviderClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, serviceName string, identityProviderName IdentityProviderType, ifMatch string, _ *IdentityProviderClientDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/identityProviders/{identityProviderName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter subscriptionID cannot be empty")
	}
...
func (client *IdentityProviderClient) getCreateRequest(ctx context.Context, resourceGroupName string, serviceName string, identityProviderName IdentityProviderType, _ *IdentityProviderClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/identityProviders/{identityProviderName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter subscriptionID cannot be empty")
	}
...
func (client *IdentityProviderClient) getHandleResponse(resp *http.Response, successCodes ...int) (IdentityProviderClientGetResponse, error) {
...
func (client *IdentityProviderClient) getEntityTagCreateRequest(ctx context.Context, resourceGroupName string, serviceName string, identityProviderName IdentityProviderType, _ *IdentityProviderClientGetEntityTagOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/identityProviders/{identityProviderName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter subscriptionID cannot be empty")
	}
...
func (client *IdentityProviderClient) getEntityTagHandleResponse(resp *http.Response, successCodes ...int) (IdentityProviderClientGetEntityTagResponse, error) {
...
func (client *IdentityProviderClient) listByServiceCreateRequest(ctx context.Context, resourceGroupName string, serviceName string, nextLink string, _ *IdentityProviderClientListByServiceOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *IdentityProviderClient) listByServiceHandleResponse(resp *http.Response, successCodes ...int) (IdentityProviderClientListByServiceResponse, error) {
...
func (client *IdentityProviderClient) listSecretsCreateRequest(ctx context.Context, resourceGroupName string, serviceName string, identityProviderName IdentityProviderType, _ *IdentityProviderClientListSecretsOptions) (*policy.Request, error) {
...
func (client *IdentityProviderClient) listSecretsHandleResponse(resp *http.Response, successCodes ...int) (IdentityProviderClientListSecretsResponse, error) {
...
func (client *IdentityProviderClient) updateCreateRequest(ctx context.Context, resourceGroupName string, serviceName string, identityProviderName IdentityProviderType, ifMatch string, parameters IdentityProviderUpdateParameters, _ *IdentityProviderClientUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/identityProviders/{identityProviderName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter subscriptionID cannot be empty")
	}
...
func (client *IdentityProviderClient) updateHandleResponse(resp *http.Response, successCodes ...int) (IdentityProviderClientUpdateResponse, error) {
