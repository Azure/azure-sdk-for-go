...
const defaultIdentityProviderClientVersion string = "2025-09-01-preview"
...
func (client *IdentityProviderClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, serviceName string, identityProviderName IdentityProviderType, parameters IdentityProviderCreateContract, options *IdentityProviderClientCreateOrUpdateOptions) (*policy.Request, error) {
	...
	reqQP.Set("api-version", defaultIdentityProviderClientVersion)
...
func (client *IdentityProviderClient) listByServiceCreateRequest(ctx context.Context, resourceGroupName string, serviceName string, _ *IdentityProviderClientListByServiceOptions) (*policy.Request, error) {
