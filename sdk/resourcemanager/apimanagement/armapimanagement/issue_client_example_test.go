...
// Generated from example definition: 2025-09-01-preview/ApiManagementGetIssue.json
func ExampleIssueClient_Get() {
	...
	// res = armapimanagement.IssueClientGetResponse{
...
// Generated from example definition: 2025-09-01-preview/ApiManagementListIssues.json
func ExampleIssueClient_NewListByServicePager() {
	...
	pager := clientFactory.NewIssueClient().NewListByServicePager("rg1", "apimService1", nil)
	for pager.More() {
		...
		// page = armapimanagement.IssueClientListByServiceResponse{
