...
// Generated from example definition: 2025-09-01-preview/ApiManagementCreateAILogger.json
func ExampleLoggerClient_CreateOrUpdate_apiManagementCreateAiLogger() {
	...
	// res = armapimanagement.LoggerClientCreateOrUpdateResponse{
...
// Generated from example definition: 2025-09-01-preview/ApiManagementCreateEHLogger.json
...
// Generated from example definition: 2025-09-01-preview/ApiManagementDeleteLogger.json
func ExampleLoggerClient_Delete() {
	...
	res, err := clientFactory.NewLoggerClient().Delete(ctx, "rg1", "apimService1", "loggerId", "*", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.LoggerClientDeleteResponse{
	// }
}

// Generated from example definition: 2025-09-01-preview/ApiManagementGetLogger.json
func ExampleLoggerClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.LoggerClientGetResponse{
	// 	LoggerContract: armapimanagement.LoggerContract{
...
// Generated from example definition: 2025-09-01-preview/ApiManagementHeadLogger.json
func ExampleLoggerClient_GetEntityTag() {
	...
	res, err := clientFactory.NewLoggerClient().GetEntityTag(ctx, "rg1", "apimService1", "templateLogger", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.LoggerClientGetEntityTagResponse{
	// }
}

// Generated from example definition: 2025-09-01-preview/ApiManagementListLoggers.json
func ExampleLoggerClient_NewListByServicePager() {
	...
	pager := clientFactory.NewLoggerClient().NewListByServicePager("rg1", "apimService1", nil)
	for pager.More() {
		...
		// page = armapimanagement.LoggerClientListByServiceResponse{
...
// Generated from example definition: 2025-09-01-preview/ApiManagementUpdateLogger.json
func ExampleLoggerClient_Update() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.LoggerClientUpdateResponse{
	// 	LoggerContract: armapimanagement.LoggerContract{
	// 		Name: to.Ptr("eh1"),
	// 		Type: to.Ptr("Microsoft.ApiManagement/service/loggers"),
	// 		ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.ApiManagement/service/apimService1/loggers/eh1"),
