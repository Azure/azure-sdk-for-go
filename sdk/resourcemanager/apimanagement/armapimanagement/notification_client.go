...
func (client *NotificationClient) createOrUpdateHandleResponse(resp *http.Response, successCodes ...int) (NotificationClientCreateOrUpdateResponse, error) {
...
func (client *NotificationClient) getHandleResponse(resp *http.Response, successCodes ...int) (NotificationClientGetResponse, error) {
...
func (client *NotificationClient) listByServiceCreateRequest(ctx context.Context, resourceGroupName string, serviceName string, nextLink string, options *NotificationClientListByServiceOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *NotificationClient) listByServiceHandleResponse(resp *http.Response, successCodes ...int) (NotificationClientListByServiceResponse, error) {
