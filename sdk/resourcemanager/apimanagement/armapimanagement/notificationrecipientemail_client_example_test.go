...
// Generated from example definition: 2025-09-01-preview/ApiManagementCreateNotificationRecipientEmail.json
func ExampleNotificationRecipientEmailClient_CreateOrUpdate() {
	...
	// res = armapimanagement.NotificationRecipientEmailClientCreateOrUpdateResponse{
	// 	RecipientEmailContract: armapimanagement.RecipientEmailContract{
...
// Generated from example definition: 2025-09-01-preview/ApiManagementDeleteNotificationRecipientEmail.json
func ExampleNotificationRecipientEmailClient_Delete() {
	...
	res, err := clientFactory.NewNotificationRecipientEmailClient().Delete(ctx, "rg1", "apimService1", armapimanagement.NotificationNameRequestPublisherNotificationMessage, "contoso@live.com", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.NotificationRecipientEmailClientDeleteResponse{
	// }
}
