...
// Generated from example definition: 2025-09-01-preview/ApiManagementCreateOpenIdConnectProvider.json
func ExampleOpenIDConnectProviderClient_CreateOrUpdate() {
	...
	// res = armapimanagement.OpenIDConnectProviderClientCreateOrUpdateResponse{
	// 	OpenidConnectProviderContract: armapimanagement.OpenidConnectProviderContract{
...
// Generated from example definition: 2025-09-01-preview/ApiManagementDeleteOpenIdConnectProvider.json
func ExampleOpenIDConnectProviderClient_Delete() {
	...
	res, err := clientFactory.NewOpenIDConnectProviderClient().Delete(ctx, "rg1", "apimService1", "templateOpenIdConnect3", "*", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.OpenIDConnectProviderClientDeleteResponse{
	// }
}

// Generated from example definition: 2025-09-01-preview/ApiManagementGetOpenIdConnectProvider.json
func ExampleOpenIDConnectProviderClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.OpenIDConnectProviderClientGetResponse{
	// 	OpenidConnectProviderContract: armapimanagement.OpenidConnectProviderContract{
...
// Generated from example definition: 2025-09-01-preview/ApiManagementHeadOpenIdConnectProvider.json
func ExampleOpenIDConnectProviderClient_GetEntityTag() {
	...
	res, err := clientFactory.NewOpenIDConnectProviderClient().GetEntityTag(ctx, "rg1", "apimService1", "templateOpenIdConnect2", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.OpenIDConnectProviderClientGetEntityTagResponse{
	// }
}

// Generated from example definition: 2025-09-01-preview/ApiManagementListOpenIdConnectProviders.json
func ExampleOpenIDConnectProviderClient_NewListByServicePager() {
	...
	pager := clientFactory.NewOpenIDConnectProviderClient().NewListByServicePager("rg1", "apimService1", nil)
	for pager.More() {
		...
		// page = armapimanagement.OpenIDConnectProviderClientListByServiceResponse{
...
// Generated from example definition: 2025-09-01-preview/ApiManagementOpenidConnectProviderListSecrets.json
func ExampleOpenIDConnectProviderClient_ListSecrets() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.OpenIDConnectProviderClientListSecretsResponse{
...
// Generated from example definition: 2025-09-01-preview/ApiManagementUpdateOpenIdConnectProvider.json
func ExampleOpenIDConnectProviderClient_Update() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.OpenIDConnectProviderClientUpdateResponse{
	// 	OpenidConnectProviderContract: armapimanagement.OpenidConnectProviderContract{
	// 		Name: to.Ptr("templateOpenIdConnect2"),
	// 		Type: to.Ptr("Microsoft.ApiManagement/service/openidconnectproviders"),
	// 		ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.ApiManagement/service/apimService1/openidConnectProviders/templateOpenIdConnect2"),
