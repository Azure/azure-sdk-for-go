...
func (client *OperationClient) NewListByTagsPager(resourceGroupName string, serviceName string, apiID string, options *OperationClientListByTagsOptions) *runtime.Pager[OperationClientListByTagsResponse] {
	return runtime.NewPager(runtime.PagingHandler[OperationClientListByTagsResponse]{
		...
		Fetcher: func(ctx context.Context, page *OperationClientListByTagsResponse) (OperationClientListByTagsResponse, error) {
			...
			req, err := client.listByTagsCreateRequest(ctx, resourceGroupName, serviceName, apiID, nextLink, options)
			if err != nil {
...
func (client *OperationClient) listByTagsCreateRequest(ctx context.Context, resourceGroupName string, serviceName string, apiID string, nextLink string, options *OperationClientListByTagsOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *OperationClient) listByTagsHandleResponse(resp *http.Response, successCodes ...int) (OperationClientListByTagsResponse, error) {
