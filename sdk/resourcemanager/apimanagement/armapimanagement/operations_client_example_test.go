...
// Generated from example definition: 2025-09-01-preview/ApiManagementListOperations.json
func ExampleOperationsClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armapimanagement.OperationsClientListResponse{
		// 	OperationListResult: armapimanagement.OperationListResult{
