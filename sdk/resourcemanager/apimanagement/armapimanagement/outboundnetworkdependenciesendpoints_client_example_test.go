...
// Generated from example definition: 2025-09-01-preview/ApiManagementServiceGetOutboundNetworkDependenciesEndpoints.json
func ExampleOutboundNetworkDependenciesEndpointsClient_ListByService() {
	...
	// res = armapimanagement.OutboundNetworkDependenciesEndpointsClientListByServiceResponse{
	// 	OutboundEnvironmentEndpointList: armapimanagement.OutboundEnvironmentEndpointList{
