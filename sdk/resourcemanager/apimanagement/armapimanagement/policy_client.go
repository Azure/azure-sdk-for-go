...
func (client *PolicyClient) createOrUpdateHandleResponse(resp *http.Response, successCodes ...int) (PolicyClientCreateOrUpdateResponse, error) {
...
func (client *PolicyClient) Delete(ctx context.Context, resourceGroupName string, serviceName string, policyID PolicyIDName, ifMatch string, options *PolicyClientDeleteOptions) (PolicyClientDeleteResponse, error) {
	...
	if !runtime.HasStatusCode(httpResp, http.StatusOK, http.StatusNoContent) {
		return PolicyClientDeleteResponse{}, runtime.NewResponseError(httpResp)
	}
...
func (client *PolicyClient) getEntityTagHandleResponse(resp *http.Response, successCodes ...int) (PolicyClientGetEntityTagResponse, error) {
...
func (client *PolicyClient) listByServiceCreateRequest(ctx context.Context, resourceGroupName string, serviceName string, nextLink string, _ *PolicyClientListByServiceOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *PolicyClient) listByServiceHandleResponse(resp *http.Response, successCodes ...int) (PolicyClientListByServiceResponse, error) {
