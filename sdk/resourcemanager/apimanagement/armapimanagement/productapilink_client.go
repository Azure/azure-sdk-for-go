...
func (client *ProductAPILinkClient) createOrUpdateHandleResponse(resp *http.Response, successCodes ...int) (ProductAPILinkClientCreateOrUpdateResponse, error) {
...
func (client *ProductAPILinkClient) Delete(ctx context.Context, resourceGroupName string, serviceName string, productID string, apiLinkID string, options *ProductAPILinkClientDeleteOptions) (ProductAPILinkClientDeleteResponse, error) {
	...
	if !runtime.HasStatusCode(httpResp, http.StatusOK, http.StatusNoContent) {
		return ProductAPILinkClientDeleteResponse{}, runtime.NewResponseError(httpResp)
	}
...
func (client *ProductAPILinkClient) getHandleResponse(resp *http.Response, successCodes ...int) (ProductAPILinkClientGetResponse, error) {
...
func (client *ProductAPILinkClient) listByProductCreateRequest(ctx context.Context, resourceGroupName string, serviceName string, productID string, nextLink string, options *ProductAPILinkClientListByProductOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *ProductAPILinkClient) listByProductHandleResponse(resp *http.Response, successCodes ...int) (ProductAPILinkClientListByProductResponse, error) {
