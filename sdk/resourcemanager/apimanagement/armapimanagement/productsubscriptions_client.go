...
func (client *ProductSubscriptionsClient) listCreateRequest(ctx context.Context, resourceGroupName string, serviceName string, productID string, nextLink string, options *ProductSubscriptionsClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *ProductSubscriptionsClient) listHandleResponse(resp *http.Response, successCodes ...int) (ProductSubscriptionsClientListResponse, error) {
