...
// Generated from example definition: 2025-09-01-preview/ApiManagementListRegions.json
func ExampleRegionClient_NewListByServicePager() {
	...
	for pager.More() {
		...
		// page = armapimanagement.RegionClientListByServiceResponse{
		// 	RegionListResult: armapimanagement.RegionListResult{
