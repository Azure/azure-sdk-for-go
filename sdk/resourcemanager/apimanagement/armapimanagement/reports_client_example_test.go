...
// Generated from example definition: 2025-09-01-preview/ApiManagementGetReportsByApi.json
func ExampleReportsClient_NewListByAPIPager() {
	...
	pager := clientFactory.NewReportsClient().NewListByAPIPager("rg1", "apimService1", "timestamp ge datetime'2017-06-01T00:00:00' and timestamp le datetime'2017-06-04T00:00:00'", nil)
	for pager.More() {
		...
		// page = armapimanagement.ReportsClientListByAPIResponse{
		// 	ReportCollection: armapimanagement.ReportCollection{
...
// Generated from example definition: 2025-09-01-preview/ApiManagementGetReportsByGeo.json
func ExampleReportsClient_NewListByGeoPager() {
	...
	pager := clientFactory.NewReportsClient().NewListByGeoPager("rg1", "apimService1", "timestamp ge datetime'2017-06-01T00:00:00' and timestamp le datetime'2017-06-04T00:00:00'", nil)
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armapimanagement.ReportsClientListByGeoResponse{
		// 	ReportCollection: armapimanagement.ReportCollection{
		// 		NextLink: to.Ptr(""),
		// 		Value: []*armapimanagement.ReportRecordContract{
		// 			{
...
// Generated from example definition: 2025-09-01-preview/ApiManagementGetReportsByOperation.json
func ExampleReportsClient_NewListByOperationPager() {
	...
	pager := clientFactory.NewReportsClient().NewListByOperationPager("rg1", "apimService1", "timestamp ge datetime'2017-06-01T00:00:00' and timestamp le datetime'2017-06-04T00:00:00'", nil)
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armapimanagement.ReportsClientListByOperationResponse{
		// 	ReportCollection: armapimanagement.ReportCollection{
...
// Generated from example definition: 2025-09-01-preview/ApiManagementGetReportsByProduct.json
func ExampleReportsClient_NewListByProductPager() {
	...
	pager := clientFactory.NewReportsClient().NewListByProductPager("rg1", "apimService1", "timestamp ge datetime'2017-06-01T00:00:00' and timestamp le datetime'2017-06-04T00:00:00'", nil)
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armapimanagement.ReportsClientListByProductResponse{
		// 	ReportCollection: armapimanagement.ReportCollection{
		// 		Count: to.Ptr[int64](2),
		// 		NextLink: to.Ptr(""),
		// 		Value: []*armapimanagement.ReportRecordContract{
...
// Generated from example definition: 2025-09-01-preview/ApiManagementGetReportsByRequest.json
func ExampleReportsClient_NewListByRequestPager() {
	...
	pager := clientFactory.NewReportsClient().NewListByRequestPager("rg1", "apimService1", "timestamp ge datetime'2017-06-01T00:00:00' and timestamp le datetime'2017-06-04T00:00:00'", nil)
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armapimanagement.ReportsClientListByRequestResponse{
		// 	RequestReportCollection: armapimanagement.RequestReportCollection{
		// 		Count: to.Ptr[int64](2),
		...
		// 				Timestamp: to.Ptr(time.Date(2017, time.June, 3, 0, 17, 0, 164913400, time.UTC)),
		...
		// 				ServiceTime: to.Ptr[float64](0),
		// 				SubscriptionID: to.Ptr("/subscriptions/5600b59475ff190048070002"),
		// 				Timestamp: to.Ptr(time.Date(2017, time.June, 3, 0, 17, 20, 525513100, time.UTC)),
...
// Generated from example definition: 2025-09-01-preview/ApiManagementGetReportsBySubscription.json
func ExampleReportsClient_NewListBySubscriptionPager() {
	...
	pager := clientFactory.NewReportsClient().NewListBySubscriptionPager("rg1", "apimService1", "timestamp ge datetime'2017-06-01T00:00:00' and timestamp le datetime'2017-06-04T00:00:00'", nil)
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armapimanagement.ReportsClientListBySubscriptionResponse{
		// 	ReportCollection: armapimanagement.ReportCollection{
		// 		Count: to.Ptr[int64](3),
		// 		NextLink: to.Ptr(""),
		// 		Value: []*armapimanagement.ReportRecordContract{
...
// Generated from example definition: 2025-09-01-preview/ApiManagementGetReportsByTime.json
func ExampleReportsClient_NewListByTimePager() {
	...
	pager := clientFactory.NewReportsClient().NewListByTimePager("rg1", "apimService1", "timestamp ge datetime'2017-06-01T00:00:00' and timestamp le datetime'2017-06-04T00:00:00'", "PT15M", nil)
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armapimanagement.ReportsClientListByTimeResponse{
		// 	ReportCollection: armapimanagement.ReportCollection{
		// 		Count: to.Ptr[int64](2),
		// 		NextLink: to.Ptr(""),
		// 		Value: []*armapimanagement.ReportRecordContract{
		...
		// 				Timestamp: to.Ptr(time.Date(2017, time.June, 3, 0, 15, 0, 0, time.UTC)),
		// 			},
		// 			{
		...
		// 				ServiceTimeMin: to.Ptr[float64](215.24),
		// 				Timestamp: to.Ptr(time.Date(2017, time.June, 3, 0, 30, 0, 0, time.UTC)),
		// 			},
		// 		},
		// 	},
		// }
...
// Generated from example definition: 2025-09-01-preview/ApiManagementGetReportsByUser.json
func ExampleReportsClient_NewListByUserPager() {
	...
	pager := clientFactory.NewReportsClient().NewListByUserPager("rg1", "apimService1", "timestamp ge datetime'2017-06-01T00:00:00' and timestamp le datetime'2017-06-04T00:00:00'", nil)
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armapimanagement.ReportsClientListByUserResponse{
		// 	ReportCollection: armapimanagement.ReportCollection{
		// 		Count: to.Ptr[int64](3),
		// 		NextLink: to.Ptr(""),
		// 		Value: []*armapimanagement.ReportRecordContract{
