...
// Generated from example definition: 2025-09-01-preview/ApiManagementPortalSettingsPutSignUp.json
func ExampleSignUpSettingsClient_CreateOrUpdate() {
	...
	}, &armapimanagement.SignUpSettingsClientCreateOrUpdateOptions{
		IfMatch: to.Ptr("*")})
	if err != nil {
	...
	// res = armapimanagement.SignUpSettingsClientCreateOrUpdateResponse{
	// 	PortalSignupSettings: armapimanagement.PortalSignupSettings{
	// 		Name: to.Ptr("signup"),
...
// Generated from example definition: 2025-09-01-preview/ApiManagementPortalSettingsGetSignUp.json
func ExampleSignUpSettingsClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.SignUpSettingsClientGetResponse{
	// 	PortalSignupSettings: armapimanagement.PortalSignupSettings{
	// 		Name: to.Ptr("signup"),
	// 		Type: to.Ptr("Microsoft.ApiManagement/service/portalsettings"),
	// 		ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.ApiManagement/service/apimService1/portalsettings/signup"),
...
// Generated from example definition: 2025-09-01-preview/ApiManagementHeadSignUpSettings.json
func ExampleSignUpSettingsClient_GetEntityTag() {
	...
	res, err := clientFactory.NewSignUpSettingsClient().GetEntityTag(ctx, "rg1", "apimService1", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.SignUpSettingsClientGetEntityTagResponse{
	// }
}

// Generated from example definition: 2025-09-01-preview/ApiManagementPortalSettingsUpdateSignUp.json
