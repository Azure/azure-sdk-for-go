...
// Generated from example definition: 2025-09-01-preview/ApiManagementListSku.json
func ExampleSKUsClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armapimanagement.SKUsClientListResponse{
		// 	SKUsResult: armapimanagement.SKUsResult{
