...
// Generated from example definition: 2025-09-01-preview/ApiManagementCreateSubscription.json
func ExampleSubscriptionClient_CreateOrUpdate() {
	...
	// res = armapimanagement.SubscriptionClientCreateOrUpdateResponse{
...
// Generated from example definition: 2025-09-01-preview/ApiManagementDeleteSubscription.json
func ExampleSubscriptionClient_Delete() {
	...
	res, err := clientFactory.NewSubscriptionClient().Delete(ctx, "rg1", "apimService1", "testsub", "*", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.SubscriptionClientDeleteResponse{
	// }
}

// Generated from example definition: 2025-09-01-preview/ApiManagementGetSubscription.json
func ExampleSubscriptionClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.SubscriptionClientGetResponse{
	// 	SubscriptionContract: armapimanagement.SubscriptionContract{
...
// Generated from example definition: 2025-09-01-preview/ApiManagementHeadSubscription.json
func ExampleSubscriptionClient_GetEntityTag() {
	...
	res, err := clientFactory.NewSubscriptionClient().GetEntityTag(ctx, "rg1", "apimService1", "5931a769d8d14f0ad8ce13b8", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.SubscriptionClientGetEntityTagResponse{
	// }
}

// Generated from example definition: 2025-09-01-preview/ApiManagementListSubscriptions.json
func ExampleSubscriptionClient_NewListPager() {
	...
	pager := clientFactory.NewSubscriptionClient().NewListPager("rg1", "apimService1", nil)
	for pager.More() {
		...
		// page = armapimanagement.SubscriptionClientListResponse{
...
// Generated from example definition: 2025-09-01-preview/ApiManagementSubscriptionListSecrets.json
func ExampleSubscriptionClient_ListSecrets() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.SubscriptionClientListSecretsResponse{
...
// Generated from example definition: 2025-09-01-preview/ApiManagementSubscriptionRegeneratePrimaryKey.json
...
// Generated from example definition: 2025-09-01-preview/ApiManagementSubscriptionRegenerateSecondaryKey.json
...
// Generated from example definition: 2025-09-01-preview/ApiManagementUpdateSubscription.json
func ExampleSubscriptionClient_Update() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.SubscriptionClientUpdateResponse{
	// 	SubscriptionContract: armapimanagement.SubscriptionContract{
	// 		Name: to.Ptr("testsub"),
	// 		Type: to.Ptr("Microsoft.ApiManagement/service/subscriptions"),
	// 		ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.ApiManagement/service/apimService1/subscriptions/testsub"),
