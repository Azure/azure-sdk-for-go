...
func (client *TagOperationLinkClient) createOrUpdateHandleResponse(resp *http.Response, successCodes ...int) (TagOperationLinkClientCreateOrUpdateResponse, error) {
...
func (client *TagOperationLinkClient) Delete(ctx context.Context, resourceGroupName string, serviceName string, tagID string, operationLinkID string, options *TagOperationLinkClientDeleteOptions) (TagOperationLinkClientDeleteResponse, error) {
	...
	if !runtime.HasStatusCode(httpResp, http.StatusOK, http.StatusNoContent) {
		return TagOperationLinkClientDeleteResponse{}, runtime.NewResponseError(httpResp)
	}
...
func (client *TagOperationLinkClient) getHandleResponse(resp *http.Response, successCodes ...int) (TagOperationLinkClientGetResponse, error) {
...
func (client *TagOperationLinkClient) listByProductCreateRequest(ctx context.Context, resourceGroupName string, serviceName string, tagID string, nextLink string, options *TagOperationLinkClientListByProductOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *TagOperationLinkClient) listByProductHandleResponse(resp *http.Response, successCodes ...int) (TagOperationLinkClientListByProductResponse, error) {
