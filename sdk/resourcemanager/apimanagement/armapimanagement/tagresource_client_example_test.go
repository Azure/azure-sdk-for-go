...
// Generated from example definition: 2025-09-01-preview/ApiManagementListTagResources.json
func ExampleTagResourceClient_NewListByServicePager() {
	...
	pager := clientFactory.NewTagResourceClient().NewListByServicePager("rg1", "apimService1", nil)
	for pager.More() {
		...
		// page = armapimanagement.TagResourceClientListByServiceResponse{
