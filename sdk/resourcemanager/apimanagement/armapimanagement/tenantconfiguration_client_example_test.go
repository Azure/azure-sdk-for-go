...
// Generated from example definition: 2025-09-01-preview/ApiManagementTenantConfigurationDeploy.json
func ExampleTenantConfigurationClient_BeginDeploy() {
	...
	// res = armapimanagement.TenantConfigurationClientDeployResponse{
...
// Generated from example definition: 2025-09-01-preview/ApiManagementTenantAccessSyncState.json
func ExampleTenantConfigurationClient_GetSyncState() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.TenantConfigurationClientGetSyncStateResponse{
	// 	TenantConfigurationSyncStateContract: armapimanagement.TenantConfigurationSyncStateContract{
	// 		Name: to.Ptr("syncState"),
	// 		Type: to.Ptr("Microsoft.ApiManagement/service/tenant/syncState"),
	// 		ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.ApiManagement/service/apimService1/tenant/configuration/syncState/syncState"),
