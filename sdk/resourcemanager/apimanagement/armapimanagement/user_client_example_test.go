...
func ExampleUserClient_CreateOrUpdate() {
	...
	// 			},
	// 			LastName: to.Ptr("bar"),
	// 			RegistrationDate: to.Ptr(time.Date(2018, time.January, 7, 21, 21, 29, 160000000, time.UTC)),
...
func ExampleUserClient_Get() {
	...
	// 			},
	// 			LastName: to.Ptr("bar"),
	// 			RegistrationDate: to.Ptr(time.Date(2017, time.June, 2, 17, 58, 50, 357000000, time.UTC)),
	// 			State: to.Ptr(armapimanagement.UserStateActive),
	// 		},
	// 	},
	// }
...
func ExampleUserClient_GetSharedAccessToken() {
	...
	res, err := clientFactory.NewUserClient().GetSharedAccessToken(ctx, "rg1", "apimService1", "userId1718", armapimanagement.UserTokenParameters{
		Properties: &armapimanagement.UserTokenParameterProperties{
			Expiry:  to.Ptr(time.Date(2019, time.April, 21, 0, 44, 24, 284526900, time.UTC)),
...
func ExampleUserClient_NewListByServicePager() {
	...
	for pager.More() {
		...
		// 					},
		// 					LastName: to.Ptr(""),
		// 					RegistrationDate: to.Ptr(time.Date(2015, time.September, 22, 1, 57, 39, 677000000, time.UTC)),
		// 					State: to.Ptr(armapimanagement.UserStateActive),
		// 				},
		// 			},
		// 			{
		...
		// 					},
		// 					LastName: to.Ptr("bar"),
		// 					RegistrationDate: to.Ptr(time.Date(2016, time.March, 17, 17, 41, 56, 327000000, time.UTC)),
		// 					State: to.Ptr(armapimanagement.UserStateActive),
		// 				},
		// 			},
		// 			{
