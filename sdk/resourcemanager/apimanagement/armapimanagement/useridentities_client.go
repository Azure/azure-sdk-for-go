...
func (client *UserIdentitiesClient) NewListPager(resourceGroupName string, serviceName string, userID string, options *UserIdentitiesClientListOptions) *runtime.Pager[UserIdentitiesClientListResponse] {
	return runtime.NewPager(runtime.PagingHandler[UserIdentitiesClientListResponse]{
		...
		Fetcher: func(ctx context.Context, page *UserIdentitiesClientListResponse) (UserIdentitiesClientListResponse, error) {
			...
			req, err := client.listCreateRequest(ctx, resourceGroupName, serviceName, userID, nextLink, options)
			if err != nil {
...
func (client *UserIdentitiesClient) listCreateRequest(ctx context.Context, resourceGroupName string, serviceName string, userID string, nextLink string, _ *UserIdentitiesClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *UserIdentitiesClient) listHandleResponse(resp *http.Response, successCodes ...int) (UserIdentitiesClientListResponse, error) {
