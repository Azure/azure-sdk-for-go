...
// Generated from example definition: 2025-09-01-preview/ApiManagementListUserIdentities.json
func ExampleUserIdentitiesClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armapimanagement.UserIdentitiesClientListResponse{
		// 	UserIdentityCollection: armapimanagement.UserIdentityCollection{
		// 		NextLink: to.Ptr(""),
