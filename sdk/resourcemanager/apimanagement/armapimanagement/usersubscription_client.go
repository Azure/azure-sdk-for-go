...
func (client *UserSubscriptionClient) getHandleResponse(resp *http.Response, successCodes ...int) (UserSubscriptionClientGetResponse, error) {
...
func (client *UserSubscriptionClient) listCreateRequest(ctx context.Context, resourceGroupName string, serviceName string, userID string, nextLink string, options *UserSubscriptionClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *UserSubscriptionClient) listHandleResponse(resp *http.Response, successCodes ...int) (UserSubscriptionClientListResponse, error) {
