...
// Generated from example definition: 2025-09-01-preview/ApiManagementGetUserSubscription.json
func ExampleUserSubscriptionClient_Get() {
	...
	// res = armapimanagement.UserSubscriptionClientGetResponse{
	...
	// 			CreatedDate: to.Ptr(time.Date(2020, time.November, 9, 21, 11, 50, 580000000, time.UTC)),
...
// Generated from example definition: 2025-09-01-preview/ApiManagementListUserSubscriptions.json
func ExampleUserSubscriptionClient_NewListPager() {
	...
	pager := clientFactory.NewUserSubscriptionClient().NewListPager("rg1", "apimService1", "57681833a40f7eb6c49f6acf", nil)
	for pager.More() {
		...
		// page = armapimanagement.UserSubscriptionClientListResponse{
		...
		// 				Properties: &armapimanagement.SubscriptionContractProperties{
		// 					CreatedDate: to.Ptr(time.Date(2016, time.June, 20, 16, 22, 39, 547000000, time.UTC)),
		...
		// 					StartDate: to.Ptr(time.Date(2016, time.June, 20, 0, 0, 0, 0, time.UTC)),
		// 					State: to.Ptr(armapimanagement.SubscriptionStateActive),
		// 				},
		// 			},
		// 			{
		...
		// 				Properties: &armapimanagement.SubscriptionContractProperties{
		// 					CreatedDate: to.Ptr(time.Date(2016, time.June, 20, 16, 22, 41, 103000000, time.UTC)),
