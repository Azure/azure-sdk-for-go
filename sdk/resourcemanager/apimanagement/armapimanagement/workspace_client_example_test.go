...
// Generated from example definition: 2025-09-01-preview/ApiManagementCreateWorkspace.json
func ExampleWorkspaceClient_CreateOrUpdate() {
	...
	// res = armapimanagement.WorkspaceClientCreateOrUpdateResponse{
	// 	WorkspaceContract: armapimanagement.WorkspaceContract{
	// 		Name: to.Ptr("wks1"),
...
// Generated from example definition: 2025-09-01-preview/ApiManagementDeleteWorkspace.json
func ExampleWorkspaceClient_Delete() {
	...
	res, err := clientFactory.NewWorkspaceClient().Delete(ctx, "rg1", "apimService1", "wks1", "*", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.WorkspaceClientDeleteResponse{
	// }
}

// Generated from example definition: 2025-09-01-preview/ApiManagementGetWorkspace.json
func ExampleWorkspaceClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.WorkspaceClientGetResponse{
	// 	WorkspaceContract: armapimanagement.WorkspaceContract{
	// 		Name: to.Ptr("wks1"),
	// 		Type: to.Ptr("Microsoft.ApiManagement/service/workspaces"),
	// 		ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.ApiManagement/service/apimService1/workspaces/wks1"),
...
// Generated from example definition: 2025-09-01-preview/ApiManagementHeadWorkspace.json
func ExampleWorkspaceClient_GetEntityTag() {
	...
	res, err := clientFactory.NewWorkspaceClient().GetEntityTag(ctx, "rg1", "apimService1", "wks", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.WorkspaceClientGetEntityTagResponse{
	// }
}
...
// Generated from example definition: 2025-09-01-preview/ApiManagementUpdateWorkspace.json
func ExampleWorkspaceClient_Update() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.WorkspaceClientUpdateResponse{
	// 	WorkspaceContract: armapimanagement.WorkspaceContract{
	// 		Name: to.Ptr("wks1"),
	// 		Type: to.Ptr("Microsoft.ApiManagement/service/workspaces"),
	// 		ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.ApiManagement/service/apimService1/workspaces/wks1"),
