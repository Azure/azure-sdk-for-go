...
func (client *WorkspaceAPIDiagnosticClient) createOrUpdateHandleResponse(resp *http.Response, successCodes ...int) (WorkspaceAPIDiagnosticClientCreateOrUpdateResponse, error) {
...
func (client *WorkspaceAPIDiagnosticClient) Delete(ctx context.Context, resourceGroupName string, serviceName string, workspaceID string, apiID string, diagnosticID string, ifMatch string, options *WorkspaceAPIDiagnosticClientDeleteOptions) (WorkspaceAPIDiagnosticClientDeleteResponse, error) {
	...
	if !runtime.HasStatusCode(httpResp, http.StatusOK, http.StatusNoContent) {
		return WorkspaceAPIDiagnosticClientDeleteResponse{}, runtime.NewResponseError(httpResp)
	}
...
func (client *WorkspaceAPIDiagnosticClient) getHandleResponse(resp *http.Response, successCodes ...int) (WorkspaceAPIDiagnosticClientGetResponse, error) {
...
func (client *WorkspaceAPIDiagnosticClient) getEntityTagHandleResponse(resp *http.Response, successCodes ...int) (WorkspaceAPIDiagnosticClientGetEntityTagResponse, error) {
	result := WorkspaceAPIDiagnosticClientGetEntityTagResponse{}
	if !runtime.HasStatusCode(resp, successCodes...) {
		return result, runtime.NewResponseError(resp)
	}
	if val := resp.Header.Get("Etag"); val != "" {
...
func (client *WorkspaceAPIDiagnosticClient) NewListByWorkspacePager(resourceGroupName string, serviceName string, workspaceID string, apiID string, options *WorkspaceAPIDiagnosticClientListByWorkspaceOptions) *runtime.Pager[WorkspaceAPIDiagnosticClientListByWorkspaceResponse] {
	return runtime.NewPager(runtime.PagingHandler[WorkspaceAPIDiagnosticClientListByWorkspaceResponse]{
		...
		Fetcher: func(ctx context.Context, page *WorkspaceAPIDiagnosticClientListByWorkspaceResponse) (WorkspaceAPIDiagnosticClientListByWorkspaceResponse, error) {
			...
			req, err := client.listByWorkspaceCreateRequest(ctx, resourceGroupName, serviceName, workspaceID, apiID, nextLink, options)
			if err != nil {
...
func (client *WorkspaceAPIDiagnosticClient) listByWorkspaceCreateRequest(ctx context.Context, resourceGroupName string, serviceName string, workspaceID string, apiID string, nextLink string, options *WorkspaceAPIDiagnosticClientListByWorkspaceOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *WorkspaceAPIDiagnosticClient) listByWorkspaceHandleResponse(resp *http.Response, successCodes ...int) (WorkspaceAPIDiagnosticClientListByWorkspaceResponse, error) {
...
func (client *WorkspaceAPIDiagnosticClient) updateHandleResponse(resp *http.Response, successCodes ...int) (WorkspaceAPIDiagnosticClientUpdateResponse, error) {
