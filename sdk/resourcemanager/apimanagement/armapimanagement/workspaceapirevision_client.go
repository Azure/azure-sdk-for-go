...
func (client *WorkspaceAPIRevisionClient) listByServiceCreateRequest(ctx context.Context, resourceGroupName string, serviceName string, workspaceID string, apiID string, nextLink string, options *WorkspaceAPIRevisionClientListByServiceOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *WorkspaceAPIRevisionClient) listByServiceHandleResponse(resp *http.Response, successCodes ...int) (WorkspaceAPIRevisionClientListByServiceResponse, error) {
