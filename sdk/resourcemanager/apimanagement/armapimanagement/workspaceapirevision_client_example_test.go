...
// Generated from example definition: 2025-09-01-preview/ApiManagementListWorkspaceApiRevisions.json
func ExampleWorkspaceAPIRevisionClient_NewListByServicePager() {
	...
	pager := clientFactory.NewWorkspaceAPIRevisionClient().NewListByServicePager("rg1", "apimService1", "wks1", "57d2ef278aa04f0888cba3f3", nil)
	for pager.More() {
		...
		// page = armapimanagement.WorkspaceAPIRevisionClientListByServiceResponse{
