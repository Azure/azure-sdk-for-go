...
func (client *WorkspaceAPISchemaClient) Delete(ctx context.Context, resourceGroupName string, serviceName string, workspaceID string, apiID string, schemaID string, ifMatch string, options *WorkspaceAPISchemaClientDeleteOptions) (WorkspaceAPISchemaClientDeleteResponse, error) {
	...
	if !runtime.HasStatusCode(httpResp, http.StatusOK, http.StatusNoContent) {
		return WorkspaceAPISchemaClientDeleteResponse{}, runtime.NewResponseError(httpResp)
	}
...
func (client *WorkspaceAPISchemaClient) getHandleResponse(resp *http.Response, successCodes ...int) (WorkspaceAPISchemaClientGetResponse, error) {
...
func (client *WorkspaceAPISchemaClient) getEntityTagHandleResponse(resp *http.Response, successCodes ...int) (WorkspaceAPISchemaClientGetEntityTagResponse, error) {
...
func (client *WorkspaceAPISchemaClient) listByAPICreateRequest(ctx context.Context, resourceGroupName string, serviceName string, workspaceID string, apiID string, nextLink string, options *WorkspaceAPISchemaClientListByAPIOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *WorkspaceAPISchemaClient) listByAPIHandleResponse(resp *http.Response, successCodes ...int) (WorkspaceAPISchemaClientListByAPIResponse, error) {
