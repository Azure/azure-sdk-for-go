...
// Generated from example definition: 2025-09-01-preview/ApiManagementCreateWorkspaceBackendProxyBackend.json
func ExampleWorkspaceBackendClient_CreateOrUpdate_apiManagementCreateWorkspaceBackendProxyBackend() {
	...
	// res = armapimanagement.WorkspaceBackendClientCreateOrUpdateResponse{
...
// Generated from example definition: 2025-09-01-preview/ApiManagementCreateWorkspaceBackendServiceFabric.json
...
// Generated from example definition: 2025-09-01-preview/ApiManagementDeleteWorkspaceBackend.json
func ExampleWorkspaceBackendClient_Delete() {
	...
	res, err := clientFactory.NewWorkspaceBackendClient().Delete(ctx, "rg1", "apimService1", "wks1", "sfbackend", "*", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.WorkspaceBackendClientDeleteResponse{
	// }
}
...
// Generated from example definition: 2025-09-01-preview/ApiManagementHeadWorkspaceBackend.json
func ExampleWorkspaceBackendClient_GetEntityTag() {
	...
	res, err := clientFactory.NewWorkspaceBackendClient().GetEntityTag(ctx, "rg1", "apimService1", "wks1", "sfbackend", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.WorkspaceBackendClientGetEntityTagResponse{
	// }
}

// Generated from example definition: 2025-09-01-preview/ApiManagementListWorkspaceBackends.json
func ExampleWorkspaceBackendClient_NewListByWorkspacePager() {
	...
	pager := clientFactory.NewWorkspaceBackendClient().NewListByWorkspacePager("rg1", "apimService1", "wks1", nil)
	for pager.More() {
		...
		// page = armapimanagement.WorkspaceBackendClientListByWorkspaceResponse{
...
// Generated from example definition: 2025-09-01-preview/ApiManagementUpdateWorkspaceBackend.json
func ExampleWorkspaceBackendClient_Update() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.WorkspaceBackendClientUpdateResponse{
	// 	BackendContract: armapimanagement.BackendContract{
	// 		Name: to.Ptr("proxybackend"),
	// 		Type: to.Ptr("Microsoft.ApiManagement/service/workspaces/backends"),
	// 		ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.ApiManagement/service/apimService1/workspaces/wks1/backends/proxybackend"),
