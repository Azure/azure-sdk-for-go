...
func (client *WorkspaceGlobalSchemaClient) Delete(ctx context.Context, resourceGroupName string, serviceName string, workspaceID string, schemaID string, ifMatch string, options *WorkspaceGlobalSchemaClientDeleteOptions) (WorkspaceGlobalSchemaClientDeleteResponse, error) {
	...
	if !runtime.HasStatusCode(httpResp, http.StatusOK, http.StatusNoContent) {
		return WorkspaceGlobalSchemaClientDeleteResponse{}, runtime.NewResponseError(httpResp)
	}
...
func (client *WorkspaceGlobalSchemaClient) getHandleResponse(resp *http.Response, successCodes ...int) (WorkspaceGlobalSchemaClientGetResponse, error) {
...
func (client *WorkspaceGlobalSchemaClient) getEntityTagHandleResponse(resp *http.Response, successCodes ...int) (WorkspaceGlobalSchemaClientGetEntityTagResponse, error) {
...
func (client *WorkspaceGlobalSchemaClient) listByServiceCreateRequest(ctx context.Context, resourceGroupName string, serviceName string, workspaceID string, nextLink string, options *WorkspaceGlobalSchemaClientListByServiceOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *WorkspaceGlobalSchemaClient) listByServiceHandleResponse(resp *http.Response, successCodes ...int) (WorkspaceGlobalSchemaClientListByServiceResponse, error) {
