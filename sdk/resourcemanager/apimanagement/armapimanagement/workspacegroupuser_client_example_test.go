...
// Generated from example definition: 2025-09-01-preview/ApiManagementHeadWorkspaceGroupUser.json
...
// Generated from example definition: 2025-09-01-preview/ApiManagementCreateWorkspaceGroupUser.json
func ExampleWorkspaceGroupUserClient_Create() {
	...
	// res = armapimanagement.WorkspaceGroupUserClientCreateResponse{
...
// Generated from example definition: 2025-09-01-preview/ApiManagementDeleteWorkspaceGroupUser.json
func ExampleWorkspaceGroupUserClient_Delete() {
	...
	res, err := clientFactory.NewWorkspaceGroupUserClient().Delete(ctx, "rg1", "apimService1", "wks1", "templategroup", "59307d350af58404d8a26300", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapimanagement.WorkspaceGroupUserClientDeleteResponse{
	// }
}
