...
const defaultWorkspaceLinkClientVersion string = "2025-09-01-preview"

// WorkspaceLinkClient contains the methods for the WorkspaceLink group.
...
func (client *WorkspaceLinkClient) getCreateRequest(ctx context.Context, resourceGroupName string, serviceName string, workspaceID string, _ *WorkspaceLinkClientGetOptions) (*policy.Request, error) {
	...
	reqQP.Set("api-version", defaultWorkspaceLinkClientVersion)
