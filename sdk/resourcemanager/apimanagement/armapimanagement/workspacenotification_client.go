...
func (client *WorkspaceNotificationClient) createOrUpdateHandleResponse(resp *http.Response, successCodes ...int) (WorkspaceNotificationClientCreateOrUpdateResponse, error) {
...
func (client *WorkspaceNotificationClient) getHandleResponse(resp *http.Response, successCodes ...int) (WorkspaceNotificationClientGetResponse, error) {
...
func (client *WorkspaceNotificationClient) listByServiceCreateRequest(ctx context.Context, resourceGroupName string, serviceName string, workspaceID string, nextLink string, options *WorkspaceNotificationClientListByServiceOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *WorkspaceNotificationClient) listByServiceHandleResponse(resp *http.Response, successCodes ...int) (WorkspaceNotificationClientListByServiceResponse, error) {
