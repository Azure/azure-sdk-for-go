...
func (client *WorkspacePolicyFragmentClient) Delete(ctx context.Context, resourceGroupName string, serviceName string, workspaceID string, id string, ifMatch string, options *WorkspacePolicyFragmentClientDeleteOptions) (WorkspacePolicyFragmentClientDeleteResponse, error) {
	...
	if !runtime.HasStatusCode(httpResp, http.StatusOK, http.StatusNoContent) {
		return WorkspacePolicyFragmentClientDeleteResponse{}, runtime.NewResponseError(httpResp)
	}
...
func (client *WorkspacePolicyFragmentClient) getHandleResponse(resp *http.Response, successCodes ...int) (WorkspacePolicyFragmentClientGetResponse, error) {
...
func (client *WorkspacePolicyFragmentClient) getEntityTagHandleResponse(resp *http.Response, successCodes ...int) (WorkspacePolicyFragmentClientGetEntityTagResponse, error) {
...
func (client *WorkspacePolicyFragmentClient) listByServiceCreateRequest(ctx context.Context, resourceGroupName string, serviceName string, workspaceID string, nextLink string, options *WorkspacePolicyFragmentClientListByServiceOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *WorkspacePolicyFragmentClient) listByServiceHandleResponse(resp *http.Response, successCodes ...int) (WorkspacePolicyFragmentClientListByServiceResponse, error) {
...
func (client *WorkspacePolicyFragmentClient) listReferencesHandleResponse(resp *http.Response, successCodes ...int) (WorkspacePolicyFragmentClientListReferencesResponse, error) {
