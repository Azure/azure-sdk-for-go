...
func NewAPIDiagnosticClient(con *arm.Connection, subscriptionID string) *APIDiagnosticClient {
	return &APIDiagnosticClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
