...
func NewSignInSettingsClient(con *arm.Connection, subscriptionID string) *SignInSettingsClient {
	return &SignInSettingsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
