...
func (client *CertificatesClient) List(resourceGroupName string, managedEnvironmentName string, options *CertificatesClientListOptions) *CertificatesClientListPager {
	return &CertificatesClientListPager{
		client: client,
		requester: func(ctx context.Context) (*policy.Request, error) {
			return client.listCreateRequest(ctx, resourceGroupName, managedEnvironmentName, options)
		},
