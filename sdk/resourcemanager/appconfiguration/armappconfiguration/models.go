...
// ConfigurationStoreListResult - The response of a ConfigurationStore list operation.
type ConfigurationStoreListResult struct {
	// REQUIRED; The ConfigurationStore items on this page
...
// DeletedConfigurationStoreListResult - The response of a DeletedConfigurationStore list operation.
type DeletedConfigurationStoreListResult struct {
	// REQUIRED; The DeletedConfigurationStore items on this page
...
type KeyValueProperties struct {
	...
	// READ-ONLY; The primary identifier of a key-value.
	// The key is used in unison with the label to uniquely identify a key-value.
	Key *string

	// READ-ONLY; A value used to group key-values.
	...
	// READ-ONLY; A value indicating whether the key-value is locked.
...
type OperationDefinitionListResult struct {
	...
	// READ-ONLY; The URI that can be used to request the next set of paged results.
	NextLink *string
}
