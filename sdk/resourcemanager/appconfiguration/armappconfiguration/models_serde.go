...
func (a APIKey) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "lastModified", a.LastModified, true)
...
func (a *APIKey) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "id":
			...
			delete(rawMsg, key)
		case "lastModified":
			err = unpopulateTime[datetime.RFC3339](val, "LastModified", &a.LastModified)
			delete(rawMsg, key)
		case "name":
...
// MarshalJSON implements the json.Marshaller interface for type AzureFrontDoorProperties.
func (a AzureFrontDoorProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "resourceId", a.ResourceID)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type AzureFrontDoorProperties.
func (a *AzureFrontDoorProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %s", a, err.Error())
	}
...
func (c ConfigurationStoreProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "azureFrontDoor", c.AzureFrontDoor)
	...
	populate(objectMap, "telemetry", c.Telemetry)
	return json.Marshal(objectMap)
}
...
func (c *ConfigurationStoreProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "azureFrontDoor":
			err = unpopulate(val, "AzureFrontDoor", &c.AzureFrontDoor)
			delete(rawMsg, key)
		case "createMode":
		...
		case "softDeleteRetentionInDays":
			...
			delete(rawMsg, key)
		case "telemetry":
			err = unpopulate(val, "Telemetry", &c.Telemetry)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %s", c, err.Error())
...
func (d DeletedConfigurationStoreProperties) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "deletionDate", d.DeletionDate, true)
	populate(objectMap, "location", d.Location)
	populate(objectMap, "purgeProtectionEnabled", d.PurgeProtectionEnabled)
	populateTime[datetime.RFC3339](objectMap, "scheduledPurgeDate", d.ScheduledPurgeDate, true)
...
func (k KeyValueProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "key", k.Key)
	populate(objectMap, "label", k.Label)
	populateTime[datetime.RFC3339](objectMap, "lastModified", k.LastModified, true)
...
func (s SnapshotProperties) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "expires", s.Expires, true)
...
// MarshalJSON implements the json.Marshaller interface for type TelemetryProperties.
func (t TelemetryProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "resourceId", t.ResourceID)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type TelemetryProperties.
func (t *TelemetryProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
