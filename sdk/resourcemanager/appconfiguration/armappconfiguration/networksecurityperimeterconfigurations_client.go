...
func (client *NetworkSecurityPerimeterConfigurationsClient) listByConfigurationStoreCreateRequest(ctx context.Context, resourceGroupName string, configStoreName string, nextLink string, _ *NetworkSecurityPerimeterConfigurationsClientListByConfigurationStoreOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *NetworkSecurityPerimeterConfigurationsClient) listByConfigurationStoreHandleResponse(resp *http.Response, successCodes ...int) (NetworkSecurityPerimeterConfigurationsClientListByConfigurationStoreResponse, error) {
