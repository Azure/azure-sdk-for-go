...
// This operation cannot be used to create a private endpoint connection. Private endpoint connections must be created with
...
func (client *PrivateEndpointConnectionsClient) NewListByConfigurationStorePager(resourceGroupName string, configStoreName string, options *PrivateEndpointConnectionsClientListByConfigurationStoreOptions) *runtime.Pager[PrivateEndpointConnectionsClientListByConfigurationStoreResponse] {
	return runtime.NewPager(runtime.PagingHandler[PrivateEndpointConnectionsClientListByConfigurationStoreResponse]{
		...
		Fetcher: func(ctx context.Context, page *PrivateEndpointConnectionsClientListByConfigurationStoreResponse) (PrivateEndpointConnectionsClientListByConfigurationStoreResponse, error) {
			...
			req, err := client.listByConfigurationStoreCreateRequest(ctx, resourceGroupName, configStoreName, nextLink, options)
			if err != nil {
			...
			return client.listByConfigurationStoreHandleResponse(resp, http.StatusOK)
		},
		Tracer: client.internal.Tracer(),
	})
}
...
func (client *PrivateEndpointConnectionsClient) listByConfigurationStoreCreateRequest(ctx context.Context, resourceGroupName string, configStoreName string, nextLink string, _ *PrivateEndpointConnectionsClientListByConfigurationStoreOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *PrivateEndpointConnectionsClient) listByConfigurationStoreHandleResponse(resp *http.Response, successCodes ...int) (PrivateEndpointConnectionsClientListByConfigurationStoreResponse, error) {
