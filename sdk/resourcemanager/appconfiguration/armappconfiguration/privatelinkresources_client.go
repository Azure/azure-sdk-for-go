...
func (client *PrivateLinkResourcesClient) listByConfigurationStoreCreateRequest(ctx context.Context, resourceGroupName string, configStoreName string, nextLink string, _ *PrivateLinkResourcesClientListByConfigurationStoreOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *PrivateLinkResourcesClient) listByConfigurationStoreHandleResponse(resp *http.Response, successCodes ...int) (PrivateLinkResourcesClientListByConfigurationStoreResponse, error) {
