...
- Type of `CertificateProperties.Value` has been changed from `[]byte` to `*string`
- Type of `CustomDomainConfiguration.CertificateValue` has been changed from `[]byte` to `*string`
