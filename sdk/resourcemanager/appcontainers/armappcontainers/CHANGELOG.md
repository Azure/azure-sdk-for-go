...
- Type of `ManagedIdentitySetting.Lifecycle` has been changed from `*IdentitySettingsLifeCycle` to `*SessionPoolIdentityLifeCycle`
...
- New enum type `ContainerAppsFunctionState` with values `ContainerAppsFunctionStateDisabled`, `ContainerAppsFunctionStateEnabled`
...
- New enum type `ManagedEnvironmentMode` with values `ManagedEnvironmentModeArchived`, `ManagedEnvironmentModeConsumptionOnly`, `ManagedEnvironmentModeExpress`, `ManagedEnvironmentModeWorkloadProfiles`
- New enum type `SandboxGroupProvisioningState` with values `SandboxGroupProvisioningStateCanceled`, `SandboxGroupProvisioningStateDeleting`, `SandboxGroupProvisioningStateFailed`, `SandboxGroupProvisioningStateInProgress`, `SandboxGroupProvisioningStateSucceeded`, `SandboxGroupProvisioningStateUpdating`
- New enum type `SessionPoolIdentityLifeCycle` with values `SessionPoolIdentityLifeCycleMain`, `SessionPoolIdentityLifeCycleNone`
...
- New enum type `VnetConnectionProvisioningState` with values `VnetConnectionProvisioningStateCanceled`, `VnetConnectionProvisioningStateDeleting`, `VnetConnectionProvisioningStateFailed`, `VnetConnectionProvisioningStateInProgress`, `VnetConnectionProvisioningStateSucceeded`, `VnetConnectionProvisioningStateUpdating`
- New function `NewAvailableEnvironmentModesClient(subscriptionID string, credential azcore.TokenCredential, options *arm.ClientOptions) (*AvailableEnvironmentModesClient, error)`
- New function `*AvailableEnvironmentModesClient.NewListPager(location string, options *AvailableEnvironmentModesClientListOptions) *runtime.Pager[AvailableEnvironmentModesClientListResponse]`
- New function `*ClientFactory.NewAvailableEnvironmentModesClient() *AvailableEnvironmentModesClient`
- New function `*ClientFactory.NewContainerAppPrivateEndpointConnectionsClient() *ContainerAppPrivateEndpointConnectionsClient`
- New function `*ClientFactory.NewContainerAppPrivateLinkResourcesClient() *ContainerAppPrivateLinkResourcesClient`
...
- New function `*ClientFactory.NewVnetConnectionsClient() *VnetConnectionsClient`
- New function `NewContainerAppPrivateEndpointConnectionsClient(subscriptionID string, credential azcore.TokenCredential, options *arm.ClientOptions) (*ContainerAppPrivateEndpointConnectionsClient, error)`
- New function `*ContainerAppPrivateEndpointConnectionsClient.BeginCreateOrUpdate(ctx context.Context, resourceGroupName string, containerAppName string, privateEndpointConnectionName string, privateEndpointConnectionEnvelope PrivateEndpointConnection, options *ContainerAppPrivateEndpointConnectionsClientBeginCreateOrUpdateOptions) (*runtime.Poller[ContainerAppPrivateEndpointConnectionsClientCreateOrUpdateResponse], error)`
- New function `*ContainerAppPrivateEndpointConnectionsClient.BeginDelete(ctx context.Context, resourceGroupName string, containerAppName string, privateEndpointConnectionName string, options *ContainerAppPrivateEndpointConnectionsClientBeginDeleteOptions) (*runtime.Poller[ContainerAppPrivateEndpointConnectionsClientDeleteResponse], error)`
- New function `*ContainerAppPrivateEndpointConnectionsClient.Get(ctx context.Context, resourceGroupName string, containerAppName string, privateEndpointConnectionName string, options *ContainerAppPrivateEndpointConnectionsClientGetOptions) (ContainerAppPrivateEndpointConnectionsClientGetResponse, error)`
- New function `*ContainerAppPrivateEndpointConnectionsClient.NewListPager(resourceGroupName string, containerAppName string, options *ContainerAppPrivateEndpointConnectionsClientListOptions) *runtime.Pager[ContainerAppPrivateEndpointConnectionsClientListResponse]`
- New function `NewContainerAppPrivateLinkResourcesClient(subscriptionID string, credential azcore.TokenCredential, options *arm.ClientOptions) (*ContainerAppPrivateLinkResourcesClient, error)`
- New function `*ContainerAppPrivateLinkResourcesClient.Get(ctx context.Context, resourceGroupName string, containerAppName string, privateLinkResourceName string, options *ContainerAppPrivateLinkResourcesClientGetOptions) (ContainerAppPrivateLinkResourcesClientGetResponse, error)`
- New function `*ContainerAppPrivateLinkResourcesClient.NewListPager(resourceGroupName string, containerAppName string, options *ContainerAppPrivateLinkResourcesClientListOptions) *runtime.Pager[ContainerAppPrivateLinkResourcesClientListResponse]`
...
- New function `*ManagedEnvironmentPrivateLinkResourcesClient.Get(ctx context.Context, resourceGroupName string, environmentName string, privateLinkResourceName string, options *ManagedEnvironmentPrivateLinkResourcesClientGetOptions) (ManagedEnvironmentPrivateLinkResourcesClientGetResponse, error)`
- New function `*ManagedEnvironmentsClient.CheckMigrationEligibility(ctx context.Context, resourceGroupName string, environmentName string, body CheckMigrationEligibilityRequest, options *ManagedEnvironmentsClientCheckMigrationEligibilityOptions) (ManagedEnvironmentsClientCheckMigrationEligibilityResponse, error)`
...
- New function `*SandboxGroupsClient.BeginUpdate(ctx context.Context, resourceGroupName string, sandboxGroupName string, properties SandboxGroupPatch, options *SandboxGroupsClientBeginUpdateOptions) (*runtime.Poller[SandboxGroupsClientUpdateResponse], error)`
- New function `NewVnetConnectionsClient(subscriptionID string, credential azcore.TokenCredential, options *arm.ClientOptions) (*VnetConnectionsClient, error)`
- New function `*VnetConnectionsClient.CreateOrUpdate(ctx context.Context, resourceGroupName string, sandboxGroupName string, vnetConnectionName string, resource VnetConnection, options *VnetConnectionsClientCreateOrUpdateOptions) (VnetConnectionsClientCreateOrUpdateResponse, error)`
- New function `*VnetConnectionsClient.BeginDelete(ctx context.Context, resourceGroupName string, sandboxGroupName string, vnetConnectionName string, options *VnetConnectionsClientBeginDeleteOptions) (*runtime.Poller[VnetConnectionsClientDeleteResponse], error)`
- New function `*VnetConnectionsClient.Get(ctx context.Context, resourceGroupName string, sandboxGroupName string, vnetConnectionName string, options *VnetConnectionsClientGetOptions) (VnetConnectionsClientGetResponse, error)`
- New function `*VnetConnectionsClient.NewListBySandboxGroupPager(resourceGroupName string, sandboxGroupName string, options *VnetConnectionsClientListBySandboxGroupOptions) *runtime.Pager[VnetConnectionsClientListBySandboxGroupResponse]`
- New struct `AppInsightsConfiguration`
- New struct `AvailableEnvironmentMode`
- New struct `AvailableEnvironmentModeProperties`
- New struct `AvailableEnvironmentModesCollection`
- New struct `CheckMigrationEligibilityRequest`
- New struct `CheckMigrationEligibilityResponse`
- New struct `ContainerAppNetworkingConfiguration`
...
- New struct `MigrationEligibilityFailureReason`
...
- New struct `SandboxGroupPatch`
- New struct `SandboxGroupPatchProperties`
...
- New struct `VnetConnection`
- New struct `VnetConnectionListResult`
- New struct `VnetConnectionProperties`
- New field `BlobContainerURI`, `ClientID`, `ManagedIdentityResourceID` in struct `BlobStorageTokenStore`
- New field `Networking` in struct `ContainerAppProperties`
...
- New field `AppInsightsConfiguration`, `EnvironmentMode`, `OpenTelemetryConfiguration` in struct `ManagedEnvironmentProperties`
- New field `DebugEndpoint` in struct `ReplicaContainer`
- New field `AllowScalingRuleOverride` in struct `Scale`
