...
// Generated from example definition: 2025-10-02-preview/AppResiliency_CreateOrUpdate.json
func ExampleAppResiliencyClient_CreateOrUpdate() {
	...
	// res = armappcontainers.AppResiliencyClientCreateOrUpdateResponse{
	// 	AppResiliency: &armappcontainers.AppResiliency{
...
// Generated from example definition: 2025-10-02-preview/AppResiliency_Delete.json
func ExampleAppResiliencyClient_Delete() {
	...
	res, err := clientFactory.NewAppResiliencyClient().Delete(ctx, "rg", "testcontainerApp0", "resiliency-policy-1", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armappcontainers.AppResiliencyClientDeleteResponse{
	// }
}

// Generated from example definition: 2025-10-02-preview/AppResiliency_Get.json
func ExampleAppResiliencyClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armappcontainers.AppResiliencyClientGetResponse{
	// 	AppResiliency: &armappcontainers.AppResiliency{
	// 		Name: to.Ptr("resiliency-policy-1"),
	// 		Type: to.Ptr("Microsoft.App/containerApps/resiliencyPolicies"),
	// 		ID: to.Ptr("/subscriptions/34adfa4f-cedf-4dc0-ba29-b6d1a69ab345/resourceGroups/rg/providers/Microsoft.App/containerApps/testcontainerApp0/resiliencyPolicies/resiliency-policy-1"),
...
// Generated from example definition: 2025-10-02-preview/AppResiliency_List.json
func ExampleAppResiliencyClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armappcontainers.AppResiliencyClientListResponse{
		// 	AppResiliencyCollection: armappcontainers.AppResiliencyCollection{
...
// Generated from example definition: 2025-10-02-preview/AppResiliency_Patch.json
func ExampleAppResiliencyClient_Update() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armappcontainers.AppResiliencyClientUpdateResponse{
	// 	AppResiliency: &armappcontainers.AppResiliency{
	// 		Name: to.Ptr("resiliency-policy-1"),
	// 		Type: to.Ptr("Microsoft.App/containerApps/resiliencyPolicies"),
	// 		ID: to.Ptr("/subscriptions/34adfa4f-cedf-4dc0-ba29-b6d1a69ab345/resourceGroups/rg/providers/Microsoft.App/containerApps/testcontainerApp0/resiliencyPolicies/resiliency-policy-1"),
