...
func (client *AvailableWorkloadProfilesClient) getCreateRequest(ctx context.Context, location string, nextLink string, _ *AvailableWorkloadProfilesClientGetOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *AvailableWorkloadProfilesClient) getHandleResponse(resp *http.Response, successCodes ...int) (AvailableWorkloadProfilesClientGetResponse, error) {
