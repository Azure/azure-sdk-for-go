...
func ExampleAvailableWorkloadProfilesClient_NewGetPager() {
	...
	for pager.More() {
		...
		// page = armappcontainers.AvailableWorkloadProfilesClientGetResponse{
		// 	AvailableWorkloadProfilesCollection: armappcontainers.AvailableWorkloadProfilesCollection{
