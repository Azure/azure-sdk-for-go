...
func (client *BuildersClient) getHandleResponse(resp *http.Response, successCodes ...int) (BuildersClientGetResponse, error) {
...
func (client *BuildersClient) listByResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, nextLink string, _ *BuildersClientListByResourceGroupOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *BuildersClient) listByResourceGroupHandleResponse(resp *http.Response, successCodes ...int) (BuildersClientListByResourceGroupResponse, error) {
...
func (client *BuildersClient) listBySubscriptionCreateRequest(ctx context.Context, nextLink string, _ *BuildersClientListBySubscriptionOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
	var req *policy.Request
	var err error
	if firstPage {
...
func (client *BuildersClient) listBySubscriptionHandleResponse(resp *http.Response, successCodes ...int) (BuildersClientListBySubscriptionResponse, error) {
