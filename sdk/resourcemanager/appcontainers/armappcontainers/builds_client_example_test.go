...
// Generated from example definition: 2025-10-02-preview/Builds_CreateOrUpdate.json
...
// Generated from example definition: 2025-10-02-preview/Builds_Delete.json
...
// Generated from example definition: 2025-10-02-preview/Builds_Get.json
func ExampleBuildsClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armappcontainers.BuildsClientGetResponse{
	// 	BuildResource: &armappcontainers.BuildResource{
	// 		Name: to.Ptr("testBuild"),
	// 		Type: to.Ptr("Microsoft.App/builders/builds"),
	// 		ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourcegroups/rg/providers/Microsoft.App/builders/testBuilder/builds/testBuild"),
