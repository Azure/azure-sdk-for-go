...
func (client *BuildsByBuilderResourceClient) NewListPager(resourceGroupName string, builderName string, options *BuildsByBuilderResourceClientListOptions) *runtime.Pager[BuildsByBuilderResourceClientListResponse] {
	return runtime.NewPager(runtime.PagingHandler[BuildsByBuilderResourceClientListResponse]{
		...
		Fetcher: func(ctx context.Context, page *BuildsByBuilderResourceClientListResponse) (BuildsByBuilderResourceClientListResponse, error) {
			...
			req, err := client.listCreateRequest(ctx, resourceGroupName, builderName, nextLink, options)
			if err != nil {
...
func (client *BuildsByBuilderResourceClient) listCreateRequest(ctx context.Context, resourceGroupName string, builderName string, nextLink string, _ *BuildsByBuilderResourceClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *BuildsByBuilderResourceClient) listHandleResponse(resp *http.Response, successCodes ...int) (BuildsByBuilderResourceClientListResponse, error) {
