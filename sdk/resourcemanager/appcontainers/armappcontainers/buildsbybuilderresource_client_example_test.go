...
// Generated from example definition: 2025-10-02-preview/Builds_ListByBuilderResource.json
func ExampleBuildsByBuilderResourceClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armappcontainers.BuildsByBuilderResourceClientListResponse{
		// 	BuildCollection: armappcontainers.BuildCollection{
