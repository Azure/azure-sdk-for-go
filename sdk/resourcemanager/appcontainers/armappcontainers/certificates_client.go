...
func (client *CertificatesClient) listCreateRequest(ctx context.Context, resourceGroupName string, environmentName string, nextLink string, _ *CertificatesClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
