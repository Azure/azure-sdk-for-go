...
func ExampleConnectedEnvironmentsCertificatesClient_BeginCreateOrUpdate() {
	...
	poller, err := clientFactory.NewConnectedEnvironmentsCertificatesClient().BeginCreateOrUpdate(ctx, "examplerg", "testcontainerenv", "certificate-firendly-name", armappcontainers.Certificate{
	...
	// res = armappcontainers.ConnectedEnvironmentsCertificatesClientCreateOrUpdateResponse{
...
func ExampleConnectedEnvironmentsCertificatesClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armappcontainers.ConnectedEnvironmentsCertificatesClientGetResponse{
	// 	Certificate: &armappcontainers.Certificate{
...
func ExampleConnectedEnvironmentsCertificatesClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armappcontainers.ConnectedEnvironmentsCertificatesClientListResponse{
...
func ExampleConnectedEnvironmentsCertificatesClient_BeginUpdate() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armappcontainers.ConnectedEnvironmentsCertificatesClientUpdateResponse{
	// 	Certificate: &armappcontainers.Certificate{
	// 		Type: to.Ptr("Microsoft.App/ConnectedEnvironments/Certificates"),
	// 		ID: to.Ptr("/subscriptions/34adfa4f-cedf-4dc0-ba29-b6d1a69ab345/resourceGroups/examplerg/providers/Microsoft.App/connectedEnvironments/testcontainerenv/certificates/certificate-firendly-name"),
	// 		Location: to.Ptr("East US"),
