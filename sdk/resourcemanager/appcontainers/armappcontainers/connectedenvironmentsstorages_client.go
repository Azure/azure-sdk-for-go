...
// NewListPager - Get all storages for a connectedEnvironment.
//
...
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - connectedEnvironmentName - Name of the connectedEnvironment.
//   - options - ConnectedEnvironmentsStoragesClientListOptions contains the optional parameters for the ConnectedEnvironmentsStoragesClient.NewListPager
//     method.
func (client *ConnectedEnvironmentsStoragesClient) NewListPager(resourceGroupName string, connectedEnvironmentName string, options *ConnectedEnvironmentsStoragesClientListOptions) *runtime.Pager[ConnectedEnvironmentsStoragesClientListResponse] {
	return runtime.NewPager(runtime.PagingHandler[ConnectedEnvironmentsStoragesClientListResponse]{
		More: func(page ConnectedEnvironmentsStoragesClientListResponse) bool {
			return false
		},
		Fetcher: func(ctx context.Context, page *ConnectedEnvironmentsStoragesClientListResponse) (ConnectedEnvironmentsStoragesClientListResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "ConnectedEnvironmentsStoragesClient.NewListPager")
