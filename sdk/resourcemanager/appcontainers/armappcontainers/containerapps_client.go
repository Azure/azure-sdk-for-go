...
func (client *ContainerAppsClient) getHandleResponse(resp *http.Response, successCodes ...int) (ContainerAppsClientGetResponse, error) {
...
func (client *ContainerAppsClient) getAuthTokenHandleResponse(resp *http.Response, successCodes ...int) (ContainerAppsClientGetAuthTokenResponse, error) {
...
func (client *ContainerAppsClient) listByResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, nextLink string, _ *ContainerAppsClientListByResourceGroupOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *ContainerAppsClient) listByResourceGroupHandleResponse(resp *http.Response, successCodes ...int) (ContainerAppsClientListByResourceGroupResponse, error) {
...
func (client *ContainerAppsClient) listBySubscriptionCreateRequest(ctx context.Context, nextLink string, _ *ContainerAppsClientListBySubscriptionOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
	var req *policy.Request
	var err error
	if firstPage {
...
func (client *ContainerAppsClient) listBySubscriptionHandleResponse(resp *http.Response, successCodes ...int) (ContainerAppsClientListBySubscriptionResponse, error) {
...
func (client *ContainerAppsClient) ListCustomHostNameAnalysis(ctx context.Context, resourceGroupName string, containerAppName string, options *ContainerAppsClientListCustomHostNameAnalysisOptions) (ContainerAppsClientListCustomHostNameAnalysisResponse, error) {
	...
	return client.listCustomHostNameAnalysisHandleResponse(httpResp, http.StatusOK)
}
...
func (client *ContainerAppsClient) listCustomHostNameAnalysisHandleResponse(resp *http.Response, successCodes ...int) (ContainerAppsClientListCustomHostNameAnalysisResponse, error) {
...
func (client *ContainerAppsClient) listSecretsHandleResponse(resp *http.Response, successCodes ...int) (ContainerAppsClientListSecretsResponse, error) {
...
// BeginUpdate - Update properties of a Container App
//
...
// Update - Update properties of a Container App
//
// Patches a Container App using JSON Merge Patch
// If the operation fails it returns an *azcore.ResponseError type.
