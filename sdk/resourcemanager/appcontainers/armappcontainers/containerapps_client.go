...
// NewListSecretsPager - List secrets for a container app
//
...
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - containerAppName - Name of the Container App.
//   - options - ContainerAppsClientListSecretsOptions contains the optional parameters for the ContainerAppsClient.NewListSecretsPager
//     method.
func (client *ContainerAppsClient) NewListSecretsPager(resourceGroupName string, containerAppName string, options *ContainerAppsClientListSecretsOptions) *runtime.Pager[ContainerAppsClientListSecretsResponse] {
	return runtime.NewPager(runtime.PagingHandler[ContainerAppsClientListSecretsResponse]{
		More: func(page ContainerAppsClientListSecretsResponse) bool {
			return false
		},
		Fetcher: func(ctx context.Context, page *ContainerAppsClientListSecretsResponse) (ContainerAppsClientListSecretsResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "ContainerAppsClient.NewListSecretsPager")
