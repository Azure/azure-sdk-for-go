...
func ExampleContainerAppsAuthConfigsClient_Delete() {
	...
	res, err := clientFactory.NewContainerAppsAuthConfigsClient().Delete(ctx, "workerapps-rg-xj", "testcanadacentral", "current", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armappcontainers.ContainerAppsAuthConfigsClientDeleteResponse{
	// }
}
...
func ExampleContainerAppsAuthConfigsClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armappcontainers.ContainerAppsAuthConfigsClientGetResponse{
	// 	AuthConfig: &armappcontainers.AuthConfig{
	// 		Name: to.Ptr("current"),
	// 		Type: to.Ptr("Microsoft.App/containerapps/authconfigs"),
...
func ExampleContainerAppsAuthConfigsClient_NewListByContainerAppPager() {
	...
	for pager.More() {
		...
		// page = armappcontainers.ContainerAppsAuthConfigsClientListByContainerAppResponse{
		// 	AuthConfigCollection: armappcontainers.AuthConfigCollection{
