...
//   - patchName - Name of the Container Apps Patch.
...
func (client *ContainerAppsPatchesClient) getHandleResponse(resp *http.Response, successCodes ...int) (ContainerAppsPatchesClientGetResponse, error) {
...
func (client *ContainerAppsPatchesClient) listByContainerAppCreateRequest(ctx context.Context, resourceGroupName string, containerAppName string, nextLink string, options *ContainerAppsPatchesClientListByContainerAppOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *ContainerAppsPatchesClient) listByContainerAppHandleResponse(resp *http.Response, successCodes ...int) (ContainerAppsPatchesClientListByContainerAppResponse, error) {
