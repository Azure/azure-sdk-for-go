...
// Generated from example definition: 2025-10-02-preview/ContainerAppsPatches_Apply.json
func ExampleContainerAppsPatchesClient_BeginApply() {
	...
	// res = armappcontainers.ContainerAppsPatchesClientApplyResponse{
	// 	ContainerAppsPatchResource: &armappcontainers.ContainerAppsPatchResource{
...
// Generated from example definition: 2025-10-02-preview/ContainerAppsPatches_Delete.json
...
// Generated from example definition: 2025-10-02-preview/ContainerAppsPatches_Get.json
func ExampleContainerAppsPatchesClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armappcontainers.ContainerAppsPatchesClientGetResponse{
	// 	ContainerAppsPatchResource: &armappcontainers.ContainerAppsPatchResource{
	// 		Name: to.Ptr("testPatch-25fe4b"),
	// 		Type: to.Ptr("Microsoft.App/containerApps/patches"),
	// 		ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg/providers/Microsoft.App/containerApps/test-app/patches/testPatch-25fe4b"),
...
// Generated from example definition: 2025-10-02-preview/ContainerAppsPatches_ListByContainerApp.json
func ExampleContainerAppsPatchesClient_NewListByContainerAppPager() {
	...
	pager := clientFactory.NewContainerAppsPatchesClient().NewListByContainerAppPager("rg", "test-app", nil)
	for pager.More() {
		...
		// page = armappcontainers.ContainerAppsPatchesClientListByContainerAppResponse{
		// 	PatchCollection: armappcontainers.PatchCollection{
...
// Generated from example definition: 2025-10-02-preview/ContainerAppsPatches_Skip_Configure.json
