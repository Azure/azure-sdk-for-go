...
// NewListReplicasPager - List replicas for a Container App Revision.
//
...
//   - containerAppName - Name of the Container App.
//   - revisionName - Name of the Container App Revision.
//   - options - ContainerAppsRevisionReplicasClientListReplicasOptions contains the optional parameters for the ContainerAppsRevisionReplicasClient.NewListReplicasPager
//     method.
func (client *ContainerAppsRevisionReplicasClient) NewListReplicasPager(resourceGroupName string, containerAppName string, revisionName string, options *ContainerAppsRevisionReplicasClientListReplicasOptions) *runtime.Pager[ContainerAppsRevisionReplicasClientListReplicasResponse] {
	return runtime.NewPager(runtime.PagingHandler[ContainerAppsRevisionReplicasClientListReplicasResponse]{
		More: func(page ContainerAppsRevisionReplicasClientListReplicasResponse) bool {
			return false
		},
		Fetcher: func(ctx context.Context, page *ContainerAppsRevisionReplicasClientListReplicasResponse) (ContainerAppsRevisionReplicasClientListReplicasResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "ContainerAppsRevisionReplicasClient.NewListReplicasPager")
