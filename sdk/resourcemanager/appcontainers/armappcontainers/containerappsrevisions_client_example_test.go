...
func ExampleContainerAppsRevisionsClient_ActivateRevision() {
	...
	res, err := clientFactory.NewContainerAppsRevisionsClient().ActivateRevision(ctx, "rg", "testcontainerApp0", "testcontainerApp0-pjxhsye", nil)
	if err != nil {
	...
	// res = armappcontainers.ContainerAppsRevisionsClientActivateRevisionResponse{
	// }
}
...
func ExampleContainerAppsRevisionsClient_DeactivateRevision() {
	...
	res, err := clientFactory.NewContainerAppsRevisionsClient().DeactivateRevision(ctx, "rg", "testcontainerApp0", "testcontainerApp0-pjxhsye", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armappcontainers.ContainerAppsRevisionsClientDeactivateRevisionResponse{
	// }
}
...
func ExampleContainerAppsRevisionsClient_GetRevision() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armappcontainers.ContainerAppsRevisionsClientGetRevisionResponse{
...
func ExampleContainerAppsRevisionsClient_NewListRevisionsPager() {
	...
	for pager.More() {
		...
		// page = armappcontainers.ContainerAppsRevisionsClientListRevisionsResponse{
...
func ExampleContainerAppsRevisionsClient_RestartRevision() {
	...
	res, err := clientFactory.NewContainerAppsRevisionsClient().RestartRevision(ctx, "rg", "testStaticSite0", "testcontainerApp0-pjxhsye", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armappcontainers.ContainerAppsRevisionsClientRestartRevisionResponse{
	// }
}
