...
//   - environmentName - Name of the Managed Environment.
//   - componentName - Name of the Dapr Component.
//   - options - DaprComponentsClientListSecretsOptions contains the optional parameters for the DaprComponentsClient.NewListSecretsPager
//     method.
func (client *DaprComponentsClient) NewListSecretsPager(resourceGroupName string, environmentName string, componentName string, options *DaprComponentsClientListSecretsOptions) *runtime.Pager[DaprComponentsClientListSecretsResponse] {
	return runtime.NewPager(runtime.PagingHandler[DaprComponentsClientListSecretsResponse]{
		More: func(page DaprComponentsClientListSecretsResponse) bool {
			return false
		},
		Fetcher: func(ctx context.Context, page *DaprComponentsClientListSecretsResponse) (DaprComponentsClientListSecretsResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "DaprComponentsClient.NewListSecretsPager")
