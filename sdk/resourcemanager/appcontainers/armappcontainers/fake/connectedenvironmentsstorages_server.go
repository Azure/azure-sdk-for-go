...
type ConnectedEnvironmentsStoragesServer struct {
	...
	// NewListPager is the fake for method ConnectedEnvironmentsStoragesClient.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager func(resourceGroupName string, connectedEnvironmentName string, options *armappcontainers.ConnectedEnvironmentsStoragesClientListOptions) (resp azfake.PagerResponder[armappcontainers.ConnectedEnvironmentsStoragesClientListResponse])
}
...
func NewConnectedEnvironmentsStoragesServerTransport(srv *ConnectedEnvironmentsStoragesServer) *ConnectedEnvironmentsStoragesServerTransport {
	return &ConnectedEnvironmentsStoragesServerTransport{
		...
		newListPager:        newTracker[azfake.PagerResponder[armappcontainers.ConnectedEnvironmentsStoragesClientListResponse]](),
	}
}
...
type ConnectedEnvironmentsStoragesServerTransport struct {
	...
	newListPager        *tracker[azfake.PagerResponder[armappcontainers.ConnectedEnvironmentsStoragesClientListResponse]]
}
...
func (c *ConnectedEnvironmentsStoragesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		if !intercepted {
			...
			case "ConnectedEnvironmentsStoragesClient.NewListPager":
...
func (c *ConnectedEnvironmentsStoragesServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
