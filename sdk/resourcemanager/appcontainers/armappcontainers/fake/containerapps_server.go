...
type ContainerAppsServer struct {
	...
	// NewListSecretsPager is the fake for method ContainerAppsClient.NewListSecretsPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListSecretsPager func(resourceGroupName string, containerAppName string, options *armappcontainers.ContainerAppsClientListSecretsOptions) (resp azfake.PagerResponder[armappcontainers.ContainerAppsClientListSecretsResponse])
...
func NewContainerAppsServerTransport(srv *ContainerAppsServer) *ContainerAppsServerTransport {
	return &ContainerAppsServerTransport{
		...
		newListSecretsPager:         newTracker[azfake.PagerResponder[armappcontainers.ContainerAppsClientListSecretsResponse]](),
...
type ContainerAppsServerTransport struct {
	...
	newListSecretsPager         *tracker[azfake.PagerResponder[armappcontainers.ContainerAppsClientListSecretsResponse]]
...
func (c *ContainerAppsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		if !intercepted {
			...
			case "ContainerAppsClient.NewListSecretsPager":
...
func (c *ContainerAppsServerTransport) dispatchNewListSecretsPager(req *http.Request) (*http.Response, error) {
	...
	if newListSecretsPager == nil {
		...
		resp := c.srv.NewListSecretsPager(resourceGroupNameParam, containerAppNameParam, nil)
