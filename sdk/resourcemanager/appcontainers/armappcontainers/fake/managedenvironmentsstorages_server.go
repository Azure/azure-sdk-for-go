...
type ManagedEnvironmentsStoragesServer struct {
	...
	// NewListPager is the fake for method ManagedEnvironmentsStoragesClient.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager func(resourceGroupName string, environmentName string, options *armappcontainers.ManagedEnvironmentsStoragesClientListOptions) (resp azfake.PagerResponder[armappcontainers.ManagedEnvironmentsStoragesClientListResponse])
}
...
func NewManagedEnvironmentsStoragesServerTransport(srv *ManagedEnvironmentsStoragesServer) *ManagedEnvironmentsStoragesServerTransport {
	return &ManagedEnvironmentsStoragesServerTransport{
		srv:          srv,
		newListPager: newTracker[azfake.PagerResponder[armappcontainers.ManagedEnvironmentsStoragesClientListResponse]](),
	}
}
...
type ManagedEnvironmentsStoragesServerTransport struct {
	...
	newListPager *tracker[azfake.PagerResponder[armappcontainers.ManagedEnvironmentsStoragesClientListResponse]]
}
...
func (m *ManagedEnvironmentsStoragesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		if !intercepted {
			...
			case "ManagedEnvironmentsStoragesClient.NewListPager":
...
func (m *ManagedEnvironmentsStoragesServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
