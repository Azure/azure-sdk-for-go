...
type ServerFactory struct {
	// AppServer contains the fakes for client AppClient
	AppServer AppServer
...
type ServerFactoryTransport struct {
	srv                                                  *ServerFactory
	trMu                                                 sync.Mutex
	trAppServer                                          *AppServerTransport
...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	switch client {
	case "AppClient":
		initServer(&s.trMu, &s.trAppServer, func() *AppServerTransport { return NewAppServerTransport(&s.srv.AppServer) })
		resp, err = s.trAppServer.Do(req)
