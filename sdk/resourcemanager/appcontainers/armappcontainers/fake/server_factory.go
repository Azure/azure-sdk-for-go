...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "ContainerAppsFunctionsClient":
		initServer(s, &s.trContainerAppsFunctionsServer, func() *ContainerAppsFunctionsServerTransport {
	...
	case "ContainerAppsRevisionFunctionsClient":
		initServer(s, &s.trContainerAppsRevisionFunctionsServer, func() *ContainerAppsRevisionFunctionsServerTransport {
