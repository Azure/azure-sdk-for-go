...
// GetDetector - Get the diagnostics data for a given Container App Job.
//
...
// Generated from API version 2025-10-02-preview
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - jobName - Name of the Container App Job.
//   - detectorName - Proxy API Name for Container App Job.
...
//   - options - JobsClientJobExecutionOptions contains the optional parameters for the JobsClient.JobExecution method.
func (client *JobsClient) JobExecution(ctx context.Context, resourceGroupName string, jobName string, jobExecutionName string, options *JobsClientJobExecutionOptions) (JobsClientJobExecutionResponse, error) {
	var err error
	const operationName = "JobsClient.JobExecution"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.jobExecutionCreateRequest(ctx, resourceGroupName, jobName, jobExecutionName, options)
	if err != nil {
		return JobsClientJobExecutionResponse{}, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
	if err != nil {
		return JobsClientJobExecutionResponse{}, err
...
func (client *JobsClient) jobExecutionCreateRequest(ctx context.Context, resourceGroupName string, jobName string, jobExecutionName string, _ *JobsClientJobExecutionOptions) (*policy.Request, error) {
...
func (client *JobsClient) jobExecutionHandleResponse(resp *http.Response) (JobsClientJobExecutionResponse, error) {
	result := JobsClientJobExecutionResponse{}
...
// NewListDetectorsPager - Get the list of diagnostics for a given Container App Job.
//
...
// NewListSecretsPager - List secrets for a container apps job
//
...
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - jobName - Job Name
//   - options - JobsClientListSecretsOptions contains the optional parameters for the JobsClient.NewListSecretsPager method.
func (client *JobsClient) NewListSecretsPager(resourceGroupName string, jobName string, options *JobsClientListSecretsOptions) *runtime.Pager[JobsClientListSecretsResponse] {
	return runtime.NewPager(runtime.PagingHandler[JobsClientListSecretsResponse]{
		More: func(page JobsClientListSecretsResponse) bool {
			return false
		},
		Fetcher: func(ctx context.Context, page *JobsClientListSecretsResponse) (JobsClientListSecretsResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "JobsClient.NewListSecretsPager")
...
// ProxyGet - Get the properties for a given Container App Job.
//
...
// BeginUpdate - Update properties of a Container Apps Job
//
...
// Update - Update properties of a Container Apps Job
//
// Patches a Container Apps Job using JSON Merge Patch
// If the operation fails it returns an *azcore.ResponseError type.
//
