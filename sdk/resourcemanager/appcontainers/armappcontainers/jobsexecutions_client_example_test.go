...
func ExampleJobsExecutionsClient_NewListPager() {
	...
	pager := clientFactory.NewJobsExecutionsClient().NewListPager("rg", "testcontainerAppsJob0", nil)
	for pager.More() {
		...
		// page = armappcontainers.JobsExecutionsClientListResponse{
		...
		// 				ID: to.Ptr("/subscriptions/34adfa4f-cedf-4dc0-ba29-b6d1a69ab345/resourceGroups/rg/providers/Microsoft.App/jobs/testcontainerAppsJob0/executions/testcontainerAppJob-27944454"),
