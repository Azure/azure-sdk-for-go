...
// Generated from example definition: 2025-10-02-preview/LogicApps_Create.json
func ExampleLogicAppsClient_CreateOrUpdate() {
	...
	res, err := clientFactory.NewLogicAppsClient().CreateOrUpdate(ctx, "examplerg", "testcontainerApp0", "testcontainerApp0", armappcontainers.LogicApp{
		Properties: &armappcontainers.LogicAppProperties{},
	}, nil)
	if err != nil {
	...
	// res = armappcontainers.LogicAppsClientCreateOrUpdateResponse{
	// 	LogicApp: &armappcontainers.LogicApp{
...
// Generated from example definition: 2025-10-02-preview/LogicApps_Delete.json
func ExampleLogicAppsClient_Delete() {
	...
	res, err := clientFactory.NewLogicAppsClient().Delete(ctx, "examplerg", "testcontainerApp0", "testcontainerApp0", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armappcontainers.LogicAppsClientDeleteResponse{
	// }
}
...
// Generated from example definition: 2025-10-02-preview/LogicApps_PostDeployWorkflowArtifacts.json
...
// Generated from example definition: 2025-10-02-preview/LogicApps_Get.json
func ExampleLogicAppsClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armappcontainers.LogicAppsClientGetResponse{
	// 	LogicApp: &armappcontainers.LogicApp{
	// 		Name: to.Ptr("testcontainerApp0"),
	// 		Type: to.Ptr("Microsoft.App/logicApps"),
	// 		ID: to.Ptr("/subscriptions/8efdecc5-919e-44eb-b179-915dca89ebf9/resourceGroups/examplerg/providers/Microsoft.App/containerApps/testcontainerApp0/providers/Microsoft.App/logicApps/testcontainerApp0"),
...
// Generated from example definition: 2025-10-02-preview/LogicApps_GetWorkflow.json
func ExampleLogicAppsClient_GetWorkflow() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armappcontainers.LogicAppsClientGetWorkflowResponse{
...
// Generated from example definition: 2025-10-02-preview/LogicApps_ListCallbackURL.json
func ExampleLogicAppsClient_Invoke() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armappcontainers.LogicAppsClientInvokeResponse{
	// 	Object: &armappcontainers.Object{
...
// Generated from example definition: 2025-10-02-preview/LogicApps_ListWorkflows.json
func ExampleLogicAppsClient_NewListWorkflowsPager() {
	...
	for pager.More() {
		...
		// page = armappcontainers.LogicAppsClientListWorkflowsResponse{
		// 	WorkflowEnvelopeCollection: armappcontainers.WorkflowEnvelopeCollection{
