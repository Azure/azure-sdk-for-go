...
func ExampleManagedCertificatesClient_BeginCreateOrUpdate() {
	...
	poller, err := clientFactory.NewManagedCertificatesClient().BeginCreateOrUpdate(ctx, "examplerg", "testcontainerenv", "certificate-firendly-name", armappcontainers.ManagedCertificate{
	...
	// res = armappcontainers.ManagedCertificatesClientCreateOrUpdateResponse{
	// 	ManagedCertificate: &armappcontainers.ManagedCertificate{
...
func ExampleManagedCertificatesClient_Delete() {
	...
	res, err := clientFactory.NewManagedCertificatesClient().Delete(ctx, "examplerg", "testcontainerenv", "certificate-firendly-name", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armappcontainers.ManagedCertificatesClientDeleteResponse{
	// }
}
...
func ExampleManagedCertificatesClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armappcontainers.ManagedCertificatesClientGetResponse{
	// 	ManagedCertificate: &armappcontainers.ManagedCertificate{
	// 		Type: to.Ptr("Microsoft.App/ManagedEnvironments/managedCertificates"),
	// 		ID: to.Ptr("/subscriptions/34adfa4f-cedf-4dc0-ba29-b6d1a69ab345/resourceGroups/examplerg/providers/Microsoft.App/managedEnvironments/testcontainerenv/managedCertificates/certificate-firendly-name"),
	// 		Location: to.Ptr("East US"),
...
func ExampleManagedCertificatesClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armappcontainers.ManagedCertificatesClientListResponse{
		// 	ManagedCertificateCollection: armappcontainers.ManagedCertificateCollection{
...
func ExampleManagedCertificatesClient_Update() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armappcontainers.ManagedCertificatesClientUpdateResponse{
	// 	ManagedCertificate: &armappcontainers.ManagedCertificate{
	// 		Type: to.Ptr("Microsoft.App/ManagedEnvironments/managedCertificates"),
	// 		ID: to.Ptr("/subscriptions/34adfa4f-cedf-4dc0-ba29-b6d1a69ab345/resourceGroups/examplerg/providers/Microsoft.App/managedEnvironments/testcontainerenv/managedCertificates/certificate-firendly-name"),
	// 		Location: to.Ptr("East US"),
