...
// NewListPager - Get all storages for a managedEnvironment.
//
...
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - environmentName - Name of the Environment.
//   - options - ManagedEnvironmentsStoragesClientListOptions contains the optional parameters for the ManagedEnvironmentsStoragesClient.NewListPager
//     method.
func (client *ManagedEnvironmentsStoragesClient) NewListPager(resourceGroupName string, environmentName string, options *ManagedEnvironmentsStoragesClientListOptions) *runtime.Pager[ManagedEnvironmentsStoragesClientListResponse] {
	return runtime.NewPager(runtime.PagingHandler[ManagedEnvironmentsStoragesClientListResponse]{
		More: func(page ManagedEnvironmentsStoragesClientListResponse) bool {
			return false
		},
		Fetcher: func(ctx context.Context, page *ManagedEnvironmentsStoragesClientListResponse) (ManagedEnvironmentsStoragesClientListResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "ManagedEnvironmentsStoragesClient.NewListPager")
