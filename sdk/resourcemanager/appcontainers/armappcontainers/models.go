...
type AuthConfigCollection struct {
	// REQUIRED; The AuthConfig items on this page
	Value []*AuthConfig
...
type AvailableOperations struct {
	// REQUIRED; The OperationDetail items on this page
...
type AvailableWorkloadProfilesCollection struct {
	// REQUIRED; The AvailableWorkloadProfile items on this page
...
type ConnectedEnvironmentCollection struct {
	// REQUIRED; The ConnectedEnvironment items on this page
...
type ContainerAppCollection struct {
	// REQUIRED; The ContainerApp items on this page
	Value []*ContainerApp
...
type ContainerAppsFunctionCollection struct {
	// REQUIRED; The ContainerAppsFunction items on this page
...
type CustomHostnameAnalysisResult struct {
	...
	// READ-ONLY; <code>true</code> if there is a conflict on the Container App's managed environment level custom domain; otherwise,
	// <code>false</code>.
	...
	// READ-ONLY; <code>true</code> if there is a conflict on the Container App's managed environment; otherwise, <code>false</code>.
...
type DaprComponentResiliencyPoliciesCollection struct {
	// REQUIRED; The DaprComponentResiliencyPolicy items on this page
...
type DiagnosticsCollection struct {
	// REQUIRED; The Diagnostics items on this page
	Value []*Diagnostics
...
type DotNetComponentsCollection struct {
	// REQUIRED; The DotNetComponent items on this page
...
type JavaComponentsCollection struct {
	// REQUIRED; The JavaComponent items on this page
	Value []*JavaComponent
...
type LabelHistoryCollection struct {
	// REQUIRED; The LabelHistory items on this page
	Value []*LabelHistory
...
// ListUsagesResult - Paged collection of Usage items
...
type MaintenanceConfigurationCollection struct {
	// REQUIRED; The MaintenanceConfigurationResource items on this page
...
type ManagedCertificateCollection struct {
	// REQUIRED; The ManagedCertificate items on this page
...
type ManagedEnvironmentsCollection struct {
	// REQUIRED; The ManagedEnvironment items on this page
...
type RevisionCollection struct {
	// REQUIRED; The Revision items on this page
	Value []*Revision
...
type RevisionProperties struct {
	...
	// READ-ONLY; Timestamp describing when the revision was created
	// by controller
	CreatedTime *time.Time
	...
	// READ-ONLY; Container App Revision Template with all possible settings and the
...
// RuntimeJavaJavaAgent - Diagnostic capabilities achieved by java agent
...
// RuntimeJavaJavaAgentLogging - Capabilities on the java logging scenario.
...
type SessionPoolCollection struct {
	// REQUIRED; The SessionPool items on this page
	Value []*SessionPool
...
type SpringBootAdminComponent struct {
	// CONSTANT; Type of the Java Component.
	// Field has constant value JavaComponentTypeSpringBootAdmin, any specified value is ignored.
	ComponentType *JavaComponentType
...
type SpringCloudConfigComponent struct {
	// CONSTANT; Type of the Java Component.
	// Field has constant value JavaComponentTypeSpringCloudConfig, any specified value is ignored.
	ComponentType *JavaComponentType
...
type SpringCloudEurekaComponent struct {
	// CONSTANT; Type of the Java Component.
	// Field has constant value JavaComponentTypeSpringCloudEureka, any specified value is ignored.
	ComponentType *JavaComponentType
...
type WorkloadProfileStatesCollection struct {
	// REQUIRED; The workloadProfileStates items on this page
