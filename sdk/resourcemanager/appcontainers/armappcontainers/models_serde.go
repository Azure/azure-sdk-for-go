...
// MarshalJSON implements the json.Marshaller interface for type RuntimeJavaJavaAgent.
func (r RuntimeJavaJavaAgent) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type RuntimeJavaJavaAgent.
func (r *RuntimeJavaJavaAgent) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", r, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type RuntimeJavaJavaAgentLogging.
func (r RuntimeJavaJavaAgentLogging) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "loggerSettings", r.LoggerSettings)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type RuntimeJavaJavaAgentLogging.
func (r *RuntimeJavaJavaAgentLogging) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", r, err)
	}
