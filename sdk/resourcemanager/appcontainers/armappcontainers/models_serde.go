...
func (c CustomDomainConfiguration) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "certificateValue", c.CertificateValue)
	populate(objectMap, "customDomainVerificationId", c.CustomDomainVerificationID)
...
func (c *CustomDomainConfiguration) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "certificateValue":
			err = unpopulate(val, "CertificateValue", &c.CertificateValue)
			delete(rawMsg, key)
		case "customDomainVerificationId":
			err = unpopulate(val, "CustomDomainVerificationID", &c.CustomDomainVerificationID)
			delete(rawMsg, key)
...
func (t TemplateStatus) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "containers", t.Containers)
	populateDateTimeRFC3339(objectMap, "createdTime", t.CreatedTime)
...
func (t *TemplateStatus) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "containers":
			...
			delete(rawMsg, key)
		case "createdTime":
			err = unpopulateDateTimeRFC3339(val, "CreatedTime", &t.CreatedTime)
			delete(rawMsg, key)
		case "details":
