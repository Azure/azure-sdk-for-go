...
## 2.0.0-beta.4 (2026-03-26)
### Breaking Changes

- Function `*WebTestsClient.NewListByComponentPager` parameter(s) have been changed from `(componentName string, resourceGroupName string, options *WebTestsClientListByComponentOptions)` to `(resourceGroupName string, componentName string, options *WebTestsClientListByComponentOptions)`
