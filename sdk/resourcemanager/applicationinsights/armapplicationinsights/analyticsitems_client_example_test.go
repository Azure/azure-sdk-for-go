...
// Generated from example definition: 2015-05-01/AnalyticsItemDelete.json
func ExampleAnalyticsItemsClient_Delete() {
	...
	res, err := clientFactory.NewAnalyticsItemsClient().Delete(ctx, "my-resource-group", "my-component", armapplicationinsights.ItemScopePathAnalyticsItems, &armapplicationinsights.AnalyticsItemsClientDeleteOptions{
	...
	// res = armapplicationinsights.AnalyticsItemsClientDeleteResponse{
	// }
}

// Generated from example definition: 2015-05-01/AnalyticsItemGet.json
func ExampleAnalyticsItemsClient_Get() {
	...
	res, err := clientFactory.NewAnalyticsItemsClient().Get(ctx, "my-resource-group", "my-component", armapplicationinsights.ItemScopePathAnalyticsItems, &armapplicationinsights.AnalyticsItemsClientGetOptions{
		ID: to.Ptr("3466c160-4a10-4df8-afdf-0007f3f6dee5")})
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapplicationinsights.AnalyticsItemsClientGetResponse{
	// 	ComponentAnalyticsItem: armapplicationinsights.ComponentAnalyticsItem{
...
// Generated from example definition: 2015-05-01/AnalyticsItemList.json
func ExampleAnalyticsItemsClient_List() {
	...
	res, err := clientFactory.NewAnalyticsItemsClient().List(ctx, "my-resource-group", "my-component", armapplicationinsights.ItemScopePathAnalyticsItems, nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapplicationinsights.AnalyticsItemsClientListResponse{
	// 	ComponentAnalyticsItemArray: []*armapplicationinsights.ComponentAnalyticsItem{
	// 		{
...
// Generated from example definition: 2015-05-01/AnalyticsItemPut.json
func ExampleAnalyticsItemsClient_Put() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapplicationinsights.AnalyticsItemsClientPutResponse{
	// 	ComponentAnalyticsItem: armapplicationinsights.ComponentAnalyticsItem{
	// 		Content: to.Ptr("let newExceptionsTimeRange = 1d;\nlet timeRangeToCheckBefore = 7d;\nexceptions\n| where timestamp < ago(timeRangeToCheckBefore)\n| summarize count() by problemId\n| join kind= rightanti (\nexceptions\n| where timestamp >= ago(newExceptionsTimeRange)\n| extend stack = tostring(details[0].rawStack)\n| summarize count(), dcount(user_AuthenticatedId), min(timestamp), max(timestamp), any(stack) by problemId  \n) on problemId \n| order by  count_ desc\n"),
	// 		ID: to.Ptr("3466c160-4a10-4df8-afdf-0007f3f6dee5"),
	// 		Name: to.Ptr("Exceptions - New in the last 24 hours"),
