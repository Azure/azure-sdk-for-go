...
// Generated from example definition: 2015-05-01/APIKeysCreate.json
func ExampleAPIKeysClient_Create() {
	...
	// res = armapplicationinsights.APIKeysClientCreateResponse{
	// 	ComponentAPIKey: &armapplicationinsights.ComponentAPIKey{
	// 		Name: to.Ptr("test"),
...
// Generated from example definition: 2015-05-01/APIKeysDelete.json
func ExampleAPIKeysClient_Delete() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapplicationinsights.APIKeysClientDeleteResponse{
	// 	ComponentAPIKey: &armapplicationinsights.ComponentAPIKey{
	// 		Name: to.Ptr("test2"),
...
// Generated from example definition: 2015-05-01/APIKeysGet.json
func ExampleAPIKeysClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapplicationinsights.APIKeysClientGetResponse{
	// 	ComponentAPIKey: &armapplicationinsights.ComponentAPIKey{
	// 		Name: to.Ptr("test2"),
	// 		CreatedDate: to.Ptr("Thu, 28 Sep 2017 16:59:18 GMT"),
	// 		ID: to.Ptr("/subscriptions/subid/resourcegroups/my-resource-group/providers/Microsoft.Insights/components/my-component/apikeys/bb820f1b-3110-4a8b-ba2c-8c1129d7eb6a"),
...
// Generated from example definition: 2015-05-01/APIKeysList.json
func ExampleAPIKeysClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armapplicationinsights.APIKeysClientListResponse{
		// 	ComponentAPIKeyListResult: armapplicationinsights.ComponentAPIKeyListResult{
