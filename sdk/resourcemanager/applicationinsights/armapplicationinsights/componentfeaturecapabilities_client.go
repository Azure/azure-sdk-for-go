...
func (client *ComponentFeatureCapabilitiesClient) getCreateRequest(ctx context.Context, resourceGroupName string, resourceName string, _ *ComponentFeatureCapabilitiesClientGetOptions) (*policy.Request, error) {
