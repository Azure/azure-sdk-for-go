...
// Generated from example definition: https://github.com/Azure/azure-rest-api-specs/blob/c7477e2145aae7b65fcdcf1678e3bdf8a15861ae/specification/applicationinsights/resource-manager/Microsoft.Insights/stable/2015-05-01/examples/FeatureCapabilitiesGet.json
func ExampleComponentFeatureCapabilitiesClient_Get() {
	...
	res, err := clientFactory.NewComponentFeatureCapabilitiesClient("<subscription-id>").Get(ctx, "my-resource-group", "my-component", nil)
	if err != nil {
