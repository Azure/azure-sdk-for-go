...
// Generated from example definition: 2020-03-01-preview/ComponentLinkedStorageAccountsCreateAndUpdate.json
func ExampleComponentLinkedStorageAccountsClient_CreateAndUpdate() {
	...
	// res = armapplicationinsights.ComponentLinkedStorageAccountsClientCreateAndUpdateResponse{
...
// Generated from example definition: 2020-03-01-preview/ComponentLinkedStorageAccountsGet.json
func ExampleComponentLinkedStorageAccountsClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapplicationinsights.ComponentLinkedStorageAccountsClientGetResponse{
	// 	ComponentLinkedStorageAccounts: armapplicationinsights.ComponentLinkedStorageAccounts{
	// 		Name: to.Ptr("serviceprofile"),
	// 		Type: to.Ptr("microsoft.insights/components/linkedStorageAccounts"),
...
// Generated from example definition: 2020-03-01-preview/ComponentLinkedStorageAccountsUpdate.json
func ExampleComponentLinkedStorageAccountsClient_Update() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapplicationinsights.ComponentLinkedStorageAccountsClientUpdateResponse{
	// 	ComponentLinkedStorageAccounts: armapplicationinsights.ComponentLinkedStorageAccounts{
	// 		Name: to.Ptr("serviceprofile"),
	// 		Type: to.Ptr("microsoft.insights/components/linkedStorageAccounts"),
	// 		ID: to.Ptr("/subscriptions/86dc51d3-92ed-4d7e-947a-775ea79b4918/resourceGroups/someResourceGroupName/providers/microsoft.insights/components/myComponent/linkedStorageAccounts/serviceprofiler"),
