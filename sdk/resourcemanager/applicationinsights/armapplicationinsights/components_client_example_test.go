...
func ExampleComponentsClient_Delete() {
	...
	res, err := clientFactory.NewComponentsClient().Delete(ctx, "my-resource-group", "my-component", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapplicationinsights.ComponentsClientDeleteResponse{
	// }
}
...
func ExampleComponentsClient_GetPurgeStatus() {
	...
	// 	ComponentPurgeStatusResponse: &armapplicationinsights.ComponentPurgeStatusResponse{
...
func ExampleComponentsClient_NewListByResourceGroupPager() {
	...
	for pager.More() {
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armapplicationinsights.ComponentsClientListByResourceGroupResponse{
		// 	ComponentListResult: armapplicationinsights.ComponentListResult{
		// 		Value: []*armapplicationinsights.Component{
		// 			{
		// 				Name: to.Ptr("my-component"),
