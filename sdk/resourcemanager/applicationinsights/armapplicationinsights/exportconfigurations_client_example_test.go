...
// Generated from example definition: 2015-05-01/ExportConfigurationsPost.json
func ExampleExportConfigurationsClient_Create() {
	...
	// res = armapplicationinsights.ExportConfigurationsClientCreateResponse{
	// 	ComponentExportConfigurationArray: []*armapplicationinsights.ComponentExportConfiguration{
	// 		{
...
// Generated from example definition: 2015-05-01/ExportConfigurationDelete.json
func ExampleExportConfigurationsClient_Delete() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapplicationinsights.ExportConfigurationsClientDeleteResponse{
	// 	ComponentExportConfiguration: armapplicationinsights.ComponentExportConfiguration{
	// 		ApplicationName: to.Ptr("my-component"),
	// 		ContainerName: to.Ptr("mystorageblob"),
	// 		DestinationAccountID: to.Ptr("/subscriptions/subid/resourceGroups/my-resource-group/providers/Microsoft.Storage/storageAccounts/mystorageblob"),
	// 		DestinationStorageLocationID: to.Ptr("eastasia"),
...
// Generated from example definition: 2015-05-01/ExportConfigurationGet.json
func ExampleExportConfigurationsClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapplicationinsights.ExportConfigurationsClientGetResponse{
	// 	ComponentExportConfiguration: armapplicationinsights.ComponentExportConfiguration{
	// 		ApplicationName: to.Ptr("my-component"),
	// 		ContainerName: to.Ptr("mystorageblob"),
	// 		DestinationAccountID: to.Ptr("/subscriptions/subid/resourceGroups/my-resource-group/providers/Microsoft.Storage/storageAccounts/mystorageblob"),
...
// Generated from example definition: 2015-05-01/ExportConfigurationsList.json
func ExampleExportConfigurationsClient_List() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapplicationinsights.ExportConfigurationsClientListResponse{
	// 	ComponentExportConfigurationArray: []*armapplicationinsights.ComponentExportConfiguration{
	// 		{
	// 			ApplicationName: to.Ptr("my-component"),
	// 			ContainerName: to.Ptr("mystorageblob"),
...
// Generated from example definition: 2015-05-01/ExportConfigurationUpdate.json
func ExampleExportConfigurationsClient_Update() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapplicationinsights.ExportConfigurationsClientUpdateResponse{
	// 	ComponentExportConfiguration: armapplicationinsights.ComponentExportConfiguration{
	// 		ApplicationName: to.Ptr("my-component"),
	// 		ContainerName: to.Ptr("mystorageblob"),
	// 		DestinationAccountID: to.Ptr("/subscriptions/subid/resourceGroups/my-resource-group/providers/Microsoft.Storage/storageAccounts/mystorageblob"),
