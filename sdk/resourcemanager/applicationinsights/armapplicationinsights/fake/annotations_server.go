...
func (a *AnnotationsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	resultChan := make(chan result, 1)
	go func() {
		var intercepted bool
		var res result
		if annotationsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = annotationsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
func (a *AnnotationsServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		resp := a.srv.NewListPager(resourceGroupNameParam, resourceNameParam, qp.Get("start"), qp.Get("end"), nil)
		newListPager = &resp
		a.newListPager.add(req, newListPager)
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armapplicationinsights.AnnotationsClientListResponse, createLink func() string) {
...
// set this to conditionally intercept incoming requests to AnnotationsServerTransport
var annotationsServerTransportInterceptor interface {
