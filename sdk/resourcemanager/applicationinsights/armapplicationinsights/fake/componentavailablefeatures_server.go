...
func (c *ComponentAvailableFeaturesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if componentAvailableFeaturesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = componentAvailableFeaturesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to ComponentAvailableFeaturesServerTransport
var componentAvailableFeaturesServerTransportInterceptor interface {
