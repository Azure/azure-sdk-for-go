...
func (c *ComponentFeatureCapabilitiesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if componentFeatureCapabilitiesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = componentFeatureCapabilitiesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to ComponentFeatureCapabilitiesServerTransport
var componentFeatureCapabilitiesServerTransportInterceptor interface {
