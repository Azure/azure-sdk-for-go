...
func (c *ComponentQuotaStatusServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if componentQuotaStatusServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = componentQuotaStatusServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to ComponentQuotaStatusServerTransport
var componentQuotaStatusServerTransportInterceptor interface {
