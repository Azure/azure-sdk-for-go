...
func (p *ProactiveDetectionConfigurationsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if proactiveDetectionConfigurationsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = proactiveDetectionConfigurationsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to ProactiveDetectionConfigurationsServerTransport
var proactiveDetectionConfigurationsServerTransportInterceptor interface {
