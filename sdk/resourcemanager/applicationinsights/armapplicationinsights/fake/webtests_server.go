...
type WebTestsServer struct {
	...
	// HTTP status codes to indicate success: http.StatusOK
	NewListByComponentPager func(resourceGroupName string, componentName string, options *armapplicationinsights.WebTestsClientListByComponentOptions) (resp azfake.PagerResponder[armapplicationinsights.WebTestsClientListByComponentResponse])
...
func (w *WebTestsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if webTestsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = webTestsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
func (w *WebTestsServerTransport) dispatchNewListByComponentPager(req *http.Request) (*http.Response, error) {
	...
	if newListByComponentPager == nil {
		...
		resp := w.srv.NewListByComponentPager(resourceGroupNameParam, componentNameParam, nil)
...
// set this to conditionally intercept incoming requests to WebTestsServerTransport
var webTestsServerTransportInterceptor interface {
