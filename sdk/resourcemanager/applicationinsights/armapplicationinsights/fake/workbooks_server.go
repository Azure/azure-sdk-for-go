...
type WorkbooksServer struct {
	...
	// HTTP status codes to indicate success: http.StatusOK, http.StatusCreated
	Update func(ctx context.Context, resourceGroupName string, resourceName string, workbookUpdateParameters armapplicationinsights.WorkbookUpdateParameters, options *armapplicationinsights.WorkbooksClientUpdateOptions) (resp azfake.Responder[armapplicationinsights.WorkbooksClientUpdateResponse], errResp azfake.ErrorResponder)
}
...
func (w *WorkbooksServerTransport) dispatchCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	sourceIDParam := getOptional(qp.Get("sourceId"))
...
func (w *WorkbooksServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	canFetchContentParam, err := parseOptional(qp.Get("canFetchContent"), strconv.ParseBool)
	if err != nil {
		return nil, err
	}
...
func (w *WorkbooksServerTransport) dispatchNewListByResourceGroupPager(req *http.Request) (*http.Response, error) {
	...
	if newListByResourceGroupPager == nil {
		...
		tagsParam := splitHelper(qp.Get("tags"), ",")
		sourceIDParam := getOptional(qp.Get("sourceId"))
		canFetchContentParam, err := parseOptional(qp.Get("canFetchContent"), strconv.ParseBool)
		if err != nil {
			return nil, err
		...
		resp := w.srv.NewListByResourceGroupPager(resourceGroupNameParam, armapplicationinsights.CategoryType(qp.Get("category")), options)
...
func (w *WorkbooksServerTransport) dispatchNewListBySubscriptionPager(req *http.Request) (*http.Response, error) {
	...
	if newListBySubscriptionPager == nil {
		...
		resp := w.srv.NewListBySubscriptionPager(armapplicationinsights.CategoryType(qp.Get("category")), options)
...
func (w *WorkbooksServerTransport) dispatchUpdate(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := w.srv.Update(req.Context(), resourceGroupNameParam, resourceNameParam, body, options)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
