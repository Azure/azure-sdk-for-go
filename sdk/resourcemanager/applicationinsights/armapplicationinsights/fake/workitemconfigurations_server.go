...
func (w *WorkItemConfigurationsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if workItemConfigurationsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = workItemConfigurationsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "WorkItemConfigurationsClient.GetDefault":
				res.resp, res.err = w.dispatchGetDefault(req)
			case "WorkItemConfigurationsClient.GetItem":
				res.resp, res.err = w.dispatchGetItem(req)
			...
			case "WorkItemConfigurationsClient.UpdateItem":
				res.resp, res.err = w.dispatchUpdateItem(req)
			default:
...
func (w *WorkItemConfigurationsServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armapplicationinsights.WorkItemConfigurationsClientListResponse, createLink func() string) {
...
// set this to conditionally intercept incoming requests to WorkItemConfigurationsServerTransport
var workItemConfigurationsServerTransportInterceptor interface {
