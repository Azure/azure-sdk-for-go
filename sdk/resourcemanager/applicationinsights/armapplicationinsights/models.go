...
type HeaderField struct {
	...
	HeaderFieldName *string `json:"key,omitempty"`

	// The value of the header.
	HeaderFieldValue *string `json:"value,omitempty"`
}
...
type WebTestPropertiesValidationRules struct {
	...
	// must be set to true.
	SSLCertRemainingLifetimeCheck *int32 `json:"SSLCertRemainingLifetimeCheck,omitempty"`
...
type WorkbookErrorDefinition struct {
	...
	// READ-ONLY; Internal error details.
	InnerError *WorkbookInnerErrorTrace `json:"innerError,omitempty" azure:"ro"`
