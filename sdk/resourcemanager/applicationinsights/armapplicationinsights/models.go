...
// ComponentListResult - The response of a ApplicationInsightsComponent list operation.
type ComponentListResult struct {
	// REQUIRED; The ApplicationInsightsComponent items on this page
	Value []*Component
...
type ComponentProperties struct {
	...
	// with this API version. Applications from older versions will not have this property.
	...
	// for all telemetry sent to Azure Application Insights. This value will be supplied upon construction of each new Application
	// Insights component.
	InstrumentationKey *string
...
// OperationListResult - Result of the request to list Azure Workbooks operations.
...
// WebTestListResult - Paged collection of WebTest items
type WebTestListResult struct {
	// REQUIRED; The WebTest items on this page
	Value []*WebTest
