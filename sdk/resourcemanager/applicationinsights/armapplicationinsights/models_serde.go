...
func (a *Annotation) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "Category":
			...
			delete(rawMsg, key)
		case "EventTime":
			err = unpopulateTime[datetime.RFC3339](val, "EventTime", &a.EventTime)
			delete(rawMsg, key)
		case "Id":
...
func (c *ComponentProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "LaMigrationDate":
			err = unpopulateTime[datetime.RFC3339](val, "LaMigrationDate", &c.LaMigrationDate)
			delete(rawMsg, key)
		case "Name":
			err = unpopulate(val, "Name", &c.Name)
			delete(rawMsg, key)
...
func (d *DeletedWorkbookProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "tags":
			...
			delete(rawMsg, key)
		case "timeModified":
			err = unpopulateTime[datetime.RFC3339](val, "TimeModified", &d.TimeModified)
			delete(rawMsg, key)
		case "userId":
...
func (w *WorkbookProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "tags":
			...
			delete(rawMsg, key)
		case "timeModified":
			err = unpopulateTime[datetime.RFC3339](val, "TimeModified", &w.TimeModified)
			delete(rawMsg, key)
		case "userId":
