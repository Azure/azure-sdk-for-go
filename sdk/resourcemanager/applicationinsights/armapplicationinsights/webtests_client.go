...
//     method.
func (client *WebTestsClient) NewListByComponentPager(resourceGroupName string, componentName string, options *WebTestsClientListByComponentOptions) *runtime.Pager[WebTestsClientListByComponentResponse] {
	return runtime.NewPager(runtime.PagingHandler[WebTestsClientListByComponentResponse]{
		...
		Fetcher: func(ctx context.Context, page *WebTestsClientListByComponentResponse) (WebTestsClientListByComponentResponse, error) {
			...
			resp, err := runtime.FetcherForNextLink(ctx, client.internal.Pipeline(), nextLink, func(ctx context.Context) (*policy.Request, error) {
				return client.listByComponentCreateRequest(ctx, resourceGroupName, componentName, options)
			}, nil)
			if err != nil {
...
func (client *WebTestsClient) listByComponentCreateRequest(ctx context.Context, resourceGroupName string, componentName string, _ *WebTestsClientListByComponentOptions) (*policy.Request, error) {
