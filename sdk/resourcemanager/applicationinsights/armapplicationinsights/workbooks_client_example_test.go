...
// Generated from example definition: 2023-06-01/WorkbookAdd.json
func ExampleWorkbooksClient_CreateOrUpdate_workbookAdd() {
	...
	}, &armapplicationinsights.WorkbooksClientCreateOrUpdateOptions{
	...
	// res = armapplicationinsights.WorkbooksClientCreateOrUpdateResponse{
...
// Generated from example definition: 2023-06-01/WorkbookManagedAdd.json
...
// Generated from example definition: 2023-06-01/WorkbookDelete.json
func ExampleWorkbooksClient_Delete() {
	...
	res, err := clientFactory.NewWorkbooksClient().Delete(ctx, "my-resource-group", "deadb33f-5e0d-4064-8ebb-1a4ed0313eb2", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapplicationinsights.WorkbooksClientDeleteResponse{
	// }
}

// Generated from example definition: 2023-06-01/WorkbookGet.json
func ExampleWorkbooksClient_Get_workbookGet() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armapplicationinsights.WorkbooksClientGetResponse{
	// 	Workbook: armapplicationinsights.Workbook{
	// 		Name: to.Ptr("deadb33f-5e0d-4064-8ebb-1a4ed0313eb2"),
	// 		Type: to.Ptr("Microsoft.Insights/workbooks"),
	// 		ID: to.Ptr("/subscriptions/6b643656-33eb-422f-aee8-3ac145d124af/resourcegroups/my-resource-group/providers/microsoft.insights/workbooks/deadb33f-5e0d-4064-8ebb-1a4ed0313eb2"),
...
// Generated from example definition: 2023-06-01/WorkbookGet1.json
...
// Generated from example definition: 2023-06-01/WorkbookManagedGet.json
...
// Generated from example definition: 2023-06-01/WorkbooksList.json
func ExampleWorkbooksClient_NewListByResourceGroupPager_workbooksList() {
	...
	for pager.More() {
		...
		// page = armapplicationinsights.WorkbooksClientListByResourceGroupResponse{
...
// Generated from example definition: 2023-06-01/WorkbooksManagedList.json
...
// Generated from example definition: 2023-06-01/WorkbooksList2.json
func ExampleWorkbooksClient_NewListBySubscriptionPager_workbooksList2() {
	...
	pager := clientFactory.NewWorkbooksClient().NewListBySubscriptionPager(armapplicationinsights.CategoryTypeWorkbook, nil)
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armapplicationinsights.WorkbooksClientListBySubscriptionResponse{
		// 	WorkbooksListResult: armapplicationinsights.WorkbooksListResult{
		// 		Value: []*armapplicationinsights.Workbook{
		// 		},
		// 	},
...
// Generated from example definition: 2023-06-01/WorkbooksListSub.json
...
// Generated from example definition: 2023-06-01/WorkbookUpdate.json
