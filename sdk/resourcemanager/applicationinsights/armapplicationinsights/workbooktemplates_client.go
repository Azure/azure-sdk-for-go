...
//     method.
func (client *WorkbookTemplatesClient) Update(ctx context.Context, resourceGroupName string, resourceName string, workbookTemplateUpdateParameters WorkbookTemplateUpdateParameters, options *WorkbookTemplatesClientUpdateOptions) (WorkbookTemplatesClientUpdateResponse, error) {
	var err error
	const operationName = "WorkbookTemplatesClient.Update"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.updateCreateRequest(ctx, resourceGroupName, resourceName, workbookTemplateUpdateParameters, options)
	if err != nil {
...
func (client *WorkbookTemplatesClient) updateCreateRequest(ctx context.Context, resourceGroupName string, resourceName string, workbookTemplateUpdateParameters WorkbookTemplateUpdateParameters, _ *WorkbookTemplatesClientUpdateOptions) (*policy.Request, error) {
	...
	req.Raw().Header["Accept"] = []string{"application/json"}
	req.Raw().Header["Content-Type"] = []string{"application/json"}
	if err := runtime.MarshalAsJSON(req, workbookTemplateUpdateParameters); err != nil {
		return nil, err
	}
	return req, nil
}
