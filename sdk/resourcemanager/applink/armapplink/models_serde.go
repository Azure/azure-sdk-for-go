...
// MarshalJSON implements the json.Marshaller interface for type MemberListResult.
func (m MemberListResult) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type MemberListResult.
func (m *MemberListResult) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", m, err)
	}
...
func (m MemberProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "clusterType", m.ClusterType)
	populate(objectMap, "connectivityProfile", m.ConnectivityProfile)
	populate(objectMap, "metadata", m.Metadata)
	populate(objectMap, "observabilityProfile", m.ObservabilityProfile)
	populate(objectMap, "provisioningState", m.ProvisioningState)
	populate(objectMap, "upgradeProfile", m.UpgradeProfile)
	return json.Marshal(objectMap)
}
...
func (m *MemberProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "clusterType":
			err = unpopulate(val, "ClusterType", &m.ClusterType)
			delete(rawMsg, key)
		case "connectivityProfile":
			err = unpopulate(val, "ConnectivityProfile", &m.ConnectivityProfile)
			delete(rawMsg, key)
		case "metadata":
			err = unpopulate(val, "Metadata", &m.Metadata)
			delete(rawMsg, key)
		case "observabilityProfile":
			err = unpopulate(val, "ObservabilityProfile", &m.ObservabilityProfile)
			delete(rawMsg, key)
		case "provisioningState":
			err = unpopulate(val, "ProvisioningState", &m.ProvisioningState)
			delete(rawMsg, key)
		case "upgradeProfile":
			err = unpopulate(val, "UpgradeProfile", &m.UpgradeProfile)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", m, err)
...
// MarshalJSON implements the json.Marshaller interface for type MemberUpdateProperties.
func (m MemberUpdateProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "connectivityProfile", m.ConnectivityProfile)
	populate(objectMap, "observabilityProfile", m.ObservabilityProfile)
	populate(objectMap, "upgradeProfile", m.UpgradeProfile)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type MemberUpdateProperties.
func (m *MemberUpdateProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", m, err)
	}
