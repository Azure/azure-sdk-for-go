...
func ExampleUpgradeHistoriesClient_NewListByAppLinkMemberPager() {
	...
	for pager.More() {
		...
		// page = armapplink.UpgradeHistoriesClientListByAppLinkMemberResponse{
		// 	UpgradeHistoryListResult: armapplink.UpgradeHistoryListResult{
		// 		Value: []*armapplink.UpgradeHistory{
		// 			{
		...
		// 				Properties: &armapplink.UpgradeHistoryProperties{
