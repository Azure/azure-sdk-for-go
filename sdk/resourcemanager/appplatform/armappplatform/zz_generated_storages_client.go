...
func NewStoragesClient(con *arm.Connection, subscriptionID string) *StoragesClient {
	return &StoragesClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *StoragesClient) listHandleResponse(resp *http.Response) (StoragesListResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.StorageResourceCollection); err != nil {
		return StoragesListResponse{}, err
	}
	return result, nil
}
