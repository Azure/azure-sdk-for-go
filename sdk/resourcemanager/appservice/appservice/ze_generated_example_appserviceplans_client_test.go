...
func ExamplePlansClient_List() {
	...
	client := appservice.NewPlansClient("<subscription-id>", cred, nil)
	pager := client.List(&appservice.PlansClientListOptions{Detailed: nil})
	for {
...
func ExamplePlansClient_BeginCreateOrUpdate() {
	...
	poller, err := client.BeginCreateOrUpdate(ctx,
		...
		appservice.Plan{
			...
			Properties: &appservice.PlanProperties{},
			SKU: &appservice.SKUDescription{
...
func ExamplePlansClient_Update() {
	...
	res, err := client.Update(ctx,
		"<resource-group-name>",
		"<name>",
		appservice.PlanPatchResource{
			Kind:       to.StringPtr("<kind>"),
			Properties: &appservice.PlanPatchResourceProperties{},
		},
		nil)
	if err != nil {
		log.Fatal(err)
