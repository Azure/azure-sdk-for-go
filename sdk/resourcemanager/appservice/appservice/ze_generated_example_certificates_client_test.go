...
func ExampleCertificatesClient_List() {
	...
	client := appservice.NewCertificatesClient("<subscription-id>", cred, nil)
	pager := client.List(&appservice.CertificatesClientListOptions{Filter: nil})
	for {
...
func ExampleCertificatesClient_CreateOrUpdate() {
	...
	res, err := client.CreateOrUpdate(ctx,
		...
		appservice.AppCertificate{
			...
			Properties: &appservice.AppCertificateProperties{
				HostNames: []*string{
...
func ExampleCertificatesClient_Update() {
	...
	res, err := client.Update(ctx,
		"<resource-group-name>",
		"<name>",
		appservice.AppCertificatePatchResource{
			Properties: &appservice.AppCertificatePatchResourceProperties{
				Password: to.StringPtr("<password>"),
			},
		},
		nil)
