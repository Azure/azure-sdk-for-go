...
func ExampleDiagnosticsClient_GetHostingEnvironmentDetectorResponse() {
	...
	res, err := client.GetHostingEnvironmentDetectorResponse(ctx,
		...
		"<name>",
		"<detector-name>",
		&appservice.DiagnosticsClientGetHostingEnvironmentDetectorResponseOptions{StartTime: nil,
			EndTime:   nil,
			TimeGrain: nil,
		})
	if err != nil {
...
func ExampleDiagnosticsClient_GetSiteDetectorResponse() {
	...
	res, err := client.GetSiteDetectorResponse(ctx,
		...
		"<site-name>",
		"<detector-name>",
		&appservice.DiagnosticsClientGetSiteDetectorResponseOptions{StartTime: nil,
			EndTime:   nil,
			TimeGrain: nil,
		})
	if err != nil {
...
func ExampleDiagnosticsClient_ExecuteSiteAnalysis() {
	...
	res, err := client.ExecuteSiteAnalysis(ctx,
		...
		"<diagnostic-category>",
		"<analysis-name>",
		&appservice.DiagnosticsClientExecuteSiteAnalysisOptions{StartTime: nil,
			EndTime:   nil,
			TimeGrain: nil,
		})
	if err != nil {
...
func ExampleDiagnosticsClient_ExecuteSiteDetector() {
	...
	res, err := client.ExecuteSiteDetector(ctx,
		...
		"<detector-name>",
		"<diagnostic-category>",
		&appservice.DiagnosticsClientExecuteSiteDetectorOptions{StartTime: nil,
			EndTime:   nil,
			TimeGrain: nil,
		})
	if err != nil {
...
func ExampleDiagnosticsClient_GetSiteDetectorResponseSlot() {
	...
	res, err := client.GetSiteDetectorResponseSlot(ctx,
		...
		"<detector-name>",
		"<slot>",
		&appservice.DiagnosticsClientGetSiteDetectorResponseSlotOptions{StartTime: nil,
			EndTime:   nil,
			TimeGrain: nil,
		})
	if err != nil {
...
func ExampleDiagnosticsClient_ExecuteSiteAnalysisSlot() {
	...
	res, err := client.ExecuteSiteAnalysisSlot(ctx,
		...
		"<analysis-name>",
		"<slot>",
		&appservice.DiagnosticsClientExecuteSiteAnalysisSlotOptions{StartTime: nil,
			EndTime:   nil,
			TimeGrain: nil,
		})
	if err != nil {
...
func ExampleDiagnosticsClient_ExecuteSiteDetectorSlot() {
	...
	res, err := client.ExecuteSiteDetectorSlot(ctx,
		...
		"<diagnostic-category>",
		"<slot>",
		&appservice.DiagnosticsClientExecuteSiteDetectorSlotOptions{StartTime: nil,
			EndTime:   nil,
			TimeGrain: nil,
		})
	if err != nil {
