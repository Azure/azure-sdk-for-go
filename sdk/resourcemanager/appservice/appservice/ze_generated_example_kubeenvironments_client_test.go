...
func ExampleKubeEnvironmentsClient_ListBySubscription() {
	...
	client := appservice.NewKubeEnvironmentsClient("<subscription-id>", cred, nil)
...
func ExampleKubeEnvironmentsClient_BeginCreateOrUpdate() {
	...
	poller, err := client.BeginCreateOrUpdate(ctx,
		...
		appservice.KubeEnvironment{
			...
			Properties: &appservice.KubeEnvironmentProperties{
...
func ExampleKubeEnvironmentsClient_Update() {
	...
	res, err := client.Update(ctx,
		"<resource-group-name>",
		"<name>",
		appservice.KubeEnvironmentPatchResource{
			Properties: &appservice.KubeEnvironmentPatchResourceProperties{
				StaticIP: to.StringPtr("<static-ip>"),
			},
		},
		nil)
