...
func ExampleStaticSitesClient_PreviewWorkflow() {
	...
	client := appservice.NewStaticSitesClient("<subscription-id>", cred, nil)
	res, err := client.PreviewWorkflow(ctx,
		"<location>",
		appservice.StaticSitesWorkflowPreviewRequest{
			Properties: &appservice.StaticSitesWorkflowPreviewRequestProperties{
				Branch: to.StringPtr("<branch>"),
				BuildProperties: &appservice.StaticSiteBuildProperties{
...
func ExampleStaticSitesClient_BeginCreateOrUpdateStaticSite() {
	...
	poller, err := client.BeginCreateOrUpdateStaticSite(ctx,
		...
		appservice.StaticSiteARMResource{
			...
			Properties: &appservice.StaticSite{
				Branch: to.StringPtr("<branch>"),
				BuildProperties: &appservice.StaticSiteBuildProperties{
					APILocation:         to.StringPtr("<apilocation>"),
					AppArtifactLocation: to.StringPtr("<app-artifact-location>"),
...
func ExampleStaticSitesClient_UpdateStaticSite() {
	...
	res, err := client.UpdateStaticSite(ctx,
		"<resource-group-name>",
		"<name>",
		appservice.StaticSitePatchResource{
			Properties: &appservice.StaticSite{},
		},
		nil)
	if err != nil {
...
func ExampleStaticSitesClient_UpdateStaticSiteUser() {
	...
	res, err := client.UpdateStaticSiteUser(ctx,
		...
		"<authprovider>",
		"<userid>",
		appservice.StaticSiteUserARMResource{
			Properties: &appservice.StaticSiteUserARMResourceProperties{
...
func ExampleStaticSitesClient_BeginRegisterUserProvidedFunctionAppWithStaticSiteBuild() {
	...
	poller, err := client.BeginRegisterUserProvidedFunctionAppWithStaticSiteBuild(ctx,
		...
		"<environment-name>",
		"<function-app-name>",
		appservice.StaticSiteUserProvidedFunctionAppARMResource{
			Properties: &appservice.StaticSiteUserProvidedFunctionAppARMResourceProperties{
				FunctionAppRegion:     to.StringPtr("<function-app-region>"),
				FunctionAppResourceID: to.StringPtr("<function-app-resource-id>"),
			},
		},
		&appservice.StaticSitesClientBeginRegisterUserProvidedFunctionAppWithStaticSiteBuildOptions{IsForced: to.BoolPtr(true)})
	if err != nil {
		log.Fatal(err)
	}
	res, err := poller.PollUntilDone(ctx, 30*time.Second)
...
func ExampleStaticSitesClient_BeginCreateZipDeploymentForStaticSiteBuild() {
	...
	poller, err := client.BeginCreateZipDeploymentForStaticSiteBuild(ctx,
		...
		"<name>",
		"<environment-name>",
		appservice.StaticSiteZipDeploymentARMResource{
			Properties: &appservice.StaticSiteZipDeployment{
...
func ExampleStaticSitesClient_CreateUserRolesInvitationLink() {
	...
	res, err := client.CreateUserRolesInvitationLink(ctx,
		"<resource-group-name>",
		"<name>",
		appservice.StaticSiteUserInvitationRequestResource{
			Properties: &appservice.StaticSiteUserInvitationRequestResourceProperties{
...
func ExampleStaticSitesClient_BeginCreateOrUpdateStaticSiteCustomDomain() {
	...
	poller, err := client.BeginCreateOrUpdateStaticSiteCustomDomain(ctx,
		...
		"<name>",
		"<domain-name>",
		appservice.StaticSiteCustomDomainRequestPropertiesARMResource{
			Properties: &appservice.StaticSiteCustomDomainRequestPropertiesARMResourceProperties{},
		},
		nil)
	if err != nil {
		log.Fatal(err)
...
func ExampleStaticSitesClient_BeginRegisterUserProvidedFunctionAppWithStaticSite() {
	...
	poller, err := client.BeginRegisterUserProvidedFunctionAppWithStaticSite(ctx,
		...
		&appservice.StaticSitesClientBeginRegisterUserProvidedFunctionAppWithStaticSiteOptions{IsForced: to.BoolPtr(true)})
	if err != nil {
		log.Fatal(err)
	}
	res, err := poller.PollUntilDone(ctx, 30*time.Second)
