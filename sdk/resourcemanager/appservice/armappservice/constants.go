...
// BuiltInAuthenticationProvider - The default authentication provider to use when multiple providers are configured.
...
// PublishingProfileFormat - Name of the format. Valid values are:
// FileZilla3
// WebDeploy -- default
// Ftp
...
// SiteUpdateStrategyType - Function app site update strategy type. Available options: Recreate, RollingUpdate
type SiteUpdateStrategyType string

const (
	// SiteUpdateStrategyTypeRecreate - If the app is under load and a deployment or site state update occurs, all pods will be
	// removed
	...
	// SiteUpdateStrategyTypeRollingUpdate - If the app is under load and a deployment or site state update occurs, pods will
	// be drained in
...
// PossibleSiteUpdateStrategyTypeValues returns the possible values for the SiteUpdateStrategyType const type.
func PossibleSiteUpdateStrategyTypeValues() []SiteUpdateStrategyType {
	return []SiteUpdateStrategyType{
