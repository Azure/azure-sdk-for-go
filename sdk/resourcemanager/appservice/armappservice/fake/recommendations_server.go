...
type RecommendationsServer struct {
	...
	DisableAllForHostingEnvironment func(ctx context.Context, resourceGroupName string, hostingEnvironmentName string, environmentName string, options *armappservice.RecommendationsClientDisableAllForHostingEnvironmentOptions) (resp azfake.Responder[armappservice.RecommendationsClientDisableAllForHostingEnvironmentResponse], errResp azfake.ErrorResponder)
	...
	// HTTP status codes to indicate success: http.StatusNoContent
	ResetAllFiltersForHostingEnvironment func(ctx context.Context, resourceGroupName string, hostingEnvironmentName string, environmentName string, options *armappservice.RecommendationsClientResetAllFiltersForHostingEnvironmentOptions) (resp azfake.Responder[armappservice.RecommendationsClientResetAllFiltersForHostingEnvironmentResponse], errResp azfake.ErrorResponder)
