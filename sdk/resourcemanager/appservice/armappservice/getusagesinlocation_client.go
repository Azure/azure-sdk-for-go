...
func (client *GetUsagesInLocationClient) listCreateRequest(ctx context.Context, location string, nextLink string, _ *GetUsagesInLocationClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *GetUsagesInLocationClient) listHandleResponse(resp *http.Response, successCodes ...int) (GetUsagesInLocationClientListResponse, error) {
