...
// Generated from example definition: 2025-05-01/GetFunctionAppStacks.json
func ExampleProviderClient_NewGetFunctionAppStacksPager() {
	...
	pager := clientFactory.NewProviderClient().NewGetFunctionAppStacksPager(nil)
	for pager.More() {
		...
		// page = armappservice.ProviderClientGetFunctionAppStacksResponse{
		// 	FunctionAppStackCollection: armappservice.FunctionAppStackCollection{
...
// Generated from example definition: 2025-05-01/GetFunctionAppStacksForLocation.json
func ExampleProviderClient_NewGetFunctionAppStacksForLocationPager() {
	...
	pager := clientFactory.NewProviderClient().NewGetFunctionAppStacksForLocationPager("westus", nil)
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armappservice.ProviderClientGetFunctionAppStacksForLocationResponse{
		// 	FunctionAppStackCollection: armappservice.FunctionAppStackCollection{
		// 		Value: []*armappservice.FunctionAppStack{
		// 			{
		// 				Name: to.Ptr("dotnet"),
...
// Generated from example definition: 2025-05-01/GetWebAppStacks.json
func ExampleProviderClient_NewGetWebAppStacksPager() {
	...
	pager := clientFactory.NewProviderClient().NewGetWebAppStacksPager(nil)
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armappservice.ProviderClientGetWebAppStacksResponse{
		// 	WebAppStackCollection: armappservice.WebAppStackCollection{
...
// Generated from example definition: 2025-05-01/GetWebAppStacksForLocation.json
func ExampleProviderClient_NewGetWebAppStacksForLocationPager() {
	...
	pager := clientFactory.NewProviderClient().NewGetWebAppStacksForLocationPager("westus", nil)
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armappservice.ProviderClientGetWebAppStacksForLocationResponse{
		// 	WebAppStackCollection: armappservice.WebAppStackCollection{
		// 		Value: []*armappservice.WebAppStack{
		// 			{
		// 				Name: to.Ptr("dotnet"),
...
func ExampleProviderClient_NewListOperationsPager() {
	...
	for pager.More() {
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armappservice.ProviderClientListOperationsResponse{
		// 	CsmOperationCollection: armappservice.CsmOperationCollection{
