...
//   - hostingEnvironmentName - Name of the App Service Environment.
...
//     method.
func (client *RecommendationsClient) DisableAllForHostingEnvironment(ctx context.Context, resourceGroupName string, hostingEnvironmentName string, environmentName string, options *RecommendationsClientDisableAllForHostingEnvironmentOptions) (RecommendationsClientDisableAllForHostingEnvironmentResponse, error) {
	var err error
	const operationName = "RecommendationsClient.DisableAllForHostingEnvironment"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.disableAllForHostingEnvironmentCreateRequest(ctx, resourceGroupName, hostingEnvironmentName, environmentName, options)
	if err != nil {
...
//     method.
func (client *RecommendationsClient) ResetAllFiltersForHostingEnvironment(ctx context.Context, resourceGroupName string, hostingEnvironmentName string, environmentName string, options *RecommendationsClientResetAllFiltersForHostingEnvironmentOptions) (RecommendationsClientResetAllFiltersForHostingEnvironmentResponse, error) {
	var err error
	const operationName = "RecommendationsClient.ResetAllFiltersForHostingEnvironment"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.resetAllFiltersForHostingEnvironmentCreateRequest(ctx, resourceGroupName, hostingEnvironmentName, environmentName, options)
	if err != nil {
