...
// Generated from example definition: 2025-05-01/GetResourceHealthMetadataBySite.json
...
// Generated from example definition: 2025-05-01/GetResourceHealthMetadataBySite_Slot.json
...
// Generated from example definition: 2025-05-01/ListResourceHealthMetadataBySubscription.json
func ExampleResourceHealthMetadataClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armappservice.ResourceHealthMetadataClientListResponse{
...
// Generated from example definition: 2025-05-01/ListResourceHealthMetadataByResourceGroup.json
func ExampleResourceHealthMetadataClient_NewListByResourceGroupPager() {
	...
	for pager.More() {
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armappservice.ResourceHealthMetadataClientListByResourceGroupResponse{
		// 	ResourceHealthMetadataCollection: armappservice.ResourceHealthMetadataCollection{
		// 		Value: []*armappservice.ResourceHealthMetadata{
		// 			{
		// 				Name: to.Ptr("default"),
...
// Generated from example definition: 2025-05-01/ListResourceHealthMetadataBySite_Slot.json
func ExampleResourceHealthMetadataClient_NewListBySiteSlotPager() {
	...
	for pager.More() {
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armappservice.ResourceHealthMetadataClientListBySiteSlotResponse{
		// 	ResourceHealthMetadataCollection: armappservice.ResourceHealthMetadataCollection{
		// 		Value: []*armappservice.ResourceHealthMetadata{
		// 			{
		// 				Name: to.Ptr("default"),
