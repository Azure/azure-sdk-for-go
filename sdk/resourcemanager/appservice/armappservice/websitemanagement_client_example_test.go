...
// Generated from example definition: 2025-05-01/ListAseRegions.json
func ExampleWebSiteManagementClient_NewListAseRegionsPager() {
	...
	for pager.More() {
		...
		// page = armappservice.WebSiteManagementClientListAseRegionsResponse{
		// 	AseRegionCollection: armappservice.AseRegionCollection{
...
// Generated from example definition: 2025-05-01/ListCustomHostNameSites.json
func ExampleWebSiteManagementClient_NewListCustomHostNameSitesPager_getCustomHostnamesUnderSubscription() {
	...
	ctx := context.Background()
	clientFactory, err := armappservice.NewClientFactory("00000000-0000-0000-0000-000000000000", cred, nil)
	if err != nil {
		log.Fatalf("failed to create client: %v", err)
	}
	pager := clientFactory.NewWebSiteManagementClient().NewListCustomHostNameSitesPager(nil)
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armappservice.WebSiteManagementClientListCustomHostNameSitesResponse{
		// 	CustomHostnameSitesCollection: armappservice.CustomHostnameSitesCollection{
...
// Generated from example definition: 2025-05-01/ListCustomSpecificHostNameSites.json
func ExampleWebSiteManagementClient_NewListCustomHostNameSitesPager_getSpecificCustomHostnameUnderSubscription() {
	...
	pager := clientFactory.NewWebSiteManagementClient().NewListCustomHostNameSitesPager(&armappservice.WebSiteManagementClientListCustomHostNameSitesOptions{
		Hostname: to.Ptr("www.example.com")})
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
...
// Generated from example definition: 2025-05-01/VerifyHostingEnvironmentVnet.json
func ExampleWebSiteManagementClient_VerifyHostingEnvironmentVnet() {
	...
	// res = armappservice.WebSiteManagementClientVerifyHostingEnvironmentVnetResponse{
	// 	VnetValidationFailureDetails: armappservice.VnetValidationFailureDetails{
