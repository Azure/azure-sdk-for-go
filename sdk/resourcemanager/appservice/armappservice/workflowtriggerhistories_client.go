...
func (client *WorkflowTriggerHistoriesClient) getHandleResponse(resp *http.Response, successCodes ...int) (WorkflowTriggerHistoriesClientGetResponse, error) {
...
func (client *WorkflowTriggerHistoriesClient) NewListPager(resourceGroupName string, name string, workflowName string, triggerName string, options *WorkflowTriggerHistoriesClientListOptions) *runtime.Pager[WorkflowTriggerHistoriesClientListResponse] {
	return runtime.NewPager(runtime.PagingHandler[WorkflowTriggerHistoriesClientListResponse]{
		...
		Fetcher: func(ctx context.Context, page *WorkflowTriggerHistoriesClientListResponse) (WorkflowTriggerHistoriesClientListResponse, error) {
			...
			req, err := client.listCreateRequest(ctx, resourceGroupName, name, workflowName, triggerName, nextLink, options)
			if err != nil {
...
func (client *WorkflowTriggerHistoriesClient) listCreateRequest(ctx context.Context, resourceGroupName string, name string, workflowName string, triggerName string, nextLink string, options *WorkflowTriggerHistoriesClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *WorkflowTriggerHistoriesClient) listHandleResponse(resp *http.Response, successCodes ...int) (WorkflowTriggerHistoriesClientListResponse, error) {
