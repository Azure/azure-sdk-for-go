...
func (client *WorkflowVersionsClient) listCreateRequest(ctx context.Context, resourceGroupName string, name string, workflowName string, nextLink string, options *WorkflowVersionsClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *WorkflowVersionsClient) listHandleResponse(resp *http.Response, successCodes ...int) (WorkflowVersionsClientListResponse, error) {
