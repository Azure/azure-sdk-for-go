...
type ProvidersServer struct {
	...
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager	func(options *armattestation.ProvidersClientListOptions) (resp azfake.PagerResponder[armattestation.ProvidersClientListResponse])

	// NewListByResourceGroupPager is the fake for method ProvidersClient.NewListByResourceGroupPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByResourceGroupPager	func(resourceGroupName string, options *armattestation.ProvidersClientListByResourceGroupOptions) (resp azfake.PagerResponder[armattestation.ProvidersClientListByResourceGroupResponse])
...
func NewProvidersServerTransport(srv *ProvidersServer) *ProvidersServerTransport {
	return &ProvidersServerTransport{
		srv:				srv,
		newListPager:			newTracker[azfake.PagerResponder[armattestation.ProvidersClientListResponse]](),
		newListByResourceGroupPager:	newTracker[azfake.PagerResponder[armattestation.ProvidersClientListByResourceGroupResponse]](),
	}
}
...
type ProvidersServerTransport struct {
	srv				*ProvidersServer
	newListPager			*tracker[azfake.PagerResponder[armattestation.ProvidersClientListResponse]]
	newListByResourceGroupPager	*tracker[azfake.PagerResponder[armattestation.ProvidersClientListByResourceGroupResponse]]
}
...
func (p *ProvidersServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		if !intercepted {
			...
			case "ProvidersClient.NewListByResourceGroupPager":
...
func (p *ProvidersServerTransport) dispatchNewListByResourceGroupPager(req *http.Request) (*http.Response, error) {
