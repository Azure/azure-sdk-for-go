...
// Generated from example definition: 2022-08-01-preview/GetAlertConfigurationById.json
func ExampleAlertConfigurationsClient_Get() {
	...
	// res = armauthorization.AlertConfigurationsClientGetResponse{
...
// Generated from example definition: 2022-08-01-preview/GetAlertConfigurations.json
func ExampleAlertConfigurationsClient_NewListForScopePager() {
	...
	for pager.More() {
		...
		// page = armauthorization.AlertConfigurationsClientListForScopeResponse{
		// 	AlertConfigurationListResult: armauthorization.AlertConfigurationListResult{
