...
// Generated from example definition: 2022-08-01-preview/GetAlertDefinitionById.json
...
// Generated from example definition: 2022-08-01-preview/GetAlertDefinitions.json
func ExampleAlertDefinitionsClient_NewListForScopePager() {
	...
	for pager.More() {
		...
		// page = armauthorization.AlertDefinitionsClientListForScopeResponse{
		// 	AlertDefinitionListResult: armauthorization.AlertDefinitionListResult{
