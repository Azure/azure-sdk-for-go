...
// Generated from example definition: 2022-08-01-preview/GetAlertIncidentById.json
func ExampleAlertIncidentsClient_Get() {
	...
	// res = armauthorization.AlertIncidentsClientGetResponse{
	// 	AlertIncident: &armauthorization.AlertIncident{
...
// Generated from example definition: 2022-08-01-preview/GetAlertIncidents.json
func ExampleAlertIncidentsClient_NewListForScopePager() {
	...
	for pager.More() {
		...
		// page = armauthorization.AlertIncidentsClientListForScopeResponse{
		// 	AlertIncidentListResult: armauthorization.AlertIncidentListResult{
