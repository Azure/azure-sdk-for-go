...
// Generated from example definition: 2024-09-01-preview/PutRoleManagementPolicyAssignment.json
...
// Generated from example definition: 2024-09-01-preview/DeleteRoleManagementPolicyAssignment.json
func ExampleRoleManagementPolicyAssignmentsClient_Delete() {
	...
	res, err := clientFactory.NewRoleManagementPolicyAssignmentsClient().Delete(ctx, "providers/Microsoft.Subscription/subscriptions/129ff972-28f8-46b8-a726-e497be039368", "b959d571-f0b5-4042-88a7-01be6cb22db9_a1705bd2-3a8f-45a5-8683-466fcfd5cc24", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	...
	// res = armauthorization.RoleManagementPolicyAssignmentsClientDeleteResponse{
	// }
}

// Generated from example definition: 2024-09-01-preview/GetRoleManagementPolicyAssignmentByName.json
...
// Generated from example definition: 2024-09-01-preview/GetRoleManagementPolicyAssignmentByScope.json
func ExampleRoleManagementPolicyAssignmentsClient_NewListForScopePager() {
	...
	for pager.More() {
		...
		// page = armauthorization.RoleManagementPolicyAssignmentsClientListForScopeResponse{
		// 	RoleManagementPolicyAssignmentListResult: armauthorization.RoleManagementPolicyAssignmentListResult{
