...
- New field `ContentType` in struct `DscConfigurationClientGetContentResponse`
...
- New field `ContentType` in struct `JobClientGetOutputResponse`
- New field `ContentType` in struct `JobClientGetRunbookContentResponse`
...
- New field `ContentType`, `Value` in struct `RunbookClientGetContentResponse`
- New field `RuntimeEnvironment` in struct `RunbookCreateOrUpdateProperties`
- New field `ContentType`, `Value` in struct `RunbookDraftClientGetContentResponse`
