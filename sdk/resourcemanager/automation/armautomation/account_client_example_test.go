...
// Generated from example definition: https://github.com/Azure/azure-rest-api-specs/blob/9e3da0a088eadf4fdbc832c41ff800cb63ca0d08/specification/automation/resource-manager/Microsoft.Automation/stable/2024-10-23/examples/updateAutomationAccount.json
...
// Generated from example definition: https://github.com/Azure/azure-rest-api-specs/blob/9e3da0a088eadf4fdbc832c41ff800cb63ca0d08/specification/automation/resource-manager/Microsoft.Automation/stable/2024-10-23/examples/createOrUpdateAutomationAccount.json
...
// Generated from example definition: https://github.com/Azure/azure-rest-api-specs/blob/9e3da0a088eadf4fdbc832c41ff800cb63ca0d08/specification/automation/resource-manager/Microsoft.Automation/stable/2024-10-23/examples/deleteAutomationAccount.json
...
// Generated from example definition: https://github.com/Azure/azure-rest-api-specs/blob/9e3da0a088eadf4fdbc832c41ff800cb63ca0d08/specification/automation/resource-manager/Microsoft.Automation/stable/2024-10-23/examples/getAutomationAccount.json
...
// Generated from example definition: https://github.com/Azure/azure-rest-api-specs/blob/9e3da0a088eadf4fdbc832c41ff800cb63ca0d08/specification/automation/resource-manager/Microsoft.Automation/stable/2024-10-23/examples/listAutomationAccountsByResourceGroup.json
...
// Generated from example definition: https://github.com/Azure/azure-rest-api-specs/blob/9e3da0a088eadf4fdbc832c41ff800cb63ca0d08/specification/automation/resource-manager/Microsoft.Automation/stable/2024-10-23/examples/listAutomationAccountsBySubscription.json
...
// Generated from example definition: https://github.com/Azure/azure-rest-api-specs/blob/9e3da0a088eadf4fdbc832c41ff800cb63ca0d08/specification/automation/resource-manager/Microsoft.Automation/stable/2024-10-23/examples/listAutomationAccountDeletedRunbooks.json
func ExampleAccountClient_NewListDeletedRunbooksPager() {
	...
	for pager.More() {
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page.DeletedRunbookListResult = armautomation.DeletedRunbookListResult{
		// 	Value: []*armautomation.DeletedRunbook{
		// 		{
		// 			Name: to.Ptr("myrunbook1"),
		// 			ID: to.Ptr("/subscriptions/subid/resourceGroups/rg/providers/Microsoft.Automation/automationAccounts/MyAutomationAccount/runbooks/myrunbook1"),
		// 			Location: to.Ptr("East US 2"),
		// 			Properties: &armautomation.DeletedRunbookProperties{
		// 				CreationTime: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2023-03-28T21:32:25.780Z"); return t}()),
		// 				DeletionTime: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2023-03-30T21:32:25.810Z"); return t}()),
		...
		// 			ID: to.Ptr("/subscriptions/subid/resourceGroups/rg/providers/Microsoft.Automation/automationAccounts/MyAutomationAccount/runbooks/myrunbook2"),
		// 			Location: to.Ptr("East US 2"),
		// 			Properties: &armautomation.DeletedRunbookProperties{
		// 				CreationTime: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2023-03-28T21:32:25.780Z"); return t}()),
		// 				DeletionTime: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2023-03-30T21:32:25.810Z"); return t}()),
		...
		// 			ID: to.Ptr("/subscriptions/subid/resourceGroups/rg/providers/Microsoft.Automation/automationAccounts/MyAutomationAccount/runbooks/myrunbook3"),
		// 			Location: to.Ptr("East US 2"),
		// 			Properties: &armautomation.DeletedRunbookProperties{
		// 				CreationTime: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2023-03-28T21:32:25.780Z"); return t}()),
		// 				DeletionTime: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2023-03-30T21:32:25.810Z"); return t}()),
