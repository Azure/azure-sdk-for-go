...
func (client *DscNodeConfigurationClient) Delete(ctx context.Context, resourceGroupName string, automationAccountName string, nodeConfigurationName string, options *DscNodeConfigurationClientDeleteOptions) (DscNodeConfigurationClientDeleteResponse, error) {
	...
	if !runtime.HasStatusCode(httpResp, http.StatusOK) {
		return DscNodeConfigurationClientDeleteResponse{}, runtime.NewResponseError(httpResp)
	}
...
func (client *DscNodeConfigurationClient) getHandleResponse(resp *http.Response, successCodes ...int) (DscNodeConfigurationClientGetResponse, error) {
...
func (client *DscNodeConfigurationClient) listByAutomationAccountCreateRequest(ctx context.Context, resourceGroupName string, automationAccountName string, nextLink string, options *DscNodeConfigurationClientListByAutomationAccountOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *DscNodeConfigurationClient) listByAutomationAccountHandleResponse(resp *http.Response, successCodes ...int) (DscNodeConfigurationClientListByAutomationAccountResponse, error) {
