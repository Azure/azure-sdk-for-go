...
func ExampleDscNodeConfigurationClient_Get() {
	...
	// 			},
	// 			CreationTime: to.Ptr(time.Date(2017, time.March, 28, 23, 17, 6, 890196800, time.UTC)),
	// 			IncrementNodeConfigurationBuild: to.Ptr(false),
	// 			LastModifiedTime: to.Ptr(time.Date(2017, time.March, 28, 23, 17, 6, 890196800, time.UTC)),
