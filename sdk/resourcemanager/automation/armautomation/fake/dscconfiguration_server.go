...
type DscConfigurationServer struct {
	// CreateOrUpdate is the fake for method DscConfigurationClient.CreateOrUpdate
	// HTTP status codes to indicate success: http.StatusOK, http.StatusCreated
	CreateOrUpdate func(ctx context.Context, resourceGroupName string, automationAccountName string, configurationName string, parameters armautomation.DscConfigurationCreateOrUpdateParameters, options *armautomation.DscConfigurationClientCreateOrUpdateOptions) (resp azfake.Responder[armautomation.DscConfigurationClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)
	...
	// Update is the fake for method DscConfigurationClient.Update
	// HTTP status codes to indicate success: http.StatusOK
	Update func(ctx context.Context, resourceGroupName string, automationAccountName string, configurationName string, parameters armautomation.DscConfigurationUpdateParameters, options *armautomation.DscConfigurationClientUpdateOptions) (resp azfake.Responder[armautomation.DscConfigurationClientUpdateResponse], errResp azfake.ErrorResponder)
}
...
func (d *DscConfigurationServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		if !intercepted {
			switch method {
			case "DscConfigurationClient.CreateOrUpdate":
			...
			case "DscConfigurationClient.Update":
...
func (d *DscConfigurationServerTransport) dispatchCreateOrUpdate(req *http.Request) (*http.Response, error) {
	if d.srv.CreateOrUpdate == nil {
		return nil, &nonRetriableError{errors.New("fake for method CreateOrUpdate not implemented")}
	}
	const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.Automation/automationAccounts/(?P<automationAccountName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/configurations/(?P<configurationName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)`
	...
	respr, errRespr := d.srv.CreateOrUpdate(req.Context(), resourceGroupNameParam, automationAccountNameParam, configurationNameParam, body, nil)
...
func (d *DscConfigurationServerTransport) dispatchGetContent(req *http.Request) (*http.Response, error) {
	...
	const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.Automation/automationAccounts/(?P<automationAccountName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/configurations/(?P<configurationName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/content`
	regex := regexp.MustCompile(regexStr)
	matches := regex.FindStringSubmatch(req.URL.EscapedPath())
	if len(matches) < 5 {
		return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
...
func (d *DscConfigurationServerTransport) dispatchNewListByAutomationAccountPager(req *http.Request) (*http.Response, error) {
	...
	if newListByAutomationAccountPager == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.Automation/automationAccounts/(?P<automationAccountName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/configurations`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 4 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
		...
		inlinecountParam := getOptional(qp.Get("$inlinecount"))
...
func (d *DscConfigurationServerTransport) dispatchUpdate(req *http.Request) (*http.Response, error) {
	if d.srv.Update == nil {
	...
	respr, errRespr := d.srv.Update(req.Context(), resourceGroupNameParam, automationAccountNameParam, configurationNameParam, body, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
