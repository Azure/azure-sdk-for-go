...
func (f *FieldsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if fieldsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = fieldsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			case "FieldsClient.NewListByTypePager":
				res.resp, res.err = f.dispatchNewListByTypePager(req)
			default:
...
func (f *FieldsServerTransport) dispatchNewListByTypePager(req *http.Request) (*http.Response, error) {
	...
	if newListByTypePager == nil {
		...
		server.PagerResponderInjectNextLinks(newListByTypePager, req, func(page *armautomation.FieldsClientListByTypeResponse, createLink func() string) {
...
// set this to conditionally intercept incoming requests to FieldsServerTransport
var fieldsServerTransportInterceptor interface {
