...
func (n *NodeReportsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if nodeReportsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = nodeReportsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "NodeReportsClient.GetContent":
				res.resp, res.err = n.dispatchGetContent(req)
			case "NodeReportsClient.NewListByNodePager":
				res.resp, res.err = n.dispatchNewListByNodePager(req)
			default:
...
// set this to conditionally intercept incoming requests to NodeReportsServerTransport
var nodeReportsServerTransportInterceptor interface {
