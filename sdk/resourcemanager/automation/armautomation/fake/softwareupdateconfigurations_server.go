...
type SoftwareUpdateConfigurationsServer struct {
	...
	// NewListPager is the fake for method SoftwareUpdateConfigurationsClient.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager func(resourceGroupName string, automationAccountName string, options *armautomation.SoftwareUpdateConfigurationsClientListOptions) (resp azfake.PagerResponder[armautomation.SoftwareUpdateConfigurationsClientListResponse])
}
...
func NewSoftwareUpdateConfigurationsServerTransport(srv *SoftwareUpdateConfigurationsServer) *SoftwareUpdateConfigurationsServerTransport {
	return &SoftwareUpdateConfigurationsServerTransport{
		srv:          srv,
		newListPager: newTracker[azfake.PagerResponder[armautomation.SoftwareUpdateConfigurationsClientListResponse]](),
	}
}
...
type SoftwareUpdateConfigurationsServerTransport struct {
	...
	newListPager *tracker[azfake.PagerResponder[armautomation.SoftwareUpdateConfigurationsClientListResponse]]
}
...
func (s *SoftwareUpdateConfigurationsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		if !intercepted {
			...
			case "SoftwareUpdateConfigurationsClient.NewListPager":
...
func (s *SoftwareUpdateConfigurationsServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		resp := s.srv.NewListPager(resourceGroupNameParam, automationAccountNameParam, options)
		newListPager = &resp
