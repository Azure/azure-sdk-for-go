...
func ExampleHybridRunbookWorkersClient_Create() {
	...
	// 			IP: to.Ptr("10.0.0.0"),
	// 			LastSeenDateTime: to.Ptr(time.Date(2018, time.April, 24, 16, 30, 55, 0, time.UTC)),
	// 			RegisteredDateTime: to.Ptr(time.Date(2018, time.April, 24, 16, 30, 55, 0, time.UTC)),
	// 			VMResourceID: to.Ptr("/subscriptions/vmsubid/resourceGroups/vmrg/providers/Microsoft.Compute/virtualMachines/vmname"),
...
func ExampleHybridRunbookWorkersClient_NewListByHybridRunbookWorkerGroupPager() {
	...
	for pager.More() {
		...
		// 				Properties: &armautomation.HybridRunbookWorkerProperties{
		// 					IP: to.Ptr("10.0.0.1"),
		// 					LastSeenDateTime: to.Ptr(time.Date(2018, time.April, 25, 16, 30, 55, 0, time.UTC)),
		// 					RegisteredDateTime: to.Ptr(time.Date(2018, time.April, 25, 16, 30, 55, 0, time.UTC)),
		// 					VMResourceID: to.Ptr(""),
