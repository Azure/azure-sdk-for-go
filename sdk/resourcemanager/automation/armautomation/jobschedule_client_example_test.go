...
// Generated from example definition: 2024-10-23/deleteJobSchedule.json
func ExampleJobScheduleClient_Delete() {
	...
	res, err := clientFactory.NewJobScheduleClient().Delete(ctx, "rg", "ContoseAutomationAccount", "0fa462ba-3aa2-4138-83ca-9ebc3bc55cdc", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	...
	// res = armautomation.JobScheduleClientDeleteResponse{
	// }
}
...
// Generated from example definition: 2024-10-23/listAllJobSchedulesByAutomationAccount.json
func ExampleJobScheduleClient_NewListByAutomationAccountPager() {
	...
	pager := clientFactory.NewJobScheduleClient().NewListByAutomationAccountPager("rg", "ContoseAutomationAccount", nil)
	for pager.More() {
		...
		// page = armautomation.JobScheduleClientListByAutomationAccountResponse{
		// 	JobScheduleListResult: armautomation.JobScheduleListResult{
		// 		Value: []*armautomation.JobSchedule{
		// 			{
		// 				ID: to.Ptr("/subscriptions/aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee/resourceGroups/rg/providers/Microsoft.Automation/automationAccounts/ContoseAutomationAccount/jobSchedules/2f4d8f35-ecd5-44ee-a019-2382fec58fb7"),
		// 				Properties: &armautomation.JobScheduleProperties{
		...
		// 			},
		// 			{
		// 				ID: to.Ptr("/subscriptions/aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee/resourceGroups/rg/providers/Microsoft.Automation/automationAccounts/ContoseAutomationAccount/jobSchedules/446f7a33-86ff-45a1-b71c-f998f701b443"),
		// 				Properties: &armautomation.JobScheduleProperties{
