...
// Generated from example definition: 2024-10-23/job/getJobStream.json
func ExampleJobStreamClient_Get() {
	...
	res, err := clientFactory.NewJobStreamClient().Get(ctx, "mygroup", "ContoseAutomationAccount", "foo", "851b2101-686f-40e2-8a4b-5b8df08afbd1_00636535684910693884_00000000000000000001", nil)
	if err != nil {
	...
	// res = armautomation.JobStreamClientGetResponse{
...
// Generated from example definition: 2024-10-23/job/listJobStreamsByJob.json
func ExampleJobStreamClient_NewListByJobPager() {
	...
	pager := clientFactory.NewJobStreamClient().NewListByJobPager("mygroup", "ContoseAutomationAccount", "foo", nil)
	for pager.More() {
		...
		// page = armautomation.JobStreamClientListByJobResponse{
		// 	JobStreamListResult: armautomation.JobStreamListResult{
