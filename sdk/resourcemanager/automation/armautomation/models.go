...
// AccountListResult - The response of a AutomationAccount list operation.
type AccountListResult struct {
	// REQUIRED; The AutomationAccount items on this page
	Value []*Account
...
type ActivityListResult struct {
	// REQUIRED; The Activity items on this page
	Value []*Activity
...
type ActivityParameter struct {
	...
	// setting is used if the cmdlet must access the complete input object. false indicates that the parameter cannot take values
	// from the complete input object.
	...
	// object that has the same name as this parameter. false indicates that the parameter cannot be filled from the incoming
	...
	// that are associated with this parameter in the form of an array. false if the cmdlet parameter does not accept all the
...
// ConnectionTypeListResult - The response of a ConnectionType list operation.
type ConnectionTypeListResult struct {
	// REQUIRED; The ConnectionType items on this page
...
type DeletedRunbookListResult struct {
	// REQUIRED; The DeletedRunbook items on this page
...
type DscConfigurationProperties struct {
	...
	// FLAG; CONSTANT; Gets or sets the provisioning state of the configuration.
...
type DscNodeReportListResult struct {
	// REQUIRED; The DscNodeReport items on this page
	Value []*DscNodeReport
...
// HybridRunbookWorkerGroupsListResult - The response of a HybridRunbookWorkerGroup list operation.
type HybridRunbookWorkerGroupsListResult struct {
	// REQUIRED; The HybridRunbookWorkerGroup items on this page
...
// HybridRunbookWorkersListResult - The response of a HybridRunbookWorker list operation.
type HybridRunbookWorkersListResult struct {
	// REQUIRED; The HybridRunbookWorker items on this page
...
type JobListResultV2 struct {
	// REQUIRED; The JobCollectionItem items on this page
...
// JobScheduleListResult - The response of a JobSchedule list operation.
type JobScheduleListResult struct {
	// REQUIRED; The JobSchedule items on this page
	Value []*JobSchedule
...
type JobStreamListResult struct {
	// REQUIRED; The JobStream items on this page
	Value []*JobStream
...
// ModuleListResult - The response of a Module list operation.
type ModuleListResult struct {
	// REQUIRED; The Module items on this page
	Value []*Module
...
// PackageListResult - The response of a Package list operation.
type PackageListResult struct {
	// REQUIRED; The Package items on this page
	Value []*Package
...
type ReplaceContentFinalResult struct {
	// REQUIRED
	Body []byte
}
...
// RunbookListResult - The response of a Runbook list operation.
type RunbookListResult struct {
	// REQUIRED; The Runbook items on this page
	Value []*Runbook
...
type RunbookProperties struct {
	...
	// FLAG; CONSTANT; Gets or sets the provisioning state of the runbook.
	ProvisioningState *string
...
// RuntimeEnvironmentListResult - The response of a RuntimeEnvironment list operation.
type RuntimeEnvironmentListResult struct {
	// REQUIRED; The RuntimeEnvironment items on this page
...
// ScheduleListResult - The response of a Schedule list operation.
...
type SoftwareUpdateConfigurationMachineRunListResult struct {
	// REQUIRED; The softwareUpdateConfigurationMachineRun items on this page
...
type SoftwareUpdateConfigurationRunListResult struct {
	// REQUIRED; The softwareUpdateConfigurationRun items on this page
...
// SourceControlListResult - The response of a SourceControl list operation.
...
// SourceControlSyncJobListResult - The response of a SourceControlSyncJob list operation.
type SourceControlSyncJobListResult struct {
	// REQUIRED; The SourceControlSyncJob items on this page
...
type SourceControlSyncJobStreamsListBySyncJob struct {
	// REQUIRED; The SourceControlSyncJobStream items on this page
...
// WebhookListResult - The response of a Webhook list operation.
type WebhookListResult struct {
	// REQUIRED; The Webhook items on this page
	Value []*Webhook
