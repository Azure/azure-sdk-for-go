...
func (d DscConfigurationProperties) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "lastModifiedTime", d.LastModifiedTime)
	populate(objectMap, "logVerbose", d.LogVerbose)
...
func (d DscNodeProperties) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "lastSeen", d.LastSeen)
	populate(objectMap, "nodeConfiguration", d.NodeConfiguration)
	populate(objectMap, "nodeId", d.NodeID)
	populateTime[datetime.RFC3339](objectMap, "registrationTime", d.RegistrationTime)
...
func (d *DscNodeProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "ip":
			...
			delete(rawMsg, key)
		case "lastSeen":
			err = unpopulateTime[datetime.RFC3339](val, "LastSeen", &d.LastSeen)
			delete(rawMsg, key)
		...
		case "registrationTime":
			err = unpopulateTime[datetime.RFC3339](val, "RegistrationTime", &d.RegistrationTime)
			delete(rawMsg, key)
		case "status":
...
func (d DscReportResource) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "startDate", d.StartDate)
	populate(objectMap, "status", d.Status)
	return json.Marshal(objectMap)
}
...
func (d *DscReportResource) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "sourceInfo":
			...
			delete(rawMsg, key)
		case "startDate":
			err = unpopulateTime[datetime.RFC3339](val, "StartDate", &d.StartDate)
			delete(rawMsg, key)
		case "status":
			err = unpopulate(val, "Status", &d.Status)
			delete(rawMsg, key)
...
func (h HybridRunbookWorkerProperties) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "lastSeenDateTime", h.LastSeenDateTime)
	populateTime[datetime.RFC3339](objectMap, "registeredDateTime", h.RegisteredDateTime)
	populate(objectMap, "vmResourceId", h.VMResourceID)
...
func (h *HybridRunbookWorkerProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "lastSeenDateTime":
			err = unpopulateTime[datetime.RFC3339](val, "LastSeenDateTime", &h.LastSeenDateTime)
			delete(rawMsg, key)
		case "registeredDateTime":
			err = unpopulateTime[datetime.RFC3339](val, "RegisteredDateTime", &h.RegisteredDateTime)
			delete(rawMsg, key)
		case "vmResourceId":
			err = unpopulate(val, "VMResourceID", &h.VMResourceID)
			delete(rawMsg, key)
...
func (j JobCollectionItemProperties) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "lastModifiedTime", j.LastModifiedTime)
...
func (j *JobCollectionItemProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "jobRuntimeEnvironment":
			...
			delete(rawMsg, key)
		case "lastModifiedTime":
			err = unpopulateTime[datetime.RFC3339](val, "LastModifiedTime", &j.LastModifiedTime)
			delete(rawMsg, key)
		case "provisioningState":
...
func (j JobProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "jobRuntimeEnvironment", j.JobRuntimeEnvironment)
	populateTime[datetime.RFC3339](objectMap, "lastModifiedTime", j.LastModifiedTime)
	populateTime[datetime.RFC3339](objectMap, "lastStatusModifiedTime", j.LastStatusModifiedTime)
	populate(objectMap, "parameters", j.Parameters)
	populate(objectMap, "provisioningState", j.ProvisioningState)
	populate(objectMap, "runOn", j.RunOn)
	populate(objectMap, "runbook", j.Runbook)
...
func (j *JobProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "lastStatusModifiedTime":
			err = unpopulateTime[datetime.RFC3339](val, "LastStatusModifiedTime", &j.LastStatusModifiedTime)
			delete(rawMsg, key)
		case "parameters":
			err = unpopulate(val, "Parameters", &j.Parameters)
			delete(rawMsg, key)
...
func (j JobStreamProperties) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "time", j.Time)
	populate(objectMap, "value", j.Value)
	return json.Marshal(objectMap)
}
...
func (j *JobStreamProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "summary":
			...
			delete(rawMsg, key)
		case "time":
			err = unpopulateTime[datetime.RFC3339](val, "Time", &j.Time)
			delete(rawMsg, key)
		case "value":
			err = unpopulate(val, "Value", &j.Value)
			delete(rawMsg, key)
...
// MarshalJSON implements the json.Marshaller interface for type ReplaceContentFinalResult.
func (r ReplaceContentFinalResult) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateByteArray(objectMap, "body", r.Body, func() any {
		return runtime.EncodeByteArray(r.Body, runtime.Base64StdFormat)
	})
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ReplaceContentFinalResult.
func (r *ReplaceContentFinalResult) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", r, err)
	}
	for key, val := range rawMsg {
		...
		case "body":
			if val != nil && string(val) != "null" {
				err = runtime.DecodeByteArray(string(val), &r.Body, runtime.Base64StdFormat)
			}
			delete(rawMsg, key)
		}
		if err != nil {
...
func (r RunbookDraft) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "lastModifiedTime", r.LastModifiedTime)
...
func (r *RunbookDraft) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "inEdit":
			...
			delete(rawMsg, key)
		case "lastModifiedTime":
			err = unpopulateTime[datetime.RFC3339](val, "LastModifiedTime", &r.LastModifiedTime)
			delete(rawMsg, key)
		case "outputTypes":
...
func (s SUCScheduleProperties) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "nextRun", s.NextRun)
...
func (s *SUCScheduleProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "lastModifiedTime":
			...
			delete(rawMsg, key)
		case "nextRun":
			err = unpopulateTime[datetime.RFC3339](val, "NextRun", &s.NextRun)
			delete(rawMsg, key)
...
func (t TestJob) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "lastModifiedTime", t.LastModifiedTime)
	populateTime[datetime.RFC3339](objectMap, "lastStatusModifiedTime", t.LastStatusModifiedTime)
...
func (t *TestJob) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "exception":
			...
			delete(rawMsg, key)
		case "lastModifiedTime":
			err = unpopulateTime[datetime.RFC3339](val, "LastModifiedTime", &t.LastModifiedTime)
			delete(rawMsg, key)
		case "lastStatusModifiedTime":
			err = unpopulateTime[datetime.RFC3339](val, "LastStatusModifiedTime", &t.LastStatusModifiedTime)
			delete(rawMsg, key)
		case "logActivityTrace":
...
func (u UpdateConfigurationMachineRunProperties) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "creationTime", u.CreationTime)
...
func (u *UpdateConfigurationMachineRunProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "createdBy":
			...
			delete(rawMsg, key)
		case "creationTime":
			err = unpopulateTime[datetime.RFC3339](val, "CreationTime", &u.CreationTime)
			delete(rawMsg, key)
		case "endTime":
...
func (v VariableProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateTime[datetime.RFC3339](objectMap, "creationTime", v.CreationTime)
	populate(objectMap, "description", v.Description)
	populate(objectMap, "isEncrypted", v.IsEncrypted)
	populateTime[datetime.RFC3339](objectMap, "lastModifiedTime", v.LastModifiedTime)
	populate(objectMap, "value", v.Value)
	return json.Marshal(objectMap)
}
...
func (v *VariableProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "creationTime":
			err = unpopulateTime[datetime.RFC3339](val, "CreationTime", &v.CreationTime)
			delete(rawMsg, key)
		case "description":
			err = unpopulate(val, "Description", &v.Description)
			delete(rawMsg, key)
		case "isEncrypted":
			...
			delete(rawMsg, key)
		case "lastModifiedTime":
			err = unpopulateTime[datetime.RFC3339](val, "LastModifiedTime", &v.LastModifiedTime)
			delete(rawMsg, key)
		case "value":
			err = unpopulate(val, "Value", &v.Value)
			delete(rawMsg, key)
...
func (w WatcherProperties) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "lastModifiedTime", w.LastModifiedTime)
...
func (w *WatcherProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "lastModifiedBy":
			...
			delete(rawMsg, key)
		case "lastModifiedTime":
			err = unpopulateTime[datetime.RFC3339](val, "LastModifiedTime", &w.LastModifiedTime)
			delete(rawMsg, key)
		case "scriptName":
...
func (w WebhookProperties) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "expiryTime", w.ExpiryTime)
	populate(objectMap, "isEnabled", w.IsEnabled)
	populateTime[datetime.RFC3339](objectMap, "lastInvokedTime", w.LastInvokedTime)
	populate(objectMap, "lastModifiedBy", w.LastModifiedBy)
	populateTime[datetime.RFC3339](objectMap, "lastModifiedTime", w.LastModifiedTime)
	populate(objectMap, "parameters", w.Parameters)
	populate(objectMap, "runOn", w.RunOn)
...
func (w *WebhookProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "lastInvokedTime":
			err = unpopulateTime[datetime.RFC3339](val, "LastInvokedTime", &w.LastInvokedTime)
			delete(rawMsg, key)
		case "lastModifiedBy":
			err = unpopulate(val, "LastModifiedBy", &w.LastModifiedBy)
			delete(rawMsg, key)
