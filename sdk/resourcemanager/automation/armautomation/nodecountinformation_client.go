...
// NewGetPager - Retrieve counts for Dsc Nodes.
//
// Generated from API version 2024-10-23
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - automationAccountName - The name of the automation account.
//   - countType - The type of counts to retrieve
//   - options - NodeCountInformationClientGetOptions contains the optional parameters for the NodeCountInformationClient.NewGetPager
//     method.
func (client *NodeCountInformationClient) NewGetPager(resourceGroupName string, automationAccountName string, countType CountType, options *NodeCountInformationClientGetOptions) *runtime.Pager[NodeCountInformationClientGetResponse] {
	return runtime.NewPager(runtime.PagingHandler[NodeCountInformationClientGetResponse]{
		More: func(page NodeCountInformationClientGetResponse) bool {
			return false
		},
		Fetcher: func(ctx context.Context, page *NodeCountInformationClientGetResponse) (NodeCountInformationClientGetResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "NodeCountInformationClient.NewGetPager")
