...
func (client *PrivateLinkResourcesClient) NewAutomationPager(resourceGroupName string, automationAccountName string, options *PrivateLinkResourcesClientAutomationOptions) *runtime.Pager[PrivateLinkResourcesClientAutomationResponse] {
	return runtime.NewPager(runtime.PagingHandler[PrivateLinkResourcesClientAutomationResponse]{
		...
		Fetcher: func(ctx context.Context, page *PrivateLinkResourcesClientAutomationResponse) (PrivateLinkResourcesClientAutomationResponse, error) {
			...
			req, err := client.automationCreateRequest(ctx, resourceGroupName, automationAccountName, nextLink, options)
			if err != nil {
			...
			return client.automationHandleResponse(resp, http.StatusOK)
		},
...
func (client *PrivateLinkResourcesClient) automationCreateRequest(ctx context.Context, resourceGroupName string, automationAccountName string, nextLink string, _ *PrivateLinkResourcesClientAutomationOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *PrivateLinkResourcesClient) automationHandleResponse(resp *http.Response, successCodes ...int) (PrivateLinkResourcesClientAutomationResponse, error) {
