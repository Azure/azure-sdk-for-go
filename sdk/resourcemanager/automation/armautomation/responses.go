...
// AccountsClientConvertGraphRunbookContentResponse contains the response from method AccountsClient.ConvertGraphRunbookContent.
type AccountsClientConvertGraphRunbookContentResponse struct {
...
// DscConfigurationClientCreateOrUpdateResponse contains the response from method DscConfigurationClient.CreateOrUpdate.
type DscConfigurationClientCreateOrUpdateResponse struct {
...
// DscConfigurationClientUpdateResponse contains the response from method DscConfigurationClient.Update.
type DscConfigurationClientUpdateResponse struct {
	// Definition of the configuration type.
	DscConfiguration
}
...
// NodeCountInformationClientGetResponse contains the response from method NodeCountInformationClient.NewGetPager.
...
// SoftwareUpdateConfigurationsClientListResponse contains the response from method SoftwareUpdateConfigurationsClient.NewListPager.
