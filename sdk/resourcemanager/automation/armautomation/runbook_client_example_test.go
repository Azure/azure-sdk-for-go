...
func ExampleRunbookClient_CreateOrUpdate_createOrUpdateRunbookAndPublishIt() {
	...
	// 			Description: to.Ptr("Description of the Runbook"),
	// 			CreationTime: to.Ptr(time.Date(2017, time.March, 28, 21, 4, 43, 660000000, time.UTC)),
	// 			JobCount: to.Ptr[int32](0),
	// 			LastModifiedBy: to.Ptr("myEmaild@microsoft.com"),
	// 			LastModifiedTime: to.Ptr(time.Date(2017, time.March, 28, 21, 4, 46, 600000000, time.UTC)),
	// 			LogActivityTrace: to.Ptr[int32](1),
	// 			LogProgress: to.Ptr(true),
...
func ExampleRunbookClient_CreateOrUpdate_createRunbookAsDraft() {
	...
	// 		Properties: &armautomation.RunbookProperties{
	// 			Description: to.Ptr("Description of the Runbook"),
	// 			CreationTime: to.Ptr(time.Date(2018, time.February, 9, 3, 25, 59, 97000000, time.UTC)),
	// 			JobCount: to.Ptr[int32](0),
	// 			LastModifiedTime: to.Ptr(time.Date(2018, time.February, 9, 3, 25, 59, 97000000, time.UTC)),
...
func ExampleRunbookClient_Get() {
	...
	// 		Properties: &armautomation.RunbookProperties{
	// 			Description: to.Ptr("Description of the Runbook"),
	// 			CreationTime: to.Ptr(time.Date(2017, time.March, 28, 21, 32, 23, 750000000, time.UTC)),
	// 			JobCount: to.Ptr[int32](0),
	// 			LastModifiedBy: to.Ptr("myEmaild@microsoft.com"),
	// 			LastModifiedTime: to.Ptr(time.Date(2017, time.March, 28, 21, 32, 23, 750000000, time.UTC)),
	// 			LogActivityTrace: to.Ptr[int32](1),
	// 			LogProgress: to.Ptr(true),
	// 			LogVerbose: to.Ptr(false),
	// 			OutputTypes: []*string{
...
func ExampleRunbookClient_NewListByAutomationAccountPager() {
	...
	for pager.More() {
		...
		// 				Location: to.Ptr("East US 2"),
		// 				Properties: &armautomation.RunbookProperties{
		// 					CreationTime: to.Ptr(time.Date(2017, time.March, 28, 21, 32, 25, 780000000, time.UTC)),
		// 					LastModifiedTime: to.Ptr(time.Date(2017, time.March, 28, 21, 32, 25, 810000000, time.UTC)),
		// 					LogActivityTrace: to.Ptr[int32](1),
		// 					LogProgress: to.Ptr(true),
		// 					LogVerbose: to.Ptr(true),
		// 					RunbookType: to.Ptr(armautomation.RunbookTypeEnumPowerShellWorkflow),
		...
		// 				Location: to.Ptr("East US 2"),
		// 				Properties: &armautomation.RunbookProperties{
		// 					CreationTime: to.Ptr(time.Date(2017, time.March, 28, 21, 32, 27, 327000000, time.UTC)),
		// 					LastModifiedTime: to.Ptr(time.Date(2017, time.March, 28, 21, 32, 27, 327000000, time.UTC)),
		// 					LogActivityTrace: to.Ptr[int32](1),
		// 					LogProgress: to.Ptr(true),
		// 					LogVerbose: to.Ptr(true),
		// 					RunbookType: to.Ptr(armautomation.RunbookTypeEnumPowerShellWorkflow),
...
func ExampleRunbookClient_Update() {
	...
	// 		Properties: &armautomation.RunbookProperties{
	// 			Description: to.Ptr("Updated Description of the Runbook"),
	// 			CreationTime: to.Ptr(time.Date(2017, time.March, 30, 21, 1, 33, 777000000, time.UTC)),
	// 			JobCount: to.Ptr[int32](0),
	// 			LastModifiedBy: to.Ptr("myEmaild@microsoft.com"),
	// 			LastModifiedTime: to.Ptr(time.Date(2017, time.March, 30, 21, 1, 39, 450000000, time.UTC)),
	// 			LogActivityTrace: to.Ptr[int32](1),
	// 			LogProgress: to.Ptr(true),
	// 			LogVerbose: to.Ptr(false),
	// 			OutputTypes: []*string{
