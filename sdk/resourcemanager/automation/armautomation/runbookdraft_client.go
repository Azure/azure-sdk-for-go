...
func (client *RunbookDraftClient) getContentHandleResponse(resp *http.Response) (RunbookDraftClientGetContentResponse, error) {
	result := RunbookDraftClientGetContentResponse{Body: resp.Body}
...
//     method.
func (client *RunbookDraftClient) BeginReplaceContent(ctx context.Context, resourceGroupName string, automationAccountName string, runbookName string, runbookContent []byte, options *RunbookDraftClientBeginReplaceContentOptions) (*runtime.Poller[RunbookDraftClientReplaceContentResponse], error) {
...
//
// Generated from API version 2024-10-23
func (client *RunbookDraftClient) replaceContent(ctx context.Context, resourceGroupName string, automationAccountName string, runbookName string, runbookContent []byte, options *RunbookDraftClientBeginReplaceContentOptions) (*http.Response, error) {
	var err error
...
func (client *RunbookDraftClient) replaceContentCreateRequest(ctx context.Context, resourceGroupName string, automationAccountName string, runbookName string, runbookContent []byte, _ *RunbookDraftClientBeginReplaceContentOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Automation/automationAccounts/{automationAccountName}/runbooks/{runbookName}/draft/content"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
	...
	req.Raw().Header["Content-Type"] = []string{"text/powershell"}
	if err := req.SetBody(body, "text/powershell"); err != nil {
		return nil, err
	}
	return req, nil
}
