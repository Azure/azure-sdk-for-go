...
// NewListPager - Get all software update configurations for the account.
//
// Generated from API version 2024-10-23
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - automationAccountName - The name of the automation account.
//   - options - SoftwareUpdateConfigurationsClientListOptions contains the optional parameters for the SoftwareUpdateConfigurationsClient.NewListPager
//     method.
func (client *SoftwareUpdateConfigurationsClient) NewListPager(resourceGroupName string, automationAccountName string, options *SoftwareUpdateConfigurationsClientListOptions) *runtime.Pager[SoftwareUpdateConfigurationsClientListResponse] {
	return runtime.NewPager(runtime.PagingHandler[SoftwareUpdateConfigurationsClientListResponse]{
		More: func(page SoftwareUpdateConfigurationsClientListResponse) bool {
			return false
		},
		Fetcher: func(ctx context.Context, page *SoftwareUpdateConfigurationsClientListResponse) (SoftwareUpdateConfigurationsClientListResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "SoftwareUpdateConfigurationsClient.NewListPager")
