...
// Generated from example definition: 2024-10-23/softwareUpdateConfiguration/createSoftwareUpdateConfiguration.json
func ExampleSoftwareUpdateConfigurationsClient_Create() {
	...
	res, err := clientFactory.NewSoftwareUpdateConfigurationsClient().Create(ctx, "mygroup", "myaccount", "testpatch", armautomation.SoftwareUpdateConfiguration{
		Properties: &armautomation.SoftwareUpdateConfigurationProperties{
			ScheduleInfo: &armautomation.SUCScheduleProperties{
				...
				ExpiryTime: to.Ptr(time.Date(2018, time.November, 9, 11, 22, 57, 0, time.UTC)),
				Frequency:  to.Ptr(armautomation.ScheduleFrequencyHour),
				Interval:   to.Ptr[int64](1),
				StartTime:  to.Ptr(time.Date(2017, time.October, 19, 12, 22, 57, 0, time.UTC)),
	...
	// res = armautomation.SoftwareUpdateConfigurationsClientCreateResponse{
	// 	SoftwareUpdateConfiguration: armautomation.SoftwareUpdateConfiguration{
	...
	// 			CreationTime: to.Ptr(time.Date(2017, time.October, 19, 18, 54, 50, 523333300, time.UTC)),
	// 			Error: &armautomation.ErrorResponse{
	// 			},
	// 			LastModifiedBy: to.Ptr("adam@contoso.com"),
	// 			LastModifiedTime: to.Ptr(time.Date(2017, time.October, 19, 18, 54, 50, 680000000, time.UTC)),
	...
	// 				},
	// 				CreationTime: to.Ptr(time.Date(2017, time.October, 19, 18, 54, 50, 523333300, time.UTC)),
	// 				ExpiryTime: to.Ptr(time.Date(2018, time.November, 9, 19, 22, 0, 0, time.UTC)),
	// 				ExpiryTimeOffsetMinutes: to.Ptr[float64](-480),
	// 				Frequency: to.Ptr(armautomation.ScheduleFrequencyWeek),
	// 				Interval: to.Ptr[int64](1),
	// 				IsEnabled: to.Ptr(true),
	// 				LastModifiedTime: to.Ptr(time.Date(2017, time.October, 19, 18, 54, 50, 523333300, time.UTC)),
	// 				NextRun: to.Ptr(time.Date(2017, time.October, 19, 19, 22, 0, 0, time.UTC)),
	// 				NextRunOffsetMinutes: to.Ptr[float64](-420),
	// 				StartTime: to.Ptr(time.Date(2017, time.October, 19, 19, 22, 0, 0, time.UTC)),
...
// Generated from example definition: 2024-10-23/softwareUpdateConfiguration/getSoftwareUpdateConfigurationByName.json
func ExampleSoftwareUpdateConfigurationsClient_GetByName() {
	...
	res, err := clientFactory.NewSoftwareUpdateConfigurationsClient().GetByName(ctx, "mygroup", "myaccount", "mypatch", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armautomation.SoftwareUpdateConfigurationsClientGetByNameResponse{
	// 	SoftwareUpdateConfiguration: armautomation.SoftwareUpdateConfiguration{
	// 		Name: to.Ptr("testpatch"),
	// 		ID: to.Ptr("/subscriptions/51766542-3ed7-4a72-a187-0c8ab644ddab/resourceGroups/mygroup/providers/Microsoft.Automation/automationAccounts/myaccount/softwareUpdateConfigurations/testpatch"),
	// 		Properties: &armautomation.SoftwareUpdateConfigurationProperties{
...
// Generated from example definition: 2024-10-23/softwareUpdateConfiguration/listSoftwareUpdateConfigurations.json
func ExampleSoftwareUpdateConfigurationsClient_List_listSoftwareUpdateConfigurations() {
	...
	ctx := context.Background()
	clientFactory, err := armautomation.NewClientFactory("1a7d4044-286c-4acb-969a-96639265bf2e", cred, nil)
	if err != nil {
		log.Fatalf("failed to create client: %v", err)
	}
	res, err := clientFactory.NewSoftwareUpdateConfigurationsClient().List(ctx, "mygroup", "myaccount", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armautomation.SoftwareUpdateConfigurationsClientListResponse{
	// 	SoftwareUpdateConfigurationListResult: armautomation.SoftwareUpdateConfigurationListResult{
	...
	// 					Frequency: to.Ptr(armautomation.ScheduleFrequencyWeek),
	// 					LastModifiedTime: to.Ptr(time.Date(2017, time.October, 19, 18, 54, 50, 680000000, time.UTC)),
	// 					NextRun: to.Ptr(time.Date(2017, time.October, 23, 19, 22, 0, 0, time.UTC)),
	...
	// 				Properties: &armautomation.SoftwareUpdateConfigurationCollectionItemProperties{
	// 					CreationTime: to.Ptr(time.Date(2017, time.August, 11, 21, 52, 2, 773333300, time.UTC)),
	// 					Frequency: to.Ptr(armautomation.ScheduleFrequencyHour),
	// 					LastModifiedTime: to.Ptr(time.Date(2017, time.August, 11, 21, 52, 22, 880000000, time.UTC)),
	// 					NextRun: to.Ptr(time.Date(2018, time.May, 5, 19, 26, 0, 0, time.UTC)),
	// 					ProvisioningState: to.Ptr("Succeeded"),
	// 					StartTime: to.Ptr(time.Date(2018, time.May, 5, 19, 26, 0, 0, time.UTC)),
	// 					Tasks: &armautomation.SoftwareUpdateConfigurationTasks{
	// 						PostTask: &armautomation.TaskProperties{
	// 							Source: to.Ptr("GetCache"),
	// 						},
...
// Generated from example definition: 2024-10-23/softwareUpdateConfiguration/listSoftwareUpdateConfigurationsByVm.json
func ExampleSoftwareUpdateConfigurationsClient_List_listSoftwareUpdateConfigurationsTargetingASpecificAzureVirtualMachine() {
	...
	res, err := clientFactory.NewSoftwareUpdateConfigurationsClient().List(ctx, "mygroup", "myaccount", &armautomation.SoftwareUpdateConfigurationsClientListOptions{
