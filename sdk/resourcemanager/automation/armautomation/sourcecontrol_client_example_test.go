...
// Generated from example definition: 2024-10-23/sourceControl/deleteSourceControl.json
func ExampleSourceControlClient_Delete() {
	...
	res, err := clientFactory.NewSourceControlClient().Delete(ctx, "rg", "sampleAccount9", "sampleSourceControl", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armautomation.SourceControlClientDeleteResponse{
	// }
}

// Generated from example definition: 2024-10-23/sourceControl/getSourceControl.json
func ExampleSourceControlClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armautomation.SourceControlClientGetResponse{
	// 	SourceControl: armautomation.SourceControl{
	// 		Name: to.Ptr("sampleSourceControl"),
	// 		ID: to.Ptr("/subscriptions/aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee/resourceGroups/rg/providers/Microsoft.Automation/automationAccounts/sampleAccount9/sourcecontrols/sampleSourceControl"),
	// 		Properties: &armautomation.SourceControlProperties{
...
// Generated from example definition: 2024-10-23/sourceControl/updateSourceControl_patch.json
func ExampleSourceControlClient_Update() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armautomation.SourceControlClientUpdateResponse{
	// 	SourceControl: armautomation.SourceControl{
	// 		Name: to.Ptr("sampleSourceControl"),
	// 		ID: to.Ptr("/subscriptions/aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee/resourceGroups/rg/providers/Microsoft.Automation/automationAccounts/sampleAccount9/sourcecontrols/sampleSourceControl"),
	// 		Properties: &armautomation.SourceControlProperties{
