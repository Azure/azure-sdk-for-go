...
func (client *SourceControlSyncJobClient) createHandleResponse(resp *http.Response, successCodes ...int) (SourceControlSyncJobClientCreateResponse, error) {
...
func (client *SourceControlSyncJobClient) getHandleResponse(resp *http.Response, successCodes ...int) (SourceControlSyncJobClientGetResponse, error) {
...
func (client *SourceControlSyncJobClient) NewListByAutomationAccountPager(resourceGroupName string, automationAccountName string, sourceControlName string, options *SourceControlSyncJobClientListByAutomationAccountOptions) *runtime.Pager[SourceControlSyncJobClientListByAutomationAccountResponse] {
	return runtime.NewPager(runtime.PagingHandler[SourceControlSyncJobClientListByAutomationAccountResponse]{
		...
		Fetcher: func(ctx context.Context, page *SourceControlSyncJobClientListByAutomationAccountResponse) (SourceControlSyncJobClientListByAutomationAccountResponse, error) {
			...
			req, err := client.listByAutomationAccountCreateRequest(ctx, resourceGroupName, automationAccountName, sourceControlName, nextLink, options)
			if err != nil {
...
func (client *SourceControlSyncJobClient) listByAutomationAccountCreateRequest(ctx context.Context, resourceGroupName string, automationAccountName string, sourceControlName string, nextLink string, options *SourceControlSyncJobClientListByAutomationAccountOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *SourceControlSyncJobClient) listByAutomationAccountHandleResponse(resp *http.Response, successCodes ...int) (SourceControlSyncJobClientListByAutomationAccountResponse, error) {
