...
// Generated from example definition: 2024-10-23/sourceControlSyncJob/getSourceControlSyncJob.json
func ExampleSourceControlSyncJobClient_Get() {
	...
	// res = armautomation.SourceControlSyncJobClientGetResponse{
	// 	SourceControlSyncJobByID: armautomation.SourceControlSyncJobByID{
	// 		ID: to.Ptr("/subscriptions/aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee/resourceGroups/rg/providers/Microsoft.Automation/automationAccounts/myAutomationAccount33/sourceControls/MySourceControl/sourceControlSyncJobs/ce6fe3e3-9db3-4096-a6b4-82bfb4c10a9a"),
	// 		Properties: &armautomation.SourceControlSyncJobByIDProperties{
	// 			CreationTime: to.Ptr(time.Date(2017, time.March, 28, 23, 14, 26, 903000000, time.UTC)),
	// 			EndTime: to.Ptr(time.Date(2017, time.March, 28, 23, 14, 28, 903000000, time.UTC)),
	// 			Exception: to.Ptr(""),
	...
	// 			StartTime: to.Ptr(time.Date(2017, time.March, 28, 23, 14, 27, 903000000, time.UTC)),
