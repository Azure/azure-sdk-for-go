...
// Generated from example definition: 2024-10-23/sourceControlSyncJobStreams/getSourceControlSyncJobStreamsByStreamId.json
func ExampleSourceControlSyncJobStreamsClient_Get() {
	...
	// res = armautomation.SourceControlSyncJobStreamsClientGetResponse{
	// 	SourceControlSyncJobStreamByID: armautomation.SourceControlSyncJobStreamByID{
	// 		ID: to.Ptr("/subscriptions/aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee/resourceGroups/rg/providers/Microsoft.Automation/automationAccounts/myAutomationAccount33/sourceControls/MySourceControl/sourceControlSyncJobs/ce6fe3e3-9db3-4096-a6b4-82bfb4c10a2b/streams/b86c5c31-e9fd-4734-8764-ddd6c101e706_00636596855139029522_00000000000000000007"),
	...
	// 			Summary: to.Ptr(""),
	// 			Time: to.Ptr(time.Date(2017, time.March, 28, 23, 14, 26, 903000000, time.UTC)),
...
// Generated from example definition: 2024-10-23/sourceControlSyncJobStreams/getSourceControlSyncJobStreams.json
func ExampleSourceControlSyncJobStreamsClient_NewListBySyncJobPager() {
	...
	pager := clientFactory.NewSourceControlSyncJobStreamsClient().NewListBySyncJobPager("rg", "myAutomationAccount33", "MySourceControl", "ce6fe3e3-9db3-4096-a6b4-82bfb4c10a2b", nil)
	for pager.More() {
		...
		// page = armautomation.SourceControlSyncJobStreamsClientListBySyncJobResponse{
		// 	SourceControlSyncJobStreamsListBySyncJob: armautomation.SourceControlSyncJobStreamsListBySyncJob{
		// 		Value: []*armautomation.SourceControlSyncJobStream{
		// 			{
		// 				ID: to.Ptr("/subscriptions/aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee/resourceGroups/rg/providers/Microsoft.Automation/automationAccounts/myAutomationAccount33/sourceControls/MySourceControl/sourceControlSyncJobs/ce6fe3e3-9db3-4096-a6b4-82bfb4c10a2b/streams/b86c5c31-e9fd-4734-8764-ddd6c101e706_00636596855134810785_00000000000000000005"),
		...
		// 			},
		// 			{
		// 				ID: to.Ptr("/subscriptions/aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee/resourceGroups/rg/providers/Microsoft.Automation/automationAccounts/myAutomationAccount33/sourceControls/MySourceControl/sourceControlSyncJobs/ce6fe3e3-9db3-4096-a6b4-82bfb4c10a2b/streams/b86c5c31-e9fd-4734-8764-ddd6c101e706_00636596855136998262_00000000000000000006"),
		// 				Properties: &armautomation.SourceControlSyncJobStreamProperties{
		...
		// 					Time: to.Ptr(time.Date(2017, time.March, 28, 23, 14, 27, 903000000, time.UTC)),
		// 				},
		// 			},
		// 			{
		// 				ID: to.Ptr("/subscriptions/aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee/resourceGroups/rg/providers/Microsoft.Automation/automationAccounts/myAutomationAccount33/sourceControls/MySourceControl/sourceControlSyncJobs/ce6fe3e3-9db3-4096-a6b4-82bfb4c10a2b/streams/b86c5c31-e9fd-4734-8764-ddd6c101e706_00636596855139029522_00000000000000000007"),
		...
		// 					Time: to.Ptr(time.Date(2017, time.March, 28, 23, 14, 28, 903000000, time.UTC)),
		// 				},
		// 			},
		// 		},
		// 	},
