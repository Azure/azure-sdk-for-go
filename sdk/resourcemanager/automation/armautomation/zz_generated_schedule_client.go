...
func NewScheduleClient(con *arm.Connection, subscriptionID string) *ScheduleClient {
	return &ScheduleClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
