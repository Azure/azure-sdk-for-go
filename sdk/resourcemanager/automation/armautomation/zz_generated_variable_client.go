...
func NewVariableClient(con *arm.Connection, subscriptionID string) *VariableClient {
	return &VariableClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
