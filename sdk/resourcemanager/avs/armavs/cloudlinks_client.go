...
func (client *CloudLinksClient) getHandleResponse(resp *http.Response, successCodes ...int) (CloudLinksClientGetResponse, error) {
...
func (client *CloudLinksClient) listCreateRequest(ctx context.Context, resourceGroupName string, privateCloudName string, nextLink string, _ *CloudLinksClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *CloudLinksClient) listHandleResponse(resp *http.Response, successCodes ...int) (CloudLinksClientListResponse, error) {
