...
// PossibleHostKindValues returns the possible values for the HostKind const type.
func PossibleHostKindValues() []HostKind {
	return []HostKind{
		HostKindGeneral,
		HostKindSpecialized,
	}
...
const (
	// HostMaintenanceReplacement - The host is a replacement host.
	HostMaintenanceReplacement HostMaintenance = "Replacement"
	// HostMaintenanceUpgrade - The host is for an upgrade, such as an upgrade to ESXi, NSX-T, or other component.
	HostMaintenanceUpgrade HostMaintenance = "Upgrade"
)

// PossibleHostMaintenanceValues returns the possible values for the HostMaintenance const type.
func PossibleHostMaintenanceValues() []HostMaintenance {
	return []HostMaintenance{
		HostMaintenanceReplacement,
		HostMaintenanceUpgrade,
	}
}

// HostProvisioningState - provisioning state of the host
type HostProvisioningState string

const (
	// HostProvisioningStateCanceled - Resource creation was canceled.
	HostProvisioningStateCanceled HostProvisioningState = "Canceled"
	// HostProvisioningStateFailed - Resource creation failed.
	HostProvisioningStateFailed HostProvisioningState = "Failed"
	// HostProvisioningStateSucceeded - Resource has been created.
	HostProvisioningStateSucceeded HostProvisioningState = "Succeeded"
)

// PossibleHostProvisioningStateValues returns the possible values for the HostProvisioningState const type.
func PossibleHostProvisioningStateValues() []HostProvisioningState {
	return []HostProvisioningState{
		HostProvisioningStateCanceled,
...
// ProvisionedNetworkProvisioningState - provisioned network provisioning state
type ProvisionedNetworkProvisioningState string

const (
	// ProvisionedNetworkProvisioningStateCanceled - Resource creation was canceled.
	ProvisionedNetworkProvisioningStateCanceled ProvisionedNetworkProvisioningState = "Canceled"
	// ProvisionedNetworkProvisioningStateFailed - Resource creation failed.
	ProvisionedNetworkProvisioningStateFailed ProvisionedNetworkProvisioningState = "Failed"
	// ProvisionedNetworkProvisioningStateSucceeded - Resource has been created.
	ProvisionedNetworkProvisioningStateSucceeded ProvisionedNetworkProvisioningState = "Succeeded"
)

// PossibleProvisionedNetworkProvisioningStateValues returns the possible values for the ProvisionedNetworkProvisioningState const type.
func PossibleProvisionedNetworkProvisioningStateValues() []ProvisionedNetworkProvisioningState {
	return []ProvisionedNetworkProvisioningState{
		ProvisionedNetworkProvisioningStateCanceled,
		ProvisionedNetworkProvisioningStateFailed,
		ProvisionedNetworkProvisioningStateSucceeded,
	}
}

// ProvisionedNetworkTypes - The type of network provisioned.
type ProvisionedNetworkTypes string

const (
	// ProvisionedNetworkTypesEsxManagement - network for ESX management
	ProvisionedNetworkTypesEsxManagement ProvisionedNetworkTypes = "esxManagement"
	// ProvisionedNetworkTypesEsxReplication - network for ESX replication
	ProvisionedNetworkTypesEsxReplication ProvisionedNetworkTypes = "esxReplication"
	// ProvisionedNetworkTypesHcxManagement - network for HCX management
	ProvisionedNetworkTypesHcxManagement ProvisionedNetworkTypes = "hcxManagement"
	// ProvisionedNetworkTypesHcxUplink - network for HCX uplink
	ProvisionedNetworkTypesHcxUplink ProvisionedNetworkTypes = "hcxUplink"
	// ProvisionedNetworkTypesVcenterManagement - network for vCenter management
	ProvisionedNetworkTypesVcenterManagement ProvisionedNetworkTypes = "vcenterManagement"
	// ProvisionedNetworkTypesVmotion - network for vmotion
	ProvisionedNetworkTypesVmotion ProvisionedNetworkTypes = "vmotion"
	// ProvisionedNetworkTypesVsan - network for vsan
	ProvisionedNetworkTypesVsan ProvisionedNetworkTypes = "vsan"
)

// PossibleProvisionedNetworkTypesValues returns the possible values for the ProvisionedNetworkTypes const type.
func PossibleProvisionedNetworkTypesValues() []ProvisionedNetworkTypes {
	return []ProvisionedNetworkTypes{
		ProvisionedNetworkTypesEsxManagement,
...
// PureStoragePolicyProvisioningState - Pure Storage Policy Based Management policy provisioning state
type PureStoragePolicyProvisioningState string

const (
	// PureStoragePolicyProvisioningStateCanceled - Resource creation was canceled.
	PureStoragePolicyProvisioningStateCanceled PureStoragePolicyProvisioningState = "Canceled"
	// PureStoragePolicyProvisioningStateDeleting - is deleting
	PureStoragePolicyProvisioningStateDeleting PureStoragePolicyProvisioningState = "Deleting"
	// PureStoragePolicyProvisioningStateFailed - Resource creation failed.
	PureStoragePolicyProvisioningStateFailed PureStoragePolicyProvisioningState = "Failed"
	// PureStoragePolicyProvisioningStateSucceeded - Resource has been created.
	PureStoragePolicyProvisioningStateSucceeded PureStoragePolicyProvisioningState = "Succeeded"
	// PureStoragePolicyProvisioningStateUpdating - is updating
	PureStoragePolicyProvisioningStateUpdating PureStoragePolicyProvisioningState = "Updating"
)

// PossiblePureStoragePolicyProvisioningStateValues returns the possible values for the PureStoragePolicyProvisioningState const type.
func PossiblePureStoragePolicyProvisioningStateValues() []PureStoragePolicyProvisioningState {
	return []PureStoragePolicyProvisioningState{
		PureStoragePolicyProvisioningStateCanceled,
...
const (
	// ResourceIdentityTypeNone - No managed system identity.
	ResourceIdentityTypeNone ResourceIdentityType = "None"
	// ResourceIdentityTypeSystemAssigned - System assigned managed system identity.
...
// ResourceSKUResourceType - Describes the type of resource the SKU applies to.
type ResourceSKUResourceType string

const (
	// ResourceSKUResourceTypePrivateClouds - The SKU is for a private cloud.
	ResourceSKUResourceTypePrivateClouds ResourceSKUResourceType = "privateClouds"
	// ResourceSKUResourceTypePrivateCloudsClusters - The SKU is for a private cloud cluster.
	ResourceSKUResourceTypePrivateCloudsClusters ResourceSKUResourceType = "privateClouds/clusters"
)

// PossibleResourceSKUResourceTypeValues returns the possible values for the ResourceSKUResourceType const type.
func PossibleResourceSKUResourceTypeValues() []ResourceSKUResourceType {
	return []ResourceSKUResourceType{
		ResourceSKUResourceTypePrivateClouds,
