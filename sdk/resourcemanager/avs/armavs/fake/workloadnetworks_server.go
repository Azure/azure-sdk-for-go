...
type WorkloadNetworksServer struct {
	...
	// BeginCreateSegment is the fake for method WorkloadNetworksClient.BeginCreateSegment
	// HTTP status codes to indicate success: http.StatusOK, http.StatusCreated
	BeginCreateSegment func(ctx context.Context, resourceGroupName string, privateCloudName string, segmentID string, workloadNetworkSegment armavs.WorkloadNetworkSegment, options *armavs.WorkloadNetworksClientBeginCreateSegmentOptions) (resp azfake.PollerResponder[armavs.WorkloadNetworksClientCreateSegmentResponse], errResp azfake.ErrorResponder)
	...
	// NewListDNSServicePager is the fake for method WorkloadNetworksClient.NewListDNSServicePager
	// HTTP status codes to indicate success: http.StatusOK
	NewListDNSServicePager func(resourceGroupName string, privateCloudName string, options *armavs.WorkloadNetworksClientListDNSServiceOptions) (resp azfake.PagerResponder[armavs.WorkloadNetworksClientListDNSServiceResponse])
	...
	// BeginUpdateSegment is the fake for method WorkloadNetworksClient.BeginUpdateSegment
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginUpdateSegment func(ctx context.Context, resourceGroupName string, privateCloudName string, segmentID string, workloadNetworkSegment armavs.WorkloadNetworkSegment, options *armavs.WorkloadNetworksClientBeginUpdateSegmentOptions) (resp azfake.PollerResponder[armavs.WorkloadNetworksClientUpdateSegmentResponse], errResp azfake.ErrorResponder)
...
func NewWorkloadNetworksServerTransport(srv *WorkloadNetworksServer) *WorkloadNetworksServerTransport {
	return &WorkloadNetworksServerTransport{
		...
		beginCreateSegment:          newTracker[azfake.PollerResponder[armavs.WorkloadNetworksClientCreateSegmentResponse]](),
		...
		newListDNSServicePager:      newTracker[azfake.PagerResponder[armavs.WorkloadNetworksClientListDNSServiceResponse]](),
		...
		beginUpdateSegment:          newTracker[azfake.PollerResponder[armavs.WorkloadNetworksClientUpdateSegmentResponse]](),
...
type WorkloadNetworksServerTransport struct {
	...
	beginCreateSegment          *tracker[azfake.PollerResponder[armavs.WorkloadNetworksClientCreateSegmentResponse]]
	...
	newListDNSServicePager      *tracker[azfake.PagerResponder[armavs.WorkloadNetworksClientListDNSServiceResponse]]
	...
	beginUpdateSegment          *tracker[azfake.PollerResponder[armavs.WorkloadNetworksClientUpdateSegmentResponse]]
...
func (w *WorkloadNetworksServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		if !intercepted {
			...
			case "WorkloadNetworksClient.BeginCreateSegment":
				res.resp, res.err = w.dispatchBeginCreateSegment(req)
			...
			case "WorkloadNetworksClient.NewListDNSServicePager":
				res.resp, res.err = w.dispatchNewListDNSServicePager(req)
			...
			case "WorkloadNetworksClient.BeginUpdateSegment":
				res.resp, res.err = w.dispatchBeginUpdateSegment(req)
...
func (w *WorkloadNetworksServerTransport) dispatchBeginCreateSegment(req *http.Request) (*http.Response, error) {
	if w.srv.BeginCreateSegment == nil {
		return nil, &nonRetriableError{errors.New("fake for method BeginCreateSegment not implemented")}
	}
	beginCreateSegment := w.beginCreateSegment.get(req)
	if beginCreateSegment == nil {
		...
		respr, errRespr := w.srv.BeginCreateSegment(req.Context(), resourceGroupNameParam, privateCloudNameParam, segmentIDParam, body, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginCreateSegment = &respr
		w.beginCreateSegment.add(req, beginCreateSegment)
	}

	resp, err := server.PollerResponderNext(beginCreateSegment, req)
	if err != nil {
		return nil, err
	}

	if !contains([]int{http.StatusOK, http.StatusCreated}, resp.StatusCode) {
		w.beginCreateSegment.remove(req)
		return nil, &nonRetriableError{fmt.Errorf("unexpected status code %d. acceptable values are http.StatusOK, http.StatusCreated", resp.StatusCode)}
	}
	if !server.PollerResponderMore(beginCreateSegment) {
		w.beginCreateSegment.remove(req)
	}
...
func (w *WorkloadNetworksServerTransport) dispatchBeginDeleteDNSService(req *http.Request) (*http.Response, error) {
	...
	if beginDeleteDNSService == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.AVS/privateClouds/(?P<privateCloudName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/workloadNetworks/default/dnsServices/(?P<dnsServiceId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/{dnsServiceId}/{privateCloudName}`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 5 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
...
func (w *WorkloadNetworksServerTransport) dispatchBeginDeleteDNSZone(req *http.Request) (*http.Response, error) {
	...
	if beginDeleteDNSZone == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.AVS/privateClouds/(?P<privateCloudName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/workloadNetworks/default/dnsZones/(?P<dnsZoneId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/{dnsZoneId}/{privateCloudName}`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 5 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
...
func (w *WorkloadNetworksServerTransport) dispatchBeginDeletePortMirroring(req *http.Request) (*http.Response, error) {
	...
	if beginDeletePortMirroring == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.AVS/privateClouds/(?P<privateCloudName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/workloadNetworks/default/portMirroringProfiles/(?P<portMirroringId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/{portMirroringId}/{privateCloudName}`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 5 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
...
func (w *WorkloadNetworksServerTransport) dispatchBeginDeleteVMGroup(req *http.Request) (*http.Response, error) {
	...
	if beginDeleteVMGroup == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.AVS/privateClouds/(?P<privateCloudName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/workloadNetworks/default/vmGroups/(?P<vmGroupId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/{vmGroupId}/{privateCloudName}`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 5 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
...
func (w *WorkloadNetworksServerTransport) dispatchGetDhcp(req *http.Request) (*http.Response, error) {
	...
	const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.AVS/privateClouds/(?P<privateCloudName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/workloadNetworks/default/dhcpConfigurations/(?P<dhcpId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/{dhcpId}/{privateCloudName}`
	regex := regexp.MustCompile(regexStr)
	matches := regex.FindStringSubmatch(req.URL.EscapedPath())
	if len(matches) < 5 {
		return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
...
func (w *WorkloadNetworksServerTransport) dispatchNewListDNSServicePager(req *http.Request) (*http.Response, error) {
	if w.srv.NewListDNSServicePager == nil {
		return nil, &nonRetriableError{errors.New("fake for method NewListDNSServicePager not implemented")}
	}
	newListDNSServicePager := w.newListDNSServicePager.get(req)
	if newListDNSServicePager == nil {
		...
		resp := w.srv.NewListDNSServicePager(resourceGroupNameParam, privateCloudNameParam, nil)
		newListDNSServicePager = &resp
		w.newListDNSServicePager.add(req, newListDNSServicePager)
		server.PagerResponderInjectNextLinks(newListDNSServicePager, req, func(page *armavs.WorkloadNetworksClientListDNSServiceResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
	resp, err := server.PagerResponderNext(newListDNSServicePager, req)
	if err != nil {
		return nil, err
	}
	if !contains([]int{http.StatusOK}, resp.StatusCode) {
		w.newListDNSServicePager.remove(req)
		return nil, &nonRetriableError{fmt.Errorf("unexpected status code %d. acceptable values are http.StatusOK", resp.StatusCode)}
	}
	if !server.PagerResponderMore(newListDNSServicePager) {
		w.newListDNSServicePager.remove(req)
	}
	return resp, nil
}
...
func (w *WorkloadNetworksServerTransport) dispatchBeginUpdateSegment(req *http.Request) (*http.Response, error) {
	if w.srv.BeginUpdateSegment == nil {
		return nil, &nonRetriableError{errors.New("fake for method BeginUpdateSegment not implemented")}
	}
	beginUpdateSegment := w.beginUpdateSegment.get(req)
	if beginUpdateSegment == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.AVS/privateClouds/(?P<privateCloudName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/workloadNetworks/default/segments/(?P<segmentId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 5 {
		...
		respr, errRespr := w.srv.BeginUpdateSegment(req.Context(), resourceGroupNameParam, privateCloudNameParam, segmentIDParam, body, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginUpdateSegment = &respr
		w.beginUpdateSegment.add(req, beginUpdateSegment)
	}

	resp, err := server.PollerResponderNext(beginUpdateSegment, req)
	if err != nil {
		return nil, err
	}

	if !contains([]int{http.StatusOK, http.StatusAccepted}, resp.StatusCode) {
		w.beginUpdateSegment.remove(req)
		return nil, &nonRetriableError{fmt.Errorf("unexpected status code %d. acceptable values are http.StatusOK, http.StatusAccepted", resp.StatusCode)}
	}
	if !server.PollerResponderMore(beginUpdateSegment) {
		w.beginUpdateSegment.remove(req)
	}
