...
func (client *IscsiPathsClient) getHandleResponse(resp *http.Response, successCodes ...int) (IscsiPathsClientGetResponse, error) {
...
func (client *IscsiPathsClient) NewListByPrivateCloudPager(resourceGroupName string, privateCloudName string, options *IscsiPathsClientListByPrivateCloudOptions) *runtime.Pager[IscsiPathsClientListByPrivateCloudResponse] {
	return runtime.NewPager(runtime.PagingHandler[IscsiPathsClientListByPrivateCloudResponse]{
		...
		Fetcher: func(ctx context.Context, page *IscsiPathsClientListByPrivateCloudResponse) (IscsiPathsClientListByPrivateCloudResponse, error) {
			...
			req, err := client.listByPrivateCloudCreateRequest(ctx, resourceGroupName, privateCloudName, nextLink, options)
			if err != nil {
			...
			return client.listByPrivateCloudHandleResponse(resp, http.StatusOK)
		},
		Tracer: client.internal.Tracer(),
	})
}
...
func (client *IscsiPathsClient) listByPrivateCloudCreateRequest(ctx context.Context, resourceGroupName string, privateCloudName string, nextLink string, _ *IscsiPathsClientListByPrivateCloudOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *IscsiPathsClient) listByPrivateCloudHandleResponse(resp *http.Response, successCodes ...int) (IscsiPathsClientListByPrivateCloudResponse, error) {
