...
// WorkloadNetworksClientBeginCreateSegmentOptions contains the optional parameters for the WorkloadNetworksClient.BeginCreateSegment
// method.
type WorkloadNetworksClientBeginCreateSegmentOptions struct {
	// Resumes the long-running operation from the provided token.
	ResumeToken string
}
...
// WorkloadNetworksClientBeginUpdateSegmentOptions contains the optional parameters for the WorkloadNetworksClient.BeginUpdateSegment
// method.
type WorkloadNetworksClientBeginUpdateSegmentOptions struct {
	// Resumes the long-running operation from the provided token.
	ResumeToken string
}
...
// WorkloadNetworksClientListDNSServiceOptions contains the optional parameters for the WorkloadNetworksClient.NewListDNSServicePager
// method.
type WorkloadNetworksClientListDNSServiceOptions struct {
	// placeholder for future optional parameters
}
