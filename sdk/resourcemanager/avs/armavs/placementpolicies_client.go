...
func (client *PlacementPoliciesClient) getHandleResponse(resp *http.Response, successCodes ...int) (PlacementPoliciesClientGetResponse, error) {
...
func (client *PlacementPoliciesClient) listCreateRequest(ctx context.Context, resourceGroupName string, privateCloudName string, clusterName string, nextLink string, _ *PlacementPoliciesClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *PlacementPoliciesClient) listHandleResponse(resp *http.Response, successCodes ...int) (PlacementPoliciesClientListResponse, error) {
