...
func (client *PureStoragePoliciesClient) getHandleResponse(resp *http.Response, successCodes ...int) (PureStoragePoliciesClientGetResponse, error) {
...
func (client *PureStoragePoliciesClient) listCreateRequest(ctx context.Context, resourceGroupName string, privateCloudName string, nextLink string, _ *PureStoragePoliciesClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *PureStoragePoliciesClient) listHandleResponse(resp *http.Response, successCodes ...int) (PureStoragePoliciesClientListResponse, error) {
