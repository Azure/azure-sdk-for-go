...
// WorkloadNetworksClientCreateSegmentResponse contains the response from method WorkloadNetworksClient.BeginCreateSegment.
type WorkloadNetworksClientCreateSegmentResponse struct {
	// NSX Segment
...
// WorkloadNetworksClientListDNSServiceResponse contains the response from method WorkloadNetworksClient.NewListDNSServicePager.
type WorkloadNetworksClientListDNSServiceResponse struct {
...
// WorkloadNetworksClientUpdateSegmentResponse contains the response from method WorkloadNetworksClient.BeginUpdateSegment.
type WorkloadNetworksClientUpdateSegmentResponse struct {
	// NSX Segment
	WorkloadNetworkSegment
}
