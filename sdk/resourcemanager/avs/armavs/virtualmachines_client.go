...
func (client *VirtualMachinesClient) listCreateRequest(ctx context.Context, resourceGroupName string, privateCloudName string, clusterName string, nextLink string, _ *VirtualMachinesClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *VirtualMachinesClient) listHandleResponse(resp *http.Response, successCodes ...int) (VirtualMachinesClientListResponse, error) {
