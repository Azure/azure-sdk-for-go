...
//     method.
func (client *WorkloadNetworksClient) BeginCreateSegment(ctx context.Context, resourceGroupName string, privateCloudName string, segmentID string, workloadNetworkSegment WorkloadNetworkSegment, options *WorkloadNetworksClientBeginCreateSegmentOptions) (*runtime.Poller[WorkloadNetworksClientCreateSegmentResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.createSegment(ctx, resourceGroupName, privateCloudName, segmentID, workloadNetworkSegment, options)
		if err != nil {
			return nil, err
		}
...
//
// Generated from API version 2024-09-01
func (client *WorkloadNetworksClient) createSegment(ctx context.Context, resourceGroupName string, privateCloudName string, segmentID string, workloadNetworkSegment WorkloadNetworkSegment, options *WorkloadNetworksClientBeginCreateSegmentOptions) (*http.Response, error) {
	var err error
	const operationName = "WorkloadNetworksClient.BeginCreateSegment"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.createSegmentCreateRequest(ctx, resourceGroupName, privateCloudName, segmentID, workloadNetworkSegment, options)
	if err != nil {
		return nil, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
...
func (client *WorkloadNetworksClient) createSegmentCreateRequest(ctx context.Context, resourceGroupName string, privateCloudName string, segmentID string, workloadNetworkSegment WorkloadNetworkSegment, _ *WorkloadNetworksClientBeginCreateSegmentOptions) (*policy.Request, error) {
...
//     method.
func (client *WorkloadNetworksClient) NewListDNSServicePager(resourceGroupName string, privateCloudName string, options *WorkloadNetworksClientListDNSServiceOptions) *runtime.Pager[WorkloadNetworksClientListDNSServiceResponse] {
	return runtime.NewPager(runtime.PagingHandler[WorkloadNetworksClientListDNSServiceResponse]{
		...
		Fetcher: func(ctx context.Context, page *WorkloadNetworksClientListDNSServiceResponse) (WorkloadNetworksClientListDNSServiceResponse, error) {
			...
			resp, err := runtime.FetcherForNextLink(ctx, client.internal.Pipeline(), nextLink, func(ctx context.Context) (*policy.Request, error) {
				return client.listDNSServiceCreateRequest(ctx, resourceGroupName, privateCloudName, options)
			}, nil)
			if err != nil {
...
func (client *WorkloadNetworksClient) listDNSServiceCreateRequest(ctx context.Context, resourceGroupName string, privateCloudName string, _ *WorkloadNetworksClientListDNSServiceOptions) (*policy.Request, error) {
...
//     method.
func (client *WorkloadNetworksClient) BeginUpdateSegment(ctx context.Context, resourceGroupName string, privateCloudName string, segmentID string, workloadNetworkSegment WorkloadNetworkSegment, options *WorkloadNetworksClientBeginUpdateSegmentOptions) (*runtime.Poller[WorkloadNetworksClientUpdateSegmentResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.updateSegment(ctx, resourceGroupName, privateCloudName, segmentID, workloadNetworkSegment, options)
		if err != nil {
			return nil, err
		}
...
//
// Generated from API version 2024-09-01
func (client *WorkloadNetworksClient) updateSegment(ctx context.Context, resourceGroupName string, privateCloudName string, segmentID string, workloadNetworkSegment WorkloadNetworkSegment, options *WorkloadNetworksClientBeginUpdateSegmentOptions) (*http.Response, error) {
	var err error
	const operationName = "WorkloadNetworksClient.BeginUpdateSegment"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.updateSegmentCreateRequest(ctx, resourceGroupName, privateCloudName, segmentID, workloadNetworkSegment, options)
	if err != nil {
		return nil, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
...
func (client *WorkloadNetworksClient) updateSegmentCreateRequest(ctx context.Context, resourceGroupName string, privateCloudName string, segmentID string, workloadNetworkSegment WorkloadNetworkSegment, _ *WorkloadNetworksClientBeginUpdateSegmentOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AVS/privateClouds/{privateCloudName}/workloadNetworks/default/segments/{segmentId}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
