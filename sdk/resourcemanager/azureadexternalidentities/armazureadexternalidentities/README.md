...
```go
client := armazureadexternalidentities.NewB2CTenantsClient(<subscription ID>, cred, nil)
```
...
client := armazureadexternalidentities.NewB2CTenantsClient(<subscription ID>, cred, &options)
```
