...
// ToPtr returns a *B2CResourceSKUTier pointing to the current value.
func (c B2CResourceSKUTier) ToPtr() *B2CResourceSKUTier {
	return &c
}
...
// ToPtr returns a *TypeValue pointing to the current value.
func (c TypeValue) ToPtr() *TypeValue {
	return &c
}
