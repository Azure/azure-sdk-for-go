...
- `ArcSQLServerLicenseTypeHADR` from enum `ArcSQLServerLicenseType` has been removed
...
- New value `ArcSQLServerLicenseTypeFabricCapacity`, `ArcSQLServerLicenseTypeHadr`, `ArcSQLServerLicenseTypeLicenseOnly`, `ArcSQLServerLicenseTypePayg`, `ArcSQLServerLicenseTypeServerCAL` added to enum type `ArcSQLServerLicenseType`
