...
// Generated from example definition: 2026-03-01-preview/DeleteDataController.json
func ExampleDataControllersClient_BeginDeleteDataController() {
	...
	// res = armazurearcdata.DataControllersClientDeleteDataControllerResponse{
	// }
}

// Generated from example definition: 2026-03-01-preview/GetDataController.json
func ExampleDataControllersClient_GetDataController() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armazurearcdata.DataControllersClientGetDataControllerResponse{
	// 	DataControllerResource: &armazurearcdata.DataControllerResource{
...
// Generated from example definition: 2026-03-01-preview/ListByResourceGroupDataController.json
func ExampleDataControllersClient_NewListInGroupPager() {
	...
	for pager.More() {
		...
		// page = armazurearcdata.DataControllersClientListInGroupResponse{
		// 	PageOfDataControllerResource: armazurearcdata.PageOfDataControllerResource{
...
// Generated from example definition: 2026-03-01-preview/ListSubscriptionDataController.json
func ExampleDataControllersClient_NewListInSubscriptionPager() {
	...
	for pager.More() {
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armazurearcdata.DataControllersClientListInSubscriptionResponse{
		// 	PageOfDataControllerResource: armazurearcdata.PageOfDataControllerResource{
		// 		Value: []*armazurearcdata.DataControllerResource{
		// 			{
		// 				Name: to.Ptr("testdataController1"),
...
// Generated from example definition: 2026-03-01-preview/UpdateDataController.json
func ExampleDataControllersClient_BeginPatchDataController() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armazurearcdata.DataControllersClientPatchDataControllerResponse{
	// 	DataControllerResource: &armazurearcdata.DataControllerResource{
	// 		Name: to.Ptr("testdataController1"),
	// 		Type: to.Ptr("Microsoft.AzureArcData/dataControllers"),
	// 		ExtendedLocation: &armazurearcdata.ExtendedLocation{
...
// Generated from example definition: 2026-03-01-preview/CreateOrUpdateDataController.json
func ExampleDataControllersClient_BeginPutDataController() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armazurearcdata.DataControllersClientPutDataControllerResponse{
	// 	DataControllerResource: &armazurearcdata.DataControllerResource{
	// 		Name: to.Ptr("testdataController"),
	// 		Type: to.Ptr("Microsoft.AzureArcData/dataControllers"),
	// 		ExtendedLocation: &armazurearcdata.ExtendedLocation{
