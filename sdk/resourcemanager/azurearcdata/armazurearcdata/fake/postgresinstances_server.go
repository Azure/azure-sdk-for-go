...
func (p *PostgresInstancesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if postgresInstancesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = postgresInstancesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to PostgresInstancesServerTransport
var postgresInstancesServerTransportInterceptor interface {
