...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "ActiveDirectoryConnectorsClient":
		initServer(&s.trMu, &s.trActiveDirectoryConnectorsServer, func() *ActiveDirectoryConnectorsServerTransport {
	...
	case "DataControllersClient":
		initServer(&s.trMu, &s.trDataControllersServer, func() *DataControllersServerTransport {
	...
	case "PostgresInstancesClient":
		initServer(&s.trMu, &s.trPostgresInstancesServer, func() *PostgresInstancesServerTransport {
	...
	case "SQLManagedInstancesClient":
		initServer(&s.trMu, &s.trSQLManagedInstancesServer, func() *SQLManagedInstancesServerTransport {
	...
	case "SQLServerAvailabilityGroupsClient":
		initServer(&s.trMu, &s.trSQLServerAvailabilityGroupsServer, func() *SQLServerAvailabilityGroupsServerTransport {
	...
	case "SQLServerDatabasesClient":
		initServer(&s.trMu, &s.trSQLServerDatabasesServer, func() *SQLServerDatabasesServerTransport {
	...
	case "SQLServerEsuLicensesClient":
		initServer(&s.trMu, &s.trSQLServerEsuLicensesServer, func() *SQLServerEsuLicensesServerTransport {
	...
	case "SQLServerInstancesClient":
		initServer(&s.trMu, &s.trSQLServerInstancesServer, func() *SQLServerInstancesServerTransport {
	...
	case "SQLServerLicensesClient":
		initServer(&s.trMu, &s.trSQLServerLicensesServer, func() *SQLServerLicensesServerTransport {
