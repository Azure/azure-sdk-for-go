...
// Generated from example definition: 2026-03-01-preview/ListOperation.json
func ExampleOperationsClient_NewListPager() {
	...
	clientFactory, err := armazurearcdata.NewClientFactory("<subscriptionID>", cred, nil)
	if err != nil {
	...
	for pager.More() {
		...
		// page = armazurearcdata.OperationsClientListResponse{
		// 	OperationListResult: armazurearcdata.OperationListResult{
		...
		// 			},
		// 			{
		// 				Name: to.Ptr("Microsoft.AzureArcData/sqlServerInstances/databases/read"),
		// 				Display: &armazurearcdata.OperationDisplay{
		// 					Description: to.Ptr("List all database resources in a Sql Server Instance."),
		// 					Operation: to.Ptr("SqlServerDatabases_List"),
		// 					Provider: to.Ptr("Microsoft.AzureArcData"),
		// 					Resource: to.Ptr("sqlServerInstances/databases"),
		// 				},
		// 				IsDataAction: to.Ptr(false),
		// 			},
		// 			{
		// 				Name: to.Ptr("Microsoft.AzureArcData/sqlServerInstances/databases/read"),
		// 				Display: &armazurearcdata.OperationDisplay{
		// 					Description: to.Ptr("Retrieves a database resource"),
		// 					Operation: to.Ptr("SqlServerDatabases_Get"),
		// 					Provider: to.Ptr("Microsoft.AzureArcData"),
		// 					Resource: to.Ptr("sqlServerInstances/databases"),
		// 				},
		// 				IsDataAction: to.Ptr(false),
		// 			},
		// 			{
		// 				Name: to.Ptr("Microsoft.AzureArcData/sqlServerInstances/databases/write"),
		// 				Display: &armazurearcdata.OperationDisplay{
		// 					Description: to.Ptr("Creates or updates a database resource."),
		// 					Operation: to.Ptr("SqlServerDatabases_Create"),
		// 					Provider: to.Ptr("Microsoft.AzureArcData"),
		// 					Resource: to.Ptr("sqlServerInstances/databases"),
		// 				},
		// 				IsDataAction: to.Ptr(false),
		// 			},
		// 			{
		// 				Name: to.Ptr("Microsoft.AzureArcData/sqlServerInstances/databases/delete"),
		// 				Display: &armazurearcdata.OperationDisplay{
		// 					Description: to.Ptr("Deletes a database resource."),
		// 					Operation: to.Ptr("SqlServerDatabases_Delete"),
		// 					Provider: to.Ptr("Microsoft.AzureArcData"),
		// 					Resource: to.Ptr("sqlServerInstances/databases"),
		// 				},
		// 				IsDataAction: to.Ptr(false),
