...
// AzureLargeStorageInstanceServer is a fake server for instances of the armazurelargeinstance.AzureLargeStorageInstanceClient type.
type AzureLargeStorageInstanceServer struct {
	// Get is the fake for method AzureLargeStorageInstanceClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, azureLargeStorageInstanceName string, options *armazurelargeinstance.AzureLargeStorageInstanceClientGetOptions) (resp azfake.Responder[armazurelargeinstance.AzureLargeStorageInstanceClientGetResponse], errResp azfake.ErrorResponder)

	// NewListByResourceGroupPager is the fake for method AzureLargeStorageInstanceClient.NewListByResourceGroupPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByResourceGroupPager func(resourceGroupName string, options *armazurelargeinstance.AzureLargeStorageInstanceClientListByResourceGroupOptions) (resp azfake.PagerResponder[armazurelargeinstance.AzureLargeStorageInstanceClientListByResourceGroupResponse])

	// NewListBySubscriptionPager is the fake for method AzureLargeStorageInstanceClient.NewListBySubscriptionPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListBySubscriptionPager func(options *armazurelargeinstance.AzureLargeStorageInstanceClientListBySubscriptionOptions) (resp azfake.PagerResponder[armazurelargeinstance.AzureLargeStorageInstanceClientListBySubscriptionResponse])

	// Update is the fake for method AzureLargeStorageInstanceClient.Update
	// HTTP status codes to indicate success: http.StatusOK
	Update func(ctx context.Context, resourceGroupName string, azureLargeStorageInstanceName string, properties armazurelargeinstance.AzureLargeStorageInstanceTagsUpdate, options *armazurelargeinstance.AzureLargeStorageInstanceClientUpdateOptions) (resp azfake.Responder[armazurelargeinstance.AzureLargeStorageInstanceClientUpdateResponse], errResp azfake.ErrorResponder)
}
...
// The returned AzureLargeStorageInstanceServerTransport instance is connected to an instance of armazurelargeinstance.AzureLargeStorageInstanceClient via the
...
func NewAzureLargeStorageInstanceServerTransport(srv *AzureLargeStorageInstanceServer) *AzureLargeStorageInstanceServerTransport {
	return &AzureLargeStorageInstanceServerTransport{
		srv:                         srv,
		newListByResourceGroupPager: newTracker[azfake.PagerResponder[armazurelargeinstance.AzureLargeStorageInstanceClientListByResourceGroupResponse]](),
		newListBySubscriptionPager:  newTracker[azfake.PagerResponder[armazurelargeinstance.AzureLargeStorageInstanceClientListBySubscriptionResponse]](),
	}
}

// AzureLargeStorageInstanceServerTransport connects instances of armazurelargeinstance.AzureLargeStorageInstanceClient to instances of AzureLargeStorageInstanceServer.
...
type AzureLargeStorageInstanceServerTransport struct {
	...
	newListByResourceGroupPager *tracker[azfake.PagerResponder[armazurelargeinstance.AzureLargeStorageInstanceClientListByResourceGroupResponse]]
	newListBySubscriptionPager  *tracker[azfake.PagerResponder[armazurelargeinstance.AzureLargeStorageInstanceClientListBySubscriptionResponse]]
}
...
func (a *AzureLargeStorageInstanceServerTransport) dispatchNewListByResourceGroupPager(req *http.Request) (*http.Response, error) {
	...
	if newListByResourceGroupPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListByResourceGroupPager, req, func(page *armazurelargeinstance.AzureLargeStorageInstanceClientListByResourceGroupResponse, createLink func() string) {
...
func (a *AzureLargeStorageInstanceServerTransport) dispatchNewListBySubscriptionPager(req *http.Request) (*http.Response, error) {
	...
	if newListBySubscriptionPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListBySubscriptionPager, req, func(page *armazurelargeinstance.AzureLargeStorageInstanceClientListBySubscriptionResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
