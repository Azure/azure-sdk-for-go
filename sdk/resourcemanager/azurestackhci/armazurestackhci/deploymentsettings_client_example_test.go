...
// Generated from example definition: 2026-04-30/PutDeploymentSettings.json
				...
				ScaleUnits: []*armazurestackhci.ScaleUnits{
					{
						DeploymentData: &armazurestackhci.DeploymentData{
							...
							HostNetwork: &armazurestackhci.DeploymentSettingHostNetwork{
								...
								SanNetworks: &armazurestackhci.SanNetworks{
									ClusterNetworkConfig: &armazurestackhci.SanClusterNetworkConfig{
										AdapterProperties: &armazurestackhci.SanAdapterProperties{
											BandwidthPercentageSmb:         to.Ptr[int32](50),
											JumboPacket:                    to.Ptr[int32](9014),
											PriorityValue8021ActionCluster: to.Ptr[int32](7),
											PriorityValue8021ActionSmb:     to.Ptr[int32](3),
										},
										AdapterIPConfig: []*armazurestackhci.SanAdapterIPConfig{
											{
												Name:               to.Ptr("clusterNetwork-A"),
												NetworkAdapterName: to.Ptr("ethernet 3"),
												VlanID:             to.Ptr[int32](711),
												AddressPrefix:      to.Ptr("10.10.30.0/24"),
											},
										},
									},
								},
							...
							Storage: &armazurestackhci.Storage{
								...
								S2D: &armazurestackhci.StorageS2DConfig{
									VolumeType:            to.Ptr(armazurestackhci.VolumeTypeThinProvisioned),
									OverprovisioningRatio: to.Ptr(armazurestackhci.OverprovisioningRatioTwo),
								},
							},
						},
...
// Generated from example definition: 2026-04-30/PutDeploymentSettingsWithADLess.json
...
// Generated from example definition: 2026-04-30/PutDeploymentSettings_StorageS2D.json
func ExampleDeploymentSettingsClient_BeginCreateOrUpdate_createDeploymentSettingsWithS2DStorage() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
...
// Generated from example definition: 2026-04-30/PutDeploymentSettings_StorageSAN.json
func ExampleDeploymentSettingsClient_BeginCreateOrUpdate_createDeploymentSettingsWithSanStorage() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
				...
				ScaleUnits: []*armazurestackhci.ScaleUnits{
					{
						DeploymentData: &armazurestackhci.DeploymentData{
							...
							Storage: &armazurestackhci.Storage{
								ConfigurationMode: to.Ptr("Express"),
								StorageType:       to.Ptr(armazurestackhci.StorageTypeSAN),
								San: &armazurestackhci.StorageSanConfig{
									InfraVolLunID:  to.Ptr("PURE1234567890ABCDEF"),
									InfraPerfLunID: to.Ptr("PURE0987654321MNOPQR"),
								},
							},
						},
						SbePartnerInfo: &armazurestackhci.SbePartnerInfo{
...
// Generated from example definition: 2026-04-30/DeleteDeploymentSettings.json
...
// Generated from example definition: 2026-04-30/GetDeploymentSettings.json
...
// Generated from example definition: 2026-04-30/ListDeploymentSettingsByCluster.json
