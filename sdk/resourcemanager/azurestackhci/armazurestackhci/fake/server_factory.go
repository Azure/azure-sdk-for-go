...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "EdgeMachineJobsClient":
		initServer(s, &s.trEdgeMachineJobsServer, func() *EdgeMachineJobsServerTransport {
	...
	case "EdgeMachinesClient":
		initServer(s, &s.trEdgeMachinesServer, func() *EdgeMachinesServerTransport { return NewEdgeMachinesServerTransport(&s.srv.EdgeMachinesServer) })
	...
	case "OwnershipVouchersClient":
		initServer(s, &s.trOwnershipVouchersServer, func() *OwnershipVouchersServerTransport {
