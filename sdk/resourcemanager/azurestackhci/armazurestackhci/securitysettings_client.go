...
func (client *SecuritySettingsClient) getHandleResponse(resp *http.Response, successCodes ...int) (SecuritySettingsClientGetResponse, error) {
...
func (client *SecuritySettingsClient) NewListByClustersPager(resourceGroupName string, clusterName string, options *SecuritySettingsClientListByClustersOptions) *runtime.Pager[SecuritySettingsClientListByClustersResponse] {
	return runtime.NewPager(runtime.PagingHandler[SecuritySettingsClientListByClustersResponse]{
		...
		Fetcher: func(ctx context.Context, page *SecuritySettingsClientListByClustersResponse) (SecuritySettingsClientListByClustersResponse, error) {
			...
			req, err := client.listByClustersCreateRequest(ctx, resourceGroupName, clusterName, nextLink, options)
			if err != nil {
			...
			return client.listByClustersHandleResponse(resp, http.StatusOK)
		},
		Tracer: client.internal.Tracer(),
	})
}
...
func (client *SecuritySettingsClient) listByClustersCreateRequest(ctx context.Context, resourceGroupName string, clusterName string, nextLink string, _ *SecuritySettingsClientListByClustersOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *SecuritySettingsClient) listByClustersHandleResponse(resp *http.Response, successCodes ...int) (SecuritySettingsClientListByClustersResponse, error) {
