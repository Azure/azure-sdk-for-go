...
// Generated from example definition: 2025-12-01-preview/GetSku.json
func ExampleSKUsClient_Get() {
	...
	res, err := clientFactory.NewSKUsClient().Get(ctx, "test-rg", "myCluster", "publisher1", "offer1", "sku1", nil)
	if err != nil {
...
// Generated from example definition: 2025-12-01-preview/ListSkusByOffer.json
func ExampleSKUsClient_NewListByOfferPager() {
	...
	pager := clientFactory.NewSKUsClient().NewListByOfferPager("test-rg", "myCluster", "publisher1", "offer1", nil)
	for pager.More() {
		...
		// page = armazurestackhci.SKUsClientListByOfferResponse{
		// 	SKUList: armazurestackhci.SKUList{
