...
// The returned ServerFactoryTransport instance is connected to an instance of armbaremetalinfrastructure.ClientFactory via the
...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	switch client {
	case "AzureBareMetalInstancesClient":
		initServer(s, &s.trAzureBareMetalInstancesServer, func() *AzureBareMetalInstancesServerTransport {
