...
// Generated from example definition: 2024-07-01/ApplicationPackageActivate.json
...
// Generated from example definition: 2024-07-01/ApplicationPackageCreate.json
func ExampleApplicationPackageClient_Create() {
	...
	res, err := clientFactory.NewApplicationPackageClient().Create(ctx, "default-azurebatch-japaneast", "sampleacct", "app1", "1", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
...
// Generated from example definition: 2024-07-01/ApplicationPackageDelete.json
...
// Generated from example definition: 2024-07-01/ApplicationPackageGet.json
...
// Generated from example definition: 2024-07-01/ApplicationPackageList.json
