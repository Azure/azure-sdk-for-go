...
func (a ApplicationPackageProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "format", a.Format)
	populateTime[datetime.RFC3339](objectMap, "lastActivationTime", a.LastActivationTime, true)
	populate(objectMap, "state", a.State)
	populate(objectMap, "storageUrl", a.StorageURL)
	populateTime[datetime.RFC3339](objectMap, "storageUrlExpiry", a.StorageURLExpiry, true)
	return json.Marshal(objectMap)
}
...
func (a AutoScaleRun) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "evaluationTime", a.EvaluationTime, true)
...
func (a AutoStorageProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "authenticationMode", a.AuthenticationMode)
	populateTime[datetime.RFC3339](objectMap, "lastKeySync", a.LastKeySync, true)
	populate(objectMap, "nodeIdentityReference", a.NodeIdentityReference)
	populate(objectMap, "storageAccountId", a.StorageAccountID)
	return json.Marshal(objectMap)
}
...
func (p PoolProperties) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "allocationStateTransitionTime", p.AllocationStateTransitionTime, true)
	...
	populateTime[datetime.RFC3339](objectMap, "provisioningStateTransitionTime", p.ProvisioningStateTransitionTime, true)
...
func (s SupportedSKU) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateTime[datetime.RFC3339](objectMap, "batchSupportEndOfLife", s.BatchSupportEndOfLife, true)
