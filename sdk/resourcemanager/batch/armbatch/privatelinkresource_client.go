...
func (client *PrivateLinkResourceClient) getCreateRequest(ctx context.Context, resourceGroupName string, accountName string, privateLinkResourceName string, _ *PrivateLinkResourceClientGetOptions) (*policy.Request, error) {
...
func (client *PrivateLinkResourceClient) getHandleResponse(resp *http.Response, successCodes ...int) (PrivateLinkResourceClientGetResponse, error) {
...
func (client *PrivateLinkResourceClient) NewListByBatchAccountPager(resourceGroupName string, accountName string, options *PrivateLinkResourceClientListByBatchAccountOptions) *runtime.Pager[PrivateLinkResourceClientListByBatchAccountResponse] {
	return runtime.NewPager(runtime.PagingHandler[PrivateLinkResourceClientListByBatchAccountResponse]{
		...
		Fetcher: func(ctx context.Context, page *PrivateLinkResourceClientListByBatchAccountResponse) (PrivateLinkResourceClientListByBatchAccountResponse, error) {
			...
			req, err := client.listByBatchAccountCreateRequest(ctx, resourceGroupName, accountName, nextLink, options)
			if err != nil {
			...
			return client.listByBatchAccountHandleResponse(resp, http.StatusOK)
		},
...
func (client *PrivateLinkResourceClient) listByBatchAccountCreateRequest(ctx context.Context, resourceGroupName string, accountName string, nextLink string, options *PrivateLinkResourceClientListByBatchAccountOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *PrivateLinkResourceClient) listByBatchAccountHandleResponse(resp *http.Response, successCodes ...int) (PrivateLinkResourceClientListByBatchAccountResponse, error) {
