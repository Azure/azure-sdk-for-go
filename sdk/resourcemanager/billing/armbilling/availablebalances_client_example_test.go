...
// Generated from example definition: 2024-04-01/availableBalanceGetByBillingAccount.json
func ExampleAvailableBalancesClient_GetByBillingAccount() {
	...
	// res = armbilling.AvailableBalancesClientGetByBillingAccountResponse{
	// 	AvailableBalance: &armbilling.AvailableBalance{
	// 		Name: to.Ptr("default"),
	...
	// 					Date: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2024-04-01T00:00:00.0000000Z"); return t}()),
	...
	// 					Date: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2023-01-01T00:00:00.0000000Z"); return t}()),
...
// Generated from example definition: 2024-04-01/availableBalanceGetByBillingProfile.json
func ExampleAvailableBalancesClient_GetByBillingProfile() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armbilling.AvailableBalancesClientGetByBillingProfileResponse{
	// 	AvailableBalance: &armbilling.AvailableBalance{
	// 		Name: to.Ptr("default"),
