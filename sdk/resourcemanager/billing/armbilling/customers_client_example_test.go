...
// Generated from example definition: 2024-04-01/customersGet.json
func ExampleCustomersClient_Get() {
	...
	// res = armbilling.CustomersClientGetResponse{
	// 	Customer: &armbilling.Customer{
...
// Generated from example definition: 2024-04-01/customersGetByBillingAccount.json
func ExampleCustomersClient_GetByBillingAccount() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armbilling.CustomersClientGetByBillingAccountResponse{
	// 	Customer: &armbilling.Customer{
	// 		Name: to.Ptr("11111111-1111-1111-1111-111111111111"),
	// 		Type: to.Ptr("Microsoft.Billing/billingAccounts/billingProfiles/customers"),
	// 		ID: to.Ptr("/providers/Microsoft.Billing/billingAccounts/00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31/billingProfiles/xxxx-xxxx-xxx-xxx/customers/11111111-1111-1111-1111-111111111111"),
...
// Generated from example definition: 2024-04-01/customersListByBillingAccount.json
func ExampleCustomersClient_NewListByBillingAccountPager_customersListByBillingAccount() {
	...
	pager := clientFactory.NewCustomersClient().NewListByBillingAccountPager("00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31", nil)
	for pager.More() {
		...
		// page = armbilling.CustomersClientListByBillingAccountResponse{
		// 	CustomerListResult: armbilling.CustomerListResult{
...
// Generated from example definition: 2024-04-01/customersListByBillingAccountWithExpand.json
func ExampleCustomersClient_NewListByBillingAccountPager_customersListByBillingAccountWithExpand() {
	...
	pager := clientFactory.NewCustomersClient().NewListByBillingAccountPager("00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31", &armbilling.CustomersClientListByBillingAccountOptions{
		Expand: to.Ptr("enabledAzurePlans,resellers")})
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
...
// Generated from example definition: 2024-04-01/customersListByBillingProfile.json
func ExampleCustomersClient_NewListByBillingProfilePager() {
	...
	pager := clientFactory.NewCustomersClient().NewListByBillingProfilePager("00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31", "xxxx-xxxx-xxx-xxx", nil)
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armbilling.CustomersClientListByBillingProfileResponse{
		// 	CustomerListResult: armbilling.CustomerListResult{
		// 		Value: []*armbilling.Customer{
		// 			{
		// 				Name: to.Ptr("11111111-1111-1111-1111-111111111111"),
