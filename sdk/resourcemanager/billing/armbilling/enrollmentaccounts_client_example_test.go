...
// Generated from example definition: 2024-04-01/enrollmentAccountByDepartment.json
func ExampleEnrollmentAccountsClient_GetByDepartment() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armbilling.EnrollmentAccountsClientGetByDepartmentResponse{
	// 	EnrollmentAccount: &armbilling.EnrollmentAccount{
	// 		Name: to.Ptr("257698"),
...
// Generated from example definition: 2024-04-01/enrollmentAccountsListByBillingAccount.json
func ExampleEnrollmentAccountsClient_NewListByBillingAccountPager() {
	...
	pager := clientFactory.NewEnrollmentAccountsClient().NewListByBillingAccountPager("6564892", nil)
	for pager.More() {
		...
		// page = armbilling.EnrollmentAccountsClientListByBillingAccountResponse{
		// 	EnrollmentAccountListResult: armbilling.EnrollmentAccountListResult{
...
// Generated from example definition: 2024-04-01/enrollmentAccountsListByDepartment.json
func ExampleEnrollmentAccountsClient_NewListByDepartmentPager() {
	...
	pager := clientFactory.NewEnrollmentAccountsClient().NewListByDepartmentPager("6564892", "164821", nil)
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armbilling.EnrollmentAccountsClientListByDepartmentResponse{
		// 	EnrollmentAccountListResult: armbilling.EnrollmentAccountListResult{
		// 		Value: []*armbilling.EnrollmentAccount{
		// 			{
		// 				Name: to.Ptr("257698"),
