...
// The returned AgreementsServerTransport instance is connected to an instance of armbilling.AgreementsClient via the
// azcore.ClientOptions.Transporter field in the client's constructor parameters.
func NewAgreementsServerTransport(srv *AgreementsServer) *AgreementsServerTransport {
	return &AgreementsServerTransport{
		srv:                          srv,
		newListByBillingAccountPager: newTracker[azfake.PagerResponder[armbilling.AgreementsClientListByBillingAccountResponse]](),
	}
}

// AgreementsServerTransport connects instances of armbilling.AgreementsClient to instances of AgreementsServer.
// Don't use this type directly, use NewAgreementsServerTransport instead.
type AgreementsServerTransport struct {
	srv                          *AgreementsServer
	newListByBillingAccountPager *tracker[azfake.PagerResponder[armbilling.AgreementsClientListByBillingAccountResponse]]
}

// Do implements the policy.Transporter interface for AgreementsServerTransport.
func (a *AgreementsServerTransport) Do(req *http.Request) (*http.Response, error) {
...
func (a *AgreementsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if agreementsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = agreementsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			case "AgreementsClient.Get":
				res.resp, res.err = a.dispatchGet(req)
			case "AgreementsClient.NewListByBillingAccountPager":
...
func (a *AgreementsServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	if a.srv.Get == nil {
	...
	resp, err := server.MarshalResponseAsJSON(respContent, server.GetResponse(respr).Agreement, req)
	if err != nil {
		return nil, err
	}
	return resp, nil
...
func (a *AgreementsServerTransport) dispatchNewListByBillingAccountPager(req *http.Request) (*http.Response, error) {
	...
	if newListByBillingAccountPager == nil {
		...
		var options *armbilling.AgreementsClientListByBillingAccountOptions
		if expandParam != nil {
			options = &armbilling.AgreementsClientListByBillingAccountOptions{
				Expand: expandParam,
			}
		}
		...
		server.PagerResponderInjectNextLinks(newListByBillingAccountPager, req, func(page *armbilling.AgreementsClientListByBillingAccountResponse, createLink func() string) {
...
// set this to conditionally intercept incoming requests to AgreementsServerTransport
var agreementsServerTransportInterceptor interface {
