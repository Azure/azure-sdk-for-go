...
func (t *TransactionsServerTransport) dispatchGetTransactionSummaryByInvoice(req *http.Request) (*http.Response, error) {
	...
	const regexStr = `/providers/Microsoft\.Billing/billingAccounts/(?P<billingAccountName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/invoices/(?P<invoiceName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/transactionSummary`
...
func (t *TransactionsServerTransport) dispatchNewListByBillingProfilePager(req *http.Request) (*http.Response, error) {
	...
	if newListByBillingProfilePager == nil {
		const regexStr = `/providers/Microsoft\.Billing/billingAccounts/(?P<billingAccountName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/billingProfiles/(?P<billingProfileName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/transactions`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 3 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
		...
		periodStartDateParam, err := time.Parse(time.DateOnly, qp.Get("periodStartDate"))
		if err != nil {
			return nil, err
		}
		periodEndDateParam, err := time.Parse(time.DateOnly, qp.Get("periodEndDate"))
		if err != nil {
			return nil, err
		}
		filterParam := getOptional(qp.Get("filter"))
		...
		resp := t.srv.NewListByBillingProfilePager(billingAccountNameParam, billingProfileNameParam, periodStartDateParam, periodEndDateParam, armbilling.TransactionType(qp.Get("type")), options)
...
func (t *TransactionsServerTransport) dispatchNewListByCustomerPager(req *http.Request) (*http.Response, error) {
	...
	if newListByCustomerPager == nil {
		const regexStr = `/providers/Microsoft\.Billing/billingAccounts/(?P<billingAccountName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/billingProfiles/(?P<billingProfileName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/customers/(?P<customerName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/transactions`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 4 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
		...
		resp := t.srv.NewListByCustomerPager(billingAccountNameParam, billingProfileNameParam, customerNameParam, periodStartDateParam, periodEndDateParam, armbilling.TransactionType(qp.Get("type")), options)
...
func (t *TransactionsServerTransport) dispatchNewListByInvoicePager(req *http.Request) (*http.Response, error) {
	...
	if newListByInvoicePager == nil {
		const regexStr = `/providers/Microsoft\.Billing/billingAccounts/(?P<billingAccountName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/invoices/(?P<invoiceName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/transactions`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 3 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
...
func (t *TransactionsServerTransport) dispatchNewListByInvoiceSectionPager(req *http.Request) (*http.Response, error) {
	...
	if newListByInvoiceSectionPager == nil {
		const regexStr = `/providers/Microsoft\.Billing/billingAccounts/(?P<billingAccountName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/billingProfiles/(?P<billingProfileName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/invoiceSections/(?P<invoiceSectionName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/transactions`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 4 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
		...
		resp := t.srv.NewListByInvoiceSectionPager(billingAccountNameParam, billingProfileNameParam, invoiceSectionNameParam, periodStartDateParam, periodEndDateParam, armbilling.TransactionType(qp.Get("type")), options)
...
func (t *TransactionsServerTransport) dispatchBeginTransactionsDownloadByInvoice(req *http.Request) (*http.Response, error) {
	...
	if beginTransactionsDownloadByInvoice == nil {
		const regexStr = `/providers/Microsoft\.Billing/billingAccounts/(?P<billingAccountName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/invoices/(?P<invoiceName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/transactionsDownload`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 3 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
