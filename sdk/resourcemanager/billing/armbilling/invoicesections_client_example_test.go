...
// Generated from example definition: 2024-04-01/invoiceSectionsCreateOrUpdate.json
func ExampleInvoiceSectionsClient_BeginCreateOrUpdate() {
	...
	// res = armbilling.InvoiceSectionsClientCreateOrUpdateResponse{
	// 	InvoiceSection: &armbilling.InvoiceSection{
...
// Generated from example definition: 2024-04-01/invoiceSectionsDelete.json
...
// Generated from example definition: 2024-04-01/invoiceSectionsGet.json
func ExampleInvoiceSectionsClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armbilling.InvoiceSectionsClientGetResponse{
	// 	InvoiceSection: &armbilling.InvoiceSection{
	// 		Name: to.Ptr("invoice-section-1"),
	// 		Type: to.Ptr("Microsoft.Billing/billingAccounts/billingProfiles/invoiceSections"),
	// 		ID: to.Ptr("/providers/Microsoft.Billing/billingAccounts/00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31/billingProfiles/xxxx-xxxx-xxx-xxx/invoiceSections/invoice-section-1"),
...
// Generated from example definition: 2024-04-01/invoiceSectionsValidateDeleteEligibilityFailure.json
func ExampleInvoiceSectionsClient_ValidateDeleteEligibility_invoiceSectionsValidateDeleteEligibilityFailure() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armbilling.InvoiceSectionsClientValidateDeleteEligibilityResponse{
	// 	DeleteInvoiceSectionEligibilityResult: &armbilling.DeleteInvoiceSectionEligibilityResult{
...
// Generated from example definition: 2024-04-01/invoiceSectionsValidateDeleteEligibilitySuccess.json
