...
// AccountListResult - Paged collection of BillingAccount items
type AccountListResult struct {
	// READ-ONLY; The BillingAccount items on this page
	Value []*Account
...
// AgreementListResult - Paged collection of Agreement items
type AgreementListResult struct {
	// READ-ONLY; The Agreement items on this page
	Value []*Agreement
...
// AssociatedTenantListResult - Paged collection of AssociatedTenant items
type AssociatedTenantListResult struct {
	// READ-ONLY; The AssociatedTenant items on this page
...
// CustomerListResult - Paged collection of Customer items
type CustomerListResult struct {
	// READ-ONLY; The Customer items on this page
	Value []*Customer
...
// DepartmentListResult - Paged collection of Department items
type DepartmentListResult struct {
	// READ-ONLY; The Department items on this page
	Value []*Department
...
// EnrollmentAccountListResult - Paged collection of EnrollmentAccount items
type EnrollmentAccountListResult struct {
	// READ-ONLY; The EnrollmentAccount items on this page
...
// InvoiceListResult - Paged collection of Invoice items
type InvoiceListResult struct {
	// READ-ONLY; The Invoice items on this page
	Value []*Invoice
...
// InvoiceSectionListResult - Paged collection of InvoiceSection items
type InvoiceSectionListResult struct {
	// READ-ONLY; The InvoiceSection items on this page
...
type InvoiceSectionWithCreateSubPermissionListResult struct {
	// READ-ONLY; The InvoiceSectionWithCreateSubPermission items on this page
...
// OperationListResult - Result of the request to list billing operations. It contains a list of operations and a URL link
// to get the next set of results.
type OperationListResult struct {
	// READ-ONLY; URL to get the next set of operation list results if there are any.
	NextLink *string

	// READ-ONLY; List of billing operations supported by the Microsoft.Billing resource provider.
	Value []*Operation
}
...
// PartnerTransferDetailsListResult - Paged collection of PartnerTransferDetails items
type PartnerTransferDetailsListResult struct {
	// READ-ONLY; The PartnerTransferDetails items on this page
...
// PaymentMethodLinksListResult - The response of a PaymentMethodLink list operation.
type PaymentMethodLinksListResult struct {
	// READ-ONLY; The PaymentMethodLink items on this page
...
// PaymentMethodsListResult - The response of a PaymentMethod list operation.
type PaymentMethodsListResult struct {
	// READ-ONLY; The PaymentMethod items on this page
	Value []*PaymentMethod
...
type PermissionListResult struct {
	// READ-ONLY; The BillingPermission items on this page
	Value []*Permission
...
type ProductListResult struct {
	// READ-ONLY; The Product items on this page
	Value []*Product
...
// ProfileListResult - Paged collection of BillingProfile items
type ProfileListResult struct {
	// READ-ONLY; The BillingProfile items on this page
	Value []*Profile
...
type PropertyProperties struct {
	...
	// to a Microsoft Customer Agreement (MCA) account. Will be present and value will be true if its a transitioned billing account.
...
// RecipientTransferDetailsListResult - Paged collection of RecipientTransferDetails items
type RecipientTransferDetailsListResult struct {
	// READ-ONLY; The RecipientTransferDetails items on this page
...
// RequestListResult - Paged collection of BillingRequest items
type RequestListResult struct {
	// READ-ONLY; The BillingRequest items on this page
	Value []*Request
...
type ReservationOrderList struct {
	// REQUIRED; The ReservationOrder items on this page
...
// RoleAssignmentListResult - Paged collection of BillingRoleAssignment items
type RoleAssignmentListResult struct {
	// READ-ONLY; The BillingRoleAssignment items on this page
...
// RoleDefinitionListResult - Paged collection of BillingRoleDefinition items
type RoleDefinitionListResult struct {
	// READ-ONLY; The BillingRoleDefinition items on this page
...
type SavingsPlanModelListResult struct {
	// REQUIRED; The roll out count summary of the savings plans
...
// SubscriptionAliasListResult - Paged collection of BillingSubscriptionAlias items
type SubscriptionAliasListResult struct {
	// READ-ONLY; The BillingSubscriptionAlias items on this page
...
type SubscriptionAliasProperties struct {
	...
	// write operations will be blocked on the Billing Subscription. Other is the default value and you may need to refer to the
	...
	// for billing accounts with agreement type Microsoft Customer Agreement and Microsoft Partner Agreement.
	SKUDescription *string
...
// TransactionListResult - Paged collection of Transaction items
type TransactionListResult struct {
	// READ-ONLY; The Transaction items on this page
	Value []*Transaction
...
// TransferDetailsListResult - Paged collection of TransferDetails items
type TransferDetailsListResult struct {
	// READ-ONLY; The TransferDetails items on this page
