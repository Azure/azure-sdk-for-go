...
func (a AgreementProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "displayName", a.DisplayName)
	populateTime[datetime.RFC3339](objectMap, "effectiveDate", a.EffectiveDate)
...
func (e EnrollmentAccountSubscriptionDetails) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateTime[datetime.RFC3339](objectMap, "enrollmentAccountStartDate", e.EnrollmentAccountStartDate)
...
func (f FailedPayment) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateTime[datetime.RFC3339](objectMap, "date", f.Date)
...
func (i InvoiceProperties) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "dueDate", i.DueDate)
	populate(objectMap, "failedPayments", i.FailedPayments)
	populate(objectMap, "freeAzureCreditApplied", i.FreeAzureCreditApplied)
	populateTime[datetime.RFC3339](objectMap, "invoiceDate", i.InvoiceDate)
	populateTime[datetime.RFC3339](objectMap, "invoicePeriodEndDate", i.InvoicePeriodEndDate)
	populateTime[datetime.RFC3339](objectMap, "invoicePeriodStartDate", i.InvoicePeriodStartDate)
...
func (i InvoicePropertiesRefundDetails) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "approvedOn", i.ApprovedOn)
	populateTime[datetime.RFC3339](objectMap, "completedOn", i.CompletedOn)
	...
	populateTime[datetime.RFC3339](objectMap, "requestedOn", i.RequestedOn)
...
func (p Participant) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "statusDate", p.StatusDate)
	return json.Marshal(objectMap)
}
...
func (p PartnerTransferProperties) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "expirationTime", p.ExpirationTime)
...
func (p Payment) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "date", p.Date)
...
func (p PaymentTerm) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateTime[datetime.RFC3339](objectMap, "endDate", p.EndDate)
	populate(objectMap, "isDefault", p.IsDefault)
	populateTime[datetime.RFC3339](objectMap, "startDate", p.StartDate)
...
func (p PlanInformation) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateTime[datetime.PlainDate](objectMap, "nextPaymentDueDate", p.NextPaymentDueDate)
	populate(objectMap, "pricingCurrencyTotal", p.PricingCurrencyTotal)
	populateTime[datetime.PlainDate](objectMap, "startDate", p.StartDate)
...
func (r RecipientTransferProperties) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "expirationTime", r.ExpirationTime)
...
func (r RenewalTermDetails) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "termEndDate", r.TermEndDate)
	return json.Marshal(objectMap)
}
...
func (r RequestProperties) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "expirationDate", r.ExpirationDate)
	...
	populateTime[datetime.RFC3339](objectMap, "lastUpdatedDate", r.LastUpdatedDate)
	populate(objectMap, "provisioningState", r.ProvisioningState)
	populate(objectMap, "recipients", r.Recipients)
	populate(objectMap, "requestScope", r.RequestScope)
	populateTime[datetime.RFC3339](objectMap, "reviewalDate", r.ReviewalDate)
...
func (r ReservationPaymentDetail) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "billingCurrencyTotal", r.BillingCurrencyTotal)
	populateTime[datetime.PlainDate](objectMap, "dueDate", r.DueDate)
	populate(objectMap, "extendedStatusInfo", r.ExtendedStatusInfo)
	populateTime[datetime.PlainDate](objectMap, "paymentDate", r.PaymentDate)
	populate(objectMap, "pricingCurrencyTotal", r.PricingCurrencyTotal)
	populate(objectMap, "status", r.Status)
	return json.Marshal(objectMap)
}
...
func (r ReservationProperty) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "effectiveDateTime", r.EffectiveDateTime)
	populate(objectMap, "expiryDate", r.ExpiryDate)
	populateTime[datetime.RFC3339](objectMap, "expiryDateTime", r.ExpiryDateTime)
	populate(objectMap, "extendedStatusInfo", r.ExtendedStatusInfo)
	populate(objectMap, "instanceFlexibility", r.InstanceFlexibility)
	populateTime[datetime.RFC3339](objectMap, "lastUpdatedDateTime", r.LastUpdatedDateTime)
	populate(objectMap, "mergeProperties", r.MergeProperties)
	populate(objectMap, "productCode", r.ProductCode)
	populate(objectMap, "provisioningState", r.ProvisioningState)
	populate(objectMap, "provisioningSubState", r.ProvisioningSubState)
	populateTime[datetime.PlainDate](objectMap, "purchaseDate", r.PurchaseDate)
	populateTime[datetime.RFC3339](objectMap, "purchaseDateTime", r.PurchaseDateTime)
	populate(objectMap, "quantity", r.Quantity)
...
func (r RoleAssignmentProperties) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "modifiedOn", r.ModifiedOn)
...
func (s SubscriptionAliasProperties) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "purchaseDate", s.PurchaseDate)
	...
	populateTime[datetime.RFC3339](objectMap, "termEndDate", s.TermEndDate)
	populateTime[datetime.RFC3339](objectMap, "termStartDate", s.TermStartDate)
	return json.Marshal(objectMap)
}
...
func (s SystemOverrides) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "cancellationAllowedEndDate", s.CancellationAllowedEndDate)
	return json.Marshal(objectMap)
}
...
func (t TransactionProperties) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "date", t.Date)
	...
	populateTime[datetime.RFC3339](objectMap, "servicePeriodEndDate", t.ServicePeriodEndDate)
	populateTime[datetime.RFC3339](objectMap, "servicePeriodStartDate", t.ServicePeriodStartDate)
...
func (t TransferProperties) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "expirationTime", t.ExpirationTime)
...
func (t TransitionDetails) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "transitionDate", t.TransitionDate)
	return json.Marshal(objectMap)
}
