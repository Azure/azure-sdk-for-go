...
// Generated from example definition: 2024-04-01/partnerTransfersCancel.json
func ExamplePartnerTransfersClient_Cancel() {
	...
	// res = armbilling.PartnerTransfersClientCancelResponse{
	// 	PartnerTransferDetails: &armbilling.PartnerTransferDetails{
	// 		Name: to.Ptr("aabb123"),
...
// Generated from example definition: 2024-04-01/partnerTransfersGet.json
func ExamplePartnerTransfersClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armbilling.PartnerTransfersClientGetResponse{
	// 	PartnerTransferDetails: &armbilling.PartnerTransferDetails{
	// 		Name: to.Ptr("aabb123"),
	// 		Type: to.Ptr("Microsoft.Billing/transfers"),
	// 		ID: to.Ptr("/providers/Microsoft.Billing/BillingAccounts/10000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31/BillingProfiles/xxxx-xxxx-xxx-xxx/customers/11111111-1111-1111-1111-111111111111/transfers/aabb123"),
...
// Generated from example definition: 2024-04-01/partnerTransfersInitiate.json
func ExamplePartnerTransfersClient_Initiate() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armbilling.PartnerTransfersClientInitiateResponse{
	// 	PartnerTransferDetails: &armbilling.PartnerTransferDetails{
	// 		Name: to.Ptr("aabb123"),
	// 		Type: to.Ptr("Microsoft.Billing/transfers"),
	// 		ID: to.Ptr("/providers/Microsoft.Billing/BillingAccounts/10000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31/BillingProfiles/xxxx-xxxx-xxx-xxx/customers/11111111-1111-1111-1111-111111111111/transfers/aabb123"),
...
// Generated from example definition: 2024-04-01/partnerTransfersList.json
func ExamplePartnerTransfersClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armbilling.PartnerTransfersClientListResponse{
		// 	PartnerTransferDetailsListResult: armbilling.PartnerTransferDetailsListResult{
