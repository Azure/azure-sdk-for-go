...
const defaultPaymentMethodsClientVersion string = "2024-04-01"
...
func (client *PaymentMethodsClient) deleteByUserCreateRequest(ctx context.Context, paymentMethodName string, _ *PaymentMethodsClientDeleteByUserOptions) (*policy.Request, error) {
	...
	reqQP.Set("api-version", defaultPaymentMethodsClientVersion)
...
// owned by the caller, these payment methods can be attached to a billing profile to make payments. The operation is supported
