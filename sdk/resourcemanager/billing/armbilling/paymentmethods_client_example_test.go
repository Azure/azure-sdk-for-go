...
// Generated from example definition: 2024-04-01/paymentMethodsGetByBillingAccount.json
func ExamplePaymentMethodsClient_GetByBillingAccount() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armbilling.PaymentMethodsClientGetByBillingAccountResponse{
...
// Generated from example definition: 2024-04-01/paymentMethodsGetByBillingProfile.json
func ExamplePaymentMethodsClient_GetByBillingProfile() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armbilling.PaymentMethodsClientGetByBillingProfileResponse{
	// 	PaymentMethodLink: &armbilling.PaymentMethodLink{
...
// Generated from example definition: 2024-04-01/paymentMethodsListByBillingAccount.json
func ExamplePaymentMethodsClient_NewListByBillingAccountPager() {
	...
	for pager.More() {
		...
		// page = armbilling.PaymentMethodsClientListByBillingAccountResponse{
		// 	PaymentMethodsListResult: armbilling.PaymentMethodsListResult{
...
// Generated from example definition: 2024-04-01/paymentMethodsListByBillingProfile.json
func ExamplePaymentMethodsClient_NewListByBillingProfilePager() {
	...
	for pager.More() {
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armbilling.PaymentMethodsClientListByBillingProfileResponse{
		// 	PaymentMethodLinksListResult: armbilling.PaymentMethodLinksListResult{
...
// Generated from example definition: 2024-04-01/paymentMethodsListByUser.json
func ExamplePaymentMethodsClient_NewListByUserPager() {
	...
	for pager.More() {
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armbilling.PaymentMethodsClientListByUserResponse{
		// 	PaymentMethodsListResult: armbilling.PaymentMethodsListResult{
		// 		Value: []*armbilling.PaymentMethod{
		// 			{
		// 				Name: to.Ptr("ABCDABCDABC0"),
