...
// Generated from example definition: 2024-04-01/billingProfilesCreateOrUpdate.json
func ExampleProfilesClient_BeginCreateOrUpdate() {
	...
	// res = armbilling.ProfilesClientCreateOrUpdateResponse{
	// 	Profile: &armbilling.Profile{
...
// Generated from example definition: 2024-04-01/billingProfilesDelete.json
...
// Generated from example definition: 2024-04-01/billingProfilesGet.json
func ExampleProfilesClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armbilling.ProfilesClientGetResponse{
	// 	Profile: &armbilling.Profile{
	// 		Name: to.Ptr("xxxx-xxxx-xxx-xxx"),
	// 		Type: to.Ptr("Microsoft.Billing/billingAccounts/billingProfiles"),
	// 		ID: to.Ptr("/providers/Microsoft.Billing/billingAccounts/00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31/billingProfiles/xxxx-xxxx-xxx-xxx"),
	...
	// 					Currency: to.Ptr("USD"),
	// 					EndDate: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2019-01-01T00:00:00.0000000Z"); return t}()),
	// 					StartDate: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2018-01-01T00:00:00.0000000Z"); return t}()),
...
// Generated from example definition: 2024-04-01/billingProfilesListByBillingAccount.json
func ExampleProfilesClient_NewListByBillingAccountPager() {
	...
	pager := clientFactory.NewProfilesClient().NewListByBillingAccountPager("00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31", nil)
	for pager.More() {
		...
		// page = armbilling.ProfilesClientListByBillingAccountResponse{
		// 	ProfileListResult: armbilling.ProfileListResult{
...
// Generated from example definition: 2024-04-01/billingProfilesValidateDeleteEligibilityFailure.json
func ExampleProfilesClient_ValidateDeleteEligibility_billingProfilesValidateDeleteEligibilityFailure() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armbilling.ProfilesClientValidateDeleteEligibilityResponse{
	// 	DeleteBillingProfileEligibilityResult: &armbilling.DeleteBillingProfileEligibilityResult{
...
// Generated from example definition: 2024-04-01/billingProfilesValidateDeleteEligibilitySuccess.json
