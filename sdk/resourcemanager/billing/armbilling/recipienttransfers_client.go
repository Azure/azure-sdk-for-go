...
// NewValidatePager - Validates if a subscription or a reservation can be transferred. Use this operation to validate your
// subscriptions or reservation before using the accept transfer operation.
//
// Validates if a subscription or a reservation can be transferred. Use this operation to validate your subscriptions or reservation
...
//   - options - RecipientTransfersClientValidateOptions contains the optional parameters for the RecipientTransfersClient.NewValidatePager
//     method.
func (client *RecipientTransfersClient) NewValidatePager(transferName string, parameters AcceptTransferRequest, options *RecipientTransfersClientValidateOptions) *runtime.Pager[RecipientTransfersClientValidateResponse] {
	return runtime.NewPager(runtime.PagingHandler[RecipientTransfersClientValidateResponse]{
		More: func(page RecipientTransfersClientValidateResponse) bool {
			return false
		},
		Fetcher: func(ctx context.Context, page *RecipientTransfersClientValidateResponse) (RecipientTransfersClientValidateResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "RecipientTransfersClient.NewValidatePager")
			...
			if !runtime.HasStatusCode(resp, http.StatusOK) {
				return RecipientTransfersClientValidateResponse{}, runtime.NewResponseError(resp)
			}
