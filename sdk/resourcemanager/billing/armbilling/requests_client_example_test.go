...
func ExampleRequestsClient_BeginCreateOrUpdate() {
	...
	// 			},
	// 			CreationDate: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2024-04-01T17:32:28Z"); return t}()),
	// 			ExpirationDate: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2023-04-15T17:32:28Z"); return t}()),
	// 			LastUpdatedBy: &armbilling.RequestPropertiesLastUpdatedBy{
	// 				Upn: to.Ptr("admin@contoso.com"),
	// 			},
	// 			LastUpdatedDate: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2024-04-01T17:32:28Z"); return t}()),
	// 			RequestScope: to.Ptr("/providers/Microsoft.Billing/billingAccounts/00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31/billingProfiles/xxxx-xxxx-xxx-xxx"),
	// 			Status: to.Ptr(armbilling.BillingRequestStatusPending),
	// 		},
	// 	},
...
func ExampleRequestsClient_NewListByBillingAccountPager() {
	...
	for pager.More() {
		...
		// 						Upn: to.Ptr("foo@contoso.com"),
		// 					},
		// 					CreationDate: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2023-03-01T17:32:28Z"); return t}()),
		// 					ExpirationDate: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2023-03-15T17:32:28Z"); return t}()),
		// 					LastUpdatedBy: &armbilling.RequestPropertiesLastUpdatedBy{
		// 						Upn: to.Ptr("admin@contosofinance.com"),
		// 					},
		// 					LastUpdatedDate: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2023-03-02T17:32:28Z"); return t}()),
		...
		// 					ReviewalDate: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2023-03-02T17:32:28Z"); return t}()),
