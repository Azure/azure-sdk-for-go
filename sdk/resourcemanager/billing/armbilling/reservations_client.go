...
// GetByReservationOrder - Get Reservation details in the billing account.
//
...
func (client *ReservationsClient) GetByReservationOrder(ctx context.Context, billingAccountName string, reservationOrderID string, reservationID string, options *ReservationsClientGetByReservationOrderOptions) (ReservationsClientGetByReservationOrderResponse, error) {
	...
	return client.getByReservationOrderHandleResponse(httpResp, http.StatusOK)
}
...
func (client *ReservationsClient) getByReservationOrderHandleResponse(resp *http.Response, successCodes ...int) (ReservationsClientGetByReservationOrderResponse, error) {
...
func (client *ReservationsClient) listByBillingAccountCreateRequest(ctx context.Context, billingAccountName string, nextLink string, options *ReservationsClientListByBillingAccountOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *ReservationsClient) listByBillingAccountHandleResponse(resp *http.Response, successCodes ...int) (ReservationsClientListByBillingAccountResponse, error) {
...
func (client *ReservationsClient) listByBillingProfileCreateRequest(ctx context.Context, billingAccountName string, billingProfileName string, nextLink string, options *ReservationsClientListByBillingProfileOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
	var req *policy.Request
	var err error
	if firstPage {
...
func (client *ReservationsClient) listByBillingProfileHandleResponse(resp *http.Response, successCodes ...int) (ReservationsClientListByBillingProfileResponse, error) {
...
// NewListByReservationOrderPager - Get Reservations in a given reservation Order in the billing account
//
...
func (client *ReservationsClient) NewListByReservationOrderPager(billingAccountName string, reservationOrderID string, options *ReservationsClientListByReservationOrderOptions) *runtime.Pager[ReservationsClientListByReservationOrderResponse] {
	return runtime.NewPager(runtime.PagingHandler[ReservationsClientListByReservationOrderResponse]{
		...
		Fetcher: func(ctx context.Context, page *ReservationsClientListByReservationOrderResponse) (ReservationsClientListByReservationOrderResponse, error) {
			...
			req, err := client.listByReservationOrderCreateRequest(ctx, billingAccountName, reservationOrderID, nextLink, options)
			if err != nil {
...
func (client *ReservationsClient) listByReservationOrderCreateRequest(ctx context.Context, billingAccountName string, reservationOrderID string, nextLink string, _ *ReservationsClientListByReservationOrderOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
	var req *policy.Request
	var err error
	if firstPage {
...
func (client *ReservationsClient) listByReservationOrderHandleResponse(resp *http.Response, successCodes ...int) (ReservationsClientListByReservationOrderResponse, error) {
