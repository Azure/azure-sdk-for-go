...
func ExampleReservationsClient_GetByReservationOrder_reservationGetByBillingAccount() {
	...
	// 			EffectiveDateTime: to.Ptr(time.Date(2023, time.January, 24, 1, 46, 5, 425051100, time.UTC)),
	...
	// 			LastUpdatedDateTime: to.Ptr(time.Date(2023, time.January, 24, 1, 46, 5, 534431800, time.UTC)),
	// 			ProductCode: to.Ptr("20000000-0000-0000-0000-000000000005"),
	// 			ProvisioningState: to.Ptr("Succeeded"),
	// 			PurchaseDate: to.Ptr(time.Date(2021, time.November, 25, 0, 0, 0, 0, time.UTC)),
	// 			PurchaseDateTime: to.Ptr(time.Date(2021, time.November, 25, 6, 31, 18, 392549300, time.UTC)),
...
func ExampleReservationsClient_GetByReservationOrder_reservationGetByBillingAccountManagementGroup() {
	...
	// 			EffectiveDateTime: to.Ptr(time.Date(2023, time.January, 26, 1, 19, 31, 991606600, time.UTC)),
	// 			ExpiryDate: to.Ptr("2024-11-25"),
	// 			ExpiryDateTime: to.Ptr(time.Date(2024, time.November, 25, 6, 34, 12, 926698700, time.UTC)),
	...
	// 			},
	// 			InstanceFlexibility: to.Ptr(armbilling.InstanceFlexibilityOn),
	// 			LastUpdatedDateTime: to.Ptr(time.Date(2023, time.January, 26, 1, 19, 32, 69712000, time.UTC)),
	// 			ProductCode: to.Ptr("20000000-0000-0000-0000-000000000005"),
	// 			ProvisioningState: to.Ptr("Succeeded"),
	// 			PurchaseDate: to.Ptr(time.Date(2021, time.November, 25, 0, 0, 0, 0, time.UTC)),
	// 			PurchaseDateTime: to.Ptr(time.Date(2021, time.November, 25, 6, 31, 18, 392549300, time.UTC)),
...
func ExampleReservationsClient_GetByReservationOrder_reservationGetByBillingAccountSingleResourceGroup() {
	...
	// 			DisplayName: to.Ptr("VM_RI_11-24-2021_22-30"),
	// 			DisplayProvisioningState: to.Ptr("Succeeded"),
	// 			EffectiveDateTime: to.Ptr(time.Date(2023, time.January, 26, 1, 21, 47, 293611600, time.UTC)),
	// 			ExpiryDate: to.Ptr("2024-11-25"),
	// 			ExpiryDateTime: to.Ptr(time.Date(2024, time.November, 25, 6, 34, 12, 926698700, time.UTC)),
	// 			InstanceFlexibility: to.Ptr(armbilling.InstanceFlexibilityOn),
	// 			LastUpdatedDateTime: to.Ptr(time.Date(2023, time.January, 26, 1, 21, 47, 356110600, time.UTC)),
	// 			ProductCode: to.Ptr("20000000-0000-0000-0000-000000000005"),
	// 			ProvisioningState: to.Ptr("Succeeded"),
	// 			PurchaseDate: to.Ptr(time.Date(2021, time.November, 25, 0, 0, 0, 0, time.UTC)),
	// 			PurchaseDateTime: to.Ptr(time.Date(2021, time.November, 25, 6, 31, 18, 392549300, time.UTC)),
...
func ExampleReservationsClient_GetByReservationOrder_reservationGetByBillingAccountSingleScope() {
	...
	// 			DisplayName: to.Ptr("VM_RI_11-24-2021_22-30"),
	// 			DisplayProvisioningState: to.Ptr("Succeeded"),
	// 			EffectiveDateTime: to.Ptr(time.Date(2023, time.January, 26, 1, 14, 18, 558909000, time.UTC)),
	// 			ExpiryDate: to.Ptr("2024-11-25"),
	// 			ExpiryDateTime: to.Ptr(time.Date(2024, time.November, 25, 6, 34, 12, 926698700, time.UTC)),
	// 			InstanceFlexibility: to.Ptr(armbilling.InstanceFlexibilityOff),
	// 			LastUpdatedDateTime: to.Ptr(time.Date(2023, time.January, 26, 1, 14, 18, 605775600, time.UTC)),
	// 			ProductCode: to.Ptr("20000000-0000-0000-0000-000000000005"),
	// 			ProvisioningState: to.Ptr("Succeeded"),
	// 			PurchaseDate: to.Ptr(time.Date(2021, time.November, 25, 0, 0, 0, 0, time.UTC)),
	// 			PurchaseDateTime: to.Ptr(time.Date(2021, time.November, 25, 6, 31, 18, 392549300, time.UTC)),
...
func ExampleReservationsClient_NewListByBillingAccountPager() {
	...
	for pager.More() {
		...
		// 					AppliedScopeType: to.Ptr("Shared"),
		// 					Archived: to.Ptr(false),
		// 					BenefitStartTime: to.Ptr(time.Date(2022, time.January, 18, 21, 54, 31, 74103400, time.UTC)),
		// 					BillingPlan: to.Ptr(armbilling.ReservationBillingPlanMonthly),
		...
		// 					DisplayProvisioningState: to.Ptr("Succeeded"),
		// 					EffectiveDateTime: to.Ptr(time.Date(1, time.January, 1, 0, 0, 0, 0, time.UTC)),
		// 					ExpiryDate: to.Ptr("2025-01-18"),
		// 					ExpiryDateTime: to.Ptr(time.Date(2025, time.January, 18, 21, 54, 31, 74103400, time.UTC)),
		// 					InstanceFlexibility: to.Ptr(armbilling.InstanceFlexibilityOn),
		// 					LastUpdatedDateTime: to.Ptr(time.Time{}),
		// 					ProductCode: to.Ptr("20000000-0000-0000-0000-000000000005"),
		// 					ProvisioningState: to.Ptr("Succeeded"),
		// 					PurchaseDate: to.Ptr(time.Date(2022, time.January, 18, 0, 0, 0, 0, time.UTC)),
		// 					PurchaseDateTime: to.Ptr(time.Date(2022, time.January, 18, 21, 51, 29, 906367100, time.UTC)),
		// 					Quantity: to.Ptr[float32](1),
		// 					Renew: to.Ptr(false),
