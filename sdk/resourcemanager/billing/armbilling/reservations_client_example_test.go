...
// Generated from example definition: 2024-04-01/reservationGetByBillingAccount.json
func ExampleReservationsClient_GetByReservationOrder_reservationGetByBillingAccount() {
	...
	// 			EffectiveDateTime: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2023-01-24T01:46:05.4250511Z"); return t}()),
	...
	// 			LastUpdatedDateTime: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2023-01-24T01:46:05.5344318Z"); return t}()),
...
// Generated from example definition: 2024-04-01/reservationGetByBillingAccountManagementGroup.json
func ExampleReservationsClient_GetByReservationOrder_reservationGetByBillingAccountManagementGroup() {
	...
	// 			EffectiveDateTime: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2023-01-26T01:19:31.9916066Z"); return t}()),
	// 			ExpiryDate: to.Ptr("2024-11-25"),
	// 			ExpiryDateTime: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2024-11-25T06:34:12.9266987Z"); return t}()),
	...
	// 			},
	// 			InstanceFlexibility: to.Ptr(armbilling.InstanceFlexibilityOn),
	// 			LastUpdatedDateTime: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2023-01-26T01:19:32.0697120Z"); return t}()),
	// 			ProductCode: to.Ptr("20000000-0000-0000-0000-000000000005"),
	// 			ProvisioningState: to.Ptr("Succeeded"),
	// 			PurchaseDate: to.Ptr(func() time.Time { t, _ := time.Parse(time.DateOnly, "2021-11-25"); return t}()),
	// 			PurchaseDateTime: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2021-11-25T06:31:18.3925493Z"); return t}()),
...
// Generated from example definition: 2024-04-01/reservationGetByBillingAccountSingleResourceGroup.json
func ExampleReservationsClient_GetByReservationOrder_reservationGetByBillingAccountSingleResourceGroup() {
	...
	// 			DisplayName: to.Ptr("VM_RI_11-24-2021_22-30"),
	// 			DisplayProvisioningState: to.Ptr("Succeeded"),
	// 			EffectiveDateTime: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2023-01-26T01:21:47.2936116Z"); return t}()),
	// 			ExpiryDate: to.Ptr("2024-11-25"),
	// 			ExpiryDateTime: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2024-11-25T06:34:12.9266987Z"); return t}()),
	// 			InstanceFlexibility: to.Ptr(armbilling.InstanceFlexibilityOn),
	// 			LastUpdatedDateTime: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2023-01-26T01:21:47.3561106Z"); return t}()),
	// 			ProductCode: to.Ptr("20000000-0000-0000-0000-000000000005"),
	// 			ProvisioningState: to.Ptr("Succeeded"),
	// 			PurchaseDate: to.Ptr(func() time.Time { t, _ := time.Parse(time.DateOnly, "2021-11-25"); return t}()),
	// 			PurchaseDateTime: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2021-11-25T06:31:18.3925493Z"); return t}()),
...
// Generated from example definition: 2024-04-01/reservationsListByBillingAccount.json
func ExampleReservationsClient_NewListByBillingAccountPager() {
	...
	pager := clientFactory.NewReservationsClient().NewListByBillingAccountPager("00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31", &armbilling.ReservationsClientListByBillingAccountOptions{
	...
	for pager.More() {
		...
		// page = armbilling.ReservationsClientListByBillingAccountResponse{
		// 	ReservationsListResult: armbilling.ReservationsListResult{
		...
		// 					AppliedScopeType: to.Ptr("Shared"),
		// 					Archived: to.Ptr(false),
		// 					BenefitStartTime: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2022-01-18T21:54:31.0741034Z"); return t}()),
		// 					BillingPlan: to.Ptr(armbilling.ReservationBillingPlanMonthly),
		...
		// 					DisplayProvisioningState: to.Ptr("Succeeded"),
		// 					EffectiveDateTime: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "0001-01-01T00:00:00Z"); return t}()),
		// 					ExpiryDate: to.Ptr("2025-01-18"),
		// 					ExpiryDateTime: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2025-01-18T21:54:31.0741034Z"); return t}()),
		// 					InstanceFlexibility: to.Ptr(armbilling.InstanceFlexibilityOn),
		// 					LastUpdatedDateTime: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "0001-01-01T00:00:00.0000000"); return t}()),
		// 					ProductCode: to.Ptr("20000000-0000-0000-0000-000000000005"),
		// 					ProvisioningState: to.Ptr("Succeeded"),
		// 					PurchaseDate: to.Ptr(func() time.Time { t, _ := time.Parse(time.DateOnly, "2022-01-18"); return t}()),
		// 					PurchaseDateTime: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2022-01-18T21:51:29.9063671Z"); return t}()),
		// 					Quantity: to.Ptr[float32](1),
		// 					Renew: to.Ptr(false),
...
// Generated from example definition: 2024-04-01/reservationsListByBillingProfile.json
func ExampleReservationsClient_NewListByBillingProfilePager() {
	...
	pager := clientFactory.NewReservationsClient().NewListByBillingProfilePager("00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31", "AAAA-AAAA-AAA-AAA", &armbilling.ReservationsClientListByBillingProfileOptions{
		SelectedState: to.Ptr("Succeeded")})
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armbilling.ReservationsClientListByBillingProfileResponse{
		// 	ReservationsListResult: armbilling.ReservationsListResult{
		// 		Summary: &armbilling.ReservationSummary{
		// 			CancelledCount: to.Ptr[float32](0),
		// 			ExpiredCount: to.Ptr[float32](0),
...
// Generated from example definition: 2024-04-01/reservationsGetFromOrderByBillingAccount.json
func ExampleReservationsClient_NewListByReservationOrderPager() {
	...
	for pager.More() {
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armbilling.ReservationsClientListByReservationOrderResponse{
		// 	ReservationList: armbilling.ReservationList{
		// 		Value: []*armbilling.Reservation{
		// 			{
...
// Generated from example definition: 2024-04-01/reservationUpdateByBillingAccount.json
func ExampleReservationsClient_BeginUpdateByBillingAccount() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armbilling.ReservationsClientUpdateByBillingAccountResponse{
	// 	Reservation: &armbilling.Reservation{
	// 		Name: to.Ptr("30000000-0000-0000-0000-000000000000"),
	// 		Type: to.Ptr("microsoft.billing/billingAccounts/reservationOrders/reservations"),
	// 		Etag: to.Ptr[int32](15),
