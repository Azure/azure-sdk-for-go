...
func (client *SavingsPlanOrdersClient) getByBillingAccountHandleResponse(resp *http.Response, successCodes ...int) (SavingsPlanOrdersClientGetByBillingAccountResponse, error) {
...
func (client *SavingsPlanOrdersClient) listByBillingAccountCreateRequest(ctx context.Context, billingAccountName string, nextLink string, options *SavingsPlanOrdersClientListByBillingAccountOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *SavingsPlanOrdersClient) listByBillingAccountHandleResponse(resp *http.Response, successCodes ...int) (SavingsPlanOrdersClientListByBillingAccountResponse, error) {
