...
// Generated from example definition: 2024-04-01/savingsPlanGetByBillingAccount.json
func ExampleSavingsPlansClient_GetByBillingAccount_savingsPlanGet() {
	...
	res, err := clientFactory.NewSavingsPlansClient().GetByBillingAccount(ctx, "00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31", "20000000-0000-0000-0000-000000000000", "30000000-0000-0000-0000-000000000000", nil)
	if err != nil {
	...
	// res = armbilling.SavingsPlansClientGetByBillingAccountResponse{
	// 	SavingsPlanModel: armbilling.SavingsPlanModel{
	...
	// 			BenefitStartTime: to.Ptr(time.Date(2022, time.November, 16, 2, 25, 11, 718386600, time.UTC)),
	...
	// 			EffectiveDateTime: to.Ptr(time.Date(2022, time.December, 16, 1, 35, 36, 290946200, time.UTC)),
	// 			ExpiryDateTime: to.Ptr(time.Date(2025, time.November, 16, 2, 25, 11, 718386600, time.UTC)),
	// 			ProductCode: to.Ptr("20000000-0000-0000-0000-000000000005"),
	// 			ProvisioningState: to.Ptr(armbilling.ProvisioningStateSucceeded),
	// 			PurchaseDateTime: to.Ptr(time.Date(2022, time.November, 16, 2, 23, 21, 386478300, time.UTC)),
	// 			Renew: to.Ptr(false),
...
// Generated from example definition: 2024-04-01/savingsPlanGetExpandRenewPropertiesByBillingAccount.json
...
func ExampleSavingsPlansClient_NewListByBillingAccountPager() {
	...
	for pager.More() {
		...
		// 					BenefitStartTime: to.Ptr(time.Date(2022, time.December, 16, 2, 17, 3, 739615200, time.UTC)),
		// 					BillingAccountID: to.Ptr("/providers/Microsoft.Billing/billingAccounts/00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31"),
		// 					BillingPlan: to.Ptr(armbilling.BillingPlanP1M),
		// 					BillingProfileID: to.Ptr("/providers/Microsoft.Billing/billingAccounts/00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31/billingProfiles/AAAA-BBBB-CCC-DDD"),
		...
		// 					EffectiveDateTime: to.Ptr(time.Date(2022, time.December, 16, 2, 17, 4, 989666100, time.UTC)),
		// 					ExpiryDateTime: to.Ptr(time.Date(2023, time.December, 16, 2, 17, 3, 739615200, time.UTC)),
		// 					ProductCode: to.Ptr("20000000-0000-0000-0000-000000000005"),
		// 					ProvisioningState: to.Ptr(armbilling.ProvisioningStateSucceeded),
		// 					PurchaseDateTime: to.Ptr(time.Date(2022, time.December, 16, 2, 14, 58, 230413400, time.UTC)),
		// 					Renew: to.Ptr(false),
		...
		// 					},
		// 					AppliedScopeType: to.Ptr(armbilling.AppliedScopeTypeManagementGroup),
		// 					BenefitStartTime: to.Ptr(time.Date(2022, time.December, 16, 2, 22, 22, 725479500, time.UTC)),
		// 					BillingAccountID: to.Ptr("/providers/Microsoft.Billing/billingAccounts/00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31"),
		// 					BillingPlan: to.Ptr(armbilling.BillingPlanP1M),
		// 					BillingProfileID: to.Ptr("/providers/Microsoft.Billing/billingAccounts/00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31/billingProfiles/AAAA-BBBB-CCC-DDD"),
		// 					BillingScopeID: to.Ptr("/subscriptions/10000000-0000-0000-0000-000000000000"),
		...
		// 					DisplayProvisioningState: to.Ptr("Succeeded"),
		// 					EffectiveDateTime: to.Ptr(time.Date(2022, time.December, 16, 2, 22, 24, 553619100, time.UTC)),
		// 					ExpiryDateTime: to.Ptr(time.Date(2023, time.December, 16, 2, 22, 22, 725479500, time.UTC)),
		// 					ProductCode: to.Ptr("20000000-0000-0000-0000-000000000005"),
		// 					ProvisioningState: to.Ptr(armbilling.ProvisioningStateSucceeded),
		// 					PurchaseDateTime: to.Ptr(time.Date(2022, time.December, 16, 2, 20, 23, 473307600, time.UTC)),
		// 					Renew: to.Ptr(false),
		// 					Term: to.Ptr(armbilling.SavingsPlanTermP1Y),
		// 					UserFriendlyAppliedScopeType: to.Ptr("ManagementGroup"),
		// 					Utilization: &armbilling.Utilization{
		...
		// 					BenefitStartTime: to.Ptr(time.Date(2022, time.October, 14, 21, 18, 55, 296061300, time.UTC)),
		// 					BillingAccountID: to.Ptr("/providers/Microsoft.Billing/billingAccounts/00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31"),
		// 					BillingPlan: to.Ptr(armbilling.BillingPlanP1M),
		// 					BillingProfileID: to.Ptr("/providers/Microsoft.Billing/billingAccounts/00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31/billingProfiles/AAAA-BBBB-CCC-DDD"),
		...
		// 					DisplayProvisioningState: to.Ptr("Succeeded"),
		// 					EffectiveDateTime: to.Ptr(time.Date(2022, time.November, 7, 23, 54, 43, 823324300, time.UTC)),
		// 					ExpiryDateTime: to.Ptr(time.Date(2025, time.October, 14, 21, 18, 55, 296061300, time.UTC)),
		// 					ProductCode: to.Ptr("20000000-0000-0000-0000-000000000005"),
		// 					ProvisioningState: to.Ptr(armbilling.ProvisioningStateSucceeded),
		// 					PurchaseDateTime: to.Ptr(time.Date(2022, time.October, 14, 21, 16, 57, 234768800, time.UTC)),
		// 					Renew: to.Ptr(true),
		// 					Term: to.Ptr(armbilling.SavingsPlanTermP3Y),
		...
		// 					},
		// 					AppliedScopeType: to.Ptr(armbilling.AppliedScopeTypeSingle),
		// 					BenefitStartTime: to.Ptr(time.Date(2022, time.November, 8, 0, 0, 6, 363674700, time.UTC)),
		// 					BillingAccountID: to.Ptr("/providers/Microsoft.Billing/billingAccounts/00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31"),
		// 					BillingPlan: to.Ptr(armbilling.BillingPlanP1M),
		// 					BillingProfileID: to.Ptr("/providers/Microsoft.Billing/billingAccounts/00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31/billingProfiles/AAAA-BBBB-CCC-DDD"),
		// 					BillingScopeID: to.Ptr("/subscriptions/10000000-0000-0000-0000-000000000000"),
		...
		// 					DisplayProvisioningState: to.Ptr("Succeeded"),
		// 					EffectiveDateTime: to.Ptr(time.Date(2022, time.November, 30, 21, 18, 12, 196732300, time.UTC)),
		// 					ExpiryDateTime: to.Ptr(time.Date(2025, time.November, 8, 0, 0, 6, 363674700, time.UTC)),
		// 					ProductCode: to.Ptr("20000000-0000-0000-0000-000000000005"),
		// 					ProvisioningState: to.Ptr(armbilling.ProvisioningStateSucceeded),
		// 					PurchaseDateTime: to.Ptr(time.Date(2022, time.November, 7, 23, 57, 58, 242867700, time.UTC)),
		// 					Renew: to.Ptr(false),
		// 					Term: to.Ptr(armbilling.SavingsPlanTermP3Y),
...
// Generated from example definition: 2024-04-01/savingsPlansListBySavingsPlanOrders.json
func ExampleSavingsPlansClient_NewListBySavingsPlanOrderPager() {
	...
	for pager.More() {
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armbilling.SavingsPlansClientListBySavingsPlanOrderResponse{
		// 	SavingsPlanModelList: armbilling.SavingsPlanModelList{
		// 		Value: []*armbilling.SavingsPlanModel{
		// 			{
		// 				Name: to.Ptr("30000000-0000-0000-0000-000000000000"),
		// 				Type: to.Ptr("microsoft.billing/billingAccounts/savingsPlanOrders/savingsPlans"),
		...
		// 					DisplayName: to.Ptr("SP1"),
		// 					DisplayProvisioningState: to.Ptr("Succeeded"),
		// 					EffectiveDateTime: to.Ptr(time.Date(2023, time.January, 20, 2, 36, 25, 89466900, time.UTC)),
		// 					ExpiryDateTime: to.Ptr(time.Date(2026, time.January, 20, 2, 36, 22, 339475500, time.UTC)),
		// 					ProvisioningState: to.Ptr(armbilling.ProvisioningStateSucceeded),
		// 					PurchaseDateTime: to.Ptr(time.Date(2023, time.January, 20, 2, 34, 38, 126169500, time.UTC)),
		// 					Renew: to.Ptr(false),
		// 					Term: to.Ptr(armbilling.SavingsPlanTermP3Y),
		// 					UserFriendlyAppliedScopeType: to.Ptr("Shared"),
		// 					Utilization: &armbilling.Utilization{
...
// Generated from example definition: 2024-04-01/savingsPlanUpdateByBillingAccount.json
func ExampleSavingsPlansClient_BeginUpdateByBillingAccount() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armbilling.SavingsPlansClientUpdateByBillingAccountResponse{
	// 	SavingsPlanModel: armbilling.SavingsPlanModel{
	// 		Name: to.Ptr("30000000-0000-0000-0000-000000000000"),
	// 		Type: to.Ptr("microsoft.billing/billingAccounts/savingsPlanOrders/savingsPlans"),
	// 		ID: to.Ptr("/providers/Microsoft.Billing/billingAccounts/00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31/savingsPlanOrders/20000000-0000-0000-0000-000000000000/savingsPlans/30000000-0000-0000-0000-000000000000"),
	...
	// 			DisplayName: to.Ptr("sp_newName"),
	// 			DisplayProvisioningState: to.Ptr("Succeeded"),
	// 			EffectiveDateTime: to.Ptr(time.Date(2023, time.February, 4, 4, 30, 49, 198298900, time.UTC)),
	// 			ExpiryDateTime: to.Ptr(time.Date(2026, time.February, 4, 3, 18, 31, 307263500, time.UTC)),
	// 			ProductCode: to.Ptr("20000000-0000-0000-0000-000000000005"),
	// 			ProvisioningState: to.Ptr(armbilling.ProvisioningStateSucceeded),
	// 			PurchaseDateTime: to.Ptr(time.Date(2023, time.February, 4, 3, 16, 38, 906550500, time.UTC)),
	// 			Renew: to.Ptr(true),
	// 			Term: to.Ptr(armbilling.SavingsPlanTermP3Y),
	// 			UserFriendlyAppliedScopeType: to.Ptr("ManagementGroup"),
	// 			Utilization: &armbilling.Utilization{
