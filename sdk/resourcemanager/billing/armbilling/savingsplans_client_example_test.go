...
func ExampleSavingsPlansClient_GetByBillingAccount_savingsPlanGet() {
	...
	// 			BenefitStartTime: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2022-11-16T02:25:11.7183866Z"); return t}()),
	...
	// 			EffectiveDateTime: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2022-12-16T01:35:36.2909462Z"); return t}()),
	// 			ExpiryDateTime: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2025-11-16T02:25:11.7183866Z"); return t}()),
	// 			ProductCode: to.Ptr("20000000-0000-0000-0000-000000000005"),
	// 			ProvisioningState: to.Ptr(armbilling.ProvisioningStateSucceeded),
	// 			PurchaseDateTime: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2022-11-16T02:23:21.3864783Z"); return t}()),
	// 			Renew: to.Ptr(false),
...
func ExampleSavingsPlansClient_NewListBySavingsPlanOrderPager() {
	...
	for pager.More() {
		...
		// 					DisplayName: to.Ptr("SP1"),
		// 					DisplayProvisioningState: to.Ptr("Succeeded"),
		// 					EffectiveDateTime: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2023-01-20T02:36:25.0894669Z"); return t}()),
		// 					ExpiryDateTime: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2026-01-20T02:36:22.3394755Z"); return t}()),
		// 					ProvisioningState: to.Ptr(armbilling.ProvisioningStateSucceeded),
		// 					PurchaseDateTime: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2023-01-20T02:34:38.1261695Z"); return t}()),
		// 					Renew: to.Ptr(false),
		// 					Term: to.Ptr(armbilling.SavingsPlanTermP3Y),
		// 					UserFriendlyAppliedScopeType: to.Ptr("Shared"),
		// 					Utilization: &armbilling.Utilization{
...
func ExampleSavingsPlansClient_BeginUpdateByBillingAccount() {
	...
	// 			DisplayName: to.Ptr("sp_newName"),
	// 			DisplayProvisioningState: to.Ptr("Succeeded"),
	// 			EffectiveDateTime: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2023-02-04T04:30:49.1982989Z"); return t}()),
	// 			ExpiryDateTime: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2026-02-04T03:18:31.3072635Z"); return t}()),
	// 			ProductCode: to.Ptr("20000000-0000-0000-0000-000000000005"),
	// 			ProvisioningState: to.Ptr(armbilling.ProvisioningStateSucceeded),
	// 			PurchaseDateTime: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2023-02-04T03:16:38.9065505Z"); return t}()),
	// 			Renew: to.Ptr(true),
	// 			Term: to.Ptr(armbilling.SavingsPlanTermP3Y),
	// 			UserFriendlyAppliedScopeType: to.Ptr("ManagementGroup"),
	// 			Utilization: &armbilling.Utilization{
