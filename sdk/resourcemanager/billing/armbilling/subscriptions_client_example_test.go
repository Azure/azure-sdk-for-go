...
func ExampleSubscriptionsClient_GetByBillingProfile() {
	...
	// 				CancellationAllowedEndDate: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2023-01-05T22:39:34.2606750Z"); return t}()),
	// 			},
	// 		},
	// 	},
	// }
...
func ExampleSubscriptionsClient_NewListByEnrollmentAccountPager() {
	...
	for pager.More() {
		...
		// 						EnrollmentAccountStartDate: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2023-01-04T00:00:00.0000000Z"); return t}()),
		// 					},
		// 					OfferID: to.Ptr("MS-AZR-0017P"),
