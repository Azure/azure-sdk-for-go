...
// Generated from example definition: 2024-04-01/billingSubscriptionsCancel.json
...
// Generated from example definition: 2024-04-01/billingSubscriptionsDelete.json
...
// Generated from example definition: 2024-04-01/billingSubscriptionsGet.json
func ExampleSubscriptionsClient_Get() {
	...
	res, err := clientFactory.NewSubscriptionsClient().Get(ctx, "00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31", "11111111-1111-1111-1111-111111111111", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	...
	// res = armbilling.SubscriptionsClientGetResponse{
	// 	Subscription: armbilling.Subscription{
	...
	// 			PurchaseDate: to.Ptr(time.Date(2023, time.January, 4, 22, 39, 34, 260675000, time.UTC)),
	...
	// 				CancellationAllowedEndDate: to.Ptr(time.Date(2023, time.February, 1, 22, 39, 34, 260675000, time.UTC)),
	// 			},
	// 			TermDuration: to.Ptr("P1M"),
	// 			TermEndDate: to.Ptr(time.Date(2023, time.February, 5, 22, 39, 34, 260675000, time.UTC)),
	// 			TermStartDate: to.Ptr(time.Date(2023, time.January, 5, 22, 39, 34, 260675000, time.UTC)),
	// 		},
...
// Generated from example definition: 2024-04-01/billingSubscriptionGetByBillingProfile.json
func ExampleSubscriptionsClient_GetByBillingProfile() {
	...
	res, err := clientFactory.NewSubscriptionsClient().GetByBillingProfile(ctx, "pcn.94077792", "6478903", "6b96d3f2-9008-4a9d-912f-f87744185aa3", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armbilling.SubscriptionsClientGetByBillingProfileResponse{
	// 	Subscription: armbilling.Subscription{
	...
	// 				CancellationAllowedEndDate: to.Ptr(time.Date(2023, time.January, 5, 22, 39, 34, 260675000, time.UTC)),
	// 			},
	// 		},
	// 	},
	// }
...
// Generated from example definition: 2024-04-01/billingSubscriptionsListByBillingAccount.json
func ExampleSubscriptionsClient_NewListByBillingAccountPager() {
	...
	pager := clientFactory.NewSubscriptionsClient().NewListByBillingAccountPager("00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31", &armbilling.SubscriptionsClientListByBillingAccountOptions{
		IncludeDeleted:             to.Ptr(false),
	...
	for pager.More() {
		...
		// page = armbilling.SubscriptionsClientListByBillingAccountResponse{
		// 	SubscriptionListResult: armbilling.SubscriptionListResult{
		...
		// 					PurchaseDate: to.Ptr(time.Date(2023, time.January, 6, 22, 39, 34, 260675000, time.UTC)),
		// 					Quantity: to.Ptr[int64](1),
		...
		// 					},
		// 					TermDuration: to.Ptr("P1M"),
		// 					TermEndDate: to.Ptr(time.Date(2023, time.February, 7, 22, 39, 34, 260675000, time.UTC)),
		// 					TermStartDate: to.Ptr(time.Date(2023, time.January, 7, 22, 39, 34, 260675000, time.UTC)),
		// 				},
		// 				SystemData: &armbilling.SystemData{
		// 					CreatedAt: to.Ptr(time.Date(2023, time.January, 6, 22, 39, 34, 260675000, time.UTC)),
		// 					LastModifiedAt: to.Ptr(time.Date(2023, time.January, 7, 22, 39, 34, 260675000, time.UTC)),
		// 				},
		// 			},
		// 			{
		...
		// 					PurchaseDate: to.Ptr(time.Date(2023, time.January, 5, 22, 39, 34, 260675000, time.UTC)),
		// 					Quantity: to.Ptr[int64](1),
		...
		// 						{
		// 							EffectiveDate: to.Ptr(time.Date(2023, time.January, 15, 22, 39, 34, 260675000, time.UTC)),
		...
		// 				},
		// 				SystemData: &armbilling.SystemData{
		// 					CreatedAt: to.Ptr(time.Date(2023, time.January, 5, 22, 39, 34, 260675000, time.UTC)),
		// 					LastModifiedAt: to.Ptr(time.Date(2023, time.January, 25, 22, 39, 34, 260675000, time.UTC)),
		// 				},
		// 			},
		// 		},
		// 	},
...
// Generated from example definition: 2024-04-01/billingSubscriptionsListByBillingProfileEA.json
func ExampleSubscriptionsClient_NewListByBillingProfilePager_billingSubscriptionsListByBillingProfileEa() {
	...
	pager := clientFactory.NewSubscriptionsClient().NewListByBillingProfilePager("pcn.94077792", "6478903", nil)
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armbilling.SubscriptionsClientListByBillingProfileResponse{
		// 	SubscriptionListResult: armbilling.SubscriptionListResult{
		// 		Value: []*armbilling.Subscription{
		// 			{
		// 				Name: to.Ptr("6b96d3f2-9008-4a9d-912f-f87744185aa3"),
...
// Generated from example definition: 2024-04-01/billingSubscriptionsListByBillingProfileMCA.json
func ExampleSubscriptionsClient_NewListByBillingProfilePager_billingSubscriptionsListByBillingProfileMca() {
	...
	pager := clientFactory.NewSubscriptionsClient().NewListByBillingProfilePager("a1a9c77e-4cec-4a6c-a089-867d973a6074:a80d3b1f-c626-4e5e-82ed-1173bd91c838_2019-05-31", "ea36e548-1505-41db-bebc-46fff3d37998", nil)
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
...
// Generated from example definition: 2024-04-01/billingSubscriptionsListByCustomer.json
func ExampleSubscriptionsClient_NewListByCustomerPager() {
	...
	pager := clientFactory.NewSubscriptionsClient().NewListByCustomerPager("a1a9c77e-4cec-4a6c-a089-867d973a6074:a80d3b1f-c626-4e5e-82ed-1173bd91c838_2019-05-31", "ea36e548-1505-41db-bebc-46fff3d37998", "Q7GV-UUVA-PJA-TGB", nil)
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armbilling.SubscriptionsClientListByCustomerResponse{
		// 	SubscriptionListResult: armbilling.SubscriptionListResult{
		// 		Value: []*armbilling.Subscription{
		// 			{
		// 				Name: to.Ptr("6b96d3f2-9008-4a9d-912f-f87744185aa3"),
...
// Generated from example definition: 2024-04-01/billingSubscriptionsListByCustomerAtBillingAccount.json
func ExampleSubscriptionsClient_NewListByCustomerAtBillingAccountPager() {
	...
	pager := clientFactory.NewSubscriptionsClient().NewListByCustomerAtBillingAccountPager("a1a9c77e-4cec-4a6c-a089-867d973a6074:a80d3b1f-c626-4e5e-82ed-1173bd91c838_2019-05-31", "Q7GV-UUVA-PJA-TGB", nil)
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armbilling.SubscriptionsClientListByCustomerAtBillingAccountResponse{
		// 	SubscriptionListResult: armbilling.SubscriptionListResult{
		// 		Value: []*armbilling.Subscription{
		// 			{
		// 				Name: to.Ptr("6b96d3f2-9008-4a9d-912f-f87744185aa3"),
...
// Generated from example definition: 2024-04-01/billingSubscriptionsListByEnrollmentAccount.json
func ExampleSubscriptionsClient_NewListByEnrollmentAccountPager() {
	...
	pager := clientFactory.NewSubscriptionsClient().NewListByEnrollmentAccountPager("6564892", "172988", nil)
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armbilling.SubscriptionsClientListByEnrollmentAccountResponse{
		// 	SubscriptionListResult: armbilling.SubscriptionListResult{
		// 		Value: []*armbilling.Subscription{
		// 			{
		// 				Name: to.Ptr("90000000-0000-0000-0000-000000000000"),
		...
		// 						EnrollmentAccountStartDate: to.Ptr(time.Date(2023, time.January, 4, 0, 0, 0, 0, time.UTC)),
		// 					},
		// 					OfferID: to.Ptr("MS-AZR-0017P"),
...
// Generated from example definition: 2024-04-01/billingSubscriptionsListByInvoiceSection.json
func ExampleSubscriptionsClient_NewListByInvoiceSectionPager() {
	...
	pager := clientFactory.NewSubscriptionsClient().NewListByInvoiceSectionPager("a1a9c77e-4cec-4a6c-a089-867d973a6074:a80d3b1f-c626-4e5e-82ed-1173bd91c838_2019-05-31", "ea36e548-1505-41db-bebc-46fff3d37998", "Q7GV-UUVA-PJA-TGB", nil)
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armbilling.SubscriptionsClientListByInvoiceSectionResponse{
		// 	SubscriptionListResult: armbilling.SubscriptionListResult{
		// 		Value: []*armbilling.Subscription{
		// 			{
		// 				Name: to.Ptr("6b96d3f2-9008-4a9d-912f-f87744185aa3"),
...
// Generated from example definition: 2024-04-01/billingSubscriptionsMerge.json
func ExampleSubscriptionsClient_BeginMerge() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armbilling.SubscriptionsClientMergeResponse{
	// 	Subscription: armbilling.Subscription{
...
// Generated from example definition: 2024-04-01/billingSubscriptionMove.json
func ExampleSubscriptionsClient_BeginMove() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armbilling.SubscriptionsClientMoveResponse{
	// 	Subscription: armbilling.Subscription{
	// 		Name: to.Ptr("6b96d3f2-9008-4a9d-912f-f87744185aa3"),
	// 		Type: to.Ptr("Microsoft.Billing/billingAccounts/billingSubscriptions"),
	// 		ID: to.Ptr("/providers/Microsoft.Billing/billingAccounts/a1a9c77e-4cec-4a6c-a089-867d973a6074:a80d3b1f-c626-4e5e-82ed-1173bd91c838_2019-05-31/billingSubscriptions/6b96d3f2-9008-4a9d-912f-f87744185aa3"),
...
// Generated from example definition: 2024-04-01/billingSubscriptionsSplit.json
func ExampleSubscriptionsClient_BeginSplit() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armbilling.SubscriptionsClientSplitResponse{
	// 	Subscription: armbilling.Subscription{
...
// Generated from example definition: 2024-04-01/billingSubscriptionsUpdate.json
func ExampleSubscriptionsClient_BeginUpdate() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armbilling.SubscriptionsClientUpdateResponse{
	// 	Subscription: armbilling.Subscription{
	// 		Name: to.Ptr("11111111-1111-1111-1111-111111111111"),
	// 		Type: to.Ptr("Microsoft.Billing/billingAccounts/billingSubscriptions"),
	// 		ID: to.Ptr("/providers/Microsoft.Billing/billingAccounts/00000000-0000-0000-0000-000000000000:00000000-0000-0000-0000-000000000000_2019-05-31/billingSubscriptions/11111111-1111-1111-1111-111111111111"),
...
// Generated from example definition: 2024-04-01/billingSubscriptionValidateMoveFailure.json
func ExampleSubscriptionsClient_ValidateMoveEligibility_billingSubscriptionValidateMoveFailure() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armbilling.SubscriptionsClientValidateMoveEligibilityResponse{
	// 	MoveBillingSubscriptionEligibilityResult: armbilling.MoveBillingSubscriptionEligibilityResult{
...
// Generated from example definition: 2024-04-01/billingSubscriptionValidateMoveSuccess.json
