...
func (client *TransactionsClient) GetTransactionSummaryByInvoice(ctx context.Context, billingAccountName string, invoiceName string, options *TransactionsClientGetTransactionSummaryByInvoiceOptions) (TransactionsClientGetTransactionSummaryByInvoiceResponse, error) {
	...
	return client.getTransactionSummaryByInvoiceHandleResponse(httpResp, http.StatusOK)
}
...
func (client *TransactionsClient) getTransactionSummaryByInvoiceHandleResponse(resp *http.Response, successCodes ...int) (TransactionsClientGetTransactionSummaryByInvoiceResponse, error) {
...
// date. Transactions include purchases, refunds and Azure usage charges. Unbilled transactions are listed under pending invoice
...
func (client *TransactionsClient) NewListByBillingProfilePager(billingAccountName string, billingProfileName string, periodStartDate time.Time, periodEndDate time.Time, typeParam TransactionType, options *TransactionsClientListByBillingProfileOptions) *runtime.Pager[TransactionsClientListByBillingProfileResponse] {
	return runtime.NewPager(runtime.PagingHandler[TransactionsClientListByBillingProfileResponse]{
		...
		Fetcher: func(ctx context.Context, page *TransactionsClientListByBillingProfileResponse) (TransactionsClientListByBillingProfileResponse, error) {
			...
			req, err := client.listByBillingProfileCreateRequest(ctx, billingAccountName, billingProfileName, periodStartDate, periodEndDate, typeParam, nextLink, options)
			if err != nil {
...
func (client *TransactionsClient) listByBillingProfileCreateRequest(ctx context.Context, billingAccountName string, billingProfileName string, periodStartDate time.Time, periodEndDate time.Time, typeParam TransactionType, nextLink string, options *TransactionsClientListByBillingProfileOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
	...
	if firstPage {
		...
		reqQP.Set("periodEndDate", datetime.PlainDate(periodEndDate).String())
		reqQP.Set("periodStartDate", datetime.PlainDate(periodStartDate).String())
		if options != nil && options.Search != nil {
			reqQP.Set("search", *options.Search)
		}
...
func (client *TransactionsClient) listByBillingProfileHandleResponse(resp *http.Response, successCodes ...int) (TransactionsClientListByBillingProfileResponse, error) {
...
// include purchases, refunds and Azure usage charges. Unbilled transactions are listed under pending invoice Id and do not
...
func (client *TransactionsClient) NewListByCustomerPager(billingAccountName string, billingProfileName string, customerName string, periodStartDate time.Time, periodEndDate time.Time, typeParam TransactionType, options *TransactionsClientListByCustomerOptions) *runtime.Pager[TransactionsClientListByCustomerResponse] {
	return runtime.NewPager(runtime.PagingHandler[TransactionsClientListByCustomerResponse]{
		...
		Fetcher: func(ctx context.Context, page *TransactionsClientListByCustomerResponse) (TransactionsClientListByCustomerResponse, error) {
			...
			req, err := client.listByCustomerCreateRequest(ctx, billingAccountName, billingProfileName, customerName, periodStartDate, periodEndDate, typeParam, nextLink, options)
			if err != nil {
...
func (client *TransactionsClient) listByCustomerCreateRequest(ctx context.Context, billingAccountName string, billingProfileName string, customerName string, periodStartDate time.Time, periodEndDate time.Time, typeParam TransactionType, nextLink string, options *TransactionsClientListByCustomerOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
	var req *policy.Request
	var err error
	if firstPage {
...
func (client *TransactionsClient) listByCustomerHandleResponse(resp *http.Response, successCodes ...int) (TransactionsClientListByCustomerResponse, error) {
...
func (client *TransactionsClient) NewListByInvoicePager(billingAccountName string, invoiceName string, options *TransactionsClientListByInvoiceOptions) *runtime.Pager[TransactionsClientListByInvoiceResponse] {
	return runtime.NewPager(runtime.PagingHandler[TransactionsClientListByInvoiceResponse]{
		...
		Fetcher: func(ctx context.Context, page *TransactionsClientListByInvoiceResponse) (TransactionsClientListByInvoiceResponse, error) {
			...
			req, err := client.listByInvoiceCreateRequest(ctx, billingAccountName, invoiceName, nextLink, options)
			if err != nil {
			...
			return client.listByInvoiceHandleResponse(resp, http.StatusOK)
		},
		Tracer: client.internal.Tracer(),
	})
}
...
func (client *TransactionsClient) listByInvoiceCreateRequest(ctx context.Context, billingAccountName string, invoiceName string, nextLink string, options *TransactionsClientListByInvoiceOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
	var req *policy.Request
	var err error
	if firstPage {
...
func (client *TransactionsClient) listByInvoiceHandleResponse(resp *http.Response, successCodes ...int) (TransactionsClientListByInvoiceResponse, error) {
...
// end date. Transactions include purchases, refunds and Azure usage charges. Unbilled transactions are listed under pending
// invoice Id and do not include tax. Tax is added to the amount once an invoice is generated.
//   - billingAccountName - The ID that uniquely identifies a billing account.
//   - billingProfileName - The ID that uniquely identifies a billing profile.
...
func (client *TransactionsClient) NewListByInvoiceSectionPager(billingAccountName string, billingProfileName string, invoiceSectionName string, periodStartDate time.Time, periodEndDate time.Time, typeParam TransactionType, options *TransactionsClientListByInvoiceSectionOptions) *runtime.Pager[TransactionsClientListByInvoiceSectionResponse] {
	return runtime.NewPager(runtime.PagingHandler[TransactionsClientListByInvoiceSectionResponse]{
		...
		Fetcher: func(ctx context.Context, page *TransactionsClientListByInvoiceSectionResponse) (TransactionsClientListByInvoiceSectionResponse, error) {
			...
			req, err := client.listByInvoiceSectionCreateRequest(ctx, billingAccountName, billingProfileName, invoiceSectionName, periodStartDate, periodEndDate, typeParam, nextLink, options)
			if err != nil {
...
func (client *TransactionsClient) listByInvoiceSectionCreateRequest(ctx context.Context, billingAccountName string, billingProfileName string, invoiceSectionName string, periodStartDate time.Time, periodEndDate time.Time, typeParam TransactionType, nextLink string, options *TransactionsClientListByInvoiceSectionOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
	var req *policy.Request
	var err error
	if firstPage {
...
func (client *TransactionsClient) listByInvoiceSectionHandleResponse(resp *http.Response, successCodes ...int) (TransactionsClientListByInvoiceSectionResponse, error) {
