...
- New function `NewBenefitClient(credential azcore.TokenCredential, options *arm.ClientOptions) (*BenefitClient, error)`
- New function `*BenefitClient.Validate(ctx context.Context, body BenefitValidateRequest, options *BenefitClientValidateOptions) (BenefitClientValidateResponse, error)`
...
- New function `*ClientFactory.NewBenefitClient() *BenefitClient`
- New function `*ClientFactory.NewConditionalCreditContributorsClient() *ConditionalCreditContributorsClient`
- New function `*ClientFactory.NewConditionalCreditsClient() *ConditionalCreditsClient`
- New function `*ClientFactory.NewContributorsClient() *ContributorsClient`
...
- New function `*ClientFactory.NewFreeServicesClient() *FreeServicesClient`
- New function `*ClientFactory.NewMaccsClient() *MaccsClient`
- New function `*ClientFactory.NewSellerResourceClient() *SellerResourceClient`
- New function `*ClientFactory.NewSourcesClient() *SourcesClient`
