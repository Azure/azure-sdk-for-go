...
// PricingCurrencyDuration - Represents either billing plan or savings plan term in ISO 8601 format.
type PricingCurrencyDuration string

const (
	PricingCurrencyDurationP1M PricingCurrencyDuration = "P1M"
	PricingCurrencyDurationP1Y PricingCurrencyDuration = "P1Y"
	PricingCurrencyDurationP3Y PricingCurrencyDuration = "P3Y"
)

// PossiblePricingCurrencyDurationValues returns the possible values for the PricingCurrencyDuration const type.
func PossiblePricingCurrencyDurationValues() []PricingCurrencyDuration {
	return []PricingCurrencyDuration{	
		PricingCurrencyDurationP1M,
		PricingCurrencyDurationP1Y,
		PricingCurrencyDurationP3Y,
	}
}
