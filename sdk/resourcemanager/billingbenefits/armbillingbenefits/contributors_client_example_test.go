...
func ExampleContributorsClient_NewListFromApplicableMaccPager() {
	...
	pager := clientFactory.NewContributorsClient("00000000-0000-0000-0000-000000000000").NewListFromApplicableMaccPager("20000000-1000-0000-0000-000000000000:20000000-0000-3000-0000-000000000000_2019-05-31", "13810867107109237", nil)
	for pager.More() {
