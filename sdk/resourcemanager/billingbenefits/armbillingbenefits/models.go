...
type CreditReason struct {
	// READ-ONLY; The reason code for credit.
	Code *float32

	// READ-ONLY; The free string description of the credit.
	Description *string
}
...
// FreeServices - The Free Services API includes operations for creating and managing free services.
...
type FreeServicesProperties struct {
	...
	// practical purposes, this can be ignored. For current status of Free Services resource,
	// refer to FreeServicesStatus.
...
type MaccModelProperties struct {
	...
	// Format must be Azure Resource ID:
