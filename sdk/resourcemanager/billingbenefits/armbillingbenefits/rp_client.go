...
func (client *RPClient) Validate(ctx context.Context, body BenefitValidateRequest, options *RPClientValidateOptions) (RPClientValidateResponse, error) {
	var err error
	const operationName = "RPClient.Validate"
...
func (client *RPClient) validateCreateRequest(ctx context.Context, body BenefitValidateRequest, _ *RPClientValidateOptions) (*policy.Request, error) {
