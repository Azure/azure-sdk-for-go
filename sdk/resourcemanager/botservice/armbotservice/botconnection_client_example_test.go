...
func ExampleBotConnectionClient_Delete() {
	...
	res, err := clientFactory.NewBotConnectionClient().Delete(ctx, "OneResourceGroupName", "samplebotname", "sampleConnection", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armbotservice.BotConnectionClientDeleteResponse{
	// }
}
...
func ExampleBotConnectionClient_Get() {
	...
	res, err := clientFactory.NewBotConnectionClient().Get(ctx, "OneResourceGroupName", "samplebotname", "sampleConnection", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
...
func ExampleBotConnectionClient_NewListByBotServicePager() {
	...
	for pager.More() {
		...
		// page = armbotservice.BotConnectionClientListByBotServiceResponse{
...
// Generated from example definition: 2023-09-15-preview/GetConnectionListWithSecrets.json
