...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "BotConnectionClient":
		initServer(&s.trMu, &s.trBotConnectionServer, func() *BotConnectionServerTransport {
			return NewBotConnectionServerTransport(&s.srv.BotConnectionServer)
		})
		resp, err = s.trBotConnectionServer.Do(req)
	case "BotsClient":
		initServer(&s.trMu, &s.trBotsServer, func() *BotsServerTransport { return NewBotsServerTransport(&s.srv.BotsServer) })
		resp, err = s.trBotsServer.Do(req)
	case "ChannelsClient":
		initServer(&s.trMu, &s.trChannelsServer, func() *ChannelsServerTransport { return NewChannelsServerTransport(&s.srv.ChannelsServer) })
		resp, err = s.trChannelsServer.Do(req)
	case "DirectLineClient":
		initServer(&s.trMu, &s.trDirectLineServer, func() *DirectLineServerTransport { return NewDirectLineServerTransport(&s.srv.DirectLineServer) })
		resp, err = s.trDirectLineServer.Do(req)
	case "EmailClient":
		initServer(&s.trMu, &s.trEmailServer, func() *EmailServerTransport { return NewEmailServerTransport(&s.srv.EmailServer) })
		resp, err = s.trEmailServer.Do(req)
	case "HostSettingsClient":
		initServer(&s.trMu, &s.trHostSettingsServer, func() *HostSettingsServerTransport { return NewHostSettingsServerTransport(&s.srv.HostSettingsServer) })
	...
	case "QnAMakerEndpointKeysClient":
		initServer(&s.trMu, &s.trQnAMakerEndpointKeysServer, func() *QnAMakerEndpointKeysServerTransport {
