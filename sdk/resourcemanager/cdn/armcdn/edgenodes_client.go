...
func (client *EdgeNodesClient) listCreateRequest(ctx context.Context, nextLink string, _ *EdgeNodesClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *EdgeNodesClient) listHandleResponse(resp *http.Response, successCodes ...int) (EdgeNodesClientListResponse, error) {
