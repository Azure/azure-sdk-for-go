...
func (client *ManagedRuleSetsClient) listCreateRequest(ctx context.Context, nextLink string, _ *ManagedRuleSetsClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *ManagedRuleSetsClient) listHandleResponse(resp *http.Response, successCodes ...int) (ManagedRuleSetsClientListResponse, error) {
