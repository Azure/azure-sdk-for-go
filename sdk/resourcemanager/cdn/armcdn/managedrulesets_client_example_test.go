...
// Generated from example definition: 2026-07-01/WafListManagedRuleSets.json
func ExampleManagedRuleSetsClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armcdn.ManagedRuleSetsClientListResponse{
		// 	ManagedRuleSetDefinitionList: armcdn.ManagedRuleSetDefinitionList{
		...
		// 				ID: to.Ptr("/subscriptions/subid/providers/Microsoft.Cdn/CdnWebApplicationFirewallManagedRuleSets/DefaultRuleSet_1.0"),
