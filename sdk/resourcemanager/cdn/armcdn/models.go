...
type CanMigrateResult struct {
	...
	Errors *MigrationErrorsListResponse `json:"errors,omitempty" azure:"ro"`
}
...
// MigrationErrorsListResponse - Error response indicates CDN service is not able to process the incoming request. The reason
// is provided in the error message.
type MigrationErrorsListResponse struct {
...
// ProfilesClientCanMigrateOptions contains the optional parameters for the ProfilesClient.CanMigrate method.
type ProfilesClientCanMigrateOptions struct {
	// placeholder for future optional parameters
}
