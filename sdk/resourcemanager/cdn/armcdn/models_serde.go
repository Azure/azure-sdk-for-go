...
func (a AFDDomainHTTPSParameters) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "serverTlsGroupPolicy", a.ServerTLSGroupPolicy)
	populate(objectMap, "serverTlsGroups", a.ServerTLSGroups)
	return json.Marshal(objectMap)
}
...
func (a *AFDDomainHTTPSParameters) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "secret":
			...
			delete(rawMsg, key)
		case "serverTlsGroupPolicy":
			err = unpopulate(val, "ServerTLSGroupPolicy", &a.ServerTLSGroupPolicy)
			delete(rawMsg, key)
		case "serverTlsGroups":
			err = unpopulate(val, "ServerTLSGroups", &a.ServerTLSGroups)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %s", a, err.Error())
...
func (a AFDOriginProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "certificateNameCheckValidationMode", a.CertificateNameCheckValidationMode)
	populate(objectMap, "customCertificateSubjects", a.CustomCertificateSubjects)
	populate(objectMap, "deploymentStatus", a.DeploymentStatus)
	populate(objectMap, "enabledState", a.EnabledState)
...
func (a *AFDOriginProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "azureOrigin":
			...
			delete(rawMsg, key)
		case "certificateNameCheckValidationMode":
			err = unpopulate(val, "CertificateNameCheckValidationMode", &a.CertificateNameCheckValidationMode)
			delete(rawMsg, key)
		case "customCertificateSubjects":
			err = unpopulate(val, "CustomCertificateSubjects", &a.CustomCertificateSubjects)
			delete(rawMsg, key)
		case "deploymentStatus":
			err = unpopulate(val, "DeploymentStatus", &a.DeploymentStatus)
			delete(rawMsg, key)
...
// MarshalJSON implements the json.Marshaller interface for type BatchRuleProperties.
func (b BatchRuleProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "actions", b.Actions)
	populate(objectMap, "conditions", b.Conditions)
	populate(objectMap, "matchProcessingBehavior", b.MatchProcessingBehavior)
	populate(objectMap, "order", b.Order)
	populate(objectMap, "ruleName", b.RuleName)
	populate(objectMap, "ruleSetName", b.RuleSetName)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type BatchRuleProperties.
func (b *BatchRuleProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "actions":
			b.Actions, err = unmarshalDeliveryRuleActionClassificationArray(val)
			delete(rawMsg, key)
		case "conditions":
			b.Conditions, err = unmarshalDeliveryRuleConditionClassificationArray(val)
			delete(rawMsg, key)
		case "matchProcessingBehavior":
			err = unpopulate(val, "MatchProcessingBehavior", &b.MatchProcessingBehavior)
			delete(rawMsg, key)
		case "order":
			err = unpopulate(val, "Order", &b.Order)
			delete(rawMsg, key)
		case "ruleName":
			err = unpopulate(val, "RuleName", &b.RuleName)
			delete(rawMsg, key)
		case "ruleSetName":
			err = unpopulate(val, "RuleSetName", &b.RuleSetName)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %s", b, err.Error())
...
func (c Components18OrqelSchemasWafmetricsresponsePropertiesSeriesItemsPropertiesDataItems) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateTime[datetime.RFC3339](objectMap, "dateTime", c.DateTime, true)
...
func (m MetricsResponse) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateTime[datetime.RFC3339](objectMap, "dateTimeBegin", m.DateTimeBegin, true)
	populateTime[datetime.RFC3339](objectMap, "dateTimeEnd", m.DateTimeEnd, true)
...
func (o OriginAuthenticationProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "tokenDestinationHeader", o.TokenDestinationHeader)
	populate(objectMap, "type", o.Type)
...
func (o *OriginAuthenticationProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "scope":
			...
			delete(rawMsg, key)
		case "tokenDestinationHeader":
			err = unpopulate(val, "TokenDestinationHeader", &o.TokenDestinationHeader)
			delete(rawMsg, key)
		case "type":
			err = unpopulate(val, "Type", &o.Type)
			delete(rawMsg, key)
...
func (r RankingsResponse) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateTime[datetime.RFC3339](objectMap, "dateTimeBegin", r.DateTimeBegin, true)
	populateTime[datetime.RFC3339](objectMap, "dateTimeEnd", r.DateTimeEnd, true)
...
func (r RuleSetProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "batchMode", r.BatchMode)
	populate(objectMap, "deploymentStatus", r.DeploymentStatus)
...
func (r *RuleSetProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "batchMode":
			err = unpopulate(val, "BatchMode", &r.BatchMode)
			delete(rawMsg, key)
		case "deploymentStatus":
			err = unpopulate(val, "DeploymentStatus", &r.DeploymentStatus)
			delete(rawMsg, key)
...
func (s SecurityPolicyWebApplicationFirewallAssociation) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "routes", s.Routes)
	return json.Marshal(objectMap)
}
...
func (s *SecurityPolicyWebApplicationFirewallAssociation) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "patternsToMatch":
			...
			delete(rawMsg, key)
		case "routes":
			err = unpopulate(val, "Routes", &s.Routes)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %s", s, err.Error())
...
func (s SecurityPolicyWebApplicationFirewallParameters) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "isProfileLevel", s.IsProfileLevel)
...
func (s *SecurityPolicyWebApplicationFirewallParameters) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "associations":
			...
			delete(rawMsg, key)
		case "isProfileLevel":
			err = unpopulate(val, "IsProfileLevel", &s.IsProfileLevel)
			delete(rawMsg, key)
		case "type":
			err = unpopulate(val, "Type", &s.Type)
			delete(rawMsg, key)
...
func (w WafMetricsResponse) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateTime[datetime.RFC3339](objectMap, "dateTimeBegin", w.DateTimeBegin, true)
	populateTime[datetime.RFC3339](objectMap, "dateTimeEnd", w.DateTimeEnd, true)
