...
func (client *OriginGroupsClient) getHandleResponse(resp *http.Response, successCodes ...int) (OriginGroupsClientGetResponse, error) {
...
func (client *OriginGroupsClient) listByEndpointCreateRequest(ctx context.Context, resourceGroupName string, profileName string, endpointName string, nextLink string, _ *OriginGroupsClientListByEndpointOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *OriginGroupsClient) listByEndpointHandleResponse(resp *http.Response, successCodes ...int) (OriginGroupsClientListByEndpointResponse, error) {
