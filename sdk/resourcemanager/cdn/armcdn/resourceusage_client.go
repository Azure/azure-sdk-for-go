...
func (client *ResourceUsageClient) listCreateRequest(ctx context.Context, nextLink string, _ *ResourceUsageClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *ResourceUsageClient) listHandleResponse(resp *http.Response, successCodes ...int) (ResourceUsageClientListResponse, error) {
