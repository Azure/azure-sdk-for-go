...
// ProfilesClientMigrateResponse contains the response from method ProfilesClient.Migrate.
type ProfilesClientMigrateResponse struct {
	MigrateResult
}

// ProfilesClientMigrationCommitResponse contains the response from method ProfilesClient.MigrationCommit.
