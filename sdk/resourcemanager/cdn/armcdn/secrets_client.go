...
func (client *SecretsClient) listByProfileCreateRequest(ctx context.Context, resourceGroupName string, profileName string, nextLink string, _ *SecretsClientListByProfileOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *SecretsClient) listByProfileHandleResponse(resp *http.Response, successCodes ...int) (SecretsClientListByProfileResponse, error) {
