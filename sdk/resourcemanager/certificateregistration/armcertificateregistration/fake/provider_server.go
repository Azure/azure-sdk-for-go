...
// ProviderServer is a fake server for instances of the armcertificateregistration.ProviderClient type.
type ProviderServer struct {
	// NewListOperationsPager is the fake for method ProviderClient.NewListOperationsPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListOperationsPager func(options *armcertificateregistration.ProviderClientListOperationsOptions) (resp azfake.PagerResponder[armcertificateregistration.ProviderClientListOperationsResponse])
}

// NewProviderServerTransport creates a new instance of ProviderServerTransport with the provided implementation.
// The returned ProviderServerTransport instance is connected to an instance of armcertificateregistration.ProviderClient via the
// azcore.ClientOptions.Transporter field in the client's constructor parameters.
func NewProviderServerTransport(srv *ProviderServer) *ProviderServerTransport {
	return &ProviderServerTransport{
		srv:                    srv,
		newListOperationsPager: newTracker[azfake.PagerResponder[armcertificateregistration.ProviderClientListOperationsResponse]](),
	}
}

// ProviderServerTransport connects instances of armcertificateregistration.ProviderClient to instances of ProviderServer.
// Don't use this type directly, use NewProviderServerTransport instead.
type ProviderServerTransport struct {
	srv                    *ProviderServer
	newListOperationsPager *tracker[azfake.PagerResponder[armcertificateregistration.ProviderClientListOperationsResponse]]
}
...
func (p *ProviderServerTransport) dispatchNewListOperationsPager(req *http.Request) (*http.Response, error) {
	...
	if newListOperationsPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListOperationsPager, req, func(page *armcertificateregistration.ProviderClientListOperationsResponse, createLink func() string) {
