...
func (a AppServiceCertificateOrderPatchResourceProperties) MarshalJSON() ([]byte, error) {
	...
	populateDateTimeRFC3339(objectMap, "lastCertificateIssuanceTime", a.LastCertificateIssuanceTime)
	populateDateTimeRFC3339(objectMap, "nextAutoRenewalTimeStamp", a.NextAutoRenewalTimeStamp)
...
func (a *AppServiceCertificateOrderPatchResourceProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "lastCertificateIssuanceTime":
			err = unpopulateDateTimeRFC3339(val, "LastCertificateIssuanceTime", &a.LastCertificateIssuanceTime)
			delete(rawMsg, key)
		case "nextAutoRenewalTimeStamp":
			err = unpopulateDateTimeRFC3339(val, "NextAutoRenewalTimeStamp", &a.NextAutoRenewalTimeStamp)
			delete(rawMsg, key)
		case "productType":
