...
func (a AppServiceCertificateOrderPatchResourceProperties) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "lastCertificateIssuanceTime", a.LastCertificateIssuanceTime, true)
	populateTime[datetime.RFC3339](objectMap, "nextAutoRenewalTimeStamp", a.NextAutoRenewalTimeStamp, true)
...
func (c CertificateDetails) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "notAfter", c.NotAfter, true)
	populateTime[datetime.RFC3339](objectMap, "notBefore", c.NotBefore, true)
