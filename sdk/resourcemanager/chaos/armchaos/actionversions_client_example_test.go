...
func ExampleActionVersionsClient_Get() {
	...
	res, err := clientFactory.NewActionVersionsClient().Get(ctx, "westus2", "microsoft-compute-shutdown", "1.0", nil)
	if err != nil {
	...
	// res = armchaos.ActionVersionsClientGetResponse{
	// 	ActionVersion: armchaos.ActionVersion{
	// 		Name: to.Ptr("1.0"),
	// 		Type: to.Ptr("Microsoft.Chaos/locations/actions/versions"),
	// 		ID: to.Ptr("/subscriptions/6b052e15-03d3-4f17-b2e1-be7f07588291/providers/Microsoft.Chaos/locations/westus2/actions/microsoft-compute-shutdown/versions/1.0"),
...
func ExampleActionVersionsClient_NewListPager() {
	...
	pager := clientFactory.NewActionVersionsClient().NewListPager("westus2", "microsoft-compute-shutdown", nil)
	for pager.More() {
