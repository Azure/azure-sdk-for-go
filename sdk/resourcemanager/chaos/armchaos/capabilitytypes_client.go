...
func (client *CapabilityTypesClient) getHandleResponse(resp *http.Response, successCodes ...int) (CapabilityTypesClientGetResponse, error) {
...
func (client *CapabilityTypesClient) NewListPager(location string, targetTypeName string, options *CapabilityTypesClientListOptions) *runtime.Pager[CapabilityTypesClientListResponse] {
	return runtime.NewPager(runtime.PagingHandler[CapabilityTypesClientListResponse]{
		...
		Fetcher: func(ctx context.Context, page *CapabilityTypesClientListResponse) (CapabilityTypesClientListResponse, error) {
			...
			req, err := client.listCreateRequest(ctx, location, targetTypeName, nextLink, options)
			if err != nil {
...
func (client *CapabilityTypesClient) listCreateRequest(ctx context.Context, location string, targetTypeName string, nextLink string, options *CapabilityTypesClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *CapabilityTypesClient) listHandleResponse(resp *http.Response, successCodes ...int) (CapabilityTypesClientListResponse, error) {
