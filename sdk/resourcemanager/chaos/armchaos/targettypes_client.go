...
func (client *TargetTypesClient) getHandleResponse(resp *http.Response, successCodes ...int) (TargetTypesClientGetResponse, error) {
...
func (client *TargetTypesClient) listCreateRequest(ctx context.Context, location string, nextLink string, options *TargetTypesClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *TargetTypesClient) listHandleResponse(resp *http.Response, successCodes ...int) (TargetTypesClientListResponse, error) {
