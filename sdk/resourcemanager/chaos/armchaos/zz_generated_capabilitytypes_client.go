...
func NewCapabilityTypesClient(con *arm.Connection, subscriptionID string) *CapabilityTypesClient {
	return &CapabilityTypesClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *CapabilityTypesClient) listHandleResponse(resp *http.Response) (CapabilityTypesListResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.CapabilityTypeListResult); err != nil {
		return CapabilityTypesListResponse{}, err
	}
	return result, nil
}
