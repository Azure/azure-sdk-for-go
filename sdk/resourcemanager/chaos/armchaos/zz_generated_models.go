...
func (e ExperimentExecutionActionTargetDetailsProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "completedDateUtc", (*timeRFC3339)(e.CompletedDateUTC))
	populate(objectMap, "error", e.Error)
	populate(objectMap, "failedDateUtc", (*timeRFC3339)(e.FailedDateUTC))
...
func (e *ExperimentExecutionActionTargetDetailsProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "completedDateUtc":
			...
			e.CompletedDateUTC = (*time.Time)(&aux)
			delete(rawMsg, key)
		case "error":
...
func (e ExperimentExecutionDetailsProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "createdDateUtc", (*timeRFC3339)(e.CreatedDateUTC))
	populate(objectMap, "experimentId", e.ExperimentID)
	populate(objectMap, "failureReason", e.FailureReason)
	populate(objectMap, "lastActionDateUtc", (*timeRFC3339)(e.LastActionDateUTC))
	populate(objectMap, "runInformation", e.RunInformation)
	populate(objectMap, "startDateUtc", (*timeRFC3339)(e.StartDateUTC))
	populate(objectMap, "status", e.Status)
	populate(objectMap, "stopDateUtc", (*timeRFC3339)(e.StopDateUTC))
	return json.Marshal(objectMap)
}
...
func (e *ExperimentExecutionDetailsProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "createdDateUtc":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			e.CreatedDateUTC = (*time.Time)(&aux)
			delete(rawMsg, key)
		case "experimentId":
		...
		case "lastActionDateUtc":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			e.LastActionDateUTC = (*time.Time)(&aux)
			delete(rawMsg, key)
		case "runInformation":
...
func (e ExperimentStatusProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "createdDateUtc", (*timeRFC3339)(e.CreatedDateUTC))
	populate(objectMap, "endDateUtc", (*timeRFC3339)(e.EndDateUTC))
	populate(objectMap, "status", e.Status)
	return json.Marshal(objectMap)
}
