...
func NewTargetsClient(con *arm.Connection, subscriptionID string) *TargetsClient {
	return &TargetsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *TargetsClient) listHandleResponse(resp *http.Response) (TargetsListResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.TargetListResult); err != nil {
		return TargetsListResponse{}, err
	}
	return result, nil
}
