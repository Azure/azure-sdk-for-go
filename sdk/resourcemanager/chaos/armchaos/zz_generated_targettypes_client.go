...
func NewTargetTypesClient(con *arm.Connection, subscriptionID string) *TargetTypesClient {
	return &TargetTypesClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *TargetTypesClient) listHandleResponse(resp *http.Response) (TargetTypesListResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.TargetTypeListResult); err != nil {
		return TargetTypesListResponse{}, err
	}
	return result, nil
}
