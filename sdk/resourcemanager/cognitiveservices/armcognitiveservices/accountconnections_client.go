...
//   - connection - The object for creating or updating a new account connection
//   - options - AccountConnectionsClientCreateOptions contains the optional parameters for the AccountConnectionsClient.Create
//     method.
func (client *AccountConnectionsClient) Create(ctx context.Context, resourceGroupName string, accountName string, connectionName string, connection ConnectionPropertiesV2BasicResource, options *AccountConnectionsClientCreateOptions) (AccountConnectionsClientCreateResponse, error) {
	var err error
	const operationName = "AccountConnectionsClient.Create"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.createCreateRequest(ctx, resourceGroupName, accountName, connectionName, connection, options)
	if err != nil {
...
func (client *AccountConnectionsClient) createCreateRequest(ctx context.Context, resourceGroupName string, accountName string, connectionName string, connection ConnectionPropertiesV2BasicResource, _ *AccountConnectionsClientCreateOptions) (*policy.Request, error) {
...
func (client *AccountConnectionsClient) createHandleResponse(resp *http.Response, successCodes ...int) (AccountConnectionsClientCreateResponse, error) {
...
func (client *AccountConnectionsClient) Delete(ctx context.Context, resourceGroupName string, accountName string, connectionName string, options *AccountConnectionsClientDeleteOptions) (AccountConnectionsClientDeleteResponse, error) {
	...
	if !runtime.HasStatusCode(httpResp, http.StatusOK, http.StatusNoContent) {
		return AccountConnectionsClientDeleteResponse{}, runtime.NewResponseError(httpResp)
	}
...
func (client *AccountConnectionsClient) getHandleResponse(resp *http.Response, successCodes ...int) (AccountConnectionsClientGetResponse, error) {
...
func (client *AccountConnectionsClient) listCreateRequest(ctx context.Context, resourceGroupName string, accountName string, nextLink string, options *AccountConnectionsClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *AccountConnectionsClient) listHandleResponse(resp *http.Response, successCodes ...int) (AccountConnectionsClientListResponse, error) {
...
//   - accountName - The name of Cognitive Services account.
//   - connectionName - Friendly name of the connection
//   - connection - Parameters for account connection update.
//   - options - AccountConnectionsClientUpdateOptions contains the optional parameters for the AccountConnectionsClient.Update
//     method.
func (client *AccountConnectionsClient) Update(ctx context.Context, resourceGroupName string, accountName string, connectionName string, connection ConnectionUpdateContent, options *AccountConnectionsClientUpdateOptions) (AccountConnectionsClientUpdateResponse, error) {
	var err error
	const operationName = "AccountConnectionsClient.Update"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.updateCreateRequest(ctx, resourceGroupName, accountName, connectionName, connection, options)
	if err != nil {
...
func (client *AccountConnectionsClient) updateCreateRequest(ctx context.Context, resourceGroupName string, accountName string, connectionName string, connection ConnectionUpdateContent, _ *AccountConnectionsClientUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.CognitiveServices/accounts/{accountName}/connections/{connectionName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *AccountConnectionsClient) updateHandleResponse(resp *http.Response, successCodes ...int) (AccountConnectionsClientUpdateResponse, error) {
