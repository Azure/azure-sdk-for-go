...
func (client *CommitmentTiersClient) listCreateRequest(ctx context.Context, location string, nextLink string, _ *CommitmentTiersClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *CommitmentTiersClient) listHandleResponse(resp *http.Response, successCodes ...int) (CommitmentTiersClientListResponse, error) {
