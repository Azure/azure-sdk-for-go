...
// QuotaScopeType - The quota scope that determines the level at which the quota is applied.
type QuotaScopeType string

const (
	QuotaScopeTypeClassic  QuotaScopeType = "Classic"
	QuotaScopeTypeDataZone QuotaScopeType = "DataZone"
	QuotaScopeTypeGlobal   QuotaScopeType = "Global"
	QuotaScopeTypeRegional QuotaScopeType = "Regional"
)

// PossibleQuotaScopeTypeValues returns the possible values for the QuotaScopeType const type.
func PossibleQuotaScopeTypeValues() []QuotaScopeType {
	return []QuotaScopeType{
		QuotaScopeTypeClassic,
		QuotaScopeTypeDataZone,
		QuotaScopeTypeGlobal,
		QuotaScopeTypeRegional,
	}
}
...
// RuleAction - The action enum for a managed network outbound rule.
