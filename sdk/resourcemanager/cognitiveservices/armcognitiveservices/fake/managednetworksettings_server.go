...
type ManagedNetworkSettingsServer struct {
	// BeginDelete is the fake for method ManagedNetworkSettingsClient.BeginDelete
...
func (m *ManagedNetworkSettingsServerTransport) dispatchBeginDelete(req *http.Request) (*http.Response, error) {
	...
	if beginDelete == nil {
		...
		respr, errRespr := m.srv.BeginDelete(req.Context(), resourceGroupNameParam, accountNameParam, managedNetworkNameParam, nil)
...
func (m *ManagedNetworkSettingsServerTransport) dispatchBeginPatch(req *http.Request) (*http.Response, error) {
	...
	if beginPatch == nil {
		...
		respr, errRespr := m.srv.BeginPatch(req.Context(), resourceGroupNameParam, accountNameParam, managedNetworkNameParam, body, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginPatch = &respr
