...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "ModelsClient":
		initServer(&s.trMu, &s.trModelsServer, func() *ModelsServerTransport { return NewModelsServerTransport(&s.srv.ModelsServer) })
	...
	case "RaiTopicsClient":
		initServer(&s.trMu, &s.trRaiTopicsServer, func() *RaiTopicsServerTransport { return NewRaiTopicsServerTransport(&s.srv.RaiTopicsServer) })
