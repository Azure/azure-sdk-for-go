...
// Generated from example definition: 2026-05-15-preview/CheckDomainAvailability.json
func ExampleManagementClient_CheckDomainAvailability() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armcognitiveservices.ManagementClientCheckDomainAvailabilityResponse{
...
// Generated from example definition: 2026-05-15-preview/CheckSkuAvailability.json
func ExampleManagementClient_CheckSKUAvailability() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armcognitiveservices.ManagementClientCheckSKUAvailabilityResponse{
