...
func (client *ModelCapacitiesClient) NewListPager(modelFormat string, modelName string, modelVersion string, options *ModelCapacitiesClientListOptions) *runtime.Pager[ModelCapacitiesClientListResponse] {
	return runtime.NewPager(runtime.PagingHandler[ModelCapacitiesClientListResponse]{
		...
		Fetcher: func(ctx context.Context, page *ModelCapacitiesClientListResponse) (ModelCapacitiesClientListResponse, error) {
			...
			req, err := client.listCreateRequest(ctx, modelFormat, modelName, modelVersion, nextLink, options)
			if err != nil {
...
func (client *ModelCapacitiesClient) listCreateRequest(ctx context.Context, modelFormat string, modelName string, modelVersion string, nextLink string, _ *ModelCapacitiesClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *ModelCapacitiesClient) listHandleResponse(resp *http.Response, successCodes ...int) (ModelCapacitiesClientListResponse, error) {
