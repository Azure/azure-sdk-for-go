...
// ComputeOperationStatusProperties - The properties of a compute operation status.
type ComputeOperationStatusProperties struct {
...
type FoundryAutoUpgrade struct {
...
type ManagedNetworkSettings struct {
	...
	// READ-ONLY; The provisioning state of the managed network settings.
...
// PrivateEndpointOutboundRule - Private Endpoint outbound rule for the managed network of a cognitive services account.
...
// PrivateEndpointOutboundRuleDestination - Private Endpoint destination for an outbound rule.
...
// ServiceTagOutboundRule - Service Tag outbound rule for the managed network of a cognitive services account.
...
// ServiceTagOutboundRuleDestination - Service Tag destination for an outbound rule.
type ServiceTagOutboundRuleDestination struct {
