...
func (client *ModelsClient) listCreateRequest(ctx context.Context, location string, nextLink string, _ *ModelsClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *ModelsClient) listHandleResponse(resp *http.Response, successCodes ...int) (ModelsClientListResponse, error) {
