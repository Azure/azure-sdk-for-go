...
// ComputeOperationsClientGetOptions contains the optional parameters for the ComputeOperationsClient.Get method.
type ComputeOperationsClientGetOptions struct {
	// placeholder for future optional parameters
}
...
// ManagedNetworkSettingsClientBeginDeleteOptions contains the optional parameters for the ManagedNetworkSettingsClient.BeginDelete
// method.
type ManagedNetworkSettingsClientBeginDeleteOptions struct {
	// Resumes the long-running operation from the provided token.
	ResumeToken string
}
