...
func (client *OutboundRuleClient) getHandleResponse(resp *http.Response, successCodes ...int) (OutboundRuleClientGetResponse, error) {
...
func (client *OutboundRuleClient) NewListPager(resourceGroupName string, accountName string, managedNetworkName string, options *OutboundRuleClientListOptions) *runtime.Pager[OutboundRuleClientListResponse] {
	return runtime.NewPager(runtime.PagingHandler[OutboundRuleClientListResponse]{
		...
		Fetcher: func(ctx context.Context, page *OutboundRuleClientListResponse) (OutboundRuleClientListResponse, error) {
			...
			req, err := client.listCreateRequest(ctx, resourceGroupName, accountName, managedNetworkName, nextLink, options)
			if err != nil {
...
func (client *OutboundRuleClient) listCreateRequest(ctx context.Context, resourceGroupName string, accountName string, managedNetworkName string, nextLink string, _ *OutboundRuleClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *OutboundRuleClient) listHandleResponse(resp *http.Response, successCodes ...int) (OutboundRuleClientListResponse, error) {
