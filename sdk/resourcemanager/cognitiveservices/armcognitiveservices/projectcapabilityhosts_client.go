...
func (client *ProjectCapabilityHostsClient) getHandleResponse(resp *http.Response, successCodes ...int) (ProjectCapabilityHostsClientGetResponse, error) {
...
func (client *ProjectCapabilityHostsClient) listCreateRequest(ctx context.Context, resourceGroupName string, accountName string, projectName string, nextLink string, _ *ProjectCapabilityHostsClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *ProjectCapabilityHostsClient) listHandleResponse(resp *http.Response, successCodes ...int) (ProjectCapabilityHostsClientListResponse, error) {
