...
func (client *ProjectsClient) listCreateRequest(ctx context.Context, resourceGroupName string, accountName string, nextLink string, _ *ProjectsClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
