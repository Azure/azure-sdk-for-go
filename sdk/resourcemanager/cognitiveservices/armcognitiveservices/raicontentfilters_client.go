...
func (client *RaiContentFiltersClient) getHandleResponse(resp *http.Response, successCodes ...int) (RaiContentFiltersClientGetResponse, error) {
...
func (client *RaiContentFiltersClient) listCreateRequest(ctx context.Context, location string, nextLink string, _ *RaiContentFiltersClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *RaiContentFiltersClient) listHandleResponse(resp *http.Response, successCodes ...int) (RaiContentFiltersClientListResponse, error) {
