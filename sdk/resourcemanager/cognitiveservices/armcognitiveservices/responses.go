...
// ComputeOperationsClientGetResponse contains the response from method ComputeOperationsClient.Get.
type ComputeOperationsClientGetResponse struct {
...
// ManagedNetworkSettingsClientDeleteResponse contains the response from method ManagedNetworkSettingsClient.BeginDelete.
type ManagedNetworkSettingsClientDeleteResponse struct {
	// placeholder for future response values
}
