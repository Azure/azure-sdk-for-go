...
// ClientCalculateModelCapacityResponse contains the response from method Client.CalculateModelCapacity.
type ClientCalculateModelCapacityResponse struct {
	// Calculate Model Capacity result.
	CalculateModelCapacityResult
}

// ClientCheckDomainAvailabilityResponse contains the response from method Client.CheckDomainAvailability.
type ClientCheckDomainAvailabilityResponse struct {
	// Domain availability.
	DomainAvailability
}

// ClientCheckSKUAvailabilityResponse contains the response from method Client.CheckSKUAvailability.
type ClientCheckSKUAvailabilityResponse struct {
