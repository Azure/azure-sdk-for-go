...
// Generated from example definition: https://github.com/Azure/azure-rest-api-specs/blob/853cc9dc24429b8c642f631a1ca4c3ff4570f8ee/specification/cognitiveservices/resource-manager/Microsoft.CognitiveServices/preview/2025-10-01-preview/examples/GetSubscriptionRaiPolicy.json
func ExampleSubscriptionRaiPolicyClient_Get() {
	...
	res, err := clientFactory.NewSubscriptionRaiPolicyClient().Get(ctx, "raiPolicyName", nil)
	if err != nil {
...
// Generated from example definition: https://github.com/Azure/azure-rest-api-specs/blob/853cc9dc24429b8c642f631a1ca4c3ff4570f8ee/specification/cognitiveservices/resource-manager/Microsoft.CognitiveServices/preview/2025-10-01-preview/examples/PutSubscriptionRaiPolicy.json
func ExampleSubscriptionRaiPolicyClient_CreateOrUpdate() {
	...
	res, err := clientFactory.NewSubscriptionRaiPolicyClient().CreateOrUpdate(ctx, "raiPolicyName", armcognitiveservices.RaiPolicy{
		Properties: &armcognitiveservices.RaiPolicyProperties{
			BasePolicyName: to.Ptr("Microsoft.Default"),
			ContentFilters: []*armcognitiveservices.RaiPolicyContentFilter{
				{
...
// Generated from example definition: https://github.com/Azure/azure-rest-api-specs/blob/853cc9dc24429b8c642f631a1ca4c3ff4570f8ee/specification/cognitiveservices/resource-manager/Microsoft.CognitiveServices/preview/2025-10-01-preview/examples/DeleteSubscriptionRaiPolicy.json
func ExampleSubscriptionRaiPolicyClient_BeginDelete() {
	...
	poller, err := clientFactory.NewSubscriptionRaiPolicyClient().BeginDelete(ctx, "raiPolicyName", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
