...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	switch client {
	case "RateCardClient":
		initServer(&s.trMu, &s.trRateCardServer, func() *RateCardServerTransport { return NewRateCardServerTransport(&s.srv.RateCardServer) })
		resp, err = s.trRateCardServer.Do(req)
	case "UsageAggregatesClient":
		initServer(&s.trMu, &s.trUsageAggregatesServer, func() *UsageAggregatesServerTransport {
