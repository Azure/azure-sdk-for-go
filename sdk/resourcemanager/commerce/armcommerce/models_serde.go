...
func (m *MeterInfo) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "EffectiveDate":
			err = unpopulateTime[datetime.RFC3339](val, "EffectiveDate", &m.EffectiveDate)
			delete(rawMsg, key)
...
func (o *OfferTermInfo) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "EffectiveDate":
			err = unpopulateTime[datetime.RFC3339](val, "EffectiveDate", &o.EffectiveDate)
			delete(rawMsg, key)
		case "Name":
...
func (r *RecurringCharge) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "EffectiveDate":
			err = unpopulateTime[datetime.RFC3339](val, "EffectiveDate", &r.EffectiveDate)
			delete(rawMsg, key)
		case "Name":
...
func (u *UsageSample) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "unit":
			...
			delete(rawMsg, key)
		case "usageEndTime":
			err = unpopulateTime[datetime.RFC3339](val, "UsageEndTime", &u.UsageEndTime)
			delete(rawMsg, key)
		case "usageStartTime":
			err = unpopulateTime[datetime.RFC3339](val, "UsageStartTime", &u.UsageStartTime)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", u, err)
