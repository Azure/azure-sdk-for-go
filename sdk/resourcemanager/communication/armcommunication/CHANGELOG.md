...
- Type of `ServiceProperties.ProvisioningState` has been changed from `*CommunicationServicesProvisioningState` to `*ServicesProvisioningState`
- Enum `CommunicationServicesProvisioningState` has been removed
...
- New enum type `ServicesProvisioningState` with values `ServicesProvisioningStateCanceled`, `ServicesProvisioningStateCreating`, `ServicesProvisioningStateDeleting`, `ServicesProvisioningStateFailed`, `ServicesProvisioningStateMoving`, `ServicesProvisioningStateRunning`, `ServicesProvisioningStateSucceeded`, `ServicesProvisioningStateUnknown`, `ServicesProvisioningStateUpdating`
