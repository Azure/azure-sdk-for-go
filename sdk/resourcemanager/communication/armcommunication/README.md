...
```sh
go get github.com/Azure/azure-sdk-for-go/sdk/resourcemanager/communication/armcommunication/v3
```
...
[open an issue](https://github.com/Azure/azure-sdk-for-go/issues) and assign the `Communication Services` label.
