...
// ServicesProvisioningState - Provisioning state of the resource.
type ServicesProvisioningState string

const (
	// ServicesProvisioningStateCanceled - Canceled
	ServicesProvisioningStateCanceled ServicesProvisioningState = "Canceled"
	// ServicesProvisioningStateCreating - Creating
	ServicesProvisioningStateCreating ServicesProvisioningState = "Creating"
	// ServicesProvisioningStateDeleting - Deleting
	ServicesProvisioningStateDeleting ServicesProvisioningState = "Deleting"
	// ServicesProvisioningStateFailed - Failed
	ServicesProvisioningStateFailed ServicesProvisioningState = "Failed"
	// ServicesProvisioningStateMoving - Moving
	ServicesProvisioningStateMoving ServicesProvisioningState = "Moving"
	// ServicesProvisioningStateRunning - Running
	ServicesProvisioningStateRunning ServicesProvisioningState = "Running"
	// ServicesProvisioningStateSucceeded - Succeeded
	ServicesProvisioningStateSucceeded ServicesProvisioningState = "Succeeded"
	// ServicesProvisioningStateUnknown - Unknown
	ServicesProvisioningStateUnknown ServicesProvisioningState = "Unknown"
	// ServicesProvisioningStateUpdating - Updating
	ServicesProvisioningStateUpdating ServicesProvisioningState = "Updating"
)

// PossibleServicesProvisioningStateValues returns the possible values for the ServicesProvisioningState const type.
func PossibleServicesProvisioningStateValues() []ServicesProvisioningState {
	return []ServicesProvisioningState{
		ServicesProvisioningStateCanceled,
		ServicesProvisioningStateCreating,
		ServicesProvisioningStateDeleting,
		ServicesProvisioningStateFailed,
		ServicesProvisioningStateMoving,
		ServicesProvisioningStateRunning,
		ServicesProvisioningStateSucceeded,
		ServicesProvisioningStateUnknown,
		ServicesProvisioningStateUpdating,
	}
}
