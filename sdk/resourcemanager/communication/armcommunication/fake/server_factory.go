...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "EmailServicesClient":
		initServer(&s.trMu, &s.trEmailServicesServer, func() *EmailServicesServerTransport {
	...
	case "SMTPUsernamesClient":
		initServer(&s.trMu, &s.trSMTPUsernamesServer, func() *SMTPUsernamesServerTransport {
	...
	case "SenderUsernamesClient":
		initServer(&s.trMu, &s.trSenderUsernamesServer, func() *SenderUsernamesServerTransport {
	...
	case "SuppressionListAddressesClient":
		initServer(&s.trMu, &s.trSuppressionListAddressesServer, func() *SuppressionListAddressesServerTransport {
	...
	case "SuppressionListsClient":
		initServer(&s.trMu, &s.trSuppressionListsServer, func() *SuppressionListsServerTransport {
