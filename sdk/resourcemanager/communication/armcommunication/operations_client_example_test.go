...
// Generated from example definition: 2025-09-01/communicationServices/operationsList.json
func ExampleOperationsClient_NewListPager() {
	...
	clientFactory, err := armcommunication.NewClientFactory("<subscriptionID>", cred, nil)
	if err != nil {
	...
	for pager.More() {
		...
		// page = armcommunication.OperationsClientListResponse{
		// 	OperationListResult: armcommunication.OperationListResult{
