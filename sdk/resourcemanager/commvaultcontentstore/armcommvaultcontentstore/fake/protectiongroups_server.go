...
// ProtectionGroupsServer is a fake server for instances of the armcommvaultcontentstore.ProtectionGroupsClient type.
type ProtectionGroupsServer struct {
	// Backup is the fake for method ProtectionGroupsClient.Backup
	// HTTP status codes to indicate success: http.StatusOK
	Backup func(ctx context.Context, resourceGroupName string, cloudAccountName string, protectionGroupName string, request armcommvaultcontentstore.BackupProtectionGroupRequest, options *armcommvaultcontentstore.ProtectionGroupsClientBackupOptions) (resp azfake.Responder[armcommvaultcontentstore.ProtectionGroupsClientBackupResponse], errResp azfake.ErrorResponder)

	// BeginCreateOrupdate is the fake for method ProtectionGroupsClient.BeginCreateOrupdate
	// HTTP status codes to indicate success: http.StatusOK, http.StatusCreated
	BeginCreateOrupdate func(ctx context.Context, resourceGroupName string, cloudAccountName string, protectionGroupName string, resource armcommvaultcontentstore.ProtectionGroup, options *armcommvaultcontentstore.ProtectionGroupsClientBeginCreateOrupdateOptions) (resp azfake.PollerResponder[armcommvaultcontentstore.ProtectionGroupsClientCreateOrupdateResponse], errResp azfake.ErrorResponder)
	...
	// HTTP status codes to indicate success: http.StatusOK
	NewListByCloudAccountPager func(resourceGroupName string, cloudAccountName string, options *armcommvaultcontentstore.ProtectionGroupsClientListByCloudAccountOptions) (resp azfake.PagerResponder[armcommvaultcontentstore.ProtectionGroupsClientListByCloudAccountResponse])

	// Restore is the fake for method ProtectionGroupsClient.Restore
	// HTTP status codes to indicate success: http.StatusOK
	Restore func(ctx context.Context, resourceGroupName string, cloudAccountName string, protectionGroupName string, request armcommvaultcontentstore.RestoreProtectionItemRequest, options *armcommvaultcontentstore.ProtectionGroupsClientRestoreOptions) (resp azfake.Responder[armcommvaultcontentstore.ProtectionGroupsClientRestoreResponse], errResp azfake.ErrorResponder)
...
// The returned ProtectionGroupsServerTransport instance is connected to an instance of armcommvaultcontentstore.ProtectionGroupsClient via the
...
// ProtectionGroupsServerTransport connects instances of armcommvaultcontentstore.ProtectionGroupsClient to instances of ProtectionGroupsServer.
...
func (p *ProtectionGroupsServerTransport) dispatchBackup(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[armcommvaultcontentstore.BackupProtectionGroupRequest](req)
	if err != nil {
		return nil, err
	}
...
func (p *ProtectionGroupsServerTransport) dispatchBeginCreateOrupdate(req *http.Request) (*http.Response, error) {
	...
	if beginCreateOrupdate == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armcommvaultcontentstore.ProtectionGroup](req)
		if err != nil {
			return nil, err
		}
		resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
...
func (p *ProtectionGroupsServerTransport) dispatchNewListByCloudAccountPager(req *http.Request) (*http.Response, error) {
	...
	if newListByCloudAccountPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListByCloudAccountPager, req, func(page *armcommvaultcontentstore.ProtectionGroupsClientListByCloudAccountResponse, createLink func() string) {
...
func (p *ProtectionGroupsServerTransport) dispatchRestore(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[armcommvaultcontentstore.RestoreProtectionItemRequest](req)
	if err != nil {
		return nil, err
	}
	resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
