...
func (client *PlansClient) listByCloudAccountCreateRequest(ctx context.Context, resourceGroupName string, cloudAccountName string, nextLink string, _ *PlansClientListByCloudAccountOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *PlansClient) listByCloudAccountHandleResponse(resp *http.Response, successCodes ...int) (PlansClientListByCloudAccountResponse, error) {
