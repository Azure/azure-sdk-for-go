...
- New function `*BulkCreateCustomClient.VirtualMachinesGetOperationStatus(ctx context.Context, resourceGroupName string, location string, name string, options *BulkCreateCustomClientVirtualMachinesGetOperationStatusOptions) (BulkCreateCustomClientVirtualMachinesGetOperationStatusResponse, error)`
