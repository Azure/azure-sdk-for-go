...
The `armbulkactions` module provides operations for working with Azure Compute.

[Source code](https://github.com/Azure/azure-sdk-for-go/tree/main/sdk/resourcemanager/compute/armbulkactions)
...
```sh
go get github.com/Azure/azure-sdk-for-go/sdk/resourcemanager/compute/armbulkactions
```
...
```go
clientFactory, err := armbulkactions.NewClientFactory(<subscription ID>, cred, nil)
```
...
clientFactory, err := armbulkactions.NewClientFactory(<subscription ID>, cred, &options)
```
...
```go
client := clientFactory.NewLaunchBulkInstancesOperationClient()
```
