...
type BulkCreateCustomVMSizeProfile struct {
	// REQUIRED; The virtual machine SKU, for example `Standard_D2ads_v5`.
	Name *string

	// REQUIRED; The customer-defined priority rank for this virtual machine size.
	Rank *int32
...
// ZoneAllocationPolicy - The preferences for distributing virtual machines across availability zones.
...
// ZonePreference - An availability zone and its allocation priority.
type ZonePreference struct {
	// REQUIRED; The customer-defined priority rank for this availability zone.
	Rank *int32

	// REQUIRED; The availability zone identifier.
	Zone *string
