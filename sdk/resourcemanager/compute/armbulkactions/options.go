...
// BulkCreateCustomClientVirtualMachinesGetOperationStatusOptions contains the optional parameters for the BulkCreateCustomClient.VirtualMachinesGetOperationStatus
// method.
