...
// BulkCreateCustomClientVirtualMachinesGetOperationStatusResponse contains the response from method BulkCreateCustomClient.VirtualMachinesGetOperationStatus.
