...
// ComponentNames - The component name. Currently, the only allowable value is Microsoft-Windows-Shell-Setup.
...
// PossibleComponentNamesValues returns the possible values for the ComponentNames const type.
...
type GetResponseContentType string

const (
	GetResponseContentTypeApplicationJSON GetResponseContentType = "application/json"
	GetResponseContentTypeTextJSON        GetResponseContentType = "text/json"
)

// PossibleGetResponseContentTypeValues returns the possible values for the GetResponseContentType const type.
func PossibleGetResponseContentTypeValues() []GetResponseContentType {
	return []GetResponseContentType{
		GetResponseContentTypeApplicationJSON,
		GetResponseContentTypeTextJSON,
	}
}
...
type ListResponseContentType string

const (
	ListResponseContentTypeApplicationJSON ListResponseContentType = "application/json"
	ListResponseContentTypeTextJSON        ListResponseContentType = "text/json"
)

// PossibleListResponseContentTypeValues returns the possible values for the ListResponseContentType const type.
func PossibleListResponseContentTypeValues() []ListResponseContentType {
	return []ListResponseContentType{
		ListResponseContentTypeApplicationJSON,
		ListResponseContentTypeTextJSON,
	}
}
...
// PossiblePassNamesValues returns the possible values for the PassNames const type.
