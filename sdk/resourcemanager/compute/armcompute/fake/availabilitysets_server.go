...
type AvailabilitySetsServer struct {
	...
	CreateOrUpdate func(ctx context.Context, resourceGroupName string, availabilitySetName string, resource armcompute.AvailabilitySet, options *armcompute.AvailabilitySetsClientCreateOrUpdateOptions) (resp azfake.Responder[armcompute.AvailabilitySetsClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)
	...
	// HTTP status codes to indicate success: http.StatusNoContent
	StartMigrationToVirtualMachineScaleSet func(ctx context.Context, resourceGroupName string, availabilitySetName string, body armcompute.MigrateToVirtualMachineScaleSetInput, options *armcompute.AvailabilitySetsClientStartMigrationToVirtualMachineScaleSetOptions) (resp azfake.Responder[armcompute.AvailabilitySetsClientStartMigrationToVirtualMachineScaleSetResponse], errResp azfake.ErrorResponder)

	// Update is the fake for method AvailabilitySetsClient.Update
	// HTTP status codes to indicate success: http.StatusOK
	Update func(ctx context.Context, resourceGroupName string, availabilitySetName string, properties armcompute.AvailabilitySetUpdate, options *armcompute.AvailabilitySetsClientUpdateOptions) (resp azfake.Responder[armcompute.AvailabilitySetsClientUpdateResponse], errResp azfake.ErrorResponder)
