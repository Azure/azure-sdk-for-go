...
type CommunityGalleriesServer struct {
	Get func(ctx context.Context, location string, publicGalleryName string, options *armcompute.CommunityGalleriesClientGetOptions) (resp azfake.Responder[armcompute.CommunityGalleriesClientGetResponse], err azfake.ErrorResponder)
}
...
func (c *CommunityGalleriesServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	resp, errResp := c.srv.Get(req.Context(), matches[regex.SubexpIndex("location")], matches[regex.SubexpIndex("publicGalleryName")], nil)
