...
type DisksServer struct {
	BeginCreateOrUpdate         func(ctx context.Context, resourceGroupName string, diskName string, disk armcompute.Disk, options *armcompute.DisksClientBeginCreateOrUpdateOptions) (resp azfake.PollerResponder[armcompute.DisksClientCreateOrUpdateResponse], err azfake.ErrorResponder)
	BeginDelete                 func(ctx context.Context, resourceGroupName string, diskName string, options *armcompute.DisksClientBeginDeleteOptions) (resp azfake.PollerResponder[armcompute.DisksClientDeleteResponse], err azfake.ErrorResponder)
	Get                         func(ctx context.Context, resourceGroupName string, diskName string, options *armcompute.DisksClientGetOptions) (resp azfake.Responder[armcompute.DisksClientGetResponse], err azfake.ErrorResponder)
	BeginGrantAccess            func(ctx context.Context, resourceGroupName string, diskName string, grantAccessData armcompute.GrantAccessData, options *armcompute.DisksClientBeginGrantAccessOptions) (resp azfake.PollerResponder[armcompute.DisksClientGrantAccessResponse], err azfake.ErrorResponder)
	...
	BeginRevokeAccess           func(ctx context.Context, resourceGroupName string, diskName string, options *armcompute.DisksClientBeginRevokeAccessOptions) (resp azfake.PollerResponder[armcompute.DisksClientRevokeAccessResponse], err azfake.ErrorResponder)
	BeginUpdate                 func(ctx context.Context, resourceGroupName string, diskName string, disk armcompute.DiskUpdate, options *armcompute.DisksClientBeginUpdateOptions) (resp azfake.PollerResponder[armcompute.DisksClientUpdateResponse], err azfake.ErrorResponder)
}
...
func (d *DisksServerTransport) dispatchBeginCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	if d.beginCreateOrUpdate == nil {
		...
		body, err := azfake.UnmarshalRequestAsJSON[armcompute.Disk](req)
		if err != nil {
			return nil, err
		}
		resp, errResp := d.srv.BeginCreateOrUpdate(req.Context(), matches[regex.SubexpIndex("resourceGroupName")], matches[regex.SubexpIndex("diskName")], body, nil)
...
func (d *DisksServerTransport) dispatchBeginDelete(req *http.Request) (*http.Response, error) {
	...
	if d.beginDelete == nil {
		...
		resp, errResp := d.srv.BeginDelete(req.Context(), matches[regex.SubexpIndex("resourceGroupName")], matches[regex.SubexpIndex("diskName")], nil)
		if err := errResp.Get(req); err != nil {
			return nil, err
		}
		d.beginDelete = &resp
...
func (d *DisksServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	resp, errResp := d.srv.Get(req.Context(), matches[regex.SubexpIndex("resourceGroupName")], matches[regex.SubexpIndex("diskName")], nil)
	if err := errResp.Get(req); err != nil {
		return nil, err
	}
...
func (d *DisksServerTransport) dispatchBeginGrantAccess(req *http.Request) (*http.Response, error) {
	...
	if d.beginGrantAccess == nil {
		...
		resp, errResp := d.srv.BeginGrantAccess(req.Context(), matches[regex.SubexpIndex("resourceGroupName")], matches[regex.SubexpIndex("diskName")], body, nil)
		if err := errResp.Get(req); err != nil {
			return nil, err
		}
...
func (d *DisksServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if d.newListPager == nil {
		...
		resp.InjectNextLinks(req, func(page *armcompute.DisksClientListResponse, createLink func() string) {
...
func (d *DisksServerTransport) dispatchNewListByResourceGroupPager(req *http.Request) (*http.Response, error) {
	...
	if d.newListByResourceGroupPager == nil {
		...
		resp.InjectNextLinks(req, func(page *armcompute.DisksClientListByResourceGroupResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
...
func (d *DisksServerTransport) dispatchBeginRevokeAccess(req *http.Request) (*http.Response, error) {
	...
	if d.beginRevokeAccess == nil {
		...
		resp, errResp := d.srv.BeginRevokeAccess(req.Context(), matches[regex.SubexpIndex("resourceGroupName")], matches[regex.SubexpIndex("diskName")], nil)
		if err := errResp.Get(req); err != nil {
			return nil, err
		}
...
func (d *DisksServerTransport) dispatchBeginUpdate(req *http.Request) (*http.Response, error) {
	...
	if d.beginUpdate == nil {
		...
		body, err := azfake.UnmarshalRequestAsJSON[armcompute.DiskUpdate](req)
		if err != nil {
			return nil, err
		}
		resp, errResp := d.srv.BeginUpdate(req.Context(), matches[regex.SubexpIndex("resourceGroupName")], matches[regex.SubexpIndex("diskName")], body, nil)
		if err := errResp.Get(req); err != nil {
			return nil, err
		}
		d.beginUpdate = &resp
