...
func (r *ResourceSKUsServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if r.newListPager == nil {
		...
		options := armcompute.ResourceSKUsClientListOptions{
			...
			IncludeExtendedLocations: getOptional(qp.Get("includeExtendedLocations")),
		}
		resp := r.srv.NewListPager(&options)
		resp.InjectNextLinks(req, func(page *armcompute.ResourceSKUsClientListResponse, createLink func() string) {
