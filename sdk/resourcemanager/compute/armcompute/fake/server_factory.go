...
type ServerFactory struct {
	...
	// CloudServiceOperatingSystemsServer contains the fakes for client CloudServiceOperatingSystemsClient
	CloudServiceOperatingSystemsServer CloudServiceOperatingSystemsServer

	// CloudServiceRoleInstancesServer contains the fakes for client CloudServiceRoleInstancesClient
	CloudServiceRoleInstancesServer CloudServiceRoleInstancesServer

	// CloudServiceRolesServer contains the fakes for client CloudServiceRolesClient
	CloudServiceRolesServer CloudServiceRolesServer

	// CloudServicesServer contains the fakes for client CloudServicesClient
	CloudServicesServer CloudServicesServer

	// CloudServicesUpdateDomainServer contains the fakes for client CloudServicesUpdateDomainClient
