...
func NewVirtualMachineExtensionsServerTransport(srv *VirtualMachineExtensionsServer) *VirtualMachineExtensionsServerTransport {
	return &VirtualMachineExtensionsServerTransport{
		...
		newListPager:        newTracker[azfake.PagerResponder[armcompute.VirtualMachineExtensionsClientListResponse]](),
...
type VirtualMachineExtensionsServerTransport struct {
	...
	newListPager        *tracker[azfake.PagerResponder[armcompute.VirtualMachineExtensionsClientListResponse]]
...
func (v *VirtualMachineExtensionsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		if !intercepted {
			...
			case "VirtualMachineExtensionsClient.NewListPager":
...
func (v *VirtualMachineExtensionsServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		resp := v.srv.NewListPager(resourceGroupNameParam, vmNameParam, options)
		newListPager = &resp
