...
func (v *VirtualMachinesServerTransport) dispatchBeginDeallocate(req *http.Request) (*http.Response, error) {
	...
	if beginDeallocate == nil {
		...
		forceDeallocateUnescaped, err := url.QueryUnescape(qp.Get("forceDeallocate"))
		if err != nil {
			return nil, err
		}
		forceDeallocateParam, err := parseOptional(forceDeallocateUnescaped, strconv.ParseBool)
		if err != nil {
			return nil, err
		}
