...
type VirtualMachineScaleSetExtensionsServer struct {
	...
	// HTTP status codes to indicate success: http.StatusOK, http.StatusCreated, http.StatusNoContent
	BeginUpdate func(ctx context.Context, resourceGroupName string, vmScaleSetName string, vmssExtensionName string, properties armcompute.VirtualMachineScaleSetExtensionUpdate, options *armcompute.VirtualMachineScaleSetExtensionsClientBeginUpdateOptions) (resp azfake.PollerResponder[armcompute.VirtualMachineScaleSetExtensionsClientUpdateResponse], errResp azfake.ErrorResponder)
}
