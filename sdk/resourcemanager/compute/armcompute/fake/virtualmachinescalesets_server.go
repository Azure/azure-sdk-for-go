...
type VirtualMachineScaleSetsServer struct {
	...
	// BeginCancel is the fake for method VirtualMachineScaleSetsClient.BeginCancel
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginCancel func(ctx context.Context, resourceGroupName string, vmScaleSetName string, options *armcompute.VirtualMachineScaleSetsClientBeginCancelOptions) (resp azfake.PollerResponder[armcompute.VirtualMachineScaleSetsClientCancelResponse], errResp azfake.ErrorResponder)
	...
	BeginCreateOrUpdate func(ctx context.Context, resourceGroupName string, vmScaleSetName string, resource armcompute.VirtualMachineScaleSet, options *armcompute.VirtualMachineScaleSetsClientBeginCreateOrUpdateOptions) (resp azfake.PollerResponder[armcompute.VirtualMachineScaleSetsClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)
	...
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginDeleteInstances func(ctx context.Context, resourceGroupName string, vmScaleSetName string, body armcompute.VirtualMachineScaleSetVMInstanceRequiredIDs, options *armcompute.VirtualMachineScaleSetsClientBeginDeleteInstancesOptions) (resp azfake.PollerResponder[armcompute.VirtualMachineScaleSetsClientDeleteInstancesResponse], errResp azfake.ErrorResponder)
	...
	// BeginScaleOut is the fake for method VirtualMachineScaleSetsClient.BeginScaleOut
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginScaleOut func(ctx context.Context, resourceGroupName string, vmScaleSetName string, body armcompute.VMScaleSetScaleOutInput, options *armcompute.VirtualMachineScaleSetsClientBeginScaleOutOptions) (resp azfake.PollerResponder[armcompute.VirtualMachineScaleSetsClientScaleOutResponse], errResp azfake.ErrorResponder)

	// BeginSetOrchestrationServiceState is the fake for method VirtualMachineScaleSetsClient.BeginSetOrchestrationServiceState
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginSetOrchestrationServiceState func(ctx context.Context, resourceGroupName string, vmScaleSetName string, body armcompute.OrchestrationServiceStateInput, options *armcompute.VirtualMachineScaleSetsClientBeginSetOrchestrationServiceStateOptions) (resp azfake.PollerResponder[armcompute.VirtualMachineScaleSetsClientSetOrchestrationServiceStateResponse], errResp azfake.ErrorResponder)
	...
	// BeginStartExtensionUpgrade is the fake for method VirtualMachineScaleSetsClient.BeginStartExtensionUpgrade
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginStartExtensionUpgrade func(ctx context.Context, resourceGroupName string, vmScaleSetName string, options *armcompute.VirtualMachineScaleSetsClientBeginStartExtensionUpgradeOptions) (resp azfake.PollerResponder[armcompute.VirtualMachineScaleSetsClientStartExtensionUpgradeResponse], errResp azfake.ErrorResponder)

	// BeginStartOSUpgrade is the fake for method VirtualMachineScaleSetsClient.BeginStartOSUpgrade
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginStartOSUpgrade func(ctx context.Context, resourceGroupName string, vmScaleSetName string, options *armcompute.VirtualMachineScaleSetsClientBeginStartOSUpgradeOptions) (resp azfake.PollerResponder[armcompute.VirtualMachineScaleSetsClientStartOSUpgradeResponse], errResp azfake.ErrorResponder)

	// BeginUpdate is the fake for method VirtualMachineScaleSetsClient.BeginUpdate
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	BeginUpdate func(ctx context.Context, resourceGroupName string, vmScaleSetName string, properties armcompute.VirtualMachineScaleSetUpdate, options *armcompute.VirtualMachineScaleSetsClientBeginUpdateOptions) (resp azfake.PollerResponder[armcompute.VirtualMachineScaleSetsClientUpdateResponse], errResp azfake.ErrorResponder)

	// BeginUpdateInstances is the fake for method VirtualMachineScaleSetsClient.BeginUpdateInstances
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginUpdateInstances func(ctx context.Context, resourceGroupName string, vmScaleSetName string, body armcompute.VirtualMachineScaleSetVMInstanceRequiredIDs, options *armcompute.VirtualMachineScaleSetsClientBeginUpdateInstancesOptions) (resp azfake.PollerResponder[armcompute.VirtualMachineScaleSetsClientUpdateInstancesResponse], errResp azfake.ErrorResponder)
}
...
func NewVirtualMachineScaleSetsServerTransport(srv *VirtualMachineScaleSetsServer) *VirtualMachineScaleSetsServerTransport {
	return &VirtualMachineScaleSetsServerTransport{
		...
		beginCancel:                       newTracker[azfake.PollerResponder[armcompute.VirtualMachineScaleSetsClientCancelResponse]](),
		...
		beginScaleOut:                     newTracker[azfake.PollerResponder[armcompute.VirtualMachineScaleSetsClientScaleOutResponse]](),
		...
		beginStartExtensionUpgrade:        newTracker[azfake.PollerResponder[armcompute.VirtualMachineScaleSetsClientStartExtensionUpgradeResponse]](),
		beginStartOSUpgrade:               newTracker[azfake.PollerResponder[armcompute.VirtualMachineScaleSetsClientStartOSUpgradeResponse]](),
...
type VirtualMachineScaleSetsServerTransport struct {
	...
	beginCancel                       *tracker[azfake.PollerResponder[armcompute.VirtualMachineScaleSetsClientCancelResponse]]
	...
	beginScaleOut                     *tracker[azfake.PollerResponder[armcompute.VirtualMachineScaleSetsClientScaleOutResponse]]
	...
	beginStartExtensionUpgrade        *tracker[azfake.PollerResponder[armcompute.VirtualMachineScaleSetsClientStartExtensionUpgradeResponse]]
	beginStartOSUpgrade               *tracker[azfake.PollerResponder[armcompute.VirtualMachineScaleSetsClientStartOSUpgradeResponse]]
...
func (v *VirtualMachineScaleSetsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		if !intercepted {
			...
			case "VirtualMachineScaleSetsClient.BeginCancel":
			...
			case "VirtualMachineScaleSetsClient.BeginScaleOut":
				res.resp, res.err = v.dispatchBeginScaleOut(req)
			...
			case "VirtualMachineScaleSetsClient.BeginStartExtensionUpgrade":
				res.resp, res.err = v.dispatchBeginStartExtensionUpgrade(req)
			case "VirtualMachineScaleSetsClient.BeginStartOSUpgrade":
...
func (v *VirtualMachineScaleSetsServerTransport) dispatchBeginCancel(req *http.Request) (*http.Response, error) {
...
func (v *VirtualMachineScaleSetsServerTransport) dispatchBeginScaleOut(req *http.Request) (*http.Response, error) {
	if v.srv.BeginScaleOut == nil {
		return nil, &nonRetriableError{errors.New("fake for method BeginScaleOut not implemented")}
	}
	...
	if beginScaleOut == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armcompute.VMScaleSetScaleOutInput](req)
		if err != nil {
			return nil, err
		}
		resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
		...
		respr, errRespr := v.srv.BeginScaleOut(req.Context(), resourceGroupNameParam, vmScaleSetNameParam, body, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginScaleOut = &respr
		v.beginScaleOut.add(req, beginScaleOut)
	}

	resp, err := server.PollerResponderNext(beginScaleOut, req)
	if err != nil {
		return nil, err
	}

	if !contains([]int{http.StatusOK, http.StatusAccepted}, resp.StatusCode) {
		v.beginScaleOut.remove(req)
		return nil, &nonRetriableError{fmt.Errorf("unexpected status code %d. acceptable values are http.StatusOK, http.StatusAccepted", resp.StatusCode)}
	}
	if !server.PollerResponderMore(beginScaleOut) {
		v.beginScaleOut.remove(req)
	}
...
func (v *VirtualMachineScaleSetsServerTransport) dispatchBeginStartExtensionUpgrade(req *http.Request) (*http.Response, error) {
...
func (v *VirtualMachineScaleSetsServerTransport) dispatchBeginStartOSUpgrade(req *http.Request) (*http.Response, error) {
