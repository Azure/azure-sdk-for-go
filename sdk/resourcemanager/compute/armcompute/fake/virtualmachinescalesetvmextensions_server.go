...
type VirtualMachineScaleSetVMExtensionsServer struct {
	...
	// NewListPager is the fake for method VirtualMachineScaleSetVMExtensionsClient.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager func(resourceGroupName string, vmScaleSetName string, instanceID string, options *armcompute.VirtualMachineScaleSetVMExtensionsClientListOptions) (resp azfake.PagerResponder[armcompute.VirtualMachineScaleSetVMExtensionsClientListResponse])

	// BeginUpdate is the fake for method VirtualMachineScaleSetVMExtensionsClient.BeginUpdate
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	BeginUpdate func(ctx context.Context, resourceGroupName string, vmScaleSetName string, instanceID string, vmExtensionName string, properties armcompute.VirtualMachineScaleSetVMExtensionUpdate, options *armcompute.VirtualMachineScaleSetVMExtensionsClientBeginUpdateOptions) (resp azfake.PollerResponder[armcompute.VirtualMachineScaleSetVMExtensionsClientUpdateResponse], errResp azfake.ErrorResponder)
}
...
func NewVirtualMachineScaleSetVMExtensionsServerTransport(srv *VirtualMachineScaleSetVMExtensionsServer) *VirtualMachineScaleSetVMExtensionsServerTransport {
	return &VirtualMachineScaleSetVMExtensionsServerTransport{
		...
		newListPager:        newTracker[azfake.PagerResponder[armcompute.VirtualMachineScaleSetVMExtensionsClientListResponse]](),
...
type VirtualMachineScaleSetVMExtensionsServerTransport struct {
	...
	newListPager        *tracker[azfake.PagerResponder[armcompute.VirtualMachineScaleSetVMExtensionsClientListResponse]]
...
func (v *VirtualMachineScaleSetVMExtensionsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		if !intercepted {
			...
			case "VirtualMachineScaleSetVMExtensionsClient.NewListPager":
...
func (v *VirtualMachineScaleSetVMExtensionsServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
