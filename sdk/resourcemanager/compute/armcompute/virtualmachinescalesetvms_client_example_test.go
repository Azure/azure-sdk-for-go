...
func ExampleVirtualMachineScaleSetVMsClient_Get_getVMScaleSetVMWithInterconnectBlock() {
	...
	// 				},
	// 			},
	// 			TimeCreated: to.Ptr(time.Date(2026, time.May, 4, 19, 59, 5, 535045900, time.UTC)),
	// 		},
	// 		Etag: to.Ptr("\"1\""),
	// 		Zones: []*string{
	// 			to.Ptr("1"),
...
func ExampleVirtualMachineScaleSetVMsClient_GetInstanceView() {
	...
	// 					Time: to.Ptr(time.Date(2025, time.April, 1, 5, 0, 32, 0, time.UTC)),
	// 				},
	// 			},
	// 		},
	...
	// 						Time: to.Ptr(time.Date(2025, time.April, 1, 4, 58, 58, 88281500, time.UTC)),
	// 					},
	// 				},
	// 			},
	// 		},
