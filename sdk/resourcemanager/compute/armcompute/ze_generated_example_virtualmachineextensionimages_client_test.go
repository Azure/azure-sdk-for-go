...
func ExampleVirtualMachineExtensionImagesClient_Get() {
	...
	client := armcompute.NewVirtualMachineExtensionImagesClient("<subscription-id>", cred, nil)
	...
	log.Printf("Response result: %#v\n", res.VirtualMachineExtensionImagesClientGetResult)
}
...
func ExampleVirtualMachineExtensionImagesClient_ListTypes() {
	...
	log.Printf("Response result: %#v\n", res.VirtualMachineExtensionImagesClientListTypesResult)
}
...
func ExampleVirtualMachineExtensionImagesClient_ListVersions() {
	...
	res, err := client.ListVersions(ctx,
		...
		"<publisher-name>",
		"<type-param>",
		&armcompute.VirtualMachineExtensionImagesClientListVersionsOptions{Filter: to.StringPtr("<filter>"),
			Top:     to.Int32Ptr(22),
	...
	log.Printf("Response result: %#v\n", res.VirtualMachineExtensionImagesClientListVersionsResult)
}
