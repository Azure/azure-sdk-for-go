...
func NewCommunityGalleryImageVersionsClient(con *arm.Connection, subscriptionID string) *CommunityGalleryImageVersionsClient {
	return &CommunityGalleryImageVersionsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
