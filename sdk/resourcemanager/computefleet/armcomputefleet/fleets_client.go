...
func (client *FleetsClient) getHandleResponse(resp *http.Response, successCodes ...int) (FleetsClientGetResponse, error) {
...
func (client *FleetsClient) listByResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, nextLink string, _ *FleetsClientListByResourceGroupOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *FleetsClient) listByResourceGroupHandleResponse(resp *http.Response, successCodes ...int) (FleetsClientListByResourceGroupResponse, error) {
...
func (client *FleetsClient) listBySubscriptionCreateRequest(ctx context.Context, nextLink string, _ *FleetsClientListBySubscriptionOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
	var req *policy.Request
	var err error
	if firstPage {
...
func (client *FleetsClient) listBySubscriptionHandleResponse(resp *http.Response, successCodes ...int) (FleetsClientListBySubscriptionResponse, error) {
...
func (client *FleetsClient) NewListVirtualMachineScaleSetsPager(resourceGroupName string, name string, options *FleetsClientListVirtualMachineScaleSetsOptions) *runtime.Pager[FleetsClientListVirtualMachineScaleSetsResponse] {
	return runtime.NewPager(runtime.PagingHandler[FleetsClientListVirtualMachineScaleSetsResponse]{
		...
		Fetcher: func(ctx context.Context, page *FleetsClientListVirtualMachineScaleSetsResponse) (FleetsClientListVirtualMachineScaleSetsResponse, error) {
			...
			req, err := client.listVirtualMachineScaleSetsCreateRequest(ctx, resourceGroupName, name, nextLink, options)
			if err != nil {
			...
			return client.listVirtualMachineScaleSetsHandleResponse(resp, http.StatusOK)
		},
		Tracer: client.internal.Tracer(),
	})
}
...
func (client *FleetsClient) listVirtualMachineScaleSetsCreateRequest(ctx context.Context, resourceGroupName string, name string, nextLink string, _ *FleetsClientListVirtualMachineScaleSetsOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
	var req *policy.Request
	var err error
	if firstPage {
...
func (client *FleetsClient) listVirtualMachineScaleSetsHandleResponse(resp *http.Response, successCodes ...int) (FleetsClientListVirtualMachineScaleSetsResponse, error) {
...
// NewListVirtualMachinesPager - List VirtualMachine resources of a Launch mode Fleet.
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - name - The name of the Fleet
...
func (client *FleetsClient) NewListVirtualMachinesPager(resourceGroupName string, name string, options *FleetsClientListVirtualMachinesOptions) *runtime.Pager[FleetsClientListVirtualMachinesResponse] {
	return runtime.NewPager(runtime.PagingHandler[FleetsClientListVirtualMachinesResponse]{
		...
		Fetcher: func(ctx context.Context, page *FleetsClientListVirtualMachinesResponse) (FleetsClientListVirtualMachinesResponse, error) {
			...
			req, err := client.listVirtualMachinesCreateRequest(ctx, resourceGroupName, name, nextLink, options)
			if err != nil {
...
func (client *FleetsClient) listVirtualMachinesCreateRequest(ctx context.Context, resourceGroupName string, name string, nextLink string, options *FleetsClientListVirtualMachinesOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
	var req *policy.Request
	var err error
	if firstPage {
...
func (client *FleetsClient) listVirtualMachinesHandleResponse(resp *http.Response, successCodes ...int) (FleetsClientListVirtualMachinesResponse, error) {
