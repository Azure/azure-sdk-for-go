...
// MarshalJSON implements the json.Marshaller interface for type ComputeProfileUpdate.
func (c ComputeProfileUpdate) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "baseVirtualMachineProfile", c.BaseVirtualMachineProfile)
	populate(objectMap, "computeApiVersion", c.ComputeAPIVersion)
	populate(objectMap, "platformFaultDomainCount", c.PlatformFaultDomainCount)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type ComputeProfileUpdate.
func (c *ComputeProfileUpdate) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type FleetPropertiesUpdate.
func (f FleetPropertiesUpdate) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "computeProfile", f.ComputeProfile)
	populate(objectMap, "regularPriorityProfile", f.RegularPriorityProfile)
	populate(objectMap, "spotPriorityProfile", f.SpotPriorityProfile)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type FleetPropertiesUpdate.
func (f *FleetPropertiesUpdate) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", f, err)
	}
