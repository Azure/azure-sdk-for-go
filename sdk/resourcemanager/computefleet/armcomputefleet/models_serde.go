...
func (b *BaseVirtualMachineProfile) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "storageProfile":
			...
			delete(rawMsg, key)
		case "timeCreated":
			err = unpopulateTime[datetime.RFC3339](val, "TimeCreated", &b.TimeCreated)
			delete(rawMsg, key)
		case "userData":
...
func (f *FleetProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "spotPriorityProfile":
			...
			delete(rawMsg, key)
		case "timeCreated":
			err = unpopulateTime[datetime.RFC3339](val, "TimeCreated", &f.TimeCreated)
			delete(rawMsg, key)
		case "uniqueId":
		...
		case "vmAttributes":
			...
			delete(rawMsg, key)
		case "vmNamePrefix":
			err = unpopulate(val, "VMNamePrefix", &f.VMNamePrefix)
			delete(rawMsg, key)
		case "vmSizesProfile":
