...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "LedgerClient":
		initServer(&s.trMu, &s.trLedgerServer, func() *LedgerServerTransport { return NewLedgerServerTransport(&s.srv.LedgerServer) })
		resp, err = s.trLedgerServer.Do(req)
	case "ManagedCCFClient":
		initServer(&s.trMu, &s.trManagedCCFServer, func() *ManagedCCFServerTransport { return NewManagedCCFServerTransport(&s.srv.ManagedCCFServer) })
