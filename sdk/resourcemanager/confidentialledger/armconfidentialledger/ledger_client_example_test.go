...
// Generated from example definition: 2025-06-10-preview/ConfidentialLedger_Backup.json
...
// Generated from example definition: 2025-06-10-preview/ConfidentialLedger_Create.json
...
// Generated from example definition: 2025-06-10-preview/ConfidentialLedger_Delete.json
func ExampleLedgerClient_BeginDelete() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armconfidentialledger.LedgerClientDeleteResponse{
	// }
}

// Generated from example definition: 2025-06-10-preview/ConfidentialLedger_Get.json
...
// Generated from example definition: 2025-06-10-preview/ConfidentialLedger_List.json
func ExampleLedgerClient_NewListByResourceGroupPager() {
	...
	pager := clientFactory.NewLedgerClient().NewListByResourceGroupPager("DummyResourceGroupName", nil)
	for pager.More() {
		...
		// page = armconfidentialledger.LedgerClientListByResourceGroupResponse{
		// 	List: armconfidentialledger.List{
...
// Generated from example definition: 2025-06-10-preview/ConfidentialLedger_ListBySub.json
func ExampleLedgerClient_NewListBySubscriptionPager() {
	...
	pager := clientFactory.NewLedgerClient().NewListBySubscriptionPager(nil)
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armconfidentialledger.LedgerClientListBySubscriptionResponse{
		// 	List: armconfidentialledger.List{
		// 		Value: []*armconfidentialledger.ConfidentialLedger{
		// 			{
		// 				Name: to.Ptr("DummyLedgerName"),
...
// Generated from example definition: 2025-06-10-preview/ConfidentialLedger_Restore.json
...
// Generated from example definition: 2025-06-10-preview/ConfidentialLedger_Update.json
