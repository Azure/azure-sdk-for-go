...
// Backup - Object representing Files Export properties of a Confidential Ledger Resource.
type Backup struct {
	// REQUIRED; SAS URI used to access the Fileshare for exporting ledger files.
	URI *string
...
// BackupResponse - Object representing the files export response of a Confidential Ledger Resource.
type BackupResponse struct {
	// READ-ONLY; Response body stating if the ledger files are being exported.
	Message *string
}
