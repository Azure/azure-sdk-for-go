...
func ExampleClusterClient_CreateOrUpdate() {
	...
	res, err := clientFactory.NewClusterClient().CreateOrUpdate(ctx, "rgconfluent", "vwqtjoijzqitjmu", "rwmpydknnovcfsattscfm", "rdizpgcbewizsgffpg", armconfluent.SCClusterRecord{
...
func ExampleClusterClient_BeginDelete_clusterDeleteMaximumSet() {
	...
	poller, err := clientFactory.NewClusterClient().BeginDelete(ctx, "rgconfluent", "rwzpoelzgevhnkrvyqy", "gnijsroqxwwyyariafdnmkc", "zsvnfsirukovzkth", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
...
func ExampleClusterClient_BeginDelete_clusterDeleteMinimumSet() {
	...
	poller, err := clientFactory.NewClusterClient().BeginDelete(ctx, "rgconfluent", "tvbhdezawspzzfprrnjoxfwtwlp", "mtmberahkmffekuuz", "nyfmkuwyeqhkgwehdjakbjheujj", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	_, err = poller.PollUntilDone(ctx, nil)
