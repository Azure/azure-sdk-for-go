...
//     method.
func (client *EnvironmentClient) CreateOrUpdate(ctx context.Context, resourceGroupName string, organizationName string, environmentID string, body SCEnvironmentRecord, options *EnvironmentClientCreateOrUpdateOptions) (EnvironmentClientCreateOrUpdateResponse, error) {
	var err error
	const operationName = "EnvironmentClient.CreateOrUpdate"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.createOrUpdateCreateRequest(ctx, resourceGroupName, organizationName, environmentID, body, options)
	if err != nil {
