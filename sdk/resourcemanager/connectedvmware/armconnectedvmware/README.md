...
```go
client, err := armconnectedvmware.NewDatastoresClient(<subscription ID>, cred, nil)
```
...
client, err := armconnectedvmware.NewDatastoresClient(<subscription ID>, cred, &options)
```
