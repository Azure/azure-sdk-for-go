...
func (r *ReservationsDetailsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if reservationsDetailsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = reservationsDetailsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to ReservationsDetailsServerTransport
var reservationsDetailsServerTransportInterceptor interface {
