...
func ExampleReservationRecommendationDetailsClient_Get() {
	...
	client := armconsumption.NewReservationRecommendationDetailsClient(cred, nil)
	res, err := client.Get(ctx,
		"<scope>",
		"<region>",
		armconsumption.Term("P1Y"),
		armconsumption.LookBackPeriod("Last60Days"),
		"<product>",
		nil)
	if err != nil {
		log.Fatal(err)
	}
	log.Printf("Response result: %#v\n", res.ReservationRecommendationDetailsClientGetResult)
}
