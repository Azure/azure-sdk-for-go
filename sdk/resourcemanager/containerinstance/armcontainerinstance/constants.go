...
// OperationsOrigin - The intended executor of the operation.
type OperationsOrigin string

const (
	// OperationsOriginSystem - System
	OperationsOriginSystem OperationsOrigin = "System"
	// OperationsOriginUser - User
	OperationsOriginUser OperationsOrigin = "User"
)

// PossibleOperationsOriginValues returns the possible values for the OperationsOrigin const type.
func PossibleOperationsOriginValues() []OperationsOrigin {
	return []OperationsOrigin{
