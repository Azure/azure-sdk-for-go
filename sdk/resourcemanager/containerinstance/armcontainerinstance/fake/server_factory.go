...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "CGProfilesClient":
		initServer(&s.trMu, &s.trCGProfilesServer, func() *CGProfilesServerTransport { return NewCGProfilesServerTransport(&s.srv.CGProfilesServer) })
		resp, err = s.trCGProfilesServer.Do(req)
	case "ContainerGroupsClient":
		initServer(&s.trMu, &s.trContainerGroupsServer, func() *ContainerGroupsServerTransport {
