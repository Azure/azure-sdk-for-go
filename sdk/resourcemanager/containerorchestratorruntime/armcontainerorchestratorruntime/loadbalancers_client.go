...
func (client *LoadBalancersClient) Delete(ctx context.Context, resourceURI string, loadBalancerName string, options *LoadBalancersClientDeleteOptions) (LoadBalancersClientDeleteResponse, error) {
	...
	if !runtime.HasStatusCode(httpResp, http.StatusOK, http.StatusNoContent) {
		return LoadBalancersClientDeleteResponse{}, runtime.NewResponseError(httpResp)
	}
...
func (client *LoadBalancersClient) listCreateRequest(ctx context.Context, resourceURI string, nextLink string, _ *LoadBalancersClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
