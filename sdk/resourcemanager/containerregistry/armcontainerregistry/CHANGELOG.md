...
- Type of `AgentPool.SystemData` has been changed from `*SystemData` to `*SystemDataAutoGenerated`
- Type of `Run.SystemData` has been changed from `*SystemData` to `*SystemDataAutoGenerated`
- Type of `SystemData.LastModifiedByType` has been changed from `*LastModifiedByType` to `*CreatedByType`
- Type of `Task.Identity` has been changed from `*IdentityProperties` to `*IdentityPropertiesAutoGenerated`
- Type of `Task.SystemData` has been changed from `*SystemData` to `*SystemDataAutoGenerated`
- Type of `TaskRun.Identity` has been changed from `*IdentityProperties` to `*IdentityPropertiesAutoGenerated`
- Type of `TaskRun.SystemData` has been changed from `*SystemData` to `*SystemDataAutoGenerated`
- Type of `TaskRunUpdateParameters.Identity` has been changed from `*IdentityProperties` to `*IdentityPropertiesAutoGenerated`
- Type of `TaskUpdateParameters.Identity` has been changed from `*IdentityProperties` to `*IdentityPropertiesAutoGenerated`
...
- New struct `IdentityPropertiesAutoGenerated`
