...
Azure Container Registry modules consist of one or more clients.  We provide a client factory which could be used to create any client in this module.
...
client, err := armcontainerregistry.NewClientFactory(<subscription ID>, cred, &options)
```
