...
func (client *ArchivesClient) getHandleResponse(resp *http.Response, successCodes ...int) (ArchivesClientGetResponse, error) {
...
func (client *ArchivesClient) NewListPager(resourceGroupName string, registryName string, packageType string, options *ArchivesClientListOptions) *runtime.Pager[ArchivesClientListResponse] {
	return runtime.NewPager(runtime.PagingHandler[ArchivesClientListResponse]{
		...
		Fetcher: func(ctx context.Context, page *ArchivesClientListResponse) (ArchivesClientListResponse, error) {
			...
			req, err := client.listCreateRequest(ctx, resourceGroupName, registryName, packageType, nextLink, options)
			if err != nil {
...
func (client *ArchivesClient) listCreateRequest(ctx context.Context, resourceGroupName string, registryName string, packageType string, nextLink string, _ *ArchivesClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *ArchivesClient) listHandleResponse(resp *http.Response, successCodes ...int) (ArchivesClientListResponse, error) {
...
func (client *ArchivesClient) updateHandleResponse(resp *http.Response, successCodes ...int) (ArchivesClientUpdateResponse, error) {
