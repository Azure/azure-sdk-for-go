...
func (client *ArchiveVersionsClient) getHandleResponse(resp *http.Response, successCodes ...int) (ArchiveVersionsClientGetResponse, error) {
...
func (client *ArchiveVersionsClient) NewListPager(resourceGroupName string, registryName string, packageType string, archiveName string, options *ArchiveVersionsClientListOptions) *runtime.Pager[ArchiveVersionsClientListResponse] {
	return runtime.NewPager(runtime.PagingHandler[ArchiveVersionsClientListResponse]{
		...
		Fetcher: func(ctx context.Context, page *ArchiveVersionsClientListResponse) (ArchiveVersionsClientListResponse, error) {
			...
			req, err := client.listCreateRequest(ctx, resourceGroupName, registryName, packageType, archiveName, nextLink, options)
			if err != nil {
...
func (client *ArchiveVersionsClient) listCreateRequest(ctx context.Context, resourceGroupName string, registryName string, packageType string, archiveName string, nextLink string, _ *ArchiveVersionsClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *ArchiveVersionsClient) listHandleResponse(resp *http.Response, successCodes ...int) (ArchiveVersionsClientListResponse, error) {
