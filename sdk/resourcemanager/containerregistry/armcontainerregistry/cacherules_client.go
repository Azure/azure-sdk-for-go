...
func (client *CacheRulesClient) listCreateRequest(ctx context.Context, resourceGroupName string, registryName string, _ *CacheRulesClientListOptions) (*policy.Request, error) {
