...
// EndpointProtocol - The connectivity protocol for the registry.
type EndpointProtocol string

const (
	// EndpointProtocolIPv4 - IPv4 connectivity only
	EndpointProtocolIPv4 EndpointProtocol = "IPv4"
	// EndpointProtocolIPv4AndIPv6 - IPv4 and IPv6 (dual stack) connectivity
	EndpointProtocolIPv4AndIPv6 EndpointProtocol = "IPv4AndIPv6"
)
...
func PossibleEndpointProtocolValues() []EndpointProtocol {
	return []EndpointProtocol{
		EndpointProtocolIPv4,
		EndpointProtocolIPv4AndIPv6,
	}
}
...
// RegionalEndpoints - Whether or not per-region endpoints are enabled for accessing the registry.
type RegionalEndpoints string

const (
	// RegionalEndpointsDisabled - Regional endpoints are disabled.
	RegionalEndpointsDisabled RegionalEndpoints = "Disabled"
	// RegionalEndpointsEnabled - Regional endpoints are enabled.
	RegionalEndpointsEnabled RegionalEndpoints = "Enabled"
)

// PossibleRegionalEndpointsValues returns the possible values for the RegionalEndpoints const type.
func PossibleRegionalEndpointsValues() []RegionalEndpoints {
	return []RegionalEndpoints{
		RegionalEndpointsDisabled,
		RegionalEndpointsEnabled,
	}
}
...
const (
	// StorageAccessModeManagedIdentity - Managed Identity access mode
	StorageAccessModeManagedIdentity StorageAccessMode = "ManagedIdentity"
	// StorageAccessModeSasToken - SAS Token access mode
...
// SyncState - The action that triggered the most recent registry sync.
type SyncState string

const (
	// SyncStateFailed - Connected Registry sync failed
	SyncStateFailed SyncState = "Failed"
	// SyncStateNotActivated - Connected Registry is not activated
	SyncStateNotActivated SyncState = "NotActivated"
	// SyncStatePending - Connected Registry sync is pending
	SyncStatePending SyncState = "Pending"
	// SyncStateSucceeded - Connected Registry sync succeeded
	SyncStateSucceeded SyncState = "Succeeded"
	// SyncStateSyncing - Connected Registry is syncing
	SyncStateSyncing SyncState = "Syncing"
	// SyncStateTimedOut - Connected Registry sync timed out
	SyncStateTimedOut SyncState = "TimedOut"
)

// PossibleSyncStateValues returns the possible values for the SyncState const type.
func PossibleSyncStateValues() []SyncState {
	return []SyncState{
		SyncStateFailed,
		SyncStateNotActivated,
		SyncStatePending,
		SyncStateSucceeded,
		SyncStateSyncing,
		SyncStateTimedOut,
...
// SyncTrigger - The status of the connected registry's most recent sync.
type SyncTrigger string

const (
	// SyncTriggerInitialSync - Connected Registry sync was triggered by an initial sync during activation
	SyncTriggerInitialSync SyncTrigger = "InitialSync"
	// SyncTriggerManualResync - Connected Registry sync was triggered by a manual resync request
	SyncTriggerManualResync SyncTrigger = "ManualResync"
	// SyncTriggerRecoveryService - Connected Registry sync was triggered by the Connected Registry's recovery service
	SyncTriggerRecoveryService SyncTrigger = "RecoveryService"
	// SyncTriggerSyncTokenUpdate - Connected Registry sync was triggered by a sync token update
	SyncTriggerSyncTokenUpdate SyncTrigger = "SyncTokenUpdate"
)

// PossibleSyncTriggerValues returns the possible values for the SyncTrigger const type.
func PossibleSyncTriggerValues() []SyncTrigger {
	return []SyncTrigger{
		SyncTriggerInitialSync,
		SyncTriggerManualResync,
		SyncTriggerRecoveryService,
		SyncTriggerSyncTokenUpdate,
	}
}
