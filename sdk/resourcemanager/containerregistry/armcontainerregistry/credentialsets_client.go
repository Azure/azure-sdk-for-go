...
func (client *CredentialSetsClient) listCreateRequest(ctx context.Context, resourceGroupName string, registryName string, _ *CredentialSetsClientListOptions) (*policy.Request, error) {
