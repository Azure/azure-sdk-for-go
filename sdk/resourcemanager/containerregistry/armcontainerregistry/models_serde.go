...
// MarshalJSON implements the json.Marshaller interface for type IdentityPropertiesAutoGenerated.
func (i IdentityPropertiesAutoGenerated) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "principalId", i.PrincipalID)
	populate(objectMap, "tenantId", i.TenantID)
	populate(objectMap, "type", i.Type)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type IdentityPropertiesAutoGenerated.
func (i *IdentityPropertiesAutoGenerated) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", i, err)
	}
