...
// MarshalJSON implements the json.Marshaller interface for type ConnectedRegistryPropertiesActivation.
func (c ConnectedRegistryPropertiesActivation) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "status", c.Status)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ConnectedRegistryPropertiesActivation.
func (c *ConnectedRegistryPropertiesActivation) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type ConnectedRegistryUpdateParametersProperties.
func (c ConnectedRegistryUpdateParametersProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "clientTokenIds", c.ClientTokenIDs)
	populate(objectMap, "garbageCollection", c.GarbageCollection)
	populate(objectMap, "logging", c.Logging)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type ConnectedRegistryUpdateParametersProperties.
func (c *ConnectedRegistryUpdateParametersProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type LoginServerPropertiesTLS.
func (l LoginServerPropertiesTLS) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "certificate", l.Certificate)
	populate(objectMap, "status", l.Status)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type LoginServerPropertiesTLS.
func (l *LoginServerPropertiesTLS) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", l, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "certificate":
			err = unpopulate(val, "Certificate", &l.Certificate)
			delete(rawMsg, key)
		case "status":
...
// MarshalJSON implements the json.Marshaller interface for type TLSPropertiesCertificate.
func (t TLSPropertiesCertificate) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type TLSPropertiesCertificate.
func (t *TLSPropertiesCertificate) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
