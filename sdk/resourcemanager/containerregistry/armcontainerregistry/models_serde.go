...
// MarshalJSON implements the json.Marshaller interface for type AdditionalAuthenticationProperties.
func (a AdditionalAuthenticationProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "authenticationType", a.AuthenticationType)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type AdditionalAuthenticationProperties.
func (a *AdditionalAuthenticationProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %s", a, err.Error())
	}
...
func (c CacheRuleProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "additionalAuthenticationProperties", c.AdditionalAuthenticationProperties)
...
func (c *CacheRuleProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		var err error
		switch key {
		case "additionalAuthenticationProperties":
			c.AdditionalAuthenticationProperties, err = unmarshalAdditionalAuthenticationPropertiesClassification(val)
			delete(rawMsg, key)
		case "creationDate":
...
func (c ConnectedRegistryProperties) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "lastActivityTime", c.LastActivityTime, true)
...
// MarshalJSON implements the json.Marshaller interface for type GarAuthenticationProperties.
func (g GarAuthenticationProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	objectMap["authenticationType"] = AdditionalAuthenticationTypeGoogleArtifactRegistry
	populate(objectMap, "projectNumber", g.ProjectNumber)
	populate(objectMap, "workloadIdentityPool", g.WorkloadIdentityPool)
	populate(objectMap, "workloadIdentityProvider", g.WorkloadIdentityProvider)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type GarAuthenticationProperties.
func (g *GarAuthenticationProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
	...
	for key, val := range rawMsg {
		...
		case "projectNumber":
			...
			delete(rawMsg, key)
		case "workloadIdentityPool":
			err = unpopulate(val, "WorkloadIdentityPool", &g.WorkloadIdentityPool)
			delete(rawMsg, key)
		case "workloadIdentityProvider":
			err = unpopulate(val, "WorkloadIdentityProvider", &g.WorkloadIdentityProvider)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %s", g, err.Error())
...
func (p PipelineRunResponse) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "catalogDigest", p.CatalogDigest)
	populateTime[datetime.RFC3339](objectMap, "finishTime", p.FinishTime, true)
...
func (r RegistryProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "writableCacheRepos", r.WritableCacheRepos)
...
func (r *RegistryProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "status":
			...
			delete(rawMsg, key)
		case "writableCacheRepos":
			err = unpopulate(val, "WritableCacheRepos", &r.WritableCacheRepos)
			delete(rawMsg, key)
		case "zoneRedundancy":
...
func (r RegistrySyncResult) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateTime[datetime.RFC3339](objectMap, "lastSuccessfulSyncEndTime", r.LastSuccessfulSyncEndTime, true)
	populateTime[datetime.RFC3339](objectMap, "lastSyncEndTime", r.LastSyncEndTime, true)
	populateTime[datetime.RFC3339](objectMap, "lastSyncStartTime", r.LastSyncStartTime, true)
...
func (r RetentionPolicy) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "lastUpdatedTime", r.LastUpdatedTime, true)
	populate(objectMap, "status", r.Status)
	return json.Marshal(objectMap)
}
...
func (s SoftDeletePolicy) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateTime[datetime.RFC3339](objectMap, "lastUpdatedTime", s.LastUpdatedTime, true)
...
func (s StatusDetailProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "availableGib", s.AvailableGib)
	populate(objectMap, "code", s.Code)
	populate(objectMap, "correlationId", s.CorrelationID)
	populate(objectMap, "description", s.Description)
	populateTime[datetime.RFC3339](objectMap, "timestamp", s.Timestamp, true)
	populate(objectMap, "totalGib", s.TotalGib)
	populate(objectMap, "type", s.Type)
	return json.Marshal(objectMap)
}
...
func (s *StatusDetailProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "availableGib":
			err = unpopulate(val, "AvailableGib", &s.AvailableGib)
			delete(rawMsg, key)
		case "code":
		...
		case "timestamp":
			...
			delete(rawMsg, key)
		case "totalGib":
			err = unpopulate(val, "TotalGib", &s.TotalGib)
			delete(rawMsg, key)
		case "type":
			err = unpopulate(val, "Type", &s.Type)
			delete(rawMsg, key)
...
func (t TokenCertificate) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "expiry", t.Expiry, true)
	populate(objectMap, "name", t.Name)
...
func (t TokenPassword) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateTime[datetime.RFC3339](objectMap, "creationTime", t.CreationTime, true)
	populateTime[datetime.RFC3339](objectMap, "expiry", t.Expiry, true)
	populate(objectMap, "name", t.Name)
	populate(objectMap, "value", t.Value)
	return json.Marshal(objectMap)
...
func (t TokenProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateTime[datetime.RFC3339](objectMap, "creationDate", t.CreationDate, true)
...
func (v VirtualNetworkRule) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "virtualNetworkSubnetResourceId", v.VirtualNetworkSubnetResourceID)
	return json.Marshal(objectMap)
}
...
func (v *VirtualNetworkRule) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "virtualNetworkSubnetResourceId":
			err = unpopulate(val, "VirtualNetworkSubnetResourceID", &v.VirtualNetworkSubnetResourceID)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %s", v, err.Error())
