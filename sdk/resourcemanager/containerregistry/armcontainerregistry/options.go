...
// ConnectedRegistriesClientResyncOptions contains the optional parameters for the ConnectedRegistriesClient.Resync method.
type ConnectedRegistriesClientResyncOptions struct {
	// placeholder for future optional parameters
}
