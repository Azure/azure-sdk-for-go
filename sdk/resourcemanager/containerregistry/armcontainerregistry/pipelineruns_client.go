...
func (client *PipelineRunsClient) listCreateRequest(ctx context.Context, resourceGroupName string, registryName string, nextLink string, _ *PipelineRunsClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *PipelineRunsClient) listHandleResponse(resp *http.Response, successCodes ...int) (PipelineRunsClientListResponse, error) {
