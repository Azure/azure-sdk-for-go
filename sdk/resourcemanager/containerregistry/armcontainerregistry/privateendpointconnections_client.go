...
func (client *PrivateEndpointConnectionsClient) listCreateRequest(ctx context.Context, resourceGroupName string, registryName string, nextLink string, _ *PrivateEndpointConnectionsClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
