...
// NewListUsagesPager - Gets the quota usages for the specified container registry.
//
// Generated from API version 2025-11-01
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - registryName - The name of the container registry.
//   - options - RegistriesClientListUsagesOptions contains the optional parameters for the RegistriesClient.NewListUsagesPager
//     method.
func (client *RegistriesClient) NewListUsagesPager(resourceGroupName string, registryName string, options *RegistriesClientListUsagesOptions) *runtime.Pager[RegistriesClientListUsagesResponse] {
	return runtime.NewPager(runtime.PagingHandler[RegistriesClientListUsagesResponse]{
		More: func(page RegistriesClientListUsagesResponse) bool {
			return false
		},
		Fetcher: func(ctx context.Context, page *RegistriesClientListUsagesResponse) (RegistriesClientListUsagesResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "RegistriesClient.NewListUsagesPager")
