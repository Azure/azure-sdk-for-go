...
func (client *ReplicationsClient) listCreateRequest(ctx context.Context, resourceGroupName string, registryName string, _ *ReplicationsClientListOptions) (*policy.Request, error) {
