...
func (client *ScopeMapsClient) listCreateRequest(ctx context.Context, resourceGroupName string, registryName string, _ *ScopeMapsClientListOptions) (*policy.Request, error) {
