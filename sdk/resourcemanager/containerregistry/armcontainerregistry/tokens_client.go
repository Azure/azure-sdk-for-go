...
func (client *TokensClient) listCreateRequest(ctx context.Context, resourceGroupName string, registryName string, _ *TokensClientListOptions) (*policy.Request, error) {
