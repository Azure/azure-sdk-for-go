...
// TasksServer is a fake server for instances of the armcontainerregistrytasks.TasksClient type.
type TasksServer struct {
	// Create is the fake for method TasksClient.Create
	// HTTP status codes to indicate success: http.StatusOK, http.StatusCreated
	Create func(ctx context.Context, resourceGroupName string, registryName string, taskName string, taskCreateParameters armcontainerregistrytasks.Task, options *armcontainerregistrytasks.TasksClientCreateOptions) (resp azfake.Responder[armcontainerregistrytasks.TasksClientCreateResponse], errResp azfake.ErrorResponder)

	// Delete is the fake for method TasksClient.Delete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	Delete func(ctx context.Context, resourceGroupName string, registryName string, taskName string, options *armcontainerregistrytasks.TasksClientDeleteOptions) (resp azfake.Responder[armcontainerregistrytasks.TasksClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method TasksClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, registryName string, taskName string, options *armcontainerregistrytasks.TasksClientGetOptions) (resp azfake.Responder[armcontainerregistrytasks.TasksClientGetResponse], errResp azfake.ErrorResponder)

	// GetDetails is the fake for method TasksClient.GetDetails
	// HTTP status codes to indicate success: http.StatusOK
	GetDetails func(ctx context.Context, resourceGroupName string, registryName string, taskName string, options *armcontainerregistrytasks.TasksClientGetDetailsOptions) (resp azfake.Responder[armcontainerregistrytasks.TasksClientGetDetailsResponse], errResp azfake.ErrorResponder)

	// NewListPager is the fake for method TasksClient.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager func(resourceGroupName string, registryName string, options *armcontainerregistrytasks.TasksClientListOptions) (resp azfake.PagerResponder[armcontainerregistrytasks.TasksClientListResponse])

	// Update is the fake for method TasksClient.Update
	// HTTP status codes to indicate success: http.StatusOK
	Update func(ctx context.Context, resourceGroupName string, registryName string, taskName string, taskUpdateParameters armcontainerregistrytasks.TaskUpdateParameters, options *armcontainerregistrytasks.TasksClientUpdateOptions) (resp azfake.Responder[armcontainerregistrytasks.TasksClientUpdateResponse], errResp azfake.ErrorResponder)
}

// NewTasksServerTransport creates a new instance of TasksServerTransport with the provided implementation.
// The returned TasksServerTransport instance is connected to an instance of armcontainerregistrytasks.TasksClient via the
// azcore.ClientOptions.Transporter field in the client's constructor parameters.
func NewTasksServerTransport(srv *TasksServer) *TasksServerTransport {
	return &TasksServerTransport{
		srv:          srv,
		newListPager: newTracker[azfake.PagerResponder[armcontainerregistrytasks.TasksClientListResponse]](),
	}
}

// TasksServerTransport connects instances of armcontainerregistrytasks.TasksClient to instances of TasksServer.
// Don't use this type directly, use NewTasksServerTransport instead.
type TasksServerTransport struct {
	srv          *TasksServer
	newListPager *tracker[azfake.PagerResponder[armcontainerregistrytasks.TasksClientListResponse]]
}
...
func (t *TasksServerTransport) dispatchCreate(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[armcontainerregistrytasks.Task](req)
	if err != nil {
		return nil, err
	}
...
func (t *TasksServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armcontainerregistrytasks.TasksClientListResponse, createLink func() string) {
...
func (t *TasksServerTransport) dispatchUpdate(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[armcontainerregistrytasks.TaskUpdateParameters](req)
	if err != nil {
		return nil, err
	}
	resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
