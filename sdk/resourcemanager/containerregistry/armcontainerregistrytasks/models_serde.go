...
func (r RunProperties) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "createTime", r.CreateTime, true)
	populate(objectMap, "customRegistries", r.CustomRegistries)
	populateTime[datetime.RFC3339](objectMap, "finishTime", r.FinishTime, true)
...
func (r *RunProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "agentPoolName":
			...
			delete(rawMsg, key)
		case "createTime":
			err = unpopulateTime[datetime.RFC3339](val, "CreateTime", &r.CreateTime)
			delete(rawMsg, key)
		case "customRegistries":
			err = unpopulate(val, "CustomRegistries", &r.CustomRegistries)
			delete(rawMsg, key)
		case "finishTime":
			err = unpopulateTime[datetime.RFC3339](val, "FinishTime", &r.FinishTime)
			delete(rawMsg, key)
