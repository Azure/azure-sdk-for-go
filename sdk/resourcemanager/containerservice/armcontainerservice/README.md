...
Azure Container Service modules consist of one or more clients.  We provide a client factory which could be used to create any client in this module.
...
client, err := armcontainerservice.NewClientFactory(<subscription ID>, cred, &options)
```
