...
// AbortLatestOperation - Aborting last running operation on agent pool. We return a 204 no content code here to indicate
// that the operation has been accepted and an abort will be attempted but is not guaranteed to complete
// successfully. Please look up the provisioning state of the agent pool to keep track of whether it changes to Canceled.
// A canceled provisioning state indicates that the abort was successful
// If the operation fails it returns an *azcore.ResponseError type.
// Generated from API version 2022-08-02-preview
// resourceGroupName - The name of the resource group. The name is case insensitive.
// resourceName - The name of the managed cluster resource.
// agentPoolName - The name of the agent pool.
// options - AgentPoolsClientAbortLatestOperationOptions contains the optional parameters for the AgentPoolsClient.AbortLatestOperation
// method.
func (client *AgentPoolsClient) AbortLatestOperation(ctx context.Context, resourceGroupName string, resourceName string, agentPoolName string, options *AgentPoolsClientAbortLatestOperationOptions) (AgentPoolsClientAbortLatestOperationResponse, error) {
	req, err := client.abortLatestOperationCreateRequest(ctx, resourceGroupName, resourceName, agentPoolName, options)
	if err != nil {
		return AgentPoolsClientAbortLatestOperationResponse{}, err
	}
	...
	if !runtime.HasStatusCode(resp, http.StatusNoContent) {
		return AgentPoolsClientAbortLatestOperationResponse{}, runtime.NewResponseError(resp)
	}
	return AgentPoolsClientAbortLatestOperationResponse{}, nil
}

// abortLatestOperationCreateRequest creates the AbortLatestOperation request.
func (client *AgentPoolsClient) abortLatestOperationCreateRequest(ctx context.Context, resourceGroupName string, resourceName string, agentPoolName string, options *AgentPoolsClientAbortLatestOperationOptions) (*policy.Request, error) {
