...
// NewListNodeImageVersionsPager - Gets a list of supported NodeImage versions in the specified subscription.
//
...
func (client *Client) NewListNodeImageVersionsPager(location string, options *ClientListNodeImageVersionsOptions) *runtime.Pager[ClientListNodeImageVersionsResponse] {
	return runtime.NewPager(runtime.PagingHandler[ClientListNodeImageVersionsResponse]{
		...
		Fetcher: func(ctx context.Context, page *ClientListNodeImageVersionsResponse) (ClientListNodeImageVersionsResponse, error) {
			...
			req, err := client.listNodeImageVersionsCreateRequest(ctx, location, nextLink, options)
			if err != nil {
			...
			return client.listNodeImageVersionsHandleResponse(resp, http.StatusOK)
		},
...
func (client *Client) listNodeImageVersionsCreateRequest(ctx context.Context, location string, nextLink string, _ *ClientListNodeImageVersionsOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *Client) listNodeImageVersionsHandleResponse(resp *http.Response, successCodes ...int) (ClientListNodeImageVersionsResponse, error) {
