...
// DriftAction - Indicates whether a machine has deviated from its expected state due to changes in managed cluster properties,
...
// VMState - Indicates the current state of the underlying virtual machine.
type VMState string
