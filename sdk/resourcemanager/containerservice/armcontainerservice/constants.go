...
// HTTP, Kafka). Policies themselves must be configured via the Cilium Network Policy resources, see https://docs.cilium.io/en/latest/security/policy/index.html.
// This can be enabled only on cilium-based clusters. If not specified, the default value is FQDN if security.enabled is set
// to true.
...
const (
	// ConnectionStatusApproved - Connection is approved.
	ConnectionStatusApproved ConnectionStatus = "Approved"
	// ConnectionStatusDisconnected - Connection is disconnected.
	ConnectionStatusDisconnected ConnectionStatus = "Disconnected"
	// ConnectionStatusPending - Connection is pending approval.
	ConnectionStatusPending ConnectionStatus = "Pending"
	// ConnectionStatusRejected - Connection is rejected.
...
const (
	// ExtendedLocationTypesEdgeZone - Azure Edge Zone extended location type.
...
// Format - The format of the kubeconfig credential.
type Format string
...
const (
	// GPUInstanceProfileMIG1G - MIG 1g GPU instance profile.
	GPUInstanceProfileMIG1G GPUInstanceProfile = "MIG1g"
	// GPUInstanceProfileMIG2G - MIG 2g GPU instance profile.
	GPUInstanceProfileMIG2G GPUInstanceProfile = "MIG2g"
	// GPUInstanceProfileMIG3G - MIG 3g GPU instance profile.
	GPUInstanceProfileMIG3G GPUInstanceProfile = "MIG3g"
	// GPUInstanceProfileMIG4G - MIG 4g GPU instance profile.
	GPUInstanceProfileMIG4G GPUInstanceProfile = "MIG4g"
	// GPUInstanceProfileMIG7G - MIG 7g GPU instance profile.
...
// and `Private`. `Public` means the key vault allows public access from all networks. `Private` means the key vault disables
// public access and enables private link. The default value is `Public`.
type KeyVaultNetworkAccessTypes string

const (
	// KeyVaultNetworkAccessTypesPrivate - Key vault disables public access and enables private link.
	KeyVaultNetworkAccessTypesPrivate KeyVaultNetworkAccessTypes = "Private"
	// KeyVaultNetworkAccessTypesPublic - Key vault allows public access from all networks.
...
// LoadBalancerSKU - The load balancer sku for the managed cluster. The default is 'standard'. See [Azure Load Balancer SKUs](https://docs.microsoft.com/azure/load-balancer/skus)
...
// ManagedClusterSKUTier - The tier of a managed cluster SKU. If not specified, the default is 'Free'. See [AKS Pricing Tier](https://learn.microsoft.com/azure/aks/free-standard-pricing-tiers)
// for more details.
...
const (
	// NamespaceProvisioningStateCanceled - The namespace provisioning was canceled.
	NamespaceProvisioningStateCanceled NamespaceProvisioningState = "Canceled"
	// NamespaceProvisioningStateCreating - The namespace is being created.
	NamespaceProvisioningStateCreating NamespaceProvisioningState = "Creating"
	// NamespaceProvisioningStateDeleting - The namespace is being deleted.
	NamespaceProvisioningStateDeleting NamespaceProvisioningState = "Deleting"
	// NamespaceProvisioningStateFailed - The namespace provisioning failed.
	NamespaceProvisioningStateFailed NamespaceProvisioningState = "Failed"
	// NamespaceProvisioningStateSucceeded - The namespace provisioning succeeded.
	NamespaceProvisioningStateSucceeded NamespaceProvisioningState = "Succeeded"
	// NamespaceProvisioningStateUpdating - The namespace is being updated.
...
// field has no effect unless mode is 'Auto'. Warning: Changing this from Auto to None on an existing cluster will cause the
// default Karpenter NodePools to be deleted, which will drain and delete the nodes associated with those pools. It is strongly
...
const (
	// PrivateEndpointConnectionProvisioningStateCanceled - Private endpoint connection provisioning was canceled.
	PrivateEndpointConnectionProvisioningStateCanceled PrivateEndpointConnectionProvisioningState = "Canceled"
	// PrivateEndpointConnectionProvisioningStateCreating - Private endpoint connection is being created.
	PrivateEndpointConnectionProvisioningStateCreating PrivateEndpointConnectionProvisioningState = "Creating"
	// PrivateEndpointConnectionProvisioningStateDeleting - Private endpoint connection is being deleted.
	PrivateEndpointConnectionProvisioningStateDeleting PrivateEndpointConnectionProvisioningState = "Deleting"
	// PrivateEndpointConnectionProvisioningStateFailed - Private endpoint connection provisioning failed.
	PrivateEndpointConnectionProvisioningStateFailed PrivateEndpointConnectionProvisioningState = "Failed"
	// PrivateEndpointConnectionProvisioningStateSucceeded - Private endpoint connection provisioning succeeded.
...
// VM when it is evicted. The default is Delete. For more information about eviction see [spot VMs](https://docs.microsoft.com/azure/virtual-machines/spot-vms)
...
const (
	// TrustedAccessRoleBindingProvisioningStateCanceled - Trusted access role binding provisioning was canceled.
	TrustedAccessRoleBindingProvisioningStateCanceled TrustedAccessRoleBindingProvisioningState = "Canceled"
	// TrustedAccessRoleBindingProvisioningStateDeleting - Trusted access role binding is being deleted.
	TrustedAccessRoleBindingProvisioningStateDeleting TrustedAccessRoleBindingProvisioningState = "Deleting"
	// TrustedAccessRoleBindingProvisioningStateFailed - Trusted access role binding provisioning failed.
	TrustedAccessRoleBindingProvisioningStateFailed TrustedAccessRoleBindingProvisioningState = "Failed"
	// TrustedAccessRoleBindingProvisioningStateSucceeded - Trusted access role binding provisioning succeeded.
	TrustedAccessRoleBindingProvisioningStateSucceeded TrustedAccessRoleBindingProvisioningState = "Succeeded"
	// TrustedAccessRoleBindingProvisioningStateUpdating - Trusted access role binding is being updated.
...
// nodes is Pod Disruption Budgets (PDBs), but other issues, such as pod termination grace period is exceeding the remaining
...
const (
	// WeekDayFriday - Represents Friday.
	WeekDayFriday WeekDay = "Friday"
	// WeekDayMonday - Represents Monday.
	WeekDayMonday WeekDay = "Monday"
	// WeekDaySaturday - Represents Saturday.
	WeekDaySaturday WeekDay = "Saturday"
	// WeekDaySunday - Represents Sunday.
	WeekDaySunday WeekDay = "Sunday"
	// WeekDayThursday - Represents Thursday.
	WeekDayThursday WeekDay = "Thursday"
	// WeekDayTuesday - Represents Tuesday.
	WeekDayTuesday WeekDay = "Tuesday"
	// WeekDayWednesday - Represents Wednesday.
