...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "ManagedNamespacesClient":
		initServer(&s.trMu, &s.trManagedNamespacesServer, func() *ManagedNamespacesServerTransport {
	...
	case "ResolvePrivateLinkServiceIDClient":
		initServer(&s.trMu, &s.trResolvePrivateLinkServiceIDServer, func() *ResolvePrivateLinkServiceIDServerTransport {
	...
	case "TrustedAccessRoleBindingsClient":
		initServer(&s.trMu, &s.trTrustedAccessRoleBindingsServer, func() *TrustedAccessRoleBindingsServerTransport {
	...
	case "TrustedAccessRolesClient":
		initServer(&s.trMu, &s.trTrustedAccessRolesServer, func() *TrustedAccessRolesServerTransport {
