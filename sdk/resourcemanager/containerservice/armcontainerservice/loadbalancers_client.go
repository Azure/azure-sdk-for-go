...
func (client *LoadBalancersClient) createOrUpdateHandleResponse(resp *http.Response, successCodes ...int) (LoadBalancersClientCreateOrUpdateResponse, error) {
...
func (client *LoadBalancersClient) getHandleResponse(resp *http.Response, successCodes ...int) (LoadBalancersClientGetResponse, error) {
...
func (client *LoadBalancersClient) listByManagedClusterCreateRequest(ctx context.Context, resourceGroupName string, resourceName string, nextLink string, _ *LoadBalancersClientListByManagedClusterOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *LoadBalancersClient) listByManagedClusterHandleResponse(resp *http.Response, successCodes ...int) (LoadBalancersClientListByManagedClusterResponse, error) {
