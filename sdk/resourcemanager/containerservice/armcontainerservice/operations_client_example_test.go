...
// Generated from example definition: 2026-02-02-preview/Operation_List.json
func ExampleOperationsClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armcontainerservice.OperationsClientListResponse{
		// 	OperationListResult: armcontainerservice.OperationListResult{
