...
const defaultPrivateEndpointConnectionsClientVersion string = "2026-03-02-preview"
...
// Get - Gets the specified private endpoint connection.
//
...
// List - Gets a list of private endpoint connections in the specified managed cluster.
//
// To learn more about private clusters, see: https://docs.microsoft.com/azure/aks/private-clusters
// If the operation fails it returns an *azcore.ResponseError type.
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
