...
const defaultPrivateLinkResourcesClientVersion string = "2026-03-02-preview"
...
// List - Gets a list of private link resources in the specified managed cluster.
//
...
func (client *PrivateLinkResourcesClient) listCreateRequest(ctx context.Context, resourceGroupName string, resourceName string, _ *PrivateLinkResourcesClientListOptions) (*policy.Request, error) {
	...
	reqQP.Set("api-version", defaultPrivateLinkResourcesClientVersion)
