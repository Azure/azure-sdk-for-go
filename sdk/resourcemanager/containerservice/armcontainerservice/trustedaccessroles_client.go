...
func (client *TrustedAccessRolesClient) listCreateRequest(ctx context.Context, location string, nextLink string, _ *TrustedAccessRolesClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *TrustedAccessRolesClient) listHandleResponse(resp *http.Response, successCodes ...int) (TrustedAccessRolesClientListResponse, error) {
