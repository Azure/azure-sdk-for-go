...
func (client *FleetsClient) listBySubscriptionCreateRequest(ctx context.Context, nextLink string, options *FleetsClientListBySubscriptionOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
	var req *policy.Request
	var err error
	if firstPage {
...
func (client *FleetsClient) listCredentialsHandleResponse(resp *http.Response, successCodes ...int) (FleetsClientListCredentialsResponse, error) {
