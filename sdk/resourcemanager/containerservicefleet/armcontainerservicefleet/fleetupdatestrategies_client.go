...
func (client *FleetUpdateStrategiesClient) getHandleResponse(resp *http.Response, successCodes ...int) (FleetUpdateStrategiesClientGetResponse, error) {
...
func (client *FleetUpdateStrategiesClient) listByFleetCreateRequest(ctx context.Context, resourceGroupName string, fleetName string, nextLink string, options *FleetUpdateStrategiesClientListByFleetOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *FleetUpdateStrategiesClient) listByFleetHandleResponse(resp *http.Response, successCodes ...int) (FleetUpdateStrategiesClientListByFleetResponse, error) {
