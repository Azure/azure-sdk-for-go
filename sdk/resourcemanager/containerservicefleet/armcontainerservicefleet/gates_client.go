...
func (client *GatesClient) getHandleResponse(resp *http.Response, successCodes ...int) (GatesClientGetResponse, error) {
...
func (client *GatesClient) listByFleetCreateRequest(ctx context.Context, resourceGroupName string, fleetName string, nextLink string, options *GatesClientListByFleetOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *GatesClient) listByFleetHandleResponse(resp *http.Response, successCodes ...int) (GatesClientListByFleetResponse, error) {
