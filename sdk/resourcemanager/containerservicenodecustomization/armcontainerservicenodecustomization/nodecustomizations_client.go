...
// BeginCreateOrUpdate - Deprecated: Create or update a node customization resource. This will create a new version. Use Prepared
...
// CreateOrUpdate - Deprecated: Create or update a node customization resource. This will create a new version. Use Prepared
// Image Specification APIs instead.
// If the operation fails it returns an *azcore.ResponseError type.
...
// BeginDelete - Deprecated: Delete a node customization. This operation will be blocked if the resource is in use. Use Prepared
// Image Specification APIs instead.
// If the operation fails it returns an *azcore.ResponseError type.
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - nodeCustomizationName - The name of the Node Customization resource.
...
// Delete - Deprecated: Delete a node customization. This operation will be blocked if the resource is in use. Use Prepared
// Image Specification APIs instead.
// If the operation fails it returns an *azcore.ResponseError type.
...
// BeginDeleteVersion - Deprecated: Delete a node customization version. This operation will be blocked if the node customization
// version is in use. Use Prepared Image Specification APIs instead.
// If the operation fails it returns an *azcore.ResponseError type.
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - nodeCustomizationName - The name of the Node Customization resource.
...
// DeleteVersion - Deprecated: Delete a node customization version. This operation will be blocked if the node customization
// version is in use. Use Prepared Image Specification APIs instead.
// If the operation fails it returns an *azcore.ResponseError type.
...
// Get - Deprecated: Get a node customization at the latest version. Use Prepared Image Specification APIs instead.
// If the operation fails it returns an *azcore.ResponseError type.
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - nodeCustomizationName - The name of the Node Customization resource.
...
func (client *NodeCustomizationsClient) getHandleResponse(resp *http.Response, successCodes ...int) (NodeCustomizationsClientGetResponse, error) {
...
// GetVersion - Deprecated: Get a node customization at a particular version. Use Prepared Image Specification APIs instead.
// If the operation fails it returns an *azcore.ResponseError type.
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - nodeCustomizationName - The name of the Node Customization resource.
//   - version - The version of the Node Customization.
...
func (client *NodeCustomizationsClient) getVersionHandleResponse(resp *http.Response, successCodes ...int) (NodeCustomizationsClientGetVersionResponse, error) {
...
// NewListByResourceGroupPager - Deprecated: List the node customizations in a resource group at the latest version. Use Prepared
// Image Specification APIs instead.
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
...
func (client *NodeCustomizationsClient) listByResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, nextLink string, _ *NodeCustomizationsClientListByResourceGroupOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *NodeCustomizationsClient) listByResourceGroupHandleResponse(resp *http.Response, successCodes ...int) (NodeCustomizationsClientListByResourceGroupResponse, error) {
...
// NewListBySubscriptionPager - Deprecated: List the node customizations in a subscription at the latest version. Use Prepared
// Image Specification APIs instead.
...
func (client *NodeCustomizationsClient) listBySubscriptionCreateRequest(ctx context.Context, nextLink string, _ *NodeCustomizationsClientListBySubscriptionOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
	var req *policy.Request
	var err error
	if firstPage {
...
func (client *NodeCustomizationsClient) listBySubscriptionHandleResponse(resp *http.Response, successCodes ...int) (NodeCustomizationsClientListBySubscriptionResponse, error) {
...
// NewListVersionsPager - Deprecated: List all versions of a node customization. Use Prepared Image Specification APIs instead.
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - nodeCustomizationName - The name of the Node Customization resource.
...
func (client *NodeCustomizationsClient) NewListVersionsPager(resourceGroupName string, nodeCustomizationName string, options *NodeCustomizationsClientListVersionsOptions) *runtime.Pager[NodeCustomizationsClientListVersionsResponse] {
	return runtime.NewPager(runtime.PagingHandler[NodeCustomizationsClientListVersionsResponse]{
		...
		Fetcher: func(ctx context.Context, page *NodeCustomizationsClientListVersionsResponse) (NodeCustomizationsClientListVersionsResponse, error) {
			...
			req, err := client.listVersionsCreateRequest(ctx, resourceGroupName, nodeCustomizationName, nextLink, options)
			if err != nil {
...
func (client *NodeCustomizationsClient) listVersionsCreateRequest(ctx context.Context, resourceGroupName string, nodeCustomizationName string, nextLink string, _ *NodeCustomizationsClientListVersionsOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
	var req *policy.Request
	var err error
	if firstPage {
...
func (client *NodeCustomizationsClient) listVersionsHandleResponse(resp *http.Response, successCodes ...int) (NodeCustomizationsClientListVersionsResponse, error) {
...
// BeginUpdate - Deprecated: Update a node customization. Use Prepared Image Specification APIs instead.
// If the operation fails it returns an *azcore.ResponseError type.
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - nodeCustomizationName - The name of the Node Customization resource.
...
// Update - Deprecated: Update a node customization. Use Prepared Image Specification APIs instead.
// If the operation fails it returns an *azcore.ResponseError type.
