...
const (
	version20260202Preview string = "2026-02-02-preview"
)
...
// PostScriptAction - The action to take after the script finishes successfully.
type PostScriptAction string

const (
	// PostScriptActionNone - No post-script action is taken.
	PostScriptActionNone PostScriptAction = "None"
	// PostScriptActionRebootAfter - Reboot the node after the script completes.
	PostScriptActionRebootAfter PostScriptAction = "RebootAfter"
)

// PossiblePostScriptActionValues returns the possible values for the PostScriptAction const type.
func PossiblePostScriptActionValues() []PostScriptAction {
	return []PostScriptAction{
		PostScriptActionNone,
		PostScriptActionRebootAfter,
	}
}
