...
package armcontainerservicesafeguards

const (
	moduleName    = "github.com/Azure/azure-sdk-for-go/sdk/resourcemanager/containerservicesafeguards/armcontainerservicesafeguards"
...
// DeploymentSafeguardsLevel - Specifies the level of Deployment Safeguards
type DeploymentSafeguardsLevel string

const (
	// DeploymentSafeguardsLevelEnforce - Best practice violations will be denied
	DeploymentSafeguardsLevelEnforce DeploymentSafeguardsLevel = "Enforce"
	// DeploymentSafeguardsLevelWarn - Best practice violations will only show warnings
	DeploymentSafeguardsLevelWarn DeploymentSafeguardsLevel = "Warn"
)

// PossibleDeploymentSafeguardsLevelValues returns the possible values for the DeploymentSafeguardsLevel const type.
func PossibleDeploymentSafeguardsLevelValues() []DeploymentSafeguardsLevel {
	return []DeploymentSafeguardsLevel{
