...
func (client *EmployeesClient) getHandleResponse(resp *http.Response, successCodes ...int) (EmployeesClientGetResponse, error) {
...
func (client *EmployeesClient) listByResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, nextLink string, _ *EmployeesClientListByResourceGroupOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *EmployeesClient) listByResourceGroupHandleResponse(resp *http.Response, successCodes ...int) (EmployeesClientListByResourceGroupResponse, error) {
...
func (client *EmployeesClient) listBySubscriptionCreateRequest(ctx context.Context, nextLink string, _ *EmployeesClientListBySubscriptionOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
	var req *policy.Request
	var err error
	if firstPage {
...
func (client *EmployeesClient) listBySubscriptionHandleResponse(resp *http.Response, successCodes ...int) (EmployeesClientListBySubscriptionResponse, error) {
...
func (client *EmployeesClient) updateHandleResponse(resp *http.Response, successCodes ...int) (EmployeesClientUpdateResponse, error) {
