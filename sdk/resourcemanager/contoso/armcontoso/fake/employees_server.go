...
type EmployeesServer struct {
	...
	BeginCreateOrUpdate func(ctx context.Context, apiVersion string, resourceGroupName string, employeeName string, resource armcontoso.Employee, options *armcontoso.EmployeesClientBeginCreateOrUpdateOptions) (resp azfake.PollerResponder[armcontoso.EmployeesClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)

	// BeginDelete is the fake for method EmployeesClient.BeginDelete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginDelete func(ctx context.Context, apiVersion string, resourceGroupName string, employeeName string, options *armcontoso.EmployeesClientBeginDeleteOptions) (resp azfake.PollerResponder[armcontoso.EmployeesClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method EmployeesClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, apiVersion string, resourceGroupName string, employeeName string, options *armcontoso.EmployeesClientGetOptions) (resp azfake.Responder[armcontoso.EmployeesClientGetResponse], errResp azfake.ErrorResponder)

	// NewListByResourceGroupPager is the fake for method EmployeesClient.NewListByResourceGroupPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByResourceGroupPager func(apiVersion string, resourceGroupName string, options *armcontoso.EmployeesClientListByResourceGroupOptions) (resp azfake.PagerResponder[armcontoso.EmployeesClientListByResourceGroupResponse])

	// NewListBySubscriptionPager is the fake for method EmployeesClient.NewListBySubscriptionPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListBySubscriptionPager func(apiVersion string, options *armcontoso.EmployeesClientListBySubscriptionOptions) (resp azfake.PagerResponder[armcontoso.EmployeesClientListBySubscriptionResponse])

	// Update is the fake for method EmployeesClient.Update
	// HTTP status codes to indicate success: http.StatusOK
	Update func(ctx context.Context, apiVersion string, resourceGroupName string, employeeName string, properties armcontoso.Employee, options *armcontoso.EmployeesClientUpdateOptions) (resp azfake.Responder[armcontoso.EmployeesClientUpdateResponse], errResp azfake.ErrorResponder)
}
...
func (e *EmployeesServerTransport) dispatchBeginCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginCreateOrUpdate == nil {
		...
		respr, errRespr := e.srv.BeginCreateOrUpdate(req.Context(), apiVersionParam, resourceGroupNameParam, employeeNameParam, body, nil)
...
func (e *EmployeesServerTransport) dispatchBeginDelete(req *http.Request) (*http.Response, error) {
	...
	if beginDelete == nil {
		...
		respr, errRespr := e.srv.BeginDelete(req.Context(), apiVersionParam, resourceGroupNameParam, employeeNameParam, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginDelete = &respr
...
func (e *EmployeesServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := e.srv.Get(req.Context(), apiVersionParam, resourceGroupNameParam, employeeNameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
...
func (e *EmployeesServerTransport) dispatchNewListByResourceGroupPager(req *http.Request) (*http.Response, error) {
	...
	if newListByResourceGroupPager == nil {
		...
		resp := e.srv.NewListByResourceGroupPager(apiVersionParam, resourceGroupNameParam, nil)
...
func (e *EmployeesServerTransport) dispatchNewListBySubscriptionPager(req *http.Request) (*http.Response, error) {
	...
	if newListBySubscriptionPager == nil {
		...
		resp := e.srv.NewListBySubscriptionPager(apiVersionParam, nil)
...
func (e *EmployeesServerTransport) dispatchUpdate(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := e.srv.Update(req.Context(), apiVersionParam, resourceGroupNameParam, employeeNameParam, body, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
