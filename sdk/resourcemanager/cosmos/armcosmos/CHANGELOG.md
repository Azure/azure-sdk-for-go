...
- Type of `DataTransferJobProperties.Error` has been changed from `*ErrorResponseAutoGenerated` to `*DBErrorResult`
...
- New value `DataTransferComponentBaseCosmosDataTransferDataSourceSink` added to enum type `DataTransferComponent`
