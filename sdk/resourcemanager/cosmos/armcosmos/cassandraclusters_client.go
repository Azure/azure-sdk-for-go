...
//     method.
func (client *CassandraClustersClient) BeginCreateUpdate(ctx context.Context, resourceGroupName string, clusterName string, body ClusterResourceAutoGenerated, options *CassandraClustersClientBeginCreateUpdateOptions) (*runtime.Poller[CassandraClustersClientCreateUpdateResponse], error) {
...
//
// Generated from API version 2025-11-01-preview
func (client *CassandraClustersClient) createUpdate(ctx context.Context, resourceGroupName string, clusterName string, body ClusterResourceAutoGenerated, options *CassandraClustersClientBeginCreateUpdateOptions) (*http.Response, error) {
	var err error
...
func (client *CassandraClustersClient) createUpdateCreateRequest(ctx context.Context, resourceGroupName string, clusterName string, body ClusterResourceAutoGenerated, _ *CassandraClustersClientBeginCreateUpdateOptions) (*policy.Request, error) {
...
func (client *CassandraClustersClient) getHandleResponse(resp *http.Response) (CassandraClustersClientGetResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.ClusterResourceAutoGenerated); err != nil {
		return CassandraClustersClientGetResponse{}, err
	}
	return result, nil
}
...
func (client *CassandraClustersClient) listByResourceGroupHandleResponse(resp *http.Response) (CassandraClustersClientListByResourceGroupResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.ListClustersAutoGenerated); err != nil {
		return CassandraClustersClientListByResourceGroupResponse{}, err
	}
	return result, nil
}
...
//     method.
func (client *CassandraClustersClient) BeginUpdate(ctx context.Context, resourceGroupName string, clusterName string, body ClusterResourceAutoGenerated, options *CassandraClustersClientBeginUpdateOptions) (*runtime.Poller[CassandraClustersClientUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
...
//
// Generated from API version 2025-11-01-preview
func (client *CassandraClustersClient) update(ctx context.Context, resourceGroupName string, clusterName string, body ClusterResourceAutoGenerated, options *CassandraClustersClientBeginUpdateOptions) (*http.Response, error) {
	var err error
...
func (client *CassandraClustersClient) updateCreateRequest(ctx context.Context, resourceGroupName string, clusterName string, body ClusterResourceAutoGenerated, _ *CassandraClustersClientBeginUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DocumentDB/cassandraClusters/{clusterName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
