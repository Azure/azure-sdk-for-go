...
//   - options - BeginEnableDisableOptions contains the optional parameters for the ChaosFaultClient.BeginEnableDisable method.
func (client *ChaosFaultClient) BeginEnableDisable(ctx context.Context, resourceGroupName string, accountName string, chaosFault string, chaosFaultRequest ChaosFaultResource, options *BeginEnableDisableOptions) (*runtime.Poller[EnableDisableResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.enableDisable(ctx, resourceGroupName, accountName, chaosFault, chaosFaultRequest, options)
		if err != nil {
			return nil, err
		}
		poller, err := runtime.NewPoller(resp, client.internal.Pipeline(), &runtime.NewPollerOptions[EnableDisableResponse]{
			Tracer: client.internal.Tracer(),
		})
		return poller, err
	} else {
		return runtime.NewPollerFromResumeToken(options.ResumeToken, client.internal.Pipeline(), &runtime.NewPollerFromResumeTokenOptions[EnableDisableResponse]{
			Tracer: client.internal.Tracer(),
		})
	}
}
...
//
// Generated from API version 2025-11-01-preview
func (client *ChaosFaultClient) enableDisable(ctx context.Context, resourceGroupName string, accountName string, chaosFault string, chaosFaultRequest ChaosFaultResource, options *BeginEnableDisableOptions) (*http.Response, error) {
	var err error
...
func (client *ChaosFaultClient) enableDisableCreateRequest(ctx context.Context, resourceGroupName string, accountName string, chaosFault string, chaosFaultRequest ChaosFaultResource, _ *BeginEnableDisableOptions) (*policy.Request, error) {
...
//   - accountName - Cosmos DB database account name.
//   - chaosFault - The name of the ChaosFault.
//   - options - GetOptions contains the optional parameters for the ChaosFaultClient.Get method.
func (client *ChaosFaultClient) Get(ctx context.Context, resourceGroupName string, accountName string, chaosFault string, options *GetOptions) (GetResponse, error) {
	var err error
...
func (client *ChaosFaultClient) getCreateRequest(ctx context.Context, resourceGroupName string, accountName string, chaosFault string, _ *GetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DocumentDB/databaseAccounts/{accountName}/chaosFaults/{chaosFault}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *ChaosFaultClient) getHandleResponse(resp *http.Response) (GetResponse, error) {
	result := GetResponse{}
...
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - accountName - Cosmos DB database account name.
//   - options - ListOptions contains the optional parameters for the ChaosFaultClient.NewListPager method.
func (client *ChaosFaultClient) NewListPager(resourceGroupName string, accountName string, options *ListOptions) *runtime.Pager[ListResponse] {
...
func (client *ChaosFaultClient) listCreateRequest(ctx context.Context, resourceGroupName string, accountName string, _ *ListOptions) (*policy.Request, error) {
...
func (client *ChaosFaultClient) listHandleResponse(resp *http.Response) (ListResponse, error) {
	result := ListResponse{}
