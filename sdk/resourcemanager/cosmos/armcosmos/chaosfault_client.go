...
func (client *ChaosFaultClient) getHandleResponse(resp *http.Response, successCodes ...int) (ChaosFaultClientGetResponse, error) {
...
func (client *ChaosFaultClient) listCreateRequest(ctx context.Context, resourceGroupName string, accountName string, nextLink string, _ *ChaosFaultClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *ChaosFaultClient) listHandleResponse(resp *http.Response, successCodes ...int) (ChaosFaultClientListResponse, error) {
