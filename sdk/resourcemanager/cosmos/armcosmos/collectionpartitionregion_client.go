...
func (client *CollectionPartitionRegionClient) listMetricsCreateRequest(ctx context.Context, resourceGroupName string, accountName string, region string, databaseRid string, collectionRid string, filter string, nextLink string, _ *CollectionPartitionRegionClientListMetricsOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *CollectionPartitionRegionClient) listMetricsHandleResponse(resp *http.Response, successCodes ...int) (CollectionPartitionRegionClientListMetricsResponse, error) {
