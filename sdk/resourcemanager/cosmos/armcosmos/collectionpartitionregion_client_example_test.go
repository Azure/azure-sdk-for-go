...
// Generated from example definition: 2026-04-01-preview/CosmosDBCollectionPartitionRegionGetMetrics.json
func ExampleCollectionPartitionRegionClient_NewListMetricsPager() {
	...
	pager := clientFactory.NewCollectionPartitionRegionClient().NewListMetricsPager("rg1", "ddb1", "North Europe", "databaseRid", "collectionRid", "(name.value eq 'Max RUs Per Second') and timeGrain eq duration'PT1M' and startTime eq '2017-11-19T23:53:55.2780000Z' and endTime eq '2017-11-20T23:58:55.2780000Z", nil)
	for pager.More() {
		...
		// page = armcosmos.CollectionPartitionRegionClientListMetricsResponse{
