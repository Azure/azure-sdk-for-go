...
//     is eq.
//   - options - ListMetricsOptions contains the optional parameters for the CollectionRegionClient.NewListMetricsPager method.
func (client *CollectionRegionClient) NewListMetricsPager(resourceGroupName string, accountName string, region string, databaseRid string, collectionRid string, filter string, options *ListMetricsOptions) *runtime.Pager[ListMetricsResponse] {
...
func (client *CollectionRegionClient) listMetricsCreateRequest(ctx context.Context, resourceGroupName string, accountName string, region string, databaseRid string, collectionRid string, filter string, _ *ListMetricsOptions) (*policy.Request, error) {
...
func (client *CollectionRegionClient) listMetricsHandleResponse(resp *http.Response) (ListMetricsResponse, error) {
