...
func (client *CollectionRegionClient) NewListMetricsPager(resourceGroupName string, accountName string, region string, databaseRid string, collectionRid string, filter string, options *CollectionRegionClientListMetricsOptions) *runtime.Pager[CollectionRegionClientListMetricsResponse] {
	return runtime.NewPager(runtime.PagingHandler[CollectionRegionClientListMetricsResponse]{
		...
		Fetcher: func(ctx context.Context, page *CollectionRegionClientListMetricsResponse) (CollectionRegionClientListMetricsResponse, error) {
			...
			req, err := client.listMetricsCreateRequest(ctx, resourceGroupName, accountName, region, databaseRid, collectionRid, filter, nextLink, options)
			if err != nil {
...
func (client *CollectionRegionClient) listMetricsCreateRequest(ctx context.Context, resourceGroupName string, accountName string, region string, databaseRid string, collectionRid string, filter string, nextLink string, _ *CollectionRegionClientListMetricsOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *CollectionRegionClient) listMetricsHandleResponse(resp *http.Response, successCodes ...int) (CollectionRegionClientListMetricsResponse, error) {
