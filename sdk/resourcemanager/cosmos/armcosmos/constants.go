...
// CustomerManagedKeyStatus - Indicates the status of the Customer Managed Key feature on the account. In case there are errors,
// the property provides troubleshooting guidance.
type CustomerManagedKeyStatus string

const (
	CustomerManagedKeyStatusAccessToTheConfiguredCustomerManagedKeyConfirmed                                                                                                                                                                                                                                                                              CustomerManagedKeyStatus = "Access to the configured customer managed key confirmed."
	                                                                     CustomerManagedKeyStatus = "Access to your account is currently revoked because the access rules are blocking outbound requests to the Azure Key Vault service; for more details about this error and how to restore access to your account please visit https://learn.microsoft.com/en-us/azure/cosmos-db/cmk-troubleshooting-guide (4016)."
...
// PossibleCustomerManagedKeyStatusValues returns the possible values for the CustomerManagedKeyStatus const type.
func PossibleCustomerManagedKeyStatusValues() []CustomerManagedKeyStatus {
	return []CustomerManagedKeyStatus{
		CustomerManagedKeyStatusAccessToTheConfiguredCustomerManagedKeyConfirmed,
		,
		,
		,
		,
