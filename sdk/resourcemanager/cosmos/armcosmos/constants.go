...
// AllocationState - Allocation state of the cluster and data center resources.
type AllocationState string

const (
	// AllocationStateActive - Active implies the virtual machines of the cluster are allocated.
	AllocationStateActive AllocationState = "Active"
	// AllocationStateDeallocated - Deallocated implies virtual machines and resources are deallocated.
...
// so should not be used except in emergencies. 'Cassandra' is the default password based authentication. The default is 'Cassandra'.
...
// FleetspacePropertiesThroughputPoolConfigurationServiceTier - Service Tier for the fleetspace. GeneralPurpose types refers
// to single write region accounts that can be added to this fleetspace, whereas BusinessCritical refers to multi write region.
type FleetspacePropertiesThroughputPoolConfigurationServiceTier string

const (
	FleetspacePropertiesThroughputPoolConfigurationServiceTierBusinessCritical FleetspacePropertiesThroughputPoolConfigurationServiceTier = "BusinessCritical"
	FleetspacePropertiesThroughputPoolConfigurationServiceTierGeneralPurpose   FleetspacePropertiesThroughputPoolConfigurationServiceTier = "GeneralPurpose"
)

// PossibleFleetspacePropertiesThroughputPoolConfigurationServiceTierValues returns the possible values for the FleetspacePropertiesThroughputPoolConfigurationServiceTier const type.
func PossibleFleetspacePropertiesThroughputPoolConfigurationServiceTierValues() []FleetspacePropertiesThroughputPoolConfigurationServiceTier {
	return []FleetspacePropertiesThroughputPoolConfigurationServiceTier{
		FleetspacePropertiesThroughputPoolConfigurationServiceTierBusinessCritical,
		FleetspacePropertiesThroughputPoolConfigurationServiceTierGeneralPurpose,
	}
}
...
// ServiceResourceStatus - Describes the status of a service.
...
const (
	...
	ServiceResourceStatusError    ServiceResourceStatus = "Error"
	ServiceResourceStatusRunning  ServiceResourceStatus = "Running"
	ServiceResourceStatusStopped  ServiceResourceStatus = "Stopped"
	ServiceResourceStatusUpdating ServiceResourceStatus = "Updating"
)

// PossibleServiceResourceStatusValues returns the possible values for the ServiceResourceStatus const type.
func PossibleServiceResourceStatusValues() []ServiceResourceStatus {
	return []ServiceResourceStatus{
		...
		ServiceResourceStatusError,
		ServiceResourceStatusRunning,
		ServiceResourceStatusStopped,
		ServiceResourceStatusUpdating,
	}
}
