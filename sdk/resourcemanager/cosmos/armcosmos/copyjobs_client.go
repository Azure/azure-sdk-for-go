...
func (client *CopyJobsClient) cancelHandleResponse(resp *http.Response, successCodes ...int) (CopyJobsClientCancelResponse, error) {
...
func (client *CopyJobsClient) completeHandleResponse(resp *http.Response, successCodes ...int) (CopyJobsClientCompleteResponse, error) {
...
func (client *CopyJobsClient) createHandleResponse(resp *http.Response, successCodes ...int) (CopyJobsClientCreateResponse, error) {
...
func (client *CopyJobsClient) getHandleResponse(resp *http.Response, successCodes ...int) (CopyJobsClientGetResponse, error) {
...
func (client *CopyJobsClient) listByDatabaseAccountCreateRequest(ctx context.Context, resourceGroupName string, accountName string, nextLink string, _ *CopyJobsClientListByDatabaseAccountOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *CopyJobsClient) listByDatabaseAccountHandleResponse(resp *http.Response, successCodes ...int) (CopyJobsClientListByDatabaseAccountResponse, error) {
...
func (client *CopyJobsClient) pauseHandleResponse(resp *http.Response, successCodes ...int) (CopyJobsClientPauseResponse, error) {
...
func (client *CopyJobsClient) resumeHandleResponse(resp *http.Response, successCodes ...int) (CopyJobsClientResumeResponse, error) {
