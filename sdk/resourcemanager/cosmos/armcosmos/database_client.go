...
//   - options - ListMetricDefinitionsOptions contains the optional parameters for the DatabaseClient.NewListMetricDefinitionsPager
//     method.
func (client *DatabaseClient) NewListMetricDefinitionsPager(resourceGroupName string, accountName string, databaseRid string, options *ListMetricDefinitionsOptions) *runtime.Pager[ListMetricDefinitionsResponse] {
...
func (client *DatabaseClient) listMetricDefinitionsCreateRequest(ctx context.Context, resourceGroupName string, accountName string, databaseRid string, _ *ListMetricDefinitionsOptions) (*policy.Request, error) {
...
func (client *DatabaseClient) listMetricDefinitionsHandleResponse(resp *http.Response) (ListMetricDefinitionsResponse, error) {
...
//     is eq.
//   - options - ListMetricsOptions contains the optional parameters for the DatabaseClient.NewListMetricsPager method.
func (client *DatabaseClient) NewListMetricsPager(resourceGroupName string, accountName string, databaseRid string, filter string, options *ListMetricsOptions) *runtime.Pager[ListMetricsResponse] {
...
func (client *DatabaseClient) listMetricsCreateRequest(ctx context.Context, resourceGroupName string, accountName string, databaseRid string, filter string, _ *ListMetricsOptions) (*policy.Request, error) {
...
func (client *DatabaseClient) listMetricsHandleResponse(resp *http.Response) (ListMetricsResponse, error) {
...
//   - accountName - Cosmos DB database account name.
//   - databaseRid - Cosmos DB database rid.
//   - options - ListUsagesOptions contains the optional parameters for the DatabaseClient.NewListUsagesPager method.
func (client *DatabaseClient) NewListUsagesPager(resourceGroupName string, accountName string, databaseRid string, options *ListUsagesOptions) *runtime.Pager[ListUsagesResponse] {
...
func (client *DatabaseClient) listUsagesCreateRequest(ctx context.Context, resourceGroupName string, accountName string, databaseRid string, options *ListUsagesOptions) (*policy.Request, error) {
...
func (client *DatabaseClient) listUsagesHandleResponse(resp *http.Response) (ListUsagesResponse, error) {
