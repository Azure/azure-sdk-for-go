...
func ExampleDatabaseClient_NewListMetricDefinitionsPager() {
	...
	for pager.More() {
		...
		// page = armcosmos.ListMetricDefinitionsResponse{
...
func ExampleDatabaseClient_NewListUsagesPager() {
	...
	pager := clientFactory.NewDatabaseClient().NewListUsagesPager("rg1", "ddb1", "databaseRid", &armcosmos.ListUsagesOptions{
	...
	for pager.More() {
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armcosmos.ListUsagesResponse{
