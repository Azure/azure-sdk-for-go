...
func (client *DatabaseAccountRegionClient) NewListMetricsPager(resourceGroupName string, accountName string, region string, filter string, options *DatabaseAccountRegionClientListMetricsOptions) *runtime.Pager[DatabaseAccountRegionClientListMetricsResponse] {
	return runtime.NewPager(runtime.PagingHandler[DatabaseAccountRegionClientListMetricsResponse]{
		...
		Fetcher: func(ctx context.Context, page *DatabaseAccountRegionClientListMetricsResponse) (DatabaseAccountRegionClientListMetricsResponse, error) {
			...
			req, err := client.listMetricsCreateRequest(ctx, resourceGroupName, accountName, region, filter, nextLink, options)
			if err != nil {
...
func (client *DatabaseAccountRegionClient) listMetricsCreateRequest(ctx context.Context, resourceGroupName string, accountName string, region string, filter string, nextLink string, _ *DatabaseAccountRegionClientListMetricsOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *DatabaseAccountRegionClient) listMetricsHandleResponse(resp *http.Response, successCodes ...int) (DatabaseAccountRegionClientListMetricsResponse, error) {
