...
type CassandraClustersServer struct {
	...
	BeginCreateUpdate func(ctx context.Context, resourceGroupName string, clusterName string, body armcosmos.ClusterResourceAutoGenerated, options *armcosmos.CassandraClustersClientBeginCreateUpdateOptions) (resp azfake.PollerResponder[armcosmos.CassandraClustersClientCreateUpdateResponse], errResp azfake.ErrorResponder)
	...
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginUpdate func(ctx context.Context, resourceGroupName string, clusterName string, body armcosmos.ClusterResourceAutoGenerated, options *armcosmos.CassandraClustersClientBeginUpdateOptions) (resp azfake.PollerResponder[armcosmos.CassandraClustersClientUpdateResponse], errResp azfake.ErrorResponder)
}
...
func (c *CassandraClustersServerTransport) dispatchBeginCreateUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginCreateUpdate == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armcosmos.ClusterResourceAutoGenerated](req)
		if err != nil {
			return nil, err
		}
...
func (c *CassandraClustersServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	resp, err := server.MarshalResponseAsJSON(respContent, server.GetResponse(respr).ClusterResourceAutoGenerated, req)
	if err != nil {
		return nil, err
	}
	return resp, nil
