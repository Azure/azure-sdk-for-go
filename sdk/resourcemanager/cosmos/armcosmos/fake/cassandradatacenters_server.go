...
type CassandraDataCentersServer struct {
	...
	BeginCreateUpdate func(ctx context.Context, resourceGroupName string, clusterName string, dataCenterName string, body armcosmos.DataCenterResource, options *armcosmos.BeginCreateUpdateOptions) (resp azfake.PollerResponder[armcosmos.CreateUpdateResponse], errResp azfake.ErrorResponder)

	// BeginDelete is the fake for method CassandraDataCentersClient.BeginDelete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginDelete func(ctx context.Context, resourceGroupName string, clusterName string, dataCenterName string, options *armcosmos.BeginDeleteOptions) (resp azfake.PollerResponder[armcosmos.DeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method CassandraDataCentersClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, clusterName string, dataCenterName string, options *armcosmos.GetOptions) (resp azfake.Responder[armcosmos.GetResponse], errResp azfake.ErrorResponder)

	// NewListPager is the fake for method CassandraDataCentersClient.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager func(resourceGroupName string, clusterName string, options *armcosmos.ListOptions) (resp azfake.PagerResponder[armcosmos.ListResponse])

	// BeginUpdate is the fake for method CassandraDataCentersClient.BeginUpdate
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginUpdate func(ctx context.Context, resourceGroupName string, clusterName string, dataCenterName string, body armcosmos.DataCenterResource, options *armcosmos.BeginUpdateOptions) (resp azfake.PollerResponder[armcosmos.UpdateResponse], errResp azfake.ErrorResponder)
}
