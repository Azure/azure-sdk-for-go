...
type ChaosFaultServer struct {
	...
	BeginEnableDisable func(ctx context.Context, resourceGroupName string, accountName string, chaosFault string, chaosFaultRequest armcosmos.ChaosFaultResource, options *armcosmos.BeginEnableDisableOptions) (resp azfake.PollerResponder[armcosmos.EnableDisableResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method ChaosFaultClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, accountName string, chaosFault string, options *armcosmos.GetOptions) (resp azfake.Responder[armcosmos.GetResponse], errResp azfake.ErrorResponder)
...
func NewChaosFaultServerTransport(srv *ChaosFaultServer) *ChaosFaultServerTransport {
	return &ChaosFaultServerTransport{
		srv:                srv,
		beginEnableDisable: newTracker[azfake.PollerResponder[armcosmos.EnableDisableResponse]](),
...
type ChaosFaultServerTransport struct {
	...
	beginEnableDisable *tracker[azfake.PollerResponder[armcosmos.EnableDisableResponse]]
