...
type CopyJobsServer struct {
	...
	Create func(ctx context.Context, resourceGroupName string, accountName string, jobName string, jobCreateParameters armcosmos.CopyJobGetResults, options *armcosmos.CreateOptions) (resp azfake.Responder[armcosmos.CreateResponse], errResp azfake.ErrorResponder)
