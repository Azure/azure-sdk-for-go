...
type DatabaseServer struct {
	...
	NewListMetricDefinitionsPager func(resourceGroupName string, accountName string, databaseRid string, options *armcosmos.ListMetricDefinitionsOptions) (resp azfake.PagerResponder[armcosmos.ListMetricDefinitionsResponse])

	// NewListMetricsPager is the fake for method DatabaseClient.NewListMetricsPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListMetricsPager func(resourceGroupName string, accountName string, databaseRid string, filter string, options *armcosmos.ListMetricsOptions) (resp azfake.PagerResponder[armcosmos.ListMetricsResponse])

	// NewListUsagesPager is the fake for method DatabaseClient.NewListUsagesPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListUsagesPager func(resourceGroupName string, accountName string, databaseRid string, options *armcosmos.ListUsagesOptions) (resp azfake.PagerResponder[armcosmos.ListUsagesResponse])
}
