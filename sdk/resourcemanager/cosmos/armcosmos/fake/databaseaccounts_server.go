...
type DatabaseAccountsServer struct {
	...
	CheckNameExists func(ctx context.Context, accountName string, options *armcosmos.CheckNameExistsOptions) (resp azfake.Responder[armcosmos.CheckNameExistsResponse], errResp azfake.ErrorResponder)

	// BeginCreateOrUpdate is the fake for method DatabaseAccountsClient.BeginCreateOrUpdate
	// HTTP status codes to indicate success: http.StatusOK
	BeginCreateOrUpdate func(ctx context.Context, resourceGroupName string, accountName string, createUpdateParameters armcosmos.DatabaseAccountCreateUpdateParameters, options *armcosmos.BeginCreateOrUpdateOptions) (resp azfake.PollerResponder[armcosmos.CreateOrUpdateResponse], errResp azfake.ErrorResponder)

	// BeginDelete is the fake for method DatabaseAccountsClient.BeginDelete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginDelete func(ctx context.Context, resourceGroupName string, accountName string, options *armcosmos.BeginDeleteOptions) (resp azfake.PollerResponder[armcosmos.DeleteResponse], errResp azfake.ErrorResponder)

	// BeginFailoverPriorityChange is the fake for method DatabaseAccountsClient.BeginFailoverPriorityChange
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginFailoverPriorityChange func(ctx context.Context, resourceGroupName string, accountName string, failoverParameters armcosmos.FailoverPolicies, options *armcosmos.BeginFailoverPriorityChangeOptions) (resp azfake.PollerResponder[armcosmos.FailoverPriorityChangeResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method DatabaseAccountsClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, accountName string, options *armcosmos.GetOptions) (resp azfake.Responder[armcosmos.GetResponse], errResp azfake.ErrorResponder)

	// GetReadOnlyKeys is the fake for method DatabaseAccountsClient.GetReadOnlyKeys
	// HTTP status codes to indicate success: http.StatusOK
	GetReadOnlyKeys func(ctx context.Context, resourceGroupName string, accountName string, options *armcosmos.GetReadOnlyKeysOptions) (resp azfake.Responder[armcosmos.GetReadOnlyKeysResponse], errResp azfake.ErrorResponder)
	...
	// HTTP status codes to indicate success: http.StatusOK
	ListConnectionStrings func(ctx context.Context, resourceGroupName string, accountName string, options *armcosmos.ListConnectionStringsOptions) (resp azfake.Responder[armcosmos.ListConnectionStringsResponse], errResp azfake.ErrorResponder)

	// ListKeys is the fake for method DatabaseAccountsClient.ListKeys
	// HTTP status codes to indicate success: http.StatusOK
	ListKeys func(ctx context.Context, resourceGroupName string, accountName string, options *armcosmos.ListKeysOptions) (resp azfake.Responder[armcosmos.ListKeysResponse], errResp azfake.ErrorResponder)

	// NewListMetricDefinitionsPager is the fake for method DatabaseAccountsClient.NewListMetricDefinitionsPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListMetricDefinitionsPager func(resourceGroupName string, accountName string, options *armcosmos.ListMetricDefinitionsOptions) (resp azfake.PagerResponder[armcosmos.ListMetricDefinitionsResponse])
	...
	// HTTP status codes to indicate success: http.StatusOK
	ListReadOnlyKeys func(ctx context.Context, resourceGroupName string, accountName string, options *armcosmos.ListReadOnlyKeysOptions) (resp azfake.Responder[armcosmos.ListReadOnlyKeysResponse], errResp azfake.ErrorResponder)

	// NewListUsagesPager is the fake for method DatabaseAccountsClient.NewListUsagesPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListUsagesPager func(resourceGroupName string, accountName string, options *armcosmos.ListUsagesOptions) (resp azfake.PagerResponder[armcosmos.ListUsagesResponse])

	// BeginOfflineRegion is the fake for method DatabaseAccountsClient.BeginOfflineRegion
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginOfflineRegion func(ctx context.Context, resourceGroupName string, accountName string, regionParameterForOffline armcosmos.RegionForOnlineOffline, options *armcosmos.BeginOfflineRegionOptions) (resp azfake.PollerResponder[armcosmos.OfflineRegionResponse], errResp azfake.ErrorResponder)

	// BeginOnlineRegion is the fake for method DatabaseAccountsClient.BeginOnlineRegion
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginOnlineRegion func(ctx context.Context, resourceGroupName string, accountName string, regionParameterForOnline armcosmos.RegionForOnlineOffline, options *armcosmos.BeginOnlineRegionOptions) (resp azfake.PollerResponder[armcosmos.OnlineRegionResponse], errResp azfake.ErrorResponder)

	// BeginRegenerateKey is the fake for method DatabaseAccountsClient.BeginRegenerateKey
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginRegenerateKey func(ctx context.Context, resourceGroupName string, accountName string, keyToRegenerate armcosmos.DatabaseAccountRegenerateKeyParameters, options *armcosmos.BeginRegenerateKeyOptions) (resp azfake.PollerResponder[armcosmos.RegenerateKeyResponse], errResp azfake.ErrorResponder)

	// BeginUpdate is the fake for method DatabaseAccountsClient.BeginUpdate
	// HTTP status codes to indicate success: http.StatusOK
	BeginUpdate func(ctx context.Context, resourceGroupName string, accountName string, updateParameters armcosmos.DatabaseAccountUpdateParameters, options *armcosmos.BeginUpdateOptions) (resp azfake.PollerResponder[armcosmos.UpdateResponse], errResp azfake.ErrorResponder)
}
...
func NewDatabaseAccountsServerTransport(srv *DatabaseAccountsServer) *DatabaseAccountsServerTransport {
	return &DatabaseAccountsServerTransport{
		...
		beginFailoverPriorityChange:   newTracker[azfake.PollerResponder[armcosmos.FailoverPriorityChangeResponse]](),
		...
		beginOfflineRegion:            newTracker[azfake.PollerResponder[armcosmos.OfflineRegionResponse]](),
		beginOnlineRegion:             newTracker[azfake.PollerResponder[armcosmos.OnlineRegionResponse]](),
		beginRegenerateKey:            newTracker[azfake.PollerResponder[armcosmos.RegenerateKeyResponse]](),
...
type DatabaseAccountsServerTransport struct {
	...
	beginFailoverPriorityChange   *tracker[azfake.PollerResponder[armcosmos.FailoverPriorityChangeResponse]]
	...
	beginOfflineRegion            *tracker[azfake.PollerResponder[armcosmos.OfflineRegionResponse]]
	beginOnlineRegion             *tracker[azfake.PollerResponder[armcosmos.OnlineRegionResponse]]
	beginRegenerateKey            *tracker[azfake.PollerResponder[armcosmos.RegenerateKeyResponse]]
