...
type DataTransferJobsServer struct {
	...
	Cancel func(ctx context.Context, resourceGroupName string, accountName string, jobName string, options *armcosmos.CancelOptions) (resp azfake.Responder[armcosmos.CancelResponse], errResp azfake.ErrorResponder)

	// Complete is the fake for method DataTransferJobsClient.Complete
	// HTTP status codes to indicate success: http.StatusOK
	Complete func(ctx context.Context, resourceGroupName string, accountName string, jobName string, options *armcosmos.CompleteOptions) (resp azfake.Responder[armcosmos.CompleteResponse], errResp azfake.ErrorResponder)

	// Create is the fake for method DataTransferJobsClient.Create
	// HTTP status codes to indicate success: http.StatusOK
	Create func(ctx context.Context, resourceGroupName string, accountName string, jobName string, jobCreateParameters armcosmos.CreateJobRequest, options *armcosmos.CreateOptions) (resp azfake.Responder[armcosmos.CreateResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method DataTransferJobsClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, accountName string, jobName string, options *armcosmos.GetOptions) (resp azfake.Responder[armcosmos.GetResponse], errResp azfake.ErrorResponder)
	...
	// HTTP status codes to indicate success: http.StatusOK
	Pause func(ctx context.Context, resourceGroupName string, accountName string, jobName string, options *armcosmos.PauseOptions) (resp azfake.Responder[armcosmos.PauseResponse], errResp azfake.ErrorResponder)

	// Resume is the fake for method DataTransferJobsClient.Resume
	// HTTP status codes to indicate success: http.StatusOK
	Resume func(ctx context.Context, resourceGroupName string, accountName string, jobName string, options *armcosmos.ResumeOptions) (resp azfake.Responder[armcosmos.ResumeResponse], errResp azfake.ErrorResponder)
}
