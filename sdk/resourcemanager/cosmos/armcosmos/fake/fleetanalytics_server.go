...
type FleetAnalyticsServer struct {
	...
	Create func(ctx context.Context, resourceGroupName string, fleetName string, fleetAnalyticsName string, body armcosmos.FleetAnalyticsResource, options *armcosmos.CreateOptions) (resp azfake.Responder[armcosmos.CreateResponse], errResp azfake.ErrorResponder)

	// BeginDelete is the fake for method FleetAnalyticsClient.BeginDelete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginDelete func(ctx context.Context, resourceGroupName string, fleetName string, fleetAnalyticsName string, options *armcosmos.BeginDeleteOptions) (resp azfake.PollerResponder[armcosmos.DeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method FleetAnalyticsClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, fleetName string, fleetAnalyticsName string, options *armcosmos.GetOptions) (resp azfake.Responder[armcosmos.GetResponse], errResp azfake.ErrorResponder)

	// NewListPager is the fake for method FleetAnalyticsClient.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager func(resourceGroupName string, fleetName string, options *armcosmos.ListOptions) (resp azfake.PagerResponder[armcosmos.ListResponse])
}
