...
type FleetspaceAccountServer struct {
	...
	BeginCreate func(ctx context.Context, resourceGroupName string, fleetName string, fleetspaceName string, fleetspaceAccountName string, body armcosmos.FleetspaceAccountResource, options *armcosmos.BeginCreateOptions) (resp azfake.PollerResponder[armcosmos.CreateResponse], errResp azfake.ErrorResponder)

	// BeginDelete is the fake for method FleetspaceAccountClient.BeginDelete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginDelete func(ctx context.Context, resourceGroupName string, fleetName string, fleetspaceName string, fleetspaceAccountName string, options *armcosmos.BeginDeleteOptions) (resp azfake.PollerResponder[armcosmos.DeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method FleetspaceAccountClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, fleetName string, fleetspaceName string, fleetspaceAccountName string, options *armcosmos.GetOptions) (resp azfake.Responder[armcosmos.GetResponse], errResp azfake.ErrorResponder)

	// NewListPager is the fake for method FleetspaceAccountClient.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager func(resourceGroupName string, fleetName string, fleetspaceName string, options *armcosmos.ListOptions) (resp azfake.PagerResponder[armcosmos.ListResponse])
}
