...
type MongoMIResourcesServer struct {
	...
	BeginCreateUpdateMongoMIRoleAssignment func(ctx context.Context, resourceGroupName string, accountName string, roleAssignmentID string, createUpdateMongoMIRoleAssignmentParameters armcosmos.MongoMIRoleAssignmentResource, options *armcosmos.BeginCreateUpdateMongoMIRoleAssignmentOptions) (resp azfake.PollerResponder[armcosmos.CreateUpdateMongoMIRoleAssignmentResponse], errResp azfake.ErrorResponder)
	...
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginCreateUpdateMongoMIRoleDefinition func(ctx context.Context, resourceGroupName string, accountName string, roleDefinitionID string, createUpdateMongoMIRoleDefinitionParameters armcosmos.MongoMIRoleDefinitionResource, options *armcosmos.BeginCreateUpdateMongoMIRoleDefinitionOptions) (resp azfake.PollerResponder[armcosmos.CreateUpdateMongoMIRoleDefinitionResponse], errResp azfake.ErrorResponder)
	...
	BeginDeleteMongoMIRoleAssignment func(ctx context.Context, resourceGroupName string, accountName string, roleAssignmentID string, options *armcosmos.BeginDeleteMongoMIRoleAssignmentOptions) (resp azfake.PollerResponder[armcosmos.DeleteMongoMIRoleAssignmentResponse], errResp azfake.ErrorResponder)

	// BeginDeleteMongoMIRoleDefinition is the fake for method MongoMIResourcesClient.BeginDeleteMongoMIRoleDefinition
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginDeleteMongoMIRoleDefinition func(ctx context.Context, resourceGroupName string, accountName string, roleDefinitionID string, options *armcosmos.BeginDeleteMongoMIRoleDefinitionOptions) (resp azfake.PollerResponder[armcosmos.DeleteMongoMIRoleDefinitionResponse], errResp azfake.ErrorResponder)

	// GetMongoMIRoleAssignment is the fake for method MongoMIResourcesClient.GetMongoMIRoleAssignment
	// HTTP status codes to indicate success: http.StatusOK
	GetMongoMIRoleAssignment func(ctx context.Context, resourceGroupName string, accountName string, roleAssignmentID string, options *armcosmos.GetMongoMIRoleAssignmentOptions) (resp azfake.Responder[armcosmos.GetMongoMIRoleAssignmentResponse], errResp azfake.ErrorResponder)

	// GetMongoMIRoleDefinition is the fake for method MongoMIResourcesClient.GetMongoMIRoleDefinition
	// HTTP status codes to indicate success: http.StatusOK
	GetMongoMIRoleDefinition func(ctx context.Context, resourceGroupName string, accountName string, roleDefinitionID string, options *armcosmos.GetMongoMIRoleDefinitionOptions) (resp azfake.Responder[armcosmos.GetMongoMIRoleDefinitionResponse], errResp azfake.ErrorResponder)

	// NewListMongoMIRoleAssignmentsPager is the fake for method MongoMIResourcesClient.NewListMongoMIRoleAssignmentsPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListMongoMIRoleAssignmentsPager func(resourceGroupName string, accountName string, options *armcosmos.ListMongoMIRoleAssignmentsOptions) (resp azfake.PagerResponder[armcosmos.ListMongoMIRoleAssignmentsResponse])

	// NewListMongoMIRoleDefinitionsPager is the fake for method MongoMIResourcesClient.NewListMongoMIRoleDefinitionsPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListMongoMIRoleDefinitionsPager func(resourceGroupName string, accountName string, options *armcosmos.ListMongoMIRoleDefinitionsOptions) (resp azfake.PagerResponder[armcosmos.ListMongoMIRoleDefinitionsResponse])
}
...
func NewMongoMIResourcesServerTransport(srv *MongoMIResourcesServer) *MongoMIResourcesServerTransport {
	return &MongoMIResourcesServerTransport{
		srv:                                    srv,
		beginCreateUpdateMongoMIRoleAssignment: newTracker[azfake.PollerResponder[armcosmos.CreateUpdateMongoMIRoleAssignmentResponse]](),
		beginCreateUpdateMongoMIRoleDefinition: newTracker[azfake.PollerResponder[armcosmos.CreateUpdateMongoMIRoleDefinitionResponse]](),
		beginDeleteMongoMIRoleAssignment:       newTracker[azfake.PollerResponder[armcosmos.DeleteMongoMIRoleAssignmentResponse]](),
		beginDeleteMongoMIRoleDefinition:       newTracker[azfake.PollerResponder[armcosmos.DeleteMongoMIRoleDefinitionResponse]](),
		newListMongoMIRoleAssignmentsPager:     newTracker[azfake.PagerResponder[armcosmos.ListMongoMIRoleAssignmentsResponse]](),
		newListMongoMIRoleDefinitionsPager:     newTracker[azfake.PagerResponder[armcosmos.ListMongoMIRoleDefinitionsResponse]](),
	}
}
...
type MongoMIResourcesServerTransport struct {
	...
	beginCreateUpdateMongoMIRoleAssignment *tracker[azfake.PollerResponder[armcosmos.CreateUpdateMongoMIRoleAssignmentResponse]]
	beginCreateUpdateMongoMIRoleDefinition *tracker[azfake.PollerResponder[armcosmos.CreateUpdateMongoMIRoleDefinitionResponse]]
	beginDeleteMongoMIRoleAssignment       *tracker[azfake.PollerResponder[armcosmos.DeleteMongoMIRoleAssignmentResponse]]
	beginDeleteMongoMIRoleDefinition       *tracker[azfake.PollerResponder[armcosmos.DeleteMongoMIRoleDefinitionResponse]]
	newListMongoMIRoleAssignmentsPager     *tracker[azfake.PagerResponder[armcosmos.ListMongoMIRoleAssignmentsResponse]]
	newListMongoMIRoleDefinitionsPager     *tracker[azfake.PagerResponder[armcosmos.ListMongoMIRoleDefinitionsResponse]]
}
...
func (m *MongoMIResourcesServerTransport) dispatchNewListMongoMIRoleAssignmentsPager(req *http.Request) (*http.Response, error) {
	...
	if newListMongoMIRoleAssignmentsPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListMongoMIRoleAssignmentsPager, req, func(page *armcosmos.ListMongoMIRoleAssignmentsResponse, createLink func() string) {
...
func (m *MongoMIResourcesServerTransport) dispatchNewListMongoMIRoleDefinitionsPager(req *http.Request) (*http.Response, error) {
	...
	if newListMongoMIRoleDefinitionsPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListMongoMIRoleDefinitionsPager, req, func(page *armcosmos.ListMongoMIRoleDefinitionsResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
