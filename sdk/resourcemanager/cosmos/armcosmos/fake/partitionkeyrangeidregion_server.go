...
type PartitionKeyRangeIDRegionServer struct {
	...
	NewListMetricsPager func(resourceGroupName string, accountName string, region string, databaseRid string, collectionRid string, partitionKeyRangeID string, filter string, options *armcosmos.ListMetricsOptions) (resp azfake.PagerResponder[armcosmos.ListMetricsResponse])
}
