...
type PercentileServer struct {
	...
	NewListMetricsPager func(resourceGroupName string, accountName string, filter string, options *armcosmos.ListMetricsOptions) (resp azfake.PagerResponder[armcosmos.ListMetricsResponse])
}
