...
func NewRestorableGremlinGraphsServerTransport(srv *RestorableGremlinGraphsServer) *RestorableGremlinGraphsServerTransport {
	return &RestorableGremlinGraphsServerTransport{
		srv:          srv,
		newListPager: newTracker[azfake.PagerResponder[armcosmos.RestorableGremlinGraphsClientListResponse]](),
	}
}
...
type RestorableGremlinGraphsServerTransport struct {
	...
	newListPager *tracker[azfake.PagerResponder[armcosmos.RestorableGremlinGraphsClientListResponse]]
}
...
func (r *RestorableGremlinGraphsServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armcosmos.RestorableGremlinGraphsClientListResponse, createLink func() string) {
