...
func (r *RestorableMongodbCollectionsServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.DocumentDB/locations/(?P<location>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/restorableDatabaseAccounts/(?P<instanceId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/restorableMongodbCollections`
		...
		restorableMongodbDatabaseRidParam := getOptional(qp.Get("restorableMongodbDatabaseRid"))
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armcosmos.RestorableMongodbCollectionsClientListResponse, createLink func() string) {
