...
func (r *RestorableMongodbResourcesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if restorableMongodbResourcesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = restorableMongodbResourcesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to RestorableMongodbResourcesServerTransport
var restorableMongodbResourcesServerTransportInterceptor interface {
