...
func (r *RestorableSQLDatabasesServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.DocumentDB/locations/(?P<location>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/restorableDatabaseAccounts/(?P<instanceId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/restorableSqlDatabases`
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armcosmos.RestorableSQLDatabasesClientListResponse, createLink func() string) {
