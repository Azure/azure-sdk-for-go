...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "CassandraClustersClient":
		initServer(&s.trMu, &s.trCassandraClustersServer, func() *CassandraClustersServerTransport {
	...
	case "CassandraDataCentersClient":
		initServer(&s.trMu, &s.trCassandraDataCentersServer, func() *CassandraDataCentersServerTransport {
	...
	case "CassandraResourcesClient":
		initServer(&s.trMu, &s.trCassandraResourcesServer, func() *CassandraResourcesServerTransport {
	...
	case "CollectionPartitionClient":
		initServer(&s.trMu, &s.trCollectionPartitionServer, func() *CollectionPartitionServerTransport {
	...
	case "CollectionPartitionRegionClient":
		initServer(&s.trMu, &s.trCollectionPartitionRegionServer, func() *CollectionPartitionRegionServerTransport {
	...
	case "CollectionRegionClient":
		initServer(&s.trMu, &s.trCollectionRegionServer, func() *CollectionRegionServerTransport {
	...
	case "DatabaseAccountsClient":
		initServer(&s.trMu, &s.trDatabaseAccountsServer, func() *DatabaseAccountsServerTransport {
	...
	case "FleetspaceAccountClient":
		initServer(&s.trMu, &s.trFleetspaceAccountServer, func() *FleetspaceAccountServerTransport {
	...
	case "MongoDBResourcesClient":
		initServer(&s.trMu, &s.trMongoDBResourcesServer, func() *MongoDBResourcesServerTransport {
	...
	case "MongoMIResourcesClient":
		initServer(&s.trMu, &s.trMongoMIResourcesServer, func() *MongoMIResourcesServerTransport {
	...
	case "PartitionKeyRangeIDClient":
		initServer(&s.trMu, &s.trPartitionKeyRangeIDServer, func() *PartitionKeyRangeIDServerTransport {
	...
	case "PartitionKeyRangeIDRegionClient":
		initServer(&s.trMu, &s.trPartitionKeyRangeIDRegionServer, func() *PartitionKeyRangeIDRegionServerTransport {
	...
	case "PercentileClient":
		initServer(&s.trMu, &s.trPercentileServer, func() *PercentileServerTransport { return NewPercentileServerTransport(&s.srv.PercentileServer) })
		resp, err = s.trPercentileServer.Do(req)
	case "PercentileSourceTargetClient":
		initServer(&s.trMu, &s.trPercentileSourceTargetServer, func() *PercentileSourceTargetServerTransport {
	...
	case "PercentileTargetClient":
		initServer(&s.trMu, &s.trPercentileTargetServer, func() *PercentileTargetServerTransport {
	...
	case "RestorableDatabaseAccountsClient":
		initServer(&s.trMu, &s.trRestorableDatabaseAccountsServer, func() *RestorableDatabaseAccountsServerTransport {
	...
	case "RestorableGremlinDatabasesClient":
		initServer(&s.trMu, &s.trRestorableGremlinDatabasesServer, func() *RestorableGremlinDatabasesServerTransport {
	...
	case "RestorableGremlinGraphsClient":
		initServer(&s.trMu, &s.trRestorableGremlinGraphsServer, func() *RestorableGremlinGraphsServerTransport {
	...
	case "RestorableGremlinResourcesClient":
		initServer(&s.trMu, &s.trRestorableGremlinResourcesServer, func() *RestorableGremlinResourcesServerTransport {
	...
	case "RestorableMongodbCollectionsClient":
		initServer(&s.trMu, &s.trRestorableMongodbCollectionsServer, func() *RestorableMongodbCollectionsServerTransport {
	...
	case "RestorableMongodbDatabasesClient":
		initServer(&s.trMu, &s.trRestorableMongodbDatabasesServer, func() *RestorableMongodbDatabasesServerTransport {
	...
	case "RestorableMongodbResourcesClient":
		initServer(&s.trMu, &s.trRestorableMongodbResourcesServer, func() *RestorableMongodbResourcesServerTransport {
	...
	case "RestorableSQLContainersClient":
		initServer(&s.trMu, &s.trRestorableSQLContainersServer, func() *RestorableSQLContainersServerTransport {
	...
	case "RestorableSQLDatabasesClient":
		initServer(&s.trMu, &s.trRestorableSQLDatabasesServer, func() *RestorableSQLDatabasesServerTransport {
	...
	case "RestorableSQLResourcesClient":
		initServer(&s.trMu, &s.trRestorableSQLResourcesServer, func() *RestorableSQLResourcesServerTransport {
	...
	case "RestorableTableResourcesClient":
		initServer(&s.trMu, &s.trRestorableTableResourcesServer, func() *RestorableTableResourcesServerTransport {
	...
	case "RestorableTablesClient":
		initServer(&s.trMu, &s.trRestorableTablesServer, func() *RestorableTablesServerTransport {
	...
	case "SQLResourcesClient":
		initServer(&s.trMu, &s.trSQLResourcesServer, func() *SQLResourcesServerTransport { return NewSQLResourcesServerTransport(&s.srv.SQLResourcesServer) })
