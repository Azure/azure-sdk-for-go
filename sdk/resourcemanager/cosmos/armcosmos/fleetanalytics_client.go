...
func (client *FleetAnalyticsClient) createHandleResponse(resp *http.Response, successCodes ...int) (FleetAnalyticsClientCreateResponse, error) {
...
func (client *FleetAnalyticsClient) getHandleResponse(resp *http.Response, successCodes ...int) (FleetAnalyticsClientGetResponse, error) {
...
func (client *FleetAnalyticsClient) listCreateRequest(ctx context.Context, resourceGroupName string, fleetName string, nextLink string, _ *FleetAnalyticsClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *FleetAnalyticsClient) listHandleResponse(resp *http.Response, successCodes ...int) (FleetAnalyticsClientListResponse, error) {
