...
func (client *GraphResourcesClient) getGraphHandleResponse(resp *http.Response, successCodes ...int) (GraphResourcesClientGetGraphResponse, error) {
...
func (client *GraphResourcesClient) NewListGraphsPager(resourceGroupName string, accountName string, options *GraphResourcesClientListGraphsOptions) *runtime.Pager[GraphResourcesClientListGraphsResponse] {
	return runtime.NewPager(runtime.PagingHandler[GraphResourcesClientListGraphsResponse]{
		...
		Fetcher: func(ctx context.Context, page *GraphResourcesClientListGraphsResponse) (GraphResourcesClientListGraphsResponse, error) {
			...
			req, err := client.listGraphsCreateRequest(ctx, resourceGroupName, accountName, nextLink, options)
			if err != nil {
			...
			return client.listGraphsHandleResponse(resp, http.StatusOK)
		},
		Tracer: client.internal.Tracer(),
	})
}
...
func (client *GraphResourcesClient) listGraphsCreateRequest(ctx context.Context, resourceGroupName string, accountName string, nextLink string, _ *GraphResourcesClientListGraphsOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *GraphResourcesClient) listGraphsHandleResponse(resp *http.Response, successCodes ...int) (GraphResourcesClientListGraphsResponse, error) {
