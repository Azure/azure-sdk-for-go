...
//   - options - GetOptions contains the optional parameters for the LocationsClient.Get method.
func (client *LocationsClient) Get(ctx context.Context, location string, options *GetOptions) (GetResponse, error) {
	var err error
...
func (client *LocationsClient) getCreateRequest(ctx context.Context, location string, _ *GetOptions) (*policy.Request, error) {
...
func (client *LocationsClient) getHandleResponse(resp *http.Response) (GetResponse, error) {
	result := GetResponse{}
...
//
// Generated from API version 2025-11-01-preview
//   - options - ListOptions contains the optional parameters for the LocationsClient.NewListPager method.
func (client *LocationsClient) NewListPager(options *ListOptions) *runtime.Pager[ListResponse] {
...
func (client *LocationsClient) listCreateRequest(ctx context.Context, _ *ListOptions) (*policy.Request, error) {
...
func (client *LocationsClient) listHandleResponse(resp *http.Response) (ListResponse, error) {
	result := ListResponse{}
