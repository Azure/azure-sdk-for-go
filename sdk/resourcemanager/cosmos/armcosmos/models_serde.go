...
func (a AccountKeyMetadata) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateTimeRFC3339(objectMap, "generationTime", a.GenerationTime)
	return json.Marshal(objectMap)
}
...
func (a *AccountKeyMetadata) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "generationTime":
			err = unpopulateTimeRFC3339(val, "GenerationTime", &a.GenerationTime)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", a, err)
...
func (m MongoClusterRestoreParameters) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateTimeRFC3339(objectMap, "pointInTimeUTC", m.PointInTimeUTC)
