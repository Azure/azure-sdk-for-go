...
func ExampleMongoMIResourcesClient_BeginDeleteMongoMIRoleAssignment() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armcosmos.MongoMIResourcesClientDeleteMongoMIRoleAssignmentResponse{
	// }
}
...
func ExampleMongoMIResourcesClient_BeginDeleteMongoMIRoleDefinition() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armcosmos.MongoMIResourcesClientDeleteMongoMIRoleDefinitionResponse{
	// }
}
...
func ExampleMongoMIResourcesClient_NewListMongoMIRoleAssignmentsPager() {
	...
	for pager.More() {
		...
		// page = armcosmos.MongoMIResourcesClientListMongoMIRoleAssignmentsResponse{
...
func ExampleMongoMIResourcesClient_NewListMongoMIRoleDefinitionsPager() {
	...
	for pager.More() {
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armcosmos.MongoMIResourcesClientListMongoMIRoleDefinitionsResponse{
