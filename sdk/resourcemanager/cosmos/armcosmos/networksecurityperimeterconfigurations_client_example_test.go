...
func ExampleNetworkSecurityPerimeterConfigurationsClient_Get() {
	...
	// 							Subscriptions: []*armcosmos.AccessRulePropertiesSubscription{
	// 								{
...
func ExampleNetworkSecurityPerimeterConfigurationsClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armcosmos.NetworkSecurityPerimeterConfigurationsClientListResponse{
		// 	NetworkSecurityPerimeterConfigurationListResult: armcosmos.NetworkSecurityPerimeterConfigurationListResult{
