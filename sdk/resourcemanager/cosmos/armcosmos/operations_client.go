...
//   - options - ListOptions contains the optional parameters for the OperationsClient.NewListPager method.
func (client *OperationsClient) NewListPager(options *ListOptions) *runtime.Pager[ListResponse] {
...
func (client *OperationsClient) listCreateRequest(ctx context.Context, _ *ListOptions) (*policy.Request, error) {
...
func (client *OperationsClient) listHandleResponse(resp *http.Response) (ListResponse, error) {
	result := ListResponse{}
