...
//     is eq.
//   - options - ListMetricsOptions contains the optional parameters for the PartitionKeyRangeIDClient.NewListMetricsPager method.
func (client *PartitionKeyRangeIDClient) NewListMetricsPager(resourceGroupName string, accountName string, databaseRid string, collectionRid string, partitionKeyRangeID string, filter string, options *ListMetricsOptions) *runtime.Pager[ListMetricsResponse] {
...
func (client *PartitionKeyRangeIDClient) listMetricsCreateRequest(ctx context.Context, resourceGroupName string, accountName string, databaseRid string, collectionRid string, partitionKeyRangeID string, filter string, _ *ListMetricsOptions) (*policy.Request, error) {
...
func (client *PartitionKeyRangeIDClient) listMetricsHandleResponse(resp *http.Response) (ListMetricsResponse, error) {
