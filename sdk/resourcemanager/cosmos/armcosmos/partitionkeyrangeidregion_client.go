...
//     is eq.
//   - options - ListMetricsOptions contains the optional parameters for the PartitionKeyRangeIDRegionClient.NewListMetricsPager
//     method.
func (client *PartitionKeyRangeIDRegionClient) NewListMetricsPager(resourceGroupName string, accountName string, region string, databaseRid string, collectionRid string, partitionKeyRangeID string, filter string, options *ListMetricsOptions) *runtime.Pager[ListMetricsResponse] {
...
func (client *PartitionKeyRangeIDRegionClient) listMetricsCreateRequest(ctx context.Context, resourceGroupName string, accountName string, region string, databaseRid string, collectionRid string, partitionKeyRangeID string, filter string, _ *ListMetricsOptions) (*policy.Request, error) {
...
func (client *PartitionKeyRangeIDRegionClient) listMetricsHandleResponse(resp *http.Response) (ListMetricsResponse, error) {
