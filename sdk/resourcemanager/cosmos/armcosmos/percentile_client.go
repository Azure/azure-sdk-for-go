...
//     is eq.
//   - options - ListMetricsOptions contains the optional parameters for the PercentileClient.NewListMetricsPager method.
func (client *PercentileClient) NewListMetricsPager(resourceGroupName string, accountName string, filter string, options *ListMetricsOptions) *runtime.Pager[ListMetricsResponse] {
...
func (client *PercentileClient) listMetricsCreateRequest(ctx context.Context, resourceGroupName string, accountName string, filter string, _ *ListMetricsOptions) (*policy.Request, error) {
...
func (client *PercentileClient) listMetricsHandleResponse(resp *http.Response) (ListMetricsResponse, error) {
