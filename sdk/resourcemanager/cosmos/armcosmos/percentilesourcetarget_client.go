...
//     is eq.
//   - options - ListMetricsOptions contains the optional parameters for the PercentileSourceTargetClient.NewListMetricsPager
//     method.
func (client *PercentileSourceTargetClient) NewListMetricsPager(resourceGroupName string, accountName string, sourceRegion string, targetRegion string, filter string, options *ListMetricsOptions) *runtime.Pager[ListMetricsResponse] {
...
func (client *PercentileSourceTargetClient) listMetricsCreateRequest(ctx context.Context, resourceGroupName string, accountName string, sourceRegion string, targetRegion string, filter string, _ *ListMetricsOptions) (*policy.Request, error) {
...
func (client *PercentileSourceTargetClient) listMetricsHandleResponse(resp *http.Response) (ListMetricsResponse, error) {
