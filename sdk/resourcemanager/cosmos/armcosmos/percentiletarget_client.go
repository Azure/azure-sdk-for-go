...
//     is eq.
//   - options - ListMetricsOptions contains the optional parameters for the PercentileTargetClient.NewListMetricsPager method.
func (client *PercentileTargetClient) NewListMetricsPager(resourceGroupName string, accountName string, targetRegion string, filter string, options *ListMetricsOptions) *runtime.Pager[ListMetricsResponse] {
...
func (client *PercentileTargetClient) listMetricsCreateRequest(ctx context.Context, resourceGroupName string, accountName string, targetRegion string, filter string, _ *ListMetricsOptions) (*policy.Request, error) {
...
func (client *PercentileTargetClient) listMetricsHandleResponse(resp *http.Response) (ListMetricsResponse, error) {
