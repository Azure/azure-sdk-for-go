...
func (client *PrivateEndpointConnectionsClient) listByDatabaseAccountCreateRequest(ctx context.Context, resourceGroupName string, accountName string, nextLink string, _ *PrivateEndpointConnectionsClientListByDatabaseAccountOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *PrivateEndpointConnectionsClient) listByDatabaseAccountHandleResponse(resp *http.Response, successCodes ...int) (PrivateEndpointConnectionsClientListByDatabaseAccountResponse, error) {
