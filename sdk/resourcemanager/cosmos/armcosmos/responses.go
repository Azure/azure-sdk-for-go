...
// SoftDeletedDatabaseAccountsClientGetResponse contains the response from method SoftDeletedDatabaseAccountsClient.Get.
type SoftDeletedDatabaseAccountsClientGetResponse struct {
	// A Azure Cosmos DB soft-deleted database account.
	SoftDeletedDatabaseAccountGetResult
}

// SoftDeletedDatabaseAccountsClientListByLocationResponse contains the response from method SoftDeletedDatabaseAccountsClient.ListByLocation.
type SoftDeletedDatabaseAccountsClientListByLocationResponse struct {
...
// SoftDeletedDatabaseAccountsClientListByResourceGroupAndLocationResponse contains the response from method SoftDeletedDatabaseAccountsClient.ListByResourceGroupAndLocation.
type SoftDeletedDatabaseAccountsClientListByResourceGroupAndLocationResponse struct {
	// The List operation response, that contains the soft-deleted database accounts and their properties.
	SoftDeletedDatabaseAccountsListResult
}

// SoftDeletedDatabaseAccountsClientPurgeResponse contains the response from method SoftDeletedDatabaseAccountsClient.BeginPurge.
type SoftDeletedDatabaseAccountsClientPurgeResponse struct {
	// placeholder for future response values
}

// SoftDeletedDatabaseAccountsClientRestoreResponse contains the response from method SoftDeletedDatabaseAccountsClient.BeginRestore.
type SoftDeletedDatabaseAccountsClientRestoreResponse struct {
	// placeholder for future response values
}

// SoftDeletedSQLContainersClientGetResponse contains the response from method SoftDeletedSQLContainersClient.Get.
type SoftDeletedSQLContainersClientGetResponse struct {
	// An Azure Cosmos DB soft-deleted SQL container.
	SoftDeletedSQLContainerGetResult
}

// SoftDeletedSQLContainersClientListResponse contains the response from method SoftDeletedSQLContainersClient.List.
type SoftDeletedSQLContainersClientListResponse struct {
...
// SoftDeletedSQLContainersClientPurgeResponse contains the response from method SoftDeletedSQLContainersClient.BeginPurge.
type SoftDeletedSQLContainersClientPurgeResponse struct {
	// placeholder for future response values
}

// SoftDeletedSQLContainersClientRestoreResponse contains the response from method SoftDeletedSQLContainersClient.BeginRestore.
type SoftDeletedSQLContainersClientRestoreResponse struct {
	// placeholder for future response values
}

// SoftDeletedSQLDatabasesClientGetResponse contains the response from method SoftDeletedSQLDatabasesClient.Get.
type SoftDeletedSQLDatabasesClientGetResponse struct {
	// An Azure Cosmos DB soft-deleted SQL database.
	SoftDeletedSQLDatabaseGetResult
}

// SoftDeletedSQLDatabasesClientListResponse contains the response from method SoftDeletedSQLDatabasesClient.List.
type SoftDeletedSQLDatabasesClientListResponse struct {
...
// SoftDeletedSQLDatabasesClientPurgeResponse contains the response from method SoftDeletedSQLDatabasesClient.BeginPurge.
type SoftDeletedSQLDatabasesClientPurgeResponse struct {
	// placeholder for future response values
}

// SoftDeletedSQLDatabasesClientRestoreResponse contains the response from method SoftDeletedSQLDatabasesClient.BeginRestore.
type SoftDeletedSQLDatabasesClientRestoreResponse struct {
	// placeholder for future response values
}
