...
//   - options - ListOptions contains the optional parameters for the RestorableGremlinDatabasesClient.NewListPager method.
func (client *RestorableGremlinDatabasesClient) NewListPager(location string, instanceID string, options *ListOptions) *runtime.Pager[ListResponse] {
...
func (client *RestorableGremlinDatabasesClient) listCreateRequest(ctx context.Context, location string, instanceID string, _ *ListOptions) (*policy.Request, error) {
...
func (client *RestorableGremlinDatabasesClient) listHandleResponse(resp *http.Response) (ListResponse, error) {
	result := ListResponse{}
