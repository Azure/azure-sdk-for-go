...
func (client *RestorableGremlinDatabasesClient) listCreateRequest(ctx context.Context, location string, instanceID string, nextLink string, _ *RestorableGremlinDatabasesClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *RestorableGremlinDatabasesClient) listHandleResponse(resp *http.Response, successCodes ...int) (RestorableGremlinDatabasesClientListResponse, error) {
