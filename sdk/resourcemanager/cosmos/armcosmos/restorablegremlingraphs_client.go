...
//   - options - ListOptions contains the optional parameters for the RestorableGremlinGraphsClient.NewListPager method.
func (client *RestorableGremlinGraphsClient) NewListPager(location string, instanceID string, options *ListOptions) *runtime.Pager[ListResponse] {
...
func (client *RestorableGremlinGraphsClient) listCreateRequest(ctx context.Context, location string, instanceID string, options *ListOptions) (*policy.Request, error) {
...
func (client *RestorableGremlinGraphsClient) listHandleResponse(resp *http.Response) (ListResponse, error) {
	result := ListResponse{}
