...
func (client *RestorableGremlinResourcesClient) listCreateRequest(ctx context.Context, location string, instanceID string, nextLink string, options *RestorableGremlinResourcesClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *RestorableGremlinResourcesClient) listHandleResponse(resp *http.Response, successCodes ...int) (RestorableGremlinResourcesClientListResponse, error) {
