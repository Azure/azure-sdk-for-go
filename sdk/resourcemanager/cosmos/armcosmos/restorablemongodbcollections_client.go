...
//   - options - ListOptions contains the optional parameters for the RestorableMongodbCollectionsClient.NewListPager method.
func (client *RestorableMongodbCollectionsClient) NewListPager(location string, instanceID string, options *ListOptions) *runtime.Pager[ListResponse] {
...
func (client *RestorableMongodbCollectionsClient) listCreateRequest(ctx context.Context, location string, instanceID string, options *ListOptions) (*policy.Request, error) {
...
func (client *RestorableMongodbCollectionsClient) listHandleResponse(resp *http.Response) (ListResponse, error) {
	result := ListResponse{}
