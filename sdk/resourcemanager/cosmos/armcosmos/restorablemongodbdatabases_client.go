...
func (client *RestorableMongodbDatabasesClient) listCreateRequest(ctx context.Context, location string, instanceID string, nextLink string, _ *RestorableMongodbDatabasesClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *RestorableMongodbDatabasesClient) listHandleResponse(resp *http.Response, successCodes ...int) (RestorableMongodbDatabasesClientListResponse, error) {
