...
//   - options - ListOptions contains the optional parameters for the RestorableMongodbDatabasesClient.NewListPager method.
func (client *RestorableMongodbDatabasesClient) NewListPager(location string, instanceID string, options *ListOptions) *runtime.Pager[ListResponse] {
...
func (client *RestorableMongodbDatabasesClient) listCreateRequest(ctx context.Context, location string, instanceID string, _ *ListOptions) (*policy.Request, error) {
...
func (client *RestorableMongodbDatabasesClient) listHandleResponse(resp *http.Response) (ListResponse, error) {
	result := ListResponse{}
