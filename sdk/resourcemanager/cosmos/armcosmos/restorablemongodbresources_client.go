...
//   - options - ListOptions contains the optional parameters for the RestorableMongodbResourcesClient.NewListPager method.
func (client *RestorableMongodbResourcesClient) NewListPager(location string, instanceID string, options *ListOptions) *runtime.Pager[ListResponse] {
...
func (client *RestorableMongodbResourcesClient) listCreateRequest(ctx context.Context, location string, instanceID string, options *ListOptions) (*policy.Request, error) {
...
func (client *RestorableMongodbResourcesClient) listHandleResponse(resp *http.Response) (ListResponse, error) {
	result := ListResponse{}
