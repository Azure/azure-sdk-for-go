...
// Generated from example definition: 2025-11-01-preview/CosmosDBRestorableMongodbResourceList.json
func ExampleRestorableMongodbResourcesClient_NewListPager() {
	...
	pager := clientFactory.NewRestorableMongodbResourcesClient().NewListPager("WestUS", "d9b26648-2f53-4541-b3d8-3044f4f9810d", &armcosmos.RestorableMongodbResourcesClientListOptions{
	...
	for pager.More() {
		...
		// page = armcosmos.RestorableMongodbResourcesClientListResponse{
		// 	RestorableMongodbResourcesListResult: armcosmos.RestorableMongodbResourcesListResult{
