...
func (client *RestorableSQLContainersClient) listCreateRequest(ctx context.Context, location string, instanceID string, nextLink string, options *RestorableSQLContainersClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *RestorableSQLContainersClient) listHandleResponse(resp *http.Response, successCodes ...int) (RestorableSQLContainersClientListResponse, error) {
