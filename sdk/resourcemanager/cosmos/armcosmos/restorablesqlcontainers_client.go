...
//   - options - ListOptions contains the optional parameters for the RestorableSQLContainersClient.NewListPager method.
func (client *RestorableSQLContainersClient) NewListPager(location string, instanceID string, options *ListOptions) *runtime.Pager[ListResponse] {
...
func (client *RestorableSQLContainersClient) listCreateRequest(ctx context.Context, location string, instanceID string, options *ListOptions) (*policy.Request, error) {
...
func (client *RestorableSQLContainersClient) listHandleResponse(resp *http.Response) (ListResponse, error) {
	result := ListResponse{}
