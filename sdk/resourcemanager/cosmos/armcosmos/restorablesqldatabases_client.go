...
//   - options - ListOptions contains the optional parameters for the RestorableSQLDatabasesClient.NewListPager method.
func (client *RestorableSQLDatabasesClient) NewListPager(location string, instanceID string, options *ListOptions) *runtime.Pager[ListResponse] {
...
func (client *RestorableSQLDatabasesClient) listCreateRequest(ctx context.Context, location string, instanceID string, _ *ListOptions) (*policy.Request, error) {
...
func (client *RestorableSQLDatabasesClient) listHandleResponse(resp *http.Response) (ListResponse, error) {
	result := ListResponse{}
