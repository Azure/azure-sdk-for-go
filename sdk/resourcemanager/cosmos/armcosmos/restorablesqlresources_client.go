...
func (client *RestorableSQLResourcesClient) listCreateRequest(ctx context.Context, location string, instanceID string, nextLink string, options *RestorableSQLResourcesClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *RestorableSQLResourcesClient) listHandleResponse(resp *http.Response, successCodes ...int) (RestorableSQLResourcesClientListResponse, error) {
