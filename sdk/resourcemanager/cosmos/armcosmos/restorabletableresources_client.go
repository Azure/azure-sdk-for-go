...
// to validate what resources exist at given timestamp and location. This API requires 'Microsoft.DocumentDB/locations/restorableDatabaseAccounts/.../read'
// permission.
//
// Generated from API version 2025-11-01-preview
//   - location - Cosmos DB region, with spaces between words and each word capitalized.
//   - instanceID - The instanceId GUID of a restorable database account.
//   - options - ListOptions contains the optional parameters for the RestorableTableResourcesClient.NewListPager method.
func (client *RestorableTableResourcesClient) NewListPager(location string, instanceID string, options *ListOptions) *runtime.Pager[ListResponse] {
...
func (client *RestorableTableResourcesClient) listCreateRequest(ctx context.Context, location string, instanceID string, options *ListOptions) (*policy.Request, error) {
...
func (client *RestorableTableResourcesClient) listHandleResponse(resp *http.Response) (ListResponse, error) {
	result := ListResponse{}
