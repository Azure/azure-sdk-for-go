...
func ExampleRestorableTableResourcesClient_NewListPager() {
	...
	pager := clientFactory.NewRestorableTableResourcesClient().NewListPager("WestUS", "d9b26648-2f53-4541-b3d8-3044f4f9810d", &armcosmos.RestorableTableResourcesClientListOptions{
	...
	for pager.More() {
		...
		// page = armcosmos.RestorableTableResourcesClientListResponse{
