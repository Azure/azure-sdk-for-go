...
func (client *RestorableTablesClient) listCreateRequest(ctx context.Context, location string, instanceID string, nextLink string, options *RestorableTablesClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *RestorableTablesClient) listHandleResponse(resp *http.Response, successCodes ...int) (RestorableTablesClientListResponse, error) {
