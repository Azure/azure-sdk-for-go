...
func (client *ServiceClient) listCreateRequest(ctx context.Context, resourceGroupName string, accountName string, nextLink string, _ *ServiceClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
