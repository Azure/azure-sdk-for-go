...
//   - options - ListOptions contains the optional parameters for the ThroughputPoolAccountsClient.NewListPager method.
func (client *ThroughputPoolAccountsClient) NewListPager(resourceGroupName string, throughputPoolName string, options *ListOptions) *runtime.Pager[ListResponse] {
...
func (client *ThroughputPoolAccountsClient) listCreateRequest(ctx context.Context, resourceGroupName string, throughputPoolName string, _ *ListOptions) (*policy.Request, error) {
...
func (client *ThroughputPoolAccountsClient) listHandleResponse(resp *http.Response) (ListResponse, error) {
	result := ListResponse{}
