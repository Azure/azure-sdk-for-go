...
func (client *ThroughputPoolsClient) listCreateRequest(ctx context.Context, nextLink string, _ *ThroughputPoolsClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *ThroughputPoolsClient) listHandleResponse(resp *http.Response, successCodes ...int) (ThroughputPoolsClientListResponse, error) {
...
func (client *ThroughputPoolsClient) listByResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, nextLink string, _ *ThroughputPoolsClientListByResourceGroupOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
	var req *policy.Request
	var err error
	if firstPage {
...
func (client *ThroughputPoolsClient) listByResourceGroupHandleResponse(resp *http.Response, successCodes ...int) (ThroughputPoolsClientListByResourceGroupResponse, error) {
