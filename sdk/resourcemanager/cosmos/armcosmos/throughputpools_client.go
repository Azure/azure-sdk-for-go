...
//   - options - ListOptions contains the optional parameters for the ThroughputPoolsClient.NewListPager method.
func (client *ThroughputPoolsClient) NewListPager(options *ListOptions) *runtime.Pager[ListResponse] {
...
func (client *ThroughputPoolsClient) listCreateRequest(ctx context.Context, _ *ListOptions) (*policy.Request, error) {
...
func (client *ThroughputPoolsClient) listHandleResponse(resp *http.Response) (ListResponse, error) {
	result := ListResponse{}
...
//   - options - ListByResourceGroupOptions contains the optional parameters for the ThroughputPoolsClient.NewListByResourceGroupPager
//     method.
func (client *ThroughputPoolsClient) NewListByResourceGroupPager(resourceGroupName string, options *ListByResourceGroupOptions) *runtime.Pager[ListByResourceGroupResponse] {
...
func (client *ThroughputPoolsClient) listByResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, _ *ListByResourceGroupOptions) (*policy.Request, error) {
...
func (client *ThroughputPoolsClient) listByResourceGroupHandleResponse(resp *http.Response) (ListByResourceGroupResponse, error) {
