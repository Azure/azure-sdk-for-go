...
func ExampleRestorableGremlinResourcesClient_List() {
	...
	client, err := armcosmos.NewRestorableGremlinResourcesClient("<subscription-id>", cred, nil)
	if err != nil {
	...
	pager := client.List("<location>",
		"<instance-id>",
		&armcosmos.RestorableGremlinResourcesClientListOptions{RestoreLocation: to.Ptr("<restore-location>"),
