...
//     /providers/Microsoft.Billing/billingAccounts/{billingAccountId}' for enterprise agreement scope, and '/providers/Microsoft.Billing/billingAccounts/{billingAccountId}/billingProfiles/{billingProfileId}'
...
func (client *BenefitRecommendationsClient) NewListPager(billingScope string, options *BenefitRecommendationsClientListOptions) *runtime.Pager[BenefitRecommendationsClientListResponse] {
	return runtime.NewPager(runtime.PagingHandler[BenefitRecommendationsClientListResponse]{
		...
		Fetcher: func(ctx context.Context, page *BenefitRecommendationsClientListResponse) (BenefitRecommendationsClientListResponse, error) {
			...
			req, err := client.listCreateRequest(ctx, billingScope, nextLink, options)
			if err != nil {
...
func (client *BenefitRecommendationsClient) listCreateRequest(ctx context.Context, billingScope string, nextLink string, options *BenefitRecommendationsClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *BenefitRecommendationsClient) listHandleResponse(resp *http.Response, successCodes ...int) (BenefitRecommendationsClientListResponse, error) {
