...
// Generated from example definition: 2026-06-01/BenefitRecommendationsByBillingAccount.json
func ExampleBenefitRecommendationsClient_NewListPager_benefitRecommendationsBillingAccountList() {
	...
	for pager.More() {
		...
		// 					FirstConsumptionDate: to.Ptr(time.Date(2022, time.October, 18, 0, 0, 0, 0, time.UTC)),
		// 					LastConsumptionDate: to.Ptr(time.Date(2022, time.October, 25, 0, 0, 0, 0, time.UTC)),
...
// Generated from example definition: 2026-06-01/BenefitRecommendationsByBillingAccountForManagementGroup.json
func ExampleBenefitRecommendationsClient_NewListPager_benefitRecommendationsManagementGroupList() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	pager := clientFactory.NewBenefitRecommendationsClient().NewListPager("providers/Microsoft.Billing/billingAccounts/123456", &armcostmanagement.BenefitRecommendationsClientListOptions{
		Expand: to.Ptr("properties/usage,properties/allRecommendationDetails"),
		Filter: to.Ptr("properties/scope eq 'ManagementGroup' AND properties/managementGroupId eq '/providers/Microsoft.Management/managementGroups/00000000-0000-0000-0000-000000000001' AND properties/lookBackPeriod eq 'Last7Days' AND properties/term eq 'P1Y'")})
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
		...
		// 				ID: to.Ptr("/providers/Microsoft.Billing/billingAccounts/123456/providers/Microsoft.CostManagement/benefitRecommendations/00000000-0000-0000-0000-000000000000"),
		// 				Kind: to.Ptr(armcostmanagement.BenefitKindSavingsPlan),
		// 				Properties: &armcostmanagement.ManagementGroupScopeBenefitRecommendationProperties{
		// 					AllRecommendationDetails: &armcostmanagement.AllSavingsList{
		// 						Value: []*armcostmanagement.AllSavingsBenefitDetails{
		// 							{
		// 								AverageUtilizationPercentage: to.Ptr[float64](99.33),
		...
		// 						WastageCost: to.Ptr[float64](0.035),
		// 					},
		// 					ManagementGroupID: to.Ptr("/providers/Microsoft.Management/managementGroups/00000000-0000-0000-0000-000000000001"),
		// 					TenantID: to.Ptr("00000000-0000-0000-0000-000000000001"),
		// 					Scope: to.Ptr(armcostmanagement.ScopeManagementGroup),
		// 					Term: to.Ptr(armcostmanagement.TermP1Y),
		// 					TotalHours: to.Ptr[int32](168),
		// 					Usage: &armcostmanagement.RecommendationUsageDetails{
		// 						Charges: []*float64{
