...
func ExampleDimensionsClient_NewByExternalCloudProviderTypePager_externalBillingAccountDimensionList() {
	...
	pager := clientFactory.NewDimensionsClient().NewByExternalCloudProviderTypePager(armcostmanagement.ExternalCloudProviderTypeExternalBillingAccounts, "100", nil)
	for pager.More() {
		...
		// page = armcostmanagement.DimensionsClientByExternalCloudProviderTypeResponse{
		...
		// 					UsageEnd: to.Ptr(time.Date(2019, time.December, 31, 0, 0, 0, 0, time.UTC)),
		// 					UsageStart: to.Ptr(time.Date(2019, time.December, 1, 0, 0, 0, 0, time.UTC)),
		// 				},
		// 			},
		// 			{
...
func ExampleDimensionsClient_NewByExternalCloudProviderTypePager_externalSubscriptionDimensionList() {
	...
	pager := clientFactory.NewDimensionsClient().NewByExternalCloudProviderTypePager(armcostmanagement.ExternalCloudProviderTypeExternalSubscriptions, "100", nil)
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
...
func ExampleDimensionsClient_NewListPager_billingAccountDimensionsListLegacy() {
	...
	pager := clientFactory.NewDimensionsClient().NewListPager("providers/Microsoft.Billing/billingAccounts/100", nil)
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
		...
		// 					UsageEnd: to.Ptr(time.Date(2018, time.May, 31, 7, 0, 0, 0, time.UTC)),
		// 					UsageStart: to.Ptr(time.Date(2018, time.May, 1, 7, 0, 0, 0, time.UTC)),
		// 				},
		// 			},
		// 			{
...
func ExampleDimensionsClient_NewListPager_billingAccountDimensionsListExpandAndTopLegacy() {
	...
	pager := clientFactory.NewDimensionsClient().NewListPager("providers/Microsoft.Billing/billingAccounts/100", &armcostmanagement.DimensionsClientListOptions{
...
func ExampleDimensionsClient_NewListPager_billingAccountDimensionsListWithFilterLegacy() {
	...
	for pager.More() {
		...
		// 					FilterEnabled: to.Ptr(true),
		// 					GroupingEnabled: to.Ptr(true),
		// 					NextLink: to.Ptr("http://management.azure.com/providers/Microsoft.Billing/billingAccounts/100/providers/Microsoft.CostManagement/Dimensions?$filter=properties/category eq 'resourceId'&$top=5&api-version=2019-10-01&$expand=properties/data&$skiptoken=AQAAAA%3D%3D"),
...
func ExampleDimensionsClient_NewListPager_departmentDimensionsListLegacy() {
	...
	pager := clientFactory.NewDimensionsClient().NewListPager("providers/Microsoft.Billing/billingAccounts/100/departments/123", nil)
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
...
func ExampleDimensionsClient_NewListPager_departmentDimensionsListExpandAndTopLegacy() {
	...
	pager := clientFactory.NewDimensionsClient().NewListPager("providers/Microsoft.Billing/billingAccounts/100/departments/123", &armcostmanagement.DimensionsClientListOptions{
		Expand: to.Ptr("properties/data"),
		Top:    to.Ptr[int32](5)})
	for pager.More() {
		page, err := pager.NextPage(ctx)
...
func ExampleDimensionsClient_NewListPager_departmentDimensionsListWithFilterLegacy() {
	...
	for pager.More() {
		...
		// 					FilterEnabled: to.Ptr(true),
		// 					GroupingEnabled: to.Ptr(true),
		// 					NextLink: to.Ptr("https://management.azure.com/providers/Microsoft.Billing/billingAccounts/100/departments/123/providers/Microsoft.CostManagement/Dimensions?$filter=properties/category eq 'resourceId'&$top=5&api-version=2019-10-01&$expand=properties/data&$skiptoken=AQAAAA%3D%3D"),
		// 					Total: to.Ptr[int32](1409),
		// 					UsageEnd: to.Ptr(time.Date(2018, time.May, 31, 7, 0, 0, 0, time.UTC)),
		// 					UsageStart: to.Ptr(time.Date(2018, time.May, 1, 7, 0, 0, 0, time.UTC)),
		// 				},
...
func ExampleDimensionsClient_NewListPager_enrollmentAccountDimensionsListLegacy() {
	...
	pager := clientFactory.NewDimensionsClient().NewListPager("providers/Microsoft.Billing/billingAccounts/100/enrollmentAccounts/456", nil)
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
...
func ExampleDimensionsClient_NewListPager_enrollmentAccountDimensionsListExpandAndTopLegacy() {
	...
	pager := clientFactory.NewDimensionsClient().NewListPager("providers/Microsoft.Billing/billingAccounts/100/enrollmentAccounts/456", &armcostmanagement.DimensionsClientListOptions{
		Expand: to.Ptr("properties/data"),
		Top:    to.Ptr[int32](5)})
	for pager.More() {
		page, err := pager.NextPage(ctx)
...
func ExampleDimensionsClient_NewListPager_enrollmentAccountDimensionsListWithFilterLegacy() {
	...
	for pager.More() {
		...
		// 					FilterEnabled: to.Ptr(true),
		// 					GroupingEnabled: to.Ptr(true),
		// 					NextLink: to.Ptr("https://management.azure.com/providers/Microsoft.Billing/billingAccounts/100/enrollmentAccounts/456/providers/Microsoft.CostManagement/Dimensions?$filter=properties/category eq 'resourceId'&$top=5&api-version=2019-10-01&$expand=properties/data&$skiptoken=AQAAAA%3D%3D"),
		// 					Total: to.Ptr[int32](1409),
		// 					UsageEnd: to.Ptr(time.Date(2018, time.May, 31, 7, 0, 0, 0, time.UTC)),
		// 					UsageStart: to.Ptr(time.Date(2018, time.May, 1, 7, 0, 0, 0, time.UTC)),
		// 				},
...
func ExampleDimensionsClient_NewListPager_billingAccountDimensionsListMca() {
	...
	pager := clientFactory.NewDimensionsClient().NewListPager("providers/Microsoft.Billing/billingAccounts/12345:6789", nil)
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
		...
		// 					GroupingEnabled: to.Ptr(true),
		// 					Total: to.Ptr[int32](377),
		// 					UsageEnd: to.Ptr(time.Date(2019, time.October, 31, 7, 0, 0, 0, time.UTC)),
		// 					UsageStart: to.Ptr(time.Date(2019, time.October, 1, 7, 0, 0, 0, time.UTC)),
		// 				},
		// 			},
		// 			{
...
func ExampleDimensionsClient_NewListPager_billingProfileDimensionsListMca() {
	...
	pager := clientFactory.NewDimensionsClient().NewListPager("providers/Microsoft.Billing/billingAccounts/12345:6789/billingProfiles/13579", nil)
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
...
func ExampleDimensionsClient_NewListPager_billingProfileDimensionsListExpandAndTopMca() {
	...
	pager := clientFactory.NewDimensionsClient().NewListPager("providers/Microsoft.Billing/billingAccounts/12345:6789/billingProfiles/13579", &armcostmanagement.DimensionsClientListOptions{
		Expand: to.Ptr("properties/data"),
		Top:    to.Ptr[int32](5)})
	for pager.More() {
		page, err := pager.NextPage(ctx)
...
func ExampleDimensionsClient_NewListPager_billingProfileDimensionsListWithFilterMca() {
	...
	for pager.More() {
		...
		// 					FilterEnabled: to.Ptr(true),
		// 					GroupingEnabled: to.Ptr(true),
		// 					NextLink: to.Ptr("http://management.azure.com/providers/Microsoft.Billing/billingAccounts/12345:6789/billingProfiles/13579/providers/Microsoft.CostManagement/Dimensions?$filter=properties/category eq 'resourceId'&$top=5&api-version=2019-10-01&$expand=properties/data&$skiptoken=AQAAAA%3D%3D"),
		// 					Total: to.Ptr[int32](1409),
		// 					UsageEnd: to.Ptr(time.Date(2019, time.October, 31, 7, 0, 0, 0, time.UTC)),
		// 					UsageStart: to.Ptr(time.Date(2019, time.October, 1, 7, 0, 0, 0, time.UTC)),
		// 				},
...
func ExampleDimensionsClient_NewListPager_customerDimensionsListMca() {
	...
	pager := clientFactory.NewDimensionsClient().NewListPager("providers/Microsoft.Billing/billingAccounts/12345:6789/customers/5678", nil)
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
...
func ExampleDimensionsClient_NewListPager_customerDimensionsListExpandAndTopMca() {
	...
	pager := clientFactory.NewDimensionsClient().NewListPager("providers/Microsoft.Billing/billingAccounts/12345:6789/customers/5678", &armcostmanagement.DimensionsClientListOptions{
		Expand: to.Ptr("properties/data"),
		Top:    to.Ptr[int32](5)})
	for pager.More() {
		page, err := pager.NextPage(ctx)
...
func ExampleDimensionsClient_NewListPager_customerDimensionsListWithFilterMca() {
	...
	for pager.More() {
		...
		// 					FilterEnabled: to.Ptr(true),
		// 					GroupingEnabled: to.Ptr(true),
		// 					NextLink: to.Ptr("http://management.azure.com/providers/Microsoft.Billing/billingAccounts/12345:6789/customers/5678/providers/Microsoft.CostManagement/Dimensions?$filter=properties/category eq 'resourceId'&$top=5&api-version=2019-10-01&$expand=properties/data&$skiptoken=AQAAAA%3D%3D"),
		// 					Total: to.Ptr[int32](1409),
		// 					UsageEnd: to.Ptr(time.Date(2019, time.October, 31, 7, 0, 0, 0, time.UTC)),
		// 					UsageStart: to.Ptr(time.Date(2019, time.October, 1, 7, 0, 0, 0, time.UTC)),
		// 				},
...
func ExampleDimensionsClient_NewListPager_invoiceSectionDimensionsListMca() {
	...
	pager := clientFactory.NewDimensionsClient().NewListPager("providers/Microsoft.Billing/billingAccounts/12345:6789/billingProfiles/13579/invoiceSections/9876", nil)
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
...
func ExampleDimensionsClient_NewListPager_invoiceSectionDimensionsListExpandAndTopMca() {
	...
	pager := clientFactory.NewDimensionsClient().NewListPager("providers/Microsoft.Billing/billingAccounts/12345:6789/billingProfiles/13579/invoiceSections/9876", &armcostmanagement.DimensionsClientListOptions{
		Expand: to.Ptr("properties/data"),
		Top:    to.Ptr[int32](5)})
	for pager.More() {
		page, err := pager.NextPage(ctx)
...
func ExampleDimensionsClient_NewListPager_managementGroupDimensionsListExpandAndTopLegacy() {
	...
	pager := clientFactory.NewDimensionsClient().NewListPager("providers/Microsoft.Management/managementGroups/MyMgId", &armcostmanagement.DimensionsClientListOptions{
		Expand: to.Ptr("properties/data"),
		Top:    to.Ptr[int32](5)})
	for pager.More() {
		page, err := pager.NextPage(ctx)
...
func ExampleDimensionsClient_NewListPager_managementGroupDimensionsListWithFilterLegacy() {
	...
	for pager.More() {
		...
		// 					FilterEnabled: to.Ptr(true),
		// 					GroupingEnabled: to.Ptr(true),
		// 					NextLink: to.Ptr("http://management.azure.com/providers/Microsoft.Management/managementGroups/MyMgId/providers/Microsoft.CostManagement/Dimensions?$filter=properties/category eq 'resourceId'&$top=5&api-version=2019-10-01&$expand=properties/data&$skiptoken=AQAAAA%3D%3D"),
		// 					Total: to.Ptr[int32](1409),
		// 					UsageEnd: to.Ptr(time.Date(2018, time.May, 31, 7, 0, 0, 0, time.UTC)),
		// 					UsageStart: to.Ptr(time.Date(2018, time.May, 1, 7, 0, 0, 0, time.UTC)),
		// 				},
...
func ExampleDimensionsClient_NewListPager_resourceGroupDimensionsListLegacy() {
	...
	pager := clientFactory.NewDimensionsClient().NewListPager("subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/system.orlando", &armcostmanagement.DimensionsClientListOptions{
		Expand: to.Ptr("properties/data"),
		Top:    to.Ptr[int32](5)})
	for pager.More() {
		page, err := pager.NextPage(ctx)
...
func ExampleDimensionsClient_NewListPager_subscriptionDimensionsListLegacy() {
	...
	pager := clientFactory.NewDimensionsClient().NewListPager("subscriptions/00000000-0000-0000-0000-000000000000", &armcostmanagement.DimensionsClientListOptions{
		Expand: to.Ptr("properties/data"),
		Top:    to.Ptr[int32](5)})
	for pager.More() {
		page, err := pager.NextPage(ctx)
