...
func ExampleExportsClient_CreateOrUpdate_exportCreateOrUpdateByBillingAccount() {
		...
		Properties: &armcostmanagement.ExportProperties{
			...
			Schedule: &armcostmanagement.ExportSchedule{
				...
				RecurrencePeriod: &armcostmanagement.ExportRecurrencePeriod{
					From: to.Ptr(time.Date(2020, time.June, 1, 0, 0, 0, 0, time.UTC)),
					To:   to.Ptr(time.Date(2020, time.June, 30, 0, 0, 0, 0, time.UTC)),
				},
	...
	// 			},
	// 			ExportDescription: to.Ptr("This is a test export."),
	// 			NextRunTimeEstimate: to.Ptr(time.Date(2020, time.June, 1, 23, 0, 0, 0, time.UTC)),
	// 			PartitionData: to.Ptr(true),
	// 			Schedule: &armcostmanagement.ExportSchedule{
	// 				Recurrence: to.Ptr(armcostmanagement.RecurrenceTypeDaily),
	// 				RecurrencePeriod: &armcostmanagement.ExportRecurrencePeriod{
		...
		Properties: &armcostmanagement.ExportProperties{
			...
			Definition: &armcostmanagement.ExportDefinition{
				...
				TimePeriod: &armcostmanagement.ExportTimePeriod{
					From: to.Ptr(time.Date(2025, time.April, 3, 0, 0, 0, 0, time.UTC)),
					To:   to.Ptr(time.Date(2025, time.April, 3, 0, 0, 0, 0, time.UTC)),
				},
...
func ExampleExportsClient_CreateOrUpdate_exportCreateOrUpdateByBillingAccountMonthly() {
	...
	res, err := clientFactory.NewExportsClient().CreateOrUpdate(ctx, "providers/Microsoft.Billing/billingAccounts/123456", "TestExport", armcostmanagement.Export{
		...
		Properties: &armcostmanagement.ExportProperties{
			...
			Schedule: &armcostmanagement.ExportSchedule{
				...
				RecurrencePeriod: &armcostmanagement.ExportRecurrencePeriod{
					From: to.Ptr(time.Date(2020, time.June, 5, 0, 0, 0, 0, time.UTC)),
					To:   to.Ptr(time.Date(2030, time.June, 30, 0, 0, 0, 0, time.UTC)),
				},
				Status: to.Ptr(armcostmanagement.StatusTypeActive),
			},
		},
	...
	// 			},
	// 			ExportDescription: to.Ptr("This is a test export."),
	// 			NextRunTimeEstimate: to.Ptr(time.Date(2020, time.June, 5, 23, 0, 0, 0, time.UTC)),
	// 			PartitionData: to.Ptr(true),
	// 			Schedule: &armcostmanagement.ExportSchedule{
	// 				Recurrence: to.Ptr(armcostmanagement.RecurrenceTypeMonthly),
	// 				RecurrencePeriod: &armcostmanagement.ExportRecurrencePeriod{
...
func ExampleExportsClient_CreateOrUpdate_exportCreateOrUpdateByBillingAccountPricesheet() {
	...
	res, err := clientFactory.NewExportsClient().CreateOrUpdate(ctx, "providers/Microsoft.Billing/billingAccounts/123456", "TestExport", armcostmanagement.Export{
		...
		Properties: &armcostmanagement.ExportProperties{
			...
			Schedule: &armcostmanagement.ExportSchedule{
				Recurrence: to.Ptr(armcostmanagement.RecurrenceTypeDaily),
				RecurrencePeriod: &armcostmanagement.ExportRecurrencePeriod{
					From: to.Ptr(time.Date(2023, time.June, 1, 0, 0, 0, 0, time.UTC)),
					To:   to.Ptr(time.Date(2023, time.June, 30, 0, 0, 0, 0, time.UTC)),
				},
				Status: to.Ptr(armcostmanagement.StatusTypeActive),
			},
		},
	...
	// 			},
	// 			ExportDescription: to.Ptr("This is a test export."),
	// 			NextRunTimeEstimate: to.Ptr(time.Date(2023, time.June, 1, 23, 0, 0, 0, time.UTC)),
	// 			PartitionData: to.Ptr(true),
	// 			Schedule: &armcostmanagement.ExportSchedule{
	// 				Recurrence: to.Ptr(armcostmanagement.RecurrenceTypeDaily),
	// 				RecurrencePeriod: &armcostmanagement.ExportRecurrencePeriod{
...
func ExampleExportsClient_Get_exportGetByBillingAccount() {
	...
	// 				},
	// 				TimePeriod: &armcostmanagement.ExportTimePeriod{
	// 					From: to.Ptr(time.Date(2020, time.May, 1, 0, 0, 0, 0, time.UTC)),
	// 					To: to.Ptr(time.Date(2020, time.May, 31, 0, 0, 0, 0, time.UTC)),
	// 				},
	// 				Timeframe: to.Ptr(armcostmanagement.TimeframeTypeCustom),
	// 			},
	// 			DeliveryInfo: &armcostmanagement.ExportDeliveryInfo{
...
func ExampleExportsClient_Get_exportGetByEnrollmentAccount() {
	...
	// 				},
	// 				TimePeriod: &armcostmanagement.ExportTimePeriod{
	// 					From: to.Ptr(time.Date(2019, time.September, 1, 0, 0, 0, 0, time.UTC)),
	// 					To: to.Ptr(time.Date(2019, time.September, 30, 0, 0, 0, 0, time.UTC)),
	// 				},
	// 				Timeframe: to.Ptr(armcostmanagement.TimeframeTypeCustom),
	// 			},
	// 			DeliveryInfo: &armcostmanagement.ExportDeliveryInfo{
...
func ExampleExportsClient_Get_exportGetByManagementGroup() {
	...
	// 				TimePeriod: &armcostmanagement.ExportTimePeriod{
	// 					From: to.Ptr(time.Date(2019, time.September, 1, 0, 0, 0, 0, time.UTC)),
	// 					To: to.Ptr(time.Date(2020, time.September, 30, 0, 0, 0, 0, time.UTC)),
	// 				},
	// 				Timeframe: to.Ptr(armcostmanagement.TimeframeTypeCustom),
	// 			},
	// 			DeliveryInfo: &armcostmanagement.ExportDeliveryInfo{
...
func ExampleExportsClient_Get_exportGetBySubscription() {
	...
	// 				},
	// 				TimePeriod: &armcostmanagement.ExportTimePeriod{
	// 					From: to.Ptr(time.Date(2019, time.June, 1, 0, 0, 0, 0, time.UTC)),
	// 					To: to.Ptr(time.Date(2019, time.June, 30, 0, 0, 0, 0, time.UTC)),
	// 				},
	// 				Timeframe: to.Ptr(armcostmanagement.TimeframeTypeCustom),
	// 			},
	// 			DeliveryInfo: &armcostmanagement.ExportDeliveryInfo{
...
func ExampleExportsClient_GetExecutionHistory_exportRunHistoryGetByBillingAccount() {
	...
	// 					EndDate: to.Ptr(time.Date(2020, time.June, 30, 0, 0, 0, 0, time.UTC)),
	...
	// 					ProcessingEndTime: to.Ptr(time.Date(2018, time.August, 3, 7, 52, 28, 37331800, time.UTC)),
	// 					ProcessingStartTime: to.Ptr(time.Date(2018, time.August, 3, 7, 52, 16, 912379700, time.UTC)),
	...
	// 						PartitionData: to.Ptr(true),
	// 					},
	// 					StartDate: to.Ptr(time.Date(2020, time.June, 1, 0, 0, 0, 0, time.UTC)),
	// 					Status: to.Ptr(armcostmanagement.ExecutionStatusCompleted),
	// 					SubmittedBy: to.Ptr("john.doe@gmail.com"),
	// 					SubmittedTime: to.Ptr(time.Date(2018, time.August, 3, 7, 52, 15, 601668100, time.UTC)),
	// 				},
	// 			},
	// 			{
	...
	// 					ManifestFile: to.Ptr("ScheduledTestsForJohnDoe/JohnDoeSchedule/20180729-20180804/manifestfile"),
	// 					ProcessingEndTime: to.Ptr(time.Date(2018, time.August, 3, 9, 4, 19, 722380800, time.UTC)),
	// 					ProcessingStartTime: to.Ptr(time.Date(2018, time.August, 3, 9, 3, 58, 571024400, time.UTC)),
	// 					RunSettings: &armcostmanagement.CommonExportProperties{
	// 						Format: to.Ptr(armcostmanagement.FormatTypeCSV),
	// 						CompressionMode: to.Ptr(armcostmanagement.CompressionModeTypeGzip),
	// 						DataOverwriteBehavior: to.Ptr(armcostmanagement.DataOverwriteBehaviorTypeOverwritePreviousReport),
	...
	// 					SubmittedTime: to.Ptr(time.Date(2018, time.August, 3, 9, 3, 58, 571024400, time.UTC)),
	// 				},
	// 			},
	// 		},
	// 	},
