...
type AlertsServer struct {
	...
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager	func(scope string, options *armcostmanagement.AlertsClientListOptions) (resp azfake.PagerResponder[armcostmanagement.AlertsClientListResponse])
...
func NewAlertsServerTransport(srv *AlertsServer) *AlertsServerTransport {
	return &AlertsServerTransport{
		srv:		srv,
		newListPager:	newTracker[azfake.PagerResponder[armcostmanagement.AlertsClientListResponse]](),
	}
}
...
type AlertsServerTransport struct {
	srv		*AlertsServer
	newListPager	*tracker[azfake.PagerResponder[armcostmanagement.AlertsClientListResponse]]
}
