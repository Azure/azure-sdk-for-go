...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "BenefitRecommendationsClient":
		initServer(&s.trMu, &s.trBenefitRecommendationsServer, func() *BenefitRecommendationsServerTransport {
	...
	case "BenefitUtilizationSummariesClient":
		initServer(&s.trMu, &s.trBenefitUtilizationSummariesServer, func() *BenefitUtilizationSummariesServerTransport {
	...
	case "BudgetsClient":
		initServer(&s.trMu, &s.trBudgetsServer, func() *BudgetsServerTransport { return NewBudgetsServerTransport(&s.srv.BudgetsServer) })
		resp, err = s.trBudgetsServer.Do(req)
	case "CostAllocationRulesClient":
		initServer(&s.trMu, &s.trCostAllocationRulesServer, func() *CostAllocationRulesServerTransport {
	...
	case "DimensionsClient":
		initServer(&s.trMu, &s.trDimensionsServer, func() *DimensionsServerTransport { return NewDimensionsServerTransport(&s.srv.DimensionsServer) })
		resp, err = s.trDimensionsServer.Do(req)
	case "ExportsClient":
		initServer(&s.trMu, &s.trExportsServer, func() *ExportsServerTransport { return NewExportsServerTransport(&s.srv.ExportsServer) })
		resp, err = s.trExportsServer.Do(req)
	case "ForecastClient":
		initServer(&s.trMu, &s.trForecastServer, func() *ForecastServerTransport { return NewForecastServerTransport(&s.srv.ForecastServer) })
		resp, err = s.trForecastServer.Do(req)
	case "GenerateBenefitUtilizationSummariesReportClient":
		initServer(&s.trMu, &s.trGenerateBenefitUtilizationSummariesReportServer, func() *GenerateBenefitUtilizationSummariesReportServerTransport {
	...
	case "GenerateCostDetailsReportClient":
		initServer(&s.trMu, &s.trGenerateCostDetailsReportServer, func() *GenerateCostDetailsReportServerTransport {
	...
	case "GenerateDetailedCostReportClient":
		initServer(&s.trMu, &s.trGenerateDetailedCostReportServer, func() *GenerateDetailedCostReportServerTransport {
	...
	case "GenerateDetailedCostReportOperationResultsClient":
		initServer(&s.trMu, &s.trGenerateDetailedCostReportOperationResultsServer, func() *GenerateDetailedCostReportOperationResultsServerTransport {
	...
	case "GenerateDetailedCostReportOperationStatusClient":
		initServer(&s.trMu, &s.trGenerateDetailedCostReportOperationStatusServer, func() *GenerateDetailedCostReportOperationStatusServerTransport {
	...
	case "GenerateReservationDetailsReportClient":
		initServer(&s.trMu, &s.trGenerateReservationDetailsReportServer, func() *GenerateReservationDetailsReportServerTransport {
	...
	case "PriceSheetClient":
		initServer(&s.trMu, &s.trPriceSheetServer, func() *PriceSheetServerTransport { return NewPriceSheetServerTransport(&s.srv.PriceSheetServer) })
		resp, err = s.trPriceSheetServer.Do(req)
	case "QueryClient":
		initServer(&s.trMu, &s.trQueryServer, func() *QueryServerTransport { return NewQueryServerTransport(&s.srv.QueryServer) })
	...
	case "ViewsClient":
		initServer(&s.trMu, &s.trViewsServer, func() *ViewsServerTransport { return NewViewsServerTransport(&s.srv.ViewsServer) })
