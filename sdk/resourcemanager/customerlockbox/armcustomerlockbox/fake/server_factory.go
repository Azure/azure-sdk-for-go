...
// The returned ServerFactoryTransport instance is connected to an instance of armcustomerlockbox.ClientFactory via the
...
// ServerFactoryTransport connects instances of armcustomerlockbox.ClientFactory to instances of ServerFactory.
...
type ServerFactoryTransport struct {
	...
	trPostServer       *PostServerTransport
...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "PostClient":
		initServer(s, &s.trPostServer, func() *PostServerTransport { return NewPostServerTransport(&s.srv.PostServer) })
		resp, err = s.trPostServer.Do(req)
	case "RequestsClient":
