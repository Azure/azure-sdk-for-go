...
- Field `AzureAsyncOperation` of struct `GrafanaClientUpdateResponse` has been removed

### Features Added

- New function `*ClientFactory.NewDashboardsClient() *DashboardsClient`
...
- New function `NewDashboardsClient(string, azcore.TokenCredential, *arm.ClientOptions) (*DashboardsClient, error)`
- New function `*DashboardsClient.Get(context.Context, string, string, *DashboardsClientGetOptions) (DashboardsClientGetResponse, error)`
...
- New function `*DashboardsClient.NewListPager(string, *DashboardsClientListOptions) *runtime.Pager[DashboardsClientListResponse]`
