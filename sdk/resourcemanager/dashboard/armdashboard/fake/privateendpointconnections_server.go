...
type PrivateEndpointConnectionsServer struct {
	...
	BeginApprove func(ctx context.Context, resourceGroupName string, workspaceName string, privateEndpointConnectionName string, options *armdashboard.PrivateEndpointConnectionsClientBeginApproveOptions) (resp azfake.PollerResponder[armdashboard.PrivateEndpointConnectionsClientApproveResponse], errResp azfake.ErrorResponder)
...
func (p *PrivateEndpointConnectionsServerTransport) dispatchBeginApprove(req *http.Request) (*http.Response, error) {
	...
	if beginApprove == nil {
		...
		var options *armdashboard.PrivateEndpointConnectionsClientBeginApproveOptions
		if !reflect.ValueOf(body).IsZero() {
			options = &armdashboard.PrivateEndpointConnectionsClientBeginApproveOptions{
				Body: &body,
			}
		}
		respr, errRespr := p.srv.BeginApprove(req.Context(), resourceGroupNameParam, workspaceNameParam, privateEndpointConnectionNameParam, options)
