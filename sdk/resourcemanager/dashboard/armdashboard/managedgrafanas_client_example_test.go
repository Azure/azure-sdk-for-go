...
func ExampleManagedGrafanasClient_BeginCreate() {
	...
	poller, err := clientFactory.NewManagedGrafanasClient().BeginCreate(ctx, "myResourceGroup", "myWorkspace", armdashboard.ManagedGrafana{
...
func ExampleManagedGrafanasClient_Update() {
	...
	res, err := clientFactory.NewManagedGrafanasClient().Update(ctx, "myResourceGroup", "myWorkspace", armdashboard.ManagedGrafanaUpdateParameters{
