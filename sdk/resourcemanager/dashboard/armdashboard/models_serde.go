...
func (m MarketplaceTrialQuota) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "trialEndAt", m.TrialEndAt, true)
	populateTime[datetime.RFC3339](objectMap, "trialStartAt", m.TrialStartAt, true)
	return json.Marshal(objectMap)
}
...
func (m *MarketplaceTrialQuota) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "grafanaResourceId":
			...
			delete(rawMsg, key)
		case "trialEndAt":
			err = unpopulateTime[datetime.RFC3339](val, "TrialEndAt", &m.TrialEndAt)
			delete(rawMsg, key)
		case "trialStartAt":
			err = unpopulateTime[datetime.RFC3339](val, "TrialStartAt", &m.TrialStartAt)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %s", m, err.Error())
