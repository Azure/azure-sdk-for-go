...
// ModelName - The customer friendly name of the combination of version and capacity of the device. This field is necessary
// only at the time of ordering the newer generation device i.e. AzureDataBox120 and AzureDataBox525 as of Feb/2025
...
const (
	...
	// ModelNameDataBoxCustomerDisk - Data Box Customer Disk
	ModelNameDataBoxCustomerDisk ModelName = "DataBoxCustomerDisk"
	// ModelNameDataBoxDisk - Data Box Disk.
	ModelNameDataBoxDisk ModelName = "DataBoxDisk"
	// ModelNameDataBoxHeavy - Data Box Heavy.
	ModelNameDataBoxHeavy ModelName = "DataBoxHeavy"
)

// PossibleModelNameValues returns the possible values for the ModelName const type.
func PossibleModelNameValues() []ModelName {
	return []ModelName{
...
const (
	...
	// PortalDelayErrorCodeHighDemandDelay - High demand
	PortalDelayErrorCodeHighDemandDelay PortalDelayErrorCode = "HighDemandDelay"
	...
	// PortalDelayErrorCodeLargeNumberOfFilesDelay - Slow copy due to large number of files
	PortalDelayErrorCodeLargeNumberOfFilesDelay PortalDelayErrorCode = "LargeNumberOfFilesDelay"
)
...
func PossiblePortalDelayErrorCodeValues() []PortalDelayErrorCode {
	return []PortalDelayErrorCode{
		...
		PortalDelayErrorCodeHighDemandDelay,
		PortalDelayErrorCodeInternalIssueDelay,
		PortalDelayErrorCodeLargeNumberOfFilesDelay,
	}
}
...
// StorageAccountAccessTier - Storage account access tier.
type StorageAccountAccessTier string

const (
	// StorageAccountAccessTierArchive - Archive access tier.
	StorageAccountAccessTierArchive StorageAccountAccessTier = "Archive"
)

// PossibleStorageAccountAccessTierValues returns the possible values for the StorageAccountAccessTier const type.
func PossibleStorageAccountAccessTierValues() []StorageAccountAccessTier {
	return []StorageAccountAccessTier{
...
const (
	// ValidationCategoryJobCreationValidation - Identify request of pre-job creation validations.
	ValidationCategoryJobCreationValidation ValidationCategory = "JobCreationValidation"
)

// PossibleValidationCategoryValues returns the possible values for the ValidationCategory const type.
