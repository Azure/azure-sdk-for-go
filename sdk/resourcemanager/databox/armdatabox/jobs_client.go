...
func (client *JobsClient) listCredentialsCreateRequest(ctx context.Context, resourceGroupName string, jobName string, _ *JobsClientListCredentialsOptions) (*policy.Request, error) {
...
func (client *JobsClient) MarkDevicesShipped(ctx context.Context, resourceGroupName string, jobName string, markDevicesShippedRequest MarkDevicesShippedRequest, options *JobsClientMarkDevicesShippedOptions) (JobsClientMarkDevicesShippedResponse, error) {
	var err error
	const operationName = "JobsClient.MarkDevicesShipped"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.markDevicesShippedCreateRequest(ctx, resourceGroupName, jobName, markDevicesShippedRequest, options)
	if err != nil {
...
func (client *JobsClient) markDevicesShippedCreateRequest(ctx context.Context, resourceGroupName string, jobName string, markDevicesShippedRequest MarkDevicesShippedRequest, _ *JobsClientMarkDevicesShippedOptions) (*policy.Request, error) {
