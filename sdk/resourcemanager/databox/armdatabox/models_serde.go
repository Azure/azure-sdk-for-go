...
func (c CommonJobDetails) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "jobDetailsType", c.JobDetailsType)
...
func (c CommonJobSecrets) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "jobSecretsType", c.JobSecretsType)
	return json.Marshal(objectMap)
}
...
func (c CopyLogDetails) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "copyLogDetailsType", c.CopyLogDetailsType)
	return json.Marshal(objectMap)
}
...
func (d DatacenterAddressResponse) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "dataCenterAzureLocation", d.DataCenterAzureLocation)
	populate(objectMap, "datacenterAddressType", d.DatacenterAddressType)
	populate(objectMap, "supportedCarriersForReturnShipment", d.SupportedCarriersForReturnShipment)
	return json.Marshal(objectMap)
}
...
func (d DeviceErasureDetails) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "secureErasureCertificateSasKey", d.SecureErasureCertificateSasKey)
	return json.Marshal(objectMap)
}
...
func (d *DeviceErasureDetails) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "erasureOrDestructionCertificateSasKey":
			...
			delete(rawMsg, key)
		case "secureErasureCertificateSasKey":
			err = unpopulate(val, "SecureErasureCertificateSasKey", &d.SecureErasureCertificateSasKey)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %s", d, err.Error())
...
func (g GranularCopyLogDetails) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "copyLogDetailsType", g.CopyLogDetailsType)
	return json.Marshal(objectMap)
}
...
func (j JobDelayDetails) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "resolutionTime", j.ResolutionTime, true)
...
func (j *JobDelayDetails) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "errorCode":
			...
			delete(rawMsg, key)
		case "resolutionTime":
			err = unpopulateTime[datetime.RFC3339](val, "ResolutionTime", &j.ResolutionTime)
			delete(rawMsg, key)
		case "startTime":
...
func (j JobDeliveryInfo) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateTime[datetime.RFC3339](objectMap, "scheduledDateTime", j.ScheduledDateTime, true)
	return json.Marshal(objectMap)
}
...
func (j *JobDeliveryInfo) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "scheduledDateTime":
			err = unpopulateTime[datetime.RFC3339](val, "ScheduledDateTime", &j.ScheduledDateTime)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %s", j, err.Error())
...
func (j JobStages) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "stageTime", j.StageTime, true)
	return json.Marshal(objectMap)
}
...
func (j *JobStages) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "stageStatus":
			...
			delete(rawMsg, key)
		case "stageTime":
			err = unpopulateTime[datetime.RFC3339](val, "StageTime", &j.StageTime)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %s", j, err.Error())
...
func (l LastMitigationActionOnJob) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateTime[datetime.RFC3339](objectMap, "actionDateTimeInUtc", l.ActionDateTimeInUTC, true)
...
func (l *LastMitigationActionOnJob) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "actionDateTimeInUtc":
			err = unpopulateTime[datetime.RFC3339](val, "ActionDateTimeInUTC", &l.ActionDateTimeInUTC)
			delete(rawMsg, key)
...
func (s ScheduleAvailabilityResponse) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	aux := make([]*datetime.RFC3339, len(s.AvailableDates), len(s.AvailableDates))
	for i := 0; i < len(s.AvailableDates); i++ {
		if s.AvailableDates[i] != nil {
			utcTime := s.AvailableDates[i].UTC()
...
func (s ShipmentPickUpResponse) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "readyByTime", s.ReadyByTime, true)
	return json.Marshal(objectMap)
}
...
func (s *ShipmentPickUpResponse) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "confirmationNumber":
			...
			delete(rawMsg, key)
		case "readyByTime":
			err = unpopulateTime[datetime.RFC3339](val, "ReadyByTime", &s.ReadyByTime)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %s", s, err.Error())
...
func (v ValidationInputRequest) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "validationType", v.ValidationType)
	return json.Marshal(objectMap)
}
