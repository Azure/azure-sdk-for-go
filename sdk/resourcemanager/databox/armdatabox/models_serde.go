...
func (j JobDelayDetails) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "resolutionTime", j.ResolutionTime)
...
func (j JobDeliveryInfo) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateTime[datetime.RFC3339](objectMap, "scheduledDateTime", j.ScheduledDateTime)
	return json.Marshal(objectMap)
}
...
func (j JobStages) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "stageTime", j.StageTime)
	return json.Marshal(objectMap)
}
...
func (l LastMitigationActionOnJob) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateTime[datetime.RFC3339](objectMap, "actionDateTimeInUtc", l.ActionDateTimeInUTC)
...
func (s ScheduleAvailabilityResponse) MarshalJSON() ([]byte, error) {
	...
	for i := 0; i < len(s.AvailableDates); i++ {
		aux[i] = (*datetime.RFC3339)(s.AvailableDates[i])
	}
...
func (s ShipmentPickUpResponse) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "readyByTime", s.ReadyByTime)
	return json.Marshal(objectMap)
}
