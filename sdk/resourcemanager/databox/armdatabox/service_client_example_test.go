...
func ExampleServiceClient_RegionConfiguration() {
	...
	// 				to.Ptr(time.Date(2019, time.July, 11, 0, 0, 0, 0, time.UTC)),
	// 				to.Ptr(time.Date(2019, time.July, 12, 0, 0, 0, 0, time.UTC)),
	// 				to.Ptr(time.Date(2019, time.July, 13, 0, 0, 0, 0, time.UTC)),
	// 				to.Ptr(time.Date(2019, time.July, 14, 0, 0, 0, 0, time.UTC)),
	// 				to.Ptr(time.Date(2019, time.July, 15, 0, 0, 0, 0, time.UTC)),
	// 				to.Ptr(time.Date(2019, time.July, 16, 0, 0, 0, 0, time.UTC)),
	// 				to.Ptr(time.Date(2019, time.July, 17, 0, 0, 0, 0, time.UTC)),
	// 				to.Ptr(time.Date(2019, time.July, 18, 0, 0, 0, 0, time.UTC)),
	// 				to.Ptr(time.Date(2019, time.July, 19, 0, 0, 0, 0, time.UTC)),
	// 				to.Ptr(time.Date(2019, time.July, 20, 0, 0, 0, 0, time.UTC)),
	// 				to.Ptr(time.Date(2019, time.July, 21, 0, 0, 0, 0, time.UTC)),
	// 				to.Ptr(time.Date(2019, time.July, 22, 0, 0, 0, 0, time.UTC)),
	// 				to.Ptr(time.Date(2019, time.July, 23, 0, 0, 0, 0, time.UTC)),
	// 				to.Ptr(time.Date(2019, time.July, 24, 0, 0, 0, 0, time.UTC)),
	// 				to.Ptr(time.Date(2019, time.July, 25, 0, 0, 0, 0, time.UTC)),
	// 				to.Ptr(time.Date(2019, time.July, 26, 0, 0, 0, 0, time.UTC)),
	// 				to.Ptr(time.Date(2019, time.July, 27, 0, 0, 0, 0, time.UTC)),
	// 				to.Ptr(time.Date(2019, time.July, 28, 0, 0, 0, 0, time.UTC)),
	// 				to.Ptr(time.Date(2019, time.July, 29, 0, 0, 0, 0, time.UTC)),
	// 				to.Ptr(time.Date(2019, time.July, 30, 0, 0, 0, 0, time.UTC)),
	// 				to.Ptr(time.Date(2019, time.July, 31, 0, 0, 0, 0, time.UTC)),
	// 			},
	// 		},
	// 	},
	// }
