...
func ExampleAlertsClient_Get() {
	...
	// 			AppearedAtDateTime: to.Ptr(time.Date(2018, time.December, 18, 2, 18, 51, 427026700, time.UTC)),
...
func ExampleAlertsClient_NewListByDataBoxEdgeDevicePager() {
	...
	for pager.More() {
		...
		// 					AppearedAtDateTime: to.Ptr(time.Date(2018, time.December, 18, 2, 29, 15, 232557700, time.UTC)),
		// 					DetailedInformation: map[string]*string{
		// 					},
		// 					ErrorDetails: &armdataboxedge.AlertErrorDetails{
		// 						ErrorCode: to.Ptr(""),
