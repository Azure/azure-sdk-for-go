...
func (client *AvailableSKUsClient) listCreateRequest(ctx context.Context, nextLink string, _ *AvailableSKUsClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *AvailableSKUsClient) listHandleResponse(resp *http.Response, successCodes ...int) (AvailableSKUsClientListResponse, error) {
