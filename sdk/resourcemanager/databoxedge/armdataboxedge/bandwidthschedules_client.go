...
func (client *BandwidthSchedulesClient) getHandleResponse(resp *http.Response, successCodes ...int) (BandwidthSchedulesClientGetResponse, error) {
...
func (client *BandwidthSchedulesClient) listByDataBoxEdgeDeviceCreateRequest(ctx context.Context, deviceName string, resourceGroupName string, nextLink string, _ *BandwidthSchedulesClientListByDataBoxEdgeDeviceOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *BandwidthSchedulesClient) listByDataBoxEdgeDeviceHandleResponse(resp *http.Response, successCodes ...int) (BandwidthSchedulesClientListByDataBoxEdgeDeviceResponse, error) {
