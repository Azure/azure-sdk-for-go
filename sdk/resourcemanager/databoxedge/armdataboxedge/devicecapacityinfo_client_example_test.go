...
// Generated from example definition: 2023-12-01/DeviceCapacityGet.json
func ExampleDeviceCapacityInfoClient_GetDeviceCapacityInfo() {
	...
	// res = armdataboxedge.DeviceCapacityInfoClientGetDeviceCapacityInfoResponse{
	// 	DeviceCapacityInfo: &armdataboxedge.DeviceCapacityInfo{
	// 		Name: to.Ptr("default"),
