...
type AddonsServer struct {
	...
	BeginCreateOrUpdate func(ctx context.Context, resourceGroupName string, deviceName string, roleName string, addonName string, addon armdataboxedge.AddonClassification, options *armdataboxedge.AddonsClientBeginCreateOrUpdateOptions) (resp azfake.PollerResponder[armdataboxedge.AddonsClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)

	// BeginDelete is the fake for method AddonsClient.BeginDelete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginDelete func(ctx context.Context, resourceGroupName string, deviceName string, roleName string, addonName string, options *armdataboxedge.AddonsClientBeginDeleteOptions) (resp azfake.PollerResponder[armdataboxedge.AddonsClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method AddonsClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, deviceName string, roleName string, addonName string, options *armdataboxedge.AddonsClientGetOptions) (resp azfake.Responder[armdataboxedge.AddonsClientGetResponse], errResp azfake.ErrorResponder)

	// NewListByRolePager is the fake for method AddonsClient.NewListByRolePager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByRolePager func(resourceGroupName string, deviceName string, roleName string, options *armdataboxedge.AddonsClientListByRoleOptions) (resp azfake.PagerResponder[armdataboxedge.AddonsClientListByRoleResponse])
}
...
func (a *AddonsServerTransport) dispatchBeginCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginCreateOrUpdate == nil {
		...
		respr, errRespr := a.srv.BeginCreateOrUpdate(req.Context(), resourceGroupNameParam, deviceNameParam, roleNameParam, addonNameParam, body, nil)
...
func (a *AddonsServerTransport) dispatchBeginDelete(req *http.Request) (*http.Response, error) {
	...
	if beginDelete == nil {
		...
		respr, errRespr := a.srv.BeginDelete(req.Context(), resourceGroupNameParam, deviceNameParam, roleNameParam, addonNameParam, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginDelete = &respr
...
func (a *AddonsServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := a.srv.Get(req.Context(), resourceGroupNameParam, deviceNameParam, roleNameParam, addonNameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
...
func (a *AddonsServerTransport) dispatchNewListByRolePager(req *http.Request) (*http.Response, error) {
	...
	if newListByRolePager == nil {
		...
		resp := a.srv.NewListByRolePager(resourceGroupNameParam, deviceNameParam, roleNameParam, nil)
