...
type AddonsServer struct {
	...
	BeginCreateOrUpdate func(ctx context.Context, deviceName string, roleName string, addonName string, resourceGroupName string, resource armdataboxedge.AddonClassification, options *armdataboxedge.AddonsClientBeginCreateOrUpdateOptions) (resp azfake.PollerResponder[armdataboxedge.AddonsClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)
