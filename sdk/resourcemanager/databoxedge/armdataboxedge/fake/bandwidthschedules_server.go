...
type BandwidthSchedulesServer struct {
	...
	BeginCreateOrUpdate func(ctx context.Context, resourceGroupName string, deviceName string, name string, parameters armdataboxedge.BandwidthSchedule, options *armdataboxedge.BandwidthSchedulesClientBeginCreateOrUpdateOptions) (resp azfake.PollerResponder[armdataboxedge.BandwidthSchedulesClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)

	// BeginDelete is the fake for method BandwidthSchedulesClient.BeginDelete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginDelete func(ctx context.Context, resourceGroupName string, deviceName string, name string, options *armdataboxedge.BandwidthSchedulesClientBeginDeleteOptions) (resp azfake.PollerResponder[armdataboxedge.BandwidthSchedulesClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method BandwidthSchedulesClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, deviceName string, name string, options *armdataboxedge.BandwidthSchedulesClientGetOptions) (resp azfake.Responder[armdataboxedge.BandwidthSchedulesClientGetResponse], errResp azfake.ErrorResponder)

	// NewListByDataBoxEdgeDevicePager is the fake for method BandwidthSchedulesClient.NewListByDataBoxEdgeDevicePager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByDataBoxEdgeDevicePager func(resourceGroupName string, deviceName string, options *armdataboxedge.BandwidthSchedulesClientListByDataBoxEdgeDeviceOptions) (resp azfake.PagerResponder[armdataboxedge.BandwidthSchedulesClientListByDataBoxEdgeDeviceResponse])
}
...
func (b *BandwidthSchedulesServerTransport) dispatchBeginCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginCreateOrUpdate == nil {
		...
		respr, errRespr := b.srv.BeginCreateOrUpdate(req.Context(), resourceGroupNameParam, deviceNameParam, nameParam, body, nil)
...
func (b *BandwidthSchedulesServerTransport) dispatchBeginDelete(req *http.Request) (*http.Response, error) {
	...
	if beginDelete == nil {
		...
		respr, errRespr := b.srv.BeginDelete(req.Context(), resourceGroupNameParam, deviceNameParam, nameParam, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginDelete = &respr
...
func (b *BandwidthSchedulesServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := b.srv.Get(req.Context(), resourceGroupNameParam, deviceNameParam, nameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
...
func (b *BandwidthSchedulesServerTransport) dispatchNewListByDataBoxEdgeDevicePager(req *http.Request) (*http.Response, error) {
	...
	if newListByDataBoxEdgeDevicePager == nil {
		...
		resp := b.srv.NewListByDataBoxEdgeDevicePager(resourceGroupNameParam, deviceNameParam, nil)
