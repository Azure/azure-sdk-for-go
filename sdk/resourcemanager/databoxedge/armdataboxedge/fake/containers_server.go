...
type ContainersServer struct {
	...
	BeginCreateOrUpdate func(ctx context.Context, resourceGroupName string, deviceName string, storageAccountName string, containerName string, containerParam armdataboxedge.Container, options *armdataboxedge.ContainersClientBeginCreateOrUpdateOptions) (resp azfake.PollerResponder[armdataboxedge.ContainersClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)

	// BeginDelete is the fake for method ContainersClient.BeginDelete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginDelete func(ctx context.Context, resourceGroupName string, deviceName string, storageAccountName string, containerName string, options *armdataboxedge.ContainersClientBeginDeleteOptions) (resp azfake.PollerResponder[armdataboxedge.ContainersClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method ContainersClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, deviceName string, storageAccountName string, containerName string, options *armdataboxedge.ContainersClientGetOptions) (resp azfake.Responder[armdataboxedge.ContainersClientGetResponse], errResp azfake.ErrorResponder)

	// NewListByStorageAccountPager is the fake for method ContainersClient.NewListByStorageAccountPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByStorageAccountPager func(resourceGroupName string, deviceName string, storageAccountName string, options *armdataboxedge.ContainersClientListByStorageAccountOptions) (resp azfake.PagerResponder[armdataboxedge.ContainersClientListByStorageAccountResponse])

	// BeginRefresh is the fake for method ContainersClient.BeginRefresh
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginRefresh func(ctx context.Context, resourceGroupName string, deviceName string, storageAccountName string, containerName string, options *armdataboxedge.ContainersClientBeginRefreshOptions) (resp azfake.PollerResponder[armdataboxedge.ContainersClientRefreshResponse], errResp azfake.ErrorResponder)
}
...
func (c *ContainersServerTransport) dispatchBeginCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginCreateOrUpdate == nil {
		...
		respr, errRespr := c.srv.BeginCreateOrUpdate(req.Context(), resourceGroupNameParam, deviceNameParam, storageAccountNameParam, containerNameParam, body, nil)
...
func (c *ContainersServerTransport) dispatchBeginDelete(req *http.Request) (*http.Response, error) {
	...
	if beginDelete == nil {
		...
		respr, errRespr := c.srv.BeginDelete(req.Context(), resourceGroupNameParam, deviceNameParam, storageAccountNameParam, containerNameParam, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginDelete = &respr
...
func (c *ContainersServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := c.srv.Get(req.Context(), resourceGroupNameParam, deviceNameParam, storageAccountNameParam, containerNameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
...
func (c *ContainersServerTransport) dispatchNewListByStorageAccountPager(req *http.Request) (*http.Response, error) {
	...
	if newListByStorageAccountPager == nil {
		...
		resp := c.srv.NewListByStorageAccountPager(resourceGroupNameParam, deviceNameParam, storageAccountNameParam, nil)
...
func (c *ContainersServerTransport) dispatchBeginRefresh(req *http.Request) (*http.Response, error) {
	...
	if beginRefresh == nil {
		...
		respr, errRespr := c.srv.BeginRefresh(req.Context(), resourceGroupNameParam, deviceNameParam, storageAccountNameParam, containerNameParam, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginRefresh = &respr
