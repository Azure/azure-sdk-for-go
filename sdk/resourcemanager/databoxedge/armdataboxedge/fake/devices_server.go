...
type DevicesServer struct {
	...
	CreateOrUpdate func(ctx context.Context, resourceGroupName string, deviceName string, dataBoxEdgeDevice armdataboxedge.Device, options *armdataboxedge.DevicesClientCreateOrUpdateOptions) (resp azfake.Responder[armdataboxedge.DevicesClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)
	...
	BeginCreateOrUpdateSecuritySettings func(ctx context.Context, resourceGroupName string, deviceName string, securitySettings armdataboxedge.SecuritySettings, options *armdataboxedge.DevicesClientBeginCreateOrUpdateSecuritySettingsOptions) (resp azfake.PollerResponder[armdataboxedge.DevicesClientCreateOrUpdateSecuritySettingsResponse], errResp azfake.ErrorResponder)

	// BeginDelete is the fake for method DevicesClient.BeginDelete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginDelete func(ctx context.Context, resourceGroupName string, deviceName string, options *armdataboxedge.DevicesClientBeginDeleteOptions) (resp azfake.PollerResponder[armdataboxedge.DevicesClientDeleteResponse], errResp azfake.ErrorResponder)

	// BeginDownloadUpdates is the fake for method DevicesClient.BeginDownloadUpdates
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginDownloadUpdates func(ctx context.Context, resourceGroupName string, deviceName string, options *armdataboxedge.DevicesClientBeginDownloadUpdatesOptions) (resp azfake.PollerResponder[armdataboxedge.DevicesClientDownloadUpdatesResponse], errResp azfake.ErrorResponder)

	// GenerateCertificate is the fake for method DevicesClient.GenerateCertificate
	// HTTP status codes to indicate success: http.StatusOK
	GenerateCertificate func(ctx context.Context, resourceGroupName string, deviceName string, options *armdataboxedge.DevicesClientGenerateCertificateOptions) (resp azfake.Responder[armdataboxedge.DevicesClientGenerateCertificateResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method DevicesClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, deviceName string, options *armdataboxedge.DevicesClientGetOptions) (resp azfake.Responder[armdataboxedge.DevicesClientGetResponse], errResp azfake.ErrorResponder)

	// GetExtendedInformation is the fake for method DevicesClient.GetExtendedInformation
	// HTTP status codes to indicate success: http.StatusOK
	GetExtendedInformation func(ctx context.Context, resourceGroupName string, deviceName string, options *armdataboxedge.DevicesClientGetExtendedInformationOptions) (resp azfake.Responder[armdataboxedge.DevicesClientGetExtendedInformationResponse], errResp azfake.ErrorResponder)

	// GetNetworkSettings is the fake for method DevicesClient.GetNetworkSettings
	// HTTP status codes to indicate success: http.StatusOK
	GetNetworkSettings func(ctx context.Context, resourceGroupName string, deviceName string, options *armdataboxedge.DevicesClientGetNetworkSettingsOptions) (resp azfake.Responder[armdataboxedge.DevicesClientGetNetworkSettingsResponse], errResp azfake.ErrorResponder)

	// GetUpdateSummary is the fake for method DevicesClient.GetUpdateSummary
	// HTTP status codes to indicate success: http.StatusOK
	GetUpdateSummary func(ctx context.Context, resourceGroupName string, deviceName string, options *armdataboxedge.DevicesClientGetUpdateSummaryOptions) (resp azfake.Responder[armdataboxedge.DevicesClientGetUpdateSummaryResponse], errResp azfake.ErrorResponder)

	// BeginInstallUpdates is the fake for method DevicesClient.BeginInstallUpdates
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginInstallUpdates func(ctx context.Context, resourceGroupName string, deviceName string, options *armdataboxedge.DevicesClientBeginInstallUpdatesOptions) (resp azfake.PollerResponder[armdataboxedge.DevicesClientInstallUpdatesResponse], errResp azfake.ErrorResponder)
	...
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginScanForUpdates func(ctx context.Context, resourceGroupName string, deviceName string, options *armdataboxedge.DevicesClientBeginScanForUpdatesOptions) (resp azfake.PollerResponder[armdataboxedge.DevicesClientScanForUpdatesResponse], errResp azfake.ErrorResponder)

	// Update is the fake for method DevicesClient.Update
	// HTTP status codes to indicate success: http.StatusOK
	Update func(ctx context.Context, resourceGroupName string, deviceName string, parameters armdataboxedge.DevicePatch, options *armdataboxedge.DevicesClientUpdateOptions) (resp azfake.Responder[armdataboxedge.DevicesClientUpdateResponse], errResp azfake.ErrorResponder)

	// UpdateExtendedInformation is the fake for method DevicesClient.UpdateExtendedInformation
	// HTTP status codes to indicate success: http.StatusOK
	UpdateExtendedInformation func(ctx context.Context, resourceGroupName string, deviceName string, parameters armdataboxedge.DeviceExtendedInfoPatch, options *armdataboxedge.DevicesClientUpdateExtendedInformationOptions) (resp azfake.Responder[armdataboxedge.DevicesClientUpdateExtendedInformationResponse], errResp azfake.ErrorResponder)

	// UploadCertificate is the fake for method DevicesClient.UploadCertificate
	// HTTP status codes to indicate success: http.StatusOK
	UploadCertificate func(ctx context.Context, resourceGroupName string, deviceName string, parameters armdataboxedge.UploadCertificateRequest, options *armdataboxedge.DevicesClientUploadCertificateOptions) (resp azfake.Responder[armdataboxedge.DevicesClientUploadCertificateResponse], errResp azfake.ErrorResponder)
}
...
func (d *DevicesServerTransport) dispatchCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := d.srv.CreateOrUpdate(req.Context(), resourceGroupNameParam, deviceNameParam, body, nil)
...
func (d *DevicesServerTransport) dispatchBeginCreateOrUpdateSecuritySettings(req *http.Request) (*http.Response, error) {
	...
	if beginCreateOrUpdateSecuritySettings == nil {
		...
		respr, errRespr := d.srv.BeginCreateOrUpdateSecuritySettings(req.Context(), resourceGroupNameParam, deviceNameParam, body, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
...
func (d *DevicesServerTransport) dispatchBeginDelete(req *http.Request) (*http.Response, error) {
	...
	if beginDelete == nil {
		...
		respr, errRespr := d.srv.BeginDelete(req.Context(), resourceGroupNameParam, deviceNameParam, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginDelete = &respr
...
func (d *DevicesServerTransport) dispatchBeginDownloadUpdates(req *http.Request) (*http.Response, error) {
	...
	if beginDownloadUpdates == nil {
		...
		respr, errRespr := d.srv.BeginDownloadUpdates(req.Context(), resourceGroupNameParam, deviceNameParam, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
...
func (d *DevicesServerTransport) dispatchGenerateCertificate(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := d.srv.GenerateCertificate(req.Context(), resourceGroupNameParam, deviceNameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (d *DevicesServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := d.srv.Get(req.Context(), resourceGroupNameParam, deviceNameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (d *DevicesServerTransport) dispatchGetExtendedInformation(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := d.srv.GetExtendedInformation(req.Context(), resourceGroupNameParam, deviceNameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (d *DevicesServerTransport) dispatchGetNetworkSettings(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := d.srv.GetNetworkSettings(req.Context(), resourceGroupNameParam, deviceNameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (d *DevicesServerTransport) dispatchGetUpdateSummary(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := d.srv.GetUpdateSummary(req.Context(), resourceGroupNameParam, deviceNameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (d *DevicesServerTransport) dispatchBeginInstallUpdates(req *http.Request) (*http.Response, error) {
	...
	if beginInstallUpdates == nil {
		...
		respr, errRespr := d.srv.BeginInstallUpdates(req.Context(), resourceGroupNameParam, deviceNameParam, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
...
func (d *DevicesServerTransport) dispatchBeginScanForUpdates(req *http.Request) (*http.Response, error) {
	...
	if beginScanForUpdates == nil {
		...
		respr, errRespr := d.srv.BeginScanForUpdates(req.Context(), resourceGroupNameParam, deviceNameParam, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
...
func (d *DevicesServerTransport) dispatchUpdate(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := d.srv.Update(req.Context(), resourceGroupNameParam, deviceNameParam, body, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (d *DevicesServerTransport) dispatchUpdateExtendedInformation(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := d.srv.UpdateExtendedInformation(req.Context(), resourceGroupNameParam, deviceNameParam, body, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (d *DevicesServerTransport) dispatchUploadCertificate(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := d.srv.UploadCertificate(req.Context(), resourceGroupNameParam, deviceNameParam, body, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
