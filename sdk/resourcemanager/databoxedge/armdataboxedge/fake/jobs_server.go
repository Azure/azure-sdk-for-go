...
type JobsServer struct {
	...
	Get func(ctx context.Context, resourceGroupName string, deviceName string, name string, options *armdataboxedge.JobsClientGetOptions) (resp azfake.Responder[armdataboxedge.JobsClientGetResponse], errResp azfake.ErrorResponder)
}

// NewJobsServerTransport creates a new instance of JobsServerTransport with the provided implementation.
// The returned JobsServerTransport instance is connected to an instance of armdataboxedge.JobsClient via the
// azcore.ClientOptions.Transporter field in the client's constructor parameters.
func NewJobsServerTransport(srv *JobsServer) *JobsServerTransport {
	return &JobsServerTransport{srv: srv}
}

// JobsServerTransport connects instances of armdataboxedge.JobsClient to instances of JobsServer.
...
func (j *JobsServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.DataBoxEdge/dataBoxEdgeDevices/(?P<deviceName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/jobs/(?P<name>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)`
	...
	respr, errRespr := j.srv.Get(req.Context(), resourceGroupNameParam, deviceNameParam, nameParam, nil)
