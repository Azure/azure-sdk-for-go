...
type OperationsStatusServer struct {
	...
	Get func(ctx context.Context, resourceGroupName string, deviceName string, name string, options *armdataboxedge.OperationsStatusClientGetOptions) (resp azfake.Responder[armdataboxedge.OperationsStatusClientGetResponse], errResp azfake.ErrorResponder)
}
...
func (o *OperationsStatusServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := o.srv.Get(req.Context(), resourceGroupNameParam, deviceNameParam, nameParam, nil)
