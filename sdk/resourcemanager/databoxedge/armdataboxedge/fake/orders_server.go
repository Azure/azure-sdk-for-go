...
type OrdersServer struct {
	...
	BeginCreateOrUpdate func(ctx context.Context, deviceName string, resourceGroupName string, resource armdataboxedge.Order, options *armdataboxedge.OrdersClientBeginCreateOrUpdateOptions) (resp azfake.PollerResponder[armdataboxedge.OrdersClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)
