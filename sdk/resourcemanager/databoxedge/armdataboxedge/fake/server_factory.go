...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "DeviceCapacityCheckClient":
		initServer(&s.trMu, &s.trDeviceCapacityCheckServer, func() *DeviceCapacityCheckServerTransport {
	...
	case "DeviceCapacityInfoClient":
		initServer(&s.trMu, &s.trDeviceCapacityInfoServer, func() *DeviceCapacityInfoServerTransport {
