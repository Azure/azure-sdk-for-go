...
type SharesServer struct {
	...
	BeginCreateOrUpdate func(ctx context.Context, deviceName string, name string, resourceGroupName string, resource armdataboxedge.Share, options *armdataboxedge.SharesClientBeginCreateOrUpdateOptions) (resp azfake.PollerResponder[armdataboxedge.SharesClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)
