...
type UsersServer struct {
	...
	BeginCreateOrUpdate func(ctx context.Context, resourceGroupName string, deviceName string, name string, userParam armdataboxedge.User, options *armdataboxedge.UsersClientBeginCreateOrUpdateOptions) (resp azfake.PollerResponder[armdataboxedge.UsersClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)

	// BeginDelete is the fake for method UsersClient.BeginDelete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginDelete func(ctx context.Context, resourceGroupName string, deviceName string, name string, options *armdataboxedge.UsersClientBeginDeleteOptions) (resp azfake.PollerResponder[armdataboxedge.UsersClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method UsersClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, deviceName string, name string, options *armdataboxedge.UsersClientGetOptions) (resp azfake.Responder[armdataboxedge.UsersClientGetResponse], errResp azfake.ErrorResponder)

	// NewListByDataBoxEdgeDevicePager is the fake for method UsersClient.NewListByDataBoxEdgeDevicePager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByDataBoxEdgeDevicePager func(resourceGroupName string, deviceName string, options *armdataboxedge.UsersClientListByDataBoxEdgeDeviceOptions) (resp azfake.PagerResponder[armdataboxedge.UsersClientListByDataBoxEdgeDeviceResponse])
}
...
func (u *UsersServerTransport) dispatchBeginCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginCreateOrUpdate == nil {
		...
		respr, errRespr := u.srv.BeginCreateOrUpdate(req.Context(), resourceGroupNameParam, deviceNameParam, nameParam, body, nil)
...
func (u *UsersServerTransport) dispatchBeginDelete(req *http.Request) (*http.Response, error) {
	...
	if beginDelete == nil {
		...
		respr, errRespr := u.srv.BeginDelete(req.Context(), resourceGroupNameParam, deviceNameParam, nameParam, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginDelete = &respr
...
func (u *UsersServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := u.srv.Get(req.Context(), resourceGroupNameParam, deviceNameParam, nameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
...
func (u *UsersServerTransport) dispatchNewListByDataBoxEdgeDevicePager(req *http.Request) (*http.Response, error) {
	...
	if newListByDataBoxEdgeDevicePager == nil {
		...
		resp := u.srv.NewListByDataBoxEdgeDevicePager(resourceGroupNameParam, deviceNameParam, options)
