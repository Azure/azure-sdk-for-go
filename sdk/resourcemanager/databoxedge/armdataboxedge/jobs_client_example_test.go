...
// Generated from example definition: 2023-12-01/JobsGet.json
func ExampleJobsClient_Get() {
	...
	res, err := clientFactory.NewJobsClient().Get(ctx, "GroupForEdgeAutomation", "testedgedevice", "159a00c7-8543-4343-9435-263ac87df3bb", nil)
	if err != nil {
	...
	// res = armdataboxedge.JobsClientGetResponse{
