...
//     method.
func (client *OrdersClient) BeginCreateOrUpdate(ctx context.Context, deviceName string, resourceGroupName string, resource Order, options *OrdersClientBeginCreateOrUpdateOptions) (*runtime.Poller[OrdersClientCreateOrUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.createOrUpdate(ctx, deviceName, resourceGroupName, resource, options)
		if err != nil {
			return nil, err
		}
...
//
// Generated from API version 2023-12-01
func (client *OrdersClient) createOrUpdate(ctx context.Context, deviceName string, resourceGroupName string, resource Order, options *OrdersClientBeginCreateOrUpdateOptions) (*http.Response, error) {
	var err error
	const operationName = "OrdersClient.BeginCreateOrUpdate"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.createOrUpdateCreateRequest(ctx, deviceName, resourceGroupName, resource, options)
	if err != nil {
		return nil, err
	}
...
func (client *OrdersClient) createOrUpdateCreateRequest(ctx context.Context, deviceName string, resourceGroupName string, resource Order, _ *OrdersClientBeginCreateOrUpdateOptions) (*policy.Request, error) {
