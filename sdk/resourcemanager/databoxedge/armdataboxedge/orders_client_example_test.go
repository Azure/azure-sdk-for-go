...
// Generated from example definition: 2023-12-01/OrderPut.json
func ExampleOrdersClient_BeginCreateOrUpdate() {
	...
	poller, err := clientFactory.NewOrdersClient().BeginCreateOrUpdate(ctx, "GroupForEdgeAutomation", "testedgedevice", armdataboxedge.Order{
	...
	// res = armdataboxedge.OrdersClientCreateOrUpdateResponse{
	// 	Order: &armdataboxedge.Order{
	// 		Name: to.Ptr("default"),
...
// Generated from example definition: 2023-12-01/OrderDelete.json
func ExampleOrdersClient_BeginDelete() {
	...
	poller, err := clientFactory.NewOrdersClient().BeginDelete(ctx, "GroupForEdgeAutomation", "testedgedevice", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	res, err := poller.PollUntilDone(ctx, nil)
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armdataboxedge.OrdersClientDeleteResponse{
	// }
}

// Generated from example definition: 2023-12-01/OrderGet.json
func ExampleOrdersClient_Get() {
	...
	res, err := clientFactory.NewOrdersClient().Get(ctx, "GroupForEdgeAutomation", "testedgedevice", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armdataboxedge.OrdersClientGetResponse{
	// 	Order: &armdataboxedge.Order{
	// 		Name: to.Ptr("default"),
	// 		Type: to.Ptr("dataBoxEdgeDevices/orders"),
	// 		ID: to.Ptr("/subscriptions/4385cf00-2d3a-425a-832f-f4285b1c9dce/resourceGroups/GroupForEdgeAutomation/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/testedgedevice/orders/default"),
...
func ExampleOrdersClient_NewListByDataBoxEdgeDevicePager() {
	...
	pager := clientFactory.NewOrdersClient().NewListByDataBoxEdgeDevicePager("GroupForEdgeAutomation", "testedgedevice", nil)
	for pager.More() {
...
// Generated from example definition: 2023-12-01/GetDCAccessCode.json
func ExampleOrdersClient_ListDCAccessCode() {
	...
	res, err := clientFactory.NewOrdersClient().ListDCAccessCode(ctx, "GroupForEdgeAutomation", "testedgedevice", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armdataboxedge.OrdersClientListDCAccessCodeResponse{
	// 	DCAccessCode: &armdataboxedge.DCAccessCode{
