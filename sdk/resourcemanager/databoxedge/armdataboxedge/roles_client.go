...
//     method.
func (client *RolesClient) BeginCreateOrUpdate(ctx context.Context, deviceName string, name string, resourceGroupName string, resource RoleClassification, options *RolesClientBeginCreateOrUpdateOptions) (*runtime.Poller[RolesClientCreateOrUpdateResponse], error) {
...
//
// Generated from API version 2023-12-01
func (client *RolesClient) createOrUpdate(ctx context.Context, deviceName string, name string, resourceGroupName string, resource RoleClassification, options *RolesClientBeginCreateOrUpdateOptions) (*http.Response, error) {
	var err error
...
func (client *RolesClient) createOrUpdateCreateRequest(ctx context.Context, deviceName string, name string, resourceGroupName string, resource RoleClassification, _ *RolesClientBeginCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *RolesClient) listByDataBoxEdgeDeviceCreateRequest(ctx context.Context, deviceName string, resourceGroupName string, _ *RolesClientListByDataBoxEdgeDeviceOptions) (*policy.Request, error) {
