...
//     method.
func (client *RolesClient) BeginCreateOrUpdate(ctx context.Context, resourceGroupName string, deviceName string, name string, role RoleClassification, options *RolesClientBeginCreateOrUpdateOptions) (*runtime.Poller[RolesClientCreateOrUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.createOrUpdate(ctx, resourceGroupName, deviceName, name, role, options)
		if err != nil {
			return nil, err
		}
...
//
// Generated from API version 2023-12-01
func (client *RolesClient) createOrUpdate(ctx context.Context, resourceGroupName string, deviceName string, name string, role RoleClassification, options *RolesClientBeginCreateOrUpdateOptions) (*http.Response, error) {
	var err error
	const operationName = "RolesClient.BeginCreateOrUpdate"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.createOrUpdateCreateRequest(ctx, resourceGroupName, deviceName, name, role, options)
	if err != nil {
		return nil, err
	}
...
func (client *RolesClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, deviceName string, name string, role RoleClassification, _ *RolesClientBeginCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *RolesClient) BeginDelete(ctx context.Context, resourceGroupName string, deviceName string, name string, options *RolesClientBeginDeleteOptions) (*runtime.Poller[RolesClientDeleteResponse], error) {
	if options == nil || options.ResumeToken == "" {
...
//
// Generated from API version 2023-12-01
func (client *RolesClient) deleteOperation(ctx context.Context, resourceGroupName string, deviceName string, name string, options *RolesClientBeginDeleteOptions) (*http.Response, error) {
	var err error
...
func (client *RolesClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, deviceName string, name string, _ *RolesClientBeginDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{deviceName}/roles/{name}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *RolesClient) Get(ctx context.Context, resourceGroupName string, deviceName string, name string, options *RolesClientGetOptions) (RolesClientGetResponse, error) {
	var err error
...
func (client *RolesClient) getCreateRequest(ctx context.Context, resourceGroupName string, deviceName string, name string, _ *RolesClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{deviceName}/roles/{name}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
//     method.
func (client *RolesClient) NewListByDataBoxEdgeDevicePager(resourceGroupName string, deviceName string, options *RolesClientListByDataBoxEdgeDeviceOptions) *runtime.Pager[RolesClientListByDataBoxEdgeDeviceResponse] {
...
func (client *RolesClient) listByDataBoxEdgeDeviceCreateRequest(ctx context.Context, resourceGroupName string, deviceName string, _ *RolesClientListByDataBoxEdgeDeviceOptions) (*policy.Request, error) {
