...
//     method.
func (client *SharesClient) BeginCreateOrUpdate(ctx context.Context, deviceName string, name string, resourceGroupName string, resource Share, options *SharesClientBeginCreateOrUpdateOptions) (*runtime.Poller[SharesClientCreateOrUpdateResponse], error) {
...
//
// Generated from API version 2023-12-01
func (client *SharesClient) createOrUpdate(ctx context.Context, deviceName string, name string, resourceGroupName string, resource Share, options *SharesClientBeginCreateOrUpdateOptions) (*http.Response, error) {
	var err error
...
func (client *SharesClient) createOrUpdateCreateRequest(ctx context.Context, deviceName string, name string, resourceGroupName string, resource Share, _ *SharesClientBeginCreateOrUpdateOptions) (*policy.Request, error) {
