...
//
// Generated from API version 2023-12-01
func (client *StorageAccountCredentialsClient) createOrUpdate(ctx context.Context, deviceName string, name string, resourceGroupName string, resource StorageAccountCredential, options *StorageAccountCredentialsClientBeginCreateOrUpdateOptions) (*http.Response, error) {
	var err error
...
func (client *StorageAccountCredentialsClient) createOrUpdateCreateRequest(ctx context.Context, deviceName string, name string, resourceGroupName string, resource StorageAccountCredential, _ *StorageAccountCredentialsClientBeginCreateOrUpdateOptions) (*policy.Request, error) {
