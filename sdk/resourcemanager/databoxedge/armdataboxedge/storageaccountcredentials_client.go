...
//     method.
func (client *StorageAccountCredentialsClient) BeginCreateOrUpdate(ctx context.Context, resourceGroupName string, deviceName string, name string, storageAccountCredential StorageAccountCredential, options *StorageAccountCredentialsClientBeginCreateOrUpdateOptions) (*runtime.Poller[StorageAccountCredentialsClientCreateOrUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.createOrUpdate(ctx, resourceGroupName, deviceName, name, storageAccountCredential, options)
		if err != nil {
			return nil, err
		}
...
//
// Generated from API version 2023-12-01
func (client *StorageAccountCredentialsClient) createOrUpdate(ctx context.Context, resourceGroupName string, deviceName string, name string, storageAccountCredential StorageAccountCredential, options *StorageAccountCredentialsClientBeginCreateOrUpdateOptions) (*http.Response, error) {
	var err error
	const operationName = "StorageAccountCredentialsClient.BeginCreateOrUpdate"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.createOrUpdateCreateRequest(ctx, resourceGroupName, deviceName, name, storageAccountCredential, options)
	if err != nil {
		return nil, err
	}
...
func (client *StorageAccountCredentialsClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, deviceName string, name string, storageAccountCredential StorageAccountCredential, _ *StorageAccountCredentialsClientBeginCreateOrUpdateOptions) (*policy.Request, error) {
...
//     method.
func (client *StorageAccountCredentialsClient) BeginDelete(ctx context.Context, resourceGroupName string, deviceName string, name string, options *StorageAccountCredentialsClientBeginDeleteOptions) (*runtime.Poller[StorageAccountCredentialsClientDeleteResponse], error) {
	if options == nil || options.ResumeToken == "" {
...
//
// Generated from API version 2023-12-01
func (client *StorageAccountCredentialsClient) deleteOperation(ctx context.Context, resourceGroupName string, deviceName string, name string, options *StorageAccountCredentialsClientBeginDeleteOptions) (*http.Response, error) {
	var err error
...
func (client *StorageAccountCredentialsClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, deviceName string, name string, _ *StorageAccountCredentialsClientBeginDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{deviceName}/storageAccountCredentials/{name}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
//     method.
func (client *StorageAccountCredentialsClient) Get(ctx context.Context, resourceGroupName string, deviceName string, name string, options *StorageAccountCredentialsClientGetOptions) (StorageAccountCredentialsClientGetResponse, error) {
	var err error
...
func (client *StorageAccountCredentialsClient) getCreateRequest(ctx context.Context, resourceGroupName string, deviceName string, name string, _ *StorageAccountCredentialsClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{deviceName}/storageAccountCredentials/{name}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
//     method.
func (client *StorageAccountCredentialsClient) NewListByDataBoxEdgeDevicePager(resourceGroupName string, deviceName string, options *StorageAccountCredentialsClientListByDataBoxEdgeDeviceOptions) *runtime.Pager[StorageAccountCredentialsClientListByDataBoxEdgeDeviceResponse] {
...
func (client *StorageAccountCredentialsClient) listByDataBoxEdgeDeviceCreateRequest(ctx context.Context, resourceGroupName string, deviceName string, _ *StorageAccountCredentialsClientListByDataBoxEdgeDeviceOptions) (*policy.Request, error) {
