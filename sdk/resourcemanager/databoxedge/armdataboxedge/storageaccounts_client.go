...
//     method.
func (client *StorageAccountsClient) BeginCreateOrUpdate(ctx context.Context, resourceGroupName string, deviceName string, storageAccountName string, storageAccount StorageAccount, options *StorageAccountsClientBeginCreateOrUpdateOptions) (*runtime.Poller[StorageAccountsClientCreateOrUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.createOrUpdate(ctx, resourceGroupName, deviceName, storageAccountName, storageAccount, options)
		if err != nil {
			return nil, err
		}
...
//
// Generated from API version 2023-12-01
func (client *StorageAccountsClient) createOrUpdate(ctx context.Context, resourceGroupName string, deviceName string, storageAccountName string, storageAccount StorageAccount, options *StorageAccountsClientBeginCreateOrUpdateOptions) (*http.Response, error) {
	var err error
	const operationName = "StorageAccountsClient.BeginCreateOrUpdate"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.createOrUpdateCreateRequest(ctx, resourceGroupName, deviceName, storageAccountName, storageAccount, options)
	if err != nil {
		return nil, err
	}
...
func (client *StorageAccountsClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, deviceName string, storageAccountName string, storageAccount StorageAccount, _ *StorageAccountsClientBeginCreateOrUpdateOptions) (*policy.Request, error) {
...
//     method.
func (client *StorageAccountsClient) BeginDelete(ctx context.Context, resourceGroupName string, deviceName string, storageAccountName string, options *StorageAccountsClientBeginDeleteOptions) (*runtime.Poller[StorageAccountsClientDeleteResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.deleteOperation(ctx, resourceGroupName, deviceName, storageAccountName, options)
		if err != nil {
			return nil, err
		}
...
//
// Generated from API version 2023-12-01
func (client *StorageAccountsClient) deleteOperation(ctx context.Context, resourceGroupName string, deviceName string, storageAccountName string, options *StorageAccountsClientBeginDeleteOptions) (*http.Response, error) {
	var err error
	const operationName = "StorageAccountsClient.BeginDelete"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.deleteCreateRequest(ctx, resourceGroupName, deviceName, storageAccountName, options)
	if err != nil {
		return nil, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
...
func (client *StorageAccountsClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, deviceName string, storageAccountName string, _ *StorageAccountsClientBeginDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{deviceName}/storageAccounts/{storageAccountName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *StorageAccountsClient) Get(ctx context.Context, resourceGroupName string, deviceName string, storageAccountName string, options *StorageAccountsClientGetOptions) (StorageAccountsClientGetResponse, error) {
	var err error
	const operationName = "StorageAccountsClient.Get"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.getCreateRequest(ctx, resourceGroupName, deviceName, storageAccountName, options)
	if err != nil {
...
func (client *StorageAccountsClient) getCreateRequest(ctx context.Context, resourceGroupName string, deviceName string, storageAccountName string, _ *StorageAccountsClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{deviceName}/storageAccounts/{storageAccountName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
//     method.
func (client *StorageAccountsClient) NewListByDataBoxEdgeDevicePager(resourceGroupName string, deviceName string, options *StorageAccountsClientListByDataBoxEdgeDeviceOptions) *runtime.Pager[StorageAccountsClientListByDataBoxEdgeDeviceResponse] {
...
func (client *StorageAccountsClient) listByDataBoxEdgeDeviceCreateRequest(ctx context.Context, resourceGroupName string, deviceName string, _ *StorageAccountsClientListByDataBoxEdgeDeviceOptions) (*policy.Request, error) {
