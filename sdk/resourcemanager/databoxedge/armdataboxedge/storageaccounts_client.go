...
func (client *StorageAccountsClient) getHandleResponse(resp *http.Response, successCodes ...int) (StorageAccountsClientGetResponse, error) {
...
func (client *StorageAccountsClient) listByDataBoxEdgeDeviceCreateRequest(ctx context.Context, deviceName string, resourceGroupName string, nextLink string, _ *StorageAccountsClientListByDataBoxEdgeDeviceOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *StorageAccountsClient) listByDataBoxEdgeDeviceHandleResponse(resp *http.Response, successCodes ...int) (StorageAccountsClientListByDataBoxEdgeDeviceResponse, error) {
