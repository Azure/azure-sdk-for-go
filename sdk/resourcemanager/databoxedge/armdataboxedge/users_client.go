...
func (client *UsersClient) listByDataBoxEdgeDeviceCreateRequest(ctx context.Context, deviceName string, resourceGroupName string, nextLink string, options *UsersClientListByDataBoxEdgeDeviceOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *UsersClient) listByDataBoxEdgeDeviceHandleResponse(resp *http.Response, successCodes ...int) (UsersClientListByDataBoxEdgeDeviceResponse, error) {
