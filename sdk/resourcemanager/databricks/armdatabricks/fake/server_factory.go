...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "AccessConnectorsClient":
		initServer(&s.trMu, &s.trAccessConnectorsServer, func() *AccessConnectorsServerTransport {
	...
	case "VNetPeeringClient":
		initServer(&s.trMu, &s.trVNetPeeringServer, func() *VNetPeeringServerTransport { return NewVNetPeeringServerTransport(&s.srv.VNetPeeringServer) })
