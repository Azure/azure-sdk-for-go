...
type AccessConnectorListResult struct {
	...
	Value []*AccessConnector `json:"value,omitempty"`
}
...
// AccessConnectorsClientListByResourceGroupOptions contains the optional parameters for the AccessConnectorsClient.ListByResourceGroup
// method.
type AccessConnectorsClientListByResourceGroupOptions struct {
	// placeholder for future optional parameters
}

// AccessConnectorsClientListBySubscriptionOptions contains the optional parameters for the AccessConnectorsClient.ListBySubscription
// method.
