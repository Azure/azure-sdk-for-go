...
// Get - Get the specified private link resource
//
...
// NewListPager - List private link resources
//
...
func (client *PrivateLinkResourcesClient) listCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, nextLink string, _ *PrivateLinkResourcesClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
