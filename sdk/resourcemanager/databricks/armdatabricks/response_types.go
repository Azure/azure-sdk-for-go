...
// AccessConnectorsClientCreateOrUpdateResponse contains the response from method AccessConnectorsClient.CreateOrUpdate.
type AccessConnectorsClientCreateOrUpdateResponse struct {
	AccessConnector
}

// AccessConnectorsClientDeleteResponse contains the response from method AccessConnectorsClient.Delete.
...
// AccessConnectorsClientListByResourceGroupResponse contains the response from method AccessConnectorsClient.ListByResourceGroup.
type AccessConnectorsClientListByResourceGroupResponse struct {
	AccessConnectorListResult
}

// AccessConnectorsClientListBySubscriptionResponse contains the response from method AccessConnectorsClient.ListBySubscription.
type AccessConnectorsClientListBySubscriptionResponse struct {
	AccessConnectorListResult
}

// AccessConnectorsClientUpdateResponse contains the response from method AccessConnectorsClient.Update.
