...
func NewADCCatalogsClient(subscriptionID string, credential azcore.TokenCredential, options *arm.ClientOptions) (*ADCCatalogsClient, error) {
	cl, err := arm.NewClient(moduleName+".ADCCatalogsClient", moduleVersion, credential, options)
	if err != nil {
		return nil, err
	}
...
func (client *ADCCatalogsClient) BeginDelete(ctx context.Context, resourceGroupName string, catalogName string, options *ADCCatalogsClientBeginDeleteOptions) (*runtime.Poller[ADCCatalogsClientDeleteResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		poller, err := runtime.NewPoller[ADCCatalogsClientDeleteResponse](resp, client.internal.Pipeline(), nil)
		return poller, err
	} else {
		return runtime.NewPollerFromResumeToken[ADCCatalogsClientDeleteResponse](options.ResumeToken, client.internal.Pipeline(), nil)
	}
}
