...
type MonitoredSubscriptionsServer struct {
	...
	BeginCreateorUpdate func(ctx context.Context, resourceGroupName string, monitorName string, configurationName string, body armdatadog.MonitoredSubscriptionProperties, options *armdatadog.MonitoredSubscriptionsClientBeginCreateorUpdateOptions) (resp azfake.PollerResponder[armdatadog.MonitoredSubscriptionsClientCreateorUpdateResponse], errResp azfake.ErrorResponder)
	...
	BeginUpdate func(ctx context.Context, resourceGroupName string, monitorName string, configurationName string, body armdatadog.MonitoredSubscriptionProperties, options *armdatadog.MonitoredSubscriptionsClientBeginUpdateOptions) (resp azfake.PollerResponder[armdatadog.MonitoredSubscriptionsClientUpdateResponse], errResp azfake.ErrorResponder)
}
...
func (m *MonitoredSubscriptionsServerTransport) dispatchBeginCreateorUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginCreateorUpdate == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.Datadog/monitors/(?P<monitorName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/monitoredSubscriptions/(?P<configurationName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)`
...
func (m *MonitoredSubscriptionsServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.Datadog/monitors/(?P<monitorName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/monitoredSubscriptions`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 4 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
