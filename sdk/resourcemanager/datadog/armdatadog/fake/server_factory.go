...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "CreationSupportedClient":
		initServer(&s.trMu, &s.trCreationSupportedServer, func() *CreationSupportedServerTransport {
	...
	case "MonitorResourcesClient":
		initServer(&s.trMu, &s.trMonitorResourcesServer, func() *MonitorResourcesServerTransport {
	...
	case "SingleSignOnConfigurationsClient":
		initServer(&s.trMu, &s.trSingleSignOnConfigurationsServer, func() *SingleSignOnConfigurationsServerTransport {
