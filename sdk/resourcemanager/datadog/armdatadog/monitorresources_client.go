...
// MonitorResourcesClient contains the methods for the DatadogMonitorResources group.
...
// LatestLinkedSaaS - Returns the latest SaaS linked to the Datadog organization of the underlying monitor.
