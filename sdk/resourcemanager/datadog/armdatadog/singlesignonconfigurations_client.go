...
func (client *SingleSignOnConfigurationsClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, monitorName string, configurationName string, body SingleSignOnResource, _ *SingleSignOnConfigurationsClientBeginCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *SingleSignOnConfigurationsClient) getHandleResponse(resp *http.Response, successCodes ...int) (SingleSignOnConfigurationsClientGetResponse, error) {
...
func (client *SingleSignOnConfigurationsClient) listCreateRequest(ctx context.Context, resourceGroupName string, monitorName string, nextLink string, _ *SingleSignOnConfigurationsClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *SingleSignOnConfigurationsClient) listHandleResponse(resp *http.Response, successCodes ...int) (SingleSignOnConfigurationsClientListResponse, error) {
