...
// Generated from example definition: 2025-12-26-preview/SingleSignOnConfigurations_CreateOrUpdate.json
func ExampleSingleSignOnConfigurationsClient_BeginCreateOrUpdate() {
	...
	poller, err := clientFactory.NewSingleSignOnConfigurationsClient().BeginCreateOrUpdate(ctx, "myResourceGroup", "myMonitor", "default", armdatadog.SingleSignOnResource{
	...
	// res = armdatadog.SingleSignOnConfigurationsClientCreateOrUpdateResponse{
...
// Generated from example definition: 2025-12-26-preview/SingleSignOnConfigurations_Get.json
func ExampleSingleSignOnConfigurationsClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armdatadog.SingleSignOnConfigurationsClientGetResponse{
	// 	SingleSignOnResource: &armdatadog.SingleSignOnResource{
	// 		Name: to.Ptr("default"),
	// 		ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/myResourceGroup/providers/Microsoft.Datadog/monitors/myMonitor/singleSignOnConfigurations/default"),
	// 		Properties: &armdatadog.SingleSignOnProperties{
...
// Generated from example definition: 2025-12-26-preview/SingleSignOnConfigurations_List.json
func ExampleSingleSignOnConfigurationsClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armdatadog.SingleSignOnConfigurationsClientListResponse{
