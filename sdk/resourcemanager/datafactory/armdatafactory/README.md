...
Azure Data Factory modules consist of one or more clients.  We provide a client factory which could be used to create any client in this module.
...
client, err := armdatafactory.NewClientFactory(<subscription ID>, cred, &options)
```
