...
func ExampleActivityRunsClient_NewQueryByPipelineRunPager() {
	...
	pager := clientFactory.NewActivityRunsClient().NewQueryByPipelineRunPager("exampleResourceGroup", "exampleFactoryName", "2f7fdb90-5df1-4b8e-ac2f-064cfa58202b", armdatafactory.RunFilterParameters{
	...
	for pager.More() {
		...
		// page = armdatafactory.ActivityRunsClientQueryByPipelineRunResponse{
