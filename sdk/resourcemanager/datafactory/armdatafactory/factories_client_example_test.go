...
// Generated from example definition: 2018-06-01/Factories_ConfigureFactoryRepo.json
func ExampleFactoriesClient_ConfigureFactoryRepo() {
	...
	res, err := clientFactory.NewFactoriesClient().ConfigureFactoryRepo(ctx, "East US", armdatafactory.FactoryRepoUpdate{
		FactoryResourceID: to.Ptr("/subscriptions/12345678-1234-1234-1234-123456789012/resourceGroups/exampleResourceGroup/providers/Microsoft.DataFactory/factories/exampleFactoryName"),
...
// Generated from example definition: 2018-06-01/Factories_Delete.json
func ExampleFactoriesClient_Delete() {
	...
	res, err := clientFactory.NewFactoriesClient().Delete(ctx, "exampleResourceGroup", "exampleFactoryName", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armdatafactory.FactoriesClientDeleteResponse{
	// }
}

// Generated from example definition: 2018-06-01/Factories_Get.json
func ExampleFactoriesClient_Get() {
	...
	res, err := clientFactory.NewFactoriesClient().Get(ctx, "exampleResourceGroup", "exampleFactoryName", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
...
// Generated from example definition: 2018-06-01/Factories_GetDataPlaneAccess.json
...
// Generated from example definition: 2018-06-01/Factories_GetGitHubAccessToken.json
...
// Generated from example definition: 2018-06-01/Factories_Update.json
