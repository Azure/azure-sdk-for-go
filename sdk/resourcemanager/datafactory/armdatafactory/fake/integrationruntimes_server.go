...
type IntegrationRuntimesServer struct {
	...
	// NewListOutboundNetworkDependenciesEndpointsPager is the fake for method IntegrationRuntimesClient.NewListOutboundNetworkDependenciesEndpointsPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListOutboundNetworkDependenciesEndpointsPager func(resourceGroupName string, factoryName string, integrationRuntimeName string, options *armdatafactory.IntegrationRuntimesClientListOutboundNetworkDependenciesEndpointsOptions) (resp azfake.PagerResponder[armdatafactory.IntegrationRuntimesClientListOutboundNetworkDependenciesEndpointsResponse])
...
func NewIntegrationRuntimesServerTransport(srv *IntegrationRuntimesServer) *IntegrationRuntimesServerTransport {
	return &IntegrationRuntimesServerTransport{
		...
		newListOutboundNetworkDependenciesEndpointsPager: newTracker[azfake.PagerResponder[armdatafactory.IntegrationRuntimesClientListOutboundNetworkDependenciesEndpointsResponse]](),
...
type IntegrationRuntimesServerTransport struct {
	...
	newListOutboundNetworkDependenciesEndpointsPager *tracker[azfake.PagerResponder[armdatafactory.IntegrationRuntimesClientListOutboundNetworkDependenciesEndpointsResponse]]
...
func (i *IntegrationRuntimesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		if !intercepted {
			...
			case "IntegrationRuntimesClient.NewListOutboundNetworkDependenciesEndpointsPager":
				res.resp, res.err = i.dispatchNewListOutboundNetworkDependenciesEndpointsPager(req)
...
func (i *IntegrationRuntimesServerTransport) dispatchNewListOutboundNetworkDependenciesEndpointsPager(req *http.Request) (*http.Response, error) {
	if i.srv.NewListOutboundNetworkDependenciesEndpointsPager == nil {
		return nil, &nonRetriableError{errors.New("fake for method NewListOutboundNetworkDependenciesEndpointsPager not implemented")}
	}
	newListOutboundNetworkDependenciesEndpointsPager := i.newListOutboundNetworkDependenciesEndpointsPager.get(req)
	if newListOutboundNetworkDependenciesEndpointsPager == nil {
		...
		resp := i.srv.NewListOutboundNetworkDependenciesEndpointsPager(resourceGroupNameParam, factoryNameParam, integrationRuntimeNameParam, nil)
		newListOutboundNetworkDependenciesEndpointsPager = &resp
		i.newListOutboundNetworkDependenciesEndpointsPager.add(req, newListOutboundNetworkDependenciesEndpointsPager)
	}
	...
	if !contains([]int{http.StatusOK}, resp.StatusCode) {
		i.newListOutboundNetworkDependenciesEndpointsPager.remove(req)
		return nil, &nonRetriableError{fmt.Errorf("unexpected status code %d. acceptable values are http.StatusOK", resp.StatusCode)}
	}
