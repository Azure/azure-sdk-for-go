...
type PipelineRunsServer struct {
	...
	// NewQueryByFactoryPager is the fake for method PipelineRunsClient.NewQueryByFactoryPager
	// HTTP status codes to indicate success: http.StatusOK
	NewQueryByFactoryPager func(resourceGroupName string, factoryName string, filterParameters armdatafactory.RunFilterParameters, options *armdatafactory.PipelineRunsClientQueryByFactoryOptions) (resp azfake.PagerResponder[armdatafactory.PipelineRunsClientQueryByFactoryResponse])
}
...
func NewPipelineRunsServerTransport(srv *PipelineRunsServer) *PipelineRunsServerTransport {
	return &PipelineRunsServerTransport{
		srv:                    srv,
		newQueryByFactoryPager: newTracker[azfake.PagerResponder[armdatafactory.PipelineRunsClientQueryByFactoryResponse]](),
	}
}
...
type PipelineRunsServerTransport struct {
	...
	newQueryByFactoryPager *tracker[azfake.PagerResponder[armdatafactory.PipelineRunsClientQueryByFactoryResponse]]
}
...
func (p *PipelineRunsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		if !intercepted {
			...
			case "PipelineRunsClient.NewQueryByFactoryPager":
				res.resp, res.err = p.dispatchNewQueryByFactoryPager(req)
			default:
...
func (p *PipelineRunsServerTransport) dispatchNewQueryByFactoryPager(req *http.Request) (*http.Response, error) {
	if p.srv.NewQueryByFactoryPager == nil {
		return nil, &nonRetriableError{errors.New("fake for method NewQueryByFactoryPager not implemented")}
	}
	newQueryByFactoryPager := p.newQueryByFactoryPager.get(req)
	if newQueryByFactoryPager == nil {
		...
		resp := p.srv.NewQueryByFactoryPager(resourceGroupNameParam, factoryNameParam, body, nil)
		newQueryByFactoryPager = &resp
		p.newQueryByFactoryPager.add(req, newQueryByFactoryPager)
	}
	...
	if !contains([]int{http.StatusOK}, resp.StatusCode) {
		p.newQueryByFactoryPager.remove(req)
