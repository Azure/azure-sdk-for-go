...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "ActivityRunsClient":
		initServer(&s.trMu, &s.trActivityRunsServer, func() *ActivityRunsServerTransport { return NewActivityRunsServerTransport(&s.srv.ActivityRunsServer) })
		resp, err = s.trActivityRunsServer.Do(req)
	case "ChangeDataCaptureClient":
		initServer(&s.trMu, &s.trChangeDataCaptureServer, func() *ChangeDataCaptureServerTransport {
	...
	case "CredentialOperationsClient":
		initServer(&s.trMu, &s.trCredentialOperationsServer, func() *CredentialOperationsServerTransport {
	...
	case "DataFlowDebugSessionClient":
		initServer(&s.trMu, &s.trDataFlowDebugSessionServer, func() *DataFlowDebugSessionServerTransport {
	...
	case "DataFlowsClient":
		initServer(&s.trMu, &s.trDataFlowsServer, func() *DataFlowsServerTransport { return NewDataFlowsServerTransport(&s.srv.DataFlowsServer) })
		resp, err = s.trDataFlowsServer.Do(req)
	case "DatasetsClient":
		initServer(&s.trMu, &s.trDatasetsServer, func() *DatasetsServerTransport { return NewDatasetsServerTransport(&s.srv.DatasetsServer) })
		resp, err = s.trDatasetsServer.Do(req)
	case "ExposureControlClient":
		initServer(&s.trMu, &s.trExposureControlServer, func() *ExposureControlServerTransport {
	...
	case "FactoriesClient":
		initServer(&s.trMu, &s.trFactoriesServer, func() *FactoriesServerTransport { return NewFactoriesServerTransport(&s.srv.FactoriesServer) })
		resp, err = s.trFactoriesServer.Do(req)
	case "GlobalParametersClient":
		initServer(&s.trMu, &s.trGlobalParametersServer, func() *GlobalParametersServerTransport {
	...
	case "IntegrationRuntimeClient":
		initServer(&s.trMu, &s.trIntegrationRuntimeServer, func() *IntegrationRuntimeServerTransport {
	...
	case "IntegrationRuntimeNodesClient":
		initServer(&s.trMu, &s.trIntegrationRuntimeNodesServer, func() *IntegrationRuntimeNodesServerTransport {
	...
	case "IntegrationRuntimeObjectMetadataClient":
		initServer(&s.trMu, &s.trIntegrationRuntimeObjectMetadataServer, func() *IntegrationRuntimeObjectMetadataServerTransport {
	...
	case "IntegrationRuntimesClient":
		initServer(&s.trMu, &s.trIntegrationRuntimesServer, func() *IntegrationRuntimesServerTransport {
	...
	case "ManagedVirtualNetworksClient":
		initServer(&s.trMu, &s.trManagedVirtualNetworksServer, func() *ManagedVirtualNetworksServerTransport {
	...
	case "PipelinesClient":
		initServer(&s.trMu, &s.trPipelinesServer, func() *PipelinesServerTransport { return NewPipelinesServerTransport(&s.srv.PipelinesServer) })
	...
	case "TriggerRunsClient":
		initServer(&s.trMu, &s.trTriggerRunsServer, func() *TriggerRunsServerTransport { return NewTriggerRunsServerTransport(&s.srv.TriggerRunsServer) })
