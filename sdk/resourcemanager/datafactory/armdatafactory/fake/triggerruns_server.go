...
type TriggerRunsServer struct {
	...
	// NewQueryByFactoryPager is the fake for method TriggerRunsClient.NewQueryByFactoryPager
	// HTTP status codes to indicate success: http.StatusOK
	NewQueryByFactoryPager func(resourceGroupName string, factoryName string, filterParameters armdatafactory.RunFilterParameters, options *armdatafactory.TriggerRunsClientQueryByFactoryOptions) (resp azfake.PagerResponder[armdatafactory.TriggerRunsClientQueryByFactoryResponse])
...
func NewTriggerRunsServerTransport(srv *TriggerRunsServer) *TriggerRunsServerTransport {
	return &TriggerRunsServerTransport{
		srv:                    srv,
		newQueryByFactoryPager: newTracker[azfake.PagerResponder[armdatafactory.TriggerRunsClientQueryByFactoryResponse]](),
	}
}
...
type TriggerRunsServerTransport struct {
	...
	newQueryByFactoryPager *tracker[azfake.PagerResponder[armdatafactory.TriggerRunsClientQueryByFactoryResponse]]
}
...
func (t *TriggerRunsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		if !intercepted {
			...
			case "TriggerRunsClient.NewQueryByFactoryPager":
...
func (t *TriggerRunsServerTransport) dispatchNewQueryByFactoryPager(req *http.Request) (*http.Response, error) {
