...
// NewListOutboundNetworkDependenciesEndpointsPager - Gets the list of outbound network dependencies for a given Azure-SSIS
// integration runtime.
//
// Generated from API version 2018-06-01
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
...
//     the IntegrationRuntimesClient.NewListOutboundNetworkDependenciesEndpointsPager method.
func (client *IntegrationRuntimesClient) NewListOutboundNetworkDependenciesEndpointsPager(resourceGroupName string, factoryName string, integrationRuntimeName string, options *IntegrationRuntimesClientListOutboundNetworkDependenciesEndpointsOptions) *runtime.Pager[IntegrationRuntimesClientListOutboundNetworkDependenciesEndpointsResponse] {
	return runtime.NewPager(runtime.PagingHandler[IntegrationRuntimesClientListOutboundNetworkDependenciesEndpointsResponse]{
		More: func(page IntegrationRuntimesClientListOutboundNetworkDependenciesEndpointsResponse) bool {
			return false
		},
		Fetcher: func(ctx context.Context, page *IntegrationRuntimesClientListOutboundNetworkDependenciesEndpointsResponse) (IntegrationRuntimesClientListOutboundNetworkDependenciesEndpointsResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "IntegrationRuntimesClient.NewListOutboundNetworkDependenciesEndpointsPager")
