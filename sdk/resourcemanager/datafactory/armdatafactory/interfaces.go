...
// - *Activity, *AzureDataExplorerCommandActivity, *AzureFunctionActivity, *AzureMLBatchExecutionActivity, *AzureMLExecutePipelineActivity,
...
// - *ExecuteSsisPackageActivity, *ExecuteWranglingDataflowActivity, *ExecutionActivity, *ForEachActivity, *GetMetadataActivity,
// - *HDInsightHiveActivity, *HDInsightMapReduceActivity, *HDInsightPigActivity, *HDInsightSparkActivity, *HDInsightStreamingActivity,
// - *LookupActivity, *SQLServerStoredProcedureActivity, *ScriptActivity, *SynapseNotebookActivity, *SynapseSparkJobDefinitionActivity,
