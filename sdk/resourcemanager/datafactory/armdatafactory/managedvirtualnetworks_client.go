...
func (client *ManagedVirtualNetworksClient) createOrUpdateHandleResponse(resp *http.Response, successCodes ...int) (ManagedVirtualNetworksClientCreateOrUpdateResponse, error) {
...
func (client *ManagedVirtualNetworksClient) getHandleResponse(resp *http.Response, successCodes ...int) (ManagedVirtualNetworksClientGetResponse, error) {
...
func (client *ManagedVirtualNetworksClient) listByFactoryCreateRequest(ctx context.Context, resourceGroupName string, factoryName string, nextLink string, _ *ManagedVirtualNetworksClientListByFactoryOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *ManagedVirtualNetworksClient) listByFactoryHandleResponse(resp *http.Response, successCodes ...int) (ManagedVirtualNetworksClientListByFactoryResponse, error) {
