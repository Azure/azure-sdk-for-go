...
// NewQueryByFactoryPager - Query pipeline runs in the factory based on input filter conditions.
//
// Generated from API version 2018-06-01
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - factoryName - The factory name.
//   - filterParameters - Parameters to filter the pipeline run.
//   - options - PipelineRunsClientQueryByFactoryOptions contains the optional parameters for the PipelineRunsClient.NewQueryByFactoryPager
//     method.
func (client *PipelineRunsClient) NewQueryByFactoryPager(resourceGroupName string, factoryName string, filterParameters RunFilterParameters, options *PipelineRunsClientQueryByFactoryOptions) *runtime.Pager[PipelineRunsClientQueryByFactoryResponse] {
	return runtime.NewPager(runtime.PagingHandler[PipelineRunsClientQueryByFactoryResponse]{
		More: func(page PipelineRunsClientQueryByFactoryResponse) bool {
			return false
		},
		Fetcher: func(ctx context.Context, page *PipelineRunsClientQueryByFactoryResponse) (PipelineRunsClientQueryByFactoryResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "PipelineRunsClient.NewQueryByFactoryPager")
