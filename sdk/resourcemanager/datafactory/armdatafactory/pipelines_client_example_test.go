...
// Generated from example definition: 2018-06-01/Pipelines_Create.json
func ExamplePipelinesClient_CreateOrUpdate_pipelinesCreate() {
	...
	// 		ID: to.Ptr("/subscriptions/12345678-1234-1234-1234-123456789012/resourceGroups/exampleResourceGroup/providers/Microsoft.DataFactory/factories/exampleFactoryName/pipelines/examplePipeline"),
	// 		Properties: &armdatafactory.Pipeline{
	// 			Activities: []armdatafactory.ActivityClassification{
	// 				&armdatafactory.ForEachActivity{
	// 					Name: to.Ptr("ExampleForeachActivity"),
...
// Generated from example definition: 2018-06-01/Pipelines_Update.json
...
// Generated from example definition: 2018-06-01/Pipelines_CreateRun.json
func ExamplePipelinesClient_CreateRun() {
	...
	res, err := clientFactory.NewPipelinesClient().CreateRun(ctx, "exampleResourceGroup", "exampleFactoryName", "examplePipeline", &armdatafactory.PipelinesClientCreateRunOptions{
		Parameters: map[string]any{
...
// Generated from example definition: 2018-06-01/Pipelines_Delete.json
func ExamplePipelinesClient_Delete() {
	...
	res, err := clientFactory.NewPipelinesClient().Delete(ctx, "exampleResourceGroup", "exampleFactoryName", "examplePipeline", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armdatafactory.PipelinesClientDeleteResponse{
	// }
}

// Generated from example definition: 2018-06-01/Pipelines_Get.json
func ExamplePipelinesClient_Get() {
	...
	res, err := clientFactory.NewPipelinesClient().Get(ctx, "exampleResourceGroup", "exampleFactoryName", "examplePipeline", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
...
// Generated from example definition: 2018-06-01/Pipelines_ListByFactory.json
func ExamplePipelinesClient_NewListByFactoryPager() {
	...
	for pager.More() {
		...
		// page = armdatafactory.PipelinesClientListByFactoryResponse{
