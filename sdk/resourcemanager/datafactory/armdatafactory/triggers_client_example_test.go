...
// Generated from example definition: 2018-06-01/Triggers_Create.json
func ExampleTriggersClient_CreateOrUpdate_triggersCreate() {
	...
	// 		ID: to.Ptr("/subscriptions/12345678-1234-1234-1234-123456789012/resourceGroups/exampleResourceGroup/providers/Microsoft.DataFactory/factories/exampleFactoryName/triggers/exampleTrigger"),
	// 		Properties: &armdatafactory.ScheduleTrigger{
	// 			Type: to.Ptr("ScheduleTrigger"),
	// 			Pipelines: []*armdatafactory.TriggerPipelineReference{
	// 				{
...
// Generated from example definition: 2018-06-01/Triggers_Update.json
...
// Generated from example definition: 2018-06-01/Triggers_Delete.json
func ExampleTriggersClient_Delete() {
	...
	res, err := clientFactory.NewTriggersClient().Delete(ctx, "exampleResourceGroup", "exampleFactoryName", "exampleTrigger", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armdatafactory.TriggersClientDeleteResponse{
	// }
}

// Generated from example definition: 2018-06-01/Triggers_Get.json
func ExampleTriggersClient_Get() {
	...
	res, err := clientFactory.NewTriggersClient().Get(ctx, "exampleResourceGroup", "exampleFactoryName", "exampleTrigger", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
...
// Generated from example definition: 2018-06-01/Triggers_GetEventSubscriptionStatus.json
...
// Generated from example definition: 2018-06-01/Triggers_ListByFactory.json
func ExampleTriggersClient_NewListByFactoryPager() {
	...
	for pager.More() {
		...
		// page = armdatafactory.TriggersClientListByFactoryResponse{
...
// Generated from example definition: 2018-06-01/Triggers_QueryByFactory.json
func ExampleTriggersClient_NewQueryByFactoryPager() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	pager := clientFactory.NewTriggersClient().NewQueryByFactoryPager("exampleResourceGroup", "exampleFactoryName", armdatafactory.TriggerFilterParameters{
	...
	for pager.More() {
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armdatafactory.TriggersClientQueryByFactoryResponse{
		// 	TriggerQueryResponse: armdatafactory.TriggerQueryResponse{
		// 		Value: []*armdatafactory.TriggerResource{
		// 			{
		// 				Name: to.Ptr("exampleRerunTrigger"),
		// 				Type: to.Ptr("Microsoft.DataFactory/factories/triggers"),
		// 				ID: to.Ptr("/subscriptions/12345678-1234-1234-1234-123456789012/resourceGroups/exampleResourceGroup/providers/Microsoft.DataFactory/factories/exampleFactoryName/triggers/exampleRerunTrigger"),
...
// Generated from example definition: 2018-06-01/Triggers_Start.json
func ExampleTriggersClient_BeginStart() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armdatafactory.TriggersClientStartResponse{
	// }
}

// Generated from example definition: 2018-06-01/Triggers_Stop.json
func ExampleTriggersClient_BeginStop() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armdatafactory.TriggersClientStopResponse{
	// }
}

// Generated from example definition: 2018-06-01/Triggers_SubscribeToEvents.json
...
// Generated from example definition: 2018-06-01/Triggers_UnsubscribeFromEvents.json
