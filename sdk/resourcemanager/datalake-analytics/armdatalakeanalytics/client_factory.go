...
func (c *ClientFactory) NewComputePoliciesClient() *ComputePoliciesClient {
	subClient, _ := NewComputePoliciesClient(c.subscriptionID, c.credential, c.options)
	return subClient
}
...
func (c *ClientFactory) NewDataLakeStoreAccountsClient() *DataLakeStoreAccountsClient {
	subClient, _ := NewDataLakeStoreAccountsClient(c.subscriptionID, c.credential, c.options)
	return subClient
}
