...
// The returned LocationsServerTransport instance is connected to an instance of armdatalakeanalytics.LocationsClient via the
...
// LocationsServerTransport connects instances of armdatalakeanalytics.LocationsClient to instances of LocationsServer.
...
func (l *LocationsServerTransport) dispatchGetCapability(req *http.Request) (*http.Response, error) {
	...
	const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.DataLakeAnalytics/locations/(?P<location>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/capability`
