...
func ExampleDatabaseMigrationsMongoToCosmosDbvCoreMongoClient_BeginDelete() {
	...
	poller, err := clientFactory.NewDatabaseMigrationsMongoToCosmosDbvCoreMongoClient().BeginDelete(ctx, "testrg", "targetCosmosDbClusterName", "migrationRequest", &armdatamigration.DatabaseMigrationsMongoToCosmosDbvCoreMongoClientBeginDeleteOptions{Force: nil})
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
