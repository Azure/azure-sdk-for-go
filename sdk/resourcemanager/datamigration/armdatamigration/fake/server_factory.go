...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "DatabaseMigrationsMongoToCosmosDbRUMongoClient":
		initServer(&s.trMu, &s.trDatabaseMigrationsMongoToCosmosDbRUMongoServer, func() *DatabaseMigrationsMongoToCosmosDbRUMongoServerTransport {
	...
	case "DatabaseMigrationsMongoToCosmosDbvCoreMongoClient":
		initServer(&s.trMu, &s.trDatabaseMigrationsMongoToCosmosDbvCoreMongoServer, func() *DatabaseMigrationsMongoToCosmosDbvCoreMongoServerTransport {
	...
	case "DatabaseMigrationsSQLDbClient":
		initServer(&s.trMu, &s.trDatabaseMigrationsSQLDbServer, func() *DatabaseMigrationsSQLDbServerTransport {
	...
	case "DatabaseMigrationsSQLMiClient":
		initServer(&s.trMu, &s.trDatabaseMigrationsSQLMiServer, func() *DatabaseMigrationsSQLMiServerTransport {
	...
	case "DatabaseMigrationsSQLVMClient":
		initServer(&s.trMu, &s.trDatabaseMigrationsSQLVMServer, func() *DatabaseMigrationsSQLVMServerTransport {
	...
	case "MigrationServicesClient":
		initServer(&s.trMu, &s.trMigrationServicesServer, func() *MigrationServicesServerTransport {
	...
	case "SQLMigrationServicesClient":
		initServer(&s.trMu, &s.trSQLMigrationServicesServer, func() *SQLMigrationServicesServerTransport {
	...
	case "ServiceTasksClient":
		initServer(&s.trMu, &s.trServiceTasksServer, func() *ServiceTasksServerTransport { return NewServiceTasksServerTransport(&s.srv.ServiceTasksServer) })
