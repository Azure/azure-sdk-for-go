...
// The returned UsagesServerTransport instance is connected to an instance of armdatamigration.UsagesClient via the
// azcore.ClientOptions.Transporter field in the client's constructor parameters.
func NewUsagesServerTransport(srv *UsagesServer) *UsagesServerTransport {
	return &UsagesServerTransport{
		srv:          srv,
		newListPager: newTracker[azfake.PagerResponder[armdatamigration.UsagesClientListResponse]](),
	}
}

// UsagesServerTransport connects instances of armdatamigration.UsagesClient to instances of UsagesServer.
// Don't use this type directly, use NewUsagesServerTransport instead.
type UsagesServerTransport struct {
	srv          *UsagesServer
	newListPager *tracker[azfake.PagerResponder[armdatamigration.UsagesClientListResponse]]
}
...
func (u *UsagesServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.DataMigration/locations/(?P<location>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/usages`
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armdatamigration.UsagesClientListResponse, createLink func() string) {
