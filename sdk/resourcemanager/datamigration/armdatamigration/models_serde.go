...
func (b BackupSetInfo) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateTime[datetime.RFC3339](objectMap, "backupFinishedDate", b.BackupFinishedDate)
	populate(objectMap, "backupSetId", b.BackupSetID)
	populateTime[datetime.RFC3339](objectMap, "backupStartDate", b.BackupStartDate)
	...
	populateTime[datetime.RFC3339](objectMap, "lastModifiedTime", b.LastModifiedTime)
...
func (c ConnectToSourceSQLServerTaskOutputAgentJobLevel) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "lastExecutedOn", c.LastExecutedOn)
...
func (c CopyProgressDetails) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "copyStart", c.CopyStart)
...
func (d DatabaseBackupInfo) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "backupFinishDate", d.BackupFinishDate)
...
func (m MigrateMySQLAzureDbForMySQLOfflineTaskInput) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "startedOn", m.StartedOn)
...
func (m MigrateMySQLAzureDbForMySQLOfflineTaskOutputDatabaseLevel) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "endedOn", m.EndedOn)
	...
	populate(objectMap, "id", m.ID)
	populateTime[datetime.RFC3339](objectMap, "lastStorageUpdate", m.LastStorageUpdate)
...
func (m MigrateMySQLAzureDbForMySQLSyncTaskOutputTableLevel) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "databaseName", m.DatabaseName)
	populateTime[datetime.RFC3339](objectMap, "fullLoadEndedOn", m.FullLoadEndedOn)
	populateTime[datetime.RFC3339](objectMap, "fullLoadEstFinishTime", m.FullLoadEstFinishTime)
	populateTime[datetime.RFC3339](objectMap, "fullLoadStartedOn", m.FullLoadStartedOn)
	populate(objectMap, "fullLoadTotalRows", m.FullLoadTotalRows)
	populate(objectMap, "id", m.ID)
	populateTime[datetime.RFC3339](objectMap, "lastModifiedTime", m.LastModifiedTime)
	objectMap["resultType"] = "TableLevelOutput"
	populate(objectMap, "state", m.State)
...
func (m MigrateSyncCompleteCommandInput) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateTime[datetime.RFC3339](objectMap, "commitTimeStamp", m.CommitTimeStamp)
	populate(objectMap, "databaseName", m.DatabaseName)
	return json.Marshal(objectMap)
}
...
func (m MongoDbCollectionProgress) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "lastEventTime", m.LastEventTime)
	populateTime[datetime.RFC3339](objectMap, "lastReplayTime", m.LastReplayTime)
	populate(objectMap, "name", m.Name)
	populate(objectMap, "qualifiedName", m.QualifiedName)
...
func (s SQLBackupSetInfo) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateTime[datetime.RFC3339](objectMap, "backupFinishDate", s.BackupFinishDate)
	populate(objectMap, "backupSetId", s.BackupSetID)
	populateTime[datetime.RFC3339](objectMap, "backupStartDate", s.BackupStartDate)
