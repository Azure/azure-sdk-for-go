...
// Generated from example definition: 2025-09-01-preview/ListOperation.json
func ExampleOperationsClient_NewListPager() {
	...
	clientFactory, err := armdatamigration.NewClientFactory("<subscriptionID>", cred, nil)
	if err != nil {
	...
	for pager.More() {
		...
		// page = armdatamigration.OperationsClientListResponse{
		// 	OperationListResult: armdatamigration.OperationListResult{
