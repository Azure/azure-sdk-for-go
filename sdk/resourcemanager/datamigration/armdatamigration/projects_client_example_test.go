...
// Generated from example definition: 2025-09-01-preview/Projects_CreateOrUpdate.json
func ExampleProjectsClient_CreateOrUpdate() {
	...
	// res = armdatamigration.ProjectsClientCreateOrUpdateResponse{
	...
	// 		Location: to.Ptr("southcentralus"),
	// 		Properties: &armdatamigration.ProjectProperties{
	// 			CreationTime: to.Ptr(time.Date(2017, time.November, 3, 9, 14, 54, 245828200, time.UTC)),
...
// Generated from example definition: 2025-09-01-preview/Projects_Delete.json
func ExampleProjectsClient_Delete() {
	...
	res, err := clientFactory.NewProjectsClient().Delete(ctx, "DmsSdkRg", "DmsSdkService", "DmsSdkProject", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armdatamigration.ProjectsClientDeleteResponse{
	// }
}

// Generated from example definition: 2025-09-01-preview/Projects_Get.json
func ExampleProjectsClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armdatamigration.ProjectsClientGetResponse{
	// 	Project: armdatamigration.Project{
	// 		Name: to.Ptr("DmsSdkProject"),
	// 		Type: to.Ptr("Microsoft.DataMigration/services/projects"),
	// 		ID: to.Ptr("/subscriptions/fc04246f-04c5-437e-ac5e-206a19e7193f/resourceGroups/DmsSdkRg/providers/Microsoft.DataMigration/services/DmsSdkService/projects/DmsSdkProject"),
	// 		Location: to.Ptr("southcentralus"),
	// 		Properties: &armdatamigration.ProjectProperties{
	// 			CreationTime: to.Ptr(time.Date(2017, time.November, 3, 9, 35, 11, 656100100, time.UTC)),
	// 			ProvisioningState: to.Ptr(armdatamigration.ProjectProvisioningStateSucceeded),
	// 			SourcePlatform: to.Ptr(armdatamigration.ProjectSourcePlatformSQL),
	// 			TargetPlatform: to.Ptr(armdatamigration.ProjectTargetPlatformSQLDB),
	// 		},
...
// Generated from example definition: 2025-09-01-preview/Projects_List.json
func ExampleProjectsClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armdatamigration.ProjectsClientListResponse{
		// 	ProjectList: armdatamigration.ProjectList{
		...
		// 				Location: to.Ptr("southcentralus"),
		// 				Properties: &armdatamigration.ProjectProperties{
		// 					CreationTime: to.Ptr(time.Date(2017, time.November, 14, 1, 29, 56, 304926300, time.UTC)),
		// 					ProvisioningState: to.Ptr(armdatamigration.ProjectProvisioningStateSucceeded),
		// 					SourcePlatform: to.Ptr(armdatamigration.ProjectSourcePlatformSQL),
		// 					TargetPlatform: to.Ptr(armdatamigration.ProjectTargetPlatformSQLDB),
		// 				},
		...
		// 				Location: to.Ptr("southcentralus"),
		// 				Properties: &armdatamigration.ProjectProperties{
		// 					CreationTime: to.Ptr(time.Date(2017, time.November, 14, 1, 30, 5, 618514800, time.UTC)),
		// 					ProvisioningState: to.Ptr(armdatamigration.ProjectProvisioningStateSucceeded),
		// 					SourcePlatform: to.Ptr(armdatamigration.ProjectSourcePlatformSQL),
		// 					TargetPlatform: to.Ptr(armdatamigration.ProjectTargetPlatformSQLDB),
		// 				},
