...
// Generated from example definition: 2025-09-01-preview/ResourceSkus_ListSkus.json
func ExampleResourceSKUsClient_NewListSKUsPager() {
	...
	for pager.More() {
		...
		// page = armdatamigration.ResourceSKUsClientListSKUsResponse{
		// 	ResourceSKUsResult: armdatamigration.ResourceSKUsResult{
