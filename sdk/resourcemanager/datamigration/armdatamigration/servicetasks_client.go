...
// Cancel - Cancel a service task
//
// The service tasks resource is a nested, proxy-only resource representing work performed by a DMS (classic) instance. This
...
func (client *ServiceTasksClient) cancelHandleResponse(resp *http.Response, successCodes ...int) (ServiceTasksClientCancelResponse, error) {
...
// CreateOrUpdate - Create or update service task
//
// The service tasks resource is a nested, proxy-only resource representing work performed by a DMS (classic) instance. The
// PUT method creates a new service task or updates an existing one, although since service tasks have no mutable custom properties,
...
func (client *ServiceTasksClient) createOrUpdateHandleResponse(resp *http.Response, successCodes ...int) (ServiceTasksClientCreateOrUpdateResponse, error) {
...
func (client *ServiceTasksClient) Delete(ctx context.Context, groupName string, serviceName string, taskName string, options *ServiceTasksClientDeleteOptions) (ServiceTasksClientDeleteResponse, error) {
	...
	if !runtime.HasStatusCode(httpResp, http.StatusOK, http.StatusNoContent) {
		return ServiceTasksClientDeleteResponse{}, runtime.NewResponseError(httpResp)
	}
...
// Get - Get service task information
//
// The service tasks resource is a nested, proxy-only resource representing work performed by a DMS (classic) instance. The
...
func (client *ServiceTasksClient) getHandleResponse(resp *http.Response, successCodes ...int) (ServiceTasksClientGetResponse, error) {
...
// NewListPager - Get service level tasks for a service
//
// The services resource is the top-level resource that represents the Azure Database Migration Service (classic). This method
// returns a list of service level tasks owned by a service resource. Some tasks may have a status of Unknown, which indicates
...
func (client *ServiceTasksClient) listCreateRequest(ctx context.Context, groupName string, serviceName string, nextLink string, options *ServiceTasksClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *ServiceTasksClient) listHandleResponse(resp *http.Response, successCodes ...int) (ServiceTasksClientListResponse, error) {
...
// Update - Create or update service task
//
// The service tasks resource is a nested, proxy-only resource representing work performed by a DMS (classic) instance. The
// PATCH method updates an existing service task, but since service tasks have no mutable custom properties, there is little
// reason to do so.
// If the operation fails it returns an *azcore.ResponseError type.
//   - groupName - Name of the resource group
//   - serviceName - Name of the service
...
func (client *ServiceTasksClient) updateHandleResponse(resp *http.Response, successCodes ...int) (ServiceTasksClientUpdateResponse, error) {
