...
func ExampleUsagesClient_NewListPager() {
	...
	clientFactory, err := armdatamigration.NewClientFactory("90fb80a6-0f71-4761-8f03-921e7396f3c0", cred, nil)
	if err != nil {
	...
	for pager.More() {
		...
		// page = armdatamigration.UsagesClientListResponse{
		// 	QuotaList: armdatamigration.QuotaList{
