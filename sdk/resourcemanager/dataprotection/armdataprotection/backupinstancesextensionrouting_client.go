...
func (client *BackupInstancesExtensionRoutingClient) NewListPager(resourceID string, options *BackupInstancesExtensionRoutingClientListOptions) *runtime.Pager[BackupInstancesExtensionRoutingClientListResponse] {
	return runtime.NewPager(runtime.PagingHandler[BackupInstancesExtensionRoutingClientListResponse]{
		...
		Fetcher: func(ctx context.Context, page *BackupInstancesExtensionRoutingClientListResponse) (BackupInstancesExtensionRoutingClientListResponse, error) {
			...
			req, err := client.listCreateRequest(ctx, resourceID, nextLink, options)
			if err != nil {
...
func (client *BackupInstancesExtensionRoutingClient) listCreateRequest(ctx context.Context, resourceID string, nextLink string, _ *BackupInstancesExtensionRoutingClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *BackupInstancesExtensionRoutingClient) listHandleResponse(resp *http.Response, successCodes ...int) (BackupInstancesExtensionRoutingClientListResponse, error) {
