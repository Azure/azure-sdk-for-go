...
func (client *BackupPoliciesClient) createOrUpdateHandleResponse(resp *http.Response, successCodes ...int) (BackupPoliciesClientCreateOrUpdateResponse, error) {
...
func (client *BackupPoliciesClient) Delete(ctx context.Context, resourceGroupName string, vaultName string, backupPolicyName string, options *BackupPoliciesClientDeleteOptions) (BackupPoliciesClientDeleteResponse, error) {
	...
	if !runtime.HasStatusCode(httpResp, http.StatusOK, http.StatusNoContent) {
		return BackupPoliciesClientDeleteResponse{}, runtime.NewResponseError(httpResp)
	}
...
func (client *BackupPoliciesClient) getHandleResponse(resp *http.Response, successCodes ...int) (BackupPoliciesClientGetResponse, error) {
...
func (client *BackupPoliciesClient) listCreateRequest(ctx context.Context, resourceGroupName string, vaultName string, nextLink string, _ *BackupPoliciesClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *BackupPoliciesClient) listHandleResponse(resp *http.Response, successCodes ...int) (BackupPoliciesClientListResponse, error) {
