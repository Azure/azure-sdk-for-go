...
func (client *BackupVaultsClient) checkNameAvailabilityHandleResponse(resp *http.Response, successCodes ...int) (BackupVaultsClientCheckNameAvailabilityResponse, error) {
...
func (client *BackupVaultsClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, vaultName string, parameters BackupVaultResource, options *BackupVaultsClientBeginCreateOrUpdateOptions) (*policy.Request, error) {
	...
	if options != nil && options.XMSDeletedVaultID != nil {
		req.Raw().Header["x-ms-deleted-vault-id"] = []string{*options.XMSDeletedVaultID}
	}
	req.Raw().Header["Content-Type"] = []string{"application/json"}
	if err := runtime.MarshalAsJSON(req, parameters); err != nil {
		return nil, err
...
func (client *BackupVaultsClient) getHandleResponse(resp *http.Response, successCodes ...int) (BackupVaultsClientGetResponse, error) {
...
func (client *BackupVaultsClient) NewGetInResourceGroupPager(resourceGroupName string, options *BackupVaultsClientGetInResourceGroupOptions) *runtime.Pager[BackupVaultsClientGetInResourceGroupResponse] {
	return runtime.NewPager(runtime.PagingHandler[BackupVaultsClientGetInResourceGroupResponse]{
		...
		Fetcher: func(ctx context.Context, page *BackupVaultsClientGetInResourceGroupResponse) (BackupVaultsClientGetInResourceGroupResponse, error) {
			...
			req, err := client.getInResourceGroupCreateRequest(ctx, resourceGroupName, nextLink, options)
			if err != nil {
			...
			return client.getInResourceGroupHandleResponse(resp, http.StatusOK)
		},
		Tracer: client.internal.Tracer(),
	})
}
...
func (client *BackupVaultsClient) getInResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, nextLink string, _ *BackupVaultsClientGetInResourceGroupOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *BackupVaultsClient) getInResourceGroupHandleResponse(resp *http.Response, successCodes ...int) (BackupVaultsClientGetInResourceGroupResponse, error) {
...
func (client *BackupVaultsClient) NewGetInSubscriptionPager(options *BackupVaultsClientGetInSubscriptionOptions) *runtime.Pager[BackupVaultsClientGetInSubscriptionResponse] {
	return runtime.NewPager(runtime.PagingHandler[BackupVaultsClientGetInSubscriptionResponse]{
		...
		Fetcher: func(ctx context.Context, page *BackupVaultsClientGetInSubscriptionResponse) (BackupVaultsClientGetInSubscriptionResponse, error) {
			...
			req, err := client.getInSubscriptionCreateRequest(ctx, nextLink, options)
			if err != nil {
			...
			return client.getInSubscriptionHandleResponse(resp, http.StatusOK)
		},
		Tracer: client.internal.Tracer(),
	})
}
...
func (client *BackupVaultsClient) getInSubscriptionCreateRequest(ctx context.Context, nextLink string, _ *BackupVaultsClientGetInSubscriptionOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
	var req *policy.Request
	var err error
	if firstPage {
...
func (client *BackupVaultsClient) getInSubscriptionHandleResponse(resp *http.Response, successCodes ...int) (BackupVaultsClientGetInSubscriptionResponse, error) {
