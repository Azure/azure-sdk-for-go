...
func (client *DeletedBackupInstancesClient) getHandleResponse(resp *http.Response, successCodes ...int) (DeletedBackupInstancesClientGetResponse, error) {
...
func (client *DeletedBackupInstancesClient) listCreateRequest(ctx context.Context, resourceGroupName string, vaultName string, nextLink string, _ *DeletedBackupInstancesClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *DeletedBackupInstancesClient) listHandleResponse(resp *http.Response, successCodes ...int) (DeletedBackupInstancesClientListResponse, error) {
