...
func (o *OperationStatusResourceGroupContextServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	resultChan := make(chan result, 1)
	go func() {
		var intercepted bool
		var res result
		if operationStatusResourceGroupContextServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = operationStatusResourceGroupContextServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
func (o *OperationStatusResourceGroupContextServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.DataProtection/operationStatus/(?P<operationId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)`
...
// set this to conditionally intercept incoming requests to OperationStatusResourceGroupContextServerTransport
var operationStatusResourceGroupContextServerTransportInterceptor interface {
