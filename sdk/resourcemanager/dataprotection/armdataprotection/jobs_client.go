...
func (client *JobsClient) listCreateRequest(ctx context.Context, resourceGroupName string, vaultName string, nextLink string, _ *JobsClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
