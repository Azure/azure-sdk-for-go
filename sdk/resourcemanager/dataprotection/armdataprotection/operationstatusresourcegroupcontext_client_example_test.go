...
// Generated from example definition: 2026-04-01-preview/GetOperationStatusRGContext.json
func ExampleOperationStatusResourceGroupContextClient_Get() {
	...
	// res = armdataprotection.OperationStatusResourceGroupContextClientGetResponse{
