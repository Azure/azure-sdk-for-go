...
// Generated from example definition: 2026-04-01-preview/BackupInstanceOperations/GetRecoveryPoint.json
...
// Generated from example definition: 2026-04-01-preview/BackupInstanceOperations/ListRecoveryPoints.json
func ExampleRecoveryPointsClient_NewListPager() {
	...
	pager := clientFactory.NewRecoveryPointsClient().NewListPager("000pikumar", "PratikPrivatePreviewVault1", "testInstance1", nil)
	for pager.More() {
		...
		// page = armdataprotection.RecoveryPointsClientListResponse{
