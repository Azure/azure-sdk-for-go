...
Install the Azure Delegated Network module:
...
Azure Delegated Network modules consist of one or more clients.  A client groups a set of related APIs, providing access to its functionality within the specified subscription.  Create one or more clients to access the APIs you require using your credential.
...
[open an issue](https://github.com/Azure/azure-sdk-for-go/issues) and assign the `Delegated Network` label.
