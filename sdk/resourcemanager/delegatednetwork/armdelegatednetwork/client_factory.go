...
func (c *ClientFactory) NewControllerClient() *ControllerClient {
	subClient, _ := NewControllerClient(c.subscriptionID, c.credential, c.options)
	return subClient
}
...
func (c *ClientFactory) NewDelegatedSubnetServiceClient() *DelegatedSubnetServiceClient {
	subClient, _ := NewDelegatedSubnetServiceClient(c.subscriptionID, c.credential, c.options)
	return subClient
}
...
func (c *ClientFactory) NewOrchestratorInstanceServiceClient() *OrchestratorInstanceServiceClient {
	subClient, _ := NewOrchestratorInstanceServiceClient(c.subscriptionID, c.credential, c.options)
	return subClient
}
