...
// The returned OperationsServerTransport instance is connected to an instance of armdeploymentmanager.OperationsClient via the
// azcore.ClientOptions.Transporter field in the client's constructor parameters.
func NewOperationsServerTransport(srv *OperationsServer) *OperationsServerTransport {
	return &OperationsServerTransport{srv: srv}
}

// OperationsServerTransport connects instances of armdeploymentmanager.OperationsClient to instances of OperationsServer.
...
func (o *OperationsServerTransport) dispatchList(req *http.Request) (*http.Response, error) {
	...
	resp, err := server.MarshalResponseAsJSON(respContent, server.GetResponse(respr).OperationsList, req)
	if err != nil {
		return nil, err
	}
	return resp, nil
