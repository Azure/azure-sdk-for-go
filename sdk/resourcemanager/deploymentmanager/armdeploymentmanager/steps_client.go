...
func (client *StepsClient) CreateOrUpdate(ctx context.Context, resourceGroupName string, stepName string, stepInfo StepResource, options *StepsClientCreateOrUpdateOptions) (StepsClientCreateOrUpdateResponse, error) {
	req, err := client.createOrUpdateCreateRequest(ctx, resourceGroupName, stepName, stepInfo, options)
	if err != nil {
...
func (client *StepsClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, stepName string, stepInfo StepResource, options *StepsClientCreateOrUpdateOptions) (*policy.Request, error) {
	...
	return req, runtime.MarshalAsJSON(req, stepInfo)
}
