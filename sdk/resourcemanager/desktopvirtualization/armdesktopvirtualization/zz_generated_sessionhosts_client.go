...
func NewSessionHostsClient(subscriptionID string, credential azcore.TokenCredential, options *arm.ClientOptions) *SessionHostsClient {
	...
	return &SessionHostsClient{subscriptionID: subscriptionID, ep: string(cp.Host), pl: armruntime.NewPipeline(module, version, credential, &cp)}
}
...
func (client *SessionHostsClient) Delete(ctx context.Context, resourceGroupName string, hostPoolName string, sessionHostName string, options *SessionHostsDeleteOptions) (SessionHostsDeleteResponse, error) {
	...
	if err != nil {
		return SessionHostsDeleteResponse{}, err
	}
	...
	if !runtime.HasStatusCode(resp, http.StatusOK, http.StatusNoContent) {
		return SessionHostsDeleteResponse{}, client.deleteHandleError(resp)
	}
	return SessionHostsDeleteResponse{RawResponse: resp}, nil
}

// deleteCreateRequest creates the Delete request.
func (client *SessionHostsClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, hostPoolName string, sessionHostName string, options *SessionHostsDeleteOptions) (*policy.Request, error) {
...
func (client *SessionHostsClient) deleteHandleError(resp *http.Response) error {
...
func (client *SessionHostsClient) Get(ctx context.Context, resourceGroupName string, hostPoolName string, sessionHostName string, options *SessionHostsGetOptions) (SessionHostsGetResponse, error) {
	...
	if err != nil {
		return SessionHostsGetResponse{}, err
	}
	resp, err := client.pl.Do(req)
	if err != nil {
		return SessionHostsGetResponse{}, err
	...
	if !runtime.HasStatusCode(resp, http.StatusOK) {
		return SessionHostsGetResponse{}, client.getHandleError(resp)
	}
	return client.getHandleResponse(resp)
}

// getCreateRequest creates the Get request.
func (client *SessionHostsClient) getCreateRequest(ctx context.Context, resourceGroupName string, hostPoolName string, sessionHostName string, options *SessionHostsGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DesktopVirtualization/hostPools/{hostPoolName}/sessionHosts/{sessionHostName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *SessionHostsClient) getHandleResponse(resp *http.Response) (SessionHostsGetResponse, error) {
	result := SessionHostsGetResponse{RawResponse: resp}
	if err := runtime.UnmarshalAsJSON(resp, &result.SessionHost); err != nil {
		return SessionHostsGetResponse{}, runtime.NewResponseError(err, resp)
	}
	return result, nil
}

// getHandleError handles the Get error response.
func (client *SessionHostsClient) getHandleError(resp *http.Response) error {
	body, err := runtime.Payload(resp)
	if err != nil {
		return runtime.NewResponseError(err, resp)
	}
...
func (client *SessionHostsClient) List(resourceGroupName string, hostPoolName string, options *SessionHostsListOptions) *SessionHostsListPager {
	return &SessionHostsListPager{
		client: client,
		requester: func(ctx context.Context) (*policy.Request, error) {
			return client.listCreateRequest(ctx, resourceGroupName, hostPoolName, options)
		},
		advancer: func(ctx context.Context, resp SessionHostsListResponse) (*policy.Request, error) {
...
func (client *SessionHostsClient) listCreateRequest(ctx context.Context, resourceGroupName string, hostPoolName string, options *SessionHostsListOptions) (*policy.Request, error) {
...
func (client *SessionHostsClient) listHandleResponse(resp *http.Response) (SessionHostsListResponse, error) {
	result := SessionHostsListResponse{RawResponse: resp}
	if err := runtime.UnmarshalAsJSON(resp, &result.SessionHostList); err != nil {
		return SessionHostsListResponse{}, runtime.NewResponseError(err, resp)
	}
	return result, nil
}

// listHandleError handles the List error response.
func (client *SessionHostsClient) listHandleError(resp *http.Response) error {
	body, err := runtime.Payload(resp)
	if err != nil {
		return runtime.NewResponseError(err, resp)
	}
...
func (client *SessionHostsClient) Update(ctx context.Context, resourceGroupName string, hostPoolName string, sessionHostName string, options *SessionHostsUpdateOptions) (SessionHostsUpdateResponse, error) {
	...
	if err != nil {
		return SessionHostsUpdateResponse{}, err
	}
	resp, err := client.pl.Do(req)
	if err != nil {
		return SessionHostsUpdateResponse{}, err
	...
	if !runtime.HasStatusCode(resp, http.StatusOK) {
		return SessionHostsUpdateResponse{}, client.updateHandleError(resp)
	}
	return client.updateHandleResponse(resp)
}

// updateCreateRequest creates the Update request.
func (client *SessionHostsClient) updateCreateRequest(ctx context.Context, resourceGroupName string, hostPoolName string, sessionHostName string, options *SessionHostsUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DesktopVirtualization/hostPools/{hostPoolName}/sessionHosts/{sessionHostName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *SessionHostsClient) updateHandleResponse(resp *http.Response) (SessionHostsUpdateResponse, error) {
	result := SessionHostsUpdateResponse{RawResponse: resp}
	if err := runtime.UnmarshalAsJSON(resp, &result.SessionHost); err != nil {
		return SessionHostsUpdateResponse{}, runtime.NewResponseError(err, resp)
	}
	return result, nil
}

// updateHandleError handles the Update error response.
func (client *SessionHostsClient) updateHandleError(resp *http.Response) error {
	body, err := runtime.Payload(resp)
	if err != nil {
		return runtime.NewResponseError(err, resp)
	}
