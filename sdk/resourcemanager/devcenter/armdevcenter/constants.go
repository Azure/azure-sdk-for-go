...
func PossibleAssignedGroupScopeValues() []AssignedGroupScope {
	return []AssignedGroupScope{
		AssignedGroupScopeDevBox,
	}
}
...
func PossibleCancelOnConnectEnableStatusValues() []CancelOnConnectEnableStatus {
	return []CancelOnConnectEnableStatus{
		CancelOnConnectEnableStatusDisabled,
		CancelOnConnectEnableStatusEnabled,
	}
}

// CatalogAutoImageBuildEnableStatus - Indicates whether auto image build is enabled/disabled for image definitions in the
// catalog.
...
func PossibleCatalogAutoImageBuildEnableStatusValues() []CatalogAutoImageBuildEnableStatus {
	return []CatalogAutoImageBuildEnableStatus{
		CatalogAutoImageBuildEnableStatusDisabled,
		CatalogAutoImageBuildEnableStatusEnabled,
	}
}
...
func PossibleFeatureStateModifiableValues() []FeatureStateModifiable {
	return []FeatureStateModifiable{
		FeatureStateModifiableModifiable,
		FeatureStateModifiableNotModifiable,
	}
}
