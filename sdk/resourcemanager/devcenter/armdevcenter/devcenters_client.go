...
func (client *DevCentersClient) getHandleResponse(resp *http.Response, successCodes ...int) (DevCentersClientGetResponse, error) {
...
func (client *DevCentersClient) listByResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, nextLink string, options *DevCentersClientListByResourceGroupOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *DevCentersClient) listByResourceGroupHandleResponse(resp *http.Response, successCodes ...int) (DevCentersClientListByResourceGroupResponse, error) {
...
func (client *DevCentersClient) listBySubscriptionCreateRequest(ctx context.Context, nextLink string, options *DevCentersClientListBySubscriptionOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
	var req *policy.Request
	var err error
	if firstPage {
...
func (client *DevCentersClient) listBySubscriptionHandleResponse(resp *http.Response, successCodes ...int) (DevCentersClientListBySubscriptionResponse, error) {
