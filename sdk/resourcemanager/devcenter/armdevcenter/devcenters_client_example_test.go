...
func ExampleDevCentersClient_BeginCreateOrUpdate_devCentersCreate() {
	...
	// 			CreatedAt: to.Ptr(time.Date(2020, time.November, 11, 22, 0, 8, 896000000, time.UTC)),
	// 			CreatedBy: to.Ptr("user1"),
	// 			CreatedByType: to.Ptr(armdevcenter.CreatedByTypeUser),
	// 			LastModifiedAt: to.Ptr(time.Date(2020, time.November, 11, 22, 0, 10, 896000000, time.UTC)),
...
func ExampleDevCentersClient_NewListByResourceGroupPager() {
	...
	for pager.More() {
		...
		// 					CreatedByType: to.Ptr(armdevcenter.CreatedByTypeUser),
		// 					LastModifiedAt: to.Ptr(time.Date(2020, time.November, 11, 22, 0, 8, 896000000, time.UTC)),
