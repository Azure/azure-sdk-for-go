...
func (c *CatalogDevBoxDefinitionsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if catalogDevBoxDefinitionsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = catalogDevBoxDefinitionsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to CatalogDevBoxDefinitionsServerTransport
var catalogDevBoxDefinitionsServerTransportInterceptor interface {
