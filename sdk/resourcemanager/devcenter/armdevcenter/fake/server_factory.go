...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "AttachedNetworksClient":
		initServer(&s.trMu, &s.trAttachedNetworksServer, func() *AttachedNetworksServerTransport {
	...
	case "CatalogImageDefinitionBuildClient":
		initServer(&s.trMu, &s.trCatalogImageDefinitionBuildServer, func() *CatalogImageDefinitionBuildServerTransport {
	...
	case "CatalogImageDefinitionBuildsClient":
		initServer(&s.trMu, &s.trCatalogImageDefinitionBuildsServer, func() *CatalogImageDefinitionBuildsServerTransport {
	...
	case "CatalogImageDefinitionsClient":
		initServer(&s.trMu, &s.trCatalogImageDefinitionsServer, func() *CatalogImageDefinitionsServerTransport {
	...
	case "CatalogsClient":
		initServer(&s.trMu, &s.trCatalogsServer, func() *CatalogsServerTransport { return NewCatalogsServerTransport(&s.srv.CatalogsServer) })
	...
	case "CheckScopedNameAvailabilityClient":
		initServer(&s.trMu, &s.trCheckScopedNameAvailabilityServer, func() *CheckScopedNameAvailabilityServerTransport {
	...
	case "CustomizationTasksClient":
		initServer(&s.trMu, &s.trCustomizationTasksServer, func() *CustomizationTasksServerTransport {
	...
	case "DevBoxDefinitionsClient":
		initServer(&s.trMu, &s.trDevBoxDefinitionsServer, func() *DevBoxDefinitionsServerTransport {
	...
	case "DevCentersClient":
		initServer(&s.trMu, &s.trDevCentersServer, func() *DevCentersServerTransport { return NewDevCentersServerTransport(&s.srv.DevCentersServer) })
		resp, err = s.trDevCentersServer.Do(req)
	case "EncryptionSetsClient":
		initServer(&s.trMu, &s.trEncryptionSetsServer, func() *EncryptionSetsServerTransport {
	...
	case "EnvironmentDefinitionsClient":
		initServer(&s.trMu, &s.trEnvironmentDefinitionsServer, func() *EnvironmentDefinitionsServerTransport {
	...
	case "EnvironmentTypesClient":
		initServer(&s.trMu, &s.trEnvironmentTypesServer, func() *EnvironmentTypesServerTransport {
	...
	case "NetworkConnectionsClient":
		initServer(&s.trMu, &s.trNetworkConnectionsServer, func() *NetworkConnectionsServerTransport {
	...
	case "ProjectAllowedEnvironmentTypesClient":
		initServer(&s.trMu, &s.trProjectAllowedEnvironmentTypesServer, func() *ProjectAllowedEnvironmentTypesServerTransport {
	...
	case "ProjectCatalogEnvironmentDefinitionsClient":
		initServer(&s.trMu, &s.trProjectCatalogEnvironmentDefinitionsServer, func() *ProjectCatalogEnvironmentDefinitionsServerTransport {
	...
	case "ProjectCatalogImageDefinitionBuildClient":
		initServer(&s.trMu, &s.trProjectCatalogImageDefinitionBuildServer, func() *ProjectCatalogImageDefinitionBuildServerTransport {
	...
	case "ProjectCatalogImageDefinitionBuildsClient":
		initServer(&s.trMu, &s.trProjectCatalogImageDefinitionBuildsServer, func() *ProjectCatalogImageDefinitionBuildsServerTransport {
	...
	case "ProjectCatalogImageDefinitionsClient":
		initServer(&s.trMu, &s.trProjectCatalogImageDefinitionsServer, func() *ProjectCatalogImageDefinitionsServerTransport {
	...
	case "ProjectCatalogsClient":
		initServer(&s.trMu, &s.trProjectCatalogsServer, func() *ProjectCatalogsServerTransport {
	...
	case "ProjectEnvironmentTypesClient":
		initServer(&s.trMu, &s.trProjectEnvironmentTypesServer, func() *ProjectEnvironmentTypesServerTransport {
	...
	case "ProjectPoliciesClient":
		initServer(&s.trMu, &s.trProjectPoliciesServer, func() *ProjectPoliciesServerTransport {
	...
	case "SchedulesClient":
		initServer(&s.trMu, &s.trSchedulesServer, func() *SchedulesServerTransport { return NewSchedulesServerTransport(&s.srv.SchedulesServer) })
