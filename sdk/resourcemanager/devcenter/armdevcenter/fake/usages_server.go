...
// The returned UsagesServerTransport instance is connected to an instance of armdevcenter.UsagesClient via the
// azcore.ClientOptions.Transporter field in the client's constructor parameters.
func NewUsagesServerTransport(srv *UsagesServer) *UsagesServerTransport {
	return &UsagesServerTransport{
		srv:                    srv,
		newListByLocationPager: newTracker[azfake.PagerResponder[armdevcenter.UsagesClientListByLocationResponse]](),
	}
}

// UsagesServerTransport connects instances of armdevcenter.UsagesClient to instances of UsagesServer.
// Don't use this type directly, use NewUsagesServerTransport instead.
type UsagesServerTransport struct {
	srv                    *UsagesServer
	newListByLocationPager *tracker[azfake.PagerResponder[armdevcenter.UsagesClientListByLocationResponse]]
}
...
func (u *UsagesServerTransport) dispatchNewListByLocationPager(req *http.Request) (*http.Response, error) {
	...
	if newListByLocationPager == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.DevCenter/locations/(?P<location>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/usages`
		...
		server.PagerResponderInjectNextLinks(newListByLocationPager, req, func(page *armdevcenter.UsagesClientListByLocationResponse, createLink func() string) {
