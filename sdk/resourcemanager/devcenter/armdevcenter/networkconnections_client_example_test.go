...
func ExampleNetworkConnectionsClient_BeginCreateOrUpdate() {
	...
	// 			CreatedAt: to.Ptr(time.Date(2020, time.November, 18, 18, 0, 36, 993000000, time.UTC)),
	// 			CreatedBy: to.Ptr("user1"),
	// 			CreatedByType: to.Ptr(armdevcenter.CreatedByTypeUser),
	// 			LastModifiedAt: to.Ptr(time.Date(2020, time.November, 18, 18, 30, 36, 993000000, time.UTC)),
...
func ExampleNetworkConnectionsClient_GetHealthDetails() {
	...
	// 			EndDateTime: to.Ptr(time.Date(2021, time.July, 3, 12, 43, 15, 0, time.UTC)),
	// 			HealthChecks: []*armdevcenter.HealthCheck{
	// 				{
	// 					DisplayName: to.Ptr("Azure AD device sync"),
	// 					EndDateTime: to.Ptr(time.Date(2021, time.July, 3, 12, 43, 14, 0, time.UTC)),
	// 					StartDateTime: to.Ptr(time.Date(2021, time.July, 3, 12, 43, 15, 0, time.UTC)),
	// 					Status: to.Ptr(armdevcenter.HealthCheckStatusPassed),
	// 				},
	// 			},
	// 			StartDateTime: to.Ptr(time.Date(2021, time.July, 3, 12, 43, 14, 0, time.UTC)),
	// 		},
	// 		SystemData: &armdevcenter.SystemData{
	// 			CreatedAt: to.Ptr(time.Date(2020, time.November, 18, 18, 0, 36, 993000000, time.UTC)),
