...
func (client *UsagesClient) listByLocationCreateRequest(ctx context.Context, location string, nextLink string, _ *UsagesClientListByLocationOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *UsagesClient) listByLocationHandleResponse(resp *http.Response, successCodes ...int) (UsagesClientListByLocationResponse, error) {
