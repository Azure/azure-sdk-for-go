...
type OperationsServer struct {
	...
	List func(ctx context.Context, options *armdevhub.OperationsClientListOptions) (resp azfake.Responder[armdevhub.OperationsClientListResponse], errResp azfake.ErrorResponder)
}

// NewOperationsServerTransport creates a new instance of OperationsServerTransport with the provided implementation.
// The returned OperationsServerTransport instance is connected to an instance of armdevhub.OperationsClient via the
// azcore.ClientOptions.Transporter field in the client's constructor parameters.
func NewOperationsServerTransport(srv *OperationsServer) *OperationsServerTransport {
	return &OperationsServerTransport{srv: srv}
}

// OperationsServerTransport connects instances of armdevhub.OperationsClient to instances of OperationsServer.
