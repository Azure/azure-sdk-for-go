...
func ExampleIacProfilesClient_CreateOrUpdate() {
	...
	// 			LastModifiedAt: to.Ptr(time.Date(2024, time.January, 16, 9, 56, 30, 783361300, time.UTC)),
...
func ExampleIacProfilesClient_NewListPager() {
	...
	for pager.More() {
		...
		// 					CreatedBy: to.Ptr(""),
		// 					CreatedByType: to.Ptr(armdevhub.CreatedByTypeUser),
		// 					LastModifiedAt: to.Ptr(time.Date(2024, time.January, 16, 14, 32, 0, 783994200, time.UTC)),
		// 					LastModifiedBy: to.Ptr("aks-dev-hub-devhub"),
		// 					LastModifiedByType: to.Ptr(armdevhub.CreatedByTypeApplication),
		// 				},
		// 				Tags: map[string]*string{
