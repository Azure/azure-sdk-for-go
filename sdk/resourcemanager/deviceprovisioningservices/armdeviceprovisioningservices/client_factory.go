...
func (c *ClientFactory) NewDpsCertificateClient() *DpsCertificateClient {
	subClient, _ := NewDpsCertificateClient(c.subscriptionID, c.credential, c.options)
	return subClient
}
...
func (c *ClientFactory) NewIotDpsResourceClient() *IotDpsResourceClient {
	subClient, _ := NewIotDpsResourceClient(c.subscriptionID, c.credential, c.options)
	return subClient
}
