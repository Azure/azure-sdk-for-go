...
// Generated from example definition: https://github.com/Azure/azure-rest-api-specs/blob/ab04533261eff228f28e08900445d0edef3eb70c/specification/deviceregistry/resource-manager/Microsoft.DeviceRegistry/stable/2024-11-01/examples/List_BillingContainers_Subscription.json
func ExampleBillingContainersClient_NewListBySubscriptionPager() {
	...
	for pager.More() {
		...
		// page.BillingContainerListResult = armdeviceregistry.BillingContainerListResult{
		...
		// 				CreatedAt: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2024-05-01T22:52:46.016Z"); return t}()),
		// 				CreatedBy: to.Ptr("0e1b4448-67b9-46a1-8158-e3dade4c008e"),
		// 				CreatedByType: to.Ptr(armdeviceregistry.CreatedByTypeApplication),
		// 				LastModifiedAt: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2024-05-01T22:52:46.016Z"); return t}()),
		...
		// 			SystemData: &armdeviceregistry.SystemData{
		// 				CreatedAt: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2024-05-01T23:58:23.321Z"); return t}()),
		// 				CreatedBy: to.Ptr("0e1b4448-67b9-46a1-8158-e3dade4c008e"),
		// 				CreatedByType: to.Ptr(armdeviceregistry.CreatedByTypeApplication),
		// 				LastModifiedAt: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2024-05-01T23:58:23.321Z"); return t}()),
		// 				LastModifiedBy: to.Ptr("0e1b4448-67b9-46a1-8158-e3dade4c008e"),
		// 				LastModifiedByType: to.Ptr(armdeviceregistry.CreatedByTypeApplication),
		// 			},
...
// Generated from example definition: https://github.com/Azure/azure-rest-api-specs/blob/ab04533261eff228f28e08900445d0edef3eb70c/specification/deviceregistry/resource-manager/Microsoft.DeviceRegistry/stable/2024-11-01/examples/Get_BillingContainer.json
func ExampleBillingContainersClient_Get() {
	...
	// res.BillingContainer = armdeviceregistry.BillingContainer{
	...
	// 	SystemData: &armdeviceregistry.SystemData{
	// 		CreatedAt: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2024-05-20T21:51:21.169Z"); return t}()),
	// 		CreatedBy: to.Ptr("0e1b4448-67b9-46a1-8158-e3dade4c008e"),
	// 		CreatedByType: to.Ptr(armdeviceregistry.CreatedByTypeApplication),
	// 		LastModifiedAt: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2024-06-18T20:37:41.937Z"); return t}()),
	// 		LastModifiedBy: to.Ptr("0e1b4448-67b9-46a1-8158-e3dade4c008e"),
	// 		LastModifiedByType: to.Ptr(armdeviceregistry.CreatedByTypeApplication),
	// 	},
