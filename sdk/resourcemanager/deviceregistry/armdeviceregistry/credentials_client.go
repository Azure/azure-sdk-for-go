...
func (client *CredentialsClient) getHandleResponse(resp *http.Response, successCodes ...int) (CredentialsClientGetResponse, error) {
...
func (client *CredentialsClient) listByResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, namespaceName string, nextLink string, _ *CredentialsClientListByResourceGroupOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *CredentialsClient) listByResourceGroupHandleResponse(resp *http.Response, successCodes ...int) (CredentialsClientListByResourceGroupResponse, error) {
