...
type NamespaceDiscoveredAsset struct {
	...
	// READ-ONLY; The name of the discovered asset.
	Name *string
...
type NamespaceDiscoveredDevice struct {
	...
	// READ-ONLY; The name of the discovered device.
	Name *string
...
// NamespaceDiscoveredEventDataPoint - Defines the discovered event data point properties.
...
// NamespaceEventDataPoint - Defines the event data point properties.
...
type Schema struct {
	...
	// READ-ONLY; Schema name parameter.
	Name *string
...
type SchemaRegistry struct {
	...
	// READ-ONLY; Schema registry name parameter.
	Name *string
...
type SchemaVersion struct {
	...
	// READ-ONLY; Schema version name parameter.
	Name *string
