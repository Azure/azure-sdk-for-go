...
// ActivateBringYourOwnRootRequest - Request payload for activating a Bring Your Own Root policy with a customer-provided
// signed certificate.
type ActivateBringYourOwnRootRequest struct {
	// REQUIRED; Certificate chain in PEM format, including the signed certificate. The first certificate must be the signed certificate
...
// BringYourOwnRoot - Configuration for Bring Your Own Root. When enabled, customers provide their own CA-signed certificates
// instead of using the service-managed CA.
type BringYourOwnRoot struct {
	// REQUIRED; Indicates whether Bring Your Own Root is enabled. This can only be set at creation time and cannot be changed
	// afterward.
	Enabled *bool

	// READ-ONLY; Certificate Signing Request (CSR) in PEM format, generated by the service. Sign this CSR with your Certificate
	// Authority and activate via the activateBringYourOwnRoot action. A new CSR is generated at policy creation and when certificates
	// near expiration.
	CertificateSigningRequest *string

	// READ-ONLY; Thumbprint of the issuing certificate.
	IssuingCertificateThumbprint *string

	// READ-ONLY; The status of the Bring Your Own Root configuration, indicating the current state of the certificate lifecycle.
...
// CertificateConfiguration - The certificate configuration.
...
// Credential - A Credential Resource
...
// CredentialListResult - The response of a Credential list operation.
type CredentialListResult struct {
	// REQUIRED; The Credential items on this page
	Value []*Credential
...
// CredentialProperties - Details of the Credential Resource.
type CredentialProperties struct {
	// READ-ONLY; The status of the last operation.
	ProvisioningState *ProvisioningState
}

// CredentialUpdate - The type used for update operations of the Credential.
...
// DeviceCredentialPolicy - Defines the Policy used to issue device certificates if any.
type DeviceCredentialPolicy struct {
	// Resource Id of the Policy.
	ResourceID *string
}

// DeviceCredentialsRevokeRequest - Request payload for revoking device credentials.
type DeviceCredentialsRevokeRequest struct {
...
// PolicyListResult - The response of a Policy list operation.
...
// PolicyProperties - Details of the Credential Policy.
...
// PolicyUpdate - The type used for update operations of the Policy.
type PolicyUpdate struct {
	// The resource-specific properties for this resource.
	Properties *PolicyUpdateProperties
}

// PolicyUpdateProperties - The updatable properties of the Policy.
