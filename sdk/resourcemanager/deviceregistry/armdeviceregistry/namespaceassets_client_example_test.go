...
// Generated from example definition: 2025-07-01-preview/CreateOrReplace_NamespaceAsset.json
func ExampleNamespaceAssetsClient_BeginCreateOrReplace() {
	...
	poller, err := clientFactory.NewNamespaceAssetsClient().BeginCreateOrReplace(ctx, "myResourceGroup", "my-namespace-1", "my-asset-1", armdeviceregistry.NamespaceAsset{
		...
		Properties: &armdeviceregistry.NamespaceAssetProperties{
			...
			Events: []*armdeviceregistry.NamespaceEvent{
				{
					Name:               to.Ptr("event1"),
					EventNotifier:      to.Ptr("nsu=http://microsoft.com/Opc/OpcPlc/;s=FastUInt5"),
					...
					DataPoints: []*armdeviceregistry.NamespaceEventDataPoint{
						{
							Name:                   to.Ptr("event1DataPoint1"),
							DataSource:             to.Ptr("nsu=http://microsoft.com/Opc/OpcPlc/;s=FastUInt6"),
							DataPointConfiguration: to.Ptr("{\"publishingInterval\":8,\"samplingInterval\":8,\"queueSize\":4}"),
						},
						{
							Name:                   to.Ptr("event1DataPoint2"),
				...
				{
					Name:               to.Ptr("event2"),
					EventNotifier:      to.Ptr("nsu=http://microsoft.com/Opc/OpcPlc/;s=FastUInt8"),
					EventConfiguration: to.Ptr("{\"publishingInterval\":7,\"samplingInterval\":1,\"queueSize\":8}"),
					Destinations: []armdeviceregistry.EventDestinationClassification{
						&armdeviceregistry.EventStorageDestination{
							Target: to.Ptr(armdeviceregistry.EventDestinationTargetStorage),
					...
					DataPoints: []*armdeviceregistry.NamespaceEventDataPoint{
						{
							Name:                   to.Ptr("event2DataPoint1"),
							DataSource:             to.Ptr("nsu=http://microsoft.com/Opc/OpcPlc/;s=FastUInt9"),
							DataPointConfiguration: to.Ptr("{\"publishingInterval\":8,\"samplingInterval\":8,\"queueSize\":4}"),
						},
						{
							Name:                   to.Ptr("event2DataPoint2"),
	...
	// 				{
	// 					Name: to.Ptr("event2"),
	// 					EventNotifier: to.Ptr("nsu=http://microsoft.com/Opc/OpcPlc/;s=FastUInt7"),
	// 					EventConfiguration: to.Ptr("{\"publishingInterval\":7,\"samplingInterval\":1,\"queueSize\":8}"),
	// 					Destinations: []armdeviceregistry.EventDestinationClassification{
	// 						&armdeviceregistry.EventStorageDestination{
	// 							Target: to.Ptr(armdeviceregistry.EventDestinationTargetStorage),
...
// Generated from example definition: 2025-07-01-preview/Delete_NamespaceAsset.json
...
// Generated from example definition: 2025-07-01-preview/Get_NamespaceAsset.json
...
// Generated from example definition: 2025-07-01-preview/List_NamespaceAssets_ByResourceGroup.json
...
// Generated from example definition: 2025-07-01-preview/Update_NamespaceAsset.json
