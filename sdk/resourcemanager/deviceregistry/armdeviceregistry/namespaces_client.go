...
func (client *NamespacesClient) listBySubscriptionCreateRequest(ctx context.Context, nextLink string, _ *NamespacesClientListBySubscriptionOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
	var req *policy.Request
	var err error
	if firstPage {
