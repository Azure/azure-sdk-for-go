...
func (client *SchemaRegistriesClient) getHandleResponse(resp *http.Response, successCodes ...int) (SchemaRegistriesClientGetResponse, error) {
...
func (client *SchemaRegistriesClient) listByResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, nextLink string, _ *SchemaRegistriesClientListByResourceGroupOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *SchemaRegistriesClient) listByResourceGroupHandleResponse(resp *http.Response, successCodes ...int) (SchemaRegistriesClientListByResourceGroupResponse, error) {
...
func (client *SchemaRegistriesClient) listBySubscriptionCreateRequest(ctx context.Context, nextLink string, _ *SchemaRegistriesClientListBySubscriptionOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
	var req *policy.Request
	var err error
	if firstPage {
...
func (client *SchemaRegistriesClient) listBySubscriptionHandleResponse(resp *http.Response, successCodes ...int) (SchemaRegistriesClientListBySubscriptionResponse, error) {
