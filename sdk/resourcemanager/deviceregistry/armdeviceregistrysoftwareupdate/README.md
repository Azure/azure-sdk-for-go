...
The `armdeviceregistrysoftwareupdate` module provides operations for working with Azure Deviceregistry.

[Source code](https://github.com/Azure/azure-sdk-for-go/tree/main/sdk/resourcemanager/deviceregistry/armdeviceregistrysoftwareupdate)
...
```sh
go get github.com/Azure/azure-sdk-for-go/sdk/resourcemanager/deviceregistry/armdeviceregistrysoftwareupdate
```
...
```go
clientFactory, err := armdeviceregistrysoftwareupdate.NewClientFactory(<subscription ID>, cred, nil)
```
...
clientFactory, err := armdeviceregistrysoftwareupdate.NewClientFactory(<subscription ID>, cred, &options)
```
...
```go
client := clientFactory.NewUpdateInstancesClient()
```
...
[open an issue](https://github.com/Azure/azure-sdk-for-go/issues) and assign the `Deviceregistry` label.
