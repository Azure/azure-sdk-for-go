...
const (
	...
	// EphemeralTypeNVMeDisk - NVMeDisk ephemeral only, requires that the SKU supports the NVMe DiskControllerType.
	EphemeralTypeNVMeDisk EphemeralType = "NVMeDisk"
