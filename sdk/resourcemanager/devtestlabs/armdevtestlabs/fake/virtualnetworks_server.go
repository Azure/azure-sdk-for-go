...
// The returned VirtualNetworksServerTransport instance is connected to an instance of armdevtestlabs.VirtualNetworksClient via the
...
func NewVirtualNetworksServerTransport(srv *VirtualNetworksServer) *VirtualNetworksServerTransport {
	return &VirtualNetworksServerTransport{
		srv:                 srv,
		beginCreateOrUpdate: newTracker[azfake.PollerResponder[armdevtestlabs.VirtualNetworksClientCreateOrUpdateResponse]](),
		beginDelete:         newTracker[azfake.PollerResponder[armdevtestlabs.VirtualNetworksClientDeleteResponse]](),
		newListPager:        newTracker[azfake.PagerResponder[armdevtestlabs.VirtualNetworksClientListResponse]](),
	}
}

// VirtualNetworksServerTransport connects instances of armdevtestlabs.VirtualNetworksClient to instances of VirtualNetworksServer.
...
type VirtualNetworksServerTransport struct {
	...
	beginCreateOrUpdate *tracker[azfake.PollerResponder[armdevtestlabs.VirtualNetworksClientCreateOrUpdateResponse]]
	beginDelete         *tracker[azfake.PollerResponder[armdevtestlabs.VirtualNetworksClientDeleteResponse]]
	newListPager        *tracker[azfake.PagerResponder[armdevtestlabs.VirtualNetworksClientListResponse]]
}
...
func (v *VirtualNetworksServerTransport) dispatchBeginCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginCreateOrUpdate == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.DevTestLab/labs/(?P<labName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/virtualnetworks/(?P<name>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if matches == nil || len(matches) < 4 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
		}
		body, err := server.UnmarshalRequestAsJSON[armdevtestlabs.VirtualNetwork](req)
		if err != nil {
			return nil, err
		}
...
func (v *VirtualNetworksServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	var options *armdevtestlabs.VirtualNetworksClientGetOptions
	if expandParam != nil {
		options = &armdevtestlabs.VirtualNetworksClientGetOptions{
			Expand: expandParam,
		}
	}
...
func (v *VirtualNetworksServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.DevTestLab/labs/(?P<labName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/virtualnetworks`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		...
		var options *armdevtestlabs.VirtualNetworksClientListOptions
		if expandParam != nil || filterParam != nil || topParam != nil || orderbyParam != nil {
			options = &armdevtestlabs.VirtualNetworksClientListOptions{
				Expand:  expandParam,
				Filter:  filterParam,
				Top:     topParam,
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armdevtestlabs.VirtualNetworksClientListResponse, createLink func() string) {
...
func (v *VirtualNetworksServerTransport) dispatchUpdate(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[armdevtestlabs.VirtualNetworkFragment](req)
	if err != nil {
		return nil, err
	}
	resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
