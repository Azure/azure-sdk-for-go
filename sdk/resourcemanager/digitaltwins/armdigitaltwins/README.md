...
Azure Digital Twins modules consist of one or more clients.  We provide a client factory which could be used to create any client in this module.
...
client, err := armdigitaltwins.NewClientFactory(<subscription ID>, cred, &options)
```
...
[open an issue](https://github.com/Azure/azure-sdk-for-go/issues) and assign the `Digital Twins` label.
