...
// ServerFactory is a fake server for instances of the armdisconnectedoperations.ClientFactory type.
...
// The returned ServerFactoryTransport instance is connected to an instance of armdisconnectedoperations.ClientFactory via the
...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "HardwareSettingsClient":
		initServer(s, &s.trHardwareSettingsServer, func() *HardwareSettingsServerTransport {
