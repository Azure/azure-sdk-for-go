...
func (a AzureNetAppFilesStore) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "mountProtocol", a.MountProtocol)
...
func (a *AzureNetAppFilesStore) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "kind":
			...
			delete(rawMsg, key)
		case "mountProtocol":
			err = unpopulate(val, "MountProtocol", &a.MountProtocol)
			delete(rawMsg, key)
		case "netAppVolumeId":
...
func (c ChatModelDeploymentProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "modelVersion", c.ModelVersion)
...
func (c *ChatModelDeploymentProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "modelName":
			...
			delete(rawMsg, key)
		case "modelVersion":
			err = unpopulate(val, "ModelVersion", &c.ModelVersion)
			delete(rawMsg, key)
		case "provisioningState":
...
func (n NodePoolProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "imageCacheLowerThreshold", n.ImageCacheLowerThreshold)
	populate(objectMap, "imageCacheUpperThreshold", n.ImageCacheUpperThreshold)
	populate(objectMap, "maxNodeCount", n.MaxNodeCount)
	populate(objectMap, "minNodeCount", n.MinNodeCount)
	populate(objectMap, "osDiskSizeGb", n.OSDiskSizeGb)
...
func (n *NodePoolProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		var err error
		switch key {
		case "imageCacheLowerThreshold":
			err = unpopulate(val, "ImageCacheLowerThreshold", &n.ImageCacheLowerThreshold)
			delete(rawMsg, key)
		case "imageCacheUpperThreshold":
			err = unpopulate(val, "ImageCacheUpperThreshold", &n.ImageCacheUpperThreshold)
			delete(rawMsg, key)
		case "maxNodeCount":
		...
		case "minNodeCount":
			...
			delete(rawMsg, key)
		case "osDiskSizeGb":
			err = unpopulate(val, "OSDiskSizeGb", &n.OSDiskSizeGb)
			delete(rawMsg, key)
		case "provisioningState":
