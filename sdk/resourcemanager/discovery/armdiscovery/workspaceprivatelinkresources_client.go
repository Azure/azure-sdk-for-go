...
func (client *WorkspacePrivateLinkResourcesClient) getHandleResponse(resp *http.Response, successCodes ...int) (WorkspacePrivateLinkResourcesClientGetResponse, error) {
...
func (client *WorkspacePrivateLinkResourcesClient) listByWorkspaceCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, nextLink string, _ *WorkspacePrivateLinkResourcesClientListByWorkspaceOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *WorkspacePrivateLinkResourcesClient) listByWorkspaceHandleResponse(resp *http.Response, successCodes ...int) (WorkspacePrivateLinkResourcesClientListByWorkspaceResponse, error) {
