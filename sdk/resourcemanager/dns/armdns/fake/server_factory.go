...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "ResourceReferenceClient":
		initServer(s, &s.trResourceReferenceServer, func() *ResourceReferenceServerTransport {
			return NewResourceReferenceServerTransport(&s.srv.ResourceReferenceServer)
		})
		resp, err = s.trResourceReferenceServer.Do(req)
	case "ZonesClient":
		initServer(s, &s.trZonesServer, func() *ZonesServerTransport { return NewZonesServerTransport(&s.srv.ZonesServer) })
