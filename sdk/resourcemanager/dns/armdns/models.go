...
// DnssecConfigListResult - The response of a DnssecConfig list operation.
type DnssecConfigListResult struct {
	// REQUIRED; The DnssecConfig items on this page
	Value []*DnssecConfig
...
type NaptrRecord struct {
	...
	// phone system might use a regular expression to convert a phone number that is entered by a user into a SIP URI. Enclose
	...
	// a DNS query for. The DDDS application replaces the input value with the value specified for replacement. Specify either
	// a value for 'regexp' or a value for 'replacement'. If you specify a value for 'regexp', specify a dot (.) for 'replacement'.
	Replacement *string
...
// ZoneListResult - The response of a Zone list operation.
type ZoneListResult struct {
	// REQUIRED; The Zone items on this page
	Value []*Zone
