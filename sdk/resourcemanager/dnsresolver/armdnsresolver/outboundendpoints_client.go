...
func (client *OutboundEndpointsClient) getHandleResponse(resp *http.Response, successCodes ...int) (OutboundEndpointsClientGetResponse, error) {
...
func (client *OutboundEndpointsClient) listCreateRequest(ctx context.Context, resourceGroupName string, dnsResolverName string, nextLink string, options *OutboundEndpointsClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *OutboundEndpointsClient) listHandleResponse(resp *http.Response, successCodes ...int) (OutboundEndpointsClientListResponse, error) {
