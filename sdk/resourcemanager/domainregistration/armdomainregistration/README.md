...
clientFactory, err := armdomainregistration.NewClientFactory(<subscription ID>, cred, &options)
```
...
[open an issue](https://github.com/Azure/azure-sdk-for-go/issues) and assign the `Domainregistration` label.
