...
// DomainsServer is a fake server for instances of the armdomainregistration.DomainsClient type.
type DomainsServer struct {
	// CheckAvailability is the fake for method DomainsClient.CheckAvailability
	// HTTP status codes to indicate success: http.StatusOK
	CheckAvailability func(ctx context.Context, identifier armdomainregistration.NameIdentifier, options *armdomainregistration.DomainsClientCheckAvailabilityOptions) (resp azfake.Responder[armdomainregistration.DomainsClientCheckAvailabilityResponse], errResp azfake.ErrorResponder)
	...
	// HTTP status codes to indicate success: http.StatusOK
	CreateOrUpdateOwnershipIdentifier func(ctx context.Context, resourceGroupName string, domainName string, name string, domainOwnershipIdentifier armdomainregistration.DomainOwnershipIdentifier, options *armdomainregistration.DomainsClientCreateOrUpdateOwnershipIdentifierOptions) (resp azfake.Responder[armdomainregistration.DomainsClientCreateOrUpdateOwnershipIdentifierResponse], errResp azfake.ErrorResponder)

	// Delete is the fake for method DomainsClient.Delete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	Delete func(ctx context.Context, resourceGroupName string, domainName string, options *armdomainregistration.DomainsClientDeleteOptions) (resp azfake.Responder[armdomainregistration.DomainsClientDeleteResponse], errResp azfake.ErrorResponder)

	// DeleteOwnershipIdentifier is the fake for method DomainsClient.DeleteOwnershipIdentifier
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	DeleteOwnershipIdentifier func(ctx context.Context, resourceGroupName string, domainName string, name string, options *armdomainregistration.DomainsClientDeleteOwnershipIdentifierOptions) (resp azfake.Responder[armdomainregistration.DomainsClientDeleteOwnershipIdentifierResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method DomainsClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, domainName string, options *armdomainregistration.DomainsClientGetOptions) (resp azfake.Responder[armdomainregistration.DomainsClientGetResponse], errResp azfake.ErrorResponder)

	// GetControlCenterSsoRequest is the fake for method DomainsClient.GetControlCenterSsoRequest
	// HTTP status codes to indicate success: http.StatusOK
	GetControlCenterSsoRequest func(ctx context.Context, options *armdomainregistration.DomainsClientGetControlCenterSsoRequestOptions) (resp azfake.Responder[armdomainregistration.DomainsClientGetControlCenterSsoRequestResponse], errResp azfake.ErrorResponder)

	// GetOwnershipIdentifier is the fake for method DomainsClient.GetOwnershipIdentifier
	// HTTP status codes to indicate success: http.StatusOK
	GetOwnershipIdentifier func(ctx context.Context, resourceGroupName string, domainName string, name string, options *armdomainregistration.DomainsClientGetOwnershipIdentifierOptions) (resp azfake.Responder[armdomainregistration.DomainsClientGetOwnershipIdentifierResponse], errResp azfake.ErrorResponder)

	// NewListPager is the fake for method DomainsClient.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager func(options *armdomainregistration.DomainsClientListOptions) (resp azfake.PagerResponder[armdomainregistration.DomainsClientListResponse])

	// NewListByResourceGroupPager is the fake for method DomainsClient.NewListByResourceGroupPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByResourceGroupPager func(resourceGroupName string, options *armdomainregistration.DomainsClientListByResourceGroupOptions) (resp azfake.PagerResponder[armdomainregistration.DomainsClientListByResourceGroupResponse])

	// NewListOwnershipIdentifiersPager is the fake for method DomainsClient.NewListOwnershipIdentifiersPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListOwnershipIdentifiersPager func(resourceGroupName string, domainName string, options *armdomainregistration.DomainsClientListOwnershipIdentifiersOptions) (resp azfake.PagerResponder[armdomainregistration.DomainsClientListOwnershipIdentifiersResponse])

	// NewListRecommendationsPager is the fake for method DomainsClient.NewListRecommendationsPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListRecommendationsPager func(parameters armdomainregistration.DomainRecommendationSearchParameters, options *armdomainregistration.DomainsClientListRecommendationsOptions) (resp azfake.PagerResponder[armdomainregistration.DomainsClientListRecommendationsResponse])

	// Renew is the fake for method DomainsClient.Renew
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	Renew func(ctx context.Context, resourceGroupName string, domainName string, options *armdomainregistration.DomainsClientRenewOptions) (resp azfake.Responder[armdomainregistration.DomainsClientRenewResponse], errResp azfake.ErrorResponder)

	// TransferOut is the fake for method DomainsClient.TransferOut
	// HTTP status codes to indicate success: http.StatusOK
	TransferOut func(ctx context.Context, resourceGroupName string, domainName string, options *armdomainregistration.DomainsClientTransferOutOptions) (resp azfake.Responder[armdomainregistration.DomainsClientTransferOutResponse], errResp azfake.ErrorResponder)

	// Update is the fake for method DomainsClient.Update
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	Update func(ctx context.Context, resourceGroupName string, domainName string, domain armdomainregistration.DomainPatchResource, options *armdomainregistration.DomainsClientUpdateOptions) (resp azfake.Responder[armdomainregistration.DomainsClientUpdateResponse], errResp azfake.ErrorResponder)

	// UpdateOwnershipIdentifier is the fake for method DomainsClient.UpdateOwnershipIdentifier
	// HTTP status codes to indicate success: http.StatusOK
	UpdateOwnershipIdentifier func(ctx context.Context, resourceGroupName string, domainName string, name string, domainOwnershipIdentifier armdomainregistration.DomainOwnershipIdentifier, options *armdomainregistration.DomainsClientUpdateOwnershipIdentifierOptions) (resp azfake.Responder[armdomainregistration.DomainsClientUpdateOwnershipIdentifierResponse], errResp azfake.ErrorResponder)
}

// NewDomainsServerTransport creates a new instance of DomainsServerTransport with the provided implementation.
// The returned DomainsServerTransport instance is connected to an instance of armdomainregistration.DomainsClient via the
// azcore.ClientOptions.Transporter field in the client's constructor parameters.
func NewDomainsServerTransport(srv *DomainsServer) *DomainsServerTransport {
	return &DomainsServerTransport{
		srv:                              srv,
		beginCreateOrUpdate:              newTracker[azfake.PollerResponder[armdomainregistration.DomainsClientCreateOrUpdateResponse]](),
		newListPager:                     newTracker[azfake.PagerResponder[armdomainregistration.DomainsClientListResponse]](),
		newListByResourceGroupPager:      newTracker[azfake.PagerResponder[armdomainregistration.DomainsClientListByResourceGroupResponse]](),
		newListOwnershipIdentifiersPager: newTracker[azfake.PagerResponder[armdomainregistration.DomainsClientListOwnershipIdentifiersResponse]](),
		newListRecommendationsPager:      newTracker[azfake.PagerResponder[armdomainregistration.DomainsClientListRecommendationsResponse]](),
	}
}

// DomainsServerTransport connects instances of armdomainregistration.DomainsClient to instances of DomainsServer.
// Don't use this type directly, use NewDomainsServerTransport instead.
type DomainsServerTransport struct {
	srv                              *DomainsServer
	beginCreateOrUpdate              *tracker[azfake.PollerResponder[armdomainregistration.DomainsClientCreateOrUpdateResponse]]
	newListPager                     *tracker[azfake.PagerResponder[armdomainregistration.DomainsClientListResponse]]
	newListByResourceGroupPager      *tracker[azfake.PagerResponder[armdomainregistration.DomainsClientListByResourceGroupResponse]]
	newListOwnershipIdentifiersPager *tracker[azfake.PagerResponder[armdomainregistration.DomainsClientListOwnershipIdentifiersResponse]]
	newListRecommendationsPager      *tracker[azfake.PagerResponder[armdomainregistration.DomainsClientListRecommendationsResponse]]
}
...
func (d *DomainsServerTransport) dispatchCheckAvailability(req *http.Request) (*http.Response, error) {
	...
	const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.DomainRegistration/checkDomainAvailability`
	regex := regexp.MustCompile(regexStr)
	matches := regex.FindStringSubmatch(req.URL.EscapedPath())
	if len(matches) < 2 {
		return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
	}
	body, err := server.UnmarshalRequestAsJSON[armdomainregistration.NameIdentifier](req)
	if err != nil {
		return nil, err
	}
...
func (d *DomainsServerTransport) dispatchBeginCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginCreateOrUpdate == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.DomainRegistration/domains/(?P<domainName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 4 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
		}
		body, err := server.UnmarshalRequestAsJSON[armdomainregistration.Domain](req)
		if err != nil {
			return nil, err
		}
...
func (d *DomainsServerTransport) dispatchCreateOrUpdateOwnershipIdentifier(req *http.Request) (*http.Response, error) {
	...
	const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.DomainRegistration/domains/(?P<domainName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/domainOwnershipIdentifiers/(?P<name>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)`
	regex := regexp.MustCompile(regexStr)
	matches := regex.FindStringSubmatch(req.URL.EscapedPath())
	if len(matches) < 5 {
		return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
	}
	body, err := server.UnmarshalRequestAsJSON[armdomainregistration.DomainOwnershipIdentifier](req)
	if err != nil {
		return nil, err
	}
	resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
...
func (d *DomainsServerTransport) dispatchDelete(req *http.Request) (*http.Response, error) {
	...
	forceHardDeleteDomainParam, err := parseOptional(qp.Get("forceHardDeleteDomain"), strconv.ParseBool)
	if err != nil {
		return nil, err
	}
	var options *armdomainregistration.DomainsClientDeleteOptions
	if forceHardDeleteDomainParam != nil {
		options = &armdomainregistration.DomainsClientDeleteOptions{
...
func (d *DomainsServerTransport) dispatchGetControlCenterSsoRequest(req *http.Request) (*http.Response, error) {
	...
	const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.DomainRegistration/generateSsoRequest`
	regex := regexp.MustCompile(regexStr)
	matches := regex.FindStringSubmatch(req.URL.EscapedPath())
	if len(matches) < 2 {
		return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
...
func (d *DomainsServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.DomainRegistration/domains`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 2 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armdomainregistration.DomainsClientListResponse, createLink func() string) {
...
func (d *DomainsServerTransport) dispatchNewListByResourceGroupPager(req *http.Request) (*http.Response, error) {
	...
	if newListByResourceGroupPager == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.DomainRegistration/domains`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 3 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
		...
		server.PagerResponderInjectNextLinks(newListByResourceGroupPager, req, func(page *armdomainregistration.DomainsClientListByResourceGroupResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
...
func (d *DomainsServerTransport) dispatchNewListOwnershipIdentifiersPager(req *http.Request) (*http.Response, error) {
	...
	if newListOwnershipIdentifiersPager == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.DomainRegistration/domains/(?P<domainName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/domainOwnershipIdentifiers`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 4 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
		...
		server.PagerResponderInjectNextLinks(newListOwnershipIdentifiersPager, req, func(page *armdomainregistration.DomainsClientListOwnershipIdentifiersResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
...
func (d *DomainsServerTransport) dispatchNewListRecommendationsPager(req *http.Request) (*http.Response, error) {
	...
	if newListRecommendationsPager == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.DomainRegistration/listDomainRecommendations`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 2 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
		}
		body, err := server.UnmarshalRequestAsJSON[armdomainregistration.DomainRecommendationSearchParameters](req)
		if err != nil {
			return nil, err
		}
		...
		server.PagerResponderInjectNextLinks(newListRecommendationsPager, req, func(page *armdomainregistration.DomainsClientListRecommendationsResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
...
func (d *DomainsServerTransport) dispatchRenew(req *http.Request) (*http.Response, error) {
	...
	const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.DomainRegistration/domains/(?P<domainName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/renew`
	regex := regexp.MustCompile(regexStr)
	matches := regex.FindStringSubmatch(req.URL.EscapedPath())
	if len(matches) < 4 {
		return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
...
func (d *DomainsServerTransport) dispatchTransferOut(req *http.Request) (*http.Response, error) {
	...
	const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.DomainRegistration/domains/(?P<domainName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/transferOut`
	regex := regexp.MustCompile(regexStr)
	matches := regex.FindStringSubmatch(req.URL.EscapedPath())
	if len(matches) < 4 {
		return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
...
func (d *DomainsServerTransport) dispatchUpdate(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[armdomainregistration.DomainPatchResource](req)
	if err != nil {
		return nil, err
	}
	resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
