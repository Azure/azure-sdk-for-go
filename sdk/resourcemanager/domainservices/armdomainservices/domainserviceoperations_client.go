...
func (client *DomainServiceOperationsClient) listCreateRequest(ctx context.Context, nextLink string, _ *DomainServiceOperationsClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *DomainServiceOperationsClient) listHandleResponse(resp *http.Response, successCodes ...int) (DomainServiceOperationsClientListResponse, error) {
