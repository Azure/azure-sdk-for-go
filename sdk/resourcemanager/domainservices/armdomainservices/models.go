...
type DomainSecuritySettings struct {
	...
	// in Entra Domain Services is synchronized from the onPremisesSamAccountName attribute in Entra ID
...
// DomainServiceListResult - The list of Domain Services.
...
// OuContainerListResult - The list of OuContainers in DomainService instance.
...
type ReplicaSet struct {
	...
	// the maximum allowed count before further self-resume is denied and support intervention is required.
