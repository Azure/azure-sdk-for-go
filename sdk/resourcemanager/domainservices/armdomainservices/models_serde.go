...
func (c ConfigDiagnostics) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC7231](objectMap, "lastExecuted", c.LastExecuted, false)
...
func (h HealthAlert) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "lastDetected", h.LastDetected, true)
	populate(objectMap, "name", h.Name)
	populateTime[datetime.RFC3339](objectMap, "raised", h.Raised, true)
...
func (h *HealthAlert) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "issue":
			...
			delete(rawMsg, key)
		case "lastDetected":
			err = unpopulateTime[datetime.RFC3339](val, "LastDetected", &h.LastDetected)
			delete(rawMsg, key)
		case "name":
			err = unpopulate(val, "Name", &h.Name)
			delete(rawMsg, key)
		case "raised":
			err = unpopulateTime[datetime.RFC3339](val, "Raised", &h.Raised)
			delete(rawMsg, key)
		case "resolutionUri":
...
func (l LdapsSettings) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateTime[datetime.RFC3339](objectMap, "certificateNotAfter", l.CertificateNotAfter, true)
...
func (l *LdapsSettings) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "certificateNotAfter":
			err = unpopulateTime[datetime.RFC3339](val, "CertificateNotAfter", &l.CertificateNotAfter)
			delete(rawMsg, key)
...
func (r ReplicaSet) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC7231](objectMap, "healthLastEvaluated", r.HealthLastEvaluated, false)
