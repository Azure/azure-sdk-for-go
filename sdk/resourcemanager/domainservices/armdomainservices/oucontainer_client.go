...
// BeginCreate - Create OuContainer
//
...
// BeginDelete - Delete OuContainer
//
...
// Get - Get particular OuContainer in DomainService instance
//
...
func (client *OuContainerClient) getHandleResponse(resp *http.Response, successCodes ...int) (OuContainerClientGetResponse, error) {
...
// NewListPager - List of OuContainers in DomainService instance
//
...
func (client *OuContainerClient) NewListPager(resourceGroupName string, domainServiceName string, options *OuContainerClientListOptions) *runtime.Pager[OuContainerClientListResponse] {
	return runtime.NewPager(runtime.PagingHandler[OuContainerClientListResponse]{
		...
		Fetcher: func(ctx context.Context, page *OuContainerClientListResponse) (OuContainerClientListResponse, error) {
			...
			req, err := client.listCreateRequest(ctx, resourceGroupName, domainServiceName, nextLink, options)
			if err != nil {
...
func (client *OuContainerClient) listCreateRequest(ctx context.Context, resourceGroupName string, domainServiceName string, nextLink string, _ *OuContainerClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *OuContainerClient) listHandleResponse(resp *http.Response, successCodes ...int) (OuContainerClientListResponse, error) {
...
// BeginUpdate - Update OuContainer (PATCH Resource)
//
...
// Update - Update OuContainer (PATCH Resource)
//
// The Update OuContainer operation can be used to update the existing OuContainers.
// If the operation fails it returns an *azcore.ResponseError type.
