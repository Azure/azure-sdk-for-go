...
func (client *RetentionPoliciesClient) getHandleResponse(resp *http.Response, successCodes ...int) (RetentionPoliciesClientGetResponse, error) {
...
func (client *RetentionPoliciesClient) listBySchedulerCreateRequest(ctx context.Context, resourceGroupName string, schedulerName string, nextLink string, _ *RetentionPoliciesClientListBySchedulerOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *RetentionPoliciesClient) listBySchedulerHandleResponse(resp *http.Response, successCodes ...int) (RetentionPoliciesClientListBySchedulerResponse, error) {
