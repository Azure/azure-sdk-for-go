...
// BeginCreateOrUpdate - Add the subscriptions that should be monitored by the Dynatrace monitor resource.
...
//     method.
func (client *MonitoredSubscriptionsClient) BeginCreateOrUpdate(ctx context.Context, resourceGroupName string, monitorName string, body MonitoredSubscriptionProperties, options *MonitoredSubscriptionsClientBeginCreateOrUpdateOptions) (*runtime.Poller[MonitoredSubscriptionsClientCreateOrUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.createOrUpdate(ctx, resourceGroupName, monitorName, body, options)
		if err != nil {
			return nil, err
		}
...
// CreateOrUpdate - Add the subscriptions that should be monitored by the Dynatrace monitor resource.
// If the operation fails it returns an *azcore.ResponseError type.
func (client *MonitoredSubscriptionsClient) createOrUpdate(ctx context.Context, resourceGroupName string, monitorName string, body MonitoredSubscriptionProperties, options *MonitoredSubscriptionsClientBeginCreateOrUpdateOptions) (*http.Response, error) {
	var err error
	const operationName = "MonitoredSubscriptionsClient.BeginCreateOrUpdate"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.createOrUpdateCreateRequest(ctx, resourceGroupName, monitorName, body, options)
	if err != nil {
		return nil, err
	}
...
func (client *MonitoredSubscriptionsClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, monitorName string, body MonitoredSubscriptionProperties, _ *MonitoredSubscriptionsClientBeginCreateOrUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Dynatrace.Observability/monitors/{monitorName}/monitoredSubscriptions/default"
...
// BeginDelete - Updates the subscriptions that are being monitored by the Dynatrace monitor resource
// If the operation fails it returns an *azcore.ResponseError type.
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - monitorName - Monitor resource name
...
//     method.
func (client *MonitoredSubscriptionsClient) BeginDelete(ctx context.Context, resourceGroupName string, monitorName string, options *MonitoredSubscriptionsClientBeginDeleteOptions) (*runtime.Poller[MonitoredSubscriptionsClientDeleteResponse], error) {
	if options == nil || options.ResumeToken == "" {
...
// If the operation fails it returns an *azcore.ResponseError type.
func (client *MonitoredSubscriptionsClient) deleteOperation(ctx context.Context, resourceGroupName string, monitorName string, options *MonitoredSubscriptionsClientBeginDeleteOptions) (*http.Response, error) {
	var err error
...
func (client *MonitoredSubscriptionsClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, monitorName string, _ *MonitoredSubscriptionsClientBeginDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Dynatrace.Observability/monitors/{monitorName}/monitoredSubscriptions/default"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
//     method.
func (client *MonitoredSubscriptionsClient) Get(ctx context.Context, resourceGroupName string, monitorName string, options *MonitoredSubscriptionsClientGetOptions) (MonitoredSubscriptionsClientGetResponse, error) {
	var err error
...
func (client *MonitoredSubscriptionsClient) getCreateRequest(ctx context.Context, resourceGroupName string, monitorName string, _ *MonitoredSubscriptionsClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Dynatrace.Observability/monitors/{monitorName}/monitoredSubscriptions/default"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *MonitoredSubscriptionsClient) getHandleResponse(resp *http.Response, successCodes ...int) (MonitoredSubscriptionsClientGetResponse, error) {
...
// NewListPager - List the subscriptions currently being monitored by the Dynatrace monitor resource.
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - monitorName - Monitor resource name
...
func (client *MonitoredSubscriptionsClient) listCreateRequest(ctx context.Context, resourceGroupName string, monitorName string, nextLink string, _ *MonitoredSubscriptionsClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
	var req *policy.Request
	var err error
	if firstPage {
		urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Dynatrace.Observability/monitors/{monitorName}/monitoredSubscriptions"
		if client.subscriptionID == "" {
			return nil, errors.New("parameter client.subscriptionID cannot be empty")
		}
		urlPath = strings.ReplaceAll(urlPath, "{subscriptionId}", url.PathEscape(client.subscriptionID))
...
func (client *MonitoredSubscriptionsClient) listHandleResponse(resp *http.Response, successCodes ...int) (MonitoredSubscriptionsClientListResponse, error) {
...
// BeginUpdate - Updates the subscriptions that are being monitored by the Dynatrace monitor resource
// If the operation fails it returns an *azcore.ResponseError type.
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - monitorName - Monitor resource name
...
//     method.
func (client *MonitoredSubscriptionsClient) BeginUpdate(ctx context.Context, resourceGroupName string, monitorName string, body MonitoredSubscriptionProperties, options *MonitoredSubscriptionsClientBeginUpdateOptions) (*runtime.Poller[MonitoredSubscriptionsClientUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
...
// If the operation fails it returns an *azcore.ResponseError type.
func (client *MonitoredSubscriptionsClient) update(ctx context.Context, resourceGroupName string, monitorName string, body MonitoredSubscriptionProperties, options *MonitoredSubscriptionsClientBeginUpdateOptions) (*http.Response, error) {
	var err error
...
func (client *MonitoredSubscriptionsClient) updateCreateRequest(ctx context.Context, resourceGroupName string, monitorName string, body MonitoredSubscriptionProperties, _ *MonitoredSubscriptionsClientBeginUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Dynatrace.Observability/monitors/{monitorName}/monitoredSubscriptions/default"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
