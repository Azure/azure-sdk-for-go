...
// Generated from example definition: 2024-04-24/SingleSignOn_CreateOrUpdate_MaximumSet_Gen.json
func ExampleSingleSignOnClient_BeginCreateOrUpdate_singleSignOnCreateOrUpdateMaximumSetGen() {
	...
	// res = armdynatrace.SingleSignOnClientCreateOrUpdateResponse{
	// 	SingleSignOnResource: &armdynatrace.SingleSignOnResource{
	// 		Name: to.Ptr("default"),
...
// Generated from example definition: 2024-04-24/SingleSignOn_CreateOrUpdate_MinimumSet_Gen.json
...
// Generated from example definition: 2024-04-24/SingleSignOn_Get_MaximumSet_Gen.json
func ExampleSingleSignOnClient_Get_singleSignOnGetMaximumSetGen() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armdynatrace.SingleSignOnClientGetResponse{
	// 	SingleSignOnResource: &armdynatrace.SingleSignOnResource{
	// 		Name: to.Ptr("default"),
	// 		Type: to.Ptr("Dynatrace.Observability/monitors"),
	// 		ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/myResourceGroup/providers/Dynatrace.Observability/monitors/myMonitor/singleSignOnConfigurations/default"),
...
// Generated from example definition: 2024-04-24/SingleSignOn_Get_MinimumSet_Gen.json
...
// Generated from example definition: 2024-04-24/SingleSignOn_List_MaximumSet_Gen.json
