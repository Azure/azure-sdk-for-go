...
// BeginAddAttachment - A long-running resource action.
...
//   - options - ClientBeginAddAttachmentOptions contains the optional parameters for the Client.BeginAddAttachment method.
func (client *Client) BeginAddAttachment(ctx context.Context, resourceGroupName string, edgeActionName string, body EdgeActionAttachment, options *ClientBeginAddAttachmentOptions) (*runtime.Poller[ClientAddAttachmentResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.addAttachment(ctx, resourceGroupName, edgeActionName, body, options)
		if err != nil {
			return nil, err
		}
		poller, err := runtime.NewPoller(resp, client.internal.Pipeline(), &runtime.NewPollerOptions[ClientAddAttachmentResponse]{
			Tracer: client.internal.Tracer(),
		})
		return poller, err
	} else {
		return runtime.NewPollerFromResumeToken(options.ResumeToken, client.internal.Pipeline(), &runtime.NewPollerFromResumeTokenOptions[ClientAddAttachmentResponse]{
			Tracer: client.internal.Tracer(),
		})
	}
}

// AddAttachment - A long-running resource action.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2025-09-01-preview
func (client *Client) addAttachment(ctx context.Context, resourceGroupName string, edgeActionName string, body EdgeActionAttachment, options *ClientBeginAddAttachmentOptions) (*http.Response, error) {
	var err error
	const operationName = "Client.BeginAddAttachment"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.addAttachmentCreateRequest(ctx, resourceGroupName, edgeActionName, body, options)
	if err != nil {
		return nil, err
	}
...
// addAttachmentCreateRequest creates the AddAttachment request.
func (client *Client) addAttachmentCreateRequest(ctx context.Context, resourceGroupName string, edgeActionName string, body EdgeActionAttachment, _ *ClientBeginAddAttachmentOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cdn/edgeActions/{edgeActionName}/addAttachment"
...
// BeginDeleteAttachment - A long-running resource action.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2025-09-01-preview
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - edgeActionName - The name of the Edge Action
//   - body - The content of the action request
//   - options - ClientBeginDeleteAttachmentOptions contains the optional parameters for the Client.BeginDeleteAttachment method.
func (client *Client) BeginDeleteAttachment(ctx context.Context, resourceGroupName string, edgeActionName string, body EdgeActionAttachment, options *ClientBeginDeleteAttachmentOptions) (*runtime.Poller[ClientDeleteAttachmentResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.deleteAttachment(ctx, resourceGroupName, edgeActionName, body, options)
		if err != nil {
			return nil, err
		}
		poller, err := runtime.NewPoller(resp, client.internal.Pipeline(), &runtime.NewPollerOptions[ClientDeleteAttachmentResponse]{
			Tracer: client.internal.Tracer(),
		})
		return poller, err
	} else {
		return runtime.NewPollerFromResumeToken(options.ResumeToken, client.internal.Pipeline(), &runtime.NewPollerFromResumeTokenOptions[ClientDeleteAttachmentResponse]{
			Tracer: client.internal.Tracer(),
		})
	}
}

// DeleteAttachment - A long-running resource action.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2025-09-01-preview
func (client *Client) deleteAttachment(ctx context.Context, resourceGroupName string, edgeActionName string, body EdgeActionAttachment, options *ClientBeginDeleteAttachmentOptions) (*http.Response, error) {
	var err error
	const operationName = "Client.BeginDeleteAttachment"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.deleteAttachmentCreateRequest(ctx, resourceGroupName, edgeActionName, body, options)
	if err != nil {
		return nil, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
...
// deleteAttachmentCreateRequest creates the DeleteAttachment request.
func (client *Client) deleteAttachmentCreateRequest(ctx context.Context, resourceGroupName string, edgeActionName string, body EdgeActionAttachment, _ *ClientBeginDeleteAttachmentOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cdn/edgeActions/{edgeActionName}/deleteAttachment"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{subscriptionId}", url.PathEscape(client.subscriptionID))
