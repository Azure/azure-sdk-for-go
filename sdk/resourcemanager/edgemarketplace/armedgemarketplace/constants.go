...
// OfferAvailability - OfferAvailability Enum
...
// OfferLaunchType - Offer launch type Enum
type OfferLaunchType string

const (
	// OfferLaunchTypeTrusted - The offer has been certified
	OfferLaunchTypeTrusted OfferLaunchType = "Trusted"
	// OfferLaunchTypeUnknown - The offer has not been certified
	OfferLaunchTypeUnknown OfferLaunchType = "Unknown"
)

// PossibleOfferLaunchTypeValues returns the possible values for the OfferLaunchType const type.
func PossibleOfferLaunchTypeValues() []OfferLaunchType {
	return []OfferLaunchType{
		OfferLaunchTypeTrusted,
		OfferLaunchTypeUnknown,
	}
}

// OfferReleaseType - Offer release type Enum
