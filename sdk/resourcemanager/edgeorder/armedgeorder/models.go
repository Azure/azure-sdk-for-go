...
// AddressesClientListByResourceGroupOptions contains the optional parameters for the AddressesClient.ListByResourceGroup
// method.
...
// AddressesClientListBySubscriptionOptions contains the optional parameters for the AddressesClient.ListBySubscription method.
...
type BasicInformation struct {
	...
	FulfilledBy *FulfillmentType `json:"fulfilledBy,omitempty" azure:"ro"`
...
type ChildConfiguration struct {
	...
	Properties *ChildConfigurationProperties `json:"properties,omitempty" azure:"ro"`
}
...
type ChildConfigurationProperties struct {
	...
	ChildConfigurationType *ChildConfigurationType `json:"childConfigurationType,omitempty" azure:"ro"`
	...
	ChildConfigurationTypes []*ChildConfigurationType `json:"childConfigurationTypes,omitempty" azure:"ro"`
	...
	// category name of the child configuration.
	GroupedChildConfigurations []*GroupedChildConfigurations `json:"groupedChildConfigurations,omitempty" azure:"ro"`
	...
	IsPartOfBaseConfiguration *bool `json:"isPartOfBaseConfiguration,omitempty" azure:"ro"`

	// READ-ONLY; Maximum quantity a customer can order while choosing this configuration.
	MaximumQuantity *int32 `json:"maximumQuantity,omitempty" azure:"ro"`

	// READ-ONLY; Minimum quantity a customer can order while choosing this configuration.
	MinimumQuantity *int32 `json:"minimumQuantity,omitempty" azure:"ro"`
...
type ConfigurationDeviceDetails struct {
	...
	IdentificationType *IdentificationType `json:"identificationType,omitempty" azure:"ro"`
...
type GroupedChildConfigurations struct {
	...
	CategoryInformation *CategoryInformation `json:"categoryInformation,omitempty" azure:"ro"`

	// READ-ONLY; List of child configurations.
	ChildConfigurations []*ChildConfiguration `json:"childConfigurations,omitempty" azure:"ro"`
}
...
// OrderItemsClientListByResourceGroupOptions contains the optional parameters for the OrderItemsClient.ListByResourceGroup
// method.
...
// OrderItemsClientListBySubscriptionOptions contains the optional parameters for the OrderItemsClient.ListBySubscription
// method.
...
type OrderProperties struct {
	...
	OrderMode *OrderMode `json:"orderMode,omitempty" azure:"ro"`
...
// OrdersClientListByResourceGroupOptions contains the optional parameters for the OrdersClient.ListByResourceGroup method.
...
// OrdersClientListBySubscriptionOptions contains the optional parameters for the OrdersClient.ListBySubscription method.
...
type ProductDetails struct {
	...
	ChildConfigurationDeviceDetails []*ConfigurationDeviceDetails `json:"childConfigurationDeviceDetails,omitempty" azure:"ro"`

	// READ-ONLY; Identification type of the configuration.
	IdentificationType *IdentificationType `json:"identificationType,omitempty" azure:"ro"`

	// READ-ONLY; Device details of the parent configuration.
	ParentDeviceDetails *DeviceDetails `json:"parentDeviceDetails,omitempty" azure:"ro"`
...
// ProductsAndConfigurationsClientListConfigurationsOptions contains the optional parameters for the ProductsAndConfigurationsClient.ListConfigurations
// method.
...
// ProductsAndConfigurationsClientListProductFamiliesMetadataOptions contains the optional parameters for the ProductsAndConfigurationsClient.ListProductFamiliesMetadata
// method.
...
// ProductsAndConfigurationsClientListProductFamiliesOptions contains the optional parameters for the ProductsAndConfigurationsClient.ListProductFamilies
// method.
