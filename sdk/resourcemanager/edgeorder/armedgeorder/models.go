...
type AddressResourceList struct {
	// READ-ONLY; The AddressResource items on this page
...
type ChildConfigurationProperties struct {
	...
	// not pass this configuration in OptInAdditionalConfigurations while placing an order, it will be shipped by default.
...
type Configurations struct {
	// READ-ONLY; The Configuration items on this page
	Value []*Configuration
...
type OrderItemResourceList struct {
	// READ-ONLY; The OrderItemResource items on this page
...
type OrderResourceList struct {
	// READ-ONLY; The OrderResource items on this page
	Value []*OrderResource
...
type ProductFamilies struct {
	// READ-ONLY; The ProductFamily items on this page
	Value []*ProductFamily
...
type ProductFamiliesMetadata struct {
	// READ-ONLY; The ProductFamiliesMetadataDetails items on this page
