...
// ExtendedZonesClient contains the methods for the ExtendedZones group.
...
func (client *ExtendedZonesClient) getCreateRequest(ctx context.Context, extendedZoneName string, options *ExtendedZonesClientGetOptions) (*policy.Request, error) {
...
func (client *ExtendedZonesClient) listBySubscriptionCreateRequest(ctx context.Context, options *ExtendedZonesClientListBySubscriptionOptions) (*policy.Request, error) {
...
func (client *ExtendedZonesClient) registerCreateRequest(ctx context.Context, extendedZoneName string, options *ExtendedZonesClientRegisterOptions) (*policy.Request, error) {
...
func (client *ExtendedZonesClient) unregisterCreateRequest(ctx context.Context, extendedZoneName string, options *ExtendedZonesClientUnregisterOptions) (*policy.Request, error) {
