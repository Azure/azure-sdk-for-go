...
func (s *StudentLabsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	resultChan := make(chan result, 1)
	go func() {
		var intercepted bool
		var res result
		if studentLabsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = studentLabsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
func (s *StudentLabsServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	const regexStr = `/providers/Microsoft\.Education/studentLabs/(?P<studentLabName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)`
...
// set this to conditionally intercept incoming requests to StudentLabsServerTransport
var studentLabsServerTransportInterceptor interface {
