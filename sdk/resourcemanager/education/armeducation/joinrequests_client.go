...
func (client *JoinRequestsClient) approveCreateRequest(ctx context.Context, billingAccountName string, billingProfileName string, invoiceSectionName string, joinRequestName string, _ *JoinRequestsClientApproveOptions) (*policy.Request, error) {
...
func (client *JoinRequestsClient) denyCreateRequest(ctx context.Context, billingAccountName string, billingProfileName string, invoiceSectionName string, joinRequestName string, _ *JoinRequestsClientDenyOptions) (*policy.Request, error) {
...
func (client *JoinRequestsClient) getCreateRequest(ctx context.Context, billingAccountName string, billingProfileName string, invoiceSectionName string, joinRequestName string, _ *JoinRequestsClientGetOptions) (*policy.Request, error) {
