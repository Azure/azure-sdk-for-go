...
type GrantListResponse struct {
	...
	// READ-ONLY; The GrantDetails items on this page.
	Value []*GrantDetails
}
...
type JoinRequestList struct {
	...
	// READ-ONLY; The JoinRequestDetails items on this page.
...
// LabListResult - List of Labs info.
type LabListResult struct {
	// The link to the next page of items.
	NextLink *string

	// READ-ONLY; The LabDetails items on this page.
	Value []*LabDetails
}
...
// StudentLabListResult - List of Student Labs info.
type StudentLabListResult struct {
	// The link to the next page of items.
	NextLink *string

	// READ-ONLY; The StudentLabDetails items on this page.
...
// StudentListResult - List of Students info.
type StudentListResult struct {
	// The link to the next page of items.
	NextLink *string

	// READ-ONLY; The StudentDetails items on this page.
