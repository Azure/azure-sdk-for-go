...
// Generated from example definition: 2021-12-01-preview/StudentLab.json
func ExampleStudentLabsClient_Get() {
	...
	// res = armeducation.StudentLabsClientGetResponse{
	// 	StudentLabDetails: armeducation.StudentLabDetails{
	...
	// 			EffectiveDate: to.Ptr(time.Date(2021, time.November, 9, 21, 54, 17, 438000000, time.UTC)),
	// 			ExpirationDate: to.Ptr(time.Date(2022, time.November, 9, 21, 54, 17, 438000000, time.UTC)),
...
// Generated from example definition: 2021-12-01-preview/StudentLabList.json
func ExampleStudentLabsClient_NewListAllPager() {
	...
	for pager.More() {
		...
		// page = armeducation.StudentLabsClientListAllResponse{
		// 	StudentLabListResult: armeducation.StudentLabListResult{
