...
// Generated from example definition: 2026-03-15-preview/AllTrafficFilters_list.json
func ExampleAllTrafficFiltersClient_List() {
	...
	// res = armelastic.AllTrafficFiltersClientListResponse{
	// 	TrafficFilterResponse: armelastic.TrafficFilterResponse{
