...
// Generated from example definition: 2026-03-15-preview/BillingInfo_Get.json
func ExampleBillingInfoClient_Get() {
	...
	// res = armelastic.BillingInfoClientGetResponse{
	// 	BillingInfoResponse: armelastic.BillingInfoResponse{
