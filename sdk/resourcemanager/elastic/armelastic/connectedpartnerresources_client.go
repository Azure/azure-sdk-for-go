...
func (client *ConnectedPartnerResourcesClient) listCreateRequest(ctx context.Context, resourceGroupName string, monitorName string, nextLink string, _ *ConnectedPartnerResourcesClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
