...
// Generated from example definition: 2026-03-15-preview/PrivateLinkTrafficFilters_Create.json
func ExampleCreateAndAssociatePLFilterClient_BeginCreate() {
	...
	poller, err := clientFactory.NewCreateAndAssociatePLFilterClient().BeginCreate(ctx, "myResourceGroup", "myMonitor", &armelastic.CreateAndAssociatePLFilterClientBeginCreateOptions{
	...
	// res = armelastic.CreateAndAssociatePLFilterClientCreateResponse{
	// }
}
