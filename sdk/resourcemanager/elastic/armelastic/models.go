...
type DeploymentInfoResponse struct {
	...
	// READ-ONLY; Elasticsearch endpoint in Elastic cloud deployment. This is either the aliased_endpoint if available, or the
...
type MonitorResourceListResponse struct {
	// REQUIRED; The ElasticMonitorResource items on this page
...
type OpenAIIntegrationRPModelListResponse struct {
	// REQUIRED; The OpenAIIntegrationRPModel items on this page
...
// OperationDisplay - Represents the display information for an operation.
...
// OperationListResult - Represents a paginated list of operations.
...
type VMHostListResponse struct {
	// REQUIRED; The VMResources items on this page
	Value []*VMResources
...
type VersionsListResponse struct {
	// REQUIRED; The ElasticVersionListFormat items on this page
