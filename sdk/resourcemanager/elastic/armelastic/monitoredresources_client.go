...
func (client *MonitoredResourcesClient) listCreateRequest(ctx context.Context, resourceGroupName string, monitorName string, nextLink string, _ *MonitoredResourcesClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *MonitoredResourcesClient) listHandleResponse(resp *http.Response, successCodes ...int) (MonitoredResourcesClientListResponse, error) {
