...
// Generated from example definition: 2026-03-15-preview/MonitoredResources_List.json
func ExampleMonitoredResourcesClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armelastic.MonitoredResourcesClientListResponse{
		// 	MonitoredResourceListResponse: armelastic.MonitoredResourceListResponse{
