...
func (client *VersionsClient) NewListPager(region string, options *VersionsClientListOptions) *runtime.Pager[VersionsClientListResponse] {
	return runtime.NewPager(runtime.PagingHandler[VersionsClientListResponse]{
		...
		Fetcher: func(ctx context.Context, page *VersionsClientListResponse) (VersionsClientListResponse, error) {
			...
			req, err := client.listCreateRequest(ctx, region, nextLink, options)
			if err != nil {
...
func (client *VersionsClient) listCreateRequest(ctx context.Context, region string, nextLink string, _ *VersionsClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *VersionsClient) listHandleResponse(resp *http.Response, successCodes ...int) (VersionsClientListResponse, error) {
