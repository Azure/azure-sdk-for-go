...
// Generated from example definition: 2026-03-15-preview/VMHost_List.json
func ExampleVMHostClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armelastic.VMHostClientListResponse{
		// 	VMHostListResponse: armelastic.VMHostListResponse{
