...
func ExampleElasticSansClient_NewListBySubscriptionPager_elasticSansListBySubscriptionMaximumSetGen() {
	...
	for pager.More() {
		...
		// 	List: armelasticsan.List{
		// 		NextLink: to.Ptr("https://management.azure.com/subscriptions/subscriptionid/providers/Microsoft.ElasticSan/elasticSans?api-version=2024-07-01-preview&%24skiptoken=abc123xyz789"),
		// 		Value: []*armelasticsan.ElasticSan{
		// 			{
		// 				Name: to.Ptr("vfoatmakv"),
		// 				Type: to.Ptr("Microsoft.ElasticSan/ElasticSans"),
