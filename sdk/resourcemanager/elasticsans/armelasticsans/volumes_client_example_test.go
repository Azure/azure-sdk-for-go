...
func ExampleVolumesClient_BeginCreate_volumesCreateMaximumSetGen() {
	...
	poller, err := client.BeginCreate(ctx, "rgelasticsan", "ti7q-k952-1qB3J_5", "u_5I_1j4t3", "9132y", armelasticsans.Volume{
		Tags: map[string]*string{
			"key7423": to.Ptr("aaaa"),
		},
		Properties: &armelasticsans.VolumeProperties{
			CreationData: &armelasticsans.SourceCreationData{
...
func ExampleVolumesClient_BeginCreate_volumesCreateMinimumSetGen() {
	...
	poller, err := client.BeginCreate(ctx, "rgelasticsan", "ti7q-k952-1qB3J_5", "u_5I_1j4t3", "9132y", armelasticsans.Volume{}, nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	res, err := poller.PollUntilDone(ctx, nil)
...
func ExampleVolumesClient_BeginUpdate_volumesUpdateMaximumSetGen() {
	...
	poller, err := client.BeginUpdate(ctx, "rgelasticsan", "ti7q-k952-1qB3J_5", "u_5I_1j4t3", "9132y", armelasticsans.VolumeUpdate{
		Properties: &armelasticsans.VolumeUpdateProperties{
...
func ExampleVolumesClient_BeginUpdate_volumesUpdateMinimumSetGen() {
	...
	poller, err := client.BeginUpdate(ctx, "rgelasticsan", "ti7q-k952-1qB3J_5", "u_5I_1j4t3", "9132y", armelasticsans.VolumeUpdate{}, nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	res, err := poller.PollUntilDone(ctx, nil)
