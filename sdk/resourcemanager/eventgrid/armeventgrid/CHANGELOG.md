...
- Function `*ChannelsClient.BeginDelete` return value(s) have been changed from `(*armruntime.Poller[ChannelsClientDeleteResponse], error)` to `(*runtime.Poller[ChannelsClientDeleteResponse], error)`
- Function `*DomainEventSubscriptionsClient.BeginCreateOrUpdate` return value(s) have been changed from `(*armruntime.Poller[DomainEventSubscriptionsClientCreateOrUpdateResponse], error)` to `(*runtime.Poller[DomainEventSubscriptionsClientCreateOrUpdateResponse], error)`
- Function `*DomainEventSubscriptionsClient.BeginDelete` return value(s) have been changed from `(*armruntime.Poller[DomainEventSubscriptionsClientDeleteResponse], error)` to `(*runtime.Poller[DomainEventSubscriptionsClientDeleteResponse], error)`
- Function `*DomainEventSubscriptionsClient.BeginUpdate` return value(s) have been changed from `(*armruntime.Poller[DomainEventSubscriptionsClientUpdateResponse], error)` to `(*runtime.Poller[DomainEventSubscriptionsClientUpdateResponse], error)`
- Function `*DomainTopicEventSubscriptionsClient.BeginCreateOrUpdate` return value(s) have been changed from `(*armruntime.Poller[DomainTopicEventSubscriptionsClientCreateOrUpdateResponse], error)` to `(*runtime.Poller[DomainTopicEventSubscriptionsClientCreateOrUpdateResponse], error)`
- Function `*DomainTopicEventSubscriptionsClient.BeginDelete` return value(s) have been changed from `(*armruntime.Poller[DomainTopicEventSubscriptionsClientDeleteResponse], error)` to `(*runtime.Poller[DomainTopicEventSubscriptionsClientDeleteResponse], error)`
- Function `*DomainTopicEventSubscriptionsClient.BeginUpdate` return value(s) have been changed from `(*armruntime.Poller[DomainTopicEventSubscriptionsClientUpdateResponse], error)` to `(*runtime.Poller[DomainTopicEventSubscriptionsClientUpdateResponse], error)`
...
- Function `*EventChannelsClient.BeginDelete` return value(s) have been changed from `(*armruntime.Poller[EventChannelsClientDeleteResponse], error)` to `(*runtime.Poller[EventChannelsClientDeleteResponse], error)`
...
- Function `*PartnerConfigurationsClient.BeginCreateOrUpdate` return value(s) have been changed from `(*armruntime.Poller[PartnerConfigurationsClientCreateOrUpdateResponse], error)` to `(*runtime.Poller[PartnerConfigurationsClientCreateOrUpdateResponse], error)`
- Function `*PartnerConfigurationsClient.BeginDelete` return value(s) have been changed from `(*armruntime.Poller[PartnerConfigurationsClientDeleteResponse], error)` to `(*runtime.Poller[PartnerConfigurationsClientDeleteResponse], error)`
- Function `*PartnerConfigurationsClient.BeginUpdate` return value(s) have been changed from `(*armruntime.Poller[PartnerConfigurationsClientUpdateResponse], error)` to `(*runtime.Poller[PartnerConfigurationsClientUpdateResponse], error)`
- Function `*PartnerDestinationsClient.BeginDelete` return value(s) have been changed from `(*armruntime.Poller[PartnerDestinationsClientDeleteResponse], error)` to `(*runtime.Poller[PartnerDestinationsClientDeleteResponse], error)`
- Function `*PartnerNamespacesClient.BeginCreateOrUpdate` return value(s) have been changed from `(*armruntime.Poller[PartnerNamespacesClientCreateOrUpdateResponse], error)` to `(*runtime.Poller[PartnerNamespacesClientCreateOrUpdateResponse], error)`
- Function `*PartnerNamespacesClient.BeginDelete` return value(s) have been changed from `(*armruntime.Poller[PartnerNamespacesClientDeleteResponse], error)` to `(*runtime.Poller[PartnerNamespacesClientDeleteResponse], error)`
- Function `*PartnerNamespacesClient.BeginUpdate` return value(s) have been changed from `(*armruntime.Poller[PartnerNamespacesClientUpdateResponse], error)` to `(*runtime.Poller[PartnerNamespacesClientUpdateResponse], error)`
- Function `*PartnerRegistrationsClient.BeginCreateOrUpdate` return value(s) have been changed from `(*armruntime.Poller[PartnerRegistrationsClientCreateOrUpdateResponse], error)` to `(*runtime.Poller[PartnerRegistrationsClientCreateOrUpdateResponse], error)`
- Function `*PartnerRegistrationsClient.BeginDelete` return value(s) have been changed from `(*armruntime.Poller[PartnerRegistrationsClientDeleteResponse], error)` to `(*runtime.Poller[PartnerRegistrationsClientDeleteResponse], error)`
- Function `*PartnerRegistrationsClient.BeginUpdate` return value(s) have been changed from `(*armruntime.Poller[PartnerRegistrationsClientUpdateResponse], error)` to `(*runtime.Poller[PartnerRegistrationsClientUpdateResponse], error)`
- Function `*PartnerTopicEventSubscriptionsClient.BeginCreateOrUpdate` return value(s) have been changed from `(*armruntime.Poller[PartnerTopicEventSubscriptionsClientCreateOrUpdateResponse], error)` to `(*runtime.Poller[PartnerTopicEventSubscriptionsClientCreateOrUpdateResponse], error)`
- Function `*PartnerTopicEventSubscriptionsClient.BeginDelete` return value(s) have been changed from `(*armruntime.Poller[PartnerTopicEventSubscriptionsClientDeleteResponse], error)` to `(*runtime.Poller[PartnerTopicEventSubscriptionsClientDeleteResponse], error)`
- Function `*PartnerTopicEventSubscriptionsClient.BeginUpdate` return value(s) have been changed from `(*armruntime.Poller[PartnerTopicEventSubscriptionsClientUpdateResponse], error)` to `(*runtime.Poller[PartnerTopicEventSubscriptionsClientUpdateResponse], error)`
- Function `*PartnerTopicsClient.BeginDelete` return value(s) have been changed from `(*armruntime.Poller[PartnerTopicsClientDeleteResponse], error)` to `(*runtime.Poller[PartnerTopicsClientDeleteResponse], error)`
...
- Function `*TopicEventSubscriptionsClient.BeginCreateOrUpdate` return value(s) have been changed from `(*armruntime.Poller[TopicEventSubscriptionsClientCreateOrUpdateResponse], error)` to `(*runtime.Poller[TopicEventSubscriptionsClientCreateOrUpdateResponse], error)`
- Function `*TopicEventSubscriptionsClient.BeginDelete` return value(s) have been changed from `(*armruntime.Poller[TopicEventSubscriptionsClientDeleteResponse], error)` to `(*runtime.Poller[TopicEventSubscriptionsClientDeleteResponse], error)`
- Function `*TopicEventSubscriptionsClient.BeginUpdate` return value(s) have been changed from `(*armruntime.Poller[TopicEventSubscriptionsClientUpdateResponse], error)` to `(*runtime.Poller[TopicEventSubscriptionsClientUpdateResponse], error)`
...
- New type alias `TopicTypeSourceScope`
