...
func (client *CaCertificatesClient) getHandleResponse(resp *http.Response, successCodes ...int) (CaCertificatesClientGetResponse, error) {
...
func (client *CaCertificatesClient) listByNamespaceCreateRequest(ctx context.Context, resourceGroupName string, namespaceName string, nextLink string, options *CaCertificatesClientListByNamespaceOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *CaCertificatesClient) listByNamespaceHandleResponse(resp *http.Response, successCodes ...int) (CaCertificatesClientListByNamespaceResponse, error) {
