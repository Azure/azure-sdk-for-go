...
func ExampleChannelsClient_Get() {
	...
	res, err := client.Get(ctx, "examplerg", "examplePartnerNamespaceName1", "exampleChannelName1", nil)
	if err != nil {
...
func ExampleChannelsClient_BeginDelete() {
	...
	poller, err := client.BeginDelete(ctx, "examplerg", "examplePartnerNamespaceName1", "exampleEventChannelName1", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
...
// Generated from example definition: https://github.com/Azure/azure-rest-api-specs/tree/main/specification/eventgrid/resource-manager/Microsoft.EventGrid/preview/2021-10-15-preview/examples/Channels_GetFullUrl.json
func ExampleChannelsClient_GetFullURL() {
	...
	res, err := client.GetFullURL(ctx, "examplerg", "examplenamespace", "examplechannel", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// TODO: use response item
