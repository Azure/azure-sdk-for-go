...
func ExampleChannelsClient_NewListByPartnerNamespacePager() {
	...
	pager := clientFactory.NewChannelsClient().NewListByPartnerNamespacePager("examplerg", "examplePartnerNamespaceName1", nil)
	for pager.More() {
		...
		// page = armeventgrid.ChannelsClientListByPartnerNamespaceResponse{
		// 	ChannelsListResult: armeventgrid.ChannelsListResult{
