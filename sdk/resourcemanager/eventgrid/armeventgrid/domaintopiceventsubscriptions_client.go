...
// NewGetDeliveryAttributesPager - Get delivery attributes for an event subscription for domain topic.
//
...
//   - topicName - Name of the domain topic.
//   - eventSubscriptionName - Name of the event subscription to be found.
//   - options - DomainTopicEventSubscriptionsClientGetDeliveryAttributesOptions contains the optional parameters for the DomainTopicEventSubscriptionsClient.NewGetDeliveryAttributesPager
//     method.
func (client *DomainTopicEventSubscriptionsClient) NewGetDeliveryAttributesPager(resourceGroupName string, domainName string, topicName string, eventSubscriptionName string, options *DomainTopicEventSubscriptionsClientGetDeliveryAttributesOptions) *runtime.Pager[DomainTopicEventSubscriptionsClientGetDeliveryAttributesResponse] {
	return runtime.NewPager(runtime.PagingHandler[DomainTopicEventSubscriptionsClientGetDeliveryAttributesResponse]{
		More: func(page DomainTopicEventSubscriptionsClientGetDeliveryAttributesResponse) bool {
			return false
		},
		Fetcher: func(ctx context.Context, page *DomainTopicEventSubscriptionsClientGetDeliveryAttributesResponse) (DomainTopicEventSubscriptionsClientGetDeliveryAttributesResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "DomainTopicEventSubscriptionsClient.NewGetDeliveryAttributesPager")
