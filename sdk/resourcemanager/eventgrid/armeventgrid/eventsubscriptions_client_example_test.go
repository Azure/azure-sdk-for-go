...
func ExampleEventSubscriptionsClient_NewGetDeliveryAttributesPager() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	pager := clientFactory.NewEventSubscriptionsClient().NewGetDeliveryAttributesPager("subscriptions/8f6b6269-84f2-4d09-9e31-1127efcd1e40/resourceGroups/examplerg/providers/Microsoft.EventGrid/topics/exampletopic2", "examplesubscription1", nil)
	for pager.More() {
		...
		// page = armeventgrid.EventSubscriptionsClientGetDeliveryAttributesResponse{
