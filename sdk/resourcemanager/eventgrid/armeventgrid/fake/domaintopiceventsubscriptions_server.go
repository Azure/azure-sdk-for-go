...
type DomainTopicEventSubscriptionsServer struct {
	...
	// NewGetDeliveryAttributesPager is the fake for method DomainTopicEventSubscriptionsClient.NewGetDeliveryAttributesPager
	// HTTP status codes to indicate success: http.StatusOK
	NewGetDeliveryAttributesPager func(resourceGroupName string, domainName string, topicName string, eventSubscriptionName string, options *armeventgrid.DomainTopicEventSubscriptionsClientGetDeliveryAttributesOptions) (resp azfake.PagerResponder[armeventgrid.DomainTopicEventSubscriptionsClientGetDeliveryAttributesResponse])
...
func NewDomainTopicEventSubscriptionsServerTransport(srv *DomainTopicEventSubscriptionsServer) *DomainTopicEventSubscriptionsServerTransport {
	return &DomainTopicEventSubscriptionsServerTransport{
		...
		newGetDeliveryAttributesPager: newTracker[azfake.PagerResponder[armeventgrid.DomainTopicEventSubscriptionsClientGetDeliveryAttributesResponse]](),
...
type DomainTopicEventSubscriptionsServerTransport struct {
	...
	newGetDeliveryAttributesPager *tracker[azfake.PagerResponder[armeventgrid.DomainTopicEventSubscriptionsClientGetDeliveryAttributesResponse]]
...
func (d *DomainTopicEventSubscriptionsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		if !intercepted {
			...
			case "DomainTopicEventSubscriptionsClient.NewGetDeliveryAttributesPager":
				res.resp, res.err = d.dispatchNewGetDeliveryAttributesPager(req)
...
func (d *DomainTopicEventSubscriptionsServerTransport) dispatchNewGetDeliveryAttributesPager(req *http.Request) (*http.Response, error) {
	if d.srv.NewGetDeliveryAttributesPager == nil {
		return nil, &nonRetriableError{errors.New("fake for method NewGetDeliveryAttributesPager not implemented")}
	}
	newGetDeliveryAttributesPager := d.newGetDeliveryAttributesPager.get(req)
	if newGetDeliveryAttributesPager == nil {
		...
		resp := d.srv.NewGetDeliveryAttributesPager(resourceGroupNameParam, domainNameParam, topicNameParam, eventSubscriptionNameParam, nil)
		newGetDeliveryAttributesPager = &resp
		d.newGetDeliveryAttributesPager.add(req, newGetDeliveryAttributesPager)
	}
	...
	if !contains([]int{http.StatusOK}, resp.StatusCode) {
		d.newGetDeliveryAttributesPager.remove(req)
