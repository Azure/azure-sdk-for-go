...
type EventSubscriptionsServer struct {
	...
	// NewGetDeliveryAttributesPager is the fake for method EventSubscriptionsClient.NewGetDeliveryAttributesPager
	// HTTP status codes to indicate success: http.StatusOK
	NewGetDeliveryAttributesPager func(scope string, eventSubscriptionName string, options *armeventgrid.EventSubscriptionsClientGetDeliveryAttributesOptions) (resp azfake.PagerResponder[armeventgrid.EventSubscriptionsClientGetDeliveryAttributesResponse])
...
func NewEventSubscriptionsServerTransport(srv *EventSubscriptionsServer) *EventSubscriptionsServerTransport {
	return &EventSubscriptionsServerTransport{
		...
		newGetDeliveryAttributesPager:     newTracker[azfake.PagerResponder[armeventgrid.EventSubscriptionsClientGetDeliveryAttributesResponse]](),
...
type EventSubscriptionsServerTransport struct {
	...
	newGetDeliveryAttributesPager                   *tracker[azfake.PagerResponder[armeventgrid.EventSubscriptionsClientGetDeliveryAttributesResponse]]
...
func (e *EventSubscriptionsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		if !intercepted {
			...
			case "EventSubscriptionsClient.NewGetDeliveryAttributesPager":
				res.resp, res.err = e.dispatchNewGetDeliveryAttributesPager(req)
...
func (e *EventSubscriptionsServerTransport) dispatchNewGetDeliveryAttributesPager(req *http.Request) (*http.Response, error) {
	if e.srv.NewGetDeliveryAttributesPager == nil {
		return nil, &nonRetriableError{errors.New("fake for method NewGetDeliveryAttributesPager not implemented")}
	}
	newGetDeliveryAttributesPager := e.newGetDeliveryAttributesPager.get(req)
	if newGetDeliveryAttributesPager == nil {
		...
		resp := e.srv.NewGetDeliveryAttributesPager(scopeParam, eventSubscriptionNameParam, nil)
		newGetDeliveryAttributesPager = &resp
		e.newGetDeliveryAttributesPager.add(req, newGetDeliveryAttributesPager)
	}
	...
	if !contains([]int{http.StatusOK}, resp.StatusCode) {
		e.newGetDeliveryAttributesPager.remove(req)
