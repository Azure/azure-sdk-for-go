...
type NamespaceTopicEventSubscriptionsServer struct {
	...
	// NewGetDeliveryAttributesPager is the fake for method NamespaceTopicEventSubscriptionsClient.NewGetDeliveryAttributesPager
	// HTTP status codes to indicate success: http.StatusOK
	NewGetDeliveryAttributesPager func(resourceGroupName string, namespaceName string, topicName string, eventSubscriptionName string, options *armeventgrid.NamespaceTopicEventSubscriptionsClientGetDeliveryAttributesOptions) (resp azfake.PagerResponder[armeventgrid.NamespaceTopicEventSubscriptionsClientGetDeliveryAttributesResponse])
...
func NewNamespaceTopicEventSubscriptionsServerTransport(srv *NamespaceTopicEventSubscriptionsServer) *NamespaceTopicEventSubscriptionsServerTransport {
	return &NamespaceTopicEventSubscriptionsServerTransport{
		...
		newGetDeliveryAttributesPager: newTracker[azfake.PagerResponder[armeventgrid.NamespaceTopicEventSubscriptionsClientGetDeliveryAttributesResponse]](),
...
type NamespaceTopicEventSubscriptionsServerTransport struct {
	...
	newGetDeliveryAttributesPager *tracker[azfake.PagerResponder[armeventgrid.NamespaceTopicEventSubscriptionsClientGetDeliveryAttributesResponse]]
...
func (n *NamespaceTopicEventSubscriptionsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		if !intercepted {
			...
			case "NamespaceTopicEventSubscriptionsClient.NewGetDeliveryAttributesPager":
				res.resp, res.err = n.dispatchNewGetDeliveryAttributesPager(req)
...
func (n *NamespaceTopicEventSubscriptionsServerTransport) dispatchNewGetDeliveryAttributesPager(req *http.Request) (*http.Response, error) {
	if n.srv.NewGetDeliveryAttributesPager == nil {
		return nil, &nonRetriableError{errors.New("fake for method NewGetDeliveryAttributesPager not implemented")}
	}
	newGetDeliveryAttributesPager := n.newGetDeliveryAttributesPager.get(req)
	if newGetDeliveryAttributesPager == nil {
		...
		resp := n.srv.NewGetDeliveryAttributesPager(resourceGroupNameParam, namespaceNameParam, topicNameParam, eventSubscriptionNameParam, nil)
		newGetDeliveryAttributesPager = &resp
		n.newGetDeliveryAttributesPager.add(req, newGetDeliveryAttributesPager)
	}
	...
	if !contains([]int{http.StatusOK}, resp.StatusCode) {
		n.newGetDeliveryAttributesPager.remove(req)
