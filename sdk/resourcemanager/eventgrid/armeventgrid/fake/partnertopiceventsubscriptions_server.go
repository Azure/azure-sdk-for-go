...
type PartnerTopicEventSubscriptionsServer struct {
	...
	// NewGetDeliveryAttributesPager is the fake for method PartnerTopicEventSubscriptionsClient.NewGetDeliveryAttributesPager
	// HTTP status codes to indicate success: http.StatusOK
	NewGetDeliveryAttributesPager func(resourceGroupName string, partnerTopicName string, eventSubscriptionName string, options *armeventgrid.PartnerTopicEventSubscriptionsClientGetDeliveryAttributesOptions) (resp azfake.PagerResponder[armeventgrid.PartnerTopicEventSubscriptionsClientGetDeliveryAttributesResponse])
...
func NewPartnerTopicEventSubscriptionsServerTransport(srv *PartnerTopicEventSubscriptionsServer) *PartnerTopicEventSubscriptionsServerTransport {
	return &PartnerTopicEventSubscriptionsServerTransport{
		...
		newGetDeliveryAttributesPager: newTracker[azfake.PagerResponder[armeventgrid.PartnerTopicEventSubscriptionsClientGetDeliveryAttributesResponse]](),
...
type PartnerTopicEventSubscriptionsServerTransport struct {
	...
	newGetDeliveryAttributesPager *tracker[azfake.PagerResponder[armeventgrid.PartnerTopicEventSubscriptionsClientGetDeliveryAttributesResponse]]
...
func (p *PartnerTopicEventSubscriptionsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		if !intercepted {
			...
			case "PartnerTopicEventSubscriptionsClient.NewGetDeliveryAttributesPager":
				res.resp, res.err = p.dispatchNewGetDeliveryAttributesPager(req)
...
func (p *PartnerTopicEventSubscriptionsServerTransport) dispatchNewGetDeliveryAttributesPager(req *http.Request) (*http.Response, error) {
	if p.srv.NewGetDeliveryAttributesPager == nil {
		return nil, &nonRetriableError{errors.New("fake for method NewGetDeliveryAttributesPager not implemented")}
	}
	newGetDeliveryAttributesPager := p.newGetDeliveryAttributesPager.get(req)
	if newGetDeliveryAttributesPager == nil {
		...
		resp := p.srv.NewGetDeliveryAttributesPager(resourceGroupNameParam, partnerTopicNameParam, eventSubscriptionNameParam, nil)
		newGetDeliveryAttributesPager = &resp
		p.newGetDeliveryAttributesPager.add(req, newGetDeliveryAttributesPager)
	}
	...
	if !contains([]int{http.StatusOK}, resp.StatusCode) {
		p.newGetDeliveryAttributesPager.remove(req)
