...
// The returned PrivateEndpointConnectionsServerTransport instance is connected to an instance of armeventgrid.PrivateEndpointConnectionsClient via the
// azcore.ClientOptions.Transporter field in the client's constructor parameters.
func NewPrivateEndpointConnectionsServerTransport(srv *PrivateEndpointConnectionsServer) *PrivateEndpointConnectionsServerTransport {
	return &PrivateEndpointConnectionsServerTransport{
		srv:                    srv,
		beginDelete:            newTracker[azfake.PollerResponder[armeventgrid.PrivateEndpointConnectionsClientDeleteResponse]](),
		newListByResourcePager: newTracker[azfake.PagerResponder[armeventgrid.PrivateEndpointConnectionsClientListByResourceResponse]](),
		beginUpdate:            newTracker[azfake.PollerResponder[armeventgrid.PrivateEndpointConnectionsClientUpdateResponse]](),
	}
}

// PrivateEndpointConnectionsServerTransport connects instances of armeventgrid.PrivateEndpointConnectionsClient to instances of PrivateEndpointConnectionsServer.
...
type PrivateEndpointConnectionsServerTransport struct {
	...
	beginDelete            *tracker[azfake.PollerResponder[armeventgrid.PrivateEndpointConnectionsClientDeleteResponse]]
	newListByResourcePager *tracker[azfake.PagerResponder[armeventgrid.PrivateEndpointConnectionsClientListByResourceResponse]]
	beginUpdate            *tracker[azfake.PollerResponder[armeventgrid.PrivateEndpointConnectionsClientUpdateResponse]]
}
...
func (p *PrivateEndpointConnectionsServerTransport) dispatchBeginDelete(req *http.Request) (*http.Response, error) {
	...
	if beginDelete == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.EventGrid/(?P<parentType>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/(?P<parentName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/privateEndpointConnections/(?P<privateEndpointConnectionName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)`
		...
		parentTypeParam, err := parseWithCast(matches[regex.SubexpIndex("parentType")], func(v string) (armeventgrid.PrivateEndpointConnectionsParentType, error) {
			p, unescapeErr := url.PathUnescape(v)
			if unescapeErr != nil {
				return "", unescapeErr
			}
			return armeventgrid.PrivateEndpointConnectionsParentType(p), nil
		})
		if err != nil {
			return nil, err
		}
		...
		respr, errRespr := p.srv.BeginDelete(req.Context(), resourceGroupNameParam, parentTypeParam, parentNameParam, privateEndpointConnectionNameParam, nil)
...
func (p *PrivateEndpointConnectionsServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := p.srv.Get(req.Context(), resourceGroupNameParam, parentTypeParam, parentNameParam, privateEndpointConnectionNameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
...
func (p *PrivateEndpointConnectionsServerTransport) dispatchNewListByResourcePager(req *http.Request) (*http.Response, error) {
	...
	if newListByResourcePager == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.EventGrid/(?P<parentType>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/(?P<parentName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/privateEndpointConnections`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 5 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
		...
		var options *armeventgrid.PrivateEndpointConnectionsClientListByResourceOptions
		...
		server.PagerResponderInjectNextLinks(newListByResourcePager, req, func(page *armeventgrid.PrivateEndpointConnectionsClientListByResourceResponse, createLink func() string) {
...
func (p *PrivateEndpointConnectionsServerTransport) dispatchBeginUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginUpdate == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armeventgrid.PrivateEndpointConnection](req)
		if err != nil {
			return nil, err
		}
		resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
		...
		respr, errRespr := p.srv.BeginUpdate(req.Context(), resourceGroupNameParam, parentTypeParam, parentNameParam, privateEndpointConnectionNameParam, body, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginUpdate = &respr
