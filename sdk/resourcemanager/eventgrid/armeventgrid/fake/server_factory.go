...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "CaCertificatesClient":
		initServer(&s.trMu, &s.trCaCertificatesServer, func() *CaCertificatesServerTransport {
	...
	case "ClientGroupsClient":
		initServer(&s.trMu, &s.trClientGroupsServer, func() *ClientGroupsServerTransport { return NewClientGroupsServerTransport(&s.srv.ClientGroupsServer) })
		resp, err = s.trClientGroupsServer.Do(req)
	case "ClientsClient":
		initServer(&s.trMu, &s.trClientsServer, func() *ClientsServerTransport { return NewClientsServerTransport(&s.srv.ClientsServer) })
		resp, err = s.trClientsServer.Do(req)
	case "DomainEventSubscriptionsClient":
		initServer(&s.trMu, &s.trDomainEventSubscriptionsServer, func() *DomainEventSubscriptionsServerTransport {
	...
	case "DomainTopicEventSubscriptionsClient":
		initServer(&s.trMu, &s.trDomainTopicEventSubscriptionsServer, func() *DomainTopicEventSubscriptionsServerTransport {
	...
	case "DomainTopicsClient":
		initServer(&s.trMu, &s.trDomainTopicsServer, func() *DomainTopicsServerTransport { return NewDomainTopicsServerTransport(&s.srv.DomainTopicsServer) })
	...
	case "EventSubscriptionsClient":
		initServer(&s.trMu, &s.trEventSubscriptionsServer, func() *EventSubscriptionsServerTransport {
	...
	case "ExtensionTopicsClient":
		initServer(&s.trMu, &s.trExtensionTopicsServer, func() *ExtensionTopicsServerTransport {
	...
	case "NamespaceTopicEventSubscriptionsClient":
		initServer(&s.trMu, &s.trNamespaceTopicEventSubscriptionsServer, func() *NamespaceTopicEventSubscriptionsServerTransport {
	...
	case "NamespaceTopicsClient":
		initServer(&s.trMu, &s.trNamespaceTopicsServer, func() *NamespaceTopicsServerTransport {
	...
	case "PartnerConfigurationsClient":
		initServer(&s.trMu, &s.trPartnerConfigurationsServer, func() *PartnerConfigurationsServerTransport {
	...
	case "PartnerDestinationsClient":
		initServer(&s.trMu, &s.trPartnerDestinationsServer, func() *PartnerDestinationsServerTransport {
	...
	case "PartnerNamespacesClient":
		initServer(&s.trMu, &s.trPartnerNamespacesServer, func() *PartnerNamespacesServerTransport {
	...
	case "PartnerRegistrationsClient":
		initServer(&s.trMu, &s.trPartnerRegistrationsServer, func() *PartnerRegistrationsServerTransport {
	...
	case "PartnerTopicEventSubscriptionsClient":
		initServer(&s.trMu, &s.trPartnerTopicEventSubscriptionsServer, func() *PartnerTopicEventSubscriptionsServerTransport {
	...
	case "PartnerTopicsClient":
		initServer(&s.trMu, &s.trPartnerTopicsServer, func() *PartnerTopicsServerTransport {
	...
	case "PermissionBindingsClient":
		initServer(&s.trMu, &s.trPermissionBindingsServer, func() *PermissionBindingsServerTransport {
	...
	case "SystemTopicEventSubscriptionsClient":
		initServer(&s.trMu, &s.trSystemTopicEventSubscriptionsServer, func() *SystemTopicEventSubscriptionsServerTransport {
	...
	case "SystemTopicsClient":
		initServer(&s.trMu, &s.trSystemTopicsServer, func() *SystemTopicsServerTransport { return NewSystemTopicsServerTransport(&s.srv.SystemTopicsServer) })
		resp, err = s.trSystemTopicsServer.Do(req)
	case "TopicEventSubscriptionsClient":
		initServer(&s.trMu, &s.trTopicEventSubscriptionsServer, func() *TopicEventSubscriptionsServerTransport {
	...
	case "TopicSpacesClient":
		initServer(&s.trMu, &s.trTopicSpacesServer, func() *TopicSpacesServerTransport { return NewTopicSpacesServerTransport(&s.srv.TopicSpacesServer) })
		resp, err = s.trTopicSpacesServer.Do(req)
	case "TopicTypesClient":
		initServer(&s.trMu, &s.trTopicTypesServer, func() *TopicTypesServerTransport { return NewTopicTypesServerTransport(&s.srv.TopicTypesServer) })
	...
	case "VerifiedPartnersClient":
		initServer(&s.trMu, &s.trVerifiedPartnersServer, func() *VerifiedPartnersServerTransport {
