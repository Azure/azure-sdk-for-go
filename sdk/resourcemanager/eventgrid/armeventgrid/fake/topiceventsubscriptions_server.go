...
type TopicEventSubscriptionsServer struct {
	...
	// NewGetDeliveryAttributesPager is the fake for method TopicEventSubscriptionsClient.NewGetDeliveryAttributesPager
	// HTTP status codes to indicate success: http.StatusOK
	NewGetDeliveryAttributesPager func(resourceGroupName string, topicName string, eventSubscriptionName string, options *armeventgrid.TopicEventSubscriptionsClientGetDeliveryAttributesOptions) (resp azfake.PagerResponder[armeventgrid.TopicEventSubscriptionsClientGetDeliveryAttributesResponse])
...
func NewTopicEventSubscriptionsServerTransport(srv *TopicEventSubscriptionsServer) *TopicEventSubscriptionsServerTransport {
	return &TopicEventSubscriptionsServerTransport{
		...
		newGetDeliveryAttributesPager: newTracker[azfake.PagerResponder[armeventgrid.TopicEventSubscriptionsClientGetDeliveryAttributesResponse]](),
...
type TopicEventSubscriptionsServerTransport struct {
	...
	newGetDeliveryAttributesPager *tracker[azfake.PagerResponder[armeventgrid.TopicEventSubscriptionsClientGetDeliveryAttributesResponse]]
...
func (t *TopicEventSubscriptionsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		if !intercepted {
			...
			case "TopicEventSubscriptionsClient.NewGetDeliveryAttributesPager":
				res.resp, res.err = t.dispatchNewGetDeliveryAttributesPager(req)
...
func (t *TopicEventSubscriptionsServerTransport) dispatchNewGetDeliveryAttributesPager(req *http.Request) (*http.Response, error) {
	if t.srv.NewGetDeliveryAttributesPager == nil {
		return nil, &nonRetriableError{errors.New("fake for method NewGetDeliveryAttributesPager not implemented")}
	}
	newGetDeliveryAttributesPager := t.newGetDeliveryAttributesPager.get(req)
	if newGetDeliveryAttributesPager == nil {
		...
		resp := t.srv.NewGetDeliveryAttributesPager(resourceGroupNameParam, topicNameParam, eventSubscriptionNameParam, nil)
		newGetDeliveryAttributesPager = &resp
		t.newGetDeliveryAttributesPager.add(req, newGetDeliveryAttributesPager)
	}
	...
	if !contains([]int{http.StatusOK}, resp.StatusCode) {
		t.newGetDeliveryAttributesPager.remove(req)
