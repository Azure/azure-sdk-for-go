...
// instantiate an object of this class. Instead, instantiate an object of a derived class such as BoolEqualsAdvancedFilter,
// NumberInAdvancedFilter, StringEqualsAdvancedFilter etc. depending on the type of the key based on which you want to filter.
...
type AzureADPartnerClientAuthentication struct {
	...
	// Field has constant value PartnerClientAuthenticationTypeAzureAD, any specified value is ignored.
...
type AzureFunctionEventSubscriptionDestination struct {
	// CONSTANT; Type of the endpoint for the event subscription destination.
	// Field has constant value EndpointTypeAzureFunction, any specified value is ignored.
...
type BoolEqualsAdvancedFilter struct {
	// CONSTANT; The operator type used for filtering, e.g., NumberIn, StringContains, BoolEquals and others.
	// Field has constant value AdvancedFilterOperatorTypeBoolEquals, any specified value is ignored.
	OperatorType *AdvancedFilterOperatorType
...
type BoolEqualsFilter struct {
	// CONSTANT; The operator type used for filtering, e.g., NumberIn, StringContains, BoolEquals and others.
	// Field has constant value FilterOperatorTypeBoolEquals, any specified value is ignored.
...
type CaCertificatesListResult struct {
	// REQUIRED; The CaCertificate items on this page
	Value []*CaCertificate
...
type ChannelsListResult struct {
	// REQUIRED; The Channel items on this page
	Value []*Channel
...
type ClientGroupsListResult struct {
	// REQUIRED; The ClientGroup items on this page
	Value []*ClientGroup
...
type ClientsListResult struct {
	// REQUIRED; The Client items on this page
	Value []*Client
...
type ConfidentialCompute struct {
	// REQUIRED; This property specifies the mode of the Azure Confidential Compute configuration.
...
type CustomDomainConfiguration struct {
	...
	// in Azure Key Vault only. While certificate URL can be either
	// versioned URL of the following format https://{key-vault-name}.vault.azure.net/certificates/{certificate-name}/{version-id},
	...
	// to 'Approved' by Event Grid only after ownership of the domain name has been successfully validated.
...
type CustomerManagedKeyEncryption struct {
	...
	// by Event Grid Runtime even if it is rotated. It is user
	// responsibility to update the URL with the new version by updating the namespace resource. When URL without version is used,
	// Event Grid will query and get latest version and will
...
// destination, do not directly instantiate an object of this class. Instead, instantiate an object of a derived class. Currently,
...
type DeadLetterWithResourceIdentity struct {
	...
	// Uses the managed identity setup on the parent resource (namely, topic or domain) to acquire the authentication tokens being
	// used during dead-lettering.
...
type DomainProperties struct {
	...
	// by the user. The self-management mode can be used if the user wants full control of when the domain topic is created, while
	...
	// for this property is true.
	// When this property is set to true, Event Grid is responsible of automatically deleting the domain topic when the last event
	...
	// Entra ID token will be used to authenticate if user is allowed to publish to the domain.
...
type DomainTopicsListResult struct {
	// REQUIRED; The DomainTopic items on this page
	Value []*DomainTopic
...
type DynamicDeliveryAttributeMapping struct {
	// CONSTANT; Type of the delivery attribute or header name.
	// Field has constant value DeliveryAttributeMappingTypeDynamic, any specified value is ignored.
	Type *DeliveryAttributeMappingType
...
type EventHubEventSubscriptionDestination struct {
	// CONSTANT; Type of the endpoint for the event subscription destination.
	// Field has constant value EndpointTypeEventHub, any specified value is ignored.
	EndpointType *EndpointType
...
type EventSubscriptionUpdateParameters struct {
	...
	// The dead letter destination of the event subscription. Any event that cannot be delivered to its' destination is sent to
	// the dead letter destination.
	// Uses the managed identity setup on the parent resource (topic / domain) to acquire the authentication tokens being used
...
type EventSubscriptionsListResult struct {
	// REQUIRED; The EventSubscription items on this page
...
// this class. Instead, instantiate
...
type HybridConnectionEventSubscriptionDestination struct {
	// CONSTANT; Type of the endpoint for the event subscription destination.
	// Field has constant value EndpointTypeHybridConnection, any specified value is ignored.
	EndpointType *EndpointType
...
// mapping enables publishing to Event Grid using a custom input schema. Currently, the only supported type of InputSchemaMapping
...
type IsNotNullAdvancedFilter struct {
	// CONSTANT; The operator type used for filtering, e.g., NumberIn, StringContains, BoolEquals and others.
	// Field has constant value AdvancedFilterOperatorTypeIsNotNull, any specified value is ignored.
	OperatorType *AdvancedFilterOperatorType
...
type IsNotNullFilter struct {
	// CONSTANT; The operator type used for filtering, e.g., NumberIn, StringContains, BoolEquals and others.
	// Field has constant value FilterOperatorTypeIsNotNull, any specified value is ignored.
	OperatorType *FilterOperatorType
...
type IsNullOrUndefinedAdvancedFilter struct {
	// CONSTANT; The operator type used for filtering, e.g., NumberIn, StringContains, BoolEquals and others.
	// Field has constant value AdvancedFilterOperatorTypeIsNullOrUndefined, any specified value is ignored.
	OperatorType *AdvancedFilterOperatorType
...
type IsNullOrUndefinedFilter struct {
	// CONSTANT; The operator type used for filtering, e.g., NumberIn, StringContains, BoolEquals and others.
	// Field has constant value FilterOperatorTypeIsNullOrUndefined, any specified value is ignored.
	OperatorType *FilterOperatorType
...
type JSONInputSchemaMapping struct {
	// CONSTANT; Type of the custom mapping
	// Field has constant value InputSchemaMappingTypeJSON, any specified value is ignored.
	InputSchemaMappingType *InputSchemaMappingType
...
type MonitorAlertEventSubscriptionDestination struct {
	// CONSTANT; Type of the endpoint for the event subscription destination.
	// Field has constant value EndpointTypeMonitorAlert, any specified value is ignored.
	EndpointType *EndpointType
...
type NamespaceTopicEventSubscriptionDestination struct {
	// CONSTANT; Type of the endpoint for the event subscription destination.
	// Field has constant value EndpointTypeNamespaceTopic, any specified value is ignored.
	EndpointType *EndpointType
...
type NamespaceTopicsListResult struct {
	// REQUIRED; The NamespaceTopic items on this page
...
type NumberGreaterThanAdvancedFilter struct {
	// CONSTANT; The operator type used for filtering, e.g., NumberIn, StringContains, BoolEquals and others.
	// Field has constant value AdvancedFilterOperatorTypeNumberGreaterThan, any specified value is ignored.
	OperatorType *AdvancedFilterOperatorType
...
type NumberGreaterThanFilter struct {
	// CONSTANT; The operator type used for filtering, e.g., NumberIn, StringContains, BoolEquals and others.
	// Field has constant value FilterOperatorTypeNumberGreaterThan, any specified value is ignored.
	OperatorType *FilterOperatorType
...
type NumberGreaterThanOrEqualsAdvancedFilter struct {
	// CONSTANT; The operator type used for filtering, e.g., NumberIn, StringContains, BoolEquals and others.
	// Field has constant value AdvancedFilterOperatorTypeNumberGreaterThanOrEquals, any specified value is ignored.
	OperatorType *AdvancedFilterOperatorType
...
type NumberGreaterThanOrEqualsFilter struct {
	// CONSTANT; The operator type used for filtering, e.g., NumberIn, StringContains, BoolEquals and others.
	// Field has constant value FilterOperatorTypeNumberGreaterThanOrEquals, any specified value is ignored.
	OperatorType *FilterOperatorType
...
type NumberInAdvancedFilter struct {
	// CONSTANT; The operator type used for filtering, e.g., NumberIn, StringContains, BoolEquals and others.
	// Field has constant value AdvancedFilterOperatorTypeNumberIn, any specified value is ignored.
	OperatorType *AdvancedFilterOperatorType
...
type NumberInFilter struct {
	// CONSTANT; The operator type used for filtering, e.g., NumberIn, StringContains, BoolEquals and others.
	// Field has constant value FilterOperatorTypeNumberIn, any specified value is ignored.
	OperatorType *FilterOperatorType
...
type NumberInRangeAdvancedFilter struct {
	// CONSTANT; The operator type used for filtering, e.g., NumberIn, StringContains, BoolEquals and others.
	// Field has constant value AdvancedFilterOperatorTypeNumberInRange, any specified value is ignored.
	OperatorType *AdvancedFilterOperatorType
...
type NumberInRangeFilter struct {
	// CONSTANT; The operator type used for filtering, e.g., NumberIn, StringContains, BoolEquals and others.
	// Field has constant value FilterOperatorTypeNumberInRange, any specified value is ignored.
	OperatorType *FilterOperatorType
...
type NumberLessThanAdvancedFilter struct {
	// CONSTANT; The operator type used for filtering, e.g., NumberIn, StringContains, BoolEquals and others.
	// Field has constant value AdvancedFilterOperatorTypeNumberLessThan, any specified value is ignored.
	OperatorType *AdvancedFilterOperatorType
...
type NumberLessThanFilter struct {
	// CONSTANT; The operator type used for filtering, e.g., NumberIn, StringContains, BoolEquals and others.
	// Field has constant value FilterOperatorTypeNumberLessThan, any specified value is ignored.
	OperatorType *FilterOperatorType
...
type NumberLessThanOrEqualsAdvancedFilter struct {
	// CONSTANT; The operator type used for filtering, e.g., NumberIn, StringContains, BoolEquals and others.
	// Field has constant value AdvancedFilterOperatorTypeNumberLessThanOrEquals, any specified value is ignored.
	OperatorType *AdvancedFilterOperatorType
...
type NumberLessThanOrEqualsFilter struct {
	// CONSTANT; The operator type used for filtering, e.g., NumberIn, StringContains, BoolEquals and others.
	// Field has constant value FilterOperatorTypeNumberLessThanOrEquals, any specified value is ignored.
	OperatorType *FilterOperatorType
...
type NumberNotInAdvancedFilter struct {
	// CONSTANT; The operator type used for filtering, e.g., NumberIn, StringContains, BoolEquals and others.
	// Field has constant value AdvancedFilterOperatorTypeNumberNotIn, any specified value is ignored.
	OperatorType *AdvancedFilterOperatorType
...
type NumberNotInFilter struct {
	// CONSTANT; The operator type used for filtering, e.g., NumberIn, StringContains, BoolEquals and others.
	// Field has constant value FilterOperatorTypeNumberNotIn, any specified value is ignored.
	OperatorType *FilterOperatorType
...
type NumberNotInRangeAdvancedFilter struct {
	// CONSTANT; The operator type used for filtering, e.g., NumberIn, StringContains, BoolEquals and others.
	// Field has constant value AdvancedFilterOperatorTypeNumberNotInRange, any specified value is ignored.
	OperatorType *AdvancedFilterOperatorType
...
type NumberNotInRangeFilter struct {
	// CONSTANT; The operator type used for filtering, e.g., NumberIn, StringContains, BoolEquals and others.
	// Field has constant value FilterOperatorTypeNumberNotInRange, any specified value is ignored.
	OperatorType *FilterOperatorType
...
type PartnerConfigurationsListResult struct {
	// REQUIRED; The PartnerConfiguration items on this page
...
type PartnerDestinationsListResult struct {
	// REQUIRED; The PartnerDestination items on this page
...
type PartnerEventSubscriptionDestination struct {
	// CONSTANT; Type of the endpoint for the event subscription destination.
	// Field has constant value EndpointTypePartnerDestination, any specified value is ignored.
	EndpointType *EndpointType
...
type PartnerNamespaceProperties struct {
	// This boolean is used to enable or disable local auth. Default value is false. When the property is set to true, only Microsoft
	// Entra ID token will be used to authenticate if user is allowed to publish to the partner namespace.
	DisableLocalAuth *bool
...
type PartnerNamespacesListResult struct {
	// REQUIRED; The PartnerNamespace items on this page
...
type PartnerRegistrationsListResult struct {
	// REQUIRED; The PartnerRegistration items on this page
...
type PartnerTopicsListResult struct {
	// REQUIRED; The PartnerTopic items on this page
	Value []*PartnerTopic
...
type PermissionBindingsListResult struct {
	// REQUIRED; The PermissionBinding items on this page
...
// PrivateEndpointConnection - Concrete proxy resource types can be created by aliasing this type using a specific property
// type.
...
type PushInfo struct {
	// The dead letter destination of the event subscription. Any event that cannot be delivered to its' destination is sent to
	// the dead letter destination.
	// Uses the managed identity setup on the parent resource (namely, namespace) to acquire the authentication tokens being used
	...
	// This duration value cannot be set greater than the topic’s EventRetentionInDays. It is is an optional field where its minimum
	// value is 1 minute, and its maximum is determined
...
type ServiceBusQueueEventSubscriptionDestination struct {
	// CONSTANT; Type of the endpoint for the event subscription destination.
	// Field has constant value EndpointTypeServiceBusQueue, any specified value is ignored.
	EndpointType *EndpointType
...
type ServiceBusTopicEventSubscriptionDestination struct {
	// CONSTANT; Type of the endpoint for the event subscription destination.
	// Field has constant value EndpointTypeServiceBusTopic, any specified value is ignored.
	EndpointType *EndpointType
...
type StaticDeliveryAttributeMapping struct {
	// CONSTANT; Type of the delivery attribute or header name.
	// Field has constant value DeliveryAttributeMappingTypeStatic, any specified value is ignored.
	Type *DeliveryAttributeMappingType
...
type StaticStringRoutingEnrichment struct {
	// CONSTANT; Static routing enrichment value type. For e.g. this property value can be 'String'.
	// Field has constant value StaticRoutingEnrichmentTypeString, any specified value is ignored.
	ValueType *StaticRoutingEnrichmentType
...
type StorageBlobDeadLetterDestination struct {
	// CONSTANT; Type of the endpoint for the dead letter destination
	// Field has constant value DeadLetterEndPointTypeStorageBlob, any specified value is ignored.
	EndpointType *DeadLetterEndPointType
...
type StorageQueueEventSubscriptionDestination struct {
	// CONSTANT; Type of the endpoint for the event subscription destination.
	// Field has constant value EndpointTypeStorageQueue, any specified value is ignored.
	EndpointType *EndpointType
...
type StringBeginsWithAdvancedFilter struct {
	// CONSTANT; The operator type used for filtering, e.g., NumberIn, StringContains, BoolEquals and others.
	// Field has constant value AdvancedFilterOperatorTypeStringBeginsWith, any specified value is ignored.
	OperatorType *AdvancedFilterOperatorType
...
type StringBeginsWithFilter struct {
	// CONSTANT; The operator type used for filtering, e.g., NumberIn, StringContains, BoolEquals and others.
	// Field has constant value FilterOperatorTypeStringBeginsWith, any specified value is ignored.
	OperatorType *FilterOperatorType
...
type StringContainsAdvancedFilter struct {
	// CONSTANT; The operator type used for filtering, e.g., NumberIn, StringContains, BoolEquals and others.
	// Field has constant value AdvancedFilterOperatorTypeStringContains, any specified value is ignored.
	OperatorType *AdvancedFilterOperatorType
...
type StringContainsFilter struct {
	// CONSTANT; The operator type used for filtering, e.g., NumberIn, StringContains, BoolEquals and others.
	// Field has constant value FilterOperatorTypeStringContains, any specified value is ignored.
	OperatorType *FilterOperatorType
...
type StringEndsWithAdvancedFilter struct {
	// CONSTANT; The operator type used for filtering, e.g., NumberIn, StringContains, BoolEquals and others.
	// Field has constant value AdvancedFilterOperatorTypeStringEndsWith, any specified value is ignored.
	OperatorType *AdvancedFilterOperatorType
...
type StringEndsWithFilter struct {
	// CONSTANT; The operator type used for filtering, e.g., NumberIn, StringContains, BoolEquals and others.
	// Field has constant value FilterOperatorTypeStringEndsWith, any specified value is ignored.
	OperatorType *FilterOperatorType
...
type StringInAdvancedFilter struct {
	// CONSTANT; The operator type used for filtering, e.g., NumberIn, StringContains, BoolEquals and others.
	// Field has constant value AdvancedFilterOperatorTypeStringIn, any specified value is ignored.
	OperatorType *AdvancedFilterOperatorType
...
type StringInFilter struct {
	// CONSTANT; The operator type used for filtering, e.g., NumberIn, StringContains, BoolEquals and others.
	// Field has constant value FilterOperatorTypeStringIn, any specified value is ignored.
	OperatorType *FilterOperatorType
...
type StringNotBeginsWithAdvancedFilter struct {
	// CONSTANT; The operator type used for filtering, e.g., NumberIn, StringContains, BoolEquals and others.
	// Field has constant value AdvancedFilterOperatorTypeStringNotBeginsWith, any specified value is ignored.
	OperatorType *AdvancedFilterOperatorType
...
type StringNotBeginsWithFilter struct {
	// CONSTANT; The operator type used for filtering, e.g., NumberIn, StringContains, BoolEquals and others.
	// Field has constant value FilterOperatorTypeStringNotBeginsWith, any specified value is ignored.
	OperatorType *FilterOperatorType
...
type StringNotContainsAdvancedFilter struct {
	// CONSTANT; The operator type used for filtering, e.g., NumberIn, StringContains, BoolEquals and others.
	// Field has constant value AdvancedFilterOperatorTypeStringNotContains, any specified value is ignored.
	OperatorType *AdvancedFilterOperatorType
...
type StringNotContainsFilter struct {
	// CONSTANT; The operator type used for filtering, e.g., NumberIn, StringContains, BoolEquals and others.
	// Field has constant value FilterOperatorTypeStringNotContains, any specified value is ignored.
	OperatorType *FilterOperatorType
...
type StringNotEndsWithAdvancedFilter struct {
	// CONSTANT; The operator type used for filtering, e.g., NumberIn, StringContains, BoolEquals and others.
	// Field has constant value AdvancedFilterOperatorTypeStringNotEndsWith, any specified value is ignored.
	OperatorType *AdvancedFilterOperatorType
...
type StringNotEndsWithFilter struct {
	// CONSTANT; The operator type used for filtering, e.g., NumberIn, StringContains, BoolEquals and others.
	// Field has constant value FilterOperatorTypeStringNotEndsWith, any specified value is ignored.
	OperatorType *FilterOperatorType
...
type StringNotInAdvancedFilter struct {
	// CONSTANT; The operator type used for filtering, e.g., NumberIn, StringContains, BoolEquals and others.
	// Field has constant value AdvancedFilterOperatorTypeStringNotIn, any specified value is ignored.
	OperatorType *AdvancedFilterOperatorType
...
type StringNotInFilter struct {
	// CONSTANT; The operator type used for filtering, e.g., NumberIn, StringContains, BoolEquals and others.
	// Field has constant value FilterOperatorTypeStringNotIn, any specified value is ignored.
	OperatorType *FilterOperatorType
...
type SubscriptionsListResult struct {
	// REQUIRED; The Subscription items on this page
	Value []*Subscription
...
type SystemTopicsListResult struct {
	// REQUIRED; The SystemTopic items on this page
	Value []*SystemTopic
...
type TopicProperties struct {
	...
	// This boolean is used to enable or disable local auth. Default value is false. When the property is set to true, only Microsoft
	// Entra ID token will be used to authenticate if user is allowed to publish to the topic.
	DisableLocalAuth *bool
...
type TopicSpacesListResult struct {
	// REQUIRED; The TopicSpace items on this page
	Value []*TopicSpace
...
type TopicsListResult struct {
	// REQUIRED; The Topic items on this page
	Value []*Topic
...
// VerifiedPartnersListResult - Result of the List Topic Types operation
type VerifiedPartnersListResult struct {
	// REQUIRED; The VerifiedPartner items on this page
...
type WebHookEventSubscriptionDestination struct {
	// CONSTANT; Type of the endpoint for the event subscription destination.
	// Field has constant value EndpointTypeWebHook, any specified value is ignored.
	EndpointType *EndpointType
...
type WebhookPartnerDestinationInfo struct {
	// CONSTANT; Type of the endpoint for the partner destination
	// Field has constant value PartnerEndpointTypeWebHook, any specified value is ignored.
	EndpointType *PartnerEndpointType
