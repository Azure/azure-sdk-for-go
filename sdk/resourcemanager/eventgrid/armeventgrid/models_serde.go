...
func (a AdvancedFilter) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "operatorType", a.OperatorType)
...
func (c CaCertificateProperties) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "expiryTimeInUtc", c.ExpiryTimeInUTC, true)
	populateTime[datetime.RFC3339](objectMap, "issueTimeInUtc", c.IssueTimeInUTC, true)
...
func (c *CaCertificateProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "expiryTimeInUtc":
			err = unpopulateTime[datetime.RFC3339](val, "ExpiryTimeInUTC", &c.ExpiryTimeInUTC)
			delete(rawMsg, key)
		case "issueTimeInUtc":
			err = unpopulateTime[datetime.RFC3339](val, "IssueTimeInUTC", &c.IssueTimeInUTC)
			delete(rawMsg, key)
...
func (c ChannelProperties) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "expirationTimeIfNotActivatedUtc", c.ExpirationTimeIfNotActivatedUTC, true)
...
func (c *ChannelProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "expirationTimeIfNotActivatedUtc":
			err = unpopulateTime[datetime.RFC3339](val, "ExpirationTimeIfNotActivatedUTC", &c.ExpirationTimeIfNotActivatedUTC)
			delete(rawMsg, key)
...
func (e EventSubscriptionProperties) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "expirationTimeUtc", e.ExpirationTimeUTC, true)
...
func (e *EventSubscriptionProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "expirationTimeUtc":
			err = unpopulateTime[datetime.RFC3339](val, "ExpirationTimeUTC", &e.ExpirationTimeUTC)
			delete(rawMsg, key)
		case "filter":
...
func (i InputSchemaMapping) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "inputSchemaMappingType", i.InputSchemaMappingType)
	return json.Marshal(objectMap)
}
...
func (p Partner) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateTime[datetime.RFC3339](objectMap, "authorizationExpirationTimeInUtc", p.AuthorizationExpirationTimeInUTC, true)
...
func (p *Partner) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "authorizationExpirationTimeInUtc":
			err = unpopulateTime[datetime.RFC3339](val, "AuthorizationExpirationTimeInUTC", &p.AuthorizationExpirationTimeInUTC)
			delete(rawMsg, key)
		case "partnerName":
...
func (p PartnerClientAuthentication) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "clientAuthenticationType", p.ClientAuthenticationType)
	return json.Marshal(objectMap)
}
...
func (p PartnerDestinationProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "endpointServiceContext", p.EndpointServiceContext)
	populateTime[datetime.RFC3339](objectMap, "expirationTimeIfNotActivatedUtc", p.ExpirationTimeIfNotActivatedUTC, true)
...
func (p *PartnerDestinationProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "endpointServiceContext":
			...
			delete(rawMsg, key)
		case "expirationTimeIfNotActivatedUtc":
			err = unpopulateTime[datetime.RFC3339](val, "ExpirationTimeIfNotActivatedUTC", &p.ExpirationTimeIfNotActivatedUTC)
			delete(rawMsg, key)
		case "messageForActivation":
...
func (r ResourceMoveChangeHistory) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "changedTimeUtc", r.ChangedTimeUTC, true)
...
func (r *ResourceMoveChangeHistory) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "azureSubscriptionId":
			...
			delete(rawMsg, key)
		case "changedTimeUtc":
			err = unpopulateTime[datetime.RFC3339](val, "ChangedTimeUTC", &r.ChangedTimeUTC)
			delete(rawMsg, key)
		case "resourceGroupName":
...
func (s SubscriptionProperties) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "expirationTimeUtc", s.ExpirationTimeUTC, true)
...
func (s *SubscriptionProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "eventDeliverySchema":
			...
			delete(rawMsg, key)
		case "expirationTimeUtc":
			err = unpopulateTime[datetime.RFC3339](val, "ExpirationTimeUTC", &s.ExpirationTimeUTC)
			delete(rawMsg, key)
