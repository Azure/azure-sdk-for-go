...
func (c CaCertificateProperties) MarshalJSON() ([]byte, error) {
	...
	populateTimeRFC3339(objectMap, "expiryTimeInUtc", c.ExpiryTimeInUTC)
	populateTimeRFC3339(objectMap, "issueTimeInUtc", c.IssueTimeInUTC)
...
func (c *CaCertificateProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "expiryTimeInUtc":
			err = unpopulateTimeRFC3339(val, "ExpiryTimeInUTC", &c.ExpiryTimeInUTC)
			delete(rawMsg, key)
		case "issueTimeInUtc":
			err = unpopulateTimeRFC3339(val, "IssueTimeInUTC", &c.IssueTimeInUTC)
			delete(rawMsg, key)
...
// MarshalJSON implements the json.Marshaller interface for type ClientAuthentication.
func (c ClientAuthentication) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "certificateSubject", c.CertificateSubject)
	populate(objectMap, "certificateThumbprint", c.CertificateThumbprint)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ClientAuthentication.
func (c *ClientAuthentication) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "certificateSubject":
			err = unpopulate(val, "CertificateSubject", &c.CertificateSubject)
			delete(rawMsg, key)
...
// MarshalJSON implements the json.Marshaller interface for type ClientCertificateSubjectDistinguishedName.
func (c ClientCertificateSubjectDistinguishedName) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type ClientCertificateSubjectDistinguishedName.
func (c *ClientCertificateSubjectDistinguishedName) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
...
func (c ClientCertificateThumbprint) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "primary", c.Primary)
	populate(objectMap, "secondary", c.Secondary)
	return json.Marshal(objectMap)
}
...
func (c *ClientCertificateThumbprint) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "primary":
			err = unpopulate(val, "Primary", &c.Primary)
			delete(rawMsg, key)
		case "secondary":
			err = unpopulate(val, "Secondary", &c.Secondary)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", c, err)
...
func (r *RoutingEnrichments) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "dynamic":
			...
			delete(rawMsg, key)
		case "static":
			err = unpopulate(val, "Static", &r.Static)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", r, err)
