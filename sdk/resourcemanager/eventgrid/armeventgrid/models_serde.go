...
// UnmarshalJSON implements the json.Unmarshaller interface for type EventChannel.
...
// MarshalJSON implements the json.Marshaller interface for type EventChannelDestination.
func (e EventChannelDestination) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "azureSubscriptionId", e.AzureSubscriptionID)
	populate(objectMap, "partnerTopicName", e.PartnerTopicName)
	populate(objectMap, "resourceGroup", e.ResourceGroup)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type EventChannelDestination.
func (e *EventChannelDestination) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", e, err)
	}
	for key, val := range rawMsg {
		...
		case "azureSubscriptionId":
			err = unpopulate(val, "AzureSubscriptionID", &e.AzureSubscriptionID)
			delete(rawMsg, key)
		case "partnerTopicName":
			err = unpopulate(val, "PartnerTopicName", &e.PartnerTopicName)
			delete(rawMsg, key)
		case "resourceGroup":
...
// MarshalJSON implements the json.Marshaller interface for type EventChannelSource.
func (e EventChannelSource) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "source", e.Source)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type EventChannelSource.
func (e *EventChannelSource) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", e, err)
	}
...
// UnmarshalJSON implements the json.Unmarshaller interface for type EventChannelsListResult.
func (e *EventChannelsListResult) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", e, err)
	}
...
func (p *PartnerRegistrationProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		var err error
		switch key {
		case "authorizedAzureSubscriptionIds":
			err = unpopulate(val, "AuthorizedAzureSubscriptionIDs", &p.AuthorizedAzureSubscriptionIDs)
			delete(rawMsg, key)
		case "customerServiceUri":
			err = unpopulate(val, "CustomerServiceURI", &p.CustomerServiceURI)
			delete(rawMsg, key)
		case "logoUri":
			err = unpopulate(val, "LogoURI", &p.LogoURI)
			delete(rawMsg, key)
		case "longDescription":
			err = unpopulate(val, "LongDescription", &p.LongDescription)
			delete(rawMsg, key)
		case "partnerCustomerServiceExtension":
			err = unpopulate(val, "PartnerCustomerServiceExtension", &p.PartnerCustomerServiceExtension)
			delete(rawMsg, key)
		case "partnerCustomerServiceNumber":
			err = unpopulate(val, "PartnerCustomerServiceNumber", &p.PartnerCustomerServiceNumber)
			delete(rawMsg, key)
		case "partnerName":
			err = unpopulate(val, "PartnerName", &p.PartnerName)
			delete(rawMsg, key)
		case "partnerRegistrationImmutableId":
			err = unpopulate(val, "PartnerRegistrationImmutableID", &p.PartnerRegistrationImmutableID)
			delete(rawMsg, key)
		case "partnerResourceTypeDescription":
			err = unpopulate(val, "PartnerResourceTypeDescription", &p.PartnerResourceTypeDescription)
			delete(rawMsg, key)
		case "partnerResourceTypeDisplayName":
			err = unpopulate(val, "PartnerResourceTypeDisplayName", &p.PartnerResourceTypeDisplayName)
			delete(rawMsg, key)
		case "partnerResourceTypeName":
			err = unpopulate(val, "PartnerResourceTypeName", &p.PartnerResourceTypeName)
			delete(rawMsg, key)
		case "provisioningState":
			err = unpopulate(val, "ProvisioningState", &p.ProvisioningState)
			delete(rawMsg, key)
		...
		case "visibilityState":
			err = unpopulate(val, "VisibilityState", &p.VisibilityState)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", p, err)
...
func (p *PartnerRegistrationUpdateParameters) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "logoUri":
			err = unpopulate(val, "LogoURI", &p.LogoURI)
			delete(rawMsg, key)
		case "partnerTopicTypeDescription":
			err = unpopulate(val, "PartnerTopicTypeDescription", &p.PartnerTopicTypeDescription)
			delete(rawMsg, key)
		case "partnerTopicTypeDisplayName":
			err = unpopulate(val, "PartnerTopicTypeDisplayName", &p.PartnerTopicTypeDisplayName)
			delete(rawMsg, key)
		case "partnerTopicTypeName":
			err = unpopulate(val, "PartnerTopicTypeName", &p.PartnerTopicTypeName)
			delete(rawMsg, key)
		case "setupUri":
			err = unpopulate(val, "SetupURI", &p.SetupURI)
			delete(rawMsg, key)
