...
func ExampleNamespaceTopicEventSubscriptionsClient_NewGetDeliveryAttributesPager() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	pager := clientFactory.NewNamespaceTopicEventSubscriptionsClient().NewGetDeliveryAttributesPager("examplerg", "exampleNamespace", "exampleNamespaceTopic", "exampleEventSubscriptionName", nil)
	for pager.More() {
		...
		// page = armeventgrid.NamespaceTopicEventSubscriptionsClientGetDeliveryAttributesResponse{
