...
func ExamplePartnerNamespacesClient_Get() {
	...
	res, err := client.Get(ctx, "examplerg", "examplePartnerNamespaceName1", nil)
	if err != nil {
...
func ExamplePartnerNamespacesClient_BeginDelete() {
	...
	poller, err := client.BeginDelete(ctx, "examplerg", "examplePartnerNamespaceName1", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	_, err = poller.PollUntilDone(ctx, nil)
...
func ExamplePartnerNamespacesClient_BeginUpdate() {
	...
	poller, err := client.BeginUpdate(ctx, "examplerg", "examplePartnerNamespaceName1", armeventgrid.PartnerNamespaceUpdateParameters{
		Tags: map[string]*string{
			"tag1": to.Ptr("value1"),
		},
	}, nil)
...
func ExamplePartnerNamespacesClient_NewListByResourceGroupPager() {
	...
	pager := client.NewListByResourceGroupPager("examplerg", &armeventgrid.PartnerNamespacesClientListByResourceGroupOptions{Filter: nil,
		Top: nil,
	})
	for pager.More() {
		nextResult, err := pager.NextPage(ctx)
...
func ExamplePartnerNamespacesClient_ListSharedAccessKeys() {
	...
	res, err := client.ListSharedAccessKeys(ctx, "examplerg", "examplePartnerNamespaceName1", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// TODO: use response item
