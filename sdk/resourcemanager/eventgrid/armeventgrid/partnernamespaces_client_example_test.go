...
func ExamplePartnerNamespacesClient_BeginDelete() {
	...
	// res = armeventgrid.PartnerNamespacesClientDeleteResponse{
	// }
}
...
func ExamplePartnerNamespacesClient_NewListByResourceGroupPager() {
	...
	pager := clientFactory.NewPartnerNamespacesClient().NewListByResourceGroupPager("examplerg", nil)
	for pager.More() {
		...
		// page = armeventgrid.PartnerNamespacesClientListByResourceGroupResponse{
		// 	PartnerNamespacesListResult: armeventgrid.PartnerNamespacesListResult{
...
func ExamplePartnerNamespacesClient_NewListBySubscriptionPager() {
	...
	pager := clientFactory.NewPartnerNamespacesClient().NewListBySubscriptionPager(nil)
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armeventgrid.PartnerNamespacesClientListBySubscriptionResponse{
		// 	PartnerNamespacesListResult: armeventgrid.PartnerNamespacesListResult{
		// 		Value: []*armeventgrid.PartnerNamespace{
		// 			{
		// 				Name: to.Ptr("partnerNamespace123"),
