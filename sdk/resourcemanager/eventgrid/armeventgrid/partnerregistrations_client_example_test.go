...
func ExamplePartnerRegistrationsClient_Get() {
	...
	res, err := client.Get(ctx, "examplerg", "examplePartnerRegistrationName1", nil)
	if err != nil {
...
func ExamplePartnerRegistrationsClient_BeginDelete() {
	...
	poller, err := client.BeginDelete(ctx, "examplerg", "examplePartnerRegistrationName1", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
...
func ExamplePartnerRegistrationsClient_BeginUpdate() {
	...
	poller, err := client.BeginUpdate(ctx, "examplerg", "examplePartnerRegistrationName1", armeventgrid.PartnerRegistrationUpdateParameters{
...
func ExamplePartnerRegistrationsClient_NewListByResourceGroupPager() {
	...
	pager := client.NewListByResourceGroupPager("examplerg", &armeventgrid.PartnerRegistrationsClientListByResourceGroupOptions{Filter: nil,
		Top: nil,
	})
	for pager.More() {
		nextResult, err := pager.NextPage(ctx)
