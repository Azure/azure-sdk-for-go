...
func ExamplePartnerTopicEventSubscriptionsClient_NewGetDeliveryAttributesPager() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	pager := clientFactory.NewPartnerTopicEventSubscriptionsClient().NewGetDeliveryAttributesPager("examplerg", "examplePartnerTopic1", "examplesubscription1", nil)
	for pager.More() {
		...
		// page = armeventgrid.PartnerTopicEventSubscriptionsClientGetDeliveryAttributesResponse{
