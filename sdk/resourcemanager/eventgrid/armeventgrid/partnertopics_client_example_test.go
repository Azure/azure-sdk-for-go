...
func ExamplePartnerTopicsClient_Get() {
	...
	res, err := client.Get(ctx, "examplerg", "examplePartnerTopicName1", nil)
	if err != nil {
...
func ExamplePartnerTopicsClient_CreateOrUpdate() {
	...
	res, err := client.CreateOrUpdate(ctx, "examplerg", "examplePartnerTopicName1", armeventgrid.PartnerTopic{
...
func ExamplePartnerTopicsClient_BeginDelete() {
	...
	poller, err := client.BeginDelete(ctx, "examplerg", "examplePartnerTopicName1", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
...
func ExamplePartnerTopicsClient_NewListByResourceGroupPager() {
	...
	pager := client.NewListByResourceGroupPager("examplerg", &armeventgrid.PartnerTopicsClientListByResourceGroupOptions{Filter: nil,
		Top: nil,
	})
	for pager.More() {
		nextResult, err := pager.NextPage(ctx)
...
func ExamplePartnerTopicsClient_Activate() {
	...
	res, err := client.Activate(ctx, "examplerg", "examplePartnerTopic1", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// TODO: use response item
...
func ExamplePartnerTopicsClient_Deactivate() {
	...
	res, err := client.Deactivate(ctx, "examplerg", "examplePartnerTopic1", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// TODO: use response item
