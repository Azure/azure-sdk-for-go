...
// BeginCreateOrUpdate - Create or update a permission binding.
//
...
// BeginDelete - Delete a permission binding.
//
...
func (client *PermissionBindingsClient) getHandleResponse(resp *http.Response, successCodes ...int) (PermissionBindingsClientGetResponse, error) {
...
func (client *PermissionBindingsClient) listByNamespaceCreateRequest(ctx context.Context, resourceGroupName string, namespaceName string, nextLink string, options *PermissionBindingsClientListByNamespaceOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *PermissionBindingsClient) listByNamespaceHandleResponse(resp *http.Response, successCodes ...int) (PermissionBindingsClientListByNamespaceResponse, error) {
