...
func ExamplePrivateEndpointConnectionsClient_BeginDelete() {
	...
	poller, err := client.BeginDelete(ctx, "examplerg", armeventgrid.ParentTypeTopics, "exampletopic1", "BMTPE5.8A30D251-4C61-489D-A1AA-B37C4A329B8B", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
...
func ExamplePrivateEndpointConnectionsClient_NewListByResourcePager() {
	...
	pager := client.NewListByResourcePager("examplerg", armeventgrid.ParentTypeTopics, "exampletopic1", &armeventgrid.PrivateEndpointConnectionsClientListByResourceOptions{Filter: nil,
		Top: nil,
	})
	for pager.More() {
