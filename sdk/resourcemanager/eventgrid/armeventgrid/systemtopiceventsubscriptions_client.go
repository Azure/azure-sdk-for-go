...
//   - systemTopicName - Name of the system topic.
//   - eventSubscriptionName - Name of the event subscription to be found.
//   - options - SystemTopicEventSubscriptionsClientGetDeliveryAttributesOptions contains the optional parameters for the SystemTopicEventSubscriptionsClient.NewGetDeliveryAttributesPager
//     method.
func (client *SystemTopicEventSubscriptionsClient) NewGetDeliveryAttributesPager(resourceGroupName string, systemTopicName string, eventSubscriptionName string, options *SystemTopicEventSubscriptionsClientGetDeliveryAttributesOptions) *runtime.Pager[SystemTopicEventSubscriptionsClientGetDeliveryAttributesResponse] {
	return runtime.NewPager(runtime.PagingHandler[SystemTopicEventSubscriptionsClientGetDeliveryAttributesResponse]{
		More: func(page SystemTopicEventSubscriptionsClientGetDeliveryAttributesResponse) bool {
			return false
		},
		Fetcher: func(ctx context.Context, page *SystemTopicEventSubscriptionsClientGetDeliveryAttributesResponse) (SystemTopicEventSubscriptionsClientGetDeliveryAttributesResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "SystemTopicEventSubscriptionsClient.NewGetDeliveryAttributesPager")
