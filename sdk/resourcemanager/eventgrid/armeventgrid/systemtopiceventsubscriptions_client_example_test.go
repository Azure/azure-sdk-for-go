...
func ExampleSystemTopicEventSubscriptionsClient_BeginDelete() {
	...
	// res = armeventgrid.SystemTopicEventSubscriptionsClientDeleteResponse{
	// }
}
...
func ExampleSystemTopicEventSubscriptionsClient_NewGetDeliveryAttributesPager() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	pager := clientFactory.NewSystemTopicEventSubscriptionsClient().NewGetDeliveryAttributesPager("examplerg", "exampleSystemTopic1", "examplesubscription1", nil)
	for pager.More() {
		...
		// page = armeventgrid.SystemTopicEventSubscriptionsClientGetDeliveryAttributesResponse{
...
func ExampleSystemTopicEventSubscriptionsClient_NewListBySystemTopicPager() {
	...
	pager := clientFactory.NewSystemTopicEventSubscriptionsClient().NewListBySystemTopicPager("examplerg", "exampleSystemTopic1", nil)
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armeventgrid.SystemTopicEventSubscriptionsClientListBySystemTopicResponse{
