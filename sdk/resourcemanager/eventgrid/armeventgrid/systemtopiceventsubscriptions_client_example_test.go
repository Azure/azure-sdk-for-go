...
func ExampleSystemTopicEventSubscriptionsClient_Get() {
	...
	res, err := client.Get(ctx, "examplerg", "exampleSystemTopic1", "examplesubscription1", nil)
	if err != nil {
...
func ExampleSystemTopicEventSubscriptionsClient_BeginCreateOrUpdate() {
	...
	poller, err := client.BeginCreateOrUpdate(ctx, "examplerg", "exampleSystemTopic1", "exampleEventSubscriptionName1", armeventgrid.EventSubscription{
...
func ExampleSystemTopicEventSubscriptionsClient_BeginDelete() {
	...
	poller, err := client.BeginDelete(ctx, "examplerg", "exampleSystemTopic1", "examplesubscription1", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	_, err = poller.PollUntilDone(ctx, nil)
...
func ExampleSystemTopicEventSubscriptionsClient_BeginUpdate() {
	...
	poller, err := client.BeginUpdate(ctx, "examplerg", "exampleSystemTopic1", "exampleEventSubscriptionName1", armeventgrid.EventSubscriptionUpdateParameters{
		Destination: &armeventgrid.WebHookEventSubscriptionDestination{
			EndpointType: to.Ptr(armeventgrid.EndpointTypeWebHook),
			Properties: &armeventgrid.WebHookEventSubscriptionDestinationProperties{
				EndpointURL: to.Ptr("https://requestb.in/15ksip71"),
...
// Generated from example definition: https://github.com/Azure/azure-rest-api-specs/tree/main/specification/eventgrid/resource-manager/Microsoft.EventGrid/preview/2021-10-15-preview/examples/SystemTopicEventSubscriptions_GetFullUrl.json
func ExampleSystemTopicEventSubscriptionsClient_GetFullURL() {
	...
	res, err := client.GetFullURL(ctx, "examplerg", "exampleSystemTopic1", "examplesubscription1", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// TODO: use response item
...
func ExampleSystemTopicEventSubscriptionsClient_NewListBySystemTopicPager() {
	...
	pager := client.NewListBySystemTopicPager("examplerg", "exampleSystemTopic1", &armeventgrid.SystemTopicEventSubscriptionsClientListBySystemTopicOptions{Filter: nil,
		Top: nil,
	})
	for pager.More() {
...
func ExampleSystemTopicEventSubscriptionsClient_GetDeliveryAttributes() {
	...
	res, err := client.GetDeliveryAttributes(ctx, "examplerg", "exampleSystemTopic1", "examplesubscription1", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// TODO: use response item
