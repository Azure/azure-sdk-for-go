...
// BeginCreateOrUpdate - Create a system topic.
//
...
// BeginDelete - Delete a system topic.
//
...
func (client *SystemTopicsClient) getHandleResponse(resp *http.Response, successCodes ...int) (SystemTopicsClientGetResponse, error) {
...
// NewListByResourceGroupPager - List system topics under a resource group.
//
...
func (client *SystemTopicsClient) listByResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, nextLink string, options *SystemTopicsClientListByResourceGroupOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *SystemTopicsClient) listByResourceGroupHandleResponse(resp *http.Response, successCodes ...int) (SystemTopicsClientListByResourceGroupResponse, error) {
...
// NewListBySubscriptionPager - List system topics under an Azure subscription.
//
...
func (client *SystemTopicsClient) listBySubscriptionCreateRequest(ctx context.Context, nextLink string, options *SystemTopicsClientListBySubscriptionOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
	var req *policy.Request
	var err error
	if firstPage {
...
func (client *SystemTopicsClient) listBySubscriptionHandleResponse(resp *http.Response, successCodes ...int) (SystemTopicsClientListBySubscriptionResponse, error) {
