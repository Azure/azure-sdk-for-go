...
func ExampleTopicsClient_Get() {
	...
	res, err := client.Get(ctx, "examplerg", "exampletopic2", nil)
	if err != nil {
...
func ExampleTopicsClient_BeginDelete() {
	...
	poller, err := client.BeginDelete(ctx, "examplerg1", "exampletopic1", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	_, err = poller.PollUntilDone(ctx, nil)
...
func ExampleTopicsClient_BeginUpdate() {
	...
	poller, err := client.BeginUpdate(ctx, "examplerg", "exampletopic1", armeventgrid.TopicUpdateParameters{
...
func ExampleTopicsClient_NewListByResourceGroupPager() {
	...
	pager := client.NewListByResourceGroupPager("examplerg", &armeventgrid.TopicsClientListByResourceGroupOptions{Filter: nil,
		Top: nil,
	})
	for pager.More() {
		nextResult, err := pager.NextPage(ctx)
...
func ExampleTopicsClient_ListSharedAccessKeys() {
	...
	res, err := client.ListSharedAccessKeys(ctx, "examplerg", "exampletopic2", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// TODO: use response item
...
func ExampleTopicsClient_BeginRegenerateKey() {
	...
	poller, err := client.BeginRegenerateKey(ctx, "examplerg", "exampletopic2", armeventgrid.TopicRegenerateKeyRequest{
		KeyName: to.Ptr("key1"),
	}, nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
