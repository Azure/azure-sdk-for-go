...
// Generated from example definition: 2026-07-01-preview/ApplicationGroup/ApplicationGroupCreate.json
func ExampleApplicationGroupClient_CreateOrUpdateApplicationGroup() {
	...
	// res = armeventhub.ApplicationGroupClientCreateOrUpdateApplicationGroupResponse{
	// 	ApplicationGroup: armeventhub.ApplicationGroup{
...
// Generated from example definition: 2026-07-01-preview/ApplicationGroup/ApplicationGroupDelete.json
func ExampleApplicationGroupClient_Delete() {
	...
	res, err := clientFactory.NewApplicationGroupClient().Delete(ctx, "contosotest", "contoso-ua-test-eh-system-1", "appGroup1", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armeventhub.ApplicationGroupClientDeleteResponse{
	// }
}

// Generated from example definition: 2026-07-01-preview/ApplicationGroup/ApplicationGroupGet.json
func ExampleApplicationGroupClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armeventhub.ApplicationGroupClientGetResponse{
	// 	ApplicationGroup: armeventhub.ApplicationGroup{
	// 		Name: to.Ptr("appGroup1"),
	// 		Type: to.Ptr("Microsoft.EventHub/Namespaces/ApplicationGroups"),
	// 		ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/contosotest/providers/Microsoft.EventHub/namespaces/contoso-ua-test-eh-system-1/applicationgroups/appGroup1"),
...
// Generated from example definition: 2026-07-01-preview/ApplicationGroup/ApplicationGroupListByNamespace.json
func ExampleApplicationGroupClient_NewListByNamespacePager() {
	...
	for pager.More() {
		...
		// page = armeventhub.ApplicationGroupClientListByNamespaceResponse{
		// 	ApplicationGroupListResult: armeventhub.ApplicationGroupListResult{
