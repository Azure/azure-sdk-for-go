...
// Generated from example definition: 2026-01-01/ConsumerGroup/EHConsumerGroupCreate.json
func ExampleConsumerGroupsClient_CreateOrUpdate() {
	...
	// res = armeventhub.ConsumerGroupsClientCreateOrUpdateResponse{
	// 	ConsumerGroup: armeventhub.ConsumerGroup{
...
// Generated from example definition: 2026-01-01/ConsumerGroup/EHConsumerGroupDelete.json
func ExampleConsumerGroupsClient_Delete() {
	...
	res, err := clientFactory.NewConsumerGroupsClient().Delete(ctx, "ArunMonocle", "sdk-Namespace-2661", "sdk-EventHub-6681", "sdk-ConsumerGroup-5563", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armeventhub.ConsumerGroupsClientDeleteResponse{
	// }
}

// Generated from example definition: 2026-01-01/ConsumerGroup/EHConsumerGroupGet.json
func ExampleConsumerGroupsClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armeventhub.ConsumerGroupsClientGetResponse{
	// 	ConsumerGroup: armeventhub.ConsumerGroup{
	// 		Name: to.Ptr("sdk-ConsumerGroup-5563"),
	// 		Type: to.Ptr("Microsoft.EventHub/Namespaces/EventHubs/ConsumerGroups"),
	// 		ID: to.Ptr("/subscriptions/5f750a97-50d9-4e36-8081-c9ee4c0210d4/resourceGroups/ArunMonocle/providers/Microsoft.EventHub/namespaces/sdk-Namespace-2661/eventhubs/sdk-EventHub-6681/consumergroups/sdk-ConsumerGroup-5563"),
...
// Generated from example definition: 2026-01-01/ConsumerGroup/EHConsumerGroupListByEventHub.json
func ExampleConsumerGroupsClient_NewListByEventHubPager() {
	...
	pager := clientFactory.NewConsumerGroupsClient().NewListByEventHubPager("ArunMonocle", "sdk-Namespace-2661", "sdk-EventHub-6681", nil)
	for pager.More() {
		...
		// page = armeventhub.ConsumerGroupsClientListByEventHubResponse{
