...
// Generated from example definition: 2026-07-01-preview/EventHubs/EHEventHubCreate.json
func ExampleEventHubsClient_CreateOrUpdate_ehEventHubCreate() {
	...
	// res = armeventhub.EventHubsClientCreateOrUpdateResponse{
	...
	// 				SizeLimitInBytes: to.Ptr[int32](10485763),
	// 			},
	// 			CreatedAt: to.Ptr(time.Date(2017, time.June, 28, 2, 45, 55, 877000000, time.UTC)),
	...
	// 			},
	// 			Status: to.Ptr(armeventhub.EntityStatusActive),
	// 			UpdatedAt: to.Ptr(time.Date(2017, time.June, 28, 2, 46, 5, 877000000, time.UTC)),
	// 			UserMetadata: to.Ptr("key"),
	// 		},
	// 	},
	// }
...
// Generated from example definition: 2026-07-01-preview/EventHubs/EHEventHubWithCompactPolicyCreate.json
...
// Generated from example definition: 2026-07-01-preview/EventHubs/EHEventHubWithDeleteOrCompactPolicyCreate.json
...
// Generated from example definition: 2026-07-01-preview/EventHubs/EHEventHubWithDeletePolicyCreate.json
...
// Generated from example definition: 2026-07-01-preview/EventHubs/EHEventHubAuthorizationRuleCreate.json
func ExampleEventHubsClient_CreateOrUpdateAuthorizationRule() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armeventhub.EventHubsClientCreateOrUpdateAuthorizationRuleResponse{
	// 	AuthorizationRule: armeventhub.AuthorizationRule{
...
// Generated from example definition: 2026-07-01-preview/EventHubs/EHEventHubDelete.json
func ExampleEventHubsClient_Delete() {
	...
	res, err := clientFactory.NewEventHubsClient().Delete(ctx, "ArunMonocle", "sdk-Namespace-5357", "sdk-EventHub-6547", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armeventhub.EventHubsClientDeleteResponse{
	// }
}

// Generated from example definition: 2026-07-01-preview/EventHubs/EHEventHubAuthorizationRuleDelete.json
func ExampleEventHubsClient_DeleteAuthorizationRule() {
	...
	res, err := clientFactory.NewEventHubsClient().DeleteAuthorizationRule(ctx, "ArunMonocle", "sdk-Namespace-960", "sdk-EventHub-532", "sdk-Authrules-2513", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armeventhub.EventHubsClientDeleteAuthorizationRuleResponse{
	// }
}

// Generated from example definition: 2026-07-01-preview/EventHubs/EHEventHubGet.json
func ExampleEventHubsClient_Get() {
	...
	ctx := context.Background()
	clientFactory, err := armeventhub.NewClientFactory("e2f361f0-3b27-4503-a9cc-21cfba380093", cred, nil)
	if err != nil {
		log.Fatalf("failed to create client: %v", err)
	}
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armeventhub.EventHubsClientGetResponse{
	// 	Eventhub: armeventhub.Eventhub{
	// 		Name: to.Ptr("sdk-EventHub-10"),
	// 		Type: to.Ptr("Microsoft.EventHub/Namespaces/EventHubs"),
	// 		ID: to.Ptr("/subscriptions/e2f361f0-3b27-4503-a9cc-21cfba380093/resourceGroups/Default-NotificationHubs-AustraliaEast/providers/Microsoft.EventHub/namespaces/sdk-Namespace-716/eventhubs/sdk-EventHub-10"),
...
// Generated from example definition: 2026-07-01-preview/EventHubs/EHEventHubAuthorizationRuleGet.json
func ExampleEventHubsClient_GetAuthorizationRule() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armeventhub.EventHubsClientGetAuthorizationRuleResponse{
	// 	AuthorizationRule: armeventhub.AuthorizationRule{
	// 		Name: to.Ptr("sdk-Authrules-2513"),
	// 		Type: to.Ptr("Microsoft.EventHub/Namespaces/EventHubs/AuthorizationRules"),
	// 		ID: to.Ptr("/subscriptions/5f750a97-50d9-4e36-8081-c9ee4c0210d4/resourceGroups/ArunMonocle/providers/Microsoft.EventHub/namespaces/sdk-Namespace-960/eventhubs/sdk-EventHub-532/authorizationRules/sdk-Authrules-2513"),
...
// Generated from example definition: 2026-07-01-preview/EventHubs/EHEventHubAuthorizationRuleListAll.json
func ExampleEventHubsClient_NewListAuthorizationRulesPager() {
	...
	for pager.More() {
		...
		// page = armeventhub.EventHubsClientListAuthorizationRulesResponse{
		// 	AuthorizationRuleListResult: armeventhub.AuthorizationRuleListResult{
...
// Generated from example definition: 2026-07-01-preview/EventHubs/EHEventHubListByNameSpace.json
func ExampleEventHubsClient_NewListByNamespacePager() {
	...
	pager := clientFactory.NewEventHubsClient().NewListByNamespacePager("Default-NotificationHubs-AustraliaEast", "sdk-Namespace-5357", nil)
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armeventhub.EventHubsClientListByNamespaceResponse{
...
// Generated from example definition: 2026-07-01-preview/EventHubs/EHEventHubAuthorizationRuleListKey.json
func ExampleEventHubsClient_ListKeys() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armeventhub.EventHubsClientListKeysResponse{
...
// Generated from example definition: 2026-07-01-preview/EventHubs/EHEventHubAuthorizationRuleRegenerateKey.json
func ExampleEventHubsClient_RegenerateKeys() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armeventhub.EventHubsClientRegenerateKeysResponse{
	// 	AccessKeys: armeventhub.AccessKeys{
