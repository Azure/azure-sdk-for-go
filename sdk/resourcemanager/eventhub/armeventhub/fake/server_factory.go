...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "ApplicationGroupClient":
		initServer(&s.trMu, &s.trApplicationGroupServer, func() *ApplicationGroupServerTransport {
	...
	case "ConfigurationClient":
		initServer(&s.trMu, &s.trConfigurationServer, func() *ConfigurationServerTransport {
	...
	case "ConsumerGroupsClient":
		initServer(&s.trMu, &s.trConsumerGroupsServer, func() *ConsumerGroupsServerTransport {
	...
	case "SchemaRegistryClient":
		initServer(&s.trMu, &s.trSchemaRegistryServer, func() *SchemaRegistryServerTransport {
