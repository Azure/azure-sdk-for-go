...
// ApplicationGroupListResult - The response of a ApplicationGroup list operation.
...
// ConsumerGroupListResult - The response of a ConsumerGroup list operation.
type ConsumerGroupListResult struct {
	// REQUIRED; The ConsumerGroup items on this page
	Value []*ConsumerGroup
...
// EHNamespaceListResult - The response of a EHNamespace list operation.
type EHNamespaceListResult struct {
	// REQUIRED; The EHNamespace items on this page
	Value []*EHNamespace
...
// ListResult - Paged collection of Eventhub items
type ListResult struct {
	// REQUIRED; The Eventhub items on this page
	Value []*Eventhub
...
type MessageTimestampDescription struct {
	...
	// generated on source side and producers can set this timestamp while sending the message. Default value is AppendTime. If
	// you are using AMQP protocol, CreateTime equals AppendTime and its behavior remains the same.
...
// NetworkRuleSetListResult - Paged collection of NetworkRuleSet items
...
// PrivateLinkResourcesListResult - Paged collection of PrivateLinkResource items
...
type Properties struct {
	...
	// can be used in kafka runtime apis wherever a UUID is required e.g Fetch & Delete Topic. This identifier is not supported
	// in AMQP runtime operations yet.
	Identifier *string
...
// SchemaGroupListResult - The response of a SchemaGroup list operation.
type SchemaGroupListResult struct {
	// REQUIRED; The SchemaGroup items on this page
	Value []*SchemaGroup
...
type ThrottlingPolicy struct {
	...
	// CONSTANT; Application Group Policy types
	// Field has constant value ApplicationGroupPolicyTypeThrottlingPolicy, any specified value is ignored.
	Type *ApplicationGroupPolicyType
}
