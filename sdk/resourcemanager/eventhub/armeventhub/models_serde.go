...
func (r RetentionDescription) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "minCompactionLagTimeInMinutes", r.MinCompactionLagTimeInMinutes)
...
func (r *RetentionDescription) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "minCompactionLagTimeInMinutes":
			err = unpopulate(val, "MinCompactionLagTimeInMinutes", &r.MinCompactionLagTimeInMinutes)
			delete(rawMsg, key)
