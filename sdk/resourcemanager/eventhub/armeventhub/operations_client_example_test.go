...
// Generated from example definition: 2025-05-01-preview/EHOperations_List.json
func ExampleOperationsClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armeventhub.OperationsClientListResponse{
		// 	OperationListResult: armeventhub.OperationListResult{
