...
func ExamplePrivateEndpointConnectionsClient_CreateOrUpdate() {
	...
	// res = armeventhub.PrivateEndpointConnectionsClientCreateOrUpdateResponse{
...
func ExamplePrivateEndpointConnectionsClient_BeginDelete() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armeventhub.PrivateEndpointConnectionsClientDeleteResponse{
	// }
}
...
func ExamplePrivateEndpointConnectionsClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armeventhub.PrivateEndpointConnectionsClientGetResponse{
	// 	PrivateEndpointConnection: &armeventhub.PrivateEndpointConnection{
...
func ExamplePrivateEndpointConnectionsClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armeventhub.PrivateEndpointConnectionsClientListResponse{
		// 	PrivateEndpointConnectionListResult: armeventhub.PrivateEndpointConnectionListResult{
