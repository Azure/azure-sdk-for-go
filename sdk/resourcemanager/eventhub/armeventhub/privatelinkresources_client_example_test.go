...
func ExamplePrivateLinkResourcesClient_Get() {
	...
	clientFactory, err := armeventhub.NewClientFactory("subID", cred, nil)
	if err != nil {
	...
	// res = armeventhub.PrivateLinkResourcesClientGetResponse{
	// 	PrivateLinkResourcesListResult: &armeventhub.PrivateLinkResourcesListResult{
