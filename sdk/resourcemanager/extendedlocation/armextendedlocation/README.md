...
```sh
go get github.com/Azure/azure-sdk-for-go/sdk/resourcemanager/extendedlocation/armextendedlocation/v2
```
...
Azure Extended Location module consists of one or more clients. We provide a client factory which could be used to create any client in this module.
...
[open an issue](https://github.com/Azure/azure-sdk-for-go/issues) and assign the `Extended Location` label.
