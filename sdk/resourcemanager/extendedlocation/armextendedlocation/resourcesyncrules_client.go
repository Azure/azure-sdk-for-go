...
// BeginCreateOrUpdate - Creates or updates a Resource Sync Rule.
//
...
// CreateOrUpdate - Creates or updates a Resource Sync Rule.
//
// Creates or updates a Resource Sync Rule in the parent Custom Location, Subscription Id and Resource Group
// If the operation fails it returns an *azcore.ResponseError type.
...
// Delete - Deletes a Resource Sync Rule.
//
...
func (client *ResourceSyncRulesClient) Delete(ctx context.Context, resourceGroupName string, resourceName string, childResourceName string, options *ResourceSyncRulesClientDeleteOptions) (ResourceSyncRulesClientDeleteResponse, error) {
	...
	if !runtime.HasStatusCode(httpResp, http.StatusOK, http.StatusNoContent) {
		return ResourceSyncRulesClientDeleteResponse{}, runtime.NewResponseError(httpResp)
	}
...
func (client *ResourceSyncRulesClient) getHandleResponse(resp *http.Response, successCodes ...int) (ResourceSyncRulesClientGetResponse, error) {
...
// NewListByCustomLocationIDPager - Lists all Resource Sync Rules in a Custom Location.
//
...
func (client *ResourceSyncRulesClient) NewListByCustomLocationIDPager(resourceGroupName string, resourceName string, options *ResourceSyncRulesClientListByCustomLocationIDOptions) *runtime.Pager[ResourceSyncRulesClientListByCustomLocationIDResponse] {
	return runtime.NewPager(runtime.PagingHandler[ResourceSyncRulesClientListByCustomLocationIDResponse]{
		...
		Fetcher: func(ctx context.Context, page *ResourceSyncRulesClientListByCustomLocationIDResponse) (ResourceSyncRulesClientListByCustomLocationIDResponse, error) {
			...
			req, err := client.listByCustomLocationIDCreateRequest(ctx, resourceGroupName, resourceName, nextLink, options)
			if err != nil {
			...
			return client.listByCustomLocationIDHandleResponse(resp, http.StatusOK)
		},
		Tracer: client.internal.Tracer(),
	})
}
...
func (client *ResourceSyncRulesClient) listByCustomLocationIDCreateRequest(ctx context.Context, resourceGroupName string, resourceName string, nextLink string, _ *ResourceSyncRulesClientListByCustomLocationIDOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *ResourceSyncRulesClient) listByCustomLocationIDHandleResponse(resp *http.Response, successCodes ...int) (ResourceSyncRulesClientListByCustomLocationIDResponse, error) {
...
// BeginUpdate - Updates a Resource Sync Rule.
//
// Updates a Resource Sync Rule with the specified Resource Sync Rule name in the specified Resource Group, Subscription and
...
// Update - Updates a Resource Sync Rule.
//
// Updates a Resource Sync Rule with the specified Resource Sync Rule name in the specified Resource Group, Subscription and
// Custom Location name.
// If the operation fails it returns an *azcore.ResponseError type.
