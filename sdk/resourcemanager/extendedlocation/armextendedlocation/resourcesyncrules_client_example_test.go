...
// Generated from example definition: 2021-08-31-preview/ResourceSyncRulesCreate_Update.json
func ExampleResourceSyncRulesClient_BeginCreateOrUpdate() {
	...
	// res = armextendedlocation.ResourceSyncRulesClientCreateOrUpdateResponse{
	...
	// 			CreatedAt: to.Ptr(time.Date(2021, time.July, 15, 18, 53, 29, 92800100, time.UTC)),
	// 			CreatedBy: to.Ptr("string"),
	// 			CreatedByType: to.Ptr(armextendedlocation.CreatedByTypeApplication),
	// 			LastModifiedAt: to.Ptr(time.Date(2021, time.July, 15, 18, 53, 29, 92800100, time.UTC)),
...
// Generated from example definition: 2021-08-31-preview/ResourceSyncRulesDelete.json
func ExampleResourceSyncRulesClient_Delete() {
	...
	res, err := clientFactory.NewResourceSyncRulesClient().Delete(ctx, "testresourcegroup", "customLocation01", "resourceSyncRule01", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armextendedlocation.ResourceSyncRulesClientDeleteResponse{
	// }
}

// Generated from example definition: 2021-08-31-preview/ResourceSyncRulesGet.json
func ExampleResourceSyncRulesClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armextendedlocation.ResourceSyncRulesClientGetResponse{
	// 	ResourceSyncRule: armextendedlocation.ResourceSyncRule{
	// 		Name: to.Ptr("resourceSyncRule01"),
	// 		Type: to.Ptr("Microsoft.ExtendedLocation/customLocations/resourceSyncRules"),
	// 		ID: to.Ptr("/subscriptions/11111111-2222-3333-4444-555555555555/resourceGroups/testresourcegroup/providers/Microsoft.ExtendedLocation/customLocations/customLocation01/resourceSyncRules/resourceSyncRule01"),
	...
	// 		},
	// 		SystemData: &armextendedlocation.SystemData{
	// 			CreatedAt: to.Ptr(time.Date(2020, time.April, 24, 18, 53, 29, 92800100, time.UTC)),
	// 			CreatedBy: to.Ptr("string"),
	// 			CreatedByType: to.Ptr(armextendedlocation.CreatedByTypeApplication),
	// 			LastModifiedAt: to.Ptr(time.Date(2020, time.April, 24, 18, 53, 29, 92800100, time.UTC)),
	// 			LastModifiedBy: to.Ptr("string"),
	// 			LastModifiedByType: to.Ptr(armextendedlocation.CreatedByTypeApplication),
	// 		},
	// 	},
...
// Generated from example definition: 2021-08-31-preview/ResourceSyncRulesListByCustomLocationID.json
func ExampleResourceSyncRulesClient_NewListByCustomLocationIDPager() {
	...
	for pager.More() {
		...
		// page = armextendedlocation.ResourceSyncRulesClientListByCustomLocationIDResponse{
		// 	ResourceSyncRuleListResult: armextendedlocation.ResourceSyncRuleListResult{
		...
		// 				},
		// 				SystemData: &armextendedlocation.SystemData{
		// 					CreatedAt: to.Ptr(time.Date(2021, time.July, 16, 18, 53, 29, 92800100, time.UTC)),
		// 					CreatedBy: to.Ptr("string"),
		// 					CreatedByType: to.Ptr(armextendedlocation.CreatedByTypeApplication),
		// 					LastModifiedAt: to.Ptr(time.Date(2021, time.July, 16, 18, 53, 29, 92800100, time.UTC)),
		// 					LastModifiedBy: to.Ptr("string"),
		// 					LastModifiedByType: to.Ptr(armextendedlocation.CreatedByTypeApplication),
		// 				},
		// 			},
...
func ExampleResourceSyncRulesClient_BeginUpdate() {
	...
	// 		},
	// 		SystemData: &armextendedlocation.SystemData{
	// 			CreatedAt: to.Ptr(time.Date(2021, time.July, 16, 23, 17, 11, 735322900, time.UTC)),
	// 			CreatedBy: to.Ptr("string"),
	// 			CreatedByType: to.Ptr(armextendedlocation.CreatedByTypeApplication),
	// 			LastModifiedAt: to.Ptr(time.Date(2021, time.July, 16, 23, 28, 0, 587085200, time.UTC)),
	// 			LastModifiedBy: to.Ptr("string"),
	// 			LastModifiedByType: to.Ptr(armextendedlocation.CreatedByTypeApplication),
	// 		},
	// 		Tags: map[string]*string{
