...
// EncryptionInTransitRequired - State of NFS encryption in transit.
type EncryptionInTransitRequired string

const (
	// EncryptionInTransitRequiredDisabled - Encryption in Transit is disabled.
	EncryptionInTransitRequiredDisabled EncryptionInTransitRequired = "Disabled"
	// EncryptionInTransitRequiredEnabled - Encryption in Transit is enabled.
	EncryptionInTransitRequiredEnabled EncryptionInTransitRequired = "Enabled"
)

// PossibleEncryptionInTransitRequiredValues returns the possible values for the EncryptionInTransitRequired const type.
func PossibleEncryptionInTransitRequiredValues() []EncryptionInTransitRequired {
	return []EncryptionInTransitRequired{
		EncryptionInTransitRequiredDisabled,
		EncryptionInTransitRequiredEnabled,
	}
}
