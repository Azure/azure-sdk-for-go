...
func (f FileShareProperties) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "provisionedIOPerSecNextAllowedDowngrade", f.ProvisionedIOPerSecNextAllowedDowngrade, true)
	populate(objectMap, "provisionedStorageGiB", f.ProvisionedStorageGiB)
	populateTime[datetime.RFC3339](objectMap, "provisionedStorageNextAllowedDowngrade", f.ProvisionedStorageNextAllowedDowngrade, true)
	populate(objectMap, "provisionedThroughputMiBPerSec", f.ProvisionedThroughputMiBPerSec)
	populateTime[datetime.RFC3339](objectMap, "provisionedThroughputNextAllowedDowngrade", f.ProvisionedThroughputNextAllowedDowngrade, true)
...
func (f FileShareProvisioningConstants) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "guardrailIOPerSecScalar", f.GuardrailIOPerSecScalar)
	populate(objectMap, "guardrailThroughputScalar", f.GuardrailThroughputScalar)
...
func (f *FileShareProvisioningConstants) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "baseThroughputMiBPerSec":
			...
			delete(rawMsg, key)
		case "guardrailIOPerSecScalar":
			err = unpopulate(val, "GuardrailIOPerSecScalar", &f.GuardrailIOPerSecScalar)
			delete(rawMsg, key)
		case "guardrailThroughputScalar":
			err = unpopulate(val, "GuardrailThroughputScalar", &f.GuardrailThroughputScalar)
			delete(rawMsg, key)
		case "scalarIOPerSec":
...
func (n NfsProtocolProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "encryptionInTransitRequired", n.EncryptionInTransitRequired)
...
func (n *NfsProtocolProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		var err error
		switch key {
		case "encryptionInTransitRequired":
			err = unpopulate(val, "EncryptionInTransitRequired", &n.EncryptionInTransitRequired)
			delete(rawMsg, key)
		case "rootSquash":
