...
func (f *FluxConfigOperationStatusServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if fluxConfigOperationStatusServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = fluxConfigOperationStatusServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to FluxConfigOperationStatusServerTransport
var fluxConfigOperationStatusServerTransportInterceptor interface {
