...
```sh
go get github.com/Azure/azure-sdk-for-go/sdk/resourcemanager/frontdoor/armfrontdoor/v2
```
...
[open an issue](https://github.com/Azure/azure-sdk-for-go/issues) and assign the `Front Door` label.
