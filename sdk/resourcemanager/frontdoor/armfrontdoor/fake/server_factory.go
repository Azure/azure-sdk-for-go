...
type ServerFactory struct {
	...
	// FrontDoorsServer contains the fakes for client FrontDoorsClient
	FrontDoorsServer FrontDoorsServer

	// FrontendEndpointsServer contains the fakes for client FrontendEndpointsClient
	...
	// NameAvailabilityWithSubscriptionServer contains the fakes for client NameAvailabilityWithSubscriptionClient
	NameAvailabilityWithSubscriptionServer NameAvailabilityWithSubscriptionServer

	// NetworkExperimentProfilesServer contains the fakes for client NetworkExperimentProfilesClient
	...
	// PreconfiguredEndpointsServer contains the fakes for client PreconfiguredEndpointsClient
	...
	// RulesEnginesServer contains the fakes for client RulesEnginesClient
...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "FrontDoorsClient":
		initServer(&s.trMu, &s.trFrontDoorsServer, func() *FrontDoorsServerTransport { return NewFrontDoorsServerTransport(&s.srv.FrontDoorsServer) })
		resp, err = s.trFrontDoorsServer.Do(req)
	case "FrontendEndpointsClient":
		initServer(&s.trMu, &s.trFrontendEndpointsServer, func() *FrontendEndpointsServerTransport {
	...
	case "NameAvailabilityWithSubscriptionClient":
		initServer(&s.trMu, &s.trNameAvailabilityWithSubscriptionServer, func() *NameAvailabilityWithSubscriptionServerTransport {
	...
	case "NetworkExperimentProfilesClient":
		initServer(&s.trMu, &s.trNetworkExperimentProfilesServer, func() *NetworkExperimentProfilesServerTransport {
	...
	case "PreconfiguredEndpointsClient":
		initServer(&s.trMu, &s.trPreconfiguredEndpointsServer, func() *PreconfiguredEndpointsServerTransport {
	...
	case "RulesEnginesClient":
		initServer(&s.trMu, &s.trRulesEnginesServer, func() *RulesEnginesServerTransport { return NewRulesEnginesServerTransport(&s.srv.RulesEnginesServer) })
