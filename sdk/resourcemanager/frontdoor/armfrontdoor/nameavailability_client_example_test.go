...
// Generated from example definition: 2026-04-01/CheckFrontdoorNameAvailability.json
func ExampleNameAvailabilityClient_Check() {
	...
	clientFactory, err := armfrontdoor.NewClientFactory("<subscriptionID>", cred, nil)
	if err != nil {
