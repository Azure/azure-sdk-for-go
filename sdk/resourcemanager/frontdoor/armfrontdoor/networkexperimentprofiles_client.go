...
//     method.
func (client *NetworkExperimentProfilesClient) BeginCreateOrUpdate(ctx context.Context, resourceGroupName string, profileName string, parameters Profile, options *NetworkExperimentProfilesClientBeginCreateOrUpdateOptions) (*runtime.Poller[NetworkExperimentProfilesClientCreateOrUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.createOrUpdate(ctx, resourceGroupName, profileName, parameters, options)
		if err != nil {
			return nil, err
		}
...
//
// Generated from API version 2025-10-01
func (client *NetworkExperimentProfilesClient) createOrUpdate(ctx context.Context, resourceGroupName string, profileName string, parameters Profile, options *NetworkExperimentProfilesClientBeginCreateOrUpdateOptions) (*http.Response, error) {
	var err error
...
func (client *NetworkExperimentProfilesClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, profileName string, parameters Profile, _ *NetworkExperimentProfilesClientBeginCreateOrUpdateOptions) (*policy.Request, error) {
...
// BeginUpdate - Updates an NetworkExperimentProfiles by NetworkExperimentProfile name
//
...
// Update - Updates an NetworkExperimentProfiles by NetworkExperimentProfile name
//
// Updates an NetworkExperimentProfiles
// If the operation fails it returns an *azcore.ResponseError type.
//
