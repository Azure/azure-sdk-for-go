...
func (client *PreconfiguredEndpointsClient) NewListPager(resourceGroupName string, profileName string, options *PreconfiguredEndpointsClientListOptions) *runtime.Pager[PreconfiguredEndpointsClientListResponse] {
	return runtime.NewPager(runtime.PagingHandler[PreconfiguredEndpointsClientListResponse]{
		...
		Fetcher: func(ctx context.Context, page *PreconfiguredEndpointsClientListResponse) (PreconfiguredEndpointsClientListResponse, error) {
			...
			req, err := client.listCreateRequest(ctx, resourceGroupName, profileName, nextLink, options)
			if err != nil {
...
func (client *PreconfiguredEndpointsClient) listCreateRequest(ctx context.Context, resourceGroupName string, profileName string, nextLink string, _ *PreconfiguredEndpointsClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *PreconfiguredEndpointsClient) listHandleResponse(resp *http.Response, successCodes ...int) (PreconfiguredEndpointsClientListResponse, error) {
