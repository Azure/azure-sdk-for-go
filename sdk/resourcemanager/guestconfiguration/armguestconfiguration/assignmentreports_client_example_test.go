...
func ExampleAssignmentReportsClient_Get() {
	...
	res, err := clientFactory.NewAssignmentReportsClient().Get(ctx, "myResourceGroupName", "myvm", "AuditSecureProtocol", "7367cbb8-ae99-47d0-a33b-a283564d2cb1", nil)
	if err != nil {
...
func ExampleAssignmentReportsClient_List() {
	...
	res, err := clientFactory.NewAssignmentReportsClient().List(ctx, "myResourceGroupName", "myVMName", "AuditSecureProtocol", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
