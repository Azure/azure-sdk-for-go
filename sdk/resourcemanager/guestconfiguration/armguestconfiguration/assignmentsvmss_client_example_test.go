...
// Generated from example definition: 2024-04-05/deleteGuestConfigurationVMSSAssignment.json
func ExampleAssignmentsVMSSClient_Delete() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armguestconfiguration.AssignmentsVMSSClientDeleteResponse{
	// 	Assignment: armguestconfiguration.Assignment{
	...
	// 				Version: to.Ptr("1.0.0.3"),
	// 			},
	// 			LastComplianceStatusChecked: to.Ptr(time.Date(2018, time.August, 29, 22, 14, 13, 0, time.UTC)),
	// 			LatestReportID: nil,
	// 			ProvisioningState: to.Ptr(armguestconfiguration.ProvisioningStateSucceeded),
...
// Generated from example definition: 2024-04-05/listVMSSGuestConfigurationAssignments.json
func ExampleAssignmentsVMSSClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armguestconfiguration.AssignmentsVMSSClientListResponse{
		...
		// 				ID: to.Ptr("/subscriptions/subscriptionId/resourceGroups/myResourceGroupName/providers/Microsoft.Compute/virtualMachineScaleSets/myVMSSName/providers/Microsoft.GuestConfiguration/guestConfigurationAssignments/AuditSecureProtocol2"),
		// 				Location: to.Ptr("centraluseuap"),
		// 				Properties: &armguestconfiguration.AssignmentProperties{
		...
		// 					},
		// 					LastComplianceStatusChecked: to.Ptr(time.Date(2018, time.August, 29, 22, 14, 13, 0, time.UTC)),
		// 					LatestReportID: to.Ptr("/subscriptions/subscriptionId/resourceGroups/myResourceGroupName/providers/Microsoft.Compute/virtualMachineScaleSets/myVMSSName/providers/Microsoft.GuestConfiguration/guestConfigurationAssignments/AuditSecureProtocol2/reports/7367cbb8-ae99-47d0-a33b-a283564d2cb1"),
		// 					ProvisioningState: nil,
		// 				},
		// 			},
		// 			{
		// 				Name: to.Ptr("myAssignment"),
		// 				ID: to.Ptr("/subscriptions/subscriptionId/resourceGroups/myResourceGroupName/providers/Microsoft.Compute/virtualMachineScaleSets/myVMSSName/providers/Microsoft.GuestConfiguration/guestConfigurationAssignments/myAssignment"),
		// 				Location: to.Ptr("centraluseuap"),
		// 				Properties: &armguestconfiguration.AssignmentProperties{
		// 					AssignmentHash: to.Ptr("content hash"),
		// 					ComplianceStatus: to.Ptr(armguestconfiguration.ComplianceStatusCompliant),
		...
		// 					},
		// 					LastComplianceStatusChecked: to.Ptr(time.Date(2018, time.August, 29, 22, 14, 13, 0, time.UTC)),
		// 					LatestReportID: to.Ptr("/subscriptions/subscriptionId/resourceGroups/myResourceGroupName/providers/Microsoft.Compute/virtualMachineScaleSets/myVMSSName/providers/Microsoft.GuestConfiguration/guestConfigurationAssignments/myAssignment/reports/7367cbb8-ae99-47d0-a33b-a283564d2cb1"),
		// 					ProvisioningState: nil,
		// 				},
		// 			},
		// 		},
