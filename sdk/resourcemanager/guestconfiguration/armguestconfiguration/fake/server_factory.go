...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "AssignmentReportsClient":
		initServer(&s.trMu, &s.trAssignmentReportsServer, func() *AssignmentReportsServerTransport {
	...
	case "AssignmentReportsVMSSClient":
		initServer(&s.trMu, &s.trAssignmentReportsVMSSServer, func() *AssignmentReportsVMSSServerTransport {
	...
	case "AssignmentsVMSSClient":
		initServer(&s.trMu, &s.trAssignmentsVMSSServer, func() *AssignmentsVMSSServerTransport {
	...
	case "ConnectedVMwarevSphereAssignmentsClient":
		initServer(&s.trMu, &s.trConnectedVMwarevSphereAssignmentsServer, func() *ConnectedVMwarevSphereAssignmentsServerTransport {
	...
	case "ConnectedVMwarevSphereAssignmentsReportsClient":
		initServer(&s.trMu, &s.trConnectedVMwarevSphereAssignmentsReportsServer, func() *ConnectedVMwarevSphereAssignmentsReportsServerTransport {
	...
	case "HCRPAssignmentReportsClient":
		initServer(&s.trMu, &s.trHCRPAssignmentReportsServer, func() *HCRPAssignmentReportsServerTransport {
	...
	case "HCRPAssignmentsClient":
		initServer(&s.trMu, &s.trHCRPAssignmentsServer, func() *HCRPAssignmentsServerTransport {
