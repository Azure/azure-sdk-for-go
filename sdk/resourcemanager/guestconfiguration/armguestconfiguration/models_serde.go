...
func (a AssignmentProperties) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "lastComplianceStatusChecked", a.LastComplianceStatusChecked, true)
...
func (a *AssignmentProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "lastComplianceStatusChecked":
			err = unpopulateTime[datetime.RFC3339](val, "LastComplianceStatusChecked", &a.LastComplianceStatusChecked)
			delete(rawMsg, key)
...
func (v VMSSVMInfo) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "lastComplianceChecked", v.LastComplianceChecked, true)
...
func (v *VMSSVMInfo) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "lastComplianceChecked":
			err = unpopulateTime[datetime.RFC3339](val, "LastComplianceChecked", &v.LastComplianceChecked)
			delete(rawMsg, key)
		case "latestReportId":
