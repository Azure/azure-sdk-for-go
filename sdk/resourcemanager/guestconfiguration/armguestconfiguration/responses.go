...
// AssignmentsVMSSClientCreateOrUpdateResponse contains the response from method AssignmentsVMSSClient.CreateOrUpdate.
type AssignmentsVMSSClientCreateOrUpdateResponse struct {
	// Guest configuration assignment is an association between a machine and guest configuration.
	Assignment
}
...
// ConnectedVMwarevSphereAssignmentsClientCreateOrUpdateResponse contains the response from method ConnectedVMwarevSphereAssignmentsClient.CreateOrUpdate.
type ConnectedVMwarevSphereAssignmentsClientCreateOrUpdateResponse struct {
	// Guest configuration assignment is an association between a machine and guest configuration.
	Assignment
}

// ConnectedVMwarevSphereAssignmentsClientDeleteResponse contains the response from method ConnectedVMwarevSphereAssignmentsClient.Delete.
type ConnectedVMwarevSphereAssignmentsClientDeleteResponse struct {
	// placeholder for future response values
}

// ConnectedVMwarevSphereAssignmentsClientGetResponse contains the response from method ConnectedVMwarevSphereAssignmentsClient.Get.
type ConnectedVMwarevSphereAssignmentsClientGetResponse struct {
	// Guest configuration assignment is an association between a machine and guest configuration.
	Assignment
}

// ConnectedVMwarevSphereAssignmentsClientListResponse contains the response from method ConnectedVMwarevSphereAssignmentsClient.NewListPager.
type ConnectedVMwarevSphereAssignmentsClientListResponse struct {
	// The response of the list guest configuration assignment operation.
	AssignmentList
}

// ConnectedVMwarevSphereAssignmentsReportsClientGetResponse contains the response from method ConnectedVMwarevSphereAssignmentsReportsClient.Get.
type ConnectedVMwarevSphereAssignmentsReportsClientGetResponse struct {
	// Report for the guest configuration assignment. Report contains information such as compliance status, reason, and more.
	AssignmentReport
}

// ConnectedVMwarevSphereAssignmentsReportsClientListResponse contains the response from method ConnectedVMwarevSphereAssignmentsReportsClient.List.
type ConnectedVMwarevSphereAssignmentsReportsClientListResponse struct {
	// List of guest configuration assignment reports.
	AssignmentReportList
}
