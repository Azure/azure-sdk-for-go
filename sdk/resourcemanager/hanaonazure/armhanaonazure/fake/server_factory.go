...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "ProviderInstancesClient":
		initServer(&s.trMu, &s.trProviderInstancesServer, func() *ProviderInstancesServerTransport {
	...
	case "SapMonitorsClient":
		initServer(&s.trMu, &s.trSapMonitorsServer, func() *SapMonitorsServerTransport { return NewSapMonitorsServerTransport(&s.srv.SapMonitorsServer) })
