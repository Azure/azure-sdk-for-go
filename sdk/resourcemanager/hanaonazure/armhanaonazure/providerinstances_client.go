...
// BeginCreate - Creates a provider instance.
//
...
func (client *ProviderInstancesClient) createCreateRequest(ctx context.Context, resourceGroupName string, sapMonitorName string, providerInstanceName string, providerInstanceParameter ProviderInstance, _ *ProviderInstancesClientBeginCreateOptions) (*policy.Request, error) {
	...
	reqQP.Set("api-version", version20200207Preview)
...
// BeginDelete - Deletes a provider instance.
//
// The product Microsoft.Workloads/sapMonitors (AMS Classic) is officially retired as of May 31, 2023.
// If the operation fails it returns an *azcore.ResponseError type.
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
...
// Delete - Deletes a provider instance.
//
// The product Microsoft.Workloads/sapMonitors (AMS Classic) is officially retired as of May 31, 2023.
// If the operation fails it returns an *azcore.ResponseError type.
...
// Get - Gets properties of a provider instance.
//
// The product Microsoft.Workloads/sapMonitors (AMS Classic) is officially retired as of May 31, 2023.
// If the operation fails it returns an *azcore.ResponseError type.
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
...
func (client *ProviderInstancesClient) getHandleResponse(resp *http.Response, successCodes ...int) (ProviderInstancesClientGetResponse, error) {
...
// NewListPager - Gets a list of provider instances in the specified SAP monitor.
//
// The product Microsoft.Workloads/sapMonitors (AMS Classic) is officially retired as of May 31, 2023.
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - sapMonitorName - Name of the SAP monitor resource.
...
func (client *ProviderInstancesClient) NewListPager(resourceGroupName string, sapMonitorName string, options *ProviderInstancesClientListOptions) *runtime.Pager[ProviderInstancesClientListResponse] {
	return runtime.NewPager(runtime.PagingHandler[ProviderInstancesClientListResponse]{
		...
		Fetcher: func(ctx context.Context, page *ProviderInstancesClientListResponse) (ProviderInstancesClientListResponse, error) {
			...
			req, err := client.listCreateRequest(ctx, resourceGroupName, sapMonitorName, nextLink, options)
			if err != nil {
...
func (client *ProviderInstancesClient) listCreateRequest(ctx context.Context, resourceGroupName string, sapMonitorName string, nextLink string, _ *ProviderInstancesClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *ProviderInstancesClient) listHandleResponse(resp *http.Response, successCodes ...int) (ProviderInstancesClientListResponse, error) {
