...
// Generated from example definition: 2020-02-07-preview/ProviderInstances_Create.json
func ExampleProviderInstancesClient_BeginCreate() {
	...
	// res = armhanaonazure.ProviderInstancesClientCreateResponse{
	// 	ProviderInstance: armhanaonazure.ProviderInstance{
	...
	// 			ProvisioningState: to.Ptr(armhanaonazure.HanaProvisioningStatesEnumAccepted),
	// 		},
	// 	},
	// }
}

// Generated from example definition: 2020-02-07-preview/ProviderInstances_Delete.json
func ExampleProviderInstancesClient_BeginDelete() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armhanaonazure.ProviderInstancesClientDeleteResponse{
	// }
}

// Generated from example definition: 2020-02-07-preview/ProviderInstances_Get.json
func ExampleProviderInstancesClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armhanaonazure.ProviderInstancesClientGetResponse{
	// 	ProviderInstance: armhanaonazure.ProviderInstance{
	// 		Name: to.Ptr("myProviderInstance"),
	// 		Type: to.Ptr("Microsoft.HanaOnAzure/sapMonitors/providerInstances"),
	// 		ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/myResourceGroup/providers/Microsoft.HanaOnAzure/sapMonitors/mySapMonitor/providerInstances/myProviderInstance"),
...
// Generated from example definition: 2020-02-07-preview/ProviderInstances_List.json
func ExampleProviderInstancesClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armhanaonazure.ProviderInstancesClientListResponse{
		// 	ProviderInstanceListResult: armhanaonazure.ProviderInstanceListResult{
