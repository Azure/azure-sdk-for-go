...
func (client *SapMonitorsClient) getHandleResponse(resp *http.Response, successCodes ...int) (SapMonitorsClientGetResponse, error) {
...
func (client *SapMonitorsClient) listCreateRequest(ctx context.Context, nextLink string, _ *SapMonitorsClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *SapMonitorsClient) listHandleResponse(resp *http.Response, successCodes ...int) (SapMonitorsClientListResponse, error) {
...
func (client *SapMonitorsClient) updateHandleResponse(resp *http.Response, successCodes ...int) (SapMonitorsClientUpdateResponse, error) {
