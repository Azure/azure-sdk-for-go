...
func ExampleCloudHsmClusterBackupStatusClient_BeginGet() {
	...
	poller, err := clientFactory.NewCloudHsmClusterBackupStatusClient().BeginGet(ctx, "rgcloudhsm", "chsm1", "572a45927fc240e1ac075de27371680b", nil)
	if err != nil {
