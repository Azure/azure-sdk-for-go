...
// PaymentHsmCluster - Resource information with extended details.
type PaymentHsmCluster struct {
	// REQUIRED; The geo-location where the resource lives
	Location *string
...
// PaymentHsmClusterListResult - The response of a PaymentHsmCluster list operation.
type PaymentHsmClusterListResult struct {
	// REQUIRED; The PaymentHsmCluster items on this page
...
// PaymentHsmClusterPatchParameters - Patchable properties of the Payment HSM Cluster
type PaymentHsmClusterPatchParameters struct {
	// Resource tags.
	Tags map[string]*string
}

// PaymentHsmClusterPrivateEndpointConnection - The private endpoint connection resource.
type PaymentHsmClusterPrivateEndpointConnection struct {
...
// PaymentHsmClusterPrivateEndpointConnectionListResult - The response of a PaymentHsmClusterPrivateEndpointConnection list
// operation.
type PaymentHsmClusterPrivateEndpointConnectionListResult struct {
	// REQUIRED; The PaymentHsmClusterPrivateEndpointConnection items on this page
...
// PaymentHsmClusterProperties - Properties of a Payment HSM Cluster.
type PaymentHsmClusterProperties struct {
	// REQUIRED; The application trusted issuer for the Payment HSM Cluster
	ApplicationTrustedIssuer *string

	// REQUIRED; The management trusted issuer for the Payment HSM Cluster
	...
	// READ-ONLY; An array of Payment HSM Cluster's HSMs
	Hsms []*PaymentHsmProperties

	// READ-ONLY; List of private endpoint connection resources
	PrivateEndpointConnections []*PaymentHsmClusterPrivateEndpointConnection

	// READ-ONLY; The Payment HSM Cluster's provisioningState
	ProvisioningState *ProvisioningState

	// READ-ONLY; Payment HSM Cluster status message
	StatusMessage *string
}

// PaymentHsmClusterSKU - Payment Hsm Cluster SKU information
type PaymentHsmClusterSKU struct {
	// REQUIRED; Sku family of the Payment HSM Cluster
	Family *PaymentHsmClusterSKUFamily

	// REQUIRED; Sku name of the Payment HSM Cluster
...
// PaymentHsmProperties - The Payment HSM Properties
type PaymentHsmProperties struct {
