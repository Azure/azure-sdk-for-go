...
func ExampleConfigurationsClient_Get() {
	...
	// 	ClusterConfiguration: &armhdinsight.ClusterConfiguration{
...
func ExampleConfigurationsClient_List() {
	...
	// 		Configurations: map[string]*armhdinsight.ClusterConfiguration{
	// 			"core-site": &armhdinsight.ClusterConfiguration{
	// 				AdditionalProperties: map[string]*string{
	// 				"fs.azure.account.key.test.blob.core.windows.net": to.Ptr("accountKey"),
	// 				"fs.defaultFS": to.Ptr("wasb://test.blob.core.windows.net"),
	// 			},
	// 			},
	// 			"gateway": &armhdinsight.ClusterConfiguration{
	// 				AdditionalProperties: map[string]*string{
...
func ExampleConfigurationsClient_BeginUpdate_disableHttpConnectivity() {
	...
	poller, err := clientFactory.NewConfigurationsClient().BeginUpdate(ctx, "rg1", "cluster1", "gateway", armhdinsight.ClusterConfiguration{
		AdditionalProperties: map[string]*string{
