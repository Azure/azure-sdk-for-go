...
type ConfigurationsServer struct {
	...
	BeginUpdate func(ctx context.Context, resourceGroupName string, clusterName string, configurationName string, parameters armhdinsight.ClusterConfiguration, options *armhdinsight.ConfigurationsClientBeginUpdateOptions) (resp azfake.PollerResponder[armhdinsight.ConfigurationsClientUpdateResponse], errResp azfake.ErrorResponder)
}
...
func (c *ConfigurationsServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	resp, err := server.MarshalResponseAsJSON(respContent, server.GetResponse(respr).ClusterConfiguration, req)
	if err != nil {
		return nil, err
	}
	return resp, nil
...
func (c *ConfigurationsServerTransport) dispatchBeginUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginUpdate == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armhdinsight.ClusterConfiguration](req)
		if err != nil {
			return nil, err
		}
		resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
