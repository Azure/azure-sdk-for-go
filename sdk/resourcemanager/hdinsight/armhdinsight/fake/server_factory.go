...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "ScriptActionsClient":
		initServer(&s.trMu, &s.trScriptActionsServer, func() *ScriptActionsServerTransport {
	...
	case "ScriptExecutionHistoryClient":
		initServer(&s.trMu, &s.trScriptExecutionHistoryServer, func() *ScriptExecutionHistoryServerTransport {
