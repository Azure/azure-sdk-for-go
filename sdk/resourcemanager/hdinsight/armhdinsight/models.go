...
// ClusterConfiguration - The configuration object for the specified configuration for the specified cluster.
...
type ClusterConfigurations struct {
	...
	Configurations map[string]*ClusterConfiguration
}
...
type ClusterDefinition struct {
	...
	Configurations *ClusterDefinitionConfigurations

	// The type of cluster.
	Kind *string
}

// ClusterDefinitionConfigurations - The cluster configurations.
type ClusterDefinitionConfigurations struct {
}
...
// of this set are Regions, ClusterFlavors, NodeTypes and ClusterVersions. The constraint should be defined based on the following:
// FilterMode (Exclude vs Include), VMSizes (the vm sizes in affect of exclusion/inclusion) and the ordering of the Filters.
// Later filters override previous settings if conflicted.
