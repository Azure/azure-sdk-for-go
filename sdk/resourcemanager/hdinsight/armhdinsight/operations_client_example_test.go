...
// Generated from example definition: 2025-01-15-preview/ListHDInsightOperations.json
func ExampleOperationsClient_NewListPager() {
	...
	clientFactory, err := armhdinsight.NewClientFactory("<subscriptionID>", cred, nil)
	if err != nil {
	...
	for pager.More() {
		...
		// page = armhdinsight.OperationsClientListResponse{
		// 	OperationListResult: armhdinsight.OperationListResult{
