...
// Generated from example definition: 2025-01-15-preview/ApprovePrivateEndpointConnection.json
func ExamplePrivateEndpointConnectionsClient_BeginCreateOrUpdate() {
	...
	// res = armhdinsight.PrivateEndpointConnectionsClientCreateOrUpdateResponse{
	// 	PrivateEndpointConnection: &armhdinsight.PrivateEndpointConnection{
...
// Generated from example definition: 2025-01-15-preview/DeletePrivateEndpointConnection.json
func ExamplePrivateEndpointConnectionsClient_BeginDelete() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armhdinsight.PrivateEndpointConnectionsClientDeleteResponse{
	// }
}

// Generated from example definition: 2025-01-15-preview/GetPrivateEndpointConnection.json
func ExamplePrivateEndpointConnectionsClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armhdinsight.PrivateEndpointConnectionsClientGetResponse{
	// 	PrivateEndpointConnection: &armhdinsight.PrivateEndpointConnection{
	// 		Name: to.Ptr("testprivateep.b3bf5fed-9b12-4560-b7d0-2abe1bba07e2"),
	// 		Type: to.Ptr("Microsoft.HDInsight/clusters/privateEndpointConnections"),
	// 		ID: to.Ptr("/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.HDInsight/clusters/cluster1/privateEndpointConnections/testprivateep.b3bf5fed-9b12-4560-b7d0-2abe1bba07e2"),
...
// Generated from example definition: 2025-01-15-preview/GetAllPrivateEndpointConnectionsInCluster.json
func ExamplePrivateEndpointConnectionsClient_NewListByClusterPager() {
	...
	for pager.More() {
		...
		// page = armhdinsight.PrivateEndpointConnectionsClientListByClusterResponse{
		// 	PrivateEndpointConnectionListResult: armhdinsight.PrivateEndpointConnectionListResult{
