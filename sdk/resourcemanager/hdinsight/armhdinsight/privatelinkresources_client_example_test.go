...
// Generated from example definition: 2025-01-15-preview/GetPrivateLinkResource.json
...
// Generated from example definition: 2025-01-15-preview/GetAllPrivateLinkResourcesInCluster.json
func ExamplePrivateLinkResourcesClient_NewListByClusterPager() {
	...
	pager := clientFactory.NewPrivateLinkResourcesClient().NewListByClusterPager("rg1", "cluster1", nil)
	for pager.More() {
		...
		// page = armhdinsight.PrivateLinkResourcesClientListByClusterResponse{
