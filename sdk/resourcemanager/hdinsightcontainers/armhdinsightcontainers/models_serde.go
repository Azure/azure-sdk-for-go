...
// MarshalJSON implements the json.Marshaller interface for type AksClusterProfile.
func (a AksClusterProfile) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "aksClusterAgentPoolIdentityProfile", a.AksClusterAgentPoolIdentityProfile)
	populate(objectMap, "aksClusterResourceId", a.AksClusterResourceID)
	populate(objectMap, "aksVersion", a.AksVersion)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type AksClusterProfile.
func (a *AksClusterProfile) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "aksClusterAgentPoolIdentityProfile":
				err = unpopulate(val, "AksClusterAgentPoolIdentityProfile", &a.AksClusterAgentPoolIdentityProfile)
			delete(rawMsg, key)
		case "aksClusterResourceId":
				err = unpopulate(val, "AksClusterResourceID", &a.AksClusterResourceID)
			delete(rawMsg, key)
		case "aksVersion":
				err = unpopulate(val, "AksVersion", &a.AksVersion)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", a, err)
...
// MarshalJSON implements the json.Marshaller interface for type ClusterInstanceViewProperties.
func (c ClusterInstanceViewProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type ClusterInstanceViewProperties.
func (c *ClusterInstanceViewProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type ClusterInstanceViewStatus.
func (c ClusterInstanceViewStatus) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "message", c.Message)
	populate(objectMap, "ready", c.Ready)
	populate(objectMap, "reason", c.Reason)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type ClusterInstanceViewStatus.
func (c *ClusterInstanceViewStatus) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type ClusterPoolComputeProfile.
func (c ClusterPoolComputeProfile) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type ClusterPoolComputeProfile.
func (c *ClusterPoolComputeProfile) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type ClusterPoolLogAnalyticsProfile.
func (c ClusterPoolLogAnalyticsProfile) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "enabled", c.Enabled)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type ClusterPoolLogAnalyticsProfile.
func (c *ClusterPoolLogAnalyticsProfile) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type ClusterPoolNetworkProfile.
func (c ClusterPoolNetworkProfile) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "subnetId", c.SubnetID)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ClusterPoolNetworkProfile.
func (c *ClusterPoolNetworkProfile) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type ClusterPoolProfile.
func (c ClusterPoolProfile) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "clusterPoolVersion", c.ClusterPoolVersion)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ClusterPoolProfile.
func (c *ClusterPoolProfile) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type ServiceConfigListResultProperties.
func (s ServiceConfigListResultProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type ServiceConfigListResultProperties.
func (s *ServiceConfigListResultProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type WebConnectivityEndpoint.
func (w WebConnectivityEndpoint) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "fqdn", w.Fqdn)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type WebConnectivityEndpoint.
func (w *WebConnectivityEndpoint) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "fqdn":
				err = unpopulate(val, "Fqdn", &w.Fqdn)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", w, err)
