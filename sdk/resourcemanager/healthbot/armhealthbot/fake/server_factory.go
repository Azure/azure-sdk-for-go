...
// The returned ServerFactoryTransport instance is connected to an instance of armhealthbot.ClientFactory via the
...
// ServerFactoryTransport connects instances of armhealthbot.ClientFactory to instances of ServerFactory.
