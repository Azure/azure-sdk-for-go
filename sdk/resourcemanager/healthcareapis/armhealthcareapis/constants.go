...
// ArmManagedServiceIdentityType - Type of managed service identity (where both SystemAssigned and UserAssigned types are
// allowed).
type ArmManagedServiceIdentityType string

const (
	// ArmManagedServiceIdentityTypeNone - No managed identity.
	ArmManagedServiceIdentityTypeNone ArmManagedServiceIdentityType = "None"
	// ArmManagedServiceIdentityTypeSystemAssigned - System assigned managed identity.
	ArmManagedServiceIdentityTypeSystemAssigned ArmManagedServiceIdentityType = "SystemAssigned"
	// ArmManagedServiceIdentityTypeSystemAssignedUserAssigned - System and user assigned managed identity.
	ArmManagedServiceIdentityTypeSystemAssignedUserAssigned ArmManagedServiceIdentityType = "SystemAssigned,UserAssigned"
	// ArmManagedServiceIdentityTypeUserAssigned - User assigned managed identity.
	ArmManagedServiceIdentityTypeUserAssigned ArmManagedServiceIdentityType = "UserAssigned"
)

// PossibleArmManagedServiceIdentityTypeValues returns the possible values for the ArmManagedServiceIdentityType const type.
func PossibleArmManagedServiceIdentityTypeValues() []ArmManagedServiceIdentityType {
	return []ArmManagedServiceIdentityType{
		ArmManagedServiceIdentityTypeNone,
		ArmManagedServiceIdentityTypeSystemAssigned,
		ArmManagedServiceIdentityTypeSystemAssignedUserAssigned,
		ArmManagedServiceIdentityTypeUserAssigned,
	}
}
