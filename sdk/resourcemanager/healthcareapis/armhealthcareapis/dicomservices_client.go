...
func (client *DicomServicesClient) getHandleResponse(resp *http.Response, successCodes ...int) (DicomServicesClientGetResponse, error) {
...
func (client *DicomServicesClient) listByWorkspaceCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, nextLink string, _ *DicomServicesClientListByWorkspaceOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *DicomServicesClient) listByWorkspaceHandleResponse(resp *http.Response, successCodes ...int) (DicomServicesClientListByWorkspaceResponse, error) {
