...
func ExampleDicomServicesClient_BeginDelete() {
	...
	poller, err := clientFactory.NewDicomServicesClient().BeginDelete(ctx, "testRG", "workspace1", "blue", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	res, err := poller.PollUntilDone(ctx, nil)
...
func ExampleDicomServicesClient_BeginUpdate() {
	...
	poller, err := clientFactory.NewDicomServicesClient().BeginUpdate(ctx, "testRG", "workspace1", "blue", armhealthcareapis.DicomServicePatchResource{
