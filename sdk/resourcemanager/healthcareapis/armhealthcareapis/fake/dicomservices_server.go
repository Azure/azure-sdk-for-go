...
type DicomServicesServer struct {
	...
	BeginDelete func(ctx context.Context, resourceGroupName string, workspaceName string, dicomServiceName string, options *armhealthcareapis.DicomServicesClientBeginDeleteOptions) (resp azfake.PollerResponder[armhealthcareapis.DicomServicesClientDeleteResponse], errResp azfake.ErrorResponder)
	...
	BeginUpdate func(ctx context.Context, resourceGroupName string, workspaceName string, dicomServiceName string, dicomservicePatchResource armhealthcareapis.DicomServicePatchResource, options *armhealthcareapis.DicomServicesClientBeginUpdateOptions) (resp azfake.PollerResponder[armhealthcareapis.DicomServicesClientUpdateResponse], errResp azfake.ErrorResponder)
}
...
func (d *DicomServicesServerTransport) dispatchBeginDelete(req *http.Request) (*http.Response, error) {
	...
	if beginDelete == nil {
		...
		respr, errRespr := d.srv.BeginDelete(req.Context(), resourceGroupNameParam, workspaceNameParam, dicomServiceNameParam, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginDelete = &respr
...
func (d *DicomServicesServerTransport) dispatchBeginUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginUpdate == nil {
		...
		respr, errRespr := d.srv.BeginUpdate(req.Context(), resourceGroupNameParam, workspaceNameParam, dicomServiceNameParam, body, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginUpdate = &respr
