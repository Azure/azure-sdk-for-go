...
type FhirServicesServer struct {
	...
	BeginDelete func(ctx context.Context, resourceGroupName string, workspaceName string, fhirServiceName string, options *armhealthcareapis.FhirServicesClientBeginDeleteOptions) (resp azfake.PollerResponder[armhealthcareapis.FhirServicesClientDeleteResponse], errResp azfake.ErrorResponder)
	...
	BeginUpdate func(ctx context.Context, resourceGroupName string, workspaceName string, fhirServiceName string, fhirservicePatchResource armhealthcareapis.FhirServicePatchResource, options *armhealthcareapis.FhirServicesClientBeginUpdateOptions) (resp azfake.PollerResponder[armhealthcareapis.FhirServicesClientUpdateResponse], errResp azfake.ErrorResponder)
}
...
func (f *FhirServicesServerTransport) dispatchBeginDelete(req *http.Request) (*http.Response, error) {
	...
	if beginDelete == nil {
		...
		respr, errRespr := f.srv.BeginDelete(req.Context(), resourceGroupNameParam, workspaceNameParam, fhirServiceNameParam, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginDelete = &respr
...
func (f *FhirServicesServerTransport) dispatchBeginUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginUpdate == nil {
		...
		respr, errRespr := f.srv.BeginUpdate(req.Context(), resourceGroupNameParam, workspaceNameParam, fhirServiceNameParam, body, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginUpdate = &respr
