...
func (i *IotConnectorFhirDestinationServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	resultChan := make(chan result, 1)
	go func() {
		var intercepted bool
		var res result
		if iotConnectorFhirDestinationServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = iotConnectorFhirDestinationServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
func (i *IotConnectorFhirDestinationServerTransport) dispatchBeginCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginCreateOrUpdate == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.HealthcareApis/workspaces/(?P<workspaceName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/iotconnectors/(?P<iotConnectorName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/fhirdestinations/(?P<fhirDestinationName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)`
...
// set this to conditionally intercept incoming requests to IotConnectorFhirDestinationServerTransport
var iotConnectorFhirDestinationServerTransportInterceptor interface {
