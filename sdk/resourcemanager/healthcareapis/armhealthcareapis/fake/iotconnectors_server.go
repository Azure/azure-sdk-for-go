...
type IotConnectorsServer struct {
	...
	BeginDelete func(ctx context.Context, resourceGroupName string, workspaceName string, iotConnectorName string, options *armhealthcareapis.IotConnectorsClientBeginDeleteOptions) (resp azfake.PollerResponder[armhealthcareapis.IotConnectorsClientDeleteResponse], errResp azfake.ErrorResponder)
...
func (i *IotConnectorsServerTransport) dispatchBeginDelete(req *http.Request) (*http.Response, error) {
	...
	if beginDelete == nil {
		...
		respr, errRespr := i.srv.BeginDelete(req.Context(), resourceGroupNameParam, workspaceNameParam, iotConnectorNameParam, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginDelete = &respr
...
func (i *IotConnectorsServerTransport) dispatchBeginUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginUpdate == nil {
		...
		respr, errRespr := i.srv.BeginUpdate(req.Context(), resourceGroupNameParam, workspaceNameParam, iotConnectorNameParam, body, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginUpdate = &respr
