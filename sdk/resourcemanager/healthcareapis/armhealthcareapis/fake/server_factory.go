...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "DicomServicesClient":
		initServer(&s.trMu, &s.trDicomServicesServer, func() *DicomServicesServerTransport {
	...
	case "FhirDestinationsClient":
		initServer(&s.trMu, &s.trFhirDestinationsServer, func() *FhirDestinationsServerTransport {
	...
	case "FhirServicesClient":
		initServer(&s.trMu, &s.trFhirServicesServer, func() *FhirServicesServerTransport { return NewFhirServicesServerTransport(&s.srv.FhirServicesServer) })
		resp, err = s.trFhirServicesServer.Do(req)
	case "IotConnectorFhirDestinationClient":
		initServer(&s.trMu, &s.trIotConnectorFhirDestinationServer, func() *IotConnectorFhirDestinationServerTransport {
	...
	case "IotConnectorsClient":
		initServer(&s.trMu, &s.trIotConnectorsServer, func() *IotConnectorsServerTransport {
