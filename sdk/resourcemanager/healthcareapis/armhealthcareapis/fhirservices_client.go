...
func (client *FhirServicesClient) getHandleResponse(resp *http.Response, successCodes ...int) (FhirServicesClientGetResponse, error) {
...
func (client *FhirServicesClient) listByWorkspaceCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, nextLink string, _ *FhirServicesClientListByWorkspaceOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *FhirServicesClient) listByWorkspaceHandleResponse(resp *http.Response, successCodes ...int) (FhirServicesClientListByWorkspaceResponse, error) {
