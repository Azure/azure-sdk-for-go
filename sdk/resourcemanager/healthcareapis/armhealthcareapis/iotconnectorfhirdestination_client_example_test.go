...
// Generated from example definition: 2025-04-01-preview/iotconnectors/iotconnector_fhirdestination_Create.json
func ExampleIotConnectorFhirDestinationClient_BeginCreateOrUpdate() {
	...
	// res = armhealthcareapis.IotConnectorFhirDestinationClientCreateOrUpdateResponse{
	// 	IotFhirDestination: &armhealthcareapis.IotFhirDestination{
	// 		Name: to.Ptr("dest1"),
...
// Generated from example definition: 2025-04-01-preview/iotconnectors/iotconnector_fhirdestination_Delete.json
func ExampleIotConnectorFhirDestinationClient_BeginDelete() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armhealthcareapis.IotConnectorFhirDestinationClientDeleteResponse{
	// }
}

// Generated from example definition: 2025-04-01-preview/iotconnectors/iotconnector_fhirdestination_Get.json
func ExampleIotConnectorFhirDestinationClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armhealthcareapis.IotConnectorFhirDestinationClientGetResponse{
	// 	IotFhirDestination: &armhealthcareapis.IotFhirDestination{
	// 		Name: to.Ptr("dest1"),
	// 		Type: to.Ptr("Microsoft.HealthcareApis/workspaces/iotconnectors/fhirdestinations"),
	// 		Etag: to.Ptr("00000000-0000-0000-f5ac-912ca49e01d6"),
