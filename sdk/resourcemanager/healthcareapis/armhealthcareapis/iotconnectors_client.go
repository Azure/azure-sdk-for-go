...
func (client *IotConnectorsClient) getHandleResponse(resp *http.Response, successCodes ...int) (IotConnectorsClientGetResponse, error) {
...
func (client *IotConnectorsClient) listByWorkspaceCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, nextLink string, _ *IotConnectorsClientListByWorkspaceOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *IotConnectorsClient) listByWorkspaceHandleResponse(resp *http.Response, successCodes ...int) (IotConnectorsClientListByWorkspaceResponse, error) {
