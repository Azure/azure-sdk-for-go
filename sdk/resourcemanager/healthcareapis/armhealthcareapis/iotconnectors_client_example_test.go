...
func ExampleIotConnectorsClient_BeginDelete() {
	...
	poller, err := clientFactory.NewIotConnectorsClient().BeginDelete(ctx, "testRG", "workspace1", "blue", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	res, err := poller.PollUntilDone(ctx, nil)
...
func ExampleIotConnectorsClient_BeginUpdate() {
	...
	poller, err := clientFactory.NewIotConnectorsClient().BeginUpdate(ctx, "testRG", "workspace1", "blue", armhealthcareapis.IotConnectorPatchResource{
