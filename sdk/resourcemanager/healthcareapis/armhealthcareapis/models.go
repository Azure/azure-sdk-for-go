...
// ServiceManagedIdentityIdentity - Managed service identity (system assigned and/or user assigned identities)
type ServiceManagedIdentityIdentity struct {
	// REQUIRED; REQUIRED; The type of managed identity assigned to this resource.
	Type *ArmManagedServiceIdentityType

	// REQUIRED; REQUIRED; Type of identity being specified, currently SystemAssigned and None are allowed.
	...
	// READ-ONLY; READ-ONLY; The service principal ID of the system assigned identity. This property will only be provided for
	...
	// READ-ONLY; READ-ONLY; The tenant ID of the system assigned identity. This property will only be provided for a system assigned
	// identity.
	TenantID *string
