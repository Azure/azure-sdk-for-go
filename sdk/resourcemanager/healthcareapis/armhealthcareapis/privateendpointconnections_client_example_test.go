...
// Generated from example definition: 2025-04-01-preview/legacy/ServiceCreatePrivateEndpointConnection.json
func ExamplePrivateEndpointConnectionsClient_BeginCreateOrUpdate() {
	...
	// res = armhealthcareapis.PrivateEndpointConnectionsClientCreateOrUpdateResponse{
...
// Generated from example definition: 2025-04-01-preview/legacy/ServiceDeletePrivateEndpointConnection.json
func ExamplePrivateEndpointConnectionsClient_BeginDelete() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armhealthcareapis.PrivateEndpointConnectionsClientDeleteResponse{
	// }
}

// Generated from example definition: 2025-04-01-preview/legacy/ServiceGetPrivateEndpointConnection.json
func ExamplePrivateEndpointConnectionsClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armhealthcareapis.PrivateEndpointConnectionsClientGetResponse{
	// 	PrivateEndpointConnectionDescription: &armhealthcareapis.PrivateEndpointConnectionDescription{
	// 		Name: to.Ptr("myConnection"),
	// 		Type: to.Ptr("Microsoft.HealthcareApis/services/privateEndpointConnections"),
	// 		ID: to.Ptr("/subscriptions/subid/resourceGroups/rg1/providers/Microsoft.HealthcareApis/services/service1/privateEndpointConnections/myConnection"),
...
// Generated from example definition: 2025-04-01-preview/legacy/ServiceListPrivateEndpointConnections.json
func ExamplePrivateEndpointConnectionsClient_NewListByServicePager() {
	...
	for pager.More() {
		...
		// page = armhealthcareapis.PrivateEndpointConnectionsClientListByServiceResponse{
