...
// operations: Solution Discovery Lists the diagnostics for an Azure issue based on the prerequisites.
...
// at the resource level to create diagnostics.
// 'RequiredParameterSets' from Discovery Solutions API response has to be passed via 'properties.insights.additionalParameters'
// as a key-value pairs to Diagnostics Api.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2023-01-01-preview
...
// The diagnostics API is called after solutions discovery and returns diagnostic info for your Azure issue.
// You must have reader access role [https://learn.microsoft.com/en-us/azure/role-based-access-control/built-in-roles#reader]
// at the resource level to get the diagnostics.
// 'RequiredParameterSets' from Discovery Solutions API response has to be passed via 'properties.insights.additionalParameters'
// as a key-value pairs to Diagnostics Api.
// If the operation fails it returns an *azcore.ResponseError type.
//
