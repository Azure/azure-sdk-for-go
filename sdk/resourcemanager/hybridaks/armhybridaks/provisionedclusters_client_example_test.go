...
func ExampleProvisionedClustersClient_Get() {
	...
	client, err := armhybridaks.NewProvisionedClustersClient("a3e42606-29b1-4d7d-b1d9-9ff6b9d3c71b", cred, nil)
	if err != nil {
...
func ExampleProvisionedClustersClient_BeginCreateOrUpdate() {
	...
	poller, err := client.BeginCreateOrUpdate(ctx, "test-arcappliance-resgrp", "test-hybridakscluster", armhybridaks.ProvisionedClusters{
		Location: to.Ptr("westus"),
		ExtendedLocation: &armhybridaks.ProvisionedClustersExtendedLocation{
		...
		Properties: &armhybridaks.ProvisionedClustersAllProperties{
			AgentPoolProfiles: []*armhybridaks.NamedAgentPoolProfile{
				{
			...
			CloudProviderProfile: &armhybridaks.CloudProviderProfile{
				InfraNetworkProfile: &armhybridaks.CloudProviderProfileInfraNetworkProfile{
				...
				InfraStorageProfile: &armhybridaks.CloudProviderProfileInfraStorageProfile{
			...
			ControlPlane: &armhybridaks.ControlPlaneProfile{
				LinuxProfile: &armhybridaks.LinuxProfileProperties{
					SSH: &armhybridaks.LinuxProfilePropertiesSSH{
						PublicKeys: []*armhybridaks.LinuxProfilePropertiesSSHPublicKeysItem{
							{
			...
			NetworkProfile: &armhybridaks.NetworkProfile{
				LoadBalancerProfile: &armhybridaks.LoadBalancerProfile{
					LinuxProfile: &armhybridaks.LinuxProfileProperties{
						SSH: &armhybridaks.LinuxProfilePropertiesSSH{
							PublicKeys: []*armhybridaks.LinuxProfilePropertiesSSHPublicKeysItem{
								{
				...
				LoadBalancerSKU: to.Ptr(armhybridaks.LoadBalancerSKUUnstackedHaproxy),
				NetworkPolicy:   to.Ptr(armhybridaks.NetworkPolicyCalico),
...
func ExampleProvisionedClustersClient_BeginUpdate() {
	...
	poller, err := client.BeginUpdate(ctx, "test-arcappliance-resgrp", "test-hybridakscluster", armhybridaks.ProvisionedClustersPatch{
