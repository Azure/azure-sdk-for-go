...
func ExampleVirtualNetworksClient_Retrieve() {
	...
	client, err := armhybridaks.NewVirtualNetworksClient("a3e42606-29b1-4d7d-b1d9-9ff6b9d3c71b", cred, nil)
	if err != nil {
...
func ExampleVirtualNetworksClient_BeginCreateOrUpdate() {
	...
	poller, err := client.BeginCreateOrUpdate(ctx, "test-arcappliance-resgrp", "test-vnet-static", armhybridaks.VirtualNetworks{
		Location: to.Ptr("westus"),
		ExtendedLocation: &armhybridaks.VirtualNetworksExtendedLocation{
		...
		Properties: &armhybridaks.VirtualNetworksProperties{
			InfraVnetProfile: &armhybridaks.VirtualNetworksPropertiesInfraVnetProfile{
				Hci: &armhybridaks.VirtualNetworksPropertiesInfraVnetProfileHci{
					MocGroup:    to.Ptr("target-group"),
					MocLocation: to.Ptr("MocLocation"),
					MocVnetName: to.Ptr("test-vnet"),
				},
			},
			VipPool: []*armhybridaks.VirtualNetworksPropertiesVipPoolItem{
				{
					EndIP:   to.Ptr("192.168.0.50"),
					StartIP: to.Ptr("192.168.0.10"),
				}},
			VmipPool: []*armhybridaks.VirtualNetworksPropertiesVmipPoolItem{
				{
...
func ExampleVirtualNetworksClient_BeginUpdate() {
	...
	poller, err := client.BeginUpdate(ctx, "test-arcappliance-resgrp", "test-vnet-static", armhybridaks.VirtualNetworksPatch{
