...
func (client *ExtensionMetadataV2Client) getHandleResponse(resp *http.Response, successCodes ...int) (ExtensionMetadataV2ClientGetResponse, error) {
...
func (client *ExtensionMetadataV2Client) listCreateRequest(ctx context.Context, location string, publisher string, extensionType string, nextLink string, _ *ExtensionMetadataV2ClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *ExtensionMetadataV2Client) listHandleResponse(resp *http.Response, successCodes ...int) (ExtensionMetadataV2ClientListResponse, error) {
