...
func (client *ExtensionPublisherClient) listCreateRequest(ctx context.Context, location string, nextLink string, _ *ExtensionPublisherClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *ExtensionPublisherClient) listHandleResponse(resp *http.Response, successCodes ...int) (ExtensionPublisherClientListResponse, error) {
