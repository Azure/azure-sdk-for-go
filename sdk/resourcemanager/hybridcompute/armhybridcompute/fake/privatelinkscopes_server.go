...
// The returned PrivateLinkScopesServerTransport instance is connected to an instance of armhybridcompute.PrivateLinkScopesClient via the
...
func NewPrivateLinkScopesServerTransport(srv *PrivateLinkScopesServer) *PrivateLinkScopesServerTransport {
	return &PrivateLinkScopesServerTransport{
		srv:                         srv,
		beginDelete:                 newTracker[azfake.PollerResponder[armhybridcompute.PrivateLinkScopesClientDeleteResponse]](),
		newListPager:                newTracker[azfake.PagerResponder[armhybridcompute.PrivateLinkScopesClientListResponse]](),
		newListByResourceGroupPager: newTracker[azfake.PagerResponder[armhybridcompute.PrivateLinkScopesClientListByResourceGroupResponse]](),
	}
}

// PrivateLinkScopesServerTransport connects instances of armhybridcompute.PrivateLinkScopesClient to instances of PrivateLinkScopesServer.
...
type PrivateLinkScopesServerTransport struct {
	...
	beginDelete                 *tracker[azfake.PollerResponder[armhybridcompute.PrivateLinkScopesClientDeleteResponse]]
	newListPager                *tracker[azfake.PagerResponder[armhybridcompute.PrivateLinkScopesClientListResponse]]
	newListByResourceGroupPager *tracker[azfake.PagerResponder[armhybridcompute.PrivateLinkScopesClientListByResourceGroupResponse]]
}
...
func (p *PrivateLinkScopesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		if !intercepted {
			...
			case "PrivateLinkScopesClient.GetValidationDetails":
				res.resp, res.err = p.dispatchGetValidationDetails(req)
			case "PrivateLinkScopesClient.GetValidationDetailsForMachine":
				res.resp, res.err = p.dispatchGetValidationDetailsForMachine(req)
...
func (p *PrivateLinkScopesServerTransport) dispatchCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.HybridCompute/privateLinkScopes/(?P<scopeName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)`
	regex := regexp.MustCompile(regexStr)
	matches := regex.FindStringSubmatch(req.URL.EscapedPath())
	if len(matches) < 4 {
		return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
	}
	body, err := server.UnmarshalRequestAsJSON[armhybridcompute.PrivateLinkScope](req)
	if err != nil {
		return nil, err
	}
	...
	resp, err := server.MarshalResponseAsJSON(respContent, server.GetResponse(respr).PrivateLinkScope, req)
	if err != nil {
		return nil, err
	}
	return resp, nil
...
func (p *PrivateLinkScopesServerTransport) dispatchGetValidationDetails(req *http.Request) (*http.Response, error) {
	if p.srv.GetValidationDetails == nil {
		return nil, &nonRetriableError{errors.New("fake for method GetValidationDetails not implemented")}
	}
	const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.HybridCompute/locations/(?P<location>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/privateLinkScopes/(?P<privateLinkScopeId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)`
	regex := regexp.MustCompile(regexStr)
	matches := regex.FindStringSubmatch(req.URL.EscapedPath())
	if len(matches) < 4 {
		return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
	...
	privateLinkScopeIDParam, err := url.PathUnescape(matches[regex.SubexpIndex("privateLinkScopeId")])
	if err != nil {
		return nil, err
	}
	respr, errRespr := p.srv.GetValidationDetails(req.Context(), locationParam, privateLinkScopeIDParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
	...
	resp, err := server.MarshalResponseAsJSON(respContent, server.GetResponse(respr).PrivateLinkScopeValidationDetails, req)
	if err != nil {
		return nil, err
	}
	return resp, nil
...
func (p *PrivateLinkScopesServerTransport) dispatchGetValidationDetailsForMachine(req *http.Request) (*http.Response, error) {
	if p.srv.GetValidationDetailsForMachine == nil {
		return nil, &nonRetriableError{errors.New("fake for method GetValidationDetailsForMachine not implemented")}
	}
	const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.HybridCompute/machines/(?P<machineName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/privateLinkScopes/current`
	regex := regexp.MustCompile(regexStr)
	matches := regex.FindStringSubmatch(req.URL.EscapedPath())
	if len(matches) < 4 {
		return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
	...
	respr, errRespr := p.srv.GetValidationDetailsForMachine(req.Context(), resourceGroupNameParam, machineNameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (p *PrivateLinkScopesServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.HybridCompute/privateLinkScopes`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 2 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armhybridcompute.PrivateLinkScopesClientListResponse, createLink func() string) {
...
func (p *PrivateLinkScopesServerTransport) dispatchNewListByResourceGroupPager(req *http.Request) (*http.Response, error) {
	...
	if newListByResourceGroupPager == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.HybridCompute/privateLinkScopes`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 3 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
		...
		server.PagerResponderInjectNextLinks(newListByResourceGroupPager, req, func(page *armhybridcompute.PrivateLinkScopesClientListByResourceGroupResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
...
func (p *PrivateLinkScopesServerTransport) dispatchUpdateTags(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[armhybridcompute.TagsResource](req)
	if err != nil {
		return nil, err
	}
	resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
