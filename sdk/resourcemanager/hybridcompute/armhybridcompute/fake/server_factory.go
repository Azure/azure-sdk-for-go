...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "ExtensionMetadataClient":
		initServer(&s.trMu, &s.trExtensionMetadataServer, func() *ExtensionMetadataServerTransport {
	...
	case "ExtensionMetadataV2Client":
		initServer(&s.trMu, &s.trExtensionMetadataV2Server, func() *ExtensionMetadataV2ServerTransport {
	...
	case "ExtensionPublisherClient":
		initServer(&s.trMu, &s.trExtensionPublisherServer, func() *ExtensionPublisherServerTransport {
	...
	case "ExtensionTypeClient":
		initServer(&s.trMu, &s.trExtensionTypeServer, func() *ExtensionTypeServerTransport {
	...
	case "LicenseProfilesClient":
		initServer(&s.trMu, &s.trLicenseProfilesServer, func() *LicenseProfilesServerTransport {
	...
	case "MachineExtensionsClient":
		initServer(&s.trMu, &s.trMachineExtensionsServer, func() *MachineExtensionsServerTransport {
	...
	case "MachineRunCommandsClient":
		initServer(&s.trMu, &s.trMachineRunCommandsServer, func() *MachineRunCommandsServerTransport {
	...
	case "NetworkProfileClient":
		initServer(&s.trMu, &s.trNetworkProfileServer, func() *NetworkProfileServerTransport {
