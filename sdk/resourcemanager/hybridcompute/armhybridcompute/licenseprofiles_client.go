...
func (client *LicenseProfilesClient) getHandleResponse(resp *http.Response, successCodes ...int) (LicenseProfilesClientGetResponse, error) {
...
func (client *LicenseProfilesClient) listCreateRequest(ctx context.Context, resourceGroupName string, machineName string, nextLink string, _ *LicenseProfilesClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *LicenseProfilesClient) listHandleResponse(resp *http.Response, successCodes ...int) (LicenseProfilesClientListResponse, error) {
