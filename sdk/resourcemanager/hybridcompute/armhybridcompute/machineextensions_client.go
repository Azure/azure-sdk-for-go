...
func (client *MachineExtensionsClient) getHandleResponse(resp *http.Response, successCodes ...int) (MachineExtensionsClientGetResponse, error) {
...
func (client *MachineExtensionsClient) listCreateRequest(ctx context.Context, resourceGroupName string, machineName string, nextLink string, options *MachineExtensionsClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *MachineExtensionsClient) listHandleResponse(resp *http.Response, successCodes ...int) (MachineExtensionsClientListResponse, error) {
