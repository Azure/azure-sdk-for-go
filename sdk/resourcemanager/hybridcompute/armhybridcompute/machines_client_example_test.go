...
func ExampleMachinesClient_BeginAssessPatches() {
	...
	// res = armhybridcompute.MachinesClientAssessPatchesResponse{
	// 	MachineAssessPatchesResult: armhybridcompute.MachineAssessPatchesResult{
...
func ExampleMachinesClient_Get_getMachine() {
	...
	res, err := clientFactory.NewMachinesClient().Get(ctx, "myResourceGroup", "myMachine", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armhybridcompute.MachinesClientGetResponse{
	// 	Machine: armhybridcompute.Machine{
	// 		Name: to.Ptr("myMachine"),
	// 		Type: to.Ptr("Microsoft.HybridCompute/machines"),
	// 		ID: to.Ptr("/subscriptions/{subscriptionId}/resourceGroups/myResourceGroup/providers/Microsoft.HybridCompute/machines/myMachine"),
...
func ExampleMachinesClient_Get_getMachineWithLicenseProfileInstanceView() {
	...
	res, err := clientFactory.NewMachinesClient().Get(ctx, "myResourceGroup", "myMachine", &armhybridcompute.MachinesClientGetOptions{
		Expand: to.Ptr(armhybridcompute.InstanceViewTypesInstanceView)})
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
...
func ExampleMachinesClient_BeginInstallPatches() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armhybridcompute.MachinesClientInstallPatchesResponse{
	// 	MachineInstallPatchesResult: armhybridcompute.MachineInstallPatchesResult{
...
func ExampleMachinesClient_NewListByResourceGroupPager() {
	...
	for pager.More() {
		...
		// page = armhybridcompute.MachinesClientListByResourceGroupResponse{
