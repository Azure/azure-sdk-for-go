...
type ExtensionPublisherListResult struct {
	// READ-ONLY; The ExtensionPublisher items on this page
...
type ExtensionValueListResultV2 struct {
	// READ-ONLY; The ExtensionValueV2 items on this page
...
// LicenseProfilesListResult - Paged collection of LicenseProfile items
type LicenseProfilesListResult struct {
	// REQUIRED; The LicenseProfile items on this page
...
// LicensesListResult - Paged collection of License items
...
// MachineExtensionsListResult - Paged collection of MachineExtension items
type MachineExtensionsListResult struct {
	// REQUIRED; The MachineExtension items on this page
...
type NetworkInterface struct {
	...
	// READ-ONLY; The list of IP addresses in this interface.
...
type NetworkSecurityPerimeterConfigurationProperties struct {
	...
	// it is defined. Users cannot change this value but are able to read from it. Values will include Provisioning ,Succeeded,
	// Canceled and Failed.
	ProvisioningState *string
}
...
type NetworkSecurityPerimeterConfigurationReconcileResult struct {
	// READ-ONLY; The URL of the resource used to check the status of the asynchronous operation.
	Location *string
}
...
// OperationListResult - The List of Operations.
...
// PrivateLinkScopeListResult - The response of a HybridComputePrivateLinkScope list operation.
type PrivateLinkScopeListResult struct {
	// REQUIRED; The HybridComputePrivateLinkScope items on this page
...
// Settings - Concrete proxy resource types can be created by aliasing this type using a specific property type.
...
type StorageProfile struct {
	// READ-ONLY; The disks on the machine.
	Disks []*Disk
}
