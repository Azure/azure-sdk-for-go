...
type AgentConfiguration struct {
	...
	ConfigMode *AgentConfigurationMode `json:"configMode,omitempty" azure:"ro"`
...
// ExtensionMetadataClientListOptions contains the optional parameters for the ExtensionMetadataClient.List method.
...
type ExtensionValueListResult struct {
	...
	Value []*ExtensionValue `json:"value,omitempty" azure:"ro"`
}
...
type ExtensionValueProperties struct {
	...
	ExtensionType *string `json:"extensionType,omitempty" azure:"ro"`
...
type Machine struct {
	...
	Resources []*MachineExtension `json:"resources,omitempty" azure:"ro"`
