...
// LicenseProfileArmEsuPropertiesWithoutAssignedLicense - Describes the properties of a License Profile ARM model.
type LicenseProfileArmEsuPropertiesWithoutAssignedLicense struct {
	// READ-ONLY; The guid id of the license.
	AssignedLicenseImmutableID *string
...
// LicenseProfileStorageModelEsuProperties - License profile storage model for ESU properties.
type LicenseProfileStorageModelEsuProperties struct {
	// READ-ONLY; The guid id of the license.
	AssignedLicenseImmutableID *string
