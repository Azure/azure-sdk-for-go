...
// Generated from example definition: 2025-09-16-preview/privateEndpoint/PrivateEndpointConnection_Update.json
func ExamplePrivateEndpointConnectionsClient_BeginCreateOrUpdate() {
	...
	// res = armhybridcompute.PrivateEndpointConnectionsClientCreateOrUpdateResponse{
	// 	PrivateEndpointConnection: armhybridcompute.PrivateEndpointConnection{
...
// Generated from example definition: 2025-09-16-preview/privateEndpoint/PrivateEndpointConnection_Delete.json
func ExamplePrivateEndpointConnectionsClient_BeginDelete() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armhybridcompute.PrivateEndpointConnectionsClientDeleteResponse{
	// }
}

// Generated from example definition: 2025-09-16-preview/privateEndpoint/PrivateEndpointConnection_Get.json
func ExamplePrivateEndpointConnectionsClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armhybridcompute.PrivateEndpointConnectionsClientGetResponse{
	// 	PrivateEndpointConnection: armhybridcompute.PrivateEndpointConnection{
	// 		Name: to.Ptr("private-endpoint-connection-name"),
	// 		Type: to.Ptr("Microsoft.HybridCompute/privateLinkScopes/privateEndpointConnections"),
	// 		ID: to.Ptr("/subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/myResourceGroup/providers/Microsoft.HybridCompute/privateLinkScopes/myPrivateLinkScope/privateEndpointConnections/private-endpoint-connection-name"),
...
// Generated from example definition: 2025-09-16-preview/privateEndpoint/PrivateEndpointConnection_List.json
func ExamplePrivateEndpointConnectionsClient_NewListByPrivateLinkScopePager() {
	...
	for pager.More() {
		...
		// page = armhybridcompute.PrivateEndpointConnectionsClientListByPrivateLinkScopeResponse{
		// 	PrivateEndpointConnectionListResult: armhybridcompute.PrivateEndpointConnectionListResult{
