...
func (client *PrivateLinkResourcesClient) listByPrivateLinkScopeCreateRequest(ctx context.Context, resourceGroupName string, scopeName string, nextLink string, _ *PrivateLinkResourcesClientListByPrivateLinkScopeOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
