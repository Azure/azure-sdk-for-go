...
// The returned OperationsServerTransport instance is connected to an instance of armhybridconnectivity.OperationsClient via the
// azcore.ClientOptions.Transporter field in the client's constructor parameters.
func NewOperationsServerTransport(srv *OperationsServer) *OperationsServerTransport {
	return &OperationsServerTransport{
		srv:          srv,
		newListPager: newTracker[azfake.PagerResponder[armhybridconnectivity.OperationsClientListResponse]](),
	}
}
...
type OperationsServerTransport struct {
	...
	newListPager *tracker[azfake.PagerResponder[armhybridconnectivity.OperationsClientListResponse]]
}
...
func (o *OperationsServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armhybridconnectivity.OperationsClientListResponse, createLink func() string) {
