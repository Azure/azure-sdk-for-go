...
```go
client, err := armhybridcontainerservice.NewAgentPoolClient(<subscription ID>, cred, nil)
```
...
client, err := armhybridcontainerservice.NewAgentPoolClient(<subscription ID>, cred, &options)
```
