...
func (c *ClientFactory) NewProvisionedClustersClient() *ProvisionedClustersClient {
	subClient, _ := NewProvisionedClustersClient(c.subscriptionID, c.credential, c.options)
	return subClient
}
...
func (c *ClientFactory) NewAgentPoolClient() *AgentPoolClient {
	subClient, _ := NewAgentPoolClient(c.subscriptionID, c.credential, c.options)
	return subClient
}
...
func (c *ClientFactory) NewStorageSpacesClient() *StorageSpacesClient {
	subClient, _ := NewStorageSpacesClient(c.subscriptionID, c.credential, c.options)
	return subClient
}
