...
// MarshalJSON implements the json.Marshaller interface for type KubernetesVersionProfilePropertiesAutoGenerated.
func (k KubernetesVersionProfilePropertiesAutoGenerated) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type KubernetesVersionProfilePropertiesAutoGenerated.
func (k *KubernetesVersionProfilePropertiesAutoGenerated) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", k, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type VMSKUProfilePropertiesAutoGenerated.
func (v VMSKUProfilePropertiesAutoGenerated) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type VMSKUProfilePropertiesAutoGenerated.
func (v *VMSKUProfilePropertiesAutoGenerated) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", v, err)
	}
