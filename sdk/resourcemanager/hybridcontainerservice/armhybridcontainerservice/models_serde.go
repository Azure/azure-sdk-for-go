...
// MarshalJSON implements the json.Marshaller interface for type AADProfileSecret.
func (a AADProfileSecret) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "serverAppSecret", a.ServerAppSecret)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type AADProfileSecret.
func (a *AADProfileSecret) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", a, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type AgentPoolName.
func (a AgentPoolName) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "name", a.Name)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type AgentPoolName.
func (a *AgentPoolName) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", a, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type AgentPoolProvisioningStatus.
func (a AgentPoolProvisioningStatus) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "provisioningState", a.ProvisioningState)
	populate(objectMap, "status", a.Status)
	return json.Marshal(objectMap)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type AgentPoolProvisioningStatus.
func (a *AgentPoolProvisioningStatus) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", a, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type ControlPlaneEndpointProfile.
func (c ControlPlaneEndpointProfile) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "controlPlaneEndpoint", c.ControlPlaneEndpoint)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ControlPlaneEndpointProfile.
func (c *ControlPlaneEndpointProfile) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type HTTPProxyConfigPassword.
func (h HTTPProxyConfigPassword) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "password", h.Password)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type HTTPProxyConfigPassword.
func (h *HTTPProxyConfigPassword) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", h, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type ProvisionedClustersCommonProperties.
func (p ProvisionedClustersCommonProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "addonProfiles", p.AddonProfiles)
	populate(objectMap, "agentPoolProfiles", p.AgentPoolProfiles)
	populate(objectMap, "cloudProviderProfile", p.CloudProviderProfile)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type ProvisionedClustersCommonProperties.
func (p *ProvisionedClustersCommonProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", p, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type ProvisionedClustersPropertiesWithSecrets.
func (p ProvisionedClustersPropertiesWithSecrets) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "aadProfile", p.AADProfile)
	populate(objectMap, "httpProxyConfig", p.HTTPProxyConfig)
	populate(objectMap, "windowsProfile", p.WindowsProfile)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type ProvisionedClustersPropertiesWithSecrets.
func (p *ProvisionedClustersPropertiesWithSecrets) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", p, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type ProvisionedClustersPropertiesWithoutSecrets.
func (p ProvisionedClustersPropertiesWithoutSecrets) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "aadProfile", p.AADProfile)
	populate(objectMap, "httpProxyConfig", p.HTTPProxyConfig)
	populate(objectMap, "windowsProfile", p.WindowsProfile)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type ProvisionedClustersPropertiesWithoutSecrets.
func (p *ProvisionedClustersPropertiesWithoutSecrets) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", p, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type WindowsProfilePassword.
func (w WindowsProfilePassword) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "adminPassword", w.AdminPassword)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type WindowsProfilePassword.
func (w *WindowsProfilePassword) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", w, err)
	}
