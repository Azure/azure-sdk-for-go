...
func (c ConnectedClusterProperties) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "lastConnectivityTime", c.LastConnectivityTime, true)
	populateTime[datetime.RFC3339](objectMap, "managedIdentityCertificateExpirationTime", c.ManagedIdentityCertificateExpirationTime, true)
...
func (c *ConnectedClusterProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "lastConnectivityTime":
			err = unpopulateTime[datetime.RFC3339](val, "LastConnectivityTime", &c.LastConnectivityTime)
			delete(rawMsg, key)
		case "managedIdentityCertificateExpirationTime":
			err = unpopulateTime[datetime.RFC3339](val, "ManagedIdentityCertificateExpirationTime", &c.ManagedIdentityCertificateExpirationTime)
			delete(rawMsg, key)
