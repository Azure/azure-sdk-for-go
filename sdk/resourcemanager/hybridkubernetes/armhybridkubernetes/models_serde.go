...
func (c ConnectedClusterProperties) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "lastConnectivityTime", c.LastConnectivityTime)
	populateTime[datetime.RFC3339](objectMap, "managedIdentityCertificateExpirationTime", c.ManagedIdentityCertificateExpirationTime)
