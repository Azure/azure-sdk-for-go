...
func (a AzureContainerRegistryScopedTokenCredential) MarshalJSON() ([]byte, error) {
	...
	populateTimeRFC3339(objectMap, "expiry", a.Expiry)
...
func (a *AzureContainerRegistryScopedTokenCredential) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "credentialType":
			...
			delete(rawMsg, key)
		case "expiry":
			err = unpopulateTimeRFC3339(val, "Expiry", &a.Expiry)
			delete(rawMsg, key)
		case "repositories":
...
func (d DeploymentStatusProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateTimeRFC3339(objectMap, "nextExpectedUpdateAt", d.NextExpectedUpdateAt)
...
func (d *DeploymentStatusProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "nextExpectedUpdateAt":
			err = unpopulateTimeRFC3339(val, "NextExpectedUpdateAt", &d.NextExpectedUpdateAt)
			delete(rawMsg, key)
		case "resources":
...
// MarshalJSON implements the json.Marshaller interface for type MappingRuleProfile.
func (m MappingRuleProfile) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "applicationEnablement", m.ApplicationEnablement)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type MappingRuleProfile.
func (m *MappingRuleProfile) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", m, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "applicationEnablement":
			err = unpopulate(val, "ApplicationEnablement", &m.ApplicationEnablement)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", m, err)
...
// MarshalJSON implements the json.Marshaller interface for type NetworkFunctionApplication.
func (n NetworkFunctionApplication) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type NetworkFunctionApplication.
func (n *NetworkFunctionApplication) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", n, err)
	}
...
func (p PodEvent) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateTimeRFC3339(objectMap, "lastSeenTime", p.LastSeenTime)
...
func (p *PodEvent) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "lastSeenTime":
			err = unpopulateTimeRFC3339(val, "LastSeenTime", &p.LastSeenTime)
			delete(rawMsg, key)
		case "message":
...
// MarshalJSON implements the json.Marshaller interface for type ProxyArtifactOverview.
func (p ProxyArtifactOverview) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "id", p.ID)
	populate(objectMap, "name", p.Name)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type ProxyArtifactOverview.
func (p *ProxyArtifactOverview) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", p, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type ProxyArtifactOverviewPropertiesFormat.
func (p ProxyArtifactOverviewPropertiesFormat) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "artifactVersions", p.ArtifactVersions)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ProxyArtifactOverviewPropertiesFormat.
func (p *ProxyArtifactOverviewPropertiesFormat) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", p, err)
	}
	for key, val := range rawMsg {
		...
		case "artifactVersions":
			err = unpopulate(val, "ArtifactVersions", &p.ArtifactVersions)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", p, err)
