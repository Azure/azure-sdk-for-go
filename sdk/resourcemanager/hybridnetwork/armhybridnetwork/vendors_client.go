...
// method.
func (client *VendorsClient) BeginCreateOrUpdate(ctx context.Context, vendorName string, parameters Vendor, options *VendorsClientBeginCreateOrUpdateOptions) (*runtime.Poller[VendorsClientCreateOrUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.createOrUpdate(ctx, vendorName, parameters, options)
		if err != nil {
			return nil, err
		}
...
// If the operation fails it returns an *azcore.ResponseError type.
// Generated from API version 2022-01-01-preview
func (client *VendorsClient) createOrUpdate(ctx context.Context, vendorName string, parameters Vendor, options *VendorsClientBeginCreateOrUpdateOptions) (*http.Response, error) {
	req, err := client.createOrUpdateCreateRequest(ctx, vendorName, parameters, options)
	if err != nil {
		return nil, err
	}
...
func (client *VendorsClient) createOrUpdateCreateRequest(ctx context.Context, vendorName string, parameters Vendor, options *VendorsClientBeginCreateOrUpdateOptions) (*policy.Request, error) {
