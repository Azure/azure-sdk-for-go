...
// OrganizationsServer is a fake server for instances of the arminformaticadatamanagement.OrganizationsClient type.
type OrganizationsServer struct {
	...
	BeginCreateOrUpdate func(ctx context.Context, resourceGroupName string, organizationName string, resource arminformaticadatamanagement.InformaticaOrganizationResource, options *arminformaticadatamanagement.OrganizationsClientBeginCreateOrUpdateOptions) (resp azfake.PollerResponder[arminformaticadatamanagement.OrganizationsClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)

	// BeginDelete is the fake for method OrganizationsClient.BeginDelete
	// HTTP status codes to indicate success: http.StatusAccepted, http.StatusNoContent
	BeginDelete func(ctx context.Context, resourceGroupName string, organizationName string, options *arminformaticadatamanagement.OrganizationsClientBeginDeleteOptions) (resp azfake.PollerResponder[arminformaticadatamanagement.OrganizationsClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method OrganizationsClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, organizationName string, options *arminformaticadatamanagement.OrganizationsClientGetOptions) (resp azfake.Responder[arminformaticadatamanagement.OrganizationsClientGetResponse], errResp azfake.ErrorResponder)

	// GetAllServerlessRuntimes is the fake for method OrganizationsClient.GetAllServerlessRuntimes
	// HTTP status codes to indicate success: http.StatusOK
	GetAllServerlessRuntimes func(ctx context.Context, resourceGroupName string, organizationName string, options *arminformaticadatamanagement.OrganizationsClientGetAllServerlessRuntimesOptions) (resp azfake.Responder[arminformaticadatamanagement.OrganizationsClientGetAllServerlessRuntimesResponse], errResp azfake.ErrorResponder)

	// GetServerlessMetadata is the fake for method OrganizationsClient.GetServerlessMetadata
	// HTTP status codes to indicate success: http.StatusOK
	GetServerlessMetadata func(ctx context.Context, resourceGroupName string, organizationName string, options *arminformaticadatamanagement.OrganizationsClientGetServerlessMetadataOptions) (resp azfake.Responder[arminformaticadatamanagement.OrganizationsClientGetServerlessMetadataResponse], errResp azfake.ErrorResponder)

	// NewListByResourceGroupPager is the fake for method OrganizationsClient.NewListByResourceGroupPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByResourceGroupPager func(resourceGroupName string, options *arminformaticadatamanagement.OrganizationsClientListByResourceGroupOptions) (resp azfake.PagerResponder[arminformaticadatamanagement.OrganizationsClientListByResourceGroupResponse])

	// NewListBySubscriptionPager is the fake for method OrganizationsClient.NewListBySubscriptionPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListBySubscriptionPager func(options *arminformaticadatamanagement.OrganizationsClientListBySubscriptionOptions) (resp azfake.PagerResponder[arminformaticadatamanagement.OrganizationsClientListBySubscriptionResponse])

	// Update is the fake for method OrganizationsClient.Update
	// HTTP status codes to indicate success: http.StatusOK
	Update func(ctx context.Context, resourceGroupName string, organizationName string, properties arminformaticadatamanagement.InformaticaOrganizationResourceUpdate, options *arminformaticadatamanagement.OrganizationsClientUpdateOptions) (resp azfake.Responder[arminformaticadatamanagement.OrganizationsClientUpdateResponse], errResp azfake.ErrorResponder)
}

// NewOrganizationsServerTransport creates a new instance of OrganizationsServerTransport with the provided implementation.
// The returned OrganizationsServerTransport instance is connected to an instance of arminformaticadatamanagement.OrganizationsClient via the
...
func NewOrganizationsServerTransport(srv *OrganizationsServer) *OrganizationsServerTransport {
	return &OrganizationsServerTransport{
		srv:                         srv,
		beginCreateOrUpdate:         newTracker[azfake.PollerResponder[arminformaticadatamanagement.OrganizationsClientCreateOrUpdateResponse]](),
		beginDelete:                 newTracker[azfake.PollerResponder[arminformaticadatamanagement.OrganizationsClientDeleteResponse]](),
		newListByResourceGroupPager: newTracker[azfake.PagerResponder[arminformaticadatamanagement.OrganizationsClientListByResourceGroupResponse]](),
		newListBySubscriptionPager:  newTracker[azfake.PagerResponder[arminformaticadatamanagement.OrganizationsClientListBySubscriptionResponse]](),
	}
}

// OrganizationsServerTransport connects instances of arminformaticadatamanagement.OrganizationsClient to instances of OrganizationsServer.
...
type OrganizationsServerTransport struct {
	...
	beginCreateOrUpdate         *tracker[azfake.PollerResponder[arminformaticadatamanagement.OrganizationsClientCreateOrUpdateResponse]]
	beginDelete                 *tracker[azfake.PollerResponder[arminformaticadatamanagement.OrganizationsClientDeleteResponse]]
	newListByResourceGroupPager *tracker[azfake.PagerResponder[arminformaticadatamanagement.OrganizationsClientListByResourceGroupResponse]]
	newListBySubscriptionPager  *tracker[azfake.PagerResponder[arminformaticadatamanagement.OrganizationsClientListBySubscriptionResponse]]
}
...
func (o *OrganizationsServerTransport) dispatchBeginCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginCreateOrUpdate == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[arminformaticadatamanagement.InformaticaOrganizationResource](req)
		if err != nil {
			return nil, err
		}
...
func (o *OrganizationsServerTransport) dispatchNewListByResourceGroupPager(req *http.Request) (*http.Response, error) {
	...
	if newListByResourceGroupPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListByResourceGroupPager, req, func(page *arminformaticadatamanagement.OrganizationsClientListByResourceGroupResponse, createLink func() string) {
...
func (o *OrganizationsServerTransport) dispatchNewListBySubscriptionPager(req *http.Request) (*http.Response, error) {
	...
	if newListBySubscriptionPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListBySubscriptionPager, req, func(page *arminformaticadatamanagement.OrganizationsClientListBySubscriptionResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
...
func (o *OrganizationsServerTransport) dispatchUpdate(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[arminformaticadatamanagement.InformaticaOrganizationResourceUpdate](req)
	if err != nil {
		return nil, err
	}
	resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
