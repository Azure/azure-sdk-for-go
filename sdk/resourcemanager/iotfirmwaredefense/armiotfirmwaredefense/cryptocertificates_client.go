...
func (client *CryptoCertificatesClient) listByFirmwareCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, firmwareID string, nextLink string, _ *CryptoCertificatesClientListByFirmwareOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *CryptoCertificatesClient) listByFirmwareHandleResponse(resp *http.Response, successCodes ...int) (CryptoCertificatesClientListByFirmwareResponse, error) {
