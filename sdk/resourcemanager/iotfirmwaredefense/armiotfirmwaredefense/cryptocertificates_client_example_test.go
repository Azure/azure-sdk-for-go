...
func ExampleCryptoCertificatesClient_NewListByFirmwarePager_cryptoCertificatesListByFirmwareMaximumSetGenGeneratedByMaximumSetRule() {
	...
	for pager.More() {
		...
		// 					},
		// 					IssuedDate: to.Ptr(time.Date(2024, time.June, 13, 15, 22, 47, 274000000, time.UTC)),
		// 					ExpirationDate: to.Ptr(time.Date(2024, time.June, 13, 15, 22, 47, 274000000, time.UTC)),
