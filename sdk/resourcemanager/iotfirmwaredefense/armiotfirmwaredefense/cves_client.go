...
func (client *CvesClient) listByFirmwareCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, firmwareID string, options *CvesClientListByFirmwareOptions) (*policy.Request, error) {
...
func (client *CvesClient) listByFirmwareHandleResponse(resp *http.Response) (CvesClientListByFirmwareResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.CveListResult); err != nil {
		return CvesClientListByFirmwareResponse{}, err
	}
	return result, nil
}
