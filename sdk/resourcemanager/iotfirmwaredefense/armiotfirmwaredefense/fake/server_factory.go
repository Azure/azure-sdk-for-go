...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "BinaryHardeningClient":
		initServer(&s.trMu, &s.trBinaryHardeningServer, func() *BinaryHardeningServerTransport {
	...
	case "CryptoCertificatesClient":
		initServer(&s.trMu, &s.trCryptoCertificatesServer, func() *CryptoCertificatesServerTransport {
	...
	case "CryptoKeysClient":
		initServer(&s.trMu, &s.trCryptoKeysServer, func() *CryptoKeysServerTransport { return NewCryptoKeysServerTransport(&s.srv.CryptoKeysServer) })
		resp, err = s.trCryptoKeysServer.Do(req)
	case "CvesClient":
		initServer(&s.trMu, &s.trCvesServer, func() *CvesServerTransport { return NewCvesServerTransport(&s.srv.CvesServer) })
		resp, err = s.trCvesServer.Do(req)
	case "FirmwaresClient":
		initServer(&s.trMu, &s.trFirmwaresServer, func() *FirmwaresServerTransport { return NewFirmwaresServerTransport(&s.srv.FirmwaresServer) })
		resp, err = s.trFirmwaresServer.Do(req)
	case "OperationsClient":
		initServer(&s.trMu, &s.trOperationsServer, func() *OperationsServerTransport { return NewOperationsServerTransport(&s.srv.OperationsServer) })
		resp, err = s.trOperationsServer.Do(req)
	case "PasswordHashesClient":
		initServer(&s.trMu, &s.trPasswordHashesServer, func() *PasswordHashesServerTransport {
	...
	case "SbomComponentsClient":
		initServer(&s.trMu, &s.trSbomComponentsServer, func() *SbomComponentsServerTransport {
