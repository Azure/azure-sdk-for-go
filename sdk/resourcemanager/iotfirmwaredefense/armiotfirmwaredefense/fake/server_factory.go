...
type ServerFactoryTransport struct {
	srv                *ServerFactory
	trMu               sync.Mutex
	trFirmwareServer   *FirmwareServerTransport
...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	switch client {
	case "FirmwareClient":
		initServer(s, &s.trFirmwareServer, func() *FirmwareServerTransport { return NewFirmwareServerTransport(&s.srv.FirmwareServer) })
		resp, err = s.trFirmwareServer.Do(req)
