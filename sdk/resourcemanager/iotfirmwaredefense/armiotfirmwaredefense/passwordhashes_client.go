...
func (client *PasswordHashesClient) listByFirmwareCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, firmwareID string, options *PasswordHashesClientListByFirmwareOptions) (*policy.Request, error) {
...
func (client *PasswordHashesClient) listByFirmwareHandleResponse(resp *http.Response) (PasswordHashesClientListByFirmwareResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.PasswordHashListResult); err != nil {
		return PasswordHashesClientListByFirmwareResponse{}, err
	}
	return result, nil
}
