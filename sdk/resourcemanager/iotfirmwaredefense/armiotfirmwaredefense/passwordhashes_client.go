...
func (client *PasswordHashesClient) listByFirmwareCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, firmwareID string, nextLink string, _ *PasswordHashesClientListByFirmwareOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *PasswordHashesClient) listByFirmwareHandleResponse(resp *http.Response, successCodes ...int) (PasswordHashesClientListByFirmwareResponse, error) {
