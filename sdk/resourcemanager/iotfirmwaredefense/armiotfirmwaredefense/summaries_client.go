...
func (client *SummariesClient) listByFirmwareCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, firmwareID string, _ *SummariesClientListByFirmwareOptions) (*policy.Request, error) {
