...
func (client *WorkspacesClient) Create(ctx context.Context, resourceGroupName string, workspaceName string, resource Workspace, options *WorkspacesClientCreateOptions) (WorkspacesClientCreateResponse, error) {
	var err error
	const operationName = "WorkspacesClient.Create"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.createCreateRequest(ctx, resourceGroupName, workspaceName, resource, options)
	if err != nil {
...
func (client *WorkspacesClient) createCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, resource Workspace, _ *WorkspacesClientCreateOptions) (*policy.Request, error) {
...
func (client *WorkspacesClient) createHandleResponse(resp *http.Response, successCodes ...int) (WorkspacesClientCreateResponse, error) {
...
//     method.
func (client *WorkspacesClient) GenerateUploadURL(ctx context.Context, resourceGroupName string, workspaceName string, body GenerateUploadURLRequest, options *WorkspacesClientGenerateUploadURLOptions) (WorkspacesClientGenerateUploadURLResponse, error) {
	var err error
	const operationName = "WorkspacesClient.GenerateUploadURL"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.generateUploadURLCreateRequest(ctx, resourceGroupName, workspaceName, body, options)
	if err != nil {
	...
	return client.generateUploadURLHandleResponse(httpResp, http.StatusOK)
}

// generateUploadURLCreateRequest creates the GenerateUploadURL request.
func (client *WorkspacesClient) generateUploadURLCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, body GenerateUploadURLRequest, _ *WorkspacesClientGenerateUploadURLOptions) (*policy.Request, error) {
...
func (client *WorkspacesClient) generateUploadURLHandleResponse(resp *http.Response, successCodes ...int) (WorkspacesClientGenerateUploadURLResponse, error) {
...
func (client *WorkspacesClient) Update(ctx context.Context, resourceGroupName string, workspaceName string, properties WorkspaceUpdate, options *WorkspacesClientUpdateOptions) (WorkspacesClientUpdateResponse, error) {
	var err error
...
func (client *WorkspacesClient) updateCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, properties WorkspaceUpdate, _ *WorkspacesClientUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.IoTFirmwareDefense/workspaces/{workspaceName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
