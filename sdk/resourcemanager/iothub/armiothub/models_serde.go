...
func (c CertificateProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "certificateAuthorityResourceId", c.CertificateAuthorityResourceID)
...
func (c *CertificateProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "certificateAuthorityResourceId":
			err = unpopulate(val, "CertificateAuthorityResourceID", &c.CertificateAuthorityResourceID)
			delete(rawMsg, key)
		case "created":
...
func (d Details) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "gatewayVersion", d.GatewayVersion)
	return json.Marshal(objectMap)
}
...
func (d *Details) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "gatewayVersion":
			err = unpopulate(val, "GatewayVersion", &d.GatewayVersion)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %s", d, err.Error())
...
func (d DeviceRegistry) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "dataPlaneHostName", d.DataPlaneHostName)
	populate(objectMap, "identity", d.Identity)
	populate(objectMap, "linkingProperties", d.LinkingProperties)
...
func (d *DeviceRegistry) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		var err error
		switch key {
		case "dataPlaneHostName":
			err = unpopulate(val, "DataPlaneHostName", &d.DataPlaneHostName)
			delete(rawMsg, key)
		case "identity":
			err = unpopulate(val, "Identity", &d.Identity)
			delete(rawMsg, key)
		case "linkingProperties":
			err = unpopulate(val, "LinkingProperties", &d.LinkingProperties)
			delete(rawMsg, key)
...
// MarshalJSON implements the json.Marshaller interface for type DeviceRegistryIdentity.
func (d DeviceRegistryIdentity) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "type", d.Type)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type DeviceRegistryIdentity.
func (d *DeviceRegistryIdentity) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %s", d, err.Error())
	}
...
// MarshalJSON implements the json.Marshaller interface for type DeviceRegistryLinkingProperties.
func (d DeviceRegistryLinkingProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type DeviceRegistryLinkingProperties.
func (d *DeviceRegistryLinkingProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %s", d, err.Error())
	}
...
func (e *EndpointHealthData) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "lastKnownErrorTime":
			err = unpopulateTime[datetime.RFC7231](val, "LastKnownErrorTime", &e.LastKnownErrorTime)
			delete(rawMsg, key)
		case "lastSendAttemptTime":
			err = unpopulateTime[datetime.RFC7231](val, "LastSendAttemptTime", &e.LastSendAttemptTime)
			delete(rawMsg, key)
		case "lastSuccessfulSendAttemptTime":
			err = unpopulateTime[datetime.RFC7231](val, "LastSuccessfulSendAttemptTime", &e.LastSuccessfulSendAttemptTime)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %s", e, err.Error())
...
func (j *JobResponse) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "endTimeUtc":
			err = unpopulateTime[datetime.RFC7231](val, "EndTimeUTC", &j.EndTimeUTC)
			delete(rawMsg, key)
		case "failureReason":
		...
		case "parentJobId":
			...
			delete(rawMsg, key)
		case "startTimeUtc":
			err = unpopulateTime[datetime.RFC7231](val, "StartTimeUTC", &j.StartTimeUTC)
			delete(rawMsg, key)
		case "status":
...
// MarshalJSON implements the json.Marshaller interface for type MqttV5Settings.
func (m MqttV5Settings) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "topicGroups", m.TopicGroups)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type MqttV5Settings.
func (m *MqttV5Settings) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %s", m, err.Error())
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "topicGroups":
			err = unpopulate(val, "TopicGroups", &m.TopicGroups)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %s", m, err.Error())
...
func (p Properties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "connectionProfile", p.ConnectionProfile)
	populate(objectMap, "deviceHostName", p.DeviceHostName)
	...
	populate(objectMap, "iotHubDetails", p.IotHubDetails)
	...
	populate(objectMap, "mqttV5Settings", p.MqttV5Settings)
	...
	populate(objectMap, "serviceHostName", p.ServiceHostName)
...
func (p *Properties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "connectionProfile":
			err = unpopulate(val, "ConnectionProfile", &p.ConnectionProfile)
			delete(rawMsg, key)
		case "deviceHostName":
			err = unpopulate(val, "DeviceHostName", &p.DeviceHostName)
			delete(rawMsg, key)
		case "deviceRegistry":
		...
		case "ipVersion":
			...
			delete(rawMsg, key)
		case "iotHubDetails":
			err = unpopulate(val, "IotHubDetails", &p.IotHubDetails)
			delete(rawMsg, key)
		case "locations":
		...
		case "minTlsVersion":
			...
			delete(rawMsg, key)
		case "mqttV5Settings":
			err = unpopulate(val, "MqttV5Settings", &p.MqttV5Settings)
			delete(rawMsg, key)
		...
		case "serviceHostName":
			err = unpopulate(val, "ServiceHostName", &p.ServiceHostName)
			delete(rawMsg, key)
		case "state":
...
func (r RouteProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "dataSchema", r.DataSchema)
...
func (r RoutingCosmosDBSQLAPIProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "messagePayloadFormat", r.MessagePayloadFormat)
	populate(objectMap, "name", r.Name)
...
func (r *RoutingCosmosDBSQLAPIProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "identity":
			...
			delete(rawMsg, key)
		case "messagePayloadFormat":
			err = unpopulate(val, "MessagePayloadFormat", &r.MessagePayloadFormat)
			delete(rawMsg, key)
		case "name":
			err = unpopulate(val, "Name", &r.Name)
			delete(rawMsg, key)
...
func (r RoutingEndpoints) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "eventStreams", r.EventStreams)
...
func (r *RoutingEndpoints) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "eventHubs":
			...
			delete(rawMsg, key)
		case "eventStreams":
			err = unpopulate(val, "EventStreams", &r.EventStreams)
			delete(rawMsg, key)
...
// MarshalJSON implements the json.Marshaller interface for type RoutingEventStreamProperties.
func (r RoutingEventStreamProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "authenticationType", r.AuthenticationType)
	populate(objectMap, "endpointUri", r.EndpointURI)
	populate(objectMap, "entityPath", r.EntityPath)
	populate(objectMap, "eventStreamId", r.EventStreamID)
	populate(objectMap, "id", r.ID)
	populate(objectMap, "identity", r.Identity)
	populate(objectMap, "messagePayloadFormat", r.MessagePayloadFormat)
	populate(objectMap, "name", r.Name)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type RoutingEventStreamProperties.
func (r *RoutingEventStreamProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %s", r, err.Error())
	}
	for key, val := range rawMsg {
		...
		case "entityPath":
			...
			delete(rawMsg, key)
		case "eventStreamId":
			err = unpopulate(val, "EventStreamID", &r.EventStreamID)
			delete(rawMsg, key)
		case "id":
			err = unpopulate(val, "ID", &r.ID)
			delete(rawMsg, key)
...
// MarshalJSON implements the json.Marshaller interface for type TopicGroup.
func (t TopicGroup) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "topicGroupId", t.TopicGroupID)
	populate(objectMap, "topicTemplates", t.TopicTemplates)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type TopicGroup.
func (t *TopicGroup) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %s", t, err.Error())
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "topicGroupId":
			err = unpopulate(val, "TopicGroupID", &t.TopicGroupID)
			delete(rawMsg, key)
		case "topicTemplates":
