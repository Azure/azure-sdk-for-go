...
func (c CertificateProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "expiry", c.Expiry)
	...
	populate(objectMap, "updated", c.Updated)
	return json.Marshal(objectMap)
}
...
func (c *CertificateProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "created":
			...
			delete(rawMsg, key)
		case "expiry":
			err = unpopulate(val, "Expiry", &c.Expiry)
			delete(rawMsg, key)
		case "isVerified":
		...
		case "thumbprint":
			...
			delete(rawMsg, key)
		case "updated":
			err = unpopulate(val, "Updated", &c.Updated)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", c, err)
...
func (e EndpointHealthData) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "lastKnownErrorTime", e.LastKnownErrorTime)
	populate(objectMap, "lastSendAttemptTime", e.LastSendAttemptTime)
	populate(objectMap, "lastSuccessfulSendAttemptTime", e.LastSuccessfulSendAttemptTime)
	return json.Marshal(objectMap)
}
...
func (e *EndpointHealthData) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "lastKnownErrorTime":
			err = unpopulate(val, "LastKnownErrorTime", &e.LastKnownErrorTime)
			delete(rawMsg, key)
		case "lastSendAttemptTime":
			err = unpopulate(val, "LastSendAttemptTime", &e.LastSendAttemptTime)
			delete(rawMsg, key)
		case "lastSuccessfulSendAttemptTime":
			err = unpopulate(val, "LastSuccessfulSendAttemptTime", &e.LastSuccessfulSendAttemptTime)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", e, err)
...
func (r RootCertificateProperties) MarshalJSON() ([]byte, error) {
	...
	populateDateTimeRFC3339(objectMap, "lastUpdatedTimeUtc", r.LastUpdatedTimeUTC)
	return json.Marshal(objectMap)
}
...
func (r *RootCertificateProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "lastUpdatedTimeUtc":
			err = unpopulateDateTimeRFC3339(val, "LastUpdatedTimeUTC", &r.LastUpdatedTimeUTC)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", r, err)
