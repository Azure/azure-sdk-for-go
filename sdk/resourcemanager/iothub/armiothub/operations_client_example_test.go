...
// Generated from example definition: 2026-03-01-preview/iothub_operations.json
func ExampleOperationsClient_NewListPager() {
	...
	clientFactory, err := armiothub.NewClientFactory("<subscriptionID>", cred, nil)
	if err != nil {
	...
	for pager.More() {
		...
		// page = armiothub.OperationsClientListResponse{
		// 	OperationListResult: armiothub.OperationListResult{
