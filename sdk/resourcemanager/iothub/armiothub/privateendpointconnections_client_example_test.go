...
// Generated from example definition: 2026-10-01-preview/iothub_deleteprivateendpointconnection.json
func ExamplePrivateEndpointConnectionsClient_BeginDelete() {
	...
	// res = armiothub.PrivateEndpointConnectionsClientDeleteResponse{
	// 	PrivateEndpointConnection: armiothub.PrivateEndpointConnection{
...
// Generated from example definition: 2026-10-01-preview/iothub_getprivateendpointconnection.json
func ExamplePrivateEndpointConnectionsClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armiothub.PrivateEndpointConnectionsClientGetResponse{
	// 	PrivateEndpointConnection: armiothub.PrivateEndpointConnection{
	// 		Name: to.Ptr("myPrivateEndpointConnection"),
	// 		Type: to.Ptr("Microsoft.Devices/IotHubs/PrivateEndpointConnections"),
	// 		ID: to.Ptr("/subscriptions/91d12660-3dec-467a-be2a-213b5544ddc0/resourceGroups/myResourceGroup/providers/Microsoft.Devices/IotHubs/testHub/PrivateEndpointConnections/myPrivateEndpointConnection"),
...
// Generated from example definition: 2026-10-01-preview/iothub_listprivateendpointconnections.json
func ExamplePrivateEndpointConnectionsClient_List() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armiothub.PrivateEndpointConnectionsClientListResponse{
	// 	PrivateEndpointConnectionArray: []*armiothub.PrivateEndpointConnection{
	// 		{
	// 			Name: to.Ptr("myPrivateEndpointConnection"),
	// 			Type: to.Ptr("Microsoft.Devices/IotHubs/PrivateEndpointConnections"),
	// 			ID: to.Ptr("/subscriptions/91d12660-3dec-467a-be2a-213b5544ddc0/resourceGroups/myResourceGroup/providers/Microsoft.Devices/IotHubs/testHub/PrivateEndpointConnections/myPrivateEndpointConnection"),
...
// Generated from example definition: 2026-10-01-preview/iothub_updateprivateendpointconnection.json
func ExamplePrivateEndpointConnectionsClient_BeginUpdate() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armiothub.PrivateEndpointConnectionsClientUpdateResponse{
	// 	PrivateEndpointConnection: armiothub.PrivateEndpointConnection{
	// 		Name: to.Ptr("myPrivateEndpointConnection"),
	// 		Type: to.Ptr("Microsoft.Devices/IotHubs/PrivateEndpointConnections"),
	// 		ID: to.Ptr("/subscriptions/91d12660-3dec-467a-be2a-213b5544ddc0/resourceGroups/myResourceGroup/providers/Microsoft.Devices/IotHubs/testHub/PrivateEndpointConnections/myPrivateEndpointConnection"),
