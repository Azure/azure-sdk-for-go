...
func ExampleAkriConnectorTemplateClient_BeginCreateOrUpdate() {
	...
	poller, err := clientFactory.NewAkriConnectorTemplateClient().BeginCreateOrUpdate(ctx, "rgiotoperations", "resource-name123", "resource-name123", armiotoperations.AkriConnectorTemplateResource{
		Properties: &armiotoperations.AkriConnectorTemplateProperties{
			...
			RuntimeConfiguration: &armiotoperations.AkriConnectorTemplateHelmConfiguration{
				RuntimeConfigurationType: to.Ptr(armiotoperations.AkriConnectorTemplateRuntimeConfigurationTypeHelmConfiguration),
				HelmConfigurationSettings: &armiotoperations.AkriConnectorTemplateHelmConfigurationSettings{
					ReleaseName:    to.Ptr("my-install"),
					RepositoryName: to.Ptr("my-repo"),
...
func ExampleAkriConnectorTemplateClient_Get_akriConnectorTemplateGetManagedRest() {
	...
	// 					Allocation: &armiotoperations.AkriConnectorTemplateBucketizedAllocation{
	// 						Policy: to.Ptr(armiotoperations.AkriConnectorTemplateAllocationPolicyBucketized),
	// 						BucketSize: to.Ptr[int32](1),
	// 					},
	// 					PersistentVolumeClaims: []*armiotoperations.AkriConnectorTemplatePersistentVolumeClaim{
	// 						{
	// 							ClaimName: to.Ptr("test-pvc"),
	// 							MountPath: to.Ptr("/data/connector"),
	// 						},
	// 					},
	// 					Secrets: []*armiotoperations.AkriConnectorsSecret{
	// 						{
	// 							SecretAlias: to.Ptr("username"),
	// 							SecretRef: to.Ptr("secret-a"),
	// 							SecretKey: to.Ptr("username"),
	// 						},
	// 						{
	// 							SecretAlias: to.Ptr("password"),
	// 							SecretRef: to.Ptr("secret-a"),
	// 							SecretKey: to.Ptr("password"),
	// 						},
	// 					},
	// 					TrustSettings: &armiotoperations.AkriConnectorTemplateTrustList{
	// 						TrustListSecretRef: to.Ptr("trust-list-secret"),
	// 					},
	...
	// 						ImageName: to.Ptr("samples/akri-connector-minimalist"),
	...
	// 								Registry: to.Ptr("mycr.azurecr.io"),
	// 							},
	// 						},
	// 					},
	// 				},
