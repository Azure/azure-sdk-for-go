...
func (client *BrokerClient) getHandleResponse(resp *http.Response, successCodes ...int) (BrokerClientGetResponse, error) {
...
func (client *BrokerClient) listByResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, instanceName string, nextLink string, _ *BrokerClientListByResourceGroupOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *BrokerClient) listByResourceGroupHandleResponse(resp *http.Response, successCodes ...int) (BrokerClientListByResourceGroupResponse, error) {
