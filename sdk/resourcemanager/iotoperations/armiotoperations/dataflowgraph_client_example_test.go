			...
			Nodes: []armiotoperations.DataflowGraphNodeClassification{
				...
				&armiotoperations.DataflowGraphDestinationNode{
					...
					DestinationSettings: &armiotoperations.DataflowGraphDestinationNodeSettings{
						...
						OutputSchemaSettings: &armiotoperations.DataflowGraphDestinationSchemaSettings{
							SchemaRef:           to.Ptr("aio-sr://namespace/alert-parquet:1"),
							SerializationFormat: to.Ptr(armiotoperations.DataflowGraphDestinationSchemaSerializationFormatParquet),
						},
					},
				},
			},
