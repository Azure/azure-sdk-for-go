...
func (client *DataflowProfileClient) getHandleResponse(resp *http.Response, successCodes ...int) (DataflowProfileClientGetResponse, error) {
...
func (client *DataflowProfileClient) NewListByResourceGroupPager(resourceGroupName string, instanceName string, options *DataflowProfileClientListByResourceGroupOptions) *runtime.Pager[DataflowProfileClientListByResourceGroupResponse] {
	return runtime.NewPager(runtime.PagingHandler[DataflowProfileClientListByResourceGroupResponse]{
		...
		Fetcher: func(ctx context.Context, page *DataflowProfileClientListByResourceGroupResponse) (DataflowProfileClientListByResourceGroupResponse, error) {
			...
			req, err := client.listByResourceGroupCreateRequest(ctx, resourceGroupName, instanceName, nextLink, options)
			if err != nil {
...
func (client *DataflowProfileClient) listByResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, instanceName string, nextLink string, _ *DataflowProfileClientListByResourceGroupOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *DataflowProfileClient) listByResourceGroupHandleResponse(resp *http.Response, successCodes ...int) (DataflowProfileClientListByResourceGroupResponse, error) {
