...
func unmarshalDataflowDestinationHeaderActionClassification(rawMsg json.RawMessage) (DataflowDestinationHeaderActionClassification, error) {
	if rawMsg == nil || string(rawMsg) == "null" {
		return nil, nil
	}
	var m map[string]any
	...
	var b DataflowDestinationHeaderActionClassification
	switch m["actionType"] {
...
func unmarshalDataflowDestinationHeaderActionClassificationArray(rawMsg json.RawMessage) ([]DataflowDestinationHeaderActionClassification, error) {
	if rawMsg == nil || string(rawMsg) == "null" {
		return nil, nil
	}
	...
	fArray := make([]DataflowDestinationHeaderActionClassification, len(rawMessages))
	for index, rawMessage := range rawMessages {
		f, err := unmarshalDataflowDestinationHeaderActionClassification(rawMessage)
		if err != nil {
			return nil, err
		}
		fArray[index] = f
...
func unmarshalDataflowGraphDestinationHeaderActionClassification(rawMsg json.RawMessage) (DataflowGraphDestinationHeaderActionClassification, error) {
	if rawMsg == nil || string(rawMsg) == "null" {
		return nil, nil
	}
	var m map[string]any
	...
	var b DataflowGraphDestinationHeaderActionClassification
	switch m["actionType"] {
...
func unmarshalDataflowGraphDestinationHeaderActionClassificationArray(rawMsg json.RawMessage) ([]DataflowGraphDestinationHeaderActionClassification, error) {
	if rawMsg == nil || string(rawMsg) == "null" {
		return nil, nil
	}
	var rawMessages []json.RawMessage
	...
	fArray := make([]DataflowGraphDestinationHeaderActionClassification, len(rawMessages))
	for index, rawMessage := range rawMessages {
		f, err := unmarshalDataflowGraphDestinationHeaderActionClassification(rawMessage)
		if err != nil {
			return nil, err
		}
		fArray[index] = f
...
func unmarshalRegistryEndpointTrustedSigningKeyClassificationArray(rawMsg json.RawMessage) ([]RegistryEndpointTrustedSigningKeyClassification, error) {
	if rawMsg == nil || string(rawMsg) == "null" {
		return nil, nil
	}
	var rawMessages []json.RawMessage
	...
	fArray := make([]RegistryEndpointTrustedSigningKeyClassification, len(rawMessages))
	for index, rawMessage := range rawMessages {
		f, err := unmarshalRegistryEndpointTrustedSigningKeyClassification(rawMessage)
		if err != nil {
			return nil, err
		}
		fArray[index] = f
