...
func ExampleManagedHsmKeysClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armkeyvault.ManagedHsmKeysClientListResponse{
		// 	ManagedHsmKeyListResult: armkeyvault.ManagedHsmKeyListResult{
...
func ExampleManagedHsmKeysClient_NewListVersionsPager() {
	...
	for pager.More() {
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armkeyvault.ManagedHsmKeysClientListVersionsResponse{
		// 	ManagedHsmKeyListResult: armkeyvault.ManagedHsmKeyListResult{
		// 		Value: []*armkeyvault.ManagedHsmKey{
		// 			{
