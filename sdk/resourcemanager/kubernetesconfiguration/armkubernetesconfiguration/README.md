...
```go
client, err := armkubernetesconfiguration.NewClusterExtensionTypeClient(<subscription ID>, cred, nil)
```
...
client, err := armkubernetesconfiguration.NewClusterExtensionTypeClient(<subscription ID>, cred, &options)
```
