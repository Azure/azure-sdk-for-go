...
func (client *OperationStatusClient) List(resourceGroupName string, clusterRp string, clusterResourceName string, clusterName string, options *OperationStatusClientListOptions) *OperationStatusClientListPager {
