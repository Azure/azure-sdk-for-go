...
// Generated from example definition: 2024-04-13/KustoAttachedDatabaseConfigurationCheckNameAvailability.json
func ExampleAttachedDatabaseConfigurationsClient_CheckNameAvailability() {
	...
	// res = armkusto.AttachedDatabaseConfigurationsClientCheckNameAvailabilityResponse{
...
// Generated from example definition: 2024-04-13/KustoAttachedDatabaseConfigurationsCreateOrUpdate.json
func ExampleAttachedDatabaseConfigurationsClient_BeginCreateOrUpdate() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armkusto.AttachedDatabaseConfigurationsClientCreateOrUpdateResponse{
	// 	AttachedDatabaseConfiguration: &armkusto.AttachedDatabaseConfiguration{
...
// Generated from example definition: 2024-04-13/KustoAttachedDatabaseConfigurationsDelete.json
func ExampleAttachedDatabaseConfigurationsClient_BeginDelete() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armkusto.AttachedDatabaseConfigurationsClientDeleteResponse{
	// }
}

// Generated from example definition: 2024-04-13/KustoAttachedDatabaseConfigurationsGet.json
func ExampleAttachedDatabaseConfigurationsClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armkusto.AttachedDatabaseConfigurationsClientGetResponse{
	// 	AttachedDatabaseConfiguration: &armkusto.AttachedDatabaseConfiguration{
	// 		Name: to.Ptr("kustoCluster2/attachedDatabaseConfigurationsTest"),
	// 		Type: to.Ptr("Microsoft.Kusto/Clusters/AttachedDatabaseConfigurations"),
	// 		ID: to.Ptr("/subscriptions/12345678-1234-1234-1234-123456789098/resourceGroups/kustorptest/providers/Microsoft.Kusto/Clusters/kustoCluster2/AttachedDatabaseConfigurations/attachedDatabaseConfigurationsTest"),
...
// Generated from example definition: 2024-04-13/KustoAttachedDatabaseConfigurationsListByCluster.json
func ExampleAttachedDatabaseConfigurationsClient_NewListByClusterPager() {
	...
	for pager.More() {
		...
		// page = armkusto.AttachedDatabaseConfigurationsClientListByClusterResponse{
