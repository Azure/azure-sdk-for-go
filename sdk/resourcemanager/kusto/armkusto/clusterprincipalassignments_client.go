...
func (client *ClusterPrincipalAssignmentsClient) checkNameAvailabilityHandleResponse(resp *http.Response, successCodes ...int) (ClusterPrincipalAssignmentsClientCheckNameAvailabilityResponse, error) {
...
func (client *ClusterPrincipalAssignmentsClient) getHandleResponse(resp *http.Response, successCodes ...int) (ClusterPrincipalAssignmentsClientGetResponse, error) {
...
func (client *ClusterPrincipalAssignmentsClient) listCreateRequest(ctx context.Context, resourceGroupName string, clusterName string, nextLink string, _ *ClusterPrincipalAssignmentsClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *ClusterPrincipalAssignmentsClient) listHandleResponse(resp *http.Response, successCodes ...int) (ClusterPrincipalAssignmentsClientListResponse, error) {
