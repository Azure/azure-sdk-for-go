...
// Generated from example definition: 2024-04-13/KustoDatabasePrincipalAssignmentsCheckNameAvailability.json
func ExampleDatabasePrincipalAssignmentsClient_CheckNameAvailability() {
	...
	// res = armkusto.DatabasePrincipalAssignmentsClientCheckNameAvailabilityResponse{
...
// Generated from example definition: 2024-04-13/KustoDatabasePrincipalAssignmentsCreateOrUpdate.json
func ExampleDatabasePrincipalAssignmentsClient_BeginCreateOrUpdate() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armkusto.DatabasePrincipalAssignmentsClientCreateOrUpdateResponse{
...
// Generated from example definition: 2024-04-13/KustoDatabasePrincipalAssignmentsDelete.json
func ExampleDatabasePrincipalAssignmentsClient_BeginDelete() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armkusto.DatabasePrincipalAssignmentsClientDeleteResponse{
	// }
}

// Generated from example definition: 2024-04-13/KustoDatabasePrincipalAssignmentsGet.json
func ExampleDatabasePrincipalAssignmentsClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armkusto.DatabasePrincipalAssignmentsClientGetResponse{
	// 	DatabasePrincipalAssignment: &armkusto.DatabasePrincipalAssignment{
	// 		Name: to.Ptr("kustoCluster/Kustodatabase8/kustoprincipal1"),
	// 		Type: to.Ptr("Microsoft.Kusto/Clusters/Databases/PrincipalAssignments"),
	// 		ID: to.Ptr("/subscriptions/12345678-1234-1234-1234-123456789098/resourceGroups/kustorptest/providers/Microsoft.Kusto/Clusters/kustoCluster/Databases/Kustodatabase8/PrincipalAssignments/kustoprincipal1"),
...
// Generated from example definition: 2024-04-13/KustoDatabasePrincipalAssignmentsList.json
func ExampleDatabasePrincipalAssignmentsClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armkusto.DatabasePrincipalAssignmentsClientListResponse{
		// 	DatabasePrincipalAssignmentListResult: armkusto.DatabasePrincipalAssignmentListResult{
