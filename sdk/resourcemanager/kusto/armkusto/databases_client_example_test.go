...
// Generated from example definition: 2025-02-14/KustoDatabaseAddPrincipals.json
func ExampleDatabasesClient_AddPrincipals() {
	...
	// res = armkusto.DatabasesClientAddPrincipalsResponse{
	// 	DatabasePrincipalListResult: &armkusto.DatabasePrincipalListResult{
	// 		Value: []*armkusto.DatabasePrincipal{
	// 			{
	// 				Name: to.Ptr("Some User"),
	// 				Type: to.Ptr(armkusto.DatabasePrincipalTypeUser),
...
// Generated from example definition: 2025-02-14/KustoDatabasesCheckNameAvailability.json
func ExampleDatabasesClient_CheckNameAvailability() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armkusto.DatabasesClientCheckNameAvailabilityResponse{
...
// Generated from example definition: 2025-02-14/KustoDatabaseReadonlyUpdate.json
func ExampleDatabasesClient_BeginCreateOrUpdate_kustoReadOnlyDatabaseUpdate() {
	...
	// 	ReadOnlyFollowingDatabase: &armkusto.ReadOnlyFollowingDatabase{
...
// Generated from example definition: 2025-02-14/KustoDatabasesCreateOrUpdate.json
func ExampleDatabasesClient_BeginCreateOrUpdate_kustoReadWriteDatabaseCreateOrUpdate() {
	...
	}, &armkusto.DatabasesClientBeginCreateOrUpdateOptions{
		CallerRole: to.Ptr(armkusto.CallerRoleAdmin)})
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	res, err := poller.PollUntilDone(ctx, nil)
	...
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armkusto.DatabasesClientCreateOrUpdateResponse{
	// 	ReadWriteDatabase: &armkusto.ReadWriteDatabase{
...
// Generated from example definition: 2025-02-14/KustoDatabasesDelete.json
func ExampleDatabasesClient_BeginDelete() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armkusto.DatabasesClientDeleteResponse{
	// }
}

// Generated from example definition: 2025-02-14/KustoDatabasesGet.json
...
// Generated from example definition: 2025-02-14/KustoSuspendedDatabasesGet.json
...
// Generated from example definition: 2025-02-14/KustoDatabasesListByCluster.json
func ExampleDatabasesClient_NewListByClusterPager() {
	...
	for pager.More() {
		...
		// page = armkusto.DatabasesClientListByClusterResponse{
		// 	DatabaseListResult: armkusto.DatabaseListResult{
...
// Generated from example definition: 2025-02-14/KustoDatabaseListPrincipals.json
func ExampleDatabasesClient_NewListPrincipalsPager() {
	...
	for pager.More() {
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armkusto.DatabasesClientListPrincipalsResponse{
		// 	DatabasePrincipalListResult: armkusto.DatabasePrincipalListResult{
		// 		Value: []*armkusto.DatabasePrincipal{
		// 			{
		// 				Name: to.Ptr("Some User"),
...
// Generated from example definition: 2025-02-14/KustoDatabaseRemovePrincipals.json
func ExampleDatabasesClient_RemovePrincipals() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armkusto.DatabasesClientRemovePrincipalsResponse{
	// 	DatabasePrincipalListResult: &armkusto.DatabasePrincipalListResult{
	// 		Value: []*armkusto.DatabasePrincipal{
	// 			{
	// 				Name: to.Ptr("Some User"),
...
// Generated from example definition: 2025-02-14/KustoDatabasesUpdate.json
