...
func (client *DataConnectionsClient) checkNameAvailabilityHandleResponse(resp *http.Response, successCodes ...int) (DataConnectionsClientCheckNameAvailabilityResponse, error) {
...
func (client *DataConnectionsClient) getHandleResponse(resp *http.Response, successCodes ...int) (DataConnectionsClientGetResponse, error) {
...
func (client *DataConnectionsClient) listByDatabaseCreateRequest(ctx context.Context, resourceGroupName string, clusterName string, databaseName string, nextLink string, _ *DataConnectionsClientListByDatabaseOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *DataConnectionsClient) listByDatabaseHandleResponse(resp *http.Response, successCodes ...int) (DataConnectionsClientListByDatabaseResponse, error) {
