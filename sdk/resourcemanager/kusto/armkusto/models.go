...
type CalloutPoliciesList struct {
	// REQUIRED; The CalloutPolicy items on this page
	Value []*CalloutPolicy
...
type CosmosDbDataConnection struct {
	// CONSTANT; Kind of the endpoint for the data connection
	// Field has constant value DataConnectionKindCosmosDb, any specified value is ignored.
...
type EventGridDataConnection struct {
	// CONSTANT; Kind of the endpoint for the data connection
	// Field has constant value DataConnectionKindEventGrid, any specified value is ignored.
	Kind *DataConnectionKind
...
type EventGridDataConnectionWithManagedIdentity struct {
	// CONSTANT; Kind of the endpoint for the data connection
	// Field has constant value DataConnectionKindEventGridWithManagedIdentity, any specified value is ignored.
	Kind *DataConnectionKind
...
type EventHubDataConnection struct {
	// CONSTANT; Kind of the endpoint for the data connection
	// Field has constant value DataConnectionKindEventHub, any specified value is ignored.
	Kind *DataConnectionKind
...
type EventHubDataConnectionWithManagedIdentity struct {
	// CONSTANT; Kind of the endpoint for the data connection
	// Field has constant value DataConnectionKindEventHubWithManagedIdentity, any specified value is ignored.
	Kind *DataConnectionKind
...
type FollowerDatabaseListResultGet struct {
	// REQUIRED; The FollowerDatabaseDefinitionGet items on this page
...
type IotHubDataConnection struct {
	// CONSTANT; Kind of the endpoint for the data connection
	// Field has constant value DataConnectionKindIotHub, any specified value is ignored.
	Kind *DataConnectionKind
...
type KeyVaultProperties struct {
	...
	// scenarios where the encryption key is stored in a different tenant than the cluster. The application must be configured
	// with the user-assigned managed identity as a federated identity credential.
	...
	// 'Unwrap Key' permissions on the Key Vault key, or be assigned the 'Key Vault Crypto Service Encryption User' role.
	UserIdentity *string
}

// LanguageExtension - The language extension object.
type LanguageExtension struct {
	// The sandbox custom image name that should be enabled as the active language extension. Sandbox custom image is a cluster
	// sub resource. When this property is set, LanguageExtensionImageName should be set to 'PythonCustomImage'.
...
// OutboundNetworkDependenciesEndpointListResult - The response of a OutboundNetworkDependenciesEndpoint list operation.
type OutboundNetworkDependenciesEndpointListResult struct {
	// REQUIRED; The OutboundNetworkDependenciesEndpoint items on this page
...
type ReadOnlyFollowingDatabase struct {
	// CONSTANT; Kind of the database
	// Field has constant value KindReadOnlyFollowing, any specified value is ignored.
	Kind *Kind
...
type ReadWriteDatabase struct {
	// CONSTANT; Kind of the database
	// Field has constant value KindReadWrite, any specified value is ignored.
	Kind *Kind
...
type SandboxCustomImagesListResult struct {
	// REQUIRED; The SandboxCustomImage items on this page
