...
func (c CosmosDbDataConnectionProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "provisioningState", c.ProvisioningState)
	populateTime[datetime.RFC3339](objectMap, "retrievalStartDate", c.RetrievalStartDate)
...
func (s SuspensionDetails) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateTime[datetime.RFC3339](objectMap, "suspensionStartDate", s.SuspensionStartDate)
	return json.Marshal(objectMap)
}
