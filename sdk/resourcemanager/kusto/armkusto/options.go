...
// OperationsResultsLocationClientBeginGetOptions contains the optional parameters for the OperationsResultsLocationClient.BeginGet
// method.
type OperationsResultsLocationClientBeginGetOptions struct {
	// Resumes the long-running operation from the provided token.
	ResumeToken string
}
