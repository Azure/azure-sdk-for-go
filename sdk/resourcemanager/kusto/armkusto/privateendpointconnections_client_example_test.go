...
// Generated from example definition: 2025-02-14/KustoPrivateEndpointConnectionsCreateOrUpdate.json
func ExamplePrivateEndpointConnectionsClient_BeginCreateOrUpdate() {
	...
	// res = armkusto.PrivateEndpointConnectionsClientCreateOrUpdateResponse{
	// 	PrivateEndpointConnection: &armkusto.PrivateEndpointConnection{
...
// Generated from example definition: 2025-02-14/KustoPrivateEndpointConnectionsDelete.json
func ExamplePrivateEndpointConnectionsClient_BeginDelete() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armkusto.PrivateEndpointConnectionsClientDeleteResponse{
	// }
}

// Generated from example definition: 2025-02-14/KustoPrivateEndpointConnectionsGet.json
func ExamplePrivateEndpointConnectionsClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armkusto.PrivateEndpointConnectionsClientGetResponse{
	// 	PrivateEndpointConnection: &armkusto.PrivateEndpointConnection{
	// 		Name: to.Ptr("privateEndpointTest"),
	// 		Type: to.Ptr("Microsoft.Kusto/clusters/privateEndpointConnections"),
...
// Generated from example definition: 2025-02-14/KustoPrivateEndpointConnectionsList.json
func ExamplePrivateEndpointConnectionsClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armkusto.PrivateEndpointConnectionsClientListResponse{
		// 	PrivateEndpointConnectionListResult: armkusto.PrivateEndpointConnectionListResult{
