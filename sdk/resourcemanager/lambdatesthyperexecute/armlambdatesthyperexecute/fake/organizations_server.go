...
// OrganizationsServer is a fake server for instances of the armlambdatesthyperexecute.OrganizationsClient type.
type OrganizationsServer struct {
	...
	BeginCreateOrUpdate func(ctx context.Context, resourceGroupName string, organizationname string, resource armlambdatesthyperexecute.OrganizationResource, options *armlambdatesthyperexecute.OrganizationsClientBeginCreateOrUpdateOptions) (resp azfake.PollerResponder[armlambdatesthyperexecute.OrganizationsClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)

	// BeginDelete is the fake for method OrganizationsClient.BeginDelete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginDelete func(ctx context.Context, resourceGroupName string, organizationname string, options *armlambdatesthyperexecute.OrganizationsClientBeginDeleteOptions) (resp azfake.PollerResponder[armlambdatesthyperexecute.OrganizationsClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method OrganizationsClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, organizationname string, options *armlambdatesthyperexecute.OrganizationsClientGetOptions) (resp azfake.Responder[armlambdatesthyperexecute.OrganizationsClientGetResponse], errResp azfake.ErrorResponder)

	// NewListByResourceGroupPager is the fake for method OrganizationsClient.NewListByResourceGroupPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByResourceGroupPager func(resourceGroupName string, options *armlambdatesthyperexecute.OrganizationsClientListByResourceGroupOptions) (resp azfake.PagerResponder[armlambdatesthyperexecute.OrganizationsClientListByResourceGroupResponse])

	// NewListBySubscriptionPager is the fake for method OrganizationsClient.NewListBySubscriptionPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListBySubscriptionPager func(options *armlambdatesthyperexecute.OrganizationsClientListBySubscriptionOptions) (resp azfake.PagerResponder[armlambdatesthyperexecute.OrganizationsClientListBySubscriptionResponse])

	// Update is the fake for method OrganizationsClient.Update
	// HTTP status codes to indicate success: http.StatusOK
	Update func(ctx context.Context, resourceGroupName string, organizationname string, properties armlambdatesthyperexecute.OrganizationResourceUpdate, options *armlambdatesthyperexecute.OrganizationsClientUpdateOptions) (resp azfake.Responder[armlambdatesthyperexecute.OrganizationsClientUpdateResponse], errResp azfake.ErrorResponder)
}

// NewOrganizationsServerTransport creates a new instance of OrganizationsServerTransport with the provided implementation.
// The returned OrganizationsServerTransport instance is connected to an instance of armlambdatesthyperexecute.OrganizationsClient via the
...
func NewOrganizationsServerTransport(srv *OrganizationsServer) *OrganizationsServerTransport {
	return &OrganizationsServerTransport{
		srv:                         srv,
		beginCreateOrUpdate:         newTracker[azfake.PollerResponder[armlambdatesthyperexecute.OrganizationsClientCreateOrUpdateResponse]](),
		beginDelete:                 newTracker[azfake.PollerResponder[armlambdatesthyperexecute.OrganizationsClientDeleteResponse]](),
		newListByResourceGroupPager: newTracker[azfake.PagerResponder[armlambdatesthyperexecute.OrganizationsClientListByResourceGroupResponse]](),
		newListBySubscriptionPager:  newTracker[azfake.PagerResponder[armlambdatesthyperexecute.OrganizationsClientListBySubscriptionResponse]](),
	}
}

// OrganizationsServerTransport connects instances of armlambdatesthyperexecute.OrganizationsClient to instances of OrganizationsServer.
...
type OrganizationsServerTransport struct {
	...
	beginCreateOrUpdate         *tracker[azfake.PollerResponder[armlambdatesthyperexecute.OrganizationsClientCreateOrUpdateResponse]]
	beginDelete                 *tracker[azfake.PollerResponder[armlambdatesthyperexecute.OrganizationsClientDeleteResponse]]
	newListByResourceGroupPager *tracker[azfake.PagerResponder[armlambdatesthyperexecute.OrganizationsClientListByResourceGroupResponse]]
	newListBySubscriptionPager  *tracker[azfake.PagerResponder[armlambdatesthyperexecute.OrganizationsClientListBySubscriptionResponse]]
}
...
func (o *OrganizationsServerTransport) dispatchBeginCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginCreateOrUpdate == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/LambdaTest\.HyperExecute/organizations/(?P<organizationname>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 4 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
		}
		body, err := server.UnmarshalRequestAsJSON[armlambdatesthyperexecute.OrganizationResource](req)
		if err != nil {
			return nil, err
		}
...
func (o *OrganizationsServerTransport) dispatchNewListByResourceGroupPager(req *http.Request) (*http.Response, error) {
	...
	if newListByResourceGroupPager == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/LambdaTest\.HyperExecute/organizations`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 3 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
		...
		server.PagerResponderInjectNextLinks(newListByResourceGroupPager, req, func(page *armlambdatesthyperexecute.OrganizationsClientListByResourceGroupResponse, createLink func() string) {
...
func (o *OrganizationsServerTransport) dispatchNewListBySubscriptionPager(req *http.Request) (*http.Response, error) {
	...
	if newListBySubscriptionPager == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/LambdaTest\.HyperExecute/organizations`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 2 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
		...
		server.PagerResponderInjectNextLinks(newListBySubscriptionPager, req, func(page *armlambdatesthyperexecute.OrganizationsClientListBySubscriptionResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
...
func (o *OrganizationsServerTransport) dispatchUpdate(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[armlambdatesthyperexecute.OrganizationResourceUpdate](req)
	if err != nil {
		return nil, err
	}
	resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
