...
func (testsuite *OperationsTestSuite) SetupSuite() {
	testutil.StartRecording(testsuite.T(), "sdk/resourcemanager/logic/armlogic/testdata")
...
func (testsuite *OperationsTestSuite) TestOperations() {
	...
	operationsClient, err := armlogic.NewOperationsClient(testsuite.cred, testsuite.options)
	testsuite.Require().NoError(err)
