...
func ExampleIntegrationServiceEnvironmentNetworkHealthClient_Get() {
	...
	client := armlogic.NewIntegrationServiceEnvironmentNetworkHealthClient("<subscription-id>", cred, nil)
	...
	log.Printf("Response result: %#v\n", res.IntegrationServiceEnvironmentNetworkHealthClientGetResult)
}
