...
func NewWorkflowRunOperationsClient(con *arm.Connection, subscriptionID string) *WorkflowRunOperationsClient {
	return &WorkflowRunOperationsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
