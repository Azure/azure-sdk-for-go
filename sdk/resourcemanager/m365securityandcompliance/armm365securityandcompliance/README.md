...
```go
client, err := armm365securityandcompliance.NewPrivateEndpointConnectionsForMIPPolicySyncClient(<subscription ID>, cred, nil)
```
...
client, err := armm365securityandcompliance.NewPrivateEndpointConnectionsForMIPPolicySyncClient(<subscription ID>, cred, &options)
```
