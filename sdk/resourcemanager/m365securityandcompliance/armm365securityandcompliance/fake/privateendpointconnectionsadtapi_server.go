...
// NewPrivateEndpointConnectionsAdtAPIServerTransport creates a new instance of PrivateEndpointConnectionsAdtAPIServerTransport with the provided implementation.
// The returned PrivateEndpointConnectionsAdtAPIServerTransport instance is connected to an instance of armm365securityandcompliance.PrivateEndpointConnectionsAdtAPIClient via the
...
func NewPrivateEndpointConnectionsAdtAPIServerTransport(srv *PrivateEndpointConnectionsAdtAPIServer) *PrivateEndpointConnectionsAdtAPIServerTransport {
	return &PrivateEndpointConnectionsAdtAPIServerTransport{
		srv:                   srv,
		beginCreateOrUpdate:   newTracker[azfake.PollerResponder[armm365securityandcompliance.PrivateEndpointConnectionsAdtAPIClientCreateOrUpdateResponse]](),
		beginDelete:           newTracker[azfake.PollerResponder[armm365securityandcompliance.PrivateEndpointConnectionsAdtAPIClientDeleteResponse]](),
		newListByServicePager: newTracker[azfake.PagerResponder[armm365securityandcompliance.PrivateEndpointConnectionsAdtAPIClientListByServiceResponse]](),
	}
}

// PrivateEndpointConnectionsAdtAPIServerTransport connects instances of armm365securityandcompliance.PrivateEndpointConnectionsAdtAPIClient to instances of PrivateEndpointConnectionsAdtAPIServer.
// Don't use this type directly, use NewPrivateEndpointConnectionsAdtAPIServerTransport instead.
type PrivateEndpointConnectionsAdtAPIServerTransport struct {
	srv                   *PrivateEndpointConnectionsAdtAPIServer
	beginCreateOrUpdate   *tracker[azfake.PollerResponder[armm365securityandcompliance.PrivateEndpointConnectionsAdtAPIClientCreateOrUpdateResponse]]
	beginDelete           *tracker[azfake.PollerResponder[armm365securityandcompliance.PrivateEndpointConnectionsAdtAPIClientDeleteResponse]]
	newListByServicePager *tracker[azfake.PagerResponder[armm365securityandcompliance.PrivateEndpointConnectionsAdtAPIClientListByServiceResponse]]
}

// Do implements the policy.Transporter interface for PrivateEndpointConnectionsAdtAPIServerTransport.
func (p *PrivateEndpointConnectionsAdtAPIServerTransport) Do(req *http.Request) (*http.Response, error) {
	...
	switch method {
	case "PrivateEndpointConnectionsAdtAPIClient.BeginCreateOrUpdate":
		resp, err = p.dispatchBeginCreateOrUpdate(req)
	case "PrivateEndpointConnectionsAdtAPIClient.BeginDelete":
		resp, err = p.dispatchBeginDelete(req)
	case "PrivateEndpointConnectionsAdtAPIClient.Get":
		resp, err = p.dispatchGet(req)
	case "PrivateEndpointConnectionsAdtAPIClient.NewListByServicePager":
...
func (p *PrivateEndpointConnectionsAdtAPIServerTransport) dispatchBeginCreateOrUpdate(req *http.Request) (*http.Response, error) {
	if p.srv.BeginCreateOrUpdate == nil {
		return nil, &nonRetriableError{errors.New("fake for method BeginCreateOrUpdate not implemented")}
	}
	beginCreateOrUpdate := p.beginCreateOrUpdate.get(req)
	if beginCreateOrUpdate == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.M365SecurityAndCompliance/privateLinkServicesForO365ManagementActivityAPI/(?P<resourceName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/privateEndpointConnections/(?P<privateEndpointConnectionName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)`
...
func (p *PrivateEndpointConnectionsAdtAPIServerTransport) dispatchBeginDelete(req *http.Request) (*http.Response, error) {
...
func (p *PrivateEndpointConnectionsAdtAPIServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	if p.srv.Get == nil {
...
func (p *PrivateEndpointConnectionsAdtAPIServerTransport) dispatchNewListByServicePager(req *http.Request) (*http.Response, error) {
	...
	if newListByServicePager == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.M365SecurityAndCompliance/privateLinkServicesForO365ManagementActivityAPI/(?P<resourceName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/privateEndpointConnections`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		...
		server.PagerResponderInjectNextLinks(newListByServicePager, req, func(page *armm365securityandcompliance.PrivateEndpointConnectionsAdtAPIClientListByServiceResponse, createLink func() string) {
