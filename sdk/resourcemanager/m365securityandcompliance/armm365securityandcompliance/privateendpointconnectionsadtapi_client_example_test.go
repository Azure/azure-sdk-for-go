...
func ExamplePrivateEndpointConnectionsAdtAPIClient_NewListByServicePager() {
	...
	pager := clientFactory.NewPrivateEndpointConnectionsAdtAPIClient().NewListByServicePager("rgname", "service1", nil)
	for pager.More() {
...
func ExamplePrivateEndpointConnectionsAdtAPIClient_Get() {
	...
	res, err := clientFactory.NewPrivateEndpointConnectionsAdtAPIClient().Get(ctx, "rgname", "service1", "myConnection", nil)
	if err != nil {
...
func ExamplePrivateEndpointConnectionsAdtAPIClient_BeginCreateOrUpdate() {
	...
	poller, err := clientFactory.NewPrivateEndpointConnectionsAdtAPIClient().BeginCreateOrUpdate(ctx, "rgname", "service1", "myConnection", armm365securityandcompliance.PrivateEndpointConnection{
		Properties: &armm365securityandcompliance.PrivateEndpointConnectionProperties{
			PrivateLinkServiceConnectionState: &armm365securityandcompliance.PrivateLinkServiceConnectionState{
				Description: to.Ptr("Auto-Approved"),
				Status:      to.Ptr(armm365securityandcompliance.PrivateEndpointServiceConnectionStatusApproved),
...
func ExamplePrivateEndpointConnectionsAdtAPIClient_BeginDelete() {
	...
	poller, err := clientFactory.NewPrivateEndpointConnectionsAdtAPIClient().BeginDelete(ctx, "rgname", "service1", "myConnection", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
