...
func ExamplePrivateEndpointConnectionsCompClient_NewListByServicePager() {
	...
	pager := clientFactory.NewPrivateEndpointConnectionsCompClient().NewListByServicePager("rgname", "service1", nil)
	for pager.More() {
...
func ExamplePrivateEndpointConnectionsCompClient_Get() {
	...
	res, err := clientFactory.NewPrivateEndpointConnectionsCompClient().Get(ctx, "rgname", "service1", "myConnection", nil)
	if err != nil {
...
func ExamplePrivateEndpointConnectionsCompClient_BeginCreateOrUpdate() {
	...
	poller, err := clientFactory.NewPrivateEndpointConnectionsCompClient().BeginCreateOrUpdate(ctx, "rgname", "service1", "myConnection", armm365securityandcompliance.PrivateEndpointConnection{
		Properties: &armm365securityandcompliance.PrivateEndpointConnectionProperties{
			PrivateLinkServiceConnectionState: &armm365securityandcompliance.PrivateLinkServiceConnectionState{
				Description: to.Ptr("Auto-Approved"),
				Status:      to.Ptr(armm365securityandcompliance.PrivateEndpointServiceConnectionStatusApproved),
...
func ExamplePrivateEndpointConnectionsCompClient_BeginDelete() {
	...
	poller, err := clientFactory.NewPrivateEndpointConnectionsCompClient().BeginDelete(ctx, "rgname", "service1", "myConnection", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
