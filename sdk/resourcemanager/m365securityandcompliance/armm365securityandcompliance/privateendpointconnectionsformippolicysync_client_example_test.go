...
func ExamplePrivateEndpointConnectionsForMIPPolicySyncClient_NewListByServicePager() {
	...
	pager := clientFactory.NewPrivateEndpointConnectionsForMIPPolicySyncClient().NewListByServicePager("rgname", "service1", nil)
	for pager.More() {
...
func ExamplePrivateEndpointConnectionsForMIPPolicySyncClient_Get() {
	...
	res, err := clientFactory.NewPrivateEndpointConnectionsForMIPPolicySyncClient().Get(ctx, "rgname", "service1", "myConnection", nil)
	if err != nil {
...
func ExamplePrivateEndpointConnectionsForMIPPolicySyncClient_BeginCreateOrUpdate() {
	...
	poller, err := clientFactory.NewPrivateEndpointConnectionsForMIPPolicySyncClient().BeginCreateOrUpdate(ctx, "rgname", "service1", "myConnection", armm365securityandcompliance.PrivateEndpointConnection{
		Properties: &armm365securityandcompliance.PrivateEndpointConnectionProperties{
			PrivateLinkServiceConnectionState: &armm365securityandcompliance.PrivateLinkServiceConnectionState{
				Description: to.Ptr("Auto-Approved"),
				Status:      to.Ptr(armm365securityandcompliance.PrivateEndpointServiceConnectionStatusApproved),
...
func ExamplePrivateEndpointConnectionsForMIPPolicySyncClient_BeginDelete() {
	...
	poller, err := clientFactory.NewPrivateEndpointConnectionsForMIPPolicySyncClient().BeginDelete(ctx, "rgname", "service1", "myConnection", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
