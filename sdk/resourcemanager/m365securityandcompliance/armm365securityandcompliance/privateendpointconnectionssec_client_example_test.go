...
func ExamplePrivateEndpointConnectionsSecClient_NewListByServicePager() {
	...
	pager := clientFactory.NewPrivateEndpointConnectionsSecClient().NewListByServicePager("rgname", "service1", nil)
	for pager.More() {
...
func ExamplePrivateEndpointConnectionsSecClient_Get() {
	...
	res, err := clientFactory.NewPrivateEndpointConnectionsSecClient().Get(ctx, "rgname", "service1", "myConnection", nil)
	if err != nil {
...
func ExamplePrivateEndpointConnectionsSecClient_BeginDelete() {
	...
	poller, err := clientFactory.NewPrivateEndpointConnectionsSecClient().BeginDelete(ctx, "rgname", "service1", "myConnection", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
