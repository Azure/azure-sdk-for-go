...
func ExamplePrivateLinkResourcesSecClient_ListByService() {
	...
	res, err := clientFactory.NewPrivateLinkResourcesSecClient().ListByService(ctx, "rgname", "service1", nil)
	if err != nil {
...
func ExamplePrivateLinkResourcesSecClient_Get() {
	...
	res, err := clientFactory.NewPrivateLinkResourcesSecClient().Get(ctx, "rgname", "service1", "fhir", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
