...
func ExamplePrivateLinkServicesForSCCPowershellClient_Get() {
	...
	res, err := clientFactory.NewPrivateLinkServicesForSCCPowershellClient().Get(ctx, "rg1", "service1", nil)
	if err != nil {
	...
	// res.PrivateLinkServicesForSCCPowershellDescription = armm365securityandcompliance.PrivateLinkServicesForSCCPowershellDescription{
...
func ExamplePrivateLinkServicesForSCCPowershellClient_BeginCreateOrUpdate_createOrUpdateAServiceWithAllParameters() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	poller, err := clientFactory.NewPrivateLinkServicesForSCCPowershellClient().BeginCreateOrUpdate(ctx, "rg1", "service1", armm365securityandcompliance.PrivateLinkServicesForSCCPowershellDescription{
...
func ExamplePrivateLinkServicesForSCCPowershellClient_BeginCreateOrUpdate_createOrUpdateAServiceWithMinimumParameters() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	poller, err := clientFactory.NewPrivateLinkServicesForSCCPowershellClient().BeginCreateOrUpdate(ctx, "rg1", "service2", armm365securityandcompliance.PrivateLinkServicesForSCCPowershellDescription{
		Kind:     to.Ptr(armm365securityandcompliance.KindFhirR4),
		Location: to.Ptr("westus2"),
		Tags:     map[string]*string{},
		Properties: &armm365securityandcompliance.ServicesProperties{
...
func ExamplePrivateLinkServicesForSCCPowershellClient_BeginUpdate() {
	...
	poller, err := clientFactory.NewPrivateLinkServicesForSCCPowershellClient().BeginUpdate(ctx, "rg1", "service1", armm365securityandcompliance.ServicesPatchDescription{
		Tags: map[string]*string{
			"tag1": to.Ptr("value1"),
			"tag2": to.Ptr("value2"),
		},
...
func ExamplePrivateLinkServicesForSCCPowershellClient_BeginDelete() {
	...
	poller, err := clientFactory.NewPrivateLinkServicesForSCCPowershellClient().BeginDelete(ctx, "rg1", "service1", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
...
func ExamplePrivateLinkServicesForSCCPowershellClient_NewListPager() {
	...
	pager := clientFactory.NewPrivateLinkServicesForSCCPowershellClient().NewListPager(nil)
	for pager.More() {
