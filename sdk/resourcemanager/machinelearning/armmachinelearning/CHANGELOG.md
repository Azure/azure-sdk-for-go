...
- New function `*InferenceEndpointsClient.BeginUpdate(ctx context.Context, resourceGroupName string, workspaceName string, poolName string, endpointName string, body map[string]any, options *InferenceEndpointsClientBeginUpdateOptions) (*runtime.Poller[InferenceEndpointsClientUpdateResponse], error)`
