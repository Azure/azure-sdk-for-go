...
```go
client, err := armmachinelearning.NewPrivateEndpointConnectionsClient(<subscription ID>, cred, nil)
```
...
client, err := armmachinelearning.NewPrivateEndpointConnectionsClient(<subscription ID>, cred, &options)
```
