...
// Generated from example definition: 2026-07-15-preview/Workspace/BatchEndpoint/createOrUpdate.json
func ExampleBatchEndpointsClient_BeginCreateOrUpdate() {
	...
	// res = armmachinelearning.BatchEndpointsClientCreateOrUpdateResponse{
	// 	BatchEndpoint: armmachinelearning.BatchEndpoint{
	// 		Name: to.Ptr("string"),
	// 		Type: to.Ptr("string"),
	// 		ID: to.Ptr("string"),
	// 		Identity: &armmachinelearning.ManagedServiceIdentity{
...
// Generated from example definition: 2026-07-15-preview/Workspace/BatchEndpoint/delete.json
func ExampleBatchEndpointsClient_BeginDelete() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armmachinelearning.BatchEndpointsClientDeleteResponse{
	// }
}

// Generated from example definition: 2026-07-15-preview/Workspace/BatchEndpoint/get.json
func ExampleBatchEndpointsClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armmachinelearning.BatchEndpointsClientGetResponse{
	// 	BatchEndpoint: armmachinelearning.BatchEndpoint{
	// 		Name: to.Ptr("string"),
	// 		Type: to.Ptr("string"),
	// 		ID: to.Ptr("string"),
...
// Generated from example definition: 2026-07-15-preview/Workspace/BatchEndpoint/list.json
func ExampleBatchEndpointsClient_NewListPager() {
	...
	pager := clientFactory.NewBatchEndpointsClient().NewListPager("test-rg", "my-aml-workspace", &armmachinelearning.BatchEndpointsClientListOptions{
...
// Generated from example definition: 2026-07-15-preview/Workspace/BatchEndpoint/listKeys.json
func ExampleBatchEndpointsClient_ListKeys() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armmachinelearning.BatchEndpointsClientListKeysResponse{
...
// Generated from example definition: 2026-07-15-preview/Workspace/BatchEndpoint/update.json
func ExampleBatchEndpointsClient_BeginUpdate() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armmachinelearning.BatchEndpointsClientUpdateResponse{
	// 	BatchEndpoint: armmachinelearning.BatchEndpoint{
	// 		Name: to.Ptr("string"),
	// 		Type: to.Ptr("string"),
	// 		ID: to.Ptr("string"),
