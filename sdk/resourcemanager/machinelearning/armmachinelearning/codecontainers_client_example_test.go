...
// Generated from example definition: 2026-05-15-preview/Workspace/CodeContainer/createOrUpdate.json
func ExampleCodeContainersClient_CreateOrUpdate() {
	...
	// res = armmachinelearning.CodeContainersClientCreateOrUpdateResponse{
...
// Generated from example definition: 2026-05-15-preview/Workspace/CodeContainer/delete.json
func ExampleCodeContainersClient_Delete() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armmachinelearning.CodeContainersClientDeleteResponse{
	// }
}

// Generated from example definition: 2026-05-15-preview/Workspace/CodeContainer/get.json
func ExampleCodeContainersClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armmachinelearning.CodeContainersClientGetResponse{
	// 	CodeContainer: armmachinelearning.CodeContainer{
	// 		Name: to.Ptr("testContainer"),
	// 		Type: to.Ptr("Microsoft.MachineLearningServices/workspaces/codes"),
	// 		ID: to.Ptr("/subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/testrg123/providers/Microsoft.MachineLearningServices/workspaces/testworkspace/codes/testContainer"),
...
// Generated from example definition: 2026-05-15-preview/Workspace/CodeContainer/list.json
