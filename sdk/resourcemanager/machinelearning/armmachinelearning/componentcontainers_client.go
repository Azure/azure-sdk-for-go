...
func (client *ComponentContainersClient) createOrUpdateHandleResponse(resp *http.Response, successCodes ...int) (ComponentContainersClientCreateOrUpdateResponse, error) {
...
func (client *ComponentContainersClient) Delete(ctx context.Context, resourceGroupName string, workspaceName string, name string, options *ComponentContainersClientDeleteOptions) (ComponentContainersClientDeleteResponse, error) {
	...
	if !runtime.HasStatusCode(httpResp, http.StatusOK, http.StatusNoContent) {
		return ComponentContainersClientDeleteResponse{}, runtime.NewResponseError(httpResp)
	}
...
func (client *ComponentContainersClient) getHandleResponse(resp *http.Response, successCodes ...int) (ComponentContainersClientGetResponse, error) {
...
func (client *ComponentContainersClient) listCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, nextLink string, options *ComponentContainersClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *ComponentContainersClient) listHandleResponse(resp *http.Response, successCodes ...int) (ComponentContainersClientListResponse, error) {
