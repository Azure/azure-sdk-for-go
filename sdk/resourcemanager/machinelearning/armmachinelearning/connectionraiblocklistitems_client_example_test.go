...
// Generated from example definition: https://github.com/Azure/azure-rest-api-specs/blob/b98ebeb5250e9af1846b14884677ac71aeb2be53/specification/machinelearningservices/resource-manager/Microsoft.MachineLearningServices/preview/2025-10-01-preview/examples/WorkspaceConnection/RaiBlocklistItem/list.json
func ExampleConnectionRaiBlocklistItemsClient_NewListPager() {
	...
	pager := clientFactory.NewConnectionRaiBlocklistItemsClient().NewListPager("test-rg", "aml-workspace-name", "testConnection", "raiBlocklistName", &armmachinelearning.ConnectionRaiBlocklistItemsClientListOptions{ProxyAPIVersion: nil})
	for pager.More() {
		...
		// page.RaiBlocklistItemPropertiesBasicResourceArmPaginatedResult = armmachinelearning.RaiBlocklistItemPropertiesBasicResourceArmPaginatedResult{
