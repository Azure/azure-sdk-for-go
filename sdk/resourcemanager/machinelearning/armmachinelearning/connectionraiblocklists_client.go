...
func (client *ConnectionRaiBlocklistsClient) NewListPager(resourceGroupName string, workspaceName string, connectionName string, options *ConnectionRaiBlocklistsClientListOptions) *runtime.Pager[ConnectionRaiBlocklistsClientListResponse] {
	return runtime.NewPager(runtime.PagingHandler[ConnectionRaiBlocklistsClientListResponse]{
		...
		Fetcher: func(ctx context.Context, page *ConnectionRaiBlocklistsClientListResponse) (ConnectionRaiBlocklistsClientListResponse, error) {
			...
			req, err := client.listCreateRequest(ctx, resourceGroupName, workspaceName, connectionName, nextLink, options)
			if err != nil {
...
func (client *ConnectionRaiBlocklistsClient) listCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, connectionName string, nextLink string, options *ConnectionRaiBlocklistsClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *ConnectionRaiBlocklistsClient) listHandleResponse(resp *http.Response, successCodes ...int) (ConnectionRaiBlocklistsClientListResponse, error) {
