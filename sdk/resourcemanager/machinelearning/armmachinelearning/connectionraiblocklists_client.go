...
func (client *ConnectionRaiBlocklistsClient) listCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, connectionName string, _ *ConnectionRaiBlocklistsClientListOptions) (*policy.Request, error) {
