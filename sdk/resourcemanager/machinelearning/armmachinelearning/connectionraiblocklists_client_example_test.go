...
// Generated from example definition: 2026-03-15-preview/WorkspaceConnection/RaiBlocklist/list.json
func ExampleConnectionRaiBlocklistsClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armmachinelearning.ConnectionRaiBlocklistsClientListResponse{
		// 	RaiBlocklistPropertiesBasicResourceArmPaginatedResult: armmachinelearning.RaiBlocklistPropertiesBasicResourceArmPaginatedResult{
