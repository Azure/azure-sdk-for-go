...
func (client *DataContainersClient) createOrUpdateHandleResponse(resp *http.Response, successCodes ...int) (DataContainersClientCreateOrUpdateResponse, error) {
...
func (client *DataContainersClient) Delete(ctx context.Context, resourceGroupName string, workspaceName string, name string, options *DataContainersClientDeleteOptions) (DataContainersClientDeleteResponse, error) {
	...
	if !runtime.HasStatusCode(httpResp, http.StatusOK, http.StatusNoContent) {
		return DataContainersClientDeleteResponse{}, runtime.NewResponseError(httpResp)
	}
...
func (client *DataContainersClient) getHandleResponse(resp *http.Response, successCodes ...int) (DataContainersClientGetResponse, error) {
...
func (client *DataContainersClient) listCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, nextLink string, options *DataContainersClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *DataContainersClient) listHandleResponse(resp *http.Response, successCodes ...int) (DataContainersClientListResponse, error) {
