...
type ConnectionServer struct {
	...
	GetAllModels func(ctx context.Context, resourceGroupName string, workspaceName string, options *armmachinelearning.ConnectionClientGetAllModelsOptions) (resp azfake.Responder[armmachinelearning.ConnectionClientGetAllModelsResponse], errResp azfake.ErrorResponder)
...
func (c *ConnectionServerTransport) dispatchBeginCreateOrUpdateDeployment(req *http.Request) (*http.Response, error) {
	...
	if beginCreateOrUpdateDeployment == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.MachineLearningServices/workspaces/(?P<workspaceName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/connections/(?P<connectionName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/deployments/(?P<deploymentName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)`
		...
		proxyAPIVersionParam := getOptional(qp.Get("proxy-api-version"))
		var options *armmachinelearning.ConnectionClientBeginCreateOrUpdateDeploymentOptions
		if proxyAPIVersionParam != nil {
			options = &armmachinelearning.ConnectionClientBeginCreateOrUpdateDeploymentOptions{
...
func (c *ConnectionServerTransport) dispatchBeginDeleteDeployment(req *http.Request) (*http.Response, error) {
	...
	if beginDeleteDeployment == nil {
		...
		proxyAPIVersionParam := getOptional(qp.Get("proxy-api-version"))
		var options *armmachinelearning.ConnectionClientBeginDeleteDeploymentOptions
		if proxyAPIVersionParam != nil {
			options = &armmachinelearning.ConnectionClientBeginDeleteDeploymentOptions{
				ProxyAPIVersion: proxyAPIVersionParam,
			}
		}
...
func (c *ConnectionServerTransport) dispatchGetAllModels(req *http.Request) (*http.Response, error) {
	...
	const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.MachineLearningServices/workspaces/(?P<workspaceName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/listConnectionModels`
	regex := regexp.MustCompile(regexStr)
	matches := regex.FindStringSubmatch(req.URL.EscapedPath())
	if len(matches) < 4 {
		return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
...
func (c *ConnectionServerTransport) dispatchNewGetModelsPager(req *http.Request) (*http.Response, error) {
	...
	if newGetModelsPager == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.MachineLearningServices/workspaces/(?P<workspaceName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/connections/(?P<connectionName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/models`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 5 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
		...
		proxyAPIVersionParam := getOptional(qp.Get("proxy-api-version"))
		var options *armmachinelearning.ConnectionClientGetModelsOptions
		if proxyAPIVersionParam != nil {
			options = &armmachinelearning.ConnectionClientGetModelsOptions{
				ProxyAPIVersion: proxyAPIVersionParam,
			}
		}
...
func (c *ConnectionServerTransport) dispatchNewListDeploymentsPager(req *http.Request) (*http.Response, error) {
	...
	if newListDeploymentsPager == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.MachineLearningServices/workspaces/(?P<workspaceName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/connections/(?P<connectionName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/deployments`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 5 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
		...
		proxyAPIVersionParam := getOptional(qp.Get("proxy-api-version"))
		var options *armmachinelearning.ConnectionClientListDeploymentsOptions
		if proxyAPIVersionParam != nil {
			options = &armmachinelearning.ConnectionClientListDeploymentsOptions{
				ProxyAPIVersion: proxyAPIVersionParam,
			}
		}
