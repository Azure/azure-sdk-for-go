...
type ConnectionRaiBlocklistItemServer struct {
	...
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginDeleteBulk func(ctx context.Context, resourceGroupName string, workspaceName string, connectionName string, raiBlocklistName string, body []*string, options *armmachinelearning.ConnectionRaiBlocklistItemClientBeginDeleteBulkOptions) (resp azfake.PollerResponder[armmachinelearning.ConnectionRaiBlocklistItemClientDeleteBulkResponse], errResp azfake.ErrorResponder)
