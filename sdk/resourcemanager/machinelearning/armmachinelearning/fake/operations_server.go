...
// The returned OperationsServerTransport instance is connected to an instance of armmachinelearning.OperationsClient via the
...
func (o *OperationsServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armmachinelearning.OperationsClientListResponse, createLink func() string) {
