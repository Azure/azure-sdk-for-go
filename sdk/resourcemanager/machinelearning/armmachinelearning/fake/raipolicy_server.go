...
func (r *RaiPolicyServerTransport) dispatchBeginCreate(req *http.Request) (*http.Response, error) {
	...
	if beginCreate == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.MachineLearningServices/workspaces/(?P<workspaceName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/endpoints/(?P<endpointName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/raiPolicies/(?P<raiPolicyName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)`
		...
		var options *armmachinelearning.RaiPolicyClientBeginCreateOptions
		if proxyAPIVersionParam != nil {
			options = &armmachinelearning.RaiPolicyClientBeginCreateOptions{
...
func (r *RaiPolicyServerTransport) dispatchBeginDelete(req *http.Request) (*http.Response, error) {
	...
	if beginDelete == nil {
		...
		proxyAPIVersionParam := getOptional(qp.Get("proxy-api-version"))
		var options *armmachinelearning.RaiPolicyClientBeginDeleteOptions
		if proxyAPIVersionParam != nil {
			options = &armmachinelearning.RaiPolicyClientBeginDeleteOptions{
				ProxyAPIVersion: proxyAPIVersionParam,
			}
		}
