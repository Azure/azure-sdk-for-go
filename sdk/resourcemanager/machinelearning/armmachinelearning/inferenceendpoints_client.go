...
// InferenceEndpointsClient - InferenceEndpoints is preview-only.
...
func (client *InferenceEndpointsClient) getHandleResponse(resp *http.Response, successCodes ...int) (InferenceEndpointsClientGetResponse, error) {
...
func (client *InferenceEndpointsClient) listCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, poolName string, nextLink string, options *InferenceEndpointsClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *InferenceEndpointsClient) listHandleResponse(resp *http.Response, successCodes ...int) (InferenceEndpointsClientListResponse, error) {
...
//     method.
func (client *InferenceEndpointsClient) BeginUpdate(ctx context.Context, resourceGroupName string, workspaceName string, poolName string, endpointName string, body map[string]any, options *InferenceEndpointsClientBeginUpdateOptions) (*runtime.Poller[InferenceEndpointsClientUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
...
// Update InferenceEndpoint (asynchronous).
// If the operation fails it returns an *azcore.ResponseError type.
func (client *InferenceEndpointsClient) update(ctx context.Context, resourceGroupName string, workspaceName string, poolName string, endpointName string, body map[string]any, options *InferenceEndpointsClientBeginUpdateOptions) (*http.Response, error) {
	var err error
...
func (client *InferenceEndpointsClient) updateCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, poolName string, endpointName string, body map[string]any, _ *InferenceEndpointsClientBeginUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/inferencePools/{poolName}/endpoints/{endpointName}"
	urlPath = strings.ReplaceAll(urlPath, "{subscriptionId}", url.PathEscape(client.subscriptionID))
	if resourceGroupName == "" {
		return nil, errors.New("parameter resourceGroupName cannot be empty")
