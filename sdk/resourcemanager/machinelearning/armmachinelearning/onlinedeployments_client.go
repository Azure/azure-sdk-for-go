...
func (client *OnlineDeploymentsClient) getHandleResponse(resp *http.Response, successCodes ...int) (OnlineDeploymentsClientGetResponse, error) {
...
func (client *OnlineDeploymentsClient) GetLogs(ctx context.Context, resourceGroupName string, workspaceName string, endpointName string, deploymentName string, body DeploymentLogsRequest, options *OnlineDeploymentsClientGetLogsOptions) (OnlineDeploymentsClientGetLogsResponse, error) {
	...
	return client.getLogsHandleResponse(httpResp, http.StatusOK)
}
...
func (client *OnlineDeploymentsClient) getLogsHandleResponse(resp *http.Response, successCodes ...int) (OnlineDeploymentsClientGetLogsResponse, error) {
...
func (client *OnlineDeploymentsClient) NewListPager(resourceGroupName string, workspaceName string, endpointName string, options *OnlineDeploymentsClientListOptions) *runtime.Pager[OnlineDeploymentsClientListResponse] {
	return runtime.NewPager(runtime.PagingHandler[OnlineDeploymentsClientListResponse]{
		...
		Fetcher: func(ctx context.Context, page *OnlineDeploymentsClientListResponse) (OnlineDeploymentsClientListResponse, error) {
			...
			req, err := client.listCreateRequest(ctx, resourceGroupName, workspaceName, endpointName, nextLink, options)
			if err != nil {
...
func (client *OnlineDeploymentsClient) listCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, endpointName string, nextLink string, options *OnlineDeploymentsClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *OnlineDeploymentsClient) listHandleResponse(resp *http.Response, successCodes ...int) (OnlineDeploymentsClientListResponse, error) {
...
func (client *OnlineDeploymentsClient) NewListSKUsPager(resourceGroupName string, workspaceName string, endpointName string, deploymentName string, options *OnlineDeploymentsClientListSKUsOptions) *runtime.Pager[OnlineDeploymentsClientListSKUsResponse] {
	return runtime.NewPager(runtime.PagingHandler[OnlineDeploymentsClientListSKUsResponse]{
		...
		Fetcher: func(ctx context.Context, page *OnlineDeploymentsClientListSKUsResponse) (OnlineDeploymentsClientListSKUsResponse, error) {
			...
			req, err := client.listSKUsCreateRequest(ctx, resourceGroupName, workspaceName, endpointName, deploymentName, nextLink, options)
			if err != nil {
...
func (client *OnlineDeploymentsClient) listSKUsCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, endpointName string, deploymentName string, nextLink string, options *OnlineDeploymentsClientListSKUsOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
	var req *policy.Request
	var err error
	if firstPage {
...
func (client *OnlineDeploymentsClient) listSKUsHandleResponse(resp *http.Response, successCodes ...int) (OnlineDeploymentsClientListSKUsResponse, error) {
