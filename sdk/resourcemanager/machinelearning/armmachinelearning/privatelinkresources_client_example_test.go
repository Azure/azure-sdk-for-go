...
// Generated from example definition: 2026-03-15-preview/PrivateLinkResource/list.json
func ExamplePrivateLinkResourcesClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armmachinelearning.PrivateLinkResourcesClientListResponse{
		// 	PrivateLinkResourceListResult: armmachinelearning.PrivateLinkResourceListResult{
