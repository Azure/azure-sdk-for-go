...
func (client *RaiPoliciesClient) listCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, endpointName string, _ *RaiPoliciesClientListOptions) (*policy.Request, error) {
