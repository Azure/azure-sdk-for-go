...
func (client *RegistryCodeContainersClient) getHandleResponse(resp *http.Response, successCodes ...int) (RegistryCodeContainersClientGetResponse, error) {
...
func (client *RegistryCodeContainersClient) listCreateRequest(ctx context.Context, resourceGroupName string, registryName string, nextLink string, options *RegistryCodeContainersClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *RegistryCodeContainersClient) listHandleResponse(resp *http.Response, successCodes ...int) (RegistryCodeContainersClientListResponse, error) {
