...
func (client *RegistryComponentContainersClient) getHandleResponse(resp *http.Response, successCodes ...int) (RegistryComponentContainersClientGetResponse, error) {
...
func (client *RegistryComponentContainersClient) listCreateRequest(ctx context.Context, resourceGroupName string, registryName string, nextLink string, options *RegistryComponentContainersClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *RegistryComponentContainersClient) listHandleResponse(resp *http.Response, successCodes ...int) (RegistryComponentContainersClientListResponse, error) {
