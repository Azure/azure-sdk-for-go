...
func ExampleRegistryComponentVersionsClient_BeginCreateOrUpdate() {
	...
	// res = armmachinelearning.RegistryComponentVersionsClientCreateOrUpdateResponse{
...
func ExampleRegistryComponentVersionsClient_BeginDelete() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armmachinelearning.RegistryComponentVersionsClientDeleteResponse{
	// }
}
...
func ExampleRegistryComponentVersionsClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armmachinelearning.RegistryComponentVersionsClientGetResponse{
	// 	ComponentVersion: &armmachinelearning.ComponentVersion{
	// 		Name: to.Ptr("string"),
	// 		Type: to.Ptr("string"),
	// 		ID: to.Ptr("string"),
