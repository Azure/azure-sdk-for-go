...
func (client *SchedulesClient) listCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, nextLink string, options *SchedulesClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *SchedulesClient) listHandleResponse(resp *http.Response, successCodes ...int) (SchedulesClientListResponse, error) {
