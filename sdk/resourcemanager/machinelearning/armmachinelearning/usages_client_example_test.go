...
// Generated from example definition: 2025-10-01-preview/Usage/list.json
func ExampleUsagesClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armmachinelearning.UsagesClientListResponse{
		// 	ListUsagesResult: armmachinelearning.ListUsagesResult{
