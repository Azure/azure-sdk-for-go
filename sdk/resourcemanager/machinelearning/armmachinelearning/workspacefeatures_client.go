...
func (client *WorkspaceFeaturesClient) listCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, nextLink string, _ *WorkspaceFeaturesClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *WorkspaceFeaturesClient) listHandleResponse(resp *http.Response, successCodes ...int) (WorkspaceFeaturesClientListResponse, error) {
