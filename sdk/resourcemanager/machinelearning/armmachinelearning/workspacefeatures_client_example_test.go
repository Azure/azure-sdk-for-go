...
// Generated from example definition: 2026-03-15-preview/WorkspaceFeature/list.json
func ExampleWorkspaceFeaturesClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armmachinelearning.WorkspaceFeaturesClientListResponse{
		// 	ListAmlUserFeatureResult: armmachinelearning.ListAmlUserFeatureResult{
