...
func (client *ModelVersionsClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, name string, version string, body ModelVersionData, options *ModelVersionsClientCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *ModelVersionsClient) createOrUpdateHandleResponse(resp *http.Response) (ModelVersionsClientCreateOrUpdateResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.ModelVersionData); err != nil {
		return ModelVersionsClientCreateOrUpdateResponse{}, err
	}
	return result, nil
}
