...
```go
client, err := armmachinelearningexperimentation.NewProjectsClient(<subscription ID>, cred, nil)
```
...
client, err := armmachinelearningexperimentation.NewProjectsClient(<subscription ID>, cred, &options)
```
