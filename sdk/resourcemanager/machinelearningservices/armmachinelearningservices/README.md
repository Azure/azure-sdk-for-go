...
Install the Azure Machine Learning Services module:

```sh
go get github.com/Azure/azure-sdk-for-go/sdk/resourcemanager/machinelearningservices/armmachinelearningservices/v2
```
...
[open an issue](https://github.com/Azure/azure-sdk-for-go/issues) and assign the `Machine Learning Services` label.
