...
// NewWorkspaceSKUsClient creates a new instance of WorkspaceSKUsClient.
func (c *ClientFactory) NewWorkspaceSKUsClient() *WorkspaceSKUsClient {
	subClient, _ := NewWorkspaceSKUsClient(c.subscriptionID, c.credential, c.options)
	return subClient
}
