...
func ExampleComputeClient_BeginCreateOrUpdate_updateAnAksCompute() {
	...
	// res = armmachinelearningservices.ComputeClientCreateOrUpdateResponse{
	// 	ComputeResource: &armmachinelearningservices.ComputeResource{
...
func ExampleComputeClient_BeginCreateOrUpdate_createAnAksCompute() {
	...
	// 		Properties: &armmachinelearningservices.AKS{
	// 			ComputeType: to.Ptr(armmachinelearningservices.ComputeTypeAKS),
	// 			ProvisioningState: to.Ptr(armmachinelearningservices.ProvisioningStateCreating),
	// 		},
	// 	},
	// }
}
...
func ExampleComputeClient_BeginDelete() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armmachinelearningservices.ComputeClientDeleteResponse{
	// }
}
...
func ExampleComputeClient_Get_getAAksCompute() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armmachinelearningservices.ComputeClientGetResponse{
	// 	ComputeResource: &armmachinelearningservices.ComputeResource{
	// 		Name: to.Ptr("compute123"),
	// 		Type: to.Ptr("Microsoft.MachineLearningServices/workspaces/computes"),
	// 		ID: to.Ptr("/subscriptions/34adfa4f-cedf-4dc0-ba29-b6d1a69ab345/resourceGroups/testrg123/providers/Microsoft.MachineLearningServices/workspaces/workspaces123/computes/compute123"),
...
func ExampleComputeClient_GetAllowedResizeSizes() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armmachinelearningservices.ComputeClientGetAllowedResizeSizesResponse{
...
func ExampleComputeClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armmachinelearningservices.ComputeClientListResponse{
		// 	PaginatedComputeResourcesList: armmachinelearningservices.PaginatedComputeResourcesList{
...
func ExampleComputeClient_ListKeys() {
	...
	// 	AksComputeSecrets: &armmachinelearningservices.AksComputeSecrets{
...
func ExampleComputeClient_NewListNodesPager() {
	...
	for pager.More() {
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armmachinelearningservices.ComputeClientListNodesResponse{
		// 	AmlComputeNodesInformation: armmachinelearningservices.AmlComputeNodesInformation{
...
func ExampleComputeClient_BeginUpdate() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armmachinelearningservices.ComputeClientUpdateResponse{
	// 	ComputeResource: &armmachinelearningservices.ComputeResource{
	// 		Name: to.Ptr("compute123"),
	// 		Type: to.Ptr("Microsoft.MachineLearningServices/workspaces/computes"),
	// 		ID: to.Ptr("/subscriptions/34adfa4f-cedf-4dc0-ba29-b6d1a69ab345/resourceGroups/testrg123/providers/Microsoft.MachineLearningServices/workspaces/workspaces123/computes/compute123"),
	...
	// 			Description: to.Ptr("some compute"),
	// 			ComputeType: to.Ptr(armmachinelearningservices.ComputeTypeAmlCompute),
	// 			ProvisioningState: to.Ptr(armmachinelearningservices.ProvisioningStateUpdating),
	// 		},
	// 	},
	// }
}
...
func ExampleComputeClient_UpdateCustomServices() {
	...
	res, err := clientFactory.NewComputeClient().UpdateCustomServices(ctx, "testrg123", "workspaces123", "compute123", []*armmachinelearningservices.CustomService{
		{
			Name:	to.Ptr("rstudio-workbench"),
			Docker: &armmachinelearningservices.Docker{
				Privileged: to.Ptr(true),
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armmachinelearningservices.ComputeClientUpdateCustomServicesResponse{
	// }
}
...
func ExampleComputeClient_UpdateDataMounts() {
	...
	res, err := clientFactory.NewComputeClient().UpdateDataMounts(ctx, "testrg123", "workspaces123", "compute123", []*armmachinelearningservices.ComputeInstanceDataMount{
		{
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armmachinelearningservices.ComputeClientUpdateDataMountsResponse{
	// }
}
...
func ExampleComputeClient_UpdateIdleShutdownSetting() {
	...
	res, err := clientFactory.NewComputeClient().UpdateIdleShutdownSetting(ctx, "testrg123", "workspaces123", "compute123", armmachinelearningservices.IdleShutdownSetting{
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armmachinelearningservices.ComputeClientUpdateIdleShutdownSettingResponse{
	// }
}
