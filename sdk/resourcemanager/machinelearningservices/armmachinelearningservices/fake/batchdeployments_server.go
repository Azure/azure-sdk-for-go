...
// BatchDeploymentsServer is a fake server for instances of the armmachinelearningservices.BatchDeploymentsClient type.
type BatchDeploymentsServer struct {
	...
	Get	func(ctx context.Context, resourceGroupName string, workspaceName string, endpointName string, deploymentName string, options *armmachinelearningservices.BatchDeploymentsClientGetOptions) (resp azfake.Responder[armmachinelearningservices.BatchDeploymentsClientGetResponse], errResp azfake.ErrorResponder)

	// NewListPager is the fake for method BatchDeploymentsClient.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager	func(resourceGroupName string, workspaceName string, endpointName string, options *armmachinelearningservices.BatchDeploymentsClientListOptions) (resp azfake.PagerResponder[armmachinelearningservices.BatchDeploymentsClientListResponse])

	// BeginUpdate is the fake for method BatchDeploymentsClient.BeginUpdate
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginUpdate	func(ctx context.Context, resourceGroupName string, workspaceName string, endpointName string, deploymentName string, body armmachinelearningservices.PartialBatchDeploymentPartialMinimalTrackedResourceWithProperties, options *armmachinelearningservices.BatchDeploymentsClientBeginUpdateOptions) (resp azfake.PollerResponder[armmachinelearningservices.BatchDeploymentsClientUpdateResponse], errResp azfake.ErrorResponder)
}
...
// The returned BatchDeploymentsServerTransport instance is connected to an instance of armmachinelearningservices.BatchDeploymentsClient via the
...
func NewBatchDeploymentsServerTransport(srv *BatchDeploymentsServer) *BatchDeploymentsServerTransport {
	return &BatchDeploymentsServerTransport{
		srv:			srv,
		beginCreateOrUpdate:	newTracker[azfake.PollerResponder[armmachinelearningservices.BatchDeploymentsClientCreateOrUpdateResponse]](),
		beginDelete:		newTracker[azfake.PollerResponder[armmachinelearningservices.BatchDeploymentsClientDeleteResponse]](),
		newListPager:		newTracker[azfake.PagerResponder[armmachinelearningservices.BatchDeploymentsClientListResponse]](),
		beginUpdate:		newTracker[azfake.PollerResponder[armmachinelearningservices.BatchDeploymentsClientUpdateResponse]](),
	}
}

// BatchDeploymentsServerTransport connects instances of armmachinelearningservices.BatchDeploymentsClient to instances of BatchDeploymentsServer.
...
type BatchDeploymentsServerTransport struct {
	...
	beginCreateOrUpdate	*tracker[azfake.PollerResponder[armmachinelearningservices.BatchDeploymentsClientCreateOrUpdateResponse]]
	beginDelete		*tracker[azfake.PollerResponder[armmachinelearningservices.BatchDeploymentsClientDeleteResponse]]
	newListPager		*tracker[azfake.PagerResponder[armmachinelearningservices.BatchDeploymentsClientListResponse]]
	beginUpdate		*tracker[azfake.PollerResponder[armmachinelearningservices.BatchDeploymentsClientUpdateResponse]]
}
...
func (b *BatchDeploymentsServerTransport) dispatchBeginCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginCreateOrUpdate == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armmachinelearningservices.BatchDeployment](req)
		if err != nil {
			return nil, err
		}
...
func (b *BatchDeploymentsServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		var options *armmachinelearningservices.BatchDeploymentsClientListOptions
		if orderByParam != nil || topParam != nil || skipParam != nil {
			options = &armmachinelearningservices.BatchDeploymentsClientListOptions{
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armmachinelearningservices.BatchDeploymentsClientListResponse, createLink func() string) {
...
func (b *BatchDeploymentsServerTransport) dispatchBeginUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginUpdate == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armmachinelearningservices.PartialBatchDeploymentPartialMinimalTrackedResourceWithProperties](req)
		if err != nil {
			return nil, err
		}
		resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
