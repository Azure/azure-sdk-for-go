...
func (c *ConnectionRaiBlocklistItemsServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		var options *armmachinelearningservices.ConnectionRaiBlocklistItemsClientListOptions
		if proxyAPIVersionParam != nil {
			options = &armmachinelearningservices.ConnectionRaiBlocklistItemsClientListOptions{
