...
func (c *ConnectionRaiPolicyServerTransport) dispatchBeginCreate(req *http.Request) (*http.Response, error) {
	...
	if beginCreate == nil {
		...
		var options *armmachinelearningservices.ConnectionRaiPolicyClientBeginCreateOptions
		if proxyAPIVersionParam != nil {
			options = &armmachinelearningservices.ConnectionRaiPolicyClientBeginCreateOptions{
...
func (c *ConnectionRaiPolicyServerTransport) dispatchBeginDelete(req *http.Request) (*http.Response, error) {
	...
	if beginDelete == nil {
		...
		proxyAPIVersionParam := getOptional(proxyAPIVersionUnescaped)
		var options *armmachinelearningservices.ConnectionRaiPolicyClientBeginDeleteOptions
		if proxyAPIVersionParam != nil {
			options = &armmachinelearningservices.ConnectionRaiPolicyClientBeginDeleteOptions{
				ProxyAPIVersion: proxyAPIVersionParam,
			}
		}
