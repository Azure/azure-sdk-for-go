...
// DataVersionsServer is a fake server for instances of the armmachinelearningservices.DataVersionsClient type.
type DataVersionsServer struct {
	// CreateOrUpdate is the fake for method DataVersionsClient.CreateOrUpdate
	// HTTP status codes to indicate success: http.StatusOK, http.StatusCreated
	CreateOrUpdate	func(ctx context.Context, resourceGroupName string, workspaceName string, name string, version string, body armmachinelearningservices.DataVersionBase, options *armmachinelearningservices.DataVersionsClientCreateOrUpdateOptions) (resp azfake.Responder[armmachinelearningservices.DataVersionsClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)

	// Delete is the fake for method DataVersionsClient.Delete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	Delete	func(ctx context.Context, resourceGroupName string, workspaceName string, name string, version string, options *armmachinelearningservices.DataVersionsClientDeleteOptions) (resp azfake.Responder[armmachinelearningservices.DataVersionsClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method DataVersionsClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get	func(ctx context.Context, resourceGroupName string, workspaceName string, name string, version string, options *armmachinelearningservices.DataVersionsClientGetOptions) (resp azfake.Responder[armmachinelearningservices.DataVersionsClientGetResponse], errResp azfake.ErrorResponder)

	// NewListPager is the fake for method DataVersionsClient.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager	func(resourceGroupName string, workspaceName string, name string, options *armmachinelearningservices.DataVersionsClientListOptions) (resp azfake.PagerResponder[armmachinelearningservices.DataVersionsClientListResponse])

	// BeginPublish is the fake for method DataVersionsClient.BeginPublish
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginPublish	func(ctx context.Context, resourceGroupName string, workspaceName string, name string, version string, body armmachinelearningservices.DestinationAsset, options *armmachinelearningservices.DataVersionsClientBeginPublishOptions) (resp azfake.PollerResponder[armmachinelearningservices.DataVersionsClientPublishResponse], errResp azfake.ErrorResponder)
}

// NewDataVersionsServerTransport creates a new instance of DataVersionsServerTransport with the provided implementation.
// The returned DataVersionsServerTransport instance is connected to an instance of armmachinelearningservices.DataVersionsClient via the
...
func NewDataVersionsServerTransport(srv *DataVersionsServer) *DataVersionsServerTransport {
	return &DataVersionsServerTransport{
		srv:		srv,
		newListPager:	newTracker[azfake.PagerResponder[armmachinelearningservices.DataVersionsClientListResponse]](),
		beginPublish:	newTracker[azfake.PollerResponder[armmachinelearningservices.DataVersionsClientPublishResponse]](),
	}
}

// DataVersionsServerTransport connects instances of armmachinelearningservices.DataVersionsClient to instances of DataVersionsServer.
...
type DataVersionsServerTransport struct {
	...
	newListPager	*tracker[azfake.PagerResponder[armmachinelearningservices.DataVersionsClientListResponse]]
	beginPublish	*tracker[azfake.PollerResponder[armmachinelearningservices.DataVersionsClientPublishResponse]]
}
...
func (d *DataVersionsServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		var options *armmachinelearningservices.DataVersionsClientListOptions
		if orderByParam != nil || topParam != nil || skipParam != nil || tagsParam != nil || listViewTypeParam != nil {
			options = &armmachinelearningservices.DataVersionsClientListOptions{
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armmachinelearningservices.DataVersionsClientListResponse, createLink func() string) {
