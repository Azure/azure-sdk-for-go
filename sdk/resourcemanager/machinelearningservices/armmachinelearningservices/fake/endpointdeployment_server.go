...
// EndpointDeploymentServer is a fake server for instances of the armmachinelearningservices.EndpointDeploymentClient type.
type EndpointDeploymentServer struct {
	...
	BeginCreateOrUpdate func(ctx context.Context, resourceGroupName string, workspaceName string, endpointName string, deploymentName string, body armmachinelearningservices.EndpointDeploymentResourcePropertiesBasicResource, options *armmachinelearningservices.EndpointDeploymentClientBeginCreateOrUpdateOptions) (resp azfake.PollerResponder[armmachinelearningservices.EndpointDeploymentClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)

	// BeginDelete is the fake for method EndpointDeploymentClient.BeginDelete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginDelete func(ctx context.Context, resourceGroupName string, workspaceName string, endpointName string, deploymentName string, options *armmachinelearningservices.EndpointDeploymentClientBeginDeleteOptions) (resp azfake.PollerResponder[armmachinelearningservices.EndpointDeploymentClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method EndpointDeploymentClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, workspaceName string, endpointName string, deploymentName string, options *armmachinelearningservices.EndpointDeploymentClientGetOptions) (resp azfake.Responder[armmachinelearningservices.EndpointDeploymentClientGetResponse], errResp azfake.ErrorResponder)

	// NewGetInWorkspacePager is the fake for method EndpointDeploymentClient.NewGetInWorkspacePager
	// HTTP status codes to indicate success: http.StatusOK
	NewGetInWorkspacePager func(resourceGroupName string, workspaceName string, options *armmachinelearningservices.EndpointDeploymentClientGetInWorkspaceOptions) (resp azfake.PagerResponder[armmachinelearningservices.EndpointDeploymentClientGetInWorkspaceResponse])

	// NewListPager is the fake for method EndpointDeploymentClient.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager func(resourceGroupName string, workspaceName string, endpointName string, options *armmachinelearningservices.EndpointDeploymentClientListOptions) (resp azfake.PagerResponder[armmachinelearningservices.EndpointDeploymentClientListResponse])
}
...
// The returned EndpointDeploymentServerTransport instance is connected to an instance of armmachinelearningservices.EndpointDeploymentClient via the
...
func NewEndpointDeploymentServerTransport(srv *EndpointDeploymentServer) *EndpointDeploymentServerTransport {
	return &EndpointDeploymentServerTransport{
		srv:                    srv,
		beginCreateOrUpdate:    newTracker[azfake.PollerResponder[armmachinelearningservices.EndpointDeploymentClientCreateOrUpdateResponse]](),
		beginDelete:            newTracker[azfake.PollerResponder[armmachinelearningservices.EndpointDeploymentClientDeleteResponse]](),
		newGetInWorkspacePager: newTracker[azfake.PagerResponder[armmachinelearningservices.EndpointDeploymentClientGetInWorkspaceResponse]](),
		newListPager:           newTracker[azfake.PagerResponder[armmachinelearningservices.EndpointDeploymentClientListResponse]](),
	}
}

// EndpointDeploymentServerTransport connects instances of armmachinelearningservices.EndpointDeploymentClient to instances of EndpointDeploymentServer.
...
type EndpointDeploymentServerTransport struct {
	...
	beginCreateOrUpdate    *tracker[azfake.PollerResponder[armmachinelearningservices.EndpointDeploymentClientCreateOrUpdateResponse]]
	beginDelete            *tracker[azfake.PollerResponder[armmachinelearningservices.EndpointDeploymentClientDeleteResponse]]
	newGetInWorkspacePager *tracker[azfake.PagerResponder[armmachinelearningservices.EndpointDeploymentClientGetInWorkspaceResponse]]
	newListPager           *tracker[azfake.PagerResponder[armmachinelearningservices.EndpointDeploymentClientListResponse]]
}
...
func (e *EndpointDeploymentServerTransport) dispatchBeginDelete(req *http.Request) (*http.Response, error) {
	...
	if beginDelete == nil {
		...
		var options *armmachinelearningservices.EndpointDeploymentClientBeginDeleteOptions
		if proxyAPIVersionParam != nil {
			options = &armmachinelearningservices.EndpointDeploymentClientBeginDeleteOptions{
...
func (e *EndpointDeploymentServerTransport) dispatchNewGetInWorkspacePager(req *http.Request) (*http.Response, error) {
	...
	if newGetInWorkspacePager == nil {
		...
		var options *armmachinelearningservices.EndpointDeploymentClientGetInWorkspaceOptions
		if endpointTypeParam != nil || skipParam != nil {
			options = &armmachinelearningservices.EndpointDeploymentClientGetInWorkspaceOptions{
		...
		server.PagerResponderInjectNextLinks(newGetInWorkspacePager, req, func(page *armmachinelearningservices.EndpointDeploymentClientGetInWorkspaceResponse, createLink func() string) {
...
func (e *EndpointDeploymentServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armmachinelearningservices.EndpointDeploymentClientListResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
