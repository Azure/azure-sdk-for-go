...
type InferenceEndpointsServer struct {
	...
	BeginUpdate func(ctx context.Context, resourceGroupName string, workspaceName string, poolName string, endpointName string, body any, options *armmachinelearningservices.InferenceEndpointsClientBeginUpdateOptions) (resp azfake.PollerResponder[armmachinelearningservices.InferenceEndpointsClientUpdateResponse], errResp azfake.ErrorResponder)
}
