...
// InferencePoolsServer is a fake server for instances of the armmachinelearningservices.InferencePoolsClient type.
type InferencePoolsServer struct {
	...
	BeginCreateOrUpdate func(ctx context.Context, resourceGroupName string, workspaceName string, inferencePoolName string, body armmachinelearningservices.InferencePool, options *armmachinelearningservices.InferencePoolsClientBeginCreateOrUpdateOptions) (resp azfake.PollerResponder[armmachinelearningservices.InferencePoolsClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)

	// BeginDelete is the fake for method InferencePoolsClient.BeginDelete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginDelete func(ctx context.Context, resourceGroupName string, workspaceName string, inferencePoolName string, options *armmachinelearningservices.InferencePoolsClientBeginDeleteOptions) (resp azfake.PollerResponder[armmachinelearningservices.InferencePoolsClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method InferencePoolsClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, workspaceName string, inferencePoolName string, options *armmachinelearningservices.InferencePoolsClientGetOptions) (resp azfake.Responder[armmachinelearningservices.InferencePoolsClientGetResponse], errResp azfake.ErrorResponder)

	// NewListPager is the fake for method InferencePoolsClient.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager func(resourceGroupName string, workspaceName string, options *armmachinelearningservices.InferencePoolsClientListOptions) (resp azfake.PagerResponder[armmachinelearningservices.InferencePoolsClientListResponse])

	// BeginUpdate is the fake for method InferencePoolsClient.BeginUpdate
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginUpdate func(ctx context.Context, resourceGroupName string, workspaceName string, inferencePoolName string, body armmachinelearningservices.PartialMinimalTrackedResourceWithSKUAndIdentity, options *armmachinelearningservices.InferencePoolsClientBeginUpdateOptions) (resp azfake.PollerResponder[armmachinelearningservices.InferencePoolsClientUpdateResponse], errResp azfake.ErrorResponder)
}
...
// The returned InferencePoolsServerTransport instance is connected to an instance of armmachinelearningservices.InferencePoolsClient via the
...
func NewInferencePoolsServerTransport(srv *InferencePoolsServer) *InferencePoolsServerTransport {
	return &InferencePoolsServerTransport{
		srv:                 srv,
		beginCreateOrUpdate: newTracker[azfake.PollerResponder[armmachinelearningservices.InferencePoolsClientCreateOrUpdateResponse]](),
		beginDelete:         newTracker[azfake.PollerResponder[armmachinelearningservices.InferencePoolsClientDeleteResponse]](),
		newListPager:        newTracker[azfake.PagerResponder[armmachinelearningservices.InferencePoolsClientListResponse]](),
		beginUpdate:         newTracker[azfake.PollerResponder[armmachinelearningservices.InferencePoolsClientUpdateResponse]](),
	}
}

// InferencePoolsServerTransport connects instances of armmachinelearningservices.InferencePoolsClient to instances of InferencePoolsServer.
...
type InferencePoolsServerTransport struct {
	...
	beginCreateOrUpdate *tracker[azfake.PollerResponder[armmachinelearningservices.InferencePoolsClientCreateOrUpdateResponse]]
	beginDelete         *tracker[azfake.PollerResponder[armmachinelearningservices.InferencePoolsClientDeleteResponse]]
	newListPager        *tracker[azfake.PagerResponder[armmachinelearningservices.InferencePoolsClientListResponse]]
	beginUpdate         *tracker[azfake.PollerResponder[armmachinelearningservices.InferencePoolsClientUpdateResponse]]
}
...
func (i *InferencePoolsServerTransport) dispatchBeginCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginCreateOrUpdate == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armmachinelearningservices.InferencePool](req)
		if err != nil {
			return nil, err
		}
...
func (i *InferencePoolsServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		var options *armmachinelearningservices.InferencePoolsClientListOptions
		if countParam != nil || skipParam != nil || tagsParam != nil || propertiesParam != nil || orderByParam != nil {
			options = &armmachinelearningservices.InferencePoolsClientListOptions{
				Count:      countParam,
				Skip:       skipParam,
				Tags:       tagsParam,
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armmachinelearningservices.InferencePoolsClientListResponse, createLink func() string) {
