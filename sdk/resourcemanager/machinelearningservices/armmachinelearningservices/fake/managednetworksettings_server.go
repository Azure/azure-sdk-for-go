...
// ManagedNetworkSettingsServer is a fake server for instances of the armmachinelearningservices.ManagedNetworkSettingsClient type.
type ManagedNetworkSettingsServer struct {
	// Get is the fake for method ManagedNetworkSettingsClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, workspaceName string, managedNetworkName string, options *armmachinelearningservices.ManagedNetworkSettingsClientGetOptions) (resp azfake.Responder[armmachinelearningservices.ManagedNetworkSettingsClientGetResponse], errResp azfake.ErrorResponder)

	// NewListPager is the fake for method ManagedNetworkSettingsClient.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager func(resourceGroupName string, workspaceName string, options *armmachinelearningservices.ManagedNetworkSettingsClientListOptions) (resp azfake.PagerResponder[armmachinelearningservices.ManagedNetworkSettingsClientListResponse])

	// BeginPatch is the fake for method ManagedNetworkSettingsClient.BeginPatch
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginPatch func(ctx context.Context, resourceGroupName string, workspaceName string, managedNetworkName string, options *armmachinelearningservices.ManagedNetworkSettingsClientBeginPatchOptions) (resp azfake.PollerResponder[armmachinelearningservices.ManagedNetworkSettingsClientPatchResponse], errResp azfake.ErrorResponder)

	// BeginPut is the fake for method ManagedNetworkSettingsClient.BeginPut
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginPut func(ctx context.Context, resourceGroupName string, workspaceName string, managedNetworkName string, body armmachinelearningservices.ManagedNetworkSettingsPropertiesBasicResource, options *armmachinelearningservices.ManagedNetworkSettingsClientBeginPutOptions) (resp azfake.PollerResponder[armmachinelearningservices.ManagedNetworkSettingsClientPutResponse], errResp azfake.ErrorResponder)
}
...
// The returned ManagedNetworkSettingsServerTransport instance is connected to an instance of armmachinelearningservices.ManagedNetworkSettingsClient via the
...
func NewManagedNetworkSettingsServerTransport(srv *ManagedNetworkSettingsServer) *ManagedNetworkSettingsServerTransport {
	return &ManagedNetworkSettingsServerTransport{
		srv:          srv,
		newListPager: newTracker[azfake.PagerResponder[armmachinelearningservices.ManagedNetworkSettingsClientListResponse]](),
		beginPatch:   newTracker[azfake.PollerResponder[armmachinelearningservices.ManagedNetworkSettingsClientPatchResponse]](),
		beginPut:     newTracker[azfake.PollerResponder[armmachinelearningservices.ManagedNetworkSettingsClientPutResponse]](),
	}
}

// ManagedNetworkSettingsServerTransport connects instances of armmachinelearningservices.ManagedNetworkSettingsClient to instances of ManagedNetworkSettingsServer.
...
type ManagedNetworkSettingsServerTransport struct {
	...
	newListPager *tracker[azfake.PagerResponder[armmachinelearningservices.ManagedNetworkSettingsClientListResponse]]
	beginPatch   *tracker[azfake.PollerResponder[armmachinelearningservices.ManagedNetworkSettingsClientPatchResponse]]
	beginPut     *tracker[azfake.PollerResponder[armmachinelearningservices.ManagedNetworkSettingsClientPutResponse]]
}
...
func (m *ManagedNetworkSettingsServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armmachinelearningservices.ManagedNetworkSettingsClientListResponse, createLink func() string) {
...
func (m *ManagedNetworkSettingsServerTransport) dispatchBeginPatch(req *http.Request) (*http.Response, error) {
	...
	if beginPatch == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armmachinelearningservices.ManagedNetworkSettingsPropertiesBasicResource](req)
		if err != nil {
			return nil, err
		}
		resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
		...
		var options *armmachinelearningservices.ManagedNetworkSettingsClientBeginPatchOptions
		if !reflect.ValueOf(body).IsZero() {
			options = &armmachinelearningservices.ManagedNetworkSettingsClientBeginPatchOptions{
				Body: &body,
			}
		}
