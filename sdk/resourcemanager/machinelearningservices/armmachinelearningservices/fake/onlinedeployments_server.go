...
// OnlineDeploymentsServer is a fake server for instances of the armmachinelearningservices.OnlineDeploymentsClient type.
type OnlineDeploymentsServer struct {
	...
	Get func(ctx context.Context, resourceGroupName string, workspaceName string, endpointName string, deploymentName string, options *armmachinelearningservices.OnlineDeploymentsClientGetOptions) (resp azfake.Responder[armmachinelearningservices.OnlineDeploymentsClientGetResponse], errResp azfake.ErrorResponder)
	...
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager func(resourceGroupName string, workspaceName string, endpointName string, options *armmachinelearningservices.OnlineDeploymentsClientListOptions) (resp azfake.PagerResponder[armmachinelearningservices.OnlineDeploymentsClientListResponse])

	// NewListSKUsPager is the fake for method OnlineDeploymentsClient.NewListSKUsPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListSKUsPager func(resourceGroupName string, workspaceName string, endpointName string, deploymentName string, options *armmachinelearningservices.OnlineDeploymentsClientListSKUsOptions) (resp azfake.PagerResponder[armmachinelearningservices.OnlineDeploymentsClientListSKUsResponse])

	// BeginUpdate is the fake for method OnlineDeploymentsClient.BeginUpdate
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginUpdate func(ctx context.Context, resourceGroupName string, workspaceName string, endpointName string, deploymentName string, body armmachinelearningservices.PartialMinimalTrackedResourceWithSKU, options *armmachinelearningservices.OnlineDeploymentsClientBeginUpdateOptions) (resp azfake.PollerResponder[armmachinelearningservices.OnlineDeploymentsClientUpdateResponse], errResp azfake.ErrorResponder)
}
...
// The returned OnlineDeploymentsServerTransport instance is connected to an instance of armmachinelearningservices.OnlineDeploymentsClient via the
...
func NewOnlineDeploymentsServerTransport(srv *OnlineDeploymentsServer) *OnlineDeploymentsServerTransport {
	return &OnlineDeploymentsServerTransport{
		srv:                 srv,
		beginCreateOrUpdate: newTracker[azfake.PollerResponder[armmachinelearningservices.OnlineDeploymentsClientCreateOrUpdateResponse]](),
		beginDelete:         newTracker[azfake.PollerResponder[armmachinelearningservices.OnlineDeploymentsClientDeleteResponse]](),
		newListPager:        newTracker[azfake.PagerResponder[armmachinelearningservices.OnlineDeploymentsClientListResponse]](),
		newListSKUsPager:    newTracker[azfake.PagerResponder[armmachinelearningservices.OnlineDeploymentsClientListSKUsResponse]](),
		beginUpdate:         newTracker[azfake.PollerResponder[armmachinelearningservices.OnlineDeploymentsClientUpdateResponse]](),
	}
}

// OnlineDeploymentsServerTransport connects instances of armmachinelearningservices.OnlineDeploymentsClient to instances of OnlineDeploymentsServer.
...
type OnlineDeploymentsServerTransport struct {
	...
	beginCreateOrUpdate *tracker[azfake.PollerResponder[armmachinelearningservices.OnlineDeploymentsClientCreateOrUpdateResponse]]
	beginDelete         *tracker[azfake.PollerResponder[armmachinelearningservices.OnlineDeploymentsClientDeleteResponse]]
	newListPager        *tracker[azfake.PagerResponder[armmachinelearningservices.OnlineDeploymentsClientListResponse]]
	newListSKUsPager    *tracker[azfake.PagerResponder[armmachinelearningservices.OnlineDeploymentsClientListSKUsResponse]]
	beginUpdate         *tracker[azfake.PollerResponder[armmachinelearningservices.OnlineDeploymentsClientUpdateResponse]]
}
...
func (o *OnlineDeploymentsServerTransport) dispatchBeginCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginCreateOrUpdate == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armmachinelearningservices.OnlineDeployment](req)
		if err != nil {
			return nil, err
		}
...
func (o *OnlineDeploymentsServerTransport) dispatchGetLogs(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[armmachinelearningservices.DeploymentLogsRequest](req)
	if err != nil {
		return nil, err
	}
	resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
...
func (o *OnlineDeploymentsServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		var options *armmachinelearningservices.OnlineDeploymentsClientListOptions
		if orderByParam != nil || topParam != nil || skipParam != nil {
			options = &armmachinelearningservices.OnlineDeploymentsClientListOptions{
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armmachinelearningservices.OnlineDeploymentsClientListResponse, createLink func() string) {
...
func (o *OnlineDeploymentsServerTransport) dispatchNewListSKUsPager(req *http.Request) (*http.Response, error) {
	...
	if newListSKUsPager == nil {
		...
		skipParam := getOptional(skipUnescaped)
		var options *armmachinelearningservices.OnlineDeploymentsClientListSKUsOptions
		if countParam != nil || skipParam != nil {
			options = &armmachinelearningservices.OnlineDeploymentsClientListSKUsOptions{
				Count: countParam,
				Skip:  skipParam,
			}
		}
		...
		server.PagerResponderInjectNextLinks(newListSKUsPager, req, func(page *armmachinelearningservices.OnlineDeploymentsClientListSKUsResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
