...
// OnlineEndpointsServer is a fake server for instances of the armmachinelearningservices.OnlineEndpointsClient type.
type OnlineEndpointsServer struct {
	...
	BeginCreateOrUpdate	func(ctx context.Context, resourceGroupName string, workspaceName string, endpointName string, body armmachinelearningservices.OnlineEndpoint, options *armmachinelearningservices.OnlineEndpointsClientBeginCreateOrUpdateOptions) (resp azfake.PollerResponder[armmachinelearningservices.OnlineEndpointsClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)

	// BeginDelete is the fake for method OnlineEndpointsClient.BeginDelete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginDelete	func(ctx context.Context, resourceGroupName string, workspaceName string, endpointName string, options *armmachinelearningservices.OnlineEndpointsClientBeginDeleteOptions) (resp azfake.PollerResponder[armmachinelearningservices.OnlineEndpointsClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method OnlineEndpointsClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get	func(ctx context.Context, resourceGroupName string, workspaceName string, endpointName string, options *armmachinelearningservices.OnlineEndpointsClientGetOptions) (resp azfake.Responder[armmachinelearningservices.OnlineEndpointsClientGetResponse], errResp azfake.ErrorResponder)

	// GetToken is the fake for method OnlineEndpointsClient.GetToken
	// HTTP status codes to indicate success: http.StatusOK
	GetToken	func(ctx context.Context, resourceGroupName string, workspaceName string, endpointName string, options *armmachinelearningservices.OnlineEndpointsClientGetTokenOptions) (resp azfake.Responder[armmachinelearningservices.OnlineEndpointsClientGetTokenResponse], errResp azfake.ErrorResponder)

	// NewListPager is the fake for method OnlineEndpointsClient.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager	func(resourceGroupName string, workspaceName string, options *armmachinelearningservices.OnlineEndpointsClientListOptions) (resp azfake.PagerResponder[armmachinelearningservices.OnlineEndpointsClientListResponse])

	// ListKeys is the fake for method OnlineEndpointsClient.ListKeys
	// HTTP status codes to indicate success: http.StatusOK
	ListKeys	func(ctx context.Context, resourceGroupName string, workspaceName string, endpointName string, options *armmachinelearningservices.OnlineEndpointsClientListKeysOptions) (resp azfake.Responder[armmachinelearningservices.OnlineEndpointsClientListKeysResponse], errResp azfake.ErrorResponder)

	// BeginRegenerateKeys is the fake for method OnlineEndpointsClient.BeginRegenerateKeys
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginRegenerateKeys	func(ctx context.Context, resourceGroupName string, workspaceName string, endpointName string, body armmachinelearningservices.RegenerateEndpointKeysRequest, options *armmachinelearningservices.OnlineEndpointsClientBeginRegenerateKeysOptions) (resp azfake.PollerResponder[armmachinelearningservices.OnlineEndpointsClientRegenerateKeysResponse], errResp azfake.ErrorResponder)

	// BeginUpdate is the fake for method OnlineEndpointsClient.BeginUpdate
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginUpdate	func(ctx context.Context, resourceGroupName string, workspaceName string, endpointName string, body armmachinelearningservices.PartialMinimalTrackedResourceWithIdentity, options *armmachinelearningservices.OnlineEndpointsClientBeginUpdateOptions) (resp azfake.PollerResponder[armmachinelearningservices.OnlineEndpointsClientUpdateResponse], errResp azfake.ErrorResponder)
}
...
// The returned OnlineEndpointsServerTransport instance is connected to an instance of armmachinelearningservices.OnlineEndpointsClient via the
...
func NewOnlineEndpointsServerTransport(srv *OnlineEndpointsServer) *OnlineEndpointsServerTransport {
	return &OnlineEndpointsServerTransport{
		srv:			srv,
		beginCreateOrUpdate:	newTracker[azfake.PollerResponder[armmachinelearningservices.OnlineEndpointsClientCreateOrUpdateResponse]](),
		beginDelete:		newTracker[azfake.PollerResponder[armmachinelearningservices.OnlineEndpointsClientDeleteResponse]](),
		newListPager:		newTracker[azfake.PagerResponder[armmachinelearningservices.OnlineEndpointsClientListResponse]](),
		beginRegenerateKeys:	newTracker[azfake.PollerResponder[armmachinelearningservices.OnlineEndpointsClientRegenerateKeysResponse]](),
		beginUpdate:		newTracker[azfake.PollerResponder[armmachinelearningservices.OnlineEndpointsClientUpdateResponse]](),
	}
}

// OnlineEndpointsServerTransport connects instances of armmachinelearningservices.OnlineEndpointsClient to instances of OnlineEndpointsServer.
...
type OnlineEndpointsServerTransport struct {
	...
	beginCreateOrUpdate	*tracker[azfake.PollerResponder[armmachinelearningservices.OnlineEndpointsClientCreateOrUpdateResponse]]
	beginDelete		*tracker[azfake.PollerResponder[armmachinelearningservices.OnlineEndpointsClientDeleteResponse]]
	newListPager		*tracker[azfake.PagerResponder[armmachinelearningservices.OnlineEndpointsClientListResponse]]
	beginRegenerateKeys	*tracker[azfake.PollerResponder[armmachinelearningservices.OnlineEndpointsClientRegenerateKeysResponse]]
	beginUpdate		*tracker[azfake.PollerResponder[armmachinelearningservices.OnlineEndpointsClientUpdateResponse]]
}
...
func (o *OnlineEndpointsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if onlineEndpointsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = onlineEndpointsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
func (o *OnlineEndpointsServerTransport) dispatchBeginCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginCreateOrUpdate == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armmachinelearningservices.OnlineEndpoint](req)
		if err != nil {
			return nil, err
		}
...
func (o *OnlineEndpointsServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		computeTypeParam := getOptional(armmachinelearningservices.EndpointComputeType(computeTypeUnescaped))
		...
		var options *armmachinelearningservices.OnlineEndpointsClientListOptions
		if nameParam != nil || countParam != nil || computeTypeParam != nil || skipParam != nil || tagsParam != nil || propertiesParam != nil || orderByParam != nil {
			options = &armmachinelearningservices.OnlineEndpointsClientListOptions{
				Name:		nameParam,
				Count:		countParam,
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armmachinelearningservices.OnlineEndpointsClientListResponse, createLink func() string) {
...
// set this to conditionally intercept incoming requests to OnlineEndpointsServerTransport
var onlineEndpointsServerTransportInterceptor interface {
