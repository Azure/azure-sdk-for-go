...
// PTUQuotaServer is a fake server for instances of the armmachinelearningservices.PTUQuotaClient type.
type PTUQuotaServer struct {
	// GetAvailable is the fake for method PTUQuotaClient.GetAvailable
	// HTTP status codes to indicate success: http.StatusOK
	GetAvailable func(ctx context.Context, location string, options *armmachinelearningservices.PTUQuotaClientGetAvailableOptions) (resp azfake.Responder[armmachinelearningservices.PTUQuotaClientGetAvailableResponse], errResp azfake.ErrorResponder)

	// NewListPager is the fake for method PTUQuotaClient.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager func(location string, options *armmachinelearningservices.PTUQuotaClientListOptions) (resp azfake.PagerResponder[armmachinelearningservices.PTUQuotaClientListResponse])

	// NewListAvailablePager is the fake for method PTUQuotaClient.NewListAvailablePager
	// HTTP status codes to indicate success: http.StatusOK
	NewListAvailablePager func(location string, options *armmachinelearningservices.PTUQuotaClientListAvailableOptions) (resp azfake.PagerResponder[armmachinelearningservices.PTUQuotaClientListAvailableResponse])
}

// NewPTUQuotaServerTransport creates a new instance of PTUQuotaServerTransport with the provided implementation.
// The returned PTUQuotaServerTransport instance is connected to an instance of armmachinelearningservices.PTUQuotaClient via the
// azcore.ClientOptions.Transporter field in the client's constructor parameters.
func NewPTUQuotaServerTransport(srv *PTUQuotaServer) *PTUQuotaServerTransport {
	return &PTUQuotaServerTransport{
		srv:                   srv,
		newListPager:          newTracker[azfake.PagerResponder[armmachinelearningservices.PTUQuotaClientListResponse]](),
		newListAvailablePager: newTracker[azfake.PagerResponder[armmachinelearningservices.PTUQuotaClientListAvailableResponse]](),
	}
}

// PTUQuotaServerTransport connects instances of armmachinelearningservices.PTUQuotaClient to instances of PTUQuotaServer.
// Don't use this type directly, use NewPTUQuotaServerTransport instead.
type PTUQuotaServerTransport struct {
	srv                   *PTUQuotaServer
	newListPager          *tracker[azfake.PagerResponder[armmachinelearningservices.PTUQuotaClientListResponse]]
	newListAvailablePager *tracker[azfake.PagerResponder[armmachinelearningservices.PTUQuotaClientListAvailableResponse]]
}
...
func (p *PTUQuotaServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		var options *armmachinelearningservices.PTUQuotaClientListOptions
		if skipParam != nil {
			options = &armmachinelearningservices.PTUQuotaClientListOptions{
				Skip: skipParam,
			}
		}
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armmachinelearningservices.PTUQuotaClientListResponse, createLink func() string) {
...
func (p *PTUQuotaServerTransport) dispatchNewListAvailablePager(req *http.Request) (*http.Response, error) {
	...
	if newListAvailablePager == nil {
		...
		skipParam := getOptional(skipUnescaped)
		var options *armmachinelearningservices.PTUQuotaClientListAvailableOptions
		if skipParam != nil {
			options = &armmachinelearningservices.PTUQuotaClientListAvailableOptions{
				Skip: skipParam,
			}
		}
		...
		server.PagerResponderInjectNextLinks(newListAvailablePager, req, func(page *armmachinelearningservices.PTUQuotaClientListAvailableResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
