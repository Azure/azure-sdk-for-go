...
// RegistryDataReferencesServer is a fake server for instances of the armmachinelearningservices.RegistryDataReferencesClient type.
type RegistryDataReferencesServer struct {
	...
	GetBlobReferenceSAS func(ctx context.Context, resourceGroupName string, registryName string, name string, version string, body armmachinelearningservices.GetBlobReferenceSASRequestDto, options *armmachinelearningservices.RegistryDataReferencesClientGetBlobReferenceSASOptions) (resp azfake.Responder[armmachinelearningservices.RegistryDataReferencesClientGetBlobReferenceSASResponse], errResp azfake.ErrorResponder)
}
...
// The returned RegistryDataReferencesServerTransport instance is connected to an instance of armmachinelearningservices.RegistryDataReferencesClient via the
...
// RegistryDataReferencesServerTransport connects instances of armmachinelearningservices.RegistryDataReferencesClient to instances of RegistryDataReferencesServer.
...
func (r *RegistryDataReferencesServerTransport) dispatchGetBlobReferenceSAS(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[armmachinelearningservices.GetBlobReferenceSASRequestDto](req)
	if err != nil {
		return nil, err
	}
