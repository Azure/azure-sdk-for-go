...
// RegistryEnvironmentContainersServer is a fake server for instances of the armmachinelearningservices.RegistryEnvironmentContainersClient type.
type RegistryEnvironmentContainersServer struct {
	...
	BeginCreateOrUpdate	func(ctx context.Context, resourceGroupName string, registryName string, environmentName string, body armmachinelearningservices.EnvironmentContainer, options *armmachinelearningservices.RegistryEnvironmentContainersClientBeginCreateOrUpdateOptions) (resp azfake.PollerResponder[armmachinelearningservices.RegistryEnvironmentContainersClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)

	// BeginDelete is the fake for method RegistryEnvironmentContainersClient.BeginDelete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginDelete	func(ctx context.Context, resourceGroupName string, registryName string, environmentName string, options *armmachinelearningservices.RegistryEnvironmentContainersClientBeginDeleteOptions) (resp azfake.PollerResponder[armmachinelearningservices.RegistryEnvironmentContainersClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method RegistryEnvironmentContainersClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get	func(ctx context.Context, resourceGroupName string, registryName string, environmentName string, options *armmachinelearningservices.RegistryEnvironmentContainersClientGetOptions) (resp azfake.Responder[armmachinelearningservices.RegistryEnvironmentContainersClientGetResponse], errResp azfake.ErrorResponder)

	// NewListPager is the fake for method RegistryEnvironmentContainersClient.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager	func(resourceGroupName string, registryName string, options *armmachinelearningservices.RegistryEnvironmentContainersClientListOptions) (resp azfake.PagerResponder[armmachinelearningservices.RegistryEnvironmentContainersClientListResponse])
}
...
// The returned RegistryEnvironmentContainersServerTransport instance is connected to an instance of armmachinelearningservices.RegistryEnvironmentContainersClient via the
...
func NewRegistryEnvironmentContainersServerTransport(srv *RegistryEnvironmentContainersServer) *RegistryEnvironmentContainersServerTransport {
	return &RegistryEnvironmentContainersServerTransport{
		srv:			srv,
		beginCreateOrUpdate:	newTracker[azfake.PollerResponder[armmachinelearningservices.RegistryEnvironmentContainersClientCreateOrUpdateResponse]](),
		beginDelete:		newTracker[azfake.PollerResponder[armmachinelearningservices.RegistryEnvironmentContainersClientDeleteResponse]](),
		newListPager:		newTracker[azfake.PagerResponder[armmachinelearningservices.RegistryEnvironmentContainersClientListResponse]](),
	}
}

// RegistryEnvironmentContainersServerTransport connects instances of armmachinelearningservices.RegistryEnvironmentContainersClient to instances of RegistryEnvironmentContainersServer.
...
type RegistryEnvironmentContainersServerTransport struct {
	...
	beginCreateOrUpdate	*tracker[azfake.PollerResponder[armmachinelearningservices.RegistryEnvironmentContainersClientCreateOrUpdateResponse]]
	beginDelete		*tracker[azfake.PollerResponder[armmachinelearningservices.RegistryEnvironmentContainersClientDeleteResponse]]
	newListPager		*tracker[azfake.PagerResponder[armmachinelearningservices.RegistryEnvironmentContainersClientListResponse]]
}
...
func (r *RegistryEnvironmentContainersServerTransport) dispatchBeginCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginCreateOrUpdate == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armmachinelearningservices.EnvironmentContainer](req)
		if err != nil {
			return nil, err
		}
...
func (r *RegistryEnvironmentContainersServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		var options *armmachinelearningservices.RegistryEnvironmentContainersClientListOptions
		if skipParam != nil || listViewTypeParam != nil {
			options = &armmachinelearningservices.RegistryEnvironmentContainersClientListOptions{
				Skip:		skipParam,
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armmachinelearningservices.RegistryEnvironmentContainersClientListResponse, createLink func() string) {
