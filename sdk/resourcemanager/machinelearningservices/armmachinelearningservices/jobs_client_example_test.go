...
func ExampleJobsClient_BeginCancel() {
	...
	// res = armmachinelearningservices.JobsClientCancelResponse{
	// }
}
...
func ExampleJobsClient_CreateOrUpdate_createOrUpdateAutoMlJob() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armmachinelearningservices.JobsClientCreateOrUpdateResponse{
	// 	JobBase: &armmachinelearningservices.JobBase{
	// 		Name: to.Ptr("string"),
	// 		Type: to.Ptr("string"),
	// 		ID: to.Ptr("string"),
	// 		Properties: &armmachinelearningservices.AutoMLJob{
...
func ExampleJobsClient_BeginDelete() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armmachinelearningservices.JobsClientDeleteResponse{
	// }
}
...
func ExampleJobsClient_Get_getAutoMlJob() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armmachinelearningservices.JobsClientGetResponse{
	// 	JobBase: &armmachinelearningservices.JobBase{
	// 		Name: to.Ptr("string"),
	// 		Type: to.Ptr("string"),
	// 		ID: to.Ptr("string"),
...
func ExampleJobsClient_NewListPager_listAutoMlJob() {
	...
	for pager.More() {
		...
		// page = armmachinelearningservices.JobsClientListResponse{
		// 	JobBaseResourceArmPaginatedResult: armmachinelearningservices.JobBaseResourceArmPaginatedResult{
...
func ExampleJobsClient_NewListPager_listCommandJob() {
	...
	pager := clientFactory.NewJobsClient().NewListPager("test-rg", "my-aml-workspace", &armmachinelearningservices.JobsClientListOptions{
