...
// Generated from example definition: 2025-10-01-preview/PrivateLinkResource/list.json
func ExamplePrivateLinkResourcesClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armmachinelearningservices.PrivateLinkResourcesClientListResponse{
		// 	PrivateLinkResourceListResult: armmachinelearningservices.PrivateLinkResourceListResult{
