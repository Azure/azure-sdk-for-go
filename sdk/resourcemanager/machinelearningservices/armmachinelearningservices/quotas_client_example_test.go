...
func ExampleQuotasClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armmachinelearningservices.QuotasClientListResponse{
		// 	ListWorkspaceQuotas: armmachinelearningservices.ListWorkspaceQuotas{
...
func ExampleQuotasClient_Update() {
	...
	// res = armmachinelearningservices.QuotasClientUpdateResponse{
	// 	UpdateWorkspaceQuotasResult: &armmachinelearningservices.UpdateWorkspaceQuotasResult{
