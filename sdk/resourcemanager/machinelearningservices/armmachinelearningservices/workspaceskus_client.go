...
func NewWorkspaceSKUsClient(subscriptionID string, credential azcore.TokenCredential, options *arm.ClientOptions) (*WorkspaceSKUsClient, error) {
	cl, err := arm.NewClient(moduleName+".WorkspaceSKUsClient", moduleVersion, credential, options)
	if err != nil {
		return nil, err
	}
...
//   - options - WorkspaceSKUsClientListOptions contains the optional parameters for the WorkspaceSKUsClient.NewListPager method.
