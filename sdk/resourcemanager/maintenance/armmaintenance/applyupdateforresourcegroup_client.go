...
func (client *ApplyUpdateForResourceGroupClient) listCreateRequest(ctx context.Context, resourceGroupName string, _ *ApplyUpdateForResourceGroupClientListOptions) (*policy.Request, error) {
