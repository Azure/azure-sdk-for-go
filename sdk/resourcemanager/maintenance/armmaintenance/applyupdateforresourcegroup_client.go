...
func (client *ApplyUpdateForResourceGroupClient) listCreateRequest(ctx context.Context, resourceGroupName string, nextLink string, _ *ApplyUpdateForResourceGroupClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *ApplyUpdateForResourceGroupClient) listHandleResponse(resp *http.Response, successCodes ...int) (ApplyUpdateForResourceGroupClientListResponse, error) {
