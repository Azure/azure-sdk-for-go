...
// Generated from example definition: 2023-10-01-preview/ApplyUpdatesResourceGroup_List.json
func ExampleApplyUpdateForResourceGroupClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armmaintenance.ApplyUpdateForResourceGroupClientListResponse{
