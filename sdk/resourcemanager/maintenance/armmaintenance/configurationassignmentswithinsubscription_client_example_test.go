...
// Generated from example definition: 2023-10-01-preview/ConfigurationAssignmentsResultWithinSubscription_List.json
func ExampleConfigurationAssignmentsWithinSubscriptionClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armmaintenance.ConfigurationAssignmentsWithinSubscriptionClientListResponse{
