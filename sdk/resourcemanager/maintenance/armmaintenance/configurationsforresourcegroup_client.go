...
func (client *ConfigurationsForResourceGroupClient) listCreateRequest(ctx context.Context, resourceGroupName string, nextLink string, _ *ConfigurationsForResourceGroupClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *ConfigurationsForResourceGroupClient) listHandleResponse(resp *http.Response, successCodes ...int) (ConfigurationsForResourceGroupClientListResponse, error) {
