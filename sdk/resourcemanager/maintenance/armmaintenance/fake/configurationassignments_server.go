...
func (c *ConfigurationAssignmentsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if configurationAssignmentsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = configurationAssignmentsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "ConfigurationAssignmentsClient.CreateOrUpdateParent":
				res.resp, res.err = c.dispatchCreateOrUpdateParent(req)
			...
			case "ConfigurationAssignmentsClient.NewListParentPager":
				res.resp, res.err = c.dispatchNewListParentPager(req)
			default:
...
func (c *ConfigurationAssignmentsServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armmaintenance.ConfigurationAssignmentsClientListResponse, createLink func() string) {
...
func (c *ConfigurationAssignmentsServerTransport) dispatchNewListParentPager(req *http.Request) (*http.Response, error) {
	...
	if newListParentPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListParentPager, req, func(page *armmaintenance.ConfigurationAssignmentsClientListParentResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
...
// set this to conditionally intercept incoming requests to ConfigurationAssignmentsServerTransport
var configurationAssignmentsServerTransportInterceptor interface {
