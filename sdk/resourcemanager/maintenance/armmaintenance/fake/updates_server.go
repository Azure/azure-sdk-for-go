...
func (u *UpdatesServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourcegroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/(?P<providerName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/(?P<resourceType>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/(?P<resourceName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.Maintenance/updates`
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armmaintenance.UpdatesClientListResponse, createLink func() string) {
...
func (u *UpdatesServerTransport) dispatchNewListParentPager(req *http.Request) (*http.Response, error) {
	...
	if newListParentPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListParentPager, req, func(page *armmaintenance.UpdatesClientListParentResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
