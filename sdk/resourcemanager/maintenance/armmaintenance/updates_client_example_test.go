...
// Generated from example definition: 2023-10-01-preview/Updates_List.json
func ExampleUpdatesClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armmaintenance.UpdatesClientListResponse{
...
// Generated from example definition: 2023-10-01-preview/Updates_ListParent.json
func ExampleUpdatesClient_NewListParentPager() {
	...
	for pager.More() {
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armmaintenance.UpdatesClientListParentResponse{
		// 	ListUpdatesResult: armmaintenance.ListUpdatesResult{
		// 		Value: []*armmaintenance.Update{
		// 			{
		// 				ImpactDurationInSec: to.Ptr[int32](1440),
