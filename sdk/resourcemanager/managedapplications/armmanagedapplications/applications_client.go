...
// NewListAllowedUpgradePlansPager - List allowed upgrade plans for application.
//
// Generated from API version 2023-12-01-preview
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - applicationName - The name of the managed application.
//   - options - ApplicationsClientListAllowedUpgradePlansOptions contains the optional parameters for the ApplicationsClient.NewListAllowedUpgradePlansPager
//     method.
func (client *ApplicationsClient) NewListAllowedUpgradePlansPager(resourceGroupName string, applicationName string, options *ApplicationsClientListAllowedUpgradePlansOptions) *runtime.Pager[ApplicationsClientListAllowedUpgradePlansResponse] {
	return runtime.NewPager(runtime.PagingHandler[ApplicationsClientListAllowedUpgradePlansResponse]{
		More: func(page ApplicationsClientListAllowedUpgradePlansResponse) bool {
			return false
		},
		Fetcher: func(ctx context.Context, page *ApplicationsClientListAllowedUpgradePlansResponse) (ApplicationsClientListAllowedUpgradePlansResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "ApplicationsClient.NewListAllowedUpgradePlansPager")
...
// NewListTokensPager - List tokens for application.
//
// Generated from API version 2023-12-01-preview
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - applicationName - The name of the managed application.
//   - parameters - Request body parameters to list tokens.
//   - options - ApplicationsClientListTokensOptions contains the optional parameters for the ApplicationsClient.NewListTokensPager
//     method.
func (client *ApplicationsClient) NewListTokensPager(resourceGroupName string, applicationName string, parameters ListTokenRequest, options *ApplicationsClientListTokensOptions) *runtime.Pager[ApplicationsClientListTokensResponse] {
	return runtime.NewPager(runtime.PagingHandler[ApplicationsClientListTokensResponse]{
		More: func(page ApplicationsClientListTokensResponse) bool {
			return false
		},
		Fetcher: func(ctx context.Context, page *ApplicationsClientListTokensResponse) (ApplicationsClientListTokensResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "ApplicationsClient.NewListTokensPager")
