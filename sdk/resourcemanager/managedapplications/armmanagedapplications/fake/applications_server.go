...
type ApplicationsServer struct {
	...
	// NewListAllowedUpgradePlansPager is the fake for method ApplicationsClient.NewListAllowedUpgradePlansPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListAllowedUpgradePlansPager func(resourceGroupName string, applicationName string, options *armmanagedapplications.ApplicationsClientListAllowedUpgradePlansOptions) (resp azfake.PagerResponder[armmanagedapplications.ApplicationsClientListAllowedUpgradePlansResponse])
	...
	// NewListTokensPager is the fake for method ApplicationsClient.NewListTokensPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListTokensPager func(resourceGroupName string, applicationName string, parameters armmanagedapplications.ListTokenRequest, options *armmanagedapplications.ApplicationsClientListTokensOptions) (resp azfake.PagerResponder[armmanagedapplications.ApplicationsClientListTokensResponse])
...
func NewApplicationsServerTransport(srv *ApplicationsServer) *ApplicationsServerTransport {
	return &ApplicationsServerTransport{
		...
		newListAllowedUpgradePlansPager: newTracker[azfake.PagerResponder[armmanagedapplications.ApplicationsClientListAllowedUpgradePlansResponse]](),
		...
		newListTokensPager:              newTracker[azfake.PagerResponder[armmanagedapplications.ApplicationsClientListTokensResponse]](),
...
type ApplicationsServerTransport struct {
	...
	newListAllowedUpgradePlansPager *tracker[azfake.PagerResponder[armmanagedapplications.ApplicationsClientListAllowedUpgradePlansResponse]]
	...
	newListTokensPager              *tracker[azfake.PagerResponder[armmanagedapplications.ApplicationsClientListTokensResponse]]
...
func (a *ApplicationsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		if !intercepted {
			...
			case "ApplicationsClient.NewListAllowedUpgradePlansPager":
				res.resp, res.err = a.dispatchNewListAllowedUpgradePlansPager(req)
			...
			case "ApplicationsClient.NewListTokensPager":
				res.resp, res.err = a.dispatchNewListTokensPager(req)
...
func (a *ApplicationsServerTransport) dispatchNewListAllowedUpgradePlansPager(req *http.Request) (*http.Response, error) {
	if a.srv.NewListAllowedUpgradePlansPager == nil {
		return nil, &nonRetriableError{errors.New("fake for method NewListAllowedUpgradePlansPager not implemented")}
	}
	newListAllowedUpgradePlansPager := a.newListAllowedUpgradePlansPager.get(req)
	if newListAllowedUpgradePlansPager == nil {
		...
		resp := a.srv.NewListAllowedUpgradePlansPager(resourceGroupNameParam, applicationNameParam, nil)
		newListAllowedUpgradePlansPager = &resp
		a.newListAllowedUpgradePlansPager.add(req, newListAllowedUpgradePlansPager)
	}
	resp, err := server.PagerResponderNext(newListAllowedUpgradePlansPager, req)
	if err != nil {
		return nil, err
	}
	if !contains([]int{http.StatusOK}, resp.StatusCode) {
		a.newListAllowedUpgradePlansPager.remove(req)
		return nil, &nonRetriableError{fmt.Errorf("unexpected status code %d. acceptable values are http.StatusOK", resp.StatusCode)}
	}
	if !server.PagerResponderMore(newListAllowedUpgradePlansPager) {
		a.newListAllowedUpgradePlansPager.remove(req)
	}
	return resp, nil
}
...
func (a *ApplicationsServerTransport) dispatchNewListTokensPager(req *http.Request) (*http.Response, error) {
	if a.srv.NewListTokensPager == nil {
		return nil, &nonRetriableError{errors.New("fake for method NewListTokensPager not implemented")}
	}
	newListTokensPager := a.newListTokensPager.get(req)
	if newListTokensPager == nil {
		...
		resp := a.srv.NewListTokensPager(resourceGroupNameParam, applicationNameParam, body, nil)
		newListTokensPager = &resp
		a.newListTokensPager.add(req, newListTokensPager)
	}
	resp, err := server.PagerResponderNext(newListTokensPager, req)
	if err != nil {
		return nil, err
	}
	if !contains([]int{http.StatusOK}, resp.StatusCode) {
		a.newListTokensPager.remove(req)
		return nil, &nonRetriableError{fmt.Errorf("unexpected status code %d. acceptable values are http.StatusOK", resp.StatusCode)}
	}
	if !server.PagerResponderMore(newListTokensPager) {
		a.newListTokensPager.remove(req)
	}
	return resp, nil
}
