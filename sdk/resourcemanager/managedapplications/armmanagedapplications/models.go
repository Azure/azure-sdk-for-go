...
type ApplicationAuthorization struct {
	...
	// on the managed application's container resource group. This role definition cannot have permission to delete the resource
	// group.
...
type ApplicationDefinitionListResult struct {
	// REQUIRED; The ApplicationDefinition items on this page
...
// JitRequestDefinitionListResult - The response of a JitRequestDefinition list operation.
type JitRequestDefinitionListResult struct {
	// REQUIRED; The JitRequestDefinition items on this page
...
// RegistryPackage - Information about an application definition request.
type RegistryPackage struct {
	// REQUIRED; The offer Id
	Offer *string

	// REQUIRED; The registry package links.
	PackageLinks *RegistryPackageLinks
	...
	// REQUIRED; The version of the plan
	Version *string
}

// RegistryPackageLinks - Resource information.
type RegistryPackageLinks struct {
	// The create ui definition link.
	CreateUIDefinitionLink *string

	// The deployment template link.
	DeploymentTemplateLink *string
}

// RegistryPackagePlan - Plan for the managed application.
type RegistryPackagePlan struct {
	// REQUIRED; The offer Id.
	Offer *string
