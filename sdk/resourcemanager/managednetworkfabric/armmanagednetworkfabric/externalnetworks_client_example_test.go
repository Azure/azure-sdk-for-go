...
func ExampleExternalNetworksClient_BeginUpdateBfdAdministrativeState() {
	...
	poller, err := clientFactory.NewExternalNetworksClient().BeginUpdateBfdAdministrativeState(ctx, "example-rg", "example-externalnetwork", "example-ext", armmanagednetworkfabric.ExternalNetworkUpdateBfdAdministrativeStateRequest{
	...
	// 	ExternalNetworkUpdateBfdAdministrativeStateResponse: &armmanagednetworkfabric.ExternalNetworkUpdateBfdAdministrativeStateResponse{
	// 		Status: to.Ptr("Failed"),
	// 		Error: &armmanagednetworkfabric.ErrorDetail{
	// 			Code: to.Ptr(""),
	// 			Message: to.Ptr(""),
	...
	// 			},
	// 		},
	// 		Properties: &armmanagednetworkfabric.ExternalNetworkUpdateBfdAdministrativeStateResponseProperties{
	// 			RouteType: to.Ptr(armmanagednetworkfabric.ExternalNetworkRouteTypeStatic),
	// 			AdministrativeState: to.Ptr(armmanagednetworkfabric.BfdAdministrativeState("Enable")),
	// 		},
	// 	},
...
func ExampleExternalNetworksClient_BeginUpdateStaticRouteBfdAdministrativeState() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armmanagednetworkfabric.ExternalNetworksClientUpdateStaticRouteBfdAdministrativeStateResponse{
	// 	UpdateAdministrativeStateResponse: &armmanagednetworkfabric.UpdateAdministrativeStateResponse{
