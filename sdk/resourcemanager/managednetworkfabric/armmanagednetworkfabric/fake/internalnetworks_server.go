...
type InternalNetworksServer struct {
	...
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginUpdateBfdAdministrativeState func(ctx context.Context, resourceGroupName string, l3IsolationDomainName string, internalNetworkName string, body armmanagednetworkfabric.InternalNetworkUpdateBfdAdministrativeStateRequest, options *armmanagednetworkfabric.InternalNetworksClientBeginUpdateBfdAdministrativeStateOptions) (resp azfake.PollerResponder[armmanagednetworkfabric.InternalNetworksClientUpdateBfdAdministrativeStateResponse], errResp azfake.ErrorResponder)

	// BeginUpdateBgpAdministrativeState is the fake for method InternalNetworksClient.BeginUpdateBgpAdministrativeState
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginUpdateBgpAdministrativeState func(ctx context.Context, resourceGroupName string, l3IsolationDomainName string, internalNetworkName string, body armmanagednetworkfabric.InternalNetworkUpdateBgpAdministrativeStateRequest, options *armmanagednetworkfabric.InternalNetworksClientBeginUpdateBgpAdministrativeStateOptions) (resp azfake.PollerResponder[armmanagednetworkfabric.InternalNetworksClientUpdateBgpAdministrativeStateResponse], errResp azfake.ErrorResponder)
	...
	go func() {
		...
		if !intercepted {
			...
			case "InternalNetworksClient.BeginUpdateStaticRouteBfdAdministrativeState":
				res.resp, res.err = i.dispatchBeginUpdateStaticRouteBfdAdministrativeState(req)
			default:
...
func (i *InternalNetworksServerTransport) dispatchBeginUpdateBfdAdministrativeState(req *http.Request) (*http.Response, error) {
	...
	if beginUpdateBfdAdministrativeState == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armmanagednetworkfabric.InternalNetworkUpdateBfdAdministrativeStateRequest](req)
		if err != nil {
			return nil, err
		}
		resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
...
func (i *InternalNetworksServerTransport) dispatchBeginUpdateBgpAdministrativeState(req *http.Request) (*http.Response, error) {
	...
	if beginUpdateBgpAdministrativeState == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armmanagednetworkfabric.InternalNetworkUpdateBgpAdministrativeStateRequest](req)
		if err != nil {
			return nil, err
		}
		resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
