...
type L2IsolationDomainsServer struct {
	...
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginUpdate	func(ctx context.Context, resourceGroupName string, l2IsolationDomainName string, properties armmanagednetworkfabric.L2IsolationDomainPatch, options *armmanagednetworkfabric.L2IsolationDomainsClientBeginUpdateOptions) (resp azfake.PollerResponder[armmanagednetworkfabric.L2IsolationDomainsClientUpdateResponse], errResp azfake.ErrorResponder)
