...
type NetworkDevicesServer struct {
	...
	// BeginResyncCertificates is the fake for method NetworkDevicesClient.BeginResyncCertificates
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginResyncCertificates func(ctx context.Context, resourceGroupName string, networkDeviceName string, options *armmanagednetworkfabric.NetworkDevicesClientBeginResyncCertificatesOptions) (resp azfake.PollerResponder[armmanagednetworkfabric.NetworkDevicesClientResyncCertificatesResponse], errResp azfake.ErrorResponder)

	// BeginResyncPasswords is the fake for method NetworkDevicesClient.BeginResyncPasswords
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginResyncPasswords func(ctx context.Context, resourceGroupName string, networkDeviceName string, options *armmanagednetworkfabric.NetworkDevicesClientBeginResyncPasswordsOptions) (resp azfake.PollerResponder[armmanagednetworkfabric.NetworkDevicesClientResyncPasswordsResponse], errResp azfake.ErrorResponder)
	...
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginUpgrade func(ctx context.Context, resourceGroupName string, networkDeviceName string, body armmanagednetworkfabric.NetworkDeviceUpgradeRequest, options *armmanagednetworkfabric.NetworkDevicesClientBeginUpgradeOptions) (resp azfake.PollerResponder[armmanagednetworkfabric.NetworkDevicesClientUpgradeResponse], errResp azfake.ErrorResponder)
}
...
func NewNetworkDevicesServerTransport(srv *NetworkDevicesServer) *NetworkDevicesServerTransport {
	return &NetworkDevicesServerTransport{
		...
		beginResyncCertificates:        newTracker[azfake.PollerResponder[armmanagednetworkfabric.NetworkDevicesClientResyncCertificatesResponse]](),
		beginResyncPasswords:           newTracker[azfake.PollerResponder[armmanagednetworkfabric.NetworkDevicesClientResyncPasswordsResponse]](),
...
type NetworkDevicesServerTransport struct {
	...
	beginResyncCertificates        *tracker[azfake.PollerResponder[armmanagednetworkfabric.NetworkDevicesClientResyncCertificatesResponse]]
	beginResyncPasswords           *tracker[azfake.PollerResponder[armmanagednetworkfabric.NetworkDevicesClientResyncPasswordsResponse]]
...
func (n *NetworkDevicesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		if !intercepted {
			...
			case "NetworkDevicesClient.BeginResyncCertificates":
				res.resp, res.err = n.dispatchBeginResyncCertificates(req)
			case "NetworkDevicesClient.BeginResyncPasswords":
...
func (n *NetworkDevicesServerTransport) dispatchBeginCreate(req *http.Request) (*http.Response, error) {
	...
	if beginCreate == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.ManagedNetworkFabric/networkDevices/(?P<networkDeviceName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)`
...
func (n *NetworkDevicesServerTransport) dispatchNewListByResourceGroupPager(req *http.Request) (*http.Response, error) {
	...
	if newListByResourceGroupPager == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.ManagedNetworkFabric/networkDevices`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 3 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
...
func (n *NetworkDevicesServerTransport) dispatchNewListBySubscriptionPager(req *http.Request) (*http.Response, error) {
	...
	if newListBySubscriptionPager == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.ManagedNetworkFabric/networkDevices`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 2 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
...
func (n *NetworkDevicesServerTransport) dispatchBeginReboot(req *http.Request) (*http.Response, error) {
	...
	if beginReboot == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.ManagedNetworkFabric/networkDevices/(?P<networkDeviceName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/reboot`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 4 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
...
func (n *NetworkDevicesServerTransport) dispatchBeginRefreshConfiguration(req *http.Request) (*http.Response, error) {
	...
	if beginRefreshConfiguration == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.ManagedNetworkFabric/networkDevices/(?P<networkDeviceName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/refreshConfiguration`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 4 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
...
func (n *NetworkDevicesServerTransport) dispatchBeginResyncCertificates(req *http.Request) (*http.Response, error) {
	...
	if beginResyncCertificates == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.ManagedNetworkFabric/networkDevices/(?P<networkDeviceName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resyncCertificates`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 4 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
		...
		respr, errRespr := n.srv.BeginResyncCertificates(req.Context(), resourceGroupNameParam, networkDeviceNameParam, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
...
func (n *NetworkDevicesServerTransport) dispatchBeginResyncPasswords(req *http.Request) (*http.Response, error) {
	...
	if beginResyncPasswords == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.ManagedNetworkFabric/networkDevices/(?P<networkDeviceName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resyncPasswords`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 4 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
		...
		respr, errRespr := n.srv.BeginResyncPasswords(req.Context(), resourceGroupNameParam, networkDeviceNameParam, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
...
func (n *NetworkDevicesServerTransport) dispatchBeginRunRoCommand(req *http.Request) (*http.Response, error) {
	...
	if beginRunRoCommand == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.ManagedNetworkFabric/networkDevices/(?P<networkDeviceName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/runRoCommand`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 4 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
...
func (n *NetworkDevicesServerTransport) dispatchBeginRunRwCommand(req *http.Request) (*http.Response, error) {
	...
	if beginRunRwCommand == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.ManagedNetworkFabric/networkDevices/(?P<networkDeviceName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/runRwCommand`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 4 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
...
func (n *NetworkDevicesServerTransport) dispatchBeginUpdateAdministrativeState(req *http.Request) (*http.Response, error) {
	...
	if beginUpdateAdministrativeState == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.ManagedNetworkFabric/networkDevices/(?P<networkDeviceName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/updateAdministrativeState`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 4 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
...
func (n *NetworkDevicesServerTransport) dispatchBeginUpgrade(req *http.Request) (*http.Response, error) {
	...
	if beginUpgrade == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.ManagedNetworkFabric/networkDevices/(?P<networkDeviceName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/upgrade`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 4 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
		}
		body, err := server.UnmarshalRequestAsJSON[armmanagednetworkfabric.NetworkDeviceUpgradeRequest](req)
		if err != nil {
			return nil, err
		}
		resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
