...
type NetworkInterfacesServer struct {
	...
	BeginCreate	func(ctx context.Context, resourceGroupName string, networkDeviceName string, networkInterfaceName string, resource armmanagednetworkfabric.NetworkInterface, options *armmanagednetworkfabric.NetworkInterfacesClientBeginCreateOptions) (resp azfake.PollerResponder[armmanagednetworkfabric.NetworkInterfacesClientCreateResponse], errResp azfake.ErrorResponder)
	...
	BeginUpdate	func(ctx context.Context, resourceGroupName string, networkDeviceName string, networkInterfaceName string, properties armmanagednetworkfabric.NetworkInterfacePatch, options *armmanagednetworkfabric.NetworkInterfacesClientBeginUpdateOptions) (resp azfake.PollerResponder[armmanagednetworkfabric.NetworkInterfacesClientUpdateResponse], errResp azfake.ErrorResponder)
	...
	go func() {
		...
		if !intercepted {
			...
			case "NetworkInterfacesClient.NewListByNetworkDevicePager":
				res.resp, res.err = n.dispatchNewListByNetworkDevicePager(req)
