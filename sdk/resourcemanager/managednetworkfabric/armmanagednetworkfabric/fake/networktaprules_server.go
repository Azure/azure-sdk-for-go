...
type NetworkTapRulesServer struct {
	...
	BeginCreate	func(ctx context.Context, resourceGroupName string, networkTapRuleName string, resource armmanagednetworkfabric.NetworkTapRule, options *armmanagednetworkfabric.NetworkTapRulesClientBeginCreateOptions) (resp azfake.PollerResponder[armmanagednetworkfabric.NetworkTapRulesClientCreateResponse], errResp azfake.ErrorResponder)
