...
type NetworkToNetworkInterconnectsServer struct {
	...
	BeginCreate	func(ctx context.Context, resourceGroupName string, networkFabricName string, networkToNetworkInterconnectName string, resource armmanagednetworkfabric.NetworkToNetworkInterconnect, options *armmanagednetworkfabric.NetworkToNetworkInterconnectsClientBeginCreateOptions) (resp azfake.PollerResponder[armmanagednetworkfabric.NetworkToNetworkInterconnectsClientCreateResponse], errResp azfake.ErrorResponder)
	...
	BeginUpdate	func(ctx context.Context, resourceGroupName string, networkFabricName string, networkToNetworkInterconnectName string, properties armmanagednetworkfabric.NetworkToNetworkInterconnectPatch, options *armmanagednetworkfabric.NetworkToNetworkInterconnectsClientBeginUpdateOptions) (resp azfake.PollerResponder[armmanagednetworkfabric.NetworkToNetworkInterconnectsClientUpdateResponse], errResp azfake.ErrorResponder)
	...
	// BeginUpdateBfdAdministrativeState is the fake for method NetworkToNetworkInterconnectsClient.BeginUpdateBfdAdministrativeState
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginUpdateBfdAdministrativeState	func(ctx context.Context, resourceGroupName string, networkFabricName string, networkToNetworkInterconnectName string, body armmanagednetworkfabric.NniBfdAdministrativeStateRequest, options *armmanagednetworkfabric.NetworkToNetworkInterconnectsClientBeginUpdateBfdAdministrativeStateOptions) (resp azfake.PollerResponder[armmanagednetworkfabric.NetworkToNetworkInterconnectsClientUpdateBfdAdministrativeStateResponse], errResp azfake.ErrorResponder)
}
...
func NewNetworkToNetworkInterconnectsServerTransport(srv *NetworkToNetworkInterconnectsServer) *NetworkToNetworkInterconnectsServerTransport {
	return &NetworkToNetworkInterconnectsServerTransport{
		...
		beginUpdateBfdAdministrativeState:	newTracker[azfake.PollerResponder[armmanagednetworkfabric.NetworkToNetworkInterconnectsClientUpdateBfdAdministrativeStateResponse]](),
	}
}
...
type NetworkToNetworkInterconnectsServerTransport struct {
	...
	beginUpdateBfdAdministrativeState	*tracker[azfake.PollerResponder[armmanagednetworkfabric.NetworkToNetworkInterconnectsClientUpdateBfdAdministrativeStateResponse]]
}
...
func (n *NetworkToNetworkInterconnectsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if networkToNetworkInterconnectsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = networkToNetworkInterconnectsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "NetworkToNetworkInterconnectsClient.NewListByNetworkFabricPager":
				res.resp, res.err = n.dispatchNewListByNetworkFabricPager(req)
			...
			case "NetworkToNetworkInterconnectsClient.BeginUpdateBfdAdministrativeState":
				res.resp, res.err = n.dispatchBeginUpdateBfdAdministrativeState(req)
			default:
...
func (n *NetworkToNetworkInterconnectsServerTransport) dispatchBeginUpdateBfdAdministrativeState(req *http.Request) (*http.Response, error) {
	if n.srv.BeginUpdateBfdAdministrativeState == nil {
	...
	if beginUpdateBfdAdministrativeState == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armmanagednetworkfabric.NniBfdAdministrativeStateRequest](req)
		if err != nil {
			return nil, err
		}
		resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
		...
		respr, errRespr := n.srv.BeginUpdateBfdAdministrativeState(req.Context(), resourceGroupNameParam, networkFabricNameParam, networkToNetworkInterconnectNameParam, body, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginUpdateBfdAdministrativeState = &respr
		n.beginUpdateBfdAdministrativeState.add(req, beginUpdateBfdAdministrativeState)
	}
...
// set this to conditionally intercept incoming requests to NetworkToNetworkInterconnectsServerTransport
var networkToNetworkInterconnectsServerTransportInterceptor interface {
