...
type NetworkToNetworkInterconnectsServer struct {
	...
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginUpdateBfdAdministrativeState func(ctx context.Context, resourceGroupName string, networkFabricName string, networkToNetworkInterconnectName string, body armmanagednetworkfabric.NniUpdateBfdAdministrativeStateRequest, options *armmanagednetworkfabric.NetworkToNetworkInterconnectsClientBeginUpdateBfdAdministrativeStateOptions) (resp azfake.PollerResponder[armmanagednetworkfabric.NetworkToNetworkInterconnectsClientUpdateBfdAdministrativeStateResponse], errResp azfake.ErrorResponder)
	...
	go func() {
		...
		if !intercepted {
			...
			case "NetworkToNetworkInterconnectsClient.BeginUpdateNpbStaticRouteBfdAdministrativeState":
				res.resp, res.err = n.dispatchBeginUpdateNpbStaticRouteBfdAdministrativeState(req)
			default:
...
func (n *NetworkToNetworkInterconnectsServerTransport) dispatchBeginUpdateBfdAdministrativeState(req *http.Request) (*http.Response, error) {
	...
	if beginUpdateBfdAdministrativeState == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armmanagednetworkfabric.NniUpdateBfdAdministrativeStateRequest](req)
		if err != nil {
			return nil, err
		}
		resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
