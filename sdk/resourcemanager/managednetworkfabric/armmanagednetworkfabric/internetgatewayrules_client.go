...
//     method.
func (client *InternetGatewayRulesClient) BeginCreate(ctx context.Context, resourceGroupName string, internetGatewayRuleName string, resource InternetGatewayRule, options *InternetGatewayRulesClientBeginCreateOptions) (*runtime.Poller[InternetGatewayRulesClientCreateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.create(ctx, resourceGroupName, internetGatewayRuleName, resource, options)
		if err != nil {
			return nil, err
		}
...
//
// Generated from API version 2024-06-15-preview
func (client *InternetGatewayRulesClient) create(ctx context.Context, resourceGroupName string, internetGatewayRuleName string, resource InternetGatewayRule, options *InternetGatewayRulesClientBeginCreateOptions) (*http.Response, error) {
	var err error
	const operationName = "InternetGatewayRulesClient.BeginCreate"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.createCreateRequest(ctx, resourceGroupName, internetGatewayRuleName, resource, options)
	if err != nil {
		return nil, err
	}
...
func (client *InternetGatewayRulesClient) createCreateRequest(ctx context.Context, resourceGroupName string, internetGatewayRuleName string, resource InternetGatewayRule, _ *InternetGatewayRulesClientBeginCreateOptions) (*policy.Request, error) {
...
func (client *InternetGatewayRulesClient) listByResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, _ *InternetGatewayRulesClientListByResourceGroupOptions) (*policy.Request, error) {
...
func (client *InternetGatewayRulesClient) listByResourceGroupHandleResponse(resp *http.Response) (InternetGatewayRulesClientListByResourceGroupResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.InternetGatewayRuleListResult); err != nil {
		return InternetGatewayRulesClientListByResourceGroupResponse{}, err
	}
	return result, nil
}
...
func (client *InternetGatewayRulesClient) listBySubscriptionCreateRequest(ctx context.Context, _ *InternetGatewayRulesClientListBySubscriptionOptions) (*policy.Request, error) {
...
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - internetGatewayRuleName - Name of the Internet Gateway rule.
//   - properties - Internet Gateway Rule properties to update.
...
//     method.
func (client *InternetGatewayRulesClient) BeginUpdate(ctx context.Context, resourceGroupName string, internetGatewayRuleName string, properties InternetGatewayRulePatch, options *InternetGatewayRulesClientBeginUpdateOptions) (*runtime.Poller[InternetGatewayRulesClientUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.update(ctx, resourceGroupName, internetGatewayRuleName, properties, options)
		if err != nil {
			return nil, err
		}
...
//
// Generated from API version 2024-06-15-preview
func (client *InternetGatewayRulesClient) update(ctx context.Context, resourceGroupName string, internetGatewayRuleName string, properties InternetGatewayRulePatch, options *InternetGatewayRulesClientBeginUpdateOptions) (*http.Response, error) {
	var err error
	const operationName = "InternetGatewayRulesClient.BeginUpdate"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.updateCreateRequest(ctx, resourceGroupName, internetGatewayRuleName, properties, options)
	if err != nil {
		return nil, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
...
func (client *InternetGatewayRulesClient) updateCreateRequest(ctx context.Context, resourceGroupName string, internetGatewayRuleName string, properties InternetGatewayRulePatch, _ *InternetGatewayRulesClientBeginUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedNetworkFabric/internetGatewayRules/{internetGatewayRuleName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
