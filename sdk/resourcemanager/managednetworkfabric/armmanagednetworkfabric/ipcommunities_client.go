...
//     method.
func (client *IPCommunitiesClient) BeginCreate(ctx context.Context, resourceGroupName string, ipCommunityName string, resource IPCommunity, options *IPCommunitiesClientBeginCreateOptions) (*runtime.Poller[IPCommunitiesClientCreateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.create(ctx, resourceGroupName, ipCommunityName, resource, options)
		if err != nil {
			return nil, err
		}
...
//
// Generated from API version 2024-06-15-preview
func (client *IPCommunitiesClient) create(ctx context.Context, resourceGroupName string, ipCommunityName string, resource IPCommunity, options *IPCommunitiesClientBeginCreateOptions) (*http.Response, error) {
	var err error
	const operationName = "IPCommunitiesClient.BeginCreate"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.createCreateRequest(ctx, resourceGroupName, ipCommunityName, resource, options)
	if err != nil {
		return nil, err
	}
...
func (client *IPCommunitiesClient) createCreateRequest(ctx context.Context, resourceGroupName string, ipCommunityName string, resource IPCommunity, _ *IPCommunitiesClientBeginCreateOptions) (*policy.Request, error) {
...
func (client *IPCommunitiesClient) listByResourceGroupHandleResponse(resp *http.Response) (IPCommunitiesClientListByResourceGroupResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.IPCommunityListResult); err != nil {
		return IPCommunitiesClientListByResourceGroupResponse{}, err
	}
	return result, nil
}
...
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - ipCommunityName - Name of the IP Community.
//   - properties - IP Community properties to update.
//   - options - IPCommunitiesClientBeginUpdateOptions contains the optional parameters for the IPCommunitiesClient.BeginUpdate
//     method.
func (client *IPCommunitiesClient) BeginUpdate(ctx context.Context, resourceGroupName string, ipCommunityName string, properties IPCommunityPatch, options *IPCommunitiesClientBeginUpdateOptions) (*runtime.Poller[IPCommunitiesClientUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.update(ctx, resourceGroupName, ipCommunityName, properties, options)
		if err != nil {
			return nil, err
		}
...
//
// Generated from API version 2024-06-15-preview
func (client *IPCommunitiesClient) update(ctx context.Context, resourceGroupName string, ipCommunityName string, properties IPCommunityPatch, options *IPCommunitiesClientBeginUpdateOptions) (*http.Response, error) {
	var err error
	const operationName = "IPCommunitiesClient.BeginUpdate"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.updateCreateRequest(ctx, resourceGroupName, ipCommunityName, properties, options)
	if err != nil {
		return nil, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
...
func (client *IPCommunitiesClient) updateCreateRequest(ctx context.Context, resourceGroupName string, ipCommunityName string, properties IPCommunityPatch, _ *IPCommunitiesClientBeginUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedNetworkFabric/ipCommunities/{ipCommunityName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
