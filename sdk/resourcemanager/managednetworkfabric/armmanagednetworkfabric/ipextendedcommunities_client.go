...
func (client *IPExtendedCommunitiesClient) createCreateRequest(ctx context.Context, resourceGroupName string, ipExtendedCommunityName string, body IPExtendedCommunity, _ *IPExtendedCommunitiesClientBeginCreateOptions) (*policy.Request, error) {
...
func (client *IPExtendedCommunitiesClient) getHandleResponse(resp *http.Response, successCodes ...int) (IPExtendedCommunitiesClientGetResponse, error) {
...
func (client *IPExtendedCommunitiesClient) listByResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, nextLink string, _ *IPExtendedCommunitiesClientListByResourceGroupOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *IPExtendedCommunitiesClient) listByResourceGroupHandleResponse(resp *http.Response, successCodes ...int) (IPExtendedCommunitiesClientListByResourceGroupResponse, error) {
...
func (client *IPExtendedCommunitiesClient) listBySubscriptionCreateRequest(ctx context.Context, nextLink string, _ *IPExtendedCommunitiesClientListBySubscriptionOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
	var req *policy.Request
	var err error
	if firstPage {
...
func (client *IPExtendedCommunitiesClient) listBySubscriptionHandleResponse(resp *http.Response, successCodes ...int) (IPExtendedCommunitiesClientListBySubscriptionResponse, error) {
...
func (client *IPExtendedCommunitiesClient) updateCreateRequest(ctx context.Context, resourceGroupName string, ipExtendedCommunityName string, body IPExtendedCommunityPatch, _ *IPExtendedCommunitiesClientBeginUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedNetworkFabric/ipExtendedCommunities/{ipExtendedCommunityName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
