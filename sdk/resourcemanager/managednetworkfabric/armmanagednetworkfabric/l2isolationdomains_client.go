...
func (client *L2IsolationDomainsClient) getHandleResponse(resp *http.Response, successCodes ...int) (L2IsolationDomainsClientGetResponse, error) {
...
func (client *L2IsolationDomainsClient) listByResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, nextLink string, _ *L2IsolationDomainsClientListByResourceGroupOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *L2IsolationDomainsClient) listByResourceGroupHandleResponse(resp *http.Response, successCodes ...int) (L2IsolationDomainsClientListByResourceGroupResponse, error) {
...
func (client *L2IsolationDomainsClient) listBySubscriptionCreateRequest(ctx context.Context, nextLink string, _ *L2IsolationDomainsClientListBySubscriptionOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
	var req *policy.Request
	var err error
	if firstPage {
...
func (client *L2IsolationDomainsClient) listBySubscriptionHandleResponse(resp *http.Response, successCodes ...int) (L2IsolationDomainsClientListBySubscriptionResponse, error) {
