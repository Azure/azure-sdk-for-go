...
// AccessControlListPatchableProperties - Access Control List Patch Properties defines the patchable resource properties.
type AccessControlListPatchableProperties struct {
	// Access Control List file URL.
	ACLsURL *string
...
// AnnotationResource - Switch configuration entries require a description to discern between configuration groups.
...
// CommonMatchConditions - Defines the common match conditions of the ACL and Network Tap Rule.
type CommonMatchConditions struct {
	// IP condition that needs to be matched.
	IPCondition *IPMatchCondition
...
// ExtensionEnumProperty - Extension property.
type ExtensionEnumProperty struct {
...
// ExternalNetworkPatchableProperties - The ExternalNetwork patchable properties.
type ExternalNetworkPatchableProperties struct {
	// Export Route Policy either IPv4 or IPv6.
	ExportRoutePolicy *ExportRoutePolicy
...
// IPCommunityAddOperationProperties - IP Community add operation properties.
type IPCommunityAddOperationProperties struct {
	// List of IP Community IDs.
	Add *IPCommunityIDList
}

// IPCommunityDeleteOperationProperties - IP Community delete operation properties.
type IPCommunityDeleteOperationProperties struct {
	// List of IP Community IDs.
	Delete *IPCommunityIDList
}
...
// IPCommunitySetOperationProperties - IP Community set operation properties.
type IPCommunitySetOperationProperties struct {
	// List of IP Community IDs.
	Set *IPCommunityIDList
}
...
// IPExtendedCommunityAddOperationProperties - IP Extended Community add operation properties.
type IPExtendedCommunityAddOperationProperties struct {
	// List of IP Extended Community IDs.
	Add *IPExtendedCommunityIDList
}

// IPExtendedCommunityDeleteOperationProperties - IP Extended Community delete operation properties.
type IPExtendedCommunityDeleteOperationProperties struct {
	// List of IP Extended Community IDs.
	Delete *IPExtendedCommunityIDList
}
...
// IPExtendedCommunityPatchableProperties - IP Extended Community patchable properties.
type IPExtendedCommunityPatchableProperties struct {
	// REQUIRED; List of IP Extended Community Rules.
	IPExtendedCommunityRules []*IPExtendedCommunityRule
}
...
// IPExtendedCommunitySetOperationProperties - IP Extended Community set operation properties.
type IPExtendedCommunitySetOperationProperties struct {
	// List of IP Extended Community IDs.
	Set *IPExtendedCommunityIDList
}
...
// IPPrefixPatchableProperties - IP Prefix patchable properties.
type IPPrefixPatchableProperties struct {
	// The list of IP Prefix Rules.
	IPPrefixRules []*IPPrefixRule
}
...
// InternalNetworkPatchableProperties - The InternalNetwork patchable properties.
type InternalNetworkPatchableProperties struct {
	// List of Connected IPv4 Subnets.
	ConnectedIPv4Subnets []*ConnectedSubnet
...
// L3IsolationDomainPatchableProperties - L3 Isolation Domain Patch Properties defines the patchable properties of the resource.
type L3IsolationDomainPatchableProperties struct {
	// Aggregate route configurations.
	AggregateRouteConfiguration *AggregateRouteConfiguration
...
// L3OptionAProperties - Peering optionA properties
type L3OptionAProperties struct {
	// BFD configuration properties
	BfdConfiguration *BfdConfiguration
...
// Layer3IPPrefixProperties - Layer 3 primary and secondary IP Address prefixes.
type Layer3IPPrefixProperties struct {
	// IPv4 Address Prefix.
	PrimaryIPv4Prefix *string
...
// NeighborGroupPatchableProperties - Neighbor Group Patchable Properties defines the patchable properties of the resource.
type NeighborGroupPatchableProperties struct {
	// An array of destination IPv4 Addresses or IPv6 Addresses.
	Destination *NeighborGroupDestination
}
...
// NetworkDevicePatchableProperties - Network Device updatable properties.
type NetworkDevicePatchableProperties struct {
	// The host name of the device.
	HostName *string
...
// NetworkFabricPatchableProperties - Network Fabric updatable properties.
type NetworkFabricPatchableProperties struct {
	// ASN of CE devices for CE/PE connectivity.
	FabricASN *int64
...
// NetworkTapRulePatchableProperties - Network Tap Rule updatable properties.
type NetworkTapRulePatchableProperties struct {
	// Input method to configure Network Tap Rule.
	ConfigurationType *ConfigurationType
