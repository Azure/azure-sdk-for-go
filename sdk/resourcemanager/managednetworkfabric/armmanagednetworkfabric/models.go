...
type AccessControlListProperties struct {
	...
	// READ-ONLY; Associated Network Fabric Resource IDs
...
// AccessControlListsListResult - Paged collection of AccessControlList items
...
// ArmConfigurationDiffOperationResponse - Arm Configuration Diff Response V2.
type ArmConfigurationDiffOperationResponse struct {
...
// ArmConfigurationDiffResponseProperties - Arm Configuration Diff Response Properties.
type ArmConfigurationDiffResponseProperties struct {
	// Storage URL to the diff file.
	ConfigurationDiffURL *string
}

// AuthorizedTransceiverPatchProperties - Authorized Transceiver Patch Properties.
type AuthorizedTransceiverPatchProperties struct {
...
// AuthorizedTransceiverProperties - Authorized Transceiver Properties.
type AuthorizedTransceiverProperties struct {
	// Key that must be configured on the fabric.
	Key *string
...
// BmpExportPolicyPatchProperties - BMP Export Policy Configuration properties.
type BmpExportPolicyPatchProperties struct {
	// Export Policy for the BGP Monitoring Protocol (BMP) Configuration.
	ExportPolicies []*BmpExportPolicy
}

// BmpExportPolicyProperties - BMP Export Policy Configuration properties.
type BmpExportPolicyProperties struct {
	// Export Policy for the BGP Monitoring Protocol (BMP) Configuration.
	ExportPolicies []*BmpExportPolicy
}
...
// CertificateArchiveReference - A reference to a version of a certificate in a key vault.
type CertificateArchiveReference struct {
	// READ-ONLY; The name of the certificate in the key vault.
	CertificateName *string

	// READ-ONLY; The version of the certificate in the key vault.
	CertificateVersion *string

	// READ-ONLY; The resource ID of the key vault containing the certificate.
	KeyVaultID *string

	// READ-ONLY; A Uniform Resource Identifier (URI) for the certificate in the key vault.
	KeyVaultURI *string
}

// CertificateRotationStatus - Status of a certificate rotation for a device (Network Device or Terminal Server).
type CertificateRotationStatus struct {
	// READ-ONLY; Reference to the currently configured version of the certificate in a key vault.
	CertificateArchiveReference *CertificateArchiveReference

	// READ-ONLY; Identifies the certificate according to its purpose.
	CertificateType *string

	// READ-ONLY; Time at which the certificate will expire, for certificates with a limited validity period.
	ExpireTime *time.Time

	// READ-ONLY; The date and time when the certificate was last changed.
	LastRotationTime *time.Time

	// READ-ONLY; Whether the device has been configured with the latest version of the certificate.
...
// CommitBatchStatusOperationResponse - Commit Batch Status Response.
type CommitBatchStatusOperationResponse struct {
	// REQUIRED; Operation status.
	Status *string
...
// CommitBatchStatusResponseProperties - Commit Batch Status Response Properties.
type CommitBatchStatusResponseProperties struct {
...
// CommitConfigurationRequest - Commit Configuration Request.
type CommitConfigurationRequest struct {
...
// CommitConfigurationResponse - Commit Configuration Response.
type CommitConfigurationResponse struct {
	// REQUIRED; Operation status.
	Status *string
...
// ControlPlanACLIPMatchCondition - Control Plane Access Control List (ACL) IP condition properties
type ControlPlanACLIPMatchCondition struct {
...
// ControlPlaneACLAction - Control Plane Access Control List (ACL) Actions
type ControlPlaneACLAction struct {
	// Remark comment
	RemarkComment *string
...
// ControlPlaneACLActionPatch - Control Plane Access Control List (ACL) Actions
type ControlPlaneACLActionPatch struct {
	// Remark comment
	RemarkComment *string
...
// ControlPlaneACLIPMatchConditionPatch - Control Plane Access Control List (ACL) IP condition patch properties
type ControlPlaneACLIPMatchConditionPatch struct {
	// List of the destination IP addresses that need to be matched.
	DestinationIPPrefix *string
...
// ControlPlaneACLMatchCondition - Control Plane Access Control List (ACL) match conditions properties
type ControlPlaneACLMatchCondition struct {
...
// ControlPlaneACLMatchConditionPatch - Control Plane Access Control List (ACL) match conditions properties
type ControlPlaneACLMatchConditionPatch struct {
	// Flags that need to be matched. Example: established | initial | <List-of-TCP-flags>. List of eligible TCP Flags are ack,
	// cwr, ece, fin, psh, rst, syn, urg, established
	Flags []*string
...
// ControlPlaneACLMatchConfigurationPatchProperties - Control Plane Access Control List (ACL) match configurations properties
type ControlPlaneACLMatchConfigurationPatchProperties struct {
...
// ControlPlaneACLMatchConfigurationProperties - Control Plane Access Control List (ACL) match configurations properties
type ControlPlaneACLMatchConfigurationProperties struct {
	// Action that need to be performed for the matched conditions.
...
// ControlPlaneACLPatchProperties - Access Control List (ACL) configurations patch properties
type ControlPlaneACLPatchProperties struct {
...
// ControlPlaneACLPortCondition - Control Plane Access Control List (ACL) Port Match conditions properties
type ControlPlaneACLPortCondition struct {
...
// ControlPlaneACLPortMatchCondition - Control Plane Access Control List (ACL) Port Match conditions properties
type ControlPlaneACLPortMatchCondition struct {
...
// ControlPlaneACLPortMatchConditionPatch - Control Plane Access Control List (ACL) Port Match conditions properties
type ControlPlaneACLPortMatchConditionPatch struct {
	// List of the destination ports that need to be matched.
	DestinationPorts *ControlPlaneACLPortCondition
...
// ControlPlaneACLProperties - Access Control List (ACL) configurations properties
type ControlPlaneACLProperties struct {
	// IP Address Type. IPv4 or IPv6
	IPAddressType *IPAddressType
...
// ControlPlaneACLTTLMatchCondition - TTL [Time To Live] match conditions properties
type ControlPlaneACLTTLMatchCondition struct {
...
// ControlPlaneACLTTLMatchConditionPatch - TTL [Time To Live] match conditions patch properties
type ControlPlaneACLTTLMatchConditionPatch struct {
	// TTL [Time To Live] match type. Example: eq | neq | gt | lt | range
	TTLMatchType *ControlPlaneACLTTLMatchType
...
// DiscardCommitBatchOperationResponse - Discard Commit Batch Response.
type DiscardCommitBatchOperationResponse struct {
	// REQUIRED; Operation status.
	Status *string
...
// DiscardCommitBatchResponseProperties - Discard Commit Batch Response Properties.
type DiscardCommitBatchResponseProperties struct {
	// Commit Batch Identifier.
	CommitBatchID *string
}
...
type ExternalNetworkProperties struct {
	...
	// READ-ONLY; Associated Network Fabric Resource ID
...
// ExternalNetworkUpdateBfdAdministrativeStateRequest - External Network Update Administrative State request
type ExternalNetworkUpdateBfdAdministrativeStateRequest struct {
...
// ExternalNetworkUpdateBfdAdministrativeStateResponse - External Network Update Administrative State response
type ExternalNetworkUpdateBfdAdministrativeStateResponse struct {
	// REQUIRED; Operation status.
	Status *string
...
// ExternalNetworkUpdateBfdAdministrativeStateResponseProperties - Response properties for External Network BFD Administrative
// State.
type ExternalNetworkUpdateBfdAdministrativeStateResponseProperties struct {
	// Administrative state.
	AdministrativeState *BfdAdministrativeState
...
// ExternalNetworksList - Paged collection of ExternalNetwork items
...
// GetTopologyResponse - GetTopology Response.
...
// GetTopologyResponseProperties - Properties of the GetTopology Response.
type GetTopologyResponseProperties struct {
...
// IPCommunitiesListResult - Paged collection of IpCommunity items
...
// IPPrefixesListResult - Paged collection of IpPrefix items
...
// InternalNetworkUpdateBfdAdministrativeStateRequest - Internal Network BFD Administrative State request
type InternalNetworkUpdateBfdAdministrativeStateRequest struct {
...
// InternalNetworkUpdateBfdAdministrativeStateResponse - Internal Network BFD Administrative State response
type InternalNetworkUpdateBfdAdministrativeStateResponse struct {
	// REQUIRED; Operation status.
	Status *string
...
// InternalNetworkUpdateBfdAdministrativeStateResponseProperties - Internal Network BFD Administrative State response properties
type InternalNetworkUpdateBfdAdministrativeStateResponseProperties struct {
	// NeighborAddress administrative status
	NeighborAddressAdministrativeStatus []*NeighborAddressBfdAdministrativeStatus
}

// InternalNetworkUpdateBgpAdministrativeStateRequest - Internal Network Administrative State Request
type InternalNetworkUpdateBgpAdministrativeStateRequest struct {
...
// InternalNetworkUpdateBgpAdministrativeStateResponse - Internal Network Administrative State Response
type InternalNetworkUpdateBgpAdministrativeStateResponse struct {
	// REQUIRED; Operation status.
	Status *string
...
// InternalNetworkUpdateBgpAdministrativeStateResponseProperties - Internal Network BGP Administrative State response properties
type InternalNetworkUpdateBgpAdministrativeStateResponseProperties struct {
	// NeighborAddress administrative status
	NeighborAddressAdministrativeStatus []*NeighborAddressBgpAdministrativeStatus
}

// InternalNetworksList - Paged collection of InternalNetwork items
...
// InternetGatewayRulesListResult - Paged collection of InternetGatewayRule items
...
// InternetGatewaysListResult - Paged collection of InternetGateway items
...
// L2IsolationDomainsListResult - Paged collection of L2IsolationDomain items
...
// L3IsolationDomainsListResult - Paged collection of L3IsolationDomain items
...
// NeighborGroupResyncResponse - Response for Neighbor Group Resync operation.
type NeighborGroupResyncResponse struct {
	// REQUIRED; Operation status.
	Status *string
...
// NeighborGroupsListResult - Paged collection of NeighborGroup items
...
// NetworkBootstrapDevice - The Network Bootstrap Device resource definition.
type NetworkBootstrapDevice struct {
	// REQUIRED; The geo-location where the resource lives
	Location *string

	// REQUIRED; The NetworkBootstrapDevice properties
...
// NetworkBootstrapDeviceListResult - The response of a NetworkBootstrapDevice list operation.
type NetworkBootstrapDeviceListResult struct {
	// REQUIRED; The NetworkBootstrapDevice items on this page
...
// NetworkBootstrapDevicePatch - The Network Bootstrap Device Patch Parameters defines the patch parameters of the resource.
type NetworkBootstrapDevicePatch struct {
	// The managed service identities assigned to this resource.
	Identity *ManagedServiceIdentityPatch
...
// NetworkBootstrapDevicePatchProperties - Network Bootstrap Device Patch properties.
type NetworkBootstrapDevicePatchProperties struct {
	// Switch configuration description.
	Annotation *string
...
// NetworkBootstrapDeviceProperties - Network Bootstrap Device Properties defines the properties of the resource.
type NetworkBootstrapDeviceProperties struct {
	// Switch configuration description.
	Annotation *string
	...
	// READ-ONLY; Dhcp server IPv4 Address.
	DhcpV4ServerIPAddress *string

	// READ-ONLY; Associated Network Fabric Resource ID
	NetworkFabricID *string

	// READ-ONLY; Primary Management IPv4 Address.
	PrimaryManagementIPv4Address *string

	// READ-ONLY; Primary Management IPv6 Address.
	PrimaryManagementIPv6Address *string

	// READ-ONLY; Provisioning state of the resource.
	ProvisioningState *ProvisioningState

	// READ-ONLY; Secondary Management IPv4 Address.
	SecondaryManagementIPv4Address *string

	// READ-ONLY; Secondary Management IPv6 Address.
...
// NetworkBootstrapDeviceRebootResponse - Network Bootstrap Device reboot Response.
type NetworkBootstrapDeviceRebootResponse struct {
	// REQUIRED; Operation status.
	Status *string
...
// NetworkBootstrapDeviceRefreshConfigurationResponse - The current status of an refresh configuration async operation.
type NetworkBootstrapDeviceRefreshConfigurationResponse struct {
	// REQUIRED; Operation status.
	Status *string
...
// NetworkBootstrapDeviceResyncPasswordsResponse - Response body for a ResyncPasswords request on a Network Bootstrap Device.
type NetworkBootstrapDeviceResyncPasswordsResponse struct {
	// REQUIRED; Operation status.
	Status *string
...
// NetworkBootstrapDeviceUpdateAdministrativeStateResponse - Network Bootstrap Device Administrative State Update Response.
type NetworkBootstrapDeviceUpdateAdministrativeStateResponse struct {
	// REQUIRED; Operation status.
	Status *string
...
// NetworkBootstrapDeviceUpgradeResponse - Network Bootstrap Device upgrade Response.
type NetworkBootstrapDeviceUpgradeResponse struct {
	// REQUIRED; Operation status.
	Status *string
...
// NetworkBootstrapInterface - Defines the NetworkBootstrapInterface resource.
type NetworkBootstrapInterface struct {
	// REQUIRED; The NetworkBootstrapInterface properties
...
// NetworkBootstrapInterfaceListResult - The response of a NetworkBootstrapInterface list operation.
type NetworkBootstrapInterfaceListResult struct {
	// REQUIRED; The NetworkBootstrapInterface items on this page
...
// NetworkBootstrapInterfacePatch - The NetworkBootstrapInterfacePatch resource definition.
type NetworkBootstrapInterfacePatch struct {
	// Network Bootstrap Interface Patch properties.
	Properties *NetworkBootstrapInterfacePatchProperties
}

// NetworkBootstrapInterfacePatchProperties - Network Bootstrap Interface Patch properties.
type NetworkBootstrapInterfacePatchProperties struct {
...
// NetworkBootstrapInterfaceProperties - Network Bootstrap Interface Properties defines the properties of the resource.
type NetworkBootstrapInterfaceProperties struct {
	// Additional description of the interface.
	AdditionalDescription *string
	...
	// READ-ONLY; Connected to information of the device.
	ConnectedTo *string

	// READ-ONLY; Description of the interface.
	Description *string
	...
	// READ-ONLY; Type of the interface.
	InterfaceType *InterfaceType

	// READ-ONLY; Physical identifier of the device.
...
type NetworkDeviceProperties struct {
	...
	// READ-ONLY; Certificate rotation status for the device's certificates.
	...
	// READ-ONLY; Secret rotation status for the device's secrets.
...
// NetworkDeviceRefreshConfigurationResponse - The current status of an refresh configuration async operation.
type NetworkDeviceRefreshConfigurationResponse struct {
	// REQUIRED; Operation status.
	Status *string
...
// NetworkDeviceResyncPasswordsResponse - Response body for a ResyncPasswords request on a Network Device.
type NetworkDeviceResyncPasswordsResponse struct {
	// REQUIRED; Operation status.
	Status *string
...
// NetworkDeviceRunRwCommandResponse - Response body for a RunRwCommand request on a Network Device.
type NetworkDeviceRunRwCommandResponse struct {
	// REQUIRED; Operation status.
	Status *string
...
// NetworkDeviceRwCommandResponseProperties - Network Device Resource defines the properties of the resource.
type NetworkDeviceRwCommandResponseProperties struct {
...
type NetworkDeviceSKU struct {
	// REQUIRED; The Network Device SKU properties.
...
// NetworkDeviceSKUsListResult - Paged collection of NetworkDeviceSku items
...
// NetworkDeviceUpdateAdministrativeStateResponse - Network Device Administrative State Update Response.
type NetworkDeviceUpdateAdministrativeStateResponse struct {
	// REQUIRED; Operation status.
	Status *string
...
// NetworkDeviceUpgradeRequest - NetworkDevice Upgrade Request Properties.
type NetworkDeviceUpgradeRequest struct {
	// REQUIRED; Version to which the device needs to be upgraded.
	Version *string
...
// NetworkDeviceUpgradeResponse - Network Device Upgrade Response.
type NetworkDeviceUpgradeResponse struct {
	// REQUIRED; Operation status.
	Status *string
...
// NetworkDevicesListResult - Paged collection of NetworkDevice items
...
// NetworkFabricControllersListResult - Paged collection of NetworkFabricController items
...
type NetworkFabricProperties struct {
	...
	// READ-ONLY; Overview of secret rotation for the Network Fabric.
	SecretRotationSummary *SecretRotationSummary
}

// NetworkFabricResyncCertificatesResponse - Response body for a ResyncCertificates request on a Network Fabric.
type NetworkFabricResyncCertificatesResponse struct {
	// REQUIRED; Operation status.
	Status *string
...
// NetworkFabricResyncPasswordsResponse - Response body for a ResyncPasswords request on a Network Fabric.
type NetworkFabricResyncPasswordsResponse struct {
	// REQUIRED; Operation status.
	Status *string
...
// NetworkFabricRotateCertificatesResponse - Response body for a RotateCertificates request on a Network Fabric.
type NetworkFabricRotateCertificatesResponse struct {
	// REQUIRED; Operation status.
	Status *string
...
// NetworkFabricRotatePasswordsResponse - Response body for a RotatePasswords request on a Network Fabric.
type NetworkFabricRotatePasswordsResponse struct {
	// REQUIRED; Operation status.
	Status *string
...
// NetworkFabricSKUsListResult - Paged collection of NetworkFabricSku items
...
// NetworkFabricsListResult - Paged collection of NetworkFabric items
...
// NetworkInterfacesList - Paged collection of NetworkInterface items
...
type NetworkMonitor struct {
	...
	// REQUIRED; The NetworkMonitor properties.
...
// NetworkPacketBrokersListResult - Paged collection of NetworkPacketBroker items
...
type NetworkRack struct {
	...
	// REQUIRED; Network Rack Properties
...
// NetworkRacksListResult - Paged collection of NetworkRack items
...
// NetworkTapResyncResponse - Response for NetworkTap Resync operation.
type NetworkTapResyncResponse struct {
	// REQUIRED; Operation status.
	Status *string
...
type NetworkTapRuleProperties struct {
	...
	// READ-ONLY; The ARM resource Id of the NetworkTap Rules.
	NetworkTapIDs []*string
...
// NetworkTapRuleResyncResponse - Response for Network Tap Rule resync operation.
type NetworkTapRuleResyncResponse struct {
	// REQUIRED; Operation status.
	Status *string
...
// NetworkTapRulesListResult - Paged collection of NetworkTapRule items
...
// NetworkTapsListResult - Paged collection of NetworkTap items
...
// NetworkToNetworkInterconnectsList - Paged collection of NetworkToNetworkInterconnect items
...
// NniUpdateBfdAdministrativeStateRequest - NNI Bidirectional Forwarding Detection (BFD) Administrative State request.
type NniUpdateBfdAdministrativeStateRequest struct {
...
// NniUpdateBfdAdministrativeStateResponse - NNI Bidirectional Forwarding Detection (BFD) Administrative State response.
type NniUpdateBfdAdministrativeStateResponse struct {
	// REQUIRED; Operation status.
	Status *string
...
// NniUpdateBfdAdministrativeStateResponseProperties - NNI Bidirectional Forwarding Detection (BFD) Update Administrative
// State response.
type NniUpdateBfdAdministrativeStateResponseProperties struct {
	// State. Select either enable or disable.
	AdministrativeState *BfdAdministrativeState
...
// QosPatchProperties - NetworkFabric QoS Patch Properties.
type QosPatchProperties struct {
	// QoS configuration state. Default is Disabled.
	QosConfigurationState *QosConfigurationState
}

// QosProperties - NetworkFabric QoS Properties.
type QosProperties struct {
	// QoS configuration state. Default is Disabled.
	QosConfigurationState *QosConfigurationState
}
...
// RoutePoliciesListResult - Paged collection of RoutePolicy items
...
// SecretArchiveReference - A reference to a version of a secret in a key vault.
type SecretArchiveReference struct {
	// READ-ONLY; The resource ID of the key vault containing the secret.
	KeyVaultID *string

	// READ-ONLY; A Uniform Resource Identifier (URI) for the secret in the key vault.
	KeyVaultURI *string
...
// SecretRotationStatus - Status of a secret rotation for a device (Network Device or Terminal Server).
type SecretRotationStatus struct {
	// READ-ONLY; The date and time when the secret was last changed.
	LastRotationTime *time.Time

	// READ-ONLY; Reference to the currently configured version of the secret in a key vault.
	SecretArchiveReference *SecretArchiveReference

	// READ-ONLY; Identifies the secret according to its purpose.
	SecretType *string

	// READ-ONLY; Whether the device has been configured with the latest version of the secret.
	SynchronizationStatus *SynchronizationStatus
}

// SecretRotationSummary - Overview of secret rotation for the Network Fabric.
type SecretRotationSummary struct {
	// READ-ONLY; The number of active password sets configured on the devices.
	ActivePasswordSetCount *int64
}
...
type TerminalServerConfiguration struct {
	...
	// READ-ONLY; Secret rotation status for the terminal server's secrets.
	SecretRotationStatus []*SecretRotationStatus
}
...
// UpdateAdministrativeStateResponse - Update Administrative State Response.
type UpdateAdministrativeStateResponse struct {
	// REQUIRED; Operation status.
	Status *string
...
// UpdateAdministrativeStateResponseProperties - Update Administrative State Response Properties.
type UpdateAdministrativeStateResponseProperties struct {
	// List of ARM Resource IDs for which the given action failed to apply.
...
// ViewDeviceConfigurationOperationResponse - View Device Configuration Response V2.
type ViewDeviceConfigurationOperationResponse struct {
	// REQUIRED; Operation status.
	Status *string
...
// ViewDeviceConfigurationResponseProperties - View Device Configuration Response Properties.
type ViewDeviceConfigurationResponseProperties struct {
