...
//     method.
func (client *NeighborGroupsClient) BeginCreate(ctx context.Context, resourceGroupName string, neighborGroupName string, resource NeighborGroup, options *NeighborGroupsClientBeginCreateOptions) (*runtime.Poller[NeighborGroupsClientCreateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.create(ctx, resourceGroupName, neighborGroupName, resource, options)
		if err != nil {
			return nil, err
		}
...
//
// Generated from API version 2024-06-15-preview
func (client *NeighborGroupsClient) create(ctx context.Context, resourceGroupName string, neighborGroupName string, resource NeighborGroup, options *NeighborGroupsClientBeginCreateOptions) (*http.Response, error) {
	var err error
	const operationName = "NeighborGroupsClient.BeginCreate"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.createCreateRequest(ctx, resourceGroupName, neighborGroupName, resource, options)
	if err != nil {
		return nil, err
	}
...
func (client *NeighborGroupsClient) createCreateRequest(ctx context.Context, resourceGroupName string, neighborGroupName string, resource NeighborGroup, _ *NeighborGroupsClientBeginCreateOptions) (*policy.Request, error) {
...
func (client *NeighborGroupsClient) listByResourceGroupHandleResponse(resp *http.Response) (NeighborGroupsClientListByResourceGroupResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.NeighborGroupListResult); err != nil {
		return NeighborGroupsClientListByResourceGroupResponse{}, err
	}
	return result, nil
}
...
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - neighborGroupName - Name of the Neighbor Group.
//   - properties - Neighbor Group properties to update. Only annotations are supported.
//   - options - NeighborGroupsClientBeginUpdateOptions contains the optional parameters for the NeighborGroupsClient.BeginUpdate
//     method.
func (client *NeighborGroupsClient) BeginUpdate(ctx context.Context, resourceGroupName string, neighborGroupName string, properties NeighborGroupPatch, options *NeighborGroupsClientBeginUpdateOptions) (*runtime.Poller[NeighborGroupsClientUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.update(ctx, resourceGroupName, neighborGroupName, properties, options)
		if err != nil {
			return nil, err
		}
...
//
// Generated from API version 2024-06-15-preview
func (client *NeighborGroupsClient) update(ctx context.Context, resourceGroupName string, neighborGroupName string, properties NeighborGroupPatch, options *NeighborGroupsClientBeginUpdateOptions) (*http.Response, error) {
	var err error
	const operationName = "NeighborGroupsClient.BeginUpdate"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.updateCreateRequest(ctx, resourceGroupName, neighborGroupName, properties, options)
	if err != nil {
		return nil, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
...
func (client *NeighborGroupsClient) updateCreateRequest(ctx context.Context, resourceGroupName string, neighborGroupName string, properties NeighborGroupPatch, _ *NeighborGroupsClientBeginUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedNetworkFabric/neighborGroups/{neighborGroupName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
