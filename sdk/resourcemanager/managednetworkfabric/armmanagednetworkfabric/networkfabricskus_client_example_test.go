...
// Generated from example definition: 2024-06-15-preview/NetworkFabricSkus_Get.json
func ExampleNetworkFabricSKUsClient_Get() {
	...
	res, err := clientFactory.NewNetworkFabricSKUsClient().Get(ctx, "wxample-fabricsku", nil)
	if err != nil {
...
// Generated from example definition: 2024-06-15-preview/NetworkFabricSkus_ListBySubscription.json
func ExampleNetworkFabricSKUsClient_NewListBySubscriptionPager() {
	...
	for pager.More() {
		...
		// page = armmanagednetworkfabric.NetworkFabricSKUsClientListBySubscriptionResponse{
		// 	NetworkFabricSKUsListResult: armmanagednetworkfabric.NetworkFabricSKUsListResult{
