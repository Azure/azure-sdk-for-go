...
// Generated from example definition: 2024-06-15-preview/NetworkPacketBrokers_Create.json
...
// Generated from example definition: 2024-06-15-preview/NetworkPacketBrokers_Delete.json
func ExampleNetworkPacketBrokersClient_BeginDelete() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
...
// Generated from example definition: 2024-06-15-preview/NetworkPacketBrokers_Get.json
func ExampleNetworkPacketBrokersClient_Get() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
...
// Generated from example definition: 2024-06-15-preview/NetworkPacketBrokers_ListByResourceGroup.json
func ExampleNetworkPacketBrokersClient_NewListByResourceGroupPager() {
	...
	for pager.More() {
		...
		// 	NetworkPacketBrokerListResult: armmanagednetworkfabric.NetworkPacketBrokerListResult{
...
// Generated from example definition: 2024-06-15-preview/NetworkPacketBrokers_ListBySubscription.json
func ExampleNetworkPacketBrokersClient_NewListBySubscriptionPager() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	for pager.More() {
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armmanagednetworkfabric.NetworkPacketBrokersClientListBySubscriptionResponse{
		// 	NetworkPacketBrokerListResult: armmanagednetworkfabric.NetworkPacketBrokerListResult{
		// 		Value: []*armmanagednetworkfabric.NetworkPacketBroker{
		// 			{
		// 				Properties: &armmanagednetworkfabric.NetworkPacketBrokerProperties{
...
// Generated from example definition: 2024-06-15-preview/NetworkPacketBrokers_Update.json
func ExampleNetworkPacketBrokersClient_BeginUpdate() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
