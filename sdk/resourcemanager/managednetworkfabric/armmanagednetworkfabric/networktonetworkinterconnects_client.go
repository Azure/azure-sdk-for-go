...
func (client *NetworkToNetworkInterconnectsClient) getHandleResponse(resp *http.Response, successCodes ...int) (NetworkToNetworkInterconnectsClientGetResponse, error) {
...
func (client *NetworkToNetworkInterconnectsClient) NewListByNetworkFabricPager(resourceGroupName string, networkFabricName string, options *NetworkToNetworkInterconnectsClientListByNetworkFabricOptions) *runtime.Pager[NetworkToNetworkInterconnectsClientListByNetworkFabricResponse] {
	return runtime.NewPager(runtime.PagingHandler[NetworkToNetworkInterconnectsClientListByNetworkFabricResponse]{
		...
		Fetcher: func(ctx context.Context, page *NetworkToNetworkInterconnectsClientListByNetworkFabricResponse) (NetworkToNetworkInterconnectsClientListByNetworkFabricResponse, error) {
			...
			req, err := client.listByNetworkFabricCreateRequest(ctx, resourceGroupName, networkFabricName, nextLink, options)
			if err != nil {
			...
			return client.listByNetworkFabricHandleResponse(resp, http.StatusOK)
		},
		Tracer: client.internal.Tracer(),
	})
}
...
func (client *NetworkToNetworkInterconnectsClient) listByNetworkFabricCreateRequest(ctx context.Context, resourceGroupName string, networkFabricName string, nextLink string, _ *NetworkToNetworkInterconnectsClientListByNetworkFabricOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *NetworkToNetworkInterconnectsClient) listByNetworkFabricHandleResponse(resp *http.Response, successCodes ...int) (NetworkToNetworkInterconnectsClientListByNetworkFabricResponse, error) {
...
func (client *NetworkToNetworkInterconnectsClient) BeginUpdateBfdAdministrativeState(ctx context.Context, resourceGroupName string, networkFabricName string, networkToNetworkInterconnectName string, body NniUpdateBfdAdministrativeStateRequest, options *NetworkToNetworkInterconnectsClientBeginUpdateBfdAdministrativeStateOptions) (*runtime.Poller[NetworkToNetworkInterconnectsClientUpdateBfdAdministrativeStateResponse], error) {
	if options == nil || options.ResumeToken == "" {
