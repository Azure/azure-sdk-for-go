...
func ExampleNetworkToNetworkInterconnectsClient_BeginUpdateBfdAdministrativeState() {
	...
	poller, err := clientFactory.NewNetworkToNetworkInterconnectsClient().BeginUpdateBfdAdministrativeState(ctx, "example-rg", "example-nf", "example-nni", armmanagednetworkfabric.NniUpdateBfdAdministrativeStateRequest{
