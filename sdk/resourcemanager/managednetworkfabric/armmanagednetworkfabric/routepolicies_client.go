...
//     method.
func (client *RoutePoliciesClient) BeginCreate(ctx context.Context, resourceGroupName string, routePolicyName string, resource RoutePolicy, options *RoutePoliciesClientBeginCreateOptions) (*runtime.Poller[RoutePoliciesClientCreateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.create(ctx, resourceGroupName, routePolicyName, resource, options)
		if err != nil {
			return nil, err
		}
...
//
// Generated from API version 2024-06-15-preview
func (client *RoutePoliciesClient) create(ctx context.Context, resourceGroupName string, routePolicyName string, resource RoutePolicy, options *RoutePoliciesClientBeginCreateOptions) (*http.Response, error) {
	var err error
	const operationName = "RoutePoliciesClient.BeginCreate"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.createCreateRequest(ctx, resourceGroupName, routePolicyName, resource, options)
	if err != nil {
		return nil, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
...
func (client *RoutePoliciesClient) createCreateRequest(ctx context.Context, resourceGroupName string, routePolicyName string, resource RoutePolicy, _ *RoutePoliciesClientBeginCreateOptions) (*policy.Request, error) {
...
func (client *RoutePoliciesClient) listByResourceGroupHandleResponse(resp *http.Response) (RoutePoliciesClientListByResourceGroupResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.RoutePolicyListResult); err != nil {
		return RoutePoliciesClientListByResourceGroupResponse{}, err
	}
	return result, nil
}
...
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - routePolicyName - Name of the Route Policy.
//   - properties - Route Policy properties to update.
//   - options - RoutePoliciesClientBeginUpdateOptions contains the optional parameters for the RoutePoliciesClient.BeginUpdate
//     method.
func (client *RoutePoliciesClient) BeginUpdate(ctx context.Context, resourceGroupName string, routePolicyName string, properties RoutePolicyPatch, options *RoutePoliciesClientBeginUpdateOptions) (*runtime.Poller[RoutePoliciesClientUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.update(ctx, resourceGroupName, routePolicyName, properties, options)
		if err != nil {
			return nil, err
		}
...
//
// Generated from API version 2024-06-15-preview
func (client *RoutePoliciesClient) update(ctx context.Context, resourceGroupName string, routePolicyName string, properties RoutePolicyPatch, options *RoutePoliciesClientBeginUpdateOptions) (*http.Response, error) {
	var err error
	const operationName = "RoutePoliciesClient.BeginUpdate"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.updateCreateRequest(ctx, resourceGroupName, routePolicyName, properties, options)
	if err != nil {
		return nil, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
...
func (client *RoutePoliciesClient) updateCreateRequest(ctx context.Context, resourceGroupName string, routePolicyName string, properties RoutePolicyPatch, _ *RoutePoliciesClientBeginUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedNetworkFabric/routePolicies/{routePolicyName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
