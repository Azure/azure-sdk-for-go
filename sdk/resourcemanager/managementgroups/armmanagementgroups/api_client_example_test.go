...
func ExampleAPIClient_CheckNameAvailability() {
	...
	// res = armmanagementgroups.APIClientCheckNameAvailabilityResponse{
...
func ExampleAPIClient_StartTenantBackfill() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armmanagementgroups.APIClientStartTenantBackfillResponse{
...
func ExampleAPIClient_TenantBackfillStatus() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armmanagementgroups.APIClientTenantBackfillStatusResponse{
	// 	TenantBackfillStatusResult: armmanagementgroups.TenantBackfillStatusResult{
	// 		Status: to.Ptr(armmanagementgroups.StatusStarted),
	// 		TenantID: to.Ptr("20000000-0000-0000-0000-000000000000"),
	// 	},
