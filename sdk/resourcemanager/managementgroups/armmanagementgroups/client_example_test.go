...
func ExampleClient_BeginCreateOrUpdate() {
	...
	// 				UpdatedTime: to.Ptr(time.Date(2018, time.January, 1, 0, 0, 0, 0, time.UTC)),
...
func ExampleClient_Get_getManagementGroupsWithExpandAndRecurse() {
	...
	// 				UpdatedTime: to.Ptr(time.Date(2018, time.January, 25, 2, 26, 49, 2209300, time.UTC)),
...
func ExampleClient_Update() {
	...
	// 				},
	// 				UpdatedBy: to.Ptr("bd490e30-04cb-433e-b8c8-6066959a8bab"),
	// 				UpdatedTime: to.Ptr(time.Date(2018, time.January, 25, 2, 46, 59, 54564500, time.UTC)),
	// 				Version: to.Ptr[int32](2),
	// 			},
	// 		},
	// 	},
