...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	switch client {
	case "APIClient":
		initServer(&s.trMu, &s.trAPIServer, func() *APIServerTransport { return NewAPIServerTransport(&s.srv.APIServer) })
	...
	case "HierarchySettingsClient":
		initServer(&s.trMu, &s.trHierarchySettingsServer, func() *HierarchySettingsServerTransport {
	...
	case "ManagementGroupSubscriptionsClient":
		initServer(&s.trMu, &s.trManagementGroupSubscriptionsServer, func() *ManagementGroupSubscriptionsServerTransport {
