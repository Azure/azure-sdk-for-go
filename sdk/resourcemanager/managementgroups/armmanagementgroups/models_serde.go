...
func (c CreateManagementGroupDetails) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "updatedTime", c.UpdatedTime, true)
...
func (c *CreateManagementGroupDetails) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "updatedBy":
			...
			delete(rawMsg, key)
		case "updatedTime":
			err = unpopulateTime[datetime.RFC3339](val, "UpdatedTime", &c.UpdatedTime)
			delete(rawMsg, key)
		case "version":
...
func (m ManagementGroupDetails) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "updatedTime", m.UpdatedTime, true)
...
func (m *ManagementGroupDetails) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "updatedBy":
			...
			delete(rawMsg, key)
		case "updatedTime":
			err = unpopulateTime[datetime.RFC3339](val, "UpdatedTime", &m.UpdatedTime)
			delete(rawMsg, key)
		case "version":
