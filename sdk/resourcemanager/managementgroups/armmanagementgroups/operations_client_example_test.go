...
// Generated from example definition: 2023-04-01/ListOperations.json
func ExampleOperationsClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armmanagementgroups.OperationsClientListResponse{
		// 	OperationListResult: armmanagementgroups.OperationListResult{
		// 		NextLink: to.Ptr("aaaaaaaaaaaaaaaaaaa"),
		// 		Value: []*armmanagementgroups.Operation{
		// 			{
		// 				Name: to.Ptr("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"),
		// 				Display: &armmanagementgroups.OperationDisplay{
