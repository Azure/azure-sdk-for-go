...
// The returned OperationServerTransport instance is connected to an instance of armmanagementpartner.OperationClient via the
...
func NewOperationServerTransport(srv *OperationServer) *OperationServerTransport {
	return &OperationServerTransport{
		srv:          srv,
		newListPager: newTracker[azfake.PagerResponder[armmanagementpartner.OperationClientListResponse]](),
	}
}

// OperationServerTransport connects instances of armmanagementpartner.OperationClient to instances of OperationServer.
// Don't use this type directly, use NewOperationServerTransport instead.
type OperationServerTransport struct {
	srv          *OperationServer
	newListPager *tracker[azfake.PagerResponder[armmanagementpartner.OperationClientListResponse]]
}
...
func (o *OperationServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armmanagementpartner.OperationClientListResponse, createLink func() string) {
