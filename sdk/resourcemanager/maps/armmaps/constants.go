...
// SigningKey - The Maps account key to use for signing. Picking `primaryKey` or `secondaryKey` will use the Maps account
// Shared Keys, and using `managedIdentity` will use the auto-renewed private key to sign the SAS.
type SigningKey string

const (
	// SigningKeyManagedIdentity - managedIdentity
	SigningKeyManagedIdentity SigningKey = "managedIdentity"
	// SigningKeyPrimaryKey - primaryKey
	SigningKeyPrimaryKey SigningKey = "primaryKey"
	// SigningKeySecondaryKey - secondaryKey
