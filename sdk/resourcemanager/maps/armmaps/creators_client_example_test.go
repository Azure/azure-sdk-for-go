...
// Generated from example definition: 2025-10-01-preview/DeleteMapsCreator.json
func ExampleCreatorsClient_Delete() {
	...
	res, err := clientFactory.NewCreatorsClient().Delete(ctx, "myResourceGroup", "myMapsAccount", "myCreator", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armmaps.CreatorsClientDeleteResponse{
	// }
}

// Generated from example definition: 2025-10-01-preview/GetMapsCreator.json
...
// Generated from example definition: 2025-10-01-preview/UpdateMapsCreator.json
