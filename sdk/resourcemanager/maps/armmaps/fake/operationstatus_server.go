...
// OperationStatusServer is a fake server for instances of the armmaps.OperationStatusClient type.
type OperationStatusServer struct {
	// Get is the fake for method OperationStatusClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, location string, operationID string, options *armmaps.OperationStatusClientGetOptions) (resp azfake.Responder[armmaps.OperationStatusClientGetResponse], errResp azfake.ErrorResponder)
}
...
// The returned OperationStatusServerTransport instance is connected to an instance of armmaps.OperationStatusClient via the
...
// OperationStatusServerTransport connects instances of armmaps.OperationStatusClient to instances of OperationStatusServer.
...
func (o *OperationStatusServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.Maps/locations/(?P<location>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/operationStatuses/(?P<operationId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)`
