...
func (client *OperationResultClient) Get(ctx context.Context, location string, operationID string, options *OperationResultClientGetOptions) (OperationResultClientGetResponse, error) {
	var err error
	const operationName = "OperationResultClient.Get"
...
func (client *OperationResultClient) getCreateRequest(ctx context.Context, location string, operationID string, _ *OperationResultClientGetOptions) (*policy.Request, error) {
