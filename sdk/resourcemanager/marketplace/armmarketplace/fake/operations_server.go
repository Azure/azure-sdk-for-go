...
type OperationsServer struct {
	...
	NewListPager func(options *armmarketplace.OperationsClientListOptions) (resp azfake.PagerResponder[armmarketplace.OperationsClientListResponse])
}
...
func NewOperationsServerTransport(srv *OperationsServer) *OperationsServerTransport {
	return &OperationsServerTransport{
		srv:		srv,
		newListPager:	newTracker[azfake.PagerResponder[armmarketplace.OperationsClientListResponse]](),
	}
}
...
type OperationsServerTransport struct {
	...
	newListPager	*tracker[azfake.PagerResponder[armmarketplace.OperationsClientListResponse]]
}
...
func (o *OperationsServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armmarketplace.OperationsClientListResponse, createLink func() string) {
