...
type PrivateStoreServer struct {
	...
	// NewAdminRequestApprovalsListPager is the fake for method PrivateStoreClient.NewAdminRequestApprovalsListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewAdminRequestApprovalsListPager	func(privateStoreID string, options *armmarketplace.PrivateStoreClientAdminRequestApprovalsListOptions) (resp azfake.PagerResponder[armmarketplace.PrivateStoreClientAdminRequestApprovalsListResponse])
	...
	// NewGetApprovalRequestsListPager is the fake for method PrivateStoreClient.NewGetApprovalRequestsListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewGetApprovalRequestsListPager	func(privateStoreID string, options *armmarketplace.PrivateStoreClientGetApprovalRequestsListOptions) (resp azfake.PagerResponder[armmarketplace.PrivateStoreClientGetApprovalRequestsListResponse])
...
func NewPrivateStoreServerTransport(srv *PrivateStoreServer) *PrivateStoreServerTransport {
	return &PrivateStoreServerTransport{
		srv:					srv,
		newAdminRequestApprovalsListPager:	newTracker[azfake.PagerResponder[armmarketplace.PrivateStoreClientAdminRequestApprovalsListResponse]](),
		newGetApprovalRequestsListPager:	newTracker[azfake.PagerResponder[armmarketplace.PrivateStoreClientGetApprovalRequestsListResponse]](),
...
type PrivateStoreServerTransport struct {
	...
	newAdminRequestApprovalsListPager	*tracker[azfake.PagerResponder[armmarketplace.PrivateStoreClientAdminRequestApprovalsListResponse]]
	newGetApprovalRequestsListPager		*tracker[azfake.PagerResponder[armmarketplace.PrivateStoreClientGetApprovalRequestsListResponse]]
...
func (p *PrivateStoreServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		if !intercepted {
			...
			case "PrivateStoreClient.NewAdminRequestApprovalsListPager":
				res.resp, res.err = p.dispatchNewAdminRequestApprovalsListPager(req)
			...
			case "PrivateStoreClient.NewGetApprovalRequestsListPager":
				res.resp, res.err = p.dispatchNewGetApprovalRequestsListPager(req)
...
func (p *PrivateStoreServerTransport) dispatchNewAdminRequestApprovalsListPager(req *http.Request) (*http.Response, error) {
	if p.srv.NewAdminRequestApprovalsListPager == nil {
		return nil, &nonRetriableError{errors.New("fake for method NewAdminRequestApprovalsListPager not implemented")}
	}
	newAdminRequestApprovalsListPager := p.newAdminRequestApprovalsListPager.get(req)
	if newAdminRequestApprovalsListPager == nil {
		...
		resp := p.srv.NewAdminRequestApprovalsListPager(privateStoreIDParam, nil)
		newAdminRequestApprovalsListPager = &resp
		p.newAdminRequestApprovalsListPager.add(req, newAdminRequestApprovalsListPager)
	}
	resp, err := server.PagerResponderNext(newAdminRequestApprovalsListPager, req)
	if err != nil {
		return nil, err
	}
	if !contains([]int{http.StatusOK}, resp.StatusCode) {
		p.newAdminRequestApprovalsListPager.remove(req)
		return nil, &nonRetriableError{fmt.Errorf("unexpected status code %d. acceptable values are http.StatusOK", resp.StatusCode)}
	}
	if !server.PagerResponderMore(newAdminRequestApprovalsListPager) {
		p.newAdminRequestApprovalsListPager.remove(req)
	}
	return resp, nil
}
...
func (p *PrivateStoreServerTransport) dispatchNewGetApprovalRequestsListPager(req *http.Request) (*http.Response, error) {
	if p.srv.NewGetApprovalRequestsListPager == nil {
		return nil, &nonRetriableError{errors.New("fake for method NewGetApprovalRequestsListPager not implemented")}
	}
	newGetApprovalRequestsListPager := p.newGetApprovalRequestsListPager.get(req)
	if newGetApprovalRequestsListPager == nil {
		...
		resp := p.srv.NewGetApprovalRequestsListPager(privateStoreIDParam, nil)
		newGetApprovalRequestsListPager = &resp
		p.newGetApprovalRequestsListPager.add(req, newGetApprovalRequestsListPager)
	}
	resp, err := server.PagerResponderNext(newGetApprovalRequestsListPager, req)
	if err != nil {
		return nil, err
	}
	if !contains([]int{http.StatusOK}, resp.StatusCode) {
		p.newGetApprovalRequestsListPager.remove(req)
		return nil, &nonRetriableError{fmt.Errorf("unexpected status code %d. acceptable values are http.StatusOK", resp.StatusCode)}
	}
	if !server.PagerResponderMore(newGetApprovalRequestsListPager) {
		p.newGetApprovalRequestsListPager.remove(req)
	}
	return resp, nil
}
