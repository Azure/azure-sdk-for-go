...
type PrivateStoreCollectionServer struct {
	...
	// HTTP status codes to indicate success: http.StatusOK
	CreateOrUpdate func(ctx context.Context, privateStoreID string, collectionID string, payload armmarketplace.Collection, options *armmarketplace.PrivateStoreCollectionClientCreateOrUpdateOptions) (resp azfake.Responder[armmarketplace.PrivateStoreCollectionClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)
...
func (p *PrivateStoreCollectionServerTransport) dispatchCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := p.srv.CreateOrUpdate(req.Context(), privateStoreIDParam, collectionIDParam, body, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (p *PrivateStoreCollectionServerTransport) dispatchPost(req *http.Request) (*http.Response, error) {
	...
	if !reflect.ValueOf(body).IsZero() {
		bodyOp := armmarketplace.Operation(body)
