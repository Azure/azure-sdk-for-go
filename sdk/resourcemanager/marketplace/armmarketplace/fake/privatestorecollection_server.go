...
type PrivateStoreCollectionServer struct {
	...
	// NewListPager is the fake for method PrivateStoreCollectionClient.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager	func(privateStoreID string, options *armmarketplace.PrivateStoreCollectionClientListOptions) (resp azfake.PagerResponder[armmarketplace.PrivateStoreCollectionClientListResponse])
...
func NewPrivateStoreCollectionServerTransport(srv *PrivateStoreCollectionServer) *PrivateStoreCollectionServerTransport {
	return &PrivateStoreCollectionServerTransport{
		srv:		srv,
		newListPager:	newTracker[azfake.PagerResponder[armmarketplace.PrivateStoreCollectionClientListResponse]](),
	}
}
...
type PrivateStoreCollectionServerTransport struct {
	...
	newListPager	*tracker[azfake.PagerResponder[armmarketplace.PrivateStoreCollectionClientListResponse]]
}
...
func (p *PrivateStoreCollectionServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		if !intercepted {
			...
			case "PrivateStoreCollectionClient.NewListPager":
...
func (p *PrivateStoreCollectionServerTransport) dispatchCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := p.srv.CreateOrUpdate(req.Context(), privateStoreIDParam, collectionIDParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (p *PrivateStoreCollectionServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		resp := p.srv.NewListPager(privateStoreIDParam, nil)
		newListPager = &resp
