...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "PrivateStoreClient":
		initServer(&s.trMu, &s.trPrivateStoreServer, func() *PrivateStoreServerTransport { return NewPrivateStoreServerTransport(&s.srv.PrivateStoreServer) })
	...
	case "RPServiceClient":
		initServer(&s.trMu, &s.trRPServiceServer, func() *RPServiceServerTransport { return NewRPServiceServerTransport(&s.srv.RPServiceServer) })
