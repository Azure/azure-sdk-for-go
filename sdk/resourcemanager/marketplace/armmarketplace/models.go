...
type CollectionOffersByContextList struct {
	...
	// READ-ONLY; aaaaaaaaaaaaaaaaaaaaaaaa
...
type CollectionsToSubscriptionsMappingResponse struct {
	...
	Details *CollectionsToSubscriptionsMappingResponseProperties
}

// CollectionsToSubscriptionsMappingResponseProperties - Collections - subscriptions mapping details, map key is collectionId.
// In case subscriptions list is null or empty: no subscription from the list is related to that collection.
type CollectionsToSubscriptionsMappingResponseProperties struct {
	AdditionalProperties map[string]*CollectionsSubscriptionsMappingDetails
}
...
// OperationListResult - aaaaaaaaaaaaaaaaaaaaa
type OperationListResult struct {
	// aaaaaaaaaaaaaaaaaaaaaaa
	Value []*SingleOperation

	// READ-ONLY; aaaaaaaaaaaaaaaaaaaaa
	NextLink *string
}
