...
func (c CollectionProperties) MarshalJSON() ([]byte, error) {
	...
	populateTimeRFC3339(objectMap, "approveAllItemsModifiedAt", c.ApproveAllItemsModifiedAt)
...
func (c *CollectionProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "approveAllItemsModifiedAt":
			err = unpopulateTimeRFC3339(val, "ApproveAllItemsModifiedAt", &c.ApproveAllItemsModifiedAt)
			delete(rawMsg, key)
		case "claim":
