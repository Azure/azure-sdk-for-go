...
func (c CollectionProperties) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "approveAllItemsModifiedAt", c.ApproveAllItemsModifiedAt)
...
func (c *CollectionProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "approveAllItemsModifiedAt":
			err = unpopulateTime[datetime.RFC3339](val, "ApproveAllItemsModifiedAt", &c.ApproveAllItemsModifiedAt)
			delete(rawMsg, key)
		case "claim":
...
// MarshalJSON implements the json.Marshaller interface for type CollectionsToSubscriptionsMappingResponseProperties.
func (c CollectionsToSubscriptionsMappingResponseProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type CollectionsToSubscriptionsMappingResponseProperties.
func (c *CollectionsToSubscriptionsMappingResponseProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
	for key, val := range rawMsg {
		...
		default:
			if c.AdditionalProperties == nil {
				c.AdditionalProperties = map[string]*CollectionsSubscriptionsMappingDetails{}
			}
			if val != nil {
				var aux CollectionsSubscriptionsMappingDetails
...
func (p PlanDetails) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "planId", p.PlanID)
	populateTime[datetime.RFC3339](objectMap, "requestDate", p.RequestDate)
...
func (p *PlanDetails) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "planId":
			...
			delete(rawMsg, key)
		case "requestDate":
			err = unpopulateTime[datetime.RFC3339](val, "RequestDate", &p.RequestDate)
			delete(rawMsg, key)
		case "status":
