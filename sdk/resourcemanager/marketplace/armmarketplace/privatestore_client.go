...
// NewAdminRequestApprovalsListPager - Get list of admin request approvals
//
// Generated from API version 2025-01-01
//   - privateStoreID - The store ID - must use the tenant ID
//   - options - PrivateStoreClientAdminRequestApprovalsListOptions contains the optional parameters for the PrivateStoreClient.NewAdminRequestApprovalsListPager
//     method.
func (client *PrivateStoreClient) NewAdminRequestApprovalsListPager(privateStoreID string, options *PrivateStoreClientAdminRequestApprovalsListOptions) *runtime.Pager[PrivateStoreClientAdminRequestApprovalsListResponse] {
	return runtime.NewPager(runtime.PagingHandler[PrivateStoreClientAdminRequestApprovalsListResponse]{
		More: func(page PrivateStoreClientAdminRequestApprovalsListResponse) bool {
			return false
		},
		Fetcher: func(ctx context.Context, page *PrivateStoreClientAdminRequestApprovalsListResponse) (PrivateStoreClientAdminRequestApprovalsListResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "PrivateStoreClient.NewAdminRequestApprovalsListPager")
...
// NewGetApprovalRequestsListPager - Get all open approval requests of current user
//
// Generated from API version 2025-01-01
//   - privateStoreID - The store ID - must use the tenant ID
//   - options - PrivateStoreClientGetApprovalRequestsListOptions contains the optional parameters for the PrivateStoreClient.NewGetApprovalRequestsListPager
//     method.
func (client *PrivateStoreClient) NewGetApprovalRequestsListPager(privateStoreID string, options *PrivateStoreClientGetApprovalRequestsListOptions) *runtime.Pager[PrivateStoreClientGetApprovalRequestsListResponse] {
	return runtime.NewPager(runtime.PagingHandler[PrivateStoreClientGetApprovalRequestsListResponse]{
		More: func(page PrivateStoreClientGetApprovalRequestsListResponse) bool {
			return false
		},
		Fetcher: func(ctx context.Context, page *PrivateStoreClientGetApprovalRequestsListResponse) (PrivateStoreClientGetApprovalRequestsListResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "PrivateStoreClient.NewGetApprovalRequestsListPager")
