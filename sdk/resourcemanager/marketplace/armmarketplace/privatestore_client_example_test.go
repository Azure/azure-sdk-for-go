...
func ExamplePrivateStoreClient_AcknowledgeOfferNotification() {
	...
	res, err := clientFactory.NewPrivateStoreClient().AcknowledgeOfferNotification(ctx, "a0e28e55-90c4-41d8-8e34-bb7ef7775406", "marketplacetestthirdparty.md-test-third-party-2", &armmarketplace.PrivateStoreClientAcknowledgeOfferNotificationOptions{
		Payload: &armmarketplace.AcknowledgeOfferNotificationProperties{
	...
	// res = armmarketplace.PrivateStoreClientAcknowledgeOfferNotificationResponse{
	// }
}

// Generated from example definition: 2025-01-01/AdminRequestApprovalsList.json
func ExamplePrivateStoreClient_NewAdminRequestApprovalsListPager() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	pager := clientFactory.NewPrivateStoreClient().NewAdminRequestApprovalsListPager("a0e28e55-90c4-41d8-8e34-bb7ef7775406", nil)
	for pager.More() {
		...
		// page = armmarketplace.PrivateStoreClientAdminRequestApprovalsListResponse{
...
// Generated from example definition: 2025-01-01/AnyExistingOffersInTheCollections.json
...
// Generated from example definition: 2025-01-01/BillingAccounts.json
...
// Generated from example definition: 2025-01-01/BulkCollectionsAction.json
func ExamplePrivateStoreClient_BulkCollectionsAction() {
	...
	res, err := clientFactory.NewPrivateStoreClient().BulkCollectionsAction(ctx, "a0e28e55-90c4-41d8-8e34-bb7ef7775406", &armmarketplace.PrivateStoreClientBulkCollectionsActionOptions{
		Payload: &armmarketplace.BulkCollectionsPayload{
...
// Generated from example definition: 2025-01-01/CollectionsToSubscriptionsMapping.json
func ExamplePrivateStoreClient_CollectionsToSubscriptionsMapping() {
	...
	res, err := clientFactory.NewPrivateStoreClient().CollectionsToSubscriptionsMapping(ctx, "a0e28e55-90c4-41d8-8e34-bb7ef7775406", &armmarketplace.PrivateStoreClientCollectionsToSubscriptionsMappingOptions{
		Payload: &armmarketplace.CollectionsToSubscriptionsMappingPayload{
	...
	// 		Details: &armmarketplace.CollectionsToSubscriptionsMappingResponseProperties{
	// 			AdditionalProperties: map[string]*armmarketplace.CollectionsSubscriptionsMappingDetails{
...
func ExamplePrivateStoreClient_CreateApprovalRequest() {
	...
	// 					Justification: to.Ptr("Because I want to...."),
	// 					PlanID: to.Ptr("testPlanA"),
	// 					RequestDate: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2021-02-01T10:23:17.6571572+02:00"); return t}()),
...
// Generated from example definition: 2025-01-01/FetchAllSubscriptionsInTenant.json
func ExamplePrivateStoreClient_FetchAllSubscriptionsInTenant() {
	...
	res, err := clientFactory.NewPrivateStoreClient().FetchAllSubscriptionsInTenant(ctx, "a0e28e55-90c4-41d8-8e34-bb7ef7775406", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
...
// Generated from example definition: 2025-01-01/GetPrivateStore.json
...
// Generated from example definition: 2025-01-01/GetAdminRequestApproval.json
...
func ExamplePrivateStoreClient_NewGetApprovalRequestsListPager() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	pager := clientFactory.NewPrivateStoreClient().NewGetApprovalRequestsListPager("a0e28e55-90c4-41d8-8e34-bb7ef7775406", nil)
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armmarketplace.PrivateStoreClientGetApprovalRequestsListResponse{
...
func ExamplePrivateStoreClient_GetRequestApproval() {
	...
	// 					Justification: to.Ptr("Because I want to...."),
	// 					PlanID: to.Ptr("testPlanA"),
	// 					RequestDate: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2020-10-05T17:18:19.1234567Z"); return t}()),
	// 					Status: to.Ptr(armmarketplace.StatusPending),
	// 					SubscriptionID: to.Ptr(""),
	// 					SubscriptionName: to.Ptr(""),
	// 				},
...
// Generated from example definition: 2025-01-01/GetPrivateStores.json
func ExamplePrivateStoreClient_NewListPager() {
	...
	pager := clientFactory.NewPrivateStoreClient().NewListPager(nil)
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armmarketplace.PrivateStoreClientListResponse{
		// 	PrivateStoreList: armmarketplace.PrivateStoreList{
...
// Generated from example definition: 2025-01-01/ListNewPlansNotifications.json
...
// Generated from example definition: 2025-01-01/ListStopSellOffersPlansNotifications.json
func ExamplePrivateStoreClient_ListStopSellOffersPlansNotifications() {
	...
	res, err := clientFactory.NewPrivateStoreClient().ListStopSellOffersPlansNotifications(ctx, "a0e28e55-90c4-41d8-8e34-bb7ef7775406", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
...
// Generated from example definition: 2025-01-01/NotificationsState.json
...
// Generated from example definition: 2025-01-01/QueryOffers.json
...
// Generated from example definition: 2025-01-01/UpdateAdminRequestApproval.json
func ExamplePrivateStoreClient_UpdateAdminRequestApproval() {
	...
	res, err := clientFactory.NewPrivateStoreClient().UpdateAdminRequestApproval(ctx, "a0e28e55-90c4-41d8-8e34-bb7ef7775406", "marketplacetestthirdparty.md-test-third-party-2", armmarketplace.AdminRequestApprovalsResource{
		Properties: &armmarketplace.AdminRequestApprovalProperties{
...
// Generated from example definition: 2025-01-01/WithdrawPlan.json
func ExamplePrivateStoreClient_WithdrawPlan() {
	...
	res, err := clientFactory.NewPrivateStoreClient().WithdrawPlan(ctx, "a0e28e55-90c4-41d8-8e34-bb7ef7775406", "marketplacetestthirdparty.md-test-third-party-2", &armmarketplace.PrivateStoreClientWithdrawPlanOptions{
		Payload: &armmarketplace.WithdrawProperties{
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armmarketplace.PrivateStoreClientWithdrawPlanResponse{
	// }
}
