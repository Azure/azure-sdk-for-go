...
func (client *PrivateStoreCollectionClient) createOrUpdateCreateRequest(ctx context.Context, privateStoreID string, collectionID string, _ *PrivateStoreCollectionClientCreateOrUpdateOptions) (*policy.Request, error) {
...
// NewListPager - Gets private store collections list
//
// Generated from API version 2025-01-01
//   - privateStoreID - The store ID - must use the tenant ID
//   - options - PrivateStoreCollectionClientListOptions contains the optional parameters for the PrivateStoreCollectionClient.NewListPager
//     method.
func (client *PrivateStoreCollectionClient) NewListPager(privateStoreID string, options *PrivateStoreCollectionClientListOptions) *runtime.Pager[PrivateStoreCollectionClientListResponse] {
	return runtime.NewPager(runtime.PagingHandler[PrivateStoreCollectionClientListResponse]{
		More: func(page PrivateStoreCollectionClientListResponse) bool {
			return false
		},
		Fetcher: func(ctx context.Context, page *PrivateStoreCollectionClientListResponse) (PrivateStoreCollectionClientListResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "PrivateStoreCollectionClient.NewListPager")
