...
func (client *PrivateStoreCollectionOfferClient) ContextsView(ctx context.Context, privateStoreID string, collectionID string, offerID string, options *PrivateStoreCollectionOfferClientContextsViewOptions) (PrivateStoreCollectionOfferClientContextsViewResponse, error) {
	...
	return client.contextsViewHandleResponse(httpResp, http.StatusOK)
}
...
func (client *PrivateStoreCollectionOfferClient) contextsViewHandleResponse(resp *http.Response, successCodes ...int) (PrivateStoreCollectionOfferClientContextsViewResponse, error) {
...
func (client *PrivateStoreCollectionOfferClient) createOrUpdateCreateRequest(ctx context.Context, privateStoreID string, collectionID string, offerID string, payload Offer, _ *PrivateStoreCollectionOfferClientCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *PrivateStoreCollectionOfferClient) createOrUpdateHandleResponse(resp *http.Response, successCodes ...int) (PrivateStoreCollectionOfferClientCreateOrUpdateResponse, error) {
...
func (client *PrivateStoreCollectionOfferClient) Delete(ctx context.Context, privateStoreID string, collectionID string, offerID string, options *PrivateStoreCollectionOfferClientDeleteOptions) (PrivateStoreCollectionOfferClientDeleteResponse, error) {
	...
	if !runtime.HasStatusCode(httpResp, http.StatusOK, http.StatusNoContent) {
		return PrivateStoreCollectionOfferClientDeleteResponse{}, runtime.NewResponseError(httpResp)
	}
...
func (client *PrivateStoreCollectionOfferClient) getHandleResponse(resp *http.Response, successCodes ...int) (PrivateStoreCollectionOfferClientGetResponse, error) {
...
func (client *PrivateStoreCollectionOfferClient) NewListPager(privateStoreID string, collectionID string, options *PrivateStoreCollectionOfferClientListOptions) *runtime.Pager[PrivateStoreCollectionOfferClientListResponse] {
	return runtime.NewPager(runtime.PagingHandler[PrivateStoreCollectionOfferClientListResponse]{
		...
		Fetcher: func(ctx context.Context, page *PrivateStoreCollectionOfferClientListResponse) (PrivateStoreCollectionOfferClientListResponse, error) {
			...
			req, err := client.listCreateRequest(ctx, privateStoreID, collectionID, nextLink, options)
			if err != nil {
...
func (client *PrivateStoreCollectionOfferClient) listCreateRequest(ctx context.Context, privateStoreID string, collectionID string, nextLink string, _ *PrivateStoreCollectionOfferClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *PrivateStoreCollectionOfferClient) listHandleResponse(resp *http.Response, successCodes ...int) (PrivateStoreCollectionOfferClientListResponse, error) {
...
func (client *PrivateStoreCollectionOfferClient) NewListByContextsPager(privateStoreID string, collectionID string, options *PrivateStoreCollectionOfferClientListByContextsOptions) *runtime.Pager[PrivateStoreCollectionOfferClientListByContextsResponse] {
	return runtime.NewPager(runtime.PagingHandler[PrivateStoreCollectionOfferClientListByContextsResponse]{
		...
		Fetcher: func(ctx context.Context, page *PrivateStoreCollectionOfferClientListByContextsResponse) (PrivateStoreCollectionOfferClientListByContextsResponse, error) {
			...
			req, err := client.listByContextsCreateRequest(ctx, privateStoreID, collectionID, nextLink, options)
			if err != nil {
			...
			return client.listByContextsHandleResponse(resp, http.StatusOK)
		},
		Tracer: client.internal.Tracer(),
	})
}
...
func (client *PrivateStoreCollectionOfferClient) listByContextsCreateRequest(ctx context.Context, privateStoreID string, collectionID string, nextLink string, options *PrivateStoreCollectionOfferClientListByContextsOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
	var req *policy.Request
	var err error
	if firstPage {
...
func (client *PrivateStoreCollectionOfferClient) listByContextsHandleResponse(resp *http.Response, successCodes ...int) (PrivateStoreCollectionOfferClientListByContextsResponse, error) {
...
func (client *PrivateStoreCollectionOfferClient) Post(ctx context.Context, privateStoreID string, collectionID string, offerID string, options *PrivateStoreCollectionOfferClientPostOptions) (PrivateStoreCollectionOfferClientPostResponse, error) {
	...
	if !runtime.HasStatusCode(httpResp, http.StatusOK) {
		return PrivateStoreCollectionOfferClientPostResponse{}, runtime.NewResponseError(httpResp)
	}
...
func (client *PrivateStoreCollectionOfferClient) UpsertOfferWithMultiContext(ctx context.Context, privateStoreID string, collectionID string, offerID string, options *PrivateStoreCollectionOfferClientUpsertOfferWithMultiContextOptions) (PrivateStoreCollectionOfferClientUpsertOfferWithMultiContextResponse, error) {
	...
	return client.upsertOfferWithMultiContextHandleResponse(httpResp, http.StatusOK)
}
...
func (client *PrivateStoreCollectionOfferClient) upsertOfferWithMultiContextHandleResponse(resp *http.Response, successCodes ...int) (PrivateStoreCollectionOfferClientUpsertOfferWithMultiContextResponse, error) {
