...
The `armmarketplacereviews` module provides operations for working with Azure Marketplace.

[Source code](https://github.com/Azure/azure-sdk-for-go/tree/main/sdk/resourcemanager/marketplace/armmarketplacereviews)
...
```sh
go get github.com/Azure/azure-sdk-for-go/sdk/resourcemanager/marketplace/armmarketplacereviews
```
...
clientFactory, err := armmarketplacereviews.NewClientFactory(cred, &options)
```
...
```go
client := clientFactory.NewRatingAndReviewsOperationsClient()
```
