...
// MarshalJSON implements the json.Marshaller interface for type UserHasReview.
func (u UserHasReview) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type UserHasReview.
func (u *UserHasReview) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
...
// MarshalJSON implements the json.Marshaller interface for type UserHasReviewProperties.
func (u UserHasReviewProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "hasReview", u.HasReview)
	populate(objectMap, "updatedAt", u.UpdatedAt)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type UserHasReviewProperties.
func (u *UserHasReviewProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %s", u, err.Error())
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "hasReview":
			err = unpopulate(val, "HasReview", &u.HasReview)
			delete(rawMsg, key)
		case "updatedAt":
			err = unpopulate(val, "UpdatedAt", &u.UpdatedAt)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %s", u, err.Error())
