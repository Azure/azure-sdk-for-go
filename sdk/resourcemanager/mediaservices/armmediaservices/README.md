...
```go
client, err := armmediaservices.NewMediaservicesClient(<subscription ID>, cred, nil)
```
...
client, err := armmediaservices.NewMediaservicesClient(<subscription ID>, cred, &options)
```
