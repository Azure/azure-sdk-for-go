...
// The returned ServerFactoryTransport instance is connected to an instance of armmigrationdiscoverysap.ClientFactory via the
...
// ServerFactoryTransport connects instances of armmigrationdiscoverysap.ClientFactory to instances of ServerFactory.
...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "SapDiscoverySitesClient":
		initServer(s, &s.trSapDiscoverySitesServer, func() *SapDiscoverySitesServerTransport {
	...
	case "SapInstancesClient":
		initServer(s, &s.trSapInstancesServer, func() *SapInstancesServerTransport { return NewSapInstancesServerTransport(&s.srv.SapInstancesServer) })
		resp, err = s.trSapInstancesServer.Do(req)
	case "ServerInstancesClient":
		initServer(s, &s.trServerInstancesServer, func() *ServerInstancesServerTransport {
