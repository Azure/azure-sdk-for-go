...
// The returned ServerFactoryTransport instance is connected to an instance of armmixedreality.ClientFactory via the
...
// ServerFactoryTransport connects instances of armmixedreality.ClientFactory to instances of ServerFactory.
...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "RemoteRenderingAccountsClient":
		initServer(s, &s.trRemoteRenderingAccountsServer, func() *RemoteRenderingAccountsServerTransport {
