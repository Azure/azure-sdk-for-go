...
- Field `Location`, `Tags` of struct `ResourceAutoGenerated4` has been removed
- Field `SystemData` of struct `ResourceAutoGenerated5` has been removed
- Field `RuleResolveConfiguration` of struct `ScheduledQueryRuleProperties` has been removed
...
- New field `Location`, `Tags` in struct `ResourceAutoGenerated5`
