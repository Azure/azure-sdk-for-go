...
// Create - Creates or updates an Azure Monitor Workspace
...
//   - azureMonitorWorkspaceProperties - Properties that need to be specified to create a new Azure Monitor Workspace
...
func (client *AzureMonitorWorkspacesClient) createCreateRequest(ctx context.Context, resourceGroupName string, azureMonitorWorkspaceName string, azureMonitorWorkspaceProperties AzureMonitorWorkspaceResource, _ *AzureMonitorWorkspacesClientCreateOptions) (*policy.Request, error) {
