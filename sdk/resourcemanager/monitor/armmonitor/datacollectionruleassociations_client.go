...
func (client *DataCollectionRuleAssociationsClient) listByRuleCreateRequest(ctx context.Context, resourceGroupName string, dataCollectionRuleName string, _ *DataCollectionRuleAssociationsClientListByRuleOptions) (*policy.Request, error) {
