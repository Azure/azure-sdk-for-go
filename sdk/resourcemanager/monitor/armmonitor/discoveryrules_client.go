...
//     method.
func (client *DiscoveryRulesClient) CreateOrUpdate(ctx context.Context, resourceGroupName string, azureMonitorWorkspaceName string, healthModelName string, discoveryRuleName string, resource DiscoveryRule, options *DiscoveryRulesClientCreateOrUpdateOptions) (DiscoveryRulesClientCreateOrUpdateResponse, error) {
	var err error
	const operationName = "DiscoveryRulesClient.CreateOrUpdate"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.createOrUpdateCreateRequest(ctx, resourceGroupName, azureMonitorWorkspaceName, healthModelName, discoveryRuleName, resource, options)
	if err != nil {
...
func (client *DiscoveryRulesClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, azureMonitorWorkspaceName string, healthModelName string, discoveryRuleName string, resource DiscoveryRule, _ *DiscoveryRulesClientCreateOrUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Monitor/accounts/{azureMonitorWorkspaceName}/healthmodels/{healthModelName}/discoveryrules/{discoveryRuleName}"
...
func (client *DiscoveryRulesClient) Delete(ctx context.Context, resourceGroupName string, azureMonitorWorkspaceName string, healthModelName string, discoveryRuleName string, options *DiscoveryRulesClientDeleteOptions) (DiscoveryRulesClientDeleteResponse, error) {
	var err error
	const operationName = "DiscoveryRulesClient.Delete"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.deleteCreateRequest(ctx, resourceGroupName, azureMonitorWorkspaceName, healthModelName, discoveryRuleName, options)
	if err != nil {
...
func (client *DiscoveryRulesClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, azureMonitorWorkspaceName string, healthModelName string, discoveryRuleName string, _ *DiscoveryRulesClientDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Monitor/accounts/{azureMonitorWorkspaceName}/healthmodels/{healthModelName}/discoveryrules/{discoveryRuleName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *DiscoveryRulesClient) Get(ctx context.Context, resourceGroupName string, azureMonitorWorkspaceName string, healthModelName string, discoveryRuleName string, options *DiscoveryRulesClientGetOptions) (DiscoveryRulesClientGetResponse, error) {
	var err error
	const operationName = "DiscoveryRulesClient.Get"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.getCreateRequest(ctx, resourceGroupName, azureMonitorWorkspaceName, healthModelName, discoveryRuleName, options)
	if err != nil {
...
func (client *DiscoveryRulesClient) getCreateRequest(ctx context.Context, resourceGroupName string, azureMonitorWorkspaceName string, healthModelName string, discoveryRuleName string, _ *DiscoveryRulesClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Monitor/accounts/{azureMonitorWorkspaceName}/healthmodels/{healthModelName}/discoveryrules/{discoveryRuleName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
//     method.
func (client *DiscoveryRulesClient) NewListByHealthModelPager(resourceGroupName string, azureMonitorWorkspaceName string, healthModelName string, options *DiscoveryRulesClientListByHealthModelOptions) *runtime.Pager[DiscoveryRulesClientListByHealthModelResponse] {
...
func (client *DiscoveryRulesClient) listByHealthModelCreateRequest(ctx context.Context, resourceGroupName string, azureMonitorWorkspaceName string, healthModelName string, options *DiscoveryRulesClientListByHealthModelOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Monitor/accounts/{azureMonitorWorkspaceName}/healthmodels/{healthModelName}/discoveryrules"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{subscriptionId}", url.PathEscape(client.subscriptionID))
