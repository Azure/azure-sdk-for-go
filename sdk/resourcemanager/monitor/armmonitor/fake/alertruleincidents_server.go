...
func (a *AlertRuleIncidentsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	resultChan := make(chan result, 1)
	go func() {
		var intercepted bool
		var res result
		if alertRuleIncidentsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = alertRuleIncidentsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
func (a *AlertRuleIncidentsServerTransport) dispatchNewListByAlertRulePager(req *http.Request) (*http.Response, error) {
	...
	if newListByAlertRulePager == nil {
		...
		server.PagerResponderInjectNextLinks(newListByAlertRulePager, req, func(page *armmonitor.AlertRuleIncidentsClientListByAlertRuleResponse, createLink func() string) {
...
// set this to conditionally intercept incoming requests to AlertRuleIncidentsServerTransport
var alertRuleIncidentsServerTransportInterceptor interface {
