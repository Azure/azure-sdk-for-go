...
type AzureMonitorWorkspacesServer struct {
	...
	CreateOrUpdate func(ctx context.Context, resourceGroupName string, azureMonitorWorkspaceName string, resource armmonitor.AzureMonitorWorkspaceResource, options *armmonitor.AzureMonitorWorkspacesClientCreateOrUpdateOptions) (resp azfake.Responder[armmonitor.AzureMonitorWorkspacesClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)
