...
func (d *DataCollectionEndpointsServerTransport) dispatchCreate(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := d.srv.Create(req.Context(), resourceGroupNameUnescaped, dataCollectionEndpointNameUnescaped, options)
...
func (d *DataCollectionEndpointsServerTransport) dispatchDelete(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := d.srv.Delete(req.Context(), resourceGroupNameUnescaped, dataCollectionEndpointNameUnescaped, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (d *DataCollectionEndpointsServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := d.srv.Get(req.Context(), resourceGroupNameUnescaped, dataCollectionEndpointNameUnescaped, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (d *DataCollectionEndpointsServerTransport) dispatchUpdate(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := d.srv.Update(req.Context(), resourceGroupNameUnescaped, dataCollectionEndpointNameUnescaped, options)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
