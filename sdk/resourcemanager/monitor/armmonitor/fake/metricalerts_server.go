...
// The returned MetricAlertsServerTransport instance is connected to an instance of armmonitor.MetricAlertsClient by way of the
...
type MetricAlertsServerTransport struct {
	...
	newListByResourceGroupPager *azfake.PagerResponder[armmonitor.MetricAlertsClientListByResourceGroupResponse]
	newListBySubscriptionPager  *azfake.PagerResponder[armmonitor.MetricAlertsClientListBySubscriptionResponse]
}
...
func (m *MetricAlertsServerTransport) dispatchCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := m.srv.CreateOrUpdate(req.Context(), resourceGroupNameUnescaped, ruleNameUnescaped, body, nil)
...
func (m *MetricAlertsServerTransport) dispatchDelete(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := m.srv.Delete(req.Context(), resourceGroupNameUnescaped, ruleNameUnescaped, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (m *MetricAlertsServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := m.srv.Get(req.Context(), resourceGroupNameUnescaped, ruleNameUnescaped, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (m *MetricAlertsServerTransport) dispatchUpdate(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := m.srv.Update(req.Context(), resourceGroupNameUnescaped, ruleNameUnescaped, body, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
