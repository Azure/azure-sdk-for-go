...
func (o *OperationsForMonitorServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if operationsForMonitorServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = operationsForMonitorServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to OperationsForMonitorServerTransport
var operationsForMonitorServerTransportInterceptor interface {
