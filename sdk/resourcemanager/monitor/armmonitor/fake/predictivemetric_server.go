...
func (p *PredictiveMetricServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := p.srv.Get(req.Context(), resourceGroupNameParam, autoscaleSettingNameParam, qp.Get("timespan"), qp.Get("interval"), qp.Get("metricNamespace"), qp.Get("metricName"), qp.Get("aggregation"), nil)
