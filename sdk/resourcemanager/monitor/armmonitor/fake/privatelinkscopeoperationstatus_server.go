...
type PrivateLinkScopeOperationStatusServer struct {
	...
	Get func(ctx context.Context, resourceGroupName string, asyncOperationID string, options *armmonitor.PrivateLinkScopeOperationStatusClientGetOptions) (resp azfake.Responder[armmonitor.PrivateLinkScopeOperationStatusClientGetResponse], errResp azfake.ErrorResponder)
}
...
func (p *PrivateLinkScopeOperationStatusServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if privateLinkScopeOperationStatusServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = privateLinkScopeOperationStatusServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
func (p *PrivateLinkScopeOperationStatusServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := p.srv.Get(req.Context(), resourceGroupNameParam, asyncOperationIDParam, nil)
...
// set this to conditionally intercept incoming requests to PrivateLinkScopeOperationStatusServerTransport
var privateLinkScopeOperationStatusServerTransportInterceptor interface {
