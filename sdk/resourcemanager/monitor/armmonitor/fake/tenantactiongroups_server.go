...
func (t *TenantActionGroupsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	resultChan := make(chan result, 1)
	go func() {
		var intercepted bool
		var res result
		if tenantActionGroupsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = tenantActionGroupsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "TenantActionGroupsClient.NewListByManagementGroupIDPager":
				res.resp, res.err = t.dispatchNewListByManagementGroupIDPager(req)
...
func (t *TenantActionGroupsServerTransport) dispatchNewListByManagementGroupIDPager(req *http.Request) (*http.Response, error) {
	...
	if newListByManagementGroupIDPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListByManagementGroupIDPager, req, func(page *armmonitor.TenantActionGroupsClientListByManagementGroupIDResponse, createLink func() string) {
...
// set this to conditionally intercept incoming requests to TenantActionGroupsServerTransport
var tenantActionGroupsServerTransportInterceptor interface {
