...
func (v *VMInsightsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if vmInsightsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = vmInsightsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			case "VMInsightsClient.GetOnboardingStatus":
				res.resp, res.err = v.dispatchGetOnboardingStatus(req)
			default:
...
// set this to conditionally intercept incoming requests to VMInsightsServerTransport
var vmInsightsServerTransportInterceptor interface {
