...
//   - options - IssueClientAddInvestigationResultOptions contains the optional parameters for the IssueClient.AddInvestigationResult
//     method.
func (client *IssueClient) AddInvestigationResult(ctx context.Context, resourceGroupName string, azureMonitorWorkspaceName string, issueName string, body InvestigationResult, options *IssueClientAddInvestigationResultOptions) (IssueClientAddInvestigationResultResponse, error) {
	var err error
	const operationName = "IssueClient.AddInvestigationResult"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.addInvestigationResultCreateRequest(ctx, resourceGroupName, azureMonitorWorkspaceName, issueName, body, options)
	if err != nil {
...
//   - azureMonitorWorkspaceName - The name of the Azure Monitor Workspace. The name is case insensitive
//   - issueName - The name of the IssueResource
//   - options - IssueClientFetchBackgroundVisualizationOptions contains the optional parameters for the IssueClient.FetchBackgroundVisualization
//     method.
func (client *IssueClient) FetchBackgroundVisualization(ctx context.Context, resourceGroupName string, azureMonitorWorkspaceName string, issueName string, options *IssueClientFetchBackgroundVisualizationOptions) (IssueClientFetchBackgroundVisualizationResponse, error) {
	var err error
	const operationName = "IssueClient.FetchBackgroundVisualization"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.fetchBackgroundVisualizationCreateRequest(ctx, resourceGroupName, azureMonitorWorkspaceName, issueName, options)
	if err != nil {
...
//   - issueName - The name of the IssueResource
//   - body - The content of the action request
//   - options - IssueClientSetBackgroundVisualizationOptions contains the optional parameters for the IssueClient.SetBackgroundVisualization
//     method.
func (client *IssueClient) SetBackgroundVisualization(ctx context.Context, resourceGroupName string, azureMonitorWorkspaceName string, issueName string, body BackgroundVisualization, options *IssueClientSetBackgroundVisualizationOptions) (IssueClientSetBackgroundVisualizationResponse, error) {
	var err error
	const operationName = "IssueClient.SetBackgroundVisualization"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.setBackgroundVisualizationCreateRequest(ctx, resourceGroupName, azureMonitorWorkspaceName, issueName, body, options)
	if err != nil {
