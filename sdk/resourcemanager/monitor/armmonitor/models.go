...
// ActionDetailAutoGenerated - The action detail
type ActionDetailAutoGenerated struct {
	// The mechanism type
	MechanismType *string
...
// AzureMonitorWorkspaceResourceForUpdate - Definition of ARM tracked top level resource properties for the Update operation
...
// ErrorResponseAutoGenerated3 - Common error response for all Azure Resource Manager APIs to return error details for failed
// operations. (This also follows the OData error response format.).
...
// ErrorResponseAutoGenerated4 - Common error response for all Azure Resource Manager APIs to return error details for failed
// operations. (This also follows the OData error response format.).
...
// ErrorResponseAutoGenerated6 - Describes the format of Error response.
type ErrorResponseAutoGenerated6 struct {
	Error *ErrorResponseError
}

// ErrorResponseAutoGenerated7 - The error response.
type ErrorResponseAutoGenerated7 struct {
	// READ-ONLY; The error code.
	Code *string
...
type EventData struct {
	...
	Category *LocalizableStringAutoGenerated
	...
	EventName *LocalizableStringAutoGenerated
	...
	OperationName *LocalizableStringAutoGenerated
	...
	ResourceProviderName *LocalizableStringAutoGenerated

	// READ-ONLY; the resource type
	ResourceType *LocalizableStringAutoGenerated

	// READ-ONLY; a string describing the status of the operation. Some typical values are: Started, In progress, Succeeded, Failed,
	// Resolved.
	Status *LocalizableStringAutoGenerated
	...
	SubStatus *LocalizableStringAutoGenerated
...
// OperationAutoGenerated - Microsoft Insights API operation definition.
...
// OperationDisplayAutoGenerated - Display metadata associated with the operation.
...
// OperationListResultAutoGenerated - Result of the request to list Microsoft.Insights operations. It contains a list of operations
...
// PrivateEndpointConnectionPropertiesAutoGenerated - Properties of the PrivateEndpointConnectProperties.
...
// ProxyResourceAutoGenerated - An azure resource object
...
// ResourceAutoGenerated3 - The autoscale setting resource.
...
// ResourceAutoGenerated6 - An azure resource object
...
// TestNotificationDetailsResponseAutoGenerated - The details of the test notification results.
type TestNotificationDetailsResponseAutoGenerated struct {
	// REQUIRED; The overall state
	State *string
