...
// ClientOperationsListOptions contains the optional parameters for the Client.OperationsList method.
type ClientOperationsListOptions struct {
	// placeholder for future optional parameters
}
...
type IngestionSettings struct {
	// READ-ONLY; The Azure resource Id of the default data collection endpoint for this monitoring account.
	DataCollectionEndpointResourceID *string `json:"dataCollectionEndpointResourceId,omitempty" azure:"ro"`

	// READ-ONLY; The Azure resource Id of the default data collection rule for this monitoring account.
...
// Metrics - Information about metrics for the monitoring account
type Metrics struct {
	...
	// READ-ONLY; The Prometheus query endpoint for the monitoring account
...
// MonitoringAccount - Properties of a monitoring account
type MonitoringAccount struct {
	// READ-ONLY; The immutable ID of the monitoring account. This property is read-only.
	...
	DefaultIngestionSettings *MonitoringAccountDefaultIngestionSettings `json:"defaultIngestionSettings,omitempty" azure:"ro"`

	// READ-ONLY; Information about metrics for the monitoring account
	Metrics *MonitoringAccountMetrics `json:"metrics,omitempty" azure:"ro"`

	// READ-ONLY; The provisioning state of the monitoring account. Set to Succeeded if everything is healthy.
	ProvisioningState *ProvisioningState `json:"provisioningState,omitempty" azure:"ro"`
}

// MonitoringAccountDefaultIngestionSettings - The Data Collection Rule and Endpoint used for ingestion by default.
type MonitoringAccountDefaultIngestionSettings struct {
	// READ-ONLY; The Azure resource Id of the default data collection endpoint for this monitoring account.
	DataCollectionEndpointResourceID *string `json:"dataCollectionEndpointResourceId,omitempty" azure:"ro"`
...
// MonitoringAccountMetrics - Information about metrics for the monitoring account
type MonitoringAccountMetrics struct {
	// READ-ONLY; An internal identifier for the metrics container. Only to be used by the system
	InternalID *string `json:"internalId,omitempty" azure:"ro"`
...
// MonitoringAccountResource - A Monitoring Account definition
type MonitoringAccountResource struct {
	// REQUIRED; The geo-location where the resource lives
	Location *string `json:"location,omitempty"`

	// Resource properties
	Properties *MonitoringAccountResourceProperties `json:"properties,omitempty"`
...
// MonitoringAccountResourceForUpdate - Definition of ARM tracked top level resource properties for update operation
type MonitoringAccountResourceForUpdate struct {
	// Resource tags
	Tags map[string]*string `json:"tags,omitempty"`
}

// MonitoringAccountResourceListResult - A pageable list of resources
type MonitoringAccountResourceListResult struct {
	// REQUIRED; A list of resources
	Value []*MonitoringAccountResource `json:"value,omitempty"`

	// The URL to use for getting the next set of results
	NextLink *string `json:"nextLink,omitempty"`
}

// MonitoringAccountResourceProperties - Resource properties
type MonitoringAccountResourceProperties struct {
	// READ-ONLY; The immutable ID of the monitoring account. This property is read-only.
	AccountID *string `json:"accountId,omitempty" azure:"ro"`
...
// MonitoringAccountsClientCreateOptions contains the optional parameters for the MonitoringAccountsClient.Create method.
type MonitoringAccountsClientCreateOptions struct {
	// placeholder for future optional parameters
}

// MonitoringAccountsClientDeleteOptions contains the optional parameters for the MonitoringAccountsClient.Delete method.
type MonitoringAccountsClientDeleteOptions struct {
	// placeholder for future optional parameters
}

// MonitoringAccountsClientGetOptions contains the optional parameters for the MonitoringAccountsClient.Get method.
type MonitoringAccountsClientGetOptions struct {
	// placeholder for future optional parameters
}

// MonitoringAccountsClientListByResourceGroupOptions contains the optional parameters for the MonitoringAccountsClient.ListByResourceGroup
// method.
type MonitoringAccountsClientListByResourceGroupOptions struct {
	// placeholder for future optional parameters
}

// MonitoringAccountsClientListBySubscriptionOptions contains the optional parameters for the MonitoringAccountsClient.ListBySubscription
// method.
type MonitoringAccountsClientListBySubscriptionOptions struct {
	// placeholder for future optional parameters
}

// MonitoringAccountsClientUpdateOptions contains the optional parameters for the MonitoringAccountsClient.Update method.
type MonitoringAccountsClientUpdateOptions struct {
	// The payload
