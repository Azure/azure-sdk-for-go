...
type AccessRuleProperties struct {
	...
	Subscriptions []*AccessRulePropertiesSubscriptionsItem `json:"subscriptions,omitempty"`
}
...
type ActionGroupAutoGenerated struct {
	...
	IncidentReceivers []*IncidentReceiver `json:"incidentReceivers,omitempty"`
...
type ActionGroupResource struct {
	...
	Properties *ActionGroupAutoGenerated `json:"properties,omitempty"`
...
type AdxDestination struct {
	...
	IngestionURI *string `json:"ingestionUri,omitempty" azure:"ro"`
}
...
type AzureMonitorPrivateLinkScopeProperties struct {
	...
	ProvisioningState *PrivateLinkScopeProvisioningState `json:"provisioningState,omitempty" azure:"ro"`
}
...
type Condition struct {
	...
	MinRecurrenceCount *int64 `json:"minRecurrenceCount,omitempty"`
...
type DataCollectionEndpointMetadata struct {
	...
	ProvisionedByImmutableID *string `json:"provisionedByImmutableId,omitempty" azure:"ro"`
...
type DataCollectionEndpointResource struct {
	...
	SKU *DataCollectionEndpointResourceSKU `json:"sku,omitempty"`
...
type DataCollectionRule struct {
	...
	AgentSettings *DataCollectionRuleAgentSettings `json:"agentSettings,omitempty"`
	...
	DirectDataSources *DataCollectionRuleDirectDataSources `json:"directDataSources,omitempty"`

	// Defines all the references that may be used in other sections of the DCR
	References *DataCollectionRuleReferences `json:"references,omitempty"`
	...
	Endpoints *DataCollectionRuleEndpoints `json:"endpoints,omitempty" azure:"ro"`
	...
	IngestionQuotas *DataCollectionRuleIngestionQuotas `json:"ingestionQuotas,omitempty" azure:"ro"`
...
type DataCollectionRuleEndpoints struct {
	...
	LogsIngestion *string `json:"logsIngestion,omitempty" azure:"ro"`

	// READ-ONLY; The ingestion endpoint for metrics
	MetricsIngestion *string `json:"metricsIngestion,omitempty" azure:"ro"`
}

// DataCollectionRuleIngestionQuotas - The specification for ingestion limits
type DataCollectionRuleIngestionQuotas struct {
	Logs *IngestionQuotasLogs `json:"logs,omitempty"`
}
...
type DataCollectionRuleReferences struct {
	...
	EnrichmentData *ReferencesSpecEnrichmentData `json:"enrichmentData,omitempty"`
}
...
type DataCollectionRuleResource struct {
	...
	// The SKU of the resource.
	SKU *DataCollectionRuleResourceSKU `json:"sku,omitempty"`
...
type ErrorContract struct {
	// The error object.
	Error *ErrorResponseAutoGenerated2 `json:"error,omitempty"`
}
...
type ErrorDetailAutoGenerated2 struct {
	...
	// string.
	AdditionalInfo []*ErrorDetailAdditionalInfoItem `json:"additionalInfo,omitempty"`
...
type ErrorDetailAutoGenerated3 struct {
	// An array of objects with 'type' and 'info' properties. The schema of 'info' is service-specific and dependent on the 'type'
	// string.
	AdditionalInfo []*ErrorDetailAdditionalInfoItemAutoGenerated `json:"additionalInfo,omitempty"`
...
type ErrorResponseAutoGenerated2 struct {
	...
	// READ-ONLY; The error details.
	Details []*ErrorResponseAutoGenerated2 `json:"details,omitempty" azure:"ro"`
...
type ErrorResponseAutoGenerated5 struct {
	Error *ErrorResponseErrorAutoGenerated `json:"error,omitempty"`
}
...
type ErrorResponseError struct {
	// An array of objects with 'type' and 'info' properties. The schema of 'info' is service-specific and dependent on the 'type'
	// string.
	AdditionalInfo []*ErrorResponseErrorAdditionalInfoItem `json:"additionalInfo,omitempty"`

	// Unlocalized string which can be used to programmatically identify the error.
	Code *string `json:"code,omitempty"`

	// An array of additional nested error response info objects, as described by this contract.
	Details []*ErrorDetailAutoGenerated2 `json:"details,omitempty"`
...
type ErrorResponseErrorAutoGenerated struct {
	// An array of objects with 'type' and 'info' properties. The schema of 'info' is service-specific and dependent on the 'type'
	// string.
	AdditionalInfo []*ErrorResponseErrorAdditionalInfoItemAutoGenerated `json:"additionalInfo,omitempty"`

	// Unlocalized string which can be used to programmatically identify the error.
	Code *string `json:"code,omitempty"`

	// An array of additional nested error response info objects, as described by this contract.
	Details []*ErrorDetailAutoGenerated3 `json:"details,omitempty"`
...
type IdentityAutoGenerated struct {
	...
	// ids in the form:
	// '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}'.
	UserAssignedIdentities map[string]*UserIdentityPropertiesAutoGenerated `json:"userAssignedIdentities,omitempty"`
...
type IncidentReceiver struct {
	...
	Connection *IncidentServiceConnection `json:"connection,omitempty"`

	// REQUIRED; The incident management service type
	IncidentManagementService *IncidentManagementService `json:"incidentManagementService,omitempty"`
...
type MetadataValue struct {
	...
	Name *LocalizableStringAutoGenerated `json:"name,omitempty"`
...
type MetricAlertProperties struct {
	...
	ResolveConfiguration *ResolveConfiguration `json:"resolveConfiguration,omitempty"`
...
type MetricDefinition struct {
	...
	Dimensions []*LocalizableStringAutoGenerated `json:"dimensions,omitempty"`
...
type NetworkSecurityProfile struct {
	...
	AccessRulesVersion *int32 `json:"accessRulesVersion,omitempty"`

	// Current diagnostic settings version
	DiagnosticSettingsVersion *int32 `json:"diagnosticSettingsVersion,omitempty"`
...
type OtelLogsDataSource struct {
	...
	// resource attribute.
	ResourceAttributeRouting *OtelLogsDataSourceResourceAttributeRouting `json:"resourceAttributeRouting,omitempty"`
}
...
type OtelMetricsDataSource struct {
	...
	// Specifies the routing policy based on OTLP payload resource attributes to route subset of the payload according to matching
	// resource attribute.
	ResourceAttributeRouting *OtelMetricsDataSourceResourceAttributeRouting `json:"resourceAttributeRouting,omitempty"`
}
...
type OtelTracesDataSource struct {
	...
	// Specifies the routing policy based on OTLP payload resource attributes to route subset of the payload according to matching
	// resource attribute.
	ResourceAttributeRouting *OtelTracesDataSourceResourceAttributeRouting `json:"resourceAttributeRouting,omitempty"`
}
...
type PromQLCriteria struct {
	...
	AllOf []MultiPromQLCriteriaClassification `json:"allOf,omitempty"`

	// Configuration for failing periods in query-based alerts.
	FailingPeriods *QueryFailingPeriods `json:"failingPeriods,omitempty"`
}
...
type PrometheusForwarderDataSource struct {
	...
	CustomVMScrapeConfig []any `json:"customVMScrapeConfig,omitempty"`
...
type ProvisioningIssueProperties struct {
	...
	IssueType *IssueType `json:"issueType,omitempty" azure:"ro"`
	...
	SuggestedAccessRules []*AccessRule `json:"suggestedAccessRules,omitempty" azure:"ro"`
	...
	SuggestedResourceIDs []*string `json:"suggestedResourceIds,omitempty" azure:"ro"`
}
...
type ScheduledQueryRuleResource struct {
	...
	// The identity of the resource.
	Identity *IdentityAutoGenerated `json:"identity,omitempty"`
...
type ScopedResourceProperties struct {
	...
	Kind *ScopedResourceKind `json:"kind,omitempty"`
	...
	SubscriptionLocation *string `json:"subscriptionLocation,omitempty"`

	// READ-ONLY; State of the Azure monitor resource.
	ProvisioningState *ScopedResourceProvisioningState `json:"provisioningState,omitempty" azure:"ro"`
}
...
type ServiceDiagnosticSettingsResource struct {
	...
	Properties *ServiceDiagnosticSettings `json:"properties,omitempty"`
