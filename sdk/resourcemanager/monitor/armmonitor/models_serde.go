...
// MarshalJSON implements the json.Marshaller interface for type DiagnosticsLogSettings.
func (d DiagnosticsLogSettings) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "category", d.Category)
	populate(objectMap, "categoryGroup", d.CategoryGroup)
	populate(objectMap, "enabled", d.Enabled)
	populate(objectMap, "retentionPolicy", d.RetentionPolicy)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type DiagnosticsLogSettings.
func (d *DiagnosticsLogSettings) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %s", d, err.Error())
	}
	for key, val := range rawMsg {
		...
		case "category":
			...
			delete(rawMsg, key)
		case "categoryGroup":
			err = unpopulate(val, "CategoryGroup", &d.CategoryGroup)
			delete(rawMsg, key)
		case "enabled":
			err = unpopulate(val, "Enabled", &d.Enabled)
			delete(rawMsg, key)
		case "retentionPolicy":
			err = unpopulate(val, "RetentionPolicy", &d.RetentionPolicy)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %s", d, err.Error())
...
// MarshalJSON implements the json.Marshaller interface for type DiagnosticsMetricSettings.
func (d DiagnosticsMetricSettings) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "category", d.Category)
	populate(objectMap, "enabled", d.Enabled)
	populate(objectMap, "retentionPolicy", d.RetentionPolicy)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type DiagnosticsMetricSettings.
func (d *DiagnosticsMetricSettings) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %s", d, err.Error())
	}
