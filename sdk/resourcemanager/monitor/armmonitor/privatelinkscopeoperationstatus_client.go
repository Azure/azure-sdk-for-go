...
//     method.
func (client *PrivateLinkScopeOperationStatusClient) Get(ctx context.Context, resourceGroupName string, asyncOperationID string, options *PrivateLinkScopeOperationStatusClientGetOptions) (PrivateLinkScopeOperationStatusClientGetResponse, error) {
	var err error
	const operationName = "PrivateLinkScopeOperationStatusClient.Get"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.getCreateRequest(ctx, resourceGroupName, asyncOperationID, options)
	if err != nil {
...
func (client *PrivateLinkScopeOperationStatusClient) getCreateRequest(ctx context.Context, resourceGroupName string, asyncOperationID string, _ *PrivateLinkScopeOperationStatusClientGetOptions) (*policy.Request, error) {
	...
	reqQP.Set("api-version", version20230601Preview)
