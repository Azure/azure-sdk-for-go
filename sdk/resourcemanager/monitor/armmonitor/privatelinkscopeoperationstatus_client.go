...
func (client *PrivateLinkScopeOperationStatusClient) getCreateRequest(ctx context.Context, asyncOperationID string, resourceGroupName string, _ *PrivateLinkScopeOperationStatusClientGetOptions) (*policy.Request, error) {
