...
func (i InvestigationMetadata) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateTime[datetime.RFC3339](objectMap, "createdAt", i.CreatedAt, true)
...
func (i InvestigationResult) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "createdAt", i.CreatedAt, true)
	populate(objectMap, "id", i.ID)
	populateTime[datetime.RFC3339](objectMap, "lastModifiedAt", i.LastModifiedAt, true)
...
func (i IssueProperties) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "impactTime", i.ImpactTime, true)
...
func (r RelatedAlert) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateTime[datetime.RFC3339](objectMap, "addedAt", r.AddedAt, true)
	populate(objectMap, "id", r.ID)
	populateTime[datetime.RFC3339](objectMap, "lastModifiedAt", r.LastModifiedAt, true)
