...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "FederatedIdentityCredentialsClient":
		initServer(&s.trMu, &s.trFederatedIdentityCredentialsServer, func() *FederatedIdentityCredentialsServerTransport {
	...
	case "SystemAssignedIdentitiesClient":
		initServer(&s.trMu, &s.trSystemAssignedIdentitiesServer, func() *SystemAssignedIdentitiesServerTransport {
	...
	case "UserAssignedIdentitiesClient":
		initServer(&s.trMu, &s.trUserAssignedIdentitiesServer, func() *UserAssignedIdentitiesServerTransport {
