...
- Function `*ServersClient.BeginUpgrade` return value(s) have been changed from `(*armruntime.Poller[ServersClientUpgradeResponse], error)` to `(*runtime.Poller[ServersClientUpgradeResponse], error)`
