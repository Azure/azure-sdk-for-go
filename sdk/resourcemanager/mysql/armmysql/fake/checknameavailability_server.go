...
type CheckNameAvailabilityServer struct {
	...
	Execute func(ctx context.Context, nameAvailabilityRequest armmysql.NameAvailabilityRequest, options *armmysql.CheckNameAvailabilityClientExecuteOptions) (resp azfake.Responder[armmysql.CheckNameAvailabilityClientExecuteResponse], errResp azfake.ErrorResponder)
}
...
// The returned CheckNameAvailabilityServerTransport instance is connected to an instance of armmysql.CheckNameAvailabilityClient via the
...
// CheckNameAvailabilityServerTransport connects instances of armmysql.CheckNameAvailabilityClient to instances of CheckNameAvailabilityServer.
...
func (c *CheckNameAvailabilityServerTransport) dispatchExecute(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[armmysql.NameAvailabilityRequest](req)
	if err != nil {
		return nil, err
	}
