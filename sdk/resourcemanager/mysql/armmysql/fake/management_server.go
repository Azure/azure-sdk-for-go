...
type ManagementServer struct {
	...
	BeginCreateRecommendedActionSession func(ctx context.Context, resourceGroupName string, serverName string, advisorName string, databaseName string, options *armmysql.ManagementClientBeginCreateRecommendedActionSessionOptions) (resp azfake.PollerResponder[armmysql.ManagementClientCreateRecommendedActionSessionResponse], errResp azfake.ErrorResponder)

	// ResetQueryPerformanceInsightData is the fake for method ManagementClient.ResetQueryPerformanceInsightData
	// HTTP status codes to indicate success: http.StatusOK
	ResetQueryPerformanceInsightData func(ctx context.Context, resourceGroupName string, serverName string, options *armmysql.ManagementClientResetQueryPerformanceInsightDataOptions) (resp azfake.Responder[armmysql.ManagementClientResetQueryPerformanceInsightDataResponse], errResp azfake.ErrorResponder)
}

// NewManagementServerTransport creates a new instance of ManagementServerTransport with the provided implementation.
// The returned ManagementServerTransport instance is connected to an instance of armmysql.ManagementClient via the
...
func NewManagementServerTransport(srv *ManagementServer) *ManagementServerTransport {
	return &ManagementServerTransport{
		srv:                                 srv,
		beginCreateRecommendedActionSession: newTracker[azfake.PollerResponder[armmysql.ManagementClientCreateRecommendedActionSessionResponse]](),
	}
}

// ManagementServerTransport connects instances of armmysql.ManagementClient to instances of ManagementServer.
...
type ManagementServerTransport struct {
	...
	beginCreateRecommendedActionSession *tracker[azfake.PollerResponder[armmysql.ManagementClientCreateRecommendedActionSessionResponse]]
}
...
func (m *ManagementServerTransport) dispatchBeginCreateRecommendedActionSession(req *http.Request) (*http.Response, error) {
	...
	if beginCreateRecommendedActionSession == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.DBforMySQL/servers/(?P<serverName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/advisors/(?P<advisorName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/createRecommendedActionSession`
...
func (m *ManagementServerTransport) dispatchResetQueryPerformanceInsightData(req *http.Request) (*http.Response, error) {
	...
	const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.DBforMySQL/servers/(?P<serverName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resetQueryPerformanceInsightData`
	regex := regexp.MustCompile(regexStr)
	matches := regex.FindStringSubmatch(req.URL.EscapedPath())
