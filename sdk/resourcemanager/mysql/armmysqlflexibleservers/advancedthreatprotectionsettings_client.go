...
func (client *AdvancedThreatProtectionSettingsClient) listCreateRequest(ctx context.Context, resourceGroupName string, serverName string, nextLink string, _ *AdvancedThreatProtectionSettingsClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *AdvancedThreatProtectionSettingsClient) listHandleResponse(resp *http.Response, successCodes ...int) (AdvancedThreatProtectionSettingsClientListResponse, error) {
