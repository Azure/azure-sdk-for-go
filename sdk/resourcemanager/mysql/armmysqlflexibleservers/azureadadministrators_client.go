...
func (client *AzureADAdministratorsClient) getHandleResponse(resp *http.Response, successCodes ...int) (AzureADAdministratorsClientGetResponse, error) {
...
func (client *AzureADAdministratorsClient) listByServerCreateRequest(ctx context.Context, resourceGroupName string, serverName string, nextLink string, _ *AzureADAdministratorsClientListByServerOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *AzureADAdministratorsClient) listByServerHandleResponse(resp *http.Response, successCodes ...int) (AzureADAdministratorsClientListByServerResponse, error) {
