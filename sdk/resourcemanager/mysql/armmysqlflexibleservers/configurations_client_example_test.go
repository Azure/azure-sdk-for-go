...
func ExampleConfigurationsClient_NewListByServerPager() {
	...
	pager := clientFactory.NewConfigurationsClient().NewListByServerPager("testrg", "mysqltestserver", &armmysqlflexibleservers.ConfigurationsClientListByServerOptions{
		Page:     to.Ptr[int32](1),
	...
	for pager.More() {
		...
		// page = armmysqlflexibleservers.ConfigurationsClientListByServerResponse{
		// 	ConfigurationListResult: armmysqlflexibleservers.ConfigurationListResult{
		// 		Value: []*armmysqlflexibleservers.Configuration{
		// 			{
		// 				Name: to.Ptr("archive"),
