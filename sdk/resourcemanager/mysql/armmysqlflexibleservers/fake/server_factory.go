...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "AdvancedThreatProtectionSettingsClient":
		initServer(&s.trMu, &s.trAdvancedThreatProtectionSettingsServer, func() *AdvancedThreatProtectionSettingsServerTransport {
	...
	case "AzureADAdministratorsClient":
		initServer(&s.trMu, &s.trAzureADAdministratorsServer, func() *AzureADAdministratorsServerTransport {
	...
	case "BackupAndExportClient":
		initServer(&s.trMu, &s.trBackupAndExportServer, func() *BackupAndExportServerTransport {
	...
	case "CheckNameAvailabilityWithoutLocationClient":
		initServer(&s.trMu, &s.trCheckNameAvailabilityWithoutLocationServer, func() *CheckNameAvailabilityWithoutLocationServerTransport {
	...
	case "CheckVirtualNetworkSubnetUsageClient":
		initServer(&s.trMu, &s.trCheckVirtualNetworkSubnetUsageServer, func() *CheckVirtualNetworkSubnetUsageServerTransport {
	...
	case "GetPrivateDNSZoneSuffixClient":
		initServer(&s.trMu, &s.trGetPrivateDNSZoneSuffixServer, func() *GetPrivateDNSZoneSuffixServerTransport {
	...
	case "LocationBasedCapabilitiesClient":
		initServer(&s.trMu, &s.trLocationBasedCapabilitiesServer, func() *LocationBasedCapabilitiesServerTransport {
	...
	case "LocationBasedCapabilitySetClient":
		initServer(&s.trMu, &s.trLocationBasedCapabilitySetServer, func() *LocationBasedCapabilitySetServerTransport {
	...
	case "LogFilesClient":
		initServer(&s.trMu, &s.trLogFilesServer, func() *LogFilesServerTransport { return NewLogFilesServerTransport(&s.srv.LogFilesServer) })
		resp, err = s.trLogFilesServer.Do(req)
	case "LongRunningBackupClient":
		initServer(&s.trMu, &s.trLongRunningBackupServer, func() *LongRunningBackupServerTransport {
	...
	case "LongRunningBackupsClient":
		initServer(&s.trMu, &s.trLongRunningBackupsServer, func() *LongRunningBackupsServerTransport {
	...
	case "OperationProgressClient":
		initServer(&s.trMu, &s.trOperationProgressServer, func() *OperationProgressServerTransport {
	...
	case "ServersMigrationClient":
		initServer(&s.trMu, &s.trServersMigrationServer, func() *ServersMigrationServerTransport {
