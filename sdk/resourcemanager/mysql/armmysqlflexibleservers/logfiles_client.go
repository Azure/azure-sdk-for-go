...
func (client *LogFilesClient) listByServerCreateRequest(ctx context.Context, resourceGroupName string, serverName string, nextLink string, _ *LogFilesClientListByServerOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *LogFilesClient) listByServerHandleResponse(resp *http.Response, successCodes ...int) (LogFilesClientListByServerResponse, error) {
