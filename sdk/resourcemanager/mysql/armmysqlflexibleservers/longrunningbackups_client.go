...
func (client *LongRunningBackupsClient) getHandleResponse(resp *http.Response, successCodes ...int) (LongRunningBackupsClientGetResponse, error) {
...
func (client *LongRunningBackupsClient) listCreateRequest(ctx context.Context, resourceGroupName string, serverName string, nextLink string, _ *LongRunningBackupsClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *LongRunningBackupsClient) listHandleResponse(resp *http.Response, successCodes ...int) (LongRunningBackupsClientListResponse, error) {
