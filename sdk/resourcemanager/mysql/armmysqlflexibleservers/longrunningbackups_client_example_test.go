...
func ExampleLongRunningBackupsClient_Get() {
	...
	res, err := clientFactory.NewLongRunningBackupsClient().Get(ctx, "TestGroup", "mysqltestserver", "daily_20210615T160516", armmysqlflexibleservers.LongRunningBackupsClientGetOptions{})
	if err != nil {
