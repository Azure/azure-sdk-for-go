...
func (m MaintenanceProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateTime[datetime.RFC3339](objectMap, "maintenanceAvailableScheduleMaxTime", m.MaintenanceAvailableScheduleMaxTime, true)
	populateTime[datetime.RFC3339](objectMap, "maintenanceAvailableScheduleMinTime", m.MaintenanceAvailableScheduleMinTime, true)
	populate(objectMap, "maintenanceDescription", m.MaintenanceDescription)
	populateTime[datetime.RFC3339](objectMap, "maintenanceEndTime", m.MaintenanceEndTime, true)
	populateTime[datetime.RFC3339](objectMap, "maintenanceExecutionEndTime", m.MaintenanceExecutionEndTime, true)
	populateTime[datetime.RFC3339](objectMap, "maintenanceExecutionStartTime", m.MaintenanceExecutionStartTime, true)
	populateTime[datetime.RFC3339](objectMap, "maintenanceStartTime", m.MaintenanceStartTime, true)
...
func (m *MaintenanceProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "maintenanceAvailableScheduleMaxTime":
			err = unpopulateTime[datetime.RFC3339](val, "MaintenanceAvailableScheduleMaxTime", &m.MaintenanceAvailableScheduleMaxTime)
			delete(rawMsg, key)
		case "maintenanceAvailableScheduleMinTime":
			err = unpopulateTime[datetime.RFC3339](val, "MaintenanceAvailableScheduleMinTime", &m.MaintenanceAvailableScheduleMinTime)
			delete(rawMsg, key)
		case "maintenanceDescription":
			err = unpopulate(val, "MaintenanceDescription", &m.MaintenanceDescription)
			delete(rawMsg, key)
		case "maintenanceEndTime":
			err = unpopulateTime[datetime.RFC3339](val, "MaintenanceEndTime", &m.MaintenanceEndTime)
			delete(rawMsg, key)
		case "maintenanceExecutionEndTime":
			err = unpopulateTime[datetime.RFC3339](val, "MaintenanceExecutionEndTime", &m.MaintenanceExecutionEndTime)
			delete(rawMsg, key)
		case "maintenanceExecutionStartTime":
			err = unpopulateTime[datetime.RFC3339](val, "MaintenanceExecutionStartTime", &m.MaintenanceExecutionStartTime)
			delete(rawMsg, key)
		case "maintenanceStartTime":
			err = unpopulateTime[datetime.RFC3339](val, "MaintenanceStartTime", &m.MaintenanceStartTime)
			delete(rawMsg, key)
...
func (s ServerBackupProperties) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "completedTime", s.CompletedTime, true)
...
func (s *ServerBackupProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "backupType":
			...
			delete(rawMsg, key)
		case "completedTime":
			err = unpopulateTime[datetime.RFC3339](val, "CompletedTime", &s.CompletedTime)
			delete(rawMsg, key)
		case "source":
...
func (s ServerProperties) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "restorePointInTime", s.RestorePointInTime, true)
