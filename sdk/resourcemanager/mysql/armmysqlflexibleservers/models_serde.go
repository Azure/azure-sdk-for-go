...
func (m MaintenanceProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateTime[datetime.RFC3339](objectMap, "maintenanceAvailableScheduleMaxTime", m.MaintenanceAvailableScheduleMaxTime)
	populateTime[datetime.RFC3339](objectMap, "maintenanceAvailableScheduleMinTime", m.MaintenanceAvailableScheduleMinTime)
	populate(objectMap, "maintenanceDescription", m.MaintenanceDescription)
	populateTime[datetime.RFC3339](objectMap, "maintenanceEndTime", m.MaintenanceEndTime)
	populateTime[datetime.RFC3339](objectMap, "maintenanceExecutionEndTime", m.MaintenanceExecutionEndTime)
	populateTime[datetime.RFC3339](objectMap, "maintenanceExecutionStartTime", m.MaintenanceExecutionStartTime)
	populateTime[datetime.RFC3339](objectMap, "maintenanceStartTime", m.MaintenanceStartTime)
...
func (s ServerBackupProperties) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "completedTime", s.CompletedTime)
