...
func (client *ReplicasClient) listByServerCreateRequest(ctx context.Context, resourceGroupName string, serverName string, nextLink string, _ *ReplicasClientListByServerOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *ReplicasClient) listByServerHandleResponse(resp *http.Response, successCodes ...int) (ReplicasClientListByServerResponse, error) {
