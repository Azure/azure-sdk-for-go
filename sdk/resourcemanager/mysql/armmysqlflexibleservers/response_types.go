...
// AzureADAdministratorsClientCreateOrUpdateResponse contains the response from method AzureADAdministratorsClient.CreateOrUpdate.
type AzureADAdministratorsClientCreateOrUpdateResponse struct {
	AzureADAdministrator
}

// AzureADAdministratorsClientDeleteResponse contains the response from method AzureADAdministratorsClient.Delete.
...
// AzureADAdministratorsClientListByServerResponse contains the response from method AzureADAdministratorsClient.ListByServer.
