...
func (client *ServersClient) listCreateRequest(ctx context.Context, nextLink string, _ *ServersClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *ServersClient) listByResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, nextLink string, _ *ServersClientListByResourceGroupOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
	var req *policy.Request
	var err error
	if firstPage {
...
func (client *ServersClient) ValidateEstimateHighAvailability(ctx context.Context, resourceGroupName string, serverName string, parameters HighAvailabilityValidationEstimation, options *ServersClientValidateEstimateHighAvailabilityOptions) (ServersClientValidateEstimateHighAvailabilityResponse, error) {
	...
	return client.validateEstimateHighAvailabilityHandleResponse(httpResp, http.StatusOK)
}
...
func (client *ServersClient) validateEstimateHighAvailabilityHandleResponse(resp *http.Response, successCodes ...int) (ServersClientValidateEstimateHighAvailabilityResponse, error) {
