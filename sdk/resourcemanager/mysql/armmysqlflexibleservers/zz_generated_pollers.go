...
// ConfigurationsBatchUpdatePoller provides polling facilities until the operation reaches a terminal state.
type ConfigurationsBatchUpdatePoller struct {
	pt *azcore.Poller
}

// Done returns true if the LRO has reached a terminal state.
func (p *ConfigurationsBatchUpdatePoller) Done() bool {
	return p.pt.Done()
}
...
func (p *ConfigurationsBatchUpdatePoller) Poll(ctx context.Context) (*http.Response, error) {
	return p.pt.Poll(ctx)
}

// FinalResponse performs a final GET to the service and returns the final response
// for the polling operation. If there is an error performing the final GET then an error is returned.
// If the final GET succeeded then the final ConfigurationsBatchUpdateResponse will be returned.
func (p *ConfigurationsBatchUpdatePoller) FinalResponse(ctx context.Context) (ConfigurationsBatchUpdateResponse, error) {
	respType := ConfigurationsBatchUpdateResponse{}
	resp, err := p.pt.FinalResponse(ctx, &respType.ConfigurationListResult)
	if err != nil {
		return ConfigurationsBatchUpdateResponse{}, err
	}
...
func (p *ConfigurationsBatchUpdatePoller) ResumeToken() (string, error) {
...
// ServersFailoverPoller provides polling facilities until the operation reaches a terminal state.
type ServersFailoverPoller struct {
	pt *azcore.Poller
}

// Done returns true if the LRO has reached a terminal state.
func (p *ServersFailoverPoller) Done() bool {
	return p.pt.Done()
}
...
// Calling Poll on an LRO that has reached a terminal state will return the final
// HTTP response or error.
func (p *ServersFailoverPoller) Poll(ctx context.Context) (*http.Response, error) {
	return p.pt.Poll(ctx)
}

// FinalResponse performs a final GET to the service and returns the final response
// for the polling operation. If there is an error performing the final GET then an error is returned.
// If the final GET succeeded then the final ServersFailoverResponse will be returned.
func (p *ServersFailoverPoller) FinalResponse(ctx context.Context) (ServersFailoverResponse, error) {
	respType := ServersFailoverResponse{}
	resp, err := p.pt.FinalResponse(ctx, nil)
	if err != nil {
		return ServersFailoverResponse{}, err
	}
	respType.RawResponse = resp
	return respType, nil
}
...
// ResumeToken returns a value representing the poller that can be used to resume
// the LRO at a later time. ResumeTokens are unique per service operation.
func (p *ServersFailoverPoller) ResumeToken() (string, error) {
	return p.pt.ResumeToken()
}
