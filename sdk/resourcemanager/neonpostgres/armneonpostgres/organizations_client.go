...
// GetPostgresVersions - Action to retrieve the PostgreSQL versions.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2025-03-01
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - options - OrganizationsClientGetPostgresVersionsOptions contains the optional parameters for the OrganizationsClient.GetPostgresVersions
//     method.
func (client *OrganizationsClient) GetPostgresVersions(ctx context.Context, resourceGroupName string, options *OrganizationsClientGetPostgresVersionsOptions) (OrganizationsClientGetPostgresVersionsResponse, error) {
	var err error
	const operationName = "OrganizationsClient.GetPostgresVersions"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.getPostgresVersionsCreateRequest(ctx, resourceGroupName, options)
	if err != nil {
		return OrganizationsClientGetPostgresVersionsResponse{}, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
	if err != nil {
		return OrganizationsClientGetPostgresVersionsResponse{}, err
	...
	resp, err := client.getPostgresVersionsHandleResponse(httpResp)
	return resp, err
}

// getPostgresVersionsCreateRequest creates the GetPostgresVersions request.
func (client *OrganizationsClient) getPostgresVersionsCreateRequest(ctx context.Context, resourceGroupName string, options *OrganizationsClientGetPostgresVersionsOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Neon.Postgres/getPostgresVersions"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{subscriptionId}", url.PathEscape(client.subscriptionID))
...
// getPostgresVersionsHandleResponse handles the GetPostgresVersions response.
func (client *OrganizationsClient) getPostgresVersionsHandleResponse(resp *http.Response) (OrganizationsClientGetPostgresVersionsResponse, error) {
	result := OrganizationsClientGetPostgresVersionsResponse{}
	if err := runtime.UnmarshalAsJSON(resp, &result.PgVersionsResult); err != nil {
		return OrganizationsClientGetPostgresVersionsResponse{}, err
	}
	return result, nil
}
...
func (client *OrganizationsClient) listByResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, _ *OrganizationsClientListByResourceGroupOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Neon.Postgres/organizations"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{subscriptionId}", url.PathEscape(client.subscriptionID))
...
func (client *OrganizationsClient) listBySubscriptionCreateRequest(ctx context.Context, _ *OrganizationsClientListBySubscriptionOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/providers/Neon.Postgres/organizations"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{subscriptionId}", url.PathEscape(client.subscriptionID))
