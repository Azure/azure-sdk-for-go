...
func (client *BackupVaultsClient) listByNetAppAccountCreateRequest(ctx context.Context, resourceGroupName string, accountName string, _ *BackupVaultsClientListByNetAppAccountOptions) (*policy.Request, error) {
