...
// BindAuthenticationLevel - The authentication level to use when binding to the LDAP server.
type BindAuthenticationLevel string

const (
	// BindAuthenticationLevelAnonymous - Anonymous bind i.e. no credentials provided
	BindAuthenticationLevelAnonymous BindAuthenticationLevel = "Anonymous"
	// BindAuthenticationLevelSimple - Simple bind i.e. plain text credentials provided
	BindAuthenticationLevelSimple BindAuthenticationLevel = "Simple"
)

// PossibleBindAuthenticationLevelValues returns the possible values for the BindAuthenticationLevel const type.
func PossibleBindAuthenticationLevelValues() []BindAuthenticationLevel {
	return []BindAuthenticationLevel{
		BindAuthenticationLevelAnonymous,
		BindAuthenticationLevelSimple,
	}
}
...
// storage based on the read pattern for cool access enabled volumes. The possible values for this field are:
...
// values for this field are: Auto - Moves cold user data blocks in both the Snapshot copies and the active file system to
// the cool tier tier. This policy is the default. SnapshotOnly - Moves user data blocks of the Volume Snapshot copies that
...
// PossibleVolumeBackupRelationshipStatusValues returns the possible values for the VolumeBackupRelationshipStatus const type.
func PossibleVolumeBackupRelationshipStatusValues() []VolumeBackupRelationshipStatus {
	return []VolumeBackupRelationshipStatus{
		VolumeBackupRelationshipStatusFailed,
...
// VolumeReplicationRelationshipStatus - Status of the volume replication relationship
...
// PossibleVolumeReplicationRelationshipStatusValues returns the possible values for the VolumeReplicationRelationshipStatus const type.
func PossibleVolumeReplicationRelationshipStatusValues() []VolumeReplicationRelationshipStatus {
	return []VolumeReplicationRelationshipStatus{
		VolumeReplicationRelationshipStatusIdle,
		VolumeReplicationRelationshipStatusTransferring,
	}
}

// VolumeRestoreRelationshipStatus - Status of the volume restore relationship
...
// PossibleVolumeRestoreRelationshipStatusValues returns the possible values for the VolumeRestoreRelationshipStatus const type.
func PossibleVolumeRestoreRelationshipStatusValues() []VolumeRestoreRelationshipStatus {
	return []VolumeRestoreRelationshipStatus{
		VolumeRestoreRelationshipStatusFailed,
