...
// Generated from example definition: 2026-04-15-preview/ElasticSnapshots_CreateOrUpdate.json
func ExampleElasticSnapshotsClient_BeginCreateOrUpdate() {
	...
	poller, err := clientFactory.NewElasticSnapshotsClient().BeginCreateOrUpdate(ctx, "myRG", "account1", "pool1", "volume1", "snapshot1", armnetapp.ElasticSnapshot{}, nil)
	if err != nil {
	...
	// res = armnetapp.ElasticSnapshotsClientCreateOrUpdateResponse{
	// 	ElasticSnapshot: armnetapp.ElasticSnapshot{
...
// Generated from example definition: 2026-04-15-preview/ElasticSnapshots_Delete.json
func ExampleElasticSnapshotsClient_BeginDelete() {
	...
	poller, err := clientFactory.NewElasticSnapshotsClient().BeginDelete(ctx, "myRG", "account1", "pool1", "volume1", "snapshot1", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
...
// Generated from example definition: 2026-04-15-preview/ElasticSnapshots_Get.json
func ExampleElasticSnapshotsClient_Get() {
	...
	res, err := clientFactory.NewElasticSnapshotsClient().Get(ctx, "myRG", "account1", "pool1", "volume1", "snapshot1", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armnetapp.ElasticSnapshotsClientGetResponse{
	// 	ElasticSnapshot: armnetapp.ElasticSnapshot{
	// 		ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/myRG/providers/Microsoft.NetApp/elasticAccounts/account1/elasticCapacityPools/pool1/elasticVolumes/volume1/elasticSnapshots/snapshot1"),
	// 		Name: to.Ptr("account1/pool1/volume1/snapshot1"),
	// 		Type: to.Ptr("Microsoft.NetApp/elasticAccounts/elasticCapacityPools/elasticVolumes/elasticSnapshots"),
...
// Generated from example definition: 2026-04-15-preview/ElasticSnapshots_ListByElasticVolume.json
