...
// AccountsClientBeginRefreshLdapBindPasswordOptions contains the optional parameters for the AccountsClient.BeginRefreshLdapBindPassword
// method.
type AccountsClientBeginRefreshLdapBindPasswordOptions struct {
	// Resumes the long-running operation from the provided token.
	ResumeToken string
}
