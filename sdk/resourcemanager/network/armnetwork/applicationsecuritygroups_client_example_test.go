...
// Generated from example definition: 2025-07-01/ApplicationSecurityGroupCreate.json
func ExampleApplicationSecurityGroupsClient_BeginCreateOrUpdate() {
	...
	// res = armnetwork.ApplicationSecurityGroupsClientCreateOrUpdateResponse{
	...
	// 		ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.Network/applicationSecurityGroups/test-asg"),
	// 		Location: to.Ptr("westus"),
	// 		Properties: &armnetwork.ApplicationSecurityGroupPropertiesFormat{
...
// Generated from example definition: 2025-07-01/ApplicationSecurityGroupDelete.json
func ExampleApplicationSecurityGroupsClient_BeginDelete() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armnetwork.ApplicationSecurityGroupsClientDeleteResponse{
	// }
}

// Generated from example definition: 2025-07-01/ApplicationSecurityGroupGet.json
func ExampleApplicationSecurityGroupsClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armnetwork.ApplicationSecurityGroupsClientGetResponse{
	// 	ApplicationSecurityGroup: armnetwork.ApplicationSecurityGroup{
	// 		Name: to.Ptr("test-asg"),
	// 		Type: to.Ptr("Microsoft.Network/applicationSecurityGroups"),
	// 		ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.Network/applicationSecurityGroups/test-asg"),
...
// Generated from example definition: 2025-07-01/ApplicationSecurityGroupList.json
...
// Generated from example definition: 2025-07-01/ApplicationSecurityGroupListAll.json
func ExampleApplicationSecurityGroupsClient_NewListAllPager() {
	...
	for pager.More() {
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armnetwork.ApplicationSecurityGroupsClientListAllResponse{
		// 	ApplicationSecurityGroupListResult: armnetwork.ApplicationSecurityGroupListResult{
		// 		Value: []*armnetwork.ApplicationSecurityGroup{
		// 			{
		// 				Name: to.Ptr("asg1"),
...
// Generated from example definition: 2025-07-01/ApplicationSecurityGroupUpdateTags.json
func ExampleApplicationSecurityGroupsClient_UpdateTags() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armnetwork.ApplicationSecurityGroupsClientUpdateTagsResponse{
	// 	ApplicationSecurityGroup: armnetwork.ApplicationSecurityGroup{
	// 		Name: to.Ptr("test-asg"),
	// 		Type: to.Ptr("Microsoft.Network/applicationSecurityGroups"),
	// 		ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.Network/applicationSecurityGroups/test-asg"),
