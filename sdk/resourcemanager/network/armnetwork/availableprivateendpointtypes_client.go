...
func (client *AvailablePrivateEndpointTypesClient) listCreateRequest(ctx context.Context, location string, nextLink string, _ *AvailablePrivateEndpointTypesClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *AvailablePrivateEndpointTypesClient) listHandleResponse(resp *http.Response, successCodes ...int) (AvailablePrivateEndpointTypesClientListResponse, error) {
...
func (client *AvailablePrivateEndpointTypesClient) NewListByResourceGroupPager(location string, resourceGroupName string, options *AvailablePrivateEndpointTypesClientListByResourceGroupOptions) *runtime.Pager[AvailablePrivateEndpointTypesClientListByResourceGroupResponse] {
	return runtime.NewPager(runtime.PagingHandler[AvailablePrivateEndpointTypesClientListByResourceGroupResponse]{
		...
		Fetcher: func(ctx context.Context, page *AvailablePrivateEndpointTypesClientListByResourceGroupResponse) (AvailablePrivateEndpointTypesClientListByResourceGroupResponse, error) {
			...
			req, err := client.listByResourceGroupCreateRequest(ctx, location, resourceGroupName, nextLink, options)
			if err != nil {
...
func (client *AvailablePrivateEndpointTypesClient) listByResourceGroupCreateRequest(ctx context.Context, location string, resourceGroupName string, nextLink string, _ *AvailablePrivateEndpointTypesClientListByResourceGroupOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
	var req *policy.Request
	var err error
	if firstPage {
...
func (client *AvailablePrivateEndpointTypesClient) listByResourceGroupHandleResponse(resp *http.Response, successCodes ...int) (AvailablePrivateEndpointTypesClientListByResourceGroupResponse, error) {
