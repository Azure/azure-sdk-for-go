...
//     method.
func (client *AvailablePrivateEndpointTypesClient) NewListByResourceGroupPager(resourceGroupName string, location string, options *AvailablePrivateEndpointTypesClientListByResourceGroupOptions) *runtime.Pager[AvailablePrivateEndpointTypesClientListByResourceGroupResponse] {
...
func (client *AvailablePrivateEndpointTypesClient) listByResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, location string, _ *AvailablePrivateEndpointTypesClientListByResourceGroupOptions) (*policy.Request, error) {
