...
//     method.
func (client *AvailableResourceGroupDelegationsClient) NewListPager(resourceGroupName string, location string, options *AvailableResourceGroupDelegationsClientListOptions) *runtime.Pager[AvailableResourceGroupDelegationsClientListResponse] {
	return runtime.NewPager(runtime.PagingHandler[AvailableResourceGroupDelegationsClientListResponse]{
		...
		Fetcher: func(ctx context.Context, page *AvailableResourceGroupDelegationsClientListResponse) (AvailableResourceGroupDelegationsClientListResponse, error) {
			...
			resp, err := runtime.FetcherForNextLink(ctx, client.internal.Pipeline(), nextLink, func(ctx context.Context) (*policy.Request, error) {
				return client.listCreateRequest(ctx, resourceGroupName, location, options)
			}, nil)
			if err != nil {
...
func (client *AvailableResourceGroupDelegationsClient) listCreateRequest(ctx context.Context, resourceGroupName string, location string, _ *AvailableResourceGroupDelegationsClientListOptions) (*policy.Request, error) {
