...
// Generated from example definition: 2025-07-01/AvailableDelegationsResourceGroupGet.json
func ExampleAvailableResourceGroupDelegationsClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armnetwork.AvailableResourceGroupDelegationsClientListResponse{
		...
		// 				},
		// 				ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.Network/availableDelegations/Microsoft.Provider.resourceType"),
