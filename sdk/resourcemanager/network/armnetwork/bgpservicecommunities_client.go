...
func (client *BgpServiceCommunitiesClient) listCreateRequest(ctx context.Context, nextLink string, _ *BgpServiceCommunitiesClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *BgpServiceCommunitiesClient) listHandleResponse(resp *http.Response, successCodes ...int) (BgpServiceCommunitiesClientListResponse, error) {
