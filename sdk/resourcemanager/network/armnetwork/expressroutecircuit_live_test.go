...
func (testsuite *ExpressRouteCircuitTestSuite) SetupSuite() {
	...
	testsuite.circuitName = testutil.GenerateAlphaNumericID(testsuite.T(), "circuitnam", 6)
	testsuite.connectionName = testutil.GenerateAlphaNumericID(testsuite.T(), "connerc", 6)
