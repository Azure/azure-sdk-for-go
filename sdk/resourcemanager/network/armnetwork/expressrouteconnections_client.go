...
//   - expressRouteGatewayName - The name of the express route gateway.
//   - connectionName - The name of the express route connection.
...
// NewListPager - Lists ExpressRouteConnections.
//
// Generated from API version 2025-05-01
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - expressRouteGatewayName - The name of the ExpressRoute gateway.
//   - options - ExpressRouteConnectionsClientListOptions contains the optional parameters for the ExpressRouteConnectionsClient.NewListPager
//     method.
func (client *ExpressRouteConnectionsClient) NewListPager(resourceGroupName string, expressRouteGatewayName string, options *ExpressRouteConnectionsClientListOptions) *runtime.Pager[ExpressRouteConnectionsClientListResponse] {
	return runtime.NewPager(runtime.PagingHandler[ExpressRouteConnectionsClientListResponse]{
		More: func(page ExpressRouteConnectionsClientListResponse) bool {
			return false
		},
		Fetcher: func(ctx context.Context, page *ExpressRouteConnectionsClientListResponse) (ExpressRouteConnectionsClientListResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "ExpressRouteConnectionsClient.NewListPager")
