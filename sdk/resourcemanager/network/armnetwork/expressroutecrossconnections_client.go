...
func (client *ExpressRouteCrossConnectionsClient) listCreateRequest(ctx context.Context, _ *ExpressRouteCrossConnectionsClientListOptions) (*policy.Request, error) {
