...
// NewListByResourceGroupPager - Lists ExpressRoute gateways in a given resource group.
//
// Generated from API version 2025-05-01
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - options - ExpressRouteGatewaysClientListByResourceGroupOptions contains the optional parameters for the ExpressRouteGatewaysClient.NewListByResourceGroupPager
//     method.
func (client *ExpressRouteGatewaysClient) NewListByResourceGroupPager(resourceGroupName string, options *ExpressRouteGatewaysClientListByResourceGroupOptions) *runtime.Pager[ExpressRouteGatewaysClientListByResourceGroupResponse] {
	return runtime.NewPager(runtime.PagingHandler[ExpressRouteGatewaysClientListByResourceGroupResponse]{
		More: func(page ExpressRouteGatewaysClientListByResourceGroupResponse) bool {
			return false
		},
		Fetcher: func(ctx context.Context, page *ExpressRouteGatewaysClientListByResourceGroupResponse) (ExpressRouteGatewaysClientListByResourceGroupResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "ExpressRouteGatewaysClient.NewListByResourceGroupPager")
...
// NewListBySubscriptionPager - Lists ExpressRoute gateways under a given subscription.
//
// Generated from API version 2025-05-01
//   - options - ExpressRouteGatewaysClientListBySubscriptionOptions contains the optional parameters for the ExpressRouteGatewaysClient.NewListBySubscriptionPager
//     method.
func (client *ExpressRouteGatewaysClient) NewListBySubscriptionPager(options *ExpressRouteGatewaysClientListBySubscriptionOptions) *runtime.Pager[ExpressRouteGatewaysClientListBySubscriptionResponse] {
	return runtime.NewPager(runtime.PagingHandler[ExpressRouteGatewaysClientListBySubscriptionResponse]{
		More: func(page ExpressRouteGatewaysClientListBySubscriptionResponse) bool {
			return false
		},
		Fetcher: func(ctx context.Context, page *ExpressRouteGatewaysClientListBySubscriptionResponse) (ExpressRouteGatewaysClientListBySubscriptionResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "ExpressRouteGatewaysClient.NewListBySubscriptionPager")
