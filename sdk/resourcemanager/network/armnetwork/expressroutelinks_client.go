...
func (client *ExpressRouteLinksClient) getHandleResponse(resp *http.Response, successCodes ...int) (ExpressRouteLinksClientGetResponse, error) {
...
func (client *ExpressRouteLinksClient) listCreateRequest(ctx context.Context, resourceGroupName string, expressRoutePortName string, nextLink string, _ *ExpressRouteLinksClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *ExpressRouteLinksClient) listHandleResponse(resp *http.Response, successCodes ...int) (ExpressRouteLinksClientListResponse, error) {
