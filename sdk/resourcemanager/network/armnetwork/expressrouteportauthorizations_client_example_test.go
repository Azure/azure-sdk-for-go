...
// Generated from example definition: 2026-01-01/ExpressRoutePortAuthorizationCreate.json
...
// Generated from example definition: 2026-01-01/ExpressRoutePortAuthorizationDelete.json
...
// Generated from example definition: 2026-01-01/ExpressRoutePortAuthorizationGet.json
...
// Generated from example definition: 2026-01-01/ExpressRoutePortAuthorizationList.json
...
// Generated from example definition: 2026-01-01/ExpressRoutePortAuthorizationListKeys.json
func ExampleExpressRoutePortAuthorizationsClient_ListKeys() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	res, err := clientFactory.NewExpressRoutePortAuthorizationsClient().ListKeys(ctx, "rg1", "expressRoutePortName", "authorizationName", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armnetwork.ExpressRoutePortAuthorizationsClientListKeysResponse{
