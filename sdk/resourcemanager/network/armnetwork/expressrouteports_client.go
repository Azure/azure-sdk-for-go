...
func (client *ExpressRoutePortsClient) generateLOACreateRequest(ctx context.Context, resourceGroupName string, expressRoutePortName string, request GenerateExpressRoutePortsLOARequest, _ *ExpressRoutePortsClientGenerateLOAOptions) (*policy.Request, error) {
...
func (client *ExpressRoutePortsClient) generateLOAHandleResponse(resp *http.Response, successCodes ...int) (ExpressRoutePortsClientGenerateLOAResponse, error) {
...
func (client *ExpressRoutePortsClient) getCreateRequest(ctx context.Context, resourceGroupName string, expressRoutePortName string, _ *ExpressRoutePortsClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/ExpressRoutePorts/{expressRoutePortName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter subscriptionID cannot be empty")
	}
...
func (client *ExpressRoutePortsClient) getHandleResponse(resp *http.Response, successCodes ...int) (ExpressRoutePortsClientGetResponse, error) {
...
func (client *ExpressRoutePortsClient) listByResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, nextLink string, _ *ExpressRoutePortsClientListByResourceGroupOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
	var req *policy.Request
	var err error
	if firstPage {
...
func (client *ExpressRoutePortsClient) listByResourceGroupHandleResponse(resp *http.Response, successCodes ...int) (ExpressRoutePortsClientListByResourceGroupResponse, error) {
...
func (client *ExpressRoutePortsClient) updateTagsCreateRequest(ctx context.Context, resourceGroupName string, expressRoutePortName string, parameters TagsObject, _ *ExpressRoutePortsClientUpdateTagsOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/ExpressRoutePorts/{expressRoutePortName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter subscriptionID cannot be empty")
	}
...
func (client *ExpressRoutePortsClient) updateTagsHandleResponse(resp *http.Response, successCodes ...int) (ExpressRoutePortsClientUpdateTagsResponse, error) {
