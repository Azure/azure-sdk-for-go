...
type AvailableResourceGroupDelegationsServer struct {
	...
	NewListPager func(resourceGroupName string, location string, options *armnetwork.AvailableResourceGroupDelegationsClientListOptions) (resp azfake.PagerResponder[armnetwork.AvailableResourceGroupDelegationsClientListResponse])
}
...
func (a *AvailableResourceGroupDelegationsServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		resp := a.srv.NewListPager(resourceGroupNameParam, locationParam, nil)
		newListPager = &resp
