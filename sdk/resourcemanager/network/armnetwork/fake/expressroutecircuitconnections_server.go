...
func (e *ExpressRouteCircuitConnectionsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if expressRouteCircuitConnectionsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = expressRouteCircuitConnectionsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to ExpressRouteCircuitConnectionsServerTransport
var expressRouteCircuitConnectionsServerTransportInterceptor interface {
