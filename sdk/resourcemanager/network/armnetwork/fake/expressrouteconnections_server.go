...
type ExpressRouteConnectionsServer struct {
	...
	// NewListPager is the fake for method ExpressRouteConnectionsClient.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager func(resourceGroupName string, expressRouteGatewayName string, options *armnetwork.ExpressRouteConnectionsClientListOptions) (resp azfake.PagerResponder[armnetwork.ExpressRouteConnectionsClientListResponse])
}
...
func NewExpressRouteConnectionsServerTransport(srv *ExpressRouteConnectionsServer) *ExpressRouteConnectionsServerTransport {
	return &ExpressRouteConnectionsServerTransport{
		...
		newListPager:        newTracker[azfake.PagerResponder[armnetwork.ExpressRouteConnectionsClientListResponse]](),
	}
}
...
type ExpressRouteConnectionsServerTransport struct {
	...
	newListPager        *tracker[azfake.PagerResponder[armnetwork.ExpressRouteConnectionsClientListResponse]]
}
...
func (e *ExpressRouteConnectionsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		if !intercepted {
			...
			case "ExpressRouteConnectionsClient.NewListPager":
...
func (e *ExpressRouteConnectionsServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		resp := e.srv.NewListPager(resourceGroupNameParam, expressRouteGatewayNameParam, nil)
		newListPager = &resp
