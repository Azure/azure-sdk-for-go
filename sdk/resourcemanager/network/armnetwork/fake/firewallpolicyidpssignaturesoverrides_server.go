...
type FirewallPolicyIdpsSignaturesOverridesServer struct {
	...
	// NewListPager is the fake for method FirewallPolicyIdpsSignaturesOverridesClient.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager func(resourceGroupName string, firewallPolicyName string, options *armnetwork.FirewallPolicyIdpsSignaturesOverridesClientListOptions) (resp azfake.PagerResponder[armnetwork.FirewallPolicyIdpsSignaturesOverridesClientListResponse])
...
func NewFirewallPolicyIdpsSignaturesOverridesServerTransport(srv *FirewallPolicyIdpsSignaturesOverridesServer) *FirewallPolicyIdpsSignaturesOverridesServerTransport {
	return &FirewallPolicyIdpsSignaturesOverridesServerTransport{
		srv:          srv,
		newListPager: newTracker[azfake.PagerResponder[armnetwork.FirewallPolicyIdpsSignaturesOverridesClientListResponse]](),
	}
}
...
type FirewallPolicyIdpsSignaturesOverridesServerTransport struct {
	...
	newListPager *tracker[azfake.PagerResponder[armnetwork.FirewallPolicyIdpsSignaturesOverridesClientListResponse]]
}
...
func (f *FirewallPolicyIdpsSignaturesOverridesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		if !intercepted {
			...
			case "FirewallPolicyIdpsSignaturesOverridesClient.NewListPager":
...
func (f *FirewallPolicyIdpsSignaturesOverridesServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
