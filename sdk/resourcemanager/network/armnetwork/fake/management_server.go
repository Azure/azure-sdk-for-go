...
type ManagementServer struct {
	...
	// NewListActiveConnectivityConfigurationsPager is the fake for method ManagementClient.NewListActiveConnectivityConfigurationsPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListActiveConnectivityConfigurationsPager func(resourceGroupName string, networkManagerName string, parameters armnetwork.ActiveConfigurationParameter, options *armnetwork.ManagementClientListActiveConnectivityConfigurationsOptions) (resp azfake.PagerResponder[armnetwork.ManagementClientListActiveConnectivityConfigurationsResponse])

	// NewListActiveSecurityAdminRulesPager is the fake for method ManagementClient.NewListActiveSecurityAdminRulesPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListActiveSecurityAdminRulesPager func(resourceGroupName string, networkManagerName string, parameters armnetwork.ActiveConfigurationParameter, options *armnetwork.ManagementClientListActiveSecurityAdminRulesOptions) (resp azfake.PagerResponder[armnetwork.ManagementClientListActiveSecurityAdminRulesResponse])

	// NewListNetworkManagerEffectiveConnectivityConfigurationsPager is the fake for method ManagementClient.NewListNetworkManagerEffectiveConnectivityConfigurationsPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListNetworkManagerEffectiveConnectivityConfigurationsPager func(resourceGroupName string, virtualNetworkName string, parameters armnetwork.QueryRequestOptions, options *armnetwork.ManagementClientListNetworkManagerEffectiveConnectivityConfigurationsOptions) (resp azfake.PagerResponder[armnetwork.ManagementClientListNetworkManagerEffectiveConnectivityConfigurationsResponse])

	// NewListNetworkManagerEffectiveSecurityAdminRulesPager is the fake for method ManagementClient.NewListNetworkManagerEffectiveSecurityAdminRulesPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListNetworkManagerEffectiveSecurityAdminRulesPager func(resourceGroupName string, virtualNetworkName string, parameters armnetwork.QueryRequestOptions, options *armnetwork.ManagementClientListNetworkManagerEffectiveSecurityAdminRulesOptions) (resp azfake.PagerResponder[armnetwork.ManagementClientListNetworkManagerEffectiveSecurityAdminRulesResponse])
...
func NewManagementServerTransport(srv *ManagementServer) *ManagementServerTransport {
	return &ManagementServerTransport{
		...
		newListActiveConnectivityConfigurationsPager:                  newTracker[azfake.PagerResponder[armnetwork.ManagementClientListActiveConnectivityConfigurationsResponse]](),
		newListActiveSecurityAdminRulesPager:                          newTracker[azfake.PagerResponder[armnetwork.ManagementClientListActiveSecurityAdminRulesResponse]](),
		newListNetworkManagerEffectiveConnectivityConfigurationsPager: newTracker[azfake.PagerResponder[armnetwork.ManagementClientListNetworkManagerEffectiveConnectivityConfigurationsResponse]](),
		newListNetworkManagerEffectiveSecurityAdminRulesPager:         newTracker[azfake.PagerResponder[armnetwork.ManagementClientListNetworkManagerEffectiveSecurityAdminRulesResponse]](),
...
type ManagementServerTransport struct {
	...
	newListActiveConnectivityConfigurationsPager                  *tracker[azfake.PagerResponder[armnetwork.ManagementClientListActiveConnectivityConfigurationsResponse]]
	newListActiveSecurityAdminRulesPager                          *tracker[azfake.PagerResponder[armnetwork.ManagementClientListActiveSecurityAdminRulesResponse]]
	newListNetworkManagerEffectiveConnectivityConfigurationsPager *tracker[azfake.PagerResponder[armnetwork.ManagementClientListNetworkManagerEffectiveConnectivityConfigurationsResponse]]
	newListNetworkManagerEffectiveSecurityAdminRulesPager         *tracker[azfake.PagerResponder[armnetwork.ManagementClientListNetworkManagerEffectiveSecurityAdminRulesResponse]]
...
func (m *ManagementServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		if !intercepted {
			...
			case "ManagementClient.NewListActiveConnectivityConfigurationsPager":
				res.resp, res.err = m.dispatchNewListActiveConnectivityConfigurationsPager(req)
			case "ManagementClient.NewListActiveSecurityAdminRulesPager":
				res.resp, res.err = m.dispatchNewListActiveSecurityAdminRulesPager(req)
			case "ManagementClient.NewListNetworkManagerEffectiveConnectivityConfigurationsPager":
				res.resp, res.err = m.dispatchNewListNetworkManagerEffectiveConnectivityConfigurationsPager(req)
			case "ManagementClient.NewListNetworkManagerEffectiveSecurityAdminRulesPager":
				res.resp, res.err = m.dispatchNewListNetworkManagerEffectiveSecurityAdminRulesPager(req)
...
func (m *ManagementServerTransport) dispatchNewListActiveConnectivityConfigurationsPager(req *http.Request) (*http.Response, error) {
	if m.srv.NewListActiveConnectivityConfigurationsPager == nil {
		return nil, &nonRetriableError{errors.New("fake for method NewListActiveConnectivityConfigurationsPager not implemented")}
	}
	newListActiveConnectivityConfigurationsPager := m.newListActiveConnectivityConfigurationsPager.get(req)
	if newListActiveConnectivityConfigurationsPager == nil {
		...
		resp := m.srv.NewListActiveConnectivityConfigurationsPager(resourceGroupNameParam, networkManagerNameParam, body, options)
		newListActiveConnectivityConfigurationsPager = &resp
		m.newListActiveConnectivityConfigurationsPager.add(req, newListActiveConnectivityConfigurationsPager)
	}
	resp, err := server.PagerResponderNext(newListActiveConnectivityConfigurationsPager, req)
	if err != nil {
		return nil, err
	}
	if !contains([]int{http.StatusOK}, resp.StatusCode) {
		m.newListActiveConnectivityConfigurationsPager.remove(req)
		return nil, &nonRetriableError{fmt.Errorf("unexpected status code %d. acceptable values are http.StatusOK", resp.StatusCode)}
	}
	if !server.PagerResponderMore(newListActiveConnectivityConfigurationsPager) {
		m.newListActiveConnectivityConfigurationsPager.remove(req)
	}
	return resp, nil
}

func (m *ManagementServerTransport) dispatchNewListActiveSecurityAdminRulesPager(req *http.Request) (*http.Response, error) {
	if m.srv.NewListActiveSecurityAdminRulesPager == nil {
		return nil, &nonRetriableError{errors.New("fake for method NewListActiveSecurityAdminRulesPager not implemented")}
	}
	newListActiveSecurityAdminRulesPager := m.newListActiveSecurityAdminRulesPager.get(req)
	if newListActiveSecurityAdminRulesPager == nil {
		...
		resp := m.srv.NewListActiveSecurityAdminRulesPager(resourceGroupNameParam, networkManagerNameParam, body, options)
		newListActiveSecurityAdminRulesPager = &resp
		m.newListActiveSecurityAdminRulesPager.add(req, newListActiveSecurityAdminRulesPager)
	}
	resp, err := server.PagerResponderNext(newListActiveSecurityAdminRulesPager, req)
	if err != nil {
		return nil, err
	}
	if !contains([]int{http.StatusOK}, resp.StatusCode) {
		m.newListActiveSecurityAdminRulesPager.remove(req)
		return nil, &nonRetriableError{fmt.Errorf("unexpected status code %d. acceptable values are http.StatusOK", resp.StatusCode)}
	}
	if !server.PagerResponderMore(newListActiveSecurityAdminRulesPager) {
		m.newListActiveSecurityAdminRulesPager.remove(req)
	}
	return resp, nil
}

func (m *ManagementServerTransport) dispatchNewListNetworkManagerEffectiveConnectivityConfigurationsPager(req *http.Request) (*http.Response, error) {
	if m.srv.NewListNetworkManagerEffectiveConnectivityConfigurationsPager == nil {
	...
	newListNetworkManagerEffectiveConnectivityConfigurationsPager := m.newListNetworkManagerEffectiveConnectivityConfigurationsPager.get(req)
	if newListNetworkManagerEffectiveConnectivityConfigurationsPager == nil {
		...
		resp := m.srv.NewListNetworkManagerEffectiveConnectivityConfigurationsPager(resourceGroupNameParam, virtualNetworkNameParam, body, options)
		newListNetworkManagerEffectiveConnectivityConfigurationsPager = &resp
		m.newListNetworkManagerEffectiveConnectivityConfigurationsPager.add(req, newListNetworkManagerEffectiveConnectivityConfigurationsPager)
	}
	...
	if !contains([]int{http.StatusOK}, resp.StatusCode) {
		m.newListNetworkManagerEffectiveConnectivityConfigurationsPager.remove(req)
		return nil, &nonRetriableError{fmt.Errorf("unexpected status code %d. acceptable values are http.StatusOK", resp.StatusCode)}
	}
...
func (m *ManagementServerTransport) dispatchNewListNetworkManagerEffectiveSecurityAdminRulesPager(req *http.Request) (*http.Response, error) {
	if m.srv.NewListNetworkManagerEffectiveSecurityAdminRulesPager == nil {
	...
	newListNetworkManagerEffectiveSecurityAdminRulesPager := m.newListNetworkManagerEffectiveSecurityAdminRulesPager.get(req)
	if newListNetworkManagerEffectiveSecurityAdminRulesPager == nil {
		...
		resp := m.srv.NewListNetworkManagerEffectiveSecurityAdminRulesPager(resourceGroupNameParam, virtualNetworkNameParam, body, options)
		newListNetworkManagerEffectiveSecurityAdminRulesPager = &resp
		m.newListNetworkManagerEffectiveSecurityAdminRulesPager.add(req, newListNetworkManagerEffectiveSecurityAdminRulesPager)
	}
	...
	if !contains([]int{http.StatusOK}, resp.StatusCode) {
		m.newListNetworkManagerEffectiveSecurityAdminRulesPager.remove(req)
		return nil, &nonRetriableError{fmt.Errorf("unexpected status code %d. acceptable values are http.StatusOK", resp.StatusCode)}
	}
