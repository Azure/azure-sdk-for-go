...
type ManagersServer struct {
	...
	// NewListActiveConnectivityConfigurationsPager is the fake for method ManagersClient.NewListActiveConnectivityConfigurationsPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListActiveConnectivityConfigurationsPager func(resourceGroupName string, networkManagerName string, parameters armnetwork.ActiveConfigurationParameter, options *armnetwork.ManagersClientListActiveConnectivityConfigurationsOptions) (resp azfake.PagerResponder[armnetwork.ManagersClientListActiveConnectivityConfigurationsResponse])

	// NewListActiveSecurityAdminRulesPager is the fake for method ManagersClient.NewListActiveSecurityAdminRulesPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListActiveSecurityAdminRulesPager func(resourceGroupName string, networkManagerName string, parameters armnetwork.ActiveConfigurationParameter, options *armnetwork.ManagersClientListActiveSecurityAdminRulesOptions) (resp azfake.PagerResponder[armnetwork.ManagersClientListActiveSecurityAdminRulesResponse])
...
func NewManagersServerTransport(srv *ManagersServer) *ManagersServerTransport {
	return &ManagersServerTransport{
		...
		newListActiveConnectivityConfigurationsPager: newTracker[azfake.PagerResponder[armnetwork.ManagersClientListActiveConnectivityConfigurationsResponse]](),
		newListActiveSecurityAdminRulesPager:         newTracker[azfake.PagerResponder[armnetwork.ManagersClientListActiveSecurityAdminRulesResponse]](),
...
type ManagersServerTransport struct {
	...
	newListActiveConnectivityConfigurationsPager *tracker[azfake.PagerResponder[armnetwork.ManagersClientListActiveConnectivityConfigurationsResponse]]
	newListActiveSecurityAdminRulesPager         *tracker[azfake.PagerResponder[armnetwork.ManagersClientListActiveSecurityAdminRulesResponse]]
...
func (m *ManagersServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		if !intercepted {
			...
			case "ManagersClient.NewListActiveConnectivityConfigurationsPager":
				res.resp, res.err = m.dispatchNewListActiveConnectivityConfigurationsPager(req)
			case "ManagersClient.NewListActiveSecurityAdminRulesPager":
...
func (m *ManagersServerTransport) dispatchNewListActiveConnectivityConfigurationsPager(req *http.Request) (*http.Response, error) {
	...
	if newListActiveConnectivityConfigurationsPager == nil {
		...
		var options *armnetwork.ManagersClientListActiveConnectivityConfigurationsOptions
		if topParam != nil {
			options = &armnetwork.ManagersClientListActiveConnectivityConfigurationsOptions{
				Top: topParam,
			}
		}
...
func (m *ManagersServerTransport) dispatchNewListActiveSecurityAdminRulesPager(req *http.Request) (*http.Response, error) {
	...
	if newListActiveSecurityAdminRulesPager == nil {
		...
		var options *armnetwork.ManagersClientListActiveSecurityAdminRulesOptions
		if topParam != nil {
			options = &armnetwork.ManagersClientListActiveSecurityAdminRulesOptions{
				Top: topParam,
			}
