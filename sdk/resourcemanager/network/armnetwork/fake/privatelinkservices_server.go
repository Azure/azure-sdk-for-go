...
type PrivateLinkServicesServer struct {
	...
	// HTTP status codes to indicate success: http.StatusOK
	NewListAutoApprovedPrivateLinkServicesByResourceGroupPager func(resourceGroupName string, location string, options *armnetwork.PrivateLinkServicesClientListAutoApprovedPrivateLinkServicesByResourceGroupOptions) (resp azfake.PagerResponder[armnetwork.PrivateLinkServicesClientListAutoApprovedPrivateLinkServicesByResourceGroupResponse])
...
func (p *PrivateLinkServicesServerTransport) dispatchBeginCheckPrivateLinkServiceVisibilityByResourceGroup(req *http.Request) (*http.Response, error) {
	...
	if beginCheckPrivateLinkServiceVisibilityByResourceGroup == nil {
		...
		respr, errRespr := p.srv.BeginCheckPrivateLinkServiceVisibilityByResourceGroup(req.Context(), resourceGroupNameParam, locationParam, body, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
...
func (p *PrivateLinkServicesServerTransport) dispatchNewListAutoApprovedPrivateLinkServicesByResourceGroupPager(req *http.Request) (*http.Response, error) {
	...
	if newListAutoApprovedPrivateLinkServicesByResourceGroupPager == nil {
		...
		resp := p.srv.NewListAutoApprovedPrivateLinkServicesByResourceGroupPager(resourceGroupNameParam, locationParam, nil)
