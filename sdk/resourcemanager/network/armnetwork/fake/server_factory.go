...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "ConnectionPoliciesClient":
		initServer(&s.trMu, &s.trConnectionPoliciesServer, func() *ConnectionPoliciesServerTransport {
			return NewConnectionPoliciesServerTransport(&s.srv.ConnectionPoliciesServer)
		})
	...
	case "InterconnectGroupsClient":
		initServer(&s.trMu, &s.trInterconnectGroupsServer, func() *InterconnectGroupsServerTransport {
			return NewInterconnectGroupsServerTransport(&s.srv.InterconnectGroupsServer)
		})
