...
type ServerFactory struct {
	...
	// CommitsServer contains the fakes for client CommitsClient
	CommitsServer CommitsServer
	...
	// ConnectionPoliciesServer contains the fakes for client ConnectionPoliciesClient
	ConnectionPoliciesServer ConnectionPoliciesServer
	...
	// InterconnectGroupsServer contains the fakes for client InterconnectGroupsClient
	InterconnectGroupsServer InterconnectGroupsServer
	...
	// SubgroupsServer contains the fakes for client SubgroupsClient
	SubgroupsServer SubgroupsServer
...
type ServerFactoryTransport struct {
	...
	trCommitsServer *CommitsServerTransport
	...
	trConnectionPoliciesServer *ConnectionPoliciesServerTransport
	...
	trInterconnectGroupsServer *InterconnectGroupsServerTransport
	...
	trSubgroupsServer *SubgroupsServerTransport
...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "AdminRuleCollectionsClient":
		initServer(&s.trMu, &s.trAdminRuleCollectionsServer, func() *AdminRuleCollectionsServerTransport { return NewAdminRuleCollectionsServerTransport(&s.srv.AdminRuleCollectionsServer) })
		resp, err = s.trAdminRuleCollectionsServer.Do(req)
	case "AdminRulesClient":
		initServer(&s.trMu, &s.trAdminRulesServer, func() *AdminRulesServerTransport { return NewAdminRulesServerTransport(&s.srv.AdminRulesServer) })
		resp, err = s.trAdminRulesServer.Do(req)
	case "ApplicationGatewayPrivateEndpointConnectionsClient":
		initServer(&s.trMu, &s.trApplicationGatewayPrivateEndpointConnectionsServer, func() *ApplicationGatewayPrivateEndpointConnectionsServerTransport { return NewApplicationGatewayPrivateEndpointConnectionsServerTransport(&s.srv.ApplicationGatewayPrivateEndpointConnectionsServer) })
		resp, err = s.trApplicationGatewayPrivateEndpointConnectionsServer.Do(req)
	case "ApplicationGatewayPrivateLinkResourcesClient":
		initServer(&s.trMu, &s.trApplicationGatewayPrivateLinkResourcesServer, func() *ApplicationGatewayPrivateLinkResourcesServerTransport { return NewApplicationGatewayPrivateLinkResourcesServerTransport(&s.srv.ApplicationGatewayPrivateLinkResourcesServer) })
		resp, err = s.trApplicationGatewayPrivateLinkResourcesServer.Do(req)
	case "ApplicationGatewayWafDynamicManifestsClient":
		initServer(&s.trMu, &s.trApplicationGatewayWafDynamicManifestsServer, func() *ApplicationGatewayWafDynamicManifestsServerTransport { return NewApplicationGatewayWafDynamicManifestsServerTransport(&s.srv.ApplicationGatewayWafDynamicManifestsServer) })
		resp, err = s.trApplicationGatewayWafDynamicManifestsServer.Do(req)
	case "ApplicationGatewayWafDynamicManifestsDefaultClient":
		initServer(&s.trMu, &s.trApplicationGatewayWafDynamicManifestsDefaultServer, func() *ApplicationGatewayWafDynamicManifestsDefaultServerTransport { return NewApplicationGatewayWafDynamicManifestsDefaultServerTransport(&s.srv.ApplicationGatewayWafDynamicManifestsDefaultServer) })
		resp, err = s.trApplicationGatewayWafDynamicManifestsDefaultServer.Do(req)
	case "ApplicationGatewaysClient":
		initServer(&s.trMu, &s.trApplicationGatewaysServer, func() *ApplicationGatewaysServerTransport { return NewApplicationGatewaysServerTransport(&s.srv.ApplicationGatewaysServer) })
		resp, err = s.trApplicationGatewaysServer.Do(req)
	case "ApplicationSecurityGroupsClient":
		initServer(&s.trMu, &s.trApplicationSecurityGroupsServer, func() *ApplicationSecurityGroupsServerTransport { return NewApplicationSecurityGroupsServerTransport(&s.srv.ApplicationSecurityGroupsServer) })
		resp, err = s.trApplicationSecurityGroupsServer.Do(req)
	case "AvailableDelegationsClient":
		initServer(&s.trMu, &s.trAvailableDelegationsServer, func() *AvailableDelegationsServerTransport { return NewAvailableDelegationsServerTransport(&s.srv.AvailableDelegationsServer) })
		resp, err = s.trAvailableDelegationsServer.Do(req)
	case "AvailableEndpointServicesClient":
		initServer(&s.trMu, &s.trAvailableEndpointServicesServer, func() *AvailableEndpointServicesServerTransport { return NewAvailableEndpointServicesServerTransport(&s.srv.AvailableEndpointServicesServer) })
		resp, err = s.trAvailableEndpointServicesServer.Do(req)
	case "AvailablePrivateEndpointTypesClient":
		initServer(&s.trMu, &s.trAvailablePrivateEndpointTypesServer, func() *AvailablePrivateEndpointTypesServerTransport { return NewAvailablePrivateEndpointTypesServerTransport(&s.srv.AvailablePrivateEndpointTypesServer) })
		resp, err = s.trAvailablePrivateEndpointTypesServer.Do(req)
	case "AvailableResourceGroupDelegationsClient":
		initServer(&s.trMu, &s.trAvailableResourceGroupDelegationsServer, func() *AvailableResourceGroupDelegationsServerTransport { return NewAvailableResourceGroupDelegationsServerTransport(&s.srv.AvailableResourceGroupDelegationsServer) })
		resp, err = s.trAvailableResourceGroupDelegationsServer.Do(req)
	case "AvailableServiceAliasesClient":
		initServer(&s.trMu, &s.trAvailableServiceAliasesServer, func() *AvailableServiceAliasesServerTransport { return NewAvailableServiceAliasesServerTransport(&s.srv.AvailableServiceAliasesServer) })
		resp, err = s.trAvailableServiceAliasesServer.Do(req)
	case "AzureFirewallFqdnTagsClient":
		initServer(&s.trMu, &s.trAzureFirewallFqdnTagsServer, func() *AzureFirewallFqdnTagsServerTransport { return NewAzureFirewallFqdnTagsServerTransport(&s.srv.AzureFirewallFqdnTagsServer) })
		resp, err = s.trAzureFirewallFqdnTagsServer.Do(req)
	case "AzureFirewallsClient":
		initServer(&s.trMu, &s.trAzureFirewallsServer, func() *AzureFirewallsServerTransport { return NewAzureFirewallsServerTransport(&s.srv.AzureFirewallsServer) })
		resp, err = s.trAzureFirewallsServer.Do(req)
	case "BastionHostsClient":
		initServer(&s.trMu, &s.trBastionHostsServer, func() *BastionHostsServerTransport { return NewBastionHostsServerTransport(&s.srv.BastionHostsServer) })
		resp, err = s.trBastionHostsServer.Do(req)
	case "BgpServiceCommunitiesClient":
		initServer(&s.trMu, &s.trBgpServiceCommunitiesServer, func() *BgpServiceCommunitiesServerTransport { return NewBgpServiceCommunitiesServerTransport(&s.srv.BgpServiceCommunitiesServer) })
		resp, err = s.trBgpServiceCommunitiesServer.Do(req)
	case "CommitsClient":
		initServer(&s.trMu, &s.trCommitsServer, func() *CommitsServerTransport { return NewCommitsServerTransport(&s.srv.CommitsServer) })
		resp, err = s.trCommitsServer.Do(req)
	case "ConfigurationPolicyGroupsClient":
		initServer(&s.trMu, &s.trConfigurationPolicyGroupsServer, func() *ConfigurationPolicyGroupsServerTransport { return NewConfigurationPolicyGroupsServerTransport(&s.srv.ConfigurationPolicyGroupsServer) })
		resp, err = s.trConfigurationPolicyGroupsServer.Do(req)
	case "ConnectionMonitorsClient":
		initServer(&s.trMu, &s.trConnectionMonitorsServer, func() *ConnectionMonitorsServerTransport { return NewConnectionMonitorsServerTransport(&s.srv.ConnectionMonitorsServer) })
		resp, err = s.trConnectionMonitorsServer.Do(req)
	case "ConnectionPoliciesClient":
		initServer(&s.trMu, &s.trConnectionPoliciesServer, func() *ConnectionPoliciesServerTransport { return NewConnectionPoliciesServerTransport(&s.srv.ConnectionPoliciesServer) })
		resp, err = s.trConnectionPoliciesServer.Do(req)
	case "ConnectivityConfigurationsClient":
		initServer(&s.trMu, &s.trConnectivityConfigurationsServer, func() *ConnectivityConfigurationsServerTransport { return NewConnectivityConfigurationsServerTransport(&s.srv.ConnectivityConfigurationsServer) })
		resp, err = s.trConnectivityConfigurationsServer.Do(req)
	case "CustomIPPrefixesClient":
		initServer(&s.trMu, &s.trCustomIPPrefixesServer, func() *CustomIPPrefixesServerTransport { return NewCustomIPPrefixesServerTransport(&s.srv.CustomIPPrefixesServer) })
		resp, err = s.trCustomIPPrefixesServer.Do(req)
	case "DdosCustomPoliciesClient":
		initServer(&s.trMu, &s.trDdosCustomPoliciesServer, func() *DdosCustomPoliciesServerTransport { return NewDdosCustomPoliciesServerTransport(&s.srv.DdosCustomPoliciesServer) })
		resp, err = s.trDdosCustomPoliciesServer.Do(req)
	case "DdosProtectionPlansClient":
		initServer(&s.trMu, &s.trDdosProtectionPlansServer, func() *DdosProtectionPlansServerTransport { return NewDdosProtectionPlansServerTransport(&s.srv.DdosProtectionPlansServer) })
		resp, err = s.trDdosProtectionPlansServer.Do(req)
	case "DefaultSecurityRulesClient":
		initServer(&s.trMu, &s.trDefaultSecurityRulesServer, func() *DefaultSecurityRulesServerTransport { return NewDefaultSecurityRulesServerTransport(&s.srv.DefaultSecurityRulesServer) })
		resp, err = s.trDefaultSecurityRulesServer.Do(req)
	case "DscpConfigurationClient":
		initServer(&s.trMu, &s.trDscpConfigurationServer, func() *DscpConfigurationServerTransport { return NewDscpConfigurationServerTransport(&s.srv.DscpConfigurationServer) })
		resp, err = s.trDscpConfigurationServer.Do(req)
	case "ExpressRouteCircuitAuthorizationsClient":
		initServer(&s.trMu, &s.trExpressRouteCircuitAuthorizationsServer, func() *ExpressRouteCircuitAuthorizationsServerTransport { return NewExpressRouteCircuitAuthorizationsServerTransport(&s.srv.ExpressRouteCircuitAuthorizationsServer) })
		resp, err = s.trExpressRouteCircuitAuthorizationsServer.Do(req)
	case "ExpressRouteCircuitConnectionsClient":
		initServer(&s.trMu, &s.trExpressRouteCircuitConnectionsServer, func() *ExpressRouteCircuitConnectionsServerTransport { return NewExpressRouteCircuitConnectionsServerTransport(&s.srv.ExpressRouteCircuitConnectionsServer) })
		resp, err = s.trExpressRouteCircuitConnectionsServer.Do(req)
	case "ExpressRouteCircuitPeeringsClient":
		initServer(&s.trMu, &s.trExpressRouteCircuitPeeringsServer, func() *ExpressRouteCircuitPeeringsServerTransport { return NewExpressRouteCircuitPeeringsServerTransport(&s.srv.ExpressRouteCircuitPeeringsServer) })
		resp, err = s.trExpressRouteCircuitPeeringsServer.Do(req)
	case "ExpressRouteCircuitsClient":
		initServer(&s.trMu, &s.trExpressRouteCircuitsServer, func() *ExpressRouteCircuitsServerTransport { return NewExpressRouteCircuitsServerTransport(&s.srv.ExpressRouteCircuitsServer) })
		resp, err = s.trExpressRouteCircuitsServer.Do(req)
	case "ExpressRouteConnectionsClient":
		initServer(&s.trMu, &s.trExpressRouteConnectionsServer, func() *ExpressRouteConnectionsServerTransport { return NewExpressRouteConnectionsServerTransport(&s.srv.ExpressRouteConnectionsServer) })
		resp, err = s.trExpressRouteConnectionsServer.Do(req)
	case "ExpressRouteCrossConnectionPeeringsClient":
		initServer(&s.trMu, &s.trExpressRouteCrossConnectionPeeringsServer, func() *ExpressRouteCrossConnectionPeeringsServerTransport { return NewExpressRouteCrossConnectionPeeringsServerTransport(&s.srv.ExpressRouteCrossConnectionPeeringsServer) })
		resp, err = s.trExpressRouteCrossConnectionPeeringsServer.Do(req)
	case "ExpressRouteCrossConnectionsClient":
		initServer(&s.trMu, &s.trExpressRouteCrossConnectionsServer, func() *ExpressRouteCrossConnectionsServerTransport { return NewExpressRouteCrossConnectionsServerTransport(&s.srv.ExpressRouteCrossConnectionsServer) })
		resp, err = s.trExpressRouteCrossConnectionsServer.Do(req)
	case "ExpressRouteGatewaysClient":
		initServer(&s.trMu, &s.trExpressRouteGatewaysServer, func() *ExpressRouteGatewaysServerTransport { return NewExpressRouteGatewaysServerTransport(&s.srv.ExpressRouteGatewaysServer) })
		resp, err = s.trExpressRouteGatewaysServer.Do(req)
	case "ExpressRouteLinksClient":
		initServer(&s.trMu, &s.trExpressRouteLinksServer, func() *ExpressRouteLinksServerTransport { return NewExpressRouteLinksServerTransport(&s.srv.ExpressRouteLinksServer) })
		resp, err = s.trExpressRouteLinksServer.Do(req)
	case "ExpressRoutePortAuthorizationsClient":
		initServer(&s.trMu, &s.trExpressRoutePortAuthorizationsServer, func() *ExpressRoutePortAuthorizationsServerTransport { return NewExpressRoutePortAuthorizationsServerTransport(&s.srv.ExpressRoutePortAuthorizationsServer) })
		resp, err = s.trExpressRoutePortAuthorizationsServer.Do(req)
	case "ExpressRoutePortsClient":
		initServer(&s.trMu, &s.trExpressRoutePortsServer, func() *ExpressRoutePortsServerTransport { return NewExpressRoutePortsServerTransport(&s.srv.ExpressRoutePortsServer) })
		resp, err = s.trExpressRoutePortsServer.Do(req)
	case "ExpressRoutePortsLocationsClient":
		initServer(&s.trMu, &s.trExpressRoutePortsLocationsServer, func() *ExpressRoutePortsLocationsServerTransport { return NewExpressRoutePortsLocationsServerTransport(&s.srv.ExpressRoutePortsLocationsServer) })
		resp, err = s.trExpressRoutePortsLocationsServer.Do(req)
	case "ExpressRouteProviderPortsLocationClient":
		initServer(&s.trMu, &s.trExpressRouteProviderPortsLocationServer, func() *ExpressRouteProviderPortsLocationServerTransport { return NewExpressRouteProviderPortsLocationServerTransport(&s.srv.ExpressRouteProviderPortsLocationServer) })
		resp, err = s.trExpressRouteProviderPortsLocationServer.Do(req)
	case "ExpressRouteServiceProvidersClient":
		initServer(&s.trMu, &s.trExpressRouteServiceProvidersServer, func() *ExpressRouteServiceProvidersServerTransport { return NewExpressRouteServiceProvidersServerTransport(&s.srv.ExpressRouteServiceProvidersServer) })
		resp, err = s.trExpressRouteServiceProvidersServer.Do(req)
	case "FirewallPoliciesClient":
		initServer(&s.trMu, &s.trFirewallPoliciesServer, func() *FirewallPoliciesServerTransport { return NewFirewallPoliciesServerTransport(&s.srv.FirewallPoliciesServer) })
		resp, err = s.trFirewallPoliciesServer.Do(req)
	case "FirewallPolicyDeploymentsClient":
		initServer(&s.trMu, &s.trFirewallPolicyDeploymentsServer, func() *FirewallPolicyDeploymentsServerTransport { return NewFirewallPolicyDeploymentsServerTransport(&s.srv.FirewallPolicyDeploymentsServer) })
		resp, err = s.trFirewallPolicyDeploymentsServer.Do(req)
	case "FirewallPolicyDraftsClient":
		initServer(&s.trMu, &s.trFirewallPolicyDraftsServer, func() *FirewallPolicyDraftsServerTransport { return NewFirewallPolicyDraftsServerTransport(&s.srv.FirewallPolicyDraftsServer) })
		resp, err = s.trFirewallPolicyDraftsServer.Do(req)
	case "FirewallPolicyIdpsSignaturesClient":
		initServer(&s.trMu, &s.trFirewallPolicyIdpsSignaturesServer, func() *FirewallPolicyIdpsSignaturesServerTransport { return NewFirewallPolicyIdpsSignaturesServerTransport(&s.srv.FirewallPolicyIdpsSignaturesServer) })
		resp, err = s.trFirewallPolicyIdpsSignaturesServer.Do(req)
	case "FirewallPolicyIdpsSignaturesFilterValuesClient":
		initServer(&s.trMu, &s.trFirewallPolicyIdpsSignaturesFilterValuesServer, func() *FirewallPolicyIdpsSignaturesFilterValuesServerTransport { return NewFirewallPolicyIdpsSignaturesFilterValuesServerTransport(&s.srv.FirewallPolicyIdpsSignaturesFilterValuesServer) })
		resp, err = s.trFirewallPolicyIdpsSignaturesFilterValuesServer.Do(req)
	case "FirewallPolicyIdpsSignaturesOverridesClient":
		initServer(&s.trMu, &s.trFirewallPolicyIdpsSignaturesOverridesServer, func() *FirewallPolicyIdpsSignaturesOverridesServerTransport { return NewFirewallPolicyIdpsSignaturesOverridesServerTransport(&s.srv.FirewallPolicyIdpsSignaturesOverridesServer) })
		resp, err = s.trFirewallPolicyIdpsSignaturesOverridesServer.Do(req)
	case "FirewallPolicyRuleCollectionGroupDraftsClient":
		initServer(&s.trMu, &s.trFirewallPolicyRuleCollectionGroupDraftsServer, func() *FirewallPolicyRuleCollectionGroupDraftsServerTransport { return NewFirewallPolicyRuleCollectionGroupDraftsServerTransport(&s.srv.FirewallPolicyRuleCollectionGroupDraftsServer) })
		resp, err = s.trFirewallPolicyRuleCollectionGroupDraftsServer.Do(req)
	case "FirewallPolicyRuleCollectionGroupsClient":
		initServer(&s.trMu, &s.trFirewallPolicyRuleCollectionGroupsServer, func() *FirewallPolicyRuleCollectionGroupsServerTransport { return NewFirewallPolicyRuleCollectionGroupsServerTransport(&s.srv.FirewallPolicyRuleCollectionGroupsServer) })
	...
	case "HubRouteTablesClient":
		initServer(&s.trMu, &s.trHubRouteTablesServer, func() *HubRouteTablesServerTransport { return NewHubRouteTablesServerTransport(&s.srv.HubRouteTablesServer) })
		resp, err = s.trHubRouteTablesServer.Do(req)
	case "HubVirtualNetworkConnectionsClient":
		initServer(&s.trMu, &s.trHubVirtualNetworkConnectionsServer, func() *HubVirtualNetworkConnectionsServerTransport { return NewHubVirtualNetworkConnectionsServerTransport(&s.srv.HubVirtualNetworkConnectionsServer) })
		resp, err = s.trHubVirtualNetworkConnectionsServer.Do(req)
	case "IPAllocationsClient":
		initServer(&s.trMu, &s.trIPAllocationsServer, func() *IPAllocationsServerTransport { return NewIPAllocationsServerTransport(&s.srv.IPAllocationsServer) })
		resp, err = s.trIPAllocationsServer.Do(req)
	case "IPGroupsClient":
		initServer(&s.trMu, &s.trIPGroupsServer, func() *IPGroupsServerTransport { return NewIPGroupsServerTransport(&s.srv.IPGroupsServer) })
		resp, err = s.trIPGroupsServer.Do(req)
	case "InboundNatRulesClient":
		initServer(&s.trMu, &s.trInboundNatRulesServer, func() *InboundNatRulesServerTransport { return NewInboundNatRulesServerTransport(&s.srv.InboundNatRulesServer) })
		resp, err = s.trInboundNatRulesServer.Do(req)
	case "InboundSecurityRuleClient":
		initServer(&s.trMu, &s.trInboundSecurityRuleServer, func() *InboundSecurityRuleServerTransport { return NewInboundSecurityRuleServerTransport(&s.srv.InboundSecurityRuleServer) })
		resp, err = s.trInboundSecurityRuleServer.Do(req)
	case "InterconnectGroupsClient":
		initServer(&s.trMu, &s.trInterconnectGroupsServer, func() *InterconnectGroupsServerTransport { return NewInterconnectGroupsServerTransport(&s.srv.InterconnectGroupsServer) })
		resp, err = s.trInterconnectGroupsServer.Do(req)
	case "InterfaceIPConfigurationsClient":
		initServer(&s.trMu, &s.trInterfaceIPConfigurationsServer, func() *InterfaceIPConfigurationsServerTransport { return NewInterfaceIPConfigurationsServerTransport(&s.srv.InterfaceIPConfigurationsServer) })
		resp, err = s.trInterfaceIPConfigurationsServer.Do(req)
	case "InterfaceLoadBalancersClient":
		initServer(&s.trMu, &s.trInterfaceLoadBalancersServer, func() *InterfaceLoadBalancersServerTransport { return NewInterfaceLoadBalancersServerTransport(&s.srv.InterfaceLoadBalancersServer) })
		resp, err = s.trInterfaceLoadBalancersServer.Do(req)
	case "InterfaceTapConfigurationsClient":
		initServer(&s.trMu, &s.trInterfaceTapConfigurationsServer, func() *InterfaceTapConfigurationsServerTransport { return NewInterfaceTapConfigurationsServerTransport(&s.srv.InterfaceTapConfigurationsServer) })
		resp, err = s.trInterfaceTapConfigurationsServer.Do(req)
	case "InterfacesClient":
		initServer(&s.trMu, &s.trInterfacesServer, func() *InterfacesServerTransport { return NewInterfacesServerTransport(&s.srv.InterfacesServer) })
		resp, err = s.trInterfacesServer.Do(req)
	case "IpamPoolsClient":
		initServer(&s.trMu, &s.trIpamPoolsServer, func() *IpamPoolsServerTransport { return NewIpamPoolsServerTransport(&s.srv.IpamPoolsServer) })
		resp, err = s.trIpamPoolsServer.Do(req)
	case "LoadBalancerBackendAddressPoolsClient":
		initServer(&s.trMu, &s.trLoadBalancerBackendAddressPoolsServer, func() *LoadBalancerBackendAddressPoolsServerTransport { return NewLoadBalancerBackendAddressPoolsServerTransport(&s.srv.LoadBalancerBackendAddressPoolsServer) })
		resp, err = s.trLoadBalancerBackendAddressPoolsServer.Do(req)
	case "LoadBalancerFrontendIPConfigurationsClient":
		initServer(&s.trMu, &s.trLoadBalancerFrontendIPConfigurationsServer, func() *LoadBalancerFrontendIPConfigurationsServerTransport { return NewLoadBalancerFrontendIPConfigurationsServerTransport(&s.srv.LoadBalancerFrontendIPConfigurationsServer) })
		resp, err = s.trLoadBalancerFrontendIPConfigurationsServer.Do(req)
	case "LoadBalancerLoadBalancingRulesClient":
		initServer(&s.trMu, &s.trLoadBalancerLoadBalancingRulesServer, func() *LoadBalancerLoadBalancingRulesServerTransport { return NewLoadBalancerLoadBalancingRulesServerTransport(&s.srv.LoadBalancerLoadBalancingRulesServer) })
		resp, err = s.trLoadBalancerLoadBalancingRulesServer.Do(req)
	case "LoadBalancerNetworkInterfacesClient":
		initServer(&s.trMu, &s.trLoadBalancerNetworkInterfacesServer, func() *LoadBalancerNetworkInterfacesServerTransport { return NewLoadBalancerNetworkInterfacesServerTransport(&s.srv.LoadBalancerNetworkInterfacesServer) })
		resp, err = s.trLoadBalancerNetworkInterfacesServer.Do(req)
	case "LoadBalancerOutboundRulesClient":
		initServer(&s.trMu, &s.trLoadBalancerOutboundRulesServer, func() *LoadBalancerOutboundRulesServerTransport { return NewLoadBalancerOutboundRulesServerTransport(&s.srv.LoadBalancerOutboundRulesServer) })
		resp, err = s.trLoadBalancerOutboundRulesServer.Do(req)
	case "LoadBalancerProbesClient":
		initServer(&s.trMu, &s.trLoadBalancerProbesServer, func() *LoadBalancerProbesServerTransport { return NewLoadBalancerProbesServerTransport(&s.srv.LoadBalancerProbesServer) })
		resp, err = s.trLoadBalancerProbesServer.Do(req)
	case "LoadBalancersClient":
		initServer(&s.trMu, &s.trLoadBalancersServer, func() *LoadBalancersServerTransport { return NewLoadBalancersServerTransport(&s.srv.LoadBalancersServer) })
		resp, err = s.trLoadBalancersServer.Do(req)
	case "LocalNetworkGatewaysClient":
		initServer(&s.trMu, &s.trLocalNetworkGatewaysServer, func() *LocalNetworkGatewaysServerTransport { return NewLocalNetworkGatewaysServerTransport(&s.srv.LocalNetworkGatewaysServer) })
	...
	case "ManagementGroupNetworkManagerConnectionsClient":
		initServer(&s.trMu, &s.trManagementGroupNetworkManagerConnectionsServer, func() *ManagementGroupNetworkManagerConnectionsServerTransport { return NewManagementGroupNetworkManagerConnectionsServerTransport(&s.srv.ManagementGroupNetworkManagerConnectionsServer) })
		resp, err = s.trManagementGroupNetworkManagerConnectionsServer.Do(req)
	case "ManagerCommitsClient":
		initServer(&s.trMu, &s.trManagerCommitsServer, func() *ManagerCommitsServerTransport { return NewManagerCommitsServerTransport(&s.srv.ManagerCommitsServer) })
		resp, err = s.trManagerCommitsServer.Do(req)
	case "ManagerDeploymentStatusClient":
		initServer(&s.trMu, &s.trManagerDeploymentStatusServer, func() *ManagerDeploymentStatusServerTransport { return NewManagerDeploymentStatusServerTransport(&s.srv.ManagerDeploymentStatusServer) })
		resp, err = s.trManagerDeploymentStatusServer.Do(req)
	case "ManagerRoutingConfigurationsClient":
		initServer(&s.trMu, &s.trManagerRoutingConfigurationsServer, func() *ManagerRoutingConfigurationsServerTransport { return NewManagerRoutingConfigurationsServerTransport(&s.srv.ManagerRoutingConfigurationsServer) })
		resp, err = s.trManagerRoutingConfigurationsServer.Do(req)
	case "ManagersClient":
		initServer(&s.trMu, &s.trManagersServer, func() *ManagersServerTransport { return NewManagersServerTransport(&s.srv.ManagersServer) })
	...
	case "NatRulesClient":
		initServer(&s.trMu, &s.trNatRulesServer, func() *NatRulesServerTransport { return NewNatRulesServerTransport(&s.srv.NatRulesServer) })
		resp, err = s.trNatRulesServer.Do(req)
	case "OperationsClient":
		initServer(&s.trMu, &s.trOperationsServer, func() *OperationsServerTransport { return NewOperationsServerTransport(&s.srv.OperationsServer) })
		resp, err = s.trOperationsServer.Do(req)
	case "P2SVPNGatewaysClient":
		initServer(&s.trMu, &s.trP2SVPNGatewaysServer, func() *P2SVPNGatewaysServerTransport { return NewP2SVPNGatewaysServerTransport(&s.srv.P2SVPNGatewaysServer) })
		resp, err = s.trP2SVPNGatewaysServer.Do(req)
	case "PacketCapturesClient":
		initServer(&s.trMu, &s.trPacketCapturesServer, func() *PacketCapturesServerTransport { return NewPacketCapturesServerTransport(&s.srv.PacketCapturesServer) })
		resp, err = s.trPacketCapturesServer.Do(req)
	case "PeerExpressRouteCircuitConnectionsClient":
		initServer(&s.trMu, &s.trPeerExpressRouteCircuitConnectionsServer, func() *PeerExpressRouteCircuitConnectionsServerTransport { return NewPeerExpressRouteCircuitConnectionsServerTransport(&s.srv.PeerExpressRouteCircuitConnectionsServer) })
		resp, err = s.trPeerExpressRouteCircuitConnectionsServer.Do(req)
	case "PrivateDNSZoneGroupsClient":
		initServer(&s.trMu, &s.trPrivateDNSZoneGroupsServer, func() *PrivateDNSZoneGroupsServerTransport { return NewPrivateDNSZoneGroupsServerTransport(&s.srv.PrivateDNSZoneGroupsServer) })
		resp, err = s.trPrivateDNSZoneGroupsServer.Do(req)
	case "PrivateEndpointsClient":
		initServer(&s.trMu, &s.trPrivateEndpointsServer, func() *PrivateEndpointsServerTransport { return NewPrivateEndpointsServerTransport(&s.srv.PrivateEndpointsServer) })
		resp, err = s.trPrivateEndpointsServer.Do(req)
	case "PrivateLinkServicesClient":
		initServer(&s.trMu, &s.trPrivateLinkServicesServer, func() *PrivateLinkServicesServerTransport { return NewPrivateLinkServicesServerTransport(&s.srv.PrivateLinkServicesServer) })
	...
	case "PublicIPAddressesClient":
		initServer(&s.trMu, &s.trPublicIPAddressesServer, func() *PublicIPAddressesServerTransport { return NewPublicIPAddressesServerTransport(&s.srv.PublicIPAddressesServer) })
		resp, err = s.trPublicIPAddressesServer.Do(req)
	case "PublicIPPrefixesClient":
		initServer(&s.trMu, &s.trPublicIPPrefixesServer, func() *PublicIPPrefixesServerTransport { return NewPublicIPPrefixesServerTransport(&s.srv.PublicIPPrefixesServer) })
		resp, err = s.trPublicIPPrefixesServer.Do(req)
	case "ReachabilityAnalysisIntentsClient":
		initServer(&s.trMu, &s.trReachabilityAnalysisIntentsServer, func() *ReachabilityAnalysisIntentsServerTransport { return NewReachabilityAnalysisIntentsServerTransport(&s.srv.ReachabilityAnalysisIntentsServer) })
		resp, err = s.trReachabilityAnalysisIntentsServer.Do(req)
	case "ReachabilityAnalysisRunsClient":
		initServer(&s.trMu, &s.trReachabilityAnalysisRunsServer, func() *ReachabilityAnalysisRunsServerTransport { return NewReachabilityAnalysisRunsServerTransport(&s.srv.ReachabilityAnalysisRunsServer) })
		resp, err = s.trReachabilityAnalysisRunsServer.Do(req)
	case "ResourceNavigationLinksClient":
		initServer(&s.trMu, &s.trResourceNavigationLinksServer, func() *ResourceNavigationLinksServerTransport { return NewResourceNavigationLinksServerTransport(&s.srv.ResourceNavigationLinksServer) })
		resp, err = s.trResourceNavigationLinksServer.Do(req)
	case "RouteFilterRulesClient":
		initServer(&s.trMu, &s.trRouteFilterRulesServer, func() *RouteFilterRulesServerTransport { return NewRouteFilterRulesServerTransport(&s.srv.RouteFilterRulesServer) })
		resp, err = s.trRouteFilterRulesServer.Do(req)
	case "RouteFiltersClient":
		initServer(&s.trMu, &s.trRouteFiltersServer, func() *RouteFiltersServerTransport { return NewRouteFiltersServerTransport(&s.srv.RouteFiltersServer) })
		resp, err = s.trRouteFiltersServer.Do(req)
	case "RouteMapsClient":
		initServer(&s.trMu, &s.trRouteMapsServer, func() *RouteMapsServerTransport { return NewRouteMapsServerTransport(&s.srv.RouteMapsServer) })
		resp, err = s.trRouteMapsServer.Do(req)
	case "RouteTablesClient":
		initServer(&s.trMu, &s.trRouteTablesServer, func() *RouteTablesServerTransport { return NewRouteTablesServerTransport(&s.srv.RouteTablesServer) })
	...
	case "RoutingIntentClient":
		initServer(&s.trMu, &s.trRoutingIntentServer, func() *RoutingIntentServerTransport { return NewRoutingIntentServerTransport(&s.srv.RoutingIntentServer) })
		resp, err = s.trRoutingIntentServer.Do(req)
	case "RoutingRuleCollectionsClient":
		initServer(&s.trMu, &s.trRoutingRuleCollectionsServer, func() *RoutingRuleCollectionsServerTransport { return NewRoutingRuleCollectionsServerTransport(&s.srv.RoutingRuleCollectionsServer) })
		resp, err = s.trRoutingRuleCollectionsServer.Do(req)
	case "RoutingRulesClient":
		initServer(&s.trMu, &s.trRoutingRulesServer, func() *RoutingRulesServerTransport { return NewRoutingRulesServerTransport(&s.srv.RoutingRulesServer) })
		resp, err = s.trRoutingRulesServer.Do(req)
	case "ScopeConnectionsClient":
		initServer(&s.trMu, &s.trScopeConnectionsServer, func() *ScopeConnectionsServerTransport { return NewScopeConnectionsServerTransport(&s.srv.ScopeConnectionsServer) })
		resp, err = s.trScopeConnectionsServer.Do(req)
	case "SecurityAdminConfigurationsClient":
		initServer(&s.trMu, &s.trSecurityAdminConfigurationsServer, func() *SecurityAdminConfigurationsServerTransport { return NewSecurityAdminConfigurationsServerTransport(&s.srv.SecurityAdminConfigurationsServer) })
		resp, err = s.trSecurityAdminConfigurationsServer.Do(req)
	case "SecurityGroupsClient":
		initServer(&s.trMu, &s.trSecurityGroupsServer, func() *SecurityGroupsServerTransport { return NewSecurityGroupsServerTransport(&s.srv.SecurityGroupsServer) })
		resp, err = s.trSecurityGroupsServer.Do(req)
	case "SecurityPartnerProvidersClient":
		initServer(&s.trMu, &s.trSecurityPartnerProvidersServer, func() *SecurityPartnerProvidersServerTransport { return NewSecurityPartnerProvidersServerTransport(&s.srv.SecurityPartnerProvidersServer) })
		resp, err = s.trSecurityPartnerProvidersServer.Do(req)
	case "SecurityPerimeterAccessRulesClient":
		initServer(&s.trMu, &s.trSecurityPerimeterAccessRulesServer, func() *SecurityPerimeterAccessRulesServerTransport { return NewSecurityPerimeterAccessRulesServerTransport(&s.srv.SecurityPerimeterAccessRulesServer) })
		resp, err = s.trSecurityPerimeterAccessRulesServer.Do(req)
	case "SecurityPerimeterAssociableResourceTypesClient":
		initServer(&s.trMu, &s.trSecurityPerimeterAssociableResourceTypesServer, func() *SecurityPerimeterAssociableResourceTypesServerTransport { return NewSecurityPerimeterAssociableResourceTypesServerTransport(&s.srv.SecurityPerimeterAssociableResourceTypesServer) })
		resp, err = s.trSecurityPerimeterAssociableResourceTypesServer.Do(req)
	case "SecurityPerimeterAssociationsClient":
		initServer(&s.trMu, &s.trSecurityPerimeterAssociationsServer, func() *SecurityPerimeterAssociationsServerTransport { return NewSecurityPerimeterAssociationsServerTransport(&s.srv.SecurityPerimeterAssociationsServer) })
		resp, err = s.trSecurityPerimeterAssociationsServer.Do(req)
	case "SecurityPerimeterLinkReferencesClient":
		initServer(&s.trMu, &s.trSecurityPerimeterLinkReferencesServer, func() *SecurityPerimeterLinkReferencesServerTransport { return NewSecurityPerimeterLinkReferencesServerTransport(&s.srv.SecurityPerimeterLinkReferencesServer) })
		resp, err = s.trSecurityPerimeterLinkReferencesServer.Do(req)
	case "SecurityPerimeterLinksClient":
		initServer(&s.trMu, &s.trSecurityPerimeterLinksServer, func() *SecurityPerimeterLinksServerTransport { return NewSecurityPerimeterLinksServerTransport(&s.srv.SecurityPerimeterLinksServer) })
		resp, err = s.trSecurityPerimeterLinksServer.Do(req)
	case "SecurityPerimeterLoggingConfigurationsClient":
		initServer(&s.trMu, &s.trSecurityPerimeterLoggingConfigurationsServer, func() *SecurityPerimeterLoggingConfigurationsServerTransport { return NewSecurityPerimeterLoggingConfigurationsServerTransport(&s.srv.SecurityPerimeterLoggingConfigurationsServer) })
		resp, err = s.trSecurityPerimeterLoggingConfigurationsServer.Do(req)
	case "SecurityPerimeterOperationStatusesClient":
		initServer(&s.trMu, &s.trSecurityPerimeterOperationStatusesServer, func() *SecurityPerimeterOperationStatusesServerTransport { return NewSecurityPerimeterOperationStatusesServerTransport(&s.srv.SecurityPerimeterOperationStatusesServer) })
		resp, err = s.trSecurityPerimeterOperationStatusesServer.Do(req)
	case "SecurityPerimeterProfilesClient":
		initServer(&s.trMu, &s.trSecurityPerimeterProfilesServer, func() *SecurityPerimeterProfilesServerTransport { return NewSecurityPerimeterProfilesServerTransport(&s.srv.SecurityPerimeterProfilesServer) })
		resp, err = s.trSecurityPerimeterProfilesServer.Do(req)
	case "SecurityPerimeterServiceTagsClient":
		initServer(&s.trMu, &s.trSecurityPerimeterServiceTagsServer, func() *SecurityPerimeterServiceTagsServerTransport { return NewSecurityPerimeterServiceTagsServerTransport(&s.srv.SecurityPerimeterServiceTagsServer) })
		resp, err = s.trSecurityPerimeterServiceTagsServer.Do(req)
	case "SecurityPerimetersClient":
		initServer(&s.trMu, &s.trSecurityPerimetersServer, func() *SecurityPerimetersServerTransport { return NewSecurityPerimetersServerTransport(&s.srv.SecurityPerimetersServer) })
		resp, err = s.trSecurityPerimetersServer.Do(req)
	case "SecurityRulesClient":
		initServer(&s.trMu, &s.trSecurityRulesServer, func() *SecurityRulesServerTransport { return NewSecurityRulesServerTransport(&s.srv.SecurityRulesServer) })
		resp, err = s.trSecurityRulesServer.Do(req)
	case "SecurityUserConfigurationsClient":
		initServer(&s.trMu, &s.trSecurityUserConfigurationsServer, func() *SecurityUserConfigurationsServerTransport { return NewSecurityUserConfigurationsServerTransport(&s.srv.SecurityUserConfigurationsServer) })
		resp, err = s.trSecurityUserConfigurationsServer.Do(req)
	case "SecurityUserRuleCollectionsClient":
		initServer(&s.trMu, &s.trSecurityUserRuleCollectionsServer, func() *SecurityUserRuleCollectionsServerTransport { return NewSecurityUserRuleCollectionsServerTransport(&s.srv.SecurityUserRuleCollectionsServer) })
		resp, err = s.trSecurityUserRuleCollectionsServer.Do(req)
	case "SecurityUserRulesClient":
		initServer(&s.trMu, &s.trSecurityUserRulesServer, func() *SecurityUserRulesServerTransport { return NewSecurityUserRulesServerTransport(&s.srv.SecurityUserRulesServer) })
		resp, err = s.trSecurityUserRulesServer.Do(req)
	case "ServiceAssociationLinksClient":
		initServer(&s.trMu, &s.trServiceAssociationLinksServer, func() *ServiceAssociationLinksServerTransport { return NewServiceAssociationLinksServerTransport(&s.srv.ServiceAssociationLinksServer) })
		resp, err = s.trServiceAssociationLinksServer.Do(req)
	case "ServiceEndpointPoliciesClient":
		initServer(&s.trMu, &s.trServiceEndpointPoliciesServer, func() *ServiceEndpointPoliciesServerTransport { return NewServiceEndpointPoliciesServerTransport(&s.srv.ServiceEndpointPoliciesServer) })
		resp, err = s.trServiceEndpointPoliciesServer.Do(req)
	case "ServiceEndpointPolicyDefinitionsClient":
		initServer(&s.trMu, &s.trServiceEndpointPolicyDefinitionsServer, func() *ServiceEndpointPolicyDefinitionsServerTransport { return NewServiceEndpointPolicyDefinitionsServerTransport(&s.srv.ServiceEndpointPolicyDefinitionsServer) })
		resp, err = s.trServiceEndpointPolicyDefinitionsServer.Do(req)
	case "ServiceGatewaysClient":
		initServer(&s.trMu, &s.trServiceGatewaysServer, func() *ServiceGatewaysServerTransport { return NewServiceGatewaysServerTransport(&s.srv.ServiceGatewaysServer) })
		resp, err = s.trServiceGatewaysServer.Do(req)
	case "ServiceTagInformationClient":
		initServer(&s.trMu, &s.trServiceTagInformationServer, func() *ServiceTagInformationServerTransport { return NewServiceTagInformationServerTransport(&s.srv.ServiceTagInformationServer) })
		resp, err = s.trServiceTagInformationServer.Do(req)
	case "ServiceTagsClient":
		initServer(&s.trMu, &s.trServiceTagsServer, func() *ServiceTagsServerTransport { return NewServiceTagsServerTransport(&s.srv.ServiceTagsServer) })
		resp, err = s.trServiceTagsServer.Do(req)
	case "StaticCidrsClient":
		initServer(&s.trMu, &s.trStaticCidrsServer, func() *StaticCidrsServerTransport { return NewStaticCidrsServerTransport(&s.srv.StaticCidrsServer) })
		resp, err = s.trStaticCidrsServer.Do(req)
	case "StaticMembersClient":
		initServer(&s.trMu, &s.trStaticMembersServer, func() *StaticMembersServerTransport { return NewStaticMembersServerTransport(&s.srv.StaticMembersServer) })
		resp, err = s.trStaticMembersServer.Do(req)
	case "SubgroupsClient":
		initServer(&s.trMu, &s.trSubgroupsServer, func() *SubgroupsServerTransport { return NewSubgroupsServerTransport(&s.srv.SubgroupsServer) })
		resp, err = s.trSubgroupsServer.Do(req)
	case "SubnetsClient":
		initServer(&s.trMu, &s.trSubnetsServer, func() *SubnetsServerTransport { return NewSubnetsServerTransport(&s.srv.SubnetsServer) })
		resp, err = s.trSubnetsServer.Do(req)
	case "SubscriptionNetworkManagerConnectionsClient":
		initServer(&s.trMu, &s.trSubscriptionNetworkManagerConnectionsServer, func() *SubscriptionNetworkManagerConnectionsServerTransport { return NewSubscriptionNetworkManagerConnectionsServerTransport(&s.srv.SubscriptionNetworkManagerConnectionsServer) })
	...
	case "VPNConnectionsClient":
		initServer(&s.trMu, &s.trVPNConnectionsServer, func() *VPNConnectionsServerTransport { return NewVPNConnectionsServerTransport(&s.srv.VPNConnectionsServer) })
		resp, err = s.trVPNConnectionsServer.Do(req)
	case "VPNGatewaysClient":
		initServer(&s.trMu, &s.trVPNGatewaysServer, func() *VPNGatewaysServerTransport { return NewVPNGatewaysServerTransport(&s.srv.VPNGatewaysServer) })
		resp, err = s.trVPNGatewaysServer.Do(req)
	case "VPNLinkConnectionsClient":
		initServer(&s.trMu, &s.trVPNLinkConnectionsServer, func() *VPNLinkConnectionsServerTransport { return NewVPNLinkConnectionsServerTransport(&s.srv.VPNLinkConnectionsServer) })
		resp, err = s.trVPNLinkConnectionsServer.Do(req)
	case "VPNServerConfigurationsAssociatedWithVirtualWanClient":
		initServer(&s.trMu, &s.trVPNServerConfigurationsAssociatedWithVirtualWanServer, func() *VPNServerConfigurationsAssociatedWithVirtualWanServerTransport { return NewVPNServerConfigurationsAssociatedWithVirtualWanServerTransport(&s.srv.VPNServerConfigurationsAssociatedWithVirtualWanServer) })
		resp, err = s.trVPNServerConfigurationsAssociatedWithVirtualWanServer.Do(req)
	case "VPNServerConfigurationsClient":
		initServer(&s.trMu, &s.trVPNServerConfigurationsServer, func() *VPNServerConfigurationsServerTransport { return NewVPNServerConfigurationsServerTransport(&s.srv.VPNServerConfigurationsServer) })
		resp, err = s.trVPNServerConfigurationsServer.Do(req)
	case "VPNSiteLinkConnectionsClient":
		initServer(&s.trMu, &s.trVPNSiteLinkConnectionsServer, func() *VPNSiteLinkConnectionsServerTransport { return NewVPNSiteLinkConnectionsServerTransport(&s.srv.VPNSiteLinkConnectionsServer) })
		resp, err = s.trVPNSiteLinkConnectionsServer.Do(req)
	case "VPNSiteLinksClient":
		initServer(&s.trMu, &s.trVPNSiteLinksServer, func() *VPNSiteLinksServerTransport { return NewVPNSiteLinksServerTransport(&s.srv.VPNSiteLinksServer) })
		resp, err = s.trVPNSiteLinksServer.Do(req)
	case "VPNSitesClient":
		initServer(&s.trMu, &s.trVPNSitesServer, func() *VPNSitesServerTransport { return NewVPNSitesServerTransport(&s.srv.VPNSitesServer) })
		resp, err = s.trVPNSitesServer.Do(req)
	case "VPNSitesConfigurationClient":
		initServer(&s.trMu, &s.trVPNSitesConfigurationServer, func() *VPNSitesConfigurationServerTransport { return NewVPNSitesConfigurationServerTransport(&s.srv.VPNSitesConfigurationServer) })
		resp, err = s.trVPNSitesConfigurationServer.Do(req)
	case "VerifierWorkspacesClient":
		initServer(&s.trMu, &s.trVerifierWorkspacesServer, func() *VerifierWorkspacesServerTransport { return NewVerifierWorkspacesServerTransport(&s.srv.VerifierWorkspacesServer) })
		resp, err = s.trVerifierWorkspacesServer.Do(req)
	case "VipSwapClient":
		initServer(&s.trMu, &s.trVipSwapServer, func() *VipSwapServerTransport { return NewVipSwapServerTransport(&s.srv.VipSwapServer) })
		resp, err = s.trVipSwapServer.Do(req)
	case "VirtualApplianceConnectionsClient":
		initServer(&s.trMu, &s.trVirtualApplianceConnectionsServer, func() *VirtualApplianceConnectionsServerTransport { return NewVirtualApplianceConnectionsServerTransport(&s.srv.VirtualApplianceConnectionsServer) })
		resp, err = s.trVirtualApplianceConnectionsServer.Do(req)
	case "VirtualApplianceSKUsClient":
		initServer(&s.trMu, &s.trVirtualApplianceSKUsServer, func() *VirtualApplianceSKUsServerTransport { return NewVirtualApplianceSKUsServerTransport(&s.srv.VirtualApplianceSKUsServer) })
		resp, err = s.trVirtualApplianceSKUsServer.Do(req)
	case "VirtualApplianceSitesClient":
		initServer(&s.trMu, &s.trVirtualApplianceSitesServer, func() *VirtualApplianceSitesServerTransport { return NewVirtualApplianceSitesServerTransport(&s.srv.VirtualApplianceSitesServer) })
		resp, err = s.trVirtualApplianceSitesServer.Do(req)
	case "VirtualAppliancesClient":
		initServer(&s.trMu, &s.trVirtualAppliancesServer, func() *VirtualAppliancesServerTransport { return NewVirtualAppliancesServerTransport(&s.srv.VirtualAppliancesServer) })
		resp, err = s.trVirtualAppliancesServer.Do(req)
	case "VirtualHubBgpConnectionClient":
		initServer(&s.trMu, &s.trVirtualHubBgpConnectionServer, func() *VirtualHubBgpConnectionServerTransport { return NewVirtualHubBgpConnectionServerTransport(&s.srv.VirtualHubBgpConnectionServer) })
		resp, err = s.trVirtualHubBgpConnectionServer.Do(req)
	case "VirtualHubBgpConnectionsClient":
		initServer(&s.trMu, &s.trVirtualHubBgpConnectionsServer, func() *VirtualHubBgpConnectionsServerTransport { return NewVirtualHubBgpConnectionsServerTransport(&s.srv.VirtualHubBgpConnectionsServer) })
		resp, err = s.trVirtualHubBgpConnectionsServer.Do(req)
	case "VirtualHubIPConfigurationClient":
		initServer(&s.trMu, &s.trVirtualHubIPConfigurationServer, func() *VirtualHubIPConfigurationServerTransport { return NewVirtualHubIPConfigurationServerTransport(&s.srv.VirtualHubIPConfigurationServer) })
		resp, err = s.trVirtualHubIPConfigurationServer.Do(req)
	case "VirtualHubRouteTableV2SClient":
		initServer(&s.trMu, &s.trVirtualHubRouteTableV2SServer, func() *VirtualHubRouteTableV2SServerTransport { return NewVirtualHubRouteTableV2SServerTransport(&s.srv.VirtualHubRouteTableV2SServer) })
	...
	case "VirtualNetworkAppliancesClient":
		initServer(&s.trMu, &s.trVirtualNetworkAppliancesServer, func() *VirtualNetworkAppliancesServerTransport { return NewVirtualNetworkAppliancesServerTransport(&s.srv.VirtualNetworkAppliancesServer) })
		resp, err = s.trVirtualNetworkAppliancesServer.Do(req)
	case "VirtualNetworkGatewayConnectionsClient":
		initServer(&s.trMu, &s.trVirtualNetworkGatewayConnectionsServer, func() *VirtualNetworkGatewayConnectionsServerTransport { return NewVirtualNetworkGatewayConnectionsServerTransport(&s.srv.VirtualNetworkGatewayConnectionsServer) })
		resp, err = s.trVirtualNetworkGatewayConnectionsServer.Do(req)
	case "VirtualNetworkGatewayNatRulesClient":
		initServer(&s.trMu, &s.trVirtualNetworkGatewayNatRulesServer, func() *VirtualNetworkGatewayNatRulesServerTransport { return NewVirtualNetworkGatewayNatRulesServerTransport(&s.srv.VirtualNetworkGatewayNatRulesServer) })
		resp, err = s.trVirtualNetworkGatewayNatRulesServer.Do(req)
	case "VirtualNetworkGatewaysClient":
		initServer(&s.trMu, &s.trVirtualNetworkGatewaysServer, func() *VirtualNetworkGatewaysServerTransport { return NewVirtualNetworkGatewaysServerTransport(&s.srv.VirtualNetworkGatewaysServer) })
		resp, err = s.trVirtualNetworkGatewaysServer.Do(req)
	case "VirtualNetworkPeeringsClient":
		initServer(&s.trMu, &s.trVirtualNetworkPeeringsServer, func() *VirtualNetworkPeeringsServerTransport { return NewVirtualNetworkPeeringsServerTransport(&s.srv.VirtualNetworkPeeringsServer) })
		resp, err = s.trVirtualNetworkPeeringsServer.Do(req)
	case "VirtualNetworkTapsClient":
		initServer(&s.trMu, &s.trVirtualNetworkTapsServer, func() *VirtualNetworkTapsServerTransport { return NewVirtualNetworkTapsServerTransport(&s.srv.VirtualNetworkTapsServer) })
		resp, err = s.trVirtualNetworkTapsServer.Do(req)
	case "VirtualNetworksClient":
		initServer(&s.trMu, &s.trVirtualNetworksServer, func() *VirtualNetworksServerTransport { return NewVirtualNetworksServerTransport(&s.srv.VirtualNetworksServer) })
		resp, err = s.trVirtualNetworksServer.Do(req)
	case "VirtualRouterPeeringsClient":
		initServer(&s.trMu, &s.trVirtualRouterPeeringsServer, func() *VirtualRouterPeeringsServerTransport { return NewVirtualRouterPeeringsServerTransport(&s.srv.VirtualRouterPeeringsServer) })
		resp, err = s.trVirtualRouterPeeringsServer.Do(req)
	case "VirtualRoutersClient":
		initServer(&s.trMu, &s.trVirtualRoutersServer, func() *VirtualRoutersServerTransport { return NewVirtualRoutersServerTransport(&s.srv.VirtualRoutersServer) })
	...
	case "WebApplicationFirewallPoliciesClient":
		initServer(&s.trMu, &s.trWebApplicationFirewallPoliciesServer, func() *WebApplicationFirewallPoliciesServerTransport { return NewWebApplicationFirewallPoliciesServerTransport(&s.srv.WebApplicationFirewallPoliciesServer) })
		resp, err = s.trWebApplicationFirewallPoliciesServer.Do(req)
	case "WebCategoriesClient":
		initServer(&s.trMu, &s.trWebCategoriesServer, func() *WebCategoriesServerTransport { return NewWebCategoriesServerTransport(&s.srv.WebCategoriesServer) })
