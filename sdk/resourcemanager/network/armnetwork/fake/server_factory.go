...
type ServerFactory struct {
	...
	// CheckDNSNameAvailabilityServer contains the fakes for client CheckDNSNameAvailabilityClient
	CheckDNSNameAvailabilityServer CheckDNSNameAvailabilityServer
	...
	// EffectiveConfigurationsServer contains the fakes for client EffectiveConfigurationsClient
	EffectiveConfigurationsServer EffectiveConfigurationsServer
	...
	// ExpressRouteProviderPortsServer contains the fakes for client ExpressRouteProviderPortsClient
	ExpressRouteProviderPortsServer ExpressRouteProviderPortsServer
...
type ServerFactoryTransport struct {
	...
	trCheckDNSNameAvailabilityServer                        *CheckDNSNameAvailabilityServerTransport
	...
	trEffectiveConfigurationsServer                         *EffectiveConfigurationsServerTransport
	...
	trExpressRouteProviderPortsServer                       *ExpressRouteProviderPortsServerTransport
...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "ApplicationGatewayPrivateEndpointConnectionsClient":
		initServer(&s.trMu, &s.trApplicationGatewayPrivateEndpointConnectionsServer, func() *ApplicationGatewayPrivateEndpointConnectionsServerTransport {
	...
	case "ApplicationGatewayPrivateLinkResourcesClient":
		initServer(&s.trMu, &s.trApplicationGatewayPrivateLinkResourcesServer, func() *ApplicationGatewayPrivateLinkResourcesServerTransport {
	...
	case "ApplicationGatewaysClient":
		initServer(&s.trMu, &s.trApplicationGatewaysServer, func() *ApplicationGatewaysServerTransport {
	...
	case "AvailableEndpointServicesClient":
		initServer(&s.trMu, &s.trAvailableEndpointServicesServer, func() *AvailableEndpointServicesServerTransport {
	...
	case "AvailableResourceGroupDelegationsClient":
		initServer(&s.trMu, &s.trAvailableResourceGroupDelegationsServer, func() *AvailableResourceGroupDelegationsServerTransport {
	...
	case "AvailableServiceAliasesClient":
		initServer(&s.trMu, &s.trAvailableServiceAliasesServer, func() *AvailableServiceAliasesServerTransport {
	...
	case "AzureFirewallFqdnTagsClient":
		initServer(&s.trMu, &s.trAzureFirewallFqdnTagsServer, func() *AzureFirewallFqdnTagsServerTransport {
	...
	case "AzureFirewallsClient":
		initServer(&s.trMu, &s.trAzureFirewallsServer, func() *AzureFirewallsServerTransport {
	...
	case "BgpServiceCommunitiesClient":
		initServer(&s.trMu, &s.trBgpServiceCommunitiesServer, func() *BgpServiceCommunitiesServerTransport {
	...
	case "CheckDNSNameAvailabilityClient":
		initServer(&s.trMu, &s.trCheckDNSNameAvailabilityServer, func() *CheckDNSNameAvailabilityServerTransport {
			return NewCheckDNSNameAvailabilityServerTransport(&s.srv.CheckDNSNameAvailabilityServer)
		})
		resp, err = s.trCheckDNSNameAvailabilityServer.Do(req)
	case "ConfigurationPolicyGroupsClient":
		initServer(&s.trMu, &s.trConfigurationPolicyGroupsServer, func() *ConfigurationPolicyGroupsServerTransport {
	...
	case "ConnectionMonitorsClient":
		initServer(&s.trMu, &s.trConnectionMonitorsServer, func() *ConnectionMonitorsServerTransport {
	...
	case "ConnectivityConfigurationsClient":
		initServer(&s.trMu, &s.trConnectivityConfigurationsServer, func() *ConnectivityConfigurationsServerTransport {
	...
	case "CustomIPPrefixesClient":
		initServer(&s.trMu, &s.trCustomIPPrefixesServer, func() *CustomIPPrefixesServerTransport {
	...
	case "DscpConfigurationClient":
		initServer(&s.trMu, &s.trDscpConfigurationServer, func() *DscpConfigurationServerTransport {
			return NewDscpConfigurationServerTransport(&s.srv.DscpConfigurationServer)
		})
		resp, err = s.trDscpConfigurationServer.Do(req)
	case "EffectiveConfigurationsClient":
		initServer(&s.trMu, &s.trEffectiveConfigurationsServer, func() *EffectiveConfigurationsServerTransport {
			return NewEffectiveConfigurationsServerTransport(&s.srv.EffectiveConfigurationsServer)
		})
		resp, err = s.trEffectiveConfigurationsServer.Do(req)
	...
	case "ExpressRouteCircuitConnectionsClient":
		initServer(&s.trMu, &s.trExpressRouteCircuitConnectionsServer, func() *ExpressRouteCircuitConnectionsServerTransport {
	...
	case "ExpressRouteCircuitsClient":
		initServer(&s.trMu, &s.trExpressRouteCircuitsServer, func() *ExpressRouteCircuitsServerTransport {
	...
	case "ExpressRouteConnectionsClient":
		initServer(&s.trMu, &s.trExpressRouteConnectionsServer, func() *ExpressRouteConnectionsServerTransport {
	...
	case "ExpressRouteCrossConnectionPeeringsClient":
		initServer(&s.trMu, &s.trExpressRouteCrossConnectionPeeringsServer, func() *ExpressRouteCrossConnectionPeeringsServerTransport {
	...
	case "ExpressRouteCrossConnectionsClient":
		initServer(&s.trMu, &s.trExpressRouteCrossConnectionsServer, func() *ExpressRouteCrossConnectionsServerTransport {
	...
	case "ExpressRouteGatewaysClient":
		initServer(&s.trMu, &s.trExpressRouteGatewaysServer, func() *ExpressRouteGatewaysServerTransport {
	...
	case "ExpressRoutePortAuthorizationsClient":
		initServer(&s.trMu, &s.trExpressRoutePortAuthorizationsServer, func() *ExpressRoutePortAuthorizationsServerTransport {
	...
	case "ExpressRoutePortsClient":
		initServer(&s.trMu, &s.trExpressRoutePortsServer, func() *ExpressRoutePortsServerTransport {
	...
	case "ExpressRoutePortsLocationsClient":
		initServer(&s.trMu, &s.trExpressRoutePortsLocationsServer, func() *ExpressRoutePortsLocationsServerTransport {
	...
	case "ExpressRouteProviderPortsClient":
		initServer(&s.trMu, &s.trExpressRouteProviderPortsServer, func() *ExpressRouteProviderPortsServerTransport {
			return NewExpressRouteProviderPortsServerTransport(&s.srv.ExpressRouteProviderPortsServer)
		})
		resp, err = s.trExpressRouteProviderPortsServer.Do(req)
	case "ExpressRouteProviderPortsLocationClient":
		initServer(&s.trMu, &s.trExpressRouteProviderPortsLocationServer, func() *ExpressRouteProviderPortsLocationServerTransport {
	...
	case "ExpressRouteServiceProvidersClient":
		initServer(&s.trMu, &s.trExpressRouteServiceProvidersServer, func() *ExpressRouteServiceProvidersServerTransport {
	...
	case "FirewallPoliciesClient":
		initServer(&s.trMu, &s.trFirewallPoliciesServer, func() *FirewallPoliciesServerTransport {
	...
	case "FirewallPolicyIdpsSignaturesClient":
		initServer(&s.trMu, &s.trFirewallPolicyIdpsSignaturesServer, func() *FirewallPolicyIdpsSignaturesServerTransport {
	...
	case "FirewallPolicyIdpsSignaturesFilterValuesClient":
		initServer(&s.trMu, &s.trFirewallPolicyIdpsSignaturesFilterValuesServer, func() *FirewallPolicyIdpsSignaturesFilterValuesServerTransport {
	...
	case "FirewallPolicyIdpsSignaturesOverridesClient":
		initServer(&s.trMu, &s.trFirewallPolicyIdpsSignaturesOverridesServer, func() *FirewallPolicyIdpsSignaturesOverridesServerTransport {
	...
	case "FirewallPolicyRuleCollectionGroupsClient":
		initServer(&s.trMu, &s.trFirewallPolicyRuleCollectionGroupsServer, func() *FirewallPolicyRuleCollectionGroupsServerTransport {
	...
	case "HubRouteTablesClient":
		initServer(&s.trMu, &s.trHubRouteTablesServer, func() *HubRouteTablesServerTransport {
	...
	case "HubVirtualNetworkConnectionsClient":
		initServer(&s.trMu, &s.trHubVirtualNetworkConnectionsServer, func() *HubVirtualNetworkConnectionsServerTransport {
	...
	case "IPAllocationsClient":
		initServer(&s.trMu, &s.trIPAllocationsServer, func() *IPAllocationsServerTransport {
	...
	case "InboundNatRulesClient":
		initServer(&s.trMu, &s.trInboundNatRulesServer, func() *InboundNatRulesServerTransport {
	...
	case "InterfaceIPConfigurationsClient":
		initServer(&s.trMu, &s.trInterfaceIPConfigurationsServer, func() *InterfaceIPConfigurationsServerTransport {
	...
	case "InterfaceLoadBalancersClient":
		initServer(&s.trMu, &s.trInterfaceLoadBalancersServer, func() *InterfaceLoadBalancersServerTransport {
	...
	case "InterfaceTapConfigurationsClient":
		initServer(&s.trMu, &s.trInterfaceTapConfigurationsServer, func() *InterfaceTapConfigurationsServerTransport {
	...
	case "LoadBalancerBackendAddressPoolsClient":
		initServer(&s.trMu, &s.trLoadBalancerBackendAddressPoolsServer, func() *LoadBalancerBackendAddressPoolsServerTransport {
	...
	case "LoadBalancerLoadBalancingRulesClient":
		initServer(&s.trMu, &s.trLoadBalancerLoadBalancingRulesServer, func() *LoadBalancerLoadBalancingRulesServerTransport {
	...
	case "LoadBalancerNetworkInterfacesClient":
		initServer(&s.trMu, &s.trLoadBalancerNetworkInterfacesServer, func() *LoadBalancerNetworkInterfacesServerTransport {
	...
	case "LoadBalancerOutboundRulesClient":
		initServer(&s.trMu, &s.trLoadBalancerOutboundRulesServer, func() *LoadBalancerOutboundRulesServerTransport {
	...
	case "LoadBalancerProbesClient":
		initServer(&s.trMu, &s.trLoadBalancerProbesServer, func() *LoadBalancerProbesServerTransport {
	...
	case "ManagementGroupNetworkManagerConnectionsClient":
		initServer(&s.trMu, &s.trManagementGroupNetworkManagerConnectionsServer, func() *ManagementGroupNetworkManagerConnectionsServerTransport {
	...
	case "ManagerCommitsClient":
		initServer(&s.trMu, &s.trManagerCommitsServer, func() *ManagerCommitsServerTransport {
	...
	case "ManagerDeploymentStatusClient":
		initServer(&s.trMu, &s.trManagerDeploymentStatusServer, func() *ManagerDeploymentStatusServerTransport {
	...
	case "ManagerRoutingConfigurationsClient":
		initServer(&s.trMu, &s.trManagerRoutingConfigurationsServer, func() *ManagerRoutingConfigurationsServerTransport {
	...
	case "P2SVPNGatewaysClient":
		initServer(&s.trMu, &s.trP2SVPNGatewaysServer, func() *P2SVPNGatewaysServerTransport {
	...
	case "PacketCapturesClient":
		initServer(&s.trMu, &s.trPacketCapturesServer, func() *PacketCapturesServerTransport {
	...
	case "PeerExpressRouteCircuitConnectionsClient":
		initServer(&s.trMu, &s.trPeerExpressRouteCircuitConnectionsServer, func() *PeerExpressRouteCircuitConnectionsServerTransport {
	...
	case "PrivateDNSZoneGroupsClient":
		initServer(&s.trMu, &s.trPrivateDNSZoneGroupsServer, func() *PrivateDNSZoneGroupsServerTransport {
	...
	case "PrivateEndpointsClient":
		initServer(&s.trMu, &s.trPrivateEndpointsServer, func() *PrivateEndpointsServerTransport {
	...
	case "PrivateLinkServicesClient":
		initServer(&s.trMu, &s.trPrivateLinkServicesServer, func() *PrivateLinkServicesServerTransport {
	...
	case "ReachabilityAnalysisIntentsClient":
		initServer(&s.trMu, &s.trReachabilityAnalysisIntentsServer, func() *ReachabilityAnalysisIntentsServerTransport {
	...
	case "ReachabilityAnalysisRunsClient":
		initServer(&s.trMu, &s.trReachabilityAnalysisRunsServer, func() *ReachabilityAnalysisRunsServerTransport {
	...
	case "ResourceNavigationLinksClient":
		initServer(&s.trMu, &s.trResourceNavigationLinksServer, func() *ResourceNavigationLinksServerTransport {
	...
	case "RoutingIntentClient":
		initServer(&s.trMu, &s.trRoutingIntentServer, func() *RoutingIntentServerTransport {
	...
	case "RoutingRuleCollectionsClient":
		initServer(&s.trMu, &s.trRoutingRuleCollectionsServer, func() *RoutingRuleCollectionsServerTransport {
	...
	case "ScopeConnectionsClient":
		initServer(&s.trMu, &s.trScopeConnectionsServer, func() *ScopeConnectionsServerTransport {
	...
	case "SecurityGroupsClient":
		initServer(&s.trMu, &s.trSecurityGroupsServer, func() *SecurityGroupsServerTransport {
	...
	case "SecurityPartnerProvidersClient":
		initServer(&s.trMu, &s.trSecurityPartnerProvidersServer, func() *SecurityPartnerProvidersServerTransport {
	...
	case "SecurityPerimeterAccessRulesClient":
		initServer(&s.trMu, &s.trSecurityPerimeterAccessRulesServer, func() *SecurityPerimeterAccessRulesServerTransport {
	...
	case "SecurityPerimeterAssociableResourceTypesClient":
		initServer(&s.trMu, &s.trSecurityPerimeterAssociableResourceTypesServer, func() *SecurityPerimeterAssociableResourceTypesServerTransport {
	...
	case "SecurityPerimeterLinkReferencesClient":
		initServer(&s.trMu, &s.trSecurityPerimeterLinkReferencesServer, func() *SecurityPerimeterLinkReferencesServerTransport {
	...
	case "SecurityPerimeterLinksClient":
		initServer(&s.trMu, &s.trSecurityPerimeterLinksServer, func() *SecurityPerimeterLinksServerTransport {
	...
	case "SecurityPerimeterLoggingConfigurationsClient":
		initServer(&s.trMu, &s.trSecurityPerimeterLoggingConfigurationsServer, func() *SecurityPerimeterLoggingConfigurationsServerTransport {
	...
	case "SecurityPerimeterOperationStatusesClient":
		initServer(&s.trMu, &s.trSecurityPerimeterOperationStatusesServer, func() *SecurityPerimeterOperationStatusesServerTransport {
	...
	case "SecurityPerimeterProfilesClient":
		initServer(&s.trMu, &s.trSecurityPerimeterProfilesServer, func() *SecurityPerimeterProfilesServerTransport {
	...
	case "SecurityPerimeterServiceTagsClient":
		initServer(&s.trMu, &s.trSecurityPerimeterServiceTagsServer, func() *SecurityPerimeterServiceTagsServerTransport {
	...
	case "SecurityPerimetersClient":
		initServer(&s.trMu, &s.trSecurityPerimetersServer, func() *SecurityPerimetersServerTransport {
	...
	case "SecurityUserConfigurationsClient":
		initServer(&s.trMu, &s.trSecurityUserConfigurationsServer, func() *SecurityUserConfigurationsServerTransport {
	...
	case "SecurityUserRulesClient":
		initServer(&s.trMu, &s.trSecurityUserRulesServer, func() *SecurityUserRulesServerTransport {
	...
	case "ServiceAssociationLinksClient":
		initServer(&s.trMu, &s.trServiceAssociationLinksServer, func() *ServiceAssociationLinksServerTransport {
	...
	case "ServiceEndpointPoliciesClient":
		initServer(&s.trMu, &s.trServiceEndpointPoliciesServer, func() *ServiceEndpointPoliciesServerTransport {
	...
	case "ServiceEndpointPolicyDefinitionsClient":
		initServer(&s.trMu, &s.trServiceEndpointPolicyDefinitionsServer, func() *ServiceEndpointPolicyDefinitionsServerTransport {
	...
	case "SubscriptionNetworkManagerConnectionsClient":
		initServer(&s.trMu, &s.trSubscriptionNetworkManagerConnectionsServer, func() *SubscriptionNetworkManagerConnectionsServerTransport {
	...
	case "VPNConnectionsClient":
		initServer(&s.trMu, &s.trVPNConnectionsServer, func() *VPNConnectionsServerTransport {
	...
	case "VPNLinkConnectionsClient":
		initServer(&s.trMu, &s.trVPNLinkConnectionsServer, func() *VPNLinkConnectionsServerTransport {
	...
	case "VPNServerConfigurationsClient":
		initServer(&s.trMu, &s.trVPNServerConfigurationsServer, func() *VPNServerConfigurationsServerTransport {
	...
	case "VPNSiteLinkConnectionsClient":
		initServer(&s.trMu, &s.trVPNSiteLinkConnectionsServer, func() *VPNSiteLinkConnectionsServerTransport {
	...
	case "VPNSitesConfigurationClient":
		initServer(&s.trMu, &s.trVPNSitesConfigurationServer, func() *VPNSitesConfigurationServerTransport {
	...
	case "VerifierWorkspacesClient":
		initServer(&s.trMu, &s.trVerifierWorkspacesServer, func() *VerifierWorkspacesServerTransport {
	...
	case "VirtualApplianceConnectionsClient":
		initServer(&s.trMu, &s.trVirtualApplianceConnectionsServer, func() *VirtualApplianceConnectionsServerTransport {
	...
	case "VirtualApplianceSKUsClient":
		initServer(&s.trMu, &s.trVirtualApplianceSKUsServer, func() *VirtualApplianceSKUsServerTransport {
	...
	case "VirtualApplianceSitesClient":
		initServer(&s.trMu, &s.trVirtualApplianceSitesServer, func() *VirtualApplianceSitesServerTransport {
	...
	case "VirtualAppliancesClient":
		initServer(&s.trMu, &s.trVirtualAppliancesServer, func() *VirtualAppliancesServerTransport {
	...
	case "VirtualHubBgpConnectionClient":
		initServer(&s.trMu, &s.trVirtualHubBgpConnectionServer, func() *VirtualHubBgpConnectionServerTransport {
	...
	case "VirtualHubBgpConnectionsClient":
		initServer(&s.trMu, &s.trVirtualHubBgpConnectionsServer, func() *VirtualHubBgpConnectionsServerTransport {
	...
	case "VirtualHubIPConfigurationClient":
		initServer(&s.trMu, &s.trVirtualHubIPConfigurationServer, func() *VirtualHubIPConfigurationServerTransport {
	...
	case "VirtualHubRouteTableV2SClient":
		initServer(&s.trMu, &s.trVirtualHubRouteTableV2SServer, func() *VirtualHubRouteTableV2SServerTransport {
	...
	case "VirtualNetworkGatewayConnectionsClient":
		initServer(&s.trMu, &s.trVirtualNetworkGatewayConnectionsServer, func() *VirtualNetworkGatewayConnectionsServerTransport {
	...
	case "VirtualNetworkGatewaysClient":
		initServer(&s.trMu, &s.trVirtualNetworkGatewaysServer, func() *VirtualNetworkGatewaysServerTransport {
	...
	case "VirtualNetworkPeeringsClient":
		initServer(&s.trMu, &s.trVirtualNetworkPeeringsServer, func() *VirtualNetworkPeeringsServerTransport {
	...
	case "VirtualRouterPeeringsClient":
		initServer(&s.trMu, &s.trVirtualRouterPeeringsServer, func() *VirtualRouterPeeringsServerTransport {
	...
	case "WebCategoriesClient":
		initServer(&s.trMu, &s.trWebCategoriesServer, func() *WebCategoriesServerTransport {
