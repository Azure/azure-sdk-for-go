...
func NewVirtualHubsServerTransport(srv *VirtualHubsServer) *VirtualHubsServerTransport {
	return &VirtualHubsServerTransport{
		...
		beginGetEffectiveVirtualHubRoutes: newTracker[azfake.PollerResponder[azfake.PagerResponder[armnetwork.VirtualHubsClientGetEffectiveVirtualHubRoutesResponse]]](),
		beginGetInboundRoutes:             newTracker[azfake.PollerResponder[azfake.PagerResponder[armnetwork.VirtualHubsClientGetInboundRoutesResponse]]](),
		beginGetOutboundRoutes:            newTracker[azfake.PollerResponder[azfake.PagerResponder[armnetwork.VirtualHubsClientGetOutboundRoutesResponse]]](),
...
type VirtualHubsServerTransport struct {
	...
	beginGetEffectiveVirtualHubRoutes *tracker[azfake.PollerResponder[azfake.PagerResponder[armnetwork.VirtualHubsClientGetEffectiveVirtualHubRoutesResponse]]]
	beginGetInboundRoutes             *tracker[azfake.PollerResponder[azfake.PagerResponder[armnetwork.VirtualHubsClientGetInboundRoutesResponse]]]
	beginGetOutboundRoutes            *tracker[azfake.PollerResponder[azfake.PagerResponder[armnetwork.VirtualHubsClientGetOutboundRoutesResponse]]]
