...
type VirtualWansServer struct {
	...
	// BeginGeneratevirtualwanvpnserverconfigurationvpnprofile is the fake for method VirtualWansClient.BeginGeneratevirtualwanvpnserverconfigurationvpnprofile
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginGeneratevirtualwanvpnserverconfigurationvpnprofile func(ctx context.Context, resourceGroupName string, virtualWANName string, vpnClientParams armnetwork.VirtualWanVPNProfileParameters, options *armnetwork.VirtualWansClientBeginGeneratevirtualwanvpnserverconfigurationvpnprofileOptions) (resp azfake.PollerResponder[armnetwork.VirtualWansClientGeneratevirtualwanvpnserverconfigurationvpnprofileResponse], errResp azfake.ErrorResponder)
	...
	// SupportedSecurityProviders is the fake for method VirtualWansClient.SupportedSecurityProviders
	// HTTP status codes to indicate success: http.StatusOK
	SupportedSecurityProviders func(ctx context.Context, resourceGroupName string, virtualWANName string, options *armnetwork.VirtualWansClientSupportedSecurityProvidersOptions) (resp azfake.Responder[armnetwork.VirtualWansClientSupportedSecurityProvidersResponse], errResp azfake.ErrorResponder)
...
func NewVirtualWansServerTransport(srv *VirtualWansServer) *VirtualWansServerTransport {
	return &VirtualWansServerTransport{
		...
		beginGeneratevirtualwanvpnserverconfigurationvpnprofile: newTracker[azfake.PollerResponder[armnetwork.VirtualWansClientGeneratevirtualwanvpnserverconfigurationvpnprofileResponse]](),
...
type VirtualWansServerTransport struct {
	...
	beginGeneratevirtualwanvpnserverconfigurationvpnprofile *tracker[azfake.PollerResponder[armnetwork.VirtualWansClientGeneratevirtualwanvpnserverconfigurationvpnprofileResponse]]
...
func (v *VirtualWansServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if virtualWansServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = virtualWansServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "VirtualWansClient.BeginGeneratevirtualwanvpnserverconfigurationvpnprofile":
				res.resp, res.err = v.dispatchBeginGeneratevirtualwanvpnserverconfigurationvpnprofile(req)
			...
			case "VirtualWansClient.SupportedSecurityProviders":
				res.resp, res.err = v.dispatchSupportedSecurityProviders(req)
...
func (v *VirtualWansServerTransport) dispatchBeginGeneratevirtualwanvpnserverconfigurationvpnprofile(req *http.Request) (*http.Response, error) {
	if v.srv.BeginGeneratevirtualwanvpnserverconfigurationvpnprofile == nil {
	...
	beginGeneratevirtualwanvpnserverconfigurationvpnprofile := v.beginGeneratevirtualwanvpnserverconfigurationvpnprofile.get(req)
	if beginGeneratevirtualwanvpnserverconfigurationvpnprofile == nil {
		...
		respr, errRespr := v.srv.BeginGeneratevirtualwanvpnserverconfigurationvpnprofile(req.Context(), resourceGroupNameParam, virtualWANNameParam, body, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginGeneratevirtualwanvpnserverconfigurationvpnprofile = &respr
		v.beginGeneratevirtualwanvpnserverconfigurationvpnprofile.add(req, beginGeneratevirtualwanvpnserverconfigurationvpnprofile)
	}
	...
	if !contains([]int{http.StatusOK, http.StatusAccepted}, resp.StatusCode) {
		v.beginGeneratevirtualwanvpnserverconfigurationvpnprofile.remove(req)
...
func (v *VirtualWansServerTransport) dispatchSupportedSecurityProviders(req *http.Request) (*http.Response, error) {
	if v.srv.SupportedSecurityProviders == nil {
	...
	respr, errRespr := v.srv.SupportedSecurityProviders(req.Context(), resourceGroupNameParam, virtualWANNameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
// set this to conditionally intercept incoming requests to VirtualWansServerTransport
var virtualWansServerTransportInterceptor interface {
