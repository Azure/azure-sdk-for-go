...
func (v *VPNSitesServerTransport) dispatchBeginCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginCreateOrUpdate == nil {
		...
		respr, errRespr := v.srv.BeginCreateOrUpdate(req.Context(), resourceGroupNameUnescaped, vpnSiteNameUnescaped, body, nil)
...
func (v *VPNSitesServerTransport) dispatchBeginDelete(req *http.Request) (*http.Response, error) {
	...
	if beginDelete == nil {
		...
		respr, errRespr := v.srv.BeginDelete(req.Context(), resourceGroupNameUnescaped, vpnSiteNameUnescaped, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginDelete = &respr
...
func (v *VPNSitesServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := v.srv.Get(req.Context(), resourceGroupNameUnescaped, vpnSiteNameUnescaped, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
...
func (v *VPNSitesServerTransport) dispatchUpdateTags(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := v.srv.UpdateTags(req.Context(), resourceGroupNameUnescaped, vpnSiteNameUnescaped, body, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
