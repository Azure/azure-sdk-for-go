...
// NewListPager - Returns all signatures overrides objects for a specific policy as a list containing a single value.
//
// Generated from API version 2025-05-01
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - firewallPolicyName - The name of the Firewall Policy.
//   - options - FirewallPolicyIdpsSignaturesOverridesClientListOptions contains the optional parameters for the FirewallPolicyIdpsSignaturesOverridesClient.NewListPager
//     method.
func (client *FirewallPolicyIdpsSignaturesOverridesClient) NewListPager(resourceGroupName string, firewallPolicyName string, options *FirewallPolicyIdpsSignaturesOverridesClientListOptions) *runtime.Pager[FirewallPolicyIdpsSignaturesOverridesClientListResponse] {
	return runtime.NewPager(runtime.PagingHandler[FirewallPolicyIdpsSignaturesOverridesClientListResponse]{
		More: func(page FirewallPolicyIdpsSignaturesOverridesClientListResponse) bool {
			return false
		},
		Fetcher: func(ctx context.Context, page *FirewallPolicyIdpsSignaturesOverridesClientListResponse) (FirewallPolicyIdpsSignaturesOverridesClientListResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "FirewallPolicyIdpsSignaturesOverridesClient.NewListPager")
