...
// Generated from example definition: 2026-01-01/NetworkWatcherFlowLogCreate.json
func ExampleFlowLogsClient_BeginCreateOrUpdate() {
	...
	poller, err := clientFactory.NewFlowLogsClient().BeginCreateOrUpdate(ctx, "rg1", "nw1", "fl", armnetwork.FlowLog{
		...
		Properties: &armnetwork.FlowLogPropertiesFormat{
			...
			StorageID:                to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.Storage/storageAccounts/nwtest1mgvbfmqsigdxe"),
			TargetResourceID:         to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.Network/networkSecurityGroups/desmondcentral-nsg"),
		},
	}, nil)
	if err != nil {
	...
	// 		ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.Network/networkWatchers/nw/FlowLogs/fl"),
	// 		Identity: &armnetwork.ManagedServiceIdentity{
	// 			Type: to.Ptr(armnetwork.ResourceIdentityTypeUserAssigned),
	// 			UserAssignedIdentities: map[string]*armnetwork.ManagedServiceIdentityUserAssignedIdentities{
...
// Generated from example definition: 2026-01-01/NetworkWatcherFlowLogDelete.json
...
// Generated from example definition: 2026-01-01/NetworkWatcherFlowLogGet.json
func ExampleFlowLogsClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armnetwork.FlowLogsClientGetResponse{
	// 	FlowLog: armnetwork.FlowLog{
	// 		Name: to.Ptr("flowLog1"),
	// 		Type: to.Ptr("Microsoft.Network/networkWatchers/FlowLogs"),
	// 		Etag: to.Ptr("W/\"00000000-0000-0000-0000-000000000000\""),
	// 		ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.Network/networkWatchers/тц1/FlowLogs/flowLog1"),
	// 		Identity: &armnetwork.ManagedServiceIdentity{
	// 			Type: to.Ptr(armnetwork.ResourceIdentityTypeUserAssigned),
	// 			UserAssignedIdentities: map[string]*armnetwork.ManagedServiceIdentityUserAssignedIdentities{
	// 				"/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.ManagedIdentity/userAssignedIdentities/id1": &armnetwork.ManagedServiceIdentityUserAssignedIdentities{
	...
	// 				Enabled: to.Ptr(false),
	// 			},
	// 			StorageID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg/providers/Microsoft.Storage/storageAccounts/wzstorage002"),
	// 			TargetResourceGUID: to.Ptr("00000000-0000-0000-0000-000000000000"),
	// 			TargetResourceID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg/providers/Microsoft.Network/networkSecurityGroups/vm5-nsg"),
	// 		},
	// 	},
	// }
}

// Generated from example definition: 2026-01-01/NetworkWatcherFlowLogList.json
func ExampleFlowLogsClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armnetwork.FlowLogsClientListResponse{
		...
		// 						Enabled: to.Ptr(false),
		// 					},
		// 					StorageID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg/providers/Microsoft.Storage/storageAccounts/iraflowlogtest2diag"),
		// 					TargetResourceGUID: to.Ptr("00000000-0000-0000-0000-000000000000"),
		// 					TargetResourceID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg/providers/Microsoft.Network/networkSecurityGroups/DSCP-test-vm1-nsg"),
		// 				},
		// 			},
		// 		},
		// 	},
...
// Generated from example definition: 2026-01-01/NetworkWatcherFlowLogUpdateTags.json
func ExampleFlowLogsClient_UpdateTags() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armnetwork.FlowLogsClientUpdateTagsResponse{
	// 	FlowLog: armnetwork.FlowLog{
	// 		Name: to.Ptr("Microsoft.Networkdesmond-rgdesmondcentral-nsg"),
	// 		Type: to.Ptr("Microsoft.Network/networkWatchers/FlowLogs"),
	// 		Etag: to.Ptr("W/\"00000000-0000-0000-0000-000000000000\""),
