...
func (client *GroupsClient) createOrUpdateHandleResponse(resp *http.Response, successCodes ...int) (GroupsClientCreateOrUpdateResponse, error) {
...
func (client *GroupsClient) getHandleResponse(resp *http.Response, successCodes ...int) (GroupsClientGetResponse, error) {
...
func (client *GroupsClient) listCreateRequest(ctx context.Context, resourceGroupName string, networkManagerName string, nextLink string, options *GroupsClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *GroupsClient) listHandleResponse(resp *http.Response, successCodes ...int) (GroupsClientListResponse, error) {
