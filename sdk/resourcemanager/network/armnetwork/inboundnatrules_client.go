...
func (client *InboundNatRulesClient) getHandleResponse(resp *http.Response, successCodes ...int) (InboundNatRulesClientGetResponse, error) {
...
func (client *InboundNatRulesClient) listCreateRequest(ctx context.Context, resourceGroupName string, loadBalancerName string, nextLink string, _ *InboundNatRulesClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *InboundNatRulesClient) listHandleResponse(resp *http.Response, successCodes ...int) (InboundNatRulesClientListResponse, error) {
