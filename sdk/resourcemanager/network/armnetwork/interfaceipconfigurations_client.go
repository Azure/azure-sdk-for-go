...
func (client *InterfaceIPConfigurationsClient) getHandleResponse(resp *http.Response, successCodes ...int) (InterfaceIPConfigurationsClientGetResponse, error) {
...
func (client *InterfaceIPConfigurationsClient) listCreateRequest(ctx context.Context, resourceGroupName string, networkInterfaceName string, nextLink string, _ *InterfaceIPConfigurationsClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *InterfaceIPConfigurationsClient) listHandleResponse(resp *http.Response, successCodes ...int) (InterfaceIPConfigurationsClientListResponse, error) {
