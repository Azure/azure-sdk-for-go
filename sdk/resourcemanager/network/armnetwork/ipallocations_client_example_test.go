...
func ExampleIPAllocationsClient_BeginCreateOrUpdate() {
	...
	// res = armnetwork.IPAllocationsClientCreateOrUpdateResponse{
	// 	IPAllocation: armnetwork.IPAllocation{
	// 		Name: to.Ptr("test-ipallocation"),
	// 		Type: to.Ptr("Microsoft.Network/IpAllocations"),
	// 		ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.Network/IpAllocations/test-ipallocation"),
	// 		Location: to.Ptr("centraluseuap"),
	// 		Properties: &armnetwork.IPAllocationPropertiesFormat{
	// 			Type: to.Ptr(armnetwork.IPAllocationTypeHypernet),
	// 			AllocationTags: map[string]*string{
...
func ExampleIPAllocationsClient_BeginDelete() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armnetwork.IPAllocationsClientDeleteResponse{
	// }
}
...
func ExampleIPAllocationsClient_Get() {
	...
	res, err := clientFactory.NewIPAllocationsClient().Get(ctx, "rg1", "test-ipallocation", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armnetwork.IPAllocationsClientGetResponse{
	// 	IPAllocation: armnetwork.IPAllocation{
	// 		Name: to.Ptr("test-ipallocation"),
	// 		Type: to.Ptr("Microsoft.Network/IpAllocations"),
	// 		ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.Network/IpAllocations/test-ipallocation"),
...
func ExampleIPAllocationsClient_NewListByResourceGroupPager() {
	...
	for pager.More() {
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armnetwork.IPAllocationsClientListByResourceGroupResponse{
		// 	IPAllocationListResult: armnetwork.IPAllocationListResult{
		// 		Value: []*armnetwork.IPAllocation{
		// 			{
		// 				Name: to.Ptr("test-ipallocation1"),
...
func ExampleIPAllocationsClient_UpdateTags() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armnetwork.IPAllocationsClientUpdateTagsResponse{
	// 	IPAllocation: armnetwork.IPAllocation{
	// 		Name: to.Ptr("test-ipallocation"),
	// 		Type: to.Ptr("Microsoft.Network/IpAllocations"),
	// 		ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.Network/IpAllocations/test-ipallocation"),
