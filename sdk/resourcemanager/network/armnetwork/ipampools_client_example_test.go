...
func ExampleIpamPoolsClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armnetwork.IpamPoolsClientGetResponse{
	// 	IpamPool: armnetwork.IpamPool{
	// 		Name: to.Ptr("TestPool"),
	// 		Type: to.Ptr("Microsoft.Network/networkManagers/ipamPools"),
	// 		Etag: to.Ptr("\"00000000-0000-0000-0000-000000000000\""),
...
func ExampleIpamPoolsClient_GetPoolUsage() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armnetwork.IpamPoolsClientGetPoolUsageResponse{
	// 	PoolUsage: armnetwork.PoolUsage{
	// 		AddressPrefixes: []*string{
	// 			to.Ptr("10.0.0.0/8"),
	// 			to.Ptr("192.0.0.0/8"),
	// 		},
...
func ExampleIpamPoolsClient_Update() {
	...
	res, err := clientFactory.NewIpamPoolsClient().Update(ctx, "rg1", "TestNetworkManager", "TestPool", armnetwork.IpamPoolUpdate{
	}, nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
