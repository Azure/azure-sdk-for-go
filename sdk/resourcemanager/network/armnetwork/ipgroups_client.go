...
func (client *IPGroupsClient) getHandleResponse(resp *http.Response, successCodes ...int) (IPGroupsClientGetResponse, error) {
...
func (client *IPGroupsClient) listByResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, nextLink string, _ *IPGroupsClientListByResourceGroupOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
	var req *policy.Request
	var err error
	if firstPage {
...
func (client *IPGroupsClient) listByResourceGroupHandleResponse(resp *http.Response, successCodes ...int) (IPGroupsClientListByResourceGroupResponse, error) {
...
func (client *IPGroupsClient) UpdateGroups(ctx context.Context, resourceGroupName string, ipGroupsName string, parameters TagsObject, options *IPGroupsClientUpdateGroupsOptions) (IPGroupsClientUpdateGroupsResponse, error) {
	...
	return client.updateGroupsHandleResponse(httpResp, http.StatusOK)
}
...
func (client *IPGroupsClient) updateGroupsHandleResponse(resp *http.Response, successCodes ...int) (IPGroupsClientUpdateGroupsResponse, error) {
