			...
			LoadBalancingRules: []*armnetwork.LoadBalancingRule{
				{
					...
					Properties: &armnetwork.LoadBalancingRulePropertiesFormat{
						...
						BackendAddressPools: []*armnetwork.SubResource{
							{
								ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.Network/loadBalancers/lb/backendAddressPools/be-lb1"),
							},
							{
								ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.Network/loadBalancers/lb/backendAddressPools/be-lb2"),
							},
						},
						BackendPort: to.Ptr[int32](0),
						EnableFloatingIP: to.Ptr(true),
						...
						LoadBalancerBackendAddresses: []*armnetwork.LoadBalancerBackendAddress{
							{
								...
								Properties: &armnetwork.LoadBalancerBackendAddressPropertiesFormat{
									LoadBalancerFrontendIPConfiguration: &armnetwork.SubResource{
										ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/regional-lb-rg1/providers/Microsoft.Network/loadBalancers/regional-lb/frontendIPConfigurations/fe-rlb"),
									},
								},
							},
						},
...
func ExampleLoadBalancersClient_BeginCreateOrUpdate_createLoadBalancerWithOutboundRules() {
			...
			FrontendIPConfigurations: []*armnetwork.FrontendIPConfiguration{
				{
					...
					Properties: &armnetwork.FrontendIPConfigurationPropertiesFormat{
						PublicIPAddress: &armnetwork.PublicIPAddress{
							ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.Network/publicIPAddresses/pip"),
						},
					},
				},
			},
	...
	// 							{
	// 								ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.Network/loadBalancers/lb/outboundRules/rule1"),
	// 							},
	// 						},
	// 						ProvisioningState: to.Ptr(armnetwork.ProvisioningStateSucceeded),
	// 					},
...
func ExampleLoadBalancersClient_BeginDelete() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armnetwork.LoadBalancersClientDeleteResponse{
	// }
}
...
func ExampleLoadBalancersClient_Get_getLoadBalancer() {
	...
	res, err := clientFactory.NewLoadBalancersClient().Get(ctx, "rg1", "lb", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
...
func ExampleLoadBalancersClient_NewListAllPager() {
	...
	for pager.More() {
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armnetwork.LoadBalancersClientListAllResponse{
		// 	LoadBalancerListResult: armnetwork.LoadBalancerListResult{
		// 		Value: []*armnetwork.LoadBalancer{
		// 			{
		// 				Name: to.Ptr("lb"),
		...
		// 				Type: to.Ptr("Microsoft.Network/loadBalancers"),
		// 				Etag: to.Ptr("W/\"00000000-0000-0000-0000-00000000\""),
		// 				ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg2/providers/Microsoft.Network/loadBalancers/lb3"),
		// 				Location: to.Ptr("westus"),
		// 				Properties: &armnetwork.LoadBalancerPropertiesFormat{
		// 					BackendAddressPools: []*armnetwork.BackendAddressPool{
		// 					},
