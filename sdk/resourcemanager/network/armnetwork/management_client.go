...
// NewListActiveConnectivityConfigurationsPager - Lists active connectivity configurations in a network manager.
//
// Generated from API version 2025-05-01
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - networkManagerName - The name of the network manager.
//   - parameters - Active Configuration Parameter.
//   - options - ManagementClientListActiveConnectivityConfigurationsOptions contains the optional parameters for the ManagementClient.NewListActiveConnectivityConfigurationsPager
//     method.
func (client *ManagementClient) NewListActiveConnectivityConfigurationsPager(resourceGroupName string, networkManagerName string, parameters ActiveConfigurationParameter, options *ManagementClientListActiveConnectivityConfigurationsOptions) *runtime.Pager[ManagementClientListActiveConnectivityConfigurationsResponse] {
	return runtime.NewPager(runtime.PagingHandler[ManagementClientListActiveConnectivityConfigurationsResponse]{
		More: func(page ManagementClientListActiveConnectivityConfigurationsResponse) bool {
			return false
		},
		Fetcher: func(ctx context.Context, page *ManagementClientListActiveConnectivityConfigurationsResponse) (ManagementClientListActiveConnectivityConfigurationsResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "ManagementClient.NewListActiveConnectivityConfigurationsPager")
...
// NewListActiveSecurityAdminRulesPager - Lists active security admin rules in a network manager.
//
// Generated from API version 2025-05-01
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - networkManagerName - The name of the network manager.
//   - parameters - Active Configuration Parameter.
//   - options - ManagementClientListActiveSecurityAdminRulesOptions contains the optional parameters for the ManagementClient.NewListActiveSecurityAdminRulesPager
//     method.
func (client *ManagementClient) NewListActiveSecurityAdminRulesPager(resourceGroupName string, networkManagerName string, parameters ActiveConfigurationParameter, options *ManagementClientListActiveSecurityAdminRulesOptions) *runtime.Pager[ManagementClientListActiveSecurityAdminRulesResponse] {
	return runtime.NewPager(runtime.PagingHandler[ManagementClientListActiveSecurityAdminRulesResponse]{
		More: func(page ManagementClientListActiveSecurityAdminRulesResponse) bool {
			return false
		},
		Fetcher: func(ctx context.Context, page *ManagementClientListActiveSecurityAdminRulesResponse) (ManagementClientListActiveSecurityAdminRulesResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "ManagementClient.NewListActiveSecurityAdminRulesPager")
...
//     for the ManagementClient.NewListNetworkManagerEffectiveConnectivityConfigurationsPager method.
func (client *ManagementClient) NewListNetworkManagerEffectiveConnectivityConfigurationsPager(resourceGroupName string, virtualNetworkName string, parameters QueryRequestOptions, options *ManagementClientListNetworkManagerEffectiveConnectivityConfigurationsOptions) *runtime.Pager[ManagementClientListNetworkManagerEffectiveConnectivityConfigurationsResponse] {
	return runtime.NewPager(runtime.PagingHandler[ManagementClientListNetworkManagerEffectiveConnectivityConfigurationsResponse]{
		More: func(page ManagementClientListNetworkManagerEffectiveConnectivityConfigurationsResponse) bool {
			return false
		},
		Fetcher: func(ctx context.Context, page *ManagementClientListNetworkManagerEffectiveConnectivityConfigurationsResponse) (ManagementClientListNetworkManagerEffectiveConnectivityConfigurationsResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "ManagementClient.NewListNetworkManagerEffectiveConnectivityConfigurationsPager")
...
//     ManagementClient.NewListNetworkManagerEffectiveSecurityAdminRulesPager method.
func (client *ManagementClient) NewListNetworkManagerEffectiveSecurityAdminRulesPager(resourceGroupName string, virtualNetworkName string, parameters QueryRequestOptions, options *ManagementClientListNetworkManagerEffectiveSecurityAdminRulesOptions) *runtime.Pager[ManagementClientListNetworkManagerEffectiveSecurityAdminRulesResponse] {
	return runtime.NewPager(runtime.PagingHandler[ManagementClientListNetworkManagerEffectiveSecurityAdminRulesResponse]{
		More: func(page ManagementClientListNetworkManagerEffectiveSecurityAdminRulesResponse) bool {
			return false
		},
		Fetcher: func(ctx context.Context, page *ManagementClientListNetworkManagerEffectiveSecurityAdminRulesResponse) (ManagementClientListNetworkManagerEffectiveSecurityAdminRulesResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "ManagementClient.NewListNetworkManagerEffectiveSecurityAdminRulesPager")
