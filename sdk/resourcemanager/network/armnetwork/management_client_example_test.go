...
func ExampleManagementClient_BeginDeleteBastionShareableLink() {
	...
	poller, err := clientFactory.NewManagementClient().BeginDeleteBastionShareableLink(ctx, "rg1", "bastionhosttenant", armnetwork.BastionShareableLinkListRequest{
		VMs: []*armnetwork.BastionShareableLink{
			{
				VM: &armnetwork.VM{
					ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rgx/providers/Microsoft.Compute/virtualMachines/vm1"),
				},
			},
			{
				VM: &armnetwork.VM{
					ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rgx/providers/Microsoft.Compute/virtualMachines/vm2"),
				},
			},
		},
	}, nil)
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armnetwork.ManagementClientDeleteBastionShareableLinkResponse{
	// }
}
...
func ExampleManagementClient_BeginGeneratevirtualwanvpnserverconfigurationvpnprofile() {
	...
	poller, err := clientFactory.NewManagementClient().BeginGeneratevirtualwanvpnserverconfigurationvpnprofile(ctx, "rg1", "wan1", armnetwork.VirtualWanVPNProfileParameters{
		...
		VPNServerConfigurationResourceID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.Network/vpnServerConfigurations/vpnconfig1"),
	}, nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armnetwork.ManagementClientGeneratevirtualwanvpnserverconfigurationvpnprofileResponse{
...
func ExampleManagementClient_ListActiveConnectivityConfigurations() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armnetwork.ManagementClientListActiveConnectivityConfigurationsResponse{
	// 	ActiveConnectivityConfigurationsListResult: armnetwork.ActiveConnectivityConfigurationsListResult{
	// 		SkipToken: to.Ptr("FakeSkipTokenCode"),
...
func ExampleManagementClient_ListActiveSecurityAdminRules() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armnetwork.ManagementClientListActiveSecurityAdminRulesResponse{
	// 	ActiveSecurityAdminRulesListResult: armnetwork.ActiveSecurityAdminRulesListResult{
	// 		SkipToken: to.Ptr("FakeSkipTokenCode"),
...
func ExampleManagementClient_ListNetworkManagerEffectiveConnectivityConfigurations() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armnetwork.ManagementClientListNetworkManagerEffectiveConnectivityConfigurationsResponse{
	// 	ManagerEffectiveConnectivityConfigurationListResult: armnetwork.ManagerEffectiveConnectivityConfigurationListResult{
	// 		SkipToken: to.Ptr("FakeSkipTokenCode"),
...
func ExampleManagementClient_ListNetworkManagerEffectiveSecurityAdminRules() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armnetwork.ManagementClientListNetworkManagerEffectiveSecurityAdminRulesResponse{
	// 	ManagerEffectiveSecurityAdminRulesListResult: armnetwork.ManagerEffectiveSecurityAdminRulesListResult{
	// 		SkipToken: to.Ptr("FakeSkipTokenCode"),
...
func ExampleManagementClient_SupportedSecurityProviders() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armnetwork.ManagementClientSupportedSecurityProvidersResponse{
	// 	VirtualWanSecurityProviders: armnetwork.VirtualWanSecurityProviders{
