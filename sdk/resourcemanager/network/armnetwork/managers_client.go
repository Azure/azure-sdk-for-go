...
//   - options - ManagersClientListActiveConnectivityConfigurationsOptions contains the optional parameters for the ManagersClient.NewListActiveConnectivityConfigurationsPager
//     method.
func (client *ManagersClient) NewListActiveConnectivityConfigurationsPager(resourceGroupName string, networkManagerName string, parameters ActiveConfigurationParameter, options *ManagersClientListActiveConnectivityConfigurationsOptions) *runtime.Pager[ManagersClientListActiveConnectivityConfigurationsResponse] {
	return runtime.NewPager(runtime.PagingHandler[ManagersClientListActiveConnectivityConfigurationsResponse]{
		More: func(page ManagersClientListActiveConnectivityConfigurationsResponse) bool {
			return false
		},
		Fetcher: func(ctx context.Context, page *ManagersClientListActiveConnectivityConfigurationsResponse) (ManagersClientListActiveConnectivityConfigurationsResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "ManagersClient.NewListActiveConnectivityConfigurationsPager")
			...
			if err != nil {
				return ManagersClientListActiveConnectivityConfigurationsResponse{}, err
			}
			...
			if !runtime.HasStatusCode(resp, http.StatusOK) {
				return ManagersClientListActiveConnectivityConfigurationsResponse{}, runtime.NewResponseError(resp)
			}
...
func (client *ManagersClient) listActiveConnectivityConfigurationsCreateRequest(ctx context.Context, resourceGroupName string, networkManagerName string, parameters ActiveConfigurationParameter, options *ManagersClientListActiveConnectivityConfigurationsOptions) (*policy.Request, error) {
...
func (client *ManagersClient) listActiveConnectivityConfigurationsHandleResponse(resp *http.Response) (ManagersClientListActiveConnectivityConfigurationsResponse, error) {
	result := ManagersClientListActiveConnectivityConfigurationsResponse{}
...
//   - networkManagerName - The name of the network manager.
//   - parameters - Active Configuration Parameter.
//   - options - ManagersClientListActiveSecurityAdminRulesOptions contains the optional parameters for the ManagersClient.NewListActiveSecurityAdminRulesPager
//     method.
func (client *ManagersClient) NewListActiveSecurityAdminRulesPager(resourceGroupName string, networkManagerName string, parameters ActiveConfigurationParameter, options *ManagersClientListActiveSecurityAdminRulesOptions) *runtime.Pager[ManagersClientListActiveSecurityAdminRulesResponse] {
	return runtime.NewPager(runtime.PagingHandler[ManagersClientListActiveSecurityAdminRulesResponse]{
		More: func(page ManagersClientListActiveSecurityAdminRulesResponse) bool {
			return false
		},
		Fetcher: func(ctx context.Context, page *ManagersClientListActiveSecurityAdminRulesResponse) (ManagersClientListActiveSecurityAdminRulesResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "ManagersClient.NewListActiveSecurityAdminRulesPager")
			req, err := client.listActiveSecurityAdminRulesCreateRequest(ctx, resourceGroupName, networkManagerName, parameters, options)
			if err != nil {
				return ManagersClientListActiveSecurityAdminRulesResponse{}, err
			}
			resp, err := client.internal.Pipeline().Do(req)
			if err != nil {
				return ManagersClientListActiveSecurityAdminRulesResponse{}, err
			...
			if !runtime.HasStatusCode(resp, http.StatusOK) {
				return ManagersClientListActiveSecurityAdminRulesResponse{}, runtime.NewResponseError(resp)
			}
...
func (client *ManagersClient) listActiveSecurityAdminRulesCreateRequest(ctx context.Context, resourceGroupName string, networkManagerName string, parameters ActiveConfigurationParameter, options *ManagersClientListActiveSecurityAdminRulesOptions) (*policy.Request, error) {
...
func (client *ManagersClient) listActiveSecurityAdminRulesHandleResponse(resp *http.Response) (ManagersClientListActiveSecurityAdminRulesResponse, error) {
	result := ManagersClientListActiveSecurityAdminRulesResponse{}
