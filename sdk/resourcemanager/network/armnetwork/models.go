...
type AdminPropertiesFormat struct {
	...
	ProvisioningState *BaseProvisioningState
...
type DeleteBastionShareableLinkFinalResult struct {
}
...
type DisconnectVirtualNetworkGatewayVPNConnectionsFinalResult struct {
}
...
// ExpressRouteProviderPortListResult - The response of a ExpressRouteProviderPort list operation.
...
type GenerateVPNProfileFinalResult struct {
	// REQUIRED
	Body *string
}

type GeneratevpnclientpackageFinalResult struct {
	// REQUIRED
	Body *string
}

type GetIkeSasFinalResult struct {
	// REQUIRED
	Body *string
}
...
type GetVPNProfilePackageURLFinalResult struct {
	// REQUIRED
	Body *string
}
...
type InterfacePropertiesFormat struct {
	...
	AuxiliaryMode *InterfaceAuxiliaryMode

	// Auxiliary sku of Network Interface resource.
	AuxiliarySKU *InterfaceAuxiliarySKU
	...
	MigrationPhase *InterfaceMigrationPhase

	// The reference to the NetworkSecurityGroup resource.
	NetworkSecurityGroup *SecurityGroup

	// Type of Network Interface resource.
	NicType *InterfaceNicType
...
// NoContentResponse - There is no content to send for this request, but the headers may be useful.
...
type PrepareNetworkPoliciesFinalResult struct {
}
...
type ResetVPNClientSharedKeyFinalResult struct {
}
...
type SecurityAdminConfigurationPropertiesFormat struct {
	...
	ApplyOnNetworkIntentPolicyBasedServices []*IntentPolicyBasedService
...
type StartExpressRouteSiteFailoverSimulationFinalResult struct {
	// REQUIRED
	Body *string
}

type StartFinalResult struct {
}

type StartPacketCaptureFinalResult struct {
	// REQUIRED
	Body *string
}

type StartPacketCaptureFinalResult1 struct {
	// REQUIRED
	Body *string
}

type StartPacketCaptureFinalResult2 struct {
	// REQUIRED
	Body *string
}
...
type StopExpressRouteSiteFailoverSimulationFinalResult struct {
	// REQUIRED
	Body *string
}
...
type StopFinalResult1 struct {
}

type StopPacketCaptureFinalResult struct {
	// REQUIRED
	Body *string
}

type StopPacketCaptureFinalResult1 struct {
	// REQUIRED
	Body *string
}

type StopPacketCaptureFinalResult2 struct {
	// REQUIRED
	Body *string
}
...
type UnprepareNetworkPoliciesFinalResult struct {
}
...
type VPNConnectionsStartPacketCaptureFinalResult struct {
	// REQUIRED
	Body *string
}

type VPNConnectionsStopPacketCaptureFinalResult struct {
	// REQUIRED
	Body *string
}
