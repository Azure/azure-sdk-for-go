...
func (testsuite *NetworkManagerConnectionTestSuite) SetupSuite() {
	...
	testsuite.networkManagerConnectionName = testutil.GenerateAlphaNumericID(testsuite.T(), "netmanagerconnsub", 6)
	testsuite.networkManagerName = testutil.GenerateAlphaNumericID(testsuite.T(), "networkmanagerconn", 6)
