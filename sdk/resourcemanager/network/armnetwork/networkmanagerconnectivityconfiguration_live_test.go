...
func (testsuite *NetworkManagerConnectivityConfigurationTestSuite) SetupSuite() {
	...
	testsuite.configurationName = testutil.GenerateAlphaNumericID(testsuite.T(), "connectivityconf", 6)
	testsuite.networkGroupName = testutil.GenerateAlphaNumericID(testsuite.T(), "networkgroconeconfig", 6)
