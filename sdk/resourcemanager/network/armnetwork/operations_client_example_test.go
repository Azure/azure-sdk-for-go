...
// Generated from example definition: 2025-07-01/OperationList.json
func ExampleOperationsClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armnetwork.OperationsClientListResponse{
		// 	OperationListResult: armnetwork.OperationListResult{
