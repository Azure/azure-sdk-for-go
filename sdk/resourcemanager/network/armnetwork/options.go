...
// BastionHostsClientBeginDeleteBastionShareableLinkByTokenOptions contains the optional parameters for the BastionHostsClient.BeginDeleteBastionShareableLinkByToken
// method.
type BastionHostsClientBeginDeleteBastionShareableLinkByTokenOptions struct {
	// Resumes the long-running operation from the provided token.
	ResumeToken string
}

// BastionHostsClientBeginDeleteBastionShareableLinkOptions contains the optional parameters for the BastionHostsClient.BeginDeleteBastionShareableLink
// method.
type BastionHostsClientBeginDeleteBastionShareableLinkOptions struct {
	// Resumes the long-running operation from the provided token.
	ResumeToken string
}
...
// BastionHostsClientBeginGetActiveSessionsOptions contains the optional parameters for the BastionHostsClient.BeginGetActiveSessions
// method.
type BastionHostsClientBeginGetActiveSessionsOptions struct {
	// Resumes the long-running operation from the provided token.
	ResumeToken string
}

// BastionHostsClientBeginPutBastionShareableLinkOptions contains the optional parameters for the BastionHostsClient.BeginPutBastionShareableLink
// method.
type BastionHostsClientBeginPutBastionShareableLinkOptions struct {
	// Resumes the long-running operation from the provided token.
	ResumeToken string
}
...
// BastionHostsClientDisconnectActiveSessionsOptions contains the optional parameters for the BastionHostsClient.NewDisconnectActiveSessionsPager
// method.
type BastionHostsClientDisconnectActiveSessionsOptions struct {
	// placeholder for future optional parameters
}

// BastionHostsClientGetBastionShareableLinkOptions contains the optional parameters for the BastionHostsClient.NewGetBastionShareableLinkPager
// method.
type BastionHostsClientGetBastionShareableLinkOptions struct {
	// placeholder for future optional parameters
}
...
// CheckDNSNameAvailabilityClientCheckDNSNameAvailabilityOptions contains the optional parameters for the CheckDNSNameAvailabilityClient.CheckDNSNameAvailability
// method.
type CheckDNSNameAvailabilityClientCheckDNSNameAvailabilityOptions struct {
	// placeholder for future optional parameters
}
...
// EffectiveConfigurationsClientListNetworkManagerEffectiveConnectivityConfigurationsOptions contains the optional parameters
// for the EffectiveConfigurationsClient.NewListNetworkManagerEffectiveConnectivityConfigurationsPager method.
type EffectiveConfigurationsClientListNetworkManagerEffectiveConnectivityConfigurationsOptions struct {
	// An optional query parameter which specifies the maximum number of records to be returned by the server.
	Top *int32
}

// EffectiveConfigurationsClientListNetworkManagerEffectiveSecurityAdminRulesOptions contains the optional parameters for
// the EffectiveConfigurationsClient.NewListNetworkManagerEffectiveSecurityAdminRulesPager method.
type EffectiveConfigurationsClientListNetworkManagerEffectiveSecurityAdminRulesOptions struct {
	// An optional query parameter which specifies the maximum number of records to be returned by the server.
	Top *int32
}
...
// ExpressRouteConnectionsClientListOptions contains the optional parameters for the ExpressRouteConnectionsClient.NewListPager
// method.
...
// ExpressRouteGatewaysClientListByResourceGroupOptions contains the optional parameters for the ExpressRouteGatewaysClient.NewListByResourceGroupPager
// method.
type ExpressRouteGatewaysClientListByResourceGroupOptions struct {
	// placeholder for future optional parameters
}

// ExpressRouteGatewaysClientListBySubscriptionOptions contains the optional parameters for the ExpressRouteGatewaysClient.NewListBySubscriptionPager
// method.
...
// ExpressRouteProviderPortsClientExpressRouteProviderPortOptions contains the optional parameters for the ExpressRouteProviderPortsClient.ExpressRouteProviderPort
// method.
type ExpressRouteProviderPortsClientExpressRouteProviderPortOptions struct {
	// placeholder for future optional parameters
}
...
// FirewallPolicyIdpsSignaturesOverridesClientListOptions contains the optional parameters for the FirewallPolicyIdpsSignaturesOverridesClient.NewListPager
// method.
...
// ManagerDeploymentStatusClientListOptions contains the optional parameters for the ManagerDeploymentStatusClient.NewListPager
// method.
...
// ManagersClientListActiveConnectivityConfigurationsOptions contains the optional parameters for the ManagersClient.NewListActiveConnectivityConfigurationsPager
// method.
type ManagersClientListActiveConnectivityConfigurationsOptions struct {
	// An optional query parameter which specifies the maximum number of records to be returned by the server.
	Top *int32
}

// ManagersClientListActiveSecurityAdminRulesOptions contains the optional parameters for the ManagersClient.NewListActiveSecurityAdminRulesPager
// method.
type ManagersClientListActiveSecurityAdminRulesOptions struct {
	// An optional query parameter which specifies the maximum number of records to be returned by the server.
	Top *int32
}
...
// VipSwapClientListOptions contains the optional parameters for the VipSwapClient.NewListPager method.
...
// VirtualWANSClientBeginGeneratevirtualwanvpnserverconfigurationvpnprofileOptions contains the optional parameters for the
// VirtualWANSClient.BeginGeneratevirtualwanvpnserverconfigurationvpnprofile method.
type VirtualWANSClientBeginGeneratevirtualwanvpnserverconfigurationvpnprofileOptions struct {
	// Resumes the long-running operation from the provided token.
	ResumeToken string
}

// VirtualWANSClientSupportedSecurityProvidersOptions contains the optional parameters for the VirtualWANSClient.SupportedSecurityProviders
// method.
type VirtualWANSClientSupportedSecurityProvidersOptions struct {
	// placeholder for future optional parameters
}
