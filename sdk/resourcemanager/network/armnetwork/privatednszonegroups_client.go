...
//   - privateDNSZoneGroupName - The name of the private endpoint.
...
func (client *PrivateDNSZoneGroupsClient) getHandleResponse(resp *http.Response, successCodes ...int) (PrivateDNSZoneGroupsClientGetResponse, error) {
...
func (client *PrivateDNSZoneGroupsClient) NewListPager(privateEndpointName string, resourceGroupName string, options *PrivateDNSZoneGroupsClientListOptions) *runtime.Pager[PrivateDNSZoneGroupsClientListResponse] {
	return runtime.NewPager(runtime.PagingHandler[PrivateDNSZoneGroupsClientListResponse]{
		...
		Fetcher: func(ctx context.Context, page *PrivateDNSZoneGroupsClientListResponse) (PrivateDNSZoneGroupsClientListResponse, error) {
			...
			req, err := client.listCreateRequest(ctx, privateEndpointName, resourceGroupName, nextLink, options)
			if err != nil {
...
func (client *PrivateDNSZoneGroupsClient) listCreateRequest(ctx context.Context, privateEndpointName string, resourceGroupName string, nextLink string, _ *PrivateDNSZoneGroupsClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *PrivateDNSZoneGroupsClient) listHandleResponse(resp *http.Response, successCodes ...int) (PrivateDNSZoneGroupsClientListResponse, error) {
