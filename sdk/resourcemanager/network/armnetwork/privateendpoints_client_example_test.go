...
func ExamplePrivateEndpointsClient_BeginCreateOrUpdate_createPrivateEndpoint() {
			...
			PrivateLinkServiceConnections: []*armnetwork.PrivateLinkServiceConnection{
				{
					Properties: &armnetwork.PrivateLinkServiceConnectionProperties{
						...
						PrivateLinkServiceID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.Network/privateLinkServices/testPls"),
	...
	// res = armnetwork.PrivateEndpointsClientCreateOrUpdateResponse{
	...
	// 				{
	// 					ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/provders/Microsoft.Network/networkInterfaces/testPe.nic.abcd1234"),
	// 				},
	// 			},
	// 			PrivateLinkServiceConnections: []*armnetwork.PrivateLinkServiceConnection{
	// 				{
	// 					ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.Network/privateEndpoints/testPe/privateLinkServiceConnections/plsconnection1"),
	// 					Properties: &armnetwork.PrivateLinkServiceConnectionProperties{
	// 						GroupIDs: []*string{
	// 							to.Ptr("groupIdFromResource"),
	// 						},
...
func ExamplePrivateEndpointsClient_BeginCreateOrUpdate_createPrivateEndpointWithManualApprovalConnection() {
	...
	// 			ManualPrivateLinkServiceConnections: []*armnetwork.PrivateLinkServiceConnection{
	// 				{
	// 					ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.Network/privateEndpoints/testPe/manualPrivateLinkServiceConnections/plsconnection1"),
	// 					Properties: &armnetwork.PrivateLinkServiceConnectionProperties{
	// 						GroupIDs: []*string{
	// 							to.Ptr("groupIdFromResource"),
	// 						},
...
func ExamplePrivateEndpointsClient_BeginCreateOrUpdate_createPrivateEndpointWithApplicationSecurityGroups() {
	...
	poller, err := clientFactory.NewPrivateEndpointsClient().BeginCreateOrUpdate(ctx, "rg1", "testPe", armnetwork.PrivateEndpoint{
		...
		Properties: &armnetwork.PrivateEndpointProperties{
			ApplicationSecurityGroups: []*armnetwork.ApplicationSecurityGroup{
				{
					ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/provders/Microsoft.Network/applicationSecurityGroup/asg1"),
				},
			},
			PrivateLinkServiceConnections: []*armnetwork.PrivateLinkServiceConnection{
				{
...
func ExamplePrivateEndpointsClient_Get_getPrivateEndpoint() {
	...
	res, err := clientFactory.NewPrivateEndpointsClient().Get(ctx, "rg1", "testPe", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armnetwork.PrivateEndpointsClientGetResponse{
	// 	PrivateEndpoint: armnetwork.PrivateEndpoint{
	// 		Name: to.Ptr("testPe"),
...
func ExamplePrivateEndpointsClient_NewListBySubscriptionPager() {
	...
	for pager.More() {
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armnetwork.PrivateEndpointsClientListBySubscriptionResponse{
		// 	PrivateEndpointListResult: armnetwork.PrivateEndpointListResult{
		// 		Value: []*armnetwork.PrivateEndpoint{
		// 			{
		// 				Name: to.Ptr("pe1"),
		...
		// 				Name: to.Ptr("pe2"),
		// 				Type: to.Ptr("Microsoft.Network/privateEndpoints"),
		// 				ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg2/providers/Microsoft.Network/privateEndpoints/pe2"),
		// 				Location: to.Ptr("eastus"),
		// 				Properties: &armnetwork.PrivateEndpointProperties{
		// 					ApplicationSecurityGroups: []*armnetwork.ApplicationSecurityGroup{
		// 					},
		...
		// 					ManualPrivateLinkServiceConnections: []*armnetwork.PrivateLinkServiceConnection{
		// 						{
		// 							ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg2/providers/Microsoft.Network/privateEndpoints/pe2/privateLinkServiceConnections/plsconnection2"),
		// 							Properties: &armnetwork.PrivateLinkServiceConnectionProperties{
		// 								GroupIDs: []*string{
		// 									to.Ptr("groupIdFromResource"),
		// 								},
		...
		// 									Status: to.Ptr("Pending"),
		// 								},
		// 								PrivateLinkServiceID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg2/providers/Microsoft.Network/privateLinkServices/testPls2"),
		// 								RequestMessage: to.Ptr("Please manually approve my connection for pe2."),
		// 							},
		// 						},
		// 					},
		// 					NetworkInterfaces: []*armnetwork.Interface{
		// 						{
		// 							ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg2/provders/Microsoft.Network/networkInterfaces/pe2.nic.zyxw9876"),
		// 						},
		// 					},
		// 					PrivateLinkServiceConnections: []*armnetwork.PrivateLinkServiceConnection{
		// 					},
		// 					ProvisioningState: to.Ptr(armnetwork.ProvisioningStateSucceeded),
		// 					Subnet: &armnetwork.Subnet{
		// 						ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg2/providers/Microsoft.Network/virtualNetworks/myVnet/subnets/mySubnet2"),
		// 					},
		// 				},
		// 			},
		// 			{
		// 				Name: to.Ptr("pe3"),
		// 				Type: to.Ptr("Microsoft.Network/privateEndpoints"),
		// 				ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg3/providers/Microsoft.Network/privateEndpoints/pe3"),
		// 				Location: to.Ptr("eastus"),
		// 				Properties: &armnetwork.PrivateEndpointProperties{
		// 					ApplicationSecurityGroups: []*armnetwork.ApplicationSecurityGroup{
		// 					},
		...
		// 					NetworkInterfaces: []*armnetwork.Interface{
		// 						{
		// 							ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg3/provders/Microsoft.Network/networkInterfaces/pe3.nic.efgh5463"),
		// 						},
		// 					},
		// 					PrivateLinkServiceConnections: []*armnetwork.PrivateLinkServiceConnection{
		// 						{
		// 							ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg3/providers/Microsoft.Network/privateEndpoints/testPe/privateLinkServiceConnections/plsconnection3"),
		// 							Properties: &armnetwork.PrivateLinkServiceConnectionProperties{
		// 								GroupIDs: []*string{
		// 									to.Ptr("groupIdFromResource"),
		// 								},
		...
		// 									Status: to.Ptr("Approved"),
		// 								},
		// 								PrivateLinkServiceID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg3/providers/Microsoft.Network/privateLinkServices/testPls3"),
