...
// Generated from example definition: 2025-07-01/PublicIpPrefixCreateCustomizedValues.json
func ExamplePublicIPPrefixesClient_BeginCreateOrUpdate_createPublicIPPrefixAllocationMethod() {
	...
	// res = armnetwork.PublicIPPrefixesClientCreateOrUpdateResponse{
...
// Generated from example definition: 2025-07-01/PublicIpPrefixCreateDefaults.json
...
// Generated from example definition: 2025-07-01/PublicIpPrefixCreateDefaultsStandardV2Sku.json
...
// Generated from example definition: 2025-07-01/PublicIpPrefixDelete.json
func ExamplePublicIPPrefixesClient_BeginDelete() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armnetwork.PublicIPPrefixesClientDeleteResponse{
	// }
}
...
// Generated from example definition: 2025-07-01/PublicIpPrefixGetStandardV2Sku.json
...
// Generated from example definition: 2025-07-01/PublicIpPrefixList.json
...
// Generated from example definition: 2025-07-01/PublicIpPrefixListAll.json
func ExamplePublicIPPrefixesClient_NewListAllPager() {
	...
	for pager.More() {
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armnetwork.PublicIPPrefixesClientListAllResponse{
		// 	PublicIPPrefixListResult: armnetwork.PublicIPPrefixListResult{
		// 		Value: []*armnetwork.PublicIPPrefix{
		// 			{
		// 				Name: to.Ptr("test-ipprefix"),
		...
		// 				Type: to.Ptr("Microsoft.Network/publicIPPrefixes"),
		// 				Etag: to.Ptr("W/\"00000000-0000-0000-0000-00000000\""),
		// 				ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg2/providers/Microsoft.Network/publicIPPrefixes/ipprefix01"),
		// 				Location: to.Ptr("westus"),
		// 				Properties: &armnetwork.PublicIPPrefixPropertiesFormat{
		...
		// 				Type: to.Ptr("Microsoft.Network/publicIPPrefixes"),
		// 				Etag: to.Ptr("W/\"00000000-0000-0000-0000-00000000\""),
		// 				ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg3/providers/Microsoft.Network/publicIPPrefixes/pfx"),
		// 				Location: to.Ptr("westus"),
		// 				Properties: &armnetwork.PublicIPPrefixPropertiesFormat{
		...
		// 						ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg3/providers/Microsoft.Network/loadBalancers/lb-pfx/frontendIPConfigurations/ipconfig1"),
		// 					},
		// 					PrefixLength: to.Ptr[int32](30),
		// 					ProvisioningState: to.Ptr(armnetwork.ProvisioningStateSucceeded),
		// 					PublicIPAddressVersion: to.Ptr(armnetwork.IPVersionIPv4),
...
// Generated from example definition: 2025-07-01/PublicIpPrefixUpdateTags.json
func ExamplePublicIPPrefixesClient_UpdateTags() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armnetwork.PublicIPPrefixesClientUpdateTagsResponse{
	// 	PublicIPPrefix: armnetwork.PublicIPPrefix{
	// 		Name: to.Ptr("test-ipprefix"),
	// 		Type: to.Ptr("Microsoft.Network/publicIPPrefixes"),
	// 		Etag: to.Ptr("W/\"00000000-0000-0000-0000-00000000\""),
