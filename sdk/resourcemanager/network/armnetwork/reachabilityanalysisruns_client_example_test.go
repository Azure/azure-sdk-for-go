...
func ExampleReachabilityAnalysisRunsClient_Create() {
	...
	// res = armnetwork.ReachabilityAnalysisRunsClientCreateResponse{
	// 	ReachabilityAnalysisRun: armnetwork.ReachabilityAnalysisRun{
...
func ExampleReachabilityAnalysisRunsClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armnetwork.ReachabilityAnalysisRunsClientGetResponse{
	// 	ReachabilityAnalysisRun: armnetwork.ReachabilityAnalysisRun{
	// 		Name: to.Ptr("testAnalysisRunName"),
	// 		Type: to.Ptr("Microsoft.Network/networkManagers/verifierWorkspaces/reachabilityAnalysisRuns"),
	// 		ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.Network/networkManagers/testNetworkManager/verifierWorkspaces/testWorkspace/reachabilityAnalysisRuns/testAnalysisRunName"),
...
func ExampleReachabilityAnalysisRunsClient_NewListPager() {
	...
	pager := clientFactory.NewReachabilityAnalysisRunsClient().NewListPager("rg1", "testNetworkManager", "testVerifierWorkspace1", nil)
	for pager.More() {
		...
		// page = armnetwork.ReachabilityAnalysisRunsClientListResponse{
		// 	ReachabilityAnalysisRunListResult: armnetwork.ReachabilityAnalysisRunListResult{
		// 		NextLink: to.Ptr("https://management.azure.com/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.Network/networkManagers/testNetworkManager/verifierWorkspaces/testVerifierWorkspace1/reachabilityAnalysisRuns?api-version=2025-07-01&$skipToken=10"),
