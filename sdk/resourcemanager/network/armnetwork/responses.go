...
// Paged collection of EndpointServiceResult items
...
// CommitsClientCreateOrUpdateResponse contains the response from method CommitsClient.BeginCreateOrUpdate.
type CommitsClientCreateOrUpdateResponse struct {
// The commit resource
	Commit
}

// CommitsClientDeleteResponse contains the response from method CommitsClient.BeginDelete.
type CommitsClientDeleteResponse struct {
	// placeholder for future response values
}

// CommitsClientGetResponse contains the response from method CommitsClient.Get.
type CommitsClientGetResponse struct {
// The commit resource
	Commit
}

// CommitsClientListResponse contains the response from method CommitsClient.NewListPager.
type CommitsClientListResponse struct {
...
// ConnectionPoliciesClientCreateOrUpdateResponse contains the response from method ConnectionPoliciesClient.BeginCreateOrUpdate.
type ConnectionPoliciesClientCreateOrUpdateResponse struct {
// ConnectionPolicy resource defined for VirtualHub.
	ConnectionPolicy
}

// ConnectionPoliciesClientDeleteResponse contains the response from method ConnectionPoliciesClient.BeginDelete.
type ConnectionPoliciesClientDeleteResponse struct {
	// placeholder for future response values
}

// ConnectionPoliciesClientGetResponse contains the response from method ConnectionPoliciesClient.Get.
type ConnectionPoliciesClientGetResponse struct {
// ConnectionPolicy resource defined for VirtualHub.
	ConnectionPolicy
}

// ConnectionPoliciesClientListResponse contains the response from method ConnectionPoliciesClient.NewListPager.
type ConnectionPoliciesClientListResponse struct {
...
// DdosCustomPoliciesClientListAllResponse contains the response from method DdosCustomPoliciesClient.NewListAllPager.
type DdosCustomPoliciesClientListAllResponse struct {
// The response of a DdosCustomPolicy list operation.
	DdosCustomPolicyListResult
}

// DdosCustomPoliciesClientListResponse contains the response from method DdosCustomPoliciesClient.NewListPager.
type DdosCustomPoliciesClientListResponse struct {
// The response of a DdosCustomPolicy list operation.
	DdosCustomPolicyListResult
}
...
// ExpressRouteCircuitsClientGetCircuitLinkFailoverAllTestsDetailsResponse contains the response from method ExpressRouteCircuitsClient.BeginGetCircuitLinkFailoverAllTestsDetails.
type ExpressRouteCircuitsClientGetCircuitLinkFailoverAllTestsDetailsResponse struct {
	ExpressRouteLinkFailoverAllTestsDetailsArray []*ExpressRouteLinkFailoverAllTestsDetails
}

// ExpressRouteCircuitsClientGetCircuitLinkFailoverSingleTestDetailsResponse contains the response from method ExpressRouteCircuitsClient.BeginGetCircuitLinkFailoverSingleTestDetails.
type ExpressRouteCircuitsClientGetCircuitLinkFailoverSingleTestDetailsResponse struct {
	ExpressRouteLinkFailoverSingleTestDetailsArray []*ExpressRouteLinkFailoverSingleTestDetails
}
...
// ExpressRouteCircuitsClientStartCircuitLinkFailoverTestResponse contains the response from method ExpressRouteCircuitsClient.BeginStartCircuitLinkFailoverTest.
type ExpressRouteCircuitsClientStartCircuitLinkFailoverTestResponse struct {
	Value *string
}

// ExpressRouteCircuitsClientStopCircuitLinkFailoverTestResponse contains the response from method ExpressRouteCircuitsClient.BeginStopCircuitLinkFailoverTest.
type ExpressRouteCircuitsClientStopCircuitLinkFailoverTestResponse struct {
	Value *string
}
...
// ExpressRouteGatewaysClientGetFailoverAllTestsDetailsResponse contains the response from method ExpressRouteGatewaysClient.BeginGetFailoverAllTestsDetails.
type ExpressRouteGatewaysClientGetFailoverAllTestsDetailsResponse struct {
	ExpressRouteFailoverTestDetailsArray []*ExpressRouteFailoverTestDetails
}

// ExpressRouteGatewaysClientGetFailoverSingleTestDetailsResponse contains the response from method ExpressRouteGatewaysClient.BeginGetFailoverSingleTestDetails.
type ExpressRouteGatewaysClientGetFailoverSingleTestDetailsResponse struct {
	ExpressRouteFailoverSingleTestDetailsArray []*ExpressRouteFailoverSingleTestDetails
}

// ExpressRouteGatewaysClientGetResiliencyInformationResponse contains the response from method ExpressRouteGatewaysClient.BeginGetResiliencyInformation.
type ExpressRouteGatewaysClientGetResiliencyInformationResponse struct {
...
// ExpressRouteGatewaysClientGetRoutesInformationResponse contains the response from method ExpressRouteGatewaysClient.BeginGetRoutesInformation.
type ExpressRouteGatewaysClientGetRoutesInformationResponse struct {
...
// ExpressRouteGatewaysClientStartSiteFailoverTestResponse contains the response from method ExpressRouteGatewaysClient.BeginStartSiteFailoverTest.
type ExpressRouteGatewaysClientStartSiteFailoverTestResponse struct {
	Value *string
}

// ExpressRouteGatewaysClientStopSiteFailoverTestResponse contains the response from method ExpressRouteGatewaysClient.BeginStopSiteFailoverTest.
type ExpressRouteGatewaysClientStopSiteFailoverTestResponse struct {
	Value *string
}
...
// InterconnectGroupsClientCreateOrUpdateResponse contains the response from method InterconnectGroupsClient.CreateOrUpdate.
type InterconnectGroupsClientCreateOrUpdateResponse struct {
// An interconnect group resource.
	InterconnectGroup
}

// InterconnectGroupsClientDeleteResponse contains the response from method InterconnectGroupsClient.Delete.
type InterconnectGroupsClientDeleteResponse struct {
	// placeholder for future response values
}

// InterconnectGroupsClientGetNodeAvailabilityResponse contains the response from method InterconnectGroupsClient.BeginGetNodeAvailability.
type InterconnectGroupsClientGetNodeAvailabilityResponse struct {
// Represents node availability information for subgroups within an interconnect group.
	InterconnectGroupNodeAvailability
}

// InterconnectGroupsClientGetResponse contains the response from method InterconnectGroupsClient.Get.
type InterconnectGroupsClientGetResponse struct {
// An interconnect group resource.
	InterconnectGroup
}

// InterconnectGroupsClientListAllResponse contains the response from method InterconnectGroupsClient.NewListAllPager.
type InterconnectGroupsClientListAllResponse struct {
// The response of a InterconnectGroup list operation.
	InterconnectGroupListResult
}

// InterconnectGroupsClientListResponse contains the response from method InterconnectGroupsClient.NewListPager.
type InterconnectGroupsClientListResponse struct {
// The response of a InterconnectGroup list operation.
	InterconnectGroupListResult
}

// InterconnectGroupsClientUpdateTagsResponse contains the response from method InterconnectGroupsClient.UpdateTags.
type InterconnectGroupsClientUpdateTagsResponse struct {
// An interconnect group resource.
	InterconnectGroup
}
...
// Paged collection of FrontendIPConfiguration items
...
// SubgroupsClientGetResponse contains the response from method SubgroupsClient.Get.
type SubgroupsClientGetResponse struct {
// A subgroup in an interconnect group.
	Subgroup
}

// SubgroupsClientListResponse contains the response from method SubgroupsClient.NewListPager.
type SubgroupsClientListResponse struct {
