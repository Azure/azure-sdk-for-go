...
func (client *RouteTablesClient) getHandleResponse(resp *http.Response, successCodes ...int) (RouteTablesClientGetResponse, error) {
...
func (client *RouteTablesClient) listCreateRequest(ctx context.Context, resourceGroupName string, nextLink string, _ *RouteTablesClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *RouteTablesClient) listHandleResponse(resp *http.Response, successCodes ...int) (RouteTablesClientListResponse, error) {
...
func (client *RouteTablesClient) listAllCreateRequest(ctx context.Context, nextLink string, _ *RouteTablesClientListAllOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
	var req *policy.Request
	var err error
	if firstPage {
...
func (client *RouteTablesClient) listAllHandleResponse(resp *http.Response, successCodes ...int) (RouteTablesClientListAllResponse, error) {
...
func (client *RouteTablesClient) updateTagsHandleResponse(resp *http.Response, successCodes ...int) (RouteTablesClientUpdateTagsResponse, error) {
