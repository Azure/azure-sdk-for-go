...
func (client *SecurityAdminConfigurationsClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, networkManagerName string, configurationName string, securityAdminConfiguration SecurityAdminConfiguration, _ *SecurityAdminConfigurationsClientCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *SecurityAdminConfigurationsClient) createOrUpdateHandleResponse(resp *http.Response, successCodes ...int) (SecurityAdminConfigurationsClientCreateOrUpdateResponse, error) {
...
func (client *SecurityAdminConfigurationsClient) getCreateRequest(ctx context.Context, resourceGroupName string, networkManagerName string, configurationName string, _ *SecurityAdminConfigurationsClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkManagers/{networkManagerName}/securityAdminConfigurations/{configurationName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter subscriptionID cannot be empty")
	}
...
func (client *SecurityAdminConfigurationsClient) getHandleResponse(resp *http.Response, successCodes ...int) (SecurityAdminConfigurationsClientGetResponse, error) {
...
func (client *SecurityAdminConfigurationsClient) listCreateRequest(ctx context.Context, resourceGroupName string, networkManagerName string, nextLink string, options *SecurityAdminConfigurationsClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *SecurityAdminConfigurationsClient) listHandleResponse(resp *http.Response, successCodes ...int) (SecurityAdminConfigurationsClientListResponse, error) {
