...
// Generated from example definition: 2025-07-01/NetworkManagerConnectionSubscriptionPut.json
func ExampleSubscriptionNetworkManagerConnectionsClient_CreateOrUpdate() {
	...
	// res = armnetwork.SubscriptionNetworkManagerConnectionsClientCreateOrUpdateResponse{
...
// Generated from example definition: 2025-07-01/NetworkManagerConnectionSubscriptionDelete.json
func ExampleSubscriptionNetworkManagerConnectionsClient_Delete() {
	...
	res, err := clientFactory.NewSubscriptionNetworkManagerConnectionsClient().Delete(ctx, "TestNMConnection", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armnetwork.SubscriptionNetworkManagerConnectionsClientDeleteResponse{
	// }
}

// Generated from example definition: 2025-07-01/NetworkManagerConnectionSubscriptionGet.json
func ExampleSubscriptionNetworkManagerConnectionsClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armnetwork.SubscriptionNetworkManagerConnectionsClientGetResponse{
	// 	ManagerConnection: armnetwork.ManagerConnection{
	// 		Name: to.Ptr("TestNMConnection"),
	// 		Type: to.Ptr("Microsoft.Network/networkManagerConnections"),
	// 		ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/providers/Microsoft.Network/networkManagerConnections/TestNMConnection"),
