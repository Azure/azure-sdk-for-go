...
//   - singletonResource - The name of the singleton resource.
...
func (client *VipSwapClient) BeginCreate(ctx context.Context, groupName string, resourceName string, singletonResource SingletonResource, parameters SwapResource, options *VipSwapClientBeginCreateOptions) (*runtime.Poller[VipSwapClientCreateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.create(ctx, groupName, resourceName, singletonResource, parameters, options)
		if err != nil {
			return nil, err
		}
...
//
// Generated from API version 2025-05-01
func (client *VipSwapClient) create(ctx context.Context, groupName string, resourceName string, singletonResource SingletonResource, parameters SwapResource, options *VipSwapClientBeginCreateOptions) (*http.Response, error) {
	var err error
	const operationName = "VipSwapClient.BeginCreate"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.createCreateRequest(ctx, groupName, resourceName, singletonResource, parameters, options)
	if err != nil {
		return nil, err
	}
...
func (client *VipSwapClient) createCreateRequest(ctx context.Context, groupName string, resourceName string, singletonResource SingletonResource, parameters SwapResource, _ *VipSwapClientBeginCreateOptions) (*policy.Request, error) {
	...
	if singletonResource == "" {
		return nil, errors.New("parameter singletonResource cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{singletonResource}", url.PathEscape(string(singletonResource)))
...
func (client *VipSwapClient) Get(ctx context.Context, groupName string, resourceName string, singletonResource SingletonResource, options *VipSwapClientGetOptions) (VipSwapClientGetResponse, error) {
	var err error
	const operationName = "VipSwapClient.Get"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.getCreateRequest(ctx, groupName, resourceName, singletonResource, options)
	if err != nil {
...
func (client *VipSwapClient) getCreateRequest(ctx context.Context, groupName string, resourceName string, singletonResource SingletonResource, _ *VipSwapClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{groupName}/providers/microsoft.Compute/cloudServices/{resourceName}/providers/Microsoft.Network/cloudServiceSlots/{singletonResource}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
// NewListPager - Gets the list of SwapResource which identifies the slot type for the specified cloud service. The slot type
// on a cloud service can either be Staging or Production
//
// Generated from API version 2025-05-01
//   - resourceName - The name of the cloud service.
//   - options - VipSwapClientListOptions contains the optional parameters for the VipSwapClient.NewListPager method.
func (client *VipSwapClient) NewListPager(groupName string, resourceName string, options *VipSwapClientListOptions) *runtime.Pager[VipSwapClientListResponse] {
	return runtime.NewPager(runtime.PagingHandler[VipSwapClientListResponse]{
		More: func(page VipSwapClientListResponse) bool {
			return false
		},
		Fetcher: func(ctx context.Context, page *VipSwapClientListResponse) (VipSwapClientListResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "VipSwapClient.NewListPager")
