...
// Generated from example definition: 2025-09-01/VirtualHubRouteTableV2Put.json
func ExampleVirtualHubRouteTableV2SClient_BeginCreateOrUpdate() {
	...
	// res = armnetwork.VirtualHubRouteTableV2SClientCreateOrUpdateResponse{
...
// Generated from example definition: 2025-09-01/VirtualHubRouteTableV2Delete.json
...
// Generated from example definition: 2025-09-01/VirtualHubRouteTableV2Get.json
...
// Generated from example definition: 2025-09-01/VirtualHubRouteTableV2List.json
func ExampleVirtualHubRouteTableV2SClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armnetwork.VirtualHubRouteTableV2SClientListResponse{
		// 	ListVirtualHubRouteTableV2SResult: armnetwork.ListVirtualHubRouteTableV2SResult{
		// 		Value: []*armnetwork.VirtualHubRouteTableV2{
		// 			{
		// 				Name: to.Ptr("virtualHubRouteTable1a"),
		// 				Etag: to.Ptr("w/\\00000000-0000-0000-0000-000000000000\\"),
		// 				ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.Network/virtualHubs/virtualHub1/routeTables/virtualHubRouteTable1a"),
		...
		// 			},
		// 			{
		// 				Name: to.Ptr("virtualHubRouteTable1b"),
		// 				Etag: to.Ptr("w/\\00000000-0000-0000-0000-000000000000\\"),
		// 				ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.Network/virtualHubs/virtualHub1/routeTables/virtualHubRouteTable1b"),
		// 				Properties: &armnetwork.VirtualHubRouteTableV2Properties{
		// 					AttachedConnections: []*string{
		// 						to.Ptr("All_Branches"),
		// 					},
