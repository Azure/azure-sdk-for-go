...
func (client *VirtualHubsClient) getHandleResponse(resp *http.Response, successCodes ...int) (VirtualHubsClientGetResponse, error) {
...
func (client *VirtualHubsClient) listByResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, nextLink string, _ *VirtualHubsClientListByResourceGroupOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
	var req *policy.Request
	var err error
	if firstPage {
...
func (client *VirtualHubsClient) listByResourceGroupHandleResponse(resp *http.Response, successCodes ...int) (VirtualHubsClientListByResourceGroupResponse, error) {
...
func (client *VirtualHubsClient) updateTagsHandleResponse(resp *http.Response, successCodes ...int) (VirtualHubsClientUpdateTagsResponse, error) {
