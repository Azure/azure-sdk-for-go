...
//     method.
func (client *VirtualHubsClient) BeginGetEffectiveVirtualHubRoutes(ctx context.Context, resourceGroupName string, virtualHubName string, options *VirtualHubsClientBeginGetEffectiveVirtualHubRoutesOptions) (*runtime.Poller[*runtime.Pager[VirtualHubsClientGetEffectiveVirtualHubRoutesResponse]], error) {
	pager := runtime.NewPager(runtime.PagingHandler[VirtualHubsClientGetEffectiveVirtualHubRoutesResponse]{
		More: func(page VirtualHubsClientGetEffectiveVirtualHubRoutesResponse) bool {
			return false
		},
		Fetcher: func(ctx context.Context, page *VirtualHubsClientGetEffectiveVirtualHubRoutesResponse) (VirtualHubsClientGetEffectiveVirtualHubRoutesResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "VirtualHubsClient.BeginGetEffectiveVirtualHubRoutes")
			...
			if !runtime.HasStatusCode(resp, http.StatusOK) {
				return VirtualHubsClientGetEffectiveVirtualHubRoutesResponse{}, runtime.NewResponseError(resp)
			}
			return client.getEffectiveVirtualHubRoutesHandleResponse(resp)
		},
		Tracer: client.internal.Tracer(),
	})
	if options == nil || options.ResumeToken == "" {
		...
		poller, err := runtime.NewPoller(resp, client.internal.Pipeline(), &runtime.NewPollerOptions[*runtime.Pager[VirtualHubsClientGetEffectiveVirtualHubRoutesResponse]]{
			Response: &pager,
			Tracer:   client.internal.Tracer(),
		})
		return poller, err
	} else {
		return runtime.NewPollerFromResumeToken(options.ResumeToken, client.internal.Pipeline(), &runtime.NewPollerFromResumeTokenOptions[*runtime.Pager[VirtualHubsClientGetEffectiveVirtualHubRoutesResponse]]{
			Response: &pager,
			Tracer:   client.internal.Tracer(),
		})
	}
...
// getEffectiveVirtualHubRoutesHandleResponse handles the GetEffectiveVirtualHubRoutes response.
func (client *VirtualHubsClient) getEffectiveVirtualHubRoutesHandleResponse(resp *http.Response) (VirtualHubsClientGetEffectiveVirtualHubRoutesResponse, error) {
	result := VirtualHubsClientGetEffectiveVirtualHubRoutesResponse{}
	if err := runtime.UnmarshalAsJSON(resp, &result.VirtualHubEffectiveRouteList); err != nil {
		return VirtualHubsClientGetEffectiveVirtualHubRoutesResponse{}, err
	}
	return result, nil
}
...
//     method.
func (client *VirtualHubsClient) BeginGetInboundRoutes(ctx context.Context, resourceGroupName string, virtualHubName string, getInboundRoutesParameters GetInboundRoutesParameters, options *VirtualHubsClientBeginGetInboundRoutesOptions) (*runtime.Poller[*runtime.Pager[VirtualHubsClientGetInboundRoutesResponse]], error) {
	pager := runtime.NewPager(runtime.PagingHandler[VirtualHubsClientGetInboundRoutesResponse]{
		More: func(page VirtualHubsClientGetInboundRoutesResponse) bool {
			return false
		},
		Fetcher: func(ctx context.Context, page *VirtualHubsClientGetInboundRoutesResponse) (VirtualHubsClientGetInboundRoutesResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "VirtualHubsClient.BeginGetInboundRoutes")
			req, err := client.getInboundRoutesCreateRequest(ctx, resourceGroupName, virtualHubName, getInboundRoutesParameters, options)
			if err != nil {
				return VirtualHubsClientGetInboundRoutesResponse{}, err
			}
			resp, err := client.internal.Pipeline().Do(req)
			if err != nil {
				return VirtualHubsClientGetInboundRoutesResponse{}, err
			...
			if !runtime.HasStatusCode(resp, http.StatusOK) {
				return VirtualHubsClientGetInboundRoutesResponse{}, runtime.NewResponseError(resp)
			}
			return client.getInboundRoutesHandleResponse(resp)
		},
		Tracer: client.internal.Tracer(),
	})
	if options == nil || options.ResumeToken == "" {
		...
		poller, err := runtime.NewPoller(resp, client.internal.Pipeline(), &runtime.NewPollerOptions[*runtime.Pager[VirtualHubsClientGetInboundRoutesResponse]]{
			Response: &pager,
			Tracer:   client.internal.Tracer(),
		})
		return poller, err
	} else {
		return runtime.NewPollerFromResumeToken(options.ResumeToken, client.internal.Pipeline(), &runtime.NewPollerFromResumeTokenOptions[*runtime.Pager[VirtualHubsClientGetInboundRoutesResponse]]{
			Response: &pager,
			Tracer:   client.internal.Tracer(),
		})
	}
...
// getInboundRoutesHandleResponse handles the GetInboundRoutes response.
func (client *VirtualHubsClient) getInboundRoutesHandleResponse(resp *http.Response) (VirtualHubsClientGetInboundRoutesResponse, error) {
	result := VirtualHubsClientGetInboundRoutesResponse{}
	if err := runtime.UnmarshalAsJSON(resp, &result.EffectiveRouteMapRouteList); err != nil {
		return VirtualHubsClientGetInboundRoutesResponse{}, err
	}
	return result, nil
}
...
//     method.
func (client *VirtualHubsClient) BeginGetOutboundRoutes(ctx context.Context, resourceGroupName string, virtualHubName string, getOutboundRoutesParameters GetOutboundRoutesParameters, options *VirtualHubsClientBeginGetOutboundRoutesOptions) (*runtime.Poller[*runtime.Pager[VirtualHubsClientGetOutboundRoutesResponse]], error) {
	pager := runtime.NewPager(runtime.PagingHandler[VirtualHubsClientGetOutboundRoutesResponse]{
		More: func(page VirtualHubsClientGetOutboundRoutesResponse) bool {
			return false
		},
		Fetcher: func(ctx context.Context, page *VirtualHubsClientGetOutboundRoutesResponse) (VirtualHubsClientGetOutboundRoutesResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "VirtualHubsClient.BeginGetOutboundRoutes")
			req, err := client.getOutboundRoutesCreateRequest(ctx, resourceGroupName, virtualHubName, getOutboundRoutesParameters, options)
			if err != nil {
				return VirtualHubsClientGetOutboundRoutesResponse{}, err
			}
			resp, err := client.internal.Pipeline().Do(req)
			if err != nil {
				return VirtualHubsClientGetOutboundRoutesResponse{}, err
			...
			if !runtime.HasStatusCode(resp, http.StatusOK) {
				return VirtualHubsClientGetOutboundRoutesResponse{}, runtime.NewResponseError(resp)
			}
			return client.getOutboundRoutesHandleResponse(resp)
		},
		Tracer: client.internal.Tracer(),
	})
	if options == nil || options.ResumeToken == "" {
		...
		poller, err := runtime.NewPoller(resp, client.internal.Pipeline(), &runtime.NewPollerOptions[*runtime.Pager[VirtualHubsClientGetOutboundRoutesResponse]]{
			Response: &pager,
			Tracer:   client.internal.Tracer(),
		})
		return poller, err
	} else {
		return runtime.NewPollerFromResumeToken(options.ResumeToken, client.internal.Pipeline(), &runtime.NewPollerFromResumeTokenOptions[*runtime.Pager[VirtualHubsClientGetOutboundRoutesResponse]]{
			Response: &pager,
			Tracer:   client.internal.Tracer(),
		})
	}
...
// getOutboundRoutesHandleResponse handles the GetOutboundRoutes response.
func (client *VirtualHubsClient) getOutboundRoutesHandleResponse(resp *http.Response) (VirtualHubsClientGetOutboundRoutesResponse, error) {
	result := VirtualHubsClientGetOutboundRoutesResponse{}
	if err := runtime.UnmarshalAsJSON(resp, &result.EffectiveRouteMapRouteList); err != nil {
		return VirtualHubsClientGetOutboundRoutesResponse{}, err
	}
	return result, nil
