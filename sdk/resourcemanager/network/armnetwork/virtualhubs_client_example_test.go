...
func ExampleVirtualHubsClient_BeginCreateOrUpdate() {
	...
	// res = armnetwork.VirtualHubsClientCreateOrUpdateResponse{
...
func ExampleVirtualHubsClient_BeginDelete() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armnetwork.VirtualHubsClientDeleteResponse{
	// }
}
...
func ExampleVirtualHubsClient_BeginGetEffectiveVirtualHubRoutes_effectiveRoutesForARouteTableResource() {
	...
	poller, err := clientFactory.NewVirtualHubsClient().BeginGetEffectiveVirtualHubRoutes(ctx, "rg1", "virtualHub1", &armnetwork.VirtualHubsClientBeginGetEffectiveVirtualHubRoutesOptions{
		EffectiveRoutesParameters: &armnetwork.EffectiveRoutesParameters{
			ResourceID:             to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.Network/virtualHubs/virtualHub1/hubRouteTables/hubRouteTable1"),
...
func ExampleVirtualHubsClient_BeginGetEffectiveVirtualHubRoutes_effectiveRoutesForTheVirtualHub() {
	...
	poller, err := clientFactory.NewVirtualHubsClient().BeginGetEffectiveVirtualHubRoutes(ctx, "rg1", "virtualHub1", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	res, err := poller.PollUntilDone(ctx, nil)
...
func ExampleVirtualHubsClient_BeginGetInboundRoutes() {
	...
	poller, err := clientFactory.NewVirtualHubsClient().BeginGetInboundRoutes(ctx, "rg1", "virtualHub1", armnetwork.GetInboundRoutesParameters{
		...
		ResourceURI:    to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.Network/expressRouteGateways/exrGw1/expressRouteConnections/exrConn1"),
	}, nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armnetwork.VirtualHubsClientGetInboundRoutesResponse{
	// 	EffectiveRouteMapRouteList: armnetwork.EffectiveRouteMapRouteList{
...
func ExampleVirtualHubsClient_BeginGetOutboundRoutes() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armnetwork.VirtualHubsClientGetOutboundRoutesResponse{
	// 	EffectiveRouteMapRouteList: armnetwork.EffectiveRouteMapRouteList{
	// 		Value: []*armnetwork.EffectiveRouteMapRoute{
	// 			{
	// 				AsPath: to.Ptr("65520-65520"),
...
func ExampleVirtualHubsClient_NewListByResourceGroupPager() {
	...
	for pager.More() {
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armnetwork.VirtualHubsClientListByResourceGroupResponse{
		// 	ListVirtualHubsResult: armnetwork.ListVirtualHubsResult{
		// 		Value: []*armnetwork.VirtualHub{
		// 			{
		// 				Name: to.Ptr("virtualHub1"),
...
func ExampleVirtualHubsClient_UpdateTags() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armnetwork.VirtualHubsClientUpdateTagsResponse{
	// 	VirtualHub: armnetwork.VirtualHub{
	// 		Name: to.Ptr("virtualHub2"),
	// 		Type: to.Ptr("Microsoft.Network/virtualHubs"),
	// 		Etag: to.Ptr("w/\\00000000-0000-0000-0000-000000000000\\"),
