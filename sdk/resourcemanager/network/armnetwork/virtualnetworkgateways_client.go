...
//     method.
func (client *VirtualNetworkGatewaysClient) BeginGetAdvertisedRoutes(ctx context.Context, resourceGroupName string, virtualNetworkGatewayName string, peer string, options *VirtualNetworkGatewaysClientBeginGetAdvertisedRoutesOptions) (*runtime.Poller[*runtime.Pager[VirtualNetworkGatewaysClientGetAdvertisedRoutesResponse]], error) {
	pager := runtime.NewPager(runtime.PagingHandler[VirtualNetworkGatewaysClientGetAdvertisedRoutesResponse]{
		More: func(page VirtualNetworkGatewaysClientGetAdvertisedRoutesResponse) bool {
			return false
		},
		Fetcher: func(ctx context.Context, page *VirtualNetworkGatewaysClientGetAdvertisedRoutesResponse) (VirtualNetworkGatewaysClientGetAdvertisedRoutesResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "VirtualNetworkGatewaysClient.BeginGetAdvertisedRoutes")
			...
			if !runtime.HasStatusCode(resp, http.StatusOK) {
				return VirtualNetworkGatewaysClientGetAdvertisedRoutesResponse{}, runtime.NewResponseError(resp)
			}
			return client.getAdvertisedRoutesHandleResponse(resp)
		},
		Tracer: client.internal.Tracer(),
	})
	if options == nil || options.ResumeToken == "" {
		...
		poller, err := runtime.NewPoller(resp, client.internal.Pipeline(), &runtime.NewPollerOptions[*runtime.Pager[VirtualNetworkGatewaysClientGetAdvertisedRoutesResponse]]{
			Response: &pager,
			Tracer:   client.internal.Tracer(),
		})
		return poller, err
	} else {
		return runtime.NewPollerFromResumeToken(options.ResumeToken, client.internal.Pipeline(), &runtime.NewPollerFromResumeTokenOptions[*runtime.Pager[VirtualNetworkGatewaysClientGetAdvertisedRoutesResponse]]{
			Response: &pager,
			Tracer:   client.internal.Tracer(),
		})
	}
...
func (client *VirtualNetworkGatewaysClient) getAdvertisedRoutesHandleResponse(resp *http.Response) (VirtualNetworkGatewaysClientGetAdvertisedRoutesResponse, error) {
	result := VirtualNetworkGatewaysClientGetAdvertisedRoutesResponse{}
	if err := runtime.UnmarshalAsJSON(resp, &result.GatewayRouteListResult); err != nil {
		return VirtualNetworkGatewaysClientGetAdvertisedRoutesResponse{}, err
	}
	return result, nil
}
...
//     method.
func (client *VirtualNetworkGatewaysClient) BeginGetBgpPeerStatus(ctx context.Context, resourceGroupName string, virtualNetworkGatewayName string, options *VirtualNetworkGatewaysClientBeginGetBgpPeerStatusOptions) (*runtime.Poller[*runtime.Pager[VirtualNetworkGatewaysClientGetBgpPeerStatusResponse]], error) {
	pager := runtime.NewPager(runtime.PagingHandler[VirtualNetworkGatewaysClientGetBgpPeerStatusResponse]{
		More: func(page VirtualNetworkGatewaysClientGetBgpPeerStatusResponse) bool {
			return false
		},
		Fetcher: func(ctx context.Context, page *VirtualNetworkGatewaysClientGetBgpPeerStatusResponse) (VirtualNetworkGatewaysClientGetBgpPeerStatusResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "VirtualNetworkGatewaysClient.BeginGetBgpPeerStatus")
			...
			if !runtime.HasStatusCode(resp, http.StatusOK) {
				return VirtualNetworkGatewaysClientGetBgpPeerStatusResponse{}, runtime.NewResponseError(resp)
			}
			return client.getBgpPeerStatusHandleResponse(resp)
		},
		Tracer: client.internal.Tracer(),
	})
	if options == nil || options.ResumeToken == "" {
		...
		poller, err := runtime.NewPoller(resp, client.internal.Pipeline(), &runtime.NewPollerOptions[*runtime.Pager[VirtualNetworkGatewaysClientGetBgpPeerStatusResponse]]{
			Response: &pager,
			Tracer:   client.internal.Tracer(),
		})
		return poller, err
	} else {
		return runtime.NewPollerFromResumeToken(options.ResumeToken, client.internal.Pipeline(), &runtime.NewPollerFromResumeTokenOptions[*runtime.Pager[VirtualNetworkGatewaysClientGetBgpPeerStatusResponse]]{
			Response: &pager,
			Tracer:   client.internal.Tracer(),
		})
	}
...
func (client *VirtualNetworkGatewaysClient) getBgpPeerStatusHandleResponse(resp *http.Response) (VirtualNetworkGatewaysClientGetBgpPeerStatusResponse, error) {
	result := VirtualNetworkGatewaysClientGetBgpPeerStatusResponse{}
	if err := runtime.UnmarshalAsJSON(resp, &result.BgpPeerStatusListResult); err != nil {
		return VirtualNetworkGatewaysClientGetBgpPeerStatusResponse{}, err
	}
	return result, nil
}
...
//     method.
func (client *VirtualNetworkGatewaysClient) BeginGetLearnedRoutes(ctx context.Context, resourceGroupName string, virtualNetworkGatewayName string, options *VirtualNetworkGatewaysClientBeginGetLearnedRoutesOptions) (*runtime.Poller[*runtime.Pager[VirtualNetworkGatewaysClientGetLearnedRoutesResponse]], error) {
	pager := runtime.NewPager(runtime.PagingHandler[VirtualNetworkGatewaysClientGetLearnedRoutesResponse]{
		More: func(page VirtualNetworkGatewaysClientGetLearnedRoutesResponse) bool {
			return false
		},
		Fetcher: func(ctx context.Context, page *VirtualNetworkGatewaysClientGetLearnedRoutesResponse) (VirtualNetworkGatewaysClientGetLearnedRoutesResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "VirtualNetworkGatewaysClient.BeginGetLearnedRoutes")
			...
			if !runtime.HasStatusCode(resp, http.StatusOK) {
				return VirtualNetworkGatewaysClientGetLearnedRoutesResponse{}, runtime.NewResponseError(resp)
			}
			return client.getLearnedRoutesHandleResponse(resp)
		},
		Tracer: client.internal.Tracer(),
	})
	if options == nil || options.ResumeToken == "" {
		...
		poller, err := runtime.NewPoller(resp, client.internal.Pipeline(), &runtime.NewPollerOptions[*runtime.Pager[VirtualNetworkGatewaysClientGetLearnedRoutesResponse]]{
			Response: &pager,
			Tracer:   client.internal.Tracer(),
		})
		return poller, err
	} else {
		return runtime.NewPollerFromResumeToken(options.ResumeToken, client.internal.Pipeline(), &runtime.NewPollerFromResumeTokenOptions[*runtime.Pager[VirtualNetworkGatewaysClientGetLearnedRoutesResponse]]{
			Response: &pager,
			Tracer:   client.internal.Tracer(),
		})
	}
...
func (client *VirtualNetworkGatewaysClient) getLearnedRoutesHandleResponse(resp *http.Response) (VirtualNetworkGatewaysClientGetLearnedRoutesResponse, error) {
...
func (client *VirtualNetworkGatewaysClient) BeginGetVpnclientConnectionHealth(ctx context.Context, resourceGroupName string, virtualNetworkGatewayName string, options *VirtualNetworkGatewaysClientBeginGetVpnclientConnectionHealthOptions) (*runtime.Poller[*runtime.Pager[VirtualNetworkGatewaysClientGetVpnclientConnectionHealthResponse]], error) {
	pager := runtime.NewPager(runtime.PagingHandler[VirtualNetworkGatewaysClientGetVpnclientConnectionHealthResponse]{
		More: func(page VirtualNetworkGatewaysClientGetVpnclientConnectionHealthResponse) bool {
			return false
		},
		Fetcher: func(ctx context.Context, page *VirtualNetworkGatewaysClientGetVpnclientConnectionHealthResponse) (VirtualNetworkGatewaysClientGetVpnclientConnectionHealthResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "VirtualNetworkGatewaysClient.BeginGetVpnclientConnectionHealth")
			...
			if !runtime.HasStatusCode(resp, http.StatusOK) {
				return VirtualNetworkGatewaysClientGetVpnclientConnectionHealthResponse{}, runtime.NewResponseError(resp)
			}
			return client.getVpnclientConnectionHealthHandleResponse(resp)
		},
		Tracer: client.internal.Tracer(),
	})
	if options == nil || options.ResumeToken == "" {
		...
		poller, err := runtime.NewPoller(resp, client.internal.Pipeline(), &runtime.NewPollerOptions[*runtime.Pager[VirtualNetworkGatewaysClientGetVpnclientConnectionHealthResponse]]{
			Response: &pager,
			Tracer:   client.internal.Tracer(),
		})
		return poller, err
	} else {
		return runtime.NewPollerFromResumeToken(options.ResumeToken, client.internal.Pipeline(), &runtime.NewPollerFromResumeTokenOptions[*runtime.Pager[VirtualNetworkGatewaysClientGetVpnclientConnectionHealthResponse]]{
			Response: &pager,
			Tracer:   client.internal.Tracer(),
		})
	}
...
func (client *VirtualNetworkGatewaysClient) getVpnclientConnectionHealthHandleResponse(resp *http.Response) (VirtualNetworkGatewaysClientGetVpnclientConnectionHealthResponse, error) {
	result := VirtualNetworkGatewaysClientGetVpnclientConnectionHealthResponse{}
	if err := runtime.UnmarshalAsJSON(resp, &result.VPNClientConnectionHealthDetailListResult); err != nil {
		return VirtualNetworkGatewaysClientGetVpnclientConnectionHealthResponse{}, err
	}
	return result, nil
}
