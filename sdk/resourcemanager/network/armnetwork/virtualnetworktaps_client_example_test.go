...
// Generated from example definition: 2026-01-01/VirtualNetworkTapCreate.json
func ExampleVirtualNetworkTapsClient_BeginCreateOrUpdate() {
	...
	poller, err := clientFactory.NewVirtualNetworkTapsClient().BeginCreateOrUpdate(ctx, "rg1", "test-vtap", armnetwork.VirtualNetworkTap{
		...
		Properties: &armnetwork.VirtualNetworkTapPropertiesFormat{
			DestinationNetworkInterfaceIPConfiguration: &armnetwork.InterfaceIPConfiguration{
				ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.Network/networkInterfaces/testNetworkInterface/ipConfigurations/ipconfig1"),
			},
		},
	}, nil)
	if err != nil {
	...
	// res = armnetwork.VirtualNetworkTapsClientCreateOrUpdateResponse{
...
// Generated from example definition: 2026-01-01/VirtualNetworkTapDelete.json
func ExampleVirtualNetworkTapsClient_BeginDelete() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armnetwork.VirtualNetworkTapsClientDeleteResponse{
	// }
}

// Generated from example definition: 2026-01-01/VirtualNetworkTapGet.json
...
// Generated from example definition: 2026-01-01/VirtualNetworkTapListAll.json
func ExampleVirtualNetworkTapsClient_NewListAllPager() {
	...
	for pager.More() {
		...
		// page = armnetwork.VirtualNetworkTapsClientListAllResponse{
		// 	VirtualNetworkTapListResult: armnetwork.VirtualNetworkTapListResult{
		...
		// 				Type: to.Ptr("Microsoft.Network/virtualNetworkTaps"),
		// 				Etag: to.Ptr("etag"),
		// 				ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.Network/virtualNetworkTaps/testvtap2"),
		// 				Location: to.Ptr("centraluseuap"),
		// 				Properties: &armnetwork.VirtualNetworkTapPropertiesFormat{
		// 					DestinationNetworkInterfaceIPConfiguration: &armnetwork.InterfaceIPConfiguration{
		// 						ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.Network/networkInterfaces/testNetworkInterface/ipConfigurations/testIPConfig1"),
		...
		// 					NetworkInterfaceTapConfigurations: []*armnetwork.InterfaceTapConfiguration{
		// 						{
		// 							ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.Network/networkInterfaces/testNetworkInterface3/tapConfigurations/testtapConfiguration"),
		// 						},
		// 					},
		// 					ProvisioningState: to.Ptr(armnetwork.ProvisioningState("Succeded")),
		// 					ResourceGUID: to.Ptr("6A7C139D-8B8D-499B-B7CB-4F3F02A8A44F"),
...
// Generated from example definition: 2026-01-01/VirtualNetworkTapList.json
func ExampleVirtualNetworkTapsClient_NewListByResourceGroupPager() {
	...
	for pager.More() {
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armnetwork.VirtualNetworkTapsClientListByResourceGroupResponse{
		// 	VirtualNetworkTapListResult: armnetwork.VirtualNetworkTapListResult{
		// 		Value: []*armnetwork.VirtualNetworkTap{
		// 			{
		// 				Name: to.Ptr("testvtap"),
...
// Generated from example definition: 2026-01-01/VirtualNetworkTapUpdateTags.json
func ExampleVirtualNetworkTapsClient_UpdateTags() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armnetwork.VirtualNetworkTapsClientUpdateTagsResponse{
	// 	VirtualNetworkTap: armnetwork.VirtualNetworkTap{
	// 		Name: to.Ptr("test-vtap"),
	// 		Type: to.Ptr("Microsoft.Network/virtualNetworkTaps"),
	// 		ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.Network/virtualNetworkTaps/test-vtap"),
