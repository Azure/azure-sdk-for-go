...
//   - options - VirtualWansClientBeginGeneratevirtualwanvpnserverconfigurationvpnprofileOptions contains the optional parameters
//     for the VirtualWansClient.BeginGeneratevirtualwanvpnserverconfigurationvpnprofile method.
func (client *VirtualWansClient) BeginGeneratevirtualwanvpnserverconfigurationvpnprofile(ctx context.Context, resourceGroupName string, virtualWANName string, vpnClientParams VirtualWanVPNProfileParameters, options *VirtualWansClientBeginGeneratevirtualwanvpnserverconfigurationvpnprofileOptions) (*runtime.Poller[VirtualWansClientGeneratevirtualwanvpnserverconfigurationvpnprofileResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		poller, err := runtime.NewPoller(resp, client.internal.Pipeline(), &runtime.NewPollerOptions[VirtualWansClientGeneratevirtualwanvpnserverconfigurationvpnprofileResponse]{
			Tracer: client.internal.Tracer(),
		})
		return poller, err
	} else {
		return runtime.NewPollerFromResumeToken(options.ResumeToken, client.internal.Pipeline(), &runtime.NewPollerFromResumeTokenOptions[VirtualWansClientGeneratevirtualwanvpnserverconfigurationvpnprofileResponse]{
			Tracer: client.internal.Tracer(),
		})
	}
}
...
//
// Generated from API version 2025-05-01
func (client *VirtualWansClient) generatevirtualwanvpnserverconfigurationvpnprofile(ctx context.Context, resourceGroupName string, virtualWANName string, vpnClientParams VirtualWanVPNProfileParameters, options *VirtualWansClientBeginGeneratevirtualwanvpnserverconfigurationvpnprofileOptions) (*http.Response, error) {
	var err error
	const operationName = "VirtualWansClient.BeginGeneratevirtualwanvpnserverconfigurationvpnprofile"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
...
func (client *VirtualWansClient) generatevirtualwanvpnserverconfigurationvpnprofileCreateRequest(ctx context.Context, resourceGroupName string, virtualWANName string, vpnClientParams VirtualWanVPNProfileParameters, _ *VirtualWansClientBeginGeneratevirtualwanvpnserverconfigurationvpnprofileOptions) (*policy.Request, error) {
...
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - virtualWANName - The name of the VirtualWAN.
//   - options - VirtualWansClientSupportedSecurityProvidersOptions contains the optional parameters for the VirtualWansClient.SupportedSecurityProviders
//     method.
func (client *VirtualWansClient) SupportedSecurityProviders(ctx context.Context, resourceGroupName string, virtualWANName string, options *VirtualWansClientSupportedSecurityProvidersOptions) (VirtualWansClientSupportedSecurityProvidersResponse, error) {
	var err error
	const operationName = "VirtualWansClient.SupportedSecurityProviders"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.supportedSecurityProvidersCreateRequest(ctx, resourceGroupName, virtualWANName, options)
	if err != nil {
		return VirtualWansClientSupportedSecurityProvidersResponse{}, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
	if err != nil {
		return VirtualWansClientSupportedSecurityProvidersResponse{}, err
...
func (client *VirtualWansClient) supportedSecurityProvidersCreateRequest(ctx context.Context, resourceGroupName string, virtualWANName string, _ *VirtualWansClientSupportedSecurityProvidersOptions) (*policy.Request, error) {
...
func (client *VirtualWansClient) supportedSecurityProvidersHandleResponse(resp *http.Response) (VirtualWansClientSupportedSecurityProvidersResponse, error) {
	result := VirtualWansClientSupportedSecurityProvidersResponse{}
