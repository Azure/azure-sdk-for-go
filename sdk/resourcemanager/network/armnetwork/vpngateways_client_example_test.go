...
func ExampleVPNGatewaysClient_BeginCreateOrUpdate() {
	...
	// res = armnetwork.VPNGatewaysClientCreateOrUpdateResponse{
...
func ExampleVPNGatewaysClient_BeginDelete() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armnetwork.VPNGatewaysClientDeleteResponse{
	// }
}
...
func ExampleVPNGatewaysClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armnetwork.VPNGatewaysClientGetResponse{
	// 	VPNGateway: armnetwork.VPNGateway{
	// 		Name: to.Ptr("gateway1"),
	// 		Type: to.Ptr("Microsoft.Network/vpnGateways"),
	// 		Etag: to.Ptr("w/\\00000000-0000-0000-0000-000000000000\\"),
	...
	// 									EgressNatRules: []*armnetwork.SubResource{
	// 										{
	// 											ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.Network/vpnGateways/gateway1/natRules/nat04"),
	// 										},
	// 									},
	// 									EnableBgp: to.Ptr(false),
	// 									EnableRateLimiting: to.Ptr(false),
	...
	// 						EgressVPNSiteLinkConnections: []*armnetwork.SubResource{
	// 							{
	// 								ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.Network/vpnGateways/gateway1/vpnConnections/vpnConnection1/vpnLinkConnections/Connection-Link2"),
	// 							},
	// 						},
	// 						ExternalMappings: []*armnetwork.VPNNatRuleMapping{
	// 							{
...
func ExampleVPNGatewaysClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armnetwork.VPNGatewaysClientListResponse{
