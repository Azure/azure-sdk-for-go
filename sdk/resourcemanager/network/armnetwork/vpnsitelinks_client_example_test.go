...
// Generated from example definition: 2025-07-01/VpnSiteLinkGet.json
func ExampleVPNSiteLinksClient_Get() {
	...
	// res = armnetwork.VPNSiteLinksClientGetResponse{
	// 	VPNSiteLink: armnetwork.VPNSiteLink{
...
// Generated from example definition: 2025-07-01/VpnSiteLinkListByVpnSite.json
func ExampleVPNSiteLinksClient_NewListByVPNSitePager() {
	...
	for pager.More() {
		...
		// page = armnetwork.VPNSiteLinksClientListByVPNSiteResponse{
		// 	ListVPNSiteLinksResult: armnetwork.ListVPNSiteLinksResult{
		...
		// 				Type: to.Ptr("Microsoft.Network/vpnSites/vpnSiteLinks"),
		// 				Etag: to.Ptr("W/\"00000000-0000-0000-0000-000000000000\""),
		// 				ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg1/providers/Microsoft.Network/vpnSites/vpnSite1/vpnSiteLinks/vpnSiteLink2"),
		// 				Properties: &armnetwork.VPNSiteLinkProperties{
		// 					BgpProperties: &armnetwork.VPNLinkBgpSettings{
		// 						Asn: to.Ptr[int64](1234),
