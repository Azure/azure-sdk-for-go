...
func ExampleWatchersClient_BeginCheckConnectivity() {
	...
	poller, err := clientFactory.NewWatchersClient().BeginCheckConnectivity(ctx, "rg1", "nw1", armnetwork.ConnectivityParameters{
		...
		Source: &armnetwork.ConnectivitySource{
			ResourceID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg2/providers/Microsoft.Compute/virtualMachines/vm1"),
		},
	}, nil)
	if err != nil {
	...
	// res = armnetwork.WatchersClientCheckConnectivityResponse{
	// 	ConnectivityInformation: armnetwork.ConnectivityInformation{
...
func ExampleWatchersClient_BeginGetFlowLogStatus() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armnetwork.WatchersClientGetFlowLogStatusResponse{
...
func ExampleWatchersClient_BeginGetNetworkConfigurationDiagnostic() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armnetwork.WatchersClientGetNetworkConfigurationDiagnosticResponse{
	// 	ConfigurationDiagnosticResponse: armnetwork.ConfigurationDiagnosticResponse{
	...
	// 						{
	// 							AppliedTo: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg2/providers/Microsoft.Network/virtualNetworks/vnet/subnets/AppSubnet"),
	// 							MatchedRule: &armnetwork.MatchedRule{
	// 								Action: to.Ptr("Allow"),
	// 								RuleName: to.Ptr("UserRule_fe_rule"),
	// 							},
	// 							NetworkSecurityGroupID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg2/providers/Microsoft.Network/networkSecurityGroups/nsg1"),
	...
	// 						},
	// 						{
	// 							AppliedTo: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg2/providers/Microsoft.Network/virtualNetworks/vnet/networkInterfaces/nic"),
	// 							MatchedRule: &armnetwork.MatchedRule{
	// 								Action: to.Ptr("Allow"),
	// 								RuleName: to.Ptr("UserRule_fe_rule"),
	// 							},
...
func ExampleWatchersClient_BeginGetVMSecurityRules() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armnetwork.WatchersClientGetVMSecurityRulesResponse{
	// 	SecurityGroupViewResult: armnetwork.SecurityGroupViewResult{
	// 		NetworkInterfaces: []*armnetwork.SecurityGroupNetworkInterface{
	// 			{
	// 				ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg2/providers/Microsoft.Network/networkInterfaces/nic1"),
	...
	// 						ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg2/providers/Microsoft.Network/virtualNetworks/vnet1/subnets/subnet1"),
	// 						SecurityRules: []*armnetwork.SecurityRule{
	// 							{
	// 								Name: to.Ptr("fe_rule"),
	// 								Etag: to.Ptr("W/\"00000000-0000-0000-0000-000000000000\""),
	// 								ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg2/providers/Microsoft.Network/networkSecurityGroups/AppNSG/securityRules/fe_rule"),
	// 								Properties: &armnetwork.SecurityRulePropertiesFormat{
...
func ExampleWatchersClient_BeginListAvailableProviders() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armnetwork.WatchersClientListAvailableProvidersResponse{
	// 	AvailableProvidersList: armnetwork.AvailableProvidersList{
...
func ExampleWatchersClient_UpdateTags() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armnetwork.WatchersClientUpdateTagsResponse{
	// 	Watcher: armnetwork.Watcher{
	// 		Name: to.Ptr("nw1"),
	// 		Type: to.Ptr("Microsoft.Network/networkWatchers"),
	// 		Etag: to.Ptr("W/\"00000000-0000-0000-0000-000000000000\""),
