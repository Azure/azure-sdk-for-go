...
// Generated from example definition: 2025-07-01/AzureWebCategoryGet.json
func ExampleWebCategoriesClient_Get() {
	...
	clientFactory, err := armnetwork.NewClientFactory("4de8428a-4a92-4cea-90ff-b47128b8cab8", cred, nil)
	if err != nil {
		log.Fatalf("failed to create client: %v", err)
	}
	res, err := clientFactory.NewWebCategoriesClient().Get(ctx, "Arts", nil)
	if err != nil {
	...
	// res = armnetwork.WebCategoriesClientGetResponse{
	// 	AzureWebCategory: armnetwork.AzureWebCategory{
	// 		Name: to.Ptr("Arts"),
...
// Generated from example definition: 2025-07-01/AzureWebCategoriesListBySubscription.json
func ExampleWebCategoriesClient_NewListBySubscriptionPager() {
	...
	for pager.More() {
		...
		// page = armnetwork.WebCategoriesClientListBySubscriptionResponse{
