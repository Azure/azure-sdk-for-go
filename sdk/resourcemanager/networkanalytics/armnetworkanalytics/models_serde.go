...
func (a AccountSas) MarshalJSON() ([]byte, error) {
	...
	populateTimeRFC3339(objectMap, "expiryTimeStamp", a.ExpiryTimeStamp)
	populate(objectMap, "ipAddress", a.IPAddress)
	populateTimeRFC3339(objectMap, "startTimeStamp", a.StartTimeStamp)
...
func (a *AccountSas) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "expiryTimeStamp":
			err = unpopulateTimeRFC3339(val, "ExpiryTimeStamp", &a.ExpiryTimeStamp)
			delete(rawMsg, key)
		case "ipAddress":
			err = unpopulate(val, "IPAddress", &a.IPAddress)
			delete(rawMsg, key)
		case "startTimeStamp":
			err = unpopulateTimeRFC3339(val, "StartTimeStamp", &a.StartTimeStamp)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", a, err)
...
func (c ContainerSaS) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateTimeRFC3339(objectMap, "expiryTimeStamp", c.ExpiryTimeStamp)
	populate(objectMap, "ipAddress", c.IPAddress)
	populateTimeRFC3339(objectMap, "startTimeStamp", c.StartTimeStamp)
	return json.Marshal(objectMap)
}
...
func (c *ContainerSaS) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "expiryTimeStamp":
			err = unpopulateTimeRFC3339(val, "ExpiryTimeStamp", &c.ExpiryTimeStamp)
			delete(rawMsg, key)
		case "ipAddress":
			err = unpopulate(val, "IPAddress", &c.IPAddress)
			delete(rawMsg, key)
		case "startTimeStamp":
			err = unpopulateTimeRFC3339(val, "StartTimeStamp", &c.StartTimeStamp)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", c, err)
