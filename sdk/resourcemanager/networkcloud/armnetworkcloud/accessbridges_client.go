...
func (client *AccessBridgesClient) getHandleResponse(resp *http.Response, successCodes ...int) (AccessBridgesClientGetResponse, error) {
...
func (client *AccessBridgesClient) listByResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, nextLink string, options *AccessBridgesClientListByResourceGroupOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *AccessBridgesClient) listByResourceGroupHandleResponse(resp *http.Response, successCodes ...int) (AccessBridgesClientListByResourceGroupResponse, error) {
...
func (client *AccessBridgesClient) listBySubscriptionCreateRequest(ctx context.Context, nextLink string, options *AccessBridgesClientListBySubscriptionOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
	var req *policy.Request
	var err error
	if firstPage {
...
func (client *AccessBridgesClient) listBySubscriptionHandleResponse(resp *http.Response, successCodes ...int) (AccessBridgesClientListBySubscriptionResponse, error) {
