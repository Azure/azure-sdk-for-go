...
func ExampleCloudServicesNetworksClient_NewListByResourceGroupPager() {
	...
	for pager.More() {
		...
		// page = armnetworkcloud.CloudServicesNetworksClientListByResourceGroupResponse{
		// 	CloudServicesNetworkList: armnetworkcloud.CloudServicesNetworkList{
...
func ExampleCloudServicesNetworksClient_NewListBySubscriptionPager() {
	...
	for pager.More() {
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armnetworkcloud.CloudServicesNetworksClientListBySubscriptionResponse{
		// 	CloudServicesNetworkList: armnetworkcloud.CloudServicesNetworkList{
		// 		NextLink: to.Ptr("https://fully.qualified.hyperlink"),
		// 		Value: []*armnetworkcloud.CloudServicesNetwork{
		// 			{
