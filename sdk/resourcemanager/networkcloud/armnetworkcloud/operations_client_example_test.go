...
func ExampleOperationsClient_NewListPager() {
	...
	clientFactory, err := armnetworkcloud.NewClientFactory("<subscriptionID>", cred, nil)
	if err != nil {
	...
	for pager.More() {
		...
		// page = armnetworkcloud.OperationsClientListResponse{
		// 	OperationListResult: armnetworkcloud.OperationListResult{
