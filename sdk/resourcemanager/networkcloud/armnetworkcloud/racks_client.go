...
func (client *RacksClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, rackName string, rackParameters Rack, _ *RacksClientBeginCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *RacksClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, rackName string, _ *RacksClientBeginDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetworkCloud/racks/{rackName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *RacksClient) listByResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, _ *RacksClientListByResourceGroupOptions) (*policy.Request, error) {
...
func (client *RacksClient) listBySubscriptionCreateRequest(ctx context.Context, _ *RacksClientListBySubscriptionOptions) (*policy.Request, error) {
...
func (client *RacksClient) updateCreateRequest(ctx context.Context, resourceGroupName string, rackName string, rackUpdateParameters RackPatchParameters, _ *RacksClientBeginUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetworkCloud/racks/{rackName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
