...
func (client *TrunkedNetworksClient) getHandleResponse(resp *http.Response, successCodes ...int) (TrunkedNetworksClientGetResponse, error) {
...
func (client *TrunkedNetworksClient) listByResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, nextLink string, options *TrunkedNetworksClientListByResourceGroupOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *TrunkedNetworksClient) listByResourceGroupHandleResponse(resp *http.Response, successCodes ...int) (TrunkedNetworksClientListByResourceGroupResponse, error) {
...
func (client *TrunkedNetworksClient) listBySubscriptionCreateRequest(ctx context.Context, nextLink string, options *TrunkedNetworksClientListBySubscriptionOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
	var req *policy.Request
	var err error
	if firstPage {
...
func (client *TrunkedNetworksClient) listBySubscriptionHandleResponse(resp *http.Response, successCodes ...int) (TrunkedNetworksClientListBySubscriptionResponse, error) {
...
func (client *TrunkedNetworksClient) updateHandleResponse(resp *http.Response, successCodes ...int) (TrunkedNetworksClientUpdateResponse, error) {
