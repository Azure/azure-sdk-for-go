...
```go
client, err := armnetworkfunction.NewAzureTrafficCollectorsByResourceGroupClient(<subscription ID>, cred, nil)
```
...
client, err := armnetworkfunction.NewAzureTrafficCollectorsByResourceGroupClient(<subscription ID>, cred, &options)
```
