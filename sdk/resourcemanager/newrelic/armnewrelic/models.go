...
// MonitorResource - A Monitor Resource by NewRelic
...
// MonitorResourceListResult - The response of a NewRelicMonitorResource list operation.
...
// MonitorResourceUpdate - The type used for update operations of the NewRelicMonitorResource.
type MonitorResourceUpdate struct {
	// The managed service identities assigned to this resource.
	Identity *ManagedServiceIdentity `json:"identity,omitempty"`

	// The updatable properties of the NewRelicMonitorResource.
	Properties *MonitorResourceUpdateProperties `json:"properties,omitempty"`

	// Resource tags.
	Tags map[string]*string `json:"tags,omitempty"`
}

// MonitorResourceUpdateProperties - The updatable properties of the NewRelicMonitorResource.
type MonitorResourceUpdateProperties struct {
	// Source of account creation
	AccountCreationSource *AccountCreationSource `json:"accountCreationSource,omitempty"`
...
// SingleSignOnProperties - Single sign on Info of the NewRelic account
