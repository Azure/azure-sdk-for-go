...
// MarshalJSON implements the json.Marshaller interface for type MonitorResourceUpdateProperties.
func (m MonitorResourceUpdateProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "accountCreationSource", m.AccountCreationSource)
	populate(objectMap, "newRelicAccountProperties", m.NewRelicAccountProperties)
	populate(objectMap, "orgCreationSource", m.OrgCreationSource)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type MonitorResourceUpdateProperties.
func (m *MonitorResourceUpdateProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", m, err)
	}
