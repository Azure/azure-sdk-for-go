...
```go
client, err := armnewrelicobservability.NewTagRulesClient(<subscription ID>, cred, nil)
```
...
client, err := armnewrelicobservability.NewTagRulesClient(<subscription ID>, cred, &options)
```
