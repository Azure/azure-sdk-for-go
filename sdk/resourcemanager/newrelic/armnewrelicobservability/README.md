...
```go
client, err := armnewrelicobservability.NewPlansClient(<subscription ID>, cred, nil)
```
...
client, err := armnewrelicobservability.NewPlansClient(<subscription ID>, cred, &options)
```
