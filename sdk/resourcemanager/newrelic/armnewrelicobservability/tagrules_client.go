...
func (client *TagRulesClient) NewListByNewRelicMonitorResourcePager(resourceGroupName string, monitorName string, options *TagRulesClientListByNewRelicMonitorResourceOptions) *runtime.Pager[TagRulesClientListByNewRelicMonitorResourceResponse] {
	return runtime.NewPager(runtime.PagingHandler[TagRulesClientListByNewRelicMonitorResourceResponse]{
		...
		Fetcher: func(ctx context.Context, page *TagRulesClientListByNewRelicMonitorResourceResponse) (TagRulesClientListByNewRelicMonitorResourceResponse, error) {
			...
			req, err := client.listByNewRelicMonitorResourceCreateRequest(ctx, resourceGroupName, monitorName, nextLink, options)
			if err != nil {
			...
			return client.listByNewRelicMonitorResourceHandleResponse(resp, http.StatusOK)
		},
		Tracer: client.internal.Tracer(),
	})
}
...
func (client *TagRulesClient) listByNewRelicMonitorResourceCreateRequest(ctx context.Context, resourceGroupName string, monitorName string, nextLink string, _ *TagRulesClientListByNewRelicMonitorResourceOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *TagRulesClient) listByNewRelicMonitorResourceHandleResponse(resp *http.Response, successCodes ...int) (TagRulesClientListByNewRelicMonitorResourceResponse, error) {
...
func (client *TagRulesClient) updateHandleResponse(resp *http.Response, successCodes ...int) (TagRulesClientUpdateResponse, error) {
