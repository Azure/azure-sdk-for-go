...
func (client *CertificatesClient) listCreateRequest(ctx context.Context, resourceGroupName string, deploymentName string, nextLink string, _ *CertificatesClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
