...
func (client *ConfigurationsClient) analysisHandleResponse(resp *http.Response, successCodes ...int) (ConfigurationsClientAnalysisResponse, error) {
...
//     method.
func (client *ConfigurationsClient) BeginCreateOrUpdate(ctx context.Context, resourceGroupName string, deploymentName string, configurationName string, body ConfigurationRequest, options *ConfigurationsClientBeginCreateOrUpdateOptions) (*runtime.Poller[ConfigurationsClientCreateOrUpdateResponse], error) {
...
// If the operation fails it returns an *azcore.ResponseError type.
func (client *ConfigurationsClient) createOrUpdate(ctx context.Context, resourceGroupName string, deploymentName string, configurationName string, body ConfigurationRequest, options *ConfigurationsClientBeginCreateOrUpdateOptions) (*http.Response, error) {
	var err error
...
func (client *ConfigurationsClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, deploymentName string, configurationName string, body ConfigurationRequest, _ *ConfigurationsClientBeginCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *ConfigurationsClient) listCreateRequest(ctx context.Context, resourceGroupName string, deploymentName string, nextLink string, _ *ConfigurationsClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
