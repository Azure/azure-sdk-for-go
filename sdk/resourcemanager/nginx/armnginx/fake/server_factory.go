...
type ServerFactory struct {
	...
	// WafPoliciesServer contains the fakes for client WafPoliciesClient
	WafPoliciesServer WafPoliciesServer
}
...
type ServerFactoryTransport struct {
	...
	trWafPoliciesServer    *WafPoliciesServerTransport
}
...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "WafPoliciesClient":
		initServer(s, &s.trWafPoliciesServer, func() *WafPoliciesServerTransport { return NewWafPoliciesServerTransport(&s.srv.WafPoliciesServer) })
		resp, err = s.trWafPoliciesServer.Do(req)
	default:
