...
// DeploymentWafPolicyAnalysisCreateRequest - Nginx Deployment Waf Policy Analysis Create Request
type DeploymentWafPolicyAnalysisCreateRequest struct {
...
// DeploymentWafPolicyAnalysisData - Nginx Deployment Waf Policy Analysis Data
type DeploymentWafPolicyAnalysisData struct {
	// List of errors found during analysis
	Errors []*DeploymentWafPolicyError
}

// DeploymentWafPolicyAnalysisResponse - Nginx Deployment Waf Policy Analysis Response
type DeploymentWafPolicyAnalysisResponse struct {
	// The analysis data containing errors
	Data *DeploymentWafPolicyAnalysisData
...
// DeploymentWafPolicyError - Nginx Deployment Waf Policy Error
type DeploymentWafPolicyError struct {
	// Error code
	Code *string
