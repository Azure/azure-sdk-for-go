...
func (c CertificateProperties) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "keyVaultSecretCreated", c.KeyVaultSecretCreated, true)
...
func (d DeploymentAPIKeyRequestProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateTime[datetime.RFC3339](objectMap, "endDateTime", d.EndDateTime, true)
...
func (d *DeploymentAPIKeyRequestProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "endDateTime":
			err = unpopulateTime[datetime.RFC3339](val, "EndDateTime", &d.EndDateTime)
			delete(rawMsg, key)
		case "secretText":
...
// MarshalJSON implements the json.Marshaller interface for type DeploymentWafPolicyAnalysisCreateRequest.
func (d DeploymentWafPolicyAnalysisCreateRequest) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateByteArray(objectMap, "content", d.Content, func() any {
		return runtime.EncodeByteArray(d.Content, runtime.Base64StdFormat)
	})
...
// UnmarshalJSON implements the json.Unmarshaller interface for type DeploymentWafPolicyAnalysisCreateRequest.
func (d *DeploymentWafPolicyAnalysisCreateRequest) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %s", d, err.Error())
	}
...
// MarshalJSON implements the json.Marshaller interface for type DeploymentWafPolicyAnalysisData.
func (d DeploymentWafPolicyAnalysisData) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "errors", d.Errors)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type DeploymentWafPolicyAnalysisData.
func (d *DeploymentWafPolicyAnalysisData) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %s", d, err.Error())
	}
...
// MarshalJSON implements the json.Marshaller interface for type DeploymentWafPolicyAnalysisResponse.
func (d DeploymentWafPolicyAnalysisResponse) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type DeploymentWafPolicyAnalysisResponse.
func (d *DeploymentWafPolicyAnalysisResponse) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %s", d, err.Error())
	}
...
// MarshalJSON implements the json.Marshaller interface for type DeploymentWafPolicyError.
func (d DeploymentWafPolicyError) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "code", d.Code)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type DeploymentWafPolicyError.
func (d *DeploymentWafPolicyError) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %s", d, err.Error())
	}
...
func (w WebApplicationFirewallPackage) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateTime[datetime.RFC3339](objectMap, "revisionDatetime", w.RevisionDatetime, true)
...
func (w *WebApplicationFirewallPackage) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "revisionDatetime":
			err = unpopulateTime[datetime.RFC3339](val, "RevisionDatetime", &w.RevisionDatetime)
			delete(rawMsg, key)
		case "version":
