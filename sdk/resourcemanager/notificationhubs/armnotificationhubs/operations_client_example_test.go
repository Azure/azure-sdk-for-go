...
func ExampleOperationsClient_NewListPager() {
	...
	clientFactory, err := armnotificationhubs.NewClientFactory("<subscriptionID>", cred, nil)
	if err != nil {
	...
	for pager.More() {
		...
		// page = armnotificationhubs.OperationsClientListResponse{
		// 	OperationListResult: armnotificationhubs.OperationListResult{
