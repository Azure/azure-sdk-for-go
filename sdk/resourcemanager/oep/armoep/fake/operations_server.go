...
// The returned OperationsServerTransport instance is connected to an instance of armoep.OperationsClient via the
// azcore.ClientOptions.Transporter field in the client's constructor parameters.
func NewOperationsServerTransport(srv *OperationsServer) *OperationsServerTransport {
	return &OperationsServerTransport{srv: srv}
}

// OperationsServerTransport connects instances of armoep.OperationsClient to instances of OperationsServer.
