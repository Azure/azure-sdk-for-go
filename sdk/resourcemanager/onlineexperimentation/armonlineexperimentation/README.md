...
clientFactory, err := armonlineexperimentation.NewClientFactory(<subscription ID>, cred, &options)
```
...
```go
client := clientFactory.NewOnlineExperimentWorkspacesClient()
```
...
[open an issue](https://github.com/Azure/azure-sdk-for-go/issues) and assign the `Onlineexperimentation` label.
