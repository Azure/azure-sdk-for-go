...
func (client *DataSourcesClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, dataSourceName string, parameters DataSource, _ *DataSourcesClientCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *DataSourcesClient) createOrUpdateHandleResponse(resp *http.Response, successCodes ...int) (DataSourcesClientCreateOrUpdateResponse, error) {
...
func (client *DataSourcesClient) Delete(ctx context.Context, resourceGroupName string, workspaceName string, dataSourceName string, options *DataSourcesClientDeleteOptions) (DataSourcesClientDeleteResponse, error) {
	...
	if !runtime.HasStatusCode(httpResp, http.StatusOK, http.StatusNoContent) {
		return DataSourcesClientDeleteResponse{}, runtime.NewResponseError(httpResp)
	}
	return DataSourcesClientDeleteResponse{}, nil
}

// deleteCreateRequest creates the Delete request.
func (client *DataSourcesClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, dataSourceName string, _ *DataSourcesClientDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/dataSources/{dataSourceName}"
	urlPath = strings.ReplaceAll(urlPath, "{subscriptionId}", url.PathEscape(client.subscriptionID))
	if resourceGroupName == "" {
		return nil, errors.New("parameter resourceGroupName cannot be empty")
...
func (client *DataSourcesClient) getCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, dataSourceName string, _ *DataSourcesClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/dataSources/{dataSourceName}"
	urlPath = strings.ReplaceAll(urlPath, "{subscriptionId}", url.PathEscape(client.subscriptionID))
	if resourceGroupName == "" {
		return nil, errors.New("parameter resourceGroupName cannot be empty")
...
func (client *DataSourcesClient) getHandleResponse(resp *http.Response, successCodes ...int) (DataSourcesClientGetResponse, error) {
...
func (client *DataSourcesClient) NewListByWorkspacePager(resourceGroupName string, workspaceName string, filter string, options *DataSourcesClientListByWorkspaceOptions) *runtime.Pager[DataSourcesClientListByWorkspaceResponse] {
	return runtime.NewPager(runtime.PagingHandler[DataSourcesClientListByWorkspaceResponse]{
		...
		Fetcher: func(ctx context.Context, page *DataSourcesClientListByWorkspaceResponse) (DataSourcesClientListByWorkspaceResponse, error) {
			...
			req, err := client.listByWorkspaceCreateRequest(ctx, resourceGroupName, workspaceName, filter, nextLink, options)
			if err != nil {
...
func (client *DataSourcesClient) listByWorkspaceCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, filter string, nextLink string, options *DataSourcesClientListByWorkspaceOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *DataSourcesClient) listByWorkspaceHandleResponse(resp *http.Response, successCodes ...int) (DataSourcesClientListByWorkspaceResponse, error) {
