...
func ExampleDataSourcesClient_CreateOrUpdate() {
	...
	// res = armoperationalinsights.DataSourcesClientCreateOrUpdateResponse{
...
func ExampleDataSourcesClient_Delete() {
	...
	res, err := clientFactory.NewDataSourcesClient().Delete(ctx, "OIAutoRest5123", "AzTest9724", "AzTestDS774", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armoperationalinsights.DataSourcesClientDeleteResponse{
	// }
}
...
func ExampleDataSourcesClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armoperationalinsights.DataSourcesClientGetResponse{
	// 	DataSource: armoperationalinsights.DataSource{
	// 		Name: to.Ptr("AzTestDS774"),
	// 		Type: to.Ptr("Microsoft.OperationalInsights/workspaces/datasources"),
	// 		Etag: to.Ptr("W/\"datetime'2017-10-01T08%3A01%3A21.2351243Z'\""),
...
func ExampleDataSourcesClient_NewListByWorkspacePager() {
	...
	pager := clientFactory.NewDataSourcesClient().NewListByWorkspacePager("OIAutoRest5123", "AzTest9724", "kind='WindowsEvent'", nil)
	for pager.More() {
