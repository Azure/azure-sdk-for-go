...
func ExampleIntelligencePacksClient_Disable() {
	...
	res, err := clientFactory.NewIntelligencePacksClient().Disable(ctx, "rg1", "TestLinkWS", "ChangeTracking", nil)
	if err != nil {
	...
	// res = armoperationalinsights.IntelligencePacksClientDisableResponse{
	// }
}
...
func ExampleIntelligencePacksClient_Enable() {
	...
	res, err := clientFactory.NewIntelligencePacksClient().Enable(ctx, "rg1", "TestLinkWS", "ChangeTracking", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armoperationalinsights.IntelligencePacksClientEnableResponse{
	// }
}
...
func ExampleIntelligencePacksClient_List() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armoperationalinsights.IntelligencePacksClientListResponse{
	// 	IntelligencePackArray: []*armoperationalinsights.IntelligencePack{
	// 		{
