...
func (client *LinkedServicesClient) listByWorkspaceCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, nextLink string, _ *LinkedServicesClientListByWorkspaceOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *LinkedServicesClient) listByWorkspaceHandleResponse(resp *http.Response, successCodes ...int) (LinkedServicesClientListByWorkspaceResponse, error) {
