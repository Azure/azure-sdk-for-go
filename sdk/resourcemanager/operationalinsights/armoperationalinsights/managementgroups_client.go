...
func (client *ManagementGroupsClient) listCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, nextLink string, _ *ManagementGroupsClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *ManagementGroupsClient) listHandleResponse(resp *http.Response, successCodes ...int) (ManagementGroupsClientListResponse, error) {
