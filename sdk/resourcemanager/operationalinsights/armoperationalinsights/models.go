...
// DataSourceListResult - The response of a DataSource list operation.
type DataSourceListResult struct {
	// REQUIRED; The DataSource items on this page
	Value []*DataSource
...
// LogAnalyticsQueryPackListResult - The response of a LogAnalyticsQueryPack list operation.
type LogAnalyticsQueryPackListResult struct {
	// REQUIRED; The LogAnalyticsQueryPack items on this page
...
// LogAnalyticsQueryPackQueryListResult - The response of a LogAnalyticsQueryPackQuery list operation.
type LogAnalyticsQueryPackQueryListResult struct {
	// REQUIRED; The LogAnalyticsQueryPackQuery items on this page
...
type SummaryLogsListResult struct {
	// REQUIRED; The SummaryLogs items on this page
	Value []*SummaryLogs
...
type SummaryLogsProperties struct {
	...
	// an ongoing operation, preventing any update to the Summary rule until the operation is complete.
