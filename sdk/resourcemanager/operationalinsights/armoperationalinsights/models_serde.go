...
func (a *AssociatedWorkspace) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "associateDate":
			err = unpopulateTime[datetime.RFC3339](val, "AssociateDate", &a.AssociateDate)
			delete(rawMsg, key)
		case "resourceId":
...
func (c *CapacityReservationProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "lastSkuUpdate":
			err = unpopulateTime[datetime.RFC3339](val, "LastSKUUpdate", &c.LastSKUUpdate)
			delete(rawMsg, key)
		case "minCapacity":
...
func (c *ClusterProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "lastModifiedDate":
			err = unpopulateTime[datetime.RFC3339](val, "LastModifiedDate", &c.LastModifiedDate)
			delete(rawMsg, key)
...
func (l *LogAnalyticsQueryPackProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "queryPackId":
			...
			delete(rawMsg, key)
		case "timeCreated":
			err = unpopulateTime[datetime.RFC3339](val, "TimeCreated", &l.TimeCreated)
			delete(rawMsg, key)
		case "timeModified":
			err = unpopulateTime[datetime.RFC3339](val, "TimeModified", &l.TimeModified)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %s", l, err.Error())
...
func (m *ManagementGroupProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "created":
			err = unpopulateTime[datetime.RFC3339](val, "Created", &m.Created)
			delete(rawMsg, key)
		case "dataReceived":
			err = unpopulateTime[datetime.RFC3339](val, "DataReceived", &m.DataReceived)
			delete(rawMsg, key)
		case "id":
...
func (r *RestoredLogs) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "azureAsyncOperationId":
			...
			delete(rawMsg, key)
		case "endRestoreTime":
			err = unpopulateTime[datetime.RFC3339](val, "EndRestoreTime", &r.EndRestoreTime)
			delete(rawMsg, key)
		case "sourceTable":
			err = unpopulate(val, "SourceTable", &r.SourceTable)
			delete(rawMsg, key)
		case "startRestoreTime":
			err = unpopulateTime[datetime.RFC3339](val, "StartRestoreTime", &r.StartRestoreTime)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %s", r, err.Error())
...
func (r *RuleDefinition) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "binSize":
			...
			delete(rawMsg, key)
		case "binStartTime":
			err = unpopulateTime[datetime.RFC3339](val, "BinStartTime", &r.BinStartTime)
			delete(rawMsg, key)
...
func (s *SearchMetadata) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "id":
			...
			delete(rawMsg, key)
		case "lastUpdated":
			err = unpopulateTime[datetime.RFC3339](val, "LastUpdated", &s.LastUpdated)
			delete(rawMsg, key)
		case "max":
...
func (s *SearchResults) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "description":
			...
			delete(rawMsg, key)
		case "endSearchTime":
			err = unpopulateTime[datetime.RFC3339](val, "EndSearchTime", &s.EndSearchTime)
			delete(rawMsg, key)
		case "limit":
		...
		case "startSearchTime":
			err = unpopulateTime[datetime.RFC3339](val, "StartSearchTime", &s.StartSearchTime)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %s", s, err.Error())
...
// MarshalJSON implements the json.Marshaller interface for type SummaryLogsIdentity.
func (s SummaryLogsIdentity) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type SummaryLogsIdentity.
func (s *SummaryLogsIdentity) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %s", s, err.Error())
	}
...
func (s *SummaryLogsRetryBinProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "retryBinStartTime":
			err = unpopulateTime[datetime.RFC3339](val, "RetryBinStartTime", &s.RetryBinStartTime)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %s", s, err.Error())
...
// MarshalJSON implements the json.Marshaller interface for type SummaryLogsUserIdentityProperties.
func (s SummaryLogsUserIdentityProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type SummaryLogsUserIdentityProperties.
func (s *SummaryLogsUserIdentityProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %s", s, err.Error())
	}
...
func (t TableProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "protectionLevel", t.ProtectionLevel)
...
func (t *TableProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "protectionLevel":
			err = unpopulate(val, "ProtectionLevel", &t.ProtectionLevel)
			delete(rawMsg, key)
		case "provisioningState":
...
func (w *WorkspaceFailoverProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "lastModifiedDate":
			err = unpopulateTime[datetime.RFC3339](val, "LastModifiedDate", &w.LastModifiedDate)
			delete(rawMsg, key)
		case "state":
...
func (w WorkspaceFeatures) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "dataAuthorizationMode", w.DataAuthorizationMode)
...
func (w *WorkspaceFeatures) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "clusterResourceId":
			...
			delete(rawMsg, key)
		case "dataAuthorizationMode":
			err = unpopulate(val, "DataAuthorizationMode", &w.DataAuthorizationMode)
			delete(rawMsg, key)
...
func (w *WorkspaceProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "createdDate":
			err = unpopulateTime[datetime.RFC3339](val, "CreatedDate", &w.CreatedDate)
			delete(rawMsg, key)
		case "customerId":
		...
		case "forceCmkForQuery":
			...
			delete(rawMsg, key)
		case "modifiedDate":
			err = unpopulateTime[datetime.RFC3339](val, "ModifiedDate", &w.ModifiedDate)
			delete(rawMsg, key)
...
// MarshalJSON implements the json.Marshaller interface for type WorkspacePurgeLakeDataBody.
func (w WorkspacePurgeLakeDataBody) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "table", w.Table)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type WorkspacePurgeLakeDataBody.
func (w *WorkspacePurgeLakeDataBody) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %s", w, err.Error())
	}
...
// UnmarshalJSON implements the json.Unmarshaller interface for type WorkspacePurgeLakeDataTimeRange.
func (w *WorkspacePurgeLakeDataTimeRange) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %s", w, err.Error())
	}
...
func (w *WorkspaceSKU) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "capacityReservationLevel":
			...
			delete(rawMsg, key)
		case "lastSkuUpdate":
			err = unpopulateTime[datetime.RFC3339](val, "LastSKUUpdate", &w.LastSKUUpdate)
			delete(rawMsg, key)
		case "name":
			err = unpopulate(val, "Name", &w.Name)
			delete(rawMsg, key)
