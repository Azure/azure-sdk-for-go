...
// Generated from example definition: 2025-07-01/OperationsListByTenant.json
func ExampleOperationsClient_NewListPager() {
	...
	clientFactory, err := armoperationalinsights.NewClientFactory("<subscriptionID>", cred, nil)
	if err != nil {
	...
	for pager.More() {
		...
		// page = armoperationalinsights.OperationsClientListResponse{
		// 	OperationListResult: armoperationalinsights.OperationListResult{
