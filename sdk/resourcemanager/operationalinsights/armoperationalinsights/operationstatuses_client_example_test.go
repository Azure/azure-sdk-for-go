...
// Generated from example definition: 2025-07-01/OperationStatusesGet.json
func ExampleOperationStatusesClient_Get() {
	...
	clientFactory, err := armoperationalinsights.NewClientFactory("613192d7-503f-477a-9cfe-4efc3ee2bd60", cred, nil)
	if err != nil {
	...
	// res = armoperationalinsights.OperationStatusesClientGetResponse{
	// 	OperationStatus: armoperationalinsights.OperationStatus{
