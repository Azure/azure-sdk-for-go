...
func ExampleQueriesClient_Delete() {
	...
	res, err := clientFactory.NewQueriesClient().Delete(ctx, "my-resource-group", "my-querypack", "a449f8af-8e64-4b3a-9b16-5a7165ff98c4", nil)
	if err != nil {
	...
	// res = armoperationalinsights.QueriesClientDeleteResponse{
	// }
}
...
func ExampleQueriesClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armoperationalinsights.QueriesClientGetResponse{
	...
	// 			TimeCreated: to.Ptr(time.Date(2018, time.February, 12, 11, 44, 39, 298063400, time.UTC)),
	// 			TimeModified: to.Ptr(time.Date(2018, time.February, 14, 13, 13, 19, 338139400, time.UTC)),
	// 		},
...
func ExampleQueriesClient_NewListPager() {
	...
	pager := clientFactory.NewQueriesClient().NewListPager("my-resource-group", "my-querypack", &armoperationalinsights.QueriesClientListOptions{
	...
	for pager.More() {
		...
		// page = armoperationalinsights.QueriesClientListResponse{
		// 	LogAnalyticsQueryPackQueryListResult: armoperationalinsights.LogAnalyticsQueryPackQueryListResult{
		...
		// 					TimeCreated: to.Ptr(time.Date(2019, time.August, 15, 10, 29, 56, 103025400, time.UTC)),
		// 					TimeModified: to.Ptr(time.Date(2019, time.August, 15, 10, 29, 56, 103025400, time.UTC)),
		// 				},
		// 				SystemData: &armoperationalinsights.SystemData{
		// 					CreatedAt: to.Ptr(time.Date(2020, time.February, 3, 1, 1, 1, 107505600, time.UTC)),
		// 					CreatedBy: to.Ptr("string"),
		...
		// 					TimeCreated: to.Ptr(time.Date(2019, time.August, 15, 10, 30, 26, 794362900, time.UTC)),
		// 					TimeModified: to.Ptr(time.Date(2019, time.August, 15, 10, 30, 26, 794362900, time.UTC)),
		// 				},
		// 				SystemData: &armoperationalinsights.SystemData{
		// 					CreatedAt: to.Ptr(time.Date(2020, time.February, 3, 1, 1, 1, 107505600, time.UTC)),
		// 					CreatedBy: to.Ptr("string"),
		...
		// 					TimeCreated: to.Ptr(time.Date(2019, time.August, 15, 10, 30, 29, 450558400, time.UTC)),
		// 					TimeModified: to.Ptr(time.Date(2019, time.August, 15, 10, 30, 29, 450558400, time.UTC)),
		// 				},
		// 				SystemData: &armoperationalinsights.SystemData{
		// 					CreatedAt: to.Ptr(time.Date(2020, time.February, 3, 1, 1, 1, 107505600, time.UTC)),
		// 					CreatedBy: to.Ptr("string"),
		...
		// 					TimeCreated: to.Ptr(time.Date(2019, time.August, 15, 10, 30, 32, 574232400, time.UTC)),
		// 					TimeModified: to.Ptr(time.Date(2019, time.August, 15, 10, 30, 32, 574232400, time.UTC)),
		// 				},
		// 				SystemData: &armoperationalinsights.SystemData{
		// 					CreatedAt: to.Ptr(time.Date(2020, time.February, 3, 1, 1, 1, 107505600, time.UTC)),
		// 					CreatedBy: to.Ptr("string"),
...
func ExampleQueriesClient_NewSearchPager() {
	...
	}, &armoperationalinsights.QueriesClientSearchOptions{
		Top:         to.Ptr[int64](3),
		IncludeBody: to.Ptr(true)})
	for pager.More() {
		page, err := pager.NextPage(ctx)
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armoperationalinsights.QueriesClientSearchResponse{
		// 	LogAnalyticsQueryPackQueryListResult: armoperationalinsights.LogAnalyticsQueryPackQueryListResult{
		// 		Value: []*armoperationalinsights.LogAnalyticsQueryPackQuery{
		// 			{
		// 				Name: to.Ptr("4337bb16-d6fe-4ff7-97cf-59df25941476"),
...
func ExampleQueriesClient_Update() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armoperationalinsights.QueriesClientUpdateResponse{
	// 	LogAnalyticsQueryPackQuery: armoperationalinsights.LogAnalyticsQueryPackQuery{
	// 		Name: to.Ptr("a449f8af-8e64-4b3a-9b16-5a7165ff98c4"),
	// 		Type: to.Ptr("microsoft.operationalinsights/queryPacks/queries"),
	// 		ID: to.Ptr("/subscriptions/86dc51d3-92ed-4d7e-947a-775ea79b4918/resourceGroups/my-resource-group/providers/microsoft.operationalinsights/queryPacks/my-querypack/queries/a449f8af-8e64-4b3a-9b16-5a7165ff98c4"),
