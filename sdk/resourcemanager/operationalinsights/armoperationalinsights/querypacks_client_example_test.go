...
func ExampleQueryPacksClient_CreateOrUpdate_queryPackCreate() {
	...
	// res = armoperationalinsights.QueryPacksClientCreateOrUpdateResponse{
...
func ExampleQueryPacksClient_Delete() {
	...
	res, err := clientFactory.NewQueryPacksClient().Delete(ctx, "my-resource-group", "my-querypack", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armoperationalinsights.QueryPacksClientDeleteResponse{
	// }
}
...
func ExampleQueryPacksClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armoperationalinsights.QueryPacksClientListResponse{
		// 	LogAnalyticsQueryPackListResult: armoperationalinsights.LogAnalyticsQueryPackListResult{
...
func ExampleQueryPacksClient_NewListByResourceGroupPager() {
	...
	for pager.More() {
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armoperationalinsights.QueryPacksClientListByResourceGroupResponse{
		// 	LogAnalyticsQueryPackListResult: armoperationalinsights.LogAnalyticsQueryPackListResult{
		// 		Value: []*armoperationalinsights.LogAnalyticsQueryPack{
		// 			{
		// 				Name: to.Ptr("my-querypack"),
