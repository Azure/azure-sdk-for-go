...
func ExampleSummaryLogsClient_BeginCreateOrUpdate() {
	...
	clientFactory, err := armoperationalinsights.NewClientFactory("11111111-1111-1111-1111-111111111111", cred, nil)
	if err != nil {
	...
	// res = armoperationalinsights.SummaryLogsClientCreateOrUpdateResponse{
	// 	SummaryLogs: armoperationalinsights.SummaryLogs{
	...
	// 			ProvisioningState: to.Ptr(armoperationalinsights.ProvisioningStateEnumUpdating),
	// 			RuleDefinition: &armoperationalinsights.RuleDefinition{
	// 				BinDelay: to.Ptr[int32](10),
	// 				BinSize: to.Ptr[int32](180),
...
func ExampleSummaryLogsClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armoperationalinsights.SummaryLogsClientGetResponse{
	// 	SummaryLogs: armoperationalinsights.SummaryLogs{
	// 		Name: to.Ptr("summarylogs1"),
	// 		ID: to.Ptr("/subscriptions/11111111-1111-1111-1111-111111111111/resourceGroups/oiautorest6685/providers/Microsoft.OperationalInsights/workspaces/oiautorest6685/summaryLogs/summarylogs1"),
	// 		Properties: &armoperationalinsights.SummaryLogsProperties{
...
func ExampleSummaryLogsClient_NewListByWorkspacePager() {
	...
	for pager.More() {
		...
		// page = armoperationalinsights.SummaryLogsClientListByWorkspaceResponse{
		// 	SummaryLogsListResult: armoperationalinsights.SummaryLogsListResult{
...
func ExampleSummaryLogsClient_Stop() {
	...
	res, err := clientFactory.NewSummaryLogsClient().Stop(ctx, "oiautorest6685", "oiautorest6685", "summarylogs1", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armoperationalinsights.SummaryLogsClientStopResponse{
	// }
}
