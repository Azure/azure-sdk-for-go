...
func (client *TablesClient) listByWorkspaceCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, _ *TablesClientListByWorkspaceOptions) (*policy.Request, error) {
