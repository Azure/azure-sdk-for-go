...
func ExampleTablesClient_CancelSearch() {
	...
	res, err := clientFactory.NewTablesClient().CancelSearch(ctx, "oiautorest6685", "oiautorest6685", "table1_SRCH", nil)
	if err != nil {
	...
	// res = armoperationalinsights.TablesClientCancelSearchResponse{
	// }
}
...
func ExampleTablesClient_BeginDelete() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armoperationalinsights.TablesClientDeleteResponse{
	// }
}
...
func ExampleTablesClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armoperationalinsights.TablesClientGetResponse{
	// 	Table: armoperationalinsights.Table{
	// 		Name: to.Ptr("table1_SRCH"),
	// 		ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/oiautorest6685/providers/Microsoft.OperationalInsights/workspaces/oiautorest6685/tables/table1_SRCH"),
	// 		Properties: &armoperationalinsights.TableProperties{
	// 			Schema: &armoperationalinsights.Schema{
	// 				Name: to.Ptr("table1_SRCH"),
	// 				Columns: []*armoperationalinsights.Column{
	...
	// 			Plan: to.Ptr(armoperationalinsights.TablePlanEnumAnalytics),
	// 			ProvisioningState: to.Ptr(armoperationalinsights.TableProvisioningStateInProgress),
	...
	// 				EndSearchTime: to.Ptr(time.Date(2020, time.February, 2, 4, 5, 6, 0, time.UTC)),
	// 				Limit: to.Ptr[int32](1000),
	// 				Query: to.Ptr("Heartbeat | where SourceSystem != '' | project SourceSystem"),
	// 				SourceTable: to.Ptr("Heartbeat"),
	// 				StartSearchTime: to.Ptr(time.Date(2020, time.February, 3, 4, 5, 6, 0, time.UTC)),
	// 			},
...
func ExampleTablesClient_Migrate() {
	...
	res, err := clientFactory.NewTablesClient().Migrate(ctx, "oiautorest6685", "oiautorest6685", "table1_CL", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armoperationalinsights.TablesClientMigrateResponse{
	// }
}
