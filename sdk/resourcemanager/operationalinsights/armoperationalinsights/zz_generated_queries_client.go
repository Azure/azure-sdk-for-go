...
func (client *QueriesClient) Delete(ctx context.Context, resourceGroupName string, queryPackName string, id string, options *QueriesClientDeleteOptions) (QueriesClientDeleteResponse, error) {
	...
	return QueriesClientDeleteResponse{RawResponse: resp}, nil
}
...
func (client *QueriesClient) List(resourceGroupName string, queryPackName string, options *QueriesClientListOptions) *QueriesClientListPager {
	return &QueriesClientListPager{
		...
		advancer: func(ctx context.Context, resp QueriesClientListResponse) (*policy.Request, error) {
			return runtime.NewRequest(ctx, http.MethodGet, *resp.LogAnalyticsQueryPackQueryListResult.NextLink)
		},
	}
}
...
func (client *QueriesClient) putHandleResponse(resp *http.Response) (QueriesClientPutResponse, error) {
	result := QueriesClientPutResponse{RawResponse: resp}
	if err := runtime.UnmarshalAsJSON(resp, &result.LogAnalyticsQueryPackQuery); err != nil {
		return QueriesClientPutResponse{}, err
	}
	return result, nil
...
func (client *QueriesClient) Search(resourceGroupName string, queryPackName string, querySearchProperties LogAnalyticsQueryPackQuerySearchProperties, options *QueriesClientSearchOptions) *QueriesClientSearchPager {
	return &QueriesClientSearchPager{
		client: client,
		requester: func(ctx context.Context) (*policy.Request, error) {
			return client.searchCreateRequest(ctx, resourceGroupName, queryPackName, querySearchProperties, options)
		},
		advancer: func(ctx context.Context, resp QueriesClientSearchResponse) (*policy.Request, error) {
			return runtime.NewRequest(ctx, http.MethodGet, *resp.LogAnalyticsQueryPackQueryListResult.NextLink)
		},
	}
}
...
func (client *QueriesClient) searchHandleResponse(resp *http.Response) (QueriesClientSearchResponse, error) {
	result := QueriesClientSearchResponse{RawResponse: resp}
	if err := runtime.UnmarshalAsJSON(resp, &result.LogAnalyticsQueryPackQueryListResult); err != nil {
...
func (client *QueriesClient) updateHandleResponse(resp *http.Response) (QueriesClientUpdateResponse, error) {
	result := QueriesClientUpdateResponse{RawResponse: resp}
	if err := runtime.UnmarshalAsJSON(resp, &result.LogAnalyticsQueryPackQuery); err != nil {
		return QueriesClientUpdateResponse{}, err
	}
	return result, nil
