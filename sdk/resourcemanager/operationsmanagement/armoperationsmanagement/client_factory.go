...
func (c *ClientFactory) NewManagementAssociationsClient() *ManagementAssociationsClient {
	subClient, _ := NewManagementAssociationsClient(c.subscriptionID, c.credential, c.options)
	return subClient
}
...
func (c *ClientFactory) NewManagementConfigurationsClient() *ManagementConfigurationsClient {
	subClient, _ := NewManagementConfigurationsClient(c.subscriptionID, c.credential, c.options)
	return subClient
}
