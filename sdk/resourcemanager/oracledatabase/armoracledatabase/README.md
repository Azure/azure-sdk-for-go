...
Install the Azure Oracle Database module:

```sh
go get github.com/Azure/azure-sdk-for-go/sdk/resourcemanager/oracledatabase/armoracledatabase/v2
```
...
Azure Oracle Database module consists of one or more clients. We provide a client factory which could be used to create any client in this module.
...
[open an issue](https://github.com/Azure/azure-sdk-for-go/issues) and assign the `Oracle Database` label.
