...
func (client *AutonomousDatabaseBackupsClient) getHandleResponse(resp *http.Response, successCodes ...int) (AutonomousDatabaseBackupsClientGetResponse, error) {
...
func (client *AutonomousDatabaseBackupsClient) NewListByAutonomousDatabasePager(resourceGroupName string, autonomousdatabasename string, options *AutonomousDatabaseBackupsClientListByAutonomousDatabaseOptions) *runtime.Pager[AutonomousDatabaseBackupsClientListByAutonomousDatabaseResponse] {
	return runtime.NewPager(runtime.PagingHandler[AutonomousDatabaseBackupsClientListByAutonomousDatabaseResponse]{
		...
		Fetcher: func(ctx context.Context, page *AutonomousDatabaseBackupsClientListByAutonomousDatabaseResponse) (AutonomousDatabaseBackupsClientListByAutonomousDatabaseResponse, error) {
			...
			req, err := client.listByAutonomousDatabaseCreateRequest(ctx, resourceGroupName, autonomousdatabasename, nextLink, options)
			if err != nil {
			...
			return client.listByAutonomousDatabaseHandleResponse(resp, http.StatusOK)
		},
		Tracer: client.internal.Tracer(),
	})
}
...
func (client *AutonomousDatabaseBackupsClient) listByAutonomousDatabaseCreateRequest(ctx context.Context, resourceGroupName string, autonomousdatabasename string, nextLink string, _ *AutonomousDatabaseBackupsClientListByAutonomousDatabaseOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *AutonomousDatabaseBackupsClient) listByAutonomousDatabaseHandleResponse(resp *http.Response, successCodes ...int) (AutonomousDatabaseBackupsClientListByAutonomousDatabaseResponse, error) {
