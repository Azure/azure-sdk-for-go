...
// Generated from example definition: 2026-06-01/DatabaseEditions_Get_MaximumSet_Gen.json
func ExampleDatabaseEditionsClient_Get() {
	...
	res, err := clientFactory.NewDatabaseEditionsClient().Get(ctx, "eastus", "resource1", nil)
	if err != nil {
	...
	// res = armoracledatabase.DatabaseEditionsClientGetResponse{
	// 	DatabaseEdition: armoracledatabase.DatabaseEdition{
