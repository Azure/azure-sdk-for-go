...
func (client *DbServersClient) getHandleResponse(resp *http.Response, successCodes ...int) (DbServersClientGetResponse, error) {
...
func (client *DbServersClient) NewListByCloudExadataInfrastructurePager(resourceGroupName string, cloudexadatainfrastructurename string, options *DbServersClientListByCloudExadataInfrastructureOptions) *runtime.Pager[DbServersClientListByCloudExadataInfrastructureResponse] {
	return runtime.NewPager(runtime.PagingHandler[DbServersClientListByCloudExadataInfrastructureResponse]{
		...
		Fetcher: func(ctx context.Context, page *DbServersClientListByCloudExadataInfrastructureResponse) (DbServersClientListByCloudExadataInfrastructureResponse, error) {
			...
			req, err := client.listByCloudExadataInfrastructureCreateRequest(ctx, resourceGroupName, cloudexadatainfrastructurename, nextLink, options)
			if err != nil {
			...
			return client.listByCloudExadataInfrastructureHandleResponse(resp, http.StatusOK)
		},
...
func (client *DbServersClient) listByCloudExadataInfrastructureCreateRequest(ctx context.Context, resourceGroupName string, cloudexadatainfrastructurename string, nextLink string, _ *DbServersClientListByCloudExadataInfrastructureOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *DbServersClient) listByCloudExadataInfrastructureHandleResponse(resp *http.Response, successCodes ...int) (DbServersClientListByCloudExadataInfrastructureResponse, error) {
