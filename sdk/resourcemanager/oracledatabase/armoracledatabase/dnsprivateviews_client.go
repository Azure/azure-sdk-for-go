...
func (client *DNSPrivateViewsClient) getHandleResponse(resp *http.Response, successCodes ...int) (DNSPrivateViewsClientGetResponse, error) {
...
func (client *DNSPrivateViewsClient) listByLocationCreateRequest(ctx context.Context, location string, nextLink string, _ *DNSPrivateViewsClientListByLocationOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *DNSPrivateViewsClient) listByLocationHandleResponse(resp *http.Response, successCodes ...int) (DNSPrivateViewsClientListByLocationResponse, error) {
