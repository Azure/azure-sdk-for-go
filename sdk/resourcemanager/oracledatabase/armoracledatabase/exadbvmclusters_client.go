...
func (client *ExadbVMClustersClient) getHandleResponse(resp *http.Response, successCodes ...int) (ExadbVMClustersClientGetResponse, error) {
...
func (client *ExadbVMClustersClient) listByResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, nextLink string, _ *ExadbVMClustersClientListByResourceGroupOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *ExadbVMClustersClient) listByResourceGroupHandleResponse(resp *http.Response, successCodes ...int) (ExadbVMClustersClientListByResourceGroupResponse, error) {
...
func (client *ExadbVMClustersClient) listBySubscriptionCreateRequest(ctx context.Context, nextLink string, _ *ExadbVMClustersClientListBySubscriptionOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
	var req *policy.Request
	var err error
	if firstPage {
...
func (client *ExadbVMClustersClient) listBySubscriptionHandleResponse(resp *http.Response, successCodes ...int) (ExadbVMClustersClientListBySubscriptionResponse, error) {
