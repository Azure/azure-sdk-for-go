...
func ExampleOperationsClient_NewListPager_listOperationsGeneratedByMaximumSetRule() {
	...
	for pager.More() {
		...
		// 					Description: to.Ptr("gsjbckclfkm"),
		// 				},
		// 				Origin: to.Ptr(armoracledatabase.OriginUser),
		// 				ActionType: to.Ptr(armoracledatabase.ActionTypeInternal),
		// 			},
		// 		},
...
func ExampleOperationsClient_NewListPager_listOperationsGeneratedByMinimumSetRule() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
