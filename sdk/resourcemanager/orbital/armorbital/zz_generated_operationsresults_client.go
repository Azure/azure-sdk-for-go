...
// method.
func (client *OperationsResultsClient) BeginGet(ctx context.Context, location string, operationID string, options *OperationsResultsClientBeginGetOptions) (*armruntime.Poller[OperationsResultsClientGetResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.get(ctx, location, operationID, options)
		if err != nil {
			return nil, err
		}
		return armruntime.NewPoller[OperationsResultsClientGetResponse](resp, client.pl, nil)
	} else {
		return armruntime.NewPollerFromResumeToken[OperationsResultsClientGetResponse](options.ResumeToken, client.pl, nil)
	}
}
