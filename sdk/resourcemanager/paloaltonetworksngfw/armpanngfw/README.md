...
```go
client, err := armpanngfw.NewFqdnListLocalRulestackClient(<subscription ID>, cred, nil)
```
...
client, err := armpanngfw.NewFqdnListLocalRulestackClient(<subscription ID>, cred, &options)
```
