...
func (client *CertificateObjectLocalRulestackClient) getHandleResponse(resp *http.Response, successCodes ...int) (CertificateObjectLocalRulestackClientGetResponse, error) {
...
func (client *CertificateObjectLocalRulestackClient) listByLocalRulestacksCreateRequest(ctx context.Context, resourceGroupName string, localRulestackName string, nextLink string, _ *CertificateObjectLocalRulestackClientListByLocalRulestacksOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *CertificateObjectLocalRulestackClient) listByLocalRulestacksHandleResponse(resp *http.Response, successCodes ...int) (CertificateObjectLocalRulestackClientListByLocalRulestacksResponse, error) {
