...
func (client *FirewallStatusClient) getHandleResponse(resp *http.Response, successCodes ...int) (FirewallStatusClientGetResponse, error) {
...
func (client *FirewallStatusClient) NewListByFirewallsPager(resourceGroupName string, firewallName string, options *FirewallStatusClientListByFirewallsOptions) *runtime.Pager[FirewallStatusClientListByFirewallsResponse] {
	return runtime.NewPager(runtime.PagingHandler[FirewallStatusClientListByFirewallsResponse]{
		...
		Fetcher: func(ctx context.Context, page *FirewallStatusClientListByFirewallsResponse) (FirewallStatusClientListByFirewallsResponse, error) {
			...
			req, err := client.listByFirewallsCreateRequest(ctx, resourceGroupName, firewallName, nextLink, options)
			if err != nil {
			...
			return client.listByFirewallsHandleResponse(resp, http.StatusOK)
		},
...
func (client *FirewallStatusClient) listByFirewallsCreateRequest(ctx context.Context, resourceGroupName string, firewallName string, nextLink string, _ *FirewallStatusClientListByFirewallsOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *FirewallStatusClient) listByFirewallsHandleResponse(resp *http.Response, successCodes ...int) (FirewallStatusClientListByFirewallsResponse, error) {
