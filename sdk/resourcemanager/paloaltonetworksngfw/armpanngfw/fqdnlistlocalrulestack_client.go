...
func (client *FqdnListLocalRulestackClient) getHandleResponse(resp *http.Response, successCodes ...int) (FqdnListLocalRulestackClientGetResponse, error) {
...
func (client *FqdnListLocalRulestackClient) listByLocalRulestacksCreateRequest(ctx context.Context, resourceGroupName string, localRulestackName string, nextLink string, _ *FqdnListLocalRulestackClientListByLocalRulestacksOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *FqdnListLocalRulestackClient) listByLocalRulestacksHandleResponse(resp *http.Response, successCodes ...int) (FqdnListLocalRulestackClientListByLocalRulestacksResponse, error) {
