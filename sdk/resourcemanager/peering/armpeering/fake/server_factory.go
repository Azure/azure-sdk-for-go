...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "LookingGlassClient":
		initServer(&s.trMu, &s.trLookingGlassServer, func() *LookingGlassServerTransport { return NewLookingGlassServerTransport(&s.srv.LookingGlassServer) })
	...
	case "PeerAsnsClient":
		initServer(&s.trMu, &s.trPeerAsnsServer, func() *PeerAsnsServerTransport { return NewPeerAsnsServerTransport(&s.srv.PeerAsnsServer) })
		resp, err = s.trPeerAsnsServer.Do(req)
	case "PeeringsClient":
		initServer(&s.trMu, &s.trPeeringsServer, func() *PeeringsServerTransport { return NewPeeringsServerTransport(&s.srv.PeeringsServer) })
		resp, err = s.trPeeringsServer.Do(req)
	case "PrefixesClient":
		initServer(&s.trMu, &s.trPrefixesServer, func() *PrefixesServerTransport { return NewPrefixesServerTransport(&s.srv.PrefixesServer) })
