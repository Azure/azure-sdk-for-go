...
func ExampleLocationsClient_NewListPager_listDirectPeeringLocations() {
	...
	pager := clientFactory.NewLocationsClient().NewListPager(armpeering.LocationsKindDirect, nil)
	for pager.More() {
...
func ExampleLocationsClient_NewListPager_listExchangePeeringLocations() {
	...
	pager := clientFactory.NewLocationsClient().NewListPager(armpeering.LocationsKindExchange, nil)
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
