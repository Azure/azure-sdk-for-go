...
type RpUnbilledPrefix struct {
	...
	PeerAsn *int32 `json:"peerAsn,omitempty" azure:"ro"`
...
type RpUnbilledPrefixListResult struct {
	...
	Value []*RpUnbilledPrefix `json:"value,omitempty"`
}

// RpUnbilledPrefixesClientListOptions contains the optional parameters for the RpUnbilledPrefixesClient.List method.
