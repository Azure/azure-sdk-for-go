...
// Generated from example definition: 2025-05-01/ListPeeringOperations.json
func ExampleOperationsClient_NewListPager() {
	...
	clientFactory, err := armpeering.NewClientFactory("<subscriptionID>", cred, nil)
	if err != nil {
	...
	for pager.More() {
		...
		// page = armpeering.OperationsClientListResponse{
		// 	OperationListResult: armpeering.OperationListResult{
