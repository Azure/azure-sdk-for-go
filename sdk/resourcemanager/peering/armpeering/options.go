...
// ClientCheckServiceProviderAvailabilityOptions contains the optional parameters for the Client.CheckServiceProviderAvailability
// method.
type ClientCheckServiceProviderAvailabilityOptions struct {
	// placeholder for future optional parameters
}
...
type LocationsClientListOptions struct {
	...
	DirectPeeringType *LocationsDirectPeeringType
}
