...
func (client *PrefixesClient) createOrUpdateHandleResponse(resp *http.Response, successCodes ...int) (PrefixesClientCreateOrUpdateResponse, error) {
...
func (client *PrefixesClient) Delete(ctx context.Context, resourceGroupName string, peeringServiceName string, prefixName string, options *PrefixesClientDeleteOptions) (PrefixesClientDeleteResponse, error) {
	...
	if !runtime.HasStatusCode(httpResp, http.StatusOK, http.StatusNoContent) {
		return PrefixesClientDeleteResponse{}, runtime.NewResponseError(httpResp)
	}
...
func (client *PrefixesClient) getHandleResponse(resp *http.Response, successCodes ...int) (PrefixesClientGetResponse, error) {
...
func (client *PrefixesClient) listByPeeringServiceCreateRequest(ctx context.Context, resourceGroupName string, peeringServiceName string, nextLink string, options *PrefixesClientListByPeeringServiceOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *PrefixesClient) listByPeeringServiceHandleResponse(resp *http.Response, successCodes ...int) (PrefixesClientListByPeeringServiceResponse, error) {
