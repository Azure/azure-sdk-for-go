...
func (client *ServiceProvidersClient) listCreateRequest(ctx context.Context, nextLink string, _ *ServiceProvidersClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *ServiceProvidersClient) listHandleResponse(resp *http.Response, successCodes ...int) (ServiceProvidersClientListResponse, error) {
