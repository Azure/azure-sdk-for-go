...
// OrganizationsServer is a fake server for instances of the armpineconevectordb.OrganizationsClient type.
type OrganizationsServer struct {
	...
	BeginCreateOrUpdate func(ctx context.Context, resourceGroupName string, organizationname string, resource armpineconevectordb.OrganizationResource, options *armpineconevectordb.OrganizationsClientBeginCreateOrUpdateOptions) (resp azfake.PollerResponder[armpineconevectordb.OrganizationsClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)

	// BeginDelete is the fake for method OrganizationsClient.BeginDelete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginDelete func(ctx context.Context, resourceGroupName string, organizationname string, options *armpineconevectordb.OrganizationsClientBeginDeleteOptions) (resp azfake.PollerResponder[armpineconevectordb.OrganizationsClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method OrganizationsClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, organizationname string, options *armpineconevectordb.OrganizationsClientGetOptions) (resp azfake.Responder[armpineconevectordb.OrganizationsClientGetResponse], errResp azfake.ErrorResponder)

	// NewListByResourceGroupPager is the fake for method OrganizationsClient.NewListByResourceGroupPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByResourceGroupPager func(resourceGroupName string, options *armpineconevectordb.OrganizationsClientListByResourceGroupOptions) (resp azfake.PagerResponder[armpineconevectordb.OrganizationsClientListByResourceGroupResponse])

	// NewListBySubscriptionPager is the fake for method OrganizationsClient.NewListBySubscriptionPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListBySubscriptionPager func(options *armpineconevectordb.OrganizationsClientListBySubscriptionOptions) (resp azfake.PagerResponder[armpineconevectordb.OrganizationsClientListBySubscriptionResponse])

	// Update is the fake for method OrganizationsClient.Update
	// HTTP status codes to indicate success: http.StatusOK
	Update func(ctx context.Context, resourceGroupName string, organizationname string, properties armpineconevectordb.OrganizationResourceUpdate, options *armpineconevectordb.OrganizationsClientUpdateOptions) (resp azfake.Responder[armpineconevectordb.OrganizationsClientUpdateResponse], errResp azfake.ErrorResponder)
}

// NewOrganizationsServerTransport creates a new instance of OrganizationsServerTransport with the provided implementation.
// The returned OrganizationsServerTransport instance is connected to an instance of armpineconevectordb.OrganizationsClient via the
...
func NewOrganizationsServerTransport(srv *OrganizationsServer) *OrganizationsServerTransport {
	return &OrganizationsServerTransport{
		srv:                         srv,
		beginCreateOrUpdate:         newTracker[azfake.PollerResponder[armpineconevectordb.OrganizationsClientCreateOrUpdateResponse]](),
		beginDelete:                 newTracker[azfake.PollerResponder[armpineconevectordb.OrganizationsClientDeleteResponse]](),
		newListByResourceGroupPager: newTracker[azfake.PagerResponder[armpineconevectordb.OrganizationsClientListByResourceGroupResponse]](),
		newListBySubscriptionPager:  newTracker[azfake.PagerResponder[armpineconevectordb.OrganizationsClientListBySubscriptionResponse]](),
	}
}

// OrganizationsServerTransport connects instances of armpineconevectordb.OrganizationsClient to instances of OrganizationsServer.
...
type OrganizationsServerTransport struct {
	...
	beginCreateOrUpdate         *tracker[azfake.PollerResponder[armpineconevectordb.OrganizationsClientCreateOrUpdateResponse]]
	beginDelete                 *tracker[azfake.PollerResponder[armpineconevectordb.OrganizationsClientDeleteResponse]]
	newListByResourceGroupPager *tracker[azfake.PagerResponder[armpineconevectordb.OrganizationsClientListByResourceGroupResponse]]
	newListBySubscriptionPager  *tracker[azfake.PagerResponder[armpineconevectordb.OrganizationsClientListBySubscriptionResponse]]
}
...
func (o *OrganizationsServerTransport) dispatchBeginCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginCreateOrUpdate == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Pinecone\.VectorDb/organizations/(?P<organizationname>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 4 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
		}
		body, err := server.UnmarshalRequestAsJSON[armpineconevectordb.OrganizationResource](req)
		if err != nil {
			return nil, err
		}
...
func (o *OrganizationsServerTransport) dispatchNewListByResourceGroupPager(req *http.Request) (*http.Response, error) {
	...
	if newListByResourceGroupPager == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Pinecone\.VectorDb/organizations`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 3 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
		...
		server.PagerResponderInjectNextLinks(newListByResourceGroupPager, req, func(page *armpineconevectordb.OrganizationsClientListByResourceGroupResponse, createLink func() string) {
...
func (o *OrganizationsServerTransport) dispatchNewListBySubscriptionPager(req *http.Request) (*http.Response, error) {
	...
	if newListBySubscriptionPager == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Pinecone\.VectorDb/organizations`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 2 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
		...
		server.PagerResponderInjectNextLinks(newListBySubscriptionPager, req, func(page *armpineconevectordb.OrganizationsClientListBySubscriptionResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
...
func (o *OrganizationsServerTransport) dispatchUpdate(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[armpineconevectordb.OrganizationResourceUpdate](req)
	if err != nil {
		return nil, err
	}
	resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
