...
func ExampleValidationTestVersionsClient_Get() {
	...
	res, err := clientFactory.NewValidationTestVersionsClient().Get(ctx, "linux-quality-validation", "1.0.0", nil)
	if err != nil {
	...
	// 			DisplayName: to.Ptr("Linux Quality Validation 1.0.0"),
	...
	// 			},
	// 		},
	// 		ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/providers/Microsoft.PlatformValidation/validationTests/linux-quality-validation/versions/1.0.0"),
	// 		Name: to.Ptr("1.0.0"),
...
func ExampleValidationTestVersionsClient_NewListPager() {
	...
	pager := clientFactory.NewValidationTestVersionsClient().NewListPager("linux-quality-validation", &armplatformvalidation.ValidationTestVersionsClientListOptions{
	...
	for pager.More() {
		...
		// 			},
		// 		},
		// 		NextLink: to.Ptr("https://management.azure.com/subscriptions/00000000-0000-0000-0000-000000000000/providers/Microsoft.PlatformValidation/validationTests/linux-quality-validation/versions?api-version=2026-08-01-preview&$filter=audience%20eq%20'Public'&$skiptoken=cGFnZT0y"),
		// 	},
		// }
	}
}
