...
func NewComponentPolicyStatesClient(subscriptionID string, credential azcore.TokenCredential, options *arm.ClientOptions) (*ComponentPolicyStatesClient, error) {
...
func (client *ComponentPolicyStatesClient) ListQueryResultsForPolicyDefinition(ctx context.Context, policyDefinitionName string, componentPolicyStatesResource ComponentPolicyStatesResource, options *ComponentPolicyStatesClientListQueryResultsForPolicyDefinitionOptions) (ComponentPolicyStatesClientListQueryResultsForPolicyDefinitionResponse, error) {
	...
	req, err := client.listQueryResultsForPolicyDefinitionCreateRequest(ctx, policyDefinitionName, componentPolicyStatesResource, options)
	if err != nil {
...
func (client *ComponentPolicyStatesClient) listQueryResultsForPolicyDefinitionCreateRequest(ctx context.Context, policyDefinitionName string, componentPolicyStatesResource ComponentPolicyStatesResource, options *ComponentPolicyStatesClientListQueryResultsForPolicyDefinitionOptions) (*policy.Request, error) {
...
//     method.
func (client *ComponentPolicyStatesClient) ListQueryResultsForResourceGroup(ctx context.Context, resourceGroupName string, componentPolicyStatesResource ComponentPolicyStatesResource, options *ComponentPolicyStatesClientListQueryResultsForResourceGroupOptions) (ComponentPolicyStatesClientListQueryResultsForResourceGroupResponse, error) {
	var err error
	const operationName = "ComponentPolicyStatesClient.ListQueryResultsForResourceGroup"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.listQueryResultsForResourceGroupCreateRequest(ctx, resourceGroupName, componentPolicyStatesResource, options)
	if err != nil {
...
func (client *ComponentPolicyStatesClient) listQueryResultsForResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, componentPolicyStatesResource ComponentPolicyStatesResource, options *ComponentPolicyStatesClientListQueryResultsForResourceGroupOptions) (*policy.Request, error) {
...
//     method.
func (client *ComponentPolicyStatesClient) ListQueryResultsForSubscription(ctx context.Context, componentPolicyStatesResource ComponentPolicyStatesResource, options *ComponentPolicyStatesClientListQueryResultsForSubscriptionOptions) (ComponentPolicyStatesClientListQueryResultsForSubscriptionResponse, error) {
	var err error
	const operationName = "ComponentPolicyStatesClient.ListQueryResultsForSubscription"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.listQueryResultsForSubscriptionCreateRequest(ctx, componentPolicyStatesResource, options)
	if err != nil {
...
func (client *ComponentPolicyStatesClient) listQueryResultsForSubscriptionCreateRequest(ctx context.Context, componentPolicyStatesResource ComponentPolicyStatesResource, options *ComponentPolicyStatesClientListQueryResultsForSubscriptionOptions) (*policy.Request, error) {
