...
type ComponentPolicyStatesServer struct {
	...
	ListQueryResultsForPolicyDefinition func(ctx context.Context, policyDefinitionName string, componentPolicyStatesResource armpolicyinsights.ComponentPolicyStatesResource, options *armpolicyinsights.ComponentPolicyStatesClientListQueryResultsForPolicyDefinitionOptions) (resp azfake.Responder[armpolicyinsights.ComponentPolicyStatesClientListQueryResultsForPolicyDefinitionResponse], errResp azfake.ErrorResponder)
	...
	// HTTP status codes to indicate success: http.StatusOK
	ListQueryResultsForResourceGroup func(ctx context.Context, resourceGroupName string, componentPolicyStatesResource armpolicyinsights.ComponentPolicyStatesResource, options *armpolicyinsights.ComponentPolicyStatesClientListQueryResultsForResourceGroupOptions) (resp azfake.Responder[armpolicyinsights.ComponentPolicyStatesClientListQueryResultsForResourceGroupResponse], errResp azfake.ErrorResponder)
	...
	// HTTP status codes to indicate success: http.StatusOK
	ListQueryResultsForResourceGroupLevelPolicyAssignment func(ctx context.Context, resourceGroupName string, policyAssignmentName string, componentPolicyStatesResource armpolicyinsights.ComponentPolicyStatesResource, options *armpolicyinsights.ComponentPolicyStatesClientListQueryResultsForResourceGroupLevelPolicyAssignmentOptions) (resp azfake.Responder[armpolicyinsights.ComponentPolicyStatesClientListQueryResultsForResourceGroupLevelPolicyAssignmentResponse], errResp azfake.ErrorResponder)

	// ListQueryResultsForSubscription is the fake for method ComponentPolicyStatesClient.ListQueryResultsForSubscription
	// HTTP status codes to indicate success: http.StatusOK
	ListQueryResultsForSubscription func(ctx context.Context, componentPolicyStatesResource armpolicyinsights.ComponentPolicyStatesResource, options *armpolicyinsights.ComponentPolicyStatesClientListQueryResultsForSubscriptionOptions) (resp azfake.Responder[armpolicyinsights.ComponentPolicyStatesClientListQueryResultsForSubscriptionResponse], errResp azfake.ErrorResponder)
	...
	// HTTP status codes to indicate success: http.StatusOK
	ListQueryResultsForSubscriptionLevelPolicyAssignment func(ctx context.Context, policyAssignmentName string, componentPolicyStatesResource armpolicyinsights.ComponentPolicyStatesResource, options *armpolicyinsights.ComponentPolicyStatesClientListQueryResultsForSubscriptionLevelPolicyAssignmentOptions) (resp azfake.Responder[armpolicyinsights.ComponentPolicyStatesClientListQueryResultsForSubscriptionLevelPolicyAssignmentResponse], errResp azfake.ErrorResponder)
}
...
func (c *ComponentPolicyStatesServerTransport) dispatchListQueryResultsForPolicyDefinition(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := c.srv.ListQueryResultsForPolicyDefinition(req.Context(), policyDefinitionNameParam, componentPolicyStatesResourceParam, options)
...
func (c *ComponentPolicyStatesServerTransport) dispatchListQueryResultsForResourceGroup(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := c.srv.ListQueryResultsForResourceGroup(req.Context(), resourceGroupNameParam, componentPolicyStatesResourceParam, options)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (c *ComponentPolicyStatesServerTransport) dispatchListQueryResultsForResourceGroupLevelPolicyAssignment(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := c.srv.ListQueryResultsForResourceGroupLevelPolicyAssignment(req.Context(), resourceGroupNameParam, policyAssignmentNameParam, componentPolicyStatesResourceParam, options)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (c *ComponentPolicyStatesServerTransport) dispatchListQueryResultsForSubscription(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := c.srv.ListQueryResultsForSubscription(req.Context(), componentPolicyStatesResourceParam, options)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (c *ComponentPolicyStatesServerTransport) dispatchListQueryResultsForSubscriptionLevelPolicyAssignment(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := c.srv.ListQueryResultsForSubscriptionLevelPolicyAssignment(req.Context(), policyAssignmentNameParam, componentPolicyStatesResourceParam, options)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
