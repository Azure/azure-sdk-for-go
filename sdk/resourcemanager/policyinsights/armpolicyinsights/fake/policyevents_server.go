...
type PolicyEventsServer struct {
	...
	// HTTP status codes to indicate success: http.StatusOK
	NewListQueryResultsForPolicyDefinitionPager func(policyEventsResource armpolicyinsights.PolicyEventsResourceType, policyDefinitionName string, options *armpolicyinsights.PolicyEventsClientListQueryResultsForPolicyDefinitionOptions) (resp azfake.PagerResponder[armpolicyinsights.PolicyEventsClientListQueryResultsForPolicyDefinitionResponse])
	...
	// HTTP status codes to indicate success: http.StatusOK
	NewListQueryResultsForPolicySetDefinitionPager func(policyEventsResource armpolicyinsights.PolicyEventsResourceType, policySetDefinitionName string, options *armpolicyinsights.PolicyEventsClientListQueryResultsForPolicySetDefinitionOptions) (resp azfake.PagerResponder[armpolicyinsights.PolicyEventsClientListQueryResultsForPolicySetDefinitionResponse])

	// NewListQueryResultsForResourcePager is the fake for method PolicyEventsClient.NewListQueryResultsForResourcePager
	// HTTP status codes to indicate success: http.StatusOK
	NewListQueryResultsForResourcePager func(policyEventsResource armpolicyinsights.PolicyEventsResourceType, resourceID string, options *armpolicyinsights.PolicyEventsClientListQueryResultsForResourceOptions) (resp azfake.PagerResponder[armpolicyinsights.PolicyEventsClientListQueryResultsForResourceResponse])
	...
	// HTTP status codes to indicate success: http.StatusOK
	NewListQueryResultsForResourceGroupPager func(resourceGroupName string, policyEventsResource armpolicyinsights.PolicyEventsResourceType, options *armpolicyinsights.PolicyEventsClientListQueryResultsForResourceGroupOptions) (resp azfake.PagerResponder[armpolicyinsights.PolicyEventsClientListQueryResultsForResourceGroupResponse])
	...
	// HTTP status codes to indicate success: http.StatusOK
	NewListQueryResultsForResourceGroupLevelPolicyAssignmentPager func(resourceGroupName string, policyEventsResource armpolicyinsights.PolicyEventsResourceType, policyAssignmentName string, options *armpolicyinsights.PolicyEventsClientListQueryResultsForResourceGroupLevelPolicyAssignmentOptions) (resp azfake.PagerResponder[armpolicyinsights.PolicyEventsClientListQueryResultsForResourceGroupLevelPolicyAssignmentResponse])
	...
	// HTTP status codes to indicate success: http.StatusOK
	NewListQueryResultsForSubscriptionPager func(policyEventsResource armpolicyinsights.PolicyEventsResourceType, options *armpolicyinsights.PolicyEventsClientListQueryResultsForSubscriptionOptions) (resp azfake.PagerResponder[armpolicyinsights.PolicyEventsClientListQueryResultsForSubscriptionResponse])
...
func (p *PolicyEventsServerTransport) dispatchNewListQueryResultsForManagementGroupPager(req *http.Request) (*http.Response, error) {
	...
	if newListQueryResultsForManagementGroupPager == nil {
		...
		var options *armpolicyinsights.PolicyEventsClientListQueryResultsForManagementGroupOptions
		if topParam != nil || orderByParam != nil || selectParam != nil || fromParam != nil || toParam != nil || filterParam != nil || applyParam != nil || skipTokenParam != nil {
			options = &armpolicyinsights.PolicyEventsClientListQueryResultsForManagementGroupOptions{
				Top:       topParam,
		...
		resp := p.srv.NewListQueryResultsForManagementGroupPager(policyEventsResourceParam, managementGroupNameParam, options)
...
func (p *PolicyEventsServerTransport) dispatchNewListQueryResultsForPolicyDefinitionPager(req *http.Request) (*http.Response, error) {
	...
	if newListQueryResultsForPolicyDefinitionPager == nil {
		...
		skipTokenParam := getOptional(skipTokenUnescaped)
		var options *armpolicyinsights.PolicyEventsClientListQueryResultsForPolicyDefinitionOptions
		if topParam != nil || orderByParam != nil || selectParam != nil || fromParam != nil || toParam != nil || filterParam != nil || applyParam != nil || skipTokenParam != nil {
			options = &armpolicyinsights.PolicyEventsClientListQueryResultsForPolicyDefinitionOptions{
				Top:       topParam,
				OrderBy:   orderByParam,
				Select:    selectParam,
				From:      fromParam,
		...
		resp := p.srv.NewListQueryResultsForPolicyDefinitionPager(policyEventsResourceParam, policyDefinitionNameParam, options)
...
func (p *PolicyEventsServerTransport) dispatchNewListQueryResultsForPolicySetDefinitionPager(req *http.Request) (*http.Response, error) {
	...
	if newListQueryResultsForPolicySetDefinitionPager == nil {
		...
		skipTokenParam := getOptional(skipTokenUnescaped)
		var options *armpolicyinsights.PolicyEventsClientListQueryResultsForPolicySetDefinitionOptions
		if topParam != nil || orderByParam != nil || selectParam != nil || fromParam != nil || toParam != nil || filterParam != nil || applyParam != nil || skipTokenParam != nil {
			options = &armpolicyinsights.PolicyEventsClientListQueryResultsForPolicySetDefinitionOptions{
				Top:       topParam,
				OrderBy:   orderByParam,
				Select:    selectParam,
				From:      fromParam,
		...
		resp := p.srv.NewListQueryResultsForPolicySetDefinitionPager(policyEventsResourceParam, policySetDefinitionNameParam, options)
...
func (p *PolicyEventsServerTransport) dispatchNewListQueryResultsForResourcePager(req *http.Request) (*http.Response, error) {
	...
	if newListQueryResultsForResourcePager == nil {
		...
		skipTokenParam := getOptional(skipTokenUnescaped)
		var options *armpolicyinsights.PolicyEventsClientListQueryResultsForResourceOptions
		if topParam != nil || orderByParam != nil || selectParam != nil || fromParam != nil || toParam != nil || filterParam != nil || applyParam != nil || expandParam != nil || skipTokenParam != nil {
			options = &armpolicyinsights.PolicyEventsClientListQueryResultsForResourceOptions{
				Top:       topParam,
				OrderBy:   orderByParam,
				Select:    selectParam,
				From:      fromParam,
		...
		resp := p.srv.NewListQueryResultsForResourcePager(policyEventsResourceParam, resourceIDParam, options)
...
func (p *PolicyEventsServerTransport) dispatchNewListQueryResultsForResourceGroupPager(req *http.Request) (*http.Response, error) {
	...
	if newListQueryResultsForResourceGroupPager == nil {
		...
		skipTokenParam := getOptional(skipTokenUnescaped)
		var options *armpolicyinsights.PolicyEventsClientListQueryResultsForResourceGroupOptions
		if topParam != nil || orderByParam != nil || selectParam != nil || fromParam != nil || toParam != nil || filterParam != nil || applyParam != nil || skipTokenParam != nil {
			options = &armpolicyinsights.PolicyEventsClientListQueryResultsForResourceGroupOptions{
				Top:       topParam,
				OrderBy:   orderByParam,
				Select:    selectParam,
				From:      fromParam,
		...
		resp := p.srv.NewListQueryResultsForResourceGroupPager(resourceGroupNameParam, policyEventsResourceParam, options)
...
func (p *PolicyEventsServerTransport) dispatchNewListQueryResultsForResourceGroupLevelPolicyAssignmentPager(req *http.Request) (*http.Response, error) {
	...
	if newListQueryResultsForResourceGroupLevelPolicyAssignmentPager == nil {
		...
		skipTokenParam := getOptional(skipTokenUnescaped)
		var options *armpolicyinsights.PolicyEventsClientListQueryResultsForResourceGroupLevelPolicyAssignmentOptions
		if topParam != nil || orderByParam != nil || selectParam != nil || fromParam != nil || toParam != nil || filterParam != nil || applyParam != nil || skipTokenParam != nil {
			options = &armpolicyinsights.PolicyEventsClientListQueryResultsForResourceGroupLevelPolicyAssignmentOptions{
				Top:       topParam,
				OrderBy:   orderByParam,
				Select:    selectParam,
				From:      fromParam,
		...
		resp := p.srv.NewListQueryResultsForResourceGroupLevelPolicyAssignmentPager(resourceGroupNameParam, policyEventsResourceParam, policyAssignmentNameParam, options)
...
func (p *PolicyEventsServerTransport) dispatchNewListQueryResultsForSubscriptionPager(req *http.Request) (*http.Response, error) {
	...
	if newListQueryResultsForSubscriptionPager == nil {
		...
		skipTokenParam := getOptional(skipTokenUnescaped)
		var options *armpolicyinsights.PolicyEventsClientListQueryResultsForSubscriptionOptions
		if topParam != nil || orderByParam != nil || selectParam != nil || fromParam != nil || toParam != nil || filterParam != nil || applyParam != nil || skipTokenParam != nil {
			options = &armpolicyinsights.PolicyEventsClientListQueryResultsForSubscriptionOptions{
				Top:       topParam,
				OrderBy:   orderByParam,
				Select:    selectParam,
				From:      fromParam,
		...
		resp := p.srv.NewListQueryResultsForSubscriptionPager(policyEventsResourceParam, options)
...
func (p *PolicyEventsServerTransport) dispatchNewListQueryResultsForSubscriptionLevelPolicyAssignmentPager(req *http.Request) (*http.Response, error) {
	...
	if newListQueryResultsForSubscriptionLevelPolicyAssignmentPager == nil {
		...
		skipTokenParam := getOptional(skipTokenUnescaped)
		var options *armpolicyinsights.PolicyEventsClientListQueryResultsForSubscriptionLevelPolicyAssignmentOptions
		if topParam != nil || orderByParam != nil || selectParam != nil || fromParam != nil || toParam != nil || filterParam != nil || applyParam != nil || skipTokenParam != nil {
			options = &armpolicyinsights.PolicyEventsClientListQueryResultsForSubscriptionLevelPolicyAssignmentOptions{
				Top:       topParam,
				OrderBy:   orderByParam,
				Select:    selectParam,
				From:      fromParam,
		...
		resp := p.srv.NewListQueryResultsForSubscriptionLevelPolicyAssignmentPager(policyEventsResourceParam, policyAssignmentNameParam, options)
