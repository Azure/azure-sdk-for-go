...
type PolicyTrackedResourcesServer struct {
	...
	NewListQueryResultsForManagementGroupPager func(managementGroupName string, policyTrackedResourcesResource armpolicyinsights.PolicyTrackedResourcesResourceType, options *armpolicyinsights.PolicyTrackedResourcesClientListQueryResultsForManagementGroupOptions) (resp azfake.PagerResponder[armpolicyinsights.PolicyTrackedResourcesClientListQueryResultsForManagementGroupResponse])
	...
	// HTTP status codes to indicate success: http.StatusOK
	NewListQueryResultsForResourcePager func(resourceID string, policyTrackedResourcesResource armpolicyinsights.PolicyTrackedResourcesResourceType, options *armpolicyinsights.PolicyTrackedResourcesClientListQueryResultsForResourceOptions) (resp azfake.PagerResponder[armpolicyinsights.PolicyTrackedResourcesClientListQueryResultsForResourceResponse])
	...
	// HTTP status codes to indicate success: http.StatusOK
	NewListQueryResultsForResourceGroupPager func(resourceGroupName string, policyTrackedResourcesResource armpolicyinsights.PolicyTrackedResourcesResourceType, options *armpolicyinsights.PolicyTrackedResourcesClientListQueryResultsForResourceGroupOptions) (resp azfake.PagerResponder[armpolicyinsights.PolicyTrackedResourcesClientListQueryResultsForResourceGroupResponse])
	...
	// HTTP status codes to indicate success: http.StatusOK
	NewListQueryResultsForSubscriptionPager func(policyTrackedResourcesResource armpolicyinsights.PolicyTrackedResourcesResourceType, options *armpolicyinsights.PolicyTrackedResourcesClientListQueryResultsForSubscriptionOptions) (resp azfake.PagerResponder[armpolicyinsights.PolicyTrackedResourcesClientListQueryResultsForSubscriptionResponse])
}
...
func (p *PolicyTrackedResourcesServerTransport) dispatchNewListQueryResultsForManagementGroupPager(req *http.Request) (*http.Response, error) {
	...
	if newListQueryResultsForManagementGroupPager == nil {
		...
		var options *armpolicyinsights.PolicyTrackedResourcesClientListQueryResultsForManagementGroupOptions
		if topParam != nil || filterParam != nil {
			options = &armpolicyinsights.PolicyTrackedResourcesClientListQueryResultsForManagementGroupOptions{
				Top:    topParam,
				Filter: filterParam,
			}
		}
		resp := p.srv.NewListQueryResultsForManagementGroupPager(managementGroupNameParam, policyTrackedResourcesResourceParam, options)
...
func (p *PolicyTrackedResourcesServerTransport) dispatchNewListQueryResultsForResourcePager(req *http.Request) (*http.Response, error) {
	...
	if newListQueryResultsForResourcePager == nil {
		...
		filterParam := getOptional(filterUnescaped)
		var options *armpolicyinsights.PolicyTrackedResourcesClientListQueryResultsForResourceOptions
		if topParam != nil || filterParam != nil {
			options = &armpolicyinsights.PolicyTrackedResourcesClientListQueryResultsForResourceOptions{
				Top:    topParam,
				Filter: filterParam,
			}
		}
		resp := p.srv.NewListQueryResultsForResourcePager(resourceIDParam, policyTrackedResourcesResourceParam, options)
...
func (p *PolicyTrackedResourcesServerTransport) dispatchNewListQueryResultsForResourceGroupPager(req *http.Request) (*http.Response, error) {
	...
	if newListQueryResultsForResourceGroupPager == nil {
		...
		filterParam := getOptional(filterUnescaped)
		var options *armpolicyinsights.PolicyTrackedResourcesClientListQueryResultsForResourceGroupOptions
		if topParam != nil || filterParam != nil {
			options = &armpolicyinsights.PolicyTrackedResourcesClientListQueryResultsForResourceGroupOptions{
				Top:    topParam,
				Filter: filterParam,
			}
		}
		resp := p.srv.NewListQueryResultsForResourceGroupPager(resourceGroupNameParam, policyTrackedResourcesResourceParam, options)
...
func (p *PolicyTrackedResourcesServerTransport) dispatchNewListQueryResultsForSubscriptionPager(req *http.Request) (*http.Response, error) {
	...
	if newListQueryResultsForSubscriptionPager == nil {
		...
		filterParam := getOptional(filterUnescaped)
		var options *armpolicyinsights.PolicyTrackedResourcesClientListQueryResultsForSubscriptionOptions
		if topParam != nil || filterParam != nil {
			options = &armpolicyinsights.PolicyTrackedResourcesClientListQueryResultsForSubscriptionOptions{
				Top:    topParam,
				Filter: filterParam,
			}
		}
		resp := p.srv.NewListQueryResultsForSubscriptionPager(policyTrackedResourcesResourceParam, options)
