...
// Generated from example definition: 2024-10-01/PolicyRestrictions_CheckAtManagementGroupScope.json
func ExamplePolicyRestrictionsClient_CheckAtManagementGroupScope() {
	...
	// res = armpolicyinsights.PolicyRestrictionsClientCheckAtManagementGroupScopeResponse{
	// 	CheckRestrictionsResult: armpolicyinsights.CheckRestrictionsResult{
...
// Generated from example definition: 2024-10-01/PolicyRestrictions_CheckAtResourceGroupScope.json
func ExamplePolicyRestrictionsClient_CheckAtResourceGroupScope_checkPolicyRestrictionsAtResourceGroupScope() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armpolicyinsights.PolicyRestrictionsClientCheckAtResourceGroupScopeResponse{
	// 	CheckRestrictionsResult: armpolicyinsights.CheckRestrictionsResult{
	// 		ContentEvaluationResult: &armpolicyinsights.CheckRestrictionsResultContentEvaluationResult{
	// 			PolicyEvaluations: []*armpolicyinsights.PolicyEvaluationResult{
	// 				{
...
// Generated from example definition: 2024-10-01/PolicyRestrictions_CheckAtResourceGroupScopeIncludeAuditEffect.json
...
// Generated from example definition: 2024-10-01/PolicyRestrictions_CheckAtSubscriptionScope.json
func ExamplePolicyRestrictionsClient_CheckAtSubscriptionScope_checkPolicyRestrictionsAtSubscriptionScope() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armpolicyinsights.PolicyRestrictionsClientCheckAtSubscriptionScopeResponse{
	// 	CheckRestrictionsResult: armpolicyinsights.CheckRestrictionsResult{
	// 		ContentEvaluationResult: &armpolicyinsights.CheckRestrictionsResultContentEvaluationResult{
	// 			PolicyEvaluations: []*armpolicyinsights.PolicyEvaluationResult{
	// 				{
...
// Generated from example definition: 2024-10-01/PolicyRestrictions_CheckAtSubscriptionScopeIncludeAuditEffect.json
