...
// The returned ServerFactoryTransport instance is connected to an instance of armportal.ClientFactory via the
...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "TenantConfigurationsClient":
		initServer(s, &s.trTenantConfigurationsServer, func() *TenantConfigurationsServerTransport {
			return NewTenantConfigurationsServerTransport(&s.srv.TenantConfigurationsServer)
		})
		resp, err = s.trTenantConfigurationsServer.Do(req)
	default:
