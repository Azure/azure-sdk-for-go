...
Install the Azure Portalservicescopilot module:

```sh
go get github.com/Azure/azure-sdk-for-go/sdk/resourcemanager/portalservicescopilot/armportalservicescopilot
```
...
[open an issue](https://github.com/Azure/azure-sdk-for-go/issues) and assign the `Portalservicescopilot` label.
