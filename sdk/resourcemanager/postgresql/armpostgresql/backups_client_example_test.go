...
// Generated from example definition: https://github.com/Azure/azure-rest-api-specs/blob/1f22d4dbd99b0fe347ad79e79d4eb1ed44a87291/specification/postgresql/resource-manager/Microsoft.DBforPostgreSQL/stable/2022-12-01/examples/BackupGet.json
func ExampleBackupsClient_Get() {
	...
	// res.ServerBackup = armpostgresql.ServerBackup{
	...
	// 	Properties: &armpostgresql.ServerBackupProperties{
	// 		BackupType: to.Ptr(armpostgresql.OriginFull),
...
// Generated from example definition: https://github.com/Azure/azure-rest-api-specs/blob/1f22d4dbd99b0fe347ad79e79d4eb1ed44a87291/specification/postgresql/resource-manager/Microsoft.DBforPostgreSQL/stable/2022-12-01/examples/BackupListByServer.json
func ExampleBackupsClient_NewListByServerPager() {
	...
	for pager.More() {
		...
		// page.ServerBackupListResult = armpostgresql.ServerBackupListResult{
		// 	Value: []*armpostgresql.ServerBackup{
		// 		{
		// 			Name: to.Ptr("daily_20210615T160516"),
		// 			Type: to.Ptr("Microsoft.DBforPostgreSQL/flexibleServers/backups"),
		// 			ID: to.Ptr("/subscriptions/ffffffff-ffff-ffff-ffff-ffffffffffff/resourceGroups/TestGroup/providers/Microsoft.DBforPostgreSQL/flexibleServers/postgresqltestserver/backups/daily_20210615T160516"),
