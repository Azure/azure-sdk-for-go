...
type DatabasesServer struct {
	...
	BeginDelete	func(ctx context.Context, resourceGroupName string, serverName string, databaseName string, options *armpostgresql.DatabasesClientBeginDeleteOptions) (resp azfake.PollerResponder[armpostgresql.DatabasesClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method DatabasesClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get	func(ctx context.Context, resourceGroupName string, serverName string, databaseName string, options *armpostgresql.DatabasesClientGetOptions) (resp azfake.Responder[armpostgresql.DatabasesClientGetResponse], errResp azfake.ErrorResponder)

	// NewListByServerPager is the fake for method DatabasesClient.NewListByServerPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByServerPager	func(resourceGroupName string, serverName string, options *armpostgresql.DatabasesClientListByServerOptions) (resp azfake.PagerResponder[armpostgresql.DatabasesClientListByServerResponse])
}

// NewDatabasesServerTransport creates a new instance of DatabasesServerTransport with the provided implementation.
// The returned DatabasesServerTransport instance is connected to an instance of armpostgresql.DatabasesClient via the
...
// DatabasesServerTransport connects instances of armpostgresql.DatabasesClient to instances of DatabasesServer.
...
func (d *DatabasesServerTransport) dispatchBeginCreate(req *http.Request) (*http.Response, error) {
	...
	if beginCreate == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armpostgresql.Database](req)
		if err != nil {
			return nil, err
		}
