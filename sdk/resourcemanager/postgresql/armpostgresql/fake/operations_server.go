...
type OperationsServer struct {
	...
	NewListPager func(options *armpostgresql.OperationsClientListOptions) (resp azfake.PagerResponder[armpostgresql.OperationsClientListResponse])
}
...
func NewOperationsServerTransport(srv *OperationsServer) *OperationsServerTransport {
	return &OperationsServerTransport{
		srv:          srv,
		newListPager: newTracker[azfake.PagerResponder[armpostgresql.OperationsClientListResponse]](),
	}
}
...
type OperationsServerTransport struct {
	...
	newListPager *tracker[azfake.PagerResponder[armpostgresql.OperationsClientListResponse]]
}
...
func (o *OperationsServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armpostgresql.OperationsClientListResponse, createLink func() string) {
