...
type ServersServer struct {
	...
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginMigrateNetworkMode	func(ctx context.Context, resourceGroupName string, serverName string, options *armpostgresql.ServersClientBeginMigrateNetworkModeOptions) (resp azfake.PollerResponder[armpostgresql.ServersClientMigrateNetworkModeResponse], errResp azfake.ErrorResponder)
...
func NewServersServerTransport(srv *ServersServer) *ServersServerTransport {
	return &ServersServerTransport{
		...
		beginMigrateNetworkMode:	newTracker[azfake.PollerResponder[armpostgresql.ServersClientMigrateNetworkModeResponse]](),
...
type ServersServerTransport struct {
	...
	beginMigrateNetworkMode		*tracker[azfake.PollerResponder[armpostgresql.ServersClientMigrateNetworkModeResponse]]
