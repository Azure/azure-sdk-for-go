...
type VirtualNetworkSubnetUsageServer struct {
	...
	List func(ctx context.Context, locationName string, parameters armpostgresql.VirtualNetworkSubnetUsageParameter, options *armpostgresql.VirtualNetworkSubnetUsageClientListOptions) (resp azfake.Responder[armpostgresql.VirtualNetworkSubnetUsageClientListResponse], errResp azfake.ErrorResponder)
}
