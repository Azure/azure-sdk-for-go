...
//   - parameters - Parameters required for creating or updating a firewall rule.
...
// BeginDelete - Deletes an existing firewall rule.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2025-08-01
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
...
// Get - Gets information about a firewall rule in a server.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2025-08-01
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
...
// NewListByServerPager - Lists information about all firewall rules in a server.
//
// Generated from API version 2025-08-01
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - serverName - The name of the server.
...
func (client *FirewallRulesClient) listByServerHandleResponse(resp *http.Response) (FirewallRulesClientListByServerResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.FirewallRuleList); err != nil {
		return FirewallRulesClientListByServerResponse{}, err
	}
	return result, nil
}
