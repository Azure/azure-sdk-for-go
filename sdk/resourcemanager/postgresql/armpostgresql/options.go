...
// ServersClientBeginMigrateNetworkModeOptions contains the optional parameters for the ServersClient.BeginMigrateNetworkMode
// method.
type ServersClientBeginMigrateNetworkModeOptions struct {
	// Resumes the long-running operation from the provided token.
	ResumeToken string
}
