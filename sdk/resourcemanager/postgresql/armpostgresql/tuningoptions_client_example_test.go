...
func ExampleTuningOptionsClient_Get() {
	...
	res, err := clientFactory.NewTuningOptionsClient().Get(ctx, "exampleresourcegroup", "exampleserver", armpostgresql.TuningOptionIndex, nil)
	if err != nil {
...
func ExampleTuningOptionsClient_NewListRecommendationsPager_listAvailableIndexRecommendations() {
	...
	pager := clientFactory.NewTuningOptionsClient().NewListRecommendationsPager("exampleresourcegroup", "exampleserver", armpostgresql.TuningOptionIndex, nil)
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
		...
		// 					RecommendationType: to.Ptr(armpostgresql.RecommendationTypeCreateIndex),
...
func ExampleTuningOptionsClient_NewListRecommendationsPager_listAvailableIndexRecommendationsFilteredToExclusivelyGetThoseOfCreateIndexType() {
	...
	pager := clientFactory.NewTuningOptionsClient().NewListRecommendationsPager("exampleresourcegroup", "exampleserver", armpostgresql.TuningOptionIndex, &armpostgresql.TuningOptionsClientListRecommendationsOptions{
		RecommendationType: to.Ptr(armpostgresql.RecommendationTypeCreateIndex)})
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
...
func ExampleTuningOptionsClient_NewListRecommendationsPager_listAvailableTableRecommendations() {
	...
	pager := clientFactory.NewTuningOptionsClient().NewListRecommendationsPager("exampleresourcegroup", "exampleserver", armpostgresql.TuningOptionTable, nil)
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
		...
		// 					RecommendationType: to.Ptr(armpostgresql.RecommendationType("Analyze")),
		// 					TimesRecommended: to.Ptr[int32](1),
		// 					Details: &armpostgresql.ObjectRecommendationDetails{
		// 						Schema: to.Ptr("public"),
...
func ExampleTuningOptionsClient_NewListRecommendationsPager_listAvailableTableRecommendationsFilteredToExclusivelyGetThoseOfAnalyzeTableType() {
	...
	pager := clientFactory.NewTuningOptionsClient().NewListRecommendationsPager("exampleresourcegroup", "exampleserver", armpostgresql.TuningOptionTable, &armpostgresql.TuningOptionsClientListRecommendationsOptions{
		RecommendationType: to.Ptr(armpostgresql.RecommendationTypeAnalyzeTable)})
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
