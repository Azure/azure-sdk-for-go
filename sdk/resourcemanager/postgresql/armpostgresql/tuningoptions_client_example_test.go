...
// Generated from example definition: 2025-08-01/TuningOptionsGet.json
func ExampleTuningOptionsClient_Get() {
	...
	// res = armpostgresql.TuningOptionsClientGetResponse{
	// 	TuningOptions: &armpostgresql.TuningOptions{
	// 		Name: to.Ptr("index"),
...
// Generated from example definition: 2025-08-01/TuningOptionsListByServer.json
func ExampleTuningOptionsClient_NewListByServerPager() {
	...
	for pager.More() {
		...
		// page = armpostgresql.TuningOptionsClientListByServerResponse{
		// 	TuningOptionsList: armpostgresql.TuningOptionsList{
...
// Generated from example definition: 2025-08-01/TuningOptionsListIndexRecommendations.json
func ExampleTuningOptionsClient_NewListRecommendationsPager_listAvailableIndexRecommendations() {
	...
	pager := clientFactory.NewTuningOptionsClient().NewListRecommendationsPager("exampleresourcegroup", "exampleserver", armpostgresql.TuningOptionParameterEnumIndex, nil)
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armpostgresql.TuningOptionsClientListRecommendationsResponse{
		// 	ObjectRecommendationList: armpostgresql.ObjectRecommendationList{
...
// Generated from example definition: 2025-08-01/TuningOptionsListIndexRecommendationsFilteredForCreateIndex.json
func ExampleTuningOptionsClient_NewListRecommendationsPager_listAvailableIndexRecommendationsFilteredToExclusivelyGetThoseOfCreateIndexType() {
	...
	pager := clientFactory.NewTuningOptionsClient().NewListRecommendationsPager("exampleresourcegroup", "exampleserver", armpostgresql.TuningOptionParameterEnumIndex, &armpostgresql.TuningOptionsClientListRecommendationsOptions{
		RecommendationType: to.Ptr(armpostgresql.RecommendationTypeParameterEnumCreateIndex)})
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
...
// Generated from example definition: 2025-08-01/TuningOptionsListTableRecommendations.json
func ExampleTuningOptionsClient_NewListRecommendationsPager_listAvailableTableRecommendations() {
	...
	pager := clientFactory.NewTuningOptionsClient().NewListRecommendationsPager("exampleresourcegroup", "exampleserver", armpostgresql.TuningOptionParameterEnumTable, nil)
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
...
// Generated from example definition: 2025-08-01/TuningOptionsListTableRecommendationsFilteredForAnalyzeTable.json
func ExampleTuningOptionsClient_NewListRecommendationsPager_listAvailableTableRecommendationsFilteredToExclusivelyGetThoseOfAnalyzeTableType() {
	...
	pager := clientFactory.NewTuningOptionsClient().NewListRecommendationsPager("exampleresourcegroup", "exampleserver", armpostgresql.TuningOptionParameterEnumTable, &armpostgresql.TuningOptionsClientListRecommendationsOptions{
		RecommendationType: to.Ptr(armpostgresql.RecommendationTypeParameterEnumAnalyzeTable)})
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
