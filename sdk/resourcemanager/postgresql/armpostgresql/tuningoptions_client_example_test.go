...
// Generated from example definition: https://github.com/Azure/azure-rest-api-specs/blob/3cb112813fdd81db3df0256920fab55a4c733032/specification/postgresql/resource-manager/Microsoft.DBforPostgreSQL/stable/2025-08-01/examples/TuningOptionsGet.json
func ExampleTuningOptionsClient_Get() {
	...
	res, err := clientFactory.NewTuningOptionsClient().Get(ctx, "exampleresourcegroup", "exampleserver", armpostgresql.TuningOptionParameterEnumIndex, nil)
	if err != nil {
	...
	// res.TuningOptions = armpostgresql.TuningOptions{
	// 	Name: to.Ptr("index"),
...
// Generated from example definition: https://github.com/Azure/azure-rest-api-specs/blob/3cb112813fdd81db3df0256920fab55a4c733032/specification/postgresql/resource-manager/Microsoft.DBforPostgreSQL/stable/2025-08-01/examples/TuningOptionsListIndexRecommendationsFilteredForCreateIndex.json
func ExampleTuningOptionsClient_NewListRecommendationsPager_listAvailableIndexRecommendationsFilteredToExclusivelyGetThoseOfCreateIndexType() {
	...
	pager := clientFactory.NewTuningOptionsClient().NewListRecommendationsPager("exampleresourcegroup", "exampleserver", armpostgresql.TuningOptionParameterEnumIndex, &armpostgresql.TuningOptionsClientListRecommendationsOptions{RecommendationType: to.Ptr(armpostgresql.RecommendationTypeParameterEnumCreateIndex)})
	for pager.More() {
		...
		// page.ObjectRecommendationList = armpostgresql.ObjectRecommendationList{
		// 	Value: []*armpostgresql.ObjectRecommendation{
		// 		{
		...
		// 			Kind: to.Ptr(""),
		// 			Properties: &armpostgresql.ObjectRecommendationProperties{
		// 				AnalyzedWorkload: &armpostgresql.ObjectRecommendationPropertiesAnalyzedWorkload{
		...
		// 				},
		// 				EstimatedImpact: []*armpostgresql.ImpactRecord{
		// 					{
		...
		// 						Unit: to.Ptr("Percentage"),
		// 				}},
		// 				ImplementationDetails: &armpostgresql.ObjectRecommendationPropertiesImplementationDetails{
		// 					Method: to.Ptr("SQL"),
		...
		// 					RecommendationType: to.Ptr(armpostgresql.RecommendationTypeEnumCreateIndex),
		// 					TimesRecommended: to.Ptr[int32](1),
		// 					Details: &armpostgresql.ObjectRecommendationDetails{
...
// Generated from example definition: https://github.com/Azure/azure-rest-api-specs/blob/3cb112813fdd81db3df0256920fab55a4c733032/specification/postgresql/resource-manager/Microsoft.DBforPostgreSQL/stable/2025-08-01/examples/TuningOptionsListIndexRecommendations.json
func ExampleTuningOptionsClient_NewListRecommendationsPager_listAvailableIndexRecommendations() {
	...
	pager := clientFactory.NewTuningOptionsClient().NewListRecommendationsPager("exampleresourcegroup", "exampleserver", armpostgresql.TuningOptionParameterEnumIndex, &armpostgresql.TuningOptionsClientListRecommendationsOptions{RecommendationType: nil})
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
...
// Generated from example definition: https://github.com/Azure/azure-rest-api-specs/blob/3cb112813fdd81db3df0256920fab55a4c733032/specification/postgresql/resource-manager/Microsoft.DBforPostgreSQL/stable/2025-08-01/examples/TuningOptionsListTableRecommendationsFilteredForAnalyzeTable.json
func ExampleTuningOptionsClient_NewListRecommendationsPager_listAvailableTableRecommendationsFilteredToExclusivelyGetThoseOfAnalyzeTableType() {
	...
	pager := clientFactory.NewTuningOptionsClient().NewListRecommendationsPager("exampleresourcegroup", "exampleserver", armpostgresql.TuningOptionParameterEnumTable, &armpostgresql.TuningOptionsClientListRecommendationsOptions{RecommendationType: to.Ptr(armpostgresql.RecommendationTypeParameterEnumAnalyzeTable)})
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
		...
		// 					RecommendationType: to.Ptr(armpostgresql.RecommendationTypeEnum("Analyze")),
		// 					TimesRecommended: to.Ptr[int32](1),
		// 					Details: &armpostgresql.ObjectRecommendationDetails{
		// 						Schema: to.Ptr("public"),
...
// Generated from example definition: https://github.com/Azure/azure-rest-api-specs/blob/3cb112813fdd81db3df0256920fab55a4c733032/specification/postgresql/resource-manager/Microsoft.DBforPostgreSQL/stable/2025-08-01/examples/TuningOptionsListTableRecommendations.json
func ExampleTuningOptionsClient_NewListRecommendationsPager_listAvailableTableRecommendations() {
	...
	pager := clientFactory.NewTuningOptionsClient().NewListRecommendationsPager("exampleresourcegroup", "exampleserver", armpostgresql.TuningOptionParameterEnumTable, &armpostgresql.TuningOptionsClientListRecommendationsOptions{RecommendationType: nil})
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
...
// Generated from example definition: https://github.com/Azure/azure-rest-api-specs/blob/3cb112813fdd81db3df0256920fab55a4c733032/specification/postgresql/resource-manager/Microsoft.DBforPostgreSQL/stable/2025-08-01/examples/TuningOptionsListByServer.json
func ExampleTuningOptionsClient_NewListByServerPager() {
	...
	for pager.More() {
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page.TuningOptionsList = armpostgresql.TuningOptionsList{
		// 	Value: []*armpostgresql.TuningOptions{
		// 		{
		// 			Name: to.Ptr("index"),
		// 			Type: to.Ptr("Microsoft.DBforPostgreSQL/flexibleServers/tuningoptions"),
		// 			ID: to.Ptr("/subscriptions/ffffffff-ffff-ffff-ffff-ffffffffffff/resourceGroups/exampleresourcegroup/providers/Microsoft.DBforPostgreSQL/flexibleServers/exampleserver/tuningoptions/index"),
