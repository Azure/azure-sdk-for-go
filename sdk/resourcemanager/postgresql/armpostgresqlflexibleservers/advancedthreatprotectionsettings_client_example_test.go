...
func ExampleAdvancedThreatProtectionSettingsClient_NewListByServerPager() {
	...
	for pager.More() {
		...
		// page = armpostgresqlflexibleservers.AdvancedThreatProtectionSettingsClientListByServerResponse{
		// 	AdvancedThreatProtectionSettingsList: armpostgresqlflexibleservers.AdvancedThreatProtectionSettingsList{
