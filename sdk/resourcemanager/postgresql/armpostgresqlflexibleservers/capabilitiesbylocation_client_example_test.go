...
// Generated from example definition: 2026-01-01-preview/CapabilitiesByLocationList.json
func ExampleCapabilitiesByLocationClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armpostgresqlflexibleservers.CapabilitiesByLocationClientListResponse{
		// 	CapabilityList: armpostgresqlflexibleservers.CapabilityList{
