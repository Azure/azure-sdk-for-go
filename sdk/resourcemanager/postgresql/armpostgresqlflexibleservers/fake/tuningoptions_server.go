...
type TuningOptionsServer struct {
	...
	Get func(ctx context.Context, resourceGroupName string, serverName string, tuningOption armpostgresqlflexibleservers.TuningOptionParameterEnum, options *armpostgresqlflexibleservers.TuningOptionsClientGetOptions) (resp azfake.Responder[armpostgresqlflexibleservers.TuningOptionsClientGetResponse], errResp azfake.ErrorResponder)
...
func (t *TuningOptionsServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	tuningOptionParam, err := parseWithCast(matches[regex.SubexpIndex("tuningOption")], func(v string) (armpostgresqlflexibleservers.TuningOptionParameterEnum, error) {
		p, unescapeErr := url.PathUnescape(v)
		if unescapeErr != nil {
			return "", unescapeErr
		}
		return armpostgresqlflexibleservers.TuningOptionParameterEnum(p), nil
	})
	if err != nil {
		return nil, err
	}
...
func (t *TuningOptionsServerTransport) dispatchNewListRecommendationsPager(req *http.Request) (*http.Response, error) {
	...
	if newListRecommendationsPager == nil {
		...
		recommendationTypeParam := getOptional(armpostgresqlflexibleservers.RecommendationTypeParameterEnum(recommendationTypeUnescaped))
