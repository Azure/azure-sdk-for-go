...
func ExampleMigrationsClient_NewListByTargetServerPager() {
	...
	pager := clientFactory.NewMigrationsClient().NewListByTargetServerPager("exampleresourcegroup", "exampleserver", &armpostgresqlflexibleservers.MigrationsClientListByTargetServerOptions{
		MigrationListFilter: to.Ptr(armpostgresqlflexibleservers.MigrationListFilterAll)})
	for pager.More() {
		...
		// page = armpostgresqlflexibleservers.MigrationsClientListByTargetServerResponse{
		// 	MigrationList: armpostgresqlflexibleservers.MigrationList{
