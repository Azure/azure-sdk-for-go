...
func ExamplePrivateLinkResourcesClient_NewListByServerPager() {
	...
	for pager.More() {
		...
		// page = armpostgresqlflexibleservers.PrivateLinkResourcesClientListByServerResponse{
		// 	PrivateLinkResourceList: armpostgresqlflexibleservers.PrivateLinkResourceList{
