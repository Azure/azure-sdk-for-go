...
func (client *TuningOptionsClient) Get(ctx context.Context, resourceGroupName string, serverName string, tuningOption TuningOption, options *TuningOptionsClientGetOptions) (TuningOptionsClientGetResponse, error) {
	var err error
...
func (client *TuningOptionsClient) getCreateRequest(ctx context.Context, resourceGroupName string, serverName string, tuningOption TuningOption, _ *TuningOptionsClientGetOptions) (*policy.Request, error) {
...
//     method.
func (client *TuningOptionsClient) NewListRecommendationsPager(resourceGroupName string, serverName string, tuningOption TuningOption, options *TuningOptionsClientListRecommendationsOptions) *runtime.Pager[TuningOptionsClientListRecommendationsResponse] {
...
func (client *TuningOptionsClient) listRecommendationsCreateRequest(ctx context.Context, resourceGroupName string, serverName string, tuningOption TuningOption, options *TuningOptionsClientListRecommendationsOptions) (*policy.Request, error) {
