...
// Generated from example definition: https://github.com/Azure/azure-rest-api-specs/blob/b0014d135f949a3db605b0b0999206f077acedd1/specification/postgresql/resource-manager/Microsoft.DBforPostgreSQL/preview/2024-11-01-preview/examples/Tuning_GetTuningOption.json
...
// Generated from example definition: https://github.com/Azure/azure-rest-api-specs/blob/b0014d135f949a3db605b0b0999206f077acedd1/specification/postgresql/resource-manager/Microsoft.DBforPostgreSQL/preview/2024-11-01-preview/examples/Tuning_GetFilteredRecommendedIndexes.json
func ExampleTuningOptionsClient_NewListRecommendationsPager_tuningOptionsListFilteredRecommendations() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	pager := clientFactory.NewTuningOptionsClient().NewListRecommendationsPager("testrg", "pgtestrecs", armpostgresqlflexibleservers.TuningOptionEnumIndex, &armpostgresqlflexibleservers.TuningOptionsClientListRecommendationsOptions{RecommendationType: to.Ptr(armpostgresqlflexibleservers.RecommendationTypeCreateIndex)})
	for pager.More() {
		...
		// 						IndexColumns: to.Ptr("\"partsupp\".\"ps_suppkey\""),
		...
		// 							Schema: to.Ptr("public"),
		// 							DatabaseName: to.Ptr("ecommerce"),
		// 							IndexColumns: to.Ptr("\"partsupp\".\"ps_partkey\""),
...
// Generated from example definition: https://github.com/Azure/azure-rest-api-specs/blob/b0014d135f949a3db605b0b0999206f077acedd1/specification/postgresql/resource-manager/Microsoft.DBforPostgreSQL/preview/2024-11-01-preview/examples/Tuning_GetRecommendedIndexes.json
func ExampleTuningOptionsClient_NewListRecommendationsPager_tuningOptionsListRecommendations() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	pager := clientFactory.NewTuningOptionsClient().NewListRecommendationsPager("testrg", "pgtestsvc4", armpostgresqlflexibleservers.TuningOptionEnumIndex, &armpostgresqlflexibleservers.TuningOptionsClientListRecommendationsOptions{RecommendationType: nil})
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
		...
		// 						Schema: to.Ptr("public"),
		// 						DatabaseName: to.Ptr("ecommerce"),
		// 						IndexColumns: to.Ptr("\"customer\".\"c_custkey\""),
		...
		// 							Schema: to.Ptr("public"),
		// 							DatabaseName: to.Ptr("ecommerce"),
		// 							IndexColumns: to.Ptr("\"lineitem\".\"l_orderkey\""),
		...
		// 								Schema: to.Ptr("public"),
		// 								DatabaseName: to.Ptr("ecommerce"),
		// 								IndexColumns: to.Ptr("\"lineitem\".\"l_orderkey\";\"lineitem\".\"l_shipdate\""),
...
// Generated from example definition: https://github.com/Azure/azure-rest-api-specs/blob/b0014d135f949a3db605b0b0999206f077acedd1/specification/postgresql/resource-manager/Microsoft.DBforPostgreSQL/preview/2024-11-01-preview/examples/Tuning_ListTuningOptions.json
