...
// ConfigurationsClientPutPoller provides polling facilities until the operation reaches a terminal state.
type ConfigurationsClientPutPoller struct {
	pt *azcore.Poller
}

// Done returns true if the LRO has reached a terminal state.
func (p *ConfigurationsClientPutPoller) Done() bool {
	return p.pt.Done()
}
...
func (p *ConfigurationsClientPutPoller) Poll(ctx context.Context) (*http.Response, error) {
	return p.pt.Poll(ctx)
}

// FinalResponse performs a final GET to the service and returns the final response
// for the polling operation. If there is an error performing the final GET then an error is returned.
// If the final GET succeeded then the final ConfigurationsClientPutResponse will be returned.
func (p *ConfigurationsClientPutPoller) FinalResponse(ctx context.Context) (ConfigurationsClientPutResponse, error) {
	respType := ConfigurationsClientPutResponse{}
	resp, err := p.pt.FinalResponse(ctx, &respType.Configuration)
	if err != nil {
		return ConfigurationsClientPutResponse{}, err
	}
...
func (p *ConfigurationsClientPutPoller) ResumeToken() (string, error) {
