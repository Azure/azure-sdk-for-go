...
// PrivateEndpointConnectionsServer is a fake server for instances of the armpostgresqlhsc.PrivateEndpointConnectionsClient type.
type PrivateEndpointConnectionsServer struct {
	// BeginCreateOrUpdate is the fake for method PrivateEndpointConnectionsClient.BeginCreateOrUpdate
	// HTTP status codes to indicate success: http.StatusOK, http.StatusCreated
	BeginCreateOrUpdate func(ctx context.Context, resourceGroupName string, clusterName string, privateEndpointConnectionName string, parameters armpostgresqlhsc.PrivateEndpointConnection, options *armpostgresqlhsc.PrivateEndpointConnectionsClientBeginCreateOrUpdateOptions) (resp azfake.PollerResponder[armpostgresqlhsc.PrivateEndpointConnectionsClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)

	// BeginDelete is the fake for method PrivateEndpointConnectionsClient.BeginDelete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginDelete func(ctx context.Context, resourceGroupName string, clusterName string, privateEndpointConnectionName string, options *armpostgresqlhsc.PrivateEndpointConnectionsClientBeginDeleteOptions) (resp azfake.PollerResponder[armpostgresqlhsc.PrivateEndpointConnectionsClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method PrivateEndpointConnectionsClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, clusterName string, privateEndpointConnectionName string, options *armpostgresqlhsc.PrivateEndpointConnectionsClientGetOptions) (resp azfake.Responder[armpostgresqlhsc.PrivateEndpointConnectionsClientGetResponse], errResp azfake.ErrorResponder)

	// NewListByClusterPager is the fake for method PrivateEndpointConnectionsClient.NewListByClusterPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByClusterPager func(resourceGroupName string, clusterName string, options *armpostgresqlhsc.PrivateEndpointConnectionsClientListByClusterOptions) (resp azfake.PagerResponder[armpostgresqlhsc.PrivateEndpointConnectionsClientListByClusterResponse])
}
...
// The returned PrivateEndpointConnectionsServerTransport instance is connected to an instance of armpostgresqlhsc.PrivateEndpointConnectionsClient via the
// azcore.ClientOptions.Transporter field in the client's constructor parameters.
func NewPrivateEndpointConnectionsServerTransport(srv *PrivateEndpointConnectionsServer) *PrivateEndpointConnectionsServerTransport {
	return &PrivateEndpointConnectionsServerTransport{
		srv:                   srv,
		beginCreateOrUpdate:   newTracker[azfake.PollerResponder[armpostgresqlhsc.PrivateEndpointConnectionsClientCreateOrUpdateResponse]](),
		beginDelete:           newTracker[azfake.PollerResponder[armpostgresqlhsc.PrivateEndpointConnectionsClientDeleteResponse]](),
		newListByClusterPager: newTracker[azfake.PagerResponder[armpostgresqlhsc.PrivateEndpointConnectionsClientListByClusterResponse]](),
	}
}

// PrivateEndpointConnectionsServerTransport connects instances of armpostgresqlhsc.PrivateEndpointConnectionsClient to instances of PrivateEndpointConnectionsServer.
...
type PrivateEndpointConnectionsServerTransport struct {
	...
	beginCreateOrUpdate   *tracker[azfake.PollerResponder[armpostgresqlhsc.PrivateEndpointConnectionsClientCreateOrUpdateResponse]]
	beginDelete           *tracker[azfake.PollerResponder[armpostgresqlhsc.PrivateEndpointConnectionsClientDeleteResponse]]
	newListByClusterPager *tracker[azfake.PagerResponder[armpostgresqlhsc.PrivateEndpointConnectionsClientListByClusterResponse]]
}
...
func (p *PrivateEndpointConnectionsServerTransport) dispatchBeginCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginCreateOrUpdate == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.DBforPostgreSQL/serverGroupsv2/(?P<clusterName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/privateEndpointConnections/(?P<privateEndpointConnectionName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 5 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
		}
		body, err := server.UnmarshalRequestAsJSON[armpostgresqlhsc.PrivateEndpointConnection](req)
		if err != nil {
			return nil, err
		}
...
func (p *PrivateEndpointConnectionsServerTransport) dispatchNewListByClusterPager(req *http.Request) (*http.Response, error) {
	...
	if newListByClusterPager == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.DBforPostgreSQL/serverGroupsv2/(?P<clusterName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/privateEndpointConnections`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 4 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
		...
		server.PagerResponderInjectNextLinks(newListByClusterPager, req, func(page *armpostgresqlhsc.PrivateEndpointConnectionsClientListByClusterResponse, createLink func() string) {
