...
func (c ClusterProperties) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "earliestRestoreTime", c.EarliestRestoreTime, true)
...
func (c *ClusterProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "earliestRestoreTime":
			err = unpopulateTime[datetime.RFC3339](val, "EarliestRestoreTime", &c.EarliestRestoreTime)
			delete(rawMsg, key)
