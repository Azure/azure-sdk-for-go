...
// BeginCreateOrUpdate - Approves or Rejects a private endpoint connection with a given name.
...
// CreateOrUpdate - Approves or Rejects a private endpoint connection with a given name.
// If the operation fails it returns an *azcore.ResponseError type.
...
func (client *PrivateEndpointConnectionsClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, clusterName string, privateEndpointConnectionName string, parameters PrivateEndpointConnection, _ *PrivateEndpointConnectionsClientBeginCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *PrivateEndpointConnectionsClient) NewListByClusterPager(resourceGroupName string, clusterName string, options *PrivateEndpointConnectionsClientListByClusterOptions) *runtime.Pager[PrivateEndpointConnectionsClientListByClusterResponse] {
	return runtime.NewPager(runtime.PagingHandler[PrivateEndpointConnectionsClientListByClusterResponse]{
		...
		Fetcher: func(ctx context.Context, page *PrivateEndpointConnectionsClientListByClusterResponse) (PrivateEndpointConnectionsClientListByClusterResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "PrivateEndpointConnectionsClient.NewListByClusterPager")
			nextLink := ""
			if page != nil {
...
func (client *PrivateEndpointConnectionsClient) listByClusterCreateRequest(ctx context.Context, resourceGroupName string, clusterName string, nextLink string, _ *PrivateEndpointConnectionsClientListByClusterOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *PrivateEndpointConnectionsClient) listByClusterHandleResponse(resp *http.Response, successCodes ...int) (PrivateEndpointConnectionsClientListByClusterResponse, error) {
