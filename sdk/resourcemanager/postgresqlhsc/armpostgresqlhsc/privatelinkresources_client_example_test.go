...
func ExamplePrivateLinkResourcesClient_NewListByClusterPager() {
	...
	for pager.More() {
		...
		// page = armpostgresqlhsc.PrivateLinkResourcesClientListByClusterResponse{
		// 	PrivateLinkResourceListResult: armpostgresqlhsc.PrivateLinkResourceListResult{
		// 		Value: []*armpostgresqlhsc.PrivateLinkResource{
		// 			{
