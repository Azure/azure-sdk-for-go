...
func (client *ServersClient) listByClusterCreateRequest(ctx context.Context, resourceGroupName string, clusterName string, nextLink string, _ *ServersClientListByClusterOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *ServersClient) listByClusterHandleResponse(resp *http.Response, successCodes ...int) (ServersClientListByClusterResponse, error) {
