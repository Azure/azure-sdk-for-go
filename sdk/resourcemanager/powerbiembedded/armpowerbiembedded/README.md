...
```go
client, err := armpowerbiembedded.NewWorkspaceCollectionsClient(<subscription ID>, cred, nil)
```
...
client, err := armpowerbiembedded.NewWorkspaceCollectionsClient(<subscription ID>, cred, &options)
```
