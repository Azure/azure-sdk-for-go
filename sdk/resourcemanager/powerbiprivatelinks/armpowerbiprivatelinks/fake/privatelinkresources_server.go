...
// The returned PrivateLinkResourcesServerTransport instance is connected to an instance of armpowerbiprivatelinks.PrivateLinkResourcesClient via the
// azcore.ClientOptions.Transporter field in the client's constructor parameters.
func NewPrivateLinkResourcesServerTransport(srv *PrivateLinkResourcesServer) *PrivateLinkResourcesServerTransport {
	return &PrivateLinkResourcesServerTransport{
		srv:                    srv,
		newListByResourcePager: newTracker[azfake.PagerResponder[armpowerbiprivatelinks.PrivateLinkResourcesClientListByResourceResponse]](),
	}
}

// PrivateLinkResourcesServerTransport connects instances of armpowerbiprivatelinks.PrivateLinkResourcesClient to instances of PrivateLinkResourcesServer.
// Don't use this type directly, use NewPrivateLinkResourcesServerTransport instead.
type PrivateLinkResourcesServerTransport struct {
	srv                    *PrivateLinkResourcesServer
	newListByResourcePager *tracker[azfake.PagerResponder[armpowerbiprivatelinks.PrivateLinkResourcesClientListByResourceResponse]]
}
...
func (p *PrivateLinkResourcesServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.PowerBI/privateLinkServicesForPowerBI/(?P<azureResourceName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/privateLinkResources/(?P<privateLinkResourceName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)`
	...
	respr, errRespr := p.srv.Get(req.Context(), resourceGroupNameParam, azureResourceNameParam, privateLinkResourceNameParam, nil)
...
func (p *PrivateLinkResourcesServerTransport) dispatchNewListByResourcePager(req *http.Request) (*http.Response, error) {
	...
	if newListByResourcePager == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.PowerBI/privateLinkServicesForPowerBI/(?P<azureResourceName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/privateLinkResources`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		...
		server.PagerResponderInjectNextLinks(newListByResourcePager, req, func(page *armpowerbiprivatelinks.PrivateLinkResourcesClientListByResourceResponse, createLink func() string) {
