...
// Generated from example definition: 2020-10-30-preview/listOperations.json
func ExampleOperationsClient_NewListPager() {
	...
	clientFactory, err := armpowerplatform.NewClientFactory("<subscriptionID>", cred, nil)
	if err != nil {
	...
	for pager.More() {
		...
		// page = armpowerplatform.OperationsClientListResponse{
		// 	OperationListResult: armpowerplatform.OperationListResult{
