...
func ExampleAlertsManagementClient_PreviewAlertRule() {
	...
	res, err := clientFactory.NewAlertsManagementClient().PreviewAlertRule(ctx, "subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/myResourceGroup/providers/Microsoft.OperationalInsights/workspaces/myWorkspace", armpreviewalertrule.Request{
		...
		Properties: &armpreviewalertrule.RequestProperties{
			ScheduledQueryRuleProperties: &armpreviewalertrule.LogAlertRuleResource{
				...
				Properties: &armpreviewalertrule.LogAlertRuleProperties{
					...
					Severity:   to.Ptr(armpreviewalertrule.AlertSeverity4),
	...
	// res = armpreviewalertrule.AlertsManagementClientPreviewAlertRuleResponse{
