...
func (e EvaluatedPeriod) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "timestamp", e.Timestamp, true)
	return json.Marshal(objectMap)
}
...
func (e Evaluation) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "evaluationTime", e.EvaluationTime, true)
	populate(objectMap, "thresholdMet", e.ThresholdMet)
	return json.Marshal(objectMap)
}
...
func (e *Evaluation) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "evaluatedPeriods":
			...
			delete(rawMsg, key)
		case "evaluationTime":
			err = unpopulateTime[datetime.RFC3339](val, "EvaluationTime", &e.EvaluationTime)
			delete(rawMsg, key)
		case "thresholdMet":
			err = unpopulate(val, "ThresholdMet", &e.ThresholdMet)
			delete(rawMsg, key)
...
func (l LogAlertRuleCondition) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "ignoreDataBefore", l.IgnoreDataBefore, true)
...
func (l *LogAlertRuleCondition) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "ignoreDataBefore":
			err = unpopulateTime[datetime.RFC3339](val, "IgnoreDataBefore", &l.IgnoreDataBefore)
			delete(rawMsg, key)
