...
// OperationClient contains the methods for the ProfessionalServiceOperation group.
...
func (client *OperationClient) getCreateRequest(ctx context.Context, operationID string, options *OperationClientBeginGetOptions) (*policy.Request, error) {
	urlPath := "/providers/Microsoft.ProfessionalService/operationResults/{operationId}"
	if operationID == "" {
