...
// NewListPager - Gets all ProfessionalService app operations.
//
...
func (client *OperationsClient) listCreateRequest(ctx context.Context, options *OperationsClientListOptions) (*policy.Request, error) {
	urlPath := "/providers/Microsoft.ProfessionalService/operations"
...
func (client *OperationsClient) listHandleResponse(resp *http.Response) (OperationsClientListResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.AppOperationsResponseWithContinuation); err != nil {
		return OperationsClientListResponse{}, err
	}
	return result, nil
}
