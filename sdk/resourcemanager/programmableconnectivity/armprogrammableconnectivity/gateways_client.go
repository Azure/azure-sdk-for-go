...
func (client *GatewaysClient) listByResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, nextLink string, _ *GatewaysClientListByResourceGroupOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *GatewaysClient) listByResourceGroupHandleResponse(resp *http.Response, successCodes ...int) (GatewaysClientListByResourceGroupResponse, error) {
...
func (client *GatewaysClient) listBySubscriptionCreateRequest(ctx context.Context, nextLink string, _ *GatewaysClientListBySubscriptionOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
	var req *policy.Request
	var err error
	if firstPage {
...
func (client *GatewaysClient) listBySubscriptionHandleResponse(resp *http.Response, successCodes ...int) (GatewaysClientListBySubscriptionResponse, error) {
...
func (client *GatewaysClient) updateHandleResponse(resp *http.Response, successCodes ...int) (GatewaysClientUpdateResponse, error) {
