...
- Function `*Client.CheckinManifest` has been removed
- Function `*Client.GenerateManifest` has been removed
...
- New function `*ClientFactory.NewOperationsPutContentsClient() *OperationsPutContentsClient`
- New function `NewOperationsPutContentsClient(subscriptionID string, credential azcore.TokenCredential, options *arm.ClientOptions) (*OperationsPutContentsClient, error)`
- New function `*OperationsPutContentsClient.CreateOrUpdate(ctx context.Context, providerNamespace string, operationsPutContent OperationsPutContent, options *OperationsPutContentsClientCreateOrUpdateOptions) (OperationsPutContentsClientCreateOrUpdateResponse, error)`
- New function `*OperationsPutContentsClient.Delete(ctx context.Context, providerNamespace string, options *OperationsPutContentsClientDeleteOptions) (OperationsPutContentsClientDeleteResponse, error)`
- New function `*OperationsPutContentsClient.ListByProviderRegistration(ctx context.Context, providerNamespace string, options *OperationsPutContentsClientListByProviderRegistrationOptions) (OperationsPutContentsClientListByProviderRegistrationResponse, error)`
- New function `*ProviderRegistrationsClient.CheckinManifest(ctx context.Context, providerNamespace string, checkinManifestParams CheckinManifestParams, options *ProviderRegistrationsClientCheckinManifestOptions) (ProviderRegistrationsClientCheckinManifestResponse, error)`
- New function `*ProviderRegistrationsClient.GenerateManifest(ctx context.Context, providerNamespace string, options *ProviderRegistrationsClientGenerateManifestOptions) (ProviderRegistrationsClientGenerateManifestResponse, error)`
