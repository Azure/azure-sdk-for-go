...
type ProviderRegistrationsServer struct {
	// CheckinManifest is the fake for method ProviderRegistrationsClient.CheckinManifest
	// HTTP status codes to indicate success: http.StatusOK
	CheckinManifest	func(ctx context.Context, providerNamespace string, checkinManifestParams armproviderhub.CheckinManifestParams, options *armproviderhub.ProviderRegistrationsClientCheckinManifestOptions) (resp azfake.Responder[armproviderhub.ProviderRegistrationsClientCheckinManifestResponse], errResp azfake.ErrorResponder)
	...
	// GenerateManifest is the fake for method ProviderRegistrationsClient.GenerateManifest
	// HTTP status codes to indicate success: http.StatusOK
	GenerateManifest	func(ctx context.Context, providerNamespace string, options *armproviderhub.ProviderRegistrationsClientGenerateManifestOptions) (resp azfake.Responder[armproviderhub.ProviderRegistrationsClientGenerateManifestResponse], errResp azfake.ErrorResponder)
...
func (p *ProviderRegistrationsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		if !intercepted {
			switch method {
			case "ProviderRegistrationsClient.CheckinManifest":
				res.resp, res.err = p.dispatchCheckinManifest(req)
			...
			case "ProviderRegistrationsClient.GenerateManifest":
				res.resp, res.err = p.dispatchGenerateManifest(req)
...
func (p *ProviderRegistrationsServerTransport) dispatchCheckinManifest(req *http.Request) (*http.Response, error) {
	if p.srv.CheckinManifest == nil {
	...
	respr, errRespr := p.srv.CheckinManifest(req.Context(), providerNamespaceParam, body, nil)
...
func (p *ProviderRegistrationsServerTransport) dispatchGenerateManifest(req *http.Request) (*http.Response, error) {
	if p.srv.GenerateManifest == nil {
	...
	respr, errRespr := p.srv.GenerateManifest(req.Context(), providerNamespaceParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
