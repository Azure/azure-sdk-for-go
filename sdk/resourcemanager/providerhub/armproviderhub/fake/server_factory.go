...
type ServerFactory struct {
	...
	// OperationsPutContentsServer contains the fakes for client OperationsPutContentsClient
	OperationsPutContentsServer OperationsPutContentsServer
...
type ServerFactoryTransport struct {
	...
	trOperationsPutContentsServer     *OperationsPutContentsServerTransport
...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "OperationsPutContentsClient":
		initServer(s, &s.trOperationsPutContentsServer, func() *OperationsPutContentsServerTransport {
			return NewOperationsPutContentsServerTransport(&s.srv.OperationsPutContentsServer)
		})
		resp, err = s.trOperationsPutContentsServer.Do(req)
