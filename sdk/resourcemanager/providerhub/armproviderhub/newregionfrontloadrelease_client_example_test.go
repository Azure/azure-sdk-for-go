...
func ExampleNewRegionFrontloadReleaseClient_CreateOrUpdate() {
	...
	res, err := clientFactory.NewNewRegionFrontloadReleaseClient().CreateOrUpdate(ctx, "Microsoft.Contoso", "2020week10", armproviderhub.FrontloadPayload{
		Properties: &armproviderhub.FrontloadPayloadProperties{
			...
			OverrideEndpointLevelFields: &armproviderhub.FrontloadPayloadPropertiesOverrideEndpointLevelFields{
				...
				DstsConfiguration: &armproviderhub.DstsConfigurationProperties{
				...
				FeaturesRule:	to.Ptr(armproviderhub.FeaturesPolicyAny),
				Locations: []*string{
					to.Ptr("East US"),
				},
	...
	// 					},
	// 				},
	// 				HighTraffic: &armproviderhub.TrafficRegionRolloutConfigurationProperties{
	// 					Regions: []*string{
	...
	// 				},
	// 				LowTraffic: &armproviderhub.TrafficRegionRolloutConfigurationProperties{
	// 					Regions: []*string{
	// 						to.Ptr("southeastasia"),
	// 					},
	// 					WaitDuration: to.Ptr("PT24H"),
	// 				},
	// 				MediumTraffic: &armproviderhub.TrafficRegionRolloutConfigurationProperties{
	// 					Regions: []*string{
	// 						to.Ptr("uksouth"),
	// 						to.Ptr("indiawest"),
	// 					},
	// 					WaitDuration: to.Ptr("PT24H"),
	// 				},
	// 				RestOfTheWorldGroupOne: &armproviderhub.TrafficRegionRolloutConfigurationProperties{
	// 					Regions: []*string{
	// 						to.Ptr("koreacentral"),
	...
	// 				},
	// 				RestOfTheWorldGroupTwo: &armproviderhub.TrafficRegionRolloutConfigurationProperties{
	// 					Regions: []*string{
	// 						to.Ptr("germanynorth"),
	// 						to.Ptr("norwayeast"),
	// 						to.Ptr("allotherregions"),
...
func ExampleNewRegionFrontloadReleaseClient_GenerateManifest() {
	...
	// 			},
	// 		},
	// 		Management: &armproviderhub.ResourceProviderManagementProperties{
...
func ExampleNewRegionFrontloadReleaseClient_Get() {
	...
	// 							ProviderAuthentication: &armproviderhub.ResourceProviderAuthenticationProperties{
