...
// ClientListByProviderRegistrationOptions contains the optional parameters for the Client.ListByProviderRegistration method.
type ClientListByProviderRegistrationOptions struct {
	// placeholder for future optional parameters
}
