...
//   - options - ProviderRegistrationsClientCheckinManifestOptions contains the optional parameters for the ProviderRegistrationsClient.CheckinManifest
//     method.
func (client *ProviderRegistrationsClient) CheckinManifest(ctx context.Context, providerNamespace string, checkinManifestParams CheckinManifestParams, options *ProviderRegistrationsClientCheckinManifestOptions) (ProviderRegistrationsClientCheckinManifestResponse, error) {
	var err error
	const operationName = "ProviderRegistrationsClient.CheckinManifest"
	...
	if err != nil {
		return ProviderRegistrationsClientCheckinManifestResponse{}, err
	}
...
func (client *ProviderRegistrationsClient) checkinManifestCreateRequest(ctx context.Context, providerNamespace string, checkinManifestParams CheckinManifestParams, _ *ProviderRegistrationsClientCheckinManifestOptions) (*policy.Request, error) {
...
func (client *ProviderRegistrationsClient) checkinManifestHandleResponse(resp *http.Response) (ProviderRegistrationsClientCheckinManifestResponse, error) {
	result := ProviderRegistrationsClientCheckinManifestResponse{}
...
// Generated from API version 2024-09-01
//   - providerNamespace - The name of the resource provider hosted within ProviderHub.
//   - options - ProviderRegistrationsClientGenerateManifestOptions contains the optional parameters for the ProviderRegistrationsClient.GenerateManifest
//     method.
func (client *ProviderRegistrationsClient) GenerateManifest(ctx context.Context, providerNamespace string, options *ProviderRegistrationsClientGenerateManifestOptions) (ProviderRegistrationsClientGenerateManifestResponse, error) {
	var err error
	const operationName = "ProviderRegistrationsClient.GenerateManifest"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.generateManifestCreateRequest(ctx, providerNamespace, options)
	if err != nil {
		return ProviderRegistrationsClientGenerateManifestResponse{}, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
	if err != nil {
		return ProviderRegistrationsClientGenerateManifestResponse{}, err
...
func (client *ProviderRegistrationsClient) generateManifestCreateRequest(ctx context.Context, providerNamespace string, _ *ProviderRegistrationsClientGenerateManifestOptions) (*policy.Request, error) {
...
func (client *ProviderRegistrationsClient) generateManifestHandleResponse(resp *http.Response) (ProviderRegistrationsClientGenerateManifestResponse, error) {
	result := ProviderRegistrationsClientGenerateManifestResponse{}
