...
func ExampleAvsStorageContainersClient_Get() {
	...
	// res = armpurestorage.AvsStorageContainersClientGetResponse{
	// 	AvsStorageContainer: &armpurestorage.AvsStorageContainer{
	// 		Properties: &armpurestorage.AvsStorageContainerProperties{
...
func ExampleAvsStorageContainersClient_NewListByStoragePoolPager() {
	...
	for pager.More() {
		...
		// page = armpurestorage.AvsStorageContainersClientListByStoragePoolResponse{
		// 	AvsStorageContainerListResult: armpurestorage.AvsStorageContainerListResult{
		// 		Value: []*armpurestorage.AvsStorageContainer{
		// 			{
		// 				Properties: &armpurestorage.AvsStorageContainerProperties{
		// 					Space: &armpurestorage.Space{
		// 						TotalUsed: to.Ptr[int64](28),
