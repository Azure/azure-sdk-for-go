...
// AvsVMsServer is a fake server for instances of the armpurestorage.AvsVMsClient type.
type AvsVMsServer struct {
	// BeginDelete is the fake for method AvsVMsClient.BeginDelete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginDelete func(ctx context.Context, resourceGroupName string, storagePoolName string, avsVMID string, options *armpurestorage.AvsVMsClientBeginDeleteOptions) (resp azfake.PollerResponder[armpurestorage.AvsVMsClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method AvsVMsClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, storagePoolName string, avsVMID string, options *armpurestorage.AvsVMsClientGetOptions) (resp azfake.Responder[armpurestorage.AvsVMsClientGetResponse], errResp azfake.ErrorResponder)

	// NewListByStoragePoolPager is the fake for method AvsVMsClient.NewListByStoragePoolPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByStoragePoolPager func(resourceGroupName string, storagePoolName string, options *armpurestorage.AvsVMsClientListByStoragePoolOptions) (resp azfake.PagerResponder[armpurestorage.AvsVMsClientListByStoragePoolResponse])

	// BeginUpdate is the fake for method AvsVMsClient.BeginUpdate
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginUpdate func(ctx context.Context, resourceGroupName string, storagePoolName string, avsVMID string, properties armpurestorage.AvsVMUpdate, options *armpurestorage.AvsVMsClientBeginUpdateOptions) (resp azfake.PollerResponder[armpurestorage.AvsVMsClientUpdateResponse], errResp azfake.ErrorResponder)
}

// NewAvsVMsServerTransport creates a new instance of AvsVMsServerTransport with the provided implementation.
// The returned AvsVMsServerTransport instance is connected to an instance of armpurestorage.AvsVMsClient via the
// azcore.ClientOptions.Transporter field in the client's constructor parameters.
func NewAvsVMsServerTransport(srv *AvsVMsServer) *AvsVMsServerTransport {
	return &AvsVMsServerTransport{
		srv:                       srv,
		beginDelete:               newTracker[azfake.PollerResponder[armpurestorage.AvsVMsClientDeleteResponse]](),
		newListByStoragePoolPager: newTracker[azfake.PagerResponder[armpurestorage.AvsVMsClientListByStoragePoolResponse]](),
		beginUpdate:               newTracker[azfake.PollerResponder[armpurestorage.AvsVMsClientUpdateResponse]](),
	}
}

// AvsVMsServerTransport connects instances of armpurestorage.AvsVMsClient to instances of AvsVMsServer.
// Don't use this type directly, use NewAvsVMsServerTransport instead.
type AvsVMsServerTransport struct {
	srv                       *AvsVMsServer
	beginDelete               *tracker[azfake.PollerResponder[armpurestorage.AvsVMsClientDeleteResponse]]
	newListByStoragePoolPager *tracker[azfake.PagerResponder[armpurestorage.AvsVMsClientListByStoragePoolResponse]]
	beginUpdate               *tracker[azfake.PollerResponder[armpurestorage.AvsVMsClientUpdateResponse]]
}
...
func (a *AvsVMsServerTransport) dispatchNewListByStoragePoolPager(req *http.Request) (*http.Response, error) {
	...
	if newListByStoragePoolPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListByStoragePoolPager, req, func(page *armpurestorage.AvsVMsClientListByStoragePoolResponse, createLink func() string) {
...
func (a *AvsVMsServerTransport) dispatchBeginUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginUpdate == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armpurestorage.AvsVMUpdate](req)
		if err != nil {
			return nil, err
		}
		resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
