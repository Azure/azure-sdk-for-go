...
// AvsVMVolumesServer is a fake server for instances of the armpurestorage.AvsVMVolumesClient type.
type AvsVMVolumesServer struct {
	// BeginDelete is the fake for method AvsVMVolumesClient.BeginDelete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginDelete func(ctx context.Context, resourceGroupName string, storagePoolName string, avsVMID string, volumeID string, options *armpurestorage.AvsVMVolumesClientBeginDeleteOptions) (resp azfake.PollerResponder[armpurestorage.AvsVMVolumesClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method AvsVMVolumesClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, storagePoolName string, avsVMID string, volumeID string, options *armpurestorage.AvsVMVolumesClientGetOptions) (resp azfake.Responder[armpurestorage.AvsVMVolumesClientGetResponse], errResp azfake.ErrorResponder)

	// NewListByAvsVMPager is the fake for method AvsVMVolumesClient.NewListByAvsVMPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByAvsVMPager func(resourceGroupName string, storagePoolName string, avsVMID string, options *armpurestorage.AvsVMVolumesClientListByAvsVMOptions) (resp azfake.PagerResponder[armpurestorage.AvsVMVolumesClientListByAvsVMResponse])

	// BeginUpdate is the fake for method AvsVMVolumesClient.BeginUpdate
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginUpdate func(ctx context.Context, resourceGroupName string, storagePoolName string, avsVMID string, volumeID string, properties armpurestorage.AvsVMVolumeUpdate, options *armpurestorage.AvsVMVolumesClientBeginUpdateOptions) (resp azfake.PollerResponder[armpurestorage.AvsVMVolumesClientUpdateResponse], errResp azfake.ErrorResponder)
}

// NewAvsVMVolumesServerTransport creates a new instance of AvsVMVolumesServerTransport with the provided implementation.
// The returned AvsVMVolumesServerTransport instance is connected to an instance of armpurestorage.AvsVMVolumesClient via the
...
func NewAvsVMVolumesServerTransport(srv *AvsVMVolumesServer) *AvsVMVolumesServerTransport {
	return &AvsVMVolumesServerTransport{
		srv:                 srv,
		beginDelete:         newTracker[azfake.PollerResponder[armpurestorage.AvsVMVolumesClientDeleteResponse]](),
		newListByAvsVMPager: newTracker[azfake.PagerResponder[armpurestorage.AvsVMVolumesClientListByAvsVMResponse]](),
		beginUpdate:         newTracker[azfake.PollerResponder[armpurestorage.AvsVMVolumesClientUpdateResponse]](),
	}
}

// AvsVMVolumesServerTransport connects instances of armpurestorage.AvsVMVolumesClient to instances of AvsVMVolumesServer.
...
type AvsVMVolumesServerTransport struct {
	...
	beginDelete         *tracker[azfake.PollerResponder[armpurestorage.AvsVMVolumesClientDeleteResponse]]
	newListByAvsVMPager *tracker[azfake.PagerResponder[armpurestorage.AvsVMVolumesClientListByAvsVMResponse]]
	beginUpdate         *tracker[azfake.PollerResponder[armpurestorage.AvsVMVolumesClientUpdateResponse]]
}
...
func (a *AvsVMVolumesServerTransport) dispatchNewListByAvsVMPager(req *http.Request) (*http.Response, error) {
	...
	if newListByAvsVMPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListByAvsVMPager, req, func(page *armpurestorage.AvsVMVolumesClientListByAvsVMResponse, createLink func() string) {
...
func (a *AvsVMVolumesServerTransport) dispatchBeginUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginUpdate == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armpurestorage.AvsVMVolumeUpdate](req)
		if err != nil {
			return nil, err
		}
		resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
