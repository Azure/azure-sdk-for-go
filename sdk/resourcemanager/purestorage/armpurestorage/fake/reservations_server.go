...
// ReservationsServer is a fake server for instances of the armpurestorage.ReservationsClient type.
type ReservationsServer struct {
	// BeginCreate is the fake for method ReservationsClient.BeginCreate
	// HTTP status codes to indicate success: http.StatusOK, http.StatusCreated
	BeginCreate func(ctx context.Context, resourceGroupName string, reservationName string, resource armpurestorage.Reservation, options *armpurestorage.ReservationsClientBeginCreateOptions) (resp azfake.PollerResponder[armpurestorage.ReservationsClientCreateResponse], errResp azfake.ErrorResponder)

	// BeginDelete is the fake for method ReservationsClient.BeginDelete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginDelete func(ctx context.Context, resourceGroupName string, reservationName string, options *armpurestorage.ReservationsClientBeginDeleteOptions) (resp azfake.PollerResponder[armpurestorage.ReservationsClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method ReservationsClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, reservationName string, options *armpurestorage.ReservationsClientGetOptions) (resp azfake.Responder[armpurestorage.ReservationsClientGetResponse], errResp azfake.ErrorResponder)

	// GetBillingReport is the fake for method ReservationsClient.GetBillingReport
	// HTTP status codes to indicate success: http.StatusOK
	GetBillingReport func(ctx context.Context, resourceGroupName string, reservationName string, options *armpurestorage.ReservationsClientGetBillingReportOptions) (resp azfake.Responder[armpurestorage.ReservationsClientGetBillingReportResponse], errResp azfake.ErrorResponder)

	// GetBillingStatus is the fake for method ReservationsClient.GetBillingStatus
	// HTTP status codes to indicate success: http.StatusOK
	GetBillingStatus func(ctx context.Context, resourceGroupName string, reservationName string, options *armpurestorage.ReservationsClientGetBillingStatusOptions) (resp azfake.Responder[armpurestorage.ReservationsClientGetBillingStatusResponse], errResp azfake.ErrorResponder)

	// GetResourceLimits is the fake for method ReservationsClient.GetResourceLimits
	// HTTP status codes to indicate success: http.StatusOK
	GetResourceLimits func(ctx context.Context, resourceGroupName string, reservationName string, options *armpurestorage.ReservationsClientGetResourceLimitsOptions) (resp azfake.Responder[armpurestorage.ReservationsClientGetResourceLimitsResponse], errResp azfake.ErrorResponder)

	// NewListByResourceGroupPager is the fake for method ReservationsClient.NewListByResourceGroupPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByResourceGroupPager func(resourceGroupName string, options *armpurestorage.ReservationsClientListByResourceGroupOptions) (resp azfake.PagerResponder[armpurestorage.ReservationsClientListByResourceGroupResponse])

	// NewListBySubscriptionPager is the fake for method ReservationsClient.NewListBySubscriptionPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListBySubscriptionPager func(options *armpurestorage.ReservationsClientListBySubscriptionOptions) (resp azfake.PagerResponder[armpurestorage.ReservationsClientListBySubscriptionResponse])

	// BeginUpdate is the fake for method ReservationsClient.BeginUpdate
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginUpdate func(ctx context.Context, resourceGroupName string, reservationName string, properties armpurestorage.ReservationUpdate, options *armpurestorage.ReservationsClientBeginUpdateOptions) (resp azfake.PollerResponder[armpurestorage.ReservationsClientUpdateResponse], errResp azfake.ErrorResponder)
}

// NewReservationsServerTransport creates a new instance of ReservationsServerTransport with the provided implementation.
// The returned ReservationsServerTransport instance is connected to an instance of armpurestorage.ReservationsClient via the
...
func NewReservationsServerTransport(srv *ReservationsServer) *ReservationsServerTransport {
	return &ReservationsServerTransport{
		srv:                         srv,
		beginCreate:                 newTracker[azfake.PollerResponder[armpurestorage.ReservationsClientCreateResponse]](),
		beginDelete:                 newTracker[azfake.PollerResponder[armpurestorage.ReservationsClientDeleteResponse]](),
		newListByResourceGroupPager: newTracker[azfake.PagerResponder[armpurestorage.ReservationsClientListByResourceGroupResponse]](),
		newListBySubscriptionPager:  newTracker[azfake.PagerResponder[armpurestorage.ReservationsClientListBySubscriptionResponse]](),
		beginUpdate:                 newTracker[azfake.PollerResponder[armpurestorage.ReservationsClientUpdateResponse]](),
	}
}

// ReservationsServerTransport connects instances of armpurestorage.ReservationsClient to instances of ReservationsServer.
...
type ReservationsServerTransport struct {
	...
	beginCreate                 *tracker[azfake.PollerResponder[armpurestorage.ReservationsClientCreateResponse]]
	beginDelete                 *tracker[azfake.PollerResponder[armpurestorage.ReservationsClientDeleteResponse]]
	newListByResourceGroupPager *tracker[azfake.PagerResponder[armpurestorage.ReservationsClientListByResourceGroupResponse]]
	newListBySubscriptionPager  *tracker[azfake.PagerResponder[armpurestorage.ReservationsClientListBySubscriptionResponse]]
	beginUpdate                 *tracker[azfake.PollerResponder[armpurestorage.ReservationsClientUpdateResponse]]
}
...
func (r *ReservationsServerTransport) dispatchBeginCreate(req *http.Request) (*http.Response, error) {
	...
	if beginCreate == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armpurestorage.Reservation](req)
		if err != nil {
			return nil, err
		}
...
func (r *ReservationsServerTransport) dispatchNewListByResourceGroupPager(req *http.Request) (*http.Response, error) {
	...
	if newListByResourceGroupPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListByResourceGroupPager, req, func(page *armpurestorage.ReservationsClientListByResourceGroupResponse, createLink func() string) {
...
func (r *ReservationsServerTransport) dispatchNewListBySubscriptionPager(req *http.Request) (*http.Response, error) {
	...
	if newListBySubscriptionPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListBySubscriptionPager, req, func(page *armpurestorage.ReservationsClientListBySubscriptionResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
...
func (r *ReservationsServerTransport) dispatchBeginUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginUpdate == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armpurestorage.ReservationUpdate](req)
		if err != nil {
			return nil, err
		}
		resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
