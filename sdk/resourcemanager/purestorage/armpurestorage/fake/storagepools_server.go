...
// StoragePoolsServer is a fake server for instances of the armpurestorage.StoragePoolsClient type.
type StoragePoolsServer struct {
	// BeginCreate is the fake for method StoragePoolsClient.BeginCreate
	// HTTP status codes to indicate success: http.StatusOK, http.StatusCreated
	BeginCreate func(ctx context.Context, resourceGroupName string, storagePoolName string, resource armpurestorage.StoragePool, options *armpurestorage.StoragePoolsClientBeginCreateOptions) (resp azfake.PollerResponder[armpurestorage.StoragePoolsClientCreateResponse], errResp azfake.ErrorResponder)

	// BeginDelete is the fake for method StoragePoolsClient.BeginDelete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginDelete func(ctx context.Context, resourceGroupName string, storagePoolName string, options *armpurestorage.StoragePoolsClientBeginDeleteOptions) (resp azfake.PollerResponder[armpurestorage.StoragePoolsClientDeleteResponse], errResp azfake.ErrorResponder)

	// BeginDisableAvsConnection is the fake for method StoragePoolsClient.BeginDisableAvsConnection
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginDisableAvsConnection func(ctx context.Context, resourceGroupName string, storagePoolName string, options *armpurestorage.StoragePoolsClientBeginDisableAvsConnectionOptions) (resp azfake.PollerResponder[armpurestorage.StoragePoolsClientDisableAvsConnectionResponse], errResp azfake.ErrorResponder)

	// BeginEnableAvsConnection is the fake for method StoragePoolsClient.BeginEnableAvsConnection
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginEnableAvsConnection func(ctx context.Context, resourceGroupName string, storagePoolName string, properties armpurestorage.StoragePoolEnableAvsConnectionPost, options *armpurestorage.StoragePoolsClientBeginEnableAvsConnectionOptions) (resp azfake.PollerResponder[armpurestorage.StoragePoolsClientEnableAvsConnectionResponse], errResp azfake.ErrorResponder)

	// BeginFinalizeAvsConnection is the fake for method StoragePoolsClient.BeginFinalizeAvsConnection
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginFinalizeAvsConnection func(ctx context.Context, resourceGroupName string, storagePoolName string, properties armpurestorage.StoragePoolFinalizeAvsConnectionPost, options *armpurestorage.StoragePoolsClientBeginFinalizeAvsConnectionOptions) (resp azfake.PollerResponder[armpurestorage.StoragePoolsClientFinalizeAvsConnectionResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method StoragePoolsClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, storagePoolName string, options *armpurestorage.StoragePoolsClientGetOptions) (resp azfake.Responder[armpurestorage.StoragePoolsClientGetResponse], errResp azfake.ErrorResponder)

	// GetAvsConnection is the fake for method StoragePoolsClient.GetAvsConnection
	// HTTP status codes to indicate success: http.StatusOK
	GetAvsConnection func(ctx context.Context, resourceGroupName string, storagePoolName string, options *armpurestorage.StoragePoolsClientGetAvsConnectionOptions) (resp azfake.Responder[armpurestorage.StoragePoolsClientGetAvsConnectionResponse], errResp azfake.ErrorResponder)

	// GetAvsStatus is the fake for method StoragePoolsClient.GetAvsStatus
	// HTTP status codes to indicate success: http.StatusOK
	GetAvsStatus func(ctx context.Context, resourceGroupName string, storagePoolName string, options *armpurestorage.StoragePoolsClientGetAvsStatusOptions) (resp azfake.Responder[armpurestorage.StoragePoolsClientGetAvsStatusResponse], errResp azfake.ErrorResponder)

	// GetHealthStatus is the fake for method StoragePoolsClient.GetHealthStatus
	// HTTP status codes to indicate success: http.StatusOK
	GetHealthStatus func(ctx context.Context, resourceGroupName string, storagePoolName string, options *armpurestorage.StoragePoolsClientGetHealthStatusOptions) (resp azfake.Responder[armpurestorage.StoragePoolsClientGetHealthStatusResponse], errResp azfake.ErrorResponder)

	// NewListByResourceGroupPager is the fake for method StoragePoolsClient.NewListByResourceGroupPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByResourceGroupPager func(resourceGroupName string, options *armpurestorage.StoragePoolsClientListByResourceGroupOptions) (resp azfake.PagerResponder[armpurestorage.StoragePoolsClientListByResourceGroupResponse])

	// NewListBySubscriptionPager is the fake for method StoragePoolsClient.NewListBySubscriptionPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListBySubscriptionPager func(options *armpurestorage.StoragePoolsClientListBySubscriptionOptions) (resp azfake.PagerResponder[armpurestorage.StoragePoolsClientListBySubscriptionResponse])

	// BeginRepairAvsConnection is the fake for method StoragePoolsClient.BeginRepairAvsConnection
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginRepairAvsConnection func(ctx context.Context, resourceGroupName string, storagePoolName string, options *armpurestorage.StoragePoolsClientBeginRepairAvsConnectionOptions) (resp azfake.PollerResponder[armpurestorage.StoragePoolsClientRepairAvsConnectionResponse], errResp azfake.ErrorResponder)

	// BeginUpdate is the fake for method StoragePoolsClient.BeginUpdate
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginUpdate func(ctx context.Context, resourceGroupName string, storagePoolName string, properties armpurestorage.StoragePoolUpdate, options *armpurestorage.StoragePoolsClientBeginUpdateOptions) (resp azfake.PollerResponder[armpurestorage.StoragePoolsClientUpdateResponse], errResp azfake.ErrorResponder)
}

// NewStoragePoolsServerTransport creates a new instance of StoragePoolsServerTransport with the provided implementation.
// The returned StoragePoolsServerTransport instance is connected to an instance of armpurestorage.StoragePoolsClient via the
...
func NewStoragePoolsServerTransport(srv *StoragePoolsServer) *StoragePoolsServerTransport {
	return &StoragePoolsServerTransport{
		srv:                         srv,
		beginCreate:                 newTracker[azfake.PollerResponder[armpurestorage.StoragePoolsClientCreateResponse]](),
		beginDelete:                 newTracker[azfake.PollerResponder[armpurestorage.StoragePoolsClientDeleteResponse]](),
		beginDisableAvsConnection:   newTracker[azfake.PollerResponder[armpurestorage.StoragePoolsClientDisableAvsConnectionResponse]](),
		beginEnableAvsConnection:    newTracker[azfake.PollerResponder[armpurestorage.StoragePoolsClientEnableAvsConnectionResponse]](),
		beginFinalizeAvsConnection:  newTracker[azfake.PollerResponder[armpurestorage.StoragePoolsClientFinalizeAvsConnectionResponse]](),
		newListByResourceGroupPager: newTracker[azfake.PagerResponder[armpurestorage.StoragePoolsClientListByResourceGroupResponse]](),
		newListBySubscriptionPager:  newTracker[azfake.PagerResponder[armpurestorage.StoragePoolsClientListBySubscriptionResponse]](),
		beginRepairAvsConnection:    newTracker[azfake.PollerResponder[armpurestorage.StoragePoolsClientRepairAvsConnectionResponse]](),
		beginUpdate:                 newTracker[azfake.PollerResponder[armpurestorage.StoragePoolsClientUpdateResponse]](),
	}
}

// StoragePoolsServerTransport connects instances of armpurestorage.StoragePoolsClient to instances of StoragePoolsServer.
...
type StoragePoolsServerTransport struct {
	...
	beginCreate                 *tracker[azfake.PollerResponder[armpurestorage.StoragePoolsClientCreateResponse]]
	beginDelete                 *tracker[azfake.PollerResponder[armpurestorage.StoragePoolsClientDeleteResponse]]
	beginDisableAvsConnection   *tracker[azfake.PollerResponder[armpurestorage.StoragePoolsClientDisableAvsConnectionResponse]]
	beginEnableAvsConnection    *tracker[azfake.PollerResponder[armpurestorage.StoragePoolsClientEnableAvsConnectionResponse]]
	beginFinalizeAvsConnection  *tracker[azfake.PollerResponder[armpurestorage.StoragePoolsClientFinalizeAvsConnectionResponse]]
	newListByResourceGroupPager *tracker[azfake.PagerResponder[armpurestorage.StoragePoolsClientListByResourceGroupResponse]]
	newListBySubscriptionPager  *tracker[azfake.PagerResponder[armpurestorage.StoragePoolsClientListBySubscriptionResponse]]
	beginRepairAvsConnection    *tracker[azfake.PollerResponder[armpurestorage.StoragePoolsClientRepairAvsConnectionResponse]]
	beginUpdate                 *tracker[azfake.PollerResponder[armpurestorage.StoragePoolsClientUpdateResponse]]
}
...
func (s *StoragePoolsServerTransport) dispatchBeginCreate(req *http.Request) (*http.Response, error) {
	...
	if beginCreate == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armpurestorage.StoragePool](req)
		if err != nil {
			return nil, err
		}
...
func (s *StoragePoolsServerTransport) dispatchBeginEnableAvsConnection(req *http.Request) (*http.Response, error) {
	...
	if beginEnableAvsConnection == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armpurestorage.StoragePoolEnableAvsConnectionPost](req)
		if err != nil {
			return nil, err
		}
		resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
...
func (s *StoragePoolsServerTransport) dispatchBeginFinalizeAvsConnection(req *http.Request) (*http.Response, error) {
	...
	if beginFinalizeAvsConnection == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armpurestorage.StoragePoolFinalizeAvsConnectionPost](req)
		if err != nil {
			return nil, err
		}
		resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
...
func (s *StoragePoolsServerTransport) dispatchNewListByResourceGroupPager(req *http.Request) (*http.Response, error) {
	...
	if newListByResourceGroupPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListByResourceGroupPager, req, func(page *armpurestorage.StoragePoolsClientListByResourceGroupResponse, createLink func() string) {
...
func (s *StoragePoolsServerTransport) dispatchNewListBySubscriptionPager(req *http.Request) (*http.Response, error) {
	...
	if newListBySubscriptionPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListBySubscriptionPager, req, func(page *armpurestorage.StoragePoolsClientListBySubscriptionResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
...
func (s *StoragePoolsServerTransport) dispatchBeginUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginUpdate == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armpurestorage.StoragePoolUpdate](req)
		if err != nil {
			return nil, err
		}
		resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
