...
func (client *AvsStorageContainerVolumesClient) getHandleResponse(resp *http.Response, successCodes ...int) (AvsStorageContainerVolumesClientGetResponse, error) {
...
func (client *AvsStorageContainerVolumesClient) NewListByAvsStorageContainerPager(resourceGroupName string, storagePoolName string, storageContainerName string, options *AvsStorageContainerVolumesClientListByAvsStorageContainerOptions) *runtime.Pager[AvsStorageContainerVolumesClientListByAvsStorageContainerResponse] {
	return runtime.NewPager(runtime.PagingHandler[AvsStorageContainerVolumesClientListByAvsStorageContainerResponse]{
		...
		Fetcher: func(ctx context.Context, page *AvsStorageContainerVolumesClientListByAvsStorageContainerResponse) (AvsStorageContainerVolumesClientListByAvsStorageContainerResponse, error) {
			...
			req, err := client.listByAvsStorageContainerCreateRequest(ctx, resourceGroupName, storagePoolName, storageContainerName, nextLink, options)
			if err != nil {
			...
			return client.listByAvsStorageContainerHandleResponse(resp, http.StatusOK)
		},
		Tracer: client.internal.Tracer(),
	})
}
...
func (client *AvsStorageContainerVolumesClient) listByAvsStorageContainerCreateRequest(ctx context.Context, resourceGroupName string, storagePoolName string, storageContainerName string, nextLink string, _ *AvsStorageContainerVolumesClientListByAvsStorageContainerOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *AvsStorageContainerVolumesClient) listByAvsStorageContainerHandleResponse(resp *http.Response, successCodes ...int) (AvsStorageContainerVolumesClientListByAvsStorageContainerResponse, error) {
