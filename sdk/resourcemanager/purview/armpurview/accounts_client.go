...
// AddRootCollectionAdmin - Add the administrator for root collection.
//
...
func (client *AccountsClient) AddRootCollectionAdmin(ctx context.Context, resourceGroupName string, accountName string, collectionAdminUpdate CollectionAdminUpdate, options *AccountsClientAddRootCollectionAdminOptions) (AccountsClientAddRootCollectionAdminResponse, error) {
	...
	if !runtime.HasStatusCode(httpResp, http.StatusOK) {
		return AccountsClientAddRootCollectionAdminResponse{}, runtime.NewResponseError(httpResp)
	}
...
// CheckNameAvailability - Checks the account name availability.
//
...
// BeginCreateOrUpdate - Create or update an account resource.
//
...
// CreateOrUpdate - Create or update an account resource.
//
// Creates or updates an account
// If the operation fails it returns an *azcore.ResponseError type.
...
// BeginDelete - Deletes the account resource.
//
...
// Delete - Deletes the account resource.
//
// Deletes an account resource
// If the operation fails it returns an *azcore.ResponseError type.
...
// NewListByResourceGroupPager - Gets the accounts resources by resource group.
//
...
func (client *AccountsClient) listByResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, nextLink string, options *AccountsClientListByResourceGroupOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
// NewListBySubscriptionPager - Gets the accounts resources by subscription.
//
...
func (client *AccountsClient) listBySubscriptionCreateRequest(ctx context.Context, nextLink string, options *AccountsClientListBySubscriptionOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
	var req *policy.Request
	var err error
	if firstPage {
...
func (client *AccountsClient) listBySubscriptionHandleResponse(resp *http.Response, successCodes ...int) (AccountsClientListBySubscriptionResponse, error) {
...
// ListKeys - Lists the keys asynchronous.
//
...
// BeginUpdate - Patches the account resource.
//
// Updates an account
// If the operation fails it returns an *azcore.ResponseError type.
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
...
// Update - Patches the account resource.
//
// Updates an account
// If the operation fails it returns an *azcore.ResponseError type.
