...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "DefaultAccountsClient":
		initServer(&s.trMu, &s.trDefaultAccountsServer, func() *DefaultAccountsServerTransport {
	...
	case "IngestionPrivateEndpointConnectionsClient":
		initServer(&s.trMu, &s.trIngestionPrivateEndpointConnectionsServer, func() *IngestionPrivateEndpointConnectionsServerTransport {
	...
	case "KafkaConfigurationsClient":
		initServer(&s.trMu, &s.trKafkaConfigurationsServer, func() *KafkaConfigurationsServerTransport {
