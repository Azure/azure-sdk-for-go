...
// BeginCreateOrUpdate - Approves/Rejects private endpoint connection request.
//
...
// CreateOrUpdate - Approves/Rejects private endpoint connection request.
//
// Create or update a private endpoint connection
// If the operation fails it returns an *azcore.ResponseError type.
...
// BeginDelete - Deletes private endpoint connection.
//
...
// Delete - Deletes private endpoint connection.
//
// Delete a private endpoint connection
// If the operation fails it returns an *azcore.ResponseError type.
...
// Get - Gets private endpoint connection information.
//
...
// NewListByAccountPager - Gets private endpoint connections.
//
...
func (client *PrivateEndpointConnectionsClient) listByAccountCreateRequest(ctx context.Context, resourceGroupName string, accountName string, nextLink string, options *PrivateEndpointConnectionsClientListByAccountOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
