...
// Generated from example definition: 2024-04-01-preview/PrivateLinkResources_ListByAccount.json
func ExamplePrivateLinkResourcesClient_NewListByAccountPager() {
	...
	for pager.More() {
		...
		// page = armpurview.PrivateLinkResourcesClientListByAccountResponse{
		// 	PrivateLinkResourceList: armpurview.PrivateLinkResourceList{
