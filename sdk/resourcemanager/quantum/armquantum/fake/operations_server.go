...
// The returned OperationsServerTransport instance is connected to an instance of armquantum.OperationsClient via the
// azcore.ClientOptions.Transporter field in the client's constructor parameters.
func NewOperationsServerTransport(srv *OperationsServer) *OperationsServerTransport {
	return &OperationsServerTransport{
		srv:          srv,
		newListPager: newTracker[azfake.PagerResponder[armquantum.OperationsClientListResponse]](),
	}
}

// OperationsServerTransport connects instances of armquantum.OperationsClient to instances of OperationsServer.
// Don't use this type directly, use NewOperationsServerTransport instead.
type OperationsServerTransport struct {
	srv          *OperationsServer
	newListPager *tracker[azfake.PagerResponder[armquantum.OperationsClientListResponse]]
}
...
func (o *OperationsServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armquantum.OperationsClientListResponse, createLink func() string) {
