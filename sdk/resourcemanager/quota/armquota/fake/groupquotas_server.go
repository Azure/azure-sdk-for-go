...
type GroupQuotasServer struct {
	...
	BeginCreateOrUpdate func(ctx context.Context, managementGroupID string, groupQuotaName string, groupQuotaPutRequestBody armquota.GroupQuotasEntity, options *armquota.GroupQuotasClientBeginCreateOrUpdateOptions) (resp azfake.PollerResponder[armquota.GroupQuotasClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)
	...
	BeginUpdate func(ctx context.Context, managementGroupID string, groupQuotaName string, groupQuotasPatchRequestBody armquota.GroupQuotasEntityPatch, options *armquota.GroupQuotasClientBeginUpdateOptions) (resp azfake.PollerResponder[armquota.GroupQuotasClientUpdateResponse], errResp azfake.ErrorResponder)
}
...
func (g *GroupQuotasServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if groupQuotasServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = groupQuotasServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
func (g *GroupQuotasServerTransport) dispatchBeginCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginCreateOrUpdate == nil {
		...
		respr, errRespr := g.srv.BeginCreateOrUpdate(req.Context(), managementGroupIDParam, groupQuotaNameParam, body, nil)
...
func (g *GroupQuotasServerTransport) dispatchBeginUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginUpdate == nil {
		...
		respr, errRespr := g.srv.BeginUpdate(req.Context(), managementGroupIDParam, groupQuotaNameParam, body, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginUpdate = &respr
...
// set this to conditionally intercept incoming requests to GroupQuotasServerTransport
var groupQuotasServerTransportInterceptor interface {
