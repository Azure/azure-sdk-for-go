...
func (g *GroupQuotaSubscriptionAllocationRequestServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if groupQuotaSubscriptionAllocationRequestServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = groupQuotaSubscriptionAllocationRequestServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to GroupQuotaSubscriptionAllocationRequestServerTransport
var groupQuotaSubscriptionAllocationRequestServerTransportInterceptor interface {
