...
func (g *GroupQuotaSubscriptionRequestsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if groupQuotaSubscriptionRequestsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = groupQuotaSubscriptionRequestsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to GroupQuotaSubscriptionRequestsServerTransport
var groupQuotaSubscriptionRequestsServerTransportInterceptor interface {
