...
func (r *RequestStatusServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if requestStatusServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = requestStatusServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to RequestStatusServerTransport
var requestStatusServerTransportInterceptor interface {
