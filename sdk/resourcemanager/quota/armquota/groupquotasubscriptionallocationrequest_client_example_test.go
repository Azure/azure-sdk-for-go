...
func ExampleGroupQuotaSubscriptionAllocationRequestClient_Get() {
	...
	res, err := clientFactory.NewGroupQuotaSubscriptionAllocationRequestClient("00000000-0000-0000-0000-000000000000").Get(ctx, "E7EC67B3-7657-4966-BFFC-41EFD36BAA09", "groupquota1", "Microsoft.Compute", "AE000000-0000-0000-0000-00000000000A", nil)
	if err != nil {
...
func ExampleGroupQuotaSubscriptionAllocationRequestClient_NewListPager() {
	...
	pager := clientFactory.NewGroupQuotaSubscriptionAllocationRequestClient("00000000-0000-0000-0000-000000000000").NewListPager("E7EC67B3-7657-4966-BFFC-41EFD36BAA09", "groupquota1", "Microsoft.Compute", "location eq westus", nil)
	for pager.More() {
		...
		// page = armquota.GroupQuotaSubscriptionAllocationRequestClientListResponse{
		// 	AllocationRequestStatusList: armquota.AllocationRequestStatusList{
...
func ExampleGroupQuotaSubscriptionAllocationRequestClient_BeginUpdate() {
	...
	poller, err := clientFactory.NewGroupQuotaSubscriptionAllocationRequestClient("00000000-0000-0000-0000-000000000000").BeginUpdate(ctx, "E7EC67B3-7657-4966-BFFC-41EFD36BAA09", "groupquota1", "Microsoft.Compute", "westus", armquota.SubscriptionQuotaAllocationsList{
