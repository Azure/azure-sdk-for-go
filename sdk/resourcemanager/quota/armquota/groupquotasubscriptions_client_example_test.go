...
func ExampleGroupQuotaSubscriptionsClient_BeginCreateOrUpdate() {
	...
	clientFactory, err := armquota.NewClientFactory("00000000-0000-0000-0000-000000000000", cred, nil)
	if err != nil {
...
func ExampleGroupQuotaSubscriptionsClient_NewListPager() {
	...
	ctx := context.Background()
	clientFactory, err := armquota.NewClientFactory("<subscriptionID>", cred, nil)
	if err != nil {
		log.Fatalf("failed to create client: %v", err)
	}
