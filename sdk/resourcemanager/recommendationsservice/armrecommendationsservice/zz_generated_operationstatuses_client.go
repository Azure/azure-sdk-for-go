...
func NewOperationStatusesClient(credential azcore.TokenCredential, options *arm.ClientOptions) *OperationStatusesClient {
	if options == nil {
...
func (client *OperationStatusesClient) getCreateRequest(ctx context.Context, location string, operationID string, options *OperationStatusesClientGetOptions) (*policy.Request, error) {
	urlPath := "/providers/Microsoft.RecommendationsService/locations/{location}/operationStatuses/{operationId}"
	if location == "" {
