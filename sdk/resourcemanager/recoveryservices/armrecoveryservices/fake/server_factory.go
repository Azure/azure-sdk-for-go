...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "RegisteredIdentitiesClient":
		initServer(&s.trMu, &s.trRegisteredIdentitiesServer, func() *RegisteredIdentitiesServerTransport {
	...
	case "ReplicationUsagesClient":
		initServer(&s.trMu, &s.trReplicationUsagesServer, func() *ReplicationUsagesServerTransport {
	...
	case "VaultCertificatesClient":
		initServer(&s.trMu, &s.trVaultCertificatesServer, func() *VaultCertificatesServerTransport {
	...
	case "VaultExtendedInfoClient":
		initServer(&s.trMu, &s.trVaultExtendedInfoServer, func() *VaultExtendedInfoServerTransport {
