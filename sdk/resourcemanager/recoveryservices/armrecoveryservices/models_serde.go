...
func (d DeletedVaultProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateDateTimeRFC3339(objectMap, "purgeAt", d.PurgeAt)
	populateDateTimeRFC3339(objectMap, "vaultDeletionTime", d.VaultDeletionTime)
...
func (d *DeletedVaultProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "purgeAt":
			err = unpopulateDateTimeRFC3339(val, "PurgeAt", &d.PurgeAt)
			delete(rawMsg, key)
		case "vaultDeletionTime":
			err = unpopulateDateTimeRFC3339(val, "VaultDeletionTime", &d.VaultDeletionTime)
			delete(rawMsg, key)
		case "vaultId":
