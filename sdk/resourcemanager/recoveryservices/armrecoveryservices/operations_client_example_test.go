...
// Generated from example definition: 2026-05-01/GetOperationResult.json
...
// Generated from example definition: 2026-05-01/ListOperations.json
func ExampleOperationsClient_NewListPager() {
	...
	ctx := context.Background()
	clientFactory, err := armrecoveryservices.NewClientFactory("<subscriptionID>", cred, nil)
	if err != nil {
		log.Fatalf("failed to create client: %v", err)
	}
	...
	for pager.More() {
		...
		// page = armrecoveryservices.OperationsClientListResponse{
		// 	ClientDiscoveryResponse: armrecoveryservices.ClientDiscoveryResponse{
...
// Generated from example definition: 2026-05-01/GetOperationStatus.json
