...
func (client *UsagesClient) NewListByVaultsPager(resourceGroupName string, vaultName string, options *UsagesClientListByVaultsOptions) *runtime.Pager[UsagesClientListByVaultsResponse] {
	return runtime.NewPager(runtime.PagingHandler[UsagesClientListByVaultsResponse]{
		...
		Fetcher: func(ctx context.Context, page *UsagesClientListByVaultsResponse) (UsagesClientListByVaultsResponse, error) {
			...
			req, err := client.listByVaultsCreateRequest(ctx, resourceGroupName, vaultName, nextLink, options)
			if err != nil {
			...
			return client.listByVaultsHandleResponse(resp, http.StatusOK)
		},
...
func (client *UsagesClient) listByVaultsCreateRequest(ctx context.Context, resourceGroupName string, vaultName string, nextLink string, _ *UsagesClientListByVaultsOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *UsagesClient) listByVaultsHandleResponse(resp *http.Response, successCodes ...int) (UsagesClientListByVaultsResponse, error) {
