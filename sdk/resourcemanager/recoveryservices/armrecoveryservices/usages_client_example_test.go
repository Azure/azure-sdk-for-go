...
// Generated from example definition: 2025-08-01/ListUsages.json
func ExampleUsagesClient_NewListByVaultsPager() {
	...
	for pager.More() {
		...
		// page = armrecoveryservices.UsagesClientListByVaultsResponse{
		// 	VaultUsageList: armrecoveryservices.VaultUsageList{
