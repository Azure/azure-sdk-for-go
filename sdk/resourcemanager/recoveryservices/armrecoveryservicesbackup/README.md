...
```go
client := armrecoveryservicesbackup.NewReplicationUsagesClient(<subscription ID>, cred, nil)
```
...
client := armrecoveryservicesbackup.NewReplicationUsagesClient(<subscription ID>, cred, &options)
```
