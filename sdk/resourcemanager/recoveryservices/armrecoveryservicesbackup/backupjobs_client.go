...
func (client *BackupJobsClient) listCreateRequest(ctx context.Context, vaultName string, resourceGroupName string, nextLink string, options *BackupJobsClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *BackupJobsClient) listHandleResponse(resp *http.Response, successCodes ...int) (BackupJobsClientListResponse, error) {
