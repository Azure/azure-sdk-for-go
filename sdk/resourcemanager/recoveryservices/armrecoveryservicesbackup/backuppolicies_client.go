...
func (client *BackupPoliciesClient) listCreateRequest(ctx context.Context, vaultName string, resourceGroupName string, nextLink string, options *BackupPoliciesClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
