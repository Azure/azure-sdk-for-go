...
func (client *BackupProtectableItemsClient) listCreateRequest(ctx context.Context, vaultName string, resourceGroupName string, nextLink string, options *BackupProtectableItemsClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *BackupProtectableItemsClient) listHandleResponse(resp *http.Response, successCodes ...int) (BackupProtectableItemsClientListResponse, error) {
