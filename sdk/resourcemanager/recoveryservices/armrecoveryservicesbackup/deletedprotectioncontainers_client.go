...
func (client *DeletedProtectionContainersClient) listCreateRequest(ctx context.Context, resourceGroupName string, vaultName string, nextLink string, options *DeletedProtectionContainersClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *DeletedProtectionContainersClient) listHandleResponse(resp *http.Response, successCodes ...int) (DeletedProtectionContainersClientListResponse, error) {
