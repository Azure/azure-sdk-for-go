...
// Generated from example definition: 2026-01-31-preview/AzureStorage/SoftDeletedContainers_List.json
func ExampleDeletedProtectionContainersClient_NewListPager() {
	...
	pager := clientFactory.NewDeletedProtectionContainersClient().NewListPager("testRg", "testVault", &armrecoveryservicesbackup.DeletedProtectionContainersClientListOptions{
	...
	for pager.More() {
		...
		// page = armrecoveryservicesbackup.DeletedProtectionContainersClientListResponse{
