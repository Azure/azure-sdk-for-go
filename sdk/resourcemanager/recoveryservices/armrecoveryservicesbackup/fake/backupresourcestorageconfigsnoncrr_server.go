...
func (b *BackupResourceStorageConfigsNonCRRServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	resultChan := make(chan result, 1)
	go func() {
		var intercepted bool
		var res result
		if backupResourceStorageConfigsNonCrrServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = backupResourceStorageConfigsNonCrrServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "BackupResourceStorageConfigsNonCRRClient.Patch":
				res.resp, res.err = b.dispatchPatch(req)
...
func (b *BackupResourceStorageConfigsNonCRRServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.RecoveryServices/vaults/(?P<vaultName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/backupstorageconfig/vaultstorageconfig`
...
// set this to conditionally intercept incoming requests to BackupResourceStorageConfigsNonCRRServerTransport
var backupResourceStorageConfigsNonCrrServerTransportInterceptor interface {
