...
// ConfigureSourceScanClientBeginExecuteOptions contains the optional parameters for the ConfigureSourceScanClient.BeginExecute
// method.
type ConfigureSourceScanClientBeginExecuteOptions struct {
	// Resumes the long-running operation from the provided token.
	ResumeToken string
}
