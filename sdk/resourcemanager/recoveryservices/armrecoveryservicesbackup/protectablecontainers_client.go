...
func (client *ProtectableContainersClient) NewListPager(vaultName string, resourceGroupName string, fabricName string, options *ProtectableContainersClientListOptions) *runtime.Pager[ProtectableContainersClientListResponse] {
	return runtime.NewPager(runtime.PagingHandler[ProtectableContainersClientListResponse]{
		...
		Fetcher: func(ctx context.Context, page *ProtectableContainersClientListResponse) (ProtectableContainersClientListResponse, error) {
			...
			req, err := client.listCreateRequest(ctx, vaultName, resourceGroupName, fabricName, nextLink, options)
			if err != nil {
...
func (client *ProtectableContainersClient) listCreateRequest(ctx context.Context, vaultName string, resourceGroupName string, fabricName string, nextLink string, options *ProtectableContainersClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *ProtectableContainersClient) listHandleResponse(resp *http.Response, successCodes ...int) (ProtectableContainersClientListResponse, error) {
