...
// x-ms-original-file: specification/recoveryservices/resource-manager/Microsoft.RecoveryServices/stable/2021-12-01/examples/PUTVaultCred.json
func ExampleVaultCertificatesClient_Create() {
	...
	client := armrecoveryservicesbackup.NewVaultCertificatesClient("<subscription-id>", cred, nil)
	res, err := client.Create(ctx,
		"<resource-group-name>",
		"<vault-name>",
		"<certificate-name>",
		armrecoveryservicesbackup.CertificateRequest{
			Properties: &armrecoveryservicesbackup.RawCertificateData{
				AuthType:    armrecoveryservicesbackup.AuthType("AAD").ToPtr(),
