...
// method.
func (client *PrivateLinkResourcesClient) List(resourceGroupName string, vaultName string, options *PrivateLinkResourcesClientListOptions) *PrivateLinkResourcesClientListPager {
