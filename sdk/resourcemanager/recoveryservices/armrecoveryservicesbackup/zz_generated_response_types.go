...
// RecoveryServicesClientCheckNameAvailabilityResponse contains the response from method RecoveryServicesClient.CheckNameAvailability.
type RecoveryServicesClientCheckNameAvailabilityResponse struct {
	RecoveryServicesClientCheckNameAvailabilityResult
	// RawResponse contains the underlying HTTP response.
	RawResponse *http.Response
}

// RecoveryServicesClientCheckNameAvailabilityResult contains the result from method RecoveryServicesClient.CheckNameAvailability.
type RecoveryServicesClientCheckNameAvailabilityResult struct {
