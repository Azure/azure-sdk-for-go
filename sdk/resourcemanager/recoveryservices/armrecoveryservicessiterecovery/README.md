...
```go
client, err := armrecoveryservicessiterecovery.NewPrivateLinkResourcesClient(<subscription ID>, cred, nil)
```
...
client, err := armrecoveryservicessiterecovery.NewPrivateLinkResourcesClient(<subscription ID>, cred, &options)
```
