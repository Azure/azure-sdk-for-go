...
Azure Recovery Services Site Recovery module consists of one or more clients. We provide a client factory which could be used to create any client in this module.
...
```go
client := clientFactory.NewReplicationAppliancesClient()
```
