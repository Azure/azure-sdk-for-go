...
type ReplicationEligibilityResultsServer struct {
	...
	// NewListPager is the fake for method ReplicationEligibilityResultsClient.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager func(resourceGroupName string, virtualMachineName string, options *armrecoveryservicessiterecovery.ReplicationEligibilityResultsClientListOptions) (resp azfake.PagerResponder[armrecoveryservicessiterecovery.ReplicationEligibilityResultsClientListResponse])
}
...
func NewReplicationEligibilityResultsServerTransport(srv *ReplicationEligibilityResultsServer) *ReplicationEligibilityResultsServerTransport {
	return &ReplicationEligibilityResultsServerTransport{
		srv:          srv,
		newListPager: newTracker[azfake.PagerResponder[armrecoveryservicessiterecovery.ReplicationEligibilityResultsClientListResponse]](),
	}
}
...
type ReplicationEligibilityResultsServerTransport struct {
	...
	newListPager *tracker[azfake.PagerResponder[armrecoveryservicessiterecovery.ReplicationEligibilityResultsClientListResponse]]
}
...
func (r *ReplicationEligibilityResultsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		if !intercepted {
			...
			case "ReplicationEligibilityResultsClient.NewListPager":
...
func (r *ReplicationEligibilityResultsServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		resp := r.srv.NewListPager(resourceGroupNameParam, virtualMachineNameParam, nil)
		newListPager = &resp
