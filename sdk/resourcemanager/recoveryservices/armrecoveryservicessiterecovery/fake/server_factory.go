...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "ClusterRecoveryPointClient":
		initServer(&s.trMu, &s.trClusterRecoveryPointServer, func() *ClusterRecoveryPointServerTransport {
	...
	case "ClusterRecoveryPointsClient":
		initServer(&s.trMu, &s.trClusterRecoveryPointsServer, func() *ClusterRecoveryPointsServerTransport {
	...
	case "MigrationRecoveryPointsClient":
		initServer(&s.trMu, &s.trMigrationRecoveryPointsServer, func() *MigrationRecoveryPointsServerTransport {
	...
	case "ReplicationAlertSettingsClient":
		initServer(&s.trMu, &s.trReplicationAlertSettingsServer, func() *ReplicationAlertSettingsServerTransport {
	...
	case "ReplicationAppliancesClient":
		initServer(&s.trMu, &s.trReplicationAppliancesServer, func() *ReplicationAppliancesServerTransport {
	...
	case "ReplicationEligibilityResultsClient":
		initServer(&s.trMu, &s.trReplicationEligibilityResultsServer, func() *ReplicationEligibilityResultsServerTransport {
	...
	case "ReplicationEventsClient":
		initServer(&s.trMu, &s.trReplicationEventsServer, func() *ReplicationEventsServerTransport {
	...
	case "ReplicationFabricsClient":
		initServer(&s.trMu, &s.trReplicationFabricsServer, func() *ReplicationFabricsServerTransport {
	...
	case "ReplicationJobsClient":
		initServer(&s.trMu, &s.trReplicationJobsServer, func() *ReplicationJobsServerTransport {
	...
	case "ReplicationLogicalNetworksClient":
		initServer(&s.trMu, &s.trReplicationLogicalNetworksServer, func() *ReplicationLogicalNetworksServerTransport {
	...
	case "ReplicationMigrationItemsClient":
		initServer(&s.trMu, &s.trReplicationMigrationItemsServer, func() *ReplicationMigrationItemsServerTransport {
	...
	case "ReplicationNetworkMappingsClient":
		initServer(&s.trMu, &s.trReplicationNetworkMappingsServer, func() *ReplicationNetworkMappingsServerTransport {
	...
	case "ReplicationNetworksClient":
		initServer(&s.trMu, &s.trReplicationNetworksServer, func() *ReplicationNetworksServerTransport {
	...
	case "ReplicationPoliciesClient":
		initServer(&s.trMu, &s.trReplicationPoliciesServer, func() *ReplicationPoliciesServerTransport {
	...
	case "ReplicationProtectableItemsClient":
		initServer(&s.trMu, &s.trReplicationProtectableItemsServer, func() *ReplicationProtectableItemsServerTransport {
	...
	case "ReplicationProtectedItemsClient":
		initServer(&s.trMu, &s.trReplicationProtectedItemsServer, func() *ReplicationProtectedItemsServerTransport {
	...
	case "ReplicationProtectionClustersClient":
		initServer(&s.trMu, &s.trReplicationProtectionClustersServer, func() *ReplicationProtectionClustersServerTransport {
	...
	case "ReplicationProtectionContainerMappingsClient":
		initServer(&s.trMu, &s.trReplicationProtectionContainerMappingsServer, func() *ReplicationProtectionContainerMappingsServerTransport {
	...
	case "ReplicationProtectionContainersClient":
		initServer(&s.trMu, &s.trReplicationProtectionContainersServer, func() *ReplicationProtectionContainersServerTransport {
	...
	case "ReplicationProtectionIntentsClient":
		initServer(&s.trMu, &s.trReplicationProtectionIntentsServer, func() *ReplicationProtectionIntentsServerTransport {
	...
	case "ReplicationRecoveryPlansClient":
		initServer(&s.trMu, &s.trReplicationRecoveryPlansServer, func() *ReplicationRecoveryPlansServerTransport {
	...
	case "ReplicationRecoveryServicesProvidersClient":
		initServer(&s.trMu, &s.trReplicationRecoveryServicesProvidersServer, func() *ReplicationRecoveryServicesProvidersServerTransport {
	...
	case "ReplicationStorageClassificationMappingsClient":
		initServer(&s.trMu, &s.trReplicationStorageClassificationMappingsServer, func() *ReplicationStorageClassificationMappingsServerTransport {
	...
	case "ReplicationStorageClassificationsClient":
		initServer(&s.trMu, &s.trReplicationStorageClassificationsServer, func() *ReplicationStorageClassificationsServerTransport {
	...
	case "ReplicationVaultHealthClient":
		initServer(&s.trMu, &s.trReplicationVaultHealthServer, func() *ReplicationVaultHealthServerTransport {
	...
	case "ReplicationVaultSettingClient":
		initServer(&s.trMu, &s.trReplicationVaultSettingServer, func() *ReplicationVaultSettingServerTransport {
	...
	case "ReplicationvCentersClient":
		initServer(&s.trMu, &s.trReplicationvCentersServer, func() *ReplicationvCentersServerTransport {
	...
	case "SupportedOperatingSystemsClient":
		initServer(&s.trMu, &s.trSupportedOperatingSystemsServer, func() *SupportedOperatingSystemsServerTransport {
	...
	case "TargetComputeSizesClient":
		initServer(&s.trMu, &s.trTargetComputeSizesServer, func() *TargetComputeSizesServerTransport {
