...
// Generated from example definition: 2025-08-01/MigrationRecoveryPoints_ListByReplicationMigrationItems.json
func ExampleMigrationRecoveryPointsClient_NewListByReplicationMigrationItemsPager() {
	...
	for pager.More() {
		...
		// page = armrecoveryservicessiterecovery.MigrationRecoveryPointsClientListByReplicationMigrationItemsResponse{
		// 	MigrationRecoveryPointCollection: armrecoveryservicessiterecovery.MigrationRecoveryPointCollection{
