...
func (client *OperationsClient) listCreateRequest(ctx context.Context, resourceGroupName string, nextLink string, _ *OperationsClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
