...
func ExampleOperationsClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armrecoveryservicessiterecovery.OperationsClientListResponse{
		// 	OperationsDiscoveryCollection: armrecoveryservicessiterecovery.OperationsDiscoveryCollection{
