...
func unmarshalSwitchProviderProviderSpecificInputClassification(rawMsg json.RawMessage) (SwitchProviderProviderSpecificInputClassification, error) {
	if rawMsg == nil || string(rawMsg) == "null" {
		return nil, nil
	}
	var m map[string]any
	...
	var b SwitchProviderProviderSpecificInputClassification
	switch m["instanceType"] {
	case "InMageAzureV2":
		b = &InMageAzureV2SwitchProviderProviderInput{}
	default:
		b = &SwitchProviderProviderSpecificInput{}
	}
	if err := json.Unmarshal(rawMsg, b); err != nil {
		return nil, err
	}
