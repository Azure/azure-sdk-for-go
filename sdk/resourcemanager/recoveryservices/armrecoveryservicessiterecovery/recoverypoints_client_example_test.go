...
// Generated from example definition: 2025-08-01/RecoveryPoints_ListByReplicationProtectedItems.json
func ExampleRecoveryPointsClient_NewListByReplicationProtectedItemsPager() {
	...
	for pager.More() {
		...
		// page = armrecoveryservicessiterecovery.RecoveryPointsClientListByReplicationProtectedItemsResponse{
		// 	RecoveryPointCollection: armrecoveryservicessiterecovery.RecoveryPointCollection{
