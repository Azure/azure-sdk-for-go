...
// Create - Configures email notifications for this vault.
//
...
func (client *ReplicationAlertSettingsClient) createHandleResponse(resp *http.Response, successCodes ...int) (ReplicationAlertSettingsClientCreateResponse, error) {
...
// Get - Gets an email notification(alert) configuration.
//
...
func (client *ReplicationAlertSettingsClient) getHandleResponse(resp *http.Response, successCodes ...int) (ReplicationAlertSettingsClientGetResponse, error) {
...
// NewListPager - Gets the list of configured email notification(alert) configurations.
//
...
func (client *ReplicationAlertSettingsClient) listCreateRequest(ctx context.Context, resourceGroupName string, resourceName string, nextLink string, _ *ReplicationAlertSettingsClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *ReplicationAlertSettingsClient) listHandleResponse(resp *http.Response, successCodes ...int) (ReplicationAlertSettingsClientListResponse, error) {
