...
// NewListPager - Gets the validation errors in case the VM is unsuitable for protection.
//
// Validates whether a given VM can be protected or not in which case returns list of errors.
//
// Generated from API version 2025-08-01
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - virtualMachineName - Virtual Machine name.
//   - options - ReplicationEligibilityResultsClientListOptions contains the optional parameters for the ReplicationEligibilityResultsClient.NewListPager
//     method.
func (client *ReplicationEligibilityResultsClient) NewListPager(resourceGroupName string, virtualMachineName string, options *ReplicationEligibilityResultsClientListOptions) *runtime.Pager[ReplicationEligibilityResultsClientListResponse] {
	return runtime.NewPager(runtime.PagingHandler[ReplicationEligibilityResultsClientListResponse]{
		More: func(page ReplicationEligibilityResultsClientListResponse) bool {
			return false
		},
		Fetcher: func(ctx context.Context, page *ReplicationEligibilityResultsClientListResponse) (ReplicationEligibilityResultsClientListResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "ReplicationEligibilityResultsClient.NewListPager")
