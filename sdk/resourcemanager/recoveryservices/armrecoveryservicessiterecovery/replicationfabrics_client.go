...
//     method.
func (client *ReplicationFabricsClient) BeginCheckConsistency(ctx context.Context, resourceName string, resourceGroupName string, fabricName string, options *ReplicationFabricsClientBeginCheckConsistencyOptions) (*runtime.Poller[ReplicationFabricsClientCheckConsistencyResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.checkConsistency(ctx, resourceName, resourceGroupName, fabricName, options)
		if err != nil {
			return nil, err
		}
...
func (client *ReplicationFabricsClient) checkConsistencyCreateRequest(ctx context.Context, resourceName string, resourceGroupName string, fabricName string, options *ReplicationFabricsClientBeginCheckConsistencyOptions) (*policy.Request, error) {
...
//     method.
func (client *ReplicationFabricsClient) BeginCreate(ctx context.Context, resourceName string, resourceGroupName string, fabricName string, input FabricCreationInput, options *ReplicationFabricsClientBeginCreateOptions) (*runtime.Poller[ReplicationFabricsClientCreateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.create(ctx, resourceName, resourceGroupName, fabricName, input, options)
		if err != nil {
			return nil, err
		}
...
func (client *ReplicationFabricsClient) createCreateRequest(ctx context.Context, resourceName string, resourceGroupName string, fabricName string, input FabricCreationInput, options *ReplicationFabricsClientBeginCreateOptions) (*policy.Request, error) {
...
//     method.
func (client *ReplicationFabricsClient) BeginDelete(ctx context.Context, resourceName string, resourceGroupName string, fabricName string, options *ReplicationFabricsClientBeginDeleteOptions) (*runtime.Poller[ReplicationFabricsClientDeleteResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.deleteOperation(ctx, resourceName, resourceGroupName, fabricName, options)
		if err != nil {
			return nil, err
		}
...
func (client *ReplicationFabricsClient) deleteCreateRequest(ctx context.Context, resourceName string, resourceGroupName string, fabricName string, options *ReplicationFabricsClientBeginDeleteOptions) (*policy.Request, error) {
...
func (client *ReplicationFabricsClient) getCreateRequest(ctx context.Context, resourceName string, resourceGroupName string, fabricName string, options *ReplicationFabricsClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{resourceName}/replicationFabrics/{fabricName}"
	if resourceName == "" {
		return nil, errors.New("parameter resourceName cannot be empty")
	}
...
//     method.
func (client *ReplicationFabricsClient) NewListPager(resourceName string, resourceGroupName string, options *ReplicationFabricsClientListOptions) *runtime.Pager[ReplicationFabricsClientListResponse] {
...
func (client *ReplicationFabricsClient) listCreateRequest(ctx context.Context, resourceName string, resourceGroupName string, options *ReplicationFabricsClientListOptions) (*policy.Request, error) {
...
//     method.
func (client *ReplicationFabricsClient) BeginMigrateToAAD(ctx context.Context, resourceName string, resourceGroupName string, fabricName string, options *ReplicationFabricsClientBeginMigrateToAADOptions) (*runtime.Poller[ReplicationFabricsClientMigrateToAADResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.migrateToAAD(ctx, resourceName, resourceGroupName, fabricName, options)
		if err != nil {
			return nil, err
		}
...
func (client *ReplicationFabricsClient) migrateToAADCreateRequest(ctx context.Context, resourceName string, resourceGroupName string, fabricName string, options *ReplicationFabricsClientBeginMigrateToAADOptions) (*policy.Request, error) {
...
//     method.
func (client *ReplicationFabricsClient) BeginPurge(ctx context.Context, resourceName string, resourceGroupName string, fabricName string, options *ReplicationFabricsClientBeginPurgeOptions) (*runtime.Poller[ReplicationFabricsClientPurgeResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.purge(ctx, resourceName, resourceGroupName, fabricName, options)
		if err != nil {
			return nil, err
		}
...
func (client *ReplicationFabricsClient) purgeCreateRequest(ctx context.Context, resourceName string, resourceGroupName string, fabricName string, options *ReplicationFabricsClientBeginPurgeOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{resourceName}/replicationFabrics/{fabricName}"
	if resourceName == "" {
		return nil, errors.New("parameter resourceName cannot be empty")
	}
...
func (client *ReplicationFabricsClient) reassociateGatewayCreateRequest(ctx context.Context, resourceName string, resourceGroupName string, fabricName string, failoverProcessServerRequest FailoverProcessServerRequest, options *ReplicationFabricsClientBeginReassociateGatewayOptions) (*policy.Request, error) {
...
//     method.
func (client *ReplicationFabricsClient) BeginRenewCertificate(ctx context.Context, resourceName string, resourceGroupName string, fabricName string, renewCertificate RenewCertificateInput, options *ReplicationFabricsClientBeginRenewCertificateOptions) (*runtime.Poller[ReplicationFabricsClientRenewCertificateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.renewCertificate(ctx, resourceName, resourceGroupName, fabricName, renewCertificate, options)
		if err != nil {
			return nil, err
		}
...
func (client *ReplicationFabricsClient) renewCertificateCreateRequest(ctx context.Context, resourceName string, resourceGroupName string, fabricName string, renewCertificate RenewCertificateInput, options *ReplicationFabricsClientBeginRenewCertificateOptions) (*policy.Request, error) {
