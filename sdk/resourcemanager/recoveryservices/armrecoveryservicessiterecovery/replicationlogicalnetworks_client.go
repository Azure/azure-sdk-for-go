...
func (client *ReplicationLogicalNetworksClient) getHandleResponse(resp *http.Response, successCodes ...int) (ReplicationLogicalNetworksClientGetResponse, error) {
...
func (client *ReplicationLogicalNetworksClient) listByReplicationFabricsCreateRequest(ctx context.Context, resourceGroupName string, resourceName string, fabricName string, nextLink string, _ *ReplicationLogicalNetworksClientListByReplicationFabricsOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *ReplicationLogicalNetworksClient) listByReplicationFabricsHandleResponse(resp *http.Response, successCodes ...int) (ReplicationLogicalNetworksClientListByReplicationFabricsResponse, error) {
