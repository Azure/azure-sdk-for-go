...
// Generated from example definition: 2025-08-01/ReplicationLogicalNetworks_Get.json
func ExampleReplicationLogicalNetworksClient_Get() {
	...
	// res = armrecoveryservicessiterecovery.ReplicationLogicalNetworksClientGetResponse{
	// 	LogicalNetwork: &armrecoveryservicessiterecovery.LogicalNetwork{
...
// Generated from example definition: 2025-08-01/ReplicationLogicalNetworks_ListByReplicationFabrics.json
func ExampleReplicationLogicalNetworksClient_NewListByReplicationFabricsPager() {
	...
	for pager.More() {
		...
		// page = armrecoveryservicessiterecovery.ReplicationLogicalNetworksClientListByReplicationFabricsResponse{
		// 	LogicalNetworkCollection: armrecoveryservicessiterecovery.LogicalNetworkCollection{
