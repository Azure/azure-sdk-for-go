...
// Get - Gets a network with specified server id and network name.
//
...
func (client *ReplicationNetworksClient) getHandleResponse(resp *http.Response, successCodes ...int) (ReplicationNetworksClientGetResponse, error) {
...
// NewListPager - Gets the list of networks. View-only API.
//
...
func (client *ReplicationNetworksClient) listCreateRequest(ctx context.Context, resourceGroupName string, resourceName string, nextLink string, _ *ReplicationNetworksClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *ReplicationNetworksClient) listHandleResponse(resp *http.Response, successCodes ...int) (ReplicationNetworksClientListResponse, error) {
...
// NewListByReplicationFabricsPager - Gets the list of networks under a fabric.
//
...
func (client *ReplicationNetworksClient) listByReplicationFabricsCreateRequest(ctx context.Context, resourceGroupName string, resourceName string, fabricName string, nextLink string, _ *ReplicationNetworksClientListByReplicationFabricsOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
	var req *policy.Request
	var err error
	if firstPage {
...
func (client *ReplicationNetworksClient) listByReplicationFabricsHandleResponse(resp *http.Response, successCodes ...int) (ReplicationNetworksClientListByReplicationFabricsResponse, error) {
