...
// Generated from example definition: 2025-08-01/ReplicationProtectionContainerMappings_Create.json
func ExampleReplicationProtectionContainerMappingsClient_BeginCreate() {
	...
	poller, err := clientFactory.NewReplicationProtectionContainerMappingsClient().BeginCreate(ctx, "resourceGroupPS1", "vault1", "cloud1", "cloud_6d224fc6-f326-5d35-96de-fbf51efb3179", "cloud1protectionprofile1", armrecoveryservicessiterecovery.CreateProtectionContainerMappingInput{
		Properties: &armrecoveryservicessiterecovery.CreateProtectionContainerMappingInputProperties{
			...
			ProviderSpecificInput: &armrecoveryservicessiterecovery.A2AContainerMappingInput{
	...
	// res = armrecoveryservicessiterecovery.ReplicationProtectionContainerMappingsClientCreateResponse{
	// 	ProtectionContainerMapping: &armrecoveryservicessiterecovery.ProtectionContainerMapping{
...
// Generated from example definition: 2025-08-01/ReplicationProtectionContainerMappings_Get.json
func ExampleReplicationProtectionContainerMappingsClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armrecoveryservicessiterecovery.ReplicationProtectionContainerMappingsClientGetResponse{
	// 	ProtectionContainerMapping: &armrecoveryservicessiterecovery.ProtectionContainerMapping{
	// 		Name: to.Ptr("cloud1protectionprofile1"),
	// 		Type: to.Ptr("Microsoft.RecoveryServices/vaults/replicationFabrics/replicationProtectionContainers/replicationProtectionContainerMappings"),
	// 		ID: to.Ptr("/Subscriptions/c183865e-6077-46f2-a3b1-deb0f4f4650a/resourceGroups/resourceGroupPS1/providers/Microsoft.RecoveryServices/vaults/vault1/replicationFabrics/cloud1/replicationProtectionContainers/cloud_6d224fc6-f326-5d35-96de-fbf51efb3179/replicationProtectionContainerMappings/cloud1protectionprofile1"),
...
// Generated from example definition: 2025-08-01/ReplicationProtectionContainerMappings_List.json
func ExampleReplicationProtectionContainerMappingsClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armrecoveryservicessiterecovery.ReplicationProtectionContainerMappingsClientListResponse{
		// 	ProtectionContainerMappingCollection: armrecoveryservicessiterecovery.ProtectionContainerMappingCollection{
...
// Generated from example definition: 2025-08-01/ReplicationProtectionContainerMappings_ListByReplicationProtectionContainers.json
func ExampleReplicationProtectionContainerMappingsClient_NewListByReplicationProtectionContainersPager() {
	...
	for pager.More() {
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armrecoveryservicessiterecovery.ReplicationProtectionContainerMappingsClientListByReplicationProtectionContainersResponse{
		// 	ProtectionContainerMappingCollection: armrecoveryservicessiterecovery.ProtectionContainerMappingCollection{
		// 		Value: []*armrecoveryservicessiterecovery.ProtectionContainerMapping{
		// 			{
		// 				Name: to.Ptr("cloud1protectionprofile1"),
...
// Generated from example definition: 2025-08-01/ReplicationProtectionContainerMappings_Purge.json
...
// Generated from example definition: 2025-08-01/ReplicationProtectionContainerMappings_Update.json
func ExampleReplicationProtectionContainerMappingsClient_BeginUpdate() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armrecoveryservicessiterecovery.ReplicationProtectionContainerMappingsClientUpdateResponse{
	// 	ProtectionContainerMapping: &armrecoveryservicessiterecovery.ProtectionContainerMapping{
	// 		Name: to.Ptr("cloud1protectionprofile1"),
	// 		Type: to.Ptr("Microsoft.RecoveryServices/vaults/replicationFabrics/replicationProtectionContainers/replicationProtectionContainerMappings"),
	// 		ID: to.Ptr("/Subscriptions/c183865e-6077-46f2-a3b1-deb0f4f4650a/resourceGroups/resourceGroupPS1/providers/Microsoft.RecoveryServices/vaults/vault1/replicationFabrics/cloud1/replicationProtectionContainers/cloud_6d224fc6-f326-5d35-96de-fbf51efb3179/replicationProtectionContainerMappings/cloud1protectionprofile1"),
