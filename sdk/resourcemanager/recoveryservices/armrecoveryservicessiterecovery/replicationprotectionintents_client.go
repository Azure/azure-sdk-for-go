...
// Create - Create protection intent Resource.
//
...
func (client *ReplicationProtectionIntentsClient) createHandleResponse(resp *http.Response, successCodes ...int) (ReplicationProtectionIntentsClientCreateResponse, error) {
...
// Get - Gets the details of a Replication protection intent item.
//
...
func (client *ReplicationProtectionIntentsClient) getHandleResponse(resp *http.Response, successCodes ...int) (ReplicationProtectionIntentsClientGetResponse, error) {
...
// NewListPager - Gets the list of replication protection intent objects.
//
...
func (client *ReplicationProtectionIntentsClient) listCreateRequest(ctx context.Context, resourceGroupName string, resourceName string, nextLink string, options *ReplicationProtectionIntentsClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *ReplicationProtectionIntentsClient) listHandleResponse(resp *http.Response, successCodes ...int) (ReplicationProtectionIntentsClientListResponse, error) {
