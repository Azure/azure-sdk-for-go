...
// Generated from example definition: 2025-08-01/ReplicationProtectionIntents_Create.json
func ExampleReplicationProtectionIntentsClient_Create() {
	...
	clientFactory, err := armrecoveryservicessiterecovery.NewClientFactory("509099b2-9d2c-4636-b43e-bd5cafb6be69", cred, nil)
	if err != nil {
	...
	// res = armrecoveryservicessiterecovery.ReplicationProtectionIntentsClientCreateResponse{
...
// Generated from example definition: 2025-08-01/ReplicationProtectionIntents_Get.json
...
// Generated from example definition: 2025-08-01/ReplicationProtectionIntents_List.json
func ExampleReplicationProtectionIntentsClient_NewListPager() {
	...
	pager := clientFactory.NewReplicationProtectionIntentsClient().NewListPager("resourceGroupPS1", "2007vttp", nil)
	for pager.More() {
		...
		// page = armrecoveryservicessiterecovery.ReplicationProtectionIntentsClientListResponse{
		// 	ReplicationProtectionIntentCollection: armrecoveryservicessiterecovery.ReplicationProtectionIntentCollection{
