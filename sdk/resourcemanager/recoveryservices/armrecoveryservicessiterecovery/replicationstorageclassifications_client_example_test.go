...
// Generated from example definition: 2025-08-01/ReplicationStorageClassifications_Get.json
func ExampleReplicationStorageClassificationsClient_Get() {
	...
	// res = armrecoveryservicessiterecovery.ReplicationStorageClassificationsClientGetResponse{
	// 	StorageClassification: &armrecoveryservicessiterecovery.StorageClassification{
...
// Generated from example definition: 2025-08-01/ReplicationStorageClassifications_List.json
func ExampleReplicationStorageClassificationsClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armrecoveryservicessiterecovery.ReplicationStorageClassificationsClientListResponse{
		// 	StorageClassificationCollection: armrecoveryservicessiterecovery.StorageClassificationCollection{
...
// Generated from example definition: 2025-08-01/ReplicationStorageClassifications_ListByReplicationFabrics.json
func ExampleReplicationStorageClassificationsClient_NewListByReplicationFabricsPager() {
	...
	for pager.More() {
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armrecoveryservicessiterecovery.ReplicationStorageClassificationsClientListByReplicationFabricsResponse{
		// 	StorageClassificationCollection: armrecoveryservicessiterecovery.StorageClassificationCollection{
		// 		Value: []*armrecoveryservicessiterecovery.StorageClassification{
		// 			{
		// 				Name: to.Ptr("8891569e-aaef-4a46-a4a0-78c14f2d7b09"),
