...
func (client *ReplicationvCentersClient) getHandleResponse(resp *http.Response, successCodes ...int) (ReplicationvCentersClientGetResponse, error) {
...
func (client *ReplicationvCentersClient) listCreateRequest(ctx context.Context, resourceGroupName string, resourceName string, nextLink string, _ *ReplicationvCentersClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *ReplicationvCentersClient) listHandleResponse(resp *http.Response, successCodes ...int) (ReplicationvCentersClientListResponse, error) {
...
func (client *ReplicationvCentersClient) listByReplicationFabricsCreateRequest(ctx context.Context, resourceGroupName string, resourceName string, fabricName string, nextLink string, _ *ReplicationvCentersClientListByReplicationFabricsOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
	var req *policy.Request
	var err error
	if firstPage {
...
func (client *ReplicationvCentersClient) listByReplicationFabricsHandleResponse(resp *http.Response, successCodes ...int) (ReplicationvCentersClientListByReplicationFabricsResponse, error) {
