...
func (client *TargetComputeSizesClient) listByReplicationProtectedItemsHandleResponse(resp *http.Response, successCodes ...int) (TargetComputeSizesClientListByReplicationProtectedItemsResponse, error) {
