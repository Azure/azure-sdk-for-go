...
func (client *EventClient) getHandleResponse(resp *http.Response, successCodes ...int) (EventClientGetResponse, error) {
...
func (client *EventClient) listCreateRequest(ctx context.Context, resourceGroupName string, vaultName string, nextLink string, options *EventClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *EventClient) listHandleResponse(resp *http.Response, successCodes ...int) (EventClientListResponse, error) {
