...
func ExampleEventClient_Get() {
	...
	// 			EventName: to.Ptr("s"),
	// 			TimeOfOccurrence: to.Ptr(time.Date(2023, time.August, 25, 0, 28, 53, 432000000, time.UTC)),
	...
	// 			CreatedAt: to.Ptr(time.Date(2023, time.August, 25, 0, 28, 53, 432000000, time.UTC)),
	...
	// 			LastModifiedAt: to.Ptr(time.Date(2023, time.August, 25, 0, 28, 53, 432000000, time.UTC)),
	// 		},
	// 	},
	// }
}
