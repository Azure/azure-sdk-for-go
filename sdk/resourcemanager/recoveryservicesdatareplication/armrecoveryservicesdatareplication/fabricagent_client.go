...
func (client *FabricAgentClient) getHandleResponse(resp *http.Response, successCodes ...int) (FabricAgentClientGetResponse, error) {
...
func (client *FabricAgentClient) NewListPager(resourceGroupName string, fabricName string, options *FabricAgentClientListOptions) *runtime.Pager[FabricAgentClientListResponse] {
	return runtime.NewPager(runtime.PagingHandler[FabricAgentClientListResponse]{
		...
		Fetcher: func(ctx context.Context, page *FabricAgentClientListResponse) (FabricAgentClientListResponse, error) {
			...
			req, err := client.listCreateRequest(ctx, resourceGroupName, fabricName, nextLink, options)
			if err != nil {
...
func (client *FabricAgentClient) listCreateRequest(ctx context.Context, resourceGroupName string, fabricName string, nextLink string, _ *FabricAgentClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *FabricAgentClient) listHandleResponse(resp *http.Response, successCodes ...int) (FabricAgentClientListResponse, error) {
