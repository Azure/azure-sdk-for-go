...
func (client *PrivateEndpointConnectionsClient) listCreateRequest(ctx context.Context, resourceGroupName string, vaultName string, nextLink string, _ *PrivateEndpointConnectionsClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
