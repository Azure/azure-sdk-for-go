...
func (client *PrivateLinkResourcesClient) listCreateRequest(ctx context.Context, resourceGroupName string, vaultName string, nextLink string, _ *PrivateLinkResourcesClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
