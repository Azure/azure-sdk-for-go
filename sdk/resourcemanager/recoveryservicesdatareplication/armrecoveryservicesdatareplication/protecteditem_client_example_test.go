...
func ExampleProtectedItemClient_BeginCreate() {
	...
	// 			LastSuccessfulPlannedFailoverTime: to.Ptr(time.Date(2023, time.August, 25, 0, 28, 55, 456000000, time.UTC)),
	// 			LastSuccessfulUnplannedFailoverTime: to.Ptr(time.Date(2023, time.August, 25, 0, 28, 55, 456000000, time.UTC)),
	// 			LastSuccessfulTestFailoverTime: to.Ptr(time.Date(2023, time.August, 25, 0, 28, 55, 456000000, time.UTC)),
	...
	// 				StartTime: to.Ptr(time.Date(2023, time.August, 25, 0, 28, 55, 456000000, time.UTC)),
	// 				EndTime: to.Ptr(time.Date(2023, time.August, 25, 0, 28, 55, 456000000, time.UTC)),
	// 			},
	// 			AllowedJobs: []*string{
	...
	// 			CreatedAt: to.Ptr(time.Date(2023, time.August, 25, 0, 28, 55, 456000000, time.UTC)),
	// 			LastModifiedBy: to.Ptr("epo"),
	// 			LastModifiedByType: to.Ptr(armrecoveryservicesdatareplication.CreatedByType("ekzmwexhjttb")),
	// 			LastModifiedAt: to.Ptr(time.Date(2023, time.August, 25, 0, 28, 55, 456000000, time.UTC)),
	// 		},
	// 	},
	// }
}
