...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "OpenShiftClustersClient":
		initServer(&s.trMu, &s.trOpenShiftClustersServer, func() *OpenShiftClustersServerTransport {
	...
	case "OpenShiftVersionsClient":
		initServer(&s.trMu, &s.trOpenShiftVersionsServer, func() *OpenShiftVersionsServerTransport {
	...
	case "PlatformWorkloadIdentityRoleSetClient":
		initServer(&s.trMu, &s.trPlatformWorkloadIdentityRoleSetServer, func() *PlatformWorkloadIdentityRoleSetServerTransport {
	...
	case "PlatformWorkloadIdentityRoleSetsClient":
		initServer(&s.trMu, &s.trPlatformWorkloadIdentityRoleSetsServer, func() *PlatformWorkloadIdentityRoleSetsServerTransport {
