...
import (
	...
	"github.com/Azure/azure-sdk-for-go/sdk/resourcemanager/redhatopenshift/armredhatopenshift/v3"
	"log"
)

// Generated from example definition: 2025-07-25/OpenShiftClusters_CreateOrUpdate.json
func ExampleOpenShiftClustersClient_BeginCreateOrUpdate() {
	...
	clientFactory, err := armredhatopenshift.NewClientFactory("00000000-0000-0000-0000-000000000000", cred, nil)
	if err != nil {
	...
	// res = armredhatopenshift.OpenShiftClustersClientCreateOrUpdateResponse{
	// 	OpenShiftCluster: &armredhatopenshift.OpenShiftCluster{
...
// Generated from example definition: 2025-07-25/OpenShiftClusters_Delete.json
...
// Generated from example definition: 2025-07-25/OpenShiftClusters_Get.json
func ExampleOpenShiftClustersClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armredhatopenshift.OpenShiftClustersClientGetResponse{
	// 	OpenShiftCluster: &armredhatopenshift.OpenShiftCluster{
	// 		Name: to.Ptr("resourceName"),
	// 		Type: to.Ptr("Microsoft.RedHatOpenShift/OpenShiftClusters"),
	// 		ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/resourceGroup/providers/Microsoft.RedHatOpenShift/OpenShiftClusters/resourceName"),
...
// Generated from example definition: 2025-07-25/OpenShiftClusters_List.json
func ExampleOpenShiftClustersClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armredhatopenshift.OpenShiftClustersClientListResponse{
		// 	OpenShiftClusterList: armredhatopenshift.OpenShiftClusterList{
...
// Generated from example definition: 2025-07-25/OpenShiftClusters_ListAdminCredentials.json
func ExampleOpenShiftClustersClient_ListAdminCredentials() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armredhatopenshift.OpenShiftClustersClientListAdminCredentialsResponse{
	// 	OpenShiftClusterAdminKubeconfig: &armredhatopenshift.OpenShiftClusterAdminKubeconfig{
	// 		Kubeconfig: to.Ptr("e30="),
	// 	},
	// }
}

// Generated from example definition: 2025-07-25/OpenShiftClusters_ListByResourceGroup.json
func ExampleOpenShiftClustersClient_NewListByResourceGroupPager() {
	...
	for pager.More() {
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armredhatopenshift.OpenShiftClustersClientListByResourceGroupResponse{
		// 	OpenShiftClusterList: armredhatopenshift.OpenShiftClusterList{
		// 		Value: []*armredhatopenshift.OpenShiftCluster{
		// 			{
		// 				Name: to.Ptr("resourceName"),
...
// Generated from example definition: 2025-07-25/OpenShiftClusters_ListCredentials.json
func ExampleOpenShiftClustersClient_ListCredentials() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armredhatopenshift.OpenShiftClustersClientListCredentialsResponse{
	// 	OpenShiftClusterCredentials: &armredhatopenshift.OpenShiftClusterCredentials{
...
// Generated from example definition: 2025-07-25/OpenShiftClusters_Update.json
func ExampleOpenShiftClustersClient_BeginUpdate() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armredhatopenshift.OpenShiftClustersClientUpdateResponse{
	// 	OpenShiftCluster: &armredhatopenshift.OpenShiftCluster{
	// 		Name: to.Ptr("resourceName"),
	// 		Type: to.Ptr("Microsoft.RedHatOpenShift/OpenShiftClusters"),
	// 		ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/resourceGroup/providers/Microsoft.RedHatOpenShift/OpenShiftClusters/resourceName"),
