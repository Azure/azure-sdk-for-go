...
func (a *AsyncOperationStatusServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.Cache/locations/(?P<location>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/asyncOperations/(?P<operationId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)`
