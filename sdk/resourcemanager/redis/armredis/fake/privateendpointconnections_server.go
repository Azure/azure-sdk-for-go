...
// The returned PrivateEndpointConnectionsServerTransport instance is connected to an instance of armredis.PrivateEndpointConnectionsClient via the
// azcore.ClientOptions.Transporter field in the client's constructor parameters.
func NewPrivateEndpointConnectionsServerTransport(srv *PrivateEndpointConnectionsServer) *PrivateEndpointConnectionsServerTransport {
	return &PrivateEndpointConnectionsServerTransport{
		srv:          srv,
		newListPager: newTracker[azfake.PagerResponder[armredis.PrivateEndpointConnectionsClientListResponse]](),
		beginPut:     newTracker[azfake.PollerResponder[armredis.PrivateEndpointConnectionsClientPutResponse]](),
	}
}

// PrivateEndpointConnectionsServerTransport connects instances of armredis.PrivateEndpointConnectionsClient to instances of PrivateEndpointConnectionsServer.
...
type PrivateEndpointConnectionsServerTransport struct {
	...
	newListPager *tracker[azfake.PagerResponder[armredis.PrivateEndpointConnectionsClientListResponse]]
	beginPut     *tracker[azfake.PollerResponder[armredis.PrivateEndpointConnectionsClientPutResponse]]
}
...
func (p *PrivateEndpointConnectionsServerTransport) dispatchDelete(req *http.Request) (*http.Response, error) {
	...
	const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.Cache/redis/(?P<cacheName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/privateEndpointConnections/(?P<privateEndpointConnectionName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)`
	...
	respr, errRespr := p.srv.Delete(req.Context(), resourceGroupNameParam, cacheNameParam, privateEndpointConnectionNameParam, nil)
...
func (p *PrivateEndpointConnectionsServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := p.srv.Get(req.Context(), resourceGroupNameParam, cacheNameParam, privateEndpointConnectionNameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (p *PrivateEndpointConnectionsServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.Cache/redis/(?P<cacheName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/privateEndpointConnections`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 4 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
		...
		resp := p.srv.NewListPager(resourceGroupNameParam, cacheNameParam, nil)
		newListPager = &resp
		p.newListPager.add(req, newListPager)
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armredis.PrivateEndpointConnectionsClientListResponse, createLink func() string) {
...
func (p *PrivateEndpointConnectionsServerTransport) dispatchBeginPut(req *http.Request) (*http.Response, error) {
	...
	if beginPut == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armredis.PrivateEndpointConnection](req)
		if err != nil {
			return nil, err
		}
		resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
		...
		respr, errRespr := p.srv.BeginPut(req.Context(), resourceGroupNameParam, cacheNameParam, privateEndpointConnectionNameParam, body, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginPut = &respr
