...
func (client *FirewallRulesClient) listCreateRequest(ctx context.Context, resourceGroupName string, cacheName string, _ *FirewallRulesClientListOptions) (*policy.Request, error) {
