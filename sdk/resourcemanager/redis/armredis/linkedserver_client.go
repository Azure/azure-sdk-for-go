...
func (client *LinkedServerClient) getHandleResponse(resp *http.Response, successCodes ...int) (LinkedServerClientGetResponse, error) {
...
func (client *LinkedServerClient) listCreateRequest(ctx context.Context, resourceGroupName string, name string, nextLink string, _ *LinkedServerClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *LinkedServerClient) listHandleResponse(resp *http.Response, successCodes ...int) (LinkedServerClientListResponse, error) {
