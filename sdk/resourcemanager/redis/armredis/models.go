...
type CacheAccessPolicyAssignmentList struct {
	// REQUIRED; The RedisCacheAccessPolicyAssignment items on this page
...
type CacheAccessPolicyList struct {
	// REQUIRED; The RedisCacheAccessPolicy items on this page
...
type CommonPropertiesRedisConfiguration struct {
	...
	// you should never disable authentication using this property!
...
type CreateProperties struct {
	...
	// passed in by you using the 'zones' parameter. 'NoZones' will produce a non-zonal cache. If 'zonalAllocationPolicy' is not
	// passed, it will be set to 'UserDefined' when zones are passed in, otherwise, it will be set to 'Automatic' in regions where
	// zones are supported and 'NoZones' in regions where zones are not supported.
...
// FirewallRuleListResult - The response of a RedisFirewallRule list operation.
type FirewallRuleListResult struct {
	// REQUIRED; The RedisFirewallRule items on this page
	Value []*FirewallRule
...
type LinkedServerWithPropertiesList struct {
	// REQUIRED; The RedisLinkedServerWithProperties items on this page
...
type ListResult struct {
	// REQUIRED; The RedisResource items on this page
	Value []*ResourceInfo
...
type NotificationListResponse struct {
	// REQUIRED; The UpgradeNotification items on this page
...
// PatchScheduleListResult - The response of a RedisPatchSchedule list operation.
type PatchScheduleListResult struct {
	// REQUIRED; The RedisPatchSchedule items on this page
	Value []*PatchSchedule
