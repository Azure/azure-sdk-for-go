...
// Generated from example definition: 2024-11-01/RedisCacheOperations.json
func ExampleOperationsClient_NewListPager() {
	...
	clientFactory, err := armredis.NewClientFactory("<subscriptionID>", cred, nil)
	if err != nil {
	...
	for pager.More() {
		...
		// page = armredis.OperationsClientListResponse{
		// 	OperationListResult: armredis.OperationListResult{
