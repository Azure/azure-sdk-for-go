...
func (client *PrivateLinkResourcesClient) NewListByRedisCachePager(resourceGroupName string, cacheName string, options *PrivateLinkResourcesClientListByRedisCacheOptions) *runtime.Pager[PrivateLinkResourcesClientListByRedisCacheResponse] {
	return runtime.NewPager(runtime.PagingHandler[PrivateLinkResourcesClientListByRedisCacheResponse]{
		...
		Fetcher: func(ctx context.Context, page *PrivateLinkResourcesClientListByRedisCacheResponse) (PrivateLinkResourcesClientListByRedisCacheResponse, error) {
			...
			req, err := client.listByRedisCacheCreateRequest(ctx, resourceGroupName, cacheName, nextLink, options)
			if err != nil {
			...
			return client.listByRedisCacheHandleResponse(resp, http.StatusOK)
		},
...
func (client *PrivateLinkResourcesClient) listByRedisCacheCreateRequest(ctx context.Context, resourceGroupName string, cacheName string, nextLink string, _ *PrivateLinkResourcesClientListByRedisCacheOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *PrivateLinkResourcesClient) listByRedisCacheHandleResponse(resp *http.Response, successCodes ...int) (PrivateLinkResourcesClientListByRedisCacheResponse, error) {
