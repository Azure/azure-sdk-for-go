...
// Generated from example definition: 2024-11-01/RedisCacheListPrivateLinkResources.json
func ExamplePrivateLinkResourcesClient_NewListByRedisCachePager() {
	...
	for pager.More() {
		...
		// page = armredis.PrivateLinkResourcesClientListByRedisCacheResponse{
		// 	PrivateLinkResourceListResult: armredis.PrivateLinkResourceListResult{
		// 		Value: []*armredis.PrivateLinkResource{
		// 			{
		// 				Name: to.Ptr("redisCache"),
		// 				Type: to.Ptr("Microsoft.Cache/Redis/privateLinkResources"),
		// 				ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rgtest01/providers/Microsoft.Cache/Redis/cacheTest01/privateLinkResources/redisCache"),
