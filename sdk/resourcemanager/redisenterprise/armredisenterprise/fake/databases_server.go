...
type DatabasesServer struct {
	...
	BeginCreate	func(ctx context.Context, resourceGroupName string, clusterName string, databaseName string, parameters armredisenterprise.Database, options *armredisenterprise.BeginCreateOptions) (resp azfake.PollerResponder[armredisenterprise.CreateResponse], errResp azfake.ErrorResponder)

	// BeginDelete is the fake for method DatabasesClient.BeginDelete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginDelete	func(ctx context.Context, resourceGroupName string, clusterName string, databaseName string, options *armredisenterprise.BeginDeleteOptions) (resp azfake.PollerResponder[armredisenterprise.DeleteResponse], errResp azfake.ErrorResponder)

	// BeginExport is the fake for method DatabasesClient.BeginExport
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginExport	func(ctx context.Context, resourceGroupName string, clusterName string, databaseName string, parameters armredisenterprise.ExportClusterParameters, options *armredisenterprise.BeginExportOptions) (resp azfake.PollerResponder[armredisenterprise.ExportResponse], errResp azfake.ErrorResponder)

	// BeginFlush is the fake for method DatabasesClient.BeginFlush
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginFlush	func(ctx context.Context, resourceGroupName string, clusterName string, databaseName string, options *armredisenterprise.BeginFlushOptions) (resp azfake.PollerResponder[armredisenterprise.FlushResponse], errResp azfake.ErrorResponder)

	// BeginForceLinkToReplicationGroup is the fake for method DatabasesClient.BeginForceLinkToReplicationGroup
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginForceLinkToReplicationGroup	func(ctx context.Context, resourceGroupName string, clusterName string, databaseName string, parameters armredisenterprise.ForceLinkParameters, options *armredisenterprise.BeginForceLinkToReplicationGroupOptions) (resp azfake.PollerResponder[armredisenterprise.ForceLinkToReplicationGroupResponse], errResp azfake.ErrorResponder)

	// BeginForceUnlink is the fake for method DatabasesClient.BeginForceUnlink
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginForceUnlink	func(ctx context.Context, resourceGroupName string, clusterName string, databaseName string, parameters armredisenterprise.ForceUnlinkParameters, options *armredisenterprise.BeginForceUnlinkOptions) (resp azfake.PollerResponder[armredisenterprise.ForceUnlinkResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method DatabasesClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get	func(ctx context.Context, resourceGroupName string, clusterName string, databaseName string, options *armredisenterprise.GetOptions) (resp azfake.Responder[armredisenterprise.GetResponse], errResp azfake.ErrorResponder)

	// BeginImport is the fake for method DatabasesClient.BeginImport
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginImport	func(ctx context.Context, resourceGroupName string, clusterName string, databaseName string, parameters armredisenterprise.ImportClusterParameters, options *armredisenterprise.BeginImportOptions) (resp azfake.PollerResponder[armredisenterprise.ImportResponse], errResp azfake.ErrorResponder)

	// NewListByClusterPager is the fake for method DatabasesClient.NewListByClusterPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByClusterPager	func(resourceGroupName string, clusterName string, options *armredisenterprise.ListByClusterOptions) (resp azfake.PagerResponder[armredisenterprise.ListByClusterResponse])

	// ListKeys is the fake for method DatabasesClient.ListKeys
	// HTTP status codes to indicate success: http.StatusOK
	ListKeys	func(ctx context.Context, resourceGroupName string, clusterName string, databaseName string, options *armredisenterprise.ListKeysOptions) (resp azfake.Responder[armredisenterprise.ListKeysResponse], errResp azfake.ErrorResponder)

	// BeginRegenerateKey is the fake for method DatabasesClient.BeginRegenerateKey
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginRegenerateKey	func(ctx context.Context, resourceGroupName string, clusterName string, databaseName string, parameters armredisenterprise.RegenerateKeyParameters, options *armredisenterprise.BeginRegenerateKeyOptions) (resp azfake.PollerResponder[armredisenterprise.RegenerateKeyResponse], errResp azfake.ErrorResponder)

	// BeginUpdate is the fake for method DatabasesClient.BeginUpdate
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginUpdate	func(ctx context.Context, resourceGroupName string, clusterName string, databaseName string, parameters armredisenterprise.DatabaseUpdate, options *armredisenterprise.BeginUpdateOptions) (resp azfake.PollerResponder[armredisenterprise.UpdateResponse], errResp azfake.ErrorResponder)

	// BeginUpgradeDBRedisVersion is the fake for method DatabasesClient.BeginUpgradeDBRedisVersion
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginUpgradeDBRedisVersion	func(ctx context.Context, resourceGroupName string, clusterName string, databaseName string, options *armredisenterprise.BeginUpgradeDBRedisVersionOptions) (resp azfake.PollerResponder[armredisenterprise.UpgradeDBRedisVersionResponse], errResp azfake.ErrorResponder)
}
...
func NewDatabasesServerTransport(srv *DatabasesServer) *DatabasesServerTransport {
	return &DatabasesServerTransport{
		...
		beginExport:				newTracker[azfake.PollerResponder[armredisenterprise.ExportResponse]](),
		beginFlush:				newTracker[azfake.PollerResponder[armredisenterprise.FlushResponse]](),
		beginForceLinkToReplicationGroup:	newTracker[azfake.PollerResponder[armredisenterprise.ForceLinkToReplicationGroupResponse]](),
		beginForceUnlink:			newTracker[azfake.PollerResponder[armredisenterprise.ForceUnlinkResponse]](),
		beginImport:				newTracker[azfake.PollerResponder[armredisenterprise.ImportResponse]](),
		newListByClusterPager:			newTracker[azfake.PagerResponder[armredisenterprise.ListByClusterResponse]](),
		beginRegenerateKey:			newTracker[azfake.PollerResponder[armredisenterprise.RegenerateKeyResponse]](),
		beginUpdate:				newTracker[azfake.PollerResponder[armredisenterprise.UpdateResponse]](),
		beginUpgradeDBRedisVersion:		newTracker[azfake.PollerResponder[armredisenterprise.UpgradeDBRedisVersionResponse]](),
	}
}
...
type DatabasesServerTransport struct {
	...
	beginExport				*tracker[azfake.PollerResponder[armredisenterprise.ExportResponse]]
	beginFlush				*tracker[azfake.PollerResponder[armredisenterprise.FlushResponse]]
	beginForceLinkToReplicationGroup	*tracker[azfake.PollerResponder[armredisenterprise.ForceLinkToReplicationGroupResponse]]
	beginForceUnlink			*tracker[azfake.PollerResponder[armredisenterprise.ForceUnlinkResponse]]
	beginImport				*tracker[azfake.PollerResponder[armredisenterprise.ImportResponse]]
	newListByClusterPager			*tracker[azfake.PagerResponder[armredisenterprise.ListByClusterResponse]]
	beginRegenerateKey			*tracker[azfake.PollerResponder[armredisenterprise.RegenerateKeyResponse]]
	beginUpdate				*tracker[azfake.PollerResponder[armredisenterprise.UpdateResponse]]
	beginUpgradeDBRedisVersion		*tracker[azfake.PollerResponder[armredisenterprise.UpgradeDBRedisVersionResponse]]
}
...
func (d *DatabasesServerTransport) dispatchBeginFlush(req *http.Request) (*http.Response, error) {
	...
	if beginFlush == nil {
		...
		var options *armredisenterprise.BeginFlushOptions
		if !reflect.ValueOf(body).IsZero() {
			options = &armredisenterprise.BeginFlushOptions{
				Parameters: &body,
			}
		}
...
func (d *DatabasesServerTransport) dispatchNewListByClusterPager(req *http.Request) (*http.Response, error) {
	...
	if newListByClusterPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListByClusterPager, req, func(page *armredisenterprise.ListByClusterResponse, createLink func() string) {
