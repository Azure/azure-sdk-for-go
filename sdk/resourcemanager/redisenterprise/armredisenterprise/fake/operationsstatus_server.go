...
type OperationsStatusServer struct {
	...
	Get func(ctx context.Context, location string, operationID string, options *armredisenterprise.GetOptions) (resp azfake.Responder[armredisenterprise.GetResponse], errResp azfake.ErrorResponder)
}
