...
type PrivateEndpointConnectionsServer struct {
	...
	BeginDelete	func(ctx context.Context, resourceGroupName string, clusterName string, privateEndpointConnectionName string, options *armredisenterprise.BeginDeleteOptions) (resp azfake.PollerResponder[armredisenterprise.DeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method PrivateEndpointConnectionsClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get	func(ctx context.Context, resourceGroupName string, clusterName string, privateEndpointConnectionName string, options *armredisenterprise.GetOptions) (resp azfake.Responder[armredisenterprise.GetResponse], errResp azfake.ErrorResponder)
	...
	BeginPut	func(ctx context.Context, resourceGroupName string, clusterName string, privateEndpointConnectionName string, properties armredisenterprise.PrivateEndpointConnection, options *armredisenterprise.BeginPutOptions) (resp azfake.PollerResponder[armredisenterprise.PutResponse], errResp azfake.ErrorResponder)
}
...
func NewPrivateEndpointConnectionsServerTransport(srv *PrivateEndpointConnectionsServer) *PrivateEndpointConnectionsServerTransport {
	return &PrivateEndpointConnectionsServerTransport{
		...
		beginPut:	newTracker[azfake.PollerResponder[armredisenterprise.PutResponse]](),
	}
}
...
type PrivateEndpointConnectionsServerTransport struct {
	...
	beginPut	*tracker[azfake.PollerResponder[armredisenterprise.PutResponse]]
}
