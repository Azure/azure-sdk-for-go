...
type AzureCacheForRedisMigrationProperties struct {
	...
	// CONSTANT; Describes the source of the migration operation.
	// Field has constant value SourceTypeAzureCacheForRedis, any specified value is ignored.
...
type DatabaseCreateProperties struct {
	...
	// is created. Default is Disabled.
...
type SKU struct {
	// REQUIRED; The level of Redis Enterprise cluster to deploy. Possible values: ('Balanced_B5', 'MemoryOptimized_M10', 'ComputeOptimized_X5',
