...
// Generated from example definition: 2026-02-01-preview/OperationsList.json
func ExampleOperationsClient_NewListPager() {
	...
	clientFactory, err := armredisenterprise.NewClientFactory("<subscriptionID>", cred, nil)
	if err != nil {
	...
	for pager.More() {
		...
		// page = armredisenterprise.OperationsClientListResponse{
		// 	OperationListResult: armredisenterprise.OperationListResult{
