...
//   - options - GetOptions contains the optional parameters for the OperationsStatusClient.Get method.
func (client *OperationsStatusClient) Get(ctx context.Context, location string, operationID string, options *GetOptions) (GetResponse, error) {
	var err error
...
func (client *OperationsStatusClient) getCreateRequest(ctx context.Context, location string, operationID string, _ *GetOptions) (*policy.Request, error) {
...
func (client *OperationsStatusClient) getHandleResponse(resp *http.Response) (GetResponse, error) {
	result := GetResponse{}
