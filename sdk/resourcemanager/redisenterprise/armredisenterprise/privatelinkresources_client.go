...
func (client *PrivateLinkResourcesClient) listByClusterCreateRequest(ctx context.Context, resourceGroupName string, clusterName string, nextLink string, _ *PrivateLinkResourcesClientListByClusterOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *PrivateLinkResourcesClient) listByClusterHandleResponse(resp *http.Response, successCodes ...int) (PrivateLinkResourcesClientListByClusterResponse, error) {
