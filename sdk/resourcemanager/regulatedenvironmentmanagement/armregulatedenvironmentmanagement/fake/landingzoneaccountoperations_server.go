...
type LandingZoneAccountOperationsServer struct {
	...
	BeginUpdate func(ctx context.Context, resourceGroupName string, landingZoneAccountName string, properties armregulatedenvironmentmanagement.LandingZoneAccountResource, options *armregulatedenvironmentmanagement.LandingZoneAccountOperationsClientBeginUpdateOptions) (resp azfake.PollerResponder[armregulatedenvironmentmanagement.LandingZoneAccountOperationsClientUpdateResponse], errResp azfake.ErrorResponder)
}
...
func (l *LandingZoneAccountOperationsServerTransport) dispatchBeginCreate(req *http.Request) (*http.Response, error) {
	...
	if beginCreate == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armregulatedenvironmentmanagement.LandingZoneAccountResource](req)
		if err != nil {
			return nil, err
		}
