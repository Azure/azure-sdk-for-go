...
// LandingZoneAccountOperationsServer is a fake server for instances of the armregulatedenvironmentmanagement.LandingZoneAccountOperationsClient type.
type LandingZoneAccountOperationsServer struct {
	...
	BeginCreate func(ctx context.Context, resourceGroupName string, landingZoneAccountName string, resource armregulatedenvironmentmanagement.LZAccount, options *armregulatedenvironmentmanagement.LandingZoneAccountOperationsClientBeginCreateOptions) (resp azfake.PollerResponder[armregulatedenvironmentmanagement.LandingZoneAccountOperationsClientCreateResponse], errResp azfake.ErrorResponder)

	// BeginDelete is the fake for method LandingZoneAccountOperationsClient.BeginDelete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginDelete func(ctx context.Context, resourceGroupName string, landingZoneAccountName string, options *armregulatedenvironmentmanagement.LandingZoneAccountOperationsClientBeginDeleteOptions) (resp azfake.PollerResponder[armregulatedenvironmentmanagement.LandingZoneAccountOperationsClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method LandingZoneAccountOperationsClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, landingZoneAccountName string, options *armregulatedenvironmentmanagement.LandingZoneAccountOperationsClientGetOptions) (resp azfake.Responder[armregulatedenvironmentmanagement.LandingZoneAccountOperationsClientGetResponse], errResp azfake.ErrorResponder)

	// NewListByResourceGroupPager is the fake for method LandingZoneAccountOperationsClient.NewListByResourceGroupPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByResourceGroupPager func(resourceGroupName string, options *armregulatedenvironmentmanagement.LandingZoneAccountOperationsClientListByResourceGroupOptions) (resp azfake.PagerResponder[armregulatedenvironmentmanagement.LandingZoneAccountOperationsClientListByResourceGroupResponse])

	// NewListBySubscriptionPager is the fake for method LandingZoneAccountOperationsClient.NewListBySubscriptionPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListBySubscriptionPager func(options *armregulatedenvironmentmanagement.LandingZoneAccountOperationsClientListBySubscriptionOptions) (resp azfake.PagerResponder[armregulatedenvironmentmanagement.LandingZoneAccountOperationsClientListBySubscriptionResponse])

	// BeginUpdate is the fake for method LandingZoneAccountOperationsClient.BeginUpdate
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginUpdate func(ctx context.Context, resourceGroupName string, landingZoneAccountName string, properties armregulatedenvironmentmanagement.LZAccount, options *armregulatedenvironmentmanagement.LandingZoneAccountOperationsClientBeginUpdateOptions) (resp azfake.PollerResponder[armregulatedenvironmentmanagement.LandingZoneAccountOperationsClientUpdateResponse], errResp azfake.ErrorResponder)
}
...
// The returned LandingZoneAccountOperationsServerTransport instance is connected to an instance of armregulatedenvironmentmanagement.LandingZoneAccountOperationsClient via the
...
func NewLandingZoneAccountOperationsServerTransport(srv *LandingZoneAccountOperationsServer) *LandingZoneAccountOperationsServerTransport {
	return &LandingZoneAccountOperationsServerTransport{
		srv:                         srv,
		beginCreate:                 newTracker[azfake.PollerResponder[armregulatedenvironmentmanagement.LandingZoneAccountOperationsClientCreateResponse]](),
		beginDelete:                 newTracker[azfake.PollerResponder[armregulatedenvironmentmanagement.LandingZoneAccountOperationsClientDeleteResponse]](),
		newListByResourceGroupPager: newTracker[azfake.PagerResponder[armregulatedenvironmentmanagement.LandingZoneAccountOperationsClientListByResourceGroupResponse]](),
		newListBySubscriptionPager:  newTracker[azfake.PagerResponder[armregulatedenvironmentmanagement.LandingZoneAccountOperationsClientListBySubscriptionResponse]](),
		beginUpdate:                 newTracker[azfake.PollerResponder[armregulatedenvironmentmanagement.LandingZoneAccountOperationsClientUpdateResponse]](),
	}
}

// LandingZoneAccountOperationsServerTransport connects instances of armregulatedenvironmentmanagement.LandingZoneAccountOperationsClient to instances of LandingZoneAccountOperationsServer.
...
type LandingZoneAccountOperationsServerTransport struct {
	...
	beginCreate                 *tracker[azfake.PollerResponder[armregulatedenvironmentmanagement.LandingZoneAccountOperationsClientCreateResponse]]
	beginDelete                 *tracker[azfake.PollerResponder[armregulatedenvironmentmanagement.LandingZoneAccountOperationsClientDeleteResponse]]
	newListByResourceGroupPager *tracker[azfake.PagerResponder[armregulatedenvironmentmanagement.LandingZoneAccountOperationsClientListByResourceGroupResponse]]
	newListBySubscriptionPager  *tracker[azfake.PagerResponder[armregulatedenvironmentmanagement.LandingZoneAccountOperationsClientListBySubscriptionResponse]]
	beginUpdate                 *tracker[azfake.PollerResponder[armregulatedenvironmentmanagement.LandingZoneAccountOperationsClientUpdateResponse]]
}
...
func (l *LandingZoneAccountOperationsServerTransport) dispatchBeginCreate(req *http.Request) (*http.Response, error) {
	...
	if beginCreate == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armregulatedenvironmentmanagement.LZAccount](req)
		if err != nil {
			return nil, err
		}
...
func (l *LandingZoneAccountOperationsServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	resp, err := server.MarshalResponseAsJSON(respContent, server.GetResponse(respr).LZAccount, req)
	if err != nil {
		return nil, err
	}
	return resp, nil
...
func (l *LandingZoneAccountOperationsServerTransport) dispatchNewListByResourceGroupPager(req *http.Request) (*http.Response, error) {
	...
	if newListByResourceGroupPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListByResourceGroupPager, req, func(page *armregulatedenvironmentmanagement.LandingZoneAccountOperationsClientListByResourceGroupResponse, createLink func() string) {
...
func (l *LandingZoneAccountOperationsServerTransport) dispatchNewListBySubscriptionPager(req *http.Request) (*http.Response, error) {
	...
	if newListBySubscriptionPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListBySubscriptionPager, req, func(page *armregulatedenvironmentmanagement.LandingZoneAccountOperationsClientListBySubscriptionResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
