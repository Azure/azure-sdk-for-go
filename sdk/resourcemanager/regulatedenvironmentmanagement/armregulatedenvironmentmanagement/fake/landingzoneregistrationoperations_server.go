...
type LandingZoneRegistrationOperationsServer struct {
	...
	BeginUpdate func(ctx context.Context, resourceGroupName string, landingZoneAccountName string, landingZoneRegistrationName string, properties armregulatedenvironmentmanagement.LandingZoneRegistrationResource, options *armregulatedenvironmentmanagement.LandingZoneRegistrationOperationsClientBeginUpdateOptions) (resp azfake.PollerResponder[armregulatedenvironmentmanagement.LandingZoneRegistrationOperationsClientUpdateResponse], errResp azfake.ErrorResponder)
}
...
func (l *LandingZoneRegistrationOperationsServerTransport) dispatchBeginCreate(req *http.Request) (*http.Response, error) {
	...
	if beginCreate == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armregulatedenvironmentmanagement.LandingZoneRegistrationResource](req)
		if err != nil {
			return nil, err
		}
