...
//     method.
func (client *LandingZoneConfigurationOperationsClient) BeginUpdate(ctx context.Context, resourceGroupName string, landingZoneAccountName string, landingZoneConfigurationName string, properties LandingZoneConfigurationResource, options *LandingZoneConfigurationOperationsClientBeginUpdateOptions) (*runtime.Poller[LandingZoneConfigurationOperationsClientUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
...
//
// Generated from API version 2025-02-27-preview
func (client *LandingZoneConfigurationOperationsClient) update(ctx context.Context, resourceGroupName string, landingZoneAccountName string, landingZoneConfigurationName string, properties LandingZoneConfigurationResource, options *LandingZoneConfigurationOperationsClientBeginUpdateOptions) (*http.Response, error) {
	var err error
...
func (client *LandingZoneConfigurationOperationsClient) updateCreateRequest(ctx context.Context, resourceGroupName string, landingZoneAccountName string, landingZoneConfigurationName string, properties LandingZoneConfigurationResource, _ *LandingZoneConfigurationOperationsClientBeginUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sovereign/landingZoneAccounts/{landingZoneAccountName}/landingZoneConfigurations/{landingZoneConfigurationName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
