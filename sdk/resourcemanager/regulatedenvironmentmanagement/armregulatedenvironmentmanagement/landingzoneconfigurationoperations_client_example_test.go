...
func ExampleLandingZoneConfigurationOperationsClient_BeginCreate() {
	...
	poller, err := clientFactory.NewLandingZoneConfigurationOperationsClient().BeginCreate(ctx, "rg-examplegroup", "ExampleLZA", "ExampleLZC", armregulatedenvironmentmanagement.LZConfiguration{
		Properties: &armregulatedenvironmentmanagement.LZConfigurationProperties{
			...
			LandingZonesMgChildren: []*armregulatedenvironmentmanagement.LZManagementGroupProperties{
				{
	...
	// 	LZConfiguration: &armregulatedenvironmentmanagement.LZConfiguration{
	// 		Properties: &armregulatedenvironmentmanagement.LZConfigurationProperties{
...
func ExampleLandingZoneConfigurationOperationsClient_BeginCreateCopy() {
	...
	poller, err := clientFactory.NewLandingZoneConfigurationOperationsClient().BeginCreateCopy(ctx, "ExampleResourceGroup", "SampleLZA", "ExampleLZC", armregulatedenvironmentmanagement.CreateLZConfigurationCopyRequest{
	...
	// 	CreateLZConfigurationCopyResult: &armregulatedenvironmentmanagement.CreateLZConfigurationCopyResult{
...
func ExampleLandingZoneConfigurationOperationsClient_BeginGenerateLandingZone() {
	...
	// 	GenerateLandingZoneResult: &armregulatedenvironmentmanagement.GenerateLandingZoneResult{
...
func ExampleLandingZoneConfigurationOperationsClient_NewListByResourceGroupPager() {
	...
	for pager.More() {
		...
		// 		Value: []*armregulatedenvironmentmanagement.LZConfiguration{
		// 			{
		// 				Properties: &armregulatedenvironmentmanagement.LZConfigurationProperties{
		// 					ProvisioningState: to.Ptr(armregulatedenvironmentmanagement.ProvisioningStateSucceeded),
		// 					AuthoringStatus: to.Ptr(armregulatedenvironmentmanagement.AuthoringStatusAuthoring),
...
func ExampleLandingZoneConfigurationOperationsClient_BeginUpdate() {
	...
	poller, err := clientFactory.NewLandingZoneConfigurationOperationsClient().BeginUpdate(ctx, "ExampleResourceGroup", "ExampleLZA", "ExampleLZC", armregulatedenvironmentmanagement.LZConfiguration{
		Properties: &armregulatedenvironmentmanagement.LZConfigurationProperties{
			DdosProtectionCreationOption:        to.Ptr(armregulatedenvironmentmanagement.ResourceCreationOptionsYes),
			LogAnalyticsWorkspaceCreationOption: to.Ptr(armregulatedenvironmentmanagement.ResourceCreationOptionsNo),
			FirewallCreationOption:              to.Ptr(armregulatedenvironmentmanagement.FirewallCreationOptionsStandard),
...
func ExampleLandingZoneConfigurationOperationsClient_BeginUpdateAuthoringStatus() {
	...
	// 	UpdateAuthoringStatusResult: &armregulatedenvironmentmanagement.UpdateAuthoringStatusResult{
	// 		LandingZoneConfigurationName: to.Ptr("ExampleLZC"),
	// 		AuthoringStatus: to.Ptr(armregulatedenvironmentmanagement.AuthoringStatusAuthoring),
	// 	},
	// }
