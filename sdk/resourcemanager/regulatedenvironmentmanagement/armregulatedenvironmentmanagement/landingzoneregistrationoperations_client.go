...
//
// Generated from API version 2025-02-27-preview
func (client *LandingZoneRegistrationOperationsClient) create(ctx context.Context, resourceGroupName string, landingZoneAccountName string, landingZoneRegistrationName string, resource LZRegistration, options *LandingZoneRegistrationOperationsClientBeginCreateOptions) (*http.Response, error) {
	var err error
...
func (client *LandingZoneRegistrationOperationsClient) createCreateRequest(ctx context.Context, resourceGroupName string, landingZoneAccountName string, landingZoneRegistrationName string, resource LZRegistration, _ *LandingZoneRegistrationOperationsClientBeginCreateOptions) (*policy.Request, error) {
...
func (client *LandingZoneRegistrationOperationsClient) getHandleResponse(resp *http.Response) (LandingZoneRegistrationOperationsClientGetResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.LZRegistration); err != nil {
		return LandingZoneRegistrationOperationsClientGetResponse{}, err
	}
	return result, nil
}
...
//     method.
func (client *LandingZoneRegistrationOperationsClient) BeginUpdate(ctx context.Context, resourceGroupName string, landingZoneAccountName string, landingZoneRegistrationName string, properties LZRegistration, options *LandingZoneRegistrationOperationsClientBeginUpdateOptions) (*runtime.Poller[LandingZoneRegistrationOperationsClientUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
...
//
// Generated from API version 2025-02-27-preview
func (client *LandingZoneRegistrationOperationsClient) update(ctx context.Context, resourceGroupName string, landingZoneAccountName string, landingZoneRegistrationName string, properties LZRegistration, options *LandingZoneRegistrationOperationsClientBeginUpdateOptions) (*http.Response, error) {
	var err error
...
func (client *LandingZoneRegistrationOperationsClient) updateCreateRequest(ctx context.Context, resourceGroupName string, landingZoneAccountName string, landingZoneRegistrationName string, properties LZRegistration, _ *LandingZoneRegistrationOperationsClientBeginUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sovereign/landingZoneAccounts/{landingZoneAccountName}/landingZoneRegistrations/{landingZoneRegistrationName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
