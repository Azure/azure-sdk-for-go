...
// CreateLandingZoneConfigurationCopyRequest - The request for create duplicate landing zone configuration.
...
// CreateLandingZoneConfigurationCopyResponse - The response of the create duplicate landing zone configuration.
...
// GenerateLandingZoneResponse - The response payload for generating infrastructure-as-code for the landing zone.
...
// LandingZoneAccountResource - The Landing zone account resource type. A Landing zone account is the container for configuring,
// deploying and managing multiple landing zones.
...
// LandingZoneManagementGroupProperties - The 'Landing Zones' management group properties..
...
// UpdateAuthoringStatusResponse - The response for authoring status update request.
