...
func (client *WCFRelaysClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, namespaceName string, relayName string, parameters WcfRelay, _ *WCFRelaysClientCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *WCFRelaysClient) createOrUpdateHandleResponse(resp *http.Response, successCodes ...int) (WCFRelaysClientCreateOrUpdateResponse, error) {
...
func (client *WCFRelaysClient) createOrUpdateAuthorizationRuleCreateRequest(ctx context.Context, resourceGroupName string, namespaceName string, relayName string, authorizationRuleName string, parameters AuthorizationRule, _ *WCFRelaysClientCreateOrUpdateAuthorizationRuleOptions) (*policy.Request, error) {
...
func (client *WCFRelaysClient) createOrUpdateAuthorizationRuleHandleResponse(resp *http.Response, successCodes ...int) (WCFRelaysClientCreateOrUpdateAuthorizationRuleResponse, error) {
...
func (client *WCFRelaysClient) Delete(ctx context.Context, resourceGroupName string, namespaceName string, relayName string, options *WCFRelaysClientDeleteOptions) (WCFRelaysClientDeleteResponse, error) {
	...
	if !runtime.HasStatusCode(httpResp, http.StatusOK, http.StatusNoContent) {
		return WCFRelaysClientDeleteResponse{}, runtime.NewResponseError(httpResp)
	}
	return WCFRelaysClientDeleteResponse{}, nil
}

// deleteCreateRequest creates the Delete request.
func (client *WCFRelaysClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, namespaceName string, relayName string, _ *WCFRelaysClientDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Relay/namespaces/{namespaceName}/wcfRelays/{relayName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *WCFRelaysClient) DeleteAuthorizationRule(ctx context.Context, resourceGroupName string, namespaceName string, relayName string, authorizationRuleName string, options *WCFRelaysClientDeleteAuthorizationRuleOptions) (WCFRelaysClientDeleteAuthorizationRuleResponse, error) {
	...
	if !runtime.HasStatusCode(httpResp, http.StatusOK, http.StatusNoContent) {
		return WCFRelaysClientDeleteAuthorizationRuleResponse{}, runtime.NewResponseError(httpResp)
	}
...
func (client *WCFRelaysClient) deleteAuthorizationRuleCreateRequest(ctx context.Context, resourceGroupName string, namespaceName string, relayName string, authorizationRuleName string, _ *WCFRelaysClientDeleteAuthorizationRuleOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Relay/namespaces/{namespaceName}/wcfRelays/{relayName}/authorizationRules/{authorizationRuleName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *WCFRelaysClient) getCreateRequest(ctx context.Context, resourceGroupName string, namespaceName string, relayName string, _ *WCFRelaysClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Relay/namespaces/{namespaceName}/wcfRelays/{relayName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *WCFRelaysClient) getHandleResponse(resp *http.Response, successCodes ...int) (WCFRelaysClientGetResponse, error) {
...
func (client *WCFRelaysClient) getAuthorizationRuleCreateRequest(ctx context.Context, resourceGroupName string, namespaceName string, relayName string, authorizationRuleName string, _ *WCFRelaysClientGetAuthorizationRuleOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Relay/namespaces/{namespaceName}/wcfRelays/{relayName}/authorizationRules/{authorizationRuleName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *WCFRelaysClient) getAuthorizationRuleHandleResponse(resp *http.Response, successCodes ...int) (WCFRelaysClientGetAuthorizationRuleResponse, error) {
...
func (client *WCFRelaysClient) NewListAuthorizationRulesPager(resourceGroupName string, namespaceName string, relayName string, options *WCFRelaysClientListAuthorizationRulesOptions) *runtime.Pager[WCFRelaysClientListAuthorizationRulesResponse] {
	return runtime.NewPager(runtime.PagingHandler[WCFRelaysClientListAuthorizationRulesResponse]{
		...
		Fetcher: func(ctx context.Context, page *WCFRelaysClientListAuthorizationRulesResponse) (WCFRelaysClientListAuthorizationRulesResponse, error) {
			...
			req, err := client.listAuthorizationRulesCreateRequest(ctx, resourceGroupName, namespaceName, relayName, nextLink, options)
			if err != nil {
...
func (client *WCFRelaysClient) listAuthorizationRulesCreateRequest(ctx context.Context, resourceGroupName string, namespaceName string, relayName string, nextLink string, _ *WCFRelaysClientListAuthorizationRulesOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *WCFRelaysClient) listAuthorizationRulesHandleResponse(resp *http.Response, successCodes ...int) (WCFRelaysClientListAuthorizationRulesResponse, error) {
...
func (client *WCFRelaysClient) listByNamespaceCreateRequest(ctx context.Context, resourceGroupName string, namespaceName string, nextLink string, _ *WCFRelaysClientListByNamespaceOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
	var req *policy.Request
	var err error
	if firstPage {
...
func (client *WCFRelaysClient) listByNamespaceHandleResponse(resp *http.Response, successCodes ...int) (WCFRelaysClientListByNamespaceResponse, error) {
...
func (client *WCFRelaysClient) listKeysCreateRequest(ctx context.Context, resourceGroupName string, namespaceName string, relayName string, authorizationRuleName string, _ *WCFRelaysClientListKeysOptions) (*policy.Request, error) {
...
func (client *WCFRelaysClient) listKeysHandleResponse(resp *http.Response, successCodes ...int) (WCFRelaysClientListKeysResponse, error) {
...
func (client *WCFRelaysClient) regenerateKeysCreateRequest(ctx context.Context, resourceGroupName string, namespaceName string, relayName string, authorizationRuleName string, parameters RegenerateAccessKeyParameters, _ *WCFRelaysClientRegenerateKeysOptions) (*policy.Request, error) {
...
func (client *WCFRelaysClient) regenerateKeysHandleResponse(resp *http.Response, successCodes ...int) (WCFRelaysClientRegenerateKeysResponse, error) {
