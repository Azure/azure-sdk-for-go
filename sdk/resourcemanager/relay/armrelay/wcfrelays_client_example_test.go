...
func ExampleWCFRelaysClient_Delete() {
	...
	res, err := clientFactory.NewWCFRelaysClient().Delete(ctx, "resourcegroup", "example-RelayNamespace-01", "example-Relay-wcf-01", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armrelay.WCFRelaysClientDeleteResponse{
	// }
}
...
func ExampleWCFRelaysClient_DeleteAuthorizationRule() {
	...
	res, err := clientFactory.NewWCFRelaysClient().DeleteAuthorizationRule(ctx, "resourcegroup", "example-RelayNamespace-01", "example-Relay-wcf-01", "example-RelayAuthRules-01", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armrelay.WCFRelaysClientDeleteAuthorizationRuleResponse{
	// }
}
...
func ExampleWCFRelaysClient_NewListAuthorizationRulesPager() {
	...
	for pager.More() {
		...
		// page = armrelay.WCFRelaysClientListAuthorizationRulesResponse{
...
func ExampleWCFRelaysClient_NewListByNamespacePager() {
	...
	for pager.More() {
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armrelay.WCFRelaysClientListByNamespaceResponse{
		// 	WcfRelaysListResult: armrelay.WcfRelaysListResult{
