...
// If the operation fails it returns the *ErrorResponse error type.
func (client *NamespacesClient) BeginCreateOrUpdate(ctx context.Context, resourceGroupName string, namespaceName string, parameters RelayNamespace, options *NamespacesBeginCreateOrUpdateOptions) (NamespacesCreateOrUpdatePollerResponse, error) {
...
// If the operation fails it returns the *ErrorResponse error type.
func (client *NamespacesClient) createOrUpdate(ctx context.Context, resourceGroupName string, namespaceName string, parameters RelayNamespace, options *NamespacesBeginCreateOrUpdateOptions) (*http.Response, error) {
...
func (client *NamespacesClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, namespaceName string, parameters RelayNamespace, options *NamespacesBeginCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *NamespacesClient) List(options *NamespacesListOptions) *NamespacesListPager {
	return &NamespacesListPager{
		...
		advancer: func(ctx context.Context, resp NamespacesListResponse) (*policy.Request, error) {
			return runtime.NewRequest(ctx, http.MethodGet, *resp.RelayNamespaceListResult.NextLink)
		},
	}
}
...
// If the operation fails it returns the *ErrorResponse error type.
func (client *NamespacesClient) Update(ctx context.Context, resourceGroupName string, namespaceName string, parameters RelayUpdateParameters, options *NamespacesUpdateOptions) (NamespacesUpdateResponse, error) {
...
func (client *NamespacesClient) updateCreateRequest(ctx context.Context, resourceGroupName string, namespaceName string, parameters RelayUpdateParameters, options *NamespacesUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Relay/namespaces/{namespaceName}"
	if resourceGroupName == "" {
		return nil, errors.New("parameter resourceGroupName cannot be empty")
	}
