...
func ExampleAzureReservationAPIClient_GetAppliedReservationList() {
	...
	// res = armreservations.AzureReservationAPIClientGetAppliedReservationListResponse{
...
func ExampleAzureReservationAPIClient_NewGetCatalogPager() {
	...
	pager := clientFactory.NewAzureReservationAPIClient().NewGetCatalogPager("23bc208b-083f-4901-ae85-4f98c0c3b4b6", &armreservations.AzureReservationAPIClientGetCatalogOptions{
	...
	for pager.More() {
		...
		// page = armreservations.AzureReservationAPIClientGetCatalogResponse{
