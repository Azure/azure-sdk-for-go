...
// Generated from example definition: 2022-11-01/CalculateExchange.json
func ExampleCalculateExchangeClient_BeginPost() {
	...
	// res = armreservations.CalculateExchangeClientPostResponse{
	// 	CalculateExchangeOperationResultResponse: &armreservations.CalculateExchangeOperationResultResponse{
