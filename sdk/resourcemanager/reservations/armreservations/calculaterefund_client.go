...
func (client *CalculateRefundClient) Post(ctx context.Context, body CalculateRefundRequest, options *CalculateRefundClientPostOptions) (CalculateRefundClientPostResponse, error) {
...
func (client *CalculateRefundClient) postCreateRequest(ctx context.Context, body CalculateRefundRequest, options *CalculateRefundClientPostOptions) (*policy.Request, error) {
	urlPath := "/providers/Microsoft.Capacity/calculateRefund"
