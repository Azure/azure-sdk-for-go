...
// Generated from example definition: 2022-11-01/GetAppliedReservations.json
func ExampleClient_GetAppliedReservationList() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	ctx := context.Background()
	clientFactory, err := armreservations.NewClientFactory("23bc208b-083f-4901-ae85-4f98c0c3b4b6", cred, nil)
	if err != nil {
		log.Fatalf("failed to create client: %v", err)
	}
	res, err := clientFactory.NewClient().GetAppliedReservationList(ctx, nil)
	if err != nil {
	...
	// res = armreservations.ClientGetAppliedReservationListResponse{
...
// Generated from example definition: 2022-11-01/GetCatalog.json
func ExampleClient_NewGetCatalogPager() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	pager := clientFactory.NewClient().NewGetCatalogPager(&armreservations.ClientGetCatalogOptions{
	...
	for pager.More() {
		...
		// page = armreservations.ClientGetCatalogResponse{
		// 	CatalogsResult: armreservations.CatalogsResult{
		// 		NextLink: to.Ptr("https://management.azure.com/providers/Microsoft.Capacity/reservationOrders?api-version=2022-11-01&$filter=(term%20eq%20'P1Y')&$take=50&$skip=50"),
