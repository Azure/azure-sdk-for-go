...
// Generated from example definition: 2022-11-01/Exchange.json
func ExampleExchangeClient_BeginPost() {
	...
	// res = armreservations.ExchangeClientPostResponse{
	// 	ExchangeOperationResultResponse: &armreservations.ExchangeOperationResultResponse{
