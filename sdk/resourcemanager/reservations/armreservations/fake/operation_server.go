...
// The returned OperationServerTransport instance is connected to an instance of armreservations.OperationClient via the
...
func NewOperationServerTransport(srv *OperationServer) *OperationServerTransport {
	return &OperationServerTransport{
		srv:          srv,
		newListPager: newTracker[azfake.PagerResponder[armreservations.OperationClientListResponse]](),
	}
}

// OperationServerTransport connects instances of armreservations.OperationClient to instances of OperationServer.
// Don't use this type directly, use NewOperationServerTransport instead.
type OperationServerTransport struct {
	srv          *OperationServer
	newListPager *tracker[azfake.PagerResponder[armreservations.OperationClientListResponse]]
}
...
func (o *OperationServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armreservations.OperationClientListResponse, createLink func() string) {
