...
type QuotaRequestStatusServer struct {
	...
	Get func(ctx context.Context, providerID string, location string, id string, options *armreservations.QuotaRequestStatusClientGetOptions) (resp azfake.Responder[armreservations.QuotaRequestStatusClientGetResponse], errResp azfake.ErrorResponder)

	// NewListPager is the fake for method QuotaRequestStatusClient.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager func(providerID string, location string, options *armreservations.QuotaRequestStatusClientListOptions) (resp azfake.PagerResponder[armreservations.QuotaRequestStatusClientListResponse])
}
...
func (q *QuotaRequestStatusServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := q.srv.Get(req.Context(), providerIDParam, locationParam, idParam, nil)
...
func (q *QuotaRequestStatusServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		resp := q.srv.NewListPager(providerIDParam, locationParam, options)
		newListPager = &resp
