...
type QuotaProperties struct {
	...
	// one minute), and PT1S (per one second). This parameter is optional because, for some resources such as compute, the time
...
// ReservationList - List of `Reservation`s
type ReservationList struct {
	// REQUIRED; The ReservationResponse items on this page
	Value []*ReservationResponse
...
// ReservationOrderList - List of `ReservationOrder`s
type ReservationOrderList struct {
	// REQUIRED; The ReservationOrderResponse items on this page
...
type ReservationResponse struct {
	...
	// FLAG; CONSTANT; Resource Provider type to be reserved.
	Kind *string
