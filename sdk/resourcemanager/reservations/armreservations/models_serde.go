...
func (p PatchProperties) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "reviewDateTime", p.ReviewDateTime)
	return json.Marshal(objectMap)
}
...
func (p *PatchProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "renewProperties":
			...
			delete(rawMsg, key)
		case "reviewDateTime":
			err = unpopulateTime[datetime.RFC3339](val, "ReviewDateTime", &p.ReviewDateTime)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", p, err)
...
func (p Properties) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "benefitStartTime", p.BenefitStartTime)
	...
	populateTime[datetime.PlainDate](objectMap, "expiryDate", p.ExpiryDate)
	populateTime[datetime.RFC3339](objectMap, "expiryDateTime", p.ExpiryDateTime)
	populate(objectMap, "extendedStatusInfo", p.ExtendedStatusInfo)
	populate(objectMap, "instanceFlexibility", p.InstanceFlexibility)
	populateTime[datetime.RFC3339](objectMap, "lastUpdatedDateTime", p.LastUpdatedDateTime)
	...
	populateTime[datetime.PlainDate](objectMap, "purchaseDate", p.PurchaseDate)
	populateTime[datetime.RFC3339](objectMap, "purchaseDateTime", p.PurchaseDateTime)
...
func (p *Properties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "benefitStartTime":
			err = unpopulateTime[datetime.RFC3339](val, "BenefitStartTime", &p.BenefitStartTime)
			delete(rawMsg, key)
		case "billingPlan":
		...
		case "effectiveDateTime":
			...
			delete(rawMsg, key)
		case "expiryDate":
			err = unpopulateTime[datetime.PlainDate](val, "ExpiryDate", &p.ExpiryDate)
			delete(rawMsg, key)
		case "expiryDateTime":
			err = unpopulateTime[datetime.RFC3339](val, "ExpiryDateTime", &p.ExpiryDateTime)
			delete(rawMsg, key)
		case "extendedStatusInfo":
			err = unpopulate(val, "ExtendedStatusInfo", &p.ExtendedStatusInfo)
			delete(rawMsg, key)
		...
		case "lastUpdatedDateTime":
			err = unpopulateTime[datetime.RFC3339](val, "LastUpdatedDateTime", &p.LastUpdatedDateTime)
			delete(rawMsg, key)
		...
		case "provisioningSubState":
			...
			delete(rawMsg, key)
		case "purchaseDate":
			err = unpopulateTime[datetime.PlainDate](val, "PurchaseDate", &p.PurchaseDate)
			delete(rawMsg, key)
		case "purchaseDateTime":
			err = unpopulateTime[datetime.RFC3339](val, "PurchaseDateTime", &p.PurchaseDateTime)
			delete(rawMsg, key)
		case "quantity":
...
func (q QuotaRequestProperties) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "requestSubmitTime", q.RequestSubmitTime)
	populate(objectMap, "value", q.Value)
	return json.Marshal(objectMap)
}
...
func (q *QuotaRequestProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "requestSubmitTime":
			err = unpopulateTime[datetime.RFC3339](val, "RequestSubmitTime", &q.RequestSubmitTime)
			delete(rawMsg, key)
		case "value":
			err = unpopulate(val, "Value", &q.Value)
			delete(rawMsg, key)
...
func (r ReservationOrderBillingPlanInformation) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateTime[datetime.PlainDate](objectMap, "nextPaymentDueDate", r.NextPaymentDueDate)
	populate(objectMap, "pricingCurrencyTotal", r.PricingCurrencyTotal)
	populateTime[datetime.PlainDate](objectMap, "startDate", r.StartDate)
...
func (r *ReservationOrderBillingPlanInformation) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "nextPaymentDueDate":
			err = unpopulateTime[datetime.PlainDate](val, "NextPaymentDueDate", &r.NextPaymentDueDate)
			delete(rawMsg, key)
		case "pricingCurrencyTotal":
			err = unpopulate(val, "PricingCurrencyTotal", &r.PricingCurrencyTotal)
			delete(rawMsg, key)
		case "startDate":
			err = unpopulateTime[datetime.PlainDate](val, "StartDate", &r.StartDate)
			delete(rawMsg, key)
		case "transactions":
...
func (r ReservationOrderProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateTime[datetime.RFC3339](objectMap, "benefitStartTime", r.BenefitStartTime)
	populate(objectMap, "billingPlan", r.BillingPlan)
	populateTime[datetime.RFC3339](objectMap, "createdDateTime", r.CreatedDateTime)
	populate(objectMap, "displayName", r.DisplayName)
	populateTime[datetime.PlainDate](objectMap, "expiryDate", r.ExpiryDate)
	populateTime[datetime.RFC3339](objectMap, "expiryDateTime", r.ExpiryDateTime)
	populate(objectMap, "originalQuantity", r.OriginalQuantity)
	populate(objectMap, "planInformation", r.PlanInformation)
	populate(objectMap, "provisioningState", r.ProvisioningState)
	populateTime[datetime.RFC3339](objectMap, "requestDateTime", r.RequestDateTime)
...
func (r *ReservationOrderProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "benefitStartTime":
			err = unpopulateTime[datetime.RFC3339](val, "BenefitStartTime", &r.BenefitStartTime)
			delete(rawMsg, key)
		case "billingPlan":
			err = unpopulate(val, "BillingPlan", &r.BillingPlan)
			delete(rawMsg, key)
		case "createdDateTime":
			err = unpopulateTime[datetime.RFC3339](val, "CreatedDateTime", &r.CreatedDateTime)
			delete(rawMsg, key)
		case "displayName":
			err = unpopulate(val, "DisplayName", &r.DisplayName)
			delete(rawMsg, key)
		case "expiryDate":
			err = unpopulateTime[datetime.PlainDate](val, "ExpiryDate", &r.ExpiryDate)
			delete(rawMsg, key)
		case "expiryDateTime":
			err = unpopulateTime[datetime.RFC3339](val, "ExpiryDateTime", &r.ExpiryDateTime)
			delete(rawMsg, key)
		...
		case "requestDateTime":
			err = unpopulateTime[datetime.RFC3339](val, "RequestDateTime", &r.RequestDateTime)
			delete(rawMsg, key)
		case "reservations":
