...
// ClientGetAppliedReservationListOptions contains the optional parameters for the Client.GetAppliedReservationList method.
type ClientGetAppliedReservationListOptions struct {
	// placeholder for future optional parameters
}

// ClientGetCatalogOptions contains the optional parameters for the Client.NewGetCatalogPager method.
type ClientGetCatalogOptions struct {
