...
func NewQuotaClient(subscriptionID string, credential azcore.TokenCredential, options *arm.ClientOptions) (*QuotaClient, error) {
...
// BeginCreateOrUpdate - Create or update the quota (service limits) of a resource to the requested value.
// Steps:
...
//     method.
func (client *QuotaClient) BeginCreateOrUpdate(ctx context.Context, providerID string, location string, resourceName string, createQuotaRequest CurrentQuotaLimitBase, options *QuotaClientBeginCreateOrUpdateOptions) (*runtime.Poller[QuotaClientCreateOrUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.createOrUpdate(ctx, providerID, location, resourceName, createQuotaRequest, options)
		if err != nil {
			return nil, err
		}
...
//
// Generated from API version 2020-10-25
func (client *QuotaClient) createOrUpdate(ctx context.Context, providerID string, location string, resourceName string, createQuotaRequest CurrentQuotaLimitBase, options *QuotaClientBeginCreateOrUpdateOptions) (*http.Response, error) {
	var err error
	const operationName = "QuotaClient.BeginCreateOrUpdate"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.createOrUpdateCreateRequest(ctx, providerID, location, resourceName, createQuotaRequest, options)
	if err != nil {
		return nil, err
	}
...
func (client *QuotaClient) createOrUpdateCreateRequest(ctx context.Context, providerID string, location string, resourceName string, createQuotaRequest CurrentQuotaLimitBase, _ *QuotaClientBeginCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *QuotaClient) Get(ctx context.Context, providerID string, location string, resourceName string, options *QuotaClientGetOptions) (QuotaClientGetResponse, error) {
	var err error
	const operationName = "QuotaClient.Get"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.getCreateRequest(ctx, providerID, location, resourceName, options)
	if err != nil {
...
func (client *QuotaClient) getCreateRequest(ctx context.Context, providerID string, location string, resourceName string, _ *QuotaClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/providers/Microsoft.Capacity/resourceProviders/{providerId}/locations/{location}/serviceLimits/{resourceName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *QuotaClient) NewListPager(providerID string, location string, options *QuotaClientListOptions) *runtime.Pager[QuotaClientListResponse] {
...
func (client *QuotaClient) listCreateRequest(ctx context.Context, providerID string, location string, _ *QuotaClientListOptions) (*policy.Request, error) {
...
func (client *QuotaClient) BeginUpdate(ctx context.Context, providerID string, location string, resourceName string, createQuotaRequest CurrentQuotaLimitBase, options *QuotaClientBeginUpdateOptions) (*runtime.Poller[QuotaClientUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.update(ctx, providerID, location, resourceName, createQuotaRequest, options)
		if err != nil {
			return nil, err
		}
...
//
// Generated from API version 2020-10-25
func (client *QuotaClient) update(ctx context.Context, providerID string, location string, resourceName string, createQuotaRequest CurrentQuotaLimitBase, options *QuotaClientBeginUpdateOptions) (*http.Response, error) {
	var err error
	const operationName = "QuotaClient.BeginUpdate"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.updateCreateRequest(ctx, providerID, location, resourceName, createQuotaRequest, options)
	if err != nil {
		return nil, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
...
func (client *QuotaClient) updateCreateRequest(ctx context.Context, providerID string, location string, resourceName string, createQuotaRequest CurrentQuotaLimitBase, _ *QuotaClientBeginUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/providers/Microsoft.Capacity/resourceProviders/{providerId}/locations/{location}/serviceLimits/{resourceName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
