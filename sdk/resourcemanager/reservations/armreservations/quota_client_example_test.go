...
// Generated from example definition: 2020-10-25/putComputeOneSkuQuotaRequest.json
func ExampleQuotaClient_BeginCreateOrUpdate_quotasRequestPutForCompute() {
	...
	clientFactory, err := armreservations.NewClientFactory("D7EC67B3-7657-4966-BFFC-41EFD36BAAB3", cred, nil)
	if err != nil {
		log.Fatalf("failed to create client: %v", err)
	}
	poller, err := clientFactory.NewQuotaClient().BeginCreateOrUpdate(ctx, "Microsoft.Compute", "eastus", "standardFSv2Family", armreservations.CurrentQuotaLimitBase{
	...
	// res = armreservations.QuotaClientCreateOrUpdateResponse{
...
// Generated from example definition: 2020-10-25/putMachineLearningServicesQuotaRequestDedicated.json
func ExampleQuotaClient_BeginCreateOrUpdate_quotasRequestPutForMachineLearningServicesDedicatedResource() {
	...
	poller, err := clientFactory.NewQuotaClient().BeginCreateOrUpdate(ctx, "Microsoft.MachineLearningServices", "eastus", "StandardDv2Family", armreservations.CurrentQuotaLimitBase{
		Properties: &armreservations.QuotaProperties{
			Name: &armreservations.ResourceName{
...
// Generated from example definition: 2020-10-25/putMachineLearningServicesQuotaRequestLowPriority.json
func ExampleQuotaClient_BeginCreateOrUpdate_quotasRequestPutForMachineLearningServicesLowPriorityResource() {
	...
	poller, err := clientFactory.NewQuotaClient().BeginCreateOrUpdate(ctx, "Microsoft.MachineLearningServices", "eastus", "TotalLowPriorityCores", armreservations.CurrentQuotaLimitBase{
		Properties: &armreservations.QuotaProperties{
			Name: &armreservations.ResourceName{
...
func ExampleQuotaClient_Get() {
	...
	ctx := context.Background()
	clientFactory, err := armreservations.NewClientFactory("00000000-0000-0000-0000-000000000000", cred, nil)
	if err != nil {
		log.Fatalf("failed to create client: %v", err)
	}
	res, err := clientFactory.NewQuotaClient().Get(ctx, "Microsoft.Compute", "eastus", "standardNDSFamily", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
...
// Generated from example definition: 2020-10-25/getComputeUsages.json
func ExampleQuotaClient_NewListPager_quotasListUsagesForCompute() {
	...
	pager := clientFactory.NewQuotaClient().NewListPager("Microsoft.Compute", "eastus", nil)
	for pager.More() {
		...
		// 		NextLink: to.Ptr("https://nextlink"),
...
func ExampleQuotaClient_NewListPager_quotasListUsagesMachineLearningServices() {
	...
	pager := clientFactory.NewQuotaClient().NewListPager("Microsoft.MachineLearningServices", "eastus", nil)
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
...
// Generated from example definition: 2020-10-25/patchComputeQuotaRequest.json
func ExampleQuotaClient_BeginUpdate() {
	...
	poller, err := clientFactory.NewQuotaClient().BeginUpdate(ctx, "Microsoft.Compute", "eastus", "standardFSv2Family", armreservations.CurrentQuotaLimitBase{
		Properties: &armreservations.QuotaProperties{
			Name: &armreservations.ResourceName{
				Value: to.Ptr("standardFSv2Family"),
			},
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armreservations.QuotaClientUpdateResponse{
	// 	CurrentQuotaLimitBase: &armreservations.CurrentQuotaLimitBase{
	// 		Name: to.Ptr("2B5C8515-37D8-4B6A-879B-CD641A2CF605"),
	// 		Type: to.Ptr("Microsoft.Capacity/serviceLimits"),
	// 		ID: to.Ptr("/subscriptions/D7EC67B3-7657-4966-BFFC-41EFD36BAAB3/providers/Microsoft.Capacity/resourceProviders/Microsoft.Compute/locations/eastus/serviceLimitsRequests/2B5C8515-37D8-4B6A-879B-CD641A2CF605"),
