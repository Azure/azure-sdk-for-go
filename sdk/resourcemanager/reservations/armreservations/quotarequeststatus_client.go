...
func (client *QuotaRequestStatusClient) getCreateRequest(ctx context.Context, subscriptionID string, providerID string, location string, id string, _ *QuotaRequestStatusClientGetOptions) (*policy.Request, error) {
	...
	reqQP.Set("api-version", version20201025)
