...
func ExampleQuotaRequestStatusClient_Get_quotaRequestStatus() {
	...
	res, err := clientFactory.NewQuotaRequestStatusClient().Get(ctx, "Microsoft.Compute", "eastus", "2B5C8515-37D8-4B6A-879B-CD641A2CF605", nil)
	if err != nil {
...
func ExampleQuotaRequestStatusClient_Get_quotaRequestInProgress() {
	...
	res, err := clientFactory.NewQuotaRequestStatusClient().Get(ctx, "Microsoft.Compute", "westus", "2B5C8515-37D8-4B6A-879B-CD641A2CF605", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
...
// Generated from example definition: 2020-10-25/getQuotaRequestsHistory.json
func ExampleQuotaRequestStatusClient_NewListPager() {
	...
	ctx := context.Background()
	clientFactory, err := armreservations.NewClientFactory("3f75fdf7-977e-44ad-990d-99f14f0f299f", cred, nil)
	if err != nil {
		log.Fatalf("failed to create client: %v", err)
	}
	pager := clientFactory.NewQuotaRequestStatusClient().NewListPager("Microsoft.Compute", "eastus", nil)
	for pager.More() {
		...
		// page = armreservations.QuotaRequestStatusClientListResponse{
		// 	QuotaRequestDetailsList: armreservations.QuotaRequestDetailsList{
		// 		NextLink: to.Ptr("https://management.azure.com/subscriptions/3f75fdf7-977e-44ad-990d-99f14f0f299f/providers/microsoft.Capacity/resourceProviders/Microsoft.Compute/locations/eastus/serviceLimitsRequests?api-version=2020-10-25&amp;$top=3"),
		...
		// 				Properties: &armreservations.QuotaRequestProperties{
		// 					Message: to.Ptr("Request completed"),
		// 					ProvisioningState: to.Ptr(armreservations.QuotaRequestState("Success")),
		// 					RequestSubmitTime: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2019-08-19T19:23:17.904Z"); return t}()),
		// 					Value: []*armreservations.SubRequest{
		// 						{
		// 							Name: &armreservations.ResourceName{
