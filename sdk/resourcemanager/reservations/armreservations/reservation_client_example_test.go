...
// Generated from example definition: 2022-11-01/GetAvailableScope.json
func ExampleReservationClient_BeginAvailableScopes() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armreservations.ReservationClientAvailableScopesResponse{
	// 	AvailableScopeProperties: armreservations.AvailableScopeProperties{
...
// Generated from example definition: 2022-11-01/GetReservationDetails.json
func ExampleReservationClient_Get() {
	...
	res, err := clientFactory.NewReservationClient().Get(ctx, "276e7ae4-84d0-4da6-ab4b-d6b94f3557da", "6ef59113-3482-40da-8d79-787f823e34bc", &armreservations.ReservationClientGetOptions{
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armreservations.ReservationClientGetResponse{
	// 	ReservationResponse: armreservations.ReservationResponse{
	...
	// 			ExpiryDate: to.Ptr(func() time.Time { t, _ := time.Parse(time.DateOnly, "2018-09-22"); return t}()),
...
// Generated from example definition: 2022-11-01/GetReservationsFromOrder.json
func ExampleReservationClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armreservations.ReservationClientListResponse{
		// 	ReservationList: armreservations.ReservationList{
		...
		// 					ProvisioningState: to.Ptr(armreservations.ProvisioningStateCancelled),
		// 					Quantity: to.Ptr[int32](3),
		// 					Renew: to.Ptr(false),
		// 					ReservedResourceType: to.Ptr(armreservations.ReservedResourceTypeVirtualMachines),
		// 					SKUDescription: to.Ptr("D1 v2"),
...
// Generated from example definition: 2022-11-01/GetReservations.json
func ExampleReservationClient_NewListAllPager() {
	...
	pager := clientFactory.NewReservationClient().NewListAllPager(&armreservations.ReservationClientListAllOptions{
	...
	for pager.More() {
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armreservations.ReservationClientListAllResponse{
		// 	ListResult: armreservations.ListResult{
		...
		// 					EffectiveDateTime: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2017-09-22T22:46:32.7632798Z"); return t}()),
		// 					ExpiryDate: to.Ptr(func() time.Time { t, _ := time.Parse(time.DateOnly, "2023-07-21"); return t}()),
		// 					ExpiryDateTime: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2023-07-21T22:46:32.7632798Z"); return t}()),
		// 					ProvisioningState: to.Ptr(armreservations.ProvisioningStateSucceeded),
		// 					PurchaseDate: to.Ptr(func() time.Time { t, _ := time.Parse(time.DateOnly, "2021-04-22"); return t}()),
...
// Generated from example definition: 2022-11-01/GetReservationRevisions.json
func ExampleReservationClient_NewListRevisionsPager() {
	...
	for pager.More() {
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armreservations.ReservationClientListRevisionsResponse{
		// 	ReservationList: armreservations.ReservationList{
		// 		Value: []*armreservations.ReservationResponse{
		// 			{
		// 				Name: to.Ptr("4"),
		...
		// 						},
		// 					},
		// 					ProvisioningState: to.Ptr(armreservations.ProvisioningStateCreating),
		// 					Quantity: to.Ptr[int32](3),
		// 					ReservedResourceType: to.Ptr(armreservations.ReservedResourceTypeVirtualMachines),
		// 					SKUDescription: to.Ptr("D1 v2"),
		// 				},
...
// Generated from example definition: 2022-11-01/MergeReservations.json
func ExampleReservationClient_BeginMerge() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armreservations.ReservationClientMergeResponse{
	// 	ReservationResponseArray: []*armreservations.ReservationResponse{
	// 		{
	// 			Name: to.Ptr("00238563-7312-4c20-a134-8c030bf938a7"),
	// 			Type: to.Ptr("Microsoft.Capacity/reservationOrders/reservations"),
	// 			Etag: to.Ptr[int32](5),
...
// Generated from example definition: 2022-11-01/SplitReservation.json
func ExampleReservationClient_BeginSplit() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armreservations.ReservationClientSplitResponse{
	// 	ReservationResponseArray: []*armreservations.ReservationResponse{
	// 		{
	// 			Name: to.Ptr("00238563-7312-4c20-a134-8c030bf938a7"),
	// 			Type: to.Ptr("Microsoft.Capacity/reservationOrders/reservations"),
...
// Generated from example definition: 2022-11-01/Unarchive.json
func ExampleReservationClient_Unarchive() {
	...
	res, err := clientFactory.NewReservationClient().Unarchive(ctx, "276e7ae4-84d0-4da6-ab4b-d6b94f3557da", "356e7ae4-84d0-4da6-ab4b-d6b94f3557da", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armreservations.ReservationClientUnarchiveResponse{
	// }
}

// Generated from example definition: 2022-11-01/UpdateReservation.json
func ExampleReservationClient_BeginUpdate() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armreservations.ReservationClientUpdateResponse{
	// 	ReservationResponse: armreservations.ReservationResponse{
	// 		Name: to.Ptr("6ef59113-3482-40da-8d79-787f823e34bc"),
	// 		Type: to.Ptr("Microsoft.Capacity/reservationOrders/reservations"),
	// 		Etag: to.Ptr[int32](4),
