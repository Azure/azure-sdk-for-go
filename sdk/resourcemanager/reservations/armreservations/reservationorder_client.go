...
// Calculate - Calculate price for a `ReservationOrder`.
//
...
// ChangeDirectory - Change directory of `ReservationOrder`.
//
...
// Get - Get a specific `ReservationOrder`.
//
...
// NewListPager - Get all `ReservationOrder`s.
//
...
// BeginPurchase - Purchase `ReservationOrder`
//
...
// Purchase - Purchase `ReservationOrder`
//
// Purchase `ReservationOrder` and create resource under the specified URI.
// If the operation fails it returns an *azcore.ResponseError type.
//
