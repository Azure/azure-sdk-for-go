...
// Generated from example definition: 2022-11-01/CalculateReservationOrder.json
func ExampleReservationOrderClient_Calculate() {
	...
	// res = armreservations.ReservationOrderClientCalculateResponse{
	// 	CalculatePriceResponse: &armreservations.CalculatePriceResponse{
	...
	// 					},
	// 					DueDate: to.Ptr(func() time.Time { t, _ := time.Parse(time.DateOnly, "2019-05-14"); return t}()),
	...
	// 				},
	// 				{
	// 					DueDate: to.Ptr(func() time.Time { t, _ := time.Parse(time.DateOnly, "2019-06-14"); return t}()),
	// 					PricingCurrencyTotal: &armreservations.Price{
	// 						Amount: to.Ptr[float64](46),
	// 						CurrencyCode: to.Ptr("USD"),
	// 					},
	// 				},
	// 				{
	// 					DueDate: to.Ptr(func() time.Time { t, _ := time.Parse(time.DateOnly, "2019-07-14"); return t}()),
	// 					PricingCurrencyTotal: &armreservations.Price{
	// 						Amount: to.Ptr[float64](46),
	// 						CurrencyCode: to.Ptr("USD"),
	// 					},
...
// Generated from example definition: 2022-11-01/ChangeDirectoryReservationOrder.json
func ExampleReservationOrderClient_ChangeDirectory() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armreservations.ReservationOrderClientChangeDirectoryResponse{
	// 	ChangeDirectoryResponse: &armreservations.ChangeDirectoryResponse{
...
// Generated from example definition: 2022-11-01/GetReservationOrderDetails.json
func ExampleReservationOrderClient_Get_getReservationOrder() {
	...
	res, err := clientFactory.NewReservationOrderClient().Get(ctx, "a075419f-44cc-497f-b68a-14ee811d48b9", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armreservations.ReservationOrderClientGetResponse{
...
// Generated from example definition: 2022-11-01/GetReservationOrderDetailsWithExpandPlanInformation.json
func ExampleReservationOrderClient_Get_getReservationWithExpandPayments() {
	...
	res, err := clientFactory.NewReservationOrderClient().Get(ctx, "a075419f-44cc-497f-b68a-14ee811d48b9", &armreservations.ReservationOrderClientGetOptions{
	...
	// 				NextPaymentDueDate: to.Ptr(func() time.Time { t, _ := time.Parse(time.DateOnly, "2019-09-30"); return t}()),
	// 				PricingCurrencyTotal: &armreservations.Price{
	// 					Amount: to.Ptr[float64](466),
	// 					CurrencyCode: to.Ptr("USD"),
	// 				},
	// 				StartDate: to.Ptr(func() time.Time { t, _ := time.Parse(time.DateOnly, "2019-08-30"); return t}()),
	...
	// 							CurrencyCode: to.Ptr("USD"),
	// 						},
	// 						DueDate: to.Ptr(func() time.Time { t, _ := time.Parse(time.DateOnly, "2019-09-30"); return t}()),
	// 						PaymentDate: to.Ptr(func() time.Time { t, _ := time.Parse(time.DateOnly, "2019-09-30"); return t}()),
	// 						PricingCurrencyTotal: &armreservations.Price{
	// 							Amount: to.Ptr[float64](466),
	// 							CurrencyCode: to.Ptr("USD"),
	// 						},
	...
	// 							CurrencyCode: to.Ptr("USD"),
	// 						},
	// 						DueDate: to.Ptr(func() time.Time { t, _ := time.Parse(time.DateOnly, "2019-10-30"); return t}()),
	...
	// 						},
	// 						PaymentDate: to.Ptr(func() time.Time { t, _ := time.Parse(time.DateOnly, "2019-10-30"); return t}()),
	// 						PricingCurrencyTotal: &armreservations.Price{
	// 							Amount: to.Ptr[float64](466),
	// 							CurrencyCode: to.Ptr("USD"),
	// 						},
	...
	// 							CurrencyCode: to.Ptr("USD"),
	// 						},
	// 						DueDate: to.Ptr(func() time.Time { t, _ := time.Parse(time.DateOnly, "2019-10-31"); return t}()),
	// 						PaymentDate: to.Ptr(func() time.Time { t, _ := time.Parse(time.DateOnly, "2019-10-31"); return t}()),
	// 						PricingCurrencyTotal: &armreservations.Price{
	// 							Amount: to.Ptr[float64](466),
	// 							CurrencyCode: to.Ptr("USD"),
	// 						},
	...
	// 							CurrencyCode: to.Ptr("USD"),
	// 						},
	// 						DueDate: to.Ptr(func() time.Time { t, _ := time.Parse(time.DateOnly, "2019-11-30"); return t}()),
	// 						PaymentDate: to.Ptr(func() time.Time { t, _ := time.Parse(time.DateOnly, "2019-11-30"); return t}()),
	// 						PricingCurrencyTotal: &armreservations.Price{
	// 							Amount: to.Ptr[float64](466),
	// 							CurrencyCode: to.Ptr("USD"),
	// 						},
	...
	// 						},
	// 						DueDate: to.Ptr(func() time.Time { t, _ := time.Parse(time.DateOnly, "2019-07-14"); return t}()),
	// 						PaymentDate: to.Ptr(func() time.Time { t, _ := time.Parse(time.DateOnly, "2019-06-14"); return t}()),
	// 						PricingCurrencyTotal: &armreservations.Price{
	// 							Amount: to.Ptr[float64](466),
	// 							CurrencyCode: to.Ptr("USD"),
	// 						},
	...
	// 						},
	// 						DueDate: to.Ptr(func() time.Time { t, _ := time.Parse(time.DateOnly, "2019-06-14"); return t}()),
	// 						PaymentDate: to.Ptr(func() time.Time { t, _ := time.Parse(time.DateOnly, "2019-08-14"); return t}()),
	// 						PricingCurrencyTotal: &armreservations.Price{
	// 							Amount: to.Ptr[float64](466),
	// 							CurrencyCode: to.Ptr("USD"),
	// 						},
...
// Generated from example definition: 2022-11-01/GetReservationOrders.json
func ExampleReservationOrderClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armreservations.ReservationOrderClientListResponse{
		// 	ReservationOrderList: armreservations.ReservationOrderList{
		// 		NextLink: to.Ptr("https://management.azure.com/providers/Microsoft.Capacity/reservationOrders?api-version=2017-11-01&%24skiptoken=eyJyZyI6IjIwNTkyMzdlLWY3MmYtNDczYi1hNTZiLWExOGJkM2UwMDhlZCIsImlnIjpudWxsLCJzdCI6bnVsbH0%3d"),
		...
		// 					DisplayName: to.Ptr("cabri"),
		// 					ExpiryDate: to.Ptr(func() time.Time { t, _ := time.Parse(time.DateOnly, "2018-08-29"); return t}()),
...
// Generated from example definition: 2022-11-01/PurchaseReservationOrder.json
func ExampleReservationOrderClient_BeginPurchase() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armreservations.ReservationOrderClientPurchaseResponse{
	// 	ReservationOrderResponse: &armreservations.ReservationOrderResponse{
	// 		Name: to.Ptr("1f14354c-dc12-4c8d-8090-6f295a3a34aa"),
	// 		Type: to.Ptr("Microsoft.Capacity/reservationOrders"),
	// 		Etag: to.Ptr[int32](7),
