...
const (
	StatusArcGatewayUpdateComplete              Status = "ArcGatewayUpdateComplete"
	StatusArcGatewayUpdateFailed                Status = "ArcGatewayUpdateFailed"
	StatusArcGatewayUpdatePreparing             Status = "ArcGatewayUpdatePreparing"
	StatusArcGatewayUpdating                    Status = "ArcGatewayUpdating"
	...
	StatusNetworkDNSUpdateComplete              Status = "NetworkDNSUpdateComplete"
	StatusNetworkDNSUpdateFailed                Status = "NetworkDNSUpdateFailed"
	StatusNetworkDNSUpdatePreparing             Status = "NetworkDNSUpdatePreparing"
	StatusNetworkDNSUpdating                    Status = "NetworkDNSUpdating"
	StatusNetworkProxyUpdateComplete            Status = "NetworkProxyUpdateComplete"
	StatusNetworkProxyUpdateFailed              Status = "NetworkProxyUpdateFailed"
	StatusNetworkProxyUpdatePreparing           Status = "NetworkProxyUpdatePreparing"
	StatusNetworkProxyUpdating                  Status = "NetworkProxyUpdating"
...
func PossibleStatusValues() []Status {
	return []Status{
		StatusArcGatewayUpdateComplete,
		StatusArcGatewayUpdateFailed,
		StatusArcGatewayUpdatePreparing,
		StatusArcGatewayUpdating,
		StatusConnected,
		StatusConnecting,
		...
		StatusImageUnknown,
		StatusNetworkDNSUpdateComplete,
		StatusNetworkDNSUpdateFailed,
		StatusNetworkDNSUpdatePreparing,
		StatusNetworkDNSUpdating,
		StatusNetworkProxyUpdateComplete,
		StatusNetworkProxyUpdateFailed,
		StatusNetworkProxyUpdatePreparing,
		StatusNetworkProxyUpdating,
		StatusNone,
		StatusOffline,
		StatusPostUpgrade,
		StatusPreUpgrade,
