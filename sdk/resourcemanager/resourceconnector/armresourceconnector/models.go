...
type ApplianceProperties struct {
	...
	// READ-ONLY; A list of events that occurred on the Appliance to relay information to the user.
	Events []*Event

	// READ-ONLY; The current deployment or provisioning state, which only appears in the response.
	ProvisioningState *string

	// READ-ONLY; Appliance’s health and state of connection to on-prem. This list of values is not exhaustive.
	Status *Status
}
...
// DNSConfiguration - Contains DNS information about the Appliance
...
// GatewayConfiguration - Contains Arc Gateway information about the Appliance
...
// NetworkProfile - Contains network information about the Appliance
...
// ProxyConfiguration - Contains proxy information about the Appliance
