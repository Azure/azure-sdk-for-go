...
// MarshalJSON implements the json.Marshaller interface for type GatewayConfiguration.
func (g GatewayConfiguration) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "version", g.Version)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type GatewayConfiguration.
func (g *GatewayConfiguration) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
...
func (n NetworkProfile) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "dnsConfiguration", n.DNSConfiguration)
	populate(objectMap, "gatewayConfiguration", n.GatewayConfiguration)
	populate(objectMap, "proxyConfiguration", n.ProxyConfiguration)
	return json.Marshal(objectMap)
}
...
func (n *NetworkProfile) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "dnsConfiguration":
			err = unpopulate(val, "DNSConfiguration", &n.DNSConfiguration)
			delete(rawMsg, key)
		case "gatewayConfiguration":
			err = unpopulate(val, "GatewayConfiguration", &n.GatewayConfiguration)
			delete(rawMsg, key)
		case "proxyConfiguration":
			err = unpopulate(val, "ProxyConfiguration", &n.ProxyConfiguration)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %s", n, err.Error())
...
// MarshalJSON implements the json.Marshaller interface for type ProxyConfiguration.
...
// UnmarshalJSON implements the json.Unmarshaller interface for type ProxyConfiguration.
