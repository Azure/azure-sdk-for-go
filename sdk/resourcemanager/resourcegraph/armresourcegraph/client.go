...
//
// Generated from API versions 2020-09-01-preview, 2021-06-01-preview, 2024-04-01
type Client struct {
	internal *arm.Client
}
...
func (client *Client) resourceChangeDetailsCreateRequest(ctx context.Context, parameters ResourceChangeDetailsRequestParameters, _ *ClientResourceChangeDetailsOptions) (*policy.Request, error) {
	...
	reqQP.Set("api-version", version20200901Preview)
...
func (client *Client) resourcesHistoryCreateRequest(ctx context.Context, request ResourcesHistoryRequest, _ *ClientResourcesHistoryOptions) (*policy.Request, error) {
	...
	reqQP := req.Raw().URL.Query()
	reqQP.Set("api-version", version20210601Preview)
	req.Raw().URL.RawQuery = strings.ReplaceAll(reqQP.Encode(), "+", "%20")
	req.Raw().Header["Accept"] = []string{"application/json"}
	req.Raw().Header["Content-Type"] = []string{"application/json"}
