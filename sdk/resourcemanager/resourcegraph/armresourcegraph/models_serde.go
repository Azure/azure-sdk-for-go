...
func (f Facet) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "resultType", f.ResultType)
	return json.Marshal(objectMap)
}
...
func (g GraphQueryProperties) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "timeModified", g.TimeModified)
	return json.Marshal(objectMap)
}
...
func (g *GraphQueryProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "resultKind":
			...
			delete(rawMsg, key)
		case "timeModified":
			err = unpopulateTime[datetime.RFC3339](val, "TimeModified", &g.TimeModified)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", g, err)
