...
func ExampleChildResourcesClient_NewListPager() {
	...
	for pager.More() {
		...
		// 					OccurredTime: to.Ptr(time.Date(2018, time.November, 30, 23, 37, 43, 0, time.UTC)),
		// 					ReasonChronicity: to.Ptr(armresourcehealth.ReasonChronicityTypesPersistent),
		// 					ReasonType: to.Ptr(""),
		// 					ReportedTime: to.Ptr(time.Date(2018, time.December, 4, 1, 18, 25, 575477000, time.UTC)),
		...
		// 					AvailabilityState: to.Ptr(armresourcehealth.AvailabilityStateValuesAvailable),
		// 					DetailedStatus: to.Ptr(""),
		// 					OccurredTime: to.Ptr(time.Date(2018, time.November, 30, 23, 37, 41, 0, time.UTC)),
		// 					ReasonChronicity: to.Ptr(armresourcehealth.ReasonChronicityTypesPersistent),
		// 					ReasonType: to.Ptr(""),
		// 					ReportedTime: to.Ptr(time.Date(2018, time.December, 4, 1, 18, 25, 575477000, time.UTC)),
		// 					Summary: to.Ptr("There aren't any known Azure platform problems affecting this virtual machine"),
		...
		// 					AvailabilityState: to.Ptr(armresourcehealth.AvailabilityStateValuesAvailable),
		// 					DetailedStatus: to.Ptr(""),
		// 					OccurredTime: to.Ptr(time.Date(2018, time.November, 30, 23, 37, 48, 0, time.UTC)),
		// 					ReasonChronicity: to.Ptr(armresourcehealth.ReasonChronicityTypesPersistent),
		// 					ReasonType: to.Ptr(""),
		// 					ReportedTime: to.Ptr(time.Date(2018, time.December, 4, 1, 18, 25, 575477000, time.UTC)),
		// 					Summary: to.Ptr("There aren't any known Azure platform problems affecting this virtual machine"),
