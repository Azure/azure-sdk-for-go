...
func ExampleEmergingIssuesClient_Get() {
	...
	// 			RefreshTimestamp: to.Ptr(time.Date(2019, time.December, 17, 9, 12, 0, 0, time.UTC)),
	...
	// 						},
	// 					},
	// 					LastModifiedTime: to.Ptr(time.Date(2019, time.December, 15, 8, 10, 0, 0, time.UTC)),
	...
	// 					StartTime: to.Ptr(time.Date(2019, time.December, 15, 8, 6, 0, 0, time.UTC)),
	...
	// 						},
	// 					},
	// 					LastModifiedTime: to.Ptr(time.Date(2019, time.December, 16, 5, 11, 0, 0, time.UTC)),
	// 					Published: to.Ptr(true),
	// 					Severity: to.Ptr(armresourcehealth.SeverityValuesError),
	// 					Stage: to.Ptr(armresourcehealth.StageValuesActive),
	// 					StartTime: to.Ptr(time.Date(2019, time.December, 16, 5, 11, 0, 0, time.UTC)),
	...
	// 				{
	// 					Cloud: to.Ptr("Public"),
	// 					LastModifiedTime: to.Ptr(time.Date(2019, time.December, 15, 8, 4, 0, 0, time.UTC)),
	// 					Message: to.Ptr("Testing backup site"),
	// 					Title: to.Ptr("Automatic updates to the dial tone page from ACM - banner"),
	// 				},
	// 				{
	// 					Cloud: to.Ptr("Public"),
	// 					LastModifiedTime: to.Ptr(time.Date(2019, time.December, 15, 10, 15, 0, 0, time.UTC)),
