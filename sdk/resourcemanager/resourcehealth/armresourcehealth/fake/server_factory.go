...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "AvailabilityStatusesClient":
		initServer(&s.trMu, &s.trAvailabilityStatusesServer, func() *AvailabilityStatusesServerTransport {
	...
	case "ChildAvailabilityStatusesClient":
		initServer(&s.trMu, &s.trChildAvailabilityStatusesServer, func() *ChildAvailabilityStatusesServerTransport {
	...
	case "ChildResourcesClient":
		initServer(&s.trMu, &s.trChildResourcesServer, func() *ChildResourcesServerTransport {
	...
	case "EmergingIssuesClient":
		initServer(&s.trMu, &s.trEmergingIssuesServer, func() *EmergingIssuesServerTransport {
	...
	case "ImpactedResourcesClient":
		initServer(&s.trMu, &s.trImpactedResourcesServer, func() *ImpactedResourcesServerTransport {
	...
	case "SecurityAdvisoryImpactedResourcesClient":
		initServer(&s.trMu, &s.trSecurityAdvisoryImpactedResourcesServer, func() *SecurityAdvisoryImpactedResourcesServerTransport {
