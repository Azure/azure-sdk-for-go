...
```sh
go get github.com/Azure/azure-sdk-for-go/sdk/resourcemanager/resources/armdeployments/v3
```
...
clientFactory, err := armdeployments.NewClientFactory(<subscription ID>, cred, &options)
```
...
```go
client := clientFactory.NewDeploymentOperationsClient()
```
