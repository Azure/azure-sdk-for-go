...
func ExampleClient_CalculateTemplateHash() {
	...
	clientFactory, err := armdeployments.NewClientFactory("<subscriptionID>", cred, nil)
	if err != nil {
	...
	// res = armdeployments.ClientCalculateTemplateHashResponse{
	// 	TemplateHashResult: &armdeployments.TemplateHashResult{
...
func ExampleClient_BeginCreateOrUpdate_createADeploymentThatWillDeployATemplateWithAUriAndQueryString() {
	...
	ctx := context.Background()
	clientFactory, err := armdeployments.NewClientFactory("00000000-0000-0000-0000-000000000001", cred, nil)
	if err != nil {
		log.Fatalf("failed to create client: %v", err)
	}
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armdeployments.ClientCreateOrUpdateResponse{
...
func ExampleClient_BeginCreateOrUpdateAtManagementGroupScope() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armdeployments.ClientCreateOrUpdateAtManagementGroupScopeResponse{
	// 	DeploymentExtended: &armdeployments.DeploymentExtended{
	// 		Name: to.Ptr("my-deployment"),
	// 		Type: to.Ptr("Microsoft.Resources/deployments"),
...
func ExampleClient_BeginCreateOrUpdateAtScope() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armdeployments.ClientCreateOrUpdateAtScopeResponse{
	// 	DeploymentExtended: &armdeployments.DeploymentExtended{
	// 		Name: to.Ptr("my-deployment"),
	// 		Type: to.Ptr("Microsoft.Resources/deployments"),
	// 		ID: to.Ptr("/providers/Microsoft.Management/managementGroups/my-management-group-id/providers/Microsoft.Resources/deployments/my-deployment"),
...
func ExampleClient_BeginCreateOrUpdateAtSubscriptionScope() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armdeployments.ClientCreateOrUpdateAtSubscriptionScopeResponse{
	// 	DeploymentExtended: &armdeployments.DeploymentExtended{
	// 		Name: to.Ptr("my-deployment"),
	// 		Type: to.Ptr("Microsoft.Resources/deployments"),
...
func ExampleClient_BeginCreateOrUpdateAtTenantScope() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armdeployments.ClientCreateOrUpdateAtTenantScopeResponse{
	// 	DeploymentExtended: &armdeployments.DeploymentExtended{
...
func ExampleClient_BeginValidate() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armdeployments.ClientValidateResponse{
	// 	DeploymentValidateResult: &armdeployments.DeploymentValidateResult{
	// 		Name: to.Ptr("my-deployment"),
	// 		Type: to.Ptr("Microsoft.Resources/deployments"),
	// 		ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000001/resourceGroups/my-resource-group/providers/Microsoft.Resources/deployments/my-deployment"),
	// 		Properties: &armdeployments.DeploymentPropertiesExtended{
...
func ExampleClient_BeginValidateAtManagementGroupScope() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armdeployments.ClientValidateAtManagementGroupScopeResponse{
	// 	DeploymentValidateResult: &armdeployments.DeploymentValidateResult{
	// 		Name: to.Ptr("my-deployment"),
	// 		Type: to.Ptr("Microsoft.Resources/deployments"),
	// 		ID: to.Ptr("/providers/Microsoft.Management/managementGroups/my-management-group-id/providers/Microsoft.Resources/deployments/my-deployment"),
...
func ExampleClient_BeginValidateAtScope() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armdeployments.ClientValidateAtScopeResponse{
	// 	DeploymentValidateResult: &armdeployments.DeploymentValidateResult{
	// 		Name: to.Ptr("my-deployment"),
	// 		Type: to.Ptr("Microsoft.Resources/deployments"),
	// 		ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000001/resourceGroups/my-resource-group/providers/Microsoft.Resources/deployments/my-deployment"),
...
func ExampleClient_BeginValidateAtSubscriptionScope() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armdeployments.ClientValidateAtSubscriptionScopeResponse{
	// 	DeploymentValidateResult: &armdeployments.DeploymentValidateResult{
	// 		Name: to.Ptr("my-deployment"),
	// 		Type: to.Ptr("Microsoft.Resources/deployments"),
	// 		ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000001/providers/Microsoft.Resources/deployments/my-deployment"),
...
func ExampleClient_BeginValidateAtTenantScope() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armdeployments.ClientValidateAtTenantScopeResponse{
	// 	DeploymentValidateResult: &armdeployments.DeploymentValidateResult{
	// 		Name: to.Ptr("my-deployment"),
	// 		Type: to.Ptr("Microsoft.Resources/deployments"),
...
func ExampleClient_BeginWhatIf() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armdeployments.ClientWhatIfResponse{
	// 	WhatIfOperationResult: &armdeployments.WhatIfOperationResult{
...
func ExampleClient_BeginWhatIfAtManagementGroupScope() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armdeployments.ClientWhatIfAtManagementGroupScopeResponse{
	// 	WhatIfOperationResult: &armdeployments.WhatIfOperationResult{
	// 		Properties: &armdeployments.WhatIfOperationProperties{
	// 			Changes: []*armdeployments.WhatIfChange{
	// 				{
...
func ExampleClient_BeginWhatIfAtSubscriptionScope() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armdeployments.ClientWhatIfAtSubscriptionScopeResponse{
	// 	WhatIfOperationResult: &armdeployments.WhatIfOperationResult{
	// 		Properties: &armdeployments.WhatIfOperationProperties{
	// 			Changes: []*armdeployments.WhatIfChange{
	// 				{
...
func ExampleClient_BeginWhatIfAtTenantScope() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armdeployments.ClientWhatIfAtTenantScopeResponse{
	// 	WhatIfOperationResult: &armdeployments.WhatIfOperationResult{
	// 		Properties: &armdeployments.WhatIfOperationProperties{
	// 			Changes: []*armdeployments.WhatIfChange{
	// 				{
