...
const (
	// DeploymentIdentityTypeNone - None
	DeploymentIdentityTypeNone DeploymentIdentityType = "None"
	// DeploymentIdentityTypeUserAssigned - UserAssigned
...
// mode, resources are deployed without deleting existing resources that are not included in the template. In Complete mode,
...
const (
	// OnErrorDeploymentTypeLastSuccessful - LastSuccessful
	OnErrorDeploymentTypeLastSuccessful OnErrorDeploymentType = "LastSuccessful"
	// OnErrorDeploymentTypeSpecificDeployment - SpecificDeployment
...
const (
	// WhatIfResultFormatFullResourcePayloads - FullResourcePayloads
	WhatIfResultFormatFullResourcePayloads WhatIfResultFormat = "FullResourcePayloads"
	// WhatIfResultFormatResourceIDOnly - ResourceIdOnly
