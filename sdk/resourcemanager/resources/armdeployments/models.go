...
type DeploymentListResult struct {
	// REQUIRED; The DeploymentExtended items on this page
...
type DeploymentOperationsListResult struct {
	// REQUIRED; The DeploymentOperation items on this page
...
type DeploymentProperties struct {
	...
	// resources are deployed without deleting existing resources that are not included in the template. In Complete mode, resources
	// are deployed and existing resources in the resource group that are not included in the template are deleted. Be careful
	// when using Complete mode as you may unintentionally delete resources.
	Mode *DeploymentMode
