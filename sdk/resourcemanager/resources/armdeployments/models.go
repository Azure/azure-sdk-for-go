...
// DeploymentStacksDebugSetting - The debug setting.
...
// DeploymentStacksParametersLink - Entity representing the reference to the deployment parameters.
...
// DeploymentStacksTemplateLink - Entity representing the reference to the template.
