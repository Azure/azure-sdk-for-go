...
// MarshalJSON implements the json.Marshaller interface for type DeploymentStacksDebugSetting.
func (d DeploymentStacksDebugSetting) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "detailLevel", d.DetailLevel)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type DeploymentStacksDebugSetting.
func (d *DeploymentStacksDebugSetting) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", d, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type DeploymentStacksParametersLink.
func (d DeploymentStacksParametersLink) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "contentVersion", d.ContentVersion)
	populate(objectMap, "uri", d.URI)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type DeploymentStacksParametersLink.
func (d *DeploymentStacksParametersLink) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", d, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "contentVersion":
			err = unpopulate(val, "ContentVersion", &d.ContentVersion)
			delete(rawMsg, key)
		case "uri":
...
// MarshalJSON implements the json.Marshaller interface for type DeploymentStacksTemplateLink.
func (d DeploymentStacksTemplateLink) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "contentVersion", d.ContentVersion)
	populate(objectMap, "id", d.ID)
	populate(objectMap, "queryString", d.QueryString)
	populate(objectMap, "relativePath", d.RelativePath)
	populate(objectMap, "uri", d.URI)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type DeploymentStacksTemplateLink.
func (d *DeploymentStacksTemplateLink) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", d, err)
	}
	for key, val := range rawMsg {
		...
		case "id":
			...
			delete(rawMsg, key)
		case "queryString":
			err = unpopulate(val, "QueryString", &d.QueryString)
			delete(rawMsg, key)
		case "relativePath":
			err = unpopulate(val, "RelativePath", &d.RelativePath)
			delete(rawMsg, key)
		case "uri":
			err = unpopulate(val, "URI", &d.URI)
			delete(rawMsg, key)
