...
```go
client, err := armdeploymentscripts.NewDeploymentScriptsClient(<subscription ID>, cred, nil)
```
...
client, err := armdeploymentscripts.NewDeploymentScriptsClient(<subscription ID>, cred, &options)
```

## Provide Feedback

If you encounter bugs or have suggestions, please
[open an issue](https://github.com/Azure/azure-sdk-for-go/issues) and assign the `Deployment Scripts` label.
