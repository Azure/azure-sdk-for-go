...
The `armfeatures` module provides operations for working with Azure Resources.
...
```go
client := armfeatures.{{NewClientName}}(<subscription ID>, cred, nil)
```
...
client := armfeatures.{{NewClientName}}(<subscription ID>, cred, &options)
```
