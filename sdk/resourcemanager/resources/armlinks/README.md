...
The `armlinks` module provides operations for working with Azure Resources.
...
```go
client := armlinks.{{NewClientName}}(<subscription ID>, cred, nil)
```
...
client := armlinks.{{NewClientName}}(<subscription ID>, cred, &options)
```
