...
The `armlocks` module provides operations for working with Azure Resources.
...
```go
client := armlocks.{{NewClientName}}(<subscription ID>, cred, nil)
```
...
client := armlocks.{{NewClientName}}(<subscription ID>, cred, &options)
```
