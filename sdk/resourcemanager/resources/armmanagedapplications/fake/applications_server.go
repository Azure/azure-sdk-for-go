...
func (a *ApplicationsServerTransport) dispatchUpdate(req *http.Request) (*http.Response, error) {
	...
	var options *armmanagedapplications.ApplicationsClientUpdateOptions
	if !reflect.ValueOf(body).IsZero() {
		options = &armmanagedapplications.ApplicationsClientUpdateOptions{
			Parameters: &body,
		}
	}
	respr, errRespr := a.srv.Update(req.Context(), resourceGroupNameParam, applicationNameParam, options)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (a *ApplicationsServerTransport) dispatchUpdateByID(req *http.Request) (*http.Response, error) {
	...
	var options *armmanagedapplications.ApplicationsClientUpdateByIDOptions
	if !reflect.ValueOf(body).IsZero() {
		options = &armmanagedapplications.ApplicationsClientUpdateByIDOptions{
			Parameters: &body,
		}
	}
	respr, errRespr := a.srv.UpdateByID(req.Context(), applicationIDParam, options)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
