...
type ApplicationsServer struct {
	...
	BeginUpdate func(ctx context.Context, resourceGroupName string, applicationName string, parameters armmanagedapplications.ApplicationPatchable, options *armmanagedapplications.ApplicationsClientBeginUpdateOptions) (resp azfake.PollerResponder[armmanagedapplications.ApplicationsClientUpdateResponse], errResp azfake.ErrorResponder)
	...
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginUpdateByID func(ctx context.Context, applicationID string, parameters armmanagedapplications.ApplicationPatchable, options *armmanagedapplications.ApplicationsClientBeginUpdateByIDOptions) (resp azfake.PollerResponder[armmanagedapplications.ApplicationsClientUpdateByIDResponse], errResp azfake.ErrorResponder)
}
...
func (a *ApplicationsServerTransport) dispatchBeginUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginUpdate == nil {
		...
		respr, errRespr := a.srv.BeginUpdate(req.Context(), resourceGroupNameParam, applicationNameParam, body, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginUpdate = &respr
...
func (a *ApplicationsServerTransport) dispatchBeginUpdateByID(req *http.Request) (*http.Response, error) {
	...
	if beginUpdateByID == nil {
		...
		respr, errRespr := a.srv.BeginUpdateByID(req.Context(), applicationIDParam, body, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
