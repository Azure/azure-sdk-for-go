...
- New value `SelectorKindGroupPrincipalID`, `SelectorKindResourceRolloutPercentage`, `SelectorKindUserPrincipalID` added to enum type `SelectorKind`
...
- New field `AdditionalInfo`, `ComplianceState`, `EndpointKind`, `PolicyAction`, `PolicyEvaluationDetails` in struct `ExternalEvaluationEndpointInvocationResult`
