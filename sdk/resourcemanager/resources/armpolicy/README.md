...
The `armpolicy` module provides operations for working with Azure Resources.
...
```go
client := armpolicy.{{NewClientName}}(<subscription ID>, cred, nil)
```
...
client := armpolicy.{{NewClientName}}(<subscription ID>, cred, &options)
```
