...
// TokenResult - The result of the completed token acquisition operation. Possible values are Succeeded and Failed.
type TokenResult string

const (
	// TokenResultFailed - Failed
	TokenResultFailed TokenResult = "Failed"
	// TokenResultSucceeded - Succeeded
	TokenResultSucceeded TokenResult = "Succeeded"
)

// PossibleTokenResultValues returns the possible values for the TokenResult const type.
func PossibleTokenResultValues() []TokenResult {
	return []TokenResult{
		TokenResultFailed,
		TokenResultSucceeded,
	}
}

// Type - The type of policy definition. Possible values are NotSpecified, BuiltIn, Custom, and Static.
type Type string
