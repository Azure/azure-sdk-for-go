...
func (v *VariableValuesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	resultChan := make(chan result, 1)
	go func() {
		var intercepted bool
		var res result
		if variableValuesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = variableValuesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "VariableValuesClient.NewListForManagementGroupPager":
				res.resp, res.err = v.dispatchNewListForManagementGroupPager(req)
			default:
...
func (v *VariableValuesServerTransport) dispatchCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.Authorization/variables/(?P<variableName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/values/(?P<variableValueName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)`
...
func (v *VariableValuesServerTransport) dispatchCreateOrUpdateAtManagementGroup(req *http.Request) (*http.Response, error) {
	...
	const regexStr = `/providers/Microsoft\.Management/managementGroups/(?P<managementGroupId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.Authorization/variables/(?P<variableName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/values/(?P<variableValueName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)`
	regex := regexp.MustCompile(regexStr)
	matches := regex.FindStringSubmatch(req.URL.EscapedPath())
	if len(matches) < 4 {
		return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
...
func (v *VariableValuesServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.Authorization/variables/(?P<variableName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/values`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 3 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
...
func (v *VariableValuesServerTransport) dispatchNewListForManagementGroupPager(req *http.Request) (*http.Response, error) {
	...
	if newListForManagementGroupPager == nil {
		const regexStr = `/providers/Microsoft\.Management/managementGroups/(?P<managementGroupId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.Authorization/variables/(?P<variableName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/values`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 3 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
...
// set this to conditionally intercept incoming requests to VariableValuesServerTransport
var variableValuesServerTransportInterceptor interface {
