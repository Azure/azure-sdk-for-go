...
// ParameterDefinitions - The parameter definitions for parameters used in the policy. The keys are the parameter names.
type ParameterDefinitions struct {
	AdditionalProperties map[string]*ParameterDefinitionsValue
}
...
// ParameterValues - The parameter values for the policy rule. The keys are the parameter names.
type ParameterValues struct {
	AdditionalProperties map[string]*ParameterValuesValue
}
