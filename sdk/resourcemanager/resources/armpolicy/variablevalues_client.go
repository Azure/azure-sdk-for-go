...
// CreateOrUpdate - Creates or updates a variable value.
//
// This operation creates or updates a variable value with the given subscription and name for a given variable. Variable
...
// CreateOrUpdateAtManagementGroup - Creates or updates a variable value.
//
// This operation creates or updates a variable value with the given management group and name for a given variable. Variable
// values are scoped to the variable for which they are created for.
// If the operation fails it returns an *azcore.ResponseError type.
...
func (client *VariableValuesClient) createOrUpdateAtManagementGroupCreateRequest(ctx context.Context, managementGroupID string, variableName string, variableValueName string, parameters VariableValue, _ *VariableValuesClientCreateOrUpdateAtManagementGroupOptions) (*policy.Request, error) {
...
// Delete - Deletes a variable value.
//
...
// DeleteAtManagementGroup - Deletes a variable value.
//
// This operation deletes a variable value, given its name, the management group it was created in, and the variable it belongs
// to. The scope of a variable value is the part of its ID preceding '/providers/Microsoft.Authorization/variables/{variableName}'.
// If the operation fails it returns an *azcore.ResponseError type.
//   - managementGroupID - The ID of the management group.
//   - variableName - The name of the variable to operate on.
...
func (client *VariableValuesClient) deleteAtManagementGroupCreateRequest(ctx context.Context, managementGroupID string, variableName string, variableValueName string, _ *VariableValuesClientDeleteAtManagementGroupOptions) (*policy.Request, error) {
	urlPath := "/providers/Microsoft.Management/managementGroups/{managementGroupId}/providers/Microsoft.Authorization/variables/{variableName}/values/{variableValueName}"
	if managementGroupID == "" {
		return nil, errors.New("parameter managementGroupID cannot be empty")
	}
...
// GetAtManagementGroup - Retrieves a variable value.
//
// This operation retrieves a single variable value; given its name, management group it was created at and the variable it's
// created for.
// If the operation fails it returns an *azcore.ResponseError type.
//   - managementGroupID - The ID of the management group.
//   - variableName - The name of the variable to operate on.
...
func (client *VariableValuesClient) getAtManagementGroupCreateRequest(ctx context.Context, managementGroupID string, variableName string, variableValueName string, _ *VariableValuesClientGetAtManagementGroupOptions) (*policy.Request, error) {
	urlPath := "/providers/Microsoft.Management/managementGroups/{managementGroupId}/providers/Microsoft.Authorization/variables/{variableName}/values/{variableValueName}"
	if managementGroupID == "" {
		return nil, errors.New("parameter managementGroupID cannot be empty")
	}
...
// NewListPager - List variable values for a variable.
//
...
// NewListForManagementGroupPager - List variable values at management group level.
//
