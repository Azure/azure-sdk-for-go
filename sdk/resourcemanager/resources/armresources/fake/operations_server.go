...
// The returned OperationsServerTransport instance is connected to an instance of armresources.OperationsClient by way of the
...
type OperationsServerTransport struct {
	...
	newListPager *azfake.PagerResponder[armresources.OperationsClientListResponse]
}
...
func (o *OperationsServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if o.newListPager == nil {
		...
		o.newListPager = &resp
		server.PagerResponderInjectNextLinks(o.newListPager, req, func(page *armresources.OperationsClientListResponse, createLink func() string) {
