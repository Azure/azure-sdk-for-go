...
func (p *ProviderResourceTypesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if providerResourceTypesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = providerResourceTypesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to ProviderResourceTypesServerTransport
var providerResourceTypesServerTransportInterceptor interface {
