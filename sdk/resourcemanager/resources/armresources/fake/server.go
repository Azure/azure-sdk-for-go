...
func (s *ServerTransport) dispatchCheckExistence(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := s.srv.CheckExistence(req.Context(), resourceGroupNameParam, resourceProviderNamespaceParam, parentResourcePathParam, resourceTypeParam, resourceNameParam, qp.Get("api-version"), nil)
...
func (s *ServerTransport) dispatchCheckExistenceByID(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := s.srv.CheckExistenceByID(req.Context(), resourceIDParam, qp.Get("api-version"), nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (s *ServerTransport) dispatchBeginCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginCreateOrUpdate == nil {
		...
		respr, errRespr := s.srv.BeginCreateOrUpdate(req.Context(), resourceGroupNameParam, resourceProviderNamespaceParam, parentResourcePathParam, resourceTypeParam, resourceNameParam, qp.Get("api-version"), body, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
...
func (s *ServerTransport) dispatchBeginCreateOrUpdateByID(req *http.Request) (*http.Response, error) {
	...
	if beginCreateOrUpdateByID == nil {
		...
		respr, errRespr := s.srv.BeginCreateOrUpdateByID(req.Context(), resourceIDParam, qp.Get("api-version"), body, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
...
func (s *ServerTransport) dispatchBeginDelete(req *http.Request) (*http.Response, error) {
	...
	if beginDelete == nil {
		...
		respr, errRespr := s.srv.BeginDelete(req.Context(), resourceGroupNameParam, resourceProviderNamespaceParam, parentResourcePathParam, resourceTypeParam, resourceNameParam, qp.Get("api-version"), nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginDelete = &respr
...
func (s *ServerTransport) dispatchBeginDeleteByID(req *http.Request) (*http.Response, error) {
	...
	if beginDeleteByID == nil {
		...
		respr, errRespr := s.srv.BeginDeleteByID(req.Context(), resourceIDParam, qp.Get("api-version"), nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
...
func (s *ServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := s.srv.Get(req.Context(), resourceGroupNameParam, resourceProviderNamespaceParam, parentResourcePathParam, resourceTypeParam, resourceNameParam, qp.Get("api-version"), nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (s *ServerTransport) dispatchGetByID(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := s.srv.GetByID(req.Context(), resourceIDParam, qp.Get("api-version"), nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (s *ServerTransport) dispatchBeginUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginUpdate == nil {
		...
		respr, errRespr := s.srv.BeginUpdate(req.Context(), resourceGroupNameParam, resourceProviderNamespaceParam, parentResourcePathParam, resourceTypeParam, resourceNameParam, qp.Get("api-version"), body, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginUpdate = &respr
...
func (s *ServerTransport) dispatchBeginUpdateByID(req *http.Request) (*http.Response, error) {
	...
	if beginUpdateByID == nil {
		...
		respr, errRespr := s.srv.BeginUpdateByID(req.Context(), resourceIDParam, qp.Get("api-version"), body, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
