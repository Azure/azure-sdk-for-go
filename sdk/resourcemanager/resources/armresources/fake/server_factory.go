...
type ServerFactory struct {
	...
	// ProviderResourceTypesServer contains the fakes for client ProviderResourceTypesClient
...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "ProviderResourceTypesClient":
		initServer(&s.trMu, &s.trProviderResourceTypesServer, func() *ProviderResourceTypesServerTransport {
