...
func (g GenericResourceExpanded) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateTime[datetime.RFC3339](objectMap, "changedTime", g.ChangedTime, true)
	populateTime[datetime.RFC3339](objectMap, "createdTime", g.CreatedTime, true)
	populate(objectMap, "extendedLocation", g.ExtendedLocation)
	populate(objectMap, "id", g.ID)
	populate(objectMap, "identity", g.Identity)
	populate(objectMap, "kind", g.Kind)
...
func (g *GenericResourceExpanded) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "changedTime":
			err = unpopulateTime[datetime.RFC3339](val, "ChangedTime", &g.ChangedTime)
			delete(rawMsg, key)
		case "createdTime":
			err = unpopulateTime[datetime.RFC3339](val, "CreatedTime", &g.CreatedTime)
			delete(rawMsg, key)
		case "extendedLocation":
			err = unpopulate(val, "ExtendedLocation", &g.ExtendedLocation)
			delete(rawMsg, key)
