...
- New function `NewResourcesClient(credential azcore.TokenCredential, options *arm.ClientOptions) (*ResourcesClient, error)`
- New function `*ResourcesClient.CheckResourceName(ctx context.Context, options *ResourcesClientCheckResourceNameOptions) (ResourcesClientCheckResourceNameResponse, error)`
- New function `*ResourcesClient.NewClient() *Client`
- New function `*ResourcesClient.NewOperationsClient() *OperationsClient`
- New function `*ResourcesClient.NewTenantsClient() *TenantsClient`
