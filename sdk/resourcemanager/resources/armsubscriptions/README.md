...
```go
client, err := armsubscriptions.NewSubscriptionsClient(<subscription ID>, cred, nil)
```
...
client, err := armsubscriptions.NewSubscriptionsClient(<subscription ID>, cred, &options)
```
