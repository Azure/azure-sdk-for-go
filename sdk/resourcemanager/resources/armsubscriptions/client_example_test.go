...
// Generated from example definition: 2022-12-01/GetSubscription.json
...
// Generated from example definition: 2022-12-01/GetSubscriptions.json
func ExampleClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armsubscriptions.ClientListResponse{
		// 	SubscriptionListResult: armsubscriptions.SubscriptionListResult{
		// 		NextLink: to.Ptr("http://nextlink"),
...
// Generated from example definition: 2022-12-01/GetLocationsWithExtendedLocations.json
func ExampleClient_NewListLocationsPager_getLocationsWithExtendedLocations() {
	...
	pager := clientFactory.NewClient().NewListLocationsPager("a1ffc958-d2c7-493e-9f1e-125a0477f536", &armsubscriptions.ClientListLocationsOptions{
