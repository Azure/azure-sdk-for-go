...
type SubscriptionPolicies struct {
	...
	// a subscription with a location placement Id of Public_2014-09-01 has access to Azure public regions.
...
type TenantListResult struct {
	// REQUIRED; The TenantIdDescription items on this page
