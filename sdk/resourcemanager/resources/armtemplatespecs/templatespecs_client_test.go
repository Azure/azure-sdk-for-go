...
func TestTemplateSpecsClient_CreateOrUpdate(t *testing.T) {
	stop := startTest(t)
	defer stop()
...
func TestTemplateSpecsClient_Get(t *testing.T) {
	stop := startTest(t)
	defer stop()
...
func TestTemplateSpecsClient_Update(t *testing.T) {
	stop := startTest(t)
	defer stop()
...
func TestTemplateSpecsClient_Delete(t *testing.T) {
	stop := startTest(t)
	defer stop()
...
func TestTemplateSpecsClient_ListByResourceGroup(t *testing.T) {
	stop := startTest(t)
	defer stop()
...
func TestTemplateSpecsClient_ListBySubscription(t *testing.T) {
	stop := startTest(t)
	defer stop()
	...
	pager := templateSpecsClient.ListBySubscription(nil)
	require.NoError(t, pager.Err())
}
