...
Azure Scheduler module consists of one or more clients. We provide a client factory which could be used to create any client in this module.
...
clientFactory, err := armscheduler.NewClientFactory(<subscription ID>, cred, &options)
```
