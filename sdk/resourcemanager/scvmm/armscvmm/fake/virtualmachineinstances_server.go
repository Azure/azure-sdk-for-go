...
type VirtualMachineInstancesServer struct {
	...
	BeginCreateCheckpoint func(ctx context.Context, resourceURI string, options *armscvmm.VirtualMachineInstancesClientBeginCreateCheckpointOptions) (resp azfake.PollerResponder[armscvmm.VirtualMachineInstancesClientCreateCheckpointResponse], errResp azfake.ErrorResponder)

	// BeginCreateOrUpdate is the fake for method VirtualMachineInstancesClient.BeginCreateOrUpdate
	// HTTP status codes to indicate success: http.StatusOK, http.StatusCreated
	BeginCreateOrUpdate func(ctx context.Context, resourceURI string, options *armscvmm.VirtualMachineInstancesClientBeginCreateOrUpdateOptions) (resp azfake.PollerResponder[armscvmm.VirtualMachineInstancesClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)
	...
	// HTTP status codes to indicate success: http.StatusAccepted
	BeginDeleteCheckpoint func(ctx context.Context, resourceURI string, options *armscvmm.VirtualMachineInstancesClientBeginDeleteCheckpointOptions) (resp azfake.PollerResponder[armscvmm.VirtualMachineInstancesClientDeleteCheckpointResponse], errResp azfake.ErrorResponder)
	...
	// HTTP status codes to indicate success: http.StatusAccepted
	BeginRestoreCheckpoint func(ctx context.Context, resourceURI string, options *armscvmm.VirtualMachineInstancesClientBeginRestoreCheckpointOptions) (resp azfake.PollerResponder[armscvmm.VirtualMachineInstancesClientRestoreCheckpointResponse], errResp azfake.ErrorResponder)
	...
	BeginUpdate func(ctx context.Context, resourceURI string, options *armscvmm.VirtualMachineInstancesClientBeginUpdateOptions) (resp azfake.PollerResponder[armscvmm.VirtualMachineInstancesClientUpdateResponse], errResp azfake.ErrorResponder)
}
...
func (v *VirtualMachineInstancesServerTransport) dispatchBeginCreateCheckpoint(req *http.Request) (*http.Response, error) {
	...
	if beginCreateCheckpoint == nil {
		...
		var options *armscvmm.VirtualMachineInstancesClientBeginCreateCheckpointOptions
		if !reflect.ValueOf(body).IsZero() {
			options = &armscvmm.VirtualMachineInstancesClientBeginCreateCheckpointOptions{
				Body: &body,
			}
		}
		respr, errRespr := v.srv.BeginCreateCheckpoint(req.Context(), resourceURIParam, options)
...
func (v *VirtualMachineInstancesServerTransport) dispatchBeginCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginCreateOrUpdate == nil {
		...
		var options *armscvmm.VirtualMachineInstancesClientBeginCreateOrUpdateOptions
		if !reflect.ValueOf(body).IsZero() {
			options = &armscvmm.VirtualMachineInstancesClientBeginCreateOrUpdateOptions{
				Body: &body,
			}
		}
		respr, errRespr := v.srv.BeginCreateOrUpdate(req.Context(), resourceURIParam, options)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
...
func (v *VirtualMachineInstancesServerTransport) dispatchBeginDeleteCheckpoint(req *http.Request) (*http.Response, error) {
	...
	if beginDeleteCheckpoint == nil {
		...
		var options *armscvmm.VirtualMachineInstancesClientBeginDeleteCheckpointOptions
		if !reflect.ValueOf(body).IsZero() {
			options = &armscvmm.VirtualMachineInstancesClientBeginDeleteCheckpointOptions{
				Body: &body,
			}
		}
		respr, errRespr := v.srv.BeginDeleteCheckpoint(req.Context(), resourceURIParam, options)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
...
func (v *VirtualMachineInstancesServerTransport) dispatchBeginRestoreCheckpoint(req *http.Request) (*http.Response, error) {
	...
	if beginRestoreCheckpoint == nil {
		...
		var options *armscvmm.VirtualMachineInstancesClientBeginRestoreCheckpointOptions
		if !reflect.ValueOf(body).IsZero() {
			options = &armscvmm.VirtualMachineInstancesClientBeginRestoreCheckpointOptions{
				Body: &body,
			}
		}
		respr, errRespr := v.srv.BeginRestoreCheckpoint(req.Context(), resourceURIParam, options)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
...
func (v *VirtualMachineInstancesServerTransport) dispatchBeginUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginUpdate == nil {
		...
		var options *armscvmm.VirtualMachineInstancesClientBeginUpdateOptions
		if !reflect.ValueOf(body).IsZero() {
			options = &armscvmm.VirtualMachineInstancesClientBeginUpdateOptions{
				Body: &body,
			}
		}
		respr, errRespr := v.srv.BeginUpdate(req.Context(), resourceURIParam, options)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginUpdate = &respr
