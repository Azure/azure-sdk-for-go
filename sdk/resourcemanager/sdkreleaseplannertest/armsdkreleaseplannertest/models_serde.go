...
// MarshalJSON implements the json.Marshaller interface for type DataBoxEdgeDeviceExtendedInfoPatch.
func (d DataBoxEdgeDeviceExtendedInfoPatch) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type DataBoxEdgeDeviceExtendedInfoPatch.
func (d *DataBoxEdgeDeviceExtendedInfoPatch) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", d, err)
	}
...
// UnmarshalJSON implements the json.Unmarshaller interface for type DataBoxEdgeDeviceExtendedInfoProperties.
func (d *DataBoxEdgeDeviceExtendedInfoProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", d, err)
	}
...
// UnmarshalJSON implements the json.Unmarshaller interface for type DataBoxEdgeDeviceList.
func (d *DataBoxEdgeDeviceList) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", d, err)
	}
...
// UnmarshalJSON implements the json.Unmarshaller interface for type DataBoxEdgeDevicePatch.
func (d *DataBoxEdgeDevicePatch) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", d, err)
	}
...
// UnmarshalJSON implements the json.Unmarshaller interface for type DataBoxEdgeDeviceProperties.
func (d *DataBoxEdgeDeviceProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", d, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type DataBoxEdgeDevicePropertiesPatch.
func (d DataBoxEdgeDevicePropertiesPatch) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "edgeProfile", d.EdgeProfile)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type DataBoxEdgeDevicePropertiesPatch.
func (d *DataBoxEdgeDevicePropertiesPatch) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", d, err)
	}
...
// UnmarshalJSON implements the json.Unmarshaller interface for type DataBoxEdgeSKU.
func (d *DataBoxEdgeSKU) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", d, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "apiVersions":
			err = unpopulate(val, "APIVersions", &d.APIVersions)
			delete(rawMsg, key)
		case "availability":
			err = unpopulate(val, "Availability", &d.Availability)
			delete(rawMsg, key)
		case "capabilities":
			err = unpopulate(val, "Capabilities", &d.Capabilities)
			delete(rawMsg, key)
		case "costs":
			err = unpopulate(val, "Costs", &d.Costs)
			delete(rawMsg, key)
		case "family":
		...
		case "kind":
			...
			delete(rawMsg, key)
		case "locationInfo":
			err = unpopulate(val, "LocationInfo", &d.LocationInfo)
			delete(rawMsg, key)
		case "locations":
		...
		case "resourceType":
			...
			delete(rawMsg, key)
		case "shipmentTypes":
			err = unpopulate(val, "ShipmentTypes", &d.ShipmentTypes)
			delete(rawMsg, key)
		case "signupOption":
			err = unpopulate(val, "SignupOption", &d.SignupOption)
			delete(rawMsg, key)
		case "size":
...
// UnmarshalJSON implements the json.Unmarshaller interface for type DataBoxEdgeSKUList.
func (d *DataBoxEdgeSKUList) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", d, err)
	}
