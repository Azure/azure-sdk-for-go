...
- Type of `Identity.UserAssignedIdentities` has been changed from `map[string]*UserAssignedIdentity` to `*UserAssignedManagedIdentities`
...
- New function `*Client.NewAdminKeysClient() *AdminKeysClient`
...
- New function `*Client.NewQueryKeysClient() *QueryKeysClient`
- New function `*Client.NewServicesClient() *ServicesClient`
- New function `*Client.NewSharedPrivateLinkResourcesClient() *SharedPrivateLinkResourcesClient`
- New function `*Client.NewUsagesClient() *UsagesClient`
- New function `*Client.UsageBySubscriptionSKU(ctx context.Context, location string, skuName string, params ManagementRequestOptions, options *ClientUsageBySubscriptionSKUOptions) (ClientUsageBySubscriptionSKUResponse, error)`
- New function `*ClientFactory.NewClient() *Client`
- New struct `AccessRulePropertiesSubscription`
- New struct `ManagementRequestOptions`
- New struct `UserAssignedManagedIdentities`
