...
func (client *AdminKeysClient) Get(ctx context.Context, resourceGroupName string, searchServiceName string, options *AdminKeysClientGetOptions) (AdminKeysClientGetResponse, error) {
	var err error
...
func (client *AdminKeysClient) getCreateRequest(ctx context.Context, resourceGroupName string, searchServiceName string, options *AdminKeysClientGetOptions) (*policy.Request, error) {
...
func (client *AdminKeysClient) Regenerate(ctx context.Context, resourceGroupName string, searchServiceName string, keyKind AdminKeyKind, options *AdminKeysClientRegenerateOptions) (AdminKeysClientRegenerateResponse, error) {
	var err error
...
func (client *AdminKeysClient) regenerateCreateRequest(ctx context.Context, resourceGroupName string, searchServiceName string, keyKind AdminKeyKind, options *AdminKeysClientRegenerateOptions) (*policy.Request, error) {
