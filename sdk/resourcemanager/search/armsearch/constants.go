...
// AutoGeneratedDomainNameLabelScope - Defines the level of reuse for the auto-generated domain name label for the search
// service.
type AutoGeneratedDomainNameLabelScope string

const (
	// AutoGeneratedDomainNameLabelScopeNoReuse - Service name will always have a unique auto-generated hash (regardless of tenant
	// or subscription).
	AutoGeneratedDomainNameLabelScopeNoReuse AutoGeneratedDomainNameLabelScope = "NoReuse"
	// AutoGeneratedDomainNameLabelScopeSubscriptionReuse - Service name will always have the same auto-generated hash within
	// the same subscription.
	AutoGeneratedDomainNameLabelScopeSubscriptionReuse AutoGeneratedDomainNameLabelScope = "SubscriptionReuse"
	// AutoGeneratedDomainNameLabelScopeTenantReuse - Service name will always have the same auto-generated hash within the same
	// tenant.
...
// that allow up to 1000 indexes, which is much higher than the maximum indexes allowed for any other SKU. For the standard3
// SKU, the value is either 'Default' or 'HighDensity'. For all other SKUs, this value must be 'Default'.
...
// If set to 'Disabled', traffic over public interface is not allowed, and private endpoint connections would be the exclusive
// access method.
...
// If a service has more than one unencrypted object, and enforcement is enabled, the service is marked as noncompliant.
...
// and no provisioning operations are underway. 'provisioning': The search service is being provisioned or scaled up or down.
// 'deleting': The search service is being deleted. 'degraded': The search service is degraded. This can occur when the underlying
// search units are not healthy. The search service is most likely operational, but performance might be slow and some requests
...
// your service is in the degraded, disabled, or error states, it means the Azure AI Search team is actively investigating
...
// the naming requirements (incorrect length, unsupported characters, etc.). 'AlreadyExists' indicates that the name is already
