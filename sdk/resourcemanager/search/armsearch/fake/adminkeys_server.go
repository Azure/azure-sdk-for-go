...
type AdminKeysServer struct {
	...
	Get func(ctx context.Context, resourceGroupName string, searchServiceName string, searchManagementRequestOptions armsearch.ManagementRequestOptions, options *armsearch.AdminKeysClientGetOptions) (resp azfake.Responder[armsearch.AdminKeysClientGetResponse], errResp azfake.ErrorResponder)

	// Regenerate is the fake for method AdminKeysClient.Regenerate
	// HTTP status codes to indicate success: http.StatusOK
	Regenerate func(ctx context.Context, resourceGroupName string, searchServiceName string, keyKind armsearch.AdminKeyKind, searchManagementRequestOptions armsearch.ManagementRequestOptions, options *armsearch.AdminKeysClientRegenerateOptions) (resp azfake.Responder[armsearch.AdminKeysClientRegenerateResponse], errResp azfake.ErrorResponder)
}
