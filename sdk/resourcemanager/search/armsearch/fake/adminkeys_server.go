...
type AdminKeysServer struct {
	...
	Get func(ctx context.Context, resourceGroupName string, searchServiceName string, options *armsearch.AdminKeysClientGetOptions) (resp azfake.Responder[armsearch.AdminKeysClientGetResponse], errResp azfake.ErrorResponder)

	// Regenerate is the fake for method AdminKeysClient.Regenerate
	// HTTP status codes to indicate success: http.StatusOK
	Regenerate func(ctx context.Context, resourceGroupName string, searchServiceName string, keyKind armsearch.AdminKeyKind, options *armsearch.AdminKeysClientRegenerateOptions) (resp azfake.Responder[armsearch.AdminKeysClientRegenerateResponse], errResp azfake.ErrorResponder)
}
...
func (a *AdminKeysServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	var options *armsearch.AdminKeysClientGetOptions
	if clientRequestIDParam != nil {
		options = &armsearch.AdminKeysClientGetOptions{
			ClientRequestID: clientRequestIDParam,
		}
	}
	respr, errRespr := a.srv.Get(req.Context(), resourceGroupNameParam, searchServiceNameParam, options)
...
func (a *AdminKeysServerTransport) dispatchRegenerate(req *http.Request) (*http.Response, error) {
	...
	clientRequestIDParam := getOptional(getHeaderValue(req.Header, "x-ms-client-request-id"))
	var options *armsearch.AdminKeysClientRegenerateOptions
	if clientRequestIDParam != nil {
		options = &armsearch.AdminKeysClientRegenerateOptions{
			ClientRequestID: clientRequestIDParam,
		}
	}
	respr, errRespr := a.srv.Regenerate(req.Context(), resourceGroupNameParam, searchServiceNameParam, keyKindParam, options)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
