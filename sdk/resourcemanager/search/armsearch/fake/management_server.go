...
type ManagementServer struct {
	...
	UsageBySubscriptionSKU func(ctx context.Context, location string, skuName string, options *armsearch.ManagementClientUsageBySubscriptionSKUOptions) (resp azfake.Responder[armsearch.ManagementClientUsageBySubscriptionSKUResponse], errResp azfake.ErrorResponder)
}
...
func (m *ManagementServerTransport) dispatchUsageBySubscriptionSKU(req *http.Request) (*http.Response, error) {
	...
	var options *armsearch.ManagementClientUsageBySubscriptionSKUOptions
	...
	respr, errRespr := m.srv.UsageBySubscriptionSKU(req.Context(), locationParam, skuNameParam, options)
