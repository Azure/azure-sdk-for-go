...
type PrivateEndpointConnectionsServer struct {
	...
	Delete func(ctx context.Context, resourceGroupName string, searchServiceName string, privateEndpointConnectionName string, options *armsearch.PrivateEndpointConnectionsClientDeleteOptions) (resp azfake.Responder[armsearch.PrivateEndpointConnectionsClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method PrivateEndpointConnectionsClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, searchServiceName string, privateEndpointConnectionName string, options *armsearch.PrivateEndpointConnectionsClientGetOptions) (resp azfake.Responder[armsearch.PrivateEndpointConnectionsClientGetResponse], errResp azfake.ErrorResponder)

	// NewListByServicePager is the fake for method PrivateEndpointConnectionsClient.NewListByServicePager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByServicePager func(resourceGroupName string, searchServiceName string, options *armsearch.PrivateEndpointConnectionsClientListByServiceOptions) (resp azfake.PagerResponder[armsearch.PrivateEndpointConnectionsClientListByServiceResponse])

	// Update is the fake for method PrivateEndpointConnectionsClient.Update
	// HTTP status codes to indicate success: http.StatusOK
	Update func(ctx context.Context, resourceGroupName string, searchServiceName string, privateEndpointConnectionName string, privateEndpointConnection armsearch.PrivateEndpointConnection, options *armsearch.PrivateEndpointConnectionsClientUpdateOptions) (resp azfake.Responder[armsearch.PrivateEndpointConnectionsClientUpdateResponse], errResp azfake.ErrorResponder)
}
...
func (p *PrivateEndpointConnectionsServerTransport) dispatchDelete(req *http.Request) (*http.Response, error) {
	...
	const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.Search/searchServices/(?P<searchServiceName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/privateEndpointConnections/(?P<privateEndpointConnectionName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)`
	...
	var options *armsearch.PrivateEndpointConnectionsClientDeleteOptions
	if clientRequestIDParam != nil {
		options = &armsearch.PrivateEndpointConnectionsClientDeleteOptions{
			ClientRequestID: clientRequestIDParam,
		}
	}
	respr, errRespr := p.srv.Delete(req.Context(), resourceGroupNameParam, searchServiceNameParam, privateEndpointConnectionNameParam, options)
...
func (p *PrivateEndpointConnectionsServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	clientRequestIDParam := getOptional(getHeaderValue(req.Header, "x-ms-client-request-id"))
	var options *armsearch.PrivateEndpointConnectionsClientGetOptions
	if clientRequestIDParam != nil {
		options = &armsearch.PrivateEndpointConnectionsClientGetOptions{
			ClientRequestID: clientRequestIDParam,
		}
	}
	respr, errRespr := p.srv.Get(req.Context(), resourceGroupNameParam, searchServiceNameParam, privateEndpointConnectionNameParam, options)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (p *PrivateEndpointConnectionsServerTransport) dispatchNewListByServicePager(req *http.Request) (*http.Response, error) {
	...
	if newListByServicePager == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.Search/searchServices/(?P<searchServiceName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/privateEndpointConnections`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 4 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
		...
		clientRequestIDParam := getOptional(getHeaderValue(req.Header, "x-ms-client-request-id"))
		var options *armsearch.PrivateEndpointConnectionsClientListByServiceOptions
		if clientRequestIDParam != nil {
			options = &armsearch.PrivateEndpointConnectionsClientListByServiceOptions{
				ClientRequestID: clientRequestIDParam,
			}
		}
		resp := p.srv.NewListByServicePager(resourceGroupNameParam, searchServiceNameParam, options)
...
func (p *PrivateEndpointConnectionsServerTransport) dispatchUpdate(req *http.Request) (*http.Response, error) {
	...
	clientRequestIDParam := getOptional(getHeaderValue(req.Header, "x-ms-client-request-id"))
	var options *armsearch.PrivateEndpointConnectionsClientUpdateOptions
	if clientRequestIDParam != nil {
		options = &armsearch.PrivateEndpointConnectionsClientUpdateOptions{
			ClientRequestID: clientRequestIDParam,
		}
	}
	respr, errRespr := p.srv.Update(req.Context(), resourceGroupNameParam, searchServiceNameParam, privateEndpointConnectionNameParam, body, options)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
