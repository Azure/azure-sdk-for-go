...
type PrivateEndpointConnectionsServer struct {
	...
	Delete func(ctx context.Context, resourceGroupName string, searchServiceName string, privateEndpointConnectionName string, searchManagementRequestOptions armsearch.ManagementRequestOptions, options *armsearch.PrivateEndpointConnectionsClientDeleteOptions) (resp azfake.Responder[armsearch.PrivateEndpointConnectionsClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method PrivateEndpointConnectionsClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, searchServiceName string, privateEndpointConnectionName string, searchManagementRequestOptions armsearch.ManagementRequestOptions, options *armsearch.PrivateEndpointConnectionsClientGetOptions) (resp azfake.Responder[armsearch.PrivateEndpointConnectionsClientGetResponse], errResp azfake.ErrorResponder)

	// NewListByServicePager is the fake for method PrivateEndpointConnectionsClient.NewListByServicePager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByServicePager func(resourceGroupName string, searchServiceName string, searchManagementRequestOptions armsearch.ManagementRequestOptions, options *armsearch.PrivateEndpointConnectionsClientListByServiceOptions) (resp azfake.PagerResponder[armsearch.PrivateEndpointConnectionsClientListByServiceResponse])
