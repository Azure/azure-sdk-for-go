...
type QueryKeysServer struct {
	...
	Create	func(ctx context.Context, resourceGroupName string, searchServiceName string, name string, params armsearch.ManagementRequestOptions, options *armsearch.QueryKeysClientCreateOptions) (resp azfake.Responder[armsearch.QueryKeysClientCreateResponse], errResp azfake.ErrorResponder)
	...
	Delete	func(ctx context.Context, resourceGroupName string, searchServiceName string, key string, params armsearch.ManagementRequestOptions, options *armsearch.QueryKeysClientDeleteOptions) (resp azfake.Responder[armsearch.QueryKeysClientDeleteResponse], errResp azfake.ErrorResponder)

	// NewListBySearchServicePager is the fake for method QueryKeysClient.NewListBySearchServicePager
	// HTTP status codes to indicate success: http.StatusOK
	NewListBySearchServicePager	func(resourceGroupName string, searchServiceName string, params armsearch.ManagementRequestOptions, options *armsearch.QueryKeysClientListBySearchServiceOptions) (resp azfake.PagerResponder[armsearch.QueryKeysClientListBySearchServiceResponse])
}
...
func (q *QueryKeysServerTransport) dispatchCreate(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := q.srv.Create(req.Context(), resourceGroupNameParam, searchServiceNameParam, nameParam, params, nil)
...
func (q *QueryKeysServerTransport) dispatchDelete(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := q.srv.Delete(req.Context(), resourceGroupNameParam, searchServiceNameParam, keyParam, params, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (q *QueryKeysServerTransport) dispatchNewListBySearchServicePager(req *http.Request) (*http.Response, error) {
	...
	if newListBySearchServicePager == nil {
		...
		resp := q.srv.NewListBySearchServicePager(resourceGroupNameParam, searchServiceNameParam, params, nil)
