...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "AdminKeysClient":
		initServer(&s.trMu, &s.trAdminKeysServer, func() *AdminKeysServerTransport { return NewAdminKeysServerTransport(&s.srv.AdminKeysServer) })
	...
	case "QueryKeysClient":
		initServer(&s.trMu, &s.trQueryKeysServer, func() *QueryKeysServerTransport { return NewQueryKeysServerTransport(&s.srv.QueryKeysServer) })
