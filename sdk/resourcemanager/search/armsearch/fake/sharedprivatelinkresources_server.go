...
type SharedPrivateLinkResourcesServer struct {
	...
	BeginCreateOrUpdate func(ctx context.Context, resourceGroupName string, searchServiceName string, sharedPrivateLinkResourceName string, sharedPrivateLinkResource armsearch.SharedPrivateLinkResource, options *armsearch.SharedPrivateLinkResourcesClientBeginCreateOrUpdateOptions) (resp azfake.PollerResponder[armsearch.SharedPrivateLinkResourcesClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)
	...
	BeginDelete func(ctx context.Context, resourceGroupName string, searchServiceName string, sharedPrivateLinkResourceName string, options *armsearch.SharedPrivateLinkResourcesClientBeginDeleteOptions) (resp azfake.PollerResponder[armsearch.SharedPrivateLinkResourcesClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method SharedPrivateLinkResourcesClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, searchServiceName string, sharedPrivateLinkResourceName string, options *armsearch.SharedPrivateLinkResourcesClientGetOptions) (resp azfake.Responder[armsearch.SharedPrivateLinkResourcesClientGetResponse], errResp azfake.ErrorResponder)

	// NewListByServicePager is the fake for method SharedPrivateLinkResourcesClient.NewListByServicePager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByServicePager func(resourceGroupName string, searchServiceName string, options *armsearch.SharedPrivateLinkResourcesClientListByServiceOptions) (resp azfake.PagerResponder[armsearch.SharedPrivateLinkResourcesClientListByServiceResponse])
}
...
func (s *SharedPrivateLinkResourcesServerTransport) dispatchBeginCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginCreateOrUpdate == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.Search/searchServices/(?P<searchServiceName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/sharedPrivateLinkResources/(?P<sharedPrivateLinkResourceName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)`
		...
		var options *armsearch.SharedPrivateLinkResourcesClientBeginCreateOrUpdateOptions
		...
		respr, errRespr := s.srv.BeginCreateOrUpdate(req.Context(), resourceGroupNameParam, searchServiceNameParam, sharedPrivateLinkResourceNameParam, body, options)
...
func (s *SharedPrivateLinkResourcesServerTransport) dispatchBeginDelete(req *http.Request) (*http.Response, error) {
	...
	if beginDelete == nil {
		...
		clientRequestIDParam := getOptional(getHeaderValue(req.Header, "x-ms-client-request-id"))
		var options *armsearch.SharedPrivateLinkResourcesClientBeginDeleteOptions
		if clientRequestIDParam != nil {
			options = &armsearch.SharedPrivateLinkResourcesClientBeginDeleteOptions{
				ClientRequestID: clientRequestIDParam,
			}
		}
		respr, errRespr := s.srv.BeginDelete(req.Context(), resourceGroupNameParam, searchServiceNameParam, sharedPrivateLinkResourceNameParam, options)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginDelete = &respr
	...
	if !slices.Contains([]int{http.StatusOK, http.StatusAccepted, http.StatusNoContent, http.StatusNotFound}, resp.StatusCode) {
...
func (s *SharedPrivateLinkResourcesServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	clientRequestIDParam := getOptional(getHeaderValue(req.Header, "x-ms-client-request-id"))
	var options *armsearch.SharedPrivateLinkResourcesClientGetOptions
	if clientRequestIDParam != nil {
		options = &armsearch.SharedPrivateLinkResourcesClientGetOptions{
			ClientRequestID: clientRequestIDParam,
		}
	}
	respr, errRespr := s.srv.Get(req.Context(), resourceGroupNameParam, searchServiceNameParam, sharedPrivateLinkResourceNameParam, options)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
...
func (s *SharedPrivateLinkResourcesServerTransport) dispatchNewListByServicePager(req *http.Request) (*http.Response, error) {
	...
	if newListByServicePager == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.Search/searchServices/(?P<searchServiceName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/sharedPrivateLinkResources`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 4 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
		...
		clientRequestIDParam := getOptional(getHeaderValue(req.Header, "x-ms-client-request-id"))
		var options *armsearch.SharedPrivateLinkResourcesClientListByServiceOptions
		if clientRequestIDParam != nil {
			options = &armsearch.SharedPrivateLinkResourcesClientListByServiceOptions{
				ClientRequestID: clientRequestIDParam,
			}
		}
		resp := s.srv.NewListByServicePager(resourceGroupNameParam, searchServiceNameParam, options)
