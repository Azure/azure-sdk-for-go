...
//     resource group.
//   - searchManagementRequestOptions - ManagementRequestOptions contains a group of parameters for the PrivateEndpointConnectionsClient.Delete
//     method.
...
//     method.
func (client *PrivateEndpointConnectionsClient) Delete(ctx context.Context, resourceGroupName string, searchServiceName string, privateEndpointConnectionName string, searchManagementRequestOptions ManagementRequestOptions, options *PrivateEndpointConnectionsClientDeleteOptions) (PrivateEndpointConnectionsClientDeleteResponse, error) {
	var err error
...
func (client *PrivateEndpointConnectionsClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, searchServiceName string, privateEndpointConnectionName string, searchManagementRequestOptions ManagementRequestOptions, _ *PrivateEndpointConnectionsClientDeleteOptions) (*policy.Request, error) {
...
//   - privateEndpointConnectionName - The name of the private endpoint connection to the Azure AI Search service with the specified
//     resource group.
//   - searchManagementRequestOptions - ManagementRequestOptions contains a group of parameters for the PrivateEndpointConnectionsClient.Get
//     method.
...
func (client *PrivateEndpointConnectionsClient) getCreateRequest(ctx context.Context, resourceGroupName string, searchServiceName string, privateEndpointConnectionName string, searchManagementRequestOptions ManagementRequestOptions, _ *PrivateEndpointConnectionsClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Search/searchServices/{searchServiceName}/privateEndpointConnections/{privateEndpointConnectionName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - searchServiceName - The name of the Azure AI Search service associated with the specified resource group.
//   - searchManagementRequestOptions - ManagementRequestOptions contains a group of parameters for the PrivateEndpointConnectionsClient.ListByService
//     method.
...
func (client *PrivateEndpointConnectionsClient) listByServiceCreateRequest(ctx context.Context, resourceGroupName string, searchServiceName string, searchManagementRequestOptions ManagementRequestOptions, _ *PrivateEndpointConnectionsClientListByServiceOptions) (*policy.Request, error) {
...
//   - searchManagementRequestOptions - ManagementRequestOptions contains a group of parameters for the PrivateEndpointConnectionsClient.Update
//     method.
