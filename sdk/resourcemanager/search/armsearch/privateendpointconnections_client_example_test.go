...
func ExamplePrivateEndpointConnectionsClient_Delete() {
	...
	res, err := clientFactory.NewPrivateEndpointConnectionsClient().Delete(ctx, "rg1", "mysearchservice", "testEndpoint.50bf4fbe-d7c1-4b48-a642-4f5892642546", nil)
	if err != nil {
...
func ExamplePrivateEndpointConnectionsClient_Get() {
	...
	res, err := clientFactory.NewPrivateEndpointConnectionsClient().Get(ctx, "rg1", "mysearchservice", "testEndpoint.50bf4fbe-d7c1-4b48-a642-4f5892642546", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
...
func ExamplePrivateEndpointConnectionsClient_NewListByServicePager() {
	...
	pager := clientFactory.NewPrivateEndpointConnectionsClient().NewListByServicePager("rg1", "mysearchservice", nil)
	for pager.More() {
		...
		// page = armsearch.PrivateEndpointConnectionsClientListByServiceResponse{
