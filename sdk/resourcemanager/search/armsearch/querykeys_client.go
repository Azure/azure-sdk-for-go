...
//   - searchManagementRequestOptions - ManagementRequestOptions contains a group of parameters for the QueryKeysClient.Create
//     method.
//   - options - QueryKeysClientCreateOptions contains the optional parameters for the QueryKeysClient.Create method.
func (client *QueryKeysClient) Create(ctx context.Context, resourceGroupName string, searchServiceName string, name string, searchManagementRequestOptions ManagementRequestOptions, options *QueryKeysClientCreateOptions) (QueryKeysClientCreateResponse, error) {
	var err error
...
func (client *QueryKeysClient) createCreateRequest(ctx context.Context, resourceGroupName string, searchServiceName string, name string, searchManagementRequestOptions ManagementRequestOptions, _ *QueryKeysClientCreateOptions) (*policy.Request, error) {
...
//   - searchManagementRequestOptions - ManagementRequestOptions contains a group of parameters for the QueryKeysClient.Delete
//     method.
//   - options - QueryKeysClientDeleteOptions contains the optional parameters for the QueryKeysClient.Delete method.
func (client *QueryKeysClient) Delete(ctx context.Context, resourceGroupName string, searchServiceName string, key string, searchManagementRequestOptions ManagementRequestOptions, options *QueryKeysClientDeleteOptions) (QueryKeysClientDeleteResponse, error) {
	var err error
...
func (client *QueryKeysClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, searchServiceName string, key string, searchManagementRequestOptions ManagementRequestOptions, _ *QueryKeysClientDeleteOptions) (*policy.Request, error) {
...
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - searchServiceName - The name of the Azure AI Search service associated with the specified resource group.
//   - searchManagementRequestOptions - ManagementRequestOptions contains a group of parameters for the QueryKeysClient.ListBySearchService
//     method.
...
//     method.
func (client *QueryKeysClient) NewListBySearchServicePager(resourceGroupName string, searchServiceName string, searchManagementRequestOptions ManagementRequestOptions, options *QueryKeysClientListBySearchServiceOptions) *runtime.Pager[QueryKeysClientListBySearchServiceResponse] {
...
func (client *QueryKeysClient) listBySearchServiceCreateRequest(ctx context.Context, resourceGroupName string, searchServiceName string, searchManagementRequestOptions ManagementRequestOptions, _ *QueryKeysClientListBySearchServiceOptions) (*policy.Request, error) {
