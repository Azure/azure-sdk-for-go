...
//   - body - The resource name and type to check.
//   - params - ManagementRequestOptions contains a group of parameters for the ServicesClient.CheckNameAvailability method.
...
func (client *ServicesClient) CheckNameAvailability(ctx context.Context, body CheckNameAvailabilityInput, params ManagementRequestOptions, options *ServicesClientCheckNameAvailabilityOptions) (ServicesClientCheckNameAvailabilityResponse, error) {
	...
	req, err := client.checkNameAvailabilityCreateRequest(ctx, body, params, options)
	if err != nil {
...
func (client *ServicesClient) checkNameAvailabilityCreateRequest(ctx context.Context, body CheckNameAvailabilityInput, params ManagementRequestOptions, _ *ServicesClientCheckNameAvailabilityOptions) (*policy.Request, error) {
...
//   - params - ManagementRequestOptions contains a group of parameters for the ServicesClient.CreateOrUpdate method.
...
//     method.
func (client *ServicesClient) BeginCreateOrUpdate(ctx context.Context, resourceGroupName string, searchServiceName string, resource Service, params ManagementRequestOptions, options *ServicesClientBeginCreateOrUpdateOptions) (*runtime.Poller[ServicesClientCreateOrUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.createOrUpdate(ctx, resourceGroupName, searchServiceName, resource, params, options)
		if err != nil {
			return nil, err
		}
...
//
// Generated from API version 2025-05-01
func (client *ServicesClient) createOrUpdate(ctx context.Context, resourceGroupName string, searchServiceName string, resource Service, params ManagementRequestOptions, options *ServicesClientBeginCreateOrUpdateOptions) (*http.Response, error) {
	var err error
	const operationName = "ServicesClient.BeginCreateOrUpdate"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.createOrUpdateCreateRequest(ctx, resourceGroupName, searchServiceName, resource, params, options)
	if err != nil {
		return nil, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
...
func (client *ServicesClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, searchServiceName string, resource Service, params ManagementRequestOptions, _ *ServicesClientBeginCreateOrUpdateOptions) (*policy.Request, error) {
...
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - searchServiceName - The name of the Azure AI Search service associated with the specified resource group.
//   - params - ManagementRequestOptions contains a group of parameters for the ServicesClient.Delete method.
//   - options - ServicesClientDeleteOptions contains the optional parameters for the ServicesClient.Delete method.
func (client *ServicesClient) Delete(ctx context.Context, resourceGroupName string, searchServiceName string, params ManagementRequestOptions, options *ServicesClientDeleteOptions) (ServicesClientDeleteResponse, error) {
	var err error
	const operationName = "ServicesClient.Delete"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.deleteCreateRequest(ctx, resourceGroupName, searchServiceName, params, options)
	if err != nil {
...
func (client *ServicesClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, searchServiceName string, params ManagementRequestOptions, _ *ServicesClientDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Search/searchServices/{searchServiceName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - searchServiceName - The name of the Azure AI Search service associated with the specified resource group.
//   - params - ManagementRequestOptions contains a group of parameters for the ServicesClient.Get method.
//   - options - ServicesClientGetOptions contains the optional parameters for the ServicesClient.Get method.
func (client *ServicesClient) Get(ctx context.Context, resourceGroupName string, searchServiceName string, params ManagementRequestOptions, options *ServicesClientGetOptions) (ServicesClientGetResponse, error) {
	var err error
...
func (client *ServicesClient) getCreateRequest(ctx context.Context, resourceGroupName string, searchServiceName string, params ManagementRequestOptions, _ *ServicesClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Search/searchServices/{searchServiceName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
// Generated from API version 2025-05-01
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - params - ManagementRequestOptions contains a group of parameters for the ServicesClient.ListByResourceGroup method.
...
//     method.
func (client *ServicesClient) NewListByResourceGroupPager(resourceGroupName string, params ManagementRequestOptions, options *ServicesClientListByResourceGroupOptions) *runtime.Pager[ServicesClientListByResourceGroupResponse] {
	return runtime.NewPager(runtime.PagingHandler[ServicesClientListByResourceGroupResponse]{
		...
		Fetcher: func(ctx context.Context, page *ServicesClientListByResourceGroupResponse) (ServicesClientListByResourceGroupResponse, error) {
			...
			resp, err := runtime.FetcherForNextLink(ctx, client.internal.Pipeline(), nextLink, func(ctx context.Context) (*policy.Request, error) {
				return client.listByResourceGroupCreateRequest(ctx, resourceGroupName, params, options)
			}, nil)
			if err != nil {
...
func (client *ServicesClient) listByResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, params ManagementRequestOptions, _ *ServicesClientListByResourceGroupOptions) (*policy.Request, error) {
...
//
// Generated from API version 2025-05-01
//   - params - ManagementRequestOptions contains a group of parameters for the ServicesClient.ListBySubscription method.
...
//     method.
func (client *ServicesClient) NewListBySubscriptionPager(params ManagementRequestOptions, options *ServicesClientListBySubscriptionOptions) *runtime.Pager[ServicesClientListBySubscriptionResponse] {
	return runtime.NewPager(runtime.PagingHandler[ServicesClientListBySubscriptionResponse]{
		...
		Fetcher: func(ctx context.Context, page *ServicesClientListBySubscriptionResponse) (ServicesClientListBySubscriptionResponse, error) {
			...
			resp, err := runtime.FetcherForNextLink(ctx, client.internal.Pipeline(), nextLink, func(ctx context.Context) (*policy.Request, error) {
				return client.listBySubscriptionCreateRequest(ctx, params, options)
			}, nil)
			if err != nil {
...
func (client *ServicesClient) listBySubscriptionCreateRequest(ctx context.Context, params ManagementRequestOptions, _ *ServicesClientListBySubscriptionOptions) (*policy.Request, error) {
...
//   - params - ManagementRequestOptions contains a group of parameters for the ServicesClient.Update method.
//   - options - ServicesClientUpdateOptions contains the optional parameters for the ServicesClient.Update method.
func (client *ServicesClient) Update(ctx context.Context, resourceGroupName string, searchServiceName string, properties ServiceUpdate, params ManagementRequestOptions, options *ServicesClientUpdateOptions) (ServicesClientUpdateResponse, error) {
	var err error
	const operationName = "ServicesClient.Update"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.updateCreateRequest(ctx, resourceGroupName, searchServiceName, properties, params, options)
	if err != nil {
...
func (client *ServicesClient) updateCreateRequest(ctx context.Context, resourceGroupName string, searchServiceName string, properties ServiceUpdate, params ManagementRequestOptions, _ *ServicesClientUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Search/searchServices/{searchServiceName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
