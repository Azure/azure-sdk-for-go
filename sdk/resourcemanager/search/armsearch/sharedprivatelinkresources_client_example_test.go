...
func ExampleSharedPrivateLinkResourcesClient_BeginDelete() {
	...
	poller, err := clientFactory.NewSharedPrivateLinkResourcesClient().BeginDelete(ctx, "rg1", "mysearchservice", "testResource", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
...
func ExampleSharedPrivateLinkResourcesClient_NewListByServicePager() {
	...
	pager := clientFactory.NewSharedPrivateLinkResourcesClient().NewListByServicePager("rg1", "mysearchservice", nil)
	for pager.More() {
		...
		// page = armsearch.SharedPrivateLinkResourcesClientListByServiceResponse{
		// 	SharedPrivateLinkResourceListResult: armsearch.SharedPrivateLinkResourceListResult{
