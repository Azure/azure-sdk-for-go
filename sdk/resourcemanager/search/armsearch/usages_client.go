...
//   - params - ManagementRequestOptions contains a group of parameters for the UsagesClient.ListBySubscription method.
	...
	return runtime.NewPager(runtime.PagingHandler[UsagesClientListBySubscriptionResponse]{
		...
		Fetcher: func(ctx context.Context, page *UsagesClientListBySubscriptionResponse) (UsagesClientListBySubscriptionResponse, error) {
			...
			resp, err := runtime.FetcherForNextLink(ctx, client.internal.Pipeline(), nextLink, func(ctx context.Context) (*policy.Request, error) {
				return client.listBySubscriptionCreateRequest(ctx, location, params, options)
			}, nil)
			if err != nil {
...
func (client *UsagesClient) listBySubscriptionCreateRequest(ctx context.Context, location string, params ManagementRequestOptions, _ *UsagesClientListBySubscriptionOptions) (*policy.Request, error) {
