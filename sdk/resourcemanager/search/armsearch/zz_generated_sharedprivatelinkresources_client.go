...
func NewSharedPrivateLinkResourcesClient(con *arm.Connection, subscriptionID string) *SharedPrivateLinkResourcesClient {
	return &SharedPrivateLinkResourcesClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
...
func (client *SharedPrivateLinkResourcesClient) listByServiceHandleResponse(resp *http.Response) (SharedPrivateLinkResourcesListByServiceResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.SharedPrivateLinkResourceListResult); err != nil {
		return SharedPrivateLinkResourcesListByServiceResponse{}, err
	}
	return result, nil
}
