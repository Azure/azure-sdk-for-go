...
- Type of `HealthReportProperties.ResourceDetails` has been changed from `*ResourceDetailsAutoGenerated` to `*HealthReportResourceDetails`
...
- New struct `HealthReportResourceDetails`
