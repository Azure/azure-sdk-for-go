...
// Generated from example definition: 2019-01-01/AdvancedThreatProtection/PutAdvancedThreatProtectionSettings_example.json
func ExampleAdvancedThreatProtectionClient_Create() {
	...
	// res = armsecurity.AdvancedThreatProtectionClientCreateResponse{
	// 	AdvancedThreatProtectionSetting: armsecurity.AdvancedThreatProtectionSetting{
	// 		Name: to.Ptr("current"),
	// 		Type: to.Ptr("Microsoft.Security/advancedThreatProtectionSettings"),
	// 		ID: to.Ptr("/subscriptions/20ff7fc3-e762-44dd-bd96-b71116dcdc23/resourceGroups/SampleRG/providers/Microsoft.Storage/storageAccounts/samplestorageaccount/providers/Microsoft.Security/advancedThreatProtectionSettings/current"),
	// 		Properties: &armsecurity.AdvancedThreatProtectionProperties{
...
// Generated from example definition: 2019-01-01/AdvancedThreatProtection/GetAdvancedThreatProtectionSettings_example.json
func ExampleAdvancedThreatProtectionClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsecurity.AdvancedThreatProtectionClientGetResponse{
	// 	AdvancedThreatProtectionSetting: armsecurity.AdvancedThreatProtectionSetting{
	// 		Name: to.Ptr("current"),
	// 		Type: to.Ptr("Microsoft.Security/advancedThreatProtectionSettings"),
	// 		ID: to.Ptr("/subscriptions/20ff7fc3-e762-44dd-bd96-b71116dcdc23/resourceGroups/SampleRG/providers/Microsoft.Storage/storageAccounts/samplestorageaccount/providers/Microsoft.Security/advancedThreatProtectionSettings/current"),
