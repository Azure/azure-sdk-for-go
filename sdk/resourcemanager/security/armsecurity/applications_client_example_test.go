...
// Generated from example definition: 2022-07-01-preview/Applications/ListBySubscriptionApplications_example.json
func ExampleApplicationsClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armsecurity.ApplicationsClientListResponse{
