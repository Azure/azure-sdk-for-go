...
// Generated from example definition: 2025-05-04/Assessments/PutAssessment_example.json
func ExampleAssessmentsClient_CreateOrUpdate() {
	...
	// res = armsecurity.AssessmentsClientCreateOrUpdateResponse{
...
// Generated from example definition: 2025-05-04/Assessments/DeleteAssessment_example.json
func ExampleAssessmentsClient_Delete() {
	...
	res, err := clientFactory.NewAssessmentsClient().Delete(ctx, "subscriptions/20ff7fc3-e762-44dd-bd96-b71116dcdc23/resourceGroups/myRg/providers/Microsoft.Compute/virtualMachineScaleSets/vmss2", "8bb8be0a-6010-4789-812f-e4d661c4ed0e", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsecurity.AssessmentsClientDeleteResponse{
	// }
}
...
// Generated from example definition: 2025-05-04/Assessments/ListAssessments_example.json
func ExampleAssessmentsClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armsecurity.AssessmentsClientListResponse{
		// 	AssessmentList: armsecurity.AssessmentList{
