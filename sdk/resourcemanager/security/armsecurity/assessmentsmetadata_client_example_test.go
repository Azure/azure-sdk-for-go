...
// Generated from example definition: 2025-05-04/AssessmentsMetadata/CreateAssessmentsMetadata_subscription_example.json
func ExampleAssessmentsMetadataClient_CreateInSubscription() {
	...
	// res = armsecurity.AssessmentsMetadataClientCreateInSubscriptionResponse{
...
// Generated from example definition: 2025-05-04/AssessmentsMetadata/GetAssessmentsMetadata_example.json
func ExampleAssessmentsMetadataClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsecurity.AssessmentsMetadataClientGetResponse{
	// 	AssessmentMetadataResponse: armsecurity.AssessmentMetadataResponse{
...
// Generated from example definition: 2025-05-04/AssessmentsMetadata/ListAssessmentsMetadata_example.json
func ExampleAssessmentsMetadataClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armsecurity.AssessmentsMetadataClientListResponse{
		// 	AssessmentMetadataResponseList: armsecurity.AssessmentMetadataResponseList{
...
// Generated from example definition: 2025-05-04/AssessmentsMetadata/ListAssessmentsMetadata_subscription_example.json
func ExampleAssessmentsMetadataClient_NewListBySubscriptionPager() {
	...
	for pager.More() {
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armsecurity.AssessmentsMetadataClientListBySubscriptionResponse{
		// 	AssessmentMetadataResponseList: armsecurity.AssessmentMetadataResponseList{
		// 		Value: []*armsecurity.AssessmentMetadataResponse{
		// 			{
		// 				Name: to.Ptr("21300918-b2e3-0346-785f-c77ff57d243b"),
