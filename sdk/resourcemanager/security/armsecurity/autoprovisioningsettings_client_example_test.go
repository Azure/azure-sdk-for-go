...
// Generated from example definition: 2017-08-01-preview/AutoProvisioningSettings/CreateAutoProvisioningSettingsSubscription_example.json
func ExampleAutoProvisioningSettingsClient_Create() {
	...
	// res = armsecurity.AutoProvisioningSettingsClientCreateResponse{
...
// Generated from example definition: 2017-08-01-preview/AutoProvisioningSettings/GetAutoProvisioningSettingSubscription_example.json
func ExampleAutoProvisioningSettingsClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsecurity.AutoProvisioningSettingsClientGetResponse{
	// 	AutoProvisioningSetting: armsecurity.AutoProvisioningSetting{
	// 		Name: to.Ptr("default"),
	// 		Type: to.Ptr("Microsoft.Security/autoProvisioningSettings"),
	// 		ID: to.Ptr("/subscriptions/20ff7fc3-e762-44dd-bd96-b71116dcdc23/providers/Microsoft.Security/autoProvisioningSettings/default"),
...
// Generated from example definition: 2017-08-01-preview/AutoProvisioningSettings/GetAutoProvisioningSettingsSubscription_example.json
func ExampleAutoProvisioningSettingsClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armsecurity.AutoProvisioningSettingsClientListResponse{
