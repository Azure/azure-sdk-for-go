...
// Generated from example definition: 2017-08-01/ComplianceResults/GetComplianceResults_example.json
func ExampleComplianceResultsClient_Get() {
	...
	// res = armsecurity.ComplianceResultsClientGetResponse{
	// 	ComplianceResult: armsecurity.ComplianceResult{
...
// Generated from example definition: 2017-08-01/ComplianceResults/ListComplianceResults_example.json
func ExampleComplianceResultsClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armsecurity.ComplianceResultsClientListResponse{
		// 	ComplianceResultList: armsecurity.ComplianceResultList{
