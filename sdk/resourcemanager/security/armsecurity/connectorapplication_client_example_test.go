...
// Generated from example definition: 2022-07-01-preview/Applications/PutSecurityConnectorApplication_example.json
func ExampleConnectorApplicationClient_CreateOrUpdate() {
	...
	// res = armsecurity.ConnectorApplicationClientCreateOrUpdateResponse{
...
// Generated from example definition: 2022-07-01-preview/Applications/DeleteSecurityConnectorApplication_example.json
func ExampleConnectorApplicationClient_Delete() {
	...
	res, err := clientFactory.NewConnectorApplicationClient().Delete(ctx, "gcpResourceGroup", "gcpconnector", "ad9a8e26-29d9-4829-bb30-e597a58cdbb8", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsecurity.ConnectorApplicationClientDeleteResponse{
	// }
}

// Generated from example definition: 2022-07-01-preview/Applications/GetSecurityConnectorApplication_example.json
func ExampleConnectorApplicationClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsecurity.ConnectorApplicationClientGetResponse{
	// 	Application: armsecurity.Application{
