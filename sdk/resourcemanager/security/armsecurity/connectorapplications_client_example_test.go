...
// Generated from example definition: 2022-07-01-preview/Applications/ListBySecurityConnectorApplications_example.json
func ExampleConnectorApplicationsClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armsecurity.ConnectorApplicationsClientListResponse{
		// 	ApplicationsList: armsecurity.ApplicationsList{
