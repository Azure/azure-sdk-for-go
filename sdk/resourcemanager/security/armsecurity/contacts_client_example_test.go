...
func ExampleContactsClient_NewListPager_updateSecurityContactDataFull() {
...
// Generated from example definition: https://github.com/Azure/azure-rest-api-specs/tree/main/specification/security/resource-manager/Microsoft.Security/preview/2017-08-01-preview/examples/SecurityContacts/GetSecurityContactsSubscription_min_example.json
func ExampleContactsClient_NewListPager_updateSecurityContactDataMinimal() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
...
// Generated from example definition: https://github.com/Azure/azure-rest-api-specs/tree/main/specification/security/resource-manager/Microsoft.Security/preview/2017-08-01-preview/examples/SecurityContacts/GetSecurityContact_min_example.json
func ExampleContactsClient_Get_getSecurityContactDataMinimal() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	res, err := client.Get(ctx, "default2", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// TODO: use response item
...
// Generated from example definition: https://github.com/Azure/azure-rest-api-specs/tree/main/specification/security/resource-manager/Microsoft.Security/preview/2017-08-01-preview/examples/SecurityContacts/CreateSecurityContact_min_example.json
func ExampleContactsClient_Create_createSecurityContactDataMinimal() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	res, err := client.Create(ctx, "default2", armsecurity.Contact{
...
func ExampleContactsClient_Delete() {
	...
	_, err = client.Delete(ctx, "default1", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
}
...
func ExampleContactsClient_Update_updateSecurityContactDataFull() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	res, err := client.Update(ctx, "john", armsecurity.Contact{
		Name: to.Ptr("default1"),
		Type: to.Ptr("Microsoft.Security/securityContacts"),
		ID:   to.Ptr("/subscriptions/20ff7fc3-e762-44dd-bd96-b71116dcdc23/providers/Microsoft.Security/securityContacts/default1"),
		Properties: &armsecurity.ContactProperties{
