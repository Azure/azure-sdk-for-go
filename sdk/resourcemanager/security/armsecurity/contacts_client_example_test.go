...
// Generated from example definition: 2023-12-01-preview/SecurityContacts/DeleteSecurityContact_example.json
func ExampleContactsClient_Delete() {
	...
	res, err := clientFactory.NewContactsClient().Delete(ctx, armsecurity.SecurityContactNameDefault, nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsecurity.ContactsClientDeleteResponse{
	// }
}

// Generated from example definition: 2023-12-01-preview/SecurityContacts/GetSecurityContact_example.json
func ExampleContactsClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsecurity.ContactsClientGetResponse{
	// 	Contact: armsecurity.Contact{
	// 		Name: to.Ptr("default"),
