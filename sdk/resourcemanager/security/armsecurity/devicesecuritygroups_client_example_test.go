...
// Generated from example definition: 2019-08-01/DeviceSecurityGroups/PutDeviceSecurityGroups_example.json
func ExampleDeviceSecurityGroupsClient_CreateOrUpdate() {
	...
	// res = armsecurity.DeviceSecurityGroupsClientCreateOrUpdateResponse{
	// 	DeviceSecurityGroup: armsecurity.DeviceSecurityGroup{
...
// Generated from example definition: 2019-08-01/DeviceSecurityGroups/DeleteDeviceSecurityGroups_example.json
func ExampleDeviceSecurityGroupsClient_Delete() {
	...
	res, err := clientFactory.NewDeviceSecurityGroupsClient().Delete(ctx, "subscriptions/20ff7fc3-e762-44dd-bd96-b71116dcdc23/resourceGroups/SampleRG/providers/Microsoft.Devices/iotHubs/sampleiothub", "samplesecuritygroup", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsecurity.DeviceSecurityGroupsClientDeleteResponse{
	// }
}

// Generated from example definition: 2019-08-01/DeviceSecurityGroups/GetDeviceSecurityGroups_example.json
func ExampleDeviceSecurityGroupsClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsecurity.DeviceSecurityGroupsClientGetResponse{
	// 	DeviceSecurityGroup: armsecurity.DeviceSecurityGroup{
	// 		Name: to.Ptr("samplesecuritygroup"),
	// 		Type: to.Ptr("Microsoft.Security/deviceSecurityGroups"),
	// 		ID: to.Ptr("/subscriptions/20ff7fc3-e762-44dd-bd96-b71116dcdc23/resourceGroups/SampleRG/providers/Microsoft.Devices/iotHubs/sampleiothub/providers/Microsoft.Security/deviceSecurityGroups/samplesecuritygroup"),
...
// Generated from example definition: 2019-08-01/DeviceSecurityGroups/ListDeviceSecurityGroups_example.json
func ExampleDeviceSecurityGroupsClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armsecurity.DeviceSecurityGroupsClientListResponse{
		// 	DeviceSecurityGroupList: armsecurity.DeviceSecurityGroupList{
