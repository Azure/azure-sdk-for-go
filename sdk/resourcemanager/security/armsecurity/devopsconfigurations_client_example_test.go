...
// Generated from example definition: 2025-11-01-preview/SecurityConnectorsDevOps/CreateOrUpdateDevOpsConfigurationsOnboardCurrentAndFuture_example.json
func ExampleDevOpsConfigurationsClient_BeginCreateOrUpdate_createOrUpdateDevOpsConfigurationsOnboardCurrentAndFuture() {
	...
	// res = armsecurity.DevOpsConfigurationsClientCreateOrUpdateResponse{
...
// Generated from example definition: 2025-11-01-preview/SecurityConnectorsDevOps/CreateOrUpdateDevOpsConfigurationsOnboardCurrentOnly_example.json
...
// Generated from example definition: 2025-11-01-preview/SecurityConnectorsDevOps/CreateOrUpdateDevOpsConfigurationsOnboardSelected_example.json
...
// Generated from example definition: 2025-11-01-preview/SecurityConnectorsDevOps/CreateOrUpdateDevOpsConfigurationsWithAgentlessConfigurations_example.json
...
// Generated from example definition: 2025-11-01-preview/SecurityConnectorsDevOps/DeleteDevOpsConfigurations_example.json
func ExampleDevOpsConfigurationsClient_BeginDelete() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsecurity.DevOpsConfigurationsClientDeleteResponse{
	// }
}

// Generated from example definition: 2025-11-01-preview/SecurityConnectorsDevOps/GetDevOpsConfigurationsWithAgentlessConfigurations_example.json
func ExampleDevOpsConfigurationsClient_Get_getDevOpsConfigurationsWithAgentlessConfigurations() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsecurity.DevOpsConfigurationsClientGetResponse{
	// 	DevOpsConfiguration: armsecurity.DevOpsConfiguration{
	// 		Name: to.Ptr("default"),
	// 		Type: to.Ptr("Microsoft.Security/securityConnectors/devops"),
	// 		ID: to.Ptr("/subscriptions/0806e1cd-cfda-4ff8-b99c-2b0af42cffd3/resourceGroups/myRg/providers/Microsoft.Security/securityConnectors/mySecurityConnectorName/devops/default"),
...
// Generated from example definition: 2025-11-01-preview/SecurityConnectorsDevOps/GetDevOpsConfigurationsWithCapabilities_example.json
...
// Generated from example definition: 2025-11-01-preview/SecurityConnectorsDevOps/GetDevOpsConfigurations_example.json
...
// Generated from example definition: 2025-11-01-preview/SecurityConnectorsDevOps/ListDevOpsConfigurations_example.json
func ExampleDevOpsConfigurationsClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armsecurity.DevOpsConfigurationsClientListResponse{
		// 	DevOpsConfigurationListResponse: armsecurity.DevOpsConfigurationListResponse{
