...
func (g *GitHubReposServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	resultChan := make(chan result, 1)
	go func() {
		var intercepted bool
		var res result
		if gitHubReposServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = gitHubReposServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to GitHubReposServerTransport
var gitHubReposServerTransportInterceptor interface {
