...
func (g *GitLabProjectsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	resultChan := make(chan result, 1)
	go func() {
		var intercepted bool
		var res result
		if gitLabProjectsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = gitLabProjectsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to GitLabProjectsServerTransport
var gitLabProjectsServerTransportInterceptor interface {
