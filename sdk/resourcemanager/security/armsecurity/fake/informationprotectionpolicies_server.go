...
func (i *InformationProtectionPoliciesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	resultChan := make(chan result, 1)
	go func() {
		var intercepted bool
		var res result
		if informationProtectionPoliciesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = informationProtectionPoliciesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to InformationProtectionPoliciesServerTransport
