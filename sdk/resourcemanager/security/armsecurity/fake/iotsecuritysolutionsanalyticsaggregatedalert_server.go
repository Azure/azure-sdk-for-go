...
func (i *IotSecuritySolutionsAnalyticsAggregatedAlertServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if iotSecuritySolutionsAnalyticsAggregatedAlertServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = iotSecuritySolutionsAnalyticsAggregatedAlertServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			case "IotSecuritySolutionsAnalyticsAggregatedAlertClient.Dismiss":
				res.resp, res.err = i.dispatchDismiss(req)
...
// set this to conditionally intercept incoming requests to IotSecuritySolutionsAnalyticsAggregatedAlertServerTransport
var iotSecuritySolutionsAnalyticsAggregatedAlertServerTransportInterceptor interface {
