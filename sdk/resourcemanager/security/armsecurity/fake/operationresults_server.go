...
// OperationResultsServer is a fake server for instances of the armsecurity.OperationResultsClient type.
type OperationResultsServer struct {
	// Get is the fake for method OperationResultsClient.Get
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	Get func(ctx context.Context, location string, operationID string, options *armsecurity.OperationResultsClientGetOptions) (resp azfake.Responder[armsecurity.OperationResultsClientGetResponse], errResp azfake.ErrorResponder)
}
...
// The returned OperationResultsServerTransport instance is connected to an instance of armsecurity.OperationResultsClient via the
...
// OperationResultsServerTransport connects instances of armsecurity.OperationResultsClient to instances of OperationResultsServer.
...
func (o *OperationResultsServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.Security/locations/(?P<location>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/operationResults/(?P<operationId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)`
