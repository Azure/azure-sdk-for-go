...
type OperatorsServer struct {
	...
	// NewListPager is the fake for method OperatorsClient.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager func(pricingName string, options *armsecurity.OperatorsClientListOptions) (resp azfake.PagerResponder[armsecurity.OperatorsClientListResponse])
}
...
func NewOperatorsServerTransport(srv *OperatorsServer) *OperatorsServerTransport {
	return &OperatorsServerTransport{
		srv:          srv,
		newListPager: newTracker[azfake.PagerResponder[armsecurity.OperatorsClientListResponse]](),
	}
}
...
type OperatorsServerTransport struct {
	srv          *OperatorsServer
	newListPager *tracker[azfake.PagerResponder[armsecurity.OperatorsClientListResponse]]
}
...
func (o *OperatorsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		if !intercepted {
			...
			case "OperatorsClient.NewListPager":
...
func (o *OperatorsServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		resp := o.srv.NewListPager(pricingNameParam, nil)
		newListPager = &resp
