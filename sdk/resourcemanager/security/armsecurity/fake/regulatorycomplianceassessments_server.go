...
func (r *RegulatoryComplianceAssessmentsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	resultChan := make(chan result, 1)
	go func() {
		var intercepted bool
		var res result
		if regulatoryComplianceAssessmentsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = regulatoryComplianceAssessmentsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to RegulatoryComplianceAssessmentsServerTransport
var regulatoryComplianceAssessmentsServerTransportInterceptor interface {
