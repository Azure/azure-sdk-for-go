...
// Generated from example definition: 2022-01-01-preview/GovernanceAssignments/PutGovernanceAssignment_example.json
func ExampleGovernanceAssignmentsClient_CreateOrUpdate() {
	...
	// res = armsecurity.GovernanceAssignmentsClientCreateOrUpdateResponse{
	// 	GovernanceAssignment: armsecurity.GovernanceAssignment{
...
// Generated from example definition: 2022-01-01-preview/GovernanceAssignments/GetGovernanceAssignment_example.json
func ExampleGovernanceAssignmentsClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsecurity.GovernanceAssignmentsClientGetResponse{
	// 	GovernanceAssignment: armsecurity.GovernanceAssignment{
	// 		Name: to.Ptr("6634ff9f-127b-4bf2-8e6e-b1737f5e789c"),
	// 		Type: to.Ptr("Microsoft.Security/assessments/governanceAssignments"),
	// 		ID: to.Ptr("/subscriptions/c32e05d9-7207-4e22-bdf4-4f7d9c72e5fd/resourceGroups/compute_servers/providers/Microsoft.Compute/virtualMachines/win2012/providers/Microsoft.Security/assessments/6b9421dd-5555-2251-9b3d-2be58e2f82cd/governanceAssignments/6634ff9f-127b-4bf2-8e6e-b1737f5e789c"),
...
// Generated from example definition: 2022-01-01-preview/GovernanceAssignments/ListGovernanceAssignments_example.json
func ExampleGovernanceAssignmentsClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armsecurity.GovernanceAssignmentsClientListResponse{
		// 	GovernanceAssignmentsList: armsecurity.GovernanceAssignmentsList{
