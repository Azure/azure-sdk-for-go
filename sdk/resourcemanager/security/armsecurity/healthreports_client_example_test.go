...
// Generated from example definition: 2023-05-01-preview/HealthReports/GetHealthReports_example.json
func ExampleHealthReportsClient_Get() {
	...
	// res = armsecurity.HealthReportsClientGetResponse{
	// 	HealthReport: armsecurity.HealthReport{
	...
	// 			},
	// 			Status: &armsecurity.HealthReportStatus{
	...
	// 				LastScannedDate: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2023-04-25T09:02:20.1349133Z"); return t}()),
...
// Generated from example definition: 2023-05-01-preview/HealthReports/ListHealthReports_example.json
func ExampleHealthReportsClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armsecurity.HealthReportsClientListResponse{
		// 	HealthReportsList: armsecurity.HealthReportsList{
