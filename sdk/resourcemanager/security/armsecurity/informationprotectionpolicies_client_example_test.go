...
// Generated from example definition: 2017-08-01-preview/InformationProtectionPolicies/CreateOrUpdateInformationProtectionPolicy_example.json
func ExampleInformationProtectionPoliciesClient_CreateOrUpdate() {
	...
	// res = armsecurity.InformationProtectionPoliciesClientCreateOrUpdateResponse{
	// 	InformationProtectionPolicy: armsecurity.InformationProtectionPolicy{
	// 		Name: to.Ptr("custom"),
...
// Generated from example definition: 2017-08-01-preview/InformationProtectionPolicies/GetCustomInformationProtectionPolicy_example.json
func ExampleInformationProtectionPoliciesClient_Get_getTheCustomizedInformationProtectionPolicyForAManagementGroup() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsecurity.InformationProtectionPoliciesClientGetResponse{
	// 	InformationProtectionPolicy: armsecurity.InformationProtectionPolicy{
	// 		Name: to.Ptr("custom"),
	// 		Type: to.Ptr("Microsoft.Security/informationProtectionPolicies"),
	// 		ID: to.Ptr("/providers/Microsoft.Management/managementGroups/148059f7-faf3-49a6-ba35-85122112291e/providers/Microsoft.Security/informationProtectionPolicies/custom"),
...
// Generated from example definition: 2017-08-01-preview/InformationProtectionPolicies/GetEffectiveInformationProtectionPolicy_example.json
...
// Generated from example definition: 2017-08-01-preview/InformationProtectionPolicies/ListInformationProtectionPolicies_example.json
func ExampleInformationProtectionPoliciesClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armsecurity.InformationProtectionPoliciesClientListResponse{
		// 	InformationProtectionPolicyList: armsecurity.InformationProtectionPolicyList{
