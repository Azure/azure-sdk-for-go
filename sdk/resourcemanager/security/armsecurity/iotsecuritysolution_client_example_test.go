...
// Generated from example definition: 2019-08-01/IoTSecuritySolutions/CreateIoTSecuritySolution.json
func ExampleIotSecuritySolutionClient_CreateOrUpdate() {
	...
	// res = armsecurity.IotSecuritySolutionClientCreateOrUpdateResponse{
	// 	IoTSecuritySolutionModel: armsecurity.IoTSecuritySolutionModel{
	// 		Name: to.Ptr("default"),
...
// Generated from example definition: 2019-08-01/IoTSecuritySolutions/DeleteIoTSecuritySolution.json
func ExampleIotSecuritySolutionClient_Delete() {
	...
	res, err := clientFactory.NewIotSecuritySolutionClient().Delete(ctx, "MyGroup", "default", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsecurity.IotSecuritySolutionClientDeleteResponse{
	// }
}

// Generated from example definition: 2019-08-01/IoTSecuritySolutions/GetIoTSecuritySolution.json
func ExampleIotSecuritySolutionClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsecurity.IotSecuritySolutionClientGetResponse{
	// 	IoTSecuritySolutionModel: armsecurity.IoTSecuritySolutionModel{
	// 		Name: to.Ptr("default"),
	// 		Type: to.Ptr("Microsoft.Security/IoTSecuritySolutions"),
...
// Generated from example definition: 2019-08-01/IoTSecuritySolutions/GetIoTSecuritySolutionsListByIotHubAndRg.json
func ExampleIotSecuritySolutionClient_NewListByResourceGroupPager_listIoTSecuritySolutionsByResourceGroupAndIoTHub() {
	...
	pager := clientFactory.NewIotSecuritySolutionClient().NewListByResourceGroupPager("MyRg", &armsecurity.IotSecuritySolutionClientListByResourceGroupOptions{
		Filter: to.Ptr("properties.iotHubs/any(i eq \"/subscriptions/075423e9-7d33-4166-8bdf-3920b04e3735/resourceGroups/myRg/providers/Microsoft.Devices/IotHubs/FirstIotHub\")")})
	for pager.More() {
		...
		// page = armsecurity.IotSecuritySolutionClientListByResourceGroupResponse{
		// 	IoTSecuritySolutionsList: armsecurity.IoTSecuritySolutionsList{
...
// Generated from example definition: 2019-08-01/IoTSecuritySolutions/GetIoTSecuritySolutionsListByRg.json
func ExampleIotSecuritySolutionClient_NewListByResourceGroupPager_listIoTSecuritySolutionsByResourceGroup() {
	...
	pager := clientFactory.NewIotSecuritySolutionClient().NewListByResourceGroupPager("MyGroup", nil)
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
...
// Generated from example definition: 2019-08-01/IoTSecuritySolutions/GetIoTSecuritySolutionsList.json
func ExampleIotSecuritySolutionClient_NewListBySubscriptionPager_listIoTSecuritySolutionsBySubscription() {
	...
	pager := clientFactory.NewIotSecuritySolutionClient().NewListBySubscriptionPager(nil)
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armsecurity.IotSecuritySolutionClientListBySubscriptionResponse{
		// 	IoTSecuritySolutionsList: armsecurity.IoTSecuritySolutionsList{
		// 		Value: []*armsecurity.IoTSecuritySolutionModel{
		// 			{
		// 				Name: to.Ptr("default"),
...
// Generated from example definition: 2019-08-01/IoTSecuritySolutions/GetIoTSecuritySolutionsListByIotHub.json
func ExampleIotSecuritySolutionClient_NewListBySubscriptionPager_listIoTSecuritySolutionsByIoTHub() {
	...
	pager := clientFactory.NewIotSecuritySolutionClient().NewListBySubscriptionPager(&armsecurity.IotSecuritySolutionClientListBySubscriptionOptions{
		Filter: to.Ptr("properties.iotHubs/any(i eq \"/subscriptions/075423e9-7d33-4166-8bdf-3920b04e3735/resourceGroups/myRg/providers/Microsoft.Devices/IotHubs/FirstIotHub\")")})
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
...
// Generated from example definition: 2019-08-01/IoTSecuritySolutions/UpdateIoTSecuritySolution.json
func ExampleIotSecuritySolutionClient_Update() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsecurity.IotSecuritySolutionClientUpdateResponse{
	// 	IoTSecuritySolutionModel: armsecurity.IoTSecuritySolutionModel{
	// 		Name: to.Ptr("default"),
	// 		Type: to.Ptr("Microsoft.Security/IoTSecuritySolutions"),
	// 		ID: to.Ptr("/subscriptions/20ff7fc3-e762-44dd-bd96-b71116dcdc23/resourceGroups/MyGroup/providers/Microsoft.Security/Locations/eastus/IoTSecuritySolutions/default"),
