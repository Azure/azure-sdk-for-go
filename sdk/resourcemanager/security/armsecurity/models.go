...
// AccessTokenAuthentication - The environment authentication details
type AccessTokenAuthentication struct {
	// CONSTANT; The authentication type
	// Field has constant value AuthenticationTypeAccessToken, any specified value is ignored.
...
// GetAuthentication implements the AuthenticationClassification interface for type AccessTokenAuthentication.
func (a *AccessTokenAuthentication) GetAuthentication() *Authentication {
...
type ActiveConnectionsNotInAllowedRange struct {
	...
	// CONSTANT; The type of the custom alert rule.
	// Field has constant value "ActiveConnectionsNotInAllowedRange", any specified value is ignored.
	RuleType *string
...
// AgentlessConfiguration - Details about Agentless configuration.
...
type AlertProperties struct {
	...
	// Defender for Endpoint, Microsoft Defender for Office, Microsoft Defender for Cloud Apps, and so on).
	ProductName *string
...
type AlertSimulatorBundlesRequestProperties struct {
	// CONSTANT; The kind of alert simulation.
	// Field has constant value KindBundles, any specified value is ignored.
	Kind                 *Kind
	AdditionalProperties map[string]any
...
type AlertSyncSettings struct {
	// CONSTANT; the kind of the settings string
	// Field has constant value SettingKindAlertSyncSettings, any specified value is ignored.
	Kind *SettingKind
...
type AlertsSuppressionRulesList struct {
	// REQUIRED; The AlertsSuppressionRule items on this page
...
type AllowlistCustomAlertRule struct {
	...
	// CONSTANT; Field has constant value "AllowlistCustomAlertRule", any specified value is ignored.
	RuleType *string
...
type AmqpC2DMessagesNotInAllowedRange struct {
	...
	// CONSTANT; The type of the custom alert rule.
	// Field has constant value "AmqpC2DMessagesNotInAllowedRange", any specified value is ignored.
	RuleType *string
...
type AmqpC2DRejectedMessagesNotInAllowedRange struct {
	...
	// CONSTANT; The type of the custom alert rule.
	// Field has constant value "AmqpC2DRejectedMessagesNotInAllowedRange", any specified value is ignored.
	RuleType *string
...
type AmqpD2CMessagesNotInAllowedRange struct {
	...
	// CONSTANT; The type of the custom alert rule.
	// Field has constant value "AmqpD2CMessagesNotInAllowedRange", any specified value is ignored.
	RuleType *string
...
type ArmSecurityStandard struct {
	// Properties of a security standard
	Properties *ArmSecurityStandardProperties
...
type AssessmentProperties struct {
	...
	Risk *AssessmentPropertiesBaseRisk
...
// AssessmentPropertiesBaseRisk - External model of risk result
type AssessmentPropertiesBaseRisk struct {
	...
	// The risk level
	Level *RiskLevel
	Paths []*AssessmentPropertiesBaseRiskPathsItem

	// The factors of the risk adding base factor
	RiskFactors []*string
}

type AssessmentPropertiesBaseRiskPathsItem struct {
	// Connections between nodes
	Edges []*AssessmentPropertiesBaseRiskPathsItemEdgeItem

	// Unique identifier for the path
	ID    *string
	Nodes []*AssessmentPropertiesBaseRiskPathsItemNodesItem
}

type AssessmentPropertiesBaseRiskPathsItemEdgeItem struct {
	// REQUIRED; Edge identifier
	ID *string

	// REQUIRED; Source node identifier
	SourceID *string

	// REQUIRED; Target node identifier
	TargetID *string
}

type AssessmentPropertiesBaseRiskPathsItemNodesItem struct {
	// Node identifier
	ID *string
...
// Authentication - The environment authentication details
...
type AutomationActionEventHub struct {
	// CONSTANT; The type of the action that will be triggered by the Automation
	// Field has constant value ActionTypeEventHub, any specified value is ignored.
	ActionType *ActionType
...
type AutomationActionLogicApp struct {
	// CONSTANT; The type of the action that will be triggered by the Automation
	// Field has constant value ActionTypeLogicApp, any specified value is ignored.
	ActionType *ActionType
...
// reside in the 'SecurityAlert' table and the assessments data will reside in the 'SecurityRecommendation' table (under the
// 'Security'/'SecurityCenterFree' solutions). Note that in order to view the data in the workspace, the Security Center Log
// Analytics free/standard solution needs to be enabled on that workspace. To learn more about Microsoft Defender for Cloud
// continuous export capabilities, visit https://aka.ms/ASCExportLearnMore
type AutomationActionWorkspace struct {
	// CONSTANT; The type of the action that will be triggered by the Automation
	// Field has constant value ActionTypeWorkspace, any specified value is ignored.
	ActionType *ActionType
...
type AutomationList struct {
	// REQUIRED; The Automation items on this page
	Value []*Automation
...
type AutomationProperties struct {
	...
	// or a resource group under that subscription. The automation will only apply on defined scopes.
...
// and security assessments. To learn more about the supported security events data models schemas - please visit https://aka.ms/ASCAutomationSchemas.
...
// value from the event model to an expected value. This comparison is done by using one of the supported operators set.
...
type AwsEnvironmentData struct {
	// CONSTANT; The type of the environment data.
	// Field has constant value EnvironmentTypeAwsAccount, any specified value is ignored.
...
type AwsOrganizationalDataMaster struct {
	// CONSTANT; The multi cloud account's membership type in the organization
	// Field has constant value OrganizationMembershipTypeOrganization, any specified value is ignored.
	OrganizationMembershipType *OrganizationMembershipType
...
type AwsOrganizationalDataMember struct {
	// CONSTANT; The multi cloud account's membership type in the organization
	// Field has constant value OrganizationMembershipTypeMember, any specified value is ignored.
	OrganizationMembershipType *OrganizationMembershipType
...
type AzureDevOpsScopeEnvironmentData struct {
	// CONSTANT; The type of the environment data.
	// Field has constant value EnvironmentTypeAzureDevOpsScope, any specified value is ignored.
	EnvironmentType *EnvironmentType
}
...
type AzureResourceDetails struct {
	// CONSTANT; The platform where the assessed resource resides
	// Field has constant value SourceAzure, any specified value is ignored.
	Source *Source
...
type AzureServersSetting struct {
	// CONSTANT; The kind of the server vulnerability assessments setting.
	// Field has constant value ServerVulnerabilityAssessmentsSettingKindAzureServersSetting, any specified value is ignored.
...
type ComplianceList struct {
	...
	// READ-ONLY; List of Compliance objects
	Value []*Compliance
}

// ComplianceProperties - The Compliance score (percentage) of a Subscription is a sum of all Resources' Compliances under
// the given Subscription. A Resource Compliance is defined as the compliant ('healthy') Policy Definitions out of all Policy
...
type ComplianceResultList struct {
	// REQUIRED; The ComplianceResult items on this page
...
type ConnectionFromIPNotAllowed struct {
	...
	// CONSTANT; Field has constant value "ConnectionFromIpNotAllowed", any specified value is ignored.
	RuleType *string
...
type ConnectionToIPNotAllowed struct {
	...
	// CONSTANT; Field has constant value "ConnectionToIpNotAllowed", any specified value is ignored.
	RuleType *string
...
type ConnectorsList struct {
	// REQUIRED; The SecurityConnector items on this page
	Value []*Connector
...
type ContactList struct {
	// REQUIRED; The SecurityContact items on this page
	Value []*Contact
...
type CspmMonitorAwsOffering struct {
	// CONSTANT; The type of the security offering.
	// Field has constant value OfferingTypeCspmMonitorAws, any specified value is ignored.
	OfferingType *OfferingType
...
type CspmMonitorAzureDevOpsOffering struct {
	// CONSTANT; The type of the security offering.
	// Field has constant value OfferingTypeCspmMonitorAzureDevOps, any specified value is ignored.
	OfferingType *OfferingType
...
// CspmMonitorDockerHubOffering - The CSPM (Cloud security posture management) monitoring for Docker Hub offering
type CspmMonitorDockerHubOffering struct {
	// CONSTANT; The type of the security offering.
	// Field has constant value OfferingTypeCspmMonitorDockerHub, any specified value is ignored.
	OfferingType *OfferingType
...
// GetCloudOffering implements the CloudOfferingClassification interface for type CspmMonitorDockerHubOffering.
func (c *CspmMonitorDockerHubOffering) GetCloudOffering() *CloudOffering {
	return &CloudOffering{
		Description:  c.Description,
		OfferingType: c.OfferingType,
	}
...
type CspmMonitorGcpOffering struct {
	// CONSTANT; The type of the security offering.
	// Field has constant value OfferingTypeCspmMonitorGcp, any specified value is ignored.
	OfferingType *OfferingType
...
type CspmMonitorGitLabOffering struct {
	// CONSTANT; The type of the security offering.
	// Field has constant value OfferingTypeCspmMonitorGitLab, any specified value is ignored.
	OfferingType *OfferingType
...
type CspmMonitorGithubOffering struct {
	// CONSTANT; The type of the security offering.
	// Field has constant value OfferingTypeCspmMonitorGithub, any specified value is ignored.
	OfferingType *OfferingType
...
// CspmMonitorJFrogOffering - The CSPM (Cloud security posture management) monitoring for JFrog Artifactory offering
type CspmMonitorJFrogOffering struct {
	// CONSTANT; The type of the security offering.
	// Field has constant value OfferingTypeCspmMonitorJFrog, any specified value is ignored.
	OfferingType *OfferingType
...
// GetCloudOffering implements the CloudOfferingClassification interface for type CspmMonitorJFrogOffering.
func (c *CspmMonitorJFrogOffering) GetCloudOffering() *CloudOffering {
	return &CloudOffering{
		Description:  c.Description,
		OfferingType: c.OfferingType,
	}
...
type DataExportSettings struct {
	// CONSTANT; the kind of the settings string
	// Field has constant value SettingKindDataExportSettings, any specified value is ignored.
	Kind *SettingKind
...
type DefenderCspmAwsOffering struct {
	// CONSTANT; The type of the security offering.
	// Field has constant value OfferingTypeDefenderCspmAws, any specified value is ignored.
	OfferingType *OfferingType
...
type DefenderCspmDockerHubOffering struct {
	// CONSTANT; The type of the security offering.
	// Field has constant value OfferingTypeDefenderCspmDockerHub, any specified value is ignored.
	OfferingType *OfferingType
...
// GetCloudOffering implements the CloudOfferingClassification interface for type DefenderCspmDockerHubOffering.
func (d *DefenderCspmDockerHubOffering) GetCloudOffering() *CloudOffering {
	return &CloudOffering{
		Description:  d.Description,
		OfferingType: d.OfferingType,
	}
...
type DefenderCspmGcpOffering struct {
	// CONSTANT; The type of the security offering.
	// Field has constant value OfferingTypeDefenderCspmGcp, any specified value is ignored.
	OfferingType *OfferingType
...
// DefenderCspmJFrogOffering - The CSPM P1 for JFrog Artifactory offering
type DefenderCspmJFrogOffering struct {
	// CONSTANT; The type of the security offering.
	// Field has constant value OfferingTypeDefenderCspmJFrog, any specified value is ignored.
	OfferingType *OfferingType
...
// GetCloudOffering implements the CloudOfferingClassification interface for type DefenderCspmJFrogOffering.
func (d *DefenderCspmJFrogOffering) GetCloudOffering() *CloudOffering {
	return &CloudOffering{
		Description:  d.Description,
		OfferingType: d.OfferingType,
	}
...
// DefenderCspmJFrogOfferingMdcContainersImageAssessment - The Microsoft Defender Container image assessment configuration
...
type DefenderFoDatabasesAwsOffering struct {
	// CONSTANT; The type of the security offering.
	// Field has constant value OfferingTypeDefenderForDatabasesAws, any specified value is ignored.
	OfferingType *OfferingType
...
type DefenderForContainersAwsOffering struct {
	// CONSTANT; The type of the security offering.
	// Field has constant value OfferingTypeDefenderForContainersAws, any specified value is ignored.
	OfferingType *OfferingType
...
type DefenderForContainersDockerHubOffering struct {
	// CONSTANT; The type of the security offering.
	// Field has constant value OfferingTypeDefenderForContainersDockerHub, any specified value is ignored.
	OfferingType *OfferingType
...
// GetCloudOffering implements the CloudOfferingClassification interface for type DefenderForContainersDockerHubOffering.
func (d *DefenderForContainersDockerHubOffering) GetCloudOffering() *CloudOffering {
	return &CloudOffering{
		Description:  d.Description,
		OfferingType: d.OfferingType,
	}
...
type DefenderForContainersGcpOffering struct {
	// CONSTANT; The type of the security offering.
	// Field has constant value OfferingTypeDefenderForContainersGcp, any specified value is ignored.
	OfferingType *OfferingType
...
// DefenderForContainersJFrogOffering - The Defender for Containers for JFrog Artifactory offering
type DefenderForContainersJFrogOffering struct {
	// CONSTANT; The type of the security offering.
	// Field has constant value OfferingTypeDefenderForContainersJFrog, any specified value is ignored.
	OfferingType *OfferingType
...
// GetCloudOffering implements the CloudOfferingClassification interface for type DefenderForContainersJFrogOffering.
func (d *DefenderForContainersJFrogOffering) GetCloudOffering() *CloudOffering {
	return &CloudOffering{
		Description:  d.Description,
		OfferingType: d.OfferingType,
	}
...
type DefenderForDatabasesGcpOffering struct {
	// CONSTANT; The type of the security offering.
	// Field has constant value OfferingTypeDefenderForDatabasesGcp, any specified value is ignored.
	OfferingType *OfferingType
...
type DefenderForServersAwsOffering struct {
	// CONSTANT; The type of the security offering.
	// Field has constant value OfferingTypeDefenderForServersAws, any specified value is ignored.
	OfferingType *OfferingType
...
type DefenderForServersGcpOffering struct {
	// CONSTANT; The type of the security offering.
	// Field has constant value OfferingTypeDefenderForServersGcp, any specified value is ignored.
	OfferingType *OfferingType
...
// DefenderForStorageSettingList - List of Defender for Storage settings.
type DefenderForStorageSettingList struct {
	// The URI to fetch the next page.
	NextLink *string

	// READ-ONLY; List of Defender for Storage settings.
	Value []*DefenderForStorageSetting
}
...
type DenylistCustomAlertRule struct {
	...
	// CONSTANT; Field has constant value "DenylistCustomAlertRule", any specified value is ignored.
	RuleType *string
...
type DirectMethodInvokesNotInAllowedRange struct {
	...
	// CONSTANT; The type of the custom alert rule.
	// Field has constant value "DirectMethodInvokesNotInAllowedRange", any specified value is ignored.
	RuleType *string
...
// DiscoveredSecuritySolution - Concrete proxy resource types can be created by aliasing this type using a specific property
// type.
...
// DockerHubEnvironmentData - The Docker Hub connector environment data
type DockerHubEnvironmentData struct {
	// CONSTANT; The type of the environment data.
	// Field has constant value EnvironmentTypeDockerHubOrganization, any specified value is ignored.
	EnvironmentType *EnvironmentType
...
// GetEnvironmentData implements the EnvironmentDataClassification interface for type DockerHubEnvironmentData.
func (d *DockerHubEnvironmentData) GetEnvironmentData() *EnvironmentData {
	return &EnvironmentData{
...
type Extension struct {
	...
	// REQUIRED; The extension name. Supported values are: <br><br>**AgentlessDiscoveryForKubernetes** - Provides zero footprint,
	// API-based discovery of Kubernetes clusters, their configurations and deployments. The collected data is used to create
	// a contextualized security graph for Kubernetes clusters, provide risk hunting capabilities, and visualize risks and threats
	// to Kubernetes environments and workloads.<br>Available for CloudPosture plan and Containers plan.<br><br>**OnUploadMalwareScanning**
	// - Limits the GB to be scanned per month for each storage account within the subscription. Once this limit reached on a
	// given storage account, Blobs won't be scanned during current calendar month.<br>Available for StorageAccounts plan (DefenderForStorageV2
	// sub plans).<br><br>**SensitiveDataDiscovery** - Sensitive data discovery identifies Blob storage container with sensitive
	// data such as credentials, credit cards, and more, to help prioritize and investigate security events.<br>Available for
	// StorageAccounts plan (DefenderForStorageV2 sub plan) and CloudPosture plan.<br><br>**ContainerRegistriesVulnerabilityAssessments**
	// - Provides vulnerability management for images stored in your container registries.<br>Available for CloudPosture plan
	// and Containers plan.<br><br>**MdeDesignatedSubscription** - Direct onboarding is a seamless integration between Defender
	// for Endpoint and Defender for Cloud that doesn't require extra software deployment on your servers. The onboarded resources
	// will be presented under a designated Azure Subscription you configure<br>Available for VirtualMachines plan (P1 and P2
	// sub plans).<br><br>**AgentlessVmScanning** - Scans your machines for installed software, vulnerabilities, malware and secret
	// scanning without relying on agents or impacting machine performance. Learn more here https://learn.microsoft.com/en-us/azure/defender-for-cloud/concept-agentless-data-collection.<br>Available
	// for CloudPosture plan, VirtualMachines plan (P2 sub plan) and Containers plan.<br><br>**EntraPermissionsManagement** -
	// Permissions Management provides Cloud Infrastructure Entitlement Management (CIEM) capabilities that helps organizations
	// to manage and control user access and entitlements in their cloud infrastructure - important attack vector for cloud environments.<br>Permissions
	// Management analyzes all permissions and active usage, and suggests recommendations to reduce permissions to enforce the
	// principle of least privilege. Learn more here https://learn.microsoft.com/en-us/azure/defender-for-cloud/permissions-management.<br>Available
	// for CloudPosture plan. <br><br>**FileIntegrityMonitoring** - File integrity monitoring (FIM), examines operating system
	// files.<br>Windows registries, Linux system files, in real time, for changes that might indicate an attack.<br>Available
	// for VirtualMachines plan (P2 sub plan). <br><br>**ContainerSensor** - The sensor is based on IG and provides a rich threat
	// detection suite for Kubernetes clusters, nodes, and workloads, powered by Microsoft leading threat intelligence, provides
	// mapping to MITRE ATT&CK framework.<br>Available for Containers plan. <br><br>**AIPromptEvidence** - Exposes the prompts
	// passed between the user and the AI model as alert evidence. This helps classify and triage the alerts with relevant user
	// context. The prompt snippets will include only segments of the user prompt or model response that were deemed suspicious
	// and relevant for security classifications. The prompt evidence will be available through Defender portal as part of each
...
type FailedLocalLoginsNotInAllowedRange struct {
	...
	// CONSTANT; The type of the custom alert rule.
	// Field has constant value "FailedLocalLoginsNotInAllowedRange", any specified value is ignored.
	RuleType *string
...
type FileUploadsNotInAllowedRange struct {
	...
	// CONSTANT; The type of the custom alert rule.
	// Field has constant value "FileUploadsNotInAllowedRange", any specified value is ignored.
	RuleType *string
...
// FilesScanSummary - A summary of the scan results of the files that were scanned.
type FilesScanSummary struct {
	// The number of failed file scans.
	FailedFilesCount *int64

	// The number of malicious files that were detected during the scan.
	MaliciousFilesCount *int64

	// The number of gigabytes of data that were scanned.
	ScannedFilesInGB *float64

	// The number of files that were skipped.
	SkippedFilesCount *int64
...
type GcpProjectEnvironmentData struct {
	// CONSTANT; The type of the environment data.
	// Field has constant value EnvironmentTypeGcpProject, any specified value is ignored.
	EnvironmentType *EnvironmentType
...
type GitHubRepositoryProperties struct {
	...
	// READ-ONLY; Gets or sets GitHub Full Name.
	...
	// READ-ONLY; Gets or sets GitHub Repository name.
	// Eg: "new-repo-1".
	RepoName *string
...
type GithubScopeEnvironmentData struct {
	// CONSTANT; The type of the environment data.
	// Field has constant value EnvironmentTypeGithubScope, any specified value is ignored.
	EnvironmentType *EnvironmentType
}
...
type GitlabScopeEnvironmentData struct {
	// CONSTANT; The type of the environment data.
	// Field has constant value EnvironmentTypeGitlabScope, any specified value is ignored.
	EnvironmentType *EnvironmentType
}
...
type HTTPC2DMessagesNotInAllowedRange struct {
	...
	// CONSTANT; The type of the custom alert rule.
	// Field has constant value "HttpC2DMessagesNotInAllowedRange", any specified value is ignored.
	RuleType *string
...
type HTTPC2DRejectedMessagesNotInAllowedRange struct {
	...
	// CONSTANT; The type of the custom alert rule.
	// Field has constant value "HttpC2DRejectedMessagesNotInAllowedRange", any specified value is ignored.
	RuleType *string
...
type HTTPD2CMessagesNotInAllowedRange struct {
	...
	// CONSTANT; The type of the custom alert rule.
	// Field has constant value "HttpD2CMessagesNotInAllowedRange", any specified value is ignored.
	RuleType *string
...
type HealthReportsList struct {
	...
	// READ-ONLY; The HealthReport items on this page.
	Value []*HealthReport
}
...
// InventoryList - Model for inventory to be included or excluded from Agentless.
...
type IoTSecurityAggregatedAlertList struct {
	// REQUIRED; The IoTSecurityAggregatedAlert items on this page
...
type IoTSecurityAggregatedRecommendationList struct {
	// REQUIRED; The IoTSecurityAggregatedRecommendation items on this page
...
type IoTSecuritySolutionAnalyticsModelList struct {
	// REQUIRED; The IoTSecuritySolutionAnalyticsModel items on this page
...
type IoTSecuritySolutionsList struct {
	// REQUIRED; The IoTSecuritySolutionModel items on this page
...
// IssueCreationRequest - The issue creation request model
...
// JFrogEnvironmentData - The JFrog Artifactory connector environment data
type JFrogEnvironmentData struct {
	// CONSTANT; The type of the environment data.
	// Field has constant value EnvironmentTypeJFrogArtifactory, any specified value is ignored.
	EnvironmentType *EnvironmentType
...
// GetEnvironmentData implements the EnvironmentDataClassification interface for type JFrogEnvironmentData.
func (j *JFrogEnvironmentData) GetEnvironmentData() *EnvironmentData {
	return &EnvironmentData{
		EnvironmentType: j.EnvironmentType,
	}
}
...
// JitNetworkAccessPolicy - Concrete proxy resource types can be created by aliasing this type using a specific property type.
...
type ListCustomAlertRule struct {
	...
	// CONSTANT; Field has constant value "ListCustomAlertRule", any specified value is ignored.
	RuleType *string
...
type LocalUserNotAllowed struct {
	...
	// CONSTANT; Field has constant value "LocalUserNotAllowed", any specified value is ignored.
	RuleType *string
...
type MqttC2DMessagesNotInAllowedRange struct {
	...
	// CONSTANT; The type of the custom alert rule.
	// Field has constant value "MqttC2DMessagesNotInAllowedRange", any specified value is ignored.
	RuleType *string
...
type MqttC2DRejectedMessagesNotInAllowedRange struct {
	...
	// CONSTANT; The type of the custom alert rule.
	// Field has constant value "MqttC2DRejectedMessagesNotInAllowedRange", any specified value is ignored.
	RuleType *string
...
type MqttD2CMessagesNotInAllowedRange struct {
	...
	// CONSTANT; The type of the custom alert rule.
	// Field has constant value "MqttD2CMessagesNotInAllowedRange", any specified value is ignored.
	RuleType *string
...
type NotificationsSourceAlert struct {
	// CONSTANT; The source type that will trigger the notification
	// Field has constant value SourceTypeAlert, any specified value is ignored.
	SourceType *SourceType
...
type NotificationsSourceAttackPath struct {
	// CONSTANT; The source type that will trigger the notification
	// Field has constant value SourceTypeAttackPath, any specified value is ignored.
	SourceType *SourceType
...
type OnPremiseResourceDetails struct {
	...
	// CONSTANT; Field has constant value SourceOnPremiseResourceDetails, any specified value is ignored.
	Source *Source
...
type OnPremiseSQLResourceDetails struct {
	...
	// CONSTANT; The platform where the assessed resource resides
	// Field has constant value SourceOnPremiseSQL, any specified value is ignored.
	Source *Source
...
// OnUploadFilters - Optional. Determine which blobs get scanned by On Upload malware scanning. An Or operation is performed
// between each filter type.
type OnUploadFilters struct {
	// Optional. Specifies the maximum size in bytes for blobs to be scanned. This parameter accepts a single positive integer
	// value. Blobs larger than this value will be excluded from scanning.
	...
	// Exclude a single container: Add a trailing slash `/` after the container name to avoid excluding other containers with
	// similar prefixes.
	ExcludeBlobsWithPrefix []*string

	// Optional. A list of suffixes to exclude from on-upload malware scanning. Suffixes match only the end of blob names, and
...
type OnUploadProperties struct {
	...
	// Optional. Determine which blobs get scanned by On Upload malware scanning. An Or operation is performed between each filter
	// type.
...
// OperationResult - Long run operation status of governance rule over a given scope
...
type PricingProperties struct {
	...
	// setting inherited="False"). If set to "True", it prevents overrides and forces this pricing configuration on all the descendants
	// of this scope. This field is only available for subscription-level pricing.
	Enforce *Enforce
	...
	// a set of security features. When not specified, full plan is applied. For VirtualMachines plan, available sub plans are
	// 'P1' & 'P2', where for resource level only 'P1' sub plan is supported.
	SubPlan *string

	// READ-ONLY; Optional. True if the plan is deprecated. If there are replacing plans they will appear in `replacedBy` property
	Deprecated *bool

	// READ-ONLY; Optional. If `pricingTier` is `Standard` then this property holds the date of the last time the `pricingTier`
	...
	// the subscription. Please note: The "pricingTier" field reflects the plan status of the subscription. However, since the
	// plan status can also be defined at the resource level, there might be misalignment between the subscription's plan status
	// and the resource status. This field helps indicate the coverage status of the resources.
...
// PrivateLinkGroupResource - A private link group resource that describes a grouping for the private link.
type PrivateLinkGroupResource struct {
	// Resource properties.
...
// PrivateLinkGroupResourceListResult - The response of a PrivateLinkGroupResource list operation.
type PrivateLinkGroupResourceListResult struct {
	// REQUIRED; The PrivateLinkGroupResource items on this page
...
// PrivateLinkProperties - Properties of a private link resource. These properties control the behavior and configuration
...
type PrivateLinkProperties struct {
	...
	// READ-ONLY; List of private endpoint connections associated with this private link. Each connection represents a private
	// endpoint from a customer's virtual network.
	PrivateEndpointConnections []*PrivateEndpointConnection

	// READ-ONLY; List of private link resources available for connection. For Defender services, this typically includes the
	// 'containers' group with 'api' and regional data endpoints.
	PrivateLinkResources []*PrivateLinkGroupResource

	// READ-ONLY; The current provisioning state of the private link resource. Indicates whether the resource is being created,
	// updated, deleted, or has completed successfully.
	ProvisioningState *ProvisioningState
}

// PrivateLinkResource - A private link resource that enables secure, private connectivity to Microsoft Defender for Cloud
// services. This resource manages the lifecycle of private endpoint connections and provides the necessary infrastructure
// for private connectivity.
type PrivateLinkResource struct {
	// REQUIRED; The geo-location where the resource lives
	Location *string

	// REQUIRED; Properties specific to the private link resource
...
// PrivateLinkUpdate - Request payload for updating a private link resource. Used in PATCH operations to update specific mutable
// properties without affecting the entire resource configuration.
type PrivateLinkUpdate struct {
	// Resource tags
	Tags map[string]*string
}

// PrivateLinksList - Paginated list of private link resources. Contains an array of private links and optional pagination
// information.
type PrivateLinksList struct {
...
type ProcessNotAllowed struct {
	...
	// CONSTANT; Field has constant value "ProcessNotAllowed", any specified value is ignored.
	RuleType *string
...
type QueuePurgesNotInAllowedRange struct {
	...
	// CONSTANT; The type of the custom alert rule.
	// Field has constant value "QueuePurgesNotInAllowedRange", any specified value is ignored.
	RuleType *string
...
type RegulatoryComplianceAssessmentList struct {
	// REQUIRED; The RegulatoryComplianceAssessment items on this page
...
type RegulatoryComplianceControlList struct {
	// REQUIRED; The RegulatoryComplianceControl items on this page
...
type RegulatoryComplianceStandardList struct {
	// REQUIRED; The RegulatoryComplianceStandard items on this page
...
// SQLVulnerabilityAssessmentScanOperationResult - Represents the result of a SQL Vulnerability Assessment scan operation,
// wrapped in the ARM resource envelope.
type SQLVulnerabilityAssessmentScanOperationResult struct {
...
// SQLVulnerabilityAssessmentScanOperationResultProperties - Represents the properties of a SQL Vulnerability Assessment scan
// operation result.
type SQLVulnerabilityAssessmentScanOperationResultProperties struct {
...
// SQLVulnerabilityAssessmentSettings - SQL Vulnerability Assessment settings resource.
type SQLVulnerabilityAssessmentSettings struct {
...
// SQLVulnerabilityAssessmentSettingsProperties - SQL Vulnerability Assessment settings properties.
type SQLVulnerabilityAssessmentSettingsProperties struct {
	// Represents the state of a SQL Vulnerability Assessment.
	State *SQLVulnerabilityAssessmentState

	// READ-ONLY; The creation time of the SQL Vulnerability Assessment settings.
...
type SecureScoreControlDefinitionList struct {
	...
	// READ-ONLY; Collection of security control definitions.
...
type ServerVulnerabilityAssessmentsSettingsList struct {
	...
	// READ-ONLY; The ServerVulnerabilityAssessmentsSetting items on this page.
...
// Solution - Concrete proxy resource types can be created by aliasing this type using a specific property type.
...
type StandardProperties struct {
	...
	// List of component objects containing component unique keys (such as assessment keys) to apply to standard scope. Currently
	// only supports assessment keys.
...
type SubAssessmentList struct {
	...
	// READ-ONLY; List of security sub-assessments
	Value []*SubAssessment
}
...
type TaskList struct {
	...
	// READ-ONLY; The SecurityTask items on this page
	Value []*Task
}
...
type ThresholdCustomAlertRule struct {
	...
	// CONSTANT; Field has constant value "ThresholdCustomAlertRule", any specified value is ignored.
	RuleType *string
...
type TimeWindowCustomAlertRule struct {
	...
	// CONSTANT; Field has constant value "TimeWindowCustomAlertRule", any specified value is ignored.
	RuleType *string
...
// TopologyResource - Concrete proxy resource types can be created by aliasing this type using a specific property type.
...
type TwinUpdatesNotInAllowedRange struct {
	...
	// CONSTANT; The type of the custom alert rule.
	// Field has constant value "TwinUpdatesNotInAllowedRange", any specified value is ignored.
	RuleType *string
...
type UnauthorizedOperationsNotInAllowedRange struct {
	...
	// CONSTANT; The type of the custom alert rule.
	// Field has constant value "UnauthorizedOperationsNotInAllowedRange", any specified value is ignored.
	RuleType *string
...
type WorkspaceSettingList struct {
	// REQUIRED; The WorkspaceSetting items on this page
