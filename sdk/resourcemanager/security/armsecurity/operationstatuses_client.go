...
func (client *OperationStatusesClient) getCreateRequest(ctx context.Context, location string, operationID string, _ *OperationStatusesClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/providers/Microsoft.Security/locations/{location}/operationStatuses/{operationId}"
...
func (client *OperationStatusesClient) getHandleResponse(resp *http.Response) (OperationStatusesClientGetResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.OperationStatusResultAutoGenerated); err != nil {
		return OperationStatusesClientGetResponse{}, err
	}
	return result, nil
}
