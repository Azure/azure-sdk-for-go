...
// OperatorsClientListOptions contains the optional parameters for the OperatorsClient.NewListPager method.
...
// PrivateLinkParameters contains a group of parameters for the PrivateLinkResourcesClient.Get method.
...
type SQLVulnerabilityAssessmentBaselineRulesClientAddOptions struct {
	...
	// than on a specific database resource, since the database name is not part of the resource URI. This is the only way to
	// assess system databases (e.g., master), which cannot be referenced directly in the resource URI.
	DatabaseName *string
}
