...
// Generated from example definition: 2026-01-01/PrivateLinkResources/PrivateLinkResources_Get.json
func ExamplePrivateLinkResourcesClient_Get() {
	...
	// res = armsecurity.PrivateLinkResourcesClientGetResponse{
	// 	PrivateLinkGroupResource: armsecurity.PrivateLinkGroupResource{
