...
// Generated from example definition: 2019-01-01-preview/RegulatoryCompliance/getRegulatoryComplianceControl_example.json
func ExampleRegulatoryComplianceControlsClient_Get() {
	...
	// res = armsecurity.RegulatoryComplianceControlsClientGetResponse{
	// 	RegulatoryComplianceControl: armsecurity.RegulatoryComplianceControl{
	// 		Name: to.Ptr("1.1"),
...
// Generated from example definition: 2019-01-01-preview/RegulatoryCompliance/getRegulatoryComplianceControlList_example.json
func ExampleRegulatoryComplianceControlsClient_NewListPager() {
	...
	pager := clientFactory.NewRegulatoryComplianceControlsClient().NewListPager("PCI-DSS-3.2", nil)
	for pager.More() {
		...
		// page = armsecurity.RegulatoryComplianceControlsClientListResponse{
		// 	RegulatoryComplianceControlList: armsecurity.RegulatoryComplianceControlList{
