...
// Generated from example definition: 2019-01-01-preview/RegulatoryCompliance/getRegulatoryComplianceStandard_example.json
func ExampleRegulatoryComplianceStandardsClient_Get() {
	...
	// res = armsecurity.RegulatoryComplianceStandardsClientGetResponse{
	// 	RegulatoryComplianceStandard: armsecurity.RegulatoryComplianceStandard{
...
// Generated from example definition: 2019-01-01-preview/RegulatoryCompliance/getRegulatoryComplianceStandardList_example.json
func ExampleRegulatoryComplianceStandardsClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armsecurity.RegulatoryComplianceStandardsClientListResponse{
		// 	RegulatoryComplianceStandardList: armsecurity.RegulatoryComplianceStandardList{
