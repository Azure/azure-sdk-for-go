...
// ConnectorGovernanceRuleClientListResponse contains the response from method ConnectorGovernanceRuleClient.NewListPager.
...
// ConnectorGovernanceRulesExecuteStatusClientGetResponse contains the response from method ConnectorGovernanceRulesExecuteStatusClient.BeginGet.
...
// GovernanceRuleClientListResponse contains the response from method GovernanceRuleClient.NewListPager.
...
// GovernanceRulesClientRuleIDExecuteSingleSecurityConnectorResponse contains the response from method GovernanceRulesClient.BeginRuleIDExecuteSingleSecurityConnector.
type GovernanceRulesClientRuleIDExecuteSingleSecurityConnectorResponse struct {
	// placeholder for future response values
}

// GovernanceRulesClientRuleIDExecuteSingleSubscriptionResponse contains the response from method GovernanceRulesClient.BeginRuleIDExecuteSingleSubscription.
...
// SubscriptionGovernanceRulesExecuteStatusClientGetResponse contains the response from method SubscriptionGovernanceRulesExecuteStatusClient.BeginGet.
