...
// Generated from example definition: 2020-01-01/secureScoreControlDefinitions/ListSecureScoreControlDefinitions_example.json
func ExampleSecureScoreControlDefinitionsClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armsecurity.SecureScoreControlDefinitionsClientListResponse{
		// 	SecureScoreControlDefinitionList: armsecurity.SecureScoreControlDefinitionList{
...
// Generated from example definition: 2020-01-01/secureScoreControlDefinitions/ListSecureScoreControlDefinitions_subscription_example.json
func ExampleSecureScoreControlDefinitionsClient_NewListBySubscriptionPager() {
	...
	for pager.More() {
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armsecurity.SecureScoreControlDefinitionsClientListBySubscriptionResponse{
		// 	SecureScoreControlDefinitionList: armsecurity.SecureScoreControlDefinitionList{
		// 		Value: []*armsecurity.SecureScoreControlDefinitionItem{
		// 			{
		// 				Name: to.Ptr("a9909064-42b4-4d34-8143-275477afe18b"),
