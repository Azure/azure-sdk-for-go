...
// Generated from example definition: 2020-01-01/secureScores/ListSecureScoreControls_example.json
func ExampleSecureScoreControlsClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armsecurity.SecureScoreControlsClientListResponse{
		// 	SecureScoreControlList: armsecurity.SecureScoreControlList{
...
// Generated from example definition: 2020-01-01/secureScores/ListSecureScoreControlsForNameWithExpand_builtin_example.json
func ExampleSecureScoreControlsClient_NewListBySecureScorePager_getSecurityControlsAndTheirCurrentScoreForTheSpecifiedInitiativeWithTheExpandParameter() {
	...
	pager := clientFactory.NewSecureScoreControlsClient().NewListBySecureScorePager("ascScore", &armsecurity.SecureScoreControlsClientListBySecureScoreOptions{
		Expand: to.Ptr(armsecurity.ExpandControlsEnumDefinition)})
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armsecurity.SecureScoreControlsClientListBySecureScoreResponse{
		// 	SecureScoreControlList: armsecurity.SecureScoreControlList{
		// 		Value: []*armsecurity.SecureScoreControlDetails{
		// 			{
		// 				Name: to.Ptr("a9909064-42b4-4d34-8143-275477afe18b"),
...
// Generated from example definition: 2020-01-01/secureScores/ListSecureScoreControlsForName_builtin_example.json
func ExampleSecureScoreControlsClient_NewListBySecureScorePager_getSecurityControlsAndTheirCurrentScoreForTheSpecifiedInitiative() {
	...
	pager := clientFactory.NewSecureScoreControlsClient().NewListBySecureScorePager("ascScore", nil)
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
