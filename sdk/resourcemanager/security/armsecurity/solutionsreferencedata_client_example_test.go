...
// Generated from example definition: 2020-01-01/SecuritySolutionsReferenceData/GetSecuritySolutionsReferenceDataSubscription_example.json
func ExampleSolutionsReferenceDataClient_List() {
	...
	// res = armsecurity.SolutionsReferenceDataClientListResponse{
	// 	SolutionsReferenceDataList: armsecurity.SolutionsReferenceDataList{
...
// Generated from example definition: 2020-01-01/SecuritySolutionsReferenceData/GetSecuritySolutionsReferenceDataSubscriptionLocation_example.json
func ExampleSolutionsReferenceDataClient_ListByHomeRegion() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsecurity.SolutionsReferenceDataClientListByHomeRegionResponse{
	// 	SolutionsReferenceDataList: armsecurity.SolutionsReferenceDataList{
	// 		Value: []*armsecurity.SolutionsReferenceData{
	// 			{
	// 				Name: to.Ptr("microsoft.ApplicationGateway-ARM"),
