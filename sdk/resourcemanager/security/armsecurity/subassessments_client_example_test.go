...
// Generated from example definition: 2019-01-01-preview/SubAssessments/GetSubAssessment_example.json
func ExampleSubAssessmentsClient_Get() {
	...
	// res = armsecurity.SubAssessmentsClientGetResponse{
...
// Generated from example definition: 2019-01-01-preview/SubAssessments/ListSubAssessments_example.json
func ExampleSubAssessmentsClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armsecurity.SubAssessmentsClientListResponse{
		// 	SubAssessmentList: armsecurity.SubAssessmentList{
...
// Generated from example definition: 2019-01-01-preview/SubAssessments/ListSubscriptionSubAssessments_example.json
func ExampleSubAssessmentsClient_NewListAllPager() {
	...
	for pager.More() {
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armsecurity.SubAssessmentsClientListAllResponse{
		// 	SubAssessmentList: armsecurity.SubAssessmentList{
		// 		Value: []*armsecurity.SubAssessment{
		// 			{
