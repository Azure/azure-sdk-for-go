...
// Generated from example definition: 2020-01-01/Topology/GetTopology_example.json
func ExampleTopologyClient_Get() {
	...
	// res = armsecurity.TopologyClientGetResponse{
	// 	TopologyResource: armsecurity.TopologyResource{
	// 		Name: to.Ptr("vnets"),
...
// Generated from example definition: 2020-01-01/Topology/GetTopologySubscription_example.json
func ExampleTopologyClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armsecurity.TopologyClientListResponse{
		// 	TopologyList: armsecurity.TopologyList{
...
// Generated from example definition: 2020-01-01/Topology/GetTopologySubscriptionLocation_example.json
func ExampleTopologyClient_NewListByHomeRegionPager() {
	...
	for pager.More() {
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armsecurity.TopologyClientListByHomeRegionResponse{
		// 	TopologyList: armsecurity.TopologyList{
		// 		Value: []*armsecurity.TopologyResource{
		// 			{
		// 				Name: to.Ptr("vnets"),
