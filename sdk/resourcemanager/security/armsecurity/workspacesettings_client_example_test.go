...
// Generated from example definition: 2017-08-01-preview/WorkspaceSettings/CreateWorkspaceSetting_example.json
func ExampleWorkspaceSettingsClient_Create() {
	...
	// res = armsecurity.WorkspaceSettingsClientCreateResponse{
	// 	WorkspaceSetting: armsecurity.WorkspaceSetting{
	// 		Name: to.Ptr("default"),
...
// Generated from example definition: 2017-08-01-preview/WorkspaceSettings/DeleteWorkspaceSetting_example.json
...
// Generated from example definition: 2017-08-01-preview/WorkspaceSettings/GetWorkspaceSetting_example.json
func ExampleWorkspaceSettingsClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsecurity.WorkspaceSettingsClientGetResponse{
	// 	WorkspaceSetting: armsecurity.WorkspaceSetting{
	// 		Name: to.Ptr("default"),
	// 		Type: to.Ptr("Microsoft.Security/workspaceSettings"),
	// 		ID: to.Ptr("/subscriptions/20ff7fc3-e762-44dd-bd96-b71116dcdc23/providers/Microsoft.Security/workspaceSettings/default"),
...
// Generated from example definition: 2017-08-01-preview/WorkspaceSettings/GetWorkspaceSettings_example.json
func ExampleWorkspaceSettingsClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armsecurity.WorkspaceSettingsClientListResponse{
		// 	WorkspaceSettingList: armsecurity.WorkspaceSettingList{
...
// Generated from example definition: 2017-08-01-preview/WorkspaceSettings/UpdateWorkspaceSetting_example.json
func ExampleWorkspaceSettingsClient_Update() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsecurity.WorkspaceSettingsClientUpdateResponse{
	// 	WorkspaceSetting: armsecurity.WorkspaceSetting{
	// 		Name: to.Ptr("default"),
	// 		Type: to.Ptr("Microsoft.Security/workspaceSettings"),
	// 		ID: to.Ptr("/subscriptions/20ff7fc3-e762-44dd-bd96-b71116dcdc23/providers/Microsoft.Security/workspaceSettings/default"),
