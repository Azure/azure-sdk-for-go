...
func (a AdaptiveNetworkHardeningProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "rules", a.Rules)
	populate(objectMap, "rulesCalculationTime", (*timeRFC3339)(a.RulesCalculationTime))
	return json.Marshal(objectMap)
}
...
func (a *AdaptiveNetworkHardeningProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "rulesCalculationTime":
			...
			a.RulesCalculationTime = (*time.Time)(&aux)
			delete(rawMsg, key)
		}
		if err != nil {
			return err
...
func (a AlertProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "endTimeUtc", (*timeRFC3339)(a.EndTimeUTC))
	...
	populate(objectMap, "processingEndTimeUtc", (*timeRFC3339)(a.ProcessingEndTimeUTC))
	...
	populate(objectMap, "startTimeUtc", (*timeRFC3339)(a.StartTimeUTC))
	populate(objectMap, "status", a.Status)
	populate(objectMap, "systemAlertId", a.SystemAlertID)
	populate(objectMap, "timeGeneratedUtc", (*timeRFC3339)(a.TimeGeneratedUTC))
...
func (a *AlertProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "processingEndTimeUtc":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			a.ProcessingEndTimeUTC = (*time.Time)(&aux)
			delete(rawMsg, key)
		...
		case "timeGeneratedUtc":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			a.TimeGeneratedUTC = (*time.Time)(&aux)
			delete(rawMsg, key)
		case "vendorName":
...
func (a AlertsSuppressionRuleProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "expirationDateUtc", (*timeRFC3339)(a.ExpirationDateUTC))
	populate(objectMap, "lastModifiedUtc", (*timeRFC3339)(a.LastModifiedUTC))
...
func (a *AlertsSuppressionRuleProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "expirationDateUtc":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			a.ExpirationDateUTC = (*time.Time)(&aux)
			delete(rawMsg, key)
		case "lastModifiedUtc":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			a.LastModifiedUTC = (*time.Time)(&aux)
			delete(rawMsg, key)
		case "reason":
...
func (a AllowedConnectionsResourceProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "calculatedDateTime", (*timeRFC3339)(a.CalculatedDateTime))
...
func (a *AllowedConnectionsResourceProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "calculatedDateTime":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			a.CalculatedDateTime = (*time.Time)(&aux)
			delete(rawMsg, key)
...
func (b Baseline) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "updatedTime", (*timeRFC3339)(b.UpdatedTime))
	return json.Marshal(objectMap)
}
...
func (c ComplianceProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "assessmentTimestampUtcDate", (*timeRFC3339)(c.AssessmentTimestampUTCDate))
...
func (c *ComplianceProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "assessmentTimestampUtcDate":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			c.AssessmentTimestampUTCDate = (*time.Time)(&aux)
			delete(rawMsg, key)
		case "resourceCount":
...
func (c ContainerRegistryVulnerabilityProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "publishedTime", (*timeRFC3339)(c.PublishedTime))
...
func (i InformationProtectionPolicyProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "lastModifiedUtc", (*timeRFC3339)(i.LastModifiedUTC))
...
func (i *InformationProtectionPolicyProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "lastModifiedUtc":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			i.LastModifiedUTC = (*time.Time)(&aux)
			delete(rawMsg, key)
		case "version":
...
func (i IoTSecurityAggregatedAlertProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "aggregatedDateUtc", (*dateType)(i.AggregatedDateUTC))
...
func (i *IoTSecurityAggregatedAlertProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "aggregatedDateUtc":
			var aux dateType
			err = unpopulate(val, &aux)
			i.AggregatedDateUTC = (*time.Time)(&aux)
			delete(rawMsg, key)
		case "alertDisplayName":
...
func (i IoTSecuritySolutionAnalyticsModelPropertiesDevicesMetricsItem) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "date", (*timeRFC3339)(i.Date))
	populate(objectMap, "devicesMetrics", i.DevicesMetrics)
	return json.Marshal(objectMap)
}
...
func (j JitNetworkAccessPolicyInitiatePort) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "endTimeUtc", (*timeRFC3339)(j.EndTimeUTC))
...
func (j JitNetworkAccessRequest) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "startTimeUtc", (*timeRFC3339)(j.StartTimeUTC))
	populate(objectMap, "virtualMachines", j.VirtualMachines)
	return json.Marshal(objectMap)
}
...
func (s SecuritySubAssessmentProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "resourceDetails", s.ResourceDetails)
	populate(objectMap, "status", s.Status)
	populate(objectMap, "timeGenerated", (*timeRFC3339)(s.TimeGenerated))
	return json.Marshal(objectMap)
}
...
func (s SecurityTaskProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "creationTimeUtc", (*timeRFC3339)(s.CreationTimeUTC))
	populate(objectMap, "lastStateChangeTimeUtc", (*timeRFC3339)(s.LastStateChangeTimeUTC))
...
func (s *SecurityTaskProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "creationTimeUtc":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			s.CreationTimeUTC = (*time.Time)(&aux)
			delete(rawMsg, key)
		case "lastStateChangeTimeUtc":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			s.LastStateChangeTimeUTC = (*time.Time)(&aux)
			delete(rawMsg, key)
...
func (s ServerVulnerabilityProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "publishedTime", (*timeRFC3339)(s.PublishedTime))
...
func (t TopologyResourceProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "calculatedDateTime", (*timeRFC3339)(t.CalculatedDateTime))
...
func (t *TopologyResourceProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "calculatedDateTime":
			var aux timeRFC3339
			err = unpopulate(val, &aux)
			t.CalculatedDateTime = (*time.Time)(&aux)
			delete(rawMsg, key)
