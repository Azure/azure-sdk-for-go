...
func ExampleGitHubOwnerClient_NewListPager() {
	...
	client, err := armsecuritydevops.NewGitHubOwnerClient("00000000-0000-0000-0000-000000000000", cred, nil)
	if err != nil {
...
func ExampleGitHubOwnerClient_Get() {
	...
	res, err := client.Get(ctx, "westusrg", "testconnector", "Azure", nil)
	if err != nil {
...
func ExampleGitHubOwnerClient_BeginCreateOrUpdate() {
	...
	poller, err := client.BeginCreateOrUpdate(ctx, "westusrg", "testconnector", "Azure", armsecuritydevops.GitHubOwner{}, nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
...
func ExampleGitHubOwnerClient_BeginUpdate() {
	...
	poller, err := client.BeginUpdate(ctx, "westusrg", "testconnector", "Azure", armsecuritydevops.GitHubOwner{}, nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
