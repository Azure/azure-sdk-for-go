...
func ExampleGitHubRepoClient_NewListByConnectorPager() {
	...
	client, err := armsecuritydevops.NewGitHubRepoClient("00000000-0000-0000-0000-000000000000", cred, nil)
	if err != nil {
		log.Fatalf("failed to create client: %v", err)
	}
	pager := client.NewListByConnectorPager("westusrg", "testconnector", nil)
	for pager.More() {
...
func ExampleGitHubRepoClient_NewListPager() {
	...
	pager := client.NewListPager("westusrg", "testconnector", "Azure", nil)
	for pager.More() {
		nextResult, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
...
func ExampleGitHubRepoClient_Get() {
	...
	res, err := client.Get(ctx, "westusrg", "testconnector", "Azure", "39093389", nil)
	if err != nil {
...
func ExampleGitHubRepoClient_BeginCreateOrUpdate() {
	...
	poller, err := client.BeginCreateOrUpdate(ctx, "westusrg", "testconnector", "Azure", "azure-rest-api-specs", armsecuritydevops.GitHubRepo{}, nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
...
func ExampleGitHubRepoClient_BeginUpdate() {
	...
	poller, err := client.BeginUpdate(ctx, "westusrg", "testconnector", "Azure", "azure-rest-api-specs", armsecuritydevops.GitHubRepo{}, nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
