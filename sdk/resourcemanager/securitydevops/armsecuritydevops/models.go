...
type AuthorizationInfo struct {
	...
	// Only used during PUT operations. The secret is cleared during GET. In general, RPaaS does not return any property marked
	// as a secret.
	Code *string
}
...
type AzureDevOpsRepoProperties struct {
	...
	// READ-ONLY; Gets or sets AzureDevOps org Name.
	OrgName *string

	// READ-ONLY; Gets or sets AzureDevOps project Name.
	ProjectName *string

	// READ-ONLY
	ProvisioningState *ProvisioningState

	// READ-ONLY; Gets or sets Azure DevOps repo id.
	RepoID *string

	// READ-ONLY; Gets or sets AzureDevOps repo url.
	RepoURL *string

	// READ-ONLY; Gets or sets AzureDevOps repo visibility, whether it is public or private etc.
	Visibility *string
}
