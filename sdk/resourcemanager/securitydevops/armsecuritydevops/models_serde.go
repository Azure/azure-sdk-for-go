...
// MarshalJSON implements the json.Marshaller interface for type GitHubReposProperties.
func (g GitHubReposProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "accountId", g.AccountID)
	populate(objectMap, "provisioningState", g.ProvisioningState)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type GitHubReposProperties.
func (g *GitHubReposProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", g, err)
	}
