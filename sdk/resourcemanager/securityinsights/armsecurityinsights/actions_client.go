...
func (client *ActionsClient) createOrUpdateHandleResponse(resp *http.Response, successCodes ...int) (ActionsClientCreateOrUpdateResponse, error) {
...
func (client *ActionsClient) Delete(ctx context.Context, resourceGroupName string, workspaceName string, ruleID string, actionID string, options *ActionsClientDeleteOptions) (ActionsClientDeleteResponse, error) {
	...
	if !runtime.HasStatusCode(httpResp, http.StatusOK, http.StatusNoContent) {
		return ActionsClientDeleteResponse{}, runtime.NewResponseError(httpResp)
	}
...
func (client *ActionsClient) NewListByAlertRulePager(resourceGroupName string, workspaceName string, ruleID string, options *ActionsClientListByAlertRuleOptions) *runtime.Pager[ActionsClientListByAlertRuleResponse] {
	return runtime.NewPager(runtime.PagingHandler[ActionsClientListByAlertRuleResponse]{
		...
		Fetcher: func(ctx context.Context, page *ActionsClientListByAlertRuleResponse) (ActionsClientListByAlertRuleResponse, error) {
			...
			req, err := client.listByAlertRuleCreateRequest(ctx, resourceGroupName, workspaceName, ruleID, nextLink, options)
			if err != nil {
			...
			return client.listByAlertRuleHandleResponse(resp, http.StatusOK)
		},
...
func (client *ActionsClient) listByAlertRuleCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, ruleID string, nextLink string, _ *ActionsClientListByAlertRuleOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *ActionsClient) listByAlertRuleHandleResponse(resp *http.Response, successCodes ...int) (ActionsClientListByAlertRuleResponse, error) {
