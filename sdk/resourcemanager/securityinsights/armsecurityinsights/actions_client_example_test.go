...
func ExampleActionsClient_CreateOrUpdate() {
	...
	// res = armsecurityinsights.ActionsClientCreateOrUpdateResponse{
	// 	ActionResponse: &armsecurityinsights.ActionResponse{
...
func ExampleActionsClient_Delete() {
	...
	res, err := clientFactory.NewActionsClient().Delete(ctx, "myRg", "myWorkspace", "73e01a99-5cd7-4139-a149-9f2736ff2ab5", "912bec42-cb66-4c03-ac63-1761b6898c3e", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsecurityinsights.ActionsClientDeleteResponse{
	// }
}
...
func ExampleActionsClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsecurityinsights.ActionsClientGetResponse{
	// 	ActionResponse: &armsecurityinsights.ActionResponse{
	// 		Name: to.Ptr("912bec42-cb66-4c03-ac63-1761b6898c3e"),
	// 		Type: to.Ptr("Microsoft.SecurityInsights/alertRules/actions"),
	// 		Etag: to.Ptr("\"0300bf09-0000-0000-0000-5c37296e0000\""),
...
func ExampleActionsClient_NewListByAlertRulePager() {
	...
	for pager.More() {
		...
		// page = armsecurityinsights.ActionsClientListByAlertRuleResponse{
		// 	ActionsList: armsecurityinsights.ActionsList{
