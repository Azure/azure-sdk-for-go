...
func ExampleAlertRulesClient_Delete() {
	...
	res, err := clientFactory.NewAlertRulesClient().Delete(ctx, "myRg", "myWorkspace", "73e01a99-5cd7-4139-a149-9f2736ff2ab5", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsecurityinsights.AlertRulesClientDeleteResponse{
	// }
}
...
func ExampleAlertRulesClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armsecurityinsights.AlertRulesClientListResponse{
		// 	AlertRulesList: armsecurityinsights.AlertRulesList{
