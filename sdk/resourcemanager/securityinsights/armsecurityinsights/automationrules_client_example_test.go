...
func ExampleAutomationRulesClient_CreateOrUpdate() {
	...
	res, err := clientFactory.NewAutomationRulesClient().CreateOrUpdate(ctx, "myRg", "myWorkspace", "73e01a99-5cd7-4139-a149-9f2736ff2ab5", armsecurityinsights.AutomationRule{}, nil)
	if err != nil {
	...
	// res = armsecurityinsights.AutomationRulesClientCreateOrUpdateResponse{
	// 	AutomationRule: &armsecurityinsights.AutomationRule{
...
func ExampleAutomationRulesClient_Delete() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsecurityinsights.AutomationRulesClientDeleteResponse{
	// 	DeleteResponse: &armsecurityinsights.DeleteResponse{
	// 	},
	// }
}
...
func ExampleAutomationRulesClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsecurityinsights.AutomationRulesClientGetResponse{
	// 	AutomationRule: &armsecurityinsights.AutomationRule{
	// 		Name: to.Ptr("73e01a99-5cd7-4139-a149-9f2736ff2ab5"),
	// 		Type: to.Ptr("Microsoft.SecurityInsights/automationRules"),
	// 		Etag: to.Ptr("\"0300bf09-0000-0000-0000-5c37296e0000\""),
