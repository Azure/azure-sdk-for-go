...
func (client *BookmarksClient) createOrUpdateHandleResponse(resp *http.Response, successCodes ...int) (BookmarksClientCreateOrUpdateResponse, error) {
...
func (client *BookmarksClient) Delete(ctx context.Context, resourceGroupName string, workspaceName string, bookmarkID string, options *BookmarksClientDeleteOptions) (BookmarksClientDeleteResponse, error) {
	...
	if !runtime.HasStatusCode(httpResp, http.StatusOK, http.StatusNoContent) {
		return BookmarksClientDeleteResponse{}, runtime.NewResponseError(httpResp)
	}
...
func (client *BookmarksClient) getHandleResponse(resp *http.Response, successCodes ...int) (BookmarksClientGetResponse, error) {
...
func (client *BookmarksClient) listCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, nextLink string, _ *BookmarksClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *BookmarksClient) listHandleResponse(resp *http.Response, successCodes ...int) (BookmarksClientListResponse, error) {
