...
func ExampleClient_ListWhoisByDomain() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsecurityinsights.ClientListWhoisByDomainResponse{
	// 	EnrichmentDomainWhois: armsecurityinsights.EnrichmentDomainWhois{
	// 		Created: to.Ptr(time.Date(2021, time.September, 1, 16, 15, 1, 187045000, time.UTC)),
	// 		Domain: to.Ptr("microsoft.com"),
	...
	// 			},
	// 		},
	// 		Updated: to.Ptr(time.Date(2021, time.September, 1, 16, 15, 1, 187045000, time.UTC)),
	// 	},
	// }
}
