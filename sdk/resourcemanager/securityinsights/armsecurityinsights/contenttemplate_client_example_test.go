...
func ExampleContentTemplateClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsecurityinsights.ContentTemplateClientGetResponse{
	// 	TemplateModel: &armsecurityinsights.TemplateModel{
...
func ExampleContentTemplateClient_Install() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsecurityinsights.ContentTemplateClientInstallResponse{
	// 	TemplateModel: &armsecurityinsights.TemplateModel{
