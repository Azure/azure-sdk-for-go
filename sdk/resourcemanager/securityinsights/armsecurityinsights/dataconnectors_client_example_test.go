...
func ExampleDataConnectorsClient_Get_getAPremiumMicrosoftDefenderForThreatIntelligenceDataConnector() {
	...
	// 				},
	// 			},
	// 			LookbackPeriod: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2023-12-26T22:16:07.000Z"); return t}()),
...
func ExampleDataConnectorsClient_CreateOrUpdate_createsOrUpdatesAPremiumMicrosoftDefenderForThreatIntelligenceDataConnector() {
	...
	// 				},
	// 			},
	// 			LookbackPeriod: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2024-11-01T00:00:00.000Z"); return t}()),
...
func ExampleDataConnectorsClient_Delete_deleteAGcpDataConnector() {
	...
	_, err = clientFactory.NewDataConnectorsClient().Delete(ctx, "myRg", "myWorkspace", "GCP_fce27b90-d6f5-4d30-991a-af509a2b50a1", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
}
...
func ExampleDataConnectorsClient_Delete_deleteAnMicrosoftThreatIntelligenceDataConnector() {
	...
	_, err = clientFactory.NewDataConnectorsClient().Delete(ctx, "myRg", "myWorkspace", "c345bf40-8509-4ed2-b947-50cb773aaf04", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
}
...
func ExampleDataConnectorsClient_Delete_deletesAPremiumMicrosoftDefenderForThreatIntelligenceDataConnector() {
	...
	_, err = clientFactory.NewDataConnectorsClient().Delete(ctx, "myRg", "myWorkspace", "8c569548-a86c-4fb4-8ae4-d1e35a6146f8", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
}
