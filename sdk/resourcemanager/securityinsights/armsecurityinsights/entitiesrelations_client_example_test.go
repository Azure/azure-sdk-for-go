...
// Generated from example definition: 2025-07-01-preview/entities/relations/GetAllEntityRelations.json
func ExampleEntitiesRelationsClient_NewListPager() {
	...
	pager := clientFactory.NewEntitiesRelationsClient().NewListPager("myRg", "myWorkspace", "afbd324f-6c48-459c-8710-8d1e1cd03812", nil)
	for pager.More() {
		...
		// page = armsecurityinsights.EntitiesRelationsClientListResponse{
