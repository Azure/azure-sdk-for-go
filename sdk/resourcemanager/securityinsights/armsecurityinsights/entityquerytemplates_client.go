...
func (client *EntityQueryTemplatesClient) getHandleResponse(resp *http.Response, successCodes ...int) (EntityQueryTemplatesClientGetResponse, error) {
...
func (client *EntityQueryTemplatesClient) listCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, nextLink string, options *EntityQueryTemplatesClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *EntityQueryTemplatesClient) listHandleResponse(resp *http.Response, successCodes ...int) (EntityQueryTemplatesClientListResponse, error) {
