...
func ExampleEntityQueryTemplatesClient_NewListPager() {
	...
	pager := clientFactory.NewEntityQueryTemplatesClient().NewListPager("myRg", "myWorkspace", &armsecurityinsights.EntityQueryTemplatesClientListOptions{
		Kind: to.Ptr(armsecurityinsights.EntityQueryTemplateKindActivity)})
	for pager.More() {
		...
		// page = armsecurityinsights.EntityQueryTemplatesClientListResponse{
		// 	EntityQueryTemplateList: armsecurityinsights.EntityQueryTemplateList{
