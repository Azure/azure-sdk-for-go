...
type SentinelOnboardingStatesServer struct {
	...
	Create func(ctx context.Context, resourceGroupName string, workspaceName string, sentinelOnboardingStateName string, sentinelOnboardingStateParameter armsecurityinsights.SentinelOnboardingState, options *armsecurityinsights.SentinelOnboardingStatesClientCreateOptions) (resp azfake.Responder[armsecurityinsights.SentinelOnboardingStatesClientCreateResponse], errResp azfake.ErrorResponder)
	...
	// NewListPager is the fake for method SentinelOnboardingStatesClient.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager func(resourceGroupName string, workspaceName string, options *armsecurityinsights.SentinelOnboardingStatesClientListOptions) (resp azfake.PagerResponder[armsecurityinsights.SentinelOnboardingStatesClientListResponse])
}
...
func NewSentinelOnboardingStatesServerTransport(srv *SentinelOnboardingStatesServer) *SentinelOnboardingStatesServerTransport {
	return &SentinelOnboardingStatesServerTransport{
		srv:          srv,
		newListPager: newTracker[azfake.PagerResponder[armsecurityinsights.SentinelOnboardingStatesClientListResponse]](),
	}
}
...
type SentinelOnboardingStatesServerTransport struct {
	...
	newListPager *tracker[azfake.PagerResponder[armsecurityinsights.SentinelOnboardingStatesClientListResponse]]
}
...
func (s *SentinelOnboardingStatesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		if !intercepted {
			...
			case "SentinelOnboardingStatesClient.NewListPager":
...
func (s *SentinelOnboardingStatesServerTransport) dispatchCreate(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := s.srv.Create(req.Context(), resourceGroupNameParam, workspaceNameParam, sentinelOnboardingStateNameParam, body, nil)
...
func (s *SentinelOnboardingStatesServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
