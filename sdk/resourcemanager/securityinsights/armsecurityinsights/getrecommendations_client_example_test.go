...
// Generated from example definition: 2025-07-01-preview/recommendations/GetRecommendations.json
func ExampleGetRecommendationsClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armsecurityinsights.GetRecommendationsClientListResponse{
		// 	RecommendationList: armsecurityinsights.RecommendationList{
