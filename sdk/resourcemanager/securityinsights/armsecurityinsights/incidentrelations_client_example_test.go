...
func ExampleIncidentRelationsClient_CreateOrUpdate() {
	...
	// res = armsecurityinsights.IncidentRelationsClientCreateOrUpdateResponse{
...
func ExampleIncidentRelationsClient_Delete() {
	...
	res, err := clientFactory.NewIncidentRelationsClient().Delete(ctx, "myRg", "myWorkspace", "afbd324f-6c48-459c-8710-8d1e1cd03812", "4bb36b7b-26ff-4d1c-9cbe-0d8ab3da0014", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsecurityinsights.IncidentRelationsClientDeleteResponse{
	// }
}
...
func ExampleIncidentRelationsClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsecurityinsights.IncidentRelationsClientGetResponse{
	// 	Relation: &armsecurityinsights.Relation{
	// 		Name: to.Ptr("4bb36b7b-26ff-4d1c-9cbe-0d8ab3da0014"),
	// 		Type: to.Ptr("Microsoft.SecurityInsights/incidents/relations"),
	// 		Etag: to.Ptr("190057d0-0000-0d00-0000-5c6f5adb0000"),
...
func ExampleIncidentRelationsClient_NewListPager() {
	...
	pager := clientFactory.NewIncidentRelationsClient().NewListPager("myRg", "myWorkspace", "afbd324f-6c48-459c-8710-8d1e1cd03812", nil)
	for pager.More() {
		...
		// page = armsecurityinsights.IncidentRelationsClientListResponse{
		// 	RelationList: armsecurityinsights.RelationList{
