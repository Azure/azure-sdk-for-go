...
// NewListAlertsPager - Gets all alerts for an incident.
//
// Generated from API version 2025-07-01-preview
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - workspaceName - The name of the monitor workspace.
//   - incidentID - Incident ID
//   - options - IncidentsClientListAlertsOptions contains the optional parameters for the IncidentsClient.NewListAlertsPager
//     method.
func (client *IncidentsClient) NewListAlertsPager(resourceGroupName string, workspaceName string, incidentID string, options *IncidentsClientListAlertsOptions) *runtime.Pager[IncidentsClientListAlertsResponse] {
	return runtime.NewPager(runtime.PagingHandler[IncidentsClientListAlertsResponse]{
		More: func(page IncidentsClientListAlertsResponse) bool {
			return false
		},
		Fetcher: func(ctx context.Context, page *IncidentsClientListAlertsResponse) (IncidentsClientListAlertsResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "IncidentsClient.NewListAlertsPager")
...
// NewListBookmarksPager - Gets all bookmarks for an incident.
//
// Generated from API version 2025-07-01-preview
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - workspaceName - The name of the monitor workspace.
//   - incidentID - Incident ID
//   - options - IncidentsClientListBookmarksOptions contains the optional parameters for the IncidentsClient.NewListBookmarksPager
//     method.
func (client *IncidentsClient) NewListBookmarksPager(resourceGroupName string, workspaceName string, incidentID string, options *IncidentsClientListBookmarksOptions) *runtime.Pager[IncidentsClientListBookmarksResponse] {
	return runtime.NewPager(runtime.PagingHandler[IncidentsClientListBookmarksResponse]{
		More: func(page IncidentsClientListBookmarksResponse) bool {
			return false
		},
		Fetcher: func(ctx context.Context, page *IncidentsClientListBookmarksResponse) (IncidentsClientListBookmarksResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "IncidentsClient.NewListBookmarksPager")
...
func (client *IncidentsClient) runPlaybookHandleResponse(resp *http.Response) (IncidentsClientRunPlaybookResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.RunPlaybookResponse); err != nil {
		return IncidentsClientRunPlaybookResponse{}, err
	}
	return result, nil
}
