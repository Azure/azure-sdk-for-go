...
func (client *MetadataClient) createHandleResponse(resp *http.Response, successCodes ...int) (MetadataClientCreateResponse, error) {
...
func (client *MetadataClient) Delete(ctx context.Context, resourceGroupName string, workspaceName string, metadataName string, options *MetadataClientDeleteOptions) (MetadataClientDeleteResponse, error) {
	...
	if !runtime.HasStatusCode(httpResp, http.StatusOK, http.StatusNoContent) {
		return MetadataClientDeleteResponse{}, runtime.NewResponseError(httpResp)
	}
...
func (client *MetadataClient) getHandleResponse(resp *http.Response, successCodes ...int) (MetadataClientGetResponse, error) {
...
func (client *MetadataClient) listCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, nextLink string, options *MetadataClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *MetadataClient) updateHandleResponse(resp *http.Response, successCodes ...int) (MetadataClientUpdateResponse, error) {
