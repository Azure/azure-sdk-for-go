...
type AADCheckRequirements struct {
	// CONSTANT; Describes the kind of connector to be checked.
	// Field has constant value DataConnectorKindAzureActiveDirectory, any specified value is ignored.
...
type AADDataConnector struct {
	// CONSTANT; The data connector kind
	// Field has constant value DataConnectorKindAzureActiveDirectory, any specified value is ignored.
	Kind *DataConnectorKind
...
type AATPCheckRequirements struct {
	// CONSTANT; Describes the kind of connector to be checked.
	// Field has constant value DataConnectorKindAzureAdvancedThreatProtection, any specified value is ignored.
	Kind *DataConnectorKind
...
// to the remote server: 'ApiKeyName: ApiKeyIdentifier ApiKey'. If 'IsApiKeyInPostPayload' is true it will send it in the
// body of the request and not the header.
type APIKeyAuthModel struct {
	...
	// CONSTANT; The auth type
	// Field has constant value CcpAuthTypeAPIKey, any specified value is ignored.
	Type *CcpAuthType
...
type ASCCheckRequirements struct {
	// CONSTANT; Describes the kind of connector to be checked.
	// Field has constant value DataConnectorKindAzureSecurityCenter, any specified value is ignored.
	Kind *DataConnectorKind
...
type AWSAuthModel struct {
	...
	// CONSTANT; The auth type
	// Field has constant value CcpAuthTypeAWS, any specified value is ignored.
	Type *CcpAuthType
...
type ActivityCustomEntityQuery struct {
	// CONSTANT; the entity query kind
	// Field has constant value CustomEntityQueryKindActivity, any specified value is ignored.
...
type Anomalies struct {
	// CONSTANT; The kind of the setting
	// Field has constant value SettingKindAnomalies, any specified value is ignored.
	Kind *SettingKind
...
type AnomalySecurityMLAnalyticsSettings struct {
	// CONSTANT; The kind of security ML Analytics Settings
	// Field has constant value SecurityMLAnalyticsSettingsKindAnomaly, any specified value is ignored.
...
type AutomationRuleAddIncidentTaskAction struct {
	// CONSTANT; The type of the automation rule action.
	// Field has constant value ActionTypeAddIncidentTask, any specified value is ignored.
	ActionType *ActionType
...
type AutomationRuleModifyPropertiesAction struct {
	// CONSTANT; The type of the automation rule action.
	// Field has constant value ActionTypeModifyProperties, any specified value is ignored.
	ActionType *ActionType
...
type AutomationRuleRunPlaybookAction struct {
	// CONSTANT; The type of the automation rule action.
	// Field has constant value ActionTypeRunPlaybook, any specified value is ignored.
	ActionType *ActionType
...
type Availability struct {
	...
	// FLAG; CONSTANT; The connector Availability Status
...
type AwsCloudTrailCheckRequirements struct {
	// CONSTANT; Describes the kind of connector to be checked.
	// Field has constant value DataConnectorKindAmazonWebServicesCloudTrail, any specified value is ignored.
	Kind *DataConnectorKind
}
...
type AwsS3CheckRequirements struct {
	// CONSTANT; Describes the kind of connector to be checked.
	// Field has constant value DataConnectorKindAmazonWebServicesS3, any specified value is ignored.
	Kind *DataConnectorKind
}
...
type BasicAuthModel struct {
	...
	// CONSTANT; The auth type
	// Field has constant value CcpAuthTypeBasic, any specified value is ignored.
	Type *CcpAuthType
...
type BooleanConditionProperties struct {
	// CONSTANT; Field has constant value ConditionTypeBoolean, any specified value is ignored.
	ConditionType       *ConditionType
...
type CcpResponseConfig struct {
	...
	// server will response with an object which each property has as a value an array of events / logs.
...
type CodelessAPIPollingDataConnector struct {
	// CONSTANT; The data connector kind
	// Field has constant value DataConnectorKindAPIPolling, any specified value is ignored.
	Kind *DataConnectorKind
...
type CodelessUIDataConnector struct {
	// CONSTANT; The data connector kind
	// Field has constant value DataConnectorKindGenericUI, any specified value is ignored.
	Kind *DataConnectorKind
...
// ConnectivityCriterion - The criteria by which we determine whether the connector is connected or not.
...
// ConnectorDataType - The data type which is created by the connector,
...
// connections.
// The user should have the required permissions(Read\Write, ..) in the specified scope ProviderPermissionsScope against the
// specified resource provider.
type ConnectorDefinitionsResourceProvider struct {
	...
	// REQUIRED; Required permissions for the connector resource provider that define in ResourceProviders.
...
type CustomizableConnectorDefinition struct {
	// CONSTANT; The data connector kind
	// Field has constant value DataConnectorDefinitionKindCustomizable, any specified value is ignored.
...
type Dynamics365CheckRequirements struct {
	// CONSTANT; Describes the kind of connector to be checked.
	// Field has constant value DataConnectorKindDynamics365, any specified value is ignored.
	Kind *DataConnectorKind
...
type EntityAnalytics struct {
	// CONSTANT; The kind of the setting
	// Field has constant value SettingKindEntityAnalytics, any specified value is ignored.
	Kind *SettingKind
...
type EyesOn struct {
	// CONSTANT; The kind of the setting
	// Field has constant value SettingKindEyesOn, any specified value is ignored.
	Kind *SettingKind
...
type FusionAlertRule struct {
	// CONSTANT; The kind of the alert rule
	// Field has constant value AlertRuleKindFusion, any specified value is ignored.
	Kind *AlertRuleKind
...
type GCPAuthModel struct {
	...
	// CONSTANT; The auth type
	// Field has constant value CcpAuthTypeGCP, any specified value is ignored.
	Type *CcpAuthType
...
type GCPDataConnector struct {
	// CONSTANT; The data connector kind
	// Field has constant value DataConnectorKindGCP, any specified value is ignored.
	Kind *DataConnectorKind
...
type GenericBlobSbsAuthModel struct {
	// CONSTANT; The auth type
	// Field has constant value CcpAuthTypeServiceBus, any specified value is ignored.
	Type *CcpAuthType
...
// app (Microsoft Security DevOps) to access the GitHub account, Then we only need the InstallationId to get the access token
// from https://api.github.com/app/installations/{installId}/access_tokens.
type GitHubAuthModel struct {
	// CONSTANT; The auth type
	// Field has constant value CcpAuthTypeGitHub, any specified value is ignored.
	Type *CcpAuthType
...
type GraphQuery struct {
	// REQUIRED; Gets or sets the base query for the graph.
...
type IoTCheckRequirements struct {
	// CONSTANT; Describes the kind of connector to be checked.
	// Field has constant value DataConnectorKindIOT, any specified value is ignored.
	Kind *DataConnectorKind
...
type JwtAuthModel struct {
	...
	// CONSTANT; The auth type
	// Field has constant value CcpAuthTypeJwtToken, any specified value is ignored.
	Type *CcpAuthType

	// REQUIRED; The user name. If user name and password sent in header request we only need to populate the `value` property
	// with the user name (Same as basic auth). If user name and password sent in body request we need to specify the `Key` and
	// `Value`.
...
type MCASCheckRequirements struct {
	// CONSTANT; Describes the kind of connector to be checked.
	// Field has constant value DataConnectorKindMicrosoftCloudAppSecurity, any specified value is ignored.
	Kind *DataConnectorKind
...
type MDATPCheckRequirements struct {
	// CONSTANT; Describes the kind of connector to be checked.
	// Field has constant value DataConnectorKindMicrosoftDefenderAdvancedThreatProtection, any specified value is ignored.
	Kind *DataConnectorKind
...
type MLBehaviorAnalyticsAlertRule struct {
	// CONSTANT; The kind of the alert rule
	// Field has constant value AlertRuleKindMLBehaviorAnalytics, any specified value is ignored.
	Kind *AlertRuleKind
...
type MSTICheckRequirements struct {
	// CONSTANT; Describes the kind of connector to be checked.
	// Field has constant value DataConnectorKindMicrosoftThreatIntelligence, any specified value is ignored.
	Kind *DataConnectorKind
...
type MTPDataConnector struct {
	// CONSTANT; The data connector kind
	// Field has constant value DataConnectorKindMicrosoftThreatProtection, any specified value is ignored.
	Kind *DataConnectorKind
...
// complex dependencies using a recursive/nested structure. For a single dependency an id/kind/version can be supplied or
...
type MetadataProperties struct {
	...
	// out of the box content and solutions. Can be optionally set for user created content to define dependencies. If an active
	// content item is made from a template, both will have the same contentId.
	ContentID *string
...
type MicrosoftPurviewInformationProtectionCheckRequirements struct {
	// CONSTANT; Describes the kind of connector to be checked.
	// Field has constant value DataConnectorKindMicrosoftPurviewInformationProtection, any specified value is ignored.
	Kind *DataConnectorKind
...
type MicrosoftSecurityIncidentCreationAlertRule struct {
	// CONSTANT; The kind of the alert rule
	// Field has constant value AlertRuleKindMicrosoftSecurityIncidentCreation, any specified value is ignored.
	Kind *AlertRuleKind
...
type NoneAuthModel struct {
	// CONSTANT; The auth type
	// Field has constant value CcpAuthTypeNone, any specified value is ignored.
	Type *CcpAuthType
}
...
type NrtAlertRule struct {
	// CONSTANT; The kind of the alert rule
	// Field has constant value AlertRuleKindNRT, any specified value is ignored.
	Kind *AlertRuleKind
...
type OAuthModel struct {
	...
	// CONSTANT; The auth type
	// Field has constant value CcpAuthTypeOAuth2, any specified value is ignored.
	Type *CcpAuthType
...
type Office365ProjectCheckRequirements struct {
	// CONSTANT; Describes the kind of connector to be checked.
	// Field has constant value DataConnectorKindOffice365Project, any specified value is ignored.
	Kind *DataConnectorKind
...
type OfficeATPCheckRequirements struct {
	// CONSTANT; Describes the kind of connector to be checked.
	// Field has constant value DataConnectorKindOfficeATP, any specified value is ignored.
	Kind *DataConnectorKind
...
type OfficeDataConnector struct {
	// CONSTANT; The data connector kind
	// Field has constant value DataConnectorKindOffice365, any specified value is ignored.
	Kind *DataConnectorKind
...
type OfficeIRMCheckRequirements struct {
	// CONSTANT; Describes the kind of connector to be checked.
	// Field has constant value DataConnectorKindOfficeIRM, any specified value is ignored.
	Kind *DataConnectorKind
...
type OfficePowerBICheckRequirements struct {
	// CONSTANT; Describes the kind of connector to be checked.
	// Field has constant value DataConnectorKindOfficePowerBI, any specified value is ignored.
	Kind *DataConnectorKind
...
type OracleAuthModel struct {
	...
	// CONSTANT; The auth type
	// Field has constant value CcpAuthTypeOracle, any specified value is ignored.
	Type *CcpAuthType
...
type PremiumMicrosoftDefenderForThreatIntelligence struct {
	// CONSTANT; The data connector kind
	// Field has constant value DataConnectorKindPremiumMicrosoftDefenderForThreatIntelligence, any specified value is ignored.
	Kind *DataConnectorKind
...
type PropertyArrayChangedConditionProperties struct {
	// CONSTANT; Field has constant value ConditionTypePropertyArrayChanged, any specified value is ignored.
	ConditionType       *ConditionType
...
type PropertyArrayConditionProperties struct {
	// CONSTANT; Field has constant value ConditionTypePropertyArray, any specified value is ignored.
	ConditionType       *ConditionType
...
type PropertyChangedConditionProperties struct {
	// CONSTANT; Field has constant value ConditionTypePropertyChanged, any specified value is ignored.
	ConditionType       *ConditionType
...
type PropertyConditionProperties struct {
	// CONSTANT; Field has constant value ConditionTypeProperty, any specified value is ignored.
	ConditionType       *ConditionType
...
type PurviewAuditCheckRequirements struct {
	// CONSTANT; Describes the kind of connector to be checked.
	// Field has constant value DataConnectorKindPurviewAudit, any specified value is ignored.
	Kind *DataConnectorKind
...
type RestAPIPollerDataConnector struct {
	// CONSTANT; The data connector kind
	// Field has constant value DataConnectorKindRestAPIPoller, any specified value is ignored.
	Kind *DataConnectorKind
...
type ScheduledAlertRule struct {
	// CONSTANT; The kind of the alert rule
	// Field has constant value AlertRuleKindScheduled, any specified value is ignored.
	Kind *AlertRuleKind
...
type SessionAuthModel struct {
	...
	// CONSTANT; The auth type
	// Field has constant value CcpAuthTypeSession, any specified value is ignored.
	Type *CcpAuthType
...
type TICheckRequirements struct {
	// CONSTANT; Describes the kind of connector to be checked.
	// Field has constant value DataConnectorKindThreatIntelligence, any specified value is ignored.
	Kind *DataConnectorKind
...
type TIObjectCommonProperties struct {
	...
	// from the STIX object (in the 'data' field), and the values are lists of sources that can be prepended to the object ID
	// in order to efficiently locate the target TI object.
...
type ThreatIntelligenceAlertRule struct {
	// CONSTANT; The kind of the alert rule
	// Field has constant value AlertRuleKindThreatIntelligence, any specified value is ignored.
	Kind *AlertRuleKind
...
type ThreatIntelligenceIndicatorModel struct {
	// CONSTANT; Field has constant value ThreatIntelligenceResourceInnerKindIndicator, any specified value is ignored.
...
type TiTaxiiCheckRequirements struct {
	// CONSTANT; Describes the kind of connector to be checked.
	// Field has constant value DataConnectorKindThreatIntelligenceTaxii, any specified value is ignored.
	Kind *DataConnectorKind
...
type Ueba struct {
	// CONSTANT; The kind of the setting
	// Field has constant value SettingKindUeba, any specified value is ignored.
	Kind *SettingKind
...
type WatchlistProperties struct {
	...
	// enable a column with IP addresses to be the designated SearchKey field, then use this field as the key field when joining
	// to other event data by IP address.
