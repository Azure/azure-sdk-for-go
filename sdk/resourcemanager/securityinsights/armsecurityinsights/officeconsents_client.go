...
func (client *OfficeConsentsClient) Delete(ctx context.Context, resourceGroupName string, workspaceName string, consentID string, options *OfficeConsentsClientDeleteOptions) (OfficeConsentsClientDeleteResponse, error) {
	...
	if !runtime.HasStatusCode(httpResp, http.StatusOK, http.StatusNoContent) {
		return OfficeConsentsClientDeleteResponse{}, runtime.NewResponseError(httpResp)
	}
	return OfficeConsentsClientDeleteResponse{}, nil
}

// deleteCreateRequest creates the Delete request.
func (client *OfficeConsentsClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, consentID string, _ *OfficeConsentsClientDeleteOptions) (*policy.Request, error) {
...
func (client *OfficeConsentsClient) getCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, consentID string, _ *OfficeConsentsClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/officeConsents/{consentId}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *OfficeConsentsClient) getHandleResponse(resp *http.Response, successCodes ...int) (OfficeConsentsClientGetResponse, error) {
...
func (client *OfficeConsentsClient) listCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, nextLink string, _ *OfficeConsentsClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *OfficeConsentsClient) listHandleResponse(resp *http.Response, successCodes ...int) (OfficeConsentsClientListResponse, error) {
