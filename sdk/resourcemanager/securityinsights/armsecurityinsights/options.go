...
// GetRecommendationsClientListOptions contains the optional parameters for the GetRecommendationsClient.List method.
...
// UpdateClientBeginRecommendationOptions contains the optional parameters for the UpdateClient.BeginRecommendation method.
type UpdateClientBeginRecommendationOptions struct {
	// Resumes the LRO from the provided token.
	ResumeToken string
}
