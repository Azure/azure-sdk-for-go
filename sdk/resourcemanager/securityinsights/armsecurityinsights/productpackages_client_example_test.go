...
func ExampleProductPackagesClient_NewListPager() {
	...
	pager := clientFactory.NewProductPackagesClient().NewListPager("myRg", "myWorkspace", nil)
	for pager.More() {
		...
		// page = armsecurityinsights.ProductPackagesClientListResponse{
		// 	ProductPackageList: armsecurityinsights.ProductPackageList{
