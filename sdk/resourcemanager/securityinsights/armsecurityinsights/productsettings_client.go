...
func (client *ProductSettingsClient) Delete(ctx context.Context, resourceGroupName string, workspaceName string, settingsName string, options *ProductSettingsClientDeleteOptions) (ProductSettingsClientDeleteResponse, error) {
	...
	if !runtime.HasStatusCode(httpResp, http.StatusOK, http.StatusNoContent) {
		return ProductSettingsClientDeleteResponse{}, runtime.NewResponseError(httpResp)
	}
...
func (client *ProductSettingsClient) getHandleResponse(resp *http.Response, successCodes ...int) (ProductSettingsClientGetResponse, error) {
...
func (client *ProductSettingsClient) listCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, nextLink string, _ *ProductSettingsClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *ProductSettingsClient) listHandleResponse(resp *http.Response, successCodes ...int) (ProductSettingsClientListResponse, error) {
...
func (client *ProductSettingsClient) updateHandleResponse(resp *http.Response, successCodes ...int) (ProductSettingsClientUpdateResponse, error) {
