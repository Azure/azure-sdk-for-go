...
type AutomationRulesClientDeleteResponse struct {
	// Possible types are DeleteResponse, DeleteResponse1
	Value any
}
...
// IncidentsClientListAlertsResponse contains the response from method IncidentsClient.NewListAlertsPager.
type IncidentsClientListAlertsResponse struct {
	// List of incident alerts.
	IncidentAlertList
}

// IncidentsClientListBookmarksResponse contains the response from method IncidentsClient.NewListBookmarksPager.
...
// SentinelOnboardingStatesClientListResponse contains the response from method SentinelOnboardingStatesClient.NewListPager.
