...
func (client *SentinelOnboardingStatesClient) createCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, sentinelOnboardingStateName string, sentinelOnboardingStateParameter SentinelOnboardingState, _ *SentinelOnboardingStatesClientCreateOptions) (*policy.Request, error) {
	...
	if err := runtime.MarshalAsJSON(req, sentinelOnboardingStateParameter); err != nil {
		return nil, err
	}
	return req, nil
}
...
// NewListPager - Gets all Sentinel onboarding states
//
// Generated from API version 2025-07-01-preview
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - workspaceName - The name of the monitor workspace.
//   - options - SentinelOnboardingStatesClientListOptions contains the optional parameters for the SentinelOnboardingStatesClient.NewListPager
//     method.
func (client *SentinelOnboardingStatesClient) NewListPager(resourceGroupName string, workspaceName string, options *SentinelOnboardingStatesClientListOptions) *runtime.Pager[SentinelOnboardingStatesClientListResponse] {
	return runtime.NewPager(runtime.PagingHandler[SentinelOnboardingStatesClientListResponse]{
		More: func(page SentinelOnboardingStatesClientListResponse) bool {
			return false
		},
		Fetcher: func(ctx context.Context, page *SentinelOnboardingStatesClientListResponse) (SentinelOnboardingStatesClientListResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "SentinelOnboardingStatesClient.NewListPager")
