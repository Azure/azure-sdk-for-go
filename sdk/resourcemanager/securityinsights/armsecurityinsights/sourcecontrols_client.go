...
func (client *SourceControlsClient) Create(ctx context.Context, resourceGroupName string, workspaceName string, sourceControlID string, sourceControl SourceControl, options *SourceControlsClientCreateOptions) (SourceControlsClientCreateResponse, error) {
	var err error
	const operationName = "SourceControlsClient.Create"
...
func (client *SourceControlsClient) createHandleResponse(resp *http.Response, successCodes ...int) (SourceControlsClientCreateResponse, error) {
...
func (client *SourceControlsClient) deleteHandleResponse(resp *http.Response, successCodes ...int) (SourceControlsClientDeleteResponse, error) {
...
func (client *SourceControlsClient) Get(ctx context.Context, resourceGroupName string, workspaceName string, sourceControlID string, options *SourceControlsClientGetOptions) (SourceControlsClientGetResponse, error) {
	var err error
	const operationName = "SourceControlsClient.Get"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
...
func (client *SourceControlsClient) getHandleResponse(resp *http.Response, successCodes ...int) (SourceControlsClientGetResponse, error) {
...
func (client *SourceControlsClient) NewListPager(resourceGroupName string, workspaceName string, options *SourceControlsClientListOptions) *runtime.Pager[SourceControlsClientListResponse] {
	return runtime.NewPager(runtime.PagingHandler[SourceControlsClientListResponse]{
		...
		Fetcher: func(ctx context.Context, page *SourceControlsClientListResponse) (SourceControlsClientListResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "SourceControlsClient.NewListPager")
			nextLink := ""
			if page != nil {
...
func (client *SourceControlsClient) listCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, nextLink string, _ *SourceControlsClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *SourceControlsClient) listHandleResponse(resp *http.Response, successCodes ...int) (SourceControlsClientListResponse, error) {
