...
func ExampleThreatIntelligenceIndicatorClient_AppendTags() {
	...
	res, err := clientFactory.NewThreatIntelligenceIndicatorClient().AppendTags(ctx, "myRg", "myWorkspace", "d9cd6f0b-96b9-3984-17cd-a779d1e15a93", armsecurityinsights.ThreatIntelligenceAppendTags{
	...
	// res = armsecurityinsights.ThreatIntelligenceIndicatorClientAppendTagsResponse{
	// }
}
...
func ExampleThreatIntelligenceIndicatorClient_NewQueryIndicatorsPager() {
	...
	for pager.More() {
		...
		// page = armsecurityinsights.ThreatIntelligenceIndicatorClientQueryIndicatorsResponse{
