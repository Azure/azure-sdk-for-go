...
func (client *ThreatIntelligenceIndicatorsClient) listCreateRequest(ctx context.Context, resourceGroupName string, workspaceName string, nextLink string, options *ThreatIntelligenceIndicatorsClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *ThreatIntelligenceIndicatorsClient) listHandleResponse(resp *http.Response, successCodes ...int) (ThreatIntelligenceIndicatorsClientListResponse, error) {
