...
type AutomationRulesClientDeleteResponse struct {
	AutomationRulesClientDeleteResult
	// RawResponse contains the underlying HTTP response.
	RawResponse *http.Response
}

// AutomationRulesClientDeleteResult contains the result from method AutomationRulesClient.Delete.
type AutomationRulesClientDeleteResult struct {
	// Anything
	Interface interface{}
}
...
// AutomationRulesClientManualTriggerPlaybookResponse contains the response from method AutomationRulesClient.ManualTriggerPlaybook.
type AutomationRulesClientManualTriggerPlaybookResponse struct {
	AutomationRulesClientManualTriggerPlaybookResult
	// RawResponse contains the underlying HTTP response.
	RawResponse *http.Response
}

// AutomationRulesClientManualTriggerPlaybookResult contains the result from method AutomationRulesClient.ManualTriggerPlaybook.
type AutomationRulesClientManualTriggerPlaybookResult struct {
	// Anything
	Interface interface{}
}
...
// UnmarshalJSON implements the json.Unmarshaller interface for type ThreatIntelligenceIndicatorClientCreateIndicatorResult.
func (t *ThreatIntelligenceIndicatorClientCreateIndicatorResult) UnmarshalJSON(data []byte) error {
...
// UnmarshalJSON implements the json.Unmarshaller interface for type ThreatIntelligenceIndicatorClientCreateResult.
func (t *ThreatIntelligenceIndicatorClientCreateResult) UnmarshalJSON(data []byte) error {
	res, err := unmarshalThreatIntelligenceInformationClassification(data)
	if err != nil {
		return err
	}
...
func (t *ThreatIntelligenceIndicatorClientGetResult) UnmarshalJSON(data []byte) error {
	res, err := unmarshalThreatIntelligenceInformationClassification(data)
	if err != nil {
		return err
	}
...
func (t *ThreatIntelligenceIndicatorClientReplaceTagsResult) UnmarshalJSON(data []byte) error {
	res, err := unmarshalThreatIntelligenceInformationClassification(data)
	if err != nil {
		return err
	}
