...
func (s *SimplifiedSolutionsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	resultChan := make(chan result, 1)
	go func() {
		var intercepted bool
		var res result
		if simplifiedSolutionsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = simplifiedSolutionsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
func (s *SimplifiedSolutionsServerTransport) dispatchBeginCreate(req *http.Request) (*http.Response, error) {
	...
	if beginCreate == nil {
		const regexStr = `/(?P<scope>[a-zA-Z0-9._~%!$&'()*+,;=:@/-]+)/providers/Microsoft\.Help/simplifiedSolutions/(?P<simplifiedSolutionsResourceName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)`
...
// set this to conditionally intercept incoming requests to SimplifiedSolutionsServerTransport
var simplifiedSolutionsServerTransportInterceptor interface {
