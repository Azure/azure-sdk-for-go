...
type DiscoveryResponse struct {
	// REQUIRED; The SolutionMetadataResource items on this page
...
// type for Solution PUT request. ReplacementKey is the only supported trigger type for Solution PATCH request.
