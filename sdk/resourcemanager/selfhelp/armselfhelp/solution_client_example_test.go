...
func ExampleSolutionClient_WarmUp() {
	...
	_, err = clientFactory.NewSolutionClient().WarmUp(ctx, "subscriptions/mySubscription/resourcegroups/myresourceGroup/providers/Microsoft.KeyVault/vaults/test-keyvault-rp", "SolutionResourceName1", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
}
