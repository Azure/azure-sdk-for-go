...
func (client *TroubleshootersClient) createCreateRequest(ctx context.Context, scope string, troubleshooterName string, createTroubleshooterRequestBody TroubleshooterResource, _ *TroubleshootersClientCreateOptions) (*policy.Request, error) {
...
func (client *TroubleshootersClient) endCreateRequest(ctx context.Context, scope string, troubleshooterName string, _ *TroubleshootersClientEndOptions) (*policy.Request, error) {
...
func (client *TroubleshootersClient) getCreateRequest(ctx context.Context, scope string, troubleshooterName string, _ *TroubleshootersClientGetOptions) (*policy.Request, error) {
	urlPath := "/{scope}/providers/Microsoft.Help/troubleshooters/{troubleshooterName}"
	if scope == "" {
		return nil, errors.New("parameter scope cannot be empty")
	}
...
func (client *TroubleshootersClient) restartCreateRequest(ctx context.Context, scope string, troubleshooterName string, _ *TroubleshootersClientRestartOptions) (*policy.Request, error) {
