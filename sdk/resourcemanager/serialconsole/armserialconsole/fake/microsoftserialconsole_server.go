...
func (m *MicrosoftSerialConsoleServerTransport) dispatchToClientFake(req *http.Request, client string) (*http.Response, error) {
	...
	case "OperationGroupClient":
		initServer(&m.trMu, &m.trOperationGroupServer, func() *OperationGroupServerTransport {
			return NewOperationGroupServerTransport(&m.srv.OperationGroupServer)
		})
		resp, err = m.trOperationGroupServer.Do(req)
