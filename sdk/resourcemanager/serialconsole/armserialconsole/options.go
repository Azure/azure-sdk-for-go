...
// OperationGroupClientDisableConsoleOptions contains the optional parameters for the OperationGroupClient.DisableConsole
// method.
type OperationGroupClientDisableConsoleOptions struct {
	// placeholder for future optional parameters
}

// OperationGroupClientEnableConsoleOptions contains the optional parameters for the OperationGroupClient.EnableConsole method.
type OperationGroupClientEnableConsoleOptions struct {
	// placeholder for future optional parameters
}
