...
func (testsuite *DisasterrecoveryconfigsTestSuite) TestDisasterrecoveryconfig() {
	...
	fmt.Println("Call operation: Namespace_CreateAuthorizationRule")
	namespacesClient, err := armservicebus.NewNamespacesClient(testsuite.subscriptionId, testsuite.cred, testsuite.options)
	testsuite.Require().NoError(err)
	...
	fmt.Println("Call operation: DisasterRecoveryConfig_CheckNameAvailability")
	...
	fmt.Println("Call operation: DisasterRecoveryConfig_Create")
	...
	fmt.Println("Call operation: DisasterRecoveryConfig_Get")
	...
	fmt.Println("Call operation: DisasterRecoveryConfig_List")
	...
	fmt.Println("Call operation: DisasterRecoveryConfig_GetAuthorizationRule")
	...
	fmt.Println("Call operation: DisasterRecoveryConfig_ListAuthorizationRules")
	...
	fmt.Println("Call operation: DisasterRecoveryConfig_ListKeys")
	...
	fmt.Println("Call operation: DisasterRecoveryConfig_FailOver")
