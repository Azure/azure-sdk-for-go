...
type NamespacesServer struct {
	...
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginUpdate func(ctx context.Context, resourceGroupName string, namespaceName string, parameters armservicebus.SBNamespaceUpdateParameters, options *armservicebus.NamespacesClientBeginUpdateOptions) (resp azfake.PollerResponder[armservicebus.NamespacesClientUpdateResponse], errResp azfake.ErrorResponder)
}
...
func NewNamespacesServerTransport(srv *NamespacesServer) *NamespacesServerTransport {
	return &NamespacesServerTransport{
		...
		beginUpdate:                    newTracker[azfake.PollerResponder[armservicebus.NamespacesClientUpdateResponse]](),
	}
}
...
type NamespacesServerTransport struct {
	...
	beginUpdate                    *tracker[azfake.PollerResponder[armservicebus.NamespacesClientUpdateResponse]]
}
