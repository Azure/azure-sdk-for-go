...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "DisasterRecoveryConfigsClient":
		initServer(&s.trMu, &s.trDisasterRecoveryConfigsServer, func() *DisasterRecoveryConfigsServerTransport {
	...
	case "MigrationConfigsClient":
		initServer(&s.trMu, &s.trMigrationConfigsServer, func() *MigrationConfigsServerTransport {
	...
	case "NetworkSecurityPerimeterConfigurationClient":
		initServer(&s.trMu, &s.trNetworkSecurityPerimeterConfigurationServer, func() *NetworkSecurityPerimeterConfigurationServerTransport {
	...
	case "QueuesClient":
		initServer(&s.trMu, &s.trQueuesServer, func() *QueuesServerTransport { return NewQueuesServerTransport(&s.srv.QueuesServer) })
