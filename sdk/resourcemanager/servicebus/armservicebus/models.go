...
type NetworkSecurityPerimeterConfiguration struct {
	...
	// READ-ONLY; The type of the resource. E.g. "Microsoft.ServiceBus/Namespaces" or "Microsoft.ServiceBus/Namespaces/ServiceBus"
	Type *string
}
...
type NetworkSecurityPerimeterConfigurationList struct {
	// A link for the next page of NetworkSecurityPerimeterConfiguration list.
	NextLink *string
