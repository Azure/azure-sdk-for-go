...
// MarshalJSON implements the json.Marshaller interface for type NamespaceFailoverProperties.
func (n NamespaceFailoverProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "properties", n.Properties)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type NamespaceFailoverProperties.
func (n *NamespaceFailoverProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", n, err)
	}
...
func (s *SBNamespaceProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "status":
			...
			delete(rawMsg, key)
		case "updatedAt":
			err = unpopulateTime[datetime.RFC3339](val, "UpdatedAt", &s.UpdatedAt)
			delete(rawMsg, key)
		case "zoneRedundant":
...
func (s *SBQueueProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "accessedAt":
			err = unpopulateTime[datetime.RFC3339](val, "AccessedAt", &s.AccessedAt)
			delete(rawMsg, key)
