...
// BeginCreateOrUpdate - Creates or updates a Service Fabric application type version resource.
//
...
// CreateOrUpdate - Creates or updates a Service Fabric application type version resource.
//
// Create or update a Service Fabric application type version resource with the specified name.
// If the operation fails it returns an *azcore.ResponseError type.
...
// BeginDelete - Deletes a Service Fabric application type version resource.
//
...
// Delete - Deletes a Service Fabric application type version resource.
//
// Delete a Service Fabric application type version resource with the specified name.
// If the operation fails it returns an *azcore.ResponseError type.
...
// Get - Gets a Service Fabric application type version resource.
//
// Get a Service Fabric application type version resource created or in the process of being created in the Service Fabric
...
// NewListPager - Gets the list of application type version resources created in the specified Service Fabric application
// type name resource.
//
// Gets all application type version resources created or in the process of being created in the Service Fabric application
// type name resource.
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - clusterName - The name of the cluster resource.
//   - applicationTypeName - The name of the application type name resource.
...
func (client *ApplicationTypeVersionsClient) NewListPager(resourceGroupName string, clusterName string, applicationTypeName string, options *ApplicationTypeVersionsClientListOptions) *runtime.Pager[ApplicationTypeVersionsClientListResponse] {
	return runtime.NewPager(runtime.PagingHandler[ApplicationTypeVersionsClientListResponse]{
		...
		Fetcher: func(ctx context.Context, page *ApplicationTypeVersionsClientListResponse) (ApplicationTypeVersionsClientListResponse, error) {
			...
			req, err := client.listCreateRequest(ctx, resourceGroupName, clusterName, applicationTypeName, nextLink, options)
			if err != nil {
...
func (client *ApplicationTypeVersionsClient) listCreateRequest(ctx context.Context, resourceGroupName string, clusterName string, applicationTypeName string, nextLink string, _ *ApplicationTypeVersionsClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *ApplicationTypeVersionsClient) listHandleResponse(resp *http.Response, successCodes ...int) (ApplicationTypeVersionsClientListResponse, error) {
