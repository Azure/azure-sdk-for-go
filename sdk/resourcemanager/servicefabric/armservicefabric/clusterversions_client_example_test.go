...
func ExampleClusterVersionsClient_Get() {
	...
	// res = armservicefabric.ClusterVersionsClientGetResponse{
	// 	ClusterCodeVersionsListResult: &armservicefabric.ClusterCodeVersionsListResult{
...
func ExampleClusterVersionsClient_GetByEnvironment() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armservicefabric.ClusterVersionsClientGetByEnvironmentResponse{
	// 	ClusterCodeVersionsListResult: &armservicefabric.ClusterCodeVersionsListResult{
	// 		Value: []*armservicefabric.ClusterCodeVersionsResult{
	// 			{
	// 				Name: to.Ptr("6.1.480.9494"),
...
func ExampleClusterVersionsClient_List() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armservicefabric.ClusterVersionsClientListResponse{
	// 	ClusterCodeVersionsListResult: &armservicefabric.ClusterCodeVersionsListResult{
	// 		Value: []*armservicefabric.ClusterCodeVersionsResult{
	// 			{
	// 				Name: to.Ptr("6.1.480.9494"),
...
func ExampleClusterVersionsClient_ListByEnvironment() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armservicefabric.ClusterVersionsClientListByEnvironmentResponse{
	// 	ClusterCodeVersionsListResult: &armservicefabric.ClusterCodeVersionsListResult{
	// 		Value: []*armservicefabric.ClusterCodeVersionsResult{
	// 			{
	// 				Name: to.Ptr("6.1.480.9494"),
