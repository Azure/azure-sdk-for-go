...
const (
	version20231101Preview string = "2023-11-01-preview"
)
...
const (
	// AddOnFeaturesBackupRestoreService - Add on BackupRestoreService
	AddOnFeaturesBackupRestoreService AddOnFeatures = "BackupRestoreService"
	// AddOnFeaturesDNSService - Add on DnsService
	AddOnFeaturesDNSService AddOnFeatures = "DnsService"
	// AddOnFeaturesRepairManager - Add on RepairManager
	AddOnFeaturesRepairManager AddOnFeatures = "RepairManager"
	// AddOnFeaturesResourceMonitorService - Add on ResourceMonitorService
...
const (
	// ClusterEnvironmentLinux - Linux operating system
	ClusterEnvironmentLinux ClusterEnvironment = "Linux"
	// ClusterEnvironmentWindows - Windows operating system
...
const (
	// ClusterStateAutoScale - Indicates that the ReliabilityLevel of the cluster is being adjusted.
	...
	// ClusterStateEnforcingClusterVersion - Indicates that cluster is on a different version than expected and the cluster is
	...
	// ClusterStateUpdatingInfrastructure - Indicates that the cluster is being upgraded with the latest Service Fabric runtime
	...
	// ClusterStateUpdatingUserCertificate - Indicates that the cluster is being upgraded with the user provided certificate.
	ClusterStateUpdatingUserCertificate ClusterState = "UpdatingUserCertificate"
	// ClusterStateUpdatingUserConfiguration - Indicates that the cluster is being upgraded with the user provided configuration.
	ClusterStateUpdatingUserConfiguration ClusterState = "UpdatingUserConfiguration"
	// ClusterStateUpgradeServiceUnreachable - Indicates that the system service in the cluster is no longer polling the Resource
...
// ClusterVersionsEnvironment - The operating system or environment of the cluster version.
type ClusterVersionsEnvironment string

const (
	// ClusterVersionsEnvironmentLinux - Linux operating system
	ClusterVersionsEnvironmentLinux ClusterVersionsEnvironment = "Linux"
	// ClusterVersionsEnvironmentWindows - Windows operating system
...
const (
	// DurabilityLevelBronze - No privileges. This is the default.
	DurabilityLevelBronze DurabilityLevel = "Bronze"
	// DurabilityLevelGold - The infrastructure jobs can be paused for a duration of 2 hours per UD. Gold durability can be enabled
	// only on full node VM skus like D15_V2, G5 etc.
	DurabilityLevelGold DurabilityLevel = "Gold"
	// DurabilityLevelSilver - The infrastructure jobs can be paused for a duration of 10 minutes per UD.
...
const (
	// ProvisioningStateCanceled - Cluster provisioning was canceled.
	ProvisioningStateCanceled ProvisioningState = "Canceled"
	// ProvisioningStateFailed - Cluster provisioning failed.
	ProvisioningStateFailed ProvisioningState = "Failed"
	// ProvisioningStateSucceeded - Cluster provisioning succeeded.
	ProvisioningStateSucceeded ProvisioningState = "Succeeded"
	// ProvisioningStateUpdating - Cluster is updating.
...
const (
	// ReliabilityLevelBronze - Run the System services with a target replica set count of 3. This should only be used for test
	// clusters.
	ReliabilityLevelBronze ReliabilityLevel = "Bronze"
	// ReliabilityLevelGold - Run the System services with a target replica set count of 7.
	ReliabilityLevelGold ReliabilityLevel = "Gold"
	// ReliabilityLevelNone - Run the System services with a target replica set count of 1. This should only be used for test
	// clusters.
	ReliabilityLevelNone ReliabilityLevel = "None"
	// ReliabilityLevelPlatinum - Run the System services with a target replica set count of 9.
	ReliabilityLevelPlatinum ReliabilityLevel = "Platinum"
	// ReliabilityLevelSilver - Run the System services with a target replica set count of 5.
...
const (
	// StoreNameAddressBook - Static value for AddressBook
	StoreNameAddressBook StoreName = "AddressBook"
	// StoreNameAuthRoot - Static value for AuthRoot
	StoreNameAuthRoot StoreName = "AuthRoot"
	// StoreNameCertificateAuthority - Static value for CertificateAuthority
	StoreNameCertificateAuthority StoreName = "CertificateAuthority"
	// StoreNameDisallowed - Static value for Disallowed
	StoreNameDisallowed StoreName = "Disallowed"
	// StoreNameMy - Static value for My
	StoreNameMy StoreName = "My"
	// StoreNameRoot - Static value for Root
	StoreNameRoot StoreName = "Root"
	// StoreNameTrustedPeople - Static value for TrustedPeople
	StoreNameTrustedPeople StoreName = "TrustedPeople"
	// StoreNameTrustedPublisher - Static value for TrustedPublisher
