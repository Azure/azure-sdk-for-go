...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "ClusterVersionsClient":
		initServer(&s.trMu, &s.trClusterVersionsServer, func() *ClusterVersionsServerTransport {
	...
	case "UnsupportedVMSizesClient":
		initServer(&s.trMu, &s.trUnsupportedVMSizesServer, func() *UnsupportedVMSizesServerTransport {
