...
func (c ClusterProperties) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "upgradePauseEndTimestampUtc", c.UpgradePauseEndTimestampUTC)
	populateTime[datetime.RFC3339](objectMap, "upgradePauseStartTimestampUtc", c.UpgradePauseStartTimestampUTC)
...
func (c *ClusterProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "upgradePauseEndTimestampUtc":
			err = unpopulateTime[datetime.RFC3339](val, "UpgradePauseEndTimestampUTC", &c.UpgradePauseEndTimestampUTC)
			delete(rawMsg, key)
		case "upgradePauseStartTimestampUtc":
			err = unpopulateTime[datetime.RFC3339](val, "UpgradePauseStartTimestampUTC", &c.UpgradePauseStartTimestampUTC)
			delete(rawMsg, key)
		case "upgradeWave":
...
func (s *ServiceResourceProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "servicePlacementPolicies":
			err = unpopulate(val, "ServicePlacementPolicies", &s.ServicePlacementPolicies)
			delete(rawMsg, key)
...
func (s StatefulServiceProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "placementConstraints", s.PlacementConstraints)
	populate(objectMap, "provisioningState", s.ProvisioningState)
	populateTime[datetime.RFC3339](objectMap, "quorumLossWaitDuration", s.QuorumLossWaitDuration)
	populateTime[datetime.RFC3339](objectMap, "replicaRestartWaitDuration", s.ReplicaRestartWaitDuration)
	populate(objectMap, "serviceDnsName", s.ServiceDNSName)
	...
	populate(objectMap, "servicePlacementPolicies", s.ServicePlacementPolicies)
	populate(objectMap, "serviceTypeName", s.ServiceTypeName)
	populateTime[datetime.RFC3339](objectMap, "standByReplicaKeepDuration", s.StandByReplicaKeepDuration)
...
func (s *StatefulServiceProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "quorumLossWaitDuration":
			err = unpopulateTime[datetime.RFC3339](val, "QuorumLossWaitDuration", &s.QuorumLossWaitDuration)
			delete(rawMsg, key)
		case "replicaRestartWaitDuration":
			err = unpopulateTime[datetime.RFC3339](val, "ReplicaRestartWaitDuration", &s.ReplicaRestartWaitDuration)
			delete(rawMsg, key)
		case "serviceDnsName":
			err = unpopulate(val, "ServiceDNSName", &s.ServiceDNSName)
			delete(rawMsg, key)
		...
		case "standByReplicaKeepDuration":
			err = unpopulateTime[datetime.RFC3339](val, "StandByReplicaKeepDuration", &s.StandByReplicaKeepDuration)
			delete(rawMsg, key)
