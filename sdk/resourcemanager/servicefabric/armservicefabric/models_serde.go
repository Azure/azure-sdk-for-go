...
func (c ClusterProperties) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "upgradePauseEndTimestampUtc", c.UpgradePauseEndTimestampUTC, true)
	populateTime[datetime.RFC3339](objectMap, "upgradePauseStartTimestampUtc", c.UpgradePauseStartTimestampUTC, true)
...
func (s StatefulServiceProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "placementConstraints", s.PlacementConstraints)
	populate(objectMap, "provisioningState", s.ProvisioningState)
	populateTime[datetime.RFC3339](objectMap, "quorumLossWaitDuration", s.QuorumLossWaitDuration, true)
	populateTime[datetime.RFC3339](objectMap, "replicaRestartWaitDuration", s.ReplicaRestartWaitDuration, true)
	populate(objectMap, "serviceDnsName", s.ServiceDNSName)
	...
	populate(objectMap, "servicePlacementPolicies", s.ServicePlacementPolicies)
	populate(objectMap, "serviceTypeName", s.ServiceTypeName)
	populateTime[datetime.RFC3339](objectMap, "standByReplicaKeepDuration", s.StandByReplicaKeepDuration, true)
