...
// BeginCreateOrUpdate - Creates or updates a Service Fabric service resource.
//
...
// CreateOrUpdate - Creates or updates a Service Fabric service resource.
//
// Create or update a Service Fabric service resource with the specified name.
// If the operation fails it returns an *azcore.ResponseError type.
...
// BeginDelete - Deletes a Service Fabric service resource.
//
...
// Delete - Deletes a Service Fabric service resource.
//
// Delete a Service Fabric service resource with the specified name.
// If the operation fails it returns an *azcore.ResponseError type.
...
// Get - Gets a Service Fabric service resource.
//
...
func (client *ServicesClient) NewListPager(resourceGroupName string, clusterName string, applicationName string, options *ServicesClientListOptions) *runtime.Pager[ServicesClientListResponse] {
	return runtime.NewPager(runtime.PagingHandler[ServicesClientListResponse]{
		...
		Fetcher: func(ctx context.Context, page *ServicesClientListResponse) (ServicesClientListResponse, error) {
			...
			req, err := client.listCreateRequest(ctx, resourceGroupName, clusterName, applicationName, nextLink, options)
			if err != nil {
...
func (client *ServicesClient) listCreateRequest(ctx context.Context, resourceGroupName string, clusterName string, applicationName string, nextLink string, _ *ServicesClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
// BeginUpdate - Updates a Service Fabric service resource.
//
...
// Update - Updates a Service Fabric service resource.
//
// Update a Service Fabric service resource with the specified name.
// If the operation fails it returns an *azcore.ResponseError type.
