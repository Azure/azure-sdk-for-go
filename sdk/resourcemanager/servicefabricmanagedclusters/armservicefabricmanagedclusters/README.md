...
Install the Azure Servicefabricmanagedclusters module:
...
Azure Servicefabricmanagedclusters module consists of one or more clients. We provide a client factory which could be used to create any client in this module.
...
[open an issue](https://github.com/Azure/azure-sdk-for-go/issues) and assign the `Servicefabricmanagedclusters` label.
