...
// ScaleInPolicyMode - Specifies the scale in policy mode for a node type.
type ScaleInPolicyMode string

const (
	// ScaleInPolicyModeDefault - Default scale in policy mode where the system will choose which nodes to remove when scaling
	// in.
	ScaleInPolicyModeDefault ScaleInPolicyMode = "Default"
	// ScaleInPolicyModeNewestNodeFirst - NewestNodeFirst scale in policy mode where the newest node in the node type will be
	// removed first when scaling in.
	ScaleInPolicyModeNewestNodeFirst ScaleInPolicyMode = "NewestNodeFirst"
	// ScaleInPolicyModeOldestNodeFirst - OldestNodeFirst scale in policy mode where the oldest node in the node type will be
	// removed first when scaling in.
	ScaleInPolicyModeOldestNodeFirst ScaleInPolicyMode = "OldestNodeFirst"
)

// PossibleScaleInPolicyModeValues returns the possible values for the ScaleInPolicyMode const type.
func PossibleScaleInPolicyModeValues() []ScaleInPolicyMode {
	return []ScaleInPolicyMode{
		ScaleInPolicyModeDefault,
		ScaleInPolicyModeNewestNodeFirst,
		ScaleInPolicyModeOldestNodeFirst,
	}
}
