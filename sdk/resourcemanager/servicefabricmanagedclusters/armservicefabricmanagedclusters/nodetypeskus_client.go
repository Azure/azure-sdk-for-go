...
func (client *NodeTypeSKUsClient) NewListPager(resourceGroupName string, clusterName string, nodeTypeName string, options *NodeTypeSKUsClientListOptions) *runtime.Pager[NodeTypeSKUsClientListResponse] {
	return runtime.NewPager(runtime.PagingHandler[NodeTypeSKUsClientListResponse]{
		...
		Fetcher: func(ctx context.Context, page *NodeTypeSKUsClientListResponse) (NodeTypeSKUsClientListResponse, error) {
			...
			req, err := client.listCreateRequest(ctx, resourceGroupName, clusterName, nodeTypeName, nextLink, options)
			if err != nil {
...
func (client *NodeTypeSKUsClient) listCreateRequest(ctx context.Context, resourceGroupName string, clusterName string, nodeTypeName string, nextLink string, _ *NodeTypeSKUsClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *NodeTypeSKUsClient) listHandleResponse(resp *http.Response, successCodes ...int) (NodeTypeSKUsClientListResponse, error) {
