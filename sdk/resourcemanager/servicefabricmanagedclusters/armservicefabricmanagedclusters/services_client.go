...
func (client *ServicesClient) NewListByApplicationsPager(resourceGroupName string, clusterName string, applicationName string, options *ServicesClientListByApplicationsOptions) *runtime.Pager[ServicesClientListByApplicationsResponse] {
	return runtime.NewPager(runtime.PagingHandler[ServicesClientListByApplicationsResponse]{
		...
		Fetcher: func(ctx context.Context, page *ServicesClientListByApplicationsResponse) (ServicesClientListByApplicationsResponse, error) {
			...
			req, err := client.listByApplicationsCreateRequest(ctx, resourceGroupName, clusterName, applicationName, nextLink, options)
			if err != nil {
			...
			return client.listByApplicationsHandleResponse(resp, http.StatusOK)
		},
		Tracer: client.internal.Tracer(),
	})
}
...
func (client *ServicesClient) listByApplicationsCreateRequest(ctx context.Context, resourceGroupName string, clusterName string, applicationName string, nextLink string, _ *ServicesClientListByApplicationsOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *ServicesClient) listByApplicationsHandleResponse(resp *http.Response, successCodes ...int) (ServicesClientListByApplicationsResponse, error) {
