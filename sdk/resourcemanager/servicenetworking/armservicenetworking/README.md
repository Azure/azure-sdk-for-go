...
```go
client, err := armservicenetworking.NewFrontendsInterfaceClient(<subscription ID>, cred, nil)
```
...
client, err := armservicenetworking.NewFrontendsInterfaceClient(<subscription ID>, cred, &options)
```
