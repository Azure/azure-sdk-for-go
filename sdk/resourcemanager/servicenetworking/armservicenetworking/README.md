...
```go
client, err := armservicenetworking.NewAssociationsInterfaceClient(<subscription ID>, cred, nil)
```
...
client, err := armservicenetworking.NewAssociationsInterfaceClient(<subscription ID>, cred, &options)
```
