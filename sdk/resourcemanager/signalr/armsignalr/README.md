...
Azure Signalr modules consist of one or more clients.  We provide a client factory which could be used to create any client in this module.
...
client, err := armsignalr.NewClientFactory(<subscription ID>, cred, &options)
```
