...
// Generated from example definition: 2025-01-01-preview/SignalR_CheckNameAvailability.json
func ExampleClient_CheckNameAvailability() {
	...
	// res = armsignalr.ClientCheckNameAvailabilityResponse{
	// 	NameAvailability: &armsignalr.NameAvailability{
...
// Generated from example definition: 2025-01-01-preview/SignalR_CreateOrUpdate.json
func ExampleClient_BeginCreateOrUpdate() {
	...
	poller, err := clientFactory.NewClient().BeginCreateOrUpdate(ctx, "myResourceGroup", "mySignalRService", armsignalr.ResourceInfo{
		...
		Properties: &armsignalr.Properties{
			...
			Serverless: &armsignalr.ServerlessSettings{
				...
				KeepAliveIntervalInSeconds: to.Ptr[int32](5),
			},
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsignalr.ClientCreateOrUpdateResponse{
	...
	// 		Location: to.Ptr("eastus"),
	// 		Properties: &armsignalr.Properties{
	// 			ApplicationFirewall: &armsignalr.ApplicationFirewallSettings{
	// 				ClientConnectionCountRules: []armsignalr.ClientConnectionCountRuleClassification{
	// 					&armsignalr.ThrottleByJwtSignatureRule{
	// 						Type: to.Ptr(armsignalr.ClientConnectionCountRuleDiscriminatorThrottleByJwtSignatureRule),
	// 						MaxCount: to.Ptr[int32](20),
	// 					},
	// 					&armsignalr.ThrottleByUserIDRule{
	// 						Type: to.Ptr(armsignalr.ClientConnectionCountRuleDiscriminatorThrottleByUserIDRule),
	// 						MaxCount: to.Ptr[int32](20),
	// 					},
	// 					&armsignalr.ThrottleByJwtCustomClaimRule{
	// 						Type: to.Ptr(armsignalr.ClientConnectionCountRuleDiscriminatorThrottleByJwtCustomClaimRule),
	// 						ClaimName: to.Ptr("claimName"),
	// 						MaxCount: to.Ptr[int32](20),
	// 					},
	// 				},
	// 				ClientTrafficControlRules: []armsignalr.ClientTrafficControlRuleClassification{
	// 					&armsignalr.TrafficThrottleByJwtSignatureRule{
	// 						Type: to.Ptr(armsignalr.ClientTrafficControlRuleDiscriminatorTrafficThrottleByJwtSignatureRule),
	// 						AggregationWindowInSeconds: to.Ptr[int32](60),
	// 						MaxInboundMessageBytes: to.Ptr[int64](1073741824),
	// 					},
	// 					&armsignalr.TrafficThrottleByUserIDRule{
	// 						Type: to.Ptr(armsignalr.ClientTrafficControlRuleDiscriminatorTrafficThrottleByUserIDRule),
	// 						AggregationWindowInSeconds: to.Ptr[int32](60),
	// 						MaxInboundMessageBytes: to.Ptr[int64](1073741824),
	// 					},
	// 					&armsignalr.TrafficThrottleByJwtCustomClaimRule{
	// 						Type: to.Ptr(armsignalr.ClientTrafficControlRuleDiscriminatorTrafficThrottleByJwtCustomClaimRule),
	// 						AggregationWindowInSeconds: to.Ptr[int32](60),
	// 						ClaimName: to.Ptr("claimName"),
	// 						MaxInboundMessageBytes: to.Ptr[int64](1073741824),
	// 					},
	...
	// 			RouteSettings: &armsignalr.RouteSettings{
	// 				ConnectionBalanceWeight: to.Ptr[int32](255),
	// 				LatencyWeight: to.Ptr[int32](0),
	// 				ServerBalanceWeight: to.Ptr[int32](255),
	// 			},
...
// Generated from example definition: 2025-01-01-preview/SignalR_Delete.json
func ExampleClient_BeginDelete() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsignalr.ClientDeleteResponse{
	// }
}

// Generated from example definition: 2025-01-01-preview/SignalR_Get.json
func ExampleClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsignalr.ClientGetResponse{
	// 	ResourceInfo: &armsignalr.ResourceInfo{
	// 		Name: to.Ptr("mySignalRService"),
	// 		Type: to.Ptr("Microsoft.SignalRService/SignalR"),
	// 		ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourcegroups/myResourceGroup/providers/Microsoft.SignalRService/SignalR/mySignalRService"),
...
// Generated from example definition: 2025-01-01-preview/SignalR_ListByResourceGroup.json
func ExampleClient_NewListByResourceGroupPager() {
	...
	for pager.More() {
		...
		// page = armsignalr.ClientListByResourceGroupResponse{
...
// Generated from example definition: 2025-01-01-preview/SignalR_ListBySubscription.json
func ExampleClient_NewListBySubscriptionPager() {
	...
	for pager.More() {
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armsignalr.ClientListBySubscriptionResponse{
		// 	ResourceInfoList: armsignalr.ResourceInfoList{
		// 		Value: []*armsignalr.ResourceInfo{
		// 			{
		// 				Name: to.Ptr("mySignalRService"),
...
// Generated from example definition: 2025-01-01-preview/SignalR_ListKeys.json
func ExampleClient_ListKeys() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsignalr.ClientListKeysResponse{
	// 	Keys: &armsignalr.Keys{
	// 	},
	// }
}
...
func ExampleClient_ListReplicaSKUs() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsignalr.ClientListReplicaSKUsResponse{
	// 	SKUList: &armsignalr.SKUList{
...
// Generated from example definition: 2025-01-01-preview/SignalR_ListSkus.json
func ExampleClient_ListSKUs() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsignalr.ClientListSKUsResponse{
	// 	SKUList: &armsignalr.SKUList{
	// 		Value: []*armsignalr.SKU{
	// 			{
	// 				Capacity: &armsignalr.SKUCapacity{
...
// Generated from example definition: 2025-01-01-preview/SignalR_RegenerateKey.json
func ExampleClient_BeginRegenerateKey() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsignalr.ClientRegenerateKeyResponse{
	// 	Keys: &armsignalr.Keys{
	// 	},
	// }
}

// Generated from example definition: 2025-01-01-preview/SignalR_Restart.json
...
// Generated from example definition: 2025-01-01-preview/SignalR_Update.json
func ExampleClient_BeginUpdate() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsignalr.ClientUpdateResponse{
	// 	ResourceInfo: &armsignalr.ResourceInfo{
	// 		Name: to.Ptr("mySignalRService"),
	// 		Type: to.Ptr("Microsoft.SignalRService/SignalR"),
	// 		ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourcegroups/myResourceGroup/providers/Microsoft.SignalRService/SignalR/mySignalRService"),
