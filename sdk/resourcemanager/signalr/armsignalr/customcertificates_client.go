...
func (client *CustomCertificatesClient) listCreateRequest(ctx context.Context, resourceGroupName string, resourceName string, _ *CustomCertificatesClientListOptions) (*policy.Request, error) {
