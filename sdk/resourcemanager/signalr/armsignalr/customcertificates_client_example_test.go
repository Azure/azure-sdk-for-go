...
// Generated from example definition: 2025-01-01-preview/SignalRCustomCertificates_CreateOrUpdate.json
func ExampleCustomCertificatesClient_BeginCreateOrUpdate() {
	...
	// res = armsignalr.CustomCertificatesClientCreateOrUpdateResponse{
...
// Generated from example definition: 2025-01-01-preview/SignalRCustomCertificates_Delete.json
func ExampleCustomCertificatesClient_Delete() {
	...
	res, err := clientFactory.NewCustomCertificatesClient().Delete(ctx, "myResourceGroup", "mySignalRService", "myCert", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsignalr.CustomCertificatesClientDeleteResponse{
	// }
}
...
// Generated from example definition: 2025-01-01-preview/SignalRCustomCertificates_List.json
func ExampleCustomCertificatesClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armsignalr.CustomCertificatesClientListResponse{
		// 	CustomCertificateList: armsignalr.CustomCertificateList{
