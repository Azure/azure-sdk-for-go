...
// Generated from example definition: 2025-01-01-preview/SignalRCustomDomains_CreateOrUpdate.json
...
// Generated from example definition: 2025-01-01-preview/SignalRCustomDomains_Delete.json
func ExampleCustomDomainsClient_BeginDelete() {
	...
	// res = armsignalr.CustomDomainsClientDeleteResponse{
	// }
}

// Generated from example definition: 2025-01-01-preview/SignalRCustomDomains_Get.json
func ExampleCustomDomainsClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsignalr.CustomDomainsClientGetResponse{
	// 	CustomDomain: &armsignalr.CustomDomain{
...
// Generated from example definition: 2025-01-01-preview/SignalRCustomDomains_List.json
func ExampleCustomDomainsClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armsignalr.CustomDomainsClientListResponse{
		// 	CustomDomainList: armsignalr.CustomDomainList{
