...
// The returned ServerFactoryTransport instance is connected to an instance of armsignalr.ClientFactory via the
...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "CustomCertificatesClient":
		initServer(&s.trMu, &s.trCustomCertificatesServer, func() *CustomCertificatesServerTransport {
	...
	case "ReplicaSharedPrivateLinkResourcesClient":
		initServer(&s.trMu, &s.trReplicaSharedPrivateLinkResourcesServer, func() *ReplicaSharedPrivateLinkResourcesServerTransport {
