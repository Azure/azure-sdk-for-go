...
// OperationList - A list of REST API operations supported by an Azure Resource Provider. It contains an URL link to get the
// next set of results.
...
// ResourceInfo - A class representing a resource.
...
type ResourceInfoList struct {
	// REQUIRED; The SignalRResource items on this page
	Value []*ResourceInfo
...
type UpstreamTemplate struct {
	...
	// the template, the value of the Upstream URL is dynamically calculated when the client request comes in.
...
type UsageList struct {
	// REQUIRED; The SignalRUsage items on this page
	Value []*Usage
