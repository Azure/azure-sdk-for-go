...
func ExampleSitesByServiceGroupClient_BeginCreateOrUpdate() {
	...
	poller, err := clientFactory.NewSitesByServiceGroupClient().BeginCreateOrUpdate(ctx, "string", "string", armsitemanager.Site{
	...
	// res = armsitemanager.SitesByServiceGroupClientCreateOrUpdateResponse{
...
func ExampleSitesByServiceGroupClient_Delete() {
	...
	res, err := clientFactory.NewSitesByServiceGroupClient().Delete(ctx, "string", "string", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsitemanager.SitesByServiceGroupClientDeleteResponse{
	// }
}
...
func ExampleSitesByServiceGroupClient_Get() {
	...
	res, err := clientFactory.NewSitesByServiceGroupClient().Get(ctx, "string", "string", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsitemanager.SitesByServiceGroupClientGetResponse{
	// 	Site: &armsitemanager.Site{
	// 		Properties: &armsitemanager.SiteProperties{
	// 			DisplayName: to.Ptr("string"),
	// 			Labels: map[string]*string{
...
func ExampleSitesByServiceGroupClient_Update() {
	...
	res, err := clientFactory.NewSitesByServiceGroupClient().Update(ctx, "string", "string", armsitemanager.SiteUpdate{
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsitemanager.SitesByServiceGroupClientUpdateResponse{
	// 	Site: &armsitemanager.Site{
	// 		Properties: &armsitemanager.SiteProperties{
	// 			DisplayName: to.Ptr("string"),
	// 			Labels: map[string]*string{
