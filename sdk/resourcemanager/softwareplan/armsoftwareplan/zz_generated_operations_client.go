...
func (client *OperationsClient) List(scope string, options *OperationsListOptions) *OperationsListPager {
...
func (client *OperationsClient) listCreateRequest(ctx context.Context, scope string, options *OperationsListOptions) (*policy.Request, error) {
