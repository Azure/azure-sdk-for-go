...
func ExampleApplicationDefinitionsClient_Get() {
	...
	client := armmanagedapplication.NewApplicationDefinitionsClient("<subscription-id>", cred, nil)
...
func ExampleApplicationDefinitionsClient_BeginCreateOrUpdate() {
	...
	poller, err := client.BeginCreateOrUpdate(ctx,
		"<resource-group-name>",
		"<application-definition-name>",
		armmanagedapplication.ApplicationDefinition{
			Properties: &armmanagedapplication.ApplicationDefinitionProperties{
				Description: to.StringPtr("<description>"),
				Authorizations: []*armmanagedapplication.ApplicationAuthorization{
					{
						PrincipalID:      to.StringPtr("<principal-id>"),
						RoleDefinitionID: to.StringPtr("<role-definition-id>"),
					}},
				DisplayName:    to.StringPtr("<display-name>"),
				LockLevel:      armmanagedapplication.ApplicationLockLevelNone.ToPtr(),
...
func ExampleApplicationDefinitionsClient_Update() {
	...
	res, err := client.Update(ctx,
		"<resource-group-name>",
		"<application-definition-name>",
		armmanagedapplication.ApplicationDefinitionPatchable{
