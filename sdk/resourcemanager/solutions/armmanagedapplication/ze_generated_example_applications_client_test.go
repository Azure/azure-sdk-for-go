...
func ExampleApplicationsClient_BeginCreateOrUpdate() {
	...
	poller, err := client.BeginCreateOrUpdate(ctx,
		"<resource-group-name>",
		"<application-name>",
		armmanagedapplication.Application{
			Kind: to.StringPtr("<kind>"),
			Properties: &armmanagedapplication.ApplicationProperties{
...
func ExampleApplicationsClient_Update() {
	...
	res, err := client.Update(ctx,
		"<resource-group-name>",
		"<application-name>",
		&armmanagedapplication.ApplicationsUpdateOptions{Parameters: &armmanagedapplication.ApplicationPatchable{
			Kind: to.StringPtr("<kind>"),
			Properties: &armmanagedapplication.ApplicationProperties{
				ApplicationDefinitionID: to.StringPtr("<application-definition-id>"),
				ManagedResourceGroupID:  to.StringPtr("<managed-resource-group-id>"),
