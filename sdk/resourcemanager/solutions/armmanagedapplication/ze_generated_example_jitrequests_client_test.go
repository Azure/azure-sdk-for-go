...
package armmanagedapplication_test
...
import (
	...
	"github.com/Azure/azure-sdk-for-go/sdk/resourcemanager/solutions/armmanagedapplication"
)
...
func ExampleJitRequestsClient_Get() {
	...
	client := armmanagedapplication.NewJitRequestsClient("<subscription-id>", cred, nil)
...
func ExampleJitRequestsClient_BeginCreateOrUpdate() {
	...
	poller, err := client.BeginCreateOrUpdate(ctx,
		"<resource-group-name>",
		"<jit-request-name>",
		armmanagedapplication.JitRequestDefinition{
			Properties: &armmanagedapplication.JitRequestProperties{
				ApplicationResourceID: to.StringPtr("<application-resource-id>"),
				JitAuthorizationPolicies: []*armmanagedapplication.JitAuthorizationPolicies{
					{
						PrincipalID:      to.StringPtr("<principal-id>"),
						RoleDefinitionID: to.StringPtr("<role-definition-id>"),
					}},
				JitSchedulingPolicy: &armmanagedapplication.JitSchedulingPolicy{
					Type:      armmanagedapplication.JitSchedulingTypeOnce.ToPtr(),
...
func ExampleJitRequestsClient_Update() {
	...
	res, err := client.Update(ctx,
		"<resource-group-name>",
		"<jit-request-name>",
		armmanagedapplication.JitRequestPatchable{
