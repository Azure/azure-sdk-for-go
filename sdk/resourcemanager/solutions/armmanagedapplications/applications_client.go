...
//
// Generated from API version 2023-12-01-preview
//   - applicationID - The ID of the managed application.
//   - parameters - Parameters supplied to create or update a managed application.
...
func (client *ApplicationsClient) updateCreateRequest(ctx context.Context, resourceGroupName string, applicationName string, parameters ApplicationPatchable, _ *ApplicationsClientBeginUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Solutions/applications/{applicationName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *ApplicationsClient) updateByIDCreateRequest(ctx context.Context, applicationID string, parameters ApplicationPatchable, _ *ApplicationsClientBeginUpdateByIDOptions) (*policy.Request, error) {
	urlPath := "/{applicationId}"
	if applicationID == "" {
		return nil, errors.New("parameter applicationID cannot be empty")
	}
