...
func (a *ApplicationServerTransport) Do(req *http.Request) (*http.Response, error) {
	...
	if client := method[:strings.Index(method, ".")]; client != "ApplicationClient" {
		return a.dispatchToClientFake(req, client)
	}
	return a.dispatchToMethodFake(req, method)
}

func (a *ApplicationServerTransport) dispatchToClientFake(req *http.Request, client string) (*http.Response, error) {
	var resp *http.Response
	var err error

	switch client {
	case "ApplicationDefinitionsClient":
		initServer(&a.trMu, &a.trApplicationDefinitionsServer, func() *ApplicationDefinitionsServerTransport {
			return NewApplicationDefinitionsServerTransport(&a.srv.ApplicationDefinitionsServer)
		})
		resp, err = a.trApplicationDefinitionsServer.Do(req)
	case "ApplicationsClient":
		initServer(&a.trMu, &a.trApplicationsServer, func() *ApplicationsServerTransport {
			return NewApplicationsServerTransport(&a.srv.ApplicationsServer)
		})
		resp, err = a.trApplicationsServer.Do(req)
	case "JitRequestsClient":
		initServer(&a.trMu, &a.trJitRequestsServer, func() *JitRequestsServerTransport {
			return NewJitRequestsServerTransport(&a.srv.JitRequestsServer)
		})
		resp, err = a.trJitRequestsServer.Do(req)
	default:
