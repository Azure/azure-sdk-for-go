...
// MarshalJSON implements the json.Marshaller interface for type RegistryPackage.
func (r RegistryPackage) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "offer", r.Offer)
	populate(objectMap, "packageLinks", r.PackageLinks)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type RegistryPackage.
func (r *RegistryPackage) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "offer":
			err = unpopulate(val, "Offer", &r.Offer)
			delete(rawMsg, key)
		case "packageLinks":
			err = unpopulate(val, "PackageLinks", &r.PackageLinks)
			delete(rawMsg, key)
		case "plan":
...
// MarshalJSON implements the json.Marshaller interface for type RegistryPackageLinks.
func (r RegistryPackageLinks) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "createUiDefinitionLink", r.CreateUIDefinitionLink)
	populate(objectMap, "deploymentTemplateLink", r.DeploymentTemplateLink)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type RegistryPackageLinks.
func (r *RegistryPackageLinks) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", r, err)
	}
	for key, val := range rawMsg {
		var err error
		switch key {
		case "createUiDefinitionLink":
			err = unpopulate(val, "CreateUIDefinitionLink", &r.CreateUIDefinitionLink)
			delete(rawMsg, key)
		case "deploymentTemplateLink":
			err = unpopulate(val, "DeploymentTemplateLink", &r.DeploymentTemplateLink)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", r, err)
...
// MarshalJSON implements the json.Marshaller interface for type RegistryPackagePlan.
func (r RegistryPackagePlan) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "offer", r.Offer)
	populate(objectMap, "plan", r.Plan)
	populate(objectMap, "publisher", r.Publisher)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type RegistryPackagePlan.
func (r *RegistryPackagePlan) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", r, err)
	}
