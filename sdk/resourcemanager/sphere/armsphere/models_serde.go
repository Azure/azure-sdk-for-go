...
func (c CertificateProperties) MarshalJSON() ([]byte, error) {
	...
	populateTimeRFC3339(objectMap, "expiryUtc", c.ExpiryUTC)
	populateTimeRFC3339(objectMap, "notBeforeUtc", c.NotBeforeUTC)
	populate(objectMap, "provisioningState", c.ProvisioningState)
...
func (c *CertificateProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "certificate":
			...
			delete(rawMsg, key)
		case "expiryUtc":
				err = unpopulateTimeRFC3339(val, "ExpiryUTC", &c.ExpiryUTC)
			delete(rawMsg, key)
		case "notBeforeUtc":
				err = unpopulateTimeRFC3339(val, "NotBeforeUTC", &c.NotBeforeUTC)
			delete(rawMsg, key)
		case "provisioningState":
				err = unpopulate(val, "ProvisioningState", &c.ProvisioningState)
			delete(rawMsg, key)
...
func (d DeploymentProperties) MarshalJSON() ([]byte, error) {
	...
	populateTimeRFC3339(objectMap, "deploymentDateUtc", d.DeploymentDateUTC)
...
func (d *DeploymentProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "deploymentDateUtc":
				err = unpopulateTimeRFC3339(val, "DeploymentDateUTC", &d.DeploymentDateUTC)
			delete(rawMsg, key)
		case "deploymentId":
...
func (d DeviceInsight) MarshalJSON() ([]byte, error) {
	...
	populateTimeRFC3339(objectMap, "endTimestampUtc", d.EndTimestampUTC)
	...
	populateTimeRFC3339(objectMap, "startTimestampUtc", d.StartTimestampUTC)
	return json.Marshal(objectMap)
}
...
func (d *DeviceInsight) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "endTimestampUtc":
				err = unpopulateTimeRFC3339(val, "EndTimestampUTC", &d.EndTimestampUTC)
			delete(rawMsg, key)
		case "eventCategory":
		...
		case "startTimestampUtc":
				err = unpopulateTimeRFC3339(val, "StartTimestampUTC", &d.StartTimestampUTC)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", d, err)
...
func (d DeviceProperties) MarshalJSON() ([]byte, error) {
	...
	populateTimeRFC3339(objectMap, "lastOsUpdateUtc", d.LastOsUpdateUTC)
	populateTimeRFC3339(objectMap, "lastUpdateRequestUtc", d.LastUpdateRequestUTC)
	populate(objectMap, "provisioningState", d.ProvisioningState)
	return json.Marshal(objectMap)
}
...
func (d *DeviceProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "lastOsUpdateUtc":
				err = unpopulateTimeRFC3339(val, "LastOsUpdateUTC", &d.LastOsUpdateUTC)
			delete(rawMsg, key)
		case "lastUpdateRequestUtc":
				err = unpopulateTimeRFC3339(val, "LastUpdateRequestUTC", &d.LastUpdateRequestUTC)
			delete(rawMsg, key)
		case "provisioningState":
				err = unpopulate(val, "ProvisioningState", &d.ProvisioningState)
			delete(rawMsg, key)
...
// MarshalJSON implements the json.Marshaller interface for type ImageUploadRequestBody.
func (i ImageUploadRequestBody) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "images", i.Images)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ImageUploadRequestBody.
func (i *ImageUploadRequestBody) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", i, err)
	}
...
func (p ProofOfPossessionNonceResponse) MarshalJSON() ([]byte, error) {
	...
	populateTimeRFC3339(objectMap, "expiryUtc", p.ExpiryUTC)
	populateTimeRFC3339(objectMap, "notBeforeUtc", p.NotBeforeUTC)
	populate(objectMap, "provisioningState", p.ProvisioningState)
...
func (p *ProofOfPossessionNonceResponse) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "certificate":
			...
			delete(rawMsg, key)
		case "expiryUtc":
				err = unpopulateTimeRFC3339(val, "ExpiryUTC", &p.ExpiryUTC)
			delete(rawMsg, key)
		case "notBeforeUtc":
				err = unpopulateTimeRFC3339(val, "NotBeforeUTC", &p.NotBeforeUTC)
			delete(rawMsg, key)
		case "provisioningState":
				err = unpopulate(val, "ProvisioningState", &p.ProvisioningState)
			delete(rawMsg, key)
