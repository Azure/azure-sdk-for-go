...
type OperationsServer struct {
	...
	NewListPager func(options *armspringappdiscovery.OperationsClientListOptions) (resp azfake.PagerResponder[armspringappdiscovery.OperationsClientListResponse])
}

// NewOperationsServerTransport creates a new instance of OperationsServerTransport with the provided implementation.
// The returned OperationsServerTransport instance is connected to an instance of armspringappdiscovery.OperationsClient via the
// azcore.ClientOptions.Transporter field in the client's constructor parameters.
func NewOperationsServerTransport(srv *OperationsServer) *OperationsServerTransport {
	return &OperationsServerTransport{
		srv:          srv,
		newListPager: newTracker[azfake.PagerResponder[armspringappdiscovery.OperationsClientListResponse]](),
	}
}
...
type OperationsServerTransport struct {
	...
	newListPager *tracker[azfake.PagerResponder[armspringappdiscovery.OperationsClientListResponse]]
}
...
func (o *OperationsServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armspringappdiscovery.OperationsClientListResponse, createLink func() string) {
