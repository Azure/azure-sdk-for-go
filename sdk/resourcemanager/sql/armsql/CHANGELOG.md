...
- New struct `VulnerabilityAssessmentScanRecordForSQLAutoGenerated`
- New struct `VulnerabilityAssessmentScanRecordForSQLListResult`
- New struct `VulnerabilityAssessmentScanRecordForSQLListResultAutoGenerated`
- New struct `VulnerabilityAssessmentScanRecordForSQLProperties`
- New struct `VulnerabilityAssessmentScanRecordForSQLPropertiesAutoGenerated`
