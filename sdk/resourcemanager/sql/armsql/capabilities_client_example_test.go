...
// Generated from example definition: 2026-08-01-preview/LocationCapabilityListByLocation.json
func ExampleCapabilitiesClient_ListByLocation() {
	...
	res, err := clientFactory.NewCapabilitiesClient().ListByLocation(ctx, "eastus", nil)
	if err != nil {
	...
	// res = armsql.CapabilitiesClientListByLocationResponse{
	// 	LocationCapabilities: armsql.LocationCapabilities{
	// 		Name: to.Ptr("East US"),
	// 		IsZoneResilientProvisioningAllowed: to.Ptr(false),
	// 		Status: to.Ptr(armsql.CapabilityStatusAvailable),
	// 		SupportedJobAgentVersions: []*armsql.JobAgentVersionCapability{
	// 			{
	// 				Name: to.Ptr("1.0"),
	// 				Status: to.Ptr(armsql.CapabilityStatusDefault),
	// 				SupportedEditions: []*armsql.JobAgentEditionCapability{
	// 					{
	// 						Name: to.Ptr("1.0"),
	// 						Status: to.Ptr(armsql.CapabilityStatusDefault),
	// 						SupportedServiceLevelObjectives: []*armsql.JobAgentServiceLevelObjectiveCapability{
	// 							{
	// 								Name: to.Ptr("JA100"),
	// 								SKU: &armsql.SKU{
	// 									Name: to.Ptr("JA100"),
	...
	// 							},
	// 							{
	// 								Reason: to.Ptr("GZRS is available in multi-az regions"),
	// 								Status: to.Ptr(armsql.CapabilityStatusAvailable),
	// 								StorageAccountType: to.Ptr(armsql.StorageCapabilityStorageAccountTypeGZRS),
	// 							},
	// 						},
	// 					},
	// 					{
