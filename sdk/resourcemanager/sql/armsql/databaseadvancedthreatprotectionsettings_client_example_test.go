...
// Generated from example definition: 2025-02-01-preview/DatabaseAdvancedThreatProtectionSettingsCreateMax.json
func ExampleDatabaseAdvancedThreatProtectionSettingsClient_CreateOrUpdate_updateADatabaseSAdvancedThreatProtectionSettingsWithAllParameters() {
	...
	// res = armsql.DatabaseAdvancedThreatProtectionSettingsClientCreateOrUpdateResponse{
	// 	DatabaseAdvancedThreatProtection: armsql.DatabaseAdvancedThreatProtection{
	// 		Name: to.Ptr("Default"),
...
// Generated from example definition: 2025-02-01-preview/DatabaseAdvancedThreatProtectionSettingsCreateMin.json
...
// Generated from example definition: 2025-02-01-preview/DatabaseAdvancedThreatProtectionSettingsGet.json
func ExampleDatabaseAdvancedThreatProtectionSettingsClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsql.DatabaseAdvancedThreatProtectionSettingsClientGetResponse{
	// 	DatabaseAdvancedThreatProtection: armsql.DatabaseAdvancedThreatProtection{
	// 		Name: to.Ptr("Default"),
	// 		Type: to.Ptr("Microsoft.Sql/servers/databases/advancedThreatProtectionSettings"),
	// 		ID: to.Ptr("/subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/threatprotection-4799/providers/Microsoft.Sql/servers/threatprotection-6440/advancedThreatProtectionSettings/Default"),
...
// Generated from example definition: 2025-02-01-preview/DatabaseAdvancedThreatProtectionSettingsListByDatabase.json
func ExampleDatabaseAdvancedThreatProtectionSettingsClient_NewListByDatabasePager() {
	...
	for pager.More() {
		...
		// page = armsql.DatabaseAdvancedThreatProtectionSettingsClientListByDatabaseResponse{
		// 	DatabaseAdvancedThreatProtectionListResult: armsql.DatabaseAdvancedThreatProtectionListResult{
