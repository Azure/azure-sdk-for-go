...
// Generated from example definition: 2025-08-01-preview/DatabaseAutomaticTuningGet.json
func ExampleDatabaseAutomaticTuningClient_Get() {
	...
	clientFactory, err := armsql.NewClientFactory("c3aa9078-0000-0000-0000-e36f151182d7", cred, nil)
	if err != nil {
	...
	// res = armsql.DatabaseAutomaticTuningClientGetResponse{
	// 	DatabaseAutomaticTuning: armsql.DatabaseAutomaticTuning{
	// 		Name: to.Ptr("current"),
...
// Generated from example definition: 2025-08-01-preview/DatabaseAutomaticTuningUpdateMax.json
func ExampleDatabaseAutomaticTuningClient_Update_updatesDatabaseAutomaticTuningSettingsWithAllProperties() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsql.DatabaseAutomaticTuningClientUpdateResponse{
	// 	DatabaseAutomaticTuning: armsql.DatabaseAutomaticTuning{
	// 		Name: to.Ptr("current"),
	// 		Type: to.Ptr("Microsoft.Sql/servers/databases/automaticTuning"),
	// 		ID: to.Ptr("/subscriptions/c3aa9078-0000-0000-0000-e36f151182d7/resourceGroups/default-sql-onebox/providers/Microsoft.Sql/servers/testsvr11/databases/db1/automaticTuning/current"),
...
// Generated from example definition: 2025-08-01-preview/DatabaseAutomaticTuningUpdateMin.json
