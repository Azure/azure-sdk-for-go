...
func (client *DatabaseOperationsClient) Cancel(ctx context.Context, resourceGroupName string, serverName string, databaseName string, operationID string, options *DatabaseOperationsClientCancelOptions) (DatabaseOperationsClientCancelResponse, error) {
	...
	if !runtime.HasStatusCode(httpResp, http.StatusOK) {
		return DatabaseOperationsClientCancelResponse{}, runtime.NewResponseError(httpResp)
	}
	return DatabaseOperationsClientCancelResponse{}, nil
}

// cancelCreateRequest creates the Cancel request.
func (client *DatabaseOperationsClient) cancelCreateRequest(ctx context.Context, resourceGroupName string, serverName string, databaseName string, operationID string, _ *DatabaseOperationsClientCancelOptions) (*policy.Request, error) {
...
func (client *DatabaseOperationsClient) listByDatabaseCreateRequest(ctx context.Context, resourceGroupName string, serverName string, databaseName string, nextLink string, _ *DatabaseOperationsClientListByDatabaseOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *DatabaseOperationsClient) listByDatabaseHandleResponse(resp *http.Response, successCodes ...int) (DatabaseOperationsClientListByDatabaseResponse, error) {
