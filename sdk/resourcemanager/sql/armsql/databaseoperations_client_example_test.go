...
// Generated from example definition: 2025-08-01-preview/CancelDatabaseOperation.json
func ExampleDatabaseOperationsClient_Cancel() {
	...
	res, err := clientFactory.NewDatabaseOperationsClient().Cancel(ctx, "sqlcrudtest-7398", "sqlcrudtest-6661", "testdb", "f779414b-e748-4925-8cfe-c8598f7660ae", nil)
	if err != nil {
	...
	// res = armsql.DatabaseOperationsClientCancelResponse{
	// }
}

// Generated from example definition: 2025-08-01-preview/ListDatabaseOperations.json
func ExampleDatabaseOperationsClient_NewListByDatabasePager() {
	...
	for pager.More() {
		...
		// page = armsql.DatabaseOperationsClientListByDatabaseResponse{
		// 	DatabaseOperationListResult: armsql.DatabaseOperationListResult{
		...
		// 					EstimatedCompletionTime: to.Ptr(time.Date(2023, time.February, 17, 14, 30, 30, 710000000, time.UTC)),
		...
		// 					StartTime: to.Ptr(time.Date(2023, time.February, 13, 6, 25, 23, 670000000, time.UTC)),
		...
		// 					DatabaseName: to.Ptr("testdb"),
		// 					EstimatedCompletionTime: to.Ptr(time.Date(2024, time.September, 27, 12, 44, 33, 953000000, time.UTC)),
		// 					IsCancellable: to.Ptr(true),
		// 					Operation: to.Ptr("UpdateLogicalDatabase"),
		// 					OperationFriendlyName: to.Ptr("ALTER DATABASE"),
		...
		// 					ServerName: to.Ptr("testsvr"),
		// 					StartTime: to.Ptr(time.Date(2024, time.September, 27, 5, 42, 30, 97000000, time.UTC)),
		...
		// 					DatabaseName: to.Ptr("testdb"),
		// 					EstimatedCompletionTime: to.Ptr(time.Date(2024, time.September, 27, 12, 28, 10, 830000000, time.UTC)),
		// 					IsCancellable: to.Ptr(true),
		// 					Operation: to.Ptr("UpdateLogicalDatabase"),
		// 					OperationFriendlyName: to.Ptr("ALTER DATABASE"),
		// 					OperationPhaseDetails: &armsql.PhaseDetails{
		...
		// 					PercentComplete: to.Ptr[int32](50),
		// 					ServerName: to.Ptr("testsvr"),
		// 					StartTime: to.Ptr(time.Date(2024, time.September, 27, 5, 13, 37, 840000000, time.UTC)),
		// 					State: to.Ptr(armsql.ManagementOperationStateInProgress),
		// 				},
		// 			},
		// 			{
		...
		// 					Description: to.Ptr("'UpdateLogicalDatabase' on database 'testdb', Source ServiceLevelObjective 'SQLDB_GP_Gen5_6', target ServiceLevelObjective 'SQLDB_HS_Gen5_6', target database MaxSize '32'GB"),
		// 					DatabaseName: to.Ptr("testdb"),
		// 					EstimatedCompletionTime: to.Ptr(time.Date(2024, time.September, 27, 14, 59, 54, 380000000, time.UTC)),
		// 					IsCancellable: to.Ptr(true),
		// 					Operation: to.Ptr("UpdateLogicalDatabase"),
		// 					OperationFriendlyName: to.Ptr("ALTER DATABASE"),
		// 					OperationPhaseDetails: &armsql.PhaseDetails{
		...
		// 					PercentComplete: to.Ptr[int32](50),
		// 					ServerName: to.Ptr("testsvr"),
		// 					StartTime: to.Ptr(time.Date(2024, time.September, 27, 7, 31, 56, 87000000, time.UTC)),
		// 					State: to.Ptr(armsql.ManagementOperationStateInProgress),
		// 				},
		// 			},
		// 			{
		...
		// 					PercentComplete: to.Ptr[int32](100),
		// 					ServerName: to.Ptr("testsvr"),
		// 					StartTime: to.Ptr(time.Date(2023, time.February, 24, 11, 48, 29, 160000000, time.UTC)),
