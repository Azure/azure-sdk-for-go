...
func (client *DatabaseSchemasClient) Get(ctx context.Context, resourceGroupName string, serverName string, databaseName string, schemaName string, options *DatabaseSchemasClientGetOptions) (DatabaseSchemasClientGetResponse, error) {
	var err error
	const operationName = "DatabaseSchemasClient.Get"
...
func (client *DatabaseSchemasClient) getCreateRequest(ctx context.Context, resourceGroupName string, serverName string, databaseName string, schemaName string, _ *DatabaseSchemasClientGetOptions) (*policy.Request, error) {
...
func (client *DatabaseSchemasClient) getHandleResponse(resp *http.Response, successCodes ...int) (DatabaseSchemasClientGetResponse, error) {
...
func (client *DatabaseSchemasClient) NewListByDatabasePager(resourceGroupName string, serverName string, databaseName string, options *DatabaseSchemasClientListByDatabaseOptions) *runtime.Pager[DatabaseSchemasClientListByDatabaseResponse] {
	return runtime.NewPager(runtime.PagingHandler[DatabaseSchemasClientListByDatabaseResponse]{
		...
		Fetcher: func(ctx context.Context, page *DatabaseSchemasClientListByDatabaseResponse) (DatabaseSchemasClientListByDatabaseResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "DatabaseSchemasClient.NewListByDatabasePager")
			nextLink := ""
			if page != nil {
...
func (client *DatabaseSchemasClient) listByDatabaseCreateRequest(ctx context.Context, resourceGroupName string, serverName string, databaseName string, nextLink string, options *DatabaseSchemasClientListByDatabaseOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *DatabaseSchemasClient) listByDatabaseHandleResponse(resp *http.Response, successCodes ...int) (DatabaseSchemasClientListByDatabaseResponse, error) {
