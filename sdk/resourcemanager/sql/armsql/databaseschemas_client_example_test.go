...
// Generated from example definition: 2025-08-01-preview/DatabaseSchemaGet.json
...
// Generated from example definition: 2025-08-01-preview/DatabaseSchemaListByDatabase.json
func ExampleDatabaseSchemasClient_NewListByDatabasePager() {
	...
	pager := clientFactory.NewDatabaseSchemasClient().NewListByDatabasePager("myRG", "serverName", "myDatabase", nil)
	for pager.More() {
		...
		// page = armsql.DatabaseSchemasClientListByDatabaseResponse{
