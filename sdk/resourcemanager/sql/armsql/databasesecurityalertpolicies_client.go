...
func (client *DatabaseSecurityAlertPoliciesClient) createOrUpdateHandleResponse(resp *http.Response, successCodes ...int) (DatabaseSecurityAlertPoliciesClientCreateOrUpdateResponse, error) {
...
func (client *DatabaseSecurityAlertPoliciesClient) getCreateRequest(ctx context.Context, resourceGroupName string, serverName string, databaseName string, securityAlertPolicyName SecurityAlertPolicyName, _ *DatabaseSecurityAlertPoliciesClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/databases/{databaseName}/securityAlertPolicies/{securityAlertPolicyName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter subscriptionID cannot be empty")
	}
...
func (client *DatabaseSecurityAlertPoliciesClient) getHandleResponse(resp *http.Response, successCodes ...int) (DatabaseSecurityAlertPoliciesClientGetResponse, error) {
...
func (client *DatabaseSecurityAlertPoliciesClient) listByDatabaseCreateRequest(ctx context.Context, resourceGroupName string, serverName string, databaseName string, nextLink string, _ *DatabaseSecurityAlertPoliciesClientListByDatabaseOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *DatabaseSecurityAlertPoliciesClient) listByDatabaseHandleResponse(resp *http.Response, successCodes ...int) (DatabaseSecurityAlertPoliciesClientListByDatabaseResponse, error) {
