...
func (client *DatabaseTablesClient) getCreateRequest(ctx context.Context, resourceGroupName string, serverName string, databaseName string, schemaName string, tableName string, _ *DatabaseTablesClientGetOptions) (*policy.Request, error) {
...
func (client *DatabaseTablesClient) getHandleResponse(resp *http.Response, successCodes ...int) (DatabaseTablesClientGetResponse, error) {
...
func (client *DatabaseTablesClient) NewListBySchemaPager(resourceGroupName string, serverName string, databaseName string, schemaName string, options *DatabaseTablesClientListBySchemaOptions) *runtime.Pager[DatabaseTablesClientListBySchemaResponse] {
	return runtime.NewPager(runtime.PagingHandler[DatabaseTablesClientListBySchemaResponse]{
		...
		Fetcher: func(ctx context.Context, page *DatabaseTablesClientListBySchemaResponse) (DatabaseTablesClientListBySchemaResponse, error) {
			...
			req, err := client.listBySchemaCreateRequest(ctx, resourceGroupName, serverName, databaseName, schemaName, nextLink, options)
			if err != nil {
...
func (client *DatabaseTablesClient) listBySchemaCreateRequest(ctx context.Context, resourceGroupName string, serverName string, databaseName string, schemaName string, nextLink string, options *DatabaseTablesClientListBySchemaOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *DatabaseTablesClient) listBySchemaHandleResponse(resp *http.Response, successCodes ...int) (DatabaseTablesClientListBySchemaResponse, error) {
