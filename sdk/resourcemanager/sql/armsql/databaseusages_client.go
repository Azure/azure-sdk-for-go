...
func (client *DatabaseUsagesClient) listByDatabaseCreateRequest(ctx context.Context, resourceGroupName string, serverName string, databaseName string, nextLink string, _ *DatabaseUsagesClientListByDatabaseOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *DatabaseUsagesClient) listByDatabaseHandleResponse(resp *http.Response, successCodes ...int) (DatabaseUsagesClientListByDatabaseResponse, error) {
