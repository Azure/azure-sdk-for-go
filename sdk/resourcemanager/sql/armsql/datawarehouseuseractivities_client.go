...
func (client *DataWarehouseUserActivitiesClient) getCreateRequest(ctx context.Context, resourceGroupName string, serverName string, databaseName string, dataWarehouseUserActivityName DataWarehouseUserActivityName, _ *DataWarehouseUserActivitiesClientGetOptions) (*policy.Request, error) {
...
func (client *DataWarehouseUserActivitiesClient) getHandleResponse(resp *http.Response, successCodes ...int) (DataWarehouseUserActivitiesClientGetResponse, error) {
...
func (client *DataWarehouseUserActivitiesClient) listByDatabaseCreateRequest(ctx context.Context, resourceGroupName string, serverName string, databaseName string, nextLink string, _ *DataWarehouseUserActivitiesClientListByDatabaseOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *DataWarehouseUserActivitiesClient) listByDatabaseHandleResponse(resp *http.Response, successCodes ...int) (DataWarehouseUserActivitiesClientListByDatabaseResponse, error) {
