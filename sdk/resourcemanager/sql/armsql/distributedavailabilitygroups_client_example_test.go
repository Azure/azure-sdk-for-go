...
func ExampleDistributedAvailabilityGroupsClient_BeginCreateOrUpdate_createADistributedAvailabilityGroupWithAllProperties() {
	...
	// res = armsql.DistributedAvailabilityGroupsClientCreateOrUpdateResponse{
...
func ExampleDistributedAvailabilityGroupsClient_BeginDelete() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsql.DistributedAvailabilityGroupsClientDeleteResponse{
	// }
}
...
func ExampleDistributedAvailabilityGroupsClient_BeginFailover() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsql.DistributedAvailabilityGroupsClientFailoverResponse{
	// 	DistributedAvailabilityGroup: armsql.DistributedAvailabilityGroup{
	// 		Name: to.Ptr("dag"),
	// 		Type: to.Ptr("Microsoft.Sql/managedInstances/distributedAvailabilityGroups"),
	// 		ID: to.Ptr("/subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/testrg/providers/Microsoft.Sql/managedInstances/testcl/distributedAvailabilityGroups/dag"),
	...
	// 					LastBackupTime: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2025-08-01T00:00:00Z"); return t}()),
	// 					LastCommitLsn: to.Ptr("71000009407900004"),
	// 					LastCommitTime: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2025-08-01T00:00:00Z"); return t}()),
	// 					LastHardenedLsn: to.Ptr("71000009408100001"),
	// 					LastHardenedTime: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2025-08-01T00:00:00Z"); return t}()),
	// 					LastReceivedLsn: to.Ptr("71000009407900001"),
	// 					LastReceivedTime: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2025-08-01T00:00:00Z"); return t}()),
...
func ExampleDistributedAvailabilityGroupsClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsql.DistributedAvailabilityGroupsClientGetResponse{
	// 	DistributedAvailabilityGroup: armsql.DistributedAvailabilityGroup{
	// 		Name: to.Ptr("dag"),
	// 		Type: to.Ptr("Microsoft.Sql/managedInstances/distributedAvailabilityGroups"),
	// 		ID: to.Ptr("/subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/testrg/providers/Microsoft.Sql/managedInstances/testcl/distributedAvailabilityGroups/dag"),
...
func ExampleDistributedAvailabilityGroupsClient_NewListByInstancePager() {
	...
	for pager.More() {
		...
		// page = armsql.DistributedAvailabilityGroupsClientListByInstanceResponse{
		// 	DistributedAvailabilityGroupsListResult: armsql.DistributedAvailabilityGroupsListResult{
		...
		// 							InstanceSendReplicationLagSeconds: to.Ptr[int32](1),
		// 							LastBackupLsn: to.Ptr("71000009405700001"),
		// 							LastBackupTime: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2023-08-01T00:00:00Z"); return t}()),
		// 							LastCommitLsn: to.Ptr("71000009407900004"),
		// 							LastCommitTime: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2023-08-01T00:00:00Z"); return t}()),
		// 							LastHardenedLsn: to.Ptr("71000009408100001"),
		// 							LastHardenedTime: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2023-08-01T00:00:00Z"); return t}()),
		// 							LastReceivedLsn: to.Ptr("71000009407900001"),
		// 							LastReceivedTime: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2023-08-01T00:00:00Z"); return t}()),
		// 							PartnerReplicaID: to.Ptr("8ffa9723-a1ec-4323-b929-c4aedee3894b"),
		// 							ReplicaState: to.Ptr("Catchup"),
		// 							SynchronizationHealth: to.Ptr(armsql.ReplicaSynchronizationHealthHEALTHY),
		// 						},
...
func ExampleDistributedAvailabilityGroupsClient_BeginSetRole() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsql.DistributedAvailabilityGroupsClientSetRoleResponse{
	// 	DistributedAvailabilityGroup: armsql.DistributedAvailabilityGroup{
	// 		Name: to.Ptr("dag"),
	// 		Type: to.Ptr("Microsoft.Sql/managedInstances/distributedAvailabilityGroups"),
	// 		ID: to.Ptr("/subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/testrg/providers/Microsoft.Sql/managedInstances/testcl/distributedAvailabilityGroups/dag"),
...
func ExampleDistributedAvailabilityGroupsClient_BeginUpdate_updateTheDatabasesOfADistributedAvailabilityGroup() {
	...
	// 					ConnectedState: to.Ptr(armsql.ReplicaConnectedStateCONNECTED),
	// 					LastReceivedLsn: to.Ptr("71000009407900001"),
	// 					LastReceivedTime: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2025-08-01T00:00:00.00Z"); return t}()),
	// 					LastCommitLsn: to.Ptr("71000009407900004"),
	// 					LastCommitTime: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2025-08-01T00:00:00.00Z"); return t}()),
	// 					LastHardenedLsn: to.Ptr("71000009408100001"),
	// 					LastHardenedTime: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2025-08-01T00:00:00.00Z"); return t}()),
	// 					LastBackupLsn: to.Ptr("71000009405700001"),
	// 					LastBackupTime: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2025-08-01T00:00:00.00Z"); return t}()),
	// 					InstanceSendReplicationLagSeconds: to.Ptr[int32](1),
	// 					InstanceRedoReplicationLagSeconds: to.Ptr[int32](1),
	// 				},
	// 				{
	...
	// 					LastReceivedTime: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2025-08-01T00:05:00.00Z"); return t}()),
	// 					LastCommitLsn: to.Ptr("72000010508000005"),
	// 					LastCommitTime: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2025-08-01T00:05:00.00Z"); return t}()),
	// 					LastHardenedLsn: to.Ptr("72000010509200002"),
	// 					LastHardenedTime: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2025-08-01T00:05:00.00Z"); return t}()),
	// 					LastBackupLsn: to.Ptr("72000010506800002"),
	// 					LastBackupTime: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2025-08-01T00:05:00.00Z"); return t}()),
