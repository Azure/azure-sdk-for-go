...
// Generated from example definition: 2025-08-01-preview/CancelElasticPoolOperation.json
func ExampleElasticPoolOperationsClient_Cancel() {
	...
	res, err := clientFactory.NewElasticPoolOperationsClient().Cancel(ctx, "sqlcrudtest-7398", "sqlcrudtest-6661", "testpool", "f779414b-e748-4925-8cfe-c8598f7660ae", nil)
	if err != nil {
	...
	// res = armsql.ElasticPoolOperationsClientCancelResponse{
	// }
}

// Generated from example definition: 2025-08-01-preview/ListElasticPoolOperations.json
func ExampleElasticPoolOperationsClient_NewListByElasticPoolPager() {
	...
	for pager.More() {
		...
		// page = armsql.ElasticPoolOperationsClientListByElasticPoolResponse{
		// 	ElasticPoolOperationListResult: armsql.ElasticPoolOperationListResult{
