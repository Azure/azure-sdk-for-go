...
func (client *EndpointCertificatesClient) Get(ctx context.Context, resourceGroupName string, managedInstanceName string, endpointType string, options *EndpointCertificatesClientGetOptions) (EndpointCertificatesClientGetResponse, error) {
	var err error
	const operationName = "EndpointCertificatesClient.Get"
...
func (client *EndpointCertificatesClient) getCreateRequest(ctx context.Context, resourceGroupName string, managedInstanceName string, endpointType string, _ *EndpointCertificatesClientGetOptions) (*policy.Request, error) {
...
func (client *EndpointCertificatesClient) getHandleResponse(resp *http.Response, successCodes ...int) (EndpointCertificatesClientGetResponse, error) {
...
func (client *EndpointCertificatesClient) NewListByInstancePager(resourceGroupName string, managedInstanceName string, options *EndpointCertificatesClientListByInstanceOptions) *runtime.Pager[EndpointCertificatesClientListByInstanceResponse] {
	return runtime.NewPager(runtime.PagingHandler[EndpointCertificatesClientListByInstanceResponse]{
		...
		Fetcher: func(ctx context.Context, page *EndpointCertificatesClientListByInstanceResponse) (EndpointCertificatesClientListByInstanceResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "EndpointCertificatesClient.NewListByInstancePager")
			nextLink := ""
			if page != nil {
...
func (client *EndpointCertificatesClient) listByInstanceCreateRequest(ctx context.Context, resourceGroupName string, managedInstanceName string, nextLink string, _ *EndpointCertificatesClientListByInstanceOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *EndpointCertificatesClient) listByInstanceHandleResponse(resp *http.Response, successCodes ...int) (EndpointCertificatesClientListByInstanceResponse, error) {
