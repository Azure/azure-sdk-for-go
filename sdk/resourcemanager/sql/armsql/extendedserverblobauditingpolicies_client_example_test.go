...
// Generated from example definition: 2025-08-01-preview/ExtendedServerBlobAuditingCreateMax.json
func ExampleExtendedServerBlobAuditingPoliciesClient_BeginCreateOrUpdate_updateAServerSExtendedBlobAuditingPolicyWithAllParameters() {
	...
	// res = armsql.ExtendedServerBlobAuditingPoliciesClientCreateOrUpdateResponse{
	// 	ExtendedServerBlobAuditingPolicy: armsql.ExtendedServerBlobAuditingPolicy{
	// 		Name: to.Ptr("default"),
...
// Generated from example definition: 2025-08-01-preview/ExtendedServerBlobAuditingCreateMin.json
...
// Generated from example definition: 2025-08-01-preview/ExtendedServerBlobAuditingGet.json
func ExampleExtendedServerBlobAuditingPoliciesClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsql.ExtendedServerBlobAuditingPoliciesClientGetResponse{
	// 	ExtendedServerBlobAuditingPolicy: armsql.ExtendedServerBlobAuditingPolicy{
	// 		Name: to.Ptr("default"),
	// 		Type: to.Ptr("Microsoft.Sql/servers/extendedAuditingSettings"),
...
// Generated from example definition: 2025-08-01-preview/ServerExtendedAuditingSettingsList.json
func ExampleExtendedServerBlobAuditingPoliciesClient_NewListByServerPager() {
	...
	for pager.More() {
		...
		// page = armsql.ExtendedServerBlobAuditingPoliciesClientListByServerResponse{
		// 	ExtendedServerBlobAuditingPolicyListResult: armsql.ExtendedServerBlobAuditingPolicyListResult{
