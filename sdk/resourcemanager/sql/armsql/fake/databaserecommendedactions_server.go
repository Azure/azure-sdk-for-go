...
func (d *DatabaseRecommendedActionsServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	resp, err := server.MarshalResponseAsJSON(respContent, server.GetResponse(respr).RecommendedActionAutoGenerated, req)
	if err != nil {
		return nil, err
	}
	return resp, nil
...
func (d *DatabaseRecommendedActionsServerTransport) dispatchListByDatabaseAdvisor(req *http.Request) (*http.Response, error) {
	...
	resp, err := server.MarshalResponseAsJSON(respContent, server.GetResponse(respr).RecommendedActionAutoGeneratedArray, req)
	if err != nil {
		return nil, err
	}
	return resp, nil
...
func (d *DatabaseRecommendedActionsServerTransport) dispatchUpdate(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[armsql.RecommendedActionAutoGenerated](req)
	if err != nil {
		return nil, err
	}
	resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
