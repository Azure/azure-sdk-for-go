...
func (e *ExtendedDatabaseBlobAuditingPoliciesServerTransport) dispatchCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := e.srv.CreateOrUpdate(req.Context(), resourceGroupNameParam, serverNameParam, databaseNameParam, blobAuditingPolicyNameParam, body, nil)
...
func (e *ExtendedDatabaseBlobAuditingPoliciesServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := e.srv.Get(req.Context(), resourceGroupNameParam, serverNameParam, databaseNameParam, blobAuditingPolicyNameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
