...
type ManagedDatabasesServer struct {
	...
	// BeginReevaluateInaccessibleDatabaseState is the fake for method ManagedDatabasesClient.BeginReevaluateInaccessibleDatabaseState
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginReevaluateInaccessibleDatabaseState func(ctx context.Context, resourceGroupName string, managedInstanceName string, databaseName string, options *armsql.ManagedDatabasesClientBeginReevaluateInaccessibleDatabaseStateOptions) (resp azfake.PollerResponder[armsql.ManagedDatabasesClientReevaluateInaccessibleDatabaseStateResponse], errResp azfake.ErrorResponder)
...
func NewManagedDatabasesServerTransport(srv *ManagedDatabasesServer) *ManagedDatabasesServerTransport {
	return &ManagedDatabasesServerTransport{
		...
		beginReevaluateInaccessibleDatabaseState: newTracker[azfake.PollerResponder[armsql.ManagedDatabasesClientReevaluateInaccessibleDatabaseStateResponse]](),
...
type ManagedDatabasesServerTransport struct {
	...
	beginReevaluateInaccessibleDatabaseState *tracker[azfake.PollerResponder[armsql.ManagedDatabasesClientReevaluateInaccessibleDatabaseStateResponse]]
...
func (m *ManagedDatabasesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		if !intercepted {
			...
			case "ManagedDatabasesClient.BeginReevaluateInaccessibleDatabaseState":
				res.resp, res.err = m.dispatchBeginReevaluateInaccessibleDatabaseState(req)
...
func (m *ManagedDatabasesServerTransport) dispatchBeginCancelMove(req *http.Request) (*http.Response, error) {
	...
	if beginCancelMove == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.Sql/managedInstances/(?P<managedInstanceName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/databases/(?P<databaseName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/cancelMove`
...
func (m *ManagedDatabasesServerTransport) dispatchBeginCompleteMove(req *http.Request) (*http.Response, error) {
	...
	if beginCompleteMove == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.Sql/managedInstances/(?P<managedInstanceName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/databases/(?P<databaseName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/completeMove`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 5 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
...
func (m *ManagedDatabasesServerTransport) dispatchBeginCompleteRestore(req *http.Request) (*http.Response, error) {
	...
	if beginCompleteRestore == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.Sql/managedInstances/(?P<managedInstanceName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/databases/(?P<databaseName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/completeRestore`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 5 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
...
func (m *ManagedDatabasesServerTransport) dispatchBeginCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginCreateOrUpdate == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.Sql/managedInstances/(?P<managedInstanceName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/databases/(?P<databaseName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 5 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
...
func (m *ManagedDatabasesServerTransport) dispatchNewListByInstancePager(req *http.Request) (*http.Response, error) {
	...
	if newListByInstancePager == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.Sql/managedInstances/(?P<managedInstanceName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/databases`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 4 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
...
func (m *ManagedDatabasesServerTransport) dispatchNewListInaccessibleByInstancePager(req *http.Request) (*http.Response, error) {
	...
	if newListInaccessibleByInstancePager == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.Sql/managedInstances/(?P<managedInstanceName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/inaccessibleManagedDatabases`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 4 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
...
func (m *ManagedDatabasesServerTransport) dispatchBeginReevaluateInaccessibleDatabaseState(req *http.Request) (*http.Response, error) {
	if m.srv.BeginReevaluateInaccessibleDatabaseState == nil {
		return nil, &nonRetriableError{errors.New("fake for method BeginReevaluateInaccessibleDatabaseState not implemented")}
	}
	beginReevaluateInaccessibleDatabaseState := m.beginReevaluateInaccessibleDatabaseState.get(req)
	if beginReevaluateInaccessibleDatabaseState == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.Sql/managedInstances/(?P<managedInstanceName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/databases/(?P<databaseName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/reevaluateInaccessibleDatabaseState`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 5 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
		...
		respr, errRespr := m.srv.BeginReevaluateInaccessibleDatabaseState(req.Context(), resourceGroupNameParam, managedInstanceNameParam, databaseNameParam, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginReevaluateInaccessibleDatabaseState = &respr
		m.beginReevaluateInaccessibleDatabaseState.add(req, beginReevaluateInaccessibleDatabaseState)
	}

	resp, err := server.PollerResponderNext(beginReevaluateInaccessibleDatabaseState, req)
	if err != nil {
		return nil, err
	}

	if !slices.Contains([]int{http.StatusOK, http.StatusAccepted}, resp.StatusCode) {
		m.beginReevaluateInaccessibleDatabaseState.remove(req)
		return nil, &nonRetriableError{fmt.Errorf("unexpected status code %d. acceptable values are http.StatusOK, http.StatusAccepted", resp.StatusCode)}
	}
	if !server.PollerResponderMore(beginReevaluateInaccessibleDatabaseState) {
		m.beginReevaluateInaccessibleDatabaseState.remove(req)
	}
...
func (m *ManagedDatabasesServerTransport) dispatchBeginStartMove(req *http.Request) (*http.Response, error) {
	...
	if beginStartMove == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.Sql/managedInstances/(?P<managedInstanceName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/databases/(?P<databaseName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/startMove`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 5 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
