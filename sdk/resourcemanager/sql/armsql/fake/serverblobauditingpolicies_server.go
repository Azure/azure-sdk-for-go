...
type ServerBlobAuditingPoliciesServer struct {
	...
	BeginCreateOrUpdate func(ctx context.Context, resourceGroupName string, serverName string, blobAuditingPolicyName armsql.BlobAuditingPolicyName, parameters armsql.ServerBlobAuditingPolicy, options *armsql.ServerBlobAuditingPoliciesClientBeginCreateOrUpdateOptions) (resp azfake.PollerResponder[armsql.ServerBlobAuditingPoliciesClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method ServerBlobAuditingPoliciesClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, serverName string, blobAuditingPolicyName armsql.BlobAuditingPolicyName, options *armsql.ServerBlobAuditingPoliciesClientGetOptions) (resp azfake.Responder[armsql.ServerBlobAuditingPoliciesClientGetResponse], errResp azfake.ErrorResponder)
...
func (s *ServerBlobAuditingPoliciesServerTransport) dispatchBeginCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginCreateOrUpdate == nil {
		...
		respr, errRespr := s.srv.BeginCreateOrUpdate(req.Context(), resourceGroupNameParam, serverNameParam, blobAuditingPolicyNameParam, body, nil)
...
func (s *ServerBlobAuditingPoliciesServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := s.srv.Get(req.Context(), resourceGroupNameParam, serverNameParam, blobAuditingPolicyNameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
