...
func (client *InstanceFailoverGroupsClient) getHandleResponse(resp *http.Response, successCodes ...int) (InstanceFailoverGroupsClientGetResponse, error) {
...
func (client *InstanceFailoverGroupsClient) listByLocationCreateRequest(ctx context.Context, resourceGroupName string, locationName string, nextLink string, _ *InstanceFailoverGroupsClientListByLocationOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *InstanceFailoverGroupsClient) listByLocationHandleResponse(resp *http.Response, successCodes ...int) (InstanceFailoverGroupsClientListByLocationResponse, error) {
