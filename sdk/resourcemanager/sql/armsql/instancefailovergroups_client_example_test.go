...
// Generated from example definition: 2025-08-01-preview/InstanceFailoverGroupCreateOrUpdate.json
func ExampleInstanceFailoverGroupsClient_BeginCreateOrUpdate() {
	...
	// res = armsql.InstanceFailoverGroupsClientCreateOrUpdateResponse{
	// 	InstanceFailoverGroup: armsql.InstanceFailoverGroup{
...
// Generated from example definition: 2025-08-01-preview/InstanceFailoverGroupDelete.json
func ExampleInstanceFailoverGroupsClient_BeginDelete() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsql.InstanceFailoverGroupsClientDeleteResponse{
	// }
}

// Generated from example definition: 2025-08-01-preview/InstanceFailoverGroupFailover.json
func ExampleInstanceFailoverGroupsClient_BeginFailover() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsql.InstanceFailoverGroupsClientFailoverResponse{
	// 	InstanceFailoverGroup: armsql.InstanceFailoverGroup{
	// 		Name: to.Ptr("failover-group-test-3"),
	// 		Type: to.Ptr("Microsoft.Sql/locations/instanceFailoverGroups"),
...
// Generated from example definition: 2025-08-01-preview/InstanceFailoverGroupForceFailoverAllowDataLoss.json
func ExampleInstanceFailoverGroupsClient_BeginForceFailoverAllowDataLoss() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsql.InstanceFailoverGroupsClientForceFailoverAllowDataLossResponse{
	// 	InstanceFailoverGroup: armsql.InstanceFailoverGroup{
	// 		Name: to.Ptr("failover-group-test-3"),
	// 		Type: to.Ptr("Microsoft.Sql/locations/instanceFailoverGroups"),
	// 		ID: to.Ptr("/subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/Default/providers/Microsoft.Sql/locations/JapanWest/instanceFailoverGroups/failover-group-test-3"),
...
// Generated from example definition: 2025-08-01-preview/InstanceFailoverGroupGet.json
func ExampleInstanceFailoverGroupsClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsql.InstanceFailoverGroupsClientGetResponse{
	// 	InstanceFailoverGroup: armsql.InstanceFailoverGroup{
	// 		Name: to.Ptr("failover-group-test-3"),
	// 		Type: to.Ptr("Microsoft.Sql/locations/instanceFailoverGroups"),
	// 		ID: to.Ptr("/subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/Default/providers/Microsoft.Sql/locations/JapanEast/instanceFailoverGroups/failover-group-test-3"),
...
// Generated from example definition: 2025-08-01-preview/InstanceFailoverGroupList.json
func ExampleInstanceFailoverGroupsClient_NewListByLocationPager() {
	...
	for pager.More() {
		...
		// page = armsql.InstanceFailoverGroupsClientListByLocationResponse{
		// 	InstanceFailoverGroupListResult: armsql.InstanceFailoverGroupListResult{
