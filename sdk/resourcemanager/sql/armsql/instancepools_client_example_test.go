...
// Generated from example definition: 2025-08-01-preview/CreateOrUpdateInstancePoolMax.json
func ExampleInstancePoolsClient_BeginCreateOrUpdate_createAnInstancePoolWithAllProperties() {
	...
	// res = armsql.InstancePoolsClientCreateOrUpdateResponse{
...
// Generated from example definition: 2025-08-01-preview/CreateOrUpdateInstancePoolMin.json
...
// Generated from example definition: 2025-08-01-preview/DeleteInstancePool.json
func ExampleInstancePoolsClient_BeginDelete() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsql.InstancePoolsClientDeleteResponse{
	// }
}

// Generated from example definition: 2025-08-01-preview/GetInstancePool.json
func ExampleInstancePoolsClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsql.InstancePoolsClientGetResponse{
	// 	InstancePool: armsql.InstancePool{
	// 		Name: to.Ptr("testIP"),
	// 		Type: to.Ptr("Microsoft.Sql/instancePools"),
	// 		ID: to.Ptr("/subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/group1/providers/Microsoft.Sql/instancePools/testIP"),
...
// Generated from example definition: 2025-08-01-preview/ListInstancePoolsBySubscriptionId.json
func ExampleInstancePoolsClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armsql.InstancePoolsClientListResponse{
		// 	InstancePoolListResult: armsql.InstancePoolListResult{
...
// Generated from example definition: 2025-08-01-preview/ListInstancePoolsByResourceGroup.json
func ExampleInstancePoolsClient_NewListByResourceGroupPager() {
	...
	for pager.More() {
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armsql.InstancePoolsClientListByResourceGroupResponse{
		// 	InstancePoolListResult: armsql.InstancePoolListResult{
		// 		Value: []*armsql.InstancePool{
		// 			{
		// 				Name: to.Ptr("testIP"),
...
// Generated from example definition: 2025-08-01-preview/PatchInstancePool.json
func ExampleInstancePoolsClient_BeginUpdate() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsql.InstancePoolsClientUpdateResponse{
	// 	InstancePool: armsql.InstancePool{
	// 		Name: to.Ptr("testIP"),
	// 		Type: to.Ptr("Microsoft.Sql/instancePools"),
	// 		ID: to.Ptr("/subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/group1/providers/Microsoft.Sql/instancePools/testIP"),
