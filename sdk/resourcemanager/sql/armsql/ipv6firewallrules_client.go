...
func (client *IPv6FirewallRulesClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, serverName string, firewallRuleName string, parameters IPv6FirewallRule, _ *IPv6FirewallRulesClientCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *IPv6FirewallRulesClient) createOrUpdateHandleResponse(resp *http.Response, successCodes ...int) (IPv6FirewallRulesClientCreateOrUpdateResponse, error) {
...
func (client *IPv6FirewallRulesClient) Delete(ctx context.Context, resourceGroupName string, serverName string, firewallRuleName string, options *IPv6FirewallRulesClientDeleteOptions) (IPv6FirewallRulesClientDeleteResponse, error) {
	...
	if !runtime.HasStatusCode(httpResp, http.StatusOK, http.StatusNoContent) {
		return IPv6FirewallRulesClientDeleteResponse{}, runtime.NewResponseError(httpResp)
	}
	return IPv6FirewallRulesClientDeleteResponse{}, nil
}

// deleteCreateRequest creates the Delete request.
func (client *IPv6FirewallRulesClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, serverName string, firewallRuleName string, _ *IPv6FirewallRulesClientDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/ipv6FirewallRules/{firewallRuleName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter subscriptionID cannot be empty")
	}
...
func (client *IPv6FirewallRulesClient) getCreateRequest(ctx context.Context, resourceGroupName string, serverName string, firewallRuleName string, _ *IPv6FirewallRulesClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/ipv6FirewallRules/{firewallRuleName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter subscriptionID cannot be empty")
	}
...
func (client *IPv6FirewallRulesClient) getHandleResponse(resp *http.Response, successCodes ...int) (IPv6FirewallRulesClientGetResponse, error) {
...
func (client *IPv6FirewallRulesClient) listByServerCreateRequest(ctx context.Context, resourceGroupName string, serverName string, nextLink string, _ *IPv6FirewallRulesClientListByServerOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *IPv6FirewallRulesClient) listByServerHandleResponse(resp *http.Response, successCodes ...int) (IPv6FirewallRulesClientListByServerResponse, error) {
