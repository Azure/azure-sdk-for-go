...
func (client *IPv6FirewallRulesClient) listByServerCreateRequest(ctx context.Context, resourceGroupName string, serverName string, _ *IPv6FirewallRulesClientListByServerOptions) (*policy.Request, error) {
