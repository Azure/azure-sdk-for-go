...
func (client *JobCredentialsClient) listByAgentCreateRequest(ctx context.Context, resourceGroupName string, serverName string, jobAgentName string, _ *JobCredentialsClientListByAgentOptions) (*policy.Request, error) {
