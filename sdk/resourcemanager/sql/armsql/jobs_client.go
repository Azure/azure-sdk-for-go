...
func (client *JobsClient) listByAgentCreateRequest(ctx context.Context, resourceGroupName string, serverName string, jobAgentName string, _ *JobsClientListByAgentOptions) (*policy.Request, error) {
