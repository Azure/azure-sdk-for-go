...
// Generated from example definition: 2025-08-01-preview/CreateOrUpdateJobTargetGroupMax.json
func ExampleJobTargetGroupsClient_CreateOrUpdate_createOrUpdateATargetGroupWithAllProperties() {
	...
	// res = armsql.JobTargetGroupsClientCreateOrUpdateResponse{
	// 	JobTargetGroup: armsql.JobTargetGroup{
...
// Generated from example definition: 2025-08-01-preview/CreateOrUpdateJobTargetGroupMin.json
...
// Generated from example definition: 2025-08-01-preview/DeleteJobTargetGroup.json
func ExampleJobTargetGroupsClient_Delete() {
	...
	res, err := clientFactory.NewJobTargetGroupsClient().Delete(ctx, "group1", "server1", "agent1", "targetGroup1", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsql.JobTargetGroupsClientDeleteResponse{
	// }
}

// Generated from example definition: 2025-08-01-preview/GetJobTargetGroup.json
func ExampleJobTargetGroupsClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsql.JobTargetGroupsClientGetResponse{
	// 	JobTargetGroup: armsql.JobTargetGroup{
	// 		Name: to.Ptr("targetGroup1"),
	// 		Type: to.Ptr("Microsoft.Sql/servers/jobAgents/targetGroups"),
	// 		ID: to.Ptr("/subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/group1/providers/Microsoft.Sql/servers/server1/jobAgents/agent1/targetGroups/targetGroup1"),
...
// Generated from example definition: 2025-08-01-preview/ListJobTargetGroups.json
func ExampleJobTargetGroupsClient_NewListByAgentPager() {
	...
	for pager.More() {
		...
		// page = armsql.JobTargetGroupsClientListByAgentResponse{
		// 	JobTargetGroupListResult: armsql.JobTargetGroupListResult{
