...
func (client *LedgerDigestUploadsClient) listByDatabaseCreateRequest(ctx context.Context, resourceGroupName string, serverName string, databaseName string, _ *LedgerDigestUploadsClientListByDatabaseOptions) (*policy.Request, error) {
