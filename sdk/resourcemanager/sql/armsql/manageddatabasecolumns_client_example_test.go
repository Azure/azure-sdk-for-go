...
// Generated from example definition: 2025-08-01-preview/ManagedDatabaseColumnGet.json
func ExampleManagedDatabaseColumnsClient_Get() {
	...
	// res = armsql.ManagedDatabaseColumnsClientGetResponse{
...
// Generated from example definition: 2025-08-01-preview/ManagedColumnsListByDatabaseMax.json
func ExampleManagedDatabaseColumnsClient_NewListByDatabasePager_filterManagedDatabaseColumns() {
	...
	pager := clientFactory.NewManagedDatabaseColumnsClient().NewListByDatabasePager("myRG", "serverName", "myDatabase", &armsql.ManagedDatabaseColumnsClientListByDatabaseOptions{
		Schema: []string{
			"dbo",
		},
		Column: []string{
	...
	for pager.More() {
		...
		// page = armsql.ManagedDatabaseColumnsClientListByDatabaseResponse{
...
// Generated from example definition: 2025-08-01-preview/ManagedColumnsListByDatabaseMin.json
func ExampleManagedDatabaseColumnsClient_NewListByDatabasePager_listManagedDatabaseColumns() {
	...
	pager := clientFactory.NewManagedDatabaseColumnsClient().NewListByDatabasePager("myRG", "serverName", "myDatabase", nil)
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
...
// Generated from example definition: 2025-08-01-preview/ManagedDatabaseColumnListByTable.json
func ExampleManagedDatabaseColumnsClient_NewListByTablePager() {
	...
	pager := clientFactory.NewManagedDatabaseColumnsClient().NewListByTablePager("myRG", "myManagedInstanceName", "myDatabase", "dbo", "table1", nil)
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armsql.ManagedDatabaseColumnsClientListByTableResponse{
		// 	DatabaseColumnListResult: armsql.DatabaseColumnListResult{
		// 		Value: []*armsql.DatabaseColumn{
		// 			{
		// 				Name: to.Ptr("col1"),
