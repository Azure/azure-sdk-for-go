...
// Generated from example definition: 2025-08-01-preview/ManagedDatabaseMoveOperationResultGet.json
func ExampleManagedDatabaseMoveOperationsClient_Get() {
	...
	// res = armsql.ManagedDatabaseMoveOperationsClientGetResponse{
	// 	ManagedDatabaseMoveOperationResult: armsql.ManagedDatabaseMoveOperationResult{
...
// Generated from example definition: 2025-08-01-preview/ManagedDatabaseMoveOperationResultList.json
func ExampleManagedDatabaseMoveOperationsClient_NewListByLocationPager_getsAllManagedDatabaseMoveOperationsForSpecifiedSubscriptionResourceGroupAndLocation() {
	...
	pager := clientFactory.NewManagedDatabaseMoveOperationsClient().NewListByLocationPager("rg1", "westeurope", nil)
	for pager.More() {
		...
		// page = armsql.ManagedDatabaseMoveOperationsClientListByLocationResponse{
		// 	ManagedDatabaseMoveOperationListResult: armsql.ManagedDatabaseMoveOperationListResult{
		...
		// 			},
		// 			{
		// 				Name: to.Ptr("87654321-30a2-43fa-a171-b78695ff32a8"),
		// 				Type: to.Ptr("Microsoft.Sql/locations/managedDatabaseMoveOperationResults"),
		// 				ID: to.Ptr("/subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/rg1/providers/Microsoft.Sql/locations/westeurope/managedDatabaseMoveOperationResults/87654321-30a2-43fa-a171-b78695ff32a8"),
		// 				Properties: &armsql.ManagedDatabaseMoveOperationResultProperties{
		// 					IsCancellable: to.Ptr(true),
		// 					Operation: to.Ptr("StartManagedInstanceDatabaseMove"),
		// 					OperationFriendlyName: to.Ptr("Start Azure SQL Managed Instance database move"),
...
// Generated from example definition: 2025-08-01-preview/ManagedDatabaseMoveOperationResultListLastOperations.json
...
// Generated from example definition: 2025-08-01-preview/ManagedDatabaseMoveOperationResultListMax.json
func ExampleManagedDatabaseMoveOperationsClient_NewListByLocationPager_getsTheLatestManagedDatabaseMoveOperationsForEachDatabaseUnderSpecifiedSubscriptionResourceGroupAndLocationFilteredByOperationType() {
	...
	pager := clientFactory.NewManagedDatabaseMoveOperationsClient().NewListByLocationPager("rg1", "westeurope", &armsql.ManagedDatabaseMoveOperationsClientListByLocationOptions{
