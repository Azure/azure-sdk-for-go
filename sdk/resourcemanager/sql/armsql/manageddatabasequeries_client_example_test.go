...
// Generated from example definition: 2025-08-01-preview/ManagedInstanceQueryGet.json
func ExampleManagedDatabaseQueriesClient_Get() {
	...
	// res = armsql.ManagedDatabaseQueriesClientGetResponse{
	// 	ManagedInstanceQuery: armsql.ManagedInstanceQuery{
	// 		Type: to.Ptr("Microsoft.Sql/managedInstances/databases/queries"),
	// 		ID: to.Ptr("/subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/sqlcrudtest-7398/providers/Microsoft.Sql/managedInstances/sqlcrudtest-4645/databases/database_1/queries/42"),
...
// Generated from example definition: 2025-08-01-preview/ManagedInstanceQueryStatisticsList.json
func ExampleManagedDatabaseQueriesClient_NewListByQueryPager_obtainQueryExecutionStatistics() {
	...
	pager := clientFactory.NewManagedDatabaseQueriesClient().NewListByQueryPager("sqlcrudtest-7398", "sqlcrudtest-4645", "database_1", "42", nil)
	for pager.More() {
		...
		// page = armsql.ManagedDatabaseQueriesClientListByQueryResponse{
		// 	ManagedInstanceQueryStatistics: armsql.ManagedInstanceQueryStatistics{
		// 		Value: []*armsql.QueryStatistics{
		// 			{
		// 				Type: to.Ptr("Microsoft.Sql/managedInstances/databases/queries/statistics"),
		// 				ID: to.Ptr("/subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/sqlcrudtest-7398/providers/Microsoft.Sql/managedInstances/sqlcrudtest-4645/databases/database_1/queries/42/statistics/35"),
...
// Generated from example definition: 2025-08-01-preview/ManagedInstanceQueryStatisticsListMax.json
func ExampleManagedDatabaseQueriesClient_NewListByQueryPager_obtainQueryExecutionStatisticsExampleWithAllRequestParameters() {
	...
	pager := clientFactory.NewManagedDatabaseQueriesClient().NewListByQueryPager("sqlcrudtest-7398", "sqlcrudtest-4645", "database_1", "42", &armsql.ManagedDatabaseQueriesClientListByQueryOptions{
	...
	for pager.More() {
		...
		// 			{
		// 				Type: to.Ptr("Microsoft.Sql/managedInstances/databases/queries/statistics"),
		// 				ID: to.Ptr("/subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/sqlcrudtest-7398/providers/Microsoft.Sql/managedInstances/sqlcrudtest-4645/databases/database_1/queries/42/statistics/28"),
		// 				Properties: &armsql.QueryStatisticsProperties{
		// 					DatabaseName: to.Ptr("db1"),
		// 					EndTime: to.Ptr("03/11/2020 14:00:00"),
		// 					Intervals: []*armsql.QueryMetricInterval{
...
// Generated from example definition: 2025-08-01-preview/ManagedInstanceQueryStatisticsListMin.json
