...
// Generated from example definition: 2025-02-01-preview/ManagedDatabaseSensitivityLabelsRecommendedUpdate.json
func ExampleManagedDatabaseRecommendedSensitivityLabelsClient_Update() {
	...
	res, err := clientFactory.NewManagedDatabaseRecommendedSensitivityLabelsClient().Update(ctx, "myRG", "myManagedInstanceName", "myDatabase", armsql.RecommendedSensitivityLabelUpdateList{
	...
	// res = armsql.ManagedDatabaseRecommendedSensitivityLabelsClientUpdateResponse{
	// }
}
