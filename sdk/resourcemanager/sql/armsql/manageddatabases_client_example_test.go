...
// Generated from example definition: 2025-08-01-preview/ManagedDatabaseCancelMove.json
func ExampleManagedDatabasesClient_BeginCancelMove() {
	...
	// res = armsql.ManagedDatabasesClientCancelMoveResponse{
	// }
}

// Generated from example definition: 2025-08-01-preview/ManagedDatabaseCompleteMove.json
func ExampleManagedDatabasesClient_BeginCompleteMove() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsql.ManagedDatabasesClientCompleteMoveResponse{
	// }
}

// Generated from example definition: 2025-08-01-preview/ManagedDatabaseCompleteExternalRestore.json
func ExampleManagedDatabasesClient_BeginCompleteRestore() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsql.ManagedDatabasesClientCompleteRestoreResponse{
	// }
}

// Generated from example definition: 2025-08-01-preview/CreateManagedDatabaseLedger.json
func ExampleManagedDatabasesClient_BeginCreateOrUpdate_createsANewManagedDatabaseWithLedgerOn() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsql.ManagedDatabasesClientCreateOrUpdateResponse{
...
// Generated from example definition: 2025-08-01-preview/ManagedDatabaseCreateCrossSubscriptionPointInTimeRestore.json
...
// Generated from example definition: 2025-08-01-preview/ManagedDatabaseCreateMax.json
...
// Generated from example definition: 2025-08-01-preview/ManagedDatabaseCreateMin.json
...
// Generated from example definition: 2025-08-01-preview/ManagedDatabaseCreatePointInTimeRestore.json
...
// Generated from example definition: 2025-08-01-preview/ManagedDatabaseCreateRecovery.json
...
// Generated from example definition: 2025-08-01-preview/ManagedDatabaseCreateRestoreExternalBackup.json
...
// Generated from example definition: 2025-08-01-preview/ManagedDatabaseCreateRestoreExternalBackupManagedIdentity.json
...
// Generated from example definition: 2025-08-01-preview/ManagedDatabaseCreateRestoreLtrBackup.json
...
// Generated from example definition: 2025-08-01-preview/ManagedDatabaseDelete.json
func ExampleManagedDatabasesClient_BeginDelete() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsql.ManagedDatabasesClientDeleteResponse{
	// }
}

// Generated from example definition: 2025-08-01-preview/ManagedDatabaseGet.json
func ExampleManagedDatabasesClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsql.ManagedDatabasesClientGetResponse{
	// 	ManagedDatabase: armsql.ManagedDatabase{
	// 		Name: to.Ptr("testdb1"),
	// 		Type: to.Ptr("Microsoft.Sql/managedInstances/databases"),
...
// Generated from example definition: 2025-08-01-preview/ManagedDatabaseListByManagedInstance.json
func ExampleManagedDatabasesClient_NewListByInstancePager() {
	...
	for pager.More() {
		...
		// page = armsql.ManagedDatabasesClientListByInstanceResponse{
		// 	ManagedDatabaseListResult: armsql.ManagedDatabaseListResult{
		...
		// 				Name: to.Ptr("testdb3"),
		// 				Type: to.Ptr("Microsoft.Sql/managedInstances/databases"),
		// 				ID: to.Ptr("/subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/testrg/providers/Microsoft.Sql/managedInstances/testcl/databases/testdb3"),
		// 				Location: to.Ptr("southeastasia"),
		// 				Properties: &armsql.ManagedDatabaseProperties{
		// 					Collation: to.Ptr("SQL_Latin1_General_CP1_CI_AS"),
		// 					CreationDate: to.Ptr(time.Date(2017, time.August, 4, 15, 0, 17, 730000000, time.UTC)),
		...
		// 						InaccessibilityReasonErrorCode: to.Ptr("1"),
		// 						InaccessibilityReasonKind: to.Ptr(armsql.InaccessibilityReasonTransparentDataEncryption),
		// 						InaccessibilityReasonTdeKeyURI: to.Ptr("https://someVault.vault.azure.net/keys/someKey/01234567890123456789012345678901"),
		// 					},
...
// Generated from example definition: 2025-08-01-preview/InaccessibleManagedDatabaseListByManagedInstance.json
func ExampleManagedDatabasesClient_NewListInaccessibleByInstancePager() {
	...
	for pager.More() {
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armsql.ManagedDatabasesClientListInaccessibleByInstanceResponse{
		// 	ManagedDatabaseListResult: armsql.ManagedDatabaseListResult{
		// 		Value: []*armsql.ManagedDatabase{
		// 			{
		// 				Name: to.Ptr("testdb1"),
		...
		// 					ExtendedAccessibilityInfo: &armsql.ManagedDatabaseExtendedAccessibilityInfo{
		// 						InaccessibilityReasonDescription: to.Ptr("Root cause explanation and mitigation action."),
		// 						InaccessibilityReasonErrorCode: to.Ptr("2"),
		// 						InaccessibilityReasonKind: to.Ptr(armsql.InaccessibilityReasonDatabaseReplication),
		// 					},
		// 					Status: to.Ptr(armsql.ManagedDatabaseStatusInaccessible),
		// 				},
		// 			},
...
// Generated from example definition: 2025-08-01-preview/ManagedDatabaseReevaluateInaccessibleDatabaseState.json
func ExampleManagedDatabasesClient_BeginReevaluateInaccessibleDatabaseState() {
	...
	poller, err := clientFactory.NewManagedDatabasesClient().BeginReevaluateInaccessibleDatabaseState(ctx, "Test1", "managedInstance", "managedDatabase", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	res, err := poller.PollUntilDone(ctx, nil)
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsql.ManagedDatabasesClientReevaluateInaccessibleDatabaseStateResponse{
	// 	ManagedDatabase: armsql.ManagedDatabase{
	// 		Name: to.Ptr("testdb1"),
	// 		Type: to.Ptr("Microsoft.Sql/managedInstances/databases"),
	// 		ID: to.Ptr("/subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/testrg/providers/Microsoft.Sql/managedInstances/testcl/databases/testdb1"),
...
// Generated from example definition: 2025-08-01-preview/ManagedDatabaseStartMoveMax.json
func ExampleManagedDatabasesClient_BeginStartMove_startsAManagedDatabaseMoveWithAllOptionalParametersSpecified() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsql.ManagedDatabasesClientStartMoveResponse{
	// }
}

// Generated from example definition: 2025-08-01-preview/ManagedDatabaseStartMoveMin.json
...
// Generated from example definition: 2025-08-01-preview/ManagedDatabaseUpdateMax.json
...
// Generated from example definition: 2025-08-01-preview/ManagedDatabaseUpdateMin.json
