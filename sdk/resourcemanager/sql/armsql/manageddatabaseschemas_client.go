...
func (client *ManagedDatabaseSchemasClient) getCreateRequest(ctx context.Context, resourceGroupName string, managedInstanceName string, databaseName string, schemaName string, _ *ManagedDatabaseSchemasClientGetOptions) (*policy.Request, error) {
...
func (client *ManagedDatabaseSchemasClient) getHandleResponse(resp *http.Response, successCodes ...int) (ManagedDatabaseSchemasClientGetResponse, error) {
...
func (client *ManagedDatabaseSchemasClient) listByDatabaseCreateRequest(ctx context.Context, resourceGroupName string, managedInstanceName string, databaseName string, nextLink string, options *ManagedDatabaseSchemasClientListByDatabaseOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *ManagedDatabaseSchemasClient) listByDatabaseHandleResponse(resp *http.Response, successCodes ...int) (ManagedDatabaseSchemasClientListByDatabaseResponse, error) {
