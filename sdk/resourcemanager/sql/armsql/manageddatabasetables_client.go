...
func (client *ManagedDatabaseTablesClient) getHandleResponse(resp *http.Response, successCodes ...int) (ManagedDatabaseTablesClientGetResponse, error) {
...
func (client *ManagedDatabaseTablesClient) NewListBySchemaPager(resourceGroupName string, managedInstanceName string, databaseName string, schemaName string, options *ManagedDatabaseTablesClientListBySchemaOptions) *runtime.Pager[ManagedDatabaseTablesClientListBySchemaResponse] {
	return runtime.NewPager(runtime.PagingHandler[ManagedDatabaseTablesClientListBySchemaResponse]{
		...
		Fetcher: func(ctx context.Context, page *ManagedDatabaseTablesClientListBySchemaResponse) (ManagedDatabaseTablesClientListBySchemaResponse, error) {
			...
			req, err := client.listBySchemaCreateRequest(ctx, resourceGroupName, managedInstanceName, databaseName, schemaName, nextLink, options)
			if err != nil {
...
func (client *ManagedDatabaseTablesClient) listBySchemaCreateRequest(ctx context.Context, resourceGroupName string, managedInstanceName string, databaseName string, schemaName string, nextLink string, options *ManagedDatabaseTablesClientListBySchemaOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *ManagedDatabaseTablesClient) listBySchemaHandleResponse(resp *http.Response, successCodes ...int) (ManagedDatabaseTablesClientListBySchemaResponse, error) {
