...
// Generated from example definition: 2025-08-01-preview/ManagedTransparentDataEncryptionUpdate.json
func ExampleManagedDatabaseTransparentDataEncryptionClient_CreateOrUpdate() {
	...
	// res = armsql.ManagedDatabaseTransparentDataEncryptionClientCreateOrUpdateResponse{
	// 	ManagedTransparentDataEncryption: armsql.ManagedTransparentDataEncryption{
	// 		Name: to.Ptr("current"),
	// 		Type: to.Ptr("Microsoft.Sql/managedInstances/databases/transparentDataEncryption"),
	// 		ID: to.Ptr("/subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/securitytde-42-rg/providers/Microsoft.Sql/managedInstances/securitytde-42/databases/testdb/transparentDataEncryption/current"),
	// 		Properties: &armsql.ManagedTransparentDataEncryptionProperties{
	// 			State: to.Ptr(armsql.TransparentDataEncryptionStateEnabled),
	// 		},
	// 	},
...
// Generated from example definition: 2025-08-01-preview/ManagedTransparentDataEncryptionGet.json
func ExampleManagedDatabaseTransparentDataEncryptionClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsql.ManagedDatabaseTransparentDataEncryptionClientGetResponse{
	// 	ManagedTransparentDataEncryption: armsql.ManagedTransparentDataEncryption{
	// 		Name: to.Ptr("default"),
	// 		Type: to.Ptr("Microsoft.Sql/managedInstances/databases/transparentDataEncryption"),
...
// Generated from example definition: 2025-08-01-preview/ManagedTransparentDataEncryptionList.json
func ExampleManagedDatabaseTransparentDataEncryptionClient_NewListByDatabasePager() {
	...
	for pager.More() {
		...
		// page = armsql.ManagedDatabaseTransparentDataEncryptionClientListByDatabaseResponse{
		// 	ManagedTransparentDataEncryptionListResult: armsql.ManagedTransparentDataEncryptionListResult{
