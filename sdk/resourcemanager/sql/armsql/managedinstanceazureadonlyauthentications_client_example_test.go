...
// Generated from example definition: 2025-08-01-preview/ManagedInstanceAzureADOnlyAuthCreateOrUpdate.json
func ExampleManagedInstanceAzureADOnlyAuthenticationsClient_BeginCreateOrUpdate() {
	...
	// res = armsql.ManagedInstanceAzureADOnlyAuthenticationsClientCreateOrUpdateResponse{
	// 	ManagedInstanceAzureADOnlyAuthentication: armsql.ManagedInstanceAzureADOnlyAuthentication{
	// 		Name: to.Ptr("Default"),
...
// Generated from example definition: 2025-08-01-preview/ManagedInstanceAzureADOnlyAuthDelete.json
func ExampleManagedInstanceAzureADOnlyAuthenticationsClient_BeginDelete() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsql.ManagedInstanceAzureADOnlyAuthenticationsClientDeleteResponse{
	// }
}

// Generated from example definition: 2025-08-01-preview/ManagedInstanceAzureADOnlyAuthGet.json
func ExampleManagedInstanceAzureADOnlyAuthenticationsClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsql.ManagedInstanceAzureADOnlyAuthenticationsClientGetResponse{
	// 	ManagedInstanceAzureADOnlyAuthentication: armsql.ManagedInstanceAzureADOnlyAuthentication{
	// 		Name: to.Ptr("Default"),
	// 		Type: to.Ptr("Microsoft.Sql/managedInstances/azureadonlyauthentications"),
	// 		ID: to.Ptr("/subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/azureADOnlyAuthentications/providers/Microsoft.Sql/managedInstances/managedInstance/azureadonlyauthentications/default"),
...
// Generated from example definition: 2025-08-01-preview/ManagedInstanceAzureADOnlyAuthListByInstance.json
func ExampleManagedInstanceAzureADOnlyAuthenticationsClient_NewListByInstancePager() {
	...
	for pager.More() {
		...
		// page = armsql.ManagedInstanceAzureADOnlyAuthenticationsClientListByInstanceResponse{
		// 	ManagedInstanceAzureADOnlyAuthListResult: armsql.ManagedInstanceAzureADOnlyAuthListResult{
