...
func (client *ManagedInstanceDtcsClient) getHandleResponse(resp *http.Response, successCodes ...int) (ManagedInstanceDtcsClientGetResponse, error) {
...
func (client *ManagedInstanceDtcsClient) listByManagedInstanceCreateRequest(ctx context.Context, resourceGroupName string, managedInstanceName string, nextLink string, _ *ManagedInstanceDtcsClientListByManagedInstanceOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *ManagedInstanceDtcsClient) listByManagedInstanceHandleResponse(resp *http.Response, successCodes ...int) (ManagedInstanceDtcsClientListByManagedInstanceResponse, error) {
