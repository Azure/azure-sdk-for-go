...
// Generated from example definition: 2025-08-01-preview/ManagedInstanceTdeCertificate.json
func ExampleManagedInstanceTdeCertificatesClient_BeginCreate() {
	...
	clientFactory, err := armsql.NewClientFactory("00000000-0000-0000-0000-000000000001", cred, nil)
	if err != nil {
	...
	// res = armsql.ManagedInstanceTdeCertificatesClientCreateResponse{
	// }
}
