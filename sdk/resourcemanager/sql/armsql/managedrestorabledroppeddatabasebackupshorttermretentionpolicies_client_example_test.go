...
// Generated from example definition: 2025-02-01-preview/CreateManagedShortTermRetentionPolicyRestorableDropped.json
func ExampleManagedRestorableDroppedDatabaseBackupShortTermRetentionPoliciesClient_BeginCreateOrUpdate() {
	...
	// res = armsql.ManagedRestorableDroppedDatabaseBackupShortTermRetentionPoliciesClientCreateOrUpdateResponse{
...
// Generated from example definition: 2025-02-01-preview/GetManagedShortTermRetentionPolicyRestorableDropped.json
func ExampleManagedRestorableDroppedDatabaseBackupShortTermRetentionPoliciesClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsql.ManagedRestorableDroppedDatabaseBackupShortTermRetentionPoliciesClientGetResponse{
	// 	ManagedBackupShortTermRetentionPolicy: armsql.ManagedBackupShortTermRetentionPolicy{
	// 		Name: to.Ptr("default"),
	// 		Type: to.Ptr("Microsoft.Sql/managedInstances/restorableDroppedDatabases/backupShortTermRetentionPolicies"),
...
// Generated from example definition: 2025-02-01-preview/GetListManagedShortTermRetentionPolicyRestorableDropped.json
func ExampleManagedRestorableDroppedDatabaseBackupShortTermRetentionPoliciesClient_NewListByRestorableDroppedDatabasePager() {
	...
	for pager.More() {
		...
		// page = armsql.ManagedRestorableDroppedDatabaseBackupShortTermRetentionPoliciesClientListByRestorableDroppedDatabaseResponse{
...
// Generated from example definition: 2025-02-01-preview/UpdateManagedShortTermRetentionPolicyRestorableDropped.json
func ExampleManagedRestorableDroppedDatabaseBackupShortTermRetentionPoliciesClient_BeginUpdate() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsql.ManagedRestorableDroppedDatabaseBackupShortTermRetentionPoliciesClientUpdateResponse{
	// 	ManagedBackupShortTermRetentionPolicy: armsql.ManagedBackupShortTermRetentionPolicy{
	// 		Name: to.Ptr("default"),
	// 		Type: to.Ptr("Microsoft.Sql/managedInstances/restorableDroppedDatabases/backupShortTermRetentionPolicies"),
	// 		ID: to.Ptr("/subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/resourceGroup/providers/Microsoft.Sql/managedInstances/testsvr/restorableDroppedDatabases/testdb,131403269876900000/backupShortTermRetentionPolicies/default"),
