...
func (c CertificateInfo) MarshalJSON() ([]byte, error) {
	...
	populateDateTimeRFC3339(objectMap, "expiryDate", c.ExpiryDate)
	return json.Marshal(objectMap)
}
...
func (c *CertificateInfo) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "certificateName":
			...
			delete(rawMsg, key)
		case "expiryDate":
			err = unpopulateDateTimeRFC3339(val, "ExpiryDate", &c.ExpiryDate)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", c, err)
...
func (d DistributedAvailabilityGroupDatabase) MarshalJSON() ([]byte, error) {
	...
	populateDateTimeRFC3339(objectMap, "lastBackupTime", d.LastBackupTime)
	populate(objectMap, "lastCommitLsn", d.LastCommitLsn)
	populateDateTimeRFC3339(objectMap, "lastCommitTime", d.LastCommitTime)
	populate(objectMap, "lastHardenedLsn", d.LastHardenedLsn)
	populateDateTimeRFC3339(objectMap, "lastHardenedTime", d.LastHardenedTime)
	populate(objectMap, "lastReceivedLsn", d.LastReceivedLsn)
	populateDateTimeRFC3339(objectMap, "lastReceivedTime", d.LastReceivedTime)
	populate(objectMap, "lastSentLsn", d.LastSentLsn)
	populateDateTimeRFC3339(objectMap, "lastSentTime", d.LastSentTime)
...
func (d *DistributedAvailabilityGroupDatabase) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "lastBackupLsn":
			...
			delete(rawMsg, key)
		case "lastBackupTime":
			err = unpopulateDateTimeRFC3339(val, "LastBackupTime", &d.LastBackupTime)
			delete(rawMsg, key)
		case "lastCommitLsn":
			err = unpopulate(val, "LastCommitLsn", &d.LastCommitLsn)
			delete(rawMsg, key)
		case "lastCommitTime":
			err = unpopulateDateTimeRFC3339(val, "LastCommitTime", &d.LastCommitTime)
			delete(rawMsg, key)
		case "lastHardenedLsn":
			err = unpopulate(val, "LastHardenedLsn", &d.LastHardenedLsn)
			delete(rawMsg, key)
		case "lastHardenedTime":
			err = unpopulateDateTimeRFC3339(val, "LastHardenedTime", &d.LastHardenedTime)
			delete(rawMsg, key)
		case "lastReceivedLsn":
			err = unpopulate(val, "LastReceivedLsn", &d.LastReceivedLsn)
			delete(rawMsg, key)
		case "lastReceivedTime":
			err = unpopulateDateTimeRFC3339(val, "LastReceivedTime", &d.LastReceivedTime)
			delete(rawMsg, key)
		case "lastSentLsn":
			err = unpopulate(val, "LastSentLsn", &d.LastSentLsn)
			delete(rawMsg, key)
		case "lastSentTime":
			err = unpopulateDateTimeRFC3339(val, "LastSentTime", &d.LastSentTime)
			delete(rawMsg, key)
...
// MarshalJSON implements the json.Marshaller interface for type RecommendedActionAutoGenerated.
func (r RecommendedActionAutoGenerated) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "id", r.ID)
	populate(objectMap, "kind", r.Kind)
	populate(objectMap, "location", r.Location)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type RecommendedActionAutoGenerated.
func (r *RecommendedActionAutoGenerated) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", r, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type ServerImportExportOperationResult.
func (s ServerImportExportOperationResult) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "id", s.ID)
	populate(objectMap, "name", s.Name)
	populate(objectMap, "properties", s.Properties)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type ServerImportExportOperationResult.
func (s *ServerImportExportOperationResult) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type ServerImportExportOperationResultProperties.
func (s ServerImportExportOperationResultProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "blobUri", s.BlobURI)
	populate(objectMap, "databaseName", s.DatabaseName)
	populate(objectMap, "errorMessage", s.ErrorMessage)
	populate(objectMap, "lastModifiedTime", s.LastModifiedTime)
	populate(objectMap, "privateEndpointConnections", s.PrivateEndpointConnections)
	populate(objectMap, "queuedTime", s.QueuedTime)
	populate(objectMap, "requestId", s.RequestID)
	populate(objectMap, "requestType", s.RequestType)
	populate(objectMap, "serverName", s.ServerName)
	populate(objectMap, "status", s.Status)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ServerImportExportOperationResultProperties.
func (s *ServerImportExportOperationResultProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "blobUri":
			err = unpopulate(val, "BlobURI", &s.BlobURI)
			delete(rawMsg, key)
		case "databaseName":
		...
		case "errorMessage":
			...
			delete(rawMsg, key)
		case "lastModifiedTime":
			err = unpopulate(val, "LastModifiedTime", &s.LastModifiedTime)
			delete(rawMsg, key)
		case "privateEndpointConnections":
			err = unpopulate(val, "PrivateEndpointConnections", &s.PrivateEndpointConnections)
			delete(rawMsg, key)
		case "queuedTime":
			err = unpopulate(val, "QueuedTime", &s.QueuedTime)
			delete(rawMsg, key)
		case "requestId":
			err = unpopulate(val, "RequestID", &s.RequestID)
			delete(rawMsg, key)
		case "requestType":
			err = unpopulate(val, "RequestType", &s.RequestType)
			delete(rawMsg, key)
		case "serverName":
...
func (u UpsertManagedServerOperationStepWithEstimatesAndDuration) MarshalJSON() ([]byte, error) {
	...
	populateDateTimeRFC3339(objectMap, "stepEndTime", u.StepEndTime)
	populateDateTimeRFC3339(objectMap, "stepStartTime", u.StepStartTime)
...
func (u *UpsertManagedServerOperationStepWithEstimatesAndDuration) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "status":
			...
			delete(rawMsg, key)
		case "stepEndTime":
			err = unpopulateDateTimeRFC3339(val, "StepEndTime", &u.StepEndTime)
			delete(rawMsg, key)
		case "stepStartTime":
			err = unpopulateDateTimeRFC3339(val, "StepStartTime", &u.StepStartTime)
			delete(rawMsg, key)
		case "timeElapsed":
