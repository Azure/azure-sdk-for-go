...
// MarshalJSON implements the json.Marshaller interface for type NetworkIsolationSettingsAutoGenerated.
func (n NetworkIsolationSettingsAutoGenerated) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "sqlServerResourceId", n.SQLServerResourceID)
	populate(objectMap, "storageAccountResourceId", n.StorageAccountResourceID)
	return json.Marshal(objectMap)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type NetworkIsolationSettingsAutoGenerated.
func (n *NetworkIsolationSettingsAutoGenerated) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", n, err)
	}
