...
// InstancePoolOperationsClientGetOptions contains the optional parameters for the InstancePoolOperationsClient.Get method.
type InstancePoolOperationsClientGetOptions struct {
	// placeholder for future optional parameters
}

// InstancePoolOperationsClientListByInstancePoolOptions contains the optional parameters for the InstancePoolOperationsClient.NewListByInstancePoolPager
// method.
type InstancePoolOperationsClientListByInstancePoolOptions struct {
	// placeholder for future optional parameters
}
...
// LongTermRetentionBackupsClientBeginLockTimeBasedImmutabilityByResourceGroupOptions contains the optional parameters for
// the LongTermRetentionBackupsClient.BeginLockTimeBasedImmutabilityByResourceGroup method.
type LongTermRetentionBackupsClientBeginLockTimeBasedImmutabilityByResourceGroupOptions struct {
	// Resumes the long-running operation from the provided token.
	ResumeToken string
}

// LongTermRetentionBackupsClientBeginLockTimeBasedImmutabilityOptions contains the optional parameters for the LongTermRetentionBackupsClient.BeginLockTimeBasedImmutability
// method.
type LongTermRetentionBackupsClientBeginLockTimeBasedImmutabilityOptions struct {
	// Resumes the long-running operation from the provided token.
	ResumeToken string
}

// LongTermRetentionBackupsClientBeginRemoveLegalHoldImmutabilityByResourceGroupOptions contains the optional parameters for
// the LongTermRetentionBackupsClient.BeginRemoveLegalHoldImmutabilityByResourceGroup method.
type LongTermRetentionBackupsClientBeginRemoveLegalHoldImmutabilityByResourceGroupOptions struct {
	// Resumes the long-running operation from the provided token.
	ResumeToken string
}

// LongTermRetentionBackupsClientBeginRemoveLegalHoldImmutabilityOptions contains the optional parameters for the LongTermRetentionBackupsClient.BeginRemoveLegalHoldImmutability
// method.
type LongTermRetentionBackupsClientBeginRemoveLegalHoldImmutabilityOptions struct {
	// Resumes the long-running operation from the provided token.
	ResumeToken string
}

// LongTermRetentionBackupsClientBeginRemoveTimeBasedImmutabilityByResourceGroupOptions contains the optional parameters for
// the LongTermRetentionBackupsClient.BeginRemoveTimeBasedImmutabilityByResourceGroup method.
type LongTermRetentionBackupsClientBeginRemoveTimeBasedImmutabilityByResourceGroupOptions struct {
	// Resumes the long-running operation from the provided token.
	ResumeToken string
}

// LongTermRetentionBackupsClientBeginRemoveTimeBasedImmutabilityOptions contains the optional parameters for the LongTermRetentionBackupsClient.BeginRemoveTimeBasedImmutability
// method.
type LongTermRetentionBackupsClientBeginRemoveTimeBasedImmutabilityOptions struct {
	// Resumes the long-running operation from the provided token.
	ResumeToken string
}

// LongTermRetentionBackupsClientBeginSetLegalHoldImmutabilityByResourceGroupOptions contains the optional parameters for
// the LongTermRetentionBackupsClient.BeginSetLegalHoldImmutabilityByResourceGroup method.
type LongTermRetentionBackupsClientBeginSetLegalHoldImmutabilityByResourceGroupOptions struct {
	// Resumes the long-running operation from the provided token.
	ResumeToken string
}

// LongTermRetentionBackupsClientBeginSetLegalHoldImmutabilityOptions contains the optional parameters for the LongTermRetentionBackupsClient.BeginSetLegalHoldImmutability
// method.
type LongTermRetentionBackupsClientBeginSetLegalHoldImmutabilityOptions struct {
	// Resumes the long-running operation from the provided token.
	ResumeToken string
}
...
// ManagedDatabasesClientBeginReevaluateInaccessibleDatabaseStateOptions contains the optional parameters for the ManagedDatabasesClient.BeginReevaluateInaccessibleDatabaseState
// method.
type ManagedDatabasesClientBeginReevaluateInaccessibleDatabaseStateOptions struct {
	// Resumes the long-running operation from the provided token.
	ResumeToken string
}
...
// ManagedInstancesClientBeginReevaluateInaccessibleDatabaseStateOptions contains the optional parameters for the ManagedInstancesClient.BeginReevaluateInaccessibleDatabaseState
// method.
type ManagedInstancesClientBeginReevaluateInaccessibleDatabaseStateOptions struct {
	// Resumes the long-running operation from the provided token.
	ResumeToken string
}
...
// ManagedInstancesClientBeginValidateAzureKeyVaultEncryptionKeyOptions contains the optional parameters for the ManagedInstancesClient.BeginValidateAzureKeyVaultEncryptionKey
// method.
type ManagedInstancesClientBeginValidateAzureKeyVaultEncryptionKeyOptions struct {
	// Resumes the long-running operation from the provided token.
	ResumeToken string
}
...
// TransparentDataEncryptionsClientBeginResumeOptions contains the optional parameters for the TransparentDataEncryptionsClient.BeginResume
// method.
type TransparentDataEncryptionsClientBeginResumeOptions struct {
	// Resumes the long-running operation from the provided token.
	ResumeToken string
}

// TransparentDataEncryptionsClientBeginSuspendOptions contains the optional parameters for the TransparentDataEncryptionsClient.BeginSuspend
// method.
type TransparentDataEncryptionsClientBeginSuspendOptions struct {
	// Resumes the long-running operation from the provided token.
	ResumeToken string
}
...
// VirtualClustersClientBeginCreateOrUpdateOptions contains the optional parameters for the VirtualClustersClient.BeginCreateOrUpdate
// method.
type VirtualClustersClientBeginCreateOrUpdateOptions struct {
	// Resumes the long-running operation from the provided token.
	ResumeToken string
}
