...
func (client *OutboundFirewallRulesClient) listByServerCreateRequest(ctx context.Context, resourceGroupName string, serverName string, _ *OutboundFirewallRulesClientListByServerOptions) (*policy.Request, error) {
