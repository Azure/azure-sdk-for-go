...
// Generated from example definition: 2026-08-01-preview/PrivateEndpointConnectionUpdate.json
func ExamplePrivateEndpointConnectionsClient_BeginCreateOrUpdate() {
	...
	// res = armsql.PrivateEndpointConnectionsClientCreateOrUpdateResponse{
	// 	PrivateEndpointConnection: armsql.PrivateEndpointConnection{
...
// Generated from example definition: 2026-08-01-preview/PrivateEndpointConnectionDelete.json
func ExamplePrivateEndpointConnectionsClient_BeginDelete() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsql.PrivateEndpointConnectionsClientDeleteResponse{
	// }
}

// Generated from example definition: 2026-08-01-preview/PrivateEndpointConnectionGet.json
func ExamplePrivateEndpointConnectionsClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsql.PrivateEndpointConnectionsClientGetResponse{
	// 	PrivateEndpointConnection: armsql.PrivateEndpointConnection{
	// 		Name: to.Ptr("private-endpoint-connection-name"),
	// 		Type: to.Ptr("Microsoft.Sql/servers/privateEndpointConnections"),
	// 		ID: to.Ptr("/subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/Default/providers/Microsoft.Sql/servers/test-svr/privateEndpointConnections/private-endpoint-connection-name"),
...
// Generated from example definition: 2026-08-01-preview/PrivateEndpointConnectionList.json
func ExamplePrivateEndpointConnectionsClient_NewListByServerPager() {
	...
	for pager.More() {
		...
		// page = armsql.PrivateEndpointConnectionsClientListByServerResponse{
