...
// Generated from example definition: 2025-02-01-preview/PrivateLinkResourcesGet.json
func ExamplePrivateLinkResourcesClient_Get() {
	...
	// res = armsql.PrivateLinkResourcesClientGetResponse{
	// 	PrivateLinkResource: armsql.PrivateLinkResource{
	// 		Name: to.Ptr("plr"),
...
// Generated from example definition: 2025-02-01-preview/PrivateLinkResourcesList.json
func ExamplePrivateLinkResourcesClient_NewListByServerPager() {
	...
	for pager.More() {
		...
		// page = armsql.PrivateLinkResourcesClientListByServerResponse{
		// 	PrivateLinkResourceListResult: armsql.PrivateLinkResourceListResult{
