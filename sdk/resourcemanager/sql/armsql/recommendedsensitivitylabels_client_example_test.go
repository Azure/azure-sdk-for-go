...
// Generated from example definition: 2025-02-01-preview/SensitivityLabelsRecommendedUpdate.json
func ExampleRecommendedSensitivityLabelsClient_Update() {
	...
	res, err := clientFactory.NewRecommendedSensitivityLabelsClient().Update(ctx, "myRG", "myServer", "myDatabase", armsql.RecommendedSensitivityLabelUpdateList{
	...
	// res = armsql.RecommendedSensitivityLabelsClientUpdateResponse{
	// }
}
