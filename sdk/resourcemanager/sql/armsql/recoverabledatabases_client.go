...
func (client *RecoverableDatabasesClient) getHandleResponse(resp *http.Response, successCodes ...int) (RecoverableDatabasesClientGetResponse, error) {
...
func (client *RecoverableDatabasesClient) listByServerCreateRequest(ctx context.Context, resourceGroupName string, serverName string, nextLink string, _ *RecoverableDatabasesClientListByServerOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *RecoverableDatabasesClient) listByServerHandleResponse(resp *http.Response, successCodes ...int) (RecoverableDatabasesClientListByServerResponse, error) {
