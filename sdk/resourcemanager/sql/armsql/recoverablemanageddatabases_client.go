...
func (client *RecoverableManagedDatabasesClient) getHandleResponse(resp *http.Response, successCodes ...int) (RecoverableManagedDatabasesClientGetResponse, error) {
...
func (client *RecoverableManagedDatabasesClient) listByInstanceCreateRequest(ctx context.Context, resourceGroupName string, managedInstanceName string, nextLink string, _ *RecoverableManagedDatabasesClientListByInstanceOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *RecoverableManagedDatabasesClient) listByInstanceHandleResponse(resp *http.Response, successCodes ...int) (RecoverableManagedDatabasesClientListByInstanceResponse, error) {
