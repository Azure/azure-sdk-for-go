...
func (client *RestorableDroppedDatabasesClient) getHandleResponse(resp *http.Response, successCodes ...int) (RestorableDroppedDatabasesClientGetResponse, error) {
...
func (client *RestorableDroppedDatabasesClient) listByServerHandleResponse(resp *http.Response, successCodes ...int) (RestorableDroppedDatabasesClientListByServerResponse, error) {
