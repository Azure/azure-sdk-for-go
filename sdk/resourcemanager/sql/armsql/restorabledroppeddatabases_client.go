...
func (client *RestorableDroppedDatabasesClient) listByServerCreateRequest(ctx context.Context, resourceGroupName string, serverName string, _ *RestorableDroppedDatabasesClientListByServerOptions) (*policy.Request, error) {
