...
// Generated from example definition: 2025-08-01-preview/GetRestorableDroppedDatabase.json
func ExampleRestorableDroppedDatabasesClient_Get_getsARestorableDroppedDatabase() {
	...
	// res = armsql.RestorableDroppedDatabasesClientGetResponse{
	// 	RestorableDroppedDatabase: armsql.RestorableDroppedDatabase{
...
// Generated from example definition: 2025-08-01-preview/GetRestorableDroppedDatabaseWithExpandEqualsKeys.json
func ExampleRestorableDroppedDatabasesClient_Get_getsARestorableDroppedDatabaseWithExpandEqualsKeys() {
	...
	res, err := clientFactory.NewRestorableDroppedDatabasesClient().Get(ctx, "Default-SQL-SouthEastAsia", "testsvr", "testdb,131403269876900000", &armsql.RestorableDroppedDatabasesClientGetOptions{
		Expand: to.Ptr("keys")})
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
...
// Generated from example definition: 2025-08-01-preview/ListRestorableDroppedDatabasesByServer.json
