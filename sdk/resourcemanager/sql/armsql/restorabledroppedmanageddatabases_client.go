...
func (client *RestorableDroppedManagedDatabasesClient) getCreateRequest(ctx context.Context, resourceGroupName string, managedInstanceName string, restorableDroppedDatabaseID string, _ *RestorableDroppedManagedDatabasesClientGetOptions) (*policy.Request, error) {
...
func (client *RestorableDroppedManagedDatabasesClient) getHandleResponse(resp *http.Response, successCodes ...int) (RestorableDroppedManagedDatabasesClientGetResponse, error) {
...
func (client *RestorableDroppedManagedDatabasesClient) listByInstanceCreateRequest(ctx context.Context, resourceGroupName string, managedInstanceName string, nextLink string, _ *RestorableDroppedManagedDatabasesClientListByInstanceOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *RestorableDroppedManagedDatabasesClient) listByInstanceHandleResponse(resp *http.Response, successCodes ...int) (RestorableDroppedManagedDatabasesClientListByInstanceResponse, error) {
