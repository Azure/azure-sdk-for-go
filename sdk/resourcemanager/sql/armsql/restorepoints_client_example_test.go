...
// Generated from example definition: 2025-08-01-preview/DatabaseRestorePointsPost.json
func ExampleRestorePointsClient_BeginCreate() {
	...
	// res = armsql.RestorePointsClientCreateResponse{
	// 	RestorePoint: armsql.RestorePoint{
...
// Generated from example definition: 2025-08-01-preview/DatabaseRestorePointsDelete.json
func ExampleRestorePointsClient_Delete() {
	...
	res, err := clientFactory.NewRestorePointsClient().Delete(ctx, "Default-SQL-SouthEastAsia", "testserver", "testDatabase", "131546477590000000", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsql.RestorePointsClientDeleteResponse{
	// }
}

// Generated from example definition: 2025-08-01-preview/DataWarehouseRestorePointsGet.json
func ExampleRestorePointsClient_Get_getsADatawarehouseDatabaseRestorePoint() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsql.RestorePointsClientGetResponse{
	// 	RestorePoint: armsql.RestorePoint{
	// 		Name: to.Ptr("131546477590000000"),
	// 		Type: to.Ptr("Microsoft.Sql/servers/databases/restorePoints"),
	// 		ID: to.Ptr("/subscriptions/00000000-1111-2222-3333-444444444444/providers/Microsoft.Sql/servers/testserver/databases/testDatabase/restorePoints/131546477590000000"),
...
// Generated from example definition: 2025-08-01-preview/DatabaseRestorePointsGet.json
...
// Generated from example definition: 2025-08-01-preview/DataWarehouseRestorePointsListByDatabase.json
...
// Generated from example definition: 2025-08-01-preview/DatabaseRestorePointsListByDatabase.json
