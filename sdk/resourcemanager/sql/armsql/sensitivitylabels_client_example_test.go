...
// Generated from example definition: 2025-08-01-preview/ColumnSensitivityLabelCreateMax.json
func ExampleSensitivityLabelsClient_CreateOrUpdate() {
	...
	// res = armsql.SensitivityLabelsClientCreateOrUpdateResponse{
...
// Generated from example definition: 2025-08-01-preview/ColumnSensitivityLabelDelete.json
func ExampleSensitivityLabelsClient_Delete() {
	...
	res, err := clientFactory.NewSensitivityLabelsClient().Delete(ctx, "myRG", "myServer", "myDatabase", "dbo", "myTable", "myColumn", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsql.SensitivityLabelsClientDeleteResponse{
	// }
}

// Generated from example definition: 2025-08-01-preview/RecommendedColumnSensitivityLabelDisable.json
func ExampleSensitivityLabelsClient_DisableRecommendation() {
	...
	res, err := clientFactory.NewSensitivityLabelsClient().DisableRecommendation(ctx, "myRG", "myServer", "myDatabase", "dbo", "myTable", "myColumn", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsql.SensitivityLabelsClientDisableRecommendationResponse{
	// }
}

// Generated from example definition: 2025-08-01-preview/RecommendedColumnSensitivityLabelEnable.json
func ExampleSensitivityLabelsClient_EnableRecommendation() {
	...
	res, err := clientFactory.NewSensitivityLabelsClient().EnableRecommendation(ctx, "myRG", "myServer", "myDatabase", "dbo", "myTable", "myColumn", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsql.SensitivityLabelsClientEnableRecommendationResponse{
	// }
}

// Generated from example definition: 2025-08-01-preview/ColumnSensitivityLabelGet.json
func ExampleSensitivityLabelsClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsql.SensitivityLabelsClientGetResponse{
	// 	SensitivityLabel: armsql.SensitivityLabel{
	// 		Name: to.Ptr("current"),
	// 		Type: to.Ptr("Microsoft.Sql/servers/databases/schemas/tables/columns/sensitivityLabels"),
	// 		ID: to.Ptr("/subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/myRG/providers/Microsoft.Sql/servers/myServer/databases/myDatabase/schemas/dbo/tables/myTable/columns/myColumn/sensitivityLabels/current"),
...
// Generated from example definition: 2025-08-01-preview/SensitivityLabelsListByDatabase.json
func ExampleSensitivityLabelsClient_NewListByDatabasePager() {
	...
	pager := clientFactory.NewSensitivityLabelsClient().NewListByDatabasePager("myRG", "myServer", "myDatabase", nil)
	for pager.More() {
		...
		// page = armsql.SensitivityLabelsClientListByDatabaseResponse{
...
// Generated from example definition: 2025-08-01-preview/SensitivityLabelsListByDatabaseWithSourceCurrent.json
func ExampleSensitivityLabelsClient_NewListCurrentByDatabasePager() {
	...
	pager := clientFactory.NewSensitivityLabelsClient().NewListCurrentByDatabasePager("myRG", "myServer", "myDatabase", nil)
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armsql.SensitivityLabelsClientListCurrentByDatabaseResponse{
		// 	SensitivityLabelListResult: armsql.SensitivityLabelListResult{
		// 		Value: []*armsql.SensitivityLabel{
		// 			{
		// 				Name: to.Ptr("current"),
...
// Generated from example definition: 2025-08-01-preview/SensitivityLabelsListByDatabaseWithSourceRecommended.json
func ExampleSensitivityLabelsClient_NewListRecommendedByDatabasePager() {
	...
	pager := clientFactory.NewSensitivityLabelsClient().NewListRecommendedByDatabasePager("myRG", "myServer", "myDatabase", nil)
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armsql.SensitivityLabelsClientListRecommendedByDatabaseResponse{
		// 	SensitivityLabelListResult: armsql.SensitivityLabelListResult{
		// 		Value: []*armsql.SensitivityLabel{
		// 			{
		// 				Name: to.Ptr("recommended"),
...
// Generated from example definition: 2025-08-01-preview/SensitivityLabelsCurrentUpdate.json
func ExampleSensitivityLabelsClient_Update() {
	...
	res, err := clientFactory.NewSensitivityLabelsClient().Update(ctx, "myRG", "myServer", "myDatabase", armsql.SensitivityLabelUpdateList{
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsql.SensitivityLabelsClientUpdateResponse{
	// }
}
