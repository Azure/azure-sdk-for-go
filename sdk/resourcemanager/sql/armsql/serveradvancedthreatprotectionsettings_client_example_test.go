...
// Generated from example definition: 2025-08-01-preview/ServerAdvancedThreatProtectionSettingsCreateMax.json
func ExampleServerAdvancedThreatProtectionSettingsClient_BeginCreateOrUpdate_updateAServerSAdvancedThreatProtectionSettingsWithAllParameters() {
	...
	// res = armsql.ServerAdvancedThreatProtectionSettingsClientCreateOrUpdateResponse{
	// 	ServerAdvancedThreatProtection: armsql.ServerAdvancedThreatProtection{
	// 		Name: to.Ptr("Default"),
...
// Generated from example definition: 2025-08-01-preview/ServerAdvancedThreatProtectionSettingsCreateMin.json
...
// Generated from example definition: 2025-08-01-preview/ServerAdvancedThreatProtectionSettingsGet.json
func ExampleServerAdvancedThreatProtectionSettingsClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsql.ServerAdvancedThreatProtectionSettingsClientGetResponse{
	// 	ServerAdvancedThreatProtection: armsql.ServerAdvancedThreatProtection{
	// 		Name: to.Ptr("Default"),
	// 		Type: to.Ptr("Microsoft.Sql/servers/advancedThreatProtectionSettings"),
	// 		ID: to.Ptr("/subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/threatprotection-4799/providers/Microsoft.Sql/servers/threatprotection-6440/advancedThreatProtectionSettings/Default"),
...
// Generated from example definition: 2025-08-01-preview/ServerAdvancedThreatProtectionSettingsListByServer.json
