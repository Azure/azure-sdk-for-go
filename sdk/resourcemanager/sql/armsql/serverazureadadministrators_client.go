...
func (client *ServerAzureADAdministratorsClient) listByServerCreateRequest(ctx context.Context, resourceGroupName string, serverName string, _ *ServerAzureADAdministratorsClientListByServerOptions) (*policy.Request, error) {
