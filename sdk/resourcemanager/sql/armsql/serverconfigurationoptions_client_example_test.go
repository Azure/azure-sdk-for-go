...
// Generated from example definition: 2025-08-01-preview/ServerConfigurationOptionUpdate.json
func ExampleServerConfigurationOptionsClient_BeginCreateOrUpdate() {
	...
	// res = armsql.ServerConfigurationOptionsClientCreateOrUpdateResponse{
	// 	ServerConfigurationOption: armsql.ServerConfigurationOption{
...
// Generated from example definition: 2025-08-01-preview/ServerConfigurationOptionGet.json
func ExampleServerConfigurationOptionsClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsql.ServerConfigurationOptionsClientGetResponse{
	// 	ServerConfigurationOption: armsql.ServerConfigurationOption{
	// 		Name: to.Ptr("allowPolybaseExport"),
	// 		Type: to.Ptr("Microsoft.Sql/managedInstances/serverConfigurationOptions"),
	// 		ID: to.Ptr("/subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/testrg/providers/Microsoft.Sql/managedInstances/testinstance/serverConfigurationOptions/allowPolybaseExport"),
...
// Generated from example definition: 2025-08-01-preview/ServerConfigurationOptionList.json
func ExampleServerConfigurationOptionsClient_NewListByManagedInstancePager() {
	...
	for pager.More() {
		...
		// page = armsql.ServerConfigurationOptionsClientListByManagedInstanceResponse{
		// 	ServerConfigurationOptionListResult: armsql.ServerConfigurationOptionListResult{
