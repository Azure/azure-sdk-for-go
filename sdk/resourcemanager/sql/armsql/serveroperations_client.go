...
func (client *ServerOperationsClient) NewListByServerPager(resourceGroupName string, serverName string, options *ServerOperationsClientListByServerOptions) *runtime.Pager[ServerOperationsClientListByServerResponse] {
	return runtime.NewPager(runtime.PagingHandler[ServerOperationsClientListByServerResponse]{
		...
		Fetcher: func(ctx context.Context, page *ServerOperationsClientListByServerResponse) (ServerOperationsClientListByServerResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "ServerOperationsClient.NewListByServerPager")
			nextLink := ""
			if page != nil {
...
func (client *ServerOperationsClient) listByServerCreateRequest(ctx context.Context, resourceGroupName string, serverName string, nextLink string, _ *ServerOperationsClientListByServerOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *ServerOperationsClient) listByServerHandleResponse(resp *http.Response, successCodes ...int) (ServerOperationsClientListByServerResponse, error) {
