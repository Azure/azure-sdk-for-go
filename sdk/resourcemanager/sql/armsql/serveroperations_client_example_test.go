...
// Generated from example definition: 2025-02-01-preview/ListServerOperations.json
func ExampleServerOperationsClient_NewListByServerPager() {
	...
	for pager.More() {
		...
		// page = armsql.ServerOperationsClientListByServerResponse{
		// 	ServerOperationListResult: armsql.ServerOperationListResult{
		...
		// 					StartTime: to.Ptr(time.Date(2017, time.June, 1, 9, 10, 8, 100000000, time.UTC)),
		...
		// 					ServerName: to.Ptr("sqlcrudtest-4645"),
		// 					StartTime: to.Ptr(time.Date(2017, time.June, 1, 9, 0, 8, 100000000, time.UTC)),
