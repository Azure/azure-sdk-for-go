...
// Generated from example definition: 2026-08-01-preview/CheckNameAvailabilityServerAlreadyExists.json
func ExampleServersClient_CheckNameAvailability_checkForAServerNameThatAlreadyExists() {
	...
	// res = armsql.ServersClientCheckNameAvailabilityResponse{
	// 	CheckNameAvailabilityResponse: armsql.CheckNameAvailabilityResponse{
	// 		Name: to.Ptr("server1"),
...
// Generated from example definition: 2026-08-01-preview/CheckNameAvailabilityServerAvailable.json
...
// Generated from example definition: 2026-08-01-preview/CheckNameAvailabilityServerInvalid.json
...
// Generated from example definition: 2026-08-01-preview/ServerCreate.json
func ExampleServersClient_BeginCreateOrUpdate() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsql.ServersClientCreateOrUpdateResponse{
...
// Generated from example definition: 2026-08-01-preview/ServerDelete.json
func ExampleServersClient_BeginDelete() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsql.ServersClientDeleteResponse{
	// }
}

// Generated from example definition: 2026-08-01-preview/ServerGet.json
func ExampleServersClient_Get_getServer() {
	...
	res, err := clientFactory.NewServersClient().Get(ctx, "sqlcrudtest-7398", "sqlcrudtest-4645", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsql.ServersClientGetResponse{
	// 	Server: armsql.Server{
	// 		Name: to.Ptr("sqlcrudtest-4645"),
	// 		Type: to.Ptr("Microsoft.Sql/servers"),
	// 		ID: to.Ptr("/subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/sqlcrudtest-7398/providers/Microsoft.Sql/servers/sqlcrudtest-4645"),
...
// Generated from example definition: 2026-08-01-preview/ServerGetWithExpandEqualsAdministrators.json
...
// Generated from example definition: 2026-08-01-preview/ImportNewDatabase.json
func ExampleServersClient_BeginImportDatabase_importsToANewDatabase() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsql.ServersClientImportDatabaseResponse{
	// 	ImportExportOperationResult: armsql.ImportExportOperationResult{
...
// Generated from example definition: 2026-08-01-preview/ImportNewDatabaseWithManagedIdentity.json
...
// Generated from example definition: 2026-08-01-preview/ImportNewDatabaseWithNetworkIsolation.json
...
// Generated from example definition: 2026-08-01-preview/ServerList.json
func ExampleServersClient_NewListPager_listServers() {
	...
	for pager.More() {
		...
		// page = armsql.ServersClientListResponse{
...
// Generated from example definition: 2026-08-01-preview/ServerListWithExpandEqualsAdministrators.json
...
// Generated from example definition: 2026-08-01-preview/ServerListByResourceGroup.json
func ExampleServersClient_NewListByResourceGroupPager_listServersByResourceGroup() {
	...
	pager := clientFactory.NewServersClient().NewListByResourceGroupPager("sqlcrudtest-7398", nil)
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armsql.ServersClientListByResourceGroupResponse{
		// 	ServerListResult: armsql.ServerListResult{
		// 		Value: []*armsql.Server{
		// 			{
		// 				Name: to.Ptr("sqlcrudtest-4645"),
...
// Generated from example definition: 2026-08-01-preview/ServerListByResourceGroupWithExpandEqualsAdministrators.json
...
// Generated from example definition: 2026-08-01-preview/RefreshExternalGovernanceStatus.json
func ExampleServersClient_BeginRefreshStatus() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsql.ServersClientRefreshStatusResponse{
	// 	RefreshExternalGovernanceStatusOperationResult: armsql.RefreshExternalGovernanceStatusOperationResult{
	// 		Name: to.Ptr("9d9a794a-5cec-4f23-af70-d29511b522a4"),
...
// Generated from example definition: 2026-08-01-preview/ServerUpdate.json
func ExampleServersClient_BeginUpdate() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsql.ServersClientUpdateResponse{
	// 	Server: armsql.Server{
	// 		Name: to.Ptr("sqlcrudtest-4645"),
	// 		Type: to.Ptr("Microsoft.Sql/servers"),
	// 		ID: to.Ptr("/subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/sqlcrudtest-7398/providers/Microsoft.Sql/servers/sqlcrudtest-4645"),
