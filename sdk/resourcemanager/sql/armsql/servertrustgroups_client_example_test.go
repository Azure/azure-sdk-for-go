...
// Generated from example definition: 2025-08-01-preview/ServerTrustGroupCreate.json
func ExampleServerTrustGroupsClient_BeginCreateOrUpdate() {
	...
	// res = armsql.ServerTrustGroupsClientCreateOrUpdateResponse{
...
// Generated from example definition: 2025-08-01-preview/ServerTrustGroupDelete.json
func ExampleServerTrustGroupsClient_BeginDelete() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsql.ServerTrustGroupsClientDeleteResponse{
	// }
}

// Generated from example definition: 2025-08-01-preview/ServerTrustGroupGet.json
...
// Generated from example definition: 2025-08-01-preview/ServerTrustGroupListByManagedInstance.json
func ExampleServerTrustGroupsClient_NewListByInstancePager() {
	...
	for pager.More() {
		...
		// page = armsql.ServerTrustGroupsClientListByInstanceResponse{
		// 	ServerTrustGroupListResult: armsql.ServerTrustGroupListResult{
...
// Generated from example definition: 2025-08-01-preview/ServerTrustGroupList.json
func ExampleServerTrustGroupsClient_NewListByLocationPager() {
	...
	for pager.More() {
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armsql.ServerTrustGroupsClientListByLocationResponse{
		// 	ServerTrustGroupListResult: armsql.ServerTrustGroupListResult{
		// 		Value: []*armsql.ServerTrustGroup{
		// 			{
		// 				Name: to.Ptr("server-trust-group-test"),
