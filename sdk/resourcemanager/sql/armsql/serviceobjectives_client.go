...
func (client *ServiceObjectivesClient) getCreateRequest(ctx context.Context, resourceGroupName string, serverName string, serviceObjectiveName string, _ *ServiceObjectivesClientGetOptions) (*policy.Request, error) {
...
func (client *ServiceObjectivesClient) listByServerCreateRequest(ctx context.Context, resourceGroupName string, serverName string, _ *ServiceObjectivesClientListByServerOptions) (*policy.Request, error) {
