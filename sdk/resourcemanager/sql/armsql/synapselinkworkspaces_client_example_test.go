...
// Generated from example definition: 2025-08-01-preview/SynapseLinkWorkspaceListByDatabase.json
func ExampleSynapseLinkWorkspacesClient_NewListByDatabasePager() {
	...
	for pager.More() {
		...
		// page = armsql.SynapseLinkWorkspacesClientListByDatabaseResponse{
		// 	SynapseLinkWorkspaceListResult: armsql.SynapseLinkWorkspaceListResult{
