...
func (client *SyncAgentsClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, serverName string, syncAgentName string, parameters SyncAgent, _ *SyncAgentsClientBeginCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *SyncAgentsClient) deleteCreateRequest(ctx context.Context, resourceGroupName string, serverName string, syncAgentName string, _ *SyncAgentsClientBeginDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/syncAgents/{syncAgentName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *SyncAgentsClient) GenerateKey(ctx context.Context, resourceGroupName string, serverName string, syncAgentName string, options *SyncAgentsClientGenerateKeyOptions) (SyncAgentsClientGenerateKeyResponse, error) {
	...
	return client.generateKeyHandleResponse(httpResp, http.StatusOK)
}

// generateKeyCreateRequest creates the GenerateKey request.
func (client *SyncAgentsClient) generateKeyCreateRequest(ctx context.Context, resourceGroupName string, serverName string, syncAgentName string, _ *SyncAgentsClientGenerateKeyOptions) (*policy.Request, error) {
...
func (client *SyncAgentsClient) generateKeyHandleResponse(resp *http.Response, successCodes ...int) (SyncAgentsClientGenerateKeyResponse, error) {
...
func (client *SyncAgentsClient) getCreateRequest(ctx context.Context, resourceGroupName string, serverName string, syncAgentName string, _ *SyncAgentsClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/syncAgents/{syncAgentName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *SyncAgentsClient) getHandleResponse(resp *http.Response, successCodes ...int) (SyncAgentsClientGetResponse, error) {
...
func (client *SyncAgentsClient) listByServerCreateRequest(ctx context.Context, resourceGroupName string, serverName string, nextLink string, _ *SyncAgentsClientListByServerOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *SyncAgentsClient) listByServerHandleResponse(resp *http.Response, successCodes ...int) (SyncAgentsClientListByServerResponse, error) {
...
func (client *SyncAgentsClient) NewListLinkedDatabasesPager(resourceGroupName string, serverName string, syncAgentName string, options *SyncAgentsClientListLinkedDatabasesOptions) *runtime.Pager[SyncAgentsClientListLinkedDatabasesResponse] {
	return runtime.NewPager(runtime.PagingHandler[SyncAgentsClientListLinkedDatabasesResponse]{
		...
		Fetcher: func(ctx context.Context, page *SyncAgentsClientListLinkedDatabasesResponse) (SyncAgentsClientListLinkedDatabasesResponse, error) {
			...
			req, err := client.listLinkedDatabasesCreateRequest(ctx, resourceGroupName, serverName, syncAgentName, nextLink, options)
			if err != nil {
			...
			return client.listLinkedDatabasesHandleResponse(resp, http.StatusOK)
		},
		Tracer: client.internal.Tracer(),
	})
}
...
func (client *SyncAgentsClient) listLinkedDatabasesCreateRequest(ctx context.Context, resourceGroupName string, serverName string, syncAgentName string, nextLink string, _ *SyncAgentsClientListLinkedDatabasesOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
	var req *policy.Request
	var err error
	if firstPage {
...
func (client *SyncAgentsClient) listLinkedDatabasesHandleResponse(resp *http.Response, successCodes ...int) (SyncAgentsClientListLinkedDatabasesResponse, error) {
