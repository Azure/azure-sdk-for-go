...
// Generated from example definition: 2025-02-01-preview/ManagedInstanceTimeZoneGet.json
func ExampleTimeZonesClient_Get() {
	...
	clientFactory, err := armsql.NewClientFactory("37d5e605-6142-4d79-b564-28b6dbfeec0f", cred, nil)
	if err != nil {
	...
	// res = armsql.TimeZonesClientGetResponse{
	// 	TimeZone: armsql.TimeZone{
...
// Generated from example definition: 2025-02-01-preview/ManagedInstanceTimeZoneListByLocation.json
func ExampleTimeZonesClient_NewListByLocationPager() {
	...
	for pager.More() {
		...
		// page = armsql.TimeZonesClientListByLocationResponse{
		// 	TimeZoneListResult: armsql.TimeZoneListResult{
