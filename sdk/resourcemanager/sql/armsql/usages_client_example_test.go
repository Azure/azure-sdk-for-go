...
// Generated from example definition: 2025-08-01-preview/ListInstancePoolUsage.json
func ExampleUsagesClient_NewListByInstancePoolPager_listInstancePoolUsages() {
	...
	pager := clientFactory.NewUsagesClient().NewListByInstancePoolPager("group1", "testIP", nil)
	for pager.More() {
		...
		// page = armsql.UsagesClientListByInstancePoolResponse{
		// 	UsageListResult: armsql.UsageListResult{
		// 		Value: []*armsql.Usage{
		// 			{
		// 				Name: &armsql.Name{
...
// Generated from example definition: 2025-08-01-preview/ListInstancePoolUsageExpanded.json
func ExampleUsagesClient_NewListByInstancePoolPager_listInstancePoolUsagesExpandedWithChildren() {
	...
	pager := clientFactory.NewUsagesClient().NewListByInstancePoolPager("group1", "testIP", &armsql.UsagesClientListByInstancePoolOptions{
		ExpandChildren: to.Ptr(true)})
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
