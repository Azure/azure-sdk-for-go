...
func (client *VirtualNetworkRulesClient) getHandleResponse(resp *http.Response, successCodes ...int) (VirtualNetworkRulesClientGetResponse, error) {
...
func (client *VirtualNetworkRulesClient) listByServerCreateRequest(ctx context.Context, resourceGroupName string, serverName string, nextLink string, _ *VirtualNetworkRulesClientListByServerOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *VirtualNetworkRulesClient) listByServerHandleResponse(resp *http.Response, successCodes ...int) (VirtualNetworkRulesClientListByServerResponse, error) {
