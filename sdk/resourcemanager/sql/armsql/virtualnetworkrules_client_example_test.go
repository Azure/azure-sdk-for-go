...
// Generated from example definition: 2025-08-01-preview/VirtualNetworkRulesCreateOrUpdate.json
func ExampleVirtualNetworkRulesClient_BeginCreateOrUpdate() {
	...
	// res = armsql.VirtualNetworkRulesClientCreateOrUpdateResponse{
	// 	VirtualNetworkRule: armsql.VirtualNetworkRule{
...
// Generated from example definition: 2025-08-01-preview/VirtualNetworkRulesDelete.json
func ExampleVirtualNetworkRulesClient_BeginDelete() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsql.VirtualNetworkRulesClientDeleteResponse{
	// }
}

// Generated from example definition: 2025-08-01-preview/VirtualNetworkRulesGet.json
func ExampleVirtualNetworkRulesClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsql.VirtualNetworkRulesClientGetResponse{
	// 	VirtualNetworkRule: armsql.VirtualNetworkRule{
	// 		Name: to.Ptr("vnet-firewall-rule"),
	// 		Type: to.Ptr("Microsoft.Sql/servers/virtualNetworkRules"),
	// 		ID: to.Ptr("/subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/Default/providers/Microsoft.Sql/servers/vnet-test-svr/virtualNetworkRules/vnet-firewall-rule"),
...
// Generated from example definition: 2025-08-01-preview/VirtualNetworkRulesList.json
func ExampleVirtualNetworkRulesClient_NewListByServerPager() {
	...
	for pager.More() {
		...
		// page = armsql.VirtualNetworkRulesClientListByServerResponse{
