...
// Generated from example definition: 2025-08-01-preview/CreateOrUpdateWorkloadClassifierMax.json
func ExampleWorkloadClassifiersClient_BeginCreateOrUpdate_createAWorkloadGroupWithAllPropertiesSpecified() {
	...
	// res = armsql.WorkloadClassifiersClientCreateOrUpdateResponse{
	// 	WorkloadClassifier: armsql.WorkloadClassifier{
...
// Generated from example definition: 2025-08-01-preview/CreateOrUpdateWorkloadClassifierMin.json
...
// Generated from example definition: 2025-08-01-preview/DeleteWorkloadClassifier.json
func ExampleWorkloadClassifiersClient_BeginDelete() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsql.WorkloadClassifiersClientDeleteResponse{
	// }
}

// Generated from example definition: 2025-08-01-preview/GetWorkloadClassifier.json
func ExampleWorkloadClassifiersClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsql.WorkloadClassifiersClientGetResponse{
	// 	WorkloadClassifier: armsql.WorkloadClassifier{
...
// Generated from example definition: 2025-08-01-preview/GetWorkloadClassifierList.json
func ExampleWorkloadClassifiersClient_NewListByWorkloadGroupPager() {
	...
	for pager.More() {
		...
		// page = armsql.WorkloadClassifiersClientListByWorkloadGroupResponse{
		// 	WorkloadClassifierListResult: armsql.WorkloadClassifierListResult{
