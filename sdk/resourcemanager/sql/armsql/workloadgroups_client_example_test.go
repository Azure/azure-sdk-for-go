...
// Generated from example definition: 2025-08-01-preview/CreateOrUpdateWorkloadGroupMax.json
func ExampleWorkloadGroupsClient_BeginCreateOrUpdate_createAWorkloadGroupWithAllPropertiesSpecified() {
	...
	// res = armsql.WorkloadGroupsClientCreateOrUpdateResponse{
	// 	WorkloadGroup: armsql.WorkloadGroup{
	// 		Name: to.Ptr("smallrc"),
...
// Generated from example definition: 2025-08-01-preview/CreateOrUpdateWorkloadGroupMin.json
...
// Generated from example definition: 2025-08-01-preview/DeleteWorkloadGroup.json
func ExampleWorkloadGroupsClient_BeginDelete() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsql.WorkloadGroupsClientDeleteResponse{
	// }
}

// Generated from example definition: 2025-08-01-preview/GetWorkloadGroup.json
func ExampleWorkloadGroupsClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armsql.WorkloadGroupsClientGetResponse{
	// 	WorkloadGroup: armsql.WorkloadGroup{
	// 		Name: to.Ptr("smallrc"),
	// 		Type: to.Ptr("Microsoft.Sql/servers/databases/workloadGroups"),
	// 		ID: to.Ptr("/subscriptions/00000000-1111-2222-3333-444444444444/resourceGroups/Default-SQL-SouthEastAsia/providers/Microsoft.Sql/servers/testsvr/databases/testdb/workloadGroups/smallrc"),
...
// Generated from example definition: 2025-08-01-preview/GetWorkloadGroupList.json
func ExampleWorkloadGroupsClient_NewListByDatabasePager() {
	...
	for pager.More() {
		...
		// page = armsql.WorkloadGroupsClientListByDatabaseResponse{
		// 	WorkloadGroupListResult: armsql.WorkloadGroupListResult{
