...
func NewElasticPoolActivitiesClient(con *arm.Connection, subscriptionID string) *ElasticPoolActivitiesClient {
	return &ElasticPoolActivitiesClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
