...
func (client *GroupsClient) listCreateRequest(ctx context.Context, nextLink string, _ *GroupsClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *GroupsClient) listByResourceGroupCreateRequest(ctx context.Context, resourceGroupName string, nextLink string, _ *GroupsClientListByResourceGroupOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
	var req *policy.Request
	var err error
	if firstPage {
...
func (client *GroupsClient) listByResourceGroupHandleResponse(resp *http.Response, successCodes ...int) (GroupsClientListByResourceGroupResponse, error) {
