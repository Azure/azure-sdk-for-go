...
func (t TroubleshootingStatus) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateTime[datetime.RFC3339](objectMap, "endTimeUtc", t.EndTimeUTC, true)
	populateTime[datetime.RFC3339](objectMap, "lastTriggerTimeUtc", t.LastTriggerTimeUTC, true)
	populate(objectMap, "properties", t.Properties)
	populate(objectMap, "rootCause", t.RootCause)
	populateTime[datetime.RFC3339](objectMap, "startTimeUtc", t.StartTimeUTC, true)
...
func (t *TroubleshootingStatus) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "endTimeUtc":
			err = unpopulateTime[datetime.RFC3339](val, "EndTimeUTC", &t.EndTimeUTC)
			delete(rawMsg, key)
		case "lastTriggerTimeUtc":
			err = unpopulateTime[datetime.RFC3339](val, "LastTriggerTimeUTC", &t.LastTriggerTimeUTC)
			delete(rawMsg, key)
		case "properties":
		...
		case "rootCause":
			...
			delete(rawMsg, key)
		case "startTimeUtc":
			err = unpopulateTime[datetime.RFC3339](val, "StartTimeUTC", &t.StartTimeUTC)
			delete(rawMsg, key)
		case "troubleshootingScenario":
