...
func (t TroubleshootingStatus) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateTime[datetime.RFC3339](objectMap, "endTimeUtc", t.EndTimeUTC)
	populateTime[datetime.RFC3339](objectMap, "lastTriggerTimeUtc", t.LastTriggerTimeUTC)
	populate(objectMap, "properties", t.Properties)
	populate(objectMap, "rootCause", t.RootCause)
	populateTime[datetime.RFC3339](objectMap, "startTimeUtc", t.StartTimeUTC)
