...
func (s *StandbyContainerGroupPoolRuntimeViewsServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.StandbyPool/standbyContainerGroupPools/(?P<standbyContainerGroupPoolName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/runtimeViews/(?P<runtimeView>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)`
...
func (s *StandbyContainerGroupPoolRuntimeViewsServerTransport) dispatchNewListByStandbyPoolPager(req *http.Request) (*http.Response, error) {
	...
	if newListByStandbyPoolPager == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.StandbyPool/standbyContainerGroupPools/(?P<standbyContainerGroupPoolName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/runtimeViews`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 4 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
