...
func ExampleStandbyVirtualMachinePoolRuntimeViewsClient_Get() {
	...
	// 					},
	// 				},
	// 				ForecastStartTime: to.Ptr(time.Date(2025, time.February, 14, 1, 34, 59, 228000000, time.UTC)),
	...
	// 			CreatedAt: to.Ptr(time.Date(2024, time.February, 14, 23, 31, 59, 679000000, time.UTC)),
	// 			LastModifiedBy: to.Ptr("pooluser@microsoft.com"),
	// 			LastModifiedByType: to.Ptr(armstandbypool.CreatedByTypeUser),
	// 			LastModifiedAt: to.Ptr(time.Date(2024, time.February, 14, 23, 31, 59, 679000000, time.UTC)),
	// 		},
	// 	},
	// }
}
