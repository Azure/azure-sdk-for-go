...
func (client *AccountsClient) checkNameAvailabilityHandleResponse(resp *http.Response, successCodes ...int) (AccountsClientCheckNameAvailabilityResponse, error) {
...
// and a subsequent create request is issued with different properties, the account properties will be updated. If an account
// is already created and a subsequent create or update request is issued with the exact same set of properties, the request
// will succeed.
// If the operation fails it returns an *azcore.ResponseError type.
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - accountName - The name of the storage account within the specified resource group. Storage account names must be between
...
// a subsequent create request is issued with different properties, the account properties will be updated. If an account
// is already created and a subsequent create or update request is issued with the exact same set of properties, the request
// will succeed.
// If the operation fails it returns an *azcore.ResponseError type.
...
// level. The migration updates the non-zonal redundant storage account to a zonal redundant account or vice-versa in order
// to have better reliability and availability. Zone-redundant storage (ZRS) replicates your storage account synchronously
...
func (client *AccountsClient) Delete(ctx context.Context, resourceGroupName string, accountName string, options *AccountsClientDeleteOptions) (AccountsClientDeleteResponse, error) {
	...
	if !runtime.HasStatusCode(httpResp, http.StatusOK, http.StatusNoContent) {
		return AccountsClientDeleteResponse{}, runtime.NewResponseError(httpResp)
	}
...
// for any reason. The failover occurs from the storage account's primary cluster to the secondary cluster for RA-GRS accounts.
// The secondary cluster will become primary after failover and the account is converted to LRS. In the case of a Planned
// Failover, the primary and secondary clusters are swapped after failover and the account remains geo-replicated. Failover
// should continue to be used in the event of availability issues as Planned failover is only available while the primary
// and secondary endpoints are available. The primary use case of a Planned Failover is disaster recovery testing drills.
// This type of failover is invoked by setting FailoverType parameter to 'Planned'. Learn more about the failover options
// here- https://learn.microsoft.com/azure/storage/common/storage-disaster-recovery-guidance
// If the operation fails it returns an *azcore.ResponseError type.
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - accountName - The name of the storage account within the specified resource group. Storage account names must be between
//     3 and 24 characters in length and use numbers and lower-case letters only.
...
func (client *AccountsClient) GetCustomerInitiatedMigration(ctx context.Context, resourceGroupName string, accountName string, migrationName MigrationName, options *AccountsClientGetCustomerInitiatedMigrationOptions) (AccountsClientGetCustomerInitiatedMigrationResponse, error) {
	...
	return client.getCustomerInitiatedMigrationHandleResponse(httpResp, http.StatusOK)
}
...
func (client *AccountsClient) getCustomerInitiatedMigrationHandleResponse(resp *http.Response, successCodes ...int) (AccountsClientGetCustomerInitiatedMigrationResponse, error) {
...
func (client *AccountsClient) getPropertiesHandleResponse(resp *http.Response, successCodes ...int) (AccountsClientGetPropertiesResponse, error) {
...
//     'HnsOnValidationRequest' or a hydration request 'HnsOnHydrationRequest'. The validation request will validate the migration
//     whereas the hydration request will migrate the account.
...
func (client *AccountsClient) ListAccountSAS(ctx context.Context, resourceGroupName string, accountName string, parameters AccountSasParameters, options *AccountsClientListAccountSASOptions) (AccountsClientListAccountSASResponse, error) {
	...
	return client.listAccountSASHandleResponse(httpResp, http.StatusOK)
}
...
func (client *AccountsClient) listAccountSASHandleResponse(resp *http.Response, successCodes ...int) (AccountsClientListAccountSASResponse, error) {
...
func (client *AccountsClient) listKeysHandleResponse(resp *http.Response, successCodes ...int) (AccountsClientListKeysResponse, error) {
...
func (client *AccountsClient) ListServiceSAS(ctx context.Context, resourceGroupName string, accountName string, parameters ServiceSasParameters, options *AccountsClientListServiceSASOptions) (AccountsClientListServiceSASResponse, error) {
	...
	return client.listServiceSASHandleResponse(httpResp, http.StatusOK)
}
...
func (client *AccountsClient) listServiceSASHandleResponse(resp *http.Response, successCodes ...int) (AccountsClientListServiceSASResponse, error) {
...
func (client *AccountsClient) regenerateKeyHandleResponse(resp *http.Response, successCodes ...int) (AccountsClientRegenerateKeyResponse, error) {
...
func (client *AccountsClient) RevokeUserDelegationKeys(ctx context.Context, resourceGroupName string, accountName string, options *AccountsClientRevokeUserDelegationKeysOptions) (AccountsClientRevokeUserDelegationKeysResponse, error) {
	...
	if !runtime.HasStatusCode(httpResp, http.StatusOK) {
		return AccountsClientRevokeUserDelegationKeysResponse{}, runtime.NewResponseError(httpResp)
	}
...
// can also be used to map the account to a custom domain. Only one custom domain is supported per storage account; the replacement/change
...
func (client *AccountsClient) updateHandleResponse(resp *http.Response, successCodes ...int) (AccountsClientUpdateResponse, error) {
