...
func ExampleBlobContainersClient_CreateOrUpdateImmutabilityPolicy_blobContainersPutImmutabilityPolicy() {
	...
	res, err := client.CreateOrUpdateImmutabilityPolicy(ctx, "res1782", "sto7069", "container6397", armstorage.ImmutabilityPolicy{
...
func ExampleBlobContainersClient_Lease_blobContainersLease_Acquire() {
	...
	res, err := client.Lease(ctx, "res3376", "sto328", "container6185", &armstorage.BlobContainersClientLeaseOptions{Parameters: &armstorage.LeaseContainerRequestAutoGenerated{
		Action:        to.Ptr(armstorage.LeaseContainerRequestAcquire),
...
func ExampleBlobContainersClient_Lease_blobContainersLease_Break() {
	...
	res, err := client.Lease(ctx, "res3376", "sto328", "container6185", &armstorage.BlobContainersClientLeaseOptions{Parameters: &armstorage.LeaseContainerRequestAutoGenerated{
		Action:  to.Ptr(armstorage.LeaseContainerRequestBreak),
