...
func ExampleBlobInventoryPoliciesClient_Delete() {
	...
	res, err := clientFactory.NewBlobInventoryPoliciesClient().Delete(ctx, "res6977", "sto2527", armstorage.BlobInventoryPolicyNameDefault, nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armstorage.BlobInventoryPoliciesClientDeleteResponse{
	// }
}
...
func ExampleBlobInventoryPoliciesClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armstorage.BlobInventoryPoliciesClientListResponse{
		// 	ListBlobInventoryPolicy: armstorage.ListBlobInventoryPolicy{
