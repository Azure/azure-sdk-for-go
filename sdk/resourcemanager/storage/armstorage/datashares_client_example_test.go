...
// Generated from example definition: 2026-06-01/StorageDataShareCRUD/StorageDataShares_Create.json
func ExampleDataSharesClient_BeginCreate() {
	...
	poller, err := clientFactory.NewDataSharesClient().BeginCreate(ctx, "testrg", "teststorageaccount", "testdatashare", armstorage.DataShare{
	...
	// res = armstorage.DataSharesClientCreateResponse{
...
// Generated from example definition: 2026-06-01/StorageDataShareCRUD/StorageDataShares_Delete.json
func ExampleDataSharesClient_BeginDelete() {
	...
	poller, err := clientFactory.NewDataSharesClient().BeginDelete(ctx, "testrg", "teststorageaccount", "testdatashare", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
...
// Generated from example definition: 2026-06-01/StorageDataShareCRUD/StorageDataShares_Get.json
func ExampleDataSharesClient_Get() {
	...
	res, err := clientFactory.NewDataSharesClient().Get(ctx, "testrg", "teststorageaccount", "testdatashare", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armstorage.DataSharesClientGetResponse{
	// 	DataShare: armstorage.DataShare{
	// 		ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/testrg/providers/Microsoft.Storage/storageAccounts/teststorageaccounts/datashares/testdatashare"),
	// 		Name: to.Ptr("testdatashare"),
	// 		Type: to.Ptr("Microsoft.Storage/storageAccounts/dataShares"),
	// 		Location: to.Ptr("eastus"),
	// 		Properties: &armstorage.DataShareProperties{
...
// Generated from example definition: 2026-06-01/StorageDataShareCRUD/StorageDataShares_ListByStorageAccount.json
...
// Generated from example definition: 2026-06-01/StorageDataShareCRUD/StorageDataShares_Update.json
