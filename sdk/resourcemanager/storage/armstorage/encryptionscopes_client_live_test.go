...
func (testsuite *EncryptionScopesClientTestSuite) TestEncryptionScopesCRUD() {
	...
	// put file services
	fmt.Println("Call operation: EncryptionScope_Put")
	...
	// get
	fmt.Println("Call operation: EncryptionScope_Get")
	...
	// list
	fmt.Println("Call operation: EncryptionScope_List")
	...
	// patch
	fmt.Println("Call operation: EncryptionScope_Patch")
