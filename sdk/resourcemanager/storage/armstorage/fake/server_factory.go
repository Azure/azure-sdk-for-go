...
type ServerFactory struct {
	...
	// BlobInventoryPoliciesServer contains the fakes for client BlobInventoryPoliciesClient
	...
	// FileServicesServer contains the fakes for client FileServicesClient
	...
	// LocalUsersServer contains the fakes for client LocalUsersClient
	LocalUsersServer LocalUsersServer

	// ManagementPoliciesServer contains the fakes for client ManagementPoliciesClient
	...
	// ObjectReplicationPoliciesServer contains the fakes for client ObjectReplicationPoliciesClient
	...
	// QueueServer contains the fakes for client QueueClient
	QueueServer QueueServer

	// QueueServicesServer contains the fakes for client QueueServicesClient
	QueueServicesServer QueueServicesServer

	// SKUsServer contains the fakes for client SKUsClient
	SKUsServer SKUsServer

	// TableServer contains the fakes for client TableClient
	TableServer TableServer

	// TableServicesServer contains the fakes for client TableServicesClient
	TableServicesServer TableServicesServer

	// TaskAssignmentInstancesReportServer contains the fakes for client TaskAssignmentInstancesReportClient
	TaskAssignmentInstancesReportServer TaskAssignmentInstancesReportServer

	// TaskAssignmentsServer contains the fakes for client TaskAssignmentsClient
	TaskAssignmentsServer TaskAssignmentsServer

	// TaskAssignmentsInstancesReportServer contains the fakes for client TaskAssignmentsInstancesReportClient
	TaskAssignmentsInstancesReportServer TaskAssignmentsInstancesReportServer
...
type ServerFactoryTransport struct {
	...
	trTaskAssignmentInstancesReportServer          *TaskAssignmentInstancesReportServerTransport
	trTaskAssignmentsServer                        *TaskAssignmentsServerTransport
	trTaskAssignmentsInstancesReportServer         *TaskAssignmentsInstancesReportServerTransport
...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "BlobInventoryPoliciesClient":
		initServer(&s.trMu, &s.trBlobInventoryPoliciesServer, func() *BlobInventoryPoliciesServerTransport {
	...
	case "FileServicesClient":
		initServer(&s.trMu, &s.trFileServicesServer, func() *FileServicesServerTransport { return NewFileServicesServerTransport(&s.srv.FileServicesServer) })
		resp, err = s.trFileServicesServer.Do(req)
	case "FileSharesClient":
		initServer(&s.trMu, &s.trFileSharesServer, func() *FileSharesServerTransport { return NewFileSharesServerTransport(&s.srv.FileSharesServer) })
		resp, err = s.trFileSharesServer.Do(req)
	case "LocalUsersClient":
		initServer(&s.trMu, &s.trLocalUsersServer, func() *LocalUsersServerTransport { return NewLocalUsersServerTransport(&s.srv.LocalUsersServer) })
		resp, err = s.trLocalUsersServer.Do(req)
	case "ManagementPoliciesClient":
		initServer(&s.trMu, &s.trManagementPoliciesServer, func() *ManagementPoliciesServerTransport {
	...
	case "ObjectReplicationPoliciesClient":
		initServer(&s.trMu, &s.trObjectReplicationPoliciesServer, func() *ObjectReplicationPoliciesServerTransport {
	...
	case "QueueClient":
		initServer(&s.trMu, &s.trQueueServer, func() *QueueServerTransport { return NewQueueServerTransport(&s.srv.QueueServer) })
		resp, err = s.trQueueServer.Do(req)
	case "QueueServicesClient":
		initServer(&s.trMu, &s.trQueueServicesServer, func() *QueueServicesServerTransport {
	...
	case "TableClient":
		initServer(&s.trMu, &s.trTableServer, func() *TableServerTransport { return NewTableServerTransport(&s.srv.TableServer) })
		resp, err = s.trTableServer.Do(req)
	case "TableServicesClient":
		initServer(&s.trMu, &s.trTableServicesServer, func() *TableServicesServerTransport {
			return NewTableServicesServerTransport(&s.srv.TableServicesServer)
		})
		resp, err = s.trTableServicesServer.Do(req)
	case "TaskAssignmentInstancesReportClient":
		initServer(&s.trMu, &s.trTaskAssignmentInstancesReportServer, func() *TaskAssignmentInstancesReportServerTransport {
			return NewTaskAssignmentInstancesReportServerTransport(&s.srv.TaskAssignmentInstancesReportServer)
		})
		resp, err = s.trTaskAssignmentInstancesReportServer.Do(req)
	case "TaskAssignmentsClient":
		initServer(&s.trMu, &s.trTaskAssignmentsServer, func() *TaskAssignmentsServerTransport {
			return NewTaskAssignmentsServerTransport(&s.srv.TaskAssignmentsServer)
		})
		resp, err = s.trTaskAssignmentsServer.Do(req)
	case "TaskAssignmentsInstancesReportClient":
		initServer(&s.trMu, &s.trTaskAssignmentsInstancesReportServer, func() *TaskAssignmentsInstancesReportServerTransport {
			return NewTaskAssignmentsInstancesReportServerTransport(&s.srv.TaskAssignmentsInstancesReportServer)
		})
		resp, err = s.trTaskAssignmentsInstancesReportServer.Do(req)
	case "UsagesClient":
