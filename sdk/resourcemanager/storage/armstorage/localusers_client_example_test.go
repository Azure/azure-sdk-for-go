...
// Generated from example definition: 2026-06-01/LocalUserCreate.json
...
// Generated from example definition: 2026-06-01/LocalUserCreateNFSv3Enabled.json
...
// Generated from example definition: 2026-06-01/LocalUserUpdate.json
...
// Generated from example definition: 2026-06-01/LocalUserDelete.json
func ExampleLocalUsersClient_Delete() {
	...
	res, err := clientFactory.NewLocalUsersClient().Delete(ctx, "res6977", "sto2527", "user1", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armstorage.LocalUsersClientDeleteResponse{
	// }
}

// Generated from example definition: 2026-06-01/LocalUserGet.json
...
// Generated from example definition: 2026-06-01/LocalUsersList.json
func ExampleLocalUsersClient_NewListPager_listLocalUsers() {
	...
	for pager.More() {
		...
		// page = armstorage.LocalUsersClientListResponse{
...
// Generated from example definition: 2026-06-01/LocalUsersListNFSv3Enabled.json
func ExampleLocalUsersClient_NewListPager_listNfSv3EnabledLocalUsers() {
	...
	pager := clientFactory.NewLocalUsersClient().NewListPager("res6977", "sto2527", &armstorage.LocalUsersClientListOptions{
...
// Generated from example definition: 2026-06-01/LocalUserListKeys.json
...
// Generated from example definition: 2026-06-01/LocalUserRegeneratePassword.json
