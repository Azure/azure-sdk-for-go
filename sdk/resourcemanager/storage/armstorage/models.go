...
// LeaseContainerRequestAutoGenerated - Lease Container request schema.
type LeaseContainerRequestAutoGenerated struct {
	// REQUIRED; Specifies the lease action. Can be one of the available actions.
	Action *LeaseContainerRequest `json:"action,omitempty"`
