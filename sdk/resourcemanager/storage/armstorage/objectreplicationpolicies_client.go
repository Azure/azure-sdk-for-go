...
//     account first. For the source account, provide the value of the policy ID that is returned when you download the policy
//     that was defined on the destination account. The policy is downloaded as a JSON file.
