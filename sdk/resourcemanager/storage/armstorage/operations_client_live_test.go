...
type OperationsClientTestSuite struct {
	suite.Suite
...
func (testsuite *OperationsClientTestSuite) SetupSuite() {
...
func (testsuite *OperationsClientTestSuite) TearDownSuite() {
	_, err := testutil.DeleteResourceGroup(testsuite.ctx, testsuite.subscriptionID, testsuite.cred, testsuite.options, testsuite.resourceGroupName)
	testsuite.Require().NoError(err)
	testutil.StopRecording(testsuite.T())
}

func TestOperationsClient(t *testing.T) {
	suite.Run(t, new(OperationsClientTestSuite))
}
