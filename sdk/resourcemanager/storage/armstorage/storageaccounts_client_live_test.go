...
func (testsuite *StorageAccountsClientTestSuite) TestStorageAccountsCRUD() {
	...
	fmt.Println("Call operation: StorageAccount_CheckNameAvailability")
	...
	// update
	fmt.Println("Call operation: StorageAccount_Update")
	...
	// get properties
	fmt.Println("Call operation: StorageAccount_Get")
	...
	// list
	fmt.Println("Call operation: StorageAccount_List")
	listPager := storageAccountsClient.NewListPager(nil)
	testsuite.Require().True(listPager.More())

	// list by resource group
	fmt.Println("Call operation: StorageAccount_ListByResourceGroup")
	...
	// list keys
	fmt.Println("Call operation: StorageAccount_ListKeys")
	...
	fmt.Println("Call operation: StorageAccount_RevokeUserDelegationKeys")
	_, err = storageAccountsClient.RevokeUserDelegationKeys(testsuite.ctx, testsuite.resourceGroupName, scName, nil)
	testsuite.Require().NoError(err)

	// regenerate key
	fmt.Println("Call operation: StorageAccount_RegenerateKey")
	...
	// delete
	fmt.Println("Call operation: StorageAccount_Delete")
