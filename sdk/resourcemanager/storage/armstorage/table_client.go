...
func (client *TableClient) Create(ctx context.Context, resourceGroupName string, accountName string, tableName string, parameters Table, options *TableClientCreateOptions) (TableClientCreateResponse, error) {
	var err error
	const operationName = "TableClient.Create"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.createCreateRequest(ctx, resourceGroupName, accountName, tableName, parameters, options)
	if err != nil {
...
func (client *TableClient) createHandleResponse(resp *http.Response, successCodes ...int) (TableClientCreateResponse, error) {
...
func (client *TableClient) Delete(ctx context.Context, resourceGroupName string, accountName string, tableName string, options *TableClientDeleteOptions) (TableClientDeleteResponse, error) {
	...
	if !runtime.HasStatusCode(httpResp, http.StatusNoContent) {
		return TableClientDeleteResponse{}, runtime.NewResponseError(httpResp)
	}
...
func (client *TableClient) getHandleResponse(resp *http.Response, successCodes ...int) (TableClientGetResponse, error) {
...
func (client *TableClient) listCreateRequest(ctx context.Context, resourceGroupName string, accountName string, nextLink string, _ *TableClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *TableClient) listHandleResponse(resp *http.Response, successCodes ...int) (TableClientListResponse, error) {
...
func (client *TableClient) Update(ctx context.Context, resourceGroupName string, accountName string, tableName string, parameters Table, options *TableClientUpdateOptions) (TableClientUpdateResponse, error) {
	var err error
	const operationName = "TableClient.Update"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.updateCreateRequest(ctx, resourceGroupName, accountName, tableName, parameters, options)
	if err != nil {
...
func (client *TableClient) updateHandleResponse(resp *http.Response, successCodes ...int) (TableClientUpdateResponse, error) {
