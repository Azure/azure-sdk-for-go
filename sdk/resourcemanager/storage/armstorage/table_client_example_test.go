...
func ExampleTableClient_Create_tableOperationPut() {
	...
	res, err := client.Create(ctx, "res3376", "sto328", "table6185", armstorage.Table{}, nil)
	if err != nil {
...
func ExampleTableClient_Create_tableOperationPutOrPatchAcls() {
	...
	res, err := client.Create(ctx, "res3376", "sto328", "table6185", armstorage.Table{
...
func ExampleTableClient_Update_tableOperationPatch() {
	...
	res, err := client.Update(ctx, "res3376", "sto328", "table6185", armstorage.Table{}, nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// TODO: use response item
