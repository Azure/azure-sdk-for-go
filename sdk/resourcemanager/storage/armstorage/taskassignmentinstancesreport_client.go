...
func (client *TaskAssignmentInstancesReportClient) NewListPager(resourceGroupName string, accountName string, storageTaskAssignmentName string, options *TaskAssignmentInstancesReportClientListOptions) *runtime.Pager[TaskAssignmentInstancesReportClientListResponse] {
	return runtime.NewPager(runtime.PagingHandler[TaskAssignmentInstancesReportClientListResponse]{
		...
		Fetcher: func(ctx context.Context, page *TaskAssignmentInstancesReportClientListResponse) (TaskAssignmentInstancesReportClientListResponse, error) {
			...
			req, err := client.listCreateRequest(ctx, resourceGroupName, accountName, storageTaskAssignmentName, nextLink, options)
			if err != nil {
...
func (client *TaskAssignmentInstancesReportClient) listCreateRequest(ctx context.Context, resourceGroupName string, accountName string, storageTaskAssignmentName string, nextLink string, options *TaskAssignmentInstancesReportClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *TaskAssignmentInstancesReportClient) listHandleResponse(resp *http.Response, successCodes ...int) (TaskAssignmentInstancesReportClientListResponse, error) {
