...
// Generated from example definition: 2025-06-01/storageTaskAssignmentsList/ListStorageTaskAssignmentInstancesReportSummary.json
func ExampleTaskAssignmentInstancesReportClient_NewListPager() {
	...
	pager := clientFactory.NewTaskAssignmentInstancesReportClient().NewListPager("res4228", "sto4445", "myassignment1", nil)
	for pager.More() {
		...
		// page = armstorage.TaskAssignmentInstancesReportClientListResponse{
		// 	TaskReportSummary: armstorage.TaskReportSummary{
