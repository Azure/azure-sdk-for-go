...
// Generated from example definition: 2026-04-01/StorageAccountListLocationUsage.json
func ExampleUsagesClient_NewListByLocationPager() {
	...
	for pager.More() {
		...
		// page = armstorage.UsagesClientListByLocationResponse{
		// 	UsageListResult: armstorage.UsageListResult{
