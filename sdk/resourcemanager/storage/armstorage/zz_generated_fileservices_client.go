...
func (client *FileServicesClient) GetServiceProperties(ctx context.Context, resourceGroupName string, accountName string, fileServicesName Enum37, options *FileServicesGetServicePropertiesOptions) (FileServicesGetServicePropertiesResponse, error) {
...
func (client *FileServicesClient) getServicePropertiesCreateRequest(ctx context.Context, resourceGroupName string, accountName string, fileServicesName Enum37, options *FileServicesGetServicePropertiesOptions) (*policy.Request, error) {
	...
	urlPath = strings.ReplaceAll(urlPath, "{FileServicesName}", url.PathEscape(string(fileServicesName)))
...
// If the operation fails it returns the *CloudErrorAutoGenerated error type.
func (client *FileServicesClient) SetServiceProperties(ctx context.Context, resourceGroupName string, accountName string, fileServicesName Enum37, parameters FileServiceProperties, options *FileServicesSetServicePropertiesOptions) (FileServicesSetServicePropertiesResponse, error) {
...
func (client *FileServicesClient) setServicePropertiesCreateRequest(ctx context.Context, resourceGroupName string, accountName string, fileServicesName Enum37, parameters FileServiceProperties, options *FileServicesSetServicePropertiesOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Storage/storageAccounts/{accountName}/fileServices/{FileServicesName}"
	if resourceGroupName == "" {
		return nil, errors.New("parameter resourceGroupName cannot be empty")
	}
