...
func (client *QueueServicesClient) GetServiceProperties(ctx context.Context, resourceGroupName string, accountName string, queueServiceName Enum37, options *QueueServicesGetServicePropertiesOptions) (QueueServicesGetServicePropertiesResponse, error) {
	req, err := client.getServicePropertiesCreateRequest(ctx, resourceGroupName, accountName, queueServiceName, options)
	if err != nil {
...
func (client *QueueServicesClient) getServicePropertiesCreateRequest(ctx context.Context, resourceGroupName string, accountName string, queueServiceName Enum37, options *QueueServicesGetServicePropertiesOptions) (*policy.Request, error) {
	...
	if queueServiceName == "" {
		return nil, errors.New("parameter queueServiceName cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{queueServiceName}", url.PathEscape(string(queueServiceName)))
...
// Sharing) rules.
// If the operation fails it returns the *CloudErrorAutoGenerated error type.
func (client *QueueServicesClient) SetServiceProperties(ctx context.Context, resourceGroupName string, accountName string, queueServiceName Enum37, parameters QueueServiceProperties, options *QueueServicesSetServicePropertiesOptions) (QueueServicesSetServicePropertiesResponse, error) {
	req, err := client.setServicePropertiesCreateRequest(ctx, resourceGroupName, accountName, queueServiceName, parameters, options)
	if err != nil {
...
func (client *QueueServicesClient) setServicePropertiesCreateRequest(ctx context.Context, resourceGroupName string, accountName string, queueServiceName Enum37, parameters QueueServiceProperties, options *QueueServicesSetServicePropertiesOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Storage/storageAccounts/{accountName}/queueServices/{queueServiceName}"
	if resourceGroupName == "" {
		return nil, errors.New("parameter resourceGroupName cannot be empty")
	}
