...
func (client *TableServicesClient) GetServiceProperties(ctx context.Context, resourceGroupName string, accountName string, tableServiceName Enum37, options *TableServicesGetServicePropertiesOptions) (TableServicesGetServicePropertiesResponse, error) {
	req, err := client.getServicePropertiesCreateRequest(ctx, resourceGroupName, accountName, tableServiceName, options)
	if err != nil {
...
func (client *TableServicesClient) getServicePropertiesCreateRequest(ctx context.Context, resourceGroupName string, accountName string, tableServiceName Enum37, options *TableServicesGetServicePropertiesOptions) (*policy.Request, error) {
	...
	if tableServiceName == "" {
		return nil, errors.New("parameter tableServiceName cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{tableServiceName}", url.PathEscape(string(tableServiceName)))
...
// Sharing) rules.
// If the operation fails it returns the *CloudErrorAutoGenerated error type.
func (client *TableServicesClient) SetServiceProperties(ctx context.Context, resourceGroupName string, accountName string, tableServiceName Enum37, parameters TableServiceProperties, options *TableServicesSetServicePropertiesOptions) (TableServicesSetServicePropertiesResponse, error) {
	req, err := client.setServicePropertiesCreateRequest(ctx, resourceGroupName, accountName, tableServiceName, parameters, options)
	if err != nil {
...
func (client *TableServicesClient) setServicePropertiesCreateRequest(ctx context.Context, resourceGroupName string, accountName string, tableServiceName Enum37, parameters TableServiceProperties, options *TableServicesSetServicePropertiesOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Storage/storageAccounts/{accountName}/tableServices/{tableServiceName}"
	if resourceGroupName == "" {
		return nil, errors.New("parameter resourceGroupName cannot be empty")
	}
