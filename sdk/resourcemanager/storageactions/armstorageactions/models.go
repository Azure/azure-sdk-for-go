...
type StorageTaskOperation struct {
	...
	// CONSTANT; Action to be taken when the operation fails for a object.
	// Field has constant value "break", any specified value is ignored.
	OnFailure *string

	// CONSTANT; Action to be taken when the operation is successful for a object.
	// Field has constant value "continue", any specified value is ignored.
	OnSuccess *string
