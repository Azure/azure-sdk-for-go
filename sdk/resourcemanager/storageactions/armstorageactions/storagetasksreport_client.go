...
func (client *StorageTasksReportClient) listCreateRequest(ctx context.Context, resourceGroupName string, storageTaskName string, nextLink string, options *StorageTasksReportClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *StorageTasksReportClient) listHandleResponse(resp *http.Response, successCodes ...int) (StorageTasksReportClientListResponse, error) {
