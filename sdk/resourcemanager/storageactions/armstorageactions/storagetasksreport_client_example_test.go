...
func ExampleStorageTasksReportClient_List() {
	...
	res, err := clientFactory.NewStorageTasksReportClient().List(ctx, "rgroup1", "mytask1", nil)
	if err != nil {
	...
	// res = armstorageactions.StorageTasksReportClientListResponse{
