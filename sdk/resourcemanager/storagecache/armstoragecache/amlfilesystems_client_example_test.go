...
func ExampleAmlFilesystemsClient_Archive() {
	...
	res, err := clientFactory.NewAmlFilesystemsClient().Archive(ctx, "scgroup", "sc", &armstoragecache.AmlFilesystemsClientArchiveOptions{
		ArchiveInfo: &armstoragecache.AmlFilesystemArchiveInfo{
	...
	// res = armstoragecache.AmlFilesystemsClientArchiveResponse{
	// }
}
...
func ExampleAmlFilesystemsClient_CancelArchive() {
	...
	res, err := clientFactory.NewAmlFilesystemsClient().CancelArchive(ctx, "scgroup", "sc", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armstoragecache.AmlFilesystemsClientCancelArchiveResponse{
	// }
}
...
func ExampleAmlFilesystemsClient_BeginCreateOrUpdate() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armstoragecache.AmlFilesystemsClientCreateOrUpdateResponse{
...
func ExampleAmlFilesystemsClient_BeginDelete() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armstoragecache.AmlFilesystemsClientDeleteResponse{
	// }
}
...
func ExampleAmlFilesystemsClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armstoragecache.AmlFilesystemsClientGetResponse{
	// 	AmlFilesystem: armstoragecache.AmlFilesystem{
	// 		Name: to.Ptr("fs1"),
	// 		Type: to.Ptr("Microsoft.StorageCache/amlFilesystem"),
	// 		ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/scgroup/providers/Microsoft.StorageCache/amlFilesystems/fs1"),
...
func ExampleAmlFilesystemsClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armstoragecache.AmlFilesystemsClientListResponse{
		// 	AmlFilesystemsListResult: armstoragecache.AmlFilesystemsListResult{
...
func ExampleAmlFilesystemsClient_NewListByResourceGroupPager() {
	...
	for pager.More() {
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armstoragecache.AmlFilesystemsClientListByResourceGroupResponse{
		// 	AmlFilesystemsListResult: armstoragecache.AmlFilesystemsListResult{
		// 		Value: []*armstoragecache.AmlFilesystem{
		// 			{
		// 				Name: to.Ptr("fs1"),
...
func ExampleAmlFilesystemsClient_BeginUpdate() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armstoragecache.AmlFilesystemsClientUpdateResponse{
	// 	AmlFilesystem: armstoragecache.AmlFilesystem{
	// 		Name: to.Ptr("fs1"),
	// 		Type: to.Ptr("Microsoft.StorageCache/amlFilesystem"),
	// 		ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/scgroup/providers/Microsoft.StorageCache/amlFilesystems/fs1"),
