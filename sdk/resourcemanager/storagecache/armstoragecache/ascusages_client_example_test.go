...
// Generated from example definition: 2026-01-01/AscResourceUsages_Get.json
func ExampleAscUsagesClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armstoragecache.AscUsagesClientListResponse{
		// 	ResourceUsagesListResult: armstoragecache.ResourceUsagesListResult{
