...
func (client *CachesClient) BeginCreateOrUpdate(ctx context.Context, resourceGroupName string, cacheName string, cache Cache, options *CachesClientBeginCreateOrUpdateOptions) (*runtime.Poller[CachesClientCreateOrUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		poller, err := runtime.NewPoller[CachesClientCreateOrUpdateResponse](resp, client.internal.Pipeline(), nil)
		return poller, err
	} else {
...
func (client *CachesClient) BeginDelete(ctx context.Context, resourceGroupName string, cacheName string, options *CachesClientBeginDeleteOptions) (*runtime.Poller[CachesClientDeleteResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		poller, err := runtime.NewPoller[CachesClientDeleteResponse](resp, client.internal.Pipeline(), nil)
		return poller, err
	} else {
...
func (client *CachesClient) BeginUpdate(ctx context.Context, resourceGroupName string, cacheName string, options *CachesClientBeginUpdateOptions) (*runtime.Poller[CachesClientUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.update(ctx, resourceGroupName, cacheName, options)
		if err != nil {
			return nil, err
		}
...
//
// Generated from API version 2023-05-01
func (client *CachesClient) update(ctx context.Context, resourceGroupName string, cacheName string, options *CachesClientBeginUpdateOptions) (*http.Response, error) {
	var err error
...
func (client *CachesClient) updateCreateRequest(ctx context.Context, resourceGroupName string, cacheName string, options *CachesClientBeginUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/Microsoft.StorageCache/caches/{cacheName}"
	if resourceGroupName == "" {
		return nil, errors.New("parameter resourceGroupName cannot be empty")
	}
	...
	if options != nil && options.Cache != nil {
		if err := runtime.MarshalAsJSON(req, *options.Cache); err != nil {
	return nil, err
}
		return req, nil
	}
