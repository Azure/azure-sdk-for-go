...
func ExampleCachesClient_BeginCreateOrUpdate_cachesCreateOrUpdate() {
	...
	// res = armstoragecache.CachesClientCreateOrUpdateResponse{
	...
	// 				},
	// 			},
	// 			ProvisioningState: to.Ptr(armstoragecache.ProvisioningStateTypeUpdating),
	// 			SecuritySettings: &armstoragecache.CacheSecuritySettings{
	// 				AccessPolicies: []*armstoragecache.NfsAccessPolicy{
	// 					{
	// 						Name: to.Ptr("default"),
...
func ExampleCachesClient_BeginDebugInfo() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armstoragecache.CachesClientDebugInfoResponse{
	// }
}
...
func ExampleCachesClient_BeginDelete() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armstoragecache.CachesClientDeleteResponse{
	// }
}
...
func ExampleCachesClient_BeginFlush() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armstoragecache.CachesClientFlushResponse{
	// }
}
...
func ExampleCachesClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armstoragecache.CachesClientGetResponse{
	// 	Cache: armstoragecache.Cache{
	// 		Name: to.Ptr("sc1"),
	// 		Type: to.Ptr("Microsoft.StorageCache/Cache"),
	// 		ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/scgroup/providers/Microsoft.StorageCache/caches/sc1"),
...
func ExampleCachesClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armstoragecache.CachesClientListResponse{
		// 	CachesListResult: armstoragecache.CachesListResult{
...
func ExampleCachesClient_NewListByResourceGroupPager() {
	...
	for pager.More() {
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armstoragecache.CachesClientListByResourceGroupResponse{
		// 	CachesListResult: armstoragecache.CachesListResult{
		// 		Value: []*armstoragecache.Cache{
		// 			{
		// 				Name: to.Ptr("sc1"),
...
func ExampleCachesClient_BeginPausePrimingJob() {
	...
	poller, err := clientFactory.NewCachesClient().BeginPausePrimingJob(ctx, "scgroup", "sc1", &armstoragecache.CachesClientBeginPausePrimingJobOptions{
		PrimingJobID: &armstoragecache.PrimingJobIDParameter{
			PrimingJobID: to.Ptr("00000000000_0000000000"),
		}})
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
...
func ExampleCachesClient_BeginResumePrimingJob() {
	...
	poller, err := clientFactory.NewCachesClient().BeginResumePrimingJob(ctx, "scgroup", "sc1", &armstoragecache.CachesClientBeginResumePrimingJobOptions{
		PrimingJobID: &armstoragecache.PrimingJobIDParameter{
			PrimingJobID: to.Ptr("00000000000_0000000000"),
		}})
	if err != nil {
...
func ExampleCachesClient_BeginStart() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armstoragecache.CachesClientStartResponse{
	// }
}
...
func ExampleCachesClient_BeginStartPrimingJob() {
	...
	poller, err := clientFactory.NewCachesClient().BeginStartPrimingJob(ctx, "scgroup", "sc1", &armstoragecache.CachesClientBeginStartPrimingJobOptions{
		Primingjob: &armstoragecache.PrimingJob{
...
func ExampleCachesClient_BeginStop() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armstoragecache.CachesClientStopResponse{
	// }
}
...
func ExampleCachesClient_BeginStopPrimingJob() {
	...
	poller, err := clientFactory.NewCachesClient().BeginStopPrimingJob(ctx, "scgroup", "sc1", &armstoragecache.CachesClientBeginStopPrimingJobOptions{
		PrimingJobID: &armstoragecache.PrimingJobIDParameter{
			PrimingJobID: to.Ptr("00000000000_0000000000"),
		}})
	if err != nil {
...
func ExampleCachesClient_BeginUpdate_cachesUpdate() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armstoragecache.CachesClientUpdateResponse{
	// 	Cache: armstoragecache.Cache{
	// 		Name: to.Ptr("sc1"),
	// 		Type: to.Ptr("Microsoft.StorageCache/Cache"),
	// 		ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/scgroup/providers/Microsoft.StorageCache/caches/sc1"),
