...
func (s *StorageTargetServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	resultChan := make(chan result, 1)
	go func() {
		var intercepted bool
		var res result
		if storageTargetServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = storageTargetServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			case "StorageTargetClient.BeginFlush":
				res.resp, res.err = s.dispatchBeginFlush(req)
			case "StorageTargetClient.BeginInvalidate":
				res.resp, res.err = s.dispatchBeginInvalidate(req)
			case "StorageTargetClient.BeginResume":
				res.resp, res.err = s.dispatchBeginResume(req)
			case "StorageTargetClient.BeginSuspend":
				res.resp, res.err = s.dispatchBeginSuspend(req)
			default:
...
func (s *StorageTargetServerTransport) dispatchBeginFlush(req *http.Request) (*http.Response, error) {
	...
	if beginFlush == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.StorageCache/caches/(?P<cacheName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/storageTargets/(?P<storageTargetName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/flush`
...
func (s *StorageTargetServerTransport) dispatchBeginInvalidate(req *http.Request) (*http.Response, error) {
	...
	if beginInvalidate == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.StorageCache/caches/(?P<cacheName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/storageTargets/(?P<storageTargetName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/invalidate`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 5 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
...
func (s *StorageTargetServerTransport) dispatchBeginResume(req *http.Request) (*http.Response, error) {
	...
	if beginResume == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.StorageCache/caches/(?P<cacheName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/storageTargets/(?P<storageTargetName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resume`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 5 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
...
func (s *StorageTargetServerTransport) dispatchBeginSuspend(req *http.Request) (*http.Response, error) {
	...
	if beginSuspend == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.StorageCache/caches/(?P<cacheName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/storageTargets/(?P<storageTargetName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/suspend`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 5 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
...
// set this to conditionally intercept incoming requests to StorageTargetServerTransport
var storageTargetServerTransportInterceptor interface {
