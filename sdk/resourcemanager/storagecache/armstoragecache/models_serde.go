...
func (a AmlFilesystemArchiveStatus) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "lastCompletionTime", a.LastCompletionTime)
	populateTime[datetime.RFC3339](objectMap, "lastStartedTime", a.LastStartedTime)
...
func (a AutoExportJobPropertiesStatus) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "lastCompletionTimeUTC", a.LastCompletionTimeUTC)
	populateTime[datetime.RFC3339](objectMap, "lastStartedTimeUTC", a.LastStartedTimeUTC)
	populateTime[datetime.RFC3339](objectMap, "lastSuccessfulIterationCompletionTimeUTC", a.LastSuccessfulIterationCompletionTimeUTC)
	populate(objectMap, "state", a.State)
	populate(objectMap, "statusCode", a.StatusCode)
...
func (a AutoImportJobPropertiesStatus) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "scanEndTime", a.ScanEndTime)
	populateTime[datetime.RFC3339](objectMap, "scanStartTime", a.ScanStartTime)
	populate(objectMap, "state", a.State)
	populate(objectMap, "statusCode", a.StatusCode)
	populate(objectMap, "statusMessage", a.StatusMessage)
...
func (a AutoImportJobPropertiesStatusBlobSyncEvents) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "importedFiles", a.ImportedFiles)
	populate(objectMap, "importedSymlinks", a.ImportedSymlinks)
	populateTime[datetime.RFC3339](objectMap, "lastChangeFeedEventConsumedTime", a.LastChangeFeedEventConsumedTime)
	populateTime[datetime.RFC3339](objectMap, "lastTimeFullySynchronized", a.LastTimeFullySynchronized)
	populate(objectMap, "preexistingDirectories", a.PreexistingDirectories)
	populate(objectMap, "preexistingFiles", a.PreexistingFiles)
	populate(objectMap, "preexistingSymlinks", a.PreexistingSymlinks)
	populate(objectMap, "rateOfBlobImport", a.RateOfBlobImport)
...
func (c CacheUpgradeSettings) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateTime[datetime.RFC3339](objectMap, "scheduledTime", c.ScheduledTime)
...
func (c CacheUpgradeStatus) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "firmwareUpdateDeadline", c.FirmwareUpdateDeadline)
	populate(objectMap, "firmwareUpdateStatus", c.FirmwareUpdateStatus)
	populateTime[datetime.RFC3339](objectMap, "lastFirmwareUpdate", c.LastFirmwareUpdate)
...
func (e ExpansionJobPropertiesStatus) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateTime[datetime.RFC3339](objectMap, "completionTimeUTC", e.CompletionTimeUTC)
...
func (i ImportJobPropertiesStatus) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "lastCompletionTime", i.LastCompletionTime)
	populateTime[datetime.RFC3339](objectMap, "lastStartedTime", i.LastStartedTime)
