...
// Generated from example definition: 2026-01-01/Operations_List.json
func ExampleOperationsClient_NewListPager() {
	...
	clientFactory, err := armstoragecache.NewClientFactory("<subscriptionID>", cred, nil)
	if err != nil {
	...
	for pager.More() {
		...
		// page = armstoragecache.OperationsClientListResponse{
		// 	APIOperationListResult: armstoragecache.APIOperationListResult{
