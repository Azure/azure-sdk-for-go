...
// AutoImportJobsClientBeginCreateOrUpdateOptions contains the optional parameters for the AutoImportJobsClient.BeginCreateOrUpdate
// method.
type AutoImportJobsClientBeginCreateOrUpdateOptions struct {
	// Resumes the long-running operation from the provided token.
	ResumeToken string
}

// AutoImportJobsClientBeginDeleteOptions contains the optional parameters for the AutoImportJobsClient.BeginDelete method.
type AutoImportJobsClientBeginDeleteOptions struct {
	// Resumes the long-running operation from the provided token.
	ResumeToken string
}

// AutoImportJobsClientBeginUpdateOptions contains the optional parameters for the AutoImportJobsClient.BeginUpdate method.
type AutoImportJobsClientBeginUpdateOptions struct {
	// Resumes the long-running operation from the provided token.
	ResumeToken string
}

// AutoImportJobsClientGetOptions contains the optional parameters for the AutoImportJobsClient.Get method.
type AutoImportJobsClientGetOptions struct {
	// placeholder for future optional parameters
}

// AutoImportJobsClientListByAmlFilesystemOptions contains the optional parameters for the AutoImportJobsClient.NewListByAmlFilesystemPager
// method.
type AutoImportJobsClientListByAmlFilesystemOptions struct {
	// placeholder for future optional parameters
}
