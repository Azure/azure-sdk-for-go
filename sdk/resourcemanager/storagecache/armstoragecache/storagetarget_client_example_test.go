...
func ExampleStorageTargetClient_BeginFlush() {
	...
	// res = armstoragecache.StorageTargetClientFlushResponse{
	// }
}
...
func ExampleStorageTargetClient_BeginInvalidate() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armstoragecache.StorageTargetClientInvalidateResponse{
	// }
}
...
func ExampleStorageTargetClient_BeginResume() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armstoragecache.StorageTargetClientResumeResponse{
	// }
}
...
func ExampleStorageTargetClient_BeginSuspend() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armstoragecache.StorageTargetClientSuspendResponse{
	// }
}
