...
// unhealthy, the actual removal of the Storage Target may be delayed until the cache is healthy again. Note that if the cache
// has data to flush to the Storage Target, the data will be flushed before the Storage Target will be deleted.
// If the operation fails it returns an *azcore.ResponseError type.
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - cacheName - Name of cache. Length of name must not be greater than 80 and chars must be from the [-0-9a-zA-Z_] char class.
//   - storageTargetName - Name of Storage Target.
...
// the actual removal of the Storage Target may be delayed until the cache is healthy again. Note that if the cache has data
...
func (client *StorageTargetsClient) getHandleResponse(resp *http.Response, successCodes ...int) (StorageTargetsClientGetResponse, error) {
...
func (client *StorageTargetsClient) NewListByCachePager(resourceGroupName string, cacheName string, options *StorageTargetsClientListByCacheOptions) *runtime.Pager[StorageTargetsClientListByCacheResponse] {
	return runtime.NewPager(runtime.PagingHandler[StorageTargetsClientListByCacheResponse]{
		...
		Fetcher: func(ctx context.Context, page *StorageTargetsClientListByCacheResponse) (StorageTargetsClientListByCacheResponse, error) {
			...
			req, err := client.listByCacheCreateRequest(ctx, resourceGroupName, cacheName, nextLink, options)
			if err != nil {
			...
			return client.listByCacheHandleResponse(resp, http.StatusOK)
		},
		Tracer: client.internal.Tracer(),
	})
}
...
func (client *StorageTargetsClient) listByCacheCreateRequest(ctx context.Context, resourceGroupName string, cacheName string, nextLink string, _ *StorageTargetsClientListByCacheOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *StorageTargetsClient) listByCacheHandleResponse(resp *http.Response, successCodes ...int) (StorageTargetsClientListByCacheResponse, error) {
