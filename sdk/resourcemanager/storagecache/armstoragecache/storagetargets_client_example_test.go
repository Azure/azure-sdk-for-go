...
func ExampleStorageTargetsClient_BeginCreateOrUpdate_storageTargetsCreateOrUpdate() {
	...
	// res = armstoragecache.StorageTargetsClientCreateOrUpdateResponse{
	// 	StorageTarget: armstoragecache.StorageTarget{
	// 		Name: to.Ptr("st1"),
...
func ExampleStorageTargetsClient_BeginDNSRefresh() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armstoragecache.StorageTargetsClientDNSRefreshResponse{
	// }
}
...
func ExampleStorageTargetsClient_BeginDelete() {
	...
	poller, err := clientFactory.NewStorageTargetsClient().BeginDelete(ctx, "scgroup", "sc1", "st1", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	res, err := poller.PollUntilDone(ctx, nil)
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armstoragecache.StorageTargetsClientDeleteResponse{
	// }
}
...
func ExampleStorageTargetsClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armstoragecache.StorageTargetsClientGetResponse{
	// 	StorageTarget: armstoragecache.StorageTarget{
	// 		Name: to.Ptr("st1"),
	// 		Type: to.Ptr("Microsoft.StorageCache/Cache/StorageTarget"),
	// 		ID: to.Ptr("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/scgroup/providers/Microsoft.StorageCache/caches/sc1/storagetargets/st1"),
...
func ExampleStorageTargetsClient_NewListByCachePager() {
	...
	for pager.More() {
		...
		// page = armstoragecache.StorageTargetsClientListByCacheResponse{
		// 	StorageTargetsResult: armstoragecache.StorageTargetsResult{
...
func ExampleStorageTargetsClient_BeginRestoreDefaults() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armstoragecache.StorageTargetsClientRestoreDefaultsResponse{
	// }
}
