...
// Generated from example definition: 2026-01-01/UsageModels_List.json
func ExampleUsageModelsClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armstoragecache.UsageModelsClientListResponse{
		// 	UsageModelsResult: armstoragecache.UsageModelsResult{
