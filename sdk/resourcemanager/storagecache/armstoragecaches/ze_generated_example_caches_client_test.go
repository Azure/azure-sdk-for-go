...
func ExampleCachesClient_List() {
	...
	client := armstoragecaches.NewCachesClient("<subscription-id>", cred, nil)
...
func ExampleCachesClient_BeginCreateOrUpdate() {
	...
	poller, err := client.BeginCreateOrUpdate(ctx,
		"<resource-group-name>",
		"<cache-name>",
		&armstoragecaches.CachesBeginCreateOrUpdateOptions{Cache: &armstoragecaches.Cache{
			Identity: &armstoragecaches.CacheIdentity{
				Type: armstoragecaches.CacheIdentityTypeUserAssigned.ToPtr(),
				UserAssignedIdentities: map[string]*armstoragecaches.UserAssignedIdentitiesValue{
			...
			Properties: &armstoragecaches.CacheProperties{
				CacheSizeGB: to.Int32Ptr(3072),
				DirectoryServicesSettings: &armstoragecaches.CacheDirectorySettings{
					ActiveDirectory: &armstoragecaches.CacheActiveDirectorySettings{
						CacheNetBiosName: to.StringPtr("<cache-net-bios-name>"),
						Credentials: &armstoragecaches.CacheActiveDirectorySettingsCredentials{
					...
					UsernameDownload: &armstoragecaches.CacheUsernameDownloadSettings{
						Credentials: &armstoragecaches.CacheUsernameDownloadSettingsCredentials{
						...
						UsernameSource: armstoragecaches.UsernameSourceLDAP.ToPtr(),
					},
				},
				EncryptionSettings: &armstoragecaches.CacheEncryptionSettings{
					KeyEncryptionKey: &armstoragecaches.KeyVaultKeyReference{
						KeyURL: to.StringPtr("<key-url>"),
						SourceVault: &armstoragecaches.KeyVaultKeyReferenceSourceVault{
							ID: to.StringPtr("<id>"),
						},
					},
				},
				SecuritySettings: &armstoragecaches.CacheSecuritySettings{
					AccessPolicies: []*armstoragecaches.NfsAccessPolicy{
						{
							Name: to.StringPtr("<name>"),
							AccessRules: []*armstoragecaches.NfsAccessRule{
								{
									Access:         armstoragecaches.NfsAccessRuleAccessRw.ToPtr(),
									RootSquash:     to.BoolPtr(false),
									Scope:          armstoragecaches.NfsAccessRuleScopeDefault.ToPtr(),
...
func ExampleCachesClient_Update() {
	...
	res, err := client.Update(ctx,
		"<resource-group-name>",
		"<cache-name>",
		&armstoragecaches.CachesUpdateOptions{Cache: &armstoragecaches.Cache{
			Location: to.StringPtr("<location>"),
			Properties: &armstoragecaches.CacheProperties{
				CacheSizeGB: to.Int32Ptr(3072),
				DirectoryServicesSettings: &armstoragecaches.CacheDirectorySettings{
					...
					UsernameDownload: &armstoragecaches.CacheUsernameDownloadSettings{
						ExtendedGroups: to.BoolPtr(true),
						UsernameSource: armstoragecaches.UsernameSourceAD.ToPtr(),
					},
				},
				NetworkSettings: &armstoragecaches.CacheNetworkSettings{
							...
							AccessRules: []*armstoragecaches.NfsAccessRule{
								{
									...
									RootSquash:     to.BoolPtr(false),
									Scope:          armstoragecaches.NfsAccessRuleScopeHost.ToPtr(),
									SubmountAccess: to.BoolPtr(true),
								...
								},
								{
									...
									Filter:         to.StringPtr("<filter>"),
									RootSquash:     to.BoolPtr(false),
									Scope:          armstoragecaches.NfsAccessRuleScopeNetwork.ToPtr(),
									SubmountAccess: to.BoolPtr(true),
									Suid:           to.BoolPtr(true),
								},
								{
									Access:         armstoragecaches.NfsAccessRuleAccessNo.ToPtr(),
