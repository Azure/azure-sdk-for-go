...
// ResourceType - Storage Discovery Resource Type
type ResourceType string

const (
	// ResourceTypeStorageAccounts - Storage Account Resource Type
	ResourceTypeStorageAccounts ResourceType = "Microsoft.Storage/storageAccounts"
)

// PossibleResourceTypeValues returns the possible values for the ResourceType const type.
func PossibleResourceTypeValues() []ResourceType {
	return []ResourceType{
		ResourceTypeStorageAccounts,
	}
}

// SKU - Storage Discovery Sku
type SKU string

const (
	// SKUFree - Free Sku
	SKUFree SKU = "Free"
	// SKUStandard - Standard Sku
