...
// The returned ServerFactoryTransport instance is connected to an instance of armstorageimportexport.ClientFactory via the
...
// ServerFactoryTransport connects instances of armstorageimportexport.ClientFactory to instances of ServerFactory.
// Don't use this type directly, use NewServerFactoryTransport instead.
type ServerFactoryTransport struct {
	srv                   *ServerFactory
	trMu                  sync.Mutex
	trBitLockerKeysServer *BitLockerKeysServerTransport
...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	switch client {
	case "BitLockerKeysClient":
		initServer(s, &s.trBitLockerKeysServer, func() *BitLockerKeysServerTransport {
			return NewBitLockerKeysServerTransport(&s.srv.BitLockerKeysServer)
		})
		resp, err = s.trBitLockerKeysServer.Do(req)
	case "JobsClient":
