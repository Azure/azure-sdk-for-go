...
func (a *AgentProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "lastStatusUpdate":
			err = unpopulateTimeRFC3339(val, "LastStatusUpdate", &a.LastStatusUpdate)
			delete(rawMsg, key)
		case "localIPAddress":
...
func (j *JobRunProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "bytesDesignatedForTransfer":
			err = unpopulate(val, "BytesDesignatedForTransfer", &j.BytesDesignatedForTransfer)
			delete(rawMsg, key)
		case "bytesExcluded":
		...
		case "executionStartTime":
			err = unpopulateTimeRFC3339(val, "ExecutionStartTime", &j.ExecutionStartTime)
			delete(rawMsg, key)
		case "itemsDesignatedForTransfer":
			err = unpopulate(val, "ItemsDesignatedForTransfer", &j.ItemsDesignatedForTransfer)
			delete(rawMsg, key)
		case "itemsExcluded":
		...
		case "lastUpdatedTime":
			err = unpopulateTimeRFC3339(val, "LastUpdatedTime", &j.LastUpdatedTime)
			delete(rawMsg, key)
		case "provisioningState":
			err = unpopulate(val, "ProvisioningState", &j.ProvisioningState)
			delete(rawMsg, key)
...
func (n *NfsMountEndpointProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "provisioningState":
			...
			delete(rawMsg, key)
		case "remoteExport":
			err = unpopulate(val, "RemoteExport", &n.RemoteExport)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", n, err)
