...
func (client *ProjectsClient) listCreateRequest(ctx context.Context, resourceGroupName string, storageMoverName string, nextLink string, _ *ProjectsClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
