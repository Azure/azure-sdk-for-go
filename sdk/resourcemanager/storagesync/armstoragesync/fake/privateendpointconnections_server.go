...
// The returned PrivateEndpointConnectionsServerTransport instance is connected to an instance of armstoragesync.PrivateEndpointConnectionsClient via the
// azcore.ClientOptions.Transporter field in the client's constructor parameters.
func NewPrivateEndpointConnectionsServerTransport(srv *PrivateEndpointConnectionsServer) *PrivateEndpointConnectionsServerTransport {
	return &PrivateEndpointConnectionsServerTransport{
		srv:                              srv,
		beginCreate:                      newTracker[azfake.PollerResponder[armstoragesync.PrivateEndpointConnectionsClientCreateResponse]](),
		beginDelete:                      newTracker[azfake.PollerResponder[armstoragesync.PrivateEndpointConnectionsClientDeleteResponse]](),
		newListByStorageSyncServicePager: newTracker[azfake.PagerResponder[armstoragesync.PrivateEndpointConnectionsClientListByStorageSyncServiceResponse]](),
	}
}

// PrivateEndpointConnectionsServerTransport connects instances of armstoragesync.PrivateEndpointConnectionsClient to instances of PrivateEndpointConnectionsServer.
...
type PrivateEndpointConnectionsServerTransport struct {
	...
	beginCreate                      *tracker[azfake.PollerResponder[armstoragesync.PrivateEndpointConnectionsClientCreateResponse]]
	beginDelete                      *tracker[azfake.PollerResponder[armstoragesync.PrivateEndpointConnectionsClientDeleteResponse]]
	newListByStorageSyncServicePager *tracker[azfake.PagerResponder[armstoragesync.PrivateEndpointConnectionsClientListByStorageSyncServiceResponse]]
}
...
func (p *PrivateEndpointConnectionsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		if !intercepted {
			...
			case "PrivateEndpointConnectionsClient.NewListByStorageSyncServicePager":
				res.resp, res.err = p.dispatchNewListByStorageSyncServicePager(req)
			default:
...
func (p *PrivateEndpointConnectionsServerTransport) dispatchBeginCreate(req *http.Request) (*http.Response, error) {
	...
	if beginCreate == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.StorageSync/storageSyncServices/(?P<storageSyncServiceName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/privateEndpointConnections/(?P<privateEndpointConnectionName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 5 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
		}
		body, err := server.UnmarshalRequestAsJSON[armstoragesync.PrivateEndpointConnection](req)
		if err != nil {
			return nil, err
		}
		...
		respr, errRespr := p.srv.BeginCreate(req.Context(), resourceGroupNameParam, storageSyncServiceNameParam, privateEndpointConnectionNameParam, body, nil)
...
func (p *PrivateEndpointConnectionsServerTransport) dispatchBeginDelete(req *http.Request) (*http.Response, error) {
	...
	if beginDelete == nil {
		...
		respr, errRespr := p.srv.BeginDelete(req.Context(), resourceGroupNameParam, storageSyncServiceNameParam, privateEndpointConnectionNameParam, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginDelete = &respr
...
func (p *PrivateEndpointConnectionsServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := p.srv.Get(req.Context(), resourceGroupNameParam, storageSyncServiceNameParam, privateEndpointConnectionNameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
...
func (p *PrivateEndpointConnectionsServerTransport) dispatchNewListByStorageSyncServicePager(req *http.Request) (*http.Response, error) {
	if p.srv.NewListByStorageSyncServicePager == nil {
		return nil, &nonRetriableError{errors.New("fake for method NewListByStorageSyncServicePager not implemented")}
	}
	newListByStorageSyncServicePager := p.newListByStorageSyncServicePager.get(req)
	if newListByStorageSyncServicePager == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.StorageSync/storageSyncServices/(?P<storageSyncServiceName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/privateEndpointConnections`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 4 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
		...
		resp := p.srv.NewListByStorageSyncServicePager(resourceGroupNameParam, storageSyncServiceNameParam, nil)
		newListByStorageSyncServicePager = &resp
		p.newListByStorageSyncServicePager.add(req, newListByStorageSyncServicePager)
		server.PagerResponderInjectNextLinks(newListByStorageSyncServicePager, req, func(page *armstoragesync.PrivateEndpointConnectionsClientListByStorageSyncServiceResponse, createLink func() string) {
	...
	if !slices.Contains([]int{http.StatusOK}, resp.StatusCode) {
		p.newListByStorageSyncServicePager.remove(req)
