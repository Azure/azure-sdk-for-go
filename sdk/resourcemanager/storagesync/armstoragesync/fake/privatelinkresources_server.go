	...
	go func() {
		...
		if !intercepted {
			...
			case "PrivateLinkResourcesClient.ListByStorageSyncService":
				res.resp, res.err = p.dispatchListByStorageSyncService(req)
			default:
...
func (p *PrivateLinkResourcesServerTransport) dispatchListByStorageSyncService(req *http.Request) (*http.Response, error) {
	...
	const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.StorageSync/storageSyncServices/(?P<storageSyncServiceName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/privateLinkResources`
