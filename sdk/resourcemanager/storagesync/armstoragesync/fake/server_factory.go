...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "CloudEndpointsClient":
		initServer(&s.trMu, &s.trCloudEndpointsServer, func() *CloudEndpointsServerTransport {
	...
	case "MicrosoftStorageSyncClient":
		initServer(&s.trMu, &s.trMicrosoftStorageSyncServer, func() *MicrosoftStorageSyncServerTransport {
	...
	case "RegisteredServersClient":
		initServer(&s.trMu, &s.trRegisteredServersServer, func() *RegisteredServersServerTransport {
	...
	case "ServerEndpointsClient":
		initServer(&s.trMu, &s.trServerEndpointsServer, func() *ServerEndpointsServerTransport {
