...
func ExampleMicrosoftStorageSyncClient_LocationOperationStatus() {
	...
	// 		EndTime: to.Ptr(time.Date(2021, time.September, 14, 19, 59, 30, 805527900, time.UTC)),
	...
	// 		StartTime: to.Ptr(time.Date(2021, time.September, 14, 19, 59, 24, 624768800, time.UTC)),
