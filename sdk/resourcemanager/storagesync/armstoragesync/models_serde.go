...
func (c CloudEndpointChangeEnumerationActivity) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "startedTimestamp", c.StartedTimestamp, true)
...
func (c *CloudEndpointChangeEnumerationActivity) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "startedTimestamp":
			err = unpopulateTime[datetime.RFC3339](val, "StartedTimestamp", &c.StartedTimestamp)
			delete(rawMsg, key)
		case "statusCode":
...
func (c CloudEndpointLastChangeEnumerationStatus) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateTime[datetime.RFC3339](objectMap, "completedTimestamp", c.CompletedTimestamp, true)
	...
	populateTime[datetime.RFC3339](objectMap, "nextRunTimestamp", c.NextRunTimestamp, true)
	populateTime[datetime.RFC3339](objectMap, "startedTimestamp", c.StartedTimestamp, true)
	return json.Marshal(objectMap)
}
...
func (c *CloudEndpointLastChangeEnumerationStatus) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "completedTimestamp":
			err = unpopulateTime[datetime.RFC3339](val, "CompletedTimestamp", &c.CompletedTimestamp)
			delete(rawMsg, key)
		...
		case "nextRunTimestamp":
			err = unpopulateTime[datetime.RFC3339](val, "NextRunTimestamp", &c.NextRunTimestamp)
			delete(rawMsg, key)
		case "startedTimestamp":
			err = unpopulateTime[datetime.RFC3339](val, "StartedTimestamp", &c.StartedTimestamp)
			delete(rawMsg, key)
...
func (c CloudTieringDatePolicyStatus) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateTime[datetime.RFC3339](objectMap, "lastUpdatedTimestamp", c.LastUpdatedTimestamp, true)
	populateTime[datetime.RFC3339](objectMap, "tieredFilesMostRecentAccessTimestamp", c.TieredFilesMostRecentAccessTimestamp, true)
	return json.Marshal(objectMap)
}
...
func (c *CloudTieringDatePolicyStatus) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "tieredFilesMostRecentAccessTimestamp":
			err = unpopulateTime[datetime.RFC3339](val, "TieredFilesMostRecentAccessTimestamp", &c.TieredFilesMostRecentAccessTimestamp)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %s", c, err.Error())
...
func (o OperationResourceMetricSpecification) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "lockAggregationType", o.LockAggregationType)
	populate(objectMap, "name", o.Name)
...
func (o *OperationResourceMetricSpecification) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "lockAggregationType":
			err = unpopulate(val, "LockAggregationType", &o.LockAggregationType)
			delete(rawMsg, key)
		case "name":
			err = unpopulate(val, "Name", &o.Name)
			delete(rawMsg, key)
...
func (r RegisteredServerProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "activeAuthType", r.ActiveAuthType)
	populate(objectMap, "agentVersion", r.AgentVersion)
	populateTime[datetime.RFC3339](objectMap, "agentVersionExpirationDate", r.AgentVersionExpirationDate, true)
	...
	populate(objectMap, "latestApplicationId", r.LatestApplicationID)
...
func (r *RegisteredServerProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "activeAuthType":
			err = unpopulate(val, "ActiveAuthType", &r.ActiveAuthType)
			delete(rawMsg, key)
		case "agentVersion":
			err = unpopulate(val, "AgentVersion", &r.AgentVersion)
			delete(rawMsg, key)
		case "agentVersionExpirationDate":
			err = unpopulateTime[datetime.RFC3339](val, "AgentVersionExpirationDate", &r.AgentVersionExpirationDate)
			delete(rawMsg, key)
		...
		case "latestApplicationId":
			err = unpopulate(val, "LatestApplicationID", &r.LatestApplicationID)
			delete(rawMsg, key)
...
// MarshalJSON implements the json.Marshaller interface for type RegisteredServerUpdateParameters.
func (r RegisteredServerUpdateParameters) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "id", r.ID)
	populate(objectMap, "name", r.Name)
	populate(objectMap, "properties", r.Properties)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type RegisteredServerUpdateParameters.
func (r *RegisteredServerUpdateParameters) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %s", r, err.Error())
	}
...
// MarshalJSON implements the json.Marshaller interface for type RegisteredServerUpdateProperties.
func (r RegisteredServerUpdateProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "applicationId", r.ApplicationID)
	populate(objectMap, "identity", r.Identity)
	return json.Marshal(objectMap)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type RegisteredServerUpdateProperties.
func (r *RegisteredServerUpdateProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %s", r, err.Error())
	}
...
func (s ServerEndpointBackgroundDataDownloadActivity) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "startedTimestamp", s.StartedTimestamp, true)
...
func (s *ServerEndpointBackgroundDataDownloadActivity) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "percentProgress":
			...
			delete(rawMsg, key)
		case "startedTimestamp":
			err = unpopulateTime[datetime.RFC3339](val, "StartedTimestamp", &s.StartedTimestamp)
			delete(rawMsg, key)
		case "timestamp":
...
func (s ServerEndpointCloudTieringStatus) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "healthLastUpdatedTimestamp", s.HealthLastUpdatedTimestamp, true)
	populate(objectMap, "lastCloudTieringResult", s.LastCloudTieringResult)
	populateTime[datetime.RFC3339](objectMap, "lastSuccessTimestamp", s.LastSuccessTimestamp, true)
	populateTime[datetime.RFC3339](objectMap, "lastUpdatedTimestamp", s.LastUpdatedTimestamp, true)
...
func (s *ServerEndpointCloudTieringStatus) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "healthLastUpdatedTimestamp":
			err = unpopulateTime[datetime.RFC3339](val, "HealthLastUpdatedTimestamp", &s.HealthLastUpdatedTimestamp)
			delete(rawMsg, key)
		case "lastCloudTieringResult":
			err = unpopulate(val, "LastCloudTieringResult", &s.LastCloudTieringResult)
			delete(rawMsg, key)
		case "lastSuccessTimestamp":
			err = unpopulateTime[datetime.RFC3339](val, "LastSuccessTimestamp", &s.LastSuccessTimestamp)
			delete(rawMsg, key)
		case "lastUpdatedTimestamp":
			err = unpopulateTime[datetime.RFC3339](val, "LastUpdatedTimestamp", &s.LastUpdatedTimestamp)
			delete(rawMsg, key)
		case "lowDiskMode":
...
func (s ServerEndpointProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "serverEndpointProvisioningStatus", s.ServerEndpointProvisioningStatus)
	populate(objectMap, "serverLocalPath", s.ServerLocalPath)
...
func (s *ServerEndpointProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "recallStatus":
			...
			delete(rawMsg, key)
		case "serverEndpointProvisioningStatus":
			err = unpopulate(val, "ServerEndpointProvisioningStatus", &s.ServerEndpointProvisioningStatus)
			delete(rawMsg, key)
		case "serverLocalPath":
			err = unpopulate(val, "ServerLocalPath", &s.ServerLocalPath)
			delete(rawMsg, key)
...
// MarshalJSON implements the json.Marshaller interface for type ServerEndpointProvisioningStatus.
func (s ServerEndpointProvisioningStatus) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "provisioningStatus", s.ProvisioningStatus)
	populate(objectMap, "provisioningStepStatuses", s.ProvisioningStepStatuses)
	populate(objectMap, "provisioningType", s.ProvisioningType)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ServerEndpointProvisioningStatus.
func (s *ServerEndpointProvisioningStatus) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %s", s, err.Error())
	}
	for key, val := range rawMsg {
		...
		case "provisioningStatus":
			...
			delete(rawMsg, key)
		case "provisioningStepStatuses":
			err = unpopulate(val, "ProvisioningStepStatuses", &s.ProvisioningStepStatuses)
			delete(rawMsg, key)
		case "provisioningType":
			err = unpopulate(val, "ProvisioningType", &s.ProvisioningType)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %s", s, err.Error())
...
// MarshalJSON implements the json.Marshaller interface for type ServerEndpointProvisioningStepStatus.
func (s ServerEndpointProvisioningStepStatus) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	...
	populate(objectMap, "errorCode", s.ErrorCode)
	populate(objectMap, "minutesLeft", s.MinutesLeft)
	populate(objectMap, "name", s.Name)
	populate(objectMap, "progressPercentage", s.ProgressPercentage)
	populateTime[datetime.RFC3339](objectMap, "startTime", s.StartTime, true)
	populate(objectMap, "status", s.Status)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ServerEndpointProvisioningStepStatus.
func (s *ServerEndpointProvisioningStepStatus) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %s", s, err.Error())
	}
	for key, val := range rawMsg {
		...
		case "errorCode":
			...
			delete(rawMsg, key)
		case "minutesLeft":
			err = unpopulate(val, "MinutesLeft", &s.MinutesLeft)
			delete(rawMsg, key)
		case "name":
			err = unpopulate(val, "Name", &s.Name)
			delete(rawMsg, key)
		case "progressPercentage":
			err = unpopulate(val, "ProgressPercentage", &s.ProgressPercentage)
			delete(rawMsg, key)
		case "startTime":
...
func (s ServerEndpointSyncSessionStatus) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "lastSyncSuccessTimestamp", s.LastSyncSuccessTimestamp, true)
	populateTime[datetime.RFC3339](objectMap, "lastSyncTimestamp", s.LastSyncTimestamp, true)
...
func (s *ServerEndpointSyncSessionStatus) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "lastSyncSuccessTimestamp":
			err = unpopulateTime[datetime.RFC3339](val, "LastSyncSuccessTimestamp", &s.LastSyncSuccessTimestamp)
			delete(rawMsg, key)
...
func (s ServiceCreateParametersProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "useIdentity", s.UseIdentity)
	return json.Marshal(objectMap)
}
...
func (s *ServiceCreateParametersProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "incomingTrafficPolicy":
			...
			delete(rawMsg, key)
		case "useIdentity":
			err = unpopulate(val, "UseIdentity", &s.UseIdentity)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %s", s, err.Error())
...
func (w WorkflowProperties) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "createdTimestamp", w.CreatedTimestamp, true)
	populate(objectMap, "lastOperationId", w.LastOperationID)
	populateTime[datetime.RFC3339](objectMap, "lastStatusTimestamp", w.LastStatusTimestamp, true)
...
func (w *WorkflowProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "createdTimestamp":
			err = unpopulateTime[datetime.RFC3339](val, "CreatedTimestamp", &w.CreatedTimestamp)
			delete(rawMsg, key)
		case "lastOperationId":
			err = unpopulate(val, "LastOperationID", &w.LastOperationID)
			delete(rawMsg, key)
		case "lastStatusTimestamp":
			err = unpopulateTime[datetime.RFC3339](val, "LastStatusTimestamp", &w.LastStatusTimestamp)
			delete(rawMsg, key)
		case "lastStepName":
