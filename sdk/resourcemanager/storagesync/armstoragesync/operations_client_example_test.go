...
// Generated from example definition: 2022-09-01/Operations_List.json
func ExampleOperationsClient_NewListPager() {
	...
	clientFactory, err := armstoragesync.NewClientFactory("<subscriptionID>", cred, nil)
	if err != nil {
	...
	for pager.More() {
		...
		// page = armstoragesync.OperationsClientListResponse{
		// 	OperationEntityListResult: armstoragesync.OperationEntityListResult{
		...
		// 								LockAggregationType: to.Ptr("Average"),
		// 								Unit: to.Ptr("Count"),
		// 							},
		// 							{
