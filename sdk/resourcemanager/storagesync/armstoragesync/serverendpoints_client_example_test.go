...
func ExampleServerEndpointsClient_BeginCreate() {
	...
	// res = armstoragesync.ServerEndpointsClientCreateResponse{
...
func ExampleServerEndpointsClient_BeginDelete() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armstoragesync.ServerEndpointsClientDeleteResponse{
	// }
}
...
func ExampleServerEndpointsClient_NewListBySyncGroupPager() {
	...
	for pager.More() {
		...
		// page = armstoragesync.ServerEndpointsClientListBySyncGroupResponse{
		// 	CorrelationRequestID: "d166ca76-dad2-49df-b409-d2acfd42d730"
		// 	RequestID: "74e55a4d-1c6f-46de-9a8d-278e53a47403"
		// 	ServerEndpointArray: armstoragesync.ServerEndpointArray{
...
func ExampleServerEndpointsClient_BeginRecallAction() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armstoragesync.ServerEndpointsClientRecallActionResponse{
	// }
}
