...
```go
client, err := armstorsimple1200series.NewIscsiDisksClient(<subscription ID>, cred, nil)
```
...
client, err := armstorsimple1200series.NewIscsiDisksClient(<subscription ID>, cred, &options)
```
