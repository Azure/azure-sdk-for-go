...
```go
client, err := armstorsimple8000series.NewHardwareComponentGroupsClient(<subscription ID>, cred, nil)
```
...
client, err := armstorsimple8000series.NewHardwareComponentGroupsClient(<subscription ID>, cred, &options)
```
