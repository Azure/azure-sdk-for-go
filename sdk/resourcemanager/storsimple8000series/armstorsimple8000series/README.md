...
```go
client, err := armstorsimple8000series.NewBackupsClient(<subscription ID>, cred, nil)
```
...
client, err := armstorsimple8000series.NewBackupsClient(<subscription ID>, cred, &options)
```
