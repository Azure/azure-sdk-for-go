...
- Function `*Client.Cancel` parameter(s) have been changed from `(ctx context.Context, subscriptionID string, options *ClientCancelOptions)` to `(ctx context.Context, options *ClientCancelOptions)`
- Function `*Client.Enable` parameter(s) have been changed from `(ctx context.Context, subscriptionID string, options *ClientEnableOptions)` to `(ctx context.Context, options *ClientEnableOptions)`
- Function `*Client.Rename` parameter(s) have been changed from `(ctx context.Context, subscriptionID string, body Name, options *ClientRenameOptions)` to `(ctx context.Context, body Name, options *ClientRenameOptions)`
...
- New function `*OperationClient.BeginGet(ctx context.Context, operationID string, options *OperationClientBeginGetOptions) (*runtime.Poller[OperationClientGetResponse], error)`
