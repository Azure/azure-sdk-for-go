...
func (client *Client) BeginAcceptOwnership(ctx context.Context, body AcceptOwnershipRequest, options *ClientBeginAcceptOwnershipOptions) (*runtime.Poller[ClientAcceptOwnershipResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.acceptOwnership(ctx, body, options)
		if err != nil {
			return nil, err
		}
...
//
// Generated from API version 2025-11-01-preview
func (client *Client) acceptOwnership(ctx context.Context, body AcceptOwnershipRequest, options *ClientBeginAcceptOwnershipOptions) (*http.Response, error) {
	var err error
	const operationName = "Client.BeginAcceptOwnership"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.acceptOwnershipCreateRequest(ctx, body, options)
	if err != nil {
		return nil, err
	}
...
func (client *Client) acceptOwnershipCreateRequest(ctx context.Context, body AcceptOwnershipRequest, _ *ClientBeginAcceptOwnershipOptions) (*policy.Request, error) {
...
func (client *Client) AcceptOwnershipStatus(ctx context.Context, options *ClientAcceptOwnershipStatusOptions) (ClientAcceptOwnershipStatusResponse, error) {
	var err error
	const operationName = "Client.AcceptOwnershipStatus"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.acceptOwnershipStatusCreateRequest(ctx, options)
	if err != nil {
...
func (client *Client) acceptOwnershipStatusCreateRequest(ctx context.Context, _ *ClientAcceptOwnershipStatusOptions) (*policy.Request, error) {
...
func (client *Client) Cancel(ctx context.Context, options *ClientCancelOptions) (ClientCancelResponse, error) {
	var err error
	const operationName = "Client.Cancel"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.cancelCreateRequest(ctx, options)
	if err != nil {
...
func (client *Client) cancelCreateRequest(ctx context.Context, _ *ClientCancelOptions) (*policy.Request, error) {
...
func (client *Client) Enable(ctx context.Context, options *ClientEnableOptions) (ClientEnableResponse, error) {
	var err error
	const operationName = "Client.Enable"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.enableCreateRequest(ctx, options)
	if err != nil {
...
func (client *Client) enableCreateRequest(ctx context.Context, _ *ClientEnableOptions) (*policy.Request, error) {
...
func (client *Client) Rename(ctx context.Context, body Name, options *ClientRenameOptions) (ClientRenameResponse, error) {
	var err error
	const operationName = "Client.Rename"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.renameCreateRequest(ctx, body, options)
	if err != nil {
...
func (client *Client) renameCreateRequest(ctx context.Context, body Name, _ *ClientRenameOptions) (*policy.Request, error) {
