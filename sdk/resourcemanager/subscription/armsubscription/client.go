...
//   - requestbodyBody - The request body
//   - options - ClientBeginAcceptOwnershipOptions contains the optional parameters for the Client.BeginAcceptOwnership method.
func (client *Client) BeginAcceptOwnership(ctx context.Context, subscriptionID string, requestbodyBody AcceptOwnershipRequest, options *ClientBeginAcceptOwnershipOptions) (*runtime.Poller[ClientAcceptOwnershipResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.acceptOwnership(ctx, subscriptionID, requestbodyBody, options)
		if err != nil {
			return nil, err
		}
...
//
// Generated from API version 2025-11-01-preview
func (client *Client) acceptOwnership(ctx context.Context, subscriptionID string, requestbodyBody AcceptOwnershipRequest, options *ClientBeginAcceptOwnershipOptions) (*http.Response, error) {
	var err error
	const operationName = "Client.BeginAcceptOwnership"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.acceptOwnershipCreateRequest(ctx, subscriptionID, requestbodyBody, options)
	if err != nil {
		return nil, err
	}
...
func (client *Client) acceptOwnershipCreateRequest(ctx context.Context, subscriptionID string, requestbodyBody AcceptOwnershipRequest, _ *ClientBeginAcceptOwnershipOptions) (*policy.Request, error) {
	...
	if err := runtime.MarshalAsJSON(req, requestbodyBody); err != nil {
		return nil, err
	}
	return req, nil
}
