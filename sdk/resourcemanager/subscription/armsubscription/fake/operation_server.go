...
type OperationServer struct {
	...
	BeginGet func(ctx context.Context, operationID string, options *armsubscription.OperationClientBeginGetOptions) (resp azfake.PollerResponder[armsubscription.OperationClientGetResponse], errResp azfake.ErrorResponder)
}
...
func NewOperationServerTransport(srv *OperationServer) *OperationServerTransport {
	return &OperationServerTransport{
		srv:      srv,
		beginGet: newTracker[azfake.PollerResponder[armsubscription.OperationClientGetResponse]](),
	}
}
...
type OperationServerTransport struct {
	srv      *OperationServer
	beginGet *tracker[azfake.PollerResponder[armsubscription.OperationClientGetResponse]]
}
