...
type Server struct {
	...
	BeginAcceptOwnership func(ctx context.Context, body armsubscription.AcceptOwnershipRequest, options *armsubscription.ClientBeginAcceptOwnershipOptions) (resp azfake.PollerResponder[armsubscription.ClientAcceptOwnershipResponse], errResp azfake.ErrorResponder)

	// AcceptOwnershipStatus is the fake for method Client.AcceptOwnershipStatus
	// HTTP status codes to indicate success: http.StatusOK
	AcceptOwnershipStatus func(ctx context.Context, options *armsubscription.ClientAcceptOwnershipStatusOptions) (resp azfake.Responder[armsubscription.ClientAcceptOwnershipStatusResponse], errResp azfake.ErrorResponder)

	// Cancel is the fake for method Client.Cancel
	// HTTP status codes to indicate success: http.StatusOK
	Cancel func(ctx context.Context, options *armsubscription.ClientCancelOptions) (resp azfake.Responder[armsubscription.ClientCancelResponse], errResp azfake.ErrorResponder)

	// Enable is the fake for method Client.Enable
	// HTTP status codes to indicate success: http.StatusOK
	Enable func(ctx context.Context, options *armsubscription.ClientEnableOptions) (resp azfake.Responder[armsubscription.ClientEnableResponse], errResp azfake.ErrorResponder)

	// Rename is the fake for method Client.Rename
	// HTTP status codes to indicate success: http.StatusOK
	Rename func(ctx context.Context, body armsubscription.Name, options *armsubscription.ClientRenameOptions) (resp azfake.Responder[armsubscription.ClientRenameResponse], errResp azfake.ErrorResponder)
}
...
func (s *ServerTransport) dispatchBeginAcceptOwnership(req *http.Request) (*http.Response, error) {
	...
	if beginAcceptOwnership == nil {
		...
		respr, errRespr := s.srv.BeginAcceptOwnership(req.Context(), body, nil)
...
func (s *ServerTransport) dispatchAcceptOwnershipStatus(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := s.srv.AcceptOwnershipStatus(req.Context(), nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
...
func (s *ServerTransport) dispatchCancel(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := s.srv.Cancel(req.Context(), nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (s *ServerTransport) dispatchEnable(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := s.srv.Enable(req.Context(), nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (s *ServerTransport) dispatchRename(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := s.srv.Rename(req.Context(), body, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
