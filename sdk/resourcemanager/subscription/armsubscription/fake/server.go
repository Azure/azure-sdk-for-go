...
type Server struct {
	...
	BeginAcceptOwnership func(ctx context.Context, subscriptionID string, requestbodyBody armsubscription.AcceptOwnershipRequest, options *armsubscription.ClientBeginAcceptOwnershipOptions) (resp azfake.PollerResponder[armsubscription.ClientAcceptOwnershipResponse], errResp azfake.ErrorResponder)
