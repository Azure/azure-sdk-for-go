...
func (t TargetDirectoryResultProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateTime[datetime.RFC3339](objectMap, "acceptedDate", t.AcceptedDate, true)
	populateTime[datetime.RFC3339](objectMap, "createdDate", t.CreatedDate, true)
	populate(objectMap, "destinationOwnerId", t.DestinationOwnerID)
	populate(objectMap, "destinationTenantId", t.DestinationTenantID)
	populateTime[datetime.RFC3339](objectMap, "expiresOn", t.ExpiresOn, true)
