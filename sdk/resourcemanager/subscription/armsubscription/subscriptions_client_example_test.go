...
func ExampleSubscriptionsClient_AcceptTargetDirectory() {
	...
	clientFactory, err := armsubscription.NewClientFactory("6c3c85bc-5366-4eaa-8055-a10529eafd03", cred, nil)
	if err != nil {
		log.Fatalf("failed to create client: %v", err)
	}
	_, err = clientFactory.NewSubscriptionsClient().AcceptTargetDirectory(ctx, nil)
	if err != nil {
...
func ExampleSubscriptionsClient_DeleteTargetDirectory() {
	...
	ctx := context.Background()
	clientFactory, err := armsubscription.NewClientFactory("ebe4f8fd-d8b3-4867-bcf4-b2407edd196d", cred, nil)
	if err != nil {
		log.Fatalf("failed to create client: %v", err)
	}
	res, err := clientFactory.NewSubscriptionsClient().DeleteTargetDirectory(ctx, nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
...
func ExampleSubscriptionsClient_GetTargetDirectory() {
	...
	res, err := clientFactory.NewSubscriptionsClient().GetTargetDirectory(ctx, nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
...
func ExampleSubscriptionsClient_NewListTargetDirectoryPager() {
	...
	pager := clientFactory.NewSubscriptionsClient().NewListTargetDirectoryPager(nil)
	for pager.More() {
...
func ExampleSubscriptionsClient_PutTargetDirectory() {
	...
	ctx := context.Background()
	clientFactory, err := armsubscription.NewClientFactory("ecce7b25-862b-44a2-9e21-a1baa50618eb", cred, nil)
	if err != nil {
		log.Fatalf("failed to create client: %v", err)
	}
	res, err := clientFactory.NewSubscriptionsClient().PutTargetDirectory(ctx, armsubscription.TargetDirectoryRequest{
...
func ExampleSubscriptionsClient_TargetDirectoryStatus() {
	...
	ctx := context.Background()
	clientFactory, err := armsubscription.NewClientFactory("e1084a54-27ab-4b72-a3ba-89fac9548f49", cred, nil)
	if err != nil {
		log.Fatalf("failed to create client: %v", err)
	}
	res, err := clientFactory.NewSubscriptionsClient().TargetDirectoryStatus(ctx, nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
