...
// Generated from example definition: 2026-07-01/GetchatTranscriptDetailsForSubscriptionSupportTicket.json
func ExampleChatTranscriptsClient_Get() {
	...
	// 					CreatedDate: to.Ptr(time.Date(2020, time.March, 23, 20, 18, 19, 0, time.UTC)),
	...
	// 					ContentType: to.Ptr("text"),
	// 					CreatedDate: to.Ptr(time.Date(2020, time.March, 23, 20, 19, 16, 0, time.UTC)),
	// 					Sender: to.Ptr("user"),
	// 				},
	// 			},
	// 		},
...
// Generated from example definition: 2026-07-01/ListChatTranscriptsForSubscriptionSupportTicket.json
func ExampleChatTranscriptsClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armsupport.ChatTranscriptsClientListResponse{
		// 	ChatTranscriptsListResult: armsupport.ChatTranscriptsListResult{
		...
		// 							CommunicationDirection: to.Ptr(armsupport.CommunicationDirectionInbound),
		// 							ContentType: to.Ptr("text"),
		// 							CreatedDate: to.Ptr(time.Date(2020, time.March, 24, 20, 19, 16, 0, time.UTC)),
		// 							Sender: to.Ptr("user"),
		// 						},
		// 					},
		// 					StartTime: to.Ptr(time.Date(2023, time.August, 22, 22, 46, 35, 0, time.UTC)),
		// 				},
		// 			},
		// 			{
		...
		// 							CommunicationDirection: to.Ptr(armsupport.CommunicationDirectionOutbound),
		// 							ContentType: to.Ptr("text"),
		// 							CreatedDate: to.Ptr(time.Date(2020, time.March, 25, 20, 18, 19, 0, time.UTC)),
		// 							Sender: to.Ptr("support engineer 2"),
		// 						},
		// 						{
		// 							Body: to.Ptr("hello"),
		// 							CommunicationDirection: to.Ptr(armsupport.CommunicationDirectionInbound),
		// 							ContentType: to.Ptr("text"),
		// 							CreatedDate: to.Ptr(time.Date(2020, time.March, 25, 20, 19, 16, 0, time.UTC)),
		// 							Sender: to.Ptr("user"),
		// 						},
		// 					},
		// 					StartTime: to.Ptr(time.Date(2023, time.August, 22, 22, 46, 35, 0, time.UTC)),
