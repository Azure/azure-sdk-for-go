...
// Generated from example definition: 2026-07-01/ClassifyProblemClassificationsForSubscription.json
func ExampleClassifyProblemsClient_ClassifyProblems() {
	...
	res, err := clientFactory.NewClassifyProblemsClient().ClassifyProblems(ctx, "serviceId1", armsupport.ProblemClassificationsClassificationInput{
	...
	// res = armsupport.ClassifyProblemsClientClassifyProblemsResponse{
