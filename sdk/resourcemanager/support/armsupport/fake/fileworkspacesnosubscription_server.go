...
func (f *FileWorkspacesNoSubscriptionServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	resultChan := make(chan result, 1)
	go func() {
		var intercepted bool
		var res result
		if fileWorkspacesNoSubscriptionServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = fileWorkspacesNoSubscriptionServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
func (f *FileWorkspacesNoSubscriptionServerTransport) dispatchCreate(req *http.Request) (*http.Response, error) {
	...
	const regexStr = `/providers/Microsoft\.Support/fileWorkspaces/(?P<fileWorkspaceName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)`
...
// set this to conditionally intercept incoming requests to FileWorkspacesNoSubscriptionServerTransport
var fileWorkspacesNoSubscriptionServerTransportInterceptor interface {
