...
func (client *FileWorkspacesNoSubscriptionClient) createCreateRequest(ctx context.Context, fileWorkspaceName string, _ *FileWorkspacesNoSubscriptionClientCreateOptions) (*policy.Request, error) {
...
func (client *FileWorkspacesNoSubscriptionClient) getCreateRequest(ctx context.Context, fileWorkspaceName string, _ *FileWorkspacesNoSubscriptionClientGetOptions) (*policy.Request, error) {
	urlPath := "/providers/Microsoft.Support/fileWorkspaces/{fileWorkspaceName}"
	if fileWorkspaceName == "" {
		return nil, errors.New("parameter fileWorkspaceName cannot be empty")
	}
