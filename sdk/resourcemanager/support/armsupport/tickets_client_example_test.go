...
func ExampleTicketsClient_NewListPager_listSupportTicketsForASubscription() {
	...
	pager := clientFactory.NewTicketsClient().NewListPager(nil)
	for pager.More() {
		...
		// page = armsupport.TicketsClientListResponse{
...
func ExampleTicketsClient_NewListPager_listSupportTicketsCreatedOnOrAfterACertainDateAndInOpenStateForASubscription() {
	...
	pager := clientFactory.NewTicketsClient().NewListPager(&armsupport.TicketsClientListOptions{
