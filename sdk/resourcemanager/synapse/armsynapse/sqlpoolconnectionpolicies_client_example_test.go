...
func ExampleSQLPoolConnectionPoliciesClient_Get() {
	...
	res, err := clientFactory.NewSQLPoolConnectionPoliciesClient().Get(ctx, "blobauditingtest-6852", "blobauditingtest-2080", "testdb", armsynapse.ConnectionPolicyNameDefault, nil)
	if err != nil {
