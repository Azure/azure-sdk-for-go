...
func ExamplePrivateEndpointConnectionsPrivateLinkHubClient_List() {
	...
	client := armsynapse.NewPrivateEndpointConnectionsPrivateLinkHubClient("<subscription-id>", cred, nil)
...
func ExamplePrivateEndpointConnectionsPrivateLinkHubClient_Get() {
	...
	log.Printf("Response result: %#v\n", res.PrivateEndpointConnectionsPrivateLinkHubClientGetResult)
}
