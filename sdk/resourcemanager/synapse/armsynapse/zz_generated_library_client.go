...
func (client *LibraryClient) getCreateRequest(ctx context.Context, resourceGroupName string, libraryName string, workspaceName string, options *LibraryClientGetOptions) (*policy.Request, error) {
