...
func unmarshalAnalysisResultSingletonResourcePropertiesClassificationArray(rawMsg json.RawMessage) ([]AnalysisResultSingletonResourcePropertiesClassification, error) {
	if rawMsg == nil {
		return nil, nil
	}
	...
	fArray := make([]AnalysisResultSingletonResourcePropertiesClassification, len(rawMessages))
	for index, rawMessage := range rawMessages {
		f, err := unmarshalAnalysisResultSingletonResourcePropertiesClassification(rawMessage)
		if err != nil {
			return nil, err
		}
		fArray[index] = f
...
func unmarshalAnalysisResultSingletonResourcePropertiesClassificationMap(rawMsg json.RawMessage) (map[string]AnalysisResultSingletonResourcePropertiesClassification, error) {
	if rawMsg == nil {
		return nil, nil
	}
	...
	fMap := make(map[string]AnalysisResultSingletonResourcePropertiesClassification, len(rawMessages))
