...
func (c *ClientFactory) NewEventSourcesClient() *EventSourcesClient {
	subClient, _ := NewEventSourcesClient(c.subscriptionID, c.credential, c.options)
	return subClient
}
...
func (c *ClientFactory) NewReferenceDataSetsClient() *ReferenceDataSetsClient {
	subClient, _ := NewReferenceDataSetsClient(c.subscriptionID, c.credential, c.options)
	return subClient
}
