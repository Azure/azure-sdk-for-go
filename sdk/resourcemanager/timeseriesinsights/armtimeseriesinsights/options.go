...
// PrivateEndpointConnectionsClientListByEnvironmentOptions contains the optional parameters for the PrivateEndpointConnectionsClient.ListByEnvironment
// method.
type PrivateEndpointConnectionsClientListByEnvironmentOptions struct {
	// placeholder for future optional parameters
}
