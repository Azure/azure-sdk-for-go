...
```sh
go get github.com/Azure/azure-sdk-for-go/sdk/resourcemanager/trafficmanager/armtrafficmanager/v2
```
...
[open an issue](https://github.com/Azure/azure-sdk-for-go/issues) and assign the `Traffic Manager` label.
