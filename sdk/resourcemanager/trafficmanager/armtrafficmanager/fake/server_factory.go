...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "GeographicHierarchiesClient":
		initServer(&s.trMu, &s.trGeographicHierarchiesServer, func() *GeographicHierarchiesServerTransport {
	...
	case "HeatMapClient":
		initServer(&s.trMu, &s.trHeatMapServer, func() *HeatMapServerTransport { return NewHeatMapServerTransport(&s.srv.HeatMapServer) })
	...
	case "UserMetricsKeysClient":
		initServer(&s.trMu, &s.trUserMetricsKeysServer, func() *UserMetricsKeysServerTransport {
