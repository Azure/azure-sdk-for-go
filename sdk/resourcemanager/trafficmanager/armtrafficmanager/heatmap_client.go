...
func (client *HeatMapClient) getCreateRequest(ctx context.Context, resourceGroupName string, profileName string, heatMapType HeatMapType, options *HeatMapClientGetOptions) (*policy.Request, error) {
