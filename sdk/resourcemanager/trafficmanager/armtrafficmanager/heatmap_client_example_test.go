...
func ExampleHeatMapClient_Get_heatMapGetWithNullValues() {
	...
	res, err := clientFactory.NewHeatMapClient().Get(ctx, "azuresdkfornetautoresttrafficmanager1323", "azuresdkfornetautoresttrafficmanager3880", armtrafficmanager.HeatMapTypeDefault, nil)
	if err != nil {
...
func ExampleHeatMapClient_Get_heatMapGetWithTopLeftBotRight() {
	...
	res, err := clientFactory.NewHeatMapClient().Get(ctx, "azuresdkfornetautoresttrafficmanager1323", "azuresdkfornetautoresttrafficmanager3880", armtrafficmanager.HeatMapTypeDefault, &armtrafficmanager.HeatMapClientGetOptions{
		BotRight: []float64{
			-50.001,
			80,
		},
