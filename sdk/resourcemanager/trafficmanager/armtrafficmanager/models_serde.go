...
func (h HeatMapProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateTime[datetime.RFC3339](objectMap, "endTime", h.EndTime, true)
	populate(objectMap, "endpoints", h.Endpoints)
	populateTime[datetime.RFC3339](objectMap, "startTime", h.StartTime, true)
...
func (h *HeatMapProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "endTime":
			err = unpopulateTime[datetime.RFC3339](val, "EndTime", &h.EndTime)
			delete(rawMsg, key)
		case "endpoints":
			err = unpopulate(val, "Endpoints", &h.Endpoints)
			delete(rawMsg, key)
		case "startTime":
			err = unpopulateTime[datetime.RFC3339](val, "StartTime", &h.StartTime)
			delete(rawMsg, key)
		case "trafficFlows":
