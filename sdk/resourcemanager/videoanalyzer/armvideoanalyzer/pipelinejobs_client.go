...
func NewPipelineJobsClient(subscriptionID string, credential azcore.TokenCredential, options *arm.ClientOptions) (*PipelineJobsClient, error) {
	cl, err := arm.NewClient(moduleName+".PipelineJobsClient", moduleVersion, credential, options)
	if err != nil {
		return nil, err
	}
...
func (client *PipelineJobsClient) BeginCancel(ctx context.Context, resourceGroupName string, accountName string, pipelineJobName string, options *PipelineJobsClientBeginCancelOptions) (*runtime.Poller[PipelineJobsClientCancelResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		poller, err := runtime.NewPoller[PipelineJobsClientCancelResponse](resp, client.internal.Pipeline(), nil)
		return poller, err
	} else {
		return runtime.NewPollerFromResumeToken[PipelineJobsClientCancelResponse](options.ResumeToken, client.internal.Pipeline(), nil)
	}
}
...
//   - resourceGroupName - The name of the resource group. The name is case insensitive.
//   - accountName - The Azure Video Analyzer account name.
//   - options - PipelineJobsClientListOptions contains the optional parameters for the PipelineJobsClient.NewListPager method.
