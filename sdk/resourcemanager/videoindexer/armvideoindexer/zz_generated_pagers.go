...
// UserClassicAccountsListPager provides operations for iterating over paged responses.
type UserClassicAccountsListPager struct {
	client    *UserClassicAccountsClient
	current   UserClassicAccountsListResponse
	err       error
	requester func(context.Context) (*policy.Request, error)
	advancer  func(context.Context, UserClassicAccountsListResponse) (*policy.Request, error)
}

// Err returns the last error encountered while paging.
func (p *UserClassicAccountsListPager) Err() error {
	return p.err
}

// NextPage returns true if the pager advanced to the next page.
// Returns false if there are no more pages or an error occurred.
func (p *UserClassicAccountsListPager) NextPage(ctx context.Context) bool {
	var req *policy.Request
	var err error
	if !reflect.ValueOf(p.current).IsZero() {
...
// PageResponse returns the current UserClassicAccountsListResponse page.
func (p *UserClassicAccountsListPager) PageResponse() UserClassicAccountsListResponse {
	return p.current
}
