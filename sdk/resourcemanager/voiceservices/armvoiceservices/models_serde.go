...
func (c CommunicationsGatewayProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateAny(objectMap, "apiBridge", c.APIBridge)
	populate(objectMap, "autoGeneratedDomainNameLabel", c.AutoGeneratedDomainNameLabel)
	populate(objectMap, "autoGeneratedDomainNameLabelScope", c.AutoGeneratedDomainNameLabelScope)
	populate(objectMap, "codecs", c.Codecs)
	populate(objectMap, "connectivity", c.Connectivity)
	populate(objectMap, "e911Type", c.E911Type)
	populate(objectMap, "emergencyDialStrings", c.EmergencyDialStrings)
	populate(objectMap, "onPremMcpEnabled", c.OnPremMcpEnabled)
	populate(objectMap, "platforms", c.Platforms)
	populate(objectMap, "provisioningState", c.ProvisioningState)
	populate(objectMap, "serviceLocations", c.ServiceLocations)
	populate(objectMap, "status", c.Status)
	populate(objectMap, "teamsVoicemailPilotNumber", c.TeamsVoicemailPilotNumber)
	return json.Marshal(objectMap)
}
...
func (c *CommunicationsGatewayProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "apiBridge":
			err = unpopulate(val, "APIBridge", &c.APIBridge)
			delete(rawMsg, key)
		case "autoGeneratedDomainNameLabel":
			err = unpopulate(val, "AutoGeneratedDomainNameLabel", &c.AutoGeneratedDomainNameLabel)
			delete(rawMsg, key)
		case "autoGeneratedDomainNameLabelScope":
			...
			delete(rawMsg, key)
		case "codecs":
			err = unpopulate(val, "Codecs", &c.Codecs)
			delete(rawMsg, key)
		case "connectivity":
			err = unpopulate(val, "Connectivity", &c.Connectivity)
			delete(rawMsg, key)
		case "e911Type":
			err = unpopulate(val, "E911Type", &c.E911Type)
			delete(rawMsg, key)
		case "emergencyDialStrings":
			err = unpopulate(val, "EmergencyDialStrings", &c.EmergencyDialStrings)
			delete(rawMsg, key)
		case "onPremMcpEnabled":
			err = unpopulate(val, "OnPremMcpEnabled", &c.OnPremMcpEnabled)
			delete(rawMsg, key)
		case "platforms":
			err = unpopulate(val, "Platforms", &c.Platforms)
			delete(rawMsg, key)
		case "provisioningState":
			err = unpopulate(val, "ProvisioningState", &c.ProvisioningState)
			delete(rawMsg, key)
		case "serviceLocations":
			err = unpopulate(val, "ServiceLocations", &c.ServiceLocations)
			delete(rawMsg, key)
		case "status":
			err = unpopulate(val, "Status", &c.Status)
			delete(rawMsg, key)
		case "teamsVoicemailPilotNumber":
			err = unpopulate(val, "TeamsVoicemailPilotNumber", &c.TeamsVoicemailPilotNumber)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", c, err)
...
func (p PrimaryRegionProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "allowedMediaSourceAddressPrefixes", p.AllowedMediaSourceAddressPrefixes)
	populate(objectMap, "allowedSignalingSourceAddressPrefixes", p.AllowedSignalingSourceAddressPrefixes)
	populate(objectMap, "esrpAddresses", p.EsrpAddresses)
	populate(objectMap, "operatorAddresses", p.OperatorAddresses)
	return json.Marshal(objectMap)
}
...
func (p *PrimaryRegionProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		var err error
		switch key {
		case "allowedMediaSourceAddressPrefixes":
			err = unpopulate(val, "AllowedMediaSourceAddressPrefixes", &p.AllowedMediaSourceAddressPrefixes)
			delete(rawMsg, key)
		case "allowedSignalingSourceAddressPrefixes":
			err = unpopulate(val, "AllowedSignalingSourceAddressPrefixes", &p.AllowedSignalingSourceAddressPrefixes)
			delete(rawMsg, key)
		case "esrpAddresses":
			err = unpopulate(val, "EsrpAddresses", &p.EsrpAddresses)
			delete(rawMsg, key)
		case "operatorAddresses":
			err = unpopulate(val, "OperatorAddresses", &p.OperatorAddresses)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", p, err)
...
func (s ServiceRegionProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "primaryRegionProperties", s.PrimaryRegionProperties)
	return json.Marshal(objectMap)
}
...
func (t TestLineProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "purpose", t.Purpose)
	return json.Marshal(objectMap)
}
