...
func ExampleCustomCertificatesClient_Delete() {
	...
	res, err := clientFactory.NewCustomCertificatesClient().Delete(ctx, "myResourceGroup", "myWebPubSubService", "myCert", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
...
func ExampleCustomCertificatesClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armwebpubsub.CustomCertificatesClientListResponse{
