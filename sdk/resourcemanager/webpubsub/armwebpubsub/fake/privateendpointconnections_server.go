...
type PrivateEndpointConnectionsServer struct {
	...
	Get func(ctx context.Context, resourceGroupName string, resourceName string, privateEndpointConnectionName string, options *armwebpubsub.PrivateEndpointConnectionsClientGetOptions) (resp azfake.Responder[armwebpubsub.PrivateEndpointConnectionsClientGetResponse], errResp azfake.ErrorResponder)
