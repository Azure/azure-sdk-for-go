...
// The returned PrivateLinkResourcesServerTransport instance is connected to an instance of armwebpubsub.PrivateLinkResourcesClient via the
// azcore.ClientOptions.Transporter field in the client's constructor parameters.
func NewPrivateLinkResourcesServerTransport(srv *PrivateLinkResourcesServer) *PrivateLinkResourcesServerTransport {
	return &PrivateLinkResourcesServerTransport{
		srv:          srv,
		newListPager: newTracker[azfake.PagerResponder[armwebpubsub.PrivateLinkResourcesClientListResponse]](),
	}
}

// PrivateLinkResourcesServerTransport connects instances of armwebpubsub.PrivateLinkResourcesClient to instances of PrivateLinkResourcesServer.
// Don't use this type directly, use NewPrivateLinkResourcesServerTransport instead.
type PrivateLinkResourcesServerTransport struct {
	srv          *PrivateLinkResourcesServer
	newListPager *tracker[azfake.PagerResponder[armwebpubsub.PrivateLinkResourcesClientListResponse]]
}
...
func (p *PrivateLinkResourcesServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/resourceGroups/(?P<resourceGroupName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/providers/Microsoft\.SignalRService/webPubSub/(?P<resourceName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)/privateLinkResources`
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armwebpubsub.PrivateLinkResourcesClientListResponse, createLink func() string) {
