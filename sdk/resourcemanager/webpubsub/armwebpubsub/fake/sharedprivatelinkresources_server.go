...
type SharedPrivateLinkResourcesServer struct {
	...
	Get func(ctx context.Context, resourceGroupName string, resourceName string, sharedPrivateLinkResourceName string, options *armwebpubsub.SharedPrivateLinkResourcesClientGetOptions) (resp azfake.Responder[armwebpubsub.SharedPrivateLinkResourcesClientGetResponse], errResp azfake.ErrorResponder)
...
func (s *SharedPrivateLinkResourcesServerTransport) dispatchBeginCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginCreateOrUpdate == nil {
		...
		respr, errRespr := s.srv.BeginCreateOrUpdate(req.Context(), resourceGroupNameParam, resourceNameParam, sharedPrivateLinkResourceNameParam, body, nil)
...
func (s *SharedPrivateLinkResourcesServerTransport) dispatchBeginDelete(req *http.Request) (*http.Response, error) {
	...
	if beginDelete == nil {
		...
		respr, errRespr := s.srv.BeginDelete(req.Context(), resourceGroupNameParam, resourceNameParam, sharedPrivateLinkResourceNameParam, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginDelete = &respr
...
func (s *SharedPrivateLinkResourcesServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := s.srv.Get(req.Context(), resourceGroupNameParam, resourceNameParam, sharedPrivateLinkResourceNameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
