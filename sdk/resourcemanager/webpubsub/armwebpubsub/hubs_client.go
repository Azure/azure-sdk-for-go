...
func (client *HubsClient) getHandleResponse(resp *http.Response, successCodes ...int) (HubsClientGetResponse, error) {
...
func (client *HubsClient) listCreateRequest(ctx context.Context, resourceGroupName string, resourceName string, nextLink string, _ *HubsClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *HubsClient) listHandleResponse(resp *http.Response, successCodes ...int) (HubsClientListResponse, error) {
