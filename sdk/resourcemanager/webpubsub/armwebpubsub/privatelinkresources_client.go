...
func (client *PrivateLinkResourcesClient) listCreateRequest(ctx context.Context, resourceGroupName string, resourceName string, nextLink string, _ *PrivateLinkResourcesClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
