...
func (client *ReplicasClient) Delete(ctx context.Context, resourceGroupName string, resourceName string, replicaName string, options *ReplicasClientDeleteOptions) (ReplicasClientDeleteResponse, error) {
	...
	if !runtime.HasStatusCode(httpResp, http.StatusOK, http.StatusNoContent) {
		return ReplicasClientDeleteResponse{}, runtime.NewResponseError(httpResp)
	}
...
func (client *ReplicasClient) listCreateRequest(ctx context.Context, resourceGroupName string, resourceName string, nextLink string, _ *ReplicasClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
