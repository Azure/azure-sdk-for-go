...
func ExampleReplicasClient_Delete() {
	...
	res, err := clientFactory.NewReplicasClient().Delete(ctx, "myResourceGroup", "myWebPubSubService", "myWebPubSubService-eastus", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
...
func ExampleReplicasClient_NewListPager() {
	...
	for pager.More() {
		...
		// page = armwebpubsub.ReplicasClientListResponse{
