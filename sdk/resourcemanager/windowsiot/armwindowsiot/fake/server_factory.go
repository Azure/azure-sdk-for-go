...
// The returned ServerFactoryTransport instance is connected to an instance of armwindowsiot.ClientFactory via the
...
// ServerFactoryTransport connects instances of armwindowsiot.ClientFactory to instances of ServerFactory.
