...
// Generated from example definition: https://github.com/Azure/azure-rest-api-specs/blob/fe0acc3d1341b96b4684864cf5f5b2ec38ebbb5e/specification/edge/resource-manager/Microsoft.Edge/configurationmanager/stable/2025-06-01/examples/ConfigTemplateVersions_ListByConfigTemplate_MaximumSet_Gen.json
func ExampleConfigTemplateVersionsClient_NewListByConfigTemplatePager() {
	...
	for pager.More() {
		...
		// page.ConfigTemplateVersionListResult = armworkloadorchestration.ConfigTemplateVersionListResult{
...
// Generated from example definition: https://github.com/Azure/azure-rest-api-specs/blob/fe0acc3d1341b96b4684864cf5f5b2ec38ebbb5e/specification/edge/resource-manager/Microsoft.Edge/configurationmanager/stable/2025-06-01/examples/ConfigTemplateVersions_Get_MaximumSet_Gen.json
func ExampleConfigTemplateVersionsClient_Get() {
	...
	// res.ConfigTemplateVersion = armworkloadorchestration.ConfigTemplateVersion{
	// 	Name: to.Ptr("ylnjncs"),
	// 	Type: to.Ptr("de"),
	// 	ID: to.Ptr("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{resourceProviderNamespace}/{resourceType}/{resourceName}"),
	// 	SystemData: &armworkloadorchestration.SystemData{
