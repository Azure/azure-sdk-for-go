...
func (client *DynamicSchemasClient) Update(ctx context.Context, resourceGroupName string, schemaName string, dynamicSchemaName string, properties DynamicSchemaUpdate, options *DynamicSchemasClientUpdateOptions) (DynamicSchemasClientUpdateResponse, error) {
	var err error
...
func (client *DynamicSchemasClient) updateCreateRequest(ctx context.Context, resourceGroupName string, schemaName string, dynamicSchemaName string, properties DynamicSchemaUpdate, _ *DynamicSchemasClientUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Edge/schemas/{schemaName}/dynamicSchemas/{dynamicSchemaName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
