...
//     method.
func (client *DynamicSchemaVersionsClient) Update(ctx context.Context, resourceGroupName string, schemaName string, dynamicSchemaName string, schemaVersionName string, properties DynamicSchemaVersionUpdate, options *DynamicSchemaVersionsClientUpdateOptions) (DynamicSchemaVersionsClientUpdateResponse, error) {
	var err error
...
func (client *DynamicSchemaVersionsClient) updateCreateRequest(ctx context.Context, resourceGroupName string, schemaName string, dynamicSchemaName string, schemaVersionName string, properties DynamicSchemaVersionUpdate, _ *DynamicSchemaVersionsClientUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Edge/schemas/{schemaName}/dynamicSchemas/{dynamicSchemaName}/versions/{schemaVersionName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
