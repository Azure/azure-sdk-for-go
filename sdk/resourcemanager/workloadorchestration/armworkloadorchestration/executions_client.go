...
func (client *ExecutionsClient) BeginUpdate(ctx context.Context, resourceGroupName string, contextName string, workflowName string, versionName string, executionName string, properties ExecutionUpdate, options *ExecutionsClientBeginUpdateOptions) (*runtime.Poller[ExecutionsClientUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
...
//
// Generated from API version 2025-06-01
func (client *ExecutionsClient) update(ctx context.Context, resourceGroupName string, contextName string, workflowName string, versionName string, executionName string, properties ExecutionUpdate, options *ExecutionsClientBeginUpdateOptions) (*http.Response, error) {
	var err error
...
func (client *ExecutionsClient) updateCreateRequest(ctx context.Context, resourceGroupName string, contextName string, workflowName string, versionName string, executionName string, properties ExecutionUpdate, _ *ExecutionsClientBeginUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Edge/contexts/{contextName}/workflows/{workflowName}/versions/{versionName}/executions/{executionName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
