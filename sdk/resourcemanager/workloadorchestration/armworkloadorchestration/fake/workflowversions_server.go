...
type WorkflowVersionsServer struct {
	...
	BeginUpdate func(ctx context.Context, resourceGroupName string, contextName string, workflowName string, versionName string, properties armworkloadorchestration.WorkflowVersionUpdate, options *armworkloadorchestration.WorkflowVersionsClientBeginUpdateOptions) (resp azfake.PollerResponder[armworkloadorchestration.WorkflowVersionsClientUpdateResponse], errResp azfake.ErrorResponder)
}
...
func (w *WorkflowVersionsServerTransport) dispatchBeginUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginUpdate == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armworkloadorchestration.WorkflowVersionUpdate](req)
		if err != nil {
			return nil, err
		}
		resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
