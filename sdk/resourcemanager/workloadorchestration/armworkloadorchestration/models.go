...
// ConfigTemplatePropertiesUpdate - Config Template Properties
type ConfigTemplatePropertiesUpdate struct {
	// Description of config template
	Description *string
}

// ConfigTemplateUpdate - Config Template Resource. Contains configuration expressions using the predefined expression language.
type ConfigTemplateUpdate struct {
	// The resource-specific properties for this resource.
	Properties *ConfigTemplatePropertiesUpdate
...
// ContextPropertiesUpdate - Context Properties
type ContextPropertiesUpdate struct {
...
// ContextUpdate - Context Resource
type ContextUpdate struct {
	// The resource-specific properties for this resource.
	Properties *ContextPropertiesUpdate
...
// DiagnosticUpdate - A Diagnostic resource.
...
// DynamicSchemaUpdate - DynamicSchema Resource
type DynamicSchemaUpdate struct {
	// The resource-specific properties for this resource.
	Properties *DynamicSchemaProperties
...
// DynamicSchemaVersionUpdate - Dynamic Schema Version Resource
type DynamicSchemaVersionUpdate struct {
	// The resource-specific properties for this resource.
...
// ExecutionPropertiesUpdate - Execution Properties
type ExecutionPropertiesUpdate struct {
	// Execution specification
	Specification map[string]any
...
// ExecutionUpdate - Execution Resource
...
// InstancePropertiesUpdate - Instance Properties
type InstancePropertiesUpdate struct {
	// State of instance
	ActiveState *ActiveState
...
// InstanceUpdate - Instance Resource. Represents a deployment object.
...
// ReconciliationPolicyPropertiesUpdate - Defines a ReconciliationPolicy
type ReconciliationPolicyPropertiesUpdate struct {
	// Policy interval
	Interval *string
...
// SchemaVersionPropertiesUpdate - Schema Version Properties
type SchemaVersionPropertiesUpdate struct {
	// Value of schema version
	Value *string
}

// SchemaVersionUpdate - Schema Version Resource
...
// SiteReferencePropertiesUpdate - Site Reference Properties
type SiteReferencePropertiesUpdate struct {
	// Azure Resource ID for Site
	SiteID *string
}

// SiteReferenceUpdate - Site Reference Resource
type SiteReferenceUpdate struct {
	// The resource-specific properties for this resource.
...
// SolutionTemplatePropertiesUpdate - Solution Template Properties
type SolutionTemplatePropertiesUpdate struct {
	// List of capabilities
	Capabilities []*string
...
// SolutionTemplateUpdate - Solution Template Resource. Contains capabilities and operations for creating versions.
type SolutionTemplateUpdate struct {
	// The resource-specific properties for this resource.
	Properties *SolutionTemplatePropertiesUpdate
...
// SolutionUpdate - Solution Resource attached to a Target
...
// SolutionVersionPropertiesUpdate - Solution Version Properties
type SolutionVersionPropertiesUpdate struct {
	// App components spec
	Specification map[string]any
}
...
// SolutionVersionUpdate - Solution Version Resource. It has the resolved configuration along with edge specification.
type SolutionVersionUpdate struct {
	// The resource-specific properties for this resource.
...
// TargetPropertiesUpdate - Target Properties
type TargetPropertiesUpdate struct {
	// List of capabilities
	Capabilities []*string
...
// TargetUpdate - Target Resource. Represents a resource to be deployed on the edge.
type TargetUpdate struct {
	// The resource-specific properties for this resource.
	Properties *TargetPropertiesUpdate
...
// WorkflowUpdate - Workflow Resource
...
// WorkflowVersionPropertiesUpdate - Workflow Version Properties
type WorkflowVersionPropertiesUpdate struct {
	// Execution specification
	Specification map[string]any
...
// WorkflowVersionUpdate - Workflow Version Resource
