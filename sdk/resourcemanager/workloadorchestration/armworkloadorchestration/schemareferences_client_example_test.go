...
// Generated from example definition: https://github.com/Azure/azure-rest-api-specs/blob/fe0acc3d1341b96b4684864cf5f5b2ec38ebbb5e/specification/edge/resource-manager/Microsoft.Edge/configurationmanager/stable/2025-06-01/examples/SchemaReferences_ListByResourceGroup_MaximumSet_Gen.json
func ExampleSchemaReferencesClient_NewListByResourceGroupPager() {
	...
	for pager.More() {
		...
		// page.SchemaReferenceListResult = armworkloadorchestration.SchemaReferenceListResult{
...
// Generated from example definition: https://github.com/Azure/azure-rest-api-specs/blob/fe0acc3d1341b96b4684864cf5f5b2ec38ebbb5e/specification/edge/resource-manager/Microsoft.Edge/configurationmanager/stable/2025-06-01/examples/SchemaReferences_Get_MaximumSet_Gen.json
func ExampleSchemaReferencesClient_Get() {
	...
	// res.SchemaReference = armworkloadorchestration.SchemaReference{
	// 	Name: to.Ptr("brijvbbrrzgtttybezvtrjzu"),
	// 	Type: to.Ptr("jbdfmlyogaxxys"),
	// 	ID: to.Ptr("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{resourceProviderNamespace}/{resourceType}/{resourceName}"),
	// 	SystemData: &armworkloadorchestration.SystemData{
