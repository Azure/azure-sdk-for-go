...
//     method.
func (client *SiteReferencesClient) BeginUpdate(ctx context.Context, resourceGroupName string, contextName string, siteReferenceName string, properties SiteReferenceUpdate, options *SiteReferencesClientBeginUpdateOptions) (*runtime.Poller[SiteReferencesClientUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
...
//
// Generated from API version 2025-06-01
func (client *SiteReferencesClient) update(ctx context.Context, resourceGroupName string, contextName string, siteReferenceName string, properties SiteReferenceUpdate, options *SiteReferencesClientBeginUpdateOptions) (*http.Response, error) {
	var err error
...
func (client *SiteReferencesClient) updateCreateRequest(ctx context.Context, resourceGroupName string, contextName string, siteReferenceName string, properties SiteReferenceUpdate, _ *SiteReferencesClientBeginUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Edge/contexts/{contextName}/siteReferences/{siteReferenceName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
