...
func (client *SolutionsClient) getHandleResponse(resp *http.Response, successCodes ...int) (SolutionsClientGetResponse, error) {
...
func (client *SolutionsClient) NewListByTargetPager(resourceGroupName string, targetName string, options *SolutionsClientListByTargetOptions) *runtime.Pager[SolutionsClientListByTargetResponse] {
	return runtime.NewPager(runtime.PagingHandler[SolutionsClientListByTargetResponse]{
		...
		Fetcher: func(ctx context.Context, page *SolutionsClientListByTargetResponse) (SolutionsClientListByTargetResponse, error) {
			...
			req, err := client.listByTargetCreateRequest(ctx, resourceGroupName, targetName, nextLink, options)
			if err != nil {
...
func (client *SolutionsClient) listByTargetCreateRequest(ctx context.Context, resourceGroupName string, targetName string, nextLink string, _ *SolutionsClientListByTargetOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *SolutionsClient) listByTargetHandleResponse(resp *http.Response, successCodes ...int) (SolutionsClientListByTargetResponse, error) {
