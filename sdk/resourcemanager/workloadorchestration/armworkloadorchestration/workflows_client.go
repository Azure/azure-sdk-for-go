...
func (client *WorkflowsClient) BeginUpdate(ctx context.Context, resourceGroupName string, contextName string, workflowName string, properties WorkflowUpdate, options *WorkflowsClientBeginUpdateOptions) (*runtime.Poller[WorkflowsClientUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
...
//
// Generated from API version 2025-06-01
func (client *WorkflowsClient) update(ctx context.Context, resourceGroupName string, contextName string, workflowName string, properties WorkflowUpdate, options *WorkflowsClientBeginUpdateOptions) (*http.Response, error) {
	var err error
...
func (client *WorkflowsClient) updateCreateRequest(ctx context.Context, resourceGroupName string, contextName string, workflowName string, properties WorkflowUpdate, _ *WorkflowsClientBeginUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Edge/contexts/{contextName}/workflows/{workflowName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
