...
//     method.
func (client *WorkflowVersionsClient) BeginUpdate(ctx context.Context, resourceGroupName string, contextName string, workflowName string, versionName string, properties WorkflowVersionUpdate, options *WorkflowVersionsClientBeginUpdateOptions) (*runtime.Poller[WorkflowVersionsClientUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
...
//
// Generated from API version 2025-06-01
func (client *WorkflowVersionsClient) update(ctx context.Context, resourceGroupName string, contextName string, workflowName string, versionName string, properties WorkflowVersionUpdate, options *WorkflowVersionsClientBeginUpdateOptions) (*http.Response, error) {
	var err error
...
func (client *WorkflowVersionsClient) updateCreateRequest(ctx context.Context, resourceGroupName string, contextName string, workflowName string, versionName string, properties WorkflowVersionUpdate, _ *WorkflowVersionsClientBeginUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Edge/contexts/{contextName}/workflows/{workflowName}/versions/{versionName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
