...
func (p Properties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "managedResourcesNetworkAccessType", p.ManagedResourcesNetworkAccessType)
	populate(objectMap, "provisioningState", p.ProvisioningState)
	populate(objectMap, "sapProduct", p.SapProduct)
...
func (p *Properties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "configuration":
			p.Configuration, err = unmarshalSAPConfigurationClassification(val)
			delete(rawMsg, key)
		case "environment":
		...
		case "managedResourcesNetworkAccessType":
			err = unpopulate(val, "ManagedResourcesNetworkAccessType", &p.ManagedResourcesNetworkAccessType)
			delete(rawMsg, key)
		case "provisioningState":
			err = unpopulate(val, "ProvisioningState", &p.ProvisioningState)
			delete(rawMsg, key)
		case "sapProduct":
			err = unpopulate(val, "SapProduct", &p.SapProduct)
			delete(rawMsg, key)
		case "state":
