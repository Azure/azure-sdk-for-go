...
func ExampleSAPApplicationServerInstancesClient_BeginCreate() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	poller, err := client.BeginCreate(ctx,
		...
		"X00",
		"app01",
		&armworkloads.SAPApplicationServerInstancesClientBeginCreateOptions{Body: &armworkloads.SAPApplicationServerInstance{
...
func ExampleSAPApplicationServerInstancesClient_BeginUpdate() {
	...
	poller, err := client.BeginUpdate(ctx,
		...
		"X00",
		"app01",
		&armworkloads.SAPApplicationServerInstancesClientBeginUpdateOptions{Body: &armworkloads.UpdateSAPApplicationInstanceRequest{
			Tags: map[string]*string{
				"tag1": to.Ptr("value1"),
			},
		},
