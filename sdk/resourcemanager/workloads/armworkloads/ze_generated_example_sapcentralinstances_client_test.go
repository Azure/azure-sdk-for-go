...
func ExampleSAPCentralInstancesClient_BeginCreate() {
	...
	poller, err := client.BeginCreate(ctx,
		...
		"X00",
		"centralServer",
		&armworkloads.SAPCentralInstancesClientBeginCreateOptions{Body: &armworkloads.SAPCentralServerInstance{
...
func ExampleSAPCentralInstancesClient_BeginUpdate() {
	...
	poller, err := client.BeginUpdate(ctx,
		...
		"X00",
		"centralServer",
		&armworkloads.SAPCentralInstancesClientBeginUpdateOptions{Body: &armworkloads.UpdateSAPCentralInstanceRequest{
			Tags: map[string]*string{
				"tag1": to.Ptr("value1"),
			},
		},
