...
func ExampleSAPDatabaseInstancesClient_BeginCreate() {
	...
	poller, err := client.BeginCreate(ctx,
		...
		"X00",
		"databaseServer",
		&armworkloads.SAPDatabaseInstancesClientBeginCreateOptions{Body: &armworkloads.SAPDatabaseInstance{
...
func ExampleSAPDatabaseInstancesClient_BeginUpdate() {
	...
	poller, err := client.BeginUpdate(ctx,
		...
		"X00",
		"databaseServer",
		&armworkloads.SAPDatabaseInstancesClientBeginUpdateOptions{Body: &armworkloads.UpdateSAPDatabaseInstanceRequest{
			Tags: map[string]*string{
				"key1": to.Ptr("value1"),
			},
		},
