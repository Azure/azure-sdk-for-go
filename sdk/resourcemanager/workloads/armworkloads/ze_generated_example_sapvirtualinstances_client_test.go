...
func ExampleSAPVirtualInstancesClient_BeginCreate() {
	...
	poller, err := client.BeginCreate(ctx,
		"test-rg",
		"X00",
		&armworkloads.SAPVirtualInstancesClientBeginCreateOptions{Body: &armworkloads.SAPVirtualInstance{
...
func ExampleSAPVirtualInstancesClient_Update() {
	...
	res, err := client.Update(ctx,
		"test-rg",
		"X00",
		&armworkloads.SAPVirtualInstancesClientUpdateOptions{Body: &armworkloads.UpdateSAPVirtualInstanceRequest{
