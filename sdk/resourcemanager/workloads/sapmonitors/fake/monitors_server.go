...
type MonitorsServer struct {
	...
	// HTTP status codes to indicate success: http.StatusOK
	Update func(ctx context.Context, resourceGroupName string, monitorName string, body sapmonitors.UpdateMonitorRequest, options *sapmonitors.MonitorsClientUpdateOptions) (resp azfake.Responder[sapmonitors.MonitorsClientUpdateResponse], errResp azfake.ErrorResponder)
}
