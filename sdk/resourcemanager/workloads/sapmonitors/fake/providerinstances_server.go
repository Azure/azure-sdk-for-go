...
type ProviderInstancesServer struct {
	...
	BeginCreate func(ctx context.Context, resourceGroupName string, monitorName string, providerInstanceName string, providerInstanceParameter sapmonitors.ProviderInstance, options *sapmonitors.ProviderInstancesClientBeginCreateOptions) (resp azfake.PollerResponder[sapmonitors.ProviderInstancesClientCreateResponse], errResp azfake.ErrorResponder)
	...
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager func(resourceGroupName string, monitorName string, options *sapmonitors.ProviderInstancesClientListOptions) (resp azfake.PagerResponder[sapmonitors.ProviderInstancesClientListResponse])
}
...
func NewProviderInstancesServerTransport(srv *ProviderInstancesServer) *ProviderInstancesServerTransport {
	return &ProviderInstancesServerTransport{
		...
		newListPager: newTracker[azfake.PagerResponder[sapmonitors.ProviderInstancesClientListResponse]](),
	}
}
...
type ProviderInstancesServerTransport struct {
	...
	newListPager *tracker[azfake.PagerResponder[sapmonitors.ProviderInstancesClientListResponse]]
}
...
func (p *ProviderInstancesServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *sapmonitors.ProviderInstancesClientListResponse, createLink func() string) {
