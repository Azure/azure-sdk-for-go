...
type SapLandscapeMonitorServer struct {
	...
	Create func(ctx context.Context, resourceGroupName string, monitorName string, sapLandscapeMonitorParameter sapmonitors.SapLandscapeMonitor, options *sapmonitors.SapLandscapeMonitorClientCreateOptions) (resp azfake.Responder[sapmonitors.SapLandscapeMonitorClientCreateResponse], errResp azfake.ErrorResponder)
	...
	// HTTP status codes to indicate success: http.StatusOK
	List func(ctx context.Context, resourceGroupName string, monitorName string, options *sapmonitors.SapLandscapeMonitorClientListOptions) (resp azfake.Responder[sapmonitors.SapLandscapeMonitorClientListResponse], errResp azfake.ErrorResponder)

	// Update is the fake for method SapLandscapeMonitorClient.Update
	// HTTP status codes to indicate success: http.StatusOK
	Update func(ctx context.Context, resourceGroupName string, monitorName string, sapLandscapeMonitorParameter sapmonitors.SapLandscapeMonitor, options *sapmonitors.SapLandscapeMonitorClientUpdateOptions) (resp azfake.Responder[sapmonitors.SapLandscapeMonitorClientUpdateResponse], errResp azfake.ErrorResponder)
}
...
func (s *SapLandscapeMonitorServerTransport) dispatchCreate(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[sapmonitors.SapLandscapeMonitor](req)
	if err != nil {
		return nil, err
	}
