...
type AADConnectivityStateDummy struct {
...
type ExternalSecuritySolution struct {
	ExternalSecuritySolutionKindDummy
	Location
	Resource
}
...
type ExternalSecuritySolutionKindDummy struct {
...
// UnmarshalJSON implements the json.Unmarshaller interface for type ExternalSecuritySolutionKindDummy.
func (e *ExternalSecuritySolutionKindDummy) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return err
	}
