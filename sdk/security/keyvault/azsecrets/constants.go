...
// DeletionRecoveryLevel - Reflects the deletion recovery level currently in effect for secrets in the
...
const (
	...
	// DeletionRecoveryLevelPurgeable - Denotes a vault state in which deletion is an irreversible operation, without
	...
	// DeletionRecoveryLevelRecoverable - Denotes a vault state in which deletion is recoverable without the possibility
