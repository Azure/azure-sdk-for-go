...
func (client *NamespacesClient) createOrUpdateIPFilterRuleCreateRequest(ctx context.Context, resourceGroupName string, namespaceName string, ipFilterRuleName string, parameters IPFilterRule, options *NamespacesCreateOrUpdateIPFilterRuleOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceBus/namespaces/{namespaceName}/ipfilterrules/{ipFilterRuleName}"
	if resourceGroupName == "" {
		return nil, errors.New("parameter resourceGroupName cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{resourceGroupName}", url.PathEscape(resourceGroupName))
...
func (client *NamespacesClient) createOrUpdateVirtualNetworkRuleCreateRequest(ctx context.Context, resourceGroupName string, namespaceName string, virtualNetworkRuleName string, parameters VirtualNetworkRule, options *NamespacesCreateOrUpdateVirtualNetworkRuleOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceBus/namespaces/{namespaceName}/virtualnetworkrules/{virtualNetworkRuleName}"
	if resourceGroupName == "" {
		return nil, errors.New("parameter resourceGroupName cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{resourceGroupName}", url.PathEscape(resourceGroupName))
...
func (client *NamespacesClient) listIPFilterRulesCreateRequest(ctx context.Context, resourceGroupName string, namespaceName string, options *NamespacesListIPFilterRulesOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceBus/namespaces/{namespaceName}/ipfilterrules"
	if resourceGroupName == "" {
		return nil, errors.New("parameter resourceGroupName cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{resourceGroupName}", url.PathEscape(resourceGroupName))
...
func (client *NamespacesClient) listNetworkRuleSetsHandleResponse(resp *http.Response) (NamespacesListNetworkRuleSetsResponse, error) {
	...
	if err := runtime.UnmarshalAsJSON(resp, &result.NetworkRuleSetListResult); err != nil {
		return NamespacesListNetworkRuleSetsResponse{}, err
	}
	return result, nil
}
...
func (client *NamespacesClient) listVirtualNetworkRulesCreateRequest(ctx context.Context, resourceGroupName string, namespaceName string, options *NamespacesListVirtualNetworkRulesOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceBus/namespaces/{namespaceName}/virtualnetworkrules"
	if resourceGroupName == "" {
		return nil, errors.New("parameter resourceGroupName cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{resourceGroupName}", url.PathEscape(resourceGroupName))
...
// If the operation fails it returns the *ErrorResponse error type.
func (client *NamespacesClient) Migrate(ctx context.Context, resourceGroupName string, namespaceName string, parameters SBNamespaceMigrate, options *NamespacesMigrateOptions) (NamespacesMigrateResponse, error) {
	req, err := client.migrateCreateRequest(ctx, resourceGroupName, namespaceName, parameters, options)
	if err != nil {
		return NamespacesMigrateResponse{}, err
	}
	resp, err := client.pl.Do(req)
	if err != nil {
		return NamespacesMigrateResponse{}, err
	...
	if !runtime.HasStatusCode(resp, http.StatusOK) {
		return NamespacesMigrateResponse{}, client.migrateHandleError(resp)
	}
	return NamespacesMigrateResponse{RawResponse: resp}, nil
}

// migrateCreateRequest creates the Migrate request.
func (client *NamespacesClient) migrateCreateRequest(ctx context.Context, resourceGroupName string, namespaceName string, parameters SBNamespaceMigrate, options *NamespacesMigrateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceBus/namespaces/{namespaceName}/migrate"
	if resourceGroupName == "" {
		return nil, errors.New("parameter resourceGroupName cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{resourceGroupName}", url.PathEscape(resourceGroupName))
...
func (client *NamespacesClient) migrateHandleError(resp *http.Response) error {
	body, err := runtime.Payload(resp)
	if err != nil {
		return runtime.NewResponseError(err, resp)
	}
