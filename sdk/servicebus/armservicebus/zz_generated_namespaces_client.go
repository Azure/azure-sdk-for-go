...
func (client *NamespacesClient) checkNameAvailabilityCreateRequest(ctx context.Context, parameters CheckNameAvailability, options *NamespacesCheckNameAvailabilityOptions) (*azcore.Request, error) {
...
// If the operation fails it returns the *ErrorResponse error type.
func (client *NamespacesClient) createOrUpdate(ctx context.Context, resourceGroupName string, namespaceName string, parameters SBNamespace, options *NamespacesBeginCreateOrUpdateOptions) (*azcore.Response, error) {
...
func (client *NamespacesClient) createOrUpdateCreateRequest(ctx context.Context, resourceGroupName string, namespaceName string, parameters SBNamespace, options *NamespacesBeginCreateOrUpdateOptions) (*azcore.Request, error) {
...
func (client *NamespacesClient) createOrUpdateAuthorizationRuleCreateRequest(ctx context.Context, resourceGroupName string, namespaceName string, authorizationRuleName string, parameters SBAuthorizationRule, options *NamespacesCreateOrUpdateAuthorizationRuleOptions) (*azcore.Request, error) {
...
func (client *NamespacesClient) getHandleResponse(resp *azcore.Response) (NamespacesGetResponse, error) {
	...
	if err := resp.UnmarshalAsJSON(&result.SBNamespace); err != nil {
		return NamespacesGetResponse{}, err
	}
	return result, nil
}
...
func (client *NamespacesClient) List(options *NamespacesListOptions) NamespacesListPager {
	return &namespacesListPager{
		...
		advancer: func(ctx context.Context, resp NamespacesListResponse) (*azcore.Request, error) {
			return azcore.NewRequest(ctx, http.MethodGet, *resp.SBNamespaceListResult.NextLink)
		},
	}
}
...
func (client *NamespacesClient) listHandleResponse(resp *azcore.Response) (NamespacesListResponse, error) {
	...
	if err := resp.UnmarshalAsJSON(&result.SBNamespaceListResult); err != nil {
...
func (client *NamespacesClient) ListNetworkRuleSets(resourceGroupName string, namespaceName string, options *NamespacesListNetworkRuleSetsOptions) NamespacesListNetworkRuleSetsPager {
	return &namespacesListNetworkRuleSetsPager{
		...
		advancer: func(ctx context.Context, resp NamespacesListNetworkRuleSetsResponse) (*azcore.Request, error) {
...
func (client *NamespacesClient) listNetworkRuleSetsHandleResponse(resp *azcore.Response) (NamespacesListNetworkRuleSetsResponse, error) {
	result := NamespacesListNetworkRuleSetsResponse{RawResponse: resp.Response}
	if err := resp.UnmarshalAsJSON(&result.NetworkRuleSetListResult); err != nil {
...
func (client *NamespacesClient) Migrate(ctx context.Context, resourceGroupName string, namespaceName string, parameters SBNamespaceMigrate, options *NamespacesMigrateOptions) (NamespacesMigrateResponse, error) {
	...
	return NamespacesMigrateResponse{RawResponse: resp.Response}, nil
}

// migrateCreateRequest creates the Migrate request.
func (client *NamespacesClient) migrateCreateRequest(ctx context.Context, resourceGroupName string, namespaceName string, parameters SBNamespaceMigrate, options *NamespacesMigrateOptions) (*azcore.Request, error) {
...
func (client *NamespacesClient) migrateHandleError(resp *azcore.Response) error {
	body, err := resp.Payload()
	if err != nil {
		return azcore.NewResponseError(err, resp.Response)
	}
...
func (client *NamespacesClient) updateCreateRequest(ctx context.Context, resourceGroupName string, namespaceName string, parameters SBNamespaceUpdateParameters, options *NamespacesUpdateOptions) (*azcore.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceBus/namespaces/{namespaceName}"
	if resourceGroupName == "" {
		return nil, errors.New("parameter resourceGroupName cannot be empty")
	}
