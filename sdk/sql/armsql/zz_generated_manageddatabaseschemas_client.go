...
func NewManagedDatabaseSchemasClient(con *armcore.Connection, subscriptionID string) *ManagedDatabaseSchemasClient {
	return &ManagedDatabaseSchemasClient{con: con, subscriptionID: subscriptionID}
}
...
func (client *ManagedDatabaseSchemasClient) getCreateRequest(ctx context.Context, resourceGroupName string, managedInstanceName string, databaseName string, schemaName string, options *ManagedDatabaseSchemasGetOptions) (*azcore.Request, error) {
...
func (client *ManagedDatabaseSchemasClient) getHandleResponse(resp *azcore.Response) (ManagedDatabaseSchemasGetResponse, error) {
	result := ManagedDatabaseSchemasGetResponse{RawResponse: resp.Response}
...
func (client *ManagedDatabaseSchemasClient) getHandleError(resp *azcore.Response) error {
...
func (client *ManagedDatabaseSchemasClient) ListByDatabase(resourceGroupName string, managedInstanceName string, databaseName string, options *ManagedDatabaseSchemasListByDatabaseOptions) ManagedDatabaseSchemasListByDatabasePager {
	return &managedDatabaseSchemasListByDatabasePager{
		...
		advancer: func(ctx context.Context, resp ManagedDatabaseSchemasListByDatabaseResponse) (*azcore.Request, error) {
...
func (client *ManagedDatabaseSchemasClient) listByDatabaseCreateRequest(ctx context.Context, resourceGroupName string, managedInstanceName string, databaseName string, options *ManagedDatabaseSchemasListByDatabaseOptions) (*azcore.Request, error) {
...
func (client *ManagedDatabaseSchemasClient) listByDatabaseHandleResponse(resp *azcore.Response) (ManagedDatabaseSchemasListByDatabaseResponse, error) {
	result := ManagedDatabaseSchemasListByDatabaseResponse{RawResponse: resp.Response}
...
func (client *ManagedDatabaseSchemasClient) listByDatabaseHandleError(resp *azcore.Response) error {
	body, err := resp.Payload()
	if err != nil {
		return azcore.NewResponseError(err, resp.Response)
	}
