...
func (ab *Client) SetExpiry(ctx context.Context, expiryOptions blob.ExpiryOptions, o *blob.SetExpiryOptions) (blob.SetExpiryResponse, error) {
	return ab.BlobClient().SetExpiry(ctx, expiryOptions, o)
}
