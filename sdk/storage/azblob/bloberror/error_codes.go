...
const (
	...
	IncrementalCopyOfEralierVersionSnapshotNotAllowed Code = "IncrementalCopyOfEralierVersionSnapshotNotAllowed" // Deprecated: Please use IncrementalCopyOfEarlierSnapshotNotAllowed instead.
