...
//	})
//	_require.NotNil(err)
//	validateBlobErrorCode(_require, err, StorageErrorCodeAppendPositionConditionNotMet)
//}
//
...
//	})
//	_require.NotNil(err)
//	validateBlobErrorCode(_require, err, StorageErrorCodeMaxBlobSizeConditionNotMet)
//}
//
