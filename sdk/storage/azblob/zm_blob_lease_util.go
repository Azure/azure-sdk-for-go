...
func (o *BlobAcquireLeaseOptions) pointers() (blobClientAcquireLeaseOptions, *ModifiedAccessConditions) {
	if o == nil {
...
func (o *BlobBreakLeaseOptions) pointers() (*blobClientBreakLeaseOptions, *ModifiedAccessConditions) {
	if o == nil {
		return nil, nil
	}
...
func (o *BlobChangeLeaseOptions) pointers() (*string, *blobClientChangeLeaseOptions, *ModifiedAccessConditions, error) {
...
func (o *BlobRenewLeaseOptions) pointers() (*blobClientRenewLeaseOptions, *ModifiedAccessConditions) {
	if o == nil {
		return nil, nil
	}
...
func (o *ReleaseLeaseBlobOptions) pointers() (*blobClientReleaseLeaseOptions, *ModifiedAccessConditions) {
	if o == nil {
		return nil, nil
	}
