...
func TestListBlobReturnsTags(t *testing.T) {
	t.Skip("TODO: Once new pacer is done")
	stop := start(t)
	defer stop()
...
//
//	containerClient3 := createNewContainer(assert.New(s.T()), generateContainerName(s.T().Name()) + "3", svcClient)
//	defer deleteContainer(assert.New(s.T()), containerClient3)
//
...
//	}
//
//	blobURL11 := getBlockBlobClient(generateBlobName(s.T().Name()) + "11", containerClient1)
...
//	_assert.NoError(err)
//
//	blobURL12 := getBlockBlobClient(generateBlobName(s.T().Name()) + "12", containerClient1)
...
//	_assert.NoError(err)
//
//	blobURL21 := getBlockBlobClient(generateBlobName(s.T().Name()) + "21", containerClient2)
...
//	_assert.NoError(err)
//
//	blobURL22 := getBlockBlobClient(generateBlobName(s.T().Name()) + "22", containerClient2)
...
//	_assert.NoError(err)
//
//	blobURL31 := getBlockBlobClient(generateBlobName(s.T().Name()) + "31", containerClient3)
