...
func (s *azblobTestSuite) TestConnectionStringParser() {
	...
	_assert.Equal(sharedKeyCred.accountName, "dummyaccount")
	_assert.Equal(getAccountKey(sharedKeyCred), "secretkeykey")
	_assert.True(strings.HasPrefix(client.client.endpoint, "https://"))
	_assert.True(strings.Contains(client.client.endpoint, "core.windows.net"))
}
...
func (s *azblobTestSuite) TestConnectionStringParserHTTP() {
	...
	_assert.Equal(sharedKeyCred.accountName, "dummyaccount")
	_assert.Equal(getAccountKey(sharedKeyCred), "secretkeykey")
	_assert.True(strings.HasPrefix(client.client.endpoint, "http://"))
	_assert.True(strings.Contains(client.client.endpoint, "core.windows.net"))
}
...
func (s *azblobTestSuite) TestConnectionStringParserCustomDomain() {
	...
	_assert.Equal(sharedKeyCred.accountName, "dummyaccount")
	_assert.Equal(getAccountKey(sharedKeyCred), "secretkeykey")
	_assert.True(strings.HasPrefix(client.client.endpoint, "www."))
	_assert.True(strings.Contains(client.client.endpoint, "mydomain.com"))
}
...
func (s *azblobTestSuite) TestConnectionStringChinaCloud() {
	...
	_assert.NotNil(client)
	_assert.True(strings.HasPrefix(client.client.endpoint, "http://"))
	_assert.True(strings.Contains(client.client.endpoint, "core.chinacloudapi.cn"))
...
func (s *azblobTestSuite) TestConnectionStringAzurite() {
	...
	_assert.NotNil(client)
	_assert.True(strings.HasPrefix(client.client.endpoint, "http://"))
	_assert.True(strings.Contains(client.client.endpoint, "http://local-machine:11002/custom/account/path/faketokensignature"))
