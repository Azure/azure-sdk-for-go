...
import (
	...
	"github.com/Azure/azure-sdk-for-go/sdk/storage/azfile/internal/structuredmessage"
)
...
func (c TransferValidationTypeCRC64) Apply(rsc io.ReadSeekCloser, cfg generated.TransactionalContentSetter) (io.ReadSeekCloser, error) {
	...
	// Note: azfile doesn't support transactional CRC64 yet according to generated code comment
	// This will be enabled when Azure File service starts supporting it
	return rsc, nil
}
