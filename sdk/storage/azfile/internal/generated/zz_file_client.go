...
// NewGetRangeListPager - Returns the list of valid ranges for a file.
//
// Generated from API version 2026-10-06
//   - options - FileClientGetRangeListOptions contains the optional parameters for the FileClient.NewGetRangeListPager method.
//   - LeaseAccessConditions - LeaseAccessConditions contains a group of parameters for the ShareClient.GetProperties method.
func (client *FileClient) NewGetRangeListPager(options *FileClientGetRangeListOptions, leaseAccessConditions *LeaseAccessConditions) *runtime.Pager[FileClientGetRangeListResponse] {
	return runtime.NewPager(runtime.PagingHandler[FileClientGetRangeListResponse]{
		More: func(page FileClientGetRangeListResponse) bool {
			return page.NextMarker != nil && len(*page.NextMarker) > 0
		},
		Fetcher: func(ctx context.Context, page *FileClientGetRangeListResponse) (FileClientGetRangeListResponse, error) {
			nextLink := ""
			if page != nil {
				nextLink = *page.NextMarker
			}
			resp, err := runtime.FetcherForNextLink(ctx, client.internal.Pipeline(), nextLink, func(ctx context.Context) (*policy.Request, error) {
				return client.getRangeListCreateRequest(ctx, options, leaseAccessConditions)
			}, nil)
			if err != nil {
