...
// GetProperties - Retrieves properties of a storage account's Queue service, including properties for Storage Analytics and
...
// NewListQueuesSegmentPager - Returns a list of queues.
...
func (client *ServiceClient) NewListQueuesSegmentPager(options *ServiceClientListQueuesSegmentOptions) *runtime.Pager[ServiceClientListQueuesSegmentResponse] {
	return runtime.NewPager(runtime.PagingHandler[ServiceClientListQueuesSegmentResponse]{
		...
		Fetcher: func(ctx context.Context, page *ServiceClientListQueuesSegmentResponse) (ServiceClientListQueuesSegmentResponse, error) {
			nextOpts := ServiceClientListQueuesSegmentOptions{}
			if options != nil {
				nextOpts = *options
			}
			if page != nil {
			...
			req, err := client.listQueuesSegmentCreateRequest(ctx, &nextOpts)
			if err != nil {
...
// If the operation fails it returns an *azcore.ResponseError type.
//   - queueServiceProperties - The storage service properties to set.
//   - options - ServiceClientSetPropertiesOptions contains the optional parameters for the ServiceClient.SetProperties method.
func (client *ServiceClient) SetProperties(ctx context.Context, queueServiceProperties StorageServiceProperties, options *ServiceClientSetPropertiesOptions) (ServiceClientSetPropertiesResponse, error) {
	var err error
	req, err := client.setPropertiesCreateRequest(ctx, queueServiceProperties, options)
	if err != nil {
...
func (client *ServiceClient) setPropertiesCreateRequest(ctx context.Context, queueServiceProperties StorageServiceProperties, options *ServiceClientSetPropertiesOptions) (*policy.Request, error) {
	urlPath := "?restype=service&comp=properties"
