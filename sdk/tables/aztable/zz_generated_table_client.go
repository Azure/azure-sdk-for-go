...
// If the operation fails it returns the *TableServiceError error type.
// Possible return types are *ByteArrayResponse, *TableInsertEntityResponse
...
func (client *tableClient) insertEntityCreateRequest(ctx context.Context, table string, tableInsertEntityOptions *TableInsertEntityOptions, queryOptions *QueryOptions) (*azcore.Request, error) {
	...
	if tableInsertEntityOptions != nil && tableInsertEntityOptions.TableEntityProperties != nil {
		return req, req.MarshalAsByteArray(tableInsertEntityOptions.TableEntityProperties, azcore.Base64StdFormat)
	}
	return req, nil
}
...
func (client *tableClient) insertEntityHandleResponse(resp *azcore.Response) (interface{}, error) {
	...
	case http.StatusCreated:
		...
		result := ByteArrayResponse{RawResponse: resp.Response, Value: val}
		if val := resp.Header.Get("x-ms-client-request-id"); val != "" {
			result.ClientRequestID = &val
		}
		if val := resp.Header.Get("x-ms-request-id"); val != "" {
...
func (client *tableClient) mergeEntityCreateRequest(ctx context.Context, table string, partitionKey string, rowKey string, tableMergeEntityOptions *TableMergeEntityOptions, queryOptions *QueryOptions) (*azcore.Request, error) {
	...
	if tableMergeEntityOptions != nil && tableMergeEntityOptions.TableEntityProperties != nil {
		return req, req.MarshalAsByteArray(tableMergeEntityOptions.TableEntityProperties, azcore.Base64StdFormat)
	}
	return req, nil
}
...
// If the operation fails it returns the *TableServiceError error type.
func (client *tableClient) QueryEntityWithPartitionAndRowKey(ctx context.Context, table string, partitionKey string, rowKey string, tableQueryEntityWithPartitionAndRowKeyOptions *TableQueryEntityWithPartitionAndRowKeyOptions, queryOptions *QueryOptions) (ByteArrayResponse, error) {
	...
	if !resp.HasStatusCode(http.StatusOK) {
		return ByteArrayResponse{}, client.queryEntityWithPartitionAndRowKeyHandleError(resp)
	}
...
func (client *tableClient) queryEntityWithPartitionAndRowKeyHandleResponse(resp *azcore.Response) (ByteArrayResponse, error) {
	var val []byte
	if err := resp.UnmarshalAsByteArray(&val, azcore.Base64StdFormat); err != nil {
		return ByteArrayResponse{}, err
	}
...
func (client *tableClient) updateEntityCreateRequest(ctx context.Context, table string, partitionKey string, rowKey string, tableUpdateEntityOptions *TableUpdateEntityOptions, queryOptions *QueryOptions) (*azcore.Request, error) {
	...
	if tableUpdateEntityOptions != nil && tableUpdateEntityOptions.TableEntityProperties != nil {
		return req, req.MarshalAsByteArray(tableUpdateEntityOptions.TableEntityProperties, azcore.Base64StdFormat)
	}
	return req, nil
}
