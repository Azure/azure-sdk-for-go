...
func NewDiagnosticsClient(con *arm.Connection, subscriptionID string) *DiagnosticsClient {
	return &DiagnosticsClient{ep: con.Endpoint(), pl: con.NewPipeline(module, version), subscriptionID: subscriptionID}
}
