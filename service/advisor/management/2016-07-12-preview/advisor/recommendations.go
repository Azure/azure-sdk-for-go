...
// GetGenerateRecommendationsStatus retrieves the status of the recommendation
// computation or generation process. Invoke this API after calling the
// generation recommendation. The URI of this API is returned in the Location
