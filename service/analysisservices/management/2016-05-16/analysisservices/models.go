...
type ServerMutableProperties struct {
	...
	DefaultConnectionMode  ConnectionMode        `json:"defaultConnectionMode,omitempty"`
}
...
// SkuDetailsForExistingResource is an object that represents SKU details for
// existing resources
type SkuDetailsForExistingResource struct {
	Sku *ResourceSku `json:"sku,omitempty"`
}

// SkuEnumerationForExistingResourceResult is an object that represents
// enumerating SKUs for existing resources
type SkuEnumerationForExistingResourceResult struct {
	autorest.Response `json:"-"`
	Value             *[]SkuDetailsForExistingResource `json:"value,omitempty"`
}

// SkuEnumerationForNewResourceResult is an object that represents enumerating
// SKUs for new resources
