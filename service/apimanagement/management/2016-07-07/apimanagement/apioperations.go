...
func (client APIOperationsClient) ListByAPIComplete(resourceGroupName string, serviceName string, aPIID string, filter string, top *int32, skip *int32, cancel <-chan struct{}) (<-chan OperationContract, <-chan error) {
