...
// PolicyClient is the use these REST APIs for performing operations on
...
// CreateOrUpdate creates or updates the global policy configuration of the Api
// Management service.
//
// resourceGroupName is the name of the resource group. serviceName is the name
// of the API Management service. policyID is the identifier of the Policy.
// parameters is the policy contents to apply.
func (client PolicyClient) CreateOrUpdate(resourceGroupName string, serviceName string, policyID string, parameters PolicyContract) (result PolicyContract, err error) {
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewErrorWithValidationError(err, "apimanagement.PolicyClient", "CreateOrUpdate")
	}

	req, err := client.CreateOrUpdatePreparer(resourceGroupName, serviceName, policyID, parameters)
	if err != nil {
...
func (client PolicyClient) CreateOrUpdatePreparer(resourceGroupName string, serviceName string, policyID string, parameters PolicyContract) (*http.Request, error) {
...
// Delete deletes the global policy configuration of the Api Management
// Service.
//
// resourceGroupName is the name of the resource group. serviceName is the name
// of the API Management service. policyID is the identifier of the Policy.
// ifMatch is the entity state (Etag) version of the policy to be deleted. A
// value of "*" can be used for If-Match to unconditionally apply the
// operation.
func (client PolicyClient) Delete(resourceGroupName string, serviceName string, policyID string, ifMatch string) (result autorest.Response, err error) {
	if err := validation.Validate([]validation.Validation{
		{TargetValue: serviceName,
			Constraints: []validation.Constraint{{Target: "serviceName", Name: validation.MaxLength, Rule: 50, Chain: nil},
				{Target: "serviceName", Name: validation.MinLength, Rule: 1, Chain: nil},
				{Target: "serviceName", Name: validation.Pattern, Rule: `^[a-zA-Z](?:[a-zA-Z0-9-]*[a-zA-Z0-9])?$`, Chain: nil}}}}); err != nil {
		return result, validation.NewErrorWithValidationError(err, "apimanagement.PolicyClient", "Delete")
	}

	req, err := client.DeletePreparer(resourceGroupName, serviceName, policyID, ifMatch)
	if err != nil {
...
func (client PolicyClient) DeletePreparer(resourceGroupName string, serviceName string, policyID string, ifMatch string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"policyId":          autorest.Encode("path", policyID),
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"serviceName":       autorest.Encode("path", serviceName),
...
// resourceGroupName is the name of the resource group. serviceName is the name
// of the API Management service. policyID is the identifier of the Policy.
func (client PolicyClient) Get(resourceGroupName string, serviceName string, policyID string) (result PolicyContract, err error) {
	if err := validation.Validate([]validation.Validation{
		{TargetValue: serviceName,
			Constraints: []validation.Constraint{{Target: "serviceName", Name: validation.MaxLength, Rule: 50, Chain: nil},
				{Target: "serviceName", Name: validation.MinLength, Rule: 1, Chain: nil},
				{Target: "serviceName", Name: validation.Pattern, Rule: `^[a-zA-Z](?:[a-zA-Z0-9-]*[a-zA-Z0-9])?$`, Chain: nil}}}}); err != nil {
		return result, validation.NewErrorWithValidationError(err, "apimanagement.PolicyClient", "Get")
	}

	req, err := client.GetPreparer(resourceGroupName, serviceName, policyID)
	if err != nil {
...
func (client PolicyClient) GetPreparer(resourceGroupName string, serviceName string, policyID string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"policyId":          autorest.Encode("path", policyID),
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"serviceName":       autorest.Encode("path", serviceName),
...
// ListByService lists all the Global Policy definitions of the Api Management
// service.
//
// resourceGroupName is the name of the resource group. serviceName is the name
// of the API Management service. scope is policy scope.
func (client PolicyClient) ListByService(resourceGroupName string, serviceName string, scope PolicyScopeContract) (result PolicyCollection, err error) {
	if err := validation.Validate([]validation.Validation{
		{TargetValue: serviceName,
			Constraints: []validation.Constraint{{Target: "serviceName", Name: validation.MaxLength, Rule: 50, Chain: nil},
				{Target: "serviceName", Name: validation.MinLength, Rule: 1, Chain: nil},
				{Target: "serviceName", Name: validation.Pattern, Rule: `^[a-zA-Z](?:[a-zA-Z0-9-]*[a-zA-Z0-9])?$`, Chain: nil}}}}); err != nil {
		return result, validation.NewErrorWithValidationError(err, "apimanagement.PolicyClient", "ListByService")
	}
...
func (client PolicyClient) ListByServicePreparer(resourceGroupName string, serviceName string, scope PolicyScopeContract) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"serviceName":       autorest.Encode("path", serviceName),
		"subscriptionId":    autorest.Encode("path", client.SubscriptionID),
