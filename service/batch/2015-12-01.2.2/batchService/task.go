...
//
// jobID is the id of the job to which the task is to be added. task is
// specifies the task to be added. timeout is sets the maximum time that the
...
// of the task to delete. timeout is sets the maximum time that the server can
...
// task to get information about. selectParameter is sets an OData $select
// clause. expand is sets an OData $expand clause. timeout is sets the maximum
...
// selectParameter is sets an OData $select clause. expand is sets an OData
// $expand clause. maxResults is sets the maximum number of items to return in
...
// sets an OData $select clause. timeout is sets the maximum time that the
// server can spend processing the request, in seconds. The default is 30
// seconds. clientRequestID is caller generated request identity, in the form
// of a GUID with no decoration such as curly braces e.g.
// 9C4D50EE-2D56-4CD3-8152-34347DC9F2B0. returnClientRequestID is specifies if
...
// to terminate. timeout is sets the maximum time that the server can spend
// processing the request, in seconds. The default is 30 seconds.
// clientRequestID is caller generated request identity, in the form of a GUID
// with no decoration such as curly braces e.g.
// 9C4D50EE-2D56-4CD3-8152-34347DC9F2B0. returnClientRequestID is specifies if
