...
func (client ApplicationClient) ListComplete(maxResults *int32, timeout *int32, clientRequestID string, returnClientRequestID *bool, ocpDate *date.TimeRFC1123, cancel <-chan struct{}) (<-chan ApplicationSummary, <-chan error) {
