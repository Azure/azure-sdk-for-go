...
// to return in the response. A maximum of 1000 results will be returned.
...
func (client AccountClient) ListNodeAgentSkus(filter string, maxResults *int32, timeout *int32, clientRequestID *uuid.UUID, returnClientRequestID *bool, ocpDate *date.TimeRFC1123) (result AccountListNodeAgentSkusResult, err error) {
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewErrorWithValidationError(err, "batchservice.AccountClient", "ListNodeAgentSkus")
	}
...
func (client AccountClient) ListNodeAgentSkusPreparer(filter string, maxResults *int32, timeout *int32, clientRequestID *uuid.UUID, returnClientRequestID *bool, ocpDate *date.TimeRFC1123) (*http.Request, error) {
...
func (client AccountClient) ListNodeAgentSkusComplete(filter string, maxResults *int32, timeout *int32, clientRequestID *uuid.UUID, returnClientRequestID *bool, ocpDate *date.TimeRFC1123, cancel <-chan struct{}) (<-chan NodeAgentSku, <-chan error) {
