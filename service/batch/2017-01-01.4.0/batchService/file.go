...
// ID of the compute node from which you want to delete the file. filePath is
// the path to the file that you want to delete. recursive is whether to delete
// children of a directory. If the filePath parameter represents a directory
...
// task whose file you want to delete. filePath is the path to the task file
...
//
// poolID is the ID of the pool that contains the compute node. nodeID is the
// ID of the compute node that contains the file. filePath is the path to the
// compute node file that you want to get the content of. timeout is the
...
// current system clock time; set it explicitly if you are calling the REST API
// directly. ocpRange is the byte range to be retrieved. The default is to
// retrieve the entire file. The format is bytes=startRange-endRange.
// ifModifiedSince is a timestamp indicating the last modified time of the
// resource known to the client. The operation will be performed only if the
// resource on the service has been modified since the specified time.
// ifUnmodifiedSince is a timestamp indicating the last modified time of the
// resource known to the client. The operation will be performed only if the
...
//
// jobID is the ID of the job that contains the task. taskID is the ID of the
// task whose file you want to retrieve. filePath is the path to the task file
...
// the time the request was issued. Client libraries typically set this to the
// current system clock time; set it explicitly if you are calling the REST API
// directly. ifModifiedSince is a timestamp indicating the last modified time
...
//
// jobID is the ID of the job that contains the task. taskID is the ID of the
// task whose file you want to get the properties of. filePath is the path to
...
// maximum of 1000 files can be returned. timeout is the maximum time that the
// server can spend processing the request, in seconds. The default is 30
// seconds. clientRequestID is the caller-generated request identity, in the
// form of a GUID with no decoration such as curly braces, e.g.
// 9C4D50EE-2D56-4CD3-8152-34347DC9F2B0. returnClientRequestID is whether the
...
func (client FileClient) ListFromComputeNodeComplete(poolID string, nodeID string, filter string, recursive *bool, maxResults *int32, timeout *int32, clientRequestID *uuid.UUID, returnClientRequestID *bool, ocpDate *date.TimeRFC1123, cancel <-chan struct{}) (<-chan NodeFile, <-chan error) {
...
// recursive is whether to list children of a directory. This parameter can be
// used in combination with the filter parameter to list specific type of
// files. maxResults is the maximum number of items to return in the response.
// A maximum of 1000 files can be returned. timeout is the maximum time that
...
func (client FileClient) ListFromTaskComplete(jobID string, taskID string, filter string, recursive *bool, maxResults *int32, timeout *int32, clientRequestID *uuid.UUID, returnClientRequestID *bool, ocpDate *date.TimeRFC1123, cancel <-chan struct{}) (<-chan NodeFile, <-chan error) {
	resultChan := make(chan NodeFile)
	errChan := make(chan error, 1)
	go func() {
		defer func() {
