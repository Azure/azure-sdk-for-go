...
//
// cloudJobSchedule is the job schedule to be added. timeout is the maximum
...
// directly.
func (client JobScheduleClient) Add(cloudJobSchedule JobScheduleAddParameter, timeout *int32, clientRequestID *uuid.UUID, returnClientRequestID *bool, ocpDate *date.TimeRFC1123) (result autorest.Response, err error) {
...
func (client JobScheduleClient) AddPreparer(cloudJobSchedule JobScheduleAddParameter, timeout *int32, clientRequestID *uuid.UUID, returnClientRequestID *bool, ocpDate *date.TimeRFC1123) (*http.Request, error) {
...
// Delete when you delete a job schedule, this also deletes all jobs and tasks
// under that schedule. When tasks are deleted, all the files in their working
...
// statistics.
//
// jobScheduleID is the ID of the job schedule to delete. timeout is the
...
// the time the request was issued. Client libraries typically set this to the
// current system clock time; set it explicitly if you are calling the REST API
// directly. ifMatch is an ETag value associated with the version of the
...
// by the client. ifNoneMatch is an ETag value associated with the version of
...
// specified by the client. ifModifiedSince is a timestamp indicating the last
...
// specified time. ifUnmodifiedSince is a timestamp indicating the last
// modified time of the resource known to the client. The operation will be
// performed only if the resource on the service has not been modified since
// the specified time.
func (client JobScheduleClient) Delete(jobScheduleID string, timeout *int32, clientRequestID *uuid.UUID, returnClientRequestID *bool, ocpDate *date.TimeRFC1123, ifMatch string, ifNoneMatch string, ifModifiedSince *date.TimeRFC1123, ifUnmodifiedSince *date.TimeRFC1123) (result autorest.Response, err error) {
...
func (client JobScheduleClient) DeletePreparer(jobScheduleID string, timeout *int32, clientRequestID *uuid.UUID, returnClientRequestID *bool, ocpDate *date.TimeRFC1123, ifMatch string, ifNoneMatch string, ifModifiedSince *date.TimeRFC1123, ifUnmodifiedSince *date.TimeRFC1123) (*http.Request, error) {
...
//
// jobScheduleID is the ID of the job schedule to disable. timeout is the
// maximum time that the server can spend processing the request, in seconds.
// The default is 30 seconds. clientRequestID is the caller-generated request
// identity, in the form of a GUID with no decoration such as curly braces,
// e.g. 9C4D50EE-2D56-4CD3-8152-34347DC9F2B0. returnClientRequestID is whether
...
// performed only if the resource on the service has not been modified since
// the specified time.
func (client JobScheduleClient) Disable(jobScheduleID string, timeout *int32, clientRequestID *uuid.UUID, returnClientRequestID *bool, ocpDate *date.TimeRFC1123, ifMatch string, ifNoneMatch string, ifModifiedSince *date.TimeRFC1123, ifUnmodifiedSince *date.TimeRFC1123) (result autorest.Response, err error) {
...
func (client JobScheduleClient) DisablePreparer(jobScheduleID string, timeout *int32, clientRequestID *uuid.UUID, returnClientRequestID *bool, ocpDate *date.TimeRFC1123, ifMatch string, ifNoneMatch string, ifModifiedSince *date.TimeRFC1123, ifUnmodifiedSince *date.TimeRFC1123) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"jobScheduleId": autorest.Encode("path", jobScheduleID),
	}
...
//
// jobScheduleID is the ID of the job schedule to enable. timeout is the
// maximum time that the server can spend processing the request, in seconds.
// The default is 30 seconds. clientRequestID is the caller-generated request
// identity, in the form of a GUID with no decoration such as curly braces,
// e.g. 9C4D50EE-2D56-4CD3-8152-34347DC9F2B0. returnClientRequestID is whether
...
// performed only if the resource on the service has not been modified since
// the specified time.
func (client JobScheduleClient) Enable(jobScheduleID string, timeout *int32, clientRequestID *uuid.UUID, returnClientRequestID *bool, ocpDate *date.TimeRFC1123, ifMatch string, ifNoneMatch string, ifModifiedSince *date.TimeRFC1123, ifUnmodifiedSince *date.TimeRFC1123) (result autorest.Response, err error) {
...
func (client JobScheduleClient) EnablePreparer(jobScheduleID string, timeout *int32, clientRequestID *uuid.UUID, returnClientRequestID *bool, ocpDate *date.TimeRFC1123, ifMatch string, ifNoneMatch string, ifModifiedSince *date.TimeRFC1123, ifUnmodifiedSince *date.TimeRFC1123) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"jobScheduleId": autorest.Encode("path", jobScheduleID),
	}
...
//
// jobScheduleID is the ID of the job schedule which you want to check. timeout
...
// the REST API directly. ifMatch is an ETag value associated with the version
// of the resource known to the client. The operation will be performed only if
// the resource's current ETag on the service exactly matches the value
// specified by the client. ifNoneMatch is an ETag value associated with the
// version of the resource known to the client. The operation will be performed
// only if the resource's current ETag on the service does not match the value
// specified by the client. ifModifiedSince is a timestamp indicating the last
// modified time of the resource known to the client. The operation will be
// performed only if the resource on the service has been modified since the
// specified time. ifUnmodifiedSince is a timestamp indicating the last
...
// performed only if the resource on the service has not been modified since
// the specified time.
func (client JobScheduleClient) Exists(jobScheduleID string, timeout *int32, clientRequestID *uuid.UUID, returnClientRequestID *bool, ocpDate *date.TimeRFC1123, ifMatch string, ifNoneMatch string, ifModifiedSince *date.TimeRFC1123, ifUnmodifiedSince *date.TimeRFC1123) (result autorest.Response, err error) {
...
func (client JobScheduleClient) ExistsPreparer(jobScheduleID string, timeout *int32, clientRequestID *uuid.UUID, returnClientRequestID *bool, ocpDate *date.TimeRFC1123, ifMatch string, ifNoneMatch string, ifModifiedSince *date.TimeRFC1123, ifUnmodifiedSince *date.TimeRFC1123) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"jobScheduleId": autorest.Encode("path", jobScheduleID),
	}
...
//
// jobScheduleID is the ID of the job schedule to get. selectParameter is an
// OData $select clause. expand is an OData $expand clause. timeout is the
// maximum time that the server can spend processing the request, in seconds.
// The default is 30 seconds. clientRequestID is the caller-generated request
// identity, in the form of a GUID with no decoration such as curly braces,
// e.g. 9C4D50EE-2D56-4CD3-8152-34347DC9F2B0. returnClientRequestID is whether
...
// of items to return in the response. A maximum of 1000 job schedules can be
// returned. timeout is the maximum time that the server can spend processing
// the request, in seconds. The default is 30 seconds. clientRequestID is the
...
func (client JobScheduleClient) List(filter string, selectParameter string, expand string, maxResults *int32, timeout *int32, clientRequestID *uuid.UUID, returnClientRequestID *bool, ocpDate *date.TimeRFC1123) (result CloudJobScheduleListResult, err error) {
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewErrorWithValidationError(err, "batchservice.JobScheduleClient", "List")
	}
...
func (client JobScheduleClient) ListPreparer(filter string, selectParameter string, expand string, maxResults *int32, timeout *int32, clientRequestID *uuid.UUID, returnClientRequestID *bool, ocpDate *date.TimeRFC1123) (*http.Request, error) {
	const APIVersion = "2017-05-01.5.0"
	queryParameters := map[string]interface{}{
		"api-version": APIVersion,
	}
...
func (client JobScheduleClient) ListComplete(filter string, selectParameter string, expand string, maxResults *int32, timeout *int32, clientRequestID *uuid.UUID, returnClientRequestID *bool, ocpDate *date.TimeRFC1123, cancel <-chan struct{}) (<-chan CloudJobSchedule, <-chan error) {
...
// Patch this replaces only the job schedule properties specified in the
// request. For example, if the schedule property is not specified with this
// request, then the Batch service will keep the existing schedule. Changes to
// a job schedule only impact jobs created by the schedule after the update has
// taken place; currently running jobs are unaffected.
//
// jobScheduleID is the ID of the job schedule to update.
// jobSchedulePatchParameter is the parameters for the request. timeout is the
// maximum time that the server can spend processing the request, in seconds.
// The default is 30 seconds. clientRequestID is the caller-generated request
// identity, in the form of a GUID with no decoration such as curly braces,
// e.g. 9C4D50EE-2D56-4CD3-8152-34347DC9F2B0. returnClientRequestID is whether
...
//
// jobScheduleID is the ID of the job schedule to terminates. timeout is the
// maximum time that the server can spend processing the request, in seconds.
// The default is 30 seconds. clientRequestID is the caller-generated request
// identity, in the form of a GUID with no decoration such as curly braces,
// e.g. 9C4D50EE-2D56-4CD3-8152-34347DC9F2B0. returnClientRequestID is whether
...
// performed only if the resource on the service has not been modified since
// the specified time.
func (client JobScheduleClient) Terminate(jobScheduleID string, timeout *int32, clientRequestID *uuid.UUID, returnClientRequestID *bool, ocpDate *date.TimeRFC1123, ifMatch string, ifNoneMatch string, ifModifiedSince *date.TimeRFC1123, ifUnmodifiedSince *date.TimeRFC1123) (result autorest.Response, err error) {
...
func (client JobScheduleClient) TerminatePreparer(jobScheduleID string, timeout *int32, clientRequestID *uuid.UUID, returnClientRequestID *bool, ocpDate *date.TimeRFC1123, ifMatch string, ifNoneMatch string, ifModifiedSince *date.TimeRFC1123, ifUnmodifiedSince *date.TimeRFC1123) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"jobScheduleId": autorest.Encode("path", jobScheduleID),
	}
...
// Update this fully replaces all the updateable properties of the job
// schedule. For example, if the schedule property is not specified with this
// request, then the Batch service will remove the existing schedule. Changes
// to a job schedule only impact jobs created by the schedule after the update
// has taken place; currently running jobs are unaffected.
//
// jobScheduleID is the ID of the job schedule to update.
// jobScheduleUpdateParameter is the parameters for the request. timeout is the
// maximum time that the server can spend processing the request, in seconds.
// The default is 30 seconds. clientRequestID is the caller-generated request
// identity, in the form of a GUID with no decoration such as curly braces,
// e.g. 9C4D50EE-2D56-4CD3-8152-34347DC9F2B0. returnClientRequestID is whether
