...
// TaskCountValidationStatus enumerates the values for task count validation
// status.
type TaskCountValidationStatus string

const (
	// Unvalidated specifies the unvalidated state for task count validation
	// status.
	Unvalidated TaskCountValidationStatus = "unvalidated"
	// Validated specifies the validated state for task count validation
	// status.
...
// ComputeNodeEndpointConfiguration is
