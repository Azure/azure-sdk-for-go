...
const (
	// ProvisioningStateCancelled specifies the provisioning state cancelled
	...
	// ProvisioningStateInvalid specifies the provisioning state invalid state
	// for provisioning state.
...
// CheckNameAvailabilityParameters is parameters for a check name availability
// request.
