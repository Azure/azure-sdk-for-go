...
// unique under endpoint originProperties is origin properties endpointName is
// name of the endpoint within the CDN profile. profileName is name of the CDN
// profile within the resource group. resourceGroupName is name of the resource
...
// name of the CDN profile within the resource group. resourceGroupName is name
