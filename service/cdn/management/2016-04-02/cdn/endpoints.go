...
// describe a file. profileName is name of the CDN profile within the resource
// group. resourceGroupName is name of the resource group within the Azure
// subscription.
...
//
// endpointName is name of the endpoint within the CDN profile.
// contentFilePaths is the path to the content to be purged. Path can describe
// a file or directory. profileName is name of the CDN profile within the
