...
// GroupClient is the the Container Service Client.
...
// the name of the container service within the given subscription and resource
// group. parameters is parameters supplied to the Create Container Service
// operation.
func (client GroupClient) CreateOrUpdate(resourceGroupName string, containerServiceName string, parameters Model, cancel <-chan struct{}) (<-chan Model, <-chan error) {
...
func (client GroupClient) CreateOrUpdatePreparer(resourceGroupName string, containerServiceName string, parameters Model, cancel <-chan struct{}) (*http.Request, error) {
...
// Delete the operation to delete a container service. This method may poll for
...
// the name of the container service within the given subscription and resource
// group.
func (client GroupClient) Get(resourceGroupName string, containerServiceName string) (result Model, err error) {
