...
func (client DisksClient) ListComplete(cancel <-chan struct{}) (<-chan Model, <-chan error) {
...
func (client DisksClient) ListByResourceGroupComplete(resourceGroupName string, cancel <-chan struct{}) (<-chan Model, <-chan error) {
	resultChan := make(chan Model)
	errChan := make(chan error, 1)
	go func() {
		defer func() {
