...
// MaintenanceOperationResultCodeTypes enumerates the values for maintenance
// operation result code types.
type MaintenanceOperationResultCodeTypes string

const (
	// MaintenanceOperationResultCodeTypesMaintenanceAborted specifies the
	// maintenance operation result code types maintenance aborted state for
	...
	// MaintenanceOperationResultCodeTypesMaintenanceCompleted specifies the
	// maintenance operation result code types maintenance completed state for
	// maintenance operation result code types.
	MaintenanceOperationResultCodeTypesMaintenanceCompleted MaintenanceOperationResultCodeTypes = "MaintenanceCompleted"
	// MaintenanceOperationResultCodeTypesNone specifies the maintenance
	// operation result code types none state for maintenance operation result
	// code types.
	MaintenanceOperationResultCodeTypesNone MaintenanceOperationResultCodeTypes = "None"
	// MaintenanceOperationResultCodeTypesRetryLater specifies the maintenance
	// operation result code types retry later state for maintenance operation
	// result code types.
...
const (
	// RecoveryModeNone specifies the recovery mode none state for recovery
	// mode.
	RecoveryModeNone RecoveryMode = "None"
	// RecoveryModeOverProvision specifies the recovery mode over provision
	// state for recovery mode.
	RecoveryModeOverProvision RecoveryMode = "OverProvision"
	// RecoveryModeReprovision specifies the recovery mode reprovision state
	// for recovery mode.
	RecoveryModeReprovision RecoveryMode = "Reprovision"
)
...
// ResourceSkuCapacityScaleType enumerates the values for resource sku capacity
// scale type.
type ResourceSkuCapacityScaleType string

const (
	// ResourceSkuCapacityScaleTypeAutomatic specifies the resource sku
	// capacity scale type automatic state for resource sku capacity scale
	// type.
	ResourceSkuCapacityScaleTypeAutomatic ResourceSkuCapacityScaleType = "Automatic"
	// ResourceSkuCapacityScaleTypeManual specifies the resource sku capacity
	// scale type manual state for resource sku capacity scale type.
	ResourceSkuCapacityScaleTypeManual ResourceSkuCapacityScaleType = "Manual"
	// ResourceSkuCapacityScaleTypeNone specifies the resource sku capacity
	// scale type none state for resource sku capacity scale type.
	ResourceSkuCapacityScaleTypeNone ResourceSkuCapacityScaleType = "None"
)

// ResourceSkuRestrictionsReasonCode enumerates the values for resource sku
// restrictions reason code.
type ResourceSkuRestrictionsReasonCode string

const (
	// NotAvailableForSubscription specifies the not available for subscription
	// state for resource sku restrictions reason code.
	NotAvailableForSubscription ResourceSkuRestrictionsReasonCode = "NotAvailableForSubscription"
	// QuotaID specifies the quota id state for resource sku restrictions
	// reason code.
	QuotaID ResourceSkuRestrictionsReasonCode = "QuotaId"
)

// ResourceSkuRestrictionsType enumerates the values for resource sku
// restrictions type.
type ResourceSkuRestrictionsType string

const (
	// Location specifies the location state for resource sku restrictions
	// type.
...
const (
	...
	// StandardA1V2 specifies the standard a1v2 state for virtual machine size
	// types.
	...
	// StandardA2mV2 specifies the standard a2mv2 state for virtual machine
	// size types.
	StandardA2mV2 VirtualMachineSizeTypes = "Standard_A2m_v2"
	// StandardA2V2 specifies the standard a2v2 state for virtual machine size
	// types.
	...
	// StandardA4mV2 specifies the standard a4mv2 state for virtual machine
	// size types.
	StandardA4mV2 VirtualMachineSizeTypes = "Standard_A4m_v2"
	// StandardA4V2 specifies the standard a4v2 state for virtual machine size
	// types.
	...
	// StandardA8mV2 specifies the standard a8mv2 state for virtual machine
	// size types.
	StandardA8mV2 VirtualMachineSizeTypes = "Standard_A8m_v2"
	// StandardA8V2 specifies the standard a8v2 state for virtual machine size
	// types.
	...
	// StandardF1 specifies the standard f1 state for virtual machine size
	// types.
	StandardF1 VirtualMachineSizeTypes = "Standard_F1"
	// StandardF16 specifies the standard f16 state for virtual machine size
	// types.
	StandardF16 VirtualMachineSizeTypes = "Standard_F16"
	// StandardF16s specifies the standard f16s state for virtual machine size
	// types.
	StandardF16s VirtualMachineSizeTypes = "Standard_F16s"
	// StandardF1s specifies the standard f1s state for virtual machine size
	// types.
	StandardF1s VirtualMachineSizeTypes = "Standard_F1s"
	// StandardF2 specifies the standard f2 state for virtual machine size
	// types.
	StandardF2 VirtualMachineSizeTypes = "Standard_F2"
	// StandardF2s specifies the standard f2s state for virtual machine size
	// types.
	StandardF2s VirtualMachineSizeTypes = "Standard_F2s"
	// StandardF4 specifies the standard f4 state for virtual machine size
	// types.
	StandardF4 VirtualMachineSizeTypes = "Standard_F4"
	// StandardF4s specifies the standard f4s state for virtual machine size
	// types.
	StandardF4s VirtualMachineSizeTypes = "Standard_F4s"
	// StandardF8 specifies the standard f8 state for virtual machine size
	// types.
	StandardF8 VirtualMachineSizeTypes = "Standard_F8"
	// StandardF8s specifies the standard f8s state for virtual machine size
	// types.
	...
	// StandardH16 specifies the standard h16 state for virtual machine size
	// types.
	StandardH16 VirtualMachineSizeTypes = "Standard_H16"
	// StandardH16m specifies the standard h16m state for virtual machine size
	// types.
	StandardH16m VirtualMachineSizeTypes = "Standard_H16m"
	// StandardH16mr specifies the standard h16mr state for virtual machine
	// size types.
	StandardH16mr VirtualMachineSizeTypes = "Standard_H16mr"
	// StandardH16r specifies the standard h16r state for virtual machine size
	// types.
	StandardH16r VirtualMachineSizeTypes = "Standard_H16r"
	// StandardH8 specifies the standard h8 state for virtual machine size
	// types.
	StandardH8 VirtualMachineSizeTypes = "Standard_H8"
	// StandardH8m specifies the standard h8m state for virtual machine size
	// types.
	StandardH8m VirtualMachineSizeTypes = "Standard_H8m"
	// StandardL16s specifies the standard l16s state for virtual machine size
	// types.
	StandardL16s VirtualMachineSizeTypes = "Standard_L16s"
	// StandardL32s specifies the standard l32s state for virtual machine size
	// types.
	StandardL32s VirtualMachineSizeTypes = "Standard_L32s"
	// StandardL4s specifies the standard l4s state for virtual machine size
	// types.
	StandardL4s VirtualMachineSizeTypes = "Standard_L4s"
	// StandardL8s specifies the standard l8s state for virtual machine size
	// types.
	StandardL8s VirtualMachineSizeTypes = "Standard_L8s"
	// StandardNC12 specifies the standard nc12 state for virtual machine size
	// types.
	StandardNC12 VirtualMachineSizeTypes = "Standard_NC12"
	// StandardNC24 specifies the standard nc24 state for virtual machine size
	// types.
	StandardNC24 VirtualMachineSizeTypes = "Standard_NC24"
	// StandardNC24r specifies the standard nc24r state for virtual machine
	// size types.
	StandardNC24r VirtualMachineSizeTypes = "Standard_NC24r"
	// StandardNC6 specifies the standard nc6 state for virtual machine size
	// types.
	StandardNC6 VirtualMachineSizeTypes = "Standard_NC6"
	// StandardNV12 specifies the standard nv12 state for virtual machine size
	// types.
	StandardNV12 VirtualMachineSizeTypes = "Standard_NV12"
	// StandardNV24 specifies the standard nv24 state for virtual machine size
	// types.
	StandardNV24 VirtualMachineSizeTypes = "Standard_NV24"
	// StandardNV6 specifies the standard nv6 state for virtual machine size
	// types.
...
// RecoveryPolicy is describes the recovery policy.
...
// VirtualMachineScaleSetExtensionListResult is the List VM scale set extension
// operation response.
...
// VirtualMachineScaleSetNetworkConfigurationDNSSettings is describes a virtual
// machines scale sets network configuration's DNS settings.
...
// VirtualMachineScaleSetPublicIPAddressConfiguration is describes a virtual
...
// VirtualMachineScaleSetPublicIPAddressConfigurationDNSSettings is describes a
// virtual machines scale sets network configuration's DNS settings.
type VirtualMachineScaleSetPublicIPAddressConfigurationDNSSettings struct {
	DomainNameLabel *string `json:"domainNameLabel,omitempty"`
}

// VirtualMachineScaleSetPublicIPAddressConfigurationProperties is describes a
// virtual machines scale set IP Configuration's PublicIPAddress configuration
