...
// VirtualMachineScaleSetExtensionsClient is the the Compute Management Client.
type VirtualMachineScaleSetExtensionsClient struct {
	ManagementClient
}

// NewVirtualMachineScaleSetExtensionsClient creates an instance of the
...
// NewVirtualMachineScaleSetExtensionsClientWithBaseURI creates an instance of
// the VirtualMachineScaleSetExtensionsClient client.
...
// CreateOrUpdate the operation to create or update an extension. This method
...
// name of the VM scale set where the extension should be create or updated.
// vmssExtensionName is the name of the VM scale set extension.
// extensionParameters is parameters supplied to the Create VM scale set
// Extension operation.
...
//
// resourceGroupName is the name of the resource group. VMScaleSetName is the
// name of the VM scale set where the extension should be deleted.
// vmssExtensionName is the name of the VM scale set extension.
...
//
// resourceGroupName is the name of the resource group. VMScaleSetName is the
// name of the VM scale set containing the extension. vmssExtensionName is the
// name of the VM scale set extension. expand is the expand expression to apply
// on the operation.
...
//
// resourceGroupName is the name of the resource group. VMScaleSetName is the
// name of the VM scale set containing the extension.
