...
// ContainerGroupsClient is the client for the ContainerGroups methods of the
// Containerinstance service.
type ContainerGroupsClient struct {
	ManagementClient
}

// NewContainerGroupsClient creates an instance of the ContainerGroupsClient
// client.
...
// NewContainerGroupsClientWithBaseURI creates an instance of the
// ContainerGroupsClient client.
...
//
// resourceGroupName is azure resource group name containerGroupName is
// container group name containerGroup is definition of the container to be
// created.
...
//
// resourceGroupName is azure resource group name containerGroupName is name of
// the container group to be deleted
...
// ListByResourceGroup get the list of container groups in a given resource
// group.
//
