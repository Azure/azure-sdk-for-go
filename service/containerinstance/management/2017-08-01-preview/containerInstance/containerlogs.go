...
// ContainerLogsClient is the client for the ContainerLogs methods of the
// Containerinstance service.
type ContainerLogsClient struct {
	ManagementClient
}

// NewContainerLogsClient creates an instance of the ContainerLogsClient
// client.
...
// NewContainerLogsClientWithBaseURI creates an instance of the
// ContainerLogsClient client.
...
//
// resourceGroupName is azure resource group name containerName is container
// name containerGroupName is container group name tail is only show this
// number of log lines. If not provided, all available logs are shown.
