...
// ContainerGroupNetworkProtocol enumerates the values for container group
// network protocol.
...
// ContainerGroupListResult is the container group list response that contains
...
// ContainerPropertiesInstanceView is the instance view of the container. Only
// valid in response.
