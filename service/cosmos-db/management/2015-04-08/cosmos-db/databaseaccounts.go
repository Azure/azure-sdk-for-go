...
// DatabaseAccountsClient is the azure Cosmos DB Database Service Resource
// Provider REST API
...
// CheckNameExists checks that the Azure Cosmos DB account name already exists.
// A valid account name may contain only lowercase letters, numbers, and the
...
// CreateOrUpdate creates or updates an Azure Cosmos DB database account. This
// method may poll for completion. Polling can be canceled by passing the
// cancel channel argument. The channel will be used to cancel polling and any
// outstanding HTTP requests.
//
// resourceGroupName is name of an Azure resource group. accountName is cosmos
// DB database account name. createUpdateParameters is the parameters to
...
// Delete deletes an existing Azure Cosmos DB database account. This method may
// poll for completion. Polling can be canceled by passing the cancel channel
// argument. The channel will be used to cancel polling and any outstanding
// HTTP requests.
//
// resourceGroupName is name of an Azure resource group. accountName is cosmos
// DB database account name.
...
// FailoverPriorityChange changes the failover priority for the Azure Cosmos DB
// database account. A failover priority of 0 indicates a write region. The
...
// database account exists. This method may poll for completion. Polling can be
// canceled by passing the cancel channel argument. The channel will be used to
// cancel polling and any outstanding HTTP requests.
//
// resourceGroupName is name of an Azure resource group. accountName is cosmos
// DB database account name. failoverParameters is the new failover policies
...
// Get retrieves the properties of an existing Azure Cosmos DB database
// account.
//
// resourceGroupName is name of an Azure resource group. accountName is cosmos
// DB database account name.
...
// List lists all the Azure Cosmos DB database accounts available under the
// subscription.
...
// ListByResourceGroup lists all the Azure Cosmos DB database accounts
...
// ListKeys lists the access keys for the specified Azure Cosmos DB database
// account.
//
// resourceGroupName is name of an Azure resource group. accountName is cosmos
// DB database account name.
...
// Patch patches the properties of an existing Azure Cosmos DB database
// account. This method may poll for completion. Polling can be canceled by
// passing the cancel channel argument. The channel will be used to cancel
// polling and any outstanding HTTP requests.
//
// resourceGroupName is name of an Azure resource group. accountName is cosmos
// DB database account name. updateParameters is the tags parameter to patch
// for the current database account.
...
// RegenerateKey regenerates an access key for the specified Azure Cosmos DB
// database account. This method may poll for completion. Polling can be
// canceled by passing the cancel channel argument. The channel will be used to
// cancel polling and any outstanding HTTP requests.
//
// resourceGroupName is name of an Azure resource group. accountName is cosmos
// DB database account name. keyToRegenerate is the name of the key to
// regenerate.
