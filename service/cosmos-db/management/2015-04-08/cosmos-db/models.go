...
// ConsistencyPolicy is the consistency policy for the Cosmos DB database
// account.
...
// DatabaseAccountConnectionString is connection string for the Cosmos DB
// account
...
// Azure Cosmos DB database accounts.
...
// DatabaseAccountPatchParameters is parameters for patching Azure Cosmos DB
...
// Location is a region in which the Azure Cosmos DB database account is
// deployed.
