...
// ConnectorMappingsClient is the the Azure Customer Insights management API
...
// NewConnectorMappingsClient creates an instance of the
// ConnectorMappingsClient client.
...
// NewConnectorMappingsClientWithBaseURI creates an instance of the
// ConnectorMappingsClient client.
...
// CreateOrUpdate creates a connector mapping or updates an existing connector
// mapping in the connector.
//
// resourceGroupName is the name of the resource group. hubName is the name of
// the hub. connectorName is the name of the connector. mappingName is the name
// of the connector mapping. parameters is parameters supplied to the
...
//
// resourceGroupName is the name of the resource group. hubName is the name of
// the hub. connectorName is the name of the connector.
