...
// HubsClient is the the Azure Customer Insights management API provides a
...
// the Hub. parameters is parameters supplied to the CreateOrUpdate Hub
// operation.
...
// Delete deletes the specified hub. This method may poll for completion.
...
//
// resourceGroupName is the name of the resource group. hubName is the name of
// the Hub. parameters is parameters supplied to the Update Hub operation.
