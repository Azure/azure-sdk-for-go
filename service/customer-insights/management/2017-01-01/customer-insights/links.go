...
// LinksClient is the the Azure Customer Insights management API provides a
...
// CreateOrUpdate creates a link or updates an existing link in the hub. This
...
//
// resourceGroupName is the name of the resource group. hubName is the name of
// the hub. linkName is the name of the link.
