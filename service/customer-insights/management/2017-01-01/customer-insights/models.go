...
const (
	// DataSourceTypeConnector specifies the data source type connector state
...
// DataSourcePrecedence is the data source precedence is a way to know the
// precedence of each data source.
