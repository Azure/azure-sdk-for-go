...
// Categories?$orderby=CategoryName desc. Optional. count is the Boolean value
// of true or false to request a count of the matching resources included with
// the resources in the response, e.g. Categories?$count=true. Optional. basic
// is the basic switch indicates what level of information to return when
// listing tables. When basic is true, only database_name, schema_name,
// table_name and version are returned for each table, otherwise all table
// metadata is returned. By default, it is false. Optional.
...
// listing tables. When basic is true, only database_name, schema_name,
// table_name and version are returned for each table, otherwise all table
// metadata is returned. By default, it is false
