...
const (
	// JobManagerResource specifies the job manager resource state for resource
	// type.
	JobManagerResource ResourceType = "JobManagerResource"
	// JobManagerResourceInUserFolder specifies the job manager resource in
	// user folder state for resource type.
	JobManagerResourceInUserFolder ResourceType = "JobManagerResourceInUserFolder"
	// StatisticsResource specifies the statistics resource state for resource
	// type.
	StatisticsResource ResourceType = "StatisticsResource"
	// StatisticsResourceInUserFolder specifies the statistics resource in user
	// folder state for resource type.
	...
	// VertexResourceInUserFolder specifies the vertex resource in user folder
	// state for resource type.
...
const (
	...
	// StateWaitingForCapacity specifies the state waiting for capacity state
	// for state.
...
// BaseJobParameters is data Lake Analytics Job Parameters base class for build
// and submit.
...
// BuildJobParameters is the parameters used to build a new Data Lake Analytics
// job.
...
// CreateJobParameters is the parameters used to submit a new Data Lake
// Analytics job.
...
// CreateJobProperties is the common Data Lake Analytics job properties for job
// submission.
...
// CreateUSQLJobProperties is u-SQL job properties used when submitting U-SQL
// jobs.
...
// Information is the extended Data Lake Analytics job information properties
// returned when retrieving a specific job.
...
// InformationBasic is the common Data Lake Analytics job information
// properties.
...
// PipelineInformation is job Pipeline Information, showing the relationship of
// jobs and recurrences of those jobs in a pipeline.
...
// RecurrenceInformation is recurrence job information for a specific
// recurrence.
...
// RelationshipProperties is job relationship information properties including
// pipeline information, correlation information, etc.
...
// StateAuditRecord is the Data Lake Analytics job state audit records for
// tracking the lifecycle of a job.
...
// StatisticsVertexStage is the Data Lake Analytics job statistics vertex stage
// information.
