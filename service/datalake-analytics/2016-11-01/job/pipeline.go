...
// operations on. pipelineIdentity is pipeline ID. startDateTime is the start
// date for when to get the pipeline and aggregate its data. The startDateTime
// and endDateTime can be no more than 30 days apart. endDateTime is the end
// date for when to get the pipeline and aggregate its data. The startDateTime
...
//
// accountName is the Azure Data Lake Analytics account to execute job
// operations on. startDateTime is the start date for when to get the list of
// pipelines. The startDateTime and endDateTime can be no more than 30 days
// apart. endDateTime is the end date for when to get the list of pipelines.
