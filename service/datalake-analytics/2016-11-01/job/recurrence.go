...
// operations on. recurrenceIdentity is recurrence ID. startDateTime is the
// start date for when to get the recurrence and aggregate its data. The
// startDateTime and endDateTime can be no more than 30 days apart. endDateTime
// is the end date for when to get recurrence and aggregate its data. The
...
// apart. endDateTime is the end date for when to get the list of recurrences.
