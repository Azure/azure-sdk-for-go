...
// are associated with an underlying Data Lake Analytics account. Returned only
...
// DataLakeAnalyticsAccountPropertiesBasic is the basic account specific
// properties that are associated with an underlying Data Lake Analytics
// account.
