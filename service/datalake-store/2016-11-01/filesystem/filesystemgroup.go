...
// error.appendParameter is flag to skip redirection. When append=false or not
// specified, the request is redirected. Submit another HTTP PUT request using
// the URL in the Location header with the file data to be written. When
// append=true, this redirection is skipped. op is the constant value for the
...
// closed/unlocked, and file metadata should get updated. leaseID is optional
// unique GUID per file to ensure single writer semantics, meaning that only
// clients that append to the file with the same leaseId will be allowed to do
// so. fileSessionID is optional unique GUID per file indicating all the
// appends with the same fileSessionId are from the same client and same
// session. This will give a performance benefit when syncFlag is DATA or
// METADATA.
...
// accountName is the Azure Data Lake Store account to execute filesystem
// operations on. pathParameter is the Data Lake Store path (starting with '/')
// of the destination file resulting from the concatenation. sources is a list
// of comma separated Data Lake Store paths (starting with '/') of the files to
...
// accountName is the Azure Data Lake Store account to execute filesystem
// operations on. pathParameter is the Data Lake Store path (starting with '/')
// of the file to which to append using concurrent append. streamContents is
// the file contents to include when appending to the file. streamContents will
...
// for append syncFlag is optionally indicates what to do after completion of
// the concurrent append. DATA indicates that more data will be sent
...
// accountName is the Azure Data Lake Store account to execute filesystem
// operations on. pathParameter is the Data Lake Store path (starting with '/')
// of the file to create. write is flag to skip redirection. When write=false
// or not specified, the request is redirected. Submit another HTTP PUT request
// using the URL in the Location header with the file data to be written. When
// write=true, this redirection is skipped. op is the constant value for the
// operation. streamContents is the file contents to include when creating the
// file. This parameter is optional, resulting in an empty file if not
// specified. streamContents will be closed upon successful return. Callers
...
// accountName is the Azure Data Lake Store account to execute filesystem
// operations on. pathParameter is the Data Lake Store path (starting with '/')
// of the file or directory to delete. op is the constant value for the
// operation. recursive is the optional switch indicating if the delete should
// be recursive
...
// accountName is the Azure Data Lake Store account to execute filesystem
// operations on. pathParameter is the Data Lake Store path (starting with '/')
// of the file for which to retrieve the summary. op is the constant value for
// the operation.
...
// accountName is the Azure Data Lake Store account to execute filesystem
// operations on. pathParameter is the Data Lake Store path (starting with '/')
// of the file or directory with the ACL being modified. aclspec is the ACL
...
// accountName is the Azure Data Lake Store account to execute filesystem
// operations on. pathParameter is the Data Lake Store path (starting with '/')
// of the destination file resulting from the concatenation. streamContents is
...
// accountName is the Azure Data Lake Store account to execute filesystem
// operations on. pathParameter is the Data Lake Store path (starting with '/')
// of the file to open. read is flag to skip redirection. When read=false or
// not specified, the request is redirected. Submit another HTTP PUT request
// using the URL in the Location header with the file data to be read. When
// read=true, this redirection is skipped. op is the constant value for the
// operation. length is the number of bytes that the server will attempt to
...
// accountName is the Azure Data Lake Store account to execute filesystem
// operations on. pathParameter is the Data Lake Store path (starting with '/')
// of the file or directory with the ACL being removed. aclspec is the ACL spec
...
// accountName is the Azure Data Lake Store account to execute filesystem
// operations on. pathParameter is the Data Lake Store path (starting with '/')
// of the file or directory on which to set the ACL. aclspec is the ACL spec
// included in ACL creation operations in the format
// '[default:]user|group|other::r|-w|-x|-' op is the constant value for the
// operation.
...
// accountName is the Azure Data Lake Store account to execute filesystem
// operations on. pathParameter is the Data Lake Store path (starting with '/')
// of the file on which to set or remove the expiration time. expiryOption is
...
// accountName is the Azure Data Lake Store account to execute filesystem
// operations on. pathParameter is the Data Lake Store path (starting with '/')
// of the file or directory for which to set the permission. op is the constant
