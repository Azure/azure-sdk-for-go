...
// DataLakeStoreAccountBasic is basic Data Lake Store account information,
...
// DataLakeStoreAccountPropertiesBasic is the basic account specific properties
// that are associated with an underlying Data Lake Store account.
...
// UpdateEncryptionConfig is the encryption configuration used to update a user
...
// UpdateKeyVaultMetaInfo is the Key Vault update information used for user
