...
// NewEnvironmentsClientWithBaseURI creates an instance of the
...
// CreateOrUpdate create or replace an existing environment. This operation can
// take a while to complete. This method may poll for completion. Polling can
...
// the lab. userName is the name of the user profile. name is the name of the
// environment. dtlEnvironment is an environment, which is essentially an ARM
// template deployment.
...
// Delete delete environment. This operation can take a while to complete. This
...
// resourceGroupName is the name of the resource group. labName is the name of
// the lab. userName is the name of the user profile. name is the name of the
// environment. expand is specify the $expand query. Example:
...
//
// resourceGroupName is the name of the resource group. labName is the name of
// the lab. userName is the name of the user profile. expand is specify the
// $expand query. Example: 'properties($select=deploymentProperties)' filter is
