...
// the zone without a terminating dot. recordType is the type of DNS record.
// relativeRecordSetName is the name of the RecordSet, relative to the name of
// the zone. parameters is parameters supplied to the CreateOrUpdate operation.
// ifMatch is the etag of RecordSet. ifNoneMatch is defines the If-None-Match
// condition. Set to '*' to force Create-If-Not-Exist. Other values will be
// ignored.
...
// the zone without a terminating dot. recordType is the type of DNS record.
// relativeRecordSetName is the name of the RecordSet, relative to the name of
// the zone. ifMatch is defines the If-Match condition. The delete operation
...
// recordType is the type of record sets to enumerate. top is query parameters.
// If null is passed returns the default number of zones. filter is the filter
...
//
// resourceGroupName is the name of the resource group that contains the zone.
// zoneName is the name of the zone from which to enumerate RecordSets. top is
