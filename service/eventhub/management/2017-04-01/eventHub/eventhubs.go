...
func (client EventHubsClient) CreateOrUpdate(resourceGroupName string, namespaceName string, eventHubName string, parameters Eventhub) (result Eventhub, err error) {
	if err := validation.Validate([]validation.Validation{
		...
		{TargetValue: parameters,
			Constraints: []validation.Constraint{{Target: "parameters.EventhubProperties", Name: validation.Null, Rule: false,
				Chain: []validation.Constraint{{Target: "parameters.EventhubProperties.MessageRetentionInDays", Name: validation.Null, Rule: false,
					Chain: []validation.Constraint{{Target: "parameters.EventhubProperties.MessageRetentionInDays", Name: validation.InclusiveMaximum, Rule: 7, Chain: nil},
						{Target: "parameters.EventhubProperties.MessageRetentionInDays", Name: validation.InclusiveMinimum, Rule: 1, Chain: nil},
					}},
					{Target: "parameters.EventhubProperties.PartitionCount", Name: validation.Null, Rule: false,
						Chain: []validation.Constraint{{Target: "parameters.EventhubProperties.PartitionCount", Name: validation.InclusiveMaximum, Rule: 32, Chain: nil},
							{Target: "parameters.EventhubProperties.PartitionCount", Name: validation.InclusiveMinimum, Rule: 1, Chain: nil},
						}},
					{Target: "parameters.EventhubProperties.CaptureDescription", Name: validation.Null, Rule: false,
						Chain: []validation.Constraint{{Target: "parameters.EventhubProperties.CaptureDescription.IntervalInSeconds", Name: validation.Null, Rule: false,
							Chain: []validation.Constraint{{Target: "parameters.EventhubProperties.CaptureDescription.IntervalInSeconds", Name: validation.InclusiveMaximum, Rule: 900, Chain: nil},
								{Target: "parameters.EventhubProperties.CaptureDescription.IntervalInSeconds", Name: validation.InclusiveMinimum, Rule: 60, Chain: nil},
							}},
							{Target: "parameters.EventhubProperties.CaptureDescription.SizeLimitInBytes", Name: validation.Null, Rule: false,
								Chain: []validation.Constraint{{Target: "parameters.EventhubProperties.CaptureDescription.SizeLimitInBytes", Name: validation.InclusiveMaximum, Rule: 524288000, Chain: nil},
									{Target: "parameters.EventhubProperties.CaptureDescription.SizeLimitInBytes", Name: validation.InclusiveMinimum, Rule: 10485760, Chain: nil},
								}},
						}},
				}}}}}); err != nil {
