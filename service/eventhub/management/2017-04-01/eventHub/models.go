...
// EncodingCaptureDescription enumerates the values for encoding capture
// description.
...
const (
	...
	// AvroDeflate specifies the avro deflate state for encoding capture
	// description.
...
// AuthorizationRule is single item in a List or Get AuthorizationRule
// operation
...
// AuthorizationRuleProperties is properties supplied to create or update
// AuthorizationRule
type AuthorizationRuleProperties struct {
	Rights *[]AccessRights `json:"rights,omitempty"`
}

// AuthorizationRuleListResult is the response from the List namespace
// operation.
...
// CaptureDescription is properties to configure capture description for
// eventhub
...
// ConsumerGroupProperties is single item in List or Get Consumer group
// operation
...
// DestinationProperties is properties describing the storage account, blob
// container and acrchive anme format for capture destination
...
// EHNamespaceProperties is namespace properties supplied for create namespace
// operation.
...
// EventhubProperties is properties supplied to the Create Or Update Event Hub
// operation.
