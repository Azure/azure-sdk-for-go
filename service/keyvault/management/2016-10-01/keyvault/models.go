...
const (
	// CreateModeDefault specifies the create mode default state for create
	// mode.
	CreateModeDefault CreateMode = "default"
	// CreateModeRecover specifies the create mode recover state for create
	// mode.
...
const (
	...
	// KeyPermissionsPurge specifies the key permissions purge state for key
	// permissions.
	KeyPermissionsPurge KeyPermissions = "purge"
	// KeyPermissionsRecover specifies the key permissions recover state for
	// key permissions.
...
const (
	// SecretPermissionsBackup specifies the secret permissions backup state
	...
	// SecretPermissionsPurge specifies the secret permissions purge state for
	// secret permissions.
	SecretPermissionsPurge SecretPermissions = "purge"
	// SecretPermissionsRecover specifies the secret permissions recover state
	// for secret permissions.
	SecretPermissionsRecover SecretPermissions = "recover"
	// SecretPermissionsRestore specifies the secret permissions restore state
	// for secret permissions.
...
const (
	// StoragePermissionsDelete specifies the storage permissions delete state
	// for storage permissions.
	StoragePermissionsDelete StoragePermissions = "delete"
	// StoragePermissionsDeletesas specifies the storage permissions deletesas
	// state for storage permissions.
	StoragePermissionsDeletesas StoragePermissions = "deletesas"
	// StoragePermissionsGet specifies the storage permissions get state for
	// storage permissions.
	StoragePermissionsGet StoragePermissions = "get"
	// StoragePermissionsGetsas specifies the storage permissions getsas state
	// for storage permissions.
	StoragePermissionsGetsas StoragePermissions = "getsas"
	// StoragePermissionsList specifies the storage permissions list state for
	// storage permissions.
	StoragePermissionsList StoragePermissions = "list"
	// StoragePermissionsListsas specifies the storage permissions listsas
	// state for storage permissions.
	StoragePermissionsListsas StoragePermissions = "listsas"
	// StoragePermissionsRegeneratekey specifies the storage permissions
	// regeneratekey state for storage permissions.
	StoragePermissionsRegeneratekey StoragePermissions = "regeneratekey"
	// StoragePermissionsSet specifies the storage permissions set state for
	// storage permissions.
	StoragePermissionsSet StoragePermissions = "set"
	// StoragePermissionsSetsas specifies the storage permissions setsas state
	// for storage permissions.
	StoragePermissionsSetsas StoragePermissions = "setsas"
	// StoragePermissionsUpdate specifies the storage permissions update state
	// for storage permissions.
...
// Permissions is permissions the identity has for keys, secrets, certificates
// and storage.
