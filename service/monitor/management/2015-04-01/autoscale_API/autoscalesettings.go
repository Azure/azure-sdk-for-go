...
// Update updates an existing AutoscaleSettingsResource. To update other fields
// use the CreateOrUpdate method.
//
// resourceGroupName is the name of the resource group. autoscaleSettingName is
// the autoscale setting name. autoscaleSettingResource is parameters supplied
// to the operation.
func (client AutoscaleSettingsClient) Update(resourceGroupName string, autoscaleSettingName string, autoscaleSettingResource AutoscaleSettingResourcePatch) (result AutoscaleSettingResource, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "autoscaleapi.AutoscaleSettingsClient", "Update", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "autoscaleapi.AutoscaleSettingsClient", "Update", resp, "Failure sending request")
		return
	}

	result, err = client.UpdateResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "autoscaleapi.AutoscaleSettingsClient", "Update", resp, "Failure responding to request")
	}
