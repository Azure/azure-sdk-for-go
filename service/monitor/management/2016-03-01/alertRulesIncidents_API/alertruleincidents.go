...
// AlertRuleIncidentsClient is the client for the AlertRuleIncidents methods of
// the Alertrulesincidentsapi service.
...
func (client AlertRuleIncidentsClient) Get(resourceGroupName string, ruleName string, incidentName string) (result Incident, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "alertrulesincidentsapi.AlertRuleIncidentsClient", "Get", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "alertrulesincidentsapi.AlertRuleIncidentsClient", "Get", resp, "Failure sending request")
		return
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "alertrulesincidentsapi.AlertRuleIncidentsClient", "Get", resp, "Failure responding to request")
	}
...
func (client AlertRuleIncidentsClient) ListByAlertRule(resourceGroupName string, ruleName string) (result IncidentListResult, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "alertrulesincidentsapi.AlertRuleIncidentsClient", "ListByAlertRule", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "alertrulesincidentsapi.AlertRuleIncidentsClient", "ListByAlertRule", resp, "Failure sending request")
		return
	}

	result, err = client.ListByAlertRuleResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "alertrulesincidentsapi.AlertRuleIncidentsClient", "ListByAlertRule", resp, "Failure responding to request")
	}
