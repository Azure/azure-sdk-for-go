...
// gateway conenction. parameters is parameters supplied to the Begin Create or
// update Virtual Network Gateway connection operation through Network resource
// provider.
