...
const (
	...
	// Draining specifies the draining state for backend health server health.
	Draining BackendHealthServerHealth = "Draining"
...
// AvailableWafRuleSetsResult is response for
// ApplicationGatewayAvailableWafRuleSets API service call.
type AvailableWafRuleSetsResult struct {
	autorest.Response `json:"-"`
	Value             *[]FirewallRuleSet `json:"value,omitempty"`
}
...
// FirewallDisabledRuleGroup is allows to disable rules within a rule group or
// an entire rule group.
type FirewallDisabledRuleGroup struct {
	RuleGroupName *string  `json:"ruleGroupName,omitempty"`
	Rules         *[]int32 `json:"rules,omitempty"`
}

// FirewallRule is a web application firewall rule.
type FirewallRule struct {
	RuleID      *int32  `json:"ruleId,omitempty"`
	Description *string `json:"description,omitempty"`
}

// FirewallRuleGroup is a web application firewall rule group.
...
// FirewallRuleSet is a web application firewall rule set.
type FirewallRuleSet struct {
	...
	*FirewallRuleSetPropertiesFormat `json:"properties,omitempty"`
}

// FirewallRuleSetPropertiesFormat is properties of the web application
// firewall rule set.
type FirewallRuleSetPropertiesFormat struct {
	ProvisioningState *string              `json:"provisioningState,omitempty"`
	RuleSetType       *string              `json:"ruleSetType,omitempty"`
	RuleSetVersion    *string              `json:"ruleSetVersion,omitempty"`
	RuleGroups        *[]FirewallRuleGroup `json:"ruleGroups,omitempty"`
}
...
type WebApplicationFirewallConfiguration struct {
	...
	RuleSetType        *string                      `json:"ruleSetType,omitempty"`
	RuleSetVersion     *string                      `json:"ruleSetVersion,omitempty"`
	DisabledRuleGroups *[]FirewallDisabledRuleGroup `json:"disabledRuleGroups,omitempty"`
}
