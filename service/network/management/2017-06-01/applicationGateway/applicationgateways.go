...
func (client ApplicationGatewaysClient) BackendHealth(resourceGroupName string, applicationGatewayName string, expand string, cancel <-chan struct{}) (<-chan BackendHealthType, <-chan error) {
	resultChan := make(chan BackendHealthType, 1)
	errChan := make(chan error, 1)
	go func() {
		var err error
		var result BackendHealthType
		defer func() {
			if err != nil {
				errChan <- err
			}
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "applicationgateway.ApplicationGatewaysClient", "BackendHealth", nil, "Failure preparing request")
			return
		}
		...
		if err != nil {
			...
			err = autorest.NewErrorWithError(err, "applicationgateway.ApplicationGatewaysClient", "BackendHealth", resp, "Failure sending request")
			return
		}

		result, err = client.BackendHealthResponder(resp)
		if err != nil {
			err = autorest.NewErrorWithError(err, "applicationgateway.ApplicationGatewaysClient", "BackendHealth", resp, "Failure responding to request")
		}
	}()
...
func (client ApplicationGatewaysClient) BackendHealthResponder(resp *http.Response) (result BackendHealthType, err error) {
...
func (client ApplicationGatewaysClient) CreateOrUpdate(resourceGroupName string, applicationGatewayName string, parameters Model, cancel <-chan struct{}) (<-chan Model, <-chan error) {
	resultChan := make(chan Model, 1)
	errChan := make(chan error, 1)
	if err := validation.Validate([]validation.Validation{
		{TargetValue: parameters,
			Constraints: []validation.Constraint{{Target: "parameters.PropertiesFormat", Name: validation.Null, Rule: false,
				Chain: []validation.Constraint{{Target: "parameters.PropertiesFormat.WebApplicationFirewallConfiguration", Name: validation.Null, Rule: false,
					Chain: []validation.Constraint{{Target: "parameters.PropertiesFormat.WebApplicationFirewallConfiguration.Enabled", Name: validation.Null, Rule: true, Chain: nil},
						{Target: "parameters.PropertiesFormat.WebApplicationFirewallConfiguration.RuleSetType", Name: validation.Null, Rule: true, Chain: nil},
						{Target: "parameters.PropertiesFormat.WebApplicationFirewallConfiguration.RuleSetVersion", Name: validation.Null, Rule: true, Chain: nil},
					}},
				}}}}}); err != nil {
		errChan <- validation.NewErrorWithValidationError(err, "applicationgateway.ApplicationGatewaysClient", "CreateOrUpdate")
		close(errChan)
		close(resultChan)
		return resultChan, errChan
	}
	...
	go func() {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "applicationgateway.ApplicationGatewaysClient", "CreateOrUpdate", nil, "Failure preparing request")
			return
		}
		...
		if err != nil {
			result.Response = autorest.Response{Response: resp}
			err = autorest.NewErrorWithError(err, "applicationgateway.ApplicationGatewaysClient", "CreateOrUpdate", resp, "Failure sending request")
			return
		}

		result, err = client.CreateOrUpdateResponder(resp)
		if err != nil {
			err = autorest.NewErrorWithError(err, "applicationgateway.ApplicationGatewaysClient", "CreateOrUpdate", resp, "Failure responding to request")
		}
	}()
	return resultChan, errChan
}
...
func (client ApplicationGatewaysClient) CreateOrUpdatePreparer(resourceGroupName string, applicationGatewayName string, parameters Model, cancel <-chan struct{}) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"applicationGatewayName": autorest.Encode("path", applicationGatewayName),
		"resourceGroupName":      autorest.Encode("path", resourceGroupName),
		"subscriptionId":         autorest.Encode("path", client.SubscriptionID),
...
// closes the http.Response Body.
func (client ApplicationGatewaysClient) CreateOrUpdateResponder(resp *http.Response) (result Model, err error) {
	err = autorest.Respond(
		resp,
		client.ByInspecting(),
...
func (client ApplicationGatewaysClient) Delete(resourceGroupName string, applicationGatewayName string, cancel <-chan struct{}) (<-chan autorest.Response, <-chan error) {
	...
	go func() {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "applicationgateway.ApplicationGatewaysClient", "Delete", nil, "Failure preparing request")
			return
		}
		...
		if err != nil {
			...
			err = autorest.NewErrorWithError(err, "applicationgateway.ApplicationGatewaysClient", "Delete", resp, "Failure sending request")
			return
		}

		result, err = client.DeleteResponder(resp)
		if err != nil {
			err = autorest.NewErrorWithError(err, "applicationgateway.ApplicationGatewaysClient", "Delete", resp, "Failure responding to request")
		}
	}()
	return resultChan, errChan
}
...
// resourceGroupName is the name of the resource group. applicationGatewayName
// is the name of the application gateway.
func (client ApplicationGatewaysClient) Get(resourceGroupName string, applicationGatewayName string) (result Model, err error) {
	req, err := client.GetPreparer(resourceGroupName, applicationGatewayName)
	if err != nil {
		err = autorest.NewErrorWithError(err, "applicationgateway.ApplicationGatewaysClient", "Get", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "applicationgateway.ApplicationGatewaysClient", "Get", resp, "Failure sending request")
		return
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "applicationgateway.ApplicationGatewaysClient", "Get", resp, "Failure responding to request")
	}
...
// closes the http.Response Body.
func (client ApplicationGatewaysClient) GetResponder(resp *http.Response) (result Model, err error) {
	err = autorest.Respond(
		resp,
		client.ByInspecting(),
...
// GetSslPredefinedPolicy gets Ssl predefined policy with the specified policy
// name.
//
// predefinedPolicyName is name of Ssl predefined policy.
func (client ApplicationGatewaysClient) GetSslPredefinedPolicy(predefinedPolicyName string) (result SslPredefinedPolicy, err error) {
	req, err := client.GetSslPredefinedPolicyPreparer(predefinedPolicyName)
	if err != nil {
		err = autorest.NewErrorWithError(err, "applicationgateway.ApplicationGatewaysClient", "GetSslPredefinedPolicy", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "applicationgateway.ApplicationGatewaysClient", "GetSslPredefinedPolicy", resp, "Failure sending request")
		return
	}

	result, err = client.GetSslPredefinedPolicyResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "applicationgateway.ApplicationGatewaysClient", "GetSslPredefinedPolicy", resp, "Failure responding to request")
	}
...
// closes the http.Response Body.
func (client ApplicationGatewaysClient) GetSslPredefinedPolicyResponder(resp *http.Response) (result SslPredefinedPolicy, err error) {
	err = autorest.Respond(
		resp,
		client.ByInspecting(),
		azure.WithErrorUnlessStatusCode(http.StatusOK),
...
func (client ApplicationGatewaysClient) List(resourceGroupName string) (result ListResult, err error) {
	req, err := client.ListPreparer(resourceGroupName)
	if err != nil {
		err = autorest.NewErrorWithError(err, "applicationgateway.ApplicationGatewaysClient", "List", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "applicationgateway.ApplicationGatewaysClient", "List", resp, "Failure sending request")
		return
	}

	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "applicationgateway.ApplicationGatewaysClient", "List", resp, "Failure responding to request")
	}
...
// closes the http.Response Body.
func (client ApplicationGatewaysClient) ListResponder(resp *http.Response) (result ListResult, err error) {
	err = autorest.Respond(
		resp,
		client.ByInspecting(),
		azure.WithErrorUnlessStatusCode(http.StatusOK),
...
func (client ApplicationGatewaysClient) ListNextResults(lastResults ListResult) (result ListResult, err error) {
	req, err := lastResults.ListResultPreparer()
	if err != nil {
		return result, autorest.NewErrorWithError(err, "applicationgateway.ApplicationGatewaysClient", "List", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "applicationgateway.ApplicationGatewaysClient", "List", resp, "Failure sending next results request")
	}

	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "applicationgateway.ApplicationGatewaysClient", "List", resp, "Failure responding to next results request")
	}
...
func (client ApplicationGatewaysClient) ListComplete(resourceGroupName string, cancel <-chan struct{}) (<-chan Model, <-chan error) {
...
func (client ApplicationGatewaysClient) ListAll() (result ListResult, err error) {
	req, err := client.ListAllPreparer()
	if err != nil {
		err = autorest.NewErrorWithError(err, "applicationgateway.ApplicationGatewaysClient", "ListAll", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "applicationgateway.ApplicationGatewaysClient", "ListAll", resp, "Failure sending request")
		return
	}

	result, err = client.ListAllResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "applicationgateway.ApplicationGatewaysClient", "ListAll", resp, "Failure responding to request")
	}
...
// closes the http.Response Body.
func (client ApplicationGatewaysClient) ListAllResponder(resp *http.Response) (result ListResult, err error) {
	err = autorest.Respond(
		resp,
		client.ByInspecting(),
		azure.WithErrorUnlessStatusCode(http.StatusOK),
...
func (client ApplicationGatewaysClient) ListAllNextResults(lastResults ListResult) (result ListResult, err error) {
	req, err := lastResults.ListResultPreparer()
	if err != nil {
		return result, autorest.NewErrorWithError(err, "applicationgateway.ApplicationGatewaysClient", "ListAll", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "applicationgateway.ApplicationGatewaysClient", "ListAll", resp, "Failure sending next results request")
	}

	result, err = client.ListAllResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "applicationgateway.ApplicationGatewaysClient", "ListAll", resp, "Failure responding to next results request")
	}
...
func (client ApplicationGatewaysClient) ListAllComplete(cancel <-chan struct{}) (<-chan Model, <-chan error) {
	resultChan := make(chan Model)
	errChan := make(chan error, 1)
	go func() {
		defer func() {
...
// ListAvailableSslOptions lists available Ssl options for configuring Ssl
// policy.
func (client ApplicationGatewaysClient) ListAvailableSslOptions() (result AvailableSslOptions, err error) {
	req, err := client.ListAvailableSslOptionsPreparer()
	if err != nil {
		err = autorest.NewErrorWithError(err, "applicationgateway.ApplicationGatewaysClient", "ListAvailableSslOptions", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "applicationgateway.ApplicationGatewaysClient", "ListAvailableSslOptions", resp, "Failure sending request")
		return
	}

	result, err = client.ListAvailableSslOptionsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "applicationgateway.ApplicationGatewaysClient", "ListAvailableSslOptions", resp, "Failure responding to request")
	}
...
// closes the http.Response Body.
func (client ApplicationGatewaysClient) ListAvailableSslOptionsResponder(resp *http.Response) (result AvailableSslOptions, err error) {
	err = autorest.Respond(
		resp,
		client.ByInspecting(),
		azure.WithErrorUnlessStatusCode(http.StatusOK),
...
// ListAvailableSslPredefinedPolicies lists all SSL predefined policies for
// configuring Ssl policy.
func (client ApplicationGatewaysClient) ListAvailableSslPredefinedPolicies() (result AvailableSslPredefinedPolicies, err error) {
	req, err := client.ListAvailableSslPredefinedPoliciesPreparer()
	if err != nil {
		err = autorest.NewErrorWithError(err, "applicationgateway.ApplicationGatewaysClient", "ListAvailableSslPredefinedPolicies", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "applicationgateway.ApplicationGatewaysClient", "ListAvailableSslPredefinedPolicies", resp, "Failure sending request")
		return
	}

	result, err = client.ListAvailableSslPredefinedPoliciesResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "applicationgateway.ApplicationGatewaysClient", "ListAvailableSslPredefinedPolicies", resp, "Failure responding to request")
	}
...
// closes the http.Response Body.
func (client ApplicationGatewaysClient) ListAvailableSslPredefinedPoliciesResponder(resp *http.Response) (result AvailableSslPredefinedPolicies, err error) {
	err = autorest.Respond(
		resp,
		client.ByInspecting(),
		azure.WithErrorUnlessStatusCode(http.StatusOK),
...
func (client ApplicationGatewaysClient) ListAvailableSslPredefinedPoliciesNextResults(lastResults AvailableSslPredefinedPolicies) (result AvailableSslPredefinedPolicies, err error) {
	req, err := lastResults.AvailableSslPredefinedPoliciesPreparer()
	if err != nil {
		return result, autorest.NewErrorWithError(err, "applicationgateway.ApplicationGatewaysClient", "ListAvailableSslPredefinedPolicies", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "applicationgateway.ApplicationGatewaysClient", "ListAvailableSslPredefinedPolicies", resp, "Failure sending next results request")
	}

	result, err = client.ListAvailableSslPredefinedPoliciesResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "applicationgateway.ApplicationGatewaysClient", "ListAvailableSslPredefinedPolicies", resp, "Failure responding to next results request")
	}
...
func (client ApplicationGatewaysClient) ListAvailableSslPredefinedPoliciesComplete(cancel <-chan struct{}) (<-chan SslPredefinedPolicy, <-chan error) {
	resultChan := make(chan SslPredefinedPolicy)
	errChan := make(chan error, 1)
	go func() {
		defer func() {
			close(resultChan)
...
// sets.
func (client ApplicationGatewaysClient) ListAvailableWafRuleSets() (result AvailableWafRuleSetsResult, err error) {
	req, err := client.ListAvailableWafRuleSetsPreparer()
	if err != nil {
		err = autorest.NewErrorWithError(err, "applicationgateway.ApplicationGatewaysClient", "ListAvailableWafRuleSets", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "applicationgateway.ApplicationGatewaysClient", "ListAvailableWafRuleSets", resp, "Failure sending request")
		return
	}

	result, err = client.ListAvailableWafRuleSetsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "applicationgateway.ApplicationGatewaysClient", "ListAvailableWafRuleSets", resp, "Failure responding to request")
	}
...
// closes the http.Response Body.
func (client ApplicationGatewaysClient) ListAvailableWafRuleSetsResponder(resp *http.Response) (result AvailableWafRuleSetsResult, err error) {
	err = autorest.Respond(
		resp,
		client.ByInspecting(),
		azure.WithErrorUnlessStatusCode(http.StatusOK),
...
func (client ApplicationGatewaysClient) Start(resourceGroupName string, applicationGatewayName string, cancel <-chan struct{}) (<-chan autorest.Response, <-chan error) {
	...
	go func() {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "applicationgateway.ApplicationGatewaysClient", "Start", nil, "Failure preparing request")
			return
		}
		...
		if err != nil {
			result.Response = resp
			err = autorest.NewErrorWithError(err, "applicationgateway.ApplicationGatewaysClient", "Start", resp, "Failure sending request")
			return
		}

		result, err = client.StartResponder(resp)
		if err != nil {
			err = autorest.NewErrorWithError(err, "applicationgateway.ApplicationGatewaysClient", "Start", resp, "Failure responding to request")
		}
	}()
	return resultChan, errChan
}
...
func (client ApplicationGatewaysClient) Stop(resourceGroupName string, applicationGatewayName string, cancel <-chan struct{}) (<-chan autorest.Response, <-chan error) {
	...
	go func() {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "applicationgateway.ApplicationGatewaysClient", "Stop", nil, "Failure preparing request")
			return
		}
		...
		if err != nil {
			result.Response = resp
			err = autorest.NewErrorWithError(err, "applicationgateway.ApplicationGatewaysClient", "Stop", resp, "Failure sending request")
			return
		}

		result, err = client.StopResponder(resp)
		if err != nil {
			err = autorest.NewErrorWithError(err, "applicationgateway.ApplicationGatewaysClient", "Stop", resp, "Failure responding to request")
		}
	}()
	return resultChan, errChan
}
