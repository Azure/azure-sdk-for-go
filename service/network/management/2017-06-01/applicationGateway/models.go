...
const (
	// Found specifies the found state for redirect type.
	Found RedirectType = "Found"
	// Permanent specifies the permanent state for redirect type.
	Permanent RedirectType = "Permanent"
	// SeeOther specifies the see other state for redirect type.
	SeeOther RedirectType = "SeeOther"
	// Temporary specifies the temporary state for redirect type.
...
// SslCipherSuite enumerates the values for ssl cipher suite.
type SslCipherSuite string

const (
	// TLSDHEDSSWITHAES128CBCSHA specifies the tlsdhedsswithaes128cbcsha state
	// for ssl cipher suite.
	TLSDHEDSSWITHAES128CBCSHA SslCipherSuite = "TLS_DHE_DSS_WITH_AES_128_CBC_SHA"
	// TLSDHEDSSWITHAES128CBCSHA256 specifies the tlsdhedsswithaes128cbcsha256
	// state for ssl cipher suite.
	TLSDHEDSSWITHAES128CBCSHA256 SslCipherSuite = "TLS_DHE_DSS_WITH_AES_128_CBC_SHA256"
	// TLSDHEDSSWITHAES256CBCSHA specifies the tlsdhedsswithaes256cbcsha state
	// for ssl cipher suite.
	TLSDHEDSSWITHAES256CBCSHA SslCipherSuite = "TLS_DHE_DSS_WITH_AES_256_CBC_SHA"
	// TLSDHEDSSWITHAES256CBCSHA256 specifies the tlsdhedsswithaes256cbcsha256
	// state for ssl cipher suite.
	TLSDHEDSSWITHAES256CBCSHA256 SslCipherSuite = "TLS_DHE_DSS_WITH_AES_256_CBC_SHA256"
	// TLSDHERSAWITHAES128CBCSHA specifies the tlsdhersawithaes128cbcsha state
	// for ssl cipher suite.
	TLSDHERSAWITHAES128CBCSHA SslCipherSuite = "TLS_DHE_RSA_WITH_AES_128_CBC_SHA"
	// TLSDHERSAWITHAES128GCMSHA256 specifies the tlsdhersawithaes128gcmsha256
	// state for ssl cipher suite.
	TLSDHERSAWITHAES128GCMSHA256 SslCipherSuite = "TLS_DHE_RSA_WITH_AES_128_GCM_SHA256"
	// TLSDHERSAWITHAES256CBCSHA specifies the tlsdhersawithaes256cbcsha state
	// for ssl cipher suite.
	TLSDHERSAWITHAES256CBCSHA SslCipherSuite = "TLS_DHE_RSA_WITH_AES_256_CBC_SHA"
	// TLSDHERSAWITHAES256GCMSHA384 specifies the tlsdhersawithaes256gcmsha384
	// state for ssl cipher suite.
	TLSDHERSAWITHAES256GCMSHA384 SslCipherSuite = "TLS_DHE_RSA_WITH_AES_256_GCM_SHA384"
	// TLSECDHEECDSAWITHAES128CBCSHA specifies the
	// tlsecdheecdsawithaes128cbcsha state for ssl cipher suite.
	TLSECDHEECDSAWITHAES128CBCSHA SslCipherSuite = "TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA"
	// TLSECDHEECDSAWITHAES128CBCSHA256 specifies the
	// tlsecdheecdsawithaes128cbcsha256 state for ssl cipher suite.
	TLSECDHEECDSAWITHAES128CBCSHA256 SslCipherSuite = "TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA256"
	// TLSECDHEECDSAWITHAES128GCMSHA256 specifies the
	// tlsecdheecdsawithaes128gcmsha256 state for ssl cipher suite.
	TLSECDHEECDSAWITHAES128GCMSHA256 SslCipherSuite = "TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256"
	// TLSECDHEECDSAWITHAES256CBCSHA specifies the
	// tlsecdheecdsawithaes256cbcsha state for ssl cipher suite.
	TLSECDHEECDSAWITHAES256CBCSHA SslCipherSuite = "TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA"
	// TLSECDHEECDSAWITHAES256CBCSHA384 specifies the
	// tlsecdheecdsawithaes256cbcsha384 state for ssl cipher suite.
	TLSECDHEECDSAWITHAES256CBCSHA384 SslCipherSuite = "TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA384"
	// TLSECDHEECDSAWITHAES256GCMSHA384 specifies the
	// tlsecdheecdsawithaes256gcmsha384 state for ssl cipher suite.
	TLSECDHEECDSAWITHAES256GCMSHA384 SslCipherSuite = "TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384"
	// TLSECDHERSAWITHAES128CBCSHA specifies the tlsecdhersawithaes128cbcsha
	// state for ssl cipher suite.
	TLSECDHERSAWITHAES128CBCSHA SslCipherSuite = "TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA"
	// TLSECDHERSAWITHAES128CBCSHA256 specifies the
	// tlsecdhersawithaes128cbcsha256 state for ssl cipher suite.
	TLSECDHERSAWITHAES128CBCSHA256 SslCipherSuite = "TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256"
	// TLSECDHERSAWITHAES256CBCSHA specifies the tlsecdhersawithaes256cbcsha
	// state for ssl cipher suite.
	TLSECDHERSAWITHAES256CBCSHA SslCipherSuite = "TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA"
	// TLSECDHERSAWITHAES256CBCSHA384 specifies the
	// tlsecdhersawithaes256cbcsha384 state for ssl cipher suite.
	TLSECDHERSAWITHAES256CBCSHA384 SslCipherSuite = "TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384"
	// TLSRSAWITH3DESEDECBCSHA specifies the tlsrsawith3desedecbcsha state for
	// ssl cipher suite.
	TLSRSAWITH3DESEDECBCSHA SslCipherSuite = "TLS_RSA_WITH_3DES_EDE_CBC_SHA"
	// TLSRSAWITHAES128CBCSHA specifies the tlsrsawithaes128cbcsha state for
	// ssl cipher suite.
	TLSRSAWITHAES128CBCSHA SslCipherSuite = "TLS_RSA_WITH_AES_128_CBC_SHA"
	// TLSRSAWITHAES128CBCSHA256 specifies the tlsrsawithaes128cbcsha256 state
	// for ssl cipher suite.
	TLSRSAWITHAES128CBCSHA256 SslCipherSuite = "TLS_RSA_WITH_AES_128_CBC_SHA256"
	// TLSRSAWITHAES128GCMSHA256 specifies the tlsrsawithaes128gcmsha256 state
	// for ssl cipher suite.
	TLSRSAWITHAES128GCMSHA256 SslCipherSuite = "TLS_RSA_WITH_AES_128_GCM_SHA256"
	// TLSRSAWITHAES256CBCSHA specifies the tlsrsawithaes256cbcsha state for
	// ssl cipher suite.
	TLSRSAWITHAES256CBCSHA SslCipherSuite = "TLS_RSA_WITH_AES_256_CBC_SHA"
	// TLSRSAWITHAES256CBCSHA256 specifies the tlsrsawithaes256cbcsha256 state
	// for ssl cipher suite.
	TLSRSAWITHAES256CBCSHA256 SslCipherSuite = "TLS_RSA_WITH_AES_256_CBC_SHA256"
	// TLSRSAWITHAES256GCMSHA384 specifies the tlsrsawithaes256gcmsha384 state
	// for ssl cipher suite.
	TLSRSAWITHAES256GCMSHA384 SslCipherSuite = "TLS_RSA_WITH_AES_256_GCM_SHA384"
)

// SslPolicyName enumerates the values for ssl policy name.
type SslPolicyName string

const (
	// AppGwSslPolicy20150501 specifies the app gw ssl policy 20150501 state
	// for ssl policy name.
	AppGwSslPolicy20150501 SslPolicyName = "AppGwSslPolicy20150501"
	// AppGwSslPolicy20170401 specifies the app gw ssl policy 20170401 state
	// for ssl policy name.
	AppGwSslPolicy20170401 SslPolicyName = "AppGwSslPolicy20170401"
	// AppGwSslPolicy20170401S specifies the app gw ssl policy 20170401s state
	// for ssl policy name.
	AppGwSslPolicy20170401S SslPolicyName = "AppGwSslPolicy20170401S"
)

// SslPolicyType enumerates the values for ssl policy type.
type SslPolicyType string

const (
	// Custom specifies the custom state for ssl policy type.
	Custom SslPolicyType = "Custom"
	// Predefined specifies the predefined state for ssl policy type.
	Predefined SslPolicyType = "Predefined"
)
...
// AvailableSslOptions is response for ApplicationGatewayAvailableSslOptions
// API service call.
type AvailableSslOptions struct {
	...
	*AvailableSslOptionsPropertiesFormat `json:"properties,omitempty"`
}

// AvailableSslOptionsPropertiesFormat is properties of
// ApplicationGatewayAvailableSslOptions
type AvailableSslOptionsPropertiesFormat struct {
	PredefinedPolicies    *[]SubResource    `json:"predefinedPolicies,omitempty"`
	DefaultPolicy         SslPolicyName     `json:"defaultPolicy,omitempty"`
	AvailableCipherSuites *[]SslCipherSuite `json:"availableCipherSuites,omitempty"`
	AvailableProtocols    *[]SslProtocol    `json:"availableProtocols,omitempty"`
}

// AvailableSslPredefinedPolicies is response for
// ApplicationGatewayAvailableSslOptions API service call.
type AvailableSslPredefinedPolicies struct {
	autorest.Response `json:"-"`
	Value             *[]SslPredefinedPolicy `json:"value,omitempty"`
	NextLink          *string                `json:"nextLink,omitempty"`
}

// AvailableSslPredefinedPoliciesPreparer prepares a request to retrieve the next set of results. It returns
// nil if no more results exist.
func (client AvailableSslPredefinedPolicies) AvailableSslPredefinedPoliciesPreparer() (*http.Request, error) {
...
// PathRulePropertiesFormat is properties of path rule of an application
// gateway.
...
// PrivateAccessServicePropertiesFormat is the private access service
// properties.
type PrivateAccessServicePropertiesFormat struct {
...
// ProbeHealthResponseMatch is application gateway probe health response match
type ProbeHealthResponseMatch struct {
...
type ProbePropertiesFormat struct {
	...
	Match                               *ProbeHealthResponseMatch `json:"match,omitempty"`
	ProvisioningState                   *string                   `json:"provisioningState,omitempty"`
}
...
// RedirectConfiguration is redirect configuration of an application gateway.
type RedirectConfiguration struct {
	ID                                     *string `json:"id,omitempty"`
	*RedirectConfigurationPropertiesFormat `json:"properties,omitempty"`
	Name                                   *string `json:"name,omitempty"`
	Etag                                   *string `json:"etag,omitempty"`
	Type                                   *string `json:"type,omitempty"`
}

// RedirectConfigurationPropertiesFormat is properties of redirect
// configuration of the application gateway.
type RedirectConfigurationPropertiesFormat struct {
...
type SslPolicy struct {
	...
	PolicyType           SslPolicyType     `json:"policyType,omitempty"`
	PolicyName           SslPolicyName     `json:"policyName,omitempty"`
	CipherSuites         *[]SslCipherSuite `json:"cipherSuites,omitempty"`
	MinProtocolVersion   SslProtocol       `json:"minProtocolVersion,omitempty"`
}

// SslPredefinedPolicy is an Ssl predefined policy
type SslPredefinedPolicy struct {
	autorest.Response                    `json:"-"`
	ID                                   *string `json:"id,omitempty"`
	Name                                 *string `json:"name,omitempty"`
	*SslPredefinedPolicyPropertiesFormat `json:"properties,omitempty"`
}

// SslPredefinedPolicyPropertiesFormat is properties of
// ApplicationGatewaySslPredefinedPolicy
type SslPredefinedPolicyPropertiesFormat struct {
	CipherSuites       *[]SslCipherSuite `json:"cipherSuites,omitempty"`
	MinProtocolVersion SslProtocol       `json:"minProtocolVersion,omitempty"`
}
...
type SubnetPropertiesFormat struct {
	...
	PrivateAccessServices   *[]PrivateAccessServicePropertiesFormat `json:"privateAccessServices,omitempty"`
