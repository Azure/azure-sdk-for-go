...
// GetLongRunningOperationStatus the Get Operation Status operation returns the
// status of the specified operation. After calling an asynchronous operation,
// you can call Get Operation Status to determine whether the operation has
