...
// WorkspacesClient is the azure Log Analytics API reference for LinkTargets,
// StorageInsightConfigs and SavedSearches.
...
// GetSearchResults submit a search for a given workspace. The response will
// contain an id to track the search. User can use the id to poll the search
// status and get the full search result later if the search takes long time to
// finish.  This method may poll for completion. Polling can be canceled by
// passing the cancel channel argument. The channel will be used to cancel
// polling and any outstanding HTTP requests.
//
// resourceGroupName is the name of the resource group to get. The name is case
// insensitive. workspaceName is log Analytics workspace name parameters is the
// parameters required to execute a search query.
...
// ListLinkTargets get a list of workspaces which the current user has
// administrator privileges and are not associated with an Azure Subscription.
...
//
// resourceGroupName is the name of the resource group to get. The name is case
// insensitive. workspaceName is log Analytics workspace name ID is the id of
// the search that will have results updated. You can get the id from the
