...
// ConfigurationsClient is the the Microsoft Azure management API provides
...
// CreateOrUpdate updates a configuration of a server. This method may poll for
...
// the portal. serverName is the name of the server. configurationName is the
// name of the server configuration. parameters is the required parameters for
