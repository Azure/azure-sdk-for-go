...
// FirewallRulesClient is the the Microsoft Azure management API provides
// create, read, update, and delete functionality for Azure PostgreSQL
// resources including servers, databases, firewall rules, log files and
// configurations.
...
// CreateOrUpdate creates a new firewall rule or updates an existing firewall
// rule. This method may poll for completion. Polling can be canceled by
...
// name of the server firewall rule. parameters is the required parameters for
...
// Delete deletes a server firewall rule. This method may poll for completion.
...
// resource. You can obtain this value from the Azure Resource Manager API or
// the portal. serverName is the name of the server. firewallRuleName is the
// name of the server firewall rule.
