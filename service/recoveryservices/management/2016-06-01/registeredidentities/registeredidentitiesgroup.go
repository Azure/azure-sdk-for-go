...
// GroupClient is the client for the RegisteredIdentitiesGroup methods of the
...
// vault. identityName is name of the protection container to unregister.
func (client GroupClient) Delete(resourceGroupName string, vaultName string, identityName string) (result autorest.Response, err error) {
	req, err := client.DeletePreparer(resourceGroupName, vaultName, identityName)
	if err != nil {
		err = autorest.NewErrorWithError(err, "registeredidentities.GroupClient", "Delete", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "registeredidentities.GroupClient", "Delete", resp, "Failure sending request")
		return
	}

	result, err = client.DeleteResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "registeredidentities.GroupClient", "Delete", resp, "Failure responding to request")
	}
...
func (client GroupClient) DeletePreparer(resourceGroupName string, vaultName string, identityName string) (*http.Request, error) {
