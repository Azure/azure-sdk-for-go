...
// NewBackupOperationResultsClient creates an instance of the
// BackupOperationResultsClient client.
...
// NewBackupOperationResultsClientWithBaseURI creates an instance of the
// BackupOperationResultsClient client.
...
// Get provides the status of the delete operations, for example, deleting a
// backup item. Once the operation starts, the response status code is
// Accepted. The response status code remains in this state until the operation
// reaches completion. On successful completion, the status code changes to OK.
// This method expects OperationID as an argument. OperationID is part of the
