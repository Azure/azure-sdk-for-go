...
// backup data. Executing this script opens File Explorer which displays the
// recoverable files and folders. This is an asynchronous operation. To get the
...
// fabricName is the fabric name associated with the backup items.
// containerName is the container name associated with the backup items.
// protectedItemName is the name of the backup item whose files or folders are
// to be restored. recoveryPointID is the recovery point ID for backup data.
// The iSCSI connection will be provisioned for this backup data.
// resourceILRRequest is the resource Item Level Recovery (ILR) request.
func (client ItemLevelRecoveryConnectionsClient) Provision(vaultName string, resourceGroupName string, fabricName string, containerName string, protectedItemName string, recoveryPointID string, resourceILRRequest ILRRequestResource) (result autorest.Response, err error) {
	req, err := client.ProvisionPreparer(vaultName, resourceGroupName, fabricName, containerName, protectedItemName, recoveryPointID, resourceILRRequest)
	if err != nil {
...
func (client ItemLevelRecoveryConnectionsClient) ProvisionPreparer(vaultName string, resourceGroupName string, fabricName string, containerName string, protectedItemName string, recoveryPointID string, resourceILRRequest ILRRequestResource) (*http.Request, error) {
...
// vaultName is the name of the Recovery Services vault. resourceGroupName is
// the name of the resource group associated with the Recovery Services vault.
// fabricName is the fabric name associated with the backup items. The value
// allowed is Azure. containerName is the container name associated with the
// backup items. protectedItemName is the name of the backup items whose files
// or folders will be restored. recoveryPointID is the string that identifies
// the recovery point. The iSCSI connection will be revoked for this protected
// data.
