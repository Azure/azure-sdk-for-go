...
// JobCancellationsClient is the client for the JobCancellations methods of the
// Recoveryservicesbackup service.
type JobCancellationsClient struct {
	ManagementClient
}

// NewJobCancellationsClient creates an instance of the JobCancellationsClient
// client.
...
// NewJobCancellationsClientWithBaseURI creates an instance of the
// JobCancellationsClient client.
...
// Trigger cancels the job. This is an asynchronous operation. To know the
// status of the cancellation, call the GetCancelOperationResult API.
//
...
// jobName is name of the job to cancel.
