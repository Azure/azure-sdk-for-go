...
// ProtectionContainerOperationResultsClient is the client for the
// ProtectionContainerOperationResults methods of the Recoveryservicesbackup
// service.
type ProtectionContainerOperationResultsClient struct {
	ManagementClient
}

// NewProtectionContainerOperationResultsClient creates an instance of the
...
// NewProtectionContainerOperationResultsClientWithBaseURI creates an instance
// of the ProtectionContainerOperationResultsClient client.
...
// is the container name used for this GET operation. operationID is the
// operation ID used for this GET operation.
