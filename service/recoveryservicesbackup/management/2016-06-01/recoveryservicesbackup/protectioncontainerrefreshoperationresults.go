...
// ProtectionContainerRefreshOperationResultsClient is the client for the
// ProtectionContainerRefreshOperationResults methods of the
// Recoveryservicesbackup service.
type ProtectionContainerRefreshOperationResultsClient struct {
	ManagementClient
}

// NewProtectionContainerRefreshOperationResultsClient creates an instance of
// the ProtectionContainerRefreshOperationResultsClient client.
...
// NewProtectionContainerRefreshOperationResultsClientWithBaseURI creates an
// instance of the ProtectionContainerRefreshOperationResultsClient client.
...
// Get provides the result of the refresh operation triggered by the
...
// fabricName is the fabric name associated with the container. operationID is
