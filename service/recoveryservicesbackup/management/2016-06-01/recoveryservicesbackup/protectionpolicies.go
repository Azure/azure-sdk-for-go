...
// ProtectionPoliciesClient is the client for the ProtectionPolicies methods of
// the Recoveryservicesbackup service.
type ProtectionPoliciesClient struct {
	ManagementClient
}

// NewProtectionPoliciesClient creates an instance of the
// ProtectionPoliciesClient client.
...
// NewProtectionPoliciesClientWithBaseURI creates an instance of the
// ProtectionPoliciesClient client.
...
// CreateOrUpdate creates or modifies a backup policy. This is an asynchronous
...
// policyName is the backup policy to be created. resourceProtectionPolicy is
// the resource backup policy.
func (client ProtectionPoliciesClient) CreateOrUpdate(vaultName string, resourceGroupName string, policyName string, resourceProtectionPolicy ProtectionPolicyResource) (result ProtectionPolicyResource, err error) {
	req, err := client.CreateOrUpdatePreparer(vaultName, resourceGroupName, policyName, resourceProtectionPolicy)
	if err != nil {
...
func (client ProtectionPoliciesClient) CreateOrUpdatePreparer(vaultName string, resourceGroupName string, policyName string, resourceProtectionPolicy ProtectionPolicyResource) (*http.Request, error) {
...
// Delete deletes the specified backup policy from your Recovery Services
// vault. This is an asynchronous operation. Use the GetPolicyOperationResult
// API to Get the operation status.
//
// vaultName is the name of the Recovery Services vault. resourceGroupName is
// the name of the resource group associated with the Recovery Services vault.
// policyName is the name of the backup policy to be deleted.
...
// Get gets the details of the backup policy associated with the Recovery
// Services vault. This is an asynchronous operation. Use the
// GetPolicyOperationResult API to Get the operation status.
//
// vaultName is the name of the Recovery Services vault. resourceGroupName is
// the name of the resource group associated with the Recovery Services vault.
// policyName is the backup policy name used in this GET operation.
...
// List lists the backup policies associated with the Recovery Services vault.
// The API provides parameters to Get scoped results.
//
// vaultName is the name of the Recovery Services vault. resourceGroupName is
// the name of the resource group associated with the Recovery Services vault.
// filter is the following equation can be used to filter the list of backup
// policies. backupManagementType eq {AzureIaasVM, MAB, DPM, AzureBackupServer,
// AzureSql}.
func (client ProtectionPoliciesClient) List(vaultName string, resourceGroupName string, filter string) (result ProtectionPolicyResourceList, err error) {
	req, err := client.ListPreparer(vaultName, resourceGroupName, filter)
	if err != nil {
		err = autorest.NewErrorWithError(err, "recoveryservicesbackup.ProtectionPoliciesClient", "List", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "recoveryservicesbackup.ProtectionPoliciesClient", "List", resp, "Failure sending request")
		return
	}

	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "recoveryservicesbackup.ProtectionPoliciesClient", "List", resp, "Failure responding to request")
	}
...
func (client ProtectionPoliciesClient) ListPreparer(vaultName string, resourceGroupName string, filter string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"subscriptionId":    autorest.Encode("path", client.SubscriptionID),
		"vaultName":         autorest.Encode("path", vaultName),
...
func (client ProtectionPoliciesClient) ListNextResults(lastResults ProtectionPolicyResourceList) (result ProtectionPolicyResourceList, err error) {
	req, err := lastResults.ProtectionPolicyResourceListPreparer()
	if err != nil {
		return result, autorest.NewErrorWithError(err, "recoveryservicesbackup.ProtectionPoliciesClient", "List", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "recoveryservicesbackup.ProtectionPoliciesClient", "List", resp, "Failure sending next results request")
	}

	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "recoveryservicesbackup.ProtectionPoliciesClient", "List", resp, "Failure responding to next results request")
	}
...
func (client ProtectionPoliciesClient) ListComplete(vaultName string, resourceGroupName string, filter string, cancel <-chan struct{}) (<-chan ProtectionPolicyResource, <-chan error) {
