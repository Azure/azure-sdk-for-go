...
// Get provides the status of the asynchronous operations like backup or
// restore. The status can be: in progress, completed, or failed. You can refer
// to the Operation Status enumeration for the possible states of an operation.
// Some operations create jobs. This method returns the list of jobs associated
// with the operation.
//
...
// policyName is the backup policy name used in this GET operation. operationID
// is the ID associated with this GET operation.
