...
func (client RecoveryPointsClient) Get(fabricName string, protectionContainerName string, replicatedProtectedItemName string, recoveryPointName string) (result RecoveryPoint, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.RecoveryPointsClient", "Get", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "service.RecoveryPointsClient", "Get", resp, "Failure sending request")
		return
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.RecoveryPointsClient", "Get", resp, "Failure responding to request")
	}
...
func (client RecoveryPointsClient) ListByReplicationProtectedItems(fabricName string, protectionContainerName string, replicatedProtectedItemName string) (result RecoveryPointCollection, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.RecoveryPointsClient", "ListByReplicationProtectedItems", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.RecoveryPointsClient", "ListByReplicationProtectedItems", resp, "Failure sending request")
		return
	}

	result, err = client.ListByReplicationProtectedItemsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.RecoveryPointsClient", "ListByReplicationProtectedItems", resp, "Failure responding to request")
	}
...
func (client RecoveryPointsClient) ListByReplicationProtectedItemsNextResults(lastResults RecoveryPointCollection) (result RecoveryPointCollection, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "service.RecoveryPointsClient", "ListByReplicationProtectedItems", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "service.RecoveryPointsClient", "ListByReplicationProtectedItems", resp, "Failure sending next results request")
	}

	result, err = client.ListByReplicationProtectedItemsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.RecoveryPointsClient", "ListByReplicationProtectedItems", resp, "Failure responding to next results request")
	}
