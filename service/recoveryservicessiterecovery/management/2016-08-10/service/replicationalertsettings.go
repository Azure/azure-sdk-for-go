...
// ReplicationAlertSettingsClient is the client for the
// ReplicationAlertSettings methods of the Service service.
type ReplicationAlertSettingsClient struct {
	ManagementClient
}

// NewReplicationAlertSettingsClient creates an instance of the
// ReplicationAlertSettingsClient client.
...
// NewReplicationAlertSettingsClientWithBaseURI creates an instance of the
// ReplicationAlertSettingsClient client.
...
//
// alertSettingName is the name of the email notification(alert) configuration.
// request is the input to configure the email notification(alert).
func (client ReplicationAlertSettingsClient) Create(alertSettingName string, request ConfigureAlertRequest) (result Alert, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ReplicationAlertSettingsClient", "Create", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "service.ReplicationAlertSettingsClient", "Create", resp, "Failure sending request")
		return
	}

	result, err = client.CreateResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ReplicationAlertSettingsClient", "Create", resp, "Failure responding to request")
	}
...
// Get gets the details of the specified email notification(alert)
// configuration.
//
...
func (client ReplicationAlertSettingsClient) Get(alertSettingName string) (result Alert, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ReplicationAlertSettingsClient", "Get", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.ReplicationAlertSettingsClient", "Get", resp, "Failure sending request")
		return
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ReplicationAlertSettingsClient", "Get", resp, "Failure responding to request")
	}
...
// List gets the list of email notification(alert) configurations for the
// vault. .
func (client ReplicationAlertSettingsClient) List() (result AlertCollection, err error) {
	req, err := client.ListPreparer()
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ReplicationAlertSettingsClient", "List", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.ReplicationAlertSettingsClient", "List", resp, "Failure sending request")
		return
	}

	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ReplicationAlertSettingsClient", "List", resp, "Failure responding to request")
	}
...
func (client ReplicationAlertSettingsClient) ListNextResults(lastResults AlertCollection) (result AlertCollection, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "service.ReplicationAlertSettingsClient", "List", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "service.ReplicationAlertSettingsClient", "List", resp, "Failure sending next results request")
	}

	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ReplicationAlertSettingsClient", "List", resp, "Failure responding to next results request")
	}
