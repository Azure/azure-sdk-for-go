...
// ReplicationProtectableItemsClient is the client for the
// ReplicationProtectableItems methods of the Service service.
type ReplicationProtectableItemsClient struct {
	ManagementClient
}

// NewReplicationProtectableItemsClient creates an instance of the
// ReplicationProtectableItemsClient client.
...
// NewReplicationProtectableItemsClientWithBaseURI creates an instance of the
// ReplicationProtectableItemsClient client.
...
// name. protectableItemName is protectable item name.
func (client ReplicationProtectableItemsClient) Get(fabricName string, protectionContainerName string, protectableItemName string) (result ProtectableItem, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ReplicationProtectableItemsClient", "Get", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "service.ReplicationProtectableItemsClient", "Get", resp, "Failure sending request")
		return
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ReplicationProtectableItemsClient", "Get", resp, "Failure responding to request")
	}
...
// ListByReplicationProtectionContainers lists the protectable items in a
...
func (client ReplicationProtectableItemsClient) ListByReplicationProtectionContainers(fabricName string, protectionContainerName string) (result ProtectableItemCollection, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ReplicationProtectableItemsClient", "ListByReplicationProtectionContainers", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.ReplicationProtectableItemsClient", "ListByReplicationProtectionContainers", resp, "Failure sending request")
		return
	}

	result, err = client.ListByReplicationProtectionContainersResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ReplicationProtectableItemsClient", "ListByReplicationProtectionContainers", resp, "Failure responding to request")
	}
...
func (client ReplicationProtectableItemsClient) ListByReplicationProtectionContainersNextResults(lastResults ProtectableItemCollection) (result ProtectableItemCollection, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "service.ReplicationProtectableItemsClient", "ListByReplicationProtectionContainers", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "service.ReplicationProtectableItemsClient", "ListByReplicationProtectionContainers", resp, "Failure sending next results request")
	}

	result, err = client.ListByReplicationProtectionContainersResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ReplicationProtectableItemsClient", "ListByReplicationProtectionContainers", resp, "Failure responding to next results request")
	}
