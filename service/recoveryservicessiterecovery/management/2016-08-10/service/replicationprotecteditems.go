...
// ReplicationProtectedItemsClient is the client for the
// ReplicationProtectedItems methods of the Service service.
type ReplicationProtectedItemsClient struct {
	ManagementClient
}

// NewReplicationProtectedItemsClient creates an instance of the
// ReplicationProtectedItemsClient client.
...
// NewReplicationProtectedItemsClientWithBaseURI creates an instance of the
// ReplicationProtectedItemsClient client.
...
// ApplyRecoveryPoint the operation to change the recovery point of a failed
// over replication protected item. This method may poll for completion.
// Polling can be canceled by passing the cancel channel argument. The channel
// will be used to cancel polling and any outstanding HTTP requests.
//
// fabricName is the ARM fabric name. protectionContainerName is the protection
// container name. replicatedProtectedItemName is the replicated protected
// item's name. applyRecoveryPointInput is the ApplyRecoveryPointInput.
func (client ReplicationProtectedItemsClient) ApplyRecoveryPoint(fabricName string, protectionContainerName string, replicatedProtectedItemName string, applyRecoveryPointInput ApplyRecoveryPointInput, cancel <-chan struct{}) (<-chan ReplicationProtectedItem, <-chan error) {
	...
	go func() {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ReplicationProtectedItemsClient", "ApplyRecoveryPoint", nil, "Failure preparing request")
			return
		}
		...
		if err != nil {
			...
			err = autorest.NewErrorWithError(err, "service.ReplicationProtectedItemsClient", "ApplyRecoveryPoint", resp, "Failure sending request")
			return
		}

		result, err = client.ApplyRecoveryPointResponder(resp)
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ReplicationProtectedItemsClient", "ApplyRecoveryPoint", resp, "Failure responding to request")
		}
	}()
...
// Create the operation to create an ASR replication protected item (Enable
// replication). This method may poll for completion. Polling can be canceled
// by passing the cancel channel argument. The channel will be used to cancel
// polling and any outstanding HTTP requests.
//
// fabricName is name of the fabric. protectionContainerName is protection
// container name. replicatedProtectedItemName is a name for the replication
// protected item. input is enable Protection Input.
func (client ReplicationProtectedItemsClient) Create(fabricName string, protectionContainerName string, replicatedProtectedItemName string, input EnableProtectionInput, cancel <-chan struct{}) (<-chan ReplicationProtectedItem, <-chan error) {
	...
	go func() {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ReplicationProtectedItemsClient", "Create", nil, "Failure preparing request")
			return
		}
		...
		if err != nil {
			result.Response = autorest.Response{Response: resp}
			err = autorest.NewErrorWithError(err, "service.ReplicationProtectedItemsClient", "Create", resp, "Failure sending request")
			return
		}

		result, err = client.CreateResponder(resp)
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ReplicationProtectedItemsClient", "Create", resp, "Failure responding to request")
		}
	}()
	return resultChan, errChan
}
...
// Delete the operation to disable replication on a replication protected item.
// This will also remove the item. This method may poll for completion. Polling
...
// name. replicatedProtectedItemName is replication protected item name.
...
func (client ReplicationProtectedItemsClient) Delete(fabricName string, protectionContainerName string, replicatedProtectedItemName string, disableProtectionInput DisableProtectionInput, cancel <-chan struct{}) (<-chan autorest.Response, <-chan error) {
	...
	go func() {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ReplicationProtectedItemsClient", "Delete", nil, "Failure preparing request")
			return
		}
		...
		if err != nil {
			...
			err = autorest.NewErrorWithError(err, "service.ReplicationProtectedItemsClient", "Delete", resp, "Failure sending request")
			return
		}

		result, err = client.DeleteResponder(resp)
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ReplicationProtectedItemsClient", "Delete", resp, "Failure responding to request")
		}
	}()
	return resultChan, errChan
}
...
// FailoverCommit operation to commit the failover of the replication protected
// item. This method may poll for completion. Polling can be canceled by
// passing the cancel channel argument. The channel will be used to cancel
// polling and any outstanding HTTP requests.
//
// fabricName is unique fabric name. protectionContainerName is protection
// container name. replicatedProtectedItemName is replication protected item
// name.
func (client ReplicationProtectedItemsClient) FailoverCommit(fabricName string, protectionContainerName string, replicatedProtectedItemName string, cancel <-chan struct{}) (<-chan ReplicationProtectedItem, <-chan error) {
	...
	go func() {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ReplicationProtectedItemsClient", "FailoverCommit", nil, "Failure preparing request")
			return
		}
		...
		if err != nil {
			result.Response = autorest.Response{Response: resp}
			err = autorest.NewErrorWithError(err, "service.ReplicationProtectedItemsClient", "FailoverCommit", resp, "Failure sending request")
			return
		}

		result, err = client.FailoverCommitResponder(resp)
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ReplicationProtectedItemsClient", "FailoverCommit", resp, "Failure responding to request")
		}
	}()
	return resultChan, errChan
}
...
//
// fabricName is fabric unique name. protectionContainerName is protection
// container name. replicatedProtectedItemName is replication protected item
// name.
func (client ReplicationProtectedItemsClient) Get(fabricName string, protectionContainerName string, replicatedProtectedItemName string) (result ReplicationProtectedItem, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ReplicationProtectedItemsClient", "Get", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.ReplicationProtectedItemsClient", "Get", resp, "Failure sending request")
		return
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ReplicationProtectedItemsClient", "Get", resp, "Failure responding to request")
	}
...
//
// skipToken is the pagination token. Possible values: "FabricId" or
// "FabricId_CloudId" or null filter is oData filter options.
func (client ReplicationProtectedItemsClient) List(skipToken string, filter string) (result ReplicationProtectedItemCollection, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ReplicationProtectedItemsClient", "List", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.ReplicationProtectedItemsClient", "List", resp, "Failure sending request")
		return
	}

	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ReplicationProtectedItemsClient", "List", resp, "Failure responding to request")
	}
...
func (client ReplicationProtectedItemsClient) ListNextResults(lastResults ReplicationProtectedItemCollection) (result ReplicationProtectedItemCollection, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "service.ReplicationProtectedItemsClient", "List", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "service.ReplicationProtectedItemsClient", "List", resp, "Failure sending next results request")
	}

	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ReplicationProtectedItemsClient", "List", resp, "Failure responding to next results request")
	}
...
// ListByReplicationProtectionContainers gets the list of ASR replication
// protected items in the protection container.
//
// fabricName is fabric name. protectionContainerName is protection container
// name.
func (client ReplicationProtectedItemsClient) ListByReplicationProtectionContainers(fabricName string, protectionContainerName string) (result ReplicationProtectedItemCollection, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ReplicationProtectedItemsClient", "ListByReplicationProtectionContainers", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.ReplicationProtectedItemsClient", "ListByReplicationProtectionContainers", resp, "Failure sending request")
		return
	}

	result, err = client.ListByReplicationProtectionContainersResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ReplicationProtectedItemsClient", "ListByReplicationProtectionContainers", resp, "Failure responding to request")
	}
...
func (client ReplicationProtectedItemsClient) ListByReplicationProtectionContainersNextResults(lastResults ReplicationProtectedItemCollection) (result ReplicationProtectedItemCollection, err error) {
	req, err := lastResults.ReplicationProtectedItemCollectionPreparer()
	if err != nil {
		return result, autorest.NewErrorWithError(err, "service.ReplicationProtectedItemsClient", "ListByReplicationProtectionContainers", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "service.ReplicationProtectedItemsClient", "ListByReplicationProtectionContainers", resp, "Failure sending next results request")
	}

	result, err = client.ListByReplicationProtectionContainersResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ReplicationProtectedItemsClient", "ListByReplicationProtectionContainers", resp, "Failure responding to next results request")
	}
...
// PlannedFailover operation to initiate a planned failover of the replication
// protected item. This method may poll for completion. Polling can be canceled
// by passing the cancel channel argument. The channel will be used to cancel
// polling and any outstanding HTTP requests.
//
// fabricName is unique fabric name. protectionContainerName is protection
// container name. replicatedProtectedItemName is replication protected item
// name. failoverInput is disable protection input.
func (client ReplicationProtectedItemsClient) PlannedFailover(fabricName string, protectionContainerName string, replicatedProtectedItemName string, failoverInput PlannedFailoverInput, cancel <-chan struct{}) (<-chan ReplicationProtectedItem, <-chan error) {
	...
	go func() {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ReplicationProtectedItemsClient", "PlannedFailover", nil, "Failure preparing request")
			return
		}
		...
		if err != nil {
			result.Response = autorest.Response{Response: resp}
			err = autorest.NewErrorWithError(err, "service.ReplicationProtectedItemsClient", "PlannedFailover", resp, "Failure sending request")
			return
		}

		result, err = client.PlannedFailoverResponder(resp)
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ReplicationProtectedItemsClient", "PlannedFailover", resp, "Failure responding to request")
		}
	}()
	return resultChan, errChan
}
...
// Purge the operation to delete or purge a replication protected item. This
...
// replication for the item. This method may poll for completion. Polling can
...
func (client ReplicationProtectedItemsClient) Purge(fabricName string, protectionContainerName string, replicatedProtectedItemName string, cancel <-chan struct{}) (<-chan autorest.Response, <-chan error) {
	...
	go func() {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ReplicationProtectedItemsClient", "Purge", nil, "Failure preparing request")
			return
		}
		...
		if err != nil {
			result.Response = resp
			err = autorest.NewErrorWithError(err, "service.ReplicationProtectedItemsClient", "Purge", resp, "Failure sending request")
			return
		}

		result, err = client.PurgeResponder(resp)
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ReplicationProtectedItemsClient", "Purge", resp, "Failure responding to request")
		}
	}()
	return resultChan, errChan
}
...
// RepairReplication the operation to start resynchronize/repair replication
// for a replication protected item requiring resynchronization. This method
...
// the container. replicatedProtectedItemName is the name of the replication
// protected item.
func (client ReplicationProtectedItemsClient) RepairReplication(fabricName string, protectionContainerName string, replicatedProtectedItemName string, cancel <-chan struct{}) (<-chan ReplicationProtectedItem, <-chan error) {
	...
	go func() {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ReplicationProtectedItemsClient", "RepairReplication", nil, "Failure preparing request")
			return
		}
		...
		if err != nil {
			result.Response = autorest.Response{Response: resp}
			err = autorest.NewErrorWithError(err, "service.ReplicationProtectedItemsClient", "RepairReplication", resp, "Failure sending request")
			return
		}

		result, err = client.RepairReplicationResponder(resp)
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ReplicationProtectedItemsClient", "RepairReplication", resp, "Failure responding to request")
		}
	}()
	return resultChan, errChan
}
...
// Reprotect operation to reprotect or reverse replicate a failed over
// replication protected item. This method may poll for completion. Polling can
// be canceled by passing the cancel channel argument. The channel will be used
// to cancel polling and any outstanding HTTP requests.
//
// fabricName is unique fabric name. protectionContainerName is protection
// container name. replicatedProtectedItemName is replication protected item
// name. rrInput is disable protection input.
func (client ReplicationProtectedItemsClient) Reprotect(fabricName string, protectionContainerName string, replicatedProtectedItemName string, rrInput ReverseReplicationInput, cancel <-chan struct{}) (<-chan ReplicationProtectedItem, <-chan error) {
	...
	go func() {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ReplicationProtectedItemsClient", "Reprotect", nil, "Failure preparing request")
			return
		}
		...
		if err != nil {
			result.Response = autorest.Response{Response: resp}
			err = autorest.NewErrorWithError(err, "service.ReplicationProtectedItemsClient", "Reprotect", resp, "Failure sending request")
			return
		}

		result, err = client.ReprotectResponder(resp)
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ReplicationProtectedItemsClient", "Reprotect", resp, "Failure responding to request")
		}
	}()
	return resultChan, errChan
}
...
// TestFailover operation to perform a test failover of the replication
// protected item. This method may poll for completion. Polling can be canceled
// by passing the cancel channel argument. The channel will be used to cancel
// polling and any outstanding HTTP requests.
//
// fabricName is unique fabric name. protectionContainerName is protection
// container name. replicatedProtectedItemName is replication protected item
// name. failoverInput is test failover input.
func (client ReplicationProtectedItemsClient) TestFailover(fabricName string, protectionContainerName string, replicatedProtectedItemName string, failoverInput TestFailoverInput, cancel <-chan struct{}) (<-chan ReplicationProtectedItem, <-chan error) {
	...
	go func() {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ReplicationProtectedItemsClient", "TestFailover", nil, "Failure preparing request")
			return
		}
		...
		if err != nil {
			result.Response = autorest.Response{Response: resp}
			err = autorest.NewErrorWithError(err, "service.ReplicationProtectedItemsClient", "TestFailover", resp, "Failure sending request")
			return
		}

		result, err = client.TestFailoverResponder(resp)
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ReplicationProtectedItemsClient", "TestFailover", resp, "Failure responding to request")
		}
	}()
	return resultChan, errChan
}
...
// TestFailoverCleanup operation to clean up the test failover of a replication
// protected item. This method may poll for completion. Polling can be canceled
// by passing the cancel channel argument. The channel will be used to cancel
// polling and any outstanding HTTP requests.
//
// fabricName is unique fabric name. protectionContainerName is protection
// container name. replicatedProtectedItemName is replication protected item
// name. cleanupInput is test failover cleanup input.
func (client ReplicationProtectedItemsClient) TestFailoverCleanup(fabricName string, protectionContainerName string, replicatedProtectedItemName string, cleanupInput TestFailoverCleanupInput, cancel <-chan struct{}) (<-chan ReplicationProtectedItem, <-chan error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		errChan <- validation.NewErrorWithValidationError(err, "service.ReplicationProtectedItemsClient", "TestFailoverCleanup")
		close(errChan)
		close(resultChan)
		return resultChan, errChan
	}
	...
	go func() {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ReplicationProtectedItemsClient", "TestFailoverCleanup", nil, "Failure preparing request")
			return
		}
		...
		if err != nil {
			result.Response = autorest.Response{Response: resp}
			err = autorest.NewErrorWithError(err, "service.ReplicationProtectedItemsClient", "TestFailoverCleanup", resp, "Failure sending request")
			return
		}

		result, err = client.TestFailoverCleanupResponder(resp)
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ReplicationProtectedItemsClient", "TestFailoverCleanup", resp, "Failure responding to request")
		}
	}()
	return resultChan, errChan
}
...
// UnplannedFailover operation to initiate a failover of the replication
// protected item. This method may poll for completion. Polling can be canceled
// by passing the cancel channel argument. The channel will be used to cancel
// polling and any outstanding HTTP requests.
//
...
func (client ReplicationProtectedItemsClient) UnplannedFailover(fabricName string, protectionContainerName string, replicatedProtectedItemName string, failoverInput UnplannedFailoverInput, cancel <-chan struct{}) (<-chan ReplicationProtectedItem, <-chan error) {
	...
	go func() {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ReplicationProtectedItemsClient", "UnplannedFailover", nil, "Failure preparing request")
			return
		}
		...
		if err != nil {
			result.Response = autorest.Response{Response: resp}
			err = autorest.NewErrorWithError(err, "service.ReplicationProtectedItemsClient", "UnplannedFailover", resp, "Failure sending request")
			return
		}

		result, err = client.UnplannedFailoverResponder(resp)
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ReplicationProtectedItemsClient", "UnplannedFailover", resp, "Failure responding to request")
		}
	}()
	return resultChan, errChan
}
...
// Update the operation to update the recovery settings of an ASR replication
// protected item. This method may poll for completion. Polling can be canceled
// by passing the cancel channel argument. The channel will be used to cancel
// polling and any outstanding HTTP requests.
//
// fabricName is fabric name. protectionContainerName is protection container
// name. replicatedProtectedItemName is replication protected item name.
// updateProtectionInput is update protection input.
func (client ReplicationProtectedItemsClient) Update(fabricName string, protectionContainerName string, replicatedProtectedItemName string, updateProtectionInput UpdateReplicationProtectedItemInput, cancel <-chan struct{}) (<-chan ReplicationProtectedItem, <-chan error) {
	...
	go func() {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ReplicationProtectedItemsClient", "Update", nil, "Failure preparing request")
			return
		}
		...
		if err != nil {
			result.Response = autorest.Response{Response: resp}
			err = autorest.NewErrorWithError(err, "service.ReplicationProtectedItemsClient", "Update", resp, "Failure sending request")
			return
		}

		result, err = client.UpdateResponder(resp)
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ReplicationProtectedItemsClient", "Update", resp, "Failure responding to request")
		}
	}()
	return resultChan, errChan
}
...
// UpdateMobilityService the operation to update(push update) the installed
// mobility service software on a replication protected item to the latest
// available version. This method may poll for completion. Polling can be
// canceled by passing the cancel channel argument. The channel will be used to
// cancel polling and any outstanding HTTP requests.
//
// fabricName is the name of the fabric containing the protected item.
// protectionContainerName is the name of the container containing the
// protected item. replicationProtectedItemName is the name of the protected
// item on which the agent is to be updated. updateMobilityServiceRequest is
...
func (client ReplicationProtectedItemsClient) UpdateMobilityService(fabricName string, protectionContainerName string, replicationProtectedItemName string, updateMobilityServiceRequest UpdateMobilityServiceRequest, cancel <-chan struct{}) (<-chan ReplicationProtectedItem, <-chan error) {
	...
	go func() {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ReplicationProtectedItemsClient", "UpdateMobilityService", nil, "Failure preparing request")
			return
		}
		...
		if err != nil {
			result.Response = autorest.Response{Response: resp}
			err = autorest.NewErrorWithError(err, "service.ReplicationProtectedItemsClient", "UpdateMobilityService", resp, "Failure sending request")
			return
		}

		result, err = client.UpdateMobilityServiceResponder(resp)
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ReplicationProtectedItemsClient", "UpdateMobilityService", resp, "Failure responding to request")
		}
	}()
	return resultChan, errChan
}
