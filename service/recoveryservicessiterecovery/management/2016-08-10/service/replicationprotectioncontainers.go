...
// ReplicationProtectionContainersClient is the client for the
// ReplicationProtectionContainers methods of the Service service.
type ReplicationProtectionContainersClient struct {
	ManagementClient
}

// NewReplicationProtectionContainersClient creates an instance of the
...
// NewReplicationProtectionContainersClientWithBaseURI creates an instance of
// the ReplicationProtectionContainersClient client.
...
// Create operation to create a protection container. This method may poll for
// completion. Polling can be canceled by passing the cancel channel argument.
// The channel will be used to cancel polling and any outstanding HTTP
// requests.
//
// fabricName is unique fabric ARM name. protectionContainerName is unique
// protection container ARM name. creationInput is creation input.
func (client ReplicationProtectionContainersClient) Create(fabricName string, protectionContainerName string, creationInput CreateProtectionContainerInput, cancel <-chan struct{}) (<-chan ProtectionContainer, <-chan error) {
	...
	go func() {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ReplicationProtectionContainersClient", "Create", nil, "Failure preparing request")
			return
		}
		...
		if err != nil {
			...
			err = autorest.NewErrorWithError(err, "service.ReplicationProtectionContainersClient", "Create", resp, "Failure sending request")
			return
		}

		result, err = client.CreateResponder(resp)
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ReplicationProtectionContainersClient", "Create", resp, "Failure responding to request")
		}
	}()
...
// Delete operation to remove a protection container. This method may poll for
// completion. Polling can be canceled by passing the cancel channel argument.
// The channel will be used to cancel polling and any outstanding HTTP
// requests.
//
// fabricName is unique fabric ARM name. protectionContainerName is unique
// protection container ARM name.
func (client ReplicationProtectionContainersClient) Delete(fabricName string, protectionContainerName string, cancel <-chan struct{}) (<-chan autorest.Response, <-chan error) {
	...
	go func() {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ReplicationProtectionContainersClient", "Delete", nil, "Failure preparing request")
			return
		}
		...
		if err != nil {
			...
			err = autorest.NewErrorWithError(err, "service.ReplicationProtectionContainersClient", "Delete", resp, "Failure sending request")
			return
		}

		result, err = client.DeleteResponder(resp)
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ReplicationProtectionContainersClient", "Delete", resp, "Failure responding to request")
		}
	}()
	return resultChan, errChan
}
...
// DiscoverProtectableItem the operation to a add a protectable item to a
// protection container(Add physical server.) This method may poll for
// completion. Polling can be canceled by passing the cancel channel argument.
// The channel will be used to cancel polling and any outstanding HTTP
// requests.
//
// fabricName is the name of the fabric. protectionContainerName is the name of
// the protection container. discoverProtectableItemRequest is the request
// object to add a protectable item.
func (client ReplicationProtectionContainersClient) DiscoverProtectableItem(fabricName string, protectionContainerName string, discoverProtectableItemRequest DiscoverProtectableItemRequest, cancel <-chan struct{}) (<-chan ProtectionContainer, <-chan error) {
	...
	go func() {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ReplicationProtectionContainersClient", "DiscoverProtectableItem", nil, "Failure preparing request")
			return
		}
		...
		if err != nil {
			result.Response = autorest.Response{Response: resp}
			err = autorest.NewErrorWithError(err, "service.ReplicationProtectionContainersClient", "DiscoverProtectableItem", resp, "Failure sending request")
			return
		}

		result, err = client.DiscoverProtectableItemResponder(resp)
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ReplicationProtectionContainersClient", "DiscoverProtectableItem", resp, "Failure responding to request")
		}
	}()
	return resultChan, errChan
}
...
func (client ReplicationProtectionContainersClient) Get(fabricName string, protectionContainerName string) (result ProtectionContainer, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ReplicationProtectionContainersClient", "Get", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.ReplicationProtectionContainersClient", "Get", resp, "Failure sending request")
		return
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ReplicationProtectionContainersClient", "Get", resp, "Failure responding to request")
	}
...
func (client ReplicationProtectionContainersClient) List() (result ProtectionContainerCollection, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ReplicationProtectionContainersClient", "List", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.ReplicationProtectionContainersClient", "List", resp, "Failure sending request")
		return
	}

	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ReplicationProtectionContainersClient", "List", resp, "Failure responding to request")
	}
...
func (client ReplicationProtectionContainersClient) ListNextResults(lastResults ProtectionContainerCollection) (result ProtectionContainerCollection, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "service.ReplicationProtectionContainersClient", "List", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "service.ReplicationProtectionContainersClient", "List", resp, "Failure sending next results request")
	}

	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ReplicationProtectionContainersClient", "List", resp, "Failure responding to next results request")
	}
...
// ListByReplicationFabrics lists the protection containers in the specified
// fabric.
//
...
func (client ReplicationProtectionContainersClient) ListByReplicationFabrics(fabricName string) (result ProtectionContainerCollection, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ReplicationProtectionContainersClient", "ListByReplicationFabrics", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.ReplicationProtectionContainersClient", "ListByReplicationFabrics", resp, "Failure sending request")
		return
	}

	result, err = client.ListByReplicationFabricsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ReplicationProtectionContainersClient", "ListByReplicationFabrics", resp, "Failure responding to request")
	}
...
func (client ReplicationProtectionContainersClient) ListByReplicationFabricsNextResults(lastResults ProtectionContainerCollection) (result ProtectionContainerCollection, err error) {
	req, err := lastResults.ProtectionContainerCollectionPreparer()
	if err != nil {
		return result, autorest.NewErrorWithError(err, "service.ReplicationProtectionContainersClient", "ListByReplicationFabrics", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "service.ReplicationProtectionContainersClient", "ListByReplicationFabrics", resp, "Failure sending next results request")
	}

	result, err = client.ListByReplicationFabricsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ReplicationProtectionContainersClient", "ListByReplicationFabrics", resp, "Failure responding to next results request")
	}
...
// SwitchProtection operation to switch protection from one container to
// another or one replication provider to another. This method may poll for
// completion. Polling can be canceled by passing the cancel channel argument.
// The channel will be used to cancel polling and any outstanding HTTP
// requests.
//
// fabricName is unique fabric name. protectionContainerName is protection
// container name. switchInput is switch protection input.
func (client ReplicationProtectionContainersClient) SwitchProtection(fabricName string, protectionContainerName string, switchInput SwitchProtectionInput, cancel <-chan struct{}) (<-chan ProtectionContainer, <-chan error) {
	...
	go func() {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ReplicationProtectionContainersClient", "SwitchProtection", nil, "Failure preparing request")
			return
		}
		...
		if err != nil {
			result.Response = autorest.Response{Response: resp}
			err = autorest.NewErrorWithError(err, "service.ReplicationProtectionContainersClient", "SwitchProtection", resp, "Failure sending request")
			return
		}

		result, err = client.SwitchProtectionResponder(resp)
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ReplicationProtectionContainersClient", "SwitchProtection", resp, "Failure responding to request")
		}
	}()
	return resultChan, errChan
}
