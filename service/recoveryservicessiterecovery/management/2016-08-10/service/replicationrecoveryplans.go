...
// ReplicationRecoveryPlansClient is the client for the
// ReplicationRecoveryPlans methods of the Service service.
type ReplicationRecoveryPlansClient struct {
	ManagementClient
}

// NewReplicationRecoveryPlansClient creates an instance of the
// ReplicationRecoveryPlansClient client.
...
// NewReplicationRecoveryPlansClientWithBaseURI creates an instance of the
// ReplicationRecoveryPlansClient client.
...
// Create the operation to create a recovery plan. This method may poll for
// completion. Polling can be canceled by passing the cancel channel argument.
// The channel will be used to cancel polling and any outstanding HTTP
// requests.
//
// recoveryPlanName is recovery plan name. input is recovery Plan creation
// input.
func (client ReplicationRecoveryPlansClient) Create(recoveryPlanName string, input CreateRecoveryPlanInput, cancel <-chan struct{}) (<-chan RecoveryPlan, <-chan error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		errChan <- validation.NewErrorWithValidationError(err, "service.ReplicationRecoveryPlansClient", "Create")
		close(errChan)
		close(resultChan)
	...
	go func() {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ReplicationRecoveryPlansClient", "Create", nil, "Failure preparing request")
			return
		}
		...
		if err != nil {
			...
			err = autorest.NewErrorWithError(err, "service.ReplicationRecoveryPlansClient", "Create", resp, "Failure sending request")
			return
		}

		result, err = client.CreateResponder(resp)
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ReplicationRecoveryPlansClient", "Create", resp, "Failure responding to request")
		}
	}()
	return resultChan, errChan
}
...
// Delete delete a recovery plan. This method may poll for completion. Polling
...
func (client ReplicationRecoveryPlansClient) Delete(recoveryPlanName string, cancel <-chan struct{}) (<-chan autorest.Response, <-chan error) {
	...
	go func() {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ReplicationRecoveryPlansClient", "Delete", nil, "Failure preparing request")
			return
		}
		...
		if err != nil {
			...
			err = autorest.NewErrorWithError(err, "service.ReplicationRecoveryPlansClient", "Delete", resp, "Failure sending request")
			return
		}

		result, err = client.DeleteResponder(resp)
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ReplicationRecoveryPlansClient", "Delete", resp, "Failure responding to request")
		}
	}()
	return resultChan, errChan
}
...
func (client ReplicationRecoveryPlansClient) FailoverCommit(recoveryPlanName string, cancel <-chan struct{}) (<-chan RecoveryPlan, <-chan error) {
	...
	go func() {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ReplicationRecoveryPlansClient", "FailoverCommit", nil, "Failure preparing request")
			return
		}
		...
		if err != nil {
			result.Response = autorest.Response{Response: resp}
			err = autorest.NewErrorWithError(err, "service.ReplicationRecoveryPlansClient", "FailoverCommit", resp, "Failure sending request")
			return
		}

		result, err = client.FailoverCommitResponder(resp)
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ReplicationRecoveryPlansClient", "FailoverCommit", resp, "Failure responding to request")
		}
	}()
	return resultChan, errChan
}
...
func (client ReplicationRecoveryPlansClient) Get(recoveryPlanName string) (result RecoveryPlan, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ReplicationRecoveryPlansClient", "Get", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.ReplicationRecoveryPlansClient", "Get", resp, "Failure sending request")
		return
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ReplicationRecoveryPlansClient", "Get", resp, "Failure responding to request")
	}
...
func (client ReplicationRecoveryPlansClient) List() (result RecoveryPlanCollection, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ReplicationRecoveryPlansClient", "List", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.ReplicationRecoveryPlansClient", "List", resp, "Failure sending request")
		return
	}

	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ReplicationRecoveryPlansClient", "List", resp, "Failure responding to request")
	}
...
func (client ReplicationRecoveryPlansClient) ListNextResults(lastResults RecoveryPlanCollection) (result RecoveryPlanCollection, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "service.ReplicationRecoveryPlansClient", "List", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "service.ReplicationRecoveryPlansClient", "List", resp, "Failure sending next results request")
	}

	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ReplicationRecoveryPlansClient", "List", resp, "Failure responding to next results request")
	}
...
// PlannedFailover the operation to start the planned failover of a recovery
// plan. This method may poll for completion. Polling can be canceled by
...
func (client ReplicationRecoveryPlansClient) PlannedFailover(recoveryPlanName string, input RecoveryPlanPlannedFailoverInput, cancel <-chan struct{}) (<-chan RecoveryPlan, <-chan error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		errChan <- validation.NewErrorWithValidationError(err, "service.ReplicationRecoveryPlansClient", "PlannedFailover")
		close(errChan)
		close(resultChan)
		return resultChan, errChan
	}
	...
	go func() {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ReplicationRecoveryPlansClient", "PlannedFailover", nil, "Failure preparing request")
			return
		}
		...
		if err != nil {
			result.Response = autorest.Response{Response: resp}
			err = autorest.NewErrorWithError(err, "service.ReplicationRecoveryPlansClient", "PlannedFailover", resp, "Failure sending request")
			return
		}

		result, err = client.PlannedFailoverResponder(resp)
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ReplicationRecoveryPlansClient", "PlannedFailover", resp, "Failure responding to request")
		}
	}()
	return resultChan, errChan
}
...
func (client ReplicationRecoveryPlansClient) Reprotect(recoveryPlanName string, cancel <-chan struct{}) (<-chan RecoveryPlan, <-chan error) {
	...
	go func() {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ReplicationRecoveryPlansClient", "Reprotect", nil, "Failure preparing request")
			return
		}
		...
		if err != nil {
			result.Response = autorest.Response{Response: resp}
			err = autorest.NewErrorWithError(err, "service.ReplicationRecoveryPlansClient", "Reprotect", resp, "Failure sending request")
			return
		}

		result, err = client.ReprotectResponder(resp)
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ReplicationRecoveryPlansClient", "Reprotect", resp, "Failure responding to request")
		}
	}()
	return resultChan, errChan
}
...
func (client ReplicationRecoveryPlansClient) TestFailover(recoveryPlanName string, input RecoveryPlanTestFailoverInput, cancel <-chan struct{}) (<-chan RecoveryPlan, <-chan error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		errChan <- validation.NewErrorWithValidationError(err, "service.ReplicationRecoveryPlansClient", "TestFailover")
		close(errChan)
		close(resultChan)
		return resultChan, errChan
	}
	...
	go func() {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ReplicationRecoveryPlansClient", "TestFailover", nil, "Failure preparing request")
			return
		}
		...
		if err != nil {
			result.Response = autorest.Response{Response: resp}
			err = autorest.NewErrorWithError(err, "service.ReplicationRecoveryPlansClient", "TestFailover", resp, "Failure sending request")
			return
		}

		result, err = client.TestFailoverResponder(resp)
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ReplicationRecoveryPlansClient", "TestFailover", resp, "Failure responding to request")
		}
	}()
	return resultChan, errChan
}
...
// polling and any outstanding HTTP requests.
//
// recoveryPlanName is recovery plan name. input is test failover cleanup
// input.
func (client ReplicationRecoveryPlansClient) TestFailoverCleanup(recoveryPlanName string, input RecoveryPlanTestFailoverCleanupInput, cancel <-chan struct{}) (<-chan RecoveryPlan, <-chan error) {
	...
	if err := validation.Validate([]validation.Validation{
		{TargetValue: input,
			Constraints: []validation.Constraint{{Target: "input.Properties", Name: validation.Null, Rule: true, Chain: nil}}}}); err != nil {
		errChan <- validation.NewErrorWithValidationError(err, "service.ReplicationRecoveryPlansClient", "TestFailoverCleanup")
		close(errChan)
		close(resultChan)
		return resultChan, errChan
	}
	...
	go func() {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ReplicationRecoveryPlansClient", "TestFailoverCleanup", nil, "Failure preparing request")
			return
		}
		...
		if err != nil {
			result.Response = autorest.Response{Response: resp}
			err = autorest.NewErrorWithError(err, "service.ReplicationRecoveryPlansClient", "TestFailoverCleanup", resp, "Failure sending request")
			return
		}

		result, err = client.TestFailoverCleanupResponder(resp)
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ReplicationRecoveryPlansClient", "TestFailoverCleanup", resp, "Failure responding to request")
		}
	}()
	return resultChan, errChan
}
...
func (client ReplicationRecoveryPlansClient) UnplannedFailover(recoveryPlanName string, input RecoveryPlanUnplannedFailoverInput, cancel <-chan struct{}) (<-chan RecoveryPlan, <-chan error) {
	...
	if err := validation.Validate([]validation.Validation{
		{TargetValue: input,
			Constraints: []validation.Constraint{{Target: "input.Properties", Name: validation.Null, Rule: true, Chain: nil}}}}); err != nil {
		errChan <- validation.NewErrorWithValidationError(err, "service.ReplicationRecoveryPlansClient", "UnplannedFailover")
		close(errChan)
		close(resultChan)
		return resultChan, errChan
	}
	...
	go func() {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ReplicationRecoveryPlansClient", "UnplannedFailover", nil, "Failure preparing request")
			return
		}
		...
		if err != nil {
			result.Response = autorest.Response{Response: resp}
			err = autorest.NewErrorWithError(err, "service.ReplicationRecoveryPlansClient", "UnplannedFailover", resp, "Failure sending request")
			return
		}

		result, err = client.UnplannedFailoverResponder(resp)
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ReplicationRecoveryPlansClient", "UnplannedFailover", resp, "Failure responding to request")
		}
	}()
	return resultChan, errChan
}
...
// Update the operation to update a recovery plan. This method may poll for
// completion. Polling can be canceled by passing the cancel channel argument.
// The channel will be used to cancel polling and any outstanding HTTP
// requests.
//
...
func (client ReplicationRecoveryPlansClient) Update(recoveryPlanName string, input UpdateRecoveryPlanInput, cancel <-chan struct{}) (<-chan RecoveryPlan, <-chan error) {
	...
	go func() {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ReplicationRecoveryPlansClient", "Update", nil, "Failure preparing request")
			return
		}
		...
		if err != nil {
			result.Response = autorest.Response{Response: resp}
			err = autorest.NewErrorWithError(err, "service.ReplicationRecoveryPlansClient", "Update", resp, "Failure sending request")
			return
		}

		result, err = client.UpdateResponder(resp)
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ReplicationRecoveryPlansClient", "Update", resp, "Failure responding to request")
		}
	}()
	return resultChan, errChan
}
