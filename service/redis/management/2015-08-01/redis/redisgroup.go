...
// Redis cache. parameters is parameters supplied to the CreateOrUpdate Redis
// operation.
...
// RegenerateKey regenerate the access keys for a Redis cache. This operation
// requires write permission to the cache resource.
//
// resourceGroupName is the name of the resource group. name is the name of the
// Redis cache. parameters is specifies which key to reset.
