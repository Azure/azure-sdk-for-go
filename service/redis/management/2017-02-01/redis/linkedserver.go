...
// NewLinkedServerClientWithBaseURI creates an instance of the
// LinkedServerClient client.
...
// Create adds a linked server to the Redis cache (requires Premium SKU). This
...
// Redis cache. linkedServerName is the name of the linked server that is being
// added to the Redis cache. parameters is parameters supplied to the Create
...
// Get gets the detailed information about a linked server of a redis cache
// (requires Premium SKU).
//
// resourceGroupName is the name of the resource group. name is the name of the
// redis cache. linkedServerName is the name of the linked server.
...
// List gets the list of linked servers associated with this redis cache
// (requires Premium SKU).
//
// resourceGroupName is the name of the resource group. name is the name of the
// redis cache.
