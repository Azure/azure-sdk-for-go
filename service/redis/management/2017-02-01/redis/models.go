...
// LinkedServerCreateParameters is parameter required for creating a linked
// server to redis cache.
...
// LinkedServerProperties is properties of a linked server to be returned in
// get/put response
...
// LinkedServerWithProperties is response to put/get linked server (with
// properties) for Redis cache.
...
// LinkedServerWithPropertiesList is list of linked servers (with properites)
// of a Redis cache.
