...
// List lists all historical availability transitions and impacting events for
// a single resource. Use the nextLink property in the response to get the next
