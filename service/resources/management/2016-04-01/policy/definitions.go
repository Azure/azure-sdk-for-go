...
// DefinitionsClient is the to manage and control access to your resources, you
...
// NewDefinitionsClientWithBaseURI creates an instance of the DefinitionsClient
// client.
