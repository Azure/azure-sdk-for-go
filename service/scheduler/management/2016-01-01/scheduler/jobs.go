...
// to request, in the of range [1..100]. skip is the (0-based) index of the job
// history list from which to begin requesting entries. filter is the filter to
// apply on the job state.
