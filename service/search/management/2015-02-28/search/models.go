...
// AdminKeyResult is response containing the primary and secondary API keys for
// a given Azure Search service.
...
// ServiceListResult is response containing a list of Azure Search services for
