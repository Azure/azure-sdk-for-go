...
// Create creates or updates a ManagementService gateway. This method may poll
...
// resourceGroupName is the resource group name uniquely identifies the
// resource group within the user subscriptionId. gatewayName is the gateway
// name (256 characters maximum) expand is gets subscription credentials which
...
// RegenerateProfile regenerate a gateway's profile This method may poll for
...
// Update updates a gateway belonging to a resource group. This method may poll
// for completion. Polling can be canceled by passing the cancel channel
// argument. The channel will be used to cancel polling and any outstanding
// HTTP requests.
//
...
// Upgrade upgrades a gateway. This method may poll for completion. Polling can
