...
// NewClientGroupsClientWithBaseURI creates an instance of the
// ClientGroupsClient client.
...
// interest. clientGroupName is client Group resource name. startTime is uTC
// date and time specifying the start time of an interval. When not specified
// the service uses DateTime.UtcNow - 10m endTime is uTC date and time
// specifying the end time of an interval. When not specified the service uses
// DateTime.UtcNow
func (client ClientGroupsClient) Get(resourceGroupName string, workspaceName string, clientGroupName string, startTime *date.Time, endTime *date.Time) (result ClientGroup, err error) {
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewErrorWithValidationError(err, "armservicemap.ClientGroupsClient", "Get")
	}

	req, err := client.GetPreparer(resourceGroupName, workspaceName, clientGroupName, startTime, endTime)
	if err != nil {
		err = autorest.NewErrorWithError(err, "armservicemap.ClientGroupsClient", "Get", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "armservicemap.ClientGroupsClient", "Get", resp, "Failure sending request")
		return
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "armservicemap.ClientGroupsClient", "Get", resp, "Failure responding to request")
	}
...
// GetMembersCount returns the approximate number of members in the client
// group.
//
// resourceGroupName is resource group name within the specified
// subscriptionId. workspaceName is oMS workspace containing the resources of
...
func (client ClientGroupsClient) GetMembersCount(resourceGroupName string, workspaceName string, clientGroupName string, startTime *date.Time, endTime *date.Time) (result ClientGroupMembersCount, err error) {
	if err := validation.Validate([]validation.Validation{
		...
		{TargetValue: clientGroupName,
			Constraints: []validation.Constraint{{Target: "clientGroupName", Name: validation.MaxLength, Rule: 256, Chain: nil},
				{Target: "clientGroupName", Name: validation.MinLength, Rule: 3, Chain: nil}}}}); err != nil {
		return result, validation.NewErrorWithValidationError(err, "armservicemap.ClientGroupsClient", "GetMembersCount")
	}

	req, err := client.GetMembersCountPreparer(resourceGroupName, workspaceName, clientGroupName, startTime, endTime)
	if err != nil {
		err = autorest.NewErrorWithError(err, "armservicemap.ClientGroupsClient", "GetMembersCount", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "armservicemap.ClientGroupsClient", "GetMembersCount", resp, "Failure sending request")
		return
	}

	result, err = client.GetMembersCountResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "armservicemap.ClientGroupsClient", "GetMembersCount", resp, "Failure responding to request")
	}
...
// ListMembers returns the members of the client group during the specified
// time interval.
//
// resourceGroupName is resource group name within the specified
// subscriptionId. workspaceName is oMS workspace containing the resources of
...
// the service uses DateTime.UtcNow - 10m endTime is uTC date and time
// specifying the end time of an interval. When not specified the service uses
// DateTime.UtcNow top is page size to use. When not specified, the default
...
func (client ClientGroupsClient) ListMembers(resourceGroupName string, workspaceName string, clientGroupName string, startTime *date.Time, endTime *date.Time, top *int32) (result ClientGroupMembersCollection, err error) {
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewErrorWithValidationError(err, "armservicemap.ClientGroupsClient", "ListMembers")
	}

	req, err := client.ListMembersPreparer(resourceGroupName, workspaceName, clientGroupName, startTime, endTime, top)
	if err != nil {
		err = autorest.NewErrorWithError(err, "armservicemap.ClientGroupsClient", "ListMembers", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "armservicemap.ClientGroupsClient", "ListMembers", resp, "Failure sending request")
		return
	}

	result, err = client.ListMembersResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "armservicemap.ClientGroupsClient", "ListMembers", resp, "Failure responding to request")
	}
...
func (client ClientGroupsClient) ListMembersNextResults(lastResults ClientGroupMembersCollection) (result ClientGroupMembersCollection, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "armservicemap.ClientGroupsClient", "ListMembers", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "armservicemap.ClientGroupsClient", "ListMembers", resp, "Failure sending next results request")
	}

	result, err = client.ListMembersResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "armservicemap.ClientGroupsClient", "ListMembers", resp, "Failure responding to next results request")
	}
