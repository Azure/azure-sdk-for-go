...
func (client MachinesClient) Get(resourceGroupName string, workspaceName string, machineName string, timestamp *date.Time) (result Machine, err error) {
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewErrorWithValidationError(err, "armservicemap.MachinesClient", "Get")
	}

	req, err := client.GetPreparer(resourceGroupName, workspaceName, machineName, timestamp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "armservicemap.MachinesClient", "Get", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "armservicemap.MachinesClient", "Get", resp, "Failure sending request")
		return
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "armservicemap.MachinesClient", "Get", resp, "Failure responding to request")
	}
...
func (client MachinesClient) GetLiveness(resourceGroupName string, workspaceName string, machineName string, startTime *date.Time, endTime *date.Time) (result Liveness, err error) {
	if err := validation.Validate([]validation.Validation{
		...
		{TargetValue: machineName,
			Constraints: []validation.Constraint{{Target: "machineName", Name: validation.MaxLength, Rule: 64, Chain: nil},
				{Target: "machineName", Name: validation.MinLength, Rule: 3, Chain: nil}}}}); err != nil {
		return result, validation.NewErrorWithValidationError(err, "armservicemap.MachinesClient", "GetLiveness")
	}

	req, err := client.GetLivenessPreparer(resourceGroupName, workspaceName, machineName, startTime, endTime)
	if err != nil {
		err = autorest.NewErrorWithError(err, "armservicemap.MachinesClient", "GetLiveness", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "armservicemap.MachinesClient", "GetLiveness", resp, "Failure sending request")
		return
	}

	result, err = client.GetLivenessResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "armservicemap.MachinesClient", "GetLiveness", resp, "Failure responding to request")
	}
...
func (client MachinesClient) ListByWorkspace(resourceGroupName string, workspaceName string, live *bool, startTime *date.Time, endTime *date.Time, timestamp *date.Time, top *int32) (result MachineCollection, err error) {
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewErrorWithValidationError(err, "armservicemap.MachinesClient", "ListByWorkspace")
	}

	req, err := client.ListByWorkspacePreparer(resourceGroupName, workspaceName, live, startTime, endTime, timestamp, top)
	if err != nil {
		err = autorest.NewErrorWithError(err, "armservicemap.MachinesClient", "ListByWorkspace", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "armservicemap.MachinesClient", "ListByWorkspace", resp, "Failure sending request")
		return
	}

	result, err = client.ListByWorkspaceResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "armservicemap.MachinesClient", "ListByWorkspace", resp, "Failure responding to request")
	}
...
func (client MachinesClient) ListByWorkspaceNextResults(lastResults MachineCollection) (result MachineCollection, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "armservicemap.MachinesClient", "ListByWorkspace", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "armservicemap.MachinesClient", "ListByWorkspace", resp, "Failure sending next results request")
	}

	result, err = client.ListByWorkspaceResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "armservicemap.MachinesClient", "ListByWorkspace", resp, "Failure responding to next results request")
	}
...
func (client MachinesClient) ListConnections(resourceGroupName string, workspaceName string, machineName string, startTime *date.Time, endTime *date.Time) (result ConnectionCollection, err error) {
	if err := validation.Validate([]validation.Validation{
		...
		{TargetValue: machineName,
			Constraints: []validation.Constraint{{Target: "machineName", Name: validation.MaxLength, Rule: 64, Chain: nil},
				{Target: "machineName", Name: validation.MinLength, Rule: 3, Chain: nil}}}}); err != nil {
		return result, validation.NewErrorWithValidationError(err, "armservicemap.MachinesClient", "ListConnections")
	}

	req, err := client.ListConnectionsPreparer(resourceGroupName, workspaceName, machineName, startTime, endTime)
	if err != nil {
		err = autorest.NewErrorWithError(err, "armservicemap.MachinesClient", "ListConnections", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "armservicemap.MachinesClient", "ListConnections", resp, "Failure sending request")
		return
	}

	result, err = client.ListConnectionsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "armservicemap.MachinesClient", "ListConnections", resp, "Failure responding to request")
	}
...
func (client MachinesClient) ListConnectionsNextResults(lastResults ConnectionCollection) (result ConnectionCollection, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "armservicemap.MachinesClient", "ListConnections", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "armservicemap.MachinesClient", "ListConnections", resp, "Failure sending next results request")
	}

	result, err = client.ListConnectionsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "armservicemap.MachinesClient", "ListConnections", resp, "Failure responding to next results request")
	}
...
func (client MachinesClient) ListMachineGroupMembership(resourceGroupName string, workspaceName string, machineName string) (result MachineGroupCollection, err error) {
	if err := validation.Validate([]validation.Validation{
		...
		{TargetValue: machineName,
			Constraints: []validation.Constraint{{Target: "machineName", Name: validation.MaxLength, Rule: 64, Chain: nil},
				{Target: "machineName", Name: validation.MinLength, Rule: 3, Chain: nil}}}}); err != nil {
		return result, validation.NewErrorWithValidationError(err, "armservicemap.MachinesClient", "ListMachineGroupMembership")
	}

	req, err := client.ListMachineGroupMembershipPreparer(resourceGroupName, workspaceName, machineName)
	if err != nil {
		err = autorest.NewErrorWithError(err, "armservicemap.MachinesClient", "ListMachineGroupMembership", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "armservicemap.MachinesClient", "ListMachineGroupMembership", resp, "Failure sending request")
		return
	}

	result, err = client.ListMachineGroupMembershipResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "armservicemap.MachinesClient", "ListMachineGroupMembership", resp, "Failure responding to request")
	}
...
func (client MachinesClient) ListMachineGroupMembershipNextResults(lastResults MachineGroupCollection) (result MachineGroupCollection, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "armservicemap.MachinesClient", "ListMachineGroupMembership", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "armservicemap.MachinesClient", "ListMachineGroupMembership", resp, "Failure sending next results request")
	}

	result, err = client.ListMachineGroupMembershipResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "armservicemap.MachinesClient", "ListMachineGroupMembership", resp, "Failure responding to next results request")
	}
...
func (client MachinesClient) ListPorts(resourceGroupName string, workspaceName string, machineName string, startTime *date.Time, endTime *date.Time) (result PortCollection, err error) {
	if err := validation.Validate([]validation.Validation{
		...
		{TargetValue: machineName,
			Constraints: []validation.Constraint{{Target: "machineName", Name: validation.MaxLength, Rule: 64, Chain: nil},
				{Target: "machineName", Name: validation.MinLength, Rule: 3, Chain: nil}}}}); err != nil {
		return result, validation.NewErrorWithValidationError(err, "armservicemap.MachinesClient", "ListPorts")
	}

	req, err := client.ListPortsPreparer(resourceGroupName, workspaceName, machineName, startTime, endTime)
	if err != nil {
		err = autorest.NewErrorWithError(err, "armservicemap.MachinesClient", "ListPorts", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "armservicemap.MachinesClient", "ListPorts", resp, "Failure sending request")
		return
	}

	result, err = client.ListPortsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "armservicemap.MachinesClient", "ListPorts", resp, "Failure responding to request")
	}
...
func (client MachinesClient) ListPortsNextResults(lastResults PortCollection) (result PortCollection, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "armservicemap.MachinesClient", "ListPorts", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "armservicemap.MachinesClient", "ListPorts", resp, "Failure sending next results request")
	}

	result, err = client.ListPortsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "armservicemap.MachinesClient", "ListPorts", resp, "Failure responding to next results request")
	}
...
func (client MachinesClient) ListProcesses(resourceGroupName string, workspaceName string, machineName string, live *bool, startTime *date.Time, endTime *date.Time, timestamp *date.Time) (result ProcessCollection, err error) {
	if err := validation.Validate([]validation.Validation{
		...
		{TargetValue: machineName,
			Constraints: []validation.Constraint{{Target: "machineName", Name: validation.MaxLength, Rule: 64, Chain: nil},
				{Target: "machineName", Name: validation.MinLength, Rule: 3, Chain: nil}}}}); err != nil {
		return result, validation.NewErrorWithValidationError(err, "armservicemap.MachinesClient", "ListProcesses")
	}

	req, err := client.ListProcessesPreparer(resourceGroupName, workspaceName, machineName, live, startTime, endTime, timestamp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "armservicemap.MachinesClient", "ListProcesses", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "armservicemap.MachinesClient", "ListProcesses", resp, "Failure sending request")
		return
	}

	result, err = client.ListProcessesResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "armservicemap.MachinesClient", "ListProcesses", resp, "Failure responding to request")
	}
...
func (client MachinesClient) ListProcessesNextResults(lastResults ProcessCollection) (result ProcessCollection, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "armservicemap.MachinesClient", "ListProcesses", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "armservicemap.MachinesClient", "ListProcesses", resp, "Failure sending next results request")
	}

	result, err = client.ListProcessesResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "armservicemap.MachinesClient", "ListProcesses", resp, "Failure responding to next results request")
	}
