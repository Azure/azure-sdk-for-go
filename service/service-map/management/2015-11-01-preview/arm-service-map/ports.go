...
func (client PortsClient) Get(resourceGroupName string, workspaceName string, machineName string, portName string, startTime *date.Time, endTime *date.Time) (result Port, err error) {
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewErrorWithValidationError(err, "armservicemap.PortsClient", "Get")
	}

	req, err := client.GetPreparer(resourceGroupName, workspaceName, machineName, portName, startTime, endTime)
	if err != nil {
		err = autorest.NewErrorWithError(err, "armservicemap.PortsClient", "Get", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "armservicemap.PortsClient", "Get", resp, "Failure sending request")
		return
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "armservicemap.PortsClient", "Get", resp, "Failure responding to request")
	}
...
func (client PortsClient) GetLiveness(resourceGroupName string, workspaceName string, machineName string, portName string, startTime *date.Time, endTime *date.Time) (result Liveness, err error) {
	if err := validation.Validate([]validation.Validation{
		...
		{TargetValue: portName,
			Constraints: []validation.Constraint{{Target: "portName", Name: validation.MaxLength, Rule: 64, Chain: nil},
				{Target: "portName", Name: validation.MinLength, Rule: 3, Chain: nil}}}}); err != nil {
		return result, validation.NewErrorWithValidationError(err, "armservicemap.PortsClient", "GetLiveness")
	}

	req, err := client.GetLivenessPreparer(resourceGroupName, workspaceName, machineName, portName, startTime, endTime)
	if err != nil {
		err = autorest.NewErrorWithError(err, "armservicemap.PortsClient", "GetLiveness", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "armservicemap.PortsClient", "GetLiveness", resp, "Failure sending request")
		return
	}

	result, err = client.GetLivenessResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "armservicemap.PortsClient", "GetLiveness", resp, "Failure responding to request")
	}
...
func (client PortsClient) ListAcceptingProcesses(resourceGroupName string, workspaceName string, machineName string, portName string, startTime *date.Time, endTime *date.Time) (result ProcessCollection, err error) {
	if err := validation.Validate([]validation.Validation{
		...
		{TargetValue: portName,
			Constraints: []validation.Constraint{{Target: "portName", Name: validation.MaxLength, Rule: 64, Chain: nil},
				{Target: "portName", Name: validation.MinLength, Rule: 3, Chain: nil}}}}); err != nil {
		return result, validation.NewErrorWithValidationError(err, "armservicemap.PortsClient", "ListAcceptingProcesses")
	}

	req, err := client.ListAcceptingProcessesPreparer(resourceGroupName, workspaceName, machineName, portName, startTime, endTime)
	if err != nil {
		err = autorest.NewErrorWithError(err, "armservicemap.PortsClient", "ListAcceptingProcesses", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "armservicemap.PortsClient", "ListAcceptingProcesses", resp, "Failure sending request")
		return
	}

	result, err = client.ListAcceptingProcessesResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "armservicemap.PortsClient", "ListAcceptingProcesses", resp, "Failure responding to request")
	}
...
func (client PortsClient) ListAcceptingProcessesNextResults(lastResults ProcessCollection) (result ProcessCollection, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "armservicemap.PortsClient", "ListAcceptingProcesses", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "armservicemap.PortsClient", "ListAcceptingProcesses", resp, "Failure sending next results request")
	}

	result, err = client.ListAcceptingProcessesResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "armservicemap.PortsClient", "ListAcceptingProcesses", resp, "Failure responding to next results request")
	}
...
func (client PortsClient) ListConnections(resourceGroupName string, workspaceName string, machineName string, portName string, startTime *date.Time, endTime *date.Time) (result ConnectionCollection, err error) {
	if err := validation.Validate([]validation.Validation{
		...
		{TargetValue: portName,
			Constraints: []validation.Constraint{{Target: "portName", Name: validation.MaxLength, Rule: 64, Chain: nil},
				{Target: "portName", Name: validation.MinLength, Rule: 3, Chain: nil}}}}); err != nil {
		return result, validation.NewErrorWithValidationError(err, "armservicemap.PortsClient", "ListConnections")
	}

	req, err := client.ListConnectionsPreparer(resourceGroupName, workspaceName, machineName, portName, startTime, endTime)
	if err != nil {
		err = autorest.NewErrorWithError(err, "armservicemap.PortsClient", "ListConnections", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "armservicemap.PortsClient", "ListConnections", resp, "Failure sending request")
		return
	}

	result, err = client.ListConnectionsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "armservicemap.PortsClient", "ListConnections", resp, "Failure responding to request")
	}
...
func (client PortsClient) ListConnectionsNextResults(lastResults ConnectionCollection) (result ConnectionCollection, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "armservicemap.PortsClient", "ListConnections", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "armservicemap.PortsClient", "ListConnections", resp, "Failure sending next results request")
	}

	result, err = client.ListConnectionsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "armservicemap.PortsClient", "ListConnections", resp, "Failure responding to next results request")
	}
