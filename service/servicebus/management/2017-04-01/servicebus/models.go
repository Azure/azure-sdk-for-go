...
const (
	// FilterTypeCorrelationFilter specifies the filter type correlation filter
	// state for filter type.
	FilterTypeCorrelationFilter FilterType = "CorrelationFilter"
	// FilterTypeSQLFilter specifies the filter type sql filter state for
	// filter type.
...
// Action is represents the filter actions which are allowed for the
...
// container and acrchive name format for capture destination
...
// ErrorResponse is error reponse indicates ServiceBus service is not able to
...
// PremiumMessagingRegionsListResult is the response of the List
// PremiumMessagingRegions operation.
...
// SBAuthorizationRuleListResult is the response to the List Namespace
// operation.
...
// SBSubscriptionListResult is the response to the List Subscriptions
// operation.
...
// SQLFilter is represents a filter which is a composition of an expression and
// an action that is executed in the pub/sub pipeline.
...
// SQLRuleAction is represents set of actions written in SQL language-based
// syntax that is performed against a ServiceBus.Messaging.BrokeredMessage
