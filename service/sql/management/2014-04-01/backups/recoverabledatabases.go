...
// RecoverableDatabasesClient is the provides read functionality for Azure SQL
// Database Backups
type RecoverableDatabasesClient struct {
	ManagementClient
}

// NewRecoverableDatabasesClient creates an instance of the
// RecoverableDatabasesClient client.
...
// NewRecoverableDatabasesClientWithBaseURI creates an instance of the
// RecoverableDatabasesClient client.
...
// Get gets a recoverable database, which is a resource representing a
...
func (client RecoverableDatabasesClient) Get(resourceGroupName string, serverName string, databaseName string) (result RecoverableDatabase, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "backups.RecoverableDatabasesClient", "Get", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "backups.RecoverableDatabasesClient", "Get", resp, "Failure sending request")
		return
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "backups.RecoverableDatabasesClient", "Get", resp, "Failure responding to request")
	}
...
func (client RecoverableDatabasesClient) ListByServer(resourceGroupName string, serverName string) (result RecoverableDatabaseListResult, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "backups.RecoverableDatabasesClient", "ListByServer", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "backups.RecoverableDatabasesClient", "ListByServer", resp, "Failure sending request")
		return
	}

	result, err = client.ListByServerResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "backups.RecoverableDatabasesClient", "ListByServer", resp, "Failure responding to request")
	}
