...
// RestorePointsClient is the provides read functionality for Azure SQL
// Database Backups
...
// NewRestorePointsClientWithBaseURI creates an instance of the
...
// of the database to get available restore points.
func (client RestorePointsClient) ListByDatabase(resourceGroupName string, serverName string, databaseName string) (result RestorePointListResult, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "backups.RestorePointsClient", "ListByDatabase", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "backups.RestorePointsClient", "ListByDatabase", resp, "Failure sending request")
		return
	}

	result, err = client.ListByDatabaseResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "backups.RestorePointsClient", "ListByDatabase", resp, "Failure responding to request")
	}
