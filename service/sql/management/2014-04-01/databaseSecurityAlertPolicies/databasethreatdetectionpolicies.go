...
// DatabaseThreatDetectionPoliciesClient is the provides create, read and
// update functionality for database Threat Detection policies.
type DatabaseThreatDetectionPoliciesClient struct {
	ManagementClient
}

// NewDatabaseThreatDetectionPoliciesClient creates an instance of the
...
// NewDatabaseThreatDetectionPoliciesClientWithBaseURI creates an instance of
// the DatabaseThreatDetectionPoliciesClient client.
...
// securityAlertPolicyName is the name of the security alert policy. parameters
// is the database Threat Detection policy.
func (client DatabaseThreatDetectionPoliciesClient) CreateOrUpdate(resourceGroupName string, serverName string, databaseName string, securityAlertPolicyName string, parameters DatabaseSecurityAlertPolicy) (result DatabaseSecurityAlertPolicy, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "databasesecurityalertpolicies.DatabaseThreatDetectionPoliciesClient", "CreateOrUpdate", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "databasesecurityalertpolicies.DatabaseThreatDetectionPoliciesClient", "CreateOrUpdate", resp, "Failure sending request")
		return
	}

	result, err = client.CreateOrUpdateResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "databasesecurityalertpolicies.DatabaseThreatDetectionPoliciesClient", "CreateOrUpdate", resp, "Failure responding to request")
	}
...
// the portal. serverName is the name of the server. databaseName is the name
// of the database for which database Threat Detection policy is defined.
// securityAlertPolicyName is the name of the security alert policy.
func (client DatabaseThreatDetectionPoliciesClient) Get(resourceGroupName string, serverName string, databaseName string, securityAlertPolicyName string) (result DatabaseSecurityAlertPolicy, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "databasesecurityalertpolicies.DatabaseThreatDetectionPoliciesClient", "Get", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "databasesecurityalertpolicies.DatabaseThreatDetectionPoliciesClient", "Get", resp, "Failure sending request")
		return
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "databasesecurityalertpolicies.DatabaseThreatDetectionPoliciesClient", "Get", resp, "Failure responding to request")
	}
