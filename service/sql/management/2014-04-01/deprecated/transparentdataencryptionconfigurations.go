...
// TransparentDataEncryptionConfigurationsClient is the provides create, read,
// update and delete functionality for Azure SQL Database resources including
// servers, databases, elastic pools, recommendations, and operations.
...
// NewTransparentDataEncryptionConfigurationsClientWithBaseURI creates an
// instance of the TransparentDataEncryptionConfigurationsClient client.
...
// ListByDatabase gets a list of a database's transparent data encryption
...
func (client TransparentDataEncryptionConfigurationsClient) ListByDatabase(resourceGroupName string, serverName string, databaseName string) (result TransparentDataEncryptionListResult, err error) {
	req, err := client.ListByDatabasePreparer(resourceGroupName, serverName, databaseName)
	if err != nil {
		err = autorest.NewErrorWithError(err, "deprecated.TransparentDataEncryptionConfigurationsClient", "ListByDatabase", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "deprecated.TransparentDataEncryptionConfigurationsClient", "ListByDatabase", resp, "Failure sending request")
		return
	}

	result, err = client.ListByDatabaseResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "deprecated.TransparentDataEncryptionConfigurationsClient", "ListByDatabase", resp, "Failure responding to request")
	}
...
func (client TransparentDataEncryptionConfigurationsClient) ListByDatabasePreparer(resourceGroupName string, serverName string, databaseName string) (*http.Request, error) {
