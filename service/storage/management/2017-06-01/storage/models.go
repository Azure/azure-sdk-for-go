...
const (
	// DefaultActionAllow specifies the default action allow state for default
	// action.
	DefaultActionAllow DefaultAction = "Allow"
	// DefaultActionDeny specifies the default action deny state for default
	// action.
...
const (
	// SignedResourceTypesC specifies the signed resource types c state for
	// signed resource types.
	SignedResourceTypesC SignedResourceTypes = "c"
	// SignedResourceTypesO specifies the signed resource types o state for
	// signed resource types.
	SignedResourceTypesO SignedResourceTypes = "o"
	// SignedResourceTypesS specifies the signed resource types s state for
	// signed resource types.
...
const (
	...
	// StateNetworkSourceDeleted specifies the state network source deleted
	// state for state.
...
// OperationProperties is properties of operation, include metric
// specifications.
