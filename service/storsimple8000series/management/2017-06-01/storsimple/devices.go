...
// DevicesClient is the client for the Devices methods of the Storsimple
// service.
...
// AuthorizeForServiceEncryptionKeyRollover authorizes the specified device for
...
// Configure complete minimal setup before using the device. This method may
// poll for completion. Polling can be canceled by passing the cancel channel
// argument. The channel will be used to cancel polling and any outstanding
// HTTP requests.
//
// parameters is the minimal properties to configure a device.
...
// Deactivate deactivates the device. This method may poll for completion.
...
// Delete deletes the device. This method may poll for completion. Polling can
...
// Failover failovers a set of volume containers from a specified source device
// to a target device. This method may poll for completion. Polling can be
// canceled by passing the cancel channel argument. The channel will be used to
// cancel polling and any outstanding HTTP requests.
//
// sourceDeviceName is the source device name on which failover is performed.
// parameters is failoverRequest containing the source device and the list of
// volume containers to be failed over. resourceGroupName is the resource group
...
//
// deviceName is the device name resourceGroupName is the resource group name
// managerName is the manager name expand is specify $expand=details to
// populate additional fields related to the device or $expand=rolloverdetails
// to populate additional fields related to the service data encryption key
// rollover on device
...
// InstallUpdates downloads and installs the updates on the device. This method
...
//
// resourceGroupName is the resource group name managerName is the manager name
// expand is specify $expand=details to populate additional fields related to
// the device or $expand=rolloverdetails to populate additional fields related
...
// ListFailoverSets returns all failover sets for a given device and their
// eligibility for participating in a failover. A failover set refers to a set
...
// ListFailoverTargets given a list of volume containers to be failed over from
// a source device, this method returns the eligibility result, as a failover
// target, for all devices under that resource.
//
// sourceDeviceName is the source device name on which failover is performed.
// parameters is listFailoverTargetsRequest containing the list of volume
// containers to be failed over. resourceGroupName is the resource group name
// managerName is the manager name
...
// ScanForUpdates scans for updates on the device. This method may poll for
...
//
// deviceName is the device name parameters is patch representation of the
// device. resourceGroupName is the resource group name managerName is the
// manager name
