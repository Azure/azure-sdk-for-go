...
const (
	// CheckingEndpoint specifies the checking endpoint state for endpoint
	// monitor status.
...
const (
	// EndpointStatusDisabled specifies the endpoint status disabled state for
	// endpoint status.
	EndpointStatusDisabled EndpointStatus = "Disabled"
	// EndpointStatusEnabled specifies the endpoint status enabled state for
	// endpoint status.
...
const (
	// ProfileMonitorStatusCheckingEndpoints specifies the profile monitor
	// status checking endpoints state for profile monitor status.
	ProfileMonitorStatusCheckingEndpoints ProfileMonitorStatus = "CheckingEndpoints"
	// ProfileMonitorStatusDegraded specifies the profile monitor status
	// degraded state for profile monitor status.
	ProfileMonitorStatusDegraded ProfileMonitorStatus = "Degraded"
	// ProfileMonitorStatusDisabled specifies the profile monitor status
	// disabled state for profile monitor status.
	ProfileMonitorStatusDisabled ProfileMonitorStatus = "Disabled"
	// ProfileMonitorStatusInactive specifies the profile monitor status
	// inactive state for profile monitor status.
	ProfileMonitorStatusInactive ProfileMonitorStatus = "Inactive"
	// ProfileMonitorStatusOnline specifies the profile monitor status online
	// state for profile monitor status.
...
const (
	// ProfileStatusDisabled specifies the profile status disabled state for
	// profile status.
	ProfileStatusDisabled ProfileStatus = "Disabled"
	// ProfileStatusEnabled specifies the profile status enabled state for
	// profile status.
...
// CloudErrorBody is the content of an error returned by the Azure Resource
// Manager
...
// GeographicHierarchy is class representing the Geographic hierarchy used with
...
// GeographicHierarchyProperties is class representing the properties of the
// Geographic hierarchy used with the Geographic traffic routing method.
...
// ProxyResource is the resource model definition for a ARM proxy resource. It
...
// Region is class representing a region in the Geographic hierarchy used with
// the Geographic traffic routing method.
type Region struct {
	Code    *string   `json:"code,omitempty"`
	Name    *string   `json:"name,omitempty"`
...
// TrackedResource is the resource model definition for a ARM tracked top level
// resource
