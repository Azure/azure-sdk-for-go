...
// AccountsClient is the use these APIs to manage Visual Studio Team Services
...
// CheckNameAvailability checks if the specified Visual Studio Team Services
// account name is available. Resource name can be either an account name or an
// account name and PUID.
//
...
func (client AccountsClient) CheckNameAvailability(body CheckNameAvailabilityParameter) (result CheckNameAvailabilityResult, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "csm.AccountsClient", "CheckNameAvailability", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "csm.AccountsClient", "CheckNameAvailability", resp, "Failure sending request")
		return
	}

	result, err = client.CheckNameAvailabilityResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "csm.AccountsClient", "CheckNameAvailability", resp, "Failure responding to request")
	}
...
// CreateOrUpdate creates or updates a Visual Studio Team Services account
// resource.
//
// resourceGroupName is name of the resource group within the Azure
// subscription. body is the request data. resourceName is name of the
// resource.
func (client AccountsClient) CreateOrUpdate(resourceGroupName string, body AccountResourceRequest, resourceName string) (result AccountResource, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "csm.AccountsClient", "CreateOrUpdate", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "csm.AccountsClient", "CreateOrUpdate", resp, "Failure sending request")
		return
	}

	result, err = client.CreateOrUpdateResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "csm.AccountsClient", "CreateOrUpdate", resp, "Failure responding to request")
	}
...
//
// resourceGroupName is name of the resource group within the Azure
// subscription. resourceName is name of the resource.
func (client AccountsClient) Delete(resourceGroupName string, resourceName string) (result autorest.Response, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "csm.AccountsClient", "Delete", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "csm.AccountsClient", "Delete", resp, "Failure sending request")
		return
	}

	result, err = client.DeleteResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "csm.AccountsClient", "Delete", resp, "Failure responding to request")
	}
...
func (client AccountsClient) Get(resourceGroupName string, resourceName string) (result AccountResource, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "csm.AccountsClient", "Get", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "csm.AccountsClient", "Get", resp, "Failure sending request")
		return
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "csm.AccountsClient", "Get", resp, "Failure responding to request")
	}
...
// ListByResourceGroup gets all Visual Studio Team Services account resources
// under the resource group linked to the specified Azure subscription.
//
// resourceGroupName is name of the resource group within the Azure
// subscription.
func (client AccountsClient) ListByResourceGroup(resourceGroupName string) (result AccountResourceListResult, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "csm.AccountsClient", "ListByResourceGroup", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "csm.AccountsClient", "ListByResourceGroup", resp, "Failure sending request")
		return
	}

	result, err = client.ListByResourceGroupResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "csm.AccountsClient", "ListByResourceGroup", resp, "Failure responding to request")
	}
