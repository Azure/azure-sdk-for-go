...
// ExtensionsClient is the use these APIs to manage Visual Studio Team Services
...
// NewExtensionsClientWithBaseURI creates an instance of the ExtensionsClient
// client.
...
// subscription. body is an object containing additional information related to
// the extension request. accountResourceName is the name of the Visual Studio
// Team Services account resource. extensionResourceName is the name of the
// extension.
func (client ExtensionsClient) Create(resourceGroupName string, body ExtensionResourceRequest, accountResourceName string, extensionResourceName string) (result ExtensionResource, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "csm.ExtensionsClient", "Create", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "csm.ExtensionsClient", "Create", resp, "Failure sending request")
		return
	}

	result, err = client.CreateResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "csm.ExtensionsClient", "Create", resp, "Failure responding to request")
	}
...
// Delete removes an extension resource registration for a Visual Studio Team
// Services account.
//
// resourceGroupName is name of the resource group within the Azure
// subscription. accountResourceName is the name of the Visual Studio Team
// Services account resource. extensionResourceName is the name of the
// extension.
func (client ExtensionsClient) Delete(resourceGroupName string, accountResourceName string, extensionResourceName string) (result autorest.Response, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "csm.ExtensionsClient", "Delete", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "csm.ExtensionsClient", "Delete", resp, "Failure sending request")
		return
	}

	result, err = client.DeleteResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "csm.ExtensionsClient", "Delete", resp, "Failure responding to request")
	}
...
// Get gets the details of an extension associated with a Visual Studio Team
...
func (client ExtensionsClient) Get(resourceGroupName string, accountResourceName string, extensionResourceName string) (result ExtensionResource, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "csm.ExtensionsClient", "Get", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "csm.ExtensionsClient", "Get", resp, "Failure sending request")
		return
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "csm.ExtensionsClient", "Get", resp, "Failure responding to request")
	}
...
// ListByAccount gets the details of the extension resources created within the
// resource group.
//
// resourceGroupName is name of the resource group within the Azure
// subscription. accountResourceName is the name of the Visual Studio Team
...
func (client ExtensionsClient) ListByAccount(resourceGroupName string, accountResourceName string) (result ExtensionResourceListResult, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "csm.ExtensionsClient", "ListByAccount", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "csm.ExtensionsClient", "ListByAccount", resp, "Failure sending request")
		return
	}

	result, err = client.ListByAccountResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "csm.ExtensionsClient", "ListByAccount", resp, "Failure responding to request")
	}
...
// Update updates an existing extension registration for the Visual Studio Team
// Services account.
//
// resourceGroupName is name of the resource group within the Azure
// subscription. body is an object containing additional information related to
...
func (client ExtensionsClient) Update(resourceGroupName string, body ExtensionResourceRequest, accountResourceName string, extensionResourceName string) (result ExtensionResource, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "csm.ExtensionsClient", "Update", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "csm.ExtensionsClient", "Update", resp, "Failure sending request")
		return
	}

	result, err = client.UpdateResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "csm.ExtensionsClient", "Update", resp, "Failure responding to request")
	}
