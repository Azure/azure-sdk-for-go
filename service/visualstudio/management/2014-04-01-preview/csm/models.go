...
// AccountResourceListResult is the response to an account resource list GET
// request.
...
// AccountResourceRequest is the body of a PUT request to modify a Visual
// Studio account resource.
...
// CheckNameAvailabilityParameter is the body of a POST request to check name
// availability.
...
// ExtensionResourceListResult is the response to an extension resource list
// GET request.
...
// OperationListResult is container for a list of operations supported by a
// resource provider.
...
// OperationProperties is properties of an operation supported by the resource
// provider.
