...
// OperationsClient is the use these APIs to manage Visual Studio Team Services
...
// List gets the details of all operations possible on the
// Microsoft.VisualStudio resource provider.
func (client OperationsClient) List() (result OperationListResult, err error) {
	req, err := client.ListPreparer()
	if err != nil {
		err = autorest.NewErrorWithError(err, "csm.OperationsClient", "List", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "csm.OperationsClient", "List", resp, "Failure sending request")
		return
	}

	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "csm.OperationsClient", "List", resp, "Failure responding to request")
	}
