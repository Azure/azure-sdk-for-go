...
// ConnectionsClient is the client for the Connections methods of the
...
// NewConnectionsClientWithBaseURI creates an instance of the ConnectionsClient
// client.
...
//
// resourceGroupName is the resource group name. connectionName is the
// connection name. content is the content.
func (client ConnectionsClient) ConfirmConsentCode(resourceGroupName string, connectionName string, content ConfirmConsentCodeInput) (result Connection, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "logicappsmanagementclient.ConnectionsClient", "ConfirmConsentCode", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "logicappsmanagementclient.ConnectionsClient", "ConfirmConsentCode", resp, "Failure sending request")
		return
	}

	result, err = client.ConfirmConsentCodeResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "logicappsmanagementclient.ConnectionsClient", "ConfirmConsentCode", resp, "Failure responding to request")
	}
...
//
// resourceGroupName is the resource group name. connectionName is the
// connection name. connection is the connection.
func (client ConnectionsClient) CreateOrUpdate(resourceGroupName string, connectionName string, connection Connection) (result Connection, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "logicappsmanagementclient.ConnectionsClient", "CreateOrUpdate", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "logicappsmanagementclient.ConnectionsClient", "CreateOrUpdate", resp, "Failure sending request")
		return
	}

	result, err = client.CreateOrUpdateResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "logicappsmanagementclient.ConnectionsClient", "CreateOrUpdate", resp, "Failure responding to request")
	}
...
func (client ConnectionsClient) Delete(resourceGroupName string, connectionName string) (result autorest.Response, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "logicappsmanagementclient.ConnectionsClient", "Delete", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "logicappsmanagementclient.ConnectionsClient", "Delete", resp, "Failure sending request")
		return
	}

	result, err = client.DeleteResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "logicappsmanagementclient.ConnectionsClient", "Delete", resp, "Failure responding to request")
	}
...
func (client ConnectionsClient) Get(resourceGroupName string, connectionName string) (result Connection, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "logicappsmanagementclient.ConnectionsClient", "Get", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "logicappsmanagementclient.ConnectionsClient", "Get", resp, "Failure sending request")
		return
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "logicappsmanagementclient.ConnectionsClient", "Get", resp, "Failure responding to request")
	}
...
//
// resourceGroupName is resource Group Name top is the number of items to be
...
func (client ConnectionsClient) List(resourceGroupName string, top *int32, filter string) (result ConnectionCollection, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "logicappsmanagementclient.ConnectionsClient", "List", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "logicappsmanagementclient.ConnectionsClient", "List", resp, "Failure sending request")
		return
	}

	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "logicappsmanagementclient.ConnectionsClient", "List", resp, "Failure responding to request")
	}
...
func (client ConnectionsClient) ListNextResults(lastResults ConnectionCollection) (result ConnectionCollection, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "logicappsmanagementclient.ConnectionsClient", "List", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "logicappsmanagementclient.ConnectionsClient", "List", resp, "Failure sending next results request")
	}

	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "logicappsmanagementclient.ConnectionsClient", "List", resp, "Failure responding to next results request")
	}
...
func (client ConnectionsClient) ListConnectionKeys(resourceGroupName string, connectionName string, content ListConnectionKeysInput) (result ConnectionSecrets, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "logicappsmanagementclient.ConnectionsClient", "ListConnectionKeys", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "logicappsmanagementclient.ConnectionsClient", "ListConnectionKeys", resp, "Failure sending request")
		return
	}

	result, err = client.ListConnectionKeysResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "logicappsmanagementclient.ConnectionsClient", "ListConnectionKeys", resp, "Failure responding to request")
	}
...
func (client ConnectionsClient) ListConsentLinks(resourceGroupName string, connectionName string, content ConsentLinkInput) (result ConsentLinkPayload, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "logicappsmanagementclient.ConnectionsClient", "ListConsentLinks", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "logicappsmanagementclient.ConnectionsClient", "ListConsentLinks", resp, "Failure sending request")
		return
	}

	result, err = client.ListConsentLinksResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "logicappsmanagementclient.ConnectionsClient", "ListConsentLinks", resp, "Failure responding to request")
	}
