...
func (client CertificatesClient) CreateOrUpdateCertificate(resourceGroupName string, name string, certificateEnvelope Certificate) (result Certificate, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.CertificatesClient", "CreateOrUpdateCertificate", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "service.CertificatesClient", "CreateOrUpdateCertificate", resp, "Failure sending request")
		return
	}

	result, err = client.CreateOrUpdateCertificateResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.CertificatesClient", "CreateOrUpdateCertificate", resp, "Failure responding to request")
	}
...
func (client CertificatesClient) CreateOrUpdateCsr(resourceGroupName string, name string, csrEnvelope Csr) (result Csr, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.CertificatesClient", "CreateOrUpdateCsr", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.CertificatesClient", "CreateOrUpdateCsr", resp, "Failure sending request")
		return
	}

	result, err = client.CreateOrUpdateCsrResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.CertificatesClient", "CreateOrUpdateCsr", resp, "Failure responding to request")
	}
...
func (client CertificatesClient) DeleteCertificate(resourceGroupName string, name string) (result SetObject, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.CertificatesClient", "DeleteCertificate", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.CertificatesClient", "DeleteCertificate", resp, "Failure sending request")
		return
	}

	result, err = client.DeleteCertificateResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.CertificatesClient", "DeleteCertificate", resp, "Failure responding to request")
	}
...
func (client CertificatesClient) DeleteCsr(resourceGroupName string, name string) (result SetObject, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.CertificatesClient", "DeleteCsr", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.CertificatesClient", "DeleteCsr", resp, "Failure sending request")
		return
	}

	result, err = client.DeleteCsrResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.CertificatesClient", "DeleteCsr", resp, "Failure responding to request")
	}
...
func (client CertificatesClient) GetCertificate(resourceGroupName string, name string) (result Certificate, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.CertificatesClient", "GetCertificate", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.CertificatesClient", "GetCertificate", resp, "Failure sending request")
		return
	}

	result, err = client.GetCertificateResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.CertificatesClient", "GetCertificate", resp, "Failure responding to request")
	}
...
func (client CertificatesClient) GetCertificates(resourceGroupName string) (result CertificateCollection, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.CertificatesClient", "GetCertificates", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.CertificatesClient", "GetCertificates", resp, "Failure sending request")
		return
	}

	result, err = client.GetCertificatesResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.CertificatesClient", "GetCertificates", resp, "Failure responding to request")
	}
...
func (client CertificatesClient) GetCertificatesNextResults(lastResults CertificateCollection) (result CertificateCollection, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "service.CertificatesClient", "GetCertificates", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "service.CertificatesClient", "GetCertificates", resp, "Failure sending next results request")
	}

	result, err = client.GetCertificatesResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.CertificatesClient", "GetCertificates", resp, "Failure responding to next results request")
	}
...
func (client CertificatesClient) GetCsr(resourceGroupName string, name string) (result Csr, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.CertificatesClient", "GetCsr", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.CertificatesClient", "GetCsr", resp, "Failure sending request")
		return
	}

	result, err = client.GetCsrResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.CertificatesClient", "GetCsr", resp, "Failure responding to request")
	}
...
func (client CertificatesClient) GetCsrs(resourceGroupName string) (result ListCsr, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.CertificatesClient", "GetCsrs", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.CertificatesClient", "GetCsrs", resp, "Failure sending request")
		return
	}

	result, err = client.GetCsrsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.CertificatesClient", "GetCsrs", resp, "Failure responding to request")
	}
...
func (client CertificatesClient) UpdateCertificate(resourceGroupName string, name string, certificateEnvelope Certificate) (result Certificate, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.CertificatesClient", "UpdateCertificate", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.CertificatesClient", "UpdateCertificate", resp, "Failure sending request")
		return
	}

	result, err = client.UpdateCertificateResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.CertificatesClient", "UpdateCertificate", resp, "Failure responding to request")
	}
...
func (client CertificatesClient) UpdateCsr(resourceGroupName string, name string, csrEnvelope Csr) (result Csr, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.CertificatesClient", "UpdateCsr", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.CertificatesClient", "UpdateCsr", resp, "Failure sending request")
		return
	}

	result, err = client.UpdateCsrResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.CertificatesClient", "UpdateCsr", resp, "Failure responding to request")
	}
