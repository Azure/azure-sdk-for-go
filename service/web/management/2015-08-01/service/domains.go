...
func (client DomainsClient) CreateOrUpdateDomain(resourceGroupName string, domainName string, domain Domain) (result Domain, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.DomainsClient", "CreateOrUpdateDomain", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "service.DomainsClient", "CreateOrUpdateDomain", resp, "Failure sending request")
		return
	}

	result, err = client.CreateOrUpdateDomainResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.DomainsClient", "CreateOrUpdateDomain", resp, "Failure responding to request")
	}
...
func (client DomainsClient) DeleteDomain(resourceGroupName string, domainName string, forceHardDeleteDomain *bool) (result SetObject, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.DomainsClient", "DeleteDomain", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.DomainsClient", "DeleteDomain", resp, "Failure sending request")
		return
	}

	result, err = client.DeleteDomainResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.DomainsClient", "DeleteDomain", resp, "Failure responding to request")
	}
...
func (client DomainsClient) GetDomain(resourceGroupName string, domainName string) (result Domain, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.DomainsClient", "GetDomain", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.DomainsClient", "GetDomain", resp, "Failure sending request")
		return
	}

	result, err = client.GetDomainResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.DomainsClient", "GetDomain", resp, "Failure responding to request")
	}
...
func (client DomainsClient) GetDomainOperation(resourceGroupName string, domainName string, operationID string) (result Domain, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.DomainsClient", "GetDomainOperation", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.DomainsClient", "GetDomainOperation", resp, "Failure sending request")
		return
	}

	result, err = client.GetDomainOperationResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.DomainsClient", "GetDomainOperation", resp, "Failure responding to request")
	}
...
func (client DomainsClient) GetDomains(resourceGroupName string) (result DomainCollection, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.DomainsClient", "GetDomains", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.DomainsClient", "GetDomains", resp, "Failure sending request")
		return
	}

	result, err = client.GetDomainsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.DomainsClient", "GetDomains", resp, "Failure responding to request")
	}
...
func (client DomainsClient) GetDomainsNextResults(lastResults DomainCollection) (result DomainCollection, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "service.DomainsClient", "GetDomains", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "service.DomainsClient", "GetDomains", resp, "Failure sending next results request")
	}

	result, err = client.GetDomainsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.DomainsClient", "GetDomains", resp, "Failure responding to next results request")
	}
...
func (client DomainsClient) UpdateDomain(resourceGroupName string, domainName string, domain Domain) (result Domain, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.DomainsClient", "UpdateDomain", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.DomainsClient", "UpdateDomain", resp, "Failure sending request")
		return
	}

	result, err = client.UpdateDomainResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.DomainsClient", "UpdateDomain", resp, "Failure responding to request")
	}
