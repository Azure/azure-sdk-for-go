...
func (client GlobalCertificateOrderClient) GetAllCertificateOrders() (result CertificateOrderCollection, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.GlobalCertificateOrderClient", "GetAllCertificateOrders", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "service.GlobalCertificateOrderClient", "GetAllCertificateOrders", resp, "Failure sending request")
		return
	}

	result, err = client.GetAllCertificateOrdersResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.GlobalCertificateOrderClient", "GetAllCertificateOrders", resp, "Failure responding to request")
	}
...
func (client GlobalCertificateOrderClient) GetAllCertificateOrdersNextResults(lastResults CertificateOrderCollection) (result CertificateOrderCollection, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "service.GlobalCertificateOrderClient", "GetAllCertificateOrders", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "service.GlobalCertificateOrderClient", "GetAllCertificateOrders", resp, "Failure sending next results request")
	}

	result, err = client.GetAllCertificateOrdersResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.GlobalCertificateOrderClient", "GetAllCertificateOrders", resp, "Failure responding to next results request")
	}
...
func (client GlobalCertificateOrderClient) ValidateCertificatePurchaseInformation(certificateOrder CertificateOrder) (result SetObject, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.GlobalCertificateOrderClient", "ValidateCertificatePurchaseInformation", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.GlobalCertificateOrderClient", "ValidateCertificatePurchaseInformation", resp, "Failure sending request")
		return
	}

	result, err = client.ValidateCertificatePurchaseInformationResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.GlobalCertificateOrderClient", "ValidateCertificatePurchaseInformation", resp, "Failure responding to request")
	}
