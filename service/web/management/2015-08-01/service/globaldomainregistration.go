...
func (client GlobalDomainRegistrationClient) CheckDomainAvailability(identifier NameIdentifier) (result DomainAvailablilityCheckResult, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.GlobalDomainRegistrationClient", "CheckDomainAvailability", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "service.GlobalDomainRegistrationClient", "CheckDomainAvailability", resp, "Failure sending request")
		return
	}

	result, err = client.CheckDomainAvailabilityResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.GlobalDomainRegistrationClient", "CheckDomainAvailability", resp, "Failure responding to request")
	}
...
func (client GlobalDomainRegistrationClient) GetAllDomains() (result DomainCollection, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.GlobalDomainRegistrationClient", "GetAllDomains", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.GlobalDomainRegistrationClient", "GetAllDomains", resp, "Failure sending request")
		return
	}

	result, err = client.GetAllDomainsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.GlobalDomainRegistrationClient", "GetAllDomains", resp, "Failure responding to request")
	}
...
func (client GlobalDomainRegistrationClient) GetAllDomainsNextResults(lastResults DomainCollection) (result DomainCollection, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "service.GlobalDomainRegistrationClient", "GetAllDomains", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "service.GlobalDomainRegistrationClient", "GetAllDomains", resp, "Failure sending next results request")
	}

	result, err = client.GetAllDomainsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.GlobalDomainRegistrationClient", "GetAllDomains", resp, "Failure responding to next results request")
	}
...
func (client GlobalDomainRegistrationClient) GetDomainControlCenterSsoRequest() (result DomainControlCenterSsoRequest, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.GlobalDomainRegistrationClient", "GetDomainControlCenterSsoRequest", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.GlobalDomainRegistrationClient", "GetDomainControlCenterSsoRequest", resp, "Failure sending request")
		return
	}

	result, err = client.GetDomainControlCenterSsoRequestResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.GlobalDomainRegistrationClient", "GetDomainControlCenterSsoRequest", resp, "Failure responding to request")
	}
...
func (client GlobalDomainRegistrationClient) ListDomainRecommendations(parameters DomainRecommendationSearchParameters) (result NameIdentifierCollection, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.GlobalDomainRegistrationClient", "ListDomainRecommendations", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.GlobalDomainRegistrationClient", "ListDomainRecommendations", resp, "Failure sending request")
		return
	}

	result, err = client.ListDomainRecommendationsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.GlobalDomainRegistrationClient", "ListDomainRecommendations", resp, "Failure responding to request")
	}
...
func (client GlobalDomainRegistrationClient) ListDomainRecommendationsNextResults(lastResults NameIdentifierCollection) (result NameIdentifierCollection, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "service.GlobalDomainRegistrationClient", "ListDomainRecommendations", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "service.GlobalDomainRegistrationClient", "ListDomainRecommendations", resp, "Failure sending next results request")
	}

	result, err = client.ListDomainRecommendationsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.GlobalDomainRegistrationClient", "ListDomainRecommendations", resp, "Failure responding to next results request")
	}
...
func (client GlobalDomainRegistrationClient) ValidateDomainPurchaseInformation(domainRegistrationInput DomainRegistrationInput) (result SetObject, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.GlobalDomainRegistrationClient", "ValidateDomainPurchaseInformation", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.GlobalDomainRegistrationClient", "ValidateDomainPurchaseInformation", resp, "Failure sending request")
		return
	}

	result, err = client.ValidateDomainPurchaseInformationResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.GlobalDomainRegistrationClient", "ValidateDomainPurchaseInformation", resp, "Failure responding to request")
	}
