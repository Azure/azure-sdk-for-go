...
// GetRecommendationBySubscription sends the get recommendation by subscription
// request.
//
...
// filter is return only channels specified in the filter. Filter is specified
// by using OData syntax. Example: $filter=channels eq 'Api' or channel eq
// 'Notification'
func (client RecommendationsClient) GetRecommendationBySubscription(featured *bool, filter string) (result ListRecommendation, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.RecommendationsClient", "GetRecommendationBySubscription", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "service.RecommendationsClient", "GetRecommendationBySubscription", resp, "Failure sending request")
		return
	}

	result, err = client.GetRecommendationBySubscriptionResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.RecommendationsClient", "GetRecommendationBySubscription", resp, "Failure responding to request")
	}
...
// '2015-01-01T00:00:00Z' and endTime eq '2015-01-02T00:00:00Z' endTime is the
// end time of a time range to query, e.g. $filter=startTime eq
...
func (client RecommendationsClient) GetRecommendationHistoryForSite(resourceGroupName string, siteName string, startTime string, endTime string) (result ListRecommendation, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.RecommendationsClient", "GetRecommendationHistoryForSite", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.RecommendationsClient", "GetRecommendationHistoryForSite", resp, "Failure sending request")
		return
	}

	result, err = client.GetRecommendationHistoryForSiteResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.RecommendationsClient", "GetRecommendationHistoryForSite", resp, "Failure responding to request")
	}
...
// others. Otherwise this API returns all recommendations available siteSku is
// the name of site SKU. numSlots is the number of site slots associated to the
// site
func (client RecommendationsClient) GetRecommendedRulesForSite(resourceGroupName string, siteName string, featured *bool, siteSku string, numSlots *int32) (result ListRecommendation, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.RecommendationsClient", "GetRecommendedRulesForSite", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.RecommendationsClient", "GetRecommendedRulesForSite", resp, "Failure sending request")
		return
	}

	result, err = client.GetRecommendedRulesForSiteResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.RecommendationsClient", "GetRecommendedRulesForSite", resp, "Failure responding to request")
	}
...
func (client RecommendationsClient) GetRuleDetailsBySiteName(resourceGroupName string, siteName string, name string) (result RecommendationRule, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.RecommendationsClient", "GetRuleDetailsBySiteName", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.RecommendationsClient", "GetRuleDetailsBySiteName", resp, "Failure sending request")
		return
	}

	result, err = client.GetRuleDetailsBySiteNameResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.RecommendationsClient", "GetRuleDetailsBySiteName", resp, "Failure responding to request")
	}
