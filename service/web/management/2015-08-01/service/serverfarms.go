...
func (client ServerFarmsClient) CreateOrUpdateServerFarm(resourceGroupName string, name string, serverFarmEnvelope ServerFarmWithRichSku, allowPendingState *bool, cancel <-chan struct{}) (<-chan ServerFarmWithRichSku, <-chan error) {
	...
	go func() {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ServerFarmsClient", "CreateOrUpdateServerFarm", nil, "Failure preparing request")
			return
		}
		...
		if err != nil {
			...
			err = autorest.NewErrorWithError(err, "service.ServerFarmsClient", "CreateOrUpdateServerFarm", resp, "Failure sending request")
			return
		}

		result, err = client.CreateOrUpdateServerFarmResponder(resp)
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.ServerFarmsClient", "CreateOrUpdateServerFarm", resp, "Failure responding to request")
		}
	}()
...
func (client ServerFarmsClient) CreateOrUpdateVnetRoute(resourceGroupName string, name string, vnetName string, routeName string, route VnetRoute) (result VnetRoute, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ServerFarmsClient", "CreateOrUpdateVnetRoute", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.ServerFarmsClient", "CreateOrUpdateVnetRoute", resp, "Failure sending request")
		return
	}

	result, err = client.CreateOrUpdateVnetRouteResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ServerFarmsClient", "CreateOrUpdateVnetRoute", resp, "Failure responding to request")
	}
...
func (client ServerFarmsClient) DeleteServerFarm(resourceGroupName string, name string) (result SetObject, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ServerFarmsClient", "DeleteServerFarm", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.ServerFarmsClient", "DeleteServerFarm", resp, "Failure sending request")
		return
	}

	result, err = client.DeleteServerFarmResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ServerFarmsClient", "DeleteServerFarm", resp, "Failure responding to request")
	}
...
func (client ServerFarmsClient) DeleteVnetRoute(resourceGroupName string, name string, vnetName string, routeName string) (result SetObject, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ServerFarmsClient", "DeleteVnetRoute", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.ServerFarmsClient", "DeleteVnetRoute", resp, "Failure sending request")
		return
	}

	result, err = client.DeleteVnetRouteResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ServerFarmsClient", "DeleteVnetRoute", resp, "Failure responding to request")
	}
...
func (client ServerFarmsClient) GetRouteForVnet(resourceGroupName string, name string, vnetName string, routeName string) (result ListVnetRoute, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ServerFarmsClient", "GetRouteForVnet", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.ServerFarmsClient", "GetRouteForVnet", resp, "Failure sending request")
		return
	}

	result, err = client.GetRouteForVnetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ServerFarmsClient", "GetRouteForVnet", resp, "Failure responding to request")
	}
...
func (client ServerFarmsClient) GetRoutesForVnet(resourceGroupName string, name string, vnetName string) (result ListVnetRoute, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ServerFarmsClient", "GetRoutesForVnet", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.ServerFarmsClient", "GetRoutesForVnet", resp, "Failure sending request")
		return
	}

	result, err = client.GetRoutesForVnetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ServerFarmsClient", "GetRoutesForVnet", resp, "Failure responding to request")
	}
...
func (client ServerFarmsClient) GetServerFarm(resourceGroupName string, name string) (result ServerFarmWithRichSku, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ServerFarmsClient", "GetServerFarm", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.ServerFarmsClient", "GetServerFarm", resp, "Failure sending request")
		return
	}

	result, err = client.GetServerFarmResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ServerFarmsClient", "GetServerFarm", resp, "Failure responding to request")
	}
...
func (client ServerFarmsClient) GetServerFarmMetricDefintions(resourceGroupName string, name string) (result MetricDefinitionCollection, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ServerFarmsClient", "GetServerFarmMetricDefintions", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.ServerFarmsClient", "GetServerFarmMetricDefintions", resp, "Failure sending request")
		return
	}

	result, err = client.GetServerFarmMetricDefintionsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ServerFarmsClient", "GetServerFarmMetricDefintions", resp, "Failure responding to request")
	}
...
func (client ServerFarmsClient) GetServerFarmMetricDefintionsNextResults(lastResults MetricDefinitionCollection) (result MetricDefinitionCollection, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "service.ServerFarmsClient", "GetServerFarmMetricDefintions", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "service.ServerFarmsClient", "GetServerFarmMetricDefintions", resp, "Failure sending next results request")
	}

	result, err = client.GetServerFarmMetricDefintionsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ServerFarmsClient", "GetServerFarmMetricDefintions", resp, "Failure responding to next results request")
	}
...
func (client ServerFarmsClient) GetServerFarmMetrics(resourceGroupName string, name string, details *bool, filter string) (result ResourceMetricCollection, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ServerFarmsClient", "GetServerFarmMetrics", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.ServerFarmsClient", "GetServerFarmMetrics", resp, "Failure sending request")
		return
	}

	result, err = client.GetServerFarmMetricsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ServerFarmsClient", "GetServerFarmMetrics", resp, "Failure responding to request")
	}
...
func (client ServerFarmsClient) GetServerFarmMetricsNextResults(lastResults ResourceMetricCollection) (result ResourceMetricCollection, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "service.ServerFarmsClient", "GetServerFarmMetrics", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "service.ServerFarmsClient", "GetServerFarmMetrics", resp, "Failure sending next results request")
	}

	result, err = client.GetServerFarmMetricsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ServerFarmsClient", "GetServerFarmMetrics", resp, "Failure responding to next results request")
	}
...
func (client ServerFarmsClient) GetServerFarmOperation(resourceGroupName string, name string, operationID string) (result ServerFarmWithRichSku, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ServerFarmsClient", "GetServerFarmOperation", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.ServerFarmsClient", "GetServerFarmOperation", resp, "Failure sending request")
		return
	}

	result, err = client.GetServerFarmOperationResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ServerFarmsClient", "GetServerFarmOperation", resp, "Failure responding to request")
	}
...
func (client ServerFarmsClient) GetServerFarms(resourceGroupName string) (result ServerFarmCollection, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ServerFarmsClient", "GetServerFarms", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.ServerFarmsClient", "GetServerFarms", resp, "Failure sending request")
		return
	}

	result, err = client.GetServerFarmsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ServerFarmsClient", "GetServerFarms", resp, "Failure responding to request")
	}
...
func (client ServerFarmsClient) GetServerFarmsNextResults(lastResults ServerFarmCollection) (result ServerFarmCollection, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "service.ServerFarmsClient", "GetServerFarms", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "service.ServerFarmsClient", "GetServerFarms", resp, "Failure sending next results request")
	}

	result, err = client.GetServerFarmsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ServerFarmsClient", "GetServerFarms", resp, "Failure responding to next results request")
	}
...
func (client ServerFarmsClient) GetServerFarmSites(resourceGroupName string, name string, skipToken string, filter string, top string) (result SiteCollection, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ServerFarmsClient", "GetServerFarmSites", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.ServerFarmsClient", "GetServerFarmSites", resp, "Failure sending request")
		return
	}

	result, err = client.GetServerFarmSitesResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ServerFarmsClient", "GetServerFarmSites", resp, "Failure responding to request")
	}
...
func (client ServerFarmsClient) GetServerFarmSitesNextResults(lastResults SiteCollection) (result SiteCollection, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "service.ServerFarmsClient", "GetServerFarmSites", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "service.ServerFarmsClient", "GetServerFarmSites", resp, "Failure sending next results request")
	}

	result, err = client.GetServerFarmSitesResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ServerFarmsClient", "GetServerFarmSites", resp, "Failure responding to next results request")
	}
...
func (client ServerFarmsClient) GetServerFarmVnetGateway(resourceGroupName string, name string, vnetName string, gatewayName string) (result VnetGateway, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ServerFarmsClient", "GetServerFarmVnetGateway", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.ServerFarmsClient", "GetServerFarmVnetGateway", resp, "Failure sending request")
		return
	}

	result, err = client.GetServerFarmVnetGatewayResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ServerFarmsClient", "GetServerFarmVnetGateway", resp, "Failure responding to request")
	}
...
func (client ServerFarmsClient) GetVnetFromServerFarm(resourceGroupName string, name string, vnetName string) (result VnetInfo, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ServerFarmsClient", "GetVnetFromServerFarm", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.ServerFarmsClient", "GetVnetFromServerFarm", resp, "Failure sending request")
		return
	}

	result, err = client.GetVnetFromServerFarmResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ServerFarmsClient", "GetVnetFromServerFarm", resp, "Failure responding to request")
	}
...
func (client ServerFarmsClient) GetVnetsForServerFarm(resourceGroupName string, name string) (result ListVnetInfo, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ServerFarmsClient", "GetVnetsForServerFarm", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.ServerFarmsClient", "GetVnetsForServerFarm", resp, "Failure sending request")
		return
	}

	result, err = client.GetVnetsForServerFarmResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ServerFarmsClient", "GetVnetsForServerFarm", resp, "Failure responding to request")
	}
...
func (client ServerFarmsClient) RebootWorkerForServerFarm(resourceGroupName string, name string, workerName string) (result SetObject, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ServerFarmsClient", "RebootWorkerForServerFarm", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.ServerFarmsClient", "RebootWorkerForServerFarm", resp, "Failure sending request")
		return
	}

	result, err = client.RebootWorkerForServerFarmResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ServerFarmsClient", "RebootWorkerForServerFarm", resp, "Failure responding to request")
	}
...
func (client ServerFarmsClient) RestartSitesForServerFarm(resourceGroupName string, name string, softRestart *bool) (result SetObject, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ServerFarmsClient", "RestartSitesForServerFarm", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.ServerFarmsClient", "RestartSitesForServerFarm", resp, "Failure sending request")
		return
	}

	result, err = client.RestartSitesForServerFarmResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ServerFarmsClient", "RestartSitesForServerFarm", resp, "Failure responding to request")
	}
...
func (client ServerFarmsClient) UpdateServerFarmVnetGateway(resourceGroupName string, name string, vnetName string, gatewayName string, connectionEnvelope VnetGateway) (result VnetGateway, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ServerFarmsClient", "UpdateServerFarmVnetGateway", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.ServerFarmsClient", "UpdateServerFarmVnetGateway", resp, "Failure sending request")
		return
	}

	result, err = client.UpdateServerFarmVnetGatewayResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ServerFarmsClient", "UpdateServerFarmVnetGateway", resp, "Failure responding to request")
	}
...
func (client ServerFarmsClient) UpdateVnetRoute(resourceGroupName string, name string, vnetName string, routeName string, route VnetRoute) (result VnetRoute, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ServerFarmsClient", "UpdateVnetRoute", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.ServerFarmsClient", "UpdateVnetRoute", resp, "Failure sending request")
		return
	}

	result, err = client.UpdateVnetRouteResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.ServerFarmsClient", "UpdateVnetRoute", resp, "Failure responding to request")
	}
