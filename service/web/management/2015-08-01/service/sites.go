...
// SitesClient is the use these APIs to manage Azure Websites resources through
...
func (client SitesClient) AddSitePremierAddOn(resourceGroupName string, name string, premierAddOnName string, premierAddOn PremierAddOnRequest) (result SetObject, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "AddSitePremierAddOn", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "service.SitesClient", "AddSitePremierAddOn", resp, "Failure sending request")
		return
	}

	result, err = client.AddSitePremierAddOnResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "AddSitePremierAddOn", resp, "Failure responding to request")
	}
...
func (client SitesClient) AddSitePremierAddOnSlot(resourceGroupName string, name string, premierAddOnName string, premierAddOn PremierAddOnRequest, slot string) (result SetObject, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "AddSitePremierAddOnSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "AddSitePremierAddOnSlot", resp, "Failure sending request")
		return
	}

	result, err = client.AddSitePremierAddOnSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "AddSitePremierAddOnSlot", resp, "Failure responding to request")
	}
...
// slotSwapEntity is request body that contains the target slot name. Settings
// from that slot will be applied on the source slot slot is name of the source
...
func (client SitesClient) ApplySlotConfigSlot(resourceGroupName string, name string, slotSwapEntity CsmSlotEntity, slot string) (result SetObject, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "ApplySlotConfigSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "ApplySlotConfigSlot", resp, "Failure sending request")
		return
	}

	result, err = client.ApplySlotConfigSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "ApplySlotConfigSlot", resp, "Failure responding to request")
	}
...
// resourceGroupName is name of resource group name is name of web app
// slotSwapEntity is request body that contains the target slot name. Settings
// from that slot will be applied on the source slot
func (client SitesClient) ApplySlotConfigToProduction(resourceGroupName string, name string, slotSwapEntity CsmSlotEntity) (result SetObject, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "ApplySlotConfigToProduction", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "ApplySlotConfigToProduction", resp, "Failure sending request")
		return
	}

	result, err = client.ApplySlotConfigToProductionResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "ApplySlotConfigToProduction", resp, "Failure responding to request")
	}
...
func (client SitesClient) BackupSite(resourceGroupName string, name string, request BackupRequest) (result BackupItem, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "BackupSite", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "BackupSite", resp, "Failure sending request")
		return
	}

	result, err = client.BackupSiteResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "BackupSite", resp, "Failure responding to request")
	}
...
func (client SitesClient) BackupSiteSlot(resourceGroupName string, name string, request BackupRequest, slot string) (result BackupItem, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "BackupSiteSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "BackupSiteSlot", resp, "Failure sending request")
		return
	}

	result, err = client.BackupSiteSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "BackupSiteSlot", resp, "Failure responding to request")
	}
...
//
// resourceGroupName is name of resource group name is name of web app ID is id
// of the deployment deployment is details of deployment
func (client SitesClient) CreateDeployment(resourceGroupName string, name string, ID string, deployment Deployment) (result Deployment, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "CreateDeployment", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "CreateDeployment", resp, "Failure sending request")
		return
	}

	result, err = client.CreateDeploymentResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "CreateDeployment", resp, "Failure responding to request")
	}
...
//
// resourceGroupName is name of resource group name is name of web app ID is id
// of the deployment slot is name of web app slot. If not specified then will
// default to production slot. deployment is details of deployment
func (client SitesClient) CreateDeploymentSlot(resourceGroupName string, name string, ID string, slot string, deployment Deployment) (result Deployment, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "CreateDeploymentSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "CreateDeploymentSlot", resp, "Failure sending request")
		return
	}

	result, err = client.CreateDeploymentSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "CreateDeploymentSlot", resp, "Failure responding to request")
	}
...
//
// resourceGroupName is name of resource group name is name of web app ID is id
// of the deployment instanceID is id of web app instance deployment is details
// of deployment
func (client SitesClient) CreateInstanceDeployment(resourceGroupName string, name string, ID string, instanceID string, deployment Deployment) (result Deployment, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "CreateInstanceDeployment", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "CreateInstanceDeployment", resp, "Failure sending request")
		return
	}

	result, err = client.CreateInstanceDeploymentResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "CreateInstanceDeployment", resp, "Failure responding to request")
	}
...
// resourceGroupName is name of resource group name is name of web app ID is id
// of the deployment slot is name of web app slot. If not specified then will
// default to production slot. instanceID is id of web app instance deployment
// is details of deployment
func (client SitesClient) CreateInstanceDeploymentSlot(resourceGroupName string, name string, ID string, slot string, instanceID string, deployment Deployment) (result Deployment, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "CreateInstanceDeploymentSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "CreateInstanceDeploymentSlot", resp, "Failure sending request")
		return
	}

	result, err = client.CreateInstanceDeploymentSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "CreateInstanceDeploymentSlot", resp, "Failure responding to request")
	}
...
// siteEnvelope is details of web app if it exists already skipDNSRegistration
// is if true web app hostname is not registered with DNS on creation. This
// parameter is
...
func (client SitesClient) CreateOrUpdateSite(resourceGroupName string, name string, siteEnvelope Site, skipDNSRegistration string, skipCustomDomainVerification string, forceDNSRegistration string, TTLInSeconds string, cancel <-chan struct{}) (<-chan Site, <-chan error) {
	...
	go func() {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.SitesClient", "CreateOrUpdateSite", nil, "Failure preparing request")
			return
		}
		...
		if err != nil {
			result.Response = autorest.Response{Response: resp}
			err = autorest.NewErrorWithError(err, "service.SitesClient", "CreateOrUpdateSite", resp, "Failure sending request")
			return
		}

		result, err = client.CreateOrUpdateSiteResponder(resp)
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.SitesClient", "CreateOrUpdateSite", resp, "Failure responding to request")
		}
	}()
...
func (client SitesClient) CreateOrUpdateSiteConfig(resourceGroupName string, name string, siteConfig SiteConfig) (result SiteConfig, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "CreateOrUpdateSiteConfig", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "CreateOrUpdateSiteConfig", resp, "Failure sending request")
		return
	}

	result, err = client.CreateOrUpdateSiteConfigResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "CreateOrUpdateSiteConfig", resp, "Failure responding to request")
	}
...
// resourceGroupName is name of resource group name is name of web app
// siteConfig is request body that contains the configuraiton setting for the
// web app slot is name of web app slot. If not specified then will default to
// production slot.
func (client SitesClient) CreateOrUpdateSiteConfigSlot(resourceGroupName string, name string, siteConfig SiteConfig, slot string) (result SiteConfig, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "CreateOrUpdateSiteConfigSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "CreateOrUpdateSiteConfigSlot", resp, "Failure sending request")
		return
	}

	result, err = client.CreateOrUpdateSiteConfigSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "CreateOrUpdateSiteConfigSlot", resp, "Failure responding to request")
	}
...
// binding request.
//
// resourceGroupName is name of resource group name is name of web app hostName
// is name of host hostNameBinding is host name binding information
func (client SitesClient) CreateOrUpdateSiteHostNameBinding(resourceGroupName string, name string, hostName string, hostNameBinding HostNameBinding) (result HostNameBinding, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "CreateOrUpdateSiteHostNameBinding", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "CreateOrUpdateSiteHostNameBinding", resp, "Failure sending request")
		return
	}

	result, err = client.CreateOrUpdateSiteHostNameBindingResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "CreateOrUpdateSiteHostNameBinding", resp, "Failure responding to request")
	}
...
//
// resourceGroupName is name of resource group name is name of web app hostName
// is name of host hostNameBinding is host name binding information slot is
...
func (client SitesClient) CreateOrUpdateSiteHostNameBindingSlot(resourceGroupName string, name string, hostName string, hostNameBinding HostNameBinding, slot string) (result HostNameBinding, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "CreateOrUpdateSiteHostNameBindingSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "CreateOrUpdateSiteHostNameBindingSlot", resp, "Failure sending request")
		return
	}

	result, err = client.CreateOrUpdateSiteHostNameBindingSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "CreateOrUpdateSiteHostNameBindingSlot", resp, "Failure responding to request")
	}
...
// entityName is the name by which the Hybrid Connection is identified
...
func (client SitesClient) CreateOrUpdateSiteRelayServiceConnection(resourceGroupName string, name string, entityName string, connectionEnvelope RelayServiceConnectionEntity) (result RelayServiceConnectionEntity, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "CreateOrUpdateSiteRelayServiceConnection", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "CreateOrUpdateSiteRelayServiceConnection", resp, "Failure sending request")
		return
	}

	result, err = client.CreateOrUpdateSiteRelayServiceConnectionResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "CreateOrUpdateSiteRelayServiceConnection", resp, "Failure responding to request")
	}
...
// CreateOrUpdateSiteRelayServiceConnectionSlot sends the create or update site
// relay service connection slot request.
//
// resourceGroupName is the resource group name name is the name of the web app
// entityName is the name by which the Hybrid Connection is identified
// connectionEnvelope is the details of the Hybrid Connection slot is the name
// of the slot for the web app.
func (client SitesClient) CreateOrUpdateSiteRelayServiceConnectionSlot(resourceGroupName string, name string, entityName string, connectionEnvelope RelayServiceConnectionEntity, slot string) (result RelayServiceConnectionEntity, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "CreateOrUpdateSiteRelayServiceConnectionSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "CreateOrUpdateSiteRelayServiceConnectionSlot", resp, "Failure sending request")
		return
	}

	result, err = client.CreateOrUpdateSiteRelayServiceConnectionSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "CreateOrUpdateSiteRelayServiceConnectionSlot", resp, "Failure responding to request")
	}
...
//
// resourceGroupName is name of the resource group name is name of the web app
// siteEnvelope is details of web app if it exists already slot is name of web
...
func (client SitesClient) CreateOrUpdateSiteSlot(resourceGroupName string, name string, siteEnvelope Site, slot string, skipDNSRegistration string, skipCustomDomainVerification string, forceDNSRegistration string, TTLInSeconds string, cancel <-chan struct{}) (<-chan Site, <-chan error) {
	...
	go func() {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.SitesClient", "CreateOrUpdateSiteSlot", nil, "Failure preparing request")
			return
		}
		...
		if err != nil {
			result.Response = autorest.Response{Response: resp}
			err = autorest.NewErrorWithError(err, "service.SitesClient", "CreateOrUpdateSiteSlot", resp, "Failure sending request")
			return
		}

		result, err = client.CreateOrUpdateSiteSlotResponder(resp)
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.SitesClient", "CreateOrUpdateSiteSlot", resp, "Failure responding to request")
		}
	}()
	return resultChan, errChan
}
...
func (client SitesClient) CreateOrUpdateSiteSourceControl(resourceGroupName string, name string, siteSourceControl SiteSourceControl) (result SiteSourceControl, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "CreateOrUpdateSiteSourceControl", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "CreateOrUpdateSiteSourceControl", resp, "Failure sending request")
		return
	}

	result, err = client.CreateOrUpdateSiteSourceControlResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "CreateOrUpdateSiteSourceControl", resp, "Failure responding to request")
	}
...
// resourceGroupName is name of resource group name is name of web app
// siteSourceControl is request body that contains the source control
// parameters slot is name of web app slot. If not specified then will default
// to production slot.
func (client SitesClient) CreateOrUpdateSiteSourceControlSlot(resourceGroupName string, name string, siteSourceControl SiteSourceControl, slot string) (result SiteSourceControl, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "CreateOrUpdateSiteSourceControlSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "CreateOrUpdateSiteSourceControlSlot", resp, "Failure sending request")
		return
	}

	result, err = client.CreateOrUpdateSiteSourceControlSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "CreateOrUpdateSiteSourceControlSlot", resp, "Failure responding to request")
	}
...
//
// resourceGroupName is the resource group name name is the name of the web app
// vnetName is the name of the Virtual Network connectionEnvelope is the
...
func (client SitesClient) CreateOrUpdateSiteVNETConnection(resourceGroupName string, name string, vnetName string, connectionEnvelope VnetInfo) (result VnetInfo, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "CreateOrUpdateSiteVNETConnection", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "CreateOrUpdateSiteVNETConnection", resp, "Failure sending request")
		return
	}

	result, err = client.CreateOrUpdateSiteVNETConnectionResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "CreateOrUpdateSiteVNETConnection", resp, "Failure responding to request")
	}
...
// CreateOrUpdateSiteVNETConnectionGateway sends the create or update site vnet
// connection gateway request.
//
// resourceGroupName is the resource group name name is the name of the web app
// vnetName is the name of the Virtual Network gatewayName is the name of the
// gateway. The only gateway that exists presently is "primary"
...
func (client SitesClient) CreateOrUpdateSiteVNETConnectionGateway(resourceGroupName string, name string, vnetName string, gatewayName string, connectionEnvelope VnetGateway) (result VnetGateway, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "CreateOrUpdateSiteVNETConnectionGateway", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "CreateOrUpdateSiteVNETConnectionGateway", resp, "Failure sending request")
		return
	}

	result, err = client.CreateOrUpdateSiteVNETConnectionGatewayResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "CreateOrUpdateSiteVNETConnectionGateway", resp, "Failure responding to request")
	}
...
func (client SitesClient) CreateOrUpdateSiteVNETConnectionGatewaySlot(resourceGroupName string, name string, vnetName string, gatewayName string, connectionEnvelope VnetGateway, slot string) (result VnetGateway, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "CreateOrUpdateSiteVNETConnectionGatewaySlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "CreateOrUpdateSiteVNETConnectionGatewaySlot", resp, "Failure sending request")
		return
	}

	result, err = client.CreateOrUpdateSiteVNETConnectionGatewaySlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "CreateOrUpdateSiteVNETConnectionGatewaySlot", resp, "Failure responding to request")
	}
...
func (client SitesClient) CreateOrUpdateSiteVNETConnectionSlot(resourceGroupName string, name string, vnetName string, connectionEnvelope VnetInfo, slot string) (result VnetInfo, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "CreateOrUpdateSiteVNETConnectionSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "CreateOrUpdateSiteVNETConnectionSlot", resp, "Failure sending request")
		return
	}

	result, err = client.CreateOrUpdateSiteVNETConnectionSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "CreateOrUpdateSiteVNETConnectionSlot", resp, "Failure responding to request")
	}
...
//
// resourceGroupName is name of resource group name is name of web app backupID
// is id of backup
func (client SitesClient) DeleteBackup(resourceGroupName string, name string, backupID string) (result BackupItem, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "DeleteBackup", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "DeleteBackup", resp, "Failure sending request")
		return
	}

	result, err = client.DeleteBackupResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "DeleteBackup", resp, "Failure responding to request")
	}
...
//
// resourceGroupName is name of resource group name is name of web app backupID
// is id of backup slot is name of web app slot. If not specified then will
...
func (client SitesClient) DeleteBackupSlot(resourceGroupName string, name string, backupID string, slot string) (result BackupItem, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "DeleteBackupSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "DeleteBackupSlot", resp, "Failure sending request")
		return
	}

	result, err = client.DeleteBackupSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "DeleteBackupSlot", resp, "Failure responding to request")
	}
...
func (client SitesClient) DeleteDeployment(resourceGroupName string, name string, ID string) (result SetObject, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "DeleteDeployment", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "DeleteDeployment", resp, "Failure sending request")
		return
	}

	result, err = client.DeleteDeploymentResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "DeleteDeployment", resp, "Failure responding to request")
	}
...
func (client SitesClient) DeleteDeploymentSlot(resourceGroupName string, name string, ID string, slot string) (result SetObject, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "DeleteDeploymentSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "DeleteDeploymentSlot", resp, "Failure sending request")
		return
	}

	result, err = client.DeleteDeploymentSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "DeleteDeploymentSlot", resp, "Failure responding to request")
	}
...
//
// resourceGroupName is name of resource group name is name of web app ID is id
// of the deployment instanceID is id of web app instance
func (client SitesClient) DeleteInstanceDeployment(resourceGroupName string, name string, ID string, instanceID string) (result SetObject, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "DeleteInstanceDeployment", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "DeleteInstanceDeployment", resp, "Failure sending request")
		return
	}

	result, err = client.DeleteInstanceDeploymentResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "DeleteInstanceDeployment", resp, "Failure responding to request")
	}
...
// resourceGroupName is name of resource group name is name of web app ID is id
// of the deployment slot is name of web app slot. If not specified then will
// default to production slot. instanceID is id of web app instance
func (client SitesClient) DeleteInstanceDeploymentSlot(resourceGroupName string, name string, ID string, slot string, instanceID string) (result SetObject, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "DeleteInstanceDeploymentSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "DeleteInstanceDeploymentSlot", resp, "Failure sending request")
		return
	}

	result, err = client.DeleteInstanceDeploymentSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "DeleteInstanceDeploymentSlot", resp, "Failure responding to request")
	}
...
// deleteEmptyServerFarm is if true and App Service Plan is empty after web app
// deletion, App Service Plan is also deleted skipDNSRegistration is if true,
// DNS registration is skipped deleteAllSlots is if true, all slots associated
...
func (client SitesClient) DeleteSite(resourceGroupName string, name string, deleteMetrics string, deleteEmptyServerFarm string, skipDNSRegistration string, deleteAllSlots string) (result SetObject, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "DeleteSite", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "DeleteSite", resp, "Failure sending request")
		return
	}

	result, err = client.DeleteSiteResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "DeleteSite", resp, "Failure responding to request")
	}
...
func (client SitesClient) DeleteSiteHostNameBinding(resourceGroupName string, name string, hostName string) (result SetObject, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "DeleteSiteHostNameBinding", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "DeleteSiteHostNameBinding", resp, "Failure sending request")
		return
	}

	result, err = client.DeleteSiteHostNameBindingResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "DeleteSiteHostNameBinding", resp, "Failure responding to request")
	}
...
func (client SitesClient) DeleteSiteHostNameBindingSlot(resourceGroupName string, name string, slot string, hostName string) (result SetObject, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "DeleteSiteHostNameBindingSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "DeleteSiteHostNameBindingSlot", resp, "Failure sending request")
		return
	}

	result, err = client.DeleteSiteHostNameBindingSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "DeleteSiteHostNameBindingSlot", resp, "Failure responding to request")
	}
...
func (client SitesClient) DeleteSitePremierAddOn(resourceGroupName string, name string, premierAddOnName string) (result SetObject, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "DeleteSitePremierAddOn", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "DeleteSitePremierAddOn", resp, "Failure sending request")
		return
	}

	result, err = client.DeleteSitePremierAddOnResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "DeleteSitePremierAddOn", resp, "Failure responding to request")
	}
...
func (client SitesClient) DeleteSitePremierAddOnSlot(resourceGroupName string, name string, premierAddOnName string, slot string) (result SetObject, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "DeleteSitePremierAddOnSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "DeleteSitePremierAddOnSlot", resp, "Failure sending request")
		return
	}

	result, err = client.DeleteSitePremierAddOnSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "DeleteSitePremierAddOnSlot", resp, "Failure responding to request")
	}
...
func (client SitesClient) DeleteSiteRelayServiceConnection(resourceGroupName string, name string, entityName string) (result SetObject, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "DeleteSiteRelayServiceConnection", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "DeleteSiteRelayServiceConnection", resp, "Failure sending request")
		return
	}

	result, err = client.DeleteSiteRelayServiceConnectionResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "DeleteSiteRelayServiceConnection", resp, "Failure responding to request")
	}
...
//
// resourceGroupName is the resource group name name is the name of the web app
// entityName is the name by which the Hybrid Connection is identified slot is
...
func (client SitesClient) DeleteSiteRelayServiceConnectionSlot(resourceGroupName string, name string, entityName string, slot string) (result SetObject, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "DeleteSiteRelayServiceConnectionSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "DeleteSiteRelayServiceConnectionSlot", resp, "Failure sending request")
		return
	}

	result, err = client.DeleteSiteRelayServiceConnectionSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "DeleteSiteRelayServiceConnectionSlot", resp, "Failure responding to request")
	}
...
func (client SitesClient) DeleteSiteSlot(resourceGroupName string, name string, slot string, deleteMetrics string, deleteEmptyServerFarm string, skipDNSRegistration string, deleteAllSlots string) (result SetObject, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "DeleteSiteSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "DeleteSiteSlot", resp, "Failure sending request")
		return
	}

	result, err = client.DeleteSiteSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "DeleteSiteSlot", resp, "Failure responding to request")
	}
...
func (client SitesClient) DeleteSiteSourceControl(resourceGroupName string, name string) (result SetObject, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "DeleteSiteSourceControl", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "DeleteSiteSourceControl", resp, "Failure sending request")
		return
	}

	result, err = client.DeleteSiteSourceControlResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "DeleteSiteSourceControl", resp, "Failure responding to request")
	}
...
func (client SitesClient) DeleteSiteSourceControlSlot(resourceGroupName string, name string, slot string) (result SetObject, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "DeleteSiteSourceControlSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "DeleteSiteSourceControlSlot", resp, "Failure sending request")
		return
	}

	result, err = client.DeleteSiteSourceControlSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "DeleteSiteSourceControlSlot", resp, "Failure responding to request")
	}
...
func (client SitesClient) DeleteSiteVNETConnection(resourceGroupName string, name string, vnetName string) (result SetObject, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "DeleteSiteVNETConnection", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "DeleteSiteVNETConnection", resp, "Failure sending request")
		return
	}

	result, err = client.DeleteSiteVNETConnectionResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "DeleteSiteVNETConnection", resp, "Failure responding to request")
	}
...
//
// resourceGroupName is the resource group name name is the name of the web app
// vnetName is the name of the Virtual Network slot is the name of the slot for
// this web app.
func (client SitesClient) DeleteSiteVNETConnectionSlot(resourceGroupName string, name string, vnetName string, slot string) (result SetObject, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "DeleteSiteVNETConnectionSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "DeleteSiteVNETConnectionSlot", resp, "Failure sending request")
		return
	}

	result, err = client.DeleteSiteVNETConnectionSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "DeleteSiteVNETConnectionSlot", resp, "Failure responding to request")
	}
...
func (client SitesClient) DiscoverSiteRestore(resourceGroupName string, name string, request RestoreRequest) (result RestoreRequest, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "DiscoverSiteRestore", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "DiscoverSiteRestore", resp, "Failure sending request")
		return
	}

	result, err = client.DiscoverSiteRestoreResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "DiscoverSiteRestore", resp, "Failure responding to request")
	}
...
func (client SitesClient) DiscoverSiteRestoreSlot(resourceGroupName string, name string, request RestoreRequest, slot string) (result RestoreRequest, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "DiscoverSiteRestoreSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "DiscoverSiteRestoreSlot", resp, "Failure sending request")
		return
	}

	result, err = client.DiscoverSiteRestoreSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "DiscoverSiteRestoreSlot", resp, "Failure responding to request")
	}
...
func (client SitesClient) GenerateNewSitePublishingPassword(resourceGroupName string, name string) (result SetObject, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GenerateNewSitePublishingPassword", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GenerateNewSitePublishingPassword", resp, "Failure sending request")
		return
	}

	result, err = client.GenerateNewSitePublishingPasswordResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GenerateNewSitePublishingPassword", resp, "Failure responding to request")
	}
...
// GenerateNewSitePublishingPasswordSlot sends the generate new site publishing
// password slot request.
//
// resourceGroupName is name of resource group name is name of web app slot is
// name of web app slot. If not specified then will default to production slot.
func (client SitesClient) GenerateNewSitePublishingPasswordSlot(resourceGroupName string, name string, slot string) (result SetObject, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GenerateNewSitePublishingPasswordSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GenerateNewSitePublishingPasswordSlot", resp, "Failure sending request")
		return
	}

	result, err = client.GenerateNewSitePublishingPasswordSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GenerateNewSitePublishingPasswordSlot", resp, "Failure responding to request")
	}
...
func (client SitesClient) GetDeletedSites(resourceGroupName string, propertiesToInclude string, includeSiteTypes string) (result DeletedSiteCollection, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetDeletedSites", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetDeletedSites", resp, "Failure sending request")
		return
	}

	result, err = client.GetDeletedSitesResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetDeletedSites", resp, "Failure responding to request")
	}
...
func (client SitesClient) GetDeletedSitesNextResults(lastResults DeletedSiteCollection) (result DeletedSiteCollection, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "service.SitesClient", "GetDeletedSites", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "service.SitesClient", "GetDeletedSites", resp, "Failure sending next results request")
	}

	result, err = client.GetDeletedSitesResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetDeletedSites", resp, "Failure responding to next results request")
	}
...
func (client SitesClient) GetDeployment(resourceGroupName string, name string, ID string) (result Deployment, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetDeployment", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetDeployment", resp, "Failure sending request")
		return
	}

	result, err = client.GetDeploymentResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetDeployment", resp, "Failure responding to request")
	}
...
func (client SitesClient) GetDeployments(resourceGroupName string, name string) (result DeploymentCollection, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetDeployments", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetDeployments", resp, "Failure sending request")
		return
	}

	result, err = client.GetDeploymentsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetDeployments", resp, "Failure responding to request")
	}
...
func (client SitesClient) GetDeploymentsNextResults(lastResults DeploymentCollection) (result DeploymentCollection, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "service.SitesClient", "GetDeployments", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "service.SitesClient", "GetDeployments", resp, "Failure sending next results request")
	}

	result, err = client.GetDeploymentsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetDeployments", resp, "Failure responding to next results request")
	}
...
func (client SitesClient) GetDeploymentSlot(resourceGroupName string, name string, ID string, slot string) (result Deployment, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetDeploymentSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetDeploymentSlot", resp, "Failure sending request")
		return
	}

	result, err = client.GetDeploymentSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetDeploymentSlot", resp, "Failure responding to request")
	}
...
func (client SitesClient) GetDeploymentsSlot(resourceGroupName string, name string, slot string) (result DeploymentCollection, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetDeploymentsSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetDeploymentsSlot", resp, "Failure sending request")
		return
	}

	result, err = client.GetDeploymentsSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetDeploymentsSlot", resp, "Failure responding to request")
	}
...
func (client SitesClient) GetDeploymentsSlotNextResults(lastResults DeploymentCollection) (result DeploymentCollection, err error) {
	req, err := lastResults.DeploymentCollectionPreparer()
	if err != nil {
		return result, autorest.NewErrorWithError(err, "service.SitesClient", "GetDeploymentsSlot", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "service.SitesClient", "GetDeploymentsSlot", resp, "Failure sending next results request")
	}

	result, err = client.GetDeploymentsSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetDeploymentsSlot", resp, "Failure responding to next results request")
	}
...
func (client SitesClient) GetInstanceDeployment(resourceGroupName string, name string, ID string, instanceID string) (result Deployment, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetInstanceDeployment", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetInstanceDeployment", resp, "Failure sending request")
		return
	}

	result, err = client.GetInstanceDeploymentResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetInstanceDeployment", resp, "Failure responding to request")
	}
...
func (client SitesClient) GetInstanceDeployments(resourceGroupName string, name string, instanceID string) (result DeploymentCollection, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetInstanceDeployments", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetInstanceDeployments", resp, "Failure sending request")
		return
	}

	result, err = client.GetInstanceDeploymentsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetInstanceDeployments", resp, "Failure responding to request")
	}
...
func (client SitesClient) GetInstanceDeploymentsNextResults(lastResults DeploymentCollection) (result DeploymentCollection, err error) {
	req, err := lastResults.DeploymentCollectionPreparer()
	if err != nil {
		return result, autorest.NewErrorWithError(err, "service.SitesClient", "GetInstanceDeployments", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "service.SitesClient", "GetInstanceDeployments", resp, "Failure sending next results request")
	}

	result, err = client.GetInstanceDeploymentsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetInstanceDeployments", resp, "Failure responding to next results request")
	}
...
func (client SitesClient) GetInstanceDeploymentSlot(resourceGroupName string, name string, ID string, slot string, instanceID string) (result Deployment, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetInstanceDeploymentSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetInstanceDeploymentSlot", resp, "Failure sending request")
		return
	}

	result, err = client.GetInstanceDeploymentSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetInstanceDeploymentSlot", resp, "Failure responding to request")
	}
...
func (client SitesClient) GetInstanceDeploymentsSlot(resourceGroupName string, name string, slot string, instanceID string) (result DeploymentCollection, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetInstanceDeploymentsSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetInstanceDeploymentsSlot", resp, "Failure sending request")
		return
	}

	result, err = client.GetInstanceDeploymentsSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetInstanceDeploymentsSlot", resp, "Failure responding to request")
	}
...
func (client SitesClient) GetInstanceDeploymentsSlotNextResults(lastResults DeploymentCollection) (result DeploymentCollection, err error) {
	req, err := lastResults.DeploymentCollectionPreparer()
	if err != nil {
		return result, autorest.NewErrorWithError(err, "service.SitesClient", "GetInstanceDeploymentsSlot", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "service.SitesClient", "GetInstanceDeploymentsSlot", resp, "Failure sending next results request")
	}

	result, err = client.GetInstanceDeploymentsSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetInstanceDeploymentsSlot", resp, "Failure responding to next results request")
	}
...
func (client SitesClient) GetSite(resourceGroupName string, name string, propertiesToInclude string) (result Site, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSite", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSite", resp, "Failure sending request")
		return
	}

	result, err = client.GetSiteResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSite", resp, "Failure responding to request")
	}
...
func (client SitesClient) GetSiteBackupConfiguration(resourceGroupName string, name string) (result BackupRequest, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteBackupConfiguration", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteBackupConfiguration", resp, "Failure sending request")
		return
	}

	result, err = client.GetSiteBackupConfigurationResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteBackupConfiguration", resp, "Failure responding to request")
	}
...
func (client SitesClient) GetSiteBackupConfigurationSlot(resourceGroupName string, name string, slot string) (result BackupRequest, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteBackupConfigurationSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteBackupConfigurationSlot", resp, "Failure sending request")
		return
	}

	result, err = client.GetSiteBackupConfigurationSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteBackupConfigurationSlot", resp, "Failure responding to request")
	}
...
func (client SitesClient) GetSiteBackupStatus(resourceGroupName string, name string, backupID string) (result BackupItem, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteBackupStatus", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteBackupStatus", resp, "Failure sending request")
		return
	}

	result, err = client.GetSiteBackupStatusResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteBackupStatus", resp, "Failure responding to request")
	}
...
//
// resourceGroupName is name of resource group name is name of web app backupID
// is id of backup request is information on backup request
func (client SitesClient) GetSiteBackupStatusSecrets(resourceGroupName string, name string, backupID string, request BackupRequest) (result BackupItem, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteBackupStatusSecrets", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteBackupStatusSecrets", resp, "Failure sending request")
		return
	}

	result, err = client.GetSiteBackupStatusSecretsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteBackupStatusSecrets", resp, "Failure responding to request")
	}
...
// GetSiteBackupStatusSecretsSlot sends the get site backup status secrets slot
// request.
//
// resourceGroupName is name of resource group name is name of web app backupID
// is id of backup request is information on backup request slot is name of web
// app slot. If not specified then will default to production slot.
func (client SitesClient) GetSiteBackupStatusSecretsSlot(resourceGroupName string, name string, backupID string, request BackupRequest, slot string) (result BackupItem, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteBackupStatusSecretsSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteBackupStatusSecretsSlot", resp, "Failure sending request")
		return
	}

	result, err = client.GetSiteBackupStatusSecretsSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteBackupStatusSecretsSlot", resp, "Failure responding to request")
	}
...
func (client SitesClient) GetSiteBackupStatusSlot(resourceGroupName string, name string, backupID string, slot string) (result BackupItem, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteBackupStatusSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteBackupStatusSlot", resp, "Failure sending request")
		return
	}

	result, err = client.GetSiteBackupStatusSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteBackupStatusSlot", resp, "Failure responding to request")
	}
...
func (client SitesClient) GetSiteConfig(resourceGroupName string, name string) (result SiteConfig, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteConfig", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteConfig", resp, "Failure sending request")
		return
	}

	result, err = client.GetSiteConfigResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteConfig", resp, "Failure responding to request")
	}
...
func (client SitesClient) GetSiteConfigSlot(resourceGroupName string, name string, slot string) (result SiteConfig, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteConfigSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteConfigSlot", resp, "Failure sending request")
		return
	}

	result, err = client.GetSiteConfigSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteConfigSlot", resp, "Failure responding to request")
	}
...
func (client SitesClient) GetSiteHostNameBinding(resourceGroupName string, name string, hostName string) (result HostNameBinding, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteHostNameBinding", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteHostNameBinding", resp, "Failure sending request")
		return
	}

	result, err = client.GetSiteHostNameBindingResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteHostNameBinding", resp, "Failure responding to request")
	}
...
func (client SitesClient) GetSiteHostNameBindings(resourceGroupName string, name string) (result HostNameBindingCollection, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteHostNameBindings", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteHostNameBindings", resp, "Failure sending request")
		return
	}

	result, err = client.GetSiteHostNameBindingsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteHostNameBindings", resp, "Failure responding to request")
	}
...
func (client SitesClient) GetSiteHostNameBindingsNextResults(lastResults HostNameBindingCollection) (result HostNameBindingCollection, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteHostNameBindings", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteHostNameBindings", resp, "Failure sending next results request")
	}

	result, err = client.GetSiteHostNameBindingsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteHostNameBindings", resp, "Failure responding to next results request")
	}
...
func (client SitesClient) GetSiteHostNameBindingSlot(resourceGroupName string, name string, slot string, hostName string) (result HostNameBinding, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteHostNameBindingSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteHostNameBindingSlot", resp, "Failure sending request")
		return
	}

	result, err = client.GetSiteHostNameBindingSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteHostNameBindingSlot", resp, "Failure responding to request")
	}
...
func (client SitesClient) GetSiteHostNameBindingsSlot(resourceGroupName string, name string, slot string) (result HostNameBindingCollection, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteHostNameBindingsSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteHostNameBindingsSlot", resp, "Failure sending request")
		return
	}

	result, err = client.GetSiteHostNameBindingsSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteHostNameBindingsSlot", resp, "Failure responding to request")
	}
...
func (client SitesClient) GetSiteHostNameBindingsSlotNextResults(lastResults HostNameBindingCollection) (result HostNameBindingCollection, err error) {
	req, err := lastResults.HostNameBindingCollectionPreparer()
	if err != nil {
		return result, autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteHostNameBindingsSlot", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteHostNameBindingsSlot", resp, "Failure sending next results request")
	}

	result, err = client.GetSiteHostNameBindingsSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteHostNameBindingsSlot", resp, "Failure responding to next results request")
	}
...
func (client SitesClient) GetSiteInstanceIdentifiers(resourceGroupName string, name string) (result SiteInstanceCollection, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteInstanceIdentifiers", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteInstanceIdentifiers", resp, "Failure sending request")
		return
	}

	result, err = client.GetSiteInstanceIdentifiersResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteInstanceIdentifiers", resp, "Failure responding to request")
	}
...
func (client SitesClient) GetSiteInstanceIdentifiersNextResults(lastResults SiteInstanceCollection) (result SiteInstanceCollection, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteInstanceIdentifiers", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteInstanceIdentifiers", resp, "Failure sending next results request")
	}

	result, err = client.GetSiteInstanceIdentifiersResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteInstanceIdentifiers", resp, "Failure responding to next results request")
	}
...
func (client SitesClient) GetSiteInstanceIdentifiersSlot(resourceGroupName string, name string, slot string) (result SiteInstanceCollection, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteInstanceIdentifiersSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteInstanceIdentifiersSlot", resp, "Failure sending request")
		return
	}

	result, err = client.GetSiteInstanceIdentifiersSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteInstanceIdentifiersSlot", resp, "Failure responding to request")
	}
...
func (client SitesClient) GetSiteInstanceIdentifiersSlotNextResults(lastResults SiteInstanceCollection) (result SiteInstanceCollection, err error) {
	req, err := lastResults.SiteInstanceCollectionPreparer()
	if err != nil {
		return result, autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteInstanceIdentifiersSlot", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteInstanceIdentifiersSlot", resp, "Failure sending next results request")
	}

	result, err = client.GetSiteInstanceIdentifiersSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteInstanceIdentifiersSlot", resp, "Failure responding to next results request")
	}
...
func (client SitesClient) GetSiteLogsConfig(resourceGroupName string, name string) (result SiteLogsConfig, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteLogsConfig", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteLogsConfig", resp, "Failure sending request")
		return
	}

	result, err = client.GetSiteLogsConfigResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteLogsConfig", resp, "Failure responding to request")
	}
...
func (client SitesClient) GetSiteLogsConfigSlot(resourceGroupName string, name string, slot string) (result SiteLogsConfig, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteLogsConfigSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteLogsConfigSlot", resp, "Failure sending request")
		return
	}

	result, err = client.GetSiteLogsConfigSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteLogsConfigSlot", resp, "Failure responding to request")
	}
...
func (client SitesClient) GetSiteMetricDefinitions(resourceGroupName string, name string) (result MetricDefinitionCollection, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteMetricDefinitions", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteMetricDefinitions", resp, "Failure sending request")
		return
	}

	result, err = client.GetSiteMetricDefinitionsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteMetricDefinitions", resp, "Failure responding to request")
	}
...
func (client SitesClient) GetSiteMetricDefinitionsNextResults(lastResults MetricDefinitionCollection) (result MetricDefinitionCollection, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteMetricDefinitions", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteMetricDefinitions", resp, "Failure sending next results request")
	}

	result, err = client.GetSiteMetricDefinitionsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteMetricDefinitions", resp, "Failure responding to next results request")
	}
...
func (client SitesClient) GetSiteMetricDefinitionsSlot(resourceGroupName string, name string, slot string) (result MetricDefinitionCollection, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteMetricDefinitionsSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteMetricDefinitionsSlot", resp, "Failure sending request")
		return
	}

	result, err = client.GetSiteMetricDefinitionsSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteMetricDefinitionsSlot", resp, "Failure responding to request")
	}
...
func (client SitesClient) GetSiteMetricDefinitionsSlotNextResults(lastResults MetricDefinitionCollection) (result MetricDefinitionCollection, err error) {
	req, err := lastResults.MetricDefinitionCollectionPreparer()
	if err != nil {
		return result, autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteMetricDefinitionsSlot", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteMetricDefinitionsSlot", resp, "Failure sending next results request")
	}

	result, err = client.GetSiteMetricDefinitionsSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteMetricDefinitionsSlot", resp, "Failure responding to next results request")
	}
...
func (client SitesClient) GetSiteMetrics(resourceGroupName string, name string, details *bool, filter string) (result ResourceMetricCollection, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteMetrics", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteMetrics", resp, "Failure sending request")
		return
	}

	result, err = client.GetSiteMetricsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteMetrics", resp, "Failure responding to request")
	}
...
func (client SitesClient) GetSiteMetricsNextResults(lastResults ResourceMetricCollection) (result ResourceMetricCollection, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteMetrics", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteMetrics", resp, "Failure sending next results request")
	}

	result, err = client.GetSiteMetricsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteMetrics", resp, "Failure responding to next results request")
	}
...
// resourceGroupName is name of resource group name is name of web app slot is
// name of web app slot. If not specified then will default to production slot.
// details is if true, metric details are included in response filter is return
// only usages/metrics specified in the filter. Filter conforms to odata
// syntax. Example: $filter=(name.value eq 'Metric1' or name.value eq
...
func (client SitesClient) GetSiteMetricsSlot(resourceGroupName string, name string, slot string, details *bool, filter string) (result ResourceMetricCollection, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteMetricsSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteMetricsSlot", resp, "Failure sending request")
		return
	}

	result, err = client.GetSiteMetricsSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteMetricsSlot", resp, "Failure responding to request")
	}
...
func (client SitesClient) GetSiteMetricsSlotNextResults(lastResults ResourceMetricCollection) (result ResourceMetricCollection, err error) {
	req, err := lastResults.ResourceMetricCollectionPreparer()
	if err != nil {
		return result, autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteMetricsSlot", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteMetricsSlot", resp, "Failure sending next results request")
	}

	result, err = client.GetSiteMetricsSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteMetricsSlot", resp, "Failure responding to next results request")
	}
...
//
// resourceGroupName is the resource group name name is the name of the web app
// view is the type of view. This can either be "summary" or "detailed".
func (client SitesClient) GetSiteNetworkFeatures(resourceGroupName string, name string, view string) (result NetworkFeatures, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteNetworkFeatures", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteNetworkFeatures", resp, "Failure sending request")
		return
	}

	result, err = client.GetSiteNetworkFeaturesResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteNetworkFeatures", resp, "Failure responding to request")
	}
...
//
// resourceGroupName is the resource group name name is the name of the web app
// view is the type of view. This can either be "summary" or "detailed". slot
...
func (client SitesClient) GetSiteNetworkFeaturesSlot(resourceGroupName string, name string, view string, slot string) (result NetworkFeatures, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteNetworkFeaturesSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteNetworkFeaturesSlot", resp, "Failure sending request")
		return
	}

	result, err = client.GetSiteNetworkFeaturesSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteNetworkFeaturesSlot", resp, "Failure responding to request")
	}
...
func (client SitesClient) GetSiteOperation(resourceGroupName string, name string, operationID string) (result SetObject, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteOperation", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteOperation", resp, "Failure sending request")
		return
	}

	result, err = client.GetSiteOperationResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteOperation", resp, "Failure responding to request")
	}
...
func (client SitesClient) GetSiteOperationSlot(resourceGroupName string, name string, operationID string, slot string) (result SetObject, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteOperationSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteOperationSlot", resp, "Failure sending request")
		return
	}

	result, err = client.GetSiteOperationSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteOperationSlot", resp, "Failure responding to request")
	}
...
func (client SitesClient) GetSitePremierAddOn(resourceGroupName string, name string, premierAddOnName string) (result SetObject, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSitePremierAddOn", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSitePremierAddOn", resp, "Failure sending request")
		return
	}

	result, err = client.GetSitePremierAddOnResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSitePremierAddOn", resp, "Failure responding to request")
	}
...
func (client SitesClient) GetSitePremierAddOnSlot(resourceGroupName string, name string, premierAddOnName string, slot string) (result SetObject, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSitePremierAddOnSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSitePremierAddOnSlot", resp, "Failure sending request")
		return
	}

	result, err = client.GetSitePremierAddOnSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSitePremierAddOnSlot", resp, "Failure responding to request")
	}
...
func (client SitesClient) GetSiteRelayServiceConnection(resourceGroupName string, name string, entityName string) (result RelayServiceConnectionEntity, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteRelayServiceConnection", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteRelayServiceConnection", resp, "Failure sending request")
		return
	}

	result, err = client.GetSiteRelayServiceConnectionResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteRelayServiceConnection", resp, "Failure responding to request")
	}
...
func (client SitesClient) GetSiteRelayServiceConnectionSlot(resourceGroupName string, name string, entityName string, slot string) (result RelayServiceConnectionEntity, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteRelayServiceConnectionSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteRelayServiceConnectionSlot", resp, "Failure sending request")
		return
	}

	result, err = client.GetSiteRelayServiceConnectionSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteRelayServiceConnectionSlot", resp, "Failure responding to request")
	}
...
func (client SitesClient) GetSites(resourceGroupName string, propertiesToInclude string, includeSiteTypes string, includeSlots *bool) (result SiteCollection, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSites", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSites", resp, "Failure sending request")
		return
	}

	result, err = client.GetSitesResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSites", resp, "Failure responding to request")
	}
...
func (client SitesClient) GetSitesNextResults(lastResults SiteCollection) (result SiteCollection, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "service.SitesClient", "GetSites", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "service.SitesClient", "GetSites", resp, "Failure sending next results request")
	}

	result, err = client.GetSitesResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSites", resp, "Failure responding to next results request")
	}
...
func (client SitesClient) GetSiteSlot(resourceGroupName string, name string, slot string, propertiesToInclude string) (result Site, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteSlot", resp, "Failure sending request")
		return
	}

	result, err = client.GetSiteSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteSlot", resp, "Failure responding to request")
	}
...
func (client SitesClient) GetSiteSlots(resourceGroupName string, name string, propertiesToInclude string) (result SiteCollection, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteSlots", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteSlots", resp, "Failure sending request")
		return
	}

	result, err = client.GetSiteSlotsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteSlots", resp, "Failure responding to request")
	}
...
func (client SitesClient) GetSiteSlotsNextResults(lastResults SiteCollection) (result SiteCollection, err error) {
	req, err := lastResults.SiteCollectionPreparer()
	if err != nil {
		return result, autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteSlots", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteSlots", resp, "Failure sending next results request")
	}

	result, err = client.GetSiteSlotsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteSlots", resp, "Failure responding to next results request")
	}
...
func (client SitesClient) GetSiteSnapshots(resourceGroupName string, name string) (result SetObject, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteSnapshots", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteSnapshots", resp, "Failure sending request")
		return
	}

	result, err = client.GetSiteSnapshotsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteSnapshots", resp, "Failure responding to request")
	}
...
func (client SitesClient) GetSiteSnapshotsSlot(resourceGroupName string, name string, slot string) (result SetObject, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteSnapshotsSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteSnapshotsSlot", resp, "Failure sending request")
		return
	}

	result, err = client.GetSiteSnapshotsSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteSnapshotsSlot", resp, "Failure responding to request")
	}
...
func (client SitesClient) GetSiteSourceControl(resourceGroupName string, name string) (result SiteSourceControl, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteSourceControl", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteSourceControl", resp, "Failure sending request")
		return
	}

	result, err = client.GetSiteSourceControlResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteSourceControl", resp, "Failure responding to request")
	}
...
func (client SitesClient) GetSiteSourceControlSlot(resourceGroupName string, name string, slot string) (result SiteSourceControl, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteSourceControlSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteSourceControlSlot", resp, "Failure sending request")
		return
	}

	result, err = client.GetSiteSourceControlSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteSourceControlSlot", resp, "Failure responding to request")
	}
...
// is return only usages specified in the filter. Filter is specified by using
...
func (client SitesClient) GetSiteUsages(resourceGroupName string, name string, filter string) (result CsmUsageQuotaCollection, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteUsages", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteUsages", resp, "Failure sending request")
		return
	}

	result, err = client.GetSiteUsagesResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteUsages", resp, "Failure responding to request")
	}
...
func (client SitesClient) GetSiteUsagesNextResults(lastResults CsmUsageQuotaCollection) (result CsmUsageQuotaCollection, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteUsages", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteUsages", resp, "Failure sending next results request")
	}

	result, err = client.GetSiteUsagesResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteUsages", resp, "Failure responding to next results request")
	}
...
// resourceGroupName is name of resource group name is name of web app slot is
// name of web app slot. If not specified then will default to production slot.
// filter is return only usages specified in the filter. Filter is specified by
// using OData syntax. Example: $filter=(name.value eq 'Metric1' or name.value
...
func (client SitesClient) GetSiteUsagesSlot(resourceGroupName string, name string, slot string, filter string) (result CsmUsageQuotaCollection, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteUsagesSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteUsagesSlot", resp, "Failure sending request")
		return
	}

	result, err = client.GetSiteUsagesSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteUsagesSlot", resp, "Failure responding to request")
	}
...
func (client SitesClient) GetSiteUsagesSlotNextResults(lastResults CsmUsageQuotaCollection) (result CsmUsageQuotaCollection, err error) {
	req, err := lastResults.CsmUsageQuotaCollectionPreparer()
	if err != nil {
		return result, autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteUsagesSlot", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteUsagesSlot", resp, "Failure sending next results request")
	}

	result, err = client.GetSiteUsagesSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteUsagesSlot", resp, "Failure responding to next results request")
	}
...
func (client SitesClient) GetSiteVNETConnection(resourceGroupName string, name string, vnetName string) (result VnetInfo, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteVNETConnection", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteVNETConnection", resp, "Failure sending request")
		return
	}

	result, err = client.GetSiteVNETConnectionResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteVNETConnection", resp, "Failure responding to request")
	}
...
func (client SitesClient) GetSiteVNETConnections(resourceGroupName string, name string) (result ListVnetInfo, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteVNETConnections", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteVNETConnections", resp, "Failure sending request")
		return
	}

	result, err = client.GetSiteVNETConnectionsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteVNETConnections", resp, "Failure responding to request")
	}
...
func (client SitesClient) GetSiteVNETConnectionSlot(resourceGroupName string, name string, vnetName string, slot string) (result VnetInfo, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteVNETConnectionSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteVNETConnectionSlot", resp, "Failure sending request")
		return
	}

	result, err = client.GetSiteVNETConnectionSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteVNETConnectionSlot", resp, "Failure responding to request")
	}
...
func (client SitesClient) GetSiteVNETConnectionsSlot(resourceGroupName string, name string, slot string) (result ListVnetInfo, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteVNETConnectionsSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteVNETConnectionsSlot", resp, "Failure sending request")
		return
	}

	result, err = client.GetSiteVNETConnectionsSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteVNETConnectionsSlot", resp, "Failure responding to request")
	}
...
func (client SitesClient) GetSiteVnetGateway(resourceGroupName string, name string, vnetName string, gatewayName string) (result SetObject, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteVnetGateway", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteVnetGateway", resp, "Failure sending request")
		return
	}

	result, err = client.GetSiteVnetGatewayResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteVnetGateway", resp, "Failure responding to request")
	}
...
// resourceGroupName is the resource group name name is the name of the web app
// vnetName is the name of the Virtual Network gatewayName is the name of the
// gateway. The only gateway that exists presently is "primary" slot is the
...
func (client SitesClient) GetSiteVnetGatewaySlot(resourceGroupName string, name string, vnetName string, gatewayName string, slot string) (result SetObject, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteVnetGatewaySlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteVnetGatewaySlot", resp, "Failure sending request")
		return
	}

	result, err = client.GetSiteVnetGatewaySlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSiteVnetGatewaySlot", resp, "Failure responding to request")
	}
...
func (client SitesClient) GetSlotConfigNames(resourceGroupName string, name string) (result SlotConfigNamesResource, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSlotConfigNames", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSlotConfigNames", resp, "Failure sending request")
		return
	}

	result, err = client.GetSlotConfigNamesResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSlotConfigNames", resp, "Failure responding to request")
	}
...
func (client SitesClient) GetSlotsDifferencesFromProduction(resourceGroupName string, name string, slotSwapEntity CsmSlotEntity) (result SlotDifferenceCollection, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSlotsDifferencesFromProduction", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSlotsDifferencesFromProduction", resp, "Failure sending request")
		return
	}

	result, err = client.GetSlotsDifferencesFromProductionResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSlotsDifferencesFromProduction", resp, "Failure responding to request")
	}
...
func (client SitesClient) GetSlotsDifferencesFromProductionNextResults(lastResults SlotDifferenceCollection) (result SlotDifferenceCollection, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "service.SitesClient", "GetSlotsDifferencesFromProduction", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "service.SitesClient", "GetSlotsDifferencesFromProduction", resp, "Failure sending next results request")
	}

	result, err = client.GetSlotsDifferencesFromProductionResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSlotsDifferencesFromProduction", resp, "Failure responding to next results request")
	}
...
func (client SitesClient) GetSlotsDifferencesSlot(resourceGroupName string, name string, slotSwapEntity CsmSlotEntity, slot string) (result SlotDifferenceCollection, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSlotsDifferencesSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSlotsDifferencesSlot", resp, "Failure sending request")
		return
	}

	result, err = client.GetSlotsDifferencesSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSlotsDifferencesSlot", resp, "Failure responding to request")
	}
...
func (client SitesClient) GetSlotsDifferencesSlotNextResults(lastResults SlotDifferenceCollection) (result SlotDifferenceCollection, err error) {
	req, err := lastResults.SlotDifferenceCollectionPreparer()
	if err != nil {
		return result, autorest.NewErrorWithError(err, "service.SitesClient", "GetSlotsDifferencesSlot", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "service.SitesClient", "GetSlotsDifferencesSlot", resp, "Failure sending next results request")
	}

	result, err = client.GetSlotsDifferencesSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "GetSlotsDifferencesSlot", resp, "Failure responding to next results request")
	}
...
func (client SitesClient) IsSiteCloneable(resourceGroupName string, name string) (result SiteCloneability, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "IsSiteCloneable", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "IsSiteCloneable", resp, "Failure sending request")
		return
	}

	result, err = client.IsSiteCloneableResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "IsSiteCloneable", resp, "Failure responding to request")
	}
...
func (client SitesClient) IsSiteCloneableSlot(resourceGroupName string, name string, slot string) (result SiteCloneability, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "IsSiteCloneableSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "IsSiteCloneableSlot", resp, "Failure sending request")
		return
	}

	result, err = client.IsSiteCloneableSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "IsSiteCloneableSlot", resp, "Failure responding to request")
	}
...
func (client SitesClient) ListSiteAppSettings(resourceGroupName string, name string) (result StringDictionary, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "ListSiteAppSettings", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "ListSiteAppSettings", resp, "Failure sending request")
		return
	}

	result, err = client.ListSiteAppSettingsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "ListSiteAppSettings", resp, "Failure responding to request")
	}
...
func (client SitesClient) ListSiteAppSettingsSlot(resourceGroupName string, name string, slot string) (result StringDictionary, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "ListSiteAppSettingsSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "ListSiteAppSettingsSlot", resp, "Failure sending request")
		return
	}

	result, err = client.ListSiteAppSettingsSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "ListSiteAppSettingsSlot", resp, "Failure responding to request")
	}
...
func (client SitesClient) ListSiteAuthSettings(resourceGroupName string, name string) (result SiteAuthSettings, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "ListSiteAuthSettings", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "ListSiteAuthSettings", resp, "Failure sending request")
		return
	}

	result, err = client.ListSiteAuthSettingsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "ListSiteAuthSettings", resp, "Failure responding to request")
	}
...
func (client SitesClient) ListSiteAuthSettingsSlot(resourceGroupName string, name string, slot string) (result SiteAuthSettings, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "ListSiteAuthSettingsSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "ListSiteAuthSettingsSlot", resp, "Failure sending request")
		return
	}

	result, err = client.ListSiteAuthSettingsSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "ListSiteAuthSettingsSlot", resp, "Failure responding to request")
	}
...
func (client SitesClient) ListSiteBackups(resourceGroupName string, name string) (result BackupItemCollection, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "ListSiteBackups", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "ListSiteBackups", resp, "Failure sending request")
		return
	}

	result, err = client.ListSiteBackupsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "ListSiteBackups", resp, "Failure responding to request")
	}
...
func (client SitesClient) ListSiteBackupsNextResults(lastResults BackupItemCollection) (result BackupItemCollection, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "service.SitesClient", "ListSiteBackups", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "service.SitesClient", "ListSiteBackups", resp, "Failure sending next results request")
	}

	result, err = client.ListSiteBackupsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "ListSiteBackups", resp, "Failure responding to next results request")
	}
...
func (client SitesClient) ListSiteBackupsSlot(resourceGroupName string, name string, slot string) (result BackupItemCollection, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "ListSiteBackupsSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "ListSiteBackupsSlot", resp, "Failure sending request")
		return
	}

	result, err = client.ListSiteBackupsSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "ListSiteBackupsSlot", resp, "Failure responding to request")
	}
...
func (client SitesClient) ListSiteBackupsSlotNextResults(lastResults BackupItemCollection) (result BackupItemCollection, err error) {
	req, err := lastResults.BackupItemCollectionPreparer()
	if err != nil {
		return result, autorest.NewErrorWithError(err, "service.SitesClient", "ListSiteBackupsSlot", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "service.SitesClient", "ListSiteBackupsSlot", resp, "Failure sending next results request")
	}

	result, err = client.ListSiteBackupsSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "ListSiteBackupsSlot", resp, "Failure responding to next results request")
	}
...
func (client SitesClient) ListSiteConnectionStrings(resourceGroupName string, name string) (result ConnectionStringDictionary, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "ListSiteConnectionStrings", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "ListSiteConnectionStrings", resp, "Failure sending request")
		return
	}

	result, err = client.ListSiteConnectionStringsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "ListSiteConnectionStrings", resp, "Failure responding to request")
	}
...
func (client SitesClient) ListSiteConnectionStringsSlot(resourceGroupName string, name string, slot string) (result ConnectionStringDictionary, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "ListSiteConnectionStringsSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "ListSiteConnectionStringsSlot", resp, "Failure sending request")
		return
	}

	result, err = client.ListSiteConnectionStringsSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "ListSiteConnectionStringsSlot", resp, "Failure responding to request")
	}
...
func (client SitesClient) ListSiteMetadata(resourceGroupName string, name string) (result StringDictionary, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "ListSiteMetadata", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "ListSiteMetadata", resp, "Failure sending request")
		return
	}

	result, err = client.ListSiteMetadataResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "ListSiteMetadata", resp, "Failure responding to request")
	}
...
func (client SitesClient) ListSiteMetadataSlot(resourceGroupName string, name string, slot string) (result StringDictionary, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "ListSiteMetadataSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "ListSiteMetadataSlot", resp, "Failure sending request")
		return
	}

	result, err = client.ListSiteMetadataSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "ListSiteMetadataSlot", resp, "Failure responding to request")
	}
...
func (client SitesClient) ListSitePremierAddOns(resourceGroupName string, name string) (result SetObject, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "ListSitePremierAddOns", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "ListSitePremierAddOns", resp, "Failure sending request")
		return
	}

	result, err = client.ListSitePremierAddOnsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "ListSitePremierAddOns", resp, "Failure responding to request")
	}
...
func (client SitesClient) ListSitePremierAddOnsSlot(resourceGroupName string, name string, slot string) (result SetObject, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "ListSitePremierAddOnsSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "ListSitePremierAddOnsSlot", resp, "Failure sending request")
		return
	}

	result, err = client.ListSitePremierAddOnsSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "ListSitePremierAddOnsSlot", resp, "Failure responding to request")
	}
...
func (client SitesClient) ListSitePublishingCredentials(resourceGroupName string, name string, cancel <-chan struct{}) (<-chan User, <-chan error) {
	...
	go func() {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.SitesClient", "ListSitePublishingCredentials", nil, "Failure preparing request")
			return
		}
		...
		if err != nil {
			result.Response = autorest.Response{Response: resp}
			err = autorest.NewErrorWithError(err, "service.SitesClient", "ListSitePublishingCredentials", resp, "Failure sending request")
			return
		}

		result, err = client.ListSitePublishingCredentialsResponder(resp)
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.SitesClient", "ListSitePublishingCredentials", resp, "Failure responding to request")
		}
	}()
	return resultChan, errChan
}
...
// ListSitePublishingCredentialsSlot sends the list site publishing credentials
// slot request. This method may poll for completion. Polling can be canceled
...
func (client SitesClient) ListSitePublishingCredentialsSlot(resourceGroupName string, name string, slot string, cancel <-chan struct{}) (<-chan User, <-chan error) {
	...
	go func() {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.SitesClient", "ListSitePublishingCredentialsSlot", nil, "Failure preparing request")
			return
		}
		...
		if err != nil {
			result.Response = autorest.Response{Response: resp}
			err = autorest.NewErrorWithError(err, "service.SitesClient", "ListSitePublishingCredentialsSlot", resp, "Failure sending request")
			return
		}

		result, err = client.ListSitePublishingCredentialsSlotResponder(resp)
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.SitesClient", "ListSitePublishingCredentialsSlot", resp, "Failure responding to request")
		}
	}()
	return resultChan, errChan
}
...
func (client SitesClient) ListSitePublishingProfileXML(resourceGroupName string, name string, options CsmPublishingProfileOptions) (result ReadCloser, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "ListSitePublishingProfileXML", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "ListSitePublishingProfileXML", resp, "Failure sending request")
		return
	}

	result, err = client.ListSitePublishingProfileXMLResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "ListSitePublishingProfileXML", resp, "Failure responding to request")
	}
...
// resourceGroupName is name of resource group name is name of web app options
// is specifies options for publishing profile. Pass
// CsmPublishingProfileOptions.Format=FileZilla3 for FileZilla FTP format. slot
// is name of web app slot. If not specified then will default to production
// slot.
func (client SitesClient) ListSitePublishingProfileXMLSlot(resourceGroupName string, name string, options CsmPublishingProfileOptions, slot string) (result ReadCloser, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "ListSitePublishingProfileXMLSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "ListSitePublishingProfileXMLSlot", resp, "Failure sending request")
		return
	}

	result, err = client.ListSitePublishingProfileXMLSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "ListSitePublishingProfileXMLSlot", resp, "Failure responding to request")
	}
...
func (client SitesClient) ListSiteRelayServiceConnections(resourceGroupName string, name string) (result RelayServiceConnectionEntity, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "ListSiteRelayServiceConnections", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "ListSiteRelayServiceConnections", resp, "Failure sending request")
		return
	}

	result, err = client.ListSiteRelayServiceConnectionsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "ListSiteRelayServiceConnections", resp, "Failure responding to request")
	}
...
func (client SitesClient) ListSiteRelayServiceConnectionsSlot(resourceGroupName string, name string, slot string) (result RelayServiceConnectionEntity, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "ListSiteRelayServiceConnectionsSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "ListSiteRelayServiceConnectionsSlot", resp, "Failure sending request")
		return
	}

	result, err = client.ListSiteRelayServiceConnectionsSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "ListSiteRelayServiceConnectionsSlot", resp, "Failure responding to request")
	}
...
func (client SitesClient) RecoverSite(resourceGroupName string, name string, recoveryEntity CsmSiteRecoveryEntity, cancel <-chan struct{}) (<-chan Site, <-chan error) {
	...
	go func() {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.SitesClient", "RecoverSite", nil, "Failure preparing request")
			return
		}
		...
		if err != nil {
			result.Response = autorest.Response{Response: resp}
			err = autorest.NewErrorWithError(err, "service.SitesClient", "RecoverSite", resp, "Failure sending request")
			return
		}

		result, err = client.RecoverSiteResponder(resp)
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.SitesClient", "RecoverSite", resp, "Failure responding to request")
		}
	}()
	return resultChan, errChan
}
...
func (client SitesClient) RecoverSiteSlot(resourceGroupName string, name string, recoveryEntity CsmSiteRecoveryEntity, slot string, cancel <-chan struct{}) (<-chan Site, <-chan error) {
	...
	go func() {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.SitesClient", "RecoverSiteSlot", nil, "Failure preparing request")
			return
		}
		...
		if err != nil {
			result.Response = autorest.Response{Response: resp}
			err = autorest.NewErrorWithError(err, "service.SitesClient", "RecoverSiteSlot", resp, "Failure sending request")
			return
		}

		result, err = client.RecoverSiteSlotResponder(resp)
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.SitesClient", "RecoverSiteSlot", resp, "Failure responding to request")
		}
	}()
	return resultChan, errChan
}
...
func (client SitesClient) ResetProductionSlotConfig(resourceGroupName string, name string) (result SetObject, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "ResetProductionSlotConfig", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "ResetProductionSlotConfig", resp, "Failure sending request")
		return
	}

	result, err = client.ResetProductionSlotConfigResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "ResetProductionSlotConfig", resp, "Failure responding to request")
	}
...
func (client SitesClient) ResetSlotConfigSlot(resourceGroupName string, name string, slot string) (result SetObject, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "ResetSlotConfigSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "ResetSlotConfigSlot", resp, "Failure sending request")
		return
	}

	result, err = client.ResetSlotConfigSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "ResetSlotConfigSlot", resp, "Failure responding to request")
	}
...
//
// resourceGroupName is name of resource group name is name of web app
// softRestart is soft restart applies the configuration settings and restarts
// the app if necessary. Hard restart always restarts and reprovisions the app
// synchronous is if true then the API will block until the app has been
// restarted
func (client SitesClient) RestartSite(resourceGroupName string, name string, softRestart *bool, synchronous *bool) (result SetObject, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "RestartSite", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "RestartSite", resp, "Failure sending request")
		return
	}

	result, err = client.RestartSiteResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "RestartSite", resp, "Failure responding to request")
	}
...
func (client SitesClient) RestartSiteSlot(resourceGroupName string, name string, slot string, softRestart *bool, synchronous *bool) (result SetObject, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "RestartSiteSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "RestartSiteSlot", resp, "Failure sending request")
		return
	}

	result, err = client.RestartSiteSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "RestartSiteSlot", resp, "Failure responding to request")
	}
...
//
// resourceGroupName is name of resource group name is name of web app backupID
// is id of backup to restore request is information on restore request
func (client SitesClient) RestoreSite(resourceGroupName string, name string, backupID string, request RestoreRequest, cancel <-chan struct{}) (<-chan RestoreResponse, <-chan error) {
	...
	go func() {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.SitesClient", "RestoreSite", nil, "Failure preparing request")
			return
		}
		...
		if err != nil {
			result.Response = autorest.Response{Response: resp}
			err = autorest.NewErrorWithError(err, "service.SitesClient", "RestoreSite", resp, "Failure sending request")
			return
		}

		result, err = client.RestoreSiteResponder(resp)
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.SitesClient", "RestoreSite", resp, "Failure responding to request")
		}
	}()
	return resultChan, errChan
}
...
//
// resourceGroupName is name of resource group name is name of web app backupID
// is id of backup to restore request is information on restore request slot is
// name of web app slot. If not specified then will default to production slot.
func (client SitesClient) RestoreSiteSlot(resourceGroupName string, name string, backupID string, request RestoreRequest, slot string, cancel <-chan struct{}) (<-chan RestoreResponse, <-chan error) {
	...
	go func() {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.SitesClient", "RestoreSiteSlot", nil, "Failure preparing request")
			return
		}
		...
		if err != nil {
			result.Response = autorest.Response{Response: resp}
			err = autorest.NewErrorWithError(err, "service.SitesClient", "RestoreSiteSlot", resp, "Failure sending request")
			return
		}

		result, err = client.RestoreSiteSlotResponder(resp)
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.SitesClient", "RestoreSiteSlot", resp, "Failure responding to request")
		}
	}()
	return resultChan, errChan
}
...
func (client SitesClient) StartSite(resourceGroupName string, name string) (result SetObject, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "StartSite", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "StartSite", resp, "Failure sending request")
		return
	}

	result, err = client.StartSiteResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "StartSite", resp, "Failure responding to request")
	}
...
func (client SitesClient) StartSiteSlot(resourceGroupName string, name string, slot string) (result SetObject, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "StartSiteSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "StartSiteSlot", resp, "Failure sending request")
		return
	}

	result, err = client.StartSiteSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "StartSiteSlot", resp, "Failure responding to request")
	}
...
func (client SitesClient) StopSite(resourceGroupName string, name string) (result SetObject, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "StopSite", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "StopSite", resp, "Failure sending request")
		return
	}

	result, err = client.StopSiteResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "StopSite", resp, "Failure responding to request")
	}
...
func (client SitesClient) StopSiteSlot(resourceGroupName string, name string, slot string) (result SetObject, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "StopSiteSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "StopSiteSlot", resp, "Failure sending request")
		return
	}

	result, err = client.StopSiteSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "StopSiteSlot", resp, "Failure responding to request")
	}
...
func (client SitesClient) SwapSlotsSlot(resourceGroupName string, name string, slotSwapEntity CsmSlotEntity, slot string, cancel <-chan struct{}) (<-chan SetObject, <-chan error) {
	...
	go func() {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.SitesClient", "SwapSlotsSlot", nil, "Failure preparing request")
			return
		}
		...
		if err != nil {
			result.Response = autorest.Response{Response: resp}
			err = autorest.NewErrorWithError(err, "service.SitesClient", "SwapSlotsSlot", resp, "Failure sending request")
			return
		}

		result, err = client.SwapSlotsSlotResponder(resp)
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.SitesClient", "SwapSlotsSlot", resp, "Failure responding to request")
		}
	}()
	return resultChan, errChan
}
...
func (client SitesClient) SwapSlotWithProduction(resourceGroupName string, name string, slotSwapEntity CsmSlotEntity, cancel <-chan struct{}) (<-chan SetObject, <-chan error) {
	...
	go func() {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.SitesClient", "SwapSlotWithProduction", nil, "Failure preparing request")
			return
		}
		...
		if err != nil {
			result.Response = autorest.Response{Response: resp}
			err = autorest.NewErrorWithError(err, "service.SitesClient", "SwapSlotWithProduction", resp, "Failure sending request")
			return
		}

		result, err = client.SwapSlotWithProductionResponder(resp)
		if err != nil {
			err = autorest.NewErrorWithError(err, "service.SitesClient", "SwapSlotWithProduction", resp, "Failure responding to request")
		}
	}()
	return resultChan, errChan
}
...
func (client SitesClient) SyncSiteRepository(resourceGroupName string, name string) (result SetObject, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "SyncSiteRepository", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "SyncSiteRepository", resp, "Failure sending request")
		return
	}

	result, err = client.SyncSiteRepositoryResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "SyncSiteRepository", resp, "Failure responding to request")
	}
...
func (client SitesClient) SyncSiteRepositorySlot(resourceGroupName string, name string, slot string) (result SetObject, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "SyncSiteRepositorySlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "SyncSiteRepositorySlot", resp, "Failure sending request")
		return
	}

	result, err = client.SyncSiteRepositorySlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "SyncSiteRepositorySlot", resp, "Failure responding to request")
	}
...
func (client SitesClient) UpdateSiteAppSettings(resourceGroupName string, name string, appSettings StringDictionary) (result StringDictionary, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteAppSettings", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteAppSettings", resp, "Failure sending request")
		return
	}

	result, err = client.UpdateSiteAppSettingsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteAppSettings", resp, "Failure responding to request")
	}
...
//
// resourceGroupName is name of resource group name is name of web app
// appSettings is application settings of web app slot is name of web app slot.
...
func (client SitesClient) UpdateSiteAppSettingsSlot(resourceGroupName string, name string, appSettings StringDictionary, slot string) (result StringDictionary, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteAppSettingsSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteAppSettingsSlot", resp, "Failure sending request")
		return
	}

	result, err = client.UpdateSiteAppSettingsSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteAppSettingsSlot", resp, "Failure responding to request")
	}
...
func (client SitesClient) UpdateSiteAuthSettings(resourceGroupName string, name string, siteAuthSettings SiteAuthSettings) (result SiteAuthSettings, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteAuthSettings", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteAuthSettings", resp, "Failure sending request")
		return
	}

	result, err = client.UpdateSiteAuthSettingsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteAuthSettings", resp, "Failure responding to request")
	}
...
func (client SitesClient) UpdateSiteAuthSettingsSlot(resourceGroupName string, name string, siteAuthSettings SiteAuthSettings, slot string) (result SiteAuthSettings, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteAuthSettingsSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteAuthSettingsSlot", resp, "Failure sending request")
		return
	}

	result, err = client.UpdateSiteAuthSettingsSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteAuthSettingsSlot", resp, "Failure responding to request")
	}
...
func (client SitesClient) UpdateSiteBackupConfiguration(resourceGroupName string, name string, request BackupRequest) (result BackupRequest, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteBackupConfiguration", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteBackupConfiguration", resp, "Failure sending request")
		return
	}

	result, err = client.UpdateSiteBackupConfigurationResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteBackupConfiguration", resp, "Failure responding to request")
	}
...
// UpdateSiteBackupConfigurationSlot sends the update site backup configuration
// slot request.
//
// resourceGroupName is name of resource group name is name of web app request
// is information on backup request slot is name of web app slot. If not
...
func (client SitesClient) UpdateSiteBackupConfigurationSlot(resourceGroupName string, name string, request BackupRequest, slot string) (result BackupRequest, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteBackupConfigurationSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteBackupConfigurationSlot", resp, "Failure sending request")
		return
	}

	result, err = client.UpdateSiteBackupConfigurationSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteBackupConfigurationSlot", resp, "Failure responding to request")
	}
...
func (client SitesClient) UpdateSiteConfig(resourceGroupName string, name string, siteConfig SiteConfig) (result SiteConfig, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteConfig", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteConfig", resp, "Failure sending request")
		return
	}

	result, err = client.UpdateSiteConfigResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteConfig", resp, "Failure responding to request")
	}
...
func (client SitesClient) UpdateSiteConfigSlot(resourceGroupName string, name string, siteConfig SiteConfig, slot string) (result SiteConfig, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteConfigSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteConfigSlot", resp, "Failure sending request")
		return
	}

	result, err = client.UpdateSiteConfigSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteConfigSlot", resp, "Failure responding to request")
	}
...
func (client SitesClient) UpdateSiteConnectionStrings(resourceGroupName string, name string, connectionStrings ConnectionStringDictionary) (result ConnectionStringDictionary, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteConnectionStrings", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteConnectionStrings", resp, "Failure sending request")
		return
	}

	result, err = client.UpdateSiteConnectionStringsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteConnectionStrings", resp, "Failure responding to request")
	}
...
//
// resourceGroupName is name of resource group name is name of web app
// connectionStrings is connection strings associated with web app slot is name
...
func (client SitesClient) UpdateSiteConnectionStringsSlot(resourceGroupName string, name string, connectionStrings ConnectionStringDictionary, slot string) (result ConnectionStringDictionary, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteConnectionStringsSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteConnectionStringsSlot", resp, "Failure sending request")
		return
	}

	result, err = client.UpdateSiteConnectionStringsSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteConnectionStringsSlot", resp, "Failure responding to request")
	}
...
func (client SitesClient) UpdateSiteLogsConfig(resourceGroupName string, name string, siteLogsConfig SiteLogsConfig) (result SiteLogsConfig, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteLogsConfig", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteLogsConfig", resp, "Failure sending request")
		return
	}

	result, err = client.UpdateSiteLogsConfigResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteLogsConfig", resp, "Failure responding to request")
	}
...
func (client SitesClient) UpdateSiteLogsConfigSlot(resourceGroupName string, name string, siteLogsConfig SiteLogsConfig, slot string) (result SiteLogsConfig, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteLogsConfigSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteLogsConfigSlot", resp, "Failure sending request")
		return
	}

	result, err = client.UpdateSiteLogsConfigSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteLogsConfigSlot", resp, "Failure responding to request")
	}
...
//
// resourceGroupName is name of resource group name is name of web app metadata
// is meta data of web app
func (client SitesClient) UpdateSiteMetadata(resourceGroupName string, name string, metadata StringDictionary) (result StringDictionary, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteMetadata", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteMetadata", resp, "Failure sending request")
		return
	}

	result, err = client.UpdateSiteMetadataResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteMetadata", resp, "Failure responding to request")
	}
...
//
// resourceGroupName is name of resource group name is name of web app metadata
// is meta data of web app slot is name of web app slot. If not specified then
...
func (client SitesClient) UpdateSiteMetadataSlot(resourceGroupName string, name string, metadata StringDictionary, slot string) (result StringDictionary, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteMetadataSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteMetadataSlot", resp, "Failure sending request")
		return
	}

	result, err = client.UpdateSiteMetadataSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteMetadataSlot", resp, "Failure responding to request")
	}
...
func (client SitesClient) UpdateSiteRelayServiceConnection(resourceGroupName string, name string, entityName string, connectionEnvelope RelayServiceConnectionEntity) (result RelayServiceConnectionEntity, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteRelayServiceConnection", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteRelayServiceConnection", resp, "Failure sending request")
		return
	}

	result, err = client.UpdateSiteRelayServiceConnectionResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteRelayServiceConnection", resp, "Failure responding to request")
	}
...
func (client SitesClient) UpdateSiteRelayServiceConnectionSlot(resourceGroupName string, name string, entityName string, connectionEnvelope RelayServiceConnectionEntity, slot string) (result RelayServiceConnectionEntity, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteRelayServiceConnectionSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteRelayServiceConnectionSlot", resp, "Failure sending request")
		return
	}

	result, err = client.UpdateSiteRelayServiceConnectionSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteRelayServiceConnectionSlot", resp, "Failure responding to request")
	}
...
func (client SitesClient) UpdateSiteSourceControl(resourceGroupName string, name string, siteSourceControl SiteSourceControl) (result SiteSourceControl, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteSourceControl", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteSourceControl", resp, "Failure sending request")
		return
	}

	result, err = client.UpdateSiteSourceControlResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteSourceControl", resp, "Failure responding to request")
	}
...
func (client SitesClient) UpdateSiteSourceControlSlot(resourceGroupName string, name string, siteSourceControl SiteSourceControl, slot string) (result SiteSourceControl, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteSourceControlSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteSourceControlSlot", resp, "Failure sending request")
		return
	}

	result, err = client.UpdateSiteSourceControlSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteSourceControlSlot", resp, "Failure responding to request")
	}
...
func (client SitesClient) UpdateSiteVNETConnection(resourceGroupName string, name string, vnetName string, connectionEnvelope VnetInfo) (result VnetInfo, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteVNETConnection", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteVNETConnection", resp, "Failure sending request")
		return
	}

	result, err = client.UpdateSiteVNETConnectionResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteVNETConnection", resp, "Failure responding to request")
	}
...
func (client SitesClient) UpdateSiteVNETConnectionGateway(resourceGroupName string, name string, vnetName string, gatewayName string, connectionEnvelope VnetGateway) (result VnetGateway, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteVNETConnectionGateway", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteVNETConnectionGateway", resp, "Failure sending request")
		return
	}

	result, err = client.UpdateSiteVNETConnectionGatewayResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteVNETConnectionGateway", resp, "Failure responding to request")
	}
...
func (client SitesClient) UpdateSiteVNETConnectionGatewaySlot(resourceGroupName string, name string, vnetName string, gatewayName string, connectionEnvelope VnetGateway, slot string) (result VnetGateway, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteVNETConnectionGatewaySlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteVNETConnectionGatewaySlot", resp, "Failure sending request")
		return
	}

	result, err = client.UpdateSiteVNETConnectionGatewaySlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteVNETConnectionGatewaySlot", resp, "Failure responding to request")
	}
...
func (client SitesClient) UpdateSiteVNETConnectionSlot(resourceGroupName string, name string, vnetName string, connectionEnvelope VnetInfo, slot string) (result VnetInfo, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteVNETConnectionSlot", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteVNETConnectionSlot", resp, "Failure sending request")
		return
	}

	result, err = client.UpdateSiteVNETConnectionSlotResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSiteVNETConnectionSlot", resp, "Failure responding to request")
	}
...
//
// resourceGroupName is name of resource group name is name of web app
// slotConfigNames is request body containing the names of application settings
...
func (client SitesClient) UpdateSlotConfigNames(resourceGroupName string, name string, slotConfigNames SlotConfigNamesResource) (result SlotConfigNamesResource, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSlotConfigNames", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSlotConfigNames", resp, "Failure sending request")
		return
	}

	result, err = client.UpdateSlotConfigNamesResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "service.SitesClient", "UpdateSlotConfigNames", resp, "Failure responding to request")
	}
