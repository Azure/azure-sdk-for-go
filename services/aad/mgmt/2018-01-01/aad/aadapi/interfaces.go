...
import (
	"context"
	"github.com/Azure/azure-sdk-for-go/services/aad/mgmt/2018-01-01/aad"
	"github.com/Azure/go-autorest/autorest"
)

// MetricsClientAPI contains the set of methods on the MetricsClient type.
type MetricsClientAPI interface {
	List(ctx context.Context, timespan string, interval *string, metricnames string, aggregation string, top *int32, orderby string, filter string, resultType aad.ResultType, metricnamespace string) (result aad.Response, err error)
}

var _ MetricsClientAPI = (*aad.MetricsClient)(nil)
...
type MetricDefinitionsClientAPI interface {
	List(ctx context.Context, metricnamespace string) (result aad.MetricDefinitionCollection, err error)
}

var _ MetricDefinitionsClientAPI = (*aad.MetricDefinitionsClient)(nil)
