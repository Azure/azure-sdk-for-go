...
// MetricDefinitionsClient is the azure Active Directory Client.
...
func (client MetricDefinitionsClient) List(ctx context.Context, metricnamespace string) (result MetricDefinitionCollection, err error) {
	...
	req, err := client.ListPreparer(ctx, metricnamespace)
	if err != nil {
		err = autorest.NewErrorWithError(err, "aad.MetricDefinitionsClient", "List", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "aad.MetricDefinitionsClient", "List", resp, "Failure sending request")
		return
	}

	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "aad.MetricDefinitionsClient", "List", resp, "Failure responding to request")
	}
...
func (client MetricDefinitionsClient) ListPreparer(ctx context.Context, metricnamespace string) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithPath("/providers/microsoft.aadiam/metricDefinitions"),
