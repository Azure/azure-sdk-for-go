...
// MetricsClient is the azure Active Directory Client.
...
func (client MetricsClient) List(ctx context.Context, timespan string, interval *string, metricnames string, aggregation string, top *int32, orderby string, filter string, resultType ResultType, metricnamespace string) (result Response, err error) {
	...
	req, err := client.ListPreparer(ctx, timespan, interval, metricnames, aggregation, top, orderby, filter, resultType, metricnamespace)
	if err != nil {
		err = autorest.NewErrorWithError(err, "aad.MetricsClient", "List", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "aad.MetricsClient", "List", resp, "Failure sending request")
		return
	}

	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "aad.MetricsClient", "List", resp, "Failure responding to request")
	}
...
func (client MetricsClient) ListPreparer(ctx context.Context, timespan string, interval *string, metricnames string, aggregation string, top *int32, orderby string, filter string, resultType ResultType, metricnamespace string) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithPath("/providers/microsoft.aadiam/metrics"),
