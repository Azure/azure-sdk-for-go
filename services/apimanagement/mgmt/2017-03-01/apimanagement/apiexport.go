...
// API identifier. Must be unique in the current API Management service instance. export is query parameter required to
// export the API details.
func (client APIExportClient) Get(resourceGroupName string, serviceName string, apiid string, export string) (result APIExportResult, err error) {
	...
	req, err := client.GetPreparer(resourceGroupName, serviceName, apiid, export)
	if err != nil {
...
func (client APIExportClient) GetPreparer(resourceGroupName string, serviceName string, apiid string, export string) (*http.Request, error) {
	...
	queryParameters := map[string]interface{}{
		...
		"export":      autorest.Encode("query", export),
	}
