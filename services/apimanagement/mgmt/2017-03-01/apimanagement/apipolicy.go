...
// API identifier. Must be unique in the current API Management service instance. policyID is the identifier of the
// Policy. parameters is the policy contents to apply. ifMatch is the entity state (Etag) version of the Api Policy to
// update. A value of "*" can be used for If-Match to unconditionally apply the operation.
func (client APIPolicyClient) CreateOrUpdate(resourceGroupName string, serviceName string, apiid string, policyID string, parameters PolicyContract, ifMatch string) (result PolicyContract, err error) {
	...
	req, err := client.CreateOrUpdatePreparer(resourceGroupName, serviceName, apiid, policyID, parameters, ifMatch)
	if err != nil {
...
func (client APIPolicyClient) CreateOrUpdatePreparer(resourceGroupName string, serviceName string, apiid string, policyID string, parameters PolicyContract, ifMatch string) (*http.Request, error) {
...
// resourceGroupName is the name of the resource group. serviceName is the name of the API Management service. apiid is
// API identifier. Must be unique in the current API Management service instance. policyID is the identifier of the
// Policy. ifMatch is the entity state (Etag) version of the Api policy to update. A value of "*" can be used for
// If-Match to unconditionally apply the operation.
func (client APIPolicyClient) Delete(resourceGroupName string, serviceName string, apiid string, policyID string, ifMatch string) (result autorest.Response, err error) {
	if err := validation.Validate([]validation.Validation{
		{TargetValue: serviceName,
			Constraints: []validation.Constraint{{Target: "serviceName", Name: validation.MaxLength, Rule: 50, Chain: nil},
				{Target: "serviceName", Name: validation.MinLength, Rule: 1, Chain: nil},
	...
	req, err := client.DeletePreparer(resourceGroupName, serviceName, apiid, policyID, ifMatch)
	if err != nil {
...
func (client APIPolicyClient) DeletePreparer(resourceGroupName string, serviceName string, apiid string, policyID string, ifMatch string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"apiId":             autorest.Encode("path", apiid),
		"policyId":          autorest.Encode("path", policyID),
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
...
// API identifier. Must be unique in the current API Management service instance. policyID is the identifier of the
// Policy.
func (client APIPolicyClient) Get(resourceGroupName string, serviceName string, apiid string, policyID string) (result PolicyContract, err error) {
	if err := validation.Validate([]validation.Validation{
		{TargetValue: serviceName,
			Constraints: []validation.Constraint{{Target: "serviceName", Name: validation.MaxLength, Rule: 50, Chain: nil},
				{Target: "serviceName", Name: validation.MinLength, Rule: 1, Chain: nil},
	...
	req, err := client.GetPreparer(resourceGroupName, serviceName, apiid, policyID)
	if err != nil {
...
func (client APIPolicyClient) GetPreparer(resourceGroupName string, serviceName string, apiid string, policyID string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"apiId":             autorest.Encode("path", apiid),
		"policyId":          autorest.Encode("path", policyID),
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
...
func (client APIPolicyClient) ListByAPI(resourceGroupName string, serviceName string, apiid string) (result PolicyCollection, err error) {
	if err := validation.Validate([]validation.Validation{
		{TargetValue: serviceName,
			Constraints: []validation.Constraint{{Target: "serviceName", Name: validation.MaxLength, Rule: 50, Chain: nil},
				{Target: "serviceName", Name: validation.MinLength, Rule: 1, Chain: nil},
		...
		{TargetValue: apiid,
			Constraints: []validation.Constraint{{Target: "apiid", Name: validation.MaxLength, Rule: 256, Chain: nil},
				{Target: "apiid", Name: validation.MinLength, Rule: 1, Chain: nil},
				{Target: "apiid", Name: validation.Pattern, Rule: `^[^*#&+:<>?]+$`, Chain: nil}}}}); err != nil {
		return result, validation.NewErrorWithValidationError(err, "apimanagement.APIPolicyClient", "ListByAPI")
	}
...
func (client APIPolicyClient) ListByAPIPreparer(resourceGroupName string, serviceName string, apiid string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"apiId":             autorest.Encode("path", apiid),
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"serviceName":       autorest.Encode("path", serviceName),
