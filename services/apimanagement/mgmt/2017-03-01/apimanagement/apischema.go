...
// API identifier. Must be unique in the current API Management service instance. schemaID is schema identifier within
// an API. Must be unique in the current API Management service instance. parameters is the schema contents to apply.
// ifMatch is the entity state (Etag) version of the Api Schema to update. A value of "*" can be used for If-Match to
// unconditionally apply the operation.
func (client APISchemaClient) CreateOrUpdate(resourceGroupName string, serviceName string, apiid string, schemaID string, parameters SchemaContract, ifMatch string) (result SchemaContract, err error) {
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewErrorWithValidationError(err, "apimanagement.APISchemaClient", "CreateOrUpdate")
	}

	req, err := client.CreateOrUpdatePreparer(resourceGroupName, serviceName, apiid, schemaID, parameters, ifMatch)
	if err != nil {
...
func (client APISchemaClient) CreateOrUpdatePreparer(resourceGroupName string, serviceName string, apiid string, schemaID string, parameters SchemaContract, ifMatch string) (*http.Request, error) {
...
// resourceGroupName is the name of the resource group. serviceName is the name of the API Management service. apiid is
// API identifier. Must be unique in the current API Management service instance. schemaID is schema identifier within
// an API. Must be unique in the current API Management service instance. ifMatch is the entity state (Etag) version of
// the Api schema to update. A value of "*" can be used for If-Match to unconditionally apply the operation.
func (client APISchemaClient) Delete(resourceGroupName string, serviceName string, apiid string, schemaID string, ifMatch string) (result autorest.Response, err error) {
	if err := validation.Validate([]validation.Validation{
		{TargetValue: serviceName,
			Constraints: []validation.Constraint{{Target: "serviceName", Name: validation.MaxLength, Rule: 50, Chain: nil},
				{Target: "serviceName", Name: validation.MinLength, Rule: 1, Chain: nil},
		...
		return result, validation.NewErrorWithValidationError(err, "apimanagement.APISchemaClient", "Delete")
	}

	req, err := client.DeletePreparer(resourceGroupName, serviceName, apiid, schemaID, ifMatch)
	if err != nil {
...
func (client APISchemaClient) DeletePreparer(resourceGroupName string, serviceName string, apiid string, schemaID string, ifMatch string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"apiId":             autorest.Encode("path", apiid),
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"schemaId":          autorest.Encode("path", schemaID),
...
// resourceGroupName is the name of the resource group. serviceName is the name of the API Management service. apiid is
// API identifier. Must be unique in the current API Management service instance. schemaID is schema identifier within
// an API. Must be unique in the current API Management service instance.
func (client APISchemaClient) Get(resourceGroupName string, serviceName string, apiid string, schemaID string) (result SchemaContract, err error) {
	if err := validation.Validate([]validation.Validation{
		{TargetValue: serviceName,
			Constraints: []validation.Constraint{{Target: "serviceName", Name: validation.MaxLength, Rule: 50, Chain: nil},
				{Target: "serviceName", Name: validation.MinLength, Rule: 1, Chain: nil},
		...
		{TargetValue: schemaID,
			Constraints: []validation.Constraint{{Target: "schemaID", Name: validation.MaxLength, Rule: 256, Chain: nil},
				{Target: "schemaID", Name: validation.MinLength, Rule: 1, Chain: nil},
				{Target: "schemaID", Name: validation.Pattern, Rule: `^[^*#&+:<>?]+$`, Chain: nil}}}}); err != nil {
		return result, validation.NewErrorWithValidationError(err, "apimanagement.APISchemaClient", "Get")
	}

	req, err := client.GetPreparer(resourceGroupName, serviceName, apiid, schemaID)
	if err != nil {
...
func (client APISchemaClient) GetPreparer(resourceGroupName string, serviceName string, apiid string, schemaID string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"apiId":             autorest.Encode("path", apiid),
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"schemaId":          autorest.Encode("path", schemaID),
...
func (client APISchemaClient) ListByAPI(resourceGroupName string, serviceName string, apiid string) (result SchemaCollection, err error) {
	if err := validation.Validate([]validation.Validation{
		{TargetValue: serviceName,
			Constraints: []validation.Constraint{{Target: "serviceName", Name: validation.MaxLength, Rule: 50, Chain: nil},
				{Target: "serviceName", Name: validation.MinLength, Rule: 1, Chain: nil},
		...
		return result, validation.NewErrorWithValidationError(err, "apimanagement.APISchemaClient", "ListByAPI")
	}

	req, err := client.ListByAPIPreparer(resourceGroupName, serviceName, apiid)
	if err != nil {
...
func (client APISchemaClient) ListByAPIPreparer(resourceGroupName string, serviceName string, apiid string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"apiId":             autorest.Encode("path", apiid),
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"serviceName":       autorest.Encode("path", serviceName),
...
func (client APISchemaClient) ListByAPINextResults(lastResults SchemaCollection) (result SchemaCollection, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "apimanagement.APISchemaClient", "ListByAPI", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "apimanagement.APISchemaClient", "ListByAPI", resp, "Failure sending next results request")
	}

	result, err = client.ListByAPIResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "apimanagement.APISchemaClient", "ListByAPI", resp, "Failure responding to next results request")
	}
...
func (client APISchemaClient) ListByAPIComplete(resourceGroupName string, serviceName string, apiid string, cancel <-chan struct{}) (<-chan SchemaContract, <-chan error) {
	resultChan := make(chan SchemaContract)
	...
	go func() {
		...
		list, err := client.ListByAPI(resourceGroupName, serviceName, apiid)
		if err != nil {
			errChan <- err
			return
		}
