...
func (acoup APICreateOrUpdateProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if acoup.ContentValue != nil {
		objectMap["contentValue"] = acoup.ContentValue
	}
	if acoup.ContentFormat != "" {
		objectMap["contentFormat"] = acoup.ContentFormat
	}
...
// MarshalJSON is the custom marshaler for APIRevisionContractProperties.
func (arcp APIRevisionContractProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	return json.Marshal(objectMap)
}
...
// MarshalJSON is the custom marshaler for CertificateConfiguration.
func (cc CertificateConfiguration) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if cc.EncodedCertificate != nil {
		objectMap["encodedCertificate"] = cc.EncodedCertificate
	}
	if cc.CertificatePassword != nil {
		objectMap["certificatePassword"] = cc.CertificatePassword
	}
	if cc.StoreName != "" {
		objectMap["storeName"] = cc.StoreName
	}
	return json.Marshal(objectMap)
}
...
// MarshalJSON is the custom marshaler for HostnameConfiguration.
func (hc HostnameConfiguration) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if hc.Type != "" {
		objectMap["type"] = hc.Type
	}
	if hc.HostName != nil {
		objectMap["hostName"] = hc.HostName
	}
	if hc.KeyVaultID != nil {
		objectMap["keyVaultId"] = hc.KeyVaultID
	}
	if hc.EncodedCertificate != nil {
		objectMap["encodedCertificate"] = hc.EncodedCertificate
	}
	if hc.CertificatePassword != nil {
		objectMap["certificatePassword"] = hc.CertificatePassword
	}
	if hc.DefaultSslBinding != nil {
		objectMap["defaultSslBinding"] = hc.DefaultSslBinding
	}
	if hc.NegotiateClientCertificate != nil {
		objectMap["negotiateClientCertificate"] = hc.NegotiateClientCertificate
	}
	return json.Marshal(objectMap)
}
...
// MarshalJSON is the custom marshaler for OperationEntityContractProperties.
func (oecp OperationEntityContractProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	return json.Marshal(objectMap)
}
...
// result is the default implementation for ServiceUpdateHostnameFuture.Result.
...
// MarshalJSON is the custom marshaler for UserCreateParameterProperties.
func (ucpp UserCreateParameterProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if ucpp.Email != nil {
		objectMap["email"] = ucpp.Email
	}
	if ucpp.FirstName != nil {
		objectMap["firstName"] = ucpp.FirstName
	}
	if ucpp.LastName != nil {
		objectMap["lastName"] = ucpp.LastName
	}
	if ucpp.Password != nil {
		objectMap["password"] = ucpp.Password
	}
	if ucpp.Confirmation != "" {
		objectMap["confirmation"] = ucpp.Confirmation
	}
	if ucpp.State != "" {
		objectMap["state"] = ucpp.State
	}
	if ucpp.Note != nil {
		objectMap["note"] = ucpp.Note
	}
	return json.Marshal(objectMap)
}
...
// MarshalJSON is the custom marshaler for UserUpdateParametersProperties.
func (uupp UserUpdateParametersProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if uupp.Email != nil {
		objectMap["email"] = uupp.Email
	}
	if uupp.Password != nil {
		objectMap["password"] = uupp.Password
	}
	if uupp.FirstName != nil {
		objectMap["firstName"] = uupp.FirstName
	}
	if uupp.LastName != nil {
		objectMap["lastName"] = uupp.LastName
	}
	if uupp.State != "" {
		objectMap["state"] = uupp.State
	}
	if uupp.Note != nil {
		objectMap["note"] = uupp.Note
	}
	return json.Marshal(objectMap)
}
