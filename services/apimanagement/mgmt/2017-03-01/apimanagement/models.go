...
// AttachmentContentFormat enumerates the values for attachment content format.
type AttachmentContentFormat string

const (
	// Link The Content is a link.
	Link AttachmentContentFormat = "link"
)

// PossibleAttachmentContentFormatValues returns an array of possible values for the AttachmentContentFormat const type.
func PossibleAttachmentContentFormatValues() []AttachmentContentFormat {
	return []AttachmentContentFormat{Link}
}
...
type IssueAttachmentContractProperties struct {
	...
	Title *string `json:"title,omitempty"`
	// ContentFormat - Content format. Possible values include: 'Link'
	ContentFormat AttachmentContentFormat `json:"contentFormat,omitempty"`
	// Content - An HTTP link to the attachment.
	Content *string `json:"content,omitempty"`
}

// IssueAttachmentPutContract issue Attachment Contract details.
type IssueAttachmentPutContract struct {
	// IssueAttachmentContractProperties - Properties of the Issue Attachment for the Put operation.
	*IssueAttachmentContractProperties `json:"properties,omitempty"`
	// ID - Resource ID.
	ID *string `json:"id,omitempty"`
	// Name - Resource name.
...
// MarshalJSON is the custom marshaler for IssueAttachmentPutContract.
func (iapc IssueAttachmentPutContract) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if iapc.IssueAttachmentContractProperties != nil {
		objectMap["properties"] = iapc.IssueAttachmentContractProperties
	}
	if iapc.ID != nil {
		objectMap["id"] = iapc.ID
	}
	if iapc.Name != nil {
		objectMap["name"] = iapc.Name
	}
	if iapc.Type != nil {
		objectMap["type"] = iapc.Type
	}
	return json.Marshal(objectMap)
}

// UnmarshalJSON is the custom unmarshaler for IssueAttachmentPutContract struct.
func (iapc *IssueAttachmentPutContract) UnmarshalJSON(body []byte) error {
	var m map[string]*json.RawMessage
	err := json.Unmarshal(body, &m)
	if err != nil {
		return err
	...
	for k, v := range m {
		...
		case "properties":
			if v != nil {
				...
				iapc.IssueAttachmentContractProperties = &issueAttachmentContractProperties
			}
		case "id":
			if v != nil {
				var ID string
...
// IssueAttachmentPutContractProperties issue Attachment contract Properties for the Put operation.
type IssueAttachmentPutContractProperties struct {
	// Title - Short description of the attachment.
	Title *string `json:"title,omitempty"`
	...
	Content *string `json:"content,omitempty"`
	// FileName - If contentFormat is not a 'link', filename by which the binary data will be saved.
