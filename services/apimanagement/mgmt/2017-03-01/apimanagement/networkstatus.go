...
// locationName is location in which the API Management service is deployed. This is one of the Azure Regions like West
// US, East US, South Central US.
func (client NetworkStatusClient) ListByLocation(resourceGroupName string, serviceName string, locationName string) (result NetworkStatusContract, err error) {
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewErrorWithValidationError(err, "apimanagement.NetworkStatusClient", "ListByLocation")
	}

	req, err := client.ListByLocationPreparer(resourceGroupName, serviceName, locationName)
	if err != nil {
...
func (client NetworkStatusClient) ListByLocationPreparer(resourceGroupName string, serviceName string, locationName string) (*http.Request, error) {
...
//
// resourceGroupName is the name of the resource group. serviceName is the name of the API Management service.
func (client NetworkStatusClient) ListByService(resourceGroupName string, serviceName string) (result NetworkStatusContract, err error) {
	if err := validation.Validate([]validation.Validation{
		{TargetValue: serviceName,
			Constraints: []validation.Constraint{{Target: "serviceName", Name: validation.MaxLength, Rule: 50, Chain: nil},
				{Target: "serviceName", Name: validation.MinLength, Rule: 1, Chain: nil},
				{Target: "serviceName", Name: validation.Pattern, Rule: `^[a-zA-Z](?:[a-zA-Z0-9-]*[a-zA-Z0-9])?$`, Chain: nil}}}}); err != nil {
		return result, validation.NewErrorWithValidationError(err, "apimanagement.NetworkStatusClient", "ListByService")
	}
...
func (client NetworkStatusClient) ListByServicePreparer(resourceGroupName string, serviceName string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"serviceName":       autorest.Encode("path", serviceName),
		"subscriptionId":    autorest.Encode("path", client.SubscriptionID),
