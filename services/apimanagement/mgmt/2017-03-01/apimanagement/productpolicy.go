...
// productID is product identifier. Must be unique in the current API Management service instance. policyID is the
// identifier of the Policy. parameters is the policy contents to apply.
func (client ProductPolicyClient) CreateOrUpdate(resourceGroupName string, serviceName string, productID string, policyID string, parameters PolicyContract) (result PolicyContract, err error) {
	...
	req, err := client.CreateOrUpdatePreparer(resourceGroupName, serviceName, productID, policyID, parameters)
	if err != nil {
...
func (client ProductPolicyClient) CreateOrUpdatePreparer(resourceGroupName string, serviceName string, productID string, policyID string, parameters PolicyContract) (*http.Request, error) {
...
// resourceGroupName is the name of the resource group. serviceName is the name of the API Management service.
// productID is product identifier. Must be unique in the current API Management service instance. policyID is the
// identifier of the Policy. ifMatch is the entity state (Etag) version of the product policy to update. A value of "*"
// can be used for If-Match to unconditionally apply the operation.
func (client ProductPolicyClient) Delete(resourceGroupName string, serviceName string, productID string, policyID string, ifMatch string) (result autorest.Response, err error) {
	if err := validation.Validate([]validation.Validation{
		{TargetValue: serviceName,
			Constraints: []validation.Constraint{{Target: "serviceName", Name: validation.MaxLength, Rule: 50, Chain: nil},
				{Target: "serviceName", Name: validation.MinLength, Rule: 1, Chain: nil},
	...
	req, err := client.DeletePreparer(resourceGroupName, serviceName, productID, policyID, ifMatch)
	if err != nil {
...
func (client ProductPolicyClient) DeletePreparer(resourceGroupName string, serviceName string, productID string, policyID string, ifMatch string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"policyId":          autorest.Encode("path", policyID),
		"productId":         autorest.Encode("path", productID),
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
...
func (client ProductPolicyClient) Get(resourceGroupName string, serviceName string, productID string, policyID string) (result PolicyContract, err error) {
	if err := validation.Validate([]validation.Validation{
		{TargetValue: serviceName,
			Constraints: []validation.Constraint{{Target: "serviceName", Name: validation.MaxLength, Rule: 50, Chain: nil},
				{Target: "serviceName", Name: validation.MinLength, Rule: 1, Chain: nil},
	...
	req, err := client.GetPreparer(resourceGroupName, serviceName, productID, policyID)
	if err != nil {
...
func (client ProductPolicyClient) GetPreparer(resourceGroupName string, serviceName string, productID string, policyID string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"policyId":          autorest.Encode("path", policyID),
		"productId":         autorest.Encode("path", productID),
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
...
func (client ProductPolicyClient) ListByProduct(resourceGroupName string, serviceName string, productID string) (result PolicyCollection, err error) {
	if err := validation.Validate([]validation.Validation{
		{TargetValue: serviceName,
			Constraints: []validation.Constraint{{Target: "serviceName", Name: validation.MaxLength, Rule: 50, Chain: nil},
				{Target: "serviceName", Name: validation.MinLength, Rule: 1, Chain: nil},
		...
		{TargetValue: productID,
			Constraints: []validation.Constraint{{Target: "productID", Name: validation.MaxLength, Rule: 256, Chain: nil},
				{Target: "productID", Name: validation.MinLength, Rule: 1, Chain: nil},
				{Target: "productID", Name: validation.Pattern, Rule: `^[^*#&+:<>?]+$`, Chain: nil}}}}); err != nil {
		return result, validation.NewErrorWithValidationError(err, "apimanagement.ProductPolicyClient", "ListByProduct")
	}

	req, err := client.ListByProductPreparer(resourceGroupName, serviceName, productID)
	if err != nil {
...
func (client ProductPolicyClient) ListByProductPreparer(resourceGroupName string, serviceName string, productID string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"productId":         autorest.Encode("path", productID),
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"serviceName":       autorest.Encode("path", serviceName),
