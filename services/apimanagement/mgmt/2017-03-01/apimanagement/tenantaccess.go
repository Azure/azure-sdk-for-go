...
// accessName is the identifier of the Access configuration.
func (client TenantAccessClient) Get(resourceGroupName string, serviceName string, accessName string) (result AccessInformationContract, err error) {
	...
	req, err := client.GetPreparer(resourceGroupName, serviceName, accessName)
	if err != nil {
...
func (client TenantAccessClient) GetPreparer(resourceGroupName string, serviceName string, accessName string) (*http.Request, error) {
...
// resourceGroupName is the name of the resource group. serviceName is the name of the API Management service.
// accessName is the identifier of the Access configuration.
func (client TenantAccessClient) RegeneratePrimaryKey(resourceGroupName string, serviceName string, accessName string) (result autorest.Response, err error) {
	if err := validation.Validate([]validation.Validation{
		{TargetValue: serviceName,
			Constraints: []validation.Constraint{{Target: "serviceName", Name: validation.MaxLength, Rule: 50, Chain: nil},
				{Target: "serviceName", Name: validation.MinLength, Rule: 1, Chain: nil},
	...
	req, err := client.RegeneratePrimaryKeyPreparer(resourceGroupName, serviceName, accessName)
	if err != nil {
...
func (client TenantAccessClient) RegeneratePrimaryKeyPreparer(resourceGroupName string, serviceName string, accessName string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"accessName":        autorest.Encode("path", accessName),
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"serviceName":       autorest.Encode("path", serviceName),
...
// resourceGroupName is the name of the resource group. serviceName is the name of the API Management service.
// accessName is the identifier of the Access configuration.
func (client TenantAccessClient) RegenerateSecondaryKey(resourceGroupName string, serviceName string, accessName string) (result autorest.Response, err error) {
	if err := validation.Validate([]validation.Validation{
		{TargetValue: serviceName,
			Constraints: []validation.Constraint{{Target: "serviceName", Name: validation.MaxLength, Rule: 50, Chain: nil},
				{Target: "serviceName", Name: validation.MinLength, Rule: 1, Chain: nil},
	...
	req, err := client.RegenerateSecondaryKeyPreparer(resourceGroupName, serviceName, accessName)
	if err != nil {
...
func (client TenantAccessClient) RegenerateSecondaryKeyPreparer(resourceGroupName string, serviceName string, accessName string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"accessName":        autorest.Encode("path", accessName),
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"serviceName":       autorest.Encode("path", serviceName),
...
//
// resourceGroupName is the name of the resource group. serviceName is the name of the API Management service.
// parameters is parameters supplied to retrieve the Tenant Access Information. accessName is the identifier of the
// Access configuration. ifMatch is the entity state (Etag) version of the property to update. A value of "*" can be
// used for If-Match to unconditionally apply the operation.
func (client TenantAccessClient) Update(resourceGroupName string, serviceName string, parameters AccessInformationUpdateParameters, accessName string, ifMatch string) (result autorest.Response, err error) {
	if err := validation.Validate([]validation.Validation{
		{TargetValue: serviceName,
			Constraints: []validation.Constraint{{Target: "serviceName", Name: validation.MaxLength, Rule: 50, Chain: nil},
				{Target: "serviceName", Name: validation.MinLength, Rule: 1, Chain: nil},
	...
	req, err := client.UpdatePreparer(resourceGroupName, serviceName, parameters, accessName, ifMatch)
	if err != nil {
...
func (client TenantAccessClient) UpdatePreparer(resourceGroupName string, serviceName string, parameters AccessInformationUpdateParameters, accessName string, ifMatch string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"accessName":        autorest.Encode("path", accessName),
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"serviceName":       autorest.Encode("path", serviceName),
