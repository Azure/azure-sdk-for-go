...
func (client TenantAccessGitClient) Get(resourceGroupName string, serviceName string, accessName string) (result AccessInformationContract, err error) {
...
func (client TenantAccessGitClient) GetPreparer(resourceGroupName string, serviceName string, accessName string) (*http.Request, error) {
...
// resourceGroupName is the name of the resource group. serviceName is the name of the API Management service.
// accessName is the identifier of the Access configuration.
func (client TenantAccessGitClient) RegeneratePrimaryKey(resourceGroupName string, serviceName string, accessName string) (result autorest.Response, err error) {
	if err := validation.Validate([]validation.Validation{
		{TargetValue: serviceName,
			Constraints: []validation.Constraint{{Target: "serviceName", Name: validation.MaxLength, Rule: 50, Chain: nil},
				{Target: "serviceName", Name: validation.MinLength, Rule: 1, Chain: nil},
...
func (client TenantAccessGitClient) RegeneratePrimaryKeyPreparer(resourceGroupName string, serviceName string, accessName string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"accessName":        autorest.Encode("path", accessName),
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"serviceName":       autorest.Encode("path", serviceName),
...
// resourceGroupName is the name of the resource group. serviceName is the name of the API Management service.
// accessName is the identifier of the Access configuration.
func (client TenantAccessGitClient) RegenerateSecondaryKey(resourceGroupName string, serviceName string, accessName string) (result autorest.Response, err error) {
	if err := validation.Validate([]validation.Validation{
		{TargetValue: serviceName,
			Constraints: []validation.Constraint{{Target: "serviceName", Name: validation.MaxLength, Rule: 50, Chain: nil},
				{Target: "serviceName", Name: validation.MinLength, Rule: 1, Chain: nil},
...
func (client TenantAccessGitClient) RegenerateSecondaryKeyPreparer(resourceGroupName string, serviceName string, accessName string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"accessName":        autorest.Encode("path", accessName),
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"serviceName":       autorest.Encode("path", serviceName),
