...
// parameters is deploy Configuration parameters. configurationName is the identifier of the Git Configuration
// Operation.
func (client TenantConfigurationClient) Deploy(resourceGroupName string, serviceName string, parameters DeployConfigurationParameters, configurationName string, cancel <-chan struct{}) (<-chan OperationResultContract, <-chan error) {
	...
	go func() {
		...
		req, err := client.DeployPreparer(resourceGroupName, serviceName, parameters, configurationName, cancel)
		if err != nil {
...
func (client TenantConfigurationClient) DeployPreparer(resourceGroupName string, serviceName string, parameters DeployConfigurationParameters, configurationName string, cancel <-chan struct{}) (*http.Request, error) {
...
//
// resourceGroupName is the name of the resource group. serviceName is the name of the API Management service.
// configurationName is the identifier of the Git Configuration Operation.
func (client TenantConfigurationClient) GetSyncState(resourceGroupName string, serviceName string, configurationName string) (result TenantConfigurationSyncStateContract, err error) {
	if err := validation.Validate([]validation.Validation{
		{TargetValue: serviceName,
			Constraints: []validation.Constraint{{Target: "serviceName", Name: validation.MaxLength, Rule: 50, Chain: nil},
				{Target: "serviceName", Name: validation.MinLength, Rule: 1, Chain: nil},
				{Target: "serviceName", Name: validation.Pattern, Rule: `^[a-zA-Z](?:[a-zA-Z0-9-]*[a-zA-Z0-9])?$`, Chain: nil}}}}); err != nil {
		return result, validation.NewErrorWithValidationError(err, "apimanagement.TenantConfigurationClient", "GetSyncState")
	}

	req, err := client.GetSyncStatePreparer(resourceGroupName, serviceName, configurationName)
	if err != nil {
...
func (client TenantConfigurationClient) GetSyncStatePreparer(resourceGroupName string, serviceName string, configurationName string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"configurationName": autorest.Encode("path", configurationName),
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"serviceName":       autorest.Encode("path", serviceName),
...
//
// resourceGroupName is the name of the resource group. serviceName is the name of the API Management service.
// parameters is save Configuration parameters. configurationName is the identifier of the Git Configuration Operation.
func (client TenantConfigurationClient) Save(resourceGroupName string, serviceName string, parameters SaveConfigurationParameter, configurationName string, cancel <-chan struct{}) (<-chan OperationResultContract, <-chan error) {
	resultChan := make(chan OperationResultContract, 1)
	errChan := make(chan error, 1)
	if err := validation.Validate([]validation.Validation{
		{TargetValue: serviceName,
	...
	go func() {
		...
		req, err := client.SavePreparer(resourceGroupName, serviceName, parameters, configurationName, cancel)
		if err != nil {
...
func (client TenantConfigurationClient) SavePreparer(resourceGroupName string, serviceName string, parameters SaveConfigurationParameter, configurationName string, cancel <-chan struct{}) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"configurationName": autorest.Encode("path", configurationName),
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"serviceName":       autorest.Encode("path", serviceName),
...
//
// resourceGroupName is the name of the resource group. serviceName is the name of the API Management service.
// parameters is validate Configuration parameters. configurationName is the identifier of the Git Configuration
// Operation.
func (client TenantConfigurationClient) Validate(resourceGroupName string, serviceName string, parameters DeployConfigurationParameters, configurationName string, cancel <-chan struct{}) (<-chan OperationResultContract, <-chan error) {
	resultChan := make(chan OperationResultContract, 1)
	errChan := make(chan error, 1)
	if err := validation.Validate([]validation.Validation{
		{TargetValue: serviceName,
	...
	go func() {
		...
		req, err := client.ValidatePreparer(resourceGroupName, serviceName, parameters, configurationName, cancel)
		if err != nil {
...
func (client TenantConfigurationClient) ValidatePreparer(resourceGroupName string, serviceName string, parameters DeployConfigurationParameters, configurationName string, cancel <-chan struct{}) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"configurationName": autorest.Encode("path", configurationName),
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"serviceName":       autorest.Encode("path", serviceName),
