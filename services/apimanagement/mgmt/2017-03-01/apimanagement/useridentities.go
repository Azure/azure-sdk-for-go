...
func (client UserIdentitiesClient) List(resourceGroupName string, serviceName string, UID string) (result UserIdentityCollection, err error) {
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewErrorWithValidationError(err, "apimanagement.UserIdentitiesClient", "List")
	}

	req, err := client.ListPreparer(resourceGroupName, serviceName, UID)
	if err != nil {
...
func (client UserIdentitiesClient) ListPreparer(resourceGroupName string, serviceName string, UID string) (*http.Request, error) {
