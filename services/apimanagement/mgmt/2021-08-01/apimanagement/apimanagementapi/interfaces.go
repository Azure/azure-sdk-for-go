...
type BaseClientAPI interface {
	PerformConnectivityCheckAsync(ctx context.Context, resourceGroupName string, serviceName string, connectivityCheckRequestParams apimanagement.ConnectivityCheckRequest) (result apimanagement.PerformConnectivityCheckAsyncFuture, err error)
}

var _ BaseClientAPI = (*apimanagement.BaseClient)(nil)
...
var _ DeletedServicesClientAPI = (*apimanagement.DeletedServicesClient)(nil)
...
var _ GatewayCertificateAuthorityClientAPI = (*apimanagement.GatewayCertificateAuthorityClient)(nil)
...
type OutboundNetworkDependenciesEndpointsClientAPI interface {
	ListByService(ctx context.Context, resourceGroupName string, serviceName string) (result apimanagement.OutboundEnvironmentEndpointList, err error)
}

var _ OutboundNetworkDependenciesEndpointsClientAPI = (*apimanagement.OutboundNetworkDependenciesEndpointsClient)(nil)
...
var _ PortalRevisionClientAPI = (*apimanagement.PortalRevisionClient)(nil)
...
var _ PortalSettingsClientAPI = (*apimanagement.PortalSettingsClient)(nil)
...
type PrivateEndpointConnectionClientAPI interface {
	CreateOrUpdate(ctx context.Context, resourceGroupName string, serviceName string, privateEndpointConnectionName string, privateEndpointConnectionRequest apimanagement.PrivateEndpointConnectionRequest) (result apimanagement.PrivateEndpointConnectionCreateOrUpdateFuture, err error)
	Delete(ctx context.Context, resourceGroupName string, serviceName string, privateEndpointConnectionName string) (result apimanagement.PrivateEndpointConnectionDeleteFuture, err error)
	GetByName(ctx context.Context, resourceGroupName string, serviceName string, privateEndpointConnectionName string) (result apimanagement.PrivateEndpointConnection, err error)
	GetPrivateLinkResource(ctx context.Context, resourceGroupName string, serviceName string, privateLinkSubResourceName string) (result apimanagement.PrivateLinkResource, err error)
	ListByService(ctx context.Context, resourceGroupName string, serviceName string) (result apimanagement.PrivateEndpointConnectionListResult, err error)
	ListPrivateLinkResources(ctx context.Context, resourceGroupName string, serviceName string) (result apimanagement.PrivateLinkResourceListResult, err error)
}

var _ PrivateEndpointConnectionClientAPI = (*apimanagement.PrivateEndpointConnectionClient)(nil)
...
var _ TenantSettingsClientAPI = (*apimanagement.TenantSettingsClient)(nil)
...
var _ SkusClientAPI = (*apimanagement.SkusClient)(nil)
