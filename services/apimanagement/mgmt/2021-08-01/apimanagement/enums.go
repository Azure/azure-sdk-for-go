...
func PossibleAccessTypeValues() []AccessType {
	return []AccessType{AccessTypeAccessKey, AccessTypeSystemAssignedManagedIdentity, AccessTypeUserAssignedManagedIdentity}
}
...
func PossibleAPITypeValues() []APIType {
	return []APIType{APITypeGraphql, APITypeHTTP, APITypeSoap, APITypeWebsocket}
}
...
func PossibleContentFormatValues() []ContentFormat {
	return []ContentFormat{ContentFormatGraphqlLink, ContentFormatOpenapi, ContentFormatOpenapijson, ContentFormatOpenapijsonLink, ContentFormatOpenapiLink, ContentFormatSwaggerJSON, ContentFormatSwaggerLinkJSON, ContentFormatWadlLinkJSON, ContentFormatWadlXML, ContentFormatWsdl, ContentFormatWsdlLink}
}
...
func PossiblePlatformVersionValues() []PlatformVersion {
	return []PlatformVersion{PlatformVersionMtv1, PlatformVersionStv1, PlatformVersionStv2, PlatformVersionUndetermined}
}
...
func PossiblePreferredIPVersionValues() []PreferredIPVersion {
	return []PreferredIPVersion{PreferredIPVersionIPv4}
}
...
func PossibleSoapAPITypeValues() []SoapAPIType {
	return []SoapAPIType{SoapAPITypeGraphQL, SoapAPITypeSoapPassThrough, SoapAPITypeSoapToRest, SoapAPITypeWebSocket}
}
