...
// AccessType enumerates the values for access type.
type AccessType string

const (
	// AccessKey Use access key.
	AccessKey AccessType = "AccessKey"
	// SystemAssignedManagedIdentity Use system assigned managed identity.
	SystemAssignedManagedIdentity AccessType = "SystemAssignedManagedIdentity"
	// UserAssignedManagedIdentity Use user assigned managed identity.
	UserAssignedManagedIdentity AccessType = "UserAssignedManagedIdentity"
)

// PossibleAccessTypeValues returns an array of possible values for the AccessType const type.
func PossibleAccessTypeValues() []AccessType {
	return []AccessType{AccessKey, SystemAssignedManagedIdentity, UserAssignedManagedIdentity}
}
...
func PossibleAPITypeValues() []APIType {
	return []APIType{Graphql, HTTP, Soap, Websocket}
}
...
const (
	// BuiltIn ...
	BuiltIn CertificateSource = "BuiltIn"
	// Custom ...
	Custom CertificateSource = "Custom"
	// KeyVault ...
	KeyVault CertificateSource = "KeyVault"
	// Managed ...
...
func PossibleCertificateSourceValues() []CertificateSource {
	return []CertificateSource{BuiltIn, Custom, KeyVault, Managed}
}
...
func PossibleConnectionStatusValues() []ConnectionStatus {
	return []ConnectionStatus{Connected, Degraded, Disconnected, Unknown}
}

// ConnectivityCheckProtocol enumerates the values for connectivity check protocol.
...
// PossibleConnectivityCheckProtocolValues returns an array of possible values for the ConnectivityCheckProtocol const type.
func PossibleConnectivityCheckProtocolValues() []ConnectivityCheckProtocol {
	return []ConnectivityCheckProtocol{ConnectivityCheckProtocolHTTP, ConnectivityCheckProtocolHTTPS, ConnectivityCheckProtocolTCP}
}
...
const (
	...
	GraphqlLink ContentFormat = "graphql-link"
...
func PossibleContentFormatValues() []ContentFormat {
	return []ContentFormat{GraphqlLink, Openapi, Openapijson, OpenapijsonLink, OpenapiLink, SwaggerJSON, SwaggerLinkJSON, WadlLinkJSON, WadlXML, Wsdl, WsdlLink}
}
...
// Method enumerates the values for method.
type Method string
...
// PossibleMethodValues returns an array of possible values for the Method const type.
...
func PossibleOriginValues() []Origin {
	return []Origin{Inbound, Local, Outbound}
}

// PlatformVersion enumerates the values for platform version.
type PlatformVersion string

const (
	// Mtv1 Platform running the service on Multi Tenant V1 platform.
	Mtv1 PlatformVersion = "mtv1"
	// Stv1 Platform running the service on Single Tenant V1 platform.
	Stv1 PlatformVersion = "stv1"
	// Stv2 Platform running the service on Single Tenant V2 platform.
	Stv2 PlatformVersion = "stv2"
	// Undetermined Platform version cannot be determined, as compute platform is not deployed.
	Undetermined PlatformVersion = "undetermined"
)

// PossiblePlatformVersionValues returns an array of possible values for the PlatformVersion const type.
func PossiblePlatformVersionValues() []PlatformVersion {
	return []PlatformVersion{Mtv1, Stv1, Stv2, Undetermined}
}
...
func PossiblePreferredIPVersionValues() []PreferredIPVersion {
	return []PreferredIPVersion{IPv4}
}
...
const (
	...
	WebSocket SoapAPIType = "websocket"
)
...
func PossibleSoapAPITypeValues() []SoapAPIType {
	return []SoapAPIType{GraphQL, SoapPassThrough, SoapToRest, WebSocket}
}
