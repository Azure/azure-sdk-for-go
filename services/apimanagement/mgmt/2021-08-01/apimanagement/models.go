...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/apimanagement/mgmt/2021-08-01/apimanagement"
...
type AdditionalLocation struct {
	...
	// PlatformVersion - READ-ONLY; Compute Platform Version running the service. Possible values include: 'Undetermined', 'Stv1', 'Stv2', 'Mtv1'
...
type APIContractProperties struct {
	...
	// APIType - Type of API. Possible values include: 'HTTP', 'Soap', 'Websocket', 'Graphql'
...
type APICreateOrUpdateProperties struct {
	...
	// Format - Format of the Content in which the API is getting imported. Possible values include: 'WadlXML', 'WadlLinkJSON', 'SwaggerJSON', 'SwaggerLinkJSON', 'Wsdl', 'WsdlLink', 'Openapi', 'Openapijson', 'OpenapiLink', 'OpenapijsonLink', 'GraphqlLink'
...
// ConnectivityCheckRequest a request to perform the connectivity check operation on a API Management
// service.
type ConnectivityCheckRequest struct {
	// Source - Definitions about the connectivity check origin.
	Source *ConnectivityCheckRequestSource `json:"source,omitempty"`
	// Destination - The connectivity check operation destination.
	Destination *ConnectivityCheckRequestDestination `json:"destination,omitempty"`
	// PreferredIPVersion - The IP version to be used. Only IPv4 is supported for now. Possible values include: 'IPv4'
	PreferredIPVersion PreferredIPVersion `json:"preferredIPVersion,omitempty"`
	// Protocol - The request's protocol. Specific protocol configuration can be available based on this selection. The specified destination address must be coherent with this value. Possible values include: 'ConnectivityCheckProtocolTCP', 'ConnectivityCheckProtocolHTTP', 'ConnectivityCheckProtocolHTTPS'
...
type ConnectivityCheckRequestDestination struct {
	// Address - Destination address. Can either be an IP address or a FQDN.
...
type ConnectivityCheckRequestProtocolConfiguration struct {
	// HTTPConfiguration - Configuration for HTTP or HTTPS requests.
...
type ConnectivityCheckRequestProtocolConfigurationHTTPConfiguration struct {
	// Method - The HTTP method to be used. Possible values include: 'MethodGET', 'MethodPOST'
	Method Method `json:"method,omitempty"`
	// ValidStatusCodes - List of HTTP status codes considered valid for the request response.
...
type ConnectivityCheckRequestSource struct {
	// Region - The API Management service region from where to start the connectivity check operation.
	Region *string `json:"region,omitempty"`
	// Instance - The particular VMSS instance from which to fire the request.
...
type ConnectivityCheckResponse struct {
	...
	// ConnectionStatus - READ-ONLY; The connection status. Possible values include: 'Unknown', 'Connected', 'Disconnected', 'Degraded'
...
// MarshalJSON is the custom marshaler for ConnectivityCheckResponse.
func (ccr ConnectivityCheckResponse) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	return json.Marshal(objectMap)
}
...
type ConnectivityIssue struct {
	// Origin - READ-ONLY; The origin of the issue. Possible values include: 'Local', 'Inbound', 'Outbound'
	Origin Origin `json:"origin,omitempty"`
	// Severity - READ-ONLY; The severity of the issue. Possible values include: 'Error', 'Warning'
...
type DataMaskingEntity struct {
	...
	Value *string `json:"value,omitempty"`
	// Mode - Data masking mode. Possible values include: 'Mask', 'Hide'
...
type DiagnosticContractProperties struct {
	...
	// OperationNameFormat - The format of the Operation Name for Application Insights telemetries. Default is Name. Possible values include: 'Name', 'URL'
...
// EndpointDetail current TCP connectivity information from the Api Management Service to a single
// endpoint.
type EndpointDetail struct {
	// Port - The port an endpoint is connected to.
	Port *int32 `json:"port,omitempty"`
	// Region - The region of the dependency.
	Region *string `json:"region,omitempty"`
}
...
type HostnameConfiguration struct {
	...
	// Certificate - Certificate information.
	Certificate *CertificateInformation `json:"certificate,omitempty"`
	// CertificateSource - Certificate Source. Possible values include: 'Managed', 'KeyVault', 'Custom', 'BuiltIn'
...
type LoggerContractProperties struct {
	// LoggerType - Logger type. Possible values include: 'AzureEventHub', 'ApplicationInsights', 'AzureMonitor'
...
// OutboundEnvironmentEndpoint endpoints accessed for a common purpose that the Api Management Service
// requires outbound network access to.
type OutboundEnvironmentEndpoint struct {
	// Category - The type of service accessed by the Api Management Service, e.g., Azure Storage, Azure SQL Database, and Azure Active Directory.
	Category *string `json:"category,omitempty"`
	// Endpoints - The endpoints that the Api Management Service reaches the service at.
...
// PerformConnectivityCheckAsyncFuture an abstraction for monitoring and retrieving the results of a
// long-running operation.
type PerformConnectivityCheckAsyncFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(BaseClient) (ConnectivityCheckResponse, error)
}

// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *PerformConnectivityCheckAsyncFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for PerformConnectivityCheckAsyncFuture.Result.
func (future *PerformConnectivityCheckAsyncFuture) result(client BaseClient) (ccr ConnectivityCheckResponse, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "apimanagement.PerformConnectivityCheckAsyncFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		ccr.Response.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("apimanagement.PerformConnectivityCheckAsyncFuture")
		return
	}
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if ccr.Response.Response, err = future.GetResult(sender); err == nil && ccr.Response.Response.StatusCode != http.StatusNoContent {
		ccr, err = client.PerformConnectivityCheckAsyncResponder(ccr.Response.Response)
		if err != nil {
			err = autorest.NewErrorWithError(err, "apimanagement.PerformConnectivityCheckAsyncFuture", "Result", ccr.Response.Response, "Failure responding to request")
		}
	}
	return
}
...
// PrivateEndpointConnectionCreateOrUpdateFuture an abstraction for monitoring and retrieving the results
// of a long-running operation.
type PrivateEndpointConnectionCreateOrUpdateFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
...
// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *PrivateEndpointConnectionCreateOrUpdateFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for PrivateEndpointConnectionCreateOrUpdateFuture.Result.
func (future *PrivateEndpointConnectionCreateOrUpdateFuture) result(client PrivateEndpointConnectionClient) (pec PrivateEndpointConnection, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "apimanagement.PrivateEndpointConnectionCreateOrUpdateFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		pec.Response.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("apimanagement.PrivateEndpointConnectionCreateOrUpdateFuture")
		return
	}
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if pec.Response.Response, err = future.GetResult(sender); err == nil && pec.Response.Response.StatusCode != http.StatusNoContent {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "apimanagement.PrivateEndpointConnectionCreateOrUpdateFuture", "Result", pec.Response.Response, "Failure responding to request")
		}
	}
	return
}
...
func (future *PrivateEndpointConnectionDeleteFuture) result(client PrivateEndpointConnectionClient) (ar autorest.Response, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "apimanagement.PrivateEndpointConnectionDeleteFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		ar.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("apimanagement.PrivateEndpointConnectionDeleteFuture")
		return
	}
	ar.Response = future.Response()
	return
...
type PrivateEndpointConnectionWrapperProperties struct {
	...
	// PrivateLinkServiceConnectionState - A collection of information about the state of the connection between service consumer and provider.
	PrivateLinkServiceConnectionState *PrivateLinkServiceConnectionState `json:"privateLinkServiceConnectionState,omitempty"`
	// ProvisioningState - READ-ONLY; The provisioning state of the private endpoint connection resource.
	ProvisioningState *string `json:"provisioningState,omitempty"`
	// GroupIds - READ-ONLY; All the Group ids.
	GroupIds *[]string `json:"groupIds,omitempty"`
}

// MarshalJSON is the custom marshaler for PrivateEndpointConnectionWrapperProperties.
func (pecwp PrivateEndpointConnectionWrapperProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if pecwp.PrivateEndpoint != nil {
		objectMap["privateEndpoint"] = pecwp.PrivateEndpoint
	}
	if pecwp.PrivateLinkServiceConnectionState != nil {
		objectMap["privateLinkServiceConnectionState"] = pecwp.PrivateLinkServiceConnectionState
	}
	return json.Marshal(objectMap)
}
...
type RemotePrivateEndpointConnectionWrapper struct {
	...
	Type *string `json:"type,omitempty"`
	// PrivateEndpointConnectionWrapperProperties - Resource properties.
	*PrivateEndpointConnectionWrapperProperties `json:"properties,omitempty"`
}

// MarshalJSON is the custom marshaler for RemotePrivateEndpointConnectionWrapper.
func (rpecw RemotePrivateEndpointConnectionWrapper) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if rpecw.ID != nil {
		objectMap["id"] = rpecw.ID
	}
	if rpecw.Name != nil {
		objectMap["name"] = rpecw.Name
	}
	if rpecw.Type != nil {
		objectMap["type"] = rpecw.Type
	}
	if rpecw.PrivateEndpointConnectionWrapperProperties != nil {
		objectMap["properties"] = rpecw.PrivateEndpointConnectionWrapperProperties
	}
	return json.Marshal(objectMap)
}

// UnmarshalJSON is the custom unmarshaler for RemotePrivateEndpointConnectionWrapper struct.
func (rpecw *RemotePrivateEndpointConnectionWrapper) UnmarshalJSON(body []byte) error {
	var m map[string]*json.RawMessage
	err := json.Unmarshal(body, &m)
	if err != nil {
		return err
	...
	for k, v := range m {
		...
		case "properties":
			if v != nil {
				var privateEndpointConnectionWrapperProperties PrivateEndpointConnectionWrapperProperties
				err = json.Unmarshal(*v, &privateEndpointConnectionWrapperProperties)
				if err != nil {
					return err
				}
				rpecw.PrivateEndpointConnectionWrapperProperties = &privateEndpointConnectionWrapperProperties
			}
		}
	}
...
// MarshalJSON is the custom marshaler for RepresentationContract.
func (rc RepresentationContract) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if rc.ContentType != nil {
		objectMap["contentType"] = rc.ContentType
	}
	if rc.SchemaID != nil {
		objectMap["schemaId"] = rc.SchemaID
	}
	if rc.TypeName != nil {
		objectMap["typeName"] = rc.TypeName
	}
	if rc.FormParameters != nil {
		objectMap["formParameters"] = rc.FormParameters
	}
	if rc.Examples != nil {
		objectMap["examples"] = rc.Examples
	}
	return json.Marshal(objectMap)
}
...
type ServiceBackupRestoreParameters struct {
	// StorageAccount - The name of the Azure storage account (used to place/retrieve the backup).
	StorageAccount *string `json:"storageAccount,omitempty"`
	// ContainerName - The name of the blob container (used to place/retrieve the backup).
	ContainerName *string `json:"containerName,omitempty"`
	// BackupName - The name of the backup file to create/retrieve.
	BackupName *string `json:"backupName,omitempty"`
	// AccessType - The type of access to be used for the storage account. Possible values include: 'AccessKey', 'SystemAssignedManagedIdentity', 'UserAssignedManagedIdentity'
	AccessType AccessType `json:"accessType,omitempty"`
	// AccessKey - Storage account access key. Required only if `accessType` is set to `AccessKey`.
	AccessKey *string `json:"accessKey,omitempty"`
	// ClientID - The Client ID of user assigned managed identity. Required only if `accessType` is set to `UserAssignedManagedIdentity`.
	ClientID *string `json:"clientId,omitempty"`
}
...
type ServiceBaseProperties struct {
	...
	PublicIPAddressID *string `json:"publicIpAddressId,omitempty"`
	// PublicNetworkAccess - Whether or not public endpoint access is allowed for this API Management service.  Value is optional but if passed in, must be 'Enabled' or 'Disabled'. If 'Disabled', private endpoints are the exclusive access method. Default value is 'Enabled'. Possible values include: 'Enabled', 'Disabled'
	...
	// PlatformVersion - READ-ONLY; Compute Platform Version running the service in this location. Possible values include: 'Undetermined', 'Stv1', 'Stv2', 'Mtv1'
	PlatformVersion PlatformVersion `json:"platformVersion,omitempty"`
}
...
func (sbp ServiceBaseProperties) MarshalJSON() ([]byte, error) {
	...
	if sbp.PublicNetworkAccess != "" {
		objectMap["publicNetworkAccess"] = sbp.PublicNetworkAccess
	}
	...
	if sbp.PrivateEndpointConnections != nil {
		objectMap["privateEndpointConnections"] = sbp.PrivateEndpointConnections
	}
	return json.Marshal(objectMap)
}
...
func (sup ServiceUpdateProperties) MarshalJSON() ([]byte, error) {
	...
	if sup.PublicNetworkAccess != "" {
		objectMap["publicNetworkAccess"] = sup.PublicNetworkAccess
	}
	...
	if sup.PrivateEndpointConnections != nil {
		objectMap["privateEndpointConnections"] = sup.PrivateEndpointConnections
	}
	return json.Marshal(objectMap)
}
