...
type AdditionalLocation struct {
	...
	// PlatformVersion - READ-ONLY; Compute Platform Version running the service. Possible values include: 'PlatformVersionUndetermined', 'PlatformVersionStv1', 'PlatformVersionStv2', 'PlatformVersionMtv1'
...
type APIContractProperties struct {
	...
	// APIType - Type of API. Possible values include: 'APITypeHTTP', 'APITypeSoap', 'APITypeWebsocket', 'APITypeGraphql'
...
type APICreateOrUpdateProperties struct {
	...
	//  * `graphql` creates GraphQL API. Possible values include: 'SoapAPITypeSoapToRest', 'SoapAPITypeSoapPassThrough', 'SoapAPITypeWebSocket', 'SoapAPITypeGraphQL'
...
type ConnectivityCheckRequest struct {
	...
	// PreferredIPVersion - The IP version to be used. Only IPv4 is supported for now. Possible values include: 'PreferredIPVersionIPv4'
...
type ServiceBackupRestoreParameters struct {
	...
	// AccessType - The type of access to be used for the storage account. Possible values include: 'AccessTypeAccessKey', 'AccessTypeSystemAssignedManagedIdentity', 'AccessTypeUserAssignedManagedIdentity'
...
type ServiceBaseProperties struct {
	...
	PublicIPAddressID *string `json:"publicIpAddressId,omitempty"`
	// PublicNetworkAccess - Whether or not public endpoint access is allowed for this API Management service.  Value is optional but if passed in, must be 'Enabled' or 'Disabled'. If 'Disabled', private endpoints are the exclusive access method. Default value is 'Enabled'. Possible values include: 'PublicNetworkAccessEnabled', 'PublicNetworkAccessDisabled'
	...
	// PlatformVersion - READ-ONLY; Compute Platform Version running the service in this location. Possible values include: 'PlatformVersionUndetermined', 'PlatformVersionStv1', 'PlatformVersionStv2', 'PlatformVersionMtv1'
	PlatformVersion PlatformVersion `json:"platformVersion,omitempty"`
}
