...
const (
	// FavoriteSourceEvents ...
	FavoriteSourceEvents FavoriteSourceType = "events"
	// FavoriteSourceFunnel ...
	FavoriteSourceFunnel FavoriteSourceType = "funnel"
	// FavoriteSourceImpact ...
	FavoriteSourceImpact FavoriteSourceType = "impact"
	// FavoriteSourceNone represents an empty FavoriteSourceType.
	FavoriteSourceNone FavoriteSourceType = ""
	// FavoriteSourceNotebook ...
	FavoriteSourceNotebook FavoriteSourceType = "notebook"
	// FavoriteSourceRetention ...
	FavoriteSourceRetention FavoriteSourceType = "retention"
	// FavoriteSourceSegmentation ...
	FavoriteSourceSegmentation FavoriteSourceType = "segmentation"
	// FavoriteSourceSessions ...
	FavoriteSourceSessions FavoriteSourceType = "sessions"
	// FavoriteSourceUserflows ...
	FavoriteSourceUserflows FavoriteSourceType = "userflows"
)
...
const (
	// FavoriteNone represents an empty FavoriteType.
	FavoriteNone FavoriteType = ""
	// FavoriteShared ...
	FavoriteShared FavoriteType = "shared"
	// FavoriteUser ...
	FavoriteUser FavoriteType = "user"
)
...
type ApplicationInsightsComponentFavorite struct {
	...
	// FavoriteType - Enum indicating if this favorite definition is owned by a specific user or is shared between all users with access to the Application Insights component. Possible values include: 'Shared', 'User', 'None'
...
// Response returns the raw HTTP response object.
func (aicf ApplicationInsightsComponentFavorite) Response() *http.Response {
	return aicf.rawResponse
}

// StatusCode returns the HTTP status code of the response, e.g. 200.
func (aicf ApplicationInsightsComponentFavorite) StatusCode() int {
	return aicf.rawResponse.StatusCode
}

// Status returns the HTTP status message of the response, e.g. "200 OK".
func (aicf ApplicationInsightsComponentFavorite) Status() string {
	return aicf.rawResponse.Status
}
...
// ApplicationInsightsComponentWebTestLocation - Properties that define a web test location available to an Application
// Insights Component.
...
// ApplicationInsightsWebTestLocationsListResult - Describes the list of web test locations available to an Application
// Insights Component.
...
// Response returns the raw HTTP response object.
func (aiwtllr ApplicationInsightsWebTestLocationsListResult) Response() *http.Response {
	return aiwtllr.rawResponse
}

// StatusCode returns the HTTP status code of the response, e.g. 200.
func (aiwtllr ApplicationInsightsWebTestLocationsListResult) StatusCode() int {
	return aiwtllr.rawResponse.StatusCode
}

// Status returns the HTTP status message of the response, e.g. "200 OK".
func (aiwtllr ApplicationInsightsWebTestLocationsListResult) Status() string {
	return aiwtllr.rawResponse.Status
}
