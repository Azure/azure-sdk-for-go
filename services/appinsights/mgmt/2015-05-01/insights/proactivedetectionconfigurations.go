...
// Delete delete a ProactiveDetection configuration of an Application Insights component.
//
...
// component.
func (client ProactiveDetectionConfigurationsClient) Delete(ctx context.Context, resourceGroupName string, resourceName string, configurationID string) (result autorest.Response, err error) {
	req, err := client.DeletePreparer(ctx, resourceGroupName, resourceName, configurationID)
	if err != nil {
		err = autorest.NewErrorWithError(err, "insights.ProactiveDetectionConfigurationsClient", "Delete", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "insights.ProactiveDetectionConfigurationsClient", "Delete", resp, "Failure sending request")
		return
	}

	result, err = client.DeleteResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "insights.ProactiveDetectionConfigurationsClient", "Delete", resp, "Failure responding to request")
	}
...
func (client ProactiveDetectionConfigurationsClient) DeletePreparer(ctx context.Context, resourceGroupName string, resourceName string, configurationID string) (*http.Request, error) {
...
func (client ProactiveDetectionConfigurationsClient) DeleteSender(req *http.Request) (*http.Response, error) {
...
func (client ProactiveDetectionConfigurationsClient) DeleteResponder(resp *http.Response) (result autorest.Response, err error) {
