...
//
// resourceGroupName is the name of the resource group. category is category of workbook to return. tags is tags
// presents on each workbook returned. canFetchContent is flag indicating whether or not to return the full content
// for each applicable workbook. If false, only return summary content for workbooks.
