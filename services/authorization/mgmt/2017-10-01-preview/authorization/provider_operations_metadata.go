...
// values.
func (client ProviderOperationsMetadataClient) Get(ctx context.Context, resourceProviderNamespace string, expand *string) (*ProviderOperationsMetadata, error) {
...
func (client ProviderOperationsMetadataClient) getPreparer(resourceProviderNamespace string, expand *string) (pipeline.Request, error) {
	u := client.url
