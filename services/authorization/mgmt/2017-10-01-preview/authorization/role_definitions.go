...
// definitions.
func (client RoleDefinitionsClient) GetByID(ctx context.Context, roleDefinitionID string) (*RoleDefinition, error) {
...
func (client RoleDefinitionsClient) getByIDPreparer(roleDefinitionID string) (pipeline.Request, error) {
	u := client.url
	u.Path = "/{roleDefinitionId}"
	req, err := pipeline.NewRequest("GET", u, nil)
	if err != nil {
		return req, pipeline.NewError(err, "failed to create request")
	}
