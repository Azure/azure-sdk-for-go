...
func NewClassicAdministratorsClient(subscriptionID string, resourceGroupName string, resourceProviderNamespace string) ClassicAdministratorsClient {
	return NewClassicAdministratorsClientWithBaseURI(DefaultBaseURI, subscriptionID, resourceGroupName, resourceProviderNamespace)
}

// NewClassicAdministratorsClientWithBaseURI creates an instance of the ClassicAdministratorsClient client.
func NewClassicAdministratorsClientWithBaseURI(baseURI string, subscriptionID string, resourceGroupName string, resourceProviderNamespace string) ClassicAdministratorsClient {
	return ClassicAdministratorsClient{NewWithBaseURI(baseURI, subscriptionID, resourceGroupName, resourceProviderNamespace)}
}
