...
func New(subscriptionID string, resourceGroupName string, resourceProviderNamespace string) BaseClient {
	return NewWithBaseURI(DefaultBaseURI, subscriptionID, resourceGroupName, resourceProviderNamespace)
}

// NewWithBaseURI creates an instance of the BaseClient client.
func NewWithBaseURI(baseURI string, subscriptionID string, resourceGroupName string, resourceProviderNamespace string) BaseClient {
	return BaseClient{
