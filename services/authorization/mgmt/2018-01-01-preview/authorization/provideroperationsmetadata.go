...
func NewProviderOperationsMetadataClient(subscriptionID string, resourceGroupName string, resourceProviderNamespace string) ProviderOperationsMetadataClient {
	return NewProviderOperationsMetadataClientWithBaseURI(DefaultBaseURI, subscriptionID, resourceGroupName, resourceProviderNamespace)
}

// NewProviderOperationsMetadataClientWithBaseURI creates an instance of the ProviderOperationsMetadataClient client.
func NewProviderOperationsMetadataClientWithBaseURI(baseURI string, subscriptionID string, resourceGroupName string, resourceProviderNamespace string) ProviderOperationsMetadataClient {
	return ProviderOperationsMetadataClient{NewWithBaseURI(baseURI, subscriptionID, resourceGroupName, resourceProviderNamespace)}
}
...
func (client ProviderOperationsMetadataClient) Get(ctx context.Context, expand string) (result ProviderOperationsMetadata, err error) {
	req, err := client.GetPreparer(ctx, expand)
	if err != nil {
...
func (client ProviderOperationsMetadataClient) GetPreparer(ctx context.Context, expand string) (*http.Request, error) {
