...
func (client RoleAssignmentsClient) CreateByID(ctx context.Context, roleID string, parameters RoleAssignmentCreateParameters) (*RoleAssignment, error) {
	req, err := client.createByIDPreparer(roleID, parameters)
	if err != nil {
		return nil, err
	}
...
func (client RoleAssignmentsClient) createByIDPreparer(roleID string, parameters RoleAssignmentCreateParameters) (pipeline.Request, error) {
	u := client.url
	u.Path = "/{roleId}"
	req, err := pipeline.NewRequest("PUT", u, nil)
	if err != nil {
...
func (client RoleAssignmentsClient) DeleteByID(ctx context.Context, roleID string) (*RoleAssignment, error) {
	req, err := client.deleteByIDPreparer(roleID)
	if err != nil {
		return nil, err
	}
...
func (client RoleAssignmentsClient) deleteByIDPreparer(roleID string) (pipeline.Request, error) {
	u := client.url
	u.Path = "/{roleId}"
	req, err := pipeline.NewRequest("DELETE", u, nil)
	if err != nil {
...
func (client RoleAssignmentsClient) GetByID(ctx context.Context, roleID string) (*RoleAssignment, error) {
...
func (client RoleAssignmentsClient) getByIDPreparer(roleID string) (pipeline.Request, error) {
	u := client.url
	u.Path = "/{roleId}"
	req, err := pipeline.NewRequest("GET", u, nil)
	if err != nil {
...
func (client RoleAssignmentsClient) ListForResource(ctx context.Context, parentResourcePath string, resourceType string, resourceName string, filter *string) (*RoleAssignmentListResult, error) {
	req, err := client.listForResourcePreparer(parentResourcePath, resourceType, resourceName, filter)
	if err != nil {
		return nil, err
	}
...
func (client RoleAssignmentsClient) listForResourcePreparer(parentResourcePath string, resourceType string, resourceName string, filter *string) (pipeline.Request, error) {
	u := client.url
...
// scope. Use $filter=principalId eq {id} to return all role assignments at, above or below the scope for the specified
// principal.
func (client RoleAssignmentsClient) ListForResourceGroup(ctx context.Context, filter *string) (*RoleAssignmentListResult, error) {
	req, err := client.listForResourceGroupPreparer(filter)
	if err != nil {
		return nil, err
	}
...
func (client RoleAssignmentsClient) listForResourceGroupPreparer(filter *string) (pipeline.Request, error) {
	u := client.url
