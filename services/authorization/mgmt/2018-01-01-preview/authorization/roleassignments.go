...
func NewRoleAssignmentsClient(subscriptionID string, resourceGroupName string, resourceProviderNamespace string) RoleAssignmentsClient {
	return NewRoleAssignmentsClientWithBaseURI(DefaultBaseURI, subscriptionID, resourceGroupName, resourceProviderNamespace)
}

// NewRoleAssignmentsClientWithBaseURI creates an instance of the RoleAssignmentsClient client.
func NewRoleAssignmentsClientWithBaseURI(baseURI string, subscriptionID string, resourceGroupName string, resourceProviderNamespace string) RoleAssignmentsClient {
	return RoleAssignmentsClient{NewWithBaseURI(baseURI, subscriptionID, resourceGroupName, resourceProviderNamespace)}
}
...
// is the name of the resource to get role assignments for. filter is the filter to apply on the operation. Use
...
func (client RoleAssignmentsClient) ListForResource(ctx context.Context, parentResourcePath string, resourceType string, resourceName string, filter string) (result RoleAssignmentListResultPage, err error) {
	result.fn = client.listForResourceNextResults
	req, err := client.ListForResourcePreparer(ctx, parentResourcePath, resourceType, resourceName, filter)
	if err != nil {
...
func (client RoleAssignmentsClient) ListForResourcePreparer(ctx context.Context, parentResourcePath string, resourceType string, resourceName string, filter string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
...
func (client RoleAssignmentsClient) ListForResourceComplete(ctx context.Context, parentResourcePath string, resourceType string, resourceName string, filter string) (result RoleAssignmentListResultIterator, err error) {
	result.page, err = client.ListForResource(ctx, parentResourcePath, resourceType, resourceName, filter)
	return
}
...
// scope. Use $filter=principalId eq {id} to return all role assignments at, above or below the scope for the specified
// principal.
func (client RoleAssignmentsClient) ListForResourceGroup(ctx context.Context, filter string) (result RoleAssignmentListResultPage, err error) {
	result.fn = client.listForResourceGroupNextResults
	req, err := client.ListForResourceGroupPreparer(ctx, filter)
	if err != nil {
...
func (client RoleAssignmentsClient) ListForResourceGroupPreparer(ctx context.Context, filter string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"resourceGroupName": autorest.Encode("path", client.ResourceGroupName),
		"subscriptionId":    autorest.Encode("path", client.SubscriptionID),
	}
...
func (client RoleAssignmentsClient) ListForResourceGroupComplete(ctx context.Context, filter string) (result RoleAssignmentListResultIterator, err error) {
	result.page, err = client.ListForResourceGroup(ctx, filter)
	return
}
