...
func (suc *SoftwareUpdateConfiguration) UnmarshalJSON(body []byte) error {
	...
	v = m["properties"]
	if v != nil {
		var properties SoftwareUpdateConfigurationProperties
		err = json.Unmarshal(*m["properties"], &properties)
		if err != nil {
			return err
		}
		suc.SoftwareUpdateConfigurationProperties = &properties
	}
...
func (succi *SoftwareUpdateConfigurationCollectionItem) UnmarshalJSON(body []byte) error {
	...
	v = m["properties"]
	if v != nil {
		var properties SoftwareUpdateConfigurationCollectionItemProperties
		err = json.Unmarshal(*m["properties"], &properties)
		if err != nil {
			return err
		}
		succi.SoftwareUpdateConfigurationCollectionItemProperties = &properties
	}
...
func (sucmr *SoftwareUpdateConfigurationMachineRun) UnmarshalJSON(body []byte) error {
	...
	v = m["properties"]
	if v != nil {
		var properties UpdateConfigurationMachineRunProperties
		err = json.Unmarshal(*m["properties"], &properties)
		if err != nil {
			return err
		}
		sucmr.UpdateConfigurationMachineRunProperties = &properties
	}
...
func (sucr *SoftwareUpdateConfigurationRun) UnmarshalJSON(body []byte) error {
	...
	v = m["properties"]
	if v != nil {
		var properties SoftwareUpdateConfigurationRunProperties
		err = json.Unmarshal(*m["properties"], &properties)
		if err != nil {
			return err
		}
		sucr.SoftwareUpdateConfigurationRunProperties = &properties
	}
