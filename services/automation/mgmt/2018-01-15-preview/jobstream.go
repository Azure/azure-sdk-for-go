...
// account. jobName is the job name. jobStreamID is the job stream id. clientRequestID is identifies this specific
// client request.
...
//
// resourceGroupName is name of an Azure Resource group. automationAccountName is the name of the automation
// account. jobName is the job name. filter is the filter to apply on the operation. clientRequestID is identifies
// this specific client request.
