...
// account. softwareUpdateConfigurationRunID is the Id of the software update configuration run. clientRequestID is
...
//
// resourceGroupName is name of an Azure Resource group. automationAccountName is the name of the automation
// account. clientRequestID is identifies this specific client request. filter is the filter to apply on the
// operation. You can use the following filters: 'properties/osType', 'properties/status', 'properties/startTime',
// and 'properties/softwareUpdateConfiguration/name' skip is number of entries you skip before returning results
// top is maximum number of entries returned in the results collection
