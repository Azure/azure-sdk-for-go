...
func NewSoftwareUpdateConfigurationsClient(subscriptionID string, resourceGroupName string) SoftwareUpdateConfigurationsClient {
	return NewSoftwareUpdateConfigurationsClientWithBaseURI(DefaultBaseURI, subscriptionID, resourceGroupName)
}
...
func NewSoftwareUpdateConfigurationsClientWithBaseURI(baseURI string, subscriptionID string, resourceGroupName string) SoftwareUpdateConfigurationsClient {
	return SoftwareUpdateConfigurationsClient{NewWithBaseURI(baseURI, subscriptionID, resourceGroupName)}
}

// Create create a new software update configuration with the name given in the URI.
//
// automationAccountName is the name of the automation account. softwareUpdateConfigurationName is the name of the
// software update configuration to be created. parameters is request body. clientRequestID is identifies this
// specific client request.
func (client SoftwareUpdateConfigurationsClient) Create(ctx context.Context, automationAccountName string, softwareUpdateConfigurationName string, parameters SoftwareUpdateConfiguration, clientRequestID string) (result SoftwareUpdateConfiguration, err error) {
	...
	req, err := client.CreatePreparer(ctx, automationAccountName, softwareUpdateConfigurationName, parameters, clientRequestID)
	if err != nil {
...
func (client SoftwareUpdateConfigurationsClient) CreatePreparer(ctx context.Context, automationAccountName string, softwareUpdateConfigurationName string, parameters SoftwareUpdateConfiguration, clientRequestID string) (*http.Request, error) {
...
//
// automationAccountName is the name of the automation account. softwareUpdateConfigurationName is the name of the
// software update configuration to be created. clientRequestID is identifies this specific client request.
func (client SoftwareUpdateConfigurationsClient) Delete(ctx context.Context, automationAccountName string, softwareUpdateConfigurationName string, clientRequestID string) (result autorest.Response, err error) {
	if err := validation.Validate([]validation.Validation{
		{TargetValue: client.ResourceGroupName,
			Constraints: []validation.Constraint{{Target: "client.ResourceGroupName", Name: validation.MaxLength, Rule: 90, Chain: nil},
				{Target: "client.ResourceGroupName", Name: validation.MinLength, Rule: 1, Chain: nil},
	...
	req, err := client.DeletePreparer(ctx, automationAccountName, softwareUpdateConfigurationName, clientRequestID)
	if err != nil {
...
func (client SoftwareUpdateConfigurationsClient) DeletePreparer(ctx context.Context, automationAccountName string, softwareUpdateConfigurationName string, clientRequestID string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"automationAccountName":           autorest.Encode("path", automationAccountName),
		"resourceGroupName":               autorest.Encode("path", client.ResourceGroupName),
		"softwareUpdateConfigurationName": autorest.Encode("path", softwareUpdateConfigurationName),
...
// automationAccountName is the name of the automation account. softwareUpdateConfigurationName is the name of the
// software update configuration to be created. clientRequestID is identifies this specific client request.
func (client SoftwareUpdateConfigurationsClient) GetByName(ctx context.Context, automationAccountName string, softwareUpdateConfigurationName string, clientRequestID string) (result SoftwareUpdateConfiguration, err error) {
	if err := validation.Validate([]validation.Validation{
		{TargetValue: client.ResourceGroupName,
			Constraints: []validation.Constraint{{Target: "client.ResourceGroupName", Name: validation.MaxLength, Rule: 90, Chain: nil},
				{Target: "client.ResourceGroupName", Name: validation.MinLength, Rule: 1, Chain: nil},
	...
	req, err := client.GetByNamePreparer(ctx, automationAccountName, softwareUpdateConfigurationName, clientRequestID)
	if err != nil {
...
func (client SoftwareUpdateConfigurationsClient) GetByNamePreparer(ctx context.Context, automationAccountName string, softwareUpdateConfigurationName string, clientRequestID string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"automationAccountName":           autorest.Encode("path", automationAccountName),
		"resourceGroupName":               autorest.Encode("path", client.ResourceGroupName),
		"softwareUpdateConfigurationName": autorest.Encode("path", softwareUpdateConfigurationName),
...
// request. filter is the filter to apply on the operation.
func (client SoftwareUpdateConfigurationsClient) List(ctx context.Context, automationAccountName string, clientRequestID string, filter string) (result SoftwareUpdateConfigurationListResult, err error) {
	if err := validation.Validate([]validation.Validation{
		{TargetValue: client.ResourceGroupName,
			Constraints: []validation.Constraint{{Target: "client.ResourceGroupName", Name: validation.MaxLength, Rule: 90, Chain: nil},
				{Target: "client.ResourceGroupName", Name: validation.MinLength, Rule: 1, Chain: nil},
	...
	req, err := client.ListPreparer(ctx, automationAccountName, clientRequestID, filter)
	if err != nil {
...
func (client SoftwareUpdateConfigurationsClient) ListPreparer(ctx context.Context, automationAccountName string, clientRequestID string, filter string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"automationAccountName": autorest.Encode("path", automationAccountName),
		"resourceGroupName":     autorest.Encode("path", client.ResourceGroupName),
		"subscriptionId":        autorest.Encode("path", client.SubscriptionID),
