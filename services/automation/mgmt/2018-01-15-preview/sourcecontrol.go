...
func NewSourceControlClient(subscriptionID string, resourceGroupName string) SourceControlClient {
	return NewSourceControlClientWithBaseURI(DefaultBaseURI, subscriptionID, resourceGroupName)
}

// NewSourceControlClientWithBaseURI creates an instance of the SourceControlClient client.
func NewSourceControlClientWithBaseURI(baseURI string, subscriptionID string, resourceGroupName string) SourceControlClient {
	return SourceControlClient{NewWithBaseURI(baseURI, subscriptionID, resourceGroupName)}
}

// CreateOrUpdate create a source control.
//
// automationAccountName is the name of the automation account. sourceControlName is the source control name.
// parameters is the parameters supplied to the create or update source control operation.
...
//
// automationAccountName is the name of the automation account. sourceControlName is the name of source control.
...
//
// automationAccountName is the name of the automation account. sourceControlName is the source control name.
// parameters is the parameters supplied to the update source control operation.
