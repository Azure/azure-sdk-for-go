...
func NewAgentRegistrationInformationClient(subscriptionID string, automationAccountName string, automationAccountName1 string, clientRequestID string) AgentRegistrationInformationClient {
	return NewAgentRegistrationInformationClientWithBaseURI(DefaultBaseURI, subscriptionID, automationAccountName, automationAccountName1, clientRequestID)
}

// NewAgentRegistrationInformationClientWithBaseURI creates an instance of the AgentRegistrationInformationClient
// client.
func NewAgentRegistrationInformationClientWithBaseURI(baseURI string, subscriptionID string, automationAccountName string, automationAccountName1 string, clientRequestID string) AgentRegistrationInformationClient {
	return AgentRegistrationInformationClient{NewWithBaseURI(baseURI, subscriptionID, automationAccountName, automationAccountName1, clientRequestID)}
}

// Get retrieve the automation agent registration information.
//
// resourceGroupName is name of an Azure Resource group.
func (client AgentRegistrationInformationClient) Get(ctx context.Context, resourceGroupName string) (result AgentRegistration, err error) {
...
func (client AgentRegistrationInformationClient) GetPreparer(ctx context.Context, resourceGroupName string) (*http.Request, error) {
...
// regenerated
func (client AgentRegistrationInformationClient) RegenerateKey(ctx context.Context, resourceGroupName string, parameters AgentRegistrationRegenerateKeyParameter) (result AgentRegistration, err error) {
	if err := validation.Validate([]validation.Validation{
		{TargetValue: resourceGroupName,
			Constraints: []validation.Constraint{{Target: "resourceGroupName", Name: validation.MaxLength, Rule: 90, Chain: nil},
				{Target: "resourceGroupName", Name: validation.MinLength, Rule: 1, Chain: nil},
...
func (client AgentRegistrationInformationClient) RegenerateKeyPreparer(ctx context.Context, resourceGroupName string, parameters AgentRegistrationRegenerateKeyParameter) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"automationAccountName": autorest.Encode("path", client.AutomationAccountName),
		"resourceGroupName":     autorest.Encode("path", resourceGroupName),
		"subscriptionId":        autorest.Encode("path", client.SubscriptionID),
