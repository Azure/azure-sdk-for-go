...
func (client DscCompilationJobStreamClient) ListByJob(ctx context.Context, resourceGroupName string, jobID uuid.UUID) (result JobStreamListResult, err error) {
...
func (client DscCompilationJobStreamClient) ListByJobPreparer(ctx context.Context, resourceGroupName string, jobID uuid.UUID) (*http.Request, error) {
