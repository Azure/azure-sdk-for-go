...
func NewNodeReportsClient(subscriptionID string, automationAccountName string, automationAccountName1 string, clientRequestID string) NodeReportsClient {
	return NewNodeReportsClientWithBaseURI(DefaultBaseURI, subscriptionID, automationAccountName, automationAccountName1, clientRequestID)
}

// NewNodeReportsClientWithBaseURI creates an instance of the NodeReportsClient client.
func NewNodeReportsClientWithBaseURI(baseURI string, subscriptionID string, automationAccountName string, automationAccountName1 string, clientRequestID string) NodeReportsClient {
	return NodeReportsClient{NewWithBaseURI(baseURI, subscriptionID, automationAccountName, automationAccountName1, clientRequestID)}
}
...
func (client NodeReportsClient) Get(ctx context.Context, resourceGroupName string, nodeID string, reportID string) (result DscNodeReport, err error) {
...
func (client NodeReportsClient) GetPreparer(ctx context.Context, resourceGroupName string, nodeID string, reportID string) (*http.Request, error) {
...
//
// resourceGroupName is name of an Azure Resource group. nodeID is the Dsc node id. reportID is the report id.
func (client NodeReportsClient) GetContent(ctx context.Context, resourceGroupName string, nodeID string, reportID string) (result ReadCloser, err error) {
	if err := validation.Validate([]validation.Validation{
		{TargetValue: resourceGroupName,
			Constraints: []validation.Constraint{{Target: "resourceGroupName", Name: validation.MaxLength, Rule: 90, Chain: nil},
				{Target: "resourceGroupName", Name: validation.MinLength, Rule: 1, Chain: nil},
...
func (client NodeReportsClient) GetContentPreparer(ctx context.Context, resourceGroupName string, nodeID string, reportID string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"automationAccountName": autorest.Encode("path", client.AutomationAccountName),
		"nodeId":                autorest.Encode("path", nodeID),
		"reportId":              autorest.Encode("path", reportID),
...
func (client NodeReportsClient) ListByNode(ctx context.Context, resourceGroupName string, nodeID string, filter string) (result DscNodeReportListResultPage, err error) {
	if err := validation.Validate([]validation.Validation{
		{TargetValue: resourceGroupName,
			Constraints: []validation.Constraint{{Target: "resourceGroupName", Name: validation.MaxLength, Rule: 90, Chain: nil},
				{Target: "resourceGroupName", Name: validation.MinLength, Rule: 1, Chain: nil},
...
func (client NodeReportsClient) ListByNodePreparer(ctx context.Context, resourceGroupName string, nodeID string, filter string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"automationAccountName": autorest.Encode("path", client.AutomationAccountName),
		"nodeId":                autorest.Encode("path", nodeID),
		"resourceGroupName":     autorest.Encode("path", resourceGroupName),
...
func (client NodeReportsClient) ListByNodeComplete(ctx context.Context, resourceGroupName string, nodeID string, filter string) (result DscNodeReportListResultIterator, err error) {
