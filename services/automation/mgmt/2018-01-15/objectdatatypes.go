...
func NewObjectDataTypesClient(subscriptionID string, automationAccountName string, automationAccountName1 string, clientRequestID string) ObjectDataTypesClient {
	return NewObjectDataTypesClientWithBaseURI(DefaultBaseURI, subscriptionID, automationAccountName, automationAccountName1, clientRequestID)
}

// NewObjectDataTypesClientWithBaseURI creates an instance of the ObjectDataTypesClient client.
func NewObjectDataTypesClientWithBaseURI(baseURI string, subscriptionID string, automationAccountName string, automationAccountName1 string, clientRequestID string) ObjectDataTypesClient {
	return ObjectDataTypesClient{NewWithBaseURI(baseURI, subscriptionID, automationAccountName, automationAccountName1, clientRequestID)}
}
