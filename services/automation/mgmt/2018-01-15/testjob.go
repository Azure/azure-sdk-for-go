...
func NewTestJobClient(subscriptionID string, automationAccountName string, automationAccountName1 string, clientRequestID string) TestJobClient {
	return NewTestJobClientWithBaseURI(DefaultBaseURI, subscriptionID, automationAccountName, automationAccountName1, clientRequestID)
}

// NewTestJobClientWithBaseURI creates an instance of the TestJobClient client.
func NewTestJobClientWithBaseURI(baseURI string, subscriptionID string, automationAccountName string, automationAccountName1 string, clientRequestID string) TestJobClient {
	return TestJobClient{NewWithBaseURI(baseURI, subscriptionID, automationAccountName, automationAccountName1, clientRequestID)}
}
