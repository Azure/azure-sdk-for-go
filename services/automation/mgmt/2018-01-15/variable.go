...
func NewVariableClient(subscriptionID string, automationAccountName string, automationAccountName1 string, clientRequestID string) VariableClient {
	return NewVariableClientWithBaseURI(DefaultBaseURI, subscriptionID, automationAccountName, automationAccountName1, clientRequestID)
}

// NewVariableClientWithBaseURI creates an instance of the VariableClient client.
func NewVariableClientWithBaseURI(baseURI string, subscriptionID string, automationAccountName string, automationAccountName1 string, clientRequestID string) VariableClient {
	return VariableClient{NewWithBaseURI(baseURI, subscriptionID, automationAccountName, automationAccountName1, clientRequestID)}
}
