...
type VirtualMachinesClientAPI interface {
	Get(ctx context.Context, resourceGroupName string, privateCloudName string, clusterName string, virtualMachineID string) (result avs.VirtualMachine, err error)
	List(ctx context.Context, resourceGroupName string, privateCloudName string, clusterName string) (result avs.VirtualMachinesListPage, err error)
	ListComplete(ctx context.Context, resourceGroupName string, privateCloudName string, clusterName string) (result avs.VirtualMachinesListIterator, err error)
	RestrictMovement(ctx context.Context, resourceGroupName string, privateCloudName string, clusterName string, virtualMachineID string, restrictMovement avs.VirtualMachineRestrictMovement) (result avs.VirtualMachinesRestrictMovementFuture, err error)
}

var _ VirtualMachinesClientAPI = (*avs.VirtualMachinesClient)(nil)

// PlacementPoliciesClientAPI contains the set of methods on the PlacementPoliciesClient type.
type PlacementPoliciesClientAPI interface {
	CreateOrUpdate(ctx context.Context, resourceGroupName string, privateCloudName string, clusterName string, placementPolicyName string, placementPolicy avs.PlacementPolicy) (result avs.PlacementPoliciesCreateOrUpdateFuture, err error)
	Delete(ctx context.Context, resourceGroupName string, privateCloudName string, clusterName string, placementPolicyName string) (result avs.PlacementPoliciesDeleteFuture, err error)
	Get(ctx context.Context, resourceGroupName string, privateCloudName string, clusterName string, placementPolicyName string) (result avs.PlacementPolicy, err error)
	List(ctx context.Context, resourceGroupName string, privateCloudName string, clusterName string) (result avs.PlacementPoliciesListPage, err error)
	ListComplete(ctx context.Context, resourceGroupName string, privateCloudName string, clusterName string) (result avs.PlacementPoliciesListIterator, err error)
	Update(ctx context.Context, resourceGroupName string, privateCloudName string, clusterName string, placementPolicyName string, placementPolicyUpdate avs.PlacementPolicyUpdate) (result avs.PlacementPoliciesUpdateFuture, err error)
}

var _ PlacementPoliciesClientAPI = (*avs.PlacementPoliciesClient)(nil)
