...
type AvailabilityProperties struct {
	// Strategy - The availability strategy for the private cloud. Possible values include: 'SingleZone', 'DualZone'
...
type DatastoreProperties struct {
	...
	// Status - READ-ONLY; The operational status of the datastore. Possible values include: 'Unknown', 'Accessible', 'Inaccessible', 'Attached', 'Detached', 'LostCommunication', 'DeadOrError'
...
type Encryption struct {
	// Status - Status of customer managed encryption key. Possible values include: 'Enabled', 'Disabled'
...
type EncryptionKeyVaultProperties struct {
	...
	// KeyState - READ-ONLY; The state of key provided. Possible values include: 'Connected', 'AccessDenied'
	KeyState EncryptionKeyStatus `json:"keyState,omitempty"`
	// VersionType - READ-ONLY; Property of the key if user provided or auto detected. Possible values include: 'Fixed', 'AutoDetected'
...
type PrivateCloudIdentity struct {
	...
	// Type - The type of identity used for the private cloud. The type 'SystemAssigned' refers to an implicitly created identity. The type 'None' will remove any identities from the Private Cloud. Possible values include: 'SystemAssigned', 'None'
...
type VMHostPlacementPolicyProperties struct {
	...
	// HostMembers - Host members list
	HostMembers *[]string `json:"hostMembers,omitempty"`
	// AffinityType - placement policy affinity type. Possible values include: 'Affinity', 'AntiAffinity'
...
type WorkloadNetworkPortMirroringProperties struct {
	...
	DisplayName *string `json:"displayName,omitempty"`
	// Direction - Direction of port mirroring profile. Possible values include: 'INGRESS', 'EGRESS', 'BIDIRECTIONAL'
...
type WorkloadNetworkVirtualMachineProperties struct {
	...
	DisplayName *string `json:"displayName,omitempty"`
	// VMType - READ-ONLY; Virtual machine type. Possible values include: 'REGULAR', 'EDGE', 'SERVICE'
