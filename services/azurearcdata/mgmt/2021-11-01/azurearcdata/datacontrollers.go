...
func (client DataControllersClient) DeleteDataController(ctx context.Context, resourceGroupName string, dataControllerName string) (result DataControllersDeleteDataControllerFuture, err error) {
	...
	result, err = client.DeleteDataControllerSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "azurearcdata.DataControllersClient", "DeleteDataController", result.Response(), "Failure sending request")
		return
	}
...
func (client DataControllersClient) DeleteDataControllerSender(req *http.Request) (future DataControllersDeleteDataControllerFuture, err error) {
...
func (client DataControllersClient) PutDataController(ctx context.Context, resourceGroupName string, dataControllerResource DataControllerResource, dataControllerName string) (result DataControllersPutDataControllerFuture, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "azurearcdata.DataControllersClient", "PutDataController", result.Response(), "Failure sending request")
		return
	}
