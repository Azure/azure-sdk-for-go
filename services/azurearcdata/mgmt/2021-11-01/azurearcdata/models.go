...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/azurearcdata/mgmt/2021-11-01/azurearcdata"
...
func (dcp DataControllerProperties) MarshalJSON() ([]byte, error) {
	...
	if dcp.MetricsDashboardCredential != nil {
		objectMap["metricsDashboardCredential"] = dcp.MetricsDashboardCredential
	}
	if dcp.LogsDashboardCredential != nil {
		objectMap["logsDashboardCredential"] = dcp.LogsDashboardCredential
	}
...
// DataControllersDeleteDataControllerFuture an abstraction for monitoring and retrieving the results of a
// long-running operation.
type DataControllersDeleteDataControllerFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(DataControllersClient) (autorest.Response, error)
}

// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *DataControllersDeleteDataControllerFuture) UnmarshalJSON(body []byte) error {
...
// result is the default implementation for DataControllersDeleteDataControllerFuture.Result.
func (future *DataControllersDeleteDataControllerFuture) result(client DataControllersClient) (ar autorest.Response, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "azurearcdata.DataControllersDeleteDataControllerFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		ar.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("azurearcdata.DataControllersDeleteDataControllerFuture")
		return
	}
	ar.Response = future.Response()
	return
...
type SQLManagedInstanceProperties struct {
	...
	// ProvisioningState - READ-ONLY
	ProvisioningState *string `json:"provisioningState,omitempty"`
	// LicenseType - The license type to apply for this managed instance. Possible values include: 'BasePrice', 'LicenseIncluded', 'DisasterRecovery'
...
// SQLManagedInstancesDeleteFuture an abstraction for monitoring and retrieving the results of a
// long-running operation.
type SQLManagedInstancesDeleteFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(SQLManagedInstancesClient) (autorest.Response, error)
}

// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *SQLManagedInstancesDeleteFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for SQLManagedInstancesDeleteFuture.Result.
func (future *SQLManagedInstancesDeleteFuture) result(client SQLManagedInstancesClient) (ar autorest.Response, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "azurearcdata.SQLManagedInstancesDeleteFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		ar.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("azurearcdata.SQLManagedInstancesDeleteFuture")
		return
	}
	ar.Response = future.Response()
	return
...
// SQLServerInstancesDeleteFuture an abstraction for monitoring and retrieving the results of a
// long-running operation.
type SQLServerInstancesDeleteFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(SQLServerInstancesClient) (autorest.Response, error)
}

// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *SQLServerInstancesDeleteFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for SQLServerInstancesDeleteFuture.Result.
func (future *SQLServerInstancesDeleteFuture) result(client SQLServerInstancesClient) (ar autorest.Response, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "azurearcdata.SQLServerInstancesDeleteFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		ar.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("azurearcdata.SQLServerInstancesDeleteFuture")
		return
	}
	ar.Response = future.Response()
	return
