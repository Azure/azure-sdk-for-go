...
func (client SQLManagedInstancesClient) Create(ctx context.Context, resourceGroupName string, SQLManagedInstanceName string, SQLManagedInstance SQLManagedInstance) (result SQLManagedInstancesCreateFuture, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "azurearcdata.SQLManagedInstancesClient", "Create", result.Response(), "Failure sending request")
		return
	}
...
// resourceGroupName - the name of the Azure resource group
// SQLManagedInstanceName - the name of Sql Managed Instances
func (client SQLManagedInstancesClient) Delete(ctx context.Context, resourceGroupName string, SQLManagedInstanceName string) (result SQLManagedInstancesDeleteFuture, err error) {
	if tracing.IsEnabled() {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "azurearcdata.SQLManagedInstancesClient", "Delete", result.Response(), "Failure sending request")
		return
	}
...
// http.Response Body if it receives an error.
func (client SQLManagedInstancesClient) DeleteSender(req *http.Request) (future SQLManagedInstancesDeleteFuture, err error) {
	var resp *http.Response
	future.FutureAPI = &azure.Future{}
	resp, err = client.Send(req, azure.DoRetryWithRegistration(client.Client))
	if err != nil {
