...
//
// pool is specifies the pool to be added. timeout is sets the maximum time
...
//
// poolID is the id of the pool to delete. timeout is sets the maximum time
// that the server can spend processing the request, in seconds. The default is
// 30 seconds. clientRequestID is caller generated request identity, in the
// form of a GUID with no decoration such as curly braces e.g.
// 9C4D50EE-2D56-4CD3-8152-34347DC9F2B0. returnClientRequestID is specifies if
...
//
// poolID is the id of the pool to get. selectParameter is sets an OData
// $select clause. timeout is sets the maximum time that the server can spend
...
// header to perform the operation only if the resource has not been modified
// since the specified date/time.
func (client PoolClient) Exists(poolID string, selectParameter string, timeout *int32, clientRequestID string, returnClientRequestID *bool, ocpDate *date.TimeRFC1123, ifMatch string, ifNoneMatch string, ifModifiedSince *date.TimeRFC1123, ifUnmodifiedSince *date.TimeRFC1123) (result autorest.Response, err error) {
	req, err := client.ExistsPreparer(poolID, selectParameter, timeout, clientRequestID, returnClientRequestID, ocpDate, ifMatch, ifNoneMatch, ifModifiedSince, ifUnmodifiedSince)
	if err != nil {
...
func (client PoolClient) ExistsPreparer(poolID string, selectParameter string, timeout *int32, clientRequestID string, returnClientRequestID *bool, ocpDate *date.TimeRFC1123, ifMatch string, ifNoneMatch string, ifModifiedSince *date.TimeRFC1123, ifUnmodifiedSince *date.TimeRFC1123) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"poolId": autorest.Encode("path", poolID),
	}
...
//
// poolID is the id of the pool to get. selectParameter is sets an OData
// $select clause. expand is sets an OData $expand clause. timeout is sets the
...
// the current time. filter is sets an OData $filter clause. maxResults is sets
// the maximum number of items to return in the response. timeout is sets the
// maximum time that the server can spend processing the request, in seconds.
// The default is 30 seconds. clientRequestID is caller generated request
// identity, in the form of a GUID with no decoration such as curly braces e.g.
...
// nodeRemoveParameter is the parameters for the request. timeout is sets the
// maximum time that the server can spend processing the request, in seconds.
// The default is 30 seconds. clientRequestID is caller generated request
// identity, in the form of a GUID with no decoration such as curly braces e.g.
// 9C4D50EE-2D56-4CD3-8152-34347DC9F2B0. returnClientRequestID is specifies if
...
// state.
//
// poolID is the id of the pool whose resizing you want to stop. timeout is
// sets the maximum time that the server can spend processing the request, in
// seconds. The default is 30 seconds. clientRequestID is caller generated
// request identity, in the form of a GUID with no decoration such as curly
// braces e.g. 9C4D50EE-2D56-4CD3-8152-34347DC9F2B0. returnClientRequestID is
