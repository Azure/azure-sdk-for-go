...
//
// jobID is the id of the job to which the task is to be added. task is the
// task to be added. timeout is the maximum time that the server can spend
...
//
// jobID is the id of the job to which the task collection is to be added.
// taskCollection is the tasks to be added. timeout is the maximum time that
...
//
// jobID is the id of the job from which to delete the task. taskID is the id
// of the task to delete. timeout is the maximum time that the server can spend
// processing the request, in seconds. The default is 30 seconds.
// clientRequestID is the caller-generated request identity, in the form of a
// GUID with no decoration such as curly braces, e.g.
// 9C4D50EE-2D56-4CD3-8152-34347DC9F2B0. returnClientRequestID is whether the
...
// task to get information about. selectParameter is an OData $select clause.
// expand is an OData $expand clause. timeout is the maximum time that the
...
//
// jobID is the id of the job. filter is an OData $filter clause.
// selectParameter is an OData $select clause. expand is an OData $expand
...
// ListSubtasks lists all of the subtasks that are associated with the
// specified multi-instance task.
//
// jobID is the id of the job. taskID is the id of the task. selectParameter is
// an OData $select clause. timeout is the maximum time that the server can
...
//
// jobID is the id of the job containing the task. taskID is the id of the task
// to terminate. timeout is the maximum time that the server can spend
// processing the request, in seconds. The default is 30 seconds.
// clientRequestID is the caller-generated request identity, in the form of a
// GUID with no decoration such as curly braces, e.g.
// 9C4D50EE-2D56-4CD3-8152-34347DC9F2B0. returnClientRequestID is whether the
...
//
// jobID is the id of the job containing the task. taskID is the id of the task
// to update. taskUpdateParameter is the parameters for the request. timeout is
