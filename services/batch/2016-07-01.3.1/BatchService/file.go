...
// server should return the client-request-id in the response. ocpDate is the
// time the request was issued. If not specified, this header will be
// automatically populated with the current system clock time. ocpRange is the
// byte range to be retrieved. The default is to retrieve the entire file. The
// format is bytes=startRange-endRange. ifModifiedSince is specify this header
// to perform the operation only if the resource has been modified since the
// specified date/time. ifUnmodifiedSince is specify this header to perform the
...
// automatically populated with the current system clock time. ifModifiedSince
// is specify this header to perform the operation only if the resource has
// been modified since the specified date/time. ifUnmodifiedSince is specify
