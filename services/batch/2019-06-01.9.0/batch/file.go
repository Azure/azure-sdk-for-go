...
// nodeID - the ID of the Node from which you want to delete the file.
...
// GetFromComputeNode returns the content of the specified Node file.
// Parameters:
// poolID - the ID of the pool that contains the Node.
// nodeID - the ID of the Node that contains the file.
// filePath - the path to the Node file that you want to get the content of.
// timeout - the maximum time that the server can spend processing the request, in seconds. The default is 30
// seconds.
// clientRequestID - the caller-generated request identity, in the form of a GUID with no decoration such as
// curly braces, e.g. 9C4D50EE-2D56-4CD3-8152-34347DC9F2B0.
...
// GetPropertiesFromComputeNode gets the properties of the specified Node file.
// Parameters:
// poolID - the ID of the pool that contains the Node.
// nodeID - the ID of the Node that contains the file.
// filePath - the path to the Node file that you want to get the properties of.
// timeout - the maximum time that the server can spend processing the request, in seconds. The default is 30
// seconds.
// clientRequestID - the caller-generated request identity, in the form of a GUID with no decoration such as
// curly braces, e.g. 9C4D50EE-2D56-4CD3-8152-34347DC9F2B0.
...
// Parameters:
// poolID - the ID of the pool that contains the Node.
// nodeID - the ID of the Node whose files you want to list.
