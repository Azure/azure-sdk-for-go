...
// deleted, all the files in their working directories on the Nodes are also deleted (the retention period is ignored).
// The Job Schedule statistics are no longer accessible once the Job Schedule is deleted, though they are still counted
// towards Account lifetime statistics.
// Parameters:
