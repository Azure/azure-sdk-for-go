...
import (
	"context"
	"github.com/Azure/azure-sdk-for-go/services/batch/2021-06-01.14.0/batch"
...
type JobClientAPI interface {
	...
	GetTaskCounts(ctx context.Context, jobID string, timeout *int32, clientRequestID *uuid.UUID, returnClientRequestID *bool, ocpDate *date.TimeRFC1123) (result batch.TaskCountsResult, err error)
...
// ComputeNodeExtensionClientAPI contains the set of methods on the ComputeNodeExtensionClient type.
type ComputeNodeExtensionClientAPI interface {
	Get(ctx context.Context, poolID string, nodeID string, extensionName string, selectParameter string, timeout *int32, clientRequestID *uuid.UUID, returnClientRequestID *bool, ocpDate *date.TimeRFC1123) (result batch.NodeVMExtension, err error)
}

var _ ComputeNodeExtensionClientAPI = (*batch.ComputeNodeExtensionClient)(nil)

// ComputeNodeExtensionsClientAPI contains the set of methods on the ComputeNodeExtensionsClient type.
type ComputeNodeExtensionsClientAPI interface {
	List(ctx context.Context, poolID string, nodeID string, selectParameter string, maxResults *int32, timeout *int32, clientRequestID *uuid.UUID, returnClientRequestID *bool, ocpDate *date.TimeRFC1123) (result batch.NodeVMExtensionListPage, err error)
	ListComplete(ctx context.Context, poolID string, nodeID string, selectParameter string, maxResults *int32, timeout *int32, clientRequestID *uuid.UUID, returnClientRequestID *bool, ocpDate *date.TimeRFC1123) (result batch.NodeVMExtensionListIterator, err error)
}

var _ ComputeNodeExtensionsClientAPI = (*batch.ComputeNodeExtensionsClient)(nil)
