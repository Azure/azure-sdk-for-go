...
// AccountIdentity the identity of the Batch account, if configured. This is only used when the user
// specifies 'Microsoft.KeyVault' as their Batch account encryption configuration.
