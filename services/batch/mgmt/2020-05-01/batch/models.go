...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/batch/mgmt/2020-05-01/batch"
...
// AccountIdentity the identity of the Batch account, if configured. This is only used when the user specifies
...
type AccountIdentity struct {
	...
	// Type - The type of identity used for the Batch account. Possible values include: 'ResourceIdentityTypeSystemAssigned', 'ResourceIdentityTypeNone'
...
// accounts are encrypted using a Microsoft managed key. For additional control, a customer-managed key can be
// used instead.
