...
import (
	"context"
	"github.com/Azure/azure-sdk-for-go/services/batch/mgmt/2021-01-01/batch"
...
type CertificateClientAPI interface {
	...
	Create(ctx context.Context, resourceGroupName string, accountName string, certificateName string, parameters batch.CertificateCreateOrUpdateParameters, ifMatch string, ifNoneMatch string) (result batch.Certificate, err error)
...
var _ PrivateLinkResourceClientAPI = (*batch.PrivateLinkResourceClient)(nil)
...
type PoolClientAPI interface {
	Create(ctx context.Context, resourceGroupName string, accountName string, poolName string, parameters batch.Pool, ifMatch string, ifNoneMatch string) (result batch.Pool, err error)
