...
// MarshalJSON is the custom marshaler for AccountIdentityUserAssignedIdentitiesValue.
func (aiAiv AccountIdentityUserAssignedIdentitiesValue) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	return json.Marshal(objectMap)
}
...
// MarshalJSON is the custom marshaler for PoolIdentityUserAssignedIdentitiesValue.
func (piAiv PoolIdentityUserAssignedIdentitiesValue) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	return json.Marshal(objectMap)
}
