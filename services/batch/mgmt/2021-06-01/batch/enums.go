...
const (
	// AAD The authentication mode using Azure Active Directory.
	AAD AuthenticationMode = "AAD"
	// SharedKey The authentication mode using shared keys.
	SharedKey AuthenticationMode = "SharedKey"
	// TaskAuthenticationToken The authentication mode using task authentication tokens.
	TaskAuthenticationToken AuthenticationMode = "TaskAuthenticationToken"
)
...
func PossibleAuthenticationModeValues() []AuthenticationMode {
	return []AuthenticationMode{AAD, SharedKey, TaskAuthenticationToken}
}
...
const (
	// BatchAccountManagedIdentity The Batch service will authenticate requests to auto-storage using the
	// managed identity assigned to the Batch account.
	BatchAccountManagedIdentity AutoStorageAuthenticationMode = "BatchAccountManagedIdentity"
	// StorageKeys The Batch service will authenticate requests to auto-storage using storage account keys.
	StorageKeys AutoStorageAuthenticationMode = "StorageKeys"
)
...
func PossibleAutoStorageAuthenticationModeValues() []AutoStorageAuthenticationMode {
	return []AutoStorageAuthenticationMode{BatchAccountManagedIdentity, StorageKeys}
}
...
const (
	...
	// Zonal Nodes in the pool will be spread across different zones with best effort balancing.
