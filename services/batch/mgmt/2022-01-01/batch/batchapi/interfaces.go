...
type AccountClientAPI interface {
	...
	GetDetector(ctx context.Context, resourceGroupName string, accountName string, detectorID string) (result batch.DetectorResponse, err error)
	...
	ListDetectors(ctx context.Context, resourceGroupName string, accountName string) (result batch.DetectorListResultPage, err error)
	ListDetectorsComplete(ctx context.Context, resourceGroupName string, accountName string) (result batch.DetectorListResultIterator, err error)
