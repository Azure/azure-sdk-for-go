...
type InvoicesClientAPI interface {
	...
	DownloadMultipleBillingSubscriptionInvoice(ctx context.Context, downloadUrls []string) (result billing.InvoicesDownloadMultipleBillingSubscriptionInvoiceFuture, err error)
	DownloadMultipleModernInvoice(ctx context.Context, billingAccountName string, downloadUrls []string) (result billing.InvoicesDownloadMultipleModernInvoiceFuture, err error)
