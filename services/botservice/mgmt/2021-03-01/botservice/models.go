...
type AlexaChannel struct {
	...
	// ChannelName - Possible values include: 'ChannelNameChannel', 'ChannelNameAlexaChannel1', 'ChannelNameFacebookChannel1', 'ChannelNameEmailChannel1', 'ChannelNameMsTeamsChannel1', 'ChannelNameSkypeChannel1', 'ChannelNameKikChannel1', 'ChannelNameWebChatChannel1', 'ChannelNameDirectLineChannel1', 'ChannelNameTelegramChannel1', 'ChannelNameSmsChannel1', 'ChannelNameSlackChannel1', 'ChannelNameLineChannel1', 'ChannelNameDirectLineSpeechChannel1'
...
func (ac AlexaChannel) MarshalJSON() ([]byte, error) {
	ac.ChannelName = ChannelNameAlexaChannel1
...
func unmarshalBasicChannel(body []byte) (BasicChannel, error) {
	...
	case string(ChannelNameAlexaChannel1):
		var ac AlexaChannel
	...
	case string(ChannelNameSlackChannel1):
		...
		err := json.Unmarshal(body, &sc)
		return sc, err
	case string(ChannelNameLineChannel1):
		var lc LineChannel
		err := json.Unmarshal(body, &lc)
		return lc, err
	case string(ChannelNameDirectLineSpeechChannel1):
...
func (dlsc DirectLineSpeechChannel) MarshalJSON() ([]byte, error) {
	dlsc.ChannelName = ChannelNameDirectLineSpeechChannel1
	objectMap := make(map[string]interface{})
...
func (lc LineChannel) MarshalJSON() ([]byte, error) {
	lc.ChannelName = ChannelNameLineChannel1
	objectMap := make(map[string]interface{})
