...
//
// accountName is the Azure Data Lake Analytics account to execute catalog
// operations on. databaseName is the name of the database in which to create
// the secret. secretName is the name of the secret. parameters is the
...
//
// accountName is the Azure Data Lake Analytics account to execute catalog
// operations on. databaseName is the name of the database containing the
// secret.
...
//
// accountName is the Azure Data Lake Analytics account to execute catalog
// operations on. databaseName is the name of the database.
...
// accountName is the Azure Data Lake Analytics account to execute catalog
// operations on. databaseName is the name of the database containing the
// partition. schemaName is the name of the schema containing the partition.
...
// accountName is the Azure Data Lake Analytics account to execute catalog
// operations on. databaseName is the name of the database containing the
// statistics. schemaName is the name of the schema containing the statistics.
...
//
// accountName is the Azure Data Lake Analytics account to execute catalog
// operations on. databaseName is the name of the database containing the table
// type. schemaName is the name of the schema containing the table type.
...
// accountName is the Azure Data Lake Analytics account to execute catalog
// operations on. databaseName is the name of the database containing the table
// valued function. schemaName is the name of the schema containing the table
// valued function. tableValuedFunctionName is the name of the
// tableValuedFunction.
...
//
// accountName is the Azure Data Lake Analytics account to execute catalog
// operations on. databaseName is the name of the database containing the view.
// schemaName is the name of the schema containing the view. viewName is the
// name of the view.
...
// accountName is the Azure Data Lake Analytics account to execute catalog
// operations on. databaseName is the name of the database containing the
// assembly. filter is oData filter. Optional. top is the number of items to
// return. Optional. skip is the number of items to skip over before returning
...
// accountName is the Azure Data Lake Analytics account to execute catalog
// operations on. databaseName is the name of the database containing the
// schema. filter is oData filter. Optional. top is the number of items to
// return. Optional. skip is the number of items to skip over before returning
// elements. Optional. expand is oData expansion. Expand related resources in
// line with the retrieved resources, e.g. Categories?$expand=Products would
// expand Product data in line with each Category entry. Optional.
...
// accountName is the Azure Data Lake Analytics account to execute catalog
// operations on. databaseName is the name of the database containing the
// external data sources. filter is oData filter. Optional. top is the number
// of items to return. Optional. skip is the number of items to skip over
// before returning elements. Optional. expand is oData expansion. Expand
...
// accountName is the Azure Data Lake Analytics account to execute catalog
// operations on. databaseName is the name of the database containing the
// procedures. schemaName is the name of the schema containing the procedures.
...
// accountName is the Azure Data Lake Analytics account to execute catalog
// operations on. databaseName is the name of the database containing the
// partitions. schemaName is the name of the schema containing the partitions.
// tableName is the name of the table containing the partitions. filter is
...
// expand is oData expansion. Expand related resources in line with the
// retrieved resources, e.g. Categories?$expand=Products would expand Product
// data in line with each Category entry. Optional. selectParameter is oData
// Select statement. Limits the properties on each entry to just those
// requested, e.g. Categories?$select=CategoryName,Description. Optional.
// orderby is orderBy clause. One or more comma-separated expressions with an
// optional "asc" (the default) or "desc" depending on the order you'd like the
// values sorted, e.g. Categories?$orderby=CategoryName desc. Optional. count
// is the Boolean value of true or false to request a count of the matching
...
// accountName is the Azure Data Lake Analytics account to execute catalog
// operations on. databaseName is the name of the database containing the
// tables. schemaName is the name of the schema containing the tables. filter
// is oData filter. Optional. top is the number of items to return. Optional.
...
// Product data in line with each Category entry. Optional. selectParameter is
...
// operations on. databaseName is the name of the database containing the
// statistics. schemaName is the name of the schema containing the statistics.
// tableName is the name of the table containing the statistics. filter is
// oData filter. Optional. top is the number of items to return. Optional. skip
// is the number of items to skip over before returning elements. Optional.
// expand is oData expansion. Expand related resources in line with the
// retrieved resources, e.g. Categories?$expand=Products would expand Product
...
// accountName is the Azure Data Lake Analytics account to execute catalog
// operations on. databaseName is the name of the database containing the table
// types. schemaName is the name of the schema containing the table types.
// filter is oData filter. Optional. top is the number of items to return.
// Optional. skip is the number of items to skip over before returning
// elements. Optional. expand is oData expansion. Expand related resources in
// line with the retrieved resources, e.g. Categories?$expand=Products would
...
// accountName is the Azure Data Lake Analytics account to execute catalog
// operations on. databaseName is the name of the database containing the table
// valued functions. schemaName is the name of the schema containing the table
// valued functions. filter is oData filter. Optional. top is the number of
// items to return. Optional. skip is the number of items to skip over before
// returning elements. Optional. expand is oData expansion. Expand related
// resources in line with the retrieved resources, e.g.
// Categories?$expand=Products would expand Product data in line with each
// Category entry. Optional. selectParameter is oData Select statement. Limits
...
// accountName is the Azure Data Lake Analytics account to execute catalog
// operations on. databaseName is the name of the database containing the
// types. schemaName is the name of the schema containing the types. filter is
// oData filter. Optional. top is the number of items to return. Optional. skip
// is the number of items to skip over before returning elements. Optional.
// expand is oData expansion. Expand related resources in line with the
// retrieved resources, e.g. Categories?$expand=Products would expand Product
...
// accountName is the Azure Data Lake Analytics account to execute catalog
// operations on. databaseName is the name of the database containing the
// views. schemaName is the name of the schema containing the views. filter is
// oData filter. Optional. top is the number of items to return. Optional. skip
// is the number of items to skip over before returning elements. Optional.
// expand is oData expansion. Expand related resources in line with the
// retrieved resources, e.g. Categories?$expand=Products would expand Product
