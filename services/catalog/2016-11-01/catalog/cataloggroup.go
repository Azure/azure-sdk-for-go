...
// catalog operations. databaseName is the name of the database in which to
// create the credential. Note: This is NOT an external database name, but the
// name of an existing U-SQL database that should contain the new credential
...
// in the specified database. This is deprecated and will be removed in the
...
// deprecated and will be removed in the next release. In the future, please
...
// accountName is the Azure Data Lake Analytics account upon which to execute
// catalog operations. databaseName is the name of the database containing the
// credential. credentialName is the name of the credential to delete
// parameters is the parameters to delete a credential if the current user is
// not the account owner. cascade is indicates if the delete should be a
...
// deprecated and will be removed in the next release. Please use GetCredential
// instead.
//
// accountName is the Azure Data Lake Analytics account upon which to execute
// catalog operations. databaseName is the name of the database containing the
...
// accountName is the Azure Data Lake Analytics account upon which to execute
// catalog operations. databaseName is the name of the database containing the
// table valued function. schemaName is the name of the schema containing the
...
//
// accountName is the Azure Data Lake Analytics account upon which to execute
// catalog operations. filter is oData filter. Optional. top is the number of
...
// before returning elements. Optional. selectParameter is oData Select
...
// accountName is the Azure Data Lake Analytics account upon which to execute
// catalog operations. databaseName is the name of the database containing the
// packages. schemaName is the name of the schema containing the packages.
...
// accountName is the Azure Data Lake Analytics account upon which to execute
// catalog operations. databaseName is the name of the database containing the
// tables. filter is oData filter. Optional. top is the number of items to
// return. Optional. skip is the number of items to skip over before returning
// elements. Optional. selectParameter is oData Select statement. Limits the
// properties on each entry to just those requested, e.g.
// Categories?$select=CategoryName,Description. Optional. orderby is orderBy
...
// accountName is the Azure Data Lake Analytics account upon which to execute
// catalog operations. databaseName is the name of the database containing the
// table statistics. filter is oData filter. Optional. top is the number of
// items to return. Optional. skip is the number of items to skip over before
// returning elements. Optional. selectParameter is oData Select statement.
// Limits the properties on each entry to just those requested, e.g.
// Categories?$select=CategoryName,Description. Optional. orderby is orderBy
...
// statistics within the specified schema from the Data Lake Analytics catalog.
//
// accountName is the Azure Data Lake Analytics account upon which to execute
// catalog operations. databaseName is the name of the database containing the
// statistics. schemaName is the name of the schema containing the statistics.
...
// accountName is the Azure Data Lake Analytics account upon which to execute
// catalog operations. databaseName is the name of the database containing the
// table types. schemaName is the name of the schema containing the table
// types. filter is oData filter. Optional. top is the number of items to
// return. Optional. skip is the number of items to skip over before returning
// elements. Optional. selectParameter is oData Select statement. Limits the
// properties on each entry to just those requested, e.g.
// Categories?$select=CategoryName,Description. Optional. orderby is orderBy
...
// accountName is the Azure Data Lake Analytics account upon which to execute
// catalog operations. databaseName is the name of the database containing the
// table valued functions. schemaName is the name of the schema containing the
// table valued functions. filter is oData filter. Optional. top is the number
// of items to return. Optional. skip is the number of items to skip over
// before returning elements. Optional. selectParameter is oData Select
// statement. Limits the properties on each entry to just those requested, e.g.
// Categories?$select=CategoryName,Description. Optional. orderby is orderBy
...
// functions in a database from the Data Lake Analytics catalog.
//
// accountName is the Azure Data Lake Analytics account upon which to execute
// catalog operations. databaseName is the name of the database containing the
// table valued functions. filter is oData filter. Optional. top is the number
...
// accountName is the Azure Data Lake Analytics account upon which to execute
// catalog operations. databaseName is the name of the database containing the
// views. filter is oData filter. Optional. top is the number of items to
// return. Optional. skip is the number of items to skip over before returning
// elements. Optional. selectParameter is oData Select statement. Limits the
// properties on each entry to just those requested, e.g.
// Categories?$select=CategoryName,Description. Optional. orderby is orderBy
...
// data sources in the specified database
//
// accountName is the Azure Data Lake Analytics account upon which to execute
// catalog operations. databaseName is the name of the database containing the
...
// sources in the specified database. This is deprecated and will be removed in
