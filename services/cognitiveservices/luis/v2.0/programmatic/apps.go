...
func (client AppsClient) Delete(ctx context.Context, appID uuid.UUID) (result autorest.Response, err error) {
...
//
// appID is the application ID.
func (client AppsClient) ListEndpoints(ctx context.Context, appID uuid.UUID) (result AvailableEndpoints, err error) {
...
// closes the http.Response Body.
func (client AppsClient) ListEndpointsResponder(resp *http.Response) (result AvailableEndpoints, err error) {
	err = autorest.Respond(
		resp,
		client.ByInspecting(),
		azure.WithErrorUnlessStatusCode(http.StatusOK),
...
//
// appID is the application ID. applicationPublishObject is the application publish object. The region is the target
// region that the application is published to.
...
func (client AppsClient) Update(ctx context.Context, appID uuid.UUID, applicationUpdateObject ApplicationUpdateObject) (result autorest.Response, err error) {
...
func (client AppsClient) UpdateSettings(ctx context.Context, appID uuid.UUID, applicationSettingUpdateObject ApplicationSettingUpdateObject) (result autorest.Response, err error) {
...
// closes the http.Response Body.
func (client AppsClient) UpdateSettingsResponder(resp *http.Response) (result autorest.Response, err error) {
	err = autorest.Respond(
		resp,
		client.ByInspecting(),
		azure.WithErrorUnlessStatusCode(http.StatusOK),
