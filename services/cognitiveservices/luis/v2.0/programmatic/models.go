...
const (
	...
	// TrainingStatusNeedsTraining ...
	TrainingStatusNeedsTraining TrainingStatus = "NeedsTraining"
	// TrainingStatusTrained ...
	TrainingStatusTrained TrainingStatus = "Trained"
)
...
// AvailableEndpoints collection of endpoint URLs the selected application is deployed to.
type AvailableEndpoints struct {
	autorest.Response `json:"-"`
	Westus            *string `json:"westus,omitempty"`
	Eastus2           *string `json:"eastus2,omitempty"`
	Westcentralus     *string `json:"westcentralus,omitempty"`
	Southeastasia     *string `json:"southeastasia,omitempty"`
	Westeurope        *string `json:"westeurope,omitempty"`
}
...
// HierarchicalModelCreateObject object model for creating a hierarchical entity extractor.
type HierarchicalModelCreateObject struct {
	// Children - List of child entities.
	Children *[]string `json:"children,omitempty"`
	// Name - Name of the new hierarchical entity.
	Name *string `json:"name,omitempty"`
}

// HierarchicalModelUpdateObject a model object containing the properties to update.
...
// PersonalAssistantsResponse response containing user's endpoint keys and the endpoint URLs of the prebuilt Cortana
// applications.
...
// PrebuiltDomainCreateBaseObject a model object containing the name of the custom prebuilt entity and the name of the
...
// PrebuiltDomainModelCreateObject a model object containing the name of the custom prebuilt intent or entity and the
...
type VersionInfo struct {
	...
	EndpointURL *string `json:"endpointUrl,omitempty"`
	// AssignedEndpointKey - The endpoint key.
	AssignedEndpointKey *map[string]*string `json:"assignedEndpointKey,omitempty"`
	// ExternalAPIKeys - External keys.
	ExternalAPIKeys *map[string]interface{} `json:"externalApiKeys,omitempty"`
	...
	// EndpointHitsCount - Number of calls made to this endpoint.
	EndpointHitsCount *int32 `json:"endpointHitsCount,omitempty"`
	// TrainingStatus - The current training status. Possible values include: 'TrainingStatusNeedsTraining', 'TrainingStatusInProgress', 'TrainingStatusTrained'
