...
//
// appID is the application ID. versionID is the version ID. versionCloneObject is a model containing the new version
// ID.
...
func (client VersionsClient) Delete(ctx context.Context, appID uuid.UUID, versionID string) (result autorest.Response, err error) {
...
func (client VersionsClient) DeleteUnlabelledUtterance(ctx context.Context, appID uuid.UUID, versionID string, utterance string) (result autorest.Response, err error) {
...
// closes the http.Response Body.
func (client VersionsClient) DeleteUnlabelledUtteranceResponder(resp *http.Response) (result autorest.Response, err error) {
	err = autorest.Respond(
		resp,
		client.ByInspecting(),
		azure.WithErrorUnlessStatusCode(http.StatusOK),
...
//
// appID is the application ID. luisApp is a LUIS application structure. versionID is the new versionId to import. If
// not specified, the versionId will be read from the imported object.
...
func (client VersionsClient) Update(ctx context.Context, appID uuid.UUID, versionID string, versionUpdateObject TaskUpdateObject) (result autorest.Response, err error) {
...
// closes the http.Response Body.
func (client VersionsClient) UpdateResponder(resp *http.Response) (result autorest.Response, err error) {
	err = autorest.Respond(
		resp,
		client.ByInspecting(),
		azure.WithErrorUnlessStatusCode(http.StatusOK),
