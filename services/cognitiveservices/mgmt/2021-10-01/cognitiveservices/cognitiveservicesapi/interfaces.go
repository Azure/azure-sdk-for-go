...
// CommitmentTiersClientAPI contains the set of methods on the CommitmentTiersClient type.
type CommitmentTiersClientAPI interface {
	List(ctx context.Context, location string) (result cognitiveservices.CommitmentTierListResultPage, err error)
	ListComplete(ctx context.Context, location string) (result cognitiveservices.CommitmentTierListResultIterator, err error)
}

var _ CommitmentTiersClientAPI = (*cognitiveservices.CommitmentTiersClient)(nil)
...
type DeploymentsClientAPI interface {
	CreateOrUpdate(ctx context.Context, resourceGroupName string, accountName string, deploymentName string, deployment cognitiveservices.Deployment) (result cognitiveservices.DeploymentsCreateOrUpdateFuture, err error)
	Delete(ctx context.Context, resourceGroupName string, accountName string, deploymentName string) (result cognitiveservices.DeploymentsDeleteFuture, err error)
	Get(ctx context.Context, resourceGroupName string, accountName string, deploymentName string) (result cognitiveservices.Deployment, err error)
	List(ctx context.Context, resourceGroupName string, accountName string) (result cognitiveservices.DeploymentListResultPage, err error)
	ListComplete(ctx context.Context, resourceGroupName string, accountName string) (result cognitiveservices.DeploymentListResultIterator, err error)
}

var _ DeploymentsClientAPI = (*cognitiveservices.DeploymentsClient)(nil)

// CommitmentPlansClientAPI contains the set of methods on the CommitmentPlansClient type.
type CommitmentPlansClientAPI interface {
	CreateOrUpdate(ctx context.Context, resourceGroupName string, accountName string, commitmentPlanName string, commitmentPlan cognitiveservices.CommitmentPlan) (result cognitiveservices.CommitmentPlan, err error)
	Delete(ctx context.Context, resourceGroupName string, accountName string, commitmentPlanName string) (result cognitiveservices.CommitmentPlansDeleteFuture, err error)
	Get(ctx context.Context, resourceGroupName string, accountName string, commitmentPlanName string) (result cognitiveservices.CommitmentPlan, err error)
	List(ctx context.Context, resourceGroupName string, accountName string) (result cognitiveservices.CommitmentPlanListResultPage, err error)
	ListComplete(ctx context.Context, resourceGroupName string, accountName string) (result cognitiveservices.CommitmentPlanListResultIterator, err error)
}

var _ CommitmentPlansClientAPI = (*cognitiveservices.CommitmentPlansClient)(nil)
