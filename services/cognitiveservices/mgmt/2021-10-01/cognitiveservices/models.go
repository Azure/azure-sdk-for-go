...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/cognitiveservices/mgmt/2021-10-01/cognitiveservices"
...
type CommitmentPlanProperties struct {
	// HostingModel - Account hosting model. Possible values include: 'Web', 'ConnectedContainer', 'DisconnectedContainer'
...
type DeploymentProperties struct {
	// ProvisioningState - READ-ONLY; Gets the status of the resource at the time the operation was called. Possible values include: 'Accepted', 'Creating', 'Deleting', 'Moving', 'Failed', 'Succeeded'
...
type DeploymentScaleSettings struct {
	// ScaleType - Deployment scale type. Possible values include: 'Manual'
