...
const (
	...
	// Microsecond ...
	Microsecond TimeGranularity = "microsecond"
	// Monthly ...
	Monthly TimeGranularity = "monthly"
	// None ...
	None TimeGranularity = "none"
	// PerMinute ...
...
func PossibleTimeGranularityValues() []TimeGranularity {
	return []TimeGranularity{Daily, Hourly, Microsecond, Monthly, None, PerMinute, PerSecond, Weekly, Yearly}
}
