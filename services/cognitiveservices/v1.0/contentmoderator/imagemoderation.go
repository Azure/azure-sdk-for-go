...
func NewImageModerationClient(ocpApimSubscriptionKey string, baseURL AzureRegionBaseURL) ImageModerationClient {
	return ImageModerationClient{New(ocpApimSubscriptionKey, baseURL)}
}
