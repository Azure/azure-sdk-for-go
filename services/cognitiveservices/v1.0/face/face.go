...
// the face feature and will be used in [Face - Identify](https://docs.microsoft.com/rest/api/faceapi/face/identify),
// [Face - Verify](https://docs.microsoft.com/rest/api/faceapi/face/verifyfacetoface), and [Face - Find
// Similar](https://docs.microsoft.com/rest/api/faceapi/face/findsimilar). The stored face feature(s) will expire and
// be deleted at the time specified by faceIdTimeToLive after the original detection call.
// * Optional parameters include faceId, landmarks, and attributes. Attributes include age, gender, headPose, smile,
// facialHair, glasses, emotion, hair, makeup, occlusion, accessories, blur, exposure, noise, and mask. Some of the
// results returned for specific attributes may not be highly accurate.
// * JPEG, PNG, GIF (the first frame), and BMP format are supported. The allowed image file size is from 1KB to 6MB.
// * Up to 100 faces can be returned for an image. Faces are ranked by face rectangle size from large to small.
// * For optimal results when querying [Face - Identify](https://docs.microsoft.com/rest/api/faceapi/face/identify),
// [Face - Verify](https://docs.microsoft.com/rest/api/faceapi/face/verifyfacetoface), and [Face - Find
// Similar](https://docs.microsoft.com/rest/api/faceapi/face/findsimilar) ('returnFaceId' is true), please use faces
// that are: frontal, clear, and with a minimum size of 200x200 pixels (100 pixels between eyes).
...
// details, please refer to [Specify a recognition
...
// string like "returnFaceAttributes=age,gender". The available attributes depends on the 'detectionModel'
// specified. 'detection_01' supports age, gender, headPose, smile, facialHair, glasses, emotion, hair, makeup,
// occlusion, accessories, blur, exposure, and noise. While 'detection_02' does not support any attributes and
// 'detection_03' only supports mask. Note that each face attribute analysis has additional computational and
// time cost.
...
// faceIDTimeToLive - the number of seconds for the faceId being cached. Supported range from 60 seconds up to
// 86400 seconds. The default value is 86400 (24 hours).
func (client Client) DetectWithStream(ctx context.Context, imageParameter io.ReadCloser, returnFaceID *bool, returnFaceLandmarks *bool, returnFaceAttributes []AttributeType, recognitionModel RecognitionModel, returnRecognitionModel *bool, detectionModel DetectionModel, faceIDTimeToLive *int32) (result ListDetectedFace, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		{TargetValue: faceIDTimeToLive,
			Constraints: []validation.Constraint{{Target: "faceIDTimeToLive", Name: validation.Null, Rule: false,
				Chain: []validation.Constraint{{Target: "faceIDTimeToLive", Name: validation.InclusiveMaximum, Rule: int64(86400), Chain: nil},
					{Target: "faceIDTimeToLive", Name: validation.InclusiveMinimum, Rule: int64(60), Chain: nil},
				}}}}}); err != nil {
		return result, validation.NewError("face.Client", "DetectWithStream", err.Error())
	}

	req, err := client.DetectWithStreamPreparer(ctx, imageParameter, returnFaceID, returnFaceLandmarks, returnFaceAttributes, recognitionModel, returnRecognitionModel, detectionModel, faceIDTimeToLive)
	if err != nil {
...
func (client Client) DetectWithStreamPreparer(ctx context.Context, imageParameter io.ReadCloser, returnFaceID *bool, returnFaceLandmarks *bool, returnFaceAttributes []AttributeType, recognitionModel RecognitionModel, returnRecognitionModel *bool, detectionModel DetectionModel, faceIDTimeToLive *int32) (*http.Request, error) {
	...
	if faceIDTimeToLive != nil {
		queryParameters["faceIdTimeToLive"] = autorest.Encode("query", *faceIDTimeToLive)
	} else {
		queryParameters["faceIdTimeToLive"] = autorest.Encode("query", 86400)
	}
...
// faceIDTimeToLive - the number of seconds for the faceId being cached. Supported range from 60 seconds up to
// 86400 seconds. The default value is 86400 (24 hours).
func (client Client) DetectWithURL(ctx context.Context, imageURL ImageURL, returnFaceID *bool, returnFaceLandmarks *bool, returnFaceAttributes []AttributeType, recognitionModel RecognitionModel, returnRecognitionModel *bool, detectionModel DetectionModel, faceIDTimeToLive *int32) (result ListDetectedFace, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.DetectWithURLPreparer(ctx, imageURL, returnFaceID, returnFaceLandmarks, returnFaceAttributes, recognitionModel, returnRecognitionModel, detectionModel, faceIDTimeToLive)
	if err != nil {
...
func (client Client) DetectWithURLPreparer(ctx context.Context, imageURL ImageURL, returnFaceID *bool, returnFaceLandmarks *bool, returnFaceAttributes []AttributeType, recognitionModel RecognitionModel, returnRecognitionModel *bool, detectionModel DetectionModel, faceIDTimeToLive *int32) (*http.Request, error) {
	urlParameters := map[string]interface{}{
		"Endpoint": client.Endpoint,
	}
...
// Stream](https://docs.microsoft.com/rest/api/faceapi/face/detectwithstream), which will expire at the time specified
// by faceIdTimeToLive after creation. A "faceListId" is created by [FaceList -
...
// Create](https://docs.microsoft.com/rest/api/faceapi/largefacelist/create) containing persistedFaceIds that will also
// not expire. Depending on the input the returned similar faces list contains faceIds or persistedFaceIds ranked by
// similarity.
...
// * Try [Face - Find Similar](https://docs.microsoft.com/rest/api/faceapi/face/findsimilar) when you need to find
// similar faces from a face list/large face list instead of a person group/large person group.
