...
// the face feature and will be used in [Face - Identify](../face/identify), [Face - Verify](../face/verifyfacetoface),
// and [Face - Find Similar](../face/findsimilar). The stored face feature(s) will expire and be deleted at the time
...
// * For optimal results when querying [Face - Identify](../face/identify), [Face - Verify](../face/verifyfacetoface),
// and [Face - Find Similar](../face/findsimilar) ('returnFaceId' is true), please use faces that are: frontal, clear,
...
// large face list. faceId array contains the faces created by [Face - Detect With Url](detectwithurl) or [Face -
// Detect With Stream](detectwithstream), which will expire at the time specified by faceIdTimeToLive after creation. A
// "faceListId" is created by [FaceList - Create](../facelist/create) containing persistedFaceIds that will not expire.
// And a "largeFaceListId" is created by [LargeFaceList - Create](../largefacelist/create) containing persistedFaceIds
...
// * Group API needs at least 2 candidate faces and 1000 at most. We suggest to try [Face - Verify](verifyfacetoface)
...
// trained to make it ready for identification. See more in [PersonGroup - Train](../persongroup/train) and
// [LargePersonGroup - Train](../largepersongroup/train).
// <br/>
//
// Remarks:<br />
...
// * Try [Face - Find Similar](../face/findsimilar) when you need to find similar faces from a face list/large face
