...
// face feature will be stored on server until [LargeFaceList Face - Delete](../largefacelist/deleteface) or
...
// <br /> After creation, user should use [LargeFaceList Face - Add](../largefacelist/addfacefromurl) to import the
// faces and [LargeFaceList - Train](../largefacelist/train) to make it ready for [Face - Find
// Similar](../face/findsimilar). No image will be stored. Only the extracted face features are stored on server until
// [LargeFaceList - Delete](../largefacelist/delete) is called.
...
// To get face information inside largeFaceList use [LargeFaceList Face - Get](../largefacelist/getface)<br />
