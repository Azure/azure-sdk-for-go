...
// to 1,000,000
// people.
// <br /> After creation, use [LargePersonGroup Person - Create](../largepersongroupperson/create) to add person into
// the group, and call [LargePersonGroup - Train](../largepersongroup/train) to get this group ready for [Face -
...
// until [LargePersonGroup Person - Delete](../largepersongroupperson/delete) or [LargePersonGroup -
...
// returns large person group information only, use [LargePersonGroup Person - List](../largepersongroupperson/list)
