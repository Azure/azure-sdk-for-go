...
// face feature will be stored on server until [FaceList - Delete Face](../facelist/deleteface) or [FaceList -
// Delete](../facelist/delete) is called.
// <br /> Note persistedFaceId is different from faceId generated by [Face - Detect](../face/detectwithurl).
...
// provided "targetFace" rectangle is not returned from [Face - Detect](../face/detectwithurl), there’s no guarantee to
...
// <br /> Face list is a list of faces, up to 1,000 faces, and used by [Face - Find Similar](../face/findsimilar).
// <br /> After creation, user should use [FaceList - Add Face](../facelist/addfacefromurl) to import the faces. No
...
// way face identification. But if the actual use is to identify person, please use [PersonGroup](../persongroup) /
// [LargePersonGroup](../largepersongroup) and [Face - Identify](../face/identify).
// <br /> Please consider [LargeFaceList](../largefacelist) when the face number is large. It can support up to
// 1,000,000 faces.
