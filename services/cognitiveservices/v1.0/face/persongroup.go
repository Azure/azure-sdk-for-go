...
// <br /> After creation, use [PersonGroup Person - Create](../persongroupperson/create) to add persons into the group,
// and then call [PersonGroup - Train](../persongroup/train) to get this group ready for [Face -
...
// until [PersonGroup Person - Delete](../persongroupperson/delete) or [PersonGroup - Delete](../persongroup/delete) is
// called.
...
// [PersonGroup Person - List](../persongroupperson/list).
// Parameters:
// personGroupID - id referencing a particular person group.
