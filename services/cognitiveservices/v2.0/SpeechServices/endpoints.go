...
// EndpointsClient is the speech Services API v2.0.
...
func (client EndpointsClient) Get(ctx context.Context) (result SetObject, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "speechservices.EndpointsClient", "Get", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "speechservices.EndpointsClient", "Get", resp, "Failure sending request")
		return
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "speechservices.EndpointsClient", "Get", resp, "Failure responding to request")
	}
...
func (client EndpointsClient) GetPreparer(ctx context.Context) (*http.Request, error) {
...
func (client EndpointsClient) GetResponder(resp *http.Response) (result SetObject, err error) {
