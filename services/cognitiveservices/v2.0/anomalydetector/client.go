// Package anomalydetector implements the Azure ARM Anomalydetector service API version 2.0.
//
...
func (client BaseClient) EntireDetectPreparer(ctx context.Context, body Request) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.AsPost(),
		autorest.WithCustomBaseURL("{Endpoint}/anomalydetector/v2.0", urlParameters),
