...
type BaseClientAPI interface {
	...
	BatchReadFile(ctx context.Context, imageURL computervision.ImageURL, mode computervision.TextRecognitionMode) (result computervision.BatchReadFileFuture, err error)
	BatchReadFileInStream(ctx context.Context, imageParameter io.ReadCloser, mode computervision.TextRecognitionMode) (result autorest.Response, err error)
