...
func (client DispatchClient) BatchAddConnectedServices(ctx context.Context, appID uuid.UUID, versionID string, connectedServices []DispatchConnectedServiceObject) (result OperationStatus, err error) {
...
func (client DispatchClient) BatchAddConnectedServicesResponder(resp *http.Response) (result OperationStatus, err error) {
...
// versionID - the version ID.
// connectedServices - a JSON array of service connections.
func (client DispatchClient) BatchUpdateConnectedServices(ctx context.Context, appID uuid.UUID, versionID string, connectedServices []DispatchConnectedServiceObject) (result OperationStatus, err error) {
	if tracing.IsEnabled() {
...
// closes the http.Response Body.
func (client DispatchClient) BatchUpdateConnectedServicesResponder(resp *http.Response) (result OperationStatus, err error) {
	err = autorest.Respond(
		resp,
		client.ByInspecting(),
		azure.WithErrorUnlessStatusCode(http.StatusOK),
...
func (client DispatchClient) DeleteConnectedServices(ctx context.Context, appID uuid.UUID, versionID string, intentNames []DispatchConnectedServiceDeleteObject) (result OperationStatus, err error) {
	if tracing.IsEnabled() {
...
// closes the http.Response Body.
func (client DispatchClient) DeleteConnectedServicesResponder(resp *http.Response) (result OperationStatus, err error) {
	err = autorest.Respond(
		resp,
		client.ByInspecting(),
		azure.WithErrorUnlessStatusCode(http.StatusOK),
