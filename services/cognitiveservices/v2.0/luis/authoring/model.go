...
// ListEntitySuggestions get suggestion examples that would improve the accuracy of the entity model.
// Parameters:
// azureRegion - supported Azure regions for Cognitive Services endpoints
// azureCloud - supported Azure Clouds for Cognitive Services endpoints
// appID - the application ID.
...
// ListIntentSuggestions suggests examples that would improve the accuracy of the intent model.
// Parameters:
// azureRegion - supported Azure regions for Cognitive Services endpoints
// azureCloud - supported Azure Clouds for Cognitive Services endpoints
// appID - the application ID.
