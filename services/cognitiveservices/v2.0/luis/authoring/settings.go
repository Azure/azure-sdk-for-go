...
func (client SettingsClient) List(ctx context.Context, appID uuid.UUID, versionID string) (result ListVersionSettingObject, err error) {
...
func (client SettingsClient) ListResponder(resp *http.Response) (result ListVersionSettingObject, err error) {
...
// appID - the application ID.
// versionID - the version ID.
// listOfVersionSettingUpdateObject - a list of the updated application version settings.
func (client SettingsClient) Update(ctx context.Context, appID uuid.UUID, versionID string, listOfVersionSettingUpdateObject VersionSettingUpdateObject) (result OperationStatus, err error) {
	req, err := client.UpdatePreparer(ctx, appID, versionID, listOfVersionSettingUpdateObject)
	if err != nil {
...
func (client SettingsClient) UpdatePreparer(ctx context.Context, appID uuid.UUID, versionID string, listOfVersionSettingUpdateObject VersionSettingUpdateObject) (*http.Request, error) {
	urlParameters := map[string]interface{}{
		"Endpoint": client.Endpoint,
	}
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithCustomBaseURL("{Endpoint}/luis/api/v2.0", urlParameters),
		autorest.WithPathParameters("/apps/{appId}/versions/{versionId}/settings", pathParameters),
		autorest.WithJSON(listOfVersionSettingUpdateObject))
	return preparer.Prepare((&http.Request{}).WithContext(ctx))
}
