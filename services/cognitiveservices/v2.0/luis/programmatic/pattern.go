...
//
// appID is the application ID. versionID is the version ID. patternID is the pattern ID.
...
//
// appID is the application ID. versionID is the version ID. patternIds is the patterns IDs.
...
//
// appID is the application ID. versionID is the version ID. intentID is the intent classifier ID. skip is the
// number of entries to skip. Default value is 0. take is the number of entries to return. Maximum page size is
// 500. Default is 100.
