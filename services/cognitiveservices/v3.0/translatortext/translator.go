...
// requestBody - the body of the request is a JSON array. Each array element is a JSON object with a string
...
// responseBody - a successful response is a JSON array with one result for each string in the input array. A
...
// responseHeader - x-RequestId - Value generated by the service to identify the request. It is used for
// troubleshooting purposes.
func (client TranslatorClient) BreakSentence(ctx context.Context, language string, script string, xClientTraceID string, requestBody string, responseBody string, responseHeader string) (result ListBreakSentenceResultItem, err error) {
	...
	req, err := client.BreakSentencePreparer(ctx, language, script, xClientTraceID, requestBody, responseBody, responseHeader)
	if err != nil {
...
func (client TranslatorClient) BreakSentencePreparer(ctx context.Context, language string, script string, xClientTraceID string, requestBody string, responseBody string, responseHeader string) (*http.Request, error) {
	...
	if len(responseHeader) > 0 {
		preparer = autorest.DecoratePreparer(preparer,
			autorest.WithHeader("Response Header", autorest.String(responseHeader)))
	}
...
// responseHeader - x-RequestId - Value generated by the service to identify the request. It is used for
// troubleshooting purposes.
func (client TranslatorClient) Detect(ctx context.Context, xClientTraceID string, requestBody string, responseBody string, responseHeader string) (result ListDetectResultItem, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.DetectPreparer(ctx, xClientTraceID, requestBody, responseBody, responseHeader)
	if err != nil {
...
func (client TranslatorClient) DetectPreparer(ctx context.Context, xClientTraceID string, requestBody string, responseBody string, responseHeader string) (*http.Request, error) {
	urlParameters := map[string]interface{}{
		"Endpoint": client.Endpoint,
	}
...
// xClientTraceID - a client-generated GUID to uniquely identify the request. Note that you can omit this
// header if you include the trace ID in the query string using a query parameter named ClientTraceId.
// requestBody - the body of the request is a JSON array. Each array element is a JSON object with the
...
// empty list.
func (client TranslatorClient) DictionaryExamples(ctx context.Context, from string, toParameter string, xClientTraceID string, requestBody string, responseBody string, responseHeader string) (result ListDictionaryExampleResultItem, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.DictionaryExamplesPreparer(ctx, from, toParameter, xClientTraceID, requestBody, responseBody, responseHeader)
	if err != nil {
...
func (client TranslatorClient) DictionaryExamplesPreparer(ctx context.Context, from string, toParameter string, xClientTraceID string, requestBody string, responseBody string, responseHeader string) (*http.Request, error) {
	urlParameters := map[string]interface{}{
		"Endpoint": client.Endpoint,
	}
...
// responseHeader - x-RequestId - Value generated by the service to identify the request. It is used for
// troubleshooting purposes.
func (client TranslatorClient) DictionaryLookup(ctx context.Context, from string, toParameter string, xClientTraceID string, requestBody string, responseBody string, responseHeader string) (result ListDictionaryLookupResultItem, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.DictionaryLookupPreparer(ctx, from, toParameter, xClientTraceID, requestBody, responseBody, responseHeader)
	if err != nil {
...
func (client TranslatorClient) DictionaryLookupPreparer(ctx context.Context, from string, toParameter string, xClientTraceID string, requestBody string, responseBody string, responseHeader string) (*http.Request, error) {
	urlParameters := map[string]interface{}{
		"Endpoint": client.Endpoint,
	}
...
// xClientTraceID - a client-generated GUID to uniquely identify the request. Note that you can omit this
// header if you include the trace ID in the query string using a query parameter named ClientTraceId.
// responseBody - a client uses the `scope` query parameter to define which groups of languages it is
// interested in.
...
//
// A client may retrieve several groups simultaneously by specifying a comma-separated list of names. For
// example, `scope=translation,transliteration,dictionary` would return supported languages for all groups.
//
...
// The value of the `translation` property is a dictionary of (key, value) pairs. Each key is a BCP 47 language
// tag. A key identifies a language for which text can be translated to or translated from. The value
// associated with the key is a JSON object with properties that describe the language
...
// The value of the `transliteration` property is a dictionary of (key, value) pairs. Each key is a BCP 47
// language tag. A key identifies a language for which text can be converted from one script to another script.
// The value associated with the key is a JSON object with properties that describe the language and its
// supported scripts
// * `name-` Display name of the language in the locale requested via `Accept-Language` header.
// * `nativeName-` Display name of the language in the locale native for this language.
...
// * `dir-` Directionality, which is `rtl` for right-to-left languages or `ltr` for left-to-right languages.
// * `toScripts-` List of scripts available to convert text to. Each element of the `toScripts` list has
// properties `code`, `name`, `nativeName`, and `dir` as described earlier.
//
// ```json
// {
// "transliteration": {
...
// ```
// * `dictionary` property
// The value of the `dictionary` property is a dictionary of (key, value) pairs. Each key is a BCP 47 language
// tag. The key identifies a language for which alternative translations and back-translations are available.
// The value is a JSON object that describes the source language and the target languages with available
// translations.
// * `name-` Display name of the source language in the locale requested via `Accept-Language` header.
// * `nativeName-` Display name of the language in the locale native for this language.
// * `dir-` Directionality, which is `rtl` for right-to-left languages or `ltr` for left-to-right languages.
// * `translations-` List of languages with alterative translations and examples for the query expressed in the
// source language. Each element of the `translations` list has properties
...
// ```
//
// The structure of the response object will not change without a change in the version of the API. For the
// same version of the API, the list of available languages may change over time because Microsoft Translator
...
// responsiveness, a client application should consider caching language resources and the corresponding entity
// tag (`ETag`). Then, the client application can periodically (for example, once every 24 hours) query the
// service to fetch the latest set of supported languages. Passing the current `ETag` value in an
// `If-None-Match` header field will allow the service to optimize the response. If the resource has not been
// modified, the service will return status code 304 and an empty response body.
// responseHeader - eTag - Current value of the entity tag for the requested groups of supported languages. To
// make subsequent requests more efficient, the client may send the `ETag` value in an `If-None-Match` header
// field.
//
// X-RequestId - Value generated by the service to identify the request. It is used for troubleshooting
// purposes.
func (client TranslatorClient) Languages(ctx context.Context, scope []string, acceptLanguage string, xClientTraceID string, responseBody string, responseHeader string) (result LanguagesResult, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.LanguagesPreparer(ctx, scope, acceptLanguage, xClientTraceID, responseBody, responseHeader)
	if err != nil {
...
func (client TranslatorClient) LanguagesPreparer(ctx context.Context, scope []string, acceptLanguage string, xClientTraceID string, responseBody string, responseHeader string) (*http.Request, error) {
	urlParameters := map[string]interface{}{
		"Endpoint": client.Endpoint,
	}
...
func (client TranslatorClient) Translate(ctx context.Context, toParameter []string, from string, textType string, category string, profanityAction string, profanityMarker string, includeAlignment *bool, includeSentenceLength *bool, suggestedFrom string, fromScript string, toScript []string, xClientTraceID string, requestBody string, responseBody string) (result ListTranslateResultAllItem, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		{TargetValue: toParameter,
			Constraints: []validation.Constraint{{Target: "toParameter", Name: validation.Null, Rule: true, Chain: nil}}}}); err != nil {
		return result, validation.NewError("translatortext.TranslatorClient", "Translate", err.Error())
	}

	req, err := client.TranslatePreparer(ctx, toParameter, from, textType, category, profanityAction, profanityMarker, includeAlignment, includeSentenceLength, suggestedFrom, fromScript, toScript, xClientTraceID, requestBody, responseBody)
	if err != nil {
...
func (client TranslatorClient) TranslatePreparer(ctx context.Context, toParameter []string, from string, textType string, category string, profanityAction string, profanityMarker string, includeAlignment *bool, includeSentenceLength *bool, suggestedFrom string, fromScript string, toScript []string, xClientTraceID string, requestBody string, responseBody string) (*http.Request, error) {
	urlParameters := map[string]interface{}{
		"Endpoint": client.Endpoint,
	}
