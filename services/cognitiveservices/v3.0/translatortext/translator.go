...
// * `prefixWord-` A string giving the the word to display as a prefix of the translation. Currently, this is
// the gendered determiner of nouns, in languages that have gendered determiners. For example, the prefix of
// the Spanish word "mosca" is "la", since "mosca" is a feminine noun in Spanish. This is only dependent on the
