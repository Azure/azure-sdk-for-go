// Package computervision implements the Azure ARM Computervision service API version 3.2.
//
...
// is "en". See https://aka.ms/cv-languages for list of supported languages.
// descriptionExclude - turn off specified domain models when generating the description.
// modelVersion - optional parameter to specify the version of the AI model. Accepted values are: "latest",
// "2021-04-01", "2021-05-01". Defaults to "latest".
func (client BaseClient) AnalyzeImage(ctx context.Context, imageURL ImageURL, visualFeatures []VisualFeatureTypes, details []Details, language string, descriptionExclude []DescriptionExclude, modelVersion string) (result ImageAnalysis, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		{TargetValue: imageURL,
			Constraints: []validation.Constraint{{Target: "imageURL.URL", Name: validation.Null, Rule: true, Chain: nil}}},
		{TargetValue: modelVersion,
			Constraints: []validation.Constraint{{Target: "modelVersion", Name: validation.Empty, Rule: false,
				Chain: []validation.Constraint{{Target: "modelVersion", Name: validation.Pattern, Rule: `^(latest|\d{4}-\d{2}-\d{2})(-preview)?$`, Chain: nil}}}}}}); err != nil {
		return result, validation.NewError("computervision.BaseClient", "AnalyzeImage", err.Error())
	}

	req, err := client.AnalyzeImagePreparer(ctx, imageURL, visualFeatures, details, language, descriptionExclude, modelVersion)
	if err != nil {
...
func (client BaseClient) AnalyzeImagePreparer(ctx context.Context, imageURL ImageURL, visualFeatures []VisualFeatureTypes, details []Details, language string, descriptionExclude []DescriptionExclude, modelVersion string) (*http.Request, error) {
	...
	if len(modelVersion) > 0 {
		queryParameters["model-version"] = autorest.Encode("query", modelVersion)
	} else {
		queryParameters["model-version"] = autorest.Encode("query", "latest")
	}

	preparer := autorest.CreatePreparer(
		autorest.AsContentType("application/json; charset=utf-8"),
		autorest.AsPost(),
		autorest.WithCustomBaseURL("{Endpoint}/vision/v3.2", urlParameters),
...
// modelVersion - optional parameter to specify the version of the AI model. Accepted values are: "latest",
// "2021-04-01", "2021-05-01". Defaults to "latest".
func (client BaseClient) AnalyzeImageByDomain(ctx context.Context, model string, imageURL ImageURL, language string, modelVersion string) (result DomainModelResults, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.AnalyzeImageByDomainPreparer(ctx, model, imageURL, language, modelVersion)
	if err != nil {
...
func (client BaseClient) AnalyzeImageByDomainPreparer(ctx context.Context, model string, imageURL ImageURL, language string, modelVersion string) (*http.Request, error) {
	urlParameters := map[string]interface{}{
		"Endpoint": client.Endpoint,
	}
...
// modelVersion - optional parameter to specify the version of the AI model. Accepted values are: "latest",
// "2021-04-01", "2021-05-01". Defaults to "latest".
func (client BaseClient) AnalyzeImageByDomainInStream(ctx context.Context, model string, imageParameter io.ReadCloser, language string, modelVersion string) (result DomainModelResults, err error) {
	if tracing.IsEnabled() {
	...
	if err := validation.Validate([]validation.Validation{
		{TargetValue: modelVersion,
			Constraints: []validation.Constraint{{Target: "modelVersion", Name: validation.Empty, Rule: false,
				Chain: []validation.Constraint{{Target: "modelVersion", Name: validation.Pattern, Rule: `^(latest|\d{4}-\d{2}-\d{2})(-preview)?$`, Chain: nil}}}}}}); err != nil {
		return result, validation.NewError("computervision.BaseClient", "AnalyzeImageByDomainInStream", err.Error())
	}

	req, err := client.AnalyzeImageByDomainInStreamPreparer(ctx, model, imageParameter, language, modelVersion)
	if err != nil {
...
func (client BaseClient) AnalyzeImageByDomainInStreamPreparer(ctx context.Context, model string, imageParameter io.ReadCloser, language string, modelVersion string) (*http.Request, error) {
	urlParameters := map[string]interface{}{
		"Endpoint": client.Endpoint,
	}
...
// modelVersion - optional parameter to specify the version of the AI model. Accepted values are: "latest",
// "2021-04-01", "2021-05-01". Defaults to "latest".
func (client BaseClient) AnalyzeImageInStream(ctx context.Context, imageParameter io.ReadCloser, visualFeatures []VisualFeatureTypes, details []Details, language string, descriptionExclude []DescriptionExclude, modelVersion string) (result ImageAnalysis, err error) {
	if tracing.IsEnabled() {
	...
	if err := validation.Validate([]validation.Validation{
		{TargetValue: modelVersion,
			Constraints: []validation.Constraint{{Target: "modelVersion", Name: validation.Empty, Rule: false,
				Chain: []validation.Constraint{{Target: "modelVersion", Name: validation.Pattern, Rule: `^(latest|\d{4}-\d{2}-\d{2})(-preview)?$`, Chain: nil}}}}}}); err != nil {
		return result, validation.NewError("computervision.BaseClient", "AnalyzeImageInStream", err.Error())
	}

	req, err := client.AnalyzeImageInStreamPreparer(ctx, imageParameter, visualFeatures, details, language, descriptionExclude, modelVersion)
	if err != nil {
...
func (client BaseClient) AnalyzeImageInStreamPreparer(ctx context.Context, imageParameter io.ReadCloser, visualFeatures []VisualFeatureTypes, details []Details, language string, descriptionExclude []DescriptionExclude, modelVersion string) (*http.Request, error) {
	urlParameters := map[string]interface{}{
		"Endpoint": client.Endpoint,
	}
...
// modelVersion - optional parameter to specify the version of the AI model. Accepted values are: "latest",
// "2021-04-01", "2021-05-01". Defaults to "latest".
func (client BaseClient) DescribeImage(ctx context.Context, imageURL ImageURL, maxCandidates *int32, language string, descriptionExclude []DescriptionExclude, modelVersion string) (result ImageDescription, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.DescribeImagePreparer(ctx, imageURL, maxCandidates, language, descriptionExclude, modelVersion)
	if err != nil {
...
func (client BaseClient) DescribeImagePreparer(ctx context.Context, imageURL ImageURL, maxCandidates *int32, language string, descriptionExclude []DescriptionExclude, modelVersion string) (*http.Request, error) {
	urlParameters := map[string]interface{}{
		"Endpoint": client.Endpoint,
	}
...
// modelVersion - optional parameter to specify the version of the AI model. Accepted values are: "latest",
// "2021-04-01", "2021-05-01". Defaults to "latest".
func (client BaseClient) DescribeImageInStream(ctx context.Context, imageParameter io.ReadCloser, maxCandidates *int32, language string, descriptionExclude []DescriptionExclude, modelVersion string) (result ImageDescription, err error) {
	if tracing.IsEnabled() {
	...
	if err := validation.Validate([]validation.Validation{
		{TargetValue: modelVersion,
			Constraints: []validation.Constraint{{Target: "modelVersion", Name: validation.Empty, Rule: false,
				Chain: []validation.Constraint{{Target: "modelVersion", Name: validation.Pattern, Rule: `^(latest|\d{4}-\d{2}-\d{2})(-preview)?$`, Chain: nil}}}}}}); err != nil {
		return result, validation.NewError("computervision.BaseClient", "DescribeImageInStream", err.Error())
	}

	req, err := client.DescribeImageInStreamPreparer(ctx, imageParameter, maxCandidates, language, descriptionExclude, modelVersion)
	if err != nil {
...
func (client BaseClient) DescribeImageInStreamPreparer(ctx context.Context, imageParameter io.ReadCloser, maxCandidates *int32, language string, descriptionExclude []DescriptionExclude, modelVersion string) (*http.Request, error) {
	urlParameters := map[string]interface{}{
		"Endpoint": client.Endpoint,
	}
...
// modelVersion - optional parameter to specify the version of the AI model. Accepted values are: "latest",
// "2021-04-01", "2021-05-01". Defaults to "latest".
func (client BaseClient) DetectObjects(ctx context.Context, imageURL ImageURL, modelVersion string) (result DetectResult, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.DetectObjectsPreparer(ctx, imageURL, modelVersion)
	if err != nil {
...
func (client BaseClient) DetectObjectsPreparer(ctx context.Context, imageURL ImageURL, modelVersion string) (*http.Request, error) {
	urlParameters := map[string]interface{}{
		"Endpoint": client.Endpoint,
	}
...
// modelVersion - optional parameter to specify the version of the AI model. Accepted values are: "latest",
// "2021-04-01", "2021-05-01". Defaults to "latest".
func (client BaseClient) DetectObjectsInStream(ctx context.Context, imageParameter io.ReadCloser, modelVersion string) (result DetectResult, err error) {
	if tracing.IsEnabled() {
	...
	if err := validation.Validate([]validation.Validation{
		{TargetValue: modelVersion,
			Constraints: []validation.Constraint{{Target: "modelVersion", Name: validation.Empty, Rule: false,
				Chain: []validation.Constraint{{Target: "modelVersion", Name: validation.Pattern, Rule: `^(latest|\d{4}-\d{2}-\d{2})(-preview)?$`, Chain: nil}}}}}}); err != nil {
		return result, validation.NewError("computervision.BaseClient", "DetectObjectsInStream", err.Error())
	}

	req, err := client.DetectObjectsInStreamPreparer(ctx, imageParameter, modelVersion)
	if err != nil {
...
func (client BaseClient) DetectObjectsInStreamPreparer(ctx context.Context, imageParameter io.ReadCloser, modelVersion string) (*http.Request, error) {
	urlParameters := map[string]interface{}{
		"Endpoint": client.Endpoint,
	}
...
// modelVersion - optional parameter to specify the version of the AI model. Accepted values are: "latest",
// "2021-04-01", "2021-05-01". Defaults to "latest".
func (client BaseClient) GenerateThumbnail(ctx context.Context, width int32, height int32, imageURL ImageURL, smartCropping *bool, modelVersion string) (result ReadCloser, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.GenerateThumbnailPreparer(ctx, width, height, imageURL, smartCropping, modelVersion)
	if err != nil {
...
func (client BaseClient) GenerateThumbnailPreparer(ctx context.Context, width int32, height int32, imageURL ImageURL, smartCropping *bool, modelVersion string) (*http.Request, error) {
	urlParameters := map[string]interface{}{
		"Endpoint": client.Endpoint,
	}
...
// modelVersion - optional parameter to specify the version of the AI model. Accepted values are: "latest",
// "2021-04-01", "2021-05-01". Defaults to "latest".
func (client BaseClient) GenerateThumbnailInStream(ctx context.Context, width int32, height int32, imageParameter io.ReadCloser, smartCropping *bool, modelVersion string) (result ReadCloser, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.GenerateThumbnailInStreamPreparer(ctx, width, height, imageParameter, smartCropping, modelVersion)
	if err != nil {
...
func (client BaseClient) GenerateThumbnailInStreamPreparer(ctx context.Context, width int32, height int32, imageParameter io.ReadCloser, smartCropping *bool, modelVersion string) (*http.Request, error) {
	urlParameters := map[string]interface{}{
		"Endpoint": client.Endpoint,
	}
...
// modelVersion - optional parameter to specify the version of the AI model. Accepted values are: "latest",
// "2021-04-01", "2021-05-01". Defaults to "latest".
func (client BaseClient) GetAreaOfInterest(ctx context.Context, imageURL ImageURL, modelVersion string) (result AreaOfInterestResult, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.GetAreaOfInterestPreparer(ctx, imageURL, modelVersion)
	if err != nil {
...
func (client BaseClient) GetAreaOfInterestPreparer(ctx context.Context, imageURL ImageURL, modelVersion string) (*http.Request, error) {
	urlParameters := map[string]interface{}{
		"Endpoint": client.Endpoint,
	}
...
// modelVersion - optional parameter to specify the version of the AI model. Accepted values are: "latest",
// "2021-04-01", "2021-05-01". Defaults to "latest".
func (client BaseClient) GetAreaOfInterestInStream(ctx context.Context, imageParameter io.ReadCloser, modelVersion string) (result AreaOfInterestResult, err error) {
	if tracing.IsEnabled() {
	...
	if err := validation.Validate([]validation.Validation{
		{TargetValue: modelVersion,
			Constraints: []validation.Constraint{{Target: "modelVersion", Name: validation.Empty, Rule: false,
				Chain: []validation.Constraint{{Target: "modelVersion", Name: validation.Pattern, Rule: `^(latest|\d{4}-\d{2}-\d{2})(-preview)?$`, Chain: nil}}}}}}); err != nil {
		return result, validation.NewError("computervision.BaseClient", "GetAreaOfInterestInStream", err.Error())
	}

	req, err := client.GetAreaOfInterestInStreamPreparer(ctx, imageParameter, modelVersion)
	if err != nil {
...
func (client BaseClient) GetAreaOfInterestInStreamPreparer(ctx context.Context, imageParameter io.ReadCloser, modelVersion string) (*http.Request, error) {
	urlParameters := map[string]interface{}{
		"Endpoint": client.Endpoint,
	}
...
// Parameters:
// imageURL - a JSON document with a URL pointing to the image that is to be analyzed.
// language - the BCP-47 language code of the text in the document. Read supports auto language identification
// and multi-language documents, so only provide a language code if you would like to force the document to be
// processed in that specific language. See https://aka.ms/ocr-languages for list of supported languages.
// pages - custom page numbers for multi-page documents(PDF/TIFF), input the number of the pages you want to
// get OCR result. For a range of pages, use a hyphen. Separate each page or range with a comma.
// modelVersion - optional parameter to specify the version of the OCR model used for text extraction. Accepted
// values are: "latest", "latest-preview", "2021-04-12". Defaults to "latest".
// readingOrder - optional parameter to specify which reading order algorithm should be applied when ordering
// the extract text elements. Can be either 'basic' or 'natural'. Will default to 'basic' if not specified
func (client BaseClient) Read(ctx context.Context, imageURL ImageURL, language OcrDetectionLanguage, pages []string, modelVersion string, readingOrder string) (result autorest.Response, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.ReadPreparer(ctx, imageURL, language, pages, modelVersion, readingOrder)
	if err != nil {
...
func (client BaseClient) ReadPreparer(ctx context.Context, imageURL ImageURL, language OcrDetectionLanguage, pages []string, modelVersion string, readingOrder string) (*http.Request, error) {
	urlParameters := map[string]interface{}{
		"Endpoint": client.Endpoint,
	}
	...
	if pages != nil && len(pages) > 0 {
		queryParameters["pages"] = autorest.Encode("query", pages, ",")
	}
	if len(modelVersion) > 0 {
		queryParameters["model-version"] = autorest.Encode("query", modelVersion)
	} else {
	...
	if len(readingOrder) > 0 {
		queryParameters["readingOrder"] = autorest.Encode("query", readingOrder)
	} else {
		queryParameters["readingOrder"] = autorest.Encode("query", "basic")
	}
...
// readingOrder - optional parameter to specify which reading order algorithm should be applied when ordering
// the extract text elements. Can be either 'basic' or 'natural'. Will default to 'basic' if not specified
func (client BaseClient) ReadInStream(ctx context.Context, imageParameter io.ReadCloser, language OcrDetectionLanguage, pages []string, modelVersion string, readingOrder string) (result autorest.Response, err error) {
	if tracing.IsEnabled() {
	...
	if err := validation.Validate([]validation.Validation{
		{TargetValue: modelVersion,
			Constraints: []validation.Constraint{{Target: "modelVersion", Name: validation.Empty, Rule: false,
				Chain: []validation.Constraint{{Target: "modelVersion", Name: validation.Pattern, Rule: `^(latest|\d{4}-\d{2}-\d{2})(-preview)?$`, Chain: nil}}}}}}); err != nil {
		return result, validation.NewError("computervision.BaseClient", "ReadInStream", err.Error())
	}

	req, err := client.ReadInStreamPreparer(ctx, imageParameter, language, pages, modelVersion, readingOrder)
	if err != nil {
...
func (client BaseClient) ReadInStreamPreparer(ctx context.Context, imageParameter io.ReadCloser, language OcrDetectionLanguage, pages []string, modelVersion string, readingOrder string) (*http.Request, error) {
	urlParameters := map[string]interface{}{
		"Endpoint": client.Endpoint,
	}
...
// modelVersion - optional parameter to specify the version of the AI model. Accepted values are: "latest",
// "2021-04-01", "2021-05-01". Defaults to "latest".
func (client BaseClient) RecognizePrintedText(ctx context.Context, detectOrientation bool, imageURL ImageURL, language OcrLanguages, modelVersion string) (result OcrResult, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.RecognizePrintedTextPreparer(ctx, detectOrientation, imageURL, language, modelVersion)
	if err != nil {
...
func (client BaseClient) RecognizePrintedTextPreparer(ctx context.Context, detectOrientation bool, imageURL ImageURL, language OcrLanguages, modelVersion string) (*http.Request, error) {
	urlParameters := map[string]interface{}{
		"Endpoint": client.Endpoint,
	}
...
// modelVersion - optional parameter to specify the version of the AI model. Accepted values are: "latest",
// "2021-04-01", "2021-05-01". Defaults to "latest".
func (client BaseClient) RecognizePrintedTextInStream(ctx context.Context, detectOrientation bool, imageParameter io.ReadCloser, language OcrLanguages, modelVersion string) (result OcrResult, err error) {
	if tracing.IsEnabled() {
	...
	if err := validation.Validate([]validation.Validation{
		{TargetValue: modelVersion,
			Constraints: []validation.Constraint{{Target: "modelVersion", Name: validation.Empty, Rule: false,
				Chain: []validation.Constraint{{Target: "modelVersion", Name: validation.Pattern, Rule: `^(latest|\d{4}-\d{2}-\d{2})(-preview)?$`, Chain: nil}}}}}}); err != nil {
		return result, validation.NewError("computervision.BaseClient", "RecognizePrintedTextInStream", err.Error())
	}

	req, err := client.RecognizePrintedTextInStreamPreparer(ctx, detectOrientation, imageParameter, language, modelVersion)
	if err != nil {
...
func (client BaseClient) RecognizePrintedTextInStreamPreparer(ctx context.Context, detectOrientation bool, imageParameter io.ReadCloser, language OcrLanguages, modelVersion string) (*http.Request, error) {
	urlParameters := map[string]interface{}{
		"Endpoint": client.Endpoint,
	}
...
// modelVersion - optional parameter to specify the version of the AI model. Accepted values are: "latest",
// "2021-04-01", "2021-05-01". Defaults to "latest".
func (client BaseClient) TagImage(ctx context.Context, imageURL ImageURL, language string, modelVersion string) (result TagResult, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.TagImagePreparer(ctx, imageURL, language, modelVersion)
	if err != nil {
...
func (client BaseClient) TagImagePreparer(ctx context.Context, imageURL ImageURL, language string, modelVersion string) (*http.Request, error) {
	urlParameters := map[string]interface{}{
		"Endpoint": client.Endpoint,
	}
...
// modelVersion - optional parameter to specify the version of the AI model. Accepted values are: "latest",
// "2021-04-01", "2021-05-01". Defaults to "latest".
func (client BaseClient) TagImageInStream(ctx context.Context, imageParameter io.ReadCloser, language string, modelVersion string) (result TagResult, err error) {
	if tracing.IsEnabled() {
	...
	if err := validation.Validate([]validation.Validation{
		{TargetValue: modelVersion,
			Constraints: []validation.Constraint{{Target: "modelVersion", Name: validation.Empty, Rule: false,
				Chain: []validation.Constraint{{Target: "modelVersion", Name: validation.Pattern, Rule: `^(latest|\d{4}-\d{2}-\d{2})(-preview)?$`, Chain: nil}}}}}}); err != nil {
		return result, validation.NewError("computervision.BaseClient", "TagImageInStream", err.Error())
	}

	req, err := client.TagImageInStreamPreparer(ctx, imageParameter, language, modelVersion)
	if err != nil {
...
func (client BaseClient) TagImageInStreamPreparer(ctx context.Context, imageParameter io.ReadCloser, language string, modelVersion string) (*http.Request, error) {
	urlParameters := map[string]interface{}{
		"Endpoint": client.Endpoint,
	}
