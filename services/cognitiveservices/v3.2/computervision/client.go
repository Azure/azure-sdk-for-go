...
func (client BaseClient) Read(ctx context.Context, imageURL ImageURL, language OcrDetectionLanguage, pages []string, modelVersion string) (result autorest.Response, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.ReadPreparer(ctx, imageURL, language, pages, modelVersion)
	if err != nil {
...
func (client BaseClient) ReadPreparer(ctx context.Context, imageURL ImageURL, language OcrDetectionLanguage, pages []string, modelVersion string) (*http.Request, error) {
	urlParameters := map[string]interface{}{
		"Endpoint": client.Endpoint,
	}
...
// pages - custom page numbers for multi-page documents(PDF/TIFF), input the number of the pages you want to
// get OCR result. For a range of pages, use a hyphen. Separate each page or range with a comma.
func (client BaseClient) ReadInStream(ctx context.Context, imageParameter io.ReadCloser, language OcrDetectionLanguage, pages []string) (result autorest.Response, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.ReadInStreamPreparer(ctx, imageParameter, language, pages)
	if err != nil {
...
func (client BaseClient) ReadInStreamPreparer(ctx context.Context, imageParameter io.ReadCloser, language OcrDetectionLanguage, pages []string) (*http.Request, error) {
	urlParameters := map[string]interface{}{
		"Endpoint": client.Endpoint,
	}
