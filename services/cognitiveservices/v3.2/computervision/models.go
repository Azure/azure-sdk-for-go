...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/cognitiveservices/v3.2/computervision"
...
type AnalyzeResults struct {
	...
	// ModelVersion - Version of the OCR model used for text extraction.
	ModelVersion *string `json:"modelVersion,omitempty"`
	// ReadResults - Text extracted from the input.
	ReadResults *[]ReadResult `json:"readResults,omitempty"`
}

// Appearance an object representing the appearance of the text line.
type Appearance struct {
	// Style - An object representing the style of the text line.
...
func (aoir AreaOfInterestResult) MarshalJSON() ([]byte, error) {
	...
	if aoir.ModelVersion != nil {
		objectMap["modelVersion"] = aoir.ModelVersion
	}
...
func (dr DetectResult) MarshalJSON() ([]byte, error) {
	...
	if dr.ModelVersion != nil {
		objectMap["modelVersion"] = dr.ModelVersion
	}
	return json.Marshal(objectMap)
}
...
// ErrorResponse the API error response.
...
func (ID ImageDescription) MarshalJSON() ([]byte, error) {
	...
	if ID.ModelVersion != nil {
		objectMap["modelVersion"] = ID.ModelVersion
	}
	return json.Marshal(objectMap)
}
	...
	for k, v := range m {
		...
		case "modelVersion":
			if v != nil {
				...
				err = json.Unmarshal(*v, &modelVersion)
				if err != nil {
					return err
				}
				ID.ModelVersion = &modelVersion
			}
		}
	}
...
// InnerError details about the API request error.
type InnerError struct {
	// Code - The error code. Possible values include: 'InnerErrorCodeValueInvalidImageFormat', 'InnerErrorCodeValueUnsupportedMediaType', 'InnerErrorCodeValueInvalidImageURL', 'InnerErrorCodeValueNotSupportedFeature', 'InnerErrorCodeValueNotSupportedImage', 'InnerErrorCodeValueTimeout', 'InnerErrorCodeValueInternalServerError', 'InnerErrorCodeValueInvalidImageSize', 'InnerErrorCodeValueBadArgument', 'InnerErrorCodeValueDetectFaceError', 'InnerErrorCodeValueNotSupportedLanguage', 'InnerErrorCodeValueInvalidThumbnailSize', 'InnerErrorCodeValueInvalidDetails', 'InnerErrorCodeValueInvalidModel', 'InnerErrorCodeValueCancelledRequest', 'InnerErrorCodeValueNotSupportedVisualFeature', 'InnerErrorCodeValueFailedToProcess', 'InnerErrorCodeValueUnspecified', 'InnerErrorCodeValueStorageException'
	Code InnerErrorCodeValue `json:"code,omitempty"`
...
type Line struct {
	...
	// Appearance - Appearance of the text line.
...
// OcrError details about the API request error.
...
// Style an object representing the style of the text line.
type Style struct {
	// Name - The text line style name, including handwriting and other. Possible values include: 'Other', 'Handwriting'
	Name TextStyle `json:"name,omitempty"`
	// Confidence - The confidence of text line style.
	Confidence *float64 `json:"confidence,omitempty"`
}
