...
func (client AvailabilitySetsClient) CreateOrUpdate(ctx context.Context, resourceGroupName string, name string, parameters AvailabilitySet) (*AvailabilitySet, error) {
...
func (client AvailabilitySetsClient) createOrUpdatePreparer(resourceGroupName string, name string, parameters AvailabilitySet) (pipeline.Request, error) {
	u := client.url
