...
func (client VirtualMachineScaleSetsClient) CreateOrUpdate(ctx context.Context, resourceGroupName string, name string, parameters VirtualMachineScaleSet) (*VirtualMachineScaleSet, error) {
	if err := validate([]validation{
		{targetValue: parameters,
			constraints: []constraint{{target: "parameters.VirtualMachineScaleSetProperties", name: null, rule: false,
				chain: []constraint{{target: "parameters.VirtualMachineScaleSetProperties.VirtualMachineProfile", name: null, rule: false,
					chain: []constraint{{target: "parameters.VirtualMachineScaleSetProperties.VirtualMachineProfile.StorageProfile", name: null, rule: false,
						chain: []constraint{{target: "parameters.VirtualMachineScaleSetProperties.VirtualMachineProfile.StorageProfile.OsDisk", name: null, rule: false,
							chain: []constraint{{target: "parameters.VirtualMachineScaleSetProperties.VirtualMachineProfile.StorageProfile.OsDisk.Name", name: null, rule: true, chain: nil}}},
						}},
					}},
				}}}}}); err != nil {
		return nil, err
