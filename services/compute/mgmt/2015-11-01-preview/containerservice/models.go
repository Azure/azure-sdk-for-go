...
// ContainerServiceCreateOrUpdateFuture an abstraction for monitoring and retrieving the results of a long-running
// operation.
type ContainerServiceCreateOrUpdateFuture struct {
	azure.Future
	req *http.Request
}
...
func (future ContainerServiceCreateOrUpdateFuture) Result(client Client) (cs ContainerService, err error) {
	var done bool
...
// ContainerServiceDeleteFuture an abstraction for monitoring and retrieving the results of a long-running operation.
type ContainerServiceDeleteFuture struct {
	azure.Future
	req *http.Request
}
...
// Result returns the result of the asynchronous operation.
// If the operation has not completed it will return an error.
func (future ContainerServiceDeleteFuture) Result(client Client) (ar autorest.Response, err error) {
	var done bool
	done, err = future.Done(client)
	if err != nil {
		return
