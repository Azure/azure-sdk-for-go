...
const (
	...
	DiskCreateOptionRestore DiskCreateOptionType = "Restore"
)
...
type CreationData struct {
	// CreateOption - This enumerates the possible sources of a disk's creation. Possible values include: 'Empty', 'Attach', 'FromImage', 'Import', 'Copy', 'Restore', 'None'
...
type DiskProperties struct {
	// AccountType - the storage account type of the disk. Possible values include: 'StandardLRS', 'PremiumLRS', 'None'
	AccountType StorageAccountTypesType `json:"accountType,omitempty"`
