...
// ReimageAll allows you to re-image all the disks ( including data disks ) in the a virtual machine scale set
// instance. This operation is only supported for managed disks. This method may poll for completion. Polling can be
