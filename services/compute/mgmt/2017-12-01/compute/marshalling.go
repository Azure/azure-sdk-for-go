...
type logAnalyticsInputBase struct {
	...
	FromTime              timeRFC3339 `json:"fromTime,omitempty"`
	ToTime                timeRFC3339 `json:"toTime,omitempty"`
...
// MarshalXML implements the xml.Marshaler interface for LogAnalyticsInputBase.
func (laib LogAnalyticsInputBase) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	if reflect.TypeOf((*LogAnalyticsInputBase)(nil)).Elem().Size() != reflect.TypeOf((*logAnalyticsInputBase)(nil)).Elem().Size() {
		panic("size mismatch between LogAnalyticsInputBase and logAnalyticsInputBase")
	}
	laib2 := (*logAnalyticsInputBase)(unsafe.Pointer(&laib))
	return e.EncodeElement(*laib2, start)
}

// UnmarshalXML implements the xml.Unmarshaler interface for LogAnalyticsInputBase.
func (laib *LogAnalyticsInputBase) UnmarshalXML(d *xml.Decoder, start xml.StartElement) error {
	if reflect.TypeOf((*LogAnalyticsInputBase)(nil)).Elem().Size() != reflect.TypeOf((*logAnalyticsInputBase)(nil)).Elem().Size() {
		panic("size mismatch between LogAnalyticsInputBase and logAnalyticsInputBase")
	}
	laib2 := (*logAnalyticsInputBase)(unsafe.Pointer(laib))
	return d.DecodeElement(laib2, &start)
}
