...
func (client VirtualMachineScaleSetsClient) CreateOrUpdate(ctx context.Context, resourceGroupName string, VMScaleSetName string, parameters VirtualMachineScaleSet) (*VirtualMachineScaleSet, error) {
	if err := validate([]validation{
		{targetValue: parameters,
			constraints: []constraint{{target: "parameters.VirtualMachineScaleSetProperties", name: null, rule: false,
				chain: []constraint{{target: "parameters.VirtualMachineScaleSetProperties.UpgradePolicy", name: null, rule: false,
					chain: []constraint{{target: "parameters.VirtualMachineScaleSetProperties.UpgradePolicy.RollingUpgradePolicy", name: null, rule: false,
						chain: []constraint{{target: "parameters.VirtualMachineScaleSetProperties.UpgradePolicy.RollingUpgradePolicy.MaxBatchInstancePercent", name: null, rule: false,
							chain: []constraint{{target: "parameters.VirtualMachineScaleSetProperties.UpgradePolicy.RollingUpgradePolicy.MaxBatchInstancePercent", name: inclusiveMaximum, rule: 100, chain: nil},
								{target: "parameters.VirtualMachineScaleSetProperties.UpgradePolicy.RollingUpgradePolicy.MaxBatchInstancePercent", name: inclusiveMinimum, rule: 5, chain: nil},
							}},
							{target: "parameters.VirtualMachineScaleSetProperties.UpgradePolicy.RollingUpgradePolicy.MaxUnhealthyInstancePercent", name: null, rule: false,
								chain: []constraint{{target: "parameters.VirtualMachineScaleSetProperties.UpgradePolicy.RollingUpgradePolicy.MaxUnhealthyInstancePercent", name: inclusiveMaximum, rule: 100, chain: nil},
									{target: "parameters.VirtualMachineScaleSetProperties.UpgradePolicy.RollingUpgradePolicy.MaxUnhealthyInstancePercent", name: inclusiveMinimum, rule: 5, chain: nil},
								}},
							{target: "parameters.VirtualMachineScaleSetProperties.UpgradePolicy.RollingUpgradePolicy.MaxUnhealthyUpgradedInstancePercent", name: null, rule: false,
								chain: []constraint{{target: "parameters.VirtualMachineScaleSetProperties.UpgradePolicy.RollingUpgradePolicy.MaxUnhealthyUpgradedInstancePercent", name: inclusiveMaximum, rule: 100, chain: nil},
									{target: "parameters.VirtualMachineScaleSetProperties.UpgradePolicy.RollingUpgradePolicy.MaxUnhealthyUpgradedInstancePercent", name: inclusiveMinimum, rule: 0, chain: nil},
								}},
						}},
					}},
				}}}}}); err != nil {
...
func (client VirtualMachineScaleSetsClient) createOrUpdatePreparer(resourceGroupName string, VMScaleSetName string, parameters VirtualMachineScaleSet) (pipeline.Request, error) {
	u := client.url
...
func (client VirtualMachineScaleSetsClient) ForceRecoveryServiceFabricPlatformUpdateDomainWalk(ctx context.Context, resourceGroupName string, VMScaleSetName string, platformUpdateDomain int32) (*RecoveryWalkResponse, error) {
	req, err := client.forceRecoveryServiceFabricPlatformUpdateDomainWalkPreparer(resourceGroupName, VMScaleSetName, platformUpdateDomain)
	if err != nil {
		return nil, err
	}
	resp, err := client.Pipeline().Do(ctx, responderPolicyFactory{responder: client.forceRecoveryServiceFabricPlatformUpdateDomainWalkResponder}, req)
	if err != nil {
		return nil, err
	}
	return resp.(*RecoveryWalkResponse), err
}
...
func (client VirtualMachineScaleSetsClient) forceRecoveryServiceFabricPlatformUpdateDomainWalkPreparer(resourceGroupName string, VMScaleSetName string, platformUpdateDomain int32) (pipeline.Request, error) {
	u := client.url
	u.Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmScaleSetName}/forceRecoveryServiceFabricPlatformUpdateDomainWalk"
	req, err := pipeline.NewRequest("POST", u, nil)
	if err != nil {
		return req, pipeline.NewError(err, "failed to create request")
	}
	params := req.URL.Query()
	params.Set("api-version", "2017-12-01")
	params.Set("platformUpdateDomain", fmt.Sprintf("%v", platformUpdateDomain))
	req.URL.RawQuery = params.Encode()
	return req, nil
}

// forceRecoveryServiceFabricPlatformUpdateDomainWalkResponder handles the response to the ForceRecoveryServiceFabricPlatformUpdateDomainWalk request.
func (client VirtualMachineScaleSetsClient) forceRecoveryServiceFabricPlatformUpdateDomainWalkResponder(resp pipeline.Response) (pipeline.Response, error) {
	err := validateResponse(resp, http.StatusOK)
	if resp == nil {
		return nil, err
	}
	result := &RecoveryWalkResponse{rawResponse: resp.Response()}
	if err != nil {
		return result, err
	}
	defer resp.Response().Body.Close()
...
// resourceGroupName is the name of the resource group. VMScaleSetName is the name of the VM scale set. VMInstanceIDs
// is a list of virtual machine instance IDs from the VM scale set.
func (client VirtualMachineScaleSetsClient) Reimage(ctx context.Context, resourceGroupName string, VMScaleSetName string, VMInstanceIDs *VirtualMachineScaleSetVMInstanceIDs) (*OperationStatusResponse, error) {
	req, err := client.reimagePreparer(resourceGroupName, VMScaleSetName, VMInstanceIDs)
	if err != nil {
		return nil, err
	}
...
func (client VirtualMachineScaleSetsClient) reimagePreparer(resourceGroupName string, VMScaleSetName string, VMInstanceIDs *VirtualMachineScaleSetVMInstanceIDs) (pipeline.Request, error) {
	u := client.url
...
// resourceGroupName is the name of the resource group. VMScaleSetName is the name of the VM scale set. VMInstanceIDs
// is a list of virtual machine instance IDs from the VM scale set.
func (client VirtualMachineScaleSetsClient) ReimageAll(ctx context.Context, resourceGroupName string, VMScaleSetName string, VMInstanceIDs *VirtualMachineScaleSetVMInstanceIDs) (*OperationStatusResponse, error) {
	req, err := client.reimageAllPreparer(resourceGroupName, VMScaleSetName, VMInstanceIDs)
	if err != nil {
		return nil, err
	}
...
func (client VirtualMachineScaleSetsClient) reimageAllPreparer(resourceGroupName string, VMScaleSetName string, VMInstanceIDs *VirtualMachineScaleSetVMInstanceIDs) (pipeline.Request, error) {
	u := client.url
...
// resourceGroupName is the name of the resource group. VMScaleSetName is the name of the VM scale set to create or
// update. parameters is the scale set object.
func (client VirtualMachineScaleSetsClient) Update(ctx context.Context, resourceGroupName string, VMScaleSetName string, parameters VirtualMachineScaleSetUpdate) (*VirtualMachineScaleSet, error) {
	req, err := client.updatePreparer(resourceGroupName, VMScaleSetName, parameters)
	if err != nil {
		return nil, err
	}
...
func (client VirtualMachineScaleSetsClient) updatePreparer(resourceGroupName string, VMScaleSetName string, parameters VirtualMachineScaleSetUpdate) (pipeline.Request, error) {
	u := client.url
	u.Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmScaleSetName}"
...
func (client VirtualMachineScaleSetsClient) updateResponder(resp pipeline.Response) (pipeline.Response, error) {
	err := validateResponse(resp, http.StatusOK)
	if resp == nil {
		return nil, err
	}
