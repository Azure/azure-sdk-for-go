...
func NewVirtualMachineSizesClient(p pipeline.Pipeline) VirtualMachineSizesClient {
	return VirtualMachineSizesClient{NewManagementClient(p)}
}
...
func (client VirtualMachineSizesClient) List(ctx context.Context, location string) (*VirtualMachineSizeListResult, error) {
...
func (client VirtualMachineSizesClient) listPreparer(location string) (pipeline.Request, error) {
	u := client.url
	u.Path = "/subscriptions/{subscriptionId}/providers/Microsoft.Compute/locations/{location}/vmSizes"
...
func (client VirtualMachineSizesClient) listResponder(resp pipeline.Response) (pipeline.Response, error) {
