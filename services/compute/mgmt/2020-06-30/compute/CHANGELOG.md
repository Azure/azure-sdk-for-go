Generated from https://github.com/Azure/azure-rest-api-specs/tree/3c764635e7d442b3e74caf593029fcd440b3ef82/specification/compute/resource-manager/readme.md tag: `package-2020-06-30`
...
1. *DiskAccessesCreateOrUpdateFuture.Result(DiskAccessesClient) (DiskAccess, error)
1. *DiskAccessesDeleteFuture.Result(DiskAccessesClient) (autorest.Response, error)
1. *DiskAccessesUpdateFuture.Result(DiskAccessesClient) (DiskAccess, error)
...
1. *VirtualMachineRunCommandsCreateOrUpdateFuture.Result(VirtualMachineRunCommandsClient) (VirtualMachineRunCommand, error)
1. *VirtualMachineRunCommandsDeleteFuture.Result(VirtualMachineRunCommandsClient) (autorest.Response, error)
1. *VirtualMachineRunCommandsUpdateFuture.Result(VirtualMachineRunCommandsClient) (VirtualMachineRunCommand, error)
...
1. *VirtualMachineScaleSetVMExtensionsCreateOrUpdateFuture.Result(VirtualMachineScaleSetVMExtensionsClient) (VirtualMachineScaleSetVMExtension, error)
1. *VirtualMachineScaleSetVMExtensionsDeleteFuture.Result(VirtualMachineScaleSetVMExtensionsClient) (autorest.Response, error)
1. *VirtualMachineScaleSetVMExtensionsUpdateFuture.Result(VirtualMachineScaleSetVMExtensionsClient) (VirtualMachineScaleSetVMExtension, error)
1. *VirtualMachineScaleSetVMRunCommandsCreateOrUpdateFuture.Result(VirtualMachineScaleSetVMRunCommandsClient) (VirtualMachineRunCommand, error)
1. *VirtualMachineScaleSetVMRunCommandsDeleteFuture.Result(VirtualMachineScaleSetVMRunCommandsClient) (autorest.Response, error)
1. *VirtualMachineScaleSetVMRunCommandsUpdateFuture.Result(VirtualMachineScaleSetVMRunCommandsClient) (VirtualMachineRunCommand, error)
...
1. *VirtualMachinesAssessPatchesFuture.Result(VirtualMachinesClient) (VirtualMachineAssessPatchesResult, error)
...
1. DiskAccessesCreateOrUpdateFuture.azure.Future
1. DiskAccessesDeleteFuture.azure.Future
1. DiskAccessesUpdateFuture.azure.Future
...
1. VirtualMachineRunCommandsCreateOrUpdateFuture.azure.Future
1. VirtualMachineRunCommandsDeleteFuture.azure.Future
1. VirtualMachineRunCommandsUpdateFuture.azure.Future
...
1. VirtualMachineScaleSetVMRunCommandsCreateOrUpdateFuture.azure.Future
1. VirtualMachineScaleSetVMRunCommandsDeleteFuture.azure.Future
1. VirtualMachineScaleSetVMRunCommandsUpdateFuture.azure.Future
...
1. VirtualMachinesAssessPatchesFuture.azure.Future
...
1. DiskAccessesCreateOrUpdateFuture.Result
1. DiskAccessesCreateOrUpdateFuture.azure.FutureAPI
1. DiskAccessesDeleteFuture.Result
1. DiskAccessesDeleteFuture.azure.FutureAPI
1. DiskAccessesUpdateFuture.Result
1. DiskAccessesUpdateFuture.azure.FutureAPI
...
1. VirtualMachineRunCommandsCreateOrUpdateFuture.Result
1. VirtualMachineRunCommandsCreateOrUpdateFuture.azure.FutureAPI
1. VirtualMachineRunCommandsDeleteFuture.Result
1. VirtualMachineRunCommandsDeleteFuture.azure.FutureAPI
1. VirtualMachineRunCommandsUpdateFuture.Result
1. VirtualMachineRunCommandsUpdateFuture.azure.FutureAPI
...
1. VirtualMachineScaleSetVMRunCommandsCreateOrUpdateFuture.Result
1. VirtualMachineScaleSetVMRunCommandsCreateOrUpdateFuture.azure.FutureAPI
1. VirtualMachineScaleSetVMRunCommandsDeleteFuture.Result
1. VirtualMachineScaleSetVMRunCommandsDeleteFuture.azure.FutureAPI
1. VirtualMachineScaleSetVMRunCommandsUpdateFuture.Result
1. VirtualMachineScaleSetVMRunCommandsUpdateFuture.azure.FutureAPI
...
1. VirtualMachinesAssessPatchesFuture.Result
1. VirtualMachinesAssessPatchesFuture.azure.FutureAPI
