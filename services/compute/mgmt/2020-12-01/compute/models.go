...
func (vmssvp VirtualMachineScaleSetVMProperties) MarshalJSON() ([]byte, error) {
	...
	if vmssvp.ApplicationProfile != nil {
		objectMap["applicationProfile"] = vmssvp.ApplicationProfile
	}
...
type VMGalleryApplication struct {
	...
	// Order - Optional, Specifies the order in which the packages have to be installed, has no effect if manuallyManaged is set to true
	Order *int32 `json:"order,omitempty"`
	// ManuallyManaged - Specifies whether the gallery application would be manually managed. If set to true, the VMApplicationExtension would not manage the gallery application
	ManuallyManaged *bool `json:"manuallyManaged,omitempty"`
	// PackageReferenceID - Specifies the GalleryApplicationVersion reference in URL form. e.g. /subscriptions/{SubscriptionId}/resourceGroups/{ResourceGroupName}/providers/Microsoft.Compute/galleries/{galleryName}/applications/{application}/versions/{version}
...
// WindowsPatchSettings specifies settings related to VM Guest Patching on Windows.
