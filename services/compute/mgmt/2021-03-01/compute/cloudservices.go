...
func (client CloudServicesClient) CreateOrUpdateSender(req *http.Request) (future CloudServicesCreateOrUpdateFuture, err error) {
	...
	future.Result = func(client CloudServicesClient) (cs CloudService, err error) {
		var done bool
		...
		if cs.Response.Response == nil && err == nil {
			err = autorest.NewErrorWithError(err, "compute.CloudServicesCreateOrUpdateFuture", "Result", nil, "received nil response and error")
		}
...
func (client CloudServicesClient) DeleteSender(req *http.Request) (future CloudServicesDeleteFuture, err error) {
	...
	azf, err = azure.NewFutureFromResponse(resp)
	future.FutureAPI = &azf
	future.Result = func(client CloudServicesClient) (ar autorest.Response, err error) {
		var done bool
		done, err = future.DoneWithContext(context.Background(), client)
		if err != nil {
...
func (client CloudServicesClient) UpdateSender(req *http.Request) (future CloudServicesUpdateFuture, err error) {
	...
	future.Result = func(client CloudServicesClient) (cs CloudService, err error) {
		...
		cs.Response.Response, err = future.GetResult(sender)
		if cs.Response.Response == nil && err == nil {
			err = autorest.NewErrorWithError(err, "compute.CloudServicesUpdateFuture", "Result", nil, "received nil response and error")
		}
		if err == nil && cs.Response.Response.StatusCode != http.StatusNoContent {
