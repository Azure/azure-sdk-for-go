...
// 'providers/Microsoft.Capacity/reservationorders/{ReservationOrderId}/reservations/{ReservationId}' grain is can be
// daily or monthly filter is required only for daily grain. The properties/UsageDate for start date and end date. The
