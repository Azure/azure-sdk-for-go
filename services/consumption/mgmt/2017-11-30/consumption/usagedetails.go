...
// perdiod. expand is may be used to expand the properties/additionalProperties or properties/meterDetails within a
// list of usage details. By default, these fields are not included when listing usage details. filter is may be used
// to filter usageDetails by properties/usageEnd (Utc time), properties/usageStart (Utc time),
// properties/resourceGroup, properties/instanceName or properties/instanceId. The filter supports 'eq', 'lt', 'gt',
// 'le', 'ge', and 'and'. It does not currently support 'ne', 'or', or 'not'. skiptoken is skiptoken is only used if a
...
// is may be used to limit the number of results to the most recent N usageDetails.
