...
// GroupClient is the consumption management client provides access to consumption resources for Azure Enterprise
// Subscriptions.
...
func (client GroupClient) GetBalancesByBillingAccount(ctx context.Context, billingAccountID string) (result Balance, err error) {
	req, err := client.GetBalancesByBillingAccountPreparer(ctx, billingAccountID)
	if err != nil {
		err = autorest.NewErrorWithError(err, "consumption.GroupClient", "GetBalancesByBillingAccount", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "consumption.GroupClient", "GetBalancesByBillingAccount", resp, "Failure sending request")
		return
	}

	result, err = client.GetBalancesByBillingAccountResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "consumption.GroupClient", "GetBalancesByBillingAccount", resp, "Failure responding to request")
	}
...
func (client GroupClient) GetBalancesByBillingAccountPreparer(ctx context.Context, billingAccountID string) (*http.Request, error) {
...
func (client GroupClient) GetBalancesByBillingAccountSender(req *http.Request) (*http.Response, error) {
...
func (client GroupClient) GetBalancesByBillingAccountResponder(resp *http.Response) (result Balance, err error) {
