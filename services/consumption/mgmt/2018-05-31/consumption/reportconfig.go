...
// ReportConfigClient is the consumption management client provides access to consumption resources for Azure
...
func (client ReportConfigClient) CreateOrUpdate(ctx context.Context, reportConfigName string, parameters ReportConfig) (result ReportConfig, err error) {
	if err := validation.Validate([]validation.Validation{
				...
				Chain: []validation.Constraint{{Target: "parameters.ReportConfigProperties.Schedule", Name: validation.Null, Rule: false,
					...
					{Target: "parameters.ReportConfigProperties.DeliveryInfo", Name: validation.Null, Rule: true,
						Chain: []validation.Constraint{{Target: "parameters.ReportConfigProperties.DeliveryInfo.Destination", Name: validation.Null, Rule: true,
							Chain: []validation.Constraint{{Target: "parameters.ReportConfigProperties.DeliveryInfo.Destination.SubscriptionID", Name: validation.Null, Rule: true, Chain: nil},
								{Target: "parameters.ReportConfigProperties.DeliveryInfo.Destination.ResourceGroup", Name: validation.Null, Rule: true, Chain: nil},
								{Target: "parameters.ReportConfigProperties.DeliveryInfo.Destination.StorageAccount", Name: validation.Null, Rule: true, Chain: nil},
								{Target: "parameters.ReportConfigProperties.DeliveryInfo.Destination.Endpoint", Name: validation.Null, Rule: true, Chain: nil},
								{Target: "parameters.ReportConfigProperties.DeliveryInfo.Destination.Container", Name: validation.Null, Rule: true, Chain: nil},
								{Target: "parameters.ReportConfigProperties.DeliveryInfo.Destination.Category", Name: validation.Null, Rule: true, Chain: nil},
							}},
						}},
		...
		return result, validation.NewError("consumption.ReportConfigClient", "CreateOrUpdate", err.Error())
	}

	req, err := client.CreateOrUpdatePreparer(ctx, reportConfigName, parameters)
	if err != nil {
		err = autorest.NewErrorWithError(err, "consumption.ReportConfigClient", "CreateOrUpdate", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "consumption.ReportConfigClient", "CreateOrUpdate", resp, "Failure sending request")
		return
	}

	result, err = client.CreateOrUpdateResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "consumption.ReportConfigClient", "CreateOrUpdate", resp, "Failure responding to request")
	}
...
func (client ReportConfigClient) CreateOrUpdatePreparer(ctx context.Context, reportConfigName string, parameters ReportConfig) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithPathParameters("/subscriptions/{subscriptionId}/providers/Microsoft.Consumption/reportconfigs/{reportConfigName}", pathParameters),
...
func (client ReportConfigClient) CreateOrUpdateByResourceGroupName(ctx context.Context, resourceGroupName string, reportConfigName string, parameters ReportConfig) (result ReportConfig, err error) {
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewError("consumption.ReportConfigClient", "CreateOrUpdateByResourceGroupName", err.Error())
	}

	req, err := client.CreateOrUpdateByResourceGroupNamePreparer(ctx, resourceGroupName, reportConfigName, parameters)
	if err != nil {
		err = autorest.NewErrorWithError(err, "consumption.ReportConfigClient", "CreateOrUpdateByResourceGroupName", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "consumption.ReportConfigClient", "CreateOrUpdateByResourceGroupName", resp, "Failure sending request")
		return
	}

	result, err = client.CreateOrUpdateByResourceGroupNameResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "consumption.ReportConfigClient", "CreateOrUpdateByResourceGroupName", resp, "Failure responding to request")
	}
...
func (client ReportConfigClient) CreateOrUpdateByResourceGroupNamePreparer(ctx context.Context, resourceGroupName string, reportConfigName string, parameters ReportConfig) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.AsPut(),
		autorest.WithBaseURL(client.BaseURI),
		autorest.WithPathParameters("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Consumption/reportconfigs/{reportConfigName}", pathParameters),
		autorest.WithJSON(parameters),
		autorest.WithQueryParameters(queryParameters))
	return preparer.Prepare((&http.Request{}).WithContext(ctx))
}
...
func (client ReportConfigClient) Delete(ctx context.Context, reportConfigName string) (result autorest.Response, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "consumption.ReportConfigClient", "Delete", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "consumption.ReportConfigClient", "Delete", resp, "Failure sending request")
		return
	}

	result, err = client.DeleteResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "consumption.ReportConfigClient", "Delete", resp, "Failure responding to request")
	}
...
func (client ReportConfigClient) DeleteByResourceGroupName(ctx context.Context, resourceGroupName string, reportConfigName string) (result autorest.Response, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "consumption.ReportConfigClient", "DeleteByResourceGroupName", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = resp
		err = autorest.NewErrorWithError(err, "consumption.ReportConfigClient", "DeleteByResourceGroupName", resp, "Failure sending request")
		return
	}

	result, err = client.DeleteByResourceGroupNameResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "consumption.ReportConfigClient", "DeleteByResourceGroupName", resp, "Failure responding to request")
	}
...
func (client ReportConfigClient) Get(ctx context.Context, reportConfigName string) (result ReportConfig, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "consumption.ReportConfigClient", "Get", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "consumption.ReportConfigClient", "Get", resp, "Failure sending request")
		return
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "consumption.ReportConfigClient", "Get", resp, "Failure responding to request")
	}
...
func (client ReportConfigClient) GetByResourceGroupName(ctx context.Context, resourceGroupName string, reportConfigName string) (result ReportConfig, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "consumption.ReportConfigClient", "GetByResourceGroupName", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "consumption.ReportConfigClient", "GetByResourceGroupName", resp, "Failure sending request")
		return
	}

	result, err = client.GetByResourceGroupNameResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "consumption.ReportConfigClient", "GetByResourceGroupName", resp, "Failure responding to request")
	}
...
func (client ReportConfigClient) List(ctx context.Context) (result ReportConfigListResult, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "consumption.ReportConfigClient", "List", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "consumption.ReportConfigClient", "List", resp, "Failure sending request")
		return
	}

	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "consumption.ReportConfigClient", "List", resp, "Failure responding to request")
	}
...
func (client ReportConfigClient) ListPreparer(ctx context.Context) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		autorest.AsGet(),
		autorest.WithBaseURL(client.BaseURI),
		autorest.WithPathParameters("/subscriptions/{subscriptionId}/providers/Microsoft.Consumption/reportconfigs", pathParameters),
		autorest.WithQueryParameters(queryParameters))
	return preparer.Prepare((&http.Request{}).WithContext(ctx))
}
...
func (client ReportConfigClient) ListByResourceGroupName(ctx context.Context, resourceGroupName string) (result ReportConfigListResult, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "consumption.ReportConfigClient", "ListByResourceGroupName", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "consumption.ReportConfigClient", "ListByResourceGroupName", resp, "Failure sending request")
		return
	}

	result, err = client.ListByResourceGroupNameResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "consumption.ReportConfigClient", "ListByResourceGroupName", resp, "Failure responding to request")
	}
...
func (client ReportConfigClient) ListByResourceGroupNamePreparer(ctx context.Context, resourceGroupName string) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		autorest.AsGet(),
		autorest.WithBaseURL(client.BaseURI),
		autorest.WithPathParameters("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Consumption/reportconfigs", pathParameters),
		autorest.WithQueryParameters(queryParameters))
	return preparer.Prepare((&http.Request{}).WithContext(ctx))
}
