...
// ResourceGroupInsightsClient is the consumption management client provides access to consumption resources for Azure
// Enterprise Subscriptions.
type ResourceGroupInsightsClient struct {
	BaseClient
}

// NewResourceGroupInsightsClient creates an instance of the ResourceGroupInsightsClient client.
func NewResourceGroupInsightsClient(subscriptionID string) ResourceGroupInsightsClient {
	return NewResourceGroupInsightsClientWithBaseURI(DefaultBaseURI, subscriptionID)
}

// NewResourceGroupInsightsClientWithBaseURI creates an instance of the ResourceGroupInsightsClient client.
func NewResourceGroupInsightsClientWithBaseURI(baseURI string, subscriptionID string) ResourceGroupInsightsClient {
	return ResourceGroupInsightsClient{NewWithBaseURI(baseURI, subscriptionID)}
}

// Post lists the consumption data for subscriptionId and resource group.
// Parameters:
// resourceGroupName - azure Resource Group Name.
// parameters - parameters supplied to the CreateOrUpdate Report Config operation.
func (client ResourceGroupInsightsClient) Post(ctx context.Context, resourceGroupName string, parameters ReportConfigDefinition) (result InsightsListResult, err error) {
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewError("consumption.ResourceGroupInsightsClient", "Post", err.Error())
	}

	req, err := client.PostPreparer(ctx, resourceGroupName, parameters)
	if err != nil {
		err = autorest.NewErrorWithError(err, "consumption.ResourceGroupInsightsClient", "Post", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "consumption.ResourceGroupInsightsClient", "Post", resp, "Failure sending request")
		return
	}

	result, err = client.PostResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "consumption.ResourceGroupInsightsClient", "Post", resp, "Failure responding to request")
	}
...
func (client ResourceGroupInsightsClient) PostPreparer(ctx context.Context, resourceGroupName string, parameters ReportConfigDefinition) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithPathParameters("/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/Microsoft.Consumption/Insights", pathParameters),
...
func (client ResourceGroupInsightsClient) PostSender(req *http.Request) (*http.Response, error) {
...
func (client ResourceGroupInsightsClient) PostResponder(resp *http.Response) (result InsightsListResult, err error) {
