...
// MarshalJSON is the custom marshaler for TenantListResult.
func (tlr TenantListResult) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	return json.Marshal(objectMap)
}
...
// MarshalJSON is the custom marshaler for TenantProperties.
func (tp TenantProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	return json.Marshal(objectMap)
}
