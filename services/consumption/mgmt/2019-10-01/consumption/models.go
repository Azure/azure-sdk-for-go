...
//
// * 503 ServiceUnavailable - Service is temporarily unavailable. Retry after waiting for the time specified in
...
func NewEventsPage(getNextPage func(context.Context, Events) (Events, error)) EventsPage {
	return EventsPage{fn: getNextPage}
}
...
func NewLotsPage(getNextPage func(context.Context, Lots) (Lots, error)) LotsPage {
	return LotsPage{fn: getNextPage}
}
...
func NewModernReservationTransactionsListResultPage(getNextPage func(context.Context, ModernReservationTransactionsListResult) (ModernReservationTransactionsListResult, error)) ModernReservationTransactionsListResultPage {
	return ModernReservationTransactionsListResultPage{fn: getNextPage}
}
...
// ReservationRecommendationDetailsUsageProperties details about historical usage data that has been used for
...
// ReservationTransactionsListResultIterator provides access to a complete listing of ReservationTransaction
// values.
...
func NewReservationTransactionsListResultPage(getNextPage func(context.Context, ReservationTransactionsListResult) (ReservationTransactionsListResult, error)) ReservationTransactionsListResultPage {
	return ReservationTransactionsListResultPage{fn: getNextPage}
}
