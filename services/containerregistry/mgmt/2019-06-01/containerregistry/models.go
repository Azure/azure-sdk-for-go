...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/containerregistry/mgmt/2019-06-01/containerregistry"
...
type TaskRunRequest struct {
	...
	// ContinuationToken - Base64 encoded continuation token that will be attached with the base image trigger webhook.
...
func (trr TaskRunRequest) MarshalJSON() ([]byte, error) {
	...
	if trr.ContinuationToken != nil {
		objectMap["continuationToken"] = trr.ContinuationToken
	}
