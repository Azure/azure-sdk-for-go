...
// operation.
func (client Client) CreateOrUpdate(ctx context.Context, resourceGroupName string, containerServiceName string, parameters ContainerService) (*ContainerService, error) {
				...
				chain: []constraint{{target: "parameters.Properties.MasterProfile", name: null, rule: true,
					...
					{target: "parameters.Properties.LinuxProfile", name: null, rule: true,
						chain: []constraint{{target: "parameters.Properties.LinuxProfile.AdminUsername", name: null, rule: true, chain: nil},
							{target: "parameters.Properties.LinuxProfile.SSH", name: null, rule: true, chain: nil},
						}},
				}}}}}); err != nil {
		return nil, err
	}
...
func (client Client) createOrUpdatePreparer(resourceGroupName string, containerServiceName string, parameters ContainerService) (pipeline.Request, error) {
	u := client.url
...
func (client Client) Delete(ctx context.Context, resourceGroupName string, containerServiceName string) (*http.Response, error) {
...
func (client Client) deletePreparer(resourceGroupName string, containerServiceName string) (pipeline.Request, error) {
	u := client.url
	u.Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerService/containerServices/{containerServiceName}"
...
// resourceGroupName is the name of the resource group. containerServiceName is the name of the container service
// within the given subscription and resource group.
func (client Client) Get(ctx context.Context, resourceGroupName string, containerServiceName string) (*ContainerService, error) {
...
func (client Client) getPreparer(resourceGroupName string, containerServiceName string) (pipeline.Request, error) {
	u := client.url
	u.Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerService/containerServices/{containerServiceName}"
...
func (client Client) ListByResourceGroup(ctx context.Context, resourceGroupName string) (*ListResult, error) {
...
func (client Client) listByResourceGroupPreparer(resourceGroupName string) (pipeline.Request, error) {
	u := client.url
