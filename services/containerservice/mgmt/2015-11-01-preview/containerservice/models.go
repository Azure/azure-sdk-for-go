...
const (
	...
	// OchestratorTypesMesos ...
	OchestratorTypesMesos OchestratorTypesType = "Mesos"
	// OchestratorTypesNone represents an empty OchestratorTypesType.
	OchestratorTypesNone OchestratorTypesType = ""
	// OchestratorTypesSwarmPreview ...
	OchestratorTypesSwarmPreview OchestratorTypesType = "SwarmPreview"
)
...
type OrchestratorProfile struct {
	// OrchestratorType - Specifies what orchestrator will be used to manage container cluster resources. Possible values include: 'Mesos', 'SwarmPreview', 'DCOS', 'None'
