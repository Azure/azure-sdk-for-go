	...
	if err := validate([]validation{
		{targetValue: parameters,
			constraints: []constraint{{target: "parameters.Properties", name: null, rule: false,
				chain: []constraint{{target: "parameters.Properties.CustomProfile", name: null, rule: false,
					chain: []constraint{{target: "parameters.Properties.CustomProfile.Orchestrator", name: null, rule: true, chain: nil}}},
					{target: "parameters.Properties.ServicePrincipalProfile", name: null, rule: false,
						chain: []constraint{{target: "parameters.Properties.ServicePrincipalProfile.ClientID", name: null, rule: true, chain: nil},
							{target: "parameters.Properties.ServicePrincipalProfile.Secret", name: null, rule: true, chain: nil},
						}},
					{target: "parameters.Properties.MasterProfile", name: null, rule: true,
					...
					{target: "parameters.Properties.WindowsProfile", name: null, rule: false,
						chain: []constraint{{target: "parameters.Properties.WindowsProfile.AdminUsername", name: null, rule: true,
							chain: []constraint{{target: "parameters.Properties.WindowsProfile.AdminUsername", name: pattern, rule: `^[a-zA-Z0-9]+([._]?[a-zA-Z0-9]+)*$`, chain: nil}}},
							{target: "parameters.Properties.WindowsProfile.AdminPassword", name: null, rule: true,
								chain: []constraint{{target: "parameters.Properties.WindowsProfile.AdminPassword", name: pattern, rule: `^(?=.*[a-z])(?=.*[A-Z])(?=.*[!@#$%\^&\*\(\)])[a-zA-Z\d!@#$%\^&\*\(\)]{12,123}$`, chain: nil}}},
						}},
					{target: "parameters.Properties.LinuxProfile", name: null, rule: true,
						chain: []constraint{{target: "parameters.Properties.LinuxProfile.AdminUsername", name: null, rule: true,
							chain: []constraint{{target: "parameters.Properties.LinuxProfile.AdminUsername", name: pattern, rule: `^[a-z][a-z0-9_-]*$`, chain: nil}}},
