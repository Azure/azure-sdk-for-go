...
const (
	// Deallocate Nodes in the underlying Scale Set of the node pool are set to the stopped-deallocated state
	// upon eviction. Nodes in the stopped-deallocated state count against your compute quota and can cause
	// issues with cluster scaling or upgrading.
