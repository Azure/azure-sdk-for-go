...
const (
	// Azure Use the Azure CNI network plugin. See [Azure CNI (advanced)
	...
	// Kubenet Use the Kubenet network plugin. See [Kubenet (basic)
...
const (
	...
	NodePool SnapshotType = "NodePool"
)
