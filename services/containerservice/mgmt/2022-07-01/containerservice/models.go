...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/containerservice/mgmt/2022-07-01/containerservice"
...
type AzureKeyVaultKms struct {
	...
	// KeyVaultNetworkAccess - Network access of key vault. The possible values are `Public` and `Private`. `Public` means the key vault allows public access from all networks. `Private` means the key vault disables public access and enables private link. The default value is `Public`. Possible values include: 'Public', 'Private'
...
type ManagedClusterAgentPoolProfile struct {
	...
	// OsType - Possible values include: 'Linux', 'Windows'
	OsType OSType `json:"osType,omitempty"`
	// OsSKU - Possible values include: 'Ubuntu', 'CBLMariner', 'Windows2019', 'Windows2022'
	...
	// CurrentOrchestratorVersion - READ-ONLY; If orchestratorVersion is a fully specified version <major.minor.patch>, this field will be exactly equal to it. If orchestratorVersion is <major.minor>, this field will contain the full <major.minor.patch> version being used.
...
type ManagedClusterProperties struct {
	...
	KubernetesVersion *string `json:"kubernetesVersion,omitempty"`
	// CurrentKubernetesVersion - READ-ONLY; If kubernetesVersion was a fully specified version <major.minor.patch>, this field will be exactly equal to it. If kubernetesVersion was <major.minor>, this field will contain the full <major.minor.patch> version being used.
...
type SnapshotProperties struct {
	...
	CreationData *CreationData `json:"creationData,omitempty"`
	// SnapshotType - Possible values include: 'NodePool'
	...
	OsType OSType `json:"osType,omitempty"`
	// OsSku - READ-ONLY; Possible values include: 'Ubuntu', 'CBLMariner', 'Windows2019', 'Windows2022'
	OsSku OSSKU `json:"osSku,omitempty"`
