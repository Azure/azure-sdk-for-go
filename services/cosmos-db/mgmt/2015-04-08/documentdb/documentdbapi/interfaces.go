...
type DatabaseAccountsClientAPI interface {
	...
	DeleteSQLStoredProcedure(ctx context.Context, resourceGroupName string, accountName string, databaseName string, containerName string, storedProcedureName string) (result documentdb.DatabaseAccountsDeleteSQLStoredProcedureFuture, err error)
	...
	GetSQLStoredProcedure(ctx context.Context, resourceGroupName string, accountName string, databaseName string, containerName string, storedProcedureName string) (result documentdb.SQLStoredProcedure, err error)
