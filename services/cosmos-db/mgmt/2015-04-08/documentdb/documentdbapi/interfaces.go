...
type DatabaseAccountsClientAPI interface {
	...
	GetSQLContainer(ctx context.Context, resourceGroupName string, accountName string, databaseRid string, containerRid string) (result documentdb.SQLContainerResource, err error)
	GetSQLDatabase(ctx context.Context, resourceGroupName string, accountName string, databaseRid string) (result documentdb.SQLDatabaseResource, err error)
