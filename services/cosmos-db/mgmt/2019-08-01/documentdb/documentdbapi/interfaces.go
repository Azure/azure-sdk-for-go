...
type DatabaseAccountsClientAPI interface {
	...
	Create(ctx context.Context, resourceGroupName string, accountName string, createParameters documentdb.DatabaseAccountCreateParameters) (result documentdb.DatabaseAccountsCreateFuture, err error)
