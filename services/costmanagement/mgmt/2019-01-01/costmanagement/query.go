...
func (client QueryClient) UsageByBillingAccount(ctx context.Context, billingAccountID string, parameters QueryDefinition) (result QueryResult, err error) {
...
func (client QueryClient) UsageByBillingAccountPreparer(ctx context.Context, billingAccountID string, parameters QueryDefinition) (*http.Request, error) {
...
// parameters - parameters supplied to the CreateOrUpdate Query Config operation.
func (client QueryClient) UsageByDepartment(ctx context.Context, billingAccountID string, departmentID string, parameters QueryDefinition) (result QueryResult, err error) {
	if tracing.IsEnabled() {
...
func (client QueryClient) UsageByDepartmentPreparer(ctx context.Context, billingAccountID string, departmentID string, parameters QueryDefinition) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"billingAccountId": autorest.Encode("path", billingAccountID),
...
// parameters - parameters supplied to the CreateOrUpdate Query Config operation.
func (client QueryClient) UsageByEnrollmentAccount(ctx context.Context, billingAccountID string, enrollmentAccountID string, parameters QueryDefinition) (result QueryResult, err error) {
	if tracing.IsEnabled() {
...
func (client QueryClient) UsageByEnrollmentAccountPreparer(ctx context.Context, billingAccountID string, enrollmentAccountID string, parameters QueryDefinition) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"billingAccountId":    autorest.Encode("path", billingAccountID),
...
// parameters - parameters supplied to the CreateOrUpdate Query Config operation.
func (client QueryClient) UsageByManagementGroup(ctx context.Context, managementGroupID string, parameters QueryDefinition) (result QueryResult, err error) {
	if tracing.IsEnabled() {
...
func (client QueryClient) UsageByManagementGroupPreparer(ctx context.Context, managementGroupID string, parameters QueryDefinition) (*http.Request, error) {
	pathParameters := map[string]interface{}{
...
// parameters - parameters supplied to the CreateOrUpdate Query Config operation.
func (client QueryClient) UsageByResourceGroup(ctx context.Context, resourceGroupName string, parameters QueryDefinition) (result QueryResult, err error) {
	if tracing.IsEnabled() {
...
func (client QueryClient) UsageByResourceGroupPreparer(ctx context.Context, resourceGroupName string, parameters QueryDefinition) (*http.Request, error) {
	pathParameters := map[string]interface{}{
...
// Parameters:
// parameters - parameters supplied to the CreateOrUpdate Query Config operation.
func (client QueryClient) UsageBySubscription(ctx context.Context, parameters QueryDefinition) (result QueryResult, err error) {
	if tracing.IsEnabled() {
...
func (client QueryClient) UsageBySubscriptionPreparer(ctx context.Context, parameters QueryDefinition) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"subscriptionId": autorest.Encode("path", client.SubscriptionID),
	}
