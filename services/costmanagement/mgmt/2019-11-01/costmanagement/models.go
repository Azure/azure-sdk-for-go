...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/costmanagement/mgmt/2019-11-01/costmanagement"
...
func (rcd ReportConfigDefinition) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if rcd.Type != nil {
		objectMap["type"] = rcd.Type
	}
	if rcd.Timeframe != "" {
		objectMap["timeframe"] = rcd.Timeframe
	}
	if rcd.TimePeriod != nil {
		objectMap["timePeriod"] = rcd.TimePeriod
	}
	if rcd.DataSet != nil {
		objectMap["dataSet"] = rcd.DataSet
	}
	return json.Marshal(objectMap)
}
...
func (s Setting) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if s.SettingsProperties != nil {
		objectMap["properties"] = s.SettingsProperties
	}
	return json.Marshal(objectMap)
}
...
func (iter *SettingsListResultIterator) NextWithContext(ctx context.Context) (err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/SettingsListResultIterator.NextWithContext")
		defer func() {
			sc := -1
			if iter.Response().Response.Response != nil {
				sc = iter.Response().Response.Response.StatusCode
...
// Response returns the raw server response from the last page request.
func (iter SettingsListResultIterator) Response() SettingsListResult {
	return iter.page.Response()
}
...
func NewSettingsListResultIterator(page SettingsListResultPage) SettingsListResultIterator {
	return SettingsListResultIterator{page: page}
}
...
// hasNextLink returns true if the NextLink is not empty.
func (slr SettingsListResult) hasNextLink() bool {
	return slr.NextLink != nil && len(*slr.NextLink) != 0
}

// settingsListResultPreparer prepares a request to retrieve the next set of results.
// It returns nil if no more results exist.
func (slr SettingsListResult) settingsListResultPreparer(ctx context.Context) (*http.Request, error) {
	if !slr.hasNextLink() {
		return nil, nil
	}
	return autorest.Prepare((&http.Request{}).WithContext(ctx),
...
type SettingsListResultPage struct {
	fn  func(context.Context, SettingsListResult) (SettingsListResult, error)
	slr SettingsListResult
}
...
func (page *SettingsListResultPage) NextWithContext(ctx context.Context) (err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/SettingsListResultPage.NextWithContext")
		defer func() {
			sc := -1
			if page.Response().Response.Response != nil {
				sc = page.Response().Response.Response.StatusCode
...
// Response returns the raw server response from the last page request.
func (page SettingsListResultPage) Response() SettingsListResult {
	return page.slr
}
