...
// GenerateDetailedCostReportMetricType enumerates the values for generate detailed cost report metric type.
type GenerateDetailedCostReportMetricType string

const (
	// ActualCost ...
	ActualCost GenerateDetailedCostReportMetricType = "ActualCost"
	// AmortizedCost ...
	AmortizedCost GenerateDetailedCostReportMetricType = "AmortizedCost"
)

// PossibleGenerateDetailedCostReportMetricTypeValues returns an array of possible values for the GenerateDetailedCostReportMetricType const type.
func PossibleGenerateDetailedCostReportMetricTypeValues() []GenerateDetailedCostReportMetricType {
	return []GenerateDetailedCostReportMetricType{ActualCost, AmortizedCost}
}
...
func PossibleOperationStatusTypeValues() []OperationStatusType {
	return []OperationStatusType{OperationStatusTypeCompleted, OperationStatusTypeFailed, OperationStatusTypeInProgress, OperationStatusTypeNoDataFound, OperationStatusTypeQueued, OperationStatusTypeReadyToDownload, OperationStatusTypeTimedOut}
}
