...
// CountryCode enumerates the values for country code.
...
// PossibleCountryCodeValues returns an array of possible values for the CountryCode const type.
func PossibleCountryCodeValues() []CountryCode {
	return []CountryCode{AT, BE, BG, CY, CZ, DE, DK, EE, ES, FI, FR, GB, GR, HR, HU, IE, IT, LT, LU, LV, MT, NL, PL, PT, RO, SE, SI, SK, US}
}
...
// ServiceRegion enumerates the values for service region.
type ServiceRegion string

const (
	// Centraluseuap ...
	Centraluseuap ServiceRegion = "centraluseuap"
	// Eastus2euap ...
	Eastus2euap ServiceRegion = "eastus2euap"
	// Westeurope ...
	Westeurope ServiceRegion = "westeurope"
	// Westus ...
	Westus ServiceRegion = "westus"
)

// PossibleServiceRegionValues returns an array of possible values for the ServiceRegion const type.
func PossibleServiceRegionValues() []ServiceRegion {
	return []ServiceRegion{Centraluseuap, Eastus2euap, Westeurope, Westus}
}
...
// StorageRegion enumerates the values for storage region.
type StorageRegion string

const (
	// StorageRegionCentralus ...
	StorageRegionCentralus StorageRegion = "centralus"
	// StorageRegionEastus ...
	StorageRegionEastus StorageRegion = "eastus"
	// StorageRegionEastus2 ...
	StorageRegionEastus2 StorageRegion = "eastus2"
	// StorageRegionGermanycentral ...
	StorageRegionGermanycentral StorageRegion = "germanycentral"
	// StorageRegionGermanynortheast ...
	StorageRegionGermanynortheast StorageRegion = "germanynortheast"
	// StorageRegionNorthcentralus ...
	StorageRegionNorthcentralus StorageRegion = "northcentralus"
	// StorageRegionNortheurope ...
	StorageRegionNortheurope StorageRegion = "northeurope"
	// StorageRegionSouthcentralus ...
	StorageRegionSouthcentralus StorageRegion = "southcentralus"
	// StorageRegionUksouth ...
	StorageRegionUksouth StorageRegion = "uksouth"
	// StorageRegionUkwest ...
	StorageRegionUkwest StorageRegion = "ukwest"
	// StorageRegionWestcentralus ...
	StorageRegionWestcentralus StorageRegion = "westcentralus"
	// StorageRegionWesteurope ...
	StorageRegionWesteurope StorageRegion = "westeurope"
	// StorageRegionWestus ...
	StorageRegionWestus StorageRegion = "westus"
	// StorageRegionWestus2 ...
	StorageRegionWestus2 StorageRegion = "westus2"
)

// PossibleStorageRegionValues returns an array of possible values for the StorageRegion const type.
func PossibleStorageRegionValues() []StorageRegion {
	return []StorageRegion{StorageRegionCentralus, StorageRegionEastus, StorageRegionEastus2, StorageRegionGermanycentral, StorageRegionGermanynortheast, StorageRegionNorthcentralus, StorageRegionNortheurope, StorageRegionSouthcentralus, StorageRegionUksouth, StorageRegionUkwest, StorageRegionWestcentralus, StorageRegionWesteurope, StorageRegionWestus, StorageRegionWestus2}
}
...
// RegionAvailabilityInput inputs to get list of supported storage regions and service regions for job creation.
type RegionAvailabilityInput struct {
	// CountryCode - Country for which the supported regions are requested. Possible values include: 'US', 'NL', 'IE', 'AT', 'IT', 'BE', 'LV', 'BG', 'LT', 'HR', 'LU', 'CY', 'MT', 'CZ', 'DK', 'PL', 'EE', 'PT', 'FI', 'RO', 'FR', 'SK', 'DE', 'SI', 'GR', 'ES', 'HU', 'SE', 'GB'
	CountryCode CountryCode `json:"countryCode,omitempty"`
	// DeviceType - Device type for which the supported regions have to be fetched. Possible values include: 'Pod', 'Disk', 'Cabinet'
	DeviceType DeviceType `json:"deviceType,omitempty"`
}

// RegionAvailabilityResponse list of service regions and storage regions
type RegionAvailabilityResponse struct {
	autorest.Response `json:"-"`
	// SupportedRegions - List of supported region.
	SupportedRegions *[]SupportedRegions `json:"supportedRegions,omitempty"`
}
...
// SupportedRegions storage region and service region mapping
type SupportedRegions struct {
	// StorageRegion - Storage Region. Possible values include: 'StorageRegionWestus', 'StorageRegionCentralus', 'StorageRegionEastus', 'StorageRegionNorthcentralus', 'StorageRegionSouthcentralus', 'StorageRegionEastus2', 'StorageRegionWestus2', 'StorageRegionWestcentralus', 'StorageRegionWesteurope', 'StorageRegionNortheurope', 'StorageRegionUkwest', 'StorageRegionUksouth', 'StorageRegionGermanycentral', 'StorageRegionGermanynortheast'
	StorageRegion StorageRegion `json:"storageRegion,omitempty"`
	// ServiceRegion - Service Region. Possible values include: 'Westus', 'Westeurope', 'Eastus2euap', 'Centraluseuap'
	ServiceRegion ServiceRegion `json:"serviceRegion,omitempty"`
}
