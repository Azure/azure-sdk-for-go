...
type ServiceClientAPI interface {
	...
	ListAvailableSkusComplete(ctx context.Context, location string, availableSkuRequest AvailableSkuRequest) (result databox.AvailableSkusResultIterator, err error)
	...
	ListAvailableSkusByResourceGroupComplete(ctx context.Context, resourceGroupName string, location string, availableSkuRequest AvailableSkuRequest) (result databox.AvailableSkusResultIterator, err error)
