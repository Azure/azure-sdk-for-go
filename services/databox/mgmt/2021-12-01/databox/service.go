...
func (client ServiceClient) RegionConfiguration(ctx context.Context, location string, regionConfigurationRequest RegionConfigurationRequest) (result RegionConfigurationResponse, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		{TargetValue: regionConfigurationRequest,
			Constraints: []validation.Constraint{{Target: "regionConfigurationRequest.DatacenterAddressRequest", Name: validation.Null, Rule: false,
				Chain: []validation.Constraint{{Target: "regionConfigurationRequest.DatacenterAddressRequest.StorageLocation", Name: validation.Null, Rule: true, Chain: nil}}}}}}); err != nil {
