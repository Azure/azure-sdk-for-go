...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/databox/mgmt/2022-02-01/databox"
...
type CustomerDiskJobDetails struct {
	...
	// DeviceErasureDetails - READ-ONLY; Holds device data erasure details
	DeviceErasureDetails *DeviceErasureDetails `json:"deviceErasureDetails,omitempty"`
...
func (cdjd *CustomerDiskJobDetails) UnmarshalJSON(body []byte) error {
	...
	for k, v := range m {
		...
		case "deviceErasureDetails":
			if v != nil {
				var deviceErasureDetails DeviceErasureDetails
				err = json.Unmarshal(*v, &deviceErasureDetails)
				if err != nil {
					return err
				}
				cdjd.DeviceErasureDetails = &deviceErasureDetails
			}
...
// DeviceErasureDetails device erasure details with erasure completion status and erasureordestructionlog
// sas key
type DeviceErasureDetails struct {
	// DeviceErasureStatus - READ-ONLY; Holds the device erasure completion status. Possible values include: 'StageStatusNone', 'StageStatusInProgress', 'StageStatusSucceeded', 'StageStatusFailed', 'StageStatusCancelled', 'StageStatusCancelling', 'StageStatusSucceededWithErrors', 'StageStatusWaitingForCustomerAction', 'StageStatusSucceededWithWarnings', 'StageStatusWaitingForCustomerActionForKek', 'StageStatusWaitingForCustomerActionForCleanUp', 'StageStatusCustomerActionPerformedForCleanUp', 'StageStatusCustomerActionPerformed'
	DeviceErasureStatus StageStatus `json:"deviceErasureStatus,omitempty"`
	// ErasureOrDestructionCertificateSasKey - READ-ONLY; Shared access key to download cleanup or destruction certificate for device
	ErasureOrDestructionCertificateSasKey *string `json:"erasureOrDestructionCertificateSasKey,omitempty"`
}

// MarshalJSON is the custom marshaler for DeviceErasureDetails.
func (ded DeviceErasureDetails) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	return json.Marshal(objectMap)
}
	...
	for k, v := range m {
		...
		case "deviceErasureDetails":
			if v != nil {
				...
				djd.DeviceErasureDetails = &deviceErasureDetails
			}
		case "keyEncryptionKey":
			if v != nil {
				var keyEncryptionKey KeyEncryptionKey
	...
	for k, v := range m {
		...
		case "deviceErasureDetails":
			if v != nil {
				...
				hjd.DeviceErasureDetails = &deviceErasureDetails
			}
		case "keyEncryptionKey":
			if v != nil {
				var keyEncryptionKey KeyEncryptionKey
	...
	for k, v := range m {
		...
		case "deviceErasureDetails":
			if v != nil {
				...
				jd.DeviceErasureDetails = &deviceErasureDetails
			}
		case "keyEncryptionKey":
			if v != nil {
				var keyEncryptionKey KeyEncryptionKey
	...
	for k, v := range m {
		...
		case "deviceErasureDetails":
			if v != nil {
				...
				jdt.DeviceErasureDetails = &deviceErasureDetails
			}
		case "keyEncryptionKey":
			if v != nil {
				var keyEncryptionKey KeyEncryptionKey
