...
type LocationsClientAPI interface {
	ListAvailableSkus(ctx context.Context, filter string) (result databoxedge.SkuInformationList, err error)
}

var _ LocationsClientAPI = (*databoxedge.LocationsClient)(nil)
