...
func (client SkusClient) List(ctx context.Context, filter string) (result SkuInformationList, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "databoxedge.SkusClient", "List", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "databoxedge.SkusClient", "List", resp, "Failure sending request")
		return
	}
