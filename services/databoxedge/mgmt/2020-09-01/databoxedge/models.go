...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/databoxedge/mgmt/2020-09-01/databoxedge"
...
type Device struct {
	...
	// Kind - The etag for the devices. Possible values include: 'AzureDataBoxGateway', 'AzureStackEdge', 'AzureStackHub', 'AzureModularDataCentre'
...
func (dp DeviceProperties) MarshalJSON() ([]byte, error) {
	...
	if dp.ResourceMoveDetails != nil {
		objectMap["resourceMoveDetails"] = dp.ResourceMoveDetails
	}
	if dp.EdgeProfile != nil {
		objectMap["edgeProfile"] = dp.EdgeProfile
	}
	return json.Marshal(objectMap)
}
