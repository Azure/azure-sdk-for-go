...
import (
	"context"
	"github.com/Azure/azure-sdk-for-go/services/databoxedge/mgmt/2021-02-01/databoxedge"
)
...
type DevicesClientAPI interface {
	CreateOrUpdate(ctx context.Context, deviceName string, dataBoxEdgeDevice databoxedge.Device, resourceGroupName string) (result databoxedge.Device, err error)
...
type DiagnosticSettingsClientAPI interface {
	GetDiagnosticProactiveLogCollectionSettings(ctx context.Context, deviceName string, resourceGroupName string) (result databoxedge.DiagnosticProactiveLogCollectionSettings, err error)
	GetDiagnosticRemoteSupportSettings(ctx context.Context, deviceName string, resourceGroupName string) (result databoxedge.DiagnosticRemoteSupportSettings, err error)
	UpdateDiagnosticProactiveLogCollectionSettings(ctx context.Context, deviceName string, proactiveLogCollectionSettings databoxedge.DiagnosticProactiveLogCollectionSettings, resourceGroupName string) (result databoxedge.DiagnosticSettingsUpdateDiagnosticProactiveLogCollectionSettingsFuture, err error)
	UpdateDiagnosticRemoteSupportSettings(ctx context.Context, deviceName string, diagnosticRemoteSupportSettings databoxedge.DiagnosticRemoteSupportSettings, resourceGroupName string) (result databoxedge.DiagnosticSettingsUpdateDiagnosticRemoteSupportSettingsFuture, err error)
}

var _ DiagnosticSettingsClientAPI = (*databoxedge.DiagnosticSettingsClient)(nil)
...
var _ AddonsClientAPI = (*databoxedge.AddonsClient)(nil)
...
var _ MonitoringConfigClientAPI = (*databoxedge.MonitoringConfigClient)(nil)
...
// SupportPackagesClientAPI contains the set of methods on the SupportPackagesClient type.
type SupportPackagesClientAPI interface {
	TriggerSupportPackage(ctx context.Context, deviceName string, triggerSupportPackageRequest databoxedge.TriggerSupportPackageRequest, resourceGroupName string) (result databoxedge.SupportPackagesTriggerSupportPackageFuture, err error)
}

var _ SupportPackagesClientAPI = (*databoxedge.SupportPackagesClient)(nil)
