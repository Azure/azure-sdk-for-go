...
func (client DevicesClient) CreateOrUpdate(ctx context.Context, deviceName string, dataBoxEdgeDevice Device, resourceGroupName string) (result Device, err error) {
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "databoxedge.DevicesClient", "CreateOrUpdate", resp, "Failure sending request")
		return
	}

	result, err = client.CreateOrUpdateResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "databoxedge.DevicesClient", "CreateOrUpdate", resp, "Failure responding to request")
		return
	}
...
func (client DevicesClient) CreateOrUpdateSender(req *http.Request) (*http.Response, error) {
