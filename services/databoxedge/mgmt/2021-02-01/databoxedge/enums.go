...
func PossibleAccessLevelValues() []AccessLevel {
	return []AccessLevel{FullAccess, None, ReadOnly, ReadWrite}
}
...
func PossibleClientPermissionTypeValues() []ClientPermissionType {
	return []ClientPermissionType{ClientPermissionTypeNoAccess, ClientPermissionTypeReadOnly, ClientPermissionTypeReadWrite}
}
...
// DataResidencyType enumerates the values for data residency type.
type DataResidencyType string

const (
	// GeoZoneReplication ...
	GeoZoneReplication DataResidencyType = "GeoZoneReplication"
	// ZoneReplication ...
	ZoneReplication DataResidencyType = "ZoneReplication"
)

// PossibleDataResidencyTypeValues returns an array of possible values for the DataResidencyType const type.
func PossibleDataResidencyTypeValues() []DataResidencyType {
	return []DataResidencyType{GeoZoneReplication, ZoneReplication}
}
...
// InstallationImpact enumerates the values for installation impact.
...
// PossibleInstallationImpactValues returns an array of possible values for the InstallationImpact const type.
func PossibleInstallationImpactValues() []InstallationImpact {
	return []InstallationImpact{InstallationImpactDeviceRebooted, InstallationImpactKubernetesWorkloadsDown, InstallationImpactNone}
}
...
const (
	...
	// KeyVaultNotSynced ...
	KeyVaultNotSynced KeyVaultSyncStatus = "KeyVaultNotSynced"
	// KeyVaultSynced ...
...
func PossibleKeyVaultSyncStatusValues() []KeyVaultSyncStatus {
	return []KeyVaultSyncStatus{KeyVaultNotConfigured, KeyVaultNotSynced, KeyVaultSynced, KeyVaultSyncFailed, KeyVaultSyncing, KeyVaultSyncPending}
}
...
const (
	...
	// AwaitingFulfillment ...
	AwaitingFulfillment OrderState = "AwaitingFulfillment"
	// AwaitingPickup ...
...
func PossibleOrderStateValues() []OrderState {
	return []OrderState{Arriving, AwaitingDrop, AwaitingFulfillment, AwaitingPickup, AwaitingPreparation, AwaitingReturnShipment, AwaitingShipment, CollectedAtMicrosoft, Declined, Delivered, LostDevice, PickupCompleted, ReplacementRequested, ReturnInitiated, Shipped, ShippedBack, Untracked}
}
...
// ProactiveDiagnosticsConsent enumerates the values for proactive diagnostics consent.
...
// PossibleProactiveDiagnosticsConsentValues returns an array of possible values for the ProactiveDiagnosticsConsent const type.
func PossibleProactiveDiagnosticsConsentValues() []ProactiveDiagnosticsConsent {
	return []ProactiveDiagnosticsConsent{ProactiveDiagnosticsConsentDisabled, ProactiveDiagnosticsConsentEnabled}
}
...
const (
	// AllApplications ...
	AllApplications RemoteApplicationType = "AllApplications"
	// LocalUI ...
	LocalUI RemoteApplicationType = "LocalUI"
	// Powershell ...
	Powershell RemoteApplicationType = "Powershell"
	// WAC ...
	WAC RemoteApplicationType = "WAC"
)
...
func PossibleRemoteApplicationTypeValues() []RemoteApplicationType {
	return []RemoteApplicationType{AllApplications, LocalUI, Powershell, WAC}
}
...
const (
	...
	// EP21281T4Mx1W ...
	EP21281T4Mx1W SkuName = "EP2_128_1T4_Mx1_W"
	// EP22562T4W ...
	EP22562T4W SkuName = "EP2_256_2T4_W"
	// EP2641VPUW ...
	EP2641VPUW SkuName = "EP2_64_1VPU_W"
	// Gateway ...
	Gateway SkuName = "Gateway"
	// GPU ...
	GPU SkuName = "GPU"
	// Management ...
	Management SkuName = "Management"
	// RCALarge ...
...
func PossibleSkuNameValues() []SkuName {
	return []SkuName{Edge, EdgeMRMini, EdgePBase, EdgePHigh, EdgePRBase, EdgePRBaseUPS, EP21281T4Mx1W, EP22562T4W, EP2641VPUW, Gateway, GPU, Management, RCALarge, RCASmall, RDC, TCALarge, TCASmall, TDC, TEA1Node, TEA1NodeHeater, TEA1NodeUPS, TEA1NodeUPSHeater, TEA4NodeHeater, TEA4NodeUPSHeater, TMA}
}
...
const (
	// DownloadCompleted ...
	DownloadCompleted UpdateStatus = "DownloadCompleted"
	// DownloadPending ...
	DownloadPending UpdateStatus = "DownloadPending"
	// DownloadStarted ...
	DownloadStarted UpdateStatus = "DownloadStarted"
	// InstallCompleted ...
	InstallCompleted UpdateStatus = "InstallCompleted"
	// InstallStarted ...
	InstallStarted UpdateStatus = "InstallStarted"
)
...
func PossibleUpdateStatusValues() []UpdateStatus {
	return []UpdateStatus{DownloadCompleted, DownloadPending, DownloadStarted, InstallCompleted, InstallStarted}
}

// UpdateType enumerates the values for update type.
...
// PossibleUpdateTypeValues returns an array of possible values for the UpdateType const type.
func PossibleUpdateTypeValues() []UpdateType {
	return []UpdateType{UpdateTypeFirmware, UpdateTypeKubernetes, UpdateTypeSoftware}
}
