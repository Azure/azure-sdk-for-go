...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/databoxedge/mgmt/2021-02-01/databoxedge"
...
type ClientAccessRight struct {
	...
	// AccessPermission - Type of access to be allowed for the client. Possible values include: 'ClientPermissionTypeNoAccess', 'ClientPermissionTypeReadOnly', 'ClientPermissionTypeReadWrite'
	AccessPermission ClientPermissionType `json:"accessPermission,omitempty"`
}

// CloudEdgeManagementRole the preview of Virtual Machine Cloud Management from the Azure supports
// deploying and managing VMs on your Azure Stack Edge device from Azure Portal.
...
// DataResidency wraps data-residency related information for edge-resource and this should be used with
// ARM layer.
type DataResidency struct {
	// Type - DataResidencyType enum. Possible values include: 'GeoZoneReplication', 'ZoneReplication'
...
type Device struct {
	...
	// Kind - The kind of the device. Possible values include: 'AzureDataBoxGateway', 'AzureStackEdge', 'AzureStackHub', 'AzureModularDataCentre'
...
type DeviceProperties struct {
	// SystemData - DataBoxEdge Device Properties
	SystemData *SystemData `json:"systemData,omitempty"`
...
func (dp DeviceProperties) MarshalJSON() ([]byte, error) {
	...
	if dp.DataResidency != nil {
		objectMap["dataResidency"] = dp.DataResidency
	}
	return json.Marshal(objectMap)
}
...
type DiagnosticProactiveLogCollectionSettings struct {
	autorest.Response `json:"-"`
	// SystemData - DiagnosticProactiveLogCollectionSettings
	SystemData *SystemData `json:"systemData,omitempty"`
	// ProactiveLogCollectionSettingsProperties - Properties of the diagnostic proactive log collection settings.
	*ProactiveLogCollectionSettingsProperties `json:"properties,omitempty"`
	// ID - READ-ONLY; The path ID that uniquely identifies the object.
	ID *string `json:"id,omitempty"`
	// Name - READ-ONLY; The object name.
	Name *string `json:"name,omitempty"`
...
// MarshalJSON is the custom marshaler for DiagnosticProactiveLogCollectionSettings.
func (dplcs DiagnosticProactiveLogCollectionSettings) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if dplcs.SystemData != nil {
		objectMap["systemData"] = dplcs.SystemData
	}
	if dplcs.ProactiveLogCollectionSettingsProperties != nil {
		objectMap["properties"] = dplcs.ProactiveLogCollectionSettingsProperties
	}
	return json.Marshal(objectMap)
}

// UnmarshalJSON is the custom unmarshaler for DiagnosticProactiveLogCollectionSettings struct.
func (dplcs *DiagnosticProactiveLogCollectionSettings) UnmarshalJSON(body []byte) error {
	var m map[string]*json.RawMessage
	err := json.Unmarshal(body, &m)
	if err != nil {
		return err
	...
	for k, v := range m {
		...
		case "systemData":
			if v != nil {
				...
				dplcs.SystemData = &systemData
			}
		case "properties":
			if v != nil {
				var proactiveLogCollectionSettingsProperties ProactiveLogCollectionSettingsProperties
				err = json.Unmarshal(*v, &proactiveLogCollectionSettingsProperties)
				if err != nil {
					return err
				}
				dplcs.ProactiveLogCollectionSettingsProperties = &proactiveLogCollectionSettingsProperties
			}
		case "id":
			if v != nil {
				var ID string
...
type DiagnosticRemoteSupportSettings struct {
	autorest.Response `json:"-"`
	// SystemData - DiagnosticRemoteSupportSettings
	SystemData *SystemData `json:"systemData,omitempty"`
	// DiagnosticRemoteSupportSettingsProperties - Properties of the remote support  settings.
	*DiagnosticRemoteSupportSettingsProperties `json:"properties,omitempty"`
	// ID - READ-ONLY; The path ID that uniquely identifies the object.
	ID *string `json:"id,omitempty"`
	// Name - READ-ONLY; The object name.
	Name *string `json:"name,omitempty"`
...
// MarshalJSON is the custom marshaler for DiagnosticRemoteSupportSettings.
func (drss DiagnosticRemoteSupportSettings) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if drss.SystemData != nil {
		objectMap["systemData"] = drss.SystemData
	}
	if drss.DiagnosticRemoteSupportSettingsProperties != nil {
		objectMap["properties"] = drss.DiagnosticRemoteSupportSettingsProperties
	}
	return json.Marshal(objectMap)
}

// UnmarshalJSON is the custom unmarshaler for DiagnosticRemoteSupportSettings struct.
func (drss *DiagnosticRemoteSupportSettings) UnmarshalJSON(body []byte) error {
	var m map[string]*json.RawMessage
	err := json.Unmarshal(body, &m)
	if err != nil {
		return err
	...
	for k, v := range m {
		...
		case "systemData":
			if v != nil {
				...
				drss.SystemData = &systemData
			}
		case "properties":
			if v != nil {
				var diagnosticRemoteSupportSettingsProperties DiagnosticRemoteSupportSettingsProperties
				err = json.Unmarshal(*v, &diagnosticRemoteSupportSettingsProperties)
				if err != nil {
					return err
				}
				drss.DiagnosticRemoteSupportSettingsProperties = &diagnosticRemoteSupportSettingsProperties
			}
		case "id":
			if v != nil {
				var ID string
...
type DiagnosticRemoteSupportSettingsProperties struct {
	// RemoteSupportSettingsList - Remote support settings list according to the RemoteApplicationType
	RemoteSupportSettingsList *[]RemoteSupportSettings `json:"remoteSupportSettingsList,omitempty"`
}

// DiagnosticSettingsUpdateDiagnosticProactiveLogCollectionSettingsFuture an abstraction for monitoring and
// retrieving the results of a long-running operation.
type DiagnosticSettingsUpdateDiagnosticProactiveLogCollectionSettingsFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(DiagnosticSettingsClient) (autorest.Response, error)
}

// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *DiagnosticSettingsUpdateDiagnosticProactiveLogCollectionSettingsFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for DiagnosticSettingsUpdateDiagnosticProactiveLogCollectionSettingsFuture.Result.
func (future *DiagnosticSettingsUpdateDiagnosticProactiveLogCollectionSettingsFuture) result(client DiagnosticSettingsClient) (ar autorest.Response, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "databoxedge.DiagnosticSettingsUpdateDiagnosticProactiveLogCollectionSettingsFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		ar.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("databoxedge.DiagnosticSettingsUpdateDiagnosticProactiveLogCollectionSettingsFuture")
		return
	}
	ar.Response = future.Response()
	return
...
// DiagnosticSettingsUpdateDiagnosticRemoteSupportSettingsFuture an abstraction for monitoring and
// retrieving the results of a long-running operation.
type DiagnosticSettingsUpdateDiagnosticRemoteSupportSettingsFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(DiagnosticSettingsClient) (autorest.Response, error)
...
// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *DiagnosticSettingsUpdateDiagnosticRemoteSupportSettingsFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for DiagnosticSettingsUpdateDiagnosticRemoteSupportSettingsFuture.Result.
func (future *DiagnosticSettingsUpdateDiagnosticRemoteSupportSettingsFuture) result(client DiagnosticSettingsClient) (ar autorest.Response, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "databoxedge.DiagnosticSettingsUpdateDiagnosticRemoteSupportSettingsFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		ar.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("databoxedge.DiagnosticSettingsUpdateDiagnosticRemoteSupportSettingsFuture")
		return
	}
	ar.Response = future.Response()
	return
...
// 1. Using a simple turn-key option in Azure Portal, deploy a Kubernetes cluster on your Azure Stack Edge
// device.
// 2. Configure Kubernetes cluster running on your device with Arc enabled Kubernetes with a click of a
// button in the Azure Portal.
// Azure Arc enables organizations to view, manage, and govern their on-premises Kubernetes clusters using
// the Azure Portal, command line tools, and APIs.
...
type ProactiveLogCollectionSettingsProperties struct {
	// UserConsent - Proactive diagnostic collection consent flag. Possible values include: 'ProactiveDiagnosticsConsentEnabled', 'ProactiveDiagnosticsConsentDisabled'
...
type RemoteSupportSettings struct {
	// RemoteApplicationType - Remote application type. Possible values include: 'Powershell', 'WAC', 'LocalUI', 'AllApplications'
	RemoteApplicationType RemoteApplicationType `json:"remoteApplicationType,omitempty"`
	// AccessLevel - Access level allowed for this remote application type. Possible values include: 'None', 'ReadOnly', 'ReadWrite', 'FullAccess'
	AccessLevel AccessLevel `json:"accessLevel,omitempty"`
	// ExpirationTimeStampInUTC - Expiration time stamp
	ExpirationTimeStampInUTC *date.Time `json:"expirationTimeStampInUTC,omitempty"`
}
...
type SupportPackageRequestProperties struct {
	// MinimumTimeStamp - MinimumTimeStamp from where logs need to be collected
	MinimumTimeStamp *date.Time `json:"minimumTimeStamp,omitempty"`
	// MaximumTimeStamp - MaximumTimeStamp until where logs need to be collected
	MaximumTimeStamp *date.Time `json:"maximumTimeStamp,omitempty"`
	// Include - Type of files, which need to be included in the logs
...
// SupportPackagesTriggerSupportPackageFuture an abstraction for monitoring and retrieving the results of a
// long-running operation.
type SupportPackagesTriggerSupportPackageFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(SupportPackagesClient) (autorest.Response, error)
}

// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *SupportPackagesTriggerSupportPackageFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for SupportPackagesTriggerSupportPackageFuture.Result.
func (future *SupportPackagesTriggerSupportPackageFuture) result(client SupportPackagesClient) (ar autorest.Response, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "databoxedge.SupportPackagesTriggerSupportPackageFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		ar.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("databoxedge.SupportPackagesTriggerSupportPackageFuture")
		return
	}
	ar.Response = future.Response()
	return
...
type TriggerSupportPackageRequest struct {
	// SupportPackageRequestProperties - The TriggerSupportPackageRequest properties.
...
// MarshalJSON is the custom marshaler for TriggerSupportPackageRequest.
func (tspr TriggerSupportPackageRequest) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if tspr.SupportPackageRequestProperties != nil {
		objectMap["properties"] = tspr.SupportPackageRequestProperties
	}
	return json.Marshal(objectMap)
}

// UnmarshalJSON is the custom unmarshaler for TriggerSupportPackageRequest struct.
func (tspr *TriggerSupportPackageRequest) UnmarshalJSON(body []byte) error {
	var m map[string]*json.RawMessage
	err := json.Unmarshal(body, &m)
	if err != nil {
		return err
	...
	for k, v := range m {
		...
		case "properties":
			if v != nil {
				...
				tspr.SupportPackageRequestProperties = &supportPackageRequestProperties
			}
		case "id":
			if v != nil {
				var ID string
...
type UpdateDetails struct {
	...
	// FriendlyVersionNumber - Friendly Version Number
	...
	// InstallationImpact - Impact of Installing an updateType. Possible values include: 'InstallationImpactNone', 'InstallationImpactDeviceRebooted', 'InstallationImpactKubernetesWorkloadsDown'
...
type UpdateSummaryProperties struct {
	...
	// LastSuccessfulScanJobTime - Time when the last scan job is successfully completed.
	LastSuccessfulScanJobTime *date.Time `json:"lastSuccessfulScanJobTime,omitempty"`
	...
	// LastSuccessfulInstallJobDateTime - The time when the Last Install job was completed successfully on the appliance
	LastSuccessfulInstallJobDateTime *date.Time `json:"lastSuccessfulInstallJobDateTime,omitempty"`
...
func (usp UpdateSummaryProperties) MarshalJSON() ([]byte, error) {
	...
	if usp.LastSuccessfulScanJobTime != nil {
		objectMap["lastSuccessfulScanJobTime"] = usp.LastSuccessfulScanJobTime
	}
	if usp.LastSuccessfulInstallJobDateTime != nil {
		objectMap["lastSuccessfulInstallJobDateTime"] = usp.LastSuccessfulInstallJobDateTime
	}
	return json.Marshal(objectMap)
}
