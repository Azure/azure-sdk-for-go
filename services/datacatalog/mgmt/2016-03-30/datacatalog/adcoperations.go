...
// ADCOperationsClient is the the Azure Data Catalog management API provides a RESTful set of web services that
// interact with Azure Data Catalog services.
...
func (client ADCOperationsClient) List(ctx context.Context) (result OperationEntityListResult, err error) {
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "datacatalog.ADCOperationsClient", "List", resp, "Failure sending request")
		return
	}
...
func (client ADCOperationsClient) ListPreparer(ctx context.Context) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithPath("/providers/Microsoft.DataCatalog/operations"),
