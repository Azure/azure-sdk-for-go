...
type IntegrationRuntimesClientAPI interface {
	...
	EnableIntegrationRuntimeInteractiveQuery(ctx context.Context, resourceGroupName string, factoryName string, integrationRuntimeName string, enableInteractiveQueryForIntegrationRuntimeRequest datafactory.EnableInteractiveQueryForIntegrationRuntimeRequest) (result datafactory.IntegrationRuntimesEnableIntegrationRuntimeInteractiveQueryFuture, err error)
