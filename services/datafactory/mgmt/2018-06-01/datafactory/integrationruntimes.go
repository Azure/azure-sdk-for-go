...
// EnableIntegrationRuntimeInteractiveQuery enable interactive query for an Auzre-VNet integration runtime.
// Parameters:
// resourceGroupName - the resource group name.
// factoryName - the factory name.
// integrationRuntimeName - the integration runtime name.
...
func (client IntegrationRuntimesClient) EnableIntegrationRuntimeInteractiveQuery(ctx context.Context, resourceGroupName string, factoryName string, integrationRuntimeName string, enableInteractiveQueryForIntegrationRuntimeRequest EnableInteractiveQueryForIntegrationRuntimeRequest) (result autorest.Response, err error) {
	...
	resp, err := client.EnableIntegrationRuntimeInteractiveQuerySender(req)
	if err != nil {
		result.Response = resp
		err = autorest.NewErrorWithError(err, "datafactory.IntegrationRuntimesClient", "EnableIntegrationRuntimeInteractiveQuery", resp, "Failure sending request")
		return
	}

	result, err = client.EnableIntegrationRuntimeInteractiveQueryResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "datafactory.IntegrationRuntimesClient", "EnableIntegrationRuntimeInteractiveQuery", resp, "Failure responding to request")
	}
...
// http.Response Body if it receives an error.
func (client IntegrationRuntimesClient) EnableIntegrationRuntimeInteractiveQuerySender(req *http.Request) (*http.Response, error) {
	return autorest.SendWithSender(client, req,
		azure.DoRetryWithRegistration(client.Client))
}
