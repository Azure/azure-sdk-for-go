...
// build a job.
func (client Client) Build(ctx context.Context, accountName string, parameters Information) (*Information, error) {
		...
		{targetValue: parameters,
			constraints: []constraint{{target: "parameters.Name", name: null, rule: true, chain: nil},
				{target: "parameters.Properties", name: null, rule: true,
					chain: []constraint{{target: "parameters.Properties.Script", name: null, rule: true, chain: nil}}}}}}); err != nil {
		return nil, err
	}
...
func (client Client) buildPreparer(accountName string, parameters Information) (pipeline.Request, error) {
...
func (client Client) Create(ctx context.Context, accountName string, jobIdentity uuid.UUID, parameters Information) (*Information, error) {
	if err := validate([]validation{
		{targetValue: parameters,
			constraints: []constraint{{target: "parameters.Name", name: null, rule: true, chain: nil},
				{target: "parameters.Properties", name: null, rule: true,
...
func (client Client) createPreparer(accountName string, jobIdentity uuid.UUID, parameters Information) (pipeline.Request, error) {
...
func (client Client) List(ctx context.Context, accountName string, filter *string, top *int32, skip *int32, expand *string, selectParameter *string, orderby *string, count *bool, search *string, formatParameter *string) (*InfoListResult, error) {
...
func (client Client) listPreparer(accountName string, filter *string, top *int32, skip *int32, expand *string, selectParameter *string, orderby *string, count *bool, search *string, formatParameter *string) (pipeline.Request, error) {
	req, err := pipeline.NewRequest("GET", client.url, nil)
	if err != nil {
		return req, pipeline.NewError(err, "failed to create request")
	}
