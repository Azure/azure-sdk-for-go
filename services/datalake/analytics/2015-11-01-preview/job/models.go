...
func PossibleResourceTypeValues() [2]ResourceType {
	return [2]ResourceType{StatisticsResource, VertexResource}
}
...
func PossibleSeverityTypesValues() [2]SeverityTypes {
	return [2]SeverityTypes{Error, Warning}
}
