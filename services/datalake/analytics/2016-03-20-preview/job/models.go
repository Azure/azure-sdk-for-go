...
type Diagnostics struct {
	...
	// Severity - the severity of the error. Possible values include: 'Warning', 'Error', 'Info', 'None'
...
type ErrorDetails struct {
	...
	// Severity - the severity level of the failure. Possible values include: 'Warning', 'Error', 'Info', 'None'
	Severity SeverityTypesType `json:"severity,omitempty"`
...
type USQLJobProperties struct {
	...
	// CompileMode - the compile mode for the job. Possible values include: 'Semantic', 'Full', 'SingleBox', 'None'
