...
func (client AccountsClient) checkNameAvailabilityPreparer(location string, parameters CheckNameAvailabilityParameters) (pipeline.Request, error) {
	u := client.url
	u.Path = "/subscriptions/{subscriptionId}/providers/Microsoft.DataLakeStore/locations/{location}/checkNameAvailability"
	...
	if err := validate([]validation{
		{targetValue: parameters,
			constraints: []constraint{{target: "parameters.Location", name: null, rule: true, chain: nil},
				{target: "parameters.Identity", name: null, rule: false,
					chain: []constraint{{target: "parameters.Identity.Type", name: null, rule: true, chain: nil}}},
				{target: "parameters.CreateDataLakeStoreAccountProperties", name: null, rule: false,
					chain: []constraint{{target: "parameters.CreateDataLakeStoreAccountProperties.EncryptionConfig", name: null, rule: false,
						chain: []constraint{{target: "parameters.CreateDataLakeStoreAccountProperties.EncryptionConfig.KeyVaultMetaInfo", name: null, rule: false,
							chain: []constraint{{target: "parameters.CreateDataLakeStoreAccountProperties.EncryptionConfig.KeyVaultMetaInfo.KeyVaultResourceID", name: null, rule: true, chain: nil},
								{target: "parameters.CreateDataLakeStoreAccountProperties.EncryptionConfig.KeyVaultMetaInfo.EncryptionKeyName", name: null, rule: true, chain: nil},
								{target: "parameters.CreateDataLakeStoreAccountProperties.EncryptionConfig.KeyVaultMetaInfo.EncryptionKeyVersion", name: null, rule: true, chain: nil},
							}},
						}},
					}}}}}); err != nil {
		return nil, err
...
func (client AccountsClient) enableKeyVaultResponder(resp pipeline.Response) (pipeline.Response, error) {
	err := validateResponse(resp, http.StatusOK)
	if resp == nil {
		return nil, err
	}
...
func (client AccountsClient) List(ctx context.Context, filter *string, top *int32, skip *int32, selectParameter *string, orderby *string, count *bool) (*DataLakeStoreAccountListResult, error) {
	if err := validate([]validation{
		{targetValue: top,
