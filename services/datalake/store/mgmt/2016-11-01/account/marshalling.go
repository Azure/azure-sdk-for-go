...
// MarshalXML implements the xml.Marshaler interface for DataLakeStoreAccountPropertiesBasic.
func (dlsapb DataLakeStoreAccountPropertiesBasic) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	if reflect.TypeOf((*DataLakeStoreAccountPropertiesBasic)(nil)).Elem().Size() != reflect.TypeOf((*dataLakeStoreAccountPropertiesBasic)(nil)).Elem().Size() {
		panic("size mismatch between DataLakeStoreAccountPropertiesBasic and dataLakeStoreAccountPropertiesBasic")
	}
	dlsapb2 := (*dataLakeStoreAccountPropertiesBasic)(unsafe.Pointer(&dlsapb))
	return e.EncodeElement(*dlsapb2, start)
}

// UnmarshalXML implements the xml.Unmarshaler interface for DataLakeStoreAccountPropertiesBasic.
func (dlsapb *DataLakeStoreAccountPropertiesBasic) UnmarshalXML(d *xml.Decoder, start xml.StartElement) error {
	if reflect.TypeOf((*DataLakeStoreAccountPropertiesBasic)(nil)).Elem().Size() != reflect.TypeOf((*dataLakeStoreAccountPropertiesBasic)(nil)).Elem().Size() {
		panic("size mismatch between DataLakeStoreAccountPropertiesBasic and dataLakeStoreAccountPropertiesBasic")
	}
	dlsapb2 := (*dataLakeStoreAccountPropertiesBasic)(unsafe.Pointer(dlsapb))
	return d.DecodeElement(dlsapb2, &start)
}
