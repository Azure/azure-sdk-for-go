...
func (client BackupInstancesClient) AdhocBackupSender(req *http.Request) (future BackupInstancesAdhocBackupFuture, err error) {
	...
	future.Result = func(client BackupInstancesClient) (ojei OperationJobExtendedInfo, err error) {
		var done bool
		...
		ojei.Response.Response, err = future.GetResult(sender)
		if ojei.Response.Response == nil && err == nil {
			err = autorest.NewErrorWithError(err, "dataprotection.BackupInstancesAdhocBackupFuture", "Result", nil, "received nil response and error")
		}
		if err == nil && ojei.Response.Response.StatusCode != http.StatusNoContent {
	...
	if err := validation.Validate([]validation.Validation{
		{TargetValue: parameters,
			Constraints: []validation.Constraint{{Target: "parameters.BackupInstance", Name: validation.Null, Rule: false,
				Chain: []validation.Constraint{{Target: "parameters.BackupInstance.FriendlyName", Name: validation.Null, Rule: true, Chain: nil},
...
func (client BackupInstancesClient) CreateOrUpdateSender(req *http.Request) (future BackupInstancesCreateOrUpdateFuture, err error) {
	...
	future.Result = func(client BackupInstancesClient) (bir BackupInstanceResource, err error) {
		...
		if bir.Response.Response == nil && err == nil {
			err = autorest.NewErrorWithError(err, "dataprotection.BackupInstancesCreateOrUpdateFuture", "Result", nil, "received nil response and error")
		}
...
func (client BackupInstancesClient) TriggerRestoreSender(req *http.Request) (future BackupInstancesTriggerRestoreFuture, err error) {
	...
	future.Result = func(client BackupInstancesClient) (ojei OperationJobExtendedInfo, err error) {
		...
		ojei.Response.Response, err = future.GetResult(sender)
		if ojei.Response.Response == nil && err == nil {
			err = autorest.NewErrorWithError(err, "dataprotection.BackupInstancesTriggerRestoreFuture", "Result", nil, "received nil response and error")
		}
		if err == nil && ojei.Response.Response.StatusCode != http.StatusNoContent {
...
func (client BackupInstancesClient) ValidateForBackupSender(req *http.Request) (future BackupInstancesValidateForBackupFuture, err error) {
	...
	future.Result = func(client BackupInstancesClient) (ojei OperationJobExtendedInfo, err error) {
		...
		ojei.Response.Response, err = future.GetResult(sender)
		if ojei.Response.Response == nil && err == nil {
			err = autorest.NewErrorWithError(err, "dataprotection.BackupInstancesValidateForBackupFuture", "Result", nil, "received nil response and error")
		}
		if err == nil && ojei.Response.Response.StatusCode != http.StatusNoContent {
...
func (client BackupInstancesClient) ValidateRestoreSender(req *http.Request) (future BackupInstancesValidateRestoreFuture, err error) {
	...
	future.Result = func(client BackupInstancesClient) (ojei OperationJobExtendedInfo, err error) {
		...
		ojei.Response.Response, err = future.GetResult(sender)
		if ojei.Response.Response == nil && err == nil {
			err = autorest.NewErrorWithError(err, "dataprotection.BackupInstancesValidateRestoreFuture", "Result", nil, "received nil response and error")
		}
		if err == nil && ojei.Response.Response.StatusCode != http.StatusNoContent {
