...
func (client BackupVaultsClient) CreateOrUpdate(ctx context.Context, vaultName string, resourceGroupName string, parameters BackupVaultResource) (result BackupVaultsCreateOrUpdateFuture, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		{TargetValue: parameters,
			Constraints: []validation.Constraint{{Target: "parameters.BackupVault", Name: validation.Null, Rule: true,
				Chain: []validation.Constraint{{Target: "parameters.BackupVault.StorageSettings", Name: validation.Null, Rule: true, Chain: nil}}}}}}); err != nil {
...
func (client BackupVaultsClient) CreateOrUpdateSender(req *http.Request) (future BackupVaultsCreateOrUpdateFuture, err error) {
	...
	future.Result = func(client BackupVaultsClient) (bvr BackupVaultResource, err error) {
		...
		if bvr.Response.Response == nil && err == nil {
			err = autorest.NewErrorWithError(err, "dataprotection.BackupVaultsCreateOrUpdateFuture", "Result", nil, "received nil response and error")
		}
