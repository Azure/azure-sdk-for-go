...
func (client BackupVaultOperationResultsClient) Get(ctx context.Context, resourceGroupName string, vaultName string, operationID string) (result BackupVaultResource, err error) {
...
func (client BackupVaultOperationResultsClient) GetPreparer(ctx context.Context, resourceGroupName string, vaultName string, operationID string) (*http.Request, error) {
