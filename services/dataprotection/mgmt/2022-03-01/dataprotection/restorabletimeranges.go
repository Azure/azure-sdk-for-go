...
func (client RestorableTimeRangesClient) Find(ctx context.Context, resourceGroupName string, vaultName string, backupInstanceName string, parameters AzureBackupFindRestorableTimeRangesRequest) (result AzureBackupFindRestorableTimeRangesResponseResource, err error) {
	...
	req, err := client.FindPreparer(ctx, resourceGroupName, vaultName, backupInstanceName, parameters)
	if err != nil {
...
func (client RestorableTimeRangesClient) FindPreparer(ctx context.Context, resourceGroupName string, vaultName string, backupInstanceName string, parameters AzureBackupFindRestorableTimeRangesRequest) (*http.Request, error) {
