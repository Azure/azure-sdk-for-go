...
func (client UsersClient) CreateOrUpdateSender(req *http.Request) (future UsersCreateOrUpdateFuture, err error) {
	...
	future.Result = func(client UsersClient) (u User, err error) {
		var done bool
		...
		if u.Response.Response == nil && err == nil {
			err = autorest.NewErrorWithError(err, "dtl.UsersCreateOrUpdateFuture", "Result", nil, "received nil response and error")
		}
...
func (client UsersClient) DeleteSender(req *http.Request) (future UsersDeleteFuture, err error) {
	...
	azf, err = azure.NewFutureFromResponse(resp)
	future.FutureAPI = &azf
	future.Result = func(client UsersClient) (ar autorest.Response, err error) {
		var done bool
		done, err = future.DoneWithContext(context.Background(), client)
		if err != nil {
