...
const (
	...
	// ConnectionTypeTimeSeriesDatabaseConnectionProperties ...
	ConnectionTypeTimeSeriesDatabaseConnectionProperties ConnectionType = "TimeSeriesDatabaseConnectionProperties"
)

// PossibleConnectionTypeValues returns an array of possible values for the ConnectionType const type.
func PossibleConnectionTypeValues() []ConnectionType {
	return []ConnectionType{ConnectionTypeAzureDataExplorer, ConnectionTypeTimeSeriesDatabaseConnectionProperties}
}
...
func PossibleEndpointProvisioningStateValues() []EndpointProvisioningState {
	return []EndpointProvisioningState{Canceled, Deleted, Deleting, Disabled, Failed, Moving, Provisioning, Restoring, Succeeded, Suspending, Updating, Warning}
}
...
// TimeSeriesDatabaseConnectionState enumerates the values for time series database connection state.
