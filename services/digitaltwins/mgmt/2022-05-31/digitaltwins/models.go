...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/digitaltwins/mgmt/2022-05-31/digitaltwins"

// AzureDataExplorerConnectionProperties properties of a time series database connection to Azure Data
// Explorer with data being sent via an EventHub.
type AzureDataExplorerConnectionProperties struct {
	...
	// AdxTableName - The name of the Azure Data Explorer table.
	...
	// ProvisioningState - READ-ONLY; The provisioning state. Possible values include: 'TimeSeriesDatabaseConnectionStateProvisioning', 'TimeSeriesDatabaseConnectionStateDeleting', 'TimeSeriesDatabaseConnectionStateUpdating', 'TimeSeriesDatabaseConnectionStateSucceeded', 'TimeSeriesDatabaseConnectionStateFailed', 'TimeSeriesDatabaseConnectionStateCanceled', 'TimeSeriesDatabaseConnectionStateDeleted', 'TimeSeriesDatabaseConnectionStateWarning', 'TimeSeriesDatabaseConnectionStateSuspending', 'TimeSeriesDatabaseConnectionStateRestoring', 'TimeSeriesDatabaseConnectionStateMoving', 'TimeSeriesDatabaseConnectionStateDisabled'
	ProvisioningState TimeSeriesDatabaseConnectionState `json:"provisioningState,omitempty"`
	// ConnectionType - Possible values include: 'ConnectionTypeTimeSeriesDatabaseConnectionProperties', 'ConnectionTypeAzureDataExplorer'
	ConnectionType ConnectionType `json:"connectionType,omitempty"`
}

// MarshalJSON is the custom marshaler for AzureDataExplorerConnectionProperties.
func (adecp AzureDataExplorerConnectionProperties) MarshalJSON() ([]byte, error) {
	adecp.ConnectionType = ConnectionTypeAzureDataExplorer
	objectMap := make(map[string]interface{})
	if adecp.AdxResourceID != nil {
		objectMap["adxResourceId"] = adecp.AdxResourceID
	}
	if adecp.AdxEndpointURI != nil {
		objectMap["adxEndpointUri"] = adecp.AdxEndpointURI
	}
	if adecp.AdxDatabaseName != nil {
		objectMap["adxDatabaseName"] = adecp.AdxDatabaseName
	}
	if adecp.AdxTableName != nil {
		objectMap["adxTableName"] = adecp.AdxTableName
	}
	if adecp.EventHubEndpointURI != nil {
		objectMap["eventHubEndpointUri"] = adecp.EventHubEndpointURI
	}
	if adecp.EventHubEntityPath != nil {
		objectMap["eventHubEntityPath"] = adecp.EventHubEntityPath
	}
	if adecp.EventHubNamespaceResourceID != nil {
		objectMap["eventHubNamespaceResourceId"] = adecp.EventHubNamespaceResourceID
	}
	if adecp.EventHubConsumerGroup != nil {
		objectMap["eventHubConsumerGroup"] = adecp.EventHubConsumerGroup
	}
	if adecp.ConnectionType != "" {
		objectMap["connectionType"] = adecp.ConnectionType
	}
	return json.Marshal(objectMap)
}

// AsAzureDataExplorerConnectionProperties is the BasicTimeSeriesDatabaseConnectionProperties implementation for AzureDataExplorerConnectionProperties.
func (adecp AzureDataExplorerConnectionProperties) AsAzureDataExplorerConnectionProperties() (*AzureDataExplorerConnectionProperties, bool) {
	return &adecp, true
}

// AsTimeSeriesDatabaseConnectionProperties is the BasicTimeSeriesDatabaseConnectionProperties implementation for AzureDataExplorerConnectionProperties.
func (adecp AzureDataExplorerConnectionProperties) AsTimeSeriesDatabaseConnectionProperties() (*TimeSeriesDatabaseConnectionProperties, bool) {
	return nil, false
}

// AsBasicTimeSeriesDatabaseConnectionProperties is the BasicTimeSeriesDatabaseConnectionProperties implementation for AzureDataExplorerConnectionProperties.
func (adecp AzureDataExplorerConnectionProperties) AsBasicTimeSeriesDatabaseConnectionProperties() (BasicTimeSeriesDatabaseConnectionProperties, bool) {
	return &adecp, true
}
...
type Description struct {
	...
	*Properties `json:"properties,omitempty"`
	...
	// SystemData - READ-ONLY; Metadata pertaining to creation and last modification of the DigitalTwinsInstance.
...
type EndpointResourceProperties struct {
	// ProvisioningState - READ-ONLY; The provisioning state. Possible values include: 'Provisioning', 'Deleting', 'Updating', 'Succeeded', 'Failed', 'Canceled', 'Deleted', 'Warning', 'Suspending', 'Restoring', 'Moving', 'Disabled'
	ProvisioningState EndpointProvisioningState `json:"provisioningState,omitempty"`
	// CreatedTime - READ-ONLY; Time when the Endpoint was added to DigitalTwinsInstance.
	CreatedTime *date.Time `json:"createdTime,omitempty"`
	// AuthenticationType - Specifies the authentication type being used for connecting to the endpoint. Defaults to 'KeyBased'. If 'KeyBased' is selected, a connection string must be specified (at least the primary connection string). If 'IdentityBased' is select, the endpointUri and entityPath properties must be specified. Possible values include: 'KeyBased', 'IdentityBased'
...
type PrivateEndpointConnection struct {
	...
	// SystemData - READ-ONLY; Metadata pertaining to creation and last modification of the private endpoint connection.
	SystemData *SystemData `json:"systemData,omitempty"`
}
...
type TimeSeriesDatabaseConnection struct {
	...
	Properties BasicTimeSeriesDatabaseConnectionProperties `json:"properties,omitempty"`
	// ID - READ-ONLY; The resource identifier.
	ID *string `json:"id,omitempty"`
	// Name - READ-ONLY; Extension resource name.
	Name *string `json:"name,omitempty"`
...
// MarshalJSON is the custom marshaler for TimeSeriesDatabaseConnection.
func (tsdc TimeSeriesDatabaseConnection) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	objectMap["properties"] = tsdc.Properties
	return json.Marshal(objectMap)
}

// UnmarshalJSON is the custom unmarshaler for TimeSeriesDatabaseConnection struct.
func (tsdc *TimeSeriesDatabaseConnection) UnmarshalJSON(body []byte) error {
	var m map[string]*json.RawMessage
	err := json.Unmarshal(body, &m)
	if err != nil {
		return err
	...
	for k, v := range m {
		...
		case "properties":
			if v != nil {
				properties, err := unmarshalBasicTimeSeriesDatabaseConnectionProperties(*v)
				if err != nil {
					return err
				}
				tsdc.Properties = properties
			}
		case "id":
			if v != nil {
				var ID string
...
type TimeSeriesDatabaseConnectionListResult struct {
	...
	NextLink *string `json:"nextLink,omitempty"`
	// Value - A list of time series database connection resources.
	Value *[]TimeSeriesDatabaseConnection `json:"value,omitempty"`
}

// TimeSeriesDatabaseConnectionListResultIterator provides access to a complete listing of
// TimeSeriesDatabaseConnection values.
type TimeSeriesDatabaseConnectionListResultIterator struct {
	i    int
	page TimeSeriesDatabaseConnectionListResultPage
}

// NextWithContext advances to the next value.  If there was an error making
// the request the iterator does not advance and the error is returned.
func (iter *TimeSeriesDatabaseConnectionListResultIterator) NextWithContext(ctx context.Context) (err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/TimeSeriesDatabaseConnectionListResultIterator.NextWithContext")
		defer func() {
			sc := -1
			if iter.Response().Response.Response != nil {
				sc = iter.Response().Response.Response.StatusCode
...
// the request the iterator does not advance and the error is returned.
// Deprecated: Use NextWithContext() instead.
func (iter *TimeSeriesDatabaseConnectionListResultIterator) Next() error {
	return iter.NextWithContext(context.Background())
}

// NotDone returns true if the enumeration should be started or is not yet complete.
func (iter TimeSeriesDatabaseConnectionListResultIterator) NotDone() bool {
	return iter.page.NotDone() && iter.i < len(iter.page.Values())
}

// Response returns the raw server response from the last page request.
func (iter TimeSeriesDatabaseConnectionListResultIterator) Response() TimeSeriesDatabaseConnectionListResult {
	return iter.page.Response()
}

// Value returns the current value or a zero-initialized value if the
// iterator has advanced beyond the end of the collection.
func (iter TimeSeriesDatabaseConnectionListResultIterator) Value() TimeSeriesDatabaseConnection {
	if !iter.page.NotDone() {
		return TimeSeriesDatabaseConnection{}
	}
	return iter.page.Values()[iter.i]
}

// Creates a new instance of the TimeSeriesDatabaseConnectionListResultIterator type.
func NewTimeSeriesDatabaseConnectionListResultIterator(page TimeSeriesDatabaseConnectionListResultPage) TimeSeriesDatabaseConnectionListResultIterator {
	return TimeSeriesDatabaseConnectionListResultIterator{page: page}
}

// IsEmpty returns true if the ListResult contains no values.
func (tsdclr TimeSeriesDatabaseConnectionListResult) IsEmpty() bool {
	return tsdclr.Value == nil || len(*tsdclr.Value) == 0
}

// hasNextLink returns true if the NextLink is not empty.
func (tsdclr TimeSeriesDatabaseConnectionListResult) hasNextLink() bool {
	return tsdclr.NextLink != nil && len(*tsdclr.NextLink) != 0
}

// timeSeriesDatabaseConnectionListResultPreparer prepares a request to retrieve the next set of results.
// It returns nil if no more results exist.
func (tsdclr TimeSeriesDatabaseConnectionListResult) timeSeriesDatabaseConnectionListResultPreparer(ctx context.Context) (*http.Request, error) {
	if !tsdclr.hasNextLink() {
		return nil, nil
	}
	return autorest.Prepare((&http.Request{}).WithContext(ctx),
		autorest.AsJSON(),
		autorest.AsGet(),
		autorest.WithBaseURL(to.String(tsdclr.NextLink)))
}

// TimeSeriesDatabaseConnectionListResultPage contains a page of TimeSeriesDatabaseConnection values.
type TimeSeriesDatabaseConnectionListResultPage struct {
	fn     func(context.Context, TimeSeriesDatabaseConnectionListResult) (TimeSeriesDatabaseConnectionListResult, error)
	tsdclr TimeSeriesDatabaseConnectionListResult
}

// NextWithContext advances to the next page of values.  If there was an error making
// the request the page does not advance and the error is returned.
func (page *TimeSeriesDatabaseConnectionListResultPage) NextWithContext(ctx context.Context) (err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/TimeSeriesDatabaseConnectionListResultPage.NextWithContext")
		defer func() {
			sc := -1
			if page.Response().Response.Response != nil {
				sc = page.Response().Response.Response.StatusCode
	...
	for {
		next, err := page.fn(ctx, page.tsdclr)
		if err != nil {
			return err
		}
		page.tsdclr = next
...
// the request the page does not advance and the error is returned.
// Deprecated: Use NextWithContext() instead.
func (page *TimeSeriesDatabaseConnectionListResultPage) Next() error {
	return page.NextWithContext(context.Background())
}

// NotDone returns true if the page enumeration should be started or is not yet complete.
func (page TimeSeriesDatabaseConnectionListResultPage) NotDone() bool {
	return !page.tsdclr.IsEmpty()
}

// Response returns the raw server response from the last page request.
func (page TimeSeriesDatabaseConnectionListResultPage) Response() TimeSeriesDatabaseConnectionListResult {
	return page.tsdclr
}

// Values returns the slice of values for the current page or nil if there are no values.
func (page TimeSeriesDatabaseConnectionListResultPage) Values() []TimeSeriesDatabaseConnection {
	if page.tsdclr.IsEmpty() {
		return nil
	}
	return *page.tsdclr.Value
}

// Creates a new instance of the TimeSeriesDatabaseConnectionListResultPage type.
func NewTimeSeriesDatabaseConnectionListResultPage(cur TimeSeriesDatabaseConnectionListResult, getNextPage func(context.Context, TimeSeriesDatabaseConnectionListResult) (TimeSeriesDatabaseConnectionListResult, error)) TimeSeriesDatabaseConnectionListResultPage {
	return TimeSeriesDatabaseConnectionListResultPage{
		fn:     getNextPage,
		tsdclr: cur,
	}
}

// BasicTimeSeriesDatabaseConnectionProperties properties of a time series database connection resource.
type BasicTimeSeriesDatabaseConnectionProperties interface {
	AsAzureDataExplorerConnectionProperties() (*AzureDataExplorerConnectionProperties, bool)
	AsTimeSeriesDatabaseConnectionProperties() (*TimeSeriesDatabaseConnectionProperties, bool)
}
...
func unmarshalBasicTimeSeriesDatabaseConnectionProperties(body []byte) (BasicTimeSeriesDatabaseConnectionProperties, error) {
	var m map[string]interface{}
	err := json.Unmarshal(body, &m)
	if err != nil {
		return nil, err
	...
	case string(ConnectionTypeAzureDataExplorer):
		var adecp AzureDataExplorerConnectionProperties
		err := json.Unmarshal(body, &adecp)
		return adecp, err
	default:
		var tsdcp TimeSeriesDatabaseConnectionProperties
		err := json.Unmarshal(body, &tsdcp)
		return tsdcp, err
	}
}
func unmarshalBasicTimeSeriesDatabaseConnectionPropertiesArray(body []byte) ([]BasicTimeSeriesDatabaseConnectionProperties, error) {
	var rawMessages []*json.RawMessage
	err := json.Unmarshal(body, &rawMessages)
	if err != nil {
		return nil, err
	...
	tsdcpArray := make([]BasicTimeSeriesDatabaseConnectionProperties, len(rawMessages))

	for index, rawMessage := range rawMessages {
		tsdcp, err := unmarshalBasicTimeSeriesDatabaseConnectionProperties(*rawMessage)
		if err != nil {
			return nil, err
		}
		tsdcpArray[index] = tsdcp
	}
	return tsdcpArray, nil
}

// MarshalJSON is the custom marshaler for TimeSeriesDatabaseConnectionProperties.
func (tsdcp TimeSeriesDatabaseConnectionProperties) MarshalJSON() ([]byte, error) {
	tsdcp.ConnectionType = ConnectionTypeTimeSeriesDatabaseConnectionProperties
	objectMap := make(map[string]interface{})
	if tsdcp.ConnectionType != "" {
		objectMap["connectionType"] = tsdcp.ConnectionType
	}
	return json.Marshal(objectMap)
}

// AsAzureDataExplorerConnectionProperties is the BasicTimeSeriesDatabaseConnectionProperties implementation for TimeSeriesDatabaseConnectionProperties.
func (tsdcp TimeSeriesDatabaseConnectionProperties) AsAzureDataExplorerConnectionProperties() (*AzureDataExplorerConnectionProperties, bool) {
	return nil, false
}

// AsTimeSeriesDatabaseConnectionProperties is the BasicTimeSeriesDatabaseConnectionProperties implementation for TimeSeriesDatabaseConnectionProperties.
func (tsdcp TimeSeriesDatabaseConnectionProperties) AsTimeSeriesDatabaseConnectionProperties() (*TimeSeriesDatabaseConnectionProperties, bool) {
	return &tsdcp, true
}

// AsBasicTimeSeriesDatabaseConnectionProperties is the BasicTimeSeriesDatabaseConnectionProperties implementation for TimeSeriesDatabaseConnectionProperties.
func (tsdcp TimeSeriesDatabaseConnectionProperties) AsBasicTimeSeriesDatabaseConnectionProperties() (BasicTimeSeriesDatabaseConnectionProperties, bool) {
	return &tsdcp, true
}

// TimeSeriesDatabaseConnectionsCreateOrUpdateFuture an abstraction for monitoring and retrieving the
// results of a long-running operation.
type TimeSeriesDatabaseConnectionsCreateOrUpdateFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(TimeSeriesDatabaseConnectionsClient) (TimeSeriesDatabaseConnection, error)
}

// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *TimeSeriesDatabaseConnectionsCreateOrUpdateFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for TimeSeriesDatabaseConnectionsCreateOrUpdateFuture.Result.
func (future *TimeSeriesDatabaseConnectionsCreateOrUpdateFuture) result(client TimeSeriesDatabaseConnectionsClient) (tsdc TimeSeriesDatabaseConnection, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "digitaltwins.TimeSeriesDatabaseConnectionsCreateOrUpdateFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		tsdc.Response.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("digitaltwins.TimeSeriesDatabaseConnectionsCreateOrUpdateFuture")
		return
	}
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if tsdc.Response.Response, err = future.GetResult(sender); err == nil && tsdc.Response.Response.StatusCode != http.StatusNoContent {
		tsdc, err = client.CreateOrUpdateResponder(tsdc.Response.Response)
		if err != nil {
			err = autorest.NewErrorWithError(err, "digitaltwins.TimeSeriesDatabaseConnectionsCreateOrUpdateFuture", "Result", tsdc.Response.Response, "Failure responding to request")
		}
	}
	return
}

// TimeSeriesDatabaseConnectionsDeleteFuture an abstraction for monitoring and retrieving the results of a
// long-running operation.
type TimeSeriesDatabaseConnectionsDeleteFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(TimeSeriesDatabaseConnectionsClient) (TimeSeriesDatabaseConnection, error)
...
// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *TimeSeriesDatabaseConnectionsDeleteFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for TimeSeriesDatabaseConnectionsDeleteFuture.Result.
func (future *TimeSeriesDatabaseConnectionsDeleteFuture) result(client TimeSeriesDatabaseConnectionsClient) (tsdc TimeSeriesDatabaseConnection, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "digitaltwins.TimeSeriesDatabaseConnectionsDeleteFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		tsdc.Response.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("digitaltwins.TimeSeriesDatabaseConnectionsDeleteFuture")
		return
	}
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if tsdc.Response.Response, err = future.GetResult(sender); err == nil && tsdc.Response.Response.StatusCode != http.StatusNoContent {
		tsdc, err = client.DeleteResponder(tsdc.Response.Response)
		if err != nil {
			err = autorest.NewErrorWithError(err, "digitaltwins.TimeSeriesDatabaseConnectionsDeleteFuture", "Result", tsdc.Response.Response, "Failure responding to request")
		}
	}
	return
}
