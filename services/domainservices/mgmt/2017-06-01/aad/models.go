...
func NewOuContainerListResultPage(getNextPage func(context.Context, OuContainerListResult) (OuContainerListResult, error)) OuContainerListResultPage {
	return OuContainerListResultPage{fn: getNextPage}
}
