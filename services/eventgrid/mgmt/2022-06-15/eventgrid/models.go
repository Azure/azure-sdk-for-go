...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/eventgrid/mgmt/2022-06-15/eventgrid"
...
type ChannelProperties struct {
	// ChannelType - The type of the event channel which represents the direction flow of events. Possible values include: 'ChannelTypePartnerTopic'
	...
	// ProvisioningState - Provisioning state of the channel. Possible values include: 'Creating', 'Updating', 'Deleting', 'Succeeded', 'Canceled', 'Failed', 'IdleDueToMirroredPartnerTopicDeletion'
...
type ChannelUpdateParametersProperties struct {
	// ExpirationTimeIfNotActivatedUtc - Expiration time of the channel. If this timer expires while the corresponding partner topic or partner destination is never activated,
...
type DomainProperties struct {
	...
	// DataResidencyBoundary - Data Residency Boundary of the resource. Possible values include: 'WithinGeopair', 'WithinRegion'
...
type DomainUpdateParameterProperties struct {
	...
	// resources by the user.
	AutoDeleteTopicWithLastSubscription *bool `json:"autoDeleteTopicWithLastSubscription,omitempty"`
	// DataResidencyBoundary - The data residency boundary for the domain. Possible values include: 'WithinGeopair', 'WithinRegion'
	DataResidencyBoundary DataResidencyBoundary `json:"dataResidencyBoundary,omitempty"`
}
...
type EventTypeInfo struct {
	// Kind - The kind of event type used. Possible values include: 'Inline'
...
type PartnerNamespaceProperties struct {
	...
	Endpoint *string `json:"endpoint,omitempty"`
	// PublicNetworkAccess - This determines if traffic is allowed over public network. By default it is enabled.
	// You can further restrict to specific IPs by configuring <seealso cref="P:Microsoft.Azure.Events.ResourceProvider.Common.Contracts.PartnerNamespaceProperties.InboundIpRules" />. Possible values include: 'Enabled', 'Disabled'
	PublicNetworkAccess PublicNetworkAccess `json:"publicNetworkAccess,omitempty"`
	// InboundIPRules - This can be used to restrict traffic from specific IPs instead of all IPs. Note: These are considered only if PublicNetworkAccess is enabled.
	InboundIPRules *[]InboundIPRule `json:"inboundIpRules,omitempty"`
	...
	// or use the channel name in the header when matching to the partner topic. If none is specified, source attribute routing will be used to match the partner topic. Possible values include: 'SourceEventAttribute', 'ChannelNameHeader'
...
type PartnerNamespaceUpdateParameterProperties struct {
	// PublicNetworkAccess - This determines if traffic is allowed over public network. By default it is enabled.
	// You can further restrict to specific IPs by configuring <seealso cref="P:Microsoft.Azure.Events.ResourceProvider.Common.Contracts.PartnerNamespaceUpdateParameterProperties.InboundIpRules" />. Possible values include: 'Enabled', 'Disabled'
	PublicNetworkAccess PublicNetworkAccess `json:"publicNetworkAccess,omitempty"`
	// InboundIPRules - This can be used to restrict traffic from specific IPs instead of all IPs. Note: These are considered only if PublicNetworkAccess is enabled.
	InboundIPRules *[]InboundIPRule `json:"inboundIpRules,omitempty"`
	// DisableLocalAuth - This boolean is used to enable or disable local auth. Default value is false. When the property is set to true, only AAD token will be used to authenticate if user is allowed to publish to the partner namespace.
...
type TopicUpdateParameterProperties struct {
	...
	// DisableLocalAuth - This boolean is used to enable or disable local auth. Default value is false. When the property is set to true, only AAD token will be used to authenticate if user is allowed to publish to the topic.
	DisableLocalAuth *bool `json:"disableLocalAuth,omitempty"`
	// DataResidencyBoundary - The data residency boundary for the topic. Possible values include: 'WithinGeopair', 'WithinRegion'
	DataResidencyBoundary DataResidencyBoundary `json:"dataResidencyBoundary,omitempty"`
}
