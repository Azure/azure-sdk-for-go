...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/frontdoor/mgmt/2020-11-01/frontdoor"
...
type Backend struct {
	...
	// EnabledState - Whether to enable use of this backend. Permitted values are 'Enabled' or 'Disabled'. Possible values include: 'BackendEnabledStateEnabled', 'BackendEnabledStateDisabled'
...
type CacheConfiguration struct {
	// QueryParameterStripDirective - Treatment of URL query terms when forming the cache key. Possible values include: 'QueryStripNone', 'QueryStripAll', 'QueryStripOnly', 'QueryStripAllExcept'
...
type CertificateSourceParameters struct {
	// CertificateType - Defines the type of the certificate used for secure connections to a frontendEndpoint. Possible values include: 'CertificateTypeDedicated'
...
type CheckNameAvailabilityInput struct {
	...
	Name *string `json:"name,omitempty"`
	// Type - The type of the resource whose name is to be validated. Possible values include: 'ResourceTypeMicrosoftNetworkfrontDoors', 'ResourceTypeMicrosoftNetworkfrontDoorsfrontendEndpoints'
...
type CheckNameAvailabilityOutput struct {
	...
	// NameAvailability - READ-ONLY; Indicates whether the name is available. Possible values include: 'AvailabilityAvailable', 'AvailabilityUnavailable'
...
type CustomHTTPSConfiguration struct {
	...
	// MinimumTLSVersion - The minimum TLS version required from the clients to establish an SSL handshake with Front Door. Possible values include: 'MinimumTLSVersionOneFullStopZero', 'MinimumTLSVersionOneFullStopTwo'
...
type CustomRule struct {
	...
	// RuleType - Describes type of rule. Possible values include: 'RuleTypeMatchRule', 'RuleTypeRateLimitRule'
...
type HeaderAction struct {
	// HeaderActionType - Which type of manipulation to apply to the header. Possible values include: 'HeaderActionTypeAppend', 'HeaderActionTypeDelete', 'HeaderActionTypeOverwrite'
...
type HealthProbeSettingsProperties struct {
	...
	// HealthProbeMethod - Configures which HTTP method to use to probe the backends defined under backendPools. Possible values include: 'HealthProbeMethodGET', 'HealthProbeMethodHEAD'
...
type ManagedRuleDefinition struct {
	...
	// DefaultAction - READ-ONLY; Describes the default action to be applied when the managed rule matches. Possible values include: 'ActionTypeAllow', 'ActionTypeBlock', 'ActionTypeLog', 'ActionTypeRedirect'
...
type ManagedRuleExclusion struct {
	// MatchVariable - The variable type to be excluded. Possible values include: 'ManagedRuleExclusionMatchVariableRequestHeaderNames', 'ManagedRuleExclusionMatchVariableRequestCookieNames', 'ManagedRuleExclusionMatchVariableQueryStringArgNames', 'ManagedRuleExclusionMatchVariableRequestBodyPostArgNames', 'ManagedRuleExclusionMatchVariableRequestBodyJSONArgNames'
	MatchVariable ManagedRuleExclusionMatchVariable `json:"matchVariable,omitempty"`
	// SelectorMatchOperator - Comparison operator to apply to the selector when specifying which elements in the collection this exclusion applies to. Possible values include: 'ManagedRuleExclusionSelectorMatchOperatorEquals', 'ManagedRuleExclusionSelectorMatchOperatorContains', 'ManagedRuleExclusionSelectorMatchOperatorStartsWith', 'ManagedRuleExclusionSelectorMatchOperatorEndsWith', 'ManagedRuleExclusionSelectorMatchOperatorEqualsAny'
...
type ManagedRuleSet struct {
	...
	// RuleSetAction - Possible values include: 'ManagedRuleSetActionTypeBlock', 'ManagedRuleSetActionTypeLog', 'ManagedRuleSetActionTypeRedirect'
...
type MatchCondition struct {
	// MatchVariable - Request variable to compare with. Possible values include: 'MatchVariableRemoteAddr', 'MatchVariableRequestMethod', 'MatchVariableQueryString', 'MatchVariablePostArgs', 'MatchVariableRequestURI', 'MatchVariableRequestHeader', 'MatchVariableRequestBody', 'MatchVariableCookies', 'MatchVariableSocketAddr'
...
type PolicySettings struct {
	...
	// RequestBodyCheck - Describes if policy managed rules will inspect the request body content. Possible values include: 'PolicyRequestBodyCheckDisabled', 'PolicyRequestBodyCheckEnabled'
...
type PreconfiguredEndpointProperties struct {
	...
	Endpoint *string `json:"endpoint,omitempty"`
	// EndpointType - The type of endpoint. Possible values include: 'EndpointTypeAFD', 'EndpointTypeAzureRegion', 'EndpointTypeCDN', 'EndpointTypeATM'
...
type Sku struct {
	// Name - Name of the pricing tier. Possible values include: 'SkuNameClassicAzureFrontDoor', 'SkuNameStandardAzureFrontDoor', 'SkuNamePremiumAzureFrontDoor'
...
type TimeseriesProperties struct {
	...
	EndDateTimeUTC *string `json:"endDateTimeUTC,omitempty"`
	// AggregationInterval - The aggregation interval of the Timeseries. Possible values include: 'AggregationIntervalHourly', 'AggregationIntervalDaily'
	AggregationInterval AggregationInterval `json:"aggregationInterval,omitempty"`
	// TimeseriesType - The type of Timeseries. Possible values include: 'TimeseriesTypeMeasurementCounts', 'TimeseriesTypeLatencyP50', 'TimeseriesTypeLatencyP75', 'TimeseriesTypeLatencyP95'
...
type WebApplicationFirewallPolicyProperties struct {
	...
	// SecurityPolicyLinks - READ-ONLY; Describes Security Policy associated with this Web Application Firewall policy.
