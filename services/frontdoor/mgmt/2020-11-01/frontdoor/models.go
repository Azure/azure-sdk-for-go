...
type ManagedRuleExclusion struct {
	// MatchVariable - The variable type to be excluded. Possible values include: 'RequestHeaderNames', 'RequestCookieNames', 'QueryStringArgNames', 'RequestBodyPostArgNames', 'RequestBodyJSONArgNames'
...
type Sku struct {
	// Name - Name of the pricing tier. Possible values include: 'ClassicAzureFrontDoor', 'StandardAzureFrontDoor', 'PremiumAzureFrontDoor'
