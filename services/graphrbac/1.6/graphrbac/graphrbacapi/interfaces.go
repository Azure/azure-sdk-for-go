...
type ServicePrincipalsClientAPI interface {
	...
	ListAppRoleAssignedTo(ctx context.Context, objectID string) (result graphrbac.AppRoleAssignmentListResultPage, err error)
	ListAppRoleAssignedToComplete(ctx context.Context, objectID string) (result graphrbac.AppRoleAssignmentListResultIterator, err error)
	ListAppRoleAssignments(ctx context.Context, objectID string) (result graphrbac.AppRoleAssignmentListResultPage, err error)
	ListAppRoleAssignmentsComplete(ctx context.Context, objectID string) (result graphrbac.AppRoleAssignmentListResultIterator, err error)
