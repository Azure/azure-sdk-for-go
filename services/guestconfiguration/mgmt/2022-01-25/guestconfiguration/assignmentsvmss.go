...
func (client AssignmentsVMSSClient) Delete(ctx context.Context, resourceGroupName string, vmssName string, name string) (result Assignment, err error) {
	...
	req, err := client.DeletePreparer(ctx, resourceGroupName, vmssName, name)
	if err != nil {
...
func (client AssignmentsVMSSClient) DeletePreparer(ctx context.Context, resourceGroupName string, vmssName string, name string) (*http.Request, error) {
...
// vmssName - the name of the virtual machine scale set.
// name - the guest configuration assignment name.
func (client AssignmentsVMSSClient) Get(ctx context.Context, resourceGroupName string, vmssName string, name string) (result Assignment, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.GetPreparer(ctx, resourceGroupName, vmssName, name)
	if err != nil {
...
func (client AssignmentsVMSSClient) GetPreparer(ctx context.Context, resourceGroupName string, vmssName string, name string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"name":              autorest.Encode("path", name),
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"subscriptionId":    autorest.Encode("path", client.SubscriptionID),
