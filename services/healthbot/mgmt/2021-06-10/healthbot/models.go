...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/healthbot/mgmt/2021-06-10/healthbot"
...
type BotResponseList struct {
	...
	NextLink *string `json:"nextLink,omitempty"`
	// Value - READ-ONLY; Gets the list of Azure Health Bot results and their properties.
...
func (hb HealthBot) MarshalJSON() ([]byte, error) {
	...
	if hb.Identity != nil {
		objectMap["identity"] = hb.Identity
	}
...
type Identity struct {
	// PrincipalID - READ-ONLY; The principal ID of resource identity. This property will only be provided for a system assigned identity.
	PrincipalID *string `json:"principalId,omitempty"`
	// TenantID - READ-ONLY; The tenant ID of resource. This property will only be provided for a system assigned identity.
...
// Properties the properties of a Azure Health Bot. The Health Bot Service is a cloud platform that
// empowers developers in Healthcare organizations to build and deploy their compliant, AI-powered virtual
// health assistants and health bots, that help them improve processes and reduce costs.
type Properties struct {
	// ProvisioningState - READ-ONLY; The provisioning state of the Azure Health Bot resource.
...
type Sku struct {
	// Name - The name of the Azure Health Bot SKU. Possible values include: 'F0', 'S1', 'C0'
...
// UserAssignedIdentity the details of the user assigned managed identity used by the Video Analyzer
// resource.
