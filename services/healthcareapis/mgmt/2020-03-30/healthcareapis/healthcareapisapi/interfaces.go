...
type PrivateEndpointConnectionsClientAPI interface {
	...
	Get(ctx context.Context, resourceGroupName string, resourceName string, privateEndpointConnectionName string) (result healthcareapis.PrivateEndpointConnection, err error)
	ListByService(ctx context.Context, resourceGroupName string, resourceName string) (result healthcareapis.PrivateEndpointConnectionListResult, err error)
}
...
type PrivateLinkResourcesClientAPI interface {
	Get(ctx context.Context, resourceGroupName string, resourceName string, groupName string) (result healthcareapis.PrivateLinkResource, err error)
	ListByService(ctx context.Context, resourceGroupName string, resourceName string) (result healthcareapis.PrivateLinkResourceListResult, err error)
}
