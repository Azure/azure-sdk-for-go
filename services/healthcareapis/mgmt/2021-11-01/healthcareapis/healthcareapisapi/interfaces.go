...
type WorkspacePrivateEndpointConnectionsClientAPI interface {
	CreateOrUpdate(ctx context.Context, resourceGroupName string, workspaceName string, privateEndpointConnectionName string, properties healthcareapis.PrivateEndpointConnectionDescription) (result healthcareapis.WorkspacePrivateEndpointConnectionsCreateOrUpdateFuture, err error)
	Delete(ctx context.Context, resourceGroupName string, workspaceName string, privateEndpointConnectionName string) (result healthcareapis.WorkspacePrivateEndpointConnectionsDeleteFuture, err error)
	Get(ctx context.Context, resourceGroupName string, workspaceName string, privateEndpointConnectionName string) (result healthcareapis.PrivateEndpointConnectionDescription, err error)
	ListByWorkspace(ctx context.Context, resourceGroupName string, workspaceName string) (result healthcareapis.PrivateEndpointConnectionListResultDescription, err error)
}

var _ WorkspacePrivateEndpointConnectionsClientAPI = (*healthcareapis.WorkspacePrivateEndpointConnectionsClient)(nil)

// WorkspacePrivateLinkResourcesClientAPI contains the set of methods on the WorkspacePrivateLinkResourcesClient type.
type WorkspacePrivateLinkResourcesClientAPI interface {
	Get(ctx context.Context, resourceGroupName string, workspaceName string, groupName string) (result healthcareapis.PrivateLinkResourceDescription, err error)
	ListByWorkspace(ctx context.Context, resourceGroupName string, workspaceName string) (result healthcareapis.PrivateLinkResourceListResultDescription, err error)
}

var _ WorkspacePrivateLinkResourcesClientAPI = (*healthcareapis.WorkspacePrivateLinkResourcesClient)(nil)
