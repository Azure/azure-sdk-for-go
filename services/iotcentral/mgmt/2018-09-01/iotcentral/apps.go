...
func (client AppsClient) Templates(ctx context.Context) (result AppTemplates, err error) {
	if tracing.IsEnabled() {
...
// closes the http.Response Body.
func (client AppsClient) TemplatesResponder(resp *http.Response) (result AppTemplates, err error) {
	err = autorest.Respond(
		resp,
		client.ByInspecting(),
		azure.WithErrorUnlessStatusCode(http.StatusOK),
