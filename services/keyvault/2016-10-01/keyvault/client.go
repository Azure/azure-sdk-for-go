...
// BackupSecret requests that a backup of the specified secret be downloaded to
// the client. Authorization: requires the secrets/backup permission.
//
// vaultBaseURL is the vault name, for example https://myvault.vault.azure.net.
...
// key vault certificate. Authorization: requires the
...
// DeleteCertificateIssuer the DeleteCertificateIssuer operation permanently
// removes the specified certificate issuer from the vault.
//
// vaultBaseURL is the vault name, for example https://myvault.vault.azure.net.
...
// certificate. Authorization: requires the certificates/update permission.
//
// vaultBaseURL is the vault name, for example https://myvault.vault.azure.net.
// certificateName is the name of the certificate.
...
// certificate. Authorization: requires the certificates/get permission.
//
// vaultBaseURL is the vault name, for example https://myvault.vault.azure.net.
// certificateName is the name of the certificate.
...
// GetDeletedCertificate the GetDeletedCertificate operation retrieves the
// deleted certificate information plus its attributes, such as retention
// interval, scheduled permanent deletion and the current deletion recovery
// level.
//
// vaultBaseURL is the vault name, for example https://myvault.vault.azure.net.
// certificateName is the name of the certificate
...
// GetDeletedCertificates the GetDeletedCertificates operation retrieves the
// certificates in the current vault which are in a deleted state and ready for
// recovery or purging.
//
// vaultBaseURL is the vault name, for example https://myvault.vault.azure.net.
// maxresults is maximum number of results to return in a page. If not
...
// GetDeletedKey retrieves the deleted key information plus its attributes.
...
// GetDeletedSecret retrieves the deleted secret information plus its
// attributes. Authorization: requires the secrets/get permission.
//
// vaultBaseURL is the vault name, for example https://myvault.vault.azure.net.
// secretName is the name of the secret
...
// GetDeletedSecrets list deleted secrets in the specified vault.
...
//
// vaultBaseURL is the vault name, for example https://myvault.vault.azure.net.
// storageAccountName is the name of the storage account. maxresults is maximum
// number of results to return in a page. If not specified the service will
...
// MergeCertificate the MergeCertificate operation performs the merging of a
// certificate or certificate chain with a key pair currently available in the
// service. Authorization: requires the certificates/update permission.
//
// vaultBaseURL is the vault name, for example https://myvault.vault.azure.net.
// certificateName is the name of the certificate. parameters is the parameters
...
// PurgeDeletedCertificate the PurgeDeletedCertificate operation performs an
// irreversible deletion of the specified certificate, without possibility for
// recovery. The operation is not available if the recovery level does not
// specify 'Purgeable'. Requires the explicit granting of the 'purge'
// permission.
//
// vaultBaseURL is the vault name, for example https://myvault.vault.azure.net.
// certificateName is the name of the certificate
...
// PurgeDeletedKey permanently deletes the specified key. aka purges the key.
...
// PurgeDeletedSecret permanently deletes the specified secret. aka purges the
// secret. Authorization: requires the secrets/purge permission.
//
// vaultBaseURL is the vault name, for example https://myvault.vault.azure.net.
// secretName is the name of the secret
...
// RecoverDeletedCertificate the RecoverDeletedCertificate operation performs
// the reversal of the Delete operation. The operation is applicable in vaults
...
//
// vaultBaseURL is the vault name, for example https://myvault.vault.azure.net.
// certificateName is the name of the deleted certificate
...
// RecoverDeletedKey recovers the deleted key back to its current version under
// /keys. Authorization: Requires the keys/recover permission.
//
// vaultBaseURL is the vault name, for example https://myvault.vault.azure.net.
// keyName is the name of the deleted key
...
// RecoverDeletedSecret recovers the deleted secret back to its current version
// under /secrets. Authorization: requires the secrets/recover permission.
//
// vaultBaseURL is the vault name, for example https://myvault.vault.azure.net.
// secretName is the name of the deleted secret
...
// RegenerateStorageAccountKey regenerates the specified key value for the
// given storage account.
//
// vaultBaseURL is the vault name, for example https://myvault.vault.azure.net.
// storageAccountName is the name of the storage account. parameters is the
...
// RestoreSecret restores a backed up secret to a vault. Authorization:
// requires the secrets/restore permission.
//
// vaultBaseURL is the vault name, for example https://myvault.vault.azure.net.
// parameters is the parameters to restore the secret.
...
// vault. Authorization: requires the certificates/managecontacts permission.
//
// vaultBaseURL is the vault name, for example https://myvault.vault.azure.net.
...
// SetCertificateIssuer the SetCertificateIssuer operation adds or updates the
// specified certificate issuer.
//
// vaultBaseURL is the vault name, for example https://myvault.vault.azure.net.
...
// vaultBaseURL is the vault name, for example https://myvault.vault.azure.net.
// storageAccountName is the name of the storage account. parameters is the
// parameters to create a storage account.
...
// UpdateCertificate the UpdateCertificate operation applies the specified
// update on the given certificate; note the only elements being updated are
// the certificate's attributes.
//
// vaultBaseURL is the vault name, for example https://myvault.vault.azure.net.
...
// UpdateCertificateIssuer the UpdateCertificateIssuer operation performs an
// update on the specified certificate issuer entity.
//
// vaultBaseURL is the vault name, for example https://myvault.vault.azure.net.
...
// UpdateCertificateOperation updates a certificate operation. Authorization:
...
// UpdateStorageAccount updates the specified attributes associated with the
// given storage account.
//
// vaultBaseURL is the vault name, for example https://myvault.vault.azure.net.
// storageAccountName is the name of the storage account. parameters is the
