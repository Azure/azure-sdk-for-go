...
const (
    ...
    // RecoverableProtectedSubscription specifies the recoverable protected
    // subscription state for deletion recovery level.
    RecoverableProtectedSubscription DeletionRecoveryLevel = "Recoverable+ProtectedSubscription"
    // RecoverablePurgeable specifies the recoverable purgeable state for
...
const (
    ...
    // RSAOAEP256 specifies the rsaoaep256 state for json web key encryption
    // algorithm.
...
// DeletedCertificateBundle is a Deleted Certificate consisting of its previous
// id, attributes and its tags, as well as information on when it will be
// purged.
...
// DeletedCertificateItem is the deleted certificate item containing metadata
// about the deleted certificate.
...
// DeletedCertificateListResult is a list of certificates that have been
// deleted in this vault.
...
// DeletedKeyBundle is a DeletedKeyBundle consisting of a WebKey plus its
// Attributes and deletion info
...
// DeletedKeyItem is the deleted key item containing the deleted key metadata
// and information about deletion.
...
// DeletedSecretBundle is a Deleted Secret consisting of its previous id,
// attributes and its tags, as well as information on when it will be purged.
...
// DeletedSecretItem is the deleted secret item containing metadata about the
// deleted secret.
...
// StorageAccountItem is the storage account item containing storage account
// metadata.
...
// StorageAccountRegenerteKeyParameters is the storage account key regenerate
// parameters.
...
// StorageBundle is a Storage account bundle consists of key vault storage
// account details plus its attributes.
