...
type ManagedHsmsClientAPI interface {
	CheckMhsmNameAvailability(ctx context.Context, mhsmName keyvault.CheckMhsmNameAvailabilityParameters) (result keyvault.CheckMhsmNameAvailabilityResult, err error)
