...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/kubernetesconfiguration/mgmt/2022-07-01/kubernetesconfiguration"
...
type ExtensionPropertiesAksAssignedIdentity struct {
	...
	// Type - The identity type. Possible values include: 'SystemAssigned', 'UserAssigned'
...
type FluxConfigurationPatchProperties struct {
	// SourceKind - Source Kind to pull the configuration data from. Possible values include: 'GitRepository', 'Bucket', 'AzureBlob'
...
func (fcp FluxConfigurationPatchProperties) MarshalJSON() ([]byte, error) {
	...
	if fcp.AzureBlob != nil {
		objectMap["azureBlob"] = fcp.AzureBlob
	}
...
func (fc FluxConfigurationProperties) MarshalJSON() ([]byte, error) {
	...
	if fc.AzureBlob != nil {
		objectMap["azureBlob"] = fc.AzureBlob
	}
