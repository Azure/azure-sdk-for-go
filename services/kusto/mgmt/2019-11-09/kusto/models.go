...
func (cpa ClusterPrincipalAssignment) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if cpa.Location != nil {
		objectMap["location"] = cpa.Location
	}
...
type ClusterPrincipalProperties struct {
	// PrincipalID - The principal ID assigned to the cluster principal. This maps to the ID inside the Active Directory. It can point to a user, service principal, or security group.
...
func (dpa DatabasePrincipalAssignment) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if dpa.Location != nil {
		objectMap["location"] = dpa.Location
	}
...
// DatabasePrincipalAssignmentListResult the list Kusto database principal assginments operation response.
...
type DatabasePrincipalProperties struct {
	// PrincipalID - The principal ID assigned to the database principal. This maps to the ID inside the Active Directory. It can point to a user, service principal, or security group.
	PrincipalID *string `json:"principalId,omitempty"`
	// Role - Database principal role. Possible values include: 'Admin', 'Ingestor', 'Monitor', 'User', 'UnrestrictedViewers', 'Viewer'
	Role DatabasePrincipalRole `json:"role,omitempty"`
	// TenantID - The tenant id of the principal
