...
type AzureSku struct {
	// Name - SKU name. Possible values include: 'DevNoSLAStandardD11V2', 'DevNoSLAStandardE2aV4', 'StandardD11V2', 'StandardD12V2', 'StandardD13V2', 'StandardD14V2', 'StandardD32dV4', 'StandardD16dV5', 'StandardD32dV5', 'StandardDS13V21TBPS', 'StandardDS13V22TBPS', 'StandardDS14V23TBPS', 'StandardDS14V24TBPS', 'StandardL4s', 'StandardL8s', 'StandardL16s', 'StandardL8sV2', 'StandardL16sV2', 'StandardE64iV3', 'StandardE80idsV4', 'StandardE2aV4', 'StandardE4aV4', 'StandardE8aV4', 'StandardE16aV4', 'StandardE8asV41TBPS', 'StandardE8asV42TBPS', 'StandardE16asV43TBPS', 'StandardE16asV44TBPS', 'StandardE8asV51TBPS', 'StandardE8asV52TBPS', 'StandardE16asV53TBPS', 'StandardE16asV54TBPS', 'StandardE2adsV5', 'StandardE4adsV5', 'StandardE8adsV5', 'StandardE16adsV5', 'StandardE8sV41TBPS', 'StandardE8sV42TBPS', 'StandardE16sV43TBPS', 'StandardE16sV44TBPS', 'StandardE8sV51TBPS', 'StandardE8sV52TBPS', 'StandardE16sV53TBPS', 'StandardE16sV54TBPS'
...
type ClusterProperties struct {
	...
	// RestrictOutboundNetworkAccess - Whether or not to restrict outbound network access.  Value is optional but if passed in, must be 'Enabled' or 'Disabled'. Possible values include: 'Enabled', 'Disabled'
	...
	// PublicIPType - Indicates what public IP type to create - IPv4 (default), or DualStack (both IPv4 and IPv6). Possible values include: 'IPv4', 'DualStack'
...
type EventGridConnectionProperties struct {
	...
	// DatabaseRouting - Indication for database routing information from the data connection, by default only database routing information is allowed. Possible values include: 'Single', 'Multi'
