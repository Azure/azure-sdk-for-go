...
func (client EnvironmentsClient) Claim(ctx context.Context, resourceGroupName string, labAccountName string, labName string, environmentSettingName string, environmentName string) (result autorest.Response, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.EnvironmentsClient", "Claim", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "ml.EnvironmentsClient", "Claim", resp, "Failure sending request")
		return
	}

	result, err = client.ClaimResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.EnvironmentsClient", "Claim", resp, "Failure responding to request")
	}
...
func (client EnvironmentsClient) CreateOrUpdate(ctx context.Context, resourceGroupName string, labAccountName string, labName string, environmentSettingName string, environmentName string, environment Environment) (result Environment, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewError("ml.EnvironmentsClient", "CreateOrUpdate", err.Error())
	}
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.EnvironmentsClient", "CreateOrUpdate", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "ml.EnvironmentsClient", "CreateOrUpdate", resp, "Failure sending request")
		return
	}

	result, err = client.CreateOrUpdateResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.EnvironmentsClient", "CreateOrUpdate", resp, "Failure responding to request")
	}
...
func (client EnvironmentsClient) Delete(ctx context.Context, resourceGroupName string, labAccountName string, labName string, environmentSettingName string, environmentName string) (result EnvironmentsDeleteFuture, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.EnvironmentsClient", "Delete", nil, "Failure preparing request")
		return
	}

	result, err = client.DeleteSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.EnvironmentsClient", "Delete", result.Response(), "Failure sending request")
		return
	}
...
func (client EnvironmentsClient) Get(ctx context.Context, resourceGroupName string, labAccountName string, labName string, environmentSettingName string, environmentName string, expand string) (result Environment, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.EnvironmentsClient", "Get", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "ml.EnvironmentsClient", "Get", resp, "Failure sending request")
		return
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.EnvironmentsClient", "Get", resp, "Failure responding to request")
	}
...
func (client EnvironmentsClient) List(ctx context.Context, resourceGroupName string, labAccountName string, labName string, environmentSettingName string, expand string, filter string, top *int32, orderby string) (result ResponseWithContinuationEnvironmentPage, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.EnvironmentsClient", "List", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "ml.EnvironmentsClient", "List", resp, "Failure sending request")
		return
	}

	result.rwce, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.EnvironmentsClient", "List", resp, "Failure responding to request")
	}
...
func (client EnvironmentsClient) listNextResults(ctx context.Context, lastResults ResponseWithContinuationEnvironment) (result ResponseWithContinuationEnvironment, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "ml.EnvironmentsClient", "listNextResults", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "ml.EnvironmentsClient", "listNextResults", resp, "Failure sending next results request")
	}
	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.EnvironmentsClient", "listNextResults", resp, "Failure responding to next results request")
	}
	return
}
...
func (client EnvironmentsClient) ResetPassword(ctx context.Context, resourceGroupName string, labAccountName string, labName string, environmentSettingName string, environmentName string, resetPasswordPayload ResetPasswordPayload) (result EnvironmentsResetPasswordFuture, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewError("ml.EnvironmentsClient", "ResetPassword", err.Error())
	}
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.EnvironmentsClient", "ResetPassword", nil, "Failure preparing request")
		return
	}

	result, err = client.ResetPasswordSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.EnvironmentsClient", "ResetPassword", result.Response(), "Failure sending request")
		return
	}
...
func (client EnvironmentsClient) Start(ctx context.Context, resourceGroupName string, labAccountName string, labName string, environmentSettingName string, environmentName string) (result EnvironmentsStartFuture, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.EnvironmentsClient", "Start", nil, "Failure preparing request")
		return
	}

	result, err = client.StartSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.EnvironmentsClient", "Start", result.Response(), "Failure sending request")
		return
	}
...
func (client EnvironmentsClient) Stop(ctx context.Context, resourceGroupName string, labAccountName string, labName string, environmentSettingName string, environmentName string) (result EnvironmentsStopFuture, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.EnvironmentsClient", "Stop", nil, "Failure preparing request")
		return
	}

	result, err = client.StopSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.EnvironmentsClient", "Stop", result.Response(), "Failure sending request")
		return
	}
...
func (client EnvironmentsClient) Update(ctx context.Context, resourceGroupName string, labAccountName string, labName string, environmentSettingName string, environmentName string, environment EnvironmentFragment) (result Environment, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.EnvironmentsClient", "Update", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "ml.EnvironmentsClient", "Update", resp, "Failure sending request")
		return
	}

	result, err = client.UpdateResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.EnvironmentsClient", "Update", resp, "Failure responding to request")
	}
