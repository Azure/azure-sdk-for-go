...
func (client EnvironmentSettingsClient) ClaimAny(ctx context.Context, resourceGroupName string, labAccountName string, labName string, environmentSettingName string) (result autorest.Response, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.EnvironmentSettingsClient", "ClaimAny", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "ml.EnvironmentSettingsClient", "ClaimAny", resp, "Failure sending request")
		return
	}

	result, err = client.ClaimAnyResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.EnvironmentSettingsClient", "ClaimAny", resp, "Failure responding to request")
	}
...
func (client EnvironmentSettingsClient) CreateOrUpdate(ctx context.Context, resourceGroupName string, labAccountName string, labName string, environmentSettingName string, environmentSetting EnvironmentSetting) (result EnvironmentSettingsCreateOrUpdateFuture, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewError("ml.EnvironmentSettingsClient", "CreateOrUpdate", err.Error())
	}
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.EnvironmentSettingsClient", "CreateOrUpdate", nil, "Failure preparing request")
		return
	}

	result, err = client.CreateOrUpdateSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.EnvironmentSettingsClient", "CreateOrUpdate", result.Response(), "Failure sending request")
		return
	}
...
func (client EnvironmentSettingsClient) Delete(ctx context.Context, resourceGroupName string, labAccountName string, labName string, environmentSettingName string) (result EnvironmentSettingsDeleteFuture, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.EnvironmentSettingsClient", "Delete", nil, "Failure preparing request")
		return
	}

	result, err = client.DeleteSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.EnvironmentSettingsClient", "Delete", result.Response(), "Failure sending request")
		return
	}
...
func (client EnvironmentSettingsClient) Get(ctx context.Context, resourceGroupName string, labAccountName string, labName string, environmentSettingName string, expand string) (result EnvironmentSetting, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.EnvironmentSettingsClient", "Get", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "ml.EnvironmentSettingsClient", "Get", resp, "Failure sending request")
		return
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.EnvironmentSettingsClient", "Get", resp, "Failure responding to request")
	}
...
func (client EnvironmentSettingsClient) List(ctx context.Context, resourceGroupName string, labAccountName string, labName string, expand string, filter string, top *int32, orderby string) (result ResponseWithContinuationEnvironmentSettingPage, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.EnvironmentSettingsClient", "List", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "ml.EnvironmentSettingsClient", "List", resp, "Failure sending request")
		return
	}

	result.rwces, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.EnvironmentSettingsClient", "List", resp, "Failure responding to request")
	}
...
func (client EnvironmentSettingsClient) listNextResults(ctx context.Context, lastResults ResponseWithContinuationEnvironmentSetting) (result ResponseWithContinuationEnvironmentSetting, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "ml.EnvironmentSettingsClient", "listNextResults", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "ml.EnvironmentSettingsClient", "listNextResults", resp, "Failure sending next results request")
	}
	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.EnvironmentSettingsClient", "listNextResults", resp, "Failure responding to next results request")
	}
	return
}
...
func (client EnvironmentSettingsClient) Publish(ctx context.Context, resourceGroupName string, labAccountName string, labName string, environmentSettingName string, publishPayload PublishPayload) (result autorest.Response, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.EnvironmentSettingsClient", "Publish", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = resp
		err = autorest.NewErrorWithError(err, "ml.EnvironmentSettingsClient", "Publish", resp, "Failure sending request")
		return
	}

	result, err = client.PublishResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.EnvironmentSettingsClient", "Publish", resp, "Failure responding to request")
	}
...
func (client EnvironmentSettingsClient) Start(ctx context.Context, resourceGroupName string, labAccountName string, labName string, environmentSettingName string) (result EnvironmentSettingsStartFuture, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.EnvironmentSettingsClient", "Start", nil, "Failure preparing request")
		return
	}

	result, err = client.StartSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.EnvironmentSettingsClient", "Start", result.Response(), "Failure sending request")
		return
	}
...
func (client EnvironmentSettingsClient) Stop(ctx context.Context, resourceGroupName string, labAccountName string, labName string, environmentSettingName string) (result EnvironmentSettingsStopFuture, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.EnvironmentSettingsClient", "Stop", nil, "Failure preparing request")
		return
	}

	result, err = client.StopSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.EnvironmentSettingsClient", "Stop", result.Response(), "Failure sending request")
		return
	}
...
func (client EnvironmentSettingsClient) Update(ctx context.Context, resourceGroupName string, labAccountName string, labName string, environmentSettingName string, environmentSetting EnvironmentSettingFragment) (result EnvironmentSetting, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.EnvironmentSettingsClient", "Update", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "ml.EnvironmentSettingsClient", "Update", resp, "Failure sending request")
		return
	}

	result, err = client.UpdateResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.EnvironmentSettingsClient", "Update", resp, "Failure responding to request")
	}
