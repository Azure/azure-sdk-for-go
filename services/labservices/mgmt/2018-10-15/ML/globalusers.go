...
func (client GlobalUsersClient) GetEnvironment(ctx context.Context, userName string, environmentOperationsPayload EnvironmentOperationsPayload, expand string) (result GetEnvironmentResponse, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewError("ml.GlobalUsersClient", "GetEnvironment", err.Error())
	}

	req, err := client.GetEnvironmentPreparer(ctx, userName, environmentOperationsPayload, expand)
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.GlobalUsersClient", "GetEnvironment", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "ml.GlobalUsersClient", "GetEnvironment", resp, "Failure sending request")
		return
	}

	result, err = client.GetEnvironmentResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.GlobalUsersClient", "GetEnvironment", resp, "Failure responding to request")
	}
...
func (client GlobalUsersClient) GetOperationBatchStatus(ctx context.Context, userName string, operationBatchStatusPayload OperationBatchStatusPayload) (result OperationBatchStatusResponse, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewError("ml.GlobalUsersClient", "GetOperationBatchStatus", err.Error())
	}

	req, err := client.GetOperationBatchStatusPreparer(ctx, userName, operationBatchStatusPayload)
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.GlobalUsersClient", "GetOperationBatchStatus", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "ml.GlobalUsersClient", "GetOperationBatchStatus", resp, "Failure sending request")
		return
	}

	result, err = client.GetOperationBatchStatusResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.GlobalUsersClient", "GetOperationBatchStatus", resp, "Failure responding to request")
	}
...
func (client GlobalUsersClient) GetOperationStatus(ctx context.Context, userName string, operationStatusPayload OperationStatusPayload) (result OperationStatusResponse, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewError("ml.GlobalUsersClient", "GetOperationStatus", err.Error())
	}

	req, err := client.GetOperationStatusPreparer(ctx, userName, operationStatusPayload)
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.GlobalUsersClient", "GetOperationStatus", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "ml.GlobalUsersClient", "GetOperationStatus", resp, "Failure sending request")
		return
	}

	result, err = client.GetOperationStatusResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.GlobalUsersClient", "GetOperationStatus", resp, "Failure responding to request")
	}
...
func (client GlobalUsersClient) GetPersonalPreferences(ctx context.Context, userName string, personalPerferencesOperationsPayload PersonalPerferencesOperationsPayload) (result GetPersonalPreferencesResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.GlobalUsersClient", "GetPersonalPreferences", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "ml.GlobalUsersClient", "GetPersonalPreferences", resp, "Failure sending request")
		return
	}

	result, err = client.GetPersonalPreferencesResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.GlobalUsersClient", "GetPersonalPreferences", resp, "Failure responding to request")
	}
...
func (client GlobalUsersClient) ListEnvironments(ctx context.Context, userName string, listEnvironmentsPayload ListEnvironmentsPayload) (result ListEnvironmentsResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.GlobalUsersClient", "ListEnvironments", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "ml.GlobalUsersClient", "ListEnvironments", resp, "Failure sending request")
		return
	}

	result, err = client.ListEnvironmentsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.GlobalUsersClient", "ListEnvironments", resp, "Failure responding to request")
	}
...
func (client GlobalUsersClient) ListLabs(ctx context.Context, userName string) (result ListLabsResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.GlobalUsersClient", "ListLabs", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "ml.GlobalUsersClient", "ListLabs", resp, "Failure sending request")
		return
	}

	result, err = client.ListLabsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.GlobalUsersClient", "ListLabs", resp, "Failure responding to request")
	}
...
func (client GlobalUsersClient) Register(ctx context.Context, userName string, registerPayload RegisterPayload) (result autorest.Response, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.GlobalUsersClient", "Register", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "ml.GlobalUsersClient", "Register", resp, "Failure sending request")
		return
	}

	result, err = client.RegisterResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.GlobalUsersClient", "Register", resp, "Failure responding to request")
	}
...
func (client GlobalUsersClient) ResetPassword(ctx context.Context, userName string, resetPasswordPayload ResetPasswordPayload) (result GlobalUsersResetPasswordFuture, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewError("ml.GlobalUsersClient", "ResetPassword", err.Error())
	}

	req, err := client.ResetPasswordPreparer(ctx, userName, resetPasswordPayload)
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.GlobalUsersClient", "ResetPassword", nil, "Failure preparing request")
		return
	}

	result, err = client.ResetPasswordSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.GlobalUsersClient", "ResetPassword", result.Response(), "Failure sending request")
		return
	}
...
func (client GlobalUsersClient) StartEnvironment(ctx context.Context, userName string, environmentOperationsPayload EnvironmentOperationsPayload) (result GlobalUsersStartEnvironmentFuture, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		{TargetValue: environmentOperationsPayload,
			Constraints: []validation.Constraint{{Target: "environmentOperationsPayload.EnvironmentID", Name: validation.Null, Rule: true, Chain: nil}}}}); err != nil {
		return result, validation.NewError("ml.GlobalUsersClient", "StartEnvironment", err.Error())
	}

	req, err := client.StartEnvironmentPreparer(ctx, userName, environmentOperationsPayload)
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.GlobalUsersClient", "StartEnvironment", nil, "Failure preparing request")
		return
	}

	result, err = client.StartEnvironmentSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.GlobalUsersClient", "StartEnvironment", result.Response(), "Failure sending request")
		return
	}
...
func (client GlobalUsersClient) StopEnvironment(ctx context.Context, userName string, environmentOperationsPayload EnvironmentOperationsPayload) (result GlobalUsersStopEnvironmentFuture, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		{TargetValue: environmentOperationsPayload,
			Constraints: []validation.Constraint{{Target: "environmentOperationsPayload.EnvironmentID", Name: validation.Null, Rule: true, Chain: nil}}}}); err != nil {
		return result, validation.NewError("ml.GlobalUsersClient", "StopEnvironment", err.Error())
	}

	req, err := client.StopEnvironmentPreparer(ctx, userName, environmentOperationsPayload)
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.GlobalUsersClient", "StopEnvironment", nil, "Failure preparing request")
		return
	}

	result, err = client.StopEnvironmentSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.GlobalUsersClient", "StopEnvironment", result.Response(), "Failure sending request")
		return
	}
