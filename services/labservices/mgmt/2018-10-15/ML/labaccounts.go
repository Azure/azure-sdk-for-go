...
func (client LabAccountsClient) CreateLab(ctx context.Context, resourceGroupName string, labAccountName string, createLabProperties CreateLabProperties) (result autorest.Response, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewError("ml.LabAccountsClient", "CreateLab", err.Error())
	}

	req, err := client.CreateLabPreparer(ctx, resourceGroupName, labAccountName, createLabProperties)
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.LabAccountsClient", "CreateLab", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "ml.LabAccountsClient", "CreateLab", resp, "Failure sending request")
		return
	}

	result, err = client.CreateLabResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.LabAccountsClient", "CreateLab", resp, "Failure responding to request")
	}
...
func (client LabAccountsClient) CreateOrUpdate(ctx context.Context, resourceGroupName string, labAccountName string, labAccount LabAccount) (result LabAccount, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.LabAccountsClient", "CreateOrUpdate", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "ml.LabAccountsClient", "CreateOrUpdate", resp, "Failure sending request")
		return
	}

	result, err = client.CreateOrUpdateResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.LabAccountsClient", "CreateOrUpdate", resp, "Failure responding to request")
	}
...
func (client LabAccountsClient) Delete(ctx context.Context, resourceGroupName string, labAccountName string) (result LabAccountsDeleteFuture, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.LabAccountsClient", "Delete", nil, "Failure preparing request")
		return
	}

	result, err = client.DeleteSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.LabAccountsClient", "Delete", result.Response(), "Failure sending request")
		return
	}
...
func (client LabAccountsClient) Get(ctx context.Context, resourceGroupName string, labAccountName string, expand string) (result LabAccount, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.LabAccountsClient", "Get", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "ml.LabAccountsClient", "Get", resp, "Failure sending request")
		return
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.LabAccountsClient", "Get", resp, "Failure responding to request")
	}
...
func (client LabAccountsClient) GetRegionalAvailability(ctx context.Context, resourceGroupName string, labAccountName string) (result GetRegionalAvailabilityResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.LabAccountsClient", "GetRegionalAvailability", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "ml.LabAccountsClient", "GetRegionalAvailability", resp, "Failure sending request")
		return
	}

	result, err = client.GetRegionalAvailabilityResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.LabAccountsClient", "GetRegionalAvailability", resp, "Failure responding to request")
	}
...
func (client LabAccountsClient) ListByResourceGroup(ctx context.Context, resourceGroupName string, expand string, filter string, top *int32, orderby string) (result ResponseWithContinuationLabAccountPage, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.LabAccountsClient", "ListByResourceGroup", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "ml.LabAccountsClient", "ListByResourceGroup", resp, "Failure sending request")
		return
	}

	result.rwcla, err = client.ListByResourceGroupResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.LabAccountsClient", "ListByResourceGroup", resp, "Failure responding to request")
	}
...
func (client LabAccountsClient) listByResourceGroupNextResults(ctx context.Context, lastResults ResponseWithContinuationLabAccount) (result ResponseWithContinuationLabAccount, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "ml.LabAccountsClient", "listByResourceGroupNextResults", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "ml.LabAccountsClient", "listByResourceGroupNextResults", resp, "Failure sending next results request")
	}
	result, err = client.ListByResourceGroupResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.LabAccountsClient", "listByResourceGroupNextResults", resp, "Failure responding to next results request")
	}
	return
}
...
func (client LabAccountsClient) ListBySubscription(ctx context.Context, expand string, filter string, top *int32, orderby string) (result ResponseWithContinuationLabAccountPage, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.LabAccountsClient", "ListBySubscription", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.rwcla.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "ml.LabAccountsClient", "ListBySubscription", resp, "Failure sending request")
		return
	}

	result.rwcla, err = client.ListBySubscriptionResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.LabAccountsClient", "ListBySubscription", resp, "Failure responding to request")
	}
...
func (client LabAccountsClient) listBySubscriptionNextResults(ctx context.Context, lastResults ResponseWithContinuationLabAccount) (result ResponseWithContinuationLabAccount, err error) {
	req, err := lastResults.responseWithContinuationLabAccountPreparer(ctx)
	if err != nil {
		return result, autorest.NewErrorWithError(err, "ml.LabAccountsClient", "listBySubscriptionNextResults", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "ml.LabAccountsClient", "listBySubscriptionNextResults", resp, "Failure sending next results request")
	}
	result, err = client.ListBySubscriptionResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.LabAccountsClient", "listBySubscriptionNextResults", resp, "Failure responding to next results request")
	}
	return
}
...
func (client LabAccountsClient) Update(ctx context.Context, resourceGroupName string, labAccountName string, labAccount LabAccountFragment) (result LabAccount, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.LabAccountsClient", "Update", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "ml.LabAccountsClient", "Update", resp, "Failure sending request")
		return
	}

	result, err = client.UpdateResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.LabAccountsClient", "Update", resp, "Failure responding to request")
	}
