...
func (client LabsClient) AddUsers(ctx context.Context, resourceGroupName string, labAccountName string, labName string, addUsersPayload AddUsersPayload) (result autorest.Response, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewError("ml.LabsClient", "AddUsers", err.Error())
	}

	req, err := client.AddUsersPreparer(ctx, resourceGroupName, labAccountName, labName, addUsersPayload)
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.LabsClient", "AddUsers", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "ml.LabsClient", "AddUsers", resp, "Failure sending request")
		return
	}

	result, err = client.AddUsersResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.LabsClient", "AddUsers", resp, "Failure responding to request")
	}
...
func (client LabsClient) CreateOrUpdate(ctx context.Context, resourceGroupName string, labAccountName string, labName string, lab Lab) (result Lab, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.LabsClient", "CreateOrUpdate", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "ml.LabsClient", "CreateOrUpdate", resp, "Failure sending request")
		return
	}

	result, err = client.CreateOrUpdateResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.LabsClient", "CreateOrUpdate", resp, "Failure responding to request")
	}
...
func (client LabsClient) Delete(ctx context.Context, resourceGroupName string, labAccountName string, labName string) (result LabsDeleteFuture, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.LabsClient", "Delete", nil, "Failure preparing request")
		return
	}

	result, err = client.DeleteSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.LabsClient", "Delete", result.Response(), "Failure sending request")
		return
	}
...
func (client LabsClient) Get(ctx context.Context, resourceGroupName string, labAccountName string, labName string, expand string) (result Lab, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.LabsClient", "Get", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "ml.LabsClient", "Get", resp, "Failure sending request")
		return
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.LabsClient", "Get", resp, "Failure responding to request")
	}
...
func (client LabsClient) List(ctx context.Context, resourceGroupName string, labAccountName string, expand string, filter string, top *int32, orderby string) (result ResponseWithContinuationLabPage, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.LabsClient", "List", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "ml.LabsClient", "List", resp, "Failure sending request")
		return
	}

	result.rwcl, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.LabsClient", "List", resp, "Failure responding to request")
	}
...
func (client LabsClient) listNextResults(ctx context.Context, lastResults ResponseWithContinuationLab) (result ResponseWithContinuationLab, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "ml.LabsClient", "listNextResults", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "ml.LabsClient", "listNextResults", resp, "Failure sending next results request")
	}
	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.LabsClient", "listNextResults", resp, "Failure responding to next results request")
	}
	return
}
...
func (client LabsClient) Register(ctx context.Context, resourceGroupName string, labAccountName string, labName string) (result autorest.Response, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.LabsClient", "Register", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = resp
		err = autorest.NewErrorWithError(err, "ml.LabsClient", "Register", resp, "Failure sending request")
		return
	}

	result, err = client.RegisterResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.LabsClient", "Register", resp, "Failure responding to request")
	}
...
func (client LabsClient) Update(ctx context.Context, resourceGroupName string, labAccountName string, labName string, lab LabFragment) (result Lab, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.LabsClient", "Update", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "ml.LabsClient", "Update", resp, "Failure sending request")
		return
	}

	result, err = client.UpdateResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.LabsClient", "Update", resp, "Failure responding to request")
	}
