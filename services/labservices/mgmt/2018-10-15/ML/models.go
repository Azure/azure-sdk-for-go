...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/labservices/mgmt/2018-10-15/ml"
...
func (future *EnvironmentsDeleteFuture) Result(client EnvironmentsClient) (ar autorest.Response, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.EnvironmentsDeleteFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		err = azure.NewAsyncOpIncompleteError("ml.EnvironmentsDeleteFuture")
		return
	}
...
func (future *EnvironmentSettingsCreateOrUpdateFuture) Result(client EnvironmentSettingsClient) (es EnvironmentSetting, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.EnvironmentSettingsCreateOrUpdateFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		err = azure.NewAsyncOpIncompleteError("ml.EnvironmentSettingsCreateOrUpdateFuture")
		return
	}
	...
	if es.Response.Response, err = future.GetResult(sender); err == nil && es.Response.Response.StatusCode != http.StatusNoContent {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "ml.EnvironmentSettingsCreateOrUpdateFuture", "Result", es.Response.Response, "Failure responding to request")
		}
	}
	return
}
...
func (future *EnvironmentSettingsDeleteFuture) Result(client EnvironmentSettingsClient) (ar autorest.Response, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.EnvironmentSettingsDeleteFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		err = azure.NewAsyncOpIncompleteError("ml.EnvironmentSettingsDeleteFuture")
		return
	}
	ar.Response = future.Response()
	return
...
func (future *EnvironmentSettingsStartFuture) Result(client EnvironmentSettingsClient) (ar autorest.Response, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.EnvironmentSettingsStartFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		err = azure.NewAsyncOpIncompleteError("ml.EnvironmentSettingsStartFuture")
		return
	}
	ar.Response = future.Response()
	return
...
func (future *EnvironmentSettingsStopFuture) Result(client EnvironmentSettingsClient) (ar autorest.Response, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.EnvironmentSettingsStopFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		err = azure.NewAsyncOpIncompleteError("ml.EnvironmentSettingsStopFuture")
		return
	}
	ar.Response = future.Response()
	return
...
func (future *EnvironmentsResetPasswordFuture) Result(client EnvironmentsClient) (ar autorest.Response, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.EnvironmentsResetPasswordFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		err = azure.NewAsyncOpIncompleteError("ml.EnvironmentsResetPasswordFuture")
		return
	}
	ar.Response = future.Response()
	return
...
func (future *EnvironmentsStartFuture) Result(client EnvironmentsClient) (ar autorest.Response, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.EnvironmentsStartFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		err = azure.NewAsyncOpIncompleteError("ml.EnvironmentsStartFuture")
		return
	}
	ar.Response = future.Response()
	return
...
func (future *EnvironmentsStopFuture) Result(client EnvironmentsClient) (ar autorest.Response, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.EnvironmentsStopFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		err = azure.NewAsyncOpIncompleteError("ml.EnvironmentsStopFuture")
		return
	}
	ar.Response = future.Response()
	return
...
func (future *GlobalUsersResetPasswordFuture) Result(client GlobalUsersClient) (ar autorest.Response, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.GlobalUsersResetPasswordFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		err = azure.NewAsyncOpIncompleteError("ml.GlobalUsersResetPasswordFuture")
		return
	}
	ar.Response = future.Response()
	return
...
func (future *GlobalUsersStartEnvironmentFuture) Result(client GlobalUsersClient) (ar autorest.Response, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.GlobalUsersStartEnvironmentFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		err = azure.NewAsyncOpIncompleteError("ml.GlobalUsersStartEnvironmentFuture")
		return
	}
	ar.Response = future.Response()
	return
...
func (future *GlobalUsersStopEnvironmentFuture) Result(client GlobalUsersClient) (ar autorest.Response, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.GlobalUsersStopEnvironmentFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		err = azure.NewAsyncOpIncompleteError("ml.GlobalUsersStopEnvironmentFuture")
		return
	}
	ar.Response = future.Response()
	return
...
func (future *LabAccountsDeleteFuture) Result(client LabAccountsClient) (ar autorest.Response, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.LabAccountsDeleteFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		err = azure.NewAsyncOpIncompleteError("ml.LabAccountsDeleteFuture")
		return
	}
	ar.Response = future.Response()
	return
...
func (future *LabsDeleteFuture) Result(client LabsClient) (ar autorest.Response, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.LabsDeleteFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		err = azure.NewAsyncOpIncompleteError("ml.LabsDeleteFuture")
		return
	}
	ar.Response = future.Response()
	return
...
func (future *UsersDeleteFuture) Result(client UsersClient) (ar autorest.Response, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.UsersDeleteFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		err = azure.NewAsyncOpIncompleteError("ml.UsersDeleteFuture")
		return
	}
	ar.Response = future.Response()
	return
