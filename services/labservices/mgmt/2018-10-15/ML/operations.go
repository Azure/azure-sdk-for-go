...
func (client OperationsClient) Get(ctx context.Context, locationName string, operationName string) (result OperationResult, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.OperationsClient", "Get", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "ml.OperationsClient", "Get", resp, "Failure sending request")
		return
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.OperationsClient", "Get", resp, "Failure responding to request")
	}
