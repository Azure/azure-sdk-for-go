...
func (client UsersClient) CreateOrUpdate(ctx context.Context, resourceGroupName string, labAccountName string, labName string, userName string, userParameter User) (result User, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.UsersClient", "CreateOrUpdate", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "ml.UsersClient", "CreateOrUpdate", resp, "Failure sending request")
		return
	}

	result, err = client.CreateOrUpdateResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.UsersClient", "CreateOrUpdate", resp, "Failure responding to request")
	}
...
func (client UsersClient) Delete(ctx context.Context, resourceGroupName string, labAccountName string, labName string, userName string) (result UsersDeleteFuture, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.UsersClient", "Delete", nil, "Failure preparing request")
		return
	}

	result, err = client.DeleteSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.UsersClient", "Delete", result.Response(), "Failure sending request")
		return
	}
...
func (client UsersClient) Get(ctx context.Context, resourceGroupName string, labAccountName string, labName string, userName string, expand string) (result User, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.UsersClient", "Get", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "ml.UsersClient", "Get", resp, "Failure sending request")
		return
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.UsersClient", "Get", resp, "Failure responding to request")
	}
...
func (client UsersClient) List(ctx context.Context, resourceGroupName string, labAccountName string, labName string, expand string, filter string, top *int32, orderby string) (result ResponseWithContinuationUserPage, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.UsersClient", "List", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "ml.UsersClient", "List", resp, "Failure sending request")
		return
	}

	result.rwcu, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.UsersClient", "List", resp, "Failure responding to request")
	}
...
func (client UsersClient) listNextResults(ctx context.Context, lastResults ResponseWithContinuationUser) (result ResponseWithContinuationUser, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "ml.UsersClient", "listNextResults", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "ml.UsersClient", "listNextResults", resp, "Failure sending next results request")
	}
	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.UsersClient", "listNextResults", resp, "Failure responding to next results request")
	}
	return
}
...
func (client UsersClient) Update(ctx context.Context, resourceGroupName string, labAccountName string, labName string, userName string, userParameter UserFragment) (result User, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.UsersClient", "Update", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "ml.UsersClient", "Update", resp, "Failure sending request")
		return
	}

	result, err = client.UpdateResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "ml.UsersClient", "Update", resp, "Failure responding to request")
	}
