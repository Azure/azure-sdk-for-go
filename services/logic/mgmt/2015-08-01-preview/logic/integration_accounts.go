...
func (client IntegrationAccountsClient) ListCallbackURL(ctx context.Context, resourceGroupName string, integrationAccountName string, parameters ListCallbackURLParameters) (*CallbackURL, error) {
...
func (client IntegrationAccountsClient) listCallbackURLPreparer(resourceGroupName string, integrationAccountName string, parameters ListCallbackURLParameters) (pipeline.Request, error) {
	u := client.url
...
func (client IntegrationAccountsClient) listCallbackURLResponder(resp pipeline.Response) (pipeline.Response, error) {
	err := validateResponse(resp, http.StatusOK)
	if resp == nil {
		return nil, err
	}
