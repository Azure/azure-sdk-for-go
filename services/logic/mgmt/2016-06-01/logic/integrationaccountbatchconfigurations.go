...
// batchConfigurationName is the batch configuration name. assemblyArtifact is the assembly artifact.
...
//
// resourceGroupName is the resource group name. integrationAccountName is the integration account name.
// batchConfigurationName is the batch configuration name.
