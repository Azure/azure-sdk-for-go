...
func NewUsageHistoryClient(p pipeline.Pipeline) UsageHistoryClient {
	return UsageHistoryClient{NewManagementClient(p)}
}
...
func (client UsageHistoryClient) List(ctx context.Context, resourceGroupName string, commitmentPlanName string, skipToken *string) (*PlanUsageHistoryListResult, error) {
	...
	return resp.(*PlanUsageHistoryListResult), err
}

// listPreparer prepares the List request.
func (client UsageHistoryClient) listPreparer(resourceGroupName string, commitmentPlanName string, skipToken *string) (pipeline.Request, error) {
	u := client.url
	u.Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearning/commitmentPlans/{commitmentPlanName}/usageHistory"
...
func (client UsageHistoryClient) listResponder(resp pipeline.Response) (pipeline.Response, error) {
	err := validateResponse(resp, http.StatusOK)
	if resp == nil {
		return nil, err
	}
	result := &PlanUsageHistoryListResult{rawResponse: resp.Response()}
	if err != nil {
		return result, err
	}
