...
func PossibleDatastoreStateValues() []DatastoreState {
	return []DatastoreState{Mounted, MountFailed}
}
...
type AmlInstanceDatastore struct {
	...
	// State - READ-ONLY; Current state of the datastore on the parent AzureML instance. Possible values include: 'Mounted', 'MountFailed'
