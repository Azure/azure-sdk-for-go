...
func (client BatchEndpointsClient) CreateOrUpdate(ctx context.Context, resourceGroupName string, workspaceName string, endpointName string, body BatchEndpointTrackedResource) (result BatchEndpointsCreateOrUpdateFuture, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "machinelearningservices.BatchEndpointsClient", "CreateOrUpdate", result.Response(), "Failure sending request")
		return
	}
...
func (client BatchEndpointsClient) CreateOrUpdatePreparer(ctx context.Context, resourceGroupName string, workspaceName string, endpointName string, body BatchEndpointTrackedResource) (*http.Request, error) {
...
func (client BatchEndpointsClient) CreateOrUpdateSender(req *http.Request) (future BatchEndpointsCreateOrUpdateFuture, err error) {
...
func (client BatchEndpointsClient) Delete(ctx context.Context, resourceGroupName string, workspaceName string, endpointName string) (result BatchEndpointsDeleteFuture, err error) {
	if tracing.IsEnabled() {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "machinelearningservices.BatchEndpointsClient", "Delete", result.Response(), "Failure sending request")
		return
	}
...
func (client BatchEndpointsClient) DeletePreparer(ctx context.Context, resourceGroupName string, workspaceName string, endpointName string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"endpointName":      autorest.Encode("path", endpointName),
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"subscriptionId":    autorest.Encode("path", client.SubscriptionID),
...
// http.Response Body if it receives an error.
func (client BatchEndpointsClient) DeleteSender(req *http.Request) (future BatchEndpointsDeleteFuture, err error) {
	var resp *http.Response
	future.FutureAPI = &azure.Future{}
	resp, err = client.Send(req, azure.DoRetryWithRegistration(client.Client))
	if err != nil {
...
func (client BatchEndpointsClient) Get(ctx context.Context, resourceGroupName string, workspaceName string, endpointName string) (result BatchEndpointTrackedResource, err error) {
	if tracing.IsEnabled() {
...
func (client BatchEndpointsClient) GetPreparer(ctx context.Context, resourceGroupName string, workspaceName string, endpointName string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"endpointName":      autorest.Encode("path", endpointName),
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"subscriptionId":    autorest.Encode("path", client.SubscriptionID),
...
// workspaceName - name of Azure Machine Learning workspace.
// endpointName - inference Endpoint name.
func (client BatchEndpointsClient) ListKeys(ctx context.Context, resourceGroupName string, workspaceName string, endpointName string) (result EndpointAuthKeys, err error) {
	if tracing.IsEnabled() {
...
func (client BatchEndpointsClient) ListKeysPreparer(ctx context.Context, resourceGroupName string, workspaceName string, endpointName string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"endpointName":      autorest.Encode("path", endpointName),
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"subscriptionId":    autorest.Encode("path", client.SubscriptionID),
...
func (client BatchEndpointsClient) Update(ctx context.Context, resourceGroupName string, workspaceName string, endpointName string, body PartialMinimalTrackedResourceWithIdentity) (result BatchEndpointsUpdateFuture, err error) {
	if tracing.IsEnabled() {
	...
	if err := validation.Validate([]validation.Validation{
		...
		{TargetValue: resourceGroupName,
			Constraints: []validation.Constraint{{Target: "resourceGroupName", Name: validation.MaxLength, Rule: 90, Chain: nil},
				{Target: "resourceGroupName", Name: validation.MinLength, Rule: 1, Chain: nil}}},
		{TargetValue: endpointName,
			Constraints: []validation.Constraint{{Target: "endpointName", Name: validation.Pattern, Rule: `^[a-zA-Z0-9][a-zA-Z0-9\-_]{0,254}$`, Chain: nil}}}}); err != nil {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "machinelearningservices.BatchEndpointsClient", "Update", result.Response(), "Failure sending request")
		return
	}
...
func (client BatchEndpointsClient) UpdatePreparer(ctx context.Context, resourceGroupName string, workspaceName string, endpointName string, body PartialMinimalTrackedResourceWithIdentity) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"endpointName":      autorest.Encode("path", endpointName),
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"subscriptionId":    autorest.Encode("path", client.SubscriptionID),
...
// http.Response Body if it receives an error.
func (client BatchEndpointsClient) UpdateSender(req *http.Request) (future BatchEndpointsUpdateFuture, err error) {
	var resp *http.Response
	future.FutureAPI = &azure.Future{}
	resp, err = client.Send(req, azure.DoRetryWithRegistration(client.Client))
	if err != nil {
