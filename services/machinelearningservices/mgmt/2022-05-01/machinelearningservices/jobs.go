...
func (client JobsClient) Cancel(ctx context.Context, resourceGroupName string, workspaceName string, ID string) (result JobsCancelFuture, err error) {
	...
	req, err := client.CancelPreparer(ctx, resourceGroupName, workspaceName, ID)
	if err != nil {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "machinelearningservices.JobsClient", "Cancel", result.Response(), "Failure sending request")
		return
	}
...
func (client JobsClient) CancelPreparer(ctx context.Context, resourceGroupName string, workspaceName string, ID string) (*http.Request, error) {
...
func (client JobsClient) CreateOrUpdate(ctx context.Context, resourceGroupName string, workspaceName string, ID string, body JobBaseResource) (result JobBaseResource, err error) {
	if tracing.IsEnabled() {
	...
	if err := validation.Validate([]validation.Validation{
		...
		{TargetValue: ID,
			Constraints: []validation.Constraint{{Target: "ID", Name: validation.Pattern, Rule: `^[a-zA-Z0-9][a-zA-Z0-9\-_]{0,254}$`, Chain: nil}}}}); err != nil {
		return result, validation.NewError("machinelearningservices.JobsClient", "CreateOrUpdate", err.Error())
	}

	req, err := client.CreateOrUpdatePreparer(ctx, resourceGroupName, workspaceName, ID, body)
	if err != nil {
...
func (client JobsClient) CreateOrUpdatePreparer(ctx context.Context, resourceGroupName string, workspaceName string, ID string, body JobBaseResource) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"id":                autorest.Encode("path", ID),
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"subscriptionId":    autorest.Encode("path", client.SubscriptionID),
...
// workspaceName - name of Azure Machine Learning workspace.
// ID - the name and identifier for the Job. This is case-sensitive.
func (client JobsClient) Delete(ctx context.Context, resourceGroupName string, workspaceName string, ID string) (result JobsDeleteFuture, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.DeletePreparer(ctx, resourceGroupName, workspaceName, ID)
	if err != nil {
...
func (client JobsClient) DeletePreparer(ctx context.Context, resourceGroupName string, workspaceName string, ID string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"id":                autorest.Encode("path", ID),
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"subscriptionId":    autorest.Encode("path", client.SubscriptionID),
...
// workspaceName - name of Azure Machine Learning workspace.
// ID - the name and identifier for the Job. This is case-sensitive.
func (client JobsClient) Get(ctx context.Context, resourceGroupName string, workspaceName string, ID string) (result JobBaseResource, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.GetPreparer(ctx, resourceGroupName, workspaceName, ID)
	if err != nil {
...
func (client JobsClient) GetPreparer(ctx context.Context, resourceGroupName string, workspaceName string, ID string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"id":                autorest.Encode("path", ID),
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"subscriptionId":    autorest.Encode("path", client.SubscriptionID),
...
func (client JobsClient) List(ctx context.Context, resourceGroupName string, workspaceName string, skip string, jobType string, tag string, listViewType ListViewType) (result JobBaseResourceArmPaginatedResultPage, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.ListPreparer(ctx, resourceGroupName, workspaceName, skip, jobType, tag, listViewType)
	if err != nil {
...
func (client JobsClient) ListPreparer(ctx context.Context, resourceGroupName string, workspaceName string, skip string, jobType string, tag string, listViewType ListViewType) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"subscriptionId":    autorest.Encode("path", client.SubscriptionID),
		"workspaceName":     autorest.Encode("path", workspaceName),
...
func (client JobsClient) ListComplete(ctx context.Context, resourceGroupName string, workspaceName string, skip string, jobType string, tag string, listViewType ListViewType) (result JobBaseResourceArmPaginatedResultIterator, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/JobsClient.List")
		defer func() {
			sc := -1
	...
	result.page, err = client.List(ctx, resourceGroupName, workspaceName, skip, jobType, tag, listViewType)
	return
}
