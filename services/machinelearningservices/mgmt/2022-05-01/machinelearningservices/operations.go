...
func (client OperationsClient) List(ctx context.Context) (result AmlOperationListResult, err error) {
...
func (client OperationsClient) ListResponder(resp *http.Response) (result AmlOperationListResult, err error) {
