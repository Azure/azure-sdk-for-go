...
type Account struct {
	...
	// Kind - Get or Set Kind property. Possible values include: 'Gen1', 'Gen2'
...
type Sku struct {
	// Name - The name of the SKU, in standard format (such as S0). Possible values include: 'S0', 'S1', 'G2'
