...
type TopQueryStatisticsClientAPI interface {
	...
	ListByServerComplete(ctx context.Context, resourceGroupName string, serverName string, parameters TopQueryStatisticsInput) (result mariadb.TopQueryStatisticsResultListIterator, err error)
}
...
type WaitStatisticsClientAPI interface {
	...
	ListByServerComplete(ctx context.Context, resourceGroupName string, serverName string, parameters WaitStatisticsInput) (result mariadb.WaitStatisticsResultListIterator, err error)
}
