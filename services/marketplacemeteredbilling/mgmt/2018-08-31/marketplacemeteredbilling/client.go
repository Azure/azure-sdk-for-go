// Package marketplacemeteredbilling implements the Azure ARM Marketplacemeteredbilling service API version 2018-08-31.
//
// REST API for MarketplaceMeteredBilling.
