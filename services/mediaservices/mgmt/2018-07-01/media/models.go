...
type ContentKeyPolicyFairPlayConfiguration struct {
	...
	// OfflineRentalConfiguration - The FairPlay offline rental configuration.
...
// ContentKeyPolicyFairPlayOfflineRentalConfiguration fairPlay Offline rental configuration.
type ContentKeyPolicyFairPlayOfflineRentalConfiguration struct {
	// StorageDurationSeconds - The storage duration. Must be greater than or equal to 0.
	StorageDurationSeconds *int64 `json:"storageDurationSeconds,omitempty"`
	// PlaybackDurationSeconds - The playback duration. Must be greater than or equal to 0.
