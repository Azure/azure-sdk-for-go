...
const (
	...
	OdataTypeBasicContentKeyPolicyPlayReadyContentKeyLocationOdataTypeContentKeyPolicyPlayReadyContentKeyLocation OdataTypeBasicContentKeyPolicyPlayReadyContentKeyLocation = "ContentKeyPolicyPlayReadyContentKeyLocation"
	...
	OdataTypeBasicContentKeyPolicyPlayReadyContentKeyLocationOdataTypeMicrosoftMediaContentKeyPolicyPlayReadyContentEncryptionKeyFromHeader OdataTypeBasicContentKeyPolicyPlayReadyContentKeyLocation = "#Microsoft.Media.ContentKeyPolicyPlayReadyContentEncryptionKeyFromHeader"
	...
	OdataTypeBasicContentKeyPolicyPlayReadyContentKeyLocationOdataTypeMicrosoftMediaContentKeyPolicyPlayReadyContentEncryptionKeyFromKeyIdentifier OdataTypeBasicContentKeyPolicyPlayReadyContentKeyLocation = "#Microsoft.Media.ContentKeyPolicyPlayReadyContentEncryptionKeyFromKeyIdentifier"
)
...
func PossibleOdataTypeBasicContentKeyPolicyPlayReadyContentKeyLocationValues() []OdataTypeBasicContentKeyPolicyPlayReadyContentKeyLocation {
	return []OdataTypeBasicContentKeyPolicyPlayReadyContentKeyLocation{OdataTypeBasicContentKeyPolicyPlayReadyContentKeyLocationOdataTypeContentKeyPolicyPlayReadyContentKeyLocation, OdataTypeBasicContentKeyPolicyPlayReadyContentKeyLocationOdataTypeMicrosoftMediaContentKeyPolicyPlayReadyContentEncryptionKeyFromHeader, OdataTypeBasicContentKeyPolicyPlayReadyContentKeyLocationOdataTypeMicrosoftMediaContentKeyPolicyPlayReadyContentEncryptionKeyFromKeyIdentifier}
}
...
const (
	...
	// StreamOptionsFlagLowLatencyV2 The live event is optimized for end to end latency. This option is only
	// available for encoding live events with RTMP input. The outputs can be streamed using HLS or DASH
	// formats. The outputs' archive or DVR rewind length is limited to 6 hours. Use "LowLatency" stream option
...
func PossibleStreamOptionsFlagValues() []StreamOptionsFlag {
	return []StreamOptionsFlag{StreamOptionsFlagDefault, StreamOptionsFlagLowLatency, StreamOptionsFlagLowLatencyV2}
}
...
func PossibleVisibilityValues() []Visibility {
	return []Visibility{VisibilityHidden, VisibilityVisible}
}
