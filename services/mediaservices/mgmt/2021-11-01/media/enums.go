...
const (
	...
	// Quality Configures the encoder to use settings optimized to produce higher quality output at the expense
	// of slower overall encode time.
	Quality Complexity = "Quality"
	// Speed Configures the encoder to use settings optimized for faster encoding. Quality is sacrificed to
	// decrease encoding time.
	Speed Complexity = "Speed"
)
...
func PossibleComplexityValues() []Complexity {
	return []Complexity{Balanced, Quality, Speed}
}
...
func PossibleH264RateControlModeValues() []H264RateControlMode {
	return []H264RateControlMode{ABR, CBR, CRF}
}
...
const (
	...
	InterleavedOutput InterleaveOutput = "InterleavedOutput"
	// NonInterleavedOutput The output is video-only or audio-only.
	NonInterleavedOutput InterleaveOutput = "NonInterleavedOutput"
)
...
func PossibleInterleaveOutputValues() []InterleaveOutput {
	return []InterleaveOutput{InterleavedOutput, NonInterleavedOutput}
}
...
// OdataTypeBasicContentKeyPolicyPlayReadyContentKeyLocation enumerates the values for odata type basic content
// key policy play ready content key location.
type OdataTypeBasicContentKeyPolicyPlayReadyContentKeyLocation string

const (
	// OdataTypeContentKeyPolicyPlayReadyContentKeyLocation ...
	OdataTypeContentKeyPolicyPlayReadyContentKeyLocation OdataTypeBasicContentKeyPolicyPlayReadyContentKeyLocation = "ContentKeyPolicyPlayReadyContentKeyLocation"
	// OdataTypeMicrosoftMediaContentKeyPolicyPlayReadyContentEncryptionKeyFromHeader ...
	OdataTypeMicrosoftMediaContentKeyPolicyPlayReadyContentEncryptionKeyFromHeader OdataTypeBasicContentKeyPolicyPlayReadyContentKeyLocation = "#Microsoft.Media.ContentKeyPolicyPlayReadyContentEncryptionKeyFromHeader"
	// OdataTypeMicrosoftMediaContentKeyPolicyPlayReadyContentEncryptionKeyFromKeyIdentifier ...
	OdataTypeMicrosoftMediaContentKeyPolicyPlayReadyContentEncryptionKeyFromKeyIdentifier OdataTypeBasicContentKeyPolicyPlayReadyContentKeyLocation = "#Microsoft.Media.ContentKeyPolicyPlayReadyContentEncryptionKeyFromKeyIdentifier"
)

// PossibleOdataTypeBasicContentKeyPolicyPlayReadyContentKeyLocationValues returns an array of possible values for the OdataTypeBasicContentKeyPolicyPlayReadyContentKeyLocation const type.
func PossibleOdataTypeBasicContentKeyPolicyPlayReadyContentKeyLocationValues() []OdataTypeBasicContentKeyPolicyPlayReadyContentKeyLocation {
	return []OdataTypeBasicContentKeyPolicyPlayReadyContentKeyLocation{OdataTypeContentKeyPolicyPlayReadyContentKeyLocation, OdataTypeMicrosoftMediaContentKeyPolicyPlayReadyContentEncryptionKeyFromHeader, OdataTypeMicrosoftMediaContentKeyPolicyPlayReadyContentEncryptionKeyFromKeyIdentifier}
}
...
func PossibleProvisioningStateValues() []ProvisioningState {
	return []ProvisioningState{Failed, InProgress, Succeeded}
}
...
const (
	...
	// LowLatencyV2 The live event is optimized for end to end latency. This option is only available for
	// encoding live events with RTMP input. The outputs can be streamed using HLS or DASH formats. The
	// outputs' archive or DVR rewind length is limited to 6 hours. Use "LowLatency" stream option for all
	// other scenarios.
	LowLatencyV2 StreamOptionsFlag = "LowLatencyV2"
)
...
func PossibleStreamOptionsFlagValues() []StreamOptionsFlag {
	return []StreamOptionsFlag{Default, LowLatency, LowLatencyV2}
}
