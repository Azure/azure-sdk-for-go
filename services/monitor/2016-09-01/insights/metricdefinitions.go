...
// MetricDefinitionsClient is the monitor Client
...
//
// resourceURI is the identifier of the resource. filter is reduces the set of data collected by retrieving particular
// metric definitions from all the definitions available for the resource.<br>For example, to get just the definition
// for the 'CPU percentage' counter: $filter=name.value eq '\Processor(_Total)\% Processor Time'.<br>Multiple metrics
// can be retrieved by joining together *'name eq <value>'* clauses separated by *or* logical operators.<br>**NOTE**:
