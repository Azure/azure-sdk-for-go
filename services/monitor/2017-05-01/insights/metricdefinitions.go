...
func (client MetricDefinitionsClient) List(resourceURI string) (result MetricDefinitionCollection, err error) {
...
func (client MetricDefinitionsClient) ListPreparer(resourceURI string) (*http.Request, error) {
