...
// MetadataValue is represents a metric metadata value.
type MetadataValue struct {
	Name  *LocalizableString `json:"name,omitempty"`
	Value *string            `json:"value,omitempty"`
}

// Metric is the result data of a query.
type Metric struct {
	ID         *string              `json:"id,omitempty"`
...
// Response is the response to a metrics query.
...
// TimeSeriesElement is a time series result type. The discriminator value is always TimeSeries in this case.
