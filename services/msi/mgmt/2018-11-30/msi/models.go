...
type IdentityProperties struct {
	...
	// ClientSecretURL -  The ManagedServiceIdentity DataPlane URL that can be queried to obtain the identity credentials. If identity is user assigned identity, the value of clientSecretUrl is null. If identity is system assigned or proxy resource, the clientSecretUrl is not null.
