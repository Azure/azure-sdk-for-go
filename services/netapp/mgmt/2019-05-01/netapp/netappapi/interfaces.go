...
type AccountsClientAPI interface {
	CreateOrUpdate(ctx context.Context, body netapp.Account) (result netapp.AccountsCreateOrUpdateFuture, err error)
	Delete(ctx context.Context) (result netapp.AccountsDeleteFuture, err error)
	...
	Update(ctx context.Context, body netapp.AccountPatch) (result netapp.Account, err error)
}
...
type PoolsClientAPI interface {
	CreateOrUpdate(ctx context.Context, body netapp.CapacityPool) (result netapp.PoolsCreateOrUpdateFuture, err error)
	Delete(ctx context.Context) (result netapp.PoolsDeleteFuture, err error)
	...
	Update(ctx context.Context, body netapp.CapacityPoolPatch) (result netapp.CapacityPool, err error)
}
...
type VolumesClientAPI interface {
	CreateOrUpdate(ctx context.Context, body netapp.Volume) (result netapp.VolumesCreateOrUpdateFuture, err error)
	Delete(ctx context.Context) (result netapp.VolumesDeleteFuture, err error)
	...
	Update(ctx context.Context, body netapp.VolumePatch) (result netapp.Volume, err error)
}
...
type SnapshotsClientAPI interface {
	Create(ctx context.Context, body netapp.Snapshot) (result netapp.SnapshotsCreateFuture, err error)
	Delete(ctx context.Context) (result netapp.SnapshotsDeleteFuture, err error)
	...
	Update(ctx context.Context, body netapp.SnapshotPatch) (result netapp.Snapshot, err error)
}
