...
type ActiveDirectory struct {
	...
	// AllowLocalNfsFSUsersWithLdap -  If enabled, NFS client local users can also (in addition to LDAP users) access the NFS volumes.
	AllowLocalNfsFSUsersWithLdap *bool `json:"allowLocalNfsFSUsersWithLdap,omitempty"`
}
...
func (ad ActiveDirectory) MarshalJSON() ([]byte, error) {
	...
	if ad.AllowLocalNfsFSUsersWithLdap != nil {
		objectMap["allowLocalNfsFSUsersWithLdap"] = ad.AllowLocalNfsFSUsersWithLdap
	}
	return json.Marshal(objectMap)
}
