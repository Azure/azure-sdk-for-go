...
type PoolProperties struct {
	...
	// Size - Provisioned size of the pool (in bytes). Allowed values are in 4TiB chunks (value must be multiply of 4398046511104).
	Size *int64 `json:"size,omitempty"`
	// ServiceLevel - Possible values include: 'Standard', 'Premium', 'Ultra', 'StandardZRS'
...
type VolumePatchProperties struct {
	...
	// DefaultUserQuotaInKiBs - Default user quota for volume in KiBs. Minimum 4 KiBs.
	DefaultUserQuotaInKiBs *int64 `json:"defaultUserQuotaInKiBs,omitempty"`
	// DefaultGroupQuotaInKiBs - Default group quota for volume in KiBs. Minimum 4 KiBs.
