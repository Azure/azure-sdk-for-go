...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/netapp/mgmt/2022-01-01/netapp"
...
type VolumeProperties struct {
	...
	ThroughputMibps          *float64 `json:"throughputMibps,omitempty"`
	// EncryptionKeySource - Source of key used to encrypt data in volume. Possible values (case-insensitive) are: 'Microsoft.NetApp'. Possible values include: 'MicrosoftNetApp'
	...
	// Encrypted - READ-ONLY; Specifies if the volume is encrypted or not. Only available on volumes created or updated after 2022-01-01.
...
type VolumeQuotaRule struct {
	...
	*VolumeQuotaRulesProperties `json:"properties,omitempty"`
	// Tags - Resource tags.
	Tags map[string]*string `json:"tags"`
	// Location - The geo-location where the resource lives
	Location *string `json:"location,omitempty"`
...
// MarshalJSON is the custom marshaler for VolumeQuotaRule.
func (vqr VolumeQuotaRule) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if vqr.VolumeQuotaRulesProperties != nil {
		objectMap["properties"] = vqr.VolumeQuotaRulesProperties
	}
	if vqr.Tags != nil {
		objectMap["tags"] = vqr.Tags
	}
	if vqr.Location != nil {
		objectMap["location"] = vqr.Location
	}
	return json.Marshal(objectMap)
}

// UnmarshalJSON is the custom unmarshaler for VolumeQuotaRule struct.
func (vqr *VolumeQuotaRule) UnmarshalJSON(body []byte) error {
	var m map[string]*json.RawMessage
	err := json.Unmarshal(body, &m)
	if err != nil {
		return err
	...
	for k, v := range m {
		...
		case "properties":
			if v != nil {
				var volumeQuotaRulesProperties VolumeQuotaRulesProperties
				err = json.Unmarshal(*v, &volumeQuotaRulesProperties)
				if err != nil {
					return err
				}
				vqr.VolumeQuotaRulesProperties = &volumeQuotaRulesProperties
			}
		case "tags":
			if v != nil {
				var tags map[string]*string
...
// MarshalJSON is the custom marshaler for VolumeQuotaRulePatch.
func (vqrp VolumeQuotaRulePatch) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if vqrp.VolumeQuotaRulesProperties != nil {
		objectMap["properties"] = vqrp.VolumeQuotaRulesProperties
	}
	return json.Marshal(objectMap)
}

// UnmarshalJSON is the custom unmarshaler for VolumeQuotaRulePatch struct.
func (vqrp *VolumeQuotaRulePatch) UnmarshalJSON(body []byte) error {
	var m map[string]*json.RawMessage
	err := json.Unmarshal(body, &m)
	if err != nil {
		return err
	...
	for k, v := range m {
		...
		case "properties":
			if v != nil {
				...
				vqrp.VolumeQuotaRulesProperties = &volumeQuotaRulesProperties
			}
		}
	}
...
// VolumeQuotaRulesCreateFuture an abstraction for monitoring and retrieving the results of a long-running
// operation.
type VolumeQuotaRulesCreateFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(VolumeQuotaRulesClient) (VolumeQuotaRule, error)
}

// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *VolumeQuotaRulesCreateFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for VolumeQuotaRulesCreateFuture.Result.
func (future *VolumeQuotaRulesCreateFuture) result(client VolumeQuotaRulesClient) (vqr VolumeQuotaRule, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "netapp.VolumeQuotaRulesCreateFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		vqr.Response.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("netapp.VolumeQuotaRulesCreateFuture")
		return
	}
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if vqr.Response.Response, err = future.GetResult(sender); err == nil && vqr.Response.Response.StatusCode != http.StatusNoContent {
		vqr, err = client.CreateResponder(vqr.Response.Response)
		if err != nil {
			err = autorest.NewErrorWithError(err, "netapp.VolumeQuotaRulesCreateFuture", "Result", vqr.Response.Response, "Failure responding to request")
		}
	}
	return
}

// VolumeQuotaRulesDeleteFuture an abstraction for monitoring and retrieving the results of a long-running
// operation.
type VolumeQuotaRulesDeleteFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(VolumeQuotaRulesClient) (autorest.Response, error)
}

// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *VolumeQuotaRulesDeleteFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for VolumeQuotaRulesDeleteFuture.Result.
func (future *VolumeQuotaRulesDeleteFuture) result(client VolumeQuotaRulesClient) (ar autorest.Response, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "netapp.VolumeQuotaRulesDeleteFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		ar.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("netapp.VolumeQuotaRulesDeleteFuture")
		return
	}
	ar.Response = future.Response()
	return
...
type VolumeQuotaRulesList struct {
	autorest.Response `json:"-"`
	// Value - A list of Volume Quota Rules
	Value *[]VolumeQuotaRule `json:"value,omitempty"`
}

// VolumeQuotaRulesProperties volume Quota Rule properties
type VolumeQuotaRulesProperties struct {
	// ProvisioningState - Possible values include: 'Accepted', 'Creating', 'Patching', 'Deleting', 'Moving', 'Failed', 'Succeeded'
	ProvisioningState ProvisioningState `json:"provisioningState,omitempty"`
	// QuotaSizeInKiBs - Size of quota
	QuotaSizeInKiBs *int64 `json:"quotaSizeInKiBs,omitempty"`
	// QuotaType - Type of quota. Possible values include: 'DefaultUserQuota', 'DefaultGroupQuota', 'IndividualUserQuota', 'IndividualGroupQuota'
...
// VolumeQuotaRulesUpdateFuture an abstraction for monitoring and retrieving the results of a long-running
// operation.
type VolumeQuotaRulesUpdateFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(VolumeQuotaRulesClient) (VolumeQuotaRule, error)
...
// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *VolumeQuotaRulesUpdateFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for VolumeQuotaRulesUpdateFuture.Result.
func (future *VolumeQuotaRulesUpdateFuture) result(client VolumeQuotaRulesClient) (vqr VolumeQuotaRule, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "netapp.VolumeQuotaRulesUpdateFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		vqr.Response.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("netapp.VolumeQuotaRulesUpdateFuture")
		return
	}
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if vqr.Response.Response, err = future.GetResult(sender); err == nil && vqr.Response.Response.StatusCode != http.StatusNoContent {
		vqr, err = client.UpdateResponder(vqr.Response.Response)
		if err != nil {
			err = autorest.NewErrorWithError(err, "netapp.VolumeQuotaRulesUpdateFuture", "Result", vqr.Response.Response, "Failure responding to request")
		}
	}
	return
}
...
type VolumeRelocationProperties struct {
	// OldVolumeID - The id of the old volume that is being relocated
	OldVolumeID *string `json:"oldVolumeId,omitempty"`
	// OldBareMetalTenantID - The id of the bare metal tenant owned by the existing volume
...
// VolumesFinalizeRelocationFuture an abstraction for monitoring and retrieving the results of a
// long-running operation.
type VolumesFinalizeRelocationFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(VolumesClient) (autorest.Response, error)
...
// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *VolumesFinalizeRelocationFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for VolumesFinalizeRelocationFuture.Result.
func (future *VolumesFinalizeRelocationFuture) result(client VolumesClient) (ar autorest.Response, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "netapp.VolumesFinalizeRelocationFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		ar.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("netapp.VolumesFinalizeRelocationFuture")
		return
	}
	ar.Response = future.Response()
	return
...
// VolumesRelocateFuture an abstraction for monitoring and retrieving the results of a long-running
// operation.
type VolumesRelocateFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(VolumesClient) (autorest.Response, error)
...
// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *VolumesRelocateFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for VolumesRelocateFuture.Result.
func (future *VolumesRelocateFuture) result(client VolumesClient) (ar autorest.Response, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "netapp.VolumesRelocateFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		ar.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("netapp.VolumesRelocateFuture")
		return
	}
	ar.Response = future.Response()
	return
...
// VolumesResetCifsPasswordFuture an abstraction for monitoring and retrieving the results of a
// long-running operation.
type VolumesResetCifsPasswordFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(VolumesClient) (autorest.Response, error)
...
// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *VolumesResetCifsPasswordFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for VolumesResetCifsPasswordFuture.Result.
func (future *VolumesResetCifsPasswordFuture) result(client VolumesClient) (ar autorest.Response, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "netapp.VolumesResetCifsPasswordFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		ar.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("netapp.VolumesResetCifsPasswordFuture")
		return
	}
	ar.Response = future.Response()
	return
...
// VolumesRevertRelocationFuture an abstraction for monitoring and retrieving the results of a long-running
// operation.
type VolumesRevertRelocationFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(VolumesClient) (autorest.Response, error)
...
// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *VolumesRevertRelocationFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for VolumesRevertRelocationFuture.Result.
func (future *VolumesRevertRelocationFuture) result(client VolumesClient) (ar autorest.Response, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "netapp.VolumesRevertRelocationFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		ar.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("netapp.VolumesRevertRelocationFuture")
		return
	}
	ar.Response = future.Response()
	return
