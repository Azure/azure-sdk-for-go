...
import (
	"context"
	"github.com/Azure/azure-sdk-for-go/services/netapp/mgmt/2022-01-01/netapp"
)
...
type VolumesClientAPI interface {
	...
	FinalizeRelocation(ctx context.Context, resourceGroupName string, accountName string, poolName string, volumeName string) (result netapp.VolumesFinalizeRelocationFuture, err error)
	...
	ListReplicationsMethod(ctx context.Context, resourceGroupName string, accountName string, poolName string, volumeName string) (result netapp.ListReplications, err error)
	...
	Relocate(ctx context.Context, resourceGroupName string, accountName string, poolName string, volumeName string) (result netapp.VolumesRelocateFuture, err error)
	...
	ResetCifsPassword(ctx context.Context, resourceGroupName string, accountName string, poolName string, volumeName string) (result netapp.VolumesResetCifsPasswordFuture, err error)
	...
	RevertRelocation(ctx context.Context, resourceGroupName string, accountName string, poolName string, volumeName string) (result netapp.VolumesRevertRelocationFuture, err error)
...
// VolumeQuotaRulesClientAPI contains the set of methods on the VolumeQuotaRulesClient type.
type VolumeQuotaRulesClientAPI interface {
	Create(ctx context.Context, body netapp.VolumeQuotaRule, resourceGroupName string, accountName string, poolName string, volumeName string, volumeQuotaRuleName string) (result netapp.VolumeQuotaRulesCreateFuture, err error)
	Delete(ctx context.Context, resourceGroupName string, accountName string, poolName string, volumeName string, volumeQuotaRuleName string) (result netapp.VolumeQuotaRulesDeleteFuture, err error)
	Get(ctx context.Context, resourceGroupName string, accountName string, poolName string, volumeName string, volumeQuotaRuleName string) (result netapp.VolumeQuotaRule, err error)
	ListByVolume(ctx context.Context, resourceGroupName string, accountName string, poolName string, volumeName string) (result netapp.VolumeQuotaRulesList, err error)
	Update(ctx context.Context, body netapp.VolumeQuotaRulePatch, resourceGroupName string, accountName string, poolName string, volumeName string, volumeQuotaRuleName string) (result netapp.VolumeQuotaRulesUpdateFuture, err error)
}

var _ VolumeQuotaRulesClientAPI = (*netapp.VolumeQuotaRulesClient)(nil)
