...
type ApplicationGatewayPropertiesFormat struct {
	...
	// GatewayIPConfigurations - Gets or sets subnets of application gateway resource. For default limits, see [Application Gateway limits](https://docs.microsoft.com/azure/azure-subscription-service-limits#application-gateway-limits).
