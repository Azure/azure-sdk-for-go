...
// CreateOrUpdate the Put RouteTable operation creates/updates a route tablein the specified resource group. This
...
// Delete the Delete RouteTable operation deletes the specifed Route Table This method may poll for completion. Polling
