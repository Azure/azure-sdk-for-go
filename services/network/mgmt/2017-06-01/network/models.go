...
func PossibleExpressRouteCircuitSkuTierValues() [3]ExpressRouteCircuitSkuTier {
	return [3]ExpressRouteCircuitSkuTier{ExpressRouteCircuitSkuTierPremium, ExpressRouteCircuitSkuTierStandard, ExpressRouteCircuitSkuTierTransport}
}
