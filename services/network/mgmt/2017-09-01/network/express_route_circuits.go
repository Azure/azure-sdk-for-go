...
func (client ExpressRouteCircuitsClient) UpdateTags(ctx context.Context, resourceGroupName string, circuitName string, parameters TagsObject) (*ExpressRouteCircuit, error) {
	req, err := client.updateTagsPreparer(resourceGroupName, circuitName, parameters)
	if err != nil {
		return nil, err
	}
...
func (client ExpressRouteCircuitsClient) updateTagsPreparer(resourceGroupName string, circuitName string, parameters TagsObject) (pipeline.Request, error) {
	u := client.url
	u.Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/expressRouteCircuits/{circuitName}"
...
func (client ExpressRouteCircuitsClient) updateTagsResponder(resp pipeline.Response) (pipeline.Response, error) {
	err := validateResponse(resp, http.StatusOK)
	if resp == nil {
		return nil, err
	}
