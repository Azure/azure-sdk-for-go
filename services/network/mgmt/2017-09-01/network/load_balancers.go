...
func (client LoadBalancersClient) UpdateTags(ctx context.Context, resourceGroupName string, loadBalancerName string, parameters TagsObject) (*LoadBalancer, error) {
	req, err := client.updateTagsPreparer(resourceGroupName, loadBalancerName, parameters)
	if err != nil {
		return nil, err
	}
...
func (client LoadBalancersClient) updateTagsPreparer(resourceGroupName string, loadBalancerName string, parameters TagsObject) (pipeline.Request, error) {
	u := client.url
	u.Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/loadBalancers/{loadBalancerName}"
...
func (client LoadBalancersClient) updateTagsResponder(resp pipeline.Response) (pipeline.Response, error) {
	err := validateResponse(resp, http.StatusOK)
	if resp == nil {
		return nil, err
	}
