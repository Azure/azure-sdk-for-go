...
func (client RouteTablesClient) UpdateTags(ctx context.Context, resourceGroupName string, routeTableName string, parameters TagsObject) (*RouteTable, error) {
	req, err := client.updateTagsPreparer(resourceGroupName, routeTableName, parameters)
	if err != nil {
		return nil, err
	}
...
func (client RouteTablesClient) updateTagsPreparer(resourceGroupName string, routeTableName string, parameters TagsObject) (pipeline.Request, error) {
	u := client.url
	u.Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/routeTables/{routeTableName}"
...
func (client RouteTablesClient) updateTagsResponder(resp pipeline.Response) (pipeline.Response, error) {
	err := validateResponse(resp, http.StatusOK)
	if resp == nil {
		return nil, err
	}
