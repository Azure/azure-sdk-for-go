...
func (client SecurityGroupsClient) UpdateTags(ctx context.Context, resourceGroupName string, networkSecurityGroupName string, parameters TagsObject) (*SecurityGroup, error) {
	req, err := client.updateTagsPreparer(resourceGroupName, networkSecurityGroupName, parameters)
	if err != nil {
		return nil, err
	}
...
func (client SecurityGroupsClient) updateTagsPreparer(resourceGroupName string, networkSecurityGroupName string, parameters TagsObject) (pipeline.Request, error) {
	u := client.url
	u.Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkSecurityGroups/{networkSecurityGroupName}"
...
func (client SecurityGroupsClient) updateTagsResponder(resp pipeline.Response) (pipeline.Response, error) {
	err := validateResponse(resp, http.StatusOK)
	if resp == nil {
		return nil, err
	}
