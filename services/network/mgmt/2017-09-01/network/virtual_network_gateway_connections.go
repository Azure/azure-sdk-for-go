...
func (client VirtualNetworkGatewayConnectionsClient) UpdateTags(ctx context.Context, resourceGroupName string, virtualNetworkGatewayConnectionName string, parameters TagsObject) (*VirtualNetworkGatewayConnectionListEntity, error) {
	req, err := client.updateTagsPreparer(resourceGroupName, virtualNetworkGatewayConnectionName, parameters)
	if err != nil {
		return nil, err
	}
	...
	return resp.(*VirtualNetworkGatewayConnectionListEntity), err
}

// updateTagsPreparer prepares the UpdateTags request.
func (client VirtualNetworkGatewayConnectionsClient) updateTagsPreparer(resourceGroupName string, virtualNetworkGatewayConnectionName string, parameters TagsObject) (pipeline.Request, error) {
	u := client.url
	u.Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/connections/{virtualNetworkGatewayConnectionName}"
...
func (client VirtualNetworkGatewayConnectionsClient) updateTagsResponder(resp pipeline.Response) (pipeline.Response, error) {
	err := validateResponse(resp, http.StatusOK)
	if resp == nil {
		return nil, err
	}
	result := &VirtualNetworkGatewayConnectionListEntity{rawResponse: resp.Response()}
	if err != nil {
		return result, err
	}
	defer resp.Response().Body.Close()
