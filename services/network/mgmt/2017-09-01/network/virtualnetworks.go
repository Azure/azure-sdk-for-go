...
func (client VirtualNetworksClient) UpdateTags(resourceGroupName string, virtualNetworkName string, parameters TagsObject, cancel <-chan struct{}) (<-chan VirtualNetwork, <-chan error) {
	resultChan := make(chan VirtualNetwork, 1)
	errChan := make(chan error, 1)
	go func() {
		var err error
		...
		req, err := client.UpdateTagsPreparer(resourceGroupName, virtualNetworkName, parameters, cancel)
		if err != nil {
...
func (client VirtualNetworksClient) UpdateTagsPreparer(resourceGroupName string, virtualNetworkName string, parameters TagsObject, cancel <-chan struct{}) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"resourceGroupName":  autorest.Encode("path", resourceGroupName),
		"subscriptionId":     autorest.Encode("path", client.SubscriptionID),
		"virtualNetworkName": autorest.Encode("path", virtualNetworkName),
