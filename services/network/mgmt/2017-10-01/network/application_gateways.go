...
func (client ApplicationGatewaysClient) BackendHealth(ctx context.Context, resourceGroupName string, applicationGatewayName string, expand *string) (*ApplicationGatewayBackendHealth, error) {
	req, err := client.backendHealthPreparer(resourceGroupName, applicationGatewayName, expand)
	if err != nil {
		return nil, err
	}
	resp, err := client.Pipeline().Do(ctx, responderPolicyFactory{responder: client.backendHealthResponder}, req)
	if err != nil {
		return nil, err
	}
	return resp.(*ApplicationGatewayBackendHealth), err
}

// backendHealthPreparer prepares the BackendHealth request.
func (client ApplicationGatewaysClient) backendHealthPreparer(resourceGroupName string, applicationGatewayName string, expand *string) (pipeline.Request, error) {
	u := client.url
	u.Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/applicationGateways/{applicationGatewayName}/backendhealth"
...
// backendHealthResponder handles the response to the BackendHealth request.
func (client ApplicationGatewaysClient) backendHealthResponder(resp pipeline.Response) (pipeline.Response, error) {
	err := validateResponse(resp, http.StatusOK, http.StatusAccepted)
	if resp == nil {
		return nil, err
	}
	result := &ApplicationGatewayBackendHealth{rawResponse: resp.Response()}
	if err != nil {
		return result, err
	}
...
func (client ApplicationGatewaysClient) CreateOrUpdate(ctx context.Context, resourceGroupName string, applicationGatewayName string, parameters ApplicationGateway) (*ApplicationGateway, error) {
	if err := validate([]validation{
		{targetValue: parameters,
			constraints: []constraint{{target: "parameters.ApplicationGatewayPropertiesFormat", name: null, rule: false,
				chain: []constraint{{target: "parameters.ApplicationGatewayPropertiesFormat.WebApplicationFirewallConfiguration", name: null, rule: false,
					chain: []constraint{{target: "parameters.ApplicationGatewayPropertiesFormat.WebApplicationFirewallConfiguration.Enabled", name: null, rule: true, chain: nil},
						{target: "parameters.ApplicationGatewayPropertiesFormat.WebApplicationFirewallConfiguration.RuleSetType", name: null, rule: true, chain: nil},
						{target: "parameters.ApplicationGatewayPropertiesFormat.WebApplicationFirewallConfiguration.RuleSetVersion", name: null, rule: true, chain: nil},
					}},
				}}}}}); err != nil {
		return nil, err
	}
...
func (client ApplicationGatewaysClient) GetSslPredefinedPolicy(ctx context.Context, predefinedPolicyName string) (*ApplicationGatewaySslPredefinedPolicy, error) {
	req, err := client.getSslPredefinedPolicyPreparer(predefinedPolicyName)
	if err != nil {
		return nil, err
	}
	resp, err := client.Pipeline().Do(ctx, responderPolicyFactory{responder: client.getSslPredefinedPolicyResponder}, req)
	if err != nil {
		return nil, err
	}
	return resp.(*ApplicationGatewaySslPredefinedPolicy), err
}

// getSslPredefinedPolicyPreparer prepares the GetSslPredefinedPolicy request.
func (client ApplicationGatewaysClient) getSslPredefinedPolicyPreparer(predefinedPolicyName string) (pipeline.Request, error) {
	u := client.url
	u.Path = "/subscriptions/{subscriptionId}/providers/Microsoft.Network/applicationGatewayAvailableSslOptions/default/predefinedPolicies/{predefinedPolicyName}"
	req, err := pipeline.NewRequest("GET", u, nil)
	if err != nil {
		return req, pipeline.NewError(err, "failed to create request")
	}
...
// getSslPredefinedPolicyResponder handles the response to the GetSslPredefinedPolicy request.
func (client ApplicationGatewaysClient) getSslPredefinedPolicyResponder(resp pipeline.Response) (pipeline.Response, error) {
	err := validateResponse(resp, http.StatusOK)
	if resp == nil {
		return nil, err
	}
	result := &ApplicationGatewaySslPredefinedPolicy{rawResponse: resp.Response()}
	if err != nil {
		return result, err
	}
	defer resp.Response().Body.Close()
...
func (client ApplicationGatewaysClient) ListAvailableSslOptions(ctx context.Context) (*ApplicationGatewayAvailableSslOptions, error) {
	req, err := client.listAvailableSslOptionsPreparer()
	if err != nil {
		return nil, err
	}
	resp, err := client.Pipeline().Do(ctx, responderPolicyFactory{responder: client.listAvailableSslOptionsResponder}, req)
	if err != nil {
		return nil, err
	}
	return resp.(*ApplicationGatewayAvailableSslOptions), err
}

// listAvailableSslOptionsPreparer prepares the ListAvailableSslOptions request.
func (client ApplicationGatewaysClient) listAvailableSslOptionsPreparer() (pipeline.Request, error) {
	u := client.url
	u.Path = "/subscriptions/{subscriptionId}/providers/Microsoft.Network/applicationGatewayAvailableSslOptions/default"
	req, err := pipeline.NewRequest("GET", u, nil)
	if err != nil {
		return req, pipeline.NewError(err, "failed to create request")
	}
...
// listAvailableSslOptionsResponder handles the response to the ListAvailableSslOptions request.
func (client ApplicationGatewaysClient) listAvailableSslOptionsResponder(resp pipeline.Response) (pipeline.Response, error) {
	err := validateResponse(resp, http.StatusOK)
	if resp == nil {
		return nil, err
	}
	result := &ApplicationGatewayAvailableSslOptions{rawResponse: resp.Response()}
	if err != nil {
		return result, err
	}
	defer resp.Response().Body.Close()
...
func (client ApplicationGatewaysClient) ListAvailableSslPredefinedPolicies(ctx context.Context) (*ApplicationGatewayAvailableSslPredefinedPolicies, error) {
	req, err := client.listAvailableSslPredefinedPoliciesPreparer()
	if err != nil {
		return nil, err
	}
	resp, err := client.Pipeline().Do(ctx, responderPolicyFactory{responder: client.listAvailableSslPredefinedPoliciesResponder}, req)
	if err != nil {
		return nil, err
	}
	return resp.(*ApplicationGatewayAvailableSslPredefinedPolicies), err
}

// listAvailableSslPredefinedPoliciesPreparer prepares the ListAvailableSslPredefinedPolicies request.
func (client ApplicationGatewaysClient) listAvailableSslPredefinedPoliciesPreparer() (pipeline.Request, error) {
	u := client.url
	u.Path = "/subscriptions/{subscriptionId}/providers/Microsoft.Network/applicationGatewayAvailableSslOptions/default/predefinedPolicies"
	req, err := pipeline.NewRequest("GET", u, nil)
	if err != nil {
		return req, pipeline.NewError(err, "failed to create request")
	}
...
// listAvailableSslPredefinedPoliciesResponder handles the response to the ListAvailableSslPredefinedPolicies request.
func (client ApplicationGatewaysClient) listAvailableSslPredefinedPoliciesResponder(resp pipeline.Response) (pipeline.Response, error) {
	err := validateResponse(resp, http.StatusOK)
	if resp == nil {
		return nil, err
	}
	result := &ApplicationGatewayAvailableSslPredefinedPolicies{rawResponse: resp.Response()}
	if err != nil {
		return result, err
	}
	defer resp.Response().Body.Close()
...
func (client ApplicationGatewaysClient) ListAvailableWafRuleSets(ctx context.Context) (*ApplicationGatewayAvailableWafRuleSetsResult, error) {
	req, err := client.listAvailableWafRuleSetsPreparer()
	if err != nil {
		return nil, err
	}
	resp, err := client.Pipeline().Do(ctx, responderPolicyFactory{responder: client.listAvailableWafRuleSetsResponder}, req)
	if err != nil {
		return nil, err
	}
	return resp.(*ApplicationGatewayAvailableWafRuleSetsResult), err
}

// listAvailableWafRuleSetsPreparer prepares the ListAvailableWafRuleSets request.
func (client ApplicationGatewaysClient) listAvailableWafRuleSetsPreparer() (pipeline.Request, error) {
	u := client.url
	u.Path = "/subscriptions/{subscriptionId}/providers/Microsoft.Network/applicationGatewayAvailableWafRuleSets"
	req, err := pipeline.NewRequest("GET", u, nil)
	if err != nil {
		return req, pipeline.NewError(err, "failed to create request")
	}
...
// listAvailableWafRuleSetsResponder handles the response to the ListAvailableWafRuleSets request.
func (client ApplicationGatewaysClient) listAvailableWafRuleSetsResponder(resp pipeline.Response) (pipeline.Response, error) {
	err := validateResponse(resp, http.StatusOK)
	if resp == nil {
		return nil, err
	}
	result := &ApplicationGatewayAvailableWafRuleSetsResult{rawResponse: resp.Response()}
	if err != nil {
		return result, err
	}
	defer resp.Response().Body.Close()
...
func (client ApplicationGatewaysClient) UpdateTags(ctx context.Context, resourceGroupName string, applicationGatewayName string, parameters TagsObject) (*ApplicationGateway, error) {
	req, err := client.updateTagsPreparer(resourceGroupName, applicationGatewayName, parameters)
	if err != nil {
		return nil, err
	}
...
func (client ApplicationGatewaysClient) updateTagsPreparer(resourceGroupName string, applicationGatewayName string, parameters TagsObject) (pipeline.Request, error) {
	u := client.url
	u.Path = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/applicationGateways/{applicationGatewayName}"
...
func (client ApplicationGatewaysClient) updateTagsResponder(resp pipeline.Response) (pipeline.Response, error) {
	err := validateResponse(resp, http.StatusOK)
	if resp == nil {
		return nil, err
	}
