...
func (client ExpressRouteCircuitPeeringsClient) CreateOrUpdate(ctx context.Context, resourceGroupName string, circuitName string, peeringName string, peeringParameters ExpressRouteCircuitPeering) (*ExpressRouteCircuitPeering, error) {
	if err := validate([]validation{
		{targetValue: peeringParameters,
			constraints: []constraint{{target: "peeringParameters.ExpressRouteCircuitPeeringPropertiesFormat", name: null, rule: false,
				chain: []constraint{{target: "peeringParameters.ExpressRouteCircuitPeeringPropertiesFormat.PeerASN", name: null, rule: false,
					chain: []constraint{{target: "peeringParameters.ExpressRouteCircuitPeeringPropertiesFormat.PeerASN", name: inclusiveMaximum, rule: 4294967295, chain: nil},
						{target: "peeringParameters.ExpressRouteCircuitPeeringPropertiesFormat.PeerASN", name: inclusiveMinimum, rule: 1, chain: nil},
					}},
				}}}}}); err != nil {
		return nil, err
	}
