...
// MarshalXML implements the xml.Marshaler interface for ConnectionMonitorResultProperties.
func (cmrp ConnectionMonitorResultProperties) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	if reflect.TypeOf((*ConnectionMonitorResultProperties)(nil)).Elem().Size() != reflect.TypeOf((*connectionMonitorResultProperties)(nil)).Elem().Size() {
		panic("size mismatch between ConnectionMonitorResultProperties and connectionMonitorResultProperties")
	}
	cmrp2 := (*connectionMonitorResultProperties)(unsafe.Pointer(&cmrp))
	return e.EncodeElement(*cmrp2, start)
}

// UnmarshalXML implements the xml.Unmarshaler interface for ConnectionMonitorResultProperties.
func (cmrp *ConnectionMonitorResultProperties) UnmarshalXML(d *xml.Decoder, start xml.StartElement) error {
	if reflect.TypeOf((*ConnectionMonitorResultProperties)(nil)).Elem().Size() != reflect.TypeOf((*connectionMonitorResultProperties)(nil)).Elem().Size() {
		panic("size mismatch between ConnectionMonitorResultProperties and connectionMonitorResultProperties")
	}
	cmrp2 := (*connectionMonitorResultProperties)(unsafe.Pointer(cmrp))
	return d.DecodeElement(cmrp2, &start)
}
...
// MarshalXML implements the xml.Marshaler interface for ConnectionStateSnapshot.
func (CSS ConnectionStateSnapshot) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	if reflect.TypeOf((*ConnectionStateSnapshot)(nil)).Elem().Size() != reflect.TypeOf((*connectionStateSnapshot)(nil)).Elem().Size() {
		panic("size mismatch between ConnectionStateSnapshot and connectionStateSnapshot")
	}
	CSS2 := (*connectionStateSnapshot)(unsafe.Pointer(&CSS))
	return e.EncodeElement(*CSS2, start)
}

// UnmarshalXML implements the xml.Unmarshaler interface for ConnectionStateSnapshot.
func (CSS *ConnectionStateSnapshot) UnmarshalXML(d *xml.Decoder, start xml.StartElement) error {
	if reflect.TypeOf((*ConnectionStateSnapshot)(nil)).Elem().Size() != reflect.TypeOf((*connectionStateSnapshot)(nil)).Elem().Size() {
		panic("size mismatch between ConnectionStateSnapshot and connectionStateSnapshot")
	}
	CSS2 := (*connectionStateSnapshot)(unsafe.Pointer(CSS))
	return d.DecodeElement(CSS2, &start)
}
