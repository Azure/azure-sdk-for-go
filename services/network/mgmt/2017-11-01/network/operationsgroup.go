...
// OperationsGroupClient is the network Client
...
func (client OperationsGroupClient) List(ctx context.Context) (result OperationListResultPage, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "network.OperationsGroupClient", "List", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "network.OperationsGroupClient", "List", resp, "Failure sending request")
		return
	}

	result.olr, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "network.OperationsGroupClient", "List", resp, "Failure responding to request")
	}
...
func (client OperationsGroupClient) listNextResults(lastResults OperationListResult) (result OperationListResult, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "network.OperationsGroupClient", "listNextResults", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "network.OperationsGroupClient", "listNextResults", resp, "Failure sending next results request")
	}
	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "network.OperationsGroupClient", "listNextResults", resp, "Failure responding to next results request")
	}
	return
}
