...
func (client ExpressRouteLinksClient) listNextResults(lastResults ExpressRouteLinkListResult) (result ExpressRouteLinkListResult, err error) {
	req, err := lastResults.expressRouteLinkListResultPreparer()
	if err != nil {
