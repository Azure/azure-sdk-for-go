...
func (client ExpressRoutePortsClient) listNextResults(lastResults ExpressRoutePortListResult) (result ExpressRoutePortListResult, err error) {
	req, err := lastResults.expressRoutePortListResultPreparer()
	if err != nil {
...
func (client ExpressRoutePortsClient) listByResourceGroupNextResults(lastResults ExpressRoutePortListResult) (result ExpressRoutePortListResult, err error) {
	req, err := lastResults.expressRoutePortListResultPreparer()
	if err != nil {
