...
func (client ExpressRoutePortsLocationsClient) listNextResults(lastResults ExpressRoutePortsLocationListResult) (result ExpressRoutePortsLocationListResult, err error) {
	req, err := lastResults.expressRoutePortsLocationListResultPreparer()
	if err != nil {
