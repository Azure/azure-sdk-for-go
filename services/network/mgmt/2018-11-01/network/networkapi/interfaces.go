...
type ApplicationGatewaysClientAPI interface {
	...
	ListAvailableRequestHeaders(ctx context.Context) (result network.ApplicationGatewayAvailableRequestHeadersResult, err error)
	ListAvailableResponseHeaders(ctx context.Context) (result network.ApplicationGatewayAvailableResponseHeadersResult, err error)
	ListAvailableServerVariables(ctx context.Context) (result network.ApplicationGatewayAvailableServerVariablesResult, err error)
