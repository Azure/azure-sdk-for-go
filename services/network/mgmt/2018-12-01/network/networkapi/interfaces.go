...
type DdosProtectionPlansClientAPI interface {
	...
	Update(ctx context.Context, resourceGroupName string, ddosProtectionPlanName string, parameters network.TagsObject) (result network.DdosProtectionPlansUpdateFuture, err error)
}
