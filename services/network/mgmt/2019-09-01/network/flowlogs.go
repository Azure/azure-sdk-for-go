...
// NewFlowLogsClientWithBaseURI creates an instance of the FlowLogsClient client.
...
func (client FlowLogsClient) List(ctx context.Context, resourceGroupName string, networkWatcherName string) (result FlowLogListResult, err error) {
	if tracing.IsEnabled() {
