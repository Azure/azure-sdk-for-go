...
type VirtualNetworkGatewaysClientAPI interface {
	...
	Disconnectvirtualnetworkgatewayvpnconnections(ctx context.Context, resourceGroupName string, gatewayName string, request network.P2SVpnConnectionRequest) (result network.VirtualNetworkGatewaysDisconnectvirtualnetworkgatewayvpnconnectionsFuture, err error)
...
type P2sVpnGatewaysClientAPI interface {
	...
	DisconnectP2sVpnConnections(ctx context.Context, resourceGroupName string, gatewayName string, request network.P2SVpnConnectionRequest) (result network.P2sVpnGatewaysDisconnectP2sVpnConnectionsFuture, err error)
