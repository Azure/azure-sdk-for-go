...
// request - request parameters supplied to disconnect vpn connections.
func (client VirtualNetworkGatewaysClient) Disconnectvirtualnetworkgatewayvpnconnections(ctx context.Context, resourceGroupName string, gatewayName string, request P2SVpnConnectionRequest) (result VirtualNetworkGatewaysDisconnectvirtualnetworkgatewayvpnconnectionsFuture, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.DisconnectvirtualnetworkgatewayvpnconnectionsPreparer(ctx, resourceGroupName, gatewayName, request)
	if err != nil {
...
func (client VirtualNetworkGatewaysClient) DisconnectvirtualnetworkgatewayvpnconnectionsPreparer(ctx context.Context, resourceGroupName string, gatewayName string, request P2SVpnConnectionRequest) (*http.Request, error) {
	pathParameters := map[string]interface{}{
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.AsPost(),
		autorest.WithBaseURL(client.BaseURI),
		autorest.WithPathParameters("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualNetworkGateways/{gatewayName}/disconnectvirtualnetworkgatewayvpnconnections", pathParameters),
