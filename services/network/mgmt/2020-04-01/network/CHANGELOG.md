Generated from https://github.com/Azure/azure-rest-api-specs/tree/3c764635e7d442b3e74caf593029fcd440b3ef82/specification/network/resource-manager/readme.md tag: `package-2020-04`
...
1. *HubRouteTablesCreateOrUpdateFuture.Result(HubRouteTablesClient) (HubRouteTable, error)
1. *HubRouteTablesDeleteFuture.Result(HubRouteTablesClient) (autorest.Response, error)
...
1. *LoadBalancerBackendAddressPoolsCreateOrUpdateFuture.Result(LoadBalancerBackendAddressPoolsClient) (BackendAddressPool, error)
1. *LoadBalancerBackendAddressPoolsDeleteFuture.Result(LoadBalancerBackendAddressPoolsClient) (autorest.Response, error)
...
1. HubRouteTablesCreateOrUpdateFuture.azure.Future
1. HubRouteTablesDeleteFuture.azure.Future
...
1. LoadBalancerBackendAddressPoolsCreateOrUpdateFuture.azure.Future
1. LoadBalancerBackendAddressPoolsDeleteFuture.azure.Future
...
1. HubRouteTablesCreateOrUpdateFuture.Result
1. HubRouteTablesCreateOrUpdateFuture.azure.FutureAPI
1. HubRouteTablesDeleteFuture.Result
1. HubRouteTablesDeleteFuture.azure.FutureAPI
...
1. LoadBalancerBackendAddressPoolsCreateOrUpdateFuture.Result
1. LoadBalancerBackendAddressPoolsCreateOrUpdateFuture.azure.FutureAPI
1. LoadBalancerBackendAddressPoolsDeleteFuture.Result
1. LoadBalancerBackendAddressPoolsDeleteFuture.azure.FutureAPI
...
1. SecurityPartnerProvidersCreateOrUpdateFuture.azure.FutureAPI
