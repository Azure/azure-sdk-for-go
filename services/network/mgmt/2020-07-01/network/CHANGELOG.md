Generated from https://github.com/Azure/azure-rest-api-specs/tree/3a3a9452f965a227ce43e6b545035b99dd175f23/specification/network/resource-manager/readme.md tag: `package-2020-07`
...
1. *ApplicationGatewayPrivateEndpointConnectionsDeleteFuture.Result(ApplicationGatewayPrivateEndpointConnectionsClient) (autorest.Response, error)
1. *ApplicationGatewayPrivateEndpointConnectionsUpdateFuture.Result(ApplicationGatewayPrivateEndpointConnectionsClient) (ApplicationGatewayPrivateEndpointConnection, error)
...
1. *CustomIPPrefixesCreateOrUpdateFuture.Result(CustomIPPrefixesClient) (CustomIPPrefix, error)
1. *CustomIPPrefixesDeleteFuture.Result(CustomIPPrefixesClient) (autorest.Response, error)
...
1. *DscpConfigurationCreateOrUpdateFuture.Result(DscpConfigurationClient) (DscpConfiguration, error)
1. *DscpConfigurationDeleteFuture.Result(DscpConfigurationClient) (autorest.Response, error)
...
1. *FirewallPolicyRuleCollectionGroupsCreateOrUpdateFuture.Result(FirewallPolicyRuleCollectionGroupsClient) (FirewallPolicyRuleCollectionGroup, error)
1. *FirewallPolicyRuleCollectionGroupsDeleteFuture.Result(FirewallPolicyRuleCollectionGroupsClient) (autorest.Response, error)
...
1. *HubVirtualNetworkConnectionsCreateOrUpdateFuture.Result(HubVirtualNetworkConnectionsClient) (HubVirtualNetworkConnection, error)
1. *HubVirtualNetworkConnectionsDeleteFuture.Result(HubVirtualNetworkConnectionsClient) (autorest.Response, error)
...
1. *InboundSecurityRuleCreateOrUpdateFuture.Result(InboundSecurityRuleClient) (InboundSecurityRule, error)
...
1. *P2SVpnGatewaysResetFuture.Result(P2sVpnGatewaysClient) (P2SVpnGateway, error)
...
1. *VirtualApplianceSitesCreateOrUpdateFuture.Result(VirtualApplianceSitesClient) (VirtualApplianceSite, error)
1. *VirtualApplianceSitesDeleteFuture.Result(VirtualApplianceSitesClient) (autorest.Response, error)
...
1. *VirtualHubBgpConnectionCreateOrUpdateFuture.Result(VirtualHubBgpConnectionClient) (BgpConnection, error)
1. *VirtualHubBgpConnectionDeleteFuture.Result(VirtualHubBgpConnectionClient) (autorest.Response, error)
1. *VirtualHubBgpConnectionsListAdvertisedRoutesFuture.Result(VirtualHubBgpConnectionsClient) (PeerRouteList, error)
1. *VirtualHubBgpConnectionsListLearnedRoutesFuture.Result(VirtualHubBgpConnectionsClient) (PeerRouteList, error)
1. *VirtualHubIPConfigurationCreateOrUpdateFuture.Result(VirtualHubIPConfigurationClient) (HubIPConfiguration, error)
1. *VirtualHubIPConfigurationDeleteFuture.Result(VirtualHubIPConfigurationClient) (autorest.Response, error)
...
1. *VirtualHubsGetEffectiveVirtualHubRoutesFuture.Result(VirtualHubsClient) (autorest.Response, error)
...
1. *VpnConnectionsStartPacketCaptureFuture.Result(VpnConnectionsClient) (String, error)
1. *VpnConnectionsStopPacketCaptureFuture.Result(VpnConnectionsClient) (String, error)
...
1. *VpnGatewaysStartPacketCaptureFuture.Result(VpnGatewaysClient) (String, error)
1. *VpnGatewaysStopPacketCaptureFuture.Result(VpnGatewaysClient) (String, error)
...
1. ApplicationGatewayPrivateEndpointConnectionsDeleteFuture.azure.Future
1. ApplicationGatewayPrivateEndpointConnectionsUpdateFuture.azure.Future
...
1. CustomIPPrefixesCreateOrUpdateFuture.azure.Future
1. CustomIPPrefixesDeleteFuture.azure.Future
...
1. DscpConfigurationCreateOrUpdateFuture.azure.Future
1. DscpConfigurationDeleteFuture.azure.Future
...
1. FirewallPolicyRuleCollectionGroupsCreateOrUpdateFuture.azure.Future
1. FirewallPolicyRuleCollectionGroupsDeleteFuture.azure.Future
...
1. HubVirtualNetworkConnectionsCreateOrUpdateFuture.azure.Future
1. HubVirtualNetworkConnectionsDeleteFuture.azure.Future
...
1. InboundSecurityRuleCreateOrUpdateFuture.azure.Future
...
1. P2SVpnGatewaysResetFuture.azure.Future
...
1. VirtualApplianceSitesCreateOrUpdateFuture.azure.Future
1. VirtualApplianceSitesDeleteFuture.azure.Future
1. VirtualAppliancesCreateOrUpdateFuture.azure.Future
1. VirtualAppliancesDeleteFuture.azure.Future
1. VirtualHubBgpConnectionCreateOrUpdateFuture.azure.Future
1. VirtualHubBgpConnectionDeleteFuture.azure.Future
1. VirtualHubBgpConnectionsListAdvertisedRoutesFuture.azure.Future
1. VirtualHubBgpConnectionsListLearnedRoutesFuture.azure.Future
1. VirtualHubIPConfigurationCreateOrUpdateFuture.azure.Future
1. VirtualHubIPConfigurationDeleteFuture.azure.Future
...
1. VirtualHubsGetEffectiveVirtualHubRoutesFuture.azure.Future
...
1. VpnConnectionsStartPacketCaptureFuture.azure.Future
1. VpnConnectionsStopPacketCaptureFuture.azure.Future
...
1. VpnGatewaysStartPacketCaptureFuture.azure.Future
1. VpnGatewaysStopPacketCaptureFuture.azure.Future
...
1. ApplicationGatewayPrivateEndpointConnectionsDeleteFuture.Result
1. ApplicationGatewayPrivateEndpointConnectionsDeleteFuture.azure.FutureAPI
1. ApplicationGatewayPrivateEndpointConnectionsUpdateFuture.Result
1. ApplicationGatewayPrivateEndpointConnectionsUpdateFuture.azure.FutureAPI
...
1. CustomIPPrefixesCreateOrUpdateFuture.Result
1. CustomIPPrefixesCreateOrUpdateFuture.azure.FutureAPI
1. CustomIPPrefixesDeleteFuture.Result
1. CustomIPPrefixesDeleteFuture.azure.FutureAPI
...
1. DscpConfigurationCreateOrUpdateFuture.Result
1. DscpConfigurationCreateOrUpdateFuture.azure.FutureAPI
1. DscpConfigurationDeleteFuture.Result
1. DscpConfigurationDeleteFuture.azure.FutureAPI
...
1. FirewallPolicyRuleCollectionGroupsCreateOrUpdateFuture.Result
1. FirewallPolicyRuleCollectionGroupsCreateOrUpdateFuture.azure.FutureAPI
1. FirewallPolicyRuleCollectionGroupsDeleteFuture.Result
1. FirewallPolicyRuleCollectionGroupsDeleteFuture.azure.FutureAPI
...
1. HubVirtualNetworkConnectionsCreateOrUpdateFuture.Result
1. HubVirtualNetworkConnectionsCreateOrUpdateFuture.azure.FutureAPI
1. HubVirtualNetworkConnectionsDeleteFuture.Result
1. HubVirtualNetworkConnectionsDeleteFuture.azure.FutureAPI
...
1. InboundSecurityRuleCreateOrUpdateFuture.Result
1. InboundSecurityRuleCreateOrUpdateFuture.azure.FutureAPI
...
1. P2SVpnGatewaysResetFuture.Result
1. P2SVpnGatewaysResetFuture.azure.FutureAPI
...
1. VirtualApplianceSitesCreateOrUpdateFuture.Result
1. VirtualApplianceSitesCreateOrUpdateFuture.azure.FutureAPI
1. VirtualApplianceSitesDeleteFuture.Result
1. VirtualApplianceSitesDeleteFuture.azure.FutureAPI
...
1. VirtualHubBgpConnectionCreateOrUpdateFuture.Result
1. VirtualHubBgpConnectionCreateOrUpdateFuture.azure.FutureAPI
1. VirtualHubBgpConnectionDeleteFuture.Result
1. VirtualHubBgpConnectionDeleteFuture.azure.FutureAPI
1. VirtualHubBgpConnectionsListAdvertisedRoutesFuture.Result
1. VirtualHubBgpConnectionsListAdvertisedRoutesFuture.azure.FutureAPI
1. VirtualHubBgpConnectionsListLearnedRoutesFuture.Result
1. VirtualHubBgpConnectionsListLearnedRoutesFuture.azure.FutureAPI
1. VirtualHubIPConfigurationCreateOrUpdateFuture.Result
1. VirtualHubIPConfigurationCreateOrUpdateFuture.azure.FutureAPI
1. VirtualHubIPConfigurationDeleteFuture.Result
1. VirtualHubIPConfigurationDeleteFuture.azure.FutureAPI
...
1. VirtualHubsGetEffectiveVirtualHubRoutesFuture.Result
1. VirtualHubsGetEffectiveVirtualHubRoutesFuture.azure.FutureAPI
...
1. VpnConnectionsStartPacketCaptureFuture.Result
1. VpnConnectionsStartPacketCaptureFuture.azure.FutureAPI
1. VpnConnectionsStopPacketCaptureFuture.Result
1. VpnConnectionsStopPacketCaptureFuture.azure.FutureAPI
...
1. VpnGatewaysStartPacketCaptureFuture.Result
1. VpnGatewaysStartPacketCaptureFuture.azure.FutureAPI
1. VpnGatewaysStopPacketCaptureFuture.Result
1. VpnGatewaysStopPacketCaptureFuture.azure.FutureAPI
