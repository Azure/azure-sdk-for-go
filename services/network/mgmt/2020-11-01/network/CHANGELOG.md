...
1. *ExpressRouteGatewaysUpdateTagsFuture.UnmarshalJSON([]byte) error
...
1. *NatRulesCreateOrUpdateFuture.UnmarshalJSON([]byte) error
1. *NatRulesDeleteFuture.UnmarshalJSON([]byte) error
...
1. *VirtualNetworkGatewayConnectionsGetIkeSasFuture.UnmarshalJSON([]byte) error
1. *VirtualNetworkGatewayConnectionsResetConnectionFuture.UnmarshalJSON([]byte) error
...
1. *VpnLinkConnectionsGetIkeSasFuture.UnmarshalJSON([]byte) error
1. *VpnLinkConnectionsResetConnectionFuture.UnmarshalJSON([]byte) error
