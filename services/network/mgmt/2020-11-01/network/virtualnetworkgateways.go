		...
		{TargetValue: parameters,
			Constraints: []validation.Constraint{{Target: "parameters.VirtualNetworkGatewayPropertiesFormat", Name: validation.Null, Rule: true,
				Chain: []validation.Constraint{{Target: "parameters.VirtualNetworkGatewayPropertiesFormat.BgpSettings", Name: validation.Null, Rule: false,
					...
					{Target: "parameters.VirtualNetworkGatewayPropertiesFormat.VirtualNetworkExtendedLocation", Name: validation.Null, Rule: false,
						Chain: []validation.Constraint{{Target: "parameters.VirtualNetworkGatewayPropertiesFormat.VirtualNetworkExtendedLocation.Name", Name: validation.Null, Rule: true, Chain: nil},
							{Target: "parameters.VirtualNetworkGatewayPropertiesFormat.VirtualNetworkExtendedLocation.Type", Name: validation.Null, Rule: true, Chain: nil},
						}},
				}}}}}); err != nil {
