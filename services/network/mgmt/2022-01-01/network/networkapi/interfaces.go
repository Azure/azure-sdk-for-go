...
type BaseClientAPI interface {
	...
	ListActiveConnectivityConfigurations(ctx context.Context, parameters network.ActiveConfigurationParameter, resourceGroupName string, networkManagerName string) (result network.ActiveConnectivityConfigurationsListResult, err error)
	ListActiveSecurityAdminRules(ctx context.Context, parameters network.ActiveConfigurationParameter, resourceGroupName string, networkManagerName string) (result network.ActiveSecurityAdminRulesListResult, err error)
	ListNetworkManagerEffectiveConnectivityConfigurations(ctx context.Context, parameters network.QueryRequestOptions, resourceGroupName string, virtualNetworkName string) (result network.ManagerEffectiveConnectivityConfigurationListResult, err error)
	ListNetworkManagerEffectiveSecurityAdminRules(ctx context.Context, parameters network.QueryRequestOptions, resourceGroupName string, virtualNetworkName string) (result network.ManagerEffectiveSecurityAdminRulesListResult, err error)
...
type ManagerDeploymentStatusClientAPI interface {
	List(ctx context.Context, parameters network.ManagerDeploymentStatusParameter, resourceGroupName string, networkManagerName string) (result network.ManagerDeploymentStatusListResult, err error)
}
