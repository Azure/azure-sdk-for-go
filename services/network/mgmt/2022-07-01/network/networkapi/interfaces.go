...
type BaseClientAPI interface {
	...
	ListActiveConnectivityConfigurations(ctx context.Context, parameters network.ActiveConfigurationParameter, resourceGroupName string, networkManagerName string, top *int32) (result network.ActiveConnectivityConfigurationsListResult, err error)
	ListActiveSecurityAdminRules(ctx context.Context, parameters network.ActiveConfigurationParameter, resourceGroupName string, networkManagerName string, top *int32) (result network.ActiveSecurityAdminRulesListResult, err error)
	ListNetworkManagerEffectiveConnectivityConfigurations(ctx context.Context, parameters network.QueryRequestOptions, resourceGroupName string, virtualNetworkName string, top *int32) (result network.ManagerEffectiveConnectivityConfigurationListResult, err error)
	ListNetworkManagerEffectiveSecurityAdminRules(ctx context.Context, parameters network.QueryRequestOptions, resourceGroupName string, virtualNetworkName string, top *int32) (result network.ManagerEffectiveSecurityAdminRulesListResult, err error)
...
// ApplicationGatewayWafDynamicManifestsDefaultClientAPI contains the set of methods on the ApplicationGatewayWafDynamicManifestsDefaultClient type.
type ApplicationGatewayWafDynamicManifestsDefaultClientAPI interface {
	Get(ctx context.Context, location string) (result network.ApplicationGatewayWafDynamicManifestResult, err error)
}

var _ ApplicationGatewayWafDynamicManifestsDefaultClientAPI = (*network.ApplicationGatewayWafDynamicManifestsDefaultClient)(nil)

// ApplicationGatewayWafDynamicManifestsClientAPI contains the set of methods on the ApplicationGatewayWafDynamicManifestsClient type.
type ApplicationGatewayWafDynamicManifestsClientAPI interface {
	Get(ctx context.Context, location string) (result network.ApplicationGatewayWafDynamicManifestResultListPage, err error)
	GetComplete(ctx context.Context, location string) (result network.ApplicationGatewayWafDynamicManifestResultListIterator, err error)
}

var _ ApplicationGatewayWafDynamicManifestsClientAPI = (*network.ApplicationGatewayWafDynamicManifestsClient)(nil)
...
type PublicIPAddressesClientAPI interface {
	...
	DdosProtectionStatus(ctx context.Context, resourceGroupName string, publicIPAddressName string) (result network.PublicIPAddressesDdosProtectionStatusFuture, err error)
...
// VipSwapClientAPI contains the set of methods on the VipSwapClient type.
type VipSwapClientAPI interface {
	Create(ctx context.Context, groupName string, resourceName string, parameters network.SwapResource) (result network.VipSwapCreateFuture, err error)
	Get(ctx context.Context, groupName string, resourceName string) (result network.SwapResource, err error)
	List(ctx context.Context, groupName string, resourceName string) (result network.SwapResourceListResult, err error)
}

var _ VipSwapClientAPI = (*network.VipSwapClient)(nil)
...
// ExpressRoutePortAuthorizationsClientAPI contains the set of methods on the ExpressRoutePortAuthorizationsClient type.
type ExpressRoutePortAuthorizationsClientAPI interface {
	CreateOrUpdate(ctx context.Context, resourceGroupName string, expressRoutePortName string, authorizationName string, authorizationParameters network.ExpressRoutePortAuthorization) (result network.ExpressRoutePortAuthorizationsCreateOrUpdateFuture, err error)
	Delete(ctx context.Context, resourceGroupName string, expressRoutePortName string, authorizationName string) (result network.ExpressRoutePortAuthorizationsDeleteFuture, err error)
	Get(ctx context.Context, resourceGroupName string, expressRoutePortName string, authorizationName string) (result network.ExpressRoutePortAuthorization, err error)
	List(ctx context.Context, resourceGroupName string, expressRoutePortName string) (result network.ExpressRoutePortAuthorizationListResultPage, err error)
	ListComplete(ctx context.Context, resourceGroupName string, expressRoutePortName string) (result network.ExpressRoutePortAuthorizationListResultIterator, err error)
}

var _ ExpressRoutePortAuthorizationsClientAPI = (*network.ExpressRoutePortAuthorizationsClient)(nil)
...
type FirewallPoliciesClientAPI interface {
	...
	UpdateTags(ctx context.Context, resourceGroupName string, firewallPolicyName string, parameters network.TagsObject) (result network.FirewallPolicy, err error)
}
...
type ManagersClientAPI interface {
	...
	Delete(ctx context.Context, resourceGroupName string, networkManagerName string, force *bool) (result network.ManagersDeleteFuture, err error)
	Get(ctx context.Context, resourceGroupName string, networkManagerName string) (result network.Manager, err error)
	List(ctx context.Context, resourceGroupName string, top *int32, skipToken string) (result network.ManagerListResultPage, err error)
	ListComplete(ctx context.Context, resourceGroupName string, top *int32, skipToken string) (result network.ManagerListResultIterator, err error)
	ListBySubscription(ctx context.Context, top *int32, skipToken string) (result network.ManagerListResultPage, err error)
	ListBySubscriptionComplete(ctx context.Context, top *int32, skipToken string) (result network.ManagerListResultIterator, err error)
	Patch(ctx context.Context, parameters network.PatchObject, resourceGroupName string, networkManagerName string) (result network.Manager, err error)
}

var _ ManagersClientAPI = (*network.ManagersClient)(nil)

// ManagerCommitsClientAPI contains the set of methods on the ManagerCommitsClient type.
type ManagerCommitsClientAPI interface {
	Post(ctx context.Context, parameters network.ManagerCommit, resourceGroupName string, networkManagerName string) (result network.ManagerCommitsPostFuture, err error)
}

var _ ManagerCommitsClientAPI = (*network.ManagerCommitsClient)(nil)

// ManagerDeploymentStatusClientAPI contains the set of methods on the ManagerDeploymentStatusClient type.
type ManagerDeploymentStatusClientAPI interface {
	List(ctx context.Context, parameters network.ManagerDeploymentStatusParameter, resourceGroupName string, networkManagerName string, top *int32) (result network.ManagerDeploymentStatusListResult, err error)
}

var _ ManagerDeploymentStatusClientAPI = (*network.ManagerDeploymentStatusClient)(nil)

// SubscriptionNetworkManagerConnectionsClientAPI contains the set of methods on the SubscriptionNetworkManagerConnectionsClient type.
type SubscriptionNetworkManagerConnectionsClientAPI interface {
	CreateOrUpdate(ctx context.Context, parameters network.ManagerConnection, networkManagerConnectionName string) (result network.ManagerConnection, err error)
	Delete(ctx context.Context, networkManagerConnectionName string) (result autorest.Response, err error)
	Get(ctx context.Context, networkManagerConnectionName string) (result network.ManagerConnection, err error)
	List(ctx context.Context, top *int32, skipToken string) (result network.ManagerConnectionListResultPage, err error)
	ListComplete(ctx context.Context, top *int32, skipToken string) (result network.ManagerConnectionListResultIterator, err error)
}

var _ SubscriptionNetworkManagerConnectionsClientAPI = (*network.SubscriptionNetworkManagerConnectionsClient)(nil)

// ManagementGroupNetworkManagerConnectionsClientAPI contains the set of methods on the ManagementGroupNetworkManagerConnectionsClient type.
type ManagementGroupNetworkManagerConnectionsClientAPI interface {
	CreateOrUpdate(ctx context.Context, parameters network.ManagerConnection, managementGroupID string, networkManagerConnectionName string) (result network.ManagerConnection, err error)
	Delete(ctx context.Context, managementGroupID string, networkManagerConnectionName string) (result autorest.Response, err error)
	Get(ctx context.Context, managementGroupID string, networkManagerConnectionName string) (result network.ManagerConnection, err error)
	List(ctx context.Context, managementGroupID string, top *int32, skipToken string) (result network.ManagerConnectionListResultPage, err error)
	ListComplete(ctx context.Context, managementGroupID string, top *int32, skipToken string) (result network.ManagerConnectionListResultIterator, err error)
}

var _ ManagementGroupNetworkManagerConnectionsClientAPI = (*network.ManagementGroupNetworkManagerConnectionsClient)(nil)
...
type ConnectivityConfigurationsClientAPI interface {
	CreateOrUpdate(ctx context.Context, connectivityConfiguration network.ConnectivityConfiguration, resourceGroupName string, networkManagerName string, configurationName string) (result network.ConnectivityConfiguration, err error)
	Delete(ctx context.Context, resourceGroupName string, networkManagerName string, configurationName string, force *bool) (result network.ConnectivityConfigurationsDeleteFuture, err error)
	...
	List(ctx context.Context, resourceGroupName string, networkManagerName string, top *int32, skipToken string) (result network.ConnectivityConfigurationListResultPage, err error)
	ListComplete(ctx context.Context, resourceGroupName string, networkManagerName string, top *int32, skipToken string) (result network.ConnectivityConfigurationListResultIterator, err error)
}
...
type GroupsClientAPI interface {
	CreateOrUpdate(ctx context.Context, parameters network.Group, resourceGroupName string, networkManagerName string, networkGroupName string, ifMatch string) (result network.Group, err error)
	Delete(ctx context.Context, resourceGroupName string, networkManagerName string, networkGroupName string, force *bool) (result network.GroupsDeleteFuture, err error)
	...
	List(ctx context.Context, resourceGroupName string, networkManagerName string, top *int32, skipToken string) (result network.GroupListResultPage, err error)
	ListComplete(ctx context.Context, resourceGroupName string, networkManagerName string, top *int32, skipToken string) (result network.GroupListResultIterator, err error)
}

var _ GroupsClientAPI = (*network.GroupsClient)(nil)

// StaticMembersClientAPI contains the set of methods on the StaticMembersClient type.
type StaticMembersClientAPI interface {
	CreateOrUpdate(ctx context.Context, parameters network.StaticMember, resourceGroupName string, networkManagerName string, networkGroupName string, staticMemberName string) (result network.StaticMember, err error)
	Delete(ctx context.Context, resourceGroupName string, networkManagerName string, networkGroupName string, staticMemberName string) (result autorest.Response, err error)
	Get(ctx context.Context, resourceGroupName string, networkManagerName string, networkGroupName string, staticMemberName string) (result network.StaticMember, err error)
	List(ctx context.Context, resourceGroupName string, networkManagerName string, networkGroupName string, top *int32, skipToken string) (result network.StaticMemberListResultPage, err error)
	ListComplete(ctx context.Context, resourceGroupName string, networkManagerName string, networkGroupName string, top *int32, skipToken string) (result network.StaticMemberListResultIterator, err error)
}

var _ StaticMembersClientAPI = (*network.StaticMembersClient)(nil)

// ScopeConnectionsClientAPI contains the set of methods on the ScopeConnectionsClient type.
type ScopeConnectionsClientAPI interface {
	CreateOrUpdate(ctx context.Context, parameters network.ScopeConnection, resourceGroupName string, networkManagerName string, scopeConnectionName string) (result network.ScopeConnection, err error)
	Delete(ctx context.Context, resourceGroupName string, networkManagerName string, scopeConnectionName string) (result autorest.Response, err error)
	Get(ctx context.Context, resourceGroupName string, networkManagerName string, scopeConnectionName string) (result network.ScopeConnection, err error)
	List(ctx context.Context, resourceGroupName string, networkManagerName string, top *int32, skipToken string) (result network.ScopeConnectionListResultPage, err error)
	ListComplete(ctx context.Context, resourceGroupName string, networkManagerName string, top *int32, skipToken string) (result network.ScopeConnectionListResultIterator, err error)
}

var _ ScopeConnectionsClientAPI = (*network.ScopeConnectionsClient)(nil)

// SecurityAdminConfigurationsClientAPI contains the set of methods on the SecurityAdminConfigurationsClient type.
type SecurityAdminConfigurationsClientAPI interface {
	CreateOrUpdate(ctx context.Context, securityAdminConfiguration network.SecurityAdminConfiguration, resourceGroupName string, networkManagerName string, configurationName string) (result network.SecurityAdminConfiguration, err error)
	Delete(ctx context.Context, resourceGroupName string, networkManagerName string, configurationName string, force *bool) (result network.SecurityAdminConfigurationsDeleteFuture, err error)
	Get(ctx context.Context, resourceGroupName string, networkManagerName string, configurationName string) (result network.SecurityAdminConfiguration, err error)
	List(ctx context.Context, resourceGroupName string, networkManagerName string, top *int32, skipToken string) (result network.SecurityAdminConfigurationListResultPage, err error)
	ListComplete(ctx context.Context, resourceGroupName string, networkManagerName string, top *int32, skipToken string) (result network.SecurityAdminConfigurationListResultIterator, err error)
}

var _ SecurityAdminConfigurationsClientAPI = (*network.SecurityAdminConfigurationsClient)(nil)

// AdminRuleCollectionsClientAPI contains the set of methods on the AdminRuleCollectionsClient type.
type AdminRuleCollectionsClientAPI interface {
	CreateOrUpdate(ctx context.Context, ruleCollection network.AdminRuleCollection, resourceGroupName string, networkManagerName string, configurationName string, ruleCollectionName string) (result network.AdminRuleCollection, err error)
	Delete(ctx context.Context, resourceGroupName string, networkManagerName string, configurationName string, ruleCollectionName string, force *bool) (result network.AdminRuleCollectionsDeleteFuture, err error)
	Get(ctx context.Context, resourceGroupName string, networkManagerName string, configurationName string, ruleCollectionName string) (result network.AdminRuleCollection, err error)
	List(ctx context.Context, resourceGroupName string, networkManagerName string, configurationName string, top *int32, skipToken string) (result network.AdminRuleCollectionListResultPage, err error)
	ListComplete(ctx context.Context, resourceGroupName string, networkManagerName string, configurationName string, top *int32, skipToken string) (result network.AdminRuleCollectionListResultIterator, err error)
}

var _ AdminRuleCollectionsClientAPI = (*network.AdminRuleCollectionsClient)(nil)

// AdminRulesClientAPI contains the set of methods on the AdminRulesClient type.
type AdminRulesClientAPI interface {
	CreateOrUpdate(ctx context.Context, adminRule network.BasicBaseAdminRule, resourceGroupName string, networkManagerName string, configurationName string, ruleCollectionName string, ruleName string) (result network.BaseAdminRuleModel, err error)
	Delete(ctx context.Context, resourceGroupName string, networkManagerName string, configurationName string, ruleCollectionName string, ruleName string, force *bool) (result network.AdminRulesDeleteFuture, err error)
	Get(ctx context.Context, resourceGroupName string, networkManagerName string, configurationName string, ruleCollectionName string, ruleName string) (result network.BaseAdminRuleModel, err error)
	List(ctx context.Context, resourceGroupName string, networkManagerName string, configurationName string, ruleCollectionName string, top *int32, skipToken string) (result network.AdminRuleListResultPage, err error)
	ListComplete(ctx context.Context, resourceGroupName string, networkManagerName string, configurationName string, ruleCollectionName string, top *int32, skipToken string) (result network.AdminRuleListResultIterator, err error)
}

var _ AdminRulesClientAPI = (*network.AdminRulesClient)(nil)
...
type VirtualNetworksClientAPI interface {
	...
	ListDdosProtectionStatus(ctx context.Context, resourceGroupName string, virtualNetworkName string, top *int32, skipToken string) (result network.VirtualNetworksListDdosProtectionStatusFuture, err error)
	ListDdosProtectionStatusComplete(ctx context.Context, resourceGroupName string, virtualNetworkName string, top *int32, skipToken string) (result network.VirtualNetworksListDdosProtectionStatusAllFuture, err error)
...
// ConfigurationPolicyGroupsClientAPI contains the set of methods on the ConfigurationPolicyGroupsClient type.
type ConfigurationPolicyGroupsClientAPI interface {
	CreateOrUpdate(ctx context.Context, resourceGroupName string, vpnServerConfigurationName string, configurationPolicyGroupName string, vpnServerConfigurationPolicyGroupParameters network.VpnServerConfigurationPolicyGroup) (result network.ConfigurationPolicyGroupsCreateOrUpdateFuture, err error)
	Delete(ctx context.Context, resourceGroupName string, vpnServerConfigurationName string, configurationPolicyGroupName string) (result network.ConfigurationPolicyGroupsDeleteFuture, err error)
	Get(ctx context.Context, resourceGroupName string, vpnServerConfigurationName string, configurationPolicyGroupName string) (result network.VpnServerConfigurationPolicyGroup, err error)
	ListByVpnServerConfiguration(ctx context.Context, resourceGroupName string, vpnServerConfigurationName string) (result network.ListVpnServerConfigurationPolicyGroupsResultPage, err error)
	ListByVpnServerConfigurationComplete(ctx context.Context, resourceGroupName string, vpnServerConfigurationName string) (result network.ListVpnServerConfigurationPolicyGroupsResultIterator, err error)
}

var _ ConfigurationPolicyGroupsClientAPI = (*network.ConfigurationPolicyGroupsClient)(nil)
...
type VirtualHubsClientAPI interface {
	...
	GetInboundRoutes(ctx context.Context, resourceGroupName string, virtualHubName string, getInboundRoutesParameters network.GetInboundRoutesParameters) (result network.VirtualHubsGetInboundRoutesFuture, err error)
	GetOutboundRoutes(ctx context.Context, resourceGroupName string, virtualHubName string, getOutboundRoutesParameters network.GetOutboundRoutesParameters) (result network.VirtualHubsGetOutboundRoutesFuture, err error)
...
// RouteMapsClientAPI contains the set of methods on the RouteMapsClient type.
type RouteMapsClientAPI interface {
	CreateOrUpdate(ctx context.Context, resourceGroupName string, virtualHubName string, routeMapName string, routeMapParameters network.RouteMap) (result network.RouteMapsCreateOrUpdateFuture, err error)
	Delete(ctx context.Context, resourceGroupName string, virtualHubName string, routeMapName string) (result network.RouteMapsDeleteFuture, err error)
	Get(ctx context.Context, resourceGroupName string, virtualHubName string, routeMapName string) (result network.RouteMap, err error)
	List(ctx context.Context, resourceGroupName string, virtualHubName string) (result network.ListRouteMapsResultPage, err error)
	ListComplete(ctx context.Context, resourceGroupName string, virtualHubName string) (result network.ListRouteMapsResultIterator, err error)
}

var _ RouteMapsClientAPI = (*network.RouteMapsClient)(nil)
