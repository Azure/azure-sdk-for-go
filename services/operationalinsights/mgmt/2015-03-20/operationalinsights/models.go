...
type WorkspacePurgeBodyFilters struct {
	...
	// Operator - A query operator to evaluate over the provided column and value(s). Supported operators are ==, =~, in, in~, >, >=, <, <=, between, and have the same behaviour as they would in a KQL query.
