...
type WorkspaceProperties struct {
	...
	// WorkspaceFeatures - Workspace features.
	*WorkspaceFeatures `json:"features,omitempty"`
}
...
func (wp WorkspaceProperties) MarshalJSON() ([]byte, error) {
	...
	if wp.WorkspaceFeatures != nil {
		objectMap["features"] = wp.WorkspaceFeatures
	}
	return json.Marshal(objectMap)
}

// UnmarshalJSON is the custom unmarshaler for WorkspaceProperties struct.
func (wp *WorkspaceProperties) UnmarshalJSON(body []byte) error {
	var m map[string]*json.RawMessage
	err := json.Unmarshal(body, &m)
	if err != nil {
		return err
	...
	for k, v := range m {
		...
		case "provisioningState":
			if v != nil {
				var provisioningState WorkspaceEntityStatus
				err = json.Unmarshal(*v, &provisioningState)
				if err != nil {
					return err
				}
				wp.ProvisioningState = provisioningState
			}
		case "customerId":
			if v != nil {
		...
		case "retentionInDays":
			if v != nil {
				...
				err = json.Unmarshal(*v, &retentionInDays)
				if err != nil {
					return err
				}
				wp.RetentionInDays = &retentionInDays
			}
		case "workspaceCapping":
			if v != nil {
				var workspaceCapping WorkspaceCapping
				err = json.Unmarshal(*v, &workspaceCapping)
				if err != nil {
					return err
				}
				wp.WorkspaceCapping = &workspaceCapping
			}
		case "createdDate":
			if v != nil {
				var createdDate string
				...
				wp.CreatedDate = &createdDate
			}
		case "modifiedDate":
			if v != nil {
				var modifiedDate string
				err = json.Unmarshal(*v, &modifiedDate)
				if err != nil {
					return err
				}
				wp.ModifiedDate = &modifiedDate
			}
		case "publicNetworkAccessForIngestion":
			if v != nil {
				var publicNetworkAccessForIngestion PublicNetworkAccessType
				err = json.Unmarshal(*v, &publicNetworkAccessForIngestion)
				if err != nil {
					return err
				}
				wp.PublicNetworkAccessForIngestion = publicNetworkAccessForIngestion
			}
		case "publicNetworkAccessForQuery":
			if v != nil {
				var publicNetworkAccessForQuery PublicNetworkAccessType
				err = json.Unmarshal(*v, &publicNetworkAccessForQuery)
				if err != nil {
					return err
				}
				wp.PublicNetworkAccessForQuery = publicNetworkAccessForQuery
			}
		case "forceCmkForQuery":
			if v != nil {
				var forceCmkForQuery bool
				err = json.Unmarshal(*v, &forceCmkForQuery)
				if err != nil {
					return err
				}
				wp.ForceCmkForQuery = &forceCmkForQuery
			}
		case "privateLinkScopedResources":
			if v != nil {
				var privateLinkScopedResources []PrivateLinkScopedResource
				err = json.Unmarshal(*v, &privateLinkScopedResources)
				if err != nil {
					return err
				}
				wp.PrivateLinkScopedResources = &privateLinkScopedResources
			}
		case "features":
			if v != nil {
				var workspaceFeatures WorkspaceFeatures
				err = json.Unmarshal(*v, &workspaceFeatures)
				if err != nil {
					return err
				}
				wp.WorkspaceFeatures = &workspaceFeatures
			}
		}
	}
