...
// GetClient is the log Analytics Data Plane Client
...
func (client GetClient) Metadata(ctx context.Context, workspaceID string) (result MetadataResults, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "operationalinsights.GetClient", "Metadata", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "operationalinsights.GetClient", "Metadata", resp, "Failure sending request")
		return
	}

	result, err = client.MetadataResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "operationalinsights.GetClient", "Metadata", resp, "Failure responding to request")
	}
...
func (client GetClient) MetadataPreparer(ctx context.Context, workspaceID string) (*http.Request, error) {
