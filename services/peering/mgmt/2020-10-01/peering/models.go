...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/peering/mgmt/2020-10-01/peering"
...
func NewCdnPeeringPrefixListResultPage(getNextPage func(context.Context, CdnPeeringPrefixListResult) (CdnPeeringPrefixListResult, error)) CdnPeeringPrefixListResultPage {
	return CdnPeeringPrefixListResultPage{fn: getNextPage}
}
