...
func (client LegacyPeeringsClient) List(ctx context.Context, peeringLocation string, kind LegacyPeeringsKind, asn *int32) (result ListResultPage, err error) {
...
func (client LegacyPeeringsClient) ListPreparer(ctx context.Context, peeringLocation string, kind LegacyPeeringsKind, asn *int32) (*http.Request, error) {
...
func (client LegacyPeeringsClient) ListComplete(ctx context.Context, peeringLocation string, kind LegacyPeeringsKind, asn *int32) (result ListResultIterator, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/LegacyPeeringsClient.List")
		defer func() {
			sc := -1
