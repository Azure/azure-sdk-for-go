...
func (client LookingGlassClient) Invoke(ctx context.Context, command LookingGlassCommand, sourceType LookingGlassSourceType, sourceLocation string, destinationIP string) (result LookingGlassOutput, err error) {
...
func (client LookingGlassClient) InvokePreparer(ctx context.Context, command LookingGlassCommand, sourceType LookingGlassSourceType, sourceLocation string, destinationIP string) (*http.Request, error) {
