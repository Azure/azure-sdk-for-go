...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/peering/mgmt/2021-06-01/peering"
...
type DirectPeeringFacility struct {
	...
	// DirectPeeringType - The type of the direct peering. Possible values include: 'Edge', 'Transit', 'Cdn', 'Internal', 'Ix', 'IxRs', 'Voice'
...
type PropertiesDirect struct {
	...
	// DirectPeeringType - The type of direct peering. Possible values include: 'Edge', 'Transit', 'Cdn', 'Internal', 'Ix', 'IxRs', 'Voice'
	DirectPeeringType DirectPeeringType `json:"directPeeringType,omitempty"`
}
