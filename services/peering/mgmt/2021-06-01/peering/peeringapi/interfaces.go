...
import (
	"context"
	"github.com/Azure/azure-sdk-for-go/services/peering/mgmt/2021-06-01/peering"
...
// CdnPeeringPrefixesClientAPI contains the set of methods on the CdnPeeringPrefixesClient type.
type CdnPeeringPrefixesClientAPI interface {
	List(ctx context.Context, peeringLocation string) (result peering.CdnPeeringPrefixListResultPage, err error)
	ListComplete(ctx context.Context, peeringLocation string) (result peering.CdnPeeringPrefixListResultIterator, err error)
}

var _ CdnPeeringPrefixesClientAPI = (*peering.CdnPeeringPrefixesClient)(nil)
...
type LegacyPeeringsClientAPI interface {
	List(ctx context.Context, peeringLocation string, kind peering.LegacyPeeringsKind, asn *int32) (result peering.ListResultPage, err error)
	ListComplete(ctx context.Context, peeringLocation string, kind peering.LegacyPeeringsKind, asn *int32) (result peering.ListResultIterator, err error)
}

var _ LegacyPeeringsClientAPI = (*peering.LegacyPeeringsClient)(nil)

// LookingGlassClientAPI contains the set of methods on the LookingGlassClient type.
type LookingGlassClientAPI interface {
	Invoke(ctx context.Context, command peering.LookingGlassCommand, sourceType peering.LookingGlassSourceType, sourceLocation string, destinationIP string) (result peering.LookingGlassOutput, err error)
}

var _ LookingGlassClientAPI = (*peering.LookingGlassClient)(nil)
...
type LocationsClientAPI interface {
	List(ctx context.Context, kind peering.LocationsKind, directPeeringType peering.LocationsDirectPeeringType) (result peering.LocationListResultPage, err error)
	ListComplete(ctx context.Context, kind peering.LocationsKind, directPeeringType peering.LocationsDirectPeeringType) (result peering.LocationListResultIterator, err error)
}
...
// ConnectionMonitorTestsClientAPI contains the set of methods on the ConnectionMonitorTestsClient type.
type ConnectionMonitorTestsClientAPI interface {
	CreateOrUpdate(ctx context.Context, resourceGroupName string, peeringServiceName string, connectionMonitorTestName string, connectionMonitorTest peering.ConnectionMonitorTest) (result peering.ConnectionMonitorTest, err error)
	Delete(ctx context.Context, resourceGroupName string, peeringServiceName string, connectionMonitorTestName string) (result autorest.Response, err error)
	Get(ctx context.Context, resourceGroupName string, peeringServiceName string, connectionMonitorTestName string) (result peering.ConnectionMonitorTest, err error)
	ListByPeeringService(ctx context.Context, resourceGroupName string, peeringServiceName string) (result peering.ConnectionMonitorTestListResultPage, err error)
	ListByPeeringServiceComplete(ctx context.Context, resourceGroupName string, peeringServiceName string) (result peering.ConnectionMonitorTestListResultIterator, err error)
}

var _ ConnectionMonitorTestsClientAPI = (*peering.ConnectionMonitorTestsClient)(nil)
...
type ServicesClientAPI interface {
	...
	InitializeConnectionMonitor(ctx context.Context) (result autorest.Response, err error)
