...
// Command enumerates the values for command.
type Command string

const (
	// BgpRoute ...
	BgpRoute Command = "BgpRoute"
	// Ping ...
	Ping Command = "Ping"
	// Traceroute ...
...
// PossibleCommandValues returns an array of possible values for the Command const type.
func PossibleCommandValues() []Command {
	return []Command{BgpRoute, Ping, Traceroute}
}
...
const (
	...
	EdgeZoneForOperators DirectPeeringType = "EdgeZoneForOperators"
	// Internal ...
...
func PossibleDirectPeeringTypeValues() []DirectPeeringType {
	return []DirectPeeringType{Cdn, Edge, EdgeZoneForOperators, Internal, Ix, IxRs, Transit, Voice}
}
...
// LegacyPeeringsKind enumerates the values for legacy peerings kind.
...
// PossibleLegacyPeeringsKindValues returns an array of possible values for the LegacyPeeringsKind const type.
func PossibleLegacyPeeringsKindValues() []LegacyPeeringsKind {
	return []LegacyPeeringsKind{LegacyPeeringsKindDirect, LegacyPeeringsKindExchange}
}

// LocationsDirectPeeringType enumerates the values for locations direct peering type.
...
// PossibleLocationsDirectPeeringTypeValues returns an array of possible values for the LocationsDirectPeeringType const type.
func PossibleLocationsDirectPeeringTypeValues() []LocationsDirectPeeringType {
	return []LocationsDirectPeeringType{LocationsDirectPeeringTypeCdn, LocationsDirectPeeringTypeEdge, LocationsDirectPeeringTypeEdgeZoneForOperators, LocationsDirectPeeringTypeInternal, LocationsDirectPeeringTypeIx, LocationsDirectPeeringTypeIxRs, LocationsDirectPeeringTypeTransit, LocationsDirectPeeringTypeVoice}
}

// LocationsKind enumerates the values for locations kind.
...
// PossibleLocationsKindValues returns an array of possible values for the LocationsKind const type.
func PossibleLocationsKindValues() []LocationsKind {
	return []LocationsKind{LocationsKindDirect, LocationsKindExchange}
}

// LookingGlassCommand enumerates the values for looking glass command.
...
// PossibleLookingGlassCommandValues returns an array of possible values for the LookingGlassCommand const type.
func PossibleLookingGlassCommandValues() []LookingGlassCommand {
	return []LookingGlassCommand{LookingGlassCommandBgpRoute, LookingGlassCommandPing, LookingGlassCommandTraceroute}
}

// LookingGlassSourceType enumerates the values for looking glass source type.
type LookingGlassSourceType string

const (
	// AzureRegion ...
	AzureRegion LookingGlassSourceType = "AzureRegion"
	// EdgeSite ...
	EdgeSite LookingGlassSourceType = "EdgeSite"
)

// PossibleLookingGlassSourceTypeValues returns an array of possible values for the LookingGlassSourceType const type.
func PossibleLookingGlassSourceTypeValues() []LookingGlassSourceType {
	return []LookingGlassSourceType{AzureRegion, EdgeSite}
}
