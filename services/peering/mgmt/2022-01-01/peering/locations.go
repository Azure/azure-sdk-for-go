...
func (client LocationsClient) List(ctx context.Context, kind LocationsKind, directPeeringType LocationsDirectPeeringType) (result LocationListResultPage, err error) {
...
func (client LocationsClient) ListPreparer(ctx context.Context, kind LocationsKind, directPeeringType LocationsDirectPeeringType) (*http.Request, error) {
...
func (client LocationsClient) ListComplete(ctx context.Context, kind LocationsKind, directPeeringType LocationsDirectPeeringType) (result LocationListResultIterator, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/LocationsClient.List")
		defer func() {
			sc := -1
