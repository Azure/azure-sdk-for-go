...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/peering/mgmt/2022-01-01/peering"
...
type CdnPeeringPrefix struct {
	...
	*CdnPeeringPrefixProperties `json:"properties,omitempty"`
...
// MarshalJSON is the custom marshaler for CdnPeeringPrefix.
func (cpp CdnPeeringPrefix) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if cpp.CdnPeeringPrefixProperties != nil {
		objectMap["properties"] = cpp.CdnPeeringPrefixProperties
	}
	return json.Marshal(objectMap)
}

// UnmarshalJSON is the custom unmarshaler for CdnPeeringPrefix struct.
func (cpp *CdnPeeringPrefix) UnmarshalJSON(body []byte) error {
	...
	for k, v := range m {
		...
		case "properties":
			if v != nil {
				var cdnPeeringPrefixProperties CdnPeeringPrefixProperties
				err = json.Unmarshal(*v, &cdnPeeringPrefixProperties)
				if err != nil {
					return err
				}
				cpp.CdnPeeringPrefixProperties = &cdnPeeringPrefixProperties
			}
		case "name":
			if v != nil {
				var name string
...
type CdnPeeringPrefixListResult struct {
	...
	// Value - The list of CDN peering prefixes.
	Value *[]CdnPeeringPrefix `json:"value,omitempty"`
	// NextLink - The link to fetch the next page of CDN peering prefixes.
	NextLink *string `json:"nextLink,omitempty"`
}

// CdnPeeringPrefixListResultIterator provides access to a complete listing of CdnPeeringPrefix values.
type CdnPeeringPrefixListResultIterator struct {
	i    int
	page CdnPeeringPrefixListResultPage
}

// NextWithContext advances to the next value.  If there was an error making
// the request the iterator does not advance and the error is returned.
func (iter *CdnPeeringPrefixListResultIterator) NextWithContext(ctx context.Context) (err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/CdnPeeringPrefixListResultIterator.NextWithContext")
		defer func() {
			sc := -1
...
func (iter *CdnPeeringPrefixListResultIterator) Next() error {
	return iter.NextWithContext(context.Background())
}

// NotDone returns true if the enumeration should be started or is not yet complete.
func (iter CdnPeeringPrefixListResultIterator) NotDone() bool {
	return iter.page.NotDone() && iter.i < len(iter.page.Values())
}

// Response returns the raw server response from the last page request.
func (iter CdnPeeringPrefixListResultIterator) Response() CdnPeeringPrefixListResult {
	return iter.page.Response()
}

// Value returns the current value or a zero-initialized value if the
// iterator has advanced beyond the end of the collection.
func (iter CdnPeeringPrefixListResultIterator) Value() CdnPeeringPrefix {
	if !iter.page.NotDone() {
		return CdnPeeringPrefix{}
	}
	return iter.page.Values()[iter.i]
}

// Creates a new instance of the CdnPeeringPrefixListResultIterator type.
func NewCdnPeeringPrefixListResultIterator(page CdnPeeringPrefixListResultPage) CdnPeeringPrefixListResultIterator {
	return CdnPeeringPrefixListResultIterator{page: page}
}

// IsEmpty returns true if the ListResult contains no values.
func (cpplr CdnPeeringPrefixListResult) IsEmpty() bool {
	return cpplr.Value == nil || len(*cpplr.Value) == 0
}

// hasNextLink returns true if the NextLink is not empty.
func (cpplr CdnPeeringPrefixListResult) hasNextLink() bool {
	return cpplr.NextLink != nil && len(*cpplr.NextLink) != 0
}

// cdnPeeringPrefixListResultPreparer prepares a request to retrieve the next set of results.
// It returns nil if no more results exist.
func (cpplr CdnPeeringPrefixListResult) cdnPeeringPrefixListResultPreparer(ctx context.Context) (*http.Request, error) {
	if !cpplr.hasNextLink() {
		return nil, nil
	}
	return autorest.Prepare((&http.Request{}).WithContext(ctx),
		autorest.AsJSON(),
		autorest.AsGet(),
		autorest.WithBaseURL(to.String(cpplr.NextLink)))
}

// CdnPeeringPrefixListResultPage contains a page of CdnPeeringPrefix values.
type CdnPeeringPrefixListResultPage struct {
	fn    func(context.Context, CdnPeeringPrefixListResult) (CdnPeeringPrefixListResult, error)
	cpplr CdnPeeringPrefixListResult
}

// NextWithContext advances to the next page of values.  If there was an error making
// the request the page does not advance and the error is returned.
func (page *CdnPeeringPrefixListResultPage) NextWithContext(ctx context.Context) (err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/CdnPeeringPrefixListResultPage.NextWithContext")
		defer func() {
			sc := -1
	...
	for {
		next, err := page.fn(ctx, page.cpplr)
		if err != nil {
			return err
		}
		page.cpplr = next
...
// the request the page does not advance and the error is returned.
// Deprecated: Use NextWithContext() instead.
func (page *CdnPeeringPrefixListResultPage) Next() error {
	return page.NextWithContext(context.Background())
}

// NotDone returns true if the page enumeration should be started or is not yet complete.
func (page CdnPeeringPrefixListResultPage) NotDone() bool {
	return !page.cpplr.IsEmpty()
}

// Response returns the raw server response from the last page request.
func (page CdnPeeringPrefixListResultPage) Response() CdnPeeringPrefixListResult {
	return page.cpplr
}

// Values returns the slice of values for the current page or nil if there are no values.
func (page CdnPeeringPrefixListResultPage) Values() []CdnPeeringPrefix {
	if page.cpplr.IsEmpty() {
		return nil
	}
	return *page.cpplr.Value
}

// Creates a new instance of the CdnPeeringPrefixListResultPage type.
func NewCdnPeeringPrefixListResultPage(cur CdnPeeringPrefixListResult, getNextPage func(context.Context, CdnPeeringPrefixListResult) (CdnPeeringPrefixListResult, error)) CdnPeeringPrefixListResultPage {
	return CdnPeeringPrefixListResultPage{
		fn:    getNextPage,
		cpplr: cur,
	}
}
...
type CdnPeeringPrefixProperties struct {
	...
	// AzureRegion - READ-ONLY; The Azure region.
	AzureRegion *string `json:"azureRegion,omitempty"`
	// AzureService - READ-ONLY; The Azure service.
	AzureService *string `json:"azureService,omitempty"`
	// IsPrimaryRegion - READ-ONLY; The flag that indicates whether or not this is the primary region.
	IsPrimaryRegion *bool `json:"isPrimaryRegion,omitempty"`
	// BgpCommunity - READ-ONLY; The BGP Community
...
type ConnectionMonitorTest struct {
	...
	*ConnectionMonitorTestProperties `json:"properties,omitempty"`
	// Name - READ-ONLY; The name of the resource.
	Name *string `json:"name,omitempty"`
	// ID - READ-ONLY; The ID of the resource.
	ID *string `json:"id,omitempty"`
...
// MarshalJSON is the custom marshaler for ConnectionMonitorTest.
func (cmt ConnectionMonitorTest) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if cmt.ConnectionMonitorTestProperties != nil {
		objectMap["properties"] = cmt.ConnectionMonitorTestProperties
	}
	return json.Marshal(objectMap)
}

// UnmarshalJSON is the custom unmarshaler for ConnectionMonitorTest struct.
func (cmt *ConnectionMonitorTest) UnmarshalJSON(body []byte) error {
	var m map[string]*json.RawMessage
	err := json.Unmarshal(body, &m)
	if err != nil {
		return err
	...
	for k, v := range m {
		...
		case "properties":
			if v != nil {
				var connectionMonitorTestProperties ConnectionMonitorTestProperties
				err = json.Unmarshal(*v, &connectionMonitorTestProperties)
				if err != nil {
					return err
				}
				cmt.ConnectionMonitorTestProperties = &connectionMonitorTestProperties
			}
		case "name":
			if v != nil {
				var name string
...
// ConnectionMonitorTestListResultIterator provides access to a complete listing of ConnectionMonitorTest
// values.
type ConnectionMonitorTestListResultIterator struct {
	i    int
	page ConnectionMonitorTestListResultPage
}

// NextWithContext advances to the next value.  If there was an error making
// the request the iterator does not advance and the error is returned.
func (iter *ConnectionMonitorTestListResultIterator) NextWithContext(ctx context.Context) (err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/ConnectionMonitorTestListResultIterator.NextWithContext")
		defer func() {
			sc := -1
			if iter.Response().Response.Response != nil {
				sc = iter.Response().Response.Response.StatusCode
...
// the request the iterator does not advance and the error is returned.
// Deprecated: Use NextWithContext() instead.
func (iter *ConnectionMonitorTestListResultIterator) Next() error {
	return iter.NextWithContext(context.Background())
}

// NotDone returns true if the enumeration should be started or is not yet complete.
func (iter ConnectionMonitorTestListResultIterator) NotDone() bool {
	return iter.page.NotDone() && iter.i < len(iter.page.Values())
}

// Response returns the raw server response from the last page request.
func (iter ConnectionMonitorTestListResultIterator) Response() ConnectionMonitorTestListResult {
	return iter.page.Response()
}

// Value returns the current value or a zero-initialized value if the
// iterator has advanced beyond the end of the collection.
func (iter ConnectionMonitorTestListResultIterator) Value() ConnectionMonitorTest {
	if !iter.page.NotDone() {
		return ConnectionMonitorTest{}
	}
	return iter.page.Values()[iter.i]
}

// Creates a new instance of the ConnectionMonitorTestListResultIterator type.
func NewConnectionMonitorTestListResultIterator(page ConnectionMonitorTestListResultPage) ConnectionMonitorTestListResultIterator {
	return ConnectionMonitorTestListResultIterator{page: page}
}

// IsEmpty returns true if the ListResult contains no values.
func (cmtlr ConnectionMonitorTestListResult) IsEmpty() bool {
	return cmtlr.Value == nil || len(*cmtlr.Value) == 0
}

// hasNextLink returns true if the NextLink is not empty.
func (cmtlr ConnectionMonitorTestListResult) hasNextLink() bool {
	return cmtlr.NextLink != nil && len(*cmtlr.NextLink) != 0
}

// connectionMonitorTestListResultPreparer prepares a request to retrieve the next set of results.
// It returns nil if no more results exist.
func (cmtlr ConnectionMonitorTestListResult) connectionMonitorTestListResultPreparer(ctx context.Context) (*http.Request, error) {
	if !cmtlr.hasNextLink() {
		return nil, nil
	}
	return autorest.Prepare((&http.Request{}).WithContext(ctx),
		autorest.AsJSON(),
		autorest.AsGet(),
		autorest.WithBaseURL(to.String(cmtlr.NextLink)))
}

// ConnectionMonitorTestListResultPage contains a page of ConnectionMonitorTest values.
type ConnectionMonitorTestListResultPage struct {
	fn    func(context.Context, ConnectionMonitorTestListResult) (ConnectionMonitorTestListResult, error)
	cmtlr ConnectionMonitorTestListResult
}

// NextWithContext advances to the next page of values.  If there was an error making
// the request the page does not advance and the error is returned.
func (page *ConnectionMonitorTestListResultPage) NextWithContext(ctx context.Context) (err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/ConnectionMonitorTestListResultPage.NextWithContext")
		defer func() {
			sc := -1
			if page.Response().Response.Response != nil {
				sc = page.Response().Response.Response.StatusCode
	...
	for {
		next, err := page.fn(ctx, page.cmtlr)
		if err != nil {
			return err
		}
		page.cmtlr = next
...
// the request the page does not advance and the error is returned.
// Deprecated: Use NextWithContext() instead.
func (page *ConnectionMonitorTestListResultPage) Next() error {
	return page.NextWithContext(context.Background())
}

// NotDone returns true if the page enumeration should be started or is not yet complete.
func (page ConnectionMonitorTestListResultPage) NotDone() bool {
	return !page.cmtlr.IsEmpty()
}

// Response returns the raw server response from the last page request.
func (page ConnectionMonitorTestListResultPage) Response() ConnectionMonitorTestListResult {
	return page.cmtlr
}

// Values returns the slice of values for the current page or nil if there are no values.
func (page ConnectionMonitorTestListResultPage) Values() []ConnectionMonitorTest {
	if page.cmtlr.IsEmpty() {
		return nil
	}
	return *page.cmtlr.Value
}

// Creates a new instance of the ConnectionMonitorTestListResultPage type.
func NewConnectionMonitorTestListResultPage(cur ConnectionMonitorTestListResult, getNextPage func(context.Context, ConnectionMonitorTestListResult) (ConnectionMonitorTestListResult, error)) ConnectionMonitorTestListResultPage {
	return ConnectionMonitorTestListResultPage{
		fn:    getNextPage,
		cmtlr: cur,
	}
}
...
type ConnectionMonitorTestProperties struct {
	...
	// IsTestSuccessful - READ-ONLY; The flag that indicates if the Connection Monitor test is successful or not.
	IsTestSuccessful *bool `json:"isTestSuccessful,omitempty"`
	// Path - READ-ONLY; The path representing the Connection Monitor test.
...
// MarshalJSON is the custom marshaler for ConnectionMonitorTestProperties.
func (cmtp ConnectionMonitorTestProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if cmtp.SourceAgent != nil {
		objectMap["sourceAgent"] = cmtp.SourceAgent
	}
	if cmtp.Destination != nil {
		objectMap["destination"] = cmtp.Destination
	}
	if cmtp.DestinationPort != nil {
		objectMap["destinationPort"] = cmtp.DestinationPort
	}
	if cmtp.TestFrequencyInSec != nil {
		objectMap["testFrequencyInSec"] = cmtp.TestFrequencyInSec
	}
	return json.Marshal(objectMap)
}
...
type DirectConnection struct {
	...
	// MicrosoftTrackingID - READ-ONLY; The ID used within Microsoft's peering provisioning system to track the connection
	MicrosoftTrackingID *string `json:"microsoftTrackingId,omitempty"`
...
type DirectPeeringFacility struct {
	...
	// DirectPeeringType - The type of the direct peering. Possible values include: 'Edge', 'Transit', 'Cdn', 'Internal', 'Ix', 'IxRs', 'Voice', 'EdgeZoneForOperators'
...
type LogAnalyticsWorkspaceProperties struct {
	// WorkspaceID - READ-ONLY; The Workspace ID.
	WorkspaceID *string `json:"workspaceID,omitempty"`
	// Key - READ-ONLY; The Workspace Key.
	Key *string `json:"key,omitempty"`
	// ConnectedAgents - READ-ONLY; The list of connected agents.
	ConnectedAgents *[]string `json:"connectedAgents,omitempty"`
}

// MarshalJSON is the custom marshaler for LogAnalyticsWorkspaceProperties.
func (lawp LogAnalyticsWorkspaceProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	return json.Marshal(objectMap)
}
...
type LookingGlassOutput struct {
	autorest.Response `json:"-"`
	// Command - Invoked command. Possible values include: 'Traceroute', 'Ping', 'BgpRoute'
...
type MetricDimension struct {
	// Name - READ-ONLY; Name of the dimension.
	Name *string `json:"name,omitempty"`
	// DisplayName - READ-ONLY; Localized friendly display name of the dimension.
...
type MetricSpecification struct {
	...
	Name *string `json:"name,omitempty"`
	// DisplayName - READ-ONLY; Localized friendly display name of the metric.
	DisplayName *string `json:"displayName,omitempty"`
	// DisplayDescription - READ-ONLY; Localized friendly description of the metric.
	DisplayDescription *string `json:"displayDescription,omitempty"`
	// Unit - READ-ONLY; Unit that makes sense for the metric.
	Unit *string `json:"unit,omitempty"`
	// AggregationType - READ-ONLY; Aggregation type will be set to one of the values: Average, Minimum, Maximum, Total, Count.
	AggregationType *string `json:"aggregationType,omitempty"`
	// SupportedTimeGrainTypes - READ-ONLY; Supported time grain types for the metric.
	SupportedTimeGrainTypes *[]string `json:"supportedTimeGrainTypes,omitempty"`
	// Dimensions - READ-ONLY; Dimensions of the metric.
...
type Operation struct {
	...
	// OperationProperties - READ-ONLY; The properties of the operation.
...
func (o *Operation) UnmarshalJSON(body []byte) error {
	...
	for k, v := range m {
		...
		case "display":
			if v != nil {
				var display OperationDisplayInfo
...
type OperationProperties struct {
	// ServiceSpecification - READ-ONLY; Service specification payload.
...
type PeerAsnProperties struct {
	...
	// ValidationState - READ-ONLY; The validation state of the ASN associated with the peer. Possible values include: 'ValidationStateNone', 'ValidationStatePending', 'ValidationStateApproved', 'ValidationStateFailed'
...
type PropertiesDirect struct {
	...
	// DirectPeeringType - The type of direct peering. Possible values include: 'Edge', 'Transit', 'Cdn', 'Internal', 'Ix', 'IxRs', 'Voice', 'EdgeZoneForOperators'
	DirectPeeringType DirectPeeringType `json:"directPeeringType,omitempty"`
}
...
// hasNextLink returns true if the NextLink is not empty.
func (rrlr ReceivedRouteListResult) hasNextLink() bool {
...
func (sp ServiceProperties) MarshalJSON() ([]byte, error) {
	...
	if sp.ProviderPrimaryPeeringLocation != nil {
		objectMap["providerPrimaryPeeringLocation"] = sp.ProviderPrimaryPeeringLocation
	}
	if sp.ProviderBackupPeeringLocation != nil {
		objectMap["providerBackupPeeringLocation"] = sp.ProviderBackupPeeringLocation
	}
	if sp.LogAnalyticsWorkspaceProperties != nil {
		objectMap["logAnalyticsWorkspaceProperties"] = sp.LogAnalyticsWorkspaceProperties
	}
	return json.Marshal(objectMap)
}
...
type ServiceProviderProperties struct {
	...
	// PeeringLocations - The list of locations at which the service provider peers with Microsoft.
...
type ServiceSpecification struct {
	// MetricSpecifications - READ-ONLY; Specifications of the Metrics for Azure Monitoring.
...
type Sku struct {
	...
	Name *string `json:"name,omitempty"`
	// Tier - READ-ONLY; The tier of the peering SKU. Possible values include: 'Basic', 'Premium'
	Tier Tier `json:"tier,omitempty"`
	// Family - READ-ONLY; The family of the peering SKU. Possible values include: 'Direct', 'Exchange'
	Family Family `json:"family,omitempty"`
	// Size - READ-ONLY; The size of the peering SKU. Possible values include: 'Free', 'Metered', 'Unlimited'
