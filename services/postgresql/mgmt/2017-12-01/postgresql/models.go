...
// ServerPropertiesForGeoRestore the properties used to create a new server by restoring to a different region from a
...
func (spfgr ServerPropertiesForGeoRestore) MarshalJSON() ([]byte, error) {
	...
	type Alias ServerPropertiesForGeoRestore
	return json.Marshal(&struct {
		Alias
	}{
		Alias: (Alias)(spfgr),
