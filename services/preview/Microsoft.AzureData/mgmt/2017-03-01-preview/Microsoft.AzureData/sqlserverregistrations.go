...
func (client SQLServerRegistrationsClient) CreateOrUpdate(ctx context.Context, resourceGroupName string, SQLServerRegistrationName string, parameters SQLServerRegistration) (result SQLServerRegistration, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsoftazuredata.SQLServerRegistrationsClient", "CreateOrUpdate", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "microsoftazuredata.SQLServerRegistrationsClient", "CreateOrUpdate", resp, "Failure sending request")
		return
	}

	result, err = client.CreateOrUpdateResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsoftazuredata.SQLServerRegistrationsClient", "CreateOrUpdate", resp, "Failure responding to request")
	}
...
func (client SQLServerRegistrationsClient) Delete(ctx context.Context, resourceGroupName string, SQLServerRegistrationName string) (result autorest.Response, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsoftazuredata.SQLServerRegistrationsClient", "Delete", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "microsoftazuredata.SQLServerRegistrationsClient", "Delete", resp, "Failure sending request")
		return
	}

	result, err = client.DeleteResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsoftazuredata.SQLServerRegistrationsClient", "Delete", resp, "Failure responding to request")
	}
...
func (client SQLServerRegistrationsClient) Get(ctx context.Context, resourceGroupName string, SQLServerRegistrationName string) (result SQLServerRegistration, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsoftazuredata.SQLServerRegistrationsClient", "Get", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "microsoftazuredata.SQLServerRegistrationsClient", "Get", resp, "Failure sending request")
		return
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsoftazuredata.SQLServerRegistrationsClient", "Get", resp, "Failure responding to request")
	}
...
func (client SQLServerRegistrationsClient) List(ctx context.Context) (result SQLServerRegistrationListResultPage, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsoftazuredata.SQLServerRegistrationsClient", "List", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "microsoftazuredata.SQLServerRegistrationsClient", "List", resp, "Failure sending request")
		return
	}

	result.ssrlr, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsoftazuredata.SQLServerRegistrationsClient", "List", resp, "Failure responding to request")
	}
...
func (client SQLServerRegistrationsClient) listNextResults(ctx context.Context, lastResults SQLServerRegistrationListResult) (result SQLServerRegistrationListResult, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "microsoftazuredata.SQLServerRegistrationsClient", "listNextResults", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "microsoftazuredata.SQLServerRegistrationsClient", "listNextResults", resp, "Failure sending next results request")
	}
	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsoftazuredata.SQLServerRegistrationsClient", "listNextResults", resp, "Failure responding to next results request")
	}
	return
}
...
func (client SQLServerRegistrationsClient) ListByResourceGroup(ctx context.Context, resourceGroupName string) (result SQLServerRegistrationListResultPage, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsoftazuredata.SQLServerRegistrationsClient", "ListByResourceGroup", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.ssrlr.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "microsoftazuredata.SQLServerRegistrationsClient", "ListByResourceGroup", resp, "Failure sending request")
		return
	}

	result.ssrlr, err = client.ListByResourceGroupResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsoftazuredata.SQLServerRegistrationsClient", "ListByResourceGroup", resp, "Failure responding to request")
	}
...
func (client SQLServerRegistrationsClient) listByResourceGroupNextResults(ctx context.Context, lastResults SQLServerRegistrationListResult) (result SQLServerRegistrationListResult, err error) {
	req, err := lastResults.sQLServerRegistrationListResultPreparer(ctx)
	if err != nil {
		return result, autorest.NewErrorWithError(err, "microsoftazuredata.SQLServerRegistrationsClient", "listByResourceGroupNextResults", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "microsoftazuredata.SQLServerRegistrationsClient", "listByResourceGroupNextResults", resp, "Failure sending next results request")
	}
	result, err = client.ListByResourceGroupResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsoftazuredata.SQLServerRegistrationsClient", "listByResourceGroupNextResults", resp, "Failure responding to next results request")
	}
	return
}
...
func (client SQLServerRegistrationsClient) Update(ctx context.Context, resourceGroupName string, SQLServerRegistrationName string, parameters SQLServerRegistrationUpdate) (result SQLServerRegistration, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsoftazuredata.SQLServerRegistrationsClient", "Update", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "microsoftazuredata.SQLServerRegistrationsClient", "Update", resp, "Failure sending request")
		return
	}

	result, err = client.UpdateResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsoftazuredata.SQLServerRegistrationsClient", "Update", resp, "Failure responding to request")
	}
