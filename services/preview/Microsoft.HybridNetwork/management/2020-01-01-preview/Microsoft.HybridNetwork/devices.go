...
// DevicesClient is the client for the Devices methods of the Microsofthybridnetwork service.
...
// CreateOrUpdate creates or updates a hybrid network device.
// Parameters:
// resourceGroupName - the name of the resource group.
// deviceName - resource name for the device resource.
// parameters - parameters supplied to the create or update hybrid network device operation.
func (client DevicesClient) CreateOrUpdate(ctx context.Context, resourceGroupName string, deviceName string, parameters Device) (result DevicesCreateOrUpdateFuture, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.DevicesClient", "CreateOrUpdate", nil, "Failure preparing request")
		return
	}

	result, err = client.CreateOrUpdateSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.DevicesClient", "CreateOrUpdate", result.Response(), "Failure sending request")
		return
	}
...
// Delete deletes the specified hybrid network device.
// Parameters:
// resourceGroupName - the name of the resource group.
// deviceName - the name of the hybrid network device.
func (client DevicesClient) Delete(ctx context.Context, resourceGroupName string, deviceName string) (result DevicesDeleteFuture, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.DevicesClient", "Delete", nil, "Failure preparing request")
		return
	}

	result, err = client.DeleteSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.DevicesClient", "Delete", result.Response(), "Failure sending request")
		return
	}
...
// Get gets information about the specified hybrid network device.
// Parameters:
// resourceGroupName - the name of the resource group.
// deviceName - the name of hybrid network device.
func (client DevicesClient) Get(ctx context.Context, resourceGroupName string, deviceName string) (result Device, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.DevicesClient", "Get", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.DevicesClient", "Get", resp, "Failure sending request")
		return
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.DevicesClient", "Get", resp, "Failure responding to request")
	}
...
// ListByResourceGroup lists all the hybrid network devices in a resource group.
// Parameters:
// resourceGroupName - the name of the resource group.
func (client DevicesClient) ListByResourceGroup(ctx context.Context, resourceGroupName string) (result DeviceListResultPage, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.DevicesClient", "ListByResourceGroup", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.DevicesClient", "ListByResourceGroup", resp, "Failure sending request")
		return
	}

	result.dlr, err = client.ListByResourceGroupResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.DevicesClient", "ListByResourceGroup", resp, "Failure responding to request")
	}
...
func (client DevicesClient) listByResourceGroupNextResults(ctx context.Context, lastResults DeviceListResult) (result DeviceListResult, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "microsofthybridnetwork.DevicesClient", "listByResourceGroupNextResults", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "microsofthybridnetwork.DevicesClient", "listByResourceGroupNextResults", resp, "Failure sending next results request")
	}
	result, err = client.ListByResourceGroupResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.DevicesClient", "listByResourceGroupNextResults", resp, "Failure responding to next results request")
	}
	return
}
...
func (client DevicesClient) ListBySubscription(ctx context.Context) (result DeviceListResultPage, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.DevicesClient", "ListBySubscription", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.dlr.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.DevicesClient", "ListBySubscription", resp, "Failure sending request")
		return
	}

	result.dlr, err = client.ListBySubscriptionResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.DevicesClient", "ListBySubscription", resp, "Failure responding to request")
	}
	if result.dlr.hasNextLink() && result.dlr.IsEmpty() {
		err = result.NextWithContext(ctx)
	}
...
func (client DevicesClient) listBySubscriptionNextResults(ctx context.Context, lastResults DeviceListResult) (result DeviceListResult, err error) {
	req, err := lastResults.deviceListResultPreparer(ctx)
	if err != nil {
		return result, autorest.NewErrorWithError(err, "microsofthybridnetwork.DevicesClient", "listBySubscriptionNextResults", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "microsofthybridnetwork.DevicesClient", "listBySubscriptionNextResults", resp, "Failure sending next results request")
	}
	result, err = client.ListBySubscriptionResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.DevicesClient", "listBySubscriptionNextResults", resp, "Failure responding to next results request")
	}
	return
}
...
// ListRegistrationKey list the registration key for the hybrid network device.
// Parameters:
// resourceGroupName - the name of the resource group.
// deviceName - the name of the hybrid network device.
func (client DevicesClient) ListRegistrationKey(ctx context.Context, resourceGroupName string, deviceName string) (result DeviceRegistrationKey, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.DevicesClient", "ListRegistrationKey", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.DevicesClient", "ListRegistrationKey", resp, "Failure sending request")
		return
	}

	result, err = client.ListRegistrationKeyResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.DevicesClient", "ListRegistrationKey", resp, "Failure responding to request")
	}
...
// UpdateTags updates a hybrid network device tags.
// Parameters:
// resourceGroupName - the name of the resource group.
// deviceName - the name of the hybrid network device.
// parameters - parameters supplied to update hybrid network device tags.
func (client DevicesClient) UpdateTags(ctx context.Context, resourceGroupName string, deviceName string, parameters TagsObject) (result Device, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.DevicesClient", "UpdateTags", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.DevicesClient", "UpdateTags", resp, "Failure sending request")
		return
	}

	result, err = client.UpdateTagsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.DevicesClient", "UpdateTags", resp, "Failure responding to request")
	}
