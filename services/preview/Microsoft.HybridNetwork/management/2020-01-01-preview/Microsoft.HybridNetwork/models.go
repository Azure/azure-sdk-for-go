...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/preview/microsoft.hybridnetwork/management/2020-01-01-preview/microsoft.hybridnetwork"
...
func (future *DevicesCreateOrUpdateFuture) Result(client DevicesClient) (d Device, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.DevicesCreateOrUpdateFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		err = azure.NewAsyncOpIncompleteError("microsofthybridnetwork.DevicesCreateOrUpdateFuture")
		return
	}
	...
	if d.Response.Response, err = future.GetResult(sender); err == nil && d.Response.Response.StatusCode != http.StatusNoContent {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "microsofthybridnetwork.DevicesCreateOrUpdateFuture", "Result", d.Response.Response, "Failure responding to request")
		}
	}
	return
}
...
func (future *DevicesDeleteFuture) Result(client DevicesClient) (ar autorest.Response, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.DevicesDeleteFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		err = azure.NewAsyncOpIncompleteError("microsofthybridnetwork.DevicesDeleteFuture")
		return
	}
...
func (psl PreviewSubscriptionsList) previewSubscriptionsListPreparer(ctx context.Context) (*http.Request, error) {
	if psl.NextLink == nil || len(to.String(psl.NextLink)) < 1 {
		return nil, nil
	}
	return autorest.Prepare((&http.Request{}).WithContext(ctx),
		autorest.AsJSON(),
...
func (future *VendorsCreateOrUpdateFuture) Result(client VendorsClient) (vVar Vendor, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VendorsCreateOrUpdateFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		err = azure.NewAsyncOpIncompleteError("microsofthybridnetwork.VendorsCreateOrUpdateFuture")
		return
	}
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if vVar.Response.Response, err = future.GetResult(sender); err == nil && vVar.Response.Response.StatusCode != http.StatusNoContent {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VendorsCreateOrUpdateFuture", "Result", vVar.Response.Response, "Failure responding to request")
		}
	}
	return
}
...
func (future *VendorsDeleteFuture) Result(client VendorsClient) (ar autorest.Response, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VendorsDeleteFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		err = azure.NewAsyncOpIncompleteError("microsofthybridnetwork.VendorsDeleteFuture")
		return
	}
	ar.Response = future.Response()
	return
...
func (vslr VendorSkuListResult) vendorSkuListResultPreparer(ctx context.Context) (*http.Request, error) {
	if vslr.NextLink == nil || len(to.String(vslr.NextLink)) < 1 {
		return nil, nil
	}
	return autorest.Prepare((&http.Request{}).WithContext(ctx),
		autorest.AsJSON(),
...
func (future *VendorSkuPreviewCreateOrUpdateFuture) Result(client VendorSkuPreviewClient) (ps PreviewSubscription, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VendorSkuPreviewCreateOrUpdateFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		err = azure.NewAsyncOpIncompleteError("microsofthybridnetwork.VendorSkuPreviewCreateOrUpdateFuture")
		return
	}
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if ps.Response.Response, err = future.GetResult(sender); err == nil && ps.Response.Response.StatusCode != http.StatusNoContent {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VendorSkuPreviewCreateOrUpdateFuture", "Result", ps.Response.Response, "Failure responding to request")
		}
	}
	return
}
...
func (future *VendorSkuPreviewDeleteFuture) Result(client VendorSkuPreviewClient) (ar autorest.Response, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VendorSkuPreviewDeleteFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		err = azure.NewAsyncOpIncompleteError("microsofthybridnetwork.VendorSkuPreviewDeleteFuture")
		return
	}
	ar.Response = future.Response()
	return
...
func (future *VendorSkusCreateOrUpdateFuture) Result(client VendorSkusClient) (vs VendorSku, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VendorSkusCreateOrUpdateFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		err = azure.NewAsyncOpIncompleteError("microsofthybridnetwork.VendorSkusCreateOrUpdateFuture")
		return
	}
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if vs.Response.Response, err = future.GetResult(sender); err == nil && vs.Response.Response.StatusCode != http.StatusNoContent {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VendorSkusCreateOrUpdateFuture", "Result", vs.Response.Response, "Failure responding to request")
		}
	}
	return
}
...
func (future *VendorSkusDeleteFuture) Result(client VendorSkusClient) (ar autorest.Response, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VendorSkusDeleteFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		err = azure.NewAsyncOpIncompleteError("microsofthybridnetwork.VendorSkusDeleteFuture")
		return
	}
	ar.Response = future.Response()
	return
...
func (vvnflr VendorVirtualNetworkFunctionListResult) vendorVirtualNetworkFunctionListResultPreparer(ctx context.Context) (*http.Request, error) {
	if vvnflr.NextLink == nil || len(to.String(vvnflr.NextLink)) < 1 {
		return nil, nil
	}
	return autorest.Prepare((&http.Request{}).WithContext(ctx),
		autorest.AsJSON(),
...
// VendorVirtualNetworkFunctionsCreateOrUpdateFuture an abstraction for monitoring and retrieving the
...
func (future *VendorVirtualNetworkFunctionsCreateOrUpdateFuture) Result(client VendorVirtualNetworkFunctionsClient) (vvnf VendorVirtualNetworkFunction, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VendorVirtualNetworkFunctionsCreateOrUpdateFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		err = azure.NewAsyncOpIncompleteError("microsofthybridnetwork.VendorVirtualNetworkFunctionsCreateOrUpdateFuture")
		return
	}
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if vvnf.Response.Response, err = future.GetResult(sender); err == nil && vvnf.Response.Response.StatusCode != http.StatusNoContent {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VendorVirtualNetworkFunctionsCreateOrUpdateFuture", "Result", vvnf.Response.Response, "Failure responding to request")
		}
	}
	return
}
...
func (vnflr VirtualNetworkFunctionListResult) virtualNetworkFunctionListResultPreparer(ctx context.Context) (*http.Request, error) {
	if vnflr.NextLink == nil || len(to.String(vnflr.NextLink)) < 1 {
		return nil, nil
	}
	return autorest.Prepare((&http.Request{}).WithContext(ctx),
		autorest.AsJSON(),
...
// VirtualNetworkFunctionsCreateOrUpdateFuture an abstraction for monitoring and retrieving the results of
...
func (future *VirtualNetworkFunctionsCreateOrUpdateFuture) Result(client VirtualNetworkFunctionsClient) (vnf VirtualNetworkFunction, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VirtualNetworkFunctionsCreateOrUpdateFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		err = azure.NewAsyncOpIncompleteError("microsofthybridnetwork.VirtualNetworkFunctionsCreateOrUpdateFuture")
		return
	}
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if vnf.Response.Response, err = future.GetResult(sender); err == nil && vnf.Response.Response.StatusCode != http.StatusNoContent {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VirtualNetworkFunctionsCreateOrUpdateFuture", "Result", vnf.Response.Response, "Failure responding to request")
		}
	}
	return
}
...
func (future *VirtualNetworkFunctionsDeleteFuture) Result(client VirtualNetworkFunctionsClient) (ar autorest.Response, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VirtualNetworkFunctionsDeleteFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		err = azure.NewAsyncOpIncompleteError("microsofthybridnetwork.VirtualNetworkFunctionsDeleteFuture")
		return
	}
	ar.Response = future.Response()
	return
...
func (vnfsd VirtualNetworkFunctionSkuDetails) virtualNetworkFunctionSkuDetailsPreparer(ctx context.Context) (*http.Request, error) {
	if vnfsd.NextLink == nil || len(to.String(vnfsd.NextLink)) < 1 {
		return nil, nil
	}
	return autorest.Prepare((&http.Request{}).WithContext(ctx),
		autorest.AsJSON(),
...
func (vnfslr VirtualNetworkFunctionSkuListResult) virtualNetworkFunctionSkuListResultPreparer(ctx context.Context) (*http.Request, error) {
	if vnfslr.NextLink == nil || len(to.String(vnfslr.NextLink)) < 1 {
		return nil, nil
	}
	return autorest.Prepare((&http.Request{}).WithContext(ctx),
		autorest.AsJSON(),
...
func (vnfvlr VirtualNetworkFunctionVendorListResult) virtualNetworkFunctionVendorListResultPreparer(ctx context.Context) (*http.Request, error) {
	if vnfvlr.NextLink == nil || len(to.String(vnfvlr.NextLink)) < 1 {
		return nil, nil
	}
	return autorest.Prepare((&http.Request{}).WithContext(ctx),
		autorest.AsJSON(),
