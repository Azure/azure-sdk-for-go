...
// VendorsClient is the client for the Vendors methods of the Microsofthybridnetwork service.
...
func (client VendorsClient) CreateOrUpdate(ctx context.Context, vendorName string, parameters *Vendor) (result VendorsCreateOrUpdateFuture, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VendorsClient", "CreateOrUpdate", nil, "Failure preparing request")
		return
	}

	result, err = client.CreateOrUpdateSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VendorsClient", "CreateOrUpdate", result.Response(), "Failure sending request")
		return
	}
...
func (client VendorsClient) Delete(ctx context.Context, vendorName string) (result VendorsDeleteFuture, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VendorsClient", "Delete", nil, "Failure preparing request")
		return
	}

	result, err = client.DeleteSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VendorsClient", "Delete", result.Response(), "Failure sending request")
		return
	}
...
func (client VendorsClient) Get(ctx context.Context, vendorName string) (result Vendor, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VendorsClient", "Get", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VendorsClient", "Get", resp, "Failure sending request")
		return
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VendorsClient", "Get", resp, "Failure responding to request")
	}
...
func (client VendorsClient) ListBySubscription(ctx context.Context) (result VendorListResultPage, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VendorsClient", "ListBySubscription", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VendorsClient", "ListBySubscription", resp, "Failure sending request")
		return
	}

	result.vlr, err = client.ListBySubscriptionResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VendorsClient", "ListBySubscription", resp, "Failure responding to request")
	}
...
func (client VendorsClient) listBySubscriptionNextResults(ctx context.Context, lastResults VendorListResult) (result VendorListResult, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "microsofthybridnetwork.VendorsClient", "listBySubscriptionNextResults", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "microsofthybridnetwork.VendorsClient", "listBySubscriptionNextResults", resp, "Failure sending next results request")
	}
	result, err = client.ListBySubscriptionResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VendorsClient", "listBySubscriptionNextResults", resp, "Failure responding to next results request")
	}
	return
}
