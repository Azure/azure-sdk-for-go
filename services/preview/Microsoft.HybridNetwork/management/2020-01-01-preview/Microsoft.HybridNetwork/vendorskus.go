...
// VendorSkusClient is the client for the VendorSkus methods of the Microsofthybridnetwork service.
...
// parameters - parameters supplied to the create or update sku.
func (client VendorSkusClient) CreateOrUpdate(ctx context.Context, vendorName string, skuName string, parameters VendorSku) (result VendorSkusCreateOrUpdateFuture, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VendorSkusClient", "CreateOrUpdate", nil, "Failure preparing request")
		return
	}

	result, err = client.CreateOrUpdateSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VendorSkusClient", "CreateOrUpdate", result.Response(), "Failure sending request")
		return
	}
...
func (client VendorSkusClient) Delete(ctx context.Context, vendorName string, skuName string) (result VendorSkusDeleteFuture, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VendorSkusClient", "Delete", nil, "Failure preparing request")
		return
	}

	result, err = client.DeleteSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VendorSkusClient", "Delete", result.Response(), "Failure sending request")
		return
	}
...
func (client VendorSkusClient) Get(ctx context.Context, vendorName string, skuName string) (result VendorSku, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VendorSkusClient", "Get", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VendorSkusClient", "Get", resp, "Failure sending request")
		return
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VendorSkusClient", "Get", resp, "Failure responding to request")
	}
...
func (client VendorSkusClient) List(ctx context.Context, vendorName string) (result VendorSkuListResultPage, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VendorSkusClient", "List", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VendorSkusClient", "List", resp, "Failure sending request")
		return
	}

	result.vslr, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VendorSkusClient", "List", resp, "Failure responding to request")
	}
...
func (client VendorSkusClient) listNextResults(ctx context.Context, lastResults VendorSkuListResult) (result VendorSkuListResult, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "microsofthybridnetwork.VendorSkusClient", "listNextResults", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "microsofthybridnetwork.VendorSkusClient", "listNextResults", resp, "Failure sending next results request")
	}
	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VendorSkusClient", "listNextResults", resp, "Failure responding to next results request")
	}
	return
}
