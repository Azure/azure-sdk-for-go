...
// VendorVirtualNetworkFunctionsClient is the client for the VendorVirtualNetworkFunctions methods of the
// Microsofthybridnetwork service.
...
func (client VendorVirtualNetworkFunctionsClient) CreateOrUpdate(ctx context.Context, locationName string, vendorName string, serviceKey string, parameters VendorVirtualNetworkFunction) (result VendorVirtualNetworkFunctionsCreateOrUpdateFuture, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VendorVirtualNetworkFunctionsClient", "CreateOrUpdate", nil, "Failure preparing request")
		return
	}

	result, err = client.CreateOrUpdateSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VendorVirtualNetworkFunctionsClient", "CreateOrUpdate", result.Response(), "Failure sending request")
		return
	}
...
func (client VendorVirtualNetworkFunctionsClient) Get(ctx context.Context, locationName string, vendorName string, serviceKey string) (result VendorVirtualNetworkFunction, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VendorVirtualNetworkFunctionsClient", "Get", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VendorVirtualNetworkFunctionsClient", "Get", resp, "Failure sending request")
		return
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VendorVirtualNetworkFunctionsClient", "Get", resp, "Failure responding to request")
	}
...
func (client VendorVirtualNetworkFunctionsClient) List(ctx context.Context, locationName string, vendorName string, filter string) (result VendorVirtualNetworkFunctionListResultPage, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VendorVirtualNetworkFunctionsClient", "List", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VendorVirtualNetworkFunctionsClient", "List", resp, "Failure sending request")
		return
	}

	result.vvnflr, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VendorVirtualNetworkFunctionsClient", "List", resp, "Failure responding to request")
	}
...
func (client VendorVirtualNetworkFunctionsClient) listNextResults(ctx context.Context, lastResults VendorVirtualNetworkFunctionListResult) (result VendorVirtualNetworkFunctionListResult, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "microsofthybridnetwork.VendorVirtualNetworkFunctionsClient", "listNextResults", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "microsofthybridnetwork.VendorVirtualNetworkFunctionsClient", "listNextResults", resp, "Failure sending next results request")
	}
	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VendorVirtualNetworkFunctionsClient", "listNextResults", resp, "Failure responding to next results request")
	}
	return
}
