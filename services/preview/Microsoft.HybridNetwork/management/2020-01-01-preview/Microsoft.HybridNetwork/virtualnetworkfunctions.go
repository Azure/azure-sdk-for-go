...
// VirtualNetworkFunctionsClient is the client for the VirtualNetworkFunctions methods of the Microsofthybridnetwork
// service.
...
func (client VirtualNetworkFunctionsClient) CreateOrUpdate(ctx context.Context, resourceGroupName string, virtualNetworkFunctionName string, parameters VirtualNetworkFunction) (result VirtualNetworkFunctionsCreateOrUpdateFuture, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VirtualNetworkFunctionsClient", "CreateOrUpdate", nil, "Failure preparing request")
		return
	}

	result, err = client.CreateOrUpdateSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VirtualNetworkFunctionsClient", "CreateOrUpdate", result.Response(), "Failure sending request")
		return
	}
...
func (client VirtualNetworkFunctionsClient) Delete(ctx context.Context, resourceGroupName string, virtualNetworkFunctionName string) (result VirtualNetworkFunctionsDeleteFuture, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VirtualNetworkFunctionsClient", "Delete", nil, "Failure preparing request")
		return
	}

	result, err = client.DeleteSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VirtualNetworkFunctionsClient", "Delete", result.Response(), "Failure sending request")
		return
	}
...
func (client VirtualNetworkFunctionsClient) Get(ctx context.Context, resourceGroupName string, virtualNetworkFunctionName string) (result VirtualNetworkFunction, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VirtualNetworkFunctionsClient", "Get", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VirtualNetworkFunctionsClient", "Get", resp, "Failure sending request")
		return
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VirtualNetworkFunctionsClient", "Get", resp, "Failure responding to request")
	}
...
func (client VirtualNetworkFunctionsClient) ListByResourceGroup(ctx context.Context, resourceGroupName string) (result VirtualNetworkFunctionListResultPage, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VirtualNetworkFunctionsClient", "ListByResourceGroup", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VirtualNetworkFunctionsClient", "ListByResourceGroup", resp, "Failure sending request")
		return
	}

	result.vnflr, err = client.ListByResourceGroupResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VirtualNetworkFunctionsClient", "ListByResourceGroup", resp, "Failure responding to request")
	}
...
func (client VirtualNetworkFunctionsClient) listByResourceGroupNextResults(ctx context.Context, lastResults VirtualNetworkFunctionListResult) (result VirtualNetworkFunctionListResult, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "microsofthybridnetwork.VirtualNetworkFunctionsClient", "listByResourceGroupNextResults", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "microsofthybridnetwork.VirtualNetworkFunctionsClient", "listByResourceGroupNextResults", resp, "Failure sending next results request")
	}
	result, err = client.ListByResourceGroupResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VirtualNetworkFunctionsClient", "listByResourceGroupNextResults", resp, "Failure responding to next results request")
	}
	return
}
...
func (client VirtualNetworkFunctionsClient) ListBySubscription(ctx context.Context) (result VirtualNetworkFunctionListResultPage, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VirtualNetworkFunctionsClient", "ListBySubscription", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.vnflr.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VirtualNetworkFunctionsClient", "ListBySubscription", resp, "Failure sending request")
		return
	}

	result.vnflr, err = client.ListBySubscriptionResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VirtualNetworkFunctionsClient", "ListBySubscription", resp, "Failure responding to request")
	}
	if result.vnflr.hasNextLink() && result.vnflr.IsEmpty() {
		err = result.NextWithContext(ctx)
	}
...
func (client VirtualNetworkFunctionsClient) listBySubscriptionNextResults(ctx context.Context, lastResults VirtualNetworkFunctionListResult) (result VirtualNetworkFunctionListResult, err error) {
	req, err := lastResults.virtualNetworkFunctionListResultPreparer(ctx)
	if err != nil {
		return result, autorest.NewErrorWithError(err, "microsofthybridnetwork.VirtualNetworkFunctionsClient", "listBySubscriptionNextResults", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "microsofthybridnetwork.VirtualNetworkFunctionsClient", "listBySubscriptionNextResults", resp, "Failure sending next results request")
	}
	result, err = client.ListBySubscriptionResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VirtualNetworkFunctionsClient", "listBySubscriptionNextResults", resp, "Failure responding to next results request")
	}
	return
}
...
func (client VirtualNetworkFunctionsClient) UpdateTags(ctx context.Context, resourceGroupName string, virtualNetworkFunctionName string, parameters TagsObject) (result VirtualNetworkFunction, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VirtualNetworkFunctionsClient", "UpdateTags", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VirtualNetworkFunctionsClient", "UpdateTags", resp, "Failure sending request")
		return
	}

	result, err = client.UpdateTagsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VirtualNetworkFunctionsClient", "UpdateTags", resp, "Failure responding to request")
	}
