...
// VirtualNetworkFunctionVendorsClient is the client for the VirtualNetworkFunctionVendors methods of the
...
func (client VirtualNetworkFunctionVendorsClient) List(ctx context.Context) (result VirtualNetworkFunctionVendorListResultPage, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VirtualNetworkFunctionVendorsClient", "List", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VirtualNetworkFunctionVendorsClient", "List", resp, "Failure sending request")
		return
	}

	result.vnfvlr, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VirtualNetworkFunctionVendorsClient", "List", resp, "Failure responding to request")
	}
...
func (client VirtualNetworkFunctionVendorsClient) listNextResults(ctx context.Context, lastResults VirtualNetworkFunctionVendorListResult) (result VirtualNetworkFunctionVendorListResult, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "microsofthybridnetwork.VirtualNetworkFunctionVendorsClient", "listNextResults", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "microsofthybridnetwork.VirtualNetworkFunctionVendorsClient", "listNextResults", resp, "Failure sending next results request")
	}
	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VirtualNetworkFunctionVendorsClient", "listNextResults", resp, "Failure responding to next results request")
	}
	return
}
