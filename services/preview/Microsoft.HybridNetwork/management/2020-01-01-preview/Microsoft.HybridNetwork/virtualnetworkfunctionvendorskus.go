...
func (client VirtualNetworkFunctionVendorSkusClient) List(ctx context.Context, vendorName string, vendorSkuName string) (result VirtualNetworkFunctionSkuDetailsPage, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VirtualNetworkFunctionVendorSkusClient", "List", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VirtualNetworkFunctionVendorSkusClient", "List", resp, "Failure sending request")
		return
	}

	result.vnfsd, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VirtualNetworkFunctionVendorSkusClient", "List", resp, "Failure responding to request")
	}
...
func (client VirtualNetworkFunctionVendorSkusClient) listNextResults(ctx context.Context, lastResults VirtualNetworkFunctionSkuDetails) (result VirtualNetworkFunctionSkuDetails, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "microsofthybridnetwork.VirtualNetworkFunctionVendorSkusClient", "listNextResults", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "microsofthybridnetwork.VirtualNetworkFunctionVendorSkusClient", "listNextResults", resp, "Failure sending next results request")
	}
	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VirtualNetworkFunctionVendorSkusClient", "listNextResults", resp, "Failure responding to next results request")
	}
	return
}
...
func (client VirtualNetworkFunctionVendorSkusClient) ListByVendor(ctx context.Context, vendorName string) (result VirtualNetworkFunctionSkuListResultPage, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VirtualNetworkFunctionVendorSkusClient", "ListByVendor", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VirtualNetworkFunctionVendorSkusClient", "ListByVendor", resp, "Failure sending request")
		return
	}

	result.vnfslr, err = client.ListByVendorResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VirtualNetworkFunctionVendorSkusClient", "ListByVendor", resp, "Failure responding to request")
	}
...
func (client VirtualNetworkFunctionVendorSkusClient) listByVendorNextResults(ctx context.Context, lastResults VirtualNetworkFunctionSkuListResult) (result VirtualNetworkFunctionSkuListResult, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "microsofthybridnetwork.VirtualNetworkFunctionVendorSkusClient", "listByVendorNextResults", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "microsofthybridnetwork.VirtualNetworkFunctionVendorSkusClient", "listByVendorNextResults", resp, "Failure sending next results request")
	}
	result, err = client.ListByVendorResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "microsofthybridnetwork.VirtualNetworkFunctionVendorSkusClient", "listByVendorNextResults", resp, "Failure responding to next results request")
	}
	return
}
