...
type AccountProperties struct {
	...
	// ProvisioningState - READ-ONLY; Gets the status of the account at the time the operation was called. Possible values include: 'Succeeded', 'Failed', 'Canceled', 'Provisioning', 'Deleting'
...
type DataPoolBaseProperties struct {
	...
	// ProvisioningState - READ-ONLY; Gets the status of the data pool at the time the operation was called. Possible values include: 'Succeeded', 'Failed', 'Canceled', 'Provisioning', 'Deleting'
	ProvisioningState ProvisioningState `json:"provisioningState,omitempty"`
...
func NewDataPoolListPage(getNextPage func(context.Context, DataPoolList) (DataPoolList, error)) DataPoolListPage {
	return DataPoolListPage{fn: getNextPage}
}
