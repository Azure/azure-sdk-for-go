...
func (client AccountsClient) CheckNameAvailability(ctx context.Context, parameters AccountCheckNameAvailabilityParameters) (result CheckNameAvailabilityResult, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		{TargetValue: parameters,
			Constraints: []validation.Constraint{{Target: "parameters.Name", Name: validation.Null, Rule: true,
				Chain: []validation.Constraint{{Target: "parameters.Name", Name: validation.Pattern, Rule: `^[a-zA-Z0-9]+(-[a-zA-Z0-9]+)*`, Chain: nil}}},
				{Target: "parameters.Type", Name: validation.Null, Rule: true, Chain: nil}}}}); err != nil {
		return result, validation.NewError("adp.AccountsClient", "CheckNameAvailability", err.Error())
	}

	req, err := client.CheckNameAvailabilityPreparer(ctx, parameters)
	if err != nil {
		err = autorest.NewErrorWithError(err, "adp.AccountsClient", "CheckNameAvailability", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "adp.AccountsClient", "CheckNameAvailability", resp, "Failure sending request")
		return
	}

	result, err = client.CheckNameAvailabilityResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "adp.AccountsClient", "CheckNameAvailability", resp, "Failure responding to request")
		return
	}
...
func (client AccountsClient) CheckNameAvailabilityPreparer(ctx context.Context, parameters AccountCheckNameAvailabilityParameters) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithPathParameters("/subscriptions/{subscriptionId}/providers/Microsoft.AutonomousDevelopmentPlatform/checkNameAvailability", pathParameters),
...
func (client AccountsClient) CreateOrUpdate(ctx context.Context, resourceGroupName string, accountName string, parameters *Account) (result AccountsCreateOrUpdateFuture, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "adp.AccountsClient", "CreateOrUpdate", nil, "Failure sending request")
		return
	}
...
func (client AccountsClient) CreateOrUpdateSender(req *http.Request) (future AccountsCreateOrUpdateFuture, err error) {
	...
	future.Result = func(client AccountsClient) (a Account, err error) {
		...
		if a.Response.Response == nil && err == nil {
			err = autorest.NewErrorWithError(err, "adp.AccountsCreateOrUpdateFuture", "Result", nil, "received nil response and error")
		}
...
func (client AccountsClient) Delete(ctx context.Context, resourceGroupName string, accountName string) (result AccountsDeleteFuture, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "adp.AccountsClient", "Delete", nil, "Failure sending request")
		return
	}
...
func (client AccountsClient) Update(ctx context.Context, resourceGroupName string, accountName string, parameters *AccountPatch) (result AccountsUpdateFuture, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "adp.AccountsClient", "Update", nil, "Failure sending request")
		return
	}
...
func (client AccountsClient) UpdateSender(req *http.Request) (future AccountsUpdateFuture, err error) {
	...
	future.Result = func(client AccountsClient) (a Account, err error) {
		...
		a.Response.Response, err = future.GetResult(sender)
		if a.Response.Response == nil && err == nil {
			err = autorest.NewErrorWithError(err, "adp.AccountsUpdateFuture", "Result", nil, "received nil response and error")
		}
		if err == nil && a.Response.Response.StatusCode != http.StatusNoContent {
