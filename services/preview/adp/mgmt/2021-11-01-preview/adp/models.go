...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/preview/adp/mgmt/2021-11-01-preview/adp"
...
type CheckNameAvailabilityResult struct {
	...
	// Reason - READ-ONLY; Gets the reason that an account name could not be used. The reason element is only returned if nameAvailable is false. Possible values include: 'Invalid', 'AlreadyExists'
...
type DataPoolEncryption struct {
	// KeyVaultURI - The URI of a soft delete-enabled Key Vault that is in the same location as the Data Pool location
	KeyVaultURI *string `json:"keyVaultUri,omitempty"`
	// KeyName - The name of Key Vault key
	KeyName *string `json:"keyName,omitempty"`
	// KeyVersion - The version of Key Vault key
	KeyVersion *string `json:"keyVersion,omitempty"`
	// UserAssignedIdentity - The resource ID of a user-assigned Managed Identity used to access the encryption key in the Key Vault. Requires access to the key operations get, wrap, unwrap, and recover
...
type DataPoolLocation struct {
	...
	Name *string `json:"name,omitempty"`
	// Encryption - Encryption properties of a Data Pool location
	Encryption *DataPoolEncryption `json:"encryption,omitempty"`
	// StorageSku - The Storage SKU. Default: Standard_ZRS.
	StorageSku *StorageSku `json:"storageSku,omitempty"`
	// StorageAccountCount - The amount of storage accounts provisioned per Data Pool. Default: 5
...
// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *DataPoolsCreateOrUpdateFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for DataPoolsCreateOrUpdateFuture.Result.
...
// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *DataPoolsDeleteFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for DataPoolsDeleteFuture.Result.
...
// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *DataPoolsUpdateFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for DataPoolsUpdateFuture.Result.
...
func (o Operation) MarshalJSON() ([]byte, error) {
	...
	if o.ActionType != nil {
		objectMap["actionType"] = o.ActionType
	}
	if o.Display != nil {
...
type StorageSku struct {
	// Name - The SKU name. Possible values include: 'StandardLRS', 'StandardGRS', 'StandardRagrs', 'StandardZRS', 'PremiumLRS', 'PremiumZRS', 'StandardGzrs', 'StandardRagzrs'
