...
func NewActionRulesClient(subscriptionID string, subscriptionID1 string) ActionRulesClient {
	return NewActionRulesClientWithBaseURI(DefaultBaseURI, subscriptionID, subscriptionID1)
}
...
func NewActionRulesClientWithBaseURI(baseURI string, subscriptionID string, subscriptionID1 string) ActionRulesClient {
	return ActionRulesClient{NewWithBaseURI(baseURI, subscriptionID, subscriptionID1)}
}
