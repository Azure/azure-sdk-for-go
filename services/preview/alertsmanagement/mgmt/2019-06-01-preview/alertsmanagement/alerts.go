...
func NewAlertsClient(subscriptionID string, subscriptionID1 string) AlertsClient {
	return NewAlertsClientWithBaseURI(DefaultBaseURI, subscriptionID, subscriptionID1)
}
...
func NewAlertsClientWithBaseURI(baseURI string, subscriptionID string, subscriptionID1 string) AlertsClient {
	return AlertsClient{NewWithBaseURI(baseURI, subscriptionID, subscriptionID1)}
}
