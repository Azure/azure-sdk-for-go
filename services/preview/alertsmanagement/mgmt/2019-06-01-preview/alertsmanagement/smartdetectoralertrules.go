...
func NewSmartDetectorAlertRulesClient(subscriptionID string, subscriptionID1 string) SmartDetectorAlertRulesClient {
	return NewSmartDetectorAlertRulesClientWithBaseURI(DefaultBaseURI, subscriptionID, subscriptionID1)
}
...
// Azure stack).
func NewSmartDetectorAlertRulesClientWithBaseURI(baseURI string, subscriptionID string, subscriptionID1 string) SmartDetectorAlertRulesClient {
	return SmartDetectorAlertRulesClient{NewWithBaseURI(baseURI, subscriptionID, subscriptionID1)}
}
