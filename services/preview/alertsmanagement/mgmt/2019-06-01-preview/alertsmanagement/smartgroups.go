...
func NewSmartGroupsClient(subscriptionID string, subscriptionID1 string) SmartGroupsClient {
	return NewSmartGroupsClientWithBaseURI(DefaultBaseURI, subscriptionID, subscriptionID1)
}
...
func NewSmartGroupsClientWithBaseURI(baseURI string, subscriptionID string, subscriptionID1 string) SmartGroupsClient {
	return SmartGroupsClient{NewWithBaseURI(baseURI, subscriptionID, subscriptionID1)}
}
