...
func PossibleExportFormatValues() [3]ExportFormat {
	return [3]ExportFormat{ExportFormatSwagger, ExportFormatWadl, ExportFormatWsdl}
}
...
func PossiblePolicyContentFormatValues() [2]PolicyContentFormat {
	return [2]PolicyContentFormat{XML, XMLLink}
}
...
func PossibleSoapAPITypeValues() [2]SoapAPIType {
	return [2]SoapAPIType{SoapPassThrough, SoapToRest}
}
...
func PossibleVersioningScheme1Values() [3]VersioningScheme1 {
	return [3]VersioningScheme1{VersioningScheme1Header, VersioningScheme1Query, VersioningScheme1Segment}
}
