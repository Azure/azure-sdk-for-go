...
type APIContractProperties struct {
	...
	// APIType - Type of API. Possible values include: 'HTTP', 'Soap', 'Websocket'
...
type APICreateOrUpdateProperties struct {
	...
	//  * `websocket` creates websocket API. Possible values include: 'SoapToRest', 'SoapPassThrough', 'WebSocket'
