...
func NewKeyValueListResultPage(getNextPage func(context.Context, KeyValueListResult) (KeyValueListResult, error)) KeyValueListResultPage {
	return KeyValueListResultPage{fn: getNextPage}
}
