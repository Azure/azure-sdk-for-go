...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/preview/appconfiguration/mgmt/2021-10-01-preview/appconfiguration"
...
type ConfigurationStoreProperties struct {
	...
	// CreateMode - Indicates whether the configuration store need to be recovered. Possible values include: 'CreateModeRecover', 'CreateModeDefault'
...
func (csp ConfigurationStoreProperties) MarshalJSON() ([]byte, error) {
	...
	if csp.SoftDeleteRetentionInDays != nil {
		objectMap["softDeleteRetentionInDays"] = csp.SoftDeleteRetentionInDays
	}
	if csp.EnablePurgeProtection != nil {
		objectMap["enablePurgeProtection"] = csp.EnablePurgeProtection
	}
	if csp.CreateMode != "" {
		objectMap["createMode"] = csp.CreateMode
	}
	return json.Marshal(objectMap)
}
...
// ConfigurationStoresPurgeDeletedFuture an abstraction for monitoring and retrieving the results of a
// long-running operation.
type ConfigurationStoresPurgeDeletedFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(ConfigurationStoresClient) (autorest.Response, error)
...
// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *ConfigurationStoresPurgeDeletedFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for ConfigurationStoresPurgeDeletedFuture.Result.
func (future *ConfigurationStoresPurgeDeletedFuture) result(client ConfigurationStoresClient) (ar autorest.Response, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "appconfiguration.ConfigurationStoresPurgeDeletedFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		ar.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("appconfiguration.ConfigurationStoresPurgeDeletedFuture")
		return
	}
	ar.Response = future.Response()
	return
...
type DeletedConfigurationStore struct {
	autorest.Response `json:"-"`
	// ID - READ-ONLY; The resource ID for the deleted configuration store.
	ID *string `json:"id,omitempty"`
	// Name - READ-ONLY; The name of the configuration store.
	Name *string `json:"name,omitempty"`
	// Type - READ-ONLY; The resource type of the configuration store.
	Type *string `json:"type,omitempty"`
	// DeletedConfigurationStoreProperties - Properties of the deleted configuration store
	*DeletedConfigurationStoreProperties `json:"properties,omitempty"`
}

// MarshalJSON is the custom marshaler for DeletedConfigurationStore.
func (dcs DeletedConfigurationStore) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if dcs.DeletedConfigurationStoreProperties != nil {
		objectMap["properties"] = dcs.DeletedConfigurationStoreProperties
	}
	return json.Marshal(objectMap)
}

// UnmarshalJSON is the custom unmarshaler for DeletedConfigurationStore struct.
func (dcs *DeletedConfigurationStore) UnmarshalJSON(body []byte) error {
	var m map[string]*json.RawMessage
	err := json.Unmarshal(body, &m)
	if err != nil {
		return err
	...
	for k, v := range m {
		...
		case "properties":
			if v != nil {
				var deletedConfigurationStoreProperties DeletedConfigurationStoreProperties
				err = json.Unmarshal(*v, &deletedConfigurationStoreProperties)
				if err != nil {
					return err
				}
				dcs.DeletedConfigurationStoreProperties = &deletedConfigurationStoreProperties
			}
		}
	}
...
type DeletedConfigurationStoreListResult struct {
	...
	// NextLink - The URL to get the next set of deleted configuration stores.
	NextLink *string `json:"nextLink,omitempty"`
}

// DeletedConfigurationStoreListResultIterator provides access to a complete listing of
// DeletedConfigurationStore values.
type DeletedConfigurationStoreListResultIterator struct {
	i    int
	page DeletedConfigurationStoreListResultPage
}

// NextWithContext advances to the next value.  If there was an error making
// the request the iterator does not advance and the error is returned.
func (iter *DeletedConfigurationStoreListResultIterator) NextWithContext(ctx context.Context) (err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/DeletedConfigurationStoreListResultIterator.NextWithContext")
		defer func() {
			sc := -1
			if iter.Response().Response.Response != nil {
				sc = iter.Response().Response.Response.StatusCode
...
// the request the iterator does not advance and the error is returned.
// Deprecated: Use NextWithContext() instead.
func (iter *DeletedConfigurationStoreListResultIterator) Next() error {
	return iter.NextWithContext(context.Background())
}

// NotDone returns true if the enumeration should be started or is not yet complete.
func (iter DeletedConfigurationStoreListResultIterator) NotDone() bool {
	return iter.page.NotDone() && iter.i < len(iter.page.Values())
}

// Response returns the raw server response from the last page request.
func (iter DeletedConfigurationStoreListResultIterator) Response() DeletedConfigurationStoreListResult {
	return iter.page.Response()
}

// Value returns the current value or a zero-initialized value if the
// iterator has advanced beyond the end of the collection.
func (iter DeletedConfigurationStoreListResultIterator) Value() DeletedConfigurationStore {
	if !iter.page.NotDone() {
		return DeletedConfigurationStore{}
	}
	return iter.page.Values()[iter.i]
}

// Creates a new instance of the DeletedConfigurationStoreListResultIterator type.
func NewDeletedConfigurationStoreListResultIterator(page DeletedConfigurationStoreListResultPage) DeletedConfigurationStoreListResultIterator {
	return DeletedConfigurationStoreListResultIterator{page: page}
}

// IsEmpty returns true if the ListResult contains no values.
func (dcslr DeletedConfigurationStoreListResult) IsEmpty() bool {
	return dcslr.Value == nil || len(*dcslr.Value) == 0
}

// hasNextLink returns true if the NextLink is not empty.
func (dcslr DeletedConfigurationStoreListResult) hasNextLink() bool {
	return dcslr.NextLink != nil && len(*dcslr.NextLink) != 0
}

// deletedConfigurationStoreListResultPreparer prepares a request to retrieve the next set of results.
// It returns nil if no more results exist.
func (dcslr DeletedConfigurationStoreListResult) deletedConfigurationStoreListResultPreparer(ctx context.Context) (*http.Request, error) {
...
// DeletedConfigurationStoreListResultPage contains a page of DeletedConfigurationStore values.
type DeletedConfigurationStoreListResultPage struct {
	fn    func(context.Context, DeletedConfigurationStoreListResult) (DeletedConfigurationStoreListResult, error)
	dcslr DeletedConfigurationStoreListResult
}

// NextWithContext advances to the next page of values.  If there was an error making
// the request the page does not advance and the error is returned.
func (page *DeletedConfigurationStoreListResultPage) NextWithContext(ctx context.Context) (err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/DeletedConfigurationStoreListResultPage.NextWithContext")
		defer func() {
			sc := -1
			if page.Response().Response.Response != nil {
				sc = page.Response().Response.Response.StatusCode
...
// the request the page does not advance and the error is returned.
// Deprecated: Use NextWithContext() instead.
func (page *DeletedConfigurationStoreListResultPage) Next() error {
	return page.NextWithContext(context.Background())
}

// NotDone returns true if the page enumeration should be started or is not yet complete.
func (page DeletedConfigurationStoreListResultPage) NotDone() bool {
	return !page.dcslr.IsEmpty()
}

// Response returns the raw server response from the last page request.
func (page DeletedConfigurationStoreListResultPage) Response() DeletedConfigurationStoreListResult {
	return page.dcslr
}
...
// Creates a new instance of the DeletedConfigurationStoreListResultPage type.
func NewDeletedConfigurationStoreListResultPage(cur DeletedConfigurationStoreListResult, getNextPage func(context.Context, DeletedConfigurationStoreListResult) (DeletedConfigurationStoreListResult, error)) DeletedConfigurationStoreListResultPage {
	return DeletedConfigurationStoreListResultPage{
		fn:    getNextPage,
		dcslr: cur,
	}
}
...
type DeletedConfigurationStoreProperties struct {
	// ConfigurationStoreID - READ-ONLY; The resource id of the original configuration store.
	ConfigurationStoreID *string `json:"configurationStoreId,omitempty"`
	// Location - READ-ONLY; The location of the original configuration store.
	Location *string `json:"location,omitempty"`
	...
	// Tags - READ-ONLY; Tags of the original configuration store.
	Tags map[string]*string `json:"tags"`
	// PurgeProtectionEnabled - READ-ONLY; Purge protection status of the original configuration store.
	PurgeProtectionEnabled *bool `json:"purgeProtectionEnabled,omitempty"`
}

// MarshalJSON is the custom marshaler for DeletedConfigurationStoreProperties.
func (dcsp DeletedConfigurationStoreProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	return json.Marshal(objectMap)
}
