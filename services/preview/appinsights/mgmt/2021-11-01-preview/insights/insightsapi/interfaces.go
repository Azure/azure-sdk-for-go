...
type OperationsClientAPI interface {
	...
	List1(ctx context.Context) (result insights.OperationsListResultPage, err error)
	List1Complete(ctx context.Context) (result insights.OperationsListResultIterator, err error)
}
