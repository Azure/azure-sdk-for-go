...
// PostClient is the composite Swagger for Application Insights Data Client
...
// portal.
func (client PostClient) Metadata(ctx context.Context, appID string) (result MetadataResults, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "insights.PostClient", "Metadata", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "insights.PostClient", "Metadata", resp, "Failure sending request")
		return
	}

	result, err = client.MetadataResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "insights.PostClient", "Metadata", resp, "Failure responding to request")
	}
...
func (client PostClient) MetadataPreparer(ctx context.Context, appID string) (*http.Request, error) {
