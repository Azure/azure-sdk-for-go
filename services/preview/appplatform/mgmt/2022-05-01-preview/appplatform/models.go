...
type APIPortalProperties struct {
	// ProvisioningState - READ-ONLY; State of the API portal. Possible values include: 'Creating', 'Updating', 'Succeeded', 'Failed', 'Deleting'
...
type BuildpackBindingProperties struct {
	// BindingType - Buildpack Binding Type. Possible values include: 'ApplicationInsights', 'ApacheSkyWalking', 'AppDynamics', 'Dynatrace', 'NewRelic', 'ElasticAPM'
...
type BuildResultUserSourceInfo struct {
	...
	// Type - Possible values include: 'TypeUserSourceInfo', 'TypeUploadedUserSourceInfo', 'TypeJar', 'TypeSource', 'TypeNetCoreZip', 'TypeBuildResult', 'TypeContainer'
...
type CertificateProperties struct {
	...
	// Type - Possible values include: 'TypeCertificateProperties', 'TypeKeyVaultCertificate', 'TypeContentCertificate'
...
func unmarshalBasicCertificateProperties(body []byte) (BasicCertificateProperties, error) {
	...
	switch m["type"] {
	case string(TypeKeyVaultCertificate):
		var kvcp KeyVaultCertificateProperties
		err := json.Unmarshal(body, &kvcp)
		return kvcp, err
	case string(TypeContentCertificate):
...
func (cp CertificateProperties) MarshalJSON() ([]byte, error) {
	cp.Type = TypeCertificateProperties
	objectMap := make(map[string]interface{})
	if cp.Type != "" {
...
func (ccp ContentCertificateProperties) MarshalJSON() ([]byte, error) {
	ccp.Type = TypeContentCertificate
	objectMap := make(map[string]interface{})
	if ccp.Content != nil {
...
type DeploymentResourceProperties struct {
	...
	// Status - READ-ONLY; Status of the Deployment. Possible values include: 'Stopped', 'Running'
...
type ExecAction struct {
	...
	Command *[]string `json:"command,omitempty"`
	// Type - Possible values include: 'TypeProbeAction', 'TypeHTTPGetAction', 'TypeExecAction', 'TypeTCPSocketAction'
...
type HTTPGetAction struct {
	...
	//  - `"HTTPS"` means that the scheme used will be https://. Possible values include: 'HTTP', 'HTTPS'
...
func (kvcp KeyVaultCertificateProperties) MarshalJSON() ([]byte, error) {
	kvcp.Type = TypeKeyVaultCertificate
	objectMap := make(map[string]interface{})
...
func unmarshalBasicProbeAction(body []byte) (BasicProbeAction, error) {
	...
	switch m["type"] {
	case string(TypeHTTPGetAction):
		var hga HTTPGetAction
		err := json.Unmarshal(body, &hga)
		return hga, err
	case string(TypeExecAction):
		var ea ExecAction
		err := json.Unmarshal(body, &ea)
		return ea, err
	case string(TypeTCPSocketAction):
...
type SupportedRuntimeVersion struct {
	// Value - The raw value which could be passed to deployment CRUD operations. Possible values include: 'Java8', 'Java11', 'Java17', 'NetCore31'
...
func (uusi UploadedUserSourceInfo) MarshalJSON() ([]byte, error) {
	uusi.Type = TypeUploadedUserSourceInfo
	objectMap := make(map[string]interface{})
...
func unmarshalBasicUserSourceInfo(body []byte) (BasicUserSourceInfo, error) {
	...
	switch m["type"] {
	case string(TypeUploadedUserSourceInfo):
		var uusi UploadedUserSourceInfo
		err := json.Unmarshal(body, &uusi)
		return uusi, err
	case string(TypeJar):
