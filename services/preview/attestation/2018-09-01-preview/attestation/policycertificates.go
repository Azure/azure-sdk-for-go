...
// policyCertificateToAdd - an RFC7519 JSON Web Token containing a claim named "aas-policyCertificate" whose
...
// Parameters:
// tenantBaseURL - the tenant name, for example https://mytenant.attest.azure.net.
// policyCertificateToRemove - an RFC7519 JSON Web Token containing a claim named "aas-policyCertificate" whose
