...
type RoleAssignmentProperties struct {
	...
	PrincipalID *string `json:"principalId,omitempty"`
	// PrincipalType - The principal type of the assigned principal ID. Possible values include: 'PrincipalTypeUser', 'PrincipalTypeGroup', 'PrincipalTypeServicePrincipal', 'PrincipalTypeUnknown', 'PrincipalTypeDirectoryRoleTemplate', 'PrincipalTypeForeignGroup', 'PrincipalTypeApplication', 'PrincipalTypeMSI', 'PrincipalTypeDirectoryObjectOrGroup', 'PrincipalTypeEveryone', 'PrincipalTypeDevice'
...
type RoleAssignmentScheduleInstanceProperties struct {
	...
	// AssignmentType - Assignment type of the role assignment schedule. Possible values include: 'Activated', 'Assigned'
