...
func (client RoleAssignmentsClient) ListForResource(ctx context.Context, resourceGroupName string, resourceProviderNamespace string, resourceType string, resourceName string, filter string) (result RoleAssignmentListResultPage, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.ListForResourcePreparer(ctx, resourceGroupName, resourceProviderNamespace, resourceType, resourceName, filter)
	if err != nil {
...
func (client RoleAssignmentsClient) ListForResourcePreparer(ctx context.Context, resourceGroupName string, resourceProviderNamespace string, resourceType string, resourceName string, filter string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
...
func (client RoleAssignmentsClient) ListForResourceComplete(ctx context.Context, resourceGroupName string, resourceProviderNamespace string, resourceType string, resourceName string, filter string) (result RoleAssignmentListResultIterator, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/RoleAssignmentsClient.ListForResource")
		defer func() {
			sc := -1
	...
	result.page, err = client.ListForResource(ctx, resourceGroupName, resourceProviderNamespace, resourceType, resourceName, filter)
	return
}
...
// above the scope. Use $filter=principalId eq {id} to return all role assignments at, above or below the scope
// for the specified principal.
func (client RoleAssignmentsClient) ListForSubscription(ctx context.Context, filter string) (result RoleAssignmentListResultPage, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.ListForSubscriptionPreparer(ctx, filter)
	if err != nil {
...
func (client RoleAssignmentsClient) ListForSubscriptionPreparer(ctx context.Context, filter string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"subscriptionId": autorest.Encode("path", client.SubscriptionID),
	}
...
func (client RoleAssignmentsClient) ListForSubscriptionComplete(ctx context.Context, filter string) (result RoleAssignmentListResultIterator, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/RoleAssignmentsClient.ListForSubscription")
		defer func() {
			sc := -1
	...
	result.page, err = client.ListForSubscription(ctx, filter)
	return
}
