...
type PrivateEndpointConnectionsClientAPI interface {
	CreateOrUpdate(ctx context.Context, resourceGroupName string, automationAccountName string, privateEndpointConnectionName string, parameters automation.PrivateEndpointConnection) (result automation.PrivateEndpointConnectionsCreateOrUpdateFuture, err error)
	Delete(ctx context.Context, resourceGroupName string, automationAccountName string, privateEndpointConnectionName string) (result automation.PrivateEndpointConnectionsDeleteFuture, err error)
	Get(ctx context.Context, resourceGroupName string, automationAccountName string, privateEndpointConnectionName string) (result automation.PrivateEndpointConnection, err error)
	ListByAutomationAccount(ctx context.Context, resourceGroupName string, automationAccountName string) (result automation.PrivateEndpointConnectionListResult, err error)
}

var _ PrivateEndpointConnectionsClientAPI = (*automation.PrivateEndpointConnectionsClient)(nil)

// PrivateLinkResourcesClientAPI contains the set of methods on the PrivateLinkResourcesClient type.
type PrivateLinkResourcesClientAPI interface {
	Method(ctx context.Context, resourceGroupName string, automationAccountName string) (result automation.PrivateLinkResourceListResult, err error)
}

var _ PrivateLinkResourcesClientAPI = (*automation.PrivateLinkResourcesClient)(nil)
