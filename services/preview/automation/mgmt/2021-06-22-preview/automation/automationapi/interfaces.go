...
type BaseClientAPI interface {
	ConvertGraphRunbookContent(ctx context.Context, resourceGroupName string, automationAccountName string, parameters automation.GraphicalRunbookContent) (result automation.GraphicalRunbookContent, err error)
}

var _ BaseClientAPI = (*automation.BaseClient)(nil)
...
type HybridRunbookWorkerGroupClientAPI interface {
	Create(ctx context.Context, resourceGroupName string, automationAccountName string, hybridRunbookWorkerGroupName string, hybridRunbookWorkerGroupCreationParameters automation.HybridRunbookWorkerGroupCreateOrUpdateParameters) (result automation.HybridRunbookWorkerGroup, err error)
	...
	Update(ctx context.Context, resourceGroupName string, automationAccountName string, hybridRunbookWorkerGroupName string, parameters automation.HybridRunbookWorkerGroupCreateOrUpdateParameters) (result automation.HybridRunbookWorkerGroup, err error)
}
...
// HybridRunbookWorkersClientAPI contains the set of methods on the HybridRunbookWorkersClient type.
type HybridRunbookWorkersClientAPI interface {
	Create(ctx context.Context, resourceGroupName string, automationAccountName string, hybridRunbookWorkerGroupName string, hybridRunbookWorkerID string, hybridRunbookWorkerCreationParameters automation.HybridRunbookWorkerCreateParameters) (result automation.HybridRunbookWorker, err error)
	Delete(ctx context.Context, resourceGroupName string, automationAccountName string, hybridRunbookWorkerGroupName string, hybridRunbookWorkerID string) (result autorest.Response, err error)
	Get(ctx context.Context, resourceGroupName string, automationAccountName string, hybridRunbookWorkerGroupName string, hybridRunbookWorkerID string) (result automation.HybridRunbookWorker, err error)
	ListByHybridRunbookWorkerGroup(ctx context.Context, resourceGroupName string, automationAccountName string, hybridRunbookWorkerGroupName string, filter string) (result automation.HybridRunbookWorkersListResultPage, err error)
	ListByHybridRunbookWorkerGroupComplete(ctx context.Context, resourceGroupName string, automationAccountName string, hybridRunbookWorkerGroupName string, filter string) (result automation.HybridRunbookWorkersListResultIterator, err error)
	Move(ctx context.Context, resourceGroupName string, automationAccountName string, hybridRunbookWorkerGroupName string, hybridRunbookWorkerID string, hybridRunbookWorkerMoveParameters automation.HybridRunbookWorkerMoveParameters) (result autorest.Response, err error)
}

var _ HybridRunbookWorkersClientAPI = (*automation.HybridRunbookWorkersClient)(nil)
