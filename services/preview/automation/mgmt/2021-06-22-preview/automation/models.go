...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/preview/automation/mgmt/2021-06-22-preview/automation"
...
func (ap AccountProperties) MarshalJSON() ([]byte, error) {
	...
	if ap.AutomationHybridServiceURL != nil {
		objectMap["automationHybridServiceUrl"] = ap.AutomationHybridServiceURL
	}
	return json.Marshal(objectMap)
}
...
func (hrw HybridRunbookWorker) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if hrw.HybridRunbookWorkerProperties != nil {
		objectMap["properties"] = hrw.HybridRunbookWorkerProperties
	}
	if hrw.SystemData != nil {
		objectMap["systemData"] = hrw.SystemData
	}
	return json.Marshal(objectMap)
}
...
func (hrw *HybridRunbookWorker) UnmarshalJSON(body []byte) error {
	...
	for k, v := range m {
		...
		case "properties":
			if v != nil {
				var hybridRunbookWorkerProperties HybridRunbookWorkerProperties
				err = json.Unmarshal(*v, &hybridRunbookWorkerProperties)
				if err != nil {
					return err
				}
				hrw.HybridRunbookWorkerProperties = &hybridRunbookWorkerProperties
			}
		case "systemData":
			if v != nil {
				var systemData SystemData
...
// HybridRunbookWorkerCreateOrUpdateParameters the parameters supplied to the create or update hybrid
// runbook worker operation.
...
// HybridRunbookWorkerCreateParameters the parameters supplied to the create hybrid runbook worker
// operation.
...
func (hrwcp HybridRunbookWorkerCreateParameters) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if hrwcp.HybridRunbookWorkerCreateOrUpdateParameters != nil {
		objectMap["properties"] = hrwcp.HybridRunbookWorkerCreateOrUpdateParameters
	}
	if hrwcp.Name != nil {
		objectMap["name"] = hrwcp.Name
	}
	return json.Marshal(objectMap)
}
...
func (hrwcp *HybridRunbookWorkerCreateParameters) UnmarshalJSON(body []byte) error {
	...
	for k, v := range m {
		...
		case "properties":
			if v != nil {
				var hybridRunbookWorkerCreateOrUpdateParameters HybridRunbookWorkerCreateOrUpdateParameters
				err = json.Unmarshal(*v, &hybridRunbookWorkerCreateOrUpdateParameters)
				if err != nil {
					return err
				}
				hrwcp.HybridRunbookWorkerCreateOrUpdateParameters = &hybridRunbookWorkerCreateOrUpdateParameters
			}
		case "name":
			if v != nil {
				var name string
...
func (hrwg HybridRunbookWorkerGroup) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if hrwg.ID != nil {
		objectMap["id"] = hrwg.ID
	}
	if hrwg.Name != nil {
		objectMap["name"] = hrwg.Name
	}
	if hrwg.HybridRunbookWorkers != nil {
		objectMap["hybridRunbookWorkers"] = hrwg.HybridRunbookWorkers
	}
	if hrwg.Credential != nil {
		objectMap["credential"] = hrwg.Credential
	}
	if hrwg.GroupType != "" {
		objectMap["groupType"] = hrwg.GroupType
	}
	if hrwg.SystemData != nil {
		objectMap["systemData"] = hrwg.SystemData
	}
	return json.Marshal(objectMap)
}

// HybridRunbookWorkerGroupCreateOrUpdateParameters the parameters supplied to the create or update hybrid
// runbook worker group operation.
...
// HybridRunbookWorkersListResultIterator provides access to a complete listing of HybridRunbookWorker
// values.
type HybridRunbookWorkersListResultIterator struct {
	i    int
	page HybridRunbookWorkersListResultPage
}
...
func (iter *HybridRunbookWorkersListResultIterator) NextWithContext(ctx context.Context) (err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/HybridRunbookWorkersListResultIterator.NextWithContext")
		defer func() {
			sc := -1
			if iter.Response().Response.Response != nil {
				sc = iter.Response().Response.Response.StatusCode
...
func NewHybridRunbookWorkersListResultIterator(page HybridRunbookWorkersListResultPage) HybridRunbookWorkersListResultIterator {
	return HybridRunbookWorkersListResultIterator{page: page}
}

// IsEmpty returns true if the ListResult contains no values.
func (hrwlr HybridRunbookWorkersListResult) IsEmpty() bool {
	return hrwlr.Value == nil || len(*hrwlr.Value) == 0
}

// hasNextLink returns true if the NextLink is not empty.
func (hrwlr HybridRunbookWorkersListResult) hasNextLink() bool {
	return hrwlr.NextLink != nil && len(*hrwlr.NextLink) != 0
}

// hybridRunbookWorkersListResultPreparer prepares a request to retrieve the next set of results.
// It returns nil if no more results exist.
func (hrwlr HybridRunbookWorkersListResult) hybridRunbookWorkersListResultPreparer(ctx context.Context) (*http.Request, error) {
	if !hrwlr.hasNextLink() {
		return nil, nil
	}
	return autorest.Prepare((&http.Request{}).WithContext(ctx),
		autorest.AsJSON(),
		autorest.AsGet(),
		autorest.WithBaseURL(to.String(hrwlr.NextLink)))
}
...
type HybridRunbookWorkersListResultPage struct {
	fn    func(context.Context, HybridRunbookWorkersListResult) (HybridRunbookWorkersListResult, error)
	hrwlr HybridRunbookWorkersListResult
}
...
func (page *HybridRunbookWorkersListResultPage) NextWithContext(ctx context.Context) (err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/HybridRunbookWorkersListResultPage.NextWithContext")
		defer func() {
			sc := -1
			if page.Response().Response.Response != nil {
				sc = page.Response().Response.Response.StatusCode
	...
	for {
		next, err := page.fn(ctx, page.hrwlr)
		if err != nil {
			return err
		}
		page.hrwlr = next
...
func (page HybridRunbookWorkersListResultPage) Values() []HybridRunbookWorker {
	if page.hrwlr.IsEmpty() {
		return nil
	}
	return *page.hrwlr.Value
}
...
func NewHybridRunbookWorkersListResultPage(cur HybridRunbookWorkersListResult, getNextPage func(context.Context, HybridRunbookWorkersListResult) (HybridRunbookWorkersListResult, error)) HybridRunbookWorkersListResultPage {
	return HybridRunbookWorkersListResultPage{
		fn:    getNextPage,
		hrwlr: cur,
	}
}
