...
func (client AddonsClient) CreateOrUpdateSender(req *http.Request) (future AddonsCreateOrUpdateFuture, err error) {
	...
	future.Result = func(client AddonsClient) (a Addon, err error) {
		var done bool
		...
		if a.Response.Response == nil && err == nil {
			err = autorest.NewErrorWithError(err, "avs.AddonsCreateOrUpdateFuture", "Result", nil, "received nil response and error")
		}
