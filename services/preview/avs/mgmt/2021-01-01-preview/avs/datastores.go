...
func (client DatastoresClient) CreateSender(req *http.Request) (future DatastoresCreateFuture, err error) {
	...
	future.Result = func(client DatastoresClient) (d Datastore, err error) {
		var done bool
		...
		if d.Response.Response == nil && err == nil {
			err = autorest.NewErrorWithError(err, "avs.DatastoresCreateFuture", "Result", nil, "received nil response and error")
		}
