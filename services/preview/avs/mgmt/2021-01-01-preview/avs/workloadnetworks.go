...
func (client WorkloadNetworksClient) CreateDNSServiceSender(req *http.Request) (future WorkloadNetworksCreateDNSServiceFuture, err error) {
	...
	future.Result = func(client WorkloadNetworksClient) (wnds WorkloadNetworkDNSService, err error) {
		...
		sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
		wnds.Response.Response, err = future.GetResult(sender)
		if wnds.Response.Response == nil && err == nil {
			err = autorest.NewErrorWithError(err, "avs.WorkloadNetworksCreateDNSServiceFuture", "Result", nil, "received nil response and error")
		}
		if err == nil && wnds.Response.Response.StatusCode != http.StatusNoContent {
...
func (client WorkloadNetworksClient) CreateDNSZoneSender(req *http.Request) (future WorkloadNetworksCreateDNSZoneFuture, err error) {
	...
	future.Result = func(client WorkloadNetworksClient) (wndz WorkloadNetworkDNSZone, err error) {
		...
		sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
		wndz.Response.Response, err = future.GetResult(sender)
		if wndz.Response.Response == nil && err == nil {
			err = autorest.NewErrorWithError(err, "avs.WorkloadNetworksCreateDNSZoneFuture", "Result", nil, "received nil response and error")
		}
		if err == nil && wndz.Response.Response.StatusCode != http.StatusNoContent {
...
func (client WorkloadNetworksClient) UpdateDNSServiceSender(req *http.Request) (future WorkloadNetworksUpdateDNSServiceFuture, err error) {
	...
	future.Result = func(client WorkloadNetworksClient) (wnds WorkloadNetworkDNSService, err error) {
		...
		wnds.Response.Response, err = future.GetResult(sender)
		if wnds.Response.Response == nil && err == nil {
			err = autorest.NewErrorWithError(err, "avs.WorkloadNetworksUpdateDNSServiceFuture", "Result", nil, "received nil response and error")
		}
		if err == nil && wnds.Response.Response.StatusCode != http.StatusNoContent {
...
func (client WorkloadNetworksClient) UpdateDNSZoneSender(req *http.Request) (future WorkloadNetworksUpdateDNSZoneFuture, err error) {
	...
	future.Result = func(client WorkloadNetworksClient) (wndz WorkloadNetworkDNSZone, err error) {
		...
		wndz.Response.Response, err = future.GetResult(sender)
		if wndz.Response.Response == nil && err == nil {
			err = autorest.NewErrorWithError(err, "avs.WorkloadNetworksUpdateDNSZoneFuture", "Result", nil, "received nil response and error")
		}
		if err == nil && wndz.Response.Response.StatusCode != http.StatusNoContent {
