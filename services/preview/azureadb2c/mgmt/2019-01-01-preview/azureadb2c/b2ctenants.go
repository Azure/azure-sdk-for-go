...
// B2CTenantsClient is the CPIM Configuration Client
...
func (client B2CTenantsClient) CheckNameAvailability(ctx context.Context, checkNameAvailabilityRequestBody *CheckNameAvailabilityRequestBody) (result NameAvailabilityResponse, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewError("azureadb2c.B2CTenantsClient", "CheckNameAvailability", err.Error())
	}

	req, err := client.CheckNameAvailabilityPreparer(ctx, checkNameAvailabilityRequestBody)
	if err != nil {
		err = autorest.NewErrorWithError(err, "azureadb2c.B2CTenantsClient", "CheckNameAvailability", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "azureadb2c.B2CTenantsClient", "CheckNameAvailability", resp, "Failure sending request")
		return
	}

	result, err = client.CheckNameAvailabilityResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "azureadb2c.B2CTenantsClient", "CheckNameAvailability", resp, "Failure responding to request")
		return
	}
		...
		{TargetValue: createTenantRequestBody,
			Constraints: []validation.Constraint{{Target: "createTenantRequestBody", Name: validation.Null, Rule: false,
				Chain: []validation.Constraint{{Target: "createTenantRequestBody.Location", Name: validation.Null, Rule: true, Chain: nil},
					{Target: "createTenantRequestBody.Properties", Name: validation.Null, Rule: true, Chain: nil},
					{Target: "createTenantRequestBody.Sku", Name: validation.Null, Rule: true, Chain: nil},
				}}}}}); err != nil {
		return result, validation.NewError("azureadb2c.B2CTenantsClient", "Create", err.Error())
	}

	req, err := client.CreatePreparer(ctx, resourceGroupName, resourceName, createTenantRequestBody)
	if err != nil {
		err = autorest.NewErrorWithError(err, "azureadb2c.B2CTenantsClient", "Create", nil, "Failure preparing request")
		return
	}

	result, err = client.CreateSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "azureadb2c.B2CTenantsClient", "Create", nil, "Failure sending request")
		return
	}
...
func (client B2CTenantsClient) CreateSender(req *http.Request) (future B2CTenantsCreateFuture, err error) {
	...
	future.Result = func(client B2CTenantsClient) (btr B2CTenantResource, err error) {
		var done bool
...
func (client B2CTenantsClient) Delete(ctx context.Context, resourceGroupName string, resourceName string) (result B2CTenantsDeleteFuture, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "azureadb2c.B2CTenantsClient", "Delete", nil, "Failure preparing request")
		return
	}

	result, err = client.DeleteSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "azureadb2c.B2CTenantsClient", "Delete", nil, "Failure sending request")
		return
	}
...
func (client B2CTenantsClient) DeleteSender(req *http.Request) (future B2CTenantsDeleteFuture, err error) {
	...
	azf, err = azure.NewFutureFromResponse(resp)
	future.FutureAPI = &azf
	future.Result = func(client B2CTenantsClient) (ar autorest.Response, err error) {
		var done bool
		done, err = future.DoneWithContext(context.Background(), client)
		if err != nil {
...
func (client B2CTenantsClient) Get(ctx context.Context, resourceGroupName string, resourceName string) (result B2CTenantResource, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "azureadb2c.B2CTenantsClient", "Get", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "azureadb2c.B2CTenantsClient", "Get", resp, "Failure sending request")
		return
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "azureadb2c.B2CTenantsClient", "Get", resp, "Failure responding to request")
		return
	}
...
func (client B2CTenantsClient) ListByResourceGroup(ctx context.Context, resourceGroupName string) (result B2CTenantResourceList, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "azureadb2c.B2CTenantsClient", "ListByResourceGroup", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "azureadb2c.B2CTenantsClient", "ListByResourceGroup", resp, "Failure sending request")
		return
	}

	result, err = client.ListByResourceGroupResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "azureadb2c.B2CTenantsClient", "ListByResourceGroup", resp, "Failure responding to request")
		return
	}
...
func (client B2CTenantsClient) ListBySubscription(ctx context.Context) (result B2CTenantResourceList, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "azureadb2c.B2CTenantsClient", "ListBySubscription", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "azureadb2c.B2CTenantsClient", "ListBySubscription", resp, "Failure sending request")
		return
	}

	result, err = client.ListBySubscriptionResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "azureadb2c.B2CTenantsClient", "ListBySubscription", resp, "Failure responding to request")
		return
	}
...
func (client B2CTenantsClient) Update(ctx context.Context, resourceGroupName string, resourceName string, updateTenantRequestBody *B2CTenantUpdateRequest) (result B2CTenantResource, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "azureadb2c.B2CTenantsClient", "Update", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "azureadb2c.B2CTenantsClient", "Update", resp, "Failure sending request")
		return
	}

	result, err = client.UpdateResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "azureadb2c.B2CTenantsClient", "Update", resp, "Failure responding to request")
		return
	}
