...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/preview/azureadexternalidentities/mgmt/2019-01-01-preview/azureadexternalidentities"
...
type B2CTenantResource struct {
	...
	*B2CTenantResourceProperties `json:"properties,omitempty"`
	...
	Name *string `json:"name,omitempty"`
	// Location - The location in which the resource is hosted and data resides. Can be one of 'United States', 'Europe', 'Asia Pacific', or 'Australia' (preview). Refer to [this documentation](https://aka.ms/B2CDataResidency) for more information.
