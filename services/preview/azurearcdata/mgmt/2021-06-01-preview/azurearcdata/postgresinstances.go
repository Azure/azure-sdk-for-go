...
func NewPostgresInstancesClient(subscriptionID string) PostgresInstancesClient {
	return NewPostgresInstancesClientWithBaseURI(DefaultBaseURI, subscriptionID)
}
...
// stack).
func NewPostgresInstancesClientWithBaseURI(baseURI string, subscriptionID string) PostgresInstancesClient {
	return PostgresInstancesClient{NewWithBaseURI(baseURI, subscriptionID)}
}
...
func (client PostgresInstancesClient) Create(ctx context.Context, resourceGroupName string, postgresInstanceName string, resource PostgresInstance) (result PostgresInstancesCreateFuture, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		{TargetValue: resource,
			Constraints: []validation.Constraint{{Target: "resource.Properties", Name: validation.Null, Rule: true, Chain: nil}}}}); err != nil {
		return result, validation.NewError("azurearcdata.PostgresInstancesClient", "Create", err.Error())
	}
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "azurearcdata.PostgresInstancesClient", "Create", nil, "Failure sending request")
		return
	}
...
func (client PostgresInstancesClient) CreateSender(req *http.Request) (future PostgresInstancesCreateFuture, err error) {
