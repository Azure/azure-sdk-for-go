...
func (client SQLServerInstancesClient) Create(ctx context.Context, resourceGroupName string, SQLServerInstanceName string, SQLServerInstance SQLServerInstance) (result SQLServerInstancesCreateFuture, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		{TargetValue: SQLServerInstance,
			Constraints: []validation.Constraint{{Target: "SQLServerInstance.Properties", Name: validation.Null, Rule: false,
				Chain: []validation.Constraint{{Target: "SQLServerInstance.Properties.ContainerResourceID", Name: validation.Null, Rule: true, Chain: nil},
					{Target: "SQLServerInstance.Properties.Status", Name: validation.Null, Rule: true, Chain: nil},
				}}}}}); err != nil {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "azurearcdata.SQLServerInstancesClient", "Create", nil, "Failure sending request")
		return
	}
...
func (client SQLServerInstancesClient) Delete(ctx context.Context, resourceGroupName string, SQLServerInstanceName string) (result autorest.Response, err error) {
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "azurearcdata.SQLServerInstancesClient", "Delete", resp, "Failure sending request")
		return
	}

	result, err = client.DeleteResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "azurearcdata.SQLServerInstancesClient", "Delete", resp, "Failure responding to request")
		return
	}
