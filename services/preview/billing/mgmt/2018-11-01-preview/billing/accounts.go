...
func (client AccountsClient) Get(ctx context.Context, billingAccountID string, expand string) (result Account, err error) {
	...
	req, err := client.GetPreparer(ctx, billingAccountID, expand)
	if err != nil {
...
func (client AccountsClient) GetPreparer(ctx context.Context, billingAccountID string, expand string) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithPathParameters("/providers/Microsoft.Billing/billingAccounts/{billingAccountId}", pathParameters),
