...
type ProductsClientAPI interface {
	Transfer(ctx context.Context, billingAccountID string, invoiceSectionID string, productName string, parameters billing.TransferProductProperties) (result autorest.Response, err error)
}
