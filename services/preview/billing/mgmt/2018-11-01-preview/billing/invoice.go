...
func (client InvoiceClient) Get(ctx context.Context, billingAccountID string, billingProfileID string, invoiceName string) (result InvoiceSummary, err error) {
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "billing.InvoiceClient", "Get", resp, "Failure sending request")
		return
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "billing.InvoiceClient", "Get", resp, "Failure responding to request")
	}
