...
func (client InvoiceSectionsClient) CreateSender(req *http.Request) (future InvoiceSectionsCreateFuture, err error) {
	...
	future.Result = func(client InvoiceSectionsClient) (is InvoiceSection, err error) {
		...
		if is.Response.Response == nil && err == nil {
			err = autorest.NewErrorWithError(err, "billing.InvoiceSectionsCreateFuture", "Result", nil, "received nil response and error")
		}
...
func (client InvoiceSectionsClient) UpdateSender(req *http.Request) (future InvoiceSectionsUpdateFuture, err error) {
	...
	future.Result = func(client InvoiceSectionsClient) (is InvoiceSection, err error) {
		...
		is.Response.Response, err = future.GetResult(sender)
		if is.Response.Response == nil && err == nil {
			err = autorest.NewErrorWithError(err, "billing.InvoiceSectionsUpdateFuture", "Result", nil, "received nil response and error")
		}
		if err == nil && is.Response.Response.StatusCode != http.StatusNoContent {
