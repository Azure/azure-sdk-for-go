...
func (client InvoiceSectionsWithCreateSubscriptionPermissionClient) List(ctx context.Context, billingAccountID string, expand string) (result InvoiceSectionListResult, err error) {
...
func (client InvoiceSectionsWithCreateSubscriptionPermissionClient) ListPreparer(ctx context.Context, billingAccountID string, expand string) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithPathParameters("/providers/Microsoft.Billing/billingAccounts/{billingAccountId}/listInvoiceSectionsWithCreateSubscriptionPermission", pathParameters),
