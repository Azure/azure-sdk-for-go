...
// ProductsByBillingSubscriptionsClient is the billing client provides access to billing resources for Azure
// subscriptions.
...
func NewProductsByBillingSubscriptionsClient(subscriptionID string) ProductsByBillingSubscriptionsClient {
	return NewProductsByBillingSubscriptionsClientWithBaseURI(DefaultBaseURI, subscriptionID)
}

// NewProductsByBillingSubscriptionsClientWithBaseURI creates an instance of the ProductsByBillingSubscriptionsClient
// client.
...
func (client ProductsByBillingSubscriptionsClient) List(ctx context.Context, billingAccountID string) (result SubscriptionsListResultPage, err error) {
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "billing.ProductsByBillingSubscriptionsClient", "List", resp, "Failure sending request")
		return
	}

	result.slr, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "billing.ProductsByBillingSubscriptionsClient", "List", resp, "Failure responding to request")
	}
...
func (client ProductsByBillingSubscriptionsClient) ListSender(req *http.Request) (*http.Response, error) {
...
func (client ProductsByBillingSubscriptionsClient) listNextResults(ctx context.Context, lastResults SubscriptionsListResult) (result SubscriptionsListResult, err error) {
	req, err := lastResults.subscriptionsListResultPreparer(ctx)
	if err != nil {
		return result, autorest.NewErrorWithError(err, "billing.ProductsByBillingSubscriptionsClient", "listNextResults", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "billing.ProductsByBillingSubscriptionsClient", "listNextResults", resp, "Failure sending next results request")
	}
	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "billing.ProductsByBillingSubscriptionsClient", "listNextResults", resp, "Failure responding to next results request")
	}
	return
}
