...
type AzureMonitorWorkspaceProperties struct {
	...
	// IncludeChangeDetails - Possible values include: 'None', 'Include', 'Exclude'
	IncludeChangeDetails ChangeDetailsMode `json:"includeChangeDetails,omitempty"`
}
...
func (cpr ConfigurationProfileResource) MarshalJSON() ([]byte, error) {
	...
	if cpr.Location != nil {
		objectMap["location"] = cpr.Location
	}
...
// ExtendedProxyResource an Azure resource.
type ExtendedProxyResource struct {
	SystemData *SystemData `json:"systemData,omitempty"`
	// ID - READ-ONLY; Fully qualified resource ID for the resource. Ex - /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{resourceProviderNamespace}/{resourceType}/{resourceName}
	ID *string `json:"id,omitempty"`
	// Name - READ-ONLY; The name of the resource
...
// MarshalJSON is the custom marshaler for ExtendedProxyResource.
func (epr ExtendedProxyResource) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if epr.SystemData != nil {
		objectMap["systemData"] = epr.SystemData
	}
	return json.Marshal(objectMap)
}
...
type ResourceIdentity struct {
	// Type - The type of managed identity used. The type 'SystemAssigned, UserAssigned' includes both an implicitly created identity and a set of user-assigned identities. The type 'None' will remove any identities. Possible values include: 'ManagedIdentityTypesNone', 'ManagedIdentityTypesSystemAssigned'
