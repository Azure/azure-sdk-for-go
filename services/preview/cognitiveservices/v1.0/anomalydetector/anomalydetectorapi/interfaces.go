...
type TimeSeriesClientAPI interface {
	...
	EntireDetectInTimeRange(ctx context.Context, timeSeriesID string, body anomalydetector.AnomalyDetectInTimeRangeRequest) (result anomalydetector.AnomalyDetectInTimeRangeReponse, err error)
	...
	LastDetectInTimeRange(ctx context.Context, timeSeriesID string, body anomalydetector.AnomalyDetectInTimeRangeRequest) (result anomalydetector.AnomalyDetectInTimeRangeReponse, err error)
