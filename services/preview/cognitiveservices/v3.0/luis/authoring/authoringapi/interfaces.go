...
type FeaturesClientAPI interface {
	...
	CreatePatternFeature(ctx context.Context, appID uuid.UUID, versionID string, patternCreateObject authoring.PatternCreateObject) (result authoring.Int32, err error)
	DeletePatternFeature(ctx context.Context, appID uuid.UUID, versionID string, patternID int32) (result authoring.OperationStatus, err error)
	...
	GetPatternFeatureInfo(ctx context.Context, appID uuid.UUID, versionID string, patternID int32) (result authoring.PatternFeatureInfo, err error)
	...
	UpdatePatternFeature(ctx context.Context, appID uuid.UUID, versionID string, patternID int32, patternUpdateObject authoring.PatternUpdateObject) (result authoring.OperationStatus, err error)
