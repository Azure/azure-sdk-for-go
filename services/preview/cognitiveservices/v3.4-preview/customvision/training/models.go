...
// Domain domains are used as the starting point for your project. Each domain is optimized for specific types
// of images. Domains with compact in their name can be exported. For more information visit the <a
