...
1. *CloudServiceRoleInstancesDeleteFuture.UnmarshalJSON([]byte) error
1. *CloudServiceRoleInstancesRebuildFuture.UnmarshalJSON([]byte) error
1. *CloudServiceRoleInstancesReimageFuture.UnmarshalJSON([]byte) error
1. *CloudServiceRoleInstancesRestartFuture.UnmarshalJSON([]byte) error
1. *CloudServicesCreateOrUpdateFuture.UnmarshalJSON([]byte) error
1. *CloudServicesDeleteFuture.UnmarshalJSON([]byte) error
1. *CloudServicesDeleteInstancesFuture.UnmarshalJSON([]byte) error
1. *CloudServicesPowerOffFuture.UnmarshalJSON([]byte) error
1. *CloudServicesRebuildFuture.UnmarshalJSON([]byte) error
1. *CloudServicesReimageFuture.UnmarshalJSON([]byte) error
1. *CloudServicesRestartFuture.UnmarshalJSON([]byte) error
1. *CloudServicesStartFuture.UnmarshalJSON([]byte) error
1. *CloudServicesUpdateDomainWalkUpdateDomainFuture.UnmarshalJSON([]byte) error
1. *CloudServicesUpdateFuture.UnmarshalJSON([]byte) error
