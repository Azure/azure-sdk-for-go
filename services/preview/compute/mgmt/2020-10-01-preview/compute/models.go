...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/preview/compute/mgmt/2020-10-01-preview/compute"
...
type CloudServiceNetworkProfile struct {
	// LoadBalancerConfigurations - The list of load balancer configurations for the cloud service.
...
type LoadBalancerConfigurationProperties struct {
	// FrontendIPConfigurations - List of IP
