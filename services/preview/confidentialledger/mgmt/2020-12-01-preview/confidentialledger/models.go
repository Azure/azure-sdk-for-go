...
// CertUser user cert and permissions associated with that user
...
type LedgerProperties struct {
	...
	// CertUsers - Array of all the cert based users who can access Confidential Ledger
	CertUsers *[]CertUser `json:"certUsers,omitempty"`
}
...
func (lp LedgerProperties) MarshalJSON() ([]byte, error) {
	...
	if lp.CertUsers != nil {
		objectMap["certUsers"] = lp.CertUsers
	}
