...
type BaseClientAPI interface {
	CheckNameAvailability(ctx context.Context, nameAvailabilityRequest confidentialledger.CheckNameAvailabilityRequest) (result confidentialledger.CheckNameAvailabilityResponse, err error)
}

var _ BaseClientAPI = (*confidentialledger.BaseClient)(nil)
