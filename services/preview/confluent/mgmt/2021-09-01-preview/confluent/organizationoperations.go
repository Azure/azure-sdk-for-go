...
func NewOrganizationOperationsClient(subscriptionID string) OrganizationOperationsClient {
	return NewOrganizationOperationsClientWithBaseURI(DefaultBaseURI, subscriptionID)
}

// NewOrganizationOperationsClientWithBaseURI creates an instance of the OrganizationOperationsClient client using a
...
func NewOrganizationOperationsClientWithBaseURI(baseURI string, subscriptionID string) OrganizationOperationsClient {
	return OrganizationOperationsClient{NewWithBaseURI(baseURI, subscriptionID)}
}

// List sends the list request.
func (client OrganizationOperationsClient) List(ctx context.Context) (result OperationListResultPage, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/OrganizationOperationsClient.List")
		defer func() {
			sc := -1
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "confluent.OrganizationOperationsClient", "List", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "confluent.OrganizationOperationsClient", "List", resp, "Failure sending request")
		return
	}
...
func (client OrganizationOperationsClient) ListPreparer(ctx context.Context) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithPath("/providers/Microsoft.Confluent/operations"),
...
func (client OrganizationOperationsClient) listNextResults(ctx context.Context, lastResults OperationListResult) (result OperationListResult, err error) {
	req, err := lastResults.operationListResultPreparer(ctx)
	if err != nil {
		return result, autorest.NewErrorWithError(err, "confluent.OrganizationOperationsClient", "listNextResults", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "confluent.OrganizationOperationsClient", "listNextResults", resp, "Failure sending next results request")
	}
