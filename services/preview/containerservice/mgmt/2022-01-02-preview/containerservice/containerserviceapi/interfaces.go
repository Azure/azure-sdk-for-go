...
type ManagedClustersClientAPI interface {
	...
	ListClusterAdminCredentials(ctx context.Context, resourceGroupName string, resourceName string, serverFqdn string, formatParameter containerservice.Format) (result containerservice.CredentialResults, err error)
