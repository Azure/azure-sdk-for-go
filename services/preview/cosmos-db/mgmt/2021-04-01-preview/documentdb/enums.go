...
func PossibleServiceTypeBasicServiceResourcePropertiesValues() []ServiceTypeBasicServiceResourceProperties {
	return []ServiceTypeBasicServiceResourceProperties{ServiceTypeDataTransferServiceResourceProperties, ServiceTypeSQLDedicatedGatewayServiceResourceProperties, ServiceTypeServiceResourceProperties}
}
