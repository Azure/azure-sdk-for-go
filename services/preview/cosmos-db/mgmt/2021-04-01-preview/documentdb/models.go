...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/preview/cosmos-db/mgmt/2021-04-01-preview/documentdb"
...
// ContinuousBackupInformation continuous backup description.
...
type DataTransferServiceResourceProperties struct {
	...
	// Status - READ-ONLY; Possible values include: 'ServiceStatusCreating', 'ServiceStatusRunning', 'ServiceStatusUpdating', 'ServiceStatusDeleting', 'ServiceStatusError', 'ServiceStatusStopped'
	Status ServiceStatus `json:"status,omitempty"`
	// ServiceType - Possible values include: 'ServiceTypeServiceResourceProperties', 'ServiceTypeDataTransferServiceResourceProperties', 'ServiceTypeSQLDedicatedGatewayServiceResourceProperties'
...
func (dtsrp DataTransferServiceResourceProperties) MarshalJSON() ([]byte, error) {
	dtsrp.ServiceType = ServiceTypeDataTransferServiceResourceProperties
	objectMap := make(map[string]interface{})
...
func (dacup DatabaseAccountCreateUpdateProperties) MarshalJSON() ([]byte, error) {
	...
	if dacup.DefaultIdentity != nil {
		objectMap["defaultIdentity"] = dacup.DefaultIdentity
	}
	...
	if dacup.NetworkACLBypass != "" {
		objectMap["networkAclBypass"] = dacup.NetworkACLBypass
	}
	if dacup.NetworkACLBypassResourceIds != nil {
		objectMap["networkAclBypassResourceIds"] = dacup.NetworkACLBypassResourceIds
	}
	if dacup.CreateMode != "" {
...
func (drdacup DefaultRequestDatabaseAccountCreateUpdateProperties) MarshalJSON() ([]byte, error) {
	...
	if drdacup.DefaultIdentity != nil {
		objectMap["defaultIdentity"] = drdacup.DefaultIdentity
	}
	...
	if drdacup.NetworkACLBypass != "" {
		objectMap["networkAclBypass"] = drdacup.NetworkACLBypass
	}
	if drdacup.NetworkACLBypassResourceIds != nil {
		objectMap["networkAclBypassResourceIds"] = drdacup.NetworkACLBypassResourceIds
	}
	...
	for k, v := range m {
		...
		case "defaultIdentity":
			if v != nil {
				...
				drdacup.DefaultIdentity = &defaultIdentity
			}
		case "publicNetworkAccess":
			if v != nil {
				var publicNetworkAccess PublicNetworkAccess
		...
		case "networkAclBypass":
			if v != nil {
				...
				drdacup.NetworkACLBypass = networkACLBypass
			}
		case "networkAclBypassResourceIds":
			if v != nil {
				var networkACLBypassResourceIds []string
				...
				drdacup.NetworkACLBypassResourceIds = &networkACLBypassResourceIds
			}
		case "createMode":
			if v != nil {
				var createMode CreateModeBasicDatabaseAccountCreateUpdateProperties
...
func (rrdacup RestoreReqeustDatabaseAccountCreateUpdateProperties) MarshalJSON() ([]byte, error) {
	...
	if rrdacup.DefaultIdentity != nil {
		objectMap["defaultIdentity"] = rrdacup.DefaultIdentity
	}
	...
	if rrdacup.NetworkACLBypass != "" {
		objectMap["networkAclBypass"] = rrdacup.NetworkACLBypass
	}
	if rrdacup.NetworkACLBypassResourceIds != nil {
		objectMap["networkAclBypassResourceIds"] = rrdacup.NetworkACLBypassResourceIds
	}
	...
	for k, v := range m {
		...
		case "defaultIdentity":
			if v != nil {
				...
				rrdacup.DefaultIdentity = &defaultIdentity
			}
		case "publicNetworkAccess":
			if v != nil {
				var publicNetworkAccess PublicNetworkAccess
		...
		case "networkAclBypass":
			if v != nil {
				...
				rrdacup.NetworkACLBypass = networkACLBypass
			}
		case "networkAclBypassResourceIds":
			if v != nil {
				var networkACLBypassResourceIds []string
				...
				rrdacup.NetworkACLBypassResourceIds = &networkACLBypassResourceIds
			}
		case "createMode":
			if v != nil {
				var createMode CreateModeBasicDatabaseAccountCreateUpdateProperties
...
func (sdgsrp SQLDedicatedGatewayServiceResourceProperties) MarshalJSON() ([]byte, error) {
	sdgsrp.ServiceType = ServiceTypeSQLDedicatedGatewayServiceResourceProperties
	objectMap := make(map[string]interface{})
...
func unmarshalBasicServiceResourceProperties(body []byte) (BasicServiceResourceProperties, error) {
	...
	case string(ServiceTypeDataTransferServiceResourceProperties):
		var dtsrp DataTransferServiceResourceProperties
		err := json.Unmarshal(body, &dtsrp)
		return dtsrp, err
	case string(ServiceTypeSQLDedicatedGatewayServiceResourceProperties):
