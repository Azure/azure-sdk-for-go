...
// MarshalJSON is the custom marshaler for GraphResourceGetPropertiesResource.
func (grgp GraphResourceGetPropertiesResource) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if grgp.ID != nil {
		objectMap["id"] = grgp.ID
	}
	return json.Marshal(objectMap)
}
