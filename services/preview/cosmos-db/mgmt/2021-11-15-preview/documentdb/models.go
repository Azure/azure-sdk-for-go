...
type RestorableGremlinGraphPropertiesResource struct {
	// Rid - READ-ONLY; A system generated property. A unique identifier.
	Rid *string `json:"_rid,omitempty"`
	// OperationType - READ-ONLY; The operation type of this graph event. Possible values include: 'Create', 'Replace', 'Delete', 'SystemOperation'
	OperationType OperationType `json:"operationType,omitempty"`
...
type RestorableTablePropertiesResource struct {
	// Rid - READ-ONLY; A system generated property. A unique identifier.
	Rid *string `json:"_rid,omitempty"`
	// OperationType - READ-ONLY; The operation type of this table event. Possible values include: 'Create', 'Replace', 'Delete', 'SystemOperation'
	OperationType OperationType `json:"operationType,omitempty"`
