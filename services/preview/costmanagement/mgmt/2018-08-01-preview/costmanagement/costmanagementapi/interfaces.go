...
type AlertsClientAPI interface {
	...
	GetByBillingAccount(ctx context.Context, billingAccountID string, alertID string) (result costmanagement.Alert, err error)
	GetByBillingProfile(ctx context.Context, billingAccountID string, billingProfileID string, alertID string) (result costmanagement.Alert, err error)
	...
	GetByInvoiceSection(ctx context.Context, billingAccountID string, invoiceSectionID string, alertID string) (result costmanagement.Alert, err error)
	...
	ListByBillingAccount(ctx context.Context, billingAccountID string, filter string, skiptoken string, top *int32) (result costmanagement.AlertListResultPage, err error)
	ListByBillingProfile(ctx context.Context, billingAccountID string, billingProfileID string, filter string, skiptoken string, top *int32) (result costmanagement.AlertListResultPage, err error)
	...
	ListByInvoiceSection(ctx context.Context, billingAccountID string, invoiceSectionID string, filter string, skiptoken string, top *int32) (result costmanagement.AlertListResultPage, err error)
