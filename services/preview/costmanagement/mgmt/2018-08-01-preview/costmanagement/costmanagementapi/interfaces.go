...
type AlertsClientAPI interface {
	...
	GetByAccount(ctx context.Context, enrollmentAccountID string, alertID string) (result costmanagement.Alert, err error)
	GetByDepartment(ctx context.Context, departmentID string, alertID string) (result costmanagement.Alert, err error)
	...
	ListByAccount(ctx context.Context, enrollmentAccountID string, filter string, skiptoken string, top *int32) (result costmanagement.AlertListResultPage, err error)
	ListByDepartment(ctx context.Context, departmentID string, filter string, skiptoken string, top *int32) (result costmanagement.AlertListResultPage, err error)
	...
	UpdateDepartmentsAlertStatus(ctx context.Context, departmentID string, alertID string, parameters costmanagement.Alert) (result costmanagement.Alert, err error)
	UpdateEnrollmentAccountAlertStatus(ctx context.Context, enrollmentAccountID string, alertID string, parameters costmanagement.Alert) (result costmanagement.Alert, err error)
