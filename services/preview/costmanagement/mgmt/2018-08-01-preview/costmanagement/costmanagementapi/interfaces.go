...
type AlertsClientAPI interface {
	GetAlertByExternalBillingAccounts(ctx context.Context, externalBillingAccountID string, alertID string) (result costmanagement.Alert, err error)
	GetAlertByExternalSubscriptions(ctx context.Context, externalSubscriptionID string, alertID string) (result costmanagement.Alert, err error)
	...
	UpdateExternalBillingAccountAlertStatus(ctx context.Context, externalBillingAccountID string, alertID string, parameters costmanagement.Alert) (result costmanagement.Alert, err error)
	UpdateExternalSubscriptionAlertStatus(ctx context.Context, externalSubscriptionID string, alertID string, parameters costmanagement.Alert) (result costmanagement.Alert, err error)
