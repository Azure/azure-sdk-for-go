...
// Parameters:
// billingAccountID - billingAccount ID
func (client ReportClient) ListByBillingAccount(ctx context.Context, billingAccountID string) (result ReportListResult, err error) {
	req, err := client.ListByBillingAccountPreparer(ctx, billingAccountID)
	if err != nil {
		err = autorest.NewErrorWithError(err, "costmanagement.ReportClient", "ListByBillingAccount", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "costmanagement.ReportClient", "ListByBillingAccount", resp, "Failure sending request")
		return
	}

	result, err = client.ListByBillingAccountResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "costmanagement.ReportClient", "ListByBillingAccount", resp, "Failure responding to request")
	}
...
func (client ReportClient) ListByBillingAccountPreparer(ctx context.Context, billingAccountID string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"billingAccountId": autorest.Encode("path", billingAccountID),
	}
...
// http.Response Body if it receives an error.
func (client ReportClient) ListByBillingAccountSender(req *http.Request) (*http.Response, error) {
	return autorest.SendWithSender(client, req,
		autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
}
...
// closes the http.Response Body.
func (client ReportClient) ListByBillingAccountResponder(resp *http.Response) (result ReportListResult, err error) {
	err = autorest.Respond(
		resp,
		client.ByInspecting(),
		azure.WithErrorUnlessStatusCode(http.StatusOK),
...
// Parameters:
// departmentID - department ID
func (client ReportClient) ListByDepartment(ctx context.Context, departmentID string) (result ReportListResult, err error) {
	req, err := client.ListByDepartmentPreparer(ctx, departmentID)
	if err != nil {
		err = autorest.NewErrorWithError(err, "costmanagement.ReportClient", "ListByDepartment", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "costmanagement.ReportClient", "ListByDepartment", resp, "Failure sending request")
		return
	}

	result, err = client.ListByDepartmentResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "costmanagement.ReportClient", "ListByDepartment", resp, "Failure responding to request")
	}
...
func (client ReportClient) ListByDepartmentPreparer(ctx context.Context, departmentID string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"departmentId": autorest.Encode("path", departmentID),
	}
...
// http.Response Body if it receives an error.
func (client ReportClient) ListByDepartmentSender(req *http.Request) (*http.Response, error) {
	return autorest.SendWithSender(client, req,
		autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
}
...
// closes the http.Response Body.
func (client ReportClient) ListByDepartmentResponder(resp *http.Response) (result ReportListResult, err error) {
	err = autorest.Respond(
		resp,
		client.ByInspecting(),
		azure.WithErrorUnlessStatusCode(http.StatusOK),
