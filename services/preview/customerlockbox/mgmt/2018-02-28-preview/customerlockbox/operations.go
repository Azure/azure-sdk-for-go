...
func (client OperationsClient) List(ctx context.Context, APIVersion string) (result OperationListResultPage, err error) {
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "customerlockbox.OperationsClient", "List", resp, "Failure sending request")
		return
	}

	result.olr, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "customerlockbox.OperationsClient", "List", resp, "Failure responding to request")
	}
...
func (client OperationsClient) ListPreparer(ctx context.Context, APIVersion string) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithPath("/providers/Microsoft.CustomerLockbox/operations"),
...
func (client OperationsClient) listNextResults(ctx context.Context, lastResults OperationListResult) (result OperationListResult, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "customerlockbox.OperationsClient", "listNextResults", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "customerlockbox.OperationsClient", "listNextResults", resp, "Failure sending next results request")
	}
	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "customerlockbox.OperationsClient", "listNextResults", resp, "Failure responding to next results request")
	}
	return
}
