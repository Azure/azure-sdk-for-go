...
import (
	"context"
	"github.com/Azure/azure-sdk-for-go/services/preview/databox/mgmt/2021-08-01-preview/databox"
...
type JobsClientAPI interface {
	...
	MarkDevicesShipped(ctx context.Context, jobName string, resourceGroupName string, markDevicesShippedRequest databox.MarkDevicesShippedRequest) (result autorest.Response, err error)
