...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/preview/databoxedge/mgmt/2020-05-01-preview/databoxedge"
...
type ResourceTypeSku struct {
	...
	// Name - READ-ONLY; The Sku name. Possible values include: 'Gateway', 'Edge', 'TEA1Node', 'TEA1NodeUPS', 'TEA1NodeHeater', 'TEA1NodeUPSHeater', 'TEA4NodeHeater', 'TEA4NodeUPSHeater', 'TMA', 'TDC', 'TCALarge', 'TCASmall', 'GPU'
...
// Sku the SKU type.
type Sku struct {
	// Name - SKU name. Possible values include: 'Gateway', 'Edge', 'TEA1Node', 'TEA1NodeUPS', 'TEA1NodeHeater', 'TEA1NodeUPSHeater', 'TEA4NodeHeater', 'TEA4NodeUPSHeater', 'TMA', 'TDC', 'TCALarge', 'TCASmall', 'GPU'
	Name SkuName `json:"name,omitempty"`
...
type SkuInformation struct {
	...
	// Costs - READ-ONLY; The cost of the SKU
	Costs *[]SkuCost `json:"costs,omitempty"`
...
type SkuType struct {
	...
	// Costs - READ-ONLY; The pricing info of the Sku.
	Costs *[]SkuCost `json:"costs,omitempty"`
	// Restrictions - READ-ONLY; Restriction info of the SKU.
	Restrictions *[]SkuRestriction `json:"restrictions,omitempty"`
	// SignupOption - READ-ONLY; Can the SKU be signed up. Possible values include: 'SkuSignupOptionNone', 'SkuSignupOptionAvailable'
	SignupOption SkuSignupOption `json:"signupOption,omitempty"`
	// Version - READ-ONLY; Sku version. Possible values include: 'Stable', 'Preview'
	Version SkuVersion `json:"version,omitempty"`
	// Availability - READ-ONLY; Is SKU available. Possible values include: 'Available', 'Unavailable'
