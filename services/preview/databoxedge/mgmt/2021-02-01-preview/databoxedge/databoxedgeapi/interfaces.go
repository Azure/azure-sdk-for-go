...
import (
	"context"
	"github.com/Azure/azure-sdk-for-go/services/preview/databoxedge/mgmt/2021-02-01-preview/databoxedge"
)
...
type UsersClientAPI interface {
	...
	ListByDataBoxEdgeDevice(ctx context.Context, deviceName string, resourceGroupName string, expand string) (result databoxedge.UserListPage, err error)
	ListByDataBoxEdgeDeviceComplete(ctx context.Context, deviceName string, resourceGroupName string, expand string) (result databoxedge.UserListIterator, err error)
}
