...
func (client MonitoredResourcesClient) List(ctx context.Context, resourceGroupName string, monitorName string) (result MonitoredResourceListResponsePage, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "datadog.MonitoredResourcesClient", "List", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "datadog.MonitoredResourcesClient", "List", resp, "Failure sending request")
		return
	}
...
func (client MonitoredResourcesClient) listNextResults(ctx context.Context, lastResults MonitoredResourceListResponse) (result MonitoredResourceListResponse, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "datadog.MonitoredResourcesClient", "listNextResults", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "datadog.MonitoredResourcesClient", "listNextResults", resp, "Failure sending next results request")
	}
