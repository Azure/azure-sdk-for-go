...
// to Azure Db For PostgreSql server and target server requirements for online migration
...
// MigrateMISyncCompleteCommandInput input for command that completes sync migration for a managed instance
// database.
...
// MigrateMISyncCompleteCommandOutput output for command that completes sync migration for a managed
// instance database.
...
// MigrateMISyncCompleteCommandProperties properties for the command that completes sync migration for a
