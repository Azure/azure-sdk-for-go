...
type BackupVaultsClientAPI interface {
	...
	Put(ctx context.Context, vaultName string, resourceGroupName string, parameters dataprotection.BackupVaultResource) (result dataprotection.BackupVaultsPutFuture, err error)
}
...
type OperationResultClientAPI interface {
	Get(ctx context.Context, operationID string, location string) (result autorest.Response, err error)
}
...
type BackupPoliciesClientAPI interface {
	...
	Put(ctx context.Context, vaultName string, resourceGroupName string, backupPolicyName string, parameters dataprotection.BaseBackupPolicyResource) (result dataprotection.BaseBackupPolicyResource, err error)
}
...
type BackupInstancesClientAPI interface {
	...
	GetBackupInstancesInVault(ctx context.Context, vaultName string, resourceGroupName string) (result dataprotection.BackupInstanceResourceListPage, err error)
	GetBackupInstancesInVaultComplete(ctx context.Context, vaultName string, resourceGroupName string) (result dataprotection.BackupInstanceResourceListIterator, err error)
	Put(ctx context.Context, vaultName string, resourceGroupName string, backupInstanceName string, parameters dataprotection.BackupInstanceResource) (result dataprotection.BackupInstancesPutFuture, err error)
...
type RecoveryPointsClientAPI interface {
	GetList(ctx context.Context, vaultName string, resourceGroupName string, backupInstanceName string) (result dataprotection.AzureBackupRecoveryPointResourceListPage, err error)
	GetListComplete(ctx context.Context, vaultName string, resourceGroupName string, backupInstanceName string) (result dataprotection.AzureBackupRecoveryPointResourceListIterator, err error)
}
