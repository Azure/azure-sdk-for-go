...
func (client RecoveryPointsClient) GetList(ctx context.Context, vaultName string, resourceGroupName string, backupInstanceName string) (result AzureBackupRecoveryPointResourceListPage, err error) {
	...
	req, err := client.GetListPreparer(ctx, vaultName, resourceGroupName, backupInstanceName)
	if err != nil {
...
func (client RecoveryPointsClient) GetListPreparer(ctx context.Context, vaultName string, resourceGroupName string, backupInstanceName string) (*http.Request, error) {
...
func (client RecoveryPointsClient) GetListComplete(ctx context.Context, vaultName string, resourceGroupName string, backupInstanceName string) (result AzureBackupRecoveryPointResourceListIterator, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/RecoveryPointsClient.GetList")
		defer func() {
			sc := -1
	...
	result.page, err = client.GetList(ctx, vaultName, resourceGroupName, backupInstanceName)
	return
}
