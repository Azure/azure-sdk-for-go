...
// controllerParameters - controller type parameters
func (client ControllerClient) Create(ctx context.Context, resourceGroupName string, resourceName string, controllerParameters ControllerTypeParameters) (result ControllerCreateFuture, err error) {
	...
	req, err := client.CreatePreparer(ctx, resourceGroupName, resourceName, controllerParameters)
	if err != nil {
...
func (client ControllerClient) CreatePreparer(ctx context.Context, resourceGroupName string, resourceName string, controllerParameters ControllerTypeParameters) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithJSON(controllerParameters),
...
// resourceName - the name of the resource. It must be a minimum of 3 characters, and a maximum of 63.
// controllerParameters - controller type parameters
func (client ControllerClient) Patch(ctx context.Context, resourceGroupName string, resourceName string, controllerParameters ControllerTypeParameters) (result DelegatedController, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.PatchPreparer(ctx, resourceGroupName, resourceName, controllerParameters)
	if err != nil {
...
func (client ControllerClient) PatchPreparer(ctx context.Context, resourceGroupName string, resourceName string, controllerParameters ControllerTypeParameters) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"resourceName":      autorest.Encode("path", resourceName),
		"subscriptionId":    autorest.Encode("path", client.SubscriptionID),
