...
// vnetName - the name of the virtual network. This name must be at least 1 character in length, and no more
// than 90.
// subnetName - the name of the delegated subnet. This name must be at least 1 character in length, and no more
// than 90.
func (client DelegatedSubnetServiceClient) DeleteDetails(ctx context.Context, resourceGroupName string, resourceName string, vnetName string, subnetName string) (result DelegatedSubnetServiceDeleteDetailsFuture, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		{TargetValue: vnetName,
			Constraints: []validation.Constraint{{Target: "vnetName", Name: validation.MaxLength, Rule: 90, Chain: nil},
				{Target: "vnetName", Name: validation.MinLength, Rule: 1, Chain: nil},
				{Target: "vnetName", Name: validation.Pattern, Rule: `^[-\w\._\(\)]+$`, Chain: nil}}},
		{TargetValue: subnetName,
			Constraints: []validation.Constraint{{Target: "subnetName", Name: validation.MaxLength, Rule: 90, Chain: nil},
				{Target: "subnetName", Name: validation.MinLength, Rule: 1, Chain: nil},
				{Target: "subnetName", Name: validation.Pattern, Rule: `^[-\w\._\(\)]+$`, Chain: nil}}}}); err != nil {
		return result, validation.NewError("delegatednetwork.DelegatedSubnetServiceClient", "DeleteDetails", err.Error())
	}

	req, err := client.DeleteDetailsPreparer(ctx, resourceGroupName, resourceName, vnetName, subnetName)
	if err != nil {
...
func (client DelegatedSubnetServiceClient) DeleteDetailsPreparer(ctx context.Context, resourceGroupName string, resourceName string, vnetName string, subnetName string) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithPathParameters("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualNetworks/{vnetName}/subnets/{subnetName}/providers/Microsoft.DelegatedNetwork/delegatedSubnets/{resourceName}", pathParameters),
...
// subnetName - the name of the delegated subnet. This name must be at least 1 character in length, and no more
// than 90.
func (client DelegatedSubnetServiceClient) GetDetails(ctx context.Context, resourceGroupName string, resourceName string, vnetName string, subnetName string) (result DelegatedSubnet, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.GetDetailsPreparer(ctx, resourceGroupName, resourceName, vnetName, subnetName)
	if err != nil {
...
func (client DelegatedSubnetServiceClient) GetDetailsPreparer(ctx context.Context, resourceGroupName string, resourceName string, vnetName string, subnetName string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"resourceName":      autorest.Encode("path", resourceName),
		"subnetName":        autorest.Encode("path", subnetName),
...
// resourceGroupName - the name of the Azure Resource group of which a given DelegatedNetwork resource is part.
// This name must be at least 1 character in length, and no more than 90.
func (client DelegatedSubnetServiceClient) ListByResourceGroup(ctx context.Context, resourceGroupName string) (result DelegatedSubnetList, err error) {
	if tracing.IsEnabled() {
...
func (client DelegatedSubnetServiceClient) ListByResourceGroupPreparer(ctx context.Context, resourceGroupName string) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		autorest.AsGet(),
		autorest.WithBaseURL(client.BaseURI),
		autorest.WithPathParameters("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DelegatedNetwork/delegatedSubnetInstances", pathParameters),
		autorest.WithQueryParameters(queryParameters))
	return preparer.Prepare((&http.Request{}).WithContext(ctx))
}
...
// closes the http.Response Body.
func (client DelegatedSubnetServiceClient) ListByResourceGroupResponder(resp *http.Response) (result DelegatedSubnetList, err error) {
	err = autorest.Respond(
		resp,
		azure.WithErrorUnlessStatusCode(http.StatusOK),
		autorest.ByUnmarshallingJSON(&result),
...
func (client DelegatedSubnetServiceClient) ListBySubscription(ctx context.Context) (result DelegatedSubnetList, err error) {
	if tracing.IsEnabled() {
...
func (client DelegatedSubnetServiceClient) ListBySubscriptionPreparer(ctx context.Context) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		autorest.AsGet(),
		autorest.WithBaseURL(client.BaseURI),
		autorest.WithPathParameters("/subscriptions/{subscriptionId}/providers/Microsoft.DelegatedNetwork/delegatedSubnetInstances", pathParameters),
		autorest.WithQueryParameters(queryParameters))
	return preparer.Prepare((&http.Request{}).WithContext(ctx))
}
...
// closes the http.Response Body.
func (client DelegatedSubnetServiceClient) ListBySubscriptionResponder(resp *http.Response) (result DelegatedSubnetList, err error) {
	err = autorest.Respond(
		resp,
		azure.WithErrorUnlessStatusCode(http.StatusOK),
		autorest.ByUnmarshallingJSON(&result),
...
// subnetName - the name of the delegated subnet. This name must be at least 1 character in length, and no more
// than 90.
// delegatedSubnetParameters - delegated subnet details.
func (client DelegatedSubnetServiceClient) PatchDetails(ctx context.Context, resourceGroupName string, resourceName string, vnetName string, subnetName string, delegatedSubnetParameters DelegatedSubnetParameters) (result DelegatedSubnetServicePatchDetailsFuture, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.PatchDetailsPreparer(ctx, resourceGroupName, resourceName, vnetName, subnetName, delegatedSubnetParameters)
	if err != nil {
...
func (client DelegatedSubnetServiceClient) PatchDetailsPreparer(ctx context.Context, resourceGroupName string, resourceName string, vnetName string, subnetName string, delegatedSubnetParameters DelegatedSubnetParameters) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"resourceName":      autorest.Encode("path", resourceName),
		"subnetName":        autorest.Encode("path", subnetName),
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithBaseURL(client.BaseURI),
		autorest.WithPathParameters("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualNetworks/{vnetName}/subnets/{subnetName}/providers/Microsoft.DelegatedNetwork/delegatedSubnets/{resourceName}", pathParameters),
		autorest.WithJSON(delegatedSubnetParameters),
		autorest.WithQueryParameters(queryParameters))
	return preparer.Prepare((&http.Request{}).WithContext(ctx))
}
...
// than 90.
// delegatedSubnetParameters - delegated subnet details.
func (client DelegatedSubnetServiceClient) PutDetails(ctx context.Context, resourceGroupName string, resourceName string, vnetName string, subnetName string, delegatedSubnetParameters DelegatedSubnetParameters) (result DelegatedSubnetServicePutDetailsFuture, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.PutDetailsPreparer(ctx, resourceGroupName, resourceName, vnetName, subnetName, delegatedSubnetParameters)
	if err != nil {
...
func (client DelegatedSubnetServiceClient) PutDetailsPreparer(ctx context.Context, resourceGroupName string, resourceName string, vnetName string, subnetName string, delegatedSubnetParameters DelegatedSubnetParameters) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"resourceName":      autorest.Encode("path", resourceName),
		"subnetName":        autorest.Encode("path", subnetName),
