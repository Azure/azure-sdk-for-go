...
func NewDelegatedControllersPage(getNextPage func(context.Context, DelegatedControllers) (DelegatedControllers, error)) DelegatedControllersPage {
	return DelegatedControllersPage{fn: getNextPage}
}
...
func NewDelegatedSubnetsPage(getNextPage func(context.Context, DelegatedSubnets) (DelegatedSubnets, error)) DelegatedSubnetsPage {
	return DelegatedSubnetsPage{fn: getNextPage}
}
...
func NewOrchestratorsPage(getNextPage func(context.Context, Orchestrators) (Orchestrators, error)) OrchestratorsPage {
	return OrchestratorsPage{fn: getNextPage}
}
