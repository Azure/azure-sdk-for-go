...
// ControllerProperties properties of Delegated controller resource.
type ControllerProperties struct {
	...
	// Type - Type of dnc controller.
	Type *string `json:"type,omitempty"`
	// ResourceGUID - Gets or sets resource GUID property of the controller resource.
	ResourceGUID *string `json:"resourceGuid,omitempty"`
	// DncAppID - Get controller AAD ID.
	DncAppID *string `json:"dncAppID,omitempty"`
	// DncEndpoint - Dnc Endpoint url.
...
func (cp ControllerProperties) MarshalJSON() ([]byte, error) {
	...
	if cp.ResourceGUID != nil {
		objectMap["resourceGuid"] = cp.ResourceGUID
	}
	if cp.DncAppID != nil {
		objectMap["dncAppID"] = cp.DncAppID
	}
	if cp.DncEndpoint != nil {
		objectMap["dncEndpoint"] = cp.DncEndpoint
	}
...
type ControllerTypeParameters struct {
	// ControllerType - Type of Delegated controller.
	ControllerType *string `json:"controllerType,omitempty"`
	// KubernetesProperties - properties of kubernetes clusters
	KubernetesProperties *[]KubernetesProperties `json:"kubernetesProperties,omitempty"`
}

// DelegatedController represents an instance of a DNC controller.
type DelegatedController struct {
	autorest.Response `json:"-"`
	// ControllerProperties - Properties of the provision operation request.
...
func (dc DelegatedController) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if dc.ControllerProperties != nil {
		objectMap["properties"] = dc.ControllerProperties
	}
	if dc.Location != nil {
	...
	for k, v := range m {
		...
		case "properties":
			if v != nil {
				...
				dc.ControllerProperties = &controllerProperties
			}
		case "id":
			if v != nil {
				var ID string
...
type DelegatedSubnet struct {
	autorest.Response `json:"-"`
	// DelegatedSubnetProperties - Properties of the delegated subnet request
...
type DelegatedSubnetParameters struct {
	// ControllerID - Delegated Network Controller ID
	ControllerID *string `json:"controllerID,omitempty"`
}

// DelegatedSubnetProperties properties of delegated subnet resource.
...
// KubernetesProperties properties of kubernetes cluster
