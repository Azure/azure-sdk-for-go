...
type RestRequest struct {
	...
	Authentication *RestRequestAuthentication `json:"authentication,omitempty"`
}

// RestRequestAuthentication the authentication information required in the REST health check request to
// the health provider.
type RestRequestAuthentication struct {
	// Type - The authentication type. ApiKey authentication gives a name and a value that can be included in either the request header or query parameters.
	Type *string `json:"type,omitempty"`
