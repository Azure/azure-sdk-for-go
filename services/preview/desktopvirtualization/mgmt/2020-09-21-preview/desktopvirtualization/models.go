...
func NewExpandMsixImageListPage(getNextPage func(context.Context, ExpandMsixImageList) (ExpandMsixImageList, error)) ExpandMsixImageListPage {
	return ExpandMsixImageListPage{fn: getNextPage}
}
...
func NewMSIXPackageListPage(getNextPage func(context.Context, MSIXPackageList) (MSIXPackageList, error)) MSIXPackageListPage {
	return MSIXPackageListPage{fn: getNextPage}
}
