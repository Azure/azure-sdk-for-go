...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/preview/desktopvirtualization/mgmt/2021-01-14-preview/desktopvirtualization"
...
type ScalingPlanPatchProperties struct {
	...
	// HostPoolType - HostPool type for scaling plan. Possible values include: 'Personal', 'Pooled'
	HostPoolType HostPoolType `json:"hostPoolType,omitempty"`
...
type ScalingSchedule struct {
	...
	// RampUpAlgorithm - Load balancing algorithm for ramp up period. Possible values include: 'SessionHostLoadBalancingAlgorithmBreadthFirst', 'SessionHostLoadBalancingAlgorithmDepthFirst'
	RampUpAlgorithm SessionHostLoadBalancingAlgorithm `json:"rampUpAlgorithm,omitempty"`
	// RampUpMinimumHostPct - Minimum host percentage for ramp up period.
	RampUpMinimumHostPct *int32 `json:"rampUpMinimumHostPct,omitempty"`
	...
	// RampDownNotificationMinutes - Number of minutes to wait to stop hosts during ramp down period.
	RampDownNotificationMinutes *int32 `json:"rampDownNotificationMinutes,omitempty"`
