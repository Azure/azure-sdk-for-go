...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/preview/desktopvirtualization/mgmt/2021-03-09-preview/desktopvirtualization"
...
type HostPoolProperties struct {
	...
	// Description - Description of HostPool.
	Description *string `json:"description,omitempty"`
	// HostPoolType - HostPool type for desktop. Possible values include: 'Personal', 'Pooled', 'BYODesktop'
...
type MigrationRequestProperties struct {
	// Operation - The type of operation for migration. Possible values include: 'Start', 'Revoke', 'Complete', 'Hide', 'Unhide'
...
type ScalingSchedule struct {
	...
	RampUpStartTime *date.Time `json:"rampUpStartTime,omitempty"`
	...
	PeakStartTime *date.Time `json:"peakStartTime,omitempty"`
	...
	RampDownStartTime *date.Time `json:"rampDownStartTime,omitempty"`
	...
	// RampDownStopHostsWhen - Specifies when to stop hosts during ramp down period. Possible values include: 'ZeroSessions', 'ZeroActiveSessions'
	...
	OffPeakStartTime *date.Time `json:"offPeakStartTime,omitempty"`
...
type SessionHostHealthCheckReport struct {
	// HealthCheckName - READ-ONLY; Represents the name of the health check operation performed. Possible values include: 'DomainJoinedCheck', 'DomainTrustCheck', 'FSLogixHealthCheck', 'SxSStackListenerCheck', 'UrlsAccessibleCheck', 'MonitoringAgentCheck', 'DomainReachable', 'WebRTCRedirectorCheck', 'SupportedEncryptionCheck', 'MetaDataServiceCheck', 'AppAttachHealthCheck'
	HealthCheckName HealthCheckName `json:"healthCheckName,omitempty"`
	// HealthCheckResult - READ-ONLY; Represents the Health state of the health check we performed. Possible values include: 'Unknown', 'HealthCheckSucceeded', 'HealthCheckFailed', 'SessionHostShutdown'
...
type SessionHostProperties struct {
	...
	// AssignedUser - User assigned to SessionHost.
	AssignedUser *string `json:"assignedUser,omitempty"`
	// Status - Status for a SessionHost. Possible values include: 'Available', 'Unavailable', 'Shutdown', 'Disconnected', 'Upgrading', 'UpgradeFailed', 'NoHeartbeat', 'NotJoinedToDomain', 'DomainTrustRelationshipLost', 'SxSStackListenerNotReady', 'FSLogixNotHealthy', 'NeedsAssistance'
	...
	// UpdateState - Update state of a SessionHost. Possible values include: 'Initial', 'Pending', 'Started', 'Succeeded', 'Failed'
