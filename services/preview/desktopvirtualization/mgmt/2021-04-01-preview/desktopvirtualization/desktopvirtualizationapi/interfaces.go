...
import (
	"context"
	"github.com/Azure/azure-sdk-for-go/services/preview/desktopvirtualization/mgmt/2021-04-01-preview/desktopvirtualization"
...
type PrivateEndpointConnectionsClientAPI interface {
	DeleteByHostPool(ctx context.Context, resourceGroupName string, hostPoolName string, privateEndpointConnectionName string) (result autorest.Response, err error)
	DeleteByWorkspace(ctx context.Context, resourceGroupName string, workspaceName string, privateEndpointConnectionName string) (result autorest.Response, err error)
	GetByHostPool(ctx context.Context, resourceGroupName string, hostPoolName string, privateEndpointConnectionName string) (result desktopvirtualization.PrivateEndpointConnectionWithSystemData, err error)
	GetByWorkspace(ctx context.Context, resourceGroupName string, workspaceName string, privateEndpointConnectionName string) (result desktopvirtualization.PrivateEndpointConnectionWithSystemData, err error)
	ListByHostPool(ctx context.Context, resourceGroupName string, hostPoolName string) (result desktopvirtualization.PrivateEndpointConnectionListResultWithSystemData, err error)
	ListByWorkspace(ctx context.Context, resourceGroupName string, workspaceName string) (result desktopvirtualization.PrivateEndpointConnectionListResultWithSystemData, err error)
	UpdateByHostPool(ctx context.Context, resourceGroupName string, hostPoolName string, privateEndpointConnectionName string, connection desktopvirtualization.PrivateEndpointConnection) (result desktopvirtualization.PrivateEndpointConnectionWithSystemData, err error)
	UpdateByWorkspace(ctx context.Context, resourceGroupName string, workspaceName string, privateEndpointConnectionName string, connection desktopvirtualization.PrivateEndpointConnection) (result desktopvirtualization.PrivateEndpointConnectionWithSystemData, err error)
}

var _ PrivateEndpointConnectionsClientAPI = (*desktopvirtualization.PrivateEndpointConnectionsClient)(nil)

// PrivateLinkResourcesClientAPI contains the set of methods on the PrivateLinkResourcesClient type.
type PrivateLinkResourcesClientAPI interface {
	ListByHostPool(ctx context.Context, resourceGroupName string, hostPoolName string) (result desktopvirtualization.PrivateLinkResourceListResult, err error)
	ListByWorkspace(ctx context.Context, resourceGroupName string, workspaceName string) (result desktopvirtualization.PrivateLinkResourceListResult, err error)
}

var _ PrivateLinkResourcesClientAPI = (*desktopvirtualization.PrivateLinkResourcesClient)(nil)
