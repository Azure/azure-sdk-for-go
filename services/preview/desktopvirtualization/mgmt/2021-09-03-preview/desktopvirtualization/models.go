...
type HostPoolPatchProperties struct {
	...
	// PublicNetworkAccess - Enabled to allow this resource to be access from the public network. Possible values include: 'Enabled', 'Disabled'
...
type HostPoolProperties struct {
	...
	// CloudPcResource - READ-ONLY; Is cloud pc resource.
	CloudPcResource *bool `json:"cloudPcResource,omitempty"`
	// PublicNetworkAccess - Enabled allows this resource to be accessed from both public and private networks, Disabled allows this resource to only be accessed via private endpoints. Possible values include: 'Enabled', 'Disabled'
	PublicNetworkAccess PublicNetworkAccess `json:"publicNetworkAccess,omitempty"`
}
