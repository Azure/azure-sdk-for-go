...
import (
	"context"
	"github.com/Azure/azure-sdk-for-go/services/preview/desktopvirtualization/mgmt/2022-02-03-preview/desktopvirtualization"
	"github.com/Azure/go-autorest/autorest"
)

// OperationsClientAPI contains the set of methods on the OperationsClient type.
type OperationsClientAPI interface {
	List(ctx context.Context) (result desktopvirtualization.ResourceProviderOperationListPage, err error)
	ListComplete(ctx context.Context) (result desktopvirtualization.ResourceProviderOperationListIterator, err error)
}
...
type DesktopsClientAPI interface {
	...
	List(ctx context.Context, resourceGroupName string, applicationGroupName string) (result desktopvirtualization.DesktopListPage, err error)
	ListComplete(ctx context.Context, resourceGroupName string, applicationGroupName string) (result desktopvirtualization.DesktopListIterator, err error)
...
type SessionHostsClientAPI interface {
	...
	Update(ctx context.Context, resourceGroupName string, hostPoolName string, sessionHostName string, sessionHost *desktopvirtualization.SessionHostPatch, force *bool) (result desktopvirtualization.SessionHost, err error)
}
...
type PrivateEndpointConnectionsClientAPI interface {
	...
	ListByHostPool(ctx context.Context, resourceGroupName string, hostPoolName string) (result desktopvirtualization.PrivateEndpointConnectionListResultWithSystemDataPage, err error)
	ListByHostPoolComplete(ctx context.Context, resourceGroupName string, hostPoolName string) (result desktopvirtualization.PrivateEndpointConnectionListResultWithSystemDataIterator, err error)
	ListByWorkspace(ctx context.Context, resourceGroupName string, workspaceName string) (result desktopvirtualization.PrivateEndpointConnectionListResultWithSystemDataPage, err error)
	ListByWorkspaceComplete(ctx context.Context, resourceGroupName string, workspaceName string) (result desktopvirtualization.PrivateEndpointConnectionListResultWithSystemDataIterator, err error)
...
type PrivateLinkResourcesClientAPI interface {
	ListByHostPool(ctx context.Context, resourceGroupName string, hostPoolName string) (result desktopvirtualization.PrivateLinkResourceListResultPage, err error)
	ListByHostPoolComplete(ctx context.Context, resourceGroupName string, hostPoolName string) (result desktopvirtualization.PrivateLinkResourceListResultIterator, err error)
	ListByWorkspace(ctx context.Context, resourceGroupName string, workspaceName string) (result desktopvirtualization.PrivateLinkResourceListResultPage, err error)
	ListByWorkspaceComplete(ctx context.Context, resourceGroupName string, workspaceName string) (result desktopvirtualization.PrivateLinkResourceListResultIterator, err error)
}
