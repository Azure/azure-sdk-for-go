...
// AgentUpdatePatchProperties the session host configuration for updating agent, monitoring agent, and
// stack component.
type AgentUpdatePatchProperties struct {
	// Type - The type of maintenance for session host components. Possible values include: 'Default', 'Scheduled'
...
// AgentUpdateProperties the session host configuration for updating agent, monitoring agent, and stack
// component.
...
type MaintenanceWindowPatchProperties struct {
	...
	// DayOfWeek - Day of the week. Possible values include: 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday'
