...
func (client Client) Add(ctx context.Context, ID string, twin interface{}, ifNoneMatch string, traceparent string, tracestate string) (result SetObject, err error) {
...
func (client Client) AddPreparer(ctx context.Context, ID string, twin interface{}, ifNoneMatch string, traceparent string, tracestate string) (*http.Request, error) {
...
// traceparent - identifies the request in a distributed tracing system.
// tracestate - provides vendor-specific trace identification information and is a companion to traceparent.
func (client Client) AddRelationship(ctx context.Context, ID string, relationshipID string, relationship interface{}, ifNoneMatch string, traceparent string, tracestate string) (result SetObject, err error) {
	if tracing.IsEnabled() {
...
func (client Client) AddRelationshipPreparer(ctx context.Context, ID string, relationshipID string, relationship interface{}, ifNoneMatch string, traceparent string, tracestate string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"id":             autorest.Encode("path", ID),
...
// traceparent - identifies the request in a distributed tracing system.
// tracestate - provides vendor-specific trace identification information and is a companion to traceparent.
func (client Client) Delete(ctx context.Context, ID string, ifMatch string, traceparent string, tracestate string) (result autorest.Response, err error) {
	if tracing.IsEnabled() {
...
func (client Client) DeletePreparer(ctx context.Context, ID string, ifMatch string, traceparent string, tracestate string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"id": autorest.Encode("path", ID),
	}
...
// traceparent - identifies the request in a distributed tracing system.
// tracestate - provides vendor-specific trace identification information and is a companion to traceparent.
func (client Client) DeleteRelationship(ctx context.Context, ID string, relationshipID string, ifMatch string, traceparent string, tracestate string) (result autorest.Response, err error) {
	if tracing.IsEnabled() {
...
func (client Client) DeleteRelationshipPreparer(ctx context.Context, ID string, relationshipID string, ifMatch string, traceparent string, tracestate string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"id":             autorest.Encode("path", ID),
		"relationshipId": autorest.Encode("path", relationshipID),
	}
...
// traceparent - identifies the request in a distributed tracing system.
// tracestate - provides vendor-specific trace identification information and is a companion to traceparent.
func (client Client) GetByID(ctx context.Context, ID string, traceparent string, tracestate string) (result SetObject, err error) {
	if tracing.IsEnabled() {
...
func (client Client) GetByIDPreparer(ctx context.Context, ID string, traceparent string, tracestate string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"id": autorest.Encode("path", ID),
	}
...
// traceparent - identifies the request in a distributed tracing system.
// tracestate - provides vendor-specific trace identification information and is a companion to traceparent.
func (client Client) GetComponent(ctx context.Context, ID string, componentPath string, traceparent string, tracestate string) (result SetObject, err error) {
	if tracing.IsEnabled() {
...
func (client Client) GetComponentPreparer(ctx context.Context, ID string, componentPath string, traceparent string, tracestate string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
...
// traceparent - identifies the request in a distributed tracing system.
// tracestate - provides vendor-specific trace identification information and is a companion to traceparent.
func (client Client) GetRelationshipByID(ctx context.Context, ID string, relationshipID string, traceparent string, tracestate string) (result SetObject, err error) {
	if tracing.IsEnabled() {
...
func (client Client) GetRelationshipByIDPreparer(ctx context.Context, ID string, relationshipID string, traceparent string, tracestate string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"id":             autorest.Encode("path", ID),
		"relationshipId": autorest.Encode("path", relationshipID),
	}
...
// traceparent - identifies the request in a distributed tracing system.
// tracestate - provides vendor-specific trace identification information and is a companion to traceparent.
func (client Client) ListIncomingRelationships(ctx context.Context, ID string, traceparent string, tracestate string) (result IncomingRelationshipCollectionPage, err error) {
	if tracing.IsEnabled() {
...
func (client Client) ListIncomingRelationshipsPreparer(ctx context.Context, ID string, traceparent string, tracestate string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"id": autorest.Encode("path", ID),
	}
...
func (client Client) ListIncomingRelationshipsComplete(ctx context.Context, ID string, traceparent string, tracestate string) (result IncomingRelationshipCollectionIterator, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/Client.ListIncomingRelationships")
		defer func() {
			sc := -1
...
// traceparent - identifies the request in a distributed tracing system.
// tracestate - provides vendor-specific trace identification information and is a companion to traceparent.
func (client Client) ListRelationships(ctx context.Context, ID string, relationshipName string, traceparent string, tracestate string) (result RelationshipCollectionPage, err error) {
	if tracing.IsEnabled() {
...
func (client Client) ListRelationshipsPreparer(ctx context.Context, ID string, relationshipName string, traceparent string, tracestate string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"id": autorest.Encode("path", ID),
	}
...
func (client Client) ListRelationshipsComplete(ctx context.Context, ID string, relationshipName string, traceparent string, tracestate string) (result RelationshipCollectionIterator, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/Client.ListRelationships")
		defer func() {
			sc := -1
...
// traceparent - identifies the request in a distributed tracing system.
// tracestate - provides vendor-specific trace identification information and is a companion to traceparent.
func (client Client) SendComponentTelemetry(ctx context.Context, ID string, componentPath string, telemetry interface{}, messageID string, telemetrySourceTime string, traceparent string, tracestate string) (result autorest.Response, err error) {
	if tracing.IsEnabled() {
...
func (client Client) SendComponentTelemetryPreparer(ctx context.Context, ID string, componentPath string, telemetry interface{}, messageID string, telemetrySourceTime string, traceparent string, tracestate string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"componentPath": autorest.Encode("path", componentPath),
		"id":            autorest.Encode("path", ID),
	}
...
// traceparent - identifies the request in a distributed tracing system.
// tracestate - provides vendor-specific trace identification information and is a companion to traceparent.
func (client Client) SendTelemetry(ctx context.Context, ID string, telemetry interface{}, messageID string, telemetrySourceTime string, traceparent string, tracestate string) (result autorest.Response, err error) {
	if tracing.IsEnabled() {
...
func (client Client) SendTelemetryPreparer(ctx context.Context, ID string, telemetry interface{}, messageID string, telemetrySourceTime string, traceparent string, tracestate string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"id": autorest.Encode("path", ID),
	}
...
// traceparent - identifies the request in a distributed tracing system.
// tracestate - provides vendor-specific trace identification information and is a companion to traceparent.
func (client Client) Update(ctx context.Context, ID string, patchDocument []interface{}, ifMatch string, traceparent string, tracestate string) (result autorest.Response, err error) {
	if tracing.IsEnabled() {
...
func (client Client) UpdatePreparer(ctx context.Context, ID string, patchDocument []interface{}, ifMatch string, traceparent string, tracestate string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"id": autorest.Encode("path", ID),
	}
...
// traceparent - identifies the request in a distributed tracing system.
// tracestate - provides vendor-specific trace identification information and is a companion to traceparent.
func (client Client) UpdateComponent(ctx context.Context, ID string, componentPath string, patchDocument []interface{}, ifMatch string, traceparent string, tracestate string) (result autorest.Response, err error) {
	if tracing.IsEnabled() {
	...
	if err := validation.Validate([]validation.Validation{
		{TargetValue: patchDocument,
			Constraints: []validation.Constraint{{Target: "patchDocument", Name: validation.Null, Rule: true, Chain: nil}}}}); err != nil {
		return result, validation.NewError("digitaltwins.Client", "UpdateComponent", err.Error())
	}
...
func (client Client) UpdateComponentPreparer(ctx context.Context, ID string, componentPath string, patchDocument []interface{}, ifMatch string, traceparent string, tracestate string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"componentPath": autorest.Encode("path", componentPath),
		"id":            autorest.Encode("path", ID),
	}
...
// traceparent - identifies the request in a distributed tracing system.
// tracestate - provides vendor-specific trace identification information and is a companion to traceparent.
func (client Client) UpdateRelationship(ctx context.Context, ID string, relationshipID string, patchDocument []interface{}, ifMatch string, traceparent string, tracestate string) (result autorest.Response, err error) {
	if tracing.IsEnabled() {
	...
	if err := validation.Validate([]validation.Validation{
		{TargetValue: patchDocument,
			Constraints: []validation.Constraint{{Target: "patchDocument", Name: validation.Null, Rule: true, Chain: nil}}}}); err != nil {
		return result, validation.NewError("digitaltwins.Client", "UpdateRelationship", err.Error())
	}
...
func (client Client) UpdateRelationshipPreparer(ctx context.Context, ID string, relationshipID string, patchDocument []interface{}, ifMatch string, traceparent string, tracestate string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"id":             autorest.Encode("path", ID),
		"relationshipId": autorest.Encode("path", relationshipID),
	}
