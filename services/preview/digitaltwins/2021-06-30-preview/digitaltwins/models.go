...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/preview/digitaltwins/2021-06-30-preview/digitaltwins"
...
// PagedDigitalTwinsModelDataCollectionIterator provides access to a complete listing of ModelData values.
type PagedDigitalTwinsModelDataCollectionIterator struct {
	i    int
	page PagedDigitalTwinsModelDataCollectionPage
}

// NextWithContext advances to the next value.  If there was an error making
// the request the iterator does not advance and the error is returned.
func (iter *PagedDigitalTwinsModelDataCollectionIterator) NextWithContext(ctx context.Context) (err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/PagedDigitalTwinsModelDataCollectionIterator.NextWithContext")
		defer func() {
			sc := -1
			if iter.Response().Response.Response != nil {
				sc = iter.Response().Response.Response.StatusCode
...
// the request the iterator does not advance and the error is returned.
// Deprecated: Use NextWithContext() instead.
func (iter *PagedDigitalTwinsModelDataCollectionIterator) Next() error {
	return iter.NextWithContext(context.Background())
}

// NotDone returns true if the enumeration should be started or is not yet complete.
func (iter PagedDigitalTwinsModelDataCollectionIterator) NotDone() bool {
	return iter.page.NotDone() && iter.i < len(iter.page.Values())
}

// Response returns the raw server response from the last page request.
func (iter PagedDigitalTwinsModelDataCollectionIterator) Response() PagedDigitalTwinsModelDataCollection {
	return iter.page.Response()
}

// Value returns the current value or a zero-initialized value if the
// iterator has advanced beyond the end of the collection.
func (iter PagedDigitalTwinsModelDataCollectionIterator) Value() ModelData {
	if !iter.page.NotDone() {
		return ModelData{}
	}
	return iter.page.Values()[iter.i]
...
// Creates a new instance of the PagedDigitalTwinsModelDataCollectionIterator type.
func NewPagedDigitalTwinsModelDataCollectionIterator(page PagedDigitalTwinsModelDataCollectionPage) PagedDigitalTwinsModelDataCollectionIterator {
	return PagedDigitalTwinsModelDataCollectionIterator{page: page}
}

// IsEmpty returns true if the ListResult contains no values.
func (pdtmdc PagedDigitalTwinsModelDataCollection) IsEmpty() bool {
	return pdtmdc.Value == nil || len(*pdtmdc.Value) == 0
}

// hasNextLink returns true if the NextLink is not empty.
func (pdtmdc PagedDigitalTwinsModelDataCollection) hasNextLink() bool {
	return pdtmdc.NextLink != nil && len(*pdtmdc.NextLink) != 0
}

// pagedDigitalTwinsModelDataCollectionPreparer prepares a request to retrieve the next set of results.
// It returns nil if no more results exist.
func (pdtmdc PagedDigitalTwinsModelDataCollection) pagedDigitalTwinsModelDataCollectionPreparer(ctx context.Context) (*http.Request, error) {
	if !pdtmdc.hasNextLink() {
		return nil, nil
	}
	return autorest.Prepare((&http.Request{}).WithContext(ctx),
		autorest.AsJSON(),
		autorest.AsGet(),
		autorest.WithBaseURL(to.String(pdtmdc.NextLink)))
}

// PagedDigitalTwinsModelDataCollectionPage contains a page of ModelData values.
type PagedDigitalTwinsModelDataCollectionPage struct {
	fn     func(context.Context, PagedDigitalTwinsModelDataCollection) (PagedDigitalTwinsModelDataCollection, error)
	pdtmdc PagedDigitalTwinsModelDataCollection
}

// NextWithContext advances to the next page of values.  If there was an error making
// the request the page does not advance and the error is returned.
func (page *PagedDigitalTwinsModelDataCollectionPage) NextWithContext(ctx context.Context) (err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/PagedDigitalTwinsModelDataCollectionPage.NextWithContext")
		defer func() {
			sc := -1
			if page.Response().Response.Response != nil {
				sc = page.Response().Response.Response.StatusCode
	...
	for {
		next, err := page.fn(ctx, page.pdtmdc)
		if err != nil {
			return err
		}
		page.pdtmdc = next
...
// the request the page does not advance and the error is returned.
// Deprecated: Use NextWithContext() instead.
func (page *PagedDigitalTwinsModelDataCollectionPage) Next() error {
	return page.NextWithContext(context.Background())
}

// NotDone returns true if the page enumeration should be started or is not yet complete.
func (page PagedDigitalTwinsModelDataCollectionPage) NotDone() bool {
	return !page.pdtmdc.IsEmpty()
}

// Response returns the raw server response from the last page request.
func (page PagedDigitalTwinsModelDataCollectionPage) Response() PagedDigitalTwinsModelDataCollection {
	return page.pdtmdc
}

// Values returns the slice of values for the current page or nil if there are no values.
func (page PagedDigitalTwinsModelDataCollectionPage) Values() []ModelData {
	if page.pdtmdc.IsEmpty() {
		return nil
	}
	return *page.pdtmdc.Value
}

// Creates a new instance of the PagedDigitalTwinsModelDataCollectionPage type.
func NewPagedDigitalTwinsModelDataCollectionPage(cur PagedDigitalTwinsModelDataCollection, getNextPage func(context.Context, PagedDigitalTwinsModelDataCollection) (PagedDigitalTwinsModelDataCollection, error)) PagedDigitalTwinsModelDataCollectionPage {
	return PagedDigitalTwinsModelDataCollectionPage{
		fn:     getNextPage,
		pdtmdc: cur,
	}
}
