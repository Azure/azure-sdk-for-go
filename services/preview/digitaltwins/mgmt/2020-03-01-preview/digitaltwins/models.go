...
func (eh EventHub) MarshalJSON() ([]byte, error) {
	...
	if eh.ConnectionStringPrimaryKey != nil {
		objectMap["connectionString-PrimaryKey"] = eh.ConnectionStringPrimaryKey
	}
	if eh.ConnectionStringSecondaryKey != nil {
		objectMap["connectionString-SecondaryKey"] = eh.ConnectionStringSecondaryKey
	}
	if eh.Tags != nil {
		objectMap["tags"] = eh.Tags
	}
	if eh.EndpointType != "" {
