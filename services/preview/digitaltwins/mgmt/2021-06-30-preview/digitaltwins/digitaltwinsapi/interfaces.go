...
import (
	"context"
	"github.com/Azure/azure-sdk-for-go/services/preview/digitaltwins/mgmt/2021-06-30-preview/digitaltwins"
)
...
// TimeSeriesDatabaseConnectionsClientAPI contains the set of methods on the TimeSeriesDatabaseConnectionsClient type.
type TimeSeriesDatabaseConnectionsClientAPI interface {
	CreateOrUpdate(ctx context.Context, resourceGroupName string, resourceName string, timeSeriesDatabaseConnectionName string, timeSeriesDatabaseConnectionDescription digitaltwins.TimeSeriesDatabaseConnection) (result digitaltwins.TimeSeriesDatabaseConnectionsCreateOrUpdateFuture, err error)
	Delete(ctx context.Context, resourceGroupName string, resourceName string, timeSeriesDatabaseConnectionName string) (result digitaltwins.TimeSeriesDatabaseConnectionsDeleteFuture, err error)
	Get(ctx context.Context, resourceGroupName string, resourceName string, timeSeriesDatabaseConnectionName string) (result digitaltwins.TimeSeriesDatabaseConnection, err error)
	List(ctx context.Context, resourceGroupName string, resourceName string) (result digitaltwins.TimeSeriesDatabaseConnectionListResultPage, err error)
	ListComplete(ctx context.Context, resourceGroupName string, resourceName string) (result digitaltwins.TimeSeriesDatabaseConnectionListResultIterator, err error)
}

var _ TimeSeriesDatabaseConnectionsClientAPI = (*digitaltwins.TimeSeriesDatabaseConnectionsClient)(nil)
