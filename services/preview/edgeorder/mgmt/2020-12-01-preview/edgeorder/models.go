...
type EncryptionPreferences struct {
	// DoubleEncryptionStatus - Defines secondary layer of software-based encryption enablement. Possible values include: 'Disabled', 'Enabled'
...
type OrderItemDetails struct {
	...
	// CancellationStatus - READ-ONLY; Describes whether the orderItem is cancellable or not. Possible values include: 'Cancellable', 'CancellableWithFee', 'NotCancellable'
	...
	// ReturnStatus - READ-ONLY; Describes whether the orderItem is returnable or not. Possible values include: 'Returnable', 'ReturnableWithFee', 'NotReturnable'
