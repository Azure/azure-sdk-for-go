...
func (future *EventSubscriptionsCreateFuture) UnmarshalJSON(body []byte) error {
...
// result is the default implementation for EventSubscriptionsCreateFuture.Result.
