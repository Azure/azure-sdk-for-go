...
// domainName - name of the top level domain.
// topicName - name of the domain topic.
func (client DomainTopicEventSubscriptionsClient) List(ctx context.Context, resourceGroupName string, domainName string, topicName string) (result EventSubscriptionsListResult, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.ListPreparer(ctx, resourceGroupName, domainName, topicName)
	if err != nil {
...
func (client DomainTopicEventSubscriptionsClient) ListPreparer(ctx context.Context, resourceGroupName string, domainName string, topicName string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"domainName":        autorest.Encode("path", domainName),
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"subscriptionId":    autorest.Encode("path", client.SubscriptionID),
