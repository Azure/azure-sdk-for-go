...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/preview/eventgrid/mgmt/2021-10-15-preview/eventgrid"
...
type AzureADPartnerClientAuthentication struct {
	// AzureADPartnerClientAuthenticationProperties - AzureAD ClientAuthentication Properties
	*AzureADPartnerClientAuthenticationProperties `json:"properties,omitempty"`
	// ClientAuthenticationType - Possible values include: 'ClientAuthenticationTypePartnerClientAuthentication', 'ClientAuthenticationTypeAzureAD'
	ClientAuthenticationType ClientAuthenticationType `json:"clientAuthenticationType,omitempty"`
}
...
func (aapca AzureADPartnerClientAuthentication) MarshalJSON() ([]byte, error) {
	aapca.ClientAuthenticationType = ClientAuthenticationTypeAzureAD
	objectMap := make(map[string]interface{})
	if aapca.AzureADPartnerClientAuthenticationProperties != nil {
		objectMap["properties"] = aapca.AzureADPartnerClientAuthenticationProperties
	}
	if aapca.ClientAuthenticationType != "" {
		objectMap["clientAuthenticationType"] = aapca.ClientAuthenticationType
	}
	return json.Marshal(objectMap)
}
...
func (aapca *AzureADPartnerClientAuthentication) UnmarshalJSON(body []byte) error {
	...
	for k, v := range m {
		...
		case "properties":
			if v != nil {
				var azureADPartnerClientAuthenticationProperties AzureADPartnerClientAuthenticationProperties
				err = json.Unmarshal(*v, &azureADPartnerClientAuthenticationProperties)
				if err != nil {
					return err
				}
				aapca.AzureADPartnerClientAuthenticationProperties = &azureADPartnerClientAuthenticationProperties
			}
		case "clientAuthenticationType":
			if v != nil {
				var clientAuthenticationType ClientAuthenticationType
				err = json.Unmarshal(*v, &clientAuthenticationType)
				if err != nil {
					return err
				}
				aapca.ClientAuthenticationType = clientAuthenticationType
			}
		}
	}
...
// AzureADPartnerClientAuthenticationProperties properties of an Azure Active Directory Partner Client
// Authentication.
...
func (afesd AzureFunctionEventSubscriptionDestination) MarshalJSON() ([]byte, error) {
	afesd.EndpointType = EndpointTypeBasicEventSubscriptionDestinationEndpointTypeAzureFunction
	objectMap := make(map[string]interface{})
...
func (afesd *AzureFunctionEventSubscriptionDestination) UnmarshalJSON(body []byte) error {
	...
	for k, v := range m {
		...
		case "endpointType":
			if v != nil {
				var endpointType EndpointTypeBasicEventSubscriptionDestination
...
type Channel struct {
	...
	*ChannelProperties `json:"properties,omitempty"`
	// SystemData - READ-ONLY; The system metadata relating to Channel resource.
...
type ChannelProperties struct {
	// ChannelType - The type of the event channel which represents the  direction flow of events. Possible values include: 'ChannelTypePartnerTopic', 'ChannelTypePartnerDestination'
	...
	// PartnerDestinationInfo - This property should be populated when channelType is PartnerDestination and represents information about the partner destination resource corresponding to the channel.
	PartnerDestinationInfo BasicPartnerDestinationInfo `json:"partnerDestinationInfo,omitempty"`
	...
	// ProvisioningState - Provisioning state of the channel. Possible values include: 'ChannelProvisioningStateCreating', 'ChannelProvisioningStateUpdating', 'ChannelProvisioningStateDeleting', 'ChannelProvisioningStateSucceeded', 'ChannelProvisioningStateCanceled', 'ChannelProvisioningStateFailed'
	ProvisioningState ChannelProvisioningState `json:"provisioningState,omitempty"`
	// ReadinessState - The readiness state of the corresponding partner topic. Possible values include: 'ReadinessStateNeverActivated', 'ReadinessStateActivated'
	...
	for k, v := range m {
		...
		case "channelType":
			if v != nil {
				...
				err = json.Unmarshal(*v, &channelType)
				if err != nil {
					return err
				}
				cp.ChannelType = channelType
			}
		case "partnerTopicInfo":
			if v != nil {
				var partnerTopicInfo PartnerTopicInfo
				err = json.Unmarshal(*v, &partnerTopicInfo)
				if err != nil {
					return err
				}
				cp.PartnerTopicInfo = &partnerTopicInfo
			}
		case "partnerDestinationInfo":
			if v != nil {
				partnerDestinationInfo, err := unmarshalBasicPartnerDestinationInfo(*v)
				if err != nil {
					return err
				}
				cp.PartnerDestinationInfo = partnerDestinationInfo
			}
		case "messageForActivation":
			if v != nil {
				var messageForActivation string
				err = json.Unmarshal(*v, &messageForActivation)
				if err != nil {
					return err
				}
				cp.MessageForActivation = &messageForActivation
			}
		case "provisioningState":
			if v != nil {
				var provisioningState ChannelProvisioningState
				err = json.Unmarshal(*v, &provisioningState)
				if err != nil {
					return err
				}
				cp.ProvisioningState = provisioningState
			}
		case "readinessState":
			if v != nil {
				var readinessState ReadinessState
				err = json.Unmarshal(*v, &readinessState)
				if err != nil {
					return err
				}
				cp.ReadinessState = readinessState
			}
		case "expirationTimeIfNotActivatedUtc":
			if v != nil {
				var expirationTimeIfNotActivatedUtc date.Time
				err = json.Unmarshal(*v, &expirationTimeIfNotActivatedUtc)
				if err != nil {
					return err
				}
				cp.ExpirationTimeIfNotActivatedUtc = &expirationTimeIfNotActivatedUtc
			}
		}
	}
...
// ChannelsDeleteFuture an abstraction for monitoring and retrieving the results of a long-running
// operation.
type ChannelsDeleteFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(ChannelsClient) (autorest.Response, error)
}
...
// result is the default implementation for ChannelsDeleteFuture.Result.
func (future *ChannelsDeleteFuture) result(client ChannelsClient) (ar autorest.Response, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "eventgrid.ChannelsDeleteFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		ar.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("eventgrid.ChannelsDeleteFuture")
		return
	}
	ar.Response = future.Response()
	return
...
type ChannelsListResult struct {
	autorest.Response `json:"-"`
	// Value - A collection of Channels.
	Value *[]Channel `json:"value,omitempty"`
	// NextLink - A link for the next page of channels.
...
func (iter *ChannelsListResultIterator) NextWithContext(ctx context.Context) (err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/ChannelsListResultIterator.NextWithContext")
		defer func() {
			sc := -1
...
func NewChannelsListResultIterator(page ChannelsListResultPage) ChannelsListResultIterator {
	return ChannelsListResultIterator{page: page}
}
...
func (clr ChannelsListResult) hasNextLink() bool {
	return clr.NextLink != nil && len(*clr.NextLink) != 0
}

// channelsListResultPreparer prepares a request to retrieve the next set of results.
// It returns nil if no more results exist.
func (clr ChannelsListResult) channelsListResultPreparer(ctx context.Context) (*http.Request, error) {
	if !clr.hasNextLink() {
		return nil, nil
	}
...
type ChannelsListResultPage struct {
	fn  func(context.Context, ChannelsListResult) (ChannelsListResult, error)
	clr ChannelsListResult
}
...
func (page *ChannelsListResultPage) NextWithContext(ctx context.Context) (err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/ChannelsListResultPage.NextWithContext")
		defer func() {
			sc := -1
...
func (cup ChannelUpdateParameters) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if cup.ChannelUpdateParametersProperties != nil {
		objectMap["properties"] = cup.ChannelUpdateParametersProperties
	}
	return json.Marshal(objectMap)
}
...
func (cup *ChannelUpdateParameters) UnmarshalJSON(body []byte) error {
	...
	for k, v := range m {
		...
		case "properties":
			if v != nil {
				var channelUpdateParametersProperties ChannelUpdateParametersProperties
				err = json.Unmarshal(*v, &channelUpdateParametersProperties)
				if err != nil {
					return err
				}
				cup.ChannelUpdateParametersProperties = &channelUpdateParametersProperties
			}
		}
	}
...
type ChannelUpdateParametersProperties struct {
	// ExpirationTimeIfNotActivatedUtc - Expiration time of the event channel. If this timer expires while the corresponding partner topic or partner destination is never activated,
	// the channel and corresponding partner topic or partner destination are deleted.
	ExpirationTimeIfNotActivatedUtc *date.Time `json:"expirationTimeIfNotActivatedUtc,omitempty"`
	// PartnerDestinationInfo - Partner destination properties which can be updated if the channel is of type PartnerDestination.
	PartnerDestinationInfo BasicPartnerUpdateDestinationInfo `json:"partnerDestinationInfo,omitempty"`
	// PartnerTopicInfo - Partner topic properties which can be updated if the channel is of type PartnerTopic.
	...
	for k, v := range m {
		...
		case "expirationTimeIfNotActivatedUtc":
			if v != nil {
				...
				cupp.ExpirationTimeIfNotActivatedUtc = &expirationTimeIfNotActivatedUtc
			}
		case "partnerDestinationInfo":
			if v != nil {
				partnerDestinationInfo, err := unmarshalBasicPartnerUpdateDestinationInfo(*v)
				if err != nil {
					return err
				}
				cupp.PartnerDestinationInfo = partnerDestinationInfo
			}
		case "partnerTopicInfo":
			if v != nil {
				var partnerTopicInfo PartnerUpdateTopicInfo
				err = json.Unmarshal(*v, &partnerTopicInfo)
				if err != nil {
					return err
				}
				cupp.PartnerTopicInfo = &partnerTopicInfo
			}
		}
	}
...
type Domain struct {
	...
	*DomainProperties `json:"properties,omitempty"`
	...
	// SystemData - READ-ONLY; The system metadata relating to the Event Grid Domain resource.
	SystemData *SystemData `json:"systemData,omitempty"`
...
// DomainEventSubscriptionsCreateOrUpdateFuture an abstraction for monitoring and retrieving the results of
// a long-running operation.
type DomainEventSubscriptionsCreateOrUpdateFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(DomainEventSubscriptionsClient) (EventSubscription, error)
}
...
// result is the default implementation for DomainEventSubscriptionsCreateOrUpdateFuture.Result.
func (future *DomainEventSubscriptionsCreateOrUpdateFuture) result(client DomainEventSubscriptionsClient) (es EventSubscription, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "eventgrid.DomainEventSubscriptionsCreateOrUpdateFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		es.Response.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("eventgrid.DomainEventSubscriptionsCreateOrUpdateFuture")
		return
	}
	...
	if es.Response.Response, err = future.GetResult(sender); err == nil && es.Response.Response.StatusCode != http.StatusNoContent {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "eventgrid.DomainEventSubscriptionsCreateOrUpdateFuture", "Result", es.Response.Response, "Failure responding to request")
		}
	}
	return
}

// DomainEventSubscriptionsDeleteFuture an abstraction for monitoring and retrieving the results of a
// long-running operation.
type DomainEventSubscriptionsDeleteFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(DomainEventSubscriptionsClient) (autorest.Response, error)
}
...
// result is the default implementation for DomainEventSubscriptionsDeleteFuture.Result.
func (future *DomainEventSubscriptionsDeleteFuture) result(client DomainEventSubscriptionsClient) (ar autorest.Response, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "eventgrid.DomainEventSubscriptionsDeleteFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		ar.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("eventgrid.DomainEventSubscriptionsDeleteFuture")
		return
	}
	ar.Response = future.Response()
	return
...
// DomainEventSubscriptionsUpdateFuture an abstraction for monitoring and retrieving the results of a
// long-running operation.
type DomainEventSubscriptionsUpdateFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(DomainEventSubscriptionsClient) (EventSubscription, error)
...
// result is the default implementation for DomainEventSubscriptionsUpdateFuture.Result.
func (future *DomainEventSubscriptionsUpdateFuture) result(client DomainEventSubscriptionsClient) (es EventSubscription, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "eventgrid.DomainEventSubscriptionsUpdateFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		es.Response.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("eventgrid.DomainEventSubscriptionsUpdateFuture")
		return
	}
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if es.Response.Response, err = future.GetResult(sender); err == nil && es.Response.Response.StatusCode != http.StatusNoContent {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "eventgrid.DomainEventSubscriptionsUpdateFuture", "Result", es.Response.Response, "Failure responding to request")
		}
	}
	return
}
...
type DomainProperties struct {
	...
	// Endpoint - READ-ONLY; Endpoint for the Event Grid Domain Resource which is used for publishing the events.
	Endpoint *string `json:"endpoint,omitempty"`
	// InputSchema - This determines the format that Event Grid should expect for incoming events published to the Event Grid Domain Resource. Possible values include: 'InputSchemaEventGridSchema', 'InputSchemaCustomEventSchema', 'InputSchemaCloudEventSchemaV10'
	...
	// MetricResourceID - READ-ONLY; Metric resource id for the Event Grid Domain Resource.
	...
	// DataResidencyBoundary - Data Residency Boundary of the resource. Possible values include: 'DataResidencyBoundaryWithinGeopair', 'DataResidencyBoundaryWithinRegion'
...
func (dp DomainProperties) MarshalJSON() ([]byte, error) {
	...
	if dp.DataResidencyBoundary != "" {
		objectMap["dataResidencyBoundary"] = dp.DataResidencyBoundary
	}
	return json.Marshal(objectMap)
}
...
func (dp *DomainProperties) UnmarshalJSON(body []byte) error {
	...
	for k, v := range m {
		...
		case "dataResidencyBoundary":
			if v != nil {
				var dataResidencyBoundary DataResidencyBoundary
				err = json.Unmarshal(*v, &dataResidencyBoundary)
				if err != nil {
					return err
				}
				dp.DataResidencyBoundary = dataResidencyBoundary
			}
		}
	}
...
// DomainTopicEventSubscriptionsCreateOrUpdateFuture an abstraction for monitoring and retrieving the
// results of a long-running operation.
type DomainTopicEventSubscriptionsCreateOrUpdateFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(DomainTopicEventSubscriptionsClient) (EventSubscription, error)
}
...
// result is the default implementation for DomainTopicEventSubscriptionsCreateOrUpdateFuture.Result.
func (future *DomainTopicEventSubscriptionsCreateOrUpdateFuture) result(client DomainTopicEventSubscriptionsClient) (es EventSubscription, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "eventgrid.DomainTopicEventSubscriptionsCreateOrUpdateFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		es.Response.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("eventgrid.DomainTopicEventSubscriptionsCreateOrUpdateFuture")
		return
	}
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if es.Response.Response, err = future.GetResult(sender); err == nil && es.Response.Response.StatusCode != http.StatusNoContent {
		es, err = client.CreateOrUpdateResponder(es.Response.Response)
		if err != nil {
			err = autorest.NewErrorWithError(err, "eventgrid.DomainTopicEventSubscriptionsCreateOrUpdateFuture", "Result", es.Response.Response, "Failure responding to request")
		}
	}
	return
}

// DomainTopicEventSubscriptionsDeleteFuture an abstraction for monitoring and retrieving the results of a
// long-running operation.
type DomainTopicEventSubscriptionsDeleteFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(DomainTopicEventSubscriptionsClient) (autorest.Response, error)
}
...
// result is the default implementation for DomainTopicEventSubscriptionsDeleteFuture.Result.
func (future *DomainTopicEventSubscriptionsDeleteFuture) result(client DomainTopicEventSubscriptionsClient) (ar autorest.Response, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "eventgrid.DomainTopicEventSubscriptionsDeleteFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		ar.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("eventgrid.DomainTopicEventSubscriptionsDeleteFuture")
		return
	}
	ar.Response = future.Response()
	return
...
// DomainTopicEventSubscriptionsUpdateFuture an abstraction for monitoring and retrieving the results of a
// long-running operation.
type DomainTopicEventSubscriptionsUpdateFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(DomainTopicEventSubscriptionsClient) (EventSubscription, error)
...
// result is the default implementation for DomainTopicEventSubscriptionsUpdateFuture.Result.
func (future *DomainTopicEventSubscriptionsUpdateFuture) result(client DomainTopicEventSubscriptionsClient) (es EventSubscription, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "eventgrid.DomainTopicEventSubscriptionsUpdateFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		es.Response.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("eventgrid.DomainTopicEventSubscriptionsUpdateFuture")
		return
	}
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if es.Response.Response, err = future.GetResult(sender); err == nil && es.Response.Response.StatusCode != http.StatusNoContent {
		es, err = client.UpdateResponder(es.Response.Response)
		if err != nil {
			err = autorest.NewErrorWithError(err, "eventgrid.DomainTopicEventSubscriptionsUpdateFuture", "Result", es.Response.Response, "Failure responding to request")
		}
	}
	return
}
...
type DomainUpdateParameterProperties struct {
	...
	// resources by the user.
	AutoDeleteTopicWithLastSubscription *bool `json:"autoDeleteTopicWithLastSubscription,omitempty"`
	// DataResidencyBoundary - The data residency boundary for the domain. Possible values include: 'DataResidencyBoundaryWithinGeopair', 'DataResidencyBoundaryWithinRegion'
	DataResidencyBoundary DataResidencyBoundary `json:"dataResidencyBoundary,omitempty"`
}
...
type EventChannelFilter struct {
	// EnableAdvancedFilteringOnArrays - Allows advanced filters to be evaluated against an array of values instead of expecting a singular value. The default value is either false or null.
...
type EventChannelProperties struct {
	...
	// PartnerTopicReadinessState - READ-ONLY; The readiness state of the corresponding partner topic. Possible values include: 'PartnerTopicReadinessStateNotActivatedByUserYet', 'PartnerTopicReadinessStateActivatedByUser', 'PartnerTopicReadinessStateDeactivatedByUser', 'PartnerTopicReadinessStateDeletedByUser'
...
func (ehesd EventHubEventSubscriptionDestination) MarshalJSON() ([]byte, error) {
	ehesd.EndpointType = EndpointTypeBasicEventSubscriptionDestinationEndpointTypeEventHub
	objectMap := make(map[string]interface{})
...
type BasicEventSubscriptionDestination interface {
	...
	AsPartnerEventSubscriptionDestination() (*PartnerEventSubscriptionDestination, bool)
...
func unmarshalBasicEventSubscriptionDestination(body []byte) (BasicEventSubscriptionDestination, error) {
	...
	switch m["endpointType"] {
	case string(EndpointTypeBasicEventSubscriptionDestinationEndpointTypeWebHook):
		var whesd WebHookEventSubscriptionDestination
		err := json.Unmarshal(body, &whesd)
		return whesd, err
	case string(EndpointTypeBasicEventSubscriptionDestinationEndpointTypeEventHub):
		var ehesd EventHubEventSubscriptionDestination
		err := json.Unmarshal(body, &ehesd)
		return ehesd, err
	case string(EndpointTypeBasicEventSubscriptionDestinationEndpointTypeStorageQueue):
		var sqesd StorageQueueEventSubscriptionDestination
		err := json.Unmarshal(body, &sqesd)
		return sqesd, err
	case string(EndpointTypeBasicEventSubscriptionDestinationEndpointTypeHybridConnection):
		var hcesd HybridConnectionEventSubscriptionDestination
		err := json.Unmarshal(body, &hcesd)
		return hcesd, err
	case string(EndpointTypeBasicEventSubscriptionDestinationEndpointTypeServiceBusQueue):
		var sbqesd ServiceBusQueueEventSubscriptionDestination
		err := json.Unmarshal(body, &sbqesd)
		return sbqesd, err
	case string(EndpointTypeBasicEventSubscriptionDestinationEndpointTypeServiceBusTopic):
		var sbtesd ServiceBusTopicEventSubscriptionDestination
		err := json.Unmarshal(body, &sbtesd)
		return sbtesd, err
	case string(EndpointTypeBasicEventSubscriptionDestinationEndpointTypeAzureFunction):
		var afesd AzureFunctionEventSubscriptionDestination
		err := json.Unmarshal(body, &afesd)
		return afesd, err
	case string(EndpointTypeBasicEventSubscriptionDestinationEndpointTypePartnerDestination):
		var pesd PartnerEventSubscriptionDestination
		err := json.Unmarshal(body, &pesd)
		return pesd, err
	default:
...
func (esd EventSubscriptionDestination) MarshalJSON() ([]byte, error) {
	esd.EndpointType = EndpointTypeBasicEventSubscriptionDestinationEndpointTypeEventSubscriptionDestination
	objectMap := make(map[string]interface{})
	if esd.EndpointType != "" {
...
type EventTypeInfo struct {
	// Kind - The kind of event type used. Possible values include: 'EventDefinitionKindInline'
	...
	InlineEventTypes map[string]*InlineEventProperties `json:"inlineEventTypes"`
}
...
func (eti EventTypeInfo) MarshalJSON() ([]byte, error) {
	...
	if eti.InlineEventTypes != nil {
		objectMap["inlineEventTypes"] = eti.InlineEventTypes
	}
	return json.Marshal(objectMap)
}
...
type ExtensionTopic struct {
	...
	*ExtensionTopicProperties `json:"properties,omitempty"`
	// SystemData - READ-ONLY; The system metadata relating to Extension Topic resource.
	SystemData *SystemData `json:"systemData,omitempty"`
	// ID - READ-ONLY; Fully qualified identifier of the resource.
	ID *string `json:"id,omitempty"`
	// Name - READ-ONLY; Name of the resource.
...
func (hcesd HybridConnectionEventSubscriptionDestination) MarshalJSON() ([]byte, error) {
	hcesd.EndpointType = EndpointTypeBasicEventSubscriptionDestinationEndpointTypeHybridConnection
	objectMap := make(map[string]interface{})
...
type Partner struct {
	...
	PartnerRegistrationImmutableID *uuid.UUID `json:"partnerRegistrationImmutableId,omitempty"`
	...
	AuthorizationExpirationTimeInUtc *date.Time `json:"authorizationExpirationTimeInUtc,omitempty"`
}
...
type BasicPartnerClientAuthentication interface {
	AsAzureADPartnerClientAuthentication() (*AzureADPartnerClientAuthentication, bool)
	AsPartnerClientAuthentication() (*PartnerClientAuthentication, bool)
}
...
func unmarshalBasicPartnerClientAuthentication(body []byte) (BasicPartnerClientAuthentication, error) {
	var m map[string]interface{}
	err := json.Unmarshal(body, &m)
	if err != nil {
		return nil, err
	...
	case string(ClientAuthenticationTypeAzureAD):
		var aapca AzureADPartnerClientAuthentication
		err := json.Unmarshal(body, &aapca)
		return aapca, err
	default:
		var pca PartnerClientAuthentication
		err := json.Unmarshal(body, &pca)
		return pca, err
	}
}
func unmarshalBasicPartnerClientAuthenticationArray(body []byte) ([]BasicPartnerClientAuthentication, error) {
	var rawMessages []*json.RawMessage
	err := json.Unmarshal(body, &rawMessages)
	if err != nil {
		return nil, err
	...
	pcaArray := make([]BasicPartnerClientAuthentication, len(rawMessages))

	for index, rawMessage := range rawMessages {
		pca, err := unmarshalBasicPartnerClientAuthentication(*rawMessage)
		if err != nil {
			return nil, err
		}
		pcaArray[index] = pca
...
func (pca PartnerClientAuthentication) MarshalJSON() ([]byte, error) {
	pca.ClientAuthenticationType = ClientAuthenticationTypePartnerClientAuthentication
	objectMap := make(map[string]interface{})
	if pca.ClientAuthenticationType != "" {
		objectMap["clientAuthenticationType"] = pca.ClientAuthenticationType
	}
	return json.Marshal(objectMap)
}
...
type PartnerConfiguration struct {
	...
	*PartnerConfigurationProperties `json:"properties,omitempty"`
	// SystemData - READ-ONLY; The system metadata relating to partner configuration resource.
	SystemData *SystemData `json:"systemData,omitempty"`
	// Location - Location of the resource.
	Location *string `json:"location,omitempty"`
	// Tags - Tags of the resource.
...
func (pc PartnerConfiguration) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if pc.PartnerConfigurationProperties != nil {
		objectMap["properties"] = pc.PartnerConfigurationProperties
	}
	if pc.Location != nil {
...
func (pc *PartnerConfiguration) UnmarshalJSON(body []byte) error {
	...
	for k, v := range m {
		...
		case "properties":
			if v != nil {
				var partnerConfigurationProperties PartnerConfigurationProperties
				err = json.Unmarshal(*v, &partnerConfigurationProperties)
				if err != nil {
					return err
				}
				pc.PartnerConfigurationProperties = &partnerConfigurationProperties
			}
		case "systemData":
			if v != nil {
				var systemData SystemData
...
// result is the default implementation for PartnerConfigurationsCreateOrUpdateFuture.Result.
func (future *PartnerConfigurationsCreateOrUpdateFuture) result(client PartnerConfigurationsClient) (pc PartnerConfiguration, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "eventgrid.PartnerConfigurationsCreateOrUpdateFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		pc.Response.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("eventgrid.PartnerConfigurationsCreateOrUpdateFuture")
		return
	}
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if pc.Response.Response, err = future.GetResult(sender); err == nil && pc.Response.Response.StatusCode != http.StatusNoContent {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "eventgrid.PartnerConfigurationsCreateOrUpdateFuture", "Result", pc.Response.Response, "Failure responding to request")
		}
	}
	return
}

// PartnerConfigurationsDeleteFuture an abstraction for monitoring and retrieving the results of a
// long-running operation.
type PartnerConfigurationsDeleteFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(PartnerConfigurationsClient) (autorest.Response, error)
}
...
// result is the default implementation for PartnerConfigurationsDeleteFuture.Result.
func (future *PartnerConfigurationsDeleteFuture) result(client PartnerConfigurationsClient) (ar autorest.Response, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "eventgrid.PartnerConfigurationsDeleteFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		ar.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("eventgrid.PartnerConfigurationsDeleteFuture")
		return
	}
	ar.Response = future.Response()
	return
...
type PartnerConfigurationsListResult struct {
	autorest.Response `json:"-"`
	// Value - A collection of partner configurations.
	Value *[]PartnerConfiguration `json:"value,omitempty"`
	// NextLink - A link for the next page of partner configurations.
	NextLink *string `json:"nextLink,omitempty"`
}

// PartnerConfigurationsListResultIterator provides access to a complete listing of PartnerConfiguration
// values.
type PartnerConfigurationsListResultIterator struct {
	i    int
	page PartnerConfigurationsListResultPage
}
...
func (iter *PartnerConfigurationsListResultIterator) NextWithContext(ctx context.Context) (err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/PartnerConfigurationsListResultIterator.NextWithContext")
		defer func() {
			sc := -1
			if iter.Response().Response.Response != nil {
				sc = iter.Response().Response.Response.StatusCode
...
func NewPartnerConfigurationsListResultIterator(page PartnerConfigurationsListResultPage) PartnerConfigurationsListResultIterator {
	return PartnerConfigurationsListResultIterator{page: page}
}

// IsEmpty returns true if the ListResult contains no values.
func (pclr PartnerConfigurationsListResult) IsEmpty() bool {
	return pclr.Value == nil || len(*pclr.Value) == 0
}

// hasNextLink returns true if the NextLink is not empty.
func (pclr PartnerConfigurationsListResult) hasNextLink() bool {
	return pclr.NextLink != nil && len(*pclr.NextLink) != 0
}

// partnerConfigurationsListResultPreparer prepares a request to retrieve the next set of results.
// It returns nil if no more results exist.
func (pclr PartnerConfigurationsListResult) partnerConfigurationsListResultPreparer(ctx context.Context) (*http.Request, error) {
	if !pclr.hasNextLink() {
		return nil, nil
	}
	return autorest.Prepare((&http.Request{}).WithContext(ctx),
		autorest.AsJSON(),
		autorest.AsGet(),
		autorest.WithBaseURL(to.String(pclr.NextLink)))
}
...
type PartnerConfigurationsListResultPage struct {
	fn   func(context.Context, PartnerConfigurationsListResult) (PartnerConfigurationsListResult, error)
	pclr PartnerConfigurationsListResult
}
...
func (page *PartnerConfigurationsListResultPage) NextWithContext(ctx context.Context) (err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/PartnerConfigurationsListResultPage.NextWithContext")
		defer func() {
			sc := -1
			if page.Response().Response.Response != nil {
				sc = page.Response().Response.Response.StatusCode
	...
	for {
		next, err := page.fn(ctx, page.pclr)
		if err != nil {
			return err
		}
		page.pclr = next
...
func (page PartnerConfigurationsListResultPage) Values() []PartnerConfiguration {
	if page.pclr.IsEmpty() {
		return nil
	}
	return *page.pclr.Value
}
...
func NewPartnerConfigurationsListResultPage(cur PartnerConfigurationsListResult, getNextPage func(context.Context, PartnerConfigurationsListResult) (PartnerConfigurationsListResult, error)) PartnerConfigurationsListResultPage {
	return PartnerConfigurationsListResultPage{
		fn:   getNextPage,
		pclr: cur,
	}
}

// PartnerConfigurationsUpdateFuture an abstraction for monitoring and retrieving the results of a
// long-running operation.
type PartnerConfigurationsUpdateFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(PartnerConfigurationsClient) (PartnerConfiguration, error)
...
// result is the default implementation for PartnerConfigurationsUpdateFuture.Result.
func (future *PartnerConfigurationsUpdateFuture) result(client PartnerConfigurationsClient) (pc PartnerConfiguration, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "eventgrid.PartnerConfigurationsUpdateFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		pc.Response.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("eventgrid.PartnerConfigurationsUpdateFuture")
		return
	}
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if pc.Response.Response, err = future.GetResult(sender); err == nil && pc.Response.Response.StatusCode != http.StatusNoContent {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "eventgrid.PartnerConfigurationsUpdateFuture", "Result", pc.Response.Response, "Failure responding to request")
		}
	}
	return
}

// PartnerConfigurationUpdateParameterProperties information of partner configuration update parameter
// properties.
type PartnerConfigurationUpdateParameterProperties struct {
	// DefaultMaximumExpirationTimeInDays - The default time used to validate the maximum expiration time for each authorized partners in days. Allowed values ar between 1 and 365 days.
	DefaultMaximumExpirationTimeInDays *int32 `json:"defaultMaximumExpirationTimeInDays,omitempty"`
}
...
type PartnerConfigurationUpdateParameters struct {
	// Tags - Tags of the partner configuration resource.
	Tags map[string]*string `json:"tags"`
	// PartnerConfigurationUpdateParameterProperties - Properties of the Topic resource.
	*PartnerConfigurationUpdateParameterProperties `json:"properties,omitempty"`
}
...
func (pcup PartnerConfigurationUpdateParameters) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if pcup.Tags != nil {
		objectMap["tags"] = pcup.Tags
	}
	if pcup.PartnerConfigurationUpdateParameterProperties != nil {
		objectMap["properties"] = pcup.PartnerConfigurationUpdateParameterProperties
	}
	return json.Marshal(objectMap)
}
...
func (pcup *PartnerConfigurationUpdateParameters) UnmarshalJSON(body []byte) error {
	...
	for k, v := range m {
		...
		case "properties":
			if v != nil {
				var partnerConfigurationUpdateParameterProperties PartnerConfigurationUpdateParameterProperties
				err = json.Unmarshal(*v, &partnerConfigurationUpdateParameterProperties)
				if err != nil {
					return err
				}
				pcup.PartnerConfigurationUpdateParameterProperties = &partnerConfigurationUpdateParameterProperties
			}
		}
	}
...
type PartnerDestination struct {
	...
	*PartnerDestinationProperties `json:"properties,omitempty"`
	// SystemData - READ-ONLY; The system metadata relating to Partner Destination resource.
	SystemData *SystemData `json:"systemData,omitempty"`
	// Location - Location of the resource.
	Location *string `json:"location,omitempty"`
	// Tags - Tags of the resource.
...
func (pd PartnerDestination) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if pd.PartnerDestinationProperties != nil {
		objectMap["properties"] = pd.PartnerDestinationProperties
	}
	if pd.Location != nil {
		objectMap["location"] = pd.Location
	}
	if pd.Tags != nil {
...
func (pd *PartnerDestination) UnmarshalJSON(body []byte) error {
	...
	for k, v := range m {
		...
		case "properties":
			if v != nil {
				var partnerDestinationProperties PartnerDestinationProperties
				err = json.Unmarshal(*v, &partnerDestinationProperties)
				if err != nil {
					return err
				}
				pd.PartnerDestinationProperties = &partnerDestinationProperties
			}
		case "systemData":
			if v != nil {
				var systemData SystemData
...
type BasicPartnerDestinationInfo interface {
	AsWebhookPartnerDestinationInfo() (*WebhookPartnerDestinationInfo, bool)
	AsPartnerDestinationInfo() (*PartnerDestinationInfo, bool)
}
...
type PartnerDestinationInfo struct {
	// AzureSubscriptionID - Azure subscription ID of the subscriber. The partner destination associated with the channel will be
	// created under this Azure subscription.
	AzureSubscriptionID *string `json:"azureSubscriptionId,omitempty"`
	// ResourceGroupName - Azure Resource Group of the subscriber. The partner destination associated with the channel will be
	// created under this resource group.
	ResourceGroupName *string `json:"resourceGroupName,omitempty"`
	// Name - Name of the partner destination associated with the channel.
	Name *string `json:"name,omitempty"`
	// EndpointServiceContext - Additional context of the partner destination endpoint.
	EndpointServiceContext *string `json:"endpointServiceContext,omitempty"`
	// ResourceMoveChangeHistory - Change history of the resource move.
	ResourceMoveChangeHistory *[]ResourceMoveChangeHistory `json:"resourceMoveChangeHistory,omitempty"`
	// EndpointType - Possible values include: 'EndpointTypePartnerDestinationInfo', 'EndpointTypeWebHook'
	EndpointType EndpointType `json:"endpointType,omitempty"`
}

func unmarshalBasicPartnerDestinationInfo(body []byte) (BasicPartnerDestinationInfo, error) {
	var m map[string]interface{}
	err := json.Unmarshal(body, &m)
	if err != nil {
		return nil, err
	...
	case string(EndpointTypeWebHook):
		var wpdi WebhookPartnerDestinationInfo
		err := json.Unmarshal(body, &wpdi)
		return wpdi, err
	default:
		var pdi PartnerDestinationInfo
		err := json.Unmarshal(body, &pdi)
		return pdi, err
	}
}
func unmarshalBasicPartnerDestinationInfoArray(body []byte) ([]BasicPartnerDestinationInfo, error) {
	var rawMessages []*json.RawMessage
	err := json.Unmarshal(body, &rawMessages)
	if err != nil {
		return nil, err
	...
	pdiArray := make([]BasicPartnerDestinationInfo, len(rawMessages))

	for index, rawMessage := range rawMessages {
		pdi, err := unmarshalBasicPartnerDestinationInfo(*rawMessage)
		if err != nil {
			return nil, err
		}
		pdiArray[index] = pdi
...
func (pdi PartnerDestinationInfo) MarshalJSON() ([]byte, error) {
	pdi.EndpointType = EndpointTypePartnerDestinationInfo
	objectMap := make(map[string]interface{})
	if pdi.AzureSubscriptionID != nil {
		objectMap["azureSubscriptionId"] = pdi.AzureSubscriptionID
	}
	if pdi.ResourceGroupName != nil {
		objectMap["resourceGroupName"] = pdi.ResourceGroupName
	}
	if pdi.Name != nil {
		objectMap["name"] = pdi.Name
	}
	if pdi.EndpointServiceContext != nil {
		objectMap["endpointServiceContext"] = pdi.EndpointServiceContext
	}
	if pdi.ResourceMoveChangeHistory != nil {
		objectMap["resourceMoveChangeHistory"] = pdi.ResourceMoveChangeHistory
	}
	if pdi.EndpointType != "" {
		objectMap["endpointType"] = pdi.EndpointType
	}
	return json.Marshal(objectMap)
}
...
type PartnerDestinationProperties struct {
	...
	ExpirationTimeIfNotActivatedUtc *date.Time `json:"expirationTimeIfNotActivatedUtc,omitempty"`
	// ProvisioningState - Provisioning state of the partner destination. Possible values include: 'PartnerDestinationProvisioningStateCreating', 'PartnerDestinationProvisioningStateUpdating', 'PartnerDestinationProvisioningStateDeleting', 'PartnerDestinationProvisioningStateSucceeded', 'PartnerDestinationProvisioningStateCanceled', 'PartnerDestinationProvisioningStateFailed'
	ProvisioningState PartnerDestinationProvisioningState `json:"provisioningState,omitempty"`
	// ActivationState - Activation state of the partner destination. Possible values include: 'PartnerDestinationActivationStateNeverActivated', 'PartnerDestinationActivationStateActivated'
...
// PartnerDestinationsDeleteFuture an abstraction for monitoring and retrieving the results of a
// long-running operation.
type PartnerDestinationsDeleteFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(PartnerDestinationsClient) (autorest.Response, error)
}
...
// result is the default implementation for PartnerDestinationsDeleteFuture.Result.
func (future *PartnerDestinationsDeleteFuture) result(client PartnerDestinationsClient) (ar autorest.Response, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "eventgrid.PartnerDestinationsDeleteFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		ar.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("eventgrid.PartnerDestinationsDeleteFuture")
		return
	}
	ar.Response = future.Response()
	return
...
type PartnerDestinationsListResult struct {
	...
	// NextLink - A link for the next page of partner destinations.
	NextLink *string `json:"nextLink,omitempty"`
}

// PartnerDestinationsListResultIterator provides access to a complete listing of PartnerDestination
// values.
type PartnerDestinationsListResultIterator struct {
	i    int
	page PartnerDestinationsListResultPage
}
...
func (iter *PartnerDestinationsListResultIterator) NextWithContext(ctx context.Context) (err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/PartnerDestinationsListResultIterator.NextWithContext")
		defer func() {
			sc := -1
			if iter.Response().Response.Response != nil {
				sc = iter.Response().Response.Response.StatusCode
...
func NewPartnerDestinationsListResultIterator(page PartnerDestinationsListResultPage) PartnerDestinationsListResultIterator {
	return PartnerDestinationsListResultIterator{page: page}
}

// IsEmpty returns true if the ListResult contains no values.
func (pdlr PartnerDestinationsListResult) IsEmpty() bool {
	return pdlr.Value == nil || len(*pdlr.Value) == 0
}

// hasNextLink returns true if the NextLink is not empty.
func (pdlr PartnerDestinationsListResult) hasNextLink() bool {
	return pdlr.NextLink != nil && len(*pdlr.NextLink) != 0
}

// partnerDestinationsListResultPreparer prepares a request to retrieve the next set of results.
// It returns nil if no more results exist.
func (pdlr PartnerDestinationsListResult) partnerDestinationsListResultPreparer(ctx context.Context) (*http.Request, error) {
	if !pdlr.hasNextLink() {
		return nil, nil
	}
	return autorest.Prepare((&http.Request{}).WithContext(ctx),
		autorest.AsJSON(),
		autorest.AsGet(),
		autorest.WithBaseURL(to.String(pdlr.NextLink)))
}
...
type PartnerDestinationsListResultPage struct {
	fn   func(context.Context, PartnerDestinationsListResult) (PartnerDestinationsListResult, error)
	pdlr PartnerDestinationsListResult
}
...
func (page *PartnerDestinationsListResultPage) NextWithContext(ctx context.Context) (err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/PartnerDestinationsListResultPage.NextWithContext")
		defer func() {
			sc := -1
			if page.Response().Response.Response != nil {
				sc = page.Response().Response.Response.StatusCode
	...
	for {
		next, err := page.fn(ctx, page.pdlr)
		if err != nil {
			return err
		}
		page.pdlr = next
...
func (page PartnerDestinationsListResultPage) Values() []PartnerDestination {
	if page.pdlr.IsEmpty() {
		return nil
	}
	return *page.pdlr.Value
}
...
func NewPartnerDestinationsListResultPage(cur PartnerDestinationsListResult, getNextPage func(context.Context, PartnerDestinationsListResult) (PartnerDestinationsListResult, error)) PartnerDestinationsListResultPage {
	return PartnerDestinationsListResultPage{
		fn:   getNextPage,
		pdlr: cur,
	}
}
...
type PartnerDestinationUpdateParameters struct {
	// Tags - Tags of the Partner Destination resource.
	Tags map[string]*string `json:"tags"`
}
...
type PartnerDetails struct {
	...
	Description *string `json:"description,omitempty"`
	// LongDescription - Long description for the partner's scenarios and integration.Length of this description should not exceed 2048 characters.
...
type PartnerEventSubscriptionDestination struct {
	// PartnerEventSubscriptionDestinationProperties - Partner Destination Properties of the event subscription destination.
	*PartnerEventSubscriptionDestinationProperties `json:"properties,omitempty"`
	// EndpointType - Possible values include: 'EndpointTypeBasicEventSubscriptionDestinationEndpointTypeEventSubscriptionDestination', 'EndpointTypeBasicEventSubscriptionDestinationEndpointTypeWebHook', 'EndpointTypeBasicEventSubscriptionDestinationEndpointTypeEventHub', 'EndpointTypeBasicEventSubscriptionDestinationEndpointTypeStorageQueue', 'EndpointTypeBasicEventSubscriptionDestinationEndpointTypeHybridConnection', 'EndpointTypeBasicEventSubscriptionDestinationEndpointTypeServiceBusQueue', 'EndpointTypeBasicEventSubscriptionDestinationEndpointTypeServiceBusTopic', 'EndpointTypeBasicEventSubscriptionDestinationEndpointTypeAzureFunction', 'EndpointTypeBasicEventSubscriptionDestinationEndpointTypePartnerDestination'
	EndpointType EndpointTypeBasicEventSubscriptionDestination `json:"endpointType,omitempty"`
}
...
func (pesd PartnerEventSubscriptionDestination) MarshalJSON() ([]byte, error) {
	pesd.EndpointType = EndpointTypeBasicEventSubscriptionDestinationEndpointTypePartnerDestination
	objectMap := make(map[string]interface{})
	if pesd.PartnerEventSubscriptionDestinationProperties != nil {
		objectMap["properties"] = pesd.PartnerEventSubscriptionDestinationProperties
	}
	if pesd.EndpointType != "" {
		objectMap["endpointType"] = pesd.EndpointType
	}
	return json.Marshal(objectMap)
}
...
func (pesd *PartnerEventSubscriptionDestination) UnmarshalJSON(body []byte) error {
	...
	for k, v := range m {
		...
		case "properties":
			if v != nil {
				var partnerEventSubscriptionDestinationProperties PartnerEventSubscriptionDestinationProperties
				err = json.Unmarshal(*v, &partnerEventSubscriptionDestinationProperties)
				if err != nil {
					return err
				}
				pesd.PartnerEventSubscriptionDestinationProperties = &partnerEventSubscriptionDestinationProperties
			}
		case "endpointType":
			if v != nil {
				var endpointType EndpointTypeBasicEventSubscriptionDestination
				...
				pesd.EndpointType = endpointType
			}
		}
	}
...
type PartnerEventSubscriptionDestinationProperties struct {
	// ResourceID - The Azure Resource Id that represents the endpoint of a Partner Destination of an event subscription.
	ResourceID *string `json:"resourceId,omitempty"`
}
...
type PartnerNamespaceProperties struct {
	...
	Endpoint *string `json:"endpoint,omitempty"`
	// PublicNetworkAccess - This determines if traffic is allowed over public network. By default it is enabled.
	// You can further restrict to specific IPs by configuring <seealso cref="P:Microsoft.Azure.Events.ResourceProvider.Common.Contracts.PartnerNamespaceProperties.InboundIpRules" />. Possible values include: 'PublicNetworkAccessEnabled', 'PublicNetworkAccessDisabled'
	PublicNetworkAccess PublicNetworkAccess `json:"publicNetworkAccess,omitempty"`
	// InboundIPRules - This can be used to restrict traffic from specific IPs instead of all IPs. Note: These are considered only if PublicNetworkAccess is enabled.
	InboundIPRules *[]InboundIPRule `json:"inboundIpRules,omitempty"`
	...
	// or use the channel name in the header when matching to the partner topic. If none is specified, source attribute routing will be used to match the partner topic. Possible values include: 'PartnerTopicRoutingModeSourceEventAttribute', 'PartnerTopicRoutingModeChannelNameHeader'
...
func (pnp PartnerNamespaceProperties) MarshalJSON() ([]byte, error) {
	...
	if pnp.PublicNetworkAccess != "" {
		objectMap["publicNetworkAccess"] = pnp.PublicNetworkAccess
	}
	if pnp.InboundIPRules != nil {
		objectMap["inboundIpRules"] = pnp.InboundIPRules
	}
	if pnp.DisableLocalAuth != nil {
		objectMap["disableLocalAuth"] = pnp.DisableLocalAuth
	}
	if pnp.PartnerTopicRoutingMode != "" {
		objectMap["partnerTopicRoutingMode"] = pnp.PartnerTopicRoutingMode
	}
	return json.Marshal(objectMap)
}
...
type PartnerNamespaceUpdateParameterProperties struct {
	// PublicNetworkAccess - This determines if traffic is allowed over public network. By default it is enabled.
	// You can further restrict to specific IPs by configuring <seealso cref="P:Microsoft.Azure.Events.ResourceProvider.Common.Contracts.PartnerNamespaceUpdateParameterProperties.InboundIpRules" />. Possible values include: 'PublicNetworkAccessEnabled', 'PublicNetworkAccessDisabled'
	PublicNetworkAccess PublicNetworkAccess `json:"publicNetworkAccess,omitempty"`
	// InboundIPRules - This can be used to restrict traffic from specific IPs instead of all IPs. Note: These are considered only if PublicNetworkAccess is enabled.
	InboundIPRules *[]InboundIPRule `json:"inboundIpRules,omitempty"`
	// DisableLocalAuth - This boolean is used to enable or disable local auth. Default value is false. When the property is set to true, only AAD token will be used to authenticate if user is allowed to publish to the partner namespace.
...
type PartnerNamespaceUpdateParameters struct {
	...
	Tags map[string]*string `json:"tags"`
	// PartnerNamespaceUpdateParameterProperties - Properties of the Partner Namespace.
	*PartnerNamespaceUpdateParameterProperties `json:"properties,omitempty"`
}
...
func (pnup PartnerNamespaceUpdateParameters) MarshalJSON() ([]byte, error) {
	...
	if pnup.PartnerNamespaceUpdateParameterProperties != nil {
		objectMap["properties"] = pnup.PartnerNamespaceUpdateParameterProperties
	}
	return json.Marshal(objectMap)
}
...
func (pnup *PartnerNamespaceUpdateParameters) UnmarshalJSON(body []byte) error {
	...
	for k, v := range m {
		...
		case "properties":
			if v != nil {
				var partnerNamespaceUpdateParameterProperties PartnerNamespaceUpdateParameterProperties
				err = json.Unmarshal(*v, &partnerNamespaceUpdateParameterProperties)
				if err != nil {
					return err
				}
				pnup.PartnerNamespaceUpdateParameterProperties = &partnerNamespaceUpdateParameterProperties
			}
		}
	}
...
type PartnerRegistrationProperties struct {
	...
	// VisibilityState - Visibility state of the partner registration. Possible values include: 'PartnerRegistrationVisibilityStateHidden', 'PartnerRegistrationVisibilityStatePublicPreview', 'PartnerRegistrationVisibilityStateGenerallyAvailable'
...
func (prp PartnerRegistrationProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if prp.PartnerRegistrationImmutableID != nil {
		objectMap["partnerRegistrationImmutableId"] = prp.PartnerRegistrationImmutableID
	}
...
// PartnerRegistrationsCreateOrUpdateFuture an abstraction for monitoring and retrieving the results of a
// long-running operation.
type PartnerRegistrationsCreateOrUpdateFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(PartnerRegistrationsClient) (PartnerRegistration, error)
}
...
// result is the default implementation for PartnerRegistrationsCreateOrUpdateFuture.Result.
func (future *PartnerRegistrationsCreateOrUpdateFuture) result(client PartnerRegistrationsClient) (pr PartnerRegistration, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "eventgrid.PartnerRegistrationsCreateOrUpdateFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		pr.Response.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("eventgrid.PartnerRegistrationsCreateOrUpdateFuture")
		return
	}
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if pr.Response.Response, err = future.GetResult(sender); err == nil && pr.Response.Response.StatusCode != http.StatusNoContent {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "eventgrid.PartnerRegistrationsCreateOrUpdateFuture", "Result", pr.Response.Response, "Failure responding to request")
		}
	}
	return
}

// PartnerRegistrationsDeleteFuture an abstraction for monitoring and retrieving the results of a
// long-running operation.
type PartnerRegistrationsDeleteFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(PartnerRegistrationsClient) (autorest.Response, error)
}
...
// result is the default implementation for PartnerRegistrationsDeleteFuture.Result.
func (future *PartnerRegistrationsDeleteFuture) result(client PartnerRegistrationsClient) (ar autorest.Response, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "eventgrid.PartnerRegistrationsDeleteFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		ar.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("eventgrid.PartnerRegistrationsDeleteFuture")
		return
	}
	ar.Response = future.Response()
	return
...
// PartnerRegistrationsUpdateFuture an abstraction for monitoring and retrieving the results of a
// long-running operation.
type PartnerRegistrationsUpdateFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(PartnerRegistrationsClient) (PartnerRegistration, error)
...
// result is the default implementation for PartnerRegistrationsUpdateFuture.Result.
func (future *PartnerRegistrationsUpdateFuture) result(client PartnerRegistrationsClient) (pr PartnerRegistration, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "eventgrid.PartnerRegistrationsUpdateFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		pr.Response.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("eventgrid.PartnerRegistrationsUpdateFuture")
		return
	}
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if pr.Response.Response, err = future.GetResult(sender); err == nil && pr.Response.Response.StatusCode != http.StatusNoContent {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "eventgrid.PartnerRegistrationsUpdateFuture", "Result", pr.Response.Response, "Failure responding to request")
		}
	}
	return
}
...
type PartnerTopicProperties struct {
	...
	// ActivationState - Activation state of the partner topic. Possible values include: 'PartnerTopicActivationStateNeverActivated', 'PartnerTopicActivationStateActivated', 'PartnerTopicActivationStateDeactivated'
...
func (ptp PartnerTopicProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if ptp.PartnerRegistrationImmutableID != nil {
		objectMap["partnerRegistrationImmutableId"] = ptp.PartnerRegistrationImmutableID
	}
	if ptp.Source != nil {
		objectMap["source"] = ptp.Source
	}
	if ptp.EventTypeInfo != nil {
		objectMap["eventTypeInfo"] = ptp.EventTypeInfo
	}
	...
	if ptp.MessageForActivation != nil {
		objectMap["messageForActivation"] = ptp.MessageForActivation
	}
	return json.Marshal(objectMap)
}
...
type PartnerTopicUpdateParameters struct {
	// Tags - Tags of the Partner Topic resource.
	Tags map[string]*string `json:"tags"`
	// Identity - Identity information for the Partner Topic resource.
	Identity *IdentityInfo `json:"identity,omitempty"`
}
...
func (ptup PartnerTopicUpdateParameters) MarshalJSON() ([]byte, error) {
	...
	if ptup.Identity != nil {
		objectMap["identity"] = ptup.Identity
	}
	return json.Marshal(objectMap)
}

// BasicPartnerUpdateDestinationInfo properties of the corresponding partner destination of a Channel.
type BasicPartnerUpdateDestinationInfo interface {
	AsWebhookUpdatePartnerDestinationInfo() (*WebhookUpdatePartnerDestinationInfo, bool)
	AsPartnerUpdateDestinationInfo() (*PartnerUpdateDestinationInfo, bool)
}
...
type PartnerUpdateDestinationInfo struct {
	// EndpointType - Possible values include: 'EndpointTypeBasicPartnerUpdateDestinationInfoEndpointTypePartnerUpdateDestinationInfo', 'EndpointTypeBasicPartnerUpdateDestinationInfoEndpointTypeWebHook'
	EndpointType EndpointTypeBasicPartnerUpdateDestinationInfo `json:"endpointType,omitempty"`
}

func unmarshalBasicPartnerUpdateDestinationInfo(body []byte) (BasicPartnerUpdateDestinationInfo, error) {
	var m map[string]interface{}
	err := json.Unmarshal(body, &m)
	if err != nil {
		return nil, err
	...
	switch m["endpointType"] {
	case string(EndpointTypeBasicPartnerUpdateDestinationInfoEndpointTypeWebHook):
		var wupdi WebhookUpdatePartnerDestinationInfo
		err := json.Unmarshal(body, &wupdi)
		return wupdi, err
	default:
		var pudi PartnerUpdateDestinationInfo
		err := json.Unmarshal(body, &pudi)
		return pudi, err
	}
}
func unmarshalBasicPartnerUpdateDestinationInfoArray(body []byte) ([]BasicPartnerUpdateDestinationInfo, error) {
	var rawMessages []*json.RawMessage
	err := json.Unmarshal(body, &rawMessages)
	if err != nil {
		return nil, err
	...
	pudiArray := make([]BasicPartnerUpdateDestinationInfo, len(rawMessages))

	for index, rawMessage := range rawMessages {
		pudi, err := unmarshalBasicPartnerUpdateDestinationInfo(*rawMessage)
		if err != nil {
			return nil, err
		}
		pudiArray[index] = pudi
	}
	return pudiArray, nil
}
...
func (pudi PartnerUpdateDestinationInfo) MarshalJSON() ([]byte, error) {
	pudi.EndpointType = EndpointTypeBasicPartnerUpdateDestinationInfoEndpointTypePartnerUpdateDestinationInfo
	objectMap := make(map[string]interface{})
	if pudi.EndpointType != "" {
		objectMap["endpointType"] = pudi.EndpointType
	}
	return json.Marshal(objectMap)
}
...
type PartnerUpdateTopicInfo struct {
	// EventTypeInfo - Event type info for the partner topic
	EventTypeInfo *EventTypeInfo `json:"eventTypeInfo,omitempty"`
}
...
type ResourceMoveChangeHistory struct {
	// AzureSubscriptionID - Azure subscription ID of the resource.
	AzureSubscriptionID *string `json:"azureSubscriptionId,omitempty"`
	// ResourceGroupName - Azure Resource Group of the resource.
	ResourceGroupName *string `json:"resourceGroupName,omitempty"`
	// ChangedTimeUtc - UTC timestamp of when the resource was changed.
	ChangedTimeUtc *date.Time `json:"changedTimeUtc,omitempty"`
}

// ResourceSku describes an EventGrid Resource Sku.
type ResourceSku struct {
	// Name - The Sku name of the resource. The possible values are: Basic or Premium. Possible values include: 'SkuBasic', 'SkuPremium'
...
func (sbqesd ServiceBusQueueEventSubscriptionDestination) MarshalJSON() ([]byte, error) {
	sbqesd.EndpointType = EndpointTypeBasicEventSubscriptionDestinationEndpointTypeServiceBusQueue
	objectMap := make(map[string]interface{})
...
func (sbtesd ServiceBusTopicEventSubscriptionDestination) MarshalJSON() ([]byte, error) {
	sbtesd.EndpointType = EndpointTypeBasicEventSubscriptionDestinationEndpointTypeServiceBusTopic
	objectMap := make(map[string]interface{})
...
func (sqesd StorageQueueEventSubscriptionDestination) MarshalJSON() ([]byte, error) {
	sqesd.EndpointType = EndpointTypeBasicEventSubscriptionDestinationEndpointTypeStorageQueue
	objectMap := make(map[string]interface{})
...
type Topic struct {
	...
	*TopicProperties `json:"properties,omitempty"`
	...
	// Identity - Identity information for the resource.
	Identity *IdentityInfo `json:"identity,omitempty"`
	// Kind - Kind of the resource. Possible values include: 'ResourceKindAzure', 'ResourceKindAzureArc'
...
// TopicEventSubscriptionsCreateOrUpdateFuture an abstraction for monitoring and retrieving the results of
// a long-running operation.
type TopicEventSubscriptionsCreateOrUpdateFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(TopicEventSubscriptionsClient) (EventSubscription, error)
}
...
// result is the default implementation for TopicEventSubscriptionsCreateOrUpdateFuture.Result.
func (future *TopicEventSubscriptionsCreateOrUpdateFuture) result(client TopicEventSubscriptionsClient) (es EventSubscription, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "eventgrid.TopicEventSubscriptionsCreateOrUpdateFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		es.Response.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("eventgrid.TopicEventSubscriptionsCreateOrUpdateFuture")
		return
	}
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if es.Response.Response, err = future.GetResult(sender); err == nil && es.Response.Response.StatusCode != http.StatusNoContent {
		es, err = client.CreateOrUpdateResponder(es.Response.Response)
		if err != nil {
			err = autorest.NewErrorWithError(err, "eventgrid.TopicEventSubscriptionsCreateOrUpdateFuture", "Result", es.Response.Response, "Failure responding to request")
		}
	}
	return
}

// TopicEventSubscriptionsDeleteFuture an abstraction for monitoring and retrieving the results of a
// long-running operation.
type TopicEventSubscriptionsDeleteFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(TopicEventSubscriptionsClient) (autorest.Response, error)
}
...
// result is the default implementation for TopicEventSubscriptionsDeleteFuture.Result.
func (future *TopicEventSubscriptionsDeleteFuture) result(client TopicEventSubscriptionsClient) (ar autorest.Response, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "eventgrid.TopicEventSubscriptionsDeleteFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		ar.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("eventgrid.TopicEventSubscriptionsDeleteFuture")
		return
	}
	ar.Response = future.Response()
	return
...
// TopicEventSubscriptionsUpdateFuture an abstraction for monitoring and retrieving the results of a
// long-running operation.
type TopicEventSubscriptionsUpdateFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(TopicEventSubscriptionsClient) (EventSubscription, error)
...
// result is the default implementation for TopicEventSubscriptionsUpdateFuture.Result.
func (future *TopicEventSubscriptionsUpdateFuture) result(client TopicEventSubscriptionsClient) (es EventSubscription, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "eventgrid.TopicEventSubscriptionsUpdateFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		es.Response.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("eventgrid.TopicEventSubscriptionsUpdateFuture")
		return
	}
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if es.Response.Response, err = future.GetResult(sender); err == nil && es.Response.Response.StatusCode != http.StatusNoContent {
		es, err = client.UpdateResponder(es.Response.Response)
		if err != nil {
			err = autorest.NewErrorWithError(err, "eventgrid.TopicEventSubscriptionsUpdateFuture", "Result", es.Response.Response, "Failure responding to request")
		}
	}
	return
}
...
func (tp TopicProperties) MarshalJSON() ([]byte, error) {
	...
	if tp.DataResidencyBoundary != "" {
		objectMap["dataResidencyBoundary"] = tp.DataResidencyBoundary
	}
	return json.Marshal(objectMap)
}
	...
	for k, v := range m {
		...
		case "dataResidencyBoundary":
			if v != nil {
				...
				tp.DataResidencyBoundary = dataResidencyBoundary
			}
		}
	}
...
type TopicUpdateParameterProperties struct {
	...
	// DisableLocalAuth - This boolean is used to enable or disable local auth. Default value is false. When the property is set to true, only AAD token will be used to authenticate if user is allowed to publish to the topic.
	DisableLocalAuth *bool `json:"disableLocalAuth,omitempty"`
	// DataResidencyBoundary - The data residency boundary for the topic. Possible values include: 'DataResidencyBoundaryWithinGeopair', 'DataResidencyBoundaryWithinRegion'
	DataResidencyBoundary DataResidencyBoundary `json:"dataResidencyBoundary,omitempty"`
}
...
type TopicUpdateParameters struct {
	...
	Identity *IdentityInfo `json:"identity,omitempty"`
	// TopicUpdateParameterProperties - Properties of the Topic resource.
...
type VerifiedPartner struct {
	...
	*VerifiedPartnerProperties `json:"properties,omitempty"`
	// SystemData - READ-ONLY; The system metadata relating to Verified Partner resource.
	SystemData *SystemData `json:"systemData,omitempty"`
	// ID - READ-ONLY; Fully qualified identifier of the resource.
	ID *string `json:"id,omitempty"`
	// Name - READ-ONLY; Name of the resource.
...
func (vp VerifiedPartner) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if vp.VerifiedPartnerProperties != nil {
		objectMap["properties"] = vp.VerifiedPartnerProperties
	}
	return json.Marshal(objectMap)
}
...
func (vp *VerifiedPartner) UnmarshalJSON(body []byte) error {
	...
	for k, v := range m {
		...
		case "properties":
			if v != nil {
				var verifiedPartnerProperties VerifiedPartnerProperties
				err = json.Unmarshal(*v, &verifiedPartnerProperties)
				if err != nil {
					return err
				}
				vp.VerifiedPartnerProperties = &verifiedPartnerProperties
			}
		case "systemData":
			if v != nil {
				var systemData SystemData
...
type VerifiedPartnerProperties struct {
	// PartnerRegistrationImmutableID - ImmutableId of the corresponding partner registration.
	PartnerRegistrationImmutableID *uuid.UUID `json:"partnerRegistrationImmutableId,omitempty"`
	// OrganizationName - Official name of the Partner.
	OrganizationName *string `json:"organizationName,omitempty"`
	// PartnerDisplayName - Display name of the verified partner.
	PartnerDisplayName *string `json:"partnerDisplayName,omitempty"`
	// PartnerTopicDetails - Details of the partner topic scenario.
	PartnerTopicDetails *PartnerDetails `json:"partnerTopicDetails,omitempty"`
	// PartnerDestinationDetails - Details of the partner destination scenario.
	PartnerDestinationDetails *PartnerDetails `json:"partnerDestinationDetails,omitempty"`
	// ProvisioningState - Provisioning state of the verified partner. Possible values include: 'VerifiedPartnerProvisioningStateCreating', 'VerifiedPartnerProvisioningStateUpdating', 'VerifiedPartnerProvisioningStateDeleting', 'VerifiedPartnerProvisioningStateSucceeded', 'VerifiedPartnerProvisioningStateCanceled', 'VerifiedPartnerProvisioningStateFailed'
...
type VerifiedPartnersListResult struct {
	autorest.Response `json:"-"`
	// Value - A collection of verified partners.
	Value *[]VerifiedPartner `json:"value,omitempty"`
	// NextLink - A link for the next page of verified partners if any.
	NextLink *string `json:"nextLink,omitempty"`
}
...
type VerifiedPartnersListResultIterator struct {
	i    int
	page VerifiedPartnersListResultPage
}
...
func (iter *VerifiedPartnersListResultIterator) NextWithContext(ctx context.Context) (err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/VerifiedPartnersListResultIterator.NextWithContext")
		defer func() {
			sc := -1
			if iter.Response().Response.Response != nil {
				sc = iter.Response().Response.Response.StatusCode
...
func NewVerifiedPartnersListResultIterator(page VerifiedPartnersListResultPage) VerifiedPartnersListResultIterator {
	return VerifiedPartnersListResultIterator{page: page}
}

// IsEmpty returns true if the ListResult contains no values.
func (vplr VerifiedPartnersListResult) IsEmpty() bool {
	return vplr.Value == nil || len(*vplr.Value) == 0
}

// hasNextLink returns true if the NextLink is not empty.
func (vplr VerifiedPartnersListResult) hasNextLink() bool {
	return vplr.NextLink != nil && len(*vplr.NextLink) != 0
}

// verifiedPartnersListResultPreparer prepares a request to retrieve the next set of results.
// It returns nil if no more results exist.
func (vplr VerifiedPartnersListResult) verifiedPartnersListResultPreparer(ctx context.Context) (*http.Request, error) {
	if !vplr.hasNextLink() {
		return nil, nil
	}
	return autorest.Prepare((&http.Request{}).WithContext(ctx),
		autorest.AsJSON(),
		autorest.AsGet(),
		autorest.WithBaseURL(to.String(vplr.NextLink)))
}

// VerifiedPartnersListResultPage contains a page of VerifiedPartner values.
type VerifiedPartnersListResultPage struct {
	fn   func(context.Context, VerifiedPartnersListResult) (VerifiedPartnersListResult, error)
	vplr VerifiedPartnersListResult
}
...
func (page *VerifiedPartnersListResultPage) NextWithContext(ctx context.Context) (err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/VerifiedPartnersListResultPage.NextWithContext")
		defer func() {
			sc := -1
			if page.Response().Response.Response != nil {
				sc = page.Response().Response.Response.StatusCode
	...
	for {
		next, err := page.fn(ctx, page.vplr)
		if err != nil {
			return err
		}
		page.vplr = next
...
func (page VerifiedPartnersListResultPage) Values() []VerifiedPartner {
	if page.vplr.IsEmpty() {
		return nil
	}
	return *page.vplr.Value
}
...
func NewVerifiedPartnersListResultPage(cur VerifiedPartnersListResult, getNextPage func(context.Context, VerifiedPartnersListResult) (VerifiedPartnersListResult, error)) VerifiedPartnersListResultPage {
	return VerifiedPartnersListResultPage{
		fn:   getNextPage,
		vplr: cur,
	}
}
...
func (whesd WebHookEventSubscriptionDestination) MarshalJSON() ([]byte, error) {
	whesd.EndpointType = EndpointTypeBasicEventSubscriptionDestinationEndpointTypeWebHook
	objectMap := make(map[string]interface{})
...
type WebhookPartnerDestinationInfo struct {
	// WebhookPartnerDestinationProperties - WebHook Properties of the partner destination.
	*WebhookPartnerDestinationProperties `json:"properties,omitempty"`
	// AzureSubscriptionID - Azure subscription ID of the subscriber. The partner destination associated with the channel will be
	// created under this Azure subscription.
	AzureSubscriptionID *string `json:"azureSubscriptionId,omitempty"`
	// ResourceGroupName - Azure Resource Group of the subscriber. The partner destination associated with the channel will be
...
func (wpdi WebhookPartnerDestinationInfo) MarshalJSON() ([]byte, error) {
	wpdi.EndpointType = EndpointTypeWebHook
	objectMap := make(map[string]interface{})
	if wpdi.WebhookPartnerDestinationProperties != nil {
		objectMap["properties"] = wpdi.WebhookPartnerDestinationProperties
	}
	if wpdi.AzureSubscriptionID != nil {
		objectMap["azureSubscriptionId"] = wpdi.AzureSubscriptionID
	}
	if wpdi.ResourceGroupName != nil {
		objectMap["resourceGroupName"] = wpdi.ResourceGroupName
	}
	if wpdi.Name != nil {
		objectMap["name"] = wpdi.Name
	}
	if wpdi.EndpointServiceContext != nil {
		objectMap["endpointServiceContext"] = wpdi.EndpointServiceContext
	}
	if wpdi.ResourceMoveChangeHistory != nil {
		objectMap["resourceMoveChangeHistory"] = wpdi.ResourceMoveChangeHistory
	}
	if wpdi.EndpointType != "" {
		objectMap["endpointType"] = wpdi.EndpointType
	}
	return json.Marshal(objectMap)
}
...
func (wpdi *WebhookPartnerDestinationInfo) UnmarshalJSON(body []byte) error {
	...
	for k, v := range m {
		...
		case "properties":
			if v != nil {
				var webhookPartnerDestinationProperties WebhookPartnerDestinationProperties
				err = json.Unmarshal(*v, &webhookPartnerDestinationProperties)
				if err != nil {
					return err
				}
				wpdi.WebhookPartnerDestinationProperties = &webhookPartnerDestinationProperties
			}
		case "azureSubscriptionId":
			if v != nil {
				var azureSubscriptionID string
				err = json.Unmarshal(*v, &azureSubscriptionID)
				if err != nil {
					return err
				}
				wpdi.AzureSubscriptionID = &azureSubscriptionID
			}
		case "resourceGroupName":
			if v != nil {
				...
				wpdi.ResourceGroupName = &resourceGroupName
			}
		case "name":
			if v != nil {
				var name string
		...
		case "endpointServiceContext":
			if v != nil {
				var endpointServiceContext string
				err = json.Unmarshal(*v, &endpointServiceContext)
				if err != nil {
					return err
				}
				wpdi.EndpointServiceContext = &endpointServiceContext
			}
		case "resourceMoveChangeHistory":
			if v != nil {
				var resourceMoveChangeHistory []ResourceMoveChangeHistory
				err = json.Unmarshal(*v, &resourceMoveChangeHistory)
				if err != nil {
					return err
				}
				wpdi.ResourceMoveChangeHistory = &resourceMoveChangeHistory
			}
		case "endpointType":
			if v != nil {
				...
				wpdi.EndpointType = endpointType
			}
		}
	}
...
type WebhookPartnerDestinationProperties struct {
	// EndpointURL - The URL that represents the endpoint of the partner destination.
	EndpointURL *string `json:"endpointUrl,omitempty"`
	// EndpointBaseURL - The base URL that represents the endpoint of the partner destination.
	EndpointBaseURL      *string                          `json:"endpointBaseUrl,omitempty"`
	...
	for k, v := range m {
		...
		case "endpointBaseUrl":
			if v != nil {
				...
				wpdp.EndpointBaseURL = &endpointBaseURL
			}
		case "clientAuthentication":
			if v != nil {
				clientAuthentication, err := unmarshalBasicPartnerClientAuthentication(*v)
				if err != nil {
					return err
				}
				wpdp.ClientAuthentication = clientAuthentication
			}
		}
	}
...
// WebhookUpdatePartnerDestinationInfo information about the update of the WebHook of the partner
// destination.
...
func (wupdi WebhookUpdatePartnerDestinationInfo) MarshalJSON() ([]byte, error) {
	wupdi.EndpointType = EndpointTypeBasicPartnerUpdateDestinationInfoEndpointTypeWebHook
	objectMap := make(map[string]interface{})
	if wupdi.WebhookPartnerDestinationProperties != nil {
		objectMap["properties"] = wupdi.WebhookPartnerDestinationProperties
	}
	if wupdi.EndpointType != "" {
		objectMap["endpointType"] = wupdi.EndpointType
	}
	return json.Marshal(objectMap)
}
	...
	for k, v := range m {
		...
		case "properties":
			if v != nil {
				...
				wupdi.WebhookPartnerDestinationProperties = &webhookPartnerDestinationProperties
			}
		case "endpointType":
			if v != nil {
				var endpointType EndpointTypeBasicPartnerUpdateDestinationInfo
				err = json.Unmarshal(*v, &endpointType)
				if err != nil {
					return err
				}
				wupdi.EndpointType = endpointType
			}
		}
	}
