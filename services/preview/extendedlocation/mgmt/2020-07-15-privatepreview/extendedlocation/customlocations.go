...
func (client CustomLocationsClient) CreateOrUpdatePreparer(ctx context.Context, resourceGroupName string, resourceName string, parameters CustomLocation) (*http.Request, error) {
	...
	const APIVersion = "2020-07-15-privatepreview"
...
func (client CustomLocationsClient) CreateOrUpdateSender(req *http.Request) (future CustomLocationsCreateOrUpdateFuture, err error) {
	...
	future.Result = func(client CustomLocationsClient) (cl CustomLocation, err error) {
		var done bool
		...
		cl.Response.Response, err = future.GetResult(sender)
		if cl.Response.Response == nil && err == nil {
			err = autorest.NewErrorWithError(err, "extendedlocation.CustomLocationsCreateOrUpdateFuture", "Result", nil, "received nil response and error")
		}
		if err == nil && cl.Response.Response.StatusCode != http.StatusNoContent {
...
func (client CustomLocationsClient) DeleteSender(req *http.Request) (future CustomLocationsDeleteFuture, err error) {
	...
	azf, err = azure.NewFutureFromResponse(resp)
	future.FutureAPI = &azf
	future.Result = func(client CustomLocationsClient) (ar autorest.Response, err error) {
		var done bool
		done, err = future.DoneWithContext(context.Background(), client)
		if err != nil {
...
// GetEnabledResourceType gets the details of the Enabled Resource Type.
// Parameters:
// resourceGroupName - the name of the resource group. The name is case insensitive.
// resourceName - custom Locations name.
// enabledResourceTypeName - custom Locations Enabled Resource Type name.
func (client CustomLocationsClient) GetEnabledResourceType(ctx context.Context, resourceGroupName string, resourceName string, enabledResourceTypeName string) (result EnabledResourceType, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/CustomLocationsClient.GetEnabledResourceType")
		defer func() {
			sc := -1
			if result.Response.Response != nil {
				sc = result.Response.Response.StatusCode
	...
	if err := validation.Validate([]validation.Validation{
		...
		{TargetValue: enabledResourceTypeName,
			Constraints: []validation.Constraint{{Target: "enabledResourceTypeName", Name: validation.MaxLength, Rule: 63, Chain: nil},
				{Target: "enabledResourceTypeName", Name: validation.MinLength, Rule: 1, Chain: nil},
				{Target: "enabledResourceTypeName", Name: validation.Pattern, Rule: `^[a-zA-Z0-9]$|^[a-zA-Z0-9][-_a-zA-Z0-9]{0,61}[a-zA-Z0-9]$`, Chain: nil}}}}); err != nil {
		return result, validation.NewError("extendedlocation.CustomLocationsClient", "GetEnabledResourceType", err.Error())
	}

	req, err := client.GetEnabledResourceTypePreparer(ctx, resourceGroupName, resourceName, enabledResourceTypeName)
	if err != nil {
		err = autorest.NewErrorWithError(err, "extendedlocation.CustomLocationsClient", "GetEnabledResourceType", nil, "Failure preparing request")
		return
	}

	resp, err := client.GetEnabledResourceTypeSender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "extendedlocation.CustomLocationsClient", "GetEnabledResourceType", resp, "Failure sending request")
		return
	}

	result, err = client.GetEnabledResourceTypeResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "extendedlocation.CustomLocationsClient", "GetEnabledResourceType", resp, "Failure responding to request")
		return
	}
...
// GetEnabledResourceTypePreparer prepares the GetEnabledResourceType request.
func (client CustomLocationsClient) GetEnabledResourceTypePreparer(ctx context.Context, resourceGroupName string, resourceName string, enabledResourceTypeName string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"enabledResourceTypeName": autorest.Encode("path", enabledResourceTypeName),
		"resourceGroupName":       autorest.Encode("path", resourceGroupName),
		"resourceName":            autorest.Encode("path", resourceName),
		"subscriptionId":          autorest.Encode("path", client.SubscriptionID),
	}
	...
	preparer := autorest.CreatePreparer(
		autorest.AsGet(),
		autorest.WithBaseURL(client.BaseURI),
		autorest.WithPathParameters("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ExtendedLocation/customLocations/{resourceName}/enabledResourceTypes/{enabledResourceTypeName}", pathParameters),
		autorest.WithQueryParameters(queryParameters))
	return preparer.Prepare((&http.Request{}).WithContext(ctx))
}

// GetEnabledResourceTypeSender sends the GetEnabledResourceType request. The method will close the
// http.Response Body if it receives an error.
func (client CustomLocationsClient) GetEnabledResourceTypeSender(req *http.Request) (*http.Response, error) {
	return client.Send(req, azure.DoRetryWithRegistration(client.Client))
}

// GetEnabledResourceTypeResponder handles the response to the GetEnabledResourceType request. The method always
// closes the http.Response Body.
func (client CustomLocationsClient) GetEnabledResourceTypeResponder(resp *http.Response) (result EnabledResourceType, err error) {
	err = autorest.Respond(
		resp,
		azure.WithErrorUnlessStatusCode(http.StatusOK),
		autorest.ByUnmarshallingJSON(&result),
