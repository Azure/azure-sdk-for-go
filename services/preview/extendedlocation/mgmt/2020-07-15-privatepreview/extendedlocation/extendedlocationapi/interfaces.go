...
import (
	"context"
	"github.com/Azure/azure-sdk-for-go/services/preview/extendedlocation/mgmt/2020-07-15-privatepreview/extendedlocation"
)
...
type CustomLocationsClientAPI interface {
	...
	GetEnabledResourceType(ctx context.Context, resourceGroupName string, resourceName string, enabledResourceTypeName string) (result extendedlocation.EnabledResourceType, err error)
