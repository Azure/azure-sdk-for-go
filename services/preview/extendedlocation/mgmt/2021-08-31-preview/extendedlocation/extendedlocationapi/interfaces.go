...
import (
	"context"
	"github.com/Azure/azure-sdk-for-go/services/preview/extendedlocation/mgmt/2021-08-31-preview/extendedlocation"
...
type CustomLocationsClientAPI interface {
	...
	FindTargetResourceGroup(ctx context.Context, resourceGroupName string, resourceName string, parameters extendedlocation.CustomLocationFindTargetResourceGroupProperties) (result extendedlocation.CustomLocationFindTargetResourceGroupResult, err error)
...
// ResourceSyncRulesClientAPI contains the set of methods on the ResourceSyncRulesClient type.
type ResourceSyncRulesClientAPI interface {
	CreateOrUpdate(ctx context.Context, resourceGroupName string, resourceName string, childResourceName string, parameters extendedlocation.ResourceSyncRule) (result extendedlocation.ResourceSyncRulesCreateOrUpdateFuture, err error)
	...
	Get(ctx context.Context, resourceGroupName string, resourceName string, childResourceName string) (result extendedlocation.ResourceSyncRule, err error)
	ListByCustomLocationID(ctx context.Context, resourceGroupName string, resourceName string) (result extendedlocation.ResourceSyncRuleListResultPage, err error)
	ListByCustomLocationIDComplete(ctx context.Context, resourceGroupName string, resourceName string) (result extendedlocation.ResourceSyncRuleListResultIterator, err error)
	Update(ctx context.Context, resourceGroupName string, resourceName string, childResourceName string, parameters extendedlocation.PatchableResourceSyncRule) (result extendedlocation.ResourceSyncRulesUpdateFuture, err error)
}

var _ ResourceSyncRulesClientAPI = (*extendedlocation.ResourceSyncRulesClient)(nil)
