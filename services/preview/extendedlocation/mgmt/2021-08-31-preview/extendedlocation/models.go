...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/preview/extendedlocation/mgmt/2021-08-31-preview/extendedlocation"
...
type CustomLocationFindTargetResourceGroupProperties struct {
	// Labels - Labels of the custom resource, this is a map of {key,value} pairs.
	Labels map[string]*string `json:"labels"`
}

// MarshalJSON is the custom marshaler for CustomLocationFindTargetResourceGroupProperties.
func (clftrgp CustomLocationFindTargetResourceGroupProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if clftrgp.Labels != nil {
		objectMap["labels"] = clftrgp.Labels
	}
	return json.Marshal(objectMap)
}
...
type CustomLocationFindTargetResourceGroupResult struct {
	autorest.Response `json:"-"`
	// MatchedResourceSyncRule - READ-ONLY; The matching resource sync rule is the particular resource sync rule that matched the match expressions and labels and had lowest priority. This is the rule responsible for mapping the target resource to the target resource group.
	MatchedResourceSyncRule *string `json:"matchedResourceSyncRule,omitempty"`
	// TargetResourceGroup - READ-ONLY; The target resource group of matching resource sync rule. The labels from the request will be used to find out matching resource sync rule against the selector property of the resource sync rule. The one with highest priority will be returned if there are multiple matching rules.
	TargetResourceGroup *string `json:"targetResourceGroup,omitempty"`
}

// MarshalJSON is the custom marshaler for CustomLocationFindTargetResourceGroupResult.
func (clftrgr CustomLocationFindTargetResourceGroupResult) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	return json.Marshal(objectMap)
}
...
type PatchableResourceSyncRule struct {
	// ResourceSyncRuleProperties - The Resource Sync Rules patchable properties.
	*ResourceSyncRuleProperties `json:"properties,omitempty"`
	// Tags - Resource tags
	Tags map[string]*string `json:"tags"`
}

// MarshalJSON is the custom marshaler for PatchableResourceSyncRule.
func (prsr PatchableResourceSyncRule) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if prsr.ResourceSyncRuleProperties != nil {
		objectMap["properties"] = prsr.ResourceSyncRuleProperties
	}
	if prsr.Tags != nil {
		objectMap["tags"] = prsr.Tags
	}
	return json.Marshal(objectMap)
}

// UnmarshalJSON is the custom unmarshaler for PatchableResourceSyncRule struct.
func (prsr *PatchableResourceSyncRule) UnmarshalJSON(body []byte) error {
	var m map[string]*json.RawMessage
	err := json.Unmarshal(body, &m)
	if err != nil {
		return err
	...
	for k, v := range m {
		...
		case "properties":
			if v != nil {
				var resourceSyncRuleProperties ResourceSyncRuleProperties
				err = json.Unmarshal(*v, &resourceSyncRuleProperties)
				if err != nil {
					return err
				}
				prsr.ResourceSyncRuleProperties = &resourceSyncRuleProperties
			}
		case "tags":
			if v != nil {
				var tags map[string]*string
...
type ResourceSyncRule struct {
	autorest.Response `json:"-"`
	// ResourceSyncRuleProperties - The set of properties specific to a Resource Sync Rule
	*ResourceSyncRuleProperties `json:"properties,omitempty"`
	// SystemData - READ-ONLY; Metadata pertaining to creation and last modification of the resource
	SystemData *SystemData `json:"systemData,omitempty"`
	// Tags - Resource tags.
...
// MarshalJSON is the custom marshaler for ResourceSyncRule.
func (rsr ResourceSyncRule) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if rsr.ResourceSyncRuleProperties != nil {
		objectMap["properties"] = rsr.ResourceSyncRuleProperties
	}
	if rsr.Tags != nil {
		objectMap["tags"] = rsr.Tags
	}
	if rsr.Location != nil {
		objectMap["location"] = rsr.Location
	}
	return json.Marshal(objectMap)
}

// UnmarshalJSON is the custom unmarshaler for ResourceSyncRule struct.
func (rsr *ResourceSyncRule) UnmarshalJSON(body []byte) error {
	var m map[string]*json.RawMessage
	err := json.Unmarshal(body, &m)
	if err != nil {
		return err
	...
	for k, v := range m {
		...
		case "properties":
			if v != nil {
				...
				rsr.ResourceSyncRuleProperties = &resourceSyncRuleProperties
			}
		case "systemData":
			if v != nil {
				var systemData SystemData
...
type ResourceSyncRuleListResult struct {
	...
	// NextLink - READ-ONLY; The URL to use for getting the next set of results.
	NextLink *string `json:"nextLink,omitempty"`
	// Value - READ-ONLY; The list of Resource Sync Rules.
	Value *[]ResourceSyncRule `json:"value,omitempty"`
}

// MarshalJSON is the custom marshaler for ResourceSyncRuleListResult.
func (rsrlr ResourceSyncRuleListResult) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	return json.Marshal(objectMap)
}

// ResourceSyncRuleListResultIterator provides access to a complete listing of ResourceSyncRule values.
type ResourceSyncRuleListResultIterator struct {
	i    int
...
// NextWithContext advances to the next value.  If there was an error making
// the request the iterator does not advance and the error is returned.
func (iter *ResourceSyncRuleListResultIterator) NextWithContext(ctx context.Context) (err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/ResourceSyncRuleListResultIterator.NextWithContext")
		defer func() {
			sc := -1
			if iter.Response().Response.Response != nil {
				sc = iter.Response().Response.Response.StatusCode
...
// the request the iterator does not advance and the error is returned.
// Deprecated: Use NextWithContext() instead.
func (iter *ResourceSyncRuleListResultIterator) Next() error {
	return iter.NextWithContext(context.Background())
}

// NotDone returns true if the enumeration should be started or is not yet complete.
func (iter ResourceSyncRuleListResultIterator) NotDone() bool {
	return iter.page.NotDone() && iter.i < len(iter.page.Values())
}

// Response returns the raw server response from the last page request.
func (iter ResourceSyncRuleListResultIterator) Response() ResourceSyncRuleListResult {
	return iter.page.Response()
}

// Value returns the current value or a zero-initialized value if the
// iterator has advanced beyond the end of the collection.
func (iter ResourceSyncRuleListResultIterator) Value() ResourceSyncRule {
	if !iter.page.NotDone() {
		return ResourceSyncRule{}
	}
	return iter.page.Values()[iter.i]
}

// Creates a new instance of the ResourceSyncRuleListResultIterator type.
func NewResourceSyncRuleListResultIterator(page ResourceSyncRuleListResultPage) ResourceSyncRuleListResultIterator {
	return ResourceSyncRuleListResultIterator{page: page}
}

// IsEmpty returns true if the ListResult contains no values.
func (rsrlr ResourceSyncRuleListResult) IsEmpty() bool {
	return rsrlr.Value == nil || len(*rsrlr.Value) == 0
}

// hasNextLink returns true if the NextLink is not empty.
func (rsrlr ResourceSyncRuleListResult) hasNextLink() bool {
	return rsrlr.NextLink != nil && len(*rsrlr.NextLink) != 0
}

// resourceSyncRuleListResultPreparer prepares a request to retrieve the next set of results.
// It returns nil if no more results exist.
func (rsrlr ResourceSyncRuleListResult) resourceSyncRuleListResultPreparer(ctx context.Context) (*http.Request, error) {
	if !rsrlr.hasNextLink() {
		return nil, nil
	}
	return autorest.Prepare((&http.Request{}).WithContext(ctx),
		autorest.AsJSON(),
		autorest.AsGet(),
		autorest.WithBaseURL(to.String(rsrlr.NextLink)))
}

// ResourceSyncRuleListResultPage contains a page of ResourceSyncRule values.
type ResourceSyncRuleListResultPage struct {
	fn    func(context.Context, ResourceSyncRuleListResult) (ResourceSyncRuleListResult, error)
	rsrlr ResourceSyncRuleListResult
}

// NextWithContext advances to the next page of values.  If there was an error making
// the request the page does not advance and the error is returned.
func (page *ResourceSyncRuleListResultPage) NextWithContext(ctx context.Context) (err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/ResourceSyncRuleListResultPage.NextWithContext")
		defer func() {
			sc := -1
			if page.Response().Response.Response != nil {
				sc = page.Response().Response.Response.StatusCode
	...
	for {
		next, err := page.fn(ctx, page.rsrlr)
		if err != nil {
			return err
		}
		page.rsrlr = next
...
// the request the page does not advance and the error is returned.
// Deprecated: Use NextWithContext() instead.
func (page *ResourceSyncRuleListResultPage) Next() error {
	return page.NextWithContext(context.Background())
}

// NotDone returns true if the page enumeration should be started or is not yet complete.
func (page ResourceSyncRuleListResultPage) NotDone() bool {
	return !page.rsrlr.IsEmpty()
}

// Response returns the raw server response from the last page request.
func (page ResourceSyncRuleListResultPage) Response() ResourceSyncRuleListResult {
	return page.rsrlr
}

// Values returns the slice of values for the current page or nil if there are no values.
func (page ResourceSyncRuleListResultPage) Values() []ResourceSyncRule {
	if page.rsrlr.IsEmpty() {
		return nil
	}
	return *page.rsrlr.Value
}

// Creates a new instance of the ResourceSyncRuleListResultPage type.
func NewResourceSyncRuleListResultPage(cur ResourceSyncRuleListResult, getNextPage func(context.Context, ResourceSyncRuleListResult) (ResourceSyncRuleListResult, error)) ResourceSyncRuleListResultPage {
	return ResourceSyncRuleListResultPage{
		fn:    getNextPage,
		rsrlr: cur,
	}
}

// ResourceSyncRuleProperties properties for a resource sync rule. For an unmapped custom resource, its
// labels will be used to find out matching resource sync rules using the selector property of the resource
// sync rule. If this resource sync rule has highest priority among all matching rules, then the unmapped
// custom resource will be projected to the target resource group associated with this resource sync rule.
type ResourceSyncRuleProperties struct {
	// Priority - Priority represents a priority of the Resource Sync Rule
	Priority *int32 `json:"priority,omitempty"`
	// ProvisioningState - READ-ONLY; Provisioning State for the Resource Sync Rule.
	ProvisioningState *string `json:"provisioningState,omitempty"`
...
// MarshalJSON is the custom marshaler for ResourceSyncRuleProperties.
func (rsrp ResourceSyncRuleProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if rsrp.Priority != nil {
		objectMap["priority"] = rsrp.Priority
	}
	if rsrp.Selector != nil {
		objectMap["selector"] = rsrp.Selector
	}
	if rsrp.TargetResourceGroup != nil {
		objectMap["targetResourceGroup"] = rsrp.TargetResourceGroup
	}
	return json.Marshal(objectMap)
}

// ResourceSyncRulePropertiesSelector a label selector is composed of two parts, matchLabels and
...
// set must be non-empty in the case of In and NotIn. The values set must be empty in the case of Exists
// and DoesNotExist. All of the requirements, from both matchLabels and matchExpressions must all be
// satisfied in order to match.
type ResourceSyncRulePropertiesSelector struct {
	// MatchExpressions - MatchExpressions is a list of resource selector requirements. Valid operators include In, NotIn, Exists, and DoesNotExist. The values set must be non-empty in the case of In and NotIn. The values set must be empty in the case of Exists and DoesNotExist.
...
// MarshalJSON is the custom marshaler for ResourceSyncRulePropertiesSelector.
func (rsrp ResourceSyncRulePropertiesSelector) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if rsrp.MatchExpressions != nil {
		objectMap["matchExpressions"] = rsrp.MatchExpressions
	}
	if rsrp.MatchLabels != nil {
		objectMap["matchLabels"] = rsrp.MatchLabels
	}
	return json.Marshal(objectMap)
}

// ResourceSyncRulesCreateOrUpdateFuture an abstraction for monitoring and retrieving the results of a
// long-running operation.
type ResourceSyncRulesCreateOrUpdateFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(ResourceSyncRulesClient) (ResourceSyncRule, error)
}

// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *ResourceSyncRulesCreateOrUpdateFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for ResourceSyncRulesCreateOrUpdateFuture.Result.
func (future *ResourceSyncRulesCreateOrUpdateFuture) result(client ResourceSyncRulesClient) (rsr ResourceSyncRule, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "extendedlocation.ResourceSyncRulesCreateOrUpdateFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		rsr.Response.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("extendedlocation.ResourceSyncRulesCreateOrUpdateFuture")
		return
	}
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if rsr.Response.Response, err = future.GetResult(sender); err == nil && rsr.Response.Response.StatusCode != http.StatusNoContent {
		rsr, err = client.CreateOrUpdateResponder(rsr.Response.Response)
		if err != nil {
			err = autorest.NewErrorWithError(err, "extendedlocation.ResourceSyncRulesCreateOrUpdateFuture", "Result", rsr.Response.Response, "Failure responding to request")
		}
	}
	return
}

// ResourceSyncRulesUpdateFuture an abstraction for monitoring and retrieving the results of a long-running
// operation.
type ResourceSyncRulesUpdateFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(ResourceSyncRulesClient) (ResourceSyncRule, error)
...
// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *ResourceSyncRulesUpdateFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for ResourceSyncRulesUpdateFuture.Result.
func (future *ResourceSyncRulesUpdateFuture) result(client ResourceSyncRulesClient) (rsr ResourceSyncRule, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "extendedlocation.ResourceSyncRulesUpdateFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		rsr.Response.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("extendedlocation.ResourceSyncRulesUpdateFuture")
		return
	}
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if rsr.Response.Response, err = future.GetResult(sender); err == nil && rsr.Response.Response.StatusCode != http.StatusNoContent {
		rsr, err = client.UpdateResponder(rsr.Response.Response)
		if err != nil {
			err = autorest.NewErrorWithError(err, "extendedlocation.ResourceSyncRulesUpdateFuture", "Result", rsr.Response.Response, "Failure responding to request")
		}
	}
	return
}
