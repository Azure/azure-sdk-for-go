...
type HanaInstancesClientAPI interface {
	...
	UpdateTags(ctx context.Context, resourceGroupName string, hanaInstanceName string, hanaInstancePatchTagsParameter hanaonazure.Tags) (result hanaonazure.HanaInstance, err error)
}
