...
type ConnectedClusterPatchProperties struct {
	// PrivateLinkState - Property which describes the state of private link on a connected cluster resource. Possible values include: 'PrivateLinkStateEnabled', 'PrivateLinkStateDisabled'
