...
type AppProperties struct {
	...
	// State - The current state of the application. Possible values include: 'Created', 'Suspended'
	State AppState `json:"state,omitempty"`
	// PublicNetworkAccess - Whether requests from the public network are allowed. Possible values include: 'Enabled', 'Disabled'
...
type NetworkRuleSets struct {
	...
	// DefaultAction - The default network action to apply. Possible values include: 'Allow', 'Deny'
...
type SystemAssignedServiceIdentity struct {
	...
	// Type - Possible values include: 'None', 'SystemAssigned'
