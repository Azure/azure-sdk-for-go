...
import (
	"context"
	"github.com/Azure/azure-sdk-for-go/services/preview/kubernetesconfiguration/mgmt/2021-11-01-preview/kubernetesconfiguration"
)
...
type ClusterExtensionTypeClientAPI interface {
	Get(ctx context.Context, resourceGroupName string, clusterRp string, clusterResourceName string, clusterName string, extensionTypeName string) (result kubernetesconfiguration.ExtensionType, err error)
}
...
type ClusterExtensionTypesClientAPI interface {
	List(ctx context.Context, resourceGroupName string, clusterRp string, clusterResourceName string, clusterName string) (result kubernetesconfiguration.ExtensionTypeListPage, err error)
	ListComplete(ctx context.Context, resourceGroupName string, clusterRp string, clusterResourceName string, clusterName string) (result kubernetesconfiguration.ExtensionTypeListIterator, err error)
}
