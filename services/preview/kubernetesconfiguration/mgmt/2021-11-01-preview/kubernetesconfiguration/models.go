...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/preview/kubernetesconfiguration/mgmt/2021-11-01-preview/kubernetesconfiguration"
...
// DependsOnDefinition specify which kustomizations must succeed reconciliation on the cluster prior to
// reconciling this kustomization
type DependsOnDefinition struct {
	// KustomizationName - Name of the kustomization to claim dependency on
...
type FluxConfigurationPatchProperties struct {
	// SourceKind - Source Kind to pull the configuration data from. Possible values include: 'GitRepository'
...
type FluxConfigurationProperties struct {
	...
	// LastSourceSyncedCommitID - READ-ONLY; Branch and SHA of the last source commit synced with the cluster.
	LastSourceSyncedCommitID *string `json:"lastSourceSyncedCommitId,omitempty"`
	// LastSourceSyncedAt - READ-ONLY; Datetime the fluxConfiguration last synced its source on the cluster.
	LastSourceSyncedAt *date.Time `json:"lastSourceSyncedAt,omitempty"`
...
type GitRepositoryDefinition struct {
	...
	HTTPSCAFile *string `json:"httpsCAFile,omitempty"`
...
type KustomizationDefinition struct {
	...
	// Validation - Specify whether to validate the Kubernetes objects referenced in the Kustomization before applying them to the cluster. Possible values include: 'None', 'Client', 'Server'
	Validation KustomizationValidationType `json:"validation,omitempty"`
