...
// ExtensionsClusterResourceName enumerates the values for extensions cluster resource name.
type ExtensionsClusterResourceName string

const (
	// ConnectedClusters ...
	ConnectedClusters ExtensionsClusterResourceName = "connectedClusters"
	// ManagedClusters ...
	ManagedClusters ExtensionsClusterResourceName = "managedClusters"
)

// PossibleExtensionsClusterResourceNameValues returns an array of possible values for the ExtensionsClusterResourceName const type.
...
// ExtensionsClusterRp enumerates the values for extensions cluster rp.
type ExtensionsClusterRp string

const (
	// MicrosoftContainerService ...
	MicrosoftContainerService ExtensionsClusterRp = "Microsoft.ContainerService"
	// MicrosoftKubernetes ...
	MicrosoftKubernetes ExtensionsClusterRp = "Microsoft.Kubernetes"
)

// PossibleExtensionsClusterRpValues returns an array of possible values for the ExtensionsClusterRp const type.
func PossibleExtensionsClusterRpValues() []ExtensionsClusterRp {
	return []ExtensionsClusterRp{MicrosoftContainerService, MicrosoftKubernetes}
}
...
func PossibleSourceKindTypeValues() []SourceKindType {
	return []SourceKindType{Bucket, GitRepository}
}
