...
// clusterName - the name of the kubernetes cluster.
// sourceControlConfigurationName - name of the Source Control Configuration.
func (client SourceControlConfigurationsClient) Delete(ctx context.Context, resourceGroupName string, clusterRp ExtensionsClusterRp, clusterResourceName ExtensionsClusterResourceName, clusterName string, sourceControlConfigurationName string) (result SourceControlConfigurationsDeleteFuture, err error) {
	if tracing.IsEnabled() {
...
func (client SourceControlConfigurationsClient) DeletePreparer(ctx context.Context, resourceGroupName string, clusterRp ExtensionsClusterRp, clusterResourceName ExtensionsClusterResourceName, clusterName string, sourceControlConfigurationName string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"clusterName":                    autorest.Encode("path", clusterName),
		"clusterResourceName":            autorest.Encode("path", clusterResourceName),
		"clusterRp":                      autorest.Encode("path", clusterRp),
...
// clusterName - the name of the kubernetes cluster.
// sourceControlConfigurationName - name of the Source Control Configuration.
func (client SourceControlConfigurationsClient) Get(ctx context.Context, resourceGroupName string, clusterRp ExtensionsClusterRp, clusterResourceName ExtensionsClusterResourceName, clusterName string, sourceControlConfigurationName string) (result SourceControlConfiguration, err error) {
	if tracing.IsEnabled() {
...
func (client SourceControlConfigurationsClient) GetPreparer(ctx context.Context, resourceGroupName string, clusterRp ExtensionsClusterRp, clusterResourceName ExtensionsClusterResourceName, clusterName string, sourceControlConfigurationName string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"clusterName":                    autorest.Encode("path", clusterName),
		"clusterResourceName":            autorest.Encode("path", clusterResourceName),
		"clusterRp":                      autorest.Encode("path", clusterRp),
...
// connectedClusters (for OnPrem K8S clusters).
// clusterName - the name of the kubernetes cluster.
func (client SourceControlConfigurationsClient) List(ctx context.Context, resourceGroupName string, clusterRp ExtensionsClusterRp, clusterResourceName ExtensionsClusterResourceName, clusterName string) (result SourceControlConfigurationListPage, err error) {
	if tracing.IsEnabled() {
...
func (client SourceControlConfigurationsClient) ListPreparer(ctx context.Context, resourceGroupName string, clusterRp ExtensionsClusterRp, clusterResourceName ExtensionsClusterResourceName, clusterName string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"clusterName":         autorest.Encode("path", clusterName),
		"clusterResourceName": autorest.Encode("path", clusterResourceName),
		"clusterRp":           autorest.Encode("path", clusterRp),
...
func (client SourceControlConfigurationsClient) ListComplete(ctx context.Context, resourceGroupName string, clusterRp ExtensionsClusterRp, clusterResourceName ExtensionsClusterResourceName, clusterName string) (result SourceControlConfigurationListIterator, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/SourceControlConfigurationsClient.List")
		defer func() {
			sc := -1
