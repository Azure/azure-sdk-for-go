...
type AutoShutdownProfile struct {
	// ShutdownOnDisconnect - Whether shutdown on disconnect is enabled. Possible values include: 'Enabled', 'Disabled'
	ShutdownOnDisconnect EnableState `json:"shutdownOnDisconnect,omitempty"`
	// ShutdownWhenNotConnected - Whether a VM will get shutdown when it hasn't been connected to after a period of time. Possible values include: 'Enabled', 'Disabled'
...
type ConnectionProfile struct {
	// WebSSHAccess - The enabled access level for Web Access over SSH. Possible values include: 'Public', 'Private', 'None'
	WebSSHAccess ConnectionType `json:"webSshAccess,omitempty"`
	// WebRdpAccess - The enabled access level for Web Access over RDP. Possible values include: 'Public', 'Private', 'None'
	WebRdpAccess ConnectionType `json:"webRdpAccess,omitempty"`
	// ClientSSHAccess - The enabled access level for Client Access over SSH. Possible values include: 'Public', 'Private', 'None'
	ClientSSHAccess ConnectionType `json:"clientSshAccess,omitempty"`
	// ClientRdpAccess - The enabled access level for Client Access over RDP. Possible values include: 'Public', 'Private', 'None'
...
type ImageProperties struct {
	...
	// OsType - READ-ONLY; The OS Type of the image. Possible values include: 'Windows', 'Linux'
	OsType OsType `json:"osType,omitempty"`
	// Plan - READ-ONLY; The ID of marketplace plan associated with the image (optional).
	Plan *string `json:"plan,omitempty"`
	// TermsStatus - READ-ONLY; The status of image terms of use (enabled = accepted, disabled = not accepted). Possible values include: 'Enabled', 'Disabled'
	...
	// OsState - READ-ONLY; The OS State of the image. Possible values include: 'Generalized', 'Specialized'
	OsState OsState `json:"osState,omitempty"`
	// EnabledState - Is the image enabled. Possible values include: 'Enabled', 'Disabled'
...
type LabProperties struct {
	...
	// State - READ-ONLY; The lab state. Possible values include: 'Draft', 'Publishing', 'Scaling', 'Syncing', 'Published'
...
type RecurrencePattern struct {
	// Frequency - The frequency of the recurrence. Possible values include: 'Daily', 'Weekly'
...
type SecurityProfile struct {
	...
	// OpenAccess - Whether any user or only specified users can register to a lab. Possible values include: 'Enabled', 'Disabled'
...
type SkuRestrictions struct {
	// Type - READ-ONLY; The type of restriction. Possible values include: 'Location'
	Type RestrictionType `json:"type,omitempty"`
	// Values - READ-ONLY; The values of the restriction.
	Values *[]string `json:"values,omitempty"`
	// ReasonCode - READ-ONLY; The reason for the restriction. Possible values include: 'QuotaID', 'NotAvailableForSubscription'
...
type Usage struct {
	...
	// Unit - The unit details. Possible values include: 'Count'
...
type UserProperties struct {
	...
	Email *string `json:"email,omitempty"`
	// RegistrationState - READ-ONLY; State of the user's registration within the lab. Possible values include: 'Registered', 'NotRegistered'
	RegistrationState RegistrationState `json:"registrationState,omitempty"`
	// InvitationState - READ-ONLY; State of the invitation message for the user. Possible values include: 'NotSent', 'Sending', 'Sent', 'Failed'
...
type VirtualMachineAdditionalCapabilities struct {
	// InstallGpuDrivers - Flag to pre-install dedicated GPU drivers. Possible values include: 'Enabled', 'Disabled'
...
type VirtualMachineProfile struct {
	...
	// UseSharedPassword - Enabling this option will use the same password for all user VMs. Possible values include: 'Enabled', 'Disabled'
...
type VirtualMachineProperties struct {
	...
	ProvisioningState ProvisioningState `json:"provisioningState,omitempty"`
	// State - READ-ONLY; The current state of the virtual machine. Possible values include: 'Stopped', 'Starting', 'Running', 'Stopping', 'ResettingPassword', 'Reimaging', 'Redeploying'
