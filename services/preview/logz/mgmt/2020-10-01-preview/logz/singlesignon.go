...
func (client SingleSignOnClient) CreateOrUpdateSender(req *http.Request) (future SingleSignOnCreateOrUpdateFuture, err error) {
	...
	future.Result = func(client SingleSignOnClient) (ssor SingleSignOnResource, err error) {
		var done bool
		...
		if ssor.Response.Response == nil && err == nil {
			err = autorest.NewErrorWithError(err, "logz.SingleSignOnCreateOrUpdateFuture", "Result", nil, "received nil response and error")
		}
