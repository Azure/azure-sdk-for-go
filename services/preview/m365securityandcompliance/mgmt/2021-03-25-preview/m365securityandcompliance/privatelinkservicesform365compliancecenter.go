...
func (client PrivateLinkServicesForM365ComplianceCenterClient) CreateOrUpdate(ctx context.Context, resourceGroupName string, resourceName string, privateLinkServicesForM365ComplianceCenterDescription PrivateLinkServicesForM365ComplianceCenterDescription) (result PrivateLinkServicesForM365ComplianceCenterCreateOrUpdateFuture, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewError("m365securityandcompliance.PrivateLinkServicesForM365ComplianceCenterClient", "CreateOrUpdate", err.Error())
	}
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "m365securityandcompliance.PrivateLinkServicesForM365ComplianceCenterClient", "CreateOrUpdate", nil, "Failure preparing request")
		return
	}

	result, err = client.CreateOrUpdateSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "m365securityandcompliance.PrivateLinkServicesForM365ComplianceCenterClient", "CreateOrUpdate", nil, "Failure sending request")
		return
	}
...
func (client PrivateLinkServicesForM365ComplianceCenterClient) CreateOrUpdatePreparer(ctx context.Context, resourceGroupName string, resourceName string, privateLinkServicesForM365ComplianceCenterDescription PrivateLinkServicesForM365ComplianceCenterDescription) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithPathParameters("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.M365SecurityAndCompliance/privateLinkServicesForM365ComplianceCenter/{resourceName}", pathParameters),
...
func (client PrivateLinkServicesForM365ComplianceCenterClient) Delete(ctx context.Context, resourceGroupName string, resourceName string) (result PrivateLinkServicesForM365ComplianceCenterDeleteFuture, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewError("m365securityandcompliance.PrivateLinkServicesForM365ComplianceCenterClient", "Delete", err.Error())
	}

	req, err := client.DeletePreparer(ctx, resourceGroupName, resourceName)
	if err != nil {
		err = autorest.NewErrorWithError(err, "m365securityandcompliance.PrivateLinkServicesForM365ComplianceCenterClient", "Delete", nil, "Failure preparing request")
		return
	}

	result, err = client.DeleteSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "m365securityandcompliance.PrivateLinkServicesForM365ComplianceCenterClient", "Delete", nil, "Failure sending request")
		return
	}
...
func (client PrivateLinkServicesForM365ComplianceCenterClient) Get(ctx context.Context, resourceGroupName string, resourceName string) (result PrivateLinkServicesForM365ComplianceCenterDescription, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		{TargetValue: resourceName,
			Constraints: []validation.Constraint{{Target: "resourceName", Name: validation.MaxLength, Rule: 24, Chain: nil},
				{Target: "resourceName", Name: validation.MinLength, Rule: 3, Chain: nil}}}}); err != nil {
		return result, validation.NewError("m365securityandcompliance.PrivateLinkServicesForM365ComplianceCenterClient", "Get", err.Error())
	}

	req, err := client.GetPreparer(ctx, resourceGroupName, resourceName)
	if err != nil {
		err = autorest.NewErrorWithError(err, "m365securityandcompliance.PrivateLinkServicesForM365ComplianceCenterClient", "Get", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "m365securityandcompliance.PrivateLinkServicesForM365ComplianceCenterClient", "Get", resp, "Failure sending request")
		return
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "m365securityandcompliance.PrivateLinkServicesForM365ComplianceCenterClient", "Get", resp, "Failure responding to request")
		return
	}
...
func (client PrivateLinkServicesForM365ComplianceCenterClient) List(ctx context.Context) (result PrivateLinkServicesForM365ComplianceCenterDescriptionListResultPage, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "m365securityandcompliance.PrivateLinkServicesForM365ComplianceCenterClient", "List", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "m365securityandcompliance.PrivateLinkServicesForM365ComplianceCenterClient", "List", resp, "Failure sending request")
		return
	}

	result.plsfmccdlr, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "m365securityandcompliance.PrivateLinkServicesForM365ComplianceCenterClient", "List", resp, "Failure responding to request")
		return
	}
...
func (client PrivateLinkServicesForM365ComplianceCenterClient) ListPreparer(ctx context.Context) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		autorest.AsGet(),
		autorest.WithBaseURL(client.BaseURI),
		autorest.WithPathParameters("/subscriptions/{subscriptionId}/providers/Microsoft.M365SecurityAndCompliance/privateLinkServicesForM365ComplianceCenter", pathParameters),
		autorest.WithQueryParameters(queryParameters))
	return preparer.Prepare((&http.Request{}).WithContext(ctx))
}
...
func (client PrivateLinkServicesForM365ComplianceCenterClient) listNextResults(ctx context.Context, lastResults PrivateLinkServicesForM365ComplianceCenterDescriptionListResult) (result PrivateLinkServicesForM365ComplianceCenterDescriptionListResult, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "m365securityandcompliance.PrivateLinkServicesForM365ComplianceCenterClient", "listNextResults", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "m365securityandcompliance.PrivateLinkServicesForM365ComplianceCenterClient", "listNextResults", resp, "Failure sending next results request")
	}
	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "m365securityandcompliance.PrivateLinkServicesForM365ComplianceCenterClient", "listNextResults", resp, "Failure responding to next results request")
	}
	return
}
...
func (client PrivateLinkServicesForM365ComplianceCenterClient) ListByResourceGroup(ctx context.Context, resourceGroupName string) (result PrivateLinkServicesForM365ComplianceCenterDescriptionListResultPage, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewError("m365securityandcompliance.PrivateLinkServicesForM365ComplianceCenterClient", "ListByResourceGroup", err.Error())
	}

	result.fn = client.listByResourceGroupNextResults
	req, err := client.ListByResourceGroupPreparer(ctx, resourceGroupName)
	if err != nil {
		err = autorest.NewErrorWithError(err, "m365securityandcompliance.PrivateLinkServicesForM365ComplianceCenterClient", "ListByResourceGroup", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.plsfmccdlr.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "m365securityandcompliance.PrivateLinkServicesForM365ComplianceCenterClient", "ListByResourceGroup", resp, "Failure sending request")
		return
	}

	result.plsfmccdlr, err = client.ListByResourceGroupResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "m365securityandcompliance.PrivateLinkServicesForM365ComplianceCenterClient", "ListByResourceGroup", resp, "Failure responding to request")
		return
	}
	if result.plsfmccdlr.hasNextLink() && result.plsfmccdlr.IsEmpty() {
		err = result.NextWithContext(ctx)
...
func (client PrivateLinkServicesForM365ComplianceCenterClient) ListByResourceGroupPreparer(ctx context.Context, resourceGroupName string) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		autorest.AsGet(),
		autorest.WithBaseURL(client.BaseURI),
		autorest.WithPathParameters("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.M365SecurityAndCompliance/privateLinkServicesForM365ComplianceCenter", pathParameters),
		autorest.WithQueryParameters(queryParameters))
	return preparer.Prepare((&http.Request{}).WithContext(ctx))
}
...
func (client PrivateLinkServicesForM365ComplianceCenterClient) listByResourceGroupNextResults(ctx context.Context, lastResults PrivateLinkServicesForM365ComplianceCenterDescriptionListResult) (result PrivateLinkServicesForM365ComplianceCenterDescriptionListResult, err error) {
	req, err := lastResults.privateLinkServicesForM365ComplianceCenterDescriptionListResultPreparer(ctx)
	if err != nil {
		return result, autorest.NewErrorWithError(err, "m365securityandcompliance.PrivateLinkServicesForM365ComplianceCenterClient", "listByResourceGroupNextResults", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "m365securityandcompliance.PrivateLinkServicesForM365ComplianceCenterClient", "listByResourceGroupNextResults", resp, "Failure sending next results request")
	}
	result, err = client.ListByResourceGroupResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "m365securityandcompliance.PrivateLinkServicesForM365ComplianceCenterClient", "listByResourceGroupNextResults", resp, "Failure responding to next results request")
	}
	return
}
...
func (client PrivateLinkServicesForM365ComplianceCenterClient) Update(ctx context.Context, resourceGroupName string, resourceName string, servicePatchDescription ServicesPatchDescription) (result PrivateLinkServicesForM365ComplianceCenterUpdateFuture, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		{TargetValue: resourceName,
			Constraints: []validation.Constraint{{Target: "resourceName", Name: validation.MaxLength, Rule: 24, Chain: nil},
				{Target: "resourceName", Name: validation.MinLength, Rule: 3, Chain: nil}}}}); err != nil {
		return result, validation.NewError("m365securityandcompliance.PrivateLinkServicesForM365ComplianceCenterClient", "Update", err.Error())
	}

	req, err := client.UpdatePreparer(ctx, resourceGroupName, resourceName, servicePatchDescription)
	if err != nil {
		err = autorest.NewErrorWithError(err, "m365securityandcompliance.PrivateLinkServicesForM365ComplianceCenterClient", "Update", nil, "Failure preparing request")
		return
	}

	result, err = client.UpdateSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "m365securityandcompliance.PrivateLinkServicesForM365ComplianceCenterClient", "Update", nil, "Failure sending request")
		return
	}
