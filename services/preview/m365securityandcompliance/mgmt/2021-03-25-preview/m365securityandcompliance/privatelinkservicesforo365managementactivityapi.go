...
func (client PrivateLinkServicesForO365ManagementActivityAPIClient) CreateOrUpdate(ctx context.Context, resourceGroupName string, resourceName string, privateLinkServicesForO365ManagementActivityAPIDescription PrivateLinkServicesForO365ManagementActivityAPIDescription) (result PrivateLinkServicesForO365ManagementActivityAPICreateOrUpdateFuture, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewError("m365securityandcompliance.PrivateLinkServicesForO365ManagementActivityAPIClient", "CreateOrUpdate", err.Error())
	}
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "m365securityandcompliance.PrivateLinkServicesForO365ManagementActivityAPIClient", "CreateOrUpdate", nil, "Failure preparing request")
		return
	}

	result, err = client.CreateOrUpdateSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "m365securityandcompliance.PrivateLinkServicesForO365ManagementActivityAPIClient", "CreateOrUpdate", nil, "Failure sending request")
		return
	}
...
func (client PrivateLinkServicesForO365ManagementActivityAPIClient) CreateOrUpdatePreparer(ctx context.Context, resourceGroupName string, resourceName string, privateLinkServicesForO365ManagementActivityAPIDescription PrivateLinkServicesForO365ManagementActivityAPIDescription) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithPathParameters("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.M365SecurityAndCompliance/privateLinkServicesForO365ManagementActivityAPI/{resourceName}", pathParameters),
...
func (client PrivateLinkServicesForO365ManagementActivityAPIClient) Delete(ctx context.Context, resourceGroupName string, resourceName string) (result PrivateLinkServicesForO365ManagementActivityAPIDeleteFuture, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewError("m365securityandcompliance.PrivateLinkServicesForO365ManagementActivityAPIClient", "Delete", err.Error())
	}

	req, err := client.DeletePreparer(ctx, resourceGroupName, resourceName)
	if err != nil {
		err = autorest.NewErrorWithError(err, "m365securityandcompliance.PrivateLinkServicesForO365ManagementActivityAPIClient", "Delete", nil, "Failure preparing request")
		return
	}

	result, err = client.DeleteSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "m365securityandcompliance.PrivateLinkServicesForO365ManagementActivityAPIClient", "Delete", nil, "Failure sending request")
		return
	}
...
func (client PrivateLinkServicesForO365ManagementActivityAPIClient) Get(ctx context.Context, resourceGroupName string, resourceName string) (result PrivateLinkServicesForO365ManagementActivityAPIDescription, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		{TargetValue: resourceName,
			Constraints: []validation.Constraint{{Target: "resourceName", Name: validation.MaxLength, Rule: 24, Chain: nil},
				{Target: "resourceName", Name: validation.MinLength, Rule: 3, Chain: nil}}}}); err != nil {
		return result, validation.NewError("m365securityandcompliance.PrivateLinkServicesForO365ManagementActivityAPIClient", "Get", err.Error())
	}

	req, err := client.GetPreparer(ctx, resourceGroupName, resourceName)
	if err != nil {
		err = autorest.NewErrorWithError(err, "m365securityandcompliance.PrivateLinkServicesForO365ManagementActivityAPIClient", "Get", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "m365securityandcompliance.PrivateLinkServicesForO365ManagementActivityAPIClient", "Get", resp, "Failure sending request")
		return
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "m365securityandcompliance.PrivateLinkServicesForO365ManagementActivityAPIClient", "Get", resp, "Failure responding to request")
		return
	}
...
func (client PrivateLinkServicesForO365ManagementActivityAPIClient) List(ctx context.Context) (result PrivateLinkServicesForO365ManagementActivityAPIDescriptionListResultPage, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "m365securityandcompliance.PrivateLinkServicesForO365ManagementActivityAPIClient", "List", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "m365securityandcompliance.PrivateLinkServicesForO365ManagementActivityAPIClient", "List", resp, "Failure sending request")
		return
	}

	result.plsfomaadlr, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "m365securityandcompliance.PrivateLinkServicesForO365ManagementActivityAPIClient", "List", resp, "Failure responding to request")
		return
	}
...
func (client PrivateLinkServicesForO365ManagementActivityAPIClient) ListPreparer(ctx context.Context) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		autorest.AsGet(),
		autorest.WithBaseURL(client.BaseURI),
		autorest.WithPathParameters("/subscriptions/{subscriptionId}/providers/Microsoft.M365SecurityAndCompliance/privateLinkServicesForO365ManagementActivityAPI", pathParameters),
		autorest.WithQueryParameters(queryParameters))
	return preparer.Prepare((&http.Request{}).WithContext(ctx))
}
...
func (client PrivateLinkServicesForO365ManagementActivityAPIClient) listNextResults(ctx context.Context, lastResults PrivateLinkServicesForO365ManagementActivityAPIDescriptionListResult) (result PrivateLinkServicesForO365ManagementActivityAPIDescriptionListResult, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "m365securityandcompliance.PrivateLinkServicesForO365ManagementActivityAPIClient", "listNextResults", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "m365securityandcompliance.PrivateLinkServicesForO365ManagementActivityAPIClient", "listNextResults", resp, "Failure sending next results request")
	}
	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "m365securityandcompliance.PrivateLinkServicesForO365ManagementActivityAPIClient", "listNextResults", resp, "Failure responding to next results request")
	}
	return
}
...
func (client PrivateLinkServicesForO365ManagementActivityAPIClient) ListByResourceGroup(ctx context.Context, resourceGroupName string) (result PrivateLinkServicesForO365ManagementActivityAPIDescriptionListResultPage, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewError("m365securityandcompliance.PrivateLinkServicesForO365ManagementActivityAPIClient", "ListByResourceGroup", err.Error())
	}

	result.fn = client.listByResourceGroupNextResults
	req, err := client.ListByResourceGroupPreparer(ctx, resourceGroupName)
	if err != nil {
		err = autorest.NewErrorWithError(err, "m365securityandcompliance.PrivateLinkServicesForO365ManagementActivityAPIClient", "ListByResourceGroup", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.plsfomaadlr.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "m365securityandcompliance.PrivateLinkServicesForO365ManagementActivityAPIClient", "ListByResourceGroup", resp, "Failure sending request")
		return
	}

	result.plsfomaadlr, err = client.ListByResourceGroupResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "m365securityandcompliance.PrivateLinkServicesForO365ManagementActivityAPIClient", "ListByResourceGroup", resp, "Failure responding to request")
		return
	}
	if result.plsfomaadlr.hasNextLink() && result.plsfomaadlr.IsEmpty() {
		err = result.NextWithContext(ctx)
...
func (client PrivateLinkServicesForO365ManagementActivityAPIClient) ListByResourceGroupPreparer(ctx context.Context, resourceGroupName string) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		autorest.AsGet(),
		autorest.WithBaseURL(client.BaseURI),
		autorest.WithPathParameters("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.M365SecurityAndCompliance/privateLinkServicesForO365ManagementActivityAPI", pathParameters),
		autorest.WithQueryParameters(queryParameters))
	return preparer.Prepare((&http.Request{}).WithContext(ctx))
}
...
func (client PrivateLinkServicesForO365ManagementActivityAPIClient) listByResourceGroupNextResults(ctx context.Context, lastResults PrivateLinkServicesForO365ManagementActivityAPIDescriptionListResult) (result PrivateLinkServicesForO365ManagementActivityAPIDescriptionListResult, err error) {
	req, err := lastResults.privateLinkServicesForO365ManagementActivityAPIDescriptionListResultPreparer(ctx)
	if err != nil {
		return result, autorest.NewErrorWithError(err, "m365securityandcompliance.PrivateLinkServicesForO365ManagementActivityAPIClient", "listByResourceGroupNextResults", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "m365securityandcompliance.PrivateLinkServicesForO365ManagementActivityAPIClient", "listByResourceGroupNextResults", resp, "Failure sending next results request")
	}
	result, err = client.ListByResourceGroupResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "m365securityandcompliance.PrivateLinkServicesForO365ManagementActivityAPIClient", "listByResourceGroupNextResults", resp, "Failure responding to next results request")
	}
	return
}
...
func (client PrivateLinkServicesForO365ManagementActivityAPIClient) Update(ctx context.Context, resourceGroupName string, resourceName string, servicePatchDescription ServicesPatchDescription) (result PrivateLinkServicesForO365ManagementActivityAPIUpdateFuture, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		{TargetValue: resourceName,
			Constraints: []validation.Constraint{{Target: "resourceName", Name: validation.MaxLength, Rule: 24, Chain: nil},
				{Target: "resourceName", Name: validation.MinLength, Rule: 3, Chain: nil}}}}); err != nil {
		return result, validation.NewError("m365securityandcompliance.PrivateLinkServicesForO365ManagementActivityAPIClient", "Update", err.Error())
	}

	req, err := client.UpdatePreparer(ctx, resourceGroupName, resourceName, servicePatchDescription)
	if err != nil {
		err = autorest.NewErrorWithError(err, "m365securityandcompliance.PrivateLinkServicesForO365ManagementActivityAPIClient", "Update", nil, "Failure preparing request")
		return
	}

	result, err = client.UpdateSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "m365securityandcompliance.PrivateLinkServicesForO365ManagementActivityAPIClient", "Update", nil, "Failure sending request")
		return
	}
