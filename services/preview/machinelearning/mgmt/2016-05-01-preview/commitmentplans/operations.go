...
// OperationsClient is the these APIs allow end users to operate on Azure Machine Learning Commitment Plans resources
...
func (client OperationsClient) List(ctx context.Context) (result OperationEntityListResult, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "commitmentplans.OperationsClient", "List", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "commitmentplans.OperationsClient", "List", resp, "Failure sending request")
		return
	}

	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "commitmentplans.OperationsClient", "List", resp, "Failure responding to request")
	}
