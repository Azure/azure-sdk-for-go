...
// workspaceName - name of Azure Machine Learning workspace.
// computeName - name of the Azure Machine Learning compute.
func (client ComputeClient) Restart(ctx context.Context, resourceGroupName string, workspaceName string, computeName string) (result autorest.Response, err error) {
	if tracing.IsEnabled() {
	...
	if err != nil {
		result.Response = resp
		err = autorest.NewErrorWithError(err, "machinelearningservices.ComputeClient", "Restart", resp, "Failure sending request")
		return
	}

	result, err = client.RestartResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "machinelearningservices.ComputeClient", "Restart", resp, "Failure responding to request")
		return
	}
...
// http.Response Body if it receives an error.
func (client ComputeClient) RestartSender(req *http.Request) (*http.Response, error) {
	return client.Send(req, azure.DoRetryWithRegistration(client.Client))
}
...
// UpdateSchedules updates schedules of a compute instance
// Parameters:
// resourceGroupName - the name of the resource group. The name is case insensitive.
// workspaceName - name of Azure Machine Learning workspace.
// computeName - name of the Azure Machine Learning compute.
// parameters - the object for updating schedules of specified ComputeInstance.
func (client ComputeClient) UpdateSchedules(ctx context.Context, resourceGroupName string, workspaceName string, computeName string, parameters *ComputeSchedules) (result autorest.Response, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/ComputeClient.UpdateSchedules")
		defer func() {
			sc := -1
			if result.Response != nil {
				sc = result.Response.StatusCode
	...
	if err := validation.Validate([]validation.Validation{
		...
		{TargetValue: resourceGroupName,
			Constraints: []validation.Constraint{{Target: "resourceGroupName", Name: validation.MaxLength, Rule: 90, Chain: nil},
				{Target: "resourceGroupName", Name: validation.MinLength, Rule: 1, Chain: nil}}}}); err != nil {
		return result, validation.NewError("machinelearningservices.ComputeClient", "UpdateSchedules", err.Error())
	}

	req, err := client.UpdateSchedulesPreparer(ctx, resourceGroupName, workspaceName, computeName, parameters)
	if err != nil {
		err = autorest.NewErrorWithError(err, "machinelearningservices.ComputeClient", "UpdateSchedules", nil, "Failure preparing request")
		return
	}

	resp, err := client.UpdateSchedulesSender(req)
	if err != nil {
		result.Response = resp
		err = autorest.NewErrorWithError(err, "machinelearningservices.ComputeClient", "UpdateSchedules", resp, "Failure sending request")
		return
	}

	result, err = client.UpdateSchedulesResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "machinelearningservices.ComputeClient", "UpdateSchedules", resp, "Failure responding to request")
		return
	}
...
// UpdateSchedulesPreparer prepares the UpdateSchedules request.
func (client ComputeClient) UpdateSchedulesPreparer(ctx context.Context, resourceGroupName string, workspaceName string, computeName string, parameters *ComputeSchedules) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"computeName":       autorest.Encode("path", computeName),
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"subscriptionId":    autorest.Encode("path", client.SubscriptionID),
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.AsPost(),
		autorest.WithBaseURL(client.BaseURI),
		autorest.WithPathParameters("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/computes/{computeName}/updateSchedules", pathParameters),
		autorest.WithQueryParameters(queryParameters))
	if parameters != nil {
...
// UpdateSchedulesSender sends the UpdateSchedules request. The method will close the
// http.Response Body if it receives an error.
func (client ComputeClient) UpdateSchedulesSender(req *http.Request) (*http.Response, error) {
	return client.Send(req, azure.DoRetryWithRegistration(client.Client))
}

// UpdateSchedulesResponder handles the response to the UpdateSchedules request. The method always
// closes the http.Response Body.
func (client ComputeClient) UpdateSchedulesResponder(resp *http.Response) (result autorest.Response, err error) {
	err = autorest.Respond(
		resp,
		azure.WithErrorUnlessStatusCode(http.StatusOK),
		autorest.ByClosing())
