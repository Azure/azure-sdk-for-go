...
type AssetReferenceBase struct {
	// ReferenceType - Possible values include: 'ReferenceTypeAssetReferenceBase', 'ReferenceTypeID', 'ReferenceTypeDataPath', 'ReferenceTypeOutputPath'
...
type AutoScaleSettings struct {
	...
	// ScaleType - Possible values include: 'ScaleTypeOnlineScaleSettings', 'ScaleTypeManual', 'ScaleTypeAuto'
...
type ComputeInstanceLastOperation struct {
	// OperationName - Name of the last operation. Possible values include: 'Create', 'Start', 'Stop', 'Restart', 'Reimage', 'Delete'
...
func (future *CreateOrUpdateFuture) result(client Client) (sr ServiceResource, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "machinelearningservices.CreateOrUpdateFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		sr.Response.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("machinelearningservices.CreateOrUpdateFuture")
		return
	}
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if sr.Response.Response, err = future.GetResult(sender); err == nil && sr.Response.Response.StatusCode != http.StatusNoContent {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "machinelearningservices.CreateOrUpdateFuture", "Result", sr.Response.Response, "Failure responding to request")
		}
	}
	return
}
...
type DistributionConfiguration struct {
	// DistributionType - Possible values include: 'DistributionTypeDistributionConfiguration', 'DistributionTypeTensorFlow1', 'DistributionTypeMpi1', 'DistributionTypePyTorch1'
...
type DockerBuild struct {
	...
	// DockerSpecificationType - Possible values include: 'DockerSpecificationTypeDockerSpecification', 'DockerSpecificationTypeImage', 'DockerSpecificationTypeBuild'
