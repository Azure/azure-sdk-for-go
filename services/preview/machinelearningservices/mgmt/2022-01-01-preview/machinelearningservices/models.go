...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/preview/machinelearningservices/mgmt/2022-01-01-preview/machinelearningservices"
...
type AKS struct {
	...
	// ComputeType - Possible values include: 'ComputeTypeCompute', 'ComputeTypeAKS1', 'ComputeTypeAmlCompute1', 'ComputeTypeComputeInstance1', 'ComputeTypeVirtualMachine1', 'ComputeTypeHDInsight1', 'ComputeTypeDataFactory1', 'ComputeTypeDatabricks1', 'ComputeTypeDataLakeAnalytics1', 'ComputeTypeSynapseSpark1'
...
type DiagnoseResult struct {
	...
	// Level - READ-ONLY; Level of workspace setup error. Possible values include: 'Warning', 'Error', 'Information'
...
type EncryptionProperty struct {
	...
	// CosmosDbResourceID - The Bring-Your-Own cosmosdb account that customer brings to store data
	CosmosDbResourceID *string `json:"cosmosDbResourceId,omitempty"`
	// StorageAccountResourceID - The Bring-Your-Own storage account that customer brings to store data
	StorageAccountResourceID *string `json:"storageAccountResourceId,omitempty"`
	// SearchAccountResourceID - The Bring-Your-Own search account that customer brings to store index
...
type WorkspaceProperties struct {
	...
	// SoftDeleteEnabled - create a workspace with soft delete capability. Possible values include: 'SoftDeleteEnabledTrue', 'SoftDeleteEnabledFalse'
	SoftDeleteEnabled SoftDeleteEnabled `json:"softDeleteEnabled,omitempty"`
	// AllowRecoverSoftDeletedWorkspace - Allow a soft deleted workspace to be recovered. Possible values include: 'True', 'False'
	AllowRecoverSoftDeletedWorkspace AllowRecoverSoftDeletedWorkspace `json:"allowRecoverSoftDeletedWorkspace,omitempty"`
...
func (wp WorkspaceProperties) MarshalJSON() ([]byte, error) {
	...
	if wp.SoftDeleteEnabled != "" {
		objectMap["softDeleteEnabled"] = wp.SoftDeleteEnabled
	}
	if wp.AllowRecoverSoftDeletedWorkspace != "" {
		objectMap["allowRecoverSoftDeletedWorkspace"] = wp.AllowRecoverSoftDeletedWorkspace
	}
