...
// deploymentName - the identifier for the Batch inference deployment.
// body - batch inference deployment definition object.
func (client BatchDeploymentsClient) Update(ctx context.Context, resourceGroupName string, workspaceName string, endpointName string, deploymentName string, body PartialBatchDeploymentPartialTrackedResource) (result BatchDeploymentsUpdateFuture, err error) {
	if tracing.IsEnabled() {
...
func (client BatchDeploymentsClient) UpdatePreparer(ctx context.Context, resourceGroupName string, workspaceName string, endpointName string, deploymentName string, body PartialBatchDeploymentPartialTrackedResource) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"deploymentName":    autorest.Encode("path", deploymentName),
		"endpointName":      autorest.Encode("path", endpointName),
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
