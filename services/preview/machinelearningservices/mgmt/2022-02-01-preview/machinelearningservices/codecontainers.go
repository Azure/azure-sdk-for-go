...
func (client CodeContainersClient) CreateOrUpdate(ctx context.Context, resourceGroupName string, workspaceName string, name string, body CodeContainerResource) (result CodeContainerResource, err error) {
...
func (client CodeContainersClient) CreateOrUpdatePreparer(ctx context.Context, resourceGroupName string, workspaceName string, name string, body CodeContainerResource) (*http.Request, error) {
...
// workspaceName - name of Azure Machine Learning workspace.
// name - container name. This is case-sensitive.
func (client CodeContainersClient) Delete(ctx context.Context, resourceGroupName string, workspaceName string, name string) (result autorest.Response, err error) {
	if tracing.IsEnabled() {
...
func (client CodeContainersClient) DeletePreparer(ctx context.Context, resourceGroupName string, workspaceName string, name string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"name":              autorest.Encode("path", name),
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"subscriptionId":    autorest.Encode("path", client.SubscriptionID),
...
// workspaceName - name of Azure Machine Learning workspace.
// name - container name. This is case-sensitive.
func (client CodeContainersClient) Get(ctx context.Context, resourceGroupName string, workspaceName string, name string) (result CodeContainerResource, err error) {
	if tracing.IsEnabled() {
...
func (client CodeContainersClient) GetPreparer(ctx context.Context, resourceGroupName string, workspaceName string, name string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"name":              autorest.Encode("path", name),
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"subscriptionId":    autorest.Encode("path", client.SubscriptionID),
