...
func (client JobsClient) Cancel(ctx context.Context, resourceGroupName string, workspaceName string, ID string) (result autorest.Response, err error) {
...
func (client JobsClient) List(ctx context.Context, resourceGroupName string, workspaceName string, skip string, jobType string, tag string, listViewType ListViewType, scheduled *bool, scheduleID string) (result JobBaseResourceArmPaginatedResultPage, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.ListPreparer(ctx, resourceGroupName, workspaceName, skip, jobType, tag, listViewType, scheduled, scheduleID)
	if err != nil {
...
func (client JobsClient) ListPreparer(ctx context.Context, resourceGroupName string, workspaceName string, skip string, jobType string, tag string, listViewType ListViewType, scheduled *bool, scheduleID string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"subscriptionId":    autorest.Encode("path", client.SubscriptionID),
		"workspaceName":     autorest.Encode("path", workspaceName),
	...
	if scheduled != nil {
		queryParameters["scheduled"] = autorest.Encode("query", *scheduled)
	}
	if len(scheduleID) > 0 {
		queryParameters["scheduleId"] = autorest.Encode("query", scheduleID)
	}
...
func (client JobsClient) ListComplete(ctx context.Context, resourceGroupName string, workspaceName string, skip string, jobType string, tag string, listViewType ListViewType, scheduled *bool, scheduleID string) (result JobBaseResourceArmPaginatedResultIterator, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/JobsClient.List")
		defer func() {
			sc := -1
	...
	result.page, err = client.List(ctx, resourceGroupName, workspaceName, skip, jobType, tag, listViewType, scheduled, scheduleID)
	return
}
