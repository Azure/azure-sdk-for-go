...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/preview/machinelearningservices/mgmt/2022-02-01-preview/machinelearningservices"
...
type AccountKeyDatastoreSecrets struct {
	...
	// SecretsType - Possible values include: 'SecretsTypeDatastoreSecrets', 'SecretsTypeAccountKey', 'SecretsTypeCertificate', 'SecretsTypeKerberosKeytab', 'SecretsTypeKerberosPassword', 'SecretsTypeSas', 'SecretsTypeServicePrincipal'
...
// AsKerberosKeytabSecrets is the BasicDatastoreSecrets implementation for AccountKeyDatastoreSecrets.
func (akds AccountKeyDatastoreSecrets) AsKerberosKeytabSecrets() (*KerberosKeytabSecrets, bool) {
	return nil, false
}

// AsKerberosPasswordSecrets is the BasicDatastoreSecrets implementation for AccountKeyDatastoreSecrets.
func (akds AccountKeyDatastoreSecrets) AsKerberosPasswordSecrets() (*KerberosPasswordSecrets, bool) {
	return nil, false
}
...
type AmlComputeProperties struct {
	...
	PropertyBag map[string]interface{} `json:"propertyBag"`
}
...
type AutoForecastHorizon struct {
	// Mode - Possible values include: 'ModeBasicForecastHorizonModeForecastHorizon', 'ModeBasicForecastHorizonModeAuto', 'ModeBasicForecastHorizonModeCustom'
	Mode ModeBasicForecastHorizon `json:"mode,omitempty"`
}

// MarshalJSON is the custom marshaler for AutoForecastHorizon.
func (afh AutoForecastHorizon) MarshalJSON() ([]byte, error) {
	afh.Mode = ModeBasicForecastHorizonModeAuto
	objectMap := make(map[string]interface{})
	if afh.Mode != "" {
		objectMap["mode"] = afh.Mode
	}
	return json.Marshal(objectMap)
}

// AsAutoForecastHorizon is the BasicForecastHorizon implementation for AutoForecastHorizon.
func (afh AutoForecastHorizon) AsAutoForecastHorizon() (*AutoForecastHorizon, bool) {
	return &afh, true
}

// AsCustomForecastHorizon is the BasicForecastHorizon implementation for AutoForecastHorizon.
func (afh AutoForecastHorizon) AsCustomForecastHorizon() (*CustomForecastHorizon, bool) {
	return nil, false
}

// AsForecastHorizon is the BasicForecastHorizon implementation for AutoForecastHorizon.
func (afh AutoForecastHorizon) AsForecastHorizon() (*ForecastHorizon, bool) {
	return nil, false
}

// AsBasicForecastHorizon is the BasicForecastHorizon implementation for AutoForecastHorizon.
func (afh AutoForecastHorizon) AsBasicForecastHorizon() (BasicForecastHorizon, bool) {
	return &afh, true
}
...
type AutoMLJob struct {
	...
	TaskDetails BasicAutoMLVertical `json:"taskDetails,omitempty"`
	...
	// IsArchived - Is the asset archived?
	IsArchived *bool `json:"isArchived,omitempty"`
	// Schedule - Schedule definition of job.
	// If no schedule is provided, the job is run once and immediately after submission.
	Schedule BasicScheduleBase `json:"schedule,omitempty"`
	// Services - List of JobEndpoints.
	// For local jobs, a job endpoint will have an endpoint value of FileStreamObject.
	Services map[string]*JobService `json:"services"`
	// Status - READ-ONLY; Status of the job. Possible values include: 'JobStatusNotStarted', 'JobStatusStarting', 'JobStatusProvisioning', 'JobStatusPreparing', 'JobStatusQueued', 'JobStatusRunning', 'JobStatusFinalizing', 'JobStatusCancelRequested', 'JobStatusCompleted', 'JobStatusFailed', 'JobStatusCanceled', 'JobStatusNotResponding', 'JobStatusPaused', 'JobStatusUnknown', 'JobStatusScheduled'
	...
	// Tags - Tag dictionary. Tags can be added, removed, and updated.
	Tags map[string]*string `json:"tags"`
	// JobType - Possible values include: 'JobTypeJobBase', 'JobTypeAutoML1', 'JobTypeCommand1', 'JobTypePipeline1', 'JobTypeSweep1'
	JobType JobTypeBasicJobBase `json:"jobType,omitempty"`
}

// MarshalJSON is the custom marshaler for AutoMLJob.
func (amj AutoMLJob) MarshalJSON() ([]byte, error) {
	amj.JobType = JobTypeAutoML1
	objectMap := make(map[string]interface{})
	if amj.EnvironmentID != nil {
		objectMap["environmentId"] = amj.EnvironmentID
	}
	if amj.EnvironmentVariables != nil {
		objectMap["environmentVariables"] = amj.EnvironmentVariables
	}
	if amj.Outputs != nil {
		objectMap["outputs"] = amj.Outputs
	}
	if amj.Resources != nil {
		objectMap["resources"] = amj.Resources
	}
	objectMap["taskDetails"] = amj.TaskDetails
	if amj.ComputeID != nil {
		objectMap["computeId"] = amj.ComputeID
	}
	if amj.DisplayName != nil {
		objectMap["displayName"] = amj.DisplayName
	}
	if amj.ExperimentName != nil {
		objectMap["experimentName"] = amj.ExperimentName
	}
	objectMap["identity"] = amj.Identity
	if amj.IsArchived != nil {
		objectMap["isArchived"] = amj.IsArchived
	}
	objectMap["schedule"] = amj.Schedule
	if amj.Services != nil {
		objectMap["services"] = amj.Services
	}
	if amj.JobType != "" {
		objectMap["jobType"] = amj.JobType
	}
	if amj.Description != nil {
		objectMap["description"] = amj.Description
	}
	if amj.Properties != nil {
		objectMap["properties"] = amj.Properties
	}
	if amj.Tags != nil {
		objectMap["tags"] = amj.Tags
	}
	return json.Marshal(objectMap)
}

// AsAutoMLJob is the BasicJobBase implementation for AutoMLJob.
func (amj AutoMLJob) AsAutoMLJob() (*AutoMLJob, bool) {
	return &amj, true
}

// AsCommandJob is the BasicJobBase implementation for AutoMLJob.
func (amj AutoMLJob) AsCommandJob() (*CommandJob, bool) {
	return nil, false
}

// AsPipelineJob is the BasicJobBase implementation for AutoMLJob.
func (amj AutoMLJob) AsPipelineJob() (*PipelineJob, bool) {
	return nil, false
}

// AsSweepJob is the BasicJobBase implementation for AutoMLJob.
func (amj AutoMLJob) AsSweepJob() (*SweepJob, bool) {
	return nil, false
}

// AsJobBase is the BasicJobBase implementation for AutoMLJob.
func (amj AutoMLJob) AsJobBase() (*JobBase, bool) {
	return nil, false
}

// AsBasicJobBase is the BasicJobBase implementation for AutoMLJob.
func (amj AutoMLJob) AsBasicJobBase() (BasicJobBase, bool) {
	return &amj, true
}

// UnmarshalJSON is the custom unmarshaler for AutoMLJob struct.
func (amj *AutoMLJob) UnmarshalJSON(body []byte) error {
	...
	for k, v := range m {
		...
		case "environmentId":
			if v != nil {
				...
				amj.EnvironmentID = &environmentID
			}
		case "environmentVariables":
			if v != nil {
				...
				amj.EnvironmentVariables = environmentVariables
			}
		case "outputs":
			if v != nil {
		...
		case "resources":
			if v != nil {
				...
				amj.Resources = &resources
			}
		case "taskDetails":
			if v != nil {
				taskDetails, err := unmarshalBasicAutoMLVertical(*v)
				if err != nil {
					return err
				}
				amj.TaskDetails = taskDetails
			}
		case "computeId":
			if v != nil {
		...
		case "experimentName":
			if v != nil {
				...
				amj.ExperimentName = &experimentName
			}
		case "identity":
			if v != nil {
		...
		case "isArchived":
			if v != nil {
				...
				amj.IsArchived = &isArchived
			}
		case "schedule":
			if v != nil {
				schedule, err := unmarshalBasicScheduleBase(*v)
				if err != nil {
					return err
				}
				amj.Schedule = schedule
			}
		case "services":
			if v != nil {
...
// BasicAutoMLVertical autoML vertical class.
// Base class for AutoML verticals - TableVertical/ImageVertical/NLPVertical
type BasicAutoMLVertical interface {
	AsAutoMLVertical() (*AutoMLVertical, bool)
}

// AutoMLVertical autoML vertical class.
// Base class for AutoML verticals - TableVertical/ImageVertical/NLPVertical
type AutoMLVertical struct {
	// LogVerbosity - Log verbosity for the job. Possible values include: 'LogVerbosityNotSet', 'LogVerbosityDebug', 'LogVerbosityInfo', 'LogVerbosityWarning', 'LogVerbosityError', 'LogVerbosityCritical'
	LogVerbosity LogVerbosity `json:"logVerbosity,omitempty"`
	// TaskType - Possible values include: 'TaskTypeAutoMLVertical'
	TaskType TaskTypeBasicAutoMLVertical `json:"taskType,omitempty"`
}

func unmarshalBasicAutoMLVertical(body []byte) (BasicAutoMLVertical, error) {
	var m map[string]interface{}
	err := json.Unmarshal(body, &m)
	if err != nil {
		return nil, err
	...
	switch m["taskType"] {
	default:
		var amv AutoMLVertical
		err := json.Unmarshal(body, &amv)
		return amv, err
	}
}
func unmarshalBasicAutoMLVerticalArray(body []byte) ([]BasicAutoMLVertical, error) {
	var rawMessages []*json.RawMessage
	err := json.Unmarshal(body, &rawMessages)
	if err != nil {
		return nil, err
	...
	amvArray := make([]BasicAutoMLVertical, len(rawMessages))
...
// MarshalJSON is the custom marshaler for AutoMLVertical.
func (amv AutoMLVertical) MarshalJSON() ([]byte, error) {
	amv.TaskType = TaskTypeAutoMLVertical
	objectMap := make(map[string]interface{})
	if amv.LogVerbosity != "" {
		objectMap["logVerbosity"] = amv.LogVerbosity
	}
	if amv.TaskType != "" {
		objectMap["taskType"] = amv.TaskType
	}
	return json.Marshal(objectMap)
}

// AsAutoMLVertical is the BasicAutoMLVertical implementation for AutoMLVertical.
func (amv AutoMLVertical) AsAutoMLVertical() (*AutoMLVertical, bool) {
	return &amv, true
}

// AsBasicAutoMLVertical is the BasicAutoMLVertical implementation for AutoMLVertical.
func (amv AutoMLVertical) AsBasicAutoMLVertical() (BasicAutoMLVertical, bool) {
	return &amv, true
}

// AutoNCrossValidations n-Cross validations determined automatically.
type AutoNCrossValidations struct {
	// Mode - Possible values include: 'ModeNCrossValidations', 'ModeAuto', 'ModeCustom'
	Mode Mode `json:"mode,omitempty"`
}

// MarshalJSON is the custom marshaler for AutoNCrossValidations.
func (ancv AutoNCrossValidations) MarshalJSON() ([]byte, error) {
	ancv.Mode = ModeAuto
	objectMap := make(map[string]interface{})
	if ancv.Mode != "" {
		objectMap["mode"] = ancv.Mode
	}
	return json.Marshal(objectMap)
}

// AsAutoNCrossValidations is the BasicNCrossValidations implementation for AutoNCrossValidations.
func (ancv AutoNCrossValidations) AsAutoNCrossValidations() (*AutoNCrossValidations, bool) {
	return &ancv, true
}

// AsCustomNCrossValidations is the BasicNCrossValidations implementation for AutoNCrossValidations.
func (ancv AutoNCrossValidations) AsCustomNCrossValidations() (*CustomNCrossValidations, bool) {
	return nil, false
}

// AsNCrossValidations is the BasicNCrossValidations implementation for AutoNCrossValidations.
func (ancv AutoNCrossValidations) AsNCrossValidations() (*NCrossValidations, bool) {
	return nil, false
}

// AsBasicNCrossValidations is the BasicNCrossValidations implementation for AutoNCrossValidations.
func (ancv AutoNCrossValidations) AsBasicNCrossValidations() (BasicNCrossValidations, bool) {
	return &ancv, true
}
...
type AutoSeasonality struct {
	// Mode - Possible values include: 'ModeBasicSeasonalityModeSeasonality', 'ModeBasicSeasonalityModeAuto', 'ModeBasicSeasonalityModeCustom'
	Mode ModeBasicSeasonality `json:"mode,omitempty"`
}

// MarshalJSON is the custom marshaler for AutoSeasonality.
func (as AutoSeasonality) MarshalJSON() ([]byte, error) {
	as.Mode = ModeBasicSeasonalityModeAuto
	objectMap := make(map[string]interface{})
	if as.Mode != "" {
		objectMap["mode"] = as.Mode
	}
	return json.Marshal(objectMap)
}

// AsAutoSeasonality is the BasicSeasonality implementation for AutoSeasonality.
func (as AutoSeasonality) AsAutoSeasonality() (*AutoSeasonality, bool) {
	return &as, true
}

// AsCustomSeasonality is the BasicSeasonality implementation for AutoSeasonality.
func (as AutoSeasonality) AsCustomSeasonality() (*CustomSeasonality, bool) {
	return nil, false
}

// AsSeasonality is the BasicSeasonality implementation for AutoSeasonality.
func (as AutoSeasonality) AsSeasonality() (*Seasonality, bool) {
	return nil, false
}

// AsBasicSeasonality is the BasicSeasonality implementation for AutoSeasonality.
func (as AutoSeasonality) AsBasicSeasonality() (BasicSeasonality, bool) {
	return &as, true
}

// AutoTargetLags ...
type AutoTargetLags struct {
	// Mode - Possible values include: 'ModeBasicTargetLagsModeTargetLags', 'ModeBasicTargetLagsModeAuto', 'ModeBasicTargetLagsModeCustom'
	Mode ModeBasicTargetLags `json:"mode,omitempty"`
}

// MarshalJSON is the custom marshaler for AutoTargetLags.
func (atl AutoTargetLags) MarshalJSON() ([]byte, error) {
	atl.Mode = ModeBasicTargetLagsModeAuto
	objectMap := make(map[string]interface{})
	if atl.Mode != "" {
		objectMap["mode"] = atl.Mode
	}
	return json.Marshal(objectMap)
}

// AsAutoTargetLags is the BasicTargetLags implementation for AutoTargetLags.
func (atl AutoTargetLags) AsAutoTargetLags() (*AutoTargetLags, bool) {
	return &atl, true
}

// AsCustomTargetLags is the BasicTargetLags implementation for AutoTargetLags.
func (atl AutoTargetLags) AsCustomTargetLags() (*CustomTargetLags, bool) {
	return nil, false
}

// AsTargetLags is the BasicTargetLags implementation for AutoTargetLags.
func (atl AutoTargetLags) AsTargetLags() (*TargetLags, bool) {
	return nil, false
}

// AsBasicTargetLags is the BasicTargetLags implementation for AutoTargetLags.
func (atl AutoTargetLags) AsBasicTargetLags() (BasicTargetLags, bool) {
	return &atl, true
}

// AutoTargetRollingWindowSize target lags rolling window determined automatically.
type AutoTargetRollingWindowSize struct {
	// Mode - Possible values include: 'ModeBasicTargetRollingWindowSizeModeTargetRollingWindowSize', 'ModeBasicTargetRollingWindowSizeModeAuto', 'ModeBasicTargetRollingWindowSizeModeCustom'
	Mode ModeBasicTargetRollingWindowSize `json:"mode,omitempty"`
}

// MarshalJSON is the custom marshaler for AutoTargetRollingWindowSize.
func (atrws AutoTargetRollingWindowSize) MarshalJSON() ([]byte, error) {
	atrws.Mode = ModeBasicTargetRollingWindowSizeModeAuto
	objectMap := make(map[string]interface{})
	if atrws.Mode != "" {
		objectMap["mode"] = atrws.Mode
	}
	return json.Marshal(objectMap)
}

// AsAutoTargetRollingWindowSize is the BasicTargetRollingWindowSize implementation for AutoTargetRollingWindowSize.
func (atrws AutoTargetRollingWindowSize) AsAutoTargetRollingWindowSize() (*AutoTargetRollingWindowSize, bool) {
	return &atrws, true
}

// AsCustomTargetRollingWindowSize is the BasicTargetRollingWindowSize implementation for AutoTargetRollingWindowSize.
func (atrws AutoTargetRollingWindowSize) AsCustomTargetRollingWindowSize() (*CustomTargetRollingWindowSize, bool) {
	return nil, false
}

// AsTargetRollingWindowSize is the BasicTargetRollingWindowSize implementation for AutoTargetRollingWindowSize.
func (atrws AutoTargetRollingWindowSize) AsTargetRollingWindowSize() (*TargetRollingWindowSize, bool) {
	return nil, false
}

// AsBasicTargetRollingWindowSize is the BasicTargetRollingWindowSize implementation for AutoTargetRollingWindowSize.
func (atrws AutoTargetRollingWindowSize) AsBasicTargetRollingWindowSize() (BasicTargetRollingWindowSize, bool) {
	return &atrws, true
}
...
type AzureBlobDatastore struct {
	...
	// Tags - Tag dictionary. Tags can be added, removed, and updated.
	Tags map[string]*string `json:"tags"`
	// DatastoreType - Possible values include: 'DatastoreTypeDatastore', 'DatastoreTypeAzureBlob', 'DatastoreTypeAzureDataLakeGen1', 'DatastoreTypeAzureDataLakeGen2', 'DatastoreTypeAzureFile', 'DatastoreTypeHdfs'
...
// AsHdfsDatastore is the BasicDatastore implementation for AzureBlobDatastore.
func (abd AzureBlobDatastore) AsHdfsDatastore() (*HdfsDatastore, bool) {
	return nil, false
}
...
// AsHdfsDatastore is the BasicDatastore implementation for AzureDataLakeGen1Datastore.
func (adlg1d AzureDataLakeGen1Datastore) AsHdfsDatastore() (*HdfsDatastore, bool) {
	return nil, false
}
...
// AsHdfsDatastore is the BasicDatastore implementation for AzureDataLakeGen2Datastore.
func (adlg2d AzureDataLakeGen2Datastore) AsHdfsDatastore() (*HdfsDatastore, bool) {
	return nil, false
}
...
type AzureFileDatastore struct {
	...
	// Endpoint - Azure cloud endpoint for the storage account.
	Endpoint *string `json:"endpoint,omitempty"`
	// FileShareName - [Required] TODO - File share name.
...
// AsHdfsDatastore is the BasicDatastore implementation for AzureFileDatastore.
func (afd AzureFileDatastore) AsHdfsDatastore() (*HdfsDatastore, bool) {
	return nil, false
}
...
// AsKerberosKeytabSecrets is the BasicDatastoreSecrets implementation for CertificateDatastoreSecrets.
func (cds CertificateDatastoreSecrets) AsKerberosKeytabSecrets() (*KerberosKeytabSecrets, bool) {
	return nil, false
}

// AsKerberosPasswordSecrets is the BasicDatastoreSecrets implementation for CertificateDatastoreSecrets.
func (cds CertificateDatastoreSecrets) AsKerberosPasswordSecrets() (*KerberosPasswordSecrets, bool) {
	return nil, false
}
...
// Classification classification task in AutoML Table vertical.
type Classification struct {
	// DataSettings - Data inputs for AutoMLJob.
	...
	// AllowedModels - Allowed models for classification task.
	AllowedModels *[]ClassificationModels `json:"allowedModels,omitempty"`
	// BlockedModels - Blocked models for classification task.
	BlockedModels *[]ClassificationModels `json:"blockedModels,omitempty"`
	// PrimaryMetric - Primary metric for the task. Possible values include: 'ClassificationPrimaryMetricsAUCWeighted', 'ClassificationPrimaryMetricsAccuracy', 'ClassificationPrimaryMetricsNormMacroRecall', 'ClassificationPrimaryMetricsAveragePrecisionScoreWeighted', 'ClassificationPrimaryMetricsPrecisionScoreWeighted'
...
func (cj CommandJob) MarshalJSON() ([]byte, error) {
	...
	objectMap["schedule"] = cj.Schedule
	if cj.Services != nil {
...
// AsAutoMLJob is the BasicJobBase implementation for CommandJob.
func (cj CommandJob) AsAutoMLJob() (*AutoMLJob, bool) {
	return nil, false
}
...
// UnmarshalJSON is the custom unmarshaler for ComputeStartStopSchedule struct.
func (csss *ComputeStartStopSchedule) UnmarshalJSON(body []byte) error {
	var m map[string]*json.RawMessage
	err := json.Unmarshal(body, &m)
	if err != nil {
		return err
	...
	for k, v := range m {
		...
		case "provisioningStatus":
			if v != nil {
				var provisioningStatus ProvisioningStatus
				err = json.Unmarshal(*v, &provisioningStatus)
				if err != nil {
					return err
				}
				csss.ProvisioningStatus = provisioningStatus
			}
		case "action":
			if v != nil {
				var action ComputePowerAction
...
type CronSchedule struct {
	...
	// EndTime - Specifies end time of schedule in ISO 8601 format.
	// If not present, the schedule will run indefinitely
	EndTime *date.Time `json:"endTime,omitempty"`
	// ScheduleStatus - Specifies the schedule's status. Possible values include: 'ScheduleStatusEnabled', 'ScheduleStatusDisabled'
	ScheduleStatus ScheduleStatus `json:"scheduleStatus,omitempty"`
	// StartTime - Specifies start time of schedule in ISO 8601 format.
	StartTime *date.Time `json:"startTime,omitempty"`
	// TimeZone - Specifies time zone in which the schedule runs.
	// TimeZone should follow Windows time zone format.
	TimeZone *string `json:"timeZone,omitempty"`
	// ScheduleType - Possible values include: 'ScheduleTypeScheduleBase', 'ScheduleTypeRecurrence', 'ScheduleTypeCron'
	ScheduleType ScheduleTypeBasicScheduleBase `json:"scheduleType,omitempty"`
}

// MarshalJSON is the custom marshaler for CronSchedule.
func (cs CronSchedule) MarshalJSON() ([]byte, error) {
	cs.ScheduleType = ScheduleTypeCron
	objectMap := make(map[string]interface{})
	if cs.Expression != nil {
		objectMap["expression"] = cs.Expression
	}
	if cs.EndTime != nil {
		objectMap["endTime"] = cs.EndTime
	}
	if cs.ScheduleStatus != "" {
		objectMap["scheduleStatus"] = cs.ScheduleStatus
	}
	if cs.StartTime != nil {
		objectMap["startTime"] = cs.StartTime
	}
	if cs.TimeZone != nil {
		objectMap["timeZone"] = cs.TimeZone
	}
	if cs.ScheduleType != "" {
		objectMap["scheduleType"] = cs.ScheduleType
	}
	return json.Marshal(objectMap)
}

// AsRecurrenceSchedule is the BasicScheduleBase implementation for CronSchedule.
func (cs CronSchedule) AsRecurrenceSchedule() (*RecurrenceSchedule, bool) {
	return nil, false
}

// AsCronSchedule is the BasicScheduleBase implementation for CronSchedule.
func (cs CronSchedule) AsCronSchedule() (*CronSchedule, bool) {
	return &cs, true
}

// AsScheduleBase is the BasicScheduleBase implementation for CronSchedule.
func (cs CronSchedule) AsScheduleBase() (*ScheduleBase, bool) {
	return nil, false
}

// AsBasicScheduleBase is the BasicScheduleBase implementation for CronSchedule.
func (cs CronSchedule) AsBasicScheduleBase() (BasicScheduleBase, bool) {
	return &cs, true
}
...
// MarshalJSON is the custom marshaler for CustomForecastHorizon.
func (cfh CustomForecastHorizon) MarshalJSON() ([]byte, error) {
	cfh.Mode = ModeBasicForecastHorizonModeCustom
	objectMap := make(map[string]interface{})
	if cfh.Value != nil {
		objectMap["value"] = cfh.Value
	}
	if cfh.Mode != "" {
		objectMap["mode"] = cfh.Mode
	}
	return json.Marshal(objectMap)
}

// AsAutoForecastHorizon is the BasicForecastHorizon implementation for CustomForecastHorizon.
func (cfh CustomForecastHorizon) AsAutoForecastHorizon() (*AutoForecastHorizon, bool) {
	return nil, false
}

// AsCustomForecastHorizon is the BasicForecastHorizon implementation for CustomForecastHorizon.
func (cfh CustomForecastHorizon) AsCustomForecastHorizon() (*CustomForecastHorizon, bool) {
	return &cfh, true
}

// AsForecastHorizon is the BasicForecastHorizon implementation for CustomForecastHorizon.
func (cfh CustomForecastHorizon) AsForecastHorizon() (*ForecastHorizon, bool) {
	return nil, false
}

// AsBasicForecastHorizon is the BasicForecastHorizon implementation for CustomForecastHorizon.
func (cfh CustomForecastHorizon) AsBasicForecastHorizon() (BasicForecastHorizon, bool) {
	return &cfh, true
}
...
// MarshalJSON is the custom marshaler for CustomNCrossValidations.
func (cncv CustomNCrossValidations) MarshalJSON() ([]byte, error) {
	cncv.Mode = ModeCustom
	objectMap := make(map[string]interface{})
	if cncv.Value != nil {
		objectMap["value"] = cncv.Value
	}
	if cncv.Mode != "" {
		objectMap["mode"] = cncv.Mode
	}
	return json.Marshal(objectMap)
}

// AsAutoNCrossValidations is the BasicNCrossValidations implementation for CustomNCrossValidations.
func (cncv CustomNCrossValidations) AsAutoNCrossValidations() (*AutoNCrossValidations, bool) {
	return nil, false
}

// AsCustomNCrossValidations is the BasicNCrossValidations implementation for CustomNCrossValidations.
func (cncv CustomNCrossValidations) AsCustomNCrossValidations() (*CustomNCrossValidations, bool) {
	return &cncv, true
}

// AsNCrossValidations is the BasicNCrossValidations implementation for CustomNCrossValidations.
func (cncv CustomNCrossValidations) AsNCrossValidations() (*NCrossValidations, bool) {
	return nil, false
}

// AsBasicNCrossValidations is the BasicNCrossValidations implementation for CustomNCrossValidations.
func (cncv CustomNCrossValidations) AsBasicNCrossValidations() (BasicNCrossValidations, bool) {
	return &cncv, true
}
...
// MarshalJSON is the custom marshaler for CustomSeasonality.
func (cs CustomSeasonality) MarshalJSON() ([]byte, error) {
	cs.Mode = ModeBasicSeasonalityModeCustom
	objectMap := make(map[string]interface{})
	if cs.Value != nil {
		objectMap["value"] = cs.Value
	}
	if cs.Mode != "" {
		objectMap["mode"] = cs.Mode
	}
	return json.Marshal(objectMap)
}

// AsAutoSeasonality is the BasicSeasonality implementation for CustomSeasonality.
func (cs CustomSeasonality) AsAutoSeasonality() (*AutoSeasonality, bool) {
	return nil, false
}

// AsCustomSeasonality is the BasicSeasonality implementation for CustomSeasonality.
func (cs CustomSeasonality) AsCustomSeasonality() (*CustomSeasonality, bool) {
	return &cs, true
}

// AsSeasonality is the BasicSeasonality implementation for CustomSeasonality.
func (cs CustomSeasonality) AsSeasonality() (*Seasonality, bool) {
	return nil, false
}

// AsBasicSeasonality is the BasicSeasonality implementation for CustomSeasonality.
func (cs CustomSeasonality) AsBasicSeasonality() (BasicSeasonality, bool) {
	return &cs, true
}
...
// MarshalJSON is the custom marshaler for CustomTargetLags.
func (ctl CustomTargetLags) MarshalJSON() ([]byte, error) {
	ctl.Mode = ModeBasicTargetLagsModeCustom
	objectMap := make(map[string]interface{})
	if ctl.Values != nil {
		objectMap["values"] = ctl.Values
	}
	if ctl.Mode != "" {
		objectMap["mode"] = ctl.Mode
	}
	return json.Marshal(objectMap)
}

// AsAutoTargetLags is the BasicTargetLags implementation for CustomTargetLags.
func (ctl CustomTargetLags) AsAutoTargetLags() (*AutoTargetLags, bool) {
	return nil, false
}

// AsCustomTargetLags is the BasicTargetLags implementation for CustomTargetLags.
func (ctl CustomTargetLags) AsCustomTargetLags() (*CustomTargetLags, bool) {
	return &ctl, true
}

// AsTargetLags is the BasicTargetLags implementation for CustomTargetLags.
func (ctl CustomTargetLags) AsTargetLags() (*TargetLags, bool) {
	return nil, false
}

// AsBasicTargetLags is the BasicTargetLags implementation for CustomTargetLags.
func (ctl CustomTargetLags) AsBasicTargetLags() (BasicTargetLags, bool) {
	return &ctl, true
}
...
// MarshalJSON is the custom marshaler for CustomTargetRollingWindowSize.
func (ctrws CustomTargetRollingWindowSize) MarshalJSON() ([]byte, error) {
	ctrws.Mode = ModeBasicTargetRollingWindowSizeModeCustom
	objectMap := make(map[string]interface{})
	if ctrws.Value != nil {
		objectMap["value"] = ctrws.Value
	}
	if ctrws.Mode != "" {
		objectMap["mode"] = ctrws.Mode
	}
	return json.Marshal(objectMap)
}

// AsAutoTargetRollingWindowSize is the BasicTargetRollingWindowSize implementation for CustomTargetRollingWindowSize.
func (ctrws CustomTargetRollingWindowSize) AsAutoTargetRollingWindowSize() (*AutoTargetRollingWindowSize, bool) {
	return nil, false
}

// AsCustomTargetRollingWindowSize is the BasicTargetRollingWindowSize implementation for CustomTargetRollingWindowSize.
func (ctrws CustomTargetRollingWindowSize) AsCustomTargetRollingWindowSize() (*CustomTargetRollingWindowSize, bool) {
	return &ctrws, true
}

// AsTargetRollingWindowSize is the BasicTargetRollingWindowSize implementation for CustomTargetRollingWindowSize.
func (ctrws CustomTargetRollingWindowSize) AsTargetRollingWindowSize() (*TargetRollingWindowSize, bool) {
	return nil, false
}

// AsBasicTargetRollingWindowSize is the BasicTargetRollingWindowSize implementation for CustomTargetRollingWindowSize.
func (ctrws CustomTargetRollingWindowSize) AsBasicTargetRollingWindowSize() (BasicTargetRollingWindowSize, bool) {
	return &ctrws, true
}
...
// DataSettings collection of registered Tabular Dataset Ids and other data settings required for training
// and validating models.
type DataSettings struct {
	// TargetColumnName - [Required] Target column name: This is prediction values column.
...
type BasicDatastore interface {
	...
	AsHdfsDatastore() (*HdfsDatastore, bool)
...
// AsHdfsDatastore is the BasicDatastore implementation for Datastore.
func (d Datastore) AsHdfsDatastore() (*HdfsDatastore, bool) {
	return nil, false
}
...
type BasicDatastoreSecrets interface {
	...
	AsKerberosKeytabSecrets() (*KerberosKeytabSecrets, bool)
	AsKerberosPasswordSecrets() (*KerberosPasswordSecrets, bool)
...
func unmarshalBasicDatastoreSecrets(body []byte) (BasicDatastoreSecrets, error) {
	...
	case string(SecretsTypeKerberosKeytab):
		var kks KerberosKeytabSecrets
		err := json.Unmarshal(body, &kks)
		return kks, err
	case string(SecretsTypeKerberosPassword):
		var kps KerberosPasswordSecrets
		err := json.Unmarshal(body, &kps)
		return kps, err
...
// AsKerberosKeytabSecrets is the BasicDatastoreSecrets implementation for DatastoreSecrets.
func (ds DatastoreSecrets) AsKerberosKeytabSecrets() (*KerberosKeytabSecrets, bool) {
	return nil, false
}

// AsKerberosPasswordSecrets is the BasicDatastoreSecrets implementation for DatastoreSecrets.
func (ds DatastoreSecrets) AsKerberosPasswordSecrets() (*KerberosPasswordSecrets, bool) {
	return nil, false
}
...
type DataVersionBase struct {
	// DataURI - [Required] Uri of the data. Usage/meaning depends on Microsoft.MachineLearning.ManagementFrontEnd.Contracts.V20220201Preview.Assets.DataVersionBase.DataType
...
// BasicForecastHorizon the desired maximum forecast horizon in units of time-series frequency.
type BasicForecastHorizon interface {
	AsAutoForecastHorizon() (*AutoForecastHorizon, bool)
	AsCustomForecastHorizon() (*CustomForecastHorizon, bool)
	AsForecastHorizon() (*ForecastHorizon, bool)
}
...
func unmarshalBasicForecastHorizon(body []byte) (BasicForecastHorizon, error) {
	var m map[string]interface{}
	err := json.Unmarshal(body, &m)
	if err != nil {
		return nil, err
	...
	switch m["mode"] {
	case string(ModeBasicForecastHorizonModeAuto):
		var afh AutoForecastHorizon
		err := json.Unmarshal(body, &afh)
		return afh, err
	case string(ModeBasicForecastHorizonModeCustom):
		var cfh CustomForecastHorizon
		err := json.Unmarshal(body, &cfh)
		return cfh, err
	default:
		var fh ForecastHorizon
		err := json.Unmarshal(body, &fh)
		return fh, err
	}
}
func unmarshalBasicForecastHorizonArray(body []byte) ([]BasicForecastHorizon, error) {
	var rawMessages []*json.RawMessage
	err := json.Unmarshal(body, &rawMessages)
	if err != nil {
		return nil, err
	...
	fhArray := make([]BasicForecastHorizon, len(rawMessages))

	for index, rawMessage := range rawMessages {
		fh, err := unmarshalBasicForecastHorizon(*rawMessage)
		if err != nil {
			return nil, err
		}
		fhArray[index] = fh
...
// MarshalJSON is the custom marshaler for ForecastHorizon.
func (fh ForecastHorizon) MarshalJSON() ([]byte, error) {
	fh.Mode = ModeBasicForecastHorizonModeForecastHorizon
	objectMap := make(map[string]interface{})
	if fh.Mode != "" {
		objectMap["mode"] = fh.Mode
	}
	return json.Marshal(objectMap)
}

// AsAutoForecastHorizon is the BasicForecastHorizon implementation for ForecastHorizon.
func (fh ForecastHorizon) AsAutoForecastHorizon() (*AutoForecastHorizon, bool) {
	return nil, false
}

// AsCustomForecastHorizon is the BasicForecastHorizon implementation for ForecastHorizon.
func (fh ForecastHorizon) AsCustomForecastHorizon() (*CustomForecastHorizon, bool) {
	return nil, false
}

// AsForecastHorizon is the BasicForecastHorizon implementation for ForecastHorizon.
func (fh ForecastHorizon) AsForecastHorizon() (*ForecastHorizon, bool) {
	return &fh, true
}

// AsBasicForecastHorizon is the BasicForecastHorizon implementation for ForecastHorizon.
func (fh ForecastHorizon) AsBasicForecastHorizon() (BasicForecastHorizon, bool) {
	return &fh, true
}

// Forecasting forecasting task in AutoML Table vertical.
type Forecasting struct {
	...
	// TaskType - [Required] Task type for AutoMLJob. Possible values include: 'TaskTypeClassification', 'TaskTypeRegression', 'TaskTypeForecasting', 'TaskTypeImageClassification', 'TaskTypeImageClassificationMultilabel', 'TaskTypeImageObjectDetection', 'TaskTypeImageInstanceSegmentation', 'TaskTypeTextClassification', 'TaskTypeTextClassificationMultilabel', 'TaskTypeTextNER'
	TaskType TaskType `json:"taskType,omitempty"`
	// AllowedModels - Allowed models for forecasting task.
	AllowedModels *[]ForecastingModels `json:"allowedModels,omitempty"`
	// BlockedModels - Blocked models for forecasting task.
	...
	// PrimaryMetric - Primary metric for forecasting task. Possible values include: 'SpearmanCorrelation', 'NormalizedRootMeanSquaredError', 'R2Score', 'NormalizedMeanAbsoluteError'
...
type ForecastingSettings struct {
	...
	// FeatureLags - Flag for generating lags for the numeric features with 'auto' or null. Possible values include: 'FeatureLagsNone', 'FeatureLagsAuto'
	FeatureLags FeatureLags `json:"featureLags,omitempty"`
	// ForecastHorizon - The desired maximum forecast horizon in units of time-series frequency.
	ForecastHorizon BasicForecastHorizon `json:"forecastHorizon,omitempty"`
	...
	Seasonality BasicSeasonality `json:"seasonality,omitempty"`
	// ShortSeriesHandlingConfig - The parameter defining how if AutoML should handle short time series. Possible values include: 'ShortSeriesHandlingConfigurationNone', 'ShortSeriesHandlingConfigurationAuto', 'ShortSeriesHandlingConfigurationPad', 'ShortSeriesHandlingConfigurationDrop'
	...
	TargetLags BasicTargetLags `json:"targetLags,omitempty"`
	// TargetRollingWindowSize - The number of past periods used to create a rolling window average of the target column.
	TargetRollingWindowSize BasicTargetRollingWindowSize `json:"targetRollingWindowSize,omitempty"`
	...
	// UseStl - Configure STL Decomposition of the time-series target column. Possible values include: 'UseStlNone', 'UseStlSeason', 'UseStlSeasonTrend'
	UseStl UseStl `json:"useStl,omitempty"`
}

// UnmarshalJSON is the custom unmarshaler for ForecastingSettings struct.
func (fs *ForecastingSettings) UnmarshalJSON(body []byte) error {
	var m map[string]*json.RawMessage
	err := json.Unmarshal(body, &m)
	if err != nil {
		return err
	...
	for k, v := range m {
		...
		case "countryOrRegionForHolidays":
			if v != nil {
				var countryOrRegionForHolidays string
				err = json.Unmarshal(*v, &countryOrRegionForHolidays)
				if err != nil {
					return err
				}
				fs.CountryOrRegionForHolidays = &countryOrRegionForHolidays
			}
		case "cvStepSize":
			if v != nil {
				var cvStepSize int32
				err = json.Unmarshal(*v, &cvStepSize)
				if err != nil {
					return err
				}
				fs.CvStepSize = &cvStepSize
			}
		case "featureLags":
			if v != nil {
				var featureLags FeatureLags
				err = json.Unmarshal(*v, &featureLags)
				if err != nil {
					return err
				}
				fs.FeatureLags = featureLags
			}
		case "forecastHorizon":
			if v != nil {
				forecastHorizon, err := unmarshalBasicForecastHorizon(*v)
				if err != nil {
					return err
				}
				fs.ForecastHorizon = forecastHorizon
			}
		case "frequency":
			if v != nil {
		...
		case "seasonality":
			if v != nil {
				seasonality, err := unmarshalBasicSeasonality(*v)
				if err != nil {
					return err
				}
				fs.Seasonality = seasonality
			}
		case "shortSeriesHandlingConfig":
			if v != nil {
				var shortSeriesHandlingConfig ShortSeriesHandlingConfiguration
				err = json.Unmarshal(*v, &shortSeriesHandlingConfig)
				if err != nil {
					return err
				}
				fs.ShortSeriesHandlingConfig = shortSeriesHandlingConfig
			}
		case "targetAggregateFunction":
			if v != nil {
				var targetAggregateFunction TargetAggregationFunction
				err = json.Unmarshal(*v, &targetAggregateFunction)
				if err != nil {
					return err
				}
				fs.TargetAggregateFunction = targetAggregateFunction
			}
		case "targetLags":
			if v != nil {
				targetLags, err := unmarshalBasicTargetLags(*v)
				if err != nil {
					return err
				}
				fs.TargetLags = targetLags
			}
		case "targetRollingWindowSize":
			if v != nil {
				targetRollingWindowSize, err := unmarshalBasicTargetRollingWindowSize(*v)
				if err != nil {
					return err
				}
				fs.TargetRollingWindowSize = targetRollingWindowSize
			}
		case "timeColumnName":
			if v != nil {
				var timeColumnName string
				err = json.Unmarshal(*v, &timeColumnName)
				if err != nil {
					return err
				}
				fs.TimeColumnName = &timeColumnName
			}
		case "timeSeriesIdColumnNames":
			if v != nil {
				var timeSeriesIDColumnNames []string
				err = json.Unmarshal(*v, &timeSeriesIDColumnNames)
				if err != nil {
					return err
				}
				fs.TimeSeriesIDColumnNames = &timeSeriesIDColumnNames
			}
		case "useStl":
			if v != nil {
				var useStl UseStl
				err = json.Unmarshal(*v, &useStl)
				if err != nil {
					return err
				}
				fs.UseStl = useStl
...
type HdfsDatastore struct {
	// HdfsServerCertificate - The TLS cert of the HDFS server. Needs to be a base64 encoded string. Required if "Https" protocol is selected.
	HdfsServerCertificate *string `json:"hdfsServerCertificate,omitempty"`
	// NameNodeAddress - [Required] IP Address or DNS HostName.
	NameNodeAddress *string `json:"nameNodeAddress,omitempty"`
	// Protocol - Protocol used to communicate with the storage account (Https/Http).
	Protocol *string `json:"protocol,omitempty"`
	// Credentials - [Required] Account credentials.
	Credentials BasicDatastoreCredentials `json:"credentials,omitempty"`
	// IsDefault - READ-ONLY; Readonly property to indicate if datastore is the workspace default datastore
...
// MarshalJSON is the custom marshaler for HdfsDatastore.
func (hd HdfsDatastore) MarshalJSON() ([]byte, error) {
	hd.DatastoreType = DatastoreTypeHdfs
	objectMap := make(map[string]interface{})
	if hd.HdfsServerCertificate != nil {
		objectMap["hdfsServerCertificate"] = hd.HdfsServerCertificate
	}
	if hd.NameNodeAddress != nil {
		objectMap["nameNodeAddress"] = hd.NameNodeAddress
	}
	if hd.Protocol != nil {
		objectMap["protocol"] = hd.Protocol
	}
	objectMap["credentials"] = hd.Credentials
	if hd.DatastoreType != "" {
		objectMap["datastoreType"] = hd.DatastoreType
	}
	if hd.Description != nil {
		objectMap["description"] = hd.Description
	}
	if hd.Properties != nil {
		objectMap["properties"] = hd.Properties
	}
	if hd.Tags != nil {
		objectMap["tags"] = hd.Tags
	}
	return json.Marshal(objectMap)
}

// AsAzureBlobDatastore is the BasicDatastore implementation for HdfsDatastore.
func (hd HdfsDatastore) AsAzureBlobDatastore() (*AzureBlobDatastore, bool) {
	return nil, false
}

// AsAzureDataLakeGen1Datastore is the BasicDatastore implementation for HdfsDatastore.
func (hd HdfsDatastore) AsAzureDataLakeGen1Datastore() (*AzureDataLakeGen1Datastore, bool) {
	return nil, false
}

// AsAzureDataLakeGen2Datastore is the BasicDatastore implementation for HdfsDatastore.
func (hd HdfsDatastore) AsAzureDataLakeGen2Datastore() (*AzureDataLakeGen2Datastore, bool) {
	return nil, false
}

// AsAzureFileDatastore is the BasicDatastore implementation for HdfsDatastore.
func (hd HdfsDatastore) AsAzureFileDatastore() (*AzureFileDatastore, bool) {
	return nil, false
}

// AsHdfsDatastore is the BasicDatastore implementation for HdfsDatastore.
func (hd HdfsDatastore) AsHdfsDatastore() (*HdfsDatastore, bool) {
	return &hd, true
}

// AsDatastore is the BasicDatastore implementation for HdfsDatastore.
func (hd HdfsDatastore) AsDatastore() (*Datastore, bool) {
	return nil, false
}

// AsBasicDatastore is the BasicDatastore implementation for HdfsDatastore.
func (hd HdfsDatastore) AsBasicDatastore() (BasicDatastore, bool) {
	return &hd, true
}

// UnmarshalJSON is the custom unmarshaler for HdfsDatastore struct.
func (hd *HdfsDatastore) UnmarshalJSON(body []byte) error {
	var m map[string]*json.RawMessage
	err := json.Unmarshal(body, &m)
	if err != nil {
		return err
	...
	for k, v := range m {
		...
		case "hdfsServerCertificate":
			if v != nil {
				var hdfsServerCertificate string
				err = json.Unmarshal(*v, &hdfsServerCertificate)
				if err != nil {
					return err
				}
				hd.HdfsServerCertificate = &hdfsServerCertificate
			}
		case "nameNodeAddress":
			if v != nil {
				var nameNodeAddress string
				err = json.Unmarshal(*v, &nameNodeAddress)
				if err != nil {
					return err
				}
				hd.NameNodeAddress = &nameNodeAddress
			}
		case "protocol":
			if v != nil {
				var protocol string
		...
		case "datastoreType":
			if v != nil {
				...
				hd.DatastoreType = datastoreType
			}
		case "description":
			if v != nil {
				var description string
...
// ImageClassification image Classification. Multi-class image classification is used when an image is
// classified with only a single label
...
type ImageClassificationBase struct {
	...
	// SearchSpace - Search space for sampling different combinations of models and their hyperparameters.
	SearchSpace *[]ImageModelDistributionSettingsClassification `json:"searchSpace,omitempty"`
	// DataSettings - [Required] Collection of registered Tabular Dataset Ids and other data settings required for training and validating models.
...
// ImageClassificationMultilabel image Classification Multilabel. Multi-label image classification is used
// when an image could have one or more labels
...
type ImageClassificationMultilabel struct {
	...
	// TaskType - [Required] Task type for AutoMLJob. Possible values include: 'TaskTypeClassification', 'TaskTypeRegression', 'TaskTypeForecasting', 'TaskTypeImageClassification', 'TaskTypeImageClassificationMultilabel', 'TaskTypeImageObjectDetection', 'TaskTypeImageInstanceSegmentation', 'TaskTypeTextClassification', 'TaskTypeTextClassificationMultilabel', 'TaskTypeTextNER'
	TaskType TaskType `json:"taskType,omitempty"`
	// PrimaryMetric - Primary metric to optimize for this task. Possible values include: 'AUCWeighted', 'Accuracy', 'NormMacroRecall', 'AveragePrecisionScoreWeighted', 'PrecisionScoreWeighted', 'IOU'
	PrimaryMetric ClassificationMultilabelPrimaryMetrics `json:"primaryMetric,omitempty"`
}

// ImageInstanceSegmentation image Instance Segmentation. Instance segmentation is used to identify objects
...
type ImageInstanceSegmentation struct {
	...
	// TaskType - [Required] Task type for AutoMLJob. Possible values include: 'TaskTypeClassification', 'TaskTypeRegression', 'TaskTypeForecasting', 'TaskTypeImageClassification', 'TaskTypeImageClassificationMultilabel', 'TaskTypeImageObjectDetection', 'TaskTypeImageInstanceSegmentation', 'TaskTypeTextClassification', 'TaskTypeTextClassificationMultilabel', 'TaskTypeTextNER'
	TaskType TaskType `json:"taskType,omitempty"`
	// PrimaryMetric - Primary metric to optimize for this task. Possible values include: 'MeanAveragePrecision'
...
// ImageModelDistributionSettings distribution expressions to sweep over values of model settings.
// <example>
// Some examples are:
// <code>
...
type ImageModelDistributionSettings struct {
	...
	// SplitRatio - If validation data is not defined, this specifies the split ratio for splitting
...
type ImageModelSettings struct {
	...
	// CheckpointDatasetID - FileDataset id for pretrained checkpoint(s) for incremental training.
	...
	// CheckpointFilename - The pretrained checkpoint filename in FileDataset for incremental training.
	...
	// LearningRateScheduler - Type of learning rate scheduler. Must be 'warmup_cosine' or 'step'. Possible values include: 'LearningRateSchedulerNone', 'LearningRateSchedulerWarmupCosine', 'LearningRateSchedulerStep'
	...
	// Optimizer - Type of optimizer. Possible values include: 'StochasticOptimizerNone', 'StochasticOptimizerSgd', 'StochasticOptimizerAdam', 'StochasticOptimizerAdamw'
...
type ImageModelSettingsObjectDetection struct {
	...
	// ModelSize - Model size. Must be 'small', 'medium', 'large', or 'xlarge'.
	// Note: training run may get into CUDA OOM if the model size is too big.
	// Note: This settings is only supported for the 'yolov5' algorithm. Possible values include: 'ModelSizeNone', 'ModelSizeSmall', 'ModelSizeMedium', 'ModelSizeLarge', 'ModelSizeExtraLarge'
	...
	// ValidationMetricType - Metric computation method to use for validation metrics. Possible values include: 'ValidationMetricTypeNone', 'ValidationMetricTypeCoco', 'ValidationMetricTypeVoc', 'ValidationMetricTypeCocoVoc'
...
// ImageObjectDetection image Object Detection. Object detection is used to identify objects in an image
// and locate each object with a
...
type ImageObjectDetection struct {
	...
	// TaskType - [Required] Task type for AutoMLJob. Possible values include: 'TaskTypeClassification', 'TaskTypeRegression', 'TaskTypeForecasting', 'TaskTypeImageClassification', 'TaskTypeImageClassificationMultilabel', 'TaskTypeImageObjectDetection', 'TaskTypeImageInstanceSegmentation', 'TaskTypeTextClassification', 'TaskTypeTextClassificationMultilabel', 'TaskTypeTextNER'
	TaskType TaskType `json:"taskType,omitempty"`
	// PrimaryMetric - Primary metric to optimize for this task. Possible values include: 'ObjectDetectionPrimaryMetricsMeanAveragePrecision'
...
type ImageSweepLimitSettings struct {
	// MaxConcurrentTrials - Maximum number of concurrent iterations for the underlying Sweep job.
	MaxConcurrentTrials *int32 `json:"maxConcurrentTrials,omitempty"`
	// MaxTrials - Maximum number of iterations for the underlying Sweep job.
	MaxTrials *int32 `json:"maxTrials,omitempty"`
}
...
type ImageSweepSettings struct {
	...
	// Limits - [Required] Limit settings for model sweeping and hyperparameter sweeping.
	Limits *ImageSweepLimitSettings `json:"limits,omitempty"`
	// SamplingAlgorithm - [Required] Type of the hyperparameter sampling algorithms. Possible values include: 'SamplingAlgorithmTypeGrid', 'SamplingAlgorithmTypeRandom', 'SamplingAlgorithmTypeBayesian'
	SamplingAlgorithm SamplingAlgorithmType `json:"samplingAlgorithm,omitempty"`
}

// UnmarshalJSON is the custom unmarshaler for ImageSweepSettings struct.
func (iss *ImageSweepSettings) UnmarshalJSON(body []byte) error {
	var m map[string]*json.RawMessage
	err := json.Unmarshal(body, &m)
	if err != nil {
		return err
	...
	for k, v := range m {
		...
		case "earlyTermination":
			if v != nil {
				...
				iss.EarlyTermination = earlyTermination
			}
		case "limits":
			if v != nil {
				var limits ImageSweepLimitSettings
				err = json.Unmarshal(*v, &limits)
				if err != nil {
					return err
				}
		...
		case "samplingAlgorithm":
			if v != nil {
				var samplingAlgorithm SamplingAlgorithmType
				err = json.Unmarshal(*v, &samplingAlgorithm)
				if err != nil {
					return err
				}
				iss.SamplingAlgorithm = samplingAlgorithm
			}
		}
	}
...
// ImageVertical abstract class for AutoML tasks that train image (computer vision) models -
...
// ImageVerticalDataSettings collection of registered Tabular Dataset Ids and other data settings required
// for training and validating models.
type ImageVerticalDataSettings struct {
	// ValidationData - Settings for the validation dataset.
...
func unmarshalBasicJobBase(body []byte) (BasicJobBase, error) {
	...
	switch m["jobType"] {
	case string(JobTypeAutoML1):
		var amj AutoMLJob
		err := json.Unmarshal(body, &amj)
		return amj, err
...
func (jb JobBase) MarshalJSON() ([]byte, error) {
	...
	objectMap["schedule"] = jb.Schedule
	if jb.Services != nil {
...
// AsAutoMLJob is the BasicJobBase implementation for JobBase.
func (jb JobBase) AsAutoMLJob() (*AutoMLJob, bool) {
	return nil, false
}
...
type KerberosCredentials struct {
	// KerberosKdcAddress - [Required] IP Address or DNS HostName.
	KerberosKdcAddress *string `json:"kerberosKdcAddress,omitempty"`
	// KerberosPrincipal - [Required] Kerberos Username
	KerberosPrincipal *string `json:"kerberosPrincipal,omitempty"`
	// KerberosRealm - [Required] Domain over which a Kerberos authentication server has the authority to authenticate a user, host or service.
...
type KerberosKeytabCredentials struct {
	...
	// KerberosRealm - [Required] Domain over which a Kerberos authentication server has the authority to authenticate a user, host or service.
	KerberosRealm *string `json:"kerberosRealm,omitempty"`
	// CredentialsType - [Required] Credential type used to authentication with storage. Possible values include: 'CredentialsTypeAccountKey', 'CredentialsTypeCertificate', 'CredentialsTypeNone', 'CredentialsTypeSas', 'CredentialsTypeServicePrincipal', 'CredentialsTypeKerberosKeytab', 'CredentialsTypeKerberosPassword'
	CredentialsType CredentialsType `json:"credentialsType,omitempty"`
	// Secrets - [Required] Keytab secrets.
	Secrets *KerberosKeytabSecrets `json:"secrets,omitempty"`
}

// KerberosKeytabSecrets ...
type KerberosKeytabSecrets struct {
	// KerberosKeytab - Kerberos keytab secret.
	KerberosKeytab *string `json:"kerberosKeytab,omitempty"`
	// SecretsType - Possible values include: 'SecretsTypeDatastoreSecrets', 'SecretsTypeAccountKey', 'SecretsTypeCertificate', 'SecretsTypeKerberosKeytab', 'SecretsTypeKerberosPassword', 'SecretsTypeSas', 'SecretsTypeServicePrincipal'
	SecretsType SecretsTypeBasicDatastoreSecrets `json:"secretsType,omitempty"`
}

// MarshalJSON is the custom marshaler for KerberosKeytabSecrets.
func (kks KerberosKeytabSecrets) MarshalJSON() ([]byte, error) {
	kks.SecretsType = SecretsTypeKerberosKeytab
	objectMap := make(map[string]interface{})
	if kks.KerberosKeytab != nil {
		objectMap["kerberosKeytab"] = kks.KerberosKeytab
	}
	if kks.SecretsType != "" {
		objectMap["secretsType"] = kks.SecretsType
	}
	return json.Marshal(objectMap)
}

// AsAccountKeyDatastoreSecrets is the BasicDatastoreSecrets implementation for KerberosKeytabSecrets.
func (kks KerberosKeytabSecrets) AsAccountKeyDatastoreSecrets() (*AccountKeyDatastoreSecrets, bool) {
	return nil, false
}

// AsCertificateDatastoreSecrets is the BasicDatastoreSecrets implementation for KerberosKeytabSecrets.
func (kks KerberosKeytabSecrets) AsCertificateDatastoreSecrets() (*CertificateDatastoreSecrets, bool) {
	return nil, false
}

// AsKerberosKeytabSecrets is the BasicDatastoreSecrets implementation for KerberosKeytabSecrets.
func (kks KerberosKeytabSecrets) AsKerberosKeytabSecrets() (*KerberosKeytabSecrets, bool) {
	return &kks, true
}

// AsKerberosPasswordSecrets is the BasicDatastoreSecrets implementation for KerberosKeytabSecrets.
func (kks KerberosKeytabSecrets) AsKerberosPasswordSecrets() (*KerberosPasswordSecrets, bool) {
	return nil, false
}

// AsSasDatastoreSecrets is the BasicDatastoreSecrets implementation for KerberosKeytabSecrets.
func (kks KerberosKeytabSecrets) AsSasDatastoreSecrets() (*SasDatastoreSecrets, bool) {
	return nil, false
}

// AsServicePrincipalDatastoreSecrets is the BasicDatastoreSecrets implementation for KerberosKeytabSecrets.
func (kks KerberosKeytabSecrets) AsServicePrincipalDatastoreSecrets() (*ServicePrincipalDatastoreSecrets, bool) {
	return nil, false
}

// AsDatastoreSecrets is the BasicDatastoreSecrets implementation for KerberosKeytabSecrets.
func (kks KerberosKeytabSecrets) AsDatastoreSecrets() (*DatastoreSecrets, bool) {
	return nil, false
}

// AsBasicDatastoreSecrets is the BasicDatastoreSecrets implementation for KerberosKeytabSecrets.
func (kks KerberosKeytabSecrets) AsBasicDatastoreSecrets() (BasicDatastoreSecrets, bool) {
	return &kks, true
}
...
type KerberosPasswordCredentials struct {
	...
	// CredentialsType - [Required] Credential type used to authentication with storage. Possible values include: 'CredentialsTypeAccountKey', 'CredentialsTypeCertificate', 'CredentialsTypeNone', 'CredentialsTypeSas', 'CredentialsTypeServicePrincipal', 'CredentialsTypeKerberosKeytab', 'CredentialsTypeKerberosPassword'
	CredentialsType CredentialsType `json:"credentialsType,omitempty"`
	// Secrets - [Required] Kerberos password secrets.
	Secrets *KerberosPasswordSecrets `json:"secrets,omitempty"`
}

// KerberosPasswordSecrets ...
type KerberosPasswordSecrets struct {
	// KerberosPassword - Kerberos password secret.
	KerberosPassword *string `json:"kerberosPassword,omitempty"`
	// SecretsType - Possible values include: 'SecretsTypeDatastoreSecrets', 'SecretsTypeAccountKey', 'SecretsTypeCertificate', 'SecretsTypeKerberosKeytab', 'SecretsTypeKerberosPassword', 'SecretsTypeSas', 'SecretsTypeServicePrincipal'
	SecretsType SecretsTypeBasicDatastoreSecrets `json:"secretsType,omitempty"`
}

// MarshalJSON is the custom marshaler for KerberosPasswordSecrets.
func (kps KerberosPasswordSecrets) MarshalJSON() ([]byte, error) {
	kps.SecretsType = SecretsTypeKerberosPassword
	objectMap := make(map[string]interface{})
	if kps.KerberosPassword != nil {
		objectMap["kerberosPassword"] = kps.KerberosPassword
	}
	if kps.SecretsType != "" {
		objectMap["secretsType"] = kps.SecretsType
	}
	return json.Marshal(objectMap)
}

// AsAccountKeyDatastoreSecrets is the BasicDatastoreSecrets implementation for KerberosPasswordSecrets.
func (kps KerberosPasswordSecrets) AsAccountKeyDatastoreSecrets() (*AccountKeyDatastoreSecrets, bool) {
	return nil, false
}

// AsCertificateDatastoreSecrets is the BasicDatastoreSecrets implementation for KerberosPasswordSecrets.
func (kps KerberosPasswordSecrets) AsCertificateDatastoreSecrets() (*CertificateDatastoreSecrets, bool) {
	return nil, false
}

// AsKerberosKeytabSecrets is the BasicDatastoreSecrets implementation for KerberosPasswordSecrets.
func (kps KerberosPasswordSecrets) AsKerberosKeytabSecrets() (*KerberosKeytabSecrets, bool) {
	return nil, false
}

// AsKerberosPasswordSecrets is the BasicDatastoreSecrets implementation for KerberosPasswordSecrets.
func (kps KerberosPasswordSecrets) AsKerberosPasswordSecrets() (*KerberosPasswordSecrets, bool) {
	return &kps, true
}

// AsSasDatastoreSecrets is the BasicDatastoreSecrets implementation for KerberosPasswordSecrets.
func (kps KerberosPasswordSecrets) AsSasDatastoreSecrets() (*SasDatastoreSecrets, bool) {
	return nil, false
}

// AsServicePrincipalDatastoreSecrets is the BasicDatastoreSecrets implementation for KerberosPasswordSecrets.
func (kps KerberosPasswordSecrets) AsServicePrincipalDatastoreSecrets() (*ServicePrincipalDatastoreSecrets, bool) {
	return nil, false
}

// AsDatastoreSecrets is the BasicDatastoreSecrets implementation for KerberosPasswordSecrets.
func (kps KerberosPasswordSecrets) AsDatastoreSecrets() (*DatastoreSecrets, bool) {
	return nil, false
}

// AsBasicDatastoreSecrets is the BasicDatastoreSecrets implementation for KerberosPasswordSecrets.
func (kps KerberosPasswordSecrets) AsBasicDatastoreSecrets() (BasicDatastoreSecrets, bool) {
	return &kps, true
}
...
type KubernetesOnlineDeployment struct {
	...
	// EgressPublicNetworkAccess - If Enabled, allow egress public network access. If Disabled, this will create secure egress. Default: Enabled. Possible values include: 'Enabled', 'Disabled'
	...
	// PrivateNetworkConnection - If true, enable private network connection.
...
func (kod KubernetesOnlineDeployment) MarshalJSON() ([]byte, error) {
	...
	if kod.EgressPublicNetworkAccess != "" {
		objectMap["egressPublicNetworkAccess"] = kod.EgressPublicNetworkAccess
	}
	...
	if kod.PrivateNetworkConnection != nil {
		objectMap["privateNetworkConnection"] = kod.PrivateNetworkConnection
	}
...
func (kod *KubernetesOnlineDeployment) UnmarshalJSON(body []byte) error {
	...
	for k, v := range m {
		...
		case "egressPublicNetworkAccess":
			if v != nil {
				var egressPublicNetworkAccess EgressPublicNetworkAccessType
				err = json.Unmarshal(*v, &egressPublicNetworkAccess)
				if err != nil {
					return err
				}
				kod.EgressPublicNetworkAccess = egressPublicNetworkAccess
			}
		case "instanceType":
			if v != nil {
		...
		case "privateNetworkConnection":
			if v != nil {
				var privateNetworkConnection bool
				err = json.Unmarshal(*v, &privateNetworkConnection)
				if err != nil {
					return err
				}
				kod.PrivateNetworkConnection = &privateNetworkConnection
			}
		case "provisioningState":
			if v != nil {
				var provisioningState DeploymentProvisioningState
...
func (mod ManagedOnlineDeployment) MarshalJSON() ([]byte, error) {
	...
	if mod.EgressPublicNetworkAccess != "" {
		objectMap["egressPublicNetworkAccess"] = mod.EgressPublicNetworkAccess
	}
	...
	if mod.PrivateNetworkConnection != nil {
		objectMap["privateNetworkConnection"] = mod.PrivateNetworkConnection
	}
	...
	for k, v := range m {
		...
		case "egressPublicNetworkAccess":
			if v != nil {
				...
				mod.EgressPublicNetworkAccess = egressPublicNetworkAccess
			}
		case "instanceType":
			if v != nil {
				var instanceType string
		...
		case "privateNetworkConnection":
			if v != nil {
				...
				mod.PrivateNetworkConnection = &privateNetworkConnection
			}
		case "provisioningState":
			if v != nil {
				var provisioningState DeploymentProvisioningState
...
type ModelVersion struct {
	...
	// ModelType - The storage format for this entity. Used for NCD. Possible values include: 'CustomModel', 'MLFlowModel', 'TritonModel'
...
// BasicNCrossValidations n-Cross validations value.
type BasicNCrossValidations interface {
	AsAutoNCrossValidations() (*AutoNCrossValidations, bool)
	AsCustomNCrossValidations() (*CustomNCrossValidations, bool)
	AsNCrossValidations() (*NCrossValidations, bool)
}
...
func unmarshalBasicNCrossValidations(body []byte) (BasicNCrossValidations, error) {
	var m map[string]interface{}
	err := json.Unmarshal(body, &m)
	if err != nil {
		return nil, err
	...
	case string(ModeAuto):
		var ancv AutoNCrossValidations
		err := json.Unmarshal(body, &ancv)
		return ancv, err
	case string(ModeCustom):
		var cncv CustomNCrossValidations
		err := json.Unmarshal(body, &cncv)
		return cncv, err
	default:
		var ncv NCrossValidations
		err := json.Unmarshal(body, &ncv)
		return ncv, err
	}
}
func unmarshalBasicNCrossValidationsArray(body []byte) ([]BasicNCrossValidations, error) {
	var rawMessages []*json.RawMessage
	err := json.Unmarshal(body, &rawMessages)
	if err != nil {
		return nil, err
	...
	ncvArray := make([]BasicNCrossValidations, len(rawMessages))

	for index, rawMessage := range rawMessages {
		ncv, err := unmarshalBasicNCrossValidations(*rawMessage)
		if err != nil {
			return nil, err
		}
		ncvArray[index] = ncv
...
// MarshalJSON is the custom marshaler for NCrossValidations.
func (ncv NCrossValidations) MarshalJSON() ([]byte, error) {
	ncv.Mode = ModeNCrossValidations
	objectMap := make(map[string]interface{})
	if ncv.Mode != "" {
		objectMap["mode"] = ncv.Mode
	}
	return json.Marshal(objectMap)
}

// AsAutoNCrossValidations is the BasicNCrossValidations implementation for NCrossValidations.
func (ncv NCrossValidations) AsAutoNCrossValidations() (*AutoNCrossValidations, bool) {
	return nil, false
}

// AsCustomNCrossValidations is the BasicNCrossValidations implementation for NCrossValidations.
func (ncv NCrossValidations) AsCustomNCrossValidations() (*CustomNCrossValidations, bool) {
	return nil, false
}

// AsNCrossValidations is the BasicNCrossValidations implementation for NCrossValidations.
func (ncv NCrossValidations) AsNCrossValidations() (*NCrossValidations, bool) {
	return &ncv, true
}

// AsBasicNCrossValidations is the BasicNCrossValidations implementation for NCrossValidations.
func (ncv NCrossValidations) AsBasicNCrossValidations() (BasicNCrossValidations, bool) {
	return &ncv, true
}
...
// NlpVerticalDataSettings class for data inputs.
// NLP - Natural Language Processing.
...
func (od OnlineDeployment) MarshalJSON() ([]byte, error) {
	...
	if od.EgressPublicNetworkAccess != "" {
		objectMap["egressPublicNetworkAccess"] = od.EgressPublicNetworkAccess
	}
	...
	if od.PrivateNetworkConnection != nil {
		objectMap["privateNetworkConnection"] = od.PrivateNetworkConnection
	}
	...
	for k, v := range m {
		...
		case "egressPublicNetworkAccess":
			if v != nil {
				...
				od.EgressPublicNetworkAccess = egressPublicNetworkAccess
			}
		case "instanceType":
			if v != nil {
				var instanceType string
		...
		case "privateNetworkConnection":
			if v != nil {
				...
				od.PrivateNetworkConnection = &privateNetworkConnection
			}
		case "provisioningState":
			if v != nil {
				var provisioningState DeploymentProvisioningState
...
type OnlineEndpoint struct {
	...
	MirrorTraffic map[string]*int32 `json:"mirrorTraffic"`
	// ProvisioningState - READ-ONLY; Provisioning state for the endpoint. Possible values include: 'EndpointProvisioningStateCreating', 'EndpointProvisioningStateDeleting', 'EndpointProvisioningStateSucceeded', 'EndpointProvisioningStateFailed', 'EndpointProvisioningStateUpdating', 'EndpointProvisioningStateCanceled'
	ProvisioningState EndpointProvisioningState `json:"provisioningState,omitempty"`
	// PublicNetworkAccess - Set to "Enabled" for endpoints that should allow public access when Private Link is enabled. Possible values include: 'PublicNetworkAccessTypeEnabled', 'PublicNetworkAccessTypeDisabled'
...
func (oe OnlineEndpoint) MarshalJSON() ([]byte, error) {
	...
	if oe.MirrorTraffic != nil {
		objectMap["mirrorTraffic"] = oe.MirrorTraffic
	}
	if oe.PublicNetworkAccess != "" {
		objectMap["publicNetworkAccess"] = oe.PublicNetworkAccess
	}
	if oe.Traffic != nil {
...
// BasicPartialAssetReferenceBase base definition for asset references.
type BasicPartialAssetReferenceBase interface {
	AsPartialDataPathAssetReference() (*PartialDataPathAssetReference, bool)
	AsPartialIDAssetReference() (*PartialIDAssetReference, bool)
	AsPartialOutputPathAssetReference() (*PartialOutputPathAssetReference, bool)
	AsPartialAssetReferenceBase() (*PartialAssetReferenceBase, bool)
}

// PartialAssetReferenceBase base definition for asset references.
type PartialAssetReferenceBase struct {
	// ReferenceType - Possible values include: 'ReferenceTypeBasicPartialAssetReferenceBaseReferenceTypePartialAssetReferenceBase', 'ReferenceTypeBasicPartialAssetReferenceBaseReferenceTypeDataPath', 'ReferenceTypeBasicPartialAssetReferenceBaseReferenceTypeID', 'ReferenceTypeBasicPartialAssetReferenceBaseReferenceTypeOutputPath'
	ReferenceType ReferenceTypeBasicPartialAssetReferenceBase `json:"referenceType,omitempty"`
}

func unmarshalBasicPartialAssetReferenceBase(body []byte) (BasicPartialAssetReferenceBase, error) {
	var m map[string]interface{}
	err := json.Unmarshal(body, &m)
	if err != nil {
		return nil, err
	...
	switch m["referenceType"] {
	case string(ReferenceTypeBasicPartialAssetReferenceBaseReferenceTypeDataPath):
		var pdpar PartialDataPathAssetReference
		err := json.Unmarshal(body, &pdpar)
		return pdpar, err
	case string(ReferenceTypeBasicPartialAssetReferenceBaseReferenceTypeID):
		var piar PartialIDAssetReference
		err := json.Unmarshal(body, &piar)
		return piar, err
	case string(ReferenceTypeBasicPartialAssetReferenceBaseReferenceTypeOutputPath):
		var popar PartialOutputPathAssetReference
		err := json.Unmarshal(body, &popar)
		return popar, err
	default:
		var parb PartialAssetReferenceBase
		err := json.Unmarshal(body, &parb)
		return parb, err
	}
}
func unmarshalBasicPartialAssetReferenceBaseArray(body []byte) ([]BasicPartialAssetReferenceBase, error) {
	var rawMessages []*json.RawMessage
	err := json.Unmarshal(body, &rawMessages)
	if err != nil {
		return nil, err
	...
	parbArray := make([]BasicPartialAssetReferenceBase, len(rawMessages))

	for index, rawMessage := range rawMessages {
		parb, err := unmarshalBasicPartialAssetReferenceBase(*rawMessage)
		if err != nil {
			return nil, err
		}
		parbArray[index] = parb
	}
	return parbArray, nil
}

// MarshalJSON is the custom marshaler for PartialAssetReferenceBase.
func (parb PartialAssetReferenceBase) MarshalJSON() ([]byte, error) {
	parb.ReferenceType = ReferenceTypeBasicPartialAssetReferenceBaseReferenceTypePartialAssetReferenceBase
	objectMap := make(map[string]interface{})
	if parb.ReferenceType != "" {
		objectMap["referenceType"] = parb.ReferenceType
	}
	return json.Marshal(objectMap)
}

// AsPartialDataPathAssetReference is the BasicPartialAssetReferenceBase implementation for PartialAssetReferenceBase.
func (parb PartialAssetReferenceBase) AsPartialDataPathAssetReference() (*PartialDataPathAssetReference, bool) {
	return nil, false
}

// AsPartialIDAssetReference is the BasicPartialAssetReferenceBase implementation for PartialAssetReferenceBase.
func (parb PartialAssetReferenceBase) AsPartialIDAssetReference() (*PartialIDAssetReference, bool) {
	return nil, false
}

// AsPartialOutputPathAssetReference is the BasicPartialAssetReferenceBase implementation for PartialAssetReferenceBase.
func (parb PartialAssetReferenceBase) AsPartialOutputPathAssetReference() (*PartialOutputPathAssetReference, bool) {
	return nil, false
}

// AsPartialAssetReferenceBase is the BasicPartialAssetReferenceBase implementation for PartialAssetReferenceBase.
func (parb PartialAssetReferenceBase) AsPartialAssetReferenceBase() (*PartialAssetReferenceBase, bool) {
	return &parb, true
}

// AsBasicPartialAssetReferenceBase is the BasicPartialAssetReferenceBase implementation for PartialAssetReferenceBase.
func (parb PartialAssetReferenceBase) AsBasicPartialAssetReferenceBase() (BasicPartialAssetReferenceBase, bool) {
	return &parb, true
}
...
type PartialBatchDeployment struct {
	...
	// Compute - Compute binding definition.
	Compute *string `json:"compute,omitempty"`
	// Description - Description of the endpoint deployment.
	Description *string `json:"description,omitempty"`
	// EnvironmentID - ARM resource ID of the environment specification for the endpoint deployment.
	...
	// LoggingLevel - Logging level for batch inference operation. Possible values include: 'Info', 'Warning', 'Debug'
	LoggingLevel BatchLoggingLevel `json:"loggingLevel,omitempty"`
	// MaxConcurrencyPerInstance - Indicates number of processes per instance
	MaxConcurrencyPerInstance *int32 `json:"maxConcurrencyPerInstance,omitempty"`
	// MiniBatchSize - Size of the mini-batch passed to each batch invocation.
	// For FileDataset, this is the number of files per mini-batch.
	// For TabularDataset, this is the size of the records in bytes, per mini-batch.
	MiniBatchSize *int64 `json:"miniBatchSize,omitempty"`
	// Model - Reference to the model asset for the endpoint deployment.
	Model BasicPartialAssetReferenceBase `json:"model,omitempty"`
	// OutputAction - Indicates how the output will be organized. Possible values include: 'SummaryOnly', 'AppendRow'
	OutputAction BatchOutputAction `json:"outputAction,omitempty"`
	// OutputFileName - Customized output file name for append_row output action.
	OutputFileName *string `json:"outputFileName,omitempty"`
...
// MarshalJSON is the custom marshaler for PartialBatchDeployment.
func (pbd PartialBatchDeployment) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if pbd.CodeConfiguration != nil {
		objectMap["codeConfiguration"] = pbd.CodeConfiguration
	}
	if pbd.Compute != nil {
		objectMap["compute"] = pbd.Compute
	}
	if pbd.Description != nil {
		objectMap["description"] = pbd.Description
	}
	if pbd.EnvironmentID != nil {
		objectMap["environmentId"] = pbd.EnvironmentID
	}
	if pbd.EnvironmentVariables != nil {
		objectMap["environmentVariables"] = pbd.EnvironmentVariables
	}
	if pbd.ErrorThreshold != nil {
		objectMap["errorThreshold"] = pbd.ErrorThreshold
	}
	if pbd.LoggingLevel != "" {
		objectMap["loggingLevel"] = pbd.LoggingLevel
	}
	if pbd.MaxConcurrencyPerInstance != nil {
		objectMap["maxConcurrencyPerInstance"] = pbd.MaxConcurrencyPerInstance
	}
	if pbd.MiniBatchSize != nil {
		objectMap["miniBatchSize"] = pbd.MiniBatchSize
	}
	objectMap["model"] = pbd.Model
	if pbd.OutputAction != "" {
		objectMap["outputAction"] = pbd.OutputAction
	}
	if pbd.OutputFileName != nil {
		objectMap["outputFileName"] = pbd.OutputFileName
	}
	if pbd.Properties != nil {
		objectMap["properties"] = pbd.Properties
	}
	if pbd.RetrySettings != nil {
		objectMap["retrySettings"] = pbd.RetrySettings
	}
	return json.Marshal(objectMap)
}

// UnmarshalJSON is the custom unmarshaler for PartialBatchDeployment struct.
func (pbd *PartialBatchDeployment) UnmarshalJSON(body []byte) error {
	var m map[string]*json.RawMessage
	err := json.Unmarshal(body, &m)
	if err != nil {
		return err
	...
	for k, v := range m {
		...
		case "codeConfiguration":
			if v != nil {
				...
				pbd.CodeConfiguration = &codeConfiguration
			}
		case "compute":
			if v != nil {
				var compute string
		...
		case "environmentId":
			if v != nil {
				...
				pbd.EnvironmentID = &environmentID
			}
		case "environmentVariables":
			if v != nil {
				var environmentVariables map[string]*string
				...
				pbd.EnvironmentVariables = environmentVariables
			}
		case "errorThreshold":
			if v != nil {
				var errorThreshold int32
				...
				pbd.ErrorThreshold = &errorThreshold
			}
		case "loggingLevel":
			if v != nil {
				var loggingLevel BatchLoggingLevel
		...
		case "maxConcurrencyPerInstance":
			if v != nil {
				...
				pbd.MaxConcurrencyPerInstance = &maxConcurrencyPerInstance
			}
		case "miniBatchSize":
			if v != nil {
				var miniBatchSize int64
				...
				pbd.MiniBatchSize = &miniBatchSize
			}
		case "model":
			if v != nil {
				model, err := unmarshalBasicPartialAssetReferenceBase(*v)
				if err != nil {
					return err
				}
				pbd.Model = model
		...
		case "outputFileName":
			if v != nil {
				...
				pbd.OutputFileName = &outputFileName
			}
		case "properties":
			if v != nil {
				var properties map[string]*string
				...
				pbd.Properties = properties
			}
		case "retrySettings":
			if v != nil {
				var retrySettings PartialBatchRetrySettings
				err = json.Unmarshal(*v, &retrySettings)
				if err != nil {
					return err
				}
				pbd.RetrySettings = &retrySettings
			}
		}
	}
...
// MarshalJSON is the custom marshaler for PartialDataPathAssetReference.
func (pdpar PartialDataPathAssetReference) MarshalJSON() ([]byte, error) {
	pdpar.ReferenceType = ReferenceTypeBasicPartialAssetReferenceBaseReferenceTypeDataPath
	objectMap := make(map[string]interface{})
	if pdpar.DatastoreID != nil {
		objectMap["datastoreId"] = pdpar.DatastoreID
	}
	if pdpar.Path != nil {
		objectMap["path"] = pdpar.Path
	}
	if pdpar.ReferenceType != "" {
		objectMap["referenceType"] = pdpar.ReferenceType
	}
	return json.Marshal(objectMap)
}

// AsPartialDataPathAssetReference is the BasicPartialAssetReferenceBase implementation for PartialDataPathAssetReference.
func (pdpar PartialDataPathAssetReference) AsPartialDataPathAssetReference() (*PartialDataPathAssetReference, bool) {
	return &pdpar, true
}

// AsPartialIDAssetReference is the BasicPartialAssetReferenceBase implementation for PartialDataPathAssetReference.
func (pdpar PartialDataPathAssetReference) AsPartialIDAssetReference() (*PartialIDAssetReference, bool) {
	return nil, false
}

// AsPartialOutputPathAssetReference is the BasicPartialAssetReferenceBase implementation for PartialDataPathAssetReference.
func (pdpar PartialDataPathAssetReference) AsPartialOutputPathAssetReference() (*PartialOutputPathAssetReference, bool) {
	return nil, false
}

// AsPartialAssetReferenceBase is the BasicPartialAssetReferenceBase implementation for PartialDataPathAssetReference.
func (pdpar PartialDataPathAssetReference) AsPartialAssetReferenceBase() (*PartialAssetReferenceBase, bool) {
	return nil, false
}

// AsBasicPartialAssetReferenceBase is the BasicPartialAssetReferenceBase implementation for PartialDataPathAssetReference.
func (pdpar PartialDataPathAssetReference) AsBasicPartialAssetReferenceBase() (BasicPartialAssetReferenceBase, bool) {
	return &pdpar, true
}
...
// MarshalJSON is the custom marshaler for PartialIDAssetReference.
func (piar PartialIDAssetReference) MarshalJSON() ([]byte, error) {
	piar.ReferenceType = ReferenceTypeBasicPartialAssetReferenceBaseReferenceTypeID
	objectMap := make(map[string]interface{})
	if piar.AssetID != nil {
		objectMap["assetId"] = piar.AssetID
	}
	if piar.ReferenceType != "" {
		objectMap["referenceType"] = piar.ReferenceType
	}
	return json.Marshal(objectMap)
}

// AsPartialDataPathAssetReference is the BasicPartialAssetReferenceBase implementation for PartialIDAssetReference.
func (piar PartialIDAssetReference) AsPartialDataPathAssetReference() (*PartialDataPathAssetReference, bool) {
	return nil, false
}

// AsPartialIDAssetReference is the BasicPartialAssetReferenceBase implementation for PartialIDAssetReference.
func (piar PartialIDAssetReference) AsPartialIDAssetReference() (*PartialIDAssetReference, bool) {
	return &piar, true
}

// AsPartialOutputPathAssetReference is the BasicPartialAssetReferenceBase implementation for PartialIDAssetReference.
func (piar PartialIDAssetReference) AsPartialOutputPathAssetReference() (*PartialOutputPathAssetReference, bool) {
	return nil, false
}

// AsPartialAssetReferenceBase is the BasicPartialAssetReferenceBase implementation for PartialIDAssetReference.
func (piar PartialIDAssetReference) AsPartialAssetReferenceBase() (*PartialAssetReferenceBase, bool) {
	return nil, false
}

// AsBasicPartialAssetReferenceBase is the BasicPartialAssetReferenceBase implementation for PartialIDAssetReference.
func (piar PartialIDAssetReference) AsBasicPartialAssetReferenceBase() (BasicPartialAssetReferenceBase, bool) {
	return &piar, true
}
...
type PartialKubernetesOnlineDeployment struct {
	// EndpointComputeType - Possible values include: 'EndpointComputeTypeBasicPartialOnlineDeploymentEndpointComputeTypePartialOnlineDeployment', 'EndpointComputeTypeBasicPartialOnlineDeploymentEndpointComputeTypeKubernetes', 'EndpointComputeTypeBasicPartialOnlineDeploymentEndpointComputeTypeManaged'
	EndpointComputeType EndpointComputeTypeBasicPartialOnlineDeployment `json:"endpointComputeType,omitempty"`
}

// MarshalJSON is the custom marshaler for PartialKubernetesOnlineDeployment.
func (pkod PartialKubernetesOnlineDeployment) MarshalJSON() ([]byte, error) {
	pkod.EndpointComputeType = EndpointComputeTypeBasicPartialOnlineDeploymentEndpointComputeTypeKubernetes
	objectMap := make(map[string]interface{})
	if pkod.EndpointComputeType != "" {
		objectMap["endpointComputeType"] = pkod.EndpointComputeType
	}
	return json.Marshal(objectMap)
}

// AsPartialKubernetesOnlineDeployment is the BasicPartialOnlineDeployment implementation for PartialKubernetesOnlineDeployment.
func (pkod PartialKubernetesOnlineDeployment) AsPartialKubernetesOnlineDeployment() (*PartialKubernetesOnlineDeployment, bool) {
	return &pkod, true
}

// AsPartialManagedOnlineDeployment is the BasicPartialOnlineDeployment implementation for PartialKubernetesOnlineDeployment.
func (pkod PartialKubernetesOnlineDeployment) AsPartialManagedOnlineDeployment() (*PartialManagedOnlineDeployment, bool) {
	return nil, false
}

// AsPartialOnlineDeployment is the BasicPartialOnlineDeployment implementation for PartialKubernetesOnlineDeployment.
func (pkod PartialKubernetesOnlineDeployment) AsPartialOnlineDeployment() (*PartialOnlineDeployment, bool) {
	return nil, false
}

// AsBasicPartialOnlineDeployment is the BasicPartialOnlineDeployment implementation for PartialKubernetesOnlineDeployment.
func (pkod PartialKubernetesOnlineDeployment) AsBasicPartialOnlineDeployment() (BasicPartialOnlineDeployment, bool) {
	return &pkod, true
}
...
// AsPartialKubernetesOnlineDeployment is the BasicPartialOnlineDeployment implementation for PartialManagedOnlineDeployment.
func (pmod PartialManagedOnlineDeployment) AsPartialKubernetesOnlineDeployment() (*PartialKubernetesOnlineDeployment, bool) {
	return nil, false
}
...
type BasicPartialOnlineDeployment interface {
	AsPartialKubernetesOnlineDeployment() (*PartialKubernetesOnlineDeployment, bool)
...
func unmarshalBasicPartialOnlineDeployment(body []byte) (BasicPartialOnlineDeployment, error) {
	...
	switch m["endpointComputeType"] {
	case string(EndpointComputeTypeBasicPartialOnlineDeploymentEndpointComputeTypeKubernetes):
		var pkod PartialKubernetesOnlineDeployment
		err := json.Unmarshal(body, &pkod)
		return pkod, err
...
// AsPartialKubernetesOnlineDeployment is the BasicPartialOnlineDeployment implementation for PartialOnlineDeployment.
func (pod PartialOnlineDeployment) AsPartialKubernetesOnlineDeployment() (*PartialKubernetesOnlineDeployment, bool) {
	return nil, false
}
...
func (poe PartialOnlineEndpoint) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if poe.MirrorTraffic != nil {
		objectMap["mirrorTraffic"] = poe.MirrorTraffic
	}
	if poe.PublicNetworkAccess != "" {
		objectMap["publicNetworkAccess"] = poe.PublicNetworkAccess
	}
	if poe.Traffic != nil {
...
// MarshalJSON is the custom marshaler for PartialOutputPathAssetReference.
func (popar PartialOutputPathAssetReference) MarshalJSON() ([]byte, error) {
	popar.ReferenceType = ReferenceTypeBasicPartialAssetReferenceBaseReferenceTypeOutputPath
	objectMap := make(map[string]interface{})
	if popar.JobID != nil {
		objectMap["jobId"] = popar.JobID
	}
	if popar.Path != nil {
		objectMap["path"] = popar.Path
	}
	if popar.ReferenceType != "" {
		objectMap["referenceType"] = popar.ReferenceType
	}
	return json.Marshal(objectMap)
}

// AsPartialDataPathAssetReference is the BasicPartialAssetReferenceBase implementation for PartialOutputPathAssetReference.
func (popar PartialOutputPathAssetReference) AsPartialDataPathAssetReference() (*PartialDataPathAssetReference, bool) {
	return nil, false
}

// AsPartialIDAssetReference is the BasicPartialAssetReferenceBase implementation for PartialOutputPathAssetReference.
func (popar PartialOutputPathAssetReference) AsPartialIDAssetReference() (*PartialIDAssetReference, bool) {
	return nil, false
}

// AsPartialOutputPathAssetReference is the BasicPartialAssetReferenceBase implementation for PartialOutputPathAssetReference.
func (popar PartialOutputPathAssetReference) AsPartialOutputPathAssetReference() (*PartialOutputPathAssetReference, bool) {
	return &popar, true
}

// AsPartialAssetReferenceBase is the BasicPartialAssetReferenceBase implementation for PartialOutputPathAssetReference.
func (popar PartialOutputPathAssetReference) AsPartialAssetReferenceBase() (*PartialAssetReferenceBase, bool) {
	return nil, false
}

// AsBasicPartialAssetReferenceBase is the BasicPartialAssetReferenceBase implementation for PartialOutputPathAssetReference.
func (popar PartialOutputPathAssetReference) AsBasicPartialAssetReferenceBase() (BasicPartialAssetReferenceBase, bool) {
	return &popar, true
}
...
func (pj PipelineJob) MarshalJSON() ([]byte, error) {
	...
	objectMap["schedule"] = pj.Schedule
	if pj.Services != nil {
...
// AsAutoMLJob is the BasicJobBase implementation for PipelineJob.
func (pj PipelineJob) AsAutoMLJob() (*AutoMLJob, bool) {
	return nil, false
}
...
type RecurrencePattern struct {
	// Hours - [Required] List of hours for recurrence schedule pattern
	Hours *[]int32 `json:"hours,omitempty"`
	// Minutes - [Required] List of minutes for recurrence schedule pattern
	Minutes *[]int32 `json:"minutes,omitempty"`
	// Weekdays - List of weekdays for recurrence schedule pattern
	Weekdays *[]Weekday `json:"weekdays,omitempty"`
}

// RecurrenceSchedule recurrence schedule definition
type RecurrenceSchedule struct {
	// Frequency - [Required] Specifies frequency with with which to trigger schedule. Possible values include: 'Minute', 'Hour', 'Day', 'Week', 'Month'
	Frequency RecurrenceFrequency `json:"frequency,omitempty"`
	// Interval - [Required] Specifies schedule interval in conjunction with frequency
	Interval *int32 `json:"interval,omitempty"`
	// Pattern - Specifies the recurrence schedule pattern
...
func (rs RecurrenceSchedule) MarshalJSON() ([]byte, error) {
	rs.ScheduleType = ScheduleTypeRecurrence
	objectMap := make(map[string]interface{})
	if rs.Frequency != "" {
		objectMap["frequency"] = rs.Frequency
	}
	if rs.Interval != nil {
		objectMap["interval"] = rs.Interval
	}
	if rs.Pattern != nil {
		objectMap["pattern"] = rs.Pattern
	}
	if rs.EndTime != nil {
		objectMap["endTime"] = rs.EndTime
	}
	if rs.ScheduleStatus != "" {
		objectMap["scheduleStatus"] = rs.ScheduleStatus
	}
	if rs.StartTime != nil {
		objectMap["startTime"] = rs.StartTime
	}
	if rs.TimeZone != nil {
		objectMap["timeZone"] = rs.TimeZone
	}
	if rs.ScheduleType != "" {
		objectMap["scheduleType"] = rs.ScheduleType
	}
	return json.Marshal(objectMap)
}

// AsRecurrenceSchedule is the BasicScheduleBase implementation for RecurrenceSchedule.
func (rs RecurrenceSchedule) AsRecurrenceSchedule() (*RecurrenceSchedule, bool) {
	return &rs, true
}

// AsCronSchedule is the BasicScheduleBase implementation for RecurrenceSchedule.
func (rs RecurrenceSchedule) AsCronSchedule() (*CronSchedule, bool) {
	return nil, false
}

// AsScheduleBase is the BasicScheduleBase implementation for RecurrenceSchedule.
func (rs RecurrenceSchedule) AsScheduleBase() (*ScheduleBase, bool) {
	return nil, false
}

// AsBasicScheduleBase is the BasicScheduleBase implementation for RecurrenceSchedule.
func (rs RecurrenceSchedule) AsBasicScheduleBase() (BasicScheduleBase, bool) {
	return &rs, true
}
...
type Regression struct {
	...
	// TaskType - [Required] Task type for AutoMLJob. Possible values include: 'TaskTypeClassification', 'TaskTypeRegression', 'TaskTypeForecasting', 'TaskTypeImageClassification', 'TaskTypeImageClassificationMultilabel', 'TaskTypeImageObjectDetection', 'TaskTypeImageInstanceSegmentation', 'TaskTypeTextClassification', 'TaskTypeTextClassificationMultilabel', 'TaskTypeTextNER'
	TaskType TaskType `json:"taskType,omitempty"`
	// AllowedModels - Allowed models for regression task.
	AllowedModels *[]RegressionModels `json:"allowedModels,omitempty"`
	// BlockedModels - Blocked models for regression task.
	BlockedModels *[]RegressionModels `json:"blockedModels,omitempty"`
	// PrimaryMetric - Primary metric for regression task. Possible values include: 'RegressionPrimaryMetricsSpearmanCorrelation', 'RegressionPrimaryMetricsNormalizedRootMeanSquaredError', 'RegressionPrimaryMetricsR2Score', 'RegressionPrimaryMetricsNormalizedMeanAbsoluteError'
...
// AsKerberosKeytabSecrets is the BasicDatastoreSecrets implementation for SasDatastoreSecrets.
func (sds SasDatastoreSecrets) AsKerberosKeytabSecrets() (*KerberosKeytabSecrets, bool) {
	return nil, false
}

// AsKerberosPasswordSecrets is the BasicDatastoreSecrets implementation for SasDatastoreSecrets.
func (sds SasDatastoreSecrets) AsKerberosPasswordSecrets() (*KerberosPasswordSecrets, bool) {
	return nil, false
}
...
// BasicScheduleBase base definition of a schedule
type BasicScheduleBase interface {
	AsRecurrenceSchedule() (*RecurrenceSchedule, bool)
	AsCronSchedule() (*CronSchedule, bool)
	AsScheduleBase() (*ScheduleBase, bool)
}
...
func unmarshalBasicScheduleBase(body []byte) (BasicScheduleBase, error) {
	var m map[string]interface{}
	err := json.Unmarshal(body, &m)
	if err != nil {
		return nil, err
	...
	case string(ScheduleTypeRecurrence):
		var rs RecurrenceSchedule
...
func unmarshalBasicScheduleBaseArray(body []byte) ([]BasicScheduleBase, error) {
	var rawMessages []*json.RawMessage
	err := json.Unmarshal(body, &rawMessages)
	if err != nil {
		return nil, err
	...
	sbArray := make([]BasicScheduleBase, len(rawMessages))

	for index, rawMessage := range rawMessages {
		sb, err := unmarshalBasicScheduleBase(*rawMessage)
		if err != nil {
			return nil, err
		}
		sbArray[index] = sb
...
// MarshalJSON is the custom marshaler for ScheduleBase.
func (sb ScheduleBase) MarshalJSON() ([]byte, error) {
	sb.ScheduleType = ScheduleTypeScheduleBase
	objectMap := make(map[string]interface{})
	if sb.EndTime != nil {
		objectMap["endTime"] = sb.EndTime
	}
	if sb.ScheduleStatus != "" {
		objectMap["scheduleStatus"] = sb.ScheduleStatus
	}
	if sb.StartTime != nil {
		objectMap["startTime"] = sb.StartTime
	}
	if sb.TimeZone != nil {
		objectMap["timeZone"] = sb.TimeZone
	}
	if sb.ScheduleType != "" {
		objectMap["scheduleType"] = sb.ScheduleType
	}
	return json.Marshal(objectMap)
}

// AsRecurrenceSchedule is the BasicScheduleBase implementation for ScheduleBase.
func (sb ScheduleBase) AsRecurrenceSchedule() (*RecurrenceSchedule, bool) {
	return nil, false
}

// AsCronSchedule is the BasicScheduleBase implementation for ScheduleBase.
func (sb ScheduleBase) AsCronSchedule() (*CronSchedule, bool) {
	return nil, false
}

// AsScheduleBase is the BasicScheduleBase implementation for ScheduleBase.
func (sb ScheduleBase) AsScheduleBase() (*ScheduleBase, bool) {
	return &sb, true
}

// AsBasicScheduleBase is the BasicScheduleBase implementation for ScheduleBase.
func (sb ScheduleBase) AsBasicScheduleBase() (BasicScheduleBase, bool) {
	return &sb, true
}
...
// BasicSeasonality forecasting seasonality.
type BasicSeasonality interface {
	AsAutoSeasonality() (*AutoSeasonality, bool)
	AsCustomSeasonality() (*CustomSeasonality, bool)
	AsSeasonality() (*Seasonality, bool)
}
...
func unmarshalBasicSeasonality(body []byte) (BasicSeasonality, error) {
	var m map[string]interface{}
	err := json.Unmarshal(body, &m)
	if err != nil {
		return nil, err
	...
	switch m["mode"] {
	case string(ModeBasicSeasonalityModeAuto):
		var as AutoSeasonality
		err := json.Unmarshal(body, &as)
		return as, err
	case string(ModeBasicSeasonalityModeCustom):
		var cs CustomSeasonality
		err := json.Unmarshal(body, &cs)
		return cs, err
	default:
		var s Seasonality
...
func unmarshalBasicSeasonalityArray(body []byte) ([]BasicSeasonality, error) {
	...
	sArray := make([]BasicSeasonality, len(rawMessages))

	for index, rawMessage := range rawMessages {
		s, err := unmarshalBasicSeasonality(*rawMessage)
		if err != nil {
			return nil, err
		}
		sArray[index] = s
...
// MarshalJSON is the custom marshaler for Seasonality.
func (s Seasonality) MarshalJSON() ([]byte, error) {
	s.Mode = ModeBasicSeasonalityModeSeasonality
	objectMap := make(map[string]interface{})
	if s.Mode != "" {
...
// AsAutoSeasonality is the BasicSeasonality implementation for Seasonality.
func (s Seasonality) AsAutoSeasonality() (*AutoSeasonality, bool) {
	return nil, false
}

// AsCustomSeasonality is the BasicSeasonality implementation for Seasonality.
func (s Seasonality) AsCustomSeasonality() (*CustomSeasonality, bool) {
	return nil, false
}

// AsSeasonality is the BasicSeasonality implementation for Seasonality.
func (s Seasonality) AsSeasonality() (*Seasonality, bool) {
	return &s, true
}

// AsBasicSeasonality is the BasicSeasonality implementation for Seasonality.
func (s Seasonality) AsBasicSeasonality() (BasicSeasonality, bool) {
	return &s, true
}
...
// AsKerberosKeytabSecrets is the BasicDatastoreSecrets implementation for ServicePrincipalDatastoreSecrets.
func (spds ServicePrincipalDatastoreSecrets) AsKerberosKeytabSecrets() (*KerberosKeytabSecrets, bool) {
	return nil, false
}

// AsKerberosPasswordSecrets is the BasicDatastoreSecrets implementation for ServicePrincipalDatastoreSecrets.
func (spds ServicePrincipalDatastoreSecrets) AsKerberosPasswordSecrets() (*KerberosPasswordSecrets, bool) {
	return nil, false
}
...
// AsAutoMLJob is the BasicJobBase implementation for SweepJob.
func (sj SweepJob) AsAutoMLJob() (*AutoMLJob, bool) {
	return nil, false
}
...
// TableVertical abstract class for AutoML tasks that use table dataset as input - such as
...
type TableVerticalFeaturizationSettings struct {
	...
	ColumnNameAndTypes map[string]*string `json:"columnNameAndTypes"`
	// DropColumns - Columns to be dropped from data during featurization.
	...
	// If 'Custom' is selected then user can specify additional inputs to customize how featurization is done. Possible values include: 'Auto', 'Custom', 'Off'
	...
	TransformerParams map[string][]ColumnTransformer `json:"transformerParams"`
	// DatasetLanguage - Dataset language, useful for the text data.
	DatasetLanguage *string `json:"datasetLanguage,omitempty"`
}

// MarshalJSON is the custom marshaler for TableVerticalFeaturizationSettings.
func (tvfs TableVerticalFeaturizationSettings) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if tvfs.BlockedTransformers != nil {
		objectMap["blockedTransformers"] = tvfs.BlockedTransformers
	}
	if tvfs.ColumnNameAndTypes != nil {
		objectMap["columnNameAndTypes"] = tvfs.ColumnNameAndTypes
	}
	if tvfs.DropColumns != nil {
		objectMap["dropColumns"] = tvfs.DropColumns
	}
	if tvfs.EnableDnnFeaturization != nil {
		objectMap["enableDnnFeaturization"] = tvfs.EnableDnnFeaturization
	}
	if tvfs.Mode != "" {
		objectMap["mode"] = tvfs.Mode
	}
	if tvfs.TransformerParams != nil {
		objectMap["transformerParams"] = tvfs.TransformerParams
	}
	if tvfs.DatasetLanguage != nil {
		objectMap["datasetLanguage"] = tvfs.DatasetLanguage
	}
	return json.Marshal(objectMap)
}
...
// TableVerticalValidationDataSettings validation settings for AutoML Table vertical tasks -
// Classification/Regression/Forecasting.
type TableVerticalValidationDataSettings struct {
	...
	NCrossValidations BasicNCrossValidations `json:"nCrossValidations,omitempty"`
	// Data - Validation data MLTable.
	Data *MLTableJobInput `json:"data,omitempty"`
	// ValidationDataSize - The fraction of training dataset that needs to be set aside for validation purpose.
	// Values between (0.0 , 1.0)
...
// UnmarshalJSON is the custom unmarshaler for TableVerticalValidationDataSettings struct.
func (tvvds *TableVerticalValidationDataSettings) UnmarshalJSON(body []byte) error {
	var m map[string]*json.RawMessage
	err := json.Unmarshal(body, &m)
	if err != nil {
		return err
	...
	for k, v := range m {
		...
		case "cvSplitColumnNames":
			if v != nil {
				var cvSplitColumnNames []string
				err = json.Unmarshal(*v, &cvSplitColumnNames)
				if err != nil {
					return err
				}
				tvvds.CvSplitColumnNames = &cvSplitColumnNames
			}
		case "nCrossValidations":
			if v != nil {
				nCrossValidations, err := unmarshalBasicNCrossValidations(*v)
				if err != nil {
					return err
				}
				tvvds.NCrossValidations = nCrossValidations
			}
		case "data":
			if v != nil {
				var data MLTableJobInput
		...
		case "validationDataSize":
			if v != nil {
				var validationDataSize float64
				err = json.Unmarshal(*v, &validationDataSize)
				if err != nil {
					return err
				}
				tvvds.ValidationDataSize = &validationDataSize
			}
		}
	}
...
// BasicTargetLags the number of past periods to lag from the target column.
type BasicTargetLags interface {
	AsAutoTargetLags() (*AutoTargetLags, bool)
	AsCustomTargetLags() (*CustomTargetLags, bool)
	AsTargetLags() (*TargetLags, bool)
}
...
func unmarshalBasicTargetLags(body []byte) (BasicTargetLags, error) {
	var m map[string]interface{}
	err := json.Unmarshal(body, &m)
	if err != nil {
		return nil, err
	...
	switch m["mode"] {
	case string(ModeBasicTargetLagsModeAuto):
		var atl AutoTargetLags
		err := json.Unmarshal(body, &atl)
		return atl, err
	case string(ModeBasicTargetLagsModeCustom):
		var ctl CustomTargetLags
...
func unmarshalBasicTargetLagsArray(body []byte) ([]BasicTargetLags, error) {
	var rawMessages []*json.RawMessage
	err := json.Unmarshal(body, &rawMessages)
	if err != nil {
		return nil, err
	...
	tlArray := make([]BasicTargetLags, len(rawMessages))

	for index, rawMessage := range rawMessages {
		tl, err := unmarshalBasicTargetLags(*rawMessage)
		if err != nil {
			return nil, err
		}
		tlArray[index] = tl
...
// MarshalJSON is the custom marshaler for TargetLags.
func (tl TargetLags) MarshalJSON() ([]byte, error) {
	tl.Mode = ModeBasicTargetLagsModeTargetLags
	objectMap := make(map[string]interface{})
	if tl.Mode != "" {
		objectMap["mode"] = tl.Mode
	}
	return json.Marshal(objectMap)
}

// AsAutoTargetLags is the BasicTargetLags implementation for TargetLags.
func (tl TargetLags) AsAutoTargetLags() (*AutoTargetLags, bool) {
	return nil, false
}

// AsCustomTargetLags is the BasicTargetLags implementation for TargetLags.
func (tl TargetLags) AsCustomTargetLags() (*CustomTargetLags, bool) {
	return nil, false
}

// AsTargetLags is the BasicTargetLags implementation for TargetLags.
func (tl TargetLags) AsTargetLags() (*TargetLags, bool) {
	return &tl, true
}

// AsBasicTargetLags is the BasicTargetLags implementation for TargetLags.
func (tl TargetLags) AsBasicTargetLags() (BasicTargetLags, bool) {
	return &tl, true
}

// BasicTargetRollingWindowSize forecasting target rolling window size.
type BasicTargetRollingWindowSize interface {
	AsAutoTargetRollingWindowSize() (*AutoTargetRollingWindowSize, bool)
	AsCustomTargetRollingWindowSize() (*CustomTargetRollingWindowSize, bool)
	AsTargetRollingWindowSize() (*TargetRollingWindowSize, bool)
}
...
func unmarshalBasicTargetRollingWindowSize(body []byte) (BasicTargetRollingWindowSize, error) {
	var m map[string]interface{}
	err := json.Unmarshal(body, &m)
	if err != nil {
		return nil, err
	...
	switch m["mode"] {
	case string(ModeBasicTargetRollingWindowSizeModeAuto):
		var atrws AutoTargetRollingWindowSize
		err := json.Unmarshal(body, &atrws)
		return atrws, err
	case string(ModeBasicTargetRollingWindowSizeModeCustom):
		var ctrws CustomTargetRollingWindowSize
		err := json.Unmarshal(body, &ctrws)
		return ctrws, err
	default:
		var trws TargetRollingWindowSize
		err := json.Unmarshal(body, &trws)
		return trws, err
	}
}
func unmarshalBasicTargetRollingWindowSizeArray(body []byte) ([]BasicTargetRollingWindowSize, error) {
	var rawMessages []*json.RawMessage
	err := json.Unmarshal(body, &rawMessages)
	if err != nil {
		return nil, err
	...
	trwsArray := make([]BasicTargetRollingWindowSize, len(rawMessages))

	for index, rawMessage := range rawMessages {
		trws, err := unmarshalBasicTargetRollingWindowSize(*rawMessage)
		if err != nil {
			return nil, err
		}
		trwsArray[index] = trws
	}
	return trwsArray, nil
}

// MarshalJSON is the custom marshaler for TargetRollingWindowSize.
func (trws TargetRollingWindowSize) MarshalJSON() ([]byte, error) {
	trws.Mode = ModeBasicTargetRollingWindowSizeModeTargetRollingWindowSize
	objectMap := make(map[string]interface{})
	if trws.Mode != "" {
		objectMap["mode"] = trws.Mode
	}
	return json.Marshal(objectMap)
}

// AsAutoTargetRollingWindowSize is the BasicTargetRollingWindowSize implementation for TargetRollingWindowSize.
func (trws TargetRollingWindowSize) AsAutoTargetRollingWindowSize() (*AutoTargetRollingWindowSize, bool) {
	return nil, false
}

// AsCustomTargetRollingWindowSize is the BasicTargetRollingWindowSize implementation for TargetRollingWindowSize.
func (trws TargetRollingWindowSize) AsCustomTargetRollingWindowSize() (*CustomTargetRollingWindowSize, bool) {
	return nil, false
}

// AsTargetRollingWindowSize is the BasicTargetRollingWindowSize implementation for TargetRollingWindowSize.
func (trws TargetRollingWindowSize) AsTargetRollingWindowSize() (*TargetRollingWindowSize, bool) {
	return &trws, true
}

// AsBasicTargetRollingWindowSize is the BasicTargetRollingWindowSize implementation for TargetRollingWindowSize.
func (trws TargetRollingWindowSize) AsBasicTargetRollingWindowSize() (BasicTargetRollingWindowSize, bool) {
	return &trws, true
}
...
type TextClassification struct {
	...
	// TaskType - [Required] Task type for AutoMLJob. Possible values include: 'TaskTypeClassification', 'TaskTypeRegression', 'TaskTypeForecasting', 'TaskTypeImageClassification', 'TaskTypeImageClassificationMultilabel', 'TaskTypeImageObjectDetection', 'TaskTypeImageInstanceSegmentation', 'TaskTypeTextClassification', 'TaskTypeTextClassificationMultilabel', 'TaskTypeTextNER'
	TaskType TaskType `json:"taskType,omitempty"`
	// PrimaryMetric - Primary metric for Text-Classification task. Possible values include: 'ClassificationPrimaryMetricsAUCWeighted', 'ClassificationPrimaryMetricsAccuracy', 'ClassificationPrimaryMetricsNormMacroRecall', 'ClassificationPrimaryMetricsAveragePrecisionScoreWeighted', 'ClassificationPrimaryMetricsPrecisionScoreWeighted'
	PrimaryMetric ClassificationPrimaryMetrics `json:"primaryMetric,omitempty"`
}
...
type TextClassificationMultilabel struct {
	...
	// TaskType - [Required] Task type for AutoMLJob. Possible values include: 'TaskTypeClassification', 'TaskTypeRegression', 'TaskTypeForecasting', 'TaskTypeImageClassification', 'TaskTypeImageClassificationMultilabel', 'TaskTypeImageObjectDetection', 'TaskTypeImageInstanceSegmentation', 'TaskTypeTextClassification', 'TaskTypeTextClassificationMultilabel', 'TaskTypeTextNER'
	TaskType TaskType `json:"taskType,omitempty"`
	// PrimaryMetric - READ-ONLY; Primary metric for Text-Classification-Multilabel task.
	// Currently only Accuracy is supported as primary metric, hence user need not set it explicitly. Possible values include: 'AUCWeighted', 'Accuracy', 'NormMacroRecall', 'AveragePrecisionScoreWeighted', 'PrecisionScoreWeighted', 'IOU'
	PrimaryMetric ClassificationMultilabelPrimaryMetrics `json:"primaryMetric,omitempty"`
}

// MarshalJSON is the custom marshaler for TextClassificationMultilabel.
func (tcm TextClassificationMultilabel) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if tcm.DataSettings != nil {
		objectMap["dataSettings"] = tcm.DataSettings
	}
	if tcm.FeaturizationSettings != nil {
		objectMap["featurizationSettings"] = tcm.FeaturizationSettings
	}
	if tcm.LimitSettings != nil {
		objectMap["limitSettings"] = tcm.LimitSettings
	}
	if tcm.LogVerbosity != "" {
		objectMap["logVerbosity"] = tcm.LogVerbosity
	}
	if tcm.TaskType != "" {
		objectMap["taskType"] = tcm.TaskType
	}
	return json.Marshal(objectMap)
}
...
type TextNer struct {
	...
	// TaskType - [Required] Task type for AutoMLJob. Possible values include: 'TaskTypeClassification', 'TaskTypeRegression', 'TaskTypeForecasting', 'TaskTypeImageClassification', 'TaskTypeImageClassificationMultilabel', 'TaskTypeImageObjectDetection', 'TaskTypeImageInstanceSegmentation', 'TaskTypeTextClassification', 'TaskTypeTextClassificationMultilabel', 'TaskTypeTextNER'
	TaskType TaskType `json:"taskType,omitempty"`
	// PrimaryMetric - READ-ONLY; Primary metric for Text-NER task.
...
// MarshalJSON is the custom marshaler for TextNer.
func (tn TextNer) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if tn.DataSettings != nil {
		objectMap["dataSettings"] = tn.DataSettings
	}
	if tn.FeaturizationSettings != nil {
		objectMap["featurizationSettings"] = tn.FeaturizationSettings
	}
	if tn.LimitSettings != nil {
		objectMap["limitSettings"] = tn.LimitSettings
	}
	if tn.LogVerbosity != "" {
		objectMap["logVerbosity"] = tn.LogVerbosity
	}
	if tn.TaskType != "" {
		objectMap["taskType"] = tn.TaskType
	}
	return json.Marshal(objectMap)
}
...
type TrainingDataSettings struct {
	// Data - [Required] Training data MLTable.
	Data *MLTableJobInput `json:"data,omitempty"`
}
