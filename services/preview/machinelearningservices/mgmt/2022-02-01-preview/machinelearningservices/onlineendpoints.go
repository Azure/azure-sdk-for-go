...
func (client OnlineEndpointsClient) CreateOrUpdate(ctx context.Context, resourceGroupName string, workspaceName string, endpointName string, body OnlineEndpointTrackedResource) (result OnlineEndpointsCreateOrUpdateFuture, err error) {
	...
	req, err := client.CreateOrUpdatePreparer(ctx, resourceGroupName, workspaceName, endpointName, body)
	if err != nil {
...
func (client OnlineEndpointsClient) CreateOrUpdatePreparer(ctx context.Context, resourceGroupName string, workspaceName string, endpointName string, body OnlineEndpointTrackedResource) (*http.Request, error) {
...
// workspaceName - name of Azure Machine Learning workspace.
// endpointName - online Endpoint name.
func (client OnlineEndpointsClient) Delete(ctx context.Context, resourceGroupName string, workspaceName string, endpointName string) (result OnlineEndpointsDeleteFuture, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.DeletePreparer(ctx, resourceGroupName, workspaceName, endpointName)
	if err != nil {
...
func (client OnlineEndpointsClient) DeletePreparer(ctx context.Context, resourceGroupName string, workspaceName string, endpointName string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"endpointName":      autorest.Encode("path", endpointName),
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"subscriptionId":    autorest.Encode("path", client.SubscriptionID),
...
// workspaceName - name of Azure Machine Learning workspace.
// endpointName - online Endpoint name.
func (client OnlineEndpointsClient) Get(ctx context.Context, resourceGroupName string, workspaceName string, endpointName string) (result OnlineEndpointTrackedResource, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.GetPreparer(ctx, resourceGroupName, workspaceName, endpointName)
	if err != nil {
...
func (client OnlineEndpointsClient) GetPreparer(ctx context.Context, resourceGroupName string, workspaceName string, endpointName string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"endpointName":      autorest.Encode("path", endpointName),
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"subscriptionId":    autorest.Encode("path", client.SubscriptionID),
...
// workspaceName - name of Azure Machine Learning workspace.
// endpointName - online Endpoint name.
func (client OnlineEndpointsClient) GetToken(ctx context.Context, resourceGroupName string, workspaceName string, endpointName string) (result EndpointAuthToken, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.GetTokenPreparer(ctx, resourceGroupName, workspaceName, endpointName)
	if err != nil {
...
func (client OnlineEndpointsClient) GetTokenPreparer(ctx context.Context, resourceGroupName string, workspaceName string, endpointName string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"endpointName":      autorest.Encode("path", endpointName),
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"subscriptionId":    autorest.Encode("path", client.SubscriptionID),
...
// workspaceName - name of Azure Machine Learning workspace.
// endpointName - online Endpoint name.
func (client OnlineEndpointsClient) ListKeys(ctx context.Context, resourceGroupName string, workspaceName string, endpointName string) (result EndpointAuthKeys, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.ListKeysPreparer(ctx, resourceGroupName, workspaceName, endpointName)
	if err != nil {
...
func (client OnlineEndpointsClient) ListKeysPreparer(ctx context.Context, resourceGroupName string, workspaceName string, endpointName string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"endpointName":      autorest.Encode("path", endpointName),
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"subscriptionId":    autorest.Encode("path", client.SubscriptionID),
...
func (client OnlineEndpointsClient) RegenerateKeys(ctx context.Context, resourceGroupName string, workspaceName string, endpointName string, body RegenerateEndpointKeysRequest) (result OnlineEndpointsRegenerateKeysFuture, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.RegenerateKeysPreparer(ctx, resourceGroupName, workspaceName, endpointName, body)
	if err != nil {
...
func (client OnlineEndpointsClient) RegenerateKeysPreparer(ctx context.Context, resourceGroupName string, workspaceName string, endpointName string, body RegenerateEndpointKeysRequest) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"endpointName":      autorest.Encode("path", endpointName),
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"subscriptionId":    autorest.Encode("path", client.SubscriptionID),
...
// endpointName - online Endpoint name.
// body - online Endpoint entity to apply during operation.
func (client OnlineEndpointsClient) Update(ctx context.Context, resourceGroupName string, workspaceName string, endpointName string, body PartialOnlineEndpointPartialTrackedResource) (result OnlineEndpointsUpdateFuture, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.UpdatePreparer(ctx, resourceGroupName, workspaceName, endpointName, body)
	if err != nil {
...
func (client OnlineEndpointsClient) UpdatePreparer(ctx context.Context, resourceGroupName string, workspaceName string, endpointName string, body PartialOnlineEndpointPartialTrackedResource) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"endpointName":      autorest.Encode("path", endpointName),
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"subscriptionId":    autorest.Encode("path", client.SubscriptionID),
