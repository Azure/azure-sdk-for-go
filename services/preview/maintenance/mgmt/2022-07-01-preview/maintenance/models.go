...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/preview/maintenance/mgmt/2022-07-01-preview/maintenance"
...
type ConfigurationProperties struct {
	...
	// MaintenanceScope - Gets or sets maintenanceScope of the configuration. Possible values include: 'ScopeHost', 'ScopeResource', 'ScopeOSImage', 'ScopeExtension', 'ScopeInGuestPatch', 'ScopeSQLDB', 'ScopeSQLManagedInstance'
...
type Update struct {
	// MaintenanceScope - The impact area. Possible values include: 'ScopeHost', 'ScopeResource', 'ScopeOSImage', 'ScopeExtension', 'ScopeInGuestPatch', 'ScopeSQLDB', 'ScopeSQLManagedInstance'
	MaintenanceScope Scope `json:"maintenanceScope,omitempty"`
