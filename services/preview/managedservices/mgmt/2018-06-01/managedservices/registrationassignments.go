...
func (client RegistrationAssignmentsClient) CreateOrUpdate(ctx context.Context, scope string, registrationAssignmentID string, APIVersion string, requestBody RegistrationAssignment) (result RegistrationAssignment, err error) {
...
// registrationAssignmentID - guid of the registration assignment.
// APIVersion - the API version to use for this operation.
func (client RegistrationAssignmentsClient) Delete(ctx context.Context, scope string, registrationAssignmentID string, APIVersion string) (result autorest.Response, err error) {
	if tracing.IsEnabled() {
