...
func unmarshalGeoJSONObjectClassification(rawMsg json.RawMessage) (GeoJSONObjectClassification, error) {
	...
	case string(GeoJSONObjectTypeGeoJSONFeatureCollection):
		b = &ExtendedGeoJSONFeatureCollection{}
...
func unmarshalStyleObjectClassification(rawMsg json.RawMessage) (StyleObjectClassification, error) {
	if rawMsg == nil {
		return nil, nil
	}
	var m map[string]interface{}
	...
	var b StyleObjectClassification
	switch m["type"] {
	case string(StyleObjectTypeBooleanTypeStyleRule):
		b = &BooleanTypeStyleRule{}
	case string(StyleObjectTypeNumberTypeStyleRule):
		b = &NumberTypeStyleRule{}
	case string(StyleObjectTypeStringTypeStyleRule):
		b = &StringTypeStyleRule{}
	default:
		b = &StyleObject{}
	}
	return b, json.Unmarshal(rawMsg, b)
...
func unmarshalStyleObjectClassificationArray(rawMsg json.RawMessage) ([]StyleObjectClassification, error) {
	if rawMsg == nil {
		return nil, nil
	}
	var rawMessages []json.RawMessage
	...
	fArray := make([]StyleObjectClassification, len(rawMessages))
	for index, rawMessage := range rawMessages {
		f, err := unmarshalStyleObjectClassification(rawMessage)
		if err != nil {
			return nil, err
		}
		fArray[index] = f
