...
// ObjectAnchorsAccountsClientAPI contains the set of methods on the ObjectAnchorsAccountsClient type.
type ObjectAnchorsAccountsClientAPI interface {
	Create(ctx context.Context, resourceGroupName string, accountName string, objectAnchorsAccount mixedreality.ObjectAnchorsAccount) (result mixedreality.ObjectAnchorsAccount, err error)
	Delete(ctx context.Context, resourceGroupName string, accountName string) (result autorest.Response, err error)
	Get(ctx context.Context, resourceGroupName string, accountName string) (result mixedreality.ObjectAnchorsAccount, err error)
	ListByResourceGroup(ctx context.Context, resourceGroupName string) (result mixedreality.ObjectAnchorsAccountPagePage, err error)
	ListByResourceGroupComplete(ctx context.Context, resourceGroupName string) (result mixedreality.ObjectAnchorsAccountPageIterator, err error)
	ListBySubscription(ctx context.Context) (result mixedreality.ObjectAnchorsAccountPagePage, err error)
	ListBySubscriptionComplete(ctx context.Context) (result mixedreality.ObjectAnchorsAccountPageIterator, err error)
	ListKeys(ctx context.Context, resourceGroupName string, accountName string) (result mixedreality.AccountKeys, err error)
	RegenerateKeys(ctx context.Context, resourceGroupName string, accountName string, regenerate mixedreality.AccountKeyRegenerateRequest) (result mixedreality.AccountKeys, err error)
	Update(ctx context.Context, resourceGroupName string, accountName string, objectAnchorsAccount mixedreality.ObjectAnchorsAccount) (result mixedreality.ObjectAnchorsAccount, err error)
}

var _ ObjectAnchorsAccountsClientAPI = (*mixedreality.ObjectAnchorsAccountsClient)(nil)
