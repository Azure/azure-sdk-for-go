...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/preview/mixedreality/mgmt/2021-03-01-preview/mixedreality"
...
// MarshalJSON is the custom marshaler for ObjectAnchorsAccount.
func (oaa ObjectAnchorsAccount) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if oaa.Identity != nil {
		objectMap["identity"] = oaa.Identity
	}
	...
	if oaa.Location != nil {
		objectMap["location"] = oaa.Location
	}
	return json.Marshal(objectMap)
}

// UnmarshalJSON is the custom unmarshaler for ObjectAnchorsAccount struct.
func (oaa *ObjectAnchorsAccount) UnmarshalJSON(body []byte) error {
...
// MarshalJSON is the custom marshaler for ObjectAnchorsAccountIdentity.
func (oaa ObjectAnchorsAccountIdentity) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if oaa.Type != "" {
...
// ObjectAnchorsAccountPage result of the request to get resource collection. It contains a list of
...
// ObjectAnchorsAccountPageIterator provides access to a complete listing of ObjectAnchorsAccount values.
type ObjectAnchorsAccountPageIterator struct {
	i    int
	page ObjectAnchorsAccountPagePage
}

// NextWithContext advances to the next value.  If there was an error making
// the request the iterator does not advance and the error is returned.
func (iter *ObjectAnchorsAccountPageIterator) NextWithContext(ctx context.Context) (err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/ObjectAnchorsAccountPageIterator.NextWithContext")
		defer func() {
			sc := -1
...
func (iter *ObjectAnchorsAccountPageIterator) Next() error {
	return iter.NextWithContext(context.Background())
}

// NotDone returns true if the enumeration should be started or is not yet complete.
func (iter ObjectAnchorsAccountPageIterator) NotDone() bool {
	return iter.page.NotDone() && iter.i < len(iter.page.Values())
}

// Response returns the raw server response from the last page request.
func (iter ObjectAnchorsAccountPageIterator) Response() ObjectAnchorsAccountPage {
	return iter.page.Response()
}

// Value returns the current value or a zero-initialized value if the
// iterator has advanced beyond the end of the collection.
func (iter ObjectAnchorsAccountPageIterator) Value() ObjectAnchorsAccount {
	if !iter.page.NotDone() {
		return ObjectAnchorsAccount{}
	}
	return iter.page.Values()[iter.i]
}

// Creates a new instance of the ObjectAnchorsAccountPageIterator type.
func NewObjectAnchorsAccountPageIterator(page ObjectAnchorsAccountPagePage) ObjectAnchorsAccountPageIterator {
	return ObjectAnchorsAccountPageIterator{page: page}
}

// IsEmpty returns true if the ListResult contains no values.
func (oaap ObjectAnchorsAccountPage) IsEmpty() bool {
	return oaap.Value == nil || len(*oaap.Value) == 0
}

// hasNextLink returns true if the NextLink is not empty.
func (oaap ObjectAnchorsAccountPage) hasNextLink() bool {
	return oaap.NextLink != nil && len(*oaap.NextLink) != 0
}

// objectAnchorsAccountPagePreparer prepares a request to retrieve the next set of results.
// It returns nil if no more results exist.
func (oaap ObjectAnchorsAccountPage) objectAnchorsAccountPagePreparer(ctx context.Context) (*http.Request, error) {
	if !oaap.hasNextLink() {
		return nil, nil
	}
	return autorest.Prepare((&http.Request{}).WithContext(ctx),
		autorest.AsJSON(),
		autorest.AsGet(),
		autorest.WithBaseURL(to.String(oaap.NextLink)))
}

// ObjectAnchorsAccountPagePage contains a page of ObjectAnchorsAccount values.
type ObjectAnchorsAccountPagePage struct {
	fn   func(context.Context, ObjectAnchorsAccountPage) (ObjectAnchorsAccountPage, error)
	oaap ObjectAnchorsAccountPage
}

// NextWithContext advances to the next page of values.  If there was an error making
// the request the page does not advance and the error is returned.
func (page *ObjectAnchorsAccountPagePage) NextWithContext(ctx context.Context) (err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/ObjectAnchorsAccountPagePage.NextWithContext")
		defer func() {
			sc := -1
	...
	for {
		next, err := page.fn(ctx, page.oaap)
		if err != nil {
			return err
		}
		page.oaap = next
...
// the request the page does not advance and the error is returned.
// Deprecated: Use NextWithContext() instead.
func (page *ObjectAnchorsAccountPagePage) Next() error {
	return page.NextWithContext(context.Background())
}

// NotDone returns true if the page enumeration should be started or is not yet complete.
func (page ObjectAnchorsAccountPagePage) NotDone() bool {
	return !page.oaap.IsEmpty()
}

// Response returns the raw server response from the last page request.
func (page ObjectAnchorsAccountPagePage) Response() ObjectAnchorsAccountPage {
	return page.oaap
}

// Values returns the slice of values for the current page or nil if there are no values.
func (page ObjectAnchorsAccountPagePage) Values() []ObjectAnchorsAccount {
	if page.oaap.IsEmpty() {
		return nil
	}
	return *page.oaap.Value
}

// Creates a new instance of the ObjectAnchorsAccountPagePage type.
func NewObjectAnchorsAccountPagePage(cur ObjectAnchorsAccountPage, getNextPage func(context.Context, ObjectAnchorsAccountPage) (ObjectAnchorsAccountPage, error)) ObjectAnchorsAccountPagePage {
	return ObjectAnchorsAccountPagePage{
		fn:   getNextPage,
		oaap: cur,
	}
}
