...
func (client EventCategoriesClient) List(ctx context.Context) (result EventCategoryCollection, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "monitorlegacy.EventCategoriesClient", "List", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "monitorlegacy.EventCategoriesClient", "List", resp, "Failure sending request")
		return
	}

	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "monitorlegacy.EventCategoriesClient", "List", resp, "Failure responding to request")
		return
	}
