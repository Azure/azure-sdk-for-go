...
const (
	...
	// OdataTypeAlertingAction ...
	OdataTypeAlertingAction OdataTypeBasicAction = "AlertingAction"
	// OdataTypeLogToMetricAction ...
	OdataTypeLogToMetricAction OdataTypeBasicAction = "LogToMetricAction"
)
...
func PossibleOdataTypeBasicActionValues() []OdataTypeBasicAction {
	return []OdataTypeBasicAction{OdataTypeAction, OdataTypeAlertingAction, OdataTypeLogToMetricAction}
}
...
type Action struct {
	// OdataType - Possible values include: 'OdataTypeAction', 'OdataTypeAlertingAction', 'OdataTypeLogToMetricAction'
...
func unmarshalBasicAction(body []byte) (BasicAction, error) {
	...
	switch m["odata.type"] {
	case string(OdataTypeAlertingAction):
		var aa AlertingAction
		err := json.Unmarshal(body, &aa)
		return aa, err
	case string(OdataTypeLogToMetricAction):
...
func (aa AlertingAction) MarshalJSON() ([]byte, error) {
	aa.OdataType = OdataTypeAlertingAction
	objectMap := make(map[string]interface{})
	if aa.Severity != "" {
...
func (ltma LogToMetricAction) MarshalJSON() ([]byte, error) {
	ltma.OdataType = OdataTypeLogToMetricAction
	objectMap := make(map[string]interface{})
