...
func (client DataCollectionRuleAssociationsClient) Create(ctx context.Context, resourceURI string, associationName string, body *DataCollectionRuleAssociationProxyOnlyResource) (result DataCollectionRuleAssociationProxyOnlyResource, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		{TargetValue: resourceURI,
			Constraints: []validation.Constraint{{Target: "resourceURI", Name: validation.MinLength, Rule: 1, Chain: nil}}},
		{TargetValue: associationName,
			Constraints: []validation.Constraint{{Target: "associationName", Name: validation.MaxLength, Rule: 64, Chain: nil},
				{Target: "associationName", Name: validation.MinLength, Rule: 1, Chain: nil},
				{Target: "associationName", Name: validation.Pattern, Rule: `^[-\w\._\(\)]+$`, Chain: nil}}},
		{TargetValue: body,
			Constraints: []validation.Constraint{{Target: "body", Name: validation.Null, Rule: false,
				Chain: []validation.Constraint{{Target: "body.DataCollectionRuleAssociationProxyOnlyResourceProperties", Name: validation.Null, Rule: true, Chain: nil}}}}}}); err != nil {
...
func (client DataCollectionRuleAssociationsClient) Delete(ctx context.Context, resourceURI string, associationName string) (result autorest.Response, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		{TargetValue: associationName,
			Constraints: []validation.Constraint{{Target: "associationName", Name: validation.MaxLength, Rule: 64, Chain: nil},
				{Target: "associationName", Name: validation.MinLength, Rule: 1, Chain: nil},
				{Target: "associationName", Name: validation.Pattern, Rule: `^[-\w\._\(\)]+$`, Chain: nil}}}}); err != nil {
...
func (client DataCollectionRuleAssociationsClient) ListByRule(ctx context.Context, resourceGroupName string, dataCollectionRuleName string) (result DataCollectionRuleAssociationProxyOnlyResourceListResultPage, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		{TargetValue: dataCollectionRuleName,
			Constraints: []validation.Constraint{{Target: "dataCollectionRuleName", Name: validation.MaxLength, Rule: 64, Chain: nil},
				{Target: "dataCollectionRuleName", Name: validation.MinLength, Rule: 1, Chain: nil},
				{Target: "dataCollectionRuleName", Name: validation.Pattern, Rule: `^[-\w\._\(\)]+$`, Chain: nil}}}}); err != nil {
