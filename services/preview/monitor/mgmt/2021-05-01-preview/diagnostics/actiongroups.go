...
func (client ActionGroupsClient) CreateNotificationsAtActionGroupResourceLevel(ctx context.Context, resourceGroupName string, actionGroupName string, notificationRequest NotificationRequestBody) (result ActionGroupsCreateNotificationsAtActionGroupResourceLevelFuture, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/ActionGroupsClient.CreateNotificationsAtActionGroupResourceLevel")
		defer func() {
			sc := -1
	...
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewError("diagnostics.ActionGroupsClient", "CreateNotificationsAtActionGroupResourceLevel", err.Error())
	}

	req, err := client.CreateNotificationsAtActionGroupResourceLevelPreparer(ctx, resourceGroupName, actionGroupName, notificationRequest)
	if err != nil {
		err = autorest.NewErrorWithError(err, "diagnostics.ActionGroupsClient", "CreateNotificationsAtActionGroupResourceLevel", nil, "Failure preparing request")
		return
	}

	result, err = client.CreateNotificationsAtActionGroupResourceLevelSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "diagnostics.ActionGroupsClient", "CreateNotificationsAtActionGroupResourceLevel", result.Response(), "Failure sending request")
		return
	}
...
func (client ActionGroupsClient) CreateNotificationsAtActionGroupResourceLevelPreparer(ctx context.Context, resourceGroupName string, actionGroupName string, notificationRequest NotificationRequestBody) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithPathParameters("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Insights/actionGroups/{actionGroupName}/createNotifications", pathParameters),
		autorest.WithJSON(notificationRequest),
		autorest.WithQueryParameters(queryParameters))
	return preparer.Prepare((&http.Request{}).WithContext(ctx))
}

// CreateNotificationsAtActionGroupResourceLevelSender sends the CreateNotificationsAtActionGroupResourceLevel request. The method will close the
...
// CreateNotificationsAtActionGroupResourceLevelResponder handles the response to the CreateNotificationsAtActionGroupResourceLevel request. The method always
...
func (client ActionGroupsClient) CreateNotificationsAtResourceGroupLevel(ctx context.Context, resourceGroupName string, notificationRequest NotificationRequestBody) (result ActionGroupsCreateNotificationsAtResourceGroupLevelFuture, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/ActionGroupsClient.CreateNotificationsAtResourceGroupLevel")
		defer func() {
			sc := -1
			if result.FutureAPI != nil && result.FutureAPI.Response() != nil {
				sc = result.FutureAPI.Response().StatusCode
	...
	if err := validation.Validate([]validation.Validation{
		...
		{TargetValue: notificationRequest,
			Constraints: []validation.Constraint{{Target: "notificationRequest.AlertType", Name: validation.Null, Rule: true,
				Chain: []validation.Constraint{{Target: "notificationRequest.AlertType", Name: validation.MaxLength, Rule: 30, Chain: nil}}}}}}); err != nil {
		return result, validation.NewError("diagnostics.ActionGroupsClient", "CreateNotificationsAtResourceGroupLevel", err.Error())
	}

	req, err := client.CreateNotificationsAtResourceGroupLevelPreparer(ctx, resourceGroupName, notificationRequest)
	if err != nil {
		err = autorest.NewErrorWithError(err, "diagnostics.ActionGroupsClient", "CreateNotificationsAtResourceGroupLevel", nil, "Failure preparing request")
		return
	}

	result, err = client.CreateNotificationsAtResourceGroupLevelSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "diagnostics.ActionGroupsClient", "CreateNotificationsAtResourceGroupLevel", result.Response(), "Failure sending request")
		return
	}
...
func (client ActionGroupsClient) CreateNotificationsAtResourceGroupLevelPreparer(ctx context.Context, resourceGroupName string, notificationRequest NotificationRequestBody) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.AsPost(),
		autorest.WithBaseURL(client.BaseURI),
		autorest.WithPathParameters("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Insights/createNotifications", pathParameters),
		autorest.WithJSON(notificationRequest),
		autorest.WithQueryParameters(queryParameters))
	return preparer.Prepare((&http.Request{}).WithContext(ctx))
}

// CreateNotificationsAtResourceGroupLevelSender sends the CreateNotificationsAtResourceGroupLevel request. The method will close the
// http.Response Body if it receives an error.
...
// CreateNotificationsAtResourceGroupLevelResponder handles the response to the CreateNotificationsAtResourceGroupLevel request. The method always
// closes the http.Response Body.
...
func (client ActionGroupsClient) GetTestNotificationsAtActionGroupResourceLevel(ctx context.Context, resourceGroupName string, actionGroupName string, notificationID string) (result TestNotificationDetailsResponse, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/ActionGroupsClient.GetTestNotificationsAtActionGroupResourceLevel")
		defer func() {
			sc := -1
			if result.Response.Response != nil {
				sc = result.Response.Response.StatusCode
	...
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewError("diagnostics.ActionGroupsClient", "GetTestNotificationsAtActionGroupResourceLevel", err.Error())
	}

	req, err := client.GetTestNotificationsAtActionGroupResourceLevelPreparer(ctx, resourceGroupName, actionGroupName, notificationID)
	if err != nil {
		err = autorest.NewErrorWithError(err, "diagnostics.ActionGroupsClient", "GetTestNotificationsAtActionGroupResourceLevel", nil, "Failure preparing request")
		return
	}

	resp, err := client.GetTestNotificationsAtActionGroupResourceLevelSender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "diagnostics.ActionGroupsClient", "GetTestNotificationsAtActionGroupResourceLevel", resp, "Failure sending request")
		return
	}

	result, err = client.GetTestNotificationsAtActionGroupResourceLevelResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "diagnostics.ActionGroupsClient", "GetTestNotificationsAtActionGroupResourceLevel", resp, "Failure responding to request")
		return
	}
...
func (client ActionGroupsClient) GetTestNotificationsAtActionGroupResourceLevelPreparer(ctx context.Context, resourceGroupName string, actionGroupName string, notificationID string) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		autorest.AsGet(),
		autorest.WithBaseURL(client.BaseURI),
		autorest.WithPathParameters("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Insights/actionGroups/{actionGroupName}/notificationStatus/{notificationId}", pathParameters),
		autorest.WithQueryParameters(queryParameters))
	return preparer.Prepare((&http.Request{}).WithContext(ctx))
}

// GetTestNotificationsAtActionGroupResourceLevelSender sends the GetTestNotificationsAtActionGroupResourceLevel request. The method will close the
// http.Response Body if it receives an error.
func (client ActionGroupsClient) GetTestNotificationsAtActionGroupResourceLevelSender(req *http.Request) (*http.Response, error) {
	return client.Send(req, azure.DoRetryWithRegistration(client.Client))
}

// GetTestNotificationsAtActionGroupResourceLevelResponder handles the response to the GetTestNotificationsAtActionGroupResourceLevel request. The method always
// closes the http.Response Body.
...
func (client ActionGroupsClient) GetTestNotificationsAtResourceGroupLevel(ctx context.Context, resourceGroupName string, notificationID string) (result TestNotificationDetailsResponse, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/ActionGroupsClient.GetTestNotificationsAtResourceGroupLevel")
		defer func() {
			sc := -1
			if result.Response.Response != nil {
				sc = result.Response.Response.StatusCode
	...
	if err := validation.Validate([]validation.Validation{
		...
		{TargetValue: resourceGroupName,
			Constraints: []validation.Constraint{{Target: "resourceGroupName", Name: validation.MaxLength, Rule: 90, Chain: nil},
				{Target: "resourceGroupName", Name: validation.MinLength, Rule: 1, Chain: nil}}}}); err != nil {
		return result, validation.NewError("diagnostics.ActionGroupsClient", "GetTestNotificationsAtResourceGroupLevel", err.Error())
	}

	req, err := client.GetTestNotificationsAtResourceGroupLevelPreparer(ctx, resourceGroupName, notificationID)
	if err != nil {
		err = autorest.NewErrorWithError(err, "diagnostics.ActionGroupsClient", "GetTestNotificationsAtResourceGroupLevel", nil, "Failure preparing request")
		return
	}

	resp, err := client.GetTestNotificationsAtResourceGroupLevelSender(req)
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "diagnostics.ActionGroupsClient", "GetTestNotificationsAtResourceGroupLevel", resp, "Failure sending request")
		return
	}

	result, err = client.GetTestNotificationsAtResourceGroupLevelResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "diagnostics.ActionGroupsClient", "GetTestNotificationsAtResourceGroupLevel", resp, "Failure responding to request")
		return
	}
...
func (client ActionGroupsClient) GetTestNotificationsAtResourceGroupLevelPreparer(ctx context.Context, resourceGroupName string, notificationID string) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		autorest.AsGet(),
		autorest.WithBaseURL(client.BaseURI),
		autorest.WithPathParameters("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Insights/notificationStatus/{notificationId}", pathParameters),
		autorest.WithQueryParameters(queryParameters))
	return preparer.Prepare((&http.Request{}).WithContext(ctx))
}

// GetTestNotificationsAtResourceGroupLevelSender sends the GetTestNotificationsAtResourceGroupLevel request. The method will close the
// http.Response Body if it receives an error.
func (client ActionGroupsClient) GetTestNotificationsAtResourceGroupLevelSender(req *http.Request) (*http.Response, error) {
	return client.Send(req, azure.DoRetryWithRegistration(client.Client))
}

// GetTestNotificationsAtResourceGroupLevelResponder handles the response to the GetTestNotificationsAtResourceGroupLevel request. The method always
// closes the http.Response Body.
