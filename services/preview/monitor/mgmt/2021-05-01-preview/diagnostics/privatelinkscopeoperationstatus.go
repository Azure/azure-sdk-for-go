...
func (client PrivateLinkScopeOperationStatusClient) Get(ctx context.Context, asyncOperationID string, resourceGroupName string) (result OperationStatus, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewError("diagnostics.PrivateLinkScopeOperationStatusClient", "Get", err.Error())
	}

	req, err := client.GetPreparer(ctx, asyncOperationID, resourceGroupName)
	if err != nil {
		err = autorest.NewErrorWithError(err, "diagnostics.PrivateLinkScopeOperationStatusClient", "Get", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "diagnostics.PrivateLinkScopeOperationStatusClient", "Get", resp, "Failure sending request")
		return
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "diagnostics.PrivateLinkScopeOperationStatusClient", "Get", resp, "Failure responding to request")
		return
	}
