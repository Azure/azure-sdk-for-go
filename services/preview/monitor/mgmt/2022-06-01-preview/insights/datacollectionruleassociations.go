...
func (client DataCollectionRuleAssociationsClient) ListByDataCollectionEndpoint(ctx context.Context, resourceGroupName string, dataCollectionEndpointName string) (result DataCollectionRuleAssociationProxyOnlyResourceListResultPage, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/DataCollectionRuleAssociationsClient.ListByDataCollectionEndpoint")
		defer func() {
			sc := -1
	...
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewError("insights.DataCollectionRuleAssociationsClient", "ListByDataCollectionEndpoint", err.Error())
	}
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "insights.DataCollectionRuleAssociationsClient", "ListByDataCollectionEndpoint", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "insights.DataCollectionRuleAssociationsClient", "ListByDataCollectionEndpoint", resp, "Failure sending request")
		return
	}

	result.dcraporlr, err = client.ListByDataCollectionEndpointResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "insights.DataCollectionRuleAssociationsClient", "ListByDataCollectionEndpoint", resp, "Failure responding to request")
		return
	}
...
func (client DataCollectionRuleAssociationsClient) listByDataCollectionEndpointNextResults(ctx context.Context, lastResults DataCollectionRuleAssociationProxyOnlyResourceListResult) (result DataCollectionRuleAssociationProxyOnlyResourceListResult, err error) {
	req, err := lastResults.dataCollectionRuleAssociationProxyOnlyResourceListResultPreparer(ctx)
	if err != nil {
		return result, autorest.NewErrorWithError(err, "insights.DataCollectionRuleAssociationsClient", "listByDataCollectionEndpointNextResults", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "insights.DataCollectionRuleAssociationsClient", "listByDataCollectionEndpointNextResults", resp, "Failure sending next results request")
	}
	result, err = client.ListByDataCollectionEndpointResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "insights.DataCollectionRuleAssociationsClient", "listByDataCollectionEndpointNextResults", resp, "Failure responding to next results request")
	}
	return
}
