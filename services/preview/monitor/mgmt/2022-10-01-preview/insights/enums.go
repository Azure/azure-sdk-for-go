...
// ConditionOperatorForCondition enumerates the values for condition operator for condition.
type ConditionOperatorForCondition string

const (
	// ConditionOperatorForConditionEquals ...
	ConditionOperatorForConditionEquals ConditionOperatorForCondition = "Equals"
	// ConditionOperatorForConditionGreaterThan ...
	ConditionOperatorForConditionGreaterThan ConditionOperatorForCondition = "GreaterThan"
	// ConditionOperatorForConditionGreaterThanOrEqual ...
	ConditionOperatorForConditionGreaterThanOrEqual ConditionOperatorForCondition = "GreaterThanOrEqual"
	// ConditionOperatorForConditionLessThan ...
	ConditionOperatorForConditionLessThan ConditionOperatorForCondition = "LessThan"
	// ConditionOperatorForConditionLessThanOrEqual ...
	ConditionOperatorForConditionLessThanOrEqual ConditionOperatorForCondition = "LessThanOrEqual"
)

// PossibleConditionOperatorForConditionValues returns an array of possible values for the ConditionOperatorForCondition const type.
func PossibleConditionOperatorForConditionValues() []ConditionOperatorForCondition {
	return []ConditionOperatorForCondition{ConditionOperatorForConditionEquals, ConditionOperatorForConditionGreaterThan, ConditionOperatorForConditionGreaterThanOrEqual, ConditionOperatorForConditionLessThan, ConditionOperatorForConditionLessThanOrEqual}
}
