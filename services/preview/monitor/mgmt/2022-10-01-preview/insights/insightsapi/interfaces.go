...
type PredictiveMetricClientAPI interface {
	Get(ctx context.Context, resourceGroupName string, autoscaleSettingName string, aggregation string, timespan string, interval *string, metricnamespace string, metricnames string) (result insights.PredictiveResponse, err error)
}

var _ PredictiveMetricClientAPI = (*insights.PredictiveMetricClient)(nil)
