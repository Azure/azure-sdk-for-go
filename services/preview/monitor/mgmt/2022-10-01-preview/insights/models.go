...
type Condition struct {
	...
	// Operator - The criteria operator. Relevant and required only for rules of the kind LogAlert. Possible values include: 'ConditionOperatorForConditionEquals', 'ConditionOperatorForConditionGreaterThan', 'ConditionOperatorForConditionGreaterThanOrEqual', 'ConditionOperatorForConditionLessThan', 'ConditionOperatorForConditionLessThanOrEqual'
	Operator ConditionOperatorForCondition `json:"operator,omitempty"`
