...
func (client PredictiveMetricClient) Get(ctx context.Context, resourceGroupName string, autoscaleSettingName string, aggregation string, timespan string, interval *string, metricnamespace string, metricnames string) (result PredictiveResponse, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewError("insights.PredictiveMetricClient", "Get", err.Error())
	}

	req, err := client.GetPreparer(ctx, resourceGroupName, autoscaleSettingName, aggregation, timespan, interval, metricnamespace, metricnames)
	if err != nil {
		err = autorest.NewErrorWithError(err, "insights.PredictiveMetricClient", "Get", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "insights.PredictiveMetricClient", "Get", resp, "Failure sending request")
		return
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "insights.PredictiveMetricClient", "Get", resp, "Failure responding to request")
		return
	}
...
func (client PredictiveMetricClient) GetPreparer(ctx context.Context, resourceGroupName string, autoscaleSettingName string, aggregation string, timespan string, interval *string, metricnamespace string, metricnames string) (*http.Request, error) {
