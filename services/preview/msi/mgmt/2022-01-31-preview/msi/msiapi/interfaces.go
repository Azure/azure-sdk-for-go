...
type UserAssignedIdentitiesClientAPI interface {
	...
	ListAssociatedResources(ctx context.Context, resourceGroupName string, resourceName string, filter string, orderby string, top *int32, skip *int32, skiptoken string) (result msi.AssociatedResourcesListResultPage, err error)
	ListAssociatedResourcesComplete(ctx context.Context, resourceGroupName string, resourceName string, filter string, orderby string, top *int32, skip *int32, skiptoken string) (result msi.AssociatedResourcesListResultIterator, err error)
...
// FederatedIdentityCredentialsClientAPI contains the set of methods on the FederatedIdentityCredentialsClient type.
type FederatedIdentityCredentialsClientAPI interface {
	CreateOrUpdate(ctx context.Context, resourceGroupName string, resourceName string, federatedIdentityCredentialResourceName string, parameters msi.FederatedIdentityCredential) (result msi.FederatedIdentityCredential, err error)
	Delete(ctx context.Context, resourceGroupName string, resourceName string, federatedIdentityCredentialResourceName string) (result autorest.Response, err error)
	Get(ctx context.Context, resourceGroupName string, resourceName string, federatedIdentityCredentialResourceName string) (result msi.FederatedIdentityCredential, err error)
	List(ctx context.Context, resourceGroupName string, resourceName string, top *int32, skiptoken string) (result msi.FederatedIdentityCredentialsListResultPage, err error)
	ListComplete(ctx context.Context, resourceGroupName string, resourceName string, top *int32, skiptoken string) (result msi.FederatedIdentityCredentialsListResultIterator, err error)
}

var _ FederatedIdentityCredentialsClientAPI = (*msi.FederatedIdentityCredentialsClient)(nil)
