...
// ServerAdministratorProperties the properties used to create a new external administrator.
type ServerAdministratorProperties struct {
	// AdministratorType - The administrator type.
	AdministratorType *string `json:"administratorType,omitempty"`
	// Login - The administrator login.
	Login *string `json:"login,omitempty"`
	// Sid - The administrator sid.
	Sid *string `json:"sid,omitempty"`
	// TenantID - The administrator tenantId.
