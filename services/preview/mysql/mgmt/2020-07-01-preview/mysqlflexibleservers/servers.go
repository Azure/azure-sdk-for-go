...
func (client ServersClient) CreateSender(req *http.Request) (future ServersCreateFuture, err error) {
	...
	future.Result = func(client ServersClient) (s Server, err error) {
		...
		if s.Response.Response == nil && err == nil {
			err = autorest.NewErrorWithError(err, "mysqlflexibleservers.ServersCreateFuture", "Result", nil, "received nil response and error")
		}
...
func (client ServersClient) UpdateSender(req *http.Request) (future ServersUpdateFuture, err error) {
	...
	future.Result = func(client ServersClient) (s Server, err error) {
		...
		s.Response.Response, err = future.GetResult(sender)
		if s.Response.Response == nil && err == nil {
			err = autorest.NewErrorWithError(err, "mysqlflexibleservers.ServersUpdateFuture", "Result", nil, "received nil response and error")
		}
		if err == nil && s.Response.Response.StatusCode != http.StatusNoContent {
