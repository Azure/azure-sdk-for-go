...
// ruleCollectionName - the name of the network manager security Configuration rule collection.
// ruleName - the name of the rule.
func (client AdminRulesClient) Delete(ctx context.Context, resourceGroupName string, networkManagerName string, configurationName string, ruleCollectionName string, ruleName string) (result autorest.Response, err error) {
	if tracing.IsEnabled() {
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "network.AdminRulesClient", "Delete", resp, "Failure sending request")
		return
	}

	result, err = client.DeleteResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "network.AdminRulesClient", "Delete", resp, "Failure responding to request")
		return
	}
...
func (client AdminRulesClient) DeletePreparer(ctx context.Context, resourceGroupName string, networkManagerName string, configurationName string, ruleCollectionName string, ruleName string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"configurationName":  autorest.Encode("path", configurationName),
		"networkManagerName": autorest.Encode("path", networkManagerName),
		"resourceGroupName":  autorest.Encode("path", resourceGroupName),
...
// http.Response Body if it receives an error.
func (client AdminRulesClient) DeleteSender(req *http.Request) (*http.Response, error) {
	return client.Send(req, azure.DoRetryWithRegistration(client.Client))
}
