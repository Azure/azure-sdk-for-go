...
// AccessRuleDirection enumerates the values for access rule direction.
type AccessRuleDirection string

const (
	// Inbound ...
	Inbound AccessRuleDirection = "Inbound"
	// Outbound ...
	Outbound AccessRuleDirection = "Outbound"
)

// PossibleAccessRuleDirectionValues returns an array of possible values for the AccessRuleDirection const type.
func PossibleAccessRuleDirectionValues() []AccessRuleDirection {
	return []AccessRuleDirection{Inbound, Outbound}
}
...
// AssociationAccessMode enumerates the values for association access mode.
type AssociationAccessMode string

const (
	// Audit ...
	Audit AssociationAccessMode = "Audit"
	// Enforced ...
	Enforced AssociationAccessMode = "Enforced"
	// Learning ...
	Learning AssociationAccessMode = "Learning"
)

// PossibleAssociationAccessModeValues returns an array of possible values for the AssociationAccessMode const type.
func PossibleAssociationAccessModeValues() []AssociationAccessMode {
	return []AssociationAccessMode{Audit, Enforced, Learning}
}
...
// NspProvisioningState enumerates the values for nsp provisioning state.
...
// PossibleNspProvisioningStateValues returns an array of possible values for the NspProvisioningState const type.
func PossibleNspProvisioningStateValues() []NspProvisioningState {
	return []NspProvisioningState{NspProvisioningStateAccepted, NspProvisioningStateCreating, NspProvisioningStateDeleting, NspProvisioningStateFailed, NspProvisioningStateSucceeded, NspProvisioningStateUpdating}
}
