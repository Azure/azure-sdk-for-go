...
// DataExportCreateOrUpdateFuture an abstraction for monitoring and retrieving the results of a long-running
// operation.
...
func NewDataExportListResultPage(getNextPage func(context.Context, DataExportListResult) (DataExportListResult, error)) DataExportListResultPage {
	return DataExportListResultPage{fn: getNextPage}
}
