...
// QueryPacksClientAPI contains the set of methods on the QueryPacksClient type.
type QueryPacksClientAPI interface {
	CreateOrUpdate(ctx context.Context, resourceGroupName string, queryPackName string, logAnalyticsQueryPackPayload operationalinsights.LogAnalyticsQueryPack) (result operationalinsights.LogAnalyticsQueryPack, err error)
	CreateOrUpdateWithoutName(ctx context.Context, resourceGroupName string, logAnalyticsQueryPackPayload operationalinsights.LogAnalyticsQueryPack) (result operationalinsights.LogAnalyticsQueryPack, err error)
	Delete(ctx context.Context, resourceGroupName string, queryPackName string) (result autorest.Response, err error)
	Get(ctx context.Context, resourceGroupName string, queryPackName string) (result operationalinsights.LogAnalyticsQueryPack, err error)
	List(ctx context.Context) (result operationalinsights.LogAnalyticsQueryPackListResultPage, err error)
	ListComplete(ctx context.Context) (result operationalinsights.LogAnalyticsQueryPackListResultIterator, err error)
	ListByResourceGroup(ctx context.Context, resourceGroupName string) (result operationalinsights.LogAnalyticsQueryPackListResultPage, err error)
	ListByResourceGroupComplete(ctx context.Context, resourceGroupName string) (result operationalinsights.LogAnalyticsQueryPackListResultIterator, err error)
	UpdateTags(ctx context.Context, resourceGroupName string, queryPackName string, queryPackTags operationalinsights.TagsResource) (result operationalinsights.LogAnalyticsQueryPack, err error)
}

var _ QueryPacksClientAPI = (*operationalinsights.QueryPacksClient)(nil)

// QueriesClientAPI contains the set of methods on the QueriesClient type.
type QueriesClientAPI interface {
	Delete(ctx context.Context, resourceGroupName string, queryPackName string, ID string) (result autorest.Response, err error)
	Get(ctx context.Context, resourceGroupName string, queryPackName string, ID string) (result operationalinsights.LogAnalyticsQueryPackQuery, err error)
	List(ctx context.Context, resourceGroupName string, queryPackName string, top *int64, includeBody *bool, skipToken string) (result operationalinsights.LogAnalyticsQueryPackQueryListResultPage, err error)
	ListComplete(ctx context.Context, resourceGroupName string, queryPackName string, top *int64, includeBody *bool, skipToken string) (result operationalinsights.LogAnalyticsQueryPackQueryListResultIterator, err error)
	Put(ctx context.Context, resourceGroupName string, queryPackName string, ID string, queryPayload operationalinsights.LogAnalyticsQueryPackQuery) (result operationalinsights.LogAnalyticsQueryPackQuery, err error)
	Search(ctx context.Context, resourceGroupName string, queryPackName string, querySearchProperties operationalinsights.LogAnalyticsQueryPackQuerySearchProperties, top *int64, includeBody *bool, skipToken string) (result operationalinsights.LogAnalyticsQueryPackQueryListResultPage, err error)
	SearchComplete(ctx context.Context, resourceGroupName string, queryPackName string, querySearchProperties operationalinsights.LogAnalyticsQueryPackQuerySearchProperties, top *int64, includeBody *bool, skipToken string) (result operationalinsights.LogAnalyticsQueryPackQueryListResultIterator, err error)
	Update(ctx context.Context, resourceGroupName string, queryPackName string, ID string, queryPayload operationalinsights.LogAnalyticsQueryPackQuery) (result operationalinsights.LogAnalyticsQueryPackQuery, err error)
}

var _ QueriesClientAPI = (*operationalinsights.QueriesClient)(nil)
