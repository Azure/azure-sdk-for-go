...
// Delete resets the model file generated by Personalizer service.
func (client ModelClient) Delete(ctx context.Context) (result autorest.Response, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "personalizer.ModelClient", "Delete", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "personalizer.ModelClient", "Delete", resp, "Failure sending request")
		return
	}

	result, err = client.DeleteResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "personalizer.ModelClient", "Delete", resp, "Failure responding to request")
	}
...
func (client ModelClient) DeletePreparer(ctx context.Context) (*http.Request, error) {
...
func (client ModelClient) DeleteResponder(resp *http.Response) (result autorest.Response, err error) {
