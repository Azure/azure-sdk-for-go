	...
	if err := validation.Validate([]validation.Validation{
		{TargetValue: config,
			Constraints: []validation.Constraint{{Target: "config.RewardWaitTime", Name: validation.Null, Rule: true, Chain: nil},
				...
				{Target: "config.RewardAggregation", Name: validation.Null, Rule: true, Chain: nil},
				...
				{Target: "config.LogRetentionDays", Name: validation.Null, Rule: true, Chain: nil}}}}); err != nil {
