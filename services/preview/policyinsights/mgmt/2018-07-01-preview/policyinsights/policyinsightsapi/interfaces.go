...
type RemediationsClientAPI interface {
	...
	CancelAtResourceGroup(ctx context.Context, resourceGroupName string, remediationName string) (result policyinsights.Remediation, err error)
	CancelAtSubscription(ctx context.Context, remediationName string) (result policyinsights.Remediation, err error)
	...
	CreateOrUpdateAtResourceGroup(ctx context.Context, resourceGroupName string, remediationName string, parameters policyinsights.Remediation) (result policyinsights.Remediation, err error)
	CreateOrUpdateAtSubscription(ctx context.Context, remediationName string, parameters policyinsights.Remediation) (result policyinsights.Remediation, err error)
	...
	DeleteAtResourceGroup(ctx context.Context, resourceGroupName string, remediationName string) (result policyinsights.Remediation, err error)
	DeleteAtSubscription(ctx context.Context, remediationName string) (result policyinsights.Remediation, err error)
	...
	GetAtResourceGroup(ctx context.Context, resourceGroupName string, remediationName string) (result policyinsights.Remediation, err error)
	GetAtSubscription(ctx context.Context, remediationName string) (result policyinsights.Remediation, err error)
	...
	ListDeploymentsAtResourceGroup(ctx context.Context, resourceGroupName string, remediationName string, top *int32) (result policyinsights.RemediationDeploymentsListResultPage, err error)
	ListDeploymentsAtSubscription(ctx context.Context, remediationName string, top *int32) (result policyinsights.RemediationDeploymentsListResultPage, err error)
	...
	ListForResourceGroup(ctx context.Context, resourceGroupName string, top *int32, filter string) (result policyinsights.RemediationListResultPage, err error)
	ListForSubscription(ctx context.Context, top *int32, filter string) (result policyinsights.RemediationListResultPage, err error)
}
