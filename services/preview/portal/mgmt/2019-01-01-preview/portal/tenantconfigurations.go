...
func NewTenantConfigurationsClient(subscriptionID string) TenantConfigurationsClient {
	return NewTenantConfigurationsClientWithBaseURI(DefaultBaseURI, subscriptionID)
}

// NewTenantConfigurationsClientWithBaseURI creates an instance of the TenantConfigurationsClient client using a custom
...
func NewTenantConfigurationsClientWithBaseURI(baseURI string, subscriptionID string) TenantConfigurationsClient {
	return TenantConfigurationsClient{NewWithBaseURI(baseURI, subscriptionID)}
}

// Create create the tenant configuration. If configuration already exists - update it. User has to be a Tenant Admin
// for this operation.
// Parameters:
...
func (client TenantConfigurationsClient) Create(ctx context.Context, tenantConfiguration Configuration) (result Configuration, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/TenantConfigurationsClient.Create")
		defer func() {
			sc := -1
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "portal.TenantConfigurationsClient", "Create", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "portal.TenantConfigurationsClient", "Create", resp, "Failure sending request")
		return
	}
...
func (client TenantConfigurationsClient) CreatePreparer(ctx context.Context, tenantConfiguration Configuration) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithPathParameters("/providers/Microsoft.Portal/tenantConfigurations/{configurationName}", pathParameters),
...
func (client TenantConfigurationsClient) Delete(ctx context.Context) (result autorest.Response, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/TenantConfigurationsClient.Delete")
		defer func() {
			sc := -1
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "portal.TenantConfigurationsClient", "Delete", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "portal.TenantConfigurationsClient", "Delete", resp, "Failure sending request")
		return
	}
...
func (client TenantConfigurationsClient) Get(ctx context.Context) (result Configuration, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/TenantConfigurationsClient.Get")
		defer func() {
			sc := -1
			if result.Response.Response != nil {
				sc = result.Response.Response.StatusCode
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "portal.TenantConfigurationsClient", "Get", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "portal.TenantConfigurationsClient", "Get", resp, "Failure sending request")
		return
	}
...
func (client TenantConfigurationsClient) List(ctx context.Context) (result ConfigurationList, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/TenantConfigurationsClient.List")
		defer func() {
			sc := -1
			if result.Response.Response != nil {
				sc = result.Response.Response.StatusCode
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "portal.TenantConfigurationsClient", "List", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "portal.TenantConfigurationsClient", "List", resp, "Failure sending request")
		return
	}
