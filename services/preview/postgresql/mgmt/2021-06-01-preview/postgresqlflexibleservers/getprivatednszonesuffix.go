...
// Parameters:
// body - the required parameters for getting private DNS zone suffix based on server type.
func (client GetPrivateDNSZoneSuffixClient) Execute(ctx context.Context, body string) (result String, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewError("postgresqlflexibleservers.GetPrivateDNSZoneSuffixClient", "Execute", err.Error())
	}

	req, err := client.ExecutePreparer(ctx, body)
	if err != nil {
...
func (client GetPrivateDNSZoneSuffixClient) ExecutePreparer(ctx context.Context, body string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"subscriptionId": autorest.Encode("path", client.SubscriptionID),
	}

	const APIVersion = "2021-03-31-privatepreview"
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithPathParameters("/subscriptions/{subscriptionId}/providers/Microsoft.DBForPostgreSql/getPrivateDnsZoneSuffix", pathParameters),
