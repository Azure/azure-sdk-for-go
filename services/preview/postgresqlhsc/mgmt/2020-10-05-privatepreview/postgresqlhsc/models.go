...
type ServerGroupProperties struct {
	// CreateMode - The mode to create a new server group. Possible values include: 'Default', 'PointInTimeRestore'
	...
	// SourceSubscriptionID - The source subscription id to restore from. It's required when 'createMode' is 'PointInTimeRestore'
	SourceSubscriptionID *string `json:"sourceSubscriptionId,omitempty"`
	// SourceResourceGroupName - The source resource group name to restore from. It's required when 'createMode' is 'PointInTimeRestore'
	SourceResourceGroupName *string `json:"sourceResourceGroupName,omitempty"`
	// SourceServerGroupName - The source server group name to restore from. It's required when 'createMode' is 'PointInTimeRestore'
	SourceServerGroupName *string `json:"sourceServerGroupName,omitempty"`
	// SourceLocation - The source server group location to restore from. It's required when 'createMode' is 'PointInTimeRestore'
