...
func NewEnterprisePoliciesClient(subscriptionID string) EnterprisePoliciesClient {
	return NewEnterprisePoliciesClientWithBaseURI(DefaultBaseURI, subscriptionID)
}

// NewEnterprisePoliciesClientWithBaseURI creates an instance of the EnterprisePoliciesClient client using a custom
...
func NewEnterprisePoliciesClientWithBaseURI(baseURI string, subscriptionID string) EnterprisePoliciesClient {
	return EnterprisePoliciesClient{NewWithBaseURI(baseURI, subscriptionID)}
}
...
func (client EnterprisePoliciesClient) CreateOrUpdate(ctx context.Context, enterprisePolicyName string, resourceGroupName string, parameters EnterprisePolicy) (result EnterprisePolicy, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/EnterprisePoliciesClient.CreateOrUpdate")
		defer func() {
			sc := -1
	...
	req, err := client.CreateOrUpdatePreparer(ctx, enterprisePolicyName, resourceGroupName, parameters)
	if err != nil {
		err = autorest.NewErrorWithError(err, "powerplatform.EnterprisePoliciesClient", "CreateOrUpdate", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "powerplatform.EnterprisePoliciesClient", "CreateOrUpdate", resp, "Failure sending request")
		return
	}
...
func (client EnterprisePoliciesClient) CreateOrUpdatePreparer(ctx context.Context, enterprisePolicyName string, resourceGroupName string, parameters EnterprisePolicy) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithPathParameters("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.PowerPlatform/enterprisePolicies/{enterprisePolicyName}", pathParameters),
...
func (client EnterprisePoliciesClient) Delete(ctx context.Context, resourceGroupName string, enterprisePolicyName string) (result autorest.Response, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/EnterprisePoliciesClient.Delete")
		defer func() {
			sc := -1
	...
	req, err := client.DeletePreparer(ctx, resourceGroupName, enterprisePolicyName)
	if err != nil {
		err = autorest.NewErrorWithError(err, "powerplatform.EnterprisePoliciesClient", "Delete", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "powerplatform.EnterprisePoliciesClient", "Delete", resp, "Failure sending request")
		return
	}
...
func (client EnterprisePoliciesClient) Get(ctx context.Context, enterprisePolicyName string, resourceGroupName string) (result EnterprisePolicy, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/EnterprisePoliciesClient.Get")
		defer func() {
			sc := -1
			if result.Response.Response != nil {
				sc = result.Response.Response.StatusCode
	...
	req, err := client.GetPreparer(ctx, enterprisePolicyName, resourceGroupName)
	if err != nil {
		err = autorest.NewErrorWithError(err, "powerplatform.EnterprisePoliciesClient", "Get", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "powerplatform.EnterprisePoliciesClient", "Get", resp, "Failure sending request")
		return
	}
...
func (client EnterprisePoliciesClient) ListByResourceGroupPreparer(ctx context.Context, resourceGroupName string) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		autorest.AsGet(),
		autorest.WithBaseURL(client.BaseURI),
		autorest.WithPathParameters("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.PowerPlatform/enterprisePolicies", pathParameters),
		autorest.WithQueryParameters(queryParameters))
	return preparer.Prepare((&http.Request{}).WithContext(ctx))
}
...
func (client EnterprisePoliciesClient) ListBySubscriptionPreparer(ctx context.Context) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		autorest.AsGet(),
		autorest.WithBaseURL(client.BaseURI),
		autorest.WithPathParameters("/subscriptions/{subscriptionId}/providers/Microsoft.PowerPlatform/enterprisePolicies", pathParameters),
		autorest.WithQueryParameters(queryParameters))
	return preparer.Prepare((&http.Request{}).WithContext(ctx))
}
...
func (client EnterprisePoliciesClient) Update(ctx context.Context, enterprisePolicyName string, resourceGroupName string, parameters EnterprisePolicy) (result EnterprisePolicy, err error) {
	...
	req, err := client.UpdatePreparer(ctx, enterprisePolicyName, resourceGroupName, parameters)
	if err != nil {
		err = autorest.NewErrorWithError(err, "powerplatform.EnterprisePoliciesClient", "Update", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "powerplatform.EnterprisePoliciesClient", "Update", resp, "Failure sending request")
		return
	}
