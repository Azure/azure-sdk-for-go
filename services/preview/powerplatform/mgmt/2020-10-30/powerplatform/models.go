...
// EnterprisePolicyIdentity identity for the EnterprisePolicy.
type EnterprisePolicyIdentity struct {
	...
	// Lockbox - lockbox configuration. Possible values include: 'Enabled', 'Disabled', 'NotConfigured'
	Lockbox Status `json:"lockbox,omitempty"`
	// Encryption - The encryption settings for a configuration store.
	Encryption *EnterprisePolicyIdentityEncryption `json:"encryption,omitempty"`
	// SystemData - Metadata for the enterprisePolicy.
...
func (epi EnterprisePolicyIdentity) MarshalJSON() ([]byte, error) {
	...
	if epi.Lockbox != "" {
		objectMap["lockbox"] = epi.Lockbox
	}
	if epi.Encryption != nil {
		objectMap["encryption"] = epi.Encryption
	}
	if epi.SystemData != nil {
		objectMap["systemData"] = epi.SystemData
	}
	return json.Marshal(objectMap)
}

// EnterprisePolicyIdentityEncryption the encryption settings for a configuration store.
