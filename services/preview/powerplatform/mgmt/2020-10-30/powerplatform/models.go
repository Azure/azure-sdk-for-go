...
// ConfigurationProperties the properties that define configuration for the enterprise policy.
type ConfigurationProperties struct {
	// Lockbox - Settings concerning lockbox.
	Lockbox *ConfigurationPropertiesLockbox `json:"lockbox,omitempty"`
	// Encryption - The encryption settings for a configuration store.
	Encryption *ConfigurationPropertiesEncryption `json:"encryption,omitempty"`
	// SystemData - Metadata pertaining to creation and last modification of the resource.
	SystemData *SystemData `json:"systemData,omitempty"`
}

// ConfigurationPropertiesEncryption the encryption settings for a configuration store.
type ConfigurationPropertiesEncryption struct {
	// KeyVaultProperties - Key vault properties.
	KeyVaultProperties *KeyVaultProperties `json:"keyVaultProperties,omitempty"`
}

// ConfigurationPropertiesLockbox settings concerning lockbox.
...
type EnterprisePolicy struct {
	...
	// ConfigurationProperties - The properties that define configuration.
...
func (ep EnterprisePolicy) MarshalJSON() ([]byte, error) {
	...
	if ep.ConfigurationProperties != nil {
		objectMap["properties"] = ep.ConfigurationProperties
	}
	if ep.Tags != nil {
	...
	for k, v := range m {
		...
		case "properties":
			if v != nil {
				...
				ep.ConfigurationProperties = &configurationProperties
			}
		case "tags":
			if v != nil {
