...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/preview/provisioningservices/mgmt/2020-09-01-preview/iothub"

// ArmIdentity the set of ARM identities associated with the IoT DPS resource.
type ArmIdentity struct {
	// PrincipalID - READ-ONLY; Principal Id
	PrincipalID *string `json:"principalId,omitempty"`
	// TenantID - READ-ONLY; Tenant Id
	TenantID *string `json:"tenantId,omitempty"`
	// IdentityType - Identity type. Only allowed values are SystemAssigned and UserAssigned. Comma separated if both for ex: SystemAssigned,UserAssigned.
	IdentityType *string `json:"identityType,omitempty"`
	// UserAssignedIdentities - The set of UserAssigned identities associated with the IoT DPS resource.
...
func (ai ArmIdentity) MarshalJSON() ([]byte, error) {
	...
	if ai.IdentityType != nil {
		objectMap["identityType"] = ai.IdentityType
	}
...
// ArmUserIdentity the ARM UserAssigned identity information
...
// EncryptionKeyIdentity the properties of the identity used to access the key encryption key in KeyVault.
type EncryptionKeyIdentity struct {
	// UserAssignedIdentity - The user assigned identity.
	UserAssignedIdentity *string `json:"userAssignedIdentity,omitempty"`
}

// EncryptionPropertiesDescription the customer-managed encryption key (CMK) properties for the IoT DPS
// instance.
type EncryptionPropertiesDescription struct {
	// KeySource - The source of the encryption key. Typically, Microsoft.KeyVault
	KeySource *string `json:"keySource,omitempty"`
	// KeyVaultProperties - The properties of the encryption key configured in KeyVault.
	KeyVaultProperties *[]KeyVaultKeyProperties `json:"keyVaultProperties,omitempty"`
	// Identity - The identity used to access the encryption key in KeyVault.
	Identity *EncryptionKeyIdentity `json:"identity,omitempty"`
}
...
type IotDpsPropertiesDescription struct {
	...
	// Encryption - The encryption properties for the IoT DPS instance.
...
func (idpd IotDpsPropertiesDescription) MarshalJSON() ([]byte, error) {
	...
	if idpd.Encryption != nil {
		objectMap["encryption"] = idpd.Encryption
	}
...
type ProvisioningServiceDescription struct {
	...
	// Identity - The managed identities for the IotDps instance.
...
func (psd ProvisioningServiceDescription) MarshalJSON() ([]byte, error) {
	...
	if psd.Identity != nil {
		objectMap["identity"] = psd.Identity
	}
	if psd.Location != nil {
