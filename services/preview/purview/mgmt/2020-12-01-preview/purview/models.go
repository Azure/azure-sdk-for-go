...
type AccountProperties struct {
	...
	// NetworkAcls - Get the network ACLs.
...
// NetworkAcls the Network ACLs
type NetworkAcls struct {
	// DefaultAction - Gets or sets the default behavior of network ACLs. Possible values include: 'Allow', 'Deny'
