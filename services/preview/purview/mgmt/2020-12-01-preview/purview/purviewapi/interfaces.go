...
type AccountsClientAPI interface {
	...
	Update(ctx context.Context, resourceGroupName string, accountName string, accountUpdateParameters purview.AccountUpdateParameters) (result purview.Account, err error)
}
