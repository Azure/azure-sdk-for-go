...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/preview/qnamaker/cognitiveservices/v5.0-preview.2/qnamaker"
...
type FileDTO struct {
	...
	// IsUnstructured - Optional Flag to specify if the given file is Unstructured.
	IsUnstructured *bool `json:"isUnstructured,omitempty"`
}

// GenerateAnswerBatchResultItem represents Prebuilt Answer Result.
type GenerateAnswerBatchResultItem struct {
	// Answer - Answer.
	...
	// AnswerSpan - Answer span object with respect to user's question.
	AnswerSpan *GenerateAnswerBatchResultItemAnswerSpan `json:"answerSpan,omitempty"`
	// AnswerStartIndex - Start index of answer in document text.
	AnswerStartIndex *int32 `json:"answerStartIndex,omitempty"`
	// AnswerEndIndex - End index of answer in document text.
	AnswerEndIndex *int32 `json:"answerEndIndex,omitempty"`
}

// GenerateAnswerBatchResultItemAnswerSpan answer span object with respect to user's question.
type GenerateAnswerBatchResultItemAnswerSpan struct {
	// Text - Predicted text of answer span.
	Text *string `json:"text,omitempty"`
	// Score - Predicted score of answer span.
	Score *float64 `json:"score,omitempty"`
...
// PrebuiltQuery POST body schema to query the documents via Prebuilt Question Answering.
type PrebuiltQuery struct {
	// Question - User question to query against the given documents.
	Question *string `json:"question,omitempty"`
	// Documents - Documents to be searched for given question.
	Documents *[]TextInput `json:"documents,omitempty"`
	// Language - (Optional) Language of the documents. This is ISO 639-1 representation of a language. For example, use "en" for English; "es" for Spanish etc. If not set, use "en" for English as default.
	Language *string `json:"language,omitempty"`
}
...
type QueryDTO struct {
	...
	// IncludeUnstructuredSources - Optional Flag to enable Query over Unstructured Sources.
	IncludeUnstructuredSources *bool `json:"includeUnstructuredSources,omitempty"`
}
...
// TextInput list of documents to be queried over.
