...
import (
	"context"
	"github.com/Azure/azure-sdk-for-go/services/preview/qnamaker/cognitiveservices/v5.0-preview.2/qnamaker"
...
type AlterationsClientAPI interface {
	...
	GetAlterationsForKb(ctx context.Context, kbID string) (result qnamaker.WordAlterationsDTO, err error)
	Replace(ctx context.Context, wordAlterations qnamaker.WordAlterationsDTO) (result autorest.Response, err error)
	ReplaceAlterationsForKb(ctx context.Context, kbID string, wordAlterations qnamaker.WordAlterationsDTO) (result autorest.Response, err error)
}
...
// PrebuiltClientAPI contains the set of methods on the PrebuiltClient type.
type PrebuiltClientAPI interface {
	GenerateAnswer(ctx context.Context, prebuiltGenerateAnswerPayload qnamaker.PrebuiltQuery, stringIndexType string) (result qnamaker.SetObject, err error)
}

var _ PrebuiltClientAPI = (*qnamaker.PrebuiltClient)(nil)
