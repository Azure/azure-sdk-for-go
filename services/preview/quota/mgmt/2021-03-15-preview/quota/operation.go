...
func (client OperationClient) List(ctx context.Context) (result OperationListPage, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "quota.OperationClient", "List", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "quota.OperationClient", "List", resp, "Failure sending request")
		return
	}

	result.ol, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "quota.OperationClient", "List", resp, "Failure responding to request")
		return
	}
...
func (client OperationClient) ListPreparer(ctx context.Context) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithPath("/providers/Microsoft.Quota/operations"),
...
func (client OperationClient) listNextResults(ctx context.Context, lastResults OperationList) (result OperationList, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "quota.OperationClient", "listNextResults", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "quota.OperationClient", "listNextResults", resp, "Failure sending next results request")
	}
	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "quota.OperationClient", "listNextResults", resp, "Failure responding to next results request")
	}
	return
}
