...
// Get gets the quota request details and status by quota request ID for the resources of the resource provider at a
...
func (client RequestStatusClient) GetPreparer(ctx context.Context, ID string, scope string) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithPathParameters("/{scope}/providers/Microsoft.Quota/quotaLimitsRequests/{id}", pathParameters),
...
// List for the specified location and resource provider, gets the current quota requests under the subscription for a
...
func (client RequestStatusClient) ListPreparer(ctx context.Context, scope string, filter string, top *int32, skiptoken string) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		autorest.AsGet(),
		autorest.WithBaseURL(client.BaseURI),
		autorest.WithPathParameters("/{scope}/providers/Microsoft.Quota/quotaLimitsRequests", pathParameters),
		autorest.WithQueryParameters(queryParameters))
	return preparer.Prepare((&http.Request{}).WithContext(ctx))
}
