...
type ApplianceCredentialKubeconfig struct {
	// Name - READ-ONLY; Name which contains the role of the kubeconfig. Possible values include: 'ClusterUser'
...
type ApplianceProperties struct {
	// Distro - Represents a supported Fabric/Infra. (AKSEdge etc...). Possible values include: 'AKSEdge'
	...
	// Status - READ-ONLY; Appliance’s health and state of connection to on-prem. Possible values include: 'WaitingForHeartbeat', 'Validating', 'Connected', 'Running'
...
type AppliancePropertiesInfrastructureConfig struct {
	// Provider - Information about the connected appliance. Possible values include: 'VMWare', 'HCI', 'SCVMM'
