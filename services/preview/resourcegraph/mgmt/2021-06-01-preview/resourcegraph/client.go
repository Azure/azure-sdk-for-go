...
//
// Package resourcegraph implements the Azure ARM Resourcegraph service API version 2021-06-01-preview.
//
		...
		{TargetValue: request,
			Constraints: []validation.Constraint{{Target: "request.Options", Name: validation.Null, Rule: false,
				Chain: []validation.Constraint{{Target: "request.Options.Interval", Name: validation.Null, Rule: false,
					...
					{Target: "request.Options.Top", Name: validation.Null, Rule: false,
						Chain: []validation.Constraint{{Target: "request.Options.Top", Name: validation.InclusiveMaximum, Rule: int64(1000), Chain: nil},
							{Target: "request.Options.Top", Name: validation.InclusiveMinimum, Rule: int64(1), Chain: nil},
						}},
					{Target: "request.Options.Skip", Name: validation.Null, Rule: false,
						Chain: []validation.Constraint{{Target: "request.Options.Skip", Name: validation.InclusiveMinimum, Rule: int64(0), Chain: nil}}},
				}}}}}); err != nil {
