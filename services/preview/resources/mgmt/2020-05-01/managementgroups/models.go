...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/preview/resources/mgmt/2020-05-01/managementgroups"
...
func (lsumg ListSubscriptionUnderManagementGroup) listSubscriptionUnderManagementGroupPreparer(ctx context.Context) (*http.Request, error) {
	if lsumg.NextLink == nil || len(to.String(lsumg.NextLink)) < 1 {
		return nil, nil
	}
	return autorest.Prepare((&http.Request{}).WithContext(ctx),
		autorest.AsJSON(),
