...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/preview/saas/mgmt/2018-03-01-preview/saas"
...
func (future *CreateResourceFuture) UnmarshalJSON(body []byte) error {
...
// result is the default implementation for CreateResourceFuture.Result.
func (future *CreateResourceFuture) result(client Client) (r Resource, err error) {
	var done bool
...
// OperationGetFuture an abstraction for monitoring and retrieving the results of a long-running operation.
type OperationGetFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(OperationClient) (Resource, error)
}

// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *OperationGetFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for OperationGetFuture.Result.
func (future *OperationGetFuture) result(client OperationClient) (r Resource, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "saas.OperationGetFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		r.Response.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("saas.OperationGetFuture")
		return
	}
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if r.Response.Response, err = future.GetResult(sender); err == nil && r.Response.Response.StatusCode != http.StatusNoContent {
		r, err = client.GetResponder(r.Response.Response)
		if err != nil {
			err = autorest.NewErrorWithError(err, "saas.OperationGetFuture", "Result", r.Response.Response, "Failure responding to request")
		}
	}
	return
}
...
func (rc ResourceCreation) MarshalJSON() ([]byte, error) {
	...
	if rc.Location != nil {
		objectMap["location"] = rc.Location
	}
...
// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *SubscriptionLevelCreateOrUpdateFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for SubscriptionLevelCreateOrUpdateFuture.Result.
func (future *SubscriptionLevelCreateOrUpdateFuture) result(client SubscriptionLevelClient) (r Resource, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
...
// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *SubscriptionLevelDeleteFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for SubscriptionLevelDeleteFuture.Result.
func (future *SubscriptionLevelDeleteFuture) result(client SubscriptionLevelClient) (ar autorest.Response, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
...
// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *SubscriptionLevelMoveResourcesFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for SubscriptionLevelMoveResourcesFuture.Result.
func (future *SubscriptionLevelMoveResourcesFuture) result(client SubscriptionLevelClient) (ar autorest.Response, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
...
// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *SubscriptionLevelUpdateFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for SubscriptionLevelUpdateFuture.Result.
func (future *SubscriptionLevelUpdateFuture) result(client SubscriptionLevelClient) (r Resource, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
...
// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *SubscriptionLevelUpdateToUnsubscribedFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for SubscriptionLevelUpdateToUnsubscribedFuture.Result.
func (future *SubscriptionLevelUpdateToUnsubscribedFuture) result(client SubscriptionLevelClient) (ar autorest.Response, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
...
// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *UpdateResourceFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for UpdateResourceFuture.Result.
func (future *UpdateResourceFuture) result(client Client) (r Resource, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
