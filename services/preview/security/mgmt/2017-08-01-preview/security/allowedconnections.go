...
// Get gets a specific allowed connections component.
// Parameters:
// resourceGroupName - the name of the resource group within the user's subscription. The name is case
// insensitive.
// connectionsType - the type of allowed connections.
func (client AllowedConnectionsClient) Get(ctx context.Context, resourceGroupName string, connectionsType string) (result AllowedConnectionsResource, err error) {
	...
	req, err := client.GetPreparer(ctx, resourceGroupName, connectionsType)
	if err != nil {
...
func (client AllowedConnectionsClient) GetPreparer(ctx context.Context, resourceGroupName string, connectionsType string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"ascLocation":       autorest.Encode("path", client.AscLocation),
		"connectionsType":   autorest.Encode("path", connectionsType),
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithPathParameters("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Security/locations/{ascLocation}/allowedConnections/{connectionsType}", pathParameters),
...
// List gets a list of allowed connections for the subscription.
...
func (client AllowedConnectionsClient) listNextResults(lastResults AllowedConnectionsList) (result AllowedConnectionsList, err error) {
	req, err := lastResults.allowedConnectionsListPreparer()
	if err != nil {
...
// ListByHomeRegion gets a list of allowed connections for the subscription and location.
...
func (client AllowedConnectionsClient) listByHomeRegionNextResults(lastResults AllowedConnectionsList) (result AllowedConnectionsList, err error) {
	req, err := lastResults.allowedConnectionsListPreparer()
	if err != nil {
