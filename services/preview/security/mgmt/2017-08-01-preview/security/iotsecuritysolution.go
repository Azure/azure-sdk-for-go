...
// Update update exists Security Solution tags. to update other fields use the CreateOrUpdate method
// Parameters:
// resourceGroupName - the name of the resource group within the user's subscription. The name is case
// insensitive.
// solutionName - the solution manager name
// securitySolutionTags - updated tag information to set into the iot hub instance.
func (client IotSecuritySolutionClient) Update(ctx context.Context, resourceGroupName string, solutionName string, securitySolutionTags TagsResource) (result IoTSecuritySolutionModel, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.UpdatePreparer(ctx, resourceGroupName, solutionName, securitySolutionTags)
	if err != nil {
...
func (client IotSecuritySolutionClient) UpdatePreparer(ctx context.Context, resourceGroupName string, solutionName string, securitySolutionTags TagsResource) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"solutionName":      autorest.Encode("path", solutionName),
		"subscriptionId":    autorest.Encode("path", client.SubscriptionID),
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithBaseURL(client.BaseURI),
		autorest.WithPathParameters("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Security/IoTSecuritySolutions/{solutionName}", pathParameters),
		autorest.WithJSON(securitySolutionTags),
		autorest.WithQueryParameters(queryParameters))
	return preparer.Prepare((&http.Request{}).WithContext(ctx))
}
