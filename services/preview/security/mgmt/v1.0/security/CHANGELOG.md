...
- Function `NewPricingListPage` signature has been changed from `(func(context.Context, PricingList) (PricingList, error))` to `(PricingList,func(context.Context, PricingList) (PricingList, error))`
