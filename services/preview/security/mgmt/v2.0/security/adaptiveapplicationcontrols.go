...
// locations
// groupName - name of an application control VM/server group
func (client AdaptiveApplicationControlsClient) Get(ctx context.Context, ascLocation string, groupName string) (result AppWhitelistingGroup, err error) {
	if tracing.IsEnabled() {
...
func (client AdaptiveApplicationControlsClient) Put(ctx context.Context, ascLocation string, groupName string, body AppWhitelistingPutGroupData) (result AppWhitelistingGroup, err error) {
	if tracing.IsEnabled() {
...
func (client AdaptiveApplicationControlsClient) PutPreparer(ctx context.Context, ascLocation string, groupName string, body AppWhitelistingPutGroupData) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"ascLocation":    autorest.Encode("path", ascLocation),
		"groupName":      autorest.Encode("path", groupName),
		"subscriptionId": autorest.Encode("path", client.SubscriptionID),
