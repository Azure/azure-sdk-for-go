...
func (client ConnectorsGroupClient) CreateOrUpdate(ctx context.Context, connectorName string, connectorSetting ConnectorSetting) (result ConnectorSetting, err error) {
...
func (client ConnectorsGroupClient) CreateOrUpdatePreparer(ctx context.Context, connectorName string, connectorSetting ConnectorSetting) (*http.Request, error) {
...
func (client ConnectorsGroupClient) CreateOrUpdateResponder(resp *http.Response) (result ConnectorSetting, err error) {
...
// Parameters:
// connectorName - name of the cloud account connector
func (client ConnectorsGroupClient) Delete(ctx context.Context, connectorName string) (result autorest.Response, err error) {
	if tracing.IsEnabled() {
...
func (client ConnectorsGroupClient) DeletePreparer(ctx context.Context, connectorName string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"connectorName":  autorest.Encode("path", connectorName),
		"subscriptionId": autorest.Encode("path", client.SubscriptionID),
	}
...
// Parameters:
// connectorName - name of the cloud account connector
func (client ConnectorsGroupClient) Get(ctx context.Context, connectorName string) (result ConnectorSetting, err error) {
	if tracing.IsEnabled() {
...
func (client ConnectorsGroupClient) GetPreparer(ctx context.Context, connectorName string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"connectorName":  autorest.Encode("path", connectorName),
		"subscriptionId": autorest.Encode("path", client.SubscriptionID),
	}
...
// closes the http.Response Body.
func (client ConnectorsGroupClient) GetResponder(resp *http.Response) (result ConnectorSetting, err error) {
	err = autorest.Respond(
		resp,
		azure.WithErrorUnlessStatusCode(http.StatusOK),
		autorest.ByUnmarshallingJSON(&result),
...
func (client ConnectorsGroupClient) List(ctx context.Context) (result ConnectorSettingListPage, err error) {
	if tracing.IsEnabled() {
...
// closes the http.Response Body.
func (client ConnectorsGroupClient) ListResponder(resp *http.Response) (result ConnectorSettingList, err error) {
	err = autorest.Respond(
		resp,
		azure.WithErrorUnlessStatusCode(http.StatusOK),
		autorest.ByUnmarshallingJSON(&result),
...
func (client ConnectorsGroupClient) listNextResults(ctx context.Context, lastResults ConnectorSettingList) (result ConnectorSettingList, err error) {
...
func (client ConnectorsGroupClient) ListComplete(ctx context.Context) (result ConnectorSettingListIterator, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/ConnectorsGroupClient.List")
		defer func() {
			sc := -1
