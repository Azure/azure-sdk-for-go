...
type AlertsClientAPI interface {
	...
	UpdateResourceGroupLevelAlertState(ctx context.Context, alertName string, resourceGroupName string) (result autorest.Response, err error)
	UpdateResourceGroupLevelAlertState1(ctx context.Context, alertName string, resourceGroupName string) (result autorest.Response, err error)
	UpdateSubscriptionLevelAlertState(ctx context.Context, alertName string) (result autorest.Response, err error)
	UpdateSubscriptionLevelAlertState1(ctx context.Context, alertName string) (result autorest.Response, err error)
}
