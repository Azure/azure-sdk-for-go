...
type NetworkDataClientAPI interface {
	Get(ctx context.Context, resourceGroupName string, resourceNamespace string, resourceType string, resourceName string, expand security.ExpandValues) (result security.NetworkData, err error)
