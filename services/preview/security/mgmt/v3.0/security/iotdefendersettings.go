...
func (client IotDefenderSettingsClient) CreateOrUpdate(ctx context.Context) (result IotDefenderSettingsModel, err error) {
...
func (client IotDefenderSettingsClient) CreateOrUpdatePreparer(ctx context.Context) (*http.Request, error) {
