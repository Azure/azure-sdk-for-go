...
// Parameters:
// scope - scope of the query, can be subscription (/subscriptions/326b1ffa-8ac7-4034-8437-69bef733dede) or IoT
// Hub (/providers/Microsoft.Devices/iotHubs/myHub)
...
// Hub (/providers/Microsoft.Devices/iotHubs/myHub)
// iotSensorName - name of the IoT sensor
func (client IotSensorsClient) DownloadActivation(ctx context.Context, scope string, iotSensorName string) (result autorest.Response, err error) {
	if tracing.IsEnabled() {
...
// closes the http.Response Body.
func (client IotSensorsClient) DownloadActivationResponder(resp *http.Response) (result autorest.Response, err error) {
	err = autorest.Respond(
		resp,
