...
func (desVar DataExportSettings) MarshalJSON() ([]byte, error) {
	...
	for k, v := range desVar.AdditionalProperties {
		objectMap[k] = v
	}
	return json.Marshal(objectMap)
}
	...
	for k, v := range m {
		...
		default:
			if v != nil {
				...
				if desVar.AdditionalProperties == nil {
					desVar.AdditionalProperties = make(map[string]interface{})
				}
				desVar.AdditionalProperties[k] = additionalProperties
			}
		case "kind":
			if v != nil {
				var kind KindEnum
...
func (sr SettingResource) MarshalJSON() ([]byte, error) {
	...
	for k, v := range sr.AdditionalProperties {
		objectMap[k] = v
	}
	return json.Marshal(objectMap)
}
...
// UnmarshalJSON is the custom unmarshaler for SettingResource struct.
func (sr *SettingResource) UnmarshalJSON(body []byte) error {
	var m map[string]*json.RawMessage
	err := json.Unmarshal(body, &m)
	if err != nil {
		return err
	...
	for k, v := range m {
		...
		default:
			if v != nil {
				...
				if sr.AdditionalProperties == nil {
					sr.AdditionalProperties = make(map[string]interface{})
				}
				sr.AdditionalProperties[k] = additionalProperties
			}
		case "kind":
			if v != nil {
				var kind KindEnum
