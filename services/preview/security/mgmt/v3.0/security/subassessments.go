...
func (client SubAssessmentsClient) Get(ctx context.Context, resourceID string, assessmentName string, subAssessmentName string) (result SubAssessment, err error) {
	...
	req, err := client.GetPreparer(ctx, resourceID, assessmentName, subAssessmentName)
	if err != nil {
...
func (client SubAssessmentsClient) GetPreparer(ctx context.Context, resourceID string, assessmentName string, subAssessmentName string) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithPathParameters("/{resourceId}/providers/Microsoft.Security/assessments/{assessmentName}/subAssessments/{subAssessmentName}", pathParameters),
...
func (client SubAssessmentsClient) List(ctx context.Context, scope string, assessmentName string, filter string, selectParameter string, expand string) (result SubAssessmentListPage, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.ListPreparer(ctx, scope, assessmentName, filter, selectParameter, expand)
	if err != nil {
...
func (client SubAssessmentsClient) ListPreparer(ctx context.Context, scope string, assessmentName string, filter string, selectParameter string, expand string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"assessmentName": autorest.Encode("path", assessmentName),
...
func (client SubAssessmentsClient) ListComplete(ctx context.Context, scope string, assessmentName string, filter string, selectParameter string, expand string) (result SubAssessmentListIterator, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/SubAssessmentsClient.List")
		defer func() {
			sc := -1
	...
	result.page, err = client.List(ctx, scope, assessmentName, filter, selectParameter, expand)
	return
}
