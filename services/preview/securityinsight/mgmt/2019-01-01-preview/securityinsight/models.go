...
// ThreatIntelligenceResourceListIterator provides access to a complete listing of
// ThreatIntelligenceResource values.
...
func NewThreatIntelligenceResourceListPage(cur ThreatIntelligenceResourceList, getNextPage func(context.Context, ThreatIntelligenceResourceList) (ThreatIntelligenceResourceList, error)) ThreatIntelligenceResourceListPage {
	return ThreatIntelligenceResourceListPage{
		fn:   getNextPage,
		tirl: cur,
	}
}
