...
func (client ServiceReplicaClient) listNextResults(lastResults ServiceReplicaDescriptionList) (result ServiceReplicaDescriptionList, err error) {
	req, err := lastResults.serviceReplicaDescriptionListPreparer()
	if err != nil {
