...
//
// locationName is the name of the region where the resource is located. operationID is management operation id
// that this request tries to complete. parameters is the definition for completing the restore of this managed
// database.
...
// the Azure Resource Manager API or the portal. managedInstanceName is the name of the managed instance.
// databaseName is the name of the database. parameters is the requested database resource state.
