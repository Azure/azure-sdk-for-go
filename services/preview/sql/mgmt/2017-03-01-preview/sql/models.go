...
// ManagedBackupShortTermRetentionPoliciesUpdateFuture an abstraction for monitoring and retrieving the results of
// a long-running operation.
...
// It returns nil if no more results exist.
func (mbstrplr ManagedBackupShortTermRetentionPolicyListResult) managedBackupShortTermRetentionPolicyListResultPreparer() (*http.Request, error) {
...
type ManagedBackupShortTermRetentionPolicyListResultPage struct {
	fn       func(ManagedBackupShortTermRetentionPolicyListResult) (ManagedBackupShortTermRetentionPolicyListResult, error)
...
func (page *ManagedBackupShortTermRetentionPolicyListResultPage) Next() error {
	next, err := page.fn(page.mbstrplr)
	if err != nil {
		return err
	}
	page.mbstrplr = next
