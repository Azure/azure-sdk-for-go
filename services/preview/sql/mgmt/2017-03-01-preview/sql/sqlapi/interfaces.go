...
type SensitivityLabelsClientAPI interface {
	...
	ListRecommendedByDatabase(ctx context.Context, resourceGroupName string, serverName string, databaseName string, filter string) (result sql.SensitivityLabelListResultPage, err error)
}
