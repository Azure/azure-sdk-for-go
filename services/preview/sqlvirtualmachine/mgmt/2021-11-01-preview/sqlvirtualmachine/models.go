...
type AgReplica struct {
	...
	// Role - Replica Role in availability group. Possible values include: 'PRIMARY', 'SECONDARY'
	Role Role `json:"role,omitempty"`
	// Commit - Replica commit mode in availability group. Possible values include: 'SYNCHRONOUSCOMMIT', 'ASYNCHRONOUSCOMMIT'
	Commit Commit `json:"commit,omitempty"`
	// Failover - Replica failover mode in availability group. Possible values include: 'AUTOMATIC', 'MANUAL'
	Failover Failover `json:"failover,omitempty"`
	// ReadableSecondary - Replica readable secondary mode in availability group. Possible values include: 'NO', 'ALL', 'READONLY'
...
type ResourceIdentity struct {
	...
	// Type - The identity type. Set this to 'SystemAssigned' in order to automatically create and assign an Azure Active Directory principal for the resource. Possible values include: 'None', 'SystemAssigned'
...
type Schedule struct {
	...
	// DayOfWeek - Day of the week to run assessment. Possible values include: 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday'
	DayOfWeek DayOfWeek `json:"dayOfWeek,omitempty"`
