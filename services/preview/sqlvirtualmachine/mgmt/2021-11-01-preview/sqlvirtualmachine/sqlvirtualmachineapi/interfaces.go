...
type AvailabilityGroupListenersClientAPI interface {
	...
	Get(ctx context.Context, resourceGroupName string, SQLVirtualMachineGroupName string, availabilityGroupListenerName string, expand string) (result sqlvirtualmachine.AvailabilityGroupListener, err error)
...
type SQLVirtualMachinesClientAPI interface {
	...
	Redeploy(ctx context.Context, resourceGroupName string, SQLVirtualMachineName string) (result sqlvirtualmachine.SQLVirtualMachinesRedeployFutureType, err error)
	StartAssessment(ctx context.Context, resourceGroupName string, SQLVirtualMachineName string) (result sqlvirtualmachine.SQLVirtualMachinesStartAssessmentFutureType, err error)
