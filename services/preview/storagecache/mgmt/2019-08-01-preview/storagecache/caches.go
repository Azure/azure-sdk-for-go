...
func (client CachesClient) Create(ctx context.Context, resourceGroupName string, cacheName string, cache *Cache) (result CachesCreateFuture, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "storagecache.CachesClient", "Create", nil, "Failure sending request")
		return
	}
...
func (client CachesClient) CreateSender(req *http.Request) (future CachesCreateFuture, err error) {
	...
	future.Result = func(client CachesClient) (c Cache, err error) {
		...
		if c.Response.Response == nil && err == nil {
			err = autorest.NewErrorWithError(err, "storagecache.CachesCreateFuture", "Result", nil, "received nil response and error")
		}
