...
// List lists all the problem classifications available for a specific Azure service.
// Parameters:
// serviceName - name of Azure service available for support for which all the problem classifications will be
// retrieved.
