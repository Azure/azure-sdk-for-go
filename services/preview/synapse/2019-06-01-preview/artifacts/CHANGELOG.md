...
1. PossibleBlobEventTypesValues() []BlobEventTypes
...
1. MicrosoftStorageBlobCreated changed type from BlobEventTypes to BlobEventType
1. MicrosoftStorageBlobDeleted changed type from BlobEventTypes to BlobEventType

### Struct Fields

1. BlobEventsTriggerTypeProperties.Events changed type from *[]BlobEventTypes to *[]BlobEventType

### New Funcs

1. PossibleBlobEventTypeValues() []BlobEventType
...
1. SynapseNotebookActivity.LinkedServiceName
1. SynapseNotebookActivity.Policy
1. SynapseSparkJobDefinitionActivity.LinkedServiceName
1. SynapseSparkJobDefinitionActivity.Policy
