...
func (pecfplhb PrivateEndpointConnectionForPrivateLinkHubBasic) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if pecfplhb.Properties != nil {
		objectMap["properties"] = pecfplhb.Properties
	}
	return json.Marshal(objectMap)
}
...
type PrivateLinkHubProperties struct {
	// ProvisioningState - READ-ONLY; PrivateLinkHub provisioning state. Possible values include: 'ProvisioningState1Succeeded', 'ProvisioningState1Failed', 'ProvisioningState1Deleting'
...
type PrivateLinkServiceConnectionState struct {
	// Status - READ-ONLY; Status of private link service connection state
	Status *string `json:"status,omitempty"`
	// Description - READ-ONLY; Description of private link service connection state
	Description *string `json:"description,omitempty"`
	// ActionsRequired - READ-ONLY; Actions Required
