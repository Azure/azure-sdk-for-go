...
// WorkspaceManagedqlServerBlobAuditingPoliciesClientAPI contains the set of methods on the WorkspaceManagedqlServerBlobAuditingPoliciesClient type.
type WorkspaceManagedqlServerBlobAuditingPoliciesClientAPI interface {
	CreateOrUpdate(ctx context.Context, resourceGroupName string, workspaceName string, parameters synapse.ServerBlobAuditingPolicy) (result synapse.WorkspaceManagedqlServerBlobAuditingPoliciesCreateOrUpdateFuture, err error)
}

var _ WorkspaceManagedqlServerBlobAuditingPoliciesClientAPI = (*synapse.WorkspaceManagedqlServerBlobAuditingPoliciesClient)(nil)
