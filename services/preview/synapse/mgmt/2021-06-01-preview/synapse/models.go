...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/preview/synapse/mgmt/2021-06-01-preview/synapse"
...
type AzureADOnlyAuthentication struct {
	...
	// AzureADOnlyAuthenticationProperties - Azure Active Directory Only Authentication resource properties
	*AzureADOnlyAuthenticationProperties `json:"properties,omitempty"`
...
// MarshalJSON is the custom marshaler for AzureADOnlyAuthentication.
func (aaoa AzureADOnlyAuthentication) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if aaoa.AzureADOnlyAuthenticationProperties != nil {
		objectMap["properties"] = aaoa.AzureADOnlyAuthenticationProperties
	}
	return json.Marshal(objectMap)
}

// UnmarshalJSON is the custom unmarshaler for AzureADOnlyAuthentication struct.
func (aaoa *AzureADOnlyAuthentication) UnmarshalJSON(body []byte) error {
	var m map[string]*json.RawMessage
	err := json.Unmarshal(body, &m)
	if err != nil {
		return err
	...
	for k, v := range m {
		...
		case "properties":
			if v != nil {
				...
				aaoa.AzureADOnlyAuthenticationProperties = &azureADOnlyAuthenticationProperties
			}
		case "id":
			if v != nil {
				var ID string
...
type AzureADOnlyAuthenticationListResult struct {
	...
	Value *[]AzureADOnlyAuthentication `json:"value,omitempty"`
	// NextLink - READ-ONLY; Link to retrieve next page of results.
	NextLink *string `json:"nextLink,omitempty"`
}

// MarshalJSON is the custom marshaler for AzureADOnlyAuthenticationListResult.
func (aaoalr AzureADOnlyAuthenticationListResult) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	return json.Marshal(objectMap)
}

// AzureADOnlyAuthenticationListResultIterator provides access to a complete listing of
// AzureADOnlyAuthentication values.
type AzureADOnlyAuthenticationListResultIterator struct {
	i    int
...
func (iter *AzureADOnlyAuthenticationListResultIterator) NextWithContext(ctx context.Context) (err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/AzureADOnlyAuthenticationListResultIterator.NextWithContext")
		defer func() {
			sc := -1
...
func (iter *AzureADOnlyAuthenticationListResultIterator) Next() error {
	return iter.NextWithContext(context.Background())
}

// NotDone returns true if the enumeration should be started or is not yet complete.
func (iter AzureADOnlyAuthenticationListResultIterator) NotDone() bool {
	return iter.page.NotDone() && iter.i < len(iter.page.Values())
}

// Response returns the raw server response from the last page request.
func (iter AzureADOnlyAuthenticationListResultIterator) Response() AzureADOnlyAuthenticationListResult {
	return iter.page.Response()
}

// Value returns the current value or a zero-initialized value if the
// iterator has advanced beyond the end of the collection.
func (iter AzureADOnlyAuthenticationListResultIterator) Value() AzureADOnlyAuthentication {
	if !iter.page.NotDone() {
		return AzureADOnlyAuthentication{}
	}
	return iter.page.Values()[iter.i]
}

// Creates a new instance of the AzureADOnlyAuthenticationListResultIterator type.
func NewAzureADOnlyAuthenticationListResultIterator(page AzureADOnlyAuthenticationListResultPage) AzureADOnlyAuthenticationListResultIterator {
	return AzureADOnlyAuthenticationListResultIterator{page: page}
}

// IsEmpty returns true if the ListResult contains no values.
func (aaoalr AzureADOnlyAuthenticationListResult) IsEmpty() bool {
	return aaoalr.Value == nil || len(*aaoalr.Value) == 0
}

// hasNextLink returns true if the NextLink is not empty.
func (aaoalr AzureADOnlyAuthenticationListResult) hasNextLink() bool {
	return aaoalr.NextLink != nil && len(*aaoalr.NextLink) != 0
}

// azureADOnlyAuthenticationListResultPreparer prepares a request to retrieve the next set of results.
// It returns nil if no more results exist.
func (aaoalr AzureADOnlyAuthenticationListResult) azureADOnlyAuthenticationListResultPreparer(ctx context.Context) (*http.Request, error) {
...
// AzureADOnlyAuthenticationListResultPage contains a page of AzureADOnlyAuthentication values.
type AzureADOnlyAuthenticationListResultPage struct {
	fn     func(context.Context, AzureADOnlyAuthenticationListResult) (AzureADOnlyAuthenticationListResult, error)
	aaoalr AzureADOnlyAuthenticationListResult
}

// NextWithContext advances to the next page of values.  If there was an error making
// the request the page does not advance and the error is returned.
func (page *AzureADOnlyAuthenticationListResultPage) NextWithContext(ctx context.Context) (err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/AzureADOnlyAuthenticationListResultPage.NextWithContext")
		defer func() {
			sc := -1
...
// the request the page does not advance and the error is returned.
// Deprecated: Use NextWithContext() instead.
func (page *AzureADOnlyAuthenticationListResultPage) Next() error {
	return page.NextWithContext(context.Background())
}

// NotDone returns true if the page enumeration should be started or is not yet complete.
func (page AzureADOnlyAuthenticationListResultPage) NotDone() bool {
	return !page.aaoalr.IsEmpty()
}

// Response returns the raw server response from the last page request.
func (page AzureADOnlyAuthenticationListResultPage) Response() AzureADOnlyAuthenticationListResult {
	return page.aaoalr
}

// Values returns the slice of values for the current page or nil if there are no values.
func (page AzureADOnlyAuthenticationListResultPage) Values() []AzureADOnlyAuthentication {
...
// Creates a new instance of the AzureADOnlyAuthenticationListResultPage type.
func NewAzureADOnlyAuthenticationListResultPage(cur AzureADOnlyAuthenticationListResult, getNextPage func(context.Context, AzureADOnlyAuthenticationListResult) (AzureADOnlyAuthenticationListResult, error)) AzureADOnlyAuthenticationListResultPage {
	return AzureADOnlyAuthenticationListResultPage{
		fn:     getNextPage,
		aaoalr: cur,
	}
}
...
type AzureADOnlyAuthenticationProperties struct {
	...
	// State - READ-ONLY; Azure Active Directory Only Authentication configuration state. Possible values include: 'AuthenticationStateConsistent', 'AuthenticationStateInConsistent', 'AuthenticationStateUpdating'
	State AuthenticationState `json:"state,omitempty"`
	// CreationDate - READ-ONLY; property configuration date
	CreationDate *date.Time `json:"creationDate,omitempty"`
}

// MarshalJSON is the custom marshaler for AzureADOnlyAuthenticationProperties.
func (aaoap AzureADOnlyAuthenticationProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if aaoap.AzureADOnlyAuthentication != nil {
		objectMap["azureADOnlyAuthentication"] = aaoap.AzureADOnlyAuthentication
	}
	return json.Marshal(objectMap)
}

// AzureADOnlyAuthenticationsCreateFuture an abstraction for monitoring and retrieving the results of a
// long-running operation.
type AzureADOnlyAuthenticationsCreateFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(AzureADOnlyAuthenticationsClient) (AzureADOnlyAuthentication, error)
}

// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *AzureADOnlyAuthenticationsCreateFuture) UnmarshalJSON(body []byte) error {
...
// result is the default implementation for AzureADOnlyAuthenticationsCreateFuture.Result.
func (future *AzureADOnlyAuthenticationsCreateFuture) result(client AzureADOnlyAuthenticationsClient) (aaoa AzureADOnlyAuthentication, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "synapse.AzureADOnlyAuthenticationsCreateFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		aaoa.Response.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("synapse.AzureADOnlyAuthenticationsCreateFuture")
		return
	}
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if aaoa.Response.Response, err = future.GetResult(sender); err == nil && aaoa.Response.Response.StatusCode != http.StatusNoContent {
		aaoa, err = client.CreateResponder(aaoa.Response.Response)
		if err != nil {
			err = autorest.NewErrorWithError(err, "synapse.AzureADOnlyAuthenticationsCreateFuture", "Result", aaoa.Response.Response, "Failure responding to request")
		}
	}
	return
}
...
type CmdkeySetup struct {
	...
	*CmdkeySetupTypeProperties `json:"typeProperties,omitempty"`
	// Type - Possible values include: 'TypeBasicCustomSetupBaseTypeCustomSetupBase', 'TypeBasicCustomSetupBaseTypeCmdkeySetup', 'TypeBasicCustomSetupBaseTypeEnvironmentVariableSetup', 'TypeBasicCustomSetupBaseTypeComponentSetup'
...
func (cs CmdkeySetup) MarshalJSON() ([]byte, error) {
	cs.Type = TypeBasicCustomSetupBaseTypeCmdkeySetup
	objectMap := make(map[string]interface{})
...
func (cs ComponentSetup) MarshalJSON() ([]byte, error) {
	cs.Type = TypeBasicCustomSetupBaseTypeComponentSetup
	objectMap := make(map[string]interface{})
...
func (cmkd CustomerManagedKeyDetails) MarshalJSON() ([]byte, error) {
	...
	if cmkd.KekIdentity != nil {
		objectMap["kekIdentity"] = cmkd.KekIdentity
	}
	return json.Marshal(objectMap)
}
...
func unmarshalBasicCustomSetupBase(body []byte) (BasicCustomSetupBase, error) {
	...
	switch m["type"] {
	case string(TypeBasicCustomSetupBaseTypeCmdkeySetup):
		var cs CmdkeySetup
		err := json.Unmarshal(body, &cs)
		return cs, err
	case string(TypeBasicCustomSetupBaseTypeEnvironmentVariableSetup):
		var evs EnvironmentVariableSetup
		err := json.Unmarshal(body, &evs)
		return evs, err
	case string(TypeBasicCustomSetupBaseTypeComponentSetup):
...
func (csb CustomSetupBase) MarshalJSON() ([]byte, error) {
	csb.Type = TypeBasicCustomSetupBaseTypeCustomSetupBase
	objectMap := make(map[string]interface{})
	if csb.Type != "" {
...
func (evs EnvironmentVariableSetup) MarshalJSON() ([]byte, error) {
	evs.Type = TypeBasicCustomSetupBaseTypeEnvironmentVariableSetup
	objectMap := make(map[string]interface{})
...
type IntegrationRuntimeDataFlowProperties struct {
	// AdditionalProperties - Unmatched properties from the message are deserialized this collection
	AdditionalProperties map[string]interface{} `json:""`
	// ComputeType - Compute type of the cluster which will execute data flow job. Possible values include: 'DataFlowComputeTypeGeneral', 'DataFlowComputeTypeMemoryOptimized', 'DataFlowComputeTypeComputeOptimized'
...
type IntegrationRuntimeRegenerateKeyParameters struct {
	// KeyName - The name of the authentication key to regenerate. Possible values include: 'IntegrationRuntimeAuthKeyNameAuthKey1', 'IntegrationRuntimeAuthKeyNameAuthKey2'
...
type IntegrationRuntimeSsisProperties struct {
	...
	// LicenseType - License type for bringing your own license scenario. Possible values include: 'IntegrationRuntimeLicenseTypeBasePrice', 'IntegrationRuntimeLicenseTypeLicenseIncluded'
	...
	// Edition - The edition for the SSIS Integration Runtime. Possible values include: 'IntegrationRuntimeEditionStandard', 'IntegrationRuntimeEditionEnterprise'
...
type ManagedIdentity struct {
	...
	// Type - The type of managed identity for the workspace. Possible values include: 'ResourceIdentityTypeNone', 'ResourceIdentityTypeSystemAssigned', 'ResourceIdentityTypeSystemAssignedUserAssigned'
...
type ManagedIdentitySQLControlSettingsModelPropertiesGrantSQLControlToManagedIdentity struct {
	...
	// ActualState - READ-ONLY; Actual state. Possible values include: 'ActualStateEnabling', 'ActualStateEnabled', 'ActualStateDisabling', 'ActualStateDisabled', 'ActualStateUnknown'
...
type QueryMetric struct {
	...
	DisplayName *string `json:"displayName,omitempty"`
	// Unit - READ-ONLY; The unit of measurement. Possible values include: 'QueryMetricUnitPercentage', 'QueryMetricUnitKB', 'QueryMetricUnitMicroseconds'
...
type ReplicationLinkProperties struct {
	...
	// Role - READ-ONLY; The role of the Sql pool in the replication link. Possible values include: 'ReplicationRolePrimary', 'ReplicationRoleSecondary', 'ReplicationRoleNonReadableSecondary', 'ReplicationRoleSource', 'ReplicationRoleCopy'
	Role ReplicationRole `json:"role,omitempty"`
	// PartnerRole - READ-ONLY; The role of the partner Sql pool in the replication link. Possible values include: 'ReplicationRolePrimary', 'ReplicationRoleSecondary', 'ReplicationRoleNonReadableSecondary', 'ReplicationRoleSource', 'ReplicationRoleCopy'
	...
	// ReplicationState - READ-ONLY; The replication state for the replication link. Possible values include: 'ReplicationStatePENDING', 'ReplicationStateSEEDING', 'ReplicationStateCATCHUP', 'ReplicationStateSUSPENDED'
...
type SecretBase struct {
	// Type - Possible values include: 'TypeBasicSecretBaseTypeSecretBase', 'TypeBasicSecretBaseTypeSecureString'
...
func unmarshalBasicSecretBase(body []byte) (BasicSecretBase, error) {
	...
	switch m["type"] {
	case string(TypeBasicSecretBaseTypeSecureString):
		var ss SecureString
...
func (sb SecretBase) MarshalJSON() ([]byte, error) {
	sb.Type = TypeBasicSecretBaseTypeSecretBase
	objectMap := make(map[string]interface{})
	if sb.Type != "" {
...
type SelfHostedIntegrationRuntimeStatusTypeProperties struct {
	...
	// AutoUpdate - READ-ONLY; Whether Self-hosted integration runtime auto update has been turned on. Possible values include: 'IntegrationRuntimeAutoUpdateOn', 'IntegrationRuntimeAutoUpdateOff'
...
type SparkConfigProperties struct {
	// Time - READ-ONLY; The last update time of the spark config properties file.
	Time *date.Time `json:"time,omitempty"`
	// Content - The spark config properties.
	Content *string `json:"content,omitempty"`
	// Filename - The filename of the spark config properties file.
	Filename *string `json:"filename,omitempty"`
	// ConfigurationType - The type of the spark config properties file. Possible values include: 'ConfigurationTypeFile', 'ConfigurationTypeArtifact'
	ConfigurationType ConfigurationType `json:"configurationType,omitempty"`
}

// MarshalJSON is the custom marshaler for SparkConfigProperties.
func (scp SparkConfigProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if scp.Content != nil {
		objectMap["content"] = scp.Content
	}
	if scp.Filename != nil {
		objectMap["filename"] = scp.Filename
	}
	if scp.ConfigurationType != "" {
		objectMap["configurationType"] = scp.ConfigurationType
	}
	return json.Marshal(objectMap)
}
...
type SparkConfigurationInfo struct {
	...
	// Created - The timestamp of resource creation.
	Created *date.Time `json:"created,omitempty"`
}

// MarshalJSON is the custom marshaler for SparkConfigurationInfo.
func (sci SparkConfigurationInfo) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if sci.Description != nil {
		objectMap["description"] = sci.Description
	}
	if sci.Configs != nil {
		objectMap["configs"] = sci.Configs
	}
	if sci.Annotations != nil {
		objectMap["annotations"] = sci.Annotations
	}
	if sci.Notes != nil {
		objectMap["notes"] = sci.Notes
	}
	if sci.CreatedBy != nil {
		objectMap["createdBy"] = sci.CreatedBy
	}
	if sci.Created != nil {
		objectMap["created"] = sci.Created
	}
	return json.Marshal(objectMap)
}
...
type SsisEnvironment struct {
	...
	Description *string `json:"description,omitempty"`
	// Type - Possible values include: 'TypeBasicSsisObjectMetadataTypeSsisObjectMetadata', 'TypeBasicSsisObjectMetadataTypeFolder', 'TypeBasicSsisObjectMetadataTypeProject', 'TypeBasicSsisObjectMetadataTypePackage', 'TypeBasicSsisObjectMetadataTypeEnvironment'
...
func (se SsisEnvironment) MarshalJSON() ([]byte, error) {
	se.Type = TypeBasicSsisObjectMetadataTypeEnvironment
	objectMap := make(map[string]interface{})
	if se.FolderID != nil {
...
func (sf SsisFolder) MarshalJSON() ([]byte, error) {
	sf.Type = TypeBasicSsisObjectMetadataTypeFolder
	objectMap := make(map[string]interface{})
	if sf.ID != nil {
		objectMap["id"] = sf.ID
	}
...
func unmarshalBasicSsisObjectMetadata(body []byte) (BasicSsisObjectMetadata, error) {
	...
	switch m["type"] {
	case string(TypeBasicSsisObjectMetadataTypeFolder):
		var sf SsisFolder
		err := json.Unmarshal(body, &sf)
		return sf, err
	case string(TypeBasicSsisObjectMetadataTypeProject):
		var sp SsisProject
		err := json.Unmarshal(body, &sp)
		return sp, err
	case string(TypeBasicSsisObjectMetadataTypePackage):
		var sp SsisPackage
		err := json.Unmarshal(body, &sp)
		return sp, err
	case string(TypeBasicSsisObjectMetadataTypeEnvironment):
...
func (som SsisObjectMetadata) MarshalJSON() ([]byte, error) {
	som.Type = TypeBasicSsisObjectMetadataTypeSsisObjectMetadata
	objectMap := make(map[string]interface{})
	if som.ID != nil {
		objectMap["id"] = som.ID
	}
...
func (sp SsisPackage) MarshalJSON() ([]byte, error) {
	sp.Type = TypeBasicSsisObjectMetadataTypePackage
	objectMap := make(map[string]interface{})
	if sp.FolderID != nil {
...
func (sp SsisProject) MarshalJSON() ([]byte, error) {
	sp.Type = TypeBasicSsisObjectMetadataTypeProject
	objectMap := make(map[string]interface{})
	if sp.FolderID != nil {
		objectMap["folderId"] = sp.FolderID
	}
...
type TopQueries struct {
	// AggregationFunction - READ-ONLY; The function that is used to aggregate each query's metrics. Possible values include: 'QueryAggregationFunctionMin', 'QueryAggregationFunctionMax', 'QueryAggregationFunctionAvg', 'QueryAggregationFunctionSum'
	AggregationFunction QueryAggregationFunction `json:"aggregationFunction,omitempty"`
	// ExecutionType - READ-ONLY; The execution type that is used to filter the query instances that are returned. Possible values include: 'QueryExecutionTypeAny', 'QueryExecutionTypeRegular', 'QueryExecutionTypeIrregular', 'QueryExecutionTypeAborted', 'QueryExecutionTypeException'
	...
	// ObservedMetric - READ-ONLY; The type of metric to use for ordering the top metrics. Possible values include: 'QueryObservedMetricTypeCPU', 'QueryObservedMetricTypeIo', 'QueryObservedMetricTypeLogio', 'QueryObservedMetricTypeDuration', 'QueryObservedMetricTypeExecutionCount'
...
type UpdateIntegrationRuntimeRequest struct {
	// AutoUpdate - Enables or disables the auto-update feature of the self-hosted integration runtime. See https://go.microsoft.com/fwlink/?linkid=854189. Possible values include: 'IntegrationRuntimeAutoUpdateOn', 'IntegrationRuntimeAutoUpdateOff'
	AutoUpdate IntegrationRuntimeAutoUpdate `json:"autoUpdate,omitempty"`
...
type WorkspaceProperties struct {
	...
	// Settings - READ-ONLY; Workspace settings
...
func (wp WorkspaceProperties) MarshalJSON() ([]byte, error) {
	...
	if wp.CspWorkspaceAdminProperties != nil {
		objectMap["cspWorkspaceAdminProperties"] = wp.CspWorkspaceAdminProperties
	}
