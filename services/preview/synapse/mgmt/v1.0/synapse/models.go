...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/preview/synapse/mgmt/v1.0/synapse"
...
type AzureADOnlyAuthentication struct {
	...
	// AzureADOnlyAuthenticationProperties - azureADOnlyAuthentication resource properties
...
type AzureADOnlyAuthenticationProperties struct {
	...
	// State - READ-ONLY; property configuration state. Possible values include: 'StateValueConsistent', 'StateValueInConsistent', 'StateValueUpdating'
