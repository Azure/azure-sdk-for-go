...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/preview/synapse/mgmt/v2.0/synapse"
...
type AttachedDatabaseConfigurationProperties struct {
	...
	// AttachedDatabaseNames - READ-ONLY; The list of databases from the clusterResourceId which are currently attached to the kusto pool.
...
func (adcp AttachedDatabaseConfigurationProperties) MarshalJSON() ([]byte, error) {
	...
	if adcp.KustoPoolResourceID != nil {
		objectMap["clusterResourceId"] = adcp.KustoPoolResourceID
	}
...
type AzureSku struct {
	// Name - SKU name. Possible values include: 'SkuNameComputeoptimized', 'SkuNameStorageoptimized'
	Name SkuName `json:"name,omitempty"`
	// Capacity - The number of instances of the cluster.
	Capacity *int32 `json:"capacity,omitempty"`
	// Size - SKU size. Possible values include: 'SkuSizeExtrasmall', 'SkuSizeSmall', 'SkuSizeMedium', 'SkuSizeLarge'
...
type ClusterPrincipalAssignmentCheckNameRequest struct {
	...
	Name *string `json:"name,omitempty"`
	// Type - The type of resource, Microsoft.Synapse/workspaces/kustoPools/principalAssignments.
	Type *string `json:"type,omitempty"`
}
...
type DatabaseCheckNameRequest struct {
	// Name - Resource name.
	Name *string `json:"name,omitempty"`
	// Type - The type of resource, for instance Microsoft.Synapse/workspaces/kustoPools/databases. Possible values include: 'TypeMicrosoftSynapseworkspaceskustoPoolsdatabases', 'TypeMicrosoftSynapseworkspaceskustoPoolsattachedDatabaseConfigurations'
...
type DatabasePrincipalAssignmentCheckNameRequest struct {
	// Name - Principal Assignment resource name.
	Name *string `json:"name,omitempty"`
	// Type - The type of resource, Microsoft.Synapse/workspaces/kustoPools/databases/principalAssignments.
	Type *string `json:"type,omitempty"`
}
...
// BasicDataConnection class representing a data connection.
...
type DataConnectionCheckNameRequest struct {
	...
	Name *string `json:"name,omitempty"`
	// Type - The type of resource, Microsoft.Synapse/workspaces/kustoPools/databases/dataConnections.
	Type *string `json:"type,omitempty"`
}
...
func (fdd FollowerDatabaseDefinition) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if fdd.KustoPoolResourceID != nil {
		objectMap["clusterResourceId"] = fdd.KustoPoolResourceID
	}
...
type IntegrationRuntime struct {
	...
	Description *string `json:"description,omitempty"`
	// Type - Possible values include: 'TypeBasicIntegrationRuntimeTypeIntegrationRuntime', 'TypeBasicIntegrationRuntimeTypeManaged', 'TypeBasicIntegrationRuntimeTypeSelfHosted'
...
func unmarshalBasicIntegrationRuntime(body []byte) (BasicIntegrationRuntime, error) {
	...
	switch m["type"] {
	case string(TypeBasicIntegrationRuntimeTypeManaged):
		var mir ManagedIntegrationRuntime
		err := json.Unmarshal(body, &mir)
		return mir, err
	case string(TypeBasicIntegrationRuntimeTypeSelfHosted):
...
func (ir IntegrationRuntime) MarshalJSON() ([]byte, error) {
	ir.Type = TypeBasicIntegrationRuntimeTypeIntegrationRuntime
	objectMap := make(map[string]interface{})
...
type KustoPool struct {
	...
	Sku *AzureSku `json:"sku,omitempty"`
	// KustoPoolProperties - The kusto pool properties.
	*KustoPoolProperties `json:"properties,omitempty"`
...
// MarshalJSON is the custom marshaler for KustoPool.
func (kp KustoPool) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if kp.Sku != nil {
		objectMap["sku"] = kp.Sku
	}
	if kp.KustoPoolProperties != nil {
		objectMap["properties"] = kp.KustoPoolProperties
	}
	if kp.Tags != nil {
		objectMap["tags"] = kp.Tags
	}
	if kp.Location != nil {
		objectMap["location"] = kp.Location
	}
	return json.Marshal(objectMap)
}

// UnmarshalJSON is the custom unmarshaler for KustoPool struct.
func (kp *KustoPool) UnmarshalJSON(body []byte) error {
	var m map[string]*json.RawMessage
	err := json.Unmarshal(body, &m)
	if err != nil {
		return err
	...
	for k, v := range m {
		...
		case "properties":
			if v != nil {
				var kustoPoolProperties KustoPoolProperties
				err = json.Unmarshal(*v, &kustoPoolProperties)
				if err != nil {
					return err
				}
				kp.KustoPoolProperties = &kustoPoolProperties
			}
		case "etag":
			if v != nil {
				var etag string
...
// KustoPoolAttachedDatabaseConfigurationsCreateOrUpdateFuture an abstraction for monitoring and retrieving
// the results of a long-running operation.
type KustoPoolAttachedDatabaseConfigurationsCreateOrUpdateFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(KustoPoolAttachedDatabaseConfigurationsClient) (AttachedDatabaseConfiguration, error)
}

// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *KustoPoolAttachedDatabaseConfigurationsCreateOrUpdateFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for KustoPoolAttachedDatabaseConfigurationsCreateOrUpdateFuture.Result.
func (future *KustoPoolAttachedDatabaseConfigurationsCreateOrUpdateFuture) result(client KustoPoolAttachedDatabaseConfigurationsClient) (adc AttachedDatabaseConfiguration, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "synapse.KustoPoolAttachedDatabaseConfigurationsCreateOrUpdateFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		adc.Response.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("synapse.KustoPoolAttachedDatabaseConfigurationsCreateOrUpdateFuture")
		return
	}
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if adc.Response.Response, err = future.GetResult(sender); err == nil && adc.Response.Response.StatusCode != http.StatusNoContent {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "synapse.KustoPoolAttachedDatabaseConfigurationsCreateOrUpdateFuture", "Result", adc.Response.Response, "Failure responding to request")
		}
	}
	return
}

// KustoPoolAttachedDatabaseConfigurationsDeleteFuture an abstraction for monitoring and retrieving the
// results of a long-running operation.
type KustoPoolAttachedDatabaseConfigurationsDeleteFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(KustoPoolAttachedDatabaseConfigurationsClient) (autorest.Response, error)
}

// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *KustoPoolAttachedDatabaseConfigurationsDeleteFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for KustoPoolAttachedDatabaseConfigurationsDeleteFuture.Result.
func (future *KustoPoolAttachedDatabaseConfigurationsDeleteFuture) result(client KustoPoolAttachedDatabaseConfigurationsClient) (ar autorest.Response, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "synapse.KustoPoolAttachedDatabaseConfigurationsDeleteFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		ar.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("synapse.KustoPoolAttachedDatabaseConfigurationsDeleteFuture")
		return
	}
	ar.Response = future.Response()
	return
...
type KustoPoolCheckNameRequest struct {
	...
	Name *string `json:"name,omitempty"`
	// Type - The type of resource, Microsoft.Synapse/workspaces/kustoPools.
	Type *string `json:"type,omitempty"`
}

// KustoPoolDatabasePrincipalAssignmentsCreateOrUpdateFuture an abstraction for monitoring and retrieving
// the results of a long-running operation.
type KustoPoolDatabasePrincipalAssignmentsCreateOrUpdateFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(KustoPoolDatabasePrincipalAssignmentsClient) (DatabasePrincipalAssignment, error)
}

// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *KustoPoolDatabasePrincipalAssignmentsCreateOrUpdateFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for KustoPoolDatabasePrincipalAssignmentsCreateOrUpdateFuture.Result.
func (future *KustoPoolDatabasePrincipalAssignmentsCreateOrUpdateFuture) result(client KustoPoolDatabasePrincipalAssignmentsClient) (dpa DatabasePrincipalAssignment, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "synapse.KustoPoolDatabasePrincipalAssignmentsCreateOrUpdateFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		dpa.Response.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("synapse.KustoPoolDatabasePrincipalAssignmentsCreateOrUpdateFuture")
		return
	}
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if dpa.Response.Response, err = future.GetResult(sender); err == nil && dpa.Response.Response.StatusCode != http.StatusNoContent {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "synapse.KustoPoolDatabasePrincipalAssignmentsCreateOrUpdateFuture", "Result", dpa.Response.Response, "Failure responding to request")
		}
	}
	return
}

// KustoPoolDatabasePrincipalAssignmentsDeleteFuture an abstraction for monitoring and retrieving the
// results of a long-running operation.
type KustoPoolDatabasePrincipalAssignmentsDeleteFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(KustoPoolDatabasePrincipalAssignmentsClient) (autorest.Response, error)
}

// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *KustoPoolDatabasePrincipalAssignmentsDeleteFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for KustoPoolDatabasePrincipalAssignmentsDeleteFuture.Result.
func (future *KustoPoolDatabasePrincipalAssignmentsDeleteFuture) result(client KustoPoolDatabasePrincipalAssignmentsClient) (ar autorest.Response, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "synapse.KustoPoolDatabasePrincipalAssignmentsDeleteFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		ar.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("synapse.KustoPoolDatabasePrincipalAssignmentsDeleteFuture")
		return
	}
	ar.Response = future.Response()
	return
...
// KustoPoolDatabasesCreateOrUpdateFuture an abstraction for monitoring and retrieving the results of a
// long-running operation.
type KustoPoolDatabasesCreateOrUpdateFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(KustoPoolDatabasesClient) (DatabaseModel, error)
}

// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *KustoPoolDatabasesCreateOrUpdateFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for KustoPoolDatabasesCreateOrUpdateFuture.Result.
func (future *KustoPoolDatabasesCreateOrUpdateFuture) result(client KustoPoolDatabasesClient) (dm DatabaseModel, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "synapse.KustoPoolDatabasesCreateOrUpdateFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		dm.Response.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("synapse.KustoPoolDatabasesCreateOrUpdateFuture")
		return
	}
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if dm.Response.Response, err = future.GetResult(sender); err == nil && dm.Response.Response.StatusCode != http.StatusNoContent {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "synapse.KustoPoolDatabasesCreateOrUpdateFuture", "Result", dm.Response.Response, "Failure responding to request")
		}
	}
	return
}

// KustoPoolDatabasesDeleteFuture an abstraction for monitoring and retrieving the results of a
// long-running operation.
type KustoPoolDatabasesDeleteFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(KustoPoolDatabasesClient) (autorest.Response, error)
}

// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *KustoPoolDatabasesDeleteFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for KustoPoolDatabasesDeleteFuture.Result.
func (future *KustoPoolDatabasesDeleteFuture) result(client KustoPoolDatabasesClient) (ar autorest.Response, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "synapse.KustoPoolDatabasesDeleteFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		ar.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("synapse.KustoPoolDatabasesDeleteFuture")
		return
	}
	ar.Response = future.Response()
	return
...
// KustoPoolDatabasesUpdateFuture an abstraction for monitoring and retrieving the results of a
// long-running operation.
type KustoPoolDatabasesUpdateFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(KustoPoolDatabasesClient) (DatabaseModel, error)
...
// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *KustoPoolDatabasesUpdateFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for KustoPoolDatabasesUpdateFuture.Result.
func (future *KustoPoolDatabasesUpdateFuture) result(client KustoPoolDatabasesClient) (dm DatabaseModel, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "synapse.KustoPoolDatabasesUpdateFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		dm.Response.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("synapse.KustoPoolDatabasesUpdateFuture")
		return
	}
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if dm.Response.Response, err = future.GetResult(sender); err == nil && dm.Response.Response.StatusCode != http.StatusNoContent {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "synapse.KustoPoolDatabasesUpdateFuture", "Result", dm.Response.Response, "Failure responding to request")
		}
	}
	return
}

// KustoPoolDataConnectionsCreateOrUpdateFuture an abstraction for monitoring and retrieving the results of
// a long-running operation.
type KustoPoolDataConnectionsCreateOrUpdateFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(KustoPoolDataConnectionsClient) (DataConnectionModel, error)
}

// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *KustoPoolDataConnectionsCreateOrUpdateFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for KustoPoolDataConnectionsCreateOrUpdateFuture.Result.
func (future *KustoPoolDataConnectionsCreateOrUpdateFuture) result(client KustoPoolDataConnectionsClient) (dcm DataConnectionModel, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "synapse.KustoPoolDataConnectionsCreateOrUpdateFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		dcm.Response.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("synapse.KustoPoolDataConnectionsCreateOrUpdateFuture")
		return
	}
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if dcm.Response.Response, err = future.GetResult(sender); err == nil && dcm.Response.Response.StatusCode != http.StatusNoContent {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "synapse.KustoPoolDataConnectionsCreateOrUpdateFuture", "Result", dcm.Response.Response, "Failure responding to request")
		}
	}
	return
}

// KustoPoolDataConnectionsDataConnectionValidationMethodFuture an abstraction for monitoring and
// retrieving the results of a long-running operation.
type KustoPoolDataConnectionsDataConnectionValidationMethodFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(KustoPoolDataConnectionsClient) (DataConnectionValidationListResult, error)
}

// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *KustoPoolDataConnectionsDataConnectionValidationMethodFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for KustoPoolDataConnectionsDataConnectionValidationMethodFuture.Result.
func (future *KustoPoolDataConnectionsDataConnectionValidationMethodFuture) result(client KustoPoolDataConnectionsClient) (dcvlr DataConnectionValidationListResult, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "synapse.KustoPoolDataConnectionsDataConnectionValidationMethodFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		dcvlr.Response.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("synapse.KustoPoolDataConnectionsDataConnectionValidationMethodFuture")
		return
	}
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if dcvlr.Response.Response, err = future.GetResult(sender); err == nil && dcvlr.Response.Response.StatusCode != http.StatusNoContent {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "synapse.KustoPoolDataConnectionsDataConnectionValidationMethodFuture", "Result", dcvlr.Response.Response, "Failure responding to request")
		}
	}
	return
}

// KustoPoolDataConnectionsDeleteFuture an abstraction for monitoring and retrieving the results of a
// long-running operation.
type KustoPoolDataConnectionsDeleteFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(KustoPoolDataConnectionsClient) (autorest.Response, error)
}

// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *KustoPoolDataConnectionsDeleteFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for KustoPoolDataConnectionsDeleteFuture.Result.
func (future *KustoPoolDataConnectionsDeleteFuture) result(client KustoPoolDataConnectionsClient) (ar autorest.Response, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "synapse.KustoPoolDataConnectionsDeleteFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		ar.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("synapse.KustoPoolDataConnectionsDeleteFuture")
		return
	}
	ar.Response = future.Response()
	return
...
// KustoPoolDataConnectionsUpdateFuture an abstraction for monitoring and retrieving the results of a
// long-running operation.
type KustoPoolDataConnectionsUpdateFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(KustoPoolDataConnectionsClient) (DataConnectionModel, error)
...
// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *KustoPoolDataConnectionsUpdateFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for KustoPoolDataConnectionsUpdateFuture.Result.
func (future *KustoPoolDataConnectionsUpdateFuture) result(client KustoPoolDataConnectionsClient) (dcm DataConnectionModel, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "synapse.KustoPoolDataConnectionsUpdateFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		dcm.Response.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("synapse.KustoPoolDataConnectionsUpdateFuture")
		return
	}
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if dcm.Response.Response, err = future.GetResult(sender); err == nil && dcm.Response.Response.StatusCode != http.StatusNoContent {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "synapse.KustoPoolDataConnectionsUpdateFuture", "Result", dcm.Response.Response, "Failure responding to request")
		}
	}
	return
}
...
type KustoPoolListResult struct {
	autorest.Response `json:"-"`
	// Value - The list of Kusto pools.
	Value *[]KustoPool `json:"value,omitempty"`
}

// KustoPoolPrincipalAssignmentsCreateOrUpdateFuture an abstraction for monitoring and retrieving the
// results of a long-running operation.
type KustoPoolPrincipalAssignmentsCreateOrUpdateFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(KustoPoolPrincipalAssignmentsClient) (ClusterPrincipalAssignment, error)
}

// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *KustoPoolPrincipalAssignmentsCreateOrUpdateFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for KustoPoolPrincipalAssignmentsCreateOrUpdateFuture.Result.
func (future *KustoPoolPrincipalAssignmentsCreateOrUpdateFuture) result(client KustoPoolPrincipalAssignmentsClient) (cpa ClusterPrincipalAssignment, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "synapse.KustoPoolPrincipalAssignmentsCreateOrUpdateFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		cpa.Response.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("synapse.KustoPoolPrincipalAssignmentsCreateOrUpdateFuture")
		return
	}
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if cpa.Response.Response, err = future.GetResult(sender); err == nil && cpa.Response.Response.StatusCode != http.StatusNoContent {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "synapse.KustoPoolPrincipalAssignmentsCreateOrUpdateFuture", "Result", cpa.Response.Response, "Failure responding to request")
		}
	}
	return
}

// KustoPoolPrincipalAssignmentsDeleteFuture an abstraction for monitoring and retrieving the results of a
// long-running operation.
type KustoPoolPrincipalAssignmentsDeleteFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(KustoPoolPrincipalAssignmentsClient) (autorest.Response, error)
}

// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *KustoPoolPrincipalAssignmentsDeleteFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for KustoPoolPrincipalAssignmentsDeleteFuture.Result.
func (future *KustoPoolPrincipalAssignmentsDeleteFuture) result(client KustoPoolPrincipalAssignmentsClient) (ar autorest.Response, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "synapse.KustoPoolPrincipalAssignmentsDeleteFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		ar.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("synapse.KustoPoolPrincipalAssignmentsDeleteFuture")
		return
	}
	ar.Response = future.Response()
	return
...
type KustoPoolProperties struct {
	...
	// ProvisioningState - The provisioned state of the resource. Possible values include: 'ResourceProvisioningStateRunning', 'ResourceProvisioningStateCreating', 'ResourceProvisioningStateDeleting', 'ResourceProvisioningStateSucceeded', 'ResourceProvisioningStateFailed', 'ResourceProvisioningStateMoving', 'ResourceProvisioningStateCanceled'
	ProvisioningState ResourceProvisioningState `json:"provisioningState,omitempty"`
	// URI - READ-ONLY; The Kusto Pool URI.
	URI *string `json:"uri,omitempty"`
	// DataIngestionURI - READ-ONLY; The Kusto Pool data ingestion URI.
	DataIngestionURI *string `json:"dataIngestionUri,omitempty"`
	// StateReason - READ-ONLY; The reason for the Kusto Pool's current state.
	...
	// LanguageExtensions - READ-ONLY; List of the Kusto Pool's language extensions.
...
// MarshalJSON is the custom marshaler for KustoPoolProperties.
func (kpp KustoPoolProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if kpp.ProvisioningState != "" {
		objectMap["provisioningState"] = kpp.ProvisioningState
	}
	if kpp.OptimizedAutoscale != nil {
		objectMap["optimizedAutoscale"] = kpp.OptimizedAutoscale
	}
	if kpp.EnableStreamingIngest != nil {
		objectMap["enableStreamingIngest"] = kpp.EnableStreamingIngest
	}
	if kpp.EnablePurge != nil {
		objectMap["enablePurge"] = kpp.EnablePurge
	}
	if kpp.WorkspaceUID != nil {
		objectMap["workspaceUID"] = kpp.WorkspaceUID
	}
	return json.Marshal(objectMap)
}

// KustoPoolsAddLanguageExtensionsFuture an abstraction for monitoring and retrieving the results of a
// long-running operation.
type KustoPoolsAddLanguageExtensionsFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(KustoPoolsClient) (autorest.Response, error)
}

// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *KustoPoolsAddLanguageExtensionsFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for KustoPoolsAddLanguageExtensionsFuture.Result.
func (future *KustoPoolsAddLanguageExtensionsFuture) result(client KustoPoolsClient) (ar autorest.Response, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "synapse.KustoPoolsAddLanguageExtensionsFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		ar.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("synapse.KustoPoolsAddLanguageExtensionsFuture")
		return
	}
	ar.Response = future.Response()
	return
...
// KustoPoolsCreateOrUpdateFuture an abstraction for monitoring and retrieving the results of a
// long-running operation.
type KustoPoolsCreateOrUpdateFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(KustoPoolsClient) (KustoPool, error)
}

// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *KustoPoolsCreateOrUpdateFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for KustoPoolsCreateOrUpdateFuture.Result.
func (future *KustoPoolsCreateOrUpdateFuture) result(client KustoPoolsClient) (kp KustoPool, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "synapse.KustoPoolsCreateOrUpdateFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		kp.Response.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("synapse.KustoPoolsCreateOrUpdateFuture")
		return
	}
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if kp.Response.Response, err = future.GetResult(sender); err == nil && kp.Response.Response.StatusCode != http.StatusNoContent {
		kp, err = client.CreateOrUpdateResponder(kp.Response.Response)
		if err != nil {
			err = autorest.NewErrorWithError(err, "synapse.KustoPoolsCreateOrUpdateFuture", "Result", kp.Response.Response, "Failure responding to request")
		}
	}
	return
}

// KustoPoolsDeleteFuture an abstraction for monitoring and retrieving the results of a long-running
// operation.
type KustoPoolsDeleteFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(KustoPoolsClient) (autorest.Response, error)
...
// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *KustoPoolsDeleteFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for KustoPoolsDeleteFuture.Result.
func (future *KustoPoolsDeleteFuture) result(client KustoPoolsClient) (ar autorest.Response, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "synapse.KustoPoolsDeleteFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		ar.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("synapse.KustoPoolsDeleteFuture")
		return
	}
	ar.Response = future.Response()
	return
...
// KustoPoolsDetachFollowerDatabasesFuture an abstraction for monitoring and retrieving the results of a
// long-running operation.
type KustoPoolsDetachFollowerDatabasesFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(KustoPoolsClient) (autorest.Response, error)
...
// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *KustoPoolsDetachFollowerDatabasesFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for KustoPoolsDetachFollowerDatabasesFuture.Result.
func (future *KustoPoolsDetachFollowerDatabasesFuture) result(client KustoPoolsClient) (ar autorest.Response, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "synapse.KustoPoolsDetachFollowerDatabasesFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		ar.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("synapse.KustoPoolsDetachFollowerDatabasesFuture")
		return
	}
	ar.Response = future.Response()
	return
...
// KustoPoolsRemoveLanguageExtensionsFuture an abstraction for monitoring and retrieving the results of a
// long-running operation.
type KustoPoolsRemoveLanguageExtensionsFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(KustoPoolsClient) (autorest.Response, error)
...
// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *KustoPoolsRemoveLanguageExtensionsFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for KustoPoolsRemoveLanguageExtensionsFuture.Result.
func (future *KustoPoolsRemoveLanguageExtensionsFuture) result(client KustoPoolsClient) (ar autorest.Response, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "synapse.KustoPoolsRemoveLanguageExtensionsFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		ar.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("synapse.KustoPoolsRemoveLanguageExtensionsFuture")
		return
	}
	ar.Response = future.Response()
	return
...
// KustoPoolsStartFuture an abstraction for monitoring and retrieving the results of a long-running
// operation.
type KustoPoolsStartFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(KustoPoolsClient) (autorest.Response, error)
...
// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *KustoPoolsStartFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for KustoPoolsStartFuture.Result.
func (future *KustoPoolsStartFuture) result(client KustoPoolsClient) (ar autorest.Response, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "synapse.KustoPoolsStartFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		ar.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("synapse.KustoPoolsStartFuture")
		return
	}
	ar.Response = future.Response()
	return
...
// KustoPoolsStopFuture an abstraction for monitoring and retrieving the results of a long-running
// operation.
type KustoPoolsStopFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(KustoPoolsClient) (autorest.Response, error)
...
// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *KustoPoolsStopFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for KustoPoolsStopFuture.Result.
func (future *KustoPoolsStopFuture) result(client KustoPoolsClient) (ar autorest.Response, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "synapse.KustoPoolsStopFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		ar.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("synapse.KustoPoolsStopFuture")
		return
	}
	ar.Response = future.Response()
	return
...
// KustoPoolsUpdateFuture an abstraction for monitoring and retrieving the results of a long-running
// operation.
type KustoPoolsUpdateFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(KustoPoolsClient) (KustoPool, error)
...
// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *KustoPoolsUpdateFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for KustoPoolsUpdateFuture.Result.
func (future *KustoPoolsUpdateFuture) result(client KustoPoolsClient) (kp KustoPool, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "synapse.KustoPoolsUpdateFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		kp.Response.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("synapse.KustoPoolsUpdateFuture")
		return
	}
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if kp.Response.Response, err = future.GetResult(sender); err == nil && kp.Response.Response.StatusCode != http.StatusNoContent {
		kp, err = client.UpdateResponder(kp.Response.Response)
		if err != nil {
			err = autorest.NewErrorWithError(err, "synapse.KustoPoolsUpdateFuture", "Result", kp.Response.Response, "Failure responding to request")
		}
	}
	return
}
...
// MarshalJSON is the custom marshaler for KustoPoolUpdate.
func (kpu KustoPoolUpdate) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if kpu.Tags != nil {
		objectMap["tags"] = kpu.Tags
	}
	if kpu.Sku != nil {
		objectMap["sku"] = kpu.Sku
	}
	if kpu.KustoPoolProperties != nil {
		objectMap["properties"] = kpu.KustoPoolProperties
	}
	return json.Marshal(objectMap)
}

// UnmarshalJSON is the custom unmarshaler for KustoPoolUpdate struct.
func (kpu *KustoPoolUpdate) UnmarshalJSON(body []byte) error {
	var m map[string]*json.RawMessage
	err := json.Unmarshal(body, &m)
	if err != nil {
		return err
	...
	for k, v := range m {
		...
		case "properties":
			if v != nil {
				...
				kpu.KustoPoolProperties = &kustoPoolProperties
			}
		case "id":
			if v != nil {
				var ID string
...
func (mir ManagedIntegrationRuntime) MarshalJSON() ([]byte, error) {
	mir.Type = TypeBasicIntegrationRuntimeTypeManaged
	objectMap := make(map[string]interface{})
...
func (shir SelfHostedIntegrationRuntime) MarshalJSON() ([]byte, error) {
	shir.Type = TypeBasicIntegrationRuntimeTypeSelfHosted
	objectMap := make(map[string]interface{})
