...
// AnalysisResultsClient is the test Base
...
func (client AnalysisResultsClient) Get(ctx context.Context, resourceGroupName string, testBaseAccountName string, packageName string, testResultName string, analysisResultName AnalysisResultName) (result AnalysisResultSingletonResource, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/AnalysisResultsClient.Get")
		defer func() {
			sc := -1
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "testbase.AnalysisResultsClient", "Get", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "testbase.AnalysisResultsClient", "Get", resp, "Failure sending request")
		return
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "testbase.AnalysisResultsClient", "Get", resp, "Failure responding to request")
		return
	}
...
func (client AnalysisResultsClient) GetPreparer(ctx context.Context, resourceGroupName string, testBaseAccountName string, packageName string, testResultName string, analysisResultName AnalysisResultName) (*http.Request, error) {
...
func (client AnalysisResultsClient) GetSender(req *http.Request) (*http.Response, error) {
	return client.Send(req, azure.DoRetryWithRegistration(client.Client))
}

// GetResponder handles the response to the Get request. The method always
// closes the http.Response Body.
func (client AnalysisResultsClient) GetResponder(resp *http.Response) (result AnalysisResultSingletonResource, err error) {
