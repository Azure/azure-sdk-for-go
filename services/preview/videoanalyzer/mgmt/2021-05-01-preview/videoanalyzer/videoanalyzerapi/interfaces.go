...
type VideoAnalyzersClientAPI interface {
	CreateOrUpdate(ctx context.Context, resourceGroupName string, accountName string, parameters videoanalyzer.VideoAnalyzer) (result videoanalyzer.VideoAnalyzer, err error)
	Delete(ctx context.Context, resourceGroupName string, accountName string) (result autorest.Response, err error)
	Get(ctx context.Context, resourceGroupName string, accountName string) (result videoanalyzer.VideoAnalyzer, err error)
	...
	Update(ctx context.Context, resourceGroupName string, accountName string, parameters videoanalyzer.Update) (result videoanalyzer.VideoAnalyzer, err error)
}
