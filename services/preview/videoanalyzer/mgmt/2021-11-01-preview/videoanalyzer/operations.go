...
func (client OperationsClient) List(ctx context.Context) (result OperationCollection, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "videoanalyzer.OperationsClient", "List", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "videoanalyzer.OperationsClient", "List", resp, "Failure sending request")
		return
	}

	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "videoanalyzer.OperationsClient", "List", resp, "Failure responding to request")
		return
	}
