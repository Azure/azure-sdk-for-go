...
// PipelineJobsClient is the azure Video Analyzer provides a platform for you to build intelligent video applications
...
func NewPipelineJobsClient(subscriptionID string) PipelineJobsClient {
	return NewPipelineJobsClientWithBaseURI(DefaultBaseURI, subscriptionID)
}

// NewPipelineJobsClientWithBaseURI creates an instance of the PipelineJobsClient client using a custom endpoint.  Use
// this when interacting with an Azure cloud that uses a non-standard base URI (sovereign clouds, Azure stack).
func NewPipelineJobsClientWithBaseURI(baseURI string, subscriptionID string) PipelineJobsClient {
	return PipelineJobsClient{NewWithBaseURI(baseURI, subscriptionID)}
}
...
func (client PipelineJobsClient) CancelPreparer(ctx context.Context, resourceGroupName string, accountName string, pipelineJobName string) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithPathParameters("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Media/videoAnalyzers/{accountName}/pipelineJobs/{pipelineJobName}/cancel", pathParameters),
...
func (client PipelineJobsClient) CreateOrUpdate(ctx context.Context, resourceGroupName string, accountName string, pipelineJobName string, parameters PipelineJob) (result PipelineJob, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/PipelineJobsClient.CreateOrUpdate")
		defer func() {
			sc := -1
	...
	if err := validation.Validate([]validation.Validation{
		...
		{TargetValue: parameters,
			Constraints: []validation.Constraint{{Target: "parameters.PipelineJobProperties", Name: validation.Null, Rule: false,
				Chain: []validation.Constraint{{Target: "parameters.PipelineJobProperties.TopologyName", Name: validation.Null, Rule: true, Chain: nil}}}}}}); err != nil {
		return result, validation.NewError("videoanalyzer.PipelineJobsClient", "CreateOrUpdate", err.Error())
	}

	req, err := client.CreateOrUpdatePreparer(ctx, resourceGroupName, accountName, pipelineJobName, parameters)
	if err != nil {
		err = autorest.NewErrorWithError(err, "videoanalyzer.PipelineJobsClient", "CreateOrUpdate", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "videoanalyzer.PipelineJobsClient", "CreateOrUpdate", resp, "Failure sending request")
		return
	}

	result, err = client.CreateOrUpdateResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "videoanalyzer.PipelineJobsClient", "CreateOrUpdate", resp, "Failure responding to request")
		return
	}
...
// Get retrieves a specific pipeline job by name. If a pipeline job with that name has been previously created, the
...
func (client PipelineJobsClient) Get(ctx context.Context, resourceGroupName string, accountName string, pipelineJobName string) (result PipelineJob, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/PipelineJobsClient.Get")
		defer func() {
			sc := -1
			if result.Response.Response != nil {
				sc = result.Response.Response.StatusCode
	...
	if err := validation.Validate([]validation.Validation{
		...
		{TargetValue: resourceGroupName,
			Constraints: []validation.Constraint{{Target: "resourceGroupName", Name: validation.MaxLength, Rule: 90, Chain: nil},
				{Target: "resourceGroupName", Name: validation.MinLength, Rule: 1, Chain: nil}}}}); err != nil {
		return result, validation.NewError("videoanalyzer.PipelineJobsClient", "Get", err.Error())
	}

	req, err := client.GetPreparer(ctx, resourceGroupName, accountName, pipelineJobName)
	if err != nil {
		err = autorest.NewErrorWithError(err, "videoanalyzer.PipelineJobsClient", "Get", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "videoanalyzer.PipelineJobsClient", "Get", resp, "Failure sending request")
		return
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "videoanalyzer.PipelineJobsClient", "Get", resp, "Failure responding to request")
		return
	}
...
func (client PipelineJobsClient) List(ctx context.Context, resourceGroupName string, accountName string, filter string, top *int32) (result PipelineJobCollectionPage, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/PipelineJobsClient.List")
		defer func() {
			sc := -1
			if result.pjc.Response.Response != nil {
				sc = result.pjc.Response.Response.StatusCode
			}
			tracing.EndSpan(ctx, sc, err)
		}()
	}
	if err := validation.Validate([]validation.Validation{
		...
		{TargetValue: resourceGroupName,
			Constraints: []validation.Constraint{{Target: "resourceGroupName", Name: validation.MaxLength, Rule: 90, Chain: nil},
				{Target: "resourceGroupName", Name: validation.MinLength, Rule: 1, Chain: nil}}}}); err != nil {
		return result, validation.NewError("videoanalyzer.PipelineJobsClient", "List", err.Error())
	}

	result.fn = client.listNextResults
	req, err := client.ListPreparer(ctx, resourceGroupName, accountName, filter, top)
	if err != nil {
		err = autorest.NewErrorWithError(err, "videoanalyzer.PipelineJobsClient", "List", nil, "Failure preparing request")
		return
	}

	resp, err := client.ListSender(req)
	if err != nil {
		result.pjc.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "videoanalyzer.PipelineJobsClient", "List", resp, "Failure sending request")
		return
	}

	result.pjc, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "videoanalyzer.PipelineJobsClient", "List", resp, "Failure responding to request")
		return
	}
	if result.pjc.hasNextLink() && result.pjc.IsEmpty() {
...
func (client PipelineJobsClient) ListPreparer(ctx context.Context, resourceGroupName string, accountName string, filter string, top *int32) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		autorest.AsGet(),
		autorest.WithBaseURL(client.BaseURI),
		autorest.WithPathParameters("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Media/videoAnalyzers/{accountName}/pipelineJobs", pathParameters),
		autorest.WithQueryParameters(queryParameters))
	return preparer.Prepare((&http.Request{}).WithContext(ctx))
}
...
func (client PipelineJobsClient) listNextResults(ctx context.Context, lastResults PipelineJobCollection) (result PipelineJobCollection, err error) {
	req, err := lastResults.pipelineJobCollectionPreparer(ctx)
	if err != nil {
		return result, autorest.NewErrorWithError(err, "videoanalyzer.PipelineJobsClient", "listNextResults", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "videoanalyzer.PipelineJobsClient", "listNextResults", resp, "Failure sending next results request")
	}
	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "videoanalyzer.PipelineJobsClient", "listNextResults", resp, "Failure responding to next results request")
	}
	return
}
...
func (client PipelineJobsClient) Update(ctx context.Context, resourceGroupName string, accountName string, pipelineJobName string, parameters PipelineJobUpdate) (result PipelineJob, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/PipelineJobsClient.Update")
		defer func() {
			sc := -1
			if result.Response.Response != nil {
				sc = result.Response.Response.StatusCode
	...
	if err := validation.Validate([]validation.Validation{
		...
		{TargetValue: resourceGroupName,
			Constraints: []validation.Constraint{{Target: "resourceGroupName", Name: validation.MaxLength, Rule: 90, Chain: nil},
				{Target: "resourceGroupName", Name: validation.MinLength, Rule: 1, Chain: nil}}}}); err != nil {
		return result, validation.NewError("videoanalyzer.PipelineJobsClient", "Update", err.Error())
	}

	req, err := client.UpdatePreparer(ctx, resourceGroupName, accountName, pipelineJobName, parameters)
	if err != nil {
		err = autorest.NewErrorWithError(err, "videoanalyzer.PipelineJobsClient", "Update", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "videoanalyzer.PipelineJobsClient", "Update", resp, "Failure sending request")
		return
	}

	result, err = client.UpdateResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "videoanalyzer.PipelineJobsClient", "Update", resp, "Failure responding to request")
		return
	}
