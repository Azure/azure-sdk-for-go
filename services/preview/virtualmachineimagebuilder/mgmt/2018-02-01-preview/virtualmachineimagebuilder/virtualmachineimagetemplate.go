...
func (client VirtualMachineImageTemplateClient) CreateOrUpdateSender(req *http.Request) (future VirtualMachineImageTemplateCreateOrUpdateFuture, err error) {
	...
	future.Result = func(client VirtualMachineImageTemplateClient) (it ImageTemplate, err error) {
		...
		if it.Response.Response == nil && err == nil {
			err = autorest.NewErrorWithError(err, "virtualmachineimagebuilder.VirtualMachineImageTemplateCreateOrUpdateFuture", "Result", nil, "received nil response and error")
		}
