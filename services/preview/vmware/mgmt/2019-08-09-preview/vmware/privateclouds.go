...
func (client PrivateCloudsClient) CreateOrUpdate(ctx context.Context, resourceGroupName string, privateCloudName string, privateCloud PrivateCloud) (result PrivateCloudsCreateOrUpdateFuture, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		{TargetValue: privateCloud,
			Constraints: []validation.Constraint{{Target: "privateCloud.Sku", Name: validation.Null, Rule: false,
				Chain: []validation.Constraint{{Target: "privateCloud.Sku.Name", Name: validation.Null, Rule: true, Chain: nil}}}}}}); err != nil {
		return result, validation.NewError("vmware.PrivateCloudsClient", "CreateOrUpdate", err.Error())
	}

	req, err := client.CreateOrUpdatePreparer(ctx, resourceGroupName, privateCloudName, privateCloud)
	if err != nil {
		err = autorest.NewErrorWithError(err, "vmware.PrivateCloudsClient", "CreateOrUpdate", nil, "Failure preparing request")
		return
	}

	result, err = client.CreateOrUpdateSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "vmware.PrivateCloudsClient", "CreateOrUpdate", result.Response(), "Failure sending request")
		return
	}
...
func (client PrivateCloudsClient) Delete(ctx context.Context, resourceGroupName string, privateCloudName string) (result PrivateCloudsDeleteFuture, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "vmware.PrivateCloudsClient", "Delete", nil, "Failure preparing request")
		return
	}

	result, err = client.DeleteSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "vmware.PrivateCloudsClient", "Delete", result.Response(), "Failure sending request")
		return
	}
...
func (client PrivateCloudsClient) Get(ctx context.Context, resourceGroupName string, privateCloudName string) (result PrivateCloud, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "vmware.PrivateCloudsClient", "Get", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "vmware.PrivateCloudsClient", "Get", resp, "Failure sending request")
		return
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "vmware.PrivateCloudsClient", "Get", resp, "Failure responding to request")
	}
...
func (client PrivateCloudsClient) List(ctx context.Context, resourceGroupName string) (result PrivateCloudListPage, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "vmware.PrivateCloudsClient", "List", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "vmware.PrivateCloudsClient", "List", resp, "Failure sending request")
		return
	}

	result.pcl, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "vmware.PrivateCloudsClient", "List", resp, "Failure responding to request")
	}
...
func (client PrivateCloudsClient) listNextResults(ctx context.Context, lastResults PrivateCloudList) (result PrivateCloudList, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "vmware.PrivateCloudsClient", "listNextResults", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "vmware.PrivateCloudsClient", "listNextResults", resp, "Failure sending next results request")
	}
	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "vmware.PrivateCloudsClient", "listNextResults", resp, "Failure responding to next results request")
	}
	return
}
...
func (client PrivateCloudsClient) ListAdminCredentials(ctx context.Context, resourceGroupName string, privateCloudName string) (result AdminCredentials, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "vmware.PrivateCloudsClient", "ListAdminCredentials", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "vmware.PrivateCloudsClient", "ListAdminCredentials", resp, "Failure sending request")
		return
	}

	result, err = client.ListAdminCredentialsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "vmware.PrivateCloudsClient", "ListAdminCredentials", resp, "Failure responding to request")
	}
...
func (client PrivateCloudsClient) ListInSubscription(ctx context.Context) (result PrivateCloudListPage, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "vmware.PrivateCloudsClient", "ListInSubscription", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.pcl.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "vmware.PrivateCloudsClient", "ListInSubscription", resp, "Failure sending request")
		return
	}

	result.pcl, err = client.ListInSubscriptionResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "vmware.PrivateCloudsClient", "ListInSubscription", resp, "Failure responding to request")
	}
...
func (client PrivateCloudsClient) listInSubscriptionNextResults(ctx context.Context, lastResults PrivateCloudList) (result PrivateCloudList, err error) {
	req, err := lastResults.privateCloudListPreparer(ctx)
	if err != nil {
		return result, autorest.NewErrorWithError(err, "vmware.PrivateCloudsClient", "listInSubscriptionNextResults", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "vmware.PrivateCloudsClient", "listInSubscriptionNextResults", resp, "Failure sending next results request")
	}
	result, err = client.ListInSubscriptionResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "vmware.PrivateCloudsClient", "listInSubscriptionNextResults", resp, "Failure responding to next results request")
	}
	return
}
...
func (client PrivateCloudsClient) Update(ctx context.Context, resourceGroupName string, privateCloudName string, privateCloud PrivateCloud) (result PrivateCloudsUpdateFuture, err error) {
	...
	req, err := client.UpdatePreparer(ctx, resourceGroupName, privateCloudName, privateCloud)
	if err != nil {
		err = autorest.NewErrorWithError(err, "vmware.PrivateCloudsClient", "Update", nil, "Failure preparing request")
		return
	}

	result, err = client.UpdateSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "vmware.PrivateCloudsClient", "Update", result.Response(), "Failure sending request")
		return
	}
