...
type GlobalDomainRegistrationClientAPI interface {
	...
	ListDomainRecommendationsComplete(ctx context.Context, parameters DomainRecommendationSearchParameters) (result web.NameIdentifierCollectionIterator, err error)
...
type SitesClientAPI interface {
	...
	GetSlotsDifferencesFromProductionComplete(ctx context.Context, resourceGroupName string, name string, slotSwapEntity CsmSlotEntity) (result web.SlotDifferenceCollectionIterator, err error)
	...
	GetSlotsDifferencesSlotComplete(ctx context.Context, resourceGroupName string, name string, slotSwapEntity CsmSlotEntity, slot string) (result web.SlotDifferenceCollectionIterator, err error)
...
type TopLevelDomainsClientAPI interface {
	...
	ListTopLevelDomainAgreementsComplete(ctx context.Context, name string, agreementOption TopLevelDomainAgreementOption) (result web.TldLegalAgreementCollectionIterator, err error)
}
