...
func (client Client) CreateOrUpdate(ctx context.Context, parameters ResourceType, resourceGroupName string, resourceName string) (result CreateOrUpdateFuture, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "webpubsub.Client", "CreateOrUpdate", result.Response(), "Failure sending request")
		return
	}
...
func (client Client) Delete(ctx context.Context, resourceGroupName string, resourceName string) (result DeleteFuture, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "webpubsub.Client", "Delete", result.Response(), "Failure sending request")
		return
	}
...
func (client Client) ListSkus(ctx context.Context, resourceGroupName string, resourceName string) (result SkuList, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "webpubsub.Client", "ListSkus", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "webpubsub.Client", "ListSkus", resp, "Failure sending request")
		return
	}

	result, err = client.ListSkusResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "webpubsub.Client", "ListSkus", resp, "Failure responding to request")
		return
	}
...
func (client Client) ListSkusPreparer(ctx context.Context, resourceGroupName string, resourceName string) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		autorest.AsGet(),
		autorest.WithBaseURL(client.BaseURI),
		autorest.WithPathParameters("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.SignalRService/webPubSub/{resourceName}/skus", pathParameters),
		autorest.WithQueryParameters(queryParameters))
	return preparer.Prepare((&http.Request{}).WithContext(ctx))
}
...
func (client Client) RegenerateKey(ctx context.Context, parameters RegenerateKeyParameters, resourceGroupName string, resourceName string) (result RegenerateKeyFuture, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "webpubsub.Client", "RegenerateKey", result.Response(), "Failure sending request")
		return
	}
...
func (client Client) Restart(ctx context.Context, resourceGroupName string, resourceName string) (result RestartFuture, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "webpubsub.Client", "Restart", result.Response(), "Failure sending request")
		return
	}
...
func (client Client) Update(ctx context.Context, parameters ResourceType, resourceGroupName string, resourceName string) (result UpdateFuture, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "webpubsub.Client", "Update", result.Response(), "Failure sending request")
		return
	}
