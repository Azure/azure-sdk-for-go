...
import (
	"context"
	"github.com/Azure/azure-sdk-for-go/services/preview/webpubsub/mgmt/2021-09-01-preview/webpubsub"
)
...
type ClientAPI interface {
	...
	ListSkus(ctx context.Context, resourceGroupName string, resourceName string) (result webpubsub.SkuList, err error)
