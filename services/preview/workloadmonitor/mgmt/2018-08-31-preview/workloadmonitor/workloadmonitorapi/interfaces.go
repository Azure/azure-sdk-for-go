...
type NotificationSettingsClientAPI interface {
	Get(ctx context.Context, resourceGroupName string, resourceNamespace string, resourceType string, resourceName string, notificationSettingName string) (result workloadmonitor.NotificationSettingsCollection, err error)
	ListByResource(ctx context.Context, resourceGroupName string, resourceNamespace string, resourceType string, resourceName string) (result workloadmonitor.NotificationSettingsCollection, err error)
	Update(ctx context.Context, resourceGroupName string, resourceNamespace string, resourceType string, resourceName string, notificationSettingName string, body workloadmonitor.NotificationSetting) (result workloadmonitor.NotificationSettingsCollection, err error)
}
