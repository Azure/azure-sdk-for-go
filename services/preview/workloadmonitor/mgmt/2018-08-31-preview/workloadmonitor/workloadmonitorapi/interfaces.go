...
type NotificationSettingsClientAPI interface {
	...
	Update(ctx context.Context, resourceGroupName string, resourceNamespace string, resourceType string, resourceName string, body workloadmonitor.NotificationSetting) (result workloadmonitor.NotificationSettingsCollection, err error)
}
