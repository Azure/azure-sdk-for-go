...
func (client OperationsClient) List(ctx context.Context) (result OperationListPage, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "workloadmonitor.OperationsClient", "List", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "workloadmonitor.OperationsClient", "List", resp, "Failure sending request")
		return
	}
...
func (client OperationsClient) ListPreparer(ctx context.Context) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithPath("/providers/Microsoft.WorkloadMonitor/operations"),
...
func (client OperationsClient) listNextResults(ctx context.Context, lastResults OperationList) (result OperationList, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "workloadmonitor.OperationsClient", "listNextResults", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "workloadmonitor.OperationsClient", "listNextResults", resp, "Failure sending next results request")
	}
