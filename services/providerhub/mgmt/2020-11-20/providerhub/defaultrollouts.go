...
// DefaultRolloutsClient is the microsoft Provider Hub
...
func (client DefaultRolloutsClient) CreateOrUpdate(ctx context.Context, providerNamespace string, rolloutName string) (result DefaultRolloutsCreateOrUpdateFuture, err error) {
	...
	req, err := client.CreateOrUpdatePreparer(ctx, providerNamespace, rolloutName)
	if err != nil {
...
func (client DefaultRolloutsClient) CreateOrUpdatePreparer(ctx context.Context, providerNamespace string, rolloutName string) (*http.Request, error) {
...
func (client DefaultRolloutsClient) CreateOrUpdateSender(req *http.Request) (future DefaultRolloutsCreateOrUpdateFuture, err error) {
	...
	future.Result = func(client DefaultRolloutsClient) (dr DefaultRollout, err error) {
		var done bool
		...
		if dr.Response.Response == nil && err == nil {
			err = autorest.NewErrorWithError(err, "providerhub.DefaultRolloutsCreateOrUpdateFuture", "Result", nil, "received nil response and error")
		}
