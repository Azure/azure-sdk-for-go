...
const (
	// ArcZone ...
	ArcZone ExtendedLocationType = "ArcZone"
	// EdgeZone ...
	EdgeZone ExtendedLocationType = "EdgeZone"
	// NotSpecified ...
	NotSpecified ExtendedLocationType = "NotSpecified"
)
...
func PossibleExtendedLocationTypeValues() []ExtendedLocationType {
	return []ExtendedLocationType{ArcZone, EdgeZone, NotSpecified}
}
...
// OperationActionType enumerates the values for operation action type.
...
// PossibleOperationActionTypeValues returns an array of possible values for the OperationActionType const type.
func PossibleOperationActionTypeValues() []OperationActionType {
	return []OperationActionType{OperationActionTypeInternal, OperationActionTypeNotSpecified}
}

// OperationOrigins enumerates the values for operation origins.
...
// PossibleOperationOriginsValues returns an array of possible values for the OperationOrigins const type.
func PossibleOperationOriginsValues() []OperationOrigins {
	return []OperationOrigins{OperationOriginsNotSpecified, OperationOriginsSystem, OperationOriginsUser}
}
