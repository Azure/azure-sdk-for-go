...
type OperationsDefinition struct {
	...
	// Origin - Possible values include: 'OperationOriginsNotSpecified', 'OperationOriginsUser', 'OperationOriginsSystem'
	...
	// ActionType - Possible values include: 'OperationActionTypeNotSpecified', 'OperationActionTypeInternal'
...
type SkuLocationInfo struct {
	...
	// Type - Possible values include: 'NotSpecified', 'EdgeZone', 'ArcZone'
