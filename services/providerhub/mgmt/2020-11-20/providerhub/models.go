...
type CustomRollout struct {
	...
	*CustomRolloutProperties `json:"properties,omitempty"`
	// ID - READ-ONLY; Fully qualified resource ID for the resource. Ex - /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{resourceProviderNamespace}/{resourceType}/{resourceName}
	ID *string `json:"id,omitempty"`
	// Name - READ-ONLY; The name of the resource
	Name *string `json:"name,omitempty"`
...
func (cr CustomRollout) MarshalJSON() ([]byte, error) {
	...
	if cr.CustomRolloutProperties != nil {
		objectMap["properties"] = cr.CustomRolloutProperties
	}
	return json.Marshal(objectMap)
}

// UnmarshalJSON is the custom unmarshaler for CustomRollout struct.
func (cr *CustomRollout) UnmarshalJSON(body []byte) error {
	...
	for k, v := range m {
		...
		case "properties":
			if v != nil {
				var customRolloutProperties CustomRolloutProperties
				err = json.Unmarshal(*v, &customRolloutProperties)
				if err != nil {
					return err
				}
				cr.CustomRolloutProperties = &customRolloutProperties
			}
		case "id":
			if v != nil {
				var ID string
...
type DefaultRollout struct {
	...
	*DefaultRolloutProperties `json:"properties,omitempty"`
	// ID - READ-ONLY; Fully qualified resource ID for the resource. Ex - /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{resourceProviderNamespace}/{resourceType}/{resourceName}
	ID *string `json:"id,omitempty"`
	// Name - READ-ONLY; The name of the resource
	Name *string `json:"name,omitempty"`
...
func (dr DefaultRollout) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if dr.DefaultRolloutProperties != nil {
		objectMap["properties"] = dr.DefaultRolloutProperties
	}
	return json.Marshal(objectMap)
}

// UnmarshalJSON is the custom unmarshaler for DefaultRollout struct.
func (dr *DefaultRollout) UnmarshalJSON(body []byte) error {
	var m map[string]*json.RawMessage
	err := json.Unmarshal(body, &m)
	if err != nil {
		return err
	...
	for k, v := range m {
		...
		case "properties":
			if v != nil {
				var defaultRolloutProperties DefaultRolloutProperties
				err = json.Unmarshal(*v, &defaultRolloutProperties)
				if err != nil {
					return err
				}
				dr.DefaultRolloutProperties = &defaultRolloutProperties
			}
		case "id":
			if v != nil {
				var ID string
