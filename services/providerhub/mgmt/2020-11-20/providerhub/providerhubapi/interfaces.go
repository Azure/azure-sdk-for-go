...
type CustomRolloutsClientAPI interface {
	CreateOrUpdate(ctx context.Context, providerNamespace string, rolloutName string, properties providerhub.CustomRolloutProperties) (result providerhub.CustomRollout, err error)
...
type DefaultRolloutsClientAPI interface {
	CreateOrUpdate(ctx context.Context, providerNamespace string, rolloutName string) (result providerhub.DefaultRolloutsCreateOrUpdateFuture, err error)
