...
type SkusClientAPI interface {
	CreateOrUpdate(ctx context.Context, providerNamespace string, resourceType string, sku string, properties providerhub.SkuResource) (result providerhub.SkuResource, err error)
	CreateOrUpdateNestedResourceTypeFirst(ctx context.Context, providerNamespace string, resourceType string, nestedResourceTypeFirst string, sku string, properties providerhub.SkuResource) (result providerhub.SkuResource, err error)
	CreateOrUpdateNestedResourceTypeSecond(ctx context.Context, providerNamespace string, resourceType string, nestedResourceTypeFirst string, nestedResourceTypeSecond string, sku string, properties providerhub.SkuResource) (result providerhub.SkuResource, err error)
	CreateOrUpdateNestedResourceTypeThird(ctx context.Context, providerNamespace string, resourceType string, nestedResourceTypeFirst string, nestedResourceTypeSecond string, nestedResourceTypeThird string, sku string, properties providerhub.SkuResource) (result providerhub.SkuResource, err error)
