...
// ResourceTypeRegistrationsClient is the microsoft Provider Hub
...
func (client ResourceTypeRegistrationsClient) CreateOrUpdateSender(req *http.Request) (future ResourceTypeRegistrationsCreateOrUpdateFuture, err error) {
	...
	future.Result = func(client ResourceTypeRegistrationsClient) (rtr ResourceTypeRegistration, err error) {
		var done bool
		...
		rtr.Response.Response, err = future.GetResult(sender)
		if rtr.Response.Response == nil && err == nil {
			err = autorest.NewErrorWithError(err, "providerhub.ResourceTypeRegistrationsCreateOrUpdateFuture", "Result", nil, "received nil response and error")
		}
		if err == nil && rtr.Response.Response.StatusCode != http.StatusNoContent {
