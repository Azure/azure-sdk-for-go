...
func (client SkusClient) CreateOrUpdate(ctx context.Context, providerNamespace string, resourceType string, sku string, properties SkuResource) (result SkuResource, err error) {
...
func (client SkusClient) CreateOrUpdatePreparer(ctx context.Context, providerNamespace string, resourceType string, sku string, properties SkuResource) (*http.Request, error) {
...
// sku - the SKU.
// properties - the required body parameters supplied to the resource sku operation.
func (client SkusClient) CreateOrUpdateNestedResourceTypeFirst(ctx context.Context, providerNamespace string, resourceType string, nestedResourceTypeFirst string, sku string, properties SkuResource) (result SkuResource, err error) {
	if tracing.IsEnabled() {
...
func (client SkusClient) CreateOrUpdateNestedResourceTypeFirstPreparer(ctx context.Context, providerNamespace string, resourceType string, nestedResourceTypeFirst string, sku string, properties SkuResource) (*http.Request, error) {
	pathParameters := map[string]interface{}{
...
// sku - the SKU.
// properties - the required body parameters supplied to the resource sku operation.
func (client SkusClient) CreateOrUpdateNestedResourceTypeSecond(ctx context.Context, providerNamespace string, resourceType string, nestedResourceTypeFirst string, nestedResourceTypeSecond string, sku string, properties SkuResource) (result SkuResource, err error) {
	if tracing.IsEnabled() {
...
func (client SkusClient) CreateOrUpdateNestedResourceTypeSecondPreparer(ctx context.Context, providerNamespace string, resourceType string, nestedResourceTypeFirst string, nestedResourceTypeSecond string, sku string, properties SkuResource) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"nestedResourceTypeFirst":  autorest.Encode("path", nestedResourceTypeFirst),
...
// sku - the SKU.
// properties - the required body parameters supplied to the resource sku operation.
func (client SkusClient) CreateOrUpdateNestedResourceTypeThird(ctx context.Context, providerNamespace string, resourceType string, nestedResourceTypeFirst string, nestedResourceTypeSecond string, nestedResourceTypeThird string, sku string, properties SkuResource) (result SkuResource, err error) {
	if tracing.IsEnabled() {
...
func (client SkusClient) CreateOrUpdateNestedResourceTypeThirdPreparer(ctx context.Context, providerNamespace string, resourceType string, nestedResourceTypeFirst string, nestedResourceTypeSecond string, nestedResourceTypeThird string, sku string, properties SkuResource) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"nestedResourceTypeFirst":  autorest.Encode("path", nestedResourceTypeFirst),
		"nestedResourceTypeSecond": autorest.Encode("path", nestedResourceTypeSecond),
