...
// provisioning service name. certificatename is common Name for the certificate. certificaterawBytes is raw data of
// certificate. certificateisVerified is indicates if the certificate has been verified by owner of the private key.
// certificatepurpose is describe the purpose of the certificate. certificatecreated is certificate creation time.
// certificatelastUpdated is certificate last updated time. certificatehasPrivateKey is indicates if the certificate
// contains private key. certificatenonce is random number generated to indicate Proof of Possession.
