...
const (
	// All ...
	All IPFilterTargetType = "all"
	// DeviceAPI ...
	DeviceAPI IPFilterTargetType = "deviceApi"
	// ServiceAPI ...
	ServiceAPI IPFilterTargetType = "serviceApi"
)
...
func PossibleIPFilterTargetTypeValues() []IPFilterTargetType {
	return []IPFilterTargetType{All, DeviceAPI, ServiceAPI}
}
