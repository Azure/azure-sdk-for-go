...
// CreateOrUpdate create or update the quota limit for the specified resource to the requested value. To update the
// quota, follow these steps:
// 1. Use the GET operation to determine how much quota remains for the specific resource and to calculate the new
...
func (client Client) CreateOrUpdate(ctx context.Context, resourceName string, scope string, createQuotaRequest CurrentQuotaLimitBase) (result CreateOrUpdateFuture, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "quota.Client", "CreateOrUpdate", nil, "Failure sending request")
		return
	}
...
func (client Client) CreateOrUpdatePreparer(ctx context.Context, resourceName string, scope string, createQuotaRequest CurrentQuotaLimitBase) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithPathParameters("/{scope}/providers/Microsoft.Quota/quotaLimits/{resourceName}", pathParameters),
...
// Get gets the quota limit and current quota usage of a resource. The response can be used to determine the remaining
...
// List get a list of current quota limits and usages of all resources. The response from this GET operation can be
...
func (client Client) ListPreparer(ctx context.Context, scope string) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		autorest.AsGet(),
		autorest.WithBaseURL(client.BaseURI),
		autorest.WithPathParameters("/{scope}/providers/Microsoft.Quota/quotaLimits", pathParameters),
		autorest.WithQueryParameters(queryParameters))
	return preparer.Prepare((&http.Request{}).WithContext(ctx))
}
...
func (client Client) Update(ctx context.Context, resourceName string, scope string, createQuotaRequest CurrentQuotaLimitBase) (result UpdateFuture, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "quota.Client", "Update", nil, "Failure sending request")
		return
	}
