...
func (client Client) CheckNameAvailability(ctx context.Context, resourceGroupName string, location string, input ResourceNameAvailabilityParameters) (result ResourceNameAvailabilityResponseResource, err error) {
...
func (client Client) CheckNameAvailabilityResponder(resp *http.Response) (result ResourceNameAvailabilityResponseResource, err error) {
