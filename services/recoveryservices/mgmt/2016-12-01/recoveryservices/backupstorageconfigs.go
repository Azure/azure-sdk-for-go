...
func (client BackupStorageConfigsClient) Get(ctx context.Context, resourceGroupName string, vaultName string) (result BackupStorageConfig, err error) {
...
func (client BackupStorageConfigsClient) GetPreparer(ctx context.Context, resourceGroupName string, vaultName string) (*http.Request, error) {
...
func (client BackupStorageConfigsClient) Update(ctx context.Context, resourceGroupName string, vaultName string, backupStorageConfig BackupStorageConfig) (result autorest.Response, err error) {
	req, err := client.UpdatePreparer(ctx, resourceGroupName, vaultName, backupStorageConfig)
	if err != nil {
...
func (client BackupStorageConfigsClient) UpdatePreparer(ctx context.Context, resourceGroupName string, vaultName string, backupStorageConfig BackupStorageConfig) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"subscriptionId":    autorest.Encode("path", client.SubscriptionID),
		"vaultName":         autorest.Encode("path", vaultName),
