...
func (client BackupVaultConfigsClient) Get(ctx context.Context, resourceGroupName string, vaultName string) (result BackupVaultConfig, err error) {
...
func (client BackupVaultConfigsClient) GetPreparer(ctx context.Context, resourceGroupName string, vaultName string) (*http.Request, error) {
...
func (client BackupVaultConfigsClient) Update(ctx context.Context, resourceGroupName string, vaultName string, backupVaultConfig BackupVaultConfig) (result BackupVaultConfig, err error) {
	req, err := client.UpdatePreparer(ctx, resourceGroupName, vaultName, backupVaultConfig)
	if err != nil {
...
func (client BackupVaultConfigsClient) UpdatePreparer(ctx context.Context, resourceGroupName string, vaultName string, backupVaultConfig BackupVaultConfig) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"subscriptionId":    autorest.Encode("path", client.SubscriptionID),
		"vaultName":         autorest.Encode("path", vaultName),
