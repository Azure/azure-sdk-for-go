...
// ManagementTypeBasicGenericBackupFabric enumerates the values for management type basic generic backup
// fabric.
type ManagementTypeBasicGenericBackupFabric string

const (
	// BackupManagementTypeGenericBackupFabric ...
	BackupManagementTypeGenericBackupFabric ManagementTypeBasicGenericBackupFabric = "GenericBackupFabric"
)

// PossibleManagementTypeBasicGenericBackupFabricValues returns an array of possible values for the ManagementTypeBasicGenericBackupFabric const type.
func PossibleManagementTypeBasicGenericBackupFabricValues() []ManagementTypeBasicGenericBackupFabric {
	return []ManagementTypeBasicGenericBackupFabric{BackupManagementTypeGenericBackupFabric}
}
...
// BMSBackupFabricQueryObject query parameters to fetch list of backup fabric.
type BMSBackupFabricQueryObject struct {
	// Expand - attribute to add extended info
	Expand *string `json:"expand,omitempty"`
}

// BMSBackupFabricsQueryObject query parameters to fetch list of backup fabrics.
type BMSBackupFabricsQueryObject struct {
	// BackupManagementType - Backup management type for the backup fabric.
	BackupManagementType *string `json:"backupManagementType,omitempty"`
	// FriendlyName - Friendly name of the backup fabric.
	FriendlyName *string `json:"friendlyName,omitempty"`
	// Expand - Attribute to add extended info.
	Expand *string `json:"expand,omitempty"`
}
...
// BasicGenericBackupFabric the generic backup fabric class.
type BasicGenericBackupFabric interface {
	AsGenericBackupFabric() (*GenericBackupFabric, bool)
}

// GenericBackupFabric the generic backup fabric class.
type GenericBackupFabric struct {
	// FriendlyName - Friendly name of the backup fabric.
	FriendlyName *string `json:"friendlyName,omitempty"`
	// Version - Version of the backup fabric.
	Version *string `json:"version,omitempty"`
	// BackupManagementType - Possible values include: 'BackupManagementTypeGenericBackupFabric'
	BackupManagementType ManagementTypeBasicGenericBackupFabric `json:"backupManagementType,omitempty"`
}

func unmarshalBasicGenericBackupFabric(body []byte) (BasicGenericBackupFabric, error) {
	var m map[string]interface{}
	err := json.Unmarshal(body, &m)
	if err != nil {
		return nil, err
	...
	default:
		var gbf GenericBackupFabric
		err := json.Unmarshal(body, &gbf)
		return gbf, err
	}
}
func unmarshalBasicGenericBackupFabricArray(body []byte) ([]BasicGenericBackupFabric, error) {
	var rawMessages []*json.RawMessage
	err := json.Unmarshal(body, &rawMessages)
	if err != nil {
		return nil, err
	...
	gbfArray := make([]BasicGenericBackupFabric, len(rawMessages))

	for index, rawMessage := range rawMessages {
		gbf, err := unmarshalBasicGenericBackupFabric(*rawMessage)
		if err != nil {
			return nil, err
		}
		gbfArray[index] = gbf
...
// MarshalJSON is the custom marshaler for GenericBackupFabric.
func (gbf GenericBackupFabric) MarshalJSON() ([]byte, error) {
	gbf.BackupManagementType = BackupManagementTypeGenericBackupFabric
	objectMap := make(map[string]interface{})
	if gbf.FriendlyName != nil {
		objectMap["friendlyName"] = gbf.FriendlyName
	}
	if gbf.Version != nil {
		objectMap["version"] = gbf.Version
	}
	if gbf.BackupManagementType != "" {
		objectMap["backupManagementType"] = gbf.BackupManagementType
	}
	return json.Marshal(objectMap)
}

// AsGenericBackupFabric is the BasicGenericBackupFabric implementation for GenericBackupFabric.
func (gbf GenericBackupFabric) AsGenericBackupFabric() (*GenericBackupFabric, bool) {
	return &gbf, true
}

// AsBasicGenericBackupFabric is the BasicGenericBackupFabric implementation for GenericBackupFabric.
func (gbf GenericBackupFabric) AsBasicGenericBackupFabric() (BasicGenericBackupFabric, bool) {
	return &gbf, true
}

// GenericBackupFabricResource the generic backup fabric class.
type GenericBackupFabricResource struct {
	autorest.Response `json:"-"`
	// Properties - GenericBackupFabricResource properties
	Properties BasicGenericBackupFabric `json:"properties,omitempty"`
	// ID - Resource Id represents the complete path to the resource.
	ID *string `json:"id,omitempty"`
	// Name - Resource name associated with the resource.
	Name *string `json:"name,omitempty"`
...
// MarshalJSON is the custom marshaler for GenericBackupFabricResource.
func (gbfr GenericBackupFabricResource) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	objectMap["properties"] = gbfr.Properties
	if gbfr.ID != nil {
		objectMap["id"] = gbfr.ID
	}
	if gbfr.Name != nil {
		objectMap["name"] = gbfr.Name
	}
	if gbfr.Type != nil {
		objectMap["type"] = gbfr.Type
	}
	if gbfr.Location != nil {
		objectMap["location"] = gbfr.Location
	}
	if gbfr.Tags != nil {
		objectMap["tags"] = gbfr.Tags
	}
	if gbfr.ETag != nil {
		objectMap["eTag"] = gbfr.ETag
	}
	return json.Marshal(objectMap)
}

// UnmarshalJSON is the custom unmarshaler for GenericBackupFabricResource struct.
func (gbfr *GenericBackupFabricResource) UnmarshalJSON(body []byte) error {
	var m map[string]*json.RawMessage
	err := json.Unmarshal(body, &m)
	if err != nil {
		return err
	...
	for k, v := range m {
		...
		case "properties":
			if v != nil {
				properties, err := unmarshalBasicGenericBackupFabric(*v)
				if err != nil {
					return err
				}
				gbfr.Properties = properties
			}
		case "id":
			if v != nil {
				var ID string
...
// GenericBackupFabricResourceList list of GenericBackupFabric resources
type GenericBackupFabricResourceList struct {
	autorest.Response `json:"-"`
	// Value - List of resources.
	Value *[]GenericBackupFabricResource `json:"value,omitempty"`
	// NextLink - The uri to fetch the next page of resources. Call ListNext() fetches next page of resources.
	NextLink *string `json:"nextLink,omitempty"`
}

// GenericBackupFabricResourceListIterator provides access to a complete listing of
// GenericBackupFabricResource values.
type GenericBackupFabricResourceListIterator struct {
	i    int
	page GenericBackupFabricResourceListPage
}

// NextWithContext advances to the next value.  If there was an error making
// the request the iterator does not advance and the error is returned.
func (iter *GenericBackupFabricResourceListIterator) NextWithContext(ctx context.Context) (err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/GenericBackupFabricResourceListIterator.NextWithContext")
		defer func() {
			sc := -1
			if iter.Response().Response.Response != nil {
				sc = iter.Response().Response.Response.StatusCode
...
// the request the iterator does not advance and the error is returned.
// Deprecated: Use NextWithContext() instead.
func (iter *GenericBackupFabricResourceListIterator) Next() error {
	return iter.NextWithContext(context.Background())
}

// NotDone returns true if the enumeration should be started or is not yet complete.
func (iter GenericBackupFabricResourceListIterator) NotDone() bool {
	return iter.page.NotDone() && iter.i < len(iter.page.Values())
}

// Response returns the raw server response from the last page request.
func (iter GenericBackupFabricResourceListIterator) Response() GenericBackupFabricResourceList {
	return iter.page.Response()
}

// Value returns the current value or a zero-initialized value if the
// iterator has advanced beyond the end of the collection.
func (iter GenericBackupFabricResourceListIterator) Value() GenericBackupFabricResource {
	if !iter.page.NotDone() {
		return GenericBackupFabricResource{}
	}
	return iter.page.Values()[iter.i]
}

// Creates a new instance of the GenericBackupFabricResourceListIterator type.
func NewGenericBackupFabricResourceListIterator(page GenericBackupFabricResourceListPage) GenericBackupFabricResourceListIterator {
	return GenericBackupFabricResourceListIterator{page: page}
}

// IsEmpty returns true if the ListResult contains no values.
func (gbfrl GenericBackupFabricResourceList) IsEmpty() bool {
	return gbfrl.Value == nil || len(*gbfrl.Value) == 0
}

// genericBackupFabricResourceListPreparer prepares a request to retrieve the next set of results.
// It returns nil if no more results exist.
func (gbfrl GenericBackupFabricResourceList) genericBackupFabricResourceListPreparer(ctx context.Context) (*http.Request, error) {
	if gbfrl.NextLink == nil || len(to.String(gbfrl.NextLink)) < 1 {
		return nil, nil
	}
	return autorest.Prepare((&http.Request{}).WithContext(ctx),
		autorest.AsJSON(),
		autorest.AsGet(),
		autorest.WithBaseURL(to.String(gbfrl.NextLink)))
}

// GenericBackupFabricResourceListPage contains a page of GenericBackupFabricResource values.
type GenericBackupFabricResourceListPage struct {
	fn    func(context.Context, GenericBackupFabricResourceList) (GenericBackupFabricResourceList, error)
	gbfrl GenericBackupFabricResourceList
}

// NextWithContext advances to the next page of values.  If there was an error making
// the request the page does not advance and the error is returned.
func (page *GenericBackupFabricResourceListPage) NextWithContext(ctx context.Context) (err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/GenericBackupFabricResourceListPage.NextWithContext")
		defer func() {
			sc := -1
			if page.Response().Response.Response != nil {
				sc = page.Response().Response.Response.StatusCode
	...
	next, err := page.fn(ctx, page.gbfrl)
	if err != nil {
		return err
	}
	page.gbfrl = next
...
// the request the page does not advance and the error is returned.
// Deprecated: Use NextWithContext() instead.
func (page *GenericBackupFabricResourceListPage) Next() error {
	return page.NextWithContext(context.Background())
}

// NotDone returns true if the page enumeration should be started or is not yet complete.
func (page GenericBackupFabricResourceListPage) NotDone() bool {
	return !page.gbfrl.IsEmpty()
}

// Response returns the raw server response from the last page request.
func (page GenericBackupFabricResourceListPage) Response() GenericBackupFabricResourceList {
	return page.gbfrl
}

// Values returns the slice of values for the current page or nil if there are no values.
func (page GenericBackupFabricResourceListPage) Values() []GenericBackupFabricResource {
	if page.gbfrl.IsEmpty() {
		return nil
	}
	return *page.gbfrl.Value
}

// Creates a new instance of the GenericBackupFabricResourceListPage type.
func NewGenericBackupFabricResourceListPage(getNextPage func(context.Context, GenericBackupFabricResourceList) (GenericBackupFabricResourceList, error)) GenericBackupFabricResourceListPage {
	return GenericBackupFabricResourceListPage{fn: getNextPage}
}
...
// GenericRestoreAccessRequest generic class for restore access request.
type GenericRestoreAccessRequest struct {
	// ProtectionContainerID - ARM ResourceId of container that will gain access to container request in uri.
	ProtectionContainerID *string `json:"protectionContainerId,omitempty"`
	// Duration - Duration for which the access has been requested.
	Duration *string `json:"duration,omitempty"`
}

// GenericRestoreAccessResponse generic class for restore access response.
type GenericRestoreAccessResponse struct {
	autorest.Response `json:"-"`
	// ServiceEndpoints - Azure Backup Service Endpoints of the container in grant access request URL
	ServiceEndpoints map[string]*string `json:"serviceEndpoints"`
	// ExpiryTime - Time till which access has been granted.
	ExpiryTime *date.Time `json:"expiryTime,omitempty"`
}

// MarshalJSON is the custom marshaler for GenericRestoreAccessResponse.
func (grar GenericRestoreAccessResponse) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if grar.ServiceEndpoints != nil {
		objectMap["serviceEndpoints"] = grar.ServiceEndpoints
	}
	if grar.ExpiryTime != nil {
		objectMap["expiryTime"] = grar.ExpiryTime
	}
	return json.Marshal(objectMap)
}
