...
// vaultName is the name of the recovery services vault. resourceGroupName is the name of the resource group where the
// recovery services vault is present.
func (client ResourceStorageConfigsClient) Update(ctx context.Context, vaultName string, resourceGroupName string) (result autorest.Response, err error) {
	req, err := client.UpdatePreparer(ctx, vaultName, resourceGroupName)
	if err != nil {
