...
func PossibleAgentVersionStatusValues() [5]AgentVersionStatus {
	return [5]AgentVersionStatus{Deprecated, NotSupported, SecurityUpdateRequired, Supported, UpdateRequired}
}
...
func PossibleHealthErrorCategoryValues() [6]HealthErrorCategory {
	return [6]HealthErrorCategory{Configuration, FabricInfrastructure, None, Replication, TestFailover, VersionExpiry}
}
...
func PossibleIdentityProviderTypeValues() [1]IdentityProviderType {
	return [1]IdentityProviderType{RecoveryServicesActiveDirectory}
}
...
func PossibleInstanceTypeValues() [4]InstanceType {
	return [4]InstanceType{InstanceTypeA2A, InstanceTypeApplyRecoveryPointProviderSpecificInput, InstanceTypeHyperVReplicaAzure, InstanceTypeInMageAzureV2}
}
...
func PossibleInstanceTypeBasicConfigurationSettingsValues() [5]InstanceTypeBasicConfigurationSettings {
	return [5]InstanceTypeBasicConfigurationSettings{InstanceTypeConfigurationSettings, InstanceTypeHyperVVirtualMachine, InstanceTypeReplicationGroupDetails, InstanceTypeVmmVirtualMachine, InstanceTypeVMwareVirtualMachine}
}
...
func PossibleMultiVMGroupCreateOptionValues() [2]MultiVMGroupCreateOption {
	return [2]MultiVMGroupCreateOption{AutoCreated, UserSpecified}
}
...
func PossibleMultiVMSyncPointOptionValues() [2]MultiVMSyncPointOption {
	return [2]MultiVMSyncPointOption{UseMultiVMSyncRecoveryPoint, UsePerVMRecoveryPoint}
}
...
func PossibleRecoveryPointSyncTypeValues() [2]RecoveryPointSyncType {
	return [2]RecoveryPointSyncType{MultiVMSyncRecoveryPoint, PerVMRecoveryPoint}
}
