...
const (
	...
	ContainerInfrastructure HealthErrorCategory = "ContainerInfrastructure"
...
func PossibleHealthErrorCategoryValues() []HealthErrorCategory {
	return []HealthErrorCategory{AgentAutoUpdate, Configuration, ContainerInfrastructure, FabricInfrastructure, None, Replication, TestFailover, VersionExpiry}
}
...
type HealthErrorSummary struct {
	...
	// Category - The category of the health error. Possible values include: 'None', 'Replication', 'TestFailover', 'Configuration', 'FabricInfrastructure', 'ContainerInfrastructure', 'VersionExpiry', 'AgentAutoUpdate'
