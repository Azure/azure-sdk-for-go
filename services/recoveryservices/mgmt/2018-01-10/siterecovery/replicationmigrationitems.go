...
// Complete the operation to initiate complete migration of the item.
// Parameters:
// fabricName - fabric name.
// protectionContainerName - protection container name.
// migrationItemName - migration item name.
func (client ReplicationMigrationItemsClient) Complete(ctx context.Context, fabricName string, protectionContainerName string, migrationItemName string) (result ReplicationMigrationItemsCompleteFuture, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/ReplicationMigrationItemsClient.Complete")
		defer func() {
			sc := -1
	...
	req, err := client.CompletePreparer(ctx, fabricName, protectionContainerName, migrationItemName)
	if err != nil {
		err = autorest.NewErrorWithError(err, "siterecovery.ReplicationMigrationItemsClient", "Complete", nil, "Failure preparing request")
		return
	}

	result, err = client.CompleteSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "siterecovery.ReplicationMigrationItemsClient", "Complete", result.Response(), "Failure sending request")
		return
	}
...
// CompletePreparer prepares the Complete request.
func (client ReplicationMigrationItemsClient) CompletePreparer(ctx context.Context, fabricName string, protectionContainerName string, migrationItemName string) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithPathParameters("/Subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{resourceName}/replicationFabrics/{fabricName}/replicationProtectionContainers/{protectionContainerName}/replicationMigrationItems/{migrationItemName}/complete", pathParameters),
		autorest.WithQueryParameters(queryParameters))
	return preparer.Prepare((&http.Request{}).WithContext(ctx))
}

// CompleteSender sends the Complete request. The method will close the
// http.Response Body if it receives an error.
func (client ReplicationMigrationItemsClient) CompleteSender(req *http.Request) (future ReplicationMigrationItemsCompleteFuture, err error) {
...
// CompleteResponder handles the response to the Complete request. The method always
// closes the http.Response Body.
func (client ReplicationMigrationItemsClient) CompleteResponder(resp *http.Response) (result MigrationItem, err error) {
...
// Delete the operation to purge an ASR migration item. This operation will force delete the migration item. Use the
// remove operation on migration item to perform a clean disable migration for the item.
// Parameters:
// fabricName - fabric name.
// protectionContainerName - protection container name.
// migrationItemName - migration item name.
func (client ReplicationMigrationItemsClient) Delete(ctx context.Context, fabricName string, protectionContainerName string, migrationItemName string) (result ReplicationMigrationItemsDeleteFuture, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.DeletePreparer(ctx, fabricName, protectionContainerName, migrationItemName)
	if err != nil {
...
func (client ReplicationMigrationItemsClient) DeletePreparer(ctx context.Context, fabricName string, protectionContainerName string, migrationItemName string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"fabricName":              autorest.Encode("path", fabricName),
		"migrationItemName":       autorest.Encode("path", migrationItemName),
		"protectionContainerName": autorest.Encode("path", protectionContainerName),
...
// Remove the operation to disable an ASR migration item.
// Parameters:
// fabricName - fabric name.
// protectionContainerName - protection container name.
// migrationItemName - migration item name.
func (client ReplicationMigrationItemsClient) Remove(ctx context.Context, fabricName string, protectionContainerName string, migrationItemName string) (result ReplicationMigrationItemsRemoveFuture, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/ReplicationMigrationItemsClient.Remove")
		defer func() {
			sc := -1
			if result.Response() != nil {
				sc = result.Response().StatusCode
	...
	req, err := client.RemovePreparer(ctx, fabricName, protectionContainerName, migrationItemName)
	if err != nil {
		err = autorest.NewErrorWithError(err, "siterecovery.ReplicationMigrationItemsClient", "Remove", nil, "Failure preparing request")
		return
	}

	result, err = client.RemoveSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "siterecovery.ReplicationMigrationItemsClient", "Remove", result.Response(), "Failure sending request")
		return
	}
...
func (client ReplicationMigrationItemsClient) RemovePreparer(ctx context.Context, fabricName string, protectionContainerName string, migrationItemName string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"fabricName":              autorest.Encode("path", fabricName),
		"migrationItemName":       autorest.Encode("path", migrationItemName),
		"protectionContainerName": autorest.Encode("path", protectionContainerName),
	...
	preparer := autorest.CreatePreparer(
		autorest.AsPost(),
		autorest.WithBaseURL(client.BaseURI),
		autorest.WithPathParameters("/Subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.RecoveryServices/vaults/{resourceName}/replicationFabrics/{fabricName}/replicationProtectionContainers/{protectionContainerName}/replicationMigrationItems/{migrationItemName}/remove", pathParameters),
		autorest.WithQueryParameters(queryParameters))
	return preparer.Prepare((&http.Request{}).WithContext(ctx))
}
...
// http.Response Body if it receives an error.
func (client ReplicationMigrationItemsClient) RemoveSender(req *http.Request) (future ReplicationMigrationItemsRemoveFuture, err error) {
	var resp *http.Response
	resp, err = autorest.SendWithSender(client, req,
		azure.DoRetryWithRegistration(client.Client))
	if err != nil {
...
// closes the http.Response Body.
func (client ReplicationMigrationItemsClient) RemoveResponder(resp *http.Response) (result autorest.Response, err error) {
	err = autorest.Respond(
		resp,
		client.ByInspecting(),
		azure.WithErrorUnlessStatusCode(http.StatusOK, http.StatusAccepted, http.StatusNoContent),
