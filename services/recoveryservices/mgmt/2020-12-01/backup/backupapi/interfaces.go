...
import (
	"context"
	"github.com/Azure/azure-sdk-for-go/services/recoveryservices/mgmt/2020-12-01/backup"
	"github.com/Azure/go-autorest/autorest"
)

// BaseClientAPI contains the set of methods on the BaseClient type.
type BaseClientAPI interface {
	BMSPrepareDataMove(ctx context.Context, vaultName string, resourceGroupName string, parameters backup.PrepareDataMoveRequest) (result autorest.Response, err error)
...
var _ UsageSummariesCRRClientAPI = (*backup.UsageSummariesCRRClient)(nil)
