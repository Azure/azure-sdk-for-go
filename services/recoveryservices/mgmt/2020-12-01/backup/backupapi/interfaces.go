...
type BMSPrepareDataMoveOperationResultClientAPI interface {
	Get(ctx context.Context, vaultName string, resourceGroupName string, operationID string) (result backup.BMSPrepareDataMoveOperationResultGetFuture, err error)
}
