// Package backup implements the Azure ARM Backup service API version 2020-12-01.
//
...
func (client BaseClient) BMSPrepareDataMove(ctx context.Context, vaultName string, resourceGroupName string, parameters PrepareDataMoveRequest) (result autorest.Response, err error) {
	...
	resp, err := client.BMSPrepareDataMoveSender(req)
	if err != nil {
		result.Response = resp
		err = autorest.NewErrorWithError(err, "backup.BaseClient", "BMSPrepareDataMove", resp, "Failure sending request")
		return
	}

	result, err = client.BMSPrepareDataMoveResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "backup.BaseClient", "BMSPrepareDataMove", resp, "Failure responding to request")
		return
	}
...
func (client BaseClient) BMSPrepareDataMoveSender(req *http.Request) (*http.Response, error) {
