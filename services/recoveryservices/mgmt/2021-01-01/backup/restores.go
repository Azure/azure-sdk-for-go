...
func (client RestoresClient) TriggerSender(req *http.Request) (future RestoresTriggerFuture, err error) {
	...
	future.Result = func(client RestoresClient) (ar autorest.Response, err error) {
		var done bool
		done, err = future.DoneWithContext(context.Background(), client)
		if err != nil {
			err = autorest.NewErrorWithError(err, "backup.RestoresTriggerFuture", "Result", future.Response(), "Polling failure")
			return
		}
		if !done {
			err = azure.NewAsyncOpIncompleteError("backup.RestoresTriggerFuture")
			return
		}
