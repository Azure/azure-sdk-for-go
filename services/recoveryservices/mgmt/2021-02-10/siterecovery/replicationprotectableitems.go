...
// take - take OData query parameter.
// skipToken - skipToken OData query parameter.
func (client ReplicationProtectableItemsClient) ListByReplicationProtectionContainers(ctx context.Context, fabricName string, protectionContainerName string, filter string, take string, skipToken string) (result ProtectableItemCollectionPage, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.ListByReplicationProtectionContainersPreparer(ctx, fabricName, protectionContainerName, filter, take, skipToken)
	if err != nil {
...
func (client ReplicationProtectableItemsClient) ListByReplicationProtectionContainersPreparer(ctx context.Context, fabricName string, protectionContainerName string, filter string, take string, skipToken string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"fabricName":              autorest.Encode("path", fabricName),
		"protectionContainerName": autorest.Encode("path", protectionContainerName),
		"resourceGroupName":       autorest.Encode("path", client.ResourceGroupName),
...
func (client ReplicationProtectableItemsClient) ListByReplicationProtectionContainersComplete(ctx context.Context, fabricName string, protectionContainerName string, filter string, take string, skipToken string) (result ProtectableItemCollectionIterator, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/ReplicationProtectableItemsClient.ListByReplicationProtectionContainers")
		defer func() {
			sc := -1
	...
	result.page, err = client.ListByReplicationProtectionContainers(ctx, fabricName, protectionContainerName, filter, take, skipToken)
	return
}
