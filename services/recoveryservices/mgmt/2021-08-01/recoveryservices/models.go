...
type IdentityData struct {
	...
	// Type - The type of managed identity used. The type 'SystemAssigned, UserAssigned' includes both an implicitly created identity and a set of user-assigned identities. The type 'None' will remove any identities. Possible values include: 'SystemAssigned', 'None', 'UserAssigned', 'SystemAssignedUserAssigned'
...
type VaultProperties struct {
	...
	// MoveState - READ-ONLY; The State of the Resource after the move operation. Possible values include: 'Unknown', 'InProgress', 'PrepareFailed', 'CommitFailed', 'PrepareTimedout', 'CommitTimedout', 'MoveSucceeded', 'Failure', 'CriticalFailure', 'PartialSuccess'
...
type VaultPropertiesEncryption struct {
	...
	// InfrastructureEncryption - Enabling/Disabling the Double Encryption state. Possible values include: 'Enabled', 'Disabled'
