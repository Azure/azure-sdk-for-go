...
// takeToken - the page size.
// filter - oData filter options.
func (client ReplicationMigrationItemsClient) List(ctx context.Context, skipToken string, takeToken string, filter string) (result MigrationItemCollectionPage, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.ListPreparer(ctx, skipToken, takeToken, filter)
	if err != nil {
...
func (client ReplicationMigrationItemsClient) ListPreparer(ctx context.Context, skipToken string, takeToken string, filter string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"resourceGroupName": autorest.Encode("path", client.ResourceGroupName),
		"resourceName":      autorest.Encode("path", client.ResourceName),
		"subscriptionId":    autorest.Encode("path", client.SubscriptionID),
	...
	if len(takeToken) > 0 {
		queryParameters["takeToken"] = autorest.Encode("query", takeToken)
	}
	if len(filter) > 0 {
...
func (client ReplicationMigrationItemsClient) ListComplete(ctx context.Context, skipToken string, takeToken string, filter string) (result MigrationItemCollectionIterator, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/ReplicationMigrationItemsClient.List")
		defer func() {
			sc := -1
	...
	result.page, err = client.List(ctx, skipToken, takeToken, filter)
	return
}
...
// takeToken - the page size.
// filter - oData filter options.
func (client ReplicationMigrationItemsClient) ListByReplicationProtectionContainers(ctx context.Context, fabricName string, protectionContainerName string, skipToken string, takeToken string, filter string) (result MigrationItemCollectionPage, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.ListByReplicationProtectionContainersPreparer(ctx, fabricName, protectionContainerName, skipToken, takeToken, filter)
	if err != nil {
...
func (client ReplicationMigrationItemsClient) ListByReplicationProtectionContainersPreparer(ctx context.Context, fabricName string, protectionContainerName string, skipToken string, takeToken string, filter string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"fabricName":              autorest.Encode("path", fabricName),
		"protectionContainerName": autorest.Encode("path", protectionContainerName),
		"resourceGroupName":       autorest.Encode("path", client.ResourceGroupName),
...
func (client ReplicationMigrationItemsClient) ListByReplicationProtectionContainersComplete(ctx context.Context, fabricName string, protectionContainerName string, skipToken string, takeToken string, filter string) (result MigrationItemCollectionIterator, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/ReplicationMigrationItemsClient.ListByReplicationProtectionContainers")
		defer func() {
			sc := -1
	...
	result.page, err = client.ListByReplicationProtectionContainers(ctx, fabricName, protectionContainerName, skipToken, takeToken, filter)
	return
}
