...
func (client SupportedOperatingSystemsClient) Get(ctx context.Context, instanceType string) (result SupportedOperatingSystems, err error) {
	...
	req, err := client.GetPreparer(ctx, instanceType)
	if err != nil {
...
func (client SupportedOperatingSystemsClient) GetPreparer(ctx context.Context, instanceType string) (*http.Request, error) {
	...
	if len(instanceType) > 0 {
		queryParameters["instanceType"] = autorest.Encode("query", instanceType)
	}
