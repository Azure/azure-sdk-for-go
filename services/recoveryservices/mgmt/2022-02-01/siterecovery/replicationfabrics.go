...
func (client ReplicationFabricsClient) Get(ctx context.Context, fabricName string, filter string) (result Fabric, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.GetPreparer(ctx, fabricName, filter)
	if err != nil {
...
func (client ReplicationFabricsClient) GetPreparer(ctx context.Context, fabricName string, filter string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"fabricName":        autorest.Encode("path", fabricName),
		"resourceGroupName": autorest.Encode("path", client.ResourceGroupName),
		"resourceName":      autorest.Encode("path", client.ResourceName),
