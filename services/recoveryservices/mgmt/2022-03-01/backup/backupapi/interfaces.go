...
var _ ResourceStorageConfigsNonCRRClientAPI = (*backup.ResourceStorageConfigsNonCRRClient)(nil)
...
// ValidateOperationClientAPI contains the set of methods on the ValidateOperationClient type.
type ValidateOperationClientAPI interface {
	Trigger(ctx context.Context, vaultName string, resourceGroupName string, parameters backup.BasicValidateOperationRequest) (result backup.ValidateOperationTriggerFuture, err error)
}

var _ ValidateOperationClientAPI = (*backup.ValidateOperationClient)(nil)

// ValidateOperationResultsClientAPI contains the set of methods on the ValidateOperationResultsClient type.
type ValidateOperationResultsClientAPI interface {
	Get(ctx context.Context, vaultName string, resourceGroupName string, operationID string) (result backup.ValidateOperationsResponse, err error)
}

var _ ValidateOperationResultsClientAPI = (*backup.ValidateOperationResultsClient)(nil)

// ValidateOperationStatusesClientAPI contains the set of methods on the ValidateOperationStatusesClient type.
type ValidateOperationStatusesClientAPI interface {
...
var _ ValidateOperationStatusesClientAPI = (*backup.ValidateOperationStatusesClient)(nil)
...
var _ ResourceGuardProxiesClientAPI = (*backup.ResourceGuardProxiesClient)(nil)
...
var _ ResourceGuardProxyClientAPI = (*backup.ResourceGuardProxyClient)(nil)
