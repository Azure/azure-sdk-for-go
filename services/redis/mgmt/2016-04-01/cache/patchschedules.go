...
func (client PatchSchedulesClient) CreateOrUpdate(resourceGroupName string, name string, parameters RedisPatchSchedule) (result RedisPatchSchedule, err error) {
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewErrorWithValidationError(err, "cache.PatchSchedulesClient", "CreateOrUpdate")
	}

	req, err := client.CreateOrUpdatePreparer(resourceGroupName, name, parameters)
	if err != nil {
		err = autorest.NewErrorWithError(err, "cache.PatchSchedulesClient", "CreateOrUpdate", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "cache.PatchSchedulesClient", "CreateOrUpdate", resp, "Failure sending request")
		return
	}

	result, err = client.CreateOrUpdateResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "cache.PatchSchedulesClient", "CreateOrUpdate", resp, "Failure responding to request")
	}
...
func (client PatchSchedulesClient) CreateOrUpdatePreparer(resourceGroupName string, name string, parameters RedisPatchSchedule) (*http.Request, error) {
...
func (client PatchSchedulesClient) CreateOrUpdateResponder(resp *http.Response) (result RedisPatchSchedule, err error) {
...
func (client PatchSchedulesClient) Delete(resourceGroupName string, name string) (result autorest.Response, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "cache.PatchSchedulesClient", "Delete", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "cache.PatchSchedulesClient", "Delete", resp, "Failure sending request")
		return
	}

	result, err = client.DeleteResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "cache.PatchSchedulesClient", "Delete", resp, "Failure responding to request")
	}
...
//
// resourceGroupName is the name of the resource group. name is the name of the redis cache.
func (client PatchSchedulesClient) Get(resourceGroupName string, name string) (result RedisPatchSchedule, err error) {
	req, err := client.GetPreparer(resourceGroupName, name)
	if err != nil {
		err = autorest.NewErrorWithError(err, "cache.PatchSchedulesClient", "Get", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "cache.PatchSchedulesClient", "Get", resp, "Failure sending request")
		return
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "cache.PatchSchedulesClient", "Get", resp, "Failure responding to request")
	}
...
// closes the http.Response Body.
func (client PatchSchedulesClient) GetResponder(resp *http.Response) (result RedisPatchSchedule, err error) {
	err = autorest.Respond(
		resp,
		client.ByInspecting(),
