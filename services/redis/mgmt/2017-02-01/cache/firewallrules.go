...
func (client FirewallRulesClient) CreateOrUpdate(resourceGroupName string, cacheName string, ruleName string, parameters RedisFirewallRule) (result RedisFirewallRule, err error) {
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewErrorWithValidationError(err, "cache.FirewallRulesClient", "CreateOrUpdate")
	}

	req, err := client.CreateOrUpdatePreparer(resourceGroupName, cacheName, ruleName, parameters)
	if err != nil {
		err = autorest.NewErrorWithError(err, "cache.FirewallRulesClient", "CreateOrUpdate", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "cache.FirewallRulesClient", "CreateOrUpdate", resp, "Failure sending request")
		return
	}

	result, err = client.CreateOrUpdateResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "cache.FirewallRulesClient", "CreateOrUpdate", resp, "Failure responding to request")
	}
...
func (client FirewallRulesClient) CreateOrUpdatePreparer(resourceGroupName string, cacheName string, ruleName string, parameters RedisFirewallRule) (*http.Request, error) {
...
func (client FirewallRulesClient) CreateOrUpdateResponder(resp *http.Response) (result RedisFirewallRule, err error) {
...
func (client FirewallRulesClient) Delete(resourceGroupName string, cacheName string, ruleName string) (result autorest.Response, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "cache.FirewallRulesClient", "Delete", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "cache.FirewallRulesClient", "Delete", resp, "Failure sending request")
		return
	}

	result, err = client.DeleteResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "cache.FirewallRulesClient", "Delete", resp, "Failure responding to request")
	}
...
// resourceGroupName is the name of the resource group. cacheName is the name of the Redis cache. ruleName is the name
// of the firewall rule.
func (client FirewallRulesClient) Get(resourceGroupName string, cacheName string, ruleName string) (result RedisFirewallRule, err error) {
	req, err := client.GetPreparer(resourceGroupName, cacheName, ruleName)
	if err != nil {
		err = autorest.NewErrorWithError(err, "cache.FirewallRulesClient", "Get", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "cache.FirewallRulesClient", "Get", resp, "Failure sending request")
		return
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "cache.FirewallRulesClient", "Get", resp, "Failure responding to request")
	}
...
// closes the http.Response Body.
func (client FirewallRulesClient) GetResponder(resp *http.Response) (result RedisFirewallRule, err error) {
	err = autorest.Respond(
		resp,
		client.ByInspecting(),
...
func (client FirewallRulesClient) ListByRedisResource(resourceGroupName string, cacheName string) (result RedisFirewallRuleListResult, err error) {
	req, err := client.ListByRedisResourcePreparer(resourceGroupName, cacheName)
	if err != nil {
		err = autorest.NewErrorWithError(err, "cache.FirewallRulesClient", "ListByRedisResource", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "cache.FirewallRulesClient", "ListByRedisResource", resp, "Failure sending request")
		return
	}

	result, err = client.ListByRedisResourceResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "cache.FirewallRulesClient", "ListByRedisResource", resp, "Failure responding to request")
	}
...
// closes the http.Response Body.
func (client FirewallRulesClient) ListByRedisResourceResponder(resp *http.Response) (result RedisFirewallRuleListResult, err error) {
	err = autorest.Respond(
		resp,
		client.ByInspecting(),
		azure.WithErrorUnlessStatusCode(http.StatusOK),
...
func (client FirewallRulesClient) ListByRedisResourceNextResults(lastResults RedisFirewallRuleListResult) (result RedisFirewallRuleListResult, err error) {
	req, err := lastResults.RedisFirewallRuleListResultPreparer()
	if err != nil {
		return result, autorest.NewErrorWithError(err, "cache.FirewallRulesClient", "ListByRedisResource", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "cache.FirewallRulesClient", "ListByRedisResource", resp, "Failure sending next results request")
	}

	result, err = client.ListByRedisResourceResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "cache.FirewallRulesClient", "ListByRedisResource", resp, "Failure responding to next results request")
	}
...
func (client FirewallRulesClient) ListByRedisResourceComplete(resourceGroupName string, cacheName string, cancel <-chan struct{}) (<-chan RedisFirewallRule, <-chan error) {
	resultChan := make(chan RedisFirewallRule)
