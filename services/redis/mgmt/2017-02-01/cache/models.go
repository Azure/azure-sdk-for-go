...
// RedisLinkedServer is linked server Id
type RedisLinkedServer struct {
	ID *string `json:"id,omitempty"`
}

// RedisLinkedServerCreateParameters is parameter required for creating a linked server to redis cache.
type RedisLinkedServerCreateParameters struct {
	*RedisLinkedServerCreateProperties `json:"properties,omitempty"`
}

// RedisLinkedServerCreateProperties is create properties for a linked server
...
// RedisLinkedServerList is list of linked server Ids of a Redis cache.
type RedisLinkedServerList struct {
	Value *[]RedisLinkedServer `json:"value,omitempty"`
}

// RedisLinkedServerProperties is properties of a linked server to be returned in get/put response
...
// RedisLinkedServerWithProperties is response to put/get linked server (with properties) for Redis cache.
type RedisLinkedServerWithProperties struct {
	autorest.Response            `json:"-"`
	ID                           *string `json:"id,omitempty"`
	Name                         *string `json:"name,omitempty"`
	Type                         *string `json:"type,omitempty"`
	*RedisLinkedServerProperties `json:"properties,omitempty"`
}

// RedisLinkedServerWithPropertiesList is list of linked servers (with properites) of a Redis cache.
...
type RedisResourceProperties struct {
	...
	LinkedServers      *RedisLinkedServerList `json:"linkedServers,omitempty"`
}
