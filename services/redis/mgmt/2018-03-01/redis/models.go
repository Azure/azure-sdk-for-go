...
// DefaultName enumerates the values for default name.
type DefaultName string

const (
	// MicrosoftCacheredis ...
	MicrosoftCacheredis DefaultName = "Microsoft.Cache/redis"
)

// PossibleDefaultNameValues returns an array of possible values for the DefaultName const type.
func PossibleDefaultNameValues() []DefaultName {
	return []DefaultName{MicrosoftCacheredis}
}
...
type CheckNameAvailabilityParameters struct {
	...
	// Type - Resource type to check name availability of, e.g. 'Microsoft.Cache/redis'. Possible values include: 'MicrosoftCacheredis'
	Type DefaultName `json:"type,omitempty"`
}
