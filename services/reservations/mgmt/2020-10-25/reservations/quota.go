...
// CreateOrUpdate create or update the quotas (service limits) of a resource to the requested value.
// Steps:
//
...
// Get get the current quotas (service limits) and usage of a resource. You can use the response from the GET operation
// to submit quota update requests.
// Parameters:
// subscriptionID - azure subscription ID.
// providerID - azure resource provider ID.
// location - azure region.
