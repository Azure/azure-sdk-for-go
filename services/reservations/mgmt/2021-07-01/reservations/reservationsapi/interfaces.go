...
import (
	"context"
	"github.com/Azure/azure-sdk-for-go/services/reservations/mgmt/2021-07-01/reservations"
)
...
type ClientAPI interface {
	...
	ListAll(ctx context.Context, filter string, orderby string, refreshSummary string, skiptoken *float64, selectedState string, take *float64) (result reservations.ListResultPage, err error)
	ListAllComplete(ctx context.Context, filter string, orderby string, refreshSummary string, skiptoken *float64, selectedState string, take *float64) (result reservations.ListResultIterator, err error)
...
type OrderClientAPI interface {
	...
	ChangeDirectory(ctx context.Context, reservationOrderID string, body reservations.ChangeDirectoryRequest) (result reservations.ChangeDirectoryResponse, err error)
