...
const (
	...
	VirtualMachineSoftware ReservedResourceType = "VirtualMachineSoftware"
	// VMwareCloudSimple ...
...
func PossibleReservedResourceTypeValues() []ReservedResourceType {
	return []ReservedResourceType{AppService, AVS, AzureDataExplorer, AzureFiles, BlockBlob, CosmosDb, Databricks, DataFactory, DedicatedHost, ManagedDisk, MariaDb, MySQL, NetAppStorage, PostgreSQL, RedHat, RedHatOsa, RedisCache, SapHana, SQLAzureHybridBenefit, SQLDatabases, SQLDataWarehouse, SQLEdge, SuseLinux, VirtualMachines, VirtualMachineSoftware, VMwareCloudSimple}
}
