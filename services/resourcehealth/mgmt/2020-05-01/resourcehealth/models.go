...
type AvailabilityStatusProperties struct {
	// AvailabilityState - Availability status of the resource. When it is null, this availabilityStatus object represents an availability impacting event. Possible values include: 'Available', 'Unavailable', 'Degraded', 'Unknown'
...
type ImpactedResourceStatusProperties struct {
	// AvailabilityState - Impacted resource status of the resource. Possible values include: 'Available', 'Unavailable', 'Degraded', 'Unknown'
	AvailabilityState AvailabilityStateValues `json:"availabilityState,omitempty"`
	// Title - Title description of the impacted resource status.
	Title *string `json:"title,omitempty"`
	// Summary - Summary description of the impacted resource status.
	Summary *string `json:"summary,omitempty"`
	// ReasonType - When the resource's availabilityState is Unavailable, it describes where the health impacting event was originated. Possible values include: 'Unplanned', 'Planned', 'UserInitiated'
