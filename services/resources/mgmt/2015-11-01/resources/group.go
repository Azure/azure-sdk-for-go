...
// groups.
func (client GroupClient) List(filter string, top *int32) (result ListResult, err error) {
...
func (client GroupClient) ListPreparer(filter string, top *int32) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"subscriptionId": autorest.Encode("path", client.SubscriptionID),
	}
...
func (client GroupClient) ListComplete(filter string, top *int32, cancel <-chan struct{}) (<-chan GenericResource, <-chan error) {
