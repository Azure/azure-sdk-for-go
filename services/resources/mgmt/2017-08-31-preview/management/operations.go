...
func (client OperationsClient) ListNextResults(lastResults OperationListResult) (result OperationListResult, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "management.OperationsClient", "List", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "management.OperationsClient", "List", resp, "Failure sending next results request")
	}

	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "management.OperationsClient", "List", resp, "Failure responding to next results request")
	}
