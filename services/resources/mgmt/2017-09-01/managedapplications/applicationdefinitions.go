...
//
// resourceGroupName is the name of the resource group. The name is case insensitive. applicationDefinitionName is
// the name of the managed application definition. parameters is parameters supplied to the create or update an
...
//
// applicationDefinitionID is the fully qualified ID of the managed application definition, including the managed
// application name and the managed application definition resource type. Use the format,
...
// parameters is parameters supplied to the create or update a managed application definition.
