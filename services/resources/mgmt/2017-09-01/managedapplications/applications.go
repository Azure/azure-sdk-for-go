...
//
// resourceGroupName is the name of the resource group. The name is case insensitive. applicationName is the name
// of the managed application. parameters is parameters supplied to the create or update a managed application.
...
//
// applicationID is the fully qualified ID of the managed application, including the managed application name and
// the managed application resource type. Use the format,
// /subscriptions/{guid}/resourceGroups/{resource-group-name}/Microsoft.Solutions/applications/{application-name}
// parameters is parameters supplied to the create or update a managed application.
...
//
// resourceGroupName is the name of the resource group. The name is case insensitive. applicationName is the name
// of the managed application. parameters is parameters supplied to update an existing managed application.
...
// the managed application resource type. Use the format,
// /subscriptions/{guid}/resourceGroups/{resource-group-name}/Microsoft.Solutions/applications/{application-name}
// parameters is parameters supplied to update an existing managed application.
