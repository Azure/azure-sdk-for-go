...
// List this operation retrieves the list of all policy assignments that apply to the given subscription that match the
// given $filter. Valid values for $filter are: 'atScope()' or 'policyDefinitionId eq '{value}''. If $filter is not
// provided, the returned list includes all policy assignments that apply to the subscription, including any that might
// apply from management groups that contain the given subscription. If $filter=atScope() is provided, the returned
// list includes only applicable policy assignments created with that subscription as their scope. If
// $filter=policyDefinitionId eq '{value}' is provided, the returned list includes only applicable policy assignments
// that enforce the policy definition whose id is {value}.
// Parameters:
// filter - the filter to apply on the operation. Valid values for $filter are: 'atScope()' or
// 'policyDefinitionId eq '{value}''
...
// ListForResource this operation retrieves the list of all policy assignments that apply to the specified resource in
// the given resource group and subscription, that match the given $filter. Valid values for $filter are: 'atScope()'
// or 'policyDefinitionId eq '{value}''. If $filter is not provided, the returned list includes all policy assignments
// that apply to the resource group, including any that might apply from higher-level scopes that contain the given
// resource group. If $filter=atScope() is provided, the returned list includes only applicable policy assignments
// created with that resource as their scope. If $filter=policyDefinitionId eq '{value}' is provided, the returned list
// includes only applicable policy assignments that enforce the policy definition whose id is {value}. Three parameters
...
// ListForResourceGroup this operation retrieves the list of all policy assignments that apply to the given resource
// group in the given subscription that match the given $filter. Valid values for $filter are: 'atScope()' or
// 'policyDefinitionId eq '{value}''. If $filter is not provided, the returned list includes all policy assignments
// that apply to the resource group, including any that might apply from higher-level scopes that contain the given
// resource group. If $filter=atScope() is provided, the returned list includes only applicable policy assignments
// created with that resource group as their scope. If $filter=policyDefinitionId eq '{value}' is provided, the
// returned list includes only applicable policy assignments that enforce the policy definition whose id is {value}.
// Parameters:
