...
// APIVersion - the api version of the resource provider
...
// APIVersion - the api version of the resource provider
func (client Client) CreateOrUpdate(ctx context.Context, resourceGroupName string, resourceProviderNamespace string, parentResourcePath string, resourceType string, resourceName string, parameters GenericResource, APIVersion string) (result CreateOrUpdateFuture, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.CreateOrUpdatePreparer(ctx, resourceGroupName, resourceProviderNamespace, parentResourcePath, resourceType, resourceName, parameters, APIVersion)
	if err != nil {
...
func (client Client) CreateOrUpdatePreparer(ctx context.Context, resourceGroupName string, resourceProviderNamespace string, parentResourcePath string, resourceType string, resourceName string, parameters GenericResource, APIVersion string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"parentResourcePath":        parentResourcePath,
		"resourceGroupName":         autorest.Encode("path", resourceGroupName),
		"resourceName":              autorest.Encode("path", resourceName),
...
// APIVersion - the api version of the resource provider
func (client Client) CreateOrUpdateByID(ctx context.Context, resourceID string, parameters GenericResource, APIVersion string) (result CreateOrUpdateByIDFuture, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.CreateOrUpdateByIDPreparer(ctx, resourceID, parameters, APIVersion)
	if err != nil {
...
func (client Client) CreateOrUpdateByIDPreparer(ctx context.Context, resourceID string, parameters GenericResource, APIVersion string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"resourceId": resourceID,
	}
...
// APIVersion - the api version of the resource provider
func (client Client) Update(ctx context.Context, resourceGroupName string, resourceProviderNamespace string, parentResourcePath string, resourceType string, resourceName string, parameters GenericResource, APIVersion string) (result UpdateFuture, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.UpdatePreparer(ctx, resourceGroupName, resourceProviderNamespace, parentResourcePath, resourceType, resourceName, parameters, APIVersion)
	if err != nil {
...
func (client Client) UpdatePreparer(ctx context.Context, resourceGroupName string, resourceProviderNamespace string, parentResourcePath string, resourceType string, resourceName string, parameters GenericResource, APIVersion string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"parentResourcePath":        parentResourcePath,
		"resourceGroupName":         autorest.Encode("path", resourceGroupName),
		"resourceName":              autorest.Encode("path", resourceName),
...
// APIVersion - the api version of the resource provider
func (client Client) UpdateByID(ctx context.Context, resourceID string, parameters GenericResource, APIVersion string) (result UpdateByIDFuture, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.UpdateByIDPreparer(ctx, resourceID, parameters, APIVersion)
	if err != nil {
...
func (client Client) UpdateByIDPreparer(ctx context.Context, resourceID string, parameters GenericResource, APIVersion string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"resourceId": resourceID,
	}
