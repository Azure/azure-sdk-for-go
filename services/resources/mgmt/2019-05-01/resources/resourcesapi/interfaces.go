...
type ClientAPI interface {
	...
	CreateOrUpdate(ctx context.Context, resourceGroupName string, resourceProviderNamespace string, parentResourcePath string, resourceType string, resourceName string, parameters resources.GenericResource, APIVersion string) (result resources.CreateOrUpdateFuture, err error)
	CreateOrUpdateByID(ctx context.Context, resourceID string, parameters resources.GenericResource, APIVersion string) (result resources.CreateOrUpdateByIDFuture, err error)
	...
	Update(ctx context.Context, resourceGroupName string, resourceProviderNamespace string, parentResourcePath string, resourceType string, resourceName string, parameters resources.GenericResource, APIVersion string) (result resources.UpdateFuture, err error)
	UpdateByID(ctx context.Context, resourceID string, parameters resources.GenericResource, APIVersion string) (result resources.UpdateByIDFuture, err error)
