...
- Function `NewResourceGroupListResultPage` signature has been changed from `(func(context.Context, ResourceGroupListResult) (ResourceGroupListResult, error))` to `(ResourceGroupListResult,func(context.Context, ResourceGroupListResult) (ResourceGroupListResult, error))`
