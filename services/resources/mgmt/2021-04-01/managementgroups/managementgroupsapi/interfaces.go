...
import (
	"context"
	"github.com/Azure/azure-sdk-for-go/services/resources/mgmt/2021-04-01/managementgroups"
...
type ClientAPI interface {
	...
	Get(ctx context.Context, groupID string, expand managementgroups.ManagementGroupExpandType, recurse *bool, filter string, cacheControl string) (result managementgroups.ManagementGroup, err error)
...
type EntitiesClientAPI interface {
	List(ctx context.Context, skiptoken string, skip *int32, top *int32, selectParameter string, search managementgroups.EntitySearchType, filter string, view managementgroups.EntityViewParameterType, groupName string, cacheControl string) (result managementgroups.EntityListResultPage, err error)
	ListComplete(ctx context.Context, skiptoken string, skip *int32, top *int32, selectParameter string, search managementgroups.EntitySearchType, filter string, view managementgroups.EntityViewParameterType, groupName string, cacheControl string) (result managementgroups.EntityListResultIterator, err error)
}
