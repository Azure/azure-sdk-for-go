...
type ProvidersClientAPI interface {
	...
	List(ctx context.Context, expand string) (result resources.ProviderListResultPage, err error)
	ListComplete(ctx context.Context, expand string) (result resources.ProviderListResultIterator, err error)
	ListAtTenantScope(ctx context.Context, expand string) (result resources.ProviderListResultPage, err error)
	ListAtTenantScopeComplete(ctx context.Context, expand string) (result resources.ProviderListResultIterator, err error)
	ProviderPermissions(ctx context.Context, resourceProviderNamespace string) (result resources.ProviderPermissionListResult, err error)
	Register(ctx context.Context, resourceProviderNamespace string, properties *resources.ProviderRegistrationRequest) (result resources.Provider, err error)
