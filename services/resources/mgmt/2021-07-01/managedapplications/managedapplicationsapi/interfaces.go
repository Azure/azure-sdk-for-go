...
import (
	"context"
	"github.com/Azure/azure-sdk-for-go/services/resources/mgmt/2021-07-01/managedapplications"
...
type ApplicationsClientAPI interface {
	...
	ListAllowedUpgradePlans(ctx context.Context, resourceGroupName string, applicationName string) (result autorest.Response, err error)
