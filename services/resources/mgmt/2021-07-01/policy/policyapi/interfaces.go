...
import (
	"context"
	"github.com/Azure/azure-sdk-for-go/services/resources/mgmt/2021-07-01/policy"
...
type PricingsClientAPI interface {
	CreateOrUpdate(ctx context.Context, scope string, policyPricingName string, parameters policy.Pricing) (result policy.PricingsCreateOrUpdateFuture, err error)
	Delete(ctx context.Context, scope string, policyPricingName string) (result policy.PricingsDeleteFuture, err error)
	Get(ctx context.Context, scope string, policyPricingName string) (result policy.Pricing, err error)
	List(ctx context.Context) (result policy.PricingListResultPage, err error)
	ListComplete(ctx context.Context) (result policy.PricingListResultIterator, err error)
	ListForManagementGroup(ctx context.Context, managementGroupID string) (result policy.PricingListResultPage, err error)
	ListForManagementGroupComplete(ctx context.Context, managementGroupID string) (result policy.PricingListResultIterator, err error)
}

var _ PricingsClientAPI = (*policy.PricingsClient)(nil)
