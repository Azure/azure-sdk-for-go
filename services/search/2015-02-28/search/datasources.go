...
//
// dataSource is the definition of the datasource to create. clientRequestID is tracking ID sent with the request to
// help with debugging.
...
func (client DataSourcesClient) CreateOrUpdate(dataSourceName string, dataSource DataSource, clientRequestID *uuid.UUID) (result DataSource, err error) {
	if err := validation.Validate([]validation.Validation{
		{TargetValue: dataSource,
			Constraints: []validation.Constraint{{Target: "dataSource.Name", Name: validation.Null, Rule: true, Chain: nil},
				{Target: "dataSource.Type", Name: validation.Null, Rule: true, Chain: nil},
	...
	req, err := client.CreateOrUpdatePreparer(dataSourceName, dataSource, clientRequestID)
	if err != nil {
...
func (client DataSourcesClient) CreateOrUpdatePreparer(dataSourceName string, dataSource DataSource, clientRequestID *uuid.UUID) (*http.Request, error) {
...
//
// dataSourceName is the name of the datasource to delete. clientRequestID is tracking ID sent with the request to help
// with debugging.
func (client DataSourcesClient) Delete(dataSourceName string, clientRequestID *uuid.UUID) (result autorest.Response, err error) {
	req, err := client.DeletePreparer(dataSourceName, clientRequestID)
	if err != nil {
...
func (client DataSourcesClient) DeletePreparer(dataSourceName string, clientRequestID *uuid.UUID) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"dataSourceName": autorest.Encode("path", dataSourceName),
	}
...
//
// dataSourceName is the name of the datasource to retrieve. clientRequestID is tracking ID sent with the request to
// help with debugging.
