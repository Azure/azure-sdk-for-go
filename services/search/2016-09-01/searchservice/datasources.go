...
//
// dataSourceName is the name of the datasource to create or update. dataSource
// is the definition of the datasource to create or update. clientRequestID is
// the tracking ID sent with the request to help with debugging. ifMatch is
// defines the If-Match condition. The operation will be performed only if the
// ETag on the server matches this value. ifNoneMatch is defines the
...
//
// dataSourceName is the name of the datasource to delete. clientRequestID is
// the tracking ID sent with the request to help with debugging. ifMatch is
// defines the If-Match condition. The operation will be performed only if the
// ETag on the server matches this value. ifNoneMatch is defines the
// If-None-Match condition. The operation will be performed only if the ETag on
