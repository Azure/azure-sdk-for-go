...
//
// indexer is the definition of the indexer to create. clientRequestID is the
...
// definition of the indexer to create or update. clientRequestID is the
// tracking ID sent with the request to help with debugging. ifMatch is defines
// the If-Match condition. The operation will be performed only if the ETag on
// the server matches this value. ifNoneMatch is defines the If-None-Match
// condition. The operation will be performed only if the ETag on the server
// does not match this value.
func (client IndexersClient) CreateOrUpdate(indexerName string, indexer Indexer, clientRequestID *uuid.UUID, ifMatch string, ifNoneMatch string) (result Indexer, err error) {
    if err := validation.Validate([]validation.Validation{
    { TargetValue: indexer,
     Constraints: []validation.Constraint{	{Target: "indexer.Name", Name: validation.Null, Rule: true, Chain: nil },
    	{Target: "indexer.DataSourceName", Name: validation.Null, Rule: true, Chain: nil },
    ...
    req, err := client.CreateOrUpdatePreparer(indexerName, indexer, clientRequestID, ifMatch, ifNoneMatch)
    if err != nil {
...
func (client IndexersClient) CreateOrUpdatePreparer(indexerName string, indexer Indexer, clientRequestID *uuid.UUID, ifMatch string, ifNoneMatch string) (*http.Request, error) {
...
//
// indexerName is the name of the indexer to delete. clientRequestID is the
// tracking ID sent with the request to help with debugging. ifMatch is defines
// the If-Match condition. The operation will be performed only if the ETag on
// the server matches this value. ifNoneMatch is defines the If-None-Match
// condition. The operation will be performed only if the ETag on the server
// does not match this value.
func (client IndexersClient) Delete(indexerName string, clientRequestID *uuid.UUID, ifMatch string, ifNoneMatch string) (result autorest.Response, err error) {
    req, err := client.DeletePreparer(indexerName, clientRequestID, ifMatch, ifNoneMatch)
    if err != nil {
...
func (client IndexersClient) DeletePreparer(indexerName string, clientRequestID *uuid.UUID, ifMatch string, ifNoneMatch string) (*http.Request, error) {
    pathParameters := map[string]interface{} {
    "indexerName": autorest.Encode("path",indexerName),
    }
...
//
// indexerName is the name of the indexer to retrieve. clientRequestID is the
// tracking ID sent with the request to help with debugging.
...
// indexer.
//
// indexerName is the name of the indexer to reset. clientRequestID is the
// tracking ID sent with the request to help with debugging.
...
//
// indexerName is the name of the indexer to run. clientRequestID is the
// tracking ID sent with the request to help with debugging.
