...
type NetworkRuleSet struct {
	// IPRules - A list of IP restriction rules that defines the inbound network access to the search service endpoint. These restriction rules are applied only when the EndpointAccess of the search service is Public.
...
type PrivateEndpointConnection struct {
	autorest.Response `json:"-"`
	// ID - The ID of the private endpoint connection. This can be used with the Azure Resource Manager to link resources together.
...
type SharedPrivateLinkResource struct {
	autorest.Response `json:"-"`
	// Name - The name of the shared private link resource.
	Name *string `json:"name,omitempty"`
