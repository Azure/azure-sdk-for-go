...
// OperationResultsClient is the use this API to manage Microsoft SecurityAndCompliance services in your Azure
// subscription.
...
func (client OperationResultsClient) Get(ctx context.Context, locationName string, operationResultID string) (result OperationResultsDescription, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "securityandcompliance.OperationResultsClient", "Get", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "securityandcompliance.OperationResultsClient", "Get", resp, "Failure sending request")
		return
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "securityandcompliance.OperationResultsClient", "Get", resp, "Failure responding to request")
		return
	}
...
func (client OperationResultsClient) GetPreparer(ctx context.Context, locationName string, operationResultID string) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithPathParameters("/subscriptions/{subscriptionId}/providers/Microsoft.SecurityAndCompliance/locations/{locationName}/operationresults/{operationResultId}", pathParameters),
