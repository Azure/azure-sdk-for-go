...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/securityandcompliance/mgmt/2021-03-08/securityandcompliance"
...
func (future *PrivateEndpointConnectionsAdtAPICreateOrUpdateFuture) UnmarshalJSON(body []byte) error {
...
// result is the default implementation for PrivateEndpointConnectionsAdtAPICreateOrUpdateFuture.Result.
func (future *PrivateEndpointConnectionsAdtAPICreateOrUpdateFuture) result(client PrivateEndpointConnectionsAdtAPIClient) (pec PrivateEndpointConnection, err error) {
	var done bool
...
// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *PrivateEndpointConnectionsAdtAPIDeleteFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for PrivateEndpointConnectionsAdtAPIDeleteFuture.Result.
func (future *PrivateEndpointConnectionsAdtAPIDeleteFuture) result(client PrivateEndpointConnectionsAdtAPIClient) (ar autorest.Response, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
...
// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *PrivateEndpointConnectionsCompCreateOrUpdateFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for PrivateEndpointConnectionsCompCreateOrUpdateFuture.Result.
func (future *PrivateEndpointConnectionsCompCreateOrUpdateFuture) result(client PrivateEndpointConnectionsCompClient) (pec PrivateEndpointConnection, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
...
// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *PrivateEndpointConnectionsCompDeleteFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for PrivateEndpointConnectionsCompDeleteFuture.Result.
func (future *PrivateEndpointConnectionsCompDeleteFuture) result(client PrivateEndpointConnectionsCompClient) (ar autorest.Response, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
...
// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *PrivateEndpointConnectionsForEDMCreateOrUpdateFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for PrivateEndpointConnectionsForEDMCreateOrUpdateFuture.Result.
func (future *PrivateEndpointConnectionsForEDMCreateOrUpdateFuture) result(client PrivateEndpointConnectionsForEDMClient) (pec PrivateEndpointConnection, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "securityandcompliance.PrivateEndpointConnectionsForEDMCreateOrUpdateFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		pec.Response.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("securityandcompliance.PrivateEndpointConnectionsForEDMCreateOrUpdateFuture")
		return
	}
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if pec.Response.Response, err = future.GetResult(sender); err == nil && pec.Response.Response.StatusCode != http.StatusNoContent {
		pec, err = client.CreateOrUpdateResponder(pec.Response.Response)
		if err != nil {
			err = autorest.NewErrorWithError(err, "securityandcompliance.PrivateEndpointConnectionsForEDMCreateOrUpdateFuture", "Result", pec.Response.Response, "Failure responding to request")
		}
	}
	return
}
...
// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *PrivateEndpointConnectionsForEDMDeleteFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for PrivateEndpointConnectionsForEDMDeleteFuture.Result.
func (future *PrivateEndpointConnectionsForEDMDeleteFuture) result(client PrivateEndpointConnectionsForEDMClient) (ar autorest.Response, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "securityandcompliance.PrivateEndpointConnectionsForEDMDeleteFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		ar.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("securityandcompliance.PrivateEndpointConnectionsForEDMDeleteFuture")
		return
	}
	ar.Response = future.Response()
	return
...
// PrivateEndpointConnectionsForMIPPolicySyncCreateOrUpdateFuture an abstraction for monitoring and
// retrieving the results of a long-running operation.
type PrivateEndpointConnectionsForMIPPolicySyncCreateOrUpdateFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(PrivateEndpointConnectionsForMIPPolicySyncClient) (PrivateEndpointConnection, error)
}

// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *PrivateEndpointConnectionsForMIPPolicySyncCreateOrUpdateFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for PrivateEndpointConnectionsForMIPPolicySyncCreateOrUpdateFuture.Result.
func (future *PrivateEndpointConnectionsForMIPPolicySyncCreateOrUpdateFuture) result(client PrivateEndpointConnectionsForMIPPolicySyncClient) (pec PrivateEndpointConnection, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "securityandcompliance.PrivateEndpointConnectionsForMIPPolicySyncCreateOrUpdateFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		pec.Response.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("securityandcompliance.PrivateEndpointConnectionsForMIPPolicySyncCreateOrUpdateFuture")
		return
	}
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if pec.Response.Response, err = future.GetResult(sender); err == nil && pec.Response.Response.StatusCode != http.StatusNoContent {
		pec, err = client.CreateOrUpdateResponder(pec.Response.Response)
		if err != nil {
			err = autorest.NewErrorWithError(err, "securityandcompliance.PrivateEndpointConnectionsForMIPPolicySyncCreateOrUpdateFuture", "Result", pec.Response.Response, "Failure responding to request")
		}
	}
	return
}

// PrivateEndpointConnectionsForMIPPolicySyncDeleteFuture an abstraction for monitoring and retrieving the
// results of a long-running operation.
type PrivateEndpointConnectionsForMIPPolicySyncDeleteFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(PrivateEndpointConnectionsForMIPPolicySyncClient) (autorest.Response, error)
}

// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *PrivateEndpointConnectionsForMIPPolicySyncDeleteFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for PrivateEndpointConnectionsForMIPPolicySyncDeleteFuture.Result.
func (future *PrivateEndpointConnectionsForMIPPolicySyncDeleteFuture) result(client PrivateEndpointConnectionsForMIPPolicySyncClient) (ar autorest.Response, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "securityandcompliance.PrivateEndpointConnectionsForMIPPolicySyncDeleteFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		ar.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("securityandcompliance.PrivateEndpointConnectionsForMIPPolicySyncDeleteFuture")
		return
	}
	ar.Response = future.Response()
	return
...
// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *PrivateEndpointConnectionsForSCCPowershellCreateOrUpdateFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for PrivateEndpointConnectionsForSCCPowershellCreateOrUpdateFuture.Result.
func (future *PrivateEndpointConnectionsForSCCPowershellCreateOrUpdateFuture) result(client PrivateEndpointConnectionsForSCCPowershellClient) (pec PrivateEndpointConnection, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
...
// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *PrivateEndpointConnectionsForSCCPowershellDeleteFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for PrivateEndpointConnectionsForSCCPowershellDeleteFuture.Result.
func (future *PrivateEndpointConnectionsForSCCPowershellDeleteFuture) result(client PrivateEndpointConnectionsForSCCPowershellClient) (ar autorest.Response, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
...
// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *PrivateEndpointConnectionsSecCreateOrUpdateFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for PrivateEndpointConnectionsSecCreateOrUpdateFuture.Result.
func (future *PrivateEndpointConnectionsSecCreateOrUpdateFuture) result(client PrivateEndpointConnectionsSecClient) (pec PrivateEndpointConnection, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "securityandcompliance.PrivateEndpointConnectionsSecCreateOrUpdateFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		pec.Response.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("securityandcompliance.PrivateEndpointConnectionsSecCreateOrUpdateFuture")
		return
	}
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if pec.Response.Response, err = future.GetResult(sender); err == nil && pec.Response.Response.StatusCode != http.StatusNoContent {
		pec, err = client.CreateOrUpdateResponder(pec.Response.Response)
		if err != nil {
			err = autorest.NewErrorWithError(err, "securityandcompliance.PrivateEndpointConnectionsSecCreateOrUpdateFuture", "Result", pec.Response.Response, "Failure responding to request")
		}
	}
	return
}
...
// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *PrivateEndpointConnectionsSecDeleteFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for PrivateEndpointConnectionsSecDeleteFuture.Result.
func (future *PrivateEndpointConnectionsSecDeleteFuture) result(client PrivateEndpointConnectionsSecClient) (ar autorest.Response, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "securityandcompliance.PrivateEndpointConnectionsSecDeleteFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		ar.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("securityandcompliance.PrivateEndpointConnectionsSecDeleteFuture")
		return
	}
	ar.Response = future.Response()
	return
...
// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *PrivateLinkServicesForEDMUploadCreateOrUpdateFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for PrivateLinkServicesForEDMUploadCreateOrUpdateFuture.Result.
func (future *PrivateLinkServicesForEDMUploadCreateOrUpdateFuture) result(client PrivateLinkServicesForEDMUploadClient) (plsfeud PrivateLinkServicesForEDMUploadDescription, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
	...
	if !done {
		plsfeud.Response.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("securityandcompliance.PrivateLinkServicesForEDMUploadCreateOrUpdateFuture")
		return
	}
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if plsfeud.Response.Response, err = future.GetResult(sender); err == nil && plsfeud.Response.Response.StatusCode != http.StatusNoContent {
...
// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *PrivateLinkServicesForEDMUploadUpdateFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for PrivateLinkServicesForEDMUploadUpdateFuture.Result.
func (future *PrivateLinkServicesForEDMUploadUpdateFuture) result(client PrivateLinkServicesForEDMUploadClient) (plsfeud PrivateLinkServicesForEDMUploadDescription, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
...
// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *PrivateLinkServicesForM365ComplianceCenterCreateOrUpdateFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for PrivateLinkServicesForM365ComplianceCenterCreateOrUpdateFuture.Result.
func (future *PrivateLinkServicesForM365ComplianceCenterCreateOrUpdateFuture) result(client PrivateLinkServicesForM365ComplianceCenterClient) (plsfmccd PrivateLinkServicesForM365ComplianceCenterDescription, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
	...
	if !done {
		plsfmccd.Response.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("securityandcompliance.PrivateLinkServicesForM365ComplianceCenterCreateOrUpdateFuture")
		return
	}
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if plsfmccd.Response.Response, err = future.GetResult(sender); err == nil && plsfmccd.Response.Response.StatusCode != http.StatusNoContent {
...
// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *PrivateLinkServicesForM365ComplianceCenterDeleteFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for PrivateLinkServicesForM365ComplianceCenterDeleteFuture.Result.
func (future *PrivateLinkServicesForM365ComplianceCenterDeleteFuture) result(client PrivateLinkServicesForM365ComplianceCenterClient) (ar autorest.Response, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
...
// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *PrivateLinkServicesForM365ComplianceCenterUpdateFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for PrivateLinkServicesForM365ComplianceCenterUpdateFuture.Result.
func (future *PrivateLinkServicesForM365ComplianceCenterUpdateFuture) result(client PrivateLinkServicesForM365ComplianceCenterClient) (plsfmccd PrivateLinkServicesForM365ComplianceCenterDescription, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
...
// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *PrivateLinkServicesForM365SecurityCenterCreateOrUpdateFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for PrivateLinkServicesForM365SecurityCenterCreateOrUpdateFuture.Result.
func (future *PrivateLinkServicesForM365SecurityCenterCreateOrUpdateFuture) result(client PrivateLinkServicesForM365SecurityCenterClient) (plsfmscd PrivateLinkServicesForM365SecurityCenterDescription, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
	...
	if !done {
		plsfmscd.Response.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("securityandcompliance.PrivateLinkServicesForM365SecurityCenterCreateOrUpdateFuture")
		return
	}
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if plsfmscd.Response.Response, err = future.GetResult(sender); err == nil && plsfmscd.Response.Response.StatusCode != http.StatusNoContent {
...
// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *PrivateLinkServicesForM365SecurityCenterDeleteFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for PrivateLinkServicesForM365SecurityCenterDeleteFuture.Result.
func (future *PrivateLinkServicesForM365SecurityCenterDeleteFuture) result(client PrivateLinkServicesForM365SecurityCenterClient) (ar autorest.Response, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
...
// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *PrivateLinkServicesForM365SecurityCenterUpdateFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for PrivateLinkServicesForM365SecurityCenterUpdateFuture.Result.
func (future *PrivateLinkServicesForM365SecurityCenterUpdateFuture) result(client PrivateLinkServicesForM365SecurityCenterClient) (plsfmscd PrivateLinkServicesForM365SecurityCenterDescription, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
...
// PrivateLinkServicesForMIPPolicySyncCreateOrUpdateFuture an abstraction for monitoring and retrieving the
// results of a long-running operation.
type PrivateLinkServicesForMIPPolicySyncCreateOrUpdateFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(PrivateLinkServicesForMIPPolicySyncClient) (PrivateLinkServicesForMIPPolicySyncDescription, error)
}

// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *PrivateLinkServicesForMIPPolicySyncCreateOrUpdateFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for PrivateLinkServicesForMIPPolicySyncCreateOrUpdateFuture.Result.
func (future *PrivateLinkServicesForMIPPolicySyncCreateOrUpdateFuture) result(client PrivateLinkServicesForMIPPolicySyncClient) (plsfmpsd PrivateLinkServicesForMIPPolicySyncDescription, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "securityandcompliance.PrivateLinkServicesForMIPPolicySyncCreateOrUpdateFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		plsfmpsd.Response.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("securityandcompliance.PrivateLinkServicesForMIPPolicySyncCreateOrUpdateFuture")
		return
	}
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if plsfmpsd.Response.Response, err = future.GetResult(sender); err == nil && plsfmpsd.Response.Response.StatusCode != http.StatusNoContent {
		plsfmpsd, err = client.CreateOrUpdateResponder(plsfmpsd.Response.Response)
		if err != nil {
			err = autorest.NewErrorWithError(err, "securityandcompliance.PrivateLinkServicesForMIPPolicySyncCreateOrUpdateFuture", "Result", plsfmpsd.Response.Response, "Failure responding to request")
		}
	}
	return
}

// PrivateLinkServicesForMIPPolicySyncDeleteFuture an abstraction for monitoring and retrieving the results
// of a long-running operation.
type PrivateLinkServicesForMIPPolicySyncDeleteFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(PrivateLinkServicesForMIPPolicySyncClient) (autorest.Response, error)
}

// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *PrivateLinkServicesForMIPPolicySyncDeleteFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for PrivateLinkServicesForMIPPolicySyncDeleteFuture.Result.
func (future *PrivateLinkServicesForMIPPolicySyncDeleteFuture) result(client PrivateLinkServicesForMIPPolicySyncClient) (ar autorest.Response, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "securityandcompliance.PrivateLinkServicesForMIPPolicySyncDeleteFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		ar.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("securityandcompliance.PrivateLinkServicesForMIPPolicySyncDeleteFuture")
		return
	}
	ar.Response = future.Response()
	return
...
// MarshalJSON is the custom marshaler for PrivateLinkServicesForMIPPolicySyncDescription.
func (plsfmpsd PrivateLinkServicesForMIPPolicySyncDescription) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if plsfmpsd.Properties != nil {
		objectMap["properties"] = plsfmpsd.Properties
	}
	if plsfmpsd.SystemData != nil {
		objectMap["systemData"] = plsfmpsd.SystemData
	}
	if plsfmpsd.Kind != "" {
		objectMap["kind"] = plsfmpsd.Kind
	}
	if plsfmpsd.Location != nil {
		objectMap["location"] = plsfmpsd.Location
	}
	if plsfmpsd.Tags != nil {
		objectMap["tags"] = plsfmpsd.Tags
	}
	if plsfmpsd.Etag != nil {
		objectMap["etag"] = plsfmpsd.Etag
	}
	if plsfmpsd.Identity != nil {
		objectMap["identity"] = plsfmpsd.Identity
	}
	return json.Marshal(objectMap)
}

// PrivateLinkServicesForMIPPolicySyncDescriptionListResult a list of service description objects with a
// next link.
...
// MarshalJSON is the custom marshaler for PrivateLinkServicesForMIPPolicySyncDescriptionListResult.
func (plsfmpsdlr PrivateLinkServicesForMIPPolicySyncDescriptionListResult) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if plsfmpsdlr.Value != nil {
		objectMap["value"] = plsfmpsdlr.Value
	}
	return json.Marshal(objectMap)
}

// PrivateLinkServicesForMIPPolicySyncDescriptionListResultIterator provides access to a complete listing
// of PrivateLinkServicesForMIPPolicySyncDescription values.
type PrivateLinkServicesForMIPPolicySyncDescriptionListResultIterator struct {
	i    int
	page PrivateLinkServicesForMIPPolicySyncDescriptionListResultPage
}

// NextWithContext advances to the next value.  If there was an error making
// the request the iterator does not advance and the error is returned.
func (iter *PrivateLinkServicesForMIPPolicySyncDescriptionListResultIterator) NextWithContext(ctx context.Context) (err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/PrivateLinkServicesForMIPPolicySyncDescriptionListResultIterator.NextWithContext")
		defer func() {
			sc := -1
			if iter.Response().Response.Response != nil {
				sc = iter.Response().Response.Response.StatusCode
...
// the request the iterator does not advance and the error is returned.
// Deprecated: Use NextWithContext() instead.
func (iter *PrivateLinkServicesForMIPPolicySyncDescriptionListResultIterator) Next() error {
	return iter.NextWithContext(context.Background())
}

// NotDone returns true if the enumeration should be started or is not yet complete.
func (iter PrivateLinkServicesForMIPPolicySyncDescriptionListResultIterator) NotDone() bool {
	return iter.page.NotDone() && iter.i < len(iter.page.Values())
}

// Response returns the raw server response from the last page request.
func (iter PrivateLinkServicesForMIPPolicySyncDescriptionListResultIterator) Response() PrivateLinkServicesForMIPPolicySyncDescriptionListResult {
	return iter.page.Response()
}

// Value returns the current value or a zero-initialized value if the
// iterator has advanced beyond the end of the collection.
func (iter PrivateLinkServicesForMIPPolicySyncDescriptionListResultIterator) Value() PrivateLinkServicesForMIPPolicySyncDescription {
	if !iter.page.NotDone() {
		return PrivateLinkServicesForMIPPolicySyncDescription{}
	}
	return iter.page.Values()[iter.i]
}

// Creates a new instance of the PrivateLinkServicesForMIPPolicySyncDescriptionListResultIterator type.
func NewPrivateLinkServicesForMIPPolicySyncDescriptionListResultIterator(page PrivateLinkServicesForMIPPolicySyncDescriptionListResultPage) PrivateLinkServicesForMIPPolicySyncDescriptionListResultIterator {
	return PrivateLinkServicesForMIPPolicySyncDescriptionListResultIterator{page: page}
}

// IsEmpty returns true if the ListResult contains no values.
func (plsfmpsdlr PrivateLinkServicesForMIPPolicySyncDescriptionListResult) IsEmpty() bool {
	return plsfmpsdlr.Value == nil || len(*plsfmpsdlr.Value) == 0
}

// hasNextLink returns true if the NextLink is not empty.
func (plsfmpsdlr PrivateLinkServicesForMIPPolicySyncDescriptionListResult) hasNextLink() bool {
	return plsfmpsdlr.NextLink != nil && len(*plsfmpsdlr.NextLink) != 0
}

// privateLinkServicesForMIPPolicySyncDescriptionListResultPreparer prepares a request to retrieve the next set of results.
// It returns nil if no more results exist.
func (plsfmpsdlr PrivateLinkServicesForMIPPolicySyncDescriptionListResult) privateLinkServicesForMIPPolicySyncDescriptionListResultPreparer(ctx context.Context) (*http.Request, error) {
	if !plsfmpsdlr.hasNextLink() {
		return nil, nil
	}
	return autorest.Prepare((&http.Request{}).WithContext(ctx),
		autorest.AsJSON(),
		autorest.AsGet(),
		autorest.WithBaseURL(to.String(plsfmpsdlr.NextLink)))
}

// PrivateLinkServicesForMIPPolicySyncDescriptionListResultPage contains a page of
// PrivateLinkServicesForMIPPolicySyncDescription values.
type PrivateLinkServicesForMIPPolicySyncDescriptionListResultPage struct {
	fn         func(context.Context, PrivateLinkServicesForMIPPolicySyncDescriptionListResult) (PrivateLinkServicesForMIPPolicySyncDescriptionListResult, error)
	plsfmpsdlr PrivateLinkServicesForMIPPolicySyncDescriptionListResult
}

// NextWithContext advances to the next page of values.  If there was an error making
// the request the page does not advance and the error is returned.
func (page *PrivateLinkServicesForMIPPolicySyncDescriptionListResultPage) NextWithContext(ctx context.Context) (err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/PrivateLinkServicesForMIPPolicySyncDescriptionListResultPage.NextWithContext")
		defer func() {
			sc := -1
			if page.Response().Response.Response != nil {
				sc = page.Response().Response.Response.StatusCode
	...
	for {
		next, err := page.fn(ctx, page.plsfmpsdlr)
		if err != nil {
			return err
		}
		page.plsfmpsdlr = next
		if !next.hasNextLink() || !next.IsEmpty() {
			break
		}
	}
...
// the request the page does not advance and the error is returned.
// Deprecated: Use NextWithContext() instead.
func (page *PrivateLinkServicesForMIPPolicySyncDescriptionListResultPage) Next() error {
	return page.NextWithContext(context.Background())
}

// NotDone returns true if the page enumeration should be started or is not yet complete.
func (page PrivateLinkServicesForMIPPolicySyncDescriptionListResultPage) NotDone() bool {
	return !page.plsfmpsdlr.IsEmpty()
}

// Response returns the raw server response from the last page request.
func (page PrivateLinkServicesForMIPPolicySyncDescriptionListResultPage) Response() PrivateLinkServicesForMIPPolicySyncDescriptionListResult {
	return page.plsfmpsdlr
}

// Values returns the slice of values for the current page or nil if there are no values.
func (page PrivateLinkServicesForMIPPolicySyncDescriptionListResultPage) Values() []PrivateLinkServicesForMIPPolicySyncDescription {
	if page.plsfmpsdlr.IsEmpty() {
		return nil
	}
	return *page.plsfmpsdlr.Value
}

// Creates a new instance of the PrivateLinkServicesForMIPPolicySyncDescriptionListResultPage type.
func NewPrivateLinkServicesForMIPPolicySyncDescriptionListResultPage(cur PrivateLinkServicesForMIPPolicySyncDescriptionListResult, getNextPage func(context.Context, PrivateLinkServicesForMIPPolicySyncDescriptionListResult) (PrivateLinkServicesForMIPPolicySyncDescriptionListResult, error)) PrivateLinkServicesForMIPPolicySyncDescriptionListResultPage {
	return PrivateLinkServicesForMIPPolicySyncDescriptionListResultPage{
		fn:         getNextPage,
		plsfmpsdlr: cur,
	}
}

// PrivateLinkServicesForMIPPolicySyncUpdateFuture an abstraction for monitoring and retrieving the results
// of a long-running operation.
type PrivateLinkServicesForMIPPolicySyncUpdateFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(PrivateLinkServicesForMIPPolicySyncClient) (PrivateLinkServicesForMIPPolicySyncDescription, error)
...
// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *PrivateLinkServicesForMIPPolicySyncUpdateFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for PrivateLinkServicesForMIPPolicySyncUpdateFuture.Result.
func (future *PrivateLinkServicesForMIPPolicySyncUpdateFuture) result(client PrivateLinkServicesForMIPPolicySyncClient) (plsfmpsd PrivateLinkServicesForMIPPolicySyncDescription, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "securityandcompliance.PrivateLinkServicesForMIPPolicySyncUpdateFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		plsfmpsd.Response.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("securityandcompliance.PrivateLinkServicesForMIPPolicySyncUpdateFuture")
		return
	}
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if plsfmpsd.Response.Response, err = future.GetResult(sender); err == nil && plsfmpsd.Response.Response.StatusCode != http.StatusNoContent {
		plsfmpsd, err = client.UpdateResponder(plsfmpsd.Response.Response)
		if err != nil {
			err = autorest.NewErrorWithError(err, "securityandcompliance.PrivateLinkServicesForMIPPolicySyncUpdateFuture", "Result", plsfmpsd.Response.Response, "Failure responding to request")
		}
	}
	return
}
...
// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *PrivateLinkServicesForO365ManagementActivityAPICreateOrUpdateFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for PrivateLinkServicesForO365ManagementActivityAPICreateOrUpdateFuture.Result.
func (future *PrivateLinkServicesForO365ManagementActivityAPICreateOrUpdateFuture) result(client PrivateLinkServicesForO365ManagementActivityAPIClient) (plsfomaad PrivateLinkServicesForO365ManagementActivityAPIDescription, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
	...
	if !done {
		plsfomaad.Response.Response = future.Response()
	...
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if plsfomaad.Response.Response, err = future.GetResult(sender); err == nil && plsfomaad.Response.Response.StatusCode != http.StatusNoContent {
...
// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *PrivateLinkServicesForO365ManagementActivityAPIDeleteFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for PrivateLinkServicesForO365ManagementActivityAPIDeleteFuture.Result.
func (future *PrivateLinkServicesForO365ManagementActivityAPIDeleteFuture) result(client PrivateLinkServicesForO365ManagementActivityAPIClient) (ar autorest.Response, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
...
// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *PrivateLinkServicesForO365ManagementActivityAPIUpdateFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for PrivateLinkServicesForO365ManagementActivityAPIUpdateFuture.Result.
func (future *PrivateLinkServicesForO365ManagementActivityAPIUpdateFuture) result(client PrivateLinkServicesForO365ManagementActivityAPIClient) (plsfomaad PrivateLinkServicesForO365ManagementActivityAPIDescription, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
...
// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *PrivateLinkServicesForSCCPowershellCreateOrUpdateFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for PrivateLinkServicesForSCCPowershellCreateOrUpdateFuture.Result.
func (future *PrivateLinkServicesForSCCPowershellCreateOrUpdateFuture) result(client PrivateLinkServicesForSCCPowershellClient) (plsfspd PrivateLinkServicesForSCCPowershellDescription, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
	...
	if !done {
		plsfspd.Response.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("securityandcompliance.PrivateLinkServicesForSCCPowershellCreateOrUpdateFuture")
		return
	}
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if plsfspd.Response.Response, err = future.GetResult(sender); err == nil && plsfspd.Response.Response.StatusCode != http.StatusNoContent {
...
// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *PrivateLinkServicesForSCCPowershellDeleteFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for PrivateLinkServicesForSCCPowershellDeleteFuture.Result.
func (future *PrivateLinkServicesForSCCPowershellDeleteFuture) result(client PrivateLinkServicesForSCCPowershellClient) (ar autorest.Response, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
...
// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *PrivateLinkServicesForSCCPowershellUpdateFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for PrivateLinkServicesForSCCPowershellUpdateFuture.Result.
func (future *PrivateLinkServicesForSCCPowershellUpdateFuture) result(client PrivateLinkServicesForSCCPowershellClient) (plsfspd PrivateLinkServicesForSCCPowershellDescription, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
