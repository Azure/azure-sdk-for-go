...
func (client PrivateLinkServicesForMIPPolicySyncClient) CreateOrUpdate(ctx context.Context, resourceGroupName string, resourceName string, privateLinkServicesForMIPPolicySyncDescription PrivateLinkServicesForMIPPolicySyncDescription) (result PrivateLinkServicesForMIPPolicySyncCreateOrUpdateFuture, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewError("securityandcompliance.PrivateLinkServicesForMIPPolicySyncClient", "CreateOrUpdate", err.Error())
	}

	req, err := client.CreateOrUpdatePreparer(ctx, resourceGroupName, resourceName, privateLinkServicesForMIPPolicySyncDescription)
	if err != nil {
		err = autorest.NewErrorWithError(err, "securityandcompliance.PrivateLinkServicesForMIPPolicySyncClient", "CreateOrUpdate", nil, "Failure preparing request")
		return
	}

	result, err = client.CreateOrUpdateSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "securityandcompliance.PrivateLinkServicesForMIPPolicySyncClient", "CreateOrUpdate", nil, "Failure sending request")
		return
	}
...
func (client PrivateLinkServicesForMIPPolicySyncClient) CreateOrUpdatePreparer(ctx context.Context, resourceGroupName string, resourceName string, privateLinkServicesForMIPPolicySyncDescription PrivateLinkServicesForMIPPolicySyncDescription) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithPathParameters("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.SecurityAndCompliance/privateLinkServicesForMIPPolicySync/{resourceName}", pathParameters),
...
func (client PrivateLinkServicesForMIPPolicySyncClient) CreateOrUpdateSender(req *http.Request) (future PrivateLinkServicesForMIPPolicySyncCreateOrUpdateFuture, err error) {
	...
	future.Result = func(client PrivateLinkServicesForMIPPolicySyncClient) (plsfmpsd PrivateLinkServicesForMIPPolicySyncDescription, err error) {
		var done bool
		...
		plsfmpsd.Response.Response, err = future.GetResult(sender)
		if plsfmpsd.Response.Response == nil && err == nil {
			err = autorest.NewErrorWithError(err, "securityandcompliance.PrivateLinkServicesForMIPPolicySyncCreateOrUpdateFuture", "Result", nil, "received nil response and error")
		}
		if err == nil && plsfmpsd.Response.Response.StatusCode != http.StatusNoContent {
...
func (client PrivateLinkServicesForMIPPolicySyncClient) Delete(ctx context.Context, resourceGroupName string, resourceName string) (result PrivateLinkServicesForMIPPolicySyncDeleteFuture, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewError("securityandcompliance.PrivateLinkServicesForMIPPolicySyncClient", "Delete", err.Error())
	}

	req, err := client.DeletePreparer(ctx, resourceGroupName, resourceName)
	if err != nil {
		err = autorest.NewErrorWithError(err, "securityandcompliance.PrivateLinkServicesForMIPPolicySyncClient", "Delete", nil, "Failure preparing request")
		return
	}

	result, err = client.DeleteSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "securityandcompliance.PrivateLinkServicesForMIPPolicySyncClient", "Delete", nil, "Failure sending request")
		return
	}
...
func (client PrivateLinkServicesForMIPPolicySyncClient) DeleteSender(req *http.Request) (future PrivateLinkServicesForMIPPolicySyncDeleteFuture, err error) {
	...
	azf, err = azure.NewFutureFromResponse(resp)
	future.FutureAPI = &azf
	future.Result = func(client PrivateLinkServicesForMIPPolicySyncClient) (ar autorest.Response, err error) {
		var done bool
		done, err = future.DoneWithContext(context.Background(), client)
		if err != nil {
...
func (client PrivateLinkServicesForMIPPolicySyncClient) Get(ctx context.Context, resourceGroupName string, resourceName string) (result PrivateLinkServicesForMIPPolicySyncDescription, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		{TargetValue: resourceName,
			Constraints: []validation.Constraint{{Target: "resourceName", Name: validation.MaxLength, Rule: 24, Chain: nil},
				{Target: "resourceName", Name: validation.MinLength, Rule: 3, Chain: nil}}}}); err != nil {
		return result, validation.NewError("securityandcompliance.PrivateLinkServicesForMIPPolicySyncClient", "Get", err.Error())
	}

	req, err := client.GetPreparer(ctx, resourceGroupName, resourceName)
	if err != nil {
		err = autorest.NewErrorWithError(err, "securityandcompliance.PrivateLinkServicesForMIPPolicySyncClient", "Get", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "securityandcompliance.PrivateLinkServicesForMIPPolicySyncClient", "Get", resp, "Failure sending request")
		return
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "securityandcompliance.PrivateLinkServicesForMIPPolicySyncClient", "Get", resp, "Failure responding to request")
		return
	}
...
func (client PrivateLinkServicesForMIPPolicySyncClient) List(ctx context.Context) (result PrivateLinkServicesForMIPPolicySyncDescriptionListResultPage, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "securityandcompliance.PrivateLinkServicesForMIPPolicySyncClient", "List", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "securityandcompliance.PrivateLinkServicesForMIPPolicySyncClient", "List", resp, "Failure sending request")
		return
	}

	result.plsfmpsdlr, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "securityandcompliance.PrivateLinkServicesForMIPPolicySyncClient", "List", resp, "Failure responding to request")
		return
	}
...
func (client PrivateLinkServicesForMIPPolicySyncClient) ListPreparer(ctx context.Context) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		autorest.AsGet(),
		autorest.WithBaseURL(client.BaseURI),
		autorest.WithPathParameters("/subscriptions/{subscriptionId}/providers/Microsoft.SecurityAndCompliance/privateLinkServicesForMIPPolicySync", pathParameters),
		autorest.WithQueryParameters(queryParameters))
	return preparer.Prepare((&http.Request{}).WithContext(ctx))
}
...
func (client PrivateLinkServicesForMIPPolicySyncClient) listNextResults(ctx context.Context, lastResults PrivateLinkServicesForMIPPolicySyncDescriptionListResult) (result PrivateLinkServicesForMIPPolicySyncDescriptionListResult, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "securityandcompliance.PrivateLinkServicesForMIPPolicySyncClient", "listNextResults", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "securityandcompliance.PrivateLinkServicesForMIPPolicySyncClient", "listNextResults", resp, "Failure sending next results request")
	}
	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "securityandcompliance.PrivateLinkServicesForMIPPolicySyncClient", "listNextResults", resp, "Failure responding to next results request")
	}
	return
}
...
func (client PrivateLinkServicesForMIPPolicySyncClient) ListByResourceGroup(ctx context.Context, resourceGroupName string) (result PrivateLinkServicesForMIPPolicySyncDescriptionListResultPage, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewError("securityandcompliance.PrivateLinkServicesForMIPPolicySyncClient", "ListByResourceGroup", err.Error())
	}

	result.fn = client.listByResourceGroupNextResults
	req, err := client.ListByResourceGroupPreparer(ctx, resourceGroupName)
	if err != nil {
		err = autorest.NewErrorWithError(err, "securityandcompliance.PrivateLinkServicesForMIPPolicySyncClient", "ListByResourceGroup", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		result.plsfmpsdlr.Response = autorest.Response{Response: resp}
		err = autorest.NewErrorWithError(err, "securityandcompliance.PrivateLinkServicesForMIPPolicySyncClient", "ListByResourceGroup", resp, "Failure sending request")
		return
	}

	result.plsfmpsdlr, err = client.ListByResourceGroupResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "securityandcompliance.PrivateLinkServicesForMIPPolicySyncClient", "ListByResourceGroup", resp, "Failure responding to request")
		return
	}
	if result.plsfmpsdlr.hasNextLink() && result.plsfmpsdlr.IsEmpty() {
		err = result.NextWithContext(ctx)
...
func (client PrivateLinkServicesForMIPPolicySyncClient) ListByResourceGroupPreparer(ctx context.Context, resourceGroupName string) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		autorest.AsGet(),
		autorest.WithBaseURL(client.BaseURI),
		autorest.WithPathParameters("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.SecurityAndCompliance/privateLinkServicesForMIPPolicySync", pathParameters),
		autorest.WithQueryParameters(queryParameters))
	return preparer.Prepare((&http.Request{}).WithContext(ctx))
}
...
func (client PrivateLinkServicesForMIPPolicySyncClient) listByResourceGroupNextResults(ctx context.Context, lastResults PrivateLinkServicesForMIPPolicySyncDescriptionListResult) (result PrivateLinkServicesForMIPPolicySyncDescriptionListResult, err error) {
	req, err := lastResults.privateLinkServicesForMIPPolicySyncDescriptionListResultPreparer(ctx)
	if err != nil {
		return result, autorest.NewErrorWithError(err, "securityandcompliance.PrivateLinkServicesForMIPPolicySyncClient", "listByResourceGroupNextResults", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "securityandcompliance.PrivateLinkServicesForMIPPolicySyncClient", "listByResourceGroupNextResults", resp, "Failure sending next results request")
	}
	result, err = client.ListByResourceGroupResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "securityandcompliance.PrivateLinkServicesForMIPPolicySyncClient", "listByResourceGroupNextResults", resp, "Failure responding to next results request")
	}
	return
}
...
func (client PrivateLinkServicesForMIPPolicySyncClient) Update(ctx context.Context, resourceGroupName string, resourceName string, servicePatchDescription ServicesPatchDescription) (result PrivateLinkServicesForMIPPolicySyncUpdateFuture, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		{TargetValue: resourceName,
			Constraints: []validation.Constraint{{Target: "resourceName", Name: validation.MaxLength, Rule: 24, Chain: nil},
				{Target: "resourceName", Name: validation.MinLength, Rule: 3, Chain: nil}}}}); err != nil {
		return result, validation.NewError("securityandcompliance.PrivateLinkServicesForMIPPolicySyncClient", "Update", err.Error())
	}

	req, err := client.UpdatePreparer(ctx, resourceGroupName, resourceName, servicePatchDescription)
	if err != nil {
		err = autorest.NewErrorWithError(err, "securityandcompliance.PrivateLinkServicesForMIPPolicySyncClient", "Update", nil, "Failure preparing request")
		return
	}

	result, err = client.UpdateSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "securityandcompliance.PrivateLinkServicesForMIPPolicySyncClient", "Update", nil, "Failure sending request")
		return
	}
...
func (client PrivateLinkServicesForMIPPolicySyncClient) UpdateSender(req *http.Request) (future PrivateLinkServicesForMIPPolicySyncUpdateFuture, err error) {
	...
	future.Result = func(client PrivateLinkServicesForMIPPolicySyncClient) (plsfmpsd PrivateLinkServicesForMIPPolicySyncDescription, err error) {
		...
		plsfmpsd.Response.Response, err = future.GetResult(sender)
		if plsfmpsd.Response.Response == nil && err == nil {
			err = autorest.NewErrorWithError(err, "securityandcompliance.PrivateLinkServicesForMIPPolicySyncUpdateFuture", "Result", nil, "received nil response and error")
		}
		if err == nil && plsfmpsd.Response.Response.StatusCode != http.StatusNoContent {
