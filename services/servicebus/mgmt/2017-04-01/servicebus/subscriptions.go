...
//
// resourceGroupName is name of the Resource group within the Azure subscription. namespaceName is the namespace
// name topicName is the topic name. skip is skip is only used if a previous operation returned a partial result.
// If a previous response contains a nextLink element, the value of the nextLink element will include a skip
// parameter that specifies a starting point to use for subsequent calls. top is may be used to limit the number of
// results to the most recent N usageDetails.
