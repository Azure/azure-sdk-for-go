...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/servicebus/mgmt/2021-11-01/servicebus"
...
// FailoverProperties safe failover is to indicate the service should wait for pending replication to
...
func (fp FailoverProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if fp.FailoverPropertiesProperties != nil {
		objectMap["properties"] = fp.FailoverPropertiesProperties
	}
	return json.Marshal(objectMap)
}
...
func (fp *FailoverProperties) UnmarshalJSON(body []byte) error {
	...
	for k, v := range m {
		...
		case "properties":
			if v != nil {
				var failoverPropertiesProperties FailoverPropertiesProperties
				err = json.Unmarshal(*v, &failoverPropertiesProperties)
				if err != nil {
					return err
				}
				fp.FailoverPropertiesProperties = &failoverPropertiesProperties
			}
		}
	}
...
// FailoverPropertiesProperties safe failover is to indicate the service should wait for pending
...
func (sn SBNamespace) MarshalJSON() ([]byte, error) {
	...
	if sn.Identity != nil {
		objectMap["identity"] = sn.Identity
	}
...
func (snp SBNamespaceProperties) MarshalJSON() ([]byte, error) {
	...
	if snp.PrivateEndpointConnections != nil {
		objectMap["privateEndpointConnections"] = snp.PrivateEndpointConnections
	}
	if snp.DisableLocalAuth != nil {
		objectMap["disableLocalAuth"] = snp.DisableLocalAuth
	}
	if snp.AlternateName != nil {
		objectMap["alternateName"] = snp.AlternateName
	}
	return json.Marshal(objectMap)
}
...
type SBNamespaceUpdateParameters struct {
	...
	*SBNamespaceUpdateProperties `json:"properties,omitempty"`
	// Identity - Properties of BYOK Identity description
	Identity *Identity `json:"identity,omitempty"`
	// Location - Resource location
	Location *string `json:"location,omitempty"`
...
func (snup SBNamespaceUpdateParameters) MarshalJSON() ([]byte, error) {
	...
	if snup.SBNamespaceUpdateProperties != nil {
		objectMap["properties"] = snup.SBNamespaceUpdateProperties
	}
...
func (snup *SBNamespaceUpdateParameters) UnmarshalJSON(body []byte) error {
	...
	for k, v := range m {
		...
		case "properties":
			if v != nil {
				var sBNamespaceUpdateProperties SBNamespaceUpdateProperties
				err = json.Unmarshal(*v, &sBNamespaceUpdateProperties)
				if err != nil {
					return err
				}
				snup.SBNamespaceUpdateProperties = &sBNamespaceUpdateProperties
			}
		case "identity":
			if v != nil {
				var identity Identity
...
// MarshalJSON is the custom marshaler for SBNamespaceUpdateProperties.
func (snup SBNamespaceUpdateProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if snup.Encryption != nil {
		objectMap["encryption"] = snup.Encryption
	}
	if snup.PrivateEndpointConnections != nil {
		objectMap["privateEndpointConnections"] = snup.PrivateEndpointConnections
	}
	if snup.DisableLocalAuth != nil {
		objectMap["disableLocalAuth"] = snup.DisableLocalAuth
	}
	if snup.AlternateName != nil {
		objectMap["alternateName"] = snup.AlternateName
	}
	return json.Marshal(objectMap)
}
...
func (sqp SBQueueProperties) MarshalJSON() ([]byte, error) {
	...
	if sqp.MaxMessageSizeInKilobytes != nil {
		objectMap["maxMessageSizeInKilobytes"] = sqp.MaxMessageSizeInKilobytes
	}
...
func (ssp SBSubscriptionProperties) MarshalJSON() ([]byte, error) {
	...
	if ssp.IsClientAffine != nil {
		objectMap["isClientAffine"] = ssp.IsClientAffine
	}
	if ssp.ClientAffineProperties != nil {
		objectMap["clientAffineProperties"] = ssp.ClientAffineProperties
	}
	return json.Marshal(objectMap)
}
...
func (stp SBTopicProperties) MarshalJSON() ([]byte, error) {
	...
	if stp.MaxMessageSizeInKilobytes != nil {
		objectMap["maxMessageSizeInKilobytes"] = stp.MaxMessageSizeInKilobytes
	}
