...
// ApplicationsClient is the client for the Applications methods of the
...
//
// applicationName is the name of the application forceRemove is the force
// remove flag to skip services check
