...
// ApplicationTypesClient is the client for the ApplicationTypes methods of the
// Servicefabric service.
type ApplicationTypesClient struct {
	ManagementClient
}

// NewApplicationTypesClient creates an instance of the ApplicationTypesClient
// client.
...
// NewApplicationTypesClientWithBaseURI creates an instance of the
// ApplicationTypesClient client.
