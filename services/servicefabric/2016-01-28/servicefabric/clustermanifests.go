...
// ClusterManifestsClient is the client for the ClusterManifests methods of the
// Servicefabric service.
type ClusterManifestsClient struct {
	ManagementClient
}

// NewClusterManifestsClient creates an instance of the ClusterManifestsClient
// client.
...
// NewClusterManifestsClientWithBaseURI creates an instance of the
// ClusterManifestsClient client.
