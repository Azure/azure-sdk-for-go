...
// ClusterUpgradesClient is the client for the ClusterUpgrades methods of the
// Servicefabric service.
type ClusterUpgradesClient struct {
	ManagementClient
}

// NewClusterUpgradesClient creates an instance of the ClusterUpgradesClient
// client.
...
// NewClusterUpgradesClientWithBaseURI creates an instance of the
// ClusterUpgradesClient client.
