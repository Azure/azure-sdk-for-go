...
// DeployedApplicationHealthsClient is the client for the
// DeployedApplicationHealths methods of the Servicefabric service.
type DeployedApplicationHealthsClient struct {
	ManagementClient
}

// NewDeployedApplicationHealthsClient creates an instance of the
// DeployedApplicationHealthsClient client.
...
// NewDeployedApplicationHealthsClientWithBaseURI creates an instance of the
// DeployedApplicationHealthsClient client.
...
// application eventsHealthStateFilter is the filter of the events health state
// deployedServicePackagesHealthStateFilter is the filter of the deployed
// service packages health state
func (client DeployedApplicationHealthsClient) Get(nodeName string, applicationName string, eventsHealthStateFilter string, deployedServicePackagesHealthStateFilter string) (result DeployedApplicationHealth, err error) {
	req, err := client.GetPreparer(nodeName, applicationName, eventsHealthStateFilter, deployedServicePackagesHealthStateFilter)
	if err != nil {
...
//
// nodeName is the name of the node applicationName is the name of the
// application deployedApplicationHealthReport is the report of the deployed
// application health
func (client DeployedApplicationHealthsClient) Send(nodeName string, applicationName string, deployedApplicationHealthReport DeployedApplicationHealthReport) (result String, err error) {
	req, err := client.SendPreparer(nodeName, applicationName, deployedApplicationHealthReport)
	if err != nil {
