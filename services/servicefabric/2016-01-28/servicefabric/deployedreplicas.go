...
// DeployedReplicasClient is the client for the DeployedReplicas methods of the
// Servicefabric service.
type DeployedReplicasClient struct {
	ManagementClient
}

// NewDeployedReplicasClient creates an instance of the DeployedReplicasClient
// client.
...
// NewDeployedReplicasClientWithBaseURI creates an instance of the
// DeployedReplicasClient client.
