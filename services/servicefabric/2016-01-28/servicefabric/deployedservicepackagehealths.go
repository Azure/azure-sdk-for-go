...
// DeployedServicePackageHealthsClient is the client for the
// DeployedServicePackageHealths methods of the Servicefabric service.
type DeployedServicePackageHealthsClient struct {
	ManagementClient
}

// NewDeployedServicePackageHealthsClient creates an instance of the
// DeployedServicePackageHealthsClient client.
...
// NewDeployedServicePackageHealthsClientWithBaseURI creates an instance of the
// DeployedServicePackageHealthsClient client.
...
// application servicePackageName is the name of the service package
// eventsHealthStateFilter is the filter of the events health state
...
//
// nodeName is the name of the node applicationName is the name of the
// application serviceManifestName is the name of the service manifest
// deployedServicePackageHealthReport is the report of the deployed service
// package health
