...
const (
    // AggregatedHealthState1Error specifies the aggregated health state 1
    // error state for aggregated health state 1.
    AggregatedHealthState1Error AggregatedHealthState1 = "Error"
    // AggregatedHealthState1Invalid specifies the aggregated health state 1
    // invalid state for aggregated health state 1.
    AggregatedHealthState1Invalid AggregatedHealthState1 = "Invalid"
    // AggregatedHealthState1Ok specifies the aggregated health state 1 ok
    // state for aggregated health state 1.
    AggregatedHealthState1Ok AggregatedHealthState1 = "Ok"
    // AggregatedHealthState1Unknown specifies the aggregated health state 1
    // unknown state for aggregated health state 1.
    AggregatedHealthState1Unknown AggregatedHealthState1 = "Unknown"
    // AggregatedHealthState1Warning specifies the aggregated health state 1
    // warning state for aggregated health state 1.
    AggregatedHealthState1Warning AggregatedHealthState1 = "Warning"
)

// AggregatedHealthState10 enumerates the values for aggregated health state
// 10.
type AggregatedHealthState10 string

const (
    // AggregatedHealthState10Error specifies the aggregated health state 10
    // error state for aggregated health state 10.
    AggregatedHealthState10Error AggregatedHealthState10 = "Error"
    // AggregatedHealthState10Invalid specifies the aggregated health state 10
    // invalid state for aggregated health state 10.
    AggregatedHealthState10Invalid AggregatedHealthState10 = "Invalid"
    // AggregatedHealthState10Ok specifies the aggregated health state 10 ok
    // state for aggregated health state 10.
    AggregatedHealthState10Ok AggregatedHealthState10 = "Ok"
    // AggregatedHealthState10Unknown specifies the aggregated health state 10
    // unknown state for aggregated health state 10.
    AggregatedHealthState10Unknown AggregatedHealthState10 = "Unknown"
    // AggregatedHealthState10Warning specifies the aggregated health state 10
    // warning state for aggregated health state 10.
    AggregatedHealthState10Warning AggregatedHealthState10 = "Warning"
)

// AggregatedHealthState11 enumerates the values for aggregated health state
// 11.
type AggregatedHealthState11 string

const (
    // AggregatedHealthState11Error specifies the aggregated health state 11
    // error state for aggregated health state 11.
    AggregatedHealthState11Error AggregatedHealthState11 = "Error"
    // AggregatedHealthState11Invalid specifies the aggregated health state 11
    // invalid state for aggregated health state 11.
    AggregatedHealthState11Invalid AggregatedHealthState11 = "Invalid"
    // AggregatedHealthState11Ok specifies the aggregated health state 11 ok
    // state for aggregated health state 11.
    AggregatedHealthState11Ok AggregatedHealthState11 = "Ok"
    // AggregatedHealthState11Unknown specifies the aggregated health state 11
    // unknown state for aggregated health state 11.
    AggregatedHealthState11Unknown AggregatedHealthState11 = "Unknown"
    // AggregatedHealthState11Warning specifies the aggregated health state 11
    // warning state for aggregated health state 11.
    AggregatedHealthState11Warning AggregatedHealthState11 = "Warning"
)

// AggregatedHealthState12 enumerates the values for aggregated health state
// 12.
type AggregatedHealthState12 string

const (
    // AggregatedHealthState12Error specifies the aggregated health state 12
    // error state for aggregated health state 12.
    AggregatedHealthState12Error AggregatedHealthState12 = "Error"
    // AggregatedHealthState12Invalid specifies the aggregated health state 12
    // invalid state for aggregated health state 12.
    AggregatedHealthState12Invalid AggregatedHealthState12 = "Invalid"
    // AggregatedHealthState12Ok specifies the aggregated health state 12 ok
    // state for aggregated health state 12.
    AggregatedHealthState12Ok AggregatedHealthState12 = "Ok"
    // AggregatedHealthState12Unknown specifies the aggregated health state 12
    // unknown state for aggregated health state 12.
    AggregatedHealthState12Unknown AggregatedHealthState12 = "Unknown"
    // AggregatedHealthState12Warning specifies the aggregated health state 12
    // warning state for aggregated health state 12.
    AggregatedHealthState12Warning AggregatedHealthState12 = "Warning"
)

// AggregatedHealthState13 enumerates the values for aggregated health state
// 13.
type AggregatedHealthState13 string

const (
    // AggregatedHealthState13Error specifies the aggregated health state 13
    // error state for aggregated health state 13.
    AggregatedHealthState13Error AggregatedHealthState13 = "Error"
    // AggregatedHealthState13Invalid specifies the aggregated health state 13
    // invalid state for aggregated health state 13.
    AggregatedHealthState13Invalid AggregatedHealthState13 = "Invalid"
    // AggregatedHealthState13Ok specifies the aggregated health state 13 ok
    // state for aggregated health state 13.
    AggregatedHealthState13Ok AggregatedHealthState13 = "Ok"
    // AggregatedHealthState13Unknown specifies the aggregated health state 13
    // unknown state for aggregated health state 13.
    AggregatedHealthState13Unknown AggregatedHealthState13 = "Unknown"
    // AggregatedHealthState13Warning specifies the aggregated health state 13
    // warning state for aggregated health state 13.
    AggregatedHealthState13Warning AggregatedHealthState13 = "Warning"
)

// AggregatedHealthState14 enumerates the values for aggregated health state
// 14.
type AggregatedHealthState14 string

const (
    // AggregatedHealthState14Error specifies the aggregated health state 14
    // error state for aggregated health state 14.
    AggregatedHealthState14Error AggregatedHealthState14 = "Error"
    // AggregatedHealthState14Invalid specifies the aggregated health state 14
    // invalid state for aggregated health state 14.
    AggregatedHealthState14Invalid AggregatedHealthState14 = "Invalid"
    // AggregatedHealthState14Ok specifies the aggregated health state 14 ok
    // state for aggregated health state 14.
    AggregatedHealthState14Ok AggregatedHealthState14 = "Ok"
    // AggregatedHealthState14Unknown specifies the aggregated health state 14
    // unknown state for aggregated health state 14.
    AggregatedHealthState14Unknown AggregatedHealthState14 = "Unknown"
    // AggregatedHealthState14Warning specifies the aggregated health state 14
    // warning state for aggregated health state 14.
    AggregatedHealthState14Warning AggregatedHealthState14 = "Warning"
)

// AggregatedHealthState15 enumerates the values for aggregated health state
// 15.
type AggregatedHealthState15 string

const (
    // AggregatedHealthState15Error specifies the aggregated health state 15
    // error state for aggregated health state 15.
    AggregatedHealthState15Error AggregatedHealthState15 = "Error"
    // AggregatedHealthState15Invalid specifies the aggregated health state 15
    // invalid state for aggregated health state 15.
    AggregatedHealthState15Invalid AggregatedHealthState15 = "Invalid"
    // AggregatedHealthState15Ok specifies the aggregated health state 15 ok
    // state for aggregated health state 15.
    AggregatedHealthState15Ok AggregatedHealthState15 = "Ok"
    // AggregatedHealthState15Unknown specifies the aggregated health state 15
    // unknown state for aggregated health state 15.
    AggregatedHealthState15Unknown AggregatedHealthState15 = "Unknown"
    // AggregatedHealthState15Warning specifies the aggregated health state 15
    // warning state for aggregated health state 15.
...
const (
    // AggregatedHealthState2Error specifies the aggregated health state 2
    // error state for aggregated health state 2.
    AggregatedHealthState2Error AggregatedHealthState2 = "Error"
    // AggregatedHealthState2Invalid specifies the aggregated health state 2
    // invalid state for aggregated health state 2.
    AggregatedHealthState2Invalid AggregatedHealthState2 = "Invalid"
    // AggregatedHealthState2Ok specifies the aggregated health state 2 ok
    // state for aggregated health state 2.
    AggregatedHealthState2Ok AggregatedHealthState2 = "Ok"
    // AggregatedHealthState2Unknown specifies the aggregated health state 2
    // unknown state for aggregated health state 2.
    AggregatedHealthState2Unknown AggregatedHealthState2 = "Unknown"
    // AggregatedHealthState2Warning specifies the aggregated health state 2
    // warning state for aggregated health state 2.
...
const (
    // AggregatedHealthState3Error specifies the aggregated health state 3
    // error state for aggregated health state 3.
    AggregatedHealthState3Error AggregatedHealthState3 = "Error"
    // AggregatedHealthState3Invalid specifies the aggregated health state 3
    // invalid state for aggregated health state 3.
    AggregatedHealthState3Invalid AggregatedHealthState3 = "Invalid"
    // AggregatedHealthState3Ok specifies the aggregated health state 3 ok
    // state for aggregated health state 3.
    AggregatedHealthState3Ok AggregatedHealthState3 = "Ok"
    // AggregatedHealthState3Unknown specifies the aggregated health state 3
    // unknown state for aggregated health state 3.
    AggregatedHealthState3Unknown AggregatedHealthState3 = "Unknown"
    // AggregatedHealthState3Warning specifies the aggregated health state 3
    // warning state for aggregated health state 3.
...
const (
    // AggregatedHealthState4Error specifies the aggregated health state 4
    // error state for aggregated health state 4.
    AggregatedHealthState4Error AggregatedHealthState4 = "Error"
    // AggregatedHealthState4Invalid specifies the aggregated health state 4
    // invalid state for aggregated health state 4.
    AggregatedHealthState4Invalid AggregatedHealthState4 = "Invalid"
    // AggregatedHealthState4Ok specifies the aggregated health state 4 ok
    // state for aggregated health state 4.
    AggregatedHealthState4Ok AggregatedHealthState4 = "Ok"
    // AggregatedHealthState4Unknown specifies the aggregated health state 4
    // unknown state for aggregated health state 4.
    AggregatedHealthState4Unknown AggregatedHealthState4 = "Unknown"
    // AggregatedHealthState4Warning specifies the aggregated health state 4
    // warning state for aggregated health state 4.
...
const (
    // AggregatedHealthState5Error specifies the aggregated health state 5
    // error state for aggregated health state 5.
    AggregatedHealthState5Error AggregatedHealthState5 = "Error"
    // AggregatedHealthState5Invalid specifies the aggregated health state 5
    // invalid state for aggregated health state 5.
    AggregatedHealthState5Invalid AggregatedHealthState5 = "Invalid"
    // AggregatedHealthState5Ok specifies the aggregated health state 5 ok
    // state for aggregated health state 5.
    AggregatedHealthState5Ok AggregatedHealthState5 = "Ok"
    // AggregatedHealthState5Unknown specifies the aggregated health state 5
    // unknown state for aggregated health state 5.
    AggregatedHealthState5Unknown AggregatedHealthState5 = "Unknown"
    // AggregatedHealthState5Warning specifies the aggregated health state 5
    // warning state for aggregated health state 5.
...
const (
    // AggregatedHealthState6Error specifies the aggregated health state 6
    // error state for aggregated health state 6.
    AggregatedHealthState6Error AggregatedHealthState6 = "Error"
    // AggregatedHealthState6Invalid specifies the aggregated health state 6
    // invalid state for aggregated health state 6.
    AggregatedHealthState6Invalid AggregatedHealthState6 = "Invalid"
    // AggregatedHealthState6Ok specifies the aggregated health state 6 ok
    // state for aggregated health state 6.
    AggregatedHealthState6Ok AggregatedHealthState6 = "Ok"
    // AggregatedHealthState6Unknown specifies the aggregated health state 6
    // unknown state for aggregated health state 6.
    AggregatedHealthState6Unknown AggregatedHealthState6 = "Unknown"
    // AggregatedHealthState6Warning specifies the aggregated health state 6
    // warning state for aggregated health state 6.
...
const (
    // AggregatedHealthState7Error specifies the aggregated health state 7
    // error state for aggregated health state 7.
    AggregatedHealthState7Error AggregatedHealthState7 = "Error"
    // AggregatedHealthState7Invalid specifies the aggregated health state 7
    // invalid state for aggregated health state 7.
    AggregatedHealthState7Invalid AggregatedHealthState7 = "Invalid"
    // AggregatedHealthState7Ok specifies the aggregated health state 7 ok
    // state for aggregated health state 7.
    AggregatedHealthState7Ok AggregatedHealthState7 = "Ok"
    // AggregatedHealthState7Unknown specifies the aggregated health state 7
    // unknown state for aggregated health state 7.
    AggregatedHealthState7Unknown AggregatedHealthState7 = "Unknown"
    // AggregatedHealthState7Warning specifies the aggregated health state 7
    // warning state for aggregated health state 7.
...
const (
    // AggregatedHealthState8Error specifies the aggregated health state 8
    // error state for aggregated health state 8.
    AggregatedHealthState8Error AggregatedHealthState8 = "Error"
    // AggregatedHealthState8Invalid specifies the aggregated health state 8
    // invalid state for aggregated health state 8.
    AggregatedHealthState8Invalid AggregatedHealthState8 = "Invalid"
    // AggregatedHealthState8Ok specifies the aggregated health state 8 ok
    // state for aggregated health state 8.
    AggregatedHealthState8Ok AggregatedHealthState8 = "Ok"
    // AggregatedHealthState8Unknown specifies the aggregated health state 8
    // unknown state for aggregated health state 8.
    AggregatedHealthState8Unknown AggregatedHealthState8 = "Unknown"
    // AggregatedHealthState8Warning specifies the aggregated health state 8
    // warning state for aggregated health state 8.
...
const (
    // AggregatedHealthState9Error specifies the aggregated health state 9
    // error state for aggregated health state 9.
    AggregatedHealthState9Error AggregatedHealthState9 = "Error"
    // AggregatedHealthState9Invalid specifies the aggregated health state 9
    // invalid state for aggregated health state 9.
    AggregatedHealthState9Invalid AggregatedHealthState9 = "Invalid"
    // AggregatedHealthState9Ok specifies the aggregated health state 9 ok
    // state for aggregated health state 9.
    AggregatedHealthState9Ok AggregatedHealthState9 = "Ok"
    // AggregatedHealthState9Unknown specifies the aggregated health state 9
    // unknown state for aggregated health state 9.
    AggregatedHealthState9Unknown AggregatedHealthState9 = "Unknown"
    // AggregatedHealthState9Warning specifies the aggregated health state 9
    // warning state for aggregated health state 9.
...
const (
    // DefaultMoveCost1High specifies the default move cost 1 high state for
    // default move cost 1.
    DefaultMoveCost1High DefaultMoveCost1 = "High"
    // DefaultMoveCost1Low specifies the default move cost 1 low state for
    // default move cost 1.
    DefaultMoveCost1Low DefaultMoveCost1 = "Low"
    // DefaultMoveCost1Medium specifies the default move cost 1 medium state
    // for default move cost 1.
    DefaultMoveCost1Medium DefaultMoveCost1 = "Medium"
    // DefaultMoveCost1Zero specifies the default move cost 1 zero state for
    // default move cost 1.
...
const (
    // DefaultMoveCost2High specifies the default move cost 2 high state for
    // default move cost 2.
    DefaultMoveCost2High DefaultMoveCost2 = "High"
    // DefaultMoveCost2Low specifies the default move cost 2 low state for
    // default move cost 2.
    DefaultMoveCost2Low DefaultMoveCost2 = "Low"
    // DefaultMoveCost2Medium specifies the default move cost 2 medium state
    // for default move cost 2.
    DefaultMoveCost2Medium DefaultMoveCost2 = "Medium"
    // DefaultMoveCost2Zero specifies the default move cost 2 zero state for
    // default move cost 2.
...
const (
    // DefaultMoveCost3High specifies the default move cost 3 high state for
    // default move cost 3.
    DefaultMoveCost3High DefaultMoveCost3 = "High"
    // DefaultMoveCost3Low specifies the default move cost 3 low state for
    // default move cost 3.
    DefaultMoveCost3Low DefaultMoveCost3 = "Low"
    // DefaultMoveCost3Medium specifies the default move cost 3 medium state
    // for default move cost 3.
    DefaultMoveCost3Medium DefaultMoveCost3 = "Medium"
    // DefaultMoveCost3Zero specifies the default move cost 3 zero state for
    // default move cost 3.
...
const (
    // FailureReasonHealthCheck specifies the failure reason health check state
    // for failure reason.
    FailureReasonHealthCheck FailureReason = "HealthCheck"
    // FailureReasonInterrupted specifies the failure reason interrupted state
    // for failure reason.
    FailureReasonInterrupted FailureReason = "Interrupted"
    // FailureReasonInvalid specifies the failure reason invalid state for
    // failure reason.
    FailureReasonInvalid FailureReason = "Invalid"
    // FailureReasonOverallUpgradeTimeout specifies the failure reason overall
    // upgrade timeout state for failure reason.
    FailureReasonOverallUpgradeTimeout FailureReason = "OverallUpgradeTimeout"
    // FailureReasonUpgradeDomainTimeout specifies the failure reason upgrade
    // domain timeout state for failure reason.
...
const (
    // FailureReason1HealthCheck specifies the failure reason 1 health check
    // state for failure reason 1.
    FailureReason1HealthCheck FailureReason1 = "HealthCheck"
    // FailureReason1Interrupted specifies the failure reason 1 interrupted
    // state for failure reason 1.
    FailureReason1Interrupted FailureReason1 = "Interrupted"
    // FailureReason1Invalid specifies the failure reason 1 invalid state for
    // failure reason 1.
    FailureReason1Invalid FailureReason1 = "Invalid"
    // FailureReason1OverallUpgradeTimeout specifies the failure reason 1
    // overall upgrade timeout state for failure reason 1.
    FailureReason1OverallUpgradeTimeout FailureReason1 = "OverallUpgradeTimeout"
    // FailureReason1UpgradeDomainTimeout specifies the failure reason 1
    // upgrade domain timeout state for failure reason 1.
...
const (
    // HealthStateError specifies the health state error state for health
    // state.
    ...
    // HealthStateUnknown specifies the health state unknown state for health
    // state.
    HealthStateUnknown HealthState = "Unknown"
    // HealthStateWarning specifies the health state warning state for health
    // state.
...
const (
    // HealthState1Error specifies the health state 1 error state for health
    // state 1.
    HealthState1Error HealthState1 = "Error"
    // HealthState1Invalid specifies the health state 1 invalid state for
    // health state 1.
    ...
    // HealthState1Unknown specifies the health state 1 unknown state for
    // health state 1.
    HealthState1Unknown HealthState1 = "Unknown"
    // HealthState1Warning specifies the health state 1 warning state for
    // health state 1.
...
const (
    // HealthState2Error specifies the health state 2 error state for health
    // state 2.
    HealthState2Error HealthState2 = "Error"
    // HealthState2Invalid specifies the health state 2 invalid state for
    // health state 2.
    ...
    // HealthState2Unknown specifies the health state 2 unknown state for
    // health state 2.
    HealthState2Unknown HealthState2 = "Unknown"
    // HealthState2Warning specifies the health state 2 warning state for
    // health state 2.
...
const (
    // HealthState3Error specifies the health state 3 error state for health
    // state 3.
    HealthState3Error HealthState3 = "Error"
    // HealthState3Invalid specifies the health state 3 invalid state for
    // health state 3.
    ...
    // HealthState3Unknown specifies the health state 3 unknown state for
    // health state 3.
    HealthState3Unknown HealthState3 = "Unknown"
    // HealthState3Warning specifies the health state 3 warning state for
    // health state 3.
...
const (
    // HealthState4Error specifies the health state 4 error state for health
    // state 4.
    HealthState4Error HealthState4 = "Error"
    // HealthState4Invalid specifies the health state 4 invalid state for
    // health state 4.
    ...
    // HealthState4Unknown specifies the health state 4 unknown state for
    // health state 4.
    HealthState4Unknown HealthState4 = "Unknown"
    // HealthState4Warning specifies the health state 4 warning state for
    // health state 4.
...
const (
    // HealthState5Error specifies the health state 5 error state for health
    // state 5.
    HealthState5Error HealthState5 = "Error"
    // HealthState5Invalid specifies the health state 5 invalid state for
    // health state 5.
    ...
    // HealthState5Unknown specifies the health state 5 unknown state for
    // health state 5.
    HealthState5Unknown HealthState5 = "Unknown"
    // HealthState5Warning specifies the health state 5 warning state for
    // health state 5.
...
const (
    // HealthState6Error specifies the health state 6 error state for health
    // state 6.
    HealthState6Error HealthState6 = "Error"
    // HealthState6Invalid specifies the health state 6 invalid state for
    // health state 6.
    ...
    // HealthState6Unknown specifies the health state 6 unknown state for
    // health state 6.
    HealthState6Unknown HealthState6 = "Unknown"
    // HealthState6Warning specifies the health state 6 warning state for
    // health state 6.
...
const (
    // NodeDeactivationIntentInvalid specifies the node deactivation intent
    // invalid state for node deactivation intent.
    NodeDeactivationIntentInvalid NodeDeactivationIntent = "Invalid"
    // NodeDeactivationIntentPause specifies the node deactivation intent pause
    // state for node deactivation intent.
    NodeDeactivationIntentPause NodeDeactivationIntent = "Pause"
    // NodeDeactivationIntentRemoveData specifies the node deactivation intent
    // remove data state for node deactivation intent.
    NodeDeactivationIntentRemoveData NodeDeactivationIntent = "RemoveData"
    // NodeDeactivationIntentRestart specifies the node deactivation intent
    // restart state for node deactivation intent.
...
const (
    // NodeDeactivationStatusCompleted specifies the node deactivation status
    // completed state for node deactivation status.
    NodeDeactivationStatusCompleted NodeDeactivationStatus = "Completed"
    // NodeDeactivationStatusInvalid specifies the node deactivation status
    // invalid state for node deactivation status.
    NodeDeactivationStatusInvalid NodeDeactivationStatus = "Invalid"
    // NodeDeactivationStatusSafetyCheckComplete specifies the node
    // deactivation status safety check complete state for node deactivation
    // status.
    NodeDeactivationStatusSafetyCheckComplete NodeDeactivationStatus = "SafetyCheckComplete"
    // NodeDeactivationStatusSafetyCheckInProgress specifies the node
    // deactivation status safety check in progress state for node deactivation
    // status.
...
const (
    // NodeStatusDisabled specifies the node status disabled state for node
    // status.
    NodeStatusDisabled NodeStatus = "Disabled"
    // NodeStatusDisabling specifies the node status disabling state for node
    // status.
    NodeStatusDisabling NodeStatus = "Disabling"
    // NodeStatusDown specifies the node status down state for node status.
    NodeStatusDown NodeStatus = "Down"
    // NodeStatusEnabling specifies the node status enabling state for node
    // status.
    NodeStatusEnabling NodeStatus = "Enabling"
    // NodeStatusInvalid specifies the node status invalid state for node
    // status.
    NodeStatusInvalid NodeStatus = "Invalid"
    // NodeStatusRemoved specifies the node status removed state for node
    // status.
    NodeStatusRemoved NodeStatus = "Removed"
    // NodeStatusUnknown specifies the node status unknown state for node
    // status.
...
const (
    // PartitionSchemeInvalid specifies the partition scheme invalid state for
    // partition scheme.
    PartitionSchemeInvalid PartitionScheme = "Invalid"
    // PartitionSchemeNamed specifies the partition scheme named state for
    // partition scheme.
    PartitionSchemeNamed PartitionScheme = "Named"
    // PartitionSchemeSingleton specifies the partition scheme singleton state
    // for partition scheme.
    PartitionSchemeSingleton PartitionScheme = "Singleton"
    // PartitionSchemeUniformInt64 specifies the partition scheme uniform int
    // 64 state for partition scheme.
...
const (
    // PartitionStatusDeleting specifies the partition status deleting state
    // for partition status.
    PartitionStatusDeleting PartitionStatus = "Deleting"
    // PartitionStatusInQuorumLoss specifies the partition status in quorum
    // loss state for partition status.
    PartitionStatusInQuorumLoss PartitionStatus = "InQuorumLoss"
    // PartitionStatusInvalid specifies the partition status invalid state for
    // partition status.
    PartitionStatusInvalid PartitionStatus = "Invalid"
    // PartitionStatusNotReady specifies the partition status not ready state
    // for partition status.
    PartitionStatusNotReady PartitionStatus = "NotReady"
    // PartitionStatusReady specifies the partition status ready state for
    // partition status.
    PartitionStatusReady PartitionStatus = "Ready"
    // PartitionStatusReconfiguring specifies the partition status
    // reconfiguring state for partition status.
...
const (
    // ReplicaRoleActiveSecondary specifies the replica role active secondary
    // state for replica role.
    ReplicaRoleActiveSecondary ReplicaRole = "ActiveSecondary"
    // ReplicaRoleIdleSecondary specifies the replica role idle secondary state
    // for replica role.
    ReplicaRoleIdleSecondary ReplicaRole = "IdleSecondary"
    // ReplicaRoleInvalid specifies the replica role invalid state for replica
    // role.
    ...
    // ReplicaRolePrimary specifies the replica role primary state for replica
    // role.
...
const (
    // ReplicaRole1ActiveSecondary specifies the replica role 1 active
    // secondary state for replica role 1.
    ReplicaRole1ActiveSecondary ReplicaRole1 = "ActiveSecondary"
    // ReplicaRole1IdleSecondary specifies the replica role 1 idle secondary
    // state for replica role 1.
    ReplicaRole1IdleSecondary ReplicaRole1 = "IdleSecondary"
    // ReplicaRole1Invalid specifies the replica role 1 invalid state for
    // replica role 1.
    ReplicaRole1Invalid ReplicaRole1 = "Invalid"
    // ReplicaRole1None specifies the replica role 1 none state for replica
    // role 1.
    ReplicaRole1None ReplicaRole1 = "None"
    // ReplicaRole1Primary specifies the replica role 1 primary state for
    // replica role 1.
...
const (
    // ReplicaStatusDown specifies the replica status down state for replica
    // status.
    ReplicaStatusDown ReplicaStatus = "Down"
    // ReplicaStatusDropped specifies the replica status dropped state for
    // replica status.
    ReplicaStatusDropped ReplicaStatus = "Dropped"
    // ReplicaStatusInBuild specifies the replica status in build state for
    // replica status.
    ReplicaStatusInBuild ReplicaStatus = "InBuild"
    // ReplicaStatusInvalid specifies the replica status invalid state for
    // replica status.
    ReplicaStatusInvalid ReplicaStatus = "Invalid"
    // ReplicaStatusReady specifies the replica status ready state for replica
    // status.
    ReplicaStatusReady ReplicaStatus = "Ready"
    // ReplicaStatusStandby specifies the replica status standby state for
    // replica status.
...
const (
    // ReplicaStatus1Down specifies the replica status 1 down state for replica
    // status 1.
    ReplicaStatus1Down ReplicaStatus1 = "Down"
    // ReplicaStatus1Dropped specifies the replica status 1 dropped state for
    // replica status 1.
    ReplicaStatus1Dropped ReplicaStatus1 = "Dropped"
    // ReplicaStatus1InBuild specifies the replica status 1 in build state for
    // replica status 1.
    ReplicaStatus1InBuild ReplicaStatus1 = "InBuild"
    // ReplicaStatus1Invalid specifies the replica status 1 invalid state for
    // replica status 1.
    ReplicaStatus1Invalid ReplicaStatus1 = "Invalid"
    // ReplicaStatus1Ready specifies the replica status 1 ready state for
    // replica status 1.
    ReplicaStatus1Ready ReplicaStatus1 = "Ready"
    // ReplicaStatus1Standby specifies the replica status 1 standby state for
    // replica status 1.
...
const (
    // RollingUpgradeModeInvalid specifies the rolling upgrade mode invalid
    // state for rolling upgrade mode.
    RollingUpgradeModeInvalid RollingUpgradeMode = "Invalid"
    // RollingUpgradeModeMonitored specifies the rolling upgrade mode monitored
    // state for rolling upgrade mode.
    RollingUpgradeModeMonitored RollingUpgradeMode = "Monitored"
    // RollingUpgradeModeUnmonitoredAuto specifies the rolling upgrade mode
    // unmonitored auto state for rolling upgrade mode.
    RollingUpgradeModeUnmonitoredAuto RollingUpgradeMode = "UnmonitoredAuto"
    // RollingUpgradeModeUnmonitoredManual specifies the rolling upgrade mode
    // unmonitored manual state for rolling upgrade mode.
...
const (
    // RollingUpgradeMode1Invalid specifies the rolling upgrade mode 1 invalid
    // state for rolling upgrade mode 1.
    RollingUpgradeMode1Invalid RollingUpgradeMode1 = "Invalid"
    // RollingUpgradeMode1Monitored specifies the rolling upgrade mode 1
    // monitored state for rolling upgrade mode 1.
    RollingUpgradeMode1Monitored RollingUpgradeMode1 = "Monitored"
    // RollingUpgradeMode1UnmonitoredAuto specifies the rolling upgrade mode 1
    // unmonitored auto state for rolling upgrade mode 1.
    RollingUpgradeMode1UnmonitoredAuto RollingUpgradeMode1 = "UnmonitoredAuto"
    // RollingUpgradeMode1UnmonitoredManual specifies the rolling upgrade mode
    // 1 unmonitored manual state for rolling upgrade mode 1.
...
const (
    // RollingUpgradeMode2Invalid specifies the rolling upgrade mode 2 invalid
    // state for rolling upgrade mode 2.
    RollingUpgradeMode2Invalid RollingUpgradeMode2 = "Invalid"
    // RollingUpgradeMode2Monitored specifies the rolling upgrade mode 2
    // monitored state for rolling upgrade mode 2.
    RollingUpgradeMode2Monitored RollingUpgradeMode2 = "Monitored"
    // RollingUpgradeMode2UnmonitoredAuto specifies the rolling upgrade mode 2
    // unmonitored auto state for rolling upgrade mode 2.
    RollingUpgradeMode2UnmonitoredAuto RollingUpgradeMode2 = "UnmonitoredAuto"
    // RollingUpgradeMode2UnmonitoredManual specifies the rolling upgrade mode
    // 2 unmonitored manual state for rolling upgrade mode 2.
...
const (
    // RollingUpgradeMode3Invalid specifies the rolling upgrade mode 3 invalid
    // state for rolling upgrade mode 3.
    RollingUpgradeMode3Invalid RollingUpgradeMode3 = "Invalid"
    // RollingUpgradeMode3Monitored specifies the rolling upgrade mode 3
    // monitored state for rolling upgrade mode 3.
    RollingUpgradeMode3Monitored RollingUpgradeMode3 = "Monitored"
    // RollingUpgradeMode3UnmonitoredAuto specifies the rolling upgrade mode 3
    // unmonitored auto state for rolling upgrade mode 3.
    RollingUpgradeMode3UnmonitoredAuto RollingUpgradeMode3 = "UnmonitoredAuto"
    // RollingUpgradeMode3UnmonitoredManual specifies the rolling upgrade mode
    // 3 unmonitored manual state for rolling upgrade mode 3.
...
const (
    // RollingUpgradeMode4Invalid specifies the rolling upgrade mode 4 invalid
    // state for rolling upgrade mode 4.
    RollingUpgradeMode4Invalid RollingUpgradeMode4 = "Invalid"
    // RollingUpgradeMode4Monitored specifies the rolling upgrade mode 4
    // monitored state for rolling upgrade mode 4.
    RollingUpgradeMode4Monitored RollingUpgradeMode4 = "Monitored"
    // RollingUpgradeMode4UnmonitoredAuto specifies the rolling upgrade mode 4
    // unmonitored auto state for rolling upgrade mode 4.
    RollingUpgradeMode4UnmonitoredAuto RollingUpgradeMode4 = "UnmonitoredAuto"
    // RollingUpgradeMode4UnmonitoredManual specifies the rolling upgrade mode
    // 4 unmonitored manual state for rolling upgrade mode 4.
...
const (
    // RollingUpgradeMode5Invalid specifies the rolling upgrade mode 5 invalid
    // state for rolling upgrade mode 5.
    RollingUpgradeMode5Invalid RollingUpgradeMode5 = "Invalid"
    // RollingUpgradeMode5Monitored specifies the rolling upgrade mode 5
    // monitored state for rolling upgrade mode 5.
    RollingUpgradeMode5Monitored RollingUpgradeMode5 = "Monitored"
    // RollingUpgradeMode5UnmonitoredAuto specifies the rolling upgrade mode 5
    // unmonitored auto state for rolling upgrade mode 5.
    RollingUpgradeMode5UnmonitoredAuto RollingUpgradeMode5 = "UnmonitoredAuto"
    // RollingUpgradeMode5UnmonitoredManual specifies the rolling upgrade mode
    // 5 unmonitored manual state for rolling upgrade mode 5.
    RollingUpgradeMode5UnmonitoredManual RollingUpgradeMode5 = "UnmonitoredManual"
)

// ServiceCorrelationScheme enumerates the values for service correlation
// scheme.
type ServiceCorrelationScheme string

const (
    // ServiceCorrelationSchemeAffinity specifies the service correlation
    // scheme affinity state for service correlation scheme.
    ServiceCorrelationSchemeAffinity ServiceCorrelationScheme = "Affinity"
    // ServiceCorrelationSchemeAlignedAffinity specifies the service
    // correlation scheme aligned affinity state for service correlation
    // scheme.
    ServiceCorrelationSchemeAlignedAffinity ServiceCorrelationScheme = "AlignedAffinity"
    // ServiceCorrelationSchemeInvalid specifies the service correlation scheme
    // invalid state for service correlation scheme.
    ServiceCorrelationSchemeInvalid ServiceCorrelationScheme = "Invalid"
    // ServiceCorrelationSchemeNonAlignedAffinity specifies the service
    // correlation scheme non aligned affinity state for service correlation
    // scheme.
...
const (
    // ServiceKindInvalid specifies the service kind invalid state for service
    // kind.
    ServiceKindInvalid ServiceKind = "Invalid"
    // ServiceKindStateful specifies the service kind stateful state for
    // service kind.
    ServiceKindStateful ServiceKind = "Stateful"
    // ServiceKindStateless specifies the service kind stateless state for
    // service kind.
...
const (
    // ServiceKind1Invalid specifies the service kind 1 invalid state for
    // service kind 1.
    ServiceKind1Invalid ServiceKind1 = "Invalid"
    // ServiceKind1Stateful specifies the service kind 1 stateful state for
    // service kind 1.
    ServiceKind1Stateful ServiceKind1 = "Stateful"
    // ServiceKind1Stateless specifies the service kind 1 stateless state for
    // service kind 1.
...
const (
    // ServiceKind2Invalid specifies the service kind 2 invalid state for
    // service kind 2.
    ServiceKind2Invalid ServiceKind2 = "Invalid"
    // ServiceKind2Stateful specifies the service kind 2 stateful state for
    // service kind 2.
    ServiceKind2Stateful ServiceKind2 = "Stateful"
    // ServiceKind2Stateless specifies the service kind 2 stateless state for
    // service kind 2.
...
const (
    // ServiceKind3Invalid specifies the service kind 3 invalid state for
    // service kind 3.
    ServiceKind3Invalid ServiceKind3 = "Invalid"
    // ServiceKind3Stateful specifies the service kind 3 stateful state for
    // service kind 3.
    ServiceKind3Stateful ServiceKind3 = "Stateful"
    // ServiceKind3Stateless specifies the service kind 3 stateless state for
    // service kind 3.
...
const (
    // ServiceKind4Invalid specifies the service kind 4 invalid state for
    // service kind 4.
    ServiceKind4Invalid ServiceKind4 = "Invalid"
    // ServiceKind4Stateful specifies the service kind 4 stateful state for
    // service kind 4.
    ServiceKind4Stateful ServiceKind4 = "Stateful"
    // ServiceKind4Stateless specifies the service kind 4 stateless state for
    // service kind 4.
...
const (
    // ServiceKind5Invalid specifies the service kind 5 invalid state for
    // service kind 5.
    ServiceKind5Invalid ServiceKind5 = "Invalid"
    // ServiceKind5Stateful specifies the service kind 5 stateful state for
    // service kind 5.
    ServiceKind5Stateful ServiceKind5 = "Stateful"
    // ServiceKind5Stateless specifies the service kind 5 stateless state for
    // service kind 5.
...
const (
    // ServiceKind6Invalid specifies the service kind 6 invalid state for
    // service kind 6.
    ServiceKind6Invalid ServiceKind6 = "Invalid"
    // ServiceKind6Stateful specifies the service kind 6 stateful state for
    // service kind 6.
    ServiceKind6Stateful ServiceKind6 = "Stateful"
    // ServiceKind6Stateless specifies the service kind 6 stateless state for
    // service kind 6.
    ServiceKind6Stateless ServiceKind6 = "Stateless"
)

// ServiceLoadMetricWeight enumerates the values for service load metric
// weight.
type ServiceLoadMetricWeight string

const (
    // ServiceLoadMetricWeightHigh specifies the service load metric weight
    // high state for service load metric weight.
    ServiceLoadMetricWeightHigh ServiceLoadMetricWeight = "High"
    // ServiceLoadMetricWeightLow specifies the service load metric weight low
    // state for service load metric weight.
    ServiceLoadMetricWeightLow ServiceLoadMetricWeight = "Low"
    // ServiceLoadMetricWeightMedium specifies the service load metric weight
    // medium state for service load metric weight.
    ServiceLoadMetricWeightMedium ServiceLoadMetricWeight = "Medium"
    // ServiceLoadMetricWeightZero specifies the service load metric weight
    // zero state for service load metric weight.
...
const (
    // ServicePartitionKindInt64Range specifies the service partition kind int
    // 64 range state for service partition kind.
    ServicePartitionKindInt64Range ServicePartitionKind = "Int64Range"
    // ServicePartitionKindInvalid specifies the service partition kind invalid
    // state for service partition kind.
    ServicePartitionKindInvalid ServicePartitionKind = "Invalid"
    // ServicePartitionKindNamed specifies the service partition kind named
    // state for service partition kind.
    ServicePartitionKindNamed ServicePartitionKind = "Named"
    // ServicePartitionKindSingleton specifies the service partition kind
    // singleton state for service partition kind.
...
const (
    // ServiceStatusActive specifies the service status active state for
    // service status.
    ServiceStatusActive ServiceStatus = "Active"
    // ServiceStatusCreating specifies the service status creating state for
    // service status.
    ...
    // ServiceStatusFaile specifies the service status faile state for service
    // status.
    ServiceStatusFaile ServiceStatus = "Faile"
    // ServiceStatusInvalid specifies the service status invalid state for
    // service status.
    ServiceStatusInvalid ServiceStatus = "Invalid"
    // ServiceStatusUpgrading specifies the service status upgrading state for
    // service status.
...
const (
    // UpgradeKindInvalid specifies the upgrade kind invalid state for upgrade
    // kind.
    UpgradeKindInvalid UpgradeKind = "Invalid"
    // UpgradeKindRolling specifies the upgrade kind rolling state for upgrade
    // kind.
...
const (
    // UpgradeStateInvalid specifies the upgrade state invalid state for
    // upgrade state.
    UpgradeStateInvalid UpgradeState = "Invalid"
    // UpgradeStateRollingBackCompleted specifies the upgrade state rolling
    // back completed state for upgrade state.
    UpgradeStateRollingBackCompleted UpgradeState = "RollingBackCompleted"
    // UpgradeStateRollingBackInProgress specifies the upgrade state rolling
    // back in progress state for upgrade state.
    UpgradeStateRollingBackInProgress UpgradeState = "RollingBackInProgress"
    // UpgradeStateRollingForwardCompleted specifies the upgrade state rolling
    // forward completed state for upgrade state.
    UpgradeStateRollingForwardCompleted UpgradeState = "RollingForwardCompleted"
    // UpgradeStateRollingForwardInProgress specifies the upgrade state rolling
    // forward in progress state for upgrade state.
    UpgradeStateRollingForwardInProgress UpgradeState = "RollingForwardInProgress"
    // UpgradeStateRollingForwardPending specifies the upgrade state rolling
    // forward pending state for upgrade state.
...
const (
    // UpgradeState1Invalid specifies the upgrade state 1 invalid state for
    // upgrade state 1.
    UpgradeState1Invalid UpgradeState1 = "Invalid"
    // UpgradeState1RollingBackCompleted specifies the upgrade state 1 rolling
    // back completed state for upgrade state 1.
    UpgradeState1RollingBackCompleted UpgradeState1 = "RollingBackCompleted"
    // UpgradeState1RollingBackInProgress specifies the upgrade state 1 rolling
    // back in progress state for upgrade state 1.
    UpgradeState1RollingBackInProgress UpgradeState1 = "RollingBackInProgress"
    // UpgradeState1RollingForwardCompleted specifies the upgrade state 1
    // rolling forward completed state for upgrade state 1.
    UpgradeState1RollingForwardCompleted UpgradeState1 = "RollingForwardCompleted"
    // UpgradeState1RollingForwardInProgress specifies the upgrade state 1
    // rolling forward in progress state for upgrade state 1.
    UpgradeState1RollingForwardInProgress UpgradeState1 = "RollingForwardInProgress"
    // UpgradeState1RollingForwardPending specifies the upgrade state 1 rolling
    // forward pending state for upgrade state 1.
...
// ApplicationHealthDeployedApplicationHealthStatesItem is the states of the
...
// ApplicationHealthPolicyDefaultServiceTypeHealthPolicy is the policy of the
...
// ApplicationTypeHealthEvaluation is the evaluation of the application type
// health
...
// ApplicationUpgradeCurrentUpgradeDomainProgress is the progress of the
...
// ApplicationUpgradeDeployedApplicationHealthStates is the states of the
// deployed application health
...
// ClusterHealthApplicationHealthStateItem is the state of the application
// health
...
// ClusterUpgradeProgressCurrentUpgradeDomainProgress is the progress of the
// current upgrade domain
...
// ClusterUpgradeProgressUpgradeDomainProgressAtFailure is the failure of the
...
// CodePackageEntryPointStatistics is the statistics of the code package entry
// point
...
// DeltaNodesCheckHealthEvaluation is the evaluation of the delta nodes check
// health
...
// DeployedApplicationHealthEvaluation is the evaluation of the deployed
// application health
...
// DeployedApplicationHealthReport is the report of the deployed application
// health
...
// DeployedApplicationsHealthEvaluation is the evaluation of the deployed
// applications health
...
// DeployedReplicaDetailReplicatorStatusReplicationQueueStatus is the status of
...
// DeployedServiceHealthReport is the report of the deployed service package
// health
...
// DeployedServicePackageHealthEvaluation is the evaluation of the deployed
...
// DeployedServicePackageHealthState is the state of the deployed service
// package health
...
// DeployedServicePackagesHealthEvaluation is the evaluation of the deployed
...
// ServicePlacementPolicyDescription is the description of the service
// placement policy
...
// StatefulCreateServiceDescription is the description of the stateful create
// service
...
// StatefulCreateServiceGroupDescription is the description of the stateful
...
// StatefulServiceGroupDescription is the description of the stateful service
// group
...
// StatefulUpdateServiceDescription is the description of the stateful update
// service
...
// StatefulUpdateServiceGroupDescription is the description of the stateful
...
// StatelessCreateServiceDescription is the description of the stateless create
// service
...
// StatelessCreateServiceGroupDescription is the description of the stateless
// create service group
...
// StatelessServiceGroupDescription is the description of the stateless service
// group
...
// StatelessUpdateServiceDescription is the description of the stateless update
// service
...
// StatelessUpdateServiceGroupDescription is the description of the stateless
// update service group
...
// SystemApplicationHealthEvaluation is the evaluation of the system
// application health
...
// UpdateApplicationUpgrade is the description of the update application
// upgrade
...
// UpgradeDomainDeltaNodesCheckHealthEvaluation is the evaluation of the
// upgrade domain delta nodes check health
...
// UpgradeDomainDeployedApplicationsHealthEvaluation is the evaluation of the
// upgrade domain deployed applications health
...
// UpgradeDomainNodesHealthEvaluation is the evaluation of the upgrade domain
// nodes health
