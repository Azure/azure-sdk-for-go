...
// NodeHealthsClient is the client for the NodeHealths methods of the
...
// NewNodeHealthsClientWithBaseURI creates an instance of the NodeHealthsClient
// client.
...
//
// nodeName is the name of the node eventsHealthStateFilter is the filter of
...
//
// nodeName is the name of the node nodeHealthReport is the report of the node
// health
