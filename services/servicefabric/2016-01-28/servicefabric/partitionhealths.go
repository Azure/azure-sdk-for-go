...
// PartitionHealthsClient is the client for the PartitionHealths methods of the
// Servicefabric service.
type PartitionHealthsClient struct {
	ManagementClient
}

// NewPartitionHealthsClient creates an instance of the PartitionHealthsClient
// client.
...
// NewPartitionHealthsClientWithBaseURI creates an instance of the
// PartitionHealthsClient client.
...
//
// partitionID is the id of the partition eventsHealthStateFilter is the filter
// of the events health state replicasHealthStateFilter is the filter of the
...
//
// partitionID is the id of the partition partitionHealthReport is the report
// of the partition health
