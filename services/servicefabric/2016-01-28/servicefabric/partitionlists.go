...
// PartitionListsClient is the client for the PartitionLists methods of the
// Servicefabric service.
type PartitionListsClient struct {
	ManagementClient
}

// NewPartitionListsClient creates an instance of the PartitionListsClient
// client.
...
// NewPartitionListsClientWithBaseURI creates an instance of the
// PartitionListsClient client.
