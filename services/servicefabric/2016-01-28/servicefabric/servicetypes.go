...
// ServiceTypesClient is the client for the ServiceTypes methods of the
...
// NewServiceTypesClientWithBaseURI creates an instance of the
// ServiceTypesClient client.
