...
// the 'fabric:' URI scheme. Starting from version 6.0, hierarchical names are delimited with the "~"
// character. For example, if the application name is "fabric://myapp/app1", the application identity would be
...
// 'fabric:' URI scheme. Starting from version 6.0, hierarchical names are delimited with the "~" character.
...
// Parameters:
// applicationDefinitionKindFilter - used to filter on ApplicationDefinitionKind for application query
// operations.
...
// Parameters:
// applicationTypeDefinitionKindFilter - used to filter on ApplicationTypeDefinitionKind for application type
// query operations.
// - Default - Default value, which performs the same function as selecting "All". The value is 0.
