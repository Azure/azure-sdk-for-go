...
import (
	"context"
	"github.com/Azure/azure-sdk-for-go/services/servicefabric/6.4/servicefabric"
...
type BaseClientAPI interface {
	...
	DisableApplicationBackup(ctx context.Context, applicationID string, timeout *int64, disableBackupDescription *servicefabric.DisableBackupDescription) (result autorest.Response, err error)
	...
	DisablePartitionBackup(ctx context.Context, partitionID uuid.UUID, disableBackupDescription *servicefabric.DisableBackupDescription, timeout *int64) (result autorest.Response, err error)
	DisableServiceBackup(ctx context.Context, serviceID string, disableBackupDescription *servicefabric.DisableBackupDescription, timeout *int64) (result autorest.Response, err error)
	...
	GetClusterVersion(ctx context.Context, timeout *int64) (result servicefabric.ClusterVersion, err error)
	...
	StartRollbackComposeDeploymentUpgrade(ctx context.Context, deploymentName string, timeout *int64) (result autorest.Response, err error)
...
// MeshSecretClientAPI contains the set of methods on the MeshSecretClient type.
type MeshSecretClientAPI interface {
	CreateOrUpdate(ctx context.Context, secretResourceName string, secretResourceDescription servicefabric.SecretResourceDescription) (result servicefabric.SecretResourceDescription, err error)
	Delete(ctx context.Context, secretResourceName string) (result autorest.Response, err error)
	Get(ctx context.Context, secretResourceName string) (result servicefabric.SecretResourceDescription, err error)
	List(ctx context.Context) (result servicefabric.PagedSecretResourceDescriptionList, err error)
}

var _ MeshSecretClientAPI = (*servicefabric.MeshSecretClient)(nil)

// MeshSecretValueClientAPI contains the set of methods on the MeshSecretValueClient type.
type MeshSecretValueClientAPI interface {
	AddValue(ctx context.Context, secretResourceName string, secretValueResourceName string, secretValueResourceDescription servicefabric.SecretValueResourceDescription) (result servicefabric.SecretValueResourceDescription, err error)
	Delete(ctx context.Context, secretResourceName string, secretValueResourceName string) (result autorest.Response, err error)
	Get(ctx context.Context, secretResourceName string, secretValueResourceName string) (result servicefabric.SecretValueResourceDescription, err error)
	List(ctx context.Context, secretResourceName string) (result servicefabric.PagedSecretValueResourceDescriptionList, err error)
	Show(ctx context.Context, secretResourceName string, secretValueResourceName string) (result servicefabric.SecretValue, err error)
}

var _ MeshSecretValueClientAPI = (*servicefabric.MeshSecretValueClient)(nil)

// MeshVolumeClientAPI contains the set of methods on the MeshVolumeClient type.
type MeshVolumeClientAPI interface {
	CreateOrUpdate(ctx context.Context, volumeResourceName string, volumeResourceDescription servicefabric.VolumeResourceDescription) (result servicefabric.VolumeResourceDescription, err error)
	Delete(ctx context.Context, volumeResourceName string) (result autorest.Response, err error)
	Get(ctx context.Context, volumeResourceName string) (result servicefabric.VolumeResourceDescription, err error)
	List(ctx context.Context) (result servicefabric.PagedVolumeResourceDescriptionList, err error)
}

var _ MeshVolumeClientAPI = (*servicefabric.MeshVolumeClient)(nil)

// MeshNetworkClientAPI contains the set of methods on the MeshNetworkClient type.
type MeshNetworkClientAPI interface {
	CreateOrUpdate(ctx context.Context, networkResourceName string, networkResourceDescription servicefabric.NetworkResourceDescription) (result servicefabric.NetworkResourceDescription, err error)
	Delete(ctx context.Context, networkResourceName string) (result autorest.Response, err error)
	Get(ctx context.Context, networkResourceName string) (result servicefabric.NetworkResourceDescription, err error)
	List(ctx context.Context) (result servicefabric.PagedNetworkResourceDescriptionList, err error)
}

var _ MeshNetworkClientAPI = (*servicefabric.MeshNetworkClient)(nil)

// MeshApplicationClientAPI contains the set of methods on the MeshApplicationClient type.
type MeshApplicationClientAPI interface {
	CreateOrUpdate(ctx context.Context, applicationResourceName string, applicationResourceDescription servicefabric.ApplicationResourceDescription) (result servicefabric.ApplicationResourceDescription, err error)
	Delete(ctx context.Context, applicationResourceName string) (result autorest.Response, err error)
	Get(ctx context.Context, applicationResourceName string) (result servicefabric.ApplicationResourceDescription, err error)
	List(ctx context.Context) (result servicefabric.PagedApplicationResourceDescriptionList, err error)
}

var _ MeshApplicationClientAPI = (*servicefabric.MeshApplicationClient)(nil)

// MeshServiceClientAPI contains the set of methods on the MeshServiceClient type.
type MeshServiceClientAPI interface {
	Get(ctx context.Context, applicationResourceName string, serviceResourceName string) (result servicefabric.ServiceResourceDescription, err error)
	List(ctx context.Context, applicationResourceName string) (result servicefabric.PagedServiceResourceDescriptionList, err error)
}

var _ MeshServiceClientAPI = (*servicefabric.MeshServiceClient)(nil)

// MeshCodePackageClientAPI contains the set of methods on the MeshCodePackageClient type.
type MeshCodePackageClientAPI interface {
	GetContainerLogs(ctx context.Context, applicationResourceName string, serviceResourceName string, replicaName string, codePackageName string, tail string) (result servicefabric.ContainerLogs, err error)
}

var _ MeshCodePackageClientAPI = (*servicefabric.MeshCodePackageClient)(nil)

// MeshServiceReplicaClientAPI contains the set of methods on the MeshServiceReplicaClient type.
type MeshServiceReplicaClientAPI interface {
	Get(ctx context.Context, applicationResourceName string, serviceResourceName string, replicaName string) (result servicefabric.ServiceReplicaDescription, err error)
	List(ctx context.Context, applicationResourceName string, serviceResourceName string) (result servicefabric.PagedServiceReplicaDescriptionList, err error)
}

var _ MeshServiceReplicaClientAPI = (*servicefabric.MeshServiceReplicaClient)(nil)

// MeshGatewayClientAPI contains the set of methods on the MeshGatewayClient type.
type MeshGatewayClientAPI interface {
	CreateOrUpdate(ctx context.Context, gatewayResourceName string, gatewayResourceDescription servicefabric.GatewayResourceDescription) (result servicefabric.GatewayResourceDescription, err error)
	Delete(ctx context.Context, gatewayResourceName string) (result autorest.Response, err error)
	Get(ctx context.Context, gatewayResourceName string) (result servicefabric.GatewayResourceDescription, err error)
	List(ctx context.Context) (result servicefabric.PagedGatewayResourceDescriptionList, err error)
}

var _ MeshGatewayClientAPI = (*servicefabric.MeshGatewayClient)(nil)
