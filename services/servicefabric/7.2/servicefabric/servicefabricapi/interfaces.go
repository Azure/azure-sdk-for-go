...
type BaseClientAPI interface {
	...
	UpdatePartitionLoad(ctx context.Context, partitionMetricLoadDescriptionList []servicefabric.PartitionMetricLoadDescription, continuationToken string, maxResults *int64, timeout *int64) (result servicefabric.PagedUpdatePartitionLoadResultList, err error)
