...
func NewApplicationsClient() ApplicationsClient {
	return NewApplicationsClientWithBaseURI(DefaultBaseURI)
}
...
func NewApplicationsClientWithBaseURI(baseURI string) ApplicationsClient {
	return ApplicationsClient{NewWithBaseURI(baseURI)}
}
...
func (client ApplicationsClient) Create(ctx context.Context, subscriptionID string, resourceGroupName string, clusterName string, applicationName string, parameters ApplicationResource) (result ApplicationsCreateFuture, err error) {
	req, err := client.CreatePreparer(ctx, subscriptionID, resourceGroupName, clusterName, applicationName, parameters)
	if err != nil {
...
func (client ApplicationsClient) CreatePreparer(ctx context.Context, subscriptionID string, resourceGroupName string, clusterName string, applicationName string, parameters ApplicationResource) (*http.Request, error) {
...
// subscriptionID is the customer subscription identifier. resourceGroupName is the name of the resource group.
// clusterName is the name of the cluster resource. applicationName is the name of the application resource.
func (client ApplicationsClient) Delete(ctx context.Context, subscriptionID string, resourceGroupName string, clusterName string, applicationName string) (result ApplicationsDeleteFuture, err error) {
...
func (client ApplicationsClient) DeletePreparer(ctx context.Context, subscriptionID string, resourceGroupName string, clusterName string, applicationName string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"applicationName":   autorest.Encode("path", applicationName),
		"clusterName":       autorest.Encode("path", clusterName),
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
...
// subscriptionID is the customer subscription identifier. resourceGroupName is the name of the resource group.
// clusterName is the name of the cluster resource. applicationName is the name of the application resource.
func (client ApplicationsClient) Get(ctx context.Context, subscriptionID string, resourceGroupName string, clusterName string, applicationName string) (result ApplicationResource, err error) {
...
func (client ApplicationsClient) GetPreparer(ctx context.Context, subscriptionID string, resourceGroupName string, clusterName string, applicationName string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"applicationName":   autorest.Encode("path", applicationName),
		"clusterName":       autorest.Encode("path", clusterName),
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
...
func (client ApplicationsClient) List(ctx context.Context, subscriptionID string, resourceGroupName string, clusterName string) (result ApplicationResourceList, err error) {
...
func (client ApplicationsClient) ListPreparer(ctx context.Context, subscriptionID string, resourceGroupName string, clusterName string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"clusterName":       autorest.Encode("path", clusterName),
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"subscriptionId":    autorest.Encode("path", subscriptionID),
...
func (client ApplicationsClient) Update(ctx context.Context, subscriptionID string, resourceGroupName string, clusterName string, applicationName string, parameters ApplicationResourceUpdate) (result ApplicationsUpdateFuture, err error) {
	req, err := client.UpdatePreparer(ctx, subscriptionID, resourceGroupName, clusterName, applicationName, parameters)
	if err != nil {
...
func (client ApplicationsClient) UpdatePreparer(ctx context.Context, subscriptionID string, resourceGroupName string, clusterName string, applicationName string, parameters ApplicationResourceUpdate) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"applicationName":   autorest.Encode("path", applicationName),
		"clusterName":       autorest.Encode("path", clusterName),
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
