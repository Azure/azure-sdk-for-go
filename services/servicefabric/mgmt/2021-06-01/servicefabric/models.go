...
type CertificateDescription struct {
	...
	// X509StoreName - Possible values include: 'AddressBook', 'AuthRoot', 'CertificateAuthority', 'Disallowed', 'My', 'Root', 'TrustedPeople', 'TrustedPublisher'
...
type ClusterProperties struct {
	...
	// ClusterState - READ-ONLY; Possible values include: 'WaitingForNodes', 'Deploying', 'BaselineUpgrade', 'UpdatingUserConfiguration', 'UpdatingUserCertificate', 'UpdatingInfrastructure', 'EnforcingClusterVersion', 'UpgradeServiceUnreachable', 'AutoScale', 'Ready'
	...
	// SfZonalUpgradeMode - Possible values include: 'Parallel', 'Hierarchical'
	...
	// UpgradeWave - Indicates when new cluster runtime version upgrades will be applied after they are released. By default is Wave0. Only applies when **upgradeMode** is set to 'Automatic'. Possible values include: 'Wave0', 'Wave1', 'Wave2'
...
type ManagedIdentity struct {
	...
	TenantID *string `json:"tenantId,omitempty"`
	// Type - Possible values include: 'SystemAssigned', 'UserAssigned', 'SystemAssignedUserAssigned', 'None'
...
type Notification struct {
	...
	// NotificationLevel - The level of notification. Possible values include: 'Critical', 'All'
...
type NotificationTarget struct {
	// NotificationChannel - The notification channel indicates the type of receivers subscribed to the notification, either user or subscription. Possible values include: 'EmailUser', 'EmailSubscription'
