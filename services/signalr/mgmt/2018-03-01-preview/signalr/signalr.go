...
// the Azure Resource Manager API or the portal. resourceName is the name of the SignalR resource. parameters is
...
//
// resourceGroupName is the name of the resource group that contains the resource. You can obtain this value from
// the Azure Resource Manager API or the portal. resourceName is the name of the SignalR resource.
...
// ListOperations lists all of the available REST API operations of the Microsoft.SignalRService provider.
func (client Client) ListOperations(ctx context.Context) (result OperationListPage, err error) {
	...
	result.ol, err = client.ListOperationsResponder(resp)
	if err != nil {
...
// closes the http.Response Body.
func (client Client) ListOperationsResponder(resp *http.Response) (result OperationList, err error) {
	err = autorest.Respond(
		resp,
		client.ByInspecting(),
		azure.WithErrorUnlessStatusCode(http.StatusOK),
...
func (client Client) listOperationsNextResults(lastResults OperationList) (result OperationList, err error) {
	req, err := lastResults.operationListPreparer()
	if err != nil {
		return result, autorest.NewErrorWithError(err, "signalr.Client", "listOperationsNextResults", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "signalr.Client", "listOperationsNextResults", resp, "Failure sending next results request")
	}
	result, err = client.ListOperationsResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "signalr.Client", "listOperationsNextResults", resp, "Failure responding to next results request")
	}
	return
}

// ListOperationsComplete enumerates all values, automatically crossing page boundaries as required.
func (client Client) ListOperationsComplete(ctx context.Context) (result OperationListIterator, err error) {
