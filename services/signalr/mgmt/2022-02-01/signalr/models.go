...
type Feature struct {
	// Flag - Possible values include: 'FeatureFlagsServiceMode', 'FeatureFlagsEnableConnectivityLogs', 'FeatureFlagsEnableMessagingLogs', 'FeatureFlagsEnableLiveTrace'
...
type ResourceType struct {
	...
	*Properties       `json:"properties,omitempty"`
	// Kind - Possible values include: 'ServiceKindSignalR', 'ServiceKindRawWebSockets'
