...
// CustomCertificatesClientAPI contains the set of methods on the CustomCertificatesClient type.
type CustomCertificatesClientAPI interface {
	CreateOrUpdate(ctx context.Context, resourceGroupName string, resourceName string, certificateName string, parameters signalr.CustomCertificate) (result signalr.CustomCertificatesCreateOrUpdateFuture, err error)
	Delete(ctx context.Context, resourceGroupName string, resourceName string, certificateName string) (result autorest.Response, err error)
	Get(ctx context.Context, resourceGroupName string, resourceName string, certificateName string) (result signalr.CustomCertificate, err error)
	List(ctx context.Context, resourceGroupName string, resourceName string) (result signalr.CustomCertificateListPage, err error)
	ListComplete(ctx context.Context, resourceGroupName string, resourceName string) (result signalr.CustomCertificateListIterator, err error)
}

var _ CustomCertificatesClientAPI = (*signalr.CustomCertificatesClient)(nil)

// CustomDomainsClientAPI contains the set of methods on the CustomDomainsClient type.
type CustomDomainsClientAPI interface {
	CreateOrUpdate(ctx context.Context, resourceGroupName string, resourceName string, name string, parameters signalr.CustomDomain) (result signalr.CustomDomainsCreateOrUpdateFuture, err error)
	Delete(ctx context.Context, resourceGroupName string, resourceName string, name string) (result signalr.CustomDomainsDeleteFuture, err error)
	Get(ctx context.Context, resourceGroupName string, resourceName string, name string) (result signalr.CustomDomain, err error)
	List(ctx context.Context, resourceGroupName string, resourceName string) (result signalr.CustomDomainListPage, err error)
	ListComplete(ctx context.Context, resourceGroupName string, resourceName string) (result signalr.CustomDomainListIterator, err error)
}

var _ CustomDomainsClientAPI = (*signalr.CustomDomainsClient)(nil)
