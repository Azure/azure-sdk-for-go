...
// OperationsClient is the azure software plans let users create and manage licenses for various software used in
// Azure.
...
func (client OperationsClient) List(ctx context.Context, scope string) (result OperationListPage, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "softwareplan.OperationsClient", "List", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "softwareplan.OperationsClient", "List", resp, "Failure sending request")
		return
	}

	result.ol, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "softwareplan.OperationsClient", "List", resp, "Failure responding to request")
		return
	}
...
func (client OperationsClient) ListPreparer(ctx context.Context, scope string) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithPathParameters("/{scope}/providers/Microsoft.SoftwarePlan/operations", pathParameters),
...
func (client OperationsClient) listNextResults(ctx context.Context, lastResults OperationList) (result OperationList, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "softwareplan.OperationsClient", "listNextResults", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "softwareplan.OperationsClient", "listNextResults", resp, "Failure sending next results request")
	}
	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "softwareplan.OperationsClient", "listNextResults", resp, "Failure responding to next results request")
	}
	return
}
