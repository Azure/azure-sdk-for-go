...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/solutions/mgmt/2018-02-01/managedapplications"
...
type ApplicationProperties struct {
	...
	// PublisherPackageID - The publisher package Id.
	PublisherPackageID *string `json:"publisherPackageId,omitempty"`
...
func (ap ApplicationProperties) MarshalJSON() ([]byte, error) {
	...
	if ap.PublisherPackageID != nil {
		objectMap["publisherPackageId"] = ap.PublisherPackageID
	}
