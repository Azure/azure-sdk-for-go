...
// CreateOrUpdate creates or update a managed application definition.
// Parameters:
...
func (client ApplicationDefinitionsClient) CreateOrUpdate(ctx context.Context, resourceGroupName string, applicationDefinitionName string, parameters ApplicationDefinition) (result ApplicationDefinition, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		{TargetValue: parameters,
			Constraints: []validation.Constraint{{Target: "parameters.ApplicationDefinitionProperties", Name: validation.Null, Rule: true, Chain: nil}}}}); err != nil {
