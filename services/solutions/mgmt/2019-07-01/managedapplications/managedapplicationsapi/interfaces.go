...
type ApplicationsClientAPI interface {
	...
	ListAllowedUpgradePlans(ctx context.Context, resourceGroupName string, applicationName string) (result managedapplications.AllowedUpgradePlansResult, err error)
