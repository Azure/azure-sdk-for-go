...
// database. dataWarehouseUserActivityName is the activity name of the data warehouse.
func (client DataWarehouseUserActivitiesClient) Get(ctx context.Context, resourceGroupName string, serverName string, databaseName string, dataWarehouseUserActivityName string) (result DataWarehouseUserActivities, err error) {
	req, err := client.GetPreparer(ctx, resourceGroupName, serverName, databaseName, dataWarehouseUserActivityName)
	if err != nil {
...
func (client DataWarehouseUserActivitiesClient) GetPreparer(ctx context.Context, resourceGroupName string, serverName string, databaseName string, dataWarehouseUserActivityName string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"databaseName":                  autorest.Encode("path", databaseName),
		"dataWarehouseUserActivityName": autorest.Encode("path", dataWarehouseUserActivityName),
