...
// agent. credentialName is the name of the credential. parameters is the requested job credential state.
func (client JobCredentialsClient) CreateOrUpdate(ctx context.Context, resourceGroupName string, serverName string, jobAgentName string, credentialName string, parameters JobCredential) (result JobCredential, err error) {
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewErrorWithValidationError(err, "sql.JobCredentialsClient", "CreateOrUpdate")
	}
...
// resourceGroupName is the name of the resource group that contains the resource. You can obtain this value from the
// Azure Resource Manager API or the portal. serverName is the name of the server. jobAgentName is the name of the job
// agent. credentialName is the name of the credential.
