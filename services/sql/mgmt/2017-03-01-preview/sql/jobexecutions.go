...
// agent. jobName is the name of the job. jobExecutionID is the id of the job execution to cancel.
...
// resourceGroupName is the name of the resource group that contains the resource. You can obtain this value from the
// Azure Resource Manager API or the portal. serverName is the name of the server. jobAgentName is the name of the job
// agent. jobName is the name of the job to get. jobExecutionID is the job execution id to create the job execution
// under.
...
// resourceGroupName is the name of the resource group that contains the resource. You can obtain this value from the
// Azure Resource Manager API or the portal. serverName is the name of the server. jobAgentName is the name of the job
// agent. jobName is the name of the job. jobExecutionID is the id of the job execution
...
// resourceGroupName is the name of the resource group that contains the resource. You can obtain this value from the
// Azure Resource Manager API or the portal. serverName is the name of the server. jobAgentName is the name of the job
// agent. skip is the number of elements in the collection to skip.
func (client JobExecutionsClient) ListByAgent(ctx context.Context, resourceGroupName string, serverName string, jobAgentName string, skip string) (result JobExecutionListResultPage, err error) {
	result.fn = client.listByAgentNextResults
	req, err := client.ListByAgentPreparer(ctx, resourceGroupName, serverName, jobAgentName, skip)
	if err != nil {
...
func (client JobExecutionsClient) ListByAgentPreparer(ctx context.Context, resourceGroupName string, serverName string, jobAgentName string, skip string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"jobAgentName":      autorest.Encode("path", jobAgentName),
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"serverName":        autorest.Encode("path", serverName),
...
func (client JobExecutionsClient) ListByAgentComplete(ctx context.Context, resourceGroupName string, serverName string, jobAgentName string, skip string) (result JobExecutionListResultIterator, err error) {
	result.page, err = client.ListByAgent(ctx, resourceGroupName, serverName, jobAgentName, skip)
	return
}
...
// resourceGroupName is the name of the resource group that contains the resource. You can obtain this value from the
// Azure Resource Manager API or the portal. serverName is the name of the server. jobAgentName is the name of the job
// agent. jobName is the name of the job to get. skip is the number of elements in the collection to skip.
func (client JobExecutionsClient) ListByJob(ctx context.Context, resourceGroupName string, serverName string, jobAgentName string, jobName string, skip string) (result JobExecutionListResultPage, err error) {
	result.fn = client.listByJobNextResults
	req, err := client.ListByJobPreparer(ctx, resourceGroupName, serverName, jobAgentName, jobName, skip)
	if err != nil {
...
func (client JobExecutionsClient) ListByJobPreparer(ctx context.Context, resourceGroupName string, serverName string, jobAgentName string, jobName string, skip string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"jobAgentName":      autorest.Encode("path", jobAgentName),
		"jobName":           autorest.Encode("path", jobName),
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
...
func (client JobExecutionsClient) ListByJobComplete(ctx context.Context, resourceGroupName string, serverName string, jobAgentName string, jobName string, skip string) (result JobExecutionListResultIterator, err error) {
	result.page, err = client.ListByJob(ctx, resourceGroupName, serverName, jobAgentName, jobName, skip)
	return
}
