...
// agent. jobName is the name of the job. stepName is the name of the job step. parameters is the requested state of
// the job step.
			...
			Constraints: []validation.Constraint{{Target: "parameters.JobStepProperties", Name: validation.Null, Rule: false,
				Chain: []validation.Constraint{{Target: "parameters.JobStepProperties.TargetGroup", Name: validation.Null, Rule: true, Chain: nil},
					...
					{Target: "parameters.JobStepProperties.Output", Name: validation.Null, Rule: false,
						Chain: []validation.Constraint{{Target: "parameters.JobStepProperties.Output.Server", Name: validation.Null, Rule: true, Chain: nil},
							{Target: "parameters.JobStepProperties.Output.Database", Name: validation.Null, Rule: true, Chain: nil},
							{Target: "parameters.JobStepProperties.Output.Table", Name: validation.Null, Rule: true, Chain: nil},
							{Target: "parameters.JobStepProperties.Output.Credential", Name: validation.Null, Rule: true, Chain: nil},
						}},
				}}}}}); err != nil {
		return result, validation.NewErrorWithValidationError(err, "sql.JobStepsClient", "CreateOrUpdate")
	}
...
// resourceGroupName is the name of the resource group that contains the resource. You can obtain this value from the
// Azure Resource Manager API or the portal. serverName is the name of the server. jobAgentName is the name of the job
// agent. jobName is the name of the job. stepName is the name of the job step to delete.
...
// resourceGroupName is the name of the resource group that contains the resource. You can obtain this value from the
// Azure Resource Manager API or the portal. serverName is the name of the server. jobAgentName is the name of the job
// agent. jobName is the name of the job. stepName is the name of the job step.
...
// resourceGroupName is the name of the resource group that contains the resource. You can obtain this value from the
// Azure Resource Manager API or the portal. serverName is the name of the server. jobAgentName is the name of the job
// agent. jobName is the name of the job. jobVersion is the version of the job to get. stepName is the name of the job
// step.
...
// resourceGroupName is the name of the resource group that contains the resource. You can obtain this value from the
// Azure Resource Manager API or the portal. serverName is the name of the server. jobAgentName is the name of the job
// agent. jobName is the name of the job to get. jobVersion is the version of the job to get.
