...
func (dwua *DataWarehouseUserActivities) UnmarshalJSON(body []byte) error {
	...
	v = m["properties"]
	if v != nil {
		var properties DataWarehouseUserActivitiesProperties
		err = json.Unmarshal(*m["properties"], &properties)
		if err != nil {
			return err
		}
		dwua.DataWarehouseUserActivitiesProperties = &properties
	}
...
// running or suspended queries. For more information, please view the sys.dm_pdw_exec_requests dynamic management view
// (DMV).
