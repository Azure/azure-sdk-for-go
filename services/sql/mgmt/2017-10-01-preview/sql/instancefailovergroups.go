...
// the Azure Resource Manager API or the portal. locationName is the name of the region where the resource is
// located. failoverGroupName is the name of the failover group. parameters is the failover group parameters.
...
// resourceGroupName is the name of the resource group that contains the resource. You can obtain this value from
// the Azure Resource Manager API or the portal. locationName is the name of the region where the resource is
// located. failoverGroupName is the name of the failover group.
