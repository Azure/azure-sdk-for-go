...
// RestorableDroppedDatabaseShortTermRetentionPoliciesCreateOrUpdateFuture an abstraction for monitoring and
// retrieving the results of a long-running operation.
type RestorableDroppedDatabaseShortTermRetentionPoliciesCreateOrUpdateFuture struct {
	azure.Future
	req *http.Request
}
...
func (future RestorableDroppedDatabaseShortTermRetentionPoliciesCreateOrUpdateFuture) Result(client RestorableDroppedDatabaseShortTermRetentionPoliciesClient) (strp ShortTermRetentionPolicy, err error) {
	var done bool
	done, err = future.Done(client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "sql.RestorableDroppedDatabaseShortTermRetentionPoliciesCreateOrUpdateFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		return strp, azure.NewAsyncOpIncompleteError("sql.RestorableDroppedDatabaseShortTermRetentionPoliciesCreateOrUpdateFuture")
	}
	if future.PollingMethod() == azure.PollingLocation {
		strp, err = client.CreateOrUpdateResponder(future.Response())
		if err != nil {
			err = autorest.NewErrorWithError(err, "sql.RestorableDroppedDatabaseShortTermRetentionPoliciesCreateOrUpdateFuture", "Result", future.Response(), "Failure responding to request")
		}
		return
	}
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "sql.RestorableDroppedDatabaseShortTermRetentionPoliciesCreateOrUpdateFuture", "Result", resp, "Failure sending request")
		return
	}
	strp, err = client.CreateOrUpdateResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "sql.RestorableDroppedDatabaseShortTermRetentionPoliciesCreateOrUpdateFuture", "Result", resp, "Failure responding to request")
	}
	return
}

// RestorableDroppedDatabaseShortTermRetentionPoliciesUpdateFuture an abstraction for monitoring and retrieving the
// results of a long-running operation.
type RestorableDroppedDatabaseShortTermRetentionPoliciesUpdateFuture struct {
	azure.Future
	req *http.Request
}
...
// Result returns the result of the asynchronous operation.
// If the operation has not completed it will return an error.
func (future RestorableDroppedDatabaseShortTermRetentionPoliciesUpdateFuture) Result(client RestorableDroppedDatabaseShortTermRetentionPoliciesClient) (strp ShortTermRetentionPolicy, err error) {
	var done bool
	done, err = future.Done(client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "sql.RestorableDroppedDatabaseShortTermRetentionPoliciesUpdateFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		return strp, azure.NewAsyncOpIncompleteError("sql.RestorableDroppedDatabaseShortTermRetentionPoliciesUpdateFuture")
	}
	if future.PollingMethod() == azure.PollingLocation {
		strp, err = client.UpdateResponder(future.Response())
		if err != nil {
			err = autorest.NewErrorWithError(err, "sql.RestorableDroppedDatabaseShortTermRetentionPoliciesUpdateFuture", "Result", future.Response(), "Failure responding to request")
		}
		return
	}
	var req *http.Request
	...
	resp, err = autorest.SendWithSender(client, req,
		autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if err != nil {
		err = autorest.NewErrorWithError(err, "sql.RestorableDroppedDatabaseShortTermRetentionPoliciesUpdateFuture", "Result", resp, "Failure sending request")
		return
	}
	strp, err = client.UpdateResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "sql.RestorableDroppedDatabaseShortTermRetentionPoliciesUpdateFuture", "Result", resp, "Failure responding to request")
	}
	return
}
