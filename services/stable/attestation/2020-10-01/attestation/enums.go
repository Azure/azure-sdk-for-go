...
// SevSnpReportType enumerates the values for sev snp report type.
type SevSnpReportType string

const (
	// HclHyperV SEV SNP report generated by HCL running on HyperV platform
	HclHyperV SevSnpReportType = "HclHyperV"
)

// PossibleSevSnpReportTypeValues returns an array of possible values for the SevSnpReportType const type.
func PossibleSevSnpReportTypeValues() []SevSnpReportType {
	return []SevSnpReportType{HclHyperV}
}
...
const (
	...
	// SevSnpVM AMD SEV SNP Virtual Machine
	SevSnpVM Type = "SevSnpVm"
...
func PossibleTypeValues() []Type {
	return []Type{OpenEnclave, SevSnpVM, SgxEnclave, Tpm}
}
