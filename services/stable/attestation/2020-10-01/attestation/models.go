...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/stable/attestation/2020-10-01/attestation"
...
type AttestSevSnpVMRequest struct {
	// ReportType - Type of the report payload. Possible values include: 'HclHyperV'
	ReportType SevSnpReportType `json:"reportType,omitempty"`
	// Report - Hardware rooted report of the virtual machine being attested
	Report *string `json:"report,omitempty"`
