...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/stable/kusto/mgmt/2019-01-21/kusto"
...
// AvailabilityZone defines Azure availability zone where a cluster can be deployed to.
type AvailabilityZone struct {
	// Value - Availability Zone where a cluster can be deployed to.
...
type ClusterProperties struct {
	...
	// AvailabilityZones - The cluster's zones.
...
type ClusterUpdate struct {
	...
	Location *string `json:"location,omitempty"`
	// Etag - An ETag of the resource updated.
	Etag *string `json:"etag,omitempty"`
	// Sku - The SKU of the cluster.
	Sku *AzureSku `json:"sku,omitempty"`
