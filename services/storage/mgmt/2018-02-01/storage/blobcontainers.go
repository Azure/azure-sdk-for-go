...
// names must be between 3 and 24 characters in length and use numbers and lower-case letters only. containerName
// is the name of the blob container within the specified storage account. Blob container names must be between 3
// and 63 characters in length and use numbers, lower-case letters and dash (-) only. Every dash (-) character must
// be immediately preceded and followed by a letter or number. legalHold is the LegalHold property that will be
// clear from a blob container.
...
// is the name of the blob container within the specified storage account. Blob container names must be between 3
// and 63 characters in length and use numbers, lower-case letters and dash (-) only. Every dash (-) character must
// be immediately preceded and followed by a letter or number. blobContainer is properties of the blob container to
// create.
...
// is the name of the blob container within the specified storage account. Blob container names must be between 3
// and 63 characters in length and use numbers, lower-case letters and dash (-) only. Every dash (-) character must
// be immediately preceded and followed by a letter or number. parameters is the ImmutabilityPolicy Properties that
// will be created or updated to a blob container. ifMatch is the entity state (ETag) version of the immutability
// policy to update. A value of "*" can be used to apply the operation only if the immutability policy already
...
// is the name of the blob container within the specified storage account. Blob container names must be between 3
// and 63 characters in length and use numbers, lower-case letters and dash (-) only. Every dash (-) character must
// be immediately preceded and followed by a letter or number. ifMatch is the entity state (ETag) version of the
// immutability policy to update. A value of "*" can be used to apply the operation only if the immutability policy
...
// be immediately preceded and followed by a letter or number. ifMatch is the entity state (ETag) version of the
// immutability policy to update. A value of "*" can be used to apply the operation only if the immutability policy
// already exists. If omitted, this operation will always be applied. parameters is the ImmutabilityPolicy
// Properties that will be extented for a blob container.
...
// is the name of the blob container within the specified storage account. Blob container names must be between 3
// and 63 characters in length and use numbers, lower-case letters and dash (-) only. Every dash (-) character must
// be immediately preceded and followed by a letter or number. legalHold is the LegalHold property that will be set
// to a blob container.
...
// is the name of the blob container within the specified storage account. Blob container names must be between 3
// and 63 characters in length and use numbers, lower-case letters and dash (-) only. Every dash (-) character must
// be immediately preceded and followed by a letter or number. blobContainer is properties to update for the blob
// container.
