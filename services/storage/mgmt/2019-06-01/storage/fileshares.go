...
func (client FileSharesClient) Create(ctx context.Context, resourceGroupName string, accountName string, shareName string, fileShare FileShareCreateParameters) (result FileShare, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		{TargetValue: fileShare,
			Constraints: []validation.Constraint{{Target: "fileShare.Properties", Name: validation.Null, Rule: false,
				Chain: []validation.Constraint{{Target: "fileShare.Properties.ShareQuota", Name: validation.Null, Rule: false,
					Chain: []validation.Constraint{{Target: "fileShare.Properties.ShareQuota", Name: validation.InclusiveMaximum, Rule: int64(5120), Chain: nil},
						{Target: "fileShare.Properties.ShareQuota", Name: validation.InclusiveMinimum, Rule: 1, Chain: nil},
					}},
				}}}},
