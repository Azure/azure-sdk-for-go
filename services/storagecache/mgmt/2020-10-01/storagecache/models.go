...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/storagecache/mgmt/2020-10-01/storagecache"
...
type CacheUsernameDownloadSettings struct {
	// ExtendedGroupsEnabled - Whether or not Extended Groups is enabled.
	ExtendedGroupsEnabled *bool `json:"extendedGroupsEnabled,omitempty"`
...
func (cuds CacheUsernameDownloadSettings) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if cuds.ExtendedGroupsEnabled != nil {
		objectMap["extendedGroupsEnabled"] = cuds.ExtendedGroupsEnabled
	}
...
type Nfs3Target struct {
	...
	Target *string `json:"target,omitempty"`
	// UsageModel - Identifies the usage model to be used for this Storage Target. Get choices from .../usageModels
...
type NfsAccessRule struct {
	...
	// AnonymousUID - UID value that replaces 0 when rootSquash is true.
	AnonymousUID *string `json:"anonymousUID,omitempty"`
	// AnonymousGID - GID value that replaces 0 when rootSquash is true.
