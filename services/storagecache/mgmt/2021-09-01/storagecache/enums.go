...
const (
	...
	SystemAssignedUserAssigned CacheIdentityType = "SystemAssigned, UserAssigned"
	// UserAssigned ...
	UserAssigned CacheIdentityType = "UserAssigned"
)
...
func PossibleCacheIdentityTypeValues() []CacheIdentityType {
	return []CacheIdentityType{None, SystemAssigned, SystemAssignedUserAssigned, UserAssigned}
}
