...
// AscUsagesClientAPI contains the set of methods on the AscUsagesClient type.
type AscUsagesClientAPI interface {
	List(ctx context.Context, location string) (result storagecache.ResourceUsagesListResultPage, err error)
	ListComplete(ctx context.Context, location string) (result storagecache.ResourceUsagesListResultIterator, err error)
}

var _ AscUsagesClientAPI = (*storagecache.AscUsagesClient)(nil)
...
type StorageTargetsClientAPI interface {
	...
	Delete(ctx context.Context, resourceGroupName string, cacheName string, storageTargetName string, force string) (result storagecache.StorageTargetsDeleteFuture, err error)
	DNSRefresh(ctx context.Context, resourceGroupName string, cacheName string, storageTargetName string) (result storagecache.StorageTargetsDNSRefreshFuture, err error)
...
// StorageTargetClientAPI contains the set of methods on the StorageTargetClient type.
type StorageTargetClientAPI interface {
	Flush(ctx context.Context, resourceGroupName string, cacheName string, storageTargetName string) (result storagecache.StorageTargetFlushFuture, err error)
	Invalidate(ctx context.Context, resourceGroupName string, cacheName string, storageTargetName string) (result storagecache.StorageTargetInvalidateFuture, err error)
	Resume(ctx context.Context, resourceGroupName string, cacheName string, storageTargetName string) (result storagecache.StorageTargetResumeFuture, err error)
	Suspend(ctx context.Context, resourceGroupName string, cacheName string, storageTargetName string) (result storagecache.StorageTargetSuspendFuture, err error)
}

var _ StorageTargetClientAPI = (*storagecache.StorageTargetClient)(nil)
