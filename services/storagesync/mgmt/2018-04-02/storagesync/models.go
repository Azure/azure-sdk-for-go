...
func (future *CloudEndpointsGroupCreateFuture) Result(client CloudEndpointsGroupClient) (ce CloudEndpoint, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "storagesyncmanagement.CloudEndpointsGroupCreateFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		err = azure.NewAsyncOpIncompleteError("storagesyncmanagement.CloudEndpointsGroupCreateFuture")
		return
	}
	...
	if ce.Response.Response, err = future.GetResult(sender); err == nil && ce.Response.Response.StatusCode != http.StatusNoContent {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "storagesyncmanagement.CloudEndpointsGroupCreateFuture", "Result", ce.Response.Response, "Failure responding to request")
		}
	}
	return
}
...
func (future *CloudEndpointsGroupDeleteFuture) Result(client CloudEndpointsGroupClient) (ar autorest.Response, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "storagesyncmanagement.CloudEndpointsGroupDeleteFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		err = azure.NewAsyncOpIncompleteError("storagesyncmanagement.CloudEndpointsGroupDeleteFuture")
		return
	}
...
func (future *CloudEndpointsGroupPostBackupFuture) Result(client CloudEndpointsGroupClient) (pbr PostBackupResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "storagesyncmanagement.CloudEndpointsGroupPostBackupFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		err = azure.NewAsyncOpIncompleteError("storagesyncmanagement.CloudEndpointsGroupPostBackupFuture")
		return
	}
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if pbr.Response.Response, err = future.GetResult(sender); err == nil && pbr.Response.Response.StatusCode != http.StatusNoContent {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "storagesyncmanagement.CloudEndpointsGroupPostBackupFuture", "Result", pbr.Response.Response, "Failure responding to request")
		}
	}
	return
}
...
func (future *CloudEndpointsGroupPostRestoreFuture) Result(client CloudEndpointsGroupClient) (ar autorest.Response, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "storagesyncmanagement.CloudEndpointsGroupPostRestoreFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		err = azure.NewAsyncOpIncompleteError("storagesyncmanagement.CloudEndpointsGroupPostRestoreFuture")
		return
	}
	ar.Response = future.Response()
	return
...
func (future *CloudEndpointsGroupPreBackupFuture) Result(client CloudEndpointsGroupClient) (ar autorest.Response, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "storagesyncmanagement.CloudEndpointsGroupPreBackupFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		err = azure.NewAsyncOpIncompleteError("storagesyncmanagement.CloudEndpointsGroupPreBackupFuture")
		return
	}
	ar.Response = future.Response()
	return
...
func (future *CloudEndpointsGroupPreRestoreFuture) Result(client CloudEndpointsGroupClient) (ar autorest.Response, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "storagesyncmanagement.CloudEndpointsGroupPreRestoreFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		err = azure.NewAsyncOpIncompleteError("storagesyncmanagement.CloudEndpointsGroupPreRestoreFuture")
		return
	}
	ar.Response = future.Response()
	return
...
func (future *RegisteredServersGroupCreateFuture) Result(client RegisteredServersGroupClient) (rs RegisteredServer, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "storagesyncmanagement.RegisteredServersGroupCreateFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		err = azure.NewAsyncOpIncompleteError("storagesyncmanagement.RegisteredServersGroupCreateFuture")
		return
	}
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if rs.Response.Response, err = future.GetResult(sender); err == nil && rs.Response.Response.StatusCode != http.StatusNoContent {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "storagesyncmanagement.RegisteredServersGroupCreateFuture", "Result", rs.Response.Response, "Failure responding to request")
		}
	}
	return
}
...
func (future *RegisteredServersGroupDeleteFuture) Result(client RegisteredServersGroupClient) (ar autorest.Response, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "storagesyncmanagement.RegisteredServersGroupDeleteFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		err = azure.NewAsyncOpIncompleteError("storagesyncmanagement.RegisteredServersGroupDeleteFuture")
		return
	}
	ar.Response = future.Response()
	return
...
func (future *ServerEndpointsGroupCreateFuture) Result(client ServerEndpointsGroupClient) (se ServerEndpoint, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "storagesyncmanagement.ServerEndpointsGroupCreateFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		err = azure.NewAsyncOpIncompleteError("storagesyncmanagement.ServerEndpointsGroupCreateFuture")
		return
	}
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if se.Response.Response, err = future.GetResult(sender); err == nil && se.Response.Response.StatusCode != http.StatusNoContent {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "storagesyncmanagement.ServerEndpointsGroupCreateFuture", "Result", se.Response.Response, "Failure responding to request")
		}
	}
	return
}
...
func (future *ServerEndpointsGroupDeleteFuture) Result(client ServerEndpointsGroupClient) (ar autorest.Response, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "storagesyncmanagement.ServerEndpointsGroupDeleteFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		err = azure.NewAsyncOpIncompleteError("storagesyncmanagement.ServerEndpointsGroupDeleteFuture")
		return
	}
	ar.Response = future.Response()
	return
...
func (future *ServerEndpointsGroupRecallActionFuture) Result(client ServerEndpointsGroupClient) (ar autorest.Response, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "storagesyncmanagement.ServerEndpointsGroupRecallActionFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		err = azure.NewAsyncOpIncompleteError("storagesyncmanagement.ServerEndpointsGroupRecallActionFuture")
		return
	}
	ar.Response = future.Response()
	return
...
func (future *ServerEndpointsGroupUpdateFuture) Result(client ServerEndpointsGroupClient) (se ServerEndpoint, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "storagesyncmanagement.ServerEndpointsGroupUpdateFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		err = azure.NewAsyncOpIncompleteError("storagesyncmanagement.ServerEndpointsGroupUpdateFuture")
		return
	}
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if se.Response.Response, err = future.GetResult(sender); err == nil && se.Response.Response.StatusCode != http.StatusNoContent {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "storagesyncmanagement.ServerEndpointsGroupUpdateFuture", "Result", se.Response.Response, "Failure responding to request")
		}
	}
	return
}
...
type StorageSyncService struct {
	autorest.Response `json:"-"`
	// StorageSyncServiceProperties - Storage Sync Service properties.
	*StorageSyncServiceProperties `json:"properties,omitempty"`
	// Tags - Resource tags.
	Tags map[string]*string `json:"tags"`
...
// MarshalJSON is the custom marshaler for StorageSyncService.
func (sss StorageSyncService) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if sss.StorageSyncServiceProperties != nil {
		objectMap["properties"] = sss.StorageSyncServiceProperties
	}
	if sss.Tags != nil {
		objectMap["tags"] = sss.Tags
	}
	if sss.Location != nil {
		objectMap["location"] = sss.Location
	}
	if sss.ID != nil {
		objectMap["id"] = sss.ID
	}
	if sss.Name != nil {
		objectMap["name"] = sss.Name
	}
	if sss.Type != nil {
...
// UnmarshalJSON is the custom unmarshaler for StorageSyncService struct.
func (sss *StorageSyncService) UnmarshalJSON(body []byte) error {
	var m map[string]*json.RawMessage
	err := json.Unmarshal(body, &m)
	if err != nil {
		return err
	...
	for k, v := range m {
		...
		case "properties":
			if v != nil {
				var storageSyncServiceProperties StorageSyncServiceProperties
				err = json.Unmarshal(*v, &storageSyncServiceProperties)
				if err != nil {
					return err
				}
				sss.StorageSyncServiceProperties = &storageSyncServiceProperties
			}
		case "tags":
			if v != nil {
				var tags map[string]*string
...
// MarshalJSON is the custom marshaler for StorageSyncServiceCreateParameters.
func (ssscp StorageSyncServiceCreateParameters) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if ssscp.Location != nil {
		objectMap["location"] = ssscp.Location
	}
	if ssscp.Tags != nil {
		objectMap["tags"] = ssscp.Tags
	}
	return json.Marshal(objectMap)
}
...
// MarshalJSON is the custom marshaler for StorageSyncServiceUpdateParameters.
func (sssup StorageSyncServiceUpdateParameters) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if sssup.Tags != nil {
		objectMap["tags"] = sssup.Tags
	}
	objectMap["properties"] = sssup.Properties
	return json.Marshal(objectMap)
}
