...
func (client OperationsGroupClient) List(ctx context.Context) (result OperationEntityListResultPage, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "storagesyncmanagement.OperationsGroupClient", "List", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "storagesyncmanagement.OperationsGroupClient", "List", resp, "Failure sending request")
		return
	}

	result.oelr, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "storagesyncmanagement.OperationsGroupClient", "List", resp, "Failure responding to request")
	}
...
func (client OperationsGroupClient) listNextResults(lastResults OperationEntityListResult) (result OperationEntityListResult, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "storagesyncmanagement.OperationsGroupClient", "listNextResults", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "storagesyncmanagement.OperationsGroupClient", "listNextResults", resp, "Failure sending next results request")
	}
	result, err = client.ListResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "storagesyncmanagement.OperationsGroupClient", "listNextResults", resp, "Failure responding to next results request")
	}
	return
}
