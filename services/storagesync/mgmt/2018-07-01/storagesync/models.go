...
func (future *CloudEndpointsCreateFuture) Result(client CloudEndpointsClient) (ce CloudEndpoint, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "storagesyncmanagement.CloudEndpointsCreateFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		err = azure.NewAsyncOpIncompleteError("storagesyncmanagement.CloudEndpointsCreateFuture")
		return
	}
	...
	if ce.Response.Response, err = future.GetResult(sender); err == nil && ce.Response.Response.StatusCode != http.StatusNoContent {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "storagesyncmanagement.CloudEndpointsCreateFuture", "Result", ce.Response.Response, "Failure responding to request")
		}
	}
	return
}
...
func (future *CloudEndpointsDeleteFuture) Result(client CloudEndpointsClient) (ar autorest.Response, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "storagesyncmanagement.CloudEndpointsDeleteFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		err = azure.NewAsyncOpIncompleteError("storagesyncmanagement.CloudEndpointsDeleteFuture")
		return
	}
...
func (future *CloudEndpointsPostBackupFuture) Result(client CloudEndpointsClient) (pbr PostBackupResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "storagesyncmanagement.CloudEndpointsPostBackupFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		err = azure.NewAsyncOpIncompleteError("storagesyncmanagement.CloudEndpointsPostBackupFuture")
		return
	}
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if pbr.Response.Response, err = future.GetResult(sender); err == nil && pbr.Response.Response.StatusCode != http.StatusNoContent {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "storagesyncmanagement.CloudEndpointsPostBackupFuture", "Result", pbr.Response.Response, "Failure responding to request")
		}
	}
	return
}
...
func (future *CloudEndpointsPostRestoreFuture) Result(client CloudEndpointsClient) (ar autorest.Response, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "storagesyncmanagement.CloudEndpointsPostRestoreFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		err = azure.NewAsyncOpIncompleteError("storagesyncmanagement.CloudEndpointsPostRestoreFuture")
		return
	}
	ar.Response = future.Response()
	return
...
func (future *CloudEndpointsPreBackupFuture) Result(client CloudEndpointsClient) (ar autorest.Response, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "storagesyncmanagement.CloudEndpointsPreBackupFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		err = azure.NewAsyncOpIncompleteError("storagesyncmanagement.CloudEndpointsPreBackupFuture")
		return
	}
	ar.Response = future.Response()
	return
...
func (future *CloudEndpointsPreRestoreFuture) Result(client CloudEndpointsClient) (ar autorest.Response, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "storagesyncmanagement.CloudEndpointsPreRestoreFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		err = azure.NewAsyncOpIncompleteError("storagesyncmanagement.CloudEndpointsPreRestoreFuture")
		return
	}
	ar.Response = future.Response()
	return
...
func (future *RegisteredServersCreateFuture) Result(client RegisteredServersClient) (rs RegisteredServer, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "storagesyncmanagement.RegisteredServersCreateFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		err = azure.NewAsyncOpIncompleteError("storagesyncmanagement.RegisteredServersCreateFuture")
		return
	}
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if rs.Response.Response, err = future.GetResult(sender); err == nil && rs.Response.Response.StatusCode != http.StatusNoContent {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "storagesyncmanagement.RegisteredServersCreateFuture", "Result", rs.Response.Response, "Failure responding to request")
		}
	}
	return
}
...
func (future *RegisteredServersDeleteFuture) Result(client RegisteredServersClient) (ar autorest.Response, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "storagesyncmanagement.RegisteredServersDeleteFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		err = azure.NewAsyncOpIncompleteError("storagesyncmanagement.RegisteredServersDeleteFuture")
		return
	}
	ar.Response = future.Response()
	return
...
func (future *ServerEndpointsCreateFuture) Result(client ServerEndpointsClient) (se ServerEndpoint, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "storagesyncmanagement.ServerEndpointsCreateFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		err = azure.NewAsyncOpIncompleteError("storagesyncmanagement.ServerEndpointsCreateFuture")
		return
	}
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if se.Response.Response, err = future.GetResult(sender); err == nil && se.Response.Response.StatusCode != http.StatusNoContent {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "storagesyncmanagement.ServerEndpointsCreateFuture", "Result", se.Response.Response, "Failure responding to request")
		}
	}
	return
}
...
func (future *ServerEndpointsDeleteFuture) Result(client ServerEndpointsClient) (ar autorest.Response, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "storagesyncmanagement.ServerEndpointsDeleteFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		err = azure.NewAsyncOpIncompleteError("storagesyncmanagement.ServerEndpointsDeleteFuture")
		return
	}
	ar.Response = future.Response()
	return
...
func (future *ServerEndpointsRecallActionFuture) Result(client ServerEndpointsClient) (ar autorest.Response, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "storagesyncmanagement.ServerEndpointsRecallActionFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		err = azure.NewAsyncOpIncompleteError("storagesyncmanagement.ServerEndpointsRecallActionFuture")
		return
	}
	ar.Response = future.Response()
	return
...
func (future *ServerEndpointsUpdateFuture) Result(client ServerEndpointsClient) (se ServerEndpoint, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "storagesyncmanagement.ServerEndpointsUpdateFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		err = azure.NewAsyncOpIncompleteError("storagesyncmanagement.ServerEndpointsUpdateFuture")
		return
	}
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if se.Response.Response, err = future.GetResult(sender); err == nil && se.Response.Response.StatusCode != http.StatusNoContent {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "storagesyncmanagement.ServerEndpointsUpdateFuture", "Result", se.Response.Response, "Failure responding to request")
		}
	}
	return
}
