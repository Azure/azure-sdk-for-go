...
func (sep ServerEndpointProperties) MarshalJSON() ([]byte, error) {
	...
	if sep.ProvisioningState != nil {
		objectMap["provisioningState"] = sep.ProvisioningState
	}
	if sep.LastWorkflowID != nil {
		objectMap["lastWorkflowId"] = sep.LastWorkflowID
	}
	if sep.LastOperationName != nil {
		objectMap["lastOperationName"] = sep.LastOperationName
	}
	if sep.SyncStatus != nil {
		objectMap["syncStatus"] = sep.SyncStatus
	}
