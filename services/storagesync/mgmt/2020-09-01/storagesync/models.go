...
const fqdn = "github.com/Azure/azure-sdk-for-go/services/storagesync/mgmt/2020-09-01/storagesync"
...
type CloudEndpointChangeEnumerationActivity struct {
	...
	// OperationState - READ-ONLY; Change enumeration operation state. Possible values include: 'InitialEnumerationInProgress', 'EnumerationInProgress'
	OperationState CloudEndpointChangeEnumerationActivityState `json:"operationState,omitempty"`
	// StatusCode - READ-ONLY; When non-zero, indicates an issue that is delaying change enumeration
	StatusCode *int32 `json:"statusCode,omitempty"`
	// StartedTimestamp - READ-ONLY; Timestamp when change enumeration started
	StartedTimestamp *date.Time `json:"startedTimestamp,omitempty"`
	// ProcessedFilesCount - READ-ONLY; Count of files processed
	ProcessedFilesCount *int64 `json:"processedFilesCount,omitempty"`
	// ProcessedDirectoriesCount - READ-ONLY; Count of directories processed
	ProcessedDirectoriesCount *int64 `json:"processedDirectoriesCount,omitempty"`
	// TotalFilesCount - READ-ONLY; Total count of files enumerated
	TotalFilesCount *int64 `json:"totalFilesCount,omitempty"`
	// TotalDirectoriesCount - READ-ONLY; Total count of directories enumerated
	TotalDirectoriesCount *int64 `json:"totalDirectoriesCount,omitempty"`
	// TotalSizeBytes - READ-ONLY; Total enumerated size in bytes
	TotalSizeBytes *int64 `json:"totalSizeBytes,omitempty"`
	// ProgressPercent - READ-ONLY; Progress percentage for change enumeration run, excluding processing of deletes
	ProgressPercent *int32 `json:"progressPercent,omitempty"`
	// MinutesRemaining - READ-ONLY; Estimate of time remaining for the enumeration run
	MinutesRemaining *int32 `json:"minutesRemaining,omitempty"`
	// TotalCountsState - READ-ONLY; Change enumeration total counts state. Possible values include: 'Calculating', 'Final'
	TotalCountsState CloudEndpointChangeEnumerationTotalCountsState `json:"totalCountsState,omitempty"`
	// DeletesProgressPercent - READ-ONLY; Progress percentage for processing deletes. This is done separately from the rest of the enumeration run
	DeletesProgressPercent *int32 `json:"deletesProgressPercent,omitempty"`
}

// MarshalJSON is the custom marshaler for CloudEndpointChangeEnumerationActivity.
func (cecea CloudEndpointChangeEnumerationActivity) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	return json.Marshal(objectMap)
}
...
type CloudEndpointChangeEnumerationStatus struct {
	// LastUpdatedTimestamp - READ-ONLY; Last updated timestamp
	LastUpdatedTimestamp *date.Time `json:"lastUpdatedTimestamp,omitempty"`
	// LastEnumerationStatus - READ-ONLY; Status of last completed change enumeration
	LastEnumerationStatus *CloudEndpointLastChangeEnumerationStatus `json:"lastEnumerationStatus,omitempty"`
	// Activity - READ-ONLY; Change enumeration activity
	Activity *CloudEndpointChangeEnumerationActivity `json:"activity,omitempty"`
}

// MarshalJSON is the custom marshaler for CloudEndpointChangeEnumerationStatus.
func (ceces CloudEndpointChangeEnumerationStatus) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	return json.Marshal(objectMap)
}
...
type CloudEndpointLastChangeEnumerationStatus struct {
	// StartedTimestamp - READ-ONLY; Timestamp when change enumeration started
	StartedTimestamp *date.Time `json:"startedTimestamp,omitempty"`
	// CompletedTimestamp - READ-ONLY; Timestamp when change enumeration completed
	CompletedTimestamp *date.Time `json:"completedTimestamp,omitempty"`
	// NamespaceFilesCount - READ-ONLY; Count of files in the namespace
	NamespaceFilesCount *int64 `json:"namespaceFilesCount,omitempty"`
	// NamespaceDirectoriesCount - READ-ONLY; Count of directories in the namespace
	NamespaceDirectoriesCount *int64 `json:"namespaceDirectoriesCount,omitempty"`
	// NamespaceSizeBytes - READ-ONLY; Namespace size in bytes
	NamespaceSizeBytes *int64 `json:"namespaceSizeBytes,omitempty"`
	// NextRunTimestamp - READ-ONLY; Timestamp of when change enumeration is expected to run again
	NextRunTimestamp *date.Time `json:"nextRunTimestamp,omitempty"`
}

// MarshalJSON is the custom marshaler for CloudEndpointLastChangeEnumerationStatus.
func (celces CloudEndpointLastChangeEnumerationStatus) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	return json.Marshal(objectMap)
}
...
type CloudEndpointProperties struct {
	...
	// ChangeEnumerationStatus - READ-ONLY; Cloud endpoint change enumeration status
...
type ServerEndpointBackgroundDataDownloadActivity struct {
	...
	// StartedTimestamp - READ-ONLY; Timestamp when the operation started
	StartedTimestamp *date.Time `json:"startedTimestamp,omitempty"`
	// PercentProgress - READ-ONLY; Progress percentage
	PercentProgress *int32 `json:"percentProgress,omitempty"`
	// DownloadedBytes - READ-ONLY; Running count of bytes downloaded
	DownloadedBytes *int64 `json:"downloadedBytes,omitempty"`
}

// MarshalJSON is the custom marshaler for ServerEndpointBackgroundDataDownloadActivity.
func (sebdda ServerEndpointBackgroundDataDownloadActivity) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	return json.Marshal(objectMap)
}
...
type ServerEndpointCloudTieringStatus struct {
	// LastUpdatedTimestamp - READ-ONLY; Last updated timestamp
	LastUpdatedTimestamp *date.Time `json:"lastUpdatedTimestamp,omitempty"`
	// Health - READ-ONLY; Cloud tiering health state. Possible values include: 'ServerEndpointHealthStateUnavailable', 'ServerEndpointHealthStateHealthy', 'ServerEndpointHealthStateError'
...
type ServerEndpointCreateParametersProperties struct {
	...
	// InitialUploadPolicy - Policy for how the initial upload sync session is performed. Possible values include: 'ServerAuthoritative', 'Merge'
...
func (sep ServerEndpointProperties) MarshalJSON() ([]byte, error) {
	...
	if sep.InitialUploadPolicy != "" {
		objectMap["initialUploadPolicy"] = sep.InitialUploadPolicy
	}
	return json.Marshal(objectMap)
}
...
type ServerEndpointSyncActivityStatus struct {
	...
	// SessionMinutesRemaining - READ-ONLY; Session minutes remaining (if available)
	SessionMinutesRemaining *int32 `json:"sessionMinutesRemaining,omitempty"`
}
...
type ServerEndpointSyncStatus struct {
	// DownloadHealth - READ-ONLY; Download Health Status. Possible values include: 'ServerEndpointHealthStateUnavailable', 'ServerEndpointHealthStateHealthy', 'ServerEndpointHealthStateError'
	DownloadHealth ServerEndpointHealthState `json:"downloadHealth,omitempty"`
	// UploadHealth - READ-ONLY; Upload Health Status. Possible values include: 'ServerEndpointHealthStateUnavailable', 'ServerEndpointHealthStateHealthy', 'ServerEndpointHealthStateError'
	UploadHealth ServerEndpointHealthState `json:"uploadHealth,omitempty"`
	// CombinedHealth - READ-ONLY; Combined Health Status. Possible values include: 'ServerEndpointHealthStateUnavailable', 'ServerEndpointHealthStateHealthy', 'ServerEndpointHealthStateError'
	...
	// BackgroundDataDownloadActivity - READ-ONLY; Background data download activity
...
type WorkflowProperties struct {
	...
	// CommandName - READ-ONLY; workflow command name.
	CommandName *string `json:"commandName,omitempty"`
	// CreatedTimestamp - READ-ONLY; workflow created timestamp.
	CreatedTimestamp *date.Time `json:"createdTimestamp,omitempty"`
	// LastStatusTimestamp - READ-ONLY; workflow last status timestamp.
	LastStatusTimestamp *date.Time `json:"lastStatusTimestamp,omitempty"`
}

// MarshalJSON is the custom marshaler for WorkflowProperties.
func (wp WorkflowProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if wp.LastStepName != nil {
		objectMap["lastStepName"] = wp.LastStepName
	}
	if wp.Status != "" {
		objectMap["status"] = wp.Status
	}
	if wp.Operation != "" {
		objectMap["operation"] = wp.Operation
	}
	if wp.Steps != nil {
		objectMap["steps"] = wp.Steps
	}
	if wp.LastOperationID != nil {
		objectMap["lastOperationId"] = wp.LastOperationID
	}
	return json.Marshal(objectMap)
}
