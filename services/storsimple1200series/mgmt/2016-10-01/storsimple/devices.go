...
// PublishSupportPackage triggers collection of support package on a device.
// Parameters:
// deviceName - the device name.
// supportPackageRequest - the publish support package request.
// resourceGroupName - the resource group name
// managerName - the manager name
func (client DevicesClient) PublishSupportPackage(ctx context.Context, deviceName string, supportPackageRequest SupportPackageRequest, resourceGroupName string, managerName string) (result DevicesPublishSupportPackageFuture, err error) {
	if err := validation.Validate([]validation.Validation{
		{TargetValue: supportPackageRequest,
			Constraints: []validation.Constraint{{Target: "supportPackageRequest.SupportPackageRequestProperties", Name: validation.Null, Rule: true,
				Chain: []validation.Constraint{{Target: "supportPackageRequest.SupportPackageRequestProperties.SdpPassKey", Name: validation.Null, Rule: true, Chain: nil}}}}},
		{TargetValue: managerName,
			Constraints: []validation.Constraint{{Target: "managerName", Name: validation.MaxLength, Rule: 50, Chain: nil},
				{Target: "managerName", Name: validation.MinLength, Rule: 2, Chain: nil}}}}); err != nil {
		return result, validation.NewError("storsimple.DevicesClient", "PublishSupportPackage", err.Error())
	}

	req, err := client.PublishSupportPackagePreparer(ctx, deviceName, supportPackageRequest, resourceGroupName, managerName)
	if err != nil {
		err = autorest.NewErrorWithError(err, "storsimple.DevicesClient", "PublishSupportPackage", nil, "Failure preparing request")
		return
	}

	result, err = client.PublishSupportPackageSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "storsimple.DevicesClient", "PublishSupportPackage", result.Response(), "Failure sending request")
		return
	}
...
// PublishSupportPackagePreparer prepares the PublishSupportPackage request.
func (client DevicesClient) PublishSupportPackagePreparer(ctx context.Context, deviceName string, supportPackageRequest SupportPackageRequest, resourceGroupName string, managerName string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"deviceName":        autorest.Encode("path", deviceName),
		"managerName":       autorest.Encode("path", managerName),
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.AsPost(),
		autorest.WithBaseURL(client.BaseURI),
		autorest.WithPathParameters("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StorSimple/managers/{managerName}/devices/{deviceName}/publishSupportPackage", pathParameters),
		autorest.WithJSON(supportPackageRequest),
		autorest.WithQueryParameters(queryParameters))
	return preparer.Prepare((&http.Request{}).WithContext(ctx))
}

// PublishSupportPackageSender sends the PublishSupportPackage request. The method will close the
// http.Response Body if it receives an error.
func (client DevicesClient) PublishSupportPackageSender(req *http.Request) (future DevicesPublishSupportPackageFuture, err error) {
	var resp *http.Response
	resp, err = autorest.SendWithSender(client, req,
		azure.DoRetryWithRegistration(client.Client))
	if err != nil {
...
// PublishSupportPackageResponder handles the response to the PublishSupportPackage request. The method always
// closes the http.Response Body.
func (client DevicesClient) PublishSupportPackageResponder(resp *http.Response) (result autorest.Response, err error) {
	err = autorest.Respond(
		resp,
		client.ByInspecting(),
		azure.WithErrorUnlessStatusCode(http.StatusOK, http.StatusAccepted, http.StatusNoContent),
