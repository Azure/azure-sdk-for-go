...
// result is the default implementation for AppsRecoverFuture.Result.
...
// result is the default implementation for AppsRecoverSlotFuture.Result.
...
type AppsRestoreFuture struct {
	...
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(AppsClient) (RestoreResponse, error)
}
