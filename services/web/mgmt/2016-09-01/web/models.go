...
// hasNextLink returns true if the NextLink is not empty.
func (aic AppInstanceCollection) hasNextLink() bool {
...
func (asppr AppServicePlanPatchResourceProperties) MarshalJSON() ([]byte, error) {
	...
	if asppr.AdminSiteName != nil {
		objectMap["adminSiteName"] = asppr.AdminSiteName
	}
...
func (asp AppServicePlanProperties) MarshalJSON() ([]byte, error) {
	...
	if asp.AdminSiteName != nil {
		objectMap["adminSiteName"] = asp.AdminSiteName
	}
...
func (spr SitePatchResourceProperties) MarshalJSON() ([]byte, error) {
	...
	if spr.SnapshotInfo != nil {
		objectMap["snapshotInfo"] = spr.SnapshotInfo
	}
...
func (s SiteProperties) MarshalJSON() ([]byte, error) {
	...
	if s.SnapshotInfo != nil {
		objectMap["snapshotInfo"] = s.SnapshotInfo
	}
	if s.HTTPSOnly != nil {
...
func (tjr TriggeredJobRunProperties) MarshalJSON() ([]byte, error) {
	...
	if tjr.Status != "" {
		objectMap["status"] = tjr.Status
	}
	if tjr.StartTime != nil {
		objectMap["startTime"] = tjr.StartTime
	}
	if tjr.EndTime != nil {
		objectMap["endTime"] = tjr.EndTime
	}
	if tjr.Duration != nil {
		objectMap["duration"] = tjr.Duration
	}
	if tjr.OutputURL != nil {
		objectMap["outputUrl"] = tjr.OutputURL
	}
	if tjr.ErrorURL != nil {
		objectMap["errorUrl"] = tjr.ErrorURL
	}
	if tjr.URL != nil {
		objectMap["url"] = tjr.URL
	}
	if tjr.JobName != nil {
		objectMap["jobName"] = tjr.JobName
	}
	if tjr.Trigger != nil {
		objectMap["trigger"] = tjr.Trigger
	}
	return json.Marshal(objectMap)
}
