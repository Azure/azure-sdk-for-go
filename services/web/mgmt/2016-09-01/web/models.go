...
func (future *AppServiceEnvironmentsResumeAllFuture) Result(client AppServiceEnvironmentsClient) (acp AppCollectionPage, err error) {
	...
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if acp.Response.Response, err = future.GetResult(sender); err == nil && acp.Response.Response.StatusCode != http.StatusNoContent {
		acp, err = client.ResumeResponder(acp.Response.Response)
		if err != nil {
			err = autorest.NewErrorWithError(err, "web.AppServiceEnvironmentsResumeAllFuture", "Result", acp.Response.Response, "Failure responding to request")
		}
	}
	return
}
...
func (future *AppServiceEnvironmentsResumeFuture) Result(client AppServiceEnvironmentsClient) (acp AppCollectionPage, err error) {
	...
	if acp.Response.Response, err = future.GetResult(sender); err == nil && acp.Response.Response.StatusCode != http.StatusNoContent {
		acp, err = client.ResumeResponder(acp.Response.Response)
		if err != nil {
			err = autorest.NewErrorWithError(err, "web.AppServiceEnvironmentsResumeFuture", "Result", acp.Response.Response, "Failure responding to request")
		}
	}
	return
}
...
func (future *AppServiceEnvironmentsSuspendAllFuture) Result(client AppServiceEnvironmentsClient) (acp AppCollectionPage, err error) {
	...
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if acp.Response.Response, err = future.GetResult(sender); err == nil && acp.Response.Response.StatusCode != http.StatusNoContent {
		acp, err = client.SuspendResponder(acp.Response.Response)
		if err != nil {
			err = autorest.NewErrorWithError(err, "web.AppServiceEnvironmentsSuspendAllFuture", "Result", acp.Response.Response, "Failure responding to request")
		}
	}
	return
}
...
func (future *AppServiceEnvironmentsSuspendFuture) Result(client AppServiceEnvironmentsClient) (acp AppCollectionPage, err error) {
	...
	if acp.Response.Response, err = future.GetResult(sender); err == nil && acp.Response.Response.StatusCode != http.StatusNoContent {
		acp, err = client.SuspendResponder(acp.Response.Response)
		if err != nil {
			err = autorest.NewErrorWithError(err, "web.AppServiceEnvironmentsSuspendFuture", "Result", acp.Response.Response, "Failure responding to request")
		}
	}
	return
}
