...
func (future *AppServiceEnvironmentsChangeVnetAllFuture) Result(client AppServiceEnvironmentsClient) (acp AppCollectionPage, err error) {
	...
	if acp.Response.Response, err = future.GetResult(sender); err == nil && acp.Response.Response.StatusCode != http.StatusNoContent {
		acp, err = client.ChangeVnetResponder(acp.Response.Response)
		if err != nil {
			err = autorest.NewErrorWithError(err, "web.AppServiceEnvironmentsChangeVnetAllFuture", "Result", acp.Response.Response, "Failure responding to request")
		}
	}
	return
}
...
func (future *AppServiceEnvironmentsChangeVnetFuture) Result(client AppServiceEnvironmentsClient) (acp AppCollectionPage, err error) {
	...
	if acp.Response.Response, err = future.GetResult(sender); err == nil && acp.Response.Response.StatusCode != http.StatusNoContent {
		acp, err = client.ChangeVnetResponder(acp.Response.Response)
		if err != nil {
			err = autorest.NewErrorWithError(err, "web.AppServiceEnvironmentsChangeVnetFuture", "Result", acp.Response.Response, "Failure responding to request")
		}
	}
	return
}
