...
//
// resourceGroupName is name of the resource group to which the resource belongs. siteName is name of the app.
// expiredOnly is specify <code>false</code> to return all recommendations. The default is <code>true</code>, which
// returns only expired recommendations. filter is filter is specified by using OData syntax. Example:
