...
type AppsClientAPI interface {
	...
	GetFunctionState(ctx context.Context, resourceGroupName string, name string, functionName string) (result web.String, err error)
	GetFunctionStateSlot(ctx context.Context, resourceGroupName string, name string, functionName string, slot string) (result web.String, err error)
	...
	GetHostConfig(ctx context.Context, resourceGroupName string, name string) (result web.SetObject, err error)
	GetHostConfigSlot(ctx context.Context, resourceGroupName string, name string, slot string) (result web.SetObject, err error)
	...
	UpdateFunctionState(ctx context.Context, resourceGroupName string, name string, functionName string, requestEnvelope string) (result web.String, err error)
	UpdateFunctionStateSlot(ctx context.Context, resourceGroupName string, name string, functionName string, requestEnvelope string, slot string) (result web.String, err error)
