...
type AppsClientAPI interface {
	...
	GetFunctionStatus(ctx context.Context, resourceGroupName string, name string, functionName string) (result web.FunctionStatus, err error)
	GetFunctionStatusSlot(ctx context.Context, resourceGroupName string, name string, functionName string, slot string) (result web.FunctionStatus, err error)
	...
	GetHostStatus(ctx context.Context, resourceGroupName string, name string) (result web.HostStatus, err error)
	GetHostStatusSlot(ctx context.Context, resourceGroupName string, name string, slot string) (result web.HostStatus, err error)
	...
	ListFunctionSecrets(ctx context.Context, resourceGroupName string, name string, functionName string) (result web.FunctionKeys, err error)
	ListFunctionSecretsSlot(ctx context.Context, resourceGroupName string, name string, functionName string, slot string) (result web.FunctionKeys, err error)
	...
	ListSyncFunctionTriggersStatus(ctx context.Context, resourceGroupName string, name string) (result autorest.Response, err error)
	ListSyncFunctionTriggersStatusSlot(ctx context.Context, resourceGroupName string, name string, slot string) (result autorest.Response, err error)
...
type AppServiceEnvironmentsClientAPI interface {
	...
	GetInboundNetworkDependenciesEndpoints(ctx context.Context, resourceGroupName string, name string) (result web.ListInboundEnvironmentEndpoint, err error)
	GetMultiRolePool(ctx context.Context, resourceGroupName string, name string) (result web.WorkerPoolResource, err error)
	GetOutboundNetworkDependenciesEndpoints(ctx context.Context, resourceGroupName string, name string) (result web.ListOutboundEnvironmentEndpoint, err error)
