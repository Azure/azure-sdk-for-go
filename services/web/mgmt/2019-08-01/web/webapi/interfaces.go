...
type BaseClientAPI interface {
	...
	ListGeoRegionsComplete(ctx context.Context, sku SkuName, linuxWorkersEnabled *bool, xenonWorkersEnabled *bool, linuxDynamicWorkersEnabled *bool) (result web.GeoRegionCollectionIterator, err error)
	...
	ListSiteIdentifiersAssignedToHostNameComplete(ctx context.Context, nameIdentifier NameIdentifier) (result web.IdentifierCollectionIterator, err error)
...
type DomainsClientAPI interface {
	...
	ListRecommendationsComplete(ctx context.Context, parameters DomainRecommendationSearchParameters) (result web.NameIdentifierCollectionIterator, err error)
...
type TopLevelDomainsClientAPI interface {
	...
	ListAgreementsComplete(ctx context.Context, name string, agreementOption TopLevelDomainAgreementOption) (result web.TldLegalAgreementCollectionIterator, err error)
}
...
type AppsClientAPI interface {
	...
	GetAppSettingKeyVaultReference(ctx context.Context, resourceGroupName string, name string, appSettingKey string) (result web.KeyVaultReferenceResource, err error)
	GetAppSettingsKeyVaultReferences(ctx context.Context, resourceGroupName string, name string) (result web.KeyVaultReferenceCollection, err error)
	...
	ListSlotDifferencesFromProductionComplete(ctx context.Context, resourceGroupName string, name string, slotSwapEntity CsmSlotEntity) (result web.SlotDifferenceCollectionIterator, err error)
	...
	ListSlotDifferencesSlotComplete(ctx context.Context, resourceGroupName string, name string, slotSwapEntity CsmSlotEntity, slot string) (result web.SlotDifferenceCollectionIterator, err error)
...
type AppServiceEnvironmentsClientAPI interface {
	...
	ChangeVnetComplete(ctx context.Context, resourceGroupName string, name string, vnetInfo VirtualNetworkProfile) (result web.AppServiceEnvironmentsChangeVnetAllFuture, err error)
