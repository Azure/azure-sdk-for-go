...
type AppServicePlansClientAPI interface {
	...
	GetVnetFromServerFarm(ctx context.Context, resourceGroupName string, name string, vnetName string) (result web.VnetInfoResource, err error)
	...
	ListUsages(ctx context.Context, resourceGroupName string, name string, filter string) (result web.CsmUsageQuotaCollectionPage, err error)
	ListUsagesComplete(ctx context.Context, resourceGroupName string, name string, filter string) (result web.CsmUsageQuotaCollectionIterator, err error)
	ListVnets(ctx context.Context, resourceGroupName string, name string) (result web.ListVnetInfoResource, err error)
...
type DiagnosticsClientAPI interface {
	...
	GetSiteDetector(ctx context.Context, resourceGroupName string, siteName string, diagnosticCategory string, detectorName string) (result web.DetectorDefinitionResource, err error)
	...
	GetSiteDetectorSlot(ctx context.Context, resourceGroupName string, siteName string, diagnosticCategory string, detectorName string, slot string) (result web.DetectorDefinitionResource, err error)
...
type AppsClientAPI interface {
	...
	CreateOrUpdateVnetConnection(ctx context.Context, resourceGroupName string, name string, vnetName string, connectionEnvelope web.VnetInfoResource) (result web.VnetInfoResource, err error)
	...
	CreateOrUpdateVnetConnectionSlot(ctx context.Context, resourceGroupName string, name string, vnetName string, connectionEnvelope web.VnetInfoResource, slot string) (result web.VnetInfoResource, err error)
	...
	GetVnetConnection(ctx context.Context, resourceGroupName string, name string, vnetName string) (result web.VnetInfoResource, err error)
	...
	GetVnetConnectionSlot(ctx context.Context, resourceGroupName string, name string, vnetName string, slot string) (result web.VnetInfoResource, err error)
	...
	ListVnetConnections(ctx context.Context, resourceGroupName string, name string) (result web.ListVnetInfoResource, err error)
	ListVnetConnectionsSlot(ctx context.Context, resourceGroupName string, name string, slot string) (result web.ListVnetInfoResource, err error)
	...
	UpdateVnetConnection(ctx context.Context, resourceGroupName string, name string, vnetName string, connectionEnvelope web.VnetInfoResource) (result web.VnetInfoResource, err error)
	...
	UpdateVnetConnectionSlot(ctx context.Context, resourceGroupName string, name string, vnetName string, connectionEnvelope web.VnetInfoResource, slot string) (result web.VnetInfoResource, err error)
}
