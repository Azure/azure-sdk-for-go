...
type BaseClientAPI interface {
	...
	ListCustomHostNameSites(ctx context.Context) (result web.CustomHostnameSitesCollectionPage, err error)
	ListCustomHostNameSitesComplete(ctx context.Context) (result web.CustomHostnameSitesCollectionIterator, err error)
...
type DomainsClientAPI interface {
	...
	TransferOut(ctx context.Context, resourceGroupName string, domainName string) (result web.Domain, err error)
...
// ContainerAppsClientAPI contains the set of methods on the ContainerAppsClient type.
type ContainerAppsClientAPI interface {
	CreateOrUpdate(ctx context.Context, resourceGroupName string, name string, containerAppEnvelope web.ContainerApp) (result web.ContainerAppsCreateOrUpdateFuture, err error)
	Delete(ctx context.Context, resourceGroupName string, name string) (result web.ContainerAppsDeleteFuture, err error)
	Get(ctx context.Context, resourceGroupName string, name string) (result web.ContainerApp, err error)
	ListByResourceGroup(ctx context.Context, resourceGroupName string) (result web.ContainerAppCollectionPage, err error)
	ListByResourceGroupComplete(ctx context.Context, resourceGroupName string) (result web.ContainerAppCollectionIterator, err error)
	ListBySubscription(ctx context.Context) (result web.ContainerAppCollectionPage, err error)
	ListBySubscriptionComplete(ctx context.Context) (result web.ContainerAppCollectionIterator, err error)
	ListSecrets(ctx context.Context, name string) (result web.SecretsCollection, err error)
}

var _ ContainerAppsClientAPI = (*web.ContainerAppsClient)(nil)

// ContainerAppsRevisionsClientAPI contains the set of methods on the ContainerAppsRevisionsClient type.
type ContainerAppsRevisionsClientAPI interface {
	ActivateRevision(ctx context.Context, resourceGroupName string, containerAppName string, name string) (result autorest.Response, err error)
	DeactivateRevision(ctx context.Context, resourceGroupName string, containerAppName string, name string) (result autorest.Response, err error)
	GetRevision(ctx context.Context, resourceGroupName string, containerAppName string, name string) (result web.Revision, err error)
	ListRevisions(ctx context.Context, resourceGroupName string, containerAppName string) (result web.RevisionCollectionPage, err error)
	ListRevisionsComplete(ctx context.Context, resourceGroupName string, containerAppName string) (result web.RevisionCollectionIterator, err error)
	RestartRevision(ctx context.Context, resourceGroupName string, containerAppName string, name string) (result autorest.Response, err error)
}

var _ ContainerAppsRevisionsClientAPI = (*web.ContainerAppsRevisionsClient)(nil)
...
type AppsClientAPI interface {
	...
	CreateOneDeployOperation(ctx context.Context, resourceGroupName string, name string) (result web.SetObject, err error)
	...
	GetAuthSettingsV2WithoutSecrets(ctx context.Context, resourceGroupName string, name string) (result web.SiteAuthSettingsV2, err error)
	GetAuthSettingsV2WithoutSecretsSlot(ctx context.Context, resourceGroupName string, name string, slot string) (result web.SiteAuthSettingsV2, err error)
	...
	GetOneDeployStatus(ctx context.Context, resourceGroupName string, name string) (result web.SetObject, err error)
