...
type HubsClientAPI interface {
	CreateOrUpdate(ctx context.Context, hubName string, parameters webpubsub.Hub, resourceGroupName string, resourceName string) (result webpubsub.HubsCreateOrUpdateFuture, err error)
	Delete(ctx context.Context, hubName string, resourceGroupName string, resourceName string) (result webpubsub.HubsDeleteFuture, err error)
	Get(ctx context.Context, hubName string, resourceGroupName string, resourceName string) (result webpubsub.Hub, err error)
	List(ctx context.Context, resourceGroupName string, resourceName string) (result webpubsub.HubListPage, err error)
	ListComplete(ctx context.Context, resourceGroupName string, resourceName string) (result webpubsub.HubListIterator, err error)
}

var _ HubsClientAPI = (*webpubsub.HubsClient)(nil)
